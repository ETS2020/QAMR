// Benchmark "FAU" written by ABC on Mon Jul  6 13:18:20 2020
...
module FAU ( 
  ...
  inv1   g066(.a(x10), .O(new_n150_));
  nand3  g067(.a(x32), .b(new_n150_), .c(new_n146_), .O(new_n151_));
  inv1   g068(.a(new_n151_), .O(z21));
  nand3  g069(.a(x34), .b(new_n150_), .c(x09), .O(new_n153_));
  inv1   g070(.a(new_n153_), .O(z22));
  nand2  g071(.a(x34), .b(new_n146_), .O(new_n155_));
  nand2  g072(.a(x35), .b(x09), .O(new_n156_));
  aoi21  g073(.a(new_n156_), .b(new_n155_), .c(x10), .O(z23));
  nand2  g074(.a(x35), .b(new_n146_), .O(new_n158_));
  nand2  g075(.a(x36), .b(x09), .O(new_n159_));
  aoi21  g076(.a(new_n159_), .b(new_n158_), .c(x10), .O(z24));
  nand2  g077(.a(x36), .b(new_n146_), .O(new_n161_));
  nand2  g078(.a(x37), .b(x09), .O(new_n162_));
  aoi21  g079(.a(new_n162_), .b(new_n161_), .c(x10), .O(z25));
  nand2  g080(.a(x37), .b(new_n146_), .O(new_n164_));
  ...
  nand2  g087(.a(x38), .b(new_n146_), .O(new_n171_));
