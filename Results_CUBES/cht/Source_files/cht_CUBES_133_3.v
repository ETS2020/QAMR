...
module FAU ( 
  ...
  inv1   g111(.a(x46), .O(new_n195_));
  inv1   g112(.a(x10), .O(new_n196_));
  nand3  g113(.a(new_n175_), .b(x45), .c(new_n196_), .O(new_n197_));
  oai21  g114(.a(new_n175_), .b(new_n195_), .c(new_n197_), .O(z34));
  nand4  g115(.a(new_n174_), .b(new_n196_), .c(x09), .d(x00), .O(new_n199_));
  oai21  g116(.a(new_n177_), .b(new_n195_), .c(new_n199_), .O(z35));
endmodule
