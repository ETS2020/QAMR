// Benchmark "FAU" written by ABC on Mon Jul  6 13:19:06 2020
...
module FAU ( 
  ...
  inv1   g081(.a(x10), .O(new_n165_));
  nand3  g082(.a(x37), .b(new_n165_), .c(new_n146_), .O(new_n166_));
  ...
  nand2  g087(.a(new_n165_), .b(x09), .O(new_n171_));
  aoi21  g088(.a(new_n170_), .b(new_n168_), .c(new_n171_), .O(z27));
  oai21  g089(.a(x14), .b(new_n146_), .c(x39), .O(new_n173_));
  nand3  g090(.a(x40), .b(new_n169_), .c(x09), .O(new_n174_));
  aoi21  g091(.a(new_n174_), .b(new_n173_), .c(x10), .O(z28));
  oai21  g092(.a(x14), .b(new_n146_), .c(x40), .O(new_n176_));
  nand3  g093(.a(x41), .b(new_n169_), .c(x09), .O(new_n177_));
  aoi21  g094(.a(new_n177_), .b(new_n176_), .c(x10), .O(z29));
  oai21  g095(.a(x14), .b(new_n146_), .c(x41), .O(new_n179_));
  nand3  g096(.a(x42), .b(new_n169_), .c(x09), .O(new_n180_));
  aoi21  g097(.a(new_n180_), .b(new_n179_), .c(x10), .O(z30));
  oai21  g098(.a(x14), .b(new_n146_), .c(x42), .O(new_n182_));
  nand3  g099(.a(x43), .b(new_n169_), .c(x09), .O(new_n183_));
  aoi21  g100(.a(new_n183_), .b(new_n182_), .c(x10), .O(z31));
  oai21  g101(.a(x14), .b(new_n146_), .c(x43), .O(new_n185_));
  nand3  g102(.a(x44), .b(new_n169_), .c(x09), .O(new_n186_));
  aoi21  g103(.a(new_n186_), .b(new_n185_), .c(x10), .O(z32));
  oai21  g104(.a(x14), .b(new_n146_), .c(x44), .O(new_n188_));
  nand3  g105(.a(x45), .b(new_n169_), .c(x09), .O(new_n189_));
  aoi21  g106(.a(new_n189_), .b(new_n188_), .c(x10), .O(z33));
  oai21  g107(.a(x14), .b(new_n146_), .c(x45), .O(new_n191_));
  nand3  g108(.a(x46), .b(new_n169_), .c(x09), .O(new_n192_));
  aoi21  g109(.a(new_n192_), .b(new_n191_), .c(x10), .O(z34));
  oai21  g110(.a(x14), .b(new_n146_), .c(x46), .O(new_n194_));
  nand3  g111(.a(new_n169_), .b(x09), .c(x00), .O(new_n195_));
