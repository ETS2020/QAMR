...
module FAU ( 
  ...
  nand3  g20(.a(new_n47_), .b(x13), .c(new_n48_), .O(new_n49_));
  oai21  g21(.a(new_n47_), .b(x13), .c(new_n49_), .O(new_n50_));
  nand3  g22(.a(new_n50_), .b(new_n40_), .c(x09), .O(new_n51_));
  ...
  inv1   g38(.a(new_n44_), .O(new_n67_));
  nand2  g39(.a(x15), .b(x14), .O(new_n68_));
  oai21  g40(.a(new_n55_), .b(new_n68_), .c(x16), .O(new_n69_));
  inv1   g41(.a(new_n55_), .O(new_n70_));
  nor2   g42(.a(new_n68_), .b(x16), .O(new_n71_));
  nand2  g43(.a(new_n71_), .b(new_n70_), .O(new_n72_));
  nand2  g44(.a(new_n72_), .b(new_n69_), .O(new_n73_));
  nand2  g45(.a(new_n73_), .b(new_n67_), .O(new_n74_));
  ...
  nand2  g53(.a(new_n81_), .b(new_n67_), .O(new_n82_));
