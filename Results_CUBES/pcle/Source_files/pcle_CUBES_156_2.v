...
module FAU ( 
  ...
  nand3  g02(.a(new_n30_), .b(x17), .c(x16), .O(new_n31_));
  ...
  oai21  g38(.a(new_n54_), .b(new_n29_), .c(x16), .O(new_n67_));
  inv1   g39(.a(x16), .O(new_n68_));
  nand3  g40(.a(new_n55_), .b(new_n30_), .c(new_n68_), .O(new_n69_));
  nand2  g41(.a(new_n69_), .b(new_n67_), .O(new_n70_));
  nand2  g42(.a(new_n70_), .b(new_n52_), .O(new_n71_));
  nand2  g43(.a(x08), .b(x05), .O(new_n72_));
  nand2  g44(.a(new_n72_), .b(new_n71_), .O(z6));
  nand3  g45(.a(x16), .b(x15), .c(x14), .O(new_n74_));
  oai21  g46(.a(new_n74_), .b(new_n54_), .c(x17), .O(new_n75_));
  ...
  oai21  g54(.a(new_n82_), .b(new_n61_), .c(x15), .O(new_n83_));
  inv1   g55(.a(x15), .O(new_n84_));
  nand2  g56(.a(x18), .b(new_n84_), .O(new_n85_));
  nand2  g57(.a(new_n85_), .b(new_n83_), .O(new_n86_));
  nand2  g58(.a(new_n86_), .b(new_n52_), .O(new_n87_));
