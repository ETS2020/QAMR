...
module FAU ( 
  ...
  oai21  g32(.a(new_n60_), .b(x15), .c(x12), .O(new_n61_));
  nand3  g33(.a(x14), .b(x13), .c(x11), .O(new_n62_));
  aoi22  g34(.a(new_n62_), .b(x15), .c(new_n61_), .d(x11), .O(new_n63_));
  ...
  nor2   g56(.a(x18), .b(new_n77_), .O(new_n85_));
  nand4  g57(.a(x16), .b(x15), .c(x14), .d(x13), .O(new_n86_));
  inv1   g58(.a(new_n86_), .O(new_n87_));
  nand3  g59(.a(new_n87_), .b(new_n85_), .c(new_n53_), .O(new_n88_));
