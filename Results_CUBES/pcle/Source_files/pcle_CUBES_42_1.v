...
module FAU ( 
  ...
  nand3  g44(.a(new_n67_), .b(x15), .c(x14), .O(new_n73_));
  nor2   g45(.a(new_n73_), .b(new_n52_), .O(new_n74_));
  nor2   g46(.a(x10), .b(new_n33_), .O(new_n75_));
  oai21  g47(.a(new_n74_), .b(new_n72_), .c(new_n75_), .O(new_n76_));
  ...
  inv1   g60(.a(new_n61_), .O(new_n89_));
