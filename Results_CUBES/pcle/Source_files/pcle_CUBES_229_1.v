...
module FAU ( 
  ...
  inv1   g46(.a(x08), .O(new_n75_));
  nand2  g47(.a(new_n52_), .b(new_n75_), .O(new_n76_));
  nand3  g48(.a(x16), .b(x15), .c(x14), .O(new_n77_));
  nand2  g49(.a(new_n77_), .b(x12), .O(new_n78_));
  aoi21  g50(.a(new_n78_), .b(new_n76_), .c(new_n74_), .O(new_n79_));
  nand4  g51(.a(new_n74_), .b(x16), .c(x15), .d(x14), .O(new_n80_));
  nor2   g52(.a(new_n80_), .b(new_n52_), .O(new_n81_));
  nor2   g53(.a(x10), .b(new_n33_), .O(new_n82_));
  oai21  g54(.a(new_n81_), .b(new_n79_), .c(new_n82_), .O(new_n83_));
