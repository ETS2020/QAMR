...
module FAU ( 
  ...
  xor2a  g22(.a(new_n50_), .b(new_n38_), .O(new_n51_));
  nand2  g23(.a(x08), .b(x02), .O(new_n52_));
  oai21  g24(.a(new_n51_), .b(new_n47_), .c(new_n52_), .O(z3));
  aoi21  g25(.a(x13), .b(x11), .c(new_n37_), .O(new_n54_));
  aoi21  g26(.a(x14), .b(new_n37_), .c(new_n54_), .O(new_n55_));
  nand2  g27(.a(x08), .b(x03), .O(new_n56_));
  oai21  g28(.a(new_n55_), .b(new_n47_), .c(new_n56_), .O(z4));
  ...
  nand2  g56(.a(new_n84_), .b(new_n58_), .O(new_n85_));
