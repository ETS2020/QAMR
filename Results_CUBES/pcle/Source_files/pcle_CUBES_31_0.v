...
module FAU ( 
  ...
  nor2   g10(.a(x16), .b(x12), .O(new_n39_));
  ...
  oai21  g29(.a(new_n57_), .b(new_n49_), .c(new_n55_), .O(new_n58_));
  nand2  g30(.a(new_n58_), .b(new_n53_), .O(new_n59_));
  nand2  g31(.a(x08), .b(x03), .O(new_n60_));
  nand2  g32(.a(new_n60_), .b(new_n59_), .O(z4));
  inv1   g33(.a(new_n49_), .O(new_n62_));
  nand4  g34(.a(x14), .b(x13), .c(x12), .d(x11), .O(new_n63_));
  nand2  g35(.a(x14), .b(x13), .O(new_n64_));
  nor2   g36(.a(new_n64_), .b(x15), .O(new_n65_));
  aoi22  g37(.a(new_n65_), .b(new_n62_), .c(new_n63_), .d(x15), .O(new_n66_));
  nand2  g38(.a(x08), .b(x04), .O(new_n67_));
  oai21  g39(.a(new_n66_), .b(new_n46_), .c(new_n67_), .O(z5));
  inv1   g40(.a(x16), .O(new_n69_));
  nand4  g41(.a(new_n69_), .b(x15), .c(x14), .d(x13), .O(new_n70_));
  aoi21  g42(.a(new_n70_), .b(x12), .c(new_n35_), .O(new_n71_));
  nand4  g43(.a(x15), .b(x14), .c(x13), .d(x11), .O(new_n72_));
  and2   g44(.a(new_n72_), .b(x16), .O(new_n73_));
  oai21  g45(.a(new_n73_), .b(new_n71_), .c(new_n53_), .O(new_n74_));
  ...
  nand2  g53(.a(new_n81_), .b(new_n53_), .O(new_n82_));
  ...
  inv1   g58(.a(new_n63_), .O(new_n87_));
