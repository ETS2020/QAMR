...
module FAU ( 
  ...
  nor3   g33(.a(new_n61_), .b(new_n47_), .c(x15), .O(new_n62_));
  aoi21  g34(.a(new_n60_), .b(x15), .c(new_n62_), .O(new_n63_));
  nand2  g35(.a(x08), .b(x04), .O(new_n64_));
  oai21  g36(.a(new_n63_), .b(new_n44_), .c(new_n64_), .O(z5));
  nand2  g37(.a(x16), .b(new_n54_), .O(new_n66_));
  ...
  nand3  g43(.a(new_n71_), .b(x16), .c(new_n70_), .O(new_n72_));
  inv1   g44(.a(new_n72_), .O(new_n73_));
  aoi21  g45(.a(new_n69_), .b(x15), .c(new_n73_), .O(new_n74_));
  nand2  g46(.a(new_n40_), .b(x09), .O(new_n75_));
  nand2  g47(.a(x08), .b(x05), .O(new_n76_));
  oai21  g48(.a(new_n75_), .b(new_n74_), .c(new_n76_), .O(z6));
  ...
  nand2  g63(.a(new_n91_), .b(new_n51_), .O(new_n92_));
