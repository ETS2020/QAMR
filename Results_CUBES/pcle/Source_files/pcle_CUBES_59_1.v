...
module FAU ( 
  ...
  nor2   g31(.a(new_n36_), .b(x15), .O(new_n60_));
  aoi22  g32(.a(new_n60_), .b(new_n52_), .c(new_n59_), .d(x15), .O(new_n61_));
  nand2  g33(.a(x08), .b(x04), .O(new_n62_));
  oai21  g34(.a(new_n61_), .b(new_n45_), .c(new_n62_), .O(z5));
  inv1   g35(.a(new_n45_), .O(new_n64_));
  ...
  nand4  g53(.a(x17), .b(x16), .c(x15), .d(x11), .O(new_n82_));
  oai21  g54(.a(new_n82_), .b(new_n36_), .c(x18), .O(new_n83_));
  inv1   g55(.a(new_n59_), .O(new_n84_));
  nor2   g56(.a(x18), .b(new_n76_), .O(new_n85_));
  nand3  g57(.a(new_n85_), .b(new_n84_), .c(new_n29_), .O(new_n86_));
  nand2  g58(.a(new_n86_), .b(new_n83_), .O(new_n87_));
  nand2  g59(.a(new_n87_), .b(new_n64_), .O(new_n88_));
