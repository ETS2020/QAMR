// Benchmark "FAU" written by ABC on Mon Jul  6 13:56:28 2020
...
module FAU ( 
  ...
  nand2  g26(.a(new_n50_), .b(x14), .O(new_n55_));
  ...
  nor2   g34(.a(x15), .b(new_n38_), .O(new_n63_));
  aoi22  g35(.a(new_n63_), .b(new_n61_), .c(new_n62_), .d(x15), .O(new_n64_));
  ...
  aoi22  g41(.a(new_n69_), .b(new_n61_), .c(new_n67_), .d(x16), .O(new_n70_));
  nand2  g42(.a(x08), .b(x05), .O(new_n71_));
  oai21  g43(.a(new_n70_), .b(new_n47_), .c(new_n71_), .O(z6));
  oai21  g44(.a(new_n62_), .b(new_n29_), .c(x17), .O(new_n73_));
  inv1   g45(.a(x17), .O(new_n74_));
  inv1   g46(.a(new_n62_), .O(new_n75_));
  nand3  g47(.a(new_n75_), .b(new_n30_), .c(new_n74_), .O(new_n76_));
  nand2  g48(.a(new_n76_), .b(new_n73_), .O(new_n77_));
  nand2  g49(.a(new_n77_), .b(new_n54_), .O(new_n78_));
  nand2  g50(.a(x08), .b(x06), .O(new_n79_));
  nand2  g51(.a(new_n79_), .b(new_n78_), .O(z7));
  nand3  g52(.a(x17), .b(x16), .c(x15), .O(new_n81_));
  oai21  g53(.a(new_n81_), .b(new_n62_), .c(x18), .O(new_n82_));
  inv1   g54(.a(x18), .O(new_n83_));
  nand4  g55(.a(new_n83_), .b(x17), .c(x16), .d(x15), .O(new_n84_));
  oai21  g56(.a(new_n84_), .b(new_n62_), .c(new_n82_), .O(new_n85_));
  nand2  g57(.a(new_n85_), .b(new_n54_), .O(new_n86_));
