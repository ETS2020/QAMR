// Benchmark "FAU" written by ABC on Mon Jul  6 13:56:59 2020
...
module FAU ( 
  ...
  nand2  g11(.a(x12), .b(x08), .O(new_n40_));
  nand4  g12(.a(new_n40_), .b(new_n35_), .c(new_n39_), .d(x09), .O(new_n41_));
  nand2  g13(.a(x08), .b(x00), .O(new_n42_));
  nand2  g14(.a(new_n42_), .b(new_n41_), .O(z1));
  xnor2a g15(.a(x12), .b(x11), .O(new_n44_));
  nand2  g16(.a(new_n34_), .b(new_n39_), .O(new_n45_));
