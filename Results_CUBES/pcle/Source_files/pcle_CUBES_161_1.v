// Benchmark "FAU" written by ABC on Mon Jul  6 13:57:08 2020
...
module FAU ( 
  ...
  nand3  g18(.a(new_n35_), .b(x11), .c(new_n41_), .O(new_n47_));
  oai21  g19(.a(new_n47_), .b(new_n45_), .c(new_n46_), .O(z2));
  xnor2a g20(.a(x13), .b(x12), .O(new_n49_));
  nand2  g21(.a(new_n34_), .b(new_n41_), .O(new_n50_));
  nand2  g22(.a(x08), .b(x02), .O(new_n51_));
  oai21  g23(.a(new_n50_), .b(new_n49_), .c(new_n51_), .O(z3));
  and2   g24(.a(x13), .b(x12), .O(new_n53_));
  xnor2a g25(.a(new_n53_), .b(x14), .O(new_n54_));
  nand2  g26(.a(x08), .b(x03), .O(new_n55_));
  oai21  g27(.a(new_n54_), .b(new_n50_), .c(new_n55_), .O(z4));
  inv1   g28(.a(new_n50_), .O(new_n57_));
  inv1   g29(.a(x15), .O(new_n58_));
  nand3  g30(.a(x14), .b(x13), .c(x12), .O(new_n59_));
  inv1   g31(.a(new_n59_), .O(new_n60_));
  nand4  g32(.a(new_n58_), .b(x14), .c(x13), .d(x12), .O(new_n61_));
  ...
  nand4  g37(.a(x15), .b(x14), .c(x13), .d(x12), .O(new_n66_));
  ...
  oai21  g42(.a(new_n69_), .b(new_n50_), .c(new_n70_), .O(z6));
