// Benchmark "FAU" written by ABC on Mon Jul  6 13:57:25 2020
...
module FAU ( 
  ...
  nand3  g51(.a(new_n79_), .b(new_n40_), .c(x09), .O(new_n80_));
  nand2  g52(.a(new_n80_), .b(new_n74_), .O(z7));
