...
module FAU ( 
  ...
  nand2  g09(.a(x13), .b(x08), .O(new_n38_));
  ...
  nand2  g15(.a(x12), .b(new_n37_), .O(new_n44_));
  nor2   g16(.a(x12), .b(new_n37_), .O(new_n45_));
  nand2  g17(.a(new_n45_), .b(x13), .O(new_n46_));
  aoi21  g18(.a(new_n46_), .b(new_n44_), .c(x08), .O(new_n47_));
  inv1   g19(.a(x13), .O(new_n48_));
  nand2  g20(.a(new_n45_), .b(new_n48_), .O(new_n49_));
  inv1   g21(.a(new_n49_), .O(new_n50_));
  oai21  g22(.a(new_n50_), .b(new_n47_), .c(new_n40_), .O(new_n51_));
  ...
  oai21  g28(.a(new_n56_), .b(x13), .c(new_n55_), .O(new_n57_));
  nand2  g29(.a(new_n57_), .b(new_n40_), .O(new_n58_));
  nand2  g30(.a(x08), .b(x02), .O(new_n59_));
  nand2  g31(.a(new_n59_), .b(new_n58_), .O(z3));
  nand2  g32(.a(new_n56_), .b(x14), .O(new_n61_));
  inv1   g33(.a(x14), .O(new_n62_));
  nand4  g34(.a(new_n62_), .b(x13), .c(x12), .d(x11), .O(new_n63_));
  aoi21  g35(.a(new_n63_), .b(new_n61_), .c(x08), .O(new_n64_));
  nor2   g36(.a(new_n62_), .b(x13), .O(new_n65_));
  oai21  g37(.a(new_n65_), .b(new_n64_), .c(new_n40_), .O(new_n66_));
  ...
  aoi22  g45(.a(new_n73_), .b(new_n31_), .c(x15), .d(new_n48_), .O(new_n74_));
  nand2  g46(.a(x08), .b(x04), .O(new_n75_));
  oai21  g47(.a(new_n74_), .b(new_n39_), .c(new_n75_), .O(z5));
  oai21  g48(.a(new_n56_), .b(new_n30_), .c(x16), .O(new_n77_));
  ...
  aoi21  g54(.a(new_n81_), .b(new_n31_), .c(new_n82_), .O(new_n83_));
  nand2  g55(.a(x08), .b(x05), .O(new_n84_));
  oai21  g56(.a(new_n83_), .b(new_n39_), .c(new_n84_), .O(z6));
  nand2  g57(.a(x16), .b(x15), .O(new_n86_));
  oai21  g58(.a(new_n86_), .b(new_n69_), .c(x17), .O(new_n87_));
  ...
  oai21  g67(.a(new_n95_), .b(new_n69_), .c(x18), .O(new_n96_));
