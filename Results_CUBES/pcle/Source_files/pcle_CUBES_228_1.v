// Benchmark "FAU" written by ABC on Mon Jul  6 13:57:36 2020
...
module FAU ( 
  ...
  nand3  g13(.a(new_n33_), .b(new_n34_), .c(new_n41_), .O(new_n42_));
  nand2  g14(.a(new_n42_), .b(new_n40_), .O(z1));
  xnor2a g15(.a(x12), .b(x11), .O(new_n44_));
  nand2  g16(.a(new_n33_), .b(new_n41_), .O(new_n45_));
  ...
  nor2   g33(.a(new_n36_), .b(x15), .O(new_n62_));
  aoi22  g34(.a(new_n62_), .b(new_n48_), .c(new_n61_), .d(x15), .O(new_n63_));
  ...
  aoi22  g40(.a(new_n68_), .b(new_n55_), .c(new_n66_), .d(x16), .O(new_n69_));
  ...
  oai21  g45(.a(new_n73_), .b(new_n72_), .c(x17), .O(new_n74_));
  inv1   g46(.a(x17), .O(new_n75_));
  nand3  g47(.a(x14), .b(x13), .c(x11), .O(new_n76_));
  inv1   g48(.a(new_n76_), .O(new_n77_));
  nand3  g49(.a(new_n77_), .b(new_n29_), .c(new_n75_), .O(new_n78_));
  nand2  g50(.a(new_n78_), .b(new_n74_), .O(new_n79_));
  nand2  g51(.a(new_n79_), .b(new_n52_), .O(new_n80_));
  nand2  g52(.a(x08), .b(x06), .O(new_n81_));
  nand2  g53(.a(new_n81_), .b(new_n80_), .O(z7));
  nand3  g54(.a(x17), .b(x16), .c(x15), .O(new_n83_));
  oai21  g55(.a(new_n83_), .b(new_n76_), .c(x18), .O(new_n84_));
  inv1   g56(.a(x18), .O(new_n85_));
  nand4  g57(.a(new_n85_), .b(x17), .c(x16), .d(x15), .O(new_n86_));
  oai21  g58(.a(new_n86_), .b(new_n76_), .c(new_n84_), .O(new_n87_));
  nand2  g59(.a(new_n87_), .b(new_n52_), .O(new_n88_));
