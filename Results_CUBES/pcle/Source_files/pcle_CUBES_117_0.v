// Benchmark "FAU" written by ABC on Mon Jul  6 13:56:49 2020
...
module FAU ( 
  ...
  nor2   g10(.a(x13), .b(x12), .O(new_n39_));
  ...
  aoi21  g19(.a(x13), .b(x12), .c(new_n35_), .O(new_n48_));
  aoi21  g20(.a(x13), .b(new_n35_), .c(new_n48_), .O(new_n49_));
  ...
  aoi22  g28(.a(new_n56_), .b(new_n54_), .c(new_n52_), .d(x14), .O(new_n57_));
  nand2  g29(.a(x08), .b(x03), .O(new_n58_));
  oai21  g30(.a(new_n57_), .b(new_n45_), .c(new_n58_), .O(z4));
  nand4  g31(.a(x14), .b(x13), .c(x12), .d(x11), .O(new_n60_));
  nand2  g32(.a(x14), .b(x13), .O(new_n61_));
  nor2   g33(.a(new_n61_), .b(x15), .O(new_n62_));
  aoi22  g34(.a(new_n62_), .b(new_n54_), .c(new_n60_), .d(x15), .O(new_n63_));
  ...
  oai21  g39(.a(new_n67_), .b(new_n53_), .c(x16), .O(new_n68_));
  ...
  inv1   g56(.a(new_n60_), .O(new_n85_));
  ...
  nand2  g61(.a(new_n89_), .b(new_n66_), .O(new_n90_));
