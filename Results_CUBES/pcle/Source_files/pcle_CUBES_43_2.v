...
module FAU ( 
  ...
  aoi21  g39(.a(new_n55_), .b(new_n29_), .c(new_n67_), .O(new_n68_));
  nand3  g40(.a(new_n67_), .b(x15), .c(x14), .O(new_n69_));
  nor2   g41(.a(new_n69_), .b(new_n54_), .O(new_n70_));
  oai21  g42(.a(new_n70_), .b(new_n68_), .c(new_n52_), .O(new_n71_));
  nand2  g43(.a(x08), .b(x05), .O(new_n72_));
  nand2  g44(.a(new_n72_), .b(new_n71_), .O(z6));
  nand2  g45(.a(x16), .b(x15), .O(new_n74_));
  oai21  g46(.a(new_n74_), .b(new_n54_), .c(x14), .O(new_n75_));
  nand2  g47(.a(x17), .b(new_n53_), .O(new_n76_));
  ...
  nand2  g57(.a(new_n85_), .b(new_n52_), .O(new_n86_));
