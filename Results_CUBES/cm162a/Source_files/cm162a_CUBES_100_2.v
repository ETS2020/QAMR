...
module FAU ( 
  ...
  nand2  g21(.a(new_n35_), .b(new_n40_), .O(new_n41_));
  ...
  oai21  g31(.a(new_n41_), .b(new_n23_), .c(new_n50_), .O(new_n51_));
  nand4  g32(.a(new_n49_), .b(new_n40_), .c(new_n32_), .d(new_n20_), .O(new_n52_));
