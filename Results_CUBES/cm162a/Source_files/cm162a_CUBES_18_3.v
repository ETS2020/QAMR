...
module FAU ( 
  ...
  nor2   g00(.a(x10), .b(x08), .O(new_n20_));
  ...
  aoi21  g12(.a(new_n30_), .b(new_n26_), .c(new_n31_), .O(new_n32_));
  nand2  g13(.a(new_n32_), .b(new_n28_), .O(z0));
  aoi21  g14(.a(new_n26_), .b(new_n25_), .c(new_n29_), .O(new_n34_));
  oai21  g15(.a(new_n34_), .b(new_n24_), .c(x03), .O(new_n35_));
  ...
  aoi21  g24(.a(new_n26_), .b(new_n20_), .c(new_n41_), .O(new_n44_));
  oai21  g25(.a(new_n44_), .b(new_n43_), .c(x03), .O(new_n45_));
  inv1   g26(.a(x06), .O(new_n46_));
  aoi21  g27(.a(new_n46_), .b(new_n37_), .c(new_n38_), .O(new_n47_));
  nand2  g28(.a(new_n47_), .b(new_n45_), .O(z2));
  inv1   g29(.a(x12), .O(new_n49_));
  nand4  g30(.a(new_n49_), .b(new_n41_), .c(new_n29_), .d(new_n25_), .O(new_n50_));
  aoi21  g31(.a(new_n50_), .b(new_n22_), .c(new_n23_), .O(new_n51_));
  nor3   g32(.a(x11), .b(x10), .c(x08), .O(new_n52_));
  aoi21  g33(.a(new_n52_), .b(new_n26_), .c(new_n49_), .O(new_n53_));
  oai21  g34(.a(new_n53_), .b(new_n51_), .c(x03), .O(new_n54_));
  inv1   g35(.a(x07), .O(new_n55_));
  aoi21  g36(.a(new_n55_), .b(new_n37_), .c(new_n38_), .O(new_n56_));
