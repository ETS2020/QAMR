...
module FAU ( 
  ...
  aoi21  g25(.a(new_n32_), .b(new_n24_), .c(new_n44_), .O(new_n45_));
  ...
  nand2  g31(.a(new_n41_), .b(new_n50_), .O(new_n51_));
  aoi21  g32(.a(new_n51_), .b(new_n20_), .c(new_n21_), .O(new_n52_));
  nand4  g33(.a(new_n44_), .b(new_n35_), .c(x04), .d(x02), .O(new_n53_));
  nand2  g34(.a(new_n53_), .b(x12), .O(new_n54_));
  nand2  g35(.a(new_n54_), .b(new_n23_), .O(new_n55_));
