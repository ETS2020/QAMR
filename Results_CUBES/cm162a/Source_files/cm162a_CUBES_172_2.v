...
module FAU ( 
  ...
  aoi21  g24(.a(new_n41_), .b(new_n24_), .c(new_n40_), .O(new_n44_));
  ...
  nor2   g30(.a(new_n49_), .b(x11), .O(new_n50_));
  oai21  g31(.a(new_n50_), .b(new_n33_), .c(new_n20_), .O(new_n51_));
  aoi21  g32(.a(new_n41_), .b(new_n24_), .c(new_n49_), .O(new_n52_));
  aoi21  g33(.a(new_n51_), .b(new_n24_), .c(new_n52_), .O(new_n53_));
