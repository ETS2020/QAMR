// Benchmark "FAU" written by ABC on Mon Jul  6 13:00:49 2020
...
module FAU ( 
  ...
  nand3  g29(.a(x11), .b(new_n32_), .c(new_n23_), .O(new_n49_));
  aoi21  g30(.a(new_n49_), .b(new_n20_), .c(new_n21_), .O(new_n50_));
  inv1   g31(.a(x12), .O(new_n51_));
  aoi21  g32(.a(new_n43_), .b(new_n24_), .c(new_n51_), .O(new_n52_));
