...
module FAU ( 
  ...
  oai21  g20(.a(new_n33_), .b(x11), .c(new_n20_), .O(new_n40_));
  nand3  g21(.a(new_n40_), .b(new_n24_), .c(x03), .O(new_n41_));
  nand3  g22(.a(new_n24_), .b(new_n32_), .c(new_n23_), .O(new_n42_));
  oai21  g23(.a(x06), .b(x03), .c(x05), .O(new_n43_));
  aoi21  g24(.a(new_n42_), .b(x11), .c(new_n43_), .O(new_n44_));
