...
module FAU ( 
  ...
  nor2   g21(.a(x12), .b(new_n40_), .O(new_n41_));
  oai21  g22(.a(new_n41_), .b(new_n33_), .c(new_n20_), .O(new_n42_));
  nor2   g23(.a(x10), .b(x08), .O(new_n43_));
  aoi21  g24(.a(new_n43_), .b(new_n24_), .c(new_n40_), .O(new_n44_));
  aoi21  g25(.a(new_n42_), .b(new_n24_), .c(new_n44_), .O(new_n45_));
  ...
  nand3  g30(.a(new_n43_), .b(new_n49_), .c(new_n40_), .O(new_n50_));
