// Benchmark "FAU" written by ABC on Mon Jul  6 13:01:14 2020
...
module FAU ( 
  ...
  aoi21  g29(.a(new_n43_), .b(new_n24_), .c(x11), .O(new_n49_));
  nor2   g30(.a(new_n40_), .b(new_n28_), .O(new_n50_));
  oai21  g31(.a(new_n50_), .b(new_n49_), .c(x12), .O(new_n51_));
  ...
  aoi21  g37(.a(new_n55_), .b(new_n24_), .c(new_n56_), .O(new_n57_));
