// Benchmark "FAU" written by ABC on Mon Jul  6 13:06:29 2020
...
module FAU ( 
  ...
  nand2  g17(.a(x01), .b(new_n41_), .O(new_n43_));
  nor3   g18(.a(new_n43_), .b(new_n39_), .c(new_n37_), .O(z04));
  inv1   g19(.a(x01), .O(new_n45_));
  nor4   g20(.a(new_n39_), .b(new_n37_), .c(new_n45_), .d(new_n41_), .O(z05));
  ...
  aoi21  g25(.a(new_n50_), .b(new_n48_), .c(new_n41_), .O(new_n51_));
  inv1   g26(.a(x08), .O(new_n52_));
  nand2  g27(.a(new_n52_), .b(new_n45_), .O(new_n53_));
  oai21  g28(.a(new_n43_), .b(x10), .c(new_n53_), .O(new_n54_));
  nand2  g29(.a(x05), .b(new_n31_), .O(new_n55_));
  inv1   g30(.a(x07), .O(new_n56_));
  inv1   g31(.a(x12), .O(new_n57_));
  nand3  g32(.a(x13), .b(new_n57_), .c(new_n56_), .O(new_n58_));
  nor2   g33(.a(new_n58_), .b(new_n55_), .O(new_n59_));
  oai21  g34(.a(new_n54_), .b(new_n51_), .c(new_n59_), .O(new_n60_));
  ...
  nand4  g39(.a(x13), .b(new_n57_), .c(x05), .d(new_n31_), .O(new_n65_));
  aoi21  g40(.a(new_n65_), .b(new_n61_), .c(new_n62_), .O(z08));
  and2   g41(.a(x13), .b(x06), .O(z09));
  nand3  g42(.a(new_n30_), .b(x06), .c(new_n26_), .O(new_n68_));
