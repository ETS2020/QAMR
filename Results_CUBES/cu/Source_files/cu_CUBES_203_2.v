...
module FAU ( 
  ...
  nor2   g23(.a(x07), .b(new_n26_), .O(new_n49_));
  nand4  g24(.a(new_n49_), .b(new_n27_), .c(x13), .d(new_n48_), .O(new_n50_));
  aoi21  g25(.a(new_n47_), .b(new_n44_), .c(new_n50_), .O(z06));
  inv1   g26(.a(new_n27_), .O(new_n52_));
  nor2   g27(.a(new_n31_), .b(new_n52_), .O(z07));
  nand3  g28(.a(x13), .b(new_n48_), .c(x04), .O(new_n54_));
  nor2   g29(.a(new_n54_), .b(new_n52_), .O(z08));
  and2   g30(.a(x13), .b(x06), .O(z09));
  inv1   g31(.a(x03), .O(new_n57_));
  nand2  g32(.a(x05), .b(x02), .O(new_n58_));
  nand3  g33(.a(new_n58_), .b(x06), .c(new_n57_), .O(new_n59_));
