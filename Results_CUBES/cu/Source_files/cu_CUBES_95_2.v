// Benchmark "FAU" written by ABC on Mon Jul  6 13:06:20 2020
...
module FAU ( 
  ...
  nand3  g17(.a(new_n34_), .b(new_n39_), .c(new_n26_), .O(new_n43_));
  nor3   g18(.a(new_n43_), .b(x01), .c(new_n42_), .O(z03));
  inv1   g19(.a(x01), .O(new_n45_));
  nor4   g20(.a(new_n40_), .b(new_n38_), .c(new_n45_), .d(x00), .O(z04));
  nor3   g21(.a(new_n43_), .b(new_n45_), .c(new_n42_), .O(z05));
  ...
  aoi21  g26(.a(new_n51_), .b(new_n49_), .c(new_n42_), .O(new_n52_));
  inv1   g27(.a(x08), .O(new_n53_));
  nand2  g28(.a(new_n53_), .b(new_n45_), .O(new_n54_));
  inv1   g29(.a(x10), .O(new_n55_));
  nand2  g30(.a(new_n55_), .b(x01), .O(new_n56_));
  nand2  g31(.a(x05), .b(new_n42_), .O(new_n57_));
  aoi21  g32(.a(new_n56_), .b(new_n54_), .c(new_n57_), .O(new_n58_));
  inv1   g33(.a(x07), .O(new_n59_));
  inv1   g34(.a(x12), .O(new_n60_));
  nand4  g35(.a(x13), .b(new_n60_), .c(new_n59_), .d(new_n31_), .O(new_n61_));
  inv1   g36(.a(new_n61_), .O(new_n62_));
  oai21  g37(.a(new_n58_), .b(new_n52_), .c(new_n62_), .O(new_n63_));
  nand3  g38(.a(new_n39_), .b(new_n28_), .c(x02), .O(new_n64_));
  nand2  g39(.a(x04), .b(new_n26_), .O(new_n65_));
  aoi21  g40(.a(new_n64_), .b(new_n63_), .c(new_n65_), .O(z06));
  aoi21  g41(.a(new_n28_), .b(new_n42_), .c(new_n43_), .O(z07));
  nand4  g42(.a(x13), .b(new_n60_), .c(x05), .d(new_n31_), .O(new_n68_));
  aoi21  g43(.a(new_n68_), .b(new_n64_), .c(new_n65_), .O(z08));
  and2   g44(.a(x13), .b(x06), .O(z09));
  nand3  g45(.a(new_n30_), .b(x06), .c(new_n26_), .O(new_n71_));
