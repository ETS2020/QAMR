// Benchmark "FAU" written by ABC on Mon Jul  6 13:07:17 2020
...
module FAU ( 
  ...
  nand4  g25(.a(new_n54_), .b(new_n53_), .c(x05), .d(new_n27_), .O(new_n55_));
  ...
  nand3  g32(.a(new_n54_), .b(x05), .c(new_n27_), .O(new_n63_));
