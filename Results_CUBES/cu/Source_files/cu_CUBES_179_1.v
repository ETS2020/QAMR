// Benchmark "FAU" written by ABC on Mon Jul  6 13:06:56 2020
...
module FAU ( 
  ...
  inv1   g11(.a(x13), .O(new_n39_));
  nand4  g12(.a(new_n39_), .b(x05), .c(new_n27_), .d(new_n26_), .O(new_n40_));
  nor3   g13(.a(new_n40_), .b(x02), .c(x00), .O(z04));
  inv1   g14(.a(x00), .O(new_n42_));
  nor3   g15(.a(new_n40_), .b(x02), .c(new_n42_), .O(z05));
  inv1   g16(.a(x10), .O(new_n44_));
  nand2  g17(.a(new_n44_), .b(new_n42_), .O(new_n45_));
  ...
  nand3  g27(.a(new_n39_), .b(new_n28_), .c(x02), .O(new_n55_));
  nand2  g28(.a(x04), .b(new_n26_), .O(new_n56_));
  aoi21  g29(.a(new_n55_), .b(new_n54_), .c(new_n56_), .O(z06));
  nand3  g30(.a(new_n39_), .b(x05), .c(new_n26_), .O(new_n58_));
