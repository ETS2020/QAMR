...
module FAU ( 
  ...
  aoi21  g25(.a(new_n50_), .b(new_n48_), .c(new_n27_), .O(new_n51_));
  ...
  nor3   g30(.a(new_n55_), .b(new_n28_), .c(x02), .O(new_n56_));
  oai21  g31(.a(new_n52_), .b(new_n51_), .c(new_n56_), .O(new_n57_));
  nand4  g32(.a(new_n38_), .b(new_n28_), .c(x04), .d(x02), .O(new_n58_));
  aoi21  g33(.a(new_n58_), .b(new_n57_), .c(x03), .O(z06));
  nor2   g34(.a(new_n39_), .b(new_n37_), .O(z07));
  nand4  g35(.a(x13), .b(new_n54_), .c(x05), .d(new_n31_), .O(new_n61_));
  nand3  g36(.a(new_n38_), .b(new_n28_), .c(x02), .O(new_n62_));
  nand2  g37(.a(x04), .b(new_n26_), .O(new_n63_));
  aoi21  g38(.a(new_n62_), .b(new_n61_), .c(new_n63_), .O(z08));
