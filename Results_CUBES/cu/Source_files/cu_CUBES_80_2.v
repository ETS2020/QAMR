// Benchmark "FAU" written by ABC on Mon Jul  6 13:06:14 2020
...
module FAU ( 
  ...
  nand4  g36(.a(new_n38_), .b(new_n28_), .c(new_n26_), .d(x02), .O(new_n62_));
  aoi21  g37(.a(new_n62_), .b(new_n61_), .c(new_n27_), .O(z06));
  nor2   g38(.a(new_n39_), .b(new_n37_), .O(z07));
  nand4  g39(.a(x13), .b(new_n58_), .c(x05), .d(new_n31_), .O(new_n65_));
  aoi21  g40(.a(new_n65_), .b(new_n62_), .c(new_n27_), .O(z08));
