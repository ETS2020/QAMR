// Benchmark "FAU" written by ABC on Mon Jul  6 13:05:53 2020
...
module FAU ( 
  ...
  nand3  g21(.a(new_n46_), .b(new_n43_), .c(new_n41_), .O(new_n47_));
  inv1   g22(.a(x09), .O(new_n48_));
  oai21  g23(.a(new_n48_), .b(x01), .c(x00), .O(new_n49_));
