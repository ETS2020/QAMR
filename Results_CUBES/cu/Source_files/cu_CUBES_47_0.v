// Benchmark "FAU" written by ABC on Mon Jul  6 13:06:00 2020
...
module FAU ( 
  ...
  nand4  g29(.a(x13), .b(new_n54_), .c(new_n53_), .d(new_n31_), .O(new_n55_));
  inv1   g30(.a(new_n55_), .O(new_n56_));
  oai21  g31(.a(new_n52_), .b(new_n51_), .c(new_n56_), .O(new_n57_));
