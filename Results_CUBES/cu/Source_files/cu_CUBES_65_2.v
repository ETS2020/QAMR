// Benchmark "FAU" written by ABC on Mon Jul  6 13:06:08 2020
...
module FAU ( 
  ...
  nand2  g09(.a(new_n26_), .b(new_n27_), .O(new_n35_));
  nand2  g10(.a(x05), .b(new_n31_), .O(new_n36_));
  ...
  aoi21  g40(.a(new_n65_), .b(new_n61_), .c(new_n31_), .O(z08));
