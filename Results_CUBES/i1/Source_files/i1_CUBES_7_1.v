// Benchmark "FAU" written by ABC on Mon Jul  6 13:16:18 2020
...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_,
    ...
    new_n64_, new_n67_, new_n68_, new_n69_, new_n73_, new_n74_, new_n77_,
    new_n79_, new_n81_, new_n83_, new_n84_;
  ...
  nor2   g34(.a(x24), .b(new_n74_), .O(z11));
  nand2  g35(.a(x23), .b(x14), .O(new_n77_));
  nor2   g36(.a(new_n77_), .b(x24), .O(z12));
  nand2  g37(.a(x23), .b(x17), .O(new_n79_));
  nor2   g38(.a(new_n79_), .b(x24), .O(z13));
