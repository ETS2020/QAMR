// Benchmark "FAU" written by ABC on Mon Jul  6 13:17:17 2020
...
module FAU ( 
  ...
  xor2a  g00(.a(x09), .b(x08), .O(new_n42_));
  ...
  oai21  g08(.a(new_n47_), .b(new_n42_), .c(new_n49_), .O(z01));
  inv1   g09(.a(x05), .O(new_n51_));
  nor2   g10(.a(x07), .b(x06), .O(new_n52_));
  nand4  g11(.a(new_n52_), .b(new_n46_), .c(new_n45_), .d(new_n51_), .O(new_n53_));
  nand3  g12(.a(new_n53_), .b(x19), .c(x00), .O(new_n54_));
  inv1   g13(.a(x09), .O(new_n55_));
  nand3  g14(.a(new_n55_), .b(x08), .c(new_n43_), .O(new_n56_));
  inv1   g15(.a(new_n56_), .O(new_n57_));
  nand4  g16(.a(new_n57_), .b(new_n46_), .c(new_n45_), .d(new_n44_), .O(new_n58_));
  nand2  g17(.a(new_n58_), .b(new_n54_), .O(z02));
  or2    g18(.a(x21), .b(x20), .O(z04));
  inv1   g19(.a(x10), .O(new_n61_));
  nand2  g20(.a(new_n46_), .b(new_n45_), .O(new_n62_));
  nor2   g21(.a(x08), .b(x07), .O(new_n63_));
  nand2  g22(.a(new_n63_), .b(new_n44_), .O(new_n64_));
  oai21  g23(.a(new_n64_), .b(new_n62_), .c(new_n61_), .O(z05));
  oai21  g24(.a(new_n53_), .b(new_n48_), .c(x19), .O(new_n66_));
  nand2  g25(.a(new_n66_), .b(new_n53_), .O(z06));
