// Benchmark "FAU" written by ABC on Mon Jul  6 13:16:36 2020
...
module FAU ( 
  ...
  nor2   g16(.a(x05), .b(x03), .O(new_n58_));
  ...
  nor2   g20(.a(new_n45_), .b(x04), .O(new_n62_));
  nor3   g21(.a(x09), .b(x07), .c(x06), .O(new_n63_));
  nand4  g22(.a(new_n63_), .b(new_n58_), .c(new_n49_), .d(new_n62_), .O(new_n64_));
  aoi21  g23(.a(new_n64_), .b(new_n61_), .c(new_n42_), .O(z02));
  or2    g24(.a(x21), .b(x20), .O(z04));
  inv1   g25(.a(x10), .O(new_n67_));
  nand2  g26(.a(new_n59_), .b(new_n49_), .O(new_n68_));
  nand3  g27(.a(new_n58_), .b(x19), .c(new_n45_), .O(new_n69_));
