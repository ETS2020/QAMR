...
module FAU ( 
  ...
  nand4  g152(.a(new_n203_), .b(new_n124_), .c(new_n57_), .d(new_n65_), .O(new_n204_));
  ...
  inv1   g157(.a(x18), .O(new_n209_));
  oai21  g158(.a(x16), .b(x00), .c(new_n209_), .O(new_n210_));
  aoi21  g159(.a(x34), .b(x19), .c(new_n210_), .O(new_n211_));
  oai21  g160(.a(new_n208_), .b(new_n52_), .c(new_n211_), .O(z15));
endmodule
