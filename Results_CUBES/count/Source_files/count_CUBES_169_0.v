...
module FAU ( 
  ...
  nand4  g112(.a(new_n97_), .b(new_n96_), .c(new_n69_), .d(new_n61_), .O(new_n164_));
  inv1   g113(.a(new_n164_), .O(new_n165_));
  inv1   g114(.a(x32), .O(new_n166_));
  nand4  g115(.a(new_n166_), .b(new_n155_), .c(new_n53_), .d(new_n52_), .O(new_n167_));
  inv1   g116(.a(new_n167_), .O(new_n168_));
  nor3   g117(.a(x30), .b(x29), .c(x28), .O(new_n169_));
  inv1   g118(.a(x27), .O(new_n170_));
  nand4  g119(.a(new_n170_), .b(new_n123_), .c(new_n98_), .d(new_n87_), .O(new_n171_));
  inv1   g120(.a(new_n171_), .O(new_n172_));
  nand4  g121(.a(new_n172_), .b(new_n169_), .c(new_n168_), .d(new_n165_), .O(new_n173_));
  nor2   g122(.a(x29), .b(x28), .O(new_n174_));
  nor2   g123(.a(x31), .b(x30), .O(new_n175_));
  nand4  g124(.a(new_n175_), .b(new_n174_), .c(new_n114_), .d(new_n98_), .O(new_n176_));
  ...
  nand4  g132(.a(new_n183_), .b(new_n142_), .c(new_n125_), .d(new_n141_), .O(new_n184_));
  oai21  g133(.a(new_n184_), .b(new_n90_), .c(x33), .O(new_n185_));
  nand4  g134(.a(new_n153_), .b(new_n152_), .c(new_n170_), .d(new_n123_), .O(new_n186_));
  inv1   g135(.a(new_n186_), .O(new_n187_));
  inv1   g136(.a(x33), .O(new_n188_));
  nand4  g137(.a(new_n188_), .b(new_n166_), .c(new_n155_), .d(new_n154_), .O(new_n189_));
  inv1   g138(.a(new_n189_), .O(new_n190_));
  nand4  g139(.a(new_n190_), .b(new_n187_), .c(new_n100_), .d(new_n71_), .O(new_n191_));
  ...
  oai21  g145(.a(new_n184_), .b(new_n90_), .c(x34), .O(new_n197_));
  nand4  g146(.a(x33), .b(new_n166_), .c(new_n155_), .d(new_n154_), .O(new_n198_));
  inv1   g147(.a(new_n198_), .O(new_n199_));
  nand4  g148(.a(new_n199_), .b(new_n187_), .c(new_n100_), .d(new_n71_), .O(new_n200_));
