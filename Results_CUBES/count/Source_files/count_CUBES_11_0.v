...
module FAU ( 
  ...
  nand3  g001(.a(x19), .b(x17), .c(x16), .O(new_n53_));
  ...
  nand4  g008(.a(new_n59_), .b(new_n56_), .c(new_n53_), .d(new_n52_), .O(z00));
  inv1   g009(.a(x20), .O(new_n61_));
  nor2   g010(.a(new_n61_), .b(new_n57_), .O(new_n62_));
  nor2   g011(.a(x20), .b(x17), .O(new_n63_));
  oai21  g012(.a(new_n63_), .b(new_n62_), .c(new_n58_), .O(new_n64_));
  nor2   g013(.a(new_n58_), .b(new_n55_), .O(new_n65_));
  ...
  oai21  g021(.a(new_n72_), .b(new_n71_), .c(new_n58_), .O(new_n73_));
  oai21  g022(.a(x16), .b(x13), .c(new_n52_), .O(new_n74_));
  ...
  nand4  g027(.a(new_n78_), .b(new_n70_), .c(new_n61_), .d(new_n57_), .O(new_n79_));
  inv1   g028(.a(new_n79_), .O(new_n80_));
  aoi21  g029(.a(new_n77_), .b(x22), .c(new_n80_), .O(new_n81_));
  oai21  g030(.a(x16), .b(x12), .c(new_n52_), .O(new_n82_));
  aoi21  g031(.a(new_n65_), .b(x22), .c(new_n82_), .O(new_n83_));
  oai21  g032(.a(new_n81_), .b(x19), .c(new_n83_), .O(z03));
  nor2   g033(.a(x23), .b(x22), .O(new_n85_));
  aoi22  g034(.a(new_n85_), .b(new_n72_), .c(new_n79_), .d(x23), .O(new_n86_));
  oai21  g035(.a(x16), .b(x11), .c(new_n52_), .O(new_n87_));
  aoi21  g036(.a(new_n65_), .b(x23), .c(new_n87_), .O(new_n88_));
  oai21  g037(.a(new_n86_), .b(x19), .c(new_n88_), .O(z04));
  nand3  g038(.a(new_n85_), .b(new_n63_), .c(new_n70_), .O(new_n90_));
  nor3   g039(.a(x24), .b(x23), .c(x22), .O(new_n91_));
  aoi22  g040(.a(new_n91_), .b(new_n72_), .c(new_n90_), .d(x24), .O(new_n92_));
  oai21  g041(.a(x16), .b(x10), .c(new_n52_), .O(new_n93_));
  aoi21  g042(.a(new_n65_), .b(x24), .c(new_n93_), .O(new_n94_));
  oai21  g043(.a(new_n92_), .b(x19), .c(new_n94_), .O(z05));
  inv1   g044(.a(x25), .O(new_n96_));
  aoi21  g045(.a(new_n91_), .b(new_n72_), .c(new_n96_), .O(new_n97_));
  nor2   g046(.a(x25), .b(x24), .O(new_n98_));
  nand4  g047(.a(new_n98_), .b(new_n85_), .c(new_n63_), .d(new_n70_), .O(new_n99_));
  inv1   g048(.a(new_n99_), .O(new_n100_));
  oai21  g049(.a(new_n100_), .b(new_n97_), .c(new_n58_), .O(new_n101_));
  oai21  g050(.a(x16), .b(x09), .c(new_n52_), .O(new_n102_));
  aoi21  g051(.a(new_n65_), .b(x25), .c(new_n102_), .O(new_n103_));
  ...
  oai21  g059(.a(x16), .b(x08), .c(new_n52_), .O(new_n111_));
  aoi21  g060(.a(new_n65_), .b(x26), .c(new_n111_), .O(new_n112_));
  oai21  g061(.a(new_n110_), .b(x19), .c(new_n112_), .O(z07));
  ...
  oai21  g068(.a(x16), .b(x07), .c(new_n52_), .O(new_n120_));
  aoi21  g069(.a(new_n65_), .b(x27), .c(new_n120_), .O(new_n121_));
  ...
  oai21  g075(.a(x16), .b(x06), .c(new_n52_), .O(new_n127_));
  aoi21  g076(.a(new_n65_), .b(x28), .c(new_n127_), .O(new_n128_));
  oai21  g077(.a(new_n126_), .b(x19), .c(new_n128_), .O(z09));
  nor3   g078(.a(x28), .b(x27), .c(x26), .O(new_n130_));
  nand4  g079(.a(new_n130_), .b(new_n98_), .c(new_n85_), .d(new_n72_), .O(new_n131_));
  ...
  oai21  g086(.a(x16), .b(x05), .c(new_n52_), .O(new_n138_));
  aoi21  g087(.a(new_n65_), .b(x29), .c(new_n138_), .O(new_n139_));
  oai21  g088(.a(new_n137_), .b(x19), .c(new_n139_), .O(z10));
  oai21  g089(.a(new_n135_), .b(new_n90_), .c(x30), .O(new_n141_));
  nor3   g090(.a(x30), .b(x29), .c(x28), .O(new_n142_));
  nand4  g091(.a(new_n142_), .b(new_n116_), .c(new_n91_), .d(new_n72_), .O(new_n143_));
  nand2  g092(.a(new_n143_), .b(new_n141_), .O(new_n144_));
  nand2  g093(.a(new_n144_), .b(new_n58_), .O(new_n145_));
  oai21  g094(.a(x16), .b(x04), .c(new_n52_), .O(new_n146_));
  aoi21  g095(.a(new_n65_), .b(x30), .c(new_n146_), .O(new_n147_));
  nand2  g096(.a(new_n147_), .b(new_n145_), .O(z11));
  nand4  g097(.a(new_n115_), .b(new_n63_), .c(new_n78_), .d(new_n70_), .O(new_n149_));
  ...
  oai21  g103(.a(x16), .b(x03), .c(new_n52_), .O(new_n155_));
  aoi21  g104(.a(new_n65_), .b(x31), .c(new_n155_), .O(new_n156_));
  oai21  g105(.a(new_n154_), .b(x19), .c(new_n156_), .O(z12));
  ...
  nand4  g115(.a(new_n166_), .b(new_n130_), .c(new_n160_), .d(new_n72_), .O(new_n167_));
  nand2  g116(.a(new_n167_), .b(new_n158_), .O(new_n168_));
  nand2  g117(.a(new_n168_), .b(new_n58_), .O(new_n169_));
  oai21  g118(.a(x16), .b(x02), .c(new_n52_), .O(new_n170_));
  aoi21  g119(.a(new_n65_), .b(x32), .c(new_n170_), .O(new_n171_));
  ...
  nand4  g131(.a(new_n182_), .b(new_n179_), .c(new_n160_), .d(new_n72_), .O(new_n183_));
  nand2  g132(.a(new_n183_), .b(new_n176_), .O(new_n184_));
  nand2  g133(.a(new_n184_), .b(new_n58_), .O(new_n185_));
  oai21  g134(.a(x16), .b(x01), .c(new_n52_), .O(new_n186_));
  aoi21  g135(.a(new_n65_), .b(x33), .c(new_n186_), .O(new_n187_));
  ...
  oai21  g146(.a(x16), .b(x00), .c(new_n52_), .O(new_n198_));
  aoi21  g147(.a(new_n65_), .b(x34), .c(new_n198_), .O(new_n199_));
