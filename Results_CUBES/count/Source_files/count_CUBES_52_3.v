...
module FAU ( 
  ...
  nor2   g142(.a(new_n64_), .b(new_n193_), .O(new_n194_));
  oai21  g143(.a(new_n194_), .b(new_n192_), .c(x16), .O(new_n195_));
  inv1   g144(.a(x02), .O(new_n196_));
  aoi21  g145(.a(new_n58_), .b(new_n196_), .c(x18), .O(new_n197_));
  nand2  g146(.a(new_n197_), .b(new_n195_), .O(z13));
  oai21  g147(.a(new_n190_), .b(new_n116_), .c(new_n53_), .O(new_n199_));
  aoi21  g148(.a(new_n199_), .b(new_n64_), .c(new_n184_), .O(new_n200_));
  nand2  g149(.a(new_n152_), .b(new_n132_), .O(new_n201_));
  nor2   g150(.a(x33), .b(x32), .O(new_n202_));
  nand2  g151(.a(new_n202_), .b(new_n175_), .O(new_n203_));
  nor3   g152(.a(new_n203_), .b(new_n201_), .c(new_n108_), .O(new_n204_));
  ...
  nand4  g158(.a(new_n175_), .b(new_n152_), .c(new_n193_), .d(new_n125_), .O(new_n210_));
  oai21  g159(.a(new_n210_), .b(new_n128_), .c(new_n53_), .O(new_n211_));
  nand3  g160(.a(new_n55_), .b(new_n184_), .c(new_n61_), .O(new_n212_));
  inv1   g161(.a(new_n212_), .O(new_n213_));
  aoi21  g162(.a(new_n213_), .b(new_n211_), .c(new_n209_), .O(new_n214_));
  nand3  g163(.a(new_n202_), .b(new_n175_), .c(new_n209_), .O(new_n215_));
  nor3   g164(.a(new_n215_), .b(new_n201_), .c(new_n108_), .O(new_n216_));
