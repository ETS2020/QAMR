...
module FAU ( 
  ...
  nand2  g073(.a(new_n75_), .b(new_n61_), .O(new_n125_));
  ...
  nand3  g133(.a(new_n177_), .b(new_n149_), .c(new_n148_), .O(new_n185_));
  oai21  g134(.a(new_n185_), .b(new_n115_), .c(new_n100_), .O(new_n186_));
  aoi21  g135(.a(new_n186_), .b(new_n139_), .c(new_n184_), .O(new_n187_));
  nand2  g136(.a(new_n141_), .b(new_n127_), .O(new_n188_));
  nor2   g137(.a(x32), .b(x31), .O(new_n189_));
  nand2  g138(.a(new_n189_), .b(new_n165_), .O(new_n190_));
  nor3   g139(.a(new_n190_), .b(new_n188_), .c(new_n93_), .O(new_n191_));
  ...
  nor3   g145(.a(x33), .b(x32), .c(x31), .O(new_n197_));
  aoi21  g146(.a(new_n197_), .b(new_n196_), .c(x27), .O(new_n198_));
  nand4  g147(.a(new_n127_), .b(new_n92_), .c(new_n76_), .d(new_n75_), .O(new_n199_));
  nor2   g148(.a(x30), .b(x26), .O(new_n200_));
  nand3  g149(.a(new_n200_), .b(new_n189_), .c(new_n154_), .O(new_n201_));
  oai21  g150(.a(new_n201_), .b(new_n115_), .c(x33), .O(new_n202_));
  oai21  g151(.a(new_n199_), .b(new_n198_), .c(new_n202_), .O(new_n203_));
  inv1   g152(.a(x33), .O(new_n204_));
  nor2   g153(.a(new_n61_), .b(new_n204_), .O(new_n205_));
  aoi21  g154(.a(new_n203_), .b(new_n100_), .c(new_n205_), .O(new_n206_));
  inv1   g155(.a(x01), .O(new_n207_));
  aoi21  g156(.a(new_n56_), .b(new_n207_), .c(x18), .O(new_n208_));
  oai21  g157(.a(new_n206_), .b(new_n56_), .c(new_n208_), .O(z14));
  inv1   g158(.a(x34), .O(new_n210_));
  nand4  g159(.a(new_n189_), .b(new_n165_), .c(new_n204_), .d(new_n134_), .O(new_n211_));
  oai21  g160(.a(new_n211_), .b(new_n136_), .c(new_n100_), .O(new_n212_));
  aoi21  g161(.a(new_n212_), .b(new_n61_), .c(new_n210_), .O(new_n213_));
  nand3  g162(.a(new_n149_), .b(new_n210_), .c(new_n204_), .O(new_n214_));
  nor4   g163(.a(new_n214_), .b(new_n190_), .c(new_n106_), .d(new_n68_), .O(new_n215_));
