// Benchmark "FAU" written by ABC on Mon Jul  6 14:18:54 2020
...
module FAU ( 
  ...
  nand4  g131(.a(new_n182_), .b(new_n113_), .c(new_n57_), .d(new_n65_), .O(new_n183_));
  ...
  inv1   g136(.a(x18), .O(new_n188_));
  oai21  g137(.a(x16), .b(x02), .c(new_n188_), .O(new_n189_));
  aoi21  g138(.a(x32), .b(x19), .c(new_n189_), .O(new_n190_));
  oai21  g139(.a(new_n187_), .b(new_n52_), .c(new_n190_), .O(z13));
  inv1   g140(.a(x30), .O(new_n192_));
  nand2  g141(.a(new_n184_), .b(new_n192_), .O(new_n193_));
  nor2   g142(.a(new_n193_), .b(new_n151_), .O(new_n194_));
  nand4  g143(.a(new_n194_), .b(new_n124_), .c(new_n66_), .d(new_n65_), .O(new_n195_));
  nand2  g144(.a(new_n150_), .b(new_n128_), .O(new_n196_));
  nor2   g145(.a(x33), .b(x32), .O(new_n197_));
  nand2  g146(.a(new_n197_), .b(new_n173_), .O(new_n198_));
  ...
  nor2   g152(.a(new_n198_), .b(new_n151_), .O(new_n204_));
  nand4  g153(.a(new_n204_), .b(new_n124_), .c(new_n66_), .d(new_n65_), .O(new_n205_));
  inv1   g154(.a(x34), .O(new_n206_));
  nand3  g155(.a(new_n197_), .b(new_n173_), .c(new_n206_), .O(new_n207_));
