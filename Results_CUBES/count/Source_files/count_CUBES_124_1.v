...
module FAU ( 
  ...
  oai21  g044(.a(new_n91_), .b(x24), .c(x16), .O(new_n96_));
  ...
  nand3  g062(.a(new_n113_), .b(new_n87_), .c(new_n71_), .O(new_n114_));
  ...
  nand4  g094(.a(new_n138_), .b(new_n113_), .c(new_n87_), .d(new_n69_), .O(new_n146_));
  ...
  nand4  g104(.a(new_n148_), .b(new_n133_), .c(new_n101_), .d(new_n77_), .O(new_n156_));
  ...
  nand3  g115(.a(new_n133_), .b(new_n101_), .c(new_n77_), .O(new_n167_));
