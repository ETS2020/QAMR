...
module FAU ( 
  ...
  nand3  g081(.a(new_n77_), .b(new_n55_), .c(new_n61_), .O(new_n133_));
  ...
  nand2  g090(.a(new_n134_), .b(new_n109_), .O(new_n142_));
  oai21  g091(.a(new_n142_), .b(new_n88_), .c(new_n53_), .O(new_n143_));
  aoi21  g092(.a(new_n143_), .b(new_n64_), .c(new_n141_), .O(new_n144_));
  nor2   g093(.a(x28), .b(x27), .O(new_n145_));
  nand4  g094(.a(new_n145_), .b(new_n109_), .c(new_n116_), .d(new_n117_), .O(new_n146_));
  ...
  nand4  g100(.a(new_n77_), .b(new_n55_), .c(new_n61_), .d(x16), .O(new_n152_));
  inv1   g101(.a(x05), .O(new_n153_));
  aoi21  g102(.a(new_n58_), .b(new_n153_), .c(x18), .O(new_n154_));
  oai21  g103(.a(new_n152_), .b(new_n146_), .c(new_n154_), .O(z10));
  inv1   g104(.a(x30), .O(new_n156_));
  nand4  g105(.a(new_n145_), .b(new_n129_), .c(new_n97_), .d(new_n77_), .O(new_n157_));
  aoi21  g106(.a(new_n157_), .b(new_n53_), .c(new_n63_), .O(new_n158_));
  nor2   g107(.a(x30), .b(x28), .O(new_n159_));
  nand3  g108(.a(new_n159_), .b(new_n120_), .c(new_n127_), .O(new_n160_));
  oai22  g109(.a(new_n160_), .b(new_n90_), .c(new_n158_), .d(new_n156_), .O(new_n161_));
  ...
  nand2  g115(.a(new_n159_), .b(new_n127_), .O(new_n167_));
  nand3  g116(.a(new_n129_), .b(new_n97_), .c(new_n77_), .O(new_n168_));
  ...
  nand3  g120(.a(new_n171_), .b(new_n145_), .c(new_n120_), .O(new_n172_));
  nor2   g121(.a(new_n172_), .b(new_n90_), .O(new_n173_));
  ...
  nand3  g127(.a(new_n171_), .b(new_n134_), .c(new_n141_), .O(new_n179_));
  oai21  g128(.a(new_n179_), .b(new_n118_), .c(new_n53_), .O(new_n180_));
  aoi21  g129(.a(new_n180_), .b(new_n64_), .c(new_n178_), .O(new_n181_));
  nor2   g130(.a(x32), .b(x31), .O(new_n182_));
  nand4  g131(.a(new_n182_), .b(new_n159_), .c(new_n134_), .d(new_n106_), .O(new_n183_));
  ...
  nand4  g138(.a(new_n182_), .b(new_n145_), .c(new_n156_), .d(new_n116_), .O(new_n190_));
  oai21  g139(.a(new_n190_), .b(new_n118_), .c(new_n53_), .O(new_n191_));
  aoi21  g140(.a(new_n191_), .b(new_n64_), .c(new_n189_), .O(new_n192_));
  nor2   g141(.a(x33), .b(x32), .O(new_n193_));
  nand4  g142(.a(new_n193_), .b(new_n171_), .c(new_n145_), .d(new_n129_), .O(new_n194_));
  ...
  nand4  g149(.a(new_n193_), .b(new_n159_), .c(new_n166_), .d(new_n127_), .O(new_n201_));
  oai21  g150(.a(new_n201_), .b(new_n130_), .c(new_n53_), .O(new_n202_));
  aoi21  g151(.a(new_n202_), .b(new_n64_), .c(new_n200_), .O(new_n203_));
  nand2  g152(.a(new_n182_), .b(new_n159_), .O(new_n204_));
  nand3  g153(.a(new_n134_), .b(new_n200_), .c(new_n189_), .O(new_n205_));
  nor2   g154(.a(new_n205_), .b(new_n204_), .O(new_n206_));
  and2   g155(.a(new_n206_), .b(new_n111_), .O(new_n207_));
