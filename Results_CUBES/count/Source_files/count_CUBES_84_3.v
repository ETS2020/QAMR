...
module FAU ( 
  ...
  nand4  g119(.a(new_n170_), .b(new_n113_), .c(new_n57_), .d(new_n65_), .O(new_n171_));
  ...
  inv1   g125(.a(x18), .O(new_n177_));
  oai21  g126(.a(x16), .b(x03), .c(new_n177_), .O(new_n178_));
  aoi21  g127(.a(x31), .b(x19), .c(new_n178_), .O(new_n179_));
  oai21  g128(.a(new_n176_), .b(new_n52_), .c(new_n179_), .O(z12));
  inv1   g129(.a(x29), .O(new_n181_));
  nand2  g130(.a(new_n173_), .b(new_n181_), .O(new_n182_));
  ...
  nand4  g134(.a(new_n185_), .b(new_n160_), .c(new_n139_), .d(new_n116_), .O(new_n186_));
  nor2   g135(.a(new_n186_), .b(new_n172_), .O(new_n187_));
