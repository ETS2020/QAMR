...
module FAU ( 
  ...
  nand4  g108(.a(new_n159_), .b(new_n122_), .c(new_n93_), .d(new_n63_), .O(new_n160_));
  ...
  nand4  g116(.a(new_n167_), .b(new_n166_), .c(new_n115_), .d(new_n100_), .O(new_n168_));
  oai21  g117(.a(new_n168_), .b(new_n99_), .c(x33), .O(new_n169_));
  ...
  nand4  g122(.a(new_n173_), .b(new_n157_), .c(new_n124_), .d(new_n100_), .O(new_n174_));
  inv1   g123(.a(new_n174_), .O(new_n175_));
  nand4  g124(.a(new_n175_), .b(new_n172_), .c(new_n93_), .d(new_n63_), .O(new_n176_));
  ...
  nand4  g131(.a(new_n182_), .b(new_n142_), .c(new_n126_), .d(new_n141_), .O(new_n183_));
  oai21  g132(.a(new_n183_), .b(new_n99_), .c(x34), .O(new_n184_));
  inv1   g133(.a(x34), .O(new_n185_));
  nand4  g134(.a(new_n185_), .b(new_n173_), .c(new_n170_), .d(new_n124_), .O(new_n186_));
  inv1   g135(.a(new_n186_), .O(new_n187_));
  nand4  g136(.a(new_n187_), .b(new_n159_), .c(new_n102_), .d(new_n71_), .O(new_n188_));
