...
module FAU ( 
  ...
  nand2  g119(.a(new_n130_), .b(new_n170_), .O(new_n171_));
  nor2   g120(.a(new_n171_), .b(new_n169_), .O(new_n172_));
  nand4  g121(.a(new_n172_), .b(new_n115_), .c(new_n63_), .d(new_n52_), .O(new_n173_));
  nor2   g122(.a(x31), .b(x30), .O(new_n174_));
  nand4  g123(.a(new_n174_), .b(new_n152_), .c(new_n130_), .d(new_n129_), .O(new_n175_));
  nor3   g124(.a(new_n175_), .b(new_n97_), .c(new_n64_), .O(new_n176_));
  ...
  nand4  g129(.a(new_n96_), .b(new_n70_), .c(new_n79_), .d(new_n52_), .O(new_n181_));
  oai21  g130(.a(new_n181_), .b(new_n175_), .c(x32), .O(new_n182_));
  nand2  g131(.a(new_n105_), .b(new_n87_), .O(new_n183_));
  inv1   g132(.a(new_n183_), .O(new_n184_));
  nor2   g133(.a(x32), .b(x31), .O(new_n185_));
  nand2  g134(.a(new_n70_), .b(new_n52_), .O(new_n186_));
  nor2   g135(.a(new_n186_), .b(new_n142_), .O(new_n187_));
  nand4  g136(.a(new_n187_), .b(new_n185_), .c(new_n162_), .d(new_n184_), .O(new_n188_));
  ...
  nand3  g142(.a(new_n193_), .b(new_n191_), .c(new_n190_), .O(z13));
  inv1   g143(.a(x30), .O(new_n195_));
  nand2  g144(.a(new_n185_), .b(new_n195_), .O(new_n196_));
  nor2   g145(.a(new_n196_), .b(new_n153_), .O(new_n197_));
  nand4  g146(.a(new_n197_), .b(new_n126_), .c(new_n63_), .d(new_n52_), .O(new_n198_));
  nand2  g147(.a(new_n152_), .b(new_n130_), .O(new_n199_));
  nor2   g148(.a(x33), .b(x32), .O(new_n200_));
  nand2  g149(.a(new_n200_), .b(new_n174_), .O(new_n201_));
  ...
  nor2   g155(.a(new_n201_), .b(new_n153_), .O(new_n207_));
  nand4  g156(.a(new_n207_), .b(new_n126_), .c(new_n63_), .d(new_n52_), .O(new_n208_));
  inv1   g157(.a(x34), .O(new_n209_));
  nand3  g158(.a(new_n200_), .b(new_n174_), .c(new_n209_), .O(new_n210_));
