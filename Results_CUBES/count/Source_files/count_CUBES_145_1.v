...
module FAU ( 
  ...
  oai21  g064(.a(new_n111_), .b(x26), .c(x16), .O(new_n116_));
  ...
  nand3  g070(.a(new_n109_), .b(new_n77_), .c(new_n121_), .O(new_n122_));
  aoi21  g071(.a(new_n122_), .b(new_n53_), .c(new_n63_), .O(new_n123_));
  nor3   g072(.a(x27), .b(x25), .c(x24), .O(new_n124_));
  nand3  g073(.a(new_n124_), .b(new_n87_), .c(new_n71_), .O(new_n125_));
  ...
  nand4  g082(.a(new_n133_), .b(new_n87_), .c(new_n132_), .d(new_n69_), .O(new_n134_));
  ...
  nand4  g094(.a(new_n138_), .b(new_n109_), .c(new_n87_), .d(new_n69_), .O(new_n146_));
  aoi21  g095(.a(new_n146_), .b(new_n53_), .c(new_n63_), .O(new_n147_));
  nor2   g096(.a(x29), .b(x28), .O(new_n148_));
  nand4  g097(.a(new_n148_), .b(new_n109_), .c(new_n120_), .d(new_n121_), .O(new_n149_));
