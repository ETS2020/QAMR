...
module FAU ( 
  ...
  nand4  g024(.a(new_n75_), .b(new_n67_), .c(new_n61_), .d(new_n52_), .O(new_n76_));
  ...
  aoi22  g031(.a(new_n82_), .b(new_n66_), .c(new_n76_), .d(x23), .O(new_n83_));
  inv1   g032(.a(x11), .O(new_n84_));
  aoi21  g033(.a(new_n58_), .b(new_n84_), .c(x18), .O(new_n85_));
  oai21  g034(.a(new_n83_), .b(new_n58_), .c(new_n85_), .O(z04));
  nand3  g035(.a(new_n82_), .b(new_n68_), .c(new_n67_), .O(new_n87_));
  nor3   g036(.a(x24), .b(x23), .c(x22), .O(new_n88_));
  aoi22  g037(.a(new_n88_), .b(new_n66_), .c(new_n87_), .d(x24), .O(new_n89_));
  ...
  aoi21  g042(.a(new_n88_), .b(new_n66_), .c(new_n93_), .O(new_n94_));
  nor2   g043(.a(x25), .b(x24), .O(new_n95_));
  nand4  g044(.a(new_n95_), .b(new_n82_), .c(new_n68_), .d(new_n67_), .O(new_n96_));
  ...
  nand4  g076(.a(new_n127_), .b(new_n95_), .c(new_n82_), .d(new_n66_), .O(new_n128_));
  ...
  nand4  g088(.a(new_n139_), .b(new_n113_), .c(new_n88_), .d(new_n66_), .O(new_n140_));
  ...
  nand4  g094(.a(new_n112_), .b(new_n68_), .c(new_n75_), .d(new_n67_), .O(new_n146_));
  ...
  nand4  g112(.a(new_n163_), .b(new_n127_), .c(new_n157_), .d(new_n66_), .O(new_n164_));
  ...
  nand4  g128(.a(new_n179_), .b(new_n176_), .c(new_n157_), .d(new_n66_), .O(new_n180_));
