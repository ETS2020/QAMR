// Benchmark "FAU" written by ABC on Mon Jul  6 14:18:40 2020
...
module FAU ( 
  ...
  oai21  g070(.a(new_n116_), .b(new_n113_), .c(new_n121_), .O(new_n122_));
  ...
  nand4  g076(.a(new_n118_), .b(new_n87_), .c(new_n117_), .d(new_n86_), .O(new_n128_));
  nand2  g077(.a(new_n128_), .b(new_n53_), .O(new_n129_));
  aoi21  g078(.a(new_n129_), .b(new_n64_), .c(new_n127_), .O(new_n130_));
  ...
  nand4  g088(.a(new_n132_), .b(new_n106_), .c(new_n87_), .d(new_n86_), .O(new_n140_));
  aoi21  g089(.a(new_n140_), .b(new_n53_), .c(new_n63_), .O(new_n141_));
  nor2   g090(.a(x28), .b(x27), .O(new_n142_));
  nand4  g091(.a(new_n142_), .b(new_n106_), .c(new_n113_), .d(new_n114_), .O(new_n143_));
  ...
  nand4  g098(.a(new_n142_), .b(new_n118_), .c(new_n96_), .d(new_n77_), .O(new_n150_));
  aoi21  g099(.a(new_n150_), .b(new_n53_), .c(new_n63_), .O(new_n151_));
  nor3   g100(.a(x29), .b(x28), .c(x27), .O(new_n152_));
  nand3  g101(.a(new_n152_), .b(new_n120_), .c(new_n89_), .O(new_n153_));
  ...
  nand3  g108(.a(new_n152_), .b(new_n118_), .c(new_n98_), .O(new_n160_));
  ...
  nor2   g112(.a(new_n163_), .b(new_n119_), .O(new_n164_));
  inv1   g113(.a(x18), .O(new_n165_));
  nand2  g114(.a(new_n165_), .b(x16), .O(new_n166_));
  aoi21  g115(.a(new_n164_), .b(new_n89_), .c(new_n166_), .O(new_n167_));
  oai21  g116(.a(new_n161_), .b(new_n159_), .c(new_n167_), .O(z11));
  inv1   g117(.a(x31), .O(new_n169_));
  nand3  g118(.a(new_n162_), .b(new_n132_), .c(new_n139_), .O(new_n170_));
  oai21  g119(.a(new_n170_), .b(new_n115_), .c(new_n53_), .O(new_n171_));
  aoi21  g120(.a(new_n171_), .b(new_n64_), .c(new_n169_), .O(new_n172_));
  nand2  g121(.a(new_n98_), .b(new_n64_), .O(new_n173_));
  nor2   g122(.a(x29), .b(x28), .O(new_n174_));
  nor2   g123(.a(x31), .b(x30), .O(new_n175_));
  nand4  g124(.a(new_n175_), .b(new_n174_), .c(new_n132_), .d(new_n103_), .O(new_n176_));
  nor2   g125(.a(new_n176_), .b(new_n173_), .O(new_n177_));
  oai21  g126(.a(new_n177_), .b(new_n172_), .c(x16), .O(new_n178_));
  ...
  nand4  g131(.a(new_n175_), .b(new_n142_), .c(new_n149_), .d(new_n113_), .O(new_n183_));
  ...
  nand4  g135(.a(new_n186_), .b(new_n162_), .c(new_n142_), .d(new_n118_), .O(new_n187_));
  nor2   g136(.a(new_n187_), .b(new_n173_), .O(new_n188_));
  ...
  nand4  g142(.a(new_n186_), .b(new_n174_), .c(new_n159_), .d(new_n127_), .O(new_n194_));
  oai21  g143(.a(new_n194_), .b(new_n128_), .c(new_n53_), .O(new_n195_));
  aoi21  g144(.a(new_n195_), .b(new_n64_), .c(new_n193_), .O(new_n196_));
  nand2  g145(.a(new_n174_), .b(new_n132_), .O(new_n197_));
  nor2   g146(.a(x33), .b(x32), .O(new_n198_));
  nand2  g147(.a(new_n198_), .b(new_n175_), .O(new_n199_));
  nor3   g148(.a(new_n199_), .b(new_n197_), .c(new_n107_), .O(new_n200_));
  ...
  nand4  g154(.a(new_n198_), .b(new_n175_), .c(new_n174_), .d(new_n127_), .O(new_n206_));
  oai21  g155(.a(new_n206_), .b(new_n128_), .c(new_n53_), .O(new_n207_));
  aoi21  g156(.a(new_n207_), .b(new_n64_), .c(new_n205_), .O(new_n208_));
  nand3  g157(.a(new_n198_), .b(new_n175_), .c(new_n205_), .O(new_n209_));
  nor3   g158(.a(new_n209_), .b(new_n197_), .c(new_n107_), .O(new_n210_));
