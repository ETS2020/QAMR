...
module FAU ( 
  ...
  nand4  g124(.a(new_n175_), .b(new_n152_), .c(new_n132_), .d(new_n103_), .O(new_n176_));
  ...
  aoi21  g133(.a(new_n184_), .b(new_n63_), .c(new_n182_), .O(new_n185_));
  nand4  g134(.a(new_n139_), .b(new_n125_), .c(new_n114_), .d(new_n103_), .O(new_n186_));
  nor2   g135(.a(x32), .b(x31), .O(new_n187_));
  nand2  g136(.a(new_n187_), .b(new_n164_), .O(new_n188_));
  nor3   g137(.a(new_n188_), .b(new_n186_), .c(new_n97_), .O(new_n189_));
  ...
  nand4  g142(.a(new_n96_), .b(new_n77_), .c(new_n61_), .d(new_n52_), .O(new_n194_));
  inv1   g143(.a(new_n194_), .O(new_n195_));
  inv1   g144(.a(x34), .O(new_n196_));
  nand2  g145(.a(new_n196_), .b(x32), .O(new_n197_));
  inv1   g146(.a(x33), .O(new_n198_));
  nand4  g147(.a(new_n198_), .b(new_n171_), .c(new_n159_), .d(new_n149_), .O(new_n199_));
  nor2   g148(.a(new_n199_), .b(new_n186_), .O(new_n200_));
  nand3  g149(.a(new_n200_), .b(new_n197_), .c(new_n195_), .O(new_n201_));
  nand4  g150(.a(new_n187_), .b(new_n152_), .c(new_n159_), .d(new_n125_), .O(new_n202_));
  oai21  g151(.a(new_n202_), .b(new_n128_), .c(x33), .O(new_n203_));
  aoi21  g152(.a(new_n203_), .b(new_n201_), .c(x19), .O(new_n204_));
  nor2   g153(.a(new_n63_), .b(new_n198_), .O(new_n205_));
  ...
  nand4  g158(.a(new_n175_), .b(new_n152_), .c(new_n198_), .d(new_n125_), .O(new_n210_));
  oai21  g159(.a(new_n210_), .b(new_n128_), .c(new_n53_), .O(new_n211_));
  aoi21  g160(.a(new_n211_), .b(new_n63_), .c(new_n196_), .O(new_n212_));
  nand2  g161(.a(new_n175_), .b(new_n198_), .O(new_n213_));
  nor2   g162(.a(x34), .b(x32), .O(new_n214_));
  nand3  g163(.a(new_n214_), .b(new_n152_), .c(new_n132_), .O(new_n215_));
  nor4   g164(.a(new_n215_), .b(new_n213_), .c(new_n108_), .d(new_n70_), .O(new_n216_));
