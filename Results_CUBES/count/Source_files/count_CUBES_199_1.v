...
module FAU ( 
  ...
  oai21  g092(.a(new_n139_), .b(x29), .c(x16), .O(new_n144_));
  ...
  nand2  g097(.a(new_n137_), .b(new_n148_), .O(new_n149_));
  ...
  nand4  g117(.a(new_n168_), .b(new_n137_), .c(new_n148_), .d(new_n110_), .O(new_n169_));
  ...
  nand4  g142(.a(new_n193_), .b(new_n168_), .c(new_n137_), .d(new_n148_), .O(new_n194_));
