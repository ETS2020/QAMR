...
module FAU ( 
  ...
  nand4  g085(.a(new_n136_), .b(new_n92_), .c(new_n57_), .d(new_n65_), .O(new_n137_));
  ...
  inv1   g091(.a(x18), .O(new_n143_));
  oai21  g092(.a(x16), .b(x06), .c(new_n143_), .O(new_n144_));
  aoi21  g093(.a(x28), .b(x19), .c(new_n144_), .O(new_n145_));
  oai21  g094(.a(new_n142_), .b(new_n52_), .c(new_n145_), .O(z09));
  nand2  g095(.a(new_n139_), .b(new_n116_), .O(new_n147_));
  ...
  nor2   g101(.a(new_n152_), .b(new_n117_), .O(new_n153_));
  ...
  nand3  g106(.a(new_n116_), .b(new_n94_), .c(new_n74_), .O(new_n158_));
  nor2   g107(.a(new_n158_), .b(new_n152_), .O(new_n159_));
  nand3  g108(.a(new_n159_), .b(new_n66_), .c(new_n65_), .O(new_n160_));
  nor2   g109(.a(x30), .b(x29), .O(new_n161_));
  nand4  g110(.a(new_n161_), .b(new_n139_), .c(new_n116_), .d(new_n115_), .O(new_n162_));
  ...
  nand2  g118(.a(new_n128_), .b(new_n169_), .O(new_n170_));
  ...
  nand4  g123(.a(new_n174_), .b(new_n151_), .c(new_n128_), .d(new_n127_), .O(new_n175_));
  ...
  nor2   g131(.a(new_n182_), .b(new_n140_), .O(new_n183_));
  nand4  g132(.a(new_n183_), .b(new_n113_), .c(new_n66_), .d(new_n65_), .O(new_n184_));
  nor2   g133(.a(x32), .b(x31), .O(new_n185_));
  nand4  g134(.a(new_n185_), .b(new_n161_), .c(new_n139_), .d(new_n116_), .O(new_n186_));
  ...
  nand4  g143(.a(new_n194_), .b(new_n124_), .c(new_n66_), .d(new_n65_), .O(new_n195_));
  nand2  g144(.a(new_n151_), .b(new_n128_), .O(new_n196_));
  ...
  nand4  g153(.a(new_n204_), .b(new_n124_), .c(new_n66_), .d(new_n65_), .O(new_n205_));
  inv1   g154(.a(x34), .O(new_n206_));
  nand3  g155(.a(new_n197_), .b(new_n174_), .c(new_n206_), .O(new_n207_));
  nor3   g156(.a(new_n207_), .b(new_n196_), .c(new_n104_), .O(new_n208_));
