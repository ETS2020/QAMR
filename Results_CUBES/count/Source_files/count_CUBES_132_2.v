...
module FAU ( 
  ...
  nand4  g088(.a(new_n139_), .b(new_n105_), .c(new_n138_), .d(new_n95_), .O(new_n140_));
  inv1   g089(.a(x27), .O(new_n141_));
  nor2   g090(.a(x26), .b(x25), .O(new_n142_));
  nor2   g091(.a(x29), .b(x28), .O(new_n143_));
  nand4  g092(.a(new_n143_), .b(new_n142_), .c(new_n141_), .d(new_n114_), .O(new_n144_));
  nor2   g093(.a(new_n144_), .b(new_n96_), .O(new_n145_));
  aoi21  g094(.a(new_n140_), .b(x29), .c(new_n145_), .O(new_n146_));
  ...
  nand4  g100(.a(new_n151_), .b(new_n124_), .c(new_n98_), .d(new_n97_), .O(new_n152_));
  ...
  nand4  g106(.a(new_n123_), .b(new_n70_), .c(new_n76_), .d(new_n52_), .O(new_n158_));
  nor2   g107(.a(x27), .b(x26), .O(new_n159_));
  nor2   g108(.a(x31), .b(x30), .O(new_n160_));
  nand4  g109(.a(new_n160_), .b(new_n143_), .c(new_n159_), .d(new_n103_), .O(new_n161_));
  nor2   g110(.a(new_n161_), .b(new_n158_), .O(new_n162_));
  aoi21  g111(.a(new_n152_), .b(x31), .c(new_n162_), .O(new_n163_));
  ...
  oai21  g115(.a(new_n161_), .b(new_n158_), .c(x32), .O(new_n167_));
  nand4  g116(.a(new_n103_), .b(new_n114_), .c(new_n88_), .d(new_n76_), .O(new_n168_));
  ...
  nand4  g124(.a(new_n175_), .b(new_n139_), .c(new_n169_), .d(new_n97_), .O(new_n176_));
  ...
  nand4  g132(.a(new_n183_), .b(new_n182_), .c(new_n131_), .d(new_n115_), .O(new_n184_));
  ...
  nand4  g138(.a(new_n189_), .b(new_n173_), .c(new_n141_), .d(new_n115_), .O(new_n190_));
  inv1   g139(.a(new_n190_), .O(new_n191_));
  nand4  g140(.a(new_n191_), .b(new_n188_), .c(new_n169_), .d(new_n97_), .O(new_n192_));
  ...
  nand4  g147(.a(new_n198_), .b(new_n160_), .c(new_n143_), .d(new_n159_), .O(new_n199_));
  oai21  g148(.a(new_n199_), .b(new_n106_), .c(x34), .O(new_n200_));
  inv1   g149(.a(x34), .O(new_n201_));
  nand4  g150(.a(new_n201_), .b(new_n189_), .c(new_n186_), .d(new_n141_), .O(new_n202_));
  inv1   g151(.a(new_n202_), .O(new_n203_));
  nand4  g152(.a(new_n203_), .b(new_n175_), .c(new_n117_), .d(new_n113_), .O(new_n204_));
