...
module FAU ( 
  ...
  nand3  g073(.a(new_n124_), .b(new_n57_), .c(new_n65_), .O(new_n125_));
  ...
  oai21  g081(.a(x16), .b(x07), .c(new_n132_), .O(new_n133_));
  aoi21  g082(.a(x27), .b(x19), .c(new_n133_), .O(new_n134_));
  oai21  g083(.a(new_n131_), .b(new_n52_), .c(new_n134_), .O(z08));
  nand2  g084(.a(new_n128_), .b(new_n103_), .O(new_n136_));
  ...
  nor3   g090(.a(new_n141_), .b(new_n126_), .c(new_n112_), .O(new_n142_));
