...
module FAU ( 
  ...
  inv1   g122(.a(x18), .O(new_n174_));
  inv1   g123(.a(x31), .O(new_n175_));
  nand3  g124(.a(new_n167_), .b(new_n135_), .c(new_n142_), .O(new_n176_));
  oai21  g125(.a(new_n176_), .b(new_n119_), .c(new_n53_), .O(new_n177_));
  aoi21  g126(.a(new_n177_), .b(new_n64_), .c(new_n175_), .O(new_n178_));
  nor2   g127(.a(x31), .b(x30), .O(new_n179_));
  nand4  g128(.a(new_n179_), .b(new_n155_), .c(new_n135_), .d(new_n107_), .O(new_n180_));
  ...
  nand4  g133(.a(new_n179_), .b(new_n145_), .c(new_n152_), .d(new_n117_), .O(new_n185_));
  ...
  nand4  g137(.a(new_n188_), .b(new_n167_), .c(new_n145_), .d(new_n130_), .O(new_n189_));
  ...
  nand4  g144(.a(new_n188_), .b(new_n155_), .c(new_n162_), .d(new_n128_), .O(new_n196_));
  ...
  nand4  g156(.a(new_n200_), .b(new_n179_), .c(new_n155_), .d(new_n128_), .O(new_n208_));
  oai21  g157(.a(new_n208_), .b(new_n131_), .c(new_n53_), .O(new_n209_));
  aoi21  g158(.a(new_n209_), .b(new_n64_), .c(new_n207_), .O(new_n210_));
  nand3  g159(.a(new_n200_), .b(new_n179_), .c(new_n207_), .O(new_n211_));
