...
module FAU ( 
  ...
  nand2  g012(.a(new_n55_), .b(new_n62_), .O(new_n64_));
  ...
  nand3  g025(.a(new_n76_), .b(new_n62_), .c(new_n52_), .O(new_n77_));
  ...
  oai21  g033(.a(new_n76_), .b(x19), .c(new_n65_), .O(new_n85_));
  ...
  oai21  g044(.a(new_n89_), .b(x19), .c(new_n65_), .O(new_n96_));
  ...
  nand4  g058(.a(new_n109_), .b(new_n87_), .c(new_n68_), .d(new_n55_), .O(new_n110_));
  ...
  aoi21  g067(.a(new_n118_), .b(new_n53_), .c(new_n64_), .O(new_n119_));
  ...
  aoi21  g080(.a(new_n131_), .b(new_n65_), .c(new_n127_), .O(new_n132_));
  nand2  g081(.a(new_n76_), .b(new_n65_), .O(new_n133_));
  ...
  aoi21  g091(.a(new_n142_), .b(new_n53_), .c(new_n64_), .O(new_n143_));
  ...
  aoi21  g113(.a(new_n164_), .b(new_n65_), .c(new_n161_), .O(new_n165_));
  ...
  aoi21  g124(.a(new_n175_), .b(new_n65_), .c(new_n173_), .O(new_n176_));
  ...
  aoi21  g158(.a(new_n209_), .b(new_n65_), .c(new_n207_), .O(new_n210_));
