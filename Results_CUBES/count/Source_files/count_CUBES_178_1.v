...
module FAU ( 
  ...
  oai21  g119(.a(new_n166_), .b(x31), .c(x16), .O(new_n171_));
  ...
  nand3  g125(.a(new_n157_), .b(new_n149_), .c(new_n115_), .O(new_n177_));
  ...
  nor2   g129(.a(x32), .b(x30), .O(new_n181_));
  nand4  g130(.a(new_n181_), .b(new_n150_), .c(new_n127_), .d(new_n111_), .O(new_n182_));
  ...
  nand3  g138(.a(new_n189_), .b(new_n175_), .c(new_n158_), .O(new_n190_));
  ...
  nand4  g153(.a(new_n204_), .b(new_n181_), .c(new_n150_), .d(new_n127_), .O(new_n205_));
