...
module FAU ( 
  ...
  nor2   g026(.a(x23), .b(new_n53_), .O(new_n78_));
  nand2  g027(.a(new_n69_), .b(new_n77_), .O(new_n79_));
  oai22  g028(.a(new_n79_), .b(new_n78_), .c(new_n77_), .d(new_n76_), .O(new_n80_));
  aoi22  g029(.a(new_n80_), .b(new_n52_), .c(new_n68_), .d(x22), .O(new_n81_));
  ...
  aoi21  g036(.a(new_n87_), .b(new_n86_), .c(new_n85_), .O(new_n88_));
  nor2   g037(.a(x23), .b(x22), .O(new_n89_));
  nand3  g038(.a(new_n89_), .b(new_n63_), .c(new_n76_), .O(new_n90_));
  ...
  nor2   g044(.a(new_n86_), .b(x17), .O(new_n96_));
  nand3  g045(.a(new_n55_), .b(new_n85_), .c(new_n61_), .O(new_n97_));
  oai21  g046(.a(new_n97_), .b(new_n96_), .c(x24), .O(new_n98_));
  nor2   g047(.a(x24), .b(x23), .O(new_n99_));
  nand3  g048(.a(new_n99_), .b(new_n86_), .c(new_n63_), .O(new_n100_));
  ...
  inv1   g054(.a(new_n97_), .O(new_n106_));
  inv1   g055(.a(x24), .O(new_n107_));
  nand2  g056(.a(new_n86_), .b(new_n107_), .O(new_n108_));
  ...
  nand4  g060(.a(new_n111_), .b(new_n89_), .c(new_n69_), .d(new_n55_), .O(new_n112_));
  ...
  nand2  g067(.a(new_n111_), .b(new_n86_), .O(new_n119_));
  aoi21  g068(.a(new_n119_), .b(new_n52_), .c(new_n97_), .O(new_n120_));
  nor3   g069(.a(x26), .b(x25), .c(x24), .O(new_n121_));
  nand3  g070(.a(new_n121_), .b(new_n89_), .c(new_n71_), .O(new_n122_));
  ...
  nand3  g078(.a(new_n129_), .b(new_n86_), .c(new_n107_), .O(new_n130_));
  aoi21  g079(.a(new_n130_), .b(new_n52_), .c(new_n97_), .O(new_n131_));
  nand2  g080(.a(new_n86_), .b(new_n63_), .O(new_n132_));
  ...
  nand4  g091(.a(new_n142_), .b(new_n86_), .c(new_n141_), .d(new_n107_), .O(new_n143_));
  nand2  g092(.a(new_n143_), .b(new_n52_), .O(new_n144_));
  aoi21  g093(.a(new_n144_), .b(new_n106_), .c(new_n140_), .O(new_n145_));
  nor2   g094(.a(x28), .b(x27), .O(new_n146_));
  nand4  g095(.a(new_n146_), .b(new_n111_), .c(new_n118_), .d(new_n85_), .O(new_n147_));
  ...
  nand2  g102(.a(new_n146_), .b(new_n129_), .O(new_n154_));
  oai21  g103(.a(new_n154_), .b(new_n108_), .c(new_n52_), .O(new_n155_));
  aoi21  g104(.a(new_n155_), .b(new_n106_), .c(new_n153_), .O(new_n156_));
  nor2   g105(.a(x29), .b(x28), .O(new_n157_));
  nand3  g106(.a(new_n157_), .b(new_n121_), .c(new_n128_), .O(new_n158_));
  nor2   g107(.a(new_n158_), .b(new_n90_), .O(new_n159_));
  ...
  oai21  g114(.a(new_n165_), .b(new_n119_), .c(new_n52_), .O(new_n166_));
  aoi21  g115(.a(new_n166_), .b(new_n106_), .c(new_n164_), .O(new_n167_));
  nor2   g116(.a(x30), .b(x29), .O(new_n168_));
  nand3  g117(.a(new_n168_), .b(new_n146_), .c(new_n121_), .O(new_n169_));
  nor2   g118(.a(new_n169_), .b(new_n90_), .O(new_n170_));
  ...
  nand2  g124(.a(new_n168_), .b(new_n140_), .O(new_n176_));
  nand3  g125(.a(new_n142_), .b(new_n111_), .c(new_n86_), .O(new_n177_));
  oai21  g126(.a(new_n177_), .b(new_n176_), .c(new_n52_), .O(new_n178_));
  aoi21  g127(.a(new_n178_), .b(new_n106_), .c(new_n175_), .O(new_n179_));
  nor2   g128(.a(x31), .b(x30), .O(new_n180_));
  nand3  g129(.a(new_n180_), .b(new_n157_), .c(new_n133_), .O(new_n181_));
  nor2   g130(.a(new_n181_), .b(new_n100_), .O(new_n182_));
  ...
  oai21  g137(.a(new_n188_), .b(new_n130_), .c(new_n52_), .O(new_n189_));
  aoi21  g138(.a(new_n189_), .b(new_n106_), .c(new_n187_), .O(new_n190_));
  nor2   g139(.a(x32), .b(x31), .O(new_n191_));
  nand2  g140(.a(new_n191_), .b(new_n168_), .O(new_n192_));
  nor3   g141(.a(new_n192_), .b(new_n154_), .c(new_n100_), .O(new_n193_));
  ...
  nand4  g147(.a(new_n191_), .b(new_n157_), .c(new_n164_), .d(new_n128_), .O(new_n199_));
  oai21  g148(.a(new_n199_), .b(new_n130_), .c(new_n52_), .O(new_n200_));
  aoi21  g149(.a(new_n200_), .b(new_n106_), .c(new_n198_), .O(new_n201_));
  nor2   g150(.a(x33), .b(x32), .O(new_n202_));
  nand2  g151(.a(new_n202_), .b(new_n180_), .O(new_n203_));
  nor3   g152(.a(new_n203_), .b(new_n165_), .c(new_n112_), .O(new_n204_));
  ...
  nand4  g158(.a(new_n202_), .b(new_n168_), .c(new_n175_), .d(new_n140_), .O(new_n210_));
  oai21  g159(.a(new_n210_), .b(new_n143_), .c(new_n52_), .O(new_n211_));
  aoi21  g160(.a(new_n211_), .b(new_n106_), .c(new_n209_), .O(new_n212_));
  nand3  g161(.a(new_n202_), .b(new_n180_), .c(new_n209_), .O(new_n213_));
  nor3   g162(.a(new_n213_), .b(new_n165_), .c(new_n112_), .O(new_n214_));
