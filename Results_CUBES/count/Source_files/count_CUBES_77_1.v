...
module FAU ( 
  ...
  nand3  g055(.a(new_n63_), .b(new_n52_), .c(x16), .O(new_n107_));
  inv1   g056(.a(x09), .O(new_n108_));
  aoi21  g057(.a(new_n58_), .b(new_n108_), .c(x18), .O(new_n109_));
  oai21  g058(.a(new_n107_), .b(new_n99_), .c(new_n109_), .O(z06));
  inv1   g059(.a(x26), .O(new_n111_));
  nand2  g060(.a(new_n99_), .b(new_n53_), .O(new_n112_));
  aoi21  g061(.a(new_n112_), .b(new_n65_), .c(new_n111_), .O(new_n113_));
  nor2   g062(.a(x26), .b(x24), .O(new_n114_));
  ...
  nand3  g071(.a(new_n114_), .b(new_n78_), .c(new_n122_), .O(new_n123_));
  aoi21  g072(.a(new_n123_), .b(new_n53_), .c(new_n64_), .O(new_n124_));
  nor3   g073(.a(x27), .b(x26), .c(x24), .O(new_n125_));
  ...
  nand3  g088(.a(new_n139_), .b(new_n98_), .c(new_n111_), .O(new_n140_));
