...
module FAU ( 
  ...
  nand4  g121(.a(new_n114_), .b(new_n104_), .c(new_n126_), .d(new_n115_), .O(new_n173_));
  ...
  nand4  g138(.a(new_n189_), .b(new_n149_), .c(new_n139_), .d(new_n114_), .O(new_n190_));
  oai21  g139(.a(new_n190_), .b(new_n116_), .c(new_n53_), .O(new_n191_));
  aoi21  g140(.a(new_n191_), .b(new_n64_), .c(new_n175_), .O(new_n192_));
  nor2   g141(.a(x32), .b(x31), .O(new_n193_));
  nand4  g142(.a(new_n193_), .b(new_n165_), .c(new_n142_), .d(new_n127_), .O(new_n194_));
  nor3   g143(.a(new_n194_), .b(new_n98_), .c(new_n63_), .O(new_n195_));
  ...
  nand4  g149(.a(new_n193_), .b(new_n153_), .c(new_n160_), .d(new_n125_), .O(new_n201_));
  oai21  g150(.a(new_n201_), .b(new_n128_), .c(new_n53_), .O(new_n202_));
  aoi21  g151(.a(new_n202_), .b(new_n64_), .c(new_n200_), .O(new_n203_));
  nand2  g152(.a(new_n153_), .b(new_n132_), .O(new_n204_));
  nor2   g153(.a(x33), .b(x32), .O(new_n205_));
  nand2  g154(.a(new_n205_), .b(new_n189_), .O(new_n206_));
  nor3   g155(.a(new_n206_), .b(new_n204_), .c(new_n108_), .O(new_n207_));
  ...
  nand4  g161(.a(new_n205_), .b(new_n189_), .c(new_n153_), .d(new_n125_), .O(new_n213_));
  oai21  g162(.a(new_n213_), .b(new_n128_), .c(new_n53_), .O(new_n214_));
  aoi21  g163(.a(new_n214_), .b(new_n64_), .c(new_n212_), .O(new_n215_));
  nand3  g164(.a(new_n205_), .b(new_n189_), .c(new_n212_), .O(new_n216_));
  nor3   g165(.a(new_n216_), .b(new_n204_), .c(new_n108_), .O(new_n217_));
