...
module FAU ( 
  ...
  inv1   g100(.a(x18), .O(new_n152_));
  inv1   g101(.a(x29), .O(new_n153_));
  nand4  g102(.a(new_n145_), .b(new_n130_), .c(new_n98_), .d(new_n77_), .O(new_n154_));
  ...
  oai22  g106(.a(new_n157_), .b(new_n91_), .c(new_n155_), .d(new_n153_), .O(new_n158_));
  nand2  g107(.a(new_n158_), .b(x16), .O(new_n159_));
  nand2  g108(.a(new_n159_), .b(new_n152_), .O(z10));
  inv1   g109(.a(x30), .O(new_n161_));
  nand2  g110(.a(new_n156_), .b(new_n128_), .O(new_n162_));
  ...
  nand3  g115(.a(new_n166_), .b(new_n145_), .c(new_n121_), .O(new_n167_));
  ...
  nand3  g122(.a(new_n166_), .b(new_n135_), .c(new_n142_), .O(new_n174_));
  ...
  nand4  g126(.a(new_n177_), .b(new_n156_), .c(new_n135_), .d(new_n107_), .O(new_n178_));
  ...
  nand4  g133(.a(new_n177_), .b(new_n145_), .c(new_n153_), .d(new_n117_), .O(new_n185_));
  ...
  nand4  g137(.a(new_n188_), .b(new_n166_), .c(new_n145_), .d(new_n130_), .O(new_n189_));
  ...
  nand4  g144(.a(new_n188_), .b(new_n156_), .c(new_n161_), .d(new_n128_), .O(new_n196_));
  oai21  g145(.a(new_n196_), .b(new_n131_), .c(new_n53_), .O(new_n197_));
  aoi21  g146(.a(new_n197_), .b(new_n64_), .c(new_n195_), .O(new_n198_));
  nand2  g147(.a(new_n156_), .b(new_n135_), .O(new_n199_));
  ...
  nand4  g156(.a(new_n200_), .b(new_n177_), .c(new_n156_), .d(new_n128_), .O(new_n208_));
