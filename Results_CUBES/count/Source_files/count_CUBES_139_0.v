...
module FAU ( 
  ...
  nand2  g16(.a(new_n52_), .b(new_n61_), .O(new_n68_));
  nor2   g17(.a(x21), .b(x20), .O(new_n69_));
  aoi22  g18(.a(new_n69_), .b(new_n52_), .c(new_n68_), .d(x21), .O(new_n70_));
  ...
  nand3  g23(.a(new_n69_), .b(new_n52_), .c(new_n74_), .O(new_n75_));
  inv1   g24(.a(new_n75_), .O(new_n76_));
  aoi21  g25(.a(new_n69_), .b(new_n52_), .c(new_n74_), .O(new_n77_));
  ...
  nand4  g37(.a(new_n88_), .b(new_n74_), .c(new_n87_), .d(new_n61_), .O(new_n89_));
  inv1   g38(.a(x24), .O(new_n90_));
  nor2   g39(.a(new_n52_), .b(new_n90_), .O(new_n91_));
  aoi21  g40(.a(new_n89_), .b(new_n52_), .c(new_n91_), .O(new_n92_));
  inv1   g41(.a(x10), .O(new_n93_));
  aoi21  g42(.a(new_n58_), .b(new_n93_), .c(x18), .O(new_n94_));
  oai21  g43(.a(new_n92_), .b(new_n58_), .c(new_n94_), .O(z05));
  aoi21  g44(.a(x25), .b(x16), .c(x18), .O(new_n96_));
  oai21  g45(.a(x16), .b(x09), .c(new_n96_), .O(z06));
  aoi21  g46(.a(x26), .b(x16), .c(x18), .O(new_n98_));
  oai21  g47(.a(x16), .b(x08), .c(new_n98_), .O(z07));
  aoi21  g48(.a(x27), .b(x16), .c(x18), .O(new_n100_));
  oai21  g49(.a(x16), .b(x07), .c(new_n100_), .O(z08));
  aoi21  g50(.a(x28), .b(x16), .c(x18), .O(new_n102_));
  oai21  g51(.a(x16), .b(x06), .c(new_n102_), .O(z09));
  aoi21  g52(.a(x29), .b(x16), .c(x18), .O(new_n104_));
  oai21  g53(.a(x16), .b(x05), .c(new_n104_), .O(z10));
  aoi21  g54(.a(x30), .b(x16), .c(x18), .O(new_n106_));
  oai21  g55(.a(x16), .b(x04), .c(new_n106_), .O(z11));
  aoi21  g56(.a(x31), .b(x16), .c(x18), .O(new_n108_));
  oai21  g57(.a(x16), .b(x03), .c(new_n108_), .O(z12));
  aoi21  g58(.a(x32), .b(x16), .c(x18), .O(new_n110_));
  oai21  g59(.a(x16), .b(x02), .c(new_n110_), .O(z13));
  aoi21  g60(.a(x33), .b(x16), .c(x18), .O(new_n112_));
  oai21  g61(.a(x16), .b(x01), .c(new_n112_), .O(z14));
  aoi21  g62(.a(x34), .b(x16), .c(x18), .O(new_n114_));
  oai21  g63(.a(x16), .b(x00), .c(new_n114_), .O(z15));
endmodule
