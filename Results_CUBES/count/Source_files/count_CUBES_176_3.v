// Benchmark "FAU" written by ABC on Mon Jul  6 14:18:29 2020
...
module FAU ( 
  ...
  aoi21  g027(.a(new_n76_), .b(x20), .c(new_n78_), .O(new_n79_));
  aoi21  g028(.a(new_n70_), .b(x22), .c(new_n79_), .O(new_n80_));
  ...
  aoi21  g032(.a(new_n77_), .b(new_n55_), .c(new_n76_), .O(new_n84_));
  nor2   g033(.a(x23), .b(x22), .O(new_n85_));
  nand4  g034(.a(new_n85_), .b(new_n55_), .c(new_n69_), .d(new_n61_), .O(new_n86_));
  ...
  nand4  g041(.a(new_n92_), .b(new_n77_), .c(new_n55_), .d(new_n61_), .O(new_n93_));
  ...
  nand4  g050(.a(new_n101_), .b(new_n100_), .c(new_n76_), .d(new_n99_), .O(new_n102_));
  ...
  nand4  g058(.a(new_n109_), .b(new_n85_), .c(new_n108_), .d(new_n55_), .O(new_n110_));
  nand2  g059(.a(new_n110_), .b(x26), .O(new_n111_));
  nor3   g060(.a(x26), .b(x25), .c(x24), .O(new_n112_));
  nand3  g061(.a(new_n112_), .b(new_n85_), .c(new_n71_), .O(new_n113_));
  ...
  nand3  g067(.a(new_n77_), .b(new_n55_), .c(new_n61_), .O(new_n119_));
  nor2   g068(.a(x27), .b(x26), .O(new_n120_));
  nand3  g069(.a(new_n120_), .b(new_n92_), .c(new_n101_), .O(new_n121_));
  ...
  nand4  g076(.a(new_n127_), .b(new_n92_), .c(new_n77_), .d(new_n63_), .O(new_n128_));
  nor2   g077(.a(x28), .b(x27), .O(new_n129_));
  nor2   g078(.a(x26), .b(x23), .O(new_n130_));
  nand3  g079(.a(new_n130_), .b(new_n129_), .c(new_n109_), .O(new_n131_));
  nor2   g080(.a(new_n131_), .b(new_n119_), .O(new_n132_));
  ...
  nand4  g088(.a(new_n139_), .b(new_n112_), .c(new_n138_), .d(new_n63_), .O(new_n140_));
  oai21  g089(.a(new_n132_), .b(new_n137_), .c(new_n140_), .O(new_n141_));
  ...
  nand4  g096(.a(new_n147_), .b(new_n129_), .c(new_n146_), .d(new_n100_), .O(new_n148_));
  nor2   g097(.a(new_n148_), .b(new_n86_), .O(new_n149_));
  aoi21  g098(.a(new_n140_), .b(x30), .c(new_n149_), .O(new_n150_));
  ...
  nand4  g113(.a(new_n156_), .b(new_n155_), .c(new_n120_), .d(new_n101_), .O(new_n165_));
  oai21  g114(.a(new_n165_), .b(new_n93_), .c(x32), .O(new_n166_));
  nor2   g115(.a(x32), .b(x31), .O(new_n167_));
  nand4  g116(.a(new_n167_), .b(new_n147_), .c(new_n129_), .d(new_n146_), .O(new_n168_));
  ...
  oai21  g124(.a(new_n168_), .b(new_n93_), .c(x33), .O(new_n176_));
  ...
  oai21  g134(.a(new_n178_), .b(new_n110_), .c(x34), .O(new_n186_));
  nand2  g135(.a(new_n155_), .b(new_n120_), .O(new_n187_));
  ...
  nand3  g145(.a(new_n196_), .b(new_n188_), .c(new_n103_), .O(new_n197_));
  nand2  g146(.a(new_n197_), .b(new_n186_), .O(new_n198_));
