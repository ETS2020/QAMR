...
module FAU ( 
  ...
  aoi21  g077(.a(new_n128_), .b(new_n53_), .c(new_n68_), .O(new_n129_));
  and2   g078(.a(new_n77_), .b(new_n63_), .O(new_n130_));
  nor2   g079(.a(x27), .b(x26), .O(new_n131_));
  nand2  g080(.a(new_n131_), .b(new_n103_), .O(new_n132_));
  nor3   g081(.a(new_n132_), .b(x24), .c(x23), .O(new_n133_));
  ...
  oai21  g085(.a(new_n129_), .b(new_n125_), .c(new_n136_), .O(z08));
  inv1   g086(.a(x28), .O(new_n138_));
  nand4  g087(.a(new_n131_), .b(new_n107_), .c(new_n88_), .d(new_n87_), .O(new_n139_));
  ...
  nand4  g091(.a(new_n142_), .b(new_n141_), .c(new_n77_), .d(new_n63_), .O(new_n143_));
  ...
  nand2  g098(.a(new_n90_), .b(new_n63_), .O(new_n150_));
  nor2   g099(.a(x28), .b(x27), .O(new_n151_));
  nand4  g100(.a(new_n151_), .b(new_n127_), .c(new_n96_), .d(new_n77_), .O(new_n152_));
  ...
  oai22  g104(.a(new_n155_), .b(new_n150_), .c(new_n153_), .d(new_n149_), .O(new_n156_));
  ...
  nand2  g110(.a(new_n154_), .b(new_n125_), .O(new_n162_));
  nand3  g111(.a(new_n127_), .b(new_n96_), .c(new_n77_), .O(new_n163_));
  oai21  g112(.a(new_n163_), .b(new_n162_), .c(new_n53_), .O(new_n164_));
  aoi21  g113(.a(new_n164_), .b(new_n63_), .c(new_n161_), .O(new_n165_));
  nor2   g114(.a(x30), .b(x29), .O(new_n166_));
  nand3  g115(.a(new_n166_), .b(new_n151_), .c(new_n118_), .O(new_n167_));
  ...
  nand3  g122(.a(new_n166_), .b(new_n131_), .c(new_n138_), .O(new_n174_));
  ...
  nor3   g127(.a(new_n178_), .b(new_n132_), .c(new_n97_), .O(new_n179_));
  ...
  nand4  g133(.a(new_n177_), .b(new_n151_), .c(new_n149_), .d(new_n114_), .O(new_n185_));
  oai21  g134(.a(new_n185_), .b(new_n116_), .c(new_n53_), .O(new_n186_));
  aoi21  g135(.a(new_n186_), .b(new_n63_), .c(new_n184_), .O(new_n187_));
  nor2   g136(.a(x32), .b(x31), .O(new_n188_));
  nand4  g137(.a(new_n188_), .b(new_n166_), .c(new_n151_), .d(new_n127_), .O(new_n189_));
  ...
  nand4  g144(.a(new_n188_), .b(new_n154_), .c(new_n161_), .d(new_n125_), .O(new_n196_));
  ...
  nand4  g156(.a(new_n200_), .b(new_n177_), .c(new_n154_), .d(new_n125_), .O(new_n208_));
