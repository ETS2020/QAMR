...
module FAU ( 
  ...
  nand4  g23(.a(new_n74_), .b(new_n61_), .c(new_n53_), .d(new_n52_), .O(new_n75_));
  ...
  nand3  g30(.a(new_n69_), .b(new_n55_), .c(new_n81_), .O(new_n82_));
  nor3   g31(.a(x23), .b(x22), .c(x21), .O(new_n83_));
  aoi22  g32(.a(new_n83_), .b(new_n63_), .c(new_n82_), .d(x23), .O(new_n84_));
  inv1   g33(.a(x11), .O(new_n85_));
  aoi21  g34(.a(new_n58_), .b(new_n85_), .c(x18), .O(new_n86_));
  oai21  g35(.a(new_n84_), .b(new_n58_), .c(new_n86_), .O(z04));
  nor2   g36(.a(x23), .b(x22), .O(new_n88_));
  nor2   g37(.a(new_n88_), .b(new_n75_), .O(new_n89_));
  inv1   g38(.a(x24), .O(new_n90_));
  aoi21  g39(.a(new_n69_), .b(new_n55_), .c(new_n90_), .O(new_n91_));
  oai21  g40(.a(new_n91_), .b(new_n89_), .c(x16), .O(new_n92_));
