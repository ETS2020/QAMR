...
module FAU ( 
  ...
  xnor2a g009(.a(x20), .b(x17), .O(new_n61_));
  nand2  g010(.a(new_n61_), .b(new_n53_), .O(new_n62_));
  nand3  g011(.a(x20), .b(x19), .c(x16), .O(new_n63_));
  ...
  nand4  g018(.a(new_n69_), .b(new_n67_), .c(new_n53_), .d(new_n52_), .O(new_n70_));
  ...
  nand3  g030(.a(new_n77_), .b(new_n55_), .c(new_n67_), .O(new_n82_));
  nor3   g031(.a(x23), .b(x22), .c(x21), .O(new_n83_));
  aoi22  g032(.a(new_n83_), .b(new_n76_), .c(new_n82_), .d(x23), .O(new_n84_));
  ...
  aoi21  g037(.a(new_n83_), .b(new_n76_), .c(new_n88_), .O(new_n89_));
  nor2   g038(.a(x24), .b(x23), .O(new_n90_));
  nand4  g039(.a(new_n90_), .b(new_n77_), .c(new_n55_), .d(new_n67_), .O(new_n91_));
  ...
  nand4  g074(.a(new_n125_), .b(new_n90_), .c(new_n77_), .d(new_n76_), .O(new_n126_));
  ...
  nand4  g085(.a(new_n136_), .b(new_n111_), .c(new_n83_), .d(new_n76_), .O(new_n137_));
  ...
  nand4  g091(.a(new_n107_), .b(new_n55_), .c(new_n69_), .d(new_n67_), .O(new_n143_));
