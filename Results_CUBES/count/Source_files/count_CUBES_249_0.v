...
module FAU ( 
  ...
  oai21  g033(.a(new_n78_), .b(x19), .c(new_n64_), .O(new_n85_));
  ...
  nand4  g058(.a(new_n109_), .b(new_n87_), .c(new_n69_), .d(new_n55_), .O(new_n110_));
  ...
  nand2  g081(.a(new_n78_), .b(new_n64_), .O(new_n133_));
  ...
  nand4  g100(.a(new_n144_), .b(new_n129_), .c(new_n97_), .d(new_n78_), .O(new_n152_));
  ...
  nand3  g111(.a(new_n129_), .b(new_n97_), .c(new_n78_), .O(new_n163_));
