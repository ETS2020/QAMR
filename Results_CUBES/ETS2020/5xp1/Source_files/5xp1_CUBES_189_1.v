...
module FAU ( 
  ...
  inv1   g27(.a(x3), .O(z8));
  nor2   g28(.a(z8), .b(new_n40_), .O(new_n48_));
  nor2   g29(.a(x1), .b(x0), .O(new_n49_));
  nand4  g30(.a(new_n49_), .b(new_n48_), .c(x5), .d(x4), .O(new_n50_));
  nand3  g31(.a(new_n50_), .b(new_n46_), .c(new_n32_), .O(z2));
  xor2a  g32(.a(x3), .b(x2), .O(z7));
  zero   g33(.O(z0));
  zero   g34(.O(z1));
  zero   g35(.O(z3));
  zero   g36(.O(z4));
