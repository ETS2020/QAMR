...
module FAU ( 
  ...
  nor2   g37(.a(new_n31_), .b(new_n32_), .O(new_n56_));
  nor2   g38(.a(new_n19_), .b(x0), .O(new_n57_));
  nor2   g39(.a(x5), .b(new_n23_), .O(new_n58_));
  nor2   g40(.a(new_n58_), .b(new_n57_), .O(new_n59_));
  inv1   g41(.a(x3), .O(new_n60_));
  nand2  g42(.a(new_n57_), .b(new_n60_), .O(new_n61_));
  oai21  g43(.a(new_n59_), .b(new_n56_), .c(new_n61_), .O(new_n62_));
  nand2  g44(.a(new_n62_), .b(new_n24_), .O(new_n63_));
  nand2  g45(.a(new_n57_), .b(new_n25_), .O(new_n64_));
  nand4  g46(.a(new_n19_), .b(new_n60_), .c(new_n32_), .d(x0), .O(new_n65_));
  nand2  g47(.a(new_n65_), .b(new_n64_), .O(new_n66_));
  nand2  g48(.a(new_n66_), .b(new_n31_), .O(new_n67_));
  oai21  g49(.a(new_n49_), .b(new_n60_), .c(new_n35_), .O(new_n68_));
  aoi21  g50(.a(new_n31_), .b(new_n24_), .c(new_n32_), .O(new_n69_));
  nand2  g51(.a(new_n69_), .b(new_n68_), .O(new_n70_));
  aoi21  g52(.a(new_n31_), .b(new_n60_), .c(new_n35_), .O(new_n71_));
  nand3  g53(.a(x6), .b(new_n19_), .c(new_n23_), .O(new_n72_));
  inv1   g54(.a(new_n72_), .O(new_n73_));
  oai21  g55(.a(new_n73_), .b(new_n71_), .c(x1), .O(new_n74_));
  nand4  g56(.a(new_n74_), .b(new_n70_), .c(new_n67_), .d(new_n63_), .O(z3));
  aoi21  g57(.a(new_n60_), .b(new_n23_), .c(new_n32_), .O(new_n76_));
  ...
  nand2  g67(.a(new_n60_), .b(x2), .O(new_n86_));
  oai21  g68(.a(new_n77_), .b(new_n24_), .c(new_n86_), .O(new_n87_));
  nand2  g69(.a(new_n87_), .b(new_n23_), .O(new_n88_));
  aoi21  g70(.a(new_n32_), .b(x1), .c(new_n60_), .O(new_n89_));
  oai21  g71(.a(new_n89_), .b(new_n82_), .c(x0), .O(new_n90_));
  nand2  g72(.a(new_n90_), .b(new_n88_), .O(z5));
  xor2a  g73(.a(new_n77_), .b(new_n24_), .O(z6));
  nand2  g74(.a(new_n86_), .b(new_n77_), .O(z7));
  nand2  g75(.a(new_n22_), .b(x4), .O(new_n95_));
  inv1   g76(.a(new_n95_), .O(z9));
  zero   g77(.O(z1));
  zero   g78(.O(z8));
endmodule
