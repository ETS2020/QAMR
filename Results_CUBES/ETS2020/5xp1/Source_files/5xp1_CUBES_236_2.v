...
module FAU ( 
  ...
  wire new_n18_, new_n19_, new_n20_, new_n21_, new_n22_, new_n23_, new_n24_,
    ...
    new_n84_, new_n85_, new_n86_, new_n87_, new_n91_, new_n93_;
  ...
  nand3  g58(.a(x5), .b(new_n75_), .c(new_n19_), .O(new_n76_));
  oai21  g59(.a(new_n74_), .b(new_n73_), .c(new_n76_), .O(new_n77_));
  nand2  g60(.a(new_n77_), .b(new_n25_), .O(new_n78_));
  nand4  g61(.a(new_n18_), .b(new_n75_), .c(new_n39_), .d(x0), .O(new_n79_));
  ...
  aoi21  g66(.a(new_n20_), .b(new_n75_), .c(new_n50_), .O(new_n84_));
  ...
  nand2  g73(.a(new_n75_), .b(x2), .O(new_n93_));
  nand2  g74(.a(new_n93_), .b(new_n91_), .O(z7));
  nor3   g75(.a(new_n23_), .b(new_n18_), .c(new_n29_), .O(z9));
  zero   g76(.O(z4));
  zero   g77(.O(z5));
  zero   g78(.O(z8));
endmodule
