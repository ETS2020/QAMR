// Benchmark "FAU" written by ABC on Mon Jul  6 15:58:02 2020
...
module FAU ( 
  ...
  aoi21  g73(.a(new_n54_), .b(new_n20_), .c(new_n33_), .O(new_n91_));
  inv1   g74(.a(x3), .O(z8));
  nand2  g75(.a(z8), .b(new_n39_), .O(new_n93_));
  nand2  g76(.a(new_n20_), .b(new_n25_), .O(new_n94_));
  aoi21  g77(.a(new_n94_), .b(new_n93_), .c(x6), .O(new_n95_));
  oai21  g78(.a(new_n95_), .b(new_n91_), .c(x1), .O(new_n96_));
  nand2  g79(.a(z8), .b(new_n25_), .O(new_n97_));
  nor2   g80(.a(x6), .b(new_n39_), .O(new_n98_));
  nand2  g81(.a(new_n97_), .b(x2), .O(new_n99_));
  aoi22  g82(.a(new_n99_), .b(x6), .c(new_n98_), .d(new_n97_), .O(new_n100_));
  oai21  g83(.a(new_n100_), .b(x1), .c(new_n96_), .O(z4));
  nand2  g84(.a(x3), .b(new_n39_), .O(new_n102_));
  nand2  g85(.a(z8), .b(x2), .O(new_n103_));
  oai21  g86(.a(new_n102_), .b(new_n26_), .c(new_n103_), .O(new_n104_));
  ...
  xor2a  g91(.a(new_n102_), .b(new_n26_), .O(z6));
  nand2  g92(.a(new_n103_), .b(new_n102_), .O(z7));
  zero   g93(.O(z9));
endmodule
