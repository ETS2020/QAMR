// Benchmark "FAU" written by ABC on Mon Jul  6 15:57:17 2020
...
module FAU ( 
  ...
  nand3  g72(.a(x3), .b(new_n39_), .c(x0), .O(new_n90_));
  oai21  g73(.a(new_n89_), .b(x1), .c(new_n90_), .O(new_n91_));
  ...
  nand3  g82(.a(x3), .b(new_n39_), .c(x1), .O(new_n100_));
  oai21  g83(.a(x3), .b(new_n39_), .c(new_n100_), .O(new_n101_));
  ...
  nand2  g88(.a(x5), .b(x4), .O(new_n109_));
  aoi21  g89(.a(new_n23_), .b(new_n22_), .c(new_n109_), .O(z9));
  zero   g90(.O(z6));
  zero   g91(.O(z7));
  zero   g92(.O(z8));
endmodule
