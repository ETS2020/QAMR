// Benchmark "FAU" written by ABC on Mon Jul  6 18:53:01 2020
...
module FAU ( 
  ...
  inv1   g20(.a(x11), .O(new_n41_));
  inv1   g21(.a(x12), .O(new_n42_));
  nand4  g22(.a(new_n42_), .b(new_n41_), .c(new_n32_), .d(new_n23_), .O(new_n43_));
  aoi21  g23(.a(new_n43_), .b(new_n20_), .c(new_n21_), .O(new_n44_));
  nor3   g24(.a(x11), .b(x10), .c(x08), .O(new_n45_));
  aoi21  g25(.a(new_n45_), .b(new_n24_), .c(new_n42_), .O(new_n46_));
  oai21  g26(.a(new_n46_), .b(new_n44_), .c(x03), .O(new_n47_));
  inv1   g27(.a(x07), .O(new_n48_));
  aoi21  g28(.a(new_n48_), .b(new_n28_), .c(new_n29_), .O(new_n49_));
