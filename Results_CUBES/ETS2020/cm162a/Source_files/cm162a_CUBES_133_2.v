// Benchmark "FAU" written by ABC on Mon Jul  6 18:52:44 2020
...
module FAU ( 
  ...
  wire new_n20_, new_n21_, new_n22_, new_n23_, new_n24_, new_n25_, new_n26_,
    ...
    new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n50_;
  ...
  nand3  g29(.a(x13), .b(x09), .c(x04), .O(new_n50_));
  inv1   g30(.a(new_n50_), .O(z4));
  zero   g31(.O(z3));
endmodule
