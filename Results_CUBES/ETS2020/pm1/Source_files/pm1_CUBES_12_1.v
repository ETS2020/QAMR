...
module FAU ( 
  ...
  and2   g15(.a(z01), .b(x04), .O(new_n46_));
  ...
  nand4  g21(.a(x12), .b(x11), .c(x04), .d(x03), .O(new_n52_));
  inv1   g22(.a(new_n52_), .O(new_n53_));
  nand4  g23(.a(new_n53_), .b(new_n51_), .c(x02), .d(x00), .O(new_n54_));
  inv1   g24(.a(x10), .O(new_n55_));
  nand2  g25(.a(new_n55_), .b(x00), .O(new_n56_));
  inv1   g26(.a(new_n56_), .O(new_n57_));
  nand3  g27(.a(new_n57_), .b(new_n54_), .c(x11), .O(z08));
  nor2   g28(.a(new_n32_), .b(new_n31_), .O(new_n59_));
  nand3  g29(.a(x04), .b(x03), .c(x02), .O(new_n60_));
  nand3  g30(.a(x04), .b(x03), .c(x02), .O(new_n61_));
  inv1   g31(.a(new_n61_), .O(new_n62_));
  nand3  g32(.a(new_n62_), .b(new_n60_), .c(x09), .O(new_n63_));
  nand2  g33(.a(new_n63_), .b(new_n59_), .O(new_n64_));
  nand2  g34(.a(new_n32_), .b(new_n31_), .O(new_n65_));
  aoi21  g35(.a(new_n65_), .b(new_n64_), .c(new_n56_), .O(z09));
  nand2  g36(.a(new_n60_), .b(x12), .O(new_n67_));
  nand2  g37(.a(x11), .b(x09), .O(new_n68_));
  nor3   g38(.a(new_n68_), .b(new_n67_), .c(new_n56_), .O(z10));
  nand2  g39(.a(new_n32_), .b(new_n30_), .O(new_n70_));
  nand2  g40(.a(new_n57_), .b(x11), .O(new_n71_));
  nand4  g41(.a(new_n60_), .b(x12), .c(x09), .d(x01), .O(new_n72_));
  aoi21  g42(.a(new_n72_), .b(new_n70_), .c(new_n71_), .O(z11));
  nor4   g43(.a(new_n56_), .b(new_n32_), .c(new_n31_), .d(x09), .O(z12));
  zero   g44(.O(z05));
endmodule
