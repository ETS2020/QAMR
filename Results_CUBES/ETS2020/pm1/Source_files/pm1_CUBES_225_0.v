...
module FAU ( 
  ...
  nor2   g28(.a(new_n31_), .b(new_n45_), .O(new_n63_));
  nand4  g29(.a(new_n63_), .b(new_n56_), .c(new_n52_), .d(x12), .O(new_n64_));
  inv1   g30(.a(new_n64_), .O(z10));
  nor4   g31(.a(new_n51_), .b(new_n54_), .c(new_n31_), .d(x09), .O(z12));
  zero   g32(.O(z00));
  zero   g33(.O(z04));
  zero   g34(.O(z05));
  zero   g35(.O(z06));
