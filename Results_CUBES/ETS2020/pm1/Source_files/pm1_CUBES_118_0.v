...
module FAU ( 
  ...
  nand4  g27(.a(new_n59_), .b(new_n56_), .c(new_n55_), .d(z01), .O(z08));
  ...
  inv1   g37(.a(x09), .O(new_n70_));
  nand3  g38(.a(x12), .b(x11), .c(new_n70_), .O(new_n71_));
  nor2   g39(.a(new_n71_), .b(new_n58_), .O(z12));
  zero   g40(.O(z04));
  zero   g41(.O(z05));
  zero   g42(.O(z07));
endmodule
