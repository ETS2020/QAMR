...
module FAU ( 
  ...
  nand4  g22(.a(new_n53_), .b(new_n51_), .c(new_n50_), .d(z01), .O(z08));
  inv1   g23(.a(x10), .O(new_n55_));
  nand2  g24(.a(new_n55_), .b(x00), .O(new_n56_));
  nand2  g25(.a(x12), .b(x11), .O(new_n57_));
  aoi21  g26(.a(new_n57_), .b(new_n51_), .c(new_n56_), .O(z09));
  nand3  g27(.a(new_n53_), .b(new_n49_), .c(new_n46_), .O(new_n59_));
  inv1   g28(.a(new_n59_), .O(z10));
  inv1   g29(.a(x09), .O(new_n62_));
  nand3  g30(.a(x12), .b(x11), .c(new_n62_), .O(new_n63_));
  nor2   g31(.a(new_n63_), .b(new_n56_), .O(z12));
  zero   g32(.O(z02));
  zero   g33(.O(z04));
  zero   g34(.O(z11));
endmodule
