...
module FAU ( 
  ...
  nand2  g14(.a(new_n41_), .b(x12), .O(new_n48_));
  inv1   g15(.a(x10), .O(new_n49_));
  nand4  g16(.a(x11), .b(new_n49_), .c(x09), .d(x00), .O(new_n50_));
  nor2   g17(.a(new_n50_), .b(new_n48_), .O(z10));
  nand4  g18(.a(new_n41_), .b(x12), .c(x09), .d(x01), .O(new_n52_));
  nand2  g19(.a(new_n32_), .b(new_n30_), .O(new_n53_));
  nand3  g20(.a(x11), .b(new_n49_), .c(x00), .O(new_n54_));
