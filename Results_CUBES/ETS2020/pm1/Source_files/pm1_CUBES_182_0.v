...
module FAU ( 
  ...
  nand3  g17(.a(x04), .b(x03), .c(x02), .O(new_n51_));
  inv1   g18(.a(new_n51_), .O(new_n52_));
  nand3  g19(.a(x12), .b(x11), .c(x09), .O(new_n53_));
  inv1   g20(.a(new_n53_), .O(new_n54_));
  nand2  g21(.a(new_n54_), .b(new_n52_), .O(new_n55_));
  nand2  g22(.a(new_n32_), .b(new_n31_), .O(new_n56_));
  inv1   g23(.a(x10), .O(new_n57_));
  nand2  g24(.a(new_n57_), .b(x00), .O(new_n58_));
  inv1   g25(.a(new_n58_), .O(new_n59_));
  nand4  g26(.a(new_n59_), .b(new_n56_), .c(new_n55_), .d(new_n35_), .O(z08));
  nand2  g27(.a(x12), .b(x11), .O(new_n61_));
  aoi21  g28(.a(new_n61_), .b(new_n56_), .c(new_n58_), .O(z09));
  nand2  g29(.a(new_n51_), .b(x12), .O(new_n63_));
  nand4  g30(.a(x11), .b(new_n57_), .c(x09), .d(x00), .O(new_n64_));
  nor2   g31(.a(new_n64_), .b(new_n63_), .O(z10));
  nand4  g32(.a(new_n51_), .b(x12), .c(x09), .d(x01), .O(new_n66_));
  nand2  g33(.a(new_n32_), .b(new_n30_), .O(new_n67_));
  nand3  g34(.a(x11), .b(new_n57_), .c(x00), .O(new_n68_));
  aoi21  g35(.a(new_n67_), .b(new_n66_), .c(new_n68_), .O(z11));
  nand3  g36(.a(x12), .b(x11), .c(new_n37_), .O(new_n70_));
  nor2   g37(.a(new_n70_), .b(new_n58_), .O(z12));
  zero   g38(.O(z01));
  zero   g39(.O(z04));
  zero   g40(.O(z05));
  zero   g41(.O(z07));
