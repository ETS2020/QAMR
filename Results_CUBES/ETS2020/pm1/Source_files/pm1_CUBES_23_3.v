...
module FAU ( 
  ...
  nand3  g18(.a(x12), .b(x11), .c(x09), .O(new_n49_));
  inv1   g19(.a(new_n49_), .O(new_n50_));
  nand2  g20(.a(new_n50_), .b(new_n48_), .O(new_n51_));
  ...
  nand4  g25(.a(new_n55_), .b(new_n52_), .c(new_n51_), .d(z01), .O(z08));
  nand2  g26(.a(x12), .b(x11), .O(new_n57_));
  aoi21  g27(.a(new_n57_), .b(new_n52_), .c(new_n54_), .O(z09));
  nand2  g28(.a(new_n47_), .b(x12), .O(new_n59_));
  nand4  g29(.a(x11), .b(new_n53_), .c(x09), .d(x00), .O(new_n60_));
  nor2   g30(.a(new_n60_), .b(new_n59_), .O(z10));
  nand4  g31(.a(new_n47_), .b(x12), .c(x09), .d(x01), .O(new_n62_));
  nand2  g32(.a(new_n32_), .b(new_n30_), .O(new_n63_));
  nand3  g33(.a(x11), .b(new_n53_), .c(x00), .O(new_n64_));
  aoi21  g34(.a(new_n63_), .b(new_n62_), .c(new_n64_), .O(z11));
  inv1   g35(.a(x09), .O(new_n66_));
  nand3  g36(.a(x12), .b(x11), .c(new_n66_), .O(new_n67_));
  nor2   g37(.a(new_n67_), .b(new_n54_), .O(z12));
  zero   g38(.O(z06));
endmodule
