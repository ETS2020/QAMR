...
module FAU ( 
  ...
  nand2  g19(.a(new_n49_), .b(new_n42_), .O(new_n50_));
  ...
  nand3  g24(.a(x04), .b(x03), .c(x02), .O(new_n56_));
  nand2  g25(.a(new_n56_), .b(x12), .O(new_n57_));
  nand4  g26(.a(x11), .b(new_n51_), .c(x09), .d(x00), .O(new_n58_));
  nor2   g27(.a(new_n58_), .b(new_n57_), .O(z10));
  nand4  g28(.a(new_n56_), .b(x12), .c(x09), .d(x01), .O(new_n60_));
  nand2  g29(.a(new_n32_), .b(new_n30_), .O(new_n61_));
  aoi21  g30(.a(new_n61_), .b(new_n60_), .c(new_n52_), .O(z11));
  nand2  g31(.a(new_n51_), .b(x00), .O(new_n63_));
  inv1   g32(.a(x09), .O(new_n64_));
  nand3  g33(.a(x12), .b(x11), .c(new_n64_), .O(new_n65_));
  nor2   g34(.a(new_n65_), .b(new_n63_), .O(z12));
  zero   g35(.O(z03));
  zero   g36(.O(z09));
endmodule
