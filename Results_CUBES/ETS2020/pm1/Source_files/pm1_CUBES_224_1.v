...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n32_, new_n35_, new_n36_, new_n37_, new_n38_,
    ...
    new_n60_, new_n61_, new_n62_, new_n64_, new_n67_, new_n68_;
  ...
  nand4  g28(.a(new_n58_), .b(new_n56_), .c(new_n55_), .d(z01), .O(z08));
  inv1   g29(.a(x10), .O(new_n60_));
  nand2  g30(.a(new_n60_), .b(x00), .O(new_n61_));
  nand2  g31(.a(x12), .b(x11), .O(new_n62_));
  aoi21  g32(.a(new_n62_), .b(new_n56_), .c(new_n61_), .O(z09));
  nand3  g33(.a(new_n58_), .b(new_n54_), .c(new_n51_), .O(new_n64_));
  inv1   g34(.a(new_n64_), .O(z10));
  inv1   g35(.a(x09), .O(new_n67_));
  nand3  g36(.a(x12), .b(x11), .c(new_n67_), .O(new_n68_));
  nor2   g37(.a(new_n68_), .b(new_n61_), .O(z12));
  zero   g38(.O(z07));
  zero   g39(.O(z11));
endmodule
