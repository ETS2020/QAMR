...
module FAU ( 
  ...
  nand2  g10(.a(x12), .b(new_n37_), .O(new_n43_));
  nand3  g11(.a(x04), .b(x03), .c(x02), .O(new_n44_));
  inv1   g12(.a(new_n44_), .O(new_n45_));
  nand2  g13(.a(x09), .b(x01), .O(new_n46_));
  aoi21  g14(.a(new_n45_), .b(new_n43_), .c(new_n46_), .O(z06));
