...
module FAU ( 
  ...
  nand4  g19(.a(new_n45_), .b(x12), .c(x09), .d(x01), .O(new_n53_));
  nand2  g20(.a(new_n32_), .b(new_n30_), .O(new_n54_));
  inv1   g21(.a(x10), .O(new_n55_));
  nand3  g22(.a(x11), .b(new_n55_), .c(x00), .O(new_n56_));
  aoi21  g23(.a(new_n54_), .b(new_n53_), .c(new_n56_), .O(z11));
  zero   g24(.O(z07));
  zero   g25(.O(z08));
  zero   g26(.O(z09));
  zero   g27(.O(z10));
