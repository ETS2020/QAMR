...
module FAU ( 
  ...
  nand4  g32(.a(new_n62_), .b(x12), .c(x09), .d(x01), .O(new_n63_));
  nand2  g33(.a(new_n32_), .b(new_n30_), .O(new_n64_));
  nand3  g34(.a(x11), .b(new_n51_), .c(x00), .O(new_n65_));
  aoi21  g35(.a(new_n64_), .b(new_n63_), .c(new_n65_), .O(z11));
  inv1   g36(.a(x09), .O(new_n67_));
  nand3  g37(.a(x12), .b(x11), .c(new_n67_), .O(new_n68_));
  nor2   g38(.a(new_n68_), .b(new_n52_), .O(z12));
  zero   g39(.O(z10));
endmodule
