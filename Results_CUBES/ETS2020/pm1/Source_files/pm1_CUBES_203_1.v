...
module FAU ( 
  ...
  nand3  g13(.a(x04), .b(x03), .c(x02), .O(new_n46_));
  inv1   g14(.a(new_n46_), .O(new_n47_));
  nand3  g15(.a(x12), .b(x11), .c(x09), .O(new_n48_));
  ...
  nand4  g22(.a(new_n54_), .b(new_n51_), .c(new_n50_), .d(z01), .O(z08));
  nand2  g23(.a(x12), .b(x11), .O(new_n56_));
  aoi21  g24(.a(new_n56_), .b(new_n51_), .c(new_n53_), .O(z09));
  nand2  g25(.a(new_n46_), .b(x12), .O(new_n58_));
  nand4  g26(.a(x11), .b(new_n52_), .c(x09), .d(x00), .O(new_n59_));
  nor2   g27(.a(new_n59_), .b(new_n58_), .O(z10));
  nand4  g28(.a(new_n46_), .b(x12), .c(x09), .d(x01), .O(new_n61_));
  nand2  g29(.a(new_n32_), .b(new_n30_), .O(new_n62_));
  nand3  g30(.a(x11), .b(new_n52_), .c(x00), .O(new_n63_));
  aoi21  g31(.a(new_n62_), .b(new_n61_), .c(new_n63_), .O(z11));
  inv1   g32(.a(x09), .O(new_n65_));
  nand3  g33(.a(x12), .b(x11), .c(new_n65_), .O(new_n66_));
  nor2   g34(.a(new_n66_), .b(new_n53_), .O(z12));
  zero   g35(.O(z02));
  zero   g36(.O(z05));
  zero   g37(.O(z07));
endmodule
