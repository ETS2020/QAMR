...
module FAU ( 
  ...
  nand2  g18(.a(x09), .b(x01), .O(new_n50_));
  aoi21  g19(.a(new_n49_), .b(new_n39_), .c(new_n50_), .O(z06));
  inv1   g20(.a(x15), .O(z07));
  nand4  g21(.a(x09), .b(x04), .c(x03), .d(x02), .O(new_n53_));
  inv1   g22(.a(new_n53_), .O(new_n54_));
  aoi21  g23(.a(new_n54_), .b(x12), .c(new_n31_), .O(new_n55_));
  nand2  g24(.a(new_n55_), .b(x11), .O(z08));
  xor2a  g25(.a(x12), .b(x11), .O(new_n57_));
  nor2   g26(.a(new_n57_), .b(new_n31_), .O(z09));
  nand2  g27(.a(new_n48_), .b(x12), .O(new_n59_));
  nand2  g28(.a(x11), .b(x09), .O(new_n60_));
  nor3   g29(.a(new_n60_), .b(new_n59_), .c(new_n31_), .O(z10));
  nand4  g30(.a(new_n48_), .b(x12), .c(x09), .d(x01), .O(new_n62_));
  nand2  g31(.a(new_n33_), .b(new_n34_), .O(new_n63_));
  nand3  g32(.a(x11), .b(new_n30_), .c(x00), .O(new_n64_));
  aoi21  g33(.a(new_n63_), .b(new_n62_), .c(new_n64_), .O(z11));
  inv1   g34(.a(x09), .O(new_n66_));
  nand2  g35(.a(x11), .b(new_n66_), .O(new_n67_));
  nor3   g36(.a(new_n67_), .b(new_n31_), .c(new_n33_), .O(z12));
  zero   g37(.O(z02));
  zero   g38(.O(z03));
endmodule
