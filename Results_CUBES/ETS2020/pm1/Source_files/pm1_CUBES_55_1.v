// Benchmark "FAU" written by ABC on Tue Jul  7 11:31:29 2020
...
module FAU ( 
  ...
  nand2  g23(.a(new_n54_), .b(x12), .O(new_n55_));
  nand4  g24(.a(x11), .b(new_n49_), .c(x09), .d(x00), .O(new_n56_));
  nor2   g25(.a(new_n56_), .b(new_n55_), .O(z10));
  nand4  g26(.a(new_n54_), .b(x12), .c(x09), .d(x01), .O(new_n58_));
  nand2  g27(.a(new_n32_), .b(new_n30_), .O(new_n59_));
  aoi21  g28(.a(new_n59_), .b(new_n58_), .c(new_n50_), .O(z11));
  nand2  g29(.a(new_n49_), .b(x00), .O(new_n61_));
  inv1   g30(.a(x09), .O(new_n62_));
  nand3  g31(.a(x12), .b(x11), .c(new_n62_), .O(new_n63_));
  nor2   g32(.a(new_n63_), .b(new_n61_), .O(z12));
  zero   g33(.O(z02));
  zero   g34(.O(z09));
endmodule
