...
module FAU ( 
  ...
  wire new_n108_, new_n109_, new_n110_, new_n111_, new_n112_, new_n113_,
    ...
    new_n210_, new_n211_, new_n212_, new_n220_;
  ...
  nand2  g013(.a(new_n109_), .b(new_n116_), .O(new_n121_));
  inv1   g014(.a(new_n121_), .O(new_n122_));
  aoi21  g015(.a(new_n122_), .b(x28), .c(new_n120_), .O(new_n123_));
  ...
  oai21  g020(.a(new_n123_), .b(new_n110_), .c(new_n127_), .O(new_n128_));
  ...
  nand3  g095(.a(new_n122_), .b(x28), .c(new_n148_), .O(new_n203_));
  ...
  nand3  g106(.a(x30), .b(new_n131_), .c(x22), .O(new_n220_));
  nor4   g107(.a(new_n220_), .b(new_n121_), .c(x21), .d(new_n183_), .O(z24));
  zero   g108(.O(z00));
  zero   g109(.O(z01));
  zero   g110(.O(z02));
  zero   g111(.O(z03));
