...
module FAU ( 
  ...
  nand3  g115(.a(x30), .b(new_n167_), .c(new_n145_), .O(new_n246_));
  nand3  g116(.a(new_n208_), .b(x21), .c(x20), .O(new_n247_));
  inv1   g117(.a(x15), .O(new_n248_));
  nand4  g118(.a(new_n129_), .b(new_n248_), .c(new_n195_), .d(x00), .O(new_n249_));
  nor3   g119(.a(new_n249_), .b(new_n247_), .c(new_n246_), .O(z41));
  zero   g120(.O(z00));
  zero   g121(.O(z01));
  zero   g122(.O(z02));
  zero   g123(.O(z03));
