...
module FAU ( 
  ...
  wire new_n91_, new_n92_, new_n93_, new_n94_, new_n95_, new_n96_, new_n97_,
    ...
    new_n104_, new_n105_, new_n106_, new_n107_, new_n128_, new_n129_,
    new_n130_;
  ...
  nand3  g18(.a(x30), .b(x29), .c(new_n96_), .O(new_n128_));
  inv1   g19(.a(x21), .O(new_n129_));
  nand4  g20(.a(x26), .b(new_n129_), .c(x20), .d(new_n94_), .O(new_n130_));
  nor4   g21(.a(new_n130_), .b(new_n128_), .c(new_n92_), .d(x17), .O(z20));
  zero   g22(.O(z01));
  zero   g23(.O(z02));
  zero   g24(.O(z03));
  zero   g25(.O(z04));
