...
module FAU ( 
  ...
  wire new_n101_, new_n102_, new_n103_, new_n104_, new_n105_, new_n106_,
    ...
    new_n173_, new_n205_, new_n206_, new_n207_, new_n208_, new_n209_;
  ...
  nand3  g074(.a(x30), .b(new_n153_), .c(x22), .O(new_n205_));
  nand4  g075(.a(new_n127_), .b(x21), .c(x20), .d(x19), .O(new_n206_));
  inv1   g076(.a(x05), .O(new_n207_));
  inv1   g077(.a(x15), .O(new_n208_));
  nand4  g078(.a(new_n118_), .b(new_n208_), .c(new_n207_), .d(x00), .O(new_n209_));
  nor3   g079(.a(new_n209_), .b(new_n206_), .c(new_n205_), .O(z41));
  zero   g080(.O(z00));
  zero   g081(.O(z01));
  zero   g082(.O(z02));
  zero   g083(.O(z03));
