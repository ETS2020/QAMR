...
module FAU ( 
  ...
  nand2  g025(.a(new_n104_), .b(x39), .O(new_n123_));
  nand3  g026(.a(new_n119_), .b(x38), .c(x37), .O(new_n124_));
  ...
  oai21  g040(.a(new_n137_), .b(new_n127_), .c(new_n98_), .O(new_n138_));
  nand2  g041(.a(new_n138_), .b(x33), .O(z21));
  inv1   g042(.a(x36), .O(new_n147_));
  xnor2a g043(.a(x39), .b(x38), .O(new_n148_));
  nand4  g044(.a(new_n111_), .b(x35), .c(x24), .d(x22), .O(new_n149_));
  inv1   g045(.a(new_n149_), .O(new_n150_));
  inv1   g046(.a(x15), .O(new_n151_));
  nor2   g047(.a(x12), .b(x11), .O(new_n152_));
  nor3   g048(.a(new_n152_), .b(x21), .c(new_n151_), .O(new_n153_));
  nand3  g049(.a(new_n153_), .b(new_n150_), .c(new_n148_), .O(new_n154_));
  inv1   g050(.a(x28), .O(new_n155_));
  nand3  g051(.a(x30), .b(x29), .c(new_n155_), .O(new_n156_));
  inv1   g052(.a(x29), .O(new_n157_));
  inv1   g053(.a(x30), .O(new_n158_));
  nand3  g054(.a(new_n158_), .b(new_n157_), .c(x28), .O(new_n159_));
  nand2  g055(.a(new_n159_), .b(new_n156_), .O(new_n160_));
  nor2   g056(.a(x35), .b(x31), .O(new_n161_));
  nor2   g057(.a(x38), .b(new_n111_), .O(new_n162_));
  nand4  g058(.a(new_n162_), .b(new_n161_), .c(new_n160_), .d(x39), .O(new_n163_));
  aoi21  g059(.a(new_n163_), .b(new_n154_), .c(x40), .O(new_n164_));
  nand4  g060(.a(new_n161_), .b(x40), .c(new_n103_), .d(x38), .O(new_n165_));
  aoi21  g061(.a(new_n159_), .b(new_n156_), .c(new_n165_), .O(new_n166_));
  oai21  g062(.a(new_n166_), .b(new_n164_), .c(new_n132_), .O(new_n167_));
  nor2   g063(.a(new_n103_), .b(x38), .O(new_n168_));
  nand4  g064(.a(x37), .b(new_n99_), .c(x34), .d(x22), .O(new_n169_));
  inv1   g065(.a(new_n169_), .O(new_n170_));
  nand4  g066(.a(new_n170_), .b(new_n168_), .c(new_n153_), .d(x40), .O(new_n171_));
  nand2  g067(.a(new_n171_), .b(new_n167_), .O(new_n172_));
  nand3  g068(.a(new_n172_), .b(new_n147_), .c(new_n100_), .O(new_n173_));
  inv1   g069(.a(new_n123_), .O(new_n174_));
  nor3   g070(.a(x38), .b(new_n111_), .c(new_n147_), .O(new_n175_));
  nand4  g071(.a(new_n175_), .b(new_n174_), .c(x35), .d(new_n132_), .O(new_n176_));
  nand3  g072(.a(x33), .b(new_n116_), .c(new_n98_), .O(new_n177_));
  aoi21  g073(.a(new_n176_), .b(new_n173_), .c(new_n177_), .O(z29));
  zero   g074(.O(z00));
  zero   g075(.O(z01));
  zero   g076(.O(z02));
  zero   g077(.O(z03));
