// Benchmark "FAU" written by ABC on Wed Jul  8 20:48:49 2020
...
module FAU ( 
  ...
  inv1   g1336(.a(new_n882_), .O(new_n1414_));
  inv1   g1337(.a(new_n1410_), .O(new_n1415_));
  inv1   g1338(.a(new_n1219_), .O(new_n1416_));
  nor2   g1339(.a(x38), .b(new_n212_), .O(new_n1417_));
  aoi22  g1340(.a(new_n1417_), .b(new_n127_), .c(new_n1416_), .d(new_n707_), .O(new_n1418_));
  oai22  g1341(.a(new_n1418_), .b(new_n1415_), .c(new_n742_), .d(new_n339_), .O(new_n1419_));
