...
module FAU ( 
  ...
  nor3   g34(.a(x22), .b(x21), .c(x20), .O(new_n86_));
  aoi22  g35(.a(new_n86_), .b(new_n73_), .c(new_n85_), .d(x22), .O(new_n87_));
  oai21  g36(.a(new_n87_), .b(new_n79_), .c(new_n83_), .O(z12));
  nand2  g37(.a(x18), .b(x04), .O(new_n89_));
  oai21  g38(.a(x18), .b(new_n56_), .c(new_n89_), .O(new_n90_));
  nand2  g39(.a(new_n90_), .b(new_n79_), .O(new_n91_));
  inv1   g40(.a(x22), .O(new_n92_));
  nand3  g41(.a(new_n84_), .b(new_n73_), .c(new_n92_), .O(new_n93_));
  nor3   g42(.a(x23), .b(x22), .c(x21), .O(new_n94_));
  aoi22  g43(.a(new_n94_), .b(new_n75_), .c(new_n93_), .d(x23), .O(new_n95_));
  oai21  g44(.a(new_n95_), .b(new_n79_), .c(new_n91_), .O(z13));
  nand2  g45(.a(x18), .b(x07), .O(new_n99_));
  oai21  g46(.a(x18), .b(new_n65_), .c(new_n99_), .O(new_n100_));
  nand2  g47(.a(new_n100_), .b(new_n79_), .O(new_n101_));
  nor2   g48(.a(x23), .b(x22), .O(new_n102_));
  nor2   g49(.a(x25), .b(x24), .O(new_n103_));
  nand4  g50(.a(new_n103_), .b(new_n102_), .c(new_n84_), .d(new_n73_), .O(new_n104_));
  nand2  g51(.a(new_n104_), .b(x26), .O(new_n105_));
  nor3   g52(.a(x26), .b(x25), .c(x24), .O(new_n106_));
  nand4  g53(.a(new_n106_), .b(new_n102_), .c(new_n84_), .d(new_n73_), .O(new_n107_));
