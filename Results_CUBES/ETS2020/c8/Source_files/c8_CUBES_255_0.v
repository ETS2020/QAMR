...
module FAU ( 
  ...
  aoi21  g35(.a(new_n83_), .b(new_n74_), .c(new_n55_), .O(new_n90_));
  nand2  g36(.a(new_n70_), .b(new_n81_), .O(new_n91_));
  nand3  g37(.a(new_n73_), .b(new_n55_), .c(new_n52_), .O(new_n92_));
  nor2   g38(.a(new_n92_), .b(new_n91_), .O(new_n93_));
  oai21  g39(.a(new_n93_), .b(new_n90_), .c(x16), .O(new_n94_));
  nand2  g40(.a(new_n94_), .b(new_n89_), .O(z14));
  ...
  inv1   g53(.a(x19), .O(new_n109_));
  nor2   g54(.a(new_n109_), .b(x17), .O(new_n110_));
  nand4  g55(.a(new_n110_), .b(new_n104_), .c(new_n100_), .d(new_n71_), .O(new_n111_));
  nand2  g56(.a(x27), .b(x17), .O(new_n112_));
  aoi21  g57(.a(new_n112_), .b(new_n111_), .c(new_n65_), .O(z17));
  zero   g58(.O(z00));
  zero   g59(.O(z01));
  zero   g60(.O(z02));
  zero   g61(.O(z03));
