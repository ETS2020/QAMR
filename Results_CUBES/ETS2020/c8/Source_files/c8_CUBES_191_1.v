...
module FAU ( 
  ...
  aoi21  g45(.a(new_n91_), .b(x21), .c(new_n93_), .O(new_n94_));
  oai21  g46(.a(new_n94_), .b(new_n86_), .c(new_n90_), .O(z11));
  inv1   g47(.a(x13), .O(new_n98_));
  nand2  g48(.a(x18), .b(x05), .O(new_n99_));
  oai21  g49(.a(x18), .b(new_n98_), .c(new_n99_), .O(new_n100_));
  nand2  g50(.a(new_n100_), .b(new_n86_), .O(new_n101_));
  nor3   g51(.a(x23), .b(x22), .c(x21), .O(new_n102_));
  aoi21  g52(.a(new_n102_), .b(new_n83_), .c(new_n63_), .O(new_n103_));
  nor2   g53(.a(x22), .b(x21), .O(new_n104_));
  nor2   g54(.a(x24), .b(x23), .O(new_n105_));
  nand4  g55(.a(new_n105_), .b(new_n104_), .c(new_n73_), .d(new_n51_), .O(new_n106_));
  inv1   g56(.a(new_n106_), .O(new_n107_));
  oai21  g57(.a(new_n107_), .b(new_n103_), .c(x16), .O(new_n108_));
  ...
  nand2  g62(.a(new_n112_), .b(new_n86_), .O(new_n113_));
  inv1   g63(.a(x25), .O(new_n114_));
  nand4  g64(.a(new_n114_), .b(new_n63_), .c(new_n60_), .d(new_n57_), .O(new_n115_));
  inv1   g65(.a(new_n115_), .O(new_n116_));
  aoi22  g66(.a(new_n116_), .b(new_n93_), .c(new_n106_), .d(x25), .O(new_n117_));
  oai21  g67(.a(new_n117_), .b(new_n86_), .c(new_n113_), .O(z15));
  nor2   g68(.a(x21), .b(x20), .O(new_n120_));
  nor2   g69(.a(x23), .b(x22), .O(new_n121_));
  ...
  aoi21  g74(.a(new_n125_), .b(new_n124_), .c(new_n86_), .O(z17));
  zero   g75(.O(z06));
  zero   g76(.O(z08));
  zero   g77(.O(z12));
  zero   g78(.O(z13));
