...
module FAU ( 
  ...
  nand3  g45(.a(new_n89_), .b(new_n72_), .c(new_n49_), .O(new_n95_));
  ...
  nand2  g52(.a(new_n101_), .b(new_n77_), .O(new_n102_));
  aoi21  g53(.a(new_n96_), .b(new_n74_), .c(new_n61_), .O(new_n103_));
  nor2   g54(.a(x24), .b(x23), .O(new_n104_));
  nand4  g55(.a(new_n104_), .b(new_n89_), .c(new_n72_), .d(new_n49_), .O(new_n105_));
  ...
  nand2  g61(.a(new_n110_), .b(new_n77_), .O(new_n111_));
  nand2  g62(.a(new_n105_), .b(x25), .O(new_n112_));
  nor2   g63(.a(x23), .b(x22), .O(new_n113_));
  nor2   g64(.a(x25), .b(x24), .O(new_n114_));
  nand4  g65(.a(new_n114_), .b(new_n113_), .c(new_n82_), .d(new_n72_), .O(new_n115_));
  ...
  nand2  g73(.a(new_n115_), .b(x26), .O(new_n123_));
  nor3   g74(.a(x26), .b(x25), .c(x24), .O(new_n124_));
  nand4  g75(.a(new_n124_), .b(new_n113_), .c(new_n82_), .d(new_n72_), .O(new_n125_));
  ...
  nand4  g81(.a(new_n130_), .b(new_n124_), .c(new_n113_), .d(new_n82_), .O(new_n131_));
