...
module FAU ( 
  ...
  nand3  g39(.a(new_n89_), .b(new_n69_), .c(new_n78_), .O(new_n90_));
  nor3   g40(.a(x23), .b(x22), .c(x21), .O(new_n91_));
  aoi22  g41(.a(new_n91_), .b(new_n80_), .c(new_n90_), .d(x23), .O(new_n92_));
  oai21  g42(.a(new_n92_), .b(new_n85_), .c(new_n88_), .O(z13));
  ...
  aoi21  g48(.a(new_n91_), .b(new_n80_), .c(new_n98_), .O(new_n99_));
  nor2   g49(.a(x24), .b(x23), .O(new_n100_));
  nand4  g50(.a(new_n100_), .b(new_n89_), .c(new_n69_), .d(new_n78_), .O(new_n101_));
  ...
  oai21  g55(.a(x18), .b(new_n62_), .c(new_n105_), .O(new_n106_));
  nand2  g56(.a(new_n106_), .b(new_n85_), .O(new_n107_));
  nand2  g57(.a(new_n101_), .b(x25), .O(new_n108_));
  nor2   g58(.a(x23), .b(x22), .O(new_n109_));
  nor2   g59(.a(x21), .b(x20), .O(new_n110_));
  nor2   g60(.a(x25), .b(x24), .O(new_n111_));
  nand4  g61(.a(new_n111_), .b(new_n110_), .c(new_n109_), .d(new_n69_), .O(new_n112_));
  nand2  g62(.a(new_n112_), .b(new_n108_), .O(new_n113_));
  nand2  g63(.a(new_n113_), .b(x16), .O(new_n114_));
  nand2  g64(.a(new_n114_), .b(new_n107_), .O(z15));
  nand2  g65(.a(x18), .b(x07), .O(new_n116_));
  oai21  g66(.a(x18), .b(new_n65_), .c(new_n116_), .O(new_n117_));
  nand2  g67(.a(new_n117_), .b(new_n85_), .O(new_n118_));
  nand2  g68(.a(new_n112_), .b(x26), .O(new_n119_));
  nor3   g69(.a(x26), .b(x25), .c(x24), .O(new_n120_));
  nand4  g70(.a(new_n120_), .b(new_n110_), .c(new_n109_), .d(new_n69_), .O(new_n121_));
  ...
  nand4  g75(.a(new_n125_), .b(new_n120_), .c(new_n110_), .d(new_n109_), .O(new_n126_));
  nand2  g76(.a(x27), .b(x17), .O(new_n127_));
  aoi21  g77(.a(new_n127_), .b(new_n126_), .c(new_n85_), .O(z17));
  zero   g78(.O(z01));
  zero   g79(.O(z05));
  zero   g80(.O(z11));
  zero   g81(.O(z12));
