...
module FAU ( 
  ...
  oai21  g22(.a(x18), .b(new_n53_), .c(new_n74_), .O(new_n75_));
  ...
  nand2  g33(.a(new_n86_), .b(new_n73_), .O(new_n87_));
  inv1   g34(.a(x24), .O(new_n88_));
  nor3   g35(.a(x23), .b(x22), .c(x21), .O(new_n89_));
  aoi21  g36(.a(new_n89_), .b(new_n80_), .c(new_n88_), .O(new_n90_));
  nand2  g37(.a(new_n65_), .b(new_n49_), .O(new_n91_));
  nand3  g38(.a(new_n79_), .b(new_n88_), .c(new_n56_), .O(new_n92_));
  nor2   g39(.a(new_n92_), .b(new_n91_), .O(new_n93_));
  ...
  nand2  g44(.a(new_n98_), .b(new_n73_), .O(new_n99_));
