...
module FAU ( 
  ...
  nand4  g67(.a(new_n117_), .b(new_n107_), .c(new_n87_), .d(new_n69_), .O(new_n118_));
  ...
  nand4  g72(.a(new_n122_), .b(new_n117_), .c(new_n107_), .d(new_n87_), .O(new_n123_));
