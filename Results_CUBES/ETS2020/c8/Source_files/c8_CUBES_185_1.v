...
module FAU ( 
  ...
  wire new_n48_, new_n49_, new_n50_, new_n52_, new_n53_, new_n55_, new_n56_,
    ...
    new_n84_, new_n90_, new_n91_, new_n92_, new_n93_, new_n94_, new_n95_,
  ...
  oai21  g34(.a(x18), .b(new_n80_), .c(new_n81_), .O(new_n82_));
  nand2  g35(.a(new_n82_), .b(new_n79_), .O(new_n83_));
  xor2a  g36(.a(new_n73_), .b(new_n49_), .O(new_n84_));
  oai21  g37(.a(new_n84_), .b(new_n79_), .c(new_n83_), .O(z10));
  ...
  nand4  g44(.a(new_n95_), .b(new_n94_), .c(new_n73_), .d(new_n49_), .O(new_n96_));
  nand4  g45(.a(new_n64_), .b(new_n61_), .c(new_n58_), .d(new_n55_), .O(new_n97_));
  inv1   g46(.a(new_n97_), .O(new_n98_));
  nand4  g47(.a(new_n52_), .b(new_n49_), .c(new_n71_), .d(new_n70_), .O(new_n99_));
  inv1   g48(.a(new_n99_), .O(new_n100_));
  aoi22  g49(.a(new_n100_), .b(new_n98_), .c(new_n96_), .d(x25), .O(new_n101_));
  oai21  g50(.a(new_n101_), .b(new_n79_), .c(new_n93_), .O(z15));
  zero   g51(.O(z00));
  zero   g52(.O(z11));
  zero   g53(.O(z12));
  zero   g54(.O(z13));
