...
module FAU ( 
  ...
  nand2  g28(.a(new_n82_), .b(new_n68_), .O(new_n83_));
  nand3  g29(.a(new_n76_), .b(new_n73_), .c(new_n51_), .O(new_n84_));
  nor3   g30(.a(x23), .b(x22), .c(x21), .O(new_n85_));
  aoi22  g31(.a(new_n85_), .b(new_n77_), .c(new_n84_), .d(x23), .O(new_n86_));
  oai21  g32(.a(new_n86_), .b(new_n68_), .c(new_n83_), .O(z13));
  inv1   g33(.a(x13), .O(new_n88_));
  nand2  g34(.a(x18), .b(x05), .O(new_n89_));
  oai21  g35(.a(x18), .b(new_n88_), .c(new_n89_), .O(new_n90_));
  nand2  g36(.a(new_n90_), .b(new_n68_), .O(new_n91_));
  inv1   g37(.a(x24), .O(new_n92_));
  aoi21  g38(.a(new_n85_), .b(new_n77_), .c(new_n92_), .O(new_n93_));
  nand2  g39(.a(new_n73_), .b(new_n51_), .O(new_n94_));
  nand3  g40(.a(new_n76_), .b(new_n92_), .c(new_n56_), .O(new_n95_));
  nor2   g41(.a(new_n95_), .b(new_n94_), .O(new_n96_));
  ...
  nand2  g46(.a(new_n101_), .b(new_n68_), .O(new_n102_));
  nor2   g47(.a(x23), .b(x22), .O(new_n103_));
  nor2   g48(.a(x25), .b(x24), .O(new_n104_));
  nand4  g49(.a(new_n104_), .b(new_n103_), .c(new_n74_), .d(new_n73_), .O(new_n105_));
  nand2  g50(.a(new_n105_), .b(x26), .O(new_n106_));
  nor3   g51(.a(x26), .b(x25), .c(x24), .O(new_n107_));
  nand4  g52(.a(new_n107_), .b(new_n103_), .c(new_n74_), .d(new_n73_), .O(new_n108_));
