...
module FAU ( 
  ...
  nand4  g32(.a(new_n82_), .b(new_n51_), .c(new_n48_), .d(new_n81_), .O(new_n83_));
  inv1   g33(.a(new_n83_), .O(new_n84_));
  aoi21  g34(.a(new_n80_), .b(x21), .c(new_n84_), .O(new_n85_));
  oai21  g35(.a(new_n85_), .b(new_n75_), .c(new_n79_), .O(z11));
  inv1   g36(.a(x12), .O(new_n88_));
  nand2  g37(.a(x18), .b(x04), .O(new_n89_));
  oai21  g38(.a(x18), .b(new_n88_), .c(new_n89_), .O(new_n90_));
  nand2  g39(.a(new_n90_), .b(new_n75_), .O(new_n91_));
  nor2   g40(.a(x22), .b(x21), .O(new_n92_));
  nand3  g41(.a(new_n92_), .b(new_n70_), .c(new_n51_), .O(new_n93_));
  nor3   g42(.a(x23), .b(x22), .c(x21), .O(new_n94_));
  aoi22  g43(.a(new_n94_), .b(new_n72_), .c(new_n93_), .d(x23), .O(new_n95_));
  oai21  g44(.a(new_n95_), .b(new_n75_), .c(new_n91_), .O(z13));
  inv1   g45(.a(x13), .O(new_n97_));
  nand2  g46(.a(x18), .b(x05), .O(new_n98_));
  oai21  g47(.a(x18), .b(new_n97_), .c(new_n98_), .O(new_n99_));
  nand2  g48(.a(new_n99_), .b(new_n75_), .O(new_n100_));
  aoi21  g49(.a(new_n94_), .b(new_n72_), .c(new_n57_), .O(new_n101_));
  nor2   g50(.a(x24), .b(x23), .O(new_n102_));
  nand4  g51(.a(new_n102_), .b(new_n92_), .c(new_n70_), .d(new_n51_), .O(new_n103_));
  ...
  nand2  g58(.a(new_n109_), .b(new_n75_), .O(new_n110_));
  inv1   g59(.a(x22), .O(new_n111_));
  inv1   g60(.a(x23), .O(new_n112_));
  nand4  g61(.a(new_n60_), .b(new_n57_), .c(new_n112_), .d(new_n111_), .O(new_n113_));
  inv1   g62(.a(new_n113_), .O(new_n114_));
  aoi22  g63(.a(new_n114_), .b(new_n84_), .c(new_n103_), .d(x25), .O(new_n115_));
  oai21  g64(.a(new_n115_), .b(new_n75_), .c(new_n110_), .O(z15));
  ...
  aoi21  g71(.a(new_n123_), .b(new_n122_), .c(new_n75_), .O(z17));
  zero   g72(.O(z02));
  zero   g73(.O(z03));
  zero   g74(.O(z04));
  zero   g75(.O(z09));
