...
module FAU ( 
  ...
  nand2  g43(.a(new_n91_), .b(new_n79_), .O(new_n92_));
  nor3   g44(.a(x20), .b(x19), .c(x17), .O(new_n93_));
  nor2   g45(.a(x22), .b(x21), .O(new_n94_));
  aoi22  g46(.a(new_n94_), .b(new_n93_), .c(new_n85_), .d(x22), .O(new_n95_));
  oai21  g47(.a(new_n95_), .b(new_n79_), .c(new_n92_), .O(z12));
  ...
  nand3  g52(.a(new_n94_), .b(new_n72_), .c(new_n51_), .O(new_n101_));
  nor3   g53(.a(x23), .b(x22), .c(x21), .O(new_n102_));
  aoi22  g54(.a(new_n102_), .b(new_n93_), .c(new_n101_), .d(x23), .O(new_n103_));
  ...
  aoi21  g60(.a(new_n102_), .b(new_n93_), .c(new_n63_), .O(new_n109_));
  nor2   g61(.a(x24), .b(x23), .O(new_n110_));
  nand4  g62(.a(new_n110_), .b(new_n94_), .c(new_n72_), .d(new_n51_), .O(new_n111_));
  ...
  aoi22  g72(.a(new_n120_), .b(new_n86_), .c(new_n111_), .d(x25), .O(new_n121_));
