...
module FAU ( 
  ...
  nand2  g53(.a(new_n102_), .b(new_n84_), .O(new_n103_));
  aoi21  g54(.a(new_n97_), .b(new_n80_), .c(new_n61_), .O(new_n104_));
  nor2   g55(.a(x24), .b(x23), .O(new_n105_));
  nand4  g56(.a(new_n105_), .b(new_n90_), .c(new_n69_), .d(new_n78_), .O(new_n106_));
  ...
  nand2  g63(.a(new_n112_), .b(new_n84_), .O(new_n113_));
  nand2  g64(.a(new_n106_), .b(x25), .O(new_n114_));
  nor2   g65(.a(x23), .b(x22), .O(new_n115_));
  nor2   g66(.a(x25), .b(x24), .O(new_n116_));
  nand4  g67(.a(new_n116_), .b(new_n115_), .c(new_n88_), .d(new_n69_), .O(new_n117_));
  ...
  nand2  g73(.a(new_n122_), .b(new_n84_), .O(new_n123_));
  nand2  g74(.a(new_n117_), .b(x26), .O(new_n124_));
  nor3   g75(.a(x26), .b(x25), .c(x24), .O(new_n125_));
  nand4  g76(.a(new_n125_), .b(new_n115_), .c(new_n88_), .d(new_n69_), .O(new_n126_));
  ...
  nand4  g81(.a(new_n130_), .b(new_n125_), .c(new_n115_), .d(new_n88_), .O(new_n131_));
  nand2  g82(.a(x27), .b(x17), .O(new_n132_));
  aoi21  g83(.a(new_n132_), .b(new_n131_), .c(new_n84_), .O(z17));
  zero   g84(.O(z01));
  zero   g85(.O(z06));
  zero   g86(.O(z11));
  buf    g87(.a(x27), .O(z08));
