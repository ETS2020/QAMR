...
module FAU ( 
  ...
  nand4  g44(.a(new_n74_), .b(new_n57_), .c(new_n54_), .d(new_n51_), .O(new_n94_));
  nor3   g45(.a(x23), .b(x22), .c(x21), .O(new_n95_));
  aoi22  g46(.a(new_n95_), .b(new_n84_), .c(new_n94_), .d(x23), .O(new_n96_));
  oai21  g47(.a(new_n96_), .b(new_n89_), .c(new_n93_), .O(z13));
  inv1   g48(.a(x13), .O(new_n98_));
  nand2  g49(.a(x18), .b(x05), .O(new_n99_));
  oai21  g50(.a(x18), .b(new_n98_), .c(new_n99_), .O(new_n100_));
  nand2  g51(.a(new_n100_), .b(new_n89_), .O(new_n101_));
  aoi21  g52(.a(new_n95_), .b(new_n84_), .c(new_n63_), .O(new_n102_));
  nand2  g53(.a(new_n74_), .b(new_n51_), .O(new_n103_));
  nand4  g54(.a(new_n63_), .b(new_n60_), .c(new_n57_), .d(new_n54_), .O(new_n104_));
  nor2   g55(.a(new_n104_), .b(new_n103_), .O(new_n105_));
  ...
  nand4  g62(.a(new_n113_), .b(new_n112_), .c(new_n111_), .d(new_n110_), .O(new_n114_));
  nand2  g63(.a(x27), .b(x17), .O(new_n115_));
  aoi21  g64(.a(new_n115_), .b(new_n114_), .c(new_n89_), .O(z17));
  zero   g65(.O(z08));
  zero   g66(.O(z11));
  zero   g67(.O(z12));
  zero   g68(.O(z15));
