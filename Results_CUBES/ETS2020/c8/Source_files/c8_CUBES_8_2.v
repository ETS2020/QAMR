...
module FAU ( 
  ...
  nor2   g40(.a(new_n81_), .b(new_n52_), .O(new_n89_));
  ...
  nand2  g44(.a(new_n92_), .b(new_n88_), .O(z11));
  ...
  nand4  g65(.a(new_n114_), .b(new_n98_), .c(new_n71_), .d(new_n49_), .O(new_n115_));
  nand4  g66(.a(new_n64_), .b(new_n61_), .c(new_n58_), .d(new_n55_), .O(new_n116_));
  inv1   g67(.a(new_n116_), .O(new_n117_));
  aoi22  g68(.a(new_n117_), .b(new_n91_), .c(new_n115_), .d(x25), .O(new_n118_));
  oai21  g69(.a(new_n118_), .b(new_n84_), .c(new_n113_), .O(z15));
  nor2   g70(.a(x21), .b(x20), .O(new_n121_));
  nor2   g71(.a(x23), .b(x22), .O(new_n122_));
  nor3   g72(.a(x26), .b(x25), .c(x24), .O(new_n123_));
  nor2   g73(.a(new_n69_), .b(x17), .O(new_n124_));
  nand4  g74(.a(new_n124_), .b(new_n123_), .c(new_n122_), .d(new_n121_), .O(new_n125_));
  nand2  g75(.a(x27), .b(x17), .O(new_n126_));
  aoi21  g76(.a(new_n126_), .b(new_n125_), .c(new_n84_), .O(z17));
  zero   g77(.O(z00));
  zero   g78(.O(z07));
  zero   g79(.O(z14));
  zero   g80(.O(z16));
