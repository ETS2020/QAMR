...
module FAU ( 
  ...
  oai21  g56(.a(x18), .b(new_n66_), .c(new_n105_), .O(new_n106_));
  nand2  g57(.a(new_n106_), .b(new_n88_), .O(new_n107_));
  nor2   g58(.a(x24), .b(x23), .O(new_n108_));
  nand4  g59(.a(new_n108_), .b(new_n94_), .c(new_n74_), .d(new_n51_), .O(new_n109_));
  nand2  g60(.a(new_n109_), .b(x25), .O(new_n110_));
  nor2   g61(.a(x23), .b(x22), .O(new_n111_));
  nor2   g62(.a(x25), .b(x24), .O(new_n112_));
  nand4  g63(.a(new_n112_), .b(new_n111_), .c(new_n92_), .d(new_n74_), .O(new_n113_));
  ...
  oai21  g68(.a(x18), .b(new_n69_), .c(new_n117_), .O(new_n118_));
  nand2  g69(.a(new_n118_), .b(new_n88_), .O(new_n119_));
  nand2  g70(.a(new_n113_), .b(x26), .O(new_n120_));
  nor3   g71(.a(x26), .b(x25), .c(x24), .O(new_n121_));
  nand4  g72(.a(new_n121_), .b(new_n111_), .c(new_n92_), .d(new_n74_), .O(new_n122_));
  ...
  nand4  g77(.a(new_n126_), .b(new_n121_), .c(new_n111_), .d(new_n92_), .O(new_n127_));
  nand2  g78(.a(x27), .b(x17), .O(new_n128_));
  aoi21  g79(.a(new_n128_), .b(new_n127_), .c(new_n88_), .O(z17));
  zero   g80(.O(z08));
  zero   g81(.O(z11));
  zero   g82(.O(z14));
endmodule
