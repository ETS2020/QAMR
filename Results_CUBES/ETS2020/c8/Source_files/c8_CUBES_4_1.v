...
module FAU ( 
  ...
  oai21  g35(.a(x18), .b(new_n52_), .c(new_n84_), .O(new_n85_));
  nand2  g36(.a(new_n85_), .b(new_n83_), .O(new_n86_));
  nand2  g37(.a(new_n70_), .b(new_n49_), .O(new_n87_));
  ...
  aoi21  g46(.a(new_n97_), .b(new_n80_), .c(new_n59_), .O(new_n98_));
  nor2   g47(.a(x22), .b(x21), .O(new_n99_));
  nor2   g48(.a(x24), .b(x23), .O(new_n100_));
  nand4  g49(.a(new_n100_), .b(new_n99_), .c(new_n70_), .d(new_n49_), .O(new_n101_));
  ...
  nand4  g59(.a(new_n110_), .b(new_n109_), .c(new_n88_), .d(new_n70_), .O(new_n111_));
  nand2  g60(.a(new_n111_), .b(new_n108_), .O(new_n112_));
  nand2  g61(.a(new_n112_), .b(x16), .O(new_n113_));
  nand2  g62(.a(new_n113_), .b(new_n107_), .O(z15));
  nand2  g63(.a(x18), .b(x07), .O(new_n115_));
  oai21  g64(.a(x18), .b(new_n65_), .c(new_n115_), .O(new_n116_));
  nand2  g65(.a(new_n116_), .b(new_n83_), .O(new_n117_));
  nand2  g66(.a(new_n111_), .b(x26), .O(new_n118_));
  nor3   g67(.a(x26), .b(x25), .c(x24), .O(new_n119_));
  nand4  g68(.a(new_n119_), .b(new_n109_), .c(new_n88_), .d(new_n70_), .O(new_n120_));
  ...
  inv1   g72(.a(x19), .O(new_n124_));
  nor2   g73(.a(new_n124_), .b(x17), .O(new_n125_));
  nand4  g74(.a(new_n125_), .b(new_n119_), .c(new_n109_), .d(new_n88_), .O(new_n126_));
