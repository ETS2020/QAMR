...
module FAU ( 
  ...
  nand2  g29(.a(x18), .b(x03), .O(new_n80_));
  ...
  nand2  g33(.a(new_n83_), .b(new_n72_), .O(new_n84_));
  nor2   g34(.a(x22), .b(x21), .O(new_n85_));
  aoi22  g35(.a(new_n85_), .b(new_n74_), .c(new_n84_), .d(x22), .O(new_n86_));
  oai21  g36(.a(new_n86_), .b(new_n78_), .c(new_n82_), .O(z12));
  inv1   g37(.a(x12), .O(new_n88_));
  nand2  g38(.a(x18), .b(x04), .O(new_n89_));
  oai21  g39(.a(x18), .b(new_n88_), .c(new_n89_), .O(new_n90_));
  nand2  g40(.a(new_n90_), .b(new_n78_), .O(new_n91_));
  nand3  g41(.a(new_n85_), .b(new_n72_), .c(new_n51_), .O(new_n92_));
  nor3   g42(.a(x23), .b(x22), .c(x21), .O(new_n93_));
  aoi22  g43(.a(new_n93_), .b(new_n74_), .c(new_n92_), .d(x23), .O(new_n94_));
  oai21  g44(.a(new_n94_), .b(new_n78_), .c(new_n91_), .O(z13));
  ...
  inv1   g49(.a(x24), .O(new_n100_));
  aoi21  g50(.a(new_n93_), .b(new_n74_), .c(new_n100_), .O(new_n101_));
  nand2  g51(.a(new_n72_), .b(new_n51_), .O(new_n102_));
  nand3  g52(.a(new_n85_), .b(new_n100_), .c(new_n58_), .O(new_n103_));
  nor2   g53(.a(new_n103_), .b(new_n102_), .O(new_n104_));
  ...
  oai21  g57(.a(x18), .b(new_n65_), .c(new_n108_), .O(new_n109_));
  nand2  g58(.a(new_n109_), .b(new_n78_), .O(new_n110_));
  nor2   g59(.a(x23), .b(x22), .O(new_n111_));
  nor2   g60(.a(x25), .b(x24), .O(new_n112_));
  nand4  g61(.a(new_n112_), .b(new_n111_), .c(new_n83_), .d(new_n72_), .O(new_n113_));
  nand2  g62(.a(new_n113_), .b(x26), .O(new_n114_));
  nor3   g63(.a(x26), .b(x25), .c(x24), .O(new_n115_));
  nand4  g64(.a(new_n115_), .b(new_n111_), .c(new_n83_), .d(new_n72_), .O(new_n116_));
  nand2  g65(.a(new_n116_), .b(new_n114_), .O(new_n117_));
  nand2  g66(.a(new_n117_), .b(x16), .O(new_n118_));
  nand2  g67(.a(new_n118_), .b(new_n110_), .O(z16));
  zero   g68(.O(z03));
  zero   g69(.O(z05));
  zero   g70(.O(z09));
  zero   g71(.O(z11));
