...
module FAU ( 
  ...
  oai21  g35(.a(x18), .b(new_n53_), .c(new_n84_), .O(new_n85_));
  ...
  nand2  g42(.a(x18), .b(x06), .O(new_n94_));
  oai21  g43(.a(x18), .b(new_n62_), .c(new_n94_), .O(new_n95_));
  nand2  g44(.a(new_n95_), .b(new_n83_), .O(new_n96_));
  nor2   g45(.a(x24), .b(x23), .O(new_n97_));
  nand4  g46(.a(new_n97_), .b(new_n89_), .c(new_n69_), .d(new_n49_), .O(new_n98_));
  nand2  g47(.a(new_n98_), .b(x25), .O(new_n99_));
  nor2   g48(.a(x23), .b(x22), .O(new_n100_));
  nor2   g49(.a(x25), .b(x24), .O(new_n101_));
  nand4  g50(.a(new_n101_), .b(new_n100_), .c(new_n87_), .d(new_n69_), .O(new_n102_));
  nand2  g51(.a(new_n102_), .b(new_n99_), .O(new_n103_));
  nand2  g52(.a(new_n103_), .b(x16), .O(new_n104_));
  nand2  g53(.a(new_n104_), .b(new_n96_), .O(z15));
  nand2  g54(.a(x18), .b(x07), .O(new_n106_));
  oai21  g55(.a(x18), .b(new_n65_), .c(new_n106_), .O(new_n107_));
  nand2  g56(.a(new_n107_), .b(new_n83_), .O(new_n108_));
  nand2  g57(.a(new_n102_), .b(x26), .O(new_n109_));
  nor3   g58(.a(x26), .b(x25), .c(x24), .O(new_n110_));
  nand4  g59(.a(new_n110_), .b(new_n100_), .c(new_n87_), .d(new_n69_), .O(new_n111_));
  nand2  g60(.a(new_n111_), .b(new_n109_), .O(new_n112_));
  nand2  g61(.a(new_n112_), .b(x16), .O(new_n113_));
  nand2  g62(.a(new_n113_), .b(new_n108_), .O(z16));
  inv1   g63(.a(x19), .O(new_n115_));
  nor2   g64(.a(new_n115_), .b(x17), .O(new_n116_));
  nand4  g65(.a(new_n116_), .b(new_n110_), .c(new_n100_), .d(new_n87_), .O(new_n117_));
  nand2  g66(.a(x27), .b(x17), .O(new_n118_));
  aoi21  g67(.a(new_n118_), .b(new_n117_), .c(new_n83_), .O(z17));
  zero   g68(.O(z00));
  zero   g69(.O(z02));
  zero   g70(.O(z11));
  zero   g71(.O(z13));
