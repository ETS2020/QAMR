...
module FAU ( 
  ...
  nand4  g58(.a(new_n108_), .b(new_n92_), .c(new_n72_), .d(new_n49_), .O(new_n109_));
  ...
  inv1   g67(.a(x23), .O(new_n118_));
  nand4  g68(.a(new_n62_), .b(new_n59_), .c(new_n118_), .d(new_n55_), .O(new_n119_));
  inv1   g69(.a(new_n119_), .O(new_n120_));
  aoi22  g70(.a(new_n120_), .b(new_n117_), .c(new_n109_), .d(x25), .O(new_n121_));
  oai21  g71(.a(new_n121_), .b(new_n86_), .c(new_n116_), .O(z15));
  ...
  aoi21  g78(.a(new_n129_), .b(new_n128_), .c(new_n86_), .O(z17));
  zero   g79(.O(z00));
  zero   g80(.O(z04));
  zero   g81(.O(z08));
  zero   g82(.O(z11));
