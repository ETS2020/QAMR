...
module FAU ( 
  ...
  nand4  g56(.a(new_n105_), .b(new_n96_), .c(new_n71_), .d(new_n51_), .O(new_n106_));
  ...
  nor2   g73(.a(new_n48_), .b(x17), .O(new_n123_));
  nand4  g74(.a(new_n123_), .b(new_n118_), .c(new_n108_), .d(new_n89_), .O(new_n124_));
  nand2  g75(.a(x27), .b(x17), .O(new_n125_));
  aoi21  g76(.a(new_n125_), .b(new_n124_), .c(new_n84_), .O(z17));
  zero   g77(.O(z05));
  zero   g78(.O(z12));
  zero   g79(.O(z14));
  buf    g80(.a(x27), .O(z08));
