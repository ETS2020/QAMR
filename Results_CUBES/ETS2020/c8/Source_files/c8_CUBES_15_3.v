...
module FAU ( 
  ...
  nand2  g51(.a(x18), .b(x04), .O(new_n99_));
  oai21  g52(.a(x18), .b(new_n60_), .c(new_n99_), .O(new_n100_));
  nand2  g53(.a(new_n100_), .b(new_n84_), .O(new_n101_));
  nand3  g54(.a(new_n96_), .b(new_n71_), .c(new_n51_), .O(new_n102_));
  nor3   g55(.a(x23), .b(x22), .c(x21), .O(new_n103_));
  aoi22  g56(.a(new_n103_), .b(new_n81_), .c(new_n102_), .d(x23), .O(new_n104_));
  oai21  g57(.a(new_n104_), .b(new_n84_), .c(new_n101_), .O(z13));
  inv1   g58(.a(x13), .O(new_n106_));
  nand2  g59(.a(x18), .b(x05), .O(new_n107_));
  oai21  g60(.a(x18), .b(new_n106_), .c(new_n107_), .O(new_n108_));
  nand2  g61(.a(new_n108_), .b(new_n84_), .O(new_n109_));
  aoi21  g62(.a(new_n103_), .b(new_n81_), .c(new_n63_), .O(new_n110_));
  nor2   g63(.a(x24), .b(x23), .O(new_n111_));
  nand4  g64(.a(new_n111_), .b(new_n96_), .c(new_n71_), .d(new_n51_), .O(new_n112_));
  inv1   g65(.a(new_n112_), .O(new_n113_));
  oai21  g66(.a(new_n113_), .b(new_n110_), .c(x16), .O(new_n114_));
  nand2  g67(.a(new_n114_), .b(new_n109_), .O(z14));
  inv1   g68(.a(x14), .O(new_n116_));
  nand2  g69(.a(x18), .b(x06), .O(new_n117_));
  oai21  g70(.a(x18), .b(new_n116_), .c(new_n117_), .O(new_n118_));
  nand2  g71(.a(new_n118_), .b(new_n84_), .O(new_n119_));
  nand2  g72(.a(new_n112_), .b(x25), .O(new_n120_));
  nor2   g73(.a(x23), .b(x22), .O(new_n121_));
  nor2   g74(.a(x25), .b(x24), .O(new_n122_));
  nand4  g75(.a(new_n122_), .b(new_n121_), .c(new_n89_), .d(new_n71_), .O(new_n123_));
  ...
  nand2  g81(.a(new_n128_), .b(new_n84_), .O(new_n129_));
  nand2  g82(.a(new_n123_), .b(x26), .O(new_n130_));
  nor3   g83(.a(x26), .b(x25), .c(x24), .O(new_n131_));
  nand4  g84(.a(new_n131_), .b(new_n121_), .c(new_n89_), .d(new_n71_), .O(new_n132_));
  ...
  nand4  g89(.a(new_n136_), .b(new_n131_), .c(new_n121_), .d(new_n89_), .O(new_n137_));
  nand2  g90(.a(x27), .b(x17), .O(new_n138_));
  aoi21  g91(.a(new_n138_), .b(new_n137_), .c(new_n84_), .O(z17));
  zero   g92(.O(z06));
  buf    g93(.a(x27), .O(z08));
endmodule
