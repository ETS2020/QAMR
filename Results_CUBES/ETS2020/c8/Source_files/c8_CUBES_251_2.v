...
module FAU ( 
  ...
  nand4  g63(.a(new_n66_), .b(new_n63_), .c(new_n60_), .d(new_n57_), .O(new_n113_));
  inv1   g64(.a(new_n113_), .O(new_n114_));
  aoi22  g65(.a(new_n114_), .b(new_n112_), .c(new_n104_), .d(x25), .O(new_n115_));
  oai21  g66(.a(new_n115_), .b(new_n80_), .c(new_n111_), .O(z15));
  ...
  aoi21  g73(.a(new_n123_), .b(new_n122_), .c(new_n80_), .O(z17));
  zero   g74(.O(z07));
  zero   g75(.O(z10));
  zero   g76(.O(z11));
  zero   g77(.O(z16));
