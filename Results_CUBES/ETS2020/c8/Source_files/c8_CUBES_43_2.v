...
module FAU ( 
  ...
  inv1   g43(.a(x12), .O(new_n92_));
  nand2  g44(.a(x18), .b(x04), .O(new_n93_));
  oai21  g45(.a(x18), .b(new_n92_), .c(new_n93_), .O(new_n94_));
  nand2  g46(.a(new_n94_), .b(new_n81_), .O(new_n95_));
  nor3   g47(.a(x20), .b(x19), .c(x17), .O(new_n96_));
  ...
  aoi22  g51(.a(new_n99_), .b(new_n96_), .c(new_n98_), .d(x23), .O(new_n100_));
  oai21  g52(.a(new_n100_), .b(new_n81_), .c(new_n95_), .O(z13));
  inv1   g53(.a(x13), .O(new_n102_));
  nand2  g54(.a(x18), .b(x05), .O(new_n103_));
  oai21  g55(.a(x18), .b(new_n102_), .c(new_n103_), .O(new_n104_));
  nand2  g56(.a(new_n104_), .b(new_n81_), .O(new_n105_));
  aoi21  g57(.a(new_n99_), .b(new_n96_), .c(new_n63_), .O(new_n106_));
  nor2   g58(.a(x24), .b(x23), .O(new_n107_));
  nand4  g59(.a(new_n107_), .b(new_n97_), .c(new_n74_), .d(new_n51_), .O(new_n108_));
  ...
  nand2  g66(.a(new_n114_), .b(new_n81_), .O(new_n115_));
  nand4  g67(.a(new_n66_), .b(new_n63_), .c(new_n60_), .d(new_n57_), .O(new_n116_));
  inv1   g68(.a(new_n116_), .O(new_n117_));
  aoi22  g69(.a(new_n117_), .b(new_n88_), .c(new_n108_), .d(x25), .O(new_n118_));
  oai21  g70(.a(new_n118_), .b(new_n81_), .c(new_n115_), .O(z15));
  nor2   g71(.a(x21), .b(x20), .O(new_n121_));
  nor2   g72(.a(x23), .b(x22), .O(new_n122_));
  nor3   g73(.a(x26), .b(x25), .c(x24), .O(new_n123_));
  nor2   g74(.a(new_n48_), .b(x17), .O(new_n124_));
  nand4  g75(.a(new_n124_), .b(new_n123_), .c(new_n122_), .d(new_n121_), .O(new_n125_));
  nand2  g76(.a(x27), .b(x17), .O(new_n126_));
  aoi21  g77(.a(new_n126_), .b(new_n125_), .c(new_n81_), .O(z17));
  zero   g78(.O(z10));
  zero   g79(.O(z12));
  zero   g80(.O(z16));
  buf    g81(.a(x27), .O(z08));
