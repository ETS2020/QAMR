...
module FAU ( 
  ...
  inv1   g31(.a(x09), .O(new_n80_));
  nor2   g32(.a(x18), .b(new_n80_), .O(new_n81_));
  aoi21  g33(.a(x18), .b(x01), .c(new_n81_), .O(new_n82_));
  nor2   g34(.a(new_n74_), .b(new_n49_), .O(new_n83_));
  nor3   g35(.a(x20), .b(x19), .c(x17), .O(new_n84_));
  oai21  g36(.a(new_n84_), .b(new_n83_), .c(x16), .O(new_n85_));
  oai21  g37(.a(new_n82_), .b(x16), .c(new_n85_), .O(z10));
  ...
  nand3  g44(.a(new_n94_), .b(new_n74_), .c(new_n49_), .O(new_n95_));
  nor3   g45(.a(x23), .b(x22), .c(x21), .O(new_n96_));
  aoi22  g46(.a(new_n96_), .b(new_n84_), .c(new_n95_), .d(x23), .O(new_n97_));
  oai21  g47(.a(new_n97_), .b(new_n89_), .c(new_n93_), .O(z13));
  inv1   g48(.a(x13), .O(new_n99_));
  nand2  g49(.a(x18), .b(x05), .O(new_n100_));
  oai21  g50(.a(x18), .b(new_n99_), .c(new_n100_), .O(new_n101_));
  nand2  g51(.a(new_n101_), .b(new_n89_), .O(new_n102_));
  aoi21  g52(.a(new_n96_), .b(new_n84_), .c(new_n61_), .O(new_n103_));
  nor2   g53(.a(x24), .b(x23), .O(new_n104_));
  nand4  g54(.a(new_n104_), .b(new_n94_), .c(new_n74_), .d(new_n49_), .O(new_n105_));
  ...
  inv1   g58(.a(x14), .O(new_n109_));
  nand2  g59(.a(x18), .b(x06), .O(new_n110_));
  oai21  g60(.a(x18), .b(new_n109_), .c(new_n110_), .O(new_n111_));
  nand2  g61(.a(new_n111_), .b(new_n89_), .O(new_n112_));
  nand4  g62(.a(new_n64_), .b(new_n61_), .c(new_n52_), .d(new_n49_), .O(new_n113_));
  inv1   g63(.a(new_n113_), .O(new_n114_));
  nand4  g64(.a(new_n58_), .b(new_n55_), .c(new_n72_), .d(new_n71_), .O(new_n115_));
  inv1   g65(.a(new_n115_), .O(new_n116_));
  aoi22  g66(.a(new_n116_), .b(new_n114_), .c(new_n105_), .d(x25), .O(new_n117_));
  oai21  g67(.a(new_n117_), .b(new_n89_), .c(new_n112_), .O(z15));
  zero   g68(.O(z00));
  zero   g69(.O(z08));
  zero   g70(.O(z11));
  zero   g71(.O(z12));
