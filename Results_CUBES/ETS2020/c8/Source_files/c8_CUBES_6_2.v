...
module FAU ( 
  ...
  nand4  g57(.a(new_n106_), .b(new_n97_), .c(new_n71_), .d(new_n51_), .O(new_n107_));
  nand2  g58(.a(new_n107_), .b(x25), .O(new_n108_));
  nor2   g59(.a(x23), .b(x22), .O(new_n109_));
  nor2   g60(.a(x25), .b(x24), .O(new_n110_));
  nand4  g61(.a(new_n110_), .b(new_n109_), .c(new_n89_), .d(new_n71_), .O(new_n111_));
  ...
  nand2  g67(.a(new_n116_), .b(new_n84_), .O(new_n117_));
  nand2  g68(.a(new_n111_), .b(x26), .O(new_n118_));
  nor3   g69(.a(x26), .b(x25), .c(x24), .O(new_n119_));
  nand4  g70(.a(new_n119_), .b(new_n109_), .c(new_n89_), .d(new_n71_), .O(new_n120_));
  ...
  nand4  g75(.a(new_n124_), .b(new_n119_), .c(new_n109_), .d(new_n89_), .O(new_n125_));
