...
module FAU ( 
  ...
  nor3   g56(.a(x23), .b(x22), .c(x21), .O(new_n106_));
  aoi21  g57(.a(new_n106_), .b(new_n81_), .c(new_n59_), .O(new_n107_));
  nor2   g58(.a(x24), .b(x23), .O(new_n108_));
  nand4  g59(.a(new_n108_), .b(new_n98_), .c(new_n71_), .d(new_n49_), .O(new_n109_));
  ...
  inv1   g63(.a(x14), .O(new_n113_));
  nand2  g64(.a(x18), .b(x06), .O(new_n114_));
  oai21  g65(.a(x18), .b(new_n113_), .c(new_n114_), .O(new_n115_));
  nand2  g66(.a(new_n115_), .b(new_n84_), .O(new_n116_));
  inv1   g67(.a(x22), .O(new_n117_));
  nand4  g68(.a(new_n62_), .b(new_n59_), .c(new_n56_), .d(new_n117_), .O(new_n118_));
  inv1   g69(.a(new_n118_), .O(new_n119_));
  aoi22  g70(.a(new_n119_), .b(new_n91_), .c(new_n109_), .d(x25), .O(new_n120_));
  oai21  g71(.a(new_n120_), .b(new_n84_), .c(new_n116_), .O(z15));
  nor2   g72(.a(x21), .b(x20), .O(new_n123_));
  nor2   g73(.a(x23), .b(x22), .O(new_n124_));
  nor3   g74(.a(x26), .b(x25), .c(x24), .O(new_n125_));
  nor2   g75(.a(new_n69_), .b(x17), .O(new_n126_));
  nand4  g76(.a(new_n126_), .b(new_n125_), .c(new_n124_), .d(new_n123_), .O(new_n127_));
  nand2  g77(.a(x27), .b(x17), .O(new_n128_));
  aoi21  g78(.a(new_n128_), .b(new_n127_), .c(new_n84_), .O(z17));
  zero   g79(.O(z00));
  zero   g80(.O(z03));
  zero   g81(.O(z13));
  zero   g82(.O(z16));
