...
module FAU ( 
  ...
  nand2  g43(.a(new_n73_), .b(new_n49_), .O(new_n91_));
  nand4  g44(.a(new_n52_), .b(new_n49_), .c(new_n71_), .d(new_n70_), .O(new_n92_));
  inv1   g45(.a(new_n92_), .O(new_n93_));
  aoi21  g46(.a(new_n91_), .b(x21), .c(new_n93_), .O(new_n94_));
  oai21  g47(.a(new_n94_), .b(new_n86_), .c(new_n90_), .O(z11));
  ...
  nand2  g60(.a(new_n108_), .b(new_n86_), .O(new_n109_));
  aoi21  g61(.a(new_n103_), .b(new_n83_), .c(new_n61_), .O(new_n110_));
  nor2   g62(.a(x24), .b(x23), .O(new_n111_));
  nand4  g63(.a(new_n111_), .b(new_n101_), .c(new_n73_), .d(new_n49_), .O(new_n112_));
  ...
  nand2  g70(.a(new_n118_), .b(new_n86_), .O(new_n119_));
  nand4  g71(.a(new_n64_), .b(new_n61_), .c(new_n58_), .d(new_n55_), .O(new_n120_));
  inv1   g72(.a(new_n120_), .O(new_n121_));
  aoi22  g73(.a(new_n121_), .b(new_n93_), .c(new_n112_), .d(x25), .O(new_n122_));
  oai21  g74(.a(new_n122_), .b(new_n86_), .c(new_n119_), .O(z15));
  nor2   g75(.a(x21), .b(x20), .O(new_n125_));
  nor2   g76(.a(x23), .b(x22), .O(new_n126_));
  nor3   g77(.a(x26), .b(x25), .c(x24), .O(new_n127_));
  nor2   g78(.a(new_n71_), .b(x17), .O(new_n128_));
  nand4  g79(.a(new_n128_), .b(new_n127_), .c(new_n126_), .d(new_n125_), .O(new_n129_));
  nand2  g80(.a(x27), .b(x17), .O(new_n130_));
  aoi21  g81(.a(new_n130_), .b(new_n129_), .c(new_n86_), .O(z17));
  zero   g82(.O(z00));
  zero   g83(.O(z12));
  zero   g84(.O(z16));
  buf    g85(.a(x27), .O(z08));
