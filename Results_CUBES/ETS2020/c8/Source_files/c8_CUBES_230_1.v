...
module FAU ( 
  ...
  nor2   g24(.a(x19), .b(x17), .O(new_n76_));
  nand2  g25(.a(new_n76_), .b(new_n49_), .O(new_n77_));
  inv1   g26(.a(x17), .O(new_n78_));
  inv1   g27(.a(x19), .O(new_n79_));
  nand4  g28(.a(new_n52_), .b(new_n49_), .c(new_n79_), .d(new_n78_), .O(new_n80_));
  inv1   g29(.a(new_n80_), .O(new_n81_));
  aoi21  g30(.a(new_n77_), .b(x21), .c(new_n81_), .O(new_n82_));
  oai21  g31(.a(new_n82_), .b(new_n71_), .c(new_n75_), .O(z11));
  inv1   g32(.a(x12), .O(new_n85_));
  nand2  g33(.a(x18), .b(x04), .O(new_n86_));
  oai21  g34(.a(x18), .b(new_n85_), .c(new_n86_), .O(new_n87_));
  nand2  g35(.a(new_n87_), .b(new_n71_), .O(new_n88_));
  nor3   g36(.a(x20), .b(x19), .c(x17), .O(new_n89_));
  nor2   g37(.a(x22), .b(x21), .O(new_n90_));
  nand3  g38(.a(new_n90_), .b(new_n76_), .c(new_n49_), .O(new_n91_));
  nor3   g39(.a(x23), .b(x22), .c(x21), .O(new_n92_));
  aoi22  g40(.a(new_n92_), .b(new_n89_), .c(new_n91_), .d(x23), .O(new_n93_));
  oai21  g41(.a(new_n93_), .b(new_n71_), .c(new_n88_), .O(z13));
  ...
  aoi21  g46(.a(new_n92_), .b(new_n89_), .c(new_n59_), .O(new_n99_));
  nor2   g47(.a(x24), .b(x23), .O(new_n100_));
  nand4  g48(.a(new_n100_), .b(new_n90_), .c(new_n76_), .d(new_n49_), .O(new_n101_));
  inv1   g49(.a(new_n101_), .O(new_n102_));
  oai21  g50(.a(new_n102_), .b(new_n99_), .c(x16), .O(new_n103_));
  nand2  g51(.a(new_n103_), .b(new_n98_), .O(z14));
  inv1   g52(.a(x14), .O(new_n105_));
  nand2  g53(.a(x18), .b(x06), .O(new_n106_));
  oai21  g54(.a(x18), .b(new_n105_), .c(new_n106_), .O(new_n107_));
  nand2  g55(.a(new_n107_), .b(new_n71_), .O(new_n108_));
  inv1   g56(.a(x23), .O(new_n109_));
  nand4  g57(.a(new_n62_), .b(new_n59_), .c(new_n109_), .d(new_n55_), .O(new_n110_));
  inv1   g58(.a(new_n110_), .O(new_n111_));
  aoi22  g59(.a(new_n111_), .b(new_n81_), .c(new_n101_), .d(x25), .O(new_n112_));
  oai21  g60(.a(new_n112_), .b(new_n71_), .c(new_n108_), .O(z15));
  zero   g61(.O(z00));
  zero   g62(.O(z04));
  zero   g63(.O(z08));
  zero   g64(.O(z09));
