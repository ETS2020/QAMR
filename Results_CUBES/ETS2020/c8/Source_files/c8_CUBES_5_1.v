...
module FAU ( 
  ...
  oai21  g53(.a(x18), .b(new_n64_), .c(new_n103_), .O(new_n104_));
  nand2  g54(.a(new_n104_), .b(new_n86_), .O(new_n105_));
  ...
  nand4  g60(.a(new_n110_), .b(new_n109_), .c(new_n90_), .d(new_n72_), .O(new_n111_));
  ...
  oai21  g65(.a(x18), .b(new_n67_), .c(new_n115_), .O(new_n116_));
  ...
  nand4  g69(.a(new_n119_), .b(new_n109_), .c(new_n90_), .d(new_n72_), .O(new_n120_));
  ...
  nand4  g74(.a(new_n124_), .b(new_n119_), .c(new_n109_), .d(new_n90_), .O(new_n125_));
  nand2  g75(.a(x27), .b(x17), .O(new_n126_));
  aoi21  g76(.a(new_n126_), .b(new_n125_), .c(new_n86_), .O(z17));
  zero   g77(.O(z05));
  zero   g78(.O(z08));
  zero   g79(.O(z11));
  zero   g80(.O(z14));
