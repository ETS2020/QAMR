...
module FAU ( 
  ...
  oai21  g31(.a(x18), .b(new_n51_), .c(new_n79_), .O(new_n80_));
  nand2  g32(.a(new_n80_), .b(new_n78_), .O(new_n81_));
  xnor2a g33(.a(new_n72_), .b(x20), .O(new_n82_));
  oai21  g34(.a(new_n82_), .b(new_n78_), .c(new_n81_), .O(z10));
  nand2  g35(.a(x18), .b(x03), .O(new_n85_));
  oai21  g36(.a(x18), .b(new_n55_), .c(new_n85_), .O(new_n86_));
  nand2  g37(.a(new_n86_), .b(new_n78_), .O(new_n87_));
  nor2   g38(.a(x21), .b(x20), .O(new_n88_));
  nand2  g39(.a(new_n88_), .b(new_n72_), .O(new_n89_));
  nor3   g40(.a(x22), .b(x21), .c(x20), .O(new_n90_));
  aoi22  g41(.a(new_n90_), .b(new_n72_), .c(new_n89_), .d(x22), .O(new_n91_));
  oai21  g42(.a(new_n91_), .b(new_n78_), .c(new_n87_), .O(z12));
  nand2  g43(.a(x18), .b(x07), .O(new_n96_));
  oai21  g44(.a(x18), .b(new_n67_), .c(new_n96_), .O(new_n97_));
  nand2  g45(.a(new_n97_), .b(new_n78_), .O(new_n98_));
  nor2   g46(.a(x23), .b(x22), .O(new_n99_));
  nor2   g47(.a(x25), .b(x24), .O(new_n100_));
  nand4  g48(.a(new_n100_), .b(new_n99_), .c(new_n88_), .d(new_n72_), .O(new_n101_));
  nand2  g49(.a(new_n101_), .b(x26), .O(new_n102_));
  nor3   g50(.a(x26), .b(x25), .c(x24), .O(new_n103_));
  nand4  g51(.a(new_n103_), .b(new_n99_), .c(new_n88_), .d(new_n72_), .O(new_n104_));
  nand2  g52(.a(new_n104_), .b(new_n102_), .O(new_n105_));
  nand2  g53(.a(new_n105_), .b(x16), .O(new_n106_));
  nand2  g54(.a(new_n106_), .b(new_n98_), .O(z16));
  nor2   g55(.a(new_n48_), .b(x17), .O(new_n108_));
  nand4  g56(.a(new_n108_), .b(new_n103_), .c(new_n99_), .d(new_n88_), .O(new_n109_));
  nand2  g57(.a(x27), .b(x17), .O(new_n110_));
  aoi21  g58(.a(new_n110_), .b(new_n109_), .c(new_n78_), .O(z17));
  zero   g59(.O(z02));
  zero   g60(.O(z08));
  zero   g61(.O(z11));
  zero   g62(.O(z13));
