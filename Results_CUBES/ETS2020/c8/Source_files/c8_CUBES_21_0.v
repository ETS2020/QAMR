...
module FAU ( 
  ...
  nand2  g24(.a(new_n65_), .b(new_n49_), .O(new_n77_));
  inv1   g25(.a(x21), .O(new_n78_));
  nand4  g26(.a(new_n78_), .b(new_n49_), .c(new_n63_), .d(new_n62_), .O(new_n79_));
  inv1   g27(.a(new_n79_), .O(new_n80_));
  aoi21  g28(.a(new_n77_), .b(x21), .c(new_n80_), .O(new_n81_));
  oai21  g29(.a(new_n81_), .b(new_n72_), .c(new_n76_), .O(z11));
  ...
  nor3   g34(.a(x20), .b(x19), .c(x17), .O(new_n87_));
  nor2   g35(.a(x22), .b(x21), .O(new_n88_));
  aoi22  g36(.a(new_n88_), .b(new_n87_), .c(new_n79_), .d(x22), .O(new_n89_));
  oai21  g37(.a(new_n89_), .b(new_n72_), .c(new_n86_), .O(z12));
  ...
  nand3  g42(.a(new_n88_), .b(new_n65_), .c(new_n49_), .O(new_n95_));
  nor3   g43(.a(x23), .b(x22), .c(x21), .O(new_n96_));
  aoi22  g44(.a(new_n96_), .b(new_n87_), .c(new_n95_), .d(x23), .O(new_n97_));
  ...
  aoi21  g51(.a(new_n96_), .b(new_n87_), .c(new_n103_), .O(new_n104_));
  nor2   g52(.a(x24), .b(x23), .O(new_n105_));
  nand4  g53(.a(new_n105_), .b(new_n88_), .c(new_n65_), .d(new_n49_), .O(new_n106_));
  ...
  inv1   g61(.a(x22), .O(new_n114_));
  inv1   g62(.a(x23), .O(new_n115_));
  nand4  g63(.a(new_n56_), .b(new_n103_), .c(new_n115_), .d(new_n114_), .O(new_n116_));
  inv1   g64(.a(new_n116_), .O(new_n117_));
  aoi22  g65(.a(new_n117_), .b(new_n80_), .c(new_n106_), .d(x25), .O(new_n118_));
  ...
  nand4  g73(.a(new_n125_), .b(new_n124_), .c(new_n123_), .d(new_n65_), .O(new_n126_));
  nand2  g74(.a(new_n126_), .b(x26), .O(new_n127_));
  nor3   g75(.a(x26), .b(x25), .c(x24), .O(new_n128_));
  nand4  g76(.a(new_n128_), .b(new_n124_), .c(new_n123_), .d(new_n65_), .O(new_n129_));
