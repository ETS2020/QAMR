// Benchmark "FAU" written by ABC on Mon Jul  6 18:51:42 2020
...
module FAU ( 
  ...
  aoi21  g63(.a(new_n104_), .b(new_n81_), .c(new_n63_), .O(new_n111_));
  nand3  g64(.a(new_n96_), .b(new_n63_), .c(new_n60_), .O(new_n112_));
  nor2   g65(.a(new_n112_), .b(new_n88_), .O(new_n113_));
  oai21  g66(.a(new_n113_), .b(new_n111_), .c(x16), .O(new_n114_));
  nand2  g67(.a(new_n114_), .b(new_n110_), .O(z14));
  inv1   g68(.a(x15), .O(new_n117_));
  nand2  g69(.a(x18), .b(x07), .O(new_n118_));
  oai21  g70(.a(x18), .b(new_n117_), .c(new_n118_), .O(new_n119_));
