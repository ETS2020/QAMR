...
module FAU ( 
  ...
  nand2  g61(.a(x18), .b(x06), .O(new_n109_));
  oai21  g62(.a(x18), .b(new_n66_), .c(new_n109_), .O(new_n110_));
  nand2  g63(.a(new_n110_), .b(new_n86_), .O(new_n111_));
  nor2   g64(.a(x24), .b(x23), .O(new_n112_));
  nand4  g65(.a(new_n112_), .b(new_n98_), .c(new_n73_), .d(new_n51_), .O(new_n113_));
  nand2  g66(.a(new_n113_), .b(x25), .O(new_n114_));
  nor2   g67(.a(x23), .b(x22), .O(new_n115_));
  nor2   g68(.a(x25), .b(x24), .O(new_n116_));
  nand4  g69(.a(new_n116_), .b(new_n115_), .c(new_n91_), .d(new_n73_), .O(new_n117_));
  nand2  g70(.a(new_n117_), .b(new_n114_), .O(new_n118_));
  nand2  g71(.a(new_n118_), .b(x16), .O(new_n119_));
  nand2  g72(.a(new_n119_), .b(new_n111_), .O(z15));
  nand2  g73(.a(x18), .b(x07), .O(new_n121_));
  oai21  g74(.a(x18), .b(new_n69_), .c(new_n121_), .O(new_n122_));
  nand2  g75(.a(new_n122_), .b(new_n86_), .O(new_n123_));
  nand2  g76(.a(new_n117_), .b(x26), .O(new_n124_));
  nor3   g77(.a(x26), .b(x25), .c(x24), .O(new_n125_));
  nand4  g78(.a(new_n125_), .b(new_n115_), .c(new_n91_), .d(new_n73_), .O(new_n126_));
  nand2  g79(.a(new_n126_), .b(new_n124_), .O(new_n127_));
  nand2  g80(.a(new_n127_), .b(x16), .O(new_n128_));
  nand2  g81(.a(new_n128_), .b(new_n123_), .O(z16));
  nor2   g82(.a(new_n48_), .b(x17), .O(new_n130_));
  nand4  g83(.a(new_n130_), .b(new_n125_), .c(new_n115_), .d(new_n91_), .O(new_n131_));
  nand2  g84(.a(x27), .b(x17), .O(new_n132_));
  aoi21  g85(.a(new_n132_), .b(new_n131_), .c(new_n86_), .O(z17));
  zero   g86(.O(z14));
  buf    g87(.a(x27), .O(z08));
endmodule
