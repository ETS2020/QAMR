...
module FAU ( 
  ...
  nor2   g66(.a(new_n48_), .b(x17), .O(new_n116_));
  nand4  g67(.a(new_n116_), .b(new_n115_), .c(new_n114_), .d(new_n91_), .O(new_n117_));
  nand2  g68(.a(x27), .b(x17), .O(new_n118_));
  aoi21  g69(.a(new_n118_), .b(new_n117_), .c(new_n86_), .O(z17));
  zero   g70(.O(z13));
  zero   g71(.O(z15));
  zero   g72(.O(z16));
  buf    g73(.a(x27), .O(z08));
