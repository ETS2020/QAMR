...
module FAU ( 
  ...
  nor2   g45(.a(new_n84_), .b(new_n54_), .O(new_n92_));
  ...
  nand2  g49(.a(new_n95_), .b(new_n91_), .O(z11));
  ...
  inv1   g65(.a(x14), .O(new_n113_));
  nand2  g66(.a(x18), .b(x06), .O(new_n114_));
  oai21  g67(.a(x18), .b(new_n113_), .c(new_n114_), .O(new_n115_));
  nand2  g68(.a(new_n115_), .b(new_n87_), .O(new_n116_));
  nor2   g69(.a(x24), .b(x23), .O(new_n117_));
  nand4  g70(.a(new_n117_), .b(new_n101_), .c(new_n74_), .d(new_n51_), .O(new_n118_));
  nand4  g71(.a(new_n66_), .b(new_n63_), .c(new_n60_), .d(new_n57_), .O(new_n119_));
  inv1   g72(.a(new_n119_), .O(new_n120_));
  aoi22  g73(.a(new_n120_), .b(new_n94_), .c(new_n118_), .d(x25), .O(new_n121_));
  oai21  g74(.a(new_n121_), .b(new_n87_), .c(new_n116_), .O(z15));
  nor2   g75(.a(x21), .b(x20), .O(new_n124_));
  nor2   g76(.a(x23), .b(x22), .O(new_n125_));
  nor3   g77(.a(x26), .b(x25), .c(x24), .O(new_n126_));
  nor2   g78(.a(new_n48_), .b(x17), .O(new_n127_));
  nand4  g79(.a(new_n127_), .b(new_n126_), .c(new_n125_), .d(new_n124_), .O(new_n128_));
  nand2  g80(.a(x27), .b(x17), .O(new_n129_));
  aoi21  g81(.a(new_n129_), .b(new_n128_), .c(new_n87_), .O(z17));
  zero   g82(.O(z14));
  zero   g83(.O(z16));
  buf    g84(.a(x27), .O(z08));
endmodule
