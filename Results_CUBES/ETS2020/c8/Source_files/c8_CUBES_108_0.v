...
module FAU ( 
  ...
  nand2  g39(.a(new_n93_), .b(new_n82_), .O(new_n94_));
  nor2   g40(.a(new_n94_), .b(new_n73_), .O(new_n95_));
  oai21  g41(.a(new_n95_), .b(new_n92_), .c(x16), .O(new_n96_));
  nand2  g42(.a(new_n96_), .b(new_n89_), .O(z14));
  nand2  g43(.a(x18), .b(x07), .O(new_n99_));
  oai21  g44(.a(x18), .b(new_n56_), .c(new_n99_), .O(new_n100_));
  nand2  g45(.a(new_n100_), .b(new_n68_), .O(new_n101_));
  nor2   g46(.a(x23), .b(x22), .O(new_n102_));
  nor2   g47(.a(x25), .b(x24), .O(new_n103_));
  nand4  g48(.a(new_n103_), .b(new_n102_), .c(new_n74_), .d(new_n63_), .O(new_n104_));
  nand2  g49(.a(new_n104_), .b(x26), .O(new_n105_));
  nor3   g50(.a(x26), .b(x25), .c(x24), .O(new_n106_));
  nand4  g51(.a(new_n106_), .b(new_n102_), .c(new_n74_), .d(new_n63_), .O(new_n107_));
  ...
  inv1   g55(.a(x19), .O(new_n111_));
  nor2   g56(.a(new_n111_), .b(x17), .O(new_n112_));
  nand4  g57(.a(new_n112_), .b(new_n106_), .c(new_n102_), .d(new_n74_), .O(new_n113_));
  nand2  g58(.a(x27), .b(x17), .O(new_n114_));
  aoi21  g59(.a(new_n114_), .b(new_n113_), .c(new_n68_), .O(z17));
  zero   g60(.O(z00));
  zero   g61(.O(z02));
  zero   g62(.O(z03));
  zero   g63(.O(z04));
