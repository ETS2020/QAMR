...
module FAU ( 
  ...
  nor2   g44(.a(x24), .b(x23), .O(new_n95_));
  nand4  g45(.a(new_n95_), .b(new_n94_), .c(new_n71_), .d(new_n51_), .O(new_n96_));
  inv1   g46(.a(new_n96_), .O(new_n97_));
  oai21  g47(.a(new_n97_), .b(new_n93_), .c(x16), .O(new_n98_));
  nand2  g48(.a(new_n98_), .b(new_n91_), .O(z14));
  nand2  g49(.a(x18), .b(x06), .O(new_n100_));
  oai21  g50(.a(x18), .b(new_n64_), .c(new_n100_), .O(new_n101_));
  nand2  g51(.a(new_n101_), .b(new_n87_), .O(new_n102_));
  nand2  g52(.a(new_n96_), .b(x25), .O(new_n103_));
  nor2   g53(.a(x23), .b(x22), .O(new_n104_));
  nor2   g54(.a(x21), .b(x20), .O(new_n105_));
  nor2   g55(.a(x25), .b(x24), .O(new_n106_));
  nand4  g56(.a(new_n106_), .b(new_n105_), .c(new_n104_), .d(new_n71_), .O(new_n107_));
  nand2  g57(.a(new_n107_), .b(new_n103_), .O(new_n108_));
  nand2  g58(.a(new_n108_), .b(x16), .O(new_n109_));
  nand2  g59(.a(new_n109_), .b(new_n102_), .O(z15));
  nand2  g60(.a(x18), .b(x07), .O(new_n111_));
  oai21  g61(.a(x18), .b(new_n67_), .c(new_n111_), .O(new_n112_));
  nand2  g62(.a(new_n112_), .b(new_n87_), .O(new_n113_));
  nand2  g63(.a(new_n107_), .b(x26), .O(new_n114_));
  nor3   g64(.a(x26), .b(x25), .c(x24), .O(new_n115_));
  nand4  g65(.a(new_n115_), .b(new_n105_), .c(new_n104_), .d(new_n71_), .O(new_n116_));
  nand2  g66(.a(new_n116_), .b(new_n114_), .O(new_n117_));
  nand2  g67(.a(new_n117_), .b(x16), .O(new_n118_));
  nand2  g68(.a(new_n118_), .b(new_n113_), .O(z16));
  nor2   g69(.a(new_n48_), .b(x17), .O(new_n120_));
  nand4  g70(.a(new_n120_), .b(new_n115_), .c(new_n105_), .d(new_n104_), .O(new_n121_));
  nand2  g71(.a(x27), .b(x17), .O(new_n122_));
  aoi21  g72(.a(new_n122_), .b(new_n121_), .c(new_n87_), .O(z17));
  zero   g73(.O(z02));
  zero   g74(.O(z11));
  zero   g75(.O(z12));
  zero   g76(.O(z13));
