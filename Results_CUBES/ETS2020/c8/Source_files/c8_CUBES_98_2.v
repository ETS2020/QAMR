...
module FAU ( 
  ...
  inv1   g25(.a(x12), .O(new_n78_));
  nand2  g26(.a(x18), .b(x04), .O(new_n79_));
  oai21  g27(.a(x18), .b(new_n78_), .c(new_n79_), .O(new_n80_));
  nand2  g28(.a(new_n80_), .b(new_n77_), .O(new_n81_));
  nor3   g29(.a(x20), .b(x19), .c(x17), .O(new_n82_));
  nor2   g30(.a(x22), .b(x21), .O(new_n83_));
  nand3  g31(.a(new_n83_), .b(new_n68_), .c(new_n51_), .O(new_n84_));
  nor3   g32(.a(x23), .b(x22), .c(x21), .O(new_n85_));
  aoi22  g33(.a(new_n85_), .b(new_n82_), .c(new_n84_), .d(x23), .O(new_n86_));
  oai21  g34(.a(new_n86_), .b(new_n77_), .c(new_n81_), .O(z13));
  ...
  aoi21  g40(.a(new_n85_), .b(new_n82_), .c(new_n92_), .O(new_n93_));
  nor2   g41(.a(x24), .b(x23), .O(new_n94_));
  nand4  g42(.a(new_n94_), .b(new_n83_), .c(new_n68_), .d(new_n51_), .O(new_n95_));
  ...
  inv1   g50(.a(x25), .O(new_n103_));
  nand4  g51(.a(new_n103_), .b(new_n92_), .c(new_n48_), .d(new_n66_), .O(new_n104_));
  inv1   g52(.a(new_n104_), .O(new_n105_));
  nand4  g53(.a(new_n60_), .b(new_n57_), .c(new_n54_), .d(new_n51_), .O(new_n106_));
  inv1   g54(.a(new_n106_), .O(new_n107_));
  aoi22  g55(.a(new_n107_), .b(new_n105_), .c(new_n95_), .d(x25), .O(new_n108_));
  oai21  g56(.a(new_n108_), .b(new_n77_), .c(new_n102_), .O(z15));
  nor2   g57(.a(x23), .b(x22), .O(new_n111_));
  nor2   g58(.a(x21), .b(x20), .O(new_n112_));
  nor3   g59(.a(x26), .b(x25), .c(x24), .O(new_n113_));
  nor2   g60(.a(new_n48_), .b(x17), .O(new_n114_));
  nand4  g61(.a(new_n114_), .b(new_n113_), .c(new_n112_), .d(new_n111_), .O(new_n115_));
  nand2  g62(.a(x27), .b(x17), .O(new_n116_));
  aoi21  g63(.a(new_n116_), .b(new_n115_), .c(new_n77_), .O(z17));
  zero   g64(.O(z05));
  zero   g65(.O(z06));
  zero   g66(.O(z07));
  zero   g67(.O(z10));
