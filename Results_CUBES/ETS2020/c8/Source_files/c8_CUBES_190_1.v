...
module FAU ( 
  ...
  inv1   g40(.a(x13), .O(new_n90_));
  nand2  g41(.a(x18), .b(x05), .O(new_n91_));
  ...
  aoi21  g45(.a(new_n94_), .b(new_n83_), .c(new_n63_), .O(new_n95_));
  nor2   g46(.a(x22), .b(x21), .O(new_n96_));
  nor2   g47(.a(x24), .b(x23), .O(new_n97_));
  nand4  g48(.a(new_n97_), .b(new_n96_), .c(new_n73_), .d(new_n51_), .O(new_n98_));
  inv1   g49(.a(new_n98_), .O(new_n99_));
  oai21  g50(.a(new_n99_), .b(new_n95_), .c(x16), .O(new_n100_));
  nand2  g51(.a(new_n100_), .b(new_n93_), .O(z14));
  nand2  g52(.a(x18), .b(x06), .O(new_n102_));
  oai21  g53(.a(x18), .b(new_n66_), .c(new_n102_), .O(new_n103_));
  nand2  g54(.a(new_n103_), .b(new_n89_), .O(new_n104_));
  nand2  g55(.a(new_n98_), .b(x25), .O(new_n105_));
  nor2   g56(.a(x23), .b(x22), .O(new_n106_));
  nor2   g57(.a(x21), .b(x20), .O(new_n107_));
  nor2   g58(.a(x25), .b(x24), .O(new_n108_));
  nand4  g59(.a(new_n108_), .b(new_n107_), .c(new_n106_), .d(new_n73_), .O(new_n109_));
  nand2  g60(.a(new_n109_), .b(new_n105_), .O(new_n110_));
  nand2  g61(.a(new_n110_), .b(x16), .O(new_n111_));
  nand2  g62(.a(new_n111_), .b(new_n104_), .O(z15));
  nand2  g63(.a(x18), .b(x07), .O(new_n113_));
  oai21  g64(.a(x18), .b(new_n69_), .c(new_n113_), .O(new_n114_));
  nand2  g65(.a(new_n114_), .b(new_n89_), .O(new_n115_));
  nand2  g66(.a(new_n109_), .b(x26), .O(new_n116_));
  nor3   g67(.a(x26), .b(x25), .c(x24), .O(new_n117_));
  nand4  g68(.a(new_n117_), .b(new_n107_), .c(new_n106_), .d(new_n73_), .O(new_n118_));
  nand2  g69(.a(new_n118_), .b(new_n116_), .O(new_n119_));
  nand2  g70(.a(new_n119_), .b(x16), .O(new_n120_));
  nand2  g71(.a(new_n120_), .b(new_n115_), .O(z16));
  nor2   g72(.a(new_n48_), .b(x17), .O(new_n122_));
  nand4  g73(.a(new_n122_), .b(new_n117_), .c(new_n107_), .d(new_n106_), .O(new_n123_));
  nand2  g74(.a(x27), .b(x17), .O(new_n124_));
  aoi21  g75(.a(new_n124_), .b(new_n123_), .c(new_n89_), .O(z17));
  zero   g76(.O(z11));
  zero   g77(.O(z12));
  zero   g78(.O(z13));
  buf    g79(.a(x27), .O(z08));
