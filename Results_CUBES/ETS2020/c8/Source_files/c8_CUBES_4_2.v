...
module FAU ( 
  ...
  nor2   g38(.a(new_n78_), .b(new_n54_), .O(new_n86_));
  inv1   g39(.a(x17), .O(new_n87_));
  nand4  g40(.a(new_n54_), .b(new_n51_), .c(new_n48_), .d(new_n87_), .O(new_n88_));
  inv1   g41(.a(new_n88_), .O(new_n89_));
  oai21  g42(.a(new_n89_), .b(new_n86_), .c(x16), .O(new_n90_));
  ...
  aoi22  g49(.a(new_n96_), .b(new_n78_), .c(new_n88_), .d(x22), .O(new_n97_));
  ...
  nand3  g55(.a(new_n96_), .b(new_n76_), .c(new_n51_), .O(new_n103_));
  nor3   g56(.a(x23), .b(x22), .c(x21), .O(new_n104_));
  aoi22  g57(.a(new_n104_), .b(new_n78_), .c(new_n103_), .d(x23), .O(new_n105_));
  ...
  nand4  g64(.a(new_n112_), .b(new_n96_), .c(new_n76_), .d(new_n51_), .O(new_n113_));
