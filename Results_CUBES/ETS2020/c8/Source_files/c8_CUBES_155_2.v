...
module FAU ( 
  ...
  inv1   g56(.a(x14), .O(new_n106_));
  nand2  g57(.a(x18), .b(x06), .O(new_n107_));
  oai21  g58(.a(x18), .b(new_n106_), .c(new_n107_), .O(new_n108_));
  nand2  g59(.a(new_n108_), .b(new_n85_), .O(new_n109_));
  nor2   g60(.a(x24), .b(x23), .O(new_n110_));
  nand4  g61(.a(new_n110_), .b(new_n100_), .c(new_n72_), .d(new_n51_), .O(new_n111_));
  nand4  g62(.a(new_n66_), .b(new_n63_), .c(new_n60_), .d(new_n57_), .O(new_n112_));
  inv1   g63(.a(new_n112_), .O(new_n113_));
  aoi22  g64(.a(new_n113_), .b(new_n92_), .c(new_n111_), .d(x25), .O(new_n114_));
  oai21  g65(.a(new_n114_), .b(new_n85_), .c(new_n109_), .O(z15));
  ...
  aoi21  g72(.a(new_n122_), .b(new_n121_), .c(new_n85_), .O(z17));
  zero   g73(.O(z07));
  zero   g74(.O(z12));
  zero   g75(.O(z14));
  zero   g76(.O(z16));
