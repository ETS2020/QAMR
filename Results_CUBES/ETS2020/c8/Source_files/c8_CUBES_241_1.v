...
module FAU ( 
  ...
  nand2  g32(.a(x18), .b(x02), .O(new_n80_));
  oai21  g33(.a(x18), .b(new_n54_), .c(new_n80_), .O(new_n81_));
  nand2  g34(.a(new_n81_), .b(new_n79_), .O(new_n82_));
  nand2  g35(.a(new_n73_), .b(new_n51_), .O(new_n83_));
  nor2   g36(.a(x21), .b(x20), .O(new_n84_));
  aoi22  g37(.a(new_n84_), .b(new_n73_), .c(new_n83_), .d(x21), .O(new_n85_));
  oai21  g38(.a(new_n85_), .b(new_n79_), .c(new_n82_), .O(z11));
  nand2  g39(.a(x18), .b(x04), .O(new_n88_));
  oai21  g40(.a(x18), .b(new_n60_), .c(new_n88_), .O(new_n89_));
  nand2  g41(.a(new_n89_), .b(new_n79_), .O(new_n90_));
  nor3   g42(.a(x20), .b(x19), .c(x17), .O(new_n91_));
  nor2   g43(.a(x22), .b(x21), .O(new_n92_));
  nand3  g44(.a(new_n92_), .b(new_n73_), .c(new_n51_), .O(new_n93_));
  nor3   g45(.a(x23), .b(x22), .c(x21), .O(new_n94_));
  aoi22  g46(.a(new_n94_), .b(new_n91_), .c(new_n93_), .d(x23), .O(new_n95_));
  oai21  g47(.a(new_n95_), .b(new_n79_), .c(new_n90_), .O(z13));
  nand2  g48(.a(x18), .b(x06), .O(new_n98_));
  oai21  g49(.a(x18), .b(new_n66_), .c(new_n98_), .O(new_n99_));
  nand2  g50(.a(new_n99_), .b(new_n79_), .O(new_n100_));
  nor2   g51(.a(x24), .b(x23), .O(new_n101_));
  nand4  g52(.a(new_n101_), .b(new_n92_), .c(new_n73_), .d(new_n51_), .O(new_n102_));
  nand2  g53(.a(new_n102_), .b(x25), .O(new_n103_));
  nor2   g54(.a(x23), .b(x22), .O(new_n104_));
  nor2   g55(.a(x25), .b(x24), .O(new_n105_));
  nand4  g56(.a(new_n105_), .b(new_n104_), .c(new_n84_), .d(new_n73_), .O(new_n106_));
  nand2  g57(.a(new_n106_), .b(new_n103_), .O(new_n107_));
  nand2  g58(.a(new_n107_), .b(x16), .O(new_n108_));
  nand2  g59(.a(new_n108_), .b(new_n100_), .O(z15));
  nand2  g60(.a(x18), .b(x07), .O(new_n110_));
  oai21  g61(.a(x18), .b(new_n69_), .c(new_n110_), .O(new_n111_));
  nand2  g62(.a(new_n111_), .b(new_n79_), .O(new_n112_));
  nand2  g63(.a(new_n106_), .b(x26), .O(new_n113_));
  nor3   g64(.a(x26), .b(x25), .c(x24), .O(new_n114_));
  nand4  g65(.a(new_n114_), .b(new_n104_), .c(new_n84_), .d(new_n73_), .O(new_n115_));
  nand2  g66(.a(new_n115_), .b(new_n113_), .O(new_n116_));
  nand2  g67(.a(new_n116_), .b(x16), .O(new_n117_));
  nand2  g68(.a(new_n117_), .b(new_n112_), .O(z16));
  zero   g69(.O(z10));
  zero   g70(.O(z12));
  zero   g71(.O(z14));
  zero   g72(.O(z17));
