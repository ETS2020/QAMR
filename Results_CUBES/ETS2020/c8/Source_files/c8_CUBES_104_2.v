...
module FAU ( 
  ...
  nand2  g38(.a(x18), .b(x04), .O(new_n88_));
  oai21  g39(.a(x18), .b(new_n58_), .c(new_n88_), .O(new_n89_));
  nand2  g40(.a(new_n89_), .b(new_n87_), .O(new_n90_));
  nor2   g41(.a(x22), .b(x21), .O(new_n91_));
  nand3  g42(.a(new_n91_), .b(new_n71_), .c(new_n80_), .O(new_n92_));
  nor3   g43(.a(x23), .b(x22), .c(x21), .O(new_n93_));
  aoi22  g44(.a(new_n93_), .b(new_n82_), .c(new_n92_), .d(x23), .O(new_n94_));
  oai21  g45(.a(new_n94_), .b(new_n87_), .c(new_n90_), .O(z13));
  inv1   g46(.a(x13), .O(new_n96_));
  nand2  g47(.a(x18), .b(x05), .O(new_n97_));
  oai21  g48(.a(x18), .b(new_n96_), .c(new_n97_), .O(new_n98_));
  nand2  g49(.a(new_n98_), .b(new_n87_), .O(new_n99_));
  aoi21  g50(.a(new_n93_), .b(new_n82_), .c(new_n61_), .O(new_n100_));
  nor2   g51(.a(x24), .b(x23), .O(new_n101_));
  nand4  g52(.a(new_n101_), .b(new_n91_), .c(new_n71_), .d(new_n80_), .O(new_n102_));
  ...
  nand2  g58(.a(new_n107_), .b(new_n87_), .O(new_n108_));
  nand2  g59(.a(new_n102_), .b(x25), .O(new_n109_));
  nor2   g60(.a(x23), .b(x22), .O(new_n110_));
  nor2   g61(.a(x21), .b(x20), .O(new_n111_));
  nor2   g62(.a(x25), .b(x24), .O(new_n112_));
  nand4  g63(.a(new_n112_), .b(new_n111_), .c(new_n110_), .d(new_n71_), .O(new_n113_));
  nand2  g64(.a(new_n113_), .b(new_n109_), .O(new_n114_));
  nand2  g65(.a(new_n114_), .b(x16), .O(new_n115_));
  nand2  g66(.a(new_n115_), .b(new_n108_), .O(z15));
  nand2  g67(.a(x18), .b(x07), .O(new_n117_));
  oai21  g68(.a(x18), .b(new_n67_), .c(new_n117_), .O(new_n118_));
  nand2  g69(.a(new_n118_), .b(new_n87_), .O(new_n119_));
  nand2  g70(.a(new_n113_), .b(x26), .O(new_n120_));
  nor3   g71(.a(x26), .b(x25), .c(x24), .O(new_n121_));
  nand4  g72(.a(new_n121_), .b(new_n111_), .c(new_n110_), .d(new_n71_), .O(new_n122_));
  ...
  nand4  g77(.a(new_n126_), .b(new_n121_), .c(new_n111_), .d(new_n110_), .O(new_n127_));
  nand2  g78(.a(x27), .b(x17), .O(new_n128_));
  aoi21  g79(.a(new_n128_), .b(new_n127_), .c(new_n87_), .O(z17));
  zero   g80(.O(z01));
  zero   g81(.O(z11));
  zero   g82(.O(z12));
  buf    g83(.a(x27), .O(z08));
