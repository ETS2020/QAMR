...
module FAU ( 
  ...
  inv1   g48(.a(x14), .O(new_n99_));
  nand2  g49(.a(x18), .b(x06), .O(new_n100_));
  oai21  g50(.a(x18), .b(new_n99_), .c(new_n100_), .O(new_n101_));
  nand2  g51(.a(new_n101_), .b(new_n80_), .O(new_n102_));
  inv1   g52(.a(new_n85_), .O(new_n103_));
  nor2   g53(.a(x24), .b(x23), .O(new_n104_));
  nand4  g54(.a(new_n104_), .b(new_n86_), .c(new_n72_), .d(new_n51_), .O(new_n105_));
  inv1   g55(.a(x25), .O(new_n106_));
  nand4  g56(.a(new_n106_), .b(new_n63_), .c(new_n60_), .d(new_n57_), .O(new_n107_));
  inv1   g57(.a(new_n107_), .O(new_n108_));
  aoi22  g58(.a(new_n108_), .b(new_n103_), .c(new_n105_), .d(x25), .O(new_n109_));
  oai21  g59(.a(new_n109_), .b(new_n80_), .c(new_n102_), .O(z15));
  ...
  aoi21  g66(.a(new_n117_), .b(new_n116_), .c(new_n80_), .O(z17));
  zero   g67(.O(z06));
  zero   g68(.O(z10));
  zero   g69(.O(z11));
  zero   g70(.O(z14));
