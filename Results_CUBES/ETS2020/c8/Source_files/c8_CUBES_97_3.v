...
module FAU ( 
  ...
  nand2  g44(.a(new_n92_), .b(new_n79_), .O(new_n93_));
  nor2   g45(.a(x22), .b(x21), .O(new_n94_));
  aoi22  g46(.a(new_n94_), .b(new_n76_), .c(new_n86_), .d(x22), .O(new_n95_));
  oai21  g47(.a(new_n95_), .b(new_n79_), .c(new_n93_), .O(z12));
  ...
  nand3  g52(.a(new_n94_), .b(new_n74_), .c(new_n51_), .O(new_n101_));
  nor3   g53(.a(x23), .b(x22), .c(x21), .O(new_n102_));
  aoi22  g54(.a(new_n102_), .b(new_n76_), .c(new_n101_), .d(x23), .O(new_n103_));
  oai21  g55(.a(new_n103_), .b(new_n79_), .c(new_n100_), .O(z13));
  inv1   g56(.a(x13), .O(new_n105_));
  nand2  g57(.a(x18), .b(x05), .O(new_n106_));
  oai21  g58(.a(x18), .b(new_n105_), .c(new_n106_), .O(new_n107_));
  nand2  g59(.a(new_n107_), .b(new_n79_), .O(new_n108_));
  aoi21  g60(.a(new_n102_), .b(new_n76_), .c(new_n63_), .O(new_n109_));
  nor2   g61(.a(x24), .b(x23), .O(new_n110_));
  nand4  g62(.a(new_n110_), .b(new_n94_), .c(new_n74_), .d(new_n51_), .O(new_n111_));
  ...
  nand2  g69(.a(new_n117_), .b(new_n79_), .O(new_n118_));
  nand4  g70(.a(new_n66_), .b(new_n63_), .c(new_n60_), .d(new_n57_), .O(new_n119_));
  inv1   g71(.a(new_n119_), .O(new_n120_));
  aoi22  g72(.a(new_n120_), .b(new_n87_), .c(new_n111_), .d(x25), .O(new_n121_));
  oai21  g73(.a(new_n121_), .b(new_n79_), .c(new_n118_), .O(z15));
  nor2   g74(.a(x21), .b(x20), .O(new_n124_));
  nor2   g75(.a(x23), .b(x22), .O(new_n125_));
  nor3   g76(.a(x26), .b(x25), .c(x24), .O(new_n126_));
  nor2   g77(.a(new_n48_), .b(x17), .O(new_n127_));
  nand4  g78(.a(new_n127_), .b(new_n126_), .c(new_n125_), .d(new_n124_), .O(new_n128_));
  nand2  g79(.a(x27), .b(x17), .O(new_n129_));
  aoi21  g80(.a(new_n129_), .b(new_n128_), .c(new_n79_), .O(z17));
  zero   g81(.O(z07));
  zero   g82(.O(z09));
  zero   g83(.O(z16));
  buf    g84(.a(x27), .O(z08));
