...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n49_, new_n50_, new_n52_, new_n53_, new_n56_, new_n57_, new_n58_,
  ...
  inv1   g06(.a(x27), .O(new_n56_));
  inv1   g07(.a(x24), .O(new_n57_));
  nand2  g08(.a(new_n56_), .b(new_n57_), .O(new_n58_));
  oai21  g09(.a(new_n56_), .b(x13), .c(new_n58_), .O(z05));
  inv1   g10(.a(x25), .O(new_n60_));
  nand2  g11(.a(new_n56_), .b(new_n60_), .O(new_n61_));
  oai21  g12(.a(new_n56_), .b(x14), .c(new_n61_), .O(z06));
  ...
  oai21  g40(.a(x18), .b(new_n52_), .c(new_n89_), .O(new_n90_));
  nand2  g41(.a(new_n90_), .b(new_n81_), .O(new_n91_));
  nand2  g42(.a(new_n86_), .b(new_n67_), .O(new_n92_));
  nor2   g43(.a(x22), .b(x21), .O(new_n93_));
  aoi22  g44(.a(new_n93_), .b(new_n78_), .c(new_n92_), .d(x22), .O(new_n94_));
  oai21  g45(.a(new_n94_), .b(new_n81_), .c(new_n91_), .O(z12));
  inv1   g46(.a(x12), .O(new_n96_));
  nand2  g47(.a(x18), .b(x04), .O(new_n97_));
  oai21  g48(.a(x18), .b(new_n96_), .c(new_n97_), .O(new_n98_));
  nand2  g49(.a(new_n98_), .b(new_n81_), .O(new_n99_));
  nand3  g50(.a(new_n93_), .b(new_n67_), .c(new_n76_), .O(new_n100_));
  nor3   g51(.a(x23), .b(x22), .c(x21), .O(new_n101_));
  aoi22  g52(.a(new_n101_), .b(new_n78_), .c(new_n100_), .d(x23), .O(new_n102_));
  oai21  g53(.a(new_n102_), .b(new_n81_), .c(new_n99_), .O(z13));
  inv1   g54(.a(x13), .O(new_n104_));
  nand2  g55(.a(x18), .b(x05), .O(new_n105_));
  oai21  g56(.a(x18), .b(new_n104_), .c(new_n105_), .O(new_n106_));
  nand2  g57(.a(new_n106_), .b(new_n81_), .O(new_n107_));
  aoi21  g58(.a(new_n101_), .b(new_n78_), .c(new_n57_), .O(new_n108_));
  nor2   g59(.a(x24), .b(x23), .O(new_n109_));
  nand2  g60(.a(new_n109_), .b(new_n93_), .O(new_n110_));
  nor2   g61(.a(new_n110_), .b(new_n85_), .O(new_n111_));
  oai21  g62(.a(new_n111_), .b(new_n108_), .c(x16), .O(new_n112_));
  nand2  g63(.a(new_n112_), .b(new_n107_), .O(z14));
  nand2  g64(.a(x18), .b(x07), .O(new_n115_));
  oai21  g65(.a(x18), .b(new_n63_), .c(new_n115_), .O(new_n116_));
  nand2  g66(.a(new_n116_), .b(new_n81_), .O(new_n117_));
  nor2   g67(.a(x23), .b(x22), .O(new_n118_));
  nor2   g68(.a(x25), .b(x24), .O(new_n119_));
  nand4  g69(.a(new_n119_), .b(new_n118_), .c(new_n86_), .d(new_n67_), .O(new_n120_));
  nand2  g70(.a(new_n120_), .b(x26), .O(new_n121_));
  nor3   g71(.a(x26), .b(x25), .c(x24), .O(new_n122_));
  nand4  g72(.a(new_n122_), .b(new_n118_), .c(new_n86_), .d(new_n67_), .O(new_n123_));
  nand2  g73(.a(new_n123_), .b(new_n121_), .O(new_n124_));
  nand2  g74(.a(new_n124_), .b(x16), .O(new_n125_));
  nand2  g75(.a(new_n125_), .b(new_n117_), .O(z16));
  zero   g76(.O(z00));
  zero   g77(.O(z01));
  zero   g78(.O(z04));
  zero   g79(.O(z15));
