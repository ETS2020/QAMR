...
module FAU ( 
  ...
  oai21  g39(.a(x18), .b(new_n60_), .c(new_n88_), .O(new_n89_));
  nand2  g40(.a(new_n89_), .b(new_n79_), .O(new_n90_));
  nor2   g41(.a(x22), .b(x21), .O(new_n91_));
  nand3  g42(.a(new_n91_), .b(new_n74_), .c(new_n51_), .O(new_n92_));
  nor3   g43(.a(x23), .b(x22), .c(x21), .O(new_n93_));
  aoi22  g44(.a(new_n93_), .b(new_n76_), .c(new_n92_), .d(x23), .O(new_n94_));
  oai21  g45(.a(new_n94_), .b(new_n79_), .c(new_n90_), .O(z13));
  ...
  aoi21  g50(.a(new_n93_), .b(new_n76_), .c(new_n63_), .O(new_n100_));
  nor2   g51(.a(x24), .b(x23), .O(new_n101_));
  nand4  g52(.a(new_n101_), .b(new_n91_), .c(new_n74_), .d(new_n51_), .O(new_n102_));
  ...
  nand2  g59(.a(new_n108_), .b(new_n79_), .O(new_n109_));
  nand2  g60(.a(new_n102_), .b(x25), .O(new_n110_));
  nor2   g61(.a(x23), .b(x22), .O(new_n111_));
  nor2   g62(.a(x25), .b(x24), .O(new_n112_));
  nand4  g63(.a(new_n112_), .b(new_n111_), .c(new_n84_), .d(new_n74_), .O(new_n113_));
  ...
  nand4  g72(.a(new_n121_), .b(new_n111_), .c(new_n84_), .d(new_n74_), .O(new_n122_));
