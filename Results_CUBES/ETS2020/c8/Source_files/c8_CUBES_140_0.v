...
module FAU ( 
  ...
  inv1   g23(.a(x13), .O(new_n80_));
  nand2  g24(.a(x18), .b(x05), .O(new_n81_));
  oai21  g25(.a(x18), .b(new_n80_), .c(new_n81_), .O(new_n82_));
  nand2  g26(.a(new_n82_), .b(new_n59_), .O(new_n83_));
  inv1   g27(.a(x24), .O(new_n84_));
  nor3   g28(.a(x23), .b(x22), .c(x21), .O(new_n85_));
  aoi21  g29(.a(new_n85_), .b(new_n74_), .c(new_n84_), .O(new_n86_));
  nor2   g30(.a(x24), .b(x23), .O(new_n87_));
  nand2  g31(.a(new_n87_), .b(new_n76_), .O(new_n88_));
  nor2   g32(.a(new_n88_), .b(new_n66_), .O(new_n89_));
  oai21  g33(.a(new_n89_), .b(new_n86_), .c(x16), .O(new_n90_));
  nand2  g34(.a(new_n90_), .b(new_n83_), .O(z14));
  nand2  g35(.a(x18), .b(x07), .O(new_n93_));
  oai21  g36(.a(x18), .b(new_n54_), .c(new_n93_), .O(new_n94_));
  nand2  g37(.a(new_n94_), .b(new_n59_), .O(new_n95_));
  nor2   g38(.a(x23), .b(x22), .O(new_n96_));
  nor2   g39(.a(x25), .b(x24), .O(new_n97_));
  nand4  g40(.a(new_n97_), .b(new_n96_), .c(new_n67_), .d(new_n64_), .O(new_n98_));
  nand2  g41(.a(new_n98_), .b(x26), .O(new_n99_));
  nor3   g42(.a(x26), .b(x25), .c(x24), .O(new_n100_));
  nand4  g43(.a(new_n100_), .b(new_n96_), .c(new_n67_), .d(new_n64_), .O(new_n101_));
  nand2  g44(.a(new_n101_), .b(new_n99_), .O(new_n102_));
  nand2  g45(.a(new_n102_), .b(x16), .O(new_n103_));
  nand2  g46(.a(new_n103_), .b(new_n95_), .O(z16));
  inv1   g47(.a(x19), .O(new_n105_));
  nor2   g48(.a(new_n105_), .b(x17), .O(new_n106_));
  nand4  g49(.a(new_n106_), .b(new_n100_), .c(new_n96_), .d(new_n67_), .O(new_n107_));
  nand2  g50(.a(x27), .b(x17), .O(new_n108_));
  aoi21  g51(.a(new_n108_), .b(new_n107_), .c(new_n59_), .O(z17));
  zero   g52(.O(z00));
  zero   g53(.O(z01));
  zero   g54(.O(z02));
  zero   g55(.O(z03));
