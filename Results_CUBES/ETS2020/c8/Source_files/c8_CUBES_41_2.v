// Benchmark "FAU" written by ABC on Mon Jul  6 18:49:50 2020
...
module FAU ( 
  ...
  inv1   g31(.a(x09), .O(new_n79_));
  nor2   g32(.a(x18), .b(new_n79_), .O(new_n80_));
  aoi21  g33(.a(x18), .b(x01), .c(new_n80_), .O(new_n81_));
  nor2   g34(.a(new_n73_), .b(new_n49_), .O(new_n82_));
  nor3   g35(.a(x20), .b(x19), .c(x17), .O(new_n83_));
  oai21  g36(.a(new_n83_), .b(new_n82_), .c(x16), .O(new_n84_));
  oai21  g37(.a(new_n81_), .b(x16), .c(new_n84_), .O(z10));
  inv1   g38(.a(x16), .O(new_n86_));
  inv1   g39(.a(x10), .O(new_n87_));
  nand2  g40(.a(x18), .b(x02), .O(new_n88_));
  oai21  g41(.a(x18), .b(new_n87_), .c(new_n88_), .O(new_n89_));
  nand2  g42(.a(new_n89_), .b(new_n86_), .O(new_n90_));
  nor2   g43(.a(new_n83_), .b(new_n52_), .O(new_n91_));
  nand4  g44(.a(new_n52_), .b(new_n49_), .c(new_n71_), .d(new_n70_), .O(new_n92_));
  inv1   g45(.a(new_n92_), .O(new_n93_));
  oai21  g46(.a(new_n93_), .b(new_n91_), .c(x16), .O(new_n94_));
  nand2  g47(.a(new_n94_), .b(new_n90_), .O(z11));
  inv1   g48(.a(x12), .O(new_n97_));
  nand2  g49(.a(x18), .b(x04), .O(new_n98_));
  oai21  g50(.a(x18), .b(new_n97_), .c(new_n98_), .O(new_n99_));
  nand2  g51(.a(new_n99_), .b(new_n86_), .O(new_n100_));
  nor2   g52(.a(x22), .b(x21), .O(new_n101_));
  nand3  g53(.a(new_n101_), .b(new_n73_), .c(new_n49_), .O(new_n102_));
  nor3   g54(.a(x23), .b(x22), .c(x21), .O(new_n103_));
  aoi22  g55(.a(new_n103_), .b(new_n83_), .c(new_n102_), .d(x23), .O(new_n104_));
  oai21  g56(.a(new_n104_), .b(new_n86_), .c(new_n100_), .O(z13));
  inv1   g57(.a(x14), .O(new_n107_));
  nand2  g58(.a(x18), .b(x06), .O(new_n108_));
  oai21  g59(.a(x18), .b(new_n107_), .c(new_n108_), .O(new_n109_));
  nand2  g60(.a(new_n109_), .b(new_n86_), .O(new_n110_));
  nor2   g61(.a(x24), .b(x23), .O(new_n111_));
  nand4  g62(.a(new_n111_), .b(new_n101_), .c(new_n73_), .d(new_n49_), .O(new_n112_));
  nand4  g63(.a(new_n64_), .b(new_n61_), .c(new_n58_), .d(new_n55_), .O(new_n113_));
  inv1   g64(.a(new_n113_), .O(new_n114_));
  aoi22  g65(.a(new_n114_), .b(new_n93_), .c(new_n112_), .d(x25), .O(new_n115_));
  oai21  g66(.a(new_n115_), .b(new_n86_), .c(new_n110_), .O(z15));
  nor2   g67(.a(x21), .b(x20), .O(new_n118_));
  nor2   g68(.a(x23), .b(x22), .O(new_n119_));
  nor3   g69(.a(x26), .b(x25), .c(x24), .O(new_n120_));
  nor2   g70(.a(new_n71_), .b(x17), .O(new_n121_));
  nand4  g71(.a(new_n121_), .b(new_n120_), .c(new_n119_), .d(new_n118_), .O(new_n122_));
  nand2  g72(.a(x27), .b(x17), .O(new_n123_));
  aoi21  g73(.a(new_n123_), .b(new_n122_), .c(new_n86_), .O(z17));
  zero   g74(.O(z00));
  zero   g75(.O(z12));
  zero   g76(.O(z14));
  zero   g77(.O(z16));
