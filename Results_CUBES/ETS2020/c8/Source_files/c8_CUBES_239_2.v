...
module FAU ( 
  ...
  nand3  g39(.a(new_n89_), .b(new_n72_), .c(new_n49_), .O(new_n90_));
  nor3   g40(.a(x23), .b(x22), .c(x21), .O(new_n91_));
  aoi22  g41(.a(new_n91_), .b(new_n74_), .c(new_n90_), .d(x23), .O(new_n92_));
  oai21  g42(.a(new_n92_), .b(new_n77_), .c(new_n88_), .O(z13));
  ...
  nand4  g47(.a(new_n98_), .b(new_n89_), .c(new_n72_), .d(new_n49_), .O(new_n99_));
  nand2  g48(.a(new_n99_), .b(x25), .O(new_n100_));
  nor2   g49(.a(x23), .b(x22), .O(new_n101_));
  nor2   g50(.a(x25), .b(x24), .O(new_n102_));
  nand4  g51(.a(new_n102_), .b(new_n101_), .c(new_n82_), .d(new_n72_), .O(new_n103_));
  ...
  nand4  g60(.a(new_n111_), .b(new_n101_), .c(new_n82_), .d(new_n72_), .O(new_n112_));
  ...
  inv1   g64(.a(x19), .O(new_n116_));
  nor2   g65(.a(new_n116_), .b(x17), .O(new_n117_));
  nand4  g66(.a(new_n117_), .b(new_n111_), .c(new_n101_), .d(new_n82_), .O(new_n118_));
  nand2  g67(.a(x27), .b(x17), .O(new_n119_));
  aoi21  g68(.a(new_n119_), .b(new_n118_), .c(new_n77_), .O(z17));
  zero   g69(.O(z00));
  zero   g70(.O(z05));
  zero   g71(.O(z09));
  zero   g72(.O(z12));
