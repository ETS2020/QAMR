...
module FAU ( 
  ...
  nand2  g33(.a(new_n71_), .b(new_n49_), .O(new_n83_));
  nand4  g34(.a(new_n52_), .b(new_n49_), .c(new_n69_), .d(new_n68_), .O(new_n84_));
  inv1   g35(.a(new_n84_), .O(new_n85_));
  aoi21  g36(.a(new_n83_), .b(x21), .c(new_n85_), .O(new_n86_));
  oai21  g37(.a(new_n86_), .b(new_n78_), .c(new_n82_), .O(z11));
  inv1   g38(.a(x11), .O(new_n88_));
  nand2  g39(.a(x18), .b(x03), .O(new_n89_));
  oai21  g40(.a(x18), .b(new_n88_), .c(new_n89_), .O(new_n90_));
  nand2  g41(.a(new_n90_), .b(new_n78_), .O(new_n91_));
  nor3   g42(.a(x20), .b(x19), .c(x17), .O(new_n92_));
  nor2   g43(.a(x22), .b(x21), .O(new_n93_));
  aoi22  g44(.a(new_n93_), .b(new_n92_), .c(new_n84_), .d(x22), .O(new_n94_));
  oai21  g45(.a(new_n94_), .b(new_n78_), .c(new_n91_), .O(z12));
  inv1   g46(.a(x13), .O(new_n97_));
  nand2  g47(.a(x18), .b(x05), .O(new_n98_));
  oai21  g48(.a(x18), .b(new_n97_), .c(new_n98_), .O(new_n99_));
  nand2  g49(.a(new_n99_), .b(new_n78_), .O(new_n100_));
  inv1   g50(.a(x24), .O(new_n101_));
  nor3   g51(.a(x23), .b(x22), .c(x21), .O(new_n102_));
  aoi21  g52(.a(new_n102_), .b(new_n92_), .c(new_n101_), .O(new_n103_));
  nor2   g53(.a(x24), .b(x23), .O(new_n104_));
  nand4  g54(.a(new_n104_), .b(new_n93_), .c(new_n71_), .d(new_n49_), .O(new_n105_));
  inv1   g55(.a(new_n105_), .O(new_n106_));
  oai21  g56(.a(new_n106_), .b(new_n103_), .c(x16), .O(new_n107_));
  nand2  g57(.a(new_n107_), .b(new_n100_), .O(z14));
  inv1   g58(.a(x14), .O(new_n109_));
  nand2  g59(.a(x18), .b(x06), .O(new_n110_));
  oai21  g60(.a(x18), .b(new_n109_), .c(new_n110_), .O(new_n111_));
  nand2  g61(.a(new_n111_), .b(new_n78_), .O(new_n112_));
  nand4  g62(.a(new_n62_), .b(new_n101_), .c(new_n58_), .d(new_n55_), .O(new_n113_));
  inv1   g63(.a(new_n113_), .O(new_n114_));
  aoi22  g64(.a(new_n114_), .b(new_n85_), .c(new_n105_), .d(x25), .O(new_n115_));
  oai21  g65(.a(new_n115_), .b(new_n78_), .c(new_n112_), .O(z15));
  nor2   g66(.a(x21), .b(x20), .O(new_n118_));
  nor2   g67(.a(x23), .b(x22), .O(new_n119_));
  nor3   g68(.a(x26), .b(x25), .c(x24), .O(new_n120_));
  nor2   g69(.a(new_n69_), .b(x17), .O(new_n121_));
  nand4  g70(.a(new_n121_), .b(new_n120_), .c(new_n119_), .d(new_n118_), .O(new_n122_));
  nand2  g71(.a(x27), .b(x17), .O(new_n123_));
  aoi21  g72(.a(new_n123_), .b(new_n122_), .c(new_n78_), .O(z17));
  zero   g73(.O(z00));
  zero   g74(.O(z05));
  zero   g75(.O(z10));
  zero   g76(.O(z13));
