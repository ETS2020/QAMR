...
module FAU ( 
  ...
  inv1   g47(.a(x13), .O(new_n96_));
  nand2  g48(.a(x18), .b(x05), .O(new_n97_));
  ...
  aoi21  g52(.a(new_n100_), .b(new_n83_), .c(new_n63_), .O(new_n101_));
  nor2   g53(.a(x22), .b(x21), .O(new_n102_));
  nor2   g54(.a(x24), .b(x23), .O(new_n103_));
  nand4  g55(.a(new_n103_), .b(new_n102_), .c(new_n73_), .d(new_n51_), .O(new_n104_));
  inv1   g56(.a(new_n104_), .O(new_n105_));
  oai21  g57(.a(new_n105_), .b(new_n101_), .c(x16), .O(new_n106_));
  nand2  g58(.a(new_n106_), .b(new_n99_), .O(z14));
  nand2  g59(.a(x18), .b(x06), .O(new_n108_));
  oai21  g60(.a(x18), .b(new_n66_), .c(new_n108_), .O(new_n109_));
  nand2  g61(.a(new_n109_), .b(new_n86_), .O(new_n110_));
  nand2  g62(.a(new_n104_), .b(x25), .O(new_n111_));
  nor2   g63(.a(x23), .b(x22), .O(new_n112_));
  nor2   g64(.a(x25), .b(x24), .O(new_n113_));
  nand4  g65(.a(new_n113_), .b(new_n112_), .c(new_n91_), .d(new_n73_), .O(new_n114_));
  ...
  nand2  g71(.a(new_n119_), .b(new_n86_), .O(new_n120_));
  nand2  g72(.a(new_n114_), .b(x26), .O(new_n121_));
  nor3   g73(.a(x26), .b(x25), .c(x24), .O(new_n122_));
  nand4  g74(.a(new_n122_), .b(new_n112_), .c(new_n91_), .d(new_n73_), .O(new_n123_));
  ...
  nand4  g79(.a(new_n127_), .b(new_n122_), .c(new_n112_), .d(new_n91_), .O(new_n128_));
  nand2  g80(.a(x27), .b(x17), .O(new_n129_));
  aoi21  g81(.a(new_n129_), .b(new_n128_), .c(new_n86_), .O(z17));
  zero   g82(.O(z12));
  zero   g83(.O(z13));
  buf    g84(.a(x27), .O(z08));
endmodule
