...
module FAU ( 
  ...
  oai21  g43(.a(x18), .b(new_n55_), .c(new_n92_), .O(new_n93_));
  ...
  aoi21  g55(.a(new_n105_), .b(new_n80_), .c(new_n104_), .O(new_n106_));
  nor2   g56(.a(x24), .b(x23), .O(new_n107_));
  nand4  g57(.a(new_n107_), .b(new_n96_), .c(new_n70_), .d(new_n51_), .O(new_n108_));
  inv1   g58(.a(new_n108_), .O(new_n109_));
  oai21  g59(.a(new_n109_), .b(new_n106_), .c(x16), .O(new_n110_));
  nand2  g60(.a(new_n110_), .b(new_n103_), .O(z14));
  nand2  g61(.a(x18), .b(x06), .O(new_n112_));
  oai21  g62(.a(x18), .b(new_n62_), .c(new_n112_), .O(new_n113_));
  nand2  g63(.a(new_n113_), .b(new_n83_), .O(new_n114_));
  nand2  g64(.a(new_n108_), .b(x25), .O(new_n115_));
  nor2   g65(.a(x23), .b(x22), .O(new_n116_));
  nor2   g66(.a(x25), .b(x24), .O(new_n117_));
  nand4  g67(.a(new_n117_), .b(new_n116_), .c(new_n89_), .d(new_n70_), .O(new_n118_));
  nand2  g68(.a(new_n118_), .b(new_n115_), .O(new_n119_));
  nand2  g69(.a(new_n119_), .b(x16), .O(new_n120_));
  nand2  g70(.a(new_n120_), .b(new_n114_), .O(z15));
  nand2  g71(.a(x18), .b(x07), .O(new_n122_));
  oai21  g72(.a(x18), .b(new_n65_), .c(new_n122_), .O(new_n123_));
  nand2  g73(.a(new_n123_), .b(new_n83_), .O(new_n124_));
  nand2  g74(.a(new_n118_), .b(x26), .O(new_n125_));
  nor3   g75(.a(x26), .b(x25), .c(x24), .O(new_n126_));
  nand4  g76(.a(new_n126_), .b(new_n116_), .c(new_n89_), .d(new_n70_), .O(new_n127_));
  ...
  nand4  g81(.a(new_n131_), .b(new_n126_), .c(new_n116_), .d(new_n89_), .O(new_n132_));
  nand2  g82(.a(x27), .b(x17), .O(new_n133_));
  aoi21  g83(.a(new_n133_), .b(new_n132_), .c(new_n83_), .O(z17));
  zero   g84(.O(z02));
  zero   g85(.O(z05));
  zero   g86(.O(z08));
  zero   g87(.O(z13));
