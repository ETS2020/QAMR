...
module FAU ( 
  ...
  nand2  g52(.a(new_n101_), .b(new_n89_), .O(new_n102_));
  nor3   g53(.a(x23), .b(x22), .c(x21), .O(new_n103_));
  aoi21  g54(.a(new_n103_), .b(new_n85_), .c(new_n63_), .O(new_n104_));
  ...
  nand2  g63(.a(new_n112_), .b(new_n89_), .O(new_n113_));
  inv1   g64(.a(new_n94_), .O(new_n114_));
  nand4  g65(.a(new_n66_), .b(new_n63_), .c(new_n60_), .d(new_n57_), .O(new_n115_));
  inv1   g66(.a(new_n115_), .O(new_n116_));
  aoi22  g67(.a(new_n116_), .b(new_n114_), .c(new_n106_), .d(x25), .O(new_n117_));
  oai21  g68(.a(new_n117_), .b(new_n89_), .c(new_n113_), .O(z15));
  ...
  aoi21  g75(.a(new_n125_), .b(new_n124_), .c(new_n89_), .O(z17));
  zero   g76(.O(z08));
  zero   g77(.O(z11));
  zero   g78(.O(z13));
  zero   g79(.O(z16));
