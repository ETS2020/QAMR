...
module FAU ( 
  ...
  nand2  g30(.a(new_n65_), .b(new_n51_), .O(new_n81_));
  nor2   g31(.a(x21), .b(x20), .O(new_n82_));
  aoi22  g32(.a(new_n82_), .b(new_n65_), .c(new_n81_), .d(x21), .O(new_n83_));
  ...
  nand2  g38(.a(new_n82_), .b(new_n65_), .O(new_n89_));
  ...
  nand3  g46(.a(new_n90_), .b(new_n65_), .c(new_n51_), .O(new_n97_));
  ...
  inv1   g50(.a(x13), .O(new_n101_));
  nand2  g51(.a(x18), .b(x05), .O(new_n102_));
  oai21  g52(.a(x18), .b(new_n101_), .c(new_n102_), .O(new_n103_));
  nand2  g53(.a(new_n103_), .b(new_n77_), .O(new_n104_));
  inv1   g54(.a(x24), .O(new_n105_));
  aoi21  g55(.a(new_n98_), .b(new_n74_), .c(new_n105_), .O(new_n106_));
  nand3  g56(.a(new_n90_), .b(new_n105_), .c(new_n58_), .O(new_n107_));
  nor2   g57(.a(new_n107_), .b(new_n81_), .O(new_n108_));
  oai21  g58(.a(new_n108_), .b(new_n106_), .c(x16), .O(new_n109_));
  nand2  g59(.a(new_n109_), .b(new_n104_), .O(z14));
  inv1   g60(.a(x15), .O(new_n112_));
  nand2  g61(.a(x18), .b(x07), .O(new_n113_));
  oai21  g62(.a(x18), .b(new_n112_), .c(new_n113_), .O(new_n114_));
  nand2  g63(.a(new_n114_), .b(new_n77_), .O(new_n115_));
  nor2   g64(.a(x23), .b(x22), .O(new_n116_));
  nor2   g65(.a(x25), .b(x24), .O(new_n117_));
  nand4  g66(.a(new_n117_), .b(new_n116_), .c(new_n82_), .d(new_n65_), .O(new_n118_));
  nand2  g67(.a(new_n118_), .b(x26), .O(new_n119_));
  nor3   g68(.a(x26), .b(x25), .c(x24), .O(new_n120_));
  nand4  g69(.a(new_n120_), .b(new_n116_), .c(new_n82_), .d(new_n65_), .O(new_n121_));
