...
module FAU ( 
  ...
  nand2  g28(.a(x18), .b(x04), .O(new_n83_));
  oai21  g29(.a(x18), .b(new_n54_), .c(new_n83_), .O(new_n84_));
  nand2  g30(.a(new_n84_), .b(new_n72_), .O(new_n85_));
  nand3  g31(.a(new_n79_), .b(new_n64_), .c(new_n49_), .O(new_n86_));
  nor3   g32(.a(x23), .b(x22), .c(x21), .O(new_n87_));
  aoi22  g33(.a(new_n87_), .b(new_n80_), .c(new_n86_), .d(x23), .O(new_n88_));
  oai21  g34(.a(new_n88_), .b(new_n72_), .c(new_n85_), .O(z13));
  inv1   g35(.a(x13), .O(new_n90_));
  nand2  g36(.a(x18), .b(x05), .O(new_n91_));
  oai21  g37(.a(x18), .b(new_n90_), .c(new_n91_), .O(new_n92_));
  nand2  g38(.a(new_n92_), .b(new_n72_), .O(new_n93_));
  inv1   g39(.a(x24), .O(new_n94_));
  aoi21  g40(.a(new_n87_), .b(new_n80_), .c(new_n94_), .O(new_n95_));
  nor2   g41(.a(x24), .b(x23), .O(new_n96_));
  nand4  g42(.a(new_n96_), .b(new_n79_), .c(new_n64_), .d(new_n49_), .O(new_n97_));
  inv1   g43(.a(new_n97_), .O(new_n98_));
  oai21  g44(.a(new_n98_), .b(new_n95_), .c(x16), .O(new_n99_));
  nand2  g45(.a(new_n99_), .b(new_n93_), .O(z14));
  inv1   g46(.a(x14), .O(new_n101_));
  nand2  g47(.a(x18), .b(x06), .O(new_n102_));
  oai21  g48(.a(x18), .b(new_n101_), .c(new_n102_), .O(new_n103_));
  nand2  g49(.a(new_n103_), .b(new_n72_), .O(new_n104_));
  nand2  g50(.a(new_n97_), .b(x25), .O(new_n105_));
  nor2   g51(.a(x23), .b(x22), .O(new_n106_));
  nor2   g52(.a(x25), .b(x24), .O(new_n107_));
  nand4  g53(.a(new_n107_), .b(new_n106_), .c(new_n77_), .d(new_n64_), .O(new_n108_));
  nand2  g54(.a(new_n108_), .b(new_n105_), .O(new_n109_));
  nand2  g55(.a(new_n109_), .b(x16), .O(new_n110_));
  nand2  g56(.a(new_n110_), .b(new_n104_), .O(z15));
  nand2  g57(.a(x18), .b(x07), .O(new_n112_));
  oai21  g58(.a(x18), .b(new_n59_), .c(new_n112_), .O(new_n113_));
  nand2  g59(.a(new_n113_), .b(new_n72_), .O(new_n114_));
  nand2  g60(.a(new_n108_), .b(x26), .O(new_n115_));
  nor3   g61(.a(x26), .b(x25), .c(x24), .O(new_n116_));
  nand4  g62(.a(new_n116_), .b(new_n106_), .c(new_n77_), .d(new_n64_), .O(new_n117_));
  nand2  g63(.a(new_n117_), .b(new_n115_), .O(new_n118_));
  nand2  g64(.a(new_n118_), .b(x16), .O(new_n119_));
  nand2  g65(.a(new_n119_), .b(new_n114_), .O(z16));
  inv1   g66(.a(x19), .O(new_n121_));
  nor2   g67(.a(new_n121_), .b(x17), .O(new_n122_));
  nand4  g68(.a(new_n122_), .b(new_n116_), .c(new_n106_), .d(new_n77_), .O(new_n123_));
