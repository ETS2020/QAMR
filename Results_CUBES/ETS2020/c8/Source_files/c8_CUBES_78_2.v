...
module FAU ( 
  ...
  inv1   g68(.a(x24), .O(new_n117_));
  nand4  g69(.a(new_n64_), .b(new_n117_), .c(new_n60_), .d(new_n57_), .O(new_n118_));
  inv1   g70(.a(new_n118_), .O(new_n119_));
  aoi22  g71(.a(new_n119_), .b(new_n92_), .c(new_n116_), .d(x25), .O(new_n120_));
  oai21  g72(.a(new_n120_), .b(new_n85_), .c(new_n114_), .O(z15));
