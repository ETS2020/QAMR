...
module FAU ( 
  ...
  wire new_n47_, new_n48_, new_n49_, new_n52_, new_n53_, new_n55_, new_n56_,
    ...
    new_n84_, new_n89_, new_n90_, new_n91_, new_n92_, new_n93_, new_n94_,
  ...
  nor2   g34(.a(new_n72_), .b(new_n81_), .O(new_n82_));
  nor3   g35(.a(x20), .b(x19), .c(x17), .O(new_n83_));
  oai21  g36(.a(new_n83_), .b(new_n82_), .c(x16), .O(new_n84_));
  oai21  g37(.a(new_n80_), .b(x16), .c(new_n84_), .O(z10));
  inv1   g38(.a(x16), .O(new_n89_));
  inv1   g39(.a(x13), .O(new_n90_));
  nand2  g40(.a(x18), .b(x05), .O(new_n91_));
  ...
  aoi21  g44(.a(new_n94_), .b(new_n83_), .c(new_n61_), .O(new_n95_));
  nor2   g45(.a(x22), .b(x21), .O(new_n96_));
  nor2   g46(.a(x24), .b(x23), .O(new_n97_));
  nand4  g47(.a(new_n97_), .b(new_n96_), .c(new_n72_), .d(new_n81_), .O(new_n98_));
  inv1   g48(.a(new_n98_), .O(new_n99_));
  oai21  g49(.a(new_n99_), .b(new_n95_), .c(x16), .O(new_n100_));
  nand2  g50(.a(new_n100_), .b(new_n93_), .O(z14));
  inv1   g51(.a(x14), .O(new_n102_));
  nand2  g52(.a(x18), .b(x06), .O(new_n103_));
  oai21  g53(.a(x18), .b(new_n102_), .c(new_n103_), .O(new_n104_));
  nand2  g54(.a(new_n104_), .b(new_n89_), .O(new_n105_));
  nand4  g55(.a(new_n64_), .b(new_n61_), .c(new_n48_), .d(new_n70_), .O(new_n106_));
  inv1   g56(.a(new_n106_), .O(new_n107_));
  nand4  g57(.a(new_n58_), .b(new_n55_), .c(new_n52_), .d(new_n81_), .O(new_n108_));
  inv1   g58(.a(new_n108_), .O(new_n109_));
  aoi22  g59(.a(new_n109_), .b(new_n107_), .c(new_n98_), .d(x25), .O(new_n110_));
  oai21  g60(.a(new_n110_), .b(new_n89_), .c(new_n105_), .O(z15));
  nor2   g61(.a(x23), .b(x22), .O(new_n113_));
  nor2   g62(.a(x21), .b(x20), .O(new_n114_));
  nor3   g63(.a(x26), .b(x25), .c(x24), .O(new_n115_));
  nor2   g64(.a(new_n48_), .b(x17), .O(new_n116_));
  nand4  g65(.a(new_n116_), .b(new_n115_), .c(new_n114_), .d(new_n113_), .O(new_n117_));
  nand2  g66(.a(x27), .b(x17), .O(new_n118_));
  aoi21  g67(.a(new_n118_), .b(new_n117_), .c(new_n89_), .O(z17));
  zero   g68(.O(z01));
  zero   g69(.O(z11));
  zero   g70(.O(z12));
  zero   g71(.O(z13));
