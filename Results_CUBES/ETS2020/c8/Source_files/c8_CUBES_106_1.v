...
module FAU ( 
  ...
  nand3  g38(.a(new_n88_), .b(new_n77_), .c(new_n51_), .O(new_n89_));
  nor3   g39(.a(x23), .b(x22), .c(x21), .O(new_n90_));
  aoi22  g40(.a(new_n90_), .b(new_n79_), .c(new_n89_), .d(x23), .O(new_n91_));
  oai21  g41(.a(new_n91_), .b(new_n84_), .c(new_n87_), .O(z13));
  nand2  g42(.a(x18), .b(x06), .O(new_n94_));
  oai21  g43(.a(x18), .b(new_n66_), .c(new_n94_), .O(new_n95_));
  nand2  g44(.a(new_n95_), .b(new_n84_), .O(new_n96_));
  nor2   g45(.a(x24), .b(x23), .O(new_n97_));
  nand4  g46(.a(new_n97_), .b(new_n88_), .c(new_n77_), .d(new_n51_), .O(new_n98_));
  nand2  g47(.a(new_n98_), .b(x25), .O(new_n99_));
  nor2   g48(.a(x23), .b(x22), .O(new_n100_));
  nor2   g49(.a(x21), .b(x20), .O(new_n101_));
  ...
  nand2  g54(.a(new_n105_), .b(new_n96_), .O(z15));
  nand2  g55(.a(x18), .b(x07), .O(new_n107_));
  oai21  g56(.a(x18), .b(new_n69_), .c(new_n107_), .O(new_n108_));
  ...
  nand4  g60(.a(new_n111_), .b(new_n101_), .c(new_n100_), .d(new_n77_), .O(new_n112_));
