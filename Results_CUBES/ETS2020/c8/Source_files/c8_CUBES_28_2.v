...
module FAU ( 
  ...
  nand2  g61(.a(new_n109_), .b(new_n84_), .O(new_n110_));
  nor2   g62(.a(x24), .b(x23), .O(new_n111_));
  nand4  g63(.a(new_n111_), .b(new_n96_), .c(new_n71_), .d(new_n51_), .O(new_n112_));
  nand2  g64(.a(new_n112_), .b(x25), .O(new_n113_));
  nor2   g65(.a(x23), .b(x22), .O(new_n114_));
  nor2   g66(.a(x25), .b(x24), .O(new_n115_));
  nand4  g67(.a(new_n115_), .b(new_n114_), .c(new_n89_), .d(new_n71_), .O(new_n116_));
  ...
  nand4  g76(.a(new_n124_), .b(new_n114_), .c(new_n89_), .d(new_n71_), .O(new_n125_));
  ...
  nand4  g81(.a(new_n129_), .b(new_n124_), .c(new_n114_), .d(new_n89_), .O(new_n130_));
