...
module FAU ( 
  ...
  nor2   g42(.a(new_n82_), .b(new_n54_), .O(new_n90_));
  nand4  g43(.a(new_n54_), .b(new_n51_), .c(new_n48_), .d(new_n70_), .O(new_n91_));
  inv1   g44(.a(new_n91_), .O(new_n92_));
  oai21  g45(.a(new_n92_), .b(new_n90_), .c(x16), .O(new_n93_));
  nand2  g46(.a(new_n93_), .b(new_n89_), .O(z11));
  ...
  inv1   g62(.a(x14), .O(new_n111_));
  nand2  g63(.a(x18), .b(x06), .O(new_n112_));
  oai21  g64(.a(x18), .b(new_n111_), .c(new_n112_), .O(new_n113_));
  nand2  g65(.a(new_n113_), .b(new_n85_), .O(new_n114_));
  nor2   g66(.a(x24), .b(x23), .O(new_n115_));
  nand4  g67(.a(new_n115_), .b(new_n99_), .c(new_n72_), .d(new_n51_), .O(new_n116_));
  nand4  g68(.a(new_n66_), .b(new_n63_), .c(new_n60_), .d(new_n57_), .O(new_n117_));
  inv1   g69(.a(new_n117_), .O(new_n118_));
  aoi22  g70(.a(new_n118_), .b(new_n92_), .c(new_n116_), .d(x25), .O(new_n119_));
  oai21  g71(.a(new_n119_), .b(new_n85_), .c(new_n114_), .O(z15));
  nor2   g72(.a(x21), .b(x20), .O(new_n122_));
  nor2   g73(.a(x23), .b(x22), .O(new_n123_));
  nor3   g74(.a(x26), .b(x25), .c(x24), .O(new_n124_));
  nor2   g75(.a(new_n48_), .b(x17), .O(new_n125_));
  nand4  g76(.a(new_n125_), .b(new_n124_), .c(new_n123_), .d(new_n122_), .O(new_n126_));
