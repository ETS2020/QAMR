...
module FAU ( 
  ...
  nand4  g62(.a(new_n110_), .b(new_n96_), .c(new_n71_), .d(new_n49_), .O(new_n111_));
  ...
  inv1   g79(.a(x19), .O(new_n128_));
  nor2   g80(.a(new_n128_), .b(x17), .O(new_n129_));
  nand4  g81(.a(new_n129_), .b(new_n123_), .c(new_n113_), .d(new_n89_), .O(new_n130_));
