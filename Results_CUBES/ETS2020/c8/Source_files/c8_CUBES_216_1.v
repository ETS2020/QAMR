...
module FAU ( 
  ...
  nand3  g45(.a(new_n90_), .b(new_n70_), .c(new_n49_), .O(new_n96_));
  ...
  nand4  g53(.a(new_n104_), .b(new_n90_), .c(new_n70_), .d(new_n49_), .O(new_n105_));
  ...
  nand2  g63(.a(new_n114_), .b(new_n84_), .O(new_n115_));
  nand2  g64(.a(new_n109_), .b(x26), .O(new_n116_));
  nor3   g65(.a(x26), .b(x25), .c(x24), .O(new_n117_));
  nand4  g66(.a(new_n117_), .b(new_n107_), .c(new_n88_), .d(new_n70_), .O(new_n118_));
  ...
  nand4  g72(.a(new_n123_), .b(new_n117_), .c(new_n107_), .d(new_n88_), .O(new_n124_));
  nand2  g73(.a(x27), .b(x17), .O(new_n125_));
  aoi21  g74(.a(new_n125_), .b(new_n124_), .c(new_n84_), .O(z17));
  zero   g75(.O(z00));
  zero   g76(.O(z05));
  zero   g77(.O(z08));
  zero   g78(.O(z11));
