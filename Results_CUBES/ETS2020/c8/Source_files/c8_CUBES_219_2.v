...
module FAU ( 
  ...
  wire new_n47_, new_n48_, new_n49_, new_n51_, new_n52_, new_n54_, new_n55_,
    new_n57_, new_n58_, new_n62_, new_n63_, new_n66_, new_n67_, new_n68_,
  ...
  nand3  g43(.a(new_n93_), .b(new_n67_), .c(new_n51_), .O(new_n94_));
  nor3   g44(.a(x23), .b(x22), .c(x21), .O(new_n95_));
  aoi22  g45(.a(new_n95_), .b(new_n77_), .c(new_n94_), .d(x23), .O(new_n96_));
  oai21  g46(.a(new_n96_), .b(new_n80_), .c(new_n92_), .O(z13));
  ...
  nand4  g51(.a(new_n102_), .b(new_n93_), .c(new_n67_), .d(new_n51_), .O(new_n103_));
