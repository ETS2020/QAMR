...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n47_, new_n48_, new_n51_, new_n52_, new_n54_, new_n55_, new_n56_,
  ...
  nand2  g08(.a(new_n54_), .b(new_n55_), .O(new_n56_));
  oai21  g09(.a(new_n54_), .b(x11), .c(new_n56_), .O(z03));
  inv1   g10(.a(x23), .O(new_n58_));
  nand2  g11(.a(new_n54_), .b(new_n58_), .O(new_n59_));
  oai21  g12(.a(new_n54_), .b(x12), .c(new_n59_), .O(z04));
  inv1   g13(.a(x24), .O(new_n61_));
  nand2  g14(.a(new_n54_), .b(new_n61_), .O(new_n62_));
  oai21  g15(.a(new_n54_), .b(x13), .c(new_n62_), .O(z05));
  ...
  inv1   g31(.a(x20), .O(new_n79_));
  nor2   g32(.a(new_n71_), .b(new_n79_), .O(new_n80_));
  nor3   g33(.a(x20), .b(x19), .c(x17), .O(new_n81_));
  oai21  g34(.a(new_n81_), .b(new_n80_), .c(x16), .O(new_n82_));
  oai21  g35(.a(new_n78_), .b(x16), .c(new_n82_), .O(z10));
  inv1   g36(.a(x16), .O(new_n84_));
  nand2  g37(.a(x18), .b(x02), .O(new_n85_));
  oai21  g38(.a(x18), .b(new_n51_), .c(new_n85_), .O(new_n86_));
  nand2  g39(.a(new_n86_), .b(new_n84_), .O(new_n87_));
  nand2  g40(.a(new_n71_), .b(new_n79_), .O(new_n88_));
  ...
  inv1   g44(.a(x13), .O(new_n94_));
  nand2  g45(.a(x18), .b(x05), .O(new_n95_));
  oai21  g46(.a(x18), .b(new_n94_), .c(new_n95_), .O(new_n96_));
  nand2  g47(.a(new_n96_), .b(new_n84_), .O(new_n97_));
  nor3   g48(.a(x23), .b(x22), .c(x21), .O(new_n98_));
  aoi21  g49(.a(new_n98_), .b(new_n81_), .c(new_n61_), .O(new_n99_));
  nor2   g50(.a(x22), .b(x21), .O(new_n100_));
  nor2   g51(.a(x24), .b(x23), .O(new_n101_));
  nand4  g52(.a(new_n101_), .b(new_n100_), .c(new_n71_), .d(new_n79_), .O(new_n102_));
  inv1   g53(.a(new_n102_), .O(new_n103_));
  oai21  g54(.a(new_n103_), .b(new_n99_), .c(x16), .O(new_n104_));
  nand2  g55(.a(new_n104_), .b(new_n97_), .O(z14));
  ...
  nand4  g62(.a(new_n111_), .b(new_n110_), .c(new_n89_), .d(new_n71_), .O(new_n112_));
  ...
  nand4  g71(.a(new_n120_), .b(new_n110_), .c(new_n89_), .d(new_n71_), .O(new_n121_));
