...
module FAU ( 
  ...
  nor3   g59(.a(x23), .b(x22), .c(x21), .O(new_n108_));
  aoi21  g60(.a(new_n108_), .b(new_n82_), .c(new_n107_), .O(new_n109_));
  nor2   g61(.a(x24), .b(x23), .O(new_n110_));
  nand4  g62(.a(new_n110_), .b(new_n99_), .c(new_n72_), .d(new_n51_), .O(new_n111_));
  inv1   g63(.a(new_n111_), .O(new_n112_));
  oai21  g64(.a(new_n112_), .b(new_n109_), .c(x16), .O(new_n113_));
  nand2  g65(.a(new_n113_), .b(new_n106_), .O(z14));
  ...
  nand4  g70(.a(new_n64_), .b(new_n107_), .c(new_n60_), .d(new_n57_), .O(new_n119_));
  inv1   g71(.a(new_n119_), .O(new_n120_));
  aoi22  g72(.a(new_n120_), .b(new_n92_), .c(new_n111_), .d(x25), .O(new_n121_));
  oai21  g73(.a(new_n121_), .b(new_n85_), .c(new_n118_), .O(z15));
  ...
  aoi21  g80(.a(new_n129_), .b(new_n128_), .c(new_n85_), .O(z17));
  zero   g81(.O(z05));
  zero   g82(.O(z13));
  zero   g83(.O(z16));
  buf    g84(.a(x27), .O(z08));
