...
module FAU ( 
  ...
  inv1   g25(.a(x20), .O(new_n76_));
  nor2   g26(.a(new_n68_), .b(new_n76_), .O(new_n77_));
  nor3   g27(.a(x20), .b(x19), .c(x17), .O(new_n78_));
  oai21  g28(.a(new_n78_), .b(new_n77_), .c(x16), .O(new_n79_));
  oai21  g29(.a(new_n75_), .b(x16), .c(new_n79_), .O(z10));
  inv1   g30(.a(x16), .O(new_n82_));
  nand2  g31(.a(x18), .b(x03), .O(new_n83_));
  oai21  g32(.a(x18), .b(new_n55_), .c(new_n83_), .O(new_n84_));
  ...
  aoi22  g37(.a(new_n88_), .b(new_n78_), .c(new_n87_), .d(x22), .O(new_n89_));
  oai21  g38(.a(new_n89_), .b(new_n82_), .c(new_n85_), .O(z12));
  nand2  g39(.a(x18), .b(x04), .O(new_n91_));
  oai21  g40(.a(x18), .b(new_n58_), .c(new_n91_), .O(new_n92_));
  nand2  g41(.a(new_n92_), .b(new_n82_), .O(new_n93_));
  nand3  g42(.a(new_n88_), .b(new_n68_), .c(new_n76_), .O(new_n94_));
  nor3   g43(.a(x23), .b(x22), .c(x21), .O(new_n95_));
  aoi22  g44(.a(new_n95_), .b(new_n78_), .c(new_n94_), .d(x23), .O(new_n96_));
  oai21  g45(.a(new_n96_), .b(new_n82_), .c(new_n93_), .O(z13));
  inv1   g46(.a(x13), .O(new_n98_));
  nand2  g47(.a(x18), .b(x05), .O(new_n99_));
  oai21  g48(.a(x18), .b(new_n98_), .c(new_n99_), .O(new_n100_));
  nand2  g49(.a(new_n100_), .b(new_n82_), .O(new_n101_));
  inv1   g50(.a(x24), .O(new_n102_));
  aoi21  g51(.a(new_n95_), .b(new_n78_), .c(new_n102_), .O(new_n103_));
  nor2   g52(.a(x24), .b(x23), .O(new_n104_));
  nand4  g53(.a(new_n104_), .b(new_n88_), .c(new_n68_), .d(new_n76_), .O(new_n105_));
  ...
  nand2  g59(.a(new_n110_), .b(new_n82_), .O(new_n111_));
  nand2  g60(.a(new_n105_), .b(x25), .O(new_n112_));
  nor2   g61(.a(x23), .b(x22), .O(new_n113_));
  nor2   g62(.a(x25), .b(x24), .O(new_n114_));
  nand4  g63(.a(new_n114_), .b(new_n113_), .c(new_n86_), .d(new_n68_), .O(new_n115_));
  ...
  nand2  g70(.a(new_n121_), .b(new_n82_), .O(new_n122_));
  nand2  g71(.a(new_n115_), .b(x26), .O(new_n123_));
  nor3   g72(.a(x26), .b(x25), .c(x24), .O(new_n124_));
  nand4  g73(.a(new_n124_), .b(new_n113_), .c(new_n86_), .d(new_n68_), .O(new_n125_));
