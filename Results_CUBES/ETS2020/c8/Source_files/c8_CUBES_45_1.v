...
module FAU ( 
  ...
  wire new_n47_, new_n48_, new_n50_, new_n51_, new_n52_, new_n55_, new_n56_,
    ...
    new_n68_, new_n71_, new_n72_, new_n73_, new_n74_, new_n75_, new_n77_,
  ...
  nand2  g57(.a(new_n108_), .b(new_n84_), .O(new_n109_));
  nor2   g58(.a(x23), .b(x22), .O(new_n110_));
  nor2   g59(.a(x25), .b(x24), .O(new_n111_));
  nand4  g60(.a(new_n111_), .b(new_n110_), .c(new_n90_), .d(new_n72_), .O(new_n112_));
  nand2  g61(.a(new_n112_), .b(x26), .O(new_n113_));
  nor3   g62(.a(x26), .b(x25), .c(x24), .O(new_n114_));
  nand4  g63(.a(new_n114_), .b(new_n110_), .c(new_n90_), .d(new_n72_), .O(new_n115_));
