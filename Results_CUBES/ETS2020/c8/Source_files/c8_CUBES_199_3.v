...
module FAU ( 
  ...
  nand2  g68(.a(new_n117_), .b(new_n83_), .O(new_n118_));
  nor2   g69(.a(x23), .b(x22), .O(new_n119_));
  nor2   g70(.a(x25), .b(x24), .O(new_n120_));
  nand4  g71(.a(new_n120_), .b(new_n119_), .c(new_n88_), .d(new_n69_), .O(new_n121_));
  nand2  g72(.a(new_n121_), .b(x26), .O(new_n122_));
  nor3   g73(.a(x26), .b(x25), .c(x24), .O(new_n123_));
  nand4  g74(.a(new_n123_), .b(new_n119_), .c(new_n88_), .d(new_n69_), .O(new_n124_));
  ...
  nand4  g79(.a(new_n128_), .b(new_n123_), .c(new_n119_), .d(new_n88_), .O(new_n129_));
