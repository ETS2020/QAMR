...
module FAU ( 
  ...
  nand2  g27(.a(new_n67_), .b(new_n49_), .O(new_n79_));
  inv1   g28(.a(x21), .O(new_n80_));
  nand4  g29(.a(new_n80_), .b(new_n49_), .c(new_n65_), .d(new_n64_), .O(new_n81_));
  inv1   g30(.a(new_n81_), .O(new_n82_));
  aoi21  g31(.a(new_n79_), .b(x21), .c(new_n82_), .O(new_n83_));
  oai21  g32(.a(new_n83_), .b(new_n74_), .c(new_n78_), .O(z11));
  inv1   g33(.a(x11), .O(new_n85_));
  nand2  g34(.a(x18), .b(x03), .O(new_n86_));
  oai21  g35(.a(x18), .b(new_n85_), .c(new_n86_), .O(new_n87_));
  nand2  g36(.a(new_n87_), .b(new_n74_), .O(new_n88_));
  nor3   g37(.a(x20), .b(x19), .c(x17), .O(new_n89_));
  nor2   g38(.a(x22), .b(x21), .O(new_n90_));
  aoi22  g39(.a(new_n90_), .b(new_n89_), .c(new_n81_), .d(x22), .O(new_n91_));
  oai21  g40(.a(new_n91_), .b(new_n74_), .c(new_n88_), .O(z12));
  inv1   g41(.a(x12), .O(new_n93_));
  nand2  g42(.a(x18), .b(x04), .O(new_n94_));
  oai21  g43(.a(x18), .b(new_n93_), .c(new_n94_), .O(new_n95_));
  nand2  g44(.a(new_n95_), .b(new_n74_), .O(new_n96_));
  nand3  g45(.a(new_n90_), .b(new_n67_), .c(new_n49_), .O(new_n97_));
  nor3   g46(.a(x23), .b(x22), .c(x21), .O(new_n98_));
  aoi22  g47(.a(new_n98_), .b(new_n89_), .c(new_n97_), .d(x23), .O(new_n99_));
  oai21  g48(.a(new_n99_), .b(new_n74_), .c(new_n96_), .O(z13));
  inv1   g49(.a(x13), .O(new_n101_));
  nand2  g50(.a(x18), .b(x05), .O(new_n102_));
  oai21  g51(.a(x18), .b(new_n101_), .c(new_n102_), .O(new_n103_));
  nand2  g52(.a(new_n103_), .b(new_n74_), .O(new_n104_));
  aoi21  g53(.a(new_n98_), .b(new_n89_), .c(new_n57_), .O(new_n105_));
  nor2   g54(.a(x24), .b(x23), .O(new_n106_));
  nand4  g55(.a(new_n106_), .b(new_n90_), .c(new_n67_), .d(new_n49_), .O(new_n107_));
  ...
  nand2  g62(.a(new_n113_), .b(new_n74_), .O(new_n114_));
  inv1   g63(.a(x22), .O(new_n115_));
  inv1   g64(.a(x25), .O(new_n116_));
  nand4  g65(.a(new_n116_), .b(new_n57_), .c(new_n54_), .d(new_n115_), .O(new_n117_));
  inv1   g66(.a(new_n117_), .O(new_n118_));
  aoi22  g67(.a(new_n118_), .b(new_n82_), .c(new_n107_), .d(x25), .O(new_n119_));
  oai21  g68(.a(new_n119_), .b(new_n74_), .c(new_n114_), .O(z15));
  nand2  g69(.a(x18), .b(x07), .O(new_n121_));
  oai21  g70(.a(x18), .b(new_n61_), .c(new_n121_), .O(new_n122_));
  nand2  g71(.a(new_n122_), .b(new_n74_), .O(new_n123_));
  nor2   g72(.a(x21), .b(x20), .O(new_n124_));
  nor2   g73(.a(x23), .b(x22), .O(new_n125_));
  nor2   g74(.a(x25), .b(x24), .O(new_n126_));
  nand4  g75(.a(new_n126_), .b(new_n125_), .c(new_n124_), .d(new_n67_), .O(new_n127_));
  nand2  g76(.a(new_n127_), .b(x26), .O(new_n128_));
  nor3   g77(.a(x26), .b(x25), .c(x24), .O(new_n129_));
  nand4  g78(.a(new_n129_), .b(new_n125_), .c(new_n124_), .d(new_n67_), .O(new_n130_));
