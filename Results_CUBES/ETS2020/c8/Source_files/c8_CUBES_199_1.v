...
module FAU ( 
  ...
  nand2  g34(.a(x18), .b(x03), .O(new_n84_));
  oai21  g35(.a(x18), .b(new_n55_), .c(new_n84_), .O(new_n85_));
  nand2  g36(.a(new_n85_), .b(new_n83_), .O(new_n86_));
  nor2   g37(.a(x21), .b(x20), .O(new_n87_));
  nand2  g38(.a(new_n87_), .b(new_n69_), .O(new_n88_));
  nor2   g39(.a(x22), .b(x21), .O(new_n89_));
  aoi22  g40(.a(new_n89_), .b(new_n79_), .c(new_n88_), .d(x22), .O(new_n90_));
  oai21  g41(.a(new_n90_), .b(new_n83_), .c(new_n86_), .O(z12));
  ...
  nand2  g66(.a(new_n116_), .b(new_n83_), .O(new_n117_));
  nand2  g67(.a(new_n111_), .b(x26), .O(new_n118_));
  nor3   g68(.a(x26), .b(x25), .c(x24), .O(new_n119_));
  nand4  g69(.a(new_n119_), .b(new_n109_), .c(new_n87_), .d(new_n69_), .O(new_n120_));
