...
module FAU ( 
  ...
  inv1   g37(.a(x16), .O(new_n88_));
  inv1   g38(.a(x12), .O(new_n89_));
  nand2  g39(.a(x18), .b(x04), .O(new_n90_));
  oai21  g40(.a(x18), .b(new_n89_), .c(new_n90_), .O(new_n91_));
  nand2  g41(.a(new_n91_), .b(new_n88_), .O(new_n92_));
  nor2   g42(.a(x22), .b(x21), .O(new_n93_));
  nand3  g43(.a(new_n93_), .b(new_n73_), .c(new_n51_), .O(new_n94_));
  nor3   g44(.a(x23), .b(x22), .c(x21), .O(new_n95_));
  aoi22  g45(.a(new_n95_), .b(new_n83_), .c(new_n94_), .d(x23), .O(new_n96_));
  oai21  g46(.a(new_n96_), .b(new_n88_), .c(new_n92_), .O(z13));
  inv1   g47(.a(x13), .O(new_n98_));
  nand2  g48(.a(x18), .b(x05), .O(new_n99_));
  oai21  g49(.a(x18), .b(new_n98_), .c(new_n99_), .O(new_n100_));
  nand2  g50(.a(new_n100_), .b(new_n88_), .O(new_n101_));
  aoi21  g51(.a(new_n95_), .b(new_n83_), .c(new_n61_), .O(new_n102_));
  nor2   g52(.a(x24), .b(x23), .O(new_n103_));
  nand4  g53(.a(new_n103_), .b(new_n93_), .c(new_n73_), .d(new_n51_), .O(new_n104_));
  ...
  nand2  g60(.a(new_n110_), .b(new_n88_), .O(new_n111_));
  nand4  g61(.a(new_n64_), .b(new_n61_), .c(new_n48_), .d(new_n71_), .O(new_n112_));
  inv1   g62(.a(new_n112_), .O(new_n113_));
  inv1   g63(.a(x21), .O(new_n114_));
  nand4  g64(.a(new_n58_), .b(new_n55_), .c(new_n114_), .d(new_n51_), .O(new_n115_));
  inv1   g65(.a(new_n115_), .O(new_n116_));
  aoi22  g66(.a(new_n116_), .b(new_n113_), .c(new_n104_), .d(x25), .O(new_n117_));
  oai21  g67(.a(new_n117_), .b(new_n88_), .c(new_n111_), .O(z15));
  nor2   g68(.a(x23), .b(x22), .O(new_n120_));
  nor2   g69(.a(x21), .b(x20), .O(new_n121_));
  nor3   g70(.a(x26), .b(x25), .c(x24), .O(new_n122_));
  nor2   g71(.a(new_n48_), .b(x17), .O(new_n123_));
  nand4  g72(.a(new_n123_), .b(new_n122_), .c(new_n121_), .d(new_n120_), .O(new_n124_));
  nand2  g73(.a(x27), .b(x17), .O(new_n125_));
  aoi21  g74(.a(new_n125_), .b(new_n124_), .c(new_n88_), .O(z17));
  zero   g75(.O(z02));
  zero   g76(.O(z08));
  zero   g77(.O(z11));
  zero   g78(.O(z12));
