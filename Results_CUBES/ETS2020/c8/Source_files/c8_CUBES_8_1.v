...
module FAU ( 
  ...
  nand2  g38(.a(new_n89_), .b(new_n76_), .O(new_n90_));
  nor3   g39(.a(x20), .b(x19), .c(x17), .O(new_n91_));
  nor3   g40(.a(x23), .b(x22), .c(x21), .O(new_n92_));
  aoi21  g41(.a(new_n92_), .b(new_n91_), .c(new_n59_), .O(new_n93_));
  nor2   g42(.a(x22), .b(x21), .O(new_n94_));
  nor2   g43(.a(x24), .b(x23), .O(new_n95_));
  nand4  g44(.a(new_n95_), .b(new_n94_), .c(new_n69_), .d(new_n80_), .O(new_n96_));
  inv1   g45(.a(new_n96_), .O(new_n97_));
  oai21  g46(.a(new_n97_), .b(new_n93_), .c(x16), .O(new_n98_));
  nand2  g47(.a(new_n98_), .b(new_n90_), .O(z14));
  nand2  g48(.a(x18), .b(x06), .O(new_n100_));
  oai21  g49(.a(x18), .b(new_n62_), .c(new_n100_), .O(new_n101_));
  nand2  g50(.a(new_n101_), .b(new_n76_), .O(new_n102_));
  nand2  g51(.a(new_n96_), .b(x25), .O(new_n103_));
  nor2   g52(.a(x23), .b(x22), .O(new_n104_));
  nor2   g53(.a(x25), .b(x24), .O(new_n105_));
  nand4  g54(.a(new_n105_), .b(new_n104_), .c(new_n82_), .d(new_n69_), .O(new_n106_));
  nand2  g55(.a(new_n106_), .b(new_n103_), .O(new_n107_));
  nand2  g56(.a(new_n107_), .b(x16), .O(new_n108_));
  nand2  g57(.a(new_n108_), .b(new_n102_), .O(z15));
  nand2  g58(.a(x18), .b(x07), .O(new_n110_));
  oai21  g59(.a(x18), .b(new_n65_), .c(new_n110_), .O(new_n111_));
  nand2  g60(.a(new_n111_), .b(new_n76_), .O(new_n112_));
  nand2  g61(.a(new_n106_), .b(x26), .O(new_n113_));
  nor3   g62(.a(x26), .b(x25), .c(x24), .O(new_n114_));
  nand4  g63(.a(new_n114_), .b(new_n104_), .c(new_n82_), .d(new_n69_), .O(new_n115_));
  ...
  nor2   g67(.a(new_n48_), .b(x17), .O(new_n119_));
  nand4  g68(.a(new_n119_), .b(new_n114_), .c(new_n104_), .d(new_n82_), .O(new_n120_));
  nand2  g69(.a(x27), .b(x17), .O(new_n121_));
  aoi21  g70(.a(new_n121_), .b(new_n120_), .c(new_n76_), .O(z17));
  zero   g71(.O(z01));
  zero   g72(.O(z04));
  zero   g73(.O(z10));
  zero   g74(.O(z12));
