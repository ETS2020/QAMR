...
module FAU ( 
  ...
  nand2  g42(.a(x18), .b(x05), .O(new_n93_));
  oai21  g43(.a(x18), .b(new_n92_), .c(new_n93_), .O(new_n94_));
  nand2  g44(.a(new_n94_), .b(new_n82_), .O(new_n95_));
  nor3   g45(.a(x23), .b(x22), .c(x21), .O(new_n96_));
  aoi21  g46(.a(new_n96_), .b(new_n79_), .c(new_n59_), .O(new_n97_));
  nor2   g47(.a(x22), .b(x21), .O(new_n98_));
  nor2   g48(.a(x24), .b(x23), .O(new_n99_));
  nand4  g49(.a(new_n99_), .b(new_n98_), .c(new_n69_), .d(new_n49_), .O(new_n100_));
  inv1   g50(.a(new_n100_), .O(new_n101_));
  oai21  g51(.a(new_n101_), .b(new_n97_), .c(x16), .O(new_n102_));
  nand2  g52(.a(new_n102_), .b(new_n95_), .O(z14));
  nand2  g53(.a(x18), .b(x06), .O(new_n104_));
  oai21  g54(.a(x18), .b(new_n62_), .c(new_n104_), .O(new_n105_));
  nand2  g55(.a(new_n105_), .b(new_n82_), .O(new_n106_));
  nand2  g56(.a(new_n100_), .b(x25), .O(new_n107_));
  nor2   g57(.a(x23), .b(x22), .O(new_n108_));
  nor2   g58(.a(x25), .b(x24), .O(new_n109_));
  nand4  g59(.a(new_n109_), .b(new_n108_), .c(new_n87_), .d(new_n69_), .O(new_n110_));
  nand2  g60(.a(new_n110_), .b(new_n107_), .O(new_n111_));
  nand2  g61(.a(new_n111_), .b(x16), .O(new_n112_));
  nand2  g62(.a(new_n112_), .b(new_n106_), .O(z15));
  nand2  g63(.a(x18), .b(x07), .O(new_n114_));
  oai21  g64(.a(x18), .b(new_n65_), .c(new_n114_), .O(new_n115_));
  nand2  g65(.a(new_n115_), .b(new_n82_), .O(new_n116_));
  nand2  g66(.a(new_n110_), .b(x26), .O(new_n117_));
  nor3   g67(.a(x26), .b(x25), .c(x24), .O(new_n118_));
  nand4  g68(.a(new_n118_), .b(new_n108_), .c(new_n87_), .d(new_n69_), .O(new_n119_));
  ...
  inv1   g72(.a(x19), .O(new_n123_));
  nor2   g73(.a(new_n123_), .b(x17), .O(new_n124_));
  nand4  g74(.a(new_n124_), .b(new_n118_), .c(new_n108_), .d(new_n87_), .O(new_n125_));
  nand2  g75(.a(x27), .b(x17), .O(new_n126_));
  aoi21  g76(.a(new_n126_), .b(new_n125_), .c(new_n82_), .O(z17));
  zero   g77(.O(z00));
  zero   g78(.O(z04));
  zero   g79(.O(z12));
  zero   g80(.O(z13));
