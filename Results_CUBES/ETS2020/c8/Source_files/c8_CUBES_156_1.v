...
module FAU ( 
  ...
  nand2  g61(.a(x18), .b(x06), .O(new_n110_));
  oai21  g62(.a(x18), .b(new_n66_), .c(new_n110_), .O(new_n111_));
  nand2  g63(.a(new_n111_), .b(new_n87_), .O(new_n112_));
  nor2   g64(.a(x24), .b(x23), .O(new_n113_));
  nand4  g65(.a(new_n113_), .b(new_n99_), .c(new_n74_), .d(new_n51_), .O(new_n114_));
  nand2  g66(.a(new_n114_), .b(x25), .O(new_n115_));
  nor2   g67(.a(x23), .b(x22), .O(new_n116_));
  nor2   g68(.a(x25), .b(x24), .O(new_n117_));
  nand4  g69(.a(new_n117_), .b(new_n116_), .c(new_n92_), .d(new_n74_), .O(new_n118_));
  nand2  g70(.a(new_n118_), .b(new_n115_), .O(new_n119_));
  nand2  g71(.a(new_n119_), .b(x16), .O(new_n120_));
  nand2  g72(.a(new_n120_), .b(new_n112_), .O(z15));
  nand2  g73(.a(x18), .b(x07), .O(new_n122_));
  oai21  g74(.a(x18), .b(new_n69_), .c(new_n122_), .O(new_n123_));
  nand2  g75(.a(new_n123_), .b(new_n87_), .O(new_n124_));
  nand2  g76(.a(new_n118_), .b(x26), .O(new_n125_));
  nor3   g77(.a(x26), .b(x25), .c(x24), .O(new_n126_));
  nand4  g78(.a(new_n126_), .b(new_n116_), .c(new_n92_), .d(new_n74_), .O(new_n127_));
  nand2  g79(.a(new_n127_), .b(new_n125_), .O(new_n128_));
  nand2  g80(.a(new_n128_), .b(x16), .O(new_n129_));
  nand2  g81(.a(new_n129_), .b(new_n124_), .O(z16));
  nor2   g82(.a(new_n48_), .b(x17), .O(new_n131_));
  nand4  g83(.a(new_n131_), .b(new_n126_), .c(new_n116_), .d(new_n92_), .O(new_n132_));
  nand2  g84(.a(x27), .b(x17), .O(new_n133_));
  aoi21  g85(.a(new_n133_), .b(new_n132_), .c(new_n87_), .O(z17));
  zero   g86(.O(z08));
  zero   g87(.O(z14));
endmodule
