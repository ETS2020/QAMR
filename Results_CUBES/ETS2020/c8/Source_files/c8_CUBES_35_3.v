...
module FAU ( 
  ...
  wire new_n47_, new_n48_, new_n49_, new_n51_, new_n52_, new_n54_, new_n55_,
    new_n57_, new_n58_, new_n60_, new_n61_, new_n64_, new_n65_, new_n69_,
  ...
  oai21  g29(.a(x18), .b(new_n54_), .c(new_n78_), .O(new_n79_));
  nand2  g30(.a(new_n79_), .b(new_n77_), .O(new_n80_));
  nand2  g31(.a(new_n72_), .b(new_n51_), .O(new_n81_));
  ...
  oai21  g36(.a(x18), .b(new_n57_), .c(new_n85_), .O(new_n86_));
  nand2  g37(.a(new_n86_), .b(new_n77_), .O(new_n87_));
  nand2  g38(.a(new_n82_), .b(new_n72_), .O(new_n88_));
  nor2   g39(.a(x22), .b(x21), .O(new_n89_));
  aoi22  g40(.a(new_n89_), .b(new_n74_), .c(new_n88_), .d(x22), .O(new_n90_));
  oai21  g41(.a(new_n90_), .b(new_n77_), .c(new_n87_), .O(z12));
  nand2  g42(.a(x18), .b(x04), .O(new_n92_));
  oai21  g43(.a(x18), .b(new_n60_), .c(new_n92_), .O(new_n93_));
  nand2  g44(.a(new_n93_), .b(new_n77_), .O(new_n94_));
  nand3  g45(.a(new_n89_), .b(new_n72_), .c(new_n51_), .O(new_n95_));
  nor3   g46(.a(x23), .b(x22), .c(x21), .O(new_n96_));
  aoi22  g47(.a(new_n96_), .b(new_n74_), .c(new_n95_), .d(x23), .O(new_n97_));
  oai21  g48(.a(new_n97_), .b(new_n77_), .c(new_n94_), .O(z13));
  nand2  g49(.a(x18), .b(x06), .O(new_n100_));
  oai21  g50(.a(x18), .b(new_n64_), .c(new_n100_), .O(new_n101_));
  nand2  g51(.a(new_n101_), .b(new_n77_), .O(new_n102_));
  nor2   g52(.a(x24), .b(x23), .O(new_n103_));
  nand4  g53(.a(new_n103_), .b(new_n89_), .c(new_n72_), .d(new_n51_), .O(new_n104_));
  nand2  g54(.a(new_n104_), .b(x25), .O(new_n105_));
  nor2   g55(.a(x23), .b(x22), .O(new_n106_));
  nor2   g56(.a(x25), .b(x24), .O(new_n107_));
  nand4  g57(.a(new_n107_), .b(new_n106_), .c(new_n82_), .d(new_n72_), .O(new_n108_));
  nand2  g58(.a(new_n108_), .b(new_n105_), .O(new_n109_));
  nand2  g59(.a(new_n109_), .b(x16), .O(new_n110_));
  nand2  g60(.a(new_n110_), .b(new_n102_), .O(z15));
  inv1   g61(.a(x15), .O(new_n112_));
  nand2  g62(.a(x18), .b(x07), .O(new_n113_));
  oai21  g63(.a(x18), .b(new_n112_), .c(new_n113_), .O(new_n114_));
  nand2  g64(.a(new_n114_), .b(new_n77_), .O(new_n115_));
  nand2  g65(.a(new_n108_), .b(x26), .O(new_n116_));
  nor3   g66(.a(x26), .b(x25), .c(x24), .O(new_n117_));
  nand4  g67(.a(new_n117_), .b(new_n106_), .c(new_n82_), .d(new_n72_), .O(new_n118_));
  nand2  g68(.a(new_n118_), .b(new_n116_), .O(new_n119_));
  nand2  g69(.a(new_n119_), .b(x16), .O(new_n120_));
  nand2  g70(.a(new_n120_), .b(new_n115_), .O(z16));
  nor2   g71(.a(new_n48_), .b(x17), .O(new_n122_));
  nand4  g72(.a(new_n122_), .b(new_n117_), .c(new_n106_), .d(new_n82_), .O(new_n123_));
  nand2  g73(.a(x27), .b(x17), .O(new_n124_));
  aoi21  g74(.a(new_n124_), .b(new_n123_), .c(new_n77_), .O(z17));
  zero   g75(.O(z05));
  zero   g76(.O(z07));
  zero   g77(.O(z09));
  zero   g78(.O(z14));
