...
module FAU ( 
  ...
  nand2  g33(.a(new_n71_), .b(new_n51_), .O(new_n82_));
  ...
  nand2  g37(.a(x18), .b(x04), .O(new_n87_));
  oai21  g38(.a(x18), .b(new_n60_), .c(new_n87_), .O(new_n88_));
  nand2  g39(.a(new_n88_), .b(new_n78_), .O(new_n89_));
  nor3   g40(.a(x20), .b(x19), .c(x17), .O(new_n90_));
  nor2   g41(.a(x22), .b(x21), .O(new_n91_));
  nand3  g42(.a(new_n91_), .b(new_n71_), .c(new_n51_), .O(new_n92_));
  nor3   g43(.a(x23), .b(x22), .c(x21), .O(new_n93_));
  aoi22  g44(.a(new_n93_), .b(new_n90_), .c(new_n92_), .d(x23), .O(new_n94_));
  oai21  g45(.a(new_n94_), .b(new_n78_), .c(new_n89_), .O(z13));
  inv1   g46(.a(x13), .O(new_n96_));
  nand2  g47(.a(x18), .b(x05), .O(new_n97_));
  oai21  g48(.a(x18), .b(new_n96_), .c(new_n97_), .O(new_n98_));
  nand2  g49(.a(new_n98_), .b(new_n78_), .O(new_n99_));
  aoi21  g50(.a(new_n93_), .b(new_n90_), .c(new_n63_), .O(new_n100_));
  nor2   g51(.a(x24), .b(x23), .O(new_n101_));
  nand4  g52(.a(new_n101_), .b(new_n91_), .c(new_n71_), .d(new_n51_), .O(new_n102_));
  ...
  nand2  g58(.a(new_n107_), .b(new_n78_), .O(new_n108_));
