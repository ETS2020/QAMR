...
module FAU ( 
  ...
  oai21  g31(.a(x18), .b(new_n55_), .c(new_n82_), .O(new_n83_));
  nand2  g32(.a(new_n83_), .b(new_n81_), .O(new_n84_));
  nor2   g33(.a(x21), .b(x20), .O(new_n85_));
  nand2  g34(.a(new_n85_), .b(new_n68_), .O(new_n86_));
  nor2   g35(.a(x22), .b(x21), .O(new_n87_));
  aoi22  g36(.a(new_n87_), .b(new_n77_), .c(new_n86_), .d(x22), .O(new_n88_));
  oai21  g37(.a(new_n88_), .b(new_n81_), .c(new_n84_), .O(z12));
  inv1   g38(.a(x12), .O(new_n90_));
  nand2  g39(.a(x18), .b(x04), .O(new_n91_));
  oai21  g40(.a(x18), .b(new_n90_), .c(new_n91_), .O(new_n92_));
  nand2  g41(.a(new_n92_), .b(new_n81_), .O(new_n93_));
  nand3  g42(.a(new_n87_), .b(new_n68_), .c(new_n51_), .O(new_n94_));
  nor3   g43(.a(x23), .b(x22), .c(x21), .O(new_n95_));
  aoi22  g44(.a(new_n95_), .b(new_n77_), .c(new_n94_), .d(x23), .O(new_n96_));
  oai21  g45(.a(new_n96_), .b(new_n81_), .c(new_n93_), .O(z13));
  ...
  nand3  g53(.a(new_n87_), .b(new_n102_), .c(new_n58_), .O(new_n105_));
  ...
  nand4  g62(.a(new_n114_), .b(new_n113_), .c(new_n85_), .d(new_n68_), .O(new_n115_));
  nand2  g63(.a(new_n115_), .b(x26), .O(new_n116_));
  nor3   g64(.a(x26), .b(x25), .c(x24), .O(new_n117_));
  nand4  g65(.a(new_n117_), .b(new_n113_), .c(new_n85_), .d(new_n68_), .O(new_n118_));
