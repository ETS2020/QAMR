...
module FAU ( 
  ...
  oai21  g32(.a(new_n83_), .b(new_n74_), .c(new_n78_), .O(z12));
  nand2  g33(.a(x18), .b(x04), .O(new_n85_));
  oai21  g34(.a(x18), .b(new_n56_), .c(new_n85_), .O(new_n86_));
  nand2  g35(.a(new_n86_), .b(new_n74_), .O(new_n87_));
  inv1   g36(.a(x20), .O(new_n88_));
  nand3  g37(.a(new_n81_), .b(new_n67_), .c(new_n88_), .O(new_n89_));
  nor3   g38(.a(x23), .b(x22), .c(x21), .O(new_n90_));
  aoi22  g39(.a(new_n90_), .b(new_n82_), .c(new_n89_), .d(x23), .O(new_n91_));
  oai21  g40(.a(new_n91_), .b(new_n74_), .c(new_n87_), .O(z13));
  ...
  aoi21  g46(.a(new_n90_), .b(new_n82_), .c(new_n97_), .O(new_n98_));
  nor2   g47(.a(x24), .b(x23), .O(new_n99_));
  nand4  g48(.a(new_n99_), .b(new_n81_), .c(new_n67_), .d(new_n88_), .O(new_n100_));
  ...
  nand4  g58(.a(new_n109_), .b(new_n108_), .c(new_n79_), .d(new_n67_), .O(new_n110_));
  ...
  nand2  g64(.a(new_n115_), .b(new_n74_), .O(new_n116_));
  nand2  g65(.a(new_n110_), .b(x26), .O(new_n117_));
  nor3   g66(.a(x26), .b(x25), .c(x24), .O(new_n118_));
  nand4  g67(.a(new_n118_), .b(new_n108_), .c(new_n79_), .d(new_n67_), .O(new_n119_));
