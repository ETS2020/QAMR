...
module FAU ( 
  ...
  nand4  g38(.a(new_n54_), .b(new_n51_), .c(new_n48_), .d(new_n73_), .O(new_n88_));
  nor2   g39(.a(x22), .b(x21), .O(new_n89_));
  nor3   g40(.a(x20), .b(x19), .c(x17), .O(new_n90_));
  aoi22  g41(.a(new_n90_), .b(new_n89_), .c(new_n88_), .d(x22), .O(new_n91_));
  ...
  aoi21  g48(.a(new_n98_), .b(new_n90_), .c(new_n63_), .O(new_n99_));
  nor2   g49(.a(x24), .b(x23), .O(new_n100_));
  nand4  g50(.a(new_n100_), .b(new_n89_), .c(new_n75_), .d(new_n51_), .O(new_n101_));
  ...
  inv1   g58(.a(new_n88_), .O(new_n109_));
