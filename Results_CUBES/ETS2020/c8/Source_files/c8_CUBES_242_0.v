...
module FAU ( 
  ...
  inv1   g31(.a(x12), .O(new_n83_));
  nand2  g32(.a(x18), .b(x04), .O(new_n84_));
  oai21  g33(.a(x18), .b(new_n83_), .c(new_n84_), .O(new_n85_));
  nand2  g34(.a(new_n85_), .b(new_n71_), .O(new_n86_));
  nand3  g35(.a(new_n79_), .b(new_n76_), .c(new_n51_), .O(new_n87_));
  nor3   g36(.a(x23), .b(x22), .c(x21), .O(new_n88_));
  aoi22  g37(.a(new_n88_), .b(new_n80_), .c(new_n87_), .d(x23), .O(new_n89_));
  oai21  g38(.a(new_n89_), .b(new_n71_), .c(new_n86_), .O(z13));
  inv1   g39(.a(x13), .O(new_n91_));
  nand2  g40(.a(x18), .b(x05), .O(new_n92_));
  oai21  g41(.a(x18), .b(new_n91_), .c(new_n92_), .O(new_n93_));
  nand2  g42(.a(new_n93_), .b(new_n71_), .O(new_n94_));
  inv1   g43(.a(x24), .O(new_n95_));
  aoi21  g44(.a(new_n88_), .b(new_n80_), .c(new_n95_), .O(new_n96_));
  nand2  g45(.a(new_n76_), .b(new_n51_), .O(new_n97_));
  nand3  g46(.a(new_n79_), .b(new_n95_), .c(new_n58_), .O(new_n98_));
  ...
  oai21  g51(.a(x18), .b(new_n65_), .c(new_n103_), .O(new_n104_));
  nand2  g52(.a(new_n104_), .b(new_n71_), .O(new_n105_));
  nor2   g53(.a(x23), .b(x22), .O(new_n106_));
  nor2   g54(.a(x25), .b(x24), .O(new_n107_));
  nand4  g55(.a(new_n107_), .b(new_n106_), .c(new_n77_), .d(new_n76_), .O(new_n108_));
  nand2  g56(.a(new_n108_), .b(x26), .O(new_n109_));
  nor3   g57(.a(x26), .b(x25), .c(x24), .O(new_n110_));
  nand4  g58(.a(new_n110_), .b(new_n106_), .c(new_n77_), .d(new_n76_), .O(new_n111_));
  nand2  g59(.a(new_n111_), .b(new_n109_), .O(new_n112_));
  nand2  g60(.a(new_n112_), .b(x16), .O(new_n113_));
  nand2  g61(.a(new_n113_), .b(new_n105_), .O(z16));
  nor2   g62(.a(new_n48_), .b(x17), .O(new_n115_));
  nand4  g63(.a(new_n115_), .b(new_n110_), .c(new_n106_), .d(new_n77_), .O(new_n116_));
