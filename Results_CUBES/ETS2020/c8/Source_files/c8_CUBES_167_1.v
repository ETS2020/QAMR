...
module FAU ( 
  ...
  inv1   g41(.a(x13), .O(new_n91_));
  nand2  g42(.a(x18), .b(x05), .O(new_n92_));
  ...
  aoi21  g46(.a(new_n95_), .b(new_n84_), .c(new_n63_), .O(new_n96_));
  nor2   g47(.a(x22), .b(x21), .O(new_n97_));
  nor2   g48(.a(x24), .b(x23), .O(new_n98_));
  nand4  g49(.a(new_n98_), .b(new_n97_), .c(new_n74_), .d(new_n51_), .O(new_n99_));
  inv1   g50(.a(new_n99_), .O(new_n100_));
  oai21  g51(.a(new_n100_), .b(new_n96_), .c(x16), .O(new_n101_));
  nand2  g52(.a(new_n101_), .b(new_n94_), .O(z14));
  inv1   g53(.a(x14), .O(new_n103_));
  nand2  g54(.a(x18), .b(x06), .O(new_n104_));
  oai21  g55(.a(x18), .b(new_n103_), .c(new_n104_), .O(new_n105_));
  nand2  g56(.a(new_n105_), .b(new_n90_), .O(new_n106_));
  nand4  g57(.a(new_n66_), .b(new_n63_), .c(new_n54_), .d(new_n51_), .O(new_n107_));
  inv1   g58(.a(new_n107_), .O(new_n108_));
  nand4  g59(.a(new_n60_), .b(new_n57_), .c(new_n48_), .d(new_n72_), .O(new_n109_));
  inv1   g60(.a(new_n109_), .O(new_n110_));
  aoi22  g61(.a(new_n110_), .b(new_n108_), .c(new_n99_), .d(x25), .O(new_n111_));
  oai21  g62(.a(new_n111_), .b(new_n90_), .c(new_n106_), .O(z15));
  zero   g63(.O(z11));
  zero   g64(.O(z12));
  zero   g65(.O(z13));
  zero   g66(.O(z16));
