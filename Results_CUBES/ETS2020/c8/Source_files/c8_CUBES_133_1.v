...
module FAU ( 
  ...
  nand4  g43(.a(new_n52_), .b(new_n49_), .c(new_n72_), .d(new_n71_), .O(new_n93_));
  nor2   g44(.a(x22), .b(x21), .O(new_n94_));
  aoi22  g45(.a(new_n94_), .b(new_n84_), .c(new_n93_), .d(x22), .O(new_n95_));
  oai21  g46(.a(new_n95_), .b(new_n88_), .c(new_n92_), .O(z12));
  inv1   g47(.a(x12), .O(new_n97_));
  nand2  g48(.a(x18), .b(x04), .O(new_n98_));
  oai21  g49(.a(x18), .b(new_n97_), .c(new_n98_), .O(new_n99_));
  nand2  g50(.a(new_n99_), .b(new_n88_), .O(new_n100_));
  nand3  g51(.a(new_n94_), .b(new_n74_), .c(new_n49_), .O(new_n101_));
  nor3   g52(.a(x23), .b(x22), .c(x21), .O(new_n102_));
  aoi22  g53(.a(new_n102_), .b(new_n84_), .c(new_n101_), .d(x23), .O(new_n103_));
  oai21  g54(.a(new_n103_), .b(new_n88_), .c(new_n100_), .O(z13));
  inv1   g55(.a(x13), .O(new_n105_));
  nand2  g56(.a(x18), .b(x05), .O(new_n106_));
  oai21  g57(.a(x18), .b(new_n105_), .c(new_n106_), .O(new_n107_));
  nand2  g58(.a(new_n107_), .b(new_n88_), .O(new_n108_));
  aoi21  g59(.a(new_n102_), .b(new_n84_), .c(new_n61_), .O(new_n109_));
  nor2   g60(.a(x24), .b(x23), .O(new_n110_));
  nand4  g61(.a(new_n110_), .b(new_n94_), .c(new_n74_), .d(new_n49_), .O(new_n111_));
  ...
  nand2  g68(.a(new_n117_), .b(new_n88_), .O(new_n118_));
  inv1   g69(.a(new_n93_), .O(new_n119_));
  ...
  oai21  g73(.a(new_n122_), .b(new_n88_), .c(new_n118_), .O(z15));
  zero   g74(.O(z00));
  zero   g75(.O(z08));
  zero   g76(.O(z11));
  zero   g77(.O(z16));
