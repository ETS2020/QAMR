...
module FAU ( 
  ...
  oai21  g35(.a(x18), .b(new_n81_), .c(new_n82_), .O(new_n83_));
  nand2  g36(.a(new_n83_), .b(new_n80_), .O(new_n84_));
  nand2  g37(.a(new_n73_), .b(new_n51_), .O(new_n85_));
  nor2   g38(.a(x21), .b(x20), .O(new_n86_));
  aoi22  g39(.a(new_n86_), .b(new_n73_), .c(new_n85_), .d(x21), .O(new_n87_));
  oai21  g40(.a(new_n87_), .b(new_n80_), .c(new_n84_), .O(z11));
  inv1   g41(.a(x12), .O(new_n90_));
  nand2  g42(.a(x18), .b(x04), .O(new_n91_));
  ...
  nand4  g46(.a(new_n73_), .b(new_n57_), .c(new_n54_), .d(new_n51_), .O(new_n95_));
  nor3   g47(.a(x23), .b(x22), .c(x21), .O(new_n96_));
  aoi22  g48(.a(new_n96_), .b(new_n94_), .c(new_n95_), .d(x23), .O(new_n97_));
  oai21  g49(.a(new_n97_), .b(new_n80_), .c(new_n93_), .O(z13));
  inv1   g50(.a(x13), .O(new_n99_));
  nand2  g51(.a(x18), .b(x05), .O(new_n100_));
  oai21  g52(.a(x18), .b(new_n99_), .c(new_n100_), .O(new_n101_));
  nand2  g53(.a(new_n101_), .b(new_n80_), .O(new_n102_));
  aoi21  g54(.a(new_n96_), .b(new_n94_), .c(new_n63_), .O(new_n103_));
  nand4  g55(.a(new_n63_), .b(new_n60_), .c(new_n57_), .d(new_n54_), .O(new_n104_));
  nor2   g56(.a(new_n104_), .b(new_n85_), .O(new_n105_));
  oai21  g57(.a(new_n105_), .b(new_n103_), .c(x16), .O(new_n106_));
  nand2  g58(.a(new_n106_), .b(new_n102_), .O(z14));
  nor2   g59(.a(x23), .b(x22), .O(new_n110_));
  nor3   g60(.a(x26), .b(x25), .c(x24), .O(new_n111_));
  nor2   g61(.a(new_n48_), .b(x17), .O(new_n112_));
  nand4  g62(.a(new_n112_), .b(new_n111_), .c(new_n110_), .d(new_n86_), .O(new_n113_));
  nand2  g63(.a(x27), .b(x17), .O(new_n114_));
  aoi21  g64(.a(new_n114_), .b(new_n113_), .c(new_n80_), .O(z17));
  zero   g65(.O(z10));
  zero   g66(.O(z12));
  zero   g67(.O(z15));
  zero   g68(.O(z16));
