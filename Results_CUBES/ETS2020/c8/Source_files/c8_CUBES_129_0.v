...
module FAU ( 
  ...
  aoi22  g44(.a(new_n94_), .b(new_n77_), .c(new_n93_), .d(x22), .O(new_n95_));
  ...
  nand3  g50(.a(new_n94_), .b(new_n68_), .c(new_n51_), .O(new_n101_));
  ...
  aoi21  g58(.a(new_n102_), .b(new_n77_), .c(new_n59_), .O(new_n109_));
  nand3  g59(.a(new_n94_), .b(new_n59_), .c(new_n56_), .O(new_n110_));
  nor2   g60(.a(new_n110_), .b(new_n85_), .O(new_n111_));
  oai21  g61(.a(new_n111_), .b(new_n109_), .c(x16), .O(new_n112_));
  nand2  g62(.a(new_n112_), .b(new_n108_), .O(z14));
