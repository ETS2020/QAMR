...
module FAU ( 
  ...
  nand2  g30(.a(new_n69_), .b(new_n49_), .O(new_n80_));
  ...
  nand2  g38(.a(new_n81_), .b(new_n69_), .O(new_n88_));
  nor2   g39(.a(x22), .b(x21), .O(new_n89_));
  aoi22  g40(.a(new_n89_), .b(new_n87_), .c(new_n88_), .d(x22), .O(new_n90_));
  oai21  g41(.a(new_n90_), .b(new_n76_), .c(new_n86_), .O(z12));
  nand2  g42(.a(x18), .b(x04), .O(new_n92_));
  oai21  g43(.a(x18), .b(new_n58_), .c(new_n92_), .O(new_n93_));
  nand2  g44(.a(new_n93_), .b(new_n76_), .O(new_n94_));
  nand3  g45(.a(new_n89_), .b(new_n69_), .c(new_n49_), .O(new_n95_));
  nor3   g46(.a(x23), .b(x22), .c(x21), .O(new_n96_));
  aoi22  g47(.a(new_n96_), .b(new_n87_), .c(new_n95_), .d(x23), .O(new_n97_));
  oai21  g48(.a(new_n97_), .b(new_n76_), .c(new_n94_), .O(z13));
  ...
  nand4  g53(.a(new_n103_), .b(new_n89_), .c(new_n69_), .d(new_n49_), .O(new_n104_));
  nand2  g54(.a(new_n104_), .b(x25), .O(new_n105_));
  nor2   g55(.a(x23), .b(x22), .O(new_n106_));
  nor2   g56(.a(x25), .b(x24), .O(new_n107_));
  nand4  g57(.a(new_n107_), .b(new_n106_), .c(new_n81_), .d(new_n69_), .O(new_n108_));
  ...
  nand2  g64(.a(new_n114_), .b(new_n76_), .O(new_n115_));
  nand2  g65(.a(new_n108_), .b(x26), .O(new_n116_));
  nor3   g66(.a(x26), .b(x25), .c(x24), .O(new_n117_));
  nand4  g67(.a(new_n117_), .b(new_n106_), .c(new_n81_), .d(new_n69_), .O(new_n118_));
  ...
  nand4  g73(.a(new_n123_), .b(new_n117_), .c(new_n106_), .d(new_n81_), .O(new_n124_));
  nand2  g74(.a(x27), .b(x17), .O(new_n125_));
  aoi21  g75(.a(new_n125_), .b(new_n124_), .c(new_n76_), .O(z17));
  zero   g76(.O(z00));
  zero   g77(.O(z07));
  zero   g78(.O(z10));
  zero   g79(.O(z14));
