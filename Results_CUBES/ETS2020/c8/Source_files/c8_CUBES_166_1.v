...
module FAU ( 
  ...
  nand4  g49(.a(new_n100_), .b(new_n92_), .c(new_n72_), .d(new_n49_), .O(new_n101_));
  ...
  nand4  g68(.a(new_n119_), .b(new_n113_), .c(new_n103_), .d(new_n90_), .O(new_n120_));
  nand2  g69(.a(x27), .b(x17), .O(new_n121_));
  aoi21  g70(.a(new_n121_), .b(new_n120_), .c(new_n86_), .O(z17));
  zero   g71(.O(z00));
  zero   g72(.O(z08));
  zero   g73(.O(z11));
  zero   g74(.O(z13));
