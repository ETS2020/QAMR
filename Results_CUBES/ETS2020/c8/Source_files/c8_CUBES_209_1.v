...
module FAU ( 
  ...
  aoi21  g42(.a(new_n93_), .b(new_n82_), .c(new_n61_), .O(new_n94_));
  ...
  nand2  g51(.a(new_n102_), .b(new_n88_), .O(new_n103_));
  nand2  g52(.a(new_n97_), .b(x25), .O(new_n104_));
  nor2   g53(.a(x23), .b(x22), .O(new_n105_));
  nor2   g54(.a(x21), .b(x20), .O(new_n106_));
  nor2   g55(.a(x25), .b(x24), .O(new_n107_));
  nand4  g56(.a(new_n107_), .b(new_n106_), .c(new_n105_), .d(new_n72_), .O(new_n108_));
  nand2  g57(.a(new_n108_), .b(new_n104_), .O(new_n109_));
  nand2  g58(.a(new_n109_), .b(x16), .O(new_n110_));
  nand2  g59(.a(new_n110_), .b(new_n103_), .O(z15));
  nand2  g60(.a(x18), .b(x07), .O(new_n112_));
  oai21  g61(.a(x18), .b(new_n67_), .c(new_n112_), .O(new_n113_));
  nand2  g62(.a(new_n113_), .b(new_n88_), .O(new_n114_));
  nand2  g63(.a(new_n108_), .b(x26), .O(new_n115_));
  nor3   g64(.a(x26), .b(x25), .c(x24), .O(new_n116_));
  nand4  g65(.a(new_n116_), .b(new_n106_), .c(new_n105_), .d(new_n72_), .O(new_n117_));
  ...
  nand4  g70(.a(new_n121_), .b(new_n116_), .c(new_n106_), .d(new_n105_), .O(new_n122_));
  nand2  g71(.a(x27), .b(x17), .O(new_n123_));
  aoi21  g72(.a(new_n123_), .b(new_n122_), .c(new_n88_), .O(z17));
  zero   g73(.O(z02));
  zero   g74(.O(z08));
  zero   g75(.O(z11));
  zero   g76(.O(z12));
