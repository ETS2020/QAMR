...
module FAU ( 
  ...
  nand2  g47(.a(new_n97_), .b(new_n86_), .O(new_n98_));
  nand3  g48(.a(new_n92_), .b(new_n72_), .c(new_n49_), .O(new_n99_));
  nor3   g49(.a(x23), .b(x22), .c(x21), .O(new_n100_));
  aoi22  g50(.a(new_n100_), .b(new_n82_), .c(new_n99_), .d(x23), .O(new_n101_));
  oai21  g51(.a(new_n101_), .b(new_n86_), .c(new_n98_), .O(z13));
  ...
  inv1   g56(.a(x24), .O(new_n107_));
  aoi21  g57(.a(new_n100_), .b(new_n82_), .c(new_n107_), .O(new_n108_));
  nor2   g58(.a(x24), .b(x23), .O(new_n109_));
  nand4  g59(.a(new_n109_), .b(new_n92_), .c(new_n72_), .d(new_n49_), .O(new_n110_));
  ...
  nand2  g66(.a(new_n116_), .b(new_n86_), .O(new_n117_));
  inv1   g67(.a(new_n91_), .O(new_n118_));
  nand4  g68(.a(new_n62_), .b(new_n107_), .c(new_n58_), .d(new_n55_), .O(new_n119_));
  inv1   g69(.a(new_n119_), .O(new_n120_));
  aoi22  g70(.a(new_n120_), .b(new_n118_), .c(new_n110_), .d(x25), .O(new_n121_));
  oai21  g71(.a(new_n121_), .b(new_n86_), .c(new_n117_), .O(z15));
  zero   g72(.O(z00));
  zero   g73(.O(z05));
  zero   g74(.O(z08));
  zero   g75(.O(z11));
