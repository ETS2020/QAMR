...
module FAU ( 
  ...
  inv1   g51(.a(x13), .O(new_n100_));
  nand2  g52(.a(x18), .b(x05), .O(new_n101_));
  oai21  g53(.a(x18), .b(new_n100_), .c(new_n101_), .O(new_n102_));
  nand2  g54(.a(new_n102_), .b(new_n84_), .O(new_n103_));
  nor3   g55(.a(x23), .b(x22), .c(x21), .O(new_n104_));
  aoi21  g56(.a(new_n104_), .b(new_n81_), .c(new_n61_), .O(new_n105_));
  ...
  nand2  g61(.a(new_n109_), .b(new_n103_), .O(z14));
