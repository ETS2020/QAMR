...
module FAU ( 
  ...
  nor3   g38(.a(x20), .b(x19), .c(x17), .O(new_n86_));
  nor2   g39(.a(new_n86_), .b(new_n54_), .O(new_n87_));
  nand4  g40(.a(new_n54_), .b(new_n51_), .c(new_n48_), .d(new_n72_), .O(new_n88_));
  inv1   g41(.a(new_n88_), .O(new_n89_));
  oai21  g42(.a(new_n89_), .b(new_n87_), .c(x16), .O(new_n90_));
  nand2  g43(.a(new_n90_), .b(new_n85_), .O(z11));
  inv1   g44(.a(x12), .O(new_n93_));
  nand2  g45(.a(x18), .b(x04), .O(new_n94_));
  oai21  g46(.a(x18), .b(new_n93_), .c(new_n94_), .O(new_n95_));
  nand2  g47(.a(new_n95_), .b(new_n81_), .O(new_n96_));
  nor2   g48(.a(x22), .b(x21), .O(new_n97_));
  nand3  g49(.a(new_n97_), .b(new_n74_), .c(new_n51_), .O(new_n98_));
  nor3   g50(.a(x23), .b(x22), .c(x21), .O(new_n99_));
  aoi22  g51(.a(new_n99_), .b(new_n86_), .c(new_n98_), .d(x23), .O(new_n100_));
  oai21  g52(.a(new_n100_), .b(new_n81_), .c(new_n96_), .O(z13));
  inv1   g53(.a(x14), .O(new_n103_));
  nand2  g54(.a(x18), .b(x06), .O(new_n104_));
  oai21  g55(.a(x18), .b(new_n103_), .c(new_n104_), .O(new_n105_));
  nand2  g56(.a(new_n105_), .b(new_n81_), .O(new_n106_));
  nor2   g57(.a(x24), .b(x23), .O(new_n107_));
  nand4  g58(.a(new_n107_), .b(new_n97_), .c(new_n74_), .d(new_n51_), .O(new_n108_));
  nand4  g59(.a(new_n66_), .b(new_n63_), .c(new_n60_), .d(new_n57_), .O(new_n109_));
  inv1   g60(.a(new_n109_), .O(new_n110_));
  aoi22  g61(.a(new_n110_), .b(new_n89_), .c(new_n108_), .d(x25), .O(new_n111_));
  oai21  g62(.a(new_n111_), .b(new_n81_), .c(new_n106_), .O(z15));
  nor2   g63(.a(x21), .b(x20), .O(new_n114_));
  nor2   g64(.a(x23), .b(x22), .O(new_n115_));
  nor3   g65(.a(x26), .b(x25), .c(x24), .O(new_n116_));
  nor2   g66(.a(new_n48_), .b(x17), .O(new_n117_));
  nand4  g67(.a(new_n117_), .b(new_n116_), .c(new_n115_), .d(new_n114_), .O(new_n118_));
  nand2  g68(.a(x27), .b(x17), .O(new_n119_));
  aoi21  g69(.a(new_n119_), .b(new_n118_), .c(new_n81_), .O(z17));
  zero   g70(.O(z10));
  zero   g71(.O(z12));
  zero   g72(.O(z14));
  zero   g73(.O(z16));
