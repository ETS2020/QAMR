...
module FAU ( 
  ...
  aoi21  g52(.a(new_n101_), .b(new_n84_), .c(new_n63_), .O(new_n102_));
  nor2   g53(.a(x22), .b(x21), .O(new_n103_));
  nor2   g54(.a(x24), .b(x23), .O(new_n104_));
  nand4  g55(.a(new_n104_), .b(new_n103_), .c(new_n74_), .d(new_n51_), .O(new_n105_));
  inv1   g56(.a(new_n105_), .O(new_n106_));
  oai21  g57(.a(new_n106_), .b(new_n102_), .c(x16), .O(new_n107_));
  nand2  g58(.a(new_n107_), .b(new_n100_), .O(z14));
  ...
  nand4  g65(.a(new_n114_), .b(new_n113_), .c(new_n92_), .d(new_n74_), .O(new_n115_));
  ...
  nand2  g71(.a(new_n120_), .b(new_n87_), .O(new_n121_));
  nand2  g72(.a(new_n115_), .b(x26), .O(new_n122_));
  nor3   g73(.a(x26), .b(x25), .c(x24), .O(new_n123_));
  nand4  g74(.a(new_n123_), .b(new_n113_), .c(new_n92_), .d(new_n74_), .O(new_n124_));
  ...
  nand4  g79(.a(new_n128_), .b(new_n123_), .c(new_n113_), .d(new_n92_), .O(new_n129_));
  nand2  g80(.a(x27), .b(x17), .O(new_n130_));
  aoi21  g81(.a(new_n130_), .b(new_n129_), .c(new_n87_), .O(z17));
  zero   g82(.O(z08));
  zero   g83(.O(z12));
  zero   g84(.O(z13));
endmodule
