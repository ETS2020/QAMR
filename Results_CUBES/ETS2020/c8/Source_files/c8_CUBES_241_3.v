...
module FAU ( 
  ...
  oai21  g26(.a(x18), .b(new_n52_), .c(new_n76_), .O(new_n77_));
  nand2  g27(.a(new_n77_), .b(new_n75_), .O(new_n78_));
  nand2  g28(.a(new_n70_), .b(new_n49_), .O(new_n79_));
  ...
  oai21  g33(.a(x18), .b(new_n55_), .c(new_n83_), .O(new_n84_));
  nand2  g34(.a(new_n84_), .b(new_n75_), .O(new_n85_));
  nand2  g35(.a(new_n80_), .b(new_n70_), .O(new_n86_));
  nor2   g36(.a(x22), .b(x21), .O(new_n87_));
  aoi22  g37(.a(new_n87_), .b(new_n72_), .c(new_n86_), .d(x22), .O(new_n88_));
  oai21  g38(.a(new_n88_), .b(new_n75_), .c(new_n85_), .O(z12));
  nand2  g39(.a(x18), .b(x04), .O(new_n90_));
  oai21  g40(.a(x18), .b(new_n58_), .c(new_n90_), .O(new_n91_));
  nand2  g41(.a(new_n91_), .b(new_n75_), .O(new_n92_));
  nand3  g42(.a(new_n87_), .b(new_n70_), .c(new_n49_), .O(new_n93_));
  nor3   g43(.a(x23), .b(x22), .c(x21), .O(new_n94_));
  aoi22  g44(.a(new_n94_), .b(new_n72_), .c(new_n93_), .d(x23), .O(new_n95_));
  oai21  g45(.a(new_n95_), .b(new_n75_), .c(new_n92_), .O(z13));
  inv1   g46(.a(x13), .O(new_n97_));
  nand2  g47(.a(x18), .b(x05), .O(new_n98_));
  oai21  g48(.a(x18), .b(new_n97_), .c(new_n98_), .O(new_n99_));
  nand2  g49(.a(new_n99_), .b(new_n75_), .O(new_n100_));
  inv1   g50(.a(x24), .O(new_n101_));
  aoi21  g51(.a(new_n94_), .b(new_n72_), .c(new_n101_), .O(new_n102_));
  nor2   g52(.a(x24), .b(x23), .O(new_n103_));
  nand4  g53(.a(new_n103_), .b(new_n87_), .c(new_n70_), .d(new_n49_), .O(new_n104_));
  ...
  nand2  g59(.a(new_n109_), .b(new_n75_), .O(new_n110_));
  nand2  g60(.a(new_n104_), .b(x25), .O(new_n111_));
  nor2   g61(.a(x23), .b(x22), .O(new_n112_));
  nor2   g62(.a(x25), .b(x24), .O(new_n113_));
  nand4  g63(.a(new_n113_), .b(new_n112_), .c(new_n80_), .d(new_n70_), .O(new_n114_));
  ...
  nand2  g70(.a(new_n120_), .b(new_n75_), .O(new_n121_));
  nand2  g71(.a(new_n114_), .b(x26), .O(new_n122_));
  nor3   g72(.a(x26), .b(x25), .c(x24), .O(new_n123_));
  nand4  g73(.a(new_n123_), .b(new_n112_), .c(new_n80_), .d(new_n70_), .O(new_n124_));
  ...
  nand4  g79(.a(new_n129_), .b(new_n123_), .c(new_n112_), .d(new_n80_), .O(new_n130_));
  nand2  g80(.a(x27), .b(x17), .O(new_n131_));
  aoi21  g81(.a(new_n131_), .b(new_n130_), .c(new_n75_), .O(z17));
  zero   g82(.O(z00));
  zero   g83(.O(z05));
  zero   g84(.O(z07));
  zero   g85(.O(z09));
