...
module FAU ( 
  ...
  aoi21  g42(.a(new_n92_), .b(new_n81_), .c(new_n63_), .O(new_n93_));
  ...
  oai21  g50(.a(x18), .b(new_n66_), .c(new_n100_), .O(new_n101_));
  ...
  inv1   g60(.a(x15), .O(new_n111_));
  nand2  g61(.a(x18), .b(x07), .O(new_n112_));
  oai21  g62(.a(x18), .b(new_n111_), .c(new_n112_), .O(new_n113_));
  nand2  g63(.a(new_n113_), .b(new_n87_), .O(new_n114_));
  nand2  g64(.a(new_n107_), .b(x26), .O(new_n115_));
  nor3   g65(.a(x26), .b(x25), .c(x24), .O(new_n116_));
  nand4  g66(.a(new_n116_), .b(new_n105_), .c(new_n104_), .d(new_n71_), .O(new_n117_));
  nand2  g67(.a(new_n117_), .b(new_n115_), .O(new_n118_));
  nand2  g68(.a(new_n118_), .b(x16), .O(new_n119_));
  nand2  g69(.a(new_n119_), .b(new_n114_), .O(z16));
  nor2   g70(.a(new_n48_), .b(x17), .O(new_n121_));
  nand4  g71(.a(new_n121_), .b(new_n116_), .c(new_n105_), .d(new_n104_), .O(new_n122_));
  nand2  g72(.a(x27), .b(x17), .O(new_n123_));
  aoi21  g73(.a(new_n123_), .b(new_n122_), .c(new_n87_), .O(z17));
  zero   g74(.O(z07));
  zero   g75(.O(z11));
  zero   g76(.O(z12));
  zero   g77(.O(z13));
