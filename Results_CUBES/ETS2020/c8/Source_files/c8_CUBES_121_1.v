// Benchmark "FAU" written by ABC on Mon Jul  6 18:50:35 2020
...
module FAU ( 
  ...
  nand2  g58(.a(x18), .b(x06), .O(new_n107_));
  oai21  g59(.a(x18), .b(new_n64_), .c(new_n107_), .O(new_n108_));
  nand2  g60(.a(new_n108_), .b(new_n84_), .O(new_n109_));
  nor2   g61(.a(x24), .b(x23), .O(new_n110_));
  nand4  g62(.a(new_n110_), .b(new_n96_), .c(new_n71_), .d(new_n51_), .O(new_n111_));
  nand2  g63(.a(new_n111_), .b(x25), .O(new_n112_));
  nor2   g64(.a(x23), .b(x22), .O(new_n113_));
  nor2   g65(.a(x25), .b(x24), .O(new_n114_));
  nand4  g66(.a(new_n114_), .b(new_n113_), .c(new_n89_), .d(new_n71_), .O(new_n115_));
  nand2  g67(.a(new_n115_), .b(new_n112_), .O(new_n116_));
  nand2  g68(.a(new_n116_), .b(x16), .O(new_n117_));
  nand2  g69(.a(new_n117_), .b(new_n109_), .O(z15));
  nand2  g70(.a(x18), .b(x07), .O(new_n119_));
  oai21  g71(.a(x18), .b(new_n67_), .c(new_n119_), .O(new_n120_));
  nand2  g72(.a(new_n120_), .b(new_n84_), .O(new_n121_));
  nand2  g73(.a(new_n115_), .b(x26), .O(new_n122_));
  nor3   g74(.a(x26), .b(x25), .c(x24), .O(new_n123_));
  nand4  g75(.a(new_n123_), .b(new_n113_), .c(new_n89_), .d(new_n71_), .O(new_n124_));
  nand2  g76(.a(new_n124_), .b(new_n122_), .O(new_n125_));
  nand2  g77(.a(new_n125_), .b(x16), .O(new_n126_));
  nand2  g78(.a(new_n126_), .b(new_n121_), .O(z16));
  nor2   g79(.a(new_n48_), .b(x17), .O(new_n128_));
  nand4  g80(.a(new_n128_), .b(new_n123_), .c(new_n113_), .d(new_n89_), .O(new_n129_));
  nand2  g81(.a(x27), .b(x17), .O(new_n130_));
  aoi21  g82(.a(new_n130_), .b(new_n129_), .c(new_n84_), .O(z17));
  zero   g83(.O(z05));
  zero   g84(.O(z14));
  buf    g85(.a(x27), .O(z08));
endmodule
