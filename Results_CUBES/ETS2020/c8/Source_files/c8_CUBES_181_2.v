...
module FAU ( 
  ...
  nand2  g39(.a(new_n69_), .b(new_n78_), .O(new_n88_));
  nor2   g40(.a(x21), .b(x20), .O(new_n89_));
  aoi22  g41(.a(new_n89_), .b(new_n69_), .c(new_n88_), .d(x21), .O(new_n90_));
  oai21  g42(.a(new_n90_), .b(new_n83_), .c(new_n87_), .O(z11));
  nand2  g43(.a(x18), .b(x04), .O(new_n93_));
  oai21  g44(.a(x18), .b(new_n56_), .c(new_n93_), .O(new_n94_));
  nand2  g45(.a(new_n94_), .b(new_n83_), .O(new_n95_));
  nor2   g46(.a(x22), .b(x21), .O(new_n96_));
  nand3  g47(.a(new_n96_), .b(new_n69_), .c(new_n78_), .O(new_n97_));
  nor3   g48(.a(x23), .b(x22), .c(x21), .O(new_n98_));
  aoi22  g49(.a(new_n98_), .b(new_n80_), .c(new_n97_), .d(x23), .O(new_n99_));
  oai21  g50(.a(new_n99_), .b(new_n83_), .c(new_n95_), .O(z13));
  ...
  aoi21  g55(.a(new_n98_), .b(new_n80_), .c(new_n59_), .O(new_n105_));
  nor2   g56(.a(x24), .b(x23), .O(new_n106_));
  nand4  g57(.a(new_n106_), .b(new_n96_), .c(new_n69_), .d(new_n78_), .O(new_n107_));
  ...
  oai21  g62(.a(x18), .b(new_n62_), .c(new_n111_), .O(new_n112_));
  nand2  g63(.a(new_n112_), .b(new_n83_), .O(new_n113_));
  nand2  g64(.a(new_n107_), .b(x25), .O(new_n114_));
  nor2   g65(.a(x23), .b(x22), .O(new_n115_));
  nor2   g66(.a(x25), .b(x24), .O(new_n116_));
  nand4  g67(.a(new_n116_), .b(new_n115_), .c(new_n89_), .d(new_n69_), .O(new_n117_));
  nand2  g68(.a(new_n117_), .b(new_n114_), .O(new_n118_));
  nand2  g69(.a(new_n118_), .b(x16), .O(new_n119_));
  nand2  g70(.a(new_n119_), .b(new_n113_), .O(z15));
  nand2  g71(.a(x18), .b(x07), .O(new_n121_));
  oai21  g72(.a(x18), .b(new_n65_), .c(new_n121_), .O(new_n122_));
  nand2  g73(.a(new_n122_), .b(new_n83_), .O(new_n123_));
  nand2  g74(.a(new_n117_), .b(x26), .O(new_n124_));
  nor3   g75(.a(x26), .b(x25), .c(x24), .O(new_n125_));
  nand4  g76(.a(new_n125_), .b(new_n115_), .c(new_n89_), .d(new_n69_), .O(new_n126_));
  ...
  nand4  g81(.a(new_n130_), .b(new_n125_), .c(new_n115_), .d(new_n89_), .O(new_n131_));
  nand2  g82(.a(x27), .b(x17), .O(new_n132_));
  aoi21  g83(.a(new_n132_), .b(new_n131_), .c(new_n83_), .O(z17));
  zero   g84(.O(z01));
  zero   g85(.O(z02));
  zero   g86(.O(z12));
  buf    g87(.a(x27), .O(z08));
