...
module FAU ( 
  ...
  inv1   g33(.a(x16), .O(new_n86_));
  inv1   g34(.a(x13), .O(new_n87_));
  nand2  g35(.a(x18), .b(x05), .O(new_n88_));
  oai21  g36(.a(x18), .b(new_n87_), .c(new_n88_), .O(new_n89_));
  nand2  g37(.a(new_n89_), .b(new_n86_), .O(new_n90_));
  nor3   g38(.a(x23), .b(x22), .c(x21), .O(new_n91_));
  aoi21  g39(.a(new_n91_), .b(new_n80_), .c(new_n59_), .O(new_n92_));
  nor2   g40(.a(x22), .b(x21), .O(new_n93_));
  nor2   g41(.a(x24), .b(x23), .O(new_n94_));
  nand4  g42(.a(new_n94_), .b(new_n93_), .c(new_n70_), .d(new_n49_), .O(new_n95_));
  inv1   g43(.a(new_n95_), .O(new_n96_));
  oai21  g44(.a(new_n96_), .b(new_n92_), .c(x16), .O(new_n97_));
  nand2  g45(.a(new_n97_), .b(new_n90_), .O(z14));
  nand2  g46(.a(x18), .b(x06), .O(new_n99_));
  oai21  g47(.a(x18), .b(new_n62_), .c(new_n99_), .O(new_n100_));
  nand2  g48(.a(new_n100_), .b(new_n86_), .O(new_n101_));
  nand2  g49(.a(new_n95_), .b(x25), .O(new_n102_));
  nor2   g50(.a(x23), .b(x22), .O(new_n103_));
  nor2   g51(.a(x21), .b(x20), .O(new_n104_));
  nor2   g52(.a(x25), .b(x24), .O(new_n105_));
  nand4  g53(.a(new_n105_), .b(new_n104_), .c(new_n103_), .d(new_n70_), .O(new_n106_));
  nand2  g54(.a(new_n106_), .b(new_n102_), .O(new_n107_));
  nand2  g55(.a(new_n107_), .b(x16), .O(new_n108_));
  nand2  g56(.a(new_n108_), .b(new_n101_), .O(z15));
  nand2  g57(.a(x18), .b(x07), .O(new_n110_));
  oai21  g58(.a(x18), .b(new_n65_), .c(new_n110_), .O(new_n111_));
  nand2  g59(.a(new_n111_), .b(new_n86_), .O(new_n112_));
  nand2  g60(.a(new_n106_), .b(x26), .O(new_n113_));
  nor3   g61(.a(x26), .b(x25), .c(x24), .O(new_n114_));
  nand4  g62(.a(new_n114_), .b(new_n104_), .c(new_n103_), .d(new_n70_), .O(new_n115_));
  nand2  g63(.a(new_n115_), .b(new_n113_), .O(new_n116_));
  nand2  g64(.a(new_n116_), .b(x16), .O(new_n117_));
  nand2  g65(.a(new_n117_), .b(new_n112_), .O(z16));
  inv1   g66(.a(x19), .O(new_n119_));
  nor2   g67(.a(new_n119_), .b(x17), .O(new_n120_));
  nand4  g68(.a(new_n120_), .b(new_n114_), .c(new_n104_), .d(new_n103_), .O(new_n121_));
  nand2  g69(.a(x27), .b(x17), .O(new_n122_));
  aoi21  g70(.a(new_n122_), .b(new_n121_), .c(new_n86_), .O(z17));
  zero   g71(.O(z00));
  zero   g72(.O(z02));
  zero   g73(.O(z08));
  zero   g74(.O(z11));
