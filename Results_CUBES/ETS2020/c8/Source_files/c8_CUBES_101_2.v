...
module FAU ( 
  ...
  oai21  g36(.a(x18), .b(new_n55_), .c(new_n85_), .O(new_n86_));
  nand2  g37(.a(new_n86_), .b(new_n84_), .O(new_n87_));
  nor2   g38(.a(x21), .b(x20), .O(new_n88_));
  nand2  g39(.a(new_n88_), .b(new_n69_), .O(new_n89_));
  nor2   g40(.a(x22), .b(x21), .O(new_n90_));
  aoi22  g41(.a(new_n90_), .b(new_n80_), .c(new_n89_), .d(x22), .O(new_n91_));
  oai21  g42(.a(new_n91_), .b(new_n84_), .c(new_n87_), .O(z12));
  nand2  g43(.a(x18), .b(x04), .O(new_n93_));
  oai21  g44(.a(x18), .b(new_n58_), .c(new_n93_), .O(new_n94_));
  nand2  g45(.a(new_n94_), .b(new_n84_), .O(new_n95_));
  nand3  g46(.a(new_n90_), .b(new_n69_), .c(new_n78_), .O(new_n96_));
  nor3   g47(.a(x23), .b(x22), .c(x21), .O(new_n97_));
  aoi22  g48(.a(new_n97_), .b(new_n80_), .c(new_n96_), .d(x23), .O(new_n98_));
  oai21  g49(.a(new_n98_), .b(new_n84_), .c(new_n95_), .O(z13));
  nand2  g50(.a(x18), .b(x06), .O(new_n101_));
  oai21  g51(.a(x18), .b(new_n64_), .c(new_n101_), .O(new_n102_));
  nand2  g52(.a(new_n102_), .b(new_n84_), .O(new_n103_));
  nor2   g53(.a(x24), .b(x23), .O(new_n104_));
  nand4  g54(.a(new_n104_), .b(new_n90_), .c(new_n69_), .d(new_n78_), .O(new_n105_));
  nand2  g55(.a(new_n105_), .b(x25), .O(new_n106_));
  nor2   g56(.a(x23), .b(x22), .O(new_n107_));
  nor2   g57(.a(x25), .b(x24), .O(new_n108_));
  nand4  g58(.a(new_n108_), .b(new_n107_), .c(new_n88_), .d(new_n69_), .O(new_n109_));
  nand2  g59(.a(new_n109_), .b(new_n106_), .O(new_n110_));
  nand2  g60(.a(new_n110_), .b(x16), .O(new_n111_));
  nand2  g61(.a(new_n111_), .b(new_n103_), .O(z15));
  inv1   g62(.a(x15), .O(new_n113_));
  nand2  g63(.a(x18), .b(x07), .O(new_n114_));
  oai21  g64(.a(x18), .b(new_n113_), .c(new_n114_), .O(new_n115_));
  nand2  g65(.a(new_n115_), .b(new_n84_), .O(new_n116_));
  nand2  g66(.a(new_n109_), .b(x26), .O(new_n117_));
  nor3   g67(.a(x26), .b(x25), .c(x24), .O(new_n118_));
  nand4  g68(.a(new_n118_), .b(new_n107_), .c(new_n88_), .d(new_n69_), .O(new_n119_));
  nand2  g69(.a(new_n119_), .b(new_n117_), .O(new_n120_));
  nand2  g70(.a(new_n120_), .b(x16), .O(new_n121_));
  nand2  g71(.a(new_n121_), .b(new_n116_), .O(z16));
  nor2   g72(.a(new_n48_), .b(x17), .O(new_n123_));
  nand4  g73(.a(new_n123_), .b(new_n118_), .c(new_n107_), .d(new_n88_), .O(new_n124_));
  nand2  g74(.a(x27), .b(x17), .O(new_n125_));
  aoi21  g75(.a(new_n125_), .b(new_n124_), .c(new_n84_), .O(z17));
  zero   g76(.O(z01));
  zero   g77(.O(z07));
  zero   g78(.O(z11));
  zero   g79(.O(z14));
