...
module FAU ( 
  ...
  xor2a  g34(.a(new_n71_), .b(new_n51_), .O(new_n82_));
  oai21  g35(.a(new_n82_), .b(new_n77_), .c(new_n81_), .O(z10));
  inv1   g36(.a(x10), .O(new_n84_));
  nand2  g37(.a(x18), .b(x02), .O(new_n85_));
  oai21  g38(.a(x18), .b(new_n84_), .c(new_n85_), .O(new_n86_));
  nand2  g39(.a(new_n86_), .b(new_n77_), .O(new_n87_));
  ...
  oai21  g43(.a(new_n90_), .b(new_n77_), .c(new_n87_), .O(z11));
  nand2  g44(.a(x18), .b(x06), .O(new_n95_));
  oai21  g45(.a(x18), .b(new_n64_), .c(new_n95_), .O(new_n96_));
  nand2  g46(.a(new_n96_), .b(new_n77_), .O(new_n97_));
  nor2   g47(.a(x22), .b(x21), .O(new_n98_));
  nor2   g48(.a(x24), .b(x23), .O(new_n99_));
  nand4  g49(.a(new_n99_), .b(new_n98_), .c(new_n71_), .d(new_n51_), .O(new_n100_));
  ...
  nand2  g59(.a(new_n109_), .b(new_n77_), .O(new_n110_));
  nand2  g60(.a(new_n104_), .b(x26), .O(new_n111_));
  nor3   g61(.a(x26), .b(x25), .c(x24), .O(new_n112_));
  nand4  g62(.a(new_n112_), .b(new_n102_), .c(new_n89_), .d(new_n71_), .O(new_n113_));
  ...
  nand4  g67(.a(new_n117_), .b(new_n112_), .c(new_n102_), .d(new_n89_), .O(new_n118_));
  nand2  g68(.a(x27), .b(x17), .O(new_n119_));
  aoi21  g69(.a(new_n119_), .b(new_n118_), .c(new_n77_), .O(z17));
  zero   g70(.O(z02));
  zero   g71(.O(z12));
  zero   g72(.O(z13));
  zero   g73(.O(z14));
