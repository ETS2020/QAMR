...
module FAU ( 
  ...
  aoi21  g40(.a(new_n86_), .b(new_n78_), .c(new_n57_), .O(new_n93_));
  nand2  g41(.a(new_n74_), .b(new_n51_), .O(new_n94_));
  nor2   g42(.a(x24), .b(x23), .O(new_n95_));
  nand2  g43(.a(new_n95_), .b(new_n77_), .O(new_n96_));
  nor2   g44(.a(new_n96_), .b(new_n94_), .O(new_n97_));
  oai21  g45(.a(new_n97_), .b(new_n93_), .c(x16), .O(new_n98_));
  nand2  g46(.a(new_n98_), .b(new_n92_), .O(z14));
  zero   g47(.O(z02));
  zero   g48(.O(z03));
  zero   g49(.O(z04));
  zero   g50(.O(z09));
