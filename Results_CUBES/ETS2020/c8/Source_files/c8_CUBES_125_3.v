...
module FAU ( 
  ...
  oai21  g30(.a(x18), .b(new_n55_), .c(new_n80_), .O(new_n81_));
  nand2  g31(.a(new_n81_), .b(new_n70_), .O(new_n82_));
  nor3   g32(.a(x20), .b(x19), .c(x17), .O(new_n83_));
  nand2  g33(.a(new_n77_), .b(new_n74_), .O(new_n84_));
  nor2   g34(.a(x22), .b(x21), .O(new_n85_));
  aoi22  g35(.a(new_n85_), .b(new_n83_), .c(new_n84_), .d(x22), .O(new_n86_));
  oai21  g36(.a(new_n86_), .b(new_n70_), .c(new_n82_), .O(z12));
  nand2  g37(.a(x18), .b(x04), .O(new_n88_));
  oai21  g38(.a(x18), .b(new_n58_), .c(new_n88_), .O(new_n89_));
  nand2  g39(.a(new_n89_), .b(new_n70_), .O(new_n90_));
  nand3  g40(.a(new_n85_), .b(new_n74_), .c(new_n75_), .O(new_n91_));
  nor3   g41(.a(x23), .b(x22), .c(x21), .O(new_n92_));
  aoi22  g42(.a(new_n92_), .b(new_n83_), .c(new_n91_), .d(x23), .O(new_n93_));
  oai21  g43(.a(new_n93_), .b(new_n70_), .c(new_n90_), .O(z13));
  inv1   g44(.a(x13), .O(new_n95_));
  nand2  g45(.a(x18), .b(x05), .O(new_n96_));
  oai21  g46(.a(x18), .b(new_n95_), .c(new_n96_), .O(new_n97_));
  nand2  g47(.a(new_n97_), .b(new_n70_), .O(new_n98_));
  aoi21  g48(.a(new_n92_), .b(new_n83_), .c(new_n61_), .O(new_n99_));
  nor2   g49(.a(x24), .b(x23), .O(new_n100_));
  nand4  g50(.a(new_n100_), .b(new_n85_), .c(new_n74_), .d(new_n75_), .O(new_n101_));
  ...
  nand2  g56(.a(new_n106_), .b(new_n70_), .O(new_n107_));
  nand2  g57(.a(new_n101_), .b(x25), .O(new_n108_));
  nor2   g58(.a(x23), .b(x22), .O(new_n109_));
  nor2   g59(.a(x25), .b(x24), .O(new_n110_));
  nand4  g60(.a(new_n110_), .b(new_n109_), .c(new_n77_), .d(new_n74_), .O(new_n111_));
  ...
  nand4  g70(.a(new_n120_), .b(new_n109_), .c(new_n77_), .d(new_n74_), .O(new_n121_));
  ...
  nand4  g75(.a(new_n125_), .b(new_n120_), .c(new_n109_), .d(new_n77_), .O(new_n126_));
