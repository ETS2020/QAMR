...
module FAU ( 
  ...
  nand2  g53(.a(new_n101_), .b(new_n87_), .O(new_n102_));
  nor3   g54(.a(x23), .b(x22), .c(x21), .O(new_n103_));
  aoi21  g55(.a(new_n103_), .b(new_n84_), .c(new_n63_), .O(new_n104_));
  nor2   g56(.a(x22), .b(x21), .O(new_n105_));
  nor2   g57(.a(x24), .b(x23), .O(new_n106_));
  nand4  g58(.a(new_n106_), .b(new_n105_), .c(new_n74_), .d(new_n51_), .O(new_n107_));
  inv1   g59(.a(new_n107_), .O(new_n108_));
  oai21  g60(.a(new_n108_), .b(new_n104_), .c(x16), .O(new_n109_));
  nand2  g61(.a(new_n109_), .b(new_n102_), .O(z14));
  inv1   g62(.a(x14), .O(new_n111_));
  nand2  g63(.a(x18), .b(x06), .O(new_n112_));
  oai21  g64(.a(x18), .b(new_n111_), .c(new_n112_), .O(new_n113_));
  nand2  g65(.a(new_n113_), .b(new_n87_), .O(new_n114_));
  nand4  g66(.a(new_n66_), .b(new_n63_), .c(new_n60_), .d(new_n57_), .O(new_n115_));
  inv1   g67(.a(new_n115_), .O(new_n116_));
  aoi22  g68(.a(new_n116_), .b(new_n94_), .c(new_n107_), .d(x25), .O(new_n117_));
  oai21  g69(.a(new_n117_), .b(new_n87_), .c(new_n114_), .O(z15));
  nor2   g70(.a(x21), .b(x20), .O(new_n120_));
  nor2   g71(.a(x23), .b(x22), .O(new_n121_));
  nor3   g72(.a(x26), .b(x25), .c(x24), .O(new_n122_));
  nor2   g73(.a(new_n48_), .b(x17), .O(new_n123_));
  nand4  g74(.a(new_n123_), .b(new_n122_), .c(new_n121_), .d(new_n120_), .O(new_n124_));
  nand2  g75(.a(x27), .b(x17), .O(new_n125_));
  aoi21  g76(.a(new_n125_), .b(new_n124_), .c(new_n87_), .O(z17));
  zero   g77(.O(z12));
  zero   g78(.O(z13));
  zero   g79(.O(z16));
  buf    g80(.a(x27), .O(z08));
