...
module FAU ( 
  ...
  inv1   g50(.a(x12), .O(new_n98_));
  nand2  g51(.a(x18), .b(x04), .O(new_n99_));
  oai21  g52(.a(x18), .b(new_n98_), .c(new_n99_), .O(new_n100_));
  nand2  g53(.a(new_n100_), .b(new_n87_), .O(new_n101_));
  nor2   g54(.a(x22), .b(x21), .O(new_n102_));
  nand3  g55(.a(new_n102_), .b(new_n74_), .c(new_n51_), .O(new_n103_));
  nor3   g56(.a(x23), .b(x22), .c(x21), .O(new_n104_));
  aoi22  g57(.a(new_n104_), .b(new_n84_), .c(new_n103_), .d(x23), .O(new_n105_));
  oai21  g58(.a(new_n105_), .b(new_n87_), .c(new_n101_), .O(z13));
  inv1   g59(.a(x13), .O(new_n107_));
  nand2  g60(.a(x18), .b(x05), .O(new_n108_));
  oai21  g61(.a(x18), .b(new_n107_), .c(new_n108_), .O(new_n109_));
  nand2  g62(.a(new_n109_), .b(new_n87_), .O(new_n110_));
  aoi21  g63(.a(new_n104_), .b(new_n84_), .c(new_n63_), .O(new_n111_));
  nor2   g64(.a(x24), .b(x23), .O(new_n112_));
  nand4  g65(.a(new_n112_), .b(new_n102_), .c(new_n74_), .d(new_n51_), .O(new_n113_));
  ...
  nand2  g72(.a(new_n119_), .b(new_n87_), .O(new_n120_));
  nand4  g73(.a(new_n66_), .b(new_n63_), .c(new_n60_), .d(new_n57_), .O(new_n121_));
  inv1   g74(.a(new_n121_), .O(new_n122_));
  aoi22  g75(.a(new_n122_), .b(new_n94_), .c(new_n113_), .d(x25), .O(new_n123_));
  oai21  g76(.a(new_n123_), .b(new_n87_), .c(new_n120_), .O(z15));
  ...
  aoi21  g83(.a(new_n131_), .b(new_n130_), .c(new_n87_), .O(z17));
  zero   g84(.O(z12));
  zero   g85(.O(z16));
  buf    g86(.a(x27), .O(z08));
endmodule
