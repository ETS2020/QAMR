...
module FAU ( 
  ...
  oai21  g43(.a(x18), .b(new_n58_), .c(new_n92_), .O(new_n93_));
  ...
  nand4  g56(.a(new_n105_), .b(new_n95_), .c(new_n69_), .d(new_n78_), .O(new_n106_));
  ...
  nand4  g66(.a(new_n115_), .b(new_n114_), .c(new_n88_), .d(new_n69_), .O(new_n116_));
  ...
  nand4  g76(.a(new_n125_), .b(new_n114_), .c(new_n88_), .d(new_n69_), .O(new_n126_));
  ...
  nand4  g81(.a(new_n130_), .b(new_n125_), .c(new_n114_), .d(new_n88_), .O(new_n131_));
