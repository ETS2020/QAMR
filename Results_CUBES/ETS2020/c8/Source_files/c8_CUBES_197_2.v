...
module FAU ( 
  ...
  nand3  g41(.a(new_n90_), .b(new_n71_), .c(new_n51_), .O(new_n91_));
  nor3   g42(.a(x23), .b(x22), .c(x21), .O(new_n92_));
  aoi22  g43(.a(new_n92_), .b(new_n81_), .c(new_n91_), .d(x23), .O(new_n93_));
  oai21  g44(.a(new_n93_), .b(new_n86_), .c(new_n89_), .O(z13));
  ...
  aoi21  g49(.a(new_n92_), .b(new_n81_), .c(new_n63_), .O(new_n99_));
  nor2   g50(.a(x24), .b(x23), .O(new_n100_));
  nand4  g51(.a(new_n100_), .b(new_n90_), .c(new_n71_), .d(new_n51_), .O(new_n101_));
  inv1   g52(.a(new_n101_), .O(new_n102_));
  oai21  g53(.a(new_n102_), .b(new_n99_), .c(x16), .O(new_n103_));
  ...
  nand2  g58(.a(new_n101_), .b(x25), .O(new_n108_));
  nor2   g59(.a(x23), .b(x22), .O(new_n109_));
  nor2   g60(.a(x21), .b(x20), .O(new_n110_));
  nor2   g61(.a(x25), .b(x24), .O(new_n111_));
  nand4  g62(.a(new_n111_), .b(new_n110_), .c(new_n109_), .d(new_n71_), .O(new_n112_));
  nand2  g63(.a(new_n112_), .b(new_n108_), .O(new_n113_));
  nand2  g64(.a(new_n113_), .b(x16), .O(new_n114_));
  nand2  g65(.a(new_n114_), .b(new_n107_), .O(z15));
  ...
  nand4  g72(.a(new_n121_), .b(new_n110_), .c(new_n109_), .d(new_n71_), .O(new_n122_));
  ...
  nand4  g77(.a(new_n126_), .b(new_n121_), .c(new_n110_), .d(new_n109_), .O(new_n127_));
