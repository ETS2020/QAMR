...
module FAU ( 
  ...
  nand4  g39(.a(new_n54_), .b(new_n51_), .c(new_n48_), .d(new_n68_), .O(new_n89_));
  nor2   g40(.a(x22), .b(x21), .O(new_n90_));
  aoi22  g41(.a(new_n90_), .b(new_n80_), .c(new_n89_), .d(x22), .O(new_n91_));
  oai21  g42(.a(new_n91_), .b(new_n84_), .c(new_n88_), .O(z12));
  ...
  nand3  g47(.a(new_n90_), .b(new_n70_), .c(new_n51_), .O(new_n97_));
  nor3   g48(.a(x23), .b(x22), .c(x21), .O(new_n98_));
  aoi22  g49(.a(new_n98_), .b(new_n80_), .c(new_n97_), .d(x23), .O(new_n99_));
  oai21  g50(.a(new_n99_), .b(new_n84_), .c(new_n96_), .O(z13));
  inv1   g51(.a(x14), .O(new_n102_));
  nand2  g52(.a(x18), .b(x06), .O(new_n103_));
  oai21  g53(.a(x18), .b(new_n102_), .c(new_n103_), .O(new_n104_));
  nand2  g54(.a(new_n104_), .b(new_n84_), .O(new_n105_));
  inv1   g55(.a(new_n89_), .O(new_n106_));
  nor2   g56(.a(x24), .b(x23), .O(new_n107_));
  nand4  g57(.a(new_n107_), .b(new_n90_), .c(new_n70_), .d(new_n51_), .O(new_n108_));
  inv1   g58(.a(x25), .O(new_n109_));
  nand4  g59(.a(new_n109_), .b(new_n63_), .c(new_n60_), .d(new_n57_), .O(new_n110_));
  inv1   g60(.a(new_n110_), .O(new_n111_));
  aoi22  g61(.a(new_n111_), .b(new_n106_), .c(new_n108_), .d(x25), .O(new_n112_));
  oai21  g62(.a(new_n112_), .b(new_n84_), .c(new_n105_), .O(z15));
  ...
  aoi21  g69(.a(new_n120_), .b(new_n119_), .c(new_n84_), .O(z17));
  zero   g70(.O(z06));
  zero   g71(.O(z07));
  zero   g72(.O(z11));
  zero   g73(.O(z14));
