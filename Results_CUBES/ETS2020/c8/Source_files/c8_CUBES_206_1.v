...
module FAU ( 
  ...
  oai21  g43(.a(new_n91_), .b(new_n78_), .c(new_n88_), .O(z11));
  ...
  nand4  g49(.a(new_n100_), .b(new_n99_), .c(new_n72_), .d(new_n51_), .O(new_n101_));
  ...
  aoi21  g69(.a(new_n120_), .b(new_n119_), .c(new_n78_), .O(z17));
  zero   g70(.O(z02));
  zero   g71(.O(z08));
  zero   g72(.O(z12));
  zero   g73(.O(z13));
