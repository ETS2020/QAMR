...
module FAU ( 
  ...
  oai21  g49(.a(x18), .b(new_n58_), .c(new_n97_), .O(new_n98_));
  nand2  g50(.a(new_n98_), .b(new_n82_), .O(new_n99_));
  nand3  g51(.a(new_n94_), .b(new_n69_), .c(new_n49_), .O(new_n100_));
  ...
  nand2  g58(.a(new_n106_), .b(new_n82_), .O(new_n107_));
  aoi21  g59(.a(new_n101_), .b(new_n79_), .c(new_n61_), .O(new_n108_));
  nor2   g60(.a(x24), .b(x23), .O(new_n109_));
  nand4  g61(.a(new_n109_), .b(new_n94_), .c(new_n69_), .d(new_n49_), .O(new_n110_));
  ...
  inv1   g65(.a(x14), .O(new_n114_));
  nand2  g66(.a(x18), .b(x06), .O(new_n115_));
  oai21  g67(.a(x18), .b(new_n114_), .c(new_n115_), .O(new_n116_));
  nand2  g68(.a(new_n116_), .b(new_n82_), .O(new_n117_));
  nand2  g69(.a(new_n110_), .b(x25), .O(new_n118_));
  nor2   g70(.a(x23), .b(x22), .O(new_n119_));
  nor2   g71(.a(x25), .b(x24), .O(new_n120_));
  nand4  g72(.a(new_n120_), .b(new_n119_), .c(new_n87_), .d(new_n69_), .O(new_n121_));
  ...
  nand2  g76(.a(x18), .b(x07), .O(new_n125_));
  oai21  g77(.a(x18), .b(new_n65_), .c(new_n125_), .O(new_n126_));
  nand2  g78(.a(new_n126_), .b(new_n82_), .O(new_n127_));
  nand2  g79(.a(new_n121_), .b(x26), .O(new_n128_));
  nor3   g80(.a(x26), .b(x25), .c(x24), .O(new_n129_));
  nand4  g81(.a(new_n129_), .b(new_n119_), .c(new_n87_), .d(new_n69_), .O(new_n130_));
  nand2  g82(.a(new_n130_), .b(new_n128_), .O(new_n131_));
  nand2  g83(.a(new_n131_), .b(x16), .O(new_n132_));
  nand2  g84(.a(new_n132_), .b(new_n127_), .O(z16));
  inv1   g85(.a(x19), .O(new_n134_));
  nor2   g86(.a(new_n134_), .b(x17), .O(new_n135_));
  nand4  g87(.a(new_n135_), .b(new_n129_), .c(new_n119_), .d(new_n87_), .O(new_n136_));
  nand2  g88(.a(x27), .b(x17), .O(new_n137_));
  aoi21  g89(.a(new_n137_), .b(new_n136_), .c(new_n82_), .O(z17));
  zero   g90(.O(z00));
  zero   g91(.O(z06));
  buf    g92(.a(x27), .O(z08));
endmodule
