...
module FAU ( 
  ...
  inv1   g51(.a(x21), .O(new_n102_));
  nand4  g52(.a(new_n61_), .b(new_n58_), .c(new_n55_), .d(new_n102_), .O(new_n103_));
  nor2   g53(.a(new_n103_), .b(new_n90_), .O(new_n104_));
  ...
  oai21  g57(.a(x18), .b(new_n67_), .c(new_n108_), .O(new_n109_));
  nand2  g58(.a(new_n109_), .b(new_n85_), .O(new_n110_));
  nor2   g59(.a(x23), .b(x22), .O(new_n111_));
  nor2   g60(.a(x25), .b(x24), .O(new_n112_));
  nand4  g61(.a(new_n112_), .b(new_n111_), .c(new_n91_), .d(new_n72_), .O(new_n113_));
  nand2  g62(.a(new_n113_), .b(x26), .O(new_n114_));
  nor3   g63(.a(x26), .b(x25), .c(x24), .O(new_n115_));
  nand4  g64(.a(new_n115_), .b(new_n111_), .c(new_n91_), .d(new_n72_), .O(new_n116_));
  ...
  nand4  g69(.a(new_n120_), .b(new_n115_), .c(new_n111_), .d(new_n91_), .O(new_n121_));
  nand2  g70(.a(x27), .b(x17), .O(new_n122_));
  aoi21  g71(.a(new_n122_), .b(new_n121_), .c(new_n85_), .O(z17));
  zero   g72(.O(z02));
  zero   g73(.O(z08));
  zero   g74(.O(z12));
  zero   g75(.O(z13));
