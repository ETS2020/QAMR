...
module FAU ( 
  ...
  wire new_n47_, new_n48_, new_n49_, new_n51_, new_n52_, new_n54_, new_n55_,
    ...
    new_n78_, new_n79_, new_n80_, new_n81_, new_n82_, new_n83_, new_n88_,
  ...
  inv1   g36(.a(x16), .O(new_n88_));
  inv1   g37(.a(x13), .O(new_n89_));
  nand2  g38(.a(x18), .b(x05), .O(new_n90_));
  oai21  g39(.a(x18), .b(new_n89_), .c(new_n90_), .O(new_n91_));
  nand2  g40(.a(new_n91_), .b(new_n88_), .O(new_n92_));
  nor3   g41(.a(x23), .b(x22), .c(x21), .O(new_n93_));
  aoi21  g42(.a(new_n93_), .b(new_n82_), .c(new_n63_), .O(new_n94_));
  nor2   g43(.a(x22), .b(x21), .O(new_n95_));
  nor2   g44(.a(x24), .b(x23), .O(new_n96_));
  nand4  g45(.a(new_n96_), .b(new_n95_), .c(new_n72_), .d(new_n51_), .O(new_n97_));
  ...
  nand2  g52(.a(new_n103_), .b(new_n88_), .O(new_n104_));
  nand2  g53(.a(new_n97_), .b(x25), .O(new_n105_));
  nor2   g54(.a(x23), .b(x22), .O(new_n106_));
  nor2   g55(.a(x21), .b(x20), .O(new_n107_));
  nor2   g56(.a(x25), .b(x24), .O(new_n108_));
  nand4  g57(.a(new_n108_), .b(new_n107_), .c(new_n106_), .d(new_n72_), .O(new_n109_));
  nand2  g58(.a(new_n109_), .b(new_n105_), .O(new_n110_));
  nand2  g59(.a(new_n110_), .b(x16), .O(new_n111_));
  nand2  g60(.a(new_n111_), .b(new_n104_), .O(z15));
  nand2  g61(.a(x18), .b(x07), .O(new_n113_));
  oai21  g62(.a(x18), .b(new_n67_), .c(new_n113_), .O(new_n114_));
  nand2  g63(.a(new_n114_), .b(new_n88_), .O(new_n115_));
  nand2  g64(.a(new_n109_), .b(x26), .O(new_n116_));
  nor3   g65(.a(x26), .b(x25), .c(x24), .O(new_n117_));
  nand4  g66(.a(new_n117_), .b(new_n107_), .c(new_n106_), .d(new_n72_), .O(new_n118_));
  nand2  g67(.a(new_n118_), .b(new_n116_), .O(new_n119_));
  nand2  g68(.a(new_n119_), .b(x16), .O(new_n120_));
  nand2  g69(.a(new_n120_), .b(new_n115_), .O(z16));
  nor2   g70(.a(new_n48_), .b(x17), .O(new_n122_));
  nand4  g71(.a(new_n122_), .b(new_n117_), .c(new_n107_), .d(new_n106_), .O(new_n123_));
  nand2  g72(.a(x27), .b(x17), .O(new_n124_));
  aoi21  g73(.a(new_n124_), .b(new_n123_), .c(new_n88_), .O(z17));
  zero   g74(.O(z06));
  zero   g75(.O(z08));
  zero   g76(.O(z11));
  zero   g77(.O(z12));
