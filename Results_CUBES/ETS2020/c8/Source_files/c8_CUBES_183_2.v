...
module FAU ( 
  ...
  nand2  g61(.a(new_n111_), .b(new_n83_), .O(new_n112_));
  nor2   g62(.a(x24), .b(x23), .O(new_n113_));
  nand4  g63(.a(new_n113_), .b(new_n97_), .c(new_n69_), .d(new_n78_), .O(new_n114_));
  nand4  g64(.a(new_n62_), .b(new_n59_), .c(new_n56_), .d(new_n53_), .O(new_n115_));
  inv1   g65(.a(new_n115_), .O(new_n116_));
  aoi22  g66(.a(new_n116_), .b(new_n90_), .c(new_n114_), .d(x25), .O(new_n117_));
  oai21  g67(.a(new_n117_), .b(new_n83_), .c(new_n112_), .O(z15));
