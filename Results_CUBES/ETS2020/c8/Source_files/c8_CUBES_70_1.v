...
module FAU ( 
  ...
  aoi21  g47(.a(new_n97_), .b(new_n79_), .c(new_n59_), .O(new_n98_));
  inv1   g48(.a(x23), .O(new_n99_));
  nand4  g49(.a(new_n59_), .b(new_n99_), .c(new_n55_), .d(new_n52_), .O(new_n100_));
  nor2   g50(.a(new_n100_), .b(new_n87_), .O(new_n101_));
  oai21  g51(.a(new_n101_), .b(new_n98_), .c(x16), .O(new_n102_));
