...
module FAU ( 
  ...
  wire new_n47_, new_n48_, new_n49_, new_n51_, new_n52_, new_n54_, new_n55_,
    new_n57_, new_n58_, new_n60_, new_n61_, new_n65_, new_n66_, new_n68_,
  ...
  nor2   g29(.a(new_n69_), .b(new_n51_), .O(new_n78_));
  ...
  oai21  g35(.a(x18), .b(new_n54_), .c(new_n83_), .O(new_n84_));
  ...
  oai21  g42(.a(x18), .b(new_n57_), .c(new_n90_), .O(new_n91_));
  ...
  nand3  g51(.a(new_n94_), .b(new_n69_), .c(new_n51_), .O(new_n100_));
  ...
  aoi21  g60(.a(new_n101_), .b(new_n79_), .c(new_n108_), .O(new_n109_));
  nor2   g61(.a(x24), .b(x23), .O(new_n110_));
  nand4  g62(.a(new_n110_), .b(new_n94_), .c(new_n69_), .d(new_n51_), .O(new_n111_));
  inv1   g63(.a(new_n111_), .O(new_n112_));
  oai21  g64(.a(new_n112_), .b(new_n109_), .c(x16), .O(new_n113_));
  nand2  g65(.a(new_n113_), .b(new_n107_), .O(z14));
  inv1   g66(.a(x14), .O(new_n115_));
  nand2  g67(.a(x18), .b(x06), .O(new_n116_));
  oai21  g68(.a(x18), .b(new_n115_), .c(new_n116_), .O(new_n117_));
  nand2  g69(.a(new_n117_), .b(new_n82_), .O(new_n118_));
  nand2  g70(.a(new_n111_), .b(x25), .O(new_n119_));
  nor2   g71(.a(x23), .b(x22), .O(new_n120_));
  nor2   g72(.a(x25), .b(x24), .O(new_n121_));
  nand4  g73(.a(new_n121_), .b(new_n120_), .c(new_n87_), .d(new_n69_), .O(new_n122_));
  nand2  g74(.a(new_n122_), .b(new_n119_), .O(new_n123_));
  nand2  g75(.a(new_n123_), .b(x16), .O(new_n124_));
  nand2  g76(.a(new_n124_), .b(new_n118_), .O(z15));
  nand2  g77(.a(x18), .b(x07), .O(new_n126_));
  oai21  g78(.a(x18), .b(new_n65_), .c(new_n126_), .O(new_n127_));
  nand2  g79(.a(new_n127_), .b(new_n82_), .O(new_n128_));
  nand2  g80(.a(new_n122_), .b(x26), .O(new_n129_));
  nor3   g81(.a(x26), .b(x25), .c(x24), .O(new_n130_));
  nand4  g82(.a(new_n130_), .b(new_n120_), .c(new_n87_), .d(new_n69_), .O(new_n131_));
  ...
  nand4  g87(.a(new_n135_), .b(new_n130_), .c(new_n120_), .d(new_n87_), .O(new_n136_));
