...
module FAU ( 
  ...
  nand2  g45(.a(x18), .b(x06), .O(new_n96_));
  oai21  g46(.a(x18), .b(new_n66_), .c(new_n96_), .O(new_n97_));
  nand2  g47(.a(new_n97_), .b(new_n85_), .O(new_n98_));
  nor2   g48(.a(x24), .b(x23), .O(new_n99_));
  nand4  g49(.a(new_n99_), .b(new_n91_), .c(new_n71_), .d(new_n51_), .O(new_n100_));
  nand2  g50(.a(new_n100_), .b(x25), .O(new_n101_));
  nor2   g51(.a(x23), .b(x22), .O(new_n102_));
  nor2   g52(.a(x25), .b(x24), .O(new_n103_));
  nand4  g53(.a(new_n103_), .b(new_n102_), .c(new_n89_), .d(new_n71_), .O(new_n104_));
  nand2  g54(.a(new_n104_), .b(new_n101_), .O(new_n105_));
  nand2  g55(.a(new_n105_), .b(x16), .O(new_n106_));
  nand2  g56(.a(new_n106_), .b(new_n98_), .O(z15));
  inv1   g57(.a(x15), .O(new_n108_));
  nand2  g58(.a(x18), .b(x07), .O(new_n109_));
  oai21  g59(.a(x18), .b(new_n108_), .c(new_n109_), .O(new_n110_));
  nand2  g60(.a(new_n110_), .b(new_n85_), .O(new_n111_));
  nand2  g61(.a(new_n104_), .b(x26), .O(new_n112_));
  nor3   g62(.a(x26), .b(x25), .c(x24), .O(new_n113_));
  nand4  g63(.a(new_n113_), .b(new_n102_), .c(new_n89_), .d(new_n71_), .O(new_n114_));
  nand2  g64(.a(new_n114_), .b(new_n112_), .O(new_n115_));
  nand2  g65(.a(new_n115_), .b(x16), .O(new_n116_));
  nand2  g66(.a(new_n116_), .b(new_n111_), .O(z16));
  nor2   g67(.a(new_n48_), .b(x17), .O(new_n118_));
  nand4  g68(.a(new_n118_), .b(new_n113_), .c(new_n102_), .d(new_n89_), .O(new_n119_));
  nand2  g69(.a(x27), .b(x17), .O(new_n120_));
  aoi21  g70(.a(new_n120_), .b(new_n119_), .c(new_n85_), .O(z17));
  zero   g71(.O(z07));
  zero   g72(.O(z11));
  zero   g73(.O(z13));
  zero   g74(.O(z14));
