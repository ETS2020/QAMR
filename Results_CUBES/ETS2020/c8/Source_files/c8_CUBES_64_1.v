...
module FAU ( 
  ...
  nand4  g49(.a(new_n71_), .b(new_n55_), .c(new_n52_), .d(new_n49_), .O(new_n98_));
  ...
  nand4  g58(.a(new_n61_), .b(new_n58_), .c(new_n55_), .d(new_n52_), .O(new_n107_));
  nor2   g59(.a(new_n107_), .b(new_n89_), .O(new_n108_));
  ...
  inv1   g64(.a(x19), .O(new_n115_));
  nor2   g65(.a(new_n115_), .b(x17), .O(new_n116_));
  nand4  g66(.a(new_n116_), .b(new_n114_), .c(new_n113_), .d(new_n90_), .O(new_n117_));
  nand2  g67(.a(x27), .b(x17), .O(new_n118_));
  aoi21  g68(.a(new_n118_), .b(new_n117_), .c(new_n84_), .O(z17));
  zero   g69(.O(z00));
  zero   g70(.O(z12));
  zero   g71(.O(z15));
  zero   g72(.O(z16));
