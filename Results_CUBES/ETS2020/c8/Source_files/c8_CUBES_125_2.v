...
module FAU ( 
  ...
  nand3  g48(.a(new_n91_), .b(new_n71_), .c(new_n49_), .O(new_n98_));
  nor3   g49(.a(x23), .b(x22), .c(x21), .O(new_n99_));
  aoi22  g50(.a(new_n99_), .b(new_n81_), .c(new_n98_), .d(x23), .O(new_n100_));
  oai21  g51(.a(new_n100_), .b(new_n85_), .c(new_n97_), .O(z13));
  inv1   g52(.a(x14), .O(new_n103_));
  nand2  g53(.a(x18), .b(x06), .O(new_n104_));
  oai21  g54(.a(x18), .b(new_n103_), .c(new_n104_), .O(new_n105_));
  nand2  g55(.a(new_n105_), .b(new_n85_), .O(new_n106_));
  inv1   g56(.a(new_n90_), .O(new_n107_));
  nor2   g57(.a(x24), .b(x23), .O(new_n108_));
  nand4  g58(.a(new_n108_), .b(new_n91_), .c(new_n71_), .d(new_n49_), .O(new_n109_));
  inv1   g59(.a(x25), .O(new_n110_));
  nand4  g60(.a(new_n110_), .b(new_n61_), .c(new_n58_), .d(new_n55_), .O(new_n111_));
  inv1   g61(.a(new_n111_), .O(new_n112_));
  aoi22  g62(.a(new_n112_), .b(new_n107_), .c(new_n109_), .d(x25), .O(new_n113_));
  oai21  g63(.a(new_n113_), .b(new_n85_), .c(new_n106_), .O(z15));
