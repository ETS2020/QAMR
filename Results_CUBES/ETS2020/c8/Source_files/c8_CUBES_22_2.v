...
module FAU ( 
  ...
  oai21  g46(.a(x18), .b(new_n64_), .c(new_n96_), .O(new_n97_));
  nand2  g47(.a(new_n97_), .b(new_n79_), .O(new_n98_));
  nor2   g48(.a(x24), .b(x23), .O(new_n99_));
  nand4  g49(.a(new_n99_), .b(new_n91_), .c(new_n74_), .d(new_n49_), .O(new_n100_));
  nand2  g50(.a(new_n100_), .b(x25), .O(new_n101_));
  nor2   g51(.a(x23), .b(x22), .O(new_n102_));
  nor2   g52(.a(x25), .b(x24), .O(new_n103_));
  nand4  g53(.a(new_n103_), .b(new_n102_), .c(new_n84_), .d(new_n74_), .O(new_n104_));
  ...
  nand2  g59(.a(new_n109_), .b(new_n79_), .O(new_n110_));
  nand2  g60(.a(new_n104_), .b(x26), .O(new_n111_));
  nor3   g61(.a(x26), .b(x25), .c(x24), .O(new_n112_));
  nand4  g62(.a(new_n112_), .b(new_n102_), .c(new_n84_), .d(new_n74_), .O(new_n113_));
  ...
  inv1   g66(.a(x19), .O(new_n117_));
  nor2   g67(.a(new_n117_), .b(x17), .O(new_n118_));
  nand4  g68(.a(new_n118_), .b(new_n112_), .c(new_n102_), .d(new_n84_), .O(new_n119_));
  nand2  g69(.a(x27), .b(x17), .O(new_n120_));
  aoi21  g70(.a(new_n120_), .b(new_n119_), .c(new_n79_), .O(z17));
  zero   g71(.O(z00));
  zero   g72(.O(z09));
  zero   g73(.O(z13));
  zero   g74(.O(z14));
