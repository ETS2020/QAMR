...
module FAU ( 
  ...
  inv1   g54(.a(x13), .O(new_n102_));
  nand2  g55(.a(x18), .b(x05), .O(new_n103_));
  oai21  g56(.a(x18), .b(new_n102_), .c(new_n103_), .O(new_n104_));
  nand2  g57(.a(new_n104_), .b(new_n86_), .O(new_n105_));
  nor3   g58(.a(x23), .b(x22), .c(x21), .O(new_n106_));
  aoi21  g59(.a(new_n106_), .b(new_n83_), .c(new_n63_), .O(new_n107_));
  ...
  nand2  g64(.a(new_n111_), .b(new_n105_), .O(z14));
