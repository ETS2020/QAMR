...
module FAU ( 
  ...
  nor2   g76(.a(x21), .b(x20), .O(new_n126_));
  nor2   g77(.a(x23), .b(x22), .O(new_n127_));
  nor3   g78(.a(x26), .b(x25), .c(x24), .O(new_n128_));
  nor2   g79(.a(new_n48_), .b(x17), .O(new_n129_));
  nand4  g80(.a(new_n129_), .b(new_n128_), .c(new_n127_), .d(new_n126_), .O(new_n130_));
  nand2  g81(.a(x27), .b(x17), .O(new_n131_));
  aoi21  g82(.a(new_n131_), .b(new_n130_), .c(new_n89_), .O(z17));
  zero   g83(.O(z08));
  zero   g84(.O(z11));
  zero   g85(.O(z16));
endmodule
