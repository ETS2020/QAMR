...
module FAU ( 
  ...
  nand3  g46(.a(new_n89_), .b(new_n72_), .c(new_n49_), .O(new_n96_));
  nor3   g47(.a(x23), .b(x22), .c(x21), .O(new_n97_));
  aoi22  g48(.a(new_n97_), .b(new_n74_), .c(new_n96_), .d(x23), .O(new_n98_));
  oai21  g49(.a(new_n98_), .b(new_n77_), .c(new_n95_), .O(z13));
  inv1   g50(.a(x13), .O(new_n100_));
  nand2  g51(.a(x18), .b(x05), .O(new_n101_));
  oai21  g52(.a(x18), .b(new_n100_), .c(new_n101_), .O(new_n102_));
  nand2  g53(.a(new_n102_), .b(new_n77_), .O(new_n103_));
  aoi21  g54(.a(new_n97_), .b(new_n74_), .c(new_n59_), .O(new_n104_));
  nor2   g55(.a(x24), .b(x23), .O(new_n105_));
  nand4  g56(.a(new_n105_), .b(new_n89_), .c(new_n72_), .d(new_n49_), .O(new_n106_));
  ...
  oai21  g61(.a(x18), .b(new_n62_), .c(new_n110_), .O(new_n111_));
  nand2  g62(.a(new_n111_), .b(new_n77_), .O(new_n112_));
  nand2  g63(.a(new_n106_), .b(x25), .O(new_n113_));
  nor2   g64(.a(x23), .b(x22), .O(new_n114_));
  nor2   g65(.a(x25), .b(x24), .O(new_n115_));
  nand4  g66(.a(new_n115_), .b(new_n114_), .c(new_n82_), .d(new_n72_), .O(new_n116_));
  ...
  nand2  g70(.a(x18), .b(x07), .O(new_n120_));
  oai21  g71(.a(x18), .b(new_n65_), .c(new_n120_), .O(new_n121_));
  nand2  g72(.a(new_n121_), .b(new_n77_), .O(new_n122_));
  nand2  g73(.a(new_n116_), .b(x26), .O(new_n123_));
  nor3   g74(.a(x26), .b(x25), .c(x24), .O(new_n124_));
  nand4  g75(.a(new_n124_), .b(new_n114_), .c(new_n82_), .d(new_n72_), .O(new_n125_));
  nand2  g76(.a(new_n125_), .b(new_n123_), .O(new_n126_));
  nand2  g77(.a(new_n126_), .b(x16), .O(new_n127_));
  nand2  g78(.a(new_n127_), .b(new_n122_), .O(z16));
  inv1   g79(.a(x19), .O(new_n129_));
  nor2   g80(.a(new_n129_), .b(x17), .O(new_n130_));
  nand4  g81(.a(new_n130_), .b(new_n124_), .c(new_n114_), .d(new_n82_), .O(new_n131_));
  nand2  g82(.a(x27), .b(x17), .O(new_n132_));
  aoi21  g83(.a(new_n132_), .b(new_n131_), .c(new_n77_), .O(z17));
  zero   g84(.O(z00));
  zero   g85(.O(z04));
  zero   g86(.O(z09));
  buf    g87(.a(x27), .O(z08));
