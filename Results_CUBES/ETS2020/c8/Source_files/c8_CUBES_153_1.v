...
module FAU ( 
  ...
  aoi21  g51(.a(new_n101_), .b(new_n92_), .c(new_n61_), .O(new_n102_));
  nor2   g52(.a(x24), .b(x23), .O(new_n103_));
  nand4  g53(.a(new_n103_), .b(new_n93_), .c(new_n71_), .d(new_n49_), .O(new_n104_));
  ...
  nand2  g60(.a(new_n110_), .b(new_n78_), .O(new_n111_));
  inv1   g61(.a(x25), .O(new_n112_));
  nand4  g62(.a(new_n112_), .b(new_n61_), .c(new_n58_), .d(new_n55_), .O(new_n113_));
  inv1   g63(.a(new_n113_), .O(new_n114_));
  aoi22  g64(.a(new_n114_), .b(new_n85_), .c(new_n104_), .d(x25), .O(new_n115_));
  oai21  g65(.a(new_n115_), .b(new_n78_), .c(new_n111_), .O(z15));
