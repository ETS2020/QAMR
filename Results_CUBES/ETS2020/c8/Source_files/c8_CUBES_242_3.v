...
module FAU ( 
  ...
  oai21  g69(.a(x18), .b(new_n66_), .c(new_n116_), .O(new_n117_));
  nand2  g70(.a(new_n117_), .b(new_n84_), .O(new_n118_));
  nand2  g71(.a(new_n112_), .b(x25), .O(new_n119_));
  nor2   g72(.a(x23), .b(x22), .O(new_n120_));
  nor2   g73(.a(x25), .b(x24), .O(new_n121_));
  nand4  g74(.a(new_n121_), .b(new_n120_), .c(new_n89_), .d(new_n71_), .O(new_n122_));
  nand2  g75(.a(new_n122_), .b(new_n119_), .O(new_n123_));
  nand2  g76(.a(new_n123_), .b(x16), .O(new_n124_));
  nand2  g77(.a(new_n124_), .b(new_n118_), .O(z15));
  inv1   g78(.a(x15), .O(new_n126_));
  nand2  g79(.a(x18), .b(x07), .O(new_n127_));
  oai21  g80(.a(x18), .b(new_n126_), .c(new_n127_), .O(new_n128_));
  nand2  g81(.a(new_n128_), .b(new_n84_), .O(new_n129_));
  nand2  g82(.a(new_n122_), .b(x26), .O(new_n130_));
  nor3   g83(.a(x26), .b(x25), .c(x24), .O(new_n131_));
  nand4  g84(.a(new_n131_), .b(new_n120_), .c(new_n89_), .d(new_n71_), .O(new_n132_));
  ...
  nand4  g89(.a(new_n136_), .b(new_n131_), .c(new_n120_), .d(new_n89_), .O(new_n137_));
