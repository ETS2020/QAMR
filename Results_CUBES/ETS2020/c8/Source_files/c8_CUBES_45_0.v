...
module FAU ( 
  ...
  nand2  g36(.a(new_n86_), .b(new_n67_), .O(new_n87_));
  nor2   g37(.a(x22), .b(x21), .O(new_n88_));
  aoi22  g38(.a(new_n88_), .b(new_n77_), .c(new_n87_), .d(x22), .O(new_n89_));
  oai21  g39(.a(new_n89_), .b(new_n81_), .c(new_n85_), .O(z12));
  inv1   g40(.a(x12), .O(new_n91_));
  nand2  g41(.a(x18), .b(x04), .O(new_n92_));
  oai21  g42(.a(x18), .b(new_n91_), .c(new_n92_), .O(new_n93_));
  nand2  g43(.a(new_n93_), .b(new_n81_), .O(new_n94_));
  nand3  g44(.a(new_n88_), .b(new_n67_), .c(new_n51_), .O(new_n95_));
  nor3   g45(.a(x23), .b(x22), .c(x21), .O(new_n96_));
  aoi22  g46(.a(new_n96_), .b(new_n77_), .c(new_n95_), .d(x23), .O(new_n97_));
  oai21  g47(.a(new_n97_), .b(new_n81_), .c(new_n94_), .O(z13));
  ...
  aoi21  g52(.a(new_n96_), .b(new_n77_), .c(new_n59_), .O(new_n103_));
  nor2   g53(.a(x24), .b(x23), .O(new_n104_));
  nand4  g54(.a(new_n104_), .b(new_n88_), .c(new_n67_), .d(new_n51_), .O(new_n105_));
  ...
  nand2  g62(.a(new_n105_), .b(x25), .O(new_n113_));
  nor2   g63(.a(x23), .b(x22), .O(new_n114_));
  nor2   g64(.a(x25), .b(x24), .O(new_n115_));
  nand4  g65(.a(new_n115_), .b(new_n114_), .c(new_n86_), .d(new_n67_), .O(new_n116_));
  ...
  nand4  g74(.a(new_n124_), .b(new_n114_), .c(new_n86_), .d(new_n67_), .O(new_n125_));
  ...
  nand4  g79(.a(new_n129_), .b(new_n124_), .c(new_n114_), .d(new_n86_), .O(new_n130_));
