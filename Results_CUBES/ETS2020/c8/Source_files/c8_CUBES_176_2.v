...
module FAU ( 
  ...
  oai21  g36(.a(x18), .b(new_n56_), .c(new_n86_), .O(new_n87_));
  ...
  aoi21  g48(.a(new_n92_), .b(new_n89_), .c(new_n59_), .O(new_n99_));
  ...
  nand2  g64(.a(x18), .b(x07), .O(new_n115_));
  oai21  g65(.a(x18), .b(new_n65_), .c(new_n115_), .O(new_n116_));
  nand2  g66(.a(new_n116_), .b(new_n76_), .O(new_n117_));
  nand2  g67(.a(new_n111_), .b(x26), .O(new_n118_));
  nor3   g68(.a(x26), .b(x25), .c(x24), .O(new_n119_));
  nand4  g69(.a(new_n119_), .b(new_n109_), .c(new_n82_), .d(new_n69_), .O(new_n120_));
  nand2  g70(.a(new_n120_), .b(new_n118_), .O(new_n121_));
  nand2  g71(.a(new_n121_), .b(x16), .O(new_n122_));
  nand2  g72(.a(new_n122_), .b(new_n117_), .O(z16));
  nor2   g73(.a(new_n48_), .b(x17), .O(new_n124_));
  nand4  g74(.a(new_n124_), .b(new_n119_), .c(new_n109_), .d(new_n82_), .O(new_n125_));
  nand2  g75(.a(x27), .b(x17), .O(new_n126_));
  aoi21  g76(.a(new_n126_), .b(new_n125_), .c(new_n76_), .O(z17));
  zero   g77(.O(z01));
  zero   g78(.O(z03));
  zero   g79(.O(z10));
  zero   g80(.O(z12));
