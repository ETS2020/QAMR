...
module FAU ( 
  ...
  nand2  g37(.a(new_n89_), .b(new_n76_), .O(new_n90_));
  nand3  g38(.a(new_n83_), .b(new_n68_), .c(new_n51_), .O(new_n91_));
  nor3   g39(.a(x23), .b(x22), .c(x21), .O(new_n92_));
  aoi22  g40(.a(new_n92_), .b(new_n84_), .c(new_n91_), .d(x23), .O(new_n93_));
  oai21  g41(.a(new_n93_), .b(new_n76_), .c(new_n90_), .O(z13));
  ...
  aoi21  g46(.a(new_n92_), .b(new_n84_), .c(new_n57_), .O(new_n99_));
  nand2  g47(.a(new_n68_), .b(new_n51_), .O(new_n100_));
  ...
  nand2  g55(.a(new_n108_), .b(new_n76_), .O(new_n109_));
  nor2   g56(.a(x23), .b(x22), .O(new_n110_));
  nor2   g57(.a(x25), .b(x24), .O(new_n111_));
  nand4  g58(.a(new_n111_), .b(new_n110_), .c(new_n81_), .d(new_n68_), .O(new_n112_));
  nand2  g59(.a(new_n112_), .b(x26), .O(new_n113_));
  nor3   g60(.a(x26), .b(x25), .c(x24), .O(new_n114_));
  nand4  g61(.a(new_n114_), .b(new_n110_), .c(new_n81_), .d(new_n68_), .O(new_n115_));
  ...
  aoi21  g68(.a(new_n121_), .b(new_n120_), .c(new_n76_), .O(z17));
  zero   g69(.O(z02));
  zero   g70(.O(z03));
  zero   g71(.O(z04));
  zero   g72(.O(z08));
