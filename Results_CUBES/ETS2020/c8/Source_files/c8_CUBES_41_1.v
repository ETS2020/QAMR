...
module FAU ( 
  ...
  wire new_n47_, new_n48_, new_n49_, new_n51_, new_n52_, new_n54_, new_n55_,
    new_n58_, new_n59_, new_n62_, new_n63_, new_n65_, new_n66_, new_n71_,
  ...
  aoi21  g37(.a(new_n89_), .b(new_n80_), .c(new_n88_), .O(new_n90_));
  nor2   g38(.a(x24), .b(x23), .O(new_n91_));
  nand4  g39(.a(new_n91_), .b(new_n79_), .c(new_n76_), .d(new_n51_), .O(new_n92_));
  inv1   g40(.a(new_n92_), .O(new_n93_));
  oai21  g41(.a(new_n93_), .b(new_n90_), .c(x16), .O(new_n94_));
  nand2  g42(.a(new_n94_), .b(new_n87_), .O(z14));
  ...
  nand4  g58(.a(new_n110_), .b(new_n100_), .c(new_n77_), .d(new_n76_), .O(new_n111_));
  ...
  nand4  g63(.a(new_n115_), .b(new_n110_), .c(new_n100_), .d(new_n77_), .O(new_n116_));
  nand2  g64(.a(x27), .b(x17), .O(new_n117_));
  aoi21  g65(.a(new_n117_), .b(new_n116_), .c(new_n71_), .O(z17));
  zero   g66(.O(z03));
  zero   g67(.O(z05));
  zero   g68(.O(z09));
  zero   g69(.O(z10));
