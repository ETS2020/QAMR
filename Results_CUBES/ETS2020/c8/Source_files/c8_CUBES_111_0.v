...
module FAU ( 
  ...
  aoi21  g46(.a(new_n93_), .b(new_n84_), .c(new_n57_), .O(new_n100_));
  nor2   g47(.a(x24), .b(x23), .O(new_n101_));
  nand4  g48(.a(new_n101_), .b(new_n85_), .c(new_n72_), .d(new_n51_), .O(new_n102_));
  inv1   g49(.a(new_n102_), .O(new_n103_));
  oai21  g50(.a(new_n103_), .b(new_n100_), .c(x16), .O(new_n104_));
  nand2  g51(.a(new_n104_), .b(new_n99_), .O(z14));
  inv1   g52(.a(x14), .O(new_n106_));
  nand2  g53(.a(x18), .b(x06), .O(new_n107_));
  oai21  g54(.a(x18), .b(new_n106_), .c(new_n107_), .O(new_n108_));
  nand2  g55(.a(new_n108_), .b(new_n67_), .O(new_n109_));
  inv1   g56(.a(x22), .O(new_n110_));
  inv1   g57(.a(x23), .O(new_n111_));
  inv1   g58(.a(x25), .O(new_n112_));
  nand4  g59(.a(new_n112_), .b(new_n57_), .c(new_n111_), .d(new_n110_), .O(new_n113_));
  inv1   g60(.a(new_n113_), .O(new_n114_));
  aoi22  g61(.a(new_n114_), .b(new_n77_), .c(new_n102_), .d(x25), .O(new_n115_));
  oai21  g62(.a(new_n115_), .b(new_n67_), .c(new_n109_), .O(z15));
