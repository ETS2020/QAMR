...
module FAU ( 
  ...
  aoi21  g51(.a(new_n94_), .b(new_n77_), .c(new_n101_), .O(new_n102_));
  nor2   g52(.a(x24), .b(x23), .O(new_n103_));
  nand4  g53(.a(new_n103_), .b(new_n92_), .c(new_n67_), .d(new_n51_), .O(new_n104_));
  ...
  nand2  g60(.a(new_n110_), .b(new_n80_), .O(new_n111_));
  nand2  g61(.a(new_n104_), .b(x25), .O(new_n112_));
  nor2   g62(.a(x23), .b(x22), .O(new_n113_));
  nor2   g63(.a(x25), .b(x24), .O(new_n114_));
  nand4  g64(.a(new_n114_), .b(new_n113_), .c(new_n85_), .d(new_n67_), .O(new_n115_));
  ...
  nand2  g71(.a(new_n121_), .b(new_n80_), .O(new_n122_));
  nand2  g72(.a(new_n115_), .b(x26), .O(new_n123_));
  nor3   g73(.a(x26), .b(x25), .c(x24), .O(new_n124_));
  nand4  g74(.a(new_n124_), .b(new_n113_), .c(new_n85_), .d(new_n67_), .O(new_n125_));
  ...
  nand4  g79(.a(new_n129_), .b(new_n124_), .c(new_n113_), .d(new_n85_), .O(new_n130_));
  nand2  g80(.a(x27), .b(x17), .O(new_n131_));
  aoi21  g81(.a(new_n131_), .b(new_n130_), .c(new_n80_), .O(z17));
  zero   g82(.O(z05));
  zero   g83(.O(z06));
  zero   g84(.O(z07));
  zero   g85(.O(z12));
