// Benchmark "FAU" written by ABC on Mon Jul  6 18:51:04 2020
...
module FAU ( 
  ...
  nand2  g32(.a(new_n85_), .b(new_n64_), .O(new_n86_));
  nand3  g33(.a(new_n80_), .b(new_n69_), .c(new_n49_), .O(new_n87_));
  nor3   g34(.a(x23), .b(x22), .c(x21), .O(new_n88_));
  aoi22  g35(.a(new_n88_), .b(new_n78_), .c(new_n87_), .d(x23), .O(new_n89_));
  oai21  g36(.a(new_n89_), .b(new_n64_), .c(new_n86_), .O(z13));
  inv1   g37(.a(x13), .O(new_n91_));
  nand2  g38(.a(x18), .b(x05), .O(new_n92_));
  oai21  g39(.a(x18), .b(new_n91_), .c(new_n92_), .O(new_n93_));
  nand2  g40(.a(new_n93_), .b(new_n64_), .O(new_n94_));
  inv1   g41(.a(x24), .O(new_n95_));
  aoi21  g42(.a(new_n88_), .b(new_n78_), .c(new_n95_), .O(new_n96_));
  nand3  g43(.a(new_n80_), .b(new_n95_), .c(new_n54_), .O(new_n97_));
  nor2   g44(.a(new_n97_), .b(new_n70_), .O(new_n98_));
  oai21  g45(.a(new_n98_), .b(new_n96_), .c(x16), .O(new_n99_));
  nand2  g46(.a(new_n99_), .b(new_n94_), .O(z14));
  nand2  g47(.a(x18), .b(x07), .O(new_n102_));
  oai21  g48(.a(x18), .b(new_n59_), .c(new_n102_), .O(new_n103_));
  nand2  g49(.a(new_n103_), .b(new_n64_), .O(new_n104_));
  nor2   g50(.a(x23), .b(x22), .O(new_n105_));
  nor2   g51(.a(x25), .b(x24), .O(new_n106_));
  nand4  g52(.a(new_n106_), .b(new_n105_), .c(new_n71_), .d(new_n69_), .O(new_n107_));
  nand2  g53(.a(new_n107_), .b(x26), .O(new_n108_));
  nor3   g54(.a(x26), .b(x25), .c(x24), .O(new_n109_));
  nand4  g55(.a(new_n109_), .b(new_n105_), .c(new_n71_), .d(new_n69_), .O(new_n110_));
  nand2  g56(.a(new_n110_), .b(new_n108_), .O(new_n111_));
  nand2  g57(.a(new_n111_), .b(x16), .O(new_n112_));
  nand2  g58(.a(new_n112_), .b(new_n104_), .O(z16));
  zero   g59(.O(z00));
  zero   g60(.O(z02));
  zero   g61(.O(z03));
  zero   g62(.O(z05));
