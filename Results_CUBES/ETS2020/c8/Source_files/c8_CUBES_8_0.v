...
module FAU ( 
  ...
  nand2  g27(.a(new_n80_), .b(new_n69_), .O(new_n81_));
  nor2   g28(.a(x22), .b(x21), .O(new_n82_));
  aoi22  g29(.a(new_n82_), .b(new_n71_), .c(new_n81_), .d(x22), .O(new_n83_));
  oai21  g30(.a(new_n83_), .b(new_n75_), .c(new_n79_), .O(z12));
  ...
  nand3  g35(.a(new_n82_), .b(new_n69_), .c(new_n51_), .O(new_n89_));
  nor3   g36(.a(x23), .b(x22), .c(x21), .O(new_n90_));
  aoi22  g37(.a(new_n90_), .b(new_n71_), .c(new_n89_), .d(x23), .O(new_n91_));
  oai21  g38(.a(new_n91_), .b(new_n75_), .c(new_n88_), .O(z13));
  ...
  aoi21  g44(.a(new_n90_), .b(new_n71_), .c(new_n97_), .O(new_n98_));
  nand2  g45(.a(new_n69_), .b(new_n51_), .O(new_n99_));
  nand3  g46(.a(new_n82_), .b(new_n97_), .c(new_n56_), .O(new_n100_));
  nor2   g47(.a(new_n100_), .b(new_n99_), .O(new_n101_));
  ...
  nand4  g55(.a(new_n109_), .b(new_n108_), .c(new_n80_), .d(new_n69_), .O(new_n110_));
  nand2  g56(.a(new_n110_), .b(x26), .O(new_n111_));
  nor3   g57(.a(x26), .b(x25), .c(x24), .O(new_n112_));
  nand4  g58(.a(new_n112_), .b(new_n108_), .c(new_n80_), .d(new_n69_), .O(new_n113_));
