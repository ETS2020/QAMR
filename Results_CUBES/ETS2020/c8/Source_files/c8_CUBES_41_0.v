...
module FAU ( 
  ...
  nor2   g15(.a(x18), .b(new_n47_), .O(new_n67_));
  aoi21  g16(.a(x18), .b(x00), .c(new_n67_), .O(new_n68_));
  oai21  g17(.a(new_n68_), .b(x16), .c(new_n66_), .O(z09));
  ...
  nand2  g45(.a(new_n96_), .b(new_n78_), .O(new_n97_));
  nand3  g46(.a(new_n91_), .b(new_n65_), .c(new_n73_), .O(new_n98_));
  nor3   g47(.a(x23), .b(x22), .c(x21), .O(new_n99_));
  aoi22  g48(.a(new_n99_), .b(new_n75_), .c(new_n98_), .d(x23), .O(new_n100_));
  oai21  g49(.a(new_n100_), .b(new_n78_), .c(new_n97_), .O(z13));
  nand2  g50(.a(x18), .b(x05), .O(new_n102_));
  oai21  g51(.a(x18), .b(new_n56_), .c(new_n102_), .O(new_n103_));
  nand2  g52(.a(new_n103_), .b(new_n78_), .O(new_n104_));
  inv1   g53(.a(x24), .O(new_n105_));
  aoi21  g54(.a(new_n99_), .b(new_n75_), .c(new_n105_), .O(new_n106_));
  nor2   g55(.a(x24), .b(x23), .O(new_n107_));
  nand2  g56(.a(new_n107_), .b(new_n91_), .O(new_n108_));
  nor2   g57(.a(new_n108_), .b(new_n83_), .O(new_n109_));
  oai21  g58(.a(new_n109_), .b(new_n106_), .c(x16), .O(new_n110_));
  nand2  g59(.a(new_n110_), .b(new_n104_), .O(z14));
  nand2  g60(.a(x18), .b(x07), .O(new_n113_));
  oai21  g61(.a(x18), .b(new_n60_), .c(new_n113_), .O(new_n114_));
  nand2  g62(.a(new_n114_), .b(new_n78_), .O(new_n115_));
  nor2   g63(.a(x23), .b(x22), .O(new_n116_));
  nor2   g64(.a(x25), .b(x24), .O(new_n117_));
  nand4  g65(.a(new_n117_), .b(new_n116_), .c(new_n84_), .d(new_n65_), .O(new_n118_));
  nand2  g66(.a(new_n118_), .b(x26), .O(new_n119_));
  nor3   g67(.a(x26), .b(x25), .c(x24), .O(new_n120_));
  nand4  g68(.a(new_n120_), .b(new_n116_), .c(new_n84_), .d(new_n65_), .O(new_n121_));
  nand2  g69(.a(new_n121_), .b(new_n119_), .O(new_n122_));
  nand2  g70(.a(new_n122_), .b(x16), .O(new_n123_));
  nand2  g71(.a(new_n123_), .b(new_n115_), .O(z16));
  zero   g72(.O(z01));
  zero   g73(.O(z02));
  zero   g74(.O(z04));
  zero   g75(.O(z06));
