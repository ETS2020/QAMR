...
module FAU ( 
  ...
  nand2  g59(.a(x18), .b(x06), .O(new_n108_));
  oai21  g60(.a(x18), .b(new_n64_), .c(new_n108_), .O(new_n109_));
  nand2  g61(.a(new_n109_), .b(new_n85_), .O(new_n110_));
  nor2   g62(.a(x24), .b(x23), .O(new_n111_));
  nand4  g63(.a(new_n111_), .b(new_n97_), .c(new_n71_), .d(new_n80_), .O(new_n112_));
  nand2  g64(.a(new_n112_), .b(x25), .O(new_n113_));
  nor2   g65(.a(x23), .b(x22), .O(new_n114_));
  nor2   g66(.a(x25), .b(x24), .O(new_n115_));
  nand4  g67(.a(new_n115_), .b(new_n114_), .c(new_n90_), .d(new_n71_), .O(new_n116_));
  nand2  g68(.a(new_n116_), .b(new_n113_), .O(new_n117_));
  nand2  g69(.a(new_n117_), .b(x16), .O(new_n118_));
  nand2  g70(.a(new_n118_), .b(new_n110_), .O(z15));
  nand2  g71(.a(x18), .b(x07), .O(new_n120_));
  oai21  g72(.a(x18), .b(new_n67_), .c(new_n120_), .O(new_n121_));
  nand2  g73(.a(new_n121_), .b(new_n85_), .O(new_n122_));
  nand2  g74(.a(new_n116_), .b(x26), .O(new_n123_));
  nor3   g75(.a(x26), .b(x25), .c(x24), .O(new_n124_));
  nand4  g76(.a(new_n124_), .b(new_n114_), .c(new_n90_), .d(new_n71_), .O(new_n125_));
  nand2  g77(.a(new_n125_), .b(new_n123_), .O(new_n126_));
  nand2  g78(.a(new_n126_), .b(x16), .O(new_n127_));
  nand2  g79(.a(new_n127_), .b(new_n122_), .O(z16));
  nor2   g80(.a(new_n48_), .b(x17), .O(new_n129_));
  nand4  g81(.a(new_n129_), .b(new_n124_), .c(new_n114_), .d(new_n90_), .O(new_n130_));
  nand2  g82(.a(x27), .b(x17), .O(new_n131_));
  aoi21  g83(.a(new_n131_), .b(new_n130_), .c(new_n85_), .O(z17));
  zero   g84(.O(z01));
  zero   g85(.O(z14));
  buf    g86(.a(x27), .O(z08));
endmodule
