// Benchmark "FAU" written by ABC on Mon Jul  6 18:50:52 2020
...
module FAU ( 
  ...
  inv1   g51(.a(x12), .O(new_n100_));
  nand2  g52(.a(x18), .b(x04), .O(new_n101_));
  oai21  g53(.a(x18), .b(new_n100_), .c(new_n101_), .O(new_n102_));
  nand2  g54(.a(new_n102_), .b(new_n83_), .O(new_n103_));
  nand3  g55(.a(new_n97_), .b(new_n70_), .c(new_n51_), .O(new_n104_));
  nor3   g56(.a(x23), .b(x22), .c(x21), .O(new_n105_));
  aoi22  g57(.a(new_n105_), .b(new_n80_), .c(new_n104_), .d(x23), .O(new_n106_));
  oai21  g58(.a(new_n106_), .b(new_n83_), .c(new_n103_), .O(z13));
  inv1   g59(.a(x13), .O(new_n108_));
  nand2  g60(.a(x18), .b(x05), .O(new_n109_));
  oai21  g61(.a(x18), .b(new_n108_), .c(new_n109_), .O(new_n110_));
  nand2  g62(.a(new_n110_), .b(new_n83_), .O(new_n111_));
  inv1   g63(.a(x24), .O(new_n112_));
  aoi21  g64(.a(new_n105_), .b(new_n80_), .c(new_n112_), .O(new_n113_));
  nor2   g65(.a(x24), .b(x23), .O(new_n114_));
  nand4  g66(.a(new_n114_), .b(new_n97_), .c(new_n70_), .d(new_n51_), .O(new_n115_));
  inv1   g67(.a(new_n115_), .O(new_n116_));
  oai21  g68(.a(new_n116_), .b(new_n113_), .c(x16), .O(new_n117_));
  nand2  g69(.a(new_n117_), .b(new_n111_), .O(z14));
  inv1   g70(.a(x14), .O(new_n119_));
  nand2  g71(.a(x18), .b(x06), .O(new_n120_));
  oai21  g72(.a(x18), .b(new_n119_), .c(new_n120_), .O(new_n121_));
  nand2  g73(.a(new_n121_), .b(new_n83_), .O(new_n122_));
  inv1   g74(.a(x22), .O(new_n123_));
  nand4  g75(.a(new_n62_), .b(new_n112_), .c(new_n58_), .d(new_n123_), .O(new_n124_));
  inv1   g76(.a(new_n124_), .O(new_n125_));
  aoi22  g77(.a(new_n125_), .b(new_n90_), .c(new_n115_), .d(x25), .O(new_n126_));
  oai21  g78(.a(new_n126_), .b(new_n83_), .c(new_n122_), .O(z15));
  ...
  aoi21  g85(.a(new_n134_), .b(new_n133_), .c(new_n83_), .O(z17));
  zero   g86(.O(z03));
  zero   g87(.O(z05));
  zero   g88(.O(z16));
  buf    g89(.a(x27), .O(z08));
