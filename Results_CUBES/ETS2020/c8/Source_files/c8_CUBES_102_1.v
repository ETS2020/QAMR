...
module FAU ( 
  ...
  nand4  g59(.a(new_n108_), .b(new_n99_), .c(new_n72_), .d(new_n51_), .O(new_n109_));
  inv1   g60(.a(x23), .O(new_n110_));
  nand4  g61(.a(new_n64_), .b(new_n61_), .c(new_n110_), .d(new_n57_), .O(new_n111_));
  inv1   g62(.a(new_n111_), .O(new_n112_));
  aoi22  g63(.a(new_n112_), .b(new_n92_), .c(new_n109_), .d(x25), .O(new_n113_));
  oai21  g64(.a(new_n113_), .b(new_n85_), .c(new_n107_), .O(z15));
