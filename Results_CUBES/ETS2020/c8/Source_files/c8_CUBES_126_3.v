...
module FAU ( 
  ...
  aoi21  g59(.a(new_n101_), .b(new_n79_), .c(new_n63_), .O(new_n108_));
  nor2   g60(.a(x24), .b(x23), .O(new_n109_));
  nand4  g61(.a(new_n109_), .b(new_n94_), .c(new_n69_), .d(new_n51_), .O(new_n110_));
  ...
  nand4  g82(.a(new_n130_), .b(new_n119_), .c(new_n87_), .d(new_n69_), .O(new_n131_));
  ...
  nand4  g87(.a(new_n135_), .b(new_n130_), .c(new_n119_), .d(new_n87_), .O(new_n136_));
