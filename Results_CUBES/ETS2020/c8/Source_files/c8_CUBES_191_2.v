...
module FAU ( 
  ...
  nand2  g35(.a(new_n84_), .b(new_n74_), .O(new_n85_));
  nor2   g36(.a(x22), .b(x21), .O(new_n86_));
  aoi22  g37(.a(new_n86_), .b(new_n76_), .c(new_n85_), .d(x22), .O(new_n87_));
  oai21  g38(.a(new_n87_), .b(new_n80_), .c(new_n83_), .O(z12));
  inv1   g39(.a(x12), .O(new_n89_));
  nand2  g40(.a(x18), .b(x04), .O(new_n90_));
  oai21  g41(.a(x18), .b(new_n89_), .c(new_n90_), .O(new_n91_));
  nand2  g42(.a(new_n91_), .b(new_n80_), .O(new_n92_));
  nand3  g43(.a(new_n86_), .b(new_n74_), .c(new_n51_), .O(new_n93_));
  nor3   g44(.a(x23), .b(x22), .c(x21), .O(new_n94_));
  aoi22  g45(.a(new_n94_), .b(new_n76_), .c(new_n93_), .d(x23), .O(new_n95_));
  oai21  g46(.a(new_n95_), .b(new_n80_), .c(new_n92_), .O(z13));
  nand2  g47(.a(x18), .b(x06), .O(new_n98_));
  oai21  g48(.a(x18), .b(new_n64_), .c(new_n98_), .O(new_n99_));
  nand2  g49(.a(new_n99_), .b(new_n80_), .O(new_n100_));
  nor2   g50(.a(x24), .b(x23), .O(new_n101_));
  nand4  g51(.a(new_n101_), .b(new_n86_), .c(new_n74_), .d(new_n51_), .O(new_n102_));
  nand2  g52(.a(new_n102_), .b(x25), .O(new_n103_));
  nor2   g53(.a(x23), .b(x22), .O(new_n104_));
  nor2   g54(.a(x25), .b(x24), .O(new_n105_));
  nand4  g55(.a(new_n105_), .b(new_n104_), .c(new_n84_), .d(new_n74_), .O(new_n106_));
  nand2  g56(.a(new_n106_), .b(new_n103_), .O(new_n107_));
  nand2  g57(.a(new_n107_), .b(x16), .O(new_n108_));
  nand2  g58(.a(new_n108_), .b(new_n100_), .O(z15));
  nand2  g59(.a(x18), .b(x07), .O(new_n110_));
  oai21  g60(.a(x18), .b(new_n67_), .c(new_n110_), .O(new_n111_));
  nand2  g61(.a(new_n111_), .b(new_n80_), .O(new_n112_));
  nand2  g62(.a(new_n106_), .b(x26), .O(new_n113_));
  nor3   g63(.a(x26), .b(x25), .c(x24), .O(new_n114_));
  nand4  g64(.a(new_n114_), .b(new_n104_), .c(new_n84_), .d(new_n74_), .O(new_n115_));
  ...
  nand4  g69(.a(new_n119_), .b(new_n114_), .c(new_n104_), .d(new_n84_), .O(new_n120_));
  nand2  g70(.a(x27), .b(x17), .O(new_n121_));
  aoi21  g71(.a(new_n121_), .b(new_n120_), .c(new_n80_), .O(z17));
  zero   g72(.O(z04));
  zero   g73(.O(z09));
  zero   g74(.O(z11));
  zero   g75(.O(z14));
