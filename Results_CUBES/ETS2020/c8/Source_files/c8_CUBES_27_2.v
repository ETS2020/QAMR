...
module FAU ( 
  ...
  oai21  g33(.a(x18), .b(new_n52_), .c(new_n82_), .O(new_n83_));
  ...
  nand2  g42(.a(new_n92_), .b(new_n81_), .O(new_n93_));
  nor2   g43(.a(x22), .b(x21), .O(new_n94_));
  nand3  g44(.a(new_n94_), .b(new_n67_), .c(new_n76_), .O(new_n95_));
  nor3   g45(.a(x23), .b(x22), .c(x21), .O(new_n96_));
  aoi22  g46(.a(new_n96_), .b(new_n78_), .c(new_n95_), .d(x23), .O(new_n97_));
  oai21  g47(.a(new_n97_), .b(new_n81_), .c(new_n93_), .O(z13));
  inv1   g48(.a(x13), .O(new_n99_));
  nand2  g49(.a(x18), .b(x05), .O(new_n100_));
  oai21  g50(.a(x18), .b(new_n99_), .c(new_n100_), .O(new_n101_));
  nand2  g51(.a(new_n101_), .b(new_n81_), .O(new_n102_));
  aoi21  g52(.a(new_n96_), .b(new_n78_), .c(new_n59_), .O(new_n103_));
  nor2   g53(.a(x24), .b(x23), .O(new_n104_));
  nand4  g54(.a(new_n104_), .b(new_n94_), .c(new_n67_), .d(new_n76_), .O(new_n105_));
  inv1   g55(.a(new_n105_), .O(new_n106_));
  oai21  g56(.a(new_n106_), .b(new_n103_), .c(x16), .O(new_n107_));
  nand2  g57(.a(new_n107_), .b(new_n102_), .O(z14));
  nand2  g58(.a(x18), .b(x06), .O(new_n109_));
  oai21  g59(.a(x18), .b(new_n62_), .c(new_n109_), .O(new_n110_));
  nand2  g60(.a(new_n110_), .b(new_n81_), .O(new_n111_));
  nand2  g61(.a(new_n105_), .b(x25), .O(new_n112_));
  nor2   g62(.a(x23), .b(x22), .O(new_n113_));
  nor2   g63(.a(x25), .b(x24), .O(new_n114_));
  nand4  g64(.a(new_n114_), .b(new_n113_), .c(new_n86_), .d(new_n67_), .O(new_n115_));
  nand2  g65(.a(new_n115_), .b(new_n112_), .O(new_n116_));
  nand2  g66(.a(new_n116_), .b(x16), .O(new_n117_));
  nand2  g67(.a(new_n117_), .b(new_n111_), .O(z15));
  inv1   g68(.a(x15), .O(new_n119_));
  nand2  g69(.a(x18), .b(x07), .O(new_n120_));
  oai21  g70(.a(x18), .b(new_n119_), .c(new_n120_), .O(new_n121_));
  nand2  g71(.a(new_n121_), .b(new_n81_), .O(new_n122_));
  nand2  g72(.a(new_n115_), .b(x26), .O(new_n123_));
  nor3   g73(.a(x26), .b(x25), .c(x24), .O(new_n124_));
  nand4  g74(.a(new_n124_), .b(new_n113_), .c(new_n86_), .d(new_n67_), .O(new_n125_));
  ...
  nand4  g79(.a(new_n129_), .b(new_n124_), .c(new_n113_), .d(new_n86_), .O(new_n130_));
