...
module FAU ( 
  ...
  nand3  g46(.a(new_n90_), .b(new_n70_), .c(new_n78_), .O(new_n97_));
  ...
  aoi21  g54(.a(new_n98_), .b(new_n80_), .c(new_n61_), .O(new_n105_));
  nand2  g55(.a(new_n70_), .b(new_n78_), .O(new_n106_));
  nand3  g56(.a(new_n90_), .b(new_n61_), .c(new_n58_), .O(new_n107_));
  nor2   g57(.a(new_n107_), .b(new_n106_), .O(new_n108_));
  ...
  nand4  g66(.a(new_n117_), .b(new_n116_), .c(new_n88_), .d(new_n70_), .O(new_n118_));
  nand2  g67(.a(new_n118_), .b(x26), .O(new_n119_));
  nor3   g68(.a(x26), .b(x25), .c(x24), .O(new_n120_));
  nand4  g69(.a(new_n120_), .b(new_n116_), .c(new_n88_), .d(new_n70_), .O(new_n121_));
