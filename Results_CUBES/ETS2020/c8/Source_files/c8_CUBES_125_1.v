...
module FAU ( 
  ...
  oai21  g42(.a(x18), .b(new_n58_), .c(new_n92_), .O(new_n93_));
  nand2  g43(.a(new_n93_), .b(new_n83_), .O(new_n94_));
  nor2   g44(.a(x22), .b(x21), .O(new_n95_));
  nand3  g45(.a(new_n95_), .b(new_n70_), .c(new_n51_), .O(new_n96_));
  nor3   g46(.a(x23), .b(x22), .c(x21), .O(new_n97_));
  aoi22  g47(.a(new_n97_), .b(new_n80_), .c(new_n96_), .d(x23), .O(new_n98_));
  oai21  g48(.a(new_n98_), .b(new_n83_), .c(new_n94_), .O(z13));
  ...
  aoi21  g54(.a(new_n97_), .b(new_n80_), .c(new_n104_), .O(new_n105_));
