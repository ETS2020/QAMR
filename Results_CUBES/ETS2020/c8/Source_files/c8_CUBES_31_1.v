...
module FAU ( 
  ...
  oai21  g37(.a(x18), .b(new_n58_), .c(new_n88_), .O(new_n89_));
  nand2  g38(.a(new_n89_), .b(new_n79_), .O(new_n90_));
  nand3  g39(.a(new_n85_), .b(new_n73_), .c(new_n49_), .O(new_n91_));
  nor3   g40(.a(x23), .b(x22), .c(x21), .O(new_n92_));
  aoi22  g41(.a(new_n92_), .b(new_n75_), .c(new_n91_), .d(x23), .O(new_n93_));
  oai21  g42(.a(new_n93_), .b(new_n79_), .c(new_n90_), .O(z13));
  nand2  g43(.a(x18), .b(x06), .O(new_n96_));
  oai21  g44(.a(x18), .b(new_n64_), .c(new_n96_), .O(new_n97_));
  nand2  g45(.a(new_n97_), .b(new_n79_), .O(new_n98_));
  nor2   g46(.a(x24), .b(x23), .O(new_n99_));
  nand4  g47(.a(new_n99_), .b(new_n85_), .c(new_n73_), .d(new_n49_), .O(new_n100_));
  nand2  g48(.a(new_n100_), .b(x25), .O(new_n101_));
  nor2   g49(.a(x23), .b(x22), .O(new_n102_));
  nor2   g50(.a(x25), .b(x24), .O(new_n103_));
  nand4  g51(.a(new_n103_), .b(new_n102_), .c(new_n83_), .d(new_n73_), .O(new_n104_));
  ...
  nand2  g58(.a(new_n110_), .b(new_n79_), .O(new_n111_));
  nand2  g59(.a(new_n104_), .b(x26), .O(new_n112_));
  nor3   g60(.a(x26), .b(x25), .c(x24), .O(new_n113_));
  nand4  g61(.a(new_n113_), .b(new_n102_), .c(new_n83_), .d(new_n73_), .O(new_n114_));
