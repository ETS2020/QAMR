...
module FAU ( 
  ...
  oai21  g44(.a(x18), .b(new_n62_), .c(new_n96_), .O(new_n97_));
  nand2  g45(.a(new_n97_), .b(new_n84_), .O(new_n98_));
  nor2   g46(.a(x24), .b(x23), .O(new_n99_));
  nand4  g47(.a(new_n99_), .b(new_n91_), .c(new_n70_), .d(new_n49_), .O(new_n100_));
  nand2  g48(.a(new_n100_), .b(x25), .O(new_n101_));
  nor2   g49(.a(x23), .b(x22), .O(new_n102_));
  nor2   g50(.a(x25), .b(x24), .O(new_n103_));
  nand4  g51(.a(new_n103_), .b(new_n102_), .c(new_n89_), .d(new_n70_), .O(new_n104_));
  ...
  nand2  g55(.a(x18), .b(x07), .O(new_n108_));
  oai21  g56(.a(x18), .b(new_n65_), .c(new_n108_), .O(new_n109_));
  nand2  g57(.a(new_n109_), .b(new_n84_), .O(new_n110_));
  nand2  g58(.a(new_n104_), .b(x26), .O(new_n111_));
  nor3   g59(.a(x26), .b(x25), .c(x24), .O(new_n112_));
  nand4  g60(.a(new_n112_), .b(new_n102_), .c(new_n89_), .d(new_n70_), .O(new_n113_));
  nand2  g61(.a(new_n113_), .b(new_n111_), .O(new_n114_));
  nand2  g62(.a(new_n114_), .b(x16), .O(new_n115_));
  nand2  g63(.a(new_n115_), .b(new_n110_), .O(z16));
  inv1   g64(.a(x19), .O(new_n117_));
  nor2   g65(.a(new_n117_), .b(x17), .O(new_n118_));
  nand4  g66(.a(new_n118_), .b(new_n112_), .c(new_n102_), .d(new_n89_), .O(new_n119_));
  nand2  g67(.a(x27), .b(x17), .O(new_n120_));
  aoi21  g68(.a(new_n120_), .b(new_n119_), .c(new_n84_), .O(z17));
  zero   g69(.O(z00));
  zero   g70(.O(z03));
  zero   g71(.O(z08));
  zero   g72(.O(z11));
