...
module FAU ( 
  ...
  nand2  g42(.a(new_n95_), .b(new_n85_), .O(new_n96_));
  nor2   g43(.a(new_n96_), .b(new_n76_), .O(new_n97_));
  oai21  g44(.a(new_n97_), .b(new_n94_), .c(x16), .O(new_n98_));
  nand2  g45(.a(new_n98_), .b(new_n92_), .O(z14));
  nand2  g46(.a(x18), .b(x07), .O(new_n101_));
  oai21  g47(.a(x18), .b(new_n59_), .c(new_n101_), .O(new_n102_));
  nand2  g48(.a(new_n102_), .b(new_n71_), .O(new_n103_));
  nor2   g49(.a(x23), .b(x22), .O(new_n104_));
  nor2   g50(.a(x25), .b(x24), .O(new_n105_));
  nand4  g51(.a(new_n105_), .b(new_n104_), .c(new_n77_), .d(new_n66_), .O(new_n106_));
  nand2  g52(.a(new_n106_), .b(x26), .O(new_n107_));
  nor3   g53(.a(x26), .b(x25), .c(x24), .O(new_n108_));
  nand4  g54(.a(new_n108_), .b(new_n104_), .c(new_n77_), .d(new_n66_), .O(new_n109_));
  ...
  inv1   g58(.a(x19), .O(new_n113_));
  nor2   g59(.a(new_n113_), .b(x17), .O(new_n114_));
  nand4  g60(.a(new_n114_), .b(new_n108_), .c(new_n104_), .d(new_n77_), .O(new_n115_));
  nand2  g61(.a(x27), .b(x17), .O(new_n116_));
  aoi21  g62(.a(new_n116_), .b(new_n115_), .c(new_n71_), .O(z17));
  zero   g63(.O(z00));
  zero   g64(.O(z02));
  zero   g65(.O(z03));
  zero   g66(.O(z04));
