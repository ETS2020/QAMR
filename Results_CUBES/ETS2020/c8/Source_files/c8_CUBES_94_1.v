// Benchmark "FAU" written by ABC on Mon Jul  6 18:50:20 2020
...
module FAU ( 
  ...
  nand2  g32(.a(new_n72_), .b(new_n51_), .O(new_n82_));
  nor2   g33(.a(x21), .b(x20), .O(new_n83_));
  aoi22  g34(.a(new_n83_), .b(new_n72_), .c(new_n82_), .d(x21), .O(new_n84_));
  oai21  g35(.a(new_n84_), .b(new_n77_), .c(new_n81_), .O(z11));
  nand2  g36(.a(x18), .b(x03), .O(new_n86_));
  oai21  g37(.a(x18), .b(new_n55_), .c(new_n86_), .O(new_n87_));
  nand2  g38(.a(new_n87_), .b(new_n77_), .O(new_n88_));
  nand2  g39(.a(new_n83_), .b(new_n72_), .O(new_n89_));
  nor2   g40(.a(x22), .b(x21), .O(new_n90_));
  aoi22  g41(.a(new_n90_), .b(new_n74_), .c(new_n89_), .d(x22), .O(new_n91_));
  oai21  g42(.a(new_n91_), .b(new_n77_), .c(new_n88_), .O(z12));
  nand2  g43(.a(x18), .b(x06), .O(new_n95_));
  oai21  g44(.a(x18), .b(new_n62_), .c(new_n95_), .O(new_n96_));
  nand2  g45(.a(new_n96_), .b(new_n77_), .O(new_n97_));
  nor2   g46(.a(x24), .b(x23), .O(new_n98_));
  nand4  g47(.a(new_n98_), .b(new_n90_), .c(new_n72_), .d(new_n51_), .O(new_n99_));
  nand2  g48(.a(new_n99_), .b(x25), .O(new_n100_));
  nor2   g49(.a(x23), .b(x22), .O(new_n101_));
  nor2   g50(.a(x25), .b(x24), .O(new_n102_));
  nand4  g51(.a(new_n102_), .b(new_n101_), .c(new_n83_), .d(new_n72_), .O(new_n103_));
  ...
  nand2  g55(.a(x18), .b(x07), .O(new_n107_));
  oai21  g56(.a(x18), .b(new_n65_), .c(new_n107_), .O(new_n108_));
  nand2  g57(.a(new_n108_), .b(new_n77_), .O(new_n109_));
  nand2  g58(.a(new_n103_), .b(x26), .O(new_n110_));
  nor3   g59(.a(x26), .b(x25), .c(x24), .O(new_n111_));
  nand4  g60(.a(new_n111_), .b(new_n101_), .c(new_n83_), .d(new_n72_), .O(new_n112_));
  nand2  g61(.a(new_n112_), .b(new_n110_), .O(new_n113_));
  nand2  g62(.a(new_n113_), .b(x16), .O(new_n114_));
  nand2  g63(.a(new_n114_), .b(new_n109_), .O(z16));
  nor2   g64(.a(new_n48_), .b(x17), .O(new_n116_));
  nand4  g65(.a(new_n116_), .b(new_n111_), .c(new_n101_), .d(new_n83_), .O(new_n117_));
  nand2  g66(.a(x27), .b(x17), .O(new_n118_));
  aoi21  g67(.a(new_n118_), .b(new_n117_), .c(new_n77_), .O(z17));
  zero   g68(.O(z02));
  zero   g69(.O(z05));
  zero   g70(.O(z09));
  zero   g71(.O(z13));
