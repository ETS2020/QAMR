...
module FAU ( 
  ...
  nand4  g23(.a(new_n75_), .b(new_n71_), .c(new_n48_), .d(new_n74_), .O(new_n76_));
  inv1   g24(.a(new_n76_), .O(new_n77_));
  aoi21  g25(.a(new_n73_), .b(x21), .c(new_n77_), .O(new_n78_));
  ...
  nand3  g39(.a(new_n85_), .b(new_n72_), .c(new_n71_), .O(new_n92_));
  ...
  aoi21  g48(.a(new_n93_), .b(new_n84_), .c(new_n100_), .O(new_n101_));
  nor2   g49(.a(x24), .b(x23), .O(new_n102_));
  nand4  g50(.a(new_n102_), .b(new_n85_), .c(new_n72_), .d(new_n71_), .O(new_n103_));
  inv1   g51(.a(new_n103_), .O(new_n104_));
  oai21  g52(.a(new_n104_), .b(new_n101_), .c(x16), .O(new_n105_));
  nand2  g53(.a(new_n105_), .b(new_n99_), .O(z14));
  inv1   g54(.a(x14), .O(new_n107_));
  nand2  g55(.a(x18), .b(x06), .O(new_n108_));
  oai21  g56(.a(x18), .b(new_n107_), .c(new_n108_), .O(new_n109_));
  nand2  g57(.a(new_n109_), .b(new_n66_), .O(new_n110_));
  inv1   g58(.a(x22), .O(new_n111_));
  nand4  g59(.a(new_n58_), .b(new_n100_), .c(new_n54_), .d(new_n111_), .O(new_n112_));
  inv1   g60(.a(new_n112_), .O(new_n113_));
  aoi22  g61(.a(new_n113_), .b(new_n77_), .c(new_n103_), .d(x25), .O(new_n114_));
  oai21  g62(.a(new_n114_), .b(new_n66_), .c(new_n110_), .O(z15));
  ...
  nand4  g69(.a(new_n121_), .b(new_n120_), .c(new_n119_), .d(new_n72_), .O(new_n122_));
  nand2  g70(.a(new_n122_), .b(x26), .O(new_n123_));
  nor3   g71(.a(x26), .b(x25), .c(x24), .O(new_n124_));
  nand4  g72(.a(new_n124_), .b(new_n120_), .c(new_n119_), .d(new_n72_), .O(new_n125_));
