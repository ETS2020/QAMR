...
module FAU ( 
  ...
  nor2   g27(.a(x19), .b(x17), .O(new_n77_));
  nand2  g28(.a(new_n77_), .b(new_n51_), .O(new_n78_));
  inv1   g29(.a(x17), .O(new_n79_));
  nand4  g30(.a(new_n54_), .b(new_n51_), .c(new_n48_), .d(new_n79_), .O(new_n80_));
  ...
  nor3   g38(.a(x20), .b(x19), .c(x17), .O(new_n88_));
  nor2   g39(.a(x22), .b(x21), .O(new_n89_));
  aoi22  g40(.a(new_n89_), .b(new_n88_), .c(new_n80_), .d(x22), .O(new_n90_));
  oai21  g41(.a(new_n90_), .b(new_n72_), .c(new_n87_), .O(z12));
  inv1   g42(.a(x12), .O(new_n92_));
  nand2  g43(.a(x18), .b(x04), .O(new_n93_));
  oai21  g44(.a(x18), .b(new_n92_), .c(new_n93_), .O(new_n94_));
  nand2  g45(.a(new_n94_), .b(new_n72_), .O(new_n95_));
  nand3  g46(.a(new_n89_), .b(new_n77_), .c(new_n51_), .O(new_n96_));
  nor3   g47(.a(x23), .b(x22), .c(x21), .O(new_n97_));
  aoi22  g48(.a(new_n97_), .b(new_n88_), .c(new_n96_), .d(x23), .O(new_n98_));
  oai21  g49(.a(new_n98_), .b(new_n72_), .c(new_n95_), .O(z13));
  inv1   g50(.a(x13), .O(new_n100_));
  nand2  g51(.a(x18), .b(x05), .O(new_n101_));
  oai21  g52(.a(x18), .b(new_n100_), .c(new_n101_), .O(new_n102_));
  nand2  g53(.a(new_n102_), .b(new_n72_), .O(new_n103_));
  aoi21  g54(.a(new_n97_), .b(new_n88_), .c(new_n63_), .O(new_n104_));
  nor2   g55(.a(x24), .b(x23), .O(new_n105_));
  nand4  g56(.a(new_n105_), .b(new_n89_), .c(new_n77_), .d(new_n51_), .O(new_n106_));
  ...
  nand2  g63(.a(new_n112_), .b(new_n72_), .O(new_n113_));
  nand4  g64(.a(new_n66_), .b(new_n63_), .c(new_n60_), .d(new_n57_), .O(new_n114_));
  inv1   g65(.a(new_n114_), .O(new_n115_));
  aoi22  g66(.a(new_n115_), .b(new_n81_), .c(new_n106_), .d(x25), .O(new_n116_));
  oai21  g67(.a(new_n116_), .b(new_n72_), .c(new_n113_), .O(z15));
  ...
  aoi21  g74(.a(new_n124_), .b(new_n123_), .c(new_n72_), .O(z17));
  zero   g75(.O(z07));
  zero   g76(.O(z09));
  zero   g77(.O(z10));
  zero   g78(.O(z16));
