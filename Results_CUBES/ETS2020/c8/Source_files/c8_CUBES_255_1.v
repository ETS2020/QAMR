...
module FAU ( 
  ...
  aoi21  g66(.a(new_n107_), .b(new_n82_), .c(new_n61_), .O(new_n114_));
  ...
  inv1   g76(.a(x23), .O(new_n124_));
  nand4  g77(.a(new_n64_), .b(new_n61_), .c(new_n124_), .d(new_n57_), .O(new_n125_));
  inv1   g78(.a(new_n125_), .O(new_n126_));
  aoi22  g79(.a(new_n126_), .b(new_n92_), .c(new_n116_), .d(x25), .O(new_n127_));
  oai21  g80(.a(new_n127_), .b(new_n85_), .c(new_n123_), .O(z15));
  zero   g81(.O(z04));
  zero   g82(.O(z16));
  zero   g83(.O(z17));
  buf    g84(.a(x27), .O(z08));
