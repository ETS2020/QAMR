...
module FAU ( 
  ...
  nor2   g19(.a(x18), .b(new_n47_), .O(new_n69_));
  aoi21  g20(.a(x18), .b(x00), .c(new_n69_), .O(new_n70_));
  oai21  g21(.a(new_n70_), .b(x16), .c(new_n68_), .O(z09));
  inv1   g22(.a(x09), .O(new_n72_));
  nor2   g23(.a(x18), .b(new_n72_), .O(new_n73_));
  aoi21  g24(.a(x18), .b(x01), .c(new_n73_), .O(new_n74_));
  nor2   g25(.a(new_n67_), .b(new_n51_), .O(new_n75_));
  nor3   g26(.a(x20), .b(x19), .c(x17), .O(new_n76_));
  oai21  g27(.a(new_n76_), .b(new_n75_), .c(x16), .O(new_n77_));
  oai21  g28(.a(new_n74_), .b(x16), .c(new_n77_), .O(z10));
  inv1   g29(.a(x16), .O(new_n80_));
  inv1   g30(.a(x11), .O(new_n81_));
  ...
  nand2  g35(.a(new_n85_), .b(new_n67_), .O(new_n86_));
  nor2   g36(.a(x22), .b(x21), .O(new_n87_));
  aoi22  g37(.a(new_n87_), .b(new_n76_), .c(new_n86_), .d(x22), .O(new_n88_));
  oai21  g38(.a(new_n88_), .b(new_n80_), .c(new_n84_), .O(z12));
  inv1   g39(.a(x12), .O(new_n90_));
  nand2  g40(.a(x18), .b(x04), .O(new_n91_));
  oai21  g41(.a(x18), .b(new_n90_), .c(new_n91_), .O(new_n92_));
  nand2  g42(.a(new_n92_), .b(new_n80_), .O(new_n93_));
  nand3  g43(.a(new_n87_), .b(new_n67_), .c(new_n51_), .O(new_n94_));
  nor3   g44(.a(x23), .b(x22), .c(x21), .O(new_n95_));
  aoi22  g45(.a(new_n95_), .b(new_n76_), .c(new_n94_), .d(x23), .O(new_n96_));
  oai21  g46(.a(new_n96_), .b(new_n80_), .c(new_n93_), .O(z13));
  inv1   g47(.a(x13), .O(new_n98_));
  nand2  g48(.a(x18), .b(x05), .O(new_n99_));
  oai21  g49(.a(x18), .b(new_n98_), .c(new_n99_), .O(new_n100_));
  nand2  g50(.a(new_n100_), .b(new_n80_), .O(new_n101_));
  aoi21  g51(.a(new_n95_), .b(new_n76_), .c(new_n57_), .O(new_n102_));
  nor2   g52(.a(x24), .b(x23), .O(new_n103_));
  nand4  g53(.a(new_n103_), .b(new_n87_), .c(new_n67_), .d(new_n51_), .O(new_n104_));
  ...
  oai21  g58(.a(x18), .b(new_n60_), .c(new_n108_), .O(new_n109_));
  nand2  g59(.a(new_n109_), .b(new_n80_), .O(new_n110_));
  nand2  g60(.a(new_n104_), .b(x25), .O(new_n111_));
  nor2   g61(.a(x23), .b(x22), .O(new_n112_));
  nor2   g62(.a(x25), .b(x24), .O(new_n113_));
  nand4  g63(.a(new_n113_), .b(new_n112_), .c(new_n85_), .d(new_n67_), .O(new_n114_));
  ...
  oai21  g68(.a(x18), .b(new_n63_), .c(new_n118_), .O(new_n119_));
  nand2  g69(.a(new_n119_), .b(new_n80_), .O(new_n120_));
  nand2  g70(.a(new_n114_), .b(x26), .O(new_n121_));
  nor3   g71(.a(x26), .b(x25), .c(x24), .O(new_n122_));
  nand4  g72(.a(new_n122_), .b(new_n112_), .c(new_n85_), .d(new_n67_), .O(new_n123_));
  nand2  g73(.a(new_n123_), .b(new_n121_), .O(new_n124_));
  nand2  g74(.a(new_n124_), .b(x16), .O(new_n125_));
  nand2  g75(.a(new_n125_), .b(new_n120_), .O(z16));
  zero   g76(.O(z02));
  zero   g77(.O(z03));
  zero   g78(.O(z04));
  zero   g79(.O(z11));
