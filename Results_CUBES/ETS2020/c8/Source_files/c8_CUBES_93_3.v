...
module FAU ( 
  ...
  nand3  g42(.a(new_n86_), .b(new_n76_), .c(new_n51_), .O(new_n92_));
  nor3   g43(.a(x23), .b(x22), .c(x21), .O(new_n93_));
  aoi22  g44(.a(new_n93_), .b(new_n84_), .c(new_n92_), .d(x23), .O(new_n94_));
  oai21  g45(.a(new_n94_), .b(new_n72_), .c(new_n91_), .O(z13));
  nand2  g46(.a(x18), .b(x06), .O(new_n97_));
  oai21  g47(.a(x18), .b(new_n66_), .c(new_n97_), .O(new_n98_));
  nand2  g48(.a(new_n98_), .b(new_n72_), .O(new_n99_));
  nor2   g49(.a(x24), .b(x23), .O(new_n100_));
  nand4  g50(.a(new_n100_), .b(new_n86_), .c(new_n76_), .d(new_n51_), .O(new_n101_));
  nand2  g51(.a(new_n101_), .b(x25), .O(new_n102_));
  nor2   g52(.a(x23), .b(x22), .O(new_n103_));
  nor2   g53(.a(x25), .b(x24), .O(new_n104_));
  nand4  g54(.a(new_n104_), .b(new_n103_), .c(new_n78_), .d(new_n76_), .O(new_n105_));
  nand2  g55(.a(new_n105_), .b(new_n102_), .O(new_n106_));
  nand2  g56(.a(new_n106_), .b(x16), .O(new_n107_));
  nand2  g57(.a(new_n107_), .b(new_n99_), .O(z15));
  inv1   g58(.a(x15), .O(new_n109_));
  nand2  g59(.a(x18), .b(x07), .O(new_n110_));
  oai21  g60(.a(x18), .b(new_n109_), .c(new_n110_), .O(new_n111_));
  nand2  g61(.a(new_n111_), .b(new_n72_), .O(new_n112_));
  nand2  g62(.a(new_n105_), .b(x26), .O(new_n113_));
  nor3   g63(.a(x26), .b(x25), .c(x24), .O(new_n114_));
  nand4  g64(.a(new_n114_), .b(new_n103_), .c(new_n78_), .d(new_n76_), .O(new_n115_));
  nand2  g65(.a(new_n115_), .b(new_n113_), .O(new_n116_));
  nand2  g66(.a(new_n116_), .b(x16), .O(new_n117_));
  nand2  g67(.a(new_n117_), .b(new_n112_), .O(z16));
  nor2   g68(.a(new_n48_), .b(x17), .O(new_n119_));
  nand4  g69(.a(new_n119_), .b(new_n114_), .c(new_n103_), .d(new_n78_), .O(new_n120_));
  nand2  g70(.a(x27), .b(x17), .O(new_n121_));
  aoi21  g71(.a(new_n121_), .b(new_n120_), .c(new_n72_), .O(z17));
  zero   g72(.O(z07));
  zero   g73(.O(z09));
  zero   g74(.O(z10));
  zero   g75(.O(z14));
