...
module FAU ( 
  ...
  nand2  g42(.a(new_n73_), .b(new_n51_), .O(new_n91_));
  inv1   g43(.a(x21), .O(new_n92_));
  nand4  g44(.a(new_n92_), .b(new_n51_), .c(new_n48_), .d(new_n71_), .O(new_n93_));
  inv1   g45(.a(new_n93_), .O(new_n94_));
  aoi21  g46(.a(new_n91_), .b(x21), .c(new_n94_), .O(new_n95_));
  oai21  g47(.a(new_n95_), .b(new_n86_), .c(new_n90_), .O(z11));
  inv1   g48(.a(x13), .O(new_n99_));
  nand2  g49(.a(x18), .b(x05), .O(new_n100_));
  oai21  g50(.a(x18), .b(new_n99_), .c(new_n100_), .O(new_n101_));
  nand2  g51(.a(new_n101_), .b(new_n86_), .O(new_n102_));
  nor3   g52(.a(x23), .b(x22), .c(x21), .O(new_n103_));
  aoi21  g53(.a(new_n103_), .b(new_n83_), .c(new_n61_), .O(new_n104_));
  nor2   g54(.a(x22), .b(x21), .O(new_n105_));
  nor2   g55(.a(x24), .b(x23), .O(new_n106_));
  nand4  g56(.a(new_n106_), .b(new_n105_), .c(new_n73_), .d(new_n51_), .O(new_n107_));
  inv1   g57(.a(new_n107_), .O(new_n108_));
  oai21  g58(.a(new_n108_), .b(new_n104_), .c(x16), .O(new_n109_));
  nand2  g59(.a(new_n109_), .b(new_n102_), .O(z14));
  inv1   g60(.a(x14), .O(new_n111_));
  nand2  g61(.a(x18), .b(x06), .O(new_n112_));
  oai21  g62(.a(x18), .b(new_n111_), .c(new_n112_), .O(new_n113_));
  nand2  g63(.a(new_n113_), .b(new_n86_), .O(new_n114_));
  nand4  g64(.a(new_n64_), .b(new_n61_), .c(new_n58_), .d(new_n55_), .O(new_n115_));
  inv1   g65(.a(new_n115_), .O(new_n116_));
  aoi22  g66(.a(new_n116_), .b(new_n94_), .c(new_n107_), .d(x25), .O(new_n117_));
  oai21  g67(.a(new_n117_), .b(new_n86_), .c(new_n114_), .O(z15));
  zero   g68(.O(z02));
  zero   g69(.O(z08));
  zero   g70(.O(z12));
  zero   g71(.O(z13));
