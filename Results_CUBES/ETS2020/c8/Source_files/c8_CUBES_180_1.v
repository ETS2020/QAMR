...
module FAU ( 
  ...
  nor3   g41(.a(x20), .b(x19), .c(x17), .O(new_n92_));
  nor3   g42(.a(x23), .b(x22), .c(x21), .O(new_n93_));
  aoi21  g43(.a(new_n93_), .b(new_n92_), .c(new_n61_), .O(new_n94_));
  nor2   g44(.a(x22), .b(x21), .O(new_n95_));
  nor2   g45(.a(x24), .b(x23), .O(new_n96_));
  nand4  g46(.a(new_n96_), .b(new_n95_), .c(new_n71_), .d(new_n49_), .O(new_n97_));
  inv1   g47(.a(new_n97_), .O(new_n98_));
  oai21  g48(.a(new_n98_), .b(new_n94_), .c(x16), .O(new_n99_));
  nand2  g49(.a(new_n99_), .b(new_n91_), .O(z14));
  nand2  g50(.a(x18), .b(x06), .O(new_n101_));
  oai21  g51(.a(x18), .b(new_n64_), .c(new_n101_), .O(new_n102_));
  nand2  g52(.a(new_n102_), .b(new_n78_), .O(new_n103_));
  nand2  g53(.a(new_n97_), .b(x25), .O(new_n104_));
  nor2   g54(.a(x23), .b(x22), .O(new_n105_));
  nor2   g55(.a(x25), .b(x24), .O(new_n106_));
  nand4  g56(.a(new_n106_), .b(new_n105_), .c(new_n83_), .d(new_n71_), .O(new_n107_));
  nand2  g57(.a(new_n107_), .b(new_n104_), .O(new_n108_));
  nand2  g58(.a(new_n108_), .b(x16), .O(new_n109_));
  nand2  g59(.a(new_n109_), .b(new_n103_), .O(z15));
  ...
  nand4  g65(.a(new_n115_), .b(new_n105_), .c(new_n83_), .d(new_n71_), .O(new_n116_));
  ...
  nand4  g71(.a(new_n121_), .b(new_n115_), .c(new_n105_), .d(new_n83_), .O(new_n122_));
  nand2  g72(.a(x27), .b(x17), .O(new_n123_));
  aoi21  g73(.a(new_n123_), .b(new_n122_), .c(new_n78_), .O(z17));
  zero   g74(.O(z00));
  zero   g75(.O(z10));
  zero   g76(.O(z12));
  zero   g77(.O(z13));
