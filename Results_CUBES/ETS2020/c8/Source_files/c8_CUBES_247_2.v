...
module FAU ( 
  ...
  nand3  g50(.a(new_n99_), .b(new_n71_), .c(new_n49_), .O(new_n100_));
  nor3   g51(.a(x23), .b(x22), .c(x21), .O(new_n101_));
  aoi22  g52(.a(new_n101_), .b(new_n81_), .c(new_n100_), .d(x23), .O(new_n102_));
  oai21  g53(.a(new_n102_), .b(new_n84_), .c(new_n98_), .O(z13));
  inv1   g54(.a(x13), .O(new_n104_));
  nand2  g55(.a(x18), .b(x05), .O(new_n105_));
  oai21  g56(.a(x18), .b(new_n104_), .c(new_n105_), .O(new_n106_));
  nand2  g57(.a(new_n106_), .b(new_n84_), .O(new_n107_));
  aoi21  g58(.a(new_n101_), .b(new_n81_), .c(new_n61_), .O(new_n108_));
  nor2   g59(.a(x24), .b(x23), .O(new_n109_));
  nand4  g60(.a(new_n109_), .b(new_n99_), .c(new_n71_), .d(new_n49_), .O(new_n110_));
  ...
  inv1   g64(.a(x14), .O(new_n114_));
  nand2  g65(.a(x18), .b(x06), .O(new_n115_));
  oai21  g66(.a(x18), .b(new_n114_), .c(new_n115_), .O(new_n116_));
  nand2  g67(.a(new_n116_), .b(new_n84_), .O(new_n117_));
  inv1   g68(.a(x25), .O(new_n118_));
  nand4  g69(.a(new_n118_), .b(new_n61_), .c(new_n58_), .d(new_n55_), .O(new_n119_));
  inv1   g70(.a(new_n119_), .O(new_n120_));
  aoi22  g71(.a(new_n120_), .b(new_n91_), .c(new_n110_), .d(x25), .O(new_n121_));
  oai21  g72(.a(new_n121_), .b(new_n84_), .c(new_n117_), .O(z15));
