...
module FAU ( 
  ...
  oai21  g43(.a(x18), .b(new_n56_), .c(new_n92_), .O(new_n93_));
  nand2  g44(.a(new_n93_), .b(new_n83_), .O(new_n94_));
  nor2   g45(.a(x22), .b(x21), .O(new_n95_));
  nand3  g46(.a(new_n95_), .b(new_n69_), .c(new_n78_), .O(new_n96_));
  nor3   g47(.a(x23), .b(x22), .c(x21), .O(new_n97_));
  aoi22  g48(.a(new_n97_), .b(new_n80_), .c(new_n96_), .d(x23), .O(new_n98_));
  oai21  g49(.a(new_n98_), .b(new_n83_), .c(new_n94_), .O(z13));
  nand2  g50(.a(x18), .b(x06), .O(new_n101_));
  oai21  g51(.a(x18), .b(new_n62_), .c(new_n101_), .O(new_n102_));
  nand2  g52(.a(new_n102_), .b(new_n83_), .O(new_n103_));
  nor2   g53(.a(x24), .b(x23), .O(new_n104_));
  nand4  g54(.a(new_n104_), .b(new_n95_), .c(new_n69_), .d(new_n78_), .O(new_n105_));
  ...
  oai21  g63(.a(x18), .b(new_n65_), .c(new_n113_), .O(new_n114_));
  nand2  g64(.a(new_n114_), .b(new_n83_), .O(new_n115_));
  nand2  g65(.a(new_n109_), .b(x26), .O(new_n116_));
  nor3   g66(.a(x26), .b(x25), .c(x24), .O(new_n117_));
  nand4  g67(.a(new_n117_), .b(new_n107_), .c(new_n88_), .d(new_n69_), .O(new_n118_));
  ...
  nand4  g72(.a(new_n122_), .b(new_n117_), .c(new_n107_), .d(new_n88_), .O(new_n123_));
  nand2  g73(.a(x27), .b(x17), .O(new_n124_));
  aoi21  g74(.a(new_n124_), .b(new_n123_), .c(new_n83_), .O(z17));
  zero   g75(.O(z01));
  zero   g76(.O(z03));
  zero   g77(.O(z12));
  zero   g78(.O(z14));
