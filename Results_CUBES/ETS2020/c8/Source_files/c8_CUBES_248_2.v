...
module FAU ( 
  ...
  nor2   g26(.a(x19), .b(x17), .O(new_n75_));
  nor2   g27(.a(new_n75_), .b(new_n74_), .O(new_n76_));
  nor3   g28(.a(x20), .b(x19), .c(x17), .O(new_n77_));
  oai21  g29(.a(new_n77_), .b(new_n76_), .c(x16), .O(new_n78_));
  oai21  g30(.a(new_n73_), .b(x16), .c(new_n78_), .O(z10));
  ...
  nand3  g36(.a(new_n86_), .b(new_n75_), .c(new_n74_), .O(new_n87_));
  nor3   g37(.a(x23), .b(x22), .c(x21), .O(new_n88_));
  aoi22  g38(.a(new_n88_), .b(new_n77_), .c(new_n87_), .d(x23), .O(new_n89_));
  oai21  g39(.a(new_n89_), .b(new_n82_), .c(new_n85_), .O(z13));
  nand2  g40(.a(x18), .b(x06), .O(new_n92_));
  oai21  g41(.a(x18), .b(new_n64_), .c(new_n92_), .O(new_n93_));
  nand2  g42(.a(new_n93_), .b(new_n82_), .O(new_n94_));
  nor2   g43(.a(x24), .b(x23), .O(new_n95_));
  nand4  g44(.a(new_n95_), .b(new_n86_), .c(new_n75_), .d(new_n74_), .O(new_n96_));
  ...
  nand4  g49(.a(new_n100_), .b(new_n99_), .c(new_n98_), .d(new_n75_), .O(new_n101_));
  ...
  nand4  g58(.a(new_n109_), .b(new_n99_), .c(new_n98_), .d(new_n75_), .O(new_n110_));
  ...
  aoi21  g65(.a(new_n116_), .b(new_n115_), .c(new_n82_), .O(z17));
  zero   g66(.O(z01));
  zero   g67(.O(z09));
  zero   g68(.O(z11));
  zero   g69(.O(z12));
