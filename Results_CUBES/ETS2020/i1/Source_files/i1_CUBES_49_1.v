...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_,
    ...
    new_n64_, new_n67_, new_n68_, new_n69_, new_n78_, new_n80_, new_n81_;
  ...
  nor2   g30(.a(x24), .b(new_n78_), .O(z14));
  nor2   g31(.a(x13), .b(x12), .O(new_n80_));
  nor2   g32(.a(x15), .b(x14), .O(new_n81_));
  nand2  g33(.a(new_n81_), .b(new_n80_), .O(z15));
  zero   g34(.O(z07));
  zero   g35(.O(z08));
  zero   g36(.O(z09));
  zero   g37(.O(z10));
