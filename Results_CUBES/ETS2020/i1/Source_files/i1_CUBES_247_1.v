// Benchmark "FAU" written by ABC on Tue Jul  7 10:57:02 2020
...
module FAU ( 
  ...
  wire new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n65_, new_n68_, new_n69_, new_n70_, new_n74_, new_n77_, new_n79_,
  ...
  nand2  g33(.a(x23), .b(x17), .O(new_n79_));
  nor2   g34(.a(new_n79_), .b(x24), .O(z13));
