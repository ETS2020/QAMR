// Benchmark "FAU" written by ABC on Tue Jul  7 10:55:55 2020
...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_,
    ...
    new_n64_, new_n68_, new_n69_, new_n70_, new_n75_, new_n79_, new_n82_,
    new_n83_;
  ...
  nand2  g31(.a(x23), .b(x17), .O(new_n79_));
  nor2   g32(.a(new_n79_), .b(x24), .O(z13));
  nor2   g33(.a(x13), .b(x12), .O(new_n82_));
  nor2   g34(.a(x15), .b(x14), .O(new_n83_));
  nand2  g35(.a(new_n83_), .b(new_n82_), .O(z15));
  zero   g36(.O(z03));
  zero   g37(.O(z04));
  zero   g38(.O(z07));
  zero   g39(.O(z08));
