// Benchmark "FAU" written by ABC on Tue Jul  7 10:56:45 2020
...
module FAU ( 
  ...
  nand2  g30(.a(x22), .b(x17), .O(new_n74_));
  nor2   g31(.a(new_n74_), .b(x24), .O(z11));
  nand2  g32(.a(x23), .b(x14), .O(new_n76_));
  nor2   g33(.a(new_n76_), .b(x24), .O(z12));
