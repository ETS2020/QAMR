// Benchmark "FAU" written by ABC on Tue Jul  7 10:56:08 2020
...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_,
    ...
    new_n64_, new_n68_, new_n69_, new_n70_, new_n75_, new_n76_, new_n78_,
  ...
  nor3   g31(.a(x24), .b(new_n76_), .c(new_n75_), .O(z10));
  inv1   g32(.a(x17), .O(new_n78_));
  nor3   g33(.a(x24), .b(new_n76_), .c(new_n78_), .O(z11));
  inv1   g34(.a(x23), .O(new_n80_));
  nor3   g35(.a(x24), .b(new_n80_), .c(new_n75_), .O(z12));
  nor3   g36(.a(x24), .b(new_n80_), .c(new_n78_), .O(z13));
  inv1   g37(.a(x16), .O(new_n83_));
  nor2   g38(.a(x24), .b(new_n83_), .O(z14));
  nor2   g39(.a(x13), .b(x12), .O(new_n85_));
  nor2   g40(.a(x15), .b(x14), .O(new_n86_));
  nand2  g41(.a(new_n86_), .b(new_n85_), .O(z15));
  zero   g42(.O(z03));
  zero   g43(.O(z04));
  zero   g44(.O(z07));
  zero   g45(.O(z08));
