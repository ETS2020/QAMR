// Benchmark "FAU" written by ABC on Tue Jul  7 10:56:18 2020
...
module FAU ( 
  ...
  inv1   g08(.a(x14), .O(new_n55_));
  inv1   g09(.a(x22), .O(new_n56_));
  nor3   g10(.a(x24), .b(new_n56_), .c(new_n55_), .O(z10));
  inv1   g11(.a(x17), .O(new_n58_));
  nor3   g12(.a(x24), .b(new_n56_), .c(new_n58_), .O(z11));
  inv1   g13(.a(x23), .O(new_n60_));
  nor3   g14(.a(x24), .b(new_n60_), .c(new_n55_), .O(z12));
  nor3   g15(.a(x24), .b(new_n60_), .c(new_n58_), .O(z13));
