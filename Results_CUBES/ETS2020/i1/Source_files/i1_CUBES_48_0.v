// Benchmark "FAU" written by ABC on Tue Jul  7 10:56:10 2020
...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_,
    ...
    new_n64_, new_n68_, new_n69_, new_n70_, new_n75_, new_n78_, new_n80_,
    new_n83_, new_n84_;
  ...
  nand2  g29(.a(x22), .b(x14), .O(new_n75_));
  nor2   g30(.a(new_n75_), .b(x24), .O(z10));
  ...
  nor2   g35(.a(x13), .b(x12), .O(new_n83_));
  nor2   g36(.a(x15), .b(x14), .O(new_n84_));
  nand2  g37(.a(new_n84_), .b(new_n83_), .O(z15));
  zero   g38(.O(z03));
  zero   g39(.O(z04));
  zero   g40(.O(z07));
  zero   g41(.O(z08));
