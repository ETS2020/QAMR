...
module FAU ( 
  ...
  wire new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n65_, new_n69_, new_n70_, new_n71_, new_n76_, new_n78_, new_n83_,
    new_n84_;
  ...
  nor2   g33(.a(x13), .b(x12), .O(new_n83_));
  nor2   g34(.a(x15), .b(x14), .O(new_n84_));
  nand2  g35(.a(new_n84_), .b(new_n83_), .O(z15));
  zero   g36(.O(z00));
  zero   g37(.O(z03));
  zero   g38(.O(z04));
  zero   g39(.O(z07));
