// Benchmark "FAU" written by ABC on Tue Jul  7 10:56:20 2020
...
module FAU ( 
  ...
  inv1   g30(.a(x14), .O(new_n74_));
  inv1   g31(.a(x22), .O(new_n75_));
  nor3   g32(.a(x24), .b(new_n75_), .c(new_n74_), .O(z10));
  inv1   g33(.a(x17), .O(new_n77_));
  nor3   g34(.a(x24), .b(new_n75_), .c(new_n77_), .O(z11));
  inv1   g35(.a(x23), .O(new_n79_));
  nor3   g36(.a(x24), .b(new_n79_), .c(new_n74_), .O(z12));
  nor3   g37(.a(x24), .b(new_n79_), .c(new_n77_), .O(z13));
  nor2   g38(.a(x13), .b(x12), .O(new_n83_));
  nor2   g39(.a(x15), .b(x14), .O(new_n84_));
  nand2  g40(.a(new_n84_), .b(new_n83_), .O(z15));
  zero   g41(.O(z03));
  zero   g42(.O(z04));
  zero   g43(.O(z14));
  buf    g44(.a(x00), .O(z00));
