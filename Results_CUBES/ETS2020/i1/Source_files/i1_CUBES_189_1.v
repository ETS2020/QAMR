...
module FAU ( 
  ...
  nand2  g31(.a(x22), .b(x14), .O(new_n74_));
  nor2   g32(.a(new_n74_), .b(x24), .O(z10));
  nand2  g33(.a(x22), .b(x17), .O(new_n76_));
  nor2   g34(.a(new_n76_), .b(x24), .O(z11));
  nand2  g35(.a(x23), .b(x14), .O(new_n78_));
  nor2   g36(.a(new_n78_), .b(x24), .O(z12));
  inv1   g37(.a(x16), .O(new_n81_));
  nor2   g38(.a(x24), .b(new_n81_), .O(z14));
  nor2   g39(.a(x13), .b(x12), .O(new_n83_));
  nor2   g40(.a(x15), .b(x14), .O(new_n84_));
  nand2  g41(.a(new_n84_), .b(new_n83_), .O(z15));
  zero   g42(.O(z00));
  zero   g43(.O(z13));
  buf    g44(.a(x20), .O(z03));
  buf    g45(.a(x19), .O(z06));
