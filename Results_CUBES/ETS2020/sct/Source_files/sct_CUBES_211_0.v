...
module FAU ( 
  ...
  nand2  g27(.a(new_n59_), .b(new_n55_), .O(new_n63_));
  oai21  g28(.a(new_n63_), .b(new_n51_), .c(x11), .O(new_n64_));
  inv1   g29(.a(x11), .O(new_n65_));
  nand4  g30(.a(new_n60_), .b(new_n65_), .c(new_n59_), .d(new_n55_), .O(new_n66_));
  nand4  g31(.a(new_n66_), .b(new_n64_), .c(new_n54_), .d(x04), .O(z07));
  inv1   g32(.a(new_n45_), .O(new_n69_));
  inv1   g33(.a(x12), .O(new_n70_));
  inv1   g34(.a(x13), .O(new_n71_));
  nand4  g35(.a(new_n71_), .b(new_n70_), .c(new_n65_), .d(new_n59_), .O(new_n72_));
  nor2   g36(.a(new_n72_), .b(new_n56_), .O(new_n73_));
  nor2   g37(.a(new_n44_), .b(x02), .O(new_n74_));
  aoi21  g38(.a(new_n73_), .b(new_n69_), .c(new_n74_), .O(new_n75_));
  nand4  g39(.a(new_n70_), .b(new_n65_), .c(new_n59_), .d(new_n55_), .O(new_n76_));
  oai21  g40(.a(new_n76_), .b(new_n51_), .c(x13), .O(new_n77_));
  ...
  nand3  g46(.a(new_n82_), .b(new_n80_), .c(new_n69_), .O(new_n83_));
