// Benchmark "FAU" written by ABC on Tue Jul  7 12:31:36 2020
...
module FAU ( 
  ...
  nor3   g11(.a(new_n47_), .b(new_n43_), .c(new_n40_), .O(z04));
  nand2  g12(.a(new_n46_), .b(x08), .O(new_n49_));
  nand2  g13(.a(new_n49_), .b(x09), .O(new_n50_));
  oai21  g14(.a(new_n40_), .b(x02), .c(new_n41_), .O(new_n51_));
  ...
  aoi21  g52(.a(new_n88_), .b(new_n87_), .c(new_n40_), .O(z10));
  nor2   g53(.a(new_n79_), .b(x03), .O(new_n90_));
  nor2   g54(.a(new_n90_), .b(new_n40_), .O(z12));
  zero   g55(.O(z01));
  zero   g56(.O(z02));
  zero   g57(.O(z13));
  zero   g58(.O(z14));
