// Benchmark "FAU" written by ABC on Tue Jul  7 12:32:13 2020
...
module FAU ( 
  ...
  oai21  g17(.a(new_n40_), .b(x02), .c(new_n43_), .O(new_n53_));
  ...
  aoi21  g22(.a(new_n53_), .b(x16), .c(new_n40_), .O(new_n58_));
  ...
  inv1   g41(.a(new_n45_), .O(new_n77_));
  inv1   g42(.a(x13), .O(new_n78_));
  nand4  g43(.a(new_n78_), .b(new_n72_), .c(new_n71_), .d(new_n60_), .O(new_n79_));
  nor2   g44(.a(new_n79_), .b(new_n56_), .O(new_n80_));
  nor2   g45(.a(new_n44_), .b(x02), .O(new_n81_));
  aoi21  g46(.a(new_n80_), .b(new_n77_), .c(new_n81_), .O(new_n82_));
  oai21  g47(.a(new_n73_), .b(new_n51_), .c(x13), .O(new_n83_));
  nand2  g48(.a(x16), .b(x03), .O(new_n84_));
  nand4  g49(.a(new_n84_), .b(new_n83_), .c(new_n82_), .d(x04), .O(z09));
  inv1   g50(.a(new_n56_), .O(new_n86_));
  inv1   g51(.a(x00), .O(new_n87_));
  nand2  g52(.a(new_n79_), .b(new_n87_), .O(new_n88_));
  nand3  g53(.a(new_n88_), .b(new_n86_), .c(new_n77_), .O(new_n89_));
  nand2  g54(.a(new_n45_), .b(x14), .O(new_n90_));
  aoi21  g55(.a(new_n90_), .b(new_n89_), .c(new_n40_), .O(z10));
  nor2   g56(.a(new_n81_), .b(x03), .O(new_n92_));
  nor2   g57(.a(new_n92_), .b(new_n40_), .O(z12));
  zero   g58(.O(z03));
  zero   g59(.O(z13));
  zero   g60(.O(z14));
  buf    g61(.a(x02), .O(z11));
