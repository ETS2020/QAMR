...
module FAU ( 
  ...
  nor2   g10(.a(new_n43_), .b(new_n38_), .O(new_n46_));
  nand2  g11(.a(new_n46_), .b(new_n45_), .O(new_n47_));
  ...
  nand3  g20(.a(new_n55_), .b(new_n53_), .c(new_n46_), .O(z05));
  ...
  nand3  g25(.a(new_n60_), .b(new_n59_), .c(new_n46_), .O(z06));
  ...
  nand3  g30(.a(new_n65_), .b(new_n62_), .c(new_n46_), .O(z07));
  ...
  nand3  g34(.a(new_n69_), .b(new_n67_), .c(new_n46_), .O(z08));
  nand2  g35(.a(new_n69_), .b(x13), .O(new_n71_));
  inv1   g36(.a(x02), .O(new_n72_));
  oai21  g37(.a(x03), .b(new_n72_), .c(x16), .O(new_n73_));
  and2   g38(.a(x06), .b(x04), .O(new_n74_));
  nand3  g39(.a(new_n58_), .b(x08), .c(x07), .O(new_n75_));
  inv1   g40(.a(new_n75_), .O(new_n76_));
  nor3   g41(.a(x13), .b(x12), .c(x11), .O(new_n77_));
  nand4  g42(.a(new_n77_), .b(new_n76_), .c(new_n74_), .d(new_n73_), .O(new_n78_));
  nand3  g43(.a(new_n78_), .b(new_n71_), .c(new_n46_), .O(z09));
  inv1   g44(.a(new_n55_), .O(new_n80_));
  inv1   g45(.a(x00), .O(new_n81_));
  inv1   g46(.a(x13), .O(new_n82_));
  nand4  g47(.a(new_n82_), .b(new_n68_), .c(new_n64_), .d(new_n63_), .O(new_n83_));
  nand2  g48(.a(new_n83_), .b(new_n81_), .O(new_n84_));
  nand3  g49(.a(new_n84_), .b(new_n80_), .c(new_n73_), .O(new_n85_));
  nand2  g50(.a(new_n43_), .b(x14), .O(new_n86_));
  aoi21  g51(.a(new_n86_), .b(new_n85_), .c(new_n38_), .O(z10));
