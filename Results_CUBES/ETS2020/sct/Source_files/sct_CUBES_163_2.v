...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14;
  wire new_n35_, new_n36_, new_n38_, new_n39_, new_n40_, new_n41_, new_n46_,
  ...
  oai21  g11(.a(new_n40_), .b(x02), .c(new_n48_), .O(new_n49_));
  nand2  g12(.a(new_n49_), .b(x16), .O(new_n50_));
  inv1   g13(.a(x09), .O(new_n51_));
  nand4  g14(.a(new_n51_), .b(x08), .c(x07), .d(x06), .O(new_n52_));
  nand4  g15(.a(new_n52_), .b(new_n50_), .c(new_n47_), .d(x04), .O(z05));
  aoi21  g16(.a(new_n49_), .b(x16), .c(new_n40_), .O(new_n54_));
  ...
  oai21  g31(.a(x03), .b(new_n35_), .c(x16), .O(new_n69_));
  ...
  inv1   g35(.a(x16), .O(new_n73_));
  nor2   g36(.a(new_n73_), .b(x02), .O(new_n74_));
  aoi21  g37(.a(new_n72_), .b(new_n69_), .c(new_n74_), .O(new_n75_));
  nand2  g38(.a(new_n67_), .b(x13), .O(new_n76_));
  nand2  g39(.a(x16), .b(x03), .O(new_n77_));
  nand4  g40(.a(new_n77_), .b(new_n76_), .c(new_n75_), .d(x04), .O(z09));
  inv1   g41(.a(new_n52_), .O(new_n79_));
  inv1   g42(.a(x00), .O(new_n80_));
  nand2  g43(.a(new_n71_), .b(new_n80_), .O(new_n81_));
  nand3  g44(.a(new_n81_), .b(new_n69_), .c(new_n79_), .O(new_n82_));
  inv1   g45(.a(x14), .O(new_n83_));
  or2    g46(.a(new_n69_), .b(new_n83_), .O(new_n84_));
  aoi21  g47(.a(new_n84_), .b(new_n82_), .c(new_n40_), .O(z10));
  nor2   g48(.a(new_n74_), .b(x03), .O(new_n86_));
  nor2   g49(.a(new_n86_), .b(new_n40_), .O(z12));
