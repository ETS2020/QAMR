...
module FAU ( 
  ...
  nand2  g31(.a(new_n62_), .b(new_n58_), .O(new_n66_));
  oai21  g32(.a(new_n66_), .b(new_n54_), .c(x11), .O(new_n67_));
  inv1   g33(.a(x11), .O(new_n68_));
  nand4  g34(.a(new_n63_), .b(new_n68_), .c(new_n62_), .d(new_n58_), .O(new_n69_));
  nand4  g35(.a(new_n69_), .b(new_n67_), .c(new_n57_), .d(x04), .O(z07));
  inv1   g36(.a(x12), .O(new_n72_));
  inv1   g37(.a(x13), .O(new_n73_));
  nand4  g38(.a(new_n73_), .b(new_n72_), .c(new_n68_), .d(new_n62_), .O(new_n74_));
  nor2   g39(.a(new_n74_), .b(new_n59_), .O(new_n75_));
  nor2   g40(.a(new_n44_), .b(x02), .O(new_n76_));
  aoi21  g41(.a(new_n75_), .b(new_n47_), .c(new_n76_), .O(new_n77_));
  nand4  g42(.a(new_n72_), .b(new_n68_), .c(new_n62_), .d(new_n58_), .O(new_n78_));
  oai21  g43(.a(new_n78_), .b(new_n54_), .c(x13), .O(new_n79_));
  nand2  g44(.a(x16), .b(x03), .O(new_n80_));
  nand4  g45(.a(new_n80_), .b(new_n79_), .c(new_n77_), .d(x04), .O(z09));
  inv1   g46(.a(new_n59_), .O(new_n82_));
  inv1   g47(.a(x00), .O(new_n83_));
  nand2  g48(.a(new_n74_), .b(new_n83_), .O(new_n84_));
  ...
  nor2   g52(.a(new_n76_), .b(x03), .O(new_n88_));
