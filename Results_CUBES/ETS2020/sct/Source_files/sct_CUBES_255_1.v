...
module FAU ( 
  ...
  inv1   g15(.a(x10), .O(new_n52_));
  inv1   g16(.a(new_n47_), .O(new_n53_));
  nand4  g17(.a(new_n53_), .b(new_n52_), .c(new_n51_), .d(x08), .O(new_n54_));
  nand2  g18(.a(new_n51_), .b(x08), .O(new_n55_));
  oai21  g19(.a(new_n55_), .b(new_n47_), .c(x10), .O(new_n56_));
  nand4  g20(.a(new_n56_), .b(new_n54_), .c(new_n39_), .d(x04), .O(z06));
