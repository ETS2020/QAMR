// Benchmark "FAU" written by ABC on Mon Jul  6 16:20:58 2020
...
module FAU ( 
  ...
  nor2   g32(.a(x07), .b(x00), .O(new_n59_));
  nand4  g33(.a(new_n59_), .b(x13), .c(new_n58_), .d(new_n41_), .O(z5));
  inv1   g34(.a(x09), .O(new_n61_));
  oai21  g35(.a(new_n61_), .b(x03), .c(new_n30_), .O(new_n62_));
  aoi21  g36(.a(x08), .b(x00), .c(x01), .O(new_n63_));
  nand2  g37(.a(new_n63_), .b(new_n62_), .O(new_n64_));
  inv1   g38(.a(x14), .O(new_n65_));
  oai21  g39(.a(x09), .b(new_n34_), .c(new_n25_), .O(new_n66_));
  inv1   g40(.a(x00), .O(new_n67_));
  nand2  g41(.a(new_n30_), .b(new_n67_), .O(new_n68_));
  oai21  g42(.a(x08), .b(new_n67_), .c(new_n68_), .O(new_n69_));
  nor2   g43(.a(new_n30_), .b(x00), .O(new_n70_));
  aoi22  g44(.a(new_n70_), .b(new_n65_), .c(new_n69_), .d(new_n66_), .O(new_n71_));
  aoi21  g45(.a(new_n71_), .b(new_n64_), .c(new_n45_), .O(z6));
  nand3  g46(.a(x09), .b(x03), .c(new_n30_), .O(new_n73_));
  inv1   g47(.a(x08), .O(new_n74_));
  nand4  g48(.a(new_n41_), .b(new_n74_), .c(new_n40_), .d(x02), .O(new_n75_));
  nand2  g49(.a(new_n75_), .b(new_n73_), .O(new_n76_));
  nand2  g50(.a(new_n76_), .b(new_n25_), .O(new_n77_));
  nand2  g51(.a(x03), .b(new_n25_), .O(new_n78_));
  aoi21  g52(.a(new_n78_), .b(new_n74_), .c(new_n45_), .O(new_n79_));
  nand2  g53(.a(new_n79_), .b(new_n77_), .O(z7));
  nand2  g54(.a(new_n58_), .b(new_n30_), .O(new_n81_));
  oai21  g55(.a(new_n81_), .b(new_n78_), .c(x09), .O(new_n82_));
  aoi21  g56(.a(new_n61_), .b(new_n67_), .c(new_n45_), .O(new_n83_));
  nand2  g57(.a(new_n83_), .b(new_n82_), .O(z8));
  zero   g58(.O(z3));
  zero   g59(.O(z4));
endmodule
