...
module FAU ( 
  ...
  nand4  g39(.a(new_n63_), .b(new_n41_), .c(new_n40_), .d(new_n56_), .O(z5));
  aoi21  g40(.a(new_n58_), .b(x03), .c(x01), .O(new_n65_));
  nand3  g41(.a(x09), .b(new_n34_), .c(new_n25_), .O(new_n66_));
  oai21  g42(.a(new_n65_), .b(x02), .c(new_n66_), .O(new_n67_));
  nand2  g43(.a(new_n67_), .b(new_n59_), .O(new_n68_));
  inv1   g44(.a(x14), .O(new_n69_));
  nand2  g45(.a(new_n25_), .b(new_n56_), .O(new_n70_));
  ...
  aoi21  g49(.a(new_n73_), .b(new_n68_), .c(new_n45_), .O(z6));
  nand3  g50(.a(x09), .b(x03), .c(new_n25_), .O(new_n75_));
  inv1   g51(.a(x08), .O(new_n76_));
  nand4  g52(.a(new_n41_), .b(new_n76_), .c(new_n40_), .d(x01), .O(new_n77_));
