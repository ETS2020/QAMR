...
module FAU ( 
  ...
  nor2   g44(.a(x07), .b(new_n27_), .O(new_n71_));
  nand2  g45(.a(x03), .b(new_n25_), .O(new_n72_));
  oai21  g46(.a(new_n72_), .b(new_n71_), .c(new_n45_), .O(new_n73_));
  nor2   g47(.a(x02), .b(x01), .O(new_n74_));
  nor2   g48(.a(new_n51_), .b(new_n36_), .O(new_n75_));
  aoi21  g49(.a(new_n75_), .b(new_n74_), .c(new_n69_), .O(new_n76_));
  nand2  g50(.a(new_n76_), .b(new_n73_), .O(z7));
  nand3  g51(.a(new_n74_), .b(new_n55_), .c(x03), .O(new_n78_));
  nand2  g52(.a(new_n78_), .b(x09), .O(new_n79_));
