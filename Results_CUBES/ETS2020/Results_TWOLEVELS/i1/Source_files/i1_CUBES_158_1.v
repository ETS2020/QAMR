...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_,
    ...
    new_n64_, new_n67_, new_n68_, new_n69_, new_n74_, new_n76_, new_n78_,
  ...
  nand2  g31(.a(x22), .b(x17), .O(new_n74_));
  nor2   g32(.a(new_n74_), .b(x24), .O(z11));
  nand2  g33(.a(x23), .b(x14), .O(new_n76_));
  nor2   g34(.a(new_n76_), .b(x24), .O(z12));
  nand2  g35(.a(x23), .b(x17), .O(new_n78_));
  nor2   g36(.a(new_n78_), .b(x24), .O(z13));
  inv1   g37(.a(x16), .O(new_n80_));
  nor2   g38(.a(x24), .b(new_n80_), .O(z14));
  nor2   g39(.a(x13), .b(x12), .O(new_n82_));
  nor2   g40(.a(x15), .b(x14), .O(new_n83_));
