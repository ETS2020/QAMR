// Benchmark "FAU" written by ABC on Tue Jul  7 10:56:35 2020
...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_,
    ...
    new_n64_, new_n68_, new_n69_, new_n70_, new_n74_, new_n75_, new_n77_,
    new_n79_, new_n83_, new_n84_;
  ...
  inv1   g29(.a(x14), .O(new_n74_));
  inv1   g30(.a(x22), .O(new_n75_));
  nor3   g31(.a(x24), .b(new_n75_), .c(new_n74_), .O(z10));
  inv1   g32(.a(x17), .O(new_n77_));
  nor3   g33(.a(x24), .b(new_n75_), .c(new_n77_), .O(z11));
  inv1   g34(.a(x23), .O(new_n79_));
  nor3   g35(.a(x24), .b(new_n79_), .c(new_n74_), .O(z12));
  nor3   g36(.a(x24), .b(new_n79_), .c(new_n77_), .O(z13));
