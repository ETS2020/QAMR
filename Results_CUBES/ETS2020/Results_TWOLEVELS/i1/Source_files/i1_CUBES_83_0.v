...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_,
    ...
    new_n64_, new_n68_, new_n69_, new_n70_, new_n78_, new_n80_, new_n82_,
    new_n83_;
  ...
  nand2  g29(.a(x23), .b(x17), .O(new_n78_));
  nor2   g30(.a(new_n78_), .b(x24), .O(z13));
  inv1   g31(.a(x16), .O(new_n80_));
  nor2   g32(.a(x24), .b(new_n80_), .O(z14));
