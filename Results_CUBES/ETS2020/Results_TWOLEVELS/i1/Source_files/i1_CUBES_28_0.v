...
module FAU ( 
  ...
  wire new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n65_, new_n68_, new_n69_, new_n70_, new_n75_, new_n81_, new_n82_;
  ...
  nor2   g31(.a(x13), .b(x12), .O(new_n81_));
  nor2   g32(.a(x15), .b(x14), .O(new_n82_));
  nand2  g33(.a(new_n82_), .b(new_n81_), .O(z15));
  zero   g34(.O(z00));
  zero   g35(.O(z04));
  zero   g36(.O(z07));
  zero   g37(.O(z08));
