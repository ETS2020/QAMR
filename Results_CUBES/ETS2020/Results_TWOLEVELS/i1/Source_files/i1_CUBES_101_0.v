// Benchmark "FAU" written by ABC on Tue Jul  7 10:56:24 2020
...
module FAU ( 
  ...
  nor2   g35(.a(x13), .b(x12), .O(new_n84_));
  nor2   g36(.a(x15), .b(x14), .O(new_n85_));
  nand2  g37(.a(new_n85_), .b(new_n84_), .O(z15));
  zero   g38(.O(z00));
  zero   g39(.O(z03));
  zero   g40(.O(z04));
  zero   g41(.O(z07));
