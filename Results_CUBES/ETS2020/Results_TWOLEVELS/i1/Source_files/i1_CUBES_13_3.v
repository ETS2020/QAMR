// Benchmark "FAU" written by ABC on Tue Jul  7 10:56:00 2020
...
module FAU ( 
  ...
  wire new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n65_, new_n68_, new_n69_, new_n70_, new_n74_, new_n75_, new_n77_,
  ...
  inv1   g31(.a(x14), .O(new_n74_));
  inv1   g32(.a(x22), .O(new_n75_));
  nor3   g33(.a(x24), .b(new_n75_), .c(new_n74_), .O(z10));
  inv1   g34(.a(x17), .O(new_n77_));
  nor3   g35(.a(x24), .b(new_n75_), .c(new_n77_), .O(z11));
  inv1   g36(.a(x23), .O(new_n79_));
  nor3   g37(.a(x24), .b(new_n79_), .c(new_n74_), .O(z12));
  nor3   g38(.a(x24), .b(new_n79_), .c(new_n77_), .O(z13));
  inv1   g39(.a(x16), .O(new_n82_));
  nor2   g40(.a(x24), .b(new_n82_), .O(z14));
  nor2   g41(.a(x13), .b(x12), .O(new_n84_));
  nor2   g42(.a(x15), .b(x14), .O(new_n85_));
  nand2  g43(.a(new_n85_), .b(new_n84_), .O(z15));
  zero   g44(.O(z00));
  buf    g45(.a(x20), .O(z03));
  buf    g46(.a(x19), .O(z06));
  buf    g47(.a(x11), .O(z08));
