// Benchmark "FAU" written by ABC on Tue Jul  7 10:56:02 2020
...
module FAU ( 
  ...
  nor2   g12(.a(x24), .b(new_n58_), .O(z14));
  nor2   g13(.a(x13), .b(x12), .O(new_n60_));
  nor2   g14(.a(x15), .b(x14), .O(new_n61_));
  nand2  g15(.a(new_n61_), .b(new_n60_), .O(z15));
  zero   g16(.O(z00));
  zero   g17(.O(z01));
  zero   g18(.O(z02));
  zero   g19(.O(z05));
