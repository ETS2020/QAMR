// Benchmark "FAU" written by ABC on Tue Jul  7 10:56:44 2020
...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_,
    ...
    new_n64_, new_n67_, new_n68_, new_n69_, new_n73_, new_n75_, new_n78_,
  ...
  nand2  g30(.a(x22), .b(x14), .O(new_n73_));
  nor2   g31(.a(new_n73_), .b(x24), .O(z10));
  nand2  g32(.a(x22), .b(x17), .O(new_n75_));
  nor2   g33(.a(new_n75_), .b(x24), .O(z11));
  nand2  g34(.a(x23), .b(x17), .O(new_n78_));
  nor2   g35(.a(new_n78_), .b(x24), .O(z13));
  inv1   g36(.a(x16), .O(new_n80_));
  nor2   g37(.a(x24), .b(new_n80_), .O(z14));
  nor2   g38(.a(x13), .b(x12), .O(new_n82_));
  nor2   g39(.a(x15), .b(x14), .O(new_n83_));
  nand2  g40(.a(new_n83_), .b(new_n82_), .O(z15));
  zero   g41(.O(z07));
  zero   g42(.O(z12));
  buf    g43(.a(x00), .O(z00));
  buf    g44(.a(x20), .O(z03));
