...
module FAU ( 
  ...
  inv1   g30(.a(x14), .O(new_n73_));
  inv1   g31(.a(x22), .O(new_n74_));
  nor3   g32(.a(x24), .b(new_n74_), .c(new_n73_), .O(z10));
  inv1   g33(.a(x17), .O(new_n76_));
  nor3   g34(.a(x24), .b(new_n74_), .c(new_n76_), .O(z11));
  inv1   g35(.a(x23), .O(new_n78_));
  nor3   g36(.a(x24), .b(new_n78_), .c(new_n73_), .O(z12));
  nor3   g37(.a(x24), .b(new_n78_), .c(new_n76_), .O(z13));
  inv1   g38(.a(x16), .O(new_n81_));
  nor2   g39(.a(x24), .b(new_n81_), .O(z14));
  nor2   g40(.a(x13), .b(x12), .O(new_n83_));
  nor2   g41(.a(x15), .b(x14), .O(new_n84_));
  nand2  g42(.a(new_n84_), .b(new_n83_), .O(z15));
  zero   g43(.O(z07));
  buf    g44(.a(x00), .O(z00));
  buf    g45(.a(x20), .O(z03));
  buf    g46(.a(x19), .O(z06));
