// Benchmark "FAU" written by ABC on Thu Jul  9 20:39:22 2020
...
module FAU ( 
  ...
  nand3  g060(.a(x19), .b(x18), .c(x17), .O(new_n108_));
  inv1   g061(.a(new_n108_), .O(new_n109_));
  nand3  g062(.a(new_n109_), .b(new_n107_), .c(x11), .O(new_n110_));
  aoi21  g063(.a(new_n110_), .b(new_n106_), .c(new_n97_), .O(new_n111_));
  nand3  g064(.a(x16), .b(new_n97_), .c(x10), .O(new_n112_));
  nor2   g065(.a(new_n112_), .b(new_n108_), .O(new_n113_));
  inv1   g066(.a(x31), .O(new_n114_));
  nor2   g067(.a(x32), .b(new_n114_), .O(new_n115_));
  oai21  g068(.a(new_n113_), .b(new_n111_), .c(new_n115_), .O(new_n116_));
  nand2  g069(.a(x32), .b(new_n96_), .O(new_n117_));
  oai21  g070(.a(new_n116_), .b(new_n96_), .c(new_n117_), .O(new_n118_));
  nand2  g071(.a(new_n118_), .b(new_n95_), .O(new_n119_));
  inv1   g072(.a(new_n95_), .O(new_n120_));
  nand2  g073(.a(x32), .b(x30), .O(new_n121_));
  oai21  g074(.a(new_n116_), .b(x30), .c(new_n121_), .O(new_n122_));
  nand2  g075(.a(x16), .b(x10), .O(new_n123_));
  oai21  g076(.a(new_n123_), .b(new_n108_), .c(new_n97_), .O(new_n124_));
  nand2  g077(.a(x19), .b(x18), .O(new_n125_));
  nand2  g078(.a(x17), .b(x11), .O(new_n126_));
  oai21  g079(.a(new_n126_), .b(new_n125_), .c(new_n107_), .O(new_n127_));
  nand2  g080(.a(x19), .b(x13), .O(new_n128_));
  nand2  g081(.a(new_n128_), .b(new_n99_), .O(new_n129_));
  inv1   g082(.a(x14), .O(new_n130_));
  nand2  g083(.a(new_n101_), .b(new_n130_), .O(new_n131_));
  nand4  g084(.a(new_n131_), .b(new_n129_), .c(new_n127_), .d(x31), .O(new_n132_));
  inv1   g085(.a(x12), .O(new_n133_));
  oai21  g086(.a(new_n125_), .b(new_n133_), .c(new_n98_), .O(new_n134_));
  nand3  g087(.a(new_n109_), .b(x16), .c(x15), .O(new_n135_));
  nand2  g088(.a(new_n135_), .b(new_n134_), .O(new_n136_));
  nor2   g089(.a(new_n136_), .b(new_n132_), .O(new_n137_));
  aoi21  g090(.a(new_n137_), .b(new_n124_), .c(z0), .O(new_n138_));
  aoi21  g091(.a(new_n122_), .b(new_n120_), .c(new_n138_), .O(new_n139_));
  nand2  g092(.a(new_n85_), .b(x00), .O(new_n140_));
  aoi21  g093(.a(new_n139_), .b(new_n119_), .c(new_n140_), .O(z8));
  inv1   g094(.a(x33), .O(new_n142_));
  oai21  g095(.a(new_n113_), .b(new_n111_), .c(new_n142_), .O(new_n143_));
  nand2  g096(.a(new_n114_), .b(new_n96_), .O(new_n144_));
  oai22  g097(.a(new_n144_), .b(new_n143_), .c(new_n142_), .d(new_n96_), .O(new_n145_));
  nand2  g098(.a(new_n145_), .b(new_n95_), .O(new_n146_));
  nand2  g099(.a(x31), .b(x30), .O(new_n147_));
  nand2  g100(.a(x33), .b(new_n114_), .O(new_n148_));
  oai21  g101(.a(new_n147_), .b(new_n143_), .c(new_n148_), .O(new_n149_));
  nand2  g102(.a(x31), .b(new_n96_), .O(new_n150_));
  nand4  g103(.a(new_n150_), .b(new_n131_), .c(new_n129_), .d(new_n127_), .O(new_n151_));
  nor2   g104(.a(new_n151_), .b(new_n136_), .O(new_n152_));
  aoi21  g105(.a(new_n152_), .b(new_n124_), .c(new_n142_), .O(new_n153_));
  aoi21  g106(.a(new_n149_), .b(new_n120_), .c(new_n153_), .O(new_n154_));
  aoi21  g107(.a(new_n154_), .b(new_n146_), .c(new_n140_), .O(z9));
  zero   g108(.O(z1));
  zero   g109(.O(z6));
  zero   g110(.O(z7));
endmodule
