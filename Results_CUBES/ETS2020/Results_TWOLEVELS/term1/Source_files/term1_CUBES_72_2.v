...
module FAU ( 
  ...
  aoi21  g050(.a(new_n91_), .b(x29), .c(new_n96_), .O(new_n97_));
  nand3  g051(.a(new_n91_), .b(new_n96_), .c(x29), .O(new_n98_));
  inv1   g052(.a(new_n98_), .O(new_n99_));
  nor2   g053(.a(new_n94_), .b(new_n83_), .O(new_n100_));
  oai21  g054(.a(new_n99_), .b(new_n97_), .c(new_n100_), .O(new_n101_));
  inv1   g055(.a(new_n101_), .O(z6));
  inv1   g056(.a(x31), .O(new_n103_));
  nand4  g057(.a(new_n91_), .b(new_n103_), .c(x30), .d(x29), .O(new_n104_));
  nand3  g058(.a(new_n91_), .b(x30), .c(x29), .O(new_n105_));
  aoi21  g059(.a(new_n105_), .b(x31), .c(new_n94_), .O(new_n106_));
  nand3  g060(.a(new_n106_), .b(new_n104_), .c(new_n82_), .O(z7));
  aoi21  g061(.a(new_n90_), .b(new_n89_), .c(new_n88_), .O(new_n108_));
  ...
  nand3  g074(.a(x19), .b(x18), .c(x17), .O(new_n121_));
  inv1   g075(.a(new_n121_), .O(new_n122_));
  nand3  g076(.a(new_n122_), .b(new_n120_), .c(x11), .O(new_n123_));
  aoi21  g077(.a(new_n123_), .b(new_n119_), .c(new_n110_), .O(new_n124_));
  nand3  g078(.a(x16), .b(new_n110_), .c(x10), .O(new_n125_));
  nor2   g079(.a(new_n125_), .b(new_n121_), .O(new_n126_));
  nor2   g080(.a(x32), .b(new_n103_), .O(new_n127_));
  oai21  g081(.a(new_n126_), .b(new_n124_), .c(new_n127_), .O(new_n128_));
  nand2  g082(.a(x32), .b(new_n96_), .O(new_n129_));
  oai21  g083(.a(new_n128_), .b(new_n96_), .c(new_n129_), .O(new_n130_));
  ...
  inv1   g087(.a(x32), .O(new_n134_));
  nand2  g088(.a(x16), .b(x10), .O(new_n135_));
  oai21  g089(.a(new_n135_), .b(new_n121_), .c(new_n110_), .O(new_n136_));
  nand4  g090(.a(x19), .b(x18), .c(x17), .d(x11), .O(new_n137_));
  and2   g091(.a(new_n137_), .b(new_n120_), .O(new_n138_));
  aoi21  g092(.a(x19), .b(x13), .c(x18), .O(new_n139_));
  oai21  g093(.a(x19), .b(x14), .c(x31), .O(new_n140_));
  nand3  g094(.a(x19), .b(x18), .c(x12), .O(new_n141_));
  nand2  g095(.a(new_n141_), .b(new_n111_), .O(new_n142_));
  nand2  g096(.a(x16), .b(x15), .O(new_n143_));
  oai21  g097(.a(new_n143_), .b(new_n121_), .c(new_n142_), .O(new_n144_));
  nor4   g098(.a(new_n144_), .b(new_n140_), .c(new_n139_), .d(new_n138_), .O(new_n145_));
  aoi21  g099(.a(new_n145_), .b(new_n136_), .c(new_n134_), .O(new_n146_));
  aoi21  g100(.a(new_n133_), .b(new_n108_), .c(new_n146_), .O(new_n147_));
  nand2  g101(.a(new_n93_), .b(x00), .O(new_n148_));
  aoi21  g102(.a(new_n147_), .b(new_n131_), .c(new_n148_), .O(z8));
  zero   g103(.O(z0));
  zero   g104(.O(z4));
  zero   g105(.O(z9));
endmodule
