// Benchmark "FAU" written by ABC on Thu Jul  9 20:47:27 2020
...
module FAU ( 
  ...
  and2   g048(.a(x28), .b(x27), .O(new_n94_));
  nand2  g049(.a(new_n94_), .b(x29), .O(new_n95_));
  inv1   g050(.a(new_n95_), .O(new_n96_));
  nand3  g051(.a(new_n94_), .b(new_n93_), .c(x29), .O(new_n97_));
  oai21  g052(.a(new_n96_), .b(new_n93_), .c(new_n97_), .O(new_n98_));
  ...
  nand3  g058(.a(new_n96_), .b(new_n103_), .c(x30), .O(new_n104_));
  nand3  g059(.a(new_n94_), .b(x30), .c(x29), .O(new_n105_));
  nand2  g060(.a(new_n105_), .b(x31), .O(new_n106_));
  nand4  g061(.a(new_n106_), .b(new_n104_), .c(new_n100_), .d(new_n92_), .O(z7));
  oai21  g062(.a(x28), .b(x27), .c(x29), .O(new_n108_));
  ...
  nor2   g080(.a(x32), .b(new_n103_), .O(new_n126_));
  oai21  g081(.a(new_n125_), .b(new_n123_), .c(new_n126_), .O(new_n127_));
  nand2  g082(.a(x32), .b(new_n93_), .O(new_n128_));
  oai21  g083(.a(new_n127_), .b(new_n93_), .c(new_n128_), .O(new_n129_));
  nand2  g084(.a(new_n129_), .b(new_n108_), .O(new_n130_));
  inv1   g085(.a(new_n108_), .O(new_n131_));
  nand2  g086(.a(x32), .b(x30), .O(new_n132_));
  oai21  g087(.a(new_n127_), .b(x30), .c(new_n132_), .O(new_n133_));
  nand2  g088(.a(x16), .b(x10), .O(new_n134_));
  oai21  g089(.a(new_n134_), .b(new_n120_), .c(new_n109_), .O(new_n135_));
  nand2  g090(.a(x19), .b(x18), .O(new_n136_));
  nand2  g091(.a(x17), .b(x11), .O(new_n137_));
  oai21  g092(.a(new_n137_), .b(new_n136_), .c(new_n119_), .O(new_n138_));
  inv1   g093(.a(x13), .O(new_n139_));
  oai21  g094(.a(new_n113_), .b(new_n139_), .c(new_n111_), .O(new_n140_));
  inv1   g095(.a(x14), .O(new_n141_));
  aoi21  g096(.a(new_n113_), .b(new_n141_), .c(new_n103_), .O(new_n142_));
  nand3  g097(.a(new_n142_), .b(new_n140_), .c(new_n138_), .O(new_n143_));
  inv1   g098(.a(x12), .O(new_n144_));
  oai21  g099(.a(new_n136_), .b(new_n144_), .c(new_n110_), .O(new_n145_));
  nand3  g100(.a(new_n121_), .b(x16), .c(x15), .O(new_n146_));
  ...
  aoi21  g104(.a(new_n133_), .b(new_n131_), .c(new_n149_), .O(new_n150_));
  nand2  g105(.a(new_n86_), .b(x00), .O(new_n151_));
  aoi21  g106(.a(new_n150_), .b(new_n130_), .c(new_n151_), .O(z8));
  inv1   g107(.a(x33), .O(new_n153_));
  oai21  g108(.a(new_n125_), .b(new_n123_), .c(new_n153_), .O(new_n154_));
  nand2  g109(.a(new_n103_), .b(new_n93_), .O(new_n155_));
  oai22  g110(.a(new_n155_), .b(new_n154_), .c(new_n153_), .d(new_n103_), .O(new_n156_));
  nand2  g111(.a(new_n156_), .b(new_n108_), .O(new_n157_));
  ...
  oai21  g116(.a(new_n111_), .b(new_n144_), .c(new_n110_), .O(new_n162_));
  nand2  g117(.a(x31), .b(new_n93_), .O(new_n163_));
  nand2  g118(.a(new_n111_), .b(new_n139_), .O(new_n164_));
  nand4  g119(.a(new_n164_), .b(new_n163_), .c(new_n162_), .d(new_n161_), .O(new_n165_));
  inv1   g120(.a(new_n165_), .O(new_n166_));
  nor2   g121(.a(new_n111_), .b(new_n110_), .O(new_n167_));
  ...
  nand2  g125(.a(new_n168_), .b(new_n113_), .O(new_n171_));
  inv1   g126(.a(new_n167_), .O(new_n172_));
  oai21  g127(.a(new_n172_), .b(new_n134_), .c(new_n109_), .O(new_n173_));
  nand2  g128(.a(new_n167_), .b(x11), .O(new_n174_));
  nand2  g129(.a(new_n174_), .b(new_n119_), .O(new_n175_));
  ...
  aoi21  g133(.a(new_n160_), .b(new_n131_), .c(new_n178_), .O(new_n179_));
