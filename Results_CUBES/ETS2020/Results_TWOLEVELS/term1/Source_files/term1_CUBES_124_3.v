// Benchmark "FAU" written by ABC on Thu Jul  9 20:46:03 2020
...
module FAU ( 
  ...
  aoi21  g053(.a(new_n94_), .b(x29), .c(new_n98_), .O(new_n99_));
  nand3  g054(.a(new_n94_), .b(new_n98_), .c(x29), .O(new_n100_));
  inv1   g055(.a(new_n100_), .O(new_n101_));
  nor2   g056(.a(new_n96_), .b(new_n80_), .O(new_n102_));
  oai21  g057(.a(new_n101_), .b(new_n99_), .c(new_n102_), .O(new_n103_));
  inv1   g058(.a(new_n103_), .O(z6));
  inv1   g059(.a(x31), .O(new_n105_));
  nand4  g060(.a(new_n94_), .b(new_n105_), .c(x30), .d(x29), .O(new_n106_));
  nand3  g061(.a(new_n94_), .b(x30), .c(x29), .O(new_n107_));
  aoi21  g062(.a(new_n107_), .b(x31), .c(new_n96_), .O(new_n108_));
  nand3  g063(.a(new_n108_), .b(new_n106_), .c(new_n81_), .O(z7));
  aoi21  g064(.a(new_n93_), .b(new_n92_), .c(new_n91_), .O(new_n110_));
  inv1   g065(.a(new_n110_), .O(new_n111_));
  inv1   g066(.a(x15), .O(new_n112_));
  inv1   g067(.a(x17), .O(new_n113_));
  ...
  aoi21  g072(.a(new_n117_), .b(new_n115_), .c(new_n113_), .O(new_n118_));
  nand4  g073(.a(x19), .b(x18), .c(new_n113_), .d(x12), .O(new_n119_));
  ...
  nand3  g079(.a(new_n124_), .b(new_n122_), .c(x11), .O(new_n125_));
  aoi21  g080(.a(new_n125_), .b(new_n121_), .c(new_n112_), .O(new_n126_));
  nand3  g081(.a(x16), .b(new_n112_), .c(x10), .O(new_n127_));
  nor2   g082(.a(new_n127_), .b(new_n123_), .O(new_n128_));
  nor2   g083(.a(x32), .b(new_n105_), .O(new_n129_));
  oai21  g084(.a(new_n128_), .b(new_n126_), .c(new_n129_), .O(new_n130_));
  nand2  g085(.a(x32), .b(new_n98_), .O(new_n131_));
  oai21  g086(.a(new_n130_), .b(new_n98_), .c(new_n131_), .O(new_n132_));
  nand2  g087(.a(new_n132_), .b(new_n111_), .O(new_n133_));
  nand2  g088(.a(x32), .b(x30), .O(new_n134_));
  oai21  g089(.a(new_n130_), .b(x30), .c(new_n134_), .O(new_n135_));
  inv1   g090(.a(x32), .O(new_n136_));
  nand2  g091(.a(x16), .b(x10), .O(new_n137_));
  oai21  g092(.a(new_n137_), .b(new_n123_), .c(new_n112_), .O(new_n138_));
  nand4  g093(.a(x19), .b(x18), .c(x17), .d(x11), .O(new_n139_));
  and2   g094(.a(new_n139_), .b(new_n122_), .O(new_n140_));
  aoi21  g095(.a(x19), .b(x13), .c(x18), .O(new_n141_));
  oai21  g096(.a(x19), .b(x14), .c(x31), .O(new_n142_));
  nand3  g097(.a(x19), .b(x18), .c(x12), .O(new_n143_));
  nand2  g098(.a(new_n143_), .b(new_n113_), .O(new_n144_));
  nand2  g099(.a(x16), .b(x15), .O(new_n145_));
  oai21  g100(.a(new_n145_), .b(new_n123_), .c(new_n144_), .O(new_n146_));
  nor4   g101(.a(new_n146_), .b(new_n142_), .c(new_n141_), .d(new_n140_), .O(new_n147_));
  aoi21  g102(.a(new_n147_), .b(new_n138_), .c(new_n136_), .O(new_n148_));
  aoi21  g103(.a(new_n135_), .b(new_n110_), .c(new_n148_), .O(new_n149_));
  inv1   g104(.a(x26), .O(new_n150_));
  nand2  g105(.a(new_n150_), .b(x00), .O(new_n151_));
  aoi21  g106(.a(new_n149_), .b(new_n133_), .c(new_n151_), .O(z8));
  zero   g107(.O(z0));
  zero   g108(.O(z9));
endmodule
