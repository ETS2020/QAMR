// Benchmark "FAU" written by ABC on Mon Jul  6 19:21:55 2020
...
module FAU ( 
  ...
  nand2  g38(.a(x29), .b(new_n101_), .O(new_n128_));
  ...
  nor2   g69(.a(x14), .b(new_n134_), .O(new_n162_));
  nand2  g70(.a(new_n162_), .b(x41), .O(new_n163_));
  aoi21  g71(.a(new_n163_), .b(new_n161_), .c(x10), .O(z29));
  nand2  g72(.a(new_n160_), .b(x42), .O(new_n166_));
  nand2  g73(.a(new_n162_), .b(x43), .O(new_n167_));
  aoi21  g74(.a(new_n167_), .b(new_n166_), .c(x10), .O(z31));
  nand2  g75(.a(new_n160_), .b(x43), .O(new_n169_));
  nand2  g76(.a(new_n162_), .b(x44), .O(new_n170_));
  aoi21  g77(.a(new_n170_), .b(new_n169_), .c(x10), .O(z32));
  nand2  g78(.a(new_n160_), .b(x44), .O(new_n172_));
  nand2  g79(.a(new_n162_), .b(x45), .O(new_n173_));
  aoi21  g80(.a(new_n173_), .b(new_n172_), .c(x10), .O(z33));
  nand2  g81(.a(new_n160_), .b(x45), .O(new_n175_));
  nand2  g82(.a(new_n162_), .b(x46), .O(new_n176_));
