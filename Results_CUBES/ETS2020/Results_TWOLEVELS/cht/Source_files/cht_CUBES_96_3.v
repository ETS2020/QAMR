...
module FAU ( 
  ...
  wire new_n85_, new_n86_, new_n87_, new_n89_, new_n90_, new_n92_, new_n93_,
    ...
    new_n133_, new_n137_, new_n138_, new_n139_, new_n141_, new_n142_,
  ...
  nand2  g070(.a(x38), .b(new_n137_), .O(new_n160_));
  ...
  nor2   g075(.a(x14), .b(new_n137_), .O(new_n165_));
