...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n89_, new_n90_, new_n93_, new_n94_,
    ...
    new_n126_, new_n128_, new_n129_, new_n131_, new_n132_, new_n137_,
  ...
  nand2  g17(.a(x21), .b(new_n101_), .O(new_n106_));
  nand2  g18(.a(x22), .b(x08), .O(new_n107_));
  aoi21  g19(.a(new_n107_), .b(new_n106_), .c(x10), .O(z10));
  nand2  g20(.a(x23), .b(new_n101_), .O(new_n110_));
