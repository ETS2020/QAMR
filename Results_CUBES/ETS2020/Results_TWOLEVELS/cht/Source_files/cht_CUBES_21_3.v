...
module FAU ( 
  ...
  nand2  g70(.a(x38), .b(new_n137_), .O(new_n160_));
  ...
  nor2   g75(.a(x14), .b(new_n137_), .O(new_n165_));
  ...
  nand2  g81(.a(new_n163_), .b(x41), .O(new_n171_));
  nand2  g82(.a(new_n165_), .b(x42), .O(new_n172_));
  aoi21  g83(.a(new_n172_), .b(new_n171_), .c(x10), .O(z30));
  nand2  g84(.a(new_n163_), .b(x44), .O(new_n176_));
  nand2  g85(.a(new_n165_), .b(x45), .O(new_n177_));
