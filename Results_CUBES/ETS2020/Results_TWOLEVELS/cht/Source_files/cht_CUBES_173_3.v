// Benchmark "FAU" written by ABC on Mon Jul  6 19:23:27 2020
...
module FAU ( 
  ...
  nand2  g051(.a(x30), .b(new_n101_), .O(new_n138_));
  ...
  nor2   g078(.a(x14), .b(new_n141_), .O(new_n168_));
  ...
  nand2  g084(.a(new_n166_), .b(x43), .O(new_n175_));
  nand2  g085(.a(new_n168_), .b(x44), .O(new_n176_));
  aoi21  g086(.a(new_n176_), .b(new_n175_), .c(x10), .O(z32));
  nand2  g087(.a(new_n166_), .b(x44), .O(new_n178_));
  nand2  g088(.a(new_n168_), .b(x45), .O(new_n179_));
  aoi21  g089(.a(new_n179_), .b(new_n178_), .c(x10), .O(z33));
  nand2  g090(.a(new_n166_), .b(x45), .O(new_n181_));
  nand2  g091(.a(new_n168_), .b(x46), .O(new_n182_));
  aoi21  g092(.a(new_n182_), .b(new_n181_), .c(x10), .O(z34));
  nand2  g093(.a(new_n166_), .b(x46), .O(new_n184_));
  nand2  g094(.a(new_n168_), .b(x00), .O(new_n185_));
