...
module FAU ( 
  ...
  nor2   g66(.a(x14), .b(new_n130_), .O(new_n160_));
  nand2  g67(.a(new_n160_), .b(x41), .O(new_n161_));
  aoi21  g68(.a(new_n161_), .b(new_n159_), .c(x10), .O(z29));
  nand2  g69(.a(new_n158_), .b(x43), .O(new_n165_));
  nand2  g70(.a(new_n160_), .b(x44), .O(new_n166_));
  aoi21  g71(.a(new_n166_), .b(new_n165_), .c(x10), .O(z32));
  nand2  g72(.a(new_n158_), .b(x44), .O(new_n168_));
  nand2  g73(.a(new_n160_), .b(x45), .O(new_n169_));
