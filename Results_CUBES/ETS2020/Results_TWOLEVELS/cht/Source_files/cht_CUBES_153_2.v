...
module FAU ( 
  ...
  inv1   g66(.a(x14), .O(new_n163_));
  nand2  g67(.a(new_n163_), .b(x09), .O(new_n164_));
  nand2  g68(.a(new_n164_), .b(x44), .O(new_n165_));
  nor2   g69(.a(x14), .b(new_n134_), .O(new_n166_));
  nand2  g70(.a(new_n166_), .b(x45), .O(new_n167_));
  aoi21  g71(.a(new_n167_), .b(new_n165_), .c(x10), .O(z33));
  nand2  g72(.a(new_n164_), .b(x45), .O(new_n169_));
  nand2  g73(.a(new_n166_), .b(x46), .O(new_n170_));
