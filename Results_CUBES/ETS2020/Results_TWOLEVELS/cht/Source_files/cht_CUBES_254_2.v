...
module FAU ( 
  ...
  nand2  g60(.a(x33), .b(new_n142_), .O(new_n147_));
  nand2  g61(.a(x34), .b(x09), .O(new_n148_));
  aoi21  g62(.a(new_n148_), .b(new_n147_), .c(x10), .O(z22));
  nand2  g63(.a(x35), .b(new_n142_), .O(new_n151_));
  ...
  inv1   g69(.a(x39), .O(new_n158_));
  nand2  g70(.a(x14), .b(x00), .O(new_n159_));
  oai21  g71(.a(new_n158_), .b(x14), .c(new_n159_), .O(new_n160_));
  nand2  g72(.a(new_n160_), .b(x09), .O(new_n161_));
  nand2  g73(.a(x38), .b(new_n142_), .O(new_n162_));
  aoi21  g74(.a(new_n162_), .b(new_n161_), .c(x10), .O(z27));
  inv1   g75(.a(x14), .O(new_n167_));
  nand2  g76(.a(new_n167_), .b(x09), .O(new_n168_));
  nand2  g77(.a(new_n168_), .b(x42), .O(new_n169_));
  nor2   g78(.a(x14), .b(new_n142_), .O(new_n170_));
  nand2  g79(.a(new_n170_), .b(x43), .O(new_n171_));
  aoi21  g80(.a(new_n171_), .b(new_n169_), .c(x10), .O(z31));
  nand2  g81(.a(new_n168_), .b(x43), .O(new_n173_));
  nand2  g82(.a(new_n170_), .b(x44), .O(new_n174_));
  aoi21  g83(.a(new_n174_), .b(new_n173_), .c(x10), .O(z32));
  nand2  g84(.a(new_n168_), .b(x45), .O(new_n177_));
  nand2  g85(.a(new_n170_), .b(x46), .O(new_n178_));
  aoi21  g86(.a(new_n178_), .b(new_n177_), .c(x10), .O(z34));
  nand2  g87(.a(new_n168_), .b(x46), .O(new_n180_));
  nand2  g88(.a(new_n170_), .b(x00), .O(new_n181_));
