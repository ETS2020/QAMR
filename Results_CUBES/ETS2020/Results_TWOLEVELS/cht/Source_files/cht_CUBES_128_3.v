// Benchmark "FAU" written by ABC on Mon Jul  6 19:23:04 2020
...
module FAU ( 
  ...
  inv1   g056(.a(x09), .O(new_n143_));
  nand2  g057(.a(x32), .b(new_n143_), .O(new_n144_));
  nand2  g058(.a(x33), .b(x09), .O(new_n145_));
  aoi21  g059(.a(new_n145_), .b(new_n144_), .c(x10), .O(z21));
  nand2  g060(.a(x34), .b(new_n143_), .O(new_n148_));
  nand2  g061(.a(x35), .b(x09), .O(new_n149_));
  aoi21  g062(.a(new_n149_), .b(new_n148_), .c(x10), .O(z23));
  nand2  g063(.a(x35), .b(new_n143_), .O(new_n151_));
  nand2  g064(.a(x36), .b(x09), .O(new_n152_));
  aoi21  g065(.a(new_n152_), .b(new_n151_), .c(x10), .O(z24));
  nand2  g066(.a(x36), .b(new_n143_), .O(new_n154_));
  nand2  g067(.a(x37), .b(x09), .O(new_n155_));
  aoi21  g068(.a(new_n155_), .b(new_n154_), .c(x10), .O(z25));
  nand2  g069(.a(x37), .b(new_n143_), .O(new_n157_));
  nand2  g070(.a(x38), .b(x09), .O(new_n158_));
  aoi21  g071(.a(new_n158_), .b(new_n157_), .c(x10), .O(z26));
  oai21  g072(.a(x14), .b(new_n143_), .c(x39), .O(new_n161_));
  inv1   g073(.a(x14), .O(new_n162_));
  nand3  g074(.a(x40), .b(new_n162_), .c(x09), .O(new_n163_));
  aoi21  g075(.a(new_n163_), .b(new_n161_), .c(x10), .O(z28));
  oai21  g076(.a(x14), .b(new_n143_), .c(x40), .O(new_n165_));
  nand3  g077(.a(x41), .b(new_n162_), .c(x09), .O(new_n166_));
  aoi21  g078(.a(new_n166_), .b(new_n165_), .c(x10), .O(z29));
  oai21  g079(.a(x14), .b(new_n143_), .c(x41), .O(new_n168_));
  nand3  g080(.a(x42), .b(new_n162_), .c(x09), .O(new_n169_));
  aoi21  g081(.a(new_n169_), .b(new_n168_), .c(x10), .O(z30));
  oai21  g082(.a(x14), .b(new_n143_), .c(x42), .O(new_n171_));
  nand3  g083(.a(x43), .b(new_n162_), .c(x09), .O(new_n172_));
  aoi21  g084(.a(new_n172_), .b(new_n171_), .c(x10), .O(z31));
  oai21  g085(.a(x14), .b(new_n143_), .c(x43), .O(new_n174_));
  nand3  g086(.a(x44), .b(new_n162_), .c(x09), .O(new_n175_));
  aoi21  g087(.a(new_n175_), .b(new_n174_), .c(x10), .O(z32));
  oai21  g088(.a(x14), .b(new_n143_), .c(x44), .O(new_n177_));
  nand3  g089(.a(x45), .b(new_n162_), .c(x09), .O(new_n178_));
  aoi21  g090(.a(new_n178_), .b(new_n177_), .c(x10), .O(z33));
  oai21  g091(.a(x14), .b(new_n143_), .c(x45), .O(new_n180_));
  nand3  g092(.a(x46), .b(new_n162_), .c(x09), .O(new_n181_));
  aoi21  g093(.a(new_n181_), .b(new_n180_), .c(x10), .O(z34));
  oai21  g094(.a(x14), .b(new_n143_), .c(x46), .O(new_n183_));
  nand3  g095(.a(new_n162_), .b(x09), .c(x00), .O(new_n184_));
  aoi21  g096(.a(new_n184_), .b(new_n183_), .c(x10), .O(z35));
  zero   g097(.O(z10));
  zero   g098(.O(z11));
  zero   g099(.O(z20));
  zero   g100(.O(z22));
