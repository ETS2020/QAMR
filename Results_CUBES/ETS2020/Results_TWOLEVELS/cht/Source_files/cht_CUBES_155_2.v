...
module FAU ( 
  ...
  nor2   g081(.a(x14), .b(new_n141_), .O(new_n170_));
  ...
  nand2  g090(.a(new_n168_), .b(x44), .O(new_n180_));
  nand2  g091(.a(new_n170_), .b(x45), .O(new_n181_));
