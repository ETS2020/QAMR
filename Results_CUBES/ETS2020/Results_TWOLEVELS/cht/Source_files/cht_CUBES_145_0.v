...
module FAU ( 
  ...
  nand2  g20(.a(x21), .b(new_n102_), .O(new_n108_));
  nand2  g21(.a(x22), .b(x08), .O(new_n109_));
  aoi21  g22(.a(new_n109_), .b(new_n108_), .c(x10), .O(z10));
  nand2  g23(.a(x22), .b(new_n102_), .O(new_n111_));
  ...
  oai21  g70(.a(x14), .b(new_n136_), .c(x41), .O(new_n162_));
  ...
  oai21  g82(.a(x14), .b(new_n136_), .c(x45), .O(new_n174_));
