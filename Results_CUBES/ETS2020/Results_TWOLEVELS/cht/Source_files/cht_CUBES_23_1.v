// Benchmark "FAU" written by ABC on Mon Jul  6 19:22:02 2020
...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n89_, new_n90_, new_n92_, new_n93_,
    ...
    new_n106_, new_n111_, new_n112_, new_n114_, new_n115_, new_n117_,
  ...
  nand2  g42(.a(x33), .b(new_n130_), .O(new_n135_));
  nand2  g43(.a(x34), .b(x09), .O(new_n136_));
  aoi21  g44(.a(new_n136_), .b(new_n135_), .c(x10), .O(z22));
  nand2  g45(.a(x37), .b(new_n130_), .O(new_n141_));
  ...
  nand2  g52(.a(x38), .b(new_n130_), .O(new_n148_));
  aoi21  g53(.a(new_n148_), .b(new_n147_), .c(x10), .O(z27));
  inv1   g54(.a(x14), .O(new_n151_));
  nand2  g55(.a(new_n151_), .b(x09), .O(new_n152_));
  nand2  g56(.a(new_n152_), .b(x40), .O(new_n153_));
  nor2   g57(.a(x14), .b(new_n130_), .O(new_n154_));
  nand2  g58(.a(new_n154_), .b(x41), .O(new_n155_));
  aoi21  g59(.a(new_n155_), .b(new_n153_), .c(x10), .O(z29));
  nand2  g60(.a(new_n152_), .b(x41), .O(new_n157_));
  nand2  g61(.a(new_n154_), .b(x42), .O(new_n158_));
  aoi21  g62(.a(new_n158_), .b(new_n157_), .c(x10), .O(z30));
  nand2  g63(.a(new_n152_), .b(x42), .O(new_n160_));
  nand2  g64(.a(new_n154_), .b(x43), .O(new_n161_));
  aoi21  g65(.a(new_n161_), .b(new_n160_), .c(x10), .O(z31));
  nand2  g66(.a(new_n152_), .b(x43), .O(new_n163_));
  nand2  g67(.a(new_n154_), .b(x44), .O(new_n164_));
  aoi21  g68(.a(new_n164_), .b(new_n163_), .c(x10), .O(z32));
  nand2  g69(.a(new_n152_), .b(x44), .O(new_n166_));
  nand2  g70(.a(new_n154_), .b(x45), .O(new_n167_));
  aoi21  g71(.a(new_n167_), .b(new_n166_), .c(x10), .O(z33));
  nand2  g72(.a(new_n152_), .b(x46), .O(new_n170_));
  nand2  g73(.a(new_n154_), .b(x00), .O(new_n171_));
