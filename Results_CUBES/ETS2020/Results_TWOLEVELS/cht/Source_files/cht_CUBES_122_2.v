...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n88_, new_n89_, new_n94_, new_n95_,
    new_n98_, new_n99_, new_n100_, new_n104_, new_n105_, new_n109_,
    ...
    new_n155_, new_n156_, new_n159_, new_n160_, new_n163_, new_n164_,
  ...
  nand2  g63(.a(new_n153_), .b(x41), .O(new_n159_));
  nand2  g64(.a(new_n155_), .b(x42), .O(new_n160_));
  aoi21  g65(.a(new_n160_), .b(new_n159_), .c(x10), .O(z30));
  nand2  g66(.a(new_n153_), .b(x43), .O(new_n163_));
  nand2  g67(.a(new_n155_), .b(x44), .O(new_n164_));
  aoi21  g68(.a(new_n164_), .b(new_n163_), .c(x10), .O(z32));
  nand2  g69(.a(new_n153_), .b(x44), .O(new_n166_));
  nand2  g70(.a(new_n155_), .b(x45), .O(new_n167_));
  aoi21  g71(.a(new_n167_), .b(new_n166_), .c(x10), .O(z33));
  nand2  g72(.a(new_n153_), .b(x46), .O(new_n170_));
  nand2  g73(.a(new_n155_), .b(x00), .O(new_n171_));
