...
module FAU ( 
  ...
  oai21  g081(.a(x14), .b(new_n144_), .c(x39), .O(new_n167_));
  inv1   g082(.a(x14), .O(new_n168_));
  nand3  g083(.a(x40), .b(new_n168_), .c(x09), .O(new_n169_));
  aoi21  g084(.a(new_n169_), .b(new_n167_), .c(x10), .O(z28));
  oai21  g085(.a(x14), .b(new_n144_), .c(x41), .O(new_n172_));
  nand3  g086(.a(x42), .b(new_n168_), .c(x09), .O(new_n173_));
  aoi21  g087(.a(new_n173_), .b(new_n172_), .c(x10), .O(z30));
  oai21  g088(.a(x14), .b(new_n144_), .c(x42), .O(new_n175_));
  nand3  g089(.a(x43), .b(new_n168_), .c(x09), .O(new_n176_));
  aoi21  g090(.a(new_n176_), .b(new_n175_), .c(x10), .O(z31));
  oai21  g091(.a(x14), .b(new_n144_), .c(x43), .O(new_n178_));
  nand3  g092(.a(x44), .b(new_n168_), .c(x09), .O(new_n179_));
  aoi21  g093(.a(new_n179_), .b(new_n178_), .c(x10), .O(z32));
  oai21  g094(.a(x14), .b(new_n144_), .c(x44), .O(new_n181_));
  nand3  g095(.a(x45), .b(new_n168_), .c(x09), .O(new_n182_));
  aoi21  g096(.a(new_n182_), .b(new_n181_), .c(x10), .O(z33));
  oai21  g097(.a(x14), .b(new_n144_), .c(x45), .O(new_n184_));
  nand3  g098(.a(x46), .b(new_n168_), .c(x09), .O(new_n185_));
  aoi21  g099(.a(new_n185_), .b(new_n184_), .c(x10), .O(z34));
  oai21  g100(.a(x14), .b(new_n144_), .c(x46), .O(new_n187_));
  nand3  g101(.a(new_n168_), .b(x09), .c(x00), .O(new_n188_));
  aoi21  g102(.a(new_n188_), .b(new_n187_), .c(x10), .O(z35));
  zero   g103(.O(z10));
  zero   g104(.O(z27));
  zero   g105(.O(z29));
endmodule
