...
module FAU ( 
  ...
  nor2   g63(.a(x14), .b(new_n133_), .O(new_n159_));
  ...
  nand2  g69(.a(new_n157_), .b(x43), .O(new_n165_));
  nand2  g70(.a(new_n159_), .b(x44), .O(new_n166_));
  aoi21  g71(.a(new_n166_), .b(new_n165_), .c(x10), .O(z32));
  nand2  g72(.a(new_n157_), .b(x44), .O(new_n168_));
  nand2  g73(.a(new_n159_), .b(x45), .O(new_n169_));
  aoi21  g74(.a(new_n169_), .b(new_n168_), .c(x10), .O(z33));
  nand2  g75(.a(new_n157_), .b(x45), .O(new_n171_));
  nand2  g76(.a(new_n159_), .b(x46), .O(new_n172_));
