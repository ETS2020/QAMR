// Benchmark "FAU" written by ABC on Mon Jul  6 19:24:03 2020
...
module FAU ( 
  ...
  oai21  g72(.a(x14), .b(new_n143_), .c(x41), .O(new_n163_));
  inv1   g73(.a(x14), .O(new_n164_));
  nand3  g74(.a(x42), .b(new_n164_), .c(x09), .O(new_n165_));
  aoi21  g75(.a(new_n165_), .b(new_n163_), .c(x10), .O(z30));
  oai21  g76(.a(x14), .b(new_n143_), .c(x42), .O(new_n167_));
  nand3  g77(.a(x43), .b(new_n164_), .c(x09), .O(new_n168_));
  aoi21  g78(.a(new_n168_), .b(new_n167_), .c(x10), .O(z31));
  oai21  g79(.a(x14), .b(new_n143_), .c(x43), .O(new_n170_));
  nand3  g80(.a(x44), .b(new_n164_), .c(x09), .O(new_n171_));
  aoi21  g81(.a(new_n171_), .b(new_n170_), .c(x10), .O(z32));
  oai21  g82(.a(x14), .b(new_n143_), .c(x44), .O(new_n173_));
  nand3  g83(.a(x45), .b(new_n164_), .c(x09), .O(new_n174_));
  aoi21  g84(.a(new_n174_), .b(new_n173_), .c(x10), .O(z33));
  oai21  g85(.a(x14), .b(new_n143_), .c(x46), .O(new_n177_));
  nand3  g86(.a(new_n164_), .b(x09), .c(x00), .O(new_n178_));
