...
module FAU ( 
  ...
  wire new_n85_, new_n86_, new_n87_, new_n89_, new_n90_, new_n92_, new_n93_,
    new_n95_, new_n96_, new_n99_, new_n100_, new_n101_, new_n104_,
  ...
  nand2  g17(.a(x19), .b(new_n99_), .O(new_n104_));
  ...
  oai21  g79(.a(x14), .b(new_n136_), .c(x44), .O(new_n171_));
  nand3  g80(.a(x45), .b(new_n160_), .c(x09), .O(new_n172_));
