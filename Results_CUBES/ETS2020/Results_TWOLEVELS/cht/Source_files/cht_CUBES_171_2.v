// Benchmark "FAU" written by ABC on Mon Jul  6 19:23:26 2020
...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18, z19, z20, z21, z22, z23, z24, z25, z26, z27,
    z28, z29, z30, z31, z32, z33, z34, z35;
  wire new_n87_, new_n88_, new_n89_, new_n91_, new_n92_, new_n94_, new_n95_,
    ...
    new_n136_, new_n137_, new_n141_, new_n142_, new_n144_, new_n145_,
  ...
  nand2  g48(.a(x35), .b(new_n132_), .O(new_n141_));
  nand2  g49(.a(x36), .b(x09), .O(new_n142_));
  aoi21  g50(.a(new_n142_), .b(new_n141_), .c(x10), .O(z24));
  nand2  g51(.a(x36), .b(new_n132_), .O(new_n144_));
  nand2  g52(.a(x37), .b(x09), .O(new_n145_));
  aoi21  g53(.a(new_n145_), .b(new_n144_), .c(x10), .O(z25));
  oai21  g54(.a(x14), .b(new_n132_), .c(x40), .O(new_n150_));
  inv1   g55(.a(x14), .O(new_n151_));
  nand3  g56(.a(x41), .b(new_n151_), .c(x09), .O(new_n152_));
  aoi21  g57(.a(new_n152_), .b(new_n150_), .c(x10), .O(z29));
  oai21  g58(.a(x14), .b(new_n132_), .c(x41), .O(new_n154_));
  nand3  g59(.a(x42), .b(new_n151_), .c(x09), .O(new_n155_));
  aoi21  g60(.a(new_n155_), .b(new_n154_), .c(x10), .O(z30));
  oai21  g61(.a(x14), .b(new_n132_), .c(x44), .O(new_n159_));
  nand3  g62(.a(x45), .b(new_n151_), .c(x09), .O(new_n160_));
  aoi21  g63(.a(new_n160_), .b(new_n159_), .c(x10), .O(z33));
  oai21  g64(.a(x14), .b(new_n132_), .c(x45), .O(new_n162_));
  nand3  g65(.a(x46), .b(new_n151_), .c(x09), .O(new_n163_));
  aoi21  g66(.a(new_n163_), .b(new_n162_), .c(x10), .O(z34));
  oai21  g67(.a(x14), .b(new_n132_), .c(x46), .O(new_n165_));
  nand3  g68(.a(new_n151_), .b(x09), .c(x00), .O(new_n166_));
