...
module FAU ( 
  ...
  inv1   g081(.a(x14), .O(new_n170_));
  nand2  g082(.a(new_n170_), .b(x09), .O(new_n171_));
  nand2  g083(.a(new_n171_), .b(x41), .O(new_n172_));
  nor2   g084(.a(x14), .b(new_n144_), .O(new_n173_));
  nand2  g085(.a(new_n173_), .b(x42), .O(new_n174_));
  aoi21  g086(.a(new_n174_), .b(new_n172_), .c(x10), .O(z30));
  nand2  g087(.a(new_n171_), .b(x43), .O(new_n177_));
  nand2  g088(.a(new_n173_), .b(x44), .O(new_n178_));
  aoi21  g089(.a(new_n178_), .b(new_n177_), .c(x10), .O(z32));
  nand2  g090(.a(new_n171_), .b(x44), .O(new_n180_));
  nand2  g091(.a(new_n173_), .b(x45), .O(new_n181_));
  aoi21  g092(.a(new_n181_), .b(new_n180_), .c(x10), .O(z33));
  nand2  g093(.a(new_n171_), .b(x46), .O(new_n184_));
  nand2  g094(.a(new_n173_), .b(x00), .O(new_n185_));
