...
module FAU ( 
  ...
  nand2  g73(.a(x38), .b(new_n136_), .O(new_n162_));
  ...
  nor2   g78(.a(x14), .b(new_n136_), .O(new_n168_));
  nand2  g79(.a(new_n168_), .b(x41), .O(new_n169_));
  aoi21  g80(.a(new_n169_), .b(new_n167_), .c(x10), .O(z29));
  nand2  g81(.a(new_n166_), .b(x42), .O(new_n172_));
  nand2  g82(.a(new_n168_), .b(x43), .O(new_n173_));
  aoi21  g83(.a(new_n173_), .b(new_n172_), .c(x10), .O(z31));
  nand2  g84(.a(new_n166_), .b(x43), .O(new_n175_));
  nand2  g85(.a(new_n168_), .b(x44), .O(new_n176_));
  aoi21  g86(.a(new_n176_), .b(new_n175_), .c(x10), .O(z32));
  nand2  g87(.a(new_n166_), .b(x44), .O(new_n178_));
  nand2  g88(.a(new_n168_), .b(x45), .O(new_n179_));
