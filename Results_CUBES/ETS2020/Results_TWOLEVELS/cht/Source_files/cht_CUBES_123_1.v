...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n88_, new_n89_, new_n93_, new_n94_,
    ...
    new_n106_, new_n112_, new_n113_, new_n115_, new_n116_, new_n119_,
    new_n120_, new_n123_, new_n124_, new_n126_, new_n127_, new_n128_,
    new_n131_, new_n132_, new_n137_, new_n138_, new_n140_, new_n141_,
  ...
  nand2  g20(.a(x25), .b(new_n99_), .O(new_n112_));
  ...
  nand2  g26(.a(x28), .b(new_n99_), .O(new_n119_));
  ...
  nand2  g39(.a(x37), .b(new_n126_), .O(new_n137_));
  nand2  g40(.a(x38), .b(x09), .O(new_n138_));
  aoi21  g41(.a(new_n138_), .b(new_n137_), .c(x10), .O(z26));
  inv1   g42(.a(x39), .O(new_n140_));
  nand2  g43(.a(x14), .b(x00), .O(new_n141_));
  oai21  g44(.a(new_n140_), .b(x14), .c(new_n141_), .O(new_n142_));
  nand2  g45(.a(new_n142_), .b(x09), .O(new_n143_));
  nand2  g46(.a(x38), .b(new_n126_), .O(new_n144_));
  aoi21  g47(.a(new_n144_), .b(new_n143_), .c(x10), .O(z27));
  inv1   g48(.a(x14), .O(new_n147_));
  nand2  g49(.a(new_n147_), .b(x09), .O(new_n148_));
  nand2  g50(.a(new_n148_), .b(x40), .O(new_n149_));
  nor2   g51(.a(x14), .b(new_n126_), .O(new_n150_));
  nand2  g52(.a(new_n150_), .b(x41), .O(new_n151_));
  aoi21  g53(.a(new_n151_), .b(new_n149_), .c(x10), .O(z29));
  nand2  g54(.a(new_n148_), .b(x41), .O(new_n153_));
  nand2  g55(.a(new_n150_), .b(x42), .O(new_n154_));
  aoi21  g56(.a(new_n154_), .b(new_n153_), .c(x10), .O(z30));
  nand2  g57(.a(new_n148_), .b(x42), .O(new_n156_));
  nand2  g58(.a(new_n150_), .b(x43), .O(new_n157_));
  aoi21  g59(.a(new_n157_), .b(new_n156_), .c(x10), .O(z31));
  nand2  g60(.a(new_n148_), .b(x43), .O(new_n159_));
  nand2  g61(.a(new_n150_), .b(x44), .O(new_n160_));
  aoi21  g62(.a(new_n160_), .b(new_n159_), .c(x10), .O(z32));
  nand2  g63(.a(new_n148_), .b(x46), .O(new_n164_));
  nand2  g64(.a(new_n150_), .b(x00), .O(new_n165_));
