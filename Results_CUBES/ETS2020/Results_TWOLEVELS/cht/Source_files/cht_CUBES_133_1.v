...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n88_, new_n89_, new_n91_, new_n92_,
    new_n94_, new_n95_, new_n97_, new_n98_, new_n104_, new_n105_,
    ...
    new_n145_, new_n146_, new_n151_, new_n152_, new_n153_, new_n155_,
  ...
  nand2  g20(.a(x21), .b(new_n104_), .O(new_n108_));
  nand2  g21(.a(x22), .b(x08), .O(new_n109_));
  aoi21  g22(.a(new_n109_), .b(new_n108_), .c(x10), .O(z10));
  nand2  g23(.a(x22), .b(new_n104_), .O(new_n111_));
  ...
  nand2  g32(.a(x27), .b(new_n104_), .O(new_n122_));
  nand2  g33(.a(x28), .b(x08), .O(new_n123_));
  aoi21  g34(.a(new_n123_), .b(new_n122_), .c(x10), .O(z16));
  nand2  g35(.a(x28), .b(new_n104_), .O(new_n125_));
  ...
  oai21  g61(.a(x14), .b(new_n132_), .c(x40), .O(new_n155_));
