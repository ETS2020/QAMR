// Benchmark "FAU" written by ABC on Mon Jul  6 19:24:06 2020
...
module FAU ( 
  ...
  nand2  g20(.a(x23), .b(new_n100_), .O(new_n110_));
  ...
  nand2  g64(.a(x38), .b(new_n130_), .O(new_n156_));
  ...
  nor2   g69(.a(x14), .b(new_n130_), .O(new_n161_));
  ...
  nand2  g81(.a(new_n159_), .b(x43), .O(new_n173_));
  nand2  g82(.a(new_n161_), .b(x44), .O(new_n174_));
  aoi21  g83(.a(new_n174_), .b(new_n173_), .c(x10), .O(z32));
  nand2  g84(.a(new_n159_), .b(x44), .O(new_n176_));
  nand2  g85(.a(new_n161_), .b(x45), .O(new_n177_));
