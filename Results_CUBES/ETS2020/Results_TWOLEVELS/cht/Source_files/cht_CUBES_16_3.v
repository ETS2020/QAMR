...
module FAU ( 
  ...
  nand2  g093(.a(new_n171_), .b(x44), .O(new_n182_));
  nand2  g094(.a(new_n173_), .b(x45), .O(new_n183_));
  aoi21  g095(.a(new_n183_), .b(new_n182_), .c(x10), .O(z33));
  nand2  g096(.a(new_n171_), .b(x45), .O(new_n185_));
  nand2  g097(.a(new_n173_), .b(x46), .O(new_n186_));
