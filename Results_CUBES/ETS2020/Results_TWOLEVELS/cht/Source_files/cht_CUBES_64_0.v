// Benchmark "FAU" written by ABC on Mon Jul  6 19:22:26 2020
...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n88_, new_n89_, new_n91_, new_n92_,
    ...
    new_n173_, new_n174_, new_n178_, new_n179_, new_n181_, new_n182_,
  ...
  nand2  g072(.a(x36), .b(new_n144_), .O(new_n158_));
  nand2  g073(.a(x37), .b(x09), .O(new_n159_));
  aoi21  g074(.a(new_n159_), .b(new_n158_), .c(x10), .O(z25));
  nand2  g075(.a(x37), .b(new_n144_), .O(new_n161_));
  ...
  nor2   g087(.a(x14), .b(new_n144_), .O(new_n173_));
  nand2  g088(.a(new_n173_), .b(x40), .O(new_n174_));
  aoi21  g089(.a(new_n174_), .b(new_n172_), .c(x10), .O(z28));
  nand2  g090(.a(new_n171_), .b(x42), .O(new_n178_));
  nand2  g091(.a(new_n173_), .b(x43), .O(new_n179_));
  aoi21  g092(.a(new_n179_), .b(new_n178_), .c(x10), .O(z31));
  nand2  g093(.a(new_n171_), .b(x43), .O(new_n181_));
  nand2  g094(.a(new_n173_), .b(x44), .O(new_n182_));
  aoi21  g095(.a(new_n182_), .b(new_n181_), .c(x10), .O(z32));
  nand2  g096(.a(new_n171_), .b(x44), .O(new_n184_));
  nand2  g097(.a(new_n173_), .b(x45), .O(new_n185_));
  aoi21  g098(.a(new_n185_), .b(new_n184_), .c(x10), .O(z33));
  nand2  g099(.a(new_n171_), .b(x45), .O(new_n187_));
  nand2  g100(.a(new_n173_), .b(x46), .O(new_n188_));
