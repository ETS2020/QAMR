...
module FAU ( 
  ...
  nand2  g32(.a(x27), .b(new_n101_), .O(new_n122_));
  ...
  oai21  g57(.a(x14), .b(new_n132_), .c(x39), .O(new_n151_));
  ...
  oai21  g67(.a(x14), .b(new_n132_), .c(x43), .O(new_n162_));
  nand3  g68(.a(x44), .b(new_n152_), .c(x09), .O(new_n163_));
  aoi21  g69(.a(new_n163_), .b(new_n162_), .c(x10), .O(z32));
  oai21  g70(.a(x14), .b(new_n132_), .c(x44), .O(new_n165_));
  nand3  g71(.a(x45), .b(new_n152_), .c(x09), .O(new_n166_));
  aoi21  g72(.a(new_n166_), .b(new_n165_), .c(x10), .O(z33));
  oai21  g73(.a(x14), .b(new_n132_), .c(x45), .O(new_n168_));
  nand3  g74(.a(x46), .b(new_n152_), .c(x09), .O(new_n169_));
  aoi21  g75(.a(new_n169_), .b(new_n168_), .c(x10), .O(z34));
  oai21  g76(.a(x14), .b(new_n132_), .c(x46), .O(new_n171_));
  nand3  g77(.a(new_n152_), .b(x09), .c(x00), .O(new_n172_));
