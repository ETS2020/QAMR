...
module FAU ( 
  ...
  wire new_n85_, new_n86_, new_n87_, new_n90_, new_n91_, new_n93_, new_n94_,
    ...
    new_n123_, new_n127_, new_n128_, new_n130_, new_n131_, new_n134_,
  ...
  nand2  g038(.a(x28), .b(new_n100_), .O(new_n127_));
  nand2  g039(.a(x29), .b(x08), .O(new_n128_));
  aoi21  g040(.a(new_n128_), .b(new_n127_), .c(x10), .O(z17));
  nand2  g041(.a(x29), .b(new_n100_), .O(new_n130_));
  ...
  nand2  g067(.a(x38), .b(new_n134_), .O(new_n158_));
  ...
  nor2   g072(.a(x14), .b(new_n134_), .O(new_n164_));
