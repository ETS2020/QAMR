// Benchmark "FAU" written by ABC on Mon Jul  6 19:23:44 2020
...
module FAU ( 
  ...
  nand2  g087(.a(new_n169_), .b(x41), .O(new_n175_));
  nand2  g088(.a(new_n171_), .b(x42), .O(new_n176_));
  aoi21  g089(.a(new_n176_), .b(new_n175_), .c(x10), .O(z30));
  nand2  g090(.a(new_n169_), .b(x42), .O(new_n178_));
  nand2  g091(.a(new_n171_), .b(x43), .O(new_n179_));
  aoi21  g092(.a(new_n179_), .b(new_n178_), .c(x10), .O(z31));
  nand2  g093(.a(new_n169_), .b(x43), .O(new_n181_));
  nand2  g094(.a(new_n171_), .b(x44), .O(new_n182_));
  aoi21  g095(.a(new_n182_), .b(new_n181_), .c(x10), .O(z32));
  nand2  g096(.a(new_n169_), .b(x44), .O(new_n184_));
  nand2  g097(.a(new_n171_), .b(x45), .O(new_n185_));
  aoi21  g098(.a(new_n185_), .b(new_n184_), .c(x10), .O(z33));
  nand2  g099(.a(new_n169_), .b(x45), .O(new_n187_));
  nand2  g100(.a(new_n171_), .b(x46), .O(new_n188_));
  aoi21  g101(.a(new_n188_), .b(new_n187_), .c(x10), .O(z34));
  nand2  g102(.a(new_n169_), .b(x46), .O(new_n190_));
  nand2  g103(.a(new_n171_), .b(x00), .O(new_n191_));
