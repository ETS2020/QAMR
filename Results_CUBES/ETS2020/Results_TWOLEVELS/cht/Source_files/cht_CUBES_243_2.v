...
module FAU ( 
  ...
  nand2  g54(.a(x37), .b(new_n131_), .O(new_n147_));
  ...
  nand2  g61(.a(x38), .b(new_n131_), .O(new_n154_));
  ...
  nor2   g66(.a(x14), .b(new_n131_), .O(new_n161_));
  ...
  nand2  g72(.a(new_n159_), .b(x44), .O(new_n168_));
  nand2  g73(.a(new_n161_), .b(x45), .O(new_n169_));
  aoi21  g74(.a(new_n169_), .b(new_n168_), .c(x10), .O(z33));
  nand2  g75(.a(new_n159_), .b(x46), .O(new_n172_));
  nand2  g76(.a(new_n161_), .b(x00), .O(new_n173_));
