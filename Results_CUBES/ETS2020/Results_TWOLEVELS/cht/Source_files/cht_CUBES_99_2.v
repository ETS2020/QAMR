// Benchmark "FAU" written by ABC on Mon Jul  6 19:22:47 2020
...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n88_, new_n89_, new_n91_, new_n92_,
    ...
    new_n162_, new_n164_, new_n165_, new_n167_, new_n168_, new_n172_,
  ...
  nand2  g60(.a(x35), .b(new_n138_), .O(new_n149_));
  ...
  oai21  g79(.a(x14), .b(new_n138_), .c(x45), .O(new_n172_));
  nand3  g80(.a(x46), .b(new_n158_), .c(x09), .O(new_n173_));
  aoi21  g81(.a(new_n173_), .b(new_n172_), .c(x10), .O(z34));
  oai21  g82(.a(x14), .b(new_n138_), .c(x46), .O(new_n175_));
  nand3  g83(.a(new_n158_), .b(x09), .c(x00), .O(new_n176_));
