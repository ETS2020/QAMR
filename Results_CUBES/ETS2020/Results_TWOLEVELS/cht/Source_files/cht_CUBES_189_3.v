// Benchmark "FAU" written by ABC on Mon Jul  6 19:23:37 2020
...
module FAU ( 
  ...
  nand2  g51(.a(x37), .b(new_n135_), .O(new_n145_));
  ...
  nand2  g58(.a(x38), .b(new_n135_), .O(new_n152_));
  ...
  nor2   g63(.a(x14), .b(new_n135_), .O(new_n157_));
