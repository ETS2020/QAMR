...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n91_, new_n92_, new_n95_, new_n96_,
    new_n97_, new_n101_, new_n102_, new_n104_, new_n105_, new_n107_,
    new_n108_, new_n112_, new_n113_, new_n116_, new_n117_, new_n119_,
    new_n120_, new_n123_, new_n124_, new_n127_, new_n128_, new_n129_,
  ...
  nand2  g26(.a(x28), .b(new_n95_), .O(new_n119_));
  ...
  nor2   g57(.a(x14), .b(new_n127_), .O(new_n153_));
