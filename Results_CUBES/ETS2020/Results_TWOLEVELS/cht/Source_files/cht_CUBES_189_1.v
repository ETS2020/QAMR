...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n88_, new_n89_, new_n93_, new_n94_,
    ...
    new_n105_, new_n108_, new_n109_, new_n112_, new_n113_, new_n117_,
    ...
    new_n157_, new_n159_, new_n160_, new_n165_, new_n166_;
  ...
  nand2  g33(.a(x30), .b(new_n100_), .O(new_n126_));
  ...
  oai21  g67(.a(x14), .b(new_n128_), .c(x46), .O(new_n165_));
  nand3  g68(.a(new_n150_), .b(x09), .c(x00), .O(new_n166_));
