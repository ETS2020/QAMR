...
module FAU ( 
  ...
  nand2  g70(.a(x38), .b(new_n140_), .O(new_n160_));
  ...
  nor2   g75(.a(x14), .b(new_n140_), .O(new_n167_));
  nand2  g76(.a(new_n167_), .b(x42), .O(new_n168_));
  aoi21  g77(.a(new_n168_), .b(new_n166_), .c(x10), .O(z30));
  nand2  g78(.a(new_n165_), .b(x42), .O(new_n170_));
  nand2  g79(.a(new_n167_), .b(x43), .O(new_n171_));
  aoi21  g80(.a(new_n171_), .b(new_n170_), .c(x10), .O(z31));
  nand2  g81(.a(new_n165_), .b(x43), .O(new_n173_));
  nand2  g82(.a(new_n167_), .b(x44), .O(new_n174_));
  aoi21  g83(.a(new_n174_), .b(new_n173_), .c(x10), .O(z32));
  nand2  g84(.a(new_n165_), .b(x44), .O(new_n176_));
  nand2  g85(.a(new_n167_), .b(x45), .O(new_n177_));
