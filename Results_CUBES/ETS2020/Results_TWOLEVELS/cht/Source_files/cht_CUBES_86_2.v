// Benchmark "FAU" written by ABC on Mon Jul  6 19:22:39 2020
...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n88_, new_n89_, new_n92_, new_n93_,
    ...
    new_n104_, new_n107_, new_n108_, new_n110_, new_n111_, new_n114_,
  ...
  nand2  g75(.a(new_n161_), .b(x44), .O(new_n170_));
  nand2  g76(.a(new_n163_), .b(x45), .O(new_n171_));
