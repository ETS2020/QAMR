...
module FAU ( 
  ...
  nand2  g085(.a(x38), .b(new_n146_), .O(new_n170_));
  ...
  nor2   g090(.a(x14), .b(new_n146_), .O(new_n175_));
  nand2  g091(.a(new_n175_), .b(x40), .O(new_n176_));
  aoi21  g092(.a(new_n176_), .b(new_n174_), .c(x10), .O(z28));
  nand2  g093(.a(new_n173_), .b(x41), .O(new_n179_));
  nand2  g094(.a(new_n175_), .b(x42), .O(new_n180_));
  aoi21  g095(.a(new_n180_), .b(new_n179_), .c(x10), .O(z30));
  nand2  g096(.a(new_n173_), .b(x43), .O(new_n183_));
  nand2  g097(.a(new_n175_), .b(x44), .O(new_n184_));
  aoi21  g098(.a(new_n184_), .b(new_n183_), .c(x10), .O(z32));
  nand2  g099(.a(new_n173_), .b(x44), .O(new_n186_));
  nand2  g100(.a(new_n175_), .b(x45), .O(new_n187_));
  aoi21  g101(.a(new_n187_), .b(new_n186_), .c(x10), .O(z33));
  nand2  g102(.a(new_n173_), .b(x45), .O(new_n189_));
  nand2  g103(.a(new_n175_), .b(x46), .O(new_n190_));
  aoi21  g104(.a(new_n190_), .b(new_n189_), .c(x10), .O(z34));
  nand2  g105(.a(new_n173_), .b(x46), .O(new_n192_));
  nand2  g106(.a(new_n175_), .b(x00), .O(new_n193_));
