// Benchmark "FAU" written by ABC on Mon Jul  6 19:24:05 2020
...
module FAU ( 
  ...
  nand2  g48(.a(x37), .b(new_n133_), .O(new_n143_));
  ...
  nand2  g55(.a(x38), .b(new_n133_), .O(new_n150_));
  ...
  nor2   g60(.a(x14), .b(new_n133_), .O(new_n156_));
  ...
  nand2  g72(.a(new_n154_), .b(x45), .O(new_n169_));
  nand2  g73(.a(new_n156_), .b(x46), .O(new_n170_));
  aoi21  g74(.a(new_n170_), .b(new_n169_), .c(x10), .O(z34));
  nand2  g75(.a(new_n154_), .b(x46), .O(new_n172_));
  nand2  g76(.a(new_n156_), .b(x00), .O(new_n173_));
