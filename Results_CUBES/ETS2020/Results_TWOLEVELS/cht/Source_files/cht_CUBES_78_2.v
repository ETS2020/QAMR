...
module FAU ( 
  ...
  nand2  g78(.a(new_n163_), .b(x41), .O(new_n169_));
  nand2  g79(.a(new_n165_), .b(x42), .O(new_n170_));
  ...
  nand2  g87(.a(new_n163_), .b(x46), .O(new_n180_));
  nand2  g88(.a(new_n165_), .b(x00), .O(new_n181_));
