...
module FAU ( 
  ...
  nand2  g066(.a(x34), .b(new_n144_), .O(new_n152_));
  nand2  g067(.a(x35), .b(x09), .O(new_n153_));
  aoi21  g068(.a(new_n153_), .b(new_n152_), .c(x10), .O(z23));
  nand2  g069(.a(x35), .b(new_n144_), .O(new_n155_));
  ...
  nand2  g096(.a(new_n171_), .b(x43), .O(new_n183_));
  nand2  g097(.a(new_n173_), .b(x44), .O(new_n184_));
  aoi21  g098(.a(new_n184_), .b(new_n183_), .c(x10), .O(z32));
  nand2  g099(.a(new_n171_), .b(x44), .O(new_n186_));
  nand2  g100(.a(new_n173_), .b(x45), .O(new_n187_));
  aoi21  g101(.a(new_n187_), .b(new_n186_), .c(x10), .O(z33));
  nand2  g102(.a(new_n171_), .b(x45), .O(new_n189_));
  nand2  g103(.a(new_n173_), .b(x46), .O(new_n190_));
  aoi21  g104(.a(new_n190_), .b(new_n189_), .c(x10), .O(z34));
  nand2  g105(.a(new_n171_), .b(x46), .O(new_n192_));
  nand2  g106(.a(new_n173_), .b(x00), .O(new_n193_));
