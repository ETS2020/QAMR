...
module FAU ( 
  ...
  wire new_n86_, new_n87_, new_n88_, new_n90_, new_n91_, new_n93_, new_n94_,
    ...
    new_n104_, new_n106_, new_n107_, new_n111_, new_n112_, new_n114_,
    new_n115_, new_n117_, new_n118_, new_n120_, new_n121_, new_n124_,
    new_n125_, new_n127_, new_n128_, new_n130_, new_n131_, new_n133_,
    new_n134_, new_n140_, new_n141_, new_n142_, new_n144_, new_n145_,
  ...
  nand2  g23(.a(x22), .b(new_n99_), .O(new_n111_));
  ...
  nand2  g35(.a(x27), .b(new_n99_), .O(new_n124_));
  ...
  nand2  g51(.a(x36), .b(new_n140_), .O(new_n144_));
  nand2  g52(.a(x37), .b(x09), .O(new_n145_));
  aoi21  g53(.a(new_n145_), .b(new_n144_), .c(x10), .O(z25));
  nand2  g54(.a(x37), .b(new_n140_), .O(new_n147_));
  ...
  nand2  g61(.a(x38), .b(new_n140_), .O(new_n154_));
  ...
  nor2   g66(.a(x14), .b(new_n140_), .O(new_n159_));
  ...
  nand2  g78(.a(new_n157_), .b(x46), .O(new_n174_));
  nand2  g79(.a(new_n159_), .b(x00), .O(new_n175_));
