...
module FAU ( 
  ...
  nand2  g73(.a(x38), .b(new_n143_), .O(new_n162_));
  ...
  nor2   g78(.a(x14), .b(new_n143_), .O(new_n168_));
  ...
  nand2  g84(.a(new_n166_), .b(x42), .O(new_n174_));
  nand2  g85(.a(new_n168_), .b(x43), .O(new_n175_));
  aoi21  g86(.a(new_n175_), .b(new_n174_), .c(x10), .O(z31));
