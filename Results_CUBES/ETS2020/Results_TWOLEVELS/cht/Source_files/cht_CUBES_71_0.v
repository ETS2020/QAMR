...
module FAU ( 
  ...
  inv1   g081(.a(x14), .O(new_n169_));
  nand2  g082(.a(new_n169_), .b(x09), .O(new_n170_));
  nand2  g083(.a(new_n170_), .b(x40), .O(new_n171_));
  nor2   g084(.a(x14), .b(new_n140_), .O(new_n172_));
  nand2  g085(.a(new_n172_), .b(x41), .O(new_n173_));
  aoi21  g086(.a(new_n173_), .b(new_n171_), .c(x10), .O(z29));
  nand2  g087(.a(new_n170_), .b(x42), .O(new_n176_));
  nand2  g088(.a(new_n172_), .b(x43), .O(new_n177_));
  aoi21  g089(.a(new_n177_), .b(new_n176_), .c(x10), .O(z31));
  nand2  g090(.a(new_n170_), .b(x43), .O(new_n179_));
  nand2  g091(.a(new_n172_), .b(x44), .O(new_n180_));
  aoi21  g092(.a(new_n180_), .b(new_n179_), .c(x10), .O(z32));
  nand2  g093(.a(new_n170_), .b(x44), .O(new_n182_));
  nand2  g094(.a(new_n172_), .b(x45), .O(new_n183_));
  aoi21  g095(.a(new_n183_), .b(new_n182_), .c(x10), .O(z33));
  nand2  g096(.a(new_n170_), .b(x45), .O(new_n185_));
  nand2  g097(.a(new_n172_), .b(x46), .O(new_n186_));
  aoi21  g098(.a(new_n186_), .b(new_n185_), .c(x10), .O(z34));
  nand2  g099(.a(new_n170_), .b(x46), .O(new_n188_));
  nand2  g100(.a(new_n172_), .b(x00), .O(new_n189_));
