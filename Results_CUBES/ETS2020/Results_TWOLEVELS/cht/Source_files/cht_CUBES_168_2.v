// Benchmark "FAU" written by ABC on Mon Jul  6 19:23:24 2020
...
module FAU ( 
  ...
  wire new_n86_, new_n87_, new_n88_, new_n90_, new_n91_, new_n95_, new_n96_,
    ...
    new_n124_, new_n127_, new_n128_, new_n130_, new_n131_, new_n135_,
  ...
  nand2  g54(.a(x36), .b(new_n135_), .O(new_n146_));
  nand2  g55(.a(x37), .b(x09), .O(new_n147_));
  aoi21  g56(.a(new_n147_), .b(new_n146_), .c(x10), .O(z25));
  nand2  g57(.a(x37), .b(new_n135_), .O(new_n149_));
  ...
  nand2  g64(.a(x38), .b(new_n135_), .O(new_n156_));
  ...
  nor2   g69(.a(x14), .b(new_n135_), .O(new_n162_));
  nand2  g70(.a(new_n162_), .b(x41), .O(new_n163_));
  aoi21  g71(.a(new_n163_), .b(new_n161_), .c(x10), .O(z29));
  nand2  g72(.a(new_n160_), .b(x41), .O(new_n165_));
  nand2  g73(.a(new_n162_), .b(x42), .O(new_n166_));
  aoi21  g74(.a(new_n166_), .b(new_n165_), .c(x10), .O(z30));
  nand2  g75(.a(new_n160_), .b(x42), .O(new_n168_));
  nand2  g76(.a(new_n162_), .b(x43), .O(new_n169_));
  aoi21  g77(.a(new_n169_), .b(new_n168_), .c(x10), .O(z31));
  nand2  g78(.a(new_n160_), .b(x43), .O(new_n171_));
  nand2  g79(.a(new_n162_), .b(x44), .O(new_n172_));
  aoi21  g80(.a(new_n172_), .b(new_n171_), .c(x10), .O(z32));
  nand2  g81(.a(new_n160_), .b(x44), .O(new_n174_));
  nand2  g82(.a(new_n162_), .b(x45), .O(new_n175_));
  aoi21  g83(.a(new_n175_), .b(new_n174_), .c(x10), .O(z33));
  nand2  g84(.a(new_n160_), .b(x46), .O(new_n178_));
  nand2  g85(.a(new_n162_), .b(x00), .O(new_n179_));
