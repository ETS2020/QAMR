...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n89_, new_n90_, new_n92_, new_n93_,
    ...
    new_n140_, new_n143_, new_n144_, new_n145_, new_n148_, new_n149_,
    new_n151_, new_n152_, new_n155_, new_n156_, new_n159_, new_n160_,
    new_n161_, new_n163_, new_n164_, new_n167_, new_n168_, new_n170_,
    new_n171_, new_n173_, new_n174_, new_n176_, new_n177_;
  ...
  nand2  g32(.a(x22), .b(new_n101_), .O(new_n117_));
  nand2  g33(.a(x23), .b(x08), .O(new_n118_));
  aoi21  g34(.a(new_n118_), .b(new_n117_), .c(x10), .O(z11));
  nand2  g35(.a(x23), .b(new_n101_), .O(new_n120_));
  nand2  g36(.a(x24), .b(x08), .O(new_n121_));
  aoi21  g37(.a(new_n121_), .b(new_n120_), .c(x10), .O(z12));
  nand2  g38(.a(x24), .b(new_n101_), .O(new_n123_));
  nand2  g39(.a(x25), .b(x08), .O(new_n124_));
  aoi21  g40(.a(new_n124_), .b(new_n123_), .c(x10), .O(z13));
  nand2  g41(.a(x25), .b(new_n101_), .O(new_n126_));
  nand2  g42(.a(x26), .b(x08), .O(new_n127_));
  aoi21  g43(.a(new_n127_), .b(new_n126_), .c(x10), .O(z14));
  nand2  g44(.a(x26), .b(new_n101_), .O(new_n129_));
  nand2  g45(.a(x27), .b(x08), .O(new_n130_));
  aoi21  g46(.a(new_n130_), .b(new_n129_), .c(x10), .O(z15));
  nand2  g47(.a(x27), .b(new_n101_), .O(new_n132_));
  nand2  g48(.a(x28), .b(x08), .O(new_n133_));
  aoi21  g49(.a(new_n133_), .b(new_n132_), .c(x10), .O(z16));
  nand2  g50(.a(x29), .b(new_n101_), .O(new_n136_));
  nand2  g51(.a(x30), .b(x08), .O(new_n137_));
  aoi21  g52(.a(new_n137_), .b(new_n136_), .c(x10), .O(z18));
  nand2  g53(.a(x08), .b(x00), .O(new_n139_));
  nand2  g54(.a(x30), .b(new_n101_), .O(new_n140_));
  aoi21  g55(.a(new_n140_), .b(new_n139_), .c(x10), .O(z19));
  inv1   g56(.a(x09), .O(new_n143_));
  nand2  g57(.a(x32), .b(new_n143_), .O(new_n144_));
  nand2  g58(.a(x33), .b(x09), .O(new_n145_));
  aoi21  g59(.a(new_n145_), .b(new_n144_), .c(x10), .O(z21));
  nand2  g60(.a(x34), .b(new_n143_), .O(new_n148_));
  nand2  g61(.a(x35), .b(x09), .O(new_n149_));
  aoi21  g62(.a(new_n149_), .b(new_n148_), .c(x10), .O(z23));
  nand2  g63(.a(x35), .b(new_n143_), .O(new_n151_));
  nand2  g64(.a(x36), .b(x09), .O(new_n152_));
  aoi21  g65(.a(new_n152_), .b(new_n151_), .c(x10), .O(z24));
  nand2  g66(.a(x37), .b(new_n143_), .O(new_n155_));
  nand2  g67(.a(x38), .b(x09), .O(new_n156_));
  aoi21  g68(.a(new_n156_), .b(new_n155_), .c(x10), .O(z26));
  oai21  g69(.a(x14), .b(new_n143_), .c(x39), .O(new_n159_));
  inv1   g70(.a(x14), .O(new_n160_));
  nand3  g71(.a(x40), .b(new_n160_), .c(x09), .O(new_n161_));
  aoi21  g72(.a(new_n161_), .b(new_n159_), .c(x10), .O(z28));
  oai21  g73(.a(x14), .b(new_n143_), .c(x40), .O(new_n163_));
  nand3  g74(.a(x41), .b(new_n160_), .c(x09), .O(new_n164_));
  aoi21  g75(.a(new_n164_), .b(new_n163_), .c(x10), .O(z29));
  oai21  g76(.a(x14), .b(new_n143_), .c(x42), .O(new_n167_));
  nand3  g77(.a(x43), .b(new_n160_), .c(x09), .O(new_n168_));
  aoi21  g78(.a(new_n168_), .b(new_n167_), .c(x10), .O(z31));
  oai21  g79(.a(x14), .b(new_n143_), .c(x43), .O(new_n170_));
  nand3  g80(.a(x44), .b(new_n160_), .c(x09), .O(new_n171_));
  aoi21  g81(.a(new_n171_), .b(new_n170_), .c(x10), .O(z32));
  oai21  g82(.a(x14), .b(new_n143_), .c(x44), .O(new_n173_));
  nand3  g83(.a(x45), .b(new_n160_), .c(x09), .O(new_n174_));
  aoi21  g84(.a(new_n174_), .b(new_n173_), .c(x10), .O(z33));
  oai21  g85(.a(x14), .b(new_n143_), .c(x45), .O(new_n176_));
  nand3  g86(.a(x46), .b(new_n160_), .c(x09), .O(new_n177_));
