// Benchmark "FAU" written by ABC on Mon Jul  6 19:23:35 2020
...
module FAU ( 
  ...
  wire new_n85_, new_n86_, new_n87_, new_n90_, new_n91_, new_n94_, new_n95_,
    ...
    new_n114_, new_n117_, new_n118_, new_n120_, new_n121_, new_n126_,
  ...
  nand2  g39(.a(x30), .b(new_n97_), .O(new_n130_));
  ...
  inv1   g63(.a(x14), .O(new_n157_));
  nand2  g64(.a(new_n157_), .b(x09), .O(new_n158_));
  nand2  g65(.a(new_n158_), .b(x40), .O(new_n159_));
  nor2   g66(.a(x14), .b(new_n132_), .O(new_n160_));
  nand2  g67(.a(new_n160_), .b(x41), .O(new_n161_));
  aoi21  g68(.a(new_n161_), .b(new_n159_), .c(x10), .O(z29));
  nand2  g69(.a(new_n158_), .b(x42), .O(new_n164_));
  nand2  g70(.a(new_n160_), .b(x43), .O(new_n165_));
  aoi21  g71(.a(new_n165_), .b(new_n164_), .c(x10), .O(z31));
  nand2  g72(.a(new_n158_), .b(x43), .O(new_n167_));
  nand2  g73(.a(new_n160_), .b(x44), .O(new_n168_));
  aoi21  g74(.a(new_n168_), .b(new_n167_), .c(x10), .O(z32));
  nand2  g75(.a(new_n158_), .b(x44), .O(new_n170_));
  nand2  g76(.a(new_n160_), .b(x45), .O(new_n171_));
  aoi21  g77(.a(new_n171_), .b(new_n170_), .c(x10), .O(z33));
  nand2  g78(.a(new_n158_), .b(x45), .O(new_n173_));
  nand2  g79(.a(new_n160_), .b(x46), .O(new_n174_));
  aoi21  g80(.a(new_n174_), .b(new_n173_), .c(x10), .O(z34));
  nand2  g81(.a(new_n158_), .b(x46), .O(new_n176_));
  nand2  g82(.a(new_n160_), .b(x00), .O(new_n177_));
