...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n88_, new_n89_, new_n93_, new_n94_,
    ...
    new_n105_, new_n107_, new_n108_, new_n111_, new_n112_, new_n115_,
  ...
  nand2  g42(.a(x30), .b(new_n100_), .O(new_n132_));
  ...
  nand2  g61(.a(x38), .b(new_n135_), .O(new_n154_));
  ...
  nor2   g66(.a(x14), .b(new_n135_), .O(new_n160_));
  ...
  nand2  g75(.a(new_n158_), .b(x43), .O(new_n169_));
  nand2  g76(.a(new_n160_), .b(x44), .O(new_n170_));
