...
module FAU ( 
  ...
  wire new_n86_, new_n87_, new_n88_, new_n90_, new_n91_, new_n93_, new_n94_,
    ...
    new_n125_, new_n127_, new_n128_, new_n130_, new_n131_, new_n135_,
  ...
  nor2   g072(.a(x14), .b(new_n135_), .O(new_n163_));
