// Benchmark "FAU" written by ABC on Mon Jul  6 19:22:23 2020
...
module FAU ( 
  ...
  nand2  g057(.a(x30), .b(new_n101_), .O(new_n142_));
  ...
  nand2  g082(.a(x38), .b(new_n145_), .O(new_n168_));
  ...
  nor2   g087(.a(x14), .b(new_n145_), .O(new_n173_));
  nand2  g088(.a(new_n173_), .b(x40), .O(new_n174_));
  aoi21  g089(.a(new_n174_), .b(new_n172_), .c(x10), .O(z28));
  nand2  g090(.a(new_n171_), .b(x41), .O(new_n177_));
  nand2  g091(.a(new_n173_), .b(x42), .O(new_n178_));
  ...
  nand2  g102(.a(new_n171_), .b(x46), .O(new_n190_));
  nand2  g103(.a(new_n173_), .b(x00), .O(new_n191_));
