...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n88_, new_n89_, new_n91_, new_n92_,
    ...
    new_n170_, new_n172_, new_n173_, new_n176_, new_n177_;
  ...
  nand2  g47(.a(x28), .b(new_n101_), .O(new_n133_));
  nand2  g48(.a(x29), .b(x08), .O(new_n134_));
  aoi21  g49(.a(new_n134_), .b(new_n133_), .c(x10), .O(z17));
  ...
  inv1   g56(.a(x09), .O(new_n142_));
  nand2  g57(.a(x31), .b(new_n142_), .O(new_n143_));
  nand2  g58(.a(x32), .b(x09), .O(new_n144_));
  aoi21  g59(.a(new_n144_), .b(new_n143_), .c(x10), .O(z20));
  nand2  g60(.a(x32), .b(new_n142_), .O(new_n146_));
  nand2  g61(.a(x33), .b(x09), .O(new_n147_));
  aoi21  g62(.a(new_n147_), .b(new_n146_), .c(x10), .O(z21));
  nand2  g63(.a(x34), .b(new_n142_), .O(new_n150_));
  nand2  g64(.a(x35), .b(x09), .O(new_n151_));
  aoi21  g65(.a(new_n151_), .b(new_n150_), .c(x10), .O(z23));
  nand2  g66(.a(x36), .b(new_n142_), .O(new_n154_));
  nand2  g67(.a(x37), .b(x09), .O(new_n155_));
  aoi21  g68(.a(new_n155_), .b(new_n154_), .c(x10), .O(z25));
  nand2  g69(.a(x37), .b(new_n142_), .O(new_n157_));
  nand2  g70(.a(x38), .b(x09), .O(new_n158_));
  aoi21  g71(.a(new_n158_), .b(new_n157_), .c(x10), .O(z26));
  oai21  g72(.a(x14), .b(new_n142_), .c(x39), .O(new_n161_));
  inv1   g73(.a(x14), .O(new_n162_));
  nand3  g74(.a(x40), .b(new_n162_), .c(x09), .O(new_n163_));
  aoi21  g75(.a(new_n163_), .b(new_n161_), .c(x10), .O(z28));
  oai21  g76(.a(x14), .b(new_n142_), .c(x40), .O(new_n165_));
  nand3  g77(.a(x41), .b(new_n162_), .c(x09), .O(new_n166_));
  aoi21  g78(.a(new_n166_), .b(new_n165_), .c(x10), .O(z29));
  oai21  g79(.a(x14), .b(new_n142_), .c(x42), .O(new_n169_));
  nand3  g80(.a(x43), .b(new_n162_), .c(x09), .O(new_n170_));
  aoi21  g81(.a(new_n170_), .b(new_n169_), .c(x10), .O(z31));
  oai21  g82(.a(x14), .b(new_n142_), .c(x43), .O(new_n172_));
  nand3  g83(.a(x44), .b(new_n162_), .c(x09), .O(new_n173_));
  aoi21  g84(.a(new_n173_), .b(new_n172_), .c(x10), .O(z32));
  oai21  g85(.a(x14), .b(new_n142_), .c(x45), .O(new_n176_));
  nand3  g86(.a(x46), .b(new_n162_), .c(x09), .O(new_n177_));
