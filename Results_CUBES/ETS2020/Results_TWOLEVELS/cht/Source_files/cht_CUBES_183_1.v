...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n88_, new_n89_, new_n91_, new_n92_,
    ...
    new_n118_, new_n123_, new_n124_, new_n127_, new_n128_, new_n129_,
  ...
  nand2  g39(.a(x35), .b(new_n127_), .O(new_n135_));
  nand2  g40(.a(x36), .b(x09), .O(new_n136_));
  aoi21  g41(.a(new_n136_), .b(new_n135_), .c(x10), .O(z24));
  nand2  g42(.a(x37), .b(new_n127_), .O(new_n139_));
  ...
  nand2  g49(.a(x38), .b(new_n127_), .O(new_n146_));
  aoi21  g50(.a(new_n146_), .b(new_n145_), .c(x10), .O(z27));
  inv1   g51(.a(x14), .O(new_n150_));
  nand2  g52(.a(new_n150_), .b(x09), .O(new_n151_));
  nand2  g53(.a(new_n151_), .b(x41), .O(new_n152_));
  nor2   g54(.a(x14), .b(new_n127_), .O(new_n153_));
  nand2  g55(.a(new_n153_), .b(x42), .O(new_n154_));
  aoi21  g56(.a(new_n154_), .b(new_n152_), .c(x10), .O(z30));
  nand2  g57(.a(new_n151_), .b(x42), .O(new_n156_));
  nand2  g58(.a(new_n153_), .b(x43), .O(new_n157_));
  aoi21  g59(.a(new_n157_), .b(new_n156_), .c(x10), .O(z31));
  nand2  g60(.a(new_n151_), .b(x46), .O(new_n162_));
  nand2  g61(.a(new_n153_), .b(x00), .O(new_n163_));
