// Benchmark "FAU" written by ABC on Mon Jul  6 19:23:33 2020
...
module FAU ( 
  ...
  nand2  g57(.a(x34), .b(new_n136_), .O(new_n146_));
  ...
  nand2  g63(.a(x37), .b(new_n136_), .O(new_n153_));
  nand2  g64(.a(x38), .b(x09), .O(new_n154_));
  aoi21  g65(.a(new_n154_), .b(new_n153_), .c(x10), .O(z26));
  oai21  g66(.a(x14), .b(new_n136_), .c(x39), .O(new_n157_));
  inv1   g67(.a(x14), .O(new_n158_));
  nand3  g68(.a(x40), .b(new_n158_), .c(x09), .O(new_n159_));
  aoi21  g69(.a(new_n159_), .b(new_n157_), .c(x10), .O(z28));
  oai21  g70(.a(x14), .b(new_n136_), .c(x40), .O(new_n161_));
  nand3  g71(.a(x41), .b(new_n158_), .c(x09), .O(new_n162_));
  aoi21  g72(.a(new_n162_), .b(new_n161_), .c(x10), .O(z29));
  oai21  g73(.a(x14), .b(new_n136_), .c(x41), .O(new_n164_));
  nand3  g74(.a(x42), .b(new_n158_), .c(x09), .O(new_n165_));
  aoi21  g75(.a(new_n165_), .b(new_n164_), .c(x10), .O(z30));
  oai21  g76(.a(x14), .b(new_n136_), .c(x42), .O(new_n167_));
  nand3  g77(.a(x43), .b(new_n158_), .c(x09), .O(new_n168_));
  aoi21  g78(.a(new_n168_), .b(new_n167_), .c(x10), .O(z31));
  oai21  g79(.a(x14), .b(new_n136_), .c(x43), .O(new_n170_));
  nand3  g80(.a(x44), .b(new_n158_), .c(x09), .O(new_n171_));
  aoi21  g81(.a(new_n171_), .b(new_n170_), .c(x10), .O(z32));
  oai21  g82(.a(x14), .b(new_n136_), .c(x44), .O(new_n173_));
  nand3  g83(.a(x45), .b(new_n158_), .c(x09), .O(new_n174_));
  aoi21  g84(.a(new_n174_), .b(new_n173_), .c(x10), .O(z33));
  oai21  g85(.a(x14), .b(new_n136_), .c(x45), .O(new_n176_));
  nand3  g86(.a(x46), .b(new_n158_), .c(x09), .O(new_n177_));
  aoi21  g87(.a(new_n177_), .b(new_n176_), .c(x10), .O(z34));
  oai21  g88(.a(x14), .b(new_n136_), .c(x46), .O(new_n179_));
  nand3  g89(.a(new_n158_), .b(x09), .c(x00), .O(new_n180_));
