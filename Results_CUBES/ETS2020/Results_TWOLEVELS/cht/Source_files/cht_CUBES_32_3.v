...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n88_, new_n89_, new_n91_, new_n92_,
    ...
    new_n139_, new_n143_, new_n144_, new_n145_, new_n147_, new_n148_,
  ...
  nor2   g084(.a(x14), .b(new_n143_), .O(new_n172_));
  nand2  g085(.a(new_n172_), .b(x41), .O(new_n173_));
  aoi21  g086(.a(new_n173_), .b(new_n171_), .c(x10), .O(z29));
  nand2  g087(.a(new_n170_), .b(x41), .O(new_n175_));
  nand2  g088(.a(new_n172_), .b(x42), .O(new_n176_));
  aoi21  g089(.a(new_n176_), .b(new_n175_), .c(x10), .O(z30));
  nand2  g090(.a(new_n170_), .b(x44), .O(new_n180_));
  nand2  g091(.a(new_n172_), .b(x45), .O(new_n181_));
  aoi21  g092(.a(new_n181_), .b(new_n180_), .c(x10), .O(z33));
  nand2  g093(.a(new_n170_), .b(x45), .O(new_n183_));
  nand2  g094(.a(new_n172_), .b(x46), .O(new_n184_));
  aoi21  g095(.a(new_n184_), .b(new_n183_), .c(x10), .O(z34));
  nand2  g096(.a(new_n170_), .b(x46), .O(new_n186_));
  nand2  g097(.a(new_n172_), .b(x00), .O(new_n187_));
