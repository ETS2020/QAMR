...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n91_, new_n92_, new_n95_, new_n96_,
    new_n97_, new_n100_, new_n101_, new_n104_, new_n105_, new_n107_,
    new_n108_, new_n112_, new_n113_, new_n115_, new_n116_, new_n118_,
  ...
  oai21  g70(.a(x14), .b(new_n128_), .c(x46), .O(new_n167_));
