...
module FAU ( 
  ...
  nand2  g38(.a(x29), .b(new_n95_), .O(new_n128_));
  ...
  nand2  g54(.a(x36), .b(new_n133_), .O(new_n146_));
  ...
  nand2  g61(.a(x38), .b(new_n133_), .O(new_n154_));
  ...
  nor2   g66(.a(x14), .b(new_n133_), .O(new_n159_));
