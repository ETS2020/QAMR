...
module FAU ( 
  ...
  nand2  g32(.a(x27), .b(new_n100_), .O(new_n122_));
  nand2  g33(.a(x28), .b(x08), .O(new_n123_));
  aoi21  g34(.a(new_n123_), .b(new_n122_), .c(x10), .O(z16));
  nand2  g35(.a(x28), .b(new_n100_), .O(new_n125_));
  ...
  nand2  g72(.a(new_n157_), .b(x43), .O(new_n167_));
  nand2  g73(.a(new_n159_), .b(x44), .O(new_n168_));
