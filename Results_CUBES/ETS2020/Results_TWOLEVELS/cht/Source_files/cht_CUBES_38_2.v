// Benchmark "FAU" written by ABC on Mon Jul  6 19:22:11 2020
...
module FAU ( 
  ...
  wire new_n87_, new_n88_, new_n89_, new_n91_, new_n92_, new_n94_, new_n95_,
    ...
    new_n115_, new_n118_, new_n119_, new_n122_, new_n123_, new_n125_,
  ...
  nand2  g000(.a(x07), .b(x01), .O(new_n87_));
  inv1   g001(.a(x07), .O(new_n88_));
  nand2  g002(.a(x14), .b(new_n88_), .O(new_n89_));
  aoi21  g003(.a(new_n89_), .b(new_n87_), .c(x10), .O(z03));
  nand2  g004(.a(x07), .b(x02), .O(new_n91_));
  nand2  g005(.a(x15), .b(new_n88_), .O(new_n92_));
  aoi21  g006(.a(new_n92_), .b(new_n91_), .c(x10), .O(z04));
  nand2  g007(.a(x07), .b(x03), .O(new_n94_));
  nand2  g008(.a(x16), .b(new_n88_), .O(new_n95_));
  ...
  nor2   g072(.a(x14), .b(new_n134_), .O(new_n163_));
  nand2  g073(.a(new_n163_), .b(x40), .O(new_n164_));
  aoi21  g074(.a(new_n164_), .b(new_n162_), .c(x10), .O(z28));
  nand2  g075(.a(new_n161_), .b(x41), .O(new_n167_));
  nand2  g076(.a(new_n163_), .b(x42), .O(new_n168_));
  aoi21  g077(.a(new_n168_), .b(new_n167_), .c(x10), .O(z30));
  nand2  g078(.a(new_n161_), .b(x42), .O(new_n170_));
  nand2  g079(.a(new_n163_), .b(x43), .O(new_n171_));
  aoi21  g080(.a(new_n171_), .b(new_n170_), .c(x10), .O(z31));
  nand2  g081(.a(new_n161_), .b(x43), .O(new_n173_));
  nand2  g082(.a(new_n163_), .b(x44), .O(new_n174_));
  aoi21  g083(.a(new_n174_), .b(new_n173_), .c(x10), .O(z32));
  nand2  g084(.a(new_n161_), .b(x44), .O(new_n176_));
  nand2  g085(.a(new_n163_), .b(x45), .O(new_n177_));
  aoi21  g086(.a(new_n177_), .b(new_n176_), .c(x10), .O(z33));
  nand2  g087(.a(new_n161_), .b(x45), .O(new_n179_));
  nand2  g088(.a(new_n163_), .b(x46), .O(new_n180_));
  aoi21  g089(.a(new_n180_), .b(new_n179_), .c(x10), .O(z34));
  nand2  g090(.a(new_n161_), .b(x46), .O(new_n182_));
  nand2  g091(.a(new_n163_), .b(x00), .O(new_n183_));
