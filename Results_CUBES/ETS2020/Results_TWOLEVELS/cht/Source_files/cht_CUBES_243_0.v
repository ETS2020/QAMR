// Benchmark "FAU" written by ABC on Mon Jul  6 19:24:08 2020
...
module FAU ( 
  ...
  oai21  g76(.a(x14), .b(new_n136_), .c(x45), .O(new_n170_));
  nand3  g77(.a(x46), .b(new_n156_), .c(x09), .O(new_n171_));
  aoi21  g78(.a(new_n171_), .b(new_n170_), .c(x10), .O(z34));
  oai21  g79(.a(x14), .b(new_n136_), .c(x46), .O(new_n173_));
  nand3  g80(.a(new_n156_), .b(x09), .c(x00), .O(new_n174_));
