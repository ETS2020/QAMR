// Benchmark "FAU" written by ABC on Mon Jul  6 19:22:51 2020
...
module FAU ( 
  ...
  nand2  g063(.a(x34), .b(new_n145_), .O(new_n150_));
  nand2  g064(.a(x35), .b(x09), .O(new_n151_));
  aoi21  g065(.a(new_n151_), .b(new_n150_), .c(x10), .O(z23));
  nand2  g066(.a(x35), .b(new_n145_), .O(new_n153_));
  nand2  g067(.a(x36), .b(x09), .O(new_n154_));
  aoi21  g068(.a(new_n154_), .b(new_n153_), .c(x10), .O(z24));
  nand2  g069(.a(x36), .b(new_n145_), .O(new_n156_));
  nand2  g070(.a(x37), .b(x09), .O(new_n157_));
  aoi21  g071(.a(new_n157_), .b(new_n156_), .c(x10), .O(z25));
  nand2  g072(.a(x37), .b(new_n145_), .O(new_n159_));
  nand2  g073(.a(x38), .b(x09), .O(new_n160_));
  aoi21  g074(.a(new_n160_), .b(new_n159_), .c(x10), .O(z26));
  oai21  g075(.a(x14), .b(new_n145_), .c(x39), .O(new_n163_));
  inv1   g076(.a(x14), .O(new_n164_));
  nand3  g077(.a(x40), .b(new_n164_), .c(x09), .O(new_n165_));
  aoi21  g078(.a(new_n165_), .b(new_n163_), .c(x10), .O(z28));
  oai21  g079(.a(x14), .b(new_n145_), .c(x40), .O(new_n167_));
  nand3  g080(.a(x41), .b(new_n164_), .c(x09), .O(new_n168_));
  aoi21  g081(.a(new_n168_), .b(new_n167_), .c(x10), .O(z29));
  oai21  g082(.a(x14), .b(new_n145_), .c(x41), .O(new_n170_));
  nand3  g083(.a(x42), .b(new_n164_), .c(x09), .O(new_n171_));
  aoi21  g084(.a(new_n171_), .b(new_n170_), .c(x10), .O(z30));
  oai21  g085(.a(x14), .b(new_n145_), .c(x42), .O(new_n173_));
  nand3  g086(.a(x43), .b(new_n164_), .c(x09), .O(new_n174_));
  aoi21  g087(.a(new_n174_), .b(new_n173_), .c(x10), .O(z31));
  oai21  g088(.a(x14), .b(new_n145_), .c(x43), .O(new_n176_));
  nand3  g089(.a(x44), .b(new_n164_), .c(x09), .O(new_n177_));
  aoi21  g090(.a(new_n177_), .b(new_n176_), .c(x10), .O(z32));
  oai21  g091(.a(x14), .b(new_n145_), .c(x44), .O(new_n179_));
  nand3  g092(.a(x45), .b(new_n164_), .c(x09), .O(new_n180_));
  aoi21  g093(.a(new_n180_), .b(new_n179_), .c(x10), .O(z33));
  oai21  g094(.a(x14), .b(new_n145_), .c(x45), .O(new_n182_));
  nand3  g095(.a(x46), .b(new_n164_), .c(x09), .O(new_n183_));
  aoi21  g096(.a(new_n183_), .b(new_n182_), .c(x10), .O(z34));
  oai21  g097(.a(x14), .b(new_n145_), .c(x46), .O(new_n185_));
  nand3  g098(.a(new_n164_), .b(x09), .c(x00), .O(new_n186_));
