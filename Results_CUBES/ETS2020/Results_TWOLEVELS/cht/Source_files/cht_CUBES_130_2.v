...
module FAU ( 
  ...
  nor2   g084(.a(x14), .b(new_n142_), .O(new_n172_));
  ...
  nand2  g090(.a(new_n170_), .b(x42), .O(new_n178_));
  nand2  g091(.a(new_n172_), .b(x43), .O(new_n179_));
  aoi21  g092(.a(new_n179_), .b(new_n178_), .c(x10), .O(z31));
  nand2  g093(.a(new_n170_), .b(x46), .O(new_n184_));
  nand2  g094(.a(new_n172_), .b(x00), .O(new_n185_));
