// Benchmark "FAU" written by ABC on Mon Jul  6 19:23:52 2020
...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n89_, new_n90_, new_n94_, new_n95_,
    ...
    new_n107_, new_n109_, new_n110_, new_n113_, new_n114_, new_n116_,
    ...
    new_n172_, new_n173_, new_n175_, new_n176_;
  ...
  nand2  g54(.a(x35), .b(new_n132_), .O(new_n145_));
  ...
  nand2  g64(.a(x38), .b(new_n132_), .O(new_n156_));
  ...
  nor2   g69(.a(x14), .b(new_n132_), .O(new_n161_));
  nand2  g70(.a(new_n161_), .b(x40), .O(new_n162_));
  aoi21  g71(.a(new_n162_), .b(new_n160_), .c(x10), .O(z28));
  nand2  g72(.a(new_n159_), .b(x42), .O(new_n166_));
  nand2  g73(.a(new_n161_), .b(x43), .O(new_n167_));
  aoi21  g74(.a(new_n167_), .b(new_n166_), .c(x10), .O(z31));
  nand2  g75(.a(new_n159_), .b(x43), .O(new_n169_));
  nand2  g76(.a(new_n161_), .b(x44), .O(new_n170_));
  aoi21  g77(.a(new_n170_), .b(new_n169_), .c(x10), .O(z32));
  nand2  g78(.a(new_n159_), .b(x44), .O(new_n172_));
  nand2  g79(.a(new_n161_), .b(x45), .O(new_n173_));
  aoi21  g80(.a(new_n173_), .b(new_n172_), .c(x10), .O(z33));
  nand2  g81(.a(new_n159_), .b(x45), .O(new_n175_));
  nand2  g82(.a(new_n161_), .b(x46), .O(new_n176_));
