// Benchmark "FAU" written by ABC on Mon Jul  6 19:23:21 2020
...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n88_, new_n89_, new_n95_, new_n96_,
    new_n97_, new_n99_, new_n100_, new_n104_, new_n105_, new_n107_,
    ...
    new_n150_, new_n152_, new_n153_, new_n155_, new_n156_, new_n159_,
  ...
  nand2  g17(.a(x22), .b(new_n95_), .O(new_n107_));
  ...
  nand2  g23(.a(x27), .b(new_n95_), .O(new_n116_));
  ...
  nand2  g45(.a(x37), .b(new_n124_), .O(new_n141_));
  nand2  g46(.a(x38), .b(x09), .O(new_n142_));
  aoi21  g47(.a(new_n142_), .b(new_n141_), .c(x10), .O(z26));
  oai21  g48(.a(x14), .b(new_n124_), .c(x39), .O(new_n145_));
  inv1   g49(.a(x14), .O(new_n146_));
  nand3  g50(.a(x40), .b(new_n146_), .c(x09), .O(new_n147_));
  aoi21  g51(.a(new_n147_), .b(new_n145_), .c(x10), .O(z28));
  oai21  g52(.a(x14), .b(new_n124_), .c(x40), .O(new_n149_));
  nand3  g53(.a(x41), .b(new_n146_), .c(x09), .O(new_n150_));
  aoi21  g54(.a(new_n150_), .b(new_n149_), .c(x10), .O(z29));
  oai21  g55(.a(x14), .b(new_n124_), .c(x41), .O(new_n152_));
  nand3  g56(.a(x42), .b(new_n146_), .c(x09), .O(new_n153_));
  aoi21  g57(.a(new_n153_), .b(new_n152_), .c(x10), .O(z30));
  oai21  g58(.a(x14), .b(new_n124_), .c(x42), .O(new_n155_));
  nand3  g59(.a(x43), .b(new_n146_), .c(x09), .O(new_n156_));
  aoi21  g60(.a(new_n156_), .b(new_n155_), .c(x10), .O(z31));
  oai21  g61(.a(x14), .b(new_n124_), .c(x44), .O(new_n159_));
  nand3  g62(.a(x45), .b(new_n146_), .c(x09), .O(new_n160_));
  aoi21  g63(.a(new_n160_), .b(new_n159_), .c(x10), .O(z33));
  oai21  g64(.a(x14), .b(new_n124_), .c(x45), .O(new_n162_));
  nand3  g65(.a(x46), .b(new_n146_), .c(x09), .O(new_n163_));
  aoi21  g66(.a(new_n163_), .b(new_n162_), .c(x10), .O(z34));
  oai21  g67(.a(x14), .b(new_n124_), .c(x46), .O(new_n165_));
  nand3  g68(.a(new_n146_), .b(x09), .c(x00), .O(new_n166_));
  aoi21  g69(.a(new_n166_), .b(new_n165_), .c(x10), .O(z35));
  zero   g70(.O(z02));
  zero   g71(.O(z03));
  zero   g72(.O(z04));
  zero   g73(.O(z05));
