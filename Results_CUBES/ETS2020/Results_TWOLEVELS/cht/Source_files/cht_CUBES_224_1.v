...
module FAU ( 
  ...
  wire new_n85_, new_n86_, new_n87_, new_n89_, new_n90_, new_n93_, new_n94_,
    ...
    new_n104_, new_n108_, new_n109_, new_n111_, new_n112_, new_n116_,
  ...
  inv1   g41(.a(x09), .O(new_n134_));
  nand2  g42(.a(x33), .b(new_n134_), .O(new_n135_));
  nand2  g43(.a(x34), .b(x09), .O(new_n136_));
  aoi21  g44(.a(new_n136_), .b(new_n135_), .c(x10), .O(z22));
  nand2  g45(.a(x37), .b(new_n134_), .O(new_n141_));
  ...
  nand2  g52(.a(x38), .b(new_n134_), .O(new_n148_));
  ...
  nor2   g57(.a(x14), .b(new_n134_), .O(new_n153_));
