...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n88_, new_n89_, new_n94_, new_n95_,
    new_n97_, new_n98_, new_n99_, new_n102_, new_n103_, new_n106_,
    ...
    new_n148_, new_n152_, new_n153_, new_n154_, new_n155_, new_n156_,
    new_n158_, new_n159_, new_n164_, new_n165_;
  ...
  nand2  g52(.a(x38), .b(new_n127_), .O(new_n148_));
  aoi21  g53(.a(new_n148_), .b(new_n147_), .c(x10), .O(z27));
  inv1   g54(.a(x14), .O(new_n152_));
  nand2  g55(.a(new_n152_), .b(x09), .O(new_n153_));
  nand2  g56(.a(new_n153_), .b(x41), .O(new_n154_));
  nor2   g57(.a(x14), .b(new_n127_), .O(new_n155_));
  nand2  g58(.a(new_n155_), .b(x42), .O(new_n156_));
  aoi21  g59(.a(new_n156_), .b(new_n154_), .c(x10), .O(z30));
  nand2  g60(.a(new_n153_), .b(x42), .O(new_n158_));
  nand2  g61(.a(new_n155_), .b(x43), .O(new_n159_));
  aoi21  g62(.a(new_n159_), .b(new_n158_), .c(x10), .O(z31));
  nand2  g63(.a(new_n153_), .b(x46), .O(new_n164_));
  nand2  g64(.a(new_n155_), .b(x00), .O(new_n165_));
