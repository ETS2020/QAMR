...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n88_, new_n89_, new_n91_, new_n92_,
    ...
    new_n103_, new_n104_, new_n105_, new_n107_, new_n108_, new_n113_,
    ...
    new_n169_, new_n171_, new_n172_, new_n175_, new_n176_, new_n178_,
    new_n179_;
  ...
  nand2  g29(.a(x24), .b(new_n103_), .O(new_n117_));
  nand2  g30(.a(x25), .b(x08), .O(new_n118_));
  aoi21  g31(.a(new_n118_), .b(new_n117_), .c(x10), .O(z13));
  nand2  g32(.a(x25), .b(new_n103_), .O(new_n120_));
