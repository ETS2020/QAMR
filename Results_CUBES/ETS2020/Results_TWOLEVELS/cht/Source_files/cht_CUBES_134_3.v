// Benchmark "FAU" written by ABC on Mon Jul  6 19:23:08 2020
...
module FAU ( 
  ...
  nor2   g081(.a(x14), .b(new_n140_), .O(new_n169_));
  nand2  g082(.a(new_n169_), .b(x40), .O(new_n170_));
  aoi21  g083(.a(new_n170_), .b(new_n168_), .c(x10), .O(z28));
  nand2  g084(.a(new_n167_), .b(x41), .O(new_n173_));
  nand2  g085(.a(new_n169_), .b(x42), .O(new_n174_));
  aoi21  g086(.a(new_n174_), .b(new_n173_), .c(x10), .O(z30));
  nand2  g087(.a(new_n167_), .b(x44), .O(new_n178_));
  nand2  g088(.a(new_n169_), .b(x45), .O(new_n179_));
  aoi21  g089(.a(new_n179_), .b(new_n178_), .c(x10), .O(z33));
  nand2  g090(.a(new_n167_), .b(x45), .O(new_n181_));
  nand2  g091(.a(new_n169_), .b(x46), .O(new_n182_));
  aoi21  g092(.a(new_n182_), .b(new_n181_), .c(x10), .O(z34));
  nand2  g093(.a(new_n167_), .b(x46), .O(new_n184_));
  nand2  g094(.a(new_n169_), .b(x00), .O(new_n185_));
