...
module FAU ( 
  ...
  oai21  g66(.a(x14), .b(new_n138_), .c(x40), .O(new_n158_));
  inv1   g67(.a(x14), .O(new_n159_));
  nand3  g68(.a(x41), .b(new_n159_), .c(x09), .O(new_n160_));
  aoi21  g69(.a(new_n160_), .b(new_n158_), .c(x10), .O(z29));
  oai21  g70(.a(x14), .b(new_n138_), .c(x42), .O(new_n163_));
  nand3  g71(.a(x43), .b(new_n159_), .c(x09), .O(new_n164_));
  aoi21  g72(.a(new_n164_), .b(new_n163_), .c(x10), .O(z31));
  oai21  g73(.a(x14), .b(new_n138_), .c(x43), .O(new_n166_));
  nand3  g74(.a(x44), .b(new_n159_), .c(x09), .O(new_n167_));
  aoi21  g75(.a(new_n167_), .b(new_n166_), .c(x10), .O(z32));
  oai21  g76(.a(x14), .b(new_n138_), .c(x44), .O(new_n169_));
  nand3  g77(.a(x45), .b(new_n159_), .c(x09), .O(new_n170_));
  aoi21  g78(.a(new_n170_), .b(new_n169_), .c(x10), .O(z33));
  oai21  g79(.a(x14), .b(new_n138_), .c(x45), .O(new_n172_));
  nand3  g80(.a(x46), .b(new_n159_), .c(x09), .O(new_n173_));
