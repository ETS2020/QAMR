...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n90_, new_n91_, new_n94_, new_n95_,
    ...
    new_n115_, new_n119_, new_n120_, new_n125_, new_n126_, new_n128_,
  ...
  oai21  g55(.a(x14), .b(new_n128_), .c(x41), .O(new_n152_));
  nand3  g56(.a(x42), .b(new_n149_), .c(x09), .O(new_n153_));
  aoi21  g57(.a(new_n153_), .b(new_n152_), .c(x10), .O(z30));
  oai21  g58(.a(x14), .b(new_n128_), .c(x42), .O(new_n155_));
  nand3  g59(.a(x43), .b(new_n149_), .c(x09), .O(new_n156_));
  aoi21  g60(.a(new_n156_), .b(new_n155_), .c(x10), .O(z31));
  oai21  g61(.a(x14), .b(new_n128_), .c(x43), .O(new_n158_));
  nand3  g62(.a(x44), .b(new_n149_), .c(x09), .O(new_n159_));
  aoi21  g63(.a(new_n159_), .b(new_n158_), .c(x10), .O(z32));
  oai21  g64(.a(x14), .b(new_n128_), .c(x44), .O(new_n161_));
  nand3  g65(.a(x45), .b(new_n149_), .c(x09), .O(new_n162_));
  aoi21  g66(.a(new_n162_), .b(new_n161_), .c(x10), .O(z33));
  oai21  g67(.a(x14), .b(new_n128_), .c(x45), .O(new_n164_));
  nand3  g68(.a(x46), .b(new_n149_), .c(x09), .O(new_n165_));
