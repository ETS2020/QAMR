// Benchmark "FAU" written by ABC on Mon Jul  6 19:23:19 2020
...
module FAU ( 
  ...
  wire new_n87_, new_n88_, new_n89_, new_n91_, new_n92_, new_n94_, new_n95_,
    new_n97_, new_n98_, new_n99_, new_n102_, new_n103_, new_n107_,
  ...
  nor2   g66(.a(x14), .b(new_n130_), .O(new_n159_));
  ...
  nand2  g75(.a(new_n157_), .b(x44), .O(new_n170_));
  nand2  g76(.a(new_n159_), .b(x45), .O(new_n171_));
  aoi21  g77(.a(new_n171_), .b(new_n170_), .c(x10), .O(z33));
  nand2  g78(.a(new_n157_), .b(x45), .O(new_n173_));
  nand2  g79(.a(new_n159_), .b(x46), .O(new_n174_));
  aoi21  g80(.a(new_n174_), .b(new_n173_), .c(x10), .O(z34));
  nand2  g81(.a(new_n157_), .b(x46), .O(new_n176_));
  nand2  g82(.a(new_n159_), .b(x00), .O(new_n177_));
