...
module FAU ( 
  ...
  wire new_n85_, new_n86_, new_n87_, new_n89_, new_n90_, new_n92_, new_n93_,
    ...
    new_n103_, new_n105_, new_n106_, new_n108_, new_n109_, new_n114_,
  ...
  nand2  g69(.a(new_n159_), .b(x44), .O(new_n166_));
  nand2  g70(.a(new_n161_), .b(x45), .O(new_n167_));
  aoi21  g71(.a(new_n167_), .b(new_n166_), .c(x10), .O(z33));
  nand2  g72(.a(new_n159_), .b(x46), .O(new_n170_));
  nand2  g73(.a(new_n161_), .b(x00), .O(new_n171_));
