...
module FAU ( 
  ...
  wire new_n77_, new_n78_, new_n79_, new_n80_, new_n81_, new_n82_, new_n83_,
    ...
    new_n119_, new_n129_, new_n130_, new_n132_, new_n140_, new_n141_,
  ...
  nor4   g014(.a(new_n89_), .b(x6), .c(x5), .d(x4), .O(z06));
  inv1   g015(.a(x2), .O(new_n91_));
  nor2   g016(.a(new_n86_), .b(x0), .O(new_n92_));
  ...
  nor2   g024(.a(new_n80_), .b(new_n99_), .O(new_n100_));
  nand2  g025(.a(new_n100_), .b(new_n79_), .O(new_n101_));
  nor2   g026(.a(new_n86_), .b(new_n85_), .O(new_n102_));
  inv1   g027(.a(x3), .O(new_n103_));
  nand2  g028(.a(new_n103_), .b(x2), .O(new_n104_));
  inv1   g029(.a(new_n104_), .O(new_n105_));
  nand2  g030(.a(new_n105_), .b(new_n102_), .O(new_n106_));
  nor2   g031(.a(new_n106_), .b(new_n101_), .O(z08));
  nor2   g032(.a(new_n99_), .b(x5), .O(new_n108_));
  nand3  g033(.a(new_n108_), .b(new_n94_), .c(x7), .O(new_n109_));
  nor2   g034(.a(new_n109_), .b(new_n87_), .O(z09));
  nand2  g035(.a(new_n92_), .b(x2), .O(new_n111_));
  nor2   g036(.a(new_n111_), .b(new_n101_), .O(z10));
  nand2  g037(.a(new_n102_), .b(new_n91_), .O(new_n113_));
  nor2   g038(.a(new_n113_), .b(new_n97_), .O(z11));
  nand3  g039(.a(new_n96_), .b(new_n77_), .c(x3), .O(new_n116_));
  nor2   g040(.a(new_n116_), .b(new_n93_), .O(z13));
  nand2  g041(.a(new_n86_), .b(x0), .O(new_n118_));
  nand2  g042(.a(x3), .b(new_n91_), .O(new_n119_));
  nor3   g043(.a(new_n119_), .b(new_n118_), .c(new_n101_), .O(z14));
  nor2   g044(.a(new_n116_), .b(new_n111_), .O(z15));
  nor2   g045(.a(new_n116_), .b(new_n113_), .O(z16));
  nor3   g046(.a(new_n89_), .b(x5), .c(new_n77_), .O(z18));
  inv1   g047(.a(x5), .O(new_n129_));
  nand3  g048(.a(new_n91_), .b(new_n86_), .c(new_n85_), .O(new_n130_));
  nor3   g049(.a(new_n130_), .b(new_n129_), .c(new_n103_), .O(z23));
  nand3  g050(.a(new_n108_), .b(new_n94_), .c(new_n80_), .O(new_n132_));
  nor2   g051(.a(new_n132_), .b(new_n130_), .O(z24));
  nor2   g052(.a(new_n132_), .b(new_n111_), .O(z27));
  nand2  g053(.a(x6), .b(new_n77_), .O(new_n140_));
  inv1   g054(.a(new_n140_), .O(new_n141_));
  nor2   g055(.a(new_n141_), .b(new_n85_), .O(new_n142_));
  nor2   g056(.a(new_n77_), .b(x3), .O(new_n143_));
  oai21  g057(.a(new_n143_), .b(new_n142_), .c(x2), .O(new_n144_));
  oai21  g058(.a(new_n140_), .b(new_n91_), .c(x0), .O(new_n145_));
  aoi22  g059(.a(new_n145_), .b(x1), .c(new_n129_), .d(x4), .O(new_n146_));
  oai21  g060(.a(new_n103_), .b(x0), .c(new_n86_), .O(new_n147_));
  nand2  g061(.a(new_n147_), .b(new_n91_), .O(new_n148_));
  aoi21  g062(.a(new_n118_), .b(x5), .c(new_n99_), .O(new_n149_));
  inv1   g063(.a(new_n108_), .O(new_n150_));
  nand2  g064(.a(new_n150_), .b(new_n85_), .O(new_n151_));
  nand2  g065(.a(new_n99_), .b(x5), .O(new_n152_));
  nand2  g066(.a(new_n152_), .b(new_n151_), .O(new_n153_));
  oai21  g067(.a(new_n153_), .b(new_n149_), .c(new_n77_), .O(new_n154_));
  nand4  g068(.a(new_n154_), .b(new_n148_), .c(new_n146_), .d(new_n144_), .O(z31));
  nand2  g069(.a(x2), .b(x1), .O(new_n159_));
  aoi21  g070(.a(new_n159_), .b(x5), .c(new_n99_), .O(new_n160_));
  oai21  g071(.a(new_n160_), .b(new_n153_), .c(new_n77_), .O(new_n161_));
  oai21  g072(.a(new_n140_), .b(new_n85_), .c(new_n104_), .O(new_n162_));
  nand2  g073(.a(new_n162_), .b(new_n86_), .O(new_n163_));
  nand2  g074(.a(new_n119_), .b(new_n86_), .O(new_n164_));
  nor2   g075(.a(x3), .b(x2), .O(new_n165_));
  aoi22  g076(.a(new_n165_), .b(x1), .c(new_n164_), .d(new_n85_), .O(new_n166_));
  nand2  g077(.a(x4), .b(x0), .O(new_n167_));
  nand3  g078(.a(new_n129_), .b(x3), .c(new_n85_), .O(new_n168_));
  aoi21  g079(.a(new_n168_), .b(new_n167_), .c(new_n91_), .O(new_n169_));
  oai21  g080(.a(new_n119_), .b(new_n86_), .c(x5), .O(new_n170_));
  aoi21  g081(.a(new_n170_), .b(x0), .c(new_n169_), .O(new_n171_));
  nand4  g082(.a(new_n171_), .b(new_n166_), .c(new_n163_), .d(new_n161_), .O(z35));
  nand2  g083(.a(new_n164_), .b(new_n85_), .O(new_n178_));
  nand2  g084(.a(new_n105_), .b(x0), .O(new_n179_));
  ...
  nand2  g132(.a(new_n119_), .b(new_n104_), .O(new_n229_));
  nand3  g133(.a(new_n229_), .b(new_n102_), .c(new_n100_), .O(new_n230_));
  nor2   g134(.a(new_n99_), .b(new_n85_), .O(new_n231_));
  aoi21  g135(.a(new_n231_), .b(new_n230_), .c(new_n129_), .O(new_n232_));
  aoi21  g136(.a(new_n86_), .b(x0), .c(new_n80_), .O(new_n233_));
  nand2  g137(.a(new_n165_), .b(new_n99_), .O(new_n234_));
  oai21  g138(.a(new_n233_), .b(new_n99_), .c(new_n234_), .O(new_n235_));
  oai21  g139(.a(new_n235_), .b(new_n232_), .c(new_n77_), .O(new_n236_));
  nand2  g140(.a(new_n141_), .b(x1), .O(new_n237_));
  nand2  g141(.a(new_n237_), .b(new_n85_), .O(new_n238_));
  oai21  g142(.a(new_n165_), .b(x4), .c(x0), .O(new_n239_));
  nand3  g143(.a(new_n99_), .b(x3), .c(new_n91_), .O(new_n240_));
  nand3  g144(.a(new_n240_), .b(new_n239_), .c(new_n211_), .O(new_n241_));
  aoi21  g145(.a(new_n238_), .b(new_n129_), .c(new_n241_), .O(new_n242_));
  nand2  g146(.a(new_n242_), .b(new_n236_), .O(z47));
  aoi21  g147(.a(x7), .b(x6), .c(new_n129_), .O(new_n244_));
  oai21  g148(.a(new_n244_), .b(new_n108_), .c(new_n77_), .O(new_n245_));
  nand4  g149(.a(x3), .b(new_n91_), .c(new_n86_), .d(new_n85_), .O(new_n246_));
  inv1   g150(.a(new_n246_), .O(new_n247_));
  nand2  g151(.a(new_n247_), .b(new_n245_), .O(z48));
  nand2  g152(.a(new_n222_), .b(x0), .O(new_n249_));
  aoi21  g153(.a(new_n77_), .b(x2), .c(new_n103_), .O(new_n250_));
  nand2  g154(.a(new_n78_), .b(new_n86_), .O(new_n251_));
  oai21  g155(.a(new_n251_), .b(new_n250_), .c(new_n85_), .O(new_n252_));
  nor2   g156(.a(new_n103_), .b(new_n85_), .O(new_n253_));
  oai21  g157(.a(new_n165_), .b(new_n253_), .c(new_n86_), .O(new_n254_));
  nand2  g158(.a(new_n108_), .b(new_n77_), .O(new_n255_));
  nand4  g159(.a(new_n255_), .b(new_n254_), .c(new_n252_), .d(new_n249_), .O(z49));
  nand2  g160(.a(x7), .b(x5), .O(new_n257_));
  nand3  g161(.a(x3), .b(new_n91_), .c(x1), .O(new_n258_));
  ...
  aoi21  g165(.a(new_n261_), .b(new_n260_), .c(new_n99_), .O(new_n262_));
  nand2  g166(.a(new_n105_), .b(new_n129_), .O(new_n263_));
  nand2  g167(.a(new_n263_), .b(new_n151_), .O(new_n264_));
  oai21  g168(.a(new_n264_), .b(new_n262_), .c(new_n77_), .O(new_n265_));
  nand3  g169(.a(new_n129_), .b(x3), .c(x2), .O(new_n266_));
  aoi21  g170(.a(new_n266_), .b(new_n77_), .c(x0), .O(new_n267_));
  nand2  g171(.a(new_n99_), .b(x3), .O(new_n268_));
  nand2  g172(.a(new_n103_), .b(x0), .O(new_n269_));
  ...
  nand2  g181(.a(new_n251_), .b(new_n85_), .O(new_n278_));
  nand3  g182(.a(new_n278_), .b(new_n277_), .c(new_n275_), .O(new_n279_));
  or2    g183(.a(new_n279_), .b(new_n274_), .O(z51));
  aoi21  g184(.a(new_n140_), .b(new_n103_), .c(x1), .O(new_n281_));
  nand3  g185(.a(x7), .b(x6), .c(x5), .O(new_n282_));
  oai21  g186(.a(new_n282_), .b(x4), .c(new_n103_), .O(new_n283_));
  and2   g187(.a(new_n283_), .b(x1), .O(new_n284_));
  oai21  g188(.a(new_n284_), .b(new_n281_), .c(x0), .O(new_n285_));
  nor2   g189(.a(new_n80_), .b(new_n129_), .O(new_n286_));
  oai22  g190(.a(new_n286_), .b(new_n99_), .c(new_n231_), .d(new_n129_), .O(new_n287_));
  nand2  g191(.a(new_n287_), .b(new_n77_), .O(new_n288_));
  nor2   g192(.a(new_n77_), .b(new_n103_), .O(new_n289_));
  nand2  g193(.a(new_n289_), .b(x2), .O(new_n290_));
  nand2  g194(.a(new_n290_), .b(new_n86_), .O(new_n291_));
  aoi22  g195(.a(new_n291_), .b(new_n85_), .c(new_n165_), .d(new_n86_), .O(new_n292_));
  nand3  g196(.a(new_n292_), .b(new_n288_), .c(new_n285_), .O(z52));
  aoi21  g197(.a(new_n103_), .b(new_n85_), .c(x2), .O(new_n294_));
  nor2   g198(.a(new_n91_), .b(x0), .O(new_n295_));
  nor2   g199(.a(new_n80_), .b(new_n86_), .O(new_n296_));
  oai21  g200(.a(new_n295_), .b(new_n294_), .c(new_n296_), .O(new_n297_));
  nand3  g201(.a(new_n297_), .b(x7), .c(x6), .O(new_n298_));
  nand2  g202(.a(new_n234_), .b(new_n150_), .O(new_n299_));
  aoi21  g203(.a(new_n298_), .b(x5), .c(new_n299_), .O(new_n300_));
  nand3  g204(.a(x5), .b(new_n91_), .c(new_n86_), .O(new_n301_));
  nand2  g205(.a(new_n129_), .b(x2), .O(new_n302_));
  ...
  oai21  g210(.a(new_n223_), .b(new_n105_), .c(x0), .O(new_n307_));
  oai21  g211(.a(new_n105_), .b(new_n129_), .c(new_n86_), .O(new_n308_));
  ...
  nand4  g216(.a(new_n312_), .b(new_n91_), .c(x1), .d(new_n85_), .O(new_n313_));
  aoi21  g217(.a(new_n313_), .b(new_n302_), .c(x3), .O(new_n314_));
  aoi21  g218(.a(new_n286_), .b(new_n118_), .c(new_n99_), .O(new_n315_));
  oai21  g219(.a(new_n315_), .b(new_n314_), .c(new_n77_), .O(new_n316_));
  inv1   g220(.a(new_n119_), .O(new_n317_));
  oai21  g221(.a(new_n317_), .b(new_n79_), .c(new_n99_), .O(new_n318_));
  oai21  g222(.a(new_n181_), .b(new_n78_), .c(x0), .O(new_n319_));
  and2   g223(.a(new_n319_), .b(new_n318_), .O(new_n320_));
  oai21  g224(.a(new_n185_), .b(new_n165_), .c(new_n86_), .O(new_n321_));
  nand2  g225(.a(new_n229_), .b(x4), .O(new_n322_));
  nand4  g226(.a(new_n322_), .b(new_n321_), .c(new_n320_), .d(new_n316_), .O(z54));
  nand2  g227(.a(new_n317_), .b(new_n86_), .O(new_n324_));
  aoi21  g228(.a(new_n324_), .b(x4), .c(x0), .O(new_n325_));
  aoi21  g229(.a(new_n317_), .b(new_n102_), .c(new_n80_), .O(new_n326_));
  nand2  g230(.a(new_n326_), .b(x6), .O(new_n327_));
  aoi21  g231(.a(new_n327_), .b(new_n77_), .c(new_n325_), .O(new_n328_));
  oai21  g232(.a(new_n192_), .b(new_n103_), .c(x5), .O(new_n329_));
  nand2  g233(.a(new_n329_), .b(new_n86_), .O(new_n330_));
  oai21  g234(.a(x2), .b(new_n85_), .c(x1), .O(new_n331_));
  nand2  g235(.a(new_n331_), .b(new_n103_), .O(new_n332_));
  nand3  g236(.a(new_n140_), .b(x2), .c(x0), .O(new_n333_));
  nand4  g237(.a(new_n333_), .b(new_n332_), .c(new_n330_), .d(new_n255_), .O(new_n334_));
  inv1   g238(.a(new_n334_), .O(new_n335_));
  oai21  g239(.a(new_n328_), .b(new_n129_), .c(new_n335_), .O(z55));
  aoi21  g240(.a(new_n100_), .b(new_n77_), .c(new_n86_), .O(new_n337_));
  ...
  nand2  g244(.a(new_n78_), .b(new_n85_), .O(new_n341_));
  aoi21  g245(.a(new_n341_), .b(x1), .c(new_n103_), .O(new_n342_));
  ...
  aoi21  g250(.a(new_n129_), .b(new_n86_), .c(new_n165_), .O(new_n347_));
  nand4  g251(.a(new_n347_), .b(new_n346_), .c(new_n344_), .d(new_n340_), .O(z56));
  nand2  g252(.a(new_n94_), .b(x1), .O(new_n349_));
  oai21  g253(.a(new_n349_), .b(new_n282_), .c(new_n103_), .O(new_n350_));
  nand2  g254(.a(new_n350_), .b(new_n85_), .O(new_n351_));
  nor3   g255(.a(new_n282_), .b(new_n180_), .c(x4), .O(new_n352_));
  oai21  g256(.a(new_n352_), .b(new_n103_), .c(x0), .O(new_n353_));
  nand3  g257(.a(new_n353_), .b(new_n351_), .c(new_n275_), .O(new_n354_));
  nand2  g258(.a(new_n354_), .b(new_n91_), .O(new_n355_));
  nand3  g259(.a(new_n283_), .b(x1), .c(x0), .O(new_n356_));
  oai21  g260(.a(new_n218_), .b(new_n86_), .c(new_n103_), .O(new_n357_));
  ...
  aoi21  g265(.a(new_n260_), .b(new_n204_), .c(new_n99_), .O(new_n362_));
  ...
  nand2  g270(.a(new_n366_), .b(new_n103_), .O(new_n367_));
  aoi22  g271(.a(new_n289_), .b(new_n91_), .c(new_n78_), .d(x0), .O(new_n368_));
  ...
  nand2  g276(.a(new_n140_), .b(x3), .O(new_n373_));
  aoi21  g277(.a(new_n373_), .b(new_n86_), .c(new_n165_), .O(new_n374_));
  oai21  g278(.a(new_n372_), .b(new_n180_), .c(new_n374_), .O(new_n375_));
  nand2  g279(.a(new_n375_), .b(x0), .O(new_n376_));
  nor2   g280(.a(new_n108_), .b(x0), .O(new_n377_));
  ...
  aoi21  g285(.a(x4), .b(new_n85_), .c(new_n381_), .O(new_n382_));
  nand4  g286(.a(new_n382_), .b(new_n380_), .c(new_n378_), .d(new_n376_), .O(z59));
  inv1   g287(.a(new_n286_), .O(new_n384_));
  nand3  g288(.a(x7), .b(x5), .c(new_n103_), .O(new_n385_));
  oai21  g289(.a(new_n385_), .b(new_n85_), .c(new_n91_), .O(new_n386_));
  aoi21  g290(.a(new_n386_), .b(x1), .c(new_n384_), .O(new_n387_));
  nand2  g291(.a(new_n302_), .b(new_n212_), .O(new_n388_));
  aoi22  g292(.a(new_n388_), .b(new_n103_), .c(new_n99_), .d(x5), .O(new_n389_));
  oai21  g293(.a(new_n387_), .b(new_n99_), .c(new_n389_), .O(new_n390_));
  ...
  oai21  g297(.a(x4), .b(x1), .c(new_n85_), .O(new_n394_));
