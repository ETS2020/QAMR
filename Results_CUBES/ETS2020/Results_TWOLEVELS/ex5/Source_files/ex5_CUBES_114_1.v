// Benchmark "FAU" written by ABC on Thu Jul  9 07:36:49 2020
...
module FAU ( 
  ...
  nor2   g041(.a(new_n117_), .b(new_n114_), .O(z16));
  nor2   g042(.a(x5), .b(new_n77_), .O(new_n123_));
  inv1   g043(.a(new_n123_), .O(new_n124_));
  nor2   g044(.a(new_n124_), .b(new_n86_), .O(z18));
  inv1   g045(.a(x5), .O(new_n130_));
  nand2  g046(.a(new_n85_), .b(new_n88_), .O(new_n131_));
  nor3   g047(.a(new_n131_), .b(new_n130_), .c(new_n102_), .O(z23));
  nand4  g048(.a(new_n92_), .b(new_n85_), .c(new_n130_), .d(new_n88_), .O(new_n133_));
  nor2   g049(.a(new_n133_), .b(new_n81_), .O(z24));
  nor4   g050(.a(new_n112_), .b(new_n110_), .c(new_n108_), .d(x7), .O(z27));
  nor3   g051(.a(new_n133_), .b(new_n80_), .c(x6), .O(z29));
  oai21  g052(.a(new_n102_), .b(x0), .c(new_n89_), .O(new_n141_));
  nand2  g053(.a(new_n141_), .b(new_n88_), .O(new_n142_));
  nand2  g054(.a(x6), .b(new_n77_), .O(new_n143_));
  oai21  g055(.a(new_n143_), .b(new_n100_), .c(new_n103_), .O(new_n144_));
  nand2  g056(.a(new_n144_), .b(new_n89_), .O(new_n145_));
  nor2   g057(.a(new_n123_), .b(new_n90_), .O(new_n146_));
  and2   g058(.a(new_n146_), .b(new_n145_), .O(new_n147_));
  nor2   g059(.a(new_n97_), .b(x4), .O(new_n148_));
  nand2  g060(.a(new_n148_), .b(x1), .O(new_n149_));
  oai21  g061(.a(new_n148_), .b(new_n100_), .c(new_n149_), .O(new_n150_));
  nand2  g062(.a(new_n150_), .b(x2), .O(new_n151_));
  nand2  g063(.a(new_n97_), .b(x5), .O(new_n152_));
  nand3  g064(.a(new_n152_), .b(new_n110_), .c(x0), .O(new_n153_));
  nand2  g065(.a(new_n153_), .b(new_n77_), .O(new_n154_));
  nand4  g066(.a(new_n154_), .b(new_n151_), .c(new_n147_), .d(new_n142_), .O(z31));
  nand2  g067(.a(x2), .b(x1), .O(new_n159_));
  aoi21  g068(.a(new_n159_), .b(x5), .c(new_n97_), .O(new_n160_));
  nand2  g069(.a(new_n110_), .b(new_n100_), .O(new_n161_));
  nand2  g070(.a(new_n152_), .b(new_n161_), .O(new_n162_));
  oai21  g071(.a(new_n162_), .b(new_n160_), .c(new_n77_), .O(new_n163_));
  nand2  g072(.a(x3), .b(new_n88_), .O(new_n164_));
  nand2  g073(.a(new_n164_), .b(new_n89_), .O(new_n165_));
  nor2   g074(.a(x3), .b(x2), .O(new_n166_));
  aoi22  g075(.a(new_n166_), .b(x1), .c(new_n165_), .d(new_n100_), .O(new_n167_));
  nand2  g076(.a(x4), .b(x0), .O(new_n168_));
  nand3  g077(.a(new_n130_), .b(x3), .c(new_n100_), .O(new_n169_));
  aoi21  g078(.a(new_n169_), .b(new_n168_), .c(new_n88_), .O(new_n170_));
  oai21  g079(.a(new_n164_), .b(new_n89_), .c(x5), .O(new_n171_));
  aoi21  g080(.a(new_n171_), .b(x0), .c(new_n170_), .O(new_n172_));
  nand4  g081(.a(new_n172_), .b(new_n167_), .c(new_n163_), .d(new_n145_), .O(z35));
  nand2  g082(.a(new_n165_), .b(new_n100_), .O(new_n179_));
  nand2  g083(.a(new_n104_), .b(x0), .O(new_n180_));
  ...
  nand2  g135(.a(new_n164_), .b(new_n103_), .O(new_n234_));
  nand3  g136(.a(new_n234_), .b(new_n101_), .c(new_n98_), .O(new_n235_));
  nor2   g137(.a(new_n97_), .b(new_n100_), .O(new_n236_));
  aoi21  g138(.a(new_n236_), .b(new_n235_), .c(new_n130_), .O(new_n237_));
  aoi21  g139(.a(new_n89_), .b(x0), .c(new_n80_), .O(new_n238_));
  nand2  g140(.a(new_n166_), .b(new_n97_), .O(new_n239_));
  oai21  g141(.a(new_n238_), .b(new_n97_), .c(new_n239_), .O(new_n240_));
  oai21  g142(.a(new_n240_), .b(new_n237_), .c(new_n77_), .O(new_n241_));
  aoi21  g143(.a(new_n149_), .b(new_n100_), .c(x5), .O(new_n242_));
  oai21  g144(.a(new_n166_), .b(x4), .c(x0), .O(new_n243_));
  nand3  g145(.a(new_n97_), .b(x3), .c(new_n88_), .O(new_n244_));
  ...
  aoi21  g149(.a(x7), .b(x6), .c(new_n130_), .O(new_n248_));
  oai21  g150(.a(new_n248_), .b(new_n109_), .c(new_n77_), .O(new_n249_));
  nand4  g151(.a(x3), .b(new_n88_), .c(new_n89_), .d(new_n100_), .O(new_n250_));
  inv1   g152(.a(new_n250_), .O(new_n251_));
  nand2  g153(.a(new_n251_), .b(new_n249_), .O(z48));
  nand2  g154(.a(new_n227_), .b(x0), .O(new_n253_));
  aoi21  g155(.a(new_n77_), .b(x2), .c(new_n102_), .O(new_n254_));
  nand2  g156(.a(new_n78_), .b(new_n89_), .O(new_n255_));
  oai21  g157(.a(new_n255_), .b(new_n254_), .c(new_n100_), .O(new_n256_));
  nor2   g158(.a(new_n102_), .b(new_n100_), .O(new_n257_));
  oai21  g159(.a(new_n166_), .b(new_n257_), .c(new_n89_), .O(new_n258_));
  nand2  g160(.a(new_n109_), .b(new_n77_), .O(new_n259_));
  nand4  g161(.a(new_n259_), .b(new_n258_), .c(new_n256_), .d(new_n253_), .O(z49));
  nand2  g162(.a(x7), .b(x5), .O(new_n261_));
  nand3  g163(.a(x3), .b(new_n88_), .c(x1), .O(new_n262_));
  ...
  aoi21  g167(.a(new_n265_), .b(new_n264_), .c(new_n97_), .O(new_n266_));
  nand2  g168(.a(new_n104_), .b(new_n130_), .O(new_n267_));
  nand2  g169(.a(new_n267_), .b(new_n161_), .O(new_n268_));
  oai21  g170(.a(new_n268_), .b(new_n266_), .c(new_n77_), .O(new_n269_));
  nand3  g171(.a(new_n130_), .b(x3), .c(x2), .O(new_n270_));
  aoi21  g172(.a(new_n270_), .b(new_n77_), .c(x0), .O(new_n271_));
  nand2  g173(.a(new_n97_), .b(x3), .O(new_n272_));
  nand2  g174(.a(new_n102_), .b(x0), .O(new_n273_));
  ...
  oai21  g216(.a(new_n228_), .b(new_n104_), .c(x0), .O(new_n315_));
  oai21  g217(.a(new_n104_), .b(new_n130_), .c(new_n89_), .O(new_n316_));
  ...
  nand4  g221(.a(new_n287_), .b(new_n88_), .c(x1), .d(new_n100_), .O(new_n320_));
  aoi21  g222(.a(new_n320_), .b(new_n310_), .c(x3), .O(new_n321_));
  inv1   g223(.a(new_n291_), .O(new_n322_));
  aoi21  g224(.a(new_n322_), .b(new_n191_), .c(new_n97_), .O(new_n323_));
  oai21  g225(.a(new_n323_), .b(new_n321_), .c(new_n77_), .O(new_n324_));
  inv1   g226(.a(new_n164_), .O(new_n325_));
  oai21  g227(.a(new_n325_), .b(new_n79_), .c(new_n97_), .O(new_n326_));
  oai21  g228(.a(new_n182_), .b(new_n78_), .c(x0), .O(new_n327_));
  and2   g229(.a(new_n327_), .b(new_n326_), .O(new_n328_));
  oai21  g230(.a(new_n186_), .b(new_n166_), .c(new_n89_), .O(new_n329_));
  nand2  g231(.a(new_n234_), .b(x4), .O(new_n330_));
  nand4  g232(.a(new_n330_), .b(new_n329_), .c(new_n328_), .d(new_n324_), .O(z54));
  nand2  g233(.a(new_n325_), .b(new_n89_), .O(new_n332_));
  aoi21  g234(.a(new_n332_), .b(x4), .c(x0), .O(new_n333_));
  aoi21  g235(.a(new_n325_), .b(new_n101_), .c(new_n80_), .O(new_n334_));
  nand2  g236(.a(new_n334_), .b(x6), .O(new_n335_));
  aoi21  g237(.a(new_n335_), .b(new_n77_), .c(new_n333_), .O(new_n336_));
  oai21  g238(.a(new_n195_), .b(new_n102_), .c(x5), .O(new_n337_));
  nand2  g239(.a(new_n337_), .b(new_n89_), .O(new_n338_));
  oai21  g240(.a(x2), .b(new_n100_), .c(x1), .O(new_n339_));
  nand2  g241(.a(new_n339_), .b(new_n102_), .O(new_n340_));
  nand3  g242(.a(new_n143_), .b(x2), .c(x0), .O(new_n341_));
  nand4  g243(.a(new_n341_), .b(new_n340_), .c(new_n338_), .d(new_n259_), .O(new_n342_));
  inv1   g244(.a(new_n342_), .O(new_n343_));
  oai21  g245(.a(new_n336_), .b(new_n130_), .c(new_n343_), .O(z55));
  aoi21  g246(.a(new_n98_), .b(new_n77_), .c(new_n89_), .O(new_n345_));
  ...
  nand2  g250(.a(new_n78_), .b(new_n100_), .O(new_n349_));
  aoi21  g251(.a(new_n349_), .b(x1), .c(new_n102_), .O(new_n350_));
  ...
  aoi21  g256(.a(new_n130_), .b(new_n89_), .c(new_n166_), .O(new_n355_));
  nand4  g257(.a(new_n355_), .b(new_n354_), .c(new_n352_), .d(new_n348_), .O(z56));
  nand2  g258(.a(new_n92_), .b(x1), .O(new_n357_));
  oai21  g259(.a(new_n357_), .b(new_n286_), .c(new_n102_), .O(new_n358_));
  nand2  g260(.a(new_n358_), .b(new_n100_), .O(new_n359_));
  nor3   g261(.a(new_n286_), .b(new_n181_), .c(x4), .O(new_n360_));
  oai21  g262(.a(new_n360_), .b(new_n102_), .c(x0), .O(new_n361_));
  nand3  g263(.a(new_n361_), .b(new_n359_), .c(new_n279_), .O(new_n362_));
  nand2  g264(.a(new_n362_), .b(new_n88_), .O(new_n363_));
  oai21  g265(.a(new_n223_), .b(new_n89_), .c(new_n102_), .O(new_n364_));
  ...
  aoi21  g270(.a(new_n264_), .b(new_n209_), .c(new_n97_), .O(new_n369_));
  ...
  nand2  g275(.a(new_n373_), .b(new_n102_), .O(new_n374_));
  aoi22  g276(.a(new_n296_), .b(new_n88_), .c(new_n78_), .d(x0), .O(new_n375_));
  ...
  nand2  g281(.a(new_n143_), .b(x3), .O(new_n380_));
  aoi21  g282(.a(new_n380_), .b(new_n89_), .c(new_n166_), .O(new_n381_));
  oai21  g283(.a(new_n379_), .b(new_n181_), .c(new_n381_), .O(new_n382_));
  nand2  g284(.a(new_n382_), .b(x0), .O(new_n383_));
  nor2   g285(.a(new_n109_), .b(x0), .O(new_n384_));
  oai21  g286(.a(new_n353_), .b(new_n384_), .c(new_n77_), .O(new_n385_));
  nand2  g287(.a(new_n169_), .b(new_n149_), .O(new_n386_));
  nand2  g288(.a(new_n386_), .b(x2), .O(new_n387_));
  nor2   g289(.a(new_n380_), .b(x2), .O(new_n388_));
  aoi21  g290(.a(x4), .b(new_n100_), .c(new_n388_), .O(new_n389_));
  nand4  g291(.a(new_n389_), .b(new_n387_), .c(new_n385_), .d(new_n383_), .O(z59));
  nand3  g292(.a(x7), .b(x5), .c(new_n102_), .O(new_n391_));
  oai21  g293(.a(new_n391_), .b(new_n100_), .c(new_n88_), .O(new_n392_));
  aoi21  g294(.a(new_n392_), .b(x1), .c(new_n291_), .O(new_n393_));
  nand2  g295(.a(new_n310_), .b(new_n217_), .O(new_n394_));
  aoi22  g296(.a(new_n394_), .b(new_n102_), .c(new_n97_), .d(x5), .O(new_n395_));
  oai21  g297(.a(new_n393_), .b(new_n97_), .c(new_n395_), .O(new_n396_));
  ...
  oai21  g301(.a(x4), .b(x1), .c(new_n100_), .O(new_n400_));
  ...
  oai21  g309(.a(new_n102_), .b(x2), .c(new_n89_), .O(new_n408_));
  nand2  g310(.a(new_n408_), .b(new_n179_), .O(new_n409_));
  nor2   g311(.a(new_n409_), .b(new_n278_), .O(new_n410_));
  oai21  g312(.a(new_n407_), .b(new_n100_), .c(new_n410_), .O(z62));
  zero   g313(.O(z00));
  zero   g314(.O(z01));
  zero   g315(.O(z02));
  zero   g316(.O(z03));
