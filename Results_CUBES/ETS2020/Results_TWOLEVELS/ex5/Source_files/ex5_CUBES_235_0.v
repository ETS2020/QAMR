...
module FAU ( 
  ...
  wire new_n72_, new_n73_, new_n75_, new_n76_, new_n78_, new_n79_, new_n80_,
    ...
    new_n114_, new_n118_, new_n119_, new_n122_, new_n126_, new_n129_,
    new_n130_, new_n131_, new_n135_, new_n138_, new_n139_, new_n142_,
  ...
  nand3  g032(.a(new_n103_), .b(new_n102_), .c(new_n79_), .O(new_n104_));
  ...
  nor4   g043(.a(new_n114_), .b(new_n113_), .c(new_n80_), .d(new_n109_), .O(z09));
  nor2   g044(.a(x1), .b(new_n100_), .O(new_n118_));
  nand2  g045(.a(new_n118_), .b(x2), .O(new_n119_));
  nor3   g046(.a(new_n119_), .b(new_n105_), .c(new_n80_), .O(z12));
  nand2  g047(.a(new_n118_), .b(new_n109_), .O(new_n122_));
  nor3   g048(.a(new_n122_), .b(new_n105_), .c(new_n87_), .O(z14));
  nand2  g049(.a(new_n82_), .b(x4), .O(new_n126_));
  nor2   g050(.a(new_n126_), .b(new_n122_), .O(z17));
  nor2   g051(.a(new_n126_), .b(new_n98_), .O(z18));
  nand2  g052(.a(new_n103_), .b(new_n97_), .O(new_n129_));
  inv1   g053(.a(new_n129_), .O(new_n130_));
  nand2  g054(.a(new_n130_), .b(x4), .O(new_n131_));
  inv1   g055(.a(new_n131_), .O(z19));
  nor3   g056(.a(new_n122_), .b(new_n80_), .c(new_n76_), .O(z20));
  nor3   g057(.a(new_n122_), .b(new_n87_), .c(new_n76_), .O(z21));
  ...
  nor2   g063(.a(new_n104_), .b(new_n91_), .O(z25));
  nand2  g064(.a(x2), .b(x0), .O(new_n142_));
  nor3   g065(.a(new_n142_), .b(new_n114_), .c(new_n80_), .O(z26));
  inv1   g066(.a(new_n110_), .O(new_n144_));
  nor4   g067(.a(new_n144_), .b(new_n101_), .c(new_n138_), .d(new_n73_), .O(z27));
  nor3   g068(.a(new_n119_), .b(new_n114_), .c(new_n87_), .O(z28));
  nor3   g069(.a(new_n139_), .b(new_n81_), .c(x6), .O(z29));
  nor2   g070(.a(new_n114_), .b(new_n111_), .O(z30));
  nand2  g071(.a(new_n118_), .b(x3), .O(new_n150_));
  oai21  g072(.a(new_n150_), .b(new_n81_), .c(x6), .O(new_n151_));
  nand2  g073(.a(new_n151_), .b(x2), .O(new_n152_));
  inv1   g074(.a(new_n122_), .O(new_n153_));
  nand2  g075(.a(x7), .b(x6), .O(new_n154_));
  oai21  g076(.a(x6), .b(x3), .c(new_n154_), .O(new_n155_));
  nand2  g077(.a(new_n89_), .b(new_n100_), .O(new_n156_));
  ...
  nand2  g086(.a(new_n164_), .b(new_n118_), .O(new_n165_));
  ...
  nand2  g092(.a(new_n170_), .b(new_n109_), .O(new_n171_));
  ...
  nor2   g097(.a(new_n79_), .b(new_n109_), .O(new_n176_));
  inv1   g098(.a(new_n176_), .O(new_n177_));
  nand2  g099(.a(new_n94_), .b(new_n79_), .O(new_n178_));
  aoi21  g100(.a(new_n178_), .b(new_n177_), .c(new_n100_), .O(new_n179_));
  ...
  oai21  g109(.a(new_n187_), .b(x0), .c(new_n109_), .O(new_n188_));
  nand2  g110(.a(new_n82_), .b(x3), .O(new_n189_));
  oai22  g111(.a(new_n189_), .b(new_n107_), .c(x4), .d(x0), .O(new_n190_));
  aoi21  g112(.a(new_n190_), .b(x7), .c(new_n179_), .O(new_n191_));
  aoi21  g113(.a(new_n89_), .b(new_n79_), .c(new_n109_), .O(new_n192_));
  oai21  g114(.a(new_n192_), .b(new_n93_), .c(new_n100_), .O(new_n193_));
  nor2   g115(.a(new_n82_), .b(new_n109_), .O(new_n194_));
  oai21  g116(.a(new_n194_), .b(new_n103_), .c(new_n172_), .O(new_n195_));
  oai21  g117(.a(new_n108_), .b(new_n72_), .c(new_n89_), .O(new_n196_));
  ...
  nand4  g126(.a(new_n81_), .b(new_n78_), .c(x1), .d(new_n100_), .O(new_n205_));
  aoi21  g127(.a(new_n205_), .b(new_n204_), .c(new_n109_), .O(new_n206_));
  ...
  aoi21  g133(.a(x7), .b(new_n100_), .c(new_n75_), .O(new_n212_));
  oai21  g134(.a(new_n211_), .b(new_n82_), .c(new_n212_), .O(new_n213_));
  oai21  g135(.a(new_n213_), .b(new_n210_), .c(new_n79_), .O(new_n214_));
  oai21  g136(.a(new_n181_), .b(x2), .c(new_n100_), .O(new_n215_));
  nor2   g137(.a(new_n197_), .b(new_n100_), .O(new_n216_));
  ...
  oai21  g159(.a(new_n237_), .b(new_n182_), .c(new_n100_), .O(new_n238_));
  ...
  nand2  g164(.a(new_n81_), .b(new_n100_), .O(new_n243_));
  oai22  g165(.a(new_n243_), .b(new_n242_), .c(new_n142_), .d(new_n81_), .O(new_n244_));
  nor2   g166(.a(x3), .b(new_n109_), .O(new_n245_));
  ...
  oai21  g172(.a(x5), .b(new_n100_), .c(x7), .O(new_n251_));
  ...
  nor3   g179(.a(new_n257_), .b(new_n101_), .c(x2), .O(new_n258_));
  ...
  nand2  g190(.a(new_n268_), .b(new_n100_), .O(new_n269_));
  nand2  g191(.a(x4), .b(x0), .O(new_n270_));
  aoi21  g192(.a(new_n270_), .b(x3), .c(new_n109_), .O(new_n271_));
  ...
  aoi22  g209(.a(new_n181_), .b(new_n100_), .c(new_n118_), .d(new_n82_), .O(new_n288_));
  oai21  g210(.a(new_n109_), .b(x0), .c(new_n172_), .O(new_n289_));
  ...
  nand4  g214(.a(new_n292_), .b(new_n287_), .c(new_n219_), .d(new_n144_), .O(z39));
  nand2  g215(.a(new_n248_), .b(x6), .O(new_n294_));
  oai21  g216(.a(x2), .b(new_n100_), .c(new_n89_), .O(new_n295_));
  aoi21  g217(.a(new_n295_), .b(new_n294_), .c(x4), .O(new_n296_));
  oai21  g218(.a(new_n296_), .b(new_n166_), .c(new_n82_), .O(new_n297_));
  nand2  g219(.a(x6), .b(x2), .O(new_n298_));
  aoi21  g220(.a(new_n298_), .b(new_n81_), .c(x0), .O(new_n299_));
  aoi21  g221(.a(new_n81_), .b(new_n89_), .c(new_n82_), .O(new_n300_));
  oai21  g222(.a(new_n300_), .b(new_n299_), .c(new_n79_), .O(new_n301_));
  nor2   g223(.a(new_n179_), .b(new_n173_), .O(new_n302_));
  oai21  g224(.a(new_n177_), .b(x1), .c(new_n170_), .O(new_n303_));
  nand2  g225(.a(new_n303_), .b(new_n78_), .O(new_n304_));
  nand2  g226(.a(new_n164_), .b(new_n100_), .O(new_n305_));
  nand2  g227(.a(new_n305_), .b(new_n170_), .O(new_n306_));
  nand2  g228(.a(new_n306_), .b(x3), .O(new_n307_));
  nand3  g229(.a(new_n307_), .b(new_n304_), .c(new_n302_), .O(new_n308_));
  inv1   g230(.a(new_n308_), .O(new_n309_));
  nand3  g231(.a(new_n309_), .b(new_n301_), .c(new_n297_), .O(z40));
  nand3  g232(.a(new_n103_), .b(x1), .c(new_n100_), .O(new_n311_));
  aoi21  g233(.a(new_n311_), .b(new_n78_), .c(x7), .O(new_n312_));
  ...
  nand2  g240(.a(new_n228_), .b(new_n110_), .O(new_n319_));
  ...
  inv1   g245(.a(new_n300_), .O(new_n324_));
  aoi21  g246(.a(new_n94_), .b(x0), .c(new_n299_), .O(new_n325_));
  ...
  oai21  g253(.a(new_n75_), .b(x7), .c(new_n100_), .O(new_n332_));
  ...
  nand2  g259(.a(new_n187_), .b(new_n100_), .O(new_n338_));
  ...
  oai21  g278(.a(new_n182_), .b(new_n176_), .c(new_n100_), .O(new_n357_));
  ...
  nand4  g283(.a(new_n361_), .b(new_n358_), .c(new_n357_), .d(new_n307_), .O(new_n362_));
  ...
  aoi22  g290(.a(new_n368_), .b(new_n110_), .c(x3), .d(x1), .O(new_n369_));
  ...
  nand2  g296(.a(new_n368_), .b(new_n100_), .O(new_n375_));
  nand2  g297(.a(new_n375_), .b(new_n270_), .O(new_n376_));
  or2    g298(.a(new_n376_), .b(new_n374_), .O(new_n377_));
  oai21  g299(.a(new_n359_), .b(new_n109_), .c(x0), .O(new_n378_));
  oai21  g300(.a(new_n164_), .b(new_n93_), .c(new_n100_), .O(new_n379_));
  aoi21  g301(.a(x1), .b(new_n100_), .c(x6), .O(new_n380_));
  ...
  nand2  g306(.a(x6), .b(x5), .O(new_n386_));
  nand2  g307(.a(new_n110_), .b(new_n79_), .O(new_n387_));
  ...
  oai21  g324(.a(new_n177_), .b(new_n113_), .c(new_n178_), .O(new_n414_));
  ...
  oai21  g328(.a(x4), .b(new_n109_), .c(x0), .O(new_n418_));
  ...
  aoi21  g332(.a(new_n421_), .b(new_n375_), .c(new_n109_), .O(new_n422_));
  ...
  aoi21  g336(.a(new_n427_), .b(new_n386_), .c(x7), .O(new_n428_));
  oai21  g337(.a(x7), .b(new_n100_), .c(x5), .O(new_n429_));
  nand2  g338(.a(new_n429_), .b(new_n332_), .O(new_n430_));
  oai21  g339(.a(new_n430_), .b(new_n428_), .c(new_n79_), .O(new_n431_));
  aoi21  g340(.a(new_n281_), .b(x6), .c(new_n107_), .O(new_n432_));
  nand2  g341(.a(x4), .b(new_n100_), .O(new_n433_));
  aoi21  g342(.a(new_n433_), .b(x3), .c(new_n109_), .O(new_n434_));
  nand3  g343(.a(x3), .b(new_n109_), .c(new_n100_), .O(new_n435_));
  ...
  nand2  g348(.a(new_n102_), .b(new_n72_), .O(new_n440_));
  oai21  g349(.a(new_n440_), .b(new_n345_), .c(new_n100_), .O(new_n441_));
  aoi22  g350(.a(new_n441_), .b(new_n109_), .c(new_n439_), .d(new_n172_), .O(new_n442_));
