// Benchmark "FAU" written by ABC on Mon Jul  6 17:37:10 2020
...
module FAU ( 
  ...
  nand2  g147(.a(new_n19_), .b(new_n18_), .O(new_n165_));
  nor2   g148(.a(new_n19_), .b(new_n18_), .O(z3));
  inv1   g149(.a(z3), .O(new_n167_));
  nand2  g150(.a(new_n167_), .b(new_n165_), .O(z2));
  nand2  g151(.a(new_n167_), .b(new_n21_), .O(new_n169_));
  aoi21  g152(.a(new_n169_), .b(x7), .c(x6), .O(new_n170_));
  inv1   g153(.a(new_n153_), .O(new_n171_));
  aoi21  g154(.a(new_n42_), .b(new_n19_), .c(new_n18_), .O(new_n172_));
  oai22  g155(.a(new_n172_), .b(x0), .c(new_n171_), .d(new_n58_), .O(new_n173_));
  oai21  g156(.a(new_n173_), .b(new_n170_), .c(x4), .O(new_n174_));
  nor2   g157(.a(new_n24_), .b(x4), .O(new_n175_));
  nand3  g158(.a(new_n175_), .b(new_n19_), .c(new_n21_), .O(new_n176_));
  nand3  g159(.a(z3), .b(new_n24_), .c(x2), .O(new_n177_));
  aoi21  g160(.a(new_n177_), .b(new_n176_), .c(new_n31_), .O(new_n178_));
  nand2  g161(.a(new_n175_), .b(x1), .O(new_n179_));
  nand4  g162(.a(new_n24_), .b(new_n21_), .c(new_n18_), .d(new_n31_), .O(new_n180_));
  aoi21  g163(.a(new_n180_), .b(new_n179_), .c(x3), .O(new_n181_));
  oai21  g164(.a(new_n181_), .b(new_n178_), .c(x6), .O(new_n182_));
  oai21  g165(.a(x8), .b(x4), .c(new_n49_), .O(new_n183_));
  nand2  g166(.a(x1), .b(new_n31_), .O(new_n184_));
  nand4  g167(.a(new_n19_), .b(x2), .c(new_n18_), .d(x0), .O(new_n185_));
  oai21  g168(.a(new_n184_), .b(new_n59_), .c(new_n185_), .O(new_n186_));
  nand2  g169(.a(new_n186_), .b(new_n183_), .O(new_n187_));
  nor2   g170(.a(new_n175_), .b(new_n42_), .O(new_n188_));
  nor2   g171(.a(new_n188_), .b(new_n69_), .O(new_n189_));
  nand2  g172(.a(x2), .b(x0), .O(new_n190_));
  nor4   g173(.a(new_n190_), .b(new_n24_), .c(x6), .d(x4), .O(new_n191_));
  oai21  g174(.a(new_n191_), .b(new_n189_), .c(new_n19_), .O(new_n192_));
  nand4  g175(.a(new_n192_), .b(new_n187_), .c(new_n182_), .d(new_n174_), .O(new_n193_));
  nand2  g176(.a(new_n193_), .b(x5), .O(new_n194_));
  nand2  g177(.a(new_n50_), .b(new_n31_), .O(new_n195_));
  nand2  g178(.a(new_n43_), .b(x3), .O(new_n196_));
  aoi21  g179(.a(new_n196_), .b(new_n195_), .c(new_n21_), .O(new_n197_));
  nand3  g180(.a(new_n50_), .b(x3), .c(new_n18_), .O(new_n198_));
  inv1   g181(.a(new_n198_), .O(new_n199_));
  oai21  g182(.a(new_n199_), .b(new_n197_), .c(new_n27_), .O(new_n200_));
  inv1   g183(.a(new_n88_), .O(new_n201_));
  nand2  g184(.a(new_n153_), .b(new_n201_), .O(new_n202_));
  aoi21  g185(.a(new_n202_), .b(new_n200_), .c(new_n35_), .O(new_n203_));
  oai21  g186(.a(new_n24_), .b(new_n21_), .c(x8), .O(new_n204_));
  oai21  g187(.a(new_n52_), .b(x1), .c(new_n204_), .O(new_n205_));
  nand3  g188(.a(x7), .b(x4), .c(x3), .O(new_n206_));
  inv1   g189(.a(new_n206_), .O(new_n207_));
  oai22  g190(.a(x8), .b(x4), .c(x7), .d(x2), .O(new_n208_));
  oai21  g191(.a(new_n208_), .b(new_n207_), .c(x6), .O(new_n209_));
  aoi21  g192(.a(new_n209_), .b(new_n205_), .c(x5), .O(new_n210_));
  inv1   g193(.a(new_n68_), .O(new_n211_));
  nand2  g194(.a(new_n175_), .b(new_n211_), .O(new_n212_));
  nand2  g195(.a(new_n201_), .b(new_n42_), .O(new_n213_));
  aoi21  g196(.a(new_n213_), .b(new_n212_), .c(new_n18_), .O(new_n214_));
  oai21  g197(.a(new_n214_), .b(new_n210_), .c(x0), .O(new_n215_));
  nand3  g198(.a(new_n138_), .b(new_n42_), .c(x3), .O(new_n216_));
  oai21  g199(.a(new_n139_), .b(new_n35_), .c(new_n216_), .O(new_n217_));
  nand2  g200(.a(new_n217_), .b(x7), .O(new_n218_));
  nand3  g201(.a(new_n43_), .b(x4), .c(x2), .O(new_n219_));
  oai21  g202(.a(new_n49_), .b(x3), .c(new_n219_), .O(new_n220_));
  nand2  g203(.a(new_n220_), .b(new_n27_), .O(new_n221_));
  nand2  g204(.a(new_n221_), .b(new_n218_), .O(new_n222_));
  aoi22  g205(.a(new_n222_), .b(x1), .c(new_n151_), .d(new_n201_), .O(new_n223_));
  nand2  g206(.a(new_n223_), .b(new_n215_), .O(new_n224_));
  nor2   g207(.a(new_n224_), .b(new_n203_), .O(new_n225_));
  aoi21  g208(.a(new_n225_), .b(new_n194_), .c(new_n20_), .O(z4));
  nand2  g209(.a(new_n21_), .b(new_n31_), .O(new_n227_));
  aoi22  g210(.a(new_n227_), .b(new_n190_), .c(new_n167_), .d(new_n165_), .O(z5));
  zero   g211(.O(z0));
endmodule
