// Benchmark "FAU" written by ABC on Tue Jul  7 13:30:08 2020
...
module FAU ( 
  ...
  nand2  g181(.a(new_n233_), .b(new_n177_), .O(new_n234_));
  ...
  aoi21  g187(.a(new_n239_), .b(new_n179_), .c(new_n232_), .O(new_n240_));
  ...
  nand2  g191(.a(new_n136_), .b(new_n243_), .O(new_n244_));
  inv1   g192(.a(new_n244_), .O(new_n245_));
  aoi21  g193(.a(new_n242_), .b(new_n143_), .c(new_n245_), .O(new_n246_));
  nand3  g194(.a(new_n145_), .b(new_n107_), .c(x08), .O(new_n247_));
  oai21  g195(.a(new_n246_), .b(x09), .c(new_n247_), .O(new_n248_));
  inv1   g196(.a(new_n130_), .O(new_n249_));
  nor2   g197(.a(new_n249_), .b(new_n66_), .O(new_n250_));
  aoi21  g198(.a(new_n248_), .b(new_n53_), .c(new_n250_), .O(new_n251_));
  inv1   g199(.a(new_n144_), .O(new_n252_));
  nand3  g200(.a(new_n153_), .b(new_n252_), .c(new_n76_), .O(new_n253_));
  ...
  nand2  g209(.a(new_n164_), .b(new_n54_), .O(new_n262_));
  ...
  nor3   g213(.a(new_n231_), .b(new_n198_), .c(x15), .O(new_n266_));
  oai21  g214(.a(new_n266_), .b(new_n164_), .c(x05), .O(new_n267_));
  inv1   g215(.a(new_n231_), .O(new_n268_));
  nand2  g216(.a(new_n268_), .b(new_n168_), .O(new_n269_));
  oai21  g217(.a(new_n269_), .b(new_n54_), .c(new_n167_), .O(new_n270_));
  nand2  g218(.a(new_n270_), .b(new_n52_), .O(new_n271_));
  aoi21  g219(.a(new_n271_), .b(new_n267_), .c(x07), .O(new_n272_));
  nor2   g220(.a(new_n118_), .b(x17), .O(new_n273_));
  nand3  g221(.a(new_n273_), .b(new_n130_), .c(new_n54_), .O(new_n274_));
  aoi21  g222(.a(new_n274_), .b(new_n165_), .c(new_n53_), .O(new_n275_));
  oai21  g223(.a(new_n275_), .b(new_n272_), .c(new_n72_), .O(new_n276_));
  aoi22  g224(.a(new_n150_), .b(x09), .c(new_n147_), .d(x05), .O(new_n277_));
  nand2  g225(.a(new_n194_), .b(new_n156_), .O(new_n278_));
  oai21  g226(.a(new_n278_), .b(new_n277_), .c(new_n276_), .O(z10));
  oai21  g227(.a(new_n77_), .b(new_n80_), .c(new_n210_), .O(new_n281_));
  nand2  g228(.a(new_n281_), .b(new_n86_), .O(new_n282_));
  nand3  g229(.a(new_n200_), .b(new_n229_), .c(x08), .O(new_n283_));
  aoi21  g230(.a(new_n283_), .b(new_n282_), .c(x15), .O(new_n284_));
  nand2  g231(.a(new_n97_), .b(new_n93_), .O(new_n285_));
  inv1   g232(.a(new_n285_), .O(new_n286_));
  oai21  g233(.a(new_n286_), .b(new_n284_), .c(new_n52_), .O(new_n287_));
  nand3  g234(.a(new_n130_), .b(x15), .c(new_n73_), .O(new_n288_));
  nand3  g235(.a(new_n268_), .b(new_n133_), .c(x12), .O(new_n289_));
  aoi21  g236(.a(new_n289_), .b(new_n288_), .c(x04), .O(new_n290_));
  inv1   g237(.a(new_n224_), .O(new_n291_));
  inv1   g238(.a(new_n225_), .O(new_n292_));
  nor3   g239(.a(new_n292_), .b(new_n291_), .c(new_n86_), .O(new_n293_));
  nor2   g240(.a(new_n293_), .b(new_n290_), .O(new_n294_));
  nand2  g241(.a(new_n168_), .b(new_n143_), .O(new_n295_));
  aoi21  g242(.a(new_n294_), .b(new_n287_), .c(new_n295_), .O(new_n296_));
  nor3   g243(.a(new_n165_), .b(new_n54_), .c(new_n58_), .O(new_n297_));
  oai21  g244(.a(new_n297_), .b(new_n296_), .c(new_n53_), .O(new_n298_));
  nor2   g245(.a(new_n53_), .b(x05), .O(new_n299_));
  nand2  g246(.a(new_n299_), .b(new_n263_), .O(new_n300_));
  aoi21  g247(.a(new_n300_), .b(new_n298_), .c(x09), .O(z12));
  nand2  g248(.a(new_n69_), .b(x17), .O(new_n302_));
  inv1   g249(.a(new_n302_), .O(new_n303_));
  oai21  g250(.a(new_n53_), .b(new_n52_), .c(new_n303_), .O(new_n304_));
  inv1   g251(.a(new_n304_), .O(z13));
  inv1   g252(.a(new_n156_), .O(new_n306_));
  nand3  g253(.a(new_n97_), .b(new_n52_), .c(new_n75_), .O(new_n307_));
  oai21  g254(.a(new_n292_), .b(new_n291_), .c(new_n307_), .O(new_n308_));
  aoi21  g255(.a(x21), .b(new_n72_), .c(x07), .O(new_n309_));
  nand2  g256(.a(new_n309_), .b(new_n308_), .O(new_n310_));
  nand3  g257(.a(new_n162_), .b(new_n243_), .c(x07), .O(new_n311_));
  aoi21  g258(.a(new_n311_), .b(new_n310_), .c(new_n306_), .O(new_n312_));
  nor2   g259(.a(x21), .b(x15), .O(new_n313_));
  nand4  g260(.a(new_n313_), .b(new_n66_), .c(new_n229_), .d(x04), .O(new_n314_));
  nor3   g261(.a(x18), .b(x09), .c(x05), .O(new_n315_));
  inv1   g262(.a(new_n315_), .O(new_n316_));
  aoi21  g263(.a(new_n314_), .b(new_n57_), .c(new_n316_), .O(new_n317_));
  oai21  g264(.a(new_n317_), .b(new_n312_), .c(new_n159_), .O(new_n318_));
  aoi21  g265(.a(new_n54_), .b(new_n53_), .c(new_n159_), .O(new_n319_));
  nor2   g266(.a(new_n53_), .b(x01), .O(new_n320_));
  oai21  g267(.a(new_n320_), .b(new_n319_), .c(new_n315_), .O(new_n321_));
  nand2  g268(.a(new_n321_), .b(new_n318_), .O(z14));
  nor2   g269(.a(x07), .b(new_n52_), .O(new_n323_));
  inv1   g270(.a(new_n323_), .O(new_n324_));
  nand3  g271(.a(new_n69_), .b(x17), .c(new_n54_), .O(new_n325_));
  nor2   g272(.a(new_n325_), .b(new_n324_), .O(z15));
  nand2  g273(.a(new_n156_), .b(new_n159_), .O(new_n327_));
  oai21  g274(.a(new_n187_), .b(new_n177_), .c(x02), .O(new_n328_));
  nor2   g275(.a(x16), .b(new_n65_), .O(new_n329_));
  oai21  g276(.a(new_n74_), .b(new_n87_), .c(new_n329_), .O(new_n330_));
  aoi21  g277(.a(new_n330_), .b(new_n328_), .c(new_n80_), .O(new_n331_));
  inv1   g278(.a(new_n74_), .O(new_n332_));
  nand3  g279(.a(x16), .b(x12), .c(new_n80_), .O(new_n333_));
  aoi22  g280(.a(new_n333_), .b(new_n84_), .c(new_n332_), .d(x13), .O(new_n334_));
  nor3   g281(.a(x21), .b(x14), .c(x09), .O(new_n335_));
  oai21  g282(.a(new_n334_), .b(new_n331_), .c(new_n335_), .O(new_n336_));
  nand2  g283(.a(new_n243_), .b(x09), .O(new_n337_));
  nand2  g284(.a(new_n54_), .b(new_n53_), .O(new_n338_));
  aoi21  g285(.a(new_n337_), .b(new_n336_), .c(new_n338_), .O(new_n339_));
  nand2  g286(.a(x15), .b(x09), .O(new_n340_));
  aoi21  g287(.a(new_n53_), .b(x02), .c(new_n340_), .O(new_n341_));
  oai21  g288(.a(new_n341_), .b(new_n339_), .c(new_n52_), .O(new_n342_));
  inv1   g289(.a(new_n66_), .O(new_n343_));
  nand3  g290(.a(new_n160_), .b(new_n343_), .c(x09), .O(new_n344_));
  aoi21  g291(.a(new_n344_), .b(new_n342_), .c(new_n327_), .O(z16));
  inv1   g292(.a(new_n219_), .O(new_n346_));
  nand2  g293(.a(new_n176_), .b(new_n80_), .O(new_n347_));
  oai21  g294(.a(new_n125_), .b(new_n75_), .c(new_n347_), .O(new_n348_));
  nor2   g295(.a(x15), .b(x08), .O(new_n349_));
  nand4  g296(.a(new_n349_), .b(new_n348_), .c(new_n168_), .d(new_n79_), .O(new_n350_));
  aoi21  g297(.a(new_n350_), .b(new_n216_), .c(x07), .O(new_n351_));
  oai21  g298(.a(new_n351_), .b(new_n346_), .c(new_n52_), .O(new_n352_));
  nand4  g299(.a(new_n223_), .b(new_n109_), .c(x15), .d(new_n73_), .O(new_n353_));
  aoi21  g300(.a(new_n353_), .b(new_n352_), .c(x09), .O(z17));
  nand3  g301(.a(x21), .b(new_n86_), .c(new_n62_), .O(new_n355_));
  nor2   g302(.a(new_n83_), .b(new_n86_), .O(new_n356_));
  inv1   g303(.a(new_n356_), .O(new_n357_));
  oai21  g304(.a(new_n357_), .b(new_n183_), .c(new_n355_), .O(new_n358_));
  nand2  g305(.a(new_n358_), .b(new_n80_), .O(new_n359_));
  inv1   g306(.a(new_n191_), .O(new_n360_));
  nand3  g307(.a(new_n356_), .b(new_n360_), .c(x06), .O(new_n361_));
  aoi21  g308(.a(new_n361_), .b(new_n359_), .c(new_n65_), .O(new_n362_));
  oai21  g309(.a(new_n362_), .b(new_n189_), .c(new_n67_), .O(new_n363_));
  nand3  g310(.a(x19), .b(x15), .c(new_n86_), .O(new_n364_));
  nor2   g311(.a(x17), .b(x09), .O(new_n365_));
  nand3  g312(.a(new_n365_), .b(new_n150_), .c(x18), .O(new_n366_));
  aoi21  g313(.a(new_n364_), .b(new_n363_), .c(new_n366_), .O(z18));
  inv1   g314(.a(new_n150_), .O(new_n368_));
  nor2   g315(.a(new_n325_), .b(new_n368_), .O(z19));
  inv1   g316(.a(new_n290_), .O(new_n370_));
  nand2  g317(.a(new_n356_), .b(new_n229_), .O(new_n371_));
  oai21  g318(.a(new_n371_), .b(new_n199_), .c(new_n231_), .O(new_n372_));
  aoi21  g319(.a(new_n372_), .b(new_n52_), .c(new_n130_), .O(new_n373_));
  nand2  g320(.a(new_n177_), .b(new_n54_), .O(new_n374_));
  oai21  g321(.a(new_n374_), .b(new_n373_), .c(new_n370_), .O(new_n375_));
  nor4   g322(.a(new_n231_), .b(new_n178_), .c(new_n134_), .d(x14), .O(new_n376_));
  aoi21  g323(.a(new_n375_), .b(new_n143_), .c(new_n376_), .O(new_n377_));
  nor2   g324(.a(new_n65_), .b(x05), .O(new_n378_));
  nand4  g325(.a(new_n378_), .b(new_n257_), .c(new_n67_), .d(x04), .O(new_n379_));
  ...
  nand4  g329(.a(new_n382_), .b(new_n177_), .c(new_n130_), .d(x09), .O(new_n383_));
  nand2  g330(.a(new_n159_), .b(new_n53_), .O(new_n384_));
  aoi21  g331(.a(new_n383_), .b(new_n381_), .c(new_n384_), .O(z20));
  nor2   g332(.a(new_n54_), .b(x09), .O(new_n386_));
  nand2  g333(.a(new_n386_), .b(new_n268_), .O(new_n387_));
  nand3  g334(.a(new_n172_), .b(x08), .c(x06), .O(new_n388_));
  aoi21  g335(.a(new_n388_), .b(new_n387_), .c(x05), .O(new_n389_));
  inv1   g336(.a(new_n136_), .O(new_n390_));
  nor4   g337(.a(new_n390_), .b(x15), .c(x09), .d(new_n80_), .O(new_n391_));
  oai21  g338(.a(new_n391_), .b(new_n389_), .c(new_n53_), .O(new_n392_));
  nand3  g339(.a(new_n386_), .b(new_n299_), .c(x08), .O(new_n393_));
  aoi21  g340(.a(new_n393_), .b(new_n392_), .c(new_n198_), .O(z21));
  nand2  g341(.a(new_n386_), .b(new_n81_), .O(new_n395_));
  nand2  g342(.a(new_n172_), .b(x08), .O(new_n396_));
  aoi21  g343(.a(new_n396_), .b(new_n395_), .c(x05), .O(new_n397_));
  oai21  g344(.a(new_n397_), .b(new_n391_), .c(new_n53_), .O(new_n398_));
  nand2  g345(.a(new_n299_), .b(new_n119_), .O(new_n399_));
  aoi21  g346(.a(new_n399_), .b(new_n398_), .c(new_n198_), .O(z22));
  nor3   g347(.a(new_n278_), .b(new_n368_), .c(new_n72_), .O(z23));
  inv1   g348(.a(new_n365_), .O(new_n402_));
  nand3  g349(.a(new_n130_), .b(x18), .c(new_n65_), .O(new_n403_));
  nand3  g350(.a(new_n378_), .b(new_n99_), .c(new_n229_), .O(new_n404_));
  nand2  g351(.a(new_n54_), .b(x04), .O(new_n405_));
  aoi21  g352(.a(new_n404_), .b(new_n403_), .c(new_n405_), .O(new_n406_));
  nand3  g353(.a(x11), .b(new_n52_), .c(new_n75_), .O(new_n407_));
  nand2  g354(.a(new_n107_), .b(new_n73_), .O(new_n408_));
  nand2  g355(.a(new_n119_), .b(x18), .O(new_n409_));
  aoi21  g356(.a(new_n408_), .b(new_n407_), .c(new_n409_), .O(new_n410_));
  oai21  g357(.a(new_n410_), .b(new_n406_), .c(new_n143_), .O(new_n411_));
  nand3  g358(.a(new_n382_), .b(new_n86_), .c(new_n52_), .O(new_n412_));
  nand2  g359(.a(new_n412_), .b(new_n411_), .O(new_n413_));
  nand2  g360(.a(new_n413_), .b(new_n53_), .O(new_n414_));
  nand4  g361(.a(new_n299_), .b(new_n116_), .c(new_n99_), .d(x08), .O(new_n415_));
  aoi21  g362(.a(new_n415_), .b(new_n414_), .c(new_n402_), .O(z24));
  ...
  nand2  g368(.a(new_n133_), .b(new_n81_), .O(new_n422_));
  nor2   g369(.a(new_n422_), .b(new_n421_), .O(new_n423_));
  oai21  g370(.a(new_n423_), .b(new_n290_), .c(new_n143_), .O(new_n424_));
  nand3  g371(.a(new_n136_), .b(x19), .c(new_n54_), .O(new_n425_));
  aoi21  g372(.a(new_n425_), .b(new_n424_), .c(x07), .O(new_n426_));
  nor4   g373(.a(new_n161_), .b(new_n243_), .c(new_n86_), .d(new_n53_), .O(new_n427_));
  oai21  g374(.a(new_n427_), .b(new_n426_), .c(new_n168_), .O(new_n428_));
  nand3  g375(.a(x15), .b(new_n53_), .c(x00), .O(new_n429_));
  oai21  g376(.a(x15), .b(new_n53_), .c(new_n429_), .O(new_n430_));
  nand4  g377(.a(new_n430_), .b(new_n99_), .c(x17), .d(new_n52_), .O(new_n431_));
  ...
  nand4  g382(.a(new_n435_), .b(new_n273_), .c(new_n172_), .d(new_n106_), .O(new_n436_));
  nand2  g383(.a(new_n436_), .b(new_n433_), .O(z27));
  nand3  g384(.a(new_n258_), .b(new_n143_), .c(x11), .O(new_n438_));
  aoi21  g385(.a(new_n438_), .b(new_n72_), .c(x02), .O(new_n439_));
  nand2  g386(.a(x11), .b(new_n53_), .O(new_n440_));
  oai21  g387(.a(new_n440_), .b(new_n439_), .c(x15), .O(new_n441_));
  nand3  g388(.a(x13), .b(new_n73_), .c(new_n75_), .O(new_n442_));
  inv1   g389(.a(new_n67_), .O(new_n443_));
  nor2   g390(.a(new_n443_), .b(x21), .O(new_n444_));
  nand4  g391(.a(new_n444_), .b(new_n442_), .c(new_n258_), .d(new_n180_), .O(new_n445_));
  aoi21  g392(.a(new_n445_), .b(new_n441_), .c(x05), .O(new_n446_));
  nand4  g393(.a(new_n252_), .b(new_n107_), .c(new_n54_), .d(x12), .O(new_n447_));
  ...
  nor3   g397(.a(new_n212_), .b(new_n443_), .c(new_n143_), .O(new_n451_));
  nor2   g398(.a(x19), .b(new_n54_), .O(new_n452_));
  ...
  oai21  g404(.a(new_n73_), .b(new_n75_), .c(new_n299_), .O(new_n458_));
  nor2   g405(.a(new_n458_), .b(new_n457_), .O(new_n459_));
  oai21  g406(.a(new_n459_), .b(new_n456_), .c(new_n159_), .O(new_n460_));
  oai21  g407(.a(new_n243_), .b(new_n53_), .c(new_n153_), .O(new_n461_));
  nand2  g408(.a(new_n461_), .b(new_n324_), .O(new_n462_));
  nand2  g409(.a(new_n462_), .b(new_n303_), .O(new_n463_));
