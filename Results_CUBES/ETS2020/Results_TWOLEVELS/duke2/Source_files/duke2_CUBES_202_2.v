// Benchmark "FAU" written by ABC on Tue Jul  7 13:31:48 2020
...
module FAU ( 
  ...
  oai21  g216(.a(new_n77_), .b(new_n80_), .c(new_n210_), .O(new_n270_));
  nand2  g217(.a(new_n270_), .b(new_n86_), .O(new_n271_));
  nand3  g218(.a(new_n200_), .b(new_n234_), .c(x08), .O(new_n272_));
  ...
  oai21  g222(.a(new_n275_), .b(new_n273_), .c(new_n52_), .O(new_n276_));
  nand3  g223(.a(new_n130_), .b(x15), .c(new_n73_), .O(new_n277_));
  inv1   g224(.a(new_n236_), .O(new_n278_));
  nand3  g225(.a(new_n278_), .b(new_n133_), .c(x12), .O(new_n279_));
  aoi21  g226(.a(new_n279_), .b(new_n277_), .c(x04), .O(new_n280_));
  inv1   g227(.a(new_n224_), .O(new_n281_));
  inv1   g228(.a(new_n225_), .O(new_n282_));
  nor3   g229(.a(new_n282_), .b(new_n281_), .c(new_n86_), .O(new_n283_));
  nor2   g230(.a(new_n283_), .b(new_n280_), .O(new_n284_));
  nand2  g231(.a(new_n168_), .b(new_n143_), .O(new_n285_));
  aoi21  g232(.a(new_n284_), .b(new_n276_), .c(new_n285_), .O(new_n286_));
  nor3   g233(.a(new_n165_), .b(new_n54_), .c(new_n58_), .O(new_n287_));
  oai21  g234(.a(new_n287_), .b(new_n286_), .c(new_n53_), .O(new_n288_));
  nor2   g235(.a(new_n53_), .b(x05), .O(new_n289_));
  nand3  g236(.a(new_n289_), .b(new_n164_), .c(new_n54_), .O(new_n290_));
  aoi21  g237(.a(new_n290_), .b(new_n288_), .c(x09), .O(z12));
  nand2  g238(.a(new_n69_), .b(x17), .O(new_n292_));
  inv1   g239(.a(new_n292_), .O(new_n293_));
  oai21  g240(.a(new_n53_), .b(new_n52_), .c(new_n293_), .O(new_n294_));
  inv1   g241(.a(new_n294_), .O(z13));
  inv1   g242(.a(new_n156_), .O(new_n296_));
  nand3  g243(.a(new_n97_), .b(new_n52_), .c(new_n75_), .O(new_n297_));
  oai21  g244(.a(new_n282_), .b(new_n281_), .c(new_n297_), .O(new_n298_));
  aoi21  g245(.a(x21), .b(new_n72_), .c(x07), .O(new_n299_));
  nand2  g246(.a(new_n299_), .b(new_n298_), .O(new_n300_));
  nand3  g247(.a(new_n162_), .b(new_n118_), .c(x07), .O(new_n301_));
  aoi21  g248(.a(new_n301_), .b(new_n300_), .c(new_n296_), .O(new_n302_));
  nor2   g249(.a(x21), .b(x15), .O(new_n303_));
  nand4  g250(.a(new_n303_), .b(new_n66_), .c(new_n234_), .d(x04), .O(new_n304_));
  nor3   g251(.a(x18), .b(x09), .c(x05), .O(new_n305_));
  inv1   g252(.a(new_n305_), .O(new_n306_));
  aoi21  g253(.a(new_n304_), .b(new_n57_), .c(new_n306_), .O(new_n307_));
  oai21  g254(.a(new_n307_), .b(new_n302_), .c(new_n159_), .O(new_n308_));
  aoi21  g255(.a(new_n54_), .b(new_n53_), .c(new_n159_), .O(new_n309_));
  nor2   g256(.a(new_n53_), .b(x01), .O(new_n310_));
  oai21  g257(.a(new_n310_), .b(new_n309_), .c(new_n305_), .O(new_n311_));
  nand2  g258(.a(new_n311_), .b(new_n308_), .O(z14));
  nor2   g259(.a(x07), .b(new_n52_), .O(new_n313_));
  inv1   g260(.a(new_n313_), .O(new_n314_));
  nand3  g261(.a(new_n69_), .b(x17), .c(new_n54_), .O(new_n315_));
  nor2   g262(.a(new_n315_), .b(new_n314_), .O(z15));
  nand2  g263(.a(new_n156_), .b(new_n159_), .O(new_n317_));
  oai21  g264(.a(new_n187_), .b(new_n177_), .c(x02), .O(new_n318_));
  nor2   g265(.a(x16), .b(new_n65_), .O(new_n319_));
  oai21  g266(.a(new_n74_), .b(new_n87_), .c(new_n319_), .O(new_n320_));
  aoi21  g267(.a(new_n320_), .b(new_n318_), .c(new_n80_), .O(new_n321_));
  inv1   g268(.a(new_n74_), .O(new_n322_));
  nand3  g269(.a(x16), .b(x12), .c(new_n80_), .O(new_n323_));
  aoi22  g270(.a(new_n323_), .b(new_n84_), .c(new_n322_), .d(x13), .O(new_n324_));
  nor3   g271(.a(x21), .b(x14), .c(x09), .O(new_n325_));
  oai21  g272(.a(new_n324_), .b(new_n321_), .c(new_n325_), .O(new_n326_));
  nand2  g273(.a(new_n118_), .b(x09), .O(new_n327_));
  nand2  g274(.a(new_n54_), .b(new_n53_), .O(new_n328_));
  aoi21  g275(.a(new_n327_), .b(new_n326_), .c(new_n328_), .O(new_n329_));
  nand2  g276(.a(x15), .b(x09), .O(new_n330_));
  aoi21  g277(.a(new_n53_), .b(x02), .c(new_n330_), .O(new_n331_));
  oai21  g278(.a(new_n331_), .b(new_n329_), .c(new_n52_), .O(new_n332_));
  inv1   g279(.a(new_n66_), .O(new_n333_));
  nand3  g280(.a(new_n160_), .b(new_n333_), .c(x09), .O(new_n334_));
  aoi21  g281(.a(new_n334_), .b(new_n332_), .c(new_n317_), .O(z16));
  inv1   g282(.a(new_n219_), .O(new_n336_));
  inv1   g283(.a(new_n169_), .O(new_n337_));
  inv1   g284(.a(new_n76_), .O(new_n338_));
  nand2  g285(.a(new_n176_), .b(new_n80_), .O(new_n339_));
  oai21  g286(.a(new_n338_), .b(new_n80_), .c(new_n339_), .O(new_n340_));
  nand3  g287(.a(new_n340_), .b(new_n337_), .c(new_n79_), .O(new_n341_));
  aoi21  g288(.a(new_n341_), .b(new_n216_), .c(x07), .O(new_n342_));
  oai21  g289(.a(new_n342_), .b(new_n336_), .c(new_n52_), .O(new_n343_));
  nand4  g290(.a(new_n223_), .b(new_n109_), .c(x15), .d(new_n73_), .O(new_n344_));
  aoi21  g291(.a(new_n344_), .b(new_n343_), .c(x09), .O(z17));
  nand3  g292(.a(x21), .b(new_n86_), .c(new_n62_), .O(new_n346_));
  nor2   g293(.a(new_n83_), .b(new_n86_), .O(new_n347_));
  inv1   g294(.a(new_n347_), .O(new_n348_));
  oai21  g295(.a(new_n348_), .b(new_n183_), .c(new_n346_), .O(new_n349_));
  nand2  g296(.a(new_n349_), .b(new_n80_), .O(new_n350_));
  inv1   g297(.a(new_n191_), .O(new_n351_));
  nand3  g298(.a(new_n347_), .b(new_n351_), .c(x06), .O(new_n352_));
  aoi21  g299(.a(new_n352_), .b(new_n350_), .c(new_n65_), .O(new_n353_));
  oai21  g300(.a(new_n353_), .b(new_n189_), .c(new_n67_), .O(new_n354_));
  nand3  g301(.a(x19), .b(x15), .c(new_n86_), .O(new_n355_));
  nor2   g302(.a(x17), .b(x09), .O(new_n356_));
  nand3  g303(.a(new_n356_), .b(new_n150_), .c(x18), .O(new_n357_));
  aoi21  g304(.a(new_n355_), .b(new_n354_), .c(new_n357_), .O(z18));
  inv1   g305(.a(new_n150_), .O(new_n359_));
  nor2   g306(.a(new_n315_), .b(new_n359_), .O(z19));
  inv1   g307(.a(new_n280_), .O(new_n361_));
  nand2  g308(.a(new_n347_), .b(new_n234_), .O(new_n362_));
  oai21  g309(.a(new_n362_), .b(new_n199_), .c(new_n236_), .O(new_n363_));
  aoi21  g310(.a(new_n363_), .b(new_n52_), .c(new_n130_), .O(new_n364_));
  nand2  g311(.a(new_n177_), .b(new_n54_), .O(new_n365_));
  oai21  g312(.a(new_n365_), .b(new_n364_), .c(new_n361_), .O(new_n366_));
  nor4   g313(.a(new_n236_), .b(new_n178_), .c(new_n134_), .d(x14), .O(new_n367_));
  aoi21  g314(.a(new_n366_), .b(new_n143_), .c(new_n367_), .O(new_n368_));
  nor2   g315(.a(new_n65_), .b(x05), .O(new_n369_));
  nand4  g316(.a(new_n369_), .b(new_n261_), .c(new_n67_), .d(x04), .O(new_n370_));
  oai21  g317(.a(new_n368_), .b(new_n99_), .c(new_n370_), .O(new_n371_));
  nand2  g318(.a(new_n371_), .b(new_n72_), .O(new_n372_));
  nor2   g319(.a(new_n99_), .b(x15), .O(new_n373_));
  nand4  g320(.a(new_n373_), .b(new_n177_), .c(new_n130_), .d(x09), .O(new_n374_));
  nand2  g321(.a(new_n159_), .b(new_n53_), .O(new_n375_));
  aoi21  g322(.a(new_n374_), .b(new_n372_), .c(new_n375_), .O(z20));
  nor2   g323(.a(new_n54_), .b(x09), .O(new_n377_));
  nand2  g324(.a(new_n377_), .b(new_n278_), .O(new_n378_));
  nand3  g325(.a(new_n172_), .b(x08), .c(x06), .O(new_n379_));
  aoi21  g326(.a(new_n379_), .b(new_n378_), .c(x05), .O(new_n380_));
  inv1   g327(.a(new_n136_), .O(new_n381_));
  nor4   g328(.a(new_n381_), .b(x15), .c(x09), .d(new_n80_), .O(new_n382_));
  oai21  g329(.a(new_n382_), .b(new_n380_), .c(new_n53_), .O(new_n383_));
  nand3  g330(.a(new_n377_), .b(new_n289_), .c(x08), .O(new_n384_));
  aoi21  g331(.a(new_n384_), .b(new_n383_), .c(new_n198_), .O(z21));
  nand2  g332(.a(new_n377_), .b(new_n81_), .O(new_n386_));
  nand2  g333(.a(new_n172_), .b(x08), .O(new_n387_));
  aoi21  g334(.a(new_n387_), .b(new_n386_), .c(x05), .O(new_n388_));
  oai21  g335(.a(new_n388_), .b(new_n382_), .c(new_n53_), .O(new_n389_));
  nand2  g336(.a(new_n289_), .b(new_n120_), .O(new_n390_));
  aoi21  g337(.a(new_n390_), .b(new_n389_), .c(new_n198_), .O(z22));
  nand2  g338(.a(new_n194_), .b(x09), .O(new_n392_));
  nor3   g339(.a(new_n392_), .b(new_n296_), .c(new_n359_), .O(z23));
  inv1   g340(.a(new_n356_), .O(new_n394_));
  nand3  g341(.a(new_n130_), .b(x18), .c(new_n65_), .O(new_n395_));
  nand3  g342(.a(new_n369_), .b(new_n99_), .c(new_n234_), .O(new_n396_));
  nand2  g343(.a(new_n54_), .b(x04), .O(new_n397_));
  aoi21  g344(.a(new_n396_), .b(new_n395_), .c(new_n397_), .O(new_n398_));
  nand3  g345(.a(x11), .b(new_n52_), .c(new_n75_), .O(new_n399_));
  nand2  g346(.a(new_n107_), .b(new_n73_), .O(new_n400_));
  nand2  g347(.a(new_n120_), .b(x18), .O(new_n401_));
  aoi21  g348(.a(new_n400_), .b(new_n399_), .c(new_n401_), .O(new_n402_));
  oai21  g349(.a(new_n402_), .b(new_n398_), .c(new_n143_), .O(new_n403_));
  nand3  g350(.a(new_n373_), .b(new_n86_), .c(new_n52_), .O(new_n404_));
  nand2  g351(.a(new_n404_), .b(new_n403_), .O(new_n405_));
  nand2  g352(.a(new_n405_), .b(new_n53_), .O(new_n406_));
  nand4  g353(.a(new_n289_), .b(new_n116_), .c(new_n99_), .d(x08), .O(new_n407_));
  aoi21  g354(.a(new_n407_), .b(new_n406_), .c(new_n394_), .O(z24));
  nand2  g355(.a(new_n377_), .b(new_n86_), .O(new_n409_));
  nand2  g356(.a(new_n168_), .b(new_n150_), .O(new_n410_));
  aoi21  g357(.a(new_n409_), .b(new_n387_), .c(new_n410_), .O(z25));
  nor2   g358(.a(new_n89_), .b(x20), .O(z26));
  nand2  g359(.a(new_n133_), .b(new_n81_), .O(new_n413_));
  nor2   g360(.a(new_n413_), .b(new_n338_), .O(new_n414_));
  oai21  g361(.a(new_n414_), .b(new_n280_), .c(new_n143_), .O(new_n415_));
  nand3  g362(.a(new_n136_), .b(x19), .c(new_n54_), .O(new_n416_));
  aoi21  g363(.a(new_n416_), .b(new_n415_), .c(x07), .O(new_n417_));
  nor3   g364(.a(new_n228_), .b(new_n161_), .c(new_n118_), .O(new_n418_));
  oai21  g365(.a(new_n418_), .b(new_n417_), .c(new_n168_), .O(new_n419_));
  nand3  g366(.a(x15), .b(new_n53_), .c(x00), .O(new_n420_));
  oai21  g367(.a(x15), .b(new_n53_), .c(new_n420_), .O(new_n421_));
  nand4  g368(.a(new_n421_), .b(new_n99_), .c(x17), .d(new_n52_), .O(new_n422_));
  nand2  g369(.a(new_n422_), .b(new_n419_), .O(new_n423_));
  nand2  g370(.a(new_n423_), .b(new_n72_), .O(new_n424_));
  nand3  g371(.a(new_n159_), .b(new_n52_), .c(x03), .O(new_n425_));
  nand3  g372(.a(new_n172_), .b(new_n119_), .c(new_n106_), .O(new_n426_));
  oai21  g373(.a(new_n426_), .b(new_n425_), .c(new_n424_), .O(z27));
  nand3  g374(.a(new_n262_), .b(new_n143_), .c(x11), .O(new_n428_));
  aoi21  g375(.a(new_n428_), .b(new_n72_), .c(x02), .O(new_n429_));
  nand2  g376(.a(x11), .b(new_n53_), .O(new_n430_));
  oai21  g377(.a(new_n430_), .b(new_n429_), .c(x15), .O(new_n431_));
  nand3  g378(.a(x13), .b(new_n73_), .c(new_n75_), .O(new_n432_));
  inv1   g379(.a(new_n67_), .O(new_n433_));
  nor2   g380(.a(new_n433_), .b(x21), .O(new_n434_));
  nand4  g381(.a(new_n434_), .b(new_n432_), .c(new_n262_), .d(new_n180_), .O(new_n435_));
  aoi21  g382(.a(new_n435_), .b(new_n431_), .c(x05), .O(new_n436_));
  nand4  g383(.a(new_n256_), .b(new_n107_), .c(new_n54_), .d(x12), .O(new_n437_));
  nand2  g384(.a(new_n377_), .b(x21), .O(new_n438_));
  aoi21  g385(.a(new_n438_), .b(new_n437_), .c(x07), .O(new_n439_));
  oai21  g386(.a(new_n439_), .b(new_n436_), .c(x08), .O(new_n440_));
  nor3   g387(.a(new_n212_), .b(new_n433_), .c(new_n143_), .O(new_n441_));
  nor2   g388(.a(x19), .b(new_n54_), .O(new_n442_));
  nand3  g389(.a(new_n150_), .b(new_n72_), .c(new_n86_), .O(new_n443_));
  inv1   g390(.a(new_n443_), .O(new_n444_));
  oai21  g391(.a(new_n442_), .b(new_n441_), .c(new_n444_), .O(new_n445_));
  aoi21  g392(.a(new_n445_), .b(new_n440_), .c(new_n99_), .O(new_n446_));
  nand2  g393(.a(new_n377_), .b(new_n99_), .O(new_n447_));
  oai21  g394(.a(new_n73_), .b(new_n75_), .c(new_n289_), .O(new_n448_));
  nor2   g395(.a(new_n448_), .b(new_n447_), .O(new_n449_));
  oai21  g396(.a(new_n449_), .b(new_n446_), .c(new_n159_), .O(new_n450_));
  oai21  g397(.a(new_n118_), .b(new_n53_), .c(new_n153_), .O(new_n451_));
  nand2  g398(.a(new_n451_), .b(new_n314_), .O(new_n452_));
  nand2  g399(.a(new_n452_), .b(new_n293_), .O(new_n453_));
  nand2  g400(.a(new_n453_), .b(new_n450_), .O(z28));
  zero   g401(.O(z10));
  zero   g402(.O(z11));
endmodule
