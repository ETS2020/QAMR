...
module FAU ( 
  ...
  wire new_n57_, new_n58_, new_n59_, new_n60_, new_n61_, new_n62_, new_n63_,
    ...
    new_n91_, new_n92_, new_n104_, new_n105_, new_n106_, new_n107_,
  ...
  inv1   g34(.a(x07), .O(new_n104_));
  nand4  g35(.a(x15), .b(new_n91_), .c(new_n59_), .d(x06), .O(new_n105_));
  inv1   g36(.a(x15), .O(new_n106_));
  nand3  g37(.a(new_n106_), .b(x09), .c(x08), .O(new_n107_));
  aoi21  g38(.a(new_n107_), .b(new_n105_), .c(x05), .O(new_n108_));
  nand2  g39(.a(x06), .b(x05), .O(new_n109_));
  nand3  g40(.a(new_n106_), .b(new_n91_), .c(new_n59_), .O(new_n110_));
  nor2   g41(.a(new_n110_), .b(new_n109_), .O(new_n111_));
  oai21  g42(.a(new_n111_), .b(new_n108_), .c(new_n104_), .O(new_n112_));
  nand4  g43(.a(x15), .b(x08), .c(x07), .d(new_n90_), .O(new_n113_));
  inv1   g44(.a(x17), .O(new_n114_));
  nand2  g45(.a(x18), .b(new_n114_), .O(new_n115_));
  aoi21  g46(.a(new_n113_), .b(new_n112_), .c(new_n115_), .O(z22));
  aoi21  g47(.a(new_n64_), .b(new_n86_), .c(x20), .O(z26));
  zero   g48(.O(z00));
  zero   g49(.O(z01));
  zero   g50(.O(z02));
  zero   g51(.O(z03));
