// Benchmark "FAU" written by ABC on Tue Jul  7 13:31:32 2020
...
module FAU ( 
  ...
  inv1   g17(.a(x14), .O(new_n76_));
  nor2   g18(.a(x20), .b(new_n76_), .O(z08));
  nand2  g19(.a(new_n67_), .b(new_n61_), .O(new_n80_));
  inv1   g20(.a(x09), .O(new_n81_));
  nand4  g21(.a(new_n81_), .b(x07), .c(new_n58_), .d(x01), .O(new_n82_));
  nor2   g22(.a(new_n82_), .b(new_n80_), .O(z11));
  inv1   g23(.a(x21), .O(new_n98_));
  aoi21  g24(.a(new_n98_), .b(new_n76_), .c(x20), .O(z26));
  zero   g25(.O(z00));
  zero   g26(.O(z01));
  zero   g27(.O(z02));
  zero   g28(.O(z04));
