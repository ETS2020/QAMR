// Benchmark "FAU" written by ABC on Tue Jul  7 13:30:11 2020
...
module FAU ( 
  ...
  wire new_n60_, new_n62_, new_n63_, new_n64_, new_n65_, new_n66_, new_n67_,
    ...
    new_n102_, new_n105_, new_n106_, new_n109_, new_n110_, new_n111_;
  ...
  inv1   g48(.a(x18), .O(new_n109_));
  nand2  g49(.a(x07), .b(x05), .O(new_n110_));
  nand4  g50(.a(new_n110_), .b(new_n109_), .c(x17), .d(new_n86_), .O(new_n111_));
  inv1   g51(.a(new_n111_), .O(z13));
  aoi21  g52(.a(new_n97_), .b(new_n60_), .c(x20), .O(z26));
  zero   g53(.O(z00));
  zero   g54(.O(z01));
  zero   g55(.O(z02));
  zero   g56(.O(z03));
