// Benchmark "FAU" written by ABC on Tue Jul  7 13:31:58 2020
...
module FAU ( 
  ...
  inv1   g228(.a(new_n150_), .O(new_n280_));
  oai22  g229(.a(new_n280_), .b(new_n72_), .c(new_n148_), .d(new_n52_), .O(new_n281_));
  nand3  g230(.a(new_n281_), .b(new_n194_), .c(new_n156_), .O(new_n282_));
  ...
  nor2   g319(.a(new_n329_), .b(new_n280_), .O(z19));
  inv1   g320(.a(new_n294_), .O(new_n373_));
  nand2  g321(.a(new_n360_), .b(new_n232_), .O(new_n374_));
  ...
  nand3  g343(.a(new_n389_), .b(new_n303_), .c(x08), .O(new_n396_));
  ...
  nand2  g349(.a(new_n303_), .b(new_n119_), .O(new_n402_));
  aoi21  g350(.a(new_n402_), .b(new_n401_), .c(new_n198_), .O(z22));
  inv1   g351(.a(new_n369_), .O(new_n405_));
  nand3  g352(.a(new_n130_), .b(x18), .c(new_n65_), .O(new_n406_));
  nand3  g353(.a(new_n381_), .b(new_n99_), .c(new_n232_), .O(new_n407_));
  nand2  g354(.a(new_n54_), .b(x04), .O(new_n408_));
  aoi21  g355(.a(new_n407_), .b(new_n406_), .c(new_n408_), .O(new_n409_));
  nand3  g356(.a(x11), .b(new_n52_), .c(new_n75_), .O(new_n410_));
  nand2  g357(.a(new_n107_), .b(new_n73_), .O(new_n411_));
  nand2  g358(.a(new_n119_), .b(x18), .O(new_n412_));
  aoi21  g359(.a(new_n411_), .b(new_n410_), .c(new_n412_), .O(new_n413_));
  oai21  g360(.a(new_n413_), .b(new_n409_), .c(new_n143_), .O(new_n414_));
  nand3  g361(.a(new_n385_), .b(new_n86_), .c(new_n52_), .O(new_n415_));
  nand2  g362(.a(new_n415_), .b(new_n414_), .O(new_n416_));
  nand2  g363(.a(new_n416_), .b(new_n53_), .O(new_n417_));
  nand4  g364(.a(new_n303_), .b(new_n116_), .c(new_n99_), .d(x08), .O(new_n418_));
  aoi21  g365(.a(new_n418_), .b(new_n417_), .c(new_n405_), .O(z24));
  nand2  g366(.a(new_n389_), .b(new_n86_), .O(new_n420_));
  nand2  g367(.a(new_n168_), .b(new_n150_), .O(new_n421_));
  aoi21  g368(.a(new_n420_), .b(new_n399_), .c(new_n421_), .O(z25));
  nor2   g369(.a(new_n89_), .b(x20), .O(z26));
  inv1   g370(.a(new_n76_), .O(new_n424_));
  nand2  g371(.a(new_n133_), .b(new_n81_), .O(new_n425_));
  nor2   g372(.a(new_n425_), .b(new_n424_), .O(new_n426_));
  oai21  g373(.a(new_n426_), .b(new_n294_), .c(new_n143_), .O(new_n427_));
  nand3  g374(.a(new_n136_), .b(x19), .c(new_n54_), .O(new_n428_));
  aoi21  g375(.a(new_n428_), .b(new_n427_), .c(x07), .O(new_n429_));
  nor4   g376(.a(new_n161_), .b(new_n246_), .c(new_n86_), .d(new_n53_), .O(new_n430_));
  oai21  g377(.a(new_n430_), .b(new_n429_), .c(new_n168_), .O(new_n431_));
  nand3  g378(.a(x15), .b(new_n53_), .c(x00), .O(new_n432_));
  oai21  g379(.a(x15), .b(new_n53_), .c(new_n432_), .O(new_n433_));
  nand4  g380(.a(new_n433_), .b(new_n99_), .c(x17), .d(new_n52_), .O(new_n434_));
  nand2  g381(.a(new_n434_), .b(new_n431_), .O(new_n435_));
  nand2  g382(.a(new_n435_), .b(new_n72_), .O(new_n436_));
  inv1   g383(.a(x03), .O(new_n437_));
  nor2   g384(.a(x05), .b(new_n437_), .O(new_n438_));
  nand4  g385(.a(new_n438_), .b(new_n276_), .c(new_n172_), .d(new_n106_), .O(new_n439_));
  nand2  g386(.a(new_n439_), .b(new_n436_), .O(z27));
  nand3  g387(.a(new_n261_), .b(new_n143_), .c(x11), .O(new_n441_));
  aoi21  g388(.a(new_n441_), .b(new_n72_), .c(x02), .O(new_n442_));
  nand2  g389(.a(x11), .b(new_n53_), .O(new_n443_));
  oai21  g390(.a(new_n443_), .b(new_n442_), .c(x15), .O(new_n444_));
  nand3  g391(.a(x13), .b(new_n73_), .c(new_n75_), .O(new_n445_));
  inv1   g392(.a(new_n67_), .O(new_n446_));
  nor2   g393(.a(new_n446_), .b(x21), .O(new_n447_));
  nand4  g394(.a(new_n447_), .b(new_n445_), .c(new_n261_), .d(new_n180_), .O(new_n448_));
  aoi21  g395(.a(new_n448_), .b(new_n444_), .c(x05), .O(new_n449_));
  nand4  g396(.a(new_n255_), .b(new_n107_), .c(new_n54_), .d(x12), .O(new_n450_));
  nand2  g397(.a(new_n389_), .b(x21), .O(new_n451_));
  aoi21  g398(.a(new_n451_), .b(new_n450_), .c(x07), .O(new_n452_));
  oai21  g399(.a(new_n452_), .b(new_n449_), .c(x08), .O(new_n453_));
  nor3   g400(.a(new_n212_), .b(new_n446_), .c(new_n143_), .O(new_n454_));
  nor2   g401(.a(x19), .b(new_n54_), .O(new_n455_));
  nand3  g402(.a(new_n150_), .b(new_n72_), .c(new_n86_), .O(new_n456_));
  inv1   g403(.a(new_n456_), .O(new_n457_));
  oai21  g404(.a(new_n455_), .b(new_n454_), .c(new_n457_), .O(new_n458_));
  aoi21  g405(.a(new_n458_), .b(new_n453_), .c(new_n99_), .O(new_n459_));
  nand2  g406(.a(new_n389_), .b(new_n99_), .O(new_n460_));
  oai21  g407(.a(new_n73_), .b(new_n75_), .c(new_n303_), .O(new_n461_));
  nor2   g408(.a(new_n461_), .b(new_n460_), .O(new_n462_));
  oai21  g409(.a(new_n462_), .b(new_n459_), .c(new_n159_), .O(new_n463_));
  oai21  g410(.a(new_n246_), .b(new_n53_), .c(new_n153_), .O(new_n464_));
  nand2  g411(.a(new_n464_), .b(new_n328_), .O(new_n465_));
  nand2  g412(.a(new_n465_), .b(new_n307_), .O(new_n466_));
  nand2  g413(.a(new_n466_), .b(new_n463_), .O(z28));
  zero   g414(.O(z11));
  zero   g415(.O(z23));
endmodule
