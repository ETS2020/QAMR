// Benchmark "FAU" written by ABC on Tue Jul  7 12:31:51 2020
...
module FAU ( 
  ...
  wire new_n35_, new_n36_, new_n38_, new_n39_, new_n40_, new_n41_, new_n44_,
    ...
    new_n87_, new_n88_, new_n89_, new_n90_, new_n91_, new_n94_;
  ...
  nor2   g57(.a(new_n82_), .b(x03), .O(new_n94_));
  nor2   g58(.a(new_n94_), .b(new_n40_), .O(z12));
