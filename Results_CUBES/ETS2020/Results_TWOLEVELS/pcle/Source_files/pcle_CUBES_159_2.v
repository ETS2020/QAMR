...
module FAU ( 
  ...
  wire new_n29_, new_n30_, new_n31_, new_n32_, new_n33_, new_n34_, new_n35_,
    ...
    new_n45_, new_n50_, new_n51_, new_n52_, new_n53_, new_n54_, new_n55_,
  ...
  inv1   g17(.a(new_n44_), .O(new_n50_));
  nand3  g18(.a(x13), .b(x12), .c(x11), .O(new_n51_));
  oai21  g19(.a(new_n51_), .b(new_n31_), .c(x16), .O(new_n52_));
  inv1   g20(.a(x16), .O(new_n53_));
  inv1   g21(.a(new_n51_), .O(new_n54_));
  nand3  g22(.a(new_n54_), .b(new_n32_), .c(new_n53_), .O(new_n55_));
  nand2  g23(.a(new_n55_), .b(new_n52_), .O(new_n56_));
  ...
  oai21  g28(.a(new_n60_), .b(new_n51_), .c(x17), .O(new_n61_));
  inv1   g29(.a(x17), .O(new_n62_));
  nand4  g30(.a(new_n62_), .b(x16), .c(x15), .d(x14), .O(new_n63_));
  oai21  g31(.a(new_n63_), .b(new_n51_), .c(new_n61_), .O(new_n64_));
  nand2  g32(.a(new_n64_), .b(new_n50_), .O(new_n65_));
