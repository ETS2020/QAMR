// Benchmark "FAU" written by ABC on Tue Jul  7 11:18:36 2020
...
module FAU ( 
  ...
  oai21  g39(.a(new_n69_), .b(new_n52_), .c(x18), .O(new_n70_));
  inv1   g40(.a(new_n61_), .O(new_n71_));
  and2   g41(.a(x16), .b(x15), .O(new_n72_));
  inv1   g42(.a(x17), .O(new_n73_));
  nor2   g43(.a(x18), .b(new_n73_), .O(new_n74_));
  nand3  g44(.a(new_n74_), .b(new_n72_), .c(new_n71_), .O(new_n75_));
  nand2  g45(.a(new_n75_), .b(new_n70_), .O(new_n76_));
