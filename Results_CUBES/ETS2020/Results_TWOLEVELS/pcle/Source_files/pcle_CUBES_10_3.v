...
module FAU ( 
  ...
  oai21  g31(.a(new_n62_), .b(new_n53_), .c(x18), .O(new_n63_));
  inv1   g32(.a(new_n45_), .O(new_n64_));
  and2   g33(.a(x16), .b(x15), .O(new_n65_));
  nor2   g34(.a(x18), .b(new_n56_), .O(new_n66_));
  nand3  g35(.a(new_n66_), .b(new_n65_), .c(new_n64_), .O(new_n67_));
  nand2  g36(.a(new_n67_), .b(new_n63_), .O(new_n68_));
  nand2  g37(.a(new_n68_), .b(new_n52_), .O(new_n69_));
