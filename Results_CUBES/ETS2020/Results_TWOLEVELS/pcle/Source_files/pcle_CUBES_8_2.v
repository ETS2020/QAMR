...
module FAU ( 
  ...
  and2   g14(.a(x12), .b(x11), .O(new_n44_));
  xnor2a g15(.a(new_n44_), .b(x13), .O(new_n45_));
  ...
  aoi22  g22(.a(new_n51_), .b(new_n44_), .c(new_n49_), .d(x14), .O(new_n52_));
  nand2  g23(.a(x08), .b(x03), .O(new_n53_));
  oai21  g24(.a(new_n52_), .b(new_n46_), .c(new_n53_), .O(z4));
  nand4  g25(.a(x14), .b(x13), .c(x12), .d(x11), .O(new_n55_));
  nand2  g26(.a(x14), .b(x13), .O(new_n56_));
  nor2   g27(.a(new_n56_), .b(x15), .O(new_n57_));
  aoi22  g28(.a(new_n57_), .b(new_n44_), .c(new_n55_), .d(x15), .O(new_n58_));
  nand2  g29(.a(x08), .b(x04), .O(new_n59_));
  oai21  g30(.a(new_n58_), .b(new_n46_), .c(new_n59_), .O(z5));
  inv1   g31(.a(new_n46_), .O(new_n62_));
