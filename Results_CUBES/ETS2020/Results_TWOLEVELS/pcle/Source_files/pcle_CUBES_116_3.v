...
module FAU ( 
  ...
  nand2  g21(.a(x15), .b(x14), .O(new_n52_));
  nand3  g22(.a(x13), .b(x12), .c(x11), .O(new_n53_));
  oai21  g23(.a(new_n53_), .b(new_n52_), .c(x16), .O(new_n54_));
  inv1   g24(.a(new_n53_), .O(new_n55_));
  nor2   g25(.a(new_n52_), .b(x16), .O(new_n56_));
  nand2  g26(.a(new_n56_), .b(new_n55_), .O(new_n57_));
  nand2  g27(.a(new_n57_), .b(new_n54_), .O(new_n58_));
  nand2  g28(.a(new_n58_), .b(new_n51_), .O(new_n59_));
  nand2  g29(.a(x08), .b(x05), .O(new_n60_));
  nand2  g30(.a(new_n60_), .b(new_n59_), .O(z6));
  nand3  g31(.a(x16), .b(x15), .c(x14), .O(new_n62_));
  oai21  g32(.a(new_n62_), .b(new_n53_), .c(x17), .O(new_n63_));
  inv1   g33(.a(x17), .O(new_n64_));
  nand4  g34(.a(new_n64_), .b(x16), .c(x15), .d(x14), .O(new_n65_));
  oai21  g35(.a(new_n65_), .b(new_n53_), .c(new_n63_), .O(new_n66_));
  ...
  oai21  g40(.a(new_n70_), .b(new_n53_), .c(x18), .O(new_n71_));
  inv1   g41(.a(new_n45_), .O(new_n72_));
  and2   g42(.a(x16), .b(x15), .O(new_n73_));
  nor2   g43(.a(x18), .b(new_n64_), .O(new_n74_));
  nand3  g44(.a(new_n74_), .b(new_n73_), .c(new_n72_), .O(new_n75_));
  nand2  g45(.a(new_n75_), .b(new_n71_), .O(new_n76_));
  nand2  g46(.a(new_n76_), .b(new_n51_), .O(new_n77_));
  nand2  g47(.a(x08), .b(x07), .O(new_n78_));
  nand2  g48(.a(new_n78_), .b(new_n77_), .O(z8));
  zero   g49(.O(z0));
  zero   g50(.O(z4));
endmodule
