...
module FAU ( 
  ...
  oai21  g22(.a(new_n51_), .b(new_n50_), .c(x14), .O(new_n52_));
  ...
  aoi22  g33(.a(new_n62_), .b(new_n54_), .c(new_n60_), .d(x15), .O(new_n63_));
  nand2  g34(.a(x08), .b(x04), .O(new_n64_));
  oai21  g35(.a(new_n63_), .b(new_n45_), .c(new_n64_), .O(z5));
  zero   g36(.O(z3));
  zero   g37(.O(z6));
  zero   g38(.O(z7));
  zero   g39(.O(z8));
