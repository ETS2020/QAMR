...
module FAU ( 
  ...
  oai21  g28(.a(new_n60_), .b(new_n42_), .c(x18), .O(new_n61_));
  and2   g29(.a(x14), .b(x13), .O(new_n62_));
  nor2   g30(.a(x18), .b(new_n54_), .O(new_n63_));
  nand4  g31(.a(x16), .b(x15), .c(x12), .d(x11), .O(new_n64_));
  inv1   g32(.a(new_n64_), .O(new_n65_));
  nand3  g33(.a(new_n65_), .b(new_n63_), .c(new_n62_), .O(new_n66_));
  nand2  g34(.a(new_n66_), .b(new_n61_), .O(new_n67_));
  nand2  g35(.a(new_n67_), .b(new_n41_), .O(new_n68_));
