// Benchmark "FAU" written by ABC on Tue Jul  7 11:19:24 2020
...
module FAU ( 
  ...
  inv1   g25(.a(new_n44_), .O(new_n56_));
  nand2  g26(.a(x12), .b(x11), .O(new_n57_));
  nand3  g27(.a(x15), .b(x14), .c(x13), .O(new_n58_));
  oai21  g28(.a(new_n58_), .b(new_n57_), .c(x16), .O(new_n59_));
  inv1   g29(.a(x16), .O(new_n60_));
  and2   g30(.a(x14), .b(x13), .O(new_n61_));
  nand4  g31(.a(new_n61_), .b(new_n49_), .c(new_n60_), .d(x15), .O(new_n62_));
  nand2  g32(.a(new_n62_), .b(new_n59_), .O(new_n63_));
  nand2  g33(.a(new_n63_), .b(new_n56_), .O(new_n64_));
