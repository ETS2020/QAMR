...
module FAU ( 
  ...
  inv1   g14(.a(x13), .O(new_n45_));
  nand2  g15(.a(x12), .b(x11), .O(new_n46_));
  oai21  g16(.a(new_n46_), .b(new_n45_), .c(x14), .O(new_n47_));
  inv1   g17(.a(x14), .O(new_n48_));
  and2   g18(.a(x12), .b(x11), .O(new_n49_));
  nand3  g19(.a(new_n49_), .b(new_n48_), .c(x13), .O(new_n50_));
  nand2  g20(.a(new_n50_), .b(new_n47_), .O(new_n51_));
  inv1   g21(.a(x08), .O(new_n52_));
  nand3  g22(.a(new_n40_), .b(x09), .c(new_n52_), .O(new_n53_));
  inv1   g23(.a(new_n53_), .O(new_n54_));
  nand2  g24(.a(new_n54_), .b(new_n51_), .O(new_n55_));
  ...
  aoi22  g30(.a(new_n60_), .b(new_n49_), .c(new_n58_), .d(x15), .O(new_n61_));
  nand2  g31(.a(x08), .b(x04), .O(new_n62_));
  oai21  g32(.a(new_n61_), .b(new_n53_), .c(new_n62_), .O(z5));
  zero   g33(.O(z2));
  zero   g34(.O(z3));
  zero   g35(.O(z6));
  zero   g36(.O(z7));
