...
module FAU ( 
  ...
  nand4  g37(.a(x17), .b(x16), .c(x15), .d(x14), .O(new_n68_));
  oai21  g38(.a(new_n68_), .b(new_n45_), .c(x18), .O(new_n69_));
  inv1   g39(.a(new_n51_), .O(new_n70_));
  and2   g40(.a(x16), .b(x15), .O(new_n71_));
  inv1   g41(.a(x17), .O(new_n72_));
  nor2   g42(.a(x18), .b(new_n72_), .O(new_n73_));
  nand3  g43(.a(new_n73_), .b(new_n71_), .c(new_n70_), .O(new_n74_));
  nand2  g44(.a(new_n74_), .b(new_n69_), .O(new_n75_));
  nand2  g45(.a(new_n75_), .b(new_n57_), .O(new_n76_));
