...
module FAU ( 
  ...
  nand2  g23(.a(new_n50_), .b(x13), .O(new_n53_));
  oai22  g24(.a(new_n53_), .b(new_n45_), .c(new_n52_), .d(new_n50_), .O(new_n54_));
  ...
  nand2  g33(.a(new_n63_), .b(new_n49_), .O(new_n64_));
  ...
  nand2  g45(.a(new_n76_), .b(new_n49_), .O(new_n77_));
