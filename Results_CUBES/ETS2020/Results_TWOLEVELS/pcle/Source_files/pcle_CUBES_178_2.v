...
module FAU ( 
  ...
  oai21  g35(.a(new_n66_), .b(new_n49_), .c(x18), .O(new_n67_));
  inv1   g36(.a(new_n58_), .O(new_n68_));
  and2   g37(.a(x16), .b(x15), .O(new_n69_));
  inv1   g38(.a(x17), .O(new_n70_));
  nor2   g39(.a(x18), .b(new_n70_), .O(new_n71_));
  nand3  g40(.a(new_n71_), .b(new_n69_), .c(new_n68_), .O(new_n72_));
  nand2  g41(.a(new_n72_), .b(new_n67_), .O(new_n73_));
  nand2  g42(.a(new_n73_), .b(new_n48_), .O(new_n74_));
