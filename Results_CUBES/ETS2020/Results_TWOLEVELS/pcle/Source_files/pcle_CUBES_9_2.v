// Benchmark "FAU" written by ABC on Tue Jul  7 11:17:36 2020
...
module FAU ( 
  ...
  oai21  g24(.a(new_n53_), .b(new_n49_), .c(new_n51_), .O(new_n54_));
  ...
  nand2  g33(.a(new_n64_), .b(new_n48_), .O(new_n65_));
  ...
  nand2  g44(.a(new_n75_), .b(new_n48_), .O(new_n76_));
