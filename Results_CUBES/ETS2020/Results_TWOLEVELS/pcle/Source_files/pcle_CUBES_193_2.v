...
module FAU ( 
  ...
  nand2  g15(.a(new_n42_), .b(x13), .O(new_n46_));
  oai22  g16(.a(new_n46_), .b(new_n43_), .c(new_n45_), .d(new_n42_), .O(new_n47_));
  ...
  nand2  g25(.a(new_n56_), .b(new_n41_), .O(new_n57_));
  ...
  nand2  g33(.a(new_n64_), .b(new_n41_), .O(new_n65_));
  ...
  nand2  g44(.a(new_n75_), .b(new_n41_), .O(new_n76_));
