...
module FAU ( 
  ...
  nand2  g15(.a(x15), .b(x14), .O(new_n47_));
  nand3  g16(.a(x13), .b(x12), .c(x11), .O(new_n48_));
  oai21  g17(.a(new_n48_), .b(new_n47_), .c(x16), .O(new_n49_));
  inv1   g18(.a(new_n48_), .O(new_n50_));
  nor2   g19(.a(new_n47_), .b(x16), .O(new_n51_));
  nand2  g20(.a(new_n51_), .b(new_n50_), .O(new_n52_));
  nand2  g21(.a(new_n52_), .b(new_n49_), .O(new_n53_));
  nand2  g22(.a(new_n53_), .b(new_n46_), .O(new_n54_));
  nand2  g23(.a(x08), .b(x05), .O(new_n55_));
  nand2  g24(.a(new_n55_), .b(new_n54_), .O(z6));
  nand3  g25(.a(x16), .b(x15), .c(x14), .O(new_n57_));
  oai21  g26(.a(new_n57_), .b(new_n48_), .c(x17), .O(new_n58_));
  inv1   g27(.a(x17), .O(new_n59_));
  nand4  g28(.a(new_n59_), .b(x16), .c(x15), .d(x14), .O(new_n60_));
  oai21  g29(.a(new_n60_), .b(new_n48_), .c(new_n58_), .O(new_n61_));
  ...
  oai21  g34(.a(new_n65_), .b(new_n48_), .c(x18), .O(new_n66_));
  and2   g35(.a(x14), .b(x13), .O(new_n67_));
  nor2   g36(.a(x18), .b(new_n59_), .O(new_n68_));
  nand4  g37(.a(x16), .b(x15), .c(x12), .d(x11), .O(new_n69_));
  inv1   g38(.a(new_n69_), .O(new_n70_));
  nand3  g39(.a(new_n70_), .b(new_n68_), .c(new_n67_), .O(new_n71_));
  nand2  g40(.a(new_n71_), .b(new_n66_), .O(new_n72_));
  nand2  g41(.a(new_n72_), .b(new_n46_), .O(new_n73_));
