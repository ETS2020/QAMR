...
module FAU ( 
  ...
  inv1   g11(.a(x16), .O(new_n44_));
  nand2  g12(.a(x15), .b(x14), .O(new_n45_));
  inv1   g13(.a(new_n45_), .O(new_n46_));
  nand3  g14(.a(x13), .b(x12), .c(x11), .O(new_n47_));
  inv1   g15(.a(new_n47_), .O(new_n48_));
  aoi21  g16(.a(new_n48_), .b(new_n46_), .c(new_n44_), .O(new_n49_));
  nor3   g17(.a(new_n47_), .b(new_n45_), .c(x16), .O(new_n50_));
  oai21  g18(.a(new_n50_), .b(new_n49_), .c(new_n43_), .O(new_n51_));
  nand2  g19(.a(x08), .b(x05), .O(new_n52_));
  nand2  g20(.a(new_n52_), .b(new_n51_), .O(z6));
  nand3  g21(.a(x16), .b(x15), .c(x14), .O(new_n54_));
  oai21  g22(.a(new_n54_), .b(new_n47_), .c(x17), .O(new_n55_));
  inv1   g23(.a(x17), .O(new_n56_));
  nand4  g24(.a(new_n56_), .b(x16), .c(x15), .d(x14), .O(new_n57_));
  oai21  g25(.a(new_n57_), .b(new_n47_), .c(new_n55_), .O(new_n58_));
  nand2  g26(.a(new_n58_), .b(new_n43_), .O(new_n59_));
