...
module FAU ( 
  ...
  nand2  g26(.a(new_n52_), .b(x13), .O(new_n55_));
  oai22  g27(.a(new_n55_), .b(new_n47_), .c(new_n54_), .d(new_n52_), .O(new_n56_));
  nand2  g28(.a(new_n56_), .b(new_n51_), .O(new_n57_));
  nand2  g29(.a(x08), .b(x03), .O(new_n58_));
  nand2  g30(.a(new_n58_), .b(new_n57_), .O(z4));
  nand2  g31(.a(x15), .b(x14), .O(new_n61_));
  oai21  g32(.a(new_n53_), .b(new_n61_), .c(x16), .O(new_n62_));
  nor2   g33(.a(new_n61_), .b(x16), .O(new_n63_));
  nand2  g34(.a(new_n63_), .b(new_n54_), .O(new_n64_));
  nand2  g35(.a(new_n64_), .b(new_n62_), .O(new_n65_));
  nand2  g36(.a(new_n65_), .b(new_n51_), .O(new_n66_));
  ...
  nand4  g44(.a(x14), .b(x13), .c(x12), .d(x11), .O(new_n75_));
  inv1   g45(.a(new_n75_), .O(new_n76_));
  nand3  g46(.a(new_n76_), .b(new_n74_), .c(new_n72_), .O(new_n77_));
  nand2  g47(.a(new_n77_), .b(new_n71_), .O(new_n78_));
  nand2  g48(.a(new_n78_), .b(new_n51_), .O(new_n79_));
  nand2  g49(.a(x08), .b(x07), .O(new_n80_));
  nand2  g50(.a(new_n80_), .b(new_n79_), .O(z8));
  zero   g51(.O(z5));
  zero   g52(.O(z7));
endmodule
