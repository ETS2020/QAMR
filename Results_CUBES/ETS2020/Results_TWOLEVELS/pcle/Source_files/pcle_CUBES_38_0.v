...
module FAU ( 
  ...
  oai21  g34(.a(new_n64_), .b(new_n42_), .c(x17), .O(new_n65_));
  inv1   g35(.a(x17), .O(new_n66_));
  nand4  g36(.a(new_n66_), .b(x16), .c(x15), .d(x14), .O(new_n67_));
  oai21  g37(.a(new_n67_), .b(new_n42_), .c(new_n65_), .O(new_n68_));
  nand2  g38(.a(new_n68_), .b(new_n54_), .O(new_n69_));
  nand2  g39(.a(x08), .b(x06), .O(new_n70_));
  nand2  g40(.a(new_n70_), .b(new_n69_), .O(z7));
  nand4  g41(.a(x17), .b(x16), .c(x15), .d(x14), .O(new_n72_));
  oai21  g42(.a(new_n72_), .b(new_n42_), .c(x18), .O(new_n73_));
  inv1   g43(.a(new_n48_), .O(new_n74_));
  and2   g44(.a(x16), .b(x15), .O(new_n75_));
  nor2   g45(.a(x18), .b(new_n66_), .O(new_n76_));
  nand3  g46(.a(new_n76_), .b(new_n75_), .c(new_n74_), .O(new_n77_));
  nand2  g47(.a(new_n77_), .b(new_n73_), .O(new_n78_));
  nand2  g48(.a(new_n78_), .b(new_n54_), .O(new_n79_));
