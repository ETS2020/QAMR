...
module FAU ( 
  ...
  nand3  g12(.a(x15), .b(x14), .c(x13), .O(new_n45_));
  oai21  g13(.a(new_n45_), .b(new_n37_), .c(x16), .O(new_n46_));
  inv1   g14(.a(x16), .O(new_n47_));
  nand4  g15(.a(new_n47_), .b(x15), .c(x14), .d(x13), .O(new_n48_));
  oai21  g16(.a(new_n48_), .b(new_n37_), .c(new_n46_), .O(new_n49_));
  nand2  g17(.a(new_n49_), .b(new_n44_), .O(new_n50_));
  nand2  g18(.a(x08), .b(x05), .O(new_n51_));
  nand2  g19(.a(new_n51_), .b(new_n50_), .O(z6));
  zero   g20(.O(z0));
  zero   g21(.O(z2));
  zero   g22(.O(z4));
  zero   g23(.O(z5));
