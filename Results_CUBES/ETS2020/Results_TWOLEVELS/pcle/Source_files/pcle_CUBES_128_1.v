...
module FAU ( 
  ...
  and2   g16(.a(x12), .b(x11), .O(new_n46_));
  xnor2a g17(.a(new_n46_), .b(x13), .O(new_n47_));
  nand2  g18(.a(new_n36_), .b(new_n42_), .O(new_n48_));
  nand2  g19(.a(x08), .b(x02), .O(new_n49_));
  oai21  g20(.a(new_n48_), .b(new_n47_), .c(new_n49_), .O(z3));
  ...
  nand4  g25(.a(new_n52_), .b(x13), .c(x12), .d(x11), .O(new_n55_));
  oai21  g26(.a(new_n54_), .b(new_n52_), .c(new_n55_), .O(new_n56_));
  ...
  nor2   g32(.a(new_n61_), .b(x15), .O(new_n62_));
  aoi22  g33(.a(new_n62_), .b(new_n46_), .c(new_n60_), .d(x15), .O(new_n63_));
  nand2  g34(.a(x08), .b(x04), .O(new_n64_));
  oai21  g35(.a(new_n63_), .b(new_n48_), .c(new_n64_), .O(z5));
  oai21  g36(.a(new_n53_), .b(new_n31_), .c(x16), .O(new_n66_));
  inv1   g37(.a(x16), .O(new_n67_));
  nand3  g38(.a(new_n54_), .b(new_n32_), .c(new_n67_), .O(new_n68_));
  nand2  g39(.a(new_n68_), .b(new_n66_), .O(new_n69_));
  nand2  g40(.a(new_n69_), .b(new_n51_), .O(new_n70_));
  nand2  g41(.a(x08), .b(x05), .O(new_n71_));
  nand2  g42(.a(new_n71_), .b(new_n70_), .O(z6));
  nand3  g43(.a(x16), .b(x15), .c(x14), .O(new_n73_));
  oai21  g44(.a(new_n73_), .b(new_n53_), .c(x17), .O(new_n74_));
  inv1   g45(.a(x17), .O(new_n75_));
  nand4  g46(.a(new_n75_), .b(x16), .c(x15), .d(x14), .O(new_n76_));
  oai21  g47(.a(new_n76_), .b(new_n53_), .c(new_n74_), .O(new_n77_));
  nand2  g48(.a(new_n77_), .b(new_n51_), .O(new_n78_));
