...
module FAU ( 
  ...
  nand4  g30(.a(x17), .b(x16), .c(x15), .d(x14), .O(new_n62_));
  oai21  g31(.a(new_n62_), .b(new_n45_), .c(x18), .O(new_n63_));
  inv1   g32(.a(new_n54_), .O(new_n64_));
  and2   g33(.a(x16), .b(x15), .O(new_n65_));
  inv1   g34(.a(x17), .O(new_n66_));
  nor2   g35(.a(x18), .b(new_n66_), .O(new_n67_));
  nand3  g36(.a(new_n67_), .b(new_n65_), .c(new_n64_), .O(new_n68_));
  nand2  g37(.a(new_n68_), .b(new_n63_), .O(new_n69_));
  nand2  g38(.a(new_n69_), .b(new_n44_), .O(new_n70_));
  nand2  g39(.a(x08), .b(x07), .O(new_n71_));
  nand2  g40(.a(new_n71_), .b(new_n70_), .O(z8));
  zero   g41(.O(z0));
  zero   g42(.O(z6));
  zero   g43(.O(z7));
endmodule
