...
module FAU ( 
  ...
  inv1   g18(.a(new_n44_), .O(new_n50_));
  nand2  g19(.a(x12), .b(x11), .O(new_n51_));
  nand3  g20(.a(x15), .b(x14), .c(x13), .O(new_n52_));
  oai21  g21(.a(new_n52_), .b(new_n51_), .c(x16), .O(new_n53_));
  inv1   g22(.a(x16), .O(new_n54_));
  nand4  g23(.a(new_n54_), .b(x15), .c(x14), .d(x13), .O(new_n55_));
  oai21  g24(.a(new_n55_), .b(new_n51_), .c(new_n53_), .O(new_n56_));
  nand2  g25(.a(new_n56_), .b(new_n50_), .O(new_n57_));
