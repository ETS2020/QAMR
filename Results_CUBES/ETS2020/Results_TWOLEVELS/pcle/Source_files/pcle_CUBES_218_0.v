...
module FAU ( 
  ...
  nand4  g41(.a(x17), .b(x16), .c(x15), .d(x14), .O(new_n72_));
  oai21  g42(.a(new_n72_), .b(new_n64_), .c(x18), .O(new_n73_));
  inv1   g43(.a(new_n54_), .O(new_n74_));
  and2   g44(.a(x16), .b(x15), .O(new_n75_));
  inv1   g45(.a(x17), .O(new_n76_));
  nor2   g46(.a(x18), .b(new_n76_), .O(new_n77_));
  nand3  g47(.a(new_n77_), .b(new_n75_), .c(new_n74_), .O(new_n78_));
  nand2  g48(.a(new_n78_), .b(new_n73_), .O(new_n79_));
  nand2  g49(.a(new_n79_), .b(new_n60_), .O(new_n80_));
