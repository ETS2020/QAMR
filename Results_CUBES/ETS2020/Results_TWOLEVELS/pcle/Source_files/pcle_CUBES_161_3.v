// Benchmark "FAU" written by ABC on Tue Jul  7 11:18:43 2020
...
module FAU ( 
  ...
  oai21  g46(.a(new_n75_), .b(new_n52_), .c(x18), .O(new_n76_));
  inv1   g47(.a(new_n58_), .O(new_n77_));
  and2   g48(.a(x16), .b(x15), .O(new_n78_));
  inv1   g49(.a(x17), .O(new_n79_));
  nor2   g50(.a(x18), .b(new_n79_), .O(new_n80_));
  nand3  g51(.a(new_n80_), .b(new_n78_), .c(new_n77_), .O(new_n81_));
  nand2  g52(.a(new_n81_), .b(new_n76_), .O(new_n82_));
  nand2  g53(.a(new_n82_), .b(new_n64_), .O(new_n83_));
