...
module FAU ( 
  ...
  oai21  g25(.a(new_n55_), .b(new_n37_), .c(x16), .O(new_n56_));
  inv1   g26(.a(x16), .O(new_n57_));
  inv1   g27(.a(new_n42_), .O(new_n58_));
  and2   g28(.a(x15), .b(x14), .O(new_n59_));
  nand3  g29(.a(new_n59_), .b(new_n58_), .c(new_n57_), .O(new_n60_));
