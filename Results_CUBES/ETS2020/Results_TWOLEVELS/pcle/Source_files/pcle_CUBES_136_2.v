...
module FAU ( 
  ...
  oai21  g25(.a(new_n54_), .b(new_n42_), .c(new_n55_), .O(z5));
  inv1   g26(.a(new_n42_), .O(new_n57_));
  nand3  g27(.a(x15), .b(x14), .c(x13), .O(new_n58_));
  oai21  g28(.a(new_n58_), .b(new_n45_), .c(x16), .O(new_n59_));
  inv1   g29(.a(x16), .O(new_n60_));
  and2   g30(.a(x14), .b(x13), .O(new_n61_));
  nand4  g31(.a(new_n61_), .b(new_n50_), .c(new_n60_), .d(x15), .O(new_n62_));
  nand2  g32(.a(new_n62_), .b(new_n59_), .O(new_n63_));
  nand2  g33(.a(new_n63_), .b(new_n57_), .O(new_n64_));
