...
module FAU ( 
  ...
  aoi22  g25(.a(new_n53_), .b(new_n47_), .c(new_n51_), .d(x14), .O(new_n54_));
  nand2  g26(.a(x08), .b(x03), .O(new_n55_));
  oai21  g27(.a(new_n54_), .b(new_n44_), .c(new_n55_), .O(z4));
  nand4  g28(.a(x14), .b(x13), .c(x12), .d(x11), .O(new_n57_));
  nand2  g29(.a(x14), .b(x13), .O(new_n58_));
  nor2   g30(.a(new_n58_), .b(x15), .O(new_n59_));
  aoi22  g31(.a(new_n59_), .b(new_n47_), .c(new_n57_), .d(x15), .O(new_n60_));
  nand2  g32(.a(x08), .b(x04), .O(new_n61_));
  oai21  g33(.a(new_n60_), .b(new_n44_), .c(new_n61_), .O(z5));
  inv1   g34(.a(new_n44_), .O(new_n64_));
  nand3  g35(.a(x16), .b(x15), .c(x14), .O(new_n65_));
  oai21  g36(.a(new_n65_), .b(new_n51_), .c(x17), .O(new_n66_));
  inv1   g37(.a(x17), .O(new_n67_));
  nand4  g38(.a(new_n67_), .b(x16), .c(x15), .d(x14), .O(new_n68_));
  oai21  g39(.a(new_n68_), .b(new_n51_), .c(new_n66_), .O(new_n69_));
  nand2  g40(.a(new_n69_), .b(new_n64_), .O(new_n70_));
  nand2  g41(.a(x08), .b(x06), .O(new_n71_));
