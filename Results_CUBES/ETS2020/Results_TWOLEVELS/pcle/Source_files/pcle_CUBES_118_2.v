// Benchmark "FAU" written by ABC on Tue Jul  7 11:18:24 2020
...
module FAU ( 
  ...
  wire new_n31_, new_n32_, new_n33_, new_n34_, new_n35_, new_n37_, new_n38_,
    new_n39_, new_n42_, new_n43_, new_n44_, new_n45_, new_n46_, new_n49_,
  ...
  inv1   g16(.a(new_n34_), .O(new_n49_));
  nand3  g17(.a(x13), .b(x12), .c(x11), .O(new_n50_));
  nand3  g18(.a(x16), .b(x15), .c(x14), .O(new_n51_));
  oai21  g19(.a(new_n51_), .b(new_n50_), .c(x17), .O(new_n52_));
  inv1   g20(.a(x17), .O(new_n53_));
  nand4  g21(.a(new_n53_), .b(x16), .c(x15), .d(x14), .O(new_n54_));
  oai21  g22(.a(new_n54_), .b(new_n50_), .c(new_n52_), .O(new_n55_));
  nand2  g23(.a(new_n55_), .b(new_n49_), .O(new_n56_));
  nand2  g24(.a(x08), .b(x06), .O(new_n57_));
  nand2  g25(.a(new_n57_), .b(new_n56_), .O(z7));
  zero   g26(.O(z0));
  zero   g27(.O(z1));
  zero   g28(.O(z4));
  zero   g29(.O(z6));
