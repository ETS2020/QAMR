// Benchmark "FAU" written by ABC on Tue Jul  7 11:17:35 2020
...
module FAU ( 
  ...
  oai21  g32(.a(new_n61_), .b(new_n52_), .c(new_n62_), .O(z5));
  oai21  g33(.a(new_n48_), .b(new_n31_), .c(x16), .O(new_n64_));
  inv1   g34(.a(x16), .O(new_n65_));
  nand3  g35(.a(new_n49_), .b(new_n32_), .c(new_n65_), .O(new_n66_));
  nand2  g36(.a(new_n66_), .b(new_n64_), .O(new_n67_));
  nand2  g37(.a(new_n67_), .b(new_n53_), .O(new_n68_));
  nand2  g38(.a(x08), .b(x05), .O(new_n69_));
  nand2  g39(.a(new_n69_), .b(new_n68_), .O(z6));
  nand3  g40(.a(x16), .b(x15), .c(x14), .O(new_n71_));
  oai21  g41(.a(new_n71_), .b(new_n48_), .c(x17), .O(new_n72_));
  inv1   g42(.a(x17), .O(new_n73_));
  nand4  g43(.a(new_n73_), .b(x16), .c(x15), .d(x14), .O(new_n74_));
  oai21  g44(.a(new_n74_), .b(new_n48_), .c(new_n72_), .O(new_n75_));
  nand2  g45(.a(new_n75_), .b(new_n53_), .O(new_n76_));
