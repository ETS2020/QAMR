// Benchmark "FAU" written by ABC on Tue Jul  7 11:19:22 2020
...
module FAU ( 
  ...
  oai21  g29(.a(new_n61_), .b(new_n44_), .c(x18), .O(new_n62_));
  and2   g30(.a(x16), .b(x15), .O(new_n63_));
  inv1   g31(.a(x17), .O(new_n64_));
  nor2   g32(.a(x18), .b(new_n64_), .O(new_n65_));
  nand4  g33(.a(x14), .b(x13), .c(x12), .d(x11), .O(new_n66_));
  inv1   g34(.a(new_n66_), .O(new_n67_));
  nand3  g35(.a(new_n67_), .b(new_n65_), .c(new_n63_), .O(new_n68_));
  nand2  g36(.a(new_n68_), .b(new_n62_), .O(new_n69_));
  nand2  g37(.a(new_n69_), .b(new_n42_), .O(new_n70_));
