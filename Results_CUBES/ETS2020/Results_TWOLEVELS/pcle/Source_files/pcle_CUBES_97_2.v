...
module FAU ( 
  ...
  inv1   g06(.a(x14), .O(new_n38_));
  nand3  g07(.a(x13), .b(x12), .c(x11), .O(new_n39_));
  inv1   g08(.a(new_n39_), .O(new_n40_));
  nand4  g09(.a(new_n38_), .b(x13), .c(x12), .d(x11), .O(new_n41_));
  oai21  g10(.a(new_n40_), .b(new_n38_), .c(new_n41_), .O(new_n42_));
  nand3  g11(.a(new_n32_), .b(x09), .c(new_n31_), .O(new_n43_));
  inv1   g12(.a(new_n43_), .O(new_n44_));
  nand2  g13(.a(new_n44_), .b(new_n42_), .O(new_n45_));
  nand2  g14(.a(x08), .b(x03), .O(new_n46_));
  nand2  g15(.a(new_n46_), .b(new_n45_), .O(z4));
  inv1   g16(.a(x16), .O(new_n49_));
  nand2  g17(.a(x15), .b(x14), .O(new_n50_));
  inv1   g18(.a(new_n50_), .O(new_n51_));
  aoi21  g19(.a(new_n51_), .b(new_n40_), .c(new_n49_), .O(new_n52_));
  nor3   g20(.a(new_n50_), .b(new_n39_), .c(x16), .O(new_n53_));
  oai21  g21(.a(new_n53_), .b(new_n52_), .c(new_n44_), .O(new_n54_));
  nand2  g22(.a(x08), .b(x05), .O(new_n55_));
  nand2  g23(.a(new_n55_), .b(new_n54_), .O(z6));
  nand3  g24(.a(x16), .b(x15), .c(x14), .O(new_n57_));
  oai21  g25(.a(new_n57_), .b(new_n39_), .c(x17), .O(new_n58_));
  inv1   g26(.a(x17), .O(new_n59_));
  nand4  g27(.a(new_n59_), .b(x16), .c(x15), .d(x14), .O(new_n60_));
  oai21  g28(.a(new_n60_), .b(new_n39_), .c(new_n58_), .O(new_n61_));
  nand2  g29(.a(new_n61_), .b(new_n44_), .O(new_n62_));
