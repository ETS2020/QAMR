...
module FAU ( 
  ...
  aoi22  g36(.a(new_n64_), .b(new_n49_), .c(new_n62_), .d(x15), .O(new_n65_));
  nand2  g37(.a(x08), .b(x04), .O(new_n66_));
  oai21  g38(.a(new_n65_), .b(new_n46_), .c(new_n66_), .O(z5));
  oai21  g39(.a(new_n55_), .b(new_n31_), .c(x16), .O(new_n68_));
  inv1   g40(.a(x16), .O(new_n69_));
  nand3  g41(.a(new_n56_), .b(new_n32_), .c(new_n69_), .O(new_n70_));
  ...
  oai21  g47(.a(new_n75_), .b(new_n55_), .c(x17), .O(new_n76_));
