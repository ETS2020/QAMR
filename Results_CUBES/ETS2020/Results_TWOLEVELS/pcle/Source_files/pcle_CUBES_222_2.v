...
module FAU ( 
  ...
  oai21  g44(.a(new_n74_), .b(new_n49_), .c(x18), .O(new_n75_));
  inv1   g45(.a(new_n58_), .O(new_n76_));
  and2   g46(.a(x16), .b(x15), .O(new_n77_));
  inv1   g47(.a(x17), .O(new_n78_));
  nor2   g48(.a(x18), .b(new_n78_), .O(new_n79_));
  nand3  g49(.a(new_n79_), .b(new_n77_), .c(new_n76_), .O(new_n80_));
  nand2  g50(.a(new_n80_), .b(new_n75_), .O(new_n81_));
  nand2  g51(.a(new_n81_), .b(new_n48_), .O(new_n82_));
  nand2  g52(.a(x08), .b(x07), .O(new_n83_));
  nand2  g53(.a(new_n83_), .b(new_n82_), .O(z8));
  zero   g54(.O(z3));
  zero   g55(.O(z7));
endmodule
