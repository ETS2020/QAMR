...
module FAU ( 
  ...
  nand2  g24(.a(new_n50_), .b(x13), .O(new_n54_));
  oai22  g25(.a(new_n54_), .b(new_n51_), .c(new_n53_), .d(new_n50_), .O(new_n55_));
  nand2  g26(.a(new_n55_), .b(new_n49_), .O(new_n56_));
  nand2  g27(.a(x08), .b(x03), .O(new_n57_));
  nand2  g28(.a(new_n57_), .b(new_n56_), .O(z4));
  nand3  g29(.a(x15), .b(x14), .c(x13), .O(new_n60_));
  oai21  g30(.a(new_n60_), .b(new_n51_), .c(x16), .O(new_n61_));
  inv1   g31(.a(x16), .O(new_n62_));
  and2   g32(.a(x15), .b(x14), .O(new_n63_));
  nand3  g33(.a(new_n53_), .b(new_n63_), .c(new_n62_), .O(new_n64_));
  nand2  g34(.a(new_n64_), .b(new_n61_), .O(new_n65_));
  nand2  g35(.a(new_n65_), .b(new_n49_), .O(new_n66_));
