...
module FAU ( 
  ...
  nand4  g21(.a(new_n50_), .b(x13), .c(x12), .d(x11), .O(new_n51_));
  and2   g22(.a(new_n51_), .b(new_n49_), .O(new_n52_));
  ...
  oai21  g27(.a(new_n58_), .b(new_n48_), .c(x17), .O(new_n59_));
  inv1   g28(.a(x17), .O(new_n60_));
  nand4  g29(.a(new_n60_), .b(x16), .c(x15), .d(x14), .O(new_n61_));
  oai21  g30(.a(new_n61_), .b(new_n48_), .c(new_n59_), .O(new_n62_));
  nand2  g31(.a(new_n62_), .b(new_n57_), .O(new_n63_));
