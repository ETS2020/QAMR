...
module FAU ( 
  ...
  nor2   g19(.a(x27), .b(new_n68_), .O(new_n76_));
  ...
  nor2   g47(.a(x24), .b(new_n68_), .O(new_n105_));
  ...
  nor2   g54(.a(x33), .b(new_n68_), .O(new_n112_));
  ...
  nor2   g61(.a(x34), .b(new_n68_), .O(new_n119_));
  ...
  nor2   g68(.a(x35), .b(new_n68_), .O(new_n126_));
