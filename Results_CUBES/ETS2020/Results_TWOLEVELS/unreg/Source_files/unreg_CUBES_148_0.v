// Benchmark "FAU" written by ABC on Tue Jul  7 16:44:37 2020
...
module FAU ( 
  ...
  nor2   g33(.a(x27), .b(new_n57_), .O(new_n88_));
  oai21  g34(.a(new_n88_), .b(new_n87_), .c(new_n60_), .O(new_n89_));
  inv1   g35(.a(x26), .O(new_n90_));
  nand2  g36(.a(new_n90_), .b(new_n59_), .O(new_n91_));
  nand2  g37(.a(new_n91_), .b(new_n89_), .O(z06));
  inv1   g38(.a(x04), .O(new_n93_));
  nor2   g39(.a(x18), .b(new_n93_), .O(new_n94_));
  nor2   g40(.a(x20), .b(new_n57_), .O(new_n95_));
  oai21  g41(.a(new_n95_), .b(new_n94_), .c(new_n60_), .O(new_n96_));
  inv1   g42(.a(x27), .O(new_n97_));
  nand2  g43(.a(new_n97_), .b(new_n59_), .O(new_n98_));
  nand2  g44(.a(new_n98_), .b(new_n96_), .O(z07));
  inv1   g45(.a(x11), .O(new_n100_));
  nor2   g46(.a(x18), .b(new_n100_), .O(new_n101_));
  nor2   g47(.a(x29), .b(new_n57_), .O(new_n102_));
  oai21  g48(.a(new_n102_), .b(new_n101_), .c(new_n60_), .O(new_n103_));
  inv1   g49(.a(x28), .O(new_n104_));
  nand2  g50(.a(new_n104_), .b(new_n59_), .O(new_n105_));
  nand2  g51(.a(new_n105_), .b(new_n103_), .O(z08));
  inv1   g52(.a(x10), .O(new_n107_));
  nor2   g53(.a(x18), .b(new_n107_), .O(new_n108_));
  nor2   g54(.a(x30), .b(new_n57_), .O(new_n109_));
  oai21  g55(.a(new_n109_), .b(new_n108_), .c(new_n60_), .O(new_n110_));
  inv1   g56(.a(x29), .O(new_n111_));
  nand2  g57(.a(new_n111_), .b(new_n59_), .O(new_n112_));
  nand2  g58(.a(new_n112_), .b(new_n110_), .O(z09));
  inv1   g59(.a(x09), .O(new_n114_));
  nor2   g60(.a(x18), .b(new_n114_), .O(new_n115_));
  nor2   g61(.a(x31), .b(new_n57_), .O(new_n116_));
  oai21  g62(.a(new_n116_), .b(new_n115_), .c(new_n60_), .O(new_n117_));
  inv1   g63(.a(x30), .O(new_n118_));
  nand2  g64(.a(new_n118_), .b(new_n59_), .O(new_n119_));
  nand2  g65(.a(new_n119_), .b(new_n117_), .O(z10));
  inv1   g66(.a(x15), .O(new_n122_));
  nor2   g67(.a(x18), .b(new_n122_), .O(new_n123_));
  nor2   g68(.a(x33), .b(new_n57_), .O(new_n124_));
  oai21  g69(.a(new_n124_), .b(new_n123_), .c(new_n60_), .O(new_n125_));
  inv1   g70(.a(x32), .O(new_n126_));
  nand2  g71(.a(new_n126_), .b(new_n59_), .O(new_n127_));
  nand2  g72(.a(new_n127_), .b(new_n125_), .O(z12));
  inv1   g73(.a(x14), .O(new_n129_));
  nor2   g74(.a(x18), .b(new_n129_), .O(new_n130_));
  nor2   g75(.a(x34), .b(new_n57_), .O(new_n131_));
  oai21  g76(.a(new_n131_), .b(new_n130_), .c(new_n60_), .O(new_n132_));
  inv1   g77(.a(x33), .O(new_n133_));
  nand2  g78(.a(new_n133_), .b(new_n59_), .O(new_n134_));
  nand2  g79(.a(new_n134_), .b(new_n132_), .O(z13));
  inv1   g80(.a(x13), .O(new_n136_));
  nor2   g81(.a(x18), .b(new_n136_), .O(new_n137_));
  nor2   g82(.a(x35), .b(new_n57_), .O(new_n138_));
  oai21  g83(.a(new_n138_), .b(new_n137_), .c(new_n60_), .O(new_n139_));
  inv1   g84(.a(x34), .O(new_n140_));
  nand2  g85(.a(new_n140_), .b(new_n59_), .O(new_n141_));
  nand2  g86(.a(new_n141_), .b(new_n139_), .O(z14));
  inv1   g87(.a(x12), .O(new_n143_));
  nor2   g88(.a(x18), .b(new_n143_), .O(new_n144_));
  nor2   g89(.a(x28), .b(new_n57_), .O(new_n145_));
  oai21  g90(.a(new_n145_), .b(new_n144_), .c(new_n60_), .O(new_n146_));
  inv1   g91(.a(x35), .O(new_n147_));
  nand2  g92(.a(new_n147_), .b(new_n59_), .O(new_n148_));
