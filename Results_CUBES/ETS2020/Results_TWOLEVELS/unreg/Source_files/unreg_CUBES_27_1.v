// Benchmark "FAU" written by ABC on Tue Jul  7 16:43:44 2020
...
module FAU ( 
  ...
  nor2   g54(.a(x28), .b(new_n57_), .O(new_n115_));
  oai21  g55(.a(new_n115_), .b(new_n114_), .c(new_n60_), .O(new_n116_));
  inv1   g56(.a(x35), .O(new_n117_));
  nand2  g57(.a(new_n117_), .b(new_n59_), .O(new_n118_));
