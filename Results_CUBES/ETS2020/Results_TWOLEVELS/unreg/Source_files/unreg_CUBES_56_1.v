...
module FAU ( 
  ...
  nor2   g19(.a(x27), .b(new_n55_), .O(new_n76_));
  oai21  g20(.a(new_n76_), .b(new_n75_), .c(new_n58_), .O(new_n77_));
  inv1   g21(.a(x26), .O(new_n78_));
  nand2  g22(.a(new_n78_), .b(new_n57_), .O(new_n79_));
  nand2  g23(.a(new_n79_), .b(new_n77_), .O(z06));
  inv1   g24(.a(x11), .O(new_n82_));
  nor2   g25(.a(x18), .b(new_n82_), .O(new_n83_));
  nor2   g26(.a(x29), .b(new_n55_), .O(new_n84_));
  oai21  g27(.a(new_n84_), .b(new_n83_), .c(new_n58_), .O(new_n85_));
  inv1   g28(.a(x28), .O(new_n86_));
  nand2  g29(.a(new_n86_), .b(new_n57_), .O(new_n87_));
