...
module FAU ( 
  ...
  nor2   g33(.a(x29), .b(new_n68_), .O(new_n90_));
  ...
  nor2   g40(.a(x30), .b(new_n68_), .O(new_n97_));
  ...
  nor2   g47(.a(x31), .b(new_n68_), .O(new_n104_));
  ...
  nor2   g54(.a(x24), .b(new_n68_), .O(new_n111_));
  ...
  nor2   g61(.a(x33), .b(new_n68_), .O(new_n118_));
  ...
  nor2   g68(.a(x34), .b(new_n68_), .O(new_n125_));
  ...
  nor2   g75(.a(x28), .b(new_n68_), .O(new_n133_));
