// Benchmark "FAU" written by ABC on Tue Jul  7 16:44:46 2020
...
module FAU ( 
  ...
  nor2   g75(.a(x33), .b(new_n56_), .O(new_n130_));
  oai21  g76(.a(new_n130_), .b(new_n129_), .c(new_n59_), .O(new_n131_));
  inv1   g77(.a(x32), .O(new_n132_));
  nand2  g78(.a(new_n132_), .b(new_n58_), .O(new_n133_));
  ...
  nor2   g89(.a(x35), .b(new_n56_), .O(new_n144_));
  oai21  g90(.a(new_n144_), .b(new_n143_), .c(new_n59_), .O(new_n145_));
  inv1   g91(.a(x34), .O(new_n146_));
  nand2  g92(.a(new_n146_), .b(new_n58_), .O(new_n147_));
