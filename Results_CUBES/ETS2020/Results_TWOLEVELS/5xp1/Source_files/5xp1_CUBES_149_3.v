// Benchmark "FAU" written by ABC on Mon Jul  6 15:57:49 2020
...
module FAU ( 
  ...
  aoi21  g072(.a(z8), .b(new_n25_), .c(new_n40_), .O(new_n90_));
  ...
  nand2  g083(.a(z8), .b(x2), .O(new_n101_));
  oai21  g084(.a(new_n91_), .b(new_n26_), .c(new_n101_), .O(new_n102_));
  nand2  g085(.a(new_n102_), .b(new_n25_), .O(new_n103_));
  aoi21  g086(.a(x3), .b(x1), .c(x2), .O(new_n104_));
  oai21  g087(.a(new_n104_), .b(new_n21_), .c(x0), .O(new_n105_));
  ...
  nand3  g096(.a(x3), .b(new_n40_), .c(new_n26_), .O(new_n114_));
  nand2  g097(.a(new_n114_), .b(new_n113_), .O(z6));
  nand2  g098(.a(new_n101_), .b(new_n91_), .O(z7));
  nand2  g099(.a(x5), .b(x4), .O(new_n117_));
  aoi21  g100(.a(new_n23_), .b(new_n22_), .c(new_n117_), .O(z9));
endmodule
