// Benchmark "FAU" written by ABC on Mon Jul  6 15:57:14 2020
...
module FAU ( 
  ...
  wire new_n18_, new_n19_, new_n20_, new_n21_, new_n22_, new_n23_, new_n24_,
    ...
    new_n107_, new_n108_, new_n109_, new_n111_, new_n114_;
  ...
  aoi21  g72(.a(new_n76_), .b(new_n25_), .c(new_n40_), .O(new_n90_));
  nand2  g73(.a(x3), .b(new_n40_), .O(new_n91_));
  oai22  g74(.a(new_n91_), .b(new_n25_), .c(new_n90_), .d(x1), .O(new_n92_));
  ...
  oai21  g89(.a(new_n107_), .b(new_n76_), .c(x1), .O(new_n108_));
  nand3  g90(.a(x3), .b(new_n40_), .c(new_n26_), .O(new_n109_));
  nand2  g91(.a(new_n109_), .b(new_n108_), .O(z6));
  nand2  g92(.a(new_n76_), .b(x2), .O(new_n111_));
  nand2  g93(.a(new_n111_), .b(new_n91_), .O(z7));
  nand2  g94(.a(x5), .b(x4), .O(new_n114_));
  aoi21  g95(.a(new_n23_), .b(new_n22_), .c(new_n114_), .O(z9));
  zero   g96(.O(z5));
  zero   g97(.O(z8));
endmodule
