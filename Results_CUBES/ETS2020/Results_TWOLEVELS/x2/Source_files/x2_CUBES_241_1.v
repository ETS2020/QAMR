...
module FAU ( 
  ...
  nand3  g12(.a(new_n30_), .b(new_n29_), .c(new_n28_), .O(new_n31_));
  inv1   g13(.a(new_n31_), .O(new_n32_));
  nand4  g14(.a(new_n32_), .b(new_n18_), .c(x8), .d(new_n20_), .O(z3));
  oai21  g15(.a(x9), .b(new_n21_), .c(new_n20_), .O(new_n34_));
  nand2  g16(.a(new_n25_), .b(x8), .O(new_n35_));
  nand3  g17(.a(new_n35_), .b(new_n34_), .c(x6), .O(z4));
  ...
  nand2  g22(.a(new_n21_), .b(new_n20_), .O(new_n41_));
  oai21  g23(.a(new_n24_), .b(new_n20_), .c(new_n41_), .O(new_n42_));
  nand4  g24(.a(new_n42_), .b(x2), .c(new_n29_), .d(new_n28_), .O(new_n43_));
  ...
  nand3  g30(.a(new_n48_), .b(new_n43_), .c(new_n40_), .O(z5));
  aoi21  g31(.a(new_n31_), .b(x8), .c(new_n18_), .O(new_n50_));
  ...
  aoi21  g36(.a(new_n54_), .b(new_n20_), .c(new_n44_), .O(new_n55_));
