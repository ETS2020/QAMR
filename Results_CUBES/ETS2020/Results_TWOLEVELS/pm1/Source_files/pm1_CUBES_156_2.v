// Benchmark "FAU" written by ABC on Tue Jul  7 11:32:13 2020
...
module FAU ( 
  ...
  nand4  g14(.a(new_n41_), .b(x12), .c(x09), .d(x01), .O(new_n49_));
  nand2  g15(.a(new_n32_), .b(new_n30_), .O(new_n50_));
  inv1   g16(.a(x10), .O(new_n51_));
  nand3  g17(.a(x11), .b(new_n51_), .c(x00), .O(new_n52_));
  aoi21  g18(.a(new_n50_), .b(new_n49_), .c(new_n52_), .O(z11));
  zero   g19(.O(z03));
  zero   g20(.O(z07));
  zero   g21(.O(z08));
  zero   g22(.O(z09));
