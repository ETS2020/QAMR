...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n32_, new_n35_, new_n36_, new_n41_, new_n42_,
    new_n43_, new_n49_, new_n50_, new_n51_, new_n52_, new_n54_, new_n55_,
    new_n56_;
  ...
  nand2  g20(.a(new_n51_), .b(x00), .O(new_n54_));
  inv1   g21(.a(x09), .O(new_n55_));
  nand3  g22(.a(x12), .b(x11), .c(new_n55_), .O(new_n56_));
  nor2   g23(.a(new_n56_), .b(new_n54_), .O(z12));
  zero   g24(.O(z03));
  zero   g25(.O(z08));
  zero   g26(.O(z09));
  zero   g27(.O(z10));
