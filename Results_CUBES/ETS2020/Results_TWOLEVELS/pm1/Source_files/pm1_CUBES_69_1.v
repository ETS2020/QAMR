// Benchmark "FAU" written by ABC on Tue Jul  7 11:31:35 2020
...
module FAU ( 
  ...
  nor2   g37(.a(new_n31_), .b(new_n50_), .O(new_n67_));
  nand4  g38(.a(new_n67_), .b(new_n60_), .c(new_n57_), .d(x12), .O(new_n68_));
  inv1   g39(.a(new_n68_), .O(z10));
  nor4   g40(.a(new_n56_), .b(new_n32_), .c(new_n31_), .d(x09), .O(z12));
  zero   g41(.O(z11));
endmodule
