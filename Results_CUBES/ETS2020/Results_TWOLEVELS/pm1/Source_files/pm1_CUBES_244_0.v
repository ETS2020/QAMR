// Benchmark "FAU" written by ABC on Tue Jul  7 11:32:51 2020
...
module FAU ( 
  ...
  nand4  g22(.a(new_n55_), .b(new_n52_), .c(new_n51_), .d(z01), .O(z08));
  ...
  nand3  g33(.a(x12), .b(x11), .c(new_n66_), .O(new_n67_));
  nor2   g34(.a(new_n67_), .b(new_n54_), .O(z12));
  zero   g35(.O(z04));
  zero   g36(.O(z05));
  zero   g37(.O(z06));
  zero   g38(.O(z07));
