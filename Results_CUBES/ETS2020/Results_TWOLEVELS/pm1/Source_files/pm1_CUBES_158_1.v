...
module FAU ( 
  ...
  nand3  g14(.a(x04), .b(x03), .c(x02), .O(new_n46_));
  inv1   g15(.a(new_n46_), .O(new_n47_));
  nand3  g16(.a(x12), .b(x11), .c(x09), .O(new_n48_));
  inv1   g17(.a(new_n48_), .O(new_n49_));
  nand2  g18(.a(new_n49_), .b(new_n47_), .O(new_n50_));
  ...
  nand4  g23(.a(new_n54_), .b(new_n51_), .c(new_n50_), .d(z01), .O(z08));
  nand2  g24(.a(x12), .b(x11), .O(new_n56_));
  aoi21  g25(.a(new_n56_), .b(new_n51_), .c(new_n53_), .O(z09));
  nand2  g26(.a(new_n46_), .b(x12), .O(new_n58_));
  nand4  g27(.a(x11), .b(new_n52_), .c(x09), .d(x00), .O(new_n59_));
  nor2   g28(.a(new_n59_), .b(new_n58_), .O(z10));
  nand4  g29(.a(new_n46_), .b(x12), .c(x09), .d(x01), .O(new_n61_));
  nand2  g30(.a(new_n32_), .b(new_n30_), .O(new_n62_));
  nand3  g31(.a(x11), .b(new_n52_), .c(x00), .O(new_n63_));
  aoi21  g32(.a(new_n62_), .b(new_n61_), .c(new_n63_), .O(z11));
  inv1   g33(.a(x09), .O(new_n65_));
  nand3  g34(.a(x12), .b(x11), .c(new_n65_), .O(new_n66_));
  nor2   g35(.a(new_n66_), .b(new_n53_), .O(z12));
  zero   g36(.O(z02));
  zero   g37(.O(z05));
endmodule
