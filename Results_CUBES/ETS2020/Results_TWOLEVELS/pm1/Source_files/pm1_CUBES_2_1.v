...
module FAU ( 
  ...
  aoi21  g11(.a(x12), .b(new_n31_), .c(new_n42_), .O(new_n43_));
  ...
  oai21  g17(.a(x10), .b(new_n47_), .c(new_n32_), .O(new_n49_));
  nand2  g18(.a(new_n49_), .b(new_n31_), .O(new_n50_));
  nand3  g19(.a(new_n41_), .b(new_n37_), .c(x04), .O(new_n51_));
  nand3  g20(.a(new_n51_), .b(new_n50_), .c(new_n48_), .O(z08));
  xnor2a g21(.a(x12), .b(x11), .O(new_n53_));
  and2   g22(.a(new_n53_), .b(new_n48_), .O(z09));
  nand3  g23(.a(x04), .b(x03), .c(x02), .O(new_n55_));
  nand2  g24(.a(new_n55_), .b(x12), .O(new_n56_));
  inv1   g25(.a(x10), .O(new_n57_));
  nand4  g26(.a(x11), .b(new_n57_), .c(x09), .d(x00), .O(new_n58_));
  nor2   g27(.a(new_n58_), .b(new_n56_), .O(z10));
  nand4  g28(.a(new_n55_), .b(x12), .c(x09), .d(x01), .O(new_n60_));
  nand2  g29(.a(new_n32_), .b(new_n30_), .O(new_n61_));
  nand3  g30(.a(x11), .b(new_n57_), .c(x00), .O(new_n62_));
