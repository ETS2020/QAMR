...
module FAU ( 
  ...
  nor2   g15(.a(x10), .b(new_n49_), .O(new_n50_));
  nand4  g16(.a(x12), .b(x11), .c(x04), .d(x03), .O(new_n51_));
  inv1   g17(.a(new_n51_), .O(new_n52_));
  nand4  g18(.a(new_n52_), .b(new_n50_), .c(x02), .d(x00), .O(new_n53_));
  inv1   g19(.a(x10), .O(new_n54_));
  nand2  g20(.a(new_n54_), .b(x00), .O(new_n55_));
  inv1   g21(.a(new_n55_), .O(new_n56_));
  nand3  g22(.a(new_n56_), .b(new_n53_), .c(x11), .O(z08));
  nand3  g23(.a(x04), .b(x03), .c(x02), .O(new_n58_));
  nand3  g24(.a(new_n58_), .b(new_n45_), .c(x09), .O(new_n59_));
  nand2  g25(.a(new_n59_), .b(new_n39_), .O(new_n60_));
  nand2  g26(.a(new_n38_), .b(new_n37_), .O(new_n61_));
  aoi21  g27(.a(new_n61_), .b(new_n60_), .c(new_n55_), .O(z09));
  nand3  g28(.a(new_n58_), .b(new_n56_), .c(new_n35_), .O(new_n63_));
  inv1   g29(.a(new_n63_), .O(z10));
  nor4   g30(.a(new_n55_), .b(new_n38_), .c(new_n37_), .d(x09), .O(z12));
  zero   g31(.O(z00));
  zero   g32(.O(z01));
  zero   g33(.O(z04));
  zero   g34(.O(z05));
