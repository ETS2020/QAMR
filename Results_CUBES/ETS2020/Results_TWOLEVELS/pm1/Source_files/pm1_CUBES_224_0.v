// Benchmark "FAU" written by ABC on Tue Jul  7 11:32:42 2020
...
module FAU ( 
  ...
  nand3  g15(.a(x12), .b(x11), .c(x09), .O(new_n49_));
  inv1   g16(.a(new_n49_), .O(new_n50_));
  nand2  g17(.a(new_n50_), .b(new_n48_), .O(new_n51_));
  nand2  g18(.a(new_n32_), .b(new_n31_), .O(new_n52_));
  inv1   g19(.a(x10), .O(new_n53_));
  nand2  g20(.a(new_n53_), .b(x00), .O(new_n54_));
  inv1   g21(.a(new_n54_), .O(new_n55_));
  nand4  g22(.a(new_n55_), .b(new_n52_), .c(new_n51_), .d(new_n35_), .O(z08));
  nand2  g23(.a(x12), .b(x11), .O(new_n57_));
  aoi21  g24(.a(new_n57_), .b(new_n52_), .c(new_n54_), .O(z09));
  nand2  g25(.a(new_n47_), .b(x12), .O(new_n59_));
  nand4  g26(.a(x11), .b(new_n53_), .c(x09), .d(x00), .O(new_n60_));
  nor2   g27(.a(new_n60_), .b(new_n59_), .O(z10));
  nand4  g28(.a(new_n47_), .b(x12), .c(x09), .d(x01), .O(new_n62_));
  nand2  g29(.a(new_n32_), .b(new_n30_), .O(new_n63_));
  nand3  g30(.a(x11), .b(new_n53_), .c(x00), .O(new_n64_));
  aoi21  g31(.a(new_n63_), .b(new_n62_), .c(new_n64_), .O(z11));
  nand3  g32(.a(x12), .b(x11), .c(new_n37_), .O(new_n66_));
  nor2   g33(.a(new_n66_), .b(new_n54_), .O(z12));
  zero   g34(.O(z01));
  zero   g35(.O(z04));
  zero   g36(.O(z05));
  zero   g37(.O(z06));
