...
module FAU ( 
  ...
  wire new_n49_, new_n50_, new_n51_, new_n52_, new_n53_, new_n54_, new_n57_,
    new_n59_, new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n69_,
    new_n70_;
  ...
  nand4  g15(.a(new_n66_), .b(new_n65_), .c(new_n64_), .d(new_n63_), .O(new_n67_));
  inv1   g16(.a(new_n67_), .O(z10));
  xnor2a g17(.a(x18), .b(x17), .O(new_n69_));
  nand3  g18(.a(new_n66_), .b(new_n64_), .c(new_n63_), .O(new_n70_));
