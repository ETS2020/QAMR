...
module FAU ( 
  ...
  oai21  g44(.a(new_n75_), .b(new_n73_), .c(x19), .O(new_n92_));
  nor2   g45(.a(new_n75_), .b(new_n73_), .O(new_n93_));
  nand2  g46(.a(new_n93_), .b(new_n76_), .O(new_n94_));
  nand2  g47(.a(new_n86_), .b(new_n56_), .O(new_n95_));
  aoi21  g48(.a(new_n94_), .b(new_n92_), .c(new_n95_), .O(z12));
  nand2  g49(.a(new_n93_), .b(x19), .O(new_n97_));
