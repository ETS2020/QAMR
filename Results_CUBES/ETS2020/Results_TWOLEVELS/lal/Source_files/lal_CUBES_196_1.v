// Benchmark "FAU" written by ABC on Wed Jul  8 19:32:34 2020
...
module FAU ( 
  ...
  oai21  g41(.a(new_n75_), .b(new_n73_), .c(x19), .O(new_n91_));
  nor2   g42(.a(new_n75_), .b(new_n73_), .O(new_n92_));
  nand2  g43(.a(new_n92_), .b(new_n76_), .O(new_n93_));
  nand2  g44(.a(new_n86_), .b(new_n56_), .O(new_n94_));
  ...
  nand4  g48(.a(new_n97_), .b(new_n86_), .c(new_n67_), .d(new_n56_), .O(z13));
  nor2   g49(.a(x21), .b(x20), .O(new_n99_));
  inv1   g50(.a(new_n99_), .O(new_n100_));
  nand2  g51(.a(new_n86_), .b(new_n56_), .O(new_n101_));
  aoi21  g52(.a(new_n67_), .b(x21), .c(new_n101_), .O(new_n102_));
  oai21  g53(.a(new_n100_), .b(new_n96_), .c(new_n102_), .O(z14));
  inv1   g54(.a(new_n101_), .O(new_n104_));
  oai21  g55(.a(new_n100_), .b(new_n96_), .c(x22), .O(new_n105_));
  inv1   g56(.a(new_n96_), .O(new_n106_));
  nand3  g57(.a(new_n106_), .b(new_n68_), .c(new_n66_), .O(new_n107_));
  nand3  g58(.a(new_n107_), .b(new_n105_), .c(new_n104_), .O(z15));
  nand2  g59(.a(new_n68_), .b(new_n66_), .O(new_n109_));
  oai21  g60(.a(new_n109_), .b(new_n96_), .c(x23), .O(new_n110_));
  nand3  g61(.a(new_n99_), .b(new_n48_), .c(new_n52_), .O(new_n111_));
  ...
  inv1   g65(.a(new_n70_), .O(new_n115_));
  oai21  g66(.a(new_n111_), .b(new_n96_), .c(x24), .O(new_n116_));
  nand3  g67(.a(new_n116_), .b(new_n104_), .c(new_n115_), .O(z17));
  inv1   g68(.a(new_n67_), .O(new_n118_));
  nand4  g69(.a(new_n82_), .b(new_n68_), .c(new_n118_), .d(new_n48_), .O(new_n119_));
  nand2  g70(.a(new_n115_), .b(x25), .O(new_n120_));
