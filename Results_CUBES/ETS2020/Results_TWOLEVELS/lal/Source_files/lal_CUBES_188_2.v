...
module FAU ( 
  ...
  wire new_n46_, new_n48_, new_n49_, new_n50_, new_n51_, new_n52_, new_n53_,
    ...
    new_n88_, new_n89_, new_n90_, new_n92_, new_n93_, new_n95_, new_n98_,
  ...
  oai21  g51(.a(new_n81_), .b(new_n79_), .c(x19), .O(new_n98_));
  nor2   g52(.a(new_n81_), .b(new_n79_), .O(new_n99_));
  nand2  g53(.a(new_n99_), .b(new_n82_), .O(new_n100_));
  nand2  g54(.a(new_n92_), .b(new_n56_), .O(new_n101_));
  aoi21  g55(.a(new_n100_), .b(new_n98_), .c(new_n101_), .O(z12));
  nand2  g56(.a(new_n99_), .b(x19), .O(new_n103_));
  nand2  g57(.a(new_n103_), .b(x20), .O(new_n104_));
  nand4  g58(.a(new_n104_), .b(new_n92_), .c(new_n73_), .d(new_n56_), .O(z13));
  nor2   g59(.a(x21), .b(x20), .O(new_n106_));
  inv1   g60(.a(new_n106_), .O(new_n107_));
  nand2  g61(.a(new_n92_), .b(new_n56_), .O(new_n108_));
  aoi21  g62(.a(new_n73_), .b(x21), .c(new_n108_), .O(new_n109_));
  ...
  nand3  g67(.a(new_n113_), .b(new_n74_), .c(new_n72_), .O(new_n114_));
  nand3  g68(.a(new_n114_), .b(new_n112_), .c(new_n111_), .O(z15));
  nand2  g69(.a(new_n74_), .b(new_n72_), .O(new_n116_));
  ...
  inv1   g75(.a(new_n76_), .O(new_n122_));
  oai21  g76(.a(new_n118_), .b(new_n103_), .c(x24), .O(new_n123_));
  nand3  g77(.a(new_n123_), .b(new_n111_), .c(new_n122_), .O(z17));
  inv1   g78(.a(new_n73_), .O(new_n125_));
  nand4  g79(.a(new_n88_), .b(new_n74_), .c(new_n125_), .d(new_n48_), .O(new_n126_));
