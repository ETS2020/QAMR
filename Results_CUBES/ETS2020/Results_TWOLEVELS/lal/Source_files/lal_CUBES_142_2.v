...
module FAU ( 
  ...
  oai21  g44(.a(new_n80_), .b(new_n78_), .c(x19), .O(new_n94_));
  nor2   g45(.a(new_n80_), .b(new_n78_), .O(new_n95_));
  nand2  g46(.a(new_n95_), .b(new_n81_), .O(new_n96_));
  inv1   g47(.a(x07), .O(new_n97_));
  inv1   g48(.a(x15), .O(new_n98_));
  nand2  g49(.a(x05), .b(x04), .O(new_n99_));
  nand3  g50(.a(new_n99_), .b(new_n98_), .c(new_n97_), .O(new_n100_));
  aoi21  g51(.a(new_n96_), .b(new_n94_), .c(new_n100_), .O(z12));
  nand2  g52(.a(new_n95_), .b(x19), .O(new_n102_));
  nand2  g53(.a(new_n102_), .b(x20), .O(new_n103_));
  nand2  g54(.a(new_n56_), .b(new_n98_), .O(new_n104_));
  inv1   g55(.a(new_n104_), .O(new_n105_));
  nand3  g56(.a(new_n105_), .b(new_n103_), .c(new_n72_), .O(z13));
  nor2   g57(.a(x21), .b(x20), .O(new_n107_));
  inv1   g58(.a(new_n107_), .O(new_n108_));
  aoi21  g59(.a(new_n72_), .b(x21), .c(new_n104_), .O(new_n109_));
  ...
  nand3  g63(.a(new_n112_), .b(new_n73_), .c(new_n71_), .O(new_n113_));
  nand3  g64(.a(new_n113_), .b(new_n111_), .c(new_n105_), .O(z15));
  nand2  g65(.a(new_n73_), .b(new_n71_), .O(new_n115_));
  ...
  inv1   g71(.a(new_n75_), .O(new_n121_));
  ...
  inv1   g75(.a(new_n72_), .O(new_n125_));
  nand4  g76(.a(new_n87_), .b(new_n73_), .c(new_n125_), .d(new_n48_), .O(new_n126_));
