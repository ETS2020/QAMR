// Benchmark "FAU" written by ABC on Wed Jul  8 19:30:03 2020
...
module FAU ( 
  ...
  nand2  g41(.a(x05), .b(x04), .O(new_n89_));
  nand4  g42(.a(new_n89_), .b(new_n75_), .c(new_n88_), .d(new_n87_), .O(new_n90_));
  inv1   g43(.a(new_n90_), .O(z10));
  xnor2a g44(.a(x18), .b(x17), .O(new_n92_));
  nand3  g45(.a(new_n89_), .b(new_n88_), .c(new_n87_), .O(new_n93_));
  nor2   g46(.a(new_n93_), .b(new_n92_), .O(z11));
  nand3  g47(.a(x19), .b(x18), .c(x17), .O(new_n96_));
  nand2  g48(.a(new_n96_), .b(x20), .O(new_n97_));
  nand2  g49(.a(new_n54_), .b(new_n88_), .O(new_n98_));
  inv1   g50(.a(new_n98_), .O(new_n99_));
  nand3  g51(.a(new_n99_), .b(new_n97_), .c(new_n69_), .O(z13));
  inv1   g52(.a(new_n96_), .O(new_n101_));
  nor2   g53(.a(x21), .b(x20), .O(new_n102_));
  nand2  g54(.a(new_n102_), .b(new_n101_), .O(new_n103_));
  nand2  g55(.a(new_n69_), .b(x21), .O(new_n104_));
  nand3  g56(.a(new_n104_), .b(new_n103_), .c(new_n99_), .O(z14));
  nand2  g57(.a(new_n103_), .b(x22), .O(new_n106_));
  nand3  g58(.a(new_n101_), .b(new_n70_), .c(new_n68_), .O(new_n107_));
  nand3  g59(.a(new_n107_), .b(new_n106_), .c(new_n99_), .O(z15));
  nand2  g60(.a(new_n107_), .b(x23), .O(new_n109_));
  nor2   g61(.a(x23), .b(x22), .O(new_n110_));
  nand3  g62(.a(new_n110_), .b(new_n102_), .c(new_n101_), .O(new_n111_));
  nand3  g63(.a(new_n111_), .b(new_n109_), .c(new_n99_), .O(z16));
  inv1   g64(.a(new_n72_), .O(new_n113_));
  inv1   g65(.a(new_n93_), .O(new_n114_));
  nand2  g66(.a(new_n111_), .b(x24), .O(new_n115_));
  nand3  g67(.a(new_n115_), .b(new_n114_), .c(new_n113_), .O(z17));
  inv1   g68(.a(new_n69_), .O(new_n117_));
  nand4  g69(.a(new_n82_), .b(new_n70_), .c(new_n117_), .d(new_n48_), .O(new_n118_));
  nand2  g70(.a(new_n113_), .b(x25), .O(new_n119_));
  nand3  g71(.a(new_n119_), .b(new_n118_), .c(new_n99_), .O(z18));
  zero   g72(.O(z05));
  zero   g73(.O(z09));
  zero   g74(.O(z12));
  buf    g75(.a(x16), .O(z02));
