...
module FAU ( 
  ...
  nand3  g46(.a(new_n94_), .b(new_n93_), .c(new_n92_), .O(new_n95_));
  nor2   g47(.a(new_n95_), .b(new_n91_), .O(z11));
  oai21  g48(.a(new_n78_), .b(new_n76_), .c(x19), .O(new_n97_));
  nor2   g49(.a(new_n78_), .b(new_n76_), .O(new_n98_));
  nand2  g50(.a(new_n98_), .b(new_n79_), .O(new_n99_));
  aoi21  g51(.a(new_n99_), .b(new_n97_), .c(new_n95_), .O(z12));
  nand2  g52(.a(new_n98_), .b(x19), .O(new_n101_));
  nand2  g53(.a(new_n101_), .b(x20), .O(new_n102_));
  nand2  g54(.a(new_n56_), .b(new_n93_), .O(new_n103_));
  inv1   g55(.a(new_n103_), .O(new_n104_));
  nand3  g56(.a(new_n104_), .b(new_n102_), .c(new_n70_), .O(z13));
  nor2   g57(.a(x21), .b(x20), .O(new_n106_));
  inv1   g58(.a(new_n106_), .O(new_n107_));
  aoi21  g59(.a(new_n70_), .b(x21), .c(new_n103_), .O(new_n108_));
  ...
  nand3  g63(.a(new_n111_), .b(new_n71_), .c(new_n69_), .O(new_n112_));
  nand3  g64(.a(new_n112_), .b(new_n110_), .c(new_n104_), .O(z15));
  nand2  g65(.a(new_n71_), .b(new_n69_), .O(new_n114_));
  ...
  inv1   g71(.a(new_n73_), .O(new_n120_));
  inv1   g72(.a(new_n95_), .O(new_n121_));
  oai21  g73(.a(new_n116_), .b(new_n101_), .c(x24), .O(new_n122_));
  nand3  g74(.a(new_n122_), .b(new_n121_), .c(new_n120_), .O(z17));
  inv1   g75(.a(new_n70_), .O(new_n124_));
  nand4  g76(.a(new_n85_), .b(new_n71_), .c(new_n124_), .d(new_n48_), .O(new_n125_));
