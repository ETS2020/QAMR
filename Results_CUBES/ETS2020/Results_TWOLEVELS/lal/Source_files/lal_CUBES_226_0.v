// Benchmark "FAU" written by ABC on Wed Jul  8 19:33:27 2020
...
module FAU ( 
  ...
  inv1   g09(.a(x07), .O(new_n61_));
  inv1   g10(.a(x15), .O(new_n62_));
  and2   g11(.a(x05), .b(x04), .O(new_n63_));
  nand3  g12(.a(new_n63_), .b(new_n62_), .c(new_n61_), .O(new_n64_));
  inv1   g13(.a(new_n64_), .O(z09));
  nand2  g14(.a(new_n62_), .b(new_n61_), .O(new_n67_));
  xnor2a g15(.a(x18), .b(x17), .O(new_n68_));
  nor3   g16(.a(new_n68_), .b(new_n67_), .c(new_n63_), .O(z11));
  zero   g17(.O(z00));
  zero   g18(.O(z01));
  zero   g19(.O(z03));
  zero   g20(.O(z05));
