...
module FAU ( 
  ...
  nand2  g19(.a(x18), .b(x17), .O(new_n70_));
  nand2  g20(.a(new_n70_), .b(x19), .O(new_n71_));
  inv1   g21(.a(x19), .O(new_n72_));
  nand3  g22(.a(new_n72_), .b(x18), .c(x17), .O(new_n73_));
  nand2  g23(.a(new_n62_), .b(new_n66_), .O(new_n74_));
  aoi21  g24(.a(new_n73_), .b(new_n71_), .c(new_n74_), .O(z12));
  zero   g25(.O(z00));
  zero   g26(.O(z01));
  zero   g27(.O(z03));
  zero   g28(.O(z08));
