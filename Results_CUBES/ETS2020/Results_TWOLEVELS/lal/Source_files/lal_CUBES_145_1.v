...
module FAU ( 
  ...
  nand2  g50(.a(new_n67_), .b(new_n65_), .O(new_n101_));
  oai21  g51(.a(new_n101_), .b(new_n90_), .c(x23), .O(new_n102_));
  nor2   g52(.a(x23), .b(x22), .O(new_n103_));
  nand3  g53(.a(new_n103_), .b(new_n94_), .c(new_n93_), .O(new_n104_));
  nand3  g54(.a(new_n104_), .b(new_n102_), .c(new_n98_), .O(z16));
  inv1   g55(.a(new_n69_), .O(new_n106_));
  nand2  g56(.a(new_n104_), .b(x24), .O(new_n107_));
  nand3  g57(.a(new_n107_), .b(new_n98_), .c(new_n106_), .O(z17));
  ...
  nand3  g61(.a(new_n111_), .b(new_n110_), .c(new_n98_), .O(z18));
  zero   g62(.O(z02));
  zero   g63(.O(z04));
  zero   g64(.O(z11));
  zero   g65(.O(z12));
