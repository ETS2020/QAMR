// Benchmark "FAU" written by ABC on Wed Jul  8 19:28:20 2020
...
module FAU ( 
  ...
  inv1   g11(.a(x07), .O(new_n62_));
  inv1   g12(.a(x15), .O(new_n63_));
  nand4  g13(.a(new_n63_), .b(new_n62_), .c(x05), .d(x04), .O(new_n64_));
  inv1   g14(.a(new_n64_), .O(z09));
  xnor2a g15(.a(x18), .b(x17), .O(new_n67_));
  nand2  g16(.a(x05), .b(x04), .O(new_n68_));
  nand3  g17(.a(new_n68_), .b(new_n63_), .c(new_n62_), .O(new_n69_));
  nor2   g18(.a(new_n69_), .b(new_n67_), .O(z11));
  nand2  g19(.a(x18), .b(x17), .O(new_n71_));
  nand2  g20(.a(new_n71_), .b(x19), .O(new_n72_));
  inv1   g21(.a(x19), .O(new_n73_));
  nand3  g22(.a(new_n73_), .b(x18), .c(x17), .O(new_n74_));
  aoi21  g23(.a(new_n74_), .b(new_n72_), .c(new_n69_), .O(z12));
  zero   g24(.O(z00));
  zero   g25(.O(z01));
  zero   g26(.O(z03));
  zero   g27(.O(z05));
