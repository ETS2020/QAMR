// Benchmark "FAU" written by ABC on Wed Jul  8 19:29:37 2020
...
module FAU ( 
  ...
  nand2  g48(.a(new_n89_), .b(new_n54_), .O(new_n95_));
  nor2   g49(.a(new_n95_), .b(new_n94_), .O(z11));
  nand3  g50(.a(x19), .b(x18), .c(x17), .O(new_n98_));
  nand2  g51(.a(new_n98_), .b(x20), .O(new_n99_));
  nand4  g52(.a(new_n99_), .b(new_n89_), .c(new_n72_), .d(new_n54_), .O(z13));
  inv1   g53(.a(new_n98_), .O(new_n101_));
  nor2   g54(.a(x21), .b(x20), .O(new_n102_));
  nand2  g55(.a(new_n102_), .b(new_n101_), .O(new_n103_));
  nand2  g56(.a(new_n72_), .b(x21), .O(new_n104_));
  nand2  g57(.a(new_n89_), .b(new_n54_), .O(new_n105_));
  inv1   g58(.a(new_n105_), .O(new_n106_));
  nand3  g59(.a(new_n106_), .b(new_n104_), .c(new_n103_), .O(z14));
  nand2  g60(.a(new_n103_), .b(x22), .O(new_n108_));
  nand3  g61(.a(new_n101_), .b(new_n73_), .c(new_n71_), .O(new_n109_));
  nand3  g62(.a(new_n109_), .b(new_n108_), .c(new_n106_), .O(z15));
  nand2  g63(.a(new_n109_), .b(x23), .O(new_n111_));
  nor2   g64(.a(x23), .b(x22), .O(new_n112_));
  nand3  g65(.a(new_n112_), .b(new_n102_), .c(new_n101_), .O(new_n113_));
  nand3  g66(.a(new_n113_), .b(new_n111_), .c(new_n106_), .O(z16));
  inv1   g67(.a(new_n75_), .O(new_n115_));
  nand2  g68(.a(new_n113_), .b(x24), .O(new_n116_));
  nand3  g69(.a(new_n116_), .b(new_n106_), .c(new_n115_), .O(z17));
  inv1   g70(.a(new_n72_), .O(new_n118_));
  nand4  g71(.a(new_n85_), .b(new_n73_), .c(new_n118_), .d(new_n48_), .O(new_n119_));
  nand2  g72(.a(new_n115_), .b(x25), .O(new_n120_));
  nand3  g73(.a(new_n120_), .b(new_n119_), .c(new_n106_), .O(z18));
  zero   g74(.O(z02));
  zero   g75(.O(z12));
endmodule
