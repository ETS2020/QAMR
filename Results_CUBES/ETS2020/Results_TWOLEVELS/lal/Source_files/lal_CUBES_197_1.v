// Benchmark "FAU" written by ABC on Wed Jul  8 19:32:36 2020
...
module FAU ( 
  ...
  nand2  g54(.a(new_n87_), .b(new_n56_), .O(new_n103_));
  aoi21  g55(.a(new_n68_), .b(x21), .c(new_n103_), .O(new_n104_));
  oai21  g56(.a(new_n102_), .b(new_n98_), .c(new_n104_), .O(z14));
  inv1   g57(.a(new_n103_), .O(new_n106_));
  oai21  g58(.a(new_n102_), .b(new_n98_), .c(x22), .O(new_n107_));
  inv1   g59(.a(new_n98_), .O(new_n108_));
  nand3  g60(.a(new_n108_), .b(new_n69_), .c(new_n67_), .O(new_n109_));
  nand3  g61(.a(new_n109_), .b(new_n107_), .c(new_n106_), .O(z15));
  nand2  g62(.a(new_n69_), .b(new_n67_), .O(new_n111_));
  oai21  g63(.a(new_n111_), .b(new_n98_), .c(x23), .O(new_n112_));
  nand3  g64(.a(new_n101_), .b(new_n48_), .c(new_n52_), .O(new_n113_));
  inv1   g65(.a(new_n113_), .O(new_n114_));
  nand2  g66(.a(new_n114_), .b(new_n108_), .O(new_n115_));
  nand3  g67(.a(new_n115_), .b(new_n112_), .c(new_n106_), .O(z16));
  inv1   g68(.a(new_n71_), .O(new_n117_));
  oai21  g69(.a(new_n113_), .b(new_n98_), .c(x24), .O(new_n118_));
  nand3  g70(.a(new_n118_), .b(new_n106_), .c(new_n117_), .O(z17));
  inv1   g71(.a(new_n68_), .O(new_n120_));
  nand4  g72(.a(new_n83_), .b(new_n69_), .c(new_n120_), .d(new_n48_), .O(new_n121_));
  nand2  g73(.a(new_n117_), .b(x25), .O(new_n122_));
  nand3  g74(.a(new_n122_), .b(new_n121_), .c(new_n106_), .O(z18));
  zero   g75(.O(z02));
  zero   g76(.O(z04));
  zero   g77(.O(z11));
endmodule
