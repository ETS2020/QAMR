// Benchmark "FAU" written by ABC on Wed Jul  8 19:27:41 2020
...
module FAU ( 
  ...
  nand2  g42(.a(new_n86_), .b(new_n56_), .O(new_n91_));
  nor2   g43(.a(new_n91_), .b(new_n90_), .O(z11));
  oai21  g44(.a(new_n75_), .b(new_n73_), .c(x19), .O(new_n93_));
  nor2   g45(.a(new_n75_), .b(new_n73_), .O(new_n94_));
  nand2  g46(.a(new_n94_), .b(new_n76_), .O(new_n95_));
