...
module FAU ( 
  ...
  nand3  g24(.a(new_n71_), .b(new_n48_), .c(new_n47_), .O(new_n72_));
  nor2   g25(.a(new_n72_), .b(new_n70_), .O(new_n73_));
  nand4  g26(.a(new_n71_), .b(new_n48_), .c(x19), .d(x18), .O(new_n74_));
  ...
  nor2   g38(.a(new_n85_), .b(new_n47_), .O(new_n86_));
  ...
  nor2   g47(.a(new_n78_), .b(new_n76_), .O(new_n97_));
  nand2  g48(.a(new_n97_), .b(new_n79_), .O(new_n98_));
  nand3  g49(.a(new_n92_), .b(new_n91_), .c(new_n90_), .O(new_n99_));
  aoi21  g50(.a(new_n98_), .b(new_n96_), .c(new_n99_), .O(z12));
  nand2  g51(.a(new_n97_), .b(x19), .O(new_n101_));
  nand2  g52(.a(new_n101_), .b(x20), .O(new_n102_));
  nand2  g53(.a(new_n55_), .b(new_n91_), .O(new_n103_));
  ...
  nand3  g66(.a(new_n106_), .b(new_n47_), .c(new_n51_), .O(new_n116_));
  ...
  nand4  g75(.a(new_n85_), .b(new_n71_), .c(new_n124_), .d(new_n47_), .O(new_n125_));
