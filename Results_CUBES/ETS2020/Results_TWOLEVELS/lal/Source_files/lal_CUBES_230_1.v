// Benchmark "FAU" written by ABC on Wed Jul  8 19:33:34 2020
...
module FAU ( 
  ...
  nand3  g47(.a(x19), .b(x18), .c(x17), .O(new_n95_));
  nand2  g48(.a(new_n95_), .b(x20), .O(new_n96_));
  nand4  g49(.a(new_n96_), .b(new_n88_), .c(new_n71_), .d(new_n54_), .O(z13));
  inv1   g50(.a(new_n95_), .O(new_n98_));
  nor2   g51(.a(x21), .b(x20), .O(new_n99_));
  nand2  g52(.a(new_n99_), .b(new_n98_), .O(new_n100_));
  nand2  g53(.a(new_n71_), .b(x21), .O(new_n101_));
  nand2  g54(.a(new_n88_), .b(new_n54_), .O(new_n102_));
  inv1   g55(.a(new_n102_), .O(new_n103_));
  nand3  g56(.a(new_n103_), .b(new_n101_), .c(new_n100_), .O(z14));
  nand2  g57(.a(new_n100_), .b(x22), .O(new_n105_));
  nand3  g58(.a(new_n98_), .b(new_n72_), .c(new_n70_), .O(new_n106_));
  nand3  g59(.a(new_n106_), .b(new_n105_), .c(new_n103_), .O(z15));
  nand2  g60(.a(new_n106_), .b(x23), .O(new_n108_));
  nor2   g61(.a(x23), .b(x22), .O(new_n109_));
  nand3  g62(.a(new_n109_), .b(new_n99_), .c(new_n98_), .O(new_n110_));
  nand3  g63(.a(new_n110_), .b(new_n108_), .c(new_n103_), .O(z16));
  inv1   g64(.a(new_n74_), .O(new_n112_));
  nand2  g65(.a(new_n110_), .b(x24), .O(new_n113_));
  nand3  g66(.a(new_n113_), .b(new_n103_), .c(new_n112_), .O(z17));
  inv1   g67(.a(new_n71_), .O(new_n115_));
  nand4  g68(.a(new_n84_), .b(new_n72_), .c(new_n115_), .d(new_n48_), .O(new_n116_));
  nand2  g69(.a(new_n112_), .b(x25), .O(new_n117_));
  nand3  g70(.a(new_n117_), .b(new_n116_), .c(new_n103_), .O(z18));
  zero   g71(.O(z11));
  zero   g72(.O(z12));
  buf    g73(.a(x16), .O(z02));
endmodule
