// Benchmark "FAU" written by ABC on Wed Jul  8 19:28:12 2020
...
module FAU ( 
  ...
  wire new_n49_, new_n50_, new_n51_, new_n52_, new_n53_, new_n54_, new_n57_,
    new_n59_, new_n62_, new_n63_, new_n64_, new_n65_, new_n68_, new_n69_;
  ...
  and2   g14(.a(x05), .b(x04), .O(new_n64_));
  nand3  g15(.a(new_n64_), .b(new_n63_), .c(new_n62_), .O(new_n65_));
  inv1   g16(.a(new_n65_), .O(z09));
  nand2  g17(.a(new_n63_), .b(new_n62_), .O(new_n68_));
  xnor2a g18(.a(x18), .b(x17), .O(new_n69_));
  nor3   g19(.a(new_n69_), .b(new_n68_), .c(new_n64_), .O(z11));
  zero   g20(.O(z00));
  zero   g21(.O(z01));
  zero   g22(.O(z03));
  zero   g23(.O(z08));
