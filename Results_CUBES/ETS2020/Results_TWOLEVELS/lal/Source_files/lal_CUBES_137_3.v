...
module FAU ( 
  ...
  inv1   g20(.a(x14), .O(new_n67_));
  nor2   g21(.a(new_n67_), .b(x08), .O(z06));
  ...
  xnor2a g46(.a(x18), .b(x17), .O(new_n93_));
  nand2  g47(.a(new_n88_), .b(new_n54_), .O(new_n94_));
  nor2   g48(.a(new_n94_), .b(new_n93_), .O(z11));
  nand3  g49(.a(x19), .b(x18), .c(x17), .O(new_n97_));
  nand2  g50(.a(new_n97_), .b(x20), .O(new_n98_));
  nand4  g51(.a(new_n98_), .b(new_n88_), .c(new_n71_), .d(new_n54_), .O(z13));
  inv1   g52(.a(new_n97_), .O(new_n100_));
  nor2   g53(.a(x21), .b(x20), .O(new_n101_));
  nand2  g54(.a(new_n101_), .b(new_n100_), .O(new_n102_));
  nand2  g55(.a(new_n71_), .b(x21), .O(new_n103_));
  nand2  g56(.a(new_n88_), .b(new_n54_), .O(new_n104_));
  inv1   g57(.a(new_n104_), .O(new_n105_));
  nand3  g58(.a(new_n105_), .b(new_n103_), .c(new_n102_), .O(z14));
  nand2  g59(.a(new_n102_), .b(x22), .O(new_n107_));
  nand3  g60(.a(new_n100_), .b(new_n72_), .c(new_n70_), .O(new_n108_));
  nand3  g61(.a(new_n108_), .b(new_n107_), .c(new_n105_), .O(z15));
  nand2  g62(.a(new_n108_), .b(x23), .O(new_n110_));
  nor2   g63(.a(x23), .b(x22), .O(new_n111_));
  nand3  g64(.a(new_n111_), .b(new_n101_), .c(new_n100_), .O(new_n112_));
  nand3  g65(.a(new_n112_), .b(new_n110_), .c(new_n105_), .O(z16));
  inv1   g66(.a(new_n74_), .O(new_n114_));
  nand2  g67(.a(new_n112_), .b(x24), .O(new_n115_));
  nand3  g68(.a(new_n115_), .b(new_n105_), .c(new_n114_), .O(z17));
  inv1   g69(.a(new_n71_), .O(new_n117_));
  nand4  g70(.a(new_n84_), .b(new_n72_), .c(new_n117_), .d(new_n48_), .O(new_n118_));
  nand2  g71(.a(new_n114_), .b(x25), .O(new_n119_));
  nand3  g72(.a(new_n119_), .b(new_n118_), .c(new_n105_), .O(z18));
  zero   g73(.O(z05));
  zero   g74(.O(z12));
  buf    g75(.a(x16), .O(z02));
endmodule
