...
module FAU ( 
  ...
  nand3  g58(.a(new_n100_), .b(new_n72_), .c(new_n70_), .O(new_n108_));
  ...
  inv1   g64(.a(new_n74_), .O(new_n114_));
  ...
  nand4  g68(.a(new_n84_), .b(new_n72_), .c(new_n117_), .d(new_n48_), .O(new_n118_));
