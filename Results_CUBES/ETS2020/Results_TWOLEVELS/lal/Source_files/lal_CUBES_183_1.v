...
module FAU ( 
  ...
  nand4  g58(.a(new_n104_), .b(new_n91_), .c(new_n72_), .d(new_n54_), .O(z13));
  inv1   g59(.a(new_n103_), .O(new_n106_));
  nor2   g60(.a(x21), .b(x20), .O(new_n107_));
  nand2  g61(.a(new_n107_), .b(new_n106_), .O(new_n108_));
  nand2  g62(.a(new_n91_), .b(new_n54_), .O(new_n109_));
  aoi21  g63(.a(new_n72_), .b(x21), .c(new_n109_), .O(new_n110_));
  nand2  g64(.a(new_n110_), .b(new_n108_), .O(z14));
  inv1   g65(.a(new_n109_), .O(new_n113_));
  nand2  g66(.a(new_n73_), .b(new_n71_), .O(new_n114_));
  oai21  g67(.a(new_n114_), .b(new_n103_), .c(x23), .O(new_n115_));
  inv1   g68(.a(x22), .O(new_n116_));
  nand3  g69(.a(new_n107_), .b(new_n48_), .c(new_n116_), .O(new_n117_));
  inv1   g70(.a(new_n117_), .O(new_n118_));
  nand2  g71(.a(new_n118_), .b(new_n106_), .O(new_n119_));
  nand3  g72(.a(new_n119_), .b(new_n115_), .c(new_n113_), .O(z16));
  inv1   g73(.a(new_n75_), .O(new_n121_));
  oai21  g74(.a(new_n117_), .b(new_n103_), .c(x24), .O(new_n122_));
  nand3  g75(.a(new_n122_), .b(new_n113_), .c(new_n121_), .O(z17));
  ...
  nand3  g79(.a(new_n126_), .b(new_n125_), .c(new_n113_), .O(z18));
  zero   g80(.O(z02));
  zero   g81(.O(z15));
endmodule
