// Benchmark "FAU" written by ABC on Wed Jul  8 19:31:30 2020
...
module FAU ( 
  ...
  nand3  g50(.a(new_n94_), .b(new_n93_), .c(new_n92_), .O(new_n98_));
  nor2   g51(.a(new_n98_), .b(new_n97_), .O(z11));
  oai21  g52(.a(new_n80_), .b(new_n78_), .c(x19), .O(new_n100_));
  nor2   g53(.a(new_n80_), .b(new_n78_), .O(new_n101_));
  ...
  nand2  g58(.a(new_n56_), .b(new_n93_), .O(new_n106_));
  inv1   g59(.a(new_n106_), .O(new_n107_));
  nand3  g60(.a(new_n107_), .b(new_n105_), .c(new_n72_), .O(z13));
  nor2   g61(.a(x21), .b(x20), .O(new_n109_));
  inv1   g62(.a(new_n109_), .O(new_n110_));
  aoi21  g63(.a(new_n72_), .b(x21), .c(new_n106_), .O(new_n111_));
  oai21  g64(.a(new_n110_), .b(new_n104_), .c(new_n111_), .O(z14));
  oai21  g65(.a(new_n110_), .b(new_n104_), .c(x22), .O(new_n113_));
  inv1   g66(.a(new_n104_), .O(new_n114_));
  nand3  g67(.a(new_n114_), .b(new_n73_), .c(new_n71_), .O(new_n115_));
  nand3  g68(.a(new_n115_), .b(new_n113_), .c(new_n107_), .O(z15));
  nand2  g69(.a(new_n73_), .b(new_n71_), .O(new_n117_));
  oai21  g70(.a(new_n117_), .b(new_n104_), .c(x23), .O(new_n118_));
  nand3  g71(.a(new_n109_), .b(new_n48_), .c(new_n52_), .O(new_n119_));
  inv1   g72(.a(new_n119_), .O(new_n120_));
  nand2  g73(.a(new_n120_), .b(new_n114_), .O(new_n121_));
  nand3  g74(.a(new_n121_), .b(new_n118_), .c(new_n107_), .O(z16));
  inv1   g75(.a(new_n75_), .O(new_n123_));
  inv1   g76(.a(new_n98_), .O(new_n124_));
  oai21  g77(.a(new_n119_), .b(new_n104_), .c(x24), .O(new_n125_));
  nand3  g78(.a(new_n125_), .b(new_n124_), .c(new_n123_), .O(z17));
  inv1   g79(.a(new_n72_), .O(new_n127_));
  nand4  g80(.a(new_n87_), .b(new_n73_), .c(new_n127_), .d(new_n48_), .O(new_n128_));
  nand2  g81(.a(new_n123_), .b(x25), .O(new_n129_));
  nand3  g82(.a(new_n129_), .b(new_n128_), .c(new_n107_), .O(z18));
  zero   g83(.O(z02));
  zero   g84(.O(z09));
endmodule
