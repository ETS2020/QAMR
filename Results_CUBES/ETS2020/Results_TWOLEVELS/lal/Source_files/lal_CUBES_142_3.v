// Benchmark "FAU" written by ABC on Wed Jul  8 19:30:50 2020
...
module FAU ( 
  ...
  nand3  g58(.a(new_n99_), .b(new_n71_), .c(new_n69_), .O(new_n107_));
  ...
  inv1   g64(.a(new_n73_), .O(new_n113_));
  ...
  nand4  g68(.a(new_n83_), .b(new_n71_), .c(new_n116_), .d(new_n48_), .O(new_n117_));
