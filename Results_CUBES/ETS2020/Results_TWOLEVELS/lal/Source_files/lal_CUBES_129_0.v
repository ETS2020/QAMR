...
module FAU ( 
  ...
  nand4  g10(.a(new_n61_), .b(new_n60_), .c(x05), .d(x04), .O(new_n62_));
  inv1   g11(.a(new_n62_), .O(z09));
  xnor2a g12(.a(x18), .b(x17), .O(new_n65_));
  nand2  g13(.a(x05), .b(x04), .O(new_n66_));
  nand3  g14(.a(new_n66_), .b(new_n61_), .c(new_n60_), .O(new_n67_));
  nor2   g15(.a(new_n67_), .b(new_n65_), .O(z11));
  ...
  aoi21  g20(.a(new_n72_), .b(new_n70_), .c(new_n67_), .O(z12));
  zero   g21(.O(z00));
  zero   g22(.O(z01));
  zero   g23(.O(z03));
  zero   g24(.O(z06));
