// Benchmark "FAU" written by ABC on Wed Jul  8 19:33:43 2020
...
module FAU ( 
  ...
  inv1   g44(.a(x07), .O(new_n92_));
  inv1   g45(.a(x15), .O(new_n93_));
  nand2  g46(.a(x05), .b(x04), .O(new_n94_));
  nand4  g47(.a(new_n94_), .b(new_n78_), .c(new_n93_), .d(new_n92_), .O(new_n95_));
  ...
  nand3  g52(.a(new_n94_), .b(new_n93_), .c(new_n92_), .O(new_n101_));
  aoi21  g53(.a(new_n100_), .b(new_n98_), .c(new_n101_), .O(z12));
  nand2  g54(.a(new_n99_), .b(x19), .O(new_n103_));
  nand2  g55(.a(new_n103_), .b(x20), .O(new_n104_));
  nand2  g56(.a(new_n56_), .b(new_n93_), .O(new_n105_));
  inv1   g57(.a(new_n105_), .O(new_n106_));
  nand3  g58(.a(new_n106_), .b(new_n104_), .c(new_n72_), .O(z13));
  nor2   g59(.a(x21), .b(x20), .O(new_n108_));
  inv1   g60(.a(new_n108_), .O(new_n109_));
  aoi21  g61(.a(new_n72_), .b(x21), .c(new_n105_), .O(new_n110_));
  oai21  g62(.a(new_n109_), .b(new_n103_), .c(new_n110_), .O(z14));
  oai21  g63(.a(new_n109_), .b(new_n103_), .c(x22), .O(new_n112_));
  inv1   g64(.a(new_n103_), .O(new_n113_));
  nand3  g65(.a(new_n113_), .b(new_n73_), .c(new_n71_), .O(new_n114_));
  nand3  g66(.a(new_n114_), .b(new_n112_), .c(new_n106_), .O(z15));
  nand2  g67(.a(new_n73_), .b(new_n71_), .O(new_n116_));
  oai21  g68(.a(new_n116_), .b(new_n103_), .c(x23), .O(new_n117_));
  nand3  g69(.a(new_n108_), .b(new_n48_), .c(new_n52_), .O(new_n118_));
  inv1   g70(.a(new_n118_), .O(new_n119_));
  nand2  g71(.a(new_n119_), .b(new_n113_), .O(new_n120_));
  nand3  g72(.a(new_n120_), .b(new_n117_), .c(new_n106_), .O(z16));
  inv1   g73(.a(new_n75_), .O(new_n122_));
  inv1   g74(.a(new_n101_), .O(new_n123_));
  oai21  g75(.a(new_n118_), .b(new_n103_), .c(x24), .O(new_n124_));
  nand3  g76(.a(new_n124_), .b(new_n123_), .c(new_n122_), .O(z17));
  inv1   g77(.a(new_n72_), .O(new_n126_));
  nand4  g78(.a(new_n87_), .b(new_n73_), .c(new_n126_), .d(new_n48_), .O(new_n127_));
  nand2  g79(.a(new_n122_), .b(x25), .O(new_n128_));
  nand3  g80(.a(new_n128_), .b(new_n127_), .c(new_n106_), .O(z18));
  zero   g81(.O(z02));
  zero   g82(.O(z09));
  zero   g83(.O(z11));
endmodule
