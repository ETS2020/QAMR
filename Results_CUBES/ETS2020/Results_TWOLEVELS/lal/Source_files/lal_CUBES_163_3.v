...
module FAU ( 
  ...
  nand3  g57(.a(new_n98_), .b(new_n71_), .c(new_n69_), .O(new_n106_));
  ...
  inv1   g63(.a(new_n73_), .O(new_n112_));
  nand2  g64(.a(new_n110_), .b(x24), .O(new_n113_));
  nand3  g65(.a(new_n113_), .b(new_n103_), .c(new_n112_), .O(z17));
  inv1   g66(.a(new_n70_), .O(new_n115_));
  nand4  g67(.a(new_n83_), .b(new_n71_), .c(new_n115_), .d(new_n48_), .O(new_n116_));
