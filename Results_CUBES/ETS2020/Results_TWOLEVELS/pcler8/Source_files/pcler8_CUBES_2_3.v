// Benchmark "FAU" written by ABC on Tue Jul  7 12:12:16 2020
...
module FAU ( 
  ...
  nand2  g54(.a(x08), .b(x03), .O(new_n100_));
  oai21  g55(.a(new_n99_), .b(new_n77_), .c(new_n100_), .O(z12));
  nand4  g56(.a(x26), .b(x25), .c(x24), .d(x15), .O(new_n102_));
  nand4  g57(.a(x22), .b(x21), .c(x20), .d(x19), .O(new_n103_));
  inv1   g58(.a(new_n103_), .O(new_n104_));
  nand2  g59(.a(new_n104_), .b(new_n102_), .O(new_n105_));
  nand2  g60(.a(x22), .b(x21), .O(new_n106_));
  nor2   g61(.a(new_n106_), .b(x23), .O(new_n107_));
  aoi22  g62(.a(new_n107_), .b(new_n87_), .c(new_n105_), .d(x23), .O(new_n108_));
  oai21  g63(.a(new_n108_), .b(new_n77_), .c(new_n64_), .O(z13));
  nand3  g64(.a(x26), .b(x25), .c(x16), .O(new_n110_));
  nand3  g65(.a(x21), .b(x20), .c(x19), .O(new_n111_));
  inv1   g66(.a(new_n111_), .O(new_n112_));
  nand4  g67(.a(new_n112_), .b(new_n110_), .c(x23), .d(x22), .O(new_n113_));
  nand2  g68(.a(x23), .b(x22), .O(new_n114_));
  nor3   g69(.a(new_n111_), .b(new_n114_), .c(x24), .O(new_n115_));
  aoi21  g70(.a(new_n113_), .b(x24), .c(new_n115_), .O(new_n116_));
  oai21  g71(.a(new_n116_), .b(new_n77_), .c(new_n66_), .O(z14));
  nand2  g72(.a(x26), .b(x17), .O(new_n118_));
  nand3  g73(.a(x24), .b(x23), .c(x22), .O(new_n119_));
  inv1   g74(.a(new_n119_), .O(new_n120_));
  nand3  g75(.a(new_n120_), .b(new_n118_), .c(new_n112_), .O(new_n121_));
  inv1   g76(.a(x25), .O(new_n122_));
  nand4  g77(.a(new_n122_), .b(x24), .c(x23), .d(x22), .O(new_n123_));
  inv1   g78(.a(new_n123_), .O(new_n124_));
  aoi22  g79(.a(new_n124_), .b(new_n112_), .c(new_n121_), .d(x25), .O(new_n125_));
  oai21  g80(.a(new_n125_), .b(new_n77_), .c(new_n68_), .O(z15));
  nor2   g81(.a(new_n52_), .b(x18), .O(new_n127_));
  nand3  g82(.a(new_n127_), .b(new_n49_), .c(new_n45_), .O(new_n128_));
  inv1   g83(.a(x26), .O(new_n129_));
  nand4  g84(.a(new_n129_), .b(x25), .c(x22), .d(x21), .O(new_n130_));
  nand4  g85(.a(x24), .b(x23), .c(x20), .d(x19), .O(new_n131_));
  nor2   g86(.a(new_n131_), .b(new_n130_), .O(new_n132_));
  aoi21  g87(.a(new_n128_), .b(x26), .c(new_n132_), .O(new_n133_));
  oai21  g88(.a(new_n133_), .b(new_n77_), .c(new_n70_), .O(z16));
  zero   g89(.O(z04));
endmodule
