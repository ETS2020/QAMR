...
module FAU ( 
  ...
  oai21  g43(.a(new_n91_), .b(new_n75_), .c(new_n62_), .O(z12));
  ...
  nand2  g48(.a(x20), .b(x19), .O(new_n97_));
  inv1   g49(.a(x23), .O(new_n98_));
  nand3  g50(.a(new_n98_), .b(x22), .c(x21), .O(new_n99_));
  nor2   g51(.a(new_n99_), .b(new_n97_), .O(new_n100_));
  aoi21  g52(.a(new_n96_), .b(x23), .c(new_n100_), .O(new_n101_));
  nand2  g53(.a(x08), .b(x04), .O(new_n102_));
  oai21  g54(.a(new_n101_), .b(new_n75_), .c(new_n102_), .O(z13));
  nand3  g55(.a(x21), .b(x20), .c(x19), .O(new_n105_));
  inv1   g56(.a(new_n105_), .O(new_n106_));
  nand2  g57(.a(x26), .b(x17), .O(new_n107_));
  nand3  g58(.a(x24), .b(x23), .c(x22), .O(new_n108_));
  inv1   g59(.a(new_n108_), .O(new_n109_));
  nand3  g60(.a(new_n109_), .b(new_n107_), .c(new_n106_), .O(new_n110_));
  inv1   g61(.a(x25), .O(new_n111_));
  nand4  g62(.a(new_n111_), .b(x24), .c(x23), .d(x22), .O(new_n112_));
  inv1   g63(.a(new_n112_), .O(new_n113_));
  aoi22  g64(.a(new_n113_), .b(new_n106_), .c(new_n110_), .d(x25), .O(new_n114_));
  oai21  g65(.a(new_n114_), .b(new_n75_), .c(new_n66_), .O(z15));
  nor2   g66(.a(new_n52_), .b(x18), .O(new_n116_));
  nand3  g67(.a(new_n116_), .b(new_n49_), .c(new_n45_), .O(new_n117_));
  inv1   g68(.a(x26), .O(new_n118_));
  nand4  g69(.a(new_n118_), .b(x25), .c(x22), .d(x21), .O(new_n119_));
  nand4  g70(.a(x24), .b(x23), .c(x20), .d(x19), .O(new_n120_));
  nor2   g71(.a(new_n120_), .b(new_n119_), .O(new_n121_));
  aoi21  g72(.a(new_n117_), .b(x26), .c(new_n121_), .O(new_n122_));
  oai21  g73(.a(new_n122_), .b(new_n75_), .c(new_n68_), .O(z16));
  zero   g74(.O(z03));
  zero   g75(.O(z05));
  zero   g76(.O(z06));
  zero   g77(.O(z11));
