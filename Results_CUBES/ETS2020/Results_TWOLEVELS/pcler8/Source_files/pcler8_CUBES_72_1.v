...
module FAU ( 
  ...
  nand2  g29(.a(x08), .b(x00), .O(new_n76_));
  oai21  g30(.a(new_n75_), .b(new_n73_), .c(new_n76_), .O(z09));
  nand3  g31(.a(x22), .b(x21), .c(x12), .O(new_n78_));
  oai21  g32(.a(new_n78_), .b(new_n70_), .c(x19), .O(new_n79_));
  nor2   g33(.a(x20), .b(new_n52_), .O(new_n80_));
  aoi21  g34(.a(new_n79_), .b(x20), .c(new_n80_), .O(new_n81_));
  oai22  g35(.a(new_n81_), .b(new_n75_), .c(new_n58_), .d(new_n57_), .O(z10));
  ...
  oai21  g45(.a(new_n92_), .b(new_n75_), .c(new_n61_), .O(z12));
