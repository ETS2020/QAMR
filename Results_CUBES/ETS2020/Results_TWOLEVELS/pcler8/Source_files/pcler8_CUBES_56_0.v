...
module FAU ( 
  ...
  and2   g43(.a(x22), .b(x21), .O(new_n93_));
  nand2  g44(.a(new_n93_), .b(new_n88_), .O(new_n94_));
  nor2   g45(.a(new_n94_), .b(new_n72_), .O(new_n95_));
  oai21  g46(.a(new_n95_), .b(new_n92_), .c(new_n87_), .O(new_n96_));
  nand2  g47(.a(new_n96_), .b(new_n54_), .O(z13));
  nand3  g48(.a(x26), .b(x25), .c(x16), .O(new_n98_));
  nand2  g49(.a(x23), .b(x22), .O(new_n99_));
  nand3  g50(.a(x21), .b(x20), .c(x19), .O(new_n100_));
  nor2   g51(.a(new_n100_), .b(new_n99_), .O(new_n101_));
  nand2  g52(.a(new_n101_), .b(new_n98_), .O(new_n102_));
  nor3   g53(.a(new_n100_), .b(new_n99_), .c(x24), .O(new_n103_));
  aoi21  g54(.a(new_n102_), .b(x24), .c(new_n103_), .O(new_n104_));
  oai21  g55(.a(new_n104_), .b(new_n68_), .c(new_n56_), .O(z14));
  inv1   g56(.a(x18), .O(new_n107_));
  nand4  g57(.a(x25), .b(x24), .c(x19), .d(new_n107_), .O(new_n108_));
  nand4  g58(.a(x23), .b(x22), .c(x21), .d(x20), .O(new_n109_));
  oai21  g59(.a(new_n109_), .b(new_n108_), .c(x26), .O(new_n110_));
  and2   g60(.a(x24), .b(x23), .O(new_n111_));
  inv1   g61(.a(x25), .O(new_n112_));
  nor2   g62(.a(x26), .b(new_n112_), .O(new_n113_));
  nand4  g63(.a(new_n113_), .b(new_n73_), .c(new_n111_), .d(new_n93_), .O(new_n114_));
  nand2  g64(.a(new_n114_), .b(new_n110_), .O(new_n115_));
  nand2  g65(.a(new_n115_), .b(new_n87_), .O(new_n116_));
  nand2  g66(.a(x08), .b(x07), .O(new_n117_));
  nand2  g67(.a(new_n117_), .b(new_n116_), .O(z16));
  zero   g68(.O(z00));
  zero   g69(.O(z01));
  zero   g70(.O(z07));
  zero   g71(.O(z08));
