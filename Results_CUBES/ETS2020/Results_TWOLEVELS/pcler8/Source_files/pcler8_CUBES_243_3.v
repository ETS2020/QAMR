...
module FAU ( 
  ...
  nand2  g19(.a(x08), .b(x05), .O(new_n65_));
  inv1   g20(.a(new_n65_), .O(z06));
  ...
  nand2  g56(.a(x08), .b(x04), .O(new_n103_));
  oai21  g57(.a(new_n102_), .b(new_n76_), .c(new_n103_), .O(z13));
  nand3  g58(.a(x26), .b(x25), .c(x16), .O(new_n105_));
  nand3  g59(.a(x21), .b(x20), .c(x19), .O(new_n106_));
  inv1   g60(.a(new_n106_), .O(new_n107_));
  nand4  g61(.a(new_n107_), .b(new_n105_), .c(x23), .d(x22), .O(new_n108_));
  nand2  g62(.a(x23), .b(x22), .O(new_n109_));
  nor3   g63(.a(new_n106_), .b(new_n109_), .c(x24), .O(new_n110_));
  aoi21  g64(.a(new_n108_), .b(x24), .c(new_n110_), .O(new_n111_));
  oai21  g65(.a(new_n111_), .b(new_n76_), .c(new_n65_), .O(z14));
  nand2  g66(.a(x26), .b(x17), .O(new_n113_));
  nand3  g67(.a(x24), .b(x23), .c(x22), .O(new_n114_));
  inv1   g68(.a(new_n114_), .O(new_n115_));
  nand3  g69(.a(new_n115_), .b(new_n113_), .c(new_n107_), .O(new_n116_));
  inv1   g70(.a(x25), .O(new_n117_));
  nand4  g71(.a(new_n117_), .b(x24), .c(x23), .d(x22), .O(new_n118_));
  inv1   g72(.a(new_n118_), .O(new_n119_));
  aoi22  g73(.a(new_n119_), .b(new_n107_), .c(new_n116_), .d(x25), .O(new_n120_));
  oai21  g74(.a(new_n120_), .b(new_n76_), .c(new_n67_), .O(z15));
  nor2   g75(.a(new_n52_), .b(x18), .O(new_n122_));
  nand3  g76(.a(new_n122_), .b(new_n49_), .c(new_n45_), .O(new_n123_));
  inv1   g77(.a(x26), .O(new_n124_));
  nand4  g78(.a(new_n124_), .b(x25), .c(x22), .d(x21), .O(new_n125_));
  nand4  g79(.a(x24), .b(x23), .c(x20), .d(x19), .O(new_n126_));
  nor2   g80(.a(new_n126_), .b(new_n125_), .O(new_n127_));
  aoi21  g81(.a(new_n123_), .b(x26), .c(new_n127_), .O(new_n128_));
  oai21  g82(.a(new_n128_), .b(new_n76_), .c(new_n69_), .O(z16));
  zero   g83(.O(z05));
  zero   g84(.O(z10));
endmodule
