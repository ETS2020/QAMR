...
module FAU ( 
  ...
  nand2  g43(.a(x08), .b(x02), .O(new_n90_));
  oai21  g44(.a(new_n89_), .b(new_n76_), .c(new_n90_), .O(z11));
  nand2  g45(.a(x23), .b(x14), .O(new_n92_));
  nand3  g46(.a(x21), .b(x20), .c(x19), .O(new_n93_));
  inv1   g47(.a(new_n93_), .O(new_n94_));
  oai21  g48(.a(new_n92_), .b(new_n83_), .c(new_n94_), .O(new_n95_));
  ...
  aoi22  g60(.a(new_n106_), .b(new_n86_), .c(new_n104_), .d(x23), .O(new_n107_));
