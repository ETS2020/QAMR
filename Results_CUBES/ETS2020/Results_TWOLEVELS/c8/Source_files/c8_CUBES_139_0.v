...
module FAU ( 
  ...
  inv1   g21(.a(x21), .O(new_n75_));
  nand4  g22(.a(new_n75_), .b(new_n51_), .c(new_n48_), .d(new_n74_), .O(new_n76_));
  inv1   g23(.a(new_n76_), .O(new_n77_));
  aoi21  g24(.a(new_n73_), .b(x21), .c(new_n77_), .O(new_n78_));
  oai21  g25(.a(new_n78_), .b(new_n67_), .c(new_n71_), .O(z11));
  inv1   g26(.a(x11), .O(new_n80_));
  nand2  g27(.a(x18), .b(x03), .O(new_n81_));
  oai21  g28(.a(x18), .b(new_n80_), .c(new_n81_), .O(new_n82_));
  nand2  g29(.a(new_n82_), .b(new_n67_), .O(new_n83_));
  nor3   g30(.a(x20), .b(x19), .c(x17), .O(new_n84_));
  nor2   g31(.a(x22), .b(x21), .O(new_n85_));
  aoi22  g32(.a(new_n85_), .b(new_n84_), .c(new_n76_), .d(x22), .O(new_n86_));
  oai21  g33(.a(new_n86_), .b(new_n67_), .c(new_n83_), .O(z12));
  inv1   g34(.a(x12), .O(new_n88_));
  nand2  g35(.a(x18), .b(x04), .O(new_n89_));
  oai21  g36(.a(x18), .b(new_n88_), .c(new_n89_), .O(new_n90_));
  nand2  g37(.a(new_n90_), .b(new_n67_), .O(new_n91_));
  nand3  g38(.a(new_n85_), .b(new_n72_), .c(new_n51_), .O(new_n92_));
  nor3   g39(.a(x23), .b(x22), .c(x21), .O(new_n93_));
  aoi22  g40(.a(new_n93_), .b(new_n84_), .c(new_n92_), .d(x23), .O(new_n94_));
  oai21  g41(.a(new_n94_), .b(new_n67_), .c(new_n91_), .O(z13));
  inv1   g42(.a(x13), .O(new_n96_));
  nand2  g43(.a(x18), .b(x05), .O(new_n97_));
  oai21  g44(.a(x18), .b(new_n96_), .c(new_n97_), .O(new_n98_));
  nand2  g45(.a(new_n98_), .b(new_n67_), .O(new_n99_));
  inv1   g46(.a(x24), .O(new_n100_));
  aoi21  g47(.a(new_n93_), .b(new_n84_), .c(new_n100_), .O(new_n101_));
  nor2   g48(.a(x24), .b(x23), .O(new_n102_));
  nand4  g49(.a(new_n102_), .b(new_n85_), .c(new_n72_), .d(new_n51_), .O(new_n103_));
  ...
  inv1   g57(.a(x22), .O(new_n111_));
  inv1   g58(.a(x23), .O(new_n112_));
  nand4  g59(.a(new_n58_), .b(new_n100_), .c(new_n112_), .d(new_n111_), .O(new_n113_));
  inv1   g60(.a(new_n113_), .O(new_n114_));
  aoi22  g61(.a(new_n114_), .b(new_n77_), .c(new_n103_), .d(x25), .O(new_n115_));
