...
module FAU ( 
  ...
  nand2  g37(.a(new_n70_), .b(new_n49_), .O(new_n88_));
  nand4  g38(.a(new_n52_), .b(new_n49_), .c(new_n68_), .d(new_n67_), .O(new_n89_));
  ...
  nand3  g53(.a(new_n97_), .b(new_n70_), .c(new_n49_), .O(new_n104_));
  ...
  nand4  g63(.a(new_n113_), .b(new_n97_), .c(new_n70_), .d(new_n49_), .O(new_n114_));
  ...
  inv1   g71(.a(x22), .O(new_n122_));
  nand4  g72(.a(new_n62_), .b(new_n59_), .c(new_n56_), .d(new_n122_), .O(new_n123_));
  ...
  nor2   g79(.a(new_n68_), .b(x17), .O(new_n131_));
