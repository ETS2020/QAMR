...
module FAU ( 
  ...
  nor2   g20(.a(new_n71_), .b(new_n49_), .O(new_n72_));
  ...
  oai21  g26(.a(x18), .b(new_n53_), .c(new_n78_), .O(new_n79_));
  ...
  nand3  g37(.a(new_n83_), .b(new_n71_), .c(new_n49_), .O(new_n90_));
  ...
  nand2  g47(.a(new_n71_), .b(new_n49_), .O(new_n100_));
  nand3  g48(.a(new_n83_), .b(new_n98_), .c(new_n56_), .O(new_n101_));
  nor2   g49(.a(new_n101_), .b(new_n100_), .O(new_n102_));
  ...
  oai21  g53(.a(x18), .b(new_n63_), .c(new_n106_), .O(new_n107_));
  nand2  g54(.a(new_n107_), .b(new_n77_), .O(new_n108_));
  nor2   g55(.a(x23), .b(x22), .O(new_n109_));
  nor2   g56(.a(x25), .b(x24), .O(new_n110_));
  nand4  g57(.a(new_n110_), .b(new_n109_), .c(new_n81_), .d(new_n71_), .O(new_n111_));
  nand2  g58(.a(new_n111_), .b(x26), .O(new_n112_));
  nor3   g59(.a(x26), .b(x25), .c(x24), .O(new_n113_));
  nand4  g60(.a(new_n113_), .b(new_n109_), .c(new_n81_), .d(new_n71_), .O(new_n114_));
  nand2  g61(.a(new_n114_), .b(new_n112_), .O(new_n115_));
  nand2  g62(.a(new_n115_), .b(x16), .O(new_n116_));
  nand2  g63(.a(new_n116_), .b(new_n108_), .O(z16));
  zero   g64(.O(z00));
  zero   g65(.O(z02));
  zero   g66(.O(z05));
  zero   g67(.O(z08));
