...
module FAU ( 
  ...
  nand2  g70(.a(new_n118_), .b(new_n84_), .O(new_n119_));
  nor2   g71(.a(x23), .b(x22), .O(new_n120_));
  nor2   g72(.a(x25), .b(x24), .O(new_n121_));
  nand4  g73(.a(new_n121_), .b(new_n120_), .c(new_n89_), .d(new_n71_), .O(new_n122_));
  nand2  g74(.a(new_n122_), .b(x26), .O(new_n123_));
  nor3   g75(.a(x26), .b(x25), .c(x24), .O(new_n124_));
  nand4  g76(.a(new_n124_), .b(new_n120_), .c(new_n89_), .d(new_n71_), .O(new_n125_));
  ...
  nand4  g81(.a(new_n129_), .b(new_n124_), .c(new_n120_), .d(new_n89_), .O(new_n130_));
