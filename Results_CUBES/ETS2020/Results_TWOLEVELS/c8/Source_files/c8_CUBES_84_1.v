...
module FAU ( 
  ...
  nand2  g50(.a(new_n99_), .b(new_n85_), .O(new_n100_));
  inv1   g51(.a(x24), .O(new_n101_));
  nor3   g52(.a(x23), .b(x22), .c(x21), .O(new_n102_));
  aoi21  g53(.a(new_n102_), .b(new_n82_), .c(new_n101_), .O(new_n103_));
  nor2   g54(.a(x22), .b(x21), .O(new_n104_));
  nor2   g55(.a(x24), .b(x23), .O(new_n105_));
  nand4  g56(.a(new_n105_), .b(new_n104_), .c(new_n72_), .d(new_n51_), .O(new_n106_));
  inv1   g57(.a(new_n106_), .O(new_n107_));
  oai21  g58(.a(new_n107_), .b(new_n103_), .c(x16), .O(new_n108_));
  nand2  g59(.a(new_n108_), .b(new_n100_), .O(z14));
  inv1   g60(.a(x14), .O(new_n110_));
  nand2  g61(.a(x18), .b(x06), .O(new_n111_));
  oai21  g62(.a(x18), .b(new_n110_), .c(new_n111_), .O(new_n112_));
  nand2  g63(.a(new_n112_), .b(new_n85_), .O(new_n113_));
  nand4  g64(.a(new_n64_), .b(new_n101_), .c(new_n60_), .d(new_n57_), .O(new_n114_));
  inv1   g65(.a(new_n114_), .O(new_n115_));
  aoi22  g66(.a(new_n115_), .b(new_n92_), .c(new_n106_), .d(x25), .O(new_n116_));
  oai21  g67(.a(new_n116_), .b(new_n85_), .c(new_n113_), .O(z15));
  zero   g68(.O(z05));
  zero   g69(.O(z12));
  zero   g70(.O(z13));
  zero   g71(.O(z16));
