...
module FAU ( 
  ...
  nand2  g30(.a(new_n80_), .b(new_n78_), .O(new_n81_));
  nor2   g31(.a(x21), .b(x20), .O(new_n82_));
  nand2  g32(.a(new_n82_), .b(new_n72_), .O(new_n83_));
  nor2   g33(.a(x22), .b(x21), .O(new_n84_));
  aoi22  g34(.a(new_n84_), .b(new_n74_), .c(new_n83_), .d(x22), .O(new_n85_));
  oai21  g35(.a(new_n85_), .b(new_n78_), .c(new_n81_), .O(z12));
  inv1   g36(.a(x12), .O(new_n87_));
  nand2  g37(.a(x18), .b(x04), .O(new_n88_));
  oai21  g38(.a(x18), .b(new_n87_), .c(new_n88_), .O(new_n89_));
  nand2  g39(.a(new_n89_), .b(new_n78_), .O(new_n90_));
  nand3  g40(.a(new_n84_), .b(new_n72_), .c(new_n49_), .O(new_n91_));
  nor3   g41(.a(x23), .b(x22), .c(x21), .O(new_n92_));
  aoi22  g42(.a(new_n92_), .b(new_n74_), .c(new_n91_), .d(x23), .O(new_n93_));
  oai21  g43(.a(new_n93_), .b(new_n78_), .c(new_n90_), .O(z13));
  inv1   g44(.a(x13), .O(new_n95_));
  nand2  g45(.a(x18), .b(x05), .O(new_n96_));
  oai21  g46(.a(x18), .b(new_n95_), .c(new_n96_), .O(new_n97_));
  nand2  g47(.a(new_n97_), .b(new_n78_), .O(new_n98_));
  aoi21  g48(.a(new_n92_), .b(new_n74_), .c(new_n59_), .O(new_n99_));
  nand2  g49(.a(new_n72_), .b(new_n49_), .O(new_n100_));
  nor2   g50(.a(x24), .b(x23), .O(new_n101_));
  nand2  g51(.a(new_n101_), .b(new_n84_), .O(new_n102_));
  nor2   g52(.a(new_n102_), .b(new_n100_), .O(new_n103_));
  oai21  g53(.a(new_n103_), .b(new_n99_), .c(x16), .O(new_n104_));
  ...
  nand2  g57(.a(new_n108_), .b(new_n78_), .O(new_n109_));
  nor2   g58(.a(x23), .b(x22), .O(new_n110_));
  nor2   g59(.a(x25), .b(x24), .O(new_n111_));
  nand4  g60(.a(new_n111_), .b(new_n110_), .c(new_n82_), .d(new_n72_), .O(new_n112_));
  nand2  g61(.a(new_n112_), .b(x26), .O(new_n113_));
  nor3   g62(.a(x26), .b(x25), .c(x24), .O(new_n114_));
  nand4  g63(.a(new_n114_), .b(new_n110_), .c(new_n82_), .d(new_n72_), .O(new_n115_));
