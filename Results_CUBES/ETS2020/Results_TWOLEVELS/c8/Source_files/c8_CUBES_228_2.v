...
module FAU ( 
  ...
  wire new_n47_, new_n48_, new_n49_, new_n51_, new_n52_, new_n54_, new_n55_,
    new_n57_, new_n58_, new_n61_, new_n62_, new_n64_, new_n65_, new_n68_,
  ...
  nand3  g40(.a(new_n90_), .b(new_n69_), .c(new_n51_), .O(new_n91_));
  ...
  nand4  g48(.a(new_n99_), .b(new_n90_), .c(new_n69_), .d(new_n51_), .O(new_n100_));
  nand2  g49(.a(new_n100_), .b(x25), .O(new_n101_));
  nor2   g50(.a(x23), .b(x22), .O(new_n102_));
  nor2   g51(.a(x25), .b(x24), .O(new_n103_));
  nand4  g52(.a(new_n103_), .b(new_n102_), .c(new_n81_), .d(new_n69_), .O(new_n104_));
  ...
  nand4  g62(.a(new_n113_), .b(new_n102_), .c(new_n81_), .d(new_n69_), .O(new_n114_));
  ...
  nand4  g67(.a(new_n118_), .b(new_n113_), .c(new_n102_), .d(new_n81_), .O(new_n119_));
