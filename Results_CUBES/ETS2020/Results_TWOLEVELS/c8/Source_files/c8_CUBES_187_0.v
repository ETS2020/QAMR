...
module FAU ( 
  ...
  aoi21  g48(.a(new_n99_), .b(new_n74_), .c(new_n98_), .O(new_n100_));
  nor2   g49(.a(x24), .b(x23), .O(new_n101_));
  nand2  g50(.a(new_n101_), .b(new_n90_), .O(new_n102_));
  nor2   g51(.a(new_n102_), .b(new_n82_), .O(new_n103_));
  ...
  oai21  g55(.a(x18), .b(new_n60_), .c(new_n107_), .O(new_n108_));
  nand2  g56(.a(new_n108_), .b(new_n77_), .O(new_n109_));
  nor2   g57(.a(x23), .b(x22), .O(new_n110_));
  nor2   g58(.a(x25), .b(x24), .O(new_n111_));
  nand4  g59(.a(new_n111_), .b(new_n110_), .c(new_n83_), .d(new_n64_), .O(new_n112_));
  nand2  g60(.a(new_n112_), .b(x26), .O(new_n113_));
  nor3   g61(.a(x26), .b(x25), .c(x24), .O(new_n114_));
  nand4  g62(.a(new_n114_), .b(new_n110_), .c(new_n83_), .d(new_n64_), .O(new_n115_));
