...
module FAU ( 
  ...
  nand4  g61(.a(new_n66_), .b(new_n63_), .c(new_n60_), .d(new_n57_), .O(new_n111_));
  inv1   g62(.a(new_n111_), .O(new_n112_));
  aoi22  g63(.a(new_n112_), .b(new_n108_), .c(new_n110_), .d(x25), .O(new_n113_));
  oai21  g64(.a(new_n113_), .b(new_n86_), .c(new_n107_), .O(z15));
  nor2   g65(.a(x21), .b(x20), .O(new_n116_));
  nor2   g66(.a(x23), .b(x22), .O(new_n117_));
  nor3   g67(.a(x26), .b(x25), .c(x24), .O(new_n118_));
  nor2   g68(.a(new_n48_), .b(x17), .O(new_n119_));
  nand4  g69(.a(new_n119_), .b(new_n118_), .c(new_n117_), .d(new_n116_), .O(new_n120_));
  nand2  g70(.a(x27), .b(x17), .O(new_n121_));
  aoi21  g71(.a(new_n121_), .b(new_n120_), .c(new_n86_), .O(z17));
  zero   g72(.O(z07));
  zero   g73(.O(z11));
  zero   g74(.O(z14));
  zero   g75(.O(z16));
