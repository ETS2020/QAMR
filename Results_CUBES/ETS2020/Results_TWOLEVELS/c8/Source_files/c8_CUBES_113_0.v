...
module FAU ( 
  ...
  wire new_n47_, new_n48_, new_n49_, new_n51_, new_n52_, new_n54_, new_n55_,
    new_n57_, new_n58_, new_n60_, new_n61_, new_n65_, new_n66_, new_n71_,
  ...
  nand2  g20(.a(x18), .b(x03), .O(new_n72_));
  oai21  g21(.a(x18), .b(new_n57_), .c(new_n72_), .O(new_n73_));
  ...
  nor3   g27(.a(x20), .b(x19), .c(x17), .O(new_n79_));
  aoi22  g28(.a(new_n79_), .b(new_n78_), .c(new_n77_), .d(x22), .O(new_n80_));
  oai21  g29(.a(new_n80_), .b(new_n71_), .c(new_n74_), .O(z12));
  inv1   g30(.a(x12), .O(new_n82_));
  nand2  g31(.a(x18), .b(x04), .O(new_n83_));
  oai21  g32(.a(x18), .b(new_n82_), .c(new_n83_), .O(new_n84_));
  nand2  g33(.a(new_n84_), .b(new_n71_), .O(new_n85_));
  nand3  g34(.a(new_n78_), .b(new_n75_), .c(new_n51_), .O(new_n86_));
  nor3   g35(.a(x23), .b(x22), .c(x21), .O(new_n87_));
  aoi22  g36(.a(new_n87_), .b(new_n79_), .c(new_n86_), .d(x23), .O(new_n88_));
  oai21  g37(.a(new_n88_), .b(new_n71_), .c(new_n85_), .O(z13));
  inv1   g38(.a(x13), .O(new_n90_));
  nand2  g39(.a(x18), .b(x05), .O(new_n91_));
  oai21  g40(.a(x18), .b(new_n90_), .c(new_n91_), .O(new_n92_));
  nand2  g41(.a(new_n92_), .b(new_n71_), .O(new_n93_));
  inv1   g42(.a(x24), .O(new_n94_));
  aoi21  g43(.a(new_n87_), .b(new_n79_), .c(new_n94_), .O(new_n95_));
  nand2  g44(.a(new_n75_), .b(new_n51_), .O(new_n96_));
  nand3  g45(.a(new_n78_), .b(new_n94_), .c(new_n60_), .O(new_n97_));
  nor2   g46(.a(new_n97_), .b(new_n96_), .O(new_n98_));
  oai21  g47(.a(new_n98_), .b(new_n95_), .c(x16), .O(new_n99_));
  nand2  g48(.a(new_n99_), .b(new_n93_), .O(z14));
  ...
  nand4  g54(.a(new_n106_), .b(new_n105_), .c(new_n76_), .d(new_n75_), .O(new_n107_));
  nand2  g55(.a(new_n107_), .b(x26), .O(new_n108_));
  nor3   g56(.a(x26), .b(x25), .c(x24), .O(new_n109_));
  nand4  g57(.a(new_n109_), .b(new_n105_), .c(new_n76_), .d(new_n75_), .O(new_n110_));
  ...
  nand4  g62(.a(new_n114_), .b(new_n109_), .c(new_n105_), .d(new_n76_), .O(new_n115_));
  nand2  g63(.a(x27), .b(x17), .O(new_n116_));
  aoi21  g64(.a(new_n116_), .b(new_n115_), .c(new_n71_), .O(z17));
  zero   g65(.O(z05));
  zero   g66(.O(z06));
  zero   g67(.O(z09));
  zero   g68(.O(z10));
