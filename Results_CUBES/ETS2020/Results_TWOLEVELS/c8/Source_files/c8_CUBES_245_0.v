...
module FAU ( 
  ...
  wire new_n47_, new_n48_, new_n49_, new_n51_, new_n52_, new_n56_, new_n57_,
    new_n59_, new_n60_, new_n63_, new_n64_, new_n68_, new_n69_, new_n70_,
  ...
  aoi22  g32(.a(new_n84_), .b(new_n73_), .c(new_n83_), .d(x22), .O(new_n85_));
  oai21  g33(.a(new_n85_), .b(new_n77_), .c(new_n81_), .O(z12));
  inv1   g34(.a(x13), .O(new_n88_));
  nand2  g35(.a(x18), .b(x05), .O(new_n89_));
  oai21  g36(.a(x18), .b(new_n88_), .c(new_n89_), .O(new_n90_));
  nand2  g37(.a(new_n90_), .b(new_n77_), .O(new_n91_));
  nor3   g38(.a(x23), .b(x22), .c(x21), .O(new_n92_));
  aoi21  g39(.a(new_n92_), .b(new_n73_), .c(new_n59_), .O(new_n93_));
  nand2  g40(.a(new_n71_), .b(new_n51_), .O(new_n94_));
  nand3  g41(.a(new_n84_), .b(new_n59_), .c(new_n56_), .O(new_n95_));
  nor2   g42(.a(new_n95_), .b(new_n94_), .O(new_n96_));
  oai21  g43(.a(new_n96_), .b(new_n93_), .c(x16), .O(new_n97_));
  nand2  g44(.a(new_n97_), .b(new_n91_), .O(z14));
  nand2  g45(.a(x18), .b(x07), .O(new_n100_));
  oai21  g46(.a(x18), .b(new_n63_), .c(new_n100_), .O(new_n101_));
  nand2  g47(.a(new_n101_), .b(new_n77_), .O(new_n102_));
  nor2   g48(.a(x23), .b(x22), .O(new_n103_));
  nor2   g49(.a(x25), .b(x24), .O(new_n104_));
  nand4  g50(.a(new_n104_), .b(new_n103_), .c(new_n82_), .d(new_n71_), .O(new_n105_));
  nand2  g51(.a(new_n105_), .b(x26), .O(new_n106_));
  nor3   g52(.a(x26), .b(x25), .c(x24), .O(new_n107_));
  nand4  g53(.a(new_n107_), .b(new_n103_), .c(new_n82_), .d(new_n71_), .O(new_n108_));
