...
module FAU ( 
  ...
  nand3  g52(.a(new_n94_), .b(new_n69_), .c(new_n51_), .O(new_n101_));
  ...
  nand2  g59(.a(new_n107_), .b(new_n82_), .O(new_n108_));
  inv1   g60(.a(x24), .O(new_n109_));
  aoi21  g61(.a(new_n102_), .b(new_n79_), .c(new_n109_), .O(new_n110_));
  nor2   g62(.a(x24), .b(x23), .O(new_n111_));
  nand4  g63(.a(new_n111_), .b(new_n94_), .c(new_n69_), .d(new_n51_), .O(new_n112_));
  inv1   g64(.a(new_n112_), .O(new_n113_));
  oai21  g65(.a(new_n113_), .b(new_n110_), .c(x16), .O(new_n114_));
  nand2  g66(.a(new_n114_), .b(new_n108_), .O(z14));
