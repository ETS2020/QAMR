...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n47_, new_n48_, new_n52_, new_n53_, new_n56_, new_n57_, new_n58_,
  ...
  nand2  g35(.a(new_n68_), .b(new_n76_), .O(new_n86_));
  ...
  oai21  g40(.a(x18), .b(new_n52_), .c(new_n90_), .O(new_n91_));
  ...
  nor3   g50(.a(x23), .b(x22), .c(x21), .O(new_n102_));
  aoi21  g51(.a(new_n102_), .b(new_n78_), .c(new_n57_), .O(new_n103_));
  nor2   g52(.a(x24), .b(x23), .O(new_n104_));
  nand2  g53(.a(new_n104_), .b(new_n94_), .O(new_n105_));
  nor2   g54(.a(new_n105_), .b(new_n86_), .O(new_n106_));
  ...
  nand4  g62(.a(new_n114_), .b(new_n113_), .c(new_n87_), .d(new_n68_), .O(new_n115_));
  nand2  g63(.a(new_n115_), .b(x26), .O(new_n116_));
  nor3   g64(.a(x26), .b(x25), .c(x24), .O(new_n117_));
  nand4  g65(.a(new_n117_), .b(new_n113_), .c(new_n87_), .d(new_n68_), .O(new_n118_));
