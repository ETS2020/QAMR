...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n51_, new_n52_, new_n53_, new_n55_, new_n56_, new_n59_, new_n60_,
  ...
  nand2  g05(.a(new_n51_), .b(new_n55_), .O(new_n56_));
  oai21  g06(.a(new_n51_), .b(x13), .c(new_n56_), .O(z05));
  ...
  nand2  g32(.a(new_n86_), .b(new_n73_), .O(new_n87_));
  nor3   g33(.a(x23), .b(x22), .c(x21), .O(new_n88_));
  aoi21  g34(.a(new_n88_), .b(new_n69_), .c(new_n55_), .O(new_n89_));
  nor2   g35(.a(x24), .b(x23), .O(new_n90_));
  nand4  g36(.a(new_n90_), .b(new_n80_), .c(new_n67_), .d(new_n66_), .O(new_n91_));
  inv1   g37(.a(new_n91_), .O(new_n92_));
  oai21  g38(.a(new_n92_), .b(new_n89_), .c(x16), .O(new_n93_));
  nand2  g39(.a(new_n93_), .b(new_n87_), .O(z14));
  inv1   g40(.a(x14), .O(new_n95_));
  nand2  g41(.a(x18), .b(x06), .O(new_n96_));
  oai21  g42(.a(x18), .b(new_n95_), .c(new_n96_), .O(new_n97_));
  nand2  g43(.a(new_n97_), .b(new_n73_), .O(new_n98_));
  nand2  g44(.a(new_n91_), .b(x25), .O(new_n99_));
  nor2   g45(.a(x23), .b(x22), .O(new_n100_));
  nor2   g46(.a(x25), .b(x24), .O(new_n101_));
  nand4  g47(.a(new_n101_), .b(new_n100_), .c(new_n78_), .d(new_n67_), .O(new_n102_));
  nand2  g48(.a(new_n102_), .b(new_n99_), .O(new_n103_));
  nand2  g49(.a(new_n103_), .b(x16), .O(new_n104_));
  nand2  g50(.a(new_n104_), .b(new_n98_), .O(z15));
  nand2  g51(.a(x18), .b(x07), .O(new_n106_));
  oai21  g52(.a(x18), .b(new_n59_), .c(new_n106_), .O(new_n107_));
  nand2  g53(.a(new_n107_), .b(new_n73_), .O(new_n108_));
  nand2  g54(.a(new_n102_), .b(x26), .O(new_n109_));
  nor3   g55(.a(x26), .b(x25), .c(x24), .O(new_n110_));
  nand4  g56(.a(new_n110_), .b(new_n100_), .c(new_n78_), .d(new_n67_), .O(new_n111_));
  nand2  g57(.a(new_n111_), .b(new_n109_), .O(new_n112_));
  nand2  g58(.a(new_n112_), .b(x16), .O(new_n113_));
  nand2  g59(.a(new_n113_), .b(new_n108_), .O(z16));
  zero   g60(.O(z00));
  zero   g61(.O(z01));
  zero   g62(.O(z02));
  zero   g63(.O(z03));
