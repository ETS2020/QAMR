...
module FAU ( 
  ...
  inv1   g48(.a(x11), .O(new_n97_));
  nand2  g49(.a(x18), .b(x03), .O(new_n98_));
  oai21  g50(.a(x18), .b(new_n97_), .c(new_n98_), .O(new_n99_));
  nand2  g51(.a(new_n99_), .b(new_n87_), .O(new_n100_));
  nor2   g52(.a(x22), .b(x21), .O(new_n101_));
  aoi22  g53(.a(new_n101_), .b(new_n84_), .c(new_n93_), .d(x22), .O(new_n102_));
  oai21  g54(.a(new_n102_), .b(new_n87_), .c(new_n100_), .O(z12));
  ...
  nor3   g59(.a(x23), .b(x22), .c(x21), .O(new_n109_));
  aoi21  g60(.a(new_n109_), .b(new_n84_), .c(new_n61_), .O(new_n110_));
  nor2   g61(.a(x24), .b(x23), .O(new_n111_));
  nand4  g62(.a(new_n111_), .b(new_n101_), .c(new_n74_), .d(new_n49_), .O(new_n112_));
  inv1   g63(.a(new_n112_), .O(new_n113_));
  oai21  g64(.a(new_n113_), .b(new_n110_), .c(x16), .O(new_n114_));
  nand2  g65(.a(new_n114_), .b(new_n108_), .O(z14));
  inv1   g66(.a(x14), .O(new_n116_));
  nand2  g67(.a(x18), .b(x06), .O(new_n117_));
  oai21  g68(.a(x18), .b(new_n116_), .c(new_n117_), .O(new_n118_));
  nand2  g69(.a(new_n118_), .b(new_n87_), .O(new_n119_));
  nand4  g70(.a(new_n64_), .b(new_n61_), .c(new_n58_), .d(new_n55_), .O(new_n120_));
  inv1   g71(.a(new_n120_), .O(new_n121_));
  aoi22  g72(.a(new_n121_), .b(new_n94_), .c(new_n112_), .d(x25), .O(new_n122_));
  oai21  g73(.a(new_n122_), .b(new_n87_), .c(new_n119_), .O(z15));
  zero   g74(.O(z00));
  zero   g75(.O(z08));
  zero   g76(.O(z13));
  zero   g77(.O(z16));
