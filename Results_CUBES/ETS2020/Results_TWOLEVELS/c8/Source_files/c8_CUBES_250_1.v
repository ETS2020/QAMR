...
module FAU ( 
  ...
  nand4  g42(.a(new_n72_), .b(new_n92_), .c(new_n54_), .d(new_n51_), .O(new_n93_));
  nor3   g43(.a(x23), .b(x22), .c(x21), .O(new_n94_));
  aoi22  g44(.a(new_n94_), .b(new_n82_), .c(new_n93_), .d(x23), .O(new_n95_));
  oai21  g45(.a(new_n95_), .b(new_n87_), .c(new_n91_), .O(z13));
  ...
  aoi21  g50(.a(new_n94_), .b(new_n82_), .c(new_n61_), .O(new_n101_));
  nand2  g51(.a(new_n72_), .b(new_n51_), .O(new_n102_));
  nand4  g52(.a(new_n61_), .b(new_n58_), .c(new_n92_), .d(new_n54_), .O(new_n103_));
  ...
  nand4  g62(.a(new_n113_), .b(new_n112_), .c(new_n111_), .d(new_n72_), .O(new_n114_));
  nand2  g63(.a(new_n114_), .b(x26), .O(new_n115_));
  nor3   g64(.a(x26), .b(x25), .c(x24), .O(new_n116_));
  nand4  g65(.a(new_n116_), .b(new_n112_), .c(new_n111_), .d(new_n72_), .O(new_n117_));
  nand2  g66(.a(new_n117_), .b(new_n115_), .O(new_n118_));
  nand2  g67(.a(new_n118_), .b(x16), .O(new_n119_));
  nand2  g68(.a(new_n119_), .b(new_n110_), .O(z16));
  nor2   g69(.a(new_n48_), .b(x17), .O(new_n121_));
  nand4  g70(.a(new_n121_), .b(new_n116_), .c(new_n112_), .d(new_n111_), .O(new_n122_));
  nand2  g71(.a(x27), .b(x17), .O(new_n123_));
  aoi21  g72(.a(new_n123_), .b(new_n122_), .c(new_n87_), .O(z17));
  zero   g73(.O(z03));
  zero   g74(.O(z08));
  zero   g75(.O(z11));
  zero   g76(.O(z12));
