...
module FAU ( 
  ...
  wire new_n47_, new_n48_, new_n49_, new_n51_, new_n52_, new_n54_, new_n55_,
    new_n57_, new_n58_, new_n60_, new_n61_, new_n66_, new_n67_, new_n68_,
  ...
  nor2   g26(.a(new_n67_), .b(new_n51_), .O(new_n76_));
  ...
  oai21  g32(.a(x18), .b(new_n54_), .c(new_n81_), .O(new_n82_));
  nand2  g33(.a(new_n82_), .b(new_n80_), .O(new_n83_));
  nand2  g34(.a(new_n67_), .b(new_n51_), .O(new_n84_));
  ...
  oai21  g39(.a(x18), .b(new_n60_), .c(new_n89_), .O(new_n90_));
  nand2  g40(.a(new_n90_), .b(new_n80_), .O(new_n91_));
  nor2   g41(.a(x22), .b(x21), .O(new_n92_));
  nand3  g42(.a(new_n92_), .b(new_n67_), .c(new_n51_), .O(new_n93_));
  nor3   g43(.a(x23), .b(x22), .c(x21), .O(new_n94_));
  aoi22  g44(.a(new_n94_), .b(new_n77_), .c(new_n93_), .d(x23), .O(new_n95_));
  oai21  g45(.a(new_n95_), .b(new_n80_), .c(new_n91_), .O(z13));
  inv1   g46(.a(x14), .O(new_n98_));
  ...
  nand4  g51(.a(new_n102_), .b(new_n92_), .c(new_n67_), .d(new_n51_), .O(new_n103_));
  nand2  g52(.a(new_n103_), .b(x25), .O(new_n104_));
  nor2   g53(.a(x23), .b(x22), .O(new_n105_));
  nor2   g54(.a(x25), .b(x24), .O(new_n106_));
  nand4  g55(.a(new_n106_), .b(new_n105_), .c(new_n85_), .d(new_n67_), .O(new_n107_));
  nand2  g56(.a(new_n107_), .b(new_n104_), .O(new_n108_));
  nand2  g57(.a(new_n108_), .b(x16), .O(new_n109_));
  nand2  g58(.a(new_n109_), .b(new_n101_), .O(z15));
  inv1   g59(.a(x15), .O(new_n111_));
  nand2  g60(.a(x18), .b(x07), .O(new_n112_));
  oai21  g61(.a(x18), .b(new_n111_), .c(new_n112_), .O(new_n113_));
  nand2  g62(.a(new_n113_), .b(new_n80_), .O(new_n114_));
  nand2  g63(.a(new_n107_), .b(x26), .O(new_n115_));
  nor3   g64(.a(x26), .b(x25), .c(x24), .O(new_n116_));
  nand4  g65(.a(new_n116_), .b(new_n105_), .c(new_n85_), .d(new_n67_), .O(new_n117_));
  nand2  g66(.a(new_n117_), .b(new_n115_), .O(new_n118_));
  nand2  g67(.a(new_n118_), .b(x16), .O(new_n119_));
  nand2  g68(.a(new_n119_), .b(new_n114_), .O(z16));
  nor2   g69(.a(new_n48_), .b(x17), .O(new_n121_));
  nand4  g70(.a(new_n121_), .b(new_n116_), .c(new_n105_), .d(new_n85_), .O(new_n122_));
  nand2  g71(.a(x27), .b(x17), .O(new_n123_));
  aoi21  g72(.a(new_n123_), .b(new_n122_), .c(new_n80_), .O(z17));
  zero   g73(.O(z05));
  zero   g74(.O(z06));
  zero   g75(.O(z07));
  zero   g76(.O(z12));
