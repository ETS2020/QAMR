...
module FAU ( 
  ...
  nand4  g40(.a(new_n52_), .b(new_n49_), .c(new_n69_), .d(new_n68_), .O(new_n90_));
  nor2   g41(.a(x22), .b(x21), .O(new_n91_));
  aoi22  g42(.a(new_n91_), .b(new_n81_), .c(new_n90_), .d(x22), .O(new_n92_));
  oai21  g43(.a(new_n92_), .b(new_n85_), .c(new_n89_), .O(z12));
  inv1   g44(.a(x13), .O(new_n95_));
  nand2  g45(.a(x18), .b(x05), .O(new_n96_));
  oai21  g46(.a(x18), .b(new_n95_), .c(new_n96_), .O(new_n97_));
  nand2  g47(.a(new_n97_), .b(new_n85_), .O(new_n98_));
  nor3   g48(.a(x23), .b(x22), .c(x21), .O(new_n99_));
  aoi21  g49(.a(new_n99_), .b(new_n81_), .c(new_n61_), .O(new_n100_));
  nor2   g50(.a(x24), .b(x23), .O(new_n101_));
  nand4  g51(.a(new_n101_), .b(new_n91_), .c(new_n71_), .d(new_n49_), .O(new_n102_));
  inv1   g52(.a(new_n102_), .O(new_n103_));
  oai21  g53(.a(new_n103_), .b(new_n100_), .c(x16), .O(new_n104_));
  nand2  g54(.a(new_n104_), .b(new_n98_), .O(z14));
  inv1   g55(.a(x14), .O(new_n106_));
  nand2  g56(.a(x18), .b(x06), .O(new_n107_));
  oai21  g57(.a(x18), .b(new_n106_), .c(new_n107_), .O(new_n108_));
  nand2  g58(.a(new_n108_), .b(new_n85_), .O(new_n109_));
  inv1   g59(.a(new_n90_), .O(new_n110_));
  nand4  g60(.a(new_n64_), .b(new_n61_), .c(new_n58_), .d(new_n55_), .O(new_n111_));
  inv1   g61(.a(new_n111_), .O(new_n112_));
  aoi22  g62(.a(new_n112_), .b(new_n110_), .c(new_n102_), .d(x25), .O(new_n113_));
  oai21  g63(.a(new_n113_), .b(new_n85_), .c(new_n109_), .O(z15));
  nor2   g64(.a(x21), .b(x20), .O(new_n116_));
  nor2   g65(.a(x23), .b(x22), .O(new_n117_));
  nor3   g66(.a(x26), .b(x25), .c(x24), .O(new_n118_));
  nor2   g67(.a(new_n69_), .b(x17), .O(new_n119_));
  nand4  g68(.a(new_n119_), .b(new_n118_), .c(new_n117_), .d(new_n116_), .O(new_n120_));
  nand2  g69(.a(x27), .b(x17), .O(new_n121_));
  aoi21  g70(.a(new_n121_), .b(new_n120_), .c(new_n85_), .O(z17));
  zero   g71(.O(z00));
  zero   g72(.O(z07));
  zero   g73(.O(z11));
  zero   g74(.O(z13));
