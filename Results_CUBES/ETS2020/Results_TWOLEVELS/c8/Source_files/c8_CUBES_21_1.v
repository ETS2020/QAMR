...
module FAU ( 
  ...
  aoi21  g59(.a(new_n107_), .b(new_n84_), .c(new_n63_), .O(new_n108_));
  nand3  g60(.a(new_n99_), .b(new_n63_), .c(new_n60_), .O(new_n109_));
  nor2   g61(.a(new_n109_), .b(new_n91_), .O(new_n110_));
  ...
  oai21  g65(.a(x18), .b(new_n69_), .c(new_n114_), .O(new_n115_));
  nand2  g66(.a(new_n115_), .b(new_n87_), .O(new_n116_));
  nor2   g67(.a(x23), .b(x22), .O(new_n117_));
  nor2   g68(.a(x25), .b(x24), .O(new_n118_));
  nand4  g69(.a(new_n118_), .b(new_n117_), .c(new_n92_), .d(new_n74_), .O(new_n119_));
  nand2  g70(.a(new_n119_), .b(x26), .O(new_n120_));
  nor3   g71(.a(x26), .b(x25), .c(x24), .O(new_n121_));
  nand4  g72(.a(new_n121_), .b(new_n117_), .c(new_n92_), .d(new_n74_), .O(new_n122_));
  ...
  nand4  g77(.a(new_n126_), .b(new_n121_), .c(new_n117_), .d(new_n92_), .O(new_n127_));
