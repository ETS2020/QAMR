...
module FAU ( 
  ...
  nand2  g25(.a(x18), .b(x03), .O(new_n77_));
  oai21  g26(.a(x18), .b(new_n53_), .c(new_n77_), .O(new_n78_));
  nand2  g27(.a(new_n78_), .b(new_n76_), .O(new_n79_));
  nor2   g28(.a(x21), .b(x20), .O(new_n80_));
  nand2  g29(.a(new_n80_), .b(new_n70_), .O(new_n81_));
  nor2   g30(.a(x22), .b(x21), .O(new_n82_));
  aoi22  g31(.a(new_n82_), .b(new_n72_), .c(new_n81_), .d(x22), .O(new_n83_));
  oai21  g32(.a(new_n83_), .b(new_n76_), .c(new_n79_), .O(z12));
  ...
  nand3  g37(.a(new_n82_), .b(new_n70_), .c(new_n49_), .O(new_n89_));
  nor3   g38(.a(x23), .b(x22), .c(x21), .O(new_n90_));
  aoi22  g39(.a(new_n90_), .b(new_n72_), .c(new_n89_), .d(x23), .O(new_n91_));
  oai21  g40(.a(new_n91_), .b(new_n76_), .c(new_n88_), .O(z13));
  ...
  nand2  g47(.a(new_n70_), .b(new_n49_), .O(new_n99_));
  nand3  g48(.a(new_n82_), .b(new_n97_), .c(new_n56_), .O(new_n100_));
  ...
  oai21  g53(.a(x18), .b(new_n63_), .c(new_n105_), .O(new_n106_));
  nand2  g54(.a(new_n106_), .b(new_n76_), .O(new_n107_));
  nor2   g55(.a(x23), .b(x22), .O(new_n108_));
  nor2   g56(.a(x25), .b(x24), .O(new_n109_));
  nand4  g57(.a(new_n109_), .b(new_n108_), .c(new_n80_), .d(new_n70_), .O(new_n110_));
  nand2  g58(.a(new_n110_), .b(x26), .O(new_n111_));
  nor3   g59(.a(x26), .b(x25), .c(x24), .O(new_n112_));
  nand4  g60(.a(new_n112_), .b(new_n108_), .c(new_n80_), .d(new_n70_), .O(new_n113_));
  nand2  g61(.a(new_n113_), .b(new_n111_), .O(new_n114_));
  nand2  g62(.a(new_n114_), .b(x16), .O(new_n115_));
  nand2  g63(.a(new_n115_), .b(new_n107_), .O(z16));
  inv1   g64(.a(x19), .O(new_n117_));
  nor2   g65(.a(new_n117_), .b(x17), .O(new_n118_));
  nand4  g66(.a(new_n118_), .b(new_n112_), .c(new_n108_), .d(new_n80_), .O(new_n119_));
  nand2  g67(.a(x27), .b(x17), .O(new_n120_));
  aoi21  g68(.a(new_n120_), .b(new_n119_), .c(new_n76_), .O(z17));
  zero   g69(.O(z00));
  zero   g70(.O(z02));
  zero   g71(.O(z05));
  zero   g72(.O(z09));
