...
module FAU ( 
  ...
  wire new_n47_, new_n48_, new_n49_, new_n51_, new_n52_, new_n54_, new_n55_,
    new_n57_, new_n58_, new_n60_, new_n61_, new_n64_, new_n65_, new_n72_,
  ...
  oai21  g21(.a(x18), .b(new_n60_), .c(new_n73_), .O(new_n74_));
  nand2  g22(.a(new_n74_), .b(new_n72_), .O(new_n75_));
  nor3   g23(.a(x20), .b(x19), .c(x17), .O(new_n76_));
  nor2   g24(.a(x22), .b(x21), .O(new_n77_));
  nor2   g25(.a(x19), .b(x17), .O(new_n78_));
  nand3  g26(.a(new_n78_), .b(new_n77_), .c(new_n51_), .O(new_n79_));
  nor3   g27(.a(x23), .b(x22), .c(x21), .O(new_n80_));
  aoi22  g28(.a(new_n80_), .b(new_n76_), .c(new_n79_), .d(x23), .O(new_n81_));
  oai21  g29(.a(new_n81_), .b(new_n72_), .c(new_n75_), .O(z13));
  inv1   g30(.a(x13), .O(new_n83_));
  nand2  g31(.a(x18), .b(x05), .O(new_n84_));
  oai21  g32(.a(x18), .b(new_n83_), .c(new_n84_), .O(new_n85_));
  nand2  g33(.a(new_n85_), .b(new_n72_), .O(new_n86_));
  inv1   g34(.a(x24), .O(new_n87_));
  aoi21  g35(.a(new_n80_), .b(new_n76_), .c(new_n87_), .O(new_n88_));
  nor2   g36(.a(x24), .b(x23), .O(new_n89_));
  nand4  g37(.a(new_n89_), .b(new_n78_), .c(new_n77_), .d(new_n51_), .O(new_n90_));
  inv1   g38(.a(new_n90_), .O(new_n91_));
  oai21  g39(.a(new_n91_), .b(new_n88_), .c(x16), .O(new_n92_));
  nand2  g40(.a(new_n92_), .b(new_n86_), .O(z14));
  nand2  g41(.a(x18), .b(x06), .O(new_n94_));
  oai21  g42(.a(x18), .b(new_n64_), .c(new_n94_), .O(new_n95_));
  nand2  g43(.a(new_n95_), .b(new_n72_), .O(new_n96_));
  nand2  g44(.a(new_n90_), .b(x25), .O(new_n97_));
  nor2   g45(.a(x23), .b(x22), .O(new_n98_));
  nor2   g46(.a(x21), .b(x20), .O(new_n99_));
  nor2   g47(.a(x25), .b(x24), .O(new_n100_));
  nand4  g48(.a(new_n100_), .b(new_n99_), .c(new_n98_), .d(new_n78_), .O(new_n101_));
  nand2  g49(.a(new_n101_), .b(new_n97_), .O(new_n102_));
  nand2  g50(.a(new_n102_), .b(x16), .O(new_n103_));
  nand2  g51(.a(new_n103_), .b(new_n96_), .O(z15));
  inv1   g52(.a(x15), .O(new_n105_));
  ...
  nand2  g56(.a(new_n101_), .b(x26), .O(new_n109_));
  nor3   g57(.a(x26), .b(x25), .c(x24), .O(new_n110_));
  nand4  g58(.a(new_n110_), .b(new_n99_), .c(new_n98_), .d(new_n78_), .O(new_n111_));
  ...
  nand4  g63(.a(new_n115_), .b(new_n110_), .c(new_n99_), .d(new_n98_), .O(new_n116_));
