...
module FAU ( 
  ...
  nand2  g55(.a(new_n102_), .b(new_n85_), .O(new_n103_));
  nand3  g56(.a(new_n97_), .b(new_n71_), .c(new_n80_), .O(new_n104_));
  nor3   g57(.a(x23), .b(x22), .c(x21), .O(new_n105_));
  aoi22  g58(.a(new_n105_), .b(new_n82_), .c(new_n104_), .d(x23), .O(new_n106_));
  oai21  g59(.a(new_n106_), .b(new_n85_), .c(new_n103_), .O(z13));
  inv1   g60(.a(x13), .O(new_n108_));
  nand2  g61(.a(x18), .b(x05), .O(new_n109_));
  oai21  g62(.a(x18), .b(new_n108_), .c(new_n109_), .O(new_n110_));
  nand2  g63(.a(new_n110_), .b(new_n85_), .O(new_n111_));
  aoi21  g64(.a(new_n105_), .b(new_n82_), .c(new_n61_), .O(new_n112_));
  nand3  g65(.a(new_n97_), .b(new_n61_), .c(new_n58_), .O(new_n113_));
  nor2   g66(.a(new_n113_), .b(new_n89_), .O(new_n114_));
  ...
  nand4  g74(.a(new_n122_), .b(new_n121_), .c(new_n90_), .d(new_n71_), .O(new_n123_));
  nand2  g75(.a(new_n123_), .b(x26), .O(new_n124_));
  nor3   g76(.a(x26), .b(x25), .c(x24), .O(new_n125_));
  nand4  g77(.a(new_n125_), .b(new_n121_), .c(new_n90_), .d(new_n71_), .O(new_n126_));
  ...
  nand4  g82(.a(new_n130_), .b(new_n125_), .c(new_n121_), .d(new_n90_), .O(new_n131_));
  nand2  g83(.a(x27), .b(x17), .O(new_n132_));
  aoi21  g84(.a(new_n132_), .b(new_n131_), .c(new_n85_), .O(z17));
  zero   g85(.O(z01));
  zero   g86(.O(z15));
  buf    g87(.a(x27), .O(z08));
endmodule
