// Benchmark "FAU" written by ABC on Mon Jul  6 18:51:36 2020
...
module FAU ( 
  ...
  inv1   g48(.a(x13), .O(new_n97_));
  nand2  g49(.a(x18), .b(x05), .O(new_n98_));
  oai21  g50(.a(x18), .b(new_n97_), .c(new_n98_), .O(new_n99_));
  nand2  g51(.a(new_n99_), .b(new_n80_), .O(new_n100_));
  nor3   g52(.a(x23), .b(x22), .c(x21), .O(new_n101_));
  aoi21  g53(.a(new_n101_), .b(new_n91_), .c(new_n63_), .O(new_n102_));
  nor2   g54(.a(x24), .b(x23), .O(new_n103_));
  nand4  g55(.a(new_n103_), .b(new_n93_), .c(new_n73_), .d(new_n51_), .O(new_n104_));
  inv1   g56(.a(new_n104_), .O(new_n105_));
  oai21  g57(.a(new_n105_), .b(new_n102_), .c(x16), .O(new_n106_));
  nand2  g58(.a(new_n106_), .b(new_n100_), .O(z14));
  nand2  g59(.a(x18), .b(x06), .O(new_n108_));
  oai21  g60(.a(x18), .b(new_n66_), .c(new_n108_), .O(new_n109_));
  nand2  g61(.a(new_n109_), .b(new_n80_), .O(new_n110_));
  nand2  g62(.a(new_n104_), .b(x25), .O(new_n111_));
  nor2   g63(.a(x23), .b(x22), .O(new_n112_));
  nor2   g64(.a(x25), .b(x24), .O(new_n113_));
  nand4  g65(.a(new_n113_), .b(new_n112_), .c(new_n85_), .d(new_n73_), .O(new_n114_));
  nand2  g66(.a(new_n114_), .b(new_n111_), .O(new_n115_));
  nand2  g67(.a(new_n115_), .b(x16), .O(new_n116_));
  nand2  g68(.a(new_n116_), .b(new_n110_), .O(z15));
  nand2  g69(.a(x18), .b(x07), .O(new_n118_));
  oai21  g70(.a(x18), .b(new_n69_), .c(new_n118_), .O(new_n119_));
  nand2  g71(.a(new_n119_), .b(new_n80_), .O(new_n120_));
  nand2  g72(.a(new_n114_), .b(x26), .O(new_n121_));
  nor3   g73(.a(x26), .b(x25), .c(x24), .O(new_n122_));
  nand4  g74(.a(new_n122_), .b(new_n112_), .c(new_n85_), .d(new_n73_), .O(new_n123_));
  nand2  g75(.a(new_n123_), .b(new_n121_), .O(new_n124_));
  nand2  g76(.a(new_n124_), .b(x16), .O(new_n125_));
  nand2  g77(.a(new_n125_), .b(new_n120_), .O(z16));
  nor2   g78(.a(new_n48_), .b(x17), .O(new_n127_));
  nand4  g79(.a(new_n127_), .b(new_n122_), .c(new_n112_), .d(new_n85_), .O(new_n128_));
  nand2  g80(.a(x27), .b(x17), .O(new_n129_));
  aoi21  g81(.a(new_n129_), .b(new_n128_), .c(new_n80_), .O(z17));
  zero   g82(.O(z10));
  zero   g83(.O(z13));
  buf    g84(.a(x27), .O(z08));
endmodule
