...
module FAU ( 
  ...
  aoi21  g52(.a(new_n101_), .b(new_n82_), .c(new_n100_), .O(new_n102_));
  nor2   g53(.a(x24), .b(x23), .O(new_n103_));
  nand4  g54(.a(new_n103_), .b(new_n92_), .c(new_n72_), .d(new_n51_), .O(new_n104_));
  inv1   g55(.a(new_n104_), .O(new_n105_));
  oai21  g56(.a(new_n105_), .b(new_n102_), .c(x16), .O(new_n106_));
  nand2  g57(.a(new_n106_), .b(new_n99_), .O(z14));
  ...
  inv1   g62(.a(new_n91_), .O(new_n112_));
  nand4  g63(.a(new_n64_), .b(new_n100_), .c(new_n60_), .d(new_n57_), .O(new_n113_));
  inv1   g64(.a(new_n113_), .O(new_n114_));
  aoi22  g65(.a(new_n114_), .b(new_n112_), .c(new_n104_), .d(x25), .O(new_n115_));
  oai21  g66(.a(new_n115_), .b(new_n86_), .c(new_n111_), .O(z15));
