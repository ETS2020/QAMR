...
module FAU ( 
  ...
  nand2  g48(.a(x18), .b(x06), .O(new_n99_));
  oai21  g49(.a(x18), .b(new_n62_), .c(new_n99_), .O(new_n100_));
  nand2  g50(.a(new_n100_), .b(new_n82_), .O(new_n101_));
  nor2   g51(.a(x24), .b(x23), .O(new_n102_));
  nand4  g52(.a(new_n102_), .b(new_n94_), .c(new_n69_), .d(new_n49_), .O(new_n103_));
  nand2  g53(.a(new_n103_), .b(x25), .O(new_n104_));
  nor2   g54(.a(x23), .b(x22), .O(new_n105_));
  nor2   g55(.a(x25), .b(x24), .O(new_n106_));
  nand4  g56(.a(new_n106_), .b(new_n105_), .c(new_n87_), .d(new_n69_), .O(new_n107_));
  nand2  g57(.a(new_n107_), .b(new_n104_), .O(new_n108_));
  nand2  g58(.a(new_n108_), .b(x16), .O(new_n109_));
  nand2  g59(.a(new_n109_), .b(new_n101_), .O(z15));
  nand2  g60(.a(x18), .b(x07), .O(new_n111_));
  oai21  g61(.a(x18), .b(new_n65_), .c(new_n111_), .O(new_n112_));
  nand2  g62(.a(new_n112_), .b(new_n82_), .O(new_n113_));
  nand2  g63(.a(new_n107_), .b(x26), .O(new_n114_));
  nor3   g64(.a(x26), .b(x25), .c(x24), .O(new_n115_));
  nand4  g65(.a(new_n115_), .b(new_n105_), .c(new_n87_), .d(new_n69_), .O(new_n116_));
  ...
  inv1   g69(.a(x19), .O(new_n120_));
  nor2   g70(.a(new_n120_), .b(x17), .O(new_n121_));
  nand4  g71(.a(new_n121_), .b(new_n115_), .c(new_n105_), .d(new_n87_), .O(new_n122_));
  nand2  g72(.a(x27), .b(x17), .O(new_n123_));
  aoi21  g73(.a(new_n123_), .b(new_n122_), .c(new_n82_), .O(z17));
  zero   g74(.O(z00));
  zero   g75(.O(z04));
  zero   g76(.O(z13));
  zero   g77(.O(z14));
