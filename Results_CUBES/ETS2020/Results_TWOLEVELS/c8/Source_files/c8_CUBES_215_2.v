...
module FAU ( 
  ...
  nand4  g40(.a(new_n52_), .b(new_n80_), .c(new_n48_), .d(new_n69_), .O(new_n91_));
  ...
  nand3  g48(.a(new_n92_), .b(new_n71_), .c(new_n80_), .O(new_n99_));
  ...
  aoi21  g56(.a(new_n100_), .b(new_n82_), .c(new_n61_), .O(new_n107_));
  nor2   g57(.a(x24), .b(x23), .O(new_n108_));
  nand4  g58(.a(new_n108_), .b(new_n92_), .c(new_n71_), .d(new_n80_), .O(new_n109_));
  ...
  inv1   g66(.a(new_n91_), .O(new_n117_));
  nand4  g67(.a(new_n64_), .b(new_n61_), .c(new_n58_), .d(new_n55_), .O(new_n118_));
  inv1   g68(.a(new_n118_), .O(new_n119_));
  aoi22  g69(.a(new_n119_), .b(new_n117_), .c(new_n109_), .d(x25), .O(new_n120_));
  oai21  g70(.a(new_n120_), .b(new_n86_), .c(new_n116_), .O(z15));
  nor2   g71(.a(x21), .b(x20), .O(new_n123_));
  nor2   g72(.a(x23), .b(x22), .O(new_n124_));
  nor3   g73(.a(x26), .b(x25), .c(x24), .O(new_n125_));
  nor2   g74(.a(new_n48_), .b(x17), .O(new_n126_));
  nand4  g75(.a(new_n126_), .b(new_n125_), .c(new_n124_), .d(new_n123_), .O(new_n127_));
  nand2  g76(.a(x27), .b(x17), .O(new_n128_));
  aoi21  g77(.a(new_n128_), .b(new_n127_), .c(new_n86_), .O(z17));
  zero   g78(.O(z01));
  zero   g79(.O(z07));
  zero   g80(.O(z08));
  zero   g81(.O(z11));
