...
module FAU ( 
  ...
  nand2  g57(.a(new_n103_), .b(new_n86_), .O(new_n104_));
  nand3  g58(.a(new_n98_), .b(new_n73_), .c(new_n51_), .O(new_n105_));
  nor3   g59(.a(x23), .b(x22), .c(x21), .O(new_n106_));
  aoi22  g60(.a(new_n106_), .b(new_n83_), .c(new_n105_), .d(x23), .O(new_n107_));
  oai21  g61(.a(new_n107_), .b(new_n86_), .c(new_n104_), .O(z13));
  inv1   g62(.a(x13), .O(new_n109_));
  nand2  g63(.a(x18), .b(x05), .O(new_n110_));
  oai21  g64(.a(x18), .b(new_n109_), .c(new_n110_), .O(new_n111_));
  nand2  g65(.a(new_n111_), .b(new_n86_), .O(new_n112_));
  aoi21  g66(.a(new_n106_), .b(new_n83_), .c(new_n63_), .O(new_n113_));
  nand3  g67(.a(new_n98_), .b(new_n63_), .c(new_n60_), .O(new_n114_));
  nor2   g68(.a(new_n114_), .b(new_n90_), .O(new_n115_));
  oai21  g69(.a(new_n115_), .b(new_n113_), .c(x16), .O(new_n116_));
  nand2  g70(.a(new_n116_), .b(new_n112_), .O(z14));
  nand2  g71(.a(x18), .b(x07), .O(new_n119_));
  oai21  g72(.a(x18), .b(new_n69_), .c(new_n119_), .O(new_n120_));
  nand2  g73(.a(new_n120_), .b(new_n86_), .O(new_n121_));
  nor2   g74(.a(x23), .b(x22), .O(new_n122_));
  nor2   g75(.a(x25), .b(x24), .O(new_n123_));
  nand4  g76(.a(new_n123_), .b(new_n122_), .c(new_n91_), .d(new_n73_), .O(new_n124_));
  nand2  g77(.a(new_n124_), .b(x26), .O(new_n125_));
  nor3   g78(.a(x26), .b(x25), .c(x24), .O(new_n126_));
  nand4  g79(.a(new_n126_), .b(new_n122_), .c(new_n91_), .d(new_n73_), .O(new_n127_));
  nand2  g80(.a(new_n127_), .b(new_n125_), .O(new_n128_));
  nand2  g81(.a(new_n128_), .b(x16), .O(new_n129_));
  nand2  g82(.a(new_n129_), .b(new_n121_), .O(z16));
  nor2   g83(.a(new_n48_), .b(x17), .O(new_n131_));
  nand4  g84(.a(new_n131_), .b(new_n126_), .c(new_n122_), .d(new_n91_), .O(new_n132_));
  nand2  g85(.a(x27), .b(x17), .O(new_n133_));
  aoi21  g86(.a(new_n133_), .b(new_n132_), .c(new_n86_), .O(z17));
  zero   g87(.O(z15));
  buf    g88(.a(x27), .O(z08));
endmodule
