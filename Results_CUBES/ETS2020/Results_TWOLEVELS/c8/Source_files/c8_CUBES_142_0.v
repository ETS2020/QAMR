...
module FAU ( 
  ...
  inv1   g60(.a(x14), .O(new_n112_));
  nand2  g61(.a(x18), .b(x06), .O(new_n113_));
  oai21  g62(.a(x18), .b(new_n112_), .c(new_n113_), .O(new_n114_));
  nand2  g63(.a(new_n114_), .b(new_n73_), .O(new_n115_));
  inv1   g64(.a(x25), .O(new_n116_));
  nand4  g65(.a(new_n116_), .b(new_n105_), .c(new_n56_), .d(new_n53_), .O(new_n117_));
  inv1   g66(.a(new_n117_), .O(new_n118_));
  aoi22  g67(.a(new_n118_), .b(new_n82_), .c(new_n108_), .d(x25), .O(new_n119_));
  oai21  g68(.a(new_n119_), .b(new_n73_), .c(new_n115_), .O(z15));
