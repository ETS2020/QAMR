...
module FAU ( 
  ...
  nand2  g47(.a(new_n94_), .b(new_n81_), .O(new_n95_));
  nor2   g48(.a(x22), .b(x21), .O(new_n96_));
  aoi22  g49(.a(new_n96_), .b(new_n86_), .c(new_n88_), .d(x22), .O(new_n97_));
  oai21  g50(.a(new_n97_), .b(new_n81_), .c(new_n95_), .O(z12));
  ...
  aoi22  g57(.a(new_n104_), .b(new_n86_), .c(new_n103_), .d(x23), .O(new_n105_));
  oai21  g58(.a(new_n105_), .b(new_n81_), .c(new_n102_), .O(z13));
  inv1   g59(.a(x14), .O(new_n108_));
  nand2  g60(.a(x18), .b(x06), .O(new_n109_));
  oai21  g61(.a(x18), .b(new_n108_), .c(new_n109_), .O(new_n110_));
  nand2  g62(.a(new_n110_), .b(new_n81_), .O(new_n111_));
  nor2   g63(.a(x24), .b(x23), .O(new_n112_));
  nand4  g64(.a(new_n112_), .b(new_n96_), .c(new_n74_), .d(new_n51_), .O(new_n113_));
  nand4  g65(.a(new_n66_), .b(new_n63_), .c(new_n60_), .d(new_n57_), .O(new_n114_));
  inv1   g66(.a(new_n114_), .O(new_n115_));
  aoi22  g67(.a(new_n115_), .b(new_n89_), .c(new_n113_), .d(x25), .O(new_n116_));
  oai21  g68(.a(new_n116_), .b(new_n81_), .c(new_n111_), .O(z15));
  nor2   g69(.a(x21), .b(x20), .O(new_n119_));
  nor2   g70(.a(x23), .b(x22), .O(new_n120_));
  nor3   g71(.a(x26), .b(x25), .c(x24), .O(new_n121_));
  nor2   g72(.a(new_n48_), .b(x17), .O(new_n122_));
  nand4  g73(.a(new_n122_), .b(new_n121_), .c(new_n120_), .d(new_n119_), .O(new_n123_));
  nand2  g74(.a(x27), .b(x17), .O(new_n124_));
  aoi21  g75(.a(new_n124_), .b(new_n123_), .c(new_n81_), .O(z17));
  zero   g76(.O(z10));
  zero   g77(.O(z14));
  zero   g78(.O(z16));
  buf    g79(.a(x27), .O(z08));
