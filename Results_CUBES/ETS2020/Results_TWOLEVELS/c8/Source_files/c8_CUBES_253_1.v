...
module FAU ( 
  ...
  nor2   g81(.a(x21), .b(x20), .O(new_n130_));
  nor2   g82(.a(x23), .b(x22), .O(new_n131_));
  nor3   g83(.a(x26), .b(x25), .c(x24), .O(new_n132_));
  nor2   g84(.a(new_n48_), .b(x17), .O(new_n133_));
  nand4  g85(.a(new_n133_), .b(new_n132_), .c(new_n131_), .d(new_n130_), .O(new_n134_));
  nand2  g86(.a(x27), .b(x17), .O(new_n135_));
  aoi21  g87(.a(new_n135_), .b(new_n134_), .c(new_n85_), .O(z17));
  zero   g88(.O(z05));
  zero   g89(.O(z16));
  buf    g90(.a(x27), .O(z08));
endmodule
