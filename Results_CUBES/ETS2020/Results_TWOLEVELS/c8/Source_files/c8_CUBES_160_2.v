...
module FAU ( 
  ...
  nand3  g45(.a(new_n89_), .b(new_n69_), .c(new_n51_), .O(new_n95_));
  ...
  nand4  g53(.a(new_n103_), .b(new_n89_), .c(new_n69_), .d(new_n51_), .O(new_n104_));
  ...
  nand4  g72(.a(new_n122_), .b(new_n117_), .c(new_n106_), .d(new_n81_), .O(new_n123_));
  nand2  g73(.a(x27), .b(x17), .O(new_n124_));
  aoi21  g74(.a(new_n124_), .b(new_n123_), .c(new_n76_), .O(z17));
  zero   g75(.O(z05));
  zero   g76(.O(z07));
  zero   g77(.O(z10));
  zero   g78(.O(z14));
