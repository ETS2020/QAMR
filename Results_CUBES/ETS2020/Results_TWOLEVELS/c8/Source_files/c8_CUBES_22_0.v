...
module FAU ( 
  ...
  nand3  g23(.a(new_n64_), .b(new_n76_), .c(new_n51_), .O(new_n77_));
  inv1   g24(.a(new_n77_), .O(new_n78_));
  aoi21  g25(.a(new_n75_), .b(x21), .c(new_n78_), .O(new_n79_));
  oai21  g26(.a(new_n79_), .b(new_n70_), .c(new_n74_), .O(z11));
  inv1   g27(.a(x11), .O(new_n81_));
  nand2  g28(.a(x18), .b(x03), .O(new_n82_));
  oai21  g29(.a(x18), .b(new_n81_), .c(new_n82_), .O(new_n83_));
  nand2  g30(.a(new_n83_), .b(new_n70_), .O(new_n84_));
