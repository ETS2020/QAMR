...
module FAU ( 
  ...
  nor2   g29(.a(new_n70_), .b(new_n49_), .O(new_n79_));
  ...
  nor2   g38(.a(x21), .b(x20), .O(new_n89_));
  nand2  g39(.a(new_n89_), .b(new_n70_), .O(new_n90_));
  nor2   g40(.a(x22), .b(x21), .O(new_n91_));
  aoi22  g41(.a(new_n91_), .b(new_n80_), .c(new_n90_), .d(x22), .O(new_n92_));
  oai21  g42(.a(new_n92_), .b(new_n84_), .c(new_n88_), .O(z12));
  nand2  g43(.a(x18), .b(x04), .O(new_n94_));
  oai21  g44(.a(x18), .b(new_n56_), .c(new_n94_), .O(new_n95_));
  nand2  g45(.a(new_n95_), .b(new_n84_), .O(new_n96_));
  nand3  g46(.a(new_n91_), .b(new_n70_), .c(new_n49_), .O(new_n97_));
  nor3   g47(.a(x23), .b(x22), .c(x21), .O(new_n98_));
  aoi22  g48(.a(new_n98_), .b(new_n80_), .c(new_n97_), .d(x23), .O(new_n99_));
  oai21  g49(.a(new_n99_), .b(new_n84_), .c(new_n96_), .O(z13));
  nand2  g50(.a(x18), .b(x06), .O(new_n102_));
  oai21  g51(.a(x18), .b(new_n62_), .c(new_n102_), .O(new_n103_));
  nand2  g52(.a(new_n103_), .b(new_n84_), .O(new_n104_));
  nor2   g53(.a(x24), .b(x23), .O(new_n105_));
  nand4  g54(.a(new_n105_), .b(new_n91_), .c(new_n70_), .d(new_n49_), .O(new_n106_));
  ...
  oai21  g63(.a(x18), .b(new_n65_), .c(new_n114_), .O(new_n115_));
  nand2  g64(.a(new_n115_), .b(new_n84_), .O(new_n116_));
  nand2  g65(.a(new_n110_), .b(x26), .O(new_n117_));
  nor3   g66(.a(x26), .b(x25), .c(x24), .O(new_n118_));
  nand4  g67(.a(new_n118_), .b(new_n108_), .c(new_n89_), .d(new_n70_), .O(new_n119_));
