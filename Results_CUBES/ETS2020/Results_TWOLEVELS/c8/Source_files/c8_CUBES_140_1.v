// Benchmark "FAU" written by ABC on Mon Jul  6 18:50:46 2020
...
module FAU ( 
  ...
  inv1   g38(.a(x16), .O(new_n87_));
  nand2  g39(.a(x18), .b(x03), .O(new_n88_));
  oai21  g40(.a(x18), .b(new_n57_), .c(new_n88_), .O(new_n89_));
  nand2  g41(.a(new_n89_), .b(new_n87_), .O(new_n90_));
  nor2   g42(.a(x21), .b(x20), .O(new_n91_));
  nand2  g43(.a(new_n91_), .b(new_n74_), .O(new_n92_));
  nor2   g44(.a(x22), .b(x21), .O(new_n93_));
  aoi22  g45(.a(new_n93_), .b(new_n83_), .c(new_n92_), .d(x22), .O(new_n94_));
  oai21  g46(.a(new_n94_), .b(new_n87_), .c(new_n90_), .O(z12));
  nand2  g47(.a(x18), .b(x04), .O(new_n96_));
  oai21  g48(.a(x18), .b(new_n60_), .c(new_n96_), .O(new_n97_));
  nand2  g49(.a(new_n97_), .b(new_n87_), .O(new_n98_));
  nand3  g50(.a(new_n93_), .b(new_n74_), .c(new_n51_), .O(new_n99_));
  nor3   g51(.a(x23), .b(x22), .c(x21), .O(new_n100_));
  aoi22  g52(.a(new_n100_), .b(new_n83_), .c(new_n99_), .d(x23), .O(new_n101_));
  oai21  g53(.a(new_n101_), .b(new_n87_), .c(new_n98_), .O(z13));
  inv1   g54(.a(x13), .O(new_n103_));
  nand2  g55(.a(x18), .b(x05), .O(new_n104_));
  oai21  g56(.a(x18), .b(new_n103_), .c(new_n104_), .O(new_n105_));
  nand2  g57(.a(new_n105_), .b(new_n87_), .O(new_n106_));
  aoi21  g58(.a(new_n100_), .b(new_n83_), .c(new_n63_), .O(new_n107_));
  nor2   g59(.a(x24), .b(x23), .O(new_n108_));
  nand4  g60(.a(new_n108_), .b(new_n93_), .c(new_n74_), .d(new_n51_), .O(new_n109_));
  ...
  oai21  g65(.a(x18), .b(new_n66_), .c(new_n113_), .O(new_n114_));
  nand2  g66(.a(new_n114_), .b(new_n87_), .O(new_n115_));
  nand2  g67(.a(new_n109_), .b(x25), .O(new_n116_));
  nor2   g68(.a(x23), .b(x22), .O(new_n117_));
  nor2   g69(.a(x25), .b(x24), .O(new_n118_));
  nand4  g70(.a(new_n118_), .b(new_n117_), .c(new_n91_), .d(new_n74_), .O(new_n119_));
  ...
  oai21  g75(.a(x18), .b(new_n69_), .c(new_n123_), .O(new_n124_));
  nand2  g76(.a(new_n124_), .b(new_n87_), .O(new_n125_));
  nand2  g77(.a(new_n119_), .b(x26), .O(new_n126_));
  nor3   g78(.a(x26), .b(x25), .c(x24), .O(new_n127_));
  nand4  g79(.a(new_n127_), .b(new_n117_), .c(new_n91_), .d(new_n74_), .O(new_n128_));
