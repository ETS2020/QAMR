...
module FAU ( 
  ...
  nand2  g62(.a(new_n110_), .b(new_n87_), .O(new_n111_));
  nor2   g63(.a(x24), .b(x23), .O(new_n112_));
  nand4  g64(.a(new_n112_), .b(new_n102_), .c(new_n74_), .d(new_n51_), .O(new_n113_));
  nand4  g65(.a(new_n66_), .b(new_n63_), .c(new_n60_), .d(new_n57_), .O(new_n114_));
  inv1   g66(.a(new_n114_), .O(new_n115_));
  aoi22  g67(.a(new_n115_), .b(new_n94_), .c(new_n113_), .d(x25), .O(new_n116_));
  oai21  g68(.a(new_n116_), .b(new_n87_), .c(new_n111_), .O(z15));
  ...
  aoi21  g75(.a(new_n124_), .b(new_n123_), .c(new_n87_), .O(z17));
  zero   g76(.O(z12));
  zero   g77(.O(z14));
  zero   g78(.O(z16));
  buf    g79(.a(x27), .O(z08));
