...
module FAU ( 
  ...
  nand2  g30(.a(x18), .b(x01), .O(new_n78_));
  oai21  g31(.a(x18), .b(new_n77_), .c(new_n78_), .O(new_n79_));
  nand2  g32(.a(new_n79_), .b(new_n76_), .O(new_n80_));
  xor2a  g33(.a(new_n71_), .b(new_n51_), .O(new_n81_));
  oai21  g34(.a(new_n81_), .b(new_n76_), .c(new_n80_), .O(z10));
  nand2  g35(.a(x18), .b(x02), .O(new_n83_));
  oai21  g36(.a(x18), .b(new_n54_), .c(new_n83_), .O(new_n84_));
  nand2  g37(.a(new_n84_), .b(new_n76_), .O(new_n85_));
  nand2  g38(.a(new_n71_), .b(new_n51_), .O(new_n86_));
  nor2   g39(.a(x21), .b(x20), .O(new_n87_));
  aoi22  g40(.a(new_n87_), .b(new_n71_), .c(new_n86_), .d(x21), .O(new_n88_));
  oai21  g41(.a(new_n88_), .b(new_n76_), .c(new_n85_), .O(z11));
  nand2  g42(.a(x18), .b(x06), .O(new_n93_));
  oai21  g43(.a(x18), .b(new_n64_), .c(new_n93_), .O(new_n94_));
  nand2  g44(.a(new_n94_), .b(new_n76_), .O(new_n95_));
  nor2   g45(.a(x22), .b(x21), .O(new_n96_));
  nor2   g46(.a(x24), .b(x23), .O(new_n97_));
  nand4  g47(.a(new_n97_), .b(new_n96_), .c(new_n71_), .d(new_n51_), .O(new_n98_));
  nand2  g48(.a(new_n98_), .b(x25), .O(new_n99_));
  nor2   g49(.a(x23), .b(x22), .O(new_n100_));
  nor2   g50(.a(x25), .b(x24), .O(new_n101_));
  nand4  g51(.a(new_n101_), .b(new_n100_), .c(new_n87_), .d(new_n71_), .O(new_n102_));
  nand2  g52(.a(new_n102_), .b(new_n99_), .O(new_n103_));
  nand2  g53(.a(new_n103_), .b(x16), .O(new_n104_));
  nand2  g54(.a(new_n104_), .b(new_n95_), .O(z15));
  nand2  g55(.a(x18), .b(x07), .O(new_n106_));
  oai21  g56(.a(x18), .b(new_n67_), .c(new_n106_), .O(new_n107_));
  nand2  g57(.a(new_n107_), .b(new_n76_), .O(new_n108_));
  nand2  g58(.a(new_n102_), .b(x26), .O(new_n109_));
  nor3   g59(.a(x26), .b(x25), .c(x24), .O(new_n110_));
  nand4  g60(.a(new_n110_), .b(new_n100_), .c(new_n87_), .d(new_n71_), .O(new_n111_));
  nand2  g61(.a(new_n111_), .b(new_n109_), .O(new_n112_));
  nand2  g62(.a(new_n112_), .b(x16), .O(new_n113_));
  nand2  g63(.a(new_n113_), .b(new_n108_), .O(z16));
  zero   g64(.O(z05));
  zero   g65(.O(z12));
  zero   g66(.O(z13));
  zero   g67(.O(z14));
