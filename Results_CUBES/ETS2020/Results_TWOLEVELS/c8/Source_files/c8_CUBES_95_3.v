...
module FAU ( 
  ...
  nand3  g53(.a(new_n95_), .b(new_n69_), .c(new_n78_), .O(new_n102_));
  nor3   g54(.a(x23), .b(x22), .c(x21), .O(new_n103_));
  aoi22  g55(.a(new_n103_), .b(new_n80_), .c(new_n102_), .d(x23), .O(new_n104_));
  oai21  g56(.a(new_n104_), .b(new_n83_), .c(new_n101_), .O(z13));
  inv1   g57(.a(x13), .O(new_n106_));
  nand2  g58(.a(x18), .b(x05), .O(new_n107_));
  oai21  g59(.a(x18), .b(new_n106_), .c(new_n107_), .O(new_n108_));
  nand2  g60(.a(new_n108_), .b(new_n83_), .O(new_n109_));
  aoi21  g61(.a(new_n103_), .b(new_n80_), .c(new_n59_), .O(new_n110_));
  nor2   g62(.a(x24), .b(x23), .O(new_n111_));
  nand4  g63(.a(new_n111_), .b(new_n95_), .c(new_n69_), .d(new_n78_), .O(new_n112_));
  ...
  oai21  g68(.a(x18), .b(new_n62_), .c(new_n116_), .O(new_n117_));
  nand2  g69(.a(new_n117_), .b(new_n83_), .O(new_n118_));
  nand2  g70(.a(new_n112_), .b(x25), .O(new_n119_));
  nor2   g71(.a(x23), .b(x22), .O(new_n120_));
  nor2   g72(.a(x25), .b(x24), .O(new_n121_));
  nand4  g73(.a(new_n121_), .b(new_n120_), .c(new_n88_), .d(new_n69_), .O(new_n122_));
  ...
  nand4  g82(.a(new_n130_), .b(new_n120_), .c(new_n88_), .d(new_n69_), .O(new_n131_));
  ...
  nand4  g87(.a(new_n135_), .b(new_n130_), .c(new_n120_), .d(new_n88_), .O(new_n136_));
