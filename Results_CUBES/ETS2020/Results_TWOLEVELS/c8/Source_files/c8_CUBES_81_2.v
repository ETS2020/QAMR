...
module FAU ( 
  ...
  nand2  g56(.a(new_n105_), .b(new_n83_), .O(new_n106_));
  aoi21  g57(.a(new_n100_), .b(new_n80_), .c(new_n63_), .O(new_n107_));
  nor2   g58(.a(x24), .b(x23), .O(new_n108_));
  nand4  g59(.a(new_n108_), .b(new_n98_), .c(new_n70_), .d(new_n51_), .O(new_n109_));
  ...
  nand2  g66(.a(new_n115_), .b(new_n83_), .O(new_n116_));
  ...
  aoi22  g70(.a(new_n119_), .b(new_n90_), .c(new_n109_), .d(x25), .O(new_n120_));
  oai21  g71(.a(new_n120_), .b(new_n83_), .c(new_n116_), .O(z15));
