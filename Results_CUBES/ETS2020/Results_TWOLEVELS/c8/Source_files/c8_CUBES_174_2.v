...
module FAU ( 
  ...
  nor2   g30(.a(new_n70_), .b(new_n79_), .O(new_n80_));
  nor3   g31(.a(x20), .b(x19), .c(x17), .O(new_n81_));
  oai21  g32(.a(new_n81_), .b(new_n80_), .c(x16), .O(new_n82_));
  oai21  g33(.a(new_n78_), .b(x16), .c(new_n82_), .O(z10));
  inv1   g34(.a(x16), .O(new_n84_));
  nand2  g35(.a(x18), .b(x02), .O(new_n85_));
  oai21  g36(.a(x18), .b(new_n52_), .c(new_n85_), .O(new_n86_));
  nand2  g37(.a(new_n86_), .b(new_n84_), .O(new_n87_));
  nand2  g38(.a(new_n70_), .b(new_n79_), .O(new_n88_));
  nor2   g39(.a(x21), .b(x20), .O(new_n89_));
  aoi22  g40(.a(new_n89_), .b(new_n70_), .c(new_n88_), .d(x21), .O(new_n90_));
  oai21  g41(.a(new_n90_), .b(new_n84_), .c(new_n87_), .O(z11));
  nand2  g42(.a(x18), .b(x04), .O(new_n93_));
  oai21  g43(.a(x18), .b(new_n58_), .c(new_n93_), .O(new_n94_));
  nand2  g44(.a(new_n94_), .b(new_n84_), .O(new_n95_));
  nor2   g45(.a(x22), .b(x21), .O(new_n96_));
  nand3  g46(.a(new_n96_), .b(new_n70_), .c(new_n79_), .O(new_n97_));
  nor3   g47(.a(x23), .b(x22), .c(x21), .O(new_n98_));
  aoi22  g48(.a(new_n98_), .b(new_n81_), .c(new_n97_), .d(x23), .O(new_n99_));
  oai21  g49(.a(new_n99_), .b(new_n84_), .c(new_n95_), .O(z13));
  nand2  g50(.a(x18), .b(x06), .O(new_n102_));
  oai21  g51(.a(x18), .b(new_n64_), .c(new_n102_), .O(new_n103_));
  nand2  g52(.a(new_n103_), .b(new_n84_), .O(new_n104_));
  nor2   g53(.a(x24), .b(x23), .O(new_n105_));
  nand4  g54(.a(new_n105_), .b(new_n96_), .c(new_n70_), .d(new_n79_), .O(new_n106_));
  nand2  g55(.a(new_n106_), .b(x25), .O(new_n107_));
  nor2   g56(.a(x23), .b(x22), .O(new_n108_));
  nor2   g57(.a(x25), .b(x24), .O(new_n109_));
  nand4  g58(.a(new_n109_), .b(new_n108_), .c(new_n89_), .d(new_n70_), .O(new_n110_));
  nand2  g59(.a(new_n110_), .b(new_n107_), .O(new_n111_));
  nand2  g60(.a(new_n111_), .b(x16), .O(new_n112_));
  nand2  g61(.a(new_n112_), .b(new_n104_), .O(z15));
  inv1   g62(.a(x15), .O(new_n114_));
  ...
  nand2  g66(.a(new_n110_), .b(x26), .O(new_n118_));
  nor3   g67(.a(x26), .b(x25), .c(x24), .O(new_n119_));
  nand4  g68(.a(new_n119_), .b(new_n108_), .c(new_n89_), .d(new_n70_), .O(new_n120_));
  nand2  g69(.a(new_n120_), .b(new_n118_), .O(new_n121_));
  nand2  g70(.a(new_n121_), .b(x16), .O(new_n122_));
  nand2  g71(.a(new_n122_), .b(new_n117_), .O(z16));
  nor2   g72(.a(new_n48_), .b(x17), .O(new_n124_));
  nand4  g73(.a(new_n124_), .b(new_n119_), .c(new_n108_), .d(new_n89_), .O(new_n125_));
  nand2  g74(.a(x27), .b(x17), .O(new_n126_));
  aoi21  g75(.a(new_n126_), .b(new_n125_), .c(new_n84_), .O(z17));
  zero   g76(.O(z01));
  zero   g77(.O(z07));
  zero   g78(.O(z08));
  zero   g79(.O(z12));
