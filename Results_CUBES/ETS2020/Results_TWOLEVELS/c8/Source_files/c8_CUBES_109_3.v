...
module FAU ( 
  ...
  aoi21  g54(.a(new_n96_), .b(new_n79_), .c(new_n103_), .O(new_n104_));
  nor2   g55(.a(x24), .b(x23), .O(new_n105_));
  nand4  g56(.a(new_n105_), .b(new_n94_), .c(new_n69_), .d(new_n51_), .O(new_n106_));
  ...
  nand2  g62(.a(new_n111_), .b(new_n82_), .O(new_n112_));
  nand2  g63(.a(new_n106_), .b(x25), .O(new_n113_));
  nor2   g64(.a(x23), .b(x22), .O(new_n114_));
  nor2   g65(.a(x25), .b(x24), .O(new_n115_));
  nand4  g66(.a(new_n115_), .b(new_n114_), .c(new_n87_), .d(new_n69_), .O(new_n116_));
  ...
  nand2  g73(.a(new_n122_), .b(new_n82_), .O(new_n123_));
  nand2  g74(.a(new_n116_), .b(x26), .O(new_n124_));
  nor3   g75(.a(x26), .b(x25), .c(x24), .O(new_n125_));
  nand4  g76(.a(new_n125_), .b(new_n114_), .c(new_n87_), .d(new_n69_), .O(new_n126_));
  ...
  nand4  g81(.a(new_n130_), .b(new_n125_), .c(new_n114_), .d(new_n87_), .O(new_n131_));
  nand2  g82(.a(x27), .b(x17), .O(new_n132_));
  aoi21  g83(.a(new_n132_), .b(new_n131_), .c(new_n82_), .O(z17));
  zero   g84(.O(z05));
  zero   g85(.O(z07));
  zero   g86(.O(z12));
  buf    g87(.a(x27), .O(z08));
