...
module FAU ( 
  ...
  aoi21  g43(.a(new_n94_), .b(new_n83_), .c(new_n61_), .O(new_n95_));
  nor2   g44(.a(x22), .b(x21), .O(new_n96_));
  nor2   g45(.a(x24), .b(x23), .O(new_n97_));
  nand4  g46(.a(new_n97_), .b(new_n96_), .c(new_n73_), .d(new_n51_), .O(new_n98_));
  ...
  nand2  g53(.a(new_n104_), .b(new_n89_), .O(new_n105_));
  nand4  g54(.a(new_n64_), .b(new_n61_), .c(new_n54_), .d(new_n51_), .O(new_n106_));
  inv1   g55(.a(new_n106_), .O(new_n107_));
  inv1   g56(.a(x23), .O(new_n108_));
  nand4  g57(.a(new_n108_), .b(new_n57_), .c(new_n48_), .d(new_n71_), .O(new_n109_));
  inv1   g58(.a(new_n109_), .O(new_n110_));
  aoi22  g59(.a(new_n110_), .b(new_n107_), .c(new_n98_), .d(x25), .O(new_n111_));
  oai21  g60(.a(new_n111_), .b(new_n89_), .c(new_n105_), .O(z15));
  zero   g61(.O(z04));
  zero   g62(.O(z08));
  zero   g63(.O(z11));
  zero   g64(.O(z12));
