...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n49_, new_n50_, new_n52_, new_n53_, new_n56_, new_n57_, new_n60_,
  ...
  nand2  g37(.a(new_n87_), .b(new_n78_), .O(new_n88_));
  nand2  g38(.a(new_n83_), .b(new_n64_), .O(new_n89_));
  nor2   g39(.a(x22), .b(x21), .O(new_n90_));
  aoi22  g40(.a(new_n90_), .b(new_n75_), .c(new_n89_), .d(x22), .O(new_n91_));
  oai21  g41(.a(new_n91_), .b(new_n78_), .c(new_n88_), .O(z12));
  inv1   g42(.a(x12), .O(new_n93_));
  nand2  g43(.a(x18), .b(x04), .O(new_n94_));
  oai21  g44(.a(x18), .b(new_n93_), .c(new_n94_), .O(new_n95_));
  nand2  g45(.a(new_n95_), .b(new_n78_), .O(new_n96_));
  nand3  g46(.a(new_n90_), .b(new_n64_), .c(new_n73_), .O(new_n97_));
  nor3   g47(.a(x23), .b(x22), .c(x21), .O(new_n98_));
  aoi22  g48(.a(new_n98_), .b(new_n75_), .c(new_n97_), .d(x23), .O(new_n99_));
  oai21  g49(.a(new_n99_), .b(new_n78_), .c(new_n96_), .O(z13));
  inv1   g50(.a(x14), .O(new_n102_));
  nand2  g51(.a(x18), .b(x06), .O(new_n103_));
  oai21  g52(.a(x18), .b(new_n102_), .c(new_n103_), .O(new_n104_));
  nand2  g53(.a(new_n104_), .b(new_n78_), .O(new_n105_));
  nor2   g54(.a(x24), .b(x23), .O(new_n106_));
  nand4  g55(.a(new_n106_), .b(new_n90_), .c(new_n64_), .d(new_n73_), .O(new_n107_));
  nand2  g56(.a(new_n107_), .b(x25), .O(new_n108_));
  nor2   g57(.a(x23), .b(x22), .O(new_n109_));
  nor2   g58(.a(x25), .b(x24), .O(new_n110_));
  nand4  g59(.a(new_n110_), .b(new_n109_), .c(new_n83_), .d(new_n64_), .O(new_n111_));
  nand2  g60(.a(new_n111_), .b(new_n108_), .O(new_n112_));
  nand2  g61(.a(new_n112_), .b(x16), .O(new_n113_));
  nand2  g62(.a(new_n113_), .b(new_n105_), .O(z15));
  nand2  g63(.a(x18), .b(x07), .O(new_n115_));
  oai21  g64(.a(x18), .b(new_n60_), .c(new_n115_), .O(new_n116_));
  nand2  g65(.a(new_n116_), .b(new_n78_), .O(new_n117_));
  nand2  g66(.a(new_n111_), .b(x26), .O(new_n118_));
  nor3   g67(.a(x26), .b(x25), .c(x24), .O(new_n119_));
  nand4  g68(.a(new_n119_), .b(new_n109_), .c(new_n83_), .d(new_n64_), .O(new_n120_));
  ...
  nand4  g74(.a(new_n125_), .b(new_n119_), .c(new_n109_), .d(new_n83_), .O(new_n126_));
  nand2  g75(.a(x27), .b(x17), .O(new_n127_));
  aoi21  g76(.a(new_n127_), .b(new_n126_), .c(new_n78_), .O(z17));
  zero   g77(.O(z00));
  zero   g78(.O(z01));
  zero   g79(.O(z04));
  zero   g80(.O(z06));
