...
module FAU ( 
  ...
  nand2  g57(.a(new_n105_), .b(new_n80_), .O(new_n106_));
  nor2   g58(.a(x24), .b(x23), .O(new_n107_));
  nand4  g59(.a(new_n107_), .b(new_n93_), .c(new_n73_), .d(new_n51_), .O(new_n108_));
  nand2  g60(.a(new_n108_), .b(x25), .O(new_n109_));
  nor2   g61(.a(x23), .b(x22), .O(new_n110_));
  nor2   g62(.a(x25), .b(x24), .O(new_n111_));
  nand4  g63(.a(new_n111_), .b(new_n110_), .c(new_n85_), .d(new_n73_), .O(new_n112_));
  ...
  nand2  g69(.a(new_n117_), .b(new_n80_), .O(new_n118_));
  nand2  g70(.a(new_n112_), .b(x26), .O(new_n119_));
  nor3   g71(.a(x26), .b(x25), .c(x24), .O(new_n120_));
  nand4  g72(.a(new_n120_), .b(new_n110_), .c(new_n85_), .d(new_n73_), .O(new_n121_));
  ...
  nand4  g77(.a(new_n125_), .b(new_n120_), .c(new_n110_), .d(new_n85_), .O(new_n126_));
  nand2  g78(.a(x27), .b(x17), .O(new_n127_));
  aoi21  g79(.a(new_n127_), .b(new_n126_), .c(new_n80_), .O(z17));
  zero   g80(.O(z10));
  zero   g81(.O(z14));
  buf    g82(.a(x27), .O(z08));
endmodule
