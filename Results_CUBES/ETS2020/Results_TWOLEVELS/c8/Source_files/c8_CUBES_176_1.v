...
module FAU ( 
  ...
  inv1   g32(.a(x17), .O(new_n83_));
  nand4  g33(.a(new_n54_), .b(new_n51_), .c(new_n48_), .d(new_n83_), .O(new_n84_));
  ...
  nand2  g40(.a(new_n92_), .b(new_n78_), .O(new_n93_));
  inv1   g41(.a(new_n84_), .O(new_n94_));
  nor2   g42(.a(x24), .b(x23), .O(new_n95_));
  nand4  g43(.a(new_n95_), .b(new_n85_), .c(new_n72_), .d(new_n51_), .O(new_n96_));
  inv1   g44(.a(x23), .O(new_n97_));
  nand4  g45(.a(new_n64_), .b(new_n61_), .c(new_n97_), .d(new_n57_), .O(new_n98_));
  inv1   g46(.a(new_n98_), .O(new_n99_));
  aoi22  g47(.a(new_n99_), .b(new_n94_), .c(new_n96_), .d(x25), .O(new_n100_));
  oai21  g48(.a(new_n100_), .b(new_n78_), .c(new_n93_), .O(z15));
  nor2   g49(.a(x21), .b(x20), .O(new_n103_));
  nor2   g50(.a(x23), .b(x22), .O(new_n104_));
  nor3   g51(.a(x26), .b(x25), .c(x24), .O(new_n105_));
  nor2   g52(.a(new_n48_), .b(x17), .O(new_n106_));
  nand4  g53(.a(new_n106_), .b(new_n105_), .c(new_n104_), .d(new_n103_), .O(new_n107_));
  nand2  g54(.a(x27), .b(x17), .O(new_n108_));
  aoi21  g55(.a(new_n108_), .b(new_n107_), .c(new_n78_), .O(z17));
  zero   g56(.O(z04));
  zero   g57(.O(z07));
  zero   g58(.O(z09));
  zero   g59(.O(z11));
