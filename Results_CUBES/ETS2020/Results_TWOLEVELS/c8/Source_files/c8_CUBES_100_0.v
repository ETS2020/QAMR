...
module FAU ( 
  ...
  nor2   g35(.a(x24), .b(x23), .O(new_n91_));
  nand4  g36(.a(new_n91_), .b(new_n79_), .c(new_n64_), .d(new_n49_), .O(new_n92_));
  inv1   g37(.a(new_n92_), .O(new_n93_));
  oai21  g38(.a(new_n93_), .b(new_n90_), .c(x16), .O(new_n94_));
  nand2  g39(.a(new_n94_), .b(new_n87_), .O(z14));
  inv1   g40(.a(x14), .O(new_n96_));
  nand2  g41(.a(x18), .b(x06), .O(new_n97_));
  oai21  g42(.a(x18), .b(new_n96_), .c(new_n97_), .O(new_n98_));
  nand2  g43(.a(new_n98_), .b(new_n72_), .O(new_n99_));
  nand2  g44(.a(new_n92_), .b(x25), .O(new_n100_));
  nor2   g45(.a(x23), .b(x22), .O(new_n101_));
  nor2   g46(.a(x25), .b(x24), .O(new_n102_));
  nand4  g47(.a(new_n102_), .b(new_n101_), .c(new_n77_), .d(new_n64_), .O(new_n103_));
  nand2  g48(.a(new_n103_), .b(new_n100_), .O(new_n104_));
  nand2  g49(.a(new_n104_), .b(x16), .O(new_n105_));
  nand2  g50(.a(new_n105_), .b(new_n99_), .O(z15));
  nand2  g51(.a(x18), .b(x07), .O(new_n107_));
  oai21  g52(.a(x18), .b(new_n59_), .c(new_n107_), .O(new_n108_));
  nand2  g53(.a(new_n108_), .b(new_n72_), .O(new_n109_));
  nand2  g54(.a(new_n103_), .b(x26), .O(new_n110_));
  nor3   g55(.a(x26), .b(x25), .c(x24), .O(new_n111_));
  nand4  g56(.a(new_n111_), .b(new_n101_), .c(new_n77_), .d(new_n64_), .O(new_n112_));
  nand2  g57(.a(new_n112_), .b(new_n110_), .O(new_n113_));
  nand2  g58(.a(new_n113_), .b(x16), .O(new_n114_));
  nand2  g59(.a(new_n114_), .b(new_n109_), .O(z16));
  zero   g60(.O(z00));
  zero   g61(.O(z02));
  zero   g62(.O(z03));
  zero   g63(.O(z05));
