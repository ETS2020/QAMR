...
module FAU ( 
  ...
  nand4  g62(.a(new_n113_), .b(new_n103_), .c(new_n90_), .d(new_n72_), .O(new_n114_));
  ...
  nand4  g67(.a(new_n118_), .b(new_n113_), .c(new_n103_), .d(new_n90_), .O(new_n119_));
  nand2  g68(.a(x27), .b(x17), .O(new_n120_));
  aoi21  g69(.a(new_n120_), .b(new_n119_), .c(new_n86_), .O(z17));
  zero   g70(.O(z05));
  zero   g71(.O(z08));
  zero   g72(.O(z11));
  zero   g73(.O(z13));
