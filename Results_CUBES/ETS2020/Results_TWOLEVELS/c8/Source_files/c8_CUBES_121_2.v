...
module FAU ( 
  ...
  inv1   g43(.a(x13), .O(new_n95_));
  nand2  g44(.a(x18), .b(x05), .O(new_n96_));
  oai21  g45(.a(x18), .b(new_n95_), .c(new_n96_), .O(new_n97_));
  nand2  g46(.a(new_n97_), .b(new_n83_), .O(new_n98_));
  nor3   g47(.a(x23), .b(x22), .c(x21), .O(new_n99_));
  aoi21  g48(.a(new_n99_), .b(new_n80_), .c(new_n59_), .O(new_n100_));
  nor2   g49(.a(x22), .b(x21), .O(new_n101_));
  nor2   g50(.a(x24), .b(x23), .O(new_n102_));
  nand4  g51(.a(new_n102_), .b(new_n101_), .c(new_n69_), .d(new_n78_), .O(new_n103_));
  inv1   g52(.a(new_n103_), .O(new_n104_));
  oai21  g53(.a(new_n104_), .b(new_n100_), .c(x16), .O(new_n105_));
  nand2  g54(.a(new_n105_), .b(new_n98_), .O(z14));
  inv1   g55(.a(x14), .O(new_n107_));
  nand2  g56(.a(x18), .b(x06), .O(new_n108_));
  oai21  g57(.a(x18), .b(new_n107_), .c(new_n108_), .O(new_n109_));
  nand2  g58(.a(new_n109_), .b(new_n83_), .O(new_n110_));
  nand4  g59(.a(new_n62_), .b(new_n59_), .c(new_n56_), .d(new_n53_), .O(new_n111_));
  inv1   g60(.a(new_n111_), .O(new_n112_));
  aoi22  g61(.a(new_n112_), .b(new_n90_), .c(new_n103_), .d(x25), .O(new_n113_));
  oai21  g62(.a(new_n113_), .b(new_n83_), .c(new_n110_), .O(z15));
