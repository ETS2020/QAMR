...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n47_, new_n48_, new_n51_, new_n52_, new_n55_, new_n56_, new_n60_,
  ...
  oai21  g28(.a(x18), .b(new_n51_), .c(new_n78_), .O(new_n79_));
  nand2  g29(.a(new_n79_), .b(new_n77_), .O(new_n80_));
  nand2  g30(.a(new_n64_), .b(new_n72_), .O(new_n81_));
  nor2   g31(.a(x21), .b(x20), .O(new_n82_));
  aoi22  g32(.a(new_n82_), .b(new_n64_), .c(new_n81_), .d(x21), .O(new_n83_));
  ...
  nand2  g38(.a(new_n82_), .b(new_n64_), .O(new_n89_));
  ...
  oai21  g43(.a(x18), .b(new_n55_), .c(new_n93_), .O(new_n94_));
  nand2  g44(.a(new_n94_), .b(new_n77_), .O(new_n95_));
  nand3  g45(.a(new_n90_), .b(new_n64_), .c(new_n72_), .O(new_n96_));
  nor3   g46(.a(x23), .b(x22), .c(x21), .O(new_n97_));
  aoi22  g47(.a(new_n97_), .b(new_n74_), .c(new_n96_), .d(x23), .O(new_n98_));
  oai21  g48(.a(new_n98_), .b(new_n77_), .c(new_n95_), .O(z13));
  ...
  aoi21  g54(.a(new_n97_), .b(new_n74_), .c(new_n104_), .O(new_n105_));
  nor2   g55(.a(x24), .b(x23), .O(new_n106_));
  nand2  g56(.a(new_n106_), .b(new_n90_), .O(new_n107_));
  nor2   g57(.a(new_n107_), .b(new_n81_), .O(new_n108_));
  ...
  nand4  g65(.a(new_n116_), .b(new_n115_), .c(new_n82_), .d(new_n64_), .O(new_n117_));
  nand2  g66(.a(new_n117_), .b(x26), .O(new_n118_));
  nor3   g67(.a(x26), .b(x25), .c(x24), .O(new_n119_));
  nand4  g68(.a(new_n119_), .b(new_n115_), .c(new_n82_), .d(new_n64_), .O(new_n120_));
