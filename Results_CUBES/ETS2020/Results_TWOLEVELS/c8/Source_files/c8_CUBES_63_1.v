...
module FAU ( 
  ...
  nand2  g51(.a(new_n92_), .b(new_n74_), .O(new_n99_));
  nor3   g52(.a(x22), .b(x21), .c(x20), .O(new_n100_));
  aoi22  g53(.a(new_n100_), .b(new_n74_), .c(new_n99_), .d(x22), .O(new_n101_));
  oai21  g54(.a(new_n101_), .b(new_n87_), .c(new_n98_), .O(z12));
  nand2  g55(.a(x18), .b(x04), .O(new_n103_));
  oai21  g56(.a(x18), .b(new_n60_), .c(new_n103_), .O(new_n104_));
  nand2  g57(.a(new_n104_), .b(new_n87_), .O(new_n105_));
  nand3  g58(.a(new_n92_), .b(new_n74_), .c(new_n57_), .O(new_n106_));
  nor3   g59(.a(x23), .b(x22), .c(x21), .O(new_n107_));
  aoi22  g60(.a(new_n107_), .b(new_n84_), .c(new_n106_), .d(x23), .O(new_n108_));
  oai21  g61(.a(new_n108_), .b(new_n87_), .c(new_n105_), .O(z13));
  nand2  g62(.a(x18), .b(x07), .O(new_n112_));
  oai21  g63(.a(x18), .b(new_n69_), .c(new_n112_), .O(new_n113_));
  nand2  g64(.a(new_n113_), .b(new_n87_), .O(new_n114_));
  nor2   g65(.a(x23), .b(x22), .O(new_n115_));
  nor2   g66(.a(x25), .b(x24), .O(new_n116_));
  nand4  g67(.a(new_n116_), .b(new_n115_), .c(new_n92_), .d(new_n74_), .O(new_n117_));
  nand2  g68(.a(new_n117_), .b(x26), .O(new_n118_));
  nor3   g69(.a(x26), .b(x25), .c(x24), .O(new_n119_));
  nand4  g70(.a(new_n119_), .b(new_n115_), .c(new_n92_), .d(new_n74_), .O(new_n120_));
  nand2  g71(.a(new_n120_), .b(new_n118_), .O(new_n121_));
  nand2  g72(.a(new_n121_), .b(x16), .O(new_n122_));
  nand2  g73(.a(new_n122_), .b(new_n114_), .O(z16));
  nor2   g74(.a(new_n48_), .b(x17), .O(new_n124_));
  nand4  g75(.a(new_n124_), .b(new_n119_), .c(new_n115_), .d(new_n92_), .O(new_n125_));
  nand2  g76(.a(x27), .b(x17), .O(new_n126_));
  aoi21  g77(.a(new_n126_), .b(new_n125_), .c(new_n87_), .O(z17));
  zero   g78(.O(z08));
  zero   g79(.O(z14));
  zero   g80(.O(z15));
endmodule
