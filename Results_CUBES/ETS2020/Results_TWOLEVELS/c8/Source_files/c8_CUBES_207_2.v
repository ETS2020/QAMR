...
module FAU ( 
  ...
  nand2  g55(.a(new_n105_), .b(new_n83_), .O(new_n106_));
  aoi21  g56(.a(new_n100_), .b(new_n80_), .c(new_n59_), .O(new_n107_));
  nor2   g57(.a(x24), .b(x23), .O(new_n108_));
  nand4  g58(.a(new_n108_), .b(new_n98_), .c(new_n69_), .d(new_n78_), .O(new_n109_));
  ...
  nand2  g65(.a(new_n115_), .b(new_n83_), .O(new_n116_));
  nand4  g66(.a(new_n62_), .b(new_n59_), .c(new_n56_), .d(new_n53_), .O(new_n117_));
  inv1   g67(.a(new_n117_), .O(new_n118_));
  aoi22  g68(.a(new_n118_), .b(new_n90_), .c(new_n109_), .d(x25), .O(new_n119_));
  oai21  g69(.a(new_n119_), .b(new_n83_), .c(new_n116_), .O(z15));
  nor2   g70(.a(x21), .b(x20), .O(new_n122_));
  nor2   g71(.a(x23), .b(x22), .O(new_n123_));
  nor3   g72(.a(x26), .b(x25), .c(x24), .O(new_n124_));
  nor2   g73(.a(new_n67_), .b(x17), .O(new_n125_));
