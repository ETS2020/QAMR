...
module FAU ( 
  ...
  nand2  g40(.a(new_n89_), .b(new_n78_), .O(new_n90_));
  nor3   g41(.a(x20), .b(x19), .c(x17), .O(new_n91_));
  nor2   g42(.a(x22), .b(x21), .O(new_n92_));
  nand3  g43(.a(new_n92_), .b(new_n71_), .c(new_n82_), .O(new_n93_));
  nor3   g44(.a(x23), .b(x22), .c(x21), .O(new_n94_));
  aoi22  g45(.a(new_n94_), .b(new_n91_), .c(new_n93_), .d(x23), .O(new_n95_));
  oai21  g46(.a(new_n95_), .b(new_n78_), .c(new_n90_), .O(z13));
  ...
  aoi21  g51(.a(new_n94_), .b(new_n91_), .c(new_n61_), .O(new_n101_));
  nor2   g52(.a(x24), .b(x23), .O(new_n102_));
  nand4  g53(.a(new_n102_), .b(new_n92_), .c(new_n71_), .d(new_n82_), .O(new_n103_));
  inv1   g54(.a(new_n103_), .O(new_n104_));
  oai21  g55(.a(new_n104_), .b(new_n101_), .c(x16), .O(new_n105_));
  nand2  g56(.a(new_n105_), .b(new_n100_), .O(z14));
  nand2  g57(.a(x18), .b(x06), .O(new_n107_));
  oai21  g58(.a(x18), .b(new_n64_), .c(new_n107_), .O(new_n108_));
  nand2  g59(.a(new_n108_), .b(new_n78_), .O(new_n109_));
  nand2  g60(.a(new_n103_), .b(x25), .O(new_n110_));
  nor2   g61(.a(x23), .b(x22), .O(new_n111_));
  nor2   g62(.a(x25), .b(x24), .O(new_n112_));
  nand4  g63(.a(new_n112_), .b(new_n111_), .c(new_n84_), .d(new_n71_), .O(new_n113_));
  nand2  g64(.a(new_n113_), .b(new_n110_), .O(new_n114_));
  nand2  g65(.a(new_n114_), .b(x16), .O(new_n115_));
  nand2  g66(.a(new_n115_), .b(new_n109_), .O(z15));
  nand2  g67(.a(x18), .b(x07), .O(new_n117_));
  oai21  g68(.a(x18), .b(new_n67_), .c(new_n117_), .O(new_n118_));
  nand2  g69(.a(new_n118_), .b(new_n78_), .O(new_n119_));
  nand2  g70(.a(new_n113_), .b(x26), .O(new_n120_));
  nor3   g71(.a(x26), .b(x25), .c(x24), .O(new_n121_));
  nand4  g72(.a(new_n121_), .b(new_n111_), .c(new_n84_), .d(new_n71_), .O(new_n122_));
  ...
  nand4  g77(.a(new_n126_), .b(new_n121_), .c(new_n111_), .d(new_n84_), .O(new_n127_));
  nand2  g78(.a(x27), .b(x17), .O(new_n128_));
  aoi21  g79(.a(new_n128_), .b(new_n127_), .c(new_n78_), .O(z17));
  zero   g80(.O(z01));
  zero   g81(.O(z10));
  zero   g82(.O(z12));
  buf    g83(.a(x27), .O(z08));
