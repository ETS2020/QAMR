...
module FAU ( 
  ...
  nand2  g54(.a(x18), .b(x06), .O(new_n103_));
  oai21  g55(.a(x18), .b(new_n66_), .c(new_n103_), .O(new_n104_));
  nand2  g56(.a(new_n104_), .b(new_n86_), .O(new_n105_));
  nor2   g57(.a(x24), .b(x23), .O(new_n106_));
  nand4  g58(.a(new_n106_), .b(new_n98_), .c(new_n73_), .d(new_n51_), .O(new_n107_));
  nand2  g59(.a(new_n107_), .b(x25), .O(new_n108_));
  nor2   g60(.a(x23), .b(x22), .O(new_n109_));
  nor2   g61(.a(x25), .b(x24), .O(new_n110_));
  nand4  g62(.a(new_n110_), .b(new_n109_), .c(new_n91_), .d(new_n73_), .O(new_n111_));
  nand2  g63(.a(new_n111_), .b(new_n108_), .O(new_n112_));
  nand2  g64(.a(new_n112_), .b(x16), .O(new_n113_));
  nand2  g65(.a(new_n113_), .b(new_n105_), .O(z15));
  nand2  g66(.a(x18), .b(x07), .O(new_n115_));
  oai21  g67(.a(x18), .b(new_n69_), .c(new_n115_), .O(new_n116_));
  nand2  g68(.a(new_n116_), .b(new_n86_), .O(new_n117_));
  nand2  g69(.a(new_n111_), .b(x26), .O(new_n118_));
  nor3   g70(.a(x26), .b(x25), .c(x24), .O(new_n119_));
  nand4  g71(.a(new_n119_), .b(new_n109_), .c(new_n91_), .d(new_n73_), .O(new_n120_));
  nand2  g72(.a(new_n120_), .b(new_n118_), .O(new_n121_));
  nand2  g73(.a(new_n121_), .b(x16), .O(new_n122_));
  nand2  g74(.a(new_n122_), .b(new_n117_), .O(z16));
  nor2   g75(.a(new_n48_), .b(x17), .O(new_n124_));
  nand4  g76(.a(new_n124_), .b(new_n119_), .c(new_n109_), .d(new_n91_), .O(new_n125_));
  nand2  g77(.a(x27), .b(x17), .O(new_n126_));
  aoi21  g78(.a(new_n126_), .b(new_n125_), .c(new_n86_), .O(z17));
  zero   g79(.O(z13));
  zero   g80(.O(z14));
  buf    g81(.a(x27), .O(z08));
endmodule
