...
module FAU ( 
  ...
  wire new_n47_, new_n48_, new_n50_, new_n51_, new_n52_, new_n54_, new_n55_,
    ...
    new_n68_, new_n71_, new_n72_, new_n73_, new_n74_, new_n75_, new_n78_,
  ...
  oai21  g30(.a(x18), .b(new_n54_), .c(new_n79_), .O(new_n80_));
  ...
  nand2  g39(.a(new_n90_), .b(new_n78_), .O(new_n91_));
  nor3   g40(.a(x20), .b(x19), .c(x17), .O(new_n92_));
  nor3   g41(.a(x23), .b(x22), .c(x21), .O(new_n93_));
  aoi21  g42(.a(new_n93_), .b(new_n92_), .c(new_n63_), .O(new_n94_));
  ...
  nand2  g48(.a(new_n99_), .b(new_n91_), .O(z14));
  ...
  nand4  g56(.a(new_n107_), .b(new_n106_), .c(new_n83_), .d(new_n72_), .O(new_n108_));
  nand2  g57(.a(new_n108_), .b(new_n105_), .O(new_n109_));
  nand2  g58(.a(new_n109_), .b(x16), .O(new_n110_));
  nand2  g59(.a(new_n110_), .b(new_n104_), .O(z15));
  nand2  g60(.a(x18), .b(x07), .O(new_n112_));
  oai21  g61(.a(x18), .b(new_n67_), .c(new_n112_), .O(new_n113_));
  nand2  g62(.a(new_n113_), .b(new_n78_), .O(new_n114_));
  nand2  g63(.a(new_n108_), .b(x26), .O(new_n115_));
  nor3   g64(.a(x26), .b(x25), .c(x24), .O(new_n116_));
  nand4  g65(.a(new_n116_), .b(new_n106_), .c(new_n83_), .d(new_n72_), .O(new_n117_));
