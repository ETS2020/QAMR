...
module FAU ( 
  ...
  nor2   g39(.a(new_n80_), .b(new_n54_), .O(new_n88_));
  ...
  nand2  g43(.a(new_n91_), .b(new_n87_), .O(z11));
  ...
  inv1   g59(.a(x14), .O(new_n109_));
  nand2  g60(.a(x18), .b(x06), .O(new_n110_));
  oai21  g61(.a(x18), .b(new_n109_), .c(new_n110_), .O(new_n111_));
  nand2  g62(.a(new_n111_), .b(new_n83_), .O(new_n112_));
  nor2   g63(.a(x24), .b(x23), .O(new_n113_));
  nand4  g64(.a(new_n113_), .b(new_n97_), .c(new_n70_), .d(new_n51_), .O(new_n114_));
  inv1   g65(.a(x25), .O(new_n115_));
  nand4  g66(.a(new_n115_), .b(new_n63_), .c(new_n60_), .d(new_n57_), .O(new_n116_));
  inv1   g67(.a(new_n116_), .O(new_n117_));
  aoi22  g68(.a(new_n117_), .b(new_n90_), .c(new_n114_), .d(x25), .O(new_n118_));
  oai21  g69(.a(new_n118_), .b(new_n83_), .c(new_n112_), .O(z15));
  ...
  nand4  g74(.a(new_n124_), .b(new_n123_), .c(new_n122_), .d(new_n121_), .O(new_n125_));
  nand2  g75(.a(x27), .b(x17), .O(new_n126_));
  aoi21  g76(.a(new_n126_), .b(new_n125_), .c(new_n83_), .O(z17));
  zero   g77(.O(z06));
  zero   g78(.O(z07));
  zero   g79(.O(z14));
  zero   g80(.O(z16));
