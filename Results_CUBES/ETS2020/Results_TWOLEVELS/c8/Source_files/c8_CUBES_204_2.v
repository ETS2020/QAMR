...
module FAU ( 
  ...
  nand3  g50(.a(new_n99_), .b(new_n70_), .c(new_n79_), .O(new_n100_));
  ...
  nand4  g60(.a(new_n109_), .b(new_n99_), .c(new_n70_), .d(new_n79_), .O(new_n110_));
  ...
  inv1   g68(.a(x22), .O(new_n118_));
  nand4  g69(.a(new_n62_), .b(new_n59_), .c(new_n56_), .d(new_n118_), .O(new_n119_));
