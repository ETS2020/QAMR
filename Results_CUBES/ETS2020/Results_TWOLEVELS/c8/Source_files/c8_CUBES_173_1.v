...
module FAU ( 
  ...
  nor2   g40(.a(new_n81_), .b(new_n89_), .O(new_n90_));
  nand4  g41(.a(new_n89_), .b(new_n51_), .c(new_n48_), .d(new_n69_), .O(new_n91_));
  inv1   g42(.a(new_n91_), .O(new_n92_));
  oai21  g43(.a(new_n92_), .b(new_n90_), .c(x16), .O(new_n93_));
  nand2  g44(.a(new_n93_), .b(new_n88_), .O(z11));
  ...
  nand4  g57(.a(new_n108_), .b(new_n99_), .c(new_n71_), .d(new_n51_), .O(new_n109_));
  nand4  g58(.a(new_n64_), .b(new_n61_), .c(new_n58_), .d(new_n55_), .O(new_n110_));
  inv1   g59(.a(new_n110_), .O(new_n111_));
  aoi22  g60(.a(new_n111_), .b(new_n92_), .c(new_n109_), .d(x25), .O(new_n112_));
  oai21  g61(.a(new_n112_), .b(new_n84_), .c(new_n107_), .O(z15));
