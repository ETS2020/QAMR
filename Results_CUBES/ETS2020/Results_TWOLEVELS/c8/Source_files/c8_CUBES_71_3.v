...
module FAU ( 
  ...
  oai21  g27(.a(x18), .b(new_n52_), .c(new_n77_), .O(new_n78_));
  nand2  g28(.a(new_n78_), .b(new_n76_), .O(new_n79_));
  nand2  g29(.a(new_n71_), .b(new_n70_), .O(new_n80_));
  nor2   g30(.a(x21), .b(x20), .O(new_n81_));
  aoi22  g31(.a(new_n81_), .b(new_n71_), .c(new_n80_), .d(x21), .O(new_n82_));
  oai21  g32(.a(new_n82_), .b(new_n76_), .c(new_n79_), .O(z11));
  ...
  nand2  g37(.a(new_n81_), .b(new_n71_), .O(new_n88_));
  nor2   g38(.a(x22), .b(x21), .O(new_n89_));
  aoi22  g39(.a(new_n89_), .b(new_n73_), .c(new_n88_), .d(x22), .O(new_n90_));
  oai21  g40(.a(new_n90_), .b(new_n76_), .c(new_n87_), .O(z12));
  nand2  g41(.a(x18), .b(x04), .O(new_n92_));
  oai21  g42(.a(x18), .b(new_n56_), .c(new_n92_), .O(new_n93_));
  nand2  g43(.a(new_n93_), .b(new_n76_), .O(new_n94_));
  nand3  g44(.a(new_n89_), .b(new_n71_), .c(new_n70_), .O(new_n95_));
  nor3   g45(.a(x23), .b(x22), .c(x21), .O(new_n96_));
  aoi22  g46(.a(new_n96_), .b(new_n73_), .c(new_n95_), .d(x23), .O(new_n97_));
  oai21  g47(.a(new_n97_), .b(new_n76_), .c(new_n94_), .O(z13));
  inv1   g48(.a(x13), .O(new_n99_));
  nand2  g49(.a(x18), .b(x05), .O(new_n100_));
  oai21  g50(.a(x18), .b(new_n99_), .c(new_n100_), .O(new_n101_));
  nand2  g51(.a(new_n101_), .b(new_n76_), .O(new_n102_));
  aoi21  g52(.a(new_n96_), .b(new_n73_), .c(new_n59_), .O(new_n103_));
  nor2   g53(.a(x24), .b(x23), .O(new_n104_));
  nand4  g54(.a(new_n104_), .b(new_n89_), .c(new_n71_), .d(new_n70_), .O(new_n105_));
  ...
  nand2  g60(.a(new_n110_), .b(new_n76_), .O(new_n111_));
  nand2  g61(.a(new_n105_), .b(x25), .O(new_n112_));
  nor2   g62(.a(x23), .b(x22), .O(new_n113_));
  nor2   g63(.a(x25), .b(x24), .O(new_n114_));
  nand4  g64(.a(new_n114_), .b(new_n113_), .c(new_n81_), .d(new_n71_), .O(new_n115_));
  ...
  nand2  g71(.a(new_n121_), .b(new_n76_), .O(new_n122_));
  nand2  g72(.a(new_n115_), .b(x26), .O(new_n123_));
  nor3   g73(.a(x26), .b(x25), .c(x24), .O(new_n124_));
  nand4  g74(.a(new_n124_), .b(new_n113_), .c(new_n81_), .d(new_n71_), .O(new_n125_));
  ...
  nand4  g79(.a(new_n129_), .b(new_n124_), .c(new_n113_), .d(new_n81_), .O(new_n130_));
  nand2  g80(.a(x27), .b(x17), .O(new_n131_));
  aoi21  g81(.a(new_n131_), .b(new_n130_), .c(new_n76_), .O(z17));
  zero   g82(.O(z01));
  zero   g83(.O(z03));
  zero   g84(.O(z07));
  zero   g85(.O(z09));
