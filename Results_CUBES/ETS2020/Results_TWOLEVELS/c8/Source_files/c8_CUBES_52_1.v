...
module FAU ( 
  ...
  inv1   g40(.a(x16), .O(new_n90_));
  inv1   g41(.a(x12), .O(new_n91_));
  nand2  g42(.a(x18), .b(x04), .O(new_n92_));
  oai21  g43(.a(x18), .b(new_n91_), .c(new_n92_), .O(new_n93_));
  nand2  g44(.a(new_n93_), .b(new_n90_), .O(new_n94_));
  nor2   g45(.a(x22), .b(x21), .O(new_n95_));
  nand3  g46(.a(new_n95_), .b(new_n75_), .c(new_n51_), .O(new_n96_));
  nor3   g47(.a(x23), .b(x22), .c(x21), .O(new_n97_));
  aoi22  g48(.a(new_n97_), .b(new_n85_), .c(new_n96_), .d(x23), .O(new_n98_));
  oai21  g49(.a(new_n98_), .b(new_n90_), .c(new_n94_), .O(z13));
  inv1   g50(.a(x14), .O(new_n101_));
  nand2  g51(.a(x18), .b(x06), .O(new_n102_));
  oai21  g52(.a(x18), .b(new_n101_), .c(new_n102_), .O(new_n103_));
  nand2  g53(.a(new_n103_), .b(new_n90_), .O(new_n104_));
  nor2   g54(.a(x24), .b(x23), .O(new_n105_));
  nand4  g55(.a(new_n105_), .b(new_n95_), .c(new_n75_), .d(new_n51_), .O(new_n106_));
  nand4  g56(.a(new_n66_), .b(new_n63_), .c(new_n54_), .d(new_n51_), .O(new_n107_));
  inv1   g57(.a(new_n107_), .O(new_n108_));
  nand4  g58(.a(new_n60_), .b(new_n57_), .c(new_n48_), .d(new_n73_), .O(new_n109_));
  inv1   g59(.a(new_n109_), .O(new_n110_));
  aoi22  g60(.a(new_n110_), .b(new_n108_), .c(new_n106_), .d(x25), .O(new_n111_));
  oai21  g61(.a(new_n111_), .b(new_n90_), .c(new_n104_), .O(z15));
  zero   g62(.O(z08));
  zero   g63(.O(z11));
  zero   g64(.O(z12));
  zero   g65(.O(z14));
