...
module FAU ( 
  ...
  oai21  g42(.a(x18), .b(new_n58_), .c(new_n91_), .O(new_n92_));
  nand2  g43(.a(new_n92_), .b(new_n82_), .O(new_n93_));
  nor2   g44(.a(x22), .b(x21), .O(new_n94_));
  nand3  g45(.a(new_n94_), .b(new_n69_), .c(new_n51_), .O(new_n95_));
  nor3   g46(.a(x23), .b(x22), .c(x21), .O(new_n96_));
  aoi22  g47(.a(new_n96_), .b(new_n79_), .c(new_n95_), .d(x23), .O(new_n97_));
  oai21  g48(.a(new_n97_), .b(new_n82_), .c(new_n93_), .O(z13));
  nand2  g49(.a(x18), .b(x06), .O(new_n100_));
  oai21  g50(.a(x18), .b(new_n64_), .c(new_n100_), .O(new_n101_));
  nand2  g51(.a(new_n101_), .b(new_n82_), .O(new_n102_));
  nor2   g52(.a(x24), .b(x23), .O(new_n103_));
  nand4  g53(.a(new_n103_), .b(new_n94_), .c(new_n69_), .d(new_n51_), .O(new_n104_));
  nand2  g54(.a(new_n104_), .b(x25), .O(new_n105_));
  nor2   g55(.a(x23), .b(x22), .O(new_n106_));
  nor2   g56(.a(x25), .b(x24), .O(new_n107_));
  nand4  g57(.a(new_n107_), .b(new_n106_), .c(new_n87_), .d(new_n69_), .O(new_n108_));
  ...
  nand2  g64(.a(new_n114_), .b(new_n82_), .O(new_n115_));
  nand2  g65(.a(new_n108_), .b(x26), .O(new_n116_));
  nor3   g66(.a(x26), .b(x25), .c(x24), .O(new_n117_));
  nand4  g67(.a(new_n117_), .b(new_n106_), .c(new_n87_), .d(new_n69_), .O(new_n118_));
  ...
  nand4  g72(.a(new_n122_), .b(new_n117_), .c(new_n106_), .d(new_n87_), .O(new_n123_));
  nand2  g73(.a(x27), .b(x17), .O(new_n124_));
  aoi21  g74(.a(new_n124_), .b(new_n123_), .c(new_n82_), .O(z17));
  zero   g75(.O(z03));
  zero   g76(.O(z07));
  zero   g77(.O(z12));
  zero   g78(.O(z14));
