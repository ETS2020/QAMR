...
module FAU ( 
  ...
  aoi21  g36(.a(new_n85_), .b(new_n72_), .c(new_n57_), .O(new_n86_));
  nand3  g37(.a(new_n85_), .b(new_n72_), .c(new_n57_), .O(new_n87_));
  inv1   g38(.a(new_n87_), .O(new_n88_));
  oai21  g39(.a(new_n88_), .b(new_n86_), .c(x16), .O(new_n89_));
  nand2  g40(.a(new_n89_), .b(new_n84_), .O(z12));
  nand2  g41(.a(x18), .b(x04), .O(new_n91_));
  oai21  g42(.a(x18), .b(new_n60_), .c(new_n91_), .O(new_n92_));
  nand2  g43(.a(new_n92_), .b(new_n80_), .O(new_n93_));
  nand2  g44(.a(new_n87_), .b(x23), .O(new_n94_));
  nor2   g45(.a(x23), .b(x22), .O(new_n95_));
  nand3  g46(.a(new_n95_), .b(new_n85_), .c(new_n72_), .O(new_n96_));
  nand2  g47(.a(new_n96_), .b(new_n94_), .O(new_n97_));
  nand2  g48(.a(new_n97_), .b(x16), .O(new_n98_));
  nand2  g49(.a(new_n98_), .b(new_n93_), .O(z13));
  nor3   g50(.a(x26), .b(x25), .c(x24), .O(new_n103_));
  nor2   g51(.a(new_n48_), .b(x17), .O(new_n104_));
  nand4  g52(.a(new_n104_), .b(new_n103_), .c(new_n95_), .d(new_n85_), .O(new_n105_));
  nand2  g53(.a(x27), .b(x17), .O(new_n106_));
  aoi21  g54(.a(new_n106_), .b(new_n105_), .c(new_n80_), .O(z17));
  zero   g55(.O(z07));
  zero   g56(.O(z10));
  zero   g57(.O(z11));
  zero   g58(.O(z14));
