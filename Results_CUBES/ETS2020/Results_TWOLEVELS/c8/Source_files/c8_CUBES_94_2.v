...
module FAU ( 
  ...
  nand4  g33(.a(new_n52_), .b(new_n84_), .c(new_n48_), .d(new_n69_), .O(new_n85_));
  nor2   g34(.a(x22), .b(x21), .O(new_n86_));
  nor3   g35(.a(x20), .b(x19), .c(x17), .O(new_n87_));
  aoi22  g36(.a(new_n87_), .b(new_n86_), .c(new_n85_), .d(x22), .O(new_n88_));
  oai21  g37(.a(new_n88_), .b(new_n79_), .c(new_n83_), .O(z12));
  inv1   g38(.a(x12), .O(new_n90_));
  nand2  g39(.a(x18), .b(x04), .O(new_n91_));
  oai21  g40(.a(x18), .b(new_n90_), .c(new_n91_), .O(new_n92_));
  nand2  g41(.a(new_n92_), .b(new_n79_), .O(new_n93_));
  nand3  g42(.a(new_n86_), .b(new_n71_), .c(new_n84_), .O(new_n94_));
  nor3   g43(.a(x23), .b(x22), .c(x21), .O(new_n95_));
  aoi22  g44(.a(new_n95_), .b(new_n87_), .c(new_n94_), .d(x23), .O(new_n96_));
  oai21  g45(.a(new_n96_), .b(new_n79_), .c(new_n93_), .O(z13));
  inv1   g46(.a(x13), .O(new_n98_));
  nand2  g47(.a(x18), .b(x05), .O(new_n99_));
  oai21  g48(.a(x18), .b(new_n98_), .c(new_n99_), .O(new_n100_));
  nand2  g49(.a(new_n100_), .b(new_n79_), .O(new_n101_));
  aoi21  g50(.a(new_n95_), .b(new_n87_), .c(new_n61_), .O(new_n102_));
  nor2   g51(.a(x24), .b(x23), .O(new_n103_));
  nand4  g52(.a(new_n103_), .b(new_n86_), .c(new_n71_), .d(new_n84_), .O(new_n104_));
  inv1   g53(.a(new_n104_), .O(new_n105_));
  oai21  g54(.a(new_n105_), .b(new_n102_), .c(x16), .O(new_n106_));
  nand2  g55(.a(new_n106_), .b(new_n101_), .O(z14));
  inv1   g56(.a(x14), .O(new_n108_));
  nand2  g57(.a(x18), .b(x06), .O(new_n109_));
  oai21  g58(.a(x18), .b(new_n108_), .c(new_n109_), .O(new_n110_));
  nand2  g59(.a(new_n110_), .b(new_n79_), .O(new_n111_));
  inv1   g60(.a(new_n85_), .O(new_n112_));
  nand4  g61(.a(new_n64_), .b(new_n61_), .c(new_n58_), .d(new_n55_), .O(new_n113_));
  inv1   g62(.a(new_n113_), .O(new_n114_));
  aoi22  g63(.a(new_n114_), .b(new_n112_), .c(new_n104_), .d(x25), .O(new_n115_));
  oai21  g64(.a(new_n115_), .b(new_n79_), .c(new_n111_), .O(z15));
  nor2   g65(.a(x21), .b(x20), .O(new_n118_));
  nor2   g66(.a(x23), .b(x22), .O(new_n119_));
  nor3   g67(.a(x26), .b(x25), .c(x24), .O(new_n120_));
  nor2   g68(.a(new_n48_), .b(x17), .O(new_n121_));
  nand4  g69(.a(new_n121_), .b(new_n120_), .c(new_n119_), .d(new_n118_), .O(new_n122_));
  nand2  g70(.a(x27), .b(x17), .O(new_n123_));
  aoi21  g71(.a(new_n123_), .b(new_n122_), .c(new_n79_), .O(z17));
  zero   g72(.O(z01));
  zero   g73(.O(z07));
  zero   g74(.O(z08));
  zero   g75(.O(z10));
