...
module FAU ( 
  ...
  nand4  g57(.a(new_n64_), .b(new_n107_), .c(new_n60_), .d(new_n57_), .O(new_n108_));
  inv1   g58(.a(new_n108_), .O(new_n109_));
  aoi22  g59(.a(new_n109_), .b(new_n87_), .c(new_n106_), .d(x25), .O(new_n110_));
  oai21  g60(.a(new_n110_), .b(new_n79_), .c(new_n104_), .O(z15));
  ...
  aoi21  g67(.a(new_n118_), .b(new_n117_), .c(new_n79_), .O(z17));
  zero   g68(.O(z05));
  zero   g69(.O(z10));
  zero   g70(.O(z12));
  zero   g71(.O(z14));
