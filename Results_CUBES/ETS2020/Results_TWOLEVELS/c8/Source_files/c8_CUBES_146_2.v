...
module FAU ( 
  ...
  oai21  g41(.a(x18), .b(new_n58_), .c(new_n91_), .O(new_n92_));
  nand2  g42(.a(new_n92_), .b(new_n74_), .O(new_n93_));
  nand3  g43(.a(new_n88_), .b(new_n67_), .c(new_n78_), .O(new_n94_));
  ...
  nand2  g50(.a(new_n100_), .b(new_n74_), .O(new_n101_));
  aoi21  g51(.a(new_n95_), .b(new_n86_), .c(new_n61_), .O(new_n102_));
  nor2   g52(.a(x24), .b(x23), .O(new_n103_));
  nand4  g53(.a(new_n103_), .b(new_n88_), .c(new_n67_), .d(new_n78_), .O(new_n104_));
  ...
  nand2  g60(.a(new_n110_), .b(new_n74_), .O(new_n111_));
  nand2  g61(.a(new_n104_), .b(x25), .O(new_n112_));
  nor2   g62(.a(x23), .b(x22), .O(new_n113_));
  nor2   g63(.a(x25), .b(x24), .O(new_n114_));
  nand4  g64(.a(new_n114_), .b(new_n113_), .c(new_n80_), .d(new_n67_), .O(new_n115_));
  ...
  nand2  g71(.a(new_n121_), .b(new_n74_), .O(new_n122_));
  nand2  g72(.a(new_n115_), .b(x26), .O(new_n123_));
  nor3   g73(.a(x26), .b(x25), .c(x24), .O(new_n124_));
  nand4  g74(.a(new_n124_), .b(new_n113_), .c(new_n80_), .d(new_n67_), .O(new_n125_));
  ...
  nand4  g79(.a(new_n129_), .b(new_n124_), .c(new_n113_), .d(new_n80_), .O(new_n130_));
  nand2  g80(.a(x27), .b(x17), .O(new_n131_));
  aoi21  g81(.a(new_n131_), .b(new_n130_), .c(new_n74_), .O(z17));
  zero   g82(.O(z01));
  zero   g83(.O(z06));
  zero   g84(.O(z07));
  zero   g85(.O(z10));
