...
module FAU ( 
  ...
  nand2  g36(.a(new_n75_), .b(new_n74_), .O(new_n85_));
  inv1   g37(.a(x17), .O(new_n86_));
  nand4  g38(.a(new_n52_), .b(new_n74_), .c(new_n48_), .d(new_n86_), .O(new_n87_));
  inv1   g39(.a(new_n87_), .O(new_n88_));
  aoi21  g40(.a(new_n85_), .b(x21), .c(new_n88_), .O(new_n89_));
  oai21  g41(.a(new_n89_), .b(new_n80_), .c(new_n84_), .O(z11));
  inv1   g42(.a(x11), .O(new_n91_));
  nand2  g43(.a(x18), .b(x03), .O(new_n92_));
  oai21  g44(.a(x18), .b(new_n91_), .c(new_n92_), .O(new_n93_));
  nand2  g45(.a(new_n93_), .b(new_n80_), .O(new_n94_));
  nor2   g46(.a(x22), .b(x21), .O(new_n95_));
  aoi22  g47(.a(new_n95_), .b(new_n77_), .c(new_n87_), .d(x22), .O(new_n96_));
  oai21  g48(.a(new_n96_), .b(new_n80_), .c(new_n94_), .O(z12));
  ...
  nand3  g53(.a(new_n95_), .b(new_n75_), .c(new_n74_), .O(new_n102_));
  nor3   g54(.a(x23), .b(x22), .c(x21), .O(new_n103_));
  aoi22  g55(.a(new_n103_), .b(new_n77_), .c(new_n102_), .d(x23), .O(new_n104_));
  ...
  aoi21  g61(.a(new_n103_), .b(new_n77_), .c(new_n61_), .O(new_n110_));
  nor2   g62(.a(x24), .b(x23), .O(new_n111_));
  nand4  g63(.a(new_n111_), .b(new_n95_), .c(new_n75_), .d(new_n74_), .O(new_n112_));
  ...
  aoi22  g73(.a(new_n121_), .b(new_n88_), .c(new_n112_), .d(x25), .O(new_n122_));
