...
module FAU ( 
  ...
  aoi21  g52(.a(new_n101_), .b(new_n82_), .c(new_n63_), .O(new_n102_));
  nor2   g53(.a(x22), .b(x21), .O(new_n103_));
  nor2   g54(.a(x24), .b(x23), .O(new_n104_));
  nand4  g55(.a(new_n104_), .b(new_n103_), .c(new_n72_), .d(new_n51_), .O(new_n105_));
  ...
  nand2  g62(.a(new_n111_), .b(new_n85_), .O(new_n112_));
  nand4  g63(.a(new_n66_), .b(new_n63_), .c(new_n60_), .d(new_n57_), .O(new_n113_));
  inv1   g64(.a(new_n113_), .O(new_n114_));
  aoi22  g65(.a(new_n114_), .b(new_n92_), .c(new_n105_), .d(x25), .O(new_n115_));
  oai21  g66(.a(new_n115_), .b(new_n85_), .c(new_n112_), .O(z15));
  ...
  aoi21  g73(.a(new_n123_), .b(new_n122_), .c(new_n85_), .O(z17));
  zero   g74(.O(z07));
  zero   g75(.O(z12));
  zero   g76(.O(z13));
  zero   g77(.O(z16));
