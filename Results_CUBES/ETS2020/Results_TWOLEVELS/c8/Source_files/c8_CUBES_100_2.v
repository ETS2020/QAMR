...
module FAU ( 
  ...
  nand4  g52(.a(new_n73_), .b(new_n57_), .c(new_n54_), .d(new_n51_), .O(new_n100_));
  nor3   g53(.a(x23), .b(x22), .c(x21), .O(new_n101_));
  aoi22  g54(.a(new_n101_), .b(new_n83_), .c(new_n100_), .d(x23), .O(new_n102_));
  oai21  g55(.a(new_n102_), .b(new_n86_), .c(new_n99_), .O(z13));
  inv1   g56(.a(x13), .O(new_n104_));
  nand2  g57(.a(x18), .b(x05), .O(new_n105_));
  oai21  g58(.a(x18), .b(new_n104_), .c(new_n105_), .O(new_n106_));
  nand2  g59(.a(new_n106_), .b(new_n86_), .O(new_n107_));
  aoi21  g60(.a(new_n101_), .b(new_n83_), .c(new_n63_), .O(new_n108_));
  nand4  g61(.a(new_n63_), .b(new_n60_), .c(new_n57_), .d(new_n54_), .O(new_n109_));
  nor2   g62(.a(new_n109_), .b(new_n91_), .O(new_n110_));
  oai21  g63(.a(new_n110_), .b(new_n108_), .c(x16), .O(new_n111_));
  nand2  g64(.a(new_n111_), .b(new_n107_), .O(z14));
  nor2   g65(.a(x23), .b(x22), .O(new_n115_));
  nor3   g66(.a(x26), .b(x25), .c(x24), .O(new_n116_));
  nor2   g67(.a(new_n48_), .b(x17), .O(new_n117_));
  nand4  g68(.a(new_n117_), .b(new_n116_), .c(new_n115_), .d(new_n92_), .O(new_n118_));
  nand2  g69(.a(x27), .b(x17), .O(new_n119_));
  aoi21  g70(.a(new_n119_), .b(new_n118_), .c(new_n86_), .O(z17));
  zero   g71(.O(z12));
  zero   g72(.O(z15));
  zero   g73(.O(z16));
  buf    g74(.a(x27), .O(z08));
