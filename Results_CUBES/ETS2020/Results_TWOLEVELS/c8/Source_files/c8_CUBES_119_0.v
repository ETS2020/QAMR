...
module FAU ( 
  ...
  inv1   g18(.a(x16), .O(new_n73_));
  inv1   g19(.a(x11), .O(new_n74_));
  nand2  g20(.a(x18), .b(x03), .O(new_n75_));
  oai21  g21(.a(x18), .b(new_n74_), .c(new_n75_), .O(new_n76_));
  nand2  g22(.a(new_n76_), .b(new_n73_), .O(new_n77_));
  nor2   g23(.a(x21), .b(x20), .O(new_n78_));
  nand2  g24(.a(new_n78_), .b(new_n67_), .O(new_n79_));
  nor2   g25(.a(x22), .b(x21), .O(new_n80_));
  aoi22  g26(.a(new_n80_), .b(new_n69_), .c(new_n79_), .d(x22), .O(new_n81_));
  oai21  g27(.a(new_n81_), .b(new_n73_), .c(new_n77_), .O(z12));
  inv1   g28(.a(x12), .O(new_n83_));
  nand2  g29(.a(x18), .b(x04), .O(new_n84_));
  oai21  g30(.a(x18), .b(new_n83_), .c(new_n84_), .O(new_n85_));
  nand2  g31(.a(new_n85_), .b(new_n73_), .O(new_n86_));
  nand3  g32(.a(new_n80_), .b(new_n67_), .c(new_n49_), .O(new_n87_));
  nor3   g33(.a(x23), .b(x22), .c(x21), .O(new_n88_));
  aoi22  g34(.a(new_n88_), .b(new_n69_), .c(new_n87_), .d(x23), .O(new_n89_));
  oai21  g35(.a(new_n89_), .b(new_n73_), .c(new_n86_), .O(z13));
  ...
  aoi21  g41(.a(new_n88_), .b(new_n69_), .c(new_n95_), .O(new_n96_));
  nand2  g42(.a(new_n67_), .b(new_n49_), .O(new_n97_));
  nand3  g43(.a(new_n80_), .b(new_n95_), .c(new_n54_), .O(new_n98_));
  nor2   g44(.a(new_n98_), .b(new_n97_), .O(new_n99_));
  oai21  g45(.a(new_n99_), .b(new_n96_), .c(x16), .O(new_n100_));
  nand2  g46(.a(new_n100_), .b(new_n94_), .O(z14));
  nand2  g47(.a(x18), .b(x07), .O(new_n103_));
  oai21  g48(.a(x18), .b(new_n59_), .c(new_n103_), .O(new_n104_));
  nand2  g49(.a(new_n104_), .b(new_n73_), .O(new_n105_));
  nor2   g50(.a(x23), .b(x22), .O(new_n106_));
  nor2   g51(.a(x25), .b(x24), .O(new_n107_));
  nand4  g52(.a(new_n107_), .b(new_n106_), .c(new_n78_), .d(new_n67_), .O(new_n108_));
  nand2  g53(.a(new_n108_), .b(x26), .O(new_n109_));
  nor3   g54(.a(x26), .b(x25), .c(x24), .O(new_n110_));
  nand4  g55(.a(new_n110_), .b(new_n106_), .c(new_n78_), .d(new_n67_), .O(new_n111_));
  nand2  g56(.a(new_n111_), .b(new_n109_), .O(new_n112_));
  nand2  g57(.a(new_n112_), .b(x16), .O(new_n113_));
  nand2  g58(.a(new_n113_), .b(new_n105_), .O(z16));
  zero   g59(.O(z00));
  zero   g60(.O(z02));
  zero   g61(.O(z03));
  zero   g62(.O(z05));
