...
module FAU ( 
  ...
  nand2  g60(.a(new_n108_), .b(new_n87_), .O(new_n109_));
  nor2   g61(.a(x24), .b(x23), .O(new_n110_));
  nand4  g62(.a(new_n110_), .b(new_n101_), .c(new_n74_), .d(new_n51_), .O(new_n111_));
  nand4  g63(.a(new_n66_), .b(new_n63_), .c(new_n60_), .d(new_n57_), .O(new_n112_));
  inv1   g64(.a(new_n112_), .O(new_n113_));
  aoi22  g65(.a(new_n113_), .b(new_n94_), .c(new_n111_), .d(x25), .O(new_n114_));
  oai21  g66(.a(new_n114_), .b(new_n87_), .c(new_n109_), .O(z15));
  nor2   g67(.a(x21), .b(x20), .O(new_n117_));
  nor2   g68(.a(x23), .b(x22), .O(new_n118_));
  nor3   g69(.a(x26), .b(x25), .c(x24), .O(new_n119_));
  nor2   g70(.a(new_n48_), .b(x17), .O(new_n120_));
  nand4  g71(.a(new_n120_), .b(new_n119_), .c(new_n118_), .d(new_n117_), .O(new_n121_));
  nand2  g72(.a(x27), .b(x17), .O(new_n122_));
  aoi21  g73(.a(new_n122_), .b(new_n121_), .c(new_n87_), .O(z17));
  zero   g74(.O(z13));
  zero   g75(.O(z14));
  zero   g76(.O(z16));
  buf    g77(.a(x27), .O(z08));
