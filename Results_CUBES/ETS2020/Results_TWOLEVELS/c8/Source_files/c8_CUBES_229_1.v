...
module FAU ( 
  ...
  oai21  g34(.a(x18), .b(new_n54_), .c(new_n83_), .O(new_n84_));
  nand2  g35(.a(new_n84_), .b(new_n76_), .O(new_n85_));
  ...
  oai21  g39(.a(new_n88_), .b(new_n76_), .c(new_n85_), .O(z11));
  nand2  g40(.a(x18), .b(x06), .O(new_n93_));
  oai21  g41(.a(x18), .b(new_n62_), .c(new_n93_), .O(new_n94_));
  nand2  g42(.a(new_n94_), .b(new_n76_), .O(new_n95_));
  ...
  nand2  g55(.a(new_n107_), .b(new_n76_), .O(new_n108_));
  ...
  nand4  g63(.a(new_n115_), .b(new_n110_), .c(new_n100_), .d(new_n87_), .O(new_n116_));
  nand2  g64(.a(x27), .b(x17), .O(new_n117_));
  aoi21  g65(.a(new_n117_), .b(new_n116_), .c(new_n76_), .O(z17));
  zero   g66(.O(z03));
  zero   g67(.O(z04));
  zero   g68(.O(z08));
  zero   g69(.O(z12));
