...
module FAU ( 
  ...
  inv1   g15(.a(x08), .O(new_n66_));
  nor2   g16(.a(x18), .b(new_n66_), .O(new_n67_));
  aoi21  g17(.a(x18), .b(x00), .c(new_n67_), .O(new_n68_));
  oai21  g18(.a(new_n68_), .b(x16), .c(new_n65_), .O(z09));
  ...
  nor2   g23(.a(new_n64_), .b(new_n73_), .O(new_n74_));
  ...
  oai21  g29(.a(x18), .b(new_n49_), .c(new_n79_), .O(new_n80_));
  nand2  g30(.a(new_n80_), .b(new_n78_), .O(new_n81_));
  nand2  g31(.a(new_n64_), .b(new_n73_), .O(new_n82_));
  nor2   g32(.a(x21), .b(x20), .O(new_n83_));
  aoi22  g33(.a(new_n83_), .b(new_n64_), .c(new_n82_), .d(x21), .O(new_n84_));
  oai21  g34(.a(new_n84_), .b(new_n78_), .c(new_n81_), .O(z11));
  nand2  g35(.a(x18), .b(x04), .O(new_n87_));
  oai21  g36(.a(x18), .b(new_n55_), .c(new_n87_), .O(new_n88_));
  nand2  g37(.a(new_n88_), .b(new_n78_), .O(new_n89_));
  nor2   g38(.a(x22), .b(x21), .O(new_n90_));
  nand3  g39(.a(new_n90_), .b(new_n64_), .c(new_n73_), .O(new_n91_));
  nor3   g40(.a(x23), .b(x22), .c(x21), .O(new_n92_));
  aoi22  g41(.a(new_n92_), .b(new_n75_), .c(new_n91_), .d(x23), .O(new_n93_));
  oai21  g42(.a(new_n93_), .b(new_n78_), .c(new_n89_), .O(z13));
  nand2  g43(.a(x18), .b(x06), .O(new_n96_));
  oai21  g44(.a(x18), .b(new_n59_), .c(new_n96_), .O(new_n97_));
  nand2  g45(.a(new_n97_), .b(new_n78_), .O(new_n98_));
  nor2   g46(.a(x24), .b(x23), .O(new_n99_));
  nand4  g47(.a(new_n99_), .b(new_n90_), .c(new_n64_), .d(new_n73_), .O(new_n100_));
  nand2  g48(.a(new_n100_), .b(x25), .O(new_n101_));
  nor2   g49(.a(x23), .b(x22), .O(new_n102_));
  nor2   g50(.a(x25), .b(x24), .O(new_n103_));
  nand4  g51(.a(new_n103_), .b(new_n102_), .c(new_n83_), .d(new_n64_), .O(new_n104_));
  ...
  nand4  g61(.a(new_n113_), .b(new_n102_), .c(new_n83_), .d(new_n64_), .O(new_n114_));
  ...
  nand4  g67(.a(new_n119_), .b(new_n113_), .c(new_n102_), .d(new_n83_), .O(new_n120_));
