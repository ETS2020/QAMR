...
module FAU ( 
  ...
  aoi21  g50(.a(new_n100_), .b(new_n82_), .c(new_n63_), .O(new_n101_));
  ...
  inv1   g56(.a(x14), .O(new_n107_));
  nand2  g57(.a(x18), .b(x06), .O(new_n108_));
  oai21  g58(.a(x18), .b(new_n107_), .c(new_n108_), .O(new_n109_));
  nand2  g59(.a(new_n109_), .b(new_n86_), .O(new_n110_));
  nand2  g60(.a(new_n103_), .b(x25), .O(new_n111_));
  nor2   g61(.a(x23), .b(x22), .O(new_n112_));
  nor2   g62(.a(x25), .b(x24), .O(new_n113_));
  nand4  g63(.a(new_n113_), .b(new_n112_), .c(new_n90_), .d(new_n72_), .O(new_n114_));
  ...
  nand2  g69(.a(new_n119_), .b(new_n86_), .O(new_n120_));
  nand2  g70(.a(new_n114_), .b(x26), .O(new_n121_));
  nor3   g71(.a(x26), .b(x25), .c(x24), .O(new_n122_));
  nand4  g72(.a(new_n122_), .b(new_n112_), .c(new_n90_), .d(new_n72_), .O(new_n123_));
  ...
  nand4  g77(.a(new_n127_), .b(new_n122_), .c(new_n112_), .d(new_n90_), .O(new_n128_));
  nand2  g78(.a(x27), .b(x17), .O(new_n129_));
  aoi21  g79(.a(new_n129_), .b(new_n128_), .c(new_n86_), .O(z17));
  zero   g80(.O(z06));
  zero   g81(.O(z08));
  zero   g82(.O(z11));
  zero   g83(.O(z13));
