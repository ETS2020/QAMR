...
module FAU ( 
  ...
  nand2  g47(.a(x18), .b(x07), .O(new_n101_));
  oai21  g48(.a(x18), .b(new_n63_), .c(new_n101_), .O(new_n102_));
  nand2  g49(.a(new_n102_), .b(new_n69_), .O(new_n103_));
  nor2   g50(.a(x23), .b(x22), .O(new_n104_));
  nor2   g51(.a(x25), .b(x24), .O(new_n105_));
  nand4  g52(.a(new_n105_), .b(new_n104_), .c(new_n75_), .d(new_n74_), .O(new_n106_));
  nand2  g53(.a(new_n106_), .b(x26), .O(new_n107_));
  nor3   g54(.a(x26), .b(x25), .c(x24), .O(new_n108_));
  nand4  g55(.a(new_n108_), .b(new_n104_), .c(new_n75_), .d(new_n74_), .O(new_n109_));
  nand2  g56(.a(new_n109_), .b(new_n107_), .O(new_n110_));
  nand2  g57(.a(new_n110_), .b(x16), .O(new_n111_));
  nand2  g58(.a(new_n111_), .b(new_n103_), .O(z16));
  nor2   g59(.a(new_n48_), .b(x17), .O(new_n113_));
  nand4  g60(.a(new_n113_), .b(new_n108_), .c(new_n104_), .d(new_n75_), .O(new_n114_));
  nand2  g61(.a(x27), .b(x17), .O(new_n115_));
  aoi21  g62(.a(new_n115_), .b(new_n114_), .c(new_n69_), .O(z17));
  zero   g63(.O(z03));
  zero   g64(.O(z04));
  zero   g65(.O(z06));
  zero   g66(.O(z09));
