...
module FAU ( 
  ...
  aoi21  g38(.a(new_n90_), .b(new_n72_), .c(new_n57_), .O(new_n91_));
  nand2  g39(.a(new_n70_), .b(new_n49_), .O(new_n92_));
  nor2   g40(.a(x24), .b(x23), .O(new_n93_));
  nand2  g41(.a(new_n93_), .b(new_n82_), .O(new_n94_));
  nor2   g42(.a(new_n94_), .b(new_n92_), .O(new_n95_));
  oai21  g43(.a(new_n95_), .b(new_n91_), .c(x16), .O(new_n96_));
  nand2  g44(.a(new_n96_), .b(new_n89_), .O(z14));
  nand2  g45(.a(x18), .b(x07), .O(new_n99_));
  oai21  g46(.a(x18), .b(new_n63_), .c(new_n99_), .O(new_n100_));
  nand2  g47(.a(new_n100_), .b(new_n76_), .O(new_n101_));
  nor2   g48(.a(x23), .b(x22), .O(new_n102_));
  nor2   g49(.a(x25), .b(x24), .O(new_n103_));
  nand4  g50(.a(new_n103_), .b(new_n102_), .c(new_n80_), .d(new_n70_), .O(new_n104_));
  nand2  g51(.a(new_n104_), .b(x26), .O(new_n105_));
  nor3   g52(.a(x26), .b(x25), .c(x24), .O(new_n106_));
  nand4  g53(.a(new_n106_), .b(new_n102_), .c(new_n80_), .d(new_n70_), .O(new_n107_));
