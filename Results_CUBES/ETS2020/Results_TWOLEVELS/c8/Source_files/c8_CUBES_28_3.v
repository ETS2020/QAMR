...
module FAU ( 
  ...
  aoi21  g61(.a(new_n103_), .b(new_n80_), .c(new_n61_), .O(new_n110_));
  nand3  g62(.a(new_n95_), .b(new_n61_), .c(new_n58_), .O(new_n111_));
  nor2   g63(.a(new_n111_), .b(new_n87_), .O(new_n112_));
  oai21  g64(.a(new_n112_), .b(new_n110_), .c(x16), .O(new_n113_));
  nand2  g65(.a(new_n113_), .b(new_n109_), .O(z14));
  inv1   g66(.a(x15), .O(new_n116_));
  nand2  g67(.a(x18), .b(x07), .O(new_n117_));
  oai21  g68(.a(x18), .b(new_n116_), .c(new_n117_), .O(new_n118_));
  nand2  g69(.a(new_n118_), .b(new_n83_), .O(new_n119_));
  nor2   g70(.a(x23), .b(x22), .O(new_n120_));
  nor2   g71(.a(x25), .b(x24), .O(new_n121_));
  nand4  g72(.a(new_n121_), .b(new_n120_), .c(new_n88_), .d(new_n69_), .O(new_n122_));
  nand2  g73(.a(new_n122_), .b(x26), .O(new_n123_));
  nor3   g74(.a(x26), .b(x25), .c(x24), .O(new_n124_));
  nand4  g75(.a(new_n124_), .b(new_n120_), .c(new_n88_), .d(new_n69_), .O(new_n125_));
  nand2  g76(.a(new_n125_), .b(new_n123_), .O(new_n126_));
  nand2  g77(.a(new_n126_), .b(x16), .O(new_n127_));
  nand2  g78(.a(new_n127_), .b(new_n119_), .O(z16));
  nor2   g79(.a(new_n48_), .b(x17), .O(new_n129_));
  nand4  g80(.a(new_n129_), .b(new_n124_), .c(new_n120_), .d(new_n88_), .O(new_n130_));
  nand2  g81(.a(x27), .b(x17), .O(new_n131_));
  aoi21  g82(.a(new_n131_), .b(new_n130_), .c(new_n83_), .O(z17));
  zero   g83(.O(z01));
  zero   g84(.O(z07));
  zero   g85(.O(z15));
  buf    g86(.a(x27), .O(z08));
