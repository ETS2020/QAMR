...
module FAU ( 
  ...
  oai21  g45(.a(new_n91_), .b(new_n85_), .c(new_n88_), .O(z11));
  inv1   g46(.a(x13), .O(new_n95_));
  nand2  g47(.a(x18), .b(x05), .O(new_n96_));
  ...
  aoi21  g51(.a(new_n99_), .b(new_n82_), .c(new_n63_), .O(new_n100_));
  nor2   g52(.a(x22), .b(x21), .O(new_n101_));
  nor2   g53(.a(x24), .b(x23), .O(new_n102_));
  nand4  g54(.a(new_n102_), .b(new_n101_), .c(new_n73_), .d(new_n51_), .O(new_n103_));
  inv1   g55(.a(new_n103_), .O(new_n104_));
  oai21  g56(.a(new_n104_), .b(new_n100_), .c(x16), .O(new_n105_));
  nand2  g57(.a(new_n105_), .b(new_n98_), .O(z14));
  nand2  g58(.a(x18), .b(x06), .O(new_n107_));
  oai21  g59(.a(x18), .b(new_n66_), .c(new_n107_), .O(new_n108_));
  nand2  g60(.a(new_n108_), .b(new_n85_), .O(new_n109_));
  nand2  g61(.a(new_n103_), .b(x25), .O(new_n110_));
  nor2   g62(.a(x23), .b(x22), .O(new_n111_));
  nor2   g63(.a(x25), .b(x24), .O(new_n112_));
  nand4  g64(.a(new_n112_), .b(new_n111_), .c(new_n90_), .d(new_n73_), .O(new_n113_));
  nand2  g65(.a(new_n113_), .b(new_n110_), .O(new_n114_));
  nand2  g66(.a(new_n114_), .b(x16), .O(new_n115_));
  nand2  g67(.a(new_n115_), .b(new_n109_), .O(z15));
  nand2  g68(.a(x18), .b(x07), .O(new_n117_));
  oai21  g69(.a(x18), .b(new_n69_), .c(new_n117_), .O(new_n118_));
  nand2  g70(.a(new_n118_), .b(new_n85_), .O(new_n119_));
  nand2  g71(.a(new_n113_), .b(x26), .O(new_n120_));
  nor3   g72(.a(x26), .b(x25), .c(x24), .O(new_n121_));
  nand4  g73(.a(new_n121_), .b(new_n111_), .c(new_n90_), .d(new_n73_), .O(new_n122_));
  nand2  g74(.a(new_n122_), .b(new_n120_), .O(new_n123_));
  nand2  g75(.a(new_n123_), .b(x16), .O(new_n124_));
  nand2  g76(.a(new_n124_), .b(new_n119_), .O(z16));
  zero   g77(.O(z12));
  zero   g78(.O(z13));
  zero   g79(.O(z17));
  buf    g80(.a(x27), .O(z08));
