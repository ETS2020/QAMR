...
module FAU ( 
  ...
  nand2  g26(.a(new_n66_), .b(new_n51_), .O(new_n78_));
  inv1   g27(.a(x21), .O(new_n79_));
  nand4  g28(.a(new_n79_), .b(new_n51_), .c(new_n48_), .d(new_n64_), .O(new_n80_));
  ...
  nand3  g44(.a(new_n89_), .b(new_n66_), .c(new_n51_), .O(new_n96_));
  ...
  aoi21  g52(.a(new_n97_), .b(new_n88_), .c(new_n57_), .O(new_n104_));
  nor2   g53(.a(x24), .b(x23), .O(new_n105_));
  nand4  g54(.a(new_n105_), .b(new_n89_), .c(new_n66_), .d(new_n51_), .O(new_n106_));
  inv1   g55(.a(new_n106_), .O(new_n107_));
  oai21  g56(.a(new_n107_), .b(new_n104_), .c(x16), .O(new_n108_));
  nand2  g57(.a(new_n108_), .b(new_n103_), .O(z14));
  inv1   g58(.a(x14), .O(new_n110_));
  ...
  inv1   g62(.a(x22), .O(new_n114_));
  inv1   g63(.a(x23), .O(new_n115_));
  inv1   g64(.a(x25), .O(new_n116_));
  nand4  g65(.a(new_n116_), .b(new_n57_), .c(new_n115_), .d(new_n114_), .O(new_n117_));
  inv1   g66(.a(new_n117_), .O(new_n118_));
  aoi22  g67(.a(new_n118_), .b(new_n81_), .c(new_n106_), .d(x25), .O(new_n119_));
  oai21  g68(.a(new_n119_), .b(new_n73_), .c(new_n113_), .O(z15));
