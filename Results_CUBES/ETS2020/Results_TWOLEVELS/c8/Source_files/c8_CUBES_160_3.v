...
module FAU ( 
  ...
  nand2  g45(.a(new_n94_), .b(new_n82_), .O(new_n95_));
  nand4  g46(.a(new_n69_), .b(new_n55_), .c(new_n52_), .d(new_n49_), .O(new_n96_));
  nor3   g47(.a(x23), .b(x22), .c(x21), .O(new_n97_));
  aoi22  g48(.a(new_n97_), .b(new_n79_), .c(new_n96_), .d(x23), .O(new_n98_));
  oai21  g49(.a(new_n98_), .b(new_n82_), .c(new_n95_), .O(z13));
  inv1   g50(.a(x13), .O(new_n100_));
  nand2  g51(.a(x18), .b(x05), .O(new_n101_));
  oai21  g52(.a(x18), .b(new_n100_), .c(new_n101_), .O(new_n102_));
  nand2  g53(.a(new_n102_), .b(new_n82_), .O(new_n103_));
  aoi21  g54(.a(new_n97_), .b(new_n79_), .c(new_n61_), .O(new_n104_));
  nand4  g55(.a(new_n61_), .b(new_n58_), .c(new_n55_), .d(new_n52_), .O(new_n105_));
  nor2   g56(.a(new_n105_), .b(new_n87_), .O(new_n106_));
  oai21  g57(.a(new_n106_), .b(new_n104_), .c(x16), .O(new_n107_));
  nand2  g58(.a(new_n107_), .b(new_n103_), .O(z14));
  ...
  nand4  g64(.a(new_n114_), .b(new_n113_), .c(new_n88_), .d(new_n69_), .O(new_n115_));
  nand2  g65(.a(new_n115_), .b(x26), .O(new_n116_));
  nor3   g66(.a(x26), .b(x25), .c(x24), .O(new_n117_));
  nand4  g67(.a(new_n117_), .b(new_n113_), .c(new_n88_), .d(new_n69_), .O(new_n118_));
  ...
  inv1   g71(.a(x19), .O(new_n122_));
  nor2   g72(.a(new_n122_), .b(x17), .O(new_n123_));
  nand4  g73(.a(new_n123_), .b(new_n117_), .c(new_n113_), .d(new_n88_), .O(new_n124_));
  nand2  g74(.a(x27), .b(x17), .O(new_n125_));
  aoi21  g75(.a(new_n125_), .b(new_n124_), .c(new_n82_), .O(z17));
  zero   g76(.O(z00));
  zero   g77(.O(z06));
  zero   g78(.O(z12));
  zero   g79(.O(z15));
