...
module FAU ( 
  ...
  nand3  g51(.a(new_n99_), .b(new_n74_), .c(new_n51_), .O(new_n100_));
  ...
  nand4  g61(.a(new_n109_), .b(new_n99_), .c(new_n74_), .d(new_n51_), .O(new_n110_));
  ...
  nand2  g67(.a(new_n115_), .b(new_n87_), .O(new_n116_));
  ...
  nand2  g77(.a(new_n125_), .b(new_n87_), .O(new_n126_));
  ...
  aoi21  g87(.a(new_n135_), .b(new_n134_), .c(new_n87_), .O(z17));
  zero   g88(.O(z08));
  zero   g89(.O(z12));
endmodule
