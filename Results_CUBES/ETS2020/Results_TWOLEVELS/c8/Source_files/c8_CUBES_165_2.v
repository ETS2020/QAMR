...
module FAU ( 
  ...
  nand2  g38(.a(new_n70_), .b(new_n51_), .O(new_n88_));
  nor2   g39(.a(x21), .b(x20), .O(new_n89_));
  aoi22  g40(.a(new_n89_), .b(new_n70_), .c(new_n88_), .d(x21), .O(new_n90_));
  oai21  g41(.a(new_n90_), .b(new_n83_), .c(new_n87_), .O(z11));
  inv1   g42(.a(x12), .O(new_n93_));
  nand2  g43(.a(x18), .b(x04), .O(new_n94_));
  oai21  g44(.a(x18), .b(new_n93_), .c(new_n94_), .O(new_n95_));
  nand2  g45(.a(new_n95_), .b(new_n83_), .O(new_n96_));
  inv1   g46(.a(x22), .O(new_n97_));
  nand4  g47(.a(new_n70_), .b(new_n97_), .c(new_n54_), .d(new_n51_), .O(new_n98_));
  nor3   g48(.a(x23), .b(x22), .c(x21), .O(new_n99_));
  aoi22  g49(.a(new_n99_), .b(new_n80_), .c(new_n98_), .d(x23), .O(new_n100_));
  oai21  g50(.a(new_n100_), .b(new_n83_), .c(new_n96_), .O(z13));
  inv1   g51(.a(x13), .O(new_n102_));
  nand2  g52(.a(x18), .b(x05), .O(new_n103_));
  oai21  g53(.a(x18), .b(new_n102_), .c(new_n103_), .O(new_n104_));
  nand2  g54(.a(new_n104_), .b(new_n83_), .O(new_n105_));
  aoi21  g55(.a(new_n99_), .b(new_n80_), .c(new_n61_), .O(new_n106_));
  nand4  g56(.a(new_n61_), .b(new_n58_), .c(new_n97_), .d(new_n54_), .O(new_n107_));
  nor2   g57(.a(new_n107_), .b(new_n88_), .O(new_n108_));
  oai21  g58(.a(new_n108_), .b(new_n106_), .c(x16), .O(new_n109_));
  nand2  g59(.a(new_n109_), .b(new_n105_), .O(z14));
  inv1   g60(.a(x15), .O(new_n112_));
  nand2  g61(.a(x18), .b(x07), .O(new_n113_));
  oai21  g62(.a(x18), .b(new_n112_), .c(new_n113_), .O(new_n114_));
  nand2  g63(.a(new_n114_), .b(new_n83_), .O(new_n115_));
  nor2   g64(.a(x23), .b(x22), .O(new_n116_));
  nor2   g65(.a(x25), .b(x24), .O(new_n117_));
  nand4  g66(.a(new_n117_), .b(new_n116_), .c(new_n89_), .d(new_n70_), .O(new_n118_));
  nand2  g67(.a(new_n118_), .b(x26), .O(new_n119_));
  nor3   g68(.a(x26), .b(x25), .c(x24), .O(new_n120_));
  nand4  g69(.a(new_n120_), .b(new_n116_), .c(new_n89_), .d(new_n70_), .O(new_n121_));
  nand2  g70(.a(new_n121_), .b(new_n119_), .O(new_n122_));
  nand2  g71(.a(new_n122_), .b(x16), .O(new_n123_));
  nand2  g72(.a(new_n123_), .b(new_n115_), .O(z16));
  nor2   g73(.a(new_n48_), .b(x17), .O(new_n125_));
  nand4  g74(.a(new_n125_), .b(new_n120_), .c(new_n116_), .d(new_n89_), .O(new_n126_));
  nand2  g75(.a(x27), .b(x17), .O(new_n127_));
  aoi21  g76(.a(new_n127_), .b(new_n126_), .c(new_n83_), .O(z17));
  zero   g77(.O(z03));
  zero   g78(.O(z07));
  zero   g79(.O(z08));
  zero   g80(.O(z12));
