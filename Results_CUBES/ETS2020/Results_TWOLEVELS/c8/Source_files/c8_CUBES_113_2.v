...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n49_, new_n50_, new_n52_, new_n53_, new_n56_, new_n57_, new_n59_,
  ...
  inv1   g22(.a(x09), .O(new_n72_));
  nor2   g23(.a(x18), .b(new_n72_), .O(new_n73_));
  aoi21  g24(.a(x18), .b(x01), .c(new_n73_), .O(new_n74_));
  inv1   g25(.a(x20), .O(new_n75_));
  nor2   g26(.a(new_n66_), .b(new_n75_), .O(new_n76_));
  nor3   g27(.a(x20), .b(x19), .c(x17), .O(new_n77_));
  oai21  g28(.a(new_n77_), .b(new_n76_), .c(x16), .O(new_n78_));
  oai21  g29(.a(new_n74_), .b(x16), .c(new_n78_), .O(z10));
  inv1   g30(.a(x16), .O(new_n80_));
  nand2  g31(.a(x18), .b(x02), .O(new_n81_));
  oai21  g32(.a(x18), .b(new_n49_), .c(new_n81_), .O(new_n82_));
  nand2  g33(.a(new_n82_), .b(new_n80_), .O(new_n83_));
  nand2  g34(.a(new_n66_), .b(new_n75_), .O(new_n84_));
  nor2   g35(.a(x21), .b(x20), .O(new_n85_));
  aoi22  g36(.a(new_n85_), .b(new_n66_), .c(new_n84_), .d(x21), .O(new_n86_));
  oai21  g37(.a(new_n86_), .b(new_n80_), .c(new_n83_), .O(z11));
  nand2  g38(.a(x18), .b(x03), .O(new_n88_));
  oai21  g39(.a(x18), .b(new_n52_), .c(new_n88_), .O(new_n89_));
  nand2  g40(.a(new_n89_), .b(new_n80_), .O(new_n90_));
  nand2  g41(.a(new_n85_), .b(new_n66_), .O(new_n91_));
  nor2   g42(.a(x22), .b(x21), .O(new_n92_));
  aoi22  g43(.a(new_n92_), .b(new_n77_), .c(new_n91_), .d(x22), .O(new_n93_));
  oai21  g44(.a(new_n93_), .b(new_n80_), .c(new_n90_), .O(z12));
  inv1   g45(.a(x12), .O(new_n95_));
  nand2  g46(.a(x18), .b(x04), .O(new_n96_));
  oai21  g47(.a(x18), .b(new_n95_), .c(new_n96_), .O(new_n97_));
  nand2  g48(.a(new_n97_), .b(new_n80_), .O(new_n98_));
  nand3  g49(.a(new_n92_), .b(new_n66_), .c(new_n75_), .O(new_n99_));
  nor3   g50(.a(x23), .b(x22), .c(x21), .O(new_n100_));
  aoi22  g51(.a(new_n100_), .b(new_n77_), .c(new_n99_), .d(x23), .O(new_n101_));
  oai21  g52(.a(new_n101_), .b(new_n80_), .c(new_n98_), .O(z13));
  nand2  g53(.a(x18), .b(x06), .O(new_n104_));
  oai21  g54(.a(x18), .b(new_n59_), .c(new_n104_), .O(new_n105_));
  nand2  g55(.a(new_n105_), .b(new_n80_), .O(new_n106_));
  nor2   g56(.a(x24), .b(x23), .O(new_n107_));
  nand4  g57(.a(new_n107_), .b(new_n92_), .c(new_n66_), .d(new_n75_), .O(new_n108_));
  nand2  g58(.a(new_n108_), .b(x25), .O(new_n109_));
  nor2   g59(.a(x23), .b(x22), .O(new_n110_));
  nor2   g60(.a(x25), .b(x24), .O(new_n111_));
  nand4  g61(.a(new_n111_), .b(new_n110_), .c(new_n85_), .d(new_n66_), .O(new_n112_));
  nand2  g62(.a(new_n112_), .b(new_n109_), .O(new_n113_));
  nand2  g63(.a(new_n113_), .b(x16), .O(new_n114_));
  nand2  g64(.a(new_n114_), .b(new_n106_), .O(z15));
  nand2  g65(.a(x18), .b(x07), .O(new_n116_));
  oai21  g66(.a(x18), .b(new_n62_), .c(new_n116_), .O(new_n117_));
  nand2  g67(.a(new_n117_), .b(new_n80_), .O(new_n118_));
  nand2  g68(.a(new_n112_), .b(x26), .O(new_n119_));
  nor3   g69(.a(x26), .b(x25), .c(x24), .O(new_n120_));
  nand4  g70(.a(new_n120_), .b(new_n110_), .c(new_n85_), .d(new_n66_), .O(new_n121_));
  ...
  inv1   g74(.a(x19), .O(new_n125_));
  nor2   g75(.a(new_n125_), .b(x17), .O(new_n126_));
  nand4  g76(.a(new_n126_), .b(new_n120_), .c(new_n110_), .d(new_n85_), .O(new_n127_));
  nand2  g77(.a(x27), .b(x17), .O(new_n128_));
  aoi21  g78(.a(new_n128_), .b(new_n127_), .c(new_n80_), .O(z17));
  zero   g79(.O(z00));
  zero   g80(.O(z01));
  zero   g81(.O(z04));
  zero   g82(.O(z14));
