...
module FAU ( 
  ...
  nand2  g60(.a(new_n107_), .b(new_n87_), .O(new_n108_));
  nor3   g61(.a(x23), .b(x22), .c(x21), .O(new_n109_));
  aoi21  g62(.a(new_n109_), .b(new_n84_), .c(new_n63_), .O(new_n110_));
  nor2   g63(.a(x24), .b(x23), .O(new_n111_));
  nand4  g64(.a(new_n111_), .b(new_n101_), .c(new_n74_), .d(new_n51_), .O(new_n112_));
  inv1   g65(.a(new_n112_), .O(new_n113_));
  oai21  g66(.a(new_n113_), .b(new_n110_), .c(x16), .O(new_n114_));
  nand2  g67(.a(new_n114_), .b(new_n108_), .O(z14));
  inv1   g68(.a(x14), .O(new_n116_));
  nand2  g69(.a(x18), .b(x06), .O(new_n117_));
  oai21  g70(.a(x18), .b(new_n116_), .c(new_n117_), .O(new_n118_));
  nand2  g71(.a(new_n118_), .b(new_n87_), .O(new_n119_));
  nand4  g72(.a(new_n66_), .b(new_n63_), .c(new_n60_), .d(new_n57_), .O(new_n120_));
  inv1   g73(.a(new_n120_), .O(new_n121_));
  aoi22  g74(.a(new_n121_), .b(new_n94_), .c(new_n112_), .d(x25), .O(new_n122_));
  oai21  g75(.a(new_n122_), .b(new_n87_), .c(new_n119_), .O(z15));
  ...
  aoi21  g82(.a(new_n130_), .b(new_n129_), .c(new_n87_), .O(z17));
  zero   g83(.O(z13));
  zero   g84(.O(z16));
  buf    g85(.a(x27), .O(z08));
endmodule
