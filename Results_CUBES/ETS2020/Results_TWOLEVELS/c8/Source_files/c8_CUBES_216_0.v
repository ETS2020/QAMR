...
module FAU ( 
  ...
  inv1   g28(.a(x13), .O(new_n83_));
  nand2  g29(.a(x18), .b(x05), .O(new_n84_));
  oai21  g30(.a(x18), .b(new_n83_), .c(new_n84_), .O(new_n85_));
  nand2  g31(.a(new_n85_), .b(new_n72_), .O(new_n86_));
  nor3   g32(.a(x23), .b(x22), .c(x21), .O(new_n87_));
  aoi21  g33(.a(new_n87_), .b(new_n69_), .c(new_n55_), .O(new_n88_));
  nor2   g34(.a(x22), .b(x21), .O(new_n89_));
  nor2   g35(.a(x24), .b(x23), .O(new_n90_));
  nand2  g36(.a(new_n90_), .b(new_n89_), .O(new_n91_));
  nor2   g37(.a(new_n91_), .b(new_n77_), .O(new_n92_));
  oai21  g38(.a(new_n92_), .b(new_n88_), .c(x16), .O(new_n93_));
  nand2  g39(.a(new_n93_), .b(new_n86_), .O(z14));
  nand2  g40(.a(x18), .b(x07), .O(new_n96_));
  oai21  g41(.a(x18), .b(new_n59_), .c(new_n96_), .O(new_n97_));
  nand2  g42(.a(new_n97_), .b(new_n72_), .O(new_n98_));
  nor2   g43(.a(x23), .b(x22), .O(new_n99_));
  nor2   g44(.a(x25), .b(x24), .O(new_n100_));
  nand4  g45(.a(new_n100_), .b(new_n99_), .c(new_n78_), .d(new_n67_), .O(new_n101_));
  nand2  g46(.a(new_n101_), .b(x26), .O(new_n102_));
  nor3   g47(.a(x26), .b(x25), .c(x24), .O(new_n103_));
  nand4  g48(.a(new_n103_), .b(new_n99_), .c(new_n78_), .d(new_n67_), .O(new_n104_));
