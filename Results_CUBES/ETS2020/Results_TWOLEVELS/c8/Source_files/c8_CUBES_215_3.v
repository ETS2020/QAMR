...
module FAU ( 
  ...
  nand3  g52(.a(new_n94_), .b(new_n69_), .c(new_n49_), .O(new_n101_));
  nor3   g53(.a(x23), .b(x22), .c(x21), .O(new_n102_));
  aoi22  g54(.a(new_n102_), .b(new_n79_), .c(new_n101_), .d(x23), .O(new_n103_));
  oai21  g55(.a(new_n103_), .b(new_n82_), .c(new_n100_), .O(z13));
  nand2  g56(.a(x18), .b(x06), .O(new_n106_));
  oai21  g57(.a(x18), .b(new_n62_), .c(new_n106_), .O(new_n107_));
  nand2  g58(.a(new_n107_), .b(new_n82_), .O(new_n108_));
  nor2   g59(.a(x24), .b(x23), .O(new_n109_));
  nand4  g60(.a(new_n109_), .b(new_n94_), .c(new_n69_), .d(new_n49_), .O(new_n110_));
  nand2  g61(.a(new_n110_), .b(x25), .O(new_n111_));
  nor2   g62(.a(x23), .b(x22), .O(new_n112_));
  nor2   g63(.a(x25), .b(x24), .O(new_n113_));
  nand4  g64(.a(new_n113_), .b(new_n112_), .c(new_n87_), .d(new_n69_), .O(new_n114_));
  ...
  nand2  g68(.a(x18), .b(x07), .O(new_n118_));
  oai21  g69(.a(x18), .b(new_n65_), .c(new_n118_), .O(new_n119_));
  nand2  g70(.a(new_n119_), .b(new_n82_), .O(new_n120_));
  nand2  g71(.a(new_n114_), .b(x26), .O(new_n121_));
  nor3   g72(.a(x26), .b(x25), .c(x24), .O(new_n122_));
  nand4  g73(.a(new_n122_), .b(new_n112_), .c(new_n87_), .d(new_n69_), .O(new_n123_));
  nand2  g74(.a(new_n123_), .b(new_n121_), .O(new_n124_));
  nand2  g75(.a(new_n124_), .b(x16), .O(new_n125_));
  nand2  g76(.a(new_n125_), .b(new_n120_), .O(z16));
  inv1   g77(.a(x19), .O(new_n127_));
  nor2   g78(.a(new_n127_), .b(x17), .O(new_n128_));
  nand4  g79(.a(new_n128_), .b(new_n122_), .c(new_n112_), .d(new_n87_), .O(new_n129_));
