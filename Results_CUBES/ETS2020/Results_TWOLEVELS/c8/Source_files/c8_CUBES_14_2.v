...
module FAU ( 
  ...
  inv1   g37(.a(x16), .O(new_n86_));
  inv1   g38(.a(x11), .O(new_n87_));
  nand2  g39(.a(x18), .b(x03), .O(new_n88_));
  oai21  g40(.a(x18), .b(new_n87_), .c(new_n88_), .O(new_n89_));
  nand2  g41(.a(new_n89_), .b(new_n86_), .O(new_n90_));
  nand4  g42(.a(new_n54_), .b(new_n51_), .c(new_n48_), .d(new_n70_), .O(new_n91_));
  nor2   g43(.a(x22), .b(x21), .O(new_n92_));
  aoi22  g44(.a(new_n92_), .b(new_n82_), .c(new_n91_), .d(x22), .O(new_n93_));
  oai21  g45(.a(new_n93_), .b(new_n86_), .c(new_n90_), .O(z12));
  inv1   g46(.a(x12), .O(new_n95_));
  nand2  g47(.a(x18), .b(x04), .O(new_n96_));
  oai21  g48(.a(x18), .b(new_n95_), .c(new_n96_), .O(new_n97_));
  nand2  g49(.a(new_n97_), .b(new_n86_), .O(new_n98_));
  nand3  g50(.a(new_n92_), .b(new_n72_), .c(new_n51_), .O(new_n99_));
  nor3   g51(.a(x23), .b(x22), .c(x21), .O(new_n100_));
  aoi22  g52(.a(new_n100_), .b(new_n82_), .c(new_n99_), .d(x23), .O(new_n101_));
  oai21  g53(.a(new_n101_), .b(new_n86_), .c(new_n98_), .O(z13));
  inv1   g54(.a(x14), .O(new_n104_));
  nand2  g55(.a(x18), .b(x06), .O(new_n105_));
  oai21  g56(.a(x18), .b(new_n104_), .c(new_n105_), .O(new_n106_));
  nand2  g57(.a(new_n106_), .b(new_n86_), .O(new_n107_));
  inv1   g58(.a(new_n91_), .O(new_n108_));
  nor2   g59(.a(x24), .b(x23), .O(new_n109_));
  nand4  g60(.a(new_n109_), .b(new_n92_), .c(new_n72_), .d(new_n51_), .O(new_n110_));
  inv1   g61(.a(x25), .O(new_n111_));
  nand4  g62(.a(new_n111_), .b(new_n63_), .c(new_n60_), .d(new_n57_), .O(new_n112_));
  inv1   g63(.a(new_n112_), .O(new_n113_));
  aoi22  g64(.a(new_n113_), .b(new_n108_), .c(new_n110_), .d(x25), .O(new_n114_));
  oai21  g65(.a(new_n114_), .b(new_n86_), .c(new_n107_), .O(z15));
  nor2   g66(.a(x21), .b(x20), .O(new_n117_));
  nor2   g67(.a(x23), .b(x22), .O(new_n118_));
  nor3   g68(.a(x26), .b(x25), .c(x24), .O(new_n119_));
  nor2   g69(.a(new_n48_), .b(x17), .O(new_n120_));
  nand4  g70(.a(new_n120_), .b(new_n119_), .c(new_n118_), .d(new_n117_), .O(new_n121_));
  nand2  g71(.a(x27), .b(x17), .O(new_n122_));
  aoi21  g72(.a(new_n122_), .b(new_n121_), .c(new_n86_), .O(z17));
  zero   g73(.O(z06));
  zero   g74(.O(z11));
  zero   g75(.O(z14));
  zero   g76(.O(z16));
