...
module FAU ( 
  ...
  aoi21  g46(.a(new_n97_), .b(new_n80_), .c(new_n61_), .O(new_n98_));
  ...
  inv1   g53(.a(x14), .O(new_n105_));
  nand2  g54(.a(x18), .b(x06), .O(new_n106_));
  oai21  g55(.a(x18), .b(new_n105_), .c(new_n106_), .O(new_n107_));
  nand2  g56(.a(new_n107_), .b(new_n83_), .O(new_n108_));
  nand2  g57(.a(new_n101_), .b(x25), .O(new_n109_));
  nor2   g58(.a(x23), .b(x22), .O(new_n110_));
  nor2   g59(.a(x25), .b(x24), .O(new_n111_));
  nand4  g60(.a(new_n111_), .b(new_n110_), .c(new_n88_), .d(new_n70_), .O(new_n112_));
  nand2  g61(.a(new_n112_), .b(new_n109_), .O(new_n113_));
  nand2  g62(.a(new_n113_), .b(x16), .O(new_n114_));
  nand2  g63(.a(new_n114_), .b(new_n108_), .O(z15));
  nand2  g64(.a(x18), .b(x07), .O(new_n116_));
  oai21  g65(.a(x18), .b(new_n65_), .c(new_n116_), .O(new_n117_));
  nand2  g66(.a(new_n117_), .b(new_n83_), .O(new_n118_));
  nand2  g67(.a(new_n112_), .b(x26), .O(new_n119_));
  nor3   g68(.a(x26), .b(x25), .c(x24), .O(new_n120_));
  nand4  g69(.a(new_n120_), .b(new_n110_), .c(new_n88_), .d(new_n70_), .O(new_n121_));
  ...
  nand4  g75(.a(new_n126_), .b(new_n120_), .c(new_n110_), .d(new_n88_), .O(new_n127_));
  nand2  g76(.a(x27), .b(x17), .O(new_n128_));
  aoi21  g77(.a(new_n128_), .b(new_n127_), .c(new_n83_), .O(z17));
  zero   g78(.O(z00));
  zero   g79(.O(z06));
  zero   g80(.O(z08));
  zero   g81(.O(z12));
