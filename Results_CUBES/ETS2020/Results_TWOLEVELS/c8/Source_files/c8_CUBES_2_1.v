...
module FAU ( 
  ...
  inv1   g46(.a(x11), .O(new_n95_));
  nand2  g47(.a(x18), .b(x03), .O(new_n96_));
  oai21  g48(.a(x18), .b(new_n95_), .c(new_n96_), .O(new_n97_));
  nand2  g49(.a(new_n97_), .b(new_n84_), .O(new_n98_));
  nor2   g50(.a(x22), .b(x21), .O(new_n99_));
  aoi22  g51(.a(new_n99_), .b(new_n81_), .c(new_n91_), .d(x22), .O(new_n100_));
  oai21  g52(.a(new_n100_), .b(new_n84_), .c(new_n98_), .O(z12));
  inv1   g53(.a(x12), .O(new_n102_));
  nand2  g54(.a(x18), .b(x04), .O(new_n103_));
  oai21  g55(.a(x18), .b(new_n102_), .c(new_n103_), .O(new_n104_));
  nand2  g56(.a(new_n104_), .b(new_n84_), .O(new_n105_));
  nand3  g57(.a(new_n99_), .b(new_n71_), .c(new_n49_), .O(new_n106_));
  nor3   g58(.a(x23), .b(x22), .c(x21), .O(new_n107_));
  aoi22  g59(.a(new_n107_), .b(new_n81_), .c(new_n106_), .d(x23), .O(new_n108_));
  oai21  g60(.a(new_n108_), .b(new_n84_), .c(new_n105_), .O(z13));
  inv1   g61(.a(x13), .O(new_n110_));
  nand2  g62(.a(x18), .b(x05), .O(new_n111_));
  oai21  g63(.a(x18), .b(new_n110_), .c(new_n111_), .O(new_n112_));
  nand2  g64(.a(new_n112_), .b(new_n84_), .O(new_n113_));
  aoi21  g65(.a(new_n107_), .b(new_n81_), .c(new_n59_), .O(new_n114_));
  nor2   g66(.a(x24), .b(x23), .O(new_n115_));
  nand4  g67(.a(new_n115_), .b(new_n99_), .c(new_n71_), .d(new_n49_), .O(new_n116_));
  inv1   g68(.a(new_n116_), .O(new_n117_));
  oai21  g69(.a(new_n117_), .b(new_n114_), .c(x16), .O(new_n118_));
  nand2  g70(.a(new_n118_), .b(new_n113_), .O(z14));
  ...
  nand4  g75(.a(new_n62_), .b(new_n59_), .c(new_n56_), .d(new_n53_), .O(new_n124_));
  inv1   g76(.a(new_n124_), .O(new_n125_));
  aoi22  g77(.a(new_n125_), .b(new_n92_), .c(new_n116_), .d(x25), .O(new_n126_));
