...
module FAU ( 
  ...
  nand2  g19(.a(new_n70_), .b(new_n71_), .O(new_n72_));
  nor2   g20(.a(x21), .b(x20), .O(new_n73_));
  aoi22  g21(.a(new_n73_), .b(new_n70_), .c(new_n72_), .d(x21), .O(new_n74_));
  oai21  g22(.a(new_n74_), .b(new_n66_), .c(new_n69_), .O(z11));
  inv1   g23(.a(x12), .O(new_n77_));
  nand2  g24(.a(x18), .b(x04), .O(new_n78_));
  ...
  nand3  g29(.a(new_n82_), .b(new_n70_), .c(new_n71_), .O(new_n83_));
  nor3   g30(.a(x23), .b(x22), .c(x21), .O(new_n84_));
  aoi22  g31(.a(new_n84_), .b(new_n81_), .c(new_n83_), .d(x23), .O(new_n85_));
  oai21  g32(.a(new_n85_), .b(new_n66_), .c(new_n80_), .O(z13));
  ...
  aoi21  g37(.a(new_n84_), .b(new_n81_), .c(new_n57_), .O(new_n91_));
  nor2   g38(.a(x24), .b(x23), .O(new_n92_));
  nand4  g39(.a(new_n92_), .b(new_n82_), .c(new_n70_), .d(new_n71_), .O(new_n93_));
  ...
  nand4  g50(.a(new_n103_), .b(new_n102_), .c(new_n73_), .d(new_n70_), .O(new_n104_));
  ...
  nand2  g56(.a(new_n109_), .b(new_n66_), .O(new_n110_));
  nand2  g57(.a(new_n104_), .b(x26), .O(new_n111_));
  nor3   g58(.a(x26), .b(x25), .c(x24), .O(new_n112_));
  nand4  g59(.a(new_n112_), .b(new_n102_), .c(new_n73_), .d(new_n70_), .O(new_n113_));
