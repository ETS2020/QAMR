...
module FAU ( 
  ...
  aoi21  g58(.a(new_n101_), .b(new_n78_), .c(new_n59_), .O(new_n108_));
  nor2   g59(.a(x24), .b(x23), .O(new_n109_));
  nand4  g60(.a(new_n109_), .b(new_n93_), .c(new_n67_), .d(new_n76_), .O(new_n110_));
  ...
  oai21  g65(.a(x18), .b(new_n62_), .c(new_n114_), .O(new_n115_));
  nand2  g66(.a(new_n115_), .b(new_n81_), .O(new_n116_));
  nand2  g67(.a(new_n110_), .b(x25), .O(new_n117_));
  nor2   g68(.a(x23), .b(x22), .O(new_n118_));
  nor2   g69(.a(x25), .b(x24), .O(new_n119_));
  nand4  g70(.a(new_n119_), .b(new_n118_), .c(new_n86_), .d(new_n67_), .O(new_n120_));
  ...
  inv1   g74(.a(x15), .O(new_n124_));
  nand2  g75(.a(x18), .b(x07), .O(new_n125_));
  oai21  g76(.a(x18), .b(new_n124_), .c(new_n125_), .O(new_n126_));
  nand2  g77(.a(new_n126_), .b(new_n81_), .O(new_n127_));
  nand2  g78(.a(new_n120_), .b(x26), .O(new_n128_));
  nor3   g79(.a(x26), .b(x25), .c(x24), .O(new_n129_));
  nand4  g80(.a(new_n129_), .b(new_n118_), .c(new_n86_), .d(new_n67_), .O(new_n130_));
  ...
  nand4  g85(.a(new_n134_), .b(new_n129_), .c(new_n118_), .d(new_n86_), .O(new_n135_));
  nand2  g86(.a(x27), .b(x17), .O(new_n136_));
  aoi21  g87(.a(new_n136_), .b(new_n135_), .c(new_n81_), .O(z17));
  zero   g88(.O(z01));
  zero   g89(.O(z04));
  zero   g90(.O(z07));
  buf    g91(.a(x27), .O(z08));
