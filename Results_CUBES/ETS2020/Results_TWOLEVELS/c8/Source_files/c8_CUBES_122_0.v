...
module FAU ( 
  ...
  aoi21  g39(.a(new_n91_), .b(new_n72_), .c(new_n57_), .O(new_n92_));
  nand2  g40(.a(new_n70_), .b(new_n49_), .O(new_n93_));
  nor2   g41(.a(x24), .b(x23), .O(new_n94_));
  nand2  g42(.a(new_n94_), .b(new_n83_), .O(new_n95_));
  nor2   g43(.a(new_n95_), .b(new_n93_), .O(new_n96_));
  ...
  nand2  g48(.a(new_n101_), .b(new_n76_), .O(new_n102_));
  nor2   g49(.a(x23), .b(x22), .O(new_n103_));
  nor2   g50(.a(x25), .b(x24), .O(new_n104_));
  nand4  g51(.a(new_n104_), .b(new_n103_), .c(new_n81_), .d(new_n70_), .O(new_n105_));
  nand2  g52(.a(new_n105_), .b(x26), .O(new_n106_));
  nor3   g53(.a(x26), .b(x25), .c(x24), .O(new_n107_));
  nand4  g54(.a(new_n107_), .b(new_n103_), .c(new_n81_), .d(new_n70_), .O(new_n108_));
