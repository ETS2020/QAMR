...
module FAU ( 
  ...
  oai21  g57(.a(x18), .b(new_n64_), .c(new_n106_), .O(new_n107_));
  nand2  g58(.a(new_n107_), .b(new_n83_), .O(new_n108_));
  nor2   g59(.a(x24), .b(x23), .O(new_n109_));
  nand4  g60(.a(new_n109_), .b(new_n95_), .c(new_n69_), .d(new_n78_), .O(new_n110_));
  nand2  g61(.a(new_n110_), .b(x25), .O(new_n111_));
  nor2   g62(.a(x23), .b(x22), .O(new_n112_));
  nor2   g63(.a(x25), .b(x24), .O(new_n113_));
  nand4  g64(.a(new_n113_), .b(new_n112_), .c(new_n88_), .d(new_n69_), .O(new_n114_));
  nand2  g65(.a(new_n114_), .b(new_n111_), .O(new_n115_));
  nand2  g66(.a(new_n115_), .b(x16), .O(new_n116_));
  nand2  g67(.a(new_n116_), .b(new_n108_), .O(z15));
  inv1   g68(.a(x15), .O(new_n118_));
  ...
  nand2  g72(.a(new_n114_), .b(x26), .O(new_n122_));
  nor3   g73(.a(x26), .b(x25), .c(x24), .O(new_n123_));
  nand4  g74(.a(new_n123_), .b(new_n112_), .c(new_n88_), .d(new_n69_), .O(new_n124_));
  ...
  nand4  g79(.a(new_n128_), .b(new_n123_), .c(new_n112_), .d(new_n88_), .O(new_n129_));
  nand2  g80(.a(x27), .b(x17), .O(new_n130_));
  aoi21  g81(.a(new_n130_), .b(new_n129_), .c(new_n83_), .O(z17));
  zero   g82(.O(z01));
  zero   g83(.O(z07));
  zero   g84(.O(z14));
  buf    g85(.a(x27), .O(z08));
