...
module FAU ( 
  ...
  nand2  g43(.a(new_n72_), .b(new_n81_), .O(new_n91_));
  nand4  g44(.a(new_n52_), .b(new_n81_), .c(new_n48_), .d(new_n70_), .O(new_n92_));
  ...
  nand3  g53(.a(new_n101_), .b(new_n72_), .c(new_n81_), .O(new_n102_));
  ...
  nand4  g63(.a(new_n111_), .b(new_n101_), .c(new_n72_), .d(new_n81_), .O(new_n112_));
