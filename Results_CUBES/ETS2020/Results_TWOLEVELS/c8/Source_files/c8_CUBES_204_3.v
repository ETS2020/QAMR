...
module FAU ( 
  ...
  nand2  g47(.a(new_n95_), .b(new_n78_), .O(new_n96_));
  nand3  g48(.a(new_n91_), .b(new_n71_), .c(new_n49_), .O(new_n97_));
  nor3   g49(.a(x23), .b(x22), .c(x21), .O(new_n98_));
  aoi22  g50(.a(new_n98_), .b(new_n89_), .c(new_n97_), .d(x23), .O(new_n99_));
  oai21  g51(.a(new_n99_), .b(new_n78_), .c(new_n96_), .O(z13));
  inv1   g52(.a(x13), .O(new_n101_));
  nand2  g53(.a(x18), .b(x05), .O(new_n102_));
  oai21  g54(.a(x18), .b(new_n101_), .c(new_n102_), .O(new_n103_));
  nand2  g55(.a(new_n103_), .b(new_n78_), .O(new_n104_));
  aoi21  g56(.a(new_n98_), .b(new_n89_), .c(new_n61_), .O(new_n105_));
  nor2   g57(.a(x24), .b(x23), .O(new_n106_));
  nand4  g58(.a(new_n106_), .b(new_n91_), .c(new_n71_), .d(new_n49_), .O(new_n107_));
  ...
  nand2  g64(.a(new_n112_), .b(new_n78_), .O(new_n113_));
  nand2  g65(.a(new_n107_), .b(x25), .O(new_n114_));
  nor2   g66(.a(x23), .b(x22), .O(new_n115_));
  nor2   g67(.a(x25), .b(x24), .O(new_n116_));
  nand4  g68(.a(new_n116_), .b(new_n115_), .c(new_n83_), .d(new_n71_), .O(new_n117_));
  ...
  nand2  g74(.a(new_n122_), .b(new_n78_), .O(new_n123_));
  nand2  g75(.a(new_n117_), .b(x26), .O(new_n124_));
  nor3   g76(.a(x26), .b(x25), .c(x24), .O(new_n125_));
  nand4  g77(.a(new_n125_), .b(new_n115_), .c(new_n83_), .d(new_n71_), .O(new_n126_));
  ...
  nand4  g83(.a(new_n131_), .b(new_n125_), .c(new_n115_), .d(new_n83_), .O(new_n132_));
