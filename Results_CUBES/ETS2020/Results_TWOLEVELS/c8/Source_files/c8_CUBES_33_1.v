...
module FAU ( 
  ...
  nand2  g47(.a(new_n96_), .b(new_n83_), .O(new_n97_));
  nor2   g48(.a(x22), .b(x21), .O(new_n98_));
  nand3  g49(.a(new_n98_), .b(new_n70_), .c(new_n51_), .O(new_n99_));
  nor3   g50(.a(x23), .b(x22), .c(x21), .O(new_n100_));
  aoi22  g51(.a(new_n100_), .b(new_n80_), .c(new_n99_), .d(x23), .O(new_n101_));
  oai21  g52(.a(new_n101_), .b(new_n83_), .c(new_n97_), .O(z13));
  ...
  nand4  g58(.a(new_n108_), .b(new_n98_), .c(new_n70_), .d(new_n51_), .O(new_n109_));
  inv1   g59(.a(x22), .O(new_n110_));
  inv1   g60(.a(x23), .O(new_n111_));
  nand4  g61(.a(new_n62_), .b(new_n59_), .c(new_n111_), .d(new_n110_), .O(new_n112_));
  inv1   g62(.a(new_n112_), .O(new_n113_));
  aoi22  g63(.a(new_n113_), .b(new_n90_), .c(new_n109_), .d(x25), .O(new_n114_));
  oai21  g64(.a(new_n114_), .b(new_n83_), .c(new_n107_), .O(z15));
  ...
  aoi21  g71(.a(new_n122_), .b(new_n121_), .c(new_n83_), .O(z17));
  zero   g72(.O(z03));
  zero   g73(.O(z04));
  zero   g74(.O(z12));
  zero   g75(.O(z14));
