...
module FAU ( 
  ...
  nor3   g58(.a(x23), .b(x22), .c(x21), .O(new_n108_));
  aoi21  g59(.a(new_n108_), .b(new_n83_), .c(new_n61_), .O(new_n109_));
  nor2   g60(.a(x24), .b(x23), .O(new_n110_));
  nand4  g61(.a(new_n110_), .b(new_n100_), .c(new_n73_), .d(new_n51_), .O(new_n111_));
  ...
  nand2  g68(.a(new_n117_), .b(new_n86_), .O(new_n118_));
  inv1   g69(.a(x23), .O(new_n119_));
  nand4  g70(.a(new_n64_), .b(new_n61_), .c(new_n119_), .d(new_n57_), .O(new_n120_));
  inv1   g71(.a(new_n120_), .O(new_n121_));
  aoi22  g72(.a(new_n121_), .b(new_n93_), .c(new_n111_), .d(x25), .O(new_n122_));
  oai21  g73(.a(new_n122_), .b(new_n86_), .c(new_n118_), .O(z15));
  nor2   g74(.a(x21), .b(x20), .O(new_n125_));
  nor2   g75(.a(x23), .b(x22), .O(new_n126_));
  nor3   g76(.a(x26), .b(x25), .c(x24), .O(new_n127_));
  nor2   g77(.a(new_n48_), .b(x17), .O(new_n128_));
  nand4  g78(.a(new_n128_), .b(new_n127_), .c(new_n126_), .d(new_n125_), .O(new_n129_));
  nand2  g79(.a(x27), .b(x17), .O(new_n130_));
  aoi21  g80(.a(new_n130_), .b(new_n129_), .c(new_n86_), .O(z17));
  zero   g81(.O(z04));
  zero   g82(.O(z08));
  zero   g83(.O(z13));
  zero   g84(.O(z16));
