...
module FAU ( 
  ...
  nand2  g44(.a(new_n92_), .b(new_n82_), .O(new_n93_));
  nand2  g45(.a(new_n87_), .b(new_n69_), .O(new_n94_));
  nor2   g46(.a(x22), .b(x21), .O(new_n95_));
  aoi22  g47(.a(new_n95_), .b(new_n79_), .c(new_n94_), .d(x22), .O(new_n96_));
  oai21  g48(.a(new_n96_), .b(new_n82_), .c(new_n93_), .O(z12));
  nand2  g49(.a(x18), .b(x04), .O(new_n98_));
  oai21  g50(.a(x18), .b(new_n56_), .c(new_n98_), .O(new_n99_));
  nand2  g51(.a(new_n99_), .b(new_n82_), .O(new_n100_));
  nand3  g52(.a(new_n95_), .b(new_n69_), .c(new_n49_), .O(new_n101_));
  ...
  aoi21  g60(.a(new_n102_), .b(new_n79_), .c(new_n59_), .O(new_n109_));
  nor2   g61(.a(x24), .b(x23), .O(new_n110_));
  nand4  g62(.a(new_n110_), .b(new_n95_), .c(new_n69_), .d(new_n49_), .O(new_n111_));
  ...
  oai21  g67(.a(x18), .b(new_n62_), .c(new_n115_), .O(new_n116_));
