...
module FAU ( 
  ...
  aoi22  g45(.a(new_n94_), .b(new_n83_), .c(new_n93_), .d(x22), .O(new_n95_));
  ...
  nand2  g50(.a(new_n100_), .b(new_n87_), .O(new_n101_));
  nor3   g51(.a(x23), .b(x22), .c(x21), .O(new_n102_));
  aoi21  g52(.a(new_n102_), .b(new_n83_), .c(new_n61_), .O(new_n103_));
  nor2   g53(.a(x24), .b(x23), .O(new_n104_));
  nand4  g54(.a(new_n104_), .b(new_n94_), .c(new_n73_), .d(new_n51_), .O(new_n105_));
  inv1   g55(.a(new_n105_), .O(new_n106_));
  oai21  g56(.a(new_n106_), .b(new_n103_), .c(x16), .O(new_n107_));
  nand2  g57(.a(new_n107_), .b(new_n101_), .O(z14));
  ...
  inv1   g62(.a(new_n93_), .O(new_n113_));
  nand4  g63(.a(new_n64_), .b(new_n61_), .c(new_n58_), .d(new_n55_), .O(new_n114_));
  inv1   g64(.a(new_n114_), .O(new_n115_));
  aoi22  g65(.a(new_n115_), .b(new_n113_), .c(new_n105_), .d(x25), .O(new_n116_));
  oai21  g66(.a(new_n116_), .b(new_n87_), .c(new_n112_), .O(z15));
  ...
  aoi21  g73(.a(new_n124_), .b(new_n123_), .c(new_n87_), .O(z17));
  zero   g74(.O(z02));
  zero   g75(.O(z08));
  zero   g76(.O(z11));
  zero   g77(.O(z13));
