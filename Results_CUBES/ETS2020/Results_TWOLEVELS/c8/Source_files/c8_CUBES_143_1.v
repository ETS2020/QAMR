...
module FAU ( 
  ...
  nor2   g26(.a(new_n75_), .b(new_n49_), .O(new_n76_));
  ...
  oai21  g32(.a(x18), .b(new_n55_), .c(new_n82_), .O(new_n83_));
  nand2  g33(.a(new_n83_), .b(new_n81_), .O(new_n84_));
  nor2   g34(.a(x21), .b(x20), .O(new_n85_));
  nand2  g35(.a(new_n85_), .b(new_n75_), .O(new_n86_));
  nor2   g36(.a(x22), .b(x21), .O(new_n87_));
  aoi22  g37(.a(new_n87_), .b(new_n77_), .c(new_n86_), .d(x22), .O(new_n88_));
  oai21  g38(.a(new_n88_), .b(new_n81_), .c(new_n84_), .O(z12));
  ...
  nand3  g42(.a(new_n87_), .b(new_n75_), .c(new_n49_), .O(new_n93_));
  nor3   g43(.a(x23), .b(x22), .c(x21), .O(new_n94_));
  aoi22  g44(.a(new_n94_), .b(new_n77_), .c(new_n93_), .d(x23), .O(new_n95_));
  oai21  g45(.a(new_n95_), .b(new_n81_), .c(new_n92_), .O(z13));
  ...
  nand2  g68(.a(new_n118_), .b(new_n81_), .O(new_n119_));
  nand2  g69(.a(new_n113_), .b(x26), .O(new_n120_));
  nor3   g70(.a(x26), .b(x25), .c(x24), .O(new_n121_));
  nand4  g71(.a(new_n121_), .b(new_n111_), .c(new_n85_), .d(new_n75_), .O(new_n122_));
