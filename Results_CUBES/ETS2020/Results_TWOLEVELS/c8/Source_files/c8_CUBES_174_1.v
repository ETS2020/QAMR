...
module FAU ( 
  ...
  inv1   g39(.a(x11), .O(new_n88_));
  nand2  g40(.a(x18), .b(x03), .O(new_n89_));
  oai21  g41(.a(x18), .b(new_n88_), .c(new_n89_), .O(new_n90_));
  nand2  g42(.a(new_n90_), .b(new_n87_), .O(new_n91_));
  nand4  g43(.a(new_n52_), .b(new_n49_), .c(new_n71_), .d(new_n70_), .O(new_n92_));
  nor2   g44(.a(x22), .b(x21), .O(new_n93_));
  aoi22  g45(.a(new_n93_), .b(new_n83_), .c(new_n92_), .d(x22), .O(new_n94_));
  oai21  g46(.a(new_n94_), .b(new_n87_), .c(new_n91_), .O(z12));
  inv1   g47(.a(x13), .O(new_n97_));
  nand2  g48(.a(x18), .b(x05), .O(new_n98_));
  oai21  g49(.a(x18), .b(new_n97_), .c(new_n98_), .O(new_n99_));
  nand2  g50(.a(new_n99_), .b(new_n87_), .O(new_n100_));
  nor3   g51(.a(x23), .b(x22), .c(x21), .O(new_n101_));
  aoi21  g52(.a(new_n101_), .b(new_n83_), .c(new_n61_), .O(new_n102_));
  nor2   g53(.a(x24), .b(x23), .O(new_n103_));
  nand4  g54(.a(new_n103_), .b(new_n93_), .c(new_n73_), .d(new_n49_), .O(new_n104_));
  inv1   g55(.a(new_n104_), .O(new_n105_));
  oai21  g56(.a(new_n105_), .b(new_n102_), .c(x16), .O(new_n106_));
  nand2  g57(.a(new_n106_), .b(new_n100_), .O(z14));
  inv1   g58(.a(x14), .O(new_n108_));
  nand2  g59(.a(x18), .b(x06), .O(new_n109_));
  oai21  g60(.a(x18), .b(new_n108_), .c(new_n109_), .O(new_n110_));
  nand2  g61(.a(new_n110_), .b(new_n87_), .O(new_n111_));
  inv1   g62(.a(new_n92_), .O(new_n112_));
  nand4  g63(.a(new_n64_), .b(new_n61_), .c(new_n58_), .d(new_n55_), .O(new_n113_));
  inv1   g64(.a(new_n113_), .O(new_n114_));
  aoi22  g65(.a(new_n114_), .b(new_n112_), .c(new_n104_), .d(x25), .O(new_n115_));
  oai21  g66(.a(new_n115_), .b(new_n87_), .c(new_n111_), .O(z15));
  zero   g67(.O(z00));
  zero   g68(.O(z11));
  zero   g69(.O(z13));
  zero   g70(.O(z16));
