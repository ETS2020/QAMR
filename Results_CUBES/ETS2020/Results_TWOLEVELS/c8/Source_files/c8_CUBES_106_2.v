...
module FAU ( 
  ...
  nand3  g60(.a(new_n98_), .b(new_n63_), .c(new_n60_), .O(new_n108_));
  nor2   g61(.a(new_n108_), .b(new_n90_), .O(new_n109_));
  oai21  g62(.a(new_n109_), .b(new_n107_), .c(x16), .O(new_n110_));
  nand2  g63(.a(new_n110_), .b(new_n105_), .O(z14));
  nand2  g64(.a(x18), .b(x07), .O(new_n113_));
  oai21  g65(.a(x18), .b(new_n69_), .c(new_n113_), .O(new_n114_));
  nand2  g66(.a(new_n114_), .b(new_n86_), .O(new_n115_));
  nor2   g67(.a(x23), .b(x22), .O(new_n116_));
  nor2   g68(.a(x25), .b(x24), .O(new_n117_));
  nand4  g69(.a(new_n117_), .b(new_n116_), .c(new_n91_), .d(new_n73_), .O(new_n118_));
  nand2  g70(.a(new_n118_), .b(x26), .O(new_n119_));
  nor3   g71(.a(x26), .b(x25), .c(x24), .O(new_n120_));
  nand4  g72(.a(new_n120_), .b(new_n116_), .c(new_n91_), .d(new_n73_), .O(new_n121_));
  nand2  g73(.a(new_n121_), .b(new_n119_), .O(new_n122_));
  nand2  g74(.a(new_n122_), .b(x16), .O(new_n123_));
  nand2  g75(.a(new_n123_), .b(new_n115_), .O(z16));
  nor2   g76(.a(new_n48_), .b(x17), .O(new_n125_));
  nand4  g77(.a(new_n125_), .b(new_n120_), .c(new_n116_), .d(new_n91_), .O(new_n126_));
  nand2  g78(.a(x27), .b(x17), .O(new_n127_));
  aoi21  g79(.a(new_n127_), .b(new_n126_), .c(new_n86_), .O(z17));
  zero   g80(.O(z13));
  zero   g81(.O(z15));
  buf    g82(.a(x27), .O(z08));
endmodule
