...
module FAU ( 
  ...
  nand2  g36(.a(new_n72_), .b(new_n84_), .O(new_n85_));
  nand4  g37(.a(new_n52_), .b(new_n84_), .c(new_n48_), .d(new_n70_), .O(new_n86_));
  ...
  oai21  g48(.a(new_n96_), .b(new_n79_), .c(new_n93_), .O(z12));
  ...
  nand3  g53(.a(new_n95_), .b(new_n72_), .c(new_n84_), .O(new_n102_));
  ...
  nand2  g60(.a(new_n108_), .b(new_n79_), .O(new_n109_));
  aoi21  g61(.a(new_n103_), .b(new_n94_), .c(new_n61_), .O(new_n110_));
  nor2   g62(.a(x24), .b(x23), .O(new_n111_));
  nand4  g63(.a(new_n111_), .b(new_n95_), .c(new_n72_), .d(new_n84_), .O(new_n112_));
  ...
  nand2  g70(.a(new_n118_), .b(new_n79_), .O(new_n119_));
  ...
  oai21  g74(.a(new_n122_), .b(new_n79_), .c(new_n119_), .O(z15));
  ...
  aoi21  g81(.a(new_n130_), .b(new_n129_), .c(new_n79_), .O(z17));
  zero   g82(.O(z01));
  zero   g83(.O(z10));
  zero   g84(.O(z16));
  buf    g85(.a(x27), .O(z08));
