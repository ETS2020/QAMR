...
module FAU ( 
  ...
  oai21  g15(.a(x18), .b(new_n55_), .c(new_n68_), .O(new_n69_));
  ...
  nand3  g28(.a(new_n74_), .b(new_n71_), .c(new_n51_), .O(new_n82_));
  nor3   g29(.a(x23), .b(x22), .c(x21), .O(new_n83_));
  aoi22  g30(.a(new_n83_), .b(new_n75_), .c(new_n82_), .d(x23), .O(new_n84_));
  oai21  g31(.a(new_n84_), .b(new_n67_), .c(new_n81_), .O(z13));
  inv1   g32(.a(x13), .O(new_n86_));
  nand2  g33(.a(x18), .b(x05), .O(new_n87_));
  oai21  g34(.a(x18), .b(new_n86_), .c(new_n87_), .O(new_n88_));
  nand2  g35(.a(new_n88_), .b(new_n67_), .O(new_n89_));
  inv1   g36(.a(x24), .O(new_n90_));
  aoi21  g37(.a(new_n83_), .b(new_n75_), .c(new_n90_), .O(new_n91_));
  nand2  g38(.a(new_n71_), .b(new_n51_), .O(new_n92_));
  nor2   g39(.a(x24), .b(x23), .O(new_n93_));
  nand2  g40(.a(new_n93_), .b(new_n74_), .O(new_n94_));
  nor2   g41(.a(new_n94_), .b(new_n92_), .O(new_n95_));
  oai21  g42(.a(new_n95_), .b(new_n91_), .c(x16), .O(new_n96_));
  nand2  g43(.a(new_n96_), .b(new_n89_), .O(z14));
