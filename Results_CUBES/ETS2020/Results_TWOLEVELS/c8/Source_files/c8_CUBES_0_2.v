...
module FAU ( 
  ...
  oai21  g56(.a(x18), .b(new_n64_), .c(new_n105_), .O(new_n106_));
  nand2  g57(.a(new_n106_), .b(new_n82_), .O(new_n107_));
  nor2   g58(.a(x24), .b(x23), .O(new_n108_));
  nand4  g59(.a(new_n108_), .b(new_n94_), .c(new_n69_), .d(new_n49_), .O(new_n109_));
  nand2  g60(.a(new_n109_), .b(x25), .O(new_n110_));
  nor2   g61(.a(x23), .b(x22), .O(new_n111_));
  nor2   g62(.a(x25), .b(x24), .O(new_n112_));
  nand4  g63(.a(new_n112_), .b(new_n111_), .c(new_n87_), .d(new_n69_), .O(new_n113_));
  nand2  g64(.a(new_n113_), .b(new_n110_), .O(new_n114_));
  nand2  g65(.a(new_n114_), .b(x16), .O(new_n115_));
  nand2  g66(.a(new_n115_), .b(new_n107_), .O(z15));
  inv1   g67(.a(x15), .O(new_n117_));
  nand2  g68(.a(x18), .b(x07), .O(new_n118_));
  oai21  g69(.a(x18), .b(new_n117_), .c(new_n118_), .O(new_n119_));
  nand2  g70(.a(new_n119_), .b(new_n82_), .O(new_n120_));
  nand2  g71(.a(new_n113_), .b(x26), .O(new_n121_));
  nor3   g72(.a(x26), .b(x25), .c(x24), .O(new_n122_));
  nand4  g73(.a(new_n122_), .b(new_n111_), .c(new_n87_), .d(new_n69_), .O(new_n123_));
  ...
  nand4  g79(.a(new_n128_), .b(new_n122_), .c(new_n111_), .d(new_n87_), .O(new_n129_));
