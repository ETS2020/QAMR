...
module FAU ( 
  ...
  inv1   g36(.a(x10), .O(new_n86_));
  nand2  g37(.a(x18), .b(x02), .O(new_n87_));
  oai21  g38(.a(x18), .b(new_n86_), .c(new_n87_), .O(new_n88_));
  nand2  g39(.a(new_n88_), .b(new_n85_), .O(new_n89_));
  nor2   g40(.a(new_n82_), .b(new_n52_), .O(new_n90_));
  nand4  g41(.a(new_n52_), .b(new_n49_), .c(new_n70_), .d(new_n69_), .O(new_n91_));
  inv1   g42(.a(new_n91_), .O(new_n92_));
  oai21  g43(.a(new_n92_), .b(new_n90_), .c(x16), .O(new_n93_));
  nand2  g44(.a(new_n93_), .b(new_n89_), .O(z11));
  inv1   g45(.a(x11), .O(new_n95_));
  nand2  g46(.a(x18), .b(x03), .O(new_n96_));
  oai21  g47(.a(x18), .b(new_n95_), .c(new_n96_), .O(new_n97_));
  nand2  g48(.a(new_n97_), .b(new_n85_), .O(new_n98_));
  nor2   g49(.a(x22), .b(x21), .O(new_n99_));
  aoi22  g50(.a(new_n99_), .b(new_n82_), .c(new_n91_), .d(x22), .O(new_n100_));
  oai21  g51(.a(new_n100_), .b(new_n85_), .c(new_n98_), .O(z12));
  ...
  nand4  g57(.a(new_n108_), .b(new_n99_), .c(new_n72_), .d(new_n49_), .O(new_n109_));
  inv1   g58(.a(x22), .O(new_n110_));
  nand4  g59(.a(new_n62_), .b(new_n59_), .c(new_n56_), .d(new_n110_), .O(new_n111_));
  inv1   g60(.a(new_n111_), .O(new_n112_));
  aoi22  g61(.a(new_n112_), .b(new_n92_), .c(new_n109_), .d(x25), .O(new_n113_));
  oai21  g62(.a(new_n113_), .b(new_n85_), .c(new_n107_), .O(z15));
  nor2   g63(.a(x21), .b(x20), .O(new_n116_));
  nor2   g64(.a(x23), .b(x22), .O(new_n117_));
  nor3   g65(.a(x26), .b(x25), .c(x24), .O(new_n118_));
  nor2   g66(.a(new_n70_), .b(x17), .O(new_n119_));
  nand4  g67(.a(new_n119_), .b(new_n118_), .c(new_n117_), .d(new_n116_), .O(new_n120_));
  nand2  g68(.a(x27), .b(x17), .O(new_n121_));
  aoi21  g69(.a(new_n121_), .b(new_n120_), .c(new_n85_), .O(z17));
  zero   g70(.O(z00));
  zero   g71(.O(z03));
  zero   g72(.O(z08));
  zero   g73(.O(z13));
