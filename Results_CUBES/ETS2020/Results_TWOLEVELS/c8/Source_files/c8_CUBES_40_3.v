...
module FAU ( 
  ...
  nand2  g16(.a(x27), .b(new_n64_), .O(new_n65_));
  oai21  g17(.a(x27), .b(x26), .c(new_n65_), .O(z07));
  and2   g18(.a(x19), .b(x17), .O(new_n67_));
  nor2   g19(.a(x19), .b(x17), .O(new_n68_));
  oai21  g20(.a(new_n68_), .b(new_n67_), .c(x16), .O(new_n69_));
  inv1   g21(.a(x08), .O(new_n70_));
  nor2   g22(.a(x18), .b(new_n70_), .O(new_n71_));
  aoi21  g23(.a(x18), .b(x00), .c(new_n71_), .O(new_n72_));
  oai21  g24(.a(new_n72_), .b(x16), .c(new_n69_), .O(z09));
  inv1   g25(.a(x09), .O(new_n74_));
  nor2   g26(.a(x18), .b(new_n74_), .O(new_n75_));
  aoi21  g27(.a(x18), .b(x01), .c(new_n75_), .O(new_n76_));
  inv1   g28(.a(x20), .O(new_n77_));
  nor2   g29(.a(new_n68_), .b(new_n77_), .O(new_n78_));
  ...
  inv1   g33(.a(x16), .O(new_n82_));
  nand2  g34(.a(x18), .b(x02), .O(new_n83_));
  oai21  g35(.a(x18), .b(new_n49_), .c(new_n83_), .O(new_n84_));
  nand2  g36(.a(new_n84_), .b(new_n82_), .O(new_n85_));
  nand2  g37(.a(new_n68_), .b(new_n77_), .O(new_n86_));
  nor2   g38(.a(x21), .b(x20), .O(new_n87_));
  aoi22  g39(.a(new_n87_), .b(new_n68_), .c(new_n86_), .d(x21), .O(new_n88_));
  oai21  g40(.a(new_n88_), .b(new_n82_), .c(new_n85_), .O(z11));
  nand2  g41(.a(x18), .b(x03), .O(new_n90_));
  oai21  g42(.a(x18), .b(new_n52_), .c(new_n90_), .O(new_n91_));
  nand2  g43(.a(new_n91_), .b(new_n82_), .O(new_n92_));
  nand2  g44(.a(new_n87_), .b(new_n68_), .O(new_n93_));
  nor2   g45(.a(x22), .b(x21), .O(new_n94_));
  aoi22  g46(.a(new_n94_), .b(new_n79_), .c(new_n93_), .d(x22), .O(new_n95_));
  oai21  g47(.a(new_n95_), .b(new_n82_), .c(new_n92_), .O(z12));
  nand2  g48(.a(x18), .b(x04), .O(new_n97_));
  oai21  g49(.a(x18), .b(new_n55_), .c(new_n97_), .O(new_n98_));
  nand2  g50(.a(new_n98_), .b(new_n82_), .O(new_n99_));
  nand3  g51(.a(new_n94_), .b(new_n68_), .c(new_n77_), .O(new_n100_));
  nor3   g52(.a(x23), .b(x22), .c(x21), .O(new_n101_));
  aoi22  g53(.a(new_n101_), .b(new_n79_), .c(new_n100_), .d(x23), .O(new_n102_));
  oai21  g54(.a(new_n102_), .b(new_n82_), .c(new_n99_), .O(z13));
  nand2  g55(.a(x18), .b(x05), .O(new_n104_));
  oai21  g56(.a(x18), .b(new_n58_), .c(new_n104_), .O(new_n105_));
  nand2  g57(.a(new_n105_), .b(new_n82_), .O(new_n106_));
  inv1   g58(.a(x24), .O(new_n107_));
  aoi21  g59(.a(new_n101_), .b(new_n79_), .c(new_n107_), .O(new_n108_));
  nor2   g60(.a(x24), .b(x23), .O(new_n109_));
  nand4  g61(.a(new_n109_), .b(new_n94_), .c(new_n68_), .d(new_n77_), .O(new_n110_));
  inv1   g62(.a(new_n110_), .O(new_n111_));
  oai21  g63(.a(new_n111_), .b(new_n108_), .c(x16), .O(new_n112_));
  nand2  g64(.a(new_n112_), .b(new_n106_), .O(z14));
  nand2  g65(.a(x18), .b(x06), .O(new_n114_));
  oai21  g66(.a(x18), .b(new_n61_), .c(new_n114_), .O(new_n115_));
  nand2  g67(.a(new_n115_), .b(new_n82_), .O(new_n116_));
  nand2  g68(.a(new_n110_), .b(x25), .O(new_n117_));
  nor2   g69(.a(x23), .b(x22), .O(new_n118_));
  nor2   g70(.a(x25), .b(x24), .O(new_n119_));
  nand4  g71(.a(new_n119_), .b(new_n118_), .c(new_n87_), .d(new_n68_), .O(new_n120_));
  ...
  oai21  g76(.a(x18), .b(new_n64_), .c(new_n124_), .O(new_n125_));
  nand2  g77(.a(new_n125_), .b(new_n82_), .O(new_n126_));
  nand2  g78(.a(new_n120_), .b(x26), .O(new_n127_));
  nor3   g79(.a(x26), .b(x25), .c(x24), .O(new_n128_));
  nand4  g80(.a(new_n128_), .b(new_n118_), .c(new_n87_), .d(new_n68_), .O(new_n129_));
  ...
  inv1   g84(.a(x19), .O(new_n133_));
  nor2   g85(.a(new_n133_), .b(x17), .O(new_n134_));
  nand4  g86(.a(new_n134_), .b(new_n128_), .c(new_n118_), .d(new_n87_), .O(new_n135_));
  nand2  g87(.a(x27), .b(x17), .O(new_n136_));
  aoi21  g88(.a(new_n136_), .b(new_n135_), .c(new_n82_), .O(z17));
  zero   g89(.O(z00));
  zero   g90(.O(z01));
  buf    g91(.a(x27), .O(z08));
endmodule
