...
module FAU ( 
  ...
  wire new_n47_, new_n48_, new_n49_, new_n51_, new_n52_, new_n55_, new_n56_,
    new_n60_, new_n61_, new_n63_, new_n64_, new_n69_, new_n70_, new_n71_,
  ...
  nand2  g22(.a(new_n74_), .b(new_n51_), .O(new_n75_));
  nor2   g23(.a(x21), .b(x20), .O(new_n76_));
  aoi22  g24(.a(new_n76_), .b(new_n74_), .c(new_n75_), .d(x21), .O(new_n77_));
  oai21  g25(.a(new_n77_), .b(new_n69_), .c(new_n73_), .O(z11));
  nand2  g26(.a(x18), .b(x03), .O(new_n79_));
  oai21  g27(.a(x18), .b(new_n55_), .c(new_n79_), .O(new_n80_));
  nand2  g28(.a(new_n80_), .b(new_n69_), .O(new_n81_));
  nor3   g29(.a(x20), .b(x19), .c(x17), .O(new_n82_));
  nand2  g30(.a(new_n76_), .b(new_n74_), .O(new_n83_));
  nor2   g31(.a(x22), .b(x21), .O(new_n84_));
  aoi22  g32(.a(new_n84_), .b(new_n82_), .c(new_n83_), .d(x22), .O(new_n85_));
  oai21  g33(.a(new_n85_), .b(new_n69_), .c(new_n81_), .O(z12));
  ...
  inv1   g38(.a(x24), .O(new_n92_));
  nor3   g39(.a(x23), .b(x22), .c(x21), .O(new_n93_));
  aoi21  g40(.a(new_n93_), .b(new_n82_), .c(new_n92_), .O(new_n94_));
  nor2   g41(.a(x24), .b(x23), .O(new_n95_));
  nand2  g42(.a(new_n95_), .b(new_n84_), .O(new_n96_));
  nor2   g43(.a(new_n96_), .b(new_n75_), .O(new_n97_));
  ...
  nand2  g48(.a(new_n102_), .b(new_n69_), .O(new_n103_));
  nor2   g49(.a(x23), .b(x22), .O(new_n104_));
  nor2   g50(.a(x25), .b(x24), .O(new_n105_));
  nand4  g51(.a(new_n105_), .b(new_n104_), .c(new_n76_), .d(new_n74_), .O(new_n106_));
  nand2  g52(.a(new_n106_), .b(x26), .O(new_n107_));
  nor3   g53(.a(x26), .b(x25), .c(x24), .O(new_n108_));
  nand4  g54(.a(new_n108_), .b(new_n104_), .c(new_n76_), .d(new_n74_), .O(new_n109_));
