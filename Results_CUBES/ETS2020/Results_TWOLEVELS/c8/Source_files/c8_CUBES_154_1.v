...
module FAU ( 
  ...
  oai21  g40(.a(x18), .b(new_n54_), .c(new_n87_), .O(new_n88_));
  nand2  g41(.a(new_n88_), .b(new_n86_), .O(new_n89_));
  nand2  g42(.a(new_n74_), .b(new_n51_), .O(new_n90_));
  nor2   g43(.a(x21), .b(x20), .O(new_n91_));
  aoi22  g44(.a(new_n91_), .b(new_n74_), .c(new_n90_), .d(x21), .O(new_n92_));
  oai21  g45(.a(new_n92_), .b(new_n86_), .c(new_n89_), .O(z11));
  nand2  g46(.a(x18), .b(x04), .O(new_n95_));
  oai21  g47(.a(x18), .b(new_n60_), .c(new_n95_), .O(new_n96_));
  nand2  g48(.a(new_n96_), .b(new_n86_), .O(new_n97_));
  nor2   g49(.a(x22), .b(x21), .O(new_n98_));
  nand3  g50(.a(new_n98_), .b(new_n74_), .c(new_n51_), .O(new_n99_));
  ...
  nand4  g60(.a(new_n108_), .b(new_n98_), .c(new_n74_), .d(new_n51_), .O(new_n109_));
  ...
  nand2  g76(.a(new_n124_), .b(new_n86_), .O(new_n125_));
