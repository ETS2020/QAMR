...
module FAU ( 
  ...
  nor2   g32(.a(new_n72_), .b(new_n81_), .O(new_n82_));
  nor3   g33(.a(x20), .b(x19), .c(x17), .O(new_n83_));
  oai21  g34(.a(new_n83_), .b(new_n82_), .c(x16), .O(new_n84_));
  oai21  g35(.a(new_n80_), .b(x16), .c(new_n84_), .O(z10));
  ...
  nand4  g41(.a(new_n50_), .b(new_n81_), .c(new_n70_), .d(new_n69_), .O(new_n92_));
  nor2   g42(.a(x22), .b(x21), .O(new_n93_));
  aoi22  g43(.a(new_n93_), .b(new_n83_), .c(new_n92_), .d(x22), .O(new_n94_));
  oai21  g44(.a(new_n94_), .b(new_n87_), .c(new_n91_), .O(z12));
  inv1   g45(.a(x12), .O(new_n96_));
  nand2  g46(.a(x18), .b(x04), .O(new_n97_));
  oai21  g47(.a(x18), .b(new_n96_), .c(new_n97_), .O(new_n98_));
  nand2  g48(.a(new_n98_), .b(new_n87_), .O(new_n99_));
  nand3  g49(.a(new_n93_), .b(new_n72_), .c(new_n81_), .O(new_n100_));
  nor3   g50(.a(x23), .b(x22), .c(x21), .O(new_n101_));
  aoi22  g51(.a(new_n101_), .b(new_n83_), .c(new_n100_), .d(x23), .O(new_n102_));
  oai21  g52(.a(new_n102_), .b(new_n87_), .c(new_n99_), .O(z13));
  ...
  aoi21  g57(.a(new_n101_), .b(new_n83_), .c(new_n59_), .O(new_n108_));
  nor2   g58(.a(x24), .b(x23), .O(new_n109_));
  nand4  g59(.a(new_n109_), .b(new_n93_), .c(new_n72_), .d(new_n81_), .O(new_n110_));
