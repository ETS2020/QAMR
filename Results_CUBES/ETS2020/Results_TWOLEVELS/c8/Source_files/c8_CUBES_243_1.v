...
module FAU ( 
  ...
  nor2   g26(.a(new_n48_), .b(new_n73_), .O(new_n74_));
  nor2   g27(.a(x19), .b(x17), .O(new_n75_));
  oai21  g28(.a(new_n75_), .b(new_n74_), .c(x16), .O(new_n76_));
  inv1   g29(.a(x08), .O(new_n77_));
  nor2   g30(.a(x18), .b(new_n77_), .O(new_n78_));
  aoi21  g31(.a(x18), .b(x00), .c(new_n78_), .O(new_n79_));
  oai21  g32(.a(new_n79_), .b(x16), .c(new_n76_), .O(z09));
  inv1   g33(.a(x09), .O(new_n81_));
  nor2   g34(.a(x18), .b(new_n81_), .O(new_n82_));
  aoi21  g35(.a(x18), .b(x01), .c(new_n82_), .O(new_n83_));
  nor2   g36(.a(new_n75_), .b(new_n51_), .O(new_n84_));
  nor3   g37(.a(x20), .b(x19), .c(x17), .O(new_n85_));
  oai21  g38(.a(new_n85_), .b(new_n84_), .c(x16), .O(new_n86_));
  oai21  g39(.a(new_n83_), .b(x16), .c(new_n86_), .O(z10));
  ...
  nand2  g44(.a(new_n92_), .b(new_n89_), .O(new_n93_));
  nand4  g45(.a(new_n54_), .b(new_n51_), .c(new_n48_), .d(new_n73_), .O(new_n94_));
  nor2   g46(.a(x22), .b(x21), .O(new_n95_));
  aoi22  g47(.a(new_n95_), .b(new_n85_), .c(new_n94_), .d(x22), .O(new_n96_));
  oai21  g48(.a(new_n96_), .b(new_n89_), .c(new_n93_), .O(z12));
  inv1   g49(.a(x12), .O(new_n98_));
  nand2  g50(.a(x18), .b(x04), .O(new_n99_));
  oai21  g51(.a(x18), .b(new_n98_), .c(new_n99_), .O(new_n100_));
  nand2  g52(.a(new_n100_), .b(new_n89_), .O(new_n101_));
  nand3  g53(.a(new_n95_), .b(new_n75_), .c(new_n51_), .O(new_n102_));
  nor3   g54(.a(x23), .b(x22), .c(x21), .O(new_n103_));
  aoi22  g55(.a(new_n103_), .b(new_n85_), .c(new_n102_), .d(x23), .O(new_n104_));
  oai21  g56(.a(new_n104_), .b(new_n89_), .c(new_n101_), .O(z13));
  inv1   g57(.a(x13), .O(new_n106_));
  nand2  g58(.a(x18), .b(x05), .O(new_n107_));
  oai21  g59(.a(x18), .b(new_n106_), .c(new_n107_), .O(new_n108_));
  nand2  g60(.a(new_n108_), .b(new_n89_), .O(new_n109_));
  aoi21  g61(.a(new_n103_), .b(new_n85_), .c(new_n63_), .O(new_n110_));
  nor2   g62(.a(x24), .b(x23), .O(new_n111_));
  nand4  g63(.a(new_n111_), .b(new_n95_), .c(new_n75_), .d(new_n51_), .O(new_n112_));
  ...
  nand2  g70(.a(new_n118_), .b(new_n89_), .O(new_n119_));
  inv1   g71(.a(new_n94_), .O(new_n120_));
  nand4  g72(.a(new_n66_), .b(new_n63_), .c(new_n60_), .d(new_n57_), .O(new_n121_));
  inv1   g73(.a(new_n121_), .O(new_n122_));
  aoi22  g74(.a(new_n122_), .b(new_n120_), .c(new_n112_), .d(x25), .O(new_n123_));
  oai21  g75(.a(new_n123_), .b(new_n89_), .c(new_n119_), .O(z15));
  zero   g76(.O(z08));
  zero   g77(.O(z11));
  zero   g78(.O(z16));
  zero   g79(.O(z17));
