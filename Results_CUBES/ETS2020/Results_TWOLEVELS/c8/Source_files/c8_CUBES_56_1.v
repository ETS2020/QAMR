...
module FAU ( 
  ...
  oai21  g40(.a(x18), .b(new_n64_), .c(new_n92_), .O(new_n93_));
  nand2  g41(.a(new_n93_), .b(new_n73_), .O(new_n94_));
  nor2   g42(.a(x24), .b(x23), .O(new_n95_));
  nand4  g43(.a(new_n95_), .b(new_n87_), .c(new_n77_), .d(new_n51_), .O(new_n96_));
  nand2  g44(.a(new_n96_), .b(x25), .O(new_n97_));
  nor2   g45(.a(x23), .b(x22), .O(new_n98_));
  nor2   g46(.a(x25), .b(x24), .O(new_n99_));
  nand4  g47(.a(new_n99_), .b(new_n98_), .c(new_n79_), .d(new_n77_), .O(new_n100_));
  nand2  g48(.a(new_n100_), .b(new_n97_), .O(new_n101_));
  nand2  g49(.a(new_n101_), .b(x16), .O(new_n102_));
  nand2  g50(.a(new_n102_), .b(new_n94_), .O(z15));
  nand2  g51(.a(x18), .b(x07), .O(new_n104_));
  oai21  g52(.a(x18), .b(new_n67_), .c(new_n104_), .O(new_n105_));
  nand2  g53(.a(new_n105_), .b(new_n73_), .O(new_n106_));
  nand2  g54(.a(new_n100_), .b(x26), .O(new_n107_));
  nor3   g55(.a(x26), .b(x25), .c(x24), .O(new_n108_));
  nand4  g56(.a(new_n108_), .b(new_n98_), .c(new_n79_), .d(new_n77_), .O(new_n109_));
  nand2  g57(.a(new_n109_), .b(new_n107_), .O(new_n110_));
  nand2  g58(.a(new_n110_), .b(x16), .O(new_n111_));
  nand2  g59(.a(new_n111_), .b(new_n106_), .O(z16));
  nor2   g60(.a(new_n48_), .b(x17), .O(new_n113_));
  nand4  g61(.a(new_n113_), .b(new_n108_), .c(new_n98_), .d(new_n79_), .O(new_n114_));
  nand2  g62(.a(x27), .b(x17), .O(new_n115_));
  aoi21  g63(.a(new_n115_), .b(new_n114_), .c(new_n73_), .O(z17));
  zero   g64(.O(z04));
  zero   g65(.O(z08));
  zero   g66(.O(z09));
  zero   g67(.O(z10));
