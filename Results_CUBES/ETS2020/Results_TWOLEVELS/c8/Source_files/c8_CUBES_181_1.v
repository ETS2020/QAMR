...
module FAU ( 
  ...
  nand2  g33(.a(x18), .b(x01), .O(new_n81_));
  oai21  g34(.a(x18), .b(new_n51_), .c(new_n81_), .O(new_n82_));
  nand2  g35(.a(new_n82_), .b(new_n80_), .O(new_n83_));
  xnor2a g36(.a(new_n74_), .b(x20), .O(new_n84_));
  oai21  g37(.a(new_n84_), .b(new_n80_), .c(new_n83_), .O(z10));
  nand2  g38(.a(x18), .b(x03), .O(new_n87_));
  oai21  g39(.a(x18), .b(new_n57_), .c(new_n87_), .O(new_n88_));
  nand2  g40(.a(new_n88_), .b(new_n80_), .O(new_n89_));
  nor2   g41(.a(x21), .b(x20), .O(new_n90_));
  nand2  g42(.a(new_n90_), .b(new_n74_), .O(new_n91_));
  nor3   g43(.a(x22), .b(x21), .c(x20), .O(new_n92_));
  aoi22  g44(.a(new_n92_), .b(new_n74_), .c(new_n91_), .d(x22), .O(new_n93_));
  oai21  g45(.a(new_n93_), .b(new_n80_), .c(new_n89_), .O(z12));
  nand2  g46(.a(x18), .b(x07), .O(new_n98_));
  oai21  g47(.a(x18), .b(new_n69_), .c(new_n98_), .O(new_n99_));
  nand2  g48(.a(new_n99_), .b(new_n80_), .O(new_n100_));
  nor2   g49(.a(x23), .b(x22), .O(new_n101_));
  nor2   g50(.a(x25), .b(x24), .O(new_n102_));
  nand4  g51(.a(new_n102_), .b(new_n101_), .c(new_n90_), .d(new_n74_), .O(new_n103_));
  nand2  g52(.a(new_n103_), .b(x26), .O(new_n104_));
  nor3   g53(.a(x26), .b(x25), .c(x24), .O(new_n105_));
  nand4  g54(.a(new_n105_), .b(new_n101_), .c(new_n90_), .d(new_n74_), .O(new_n106_));
  nand2  g55(.a(new_n106_), .b(new_n104_), .O(new_n107_));
  nand2  g56(.a(new_n107_), .b(x16), .O(new_n108_));
  nand2  g57(.a(new_n108_), .b(new_n100_), .O(z16));
  nor2   g58(.a(new_n48_), .b(x17), .O(new_n110_));
  nand4  g59(.a(new_n110_), .b(new_n105_), .c(new_n101_), .d(new_n90_), .O(new_n111_));
  nand2  g60(.a(x27), .b(x17), .O(new_n112_));
  aoi21  g61(.a(new_n112_), .b(new_n111_), .c(new_n80_), .O(z17));
  zero   g62(.O(z08));
  zero   g63(.O(z11));
  zero   g64(.O(z13));
  zero   g65(.O(z14));
