...
module FAU ( 
  ...
  aoi21  g48(.a(new_n94_), .b(new_n69_), .c(new_n55_), .O(new_n101_));
  nor2   g49(.a(x24), .b(x23), .O(new_n102_));
  nand2  g50(.a(new_n102_), .b(new_n86_), .O(new_n103_));
  nor2   g51(.a(new_n103_), .b(new_n77_), .O(new_n104_));
  oai21  g52(.a(new_n104_), .b(new_n101_), .c(x16), .O(new_n105_));
  nand2  g53(.a(new_n105_), .b(new_n100_), .O(z14));
  nand2  g54(.a(x18), .b(x07), .O(new_n108_));
  oai21  g55(.a(x18), .b(new_n59_), .c(new_n108_), .O(new_n109_));
  nand2  g56(.a(new_n109_), .b(new_n72_), .O(new_n110_));
  nor2   g57(.a(x23), .b(x22), .O(new_n111_));
  nor2   g58(.a(x25), .b(x24), .O(new_n112_));
  nand4  g59(.a(new_n112_), .b(new_n111_), .c(new_n78_), .d(new_n67_), .O(new_n113_));
  nand2  g60(.a(new_n113_), .b(x26), .O(new_n114_));
  nor3   g61(.a(x26), .b(x25), .c(x24), .O(new_n115_));
  nand4  g62(.a(new_n115_), .b(new_n111_), .c(new_n78_), .d(new_n67_), .O(new_n116_));
  nand2  g63(.a(new_n116_), .b(new_n114_), .O(new_n117_));
  nand2  g64(.a(new_n117_), .b(x16), .O(new_n118_));
  nand2  g65(.a(new_n118_), .b(new_n110_), .O(z16));
  zero   g66(.O(z01));
  zero   g67(.O(z02));
  zero   g68(.O(z03));
  zero   g69(.O(z04));
