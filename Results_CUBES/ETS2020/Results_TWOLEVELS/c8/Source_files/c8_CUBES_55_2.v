...
module FAU ( 
  ...
  nand4  g58(.a(new_n62_), .b(new_n59_), .c(new_n56_), .d(new_n53_), .O(new_n110_));
  inv1   g59(.a(new_n110_), .O(new_n111_));
  aoi22  g60(.a(new_n111_), .b(new_n90_), .c(new_n109_), .d(x25), .O(new_n112_));
  oai21  g61(.a(new_n112_), .b(new_n83_), .c(new_n107_), .O(z15));
