...
module FAU ( 
  ...
  wire new_n48_, new_n49_, new_n50_, new_n52_, new_n53_, new_n56_, new_n57_,
    new_n59_, new_n60_, new_n67_, new_n68_, new_n69_, new_n70_, new_n71_,
  ...
  nand4  g20(.a(new_n52_), .b(new_n49_), .c(new_n73_), .d(new_n72_), .O(new_n74_));
  ...
  nor2   g29(.a(x19), .b(x17), .O(new_n83_));
  nand3  g30(.a(new_n75_), .b(new_n83_), .c(new_n49_), .O(new_n84_));
  nor3   g31(.a(x23), .b(x22), .c(x21), .O(new_n85_));
  aoi22  g32(.a(new_n85_), .b(new_n76_), .c(new_n84_), .d(x23), .O(new_n86_));
  oai21  g33(.a(new_n86_), .b(new_n67_), .c(new_n82_), .O(z13));
  inv1   g34(.a(x14), .O(new_n89_));
  nand2  g35(.a(x18), .b(x06), .O(new_n90_));
  oai21  g36(.a(x18), .b(new_n89_), .c(new_n90_), .O(new_n91_));
  nand2  g37(.a(new_n91_), .b(new_n67_), .O(new_n92_));
  inv1   g38(.a(new_n74_), .O(new_n93_));
  nor2   g39(.a(x24), .b(x23), .O(new_n94_));
  nand4  g40(.a(new_n94_), .b(new_n75_), .c(new_n83_), .d(new_n49_), .O(new_n95_));
  inv1   g41(.a(x22), .O(new_n96_));
  inv1   g42(.a(x25), .O(new_n97_));
  nand4  g43(.a(new_n97_), .b(new_n59_), .c(new_n56_), .d(new_n96_), .O(new_n98_));
  inv1   g44(.a(new_n98_), .O(new_n99_));
  aoi22  g45(.a(new_n99_), .b(new_n93_), .c(new_n95_), .d(x25), .O(new_n100_));
  oai21  g46(.a(new_n100_), .b(new_n67_), .c(new_n92_), .O(z15));
  nor2   g47(.a(x21), .b(x20), .O(new_n103_));
  nor2   g48(.a(x23), .b(x22), .O(new_n104_));
  nor3   g49(.a(x26), .b(x25), .c(x24), .O(new_n105_));
  nor2   g50(.a(new_n73_), .b(x17), .O(new_n106_));
  nand4  g51(.a(new_n106_), .b(new_n105_), .c(new_n104_), .d(new_n103_), .O(new_n107_));
  nand2  g52(.a(x27), .b(x17), .O(new_n108_));
  aoi21  g53(.a(new_n108_), .b(new_n107_), .c(new_n67_), .O(z17));
  zero   g54(.O(z00));
  zero   g55(.O(z03));
  zero   g56(.O(z06));
  zero   g57(.O(z07));
