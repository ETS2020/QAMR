...
module FAU ( 
  ...
  oai21  g59(.a(x18), .b(new_n66_), .c(new_n107_), .O(new_n108_));
  ...
  nand2  g74(.a(new_n115_), .b(x26), .O(new_n123_));
  nor3   g75(.a(x26), .b(x25), .c(x24), .O(new_n124_));
  nand4  g76(.a(new_n124_), .b(new_n113_), .c(new_n89_), .d(new_n71_), .O(new_n125_));
  ...
  nand4  g81(.a(new_n129_), .b(new_n124_), .c(new_n113_), .d(new_n89_), .O(new_n130_));
  nand2  g82(.a(x27), .b(x17), .O(new_n131_));
  aoi21  g83(.a(new_n131_), .b(new_n130_), .c(new_n84_), .O(z17));
  zero   g84(.O(z07));
  zero   g85(.O(z14));
  buf    g86(.a(x27), .O(z08));
endmodule
