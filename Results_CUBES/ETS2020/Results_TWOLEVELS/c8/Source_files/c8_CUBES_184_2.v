...
module FAU ( 
  ...
  nand3  g52(.a(new_n95_), .b(new_n70_), .c(new_n51_), .O(new_n102_));
  ...
  nand4  g79(.a(new_n129_), .b(new_n124_), .c(new_n113_), .d(new_n88_), .O(new_n130_));
  nand2  g80(.a(x27), .b(x17), .O(new_n131_));
  aoi21  g81(.a(new_n131_), .b(new_n130_), .c(new_n83_), .O(z17));
  zero   g82(.O(z04));
  zero   g83(.O(z07));
  zero   g84(.O(z08));
  zero   g85(.O(z14));
