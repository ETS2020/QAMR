...
module FAU ( 
  ...
  nand4  g71(.a(new_n119_), .b(new_n118_), .c(new_n87_), .d(new_n69_), .O(new_n120_));
  ...
  inv1   g75(.a(x15), .O(new_n124_));
  nand2  g76(.a(x18), .b(x07), .O(new_n125_));
  oai21  g77(.a(x18), .b(new_n124_), .c(new_n125_), .O(new_n126_));
  nand2  g78(.a(new_n126_), .b(new_n82_), .O(new_n127_));
  nand2  g79(.a(new_n120_), .b(x26), .O(new_n128_));
  nor3   g80(.a(x26), .b(x25), .c(x24), .O(new_n129_));
  nand4  g81(.a(new_n129_), .b(new_n118_), .c(new_n87_), .d(new_n69_), .O(new_n130_));
  ...
  nand4  g87(.a(new_n135_), .b(new_n129_), .c(new_n118_), .d(new_n87_), .O(new_n136_));
