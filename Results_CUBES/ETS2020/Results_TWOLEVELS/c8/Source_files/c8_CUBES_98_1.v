...
module FAU ( 
  ...
  oai21  g55(.a(x18), .b(new_n66_), .c(new_n104_), .O(new_n105_));
  nand2  g56(.a(new_n105_), .b(new_n87_), .O(new_n106_));
  nor2   g57(.a(x24), .b(x23), .O(new_n107_));
  nand4  g58(.a(new_n107_), .b(new_n99_), .c(new_n74_), .d(new_n51_), .O(new_n108_));
  nand2  g59(.a(new_n108_), .b(x25), .O(new_n109_));
  nor2   g60(.a(x23), .b(x22), .O(new_n110_));
  nor2   g61(.a(x25), .b(x24), .O(new_n111_));
  nand4  g62(.a(new_n111_), .b(new_n110_), .c(new_n92_), .d(new_n74_), .O(new_n112_));
  ...
  oai21  g67(.a(x18), .b(new_n69_), .c(new_n116_), .O(new_n117_));
  nand2  g68(.a(new_n117_), .b(new_n87_), .O(new_n118_));
  nand2  g69(.a(new_n112_), .b(x26), .O(new_n119_));
  nor3   g70(.a(x26), .b(x25), .c(x24), .O(new_n120_));
  nand4  g71(.a(new_n120_), .b(new_n110_), .c(new_n92_), .d(new_n74_), .O(new_n121_));
  ...
  nand4  g76(.a(new_n125_), .b(new_n120_), .c(new_n110_), .d(new_n92_), .O(new_n126_));
  nand2  g77(.a(x27), .b(x17), .O(new_n127_));
  aoi21  g78(.a(new_n127_), .b(new_n126_), .c(new_n87_), .O(z17));
  zero   g79(.O(z08));
  zero   g80(.O(z13));
  zero   g81(.O(z14));
endmodule
