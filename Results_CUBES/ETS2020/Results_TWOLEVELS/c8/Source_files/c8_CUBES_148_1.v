...
module FAU ( 
  ...
  nor2   g38(.a(new_n79_), .b(new_n54_), .O(new_n87_));
  inv1   g39(.a(x17), .O(new_n88_));
  nand4  g40(.a(new_n54_), .b(new_n51_), .c(new_n48_), .d(new_n88_), .O(new_n89_));
  inv1   g41(.a(new_n89_), .O(new_n90_));
  oai21  g42(.a(new_n90_), .b(new_n87_), .c(x16), .O(new_n91_));
  nand2  g43(.a(new_n91_), .b(new_n86_), .O(z11));
  inv1   g44(.a(x11), .O(new_n93_));
  nand2  g45(.a(x18), .b(x03), .O(new_n94_));
  oai21  g46(.a(x18), .b(new_n93_), .c(new_n94_), .O(new_n95_));
  nand2  g47(.a(new_n95_), .b(new_n82_), .O(new_n96_));
  nor2   g48(.a(x22), .b(x21), .O(new_n97_));
  aoi22  g49(.a(new_n97_), .b(new_n79_), .c(new_n89_), .d(x22), .O(new_n98_));
  oai21  g50(.a(new_n98_), .b(new_n82_), .c(new_n96_), .O(z12));
  ...
  nand4  g56(.a(new_n106_), .b(new_n97_), .c(new_n77_), .d(new_n51_), .O(new_n107_));
  nand4  g57(.a(new_n66_), .b(new_n63_), .c(new_n60_), .d(new_n57_), .O(new_n108_));
  inv1   g58(.a(new_n108_), .O(new_n109_));
  aoi22  g59(.a(new_n109_), .b(new_n90_), .c(new_n107_), .d(x25), .O(new_n110_));
  oai21  g60(.a(new_n110_), .b(new_n82_), .c(new_n105_), .O(z15));
  nor2   g61(.a(x21), .b(x20), .O(new_n113_));
  ...
  aoi21  g67(.a(new_n118_), .b(new_n117_), .c(new_n82_), .O(z17));
  zero   g68(.O(z08));
  zero   g69(.O(z09));
  zero   g70(.O(z13));
  zero   g71(.O(z14));
