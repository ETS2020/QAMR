...
module FAU ( 
  ...
  nor3   g49(.a(x26), .b(x25), .c(x24), .O(new_n102_));
  inv1   g50(.a(x19), .O(new_n103_));
  nor2   g51(.a(new_n103_), .b(x17), .O(new_n104_));
  nor2   g52(.a(x21), .b(x20), .O(new_n105_));
  nand4  g53(.a(new_n105_), .b(new_n104_), .c(new_n102_), .d(new_n101_), .O(new_n106_));
