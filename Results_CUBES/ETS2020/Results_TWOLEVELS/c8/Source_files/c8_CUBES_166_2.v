// Benchmark "FAU" written by ABC on Mon Jul  6 18:51:01 2020
...
module FAU ( 
  ...
  nor2   g28(.a(new_n68_), .b(new_n77_), .O(new_n78_));
  ...
  nand2  g37(.a(new_n68_), .b(new_n77_), .O(new_n87_));
  nand4  g38(.a(new_n52_), .b(new_n77_), .c(new_n48_), .d(new_n66_), .O(new_n88_));
  inv1   g39(.a(new_n88_), .O(new_n89_));
  aoi21  g40(.a(new_n87_), .b(x21), .c(new_n89_), .O(new_n90_));
  oai21  g41(.a(new_n90_), .b(new_n82_), .c(new_n86_), .O(z11));
  inv1   g42(.a(x12), .O(new_n93_));
  nand2  g43(.a(x18), .b(x04), .O(new_n94_));
  oai21  g44(.a(x18), .b(new_n93_), .c(new_n94_), .O(new_n95_));
  nand2  g45(.a(new_n95_), .b(new_n82_), .O(new_n96_));
  nor2   g46(.a(x22), .b(x21), .O(new_n97_));
  nand3  g47(.a(new_n97_), .b(new_n68_), .c(new_n77_), .O(new_n98_));
  nor3   g48(.a(x23), .b(x22), .c(x21), .O(new_n99_));
  aoi22  g49(.a(new_n99_), .b(new_n79_), .c(new_n98_), .d(x23), .O(new_n100_));
  oai21  g50(.a(new_n100_), .b(new_n82_), .c(new_n96_), .O(z13));
  inv1   g51(.a(x13), .O(new_n102_));
  nand2  g52(.a(x18), .b(x05), .O(new_n103_));
  oai21  g53(.a(x18), .b(new_n102_), .c(new_n103_), .O(new_n104_));
  nand2  g54(.a(new_n104_), .b(new_n82_), .O(new_n105_));
  aoi21  g55(.a(new_n99_), .b(new_n79_), .c(new_n59_), .O(new_n106_));
  nor2   g56(.a(x24), .b(x23), .O(new_n107_));
  nand4  g57(.a(new_n107_), .b(new_n97_), .c(new_n68_), .d(new_n77_), .O(new_n108_));
  ...
  inv1   g65(.a(x23), .O(new_n116_));
  nand4  g66(.a(new_n62_), .b(new_n59_), .c(new_n116_), .d(new_n55_), .O(new_n117_));
  inv1   g67(.a(new_n117_), .O(new_n118_));
  aoi22  g68(.a(new_n118_), .b(new_n89_), .c(new_n108_), .d(x25), .O(new_n119_));
  oai21  g69(.a(new_n119_), .b(new_n82_), .c(new_n115_), .O(z15));
  nor2   g70(.a(x21), .b(x20), .O(new_n122_));
  nor2   g71(.a(x23), .b(x22), .O(new_n123_));
  nor3   g72(.a(x26), .b(x25), .c(x24), .O(new_n124_));
  nor2   g73(.a(new_n48_), .b(x17), .O(new_n125_));
  nand4  g74(.a(new_n125_), .b(new_n124_), .c(new_n123_), .d(new_n122_), .O(new_n126_));
  nand2  g75(.a(x27), .b(x17), .O(new_n127_));
  aoi21  g76(.a(new_n127_), .b(new_n126_), .c(new_n82_), .O(z17));
  zero   g77(.O(z01));
  zero   g78(.O(z04));
  zero   g79(.O(z07));
  zero   g80(.O(z12));
