...
module FAU ( 
  ...
  nand2  g41(.a(new_n71_), .b(new_n49_), .O(new_n89_));
  ...
  aoi21  g50(.a(new_n99_), .b(new_n81_), .c(new_n61_), .O(new_n100_));
  nand4  g51(.a(new_n61_), .b(new_n58_), .c(new_n55_), .d(new_n52_), .O(new_n101_));
  nor2   g52(.a(new_n101_), .b(new_n89_), .O(new_n102_));
  ...
  nand2  g57(.a(new_n107_), .b(new_n84_), .O(new_n108_));
  nor2   g58(.a(x23), .b(x22), .O(new_n109_));
  nor2   g59(.a(x25), .b(x24), .O(new_n110_));
  nand4  g60(.a(new_n110_), .b(new_n109_), .c(new_n90_), .d(new_n71_), .O(new_n111_));
  nand2  g61(.a(new_n111_), .b(x26), .O(new_n112_));
  nor3   g62(.a(x26), .b(x25), .c(x24), .O(new_n113_));
  nand4  g63(.a(new_n113_), .b(new_n109_), .c(new_n90_), .d(new_n71_), .O(new_n114_));
