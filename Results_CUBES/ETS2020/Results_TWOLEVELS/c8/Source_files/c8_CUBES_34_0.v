...
module FAU ( 
  ...
  aoi22  g32(.a(new_n82_), .b(new_n71_), .c(new_n81_), .d(x21), .O(new_n83_));
  oai21  g33(.a(new_n83_), .b(new_n76_), .c(new_n80_), .O(z11));
  ...
  nand2  g38(.a(new_n82_), .b(new_n71_), .O(new_n89_));
  nor2   g39(.a(x22), .b(x21), .O(new_n90_));
  aoi22  g40(.a(new_n90_), .b(new_n73_), .c(new_n89_), .d(x22), .O(new_n91_));
  oai21  g41(.a(new_n91_), .b(new_n76_), .c(new_n88_), .O(z12));
  nand2  g42(.a(x18), .b(x04), .O(new_n93_));
  oai21  g43(.a(x18), .b(new_n54_), .c(new_n93_), .O(new_n94_));
  nand2  g44(.a(new_n94_), .b(new_n76_), .O(new_n95_));
  nand3  g45(.a(new_n90_), .b(new_n71_), .c(new_n70_), .O(new_n96_));
  nor3   g46(.a(x23), .b(x22), .c(x21), .O(new_n97_));
  aoi22  g47(.a(new_n97_), .b(new_n73_), .c(new_n96_), .d(x23), .O(new_n98_));
  oai21  g48(.a(new_n98_), .b(new_n76_), .c(new_n95_), .O(z13));
  inv1   g49(.a(x13), .O(new_n100_));
  nand2  g50(.a(x18), .b(x05), .O(new_n101_));
  oai21  g51(.a(x18), .b(new_n100_), .c(new_n101_), .O(new_n102_));
  nand2  g52(.a(new_n102_), .b(new_n76_), .O(new_n103_));
  aoi21  g53(.a(new_n97_), .b(new_n73_), .c(new_n57_), .O(new_n104_));
  nor2   g54(.a(x24), .b(x23), .O(new_n105_));
  nand4  g55(.a(new_n105_), .b(new_n90_), .c(new_n71_), .d(new_n70_), .O(new_n106_));
  ...
  nand2  g61(.a(new_n111_), .b(new_n76_), .O(new_n112_));
  nand2  g62(.a(new_n106_), .b(x25), .O(new_n113_));
  nor2   g63(.a(x23), .b(x22), .O(new_n114_));
  nor2   g64(.a(x25), .b(x24), .O(new_n115_));
  nand4  g65(.a(new_n115_), .b(new_n114_), .c(new_n82_), .d(new_n71_), .O(new_n116_));
  ...
  nand4  g74(.a(new_n124_), .b(new_n114_), .c(new_n82_), .d(new_n71_), .O(new_n125_));
  ...
  nand4  g79(.a(new_n129_), .b(new_n124_), .c(new_n114_), .d(new_n82_), .O(new_n130_));
