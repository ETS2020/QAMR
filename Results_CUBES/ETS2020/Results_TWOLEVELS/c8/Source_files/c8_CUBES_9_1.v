...
module FAU ( 
  ...
  nand4  g49(.a(new_n97_), .b(new_n58_), .c(new_n55_), .d(new_n52_), .O(new_n100_));
  nor2   g50(.a(new_n100_), .b(new_n87_), .O(new_n101_));
  oai21  g51(.a(new_n101_), .b(new_n99_), .c(x16), .O(new_n102_));
  nand2  g52(.a(new_n102_), .b(new_n96_), .O(z14));
  nand2  g53(.a(x18), .b(x07), .O(new_n105_));
  oai21  g54(.a(x18), .b(new_n65_), .c(new_n105_), .O(new_n106_));
  nand2  g55(.a(new_n106_), .b(new_n82_), .O(new_n107_));
  nor2   g56(.a(x23), .b(x22), .O(new_n108_));
  nor2   g57(.a(x25), .b(x24), .O(new_n109_));
  nand4  g58(.a(new_n109_), .b(new_n108_), .c(new_n88_), .d(new_n69_), .O(new_n110_));
  nand2  g59(.a(new_n110_), .b(x26), .O(new_n111_));
  nor3   g60(.a(x26), .b(x25), .c(x24), .O(new_n112_));
  nand4  g61(.a(new_n112_), .b(new_n108_), .c(new_n88_), .d(new_n69_), .O(new_n113_));
  nand2  g62(.a(new_n113_), .b(new_n111_), .O(new_n114_));
  nand2  g63(.a(new_n114_), .b(x16), .O(new_n115_));
  nand2  g64(.a(new_n115_), .b(new_n107_), .O(z16));
  inv1   g65(.a(x19), .O(new_n117_));
  nor2   g66(.a(new_n117_), .b(x17), .O(new_n118_));
  nand4  g67(.a(new_n118_), .b(new_n112_), .c(new_n108_), .d(new_n88_), .O(new_n119_));
  nand2  g68(.a(x27), .b(x17), .O(new_n120_));
  aoi21  g69(.a(new_n120_), .b(new_n119_), .c(new_n82_), .O(z17));
  zero   g70(.O(z00));
  zero   g71(.O(z05));
  zero   g72(.O(z12));
  zero   g73(.O(z13));
