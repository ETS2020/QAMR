...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17;
  wire new_n48_, new_n49_, new_n56_, new_n57_, new_n59_, new_n60_, new_n61_,
  ...
  nor2   g13(.a(x18), .b(new_n48_), .O(new_n66_));
  aoi21  g14(.a(x18), .b(x01), .c(new_n66_), .O(new_n67_));
  inv1   g15(.a(x20), .O(new_n68_));
  nor2   g16(.a(new_n60_), .b(new_n68_), .O(new_n69_));
  nor3   g17(.a(x20), .b(x19), .c(x17), .O(new_n70_));
  oai21  g18(.a(new_n70_), .b(new_n69_), .c(x16), .O(new_n71_));
  oai21  g19(.a(new_n67_), .b(x16), .c(new_n71_), .O(z10));
  ...
  nand2  g26(.a(new_n79_), .b(new_n60_), .O(new_n80_));
  nor2   g27(.a(x22), .b(x21), .O(new_n81_));
  aoi22  g28(.a(new_n81_), .b(new_n70_), .c(new_n80_), .d(x22), .O(new_n82_));
  ...
  nand3  g34(.a(new_n81_), .b(new_n60_), .c(new_n68_), .O(new_n88_));
  nor3   g35(.a(x23), .b(x22), .c(x21), .O(new_n89_));
  aoi22  g36(.a(new_n89_), .b(new_n70_), .c(new_n88_), .d(x23), .O(new_n90_));
  oai21  g37(.a(new_n90_), .b(new_n74_), .c(new_n87_), .O(z13));
  inv1   g38(.a(x13), .O(new_n92_));
  nand2  g39(.a(x18), .b(x05), .O(new_n93_));
  oai21  g40(.a(x18), .b(new_n92_), .c(new_n93_), .O(new_n94_));
  nand2  g41(.a(new_n94_), .b(new_n74_), .O(new_n95_));
  inv1   g42(.a(x24), .O(new_n96_));
  aoi21  g43(.a(new_n89_), .b(new_n70_), .c(new_n96_), .O(new_n97_));
  nand2  g44(.a(new_n60_), .b(new_n68_), .O(new_n98_));
  nor2   g45(.a(x24), .b(x23), .O(new_n99_));
  nand2  g46(.a(new_n99_), .b(new_n81_), .O(new_n100_));
  ...
  nand2  g52(.a(new_n106_), .b(new_n74_), .O(new_n107_));
  nor2   g53(.a(x23), .b(x22), .O(new_n108_));
  nor2   g54(.a(x25), .b(x24), .O(new_n109_));
  nand4  g55(.a(new_n109_), .b(new_n108_), .c(new_n79_), .d(new_n60_), .O(new_n110_));
  nand2  g56(.a(new_n110_), .b(x26), .O(new_n111_));
  nor3   g57(.a(x26), .b(x25), .c(x24), .O(new_n112_));
  nand4  g58(.a(new_n112_), .b(new_n108_), .c(new_n79_), .d(new_n60_), .O(new_n113_));
