...
module FAU ( 
  ...
  wire new_n47_, new_n48_, new_n49_, new_n51_, new_n52_, new_n54_, new_n55_,
    new_n57_, new_n58_, new_n60_, new_n61_, new_n63_, new_n64_, new_n69_,
  ...
  nand4  g54(.a(new_n104_), .b(new_n89_), .c(new_n72_), .d(new_n51_), .O(new_n105_));
  nand2  g55(.a(new_n105_), .b(x25), .O(new_n106_));
  nor2   g56(.a(x23), .b(x22), .O(new_n107_));
  nor2   g57(.a(x25), .b(x24), .O(new_n108_));
  nand4  g58(.a(new_n108_), .b(new_n107_), .c(new_n82_), .d(new_n72_), .O(new_n109_));
  ...
  nand2  g65(.a(new_n115_), .b(new_n77_), .O(new_n116_));
  nand2  g66(.a(new_n109_), .b(x26), .O(new_n117_));
  nor3   g67(.a(x26), .b(x25), .c(x24), .O(new_n118_));
  nand4  g68(.a(new_n118_), .b(new_n107_), .c(new_n82_), .d(new_n72_), .O(new_n119_));
  ...
  nand4  g73(.a(new_n123_), .b(new_n118_), .c(new_n107_), .d(new_n82_), .O(new_n124_));
  nand2  g74(.a(x27), .b(x17), .O(new_n125_));
  aoi21  g75(.a(new_n125_), .b(new_n124_), .c(new_n77_), .O(z17));
  zero   g76(.O(z06));
  zero   g77(.O(z07));
  zero   g78(.O(z09));
  zero   g79(.O(z14));
