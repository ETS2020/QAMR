...
module FAU ( 
  ...
  nand4  g51(.a(new_n102_), .b(new_n93_), .c(new_n67_), .d(new_n76_), .O(new_n103_));
  nand2  g52(.a(new_n103_), .b(x25), .O(new_n104_));
  nor2   g53(.a(x23), .b(x22), .O(new_n105_));
  nor2   g54(.a(x25), .b(x24), .O(new_n106_));
  nand4  g55(.a(new_n106_), .b(new_n105_), .c(new_n86_), .d(new_n67_), .O(new_n107_));
  ...
  nand2  g62(.a(new_n113_), .b(new_n81_), .O(new_n114_));
  nand2  g63(.a(new_n107_), .b(x26), .O(new_n115_));
  nor3   g64(.a(x26), .b(x25), .c(x24), .O(new_n116_));
  nand4  g65(.a(new_n116_), .b(new_n105_), .c(new_n86_), .d(new_n67_), .O(new_n117_));
  ...
  nand4  g71(.a(new_n122_), .b(new_n116_), .c(new_n105_), .d(new_n86_), .O(new_n123_));
  nand2  g72(.a(x27), .b(x17), .O(new_n124_));
  aoi21  g73(.a(new_n124_), .b(new_n123_), .c(new_n81_), .O(z17));
  zero   g74(.O(z00));
  zero   g75(.O(z01));
  zero   g76(.O(z07));
  zero   g77(.O(z12));
