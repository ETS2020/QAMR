...
module FAU ( 
  ...
  nand2  g30(.a(new_n68_), .b(new_n80_), .O(new_n81_));
  nand4  g31(.a(new_n52_), .b(new_n80_), .c(new_n48_), .d(new_n66_), .O(new_n82_));
  inv1   g32(.a(new_n82_), .O(new_n83_));
  aoi21  g33(.a(new_n81_), .b(x21), .c(new_n83_), .O(new_n84_));
  oai21  g34(.a(new_n84_), .b(new_n75_), .c(new_n79_), .O(z11));
  inv1   g35(.a(x11), .O(new_n86_));
  nand2  g36(.a(x18), .b(x03), .O(new_n87_));
  oai21  g37(.a(x18), .b(new_n86_), .c(new_n87_), .O(new_n88_));
  nand2  g38(.a(new_n88_), .b(new_n75_), .O(new_n89_));
  nor3   g39(.a(x20), .b(x19), .c(x17), .O(new_n90_));
  nor2   g40(.a(x22), .b(x21), .O(new_n91_));
  aoi22  g41(.a(new_n91_), .b(new_n90_), .c(new_n82_), .d(x22), .O(new_n92_));
  oai21  g42(.a(new_n92_), .b(new_n75_), .c(new_n89_), .O(z12));
  ...
  nand3  g47(.a(new_n91_), .b(new_n68_), .c(new_n80_), .O(new_n98_));
  nor3   g48(.a(x23), .b(x22), .c(x21), .O(new_n99_));
  aoi22  g49(.a(new_n99_), .b(new_n90_), .c(new_n98_), .d(x23), .O(new_n100_));
  ...
  nand2  g54(.a(new_n104_), .b(new_n75_), .O(new_n105_));
  aoi21  g55(.a(new_n99_), .b(new_n90_), .c(new_n61_), .O(new_n106_));
  nor2   g56(.a(x24), .b(x23), .O(new_n107_));
  nand4  g57(.a(new_n107_), .b(new_n91_), .c(new_n68_), .d(new_n80_), .O(new_n108_));
  ...
  nand2  g64(.a(new_n114_), .b(new_n75_), .O(new_n115_));
  inv1   g65(.a(x25), .O(new_n116_));
  nand4  g66(.a(new_n116_), .b(new_n61_), .c(new_n58_), .d(new_n55_), .O(new_n117_));
  inv1   g67(.a(new_n117_), .O(new_n118_));
  aoi22  g68(.a(new_n118_), .b(new_n83_), .c(new_n108_), .d(x25), .O(new_n119_));
  oai21  g69(.a(new_n119_), .b(new_n75_), .c(new_n115_), .O(z15));
  ...
  aoi21  g76(.a(new_n127_), .b(new_n126_), .c(new_n75_), .O(z17));
  zero   g77(.O(z01));
  zero   g78(.O(z06));
  zero   g79(.O(z07));
  zero   g80(.O(z10));
