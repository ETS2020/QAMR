...
module FAU ( 
  ...
  oai21  g39(.a(x18), .b(new_n58_), .c(new_n89_), .O(new_n90_));
  nand2  g40(.a(new_n90_), .b(new_n80_), .O(new_n91_));
  nor2   g41(.a(x22), .b(x21), .O(new_n92_));
  nand3  g42(.a(new_n92_), .b(new_n67_), .c(new_n49_), .O(new_n93_));
  ...
  oai21  g47(.a(x18), .b(new_n62_), .c(new_n98_), .O(new_n99_));
  nand2  g48(.a(new_n99_), .b(new_n80_), .O(new_n100_));
  nor2   g49(.a(x24), .b(x23), .O(new_n101_));
  nand4  g50(.a(new_n101_), .b(new_n92_), .c(new_n67_), .d(new_n49_), .O(new_n102_));
  nand2  g51(.a(new_n102_), .b(x25), .O(new_n103_));
  nor2   g52(.a(x23), .b(x22), .O(new_n104_));
  nor2   g53(.a(x25), .b(x24), .O(new_n105_));
  nand4  g54(.a(new_n105_), .b(new_n104_), .c(new_n85_), .d(new_n67_), .O(new_n106_));
  ...
  nand2  g61(.a(new_n112_), .b(new_n80_), .O(new_n113_));
  nand2  g62(.a(new_n106_), .b(x26), .O(new_n114_));
  nor3   g63(.a(x26), .b(x25), .c(x24), .O(new_n115_));
  nand4  g64(.a(new_n115_), .b(new_n104_), .c(new_n85_), .d(new_n67_), .O(new_n116_));
  ...
  nand4  g70(.a(new_n121_), .b(new_n115_), .c(new_n104_), .d(new_n85_), .O(new_n122_));
