...
module FAU ( 
  ...
  nand3  g44(.a(new_n80_), .b(new_n95_), .c(new_n54_), .O(new_n98_));
  nor2   g45(.a(new_n98_), .b(new_n97_), .O(new_n99_));
  oai21  g46(.a(new_n99_), .b(new_n96_), .c(x16), .O(new_n100_));
  nand2  g47(.a(new_n100_), .b(new_n94_), .O(z14));
  nand2  g48(.a(x18), .b(x07), .O(new_n103_));
  oai21  g49(.a(x18), .b(new_n59_), .c(new_n103_), .O(new_n104_));
  nand2  g50(.a(new_n104_), .b(new_n73_), .O(new_n105_));
  nor2   g51(.a(x23), .b(x22), .O(new_n106_));
  nor2   g52(.a(x25), .b(x24), .O(new_n107_));
  nand4  g53(.a(new_n107_), .b(new_n106_), .c(new_n78_), .d(new_n67_), .O(new_n108_));
  nand2  g54(.a(new_n108_), .b(x26), .O(new_n109_));
  nor3   g55(.a(x26), .b(x25), .c(x24), .O(new_n110_));
  nand4  g56(.a(new_n110_), .b(new_n106_), .c(new_n78_), .d(new_n67_), .O(new_n111_));
  nand2  g57(.a(new_n111_), .b(new_n109_), .O(new_n112_));
  nand2  g58(.a(new_n112_), .b(x16), .O(new_n113_));
  nand2  g59(.a(new_n113_), .b(new_n105_), .O(z16));
  nor2   g60(.a(new_n48_), .b(x17), .O(new_n115_));
  nand4  g61(.a(new_n115_), .b(new_n110_), .c(new_n106_), .d(new_n78_), .O(new_n116_));
  nand2  g62(.a(x27), .b(x17), .O(new_n117_));
  aoi21  g63(.a(new_n117_), .b(new_n116_), .c(new_n73_), .O(z17));
  zero   g64(.O(z01));
  zero   g65(.O(z02));
  zero   g66(.O(z03));
  zero   g67(.O(z05));
