...
module FAU ( 
  ...
  inv1   g38(.a(x10), .O(new_n87_));
  nand2  g39(.a(x18), .b(x02), .O(new_n88_));
  oai21  g40(.a(x18), .b(new_n87_), .c(new_n88_), .O(new_n89_));
  nand2  g41(.a(new_n89_), .b(new_n86_), .O(new_n90_));
  nor2   g42(.a(new_n83_), .b(new_n54_), .O(new_n91_));
  nand4  g43(.a(new_n54_), .b(new_n51_), .c(new_n48_), .d(new_n71_), .O(new_n92_));
  inv1   g44(.a(new_n92_), .O(new_n93_));
  oai21  g45(.a(new_n93_), .b(new_n91_), .c(x16), .O(new_n94_));
  nand2  g46(.a(new_n94_), .b(new_n90_), .O(z11));
  inv1   g47(.a(x11), .O(new_n96_));
  nand2  g48(.a(x18), .b(x03), .O(new_n97_));
  oai21  g49(.a(x18), .b(new_n96_), .c(new_n97_), .O(new_n98_));
  nand2  g50(.a(new_n98_), .b(new_n86_), .O(new_n99_));
  nor2   g51(.a(x22), .b(x21), .O(new_n100_));
  aoi22  g52(.a(new_n100_), .b(new_n83_), .c(new_n92_), .d(x22), .O(new_n101_));
  oai21  g53(.a(new_n101_), .b(new_n86_), .c(new_n99_), .O(z12));
  inv1   g54(.a(x14), .O(new_n105_));
  nand2  g55(.a(x18), .b(x06), .O(new_n106_));
  oai21  g56(.a(x18), .b(new_n105_), .c(new_n106_), .O(new_n107_));
  nand2  g57(.a(new_n107_), .b(new_n86_), .O(new_n108_));
  nor2   g58(.a(x24), .b(x23), .O(new_n109_));
  nand4  g59(.a(new_n109_), .b(new_n100_), .c(new_n73_), .d(new_n51_), .O(new_n110_));
  inv1   g60(.a(x23), .O(new_n111_));
  nand4  g61(.a(new_n64_), .b(new_n61_), .c(new_n111_), .d(new_n57_), .O(new_n112_));
  inv1   g62(.a(new_n112_), .O(new_n113_));
  aoi22  g63(.a(new_n113_), .b(new_n93_), .c(new_n110_), .d(x25), .O(new_n114_));
  oai21  g64(.a(new_n114_), .b(new_n86_), .c(new_n108_), .O(z15));
  nor2   g65(.a(x21), .b(x20), .O(new_n117_));
  nor2   g66(.a(x23), .b(x22), .O(new_n118_));
  nor3   g67(.a(x26), .b(x25), .c(x24), .O(new_n119_));
  nor2   g68(.a(new_n48_), .b(x17), .O(new_n120_));
  nand4  g69(.a(new_n120_), .b(new_n119_), .c(new_n118_), .d(new_n117_), .O(new_n121_));
  nand2  g70(.a(x27), .b(x17), .O(new_n122_));
  aoi21  g71(.a(new_n122_), .b(new_n121_), .c(new_n86_), .O(z17));
  zero   g72(.O(z04));
  zero   g73(.O(z08));
  zero   g74(.O(z13));
  zero   g75(.O(z14));
