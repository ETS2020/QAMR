...
module FAU ( 
  ...
  nand2  g53(.a(new_n102_), .b(new_n90_), .O(new_n103_));
  aoi21  g54(.a(new_n97_), .b(new_n85_), .c(new_n63_), .O(new_n104_));
  nor2   g55(.a(x24), .b(x23), .O(new_n105_));
  nand4  g56(.a(new_n105_), .b(new_n95_), .c(new_n75_), .d(new_n51_), .O(new_n106_));
  ...
  nand2  g63(.a(new_n112_), .b(new_n90_), .O(new_n113_));
  nand4  g64(.a(new_n66_), .b(new_n63_), .c(new_n48_), .d(new_n73_), .O(new_n114_));
  inv1   g65(.a(new_n114_), .O(new_n115_));
  nand4  g66(.a(new_n60_), .b(new_n57_), .c(new_n54_), .d(new_n51_), .O(new_n116_));
  inv1   g67(.a(new_n116_), .O(new_n117_));
  aoi22  g68(.a(new_n117_), .b(new_n115_), .c(new_n106_), .d(x25), .O(new_n118_));
  oai21  g69(.a(new_n118_), .b(new_n90_), .c(new_n113_), .O(z15));
  nor2   g70(.a(x23), .b(x22), .O(new_n121_));
  nor2   g71(.a(x21), .b(x20), .O(new_n122_));
  ...
  aoi21  g76(.a(new_n126_), .b(new_n125_), .c(new_n90_), .O(z17));
  zero   g77(.O(z08));
  zero   g78(.O(z11));
  zero   g79(.O(z12));
  zero   g80(.O(z16));
