...
module FAU ( 
  ...
  aoi21  g44(.a(new_n96_), .b(new_n71_), .c(new_n57_), .O(new_n97_));
  nand3  g45(.a(new_n88_), .b(new_n57_), .c(new_n54_), .O(new_n98_));
  nor2   g46(.a(new_n98_), .b(new_n79_), .O(new_n99_));
  oai21  g47(.a(new_n99_), .b(new_n97_), .c(x16), .O(new_n100_));
  nand2  g48(.a(new_n100_), .b(new_n95_), .O(z14));
  nand2  g49(.a(x18), .b(x07), .O(new_n103_));
  oai21  g50(.a(x18), .b(new_n61_), .c(new_n103_), .O(new_n104_));
  nand2  g51(.a(new_n104_), .b(new_n74_), .O(new_n105_));
  nor2   g52(.a(x23), .b(x22), .O(new_n106_));
  nor2   g53(.a(x25), .b(x24), .O(new_n107_));
  nand4  g54(.a(new_n107_), .b(new_n106_), .c(new_n80_), .d(new_n69_), .O(new_n108_));
  nand2  g55(.a(new_n108_), .b(x26), .O(new_n109_));
  nor3   g56(.a(x26), .b(x25), .c(x24), .O(new_n110_));
  nand4  g57(.a(new_n110_), .b(new_n106_), .c(new_n80_), .d(new_n69_), .O(new_n111_));
  ...
  nand4  g62(.a(new_n115_), .b(new_n110_), .c(new_n106_), .d(new_n80_), .O(new_n116_));
  nand2  g63(.a(x27), .b(x17), .O(new_n117_));
  aoi21  g64(.a(new_n117_), .b(new_n116_), .c(new_n74_), .O(z17));
  zero   g65(.O(z01));
  zero   g66(.O(z02));
  zero   g67(.O(z03));
  zero   g68(.O(z06));
