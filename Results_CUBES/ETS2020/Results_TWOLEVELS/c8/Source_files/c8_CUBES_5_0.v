// Benchmark "FAU" written by ABC on Mon Jul  6 18:49:29 2020
...
module FAU ( 
  ...
  nand2  g35(.a(new_n67_), .b(new_n49_), .O(new_n85_));
  nor2   g36(.a(x21), .b(x20), .O(new_n86_));
  aoi22  g37(.a(new_n86_), .b(new_n67_), .c(new_n85_), .d(x21), .O(new_n87_));
  oai21  g38(.a(new_n87_), .b(new_n80_), .c(new_n84_), .O(z11));
  ...
  aoi21  g44(.a(new_n95_), .b(new_n77_), .c(new_n59_), .O(new_n96_));
  inv1   g45(.a(x23), .O(new_n97_));
  nand4  g46(.a(new_n59_), .b(new_n97_), .c(new_n55_), .d(new_n52_), .O(new_n98_));
  nor2   g47(.a(new_n98_), .b(new_n85_), .O(new_n99_));
