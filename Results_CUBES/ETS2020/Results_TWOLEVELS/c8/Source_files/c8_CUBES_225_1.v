...
module FAU ( 
  ...
  nand3  g48(.a(new_n96_), .b(new_n71_), .c(new_n51_), .O(new_n97_));
  ...
  aoi21  g56(.a(new_n98_), .b(new_n81_), .c(new_n61_), .O(new_n105_));
  nor2   g57(.a(x24), .b(x23), .O(new_n106_));
  nand4  g58(.a(new_n106_), .b(new_n96_), .c(new_n71_), .d(new_n51_), .O(new_n107_));
  ...
  nand2  g64(.a(new_n112_), .b(new_n84_), .O(new_n113_));
  nand2  g65(.a(new_n107_), .b(x25), .O(new_n114_));
  nor2   g66(.a(x23), .b(x22), .O(new_n115_));
  nor2   g67(.a(x25), .b(x24), .O(new_n116_));
  nand4  g68(.a(new_n116_), .b(new_n115_), .c(new_n89_), .d(new_n71_), .O(new_n117_));
  ...
  nand4  g77(.a(new_n125_), .b(new_n115_), .c(new_n89_), .d(new_n71_), .O(new_n126_));
  ...
  nand4  g82(.a(new_n130_), .b(new_n125_), .c(new_n115_), .d(new_n89_), .O(new_n131_));
