...
module FAU ( 
  ...
  nor2   g25(.a(x19), .b(x17), .O(new_n76_));
  nand2  g26(.a(new_n76_), .b(new_n75_), .O(new_n77_));
  inv1   g27(.a(x17), .O(new_n78_));
  inv1   g28(.a(x19), .O(new_n79_));
  nand4  g29(.a(new_n50_), .b(new_n75_), .c(new_n79_), .d(new_n78_), .O(new_n80_));
  inv1   g30(.a(new_n80_), .O(new_n81_));
  aoi21  g31(.a(new_n77_), .b(x21), .c(new_n81_), .O(new_n82_));
  oai21  g32(.a(new_n82_), .b(new_n70_), .c(new_n74_), .O(z11));
  ...
  aoi22  g39(.a(new_n89_), .b(new_n88_), .c(new_n80_), .d(x22), .O(new_n90_));
  oai21  g40(.a(new_n90_), .b(new_n70_), .c(new_n87_), .O(z12));
  inv1   g41(.a(x12), .O(new_n92_));
  nand2  g42(.a(x18), .b(x04), .O(new_n93_));
  oai21  g43(.a(x18), .b(new_n92_), .c(new_n93_), .O(new_n94_));
  nand2  g44(.a(new_n94_), .b(new_n70_), .O(new_n95_));
  nand3  g45(.a(new_n89_), .b(new_n76_), .c(new_n75_), .O(new_n96_));
  nor3   g46(.a(x23), .b(x22), .c(x21), .O(new_n97_));
  aoi22  g47(.a(new_n97_), .b(new_n88_), .c(new_n96_), .d(x23), .O(new_n98_));
  oai21  g48(.a(new_n98_), .b(new_n70_), .c(new_n95_), .O(z13));
  inv1   g49(.a(x13), .O(new_n100_));
  nand2  g50(.a(x18), .b(x05), .O(new_n101_));
  oai21  g51(.a(x18), .b(new_n100_), .c(new_n101_), .O(new_n102_));
  nand2  g52(.a(new_n102_), .b(new_n70_), .O(new_n103_));
  aoi21  g53(.a(new_n97_), .b(new_n88_), .c(new_n59_), .O(new_n104_));
  nor2   g54(.a(x24), .b(x23), .O(new_n105_));
  nand4  g55(.a(new_n105_), .b(new_n89_), .c(new_n76_), .d(new_n75_), .O(new_n106_));
  inv1   g56(.a(new_n106_), .O(new_n107_));
  oai21  g57(.a(new_n107_), .b(new_n104_), .c(x16), .O(new_n108_));
  nand2  g58(.a(new_n108_), .b(new_n103_), .O(z14));
  inv1   g59(.a(x14), .O(new_n110_));
  nand2  g60(.a(x18), .b(x06), .O(new_n111_));
  oai21  g61(.a(x18), .b(new_n110_), .c(new_n111_), .O(new_n112_));
  nand2  g62(.a(new_n112_), .b(new_n70_), .O(new_n113_));
  nand4  g63(.a(new_n62_), .b(new_n59_), .c(new_n56_), .d(new_n53_), .O(new_n114_));
  inv1   g64(.a(new_n114_), .O(new_n115_));
  aoi22  g65(.a(new_n115_), .b(new_n81_), .c(new_n106_), .d(x25), .O(new_n116_));
  oai21  g66(.a(new_n116_), .b(new_n70_), .c(new_n113_), .O(z15));
  nor2   g67(.a(x21), .b(x20), .O(new_n119_));
  nor2   g68(.a(x23), .b(x22), .O(new_n120_));
  nor3   g69(.a(x26), .b(x25), .c(x24), .O(new_n121_));
  nor2   g70(.a(new_n79_), .b(x17), .O(new_n122_));
  nand4  g71(.a(new_n122_), .b(new_n121_), .c(new_n120_), .d(new_n119_), .O(new_n123_));
  nand2  g72(.a(x27), .b(x17), .O(new_n124_));
  aoi21  g73(.a(new_n124_), .b(new_n123_), .c(new_n70_), .O(z17));
  zero   g74(.O(z00));
  zero   g75(.O(z01));
  zero   g76(.O(z09));
  zero   g77(.O(z10));
