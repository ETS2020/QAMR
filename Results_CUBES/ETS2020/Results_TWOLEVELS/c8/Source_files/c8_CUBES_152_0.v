...
module FAU ( 
  ...
  aoi22  g29(.a(new_n81_), .b(new_n70_), .c(new_n80_), .d(x21), .O(new_n82_));
  oai21  g30(.a(new_n82_), .b(new_n75_), .c(new_n79_), .O(z11));
  inv1   g31(.a(x11), .O(new_n84_));
  nand2  g32(.a(x18), .b(x03), .O(new_n85_));
  oai21  g33(.a(x18), .b(new_n84_), .c(new_n85_), .O(new_n86_));
  nand2  g34(.a(new_n86_), .b(new_n75_), .O(new_n87_));
  nand2  g35(.a(new_n81_), .b(new_n70_), .O(new_n88_));
  nor2   g36(.a(x22), .b(x21), .O(new_n89_));
  aoi22  g37(.a(new_n89_), .b(new_n72_), .c(new_n88_), .d(x22), .O(new_n90_));
  oai21  g38(.a(new_n90_), .b(new_n75_), .c(new_n87_), .O(z12));
  inv1   g39(.a(x13), .O(new_n93_));
  nand2  g40(.a(x18), .b(x05), .O(new_n94_));
  oai21  g41(.a(x18), .b(new_n93_), .c(new_n94_), .O(new_n95_));
  nand2  g42(.a(new_n95_), .b(new_n75_), .O(new_n96_));
  nor3   g43(.a(x23), .b(x22), .c(x21), .O(new_n97_));
  aoi21  g44(.a(new_n97_), .b(new_n72_), .c(new_n55_), .O(new_n98_));
  nor2   g45(.a(x24), .b(x23), .O(new_n99_));
  nand2  g46(.a(new_n99_), .b(new_n89_), .O(new_n100_));
  nor2   g47(.a(new_n100_), .b(new_n80_), .O(new_n101_));
  ...
  nand2  g52(.a(new_n106_), .b(new_n75_), .O(new_n107_));
  nor2   g53(.a(x23), .b(x22), .O(new_n108_));
  nor2   g54(.a(x25), .b(x24), .O(new_n109_));
  nand4  g55(.a(new_n109_), .b(new_n108_), .c(new_n81_), .d(new_n70_), .O(new_n110_));
  nand2  g56(.a(new_n110_), .b(x26), .O(new_n111_));
  nor3   g57(.a(x26), .b(x25), .c(x24), .O(new_n112_));
  nand4  g58(.a(new_n112_), .b(new_n108_), .c(new_n81_), .d(new_n70_), .O(new_n113_));
  ...
  nand4  g63(.a(new_n117_), .b(new_n112_), .c(new_n108_), .d(new_n81_), .O(new_n118_));
  nand2  g64(.a(x27), .b(x17), .O(new_n119_));
  aoi21  g65(.a(new_n119_), .b(new_n118_), .c(new_n75_), .O(z17));
  zero   g66(.O(z01));
  zero   g67(.O(z02));
  zero   g68(.O(z03));
  zero   g69(.O(z04));
