...
module FAU ( 
  ...
  nand3  g40(.a(new_n85_), .b(new_n72_), .c(new_n51_), .O(new_n91_));
  ...
  oai21  g45(.a(x18), .b(new_n62_), .c(new_n96_), .O(new_n97_));
  nand2  g46(.a(new_n97_), .b(new_n78_), .O(new_n98_));
  nor2   g47(.a(x24), .b(x23), .O(new_n99_));
  nand4  g48(.a(new_n99_), .b(new_n85_), .c(new_n72_), .d(new_n51_), .O(new_n100_));
  nand2  g49(.a(new_n100_), .b(x25), .O(new_n101_));
  nor2   g50(.a(x23), .b(x22), .O(new_n102_));
  nor2   g51(.a(x25), .b(x24), .O(new_n103_));
  nand4  g52(.a(new_n103_), .b(new_n102_), .c(new_n83_), .d(new_n72_), .O(new_n104_));
  ...
  nand2  g59(.a(new_n104_), .b(x26), .O(new_n111_));
  nor3   g60(.a(x26), .b(x25), .c(x24), .O(new_n112_));
  nand4  g61(.a(new_n112_), .b(new_n102_), .c(new_n83_), .d(new_n72_), .O(new_n113_));
