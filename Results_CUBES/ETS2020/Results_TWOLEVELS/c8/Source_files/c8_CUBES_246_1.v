...
module FAU ( 
  ...
  aoi21  g53(.a(new_n101_), .b(new_n83_), .c(new_n63_), .O(new_n102_));
  nand4  g54(.a(new_n63_), .b(new_n60_), .c(new_n57_), .d(new_n54_), .O(new_n103_));
  nor2   g55(.a(new_n103_), .b(new_n91_), .O(new_n104_));
  oai21  g56(.a(new_n104_), .b(new_n102_), .c(x16), .O(new_n105_));
  nand2  g57(.a(new_n105_), .b(new_n100_), .O(z14));
  nand2  g58(.a(x18), .b(x07), .O(new_n108_));
  oai21  g59(.a(x18), .b(new_n69_), .c(new_n108_), .O(new_n109_));
  nand2  g60(.a(new_n109_), .b(new_n86_), .O(new_n110_));
  nor2   g61(.a(x23), .b(x22), .O(new_n111_));
  nor2   g62(.a(x25), .b(x24), .O(new_n112_));
  nand4  g63(.a(new_n112_), .b(new_n111_), .c(new_n92_), .d(new_n73_), .O(new_n113_));
  nand2  g64(.a(new_n113_), .b(x26), .O(new_n114_));
  nor3   g65(.a(x26), .b(x25), .c(x24), .O(new_n115_));
  nand4  g66(.a(new_n115_), .b(new_n111_), .c(new_n92_), .d(new_n73_), .O(new_n116_));
  nand2  g67(.a(new_n116_), .b(new_n114_), .O(new_n117_));
  nand2  g68(.a(new_n117_), .b(x16), .O(new_n118_));
  nand2  g69(.a(new_n118_), .b(new_n110_), .O(z16));
  nor2   g70(.a(new_n48_), .b(x17), .O(new_n120_));
  nand4  g71(.a(new_n120_), .b(new_n115_), .c(new_n111_), .d(new_n92_), .O(new_n121_));
  nand2  g72(.a(x27), .b(x17), .O(new_n122_));
  aoi21  g73(.a(new_n122_), .b(new_n121_), .c(new_n86_), .O(z17));
  zero   g74(.O(z12));
  zero   g75(.O(z13));
  zero   g76(.O(z15));
  buf    g77(.a(x27), .O(z08));
