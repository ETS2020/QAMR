...
module FAU ( 
  ...
  aoi21  g66(.a(new_n107_), .b(new_n82_), .c(new_n63_), .O(new_n114_));
  nor2   g67(.a(x24), .b(x23), .O(new_n115_));
  nand4  g68(.a(new_n115_), .b(new_n99_), .c(new_n72_), .d(new_n51_), .O(new_n116_));
  inv1   g69(.a(new_n116_), .O(new_n117_));
  oai21  g70(.a(new_n117_), .b(new_n114_), .c(x16), .O(new_n118_));
  nand2  g71(.a(new_n118_), .b(new_n113_), .O(z14));
  inv1   g72(.a(x14), .O(new_n120_));
  nand2  g73(.a(x18), .b(x06), .O(new_n121_));
  oai21  g74(.a(x18), .b(new_n120_), .c(new_n121_), .O(new_n122_));
  nand2  g75(.a(new_n122_), .b(new_n85_), .O(new_n123_));
  nand4  g76(.a(new_n66_), .b(new_n63_), .c(new_n60_), .d(new_n57_), .O(new_n124_));
  inv1   g77(.a(new_n124_), .O(new_n125_));
  aoi22  g78(.a(new_n125_), .b(new_n92_), .c(new_n116_), .d(x25), .O(new_n126_));
  oai21  g79(.a(new_n126_), .b(new_n85_), .c(new_n123_), .O(z15));
  nor2   g80(.a(x21), .b(x20), .O(new_n129_));
  nor2   g81(.a(x23), .b(x22), .O(new_n130_));
  nor3   g82(.a(x26), .b(x25), .c(x24), .O(new_n131_));
  nor2   g83(.a(new_n48_), .b(x17), .O(new_n132_));
  nand4  g84(.a(new_n132_), .b(new_n131_), .c(new_n130_), .d(new_n129_), .O(new_n133_));
