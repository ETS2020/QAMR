...
module FAU ( 
  ...
  wire new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n33_, new_n34_,
    new_n35_, new_n36_, new_n37_, new_n38_, new_n40_, new_n43_, new_n46_,
    new_n50_, new_n51_;
  ...
  nand4  g15(.a(new_n28_), .b(new_n27_), .c(x01), .d(x00), .O(new_n43_));
  nor2   g16(.a(new_n43_), .b(new_n35_), .O(z05));
  nand2  g17(.a(new_n28_), .b(new_n27_), .O(new_n46_));
  nor2   g18(.a(new_n35_), .b(new_n46_), .O(z07));
  and2   g19(.a(x13), .b(x06), .O(z09));
  nand2  g20(.a(x05), .b(x02), .O(new_n50_));
  nand3  g21(.a(new_n50_), .b(x06), .c(new_n33_), .O(new_n51_));
