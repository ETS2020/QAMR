...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n32_,
    new_n35_, new_n36_, new_n37_, new_n38_, new_n39_, new_n42_, new_n44_,
  ...
  nand4  g14(.a(new_n26_), .b(new_n27_), .c(x01), .d(new_n37_), .O(new_n42_));
  nor2   g15(.a(new_n42_), .b(new_n36_), .O(z04));
  nand4  g16(.a(new_n26_), .b(new_n27_), .c(x01), .d(x00), .O(new_n44_));
  nor2   g17(.a(new_n44_), .b(new_n36_), .O(z05));
