...
module FAU ( 
  ...
  wire new_n28_, new_n29_, new_n30_, new_n31_, new_n32_, new_n33_, new_n34_,
    new_n35_, new_n37_, new_n39_, new_n41_, new_n44_, new_n48_, new_n49_;
  ...
  nand2  g18(.a(x05), .b(x02), .O(new_n48_));
  nand3  g19(.a(new_n48_), .b(x06), .c(new_n34_), .O(new_n49_));
  inv1   g20(.a(new_n49_), .O(z10));
  zero   g21(.O(z00));
  zero   g22(.O(z01));
  zero   g23(.O(z06));
  zero   g24(.O(z08));
