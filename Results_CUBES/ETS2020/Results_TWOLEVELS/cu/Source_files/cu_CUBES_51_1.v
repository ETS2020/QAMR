// Benchmark "FAU" written by ABC on Tue Jul  7 10:50:41 2020
...
module FAU ( 
  ...
  nand4  g24(.a(x13), .b(new_n51_), .c(x05), .d(new_n27_), .O(new_n52_));
  ...
  nand3  g30(.a(new_n57_), .b(x06), .c(new_n26_), .O(new_n58_));
