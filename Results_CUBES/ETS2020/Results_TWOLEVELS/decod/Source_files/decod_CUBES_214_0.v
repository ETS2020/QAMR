...
module FAU ( 
  ...
  nand3  g15(.a(new_n24_), .b(x1), .c(new_n37_), .O(new_n41_));
  nor2   g16(.a(new_n41_), .b(new_n26_), .O(z10));
  nor2   g17(.a(new_n41_), .b(new_n29_), .O(z11));
  nand3  g18(.a(x2), .b(new_n33_), .c(new_n37_), .O(new_n44_));
  nor2   g19(.a(new_n44_), .b(new_n26_), .O(z12));
  nor2   g20(.a(new_n44_), .b(new_n29_), .O(z13));
  nand3  g21(.a(new_n24_), .b(new_n33_), .c(new_n37_), .O(new_n47_));
  nor2   g22(.a(new_n47_), .b(new_n26_), .O(z14));
  nor2   g23(.a(new_n47_), .b(new_n29_), .O(z15));
  zero   g24(.O(z00));
  zero   g25(.O(z01));
  zero   g26(.O(z04));
  zero   g27(.O(z05));
