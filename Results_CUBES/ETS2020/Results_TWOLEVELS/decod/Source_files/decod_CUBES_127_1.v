// Benchmark "FAU" written by ABC on Tue Jul  7 10:46:25 2020
...
module FAU ( 
  ...
  nand3  g10(.a(new_n28_), .b(new_n32_), .c(x0), .O(new_n35_));
  ...
  nand3  g19(.a(new_n28_), .b(x1), .c(new_n40_), .O(new_n44_));
  ...
  nand3  g25(.a(new_n28_), .b(new_n32_), .c(new_n40_), .O(new_n50_));
  nor2   g26(.a(new_n50_), .b(new_n36_), .O(z14));
  nor2   g27(.a(new_n50_), .b(new_n38_), .O(z15));
  zero   g28(.O(z00));
  zero   g29(.O(z02));
  zero   g30(.O(z04));
endmodule
