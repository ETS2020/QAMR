...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n27_, new_n28_, new_n29_, new_n31_, new_n32_,
    new_n33_, new_n35_, new_n38_, new_n40_, new_n41_, new_n46_, new_n49_;
  ...
  nor2   g17(.a(new_n41_), .b(new_n33_), .O(z08));
  nor2   g18(.a(new_n41_), .b(new_n35_), .O(z09));
  nand3  g19(.a(x2), .b(new_n31_), .c(new_n40_), .O(new_n46_));
  nor2   g20(.a(new_n46_), .b(new_n33_), .O(z12));
  nor2   g21(.a(new_n46_), .b(new_n35_), .O(z13));
  nand3  g22(.a(new_n27_), .b(new_n31_), .c(new_n40_), .O(new_n49_));
  nor2   g23(.a(new_n49_), .b(new_n33_), .O(z14));
  nor2   g24(.a(new_n49_), .b(new_n35_), .O(z15));
  zero   g25(.O(z01));
  zero   g26(.O(z02));
  zero   g27(.O(z06));
  zero   g28(.O(z10));
