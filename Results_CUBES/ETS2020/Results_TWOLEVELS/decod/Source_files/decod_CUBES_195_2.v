...
module FAU ( 
  ...
  nand2  g18(.a(new_n35_), .b(new_n39_), .O(new_n46_));
  nor2   g19(.a(new_n46_), .b(new_n41_), .O(z12));
  nand3  g20(.a(new_n29_), .b(new_n35_), .c(new_n39_), .O(new_n49_));
  nor2   g21(.a(new_n49_), .b(new_n23_), .O(z14));
  nor2   g22(.a(new_n49_), .b(new_n26_), .O(z15));
  zero   g23(.O(z03));
  zero   g24(.O(z04));
  zero   g25(.O(z05));
  zero   g26(.O(z07));
