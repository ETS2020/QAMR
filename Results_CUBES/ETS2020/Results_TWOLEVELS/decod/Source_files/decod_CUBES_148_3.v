...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n30_,
    new_n34_, new_n35_, new_n36_, new_n39_, new_n41_, new_n42_, new_n45_,
    new_n48_, new_n51_;
  ...
  nand3  g14(.a(x4), .b(new_n25_), .c(new_n29_), .O(new_n39_));
  ...
  nor2   g19(.a(new_n42_), .b(new_n26_), .O(z09));
  nand3  g20(.a(new_n29_), .b(x1), .c(new_n41_), .O(new_n45_));
  nor2   g21(.a(new_n45_), .b(new_n23_), .O(z10));
  nor2   g22(.a(new_n45_), .b(new_n26_), .O(z11));
  nand3  g23(.a(x2), .b(new_n34_), .c(new_n41_), .O(new_n48_));
  nor2   g24(.a(new_n48_), .b(new_n23_), .O(z12));
  nor2   g25(.a(new_n48_), .b(new_n26_), .O(z13));
  nand3  g26(.a(new_n29_), .b(new_n34_), .c(new_n41_), .O(new_n51_));
