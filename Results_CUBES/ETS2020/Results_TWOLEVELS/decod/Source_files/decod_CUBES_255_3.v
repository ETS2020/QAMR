// Benchmark "FAU" written by ABC on Tue Jul  7 10:46:55 2020
...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n26_, new_n27_, new_n30_, new_n31_, new_n32_,
    new_n34_, new_n35_, new_n39_, new_n40_, new_n43_, new_n46_, new_n49_;
  ...
  nor2   g15(.a(new_n40_), .b(new_n32_), .O(z08));
  nor2   g16(.a(new_n40_), .b(new_n35_), .O(z09));
  nand2  g17(.a(x1), .b(new_n39_), .O(new_n43_));
  nor2   g18(.a(new_n43_), .b(new_n27_), .O(z10));
  nand2  g19(.a(new_n30_), .b(new_n39_), .O(new_n46_));
  nor2   g20(.a(new_n46_), .b(new_n23_), .O(z12));
  nand3  g21(.a(new_n26_), .b(new_n30_), .c(new_n39_), .O(new_n49_));
  nor2   g22(.a(new_n49_), .b(new_n32_), .O(z14));
  nor2   g23(.a(new_n49_), .b(new_n35_), .O(z15));
  zero   g24(.O(z01));
  zero   g25(.O(z03));
  zero   g26(.O(z06));
  zero   g27(.O(z07));
