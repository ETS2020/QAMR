...
module FAU ( 
  ...
  wire new_n23_, new_n24_, new_n25_, new_n29_, new_n30_, new_n31_, new_n33_,
    new_n35_, new_n36_, new_n39_, new_n40_, new_n41_, new_n44_, new_n47_,
    new_n50_;
  ...
  nand3  g18(.a(x4), .b(x3), .c(new_n35_), .O(new_n44_));
  nor2   g19(.a(new_n44_), .b(new_n40_), .O(z10));
  nand3  g20(.a(x2), .b(new_n29_), .c(new_n39_), .O(new_n47_));
  nor2   g21(.a(new_n47_), .b(new_n31_), .O(z12));
  nor2   g22(.a(new_n47_), .b(new_n33_), .O(z13));
  nand3  g23(.a(new_n35_), .b(new_n29_), .c(new_n39_), .O(new_n50_));
