...
module FAU ( 
  ...
  wire new_n24_, new_n25_, new_n26_, new_n29_, new_n30_, new_n31_, new_n35_,
    new_n36_, new_n38_, new_n39_, new_n40_, new_n42_, new_n44_, new_n47_,
    new_n50_;
  ...
  nand2  g15(.a(x4), .b(new_n35_), .O(new_n42_));
  nor2   g16(.a(new_n42_), .b(new_n39_), .O(z09));
  nand2  g17(.a(x1), .b(new_n38_), .O(new_n44_));
  nor2   g18(.a(new_n44_), .b(new_n26_), .O(z10));
  nand3  g19(.a(x2), .b(new_n29_), .c(new_n38_), .O(new_n47_));
  nor2   g20(.a(new_n47_), .b(new_n40_), .O(z12));
  nor2   g21(.a(new_n47_), .b(new_n42_), .O(z13));
  nand2  g22(.a(new_n29_), .b(new_n38_), .O(new_n50_));
  nor2   g23(.a(new_n50_), .b(new_n26_), .O(z14));
  zero   g24(.O(z00));
  zero   g25(.O(z01));
  zero   g26(.O(z03));
  zero   g27(.O(z05));
