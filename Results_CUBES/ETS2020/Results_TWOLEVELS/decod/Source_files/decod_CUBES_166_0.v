...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n27_, new_n28_, new_n29_, new_n31_, new_n32_,
    new_n33_, new_n35_, new_n37_, new_n41_, new_n42_, new_n43_, new_n45_,
    new_n49_;
  ...
  nand3  g20(.a(new_n27_), .b(x1), .c(new_n41_), .O(new_n45_));
  nor2   g21(.a(new_n45_), .b(new_n33_), .O(z10));
  nor2   g22(.a(new_n45_), .b(new_n35_), .O(z11));
