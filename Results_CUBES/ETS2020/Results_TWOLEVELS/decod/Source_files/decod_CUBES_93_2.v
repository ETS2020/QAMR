...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n29_, new_n30_, new_n31_,
    new_n34_, new_n35_, new_n36_, new_n40_, new_n41_, new_n42_, new_n45_,
    new_n48_, new_n51_;
  ...
  nand3  g18(.a(x4), .b(x3), .c(new_n30_), .O(new_n45_));
  nor2   g19(.a(new_n45_), .b(new_n41_), .O(z10));
  nand3  g20(.a(x2), .b(new_n34_), .c(new_n40_), .O(new_n48_));
  nor2   g21(.a(new_n48_), .b(new_n23_), .O(z12));
  nor2   g22(.a(new_n48_), .b(new_n26_), .O(z13));
  nand2  g23(.a(new_n34_), .b(new_n40_), .O(new_n51_));
  nor2   g24(.a(new_n51_), .b(new_n45_), .O(z14));
  zero   g25(.O(z02));
  zero   g26(.O(z04));
  zero   g27(.O(z06));
  zero   g28(.O(z07));
