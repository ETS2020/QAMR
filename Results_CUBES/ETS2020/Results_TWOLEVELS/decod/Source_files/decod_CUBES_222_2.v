...
module FAU ( 
  ...
  wire new_n23_, new_n24_, new_n25_, new_n27_, new_n28_, new_n29_, new_n31_,
    new_n33_, new_n34_, new_n39_, new_n40_, new_n44_, new_n45_, new_n47_,
    new_n50_;
  ...
  nand3  g24(.a(new_n27_), .b(new_n33_), .c(new_n39_), .O(new_n50_));
  nor2   g25(.a(new_n50_), .b(new_n29_), .O(z14));
