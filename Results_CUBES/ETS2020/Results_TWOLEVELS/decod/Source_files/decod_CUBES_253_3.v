...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n30_,
    new_n33_, new_n34_, new_n37_, new_n40_, new_n41_, new_n42_, new_n47_,
    new_n50_;
  ...
  nor2   g21(.a(new_n41_), .b(new_n30_), .O(z10));
  nand2  g22(.a(new_n33_), .b(new_n40_), .O(new_n47_));
  nor2   g23(.a(new_n47_), .b(new_n42_), .O(z12));
  nand3  g24(.a(new_n29_), .b(new_n33_), .c(new_n40_), .O(new_n50_));
