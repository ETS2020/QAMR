...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n33_,
    new_n34_, new_n35_, new_n40_, new_n41_, new_n44_, new_n46_, new_n49_;
  ...
  nor2   g16(.a(new_n41_), .b(new_n35_), .O(z09));
  nand3  g17(.a(x4), .b(new_n25_), .c(new_n28_), .O(new_n44_));
  ...
  nand3  g22(.a(new_n28_), .b(new_n33_), .c(new_n40_), .O(new_n49_));
