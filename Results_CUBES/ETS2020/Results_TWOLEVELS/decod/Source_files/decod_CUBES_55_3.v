...
module FAU ( 
  ...
  nand3  g18(.a(new_n34_), .b(x1), .c(new_n38_), .O(new_n42_));
  nor2   g19(.a(new_n42_), .b(new_n23_), .O(z10));
  nor2   g20(.a(new_n42_), .b(new_n26_), .O(z11));
  nand3  g21(.a(x2), .b(new_n30_), .c(new_n38_), .O(new_n45_));
  nor2   g22(.a(new_n45_), .b(new_n23_), .O(z12));
  nor2   g23(.a(new_n45_), .b(new_n26_), .O(z13));
  nand3  g24(.a(new_n34_), .b(new_n30_), .c(new_n38_), .O(new_n48_));
  nor2   g25(.a(new_n48_), .b(new_n23_), .O(z14));
  nor2   g26(.a(new_n48_), .b(new_n26_), .O(z15));
  zero   g27(.O(z02));
  zero   g28(.O(z03));
endmodule
