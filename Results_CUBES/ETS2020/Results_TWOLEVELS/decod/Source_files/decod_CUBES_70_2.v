...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n29_, new_n30_, new_n31_, new_n32_, new_n35_,
    new_n36_, new_n38_, new_n39_, new_n42_, new_n43_, new_n45_, new_n48_,
    new_n50_;
  ...
  nand2  g19(.a(new_n29_), .b(new_n38_), .O(new_n48_));
  nor2   g20(.a(new_n48_), .b(new_n32_), .O(z13));
  nand3  g21(.a(new_n35_), .b(new_n29_), .c(new_n38_), .O(new_n50_));
  nor2   g22(.a(new_n50_), .b(new_n43_), .O(z14));
  nor2   g23(.a(new_n50_), .b(new_n45_), .O(z15));
  zero   g24(.O(z01));
  zero   g25(.O(z02));
  zero   g26(.O(z03));
  zero   g27(.O(z04));
