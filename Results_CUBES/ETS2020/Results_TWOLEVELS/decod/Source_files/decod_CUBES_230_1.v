...
module FAU ( 
  ...
  wire new_n24_, new_n25_, new_n26_, new_n28_, new_n29_, new_n31_, new_n32_,
    new_n33_, new_n36_, new_n40_, new_n41_, new_n42_, new_n44_, new_n48_,
    new_n50_;
  ...
  nand3  g18(.a(new_n24_), .b(x1), .c(new_n40_), .O(new_n44_));
  nor2   g19(.a(new_n44_), .b(new_n26_), .O(z10));
  nor2   g20(.a(new_n44_), .b(new_n29_), .O(z11));
  nand2  g21(.a(new_n31_), .b(new_n40_), .O(new_n48_));
  nor2   g22(.a(new_n48_), .b(new_n42_), .O(z13));
  nand3  g23(.a(new_n24_), .b(new_n31_), .c(new_n40_), .O(new_n50_));
  nor2   g24(.a(new_n50_), .b(new_n26_), .O(z14));
  nor2   g25(.a(new_n50_), .b(new_n29_), .O(z15));
  zero   g26(.O(z00));
  zero   g27(.O(z01));
  zero   g28(.O(z05));
  zero   g29(.O(z08));
