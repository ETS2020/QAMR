// Benchmark "FAU" written by ABC on Tue Jul  7 10:46:05 2020
...
module FAU ( 
  ...
  wire new_n23_, new_n24_, new_n25_, new_n27_, new_n28_, new_n29_, new_n31_,
    new_n34_, new_n35_, new_n37_, new_n40_, new_n41_, new_n44_, new_n48_,
    new_n50_;
  ...
  nand2  g23(.a(new_n34_), .b(new_n40_), .O(new_n48_));
  nor2   g24(.a(new_n48_), .b(new_n25_), .O(z13));
  nand3  g25(.a(new_n27_), .b(new_n34_), .c(new_n40_), .O(new_n50_));
  nor2   g26(.a(new_n50_), .b(new_n29_), .O(z14));
