...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n32_,
    new_n33_, new_n38_, new_n39_, new_n42_, new_n45_, new_n49_, new_n50_;
  ...
  nand2  g24(.a(new_n32_), .b(new_n38_), .O(new_n49_));
  nand3  g25(.a(x4), .b(new_n25_), .c(new_n28_), .O(new_n50_));
  nor2   g26(.a(new_n50_), .b(new_n49_), .O(z15));
  zero   g27(.O(z06));
  zero   g28(.O(z07));
  zero   g29(.O(z14));
endmodule
