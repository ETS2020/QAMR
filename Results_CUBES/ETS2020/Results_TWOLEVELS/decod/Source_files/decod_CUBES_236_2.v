...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n26_, new_n27_, new_n28_, new_n30_, new_n31_,
    new_n35_, new_n36_, new_n39_, new_n40_, new_n43_, new_n46_, new_n50_,
    new_n51_;
  ...
  nand3  g11(.a(new_n26_), .b(new_n35_), .c(x0), .O(new_n36_));
  nor2   g12(.a(new_n36_), .b(new_n28_), .O(z06));
  ...
  nand3  g17(.a(x4), .b(x3), .c(new_n26_), .O(new_n43_));
  nor2   g18(.a(new_n43_), .b(new_n40_), .O(z10));
  nand3  g19(.a(x2), .b(new_n35_), .c(new_n39_), .O(new_n46_));
  nor2   g20(.a(new_n46_), .b(new_n28_), .O(z12));
  nor2   g21(.a(new_n46_), .b(new_n31_), .O(z13));
  nand2  g22(.a(new_n35_), .b(new_n39_), .O(new_n50_));
  nand3  g23(.a(x4), .b(new_n30_), .c(new_n26_), .O(new_n51_));
  nor2   g24(.a(new_n51_), .b(new_n50_), .O(z15));
  zero   g25(.O(z01));
  zero   g26(.O(z04));
  zero   g27(.O(z05));
  zero   g28(.O(z09));
