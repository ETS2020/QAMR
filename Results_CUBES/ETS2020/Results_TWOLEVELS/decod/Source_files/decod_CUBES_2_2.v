...
module FAU ( 
  ...
  nor2   g16(.a(new_n40_), .b(new_n32_), .O(z08));
  nand3  g17(.a(new_n35_), .b(x1), .c(new_n39_), .O(new_n43_));
  nor2   g18(.a(new_n43_), .b(new_n23_), .O(z10));
  nor2   g19(.a(new_n43_), .b(new_n26_), .O(z11));
  nand2  g20(.a(new_n30_), .b(new_n39_), .O(new_n46_));
  nor2   g21(.a(new_n46_), .b(new_n32_), .O(z12));
  nand3  g22(.a(new_n35_), .b(new_n30_), .c(new_n39_), .O(new_n49_));
