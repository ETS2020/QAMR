...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n32_,
    new_n33_, new_n36_, new_n43_, new_n44_, new_n47_;
  ...
  nand3  g18(.a(x2), .b(new_n32_), .c(new_n43_), .O(new_n44_));
  nor2   g19(.a(new_n44_), .b(new_n23_), .O(z12));
  nor2   g20(.a(new_n44_), .b(new_n26_), .O(z13));
  nand3  g21(.a(new_n28_), .b(new_n32_), .c(new_n43_), .O(new_n47_));
  nor2   g22(.a(new_n47_), .b(new_n23_), .O(z14));
  nor2   g23(.a(new_n47_), .b(new_n26_), .O(z15));
  zero   g24(.O(z08));
  zero   g25(.O(z09));
  zero   g26(.O(z10));
  zero   g27(.O(z11));
