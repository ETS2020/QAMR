...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n26_, new_n27_, new_n28_, new_n30_, new_n31_,
    new_n34_, new_n35_, new_n36_, new_n38_, new_n42_, new_n43_, new_n46_,
    new_n49_, new_n51_;
  ...
  nand3  g20(.a(x4), .b(new_n30_), .c(new_n26_), .O(new_n46_));
  nor2   g21(.a(new_n46_), .b(new_n43_), .O(z11));
  nand2  g22(.a(new_n34_), .b(new_n42_), .O(new_n49_));
  nor2   g23(.a(new_n49_), .b(new_n36_), .O(z13));
  nand3  g24(.a(x4), .b(x3), .c(new_n26_), .O(new_n51_));
  nor2   g25(.a(new_n51_), .b(new_n49_), .O(z14));
  zero   g26(.O(z01));
  zero   g27(.O(z04));
  zero   g28(.O(z08));
  zero   g29(.O(z10));
