...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n32_,
    new_n33_, new_n34_, new_n37_, new_n43_, new_n44_, new_n45_, new_n47_,
    new_n50_;
  ...
  nand2  g18(.a(x1), .b(new_n43_), .O(new_n44_));
  nand3  g19(.a(x4), .b(new_n25_), .c(new_n28_), .O(new_n45_));
  nor2   g20(.a(new_n45_), .b(new_n44_), .O(z11));
  nand2  g21(.a(new_n32_), .b(new_n43_), .O(new_n47_));
  nor2   g22(.a(new_n47_), .b(new_n34_), .O(z12));
  nand3  g23(.a(new_n28_), .b(new_n32_), .c(new_n43_), .O(new_n50_));
