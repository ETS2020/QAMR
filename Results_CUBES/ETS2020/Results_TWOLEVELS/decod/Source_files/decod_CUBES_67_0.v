...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n34_,
    new_n35_, new_n39_, new_n40_, new_n41_, new_n43_, new_n47_, new_n49_;
  ...
  nand3  g18(.a(new_n28_), .b(x1), .c(new_n39_), .O(new_n43_));
  nor2   g19(.a(new_n43_), .b(new_n23_), .O(z10));
  nor2   g20(.a(new_n43_), .b(new_n26_), .O(z11));
  nand2  g21(.a(new_n34_), .b(new_n39_), .O(new_n47_));
  nor2   g22(.a(new_n47_), .b(new_n41_), .O(z13));
  nand3  g23(.a(x4), .b(x3), .c(new_n28_), .O(new_n49_));
  nor2   g24(.a(new_n49_), .b(new_n47_), .O(z14));
  zero   g25(.O(z04));
  zero   g26(.O(z05));
  zero   g27(.O(z08));
  zero   g28(.O(z12));
