...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n32_,
    new_n33_, new_n38_, new_n39_, new_n40_, new_n44_, new_n46_;
  ...
  nor2   g19(.a(new_n44_), .b(new_n39_), .O(z11));
  nand2  g20(.a(new_n32_), .b(new_n38_), .O(new_n46_));
  nor2   g21(.a(new_n46_), .b(new_n40_), .O(z12));
  zero   g22(.O(z06));
  zero   g23(.O(z07));
  zero   g24(.O(z09));
  zero   g25(.O(z10));
