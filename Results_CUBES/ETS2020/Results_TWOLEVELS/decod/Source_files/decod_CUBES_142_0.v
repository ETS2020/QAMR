...
module FAU ( 
  ...
  wire new_n23_, new_n24_, new_n25_, new_n28_, new_n29_, new_n33_, new_n34_,
    new_n35_, new_n37_, new_n40_, new_n41_, new_n46_;
  ...
  nor2   g16(.a(new_n41_), .b(new_n29_), .O(z11));
  nand2  g17(.a(new_n33_), .b(new_n40_), .O(new_n46_));
  nor2   g18(.a(new_n46_), .b(new_n25_), .O(z13));
  nor2   g19(.a(new_n46_), .b(new_n29_), .O(z15));
  zero   g20(.O(z00));
  zero   g21(.O(z02));
  zero   g22(.O(z04));
  zero   g23(.O(z05));
