...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n26_, new_n27_, new_n28_, new_n30_, new_n31_,
    new_n34_, new_n35_, new_n36_, new_n38_, new_n41_, new_n42_, new_n46_,
    new_n47_, new_n51_;
  ...
  nor2   g19(.a(new_n42_), .b(new_n28_), .O(z08));
  nor2   g20(.a(new_n42_), .b(new_n31_), .O(z09));
  nand2  g21(.a(x1), .b(new_n41_), .O(new_n46_));
  nand3  g22(.a(x4), .b(new_n30_), .c(new_n26_), .O(new_n47_));
  nor2   g23(.a(new_n47_), .b(new_n46_), .O(z11));
  nand3  g24(.a(new_n26_), .b(new_n34_), .c(new_n41_), .O(new_n51_));
  nor2   g25(.a(new_n51_), .b(new_n28_), .O(z14));
