...
module FAU ( 
  ...
  nand3  g18(.a(x4), .b(x3), .c(new_n28_), .O(new_n43_));
  nor2   g19(.a(new_n43_), .b(new_n39_), .O(z10));
  nand3  g20(.a(x2), .b(new_n32_), .c(new_n38_), .O(new_n46_));
  nor2   g21(.a(new_n46_), .b(new_n23_), .O(z12));
  nor2   g22(.a(new_n46_), .b(new_n26_), .O(z13));
  nand2  g23(.a(new_n32_), .b(new_n38_), .O(new_n50_));
  nand3  g24(.a(x4), .b(new_n25_), .c(new_n28_), .O(new_n51_));
