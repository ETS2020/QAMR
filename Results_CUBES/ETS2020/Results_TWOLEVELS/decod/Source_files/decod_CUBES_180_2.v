...
module FAU ( 
  ...
  nand3  g16(.a(new_n26_), .b(x1), .c(new_n39_), .O(new_n43_));
  nor2   g17(.a(new_n43_), .b(new_n28_), .O(z10));
  nor2   g18(.a(new_n43_), .b(new_n31_), .O(z11));
  nand2  g19(.a(new_n33_), .b(new_n39_), .O(new_n46_));
  nor2   g20(.a(new_n46_), .b(new_n23_), .O(z12));
  nand3  g21(.a(x4), .b(x3), .c(new_n26_), .O(new_n49_));
  nor2   g22(.a(new_n49_), .b(new_n46_), .O(z14));
  zero   g23(.O(z01));
  zero   g24(.O(z05));
  zero   g25(.O(z06));
  zero   g26(.O(z07));
