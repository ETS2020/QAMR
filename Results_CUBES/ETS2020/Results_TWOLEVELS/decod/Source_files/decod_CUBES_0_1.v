...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n32_,
    new_n33_, new_n36_, new_n37_, new_n41_, new_n42_, new_n43_, new_n46_,
  ...
  nor2   g22(.a(new_n46_), .b(new_n42_), .O(z11));
  nand2  g23(.a(new_n32_), .b(new_n41_), .O(new_n48_));
  nand3  g24(.a(x4), .b(x3), .c(x2), .O(new_n49_));
  nor2   g25(.a(new_n49_), .b(new_n48_), .O(z12));
  nand3  g26(.a(new_n28_), .b(new_n32_), .c(new_n41_), .O(new_n52_));
  nor2   g27(.a(new_n52_), .b(new_n23_), .O(z14));
  nor2   g28(.a(new_n52_), .b(new_n26_), .O(z15));
  zero   g29(.O(z07));
  zero   g30(.O(z08));
  zero   g31(.O(z10));
  zero   g32(.O(z13));
