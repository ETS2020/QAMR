...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n26_, new_n27_, new_n28_, new_n30_, new_n31_,
    new_n33_, new_n34_, new_n37_, new_n38_, new_n41_, new_n42_, new_n45_,
    new_n48_, new_n51_;
  ...
  nand3  g21(.a(new_n26_), .b(x1), .c(new_n41_), .O(new_n45_));
  ...
  nand3  g27(.a(new_n26_), .b(new_n33_), .c(new_n41_), .O(new_n51_));
