...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n26_, new_n27_, new_n30_, new_n31_, new_n32_,
    new_n34_, new_n35_, new_n37_, new_n40_, new_n41_, new_n45_, new_n47_;
  ...
  nand3  g18(.a(x4), .b(new_n34_), .c(new_n26_), .O(new_n45_));
  nor2   g19(.a(new_n45_), .b(new_n41_), .O(z11));
  nand2  g20(.a(new_n30_), .b(new_n40_), .O(new_n47_));
  nor2   g21(.a(new_n47_), .b(new_n23_), .O(z12));
  nor2   g22(.a(new_n47_), .b(new_n27_), .O(z14));
  zero   g23(.O(z01));
  zero   g24(.O(z03));
  zero   g25(.O(z07));
  zero   g26(.O(z09));
