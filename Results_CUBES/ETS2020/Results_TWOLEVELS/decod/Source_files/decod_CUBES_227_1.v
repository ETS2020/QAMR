...
module FAU ( 
  ...
  wire new_n24_, new_n25_, new_n26_, new_n28_, new_n29_, new_n31_, new_n32_,
    new_n35_, new_n39_, new_n40_, new_n41_, new_n43_, new_n46_, new_n49_;
  ...
  nor2   g19(.a(new_n43_), .b(new_n40_), .O(z10));
  nand3  g20(.a(x2), .b(new_n31_), .c(new_n39_), .O(new_n46_));
  nor2   g21(.a(new_n46_), .b(new_n26_), .O(z12));
  nor2   g22(.a(new_n46_), .b(new_n29_), .O(z13));
  nand2  g23(.a(new_n31_), .b(new_n39_), .O(new_n49_));
  nor2   g24(.a(new_n49_), .b(new_n43_), .O(z14));
  zero   g25(.O(z00));
  zero   g26(.O(z01));
  zero   g27(.O(z08));
  zero   g28(.O(z11));
