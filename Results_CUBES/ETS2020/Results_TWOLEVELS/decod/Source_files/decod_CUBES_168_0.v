...
module FAU ( 
  ...
  wire new_n23_, new_n24_, new_n25_, new_n27_, new_n28_, new_n29_, new_n31_,
    new_n33_, new_n34_, new_n35_, new_n38_, new_n42_, new_n43_, new_n46_,
    new_n48_, new_n52_;
  ...
  nand3  g20(.a(x4), .b(new_n24_), .c(new_n27_), .O(new_n46_));
  nor2   g21(.a(new_n46_), .b(new_n43_), .O(z11));
  nand3  g22(.a(x2), .b(new_n33_), .c(new_n42_), .O(new_n48_));
  nor2   g23(.a(new_n48_), .b(new_n29_), .O(z12));
  nor2   g24(.a(new_n48_), .b(new_n31_), .O(z13));
  nand2  g25(.a(new_n33_), .b(new_n42_), .O(new_n52_));
  nor2   g26(.a(new_n52_), .b(new_n46_), .O(z15));
  zero   g27(.O(z00));
  zero   g28(.O(z05));
  zero   g29(.O(z08));
  zero   g30(.O(z10));
