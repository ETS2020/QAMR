...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n26_, new_n27_, new_n28_, new_n30_, new_n31_,
    new_n33_, new_n34_, new_n37_, new_n42_, new_n43_, new_n46_, new_n49_;
  ...
  nand3  g18(.a(new_n26_), .b(x1), .c(new_n42_), .O(new_n43_));
  nor2   g19(.a(new_n43_), .b(new_n28_), .O(z10));
  nor2   g20(.a(new_n43_), .b(new_n31_), .O(z11));
  nand2  g21(.a(new_n33_), .b(new_n42_), .O(new_n46_));
