...
module FAU ( 
  ...
  wire new_n23_, new_n24_, new_n25_, new_n27_, new_n28_, new_n29_, new_n31_,
    new_n33_, new_n34_, new_n35_, new_n38_, new_n41_, new_n42_, new_n46_,
  ...
  nand3  g22(.a(x4), .b(new_n24_), .c(new_n27_), .O(new_n47_));
  nor2   g23(.a(new_n47_), .b(new_n46_), .O(z11));
  nand2  g24(.a(new_n33_), .b(new_n41_), .O(new_n49_));
  nor2   g25(.a(new_n49_), .b(new_n35_), .O(z12));
  nand3  g26(.a(x4), .b(x3), .c(new_n27_), .O(new_n52_));
  nor2   g27(.a(new_n52_), .b(new_n49_), .O(z14));
  zero   g28(.O(z00));
  zero   g29(.O(z05));
  zero   g30(.O(z10));
  zero   g31(.O(z13));
