...
module FAU ( 
  ...
  wire new_n23_, new_n24_, new_n25_, new_n31_, new_n32_, new_n33_, new_n34_,
    new_n36_, new_n38_, new_n39_, new_n42_, new_n43_, new_n47_, new_n50_;
  ...
  nand2  g15(.a(x1), .b(new_n38_), .O(new_n42_));
  nand3  g16(.a(x4), .b(x3), .c(new_n32_), .O(new_n43_));
  nor2   g17(.a(new_n43_), .b(new_n42_), .O(z10));
  nand2  g18(.a(new_n31_), .b(new_n38_), .O(new_n47_));
  nor2   g19(.a(new_n47_), .b(new_n25_), .O(z13));
  nand3  g20(.a(x4), .b(new_n24_), .c(new_n32_), .O(new_n50_));
  nor2   g21(.a(new_n50_), .b(new_n47_), .O(z15));
  zero   g22(.O(z00));
  zero   g23(.O(z02));
  zero   g24(.O(z03));
  zero   g25(.O(z04));
