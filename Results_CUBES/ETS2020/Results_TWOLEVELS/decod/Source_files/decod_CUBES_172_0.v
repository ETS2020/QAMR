...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n27_, new_n28_, new_n29_, new_n31_, new_n32_,
    new_n38_, new_n39_, new_n40_, new_n42_, new_n43_, new_n45_, new_n47_,
    new_n51_;
  ...
  nor2   g10(.a(new_n32_), .b(new_n29_), .O(z07));
  ...
  nand3  g15(.a(new_n27_), .b(x1), .c(new_n38_), .O(new_n42_));
  nand2  g16(.a(x4), .b(x3), .O(new_n43_));
  nor2   g17(.a(new_n43_), .b(new_n42_), .O(z10));
  nand2  g18(.a(x4), .b(new_n28_), .O(new_n45_));
  nor2   g19(.a(new_n45_), .b(new_n42_), .O(z11));
  nand3  g20(.a(x2), .b(new_n31_), .c(new_n38_), .O(new_n47_));
  nor2   g21(.a(new_n47_), .b(new_n43_), .O(z12));
  nor2   g22(.a(new_n47_), .b(new_n45_), .O(z13));
  nand2  g23(.a(new_n31_), .b(new_n38_), .O(new_n51_));
  nor2   g24(.a(new_n51_), .b(new_n29_), .O(z15));
  zero   g25(.O(z01));
  zero   g26(.O(z02));
  zero   g27(.O(z05));
  zero   g28(.O(z06));
