...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n26_, new_n27_, new_n28_, new_n30_, new_n31_,
    new_n33_, new_n34_, new_n38_, new_n39_, new_n42_, new_n43_, new_n44_,
    new_n46_, new_n49_, new_n53_;
  ...
  nand3  g19(.a(x4), .b(new_n30_), .c(x2), .O(new_n44_));
  nor2   g20(.a(new_n44_), .b(new_n43_), .O(z09));
  nand3  g21(.a(new_n26_), .b(x1), .c(new_n42_), .O(new_n46_));
  nor2   g22(.a(new_n46_), .b(new_n28_), .O(z10));
  nor2   g23(.a(new_n46_), .b(new_n31_), .O(z11));
  nand3  g24(.a(x2), .b(new_n33_), .c(new_n42_), .O(new_n49_));
  nor2   g25(.a(new_n49_), .b(new_n28_), .O(z12));
  nor2   g26(.a(new_n49_), .b(new_n31_), .O(z13));
  nand2  g27(.a(new_n33_), .b(new_n42_), .O(new_n53_));
  nor2   g28(.a(new_n53_), .b(new_n39_), .O(z15));
  zero   g29(.O(z01));
  zero   g30(.O(z06));
  zero   g31(.O(z08));
  zero   g32(.O(z14));
