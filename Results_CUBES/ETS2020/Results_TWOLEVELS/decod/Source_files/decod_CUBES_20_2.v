...
module FAU ( 
  ...
  nand2  g15(.a(x4), .b(new_n28_), .O(new_n41_));
  nor2   g16(.a(new_n41_), .b(new_n38_), .O(z09));
  nand2  g17(.a(x1), .b(new_n37_), .O(new_n43_));
  nand3  g18(.a(x4), .b(x3), .c(new_n27_), .O(new_n44_));
  nor2   g19(.a(new_n44_), .b(new_n43_), .O(z10));
  nand2  g20(.a(new_n31_), .b(new_n37_), .O(new_n47_));
  nor2   g21(.a(new_n47_), .b(new_n23_), .O(z12));
  nand3  g22(.a(new_n27_), .b(new_n31_), .c(new_n37_), .O(new_n50_));
  nor2   g23(.a(new_n50_), .b(new_n39_), .O(z14));
  nor2   g24(.a(new_n50_), .b(new_n41_), .O(z15));
  zero   g25(.O(z01));
  zero   g26(.O(z02));
  zero   g27(.O(z05));
  zero   g28(.O(z06));
