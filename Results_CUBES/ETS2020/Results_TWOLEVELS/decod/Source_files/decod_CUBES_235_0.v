...
module FAU ( 
  ...
  nand3  g19(.a(x4), .b(new_n28_), .c(new_n24_), .O(new_n45_));
  nor2   g20(.a(new_n45_), .b(new_n44_), .O(z11));
  nand3  g21(.a(x2), .b(new_n31_), .c(new_n39_), .O(new_n47_));
  nor2   g22(.a(new_n47_), .b(new_n26_), .O(z12));
  nor2   g23(.a(new_n47_), .b(new_n29_), .O(z13));
  nand2  g24(.a(new_n31_), .b(new_n39_), .O(new_n51_));
