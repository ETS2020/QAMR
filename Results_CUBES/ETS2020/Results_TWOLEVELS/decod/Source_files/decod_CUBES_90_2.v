...
module FAU ( 
  ...
  nand3  g17(.a(x4), .b(x3), .c(x2), .O(new_n42_));
  nor2   g18(.a(new_n42_), .b(new_n41_), .O(z08));
  nand3  g19(.a(x4), .b(x3), .c(new_n30_), .O(new_n45_));
  nor2   g20(.a(new_n45_), .b(new_n41_), .O(z10));
  nand3  g21(.a(x2), .b(new_n34_), .c(new_n40_), .O(new_n48_));
  nor2   g22(.a(new_n48_), .b(new_n23_), .O(z12));
  nor2   g23(.a(new_n48_), .b(new_n26_), .O(z13));
  nand3  g24(.a(new_n30_), .b(new_n34_), .c(new_n40_), .O(new_n51_));
