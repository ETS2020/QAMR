// Benchmark "FAU" written by ABC on Tue Jul  7 10:46:32 2020
...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n23_, new_n24_, new_n25_, new_n28_, new_n29_, new_n33_, new_n34_,
    new_n35_, new_n37_, new_n39_, new_n40_, new_n43_, new_n47_;
  ...
  nand3  g08(.a(new_n28_), .b(new_n33_), .c(x0), .O(new_n34_));
  ...
  nand3  g17(.a(new_n28_), .b(x1), .c(new_n39_), .O(new_n43_));
  nor2   g18(.a(new_n43_), .b(new_n35_), .O(z10));
  nor2   g19(.a(new_n43_), .b(new_n37_), .O(z11));
  nand2  g20(.a(new_n33_), .b(new_n39_), .O(new_n47_));
  nor2   g21(.a(new_n47_), .b(new_n25_), .O(z13));
  nor2   g22(.a(new_n47_), .b(new_n29_), .O(z15));
  zero   g23(.O(z00));
  zero   g24(.O(z02));
  zero   g25(.O(z04));
  zero   g26(.O(z05));
