...
module FAU ( 
  ...
  wire new_n23_, new_n24_, new_n25_, new_n27_, new_n28_, new_n29_, new_n31_,
    new_n33_, new_n34_, new_n39_, new_n40_, new_n43_, new_n47_, new_n49_;
  ...
  nand3  g18(.a(new_n27_), .b(x1), .c(new_n39_), .O(new_n43_));
  nor2   g19(.a(new_n43_), .b(new_n29_), .O(z10));
  nor2   g20(.a(new_n43_), .b(new_n31_), .O(z11));
  nand2  g21(.a(new_n33_), .b(new_n39_), .O(new_n47_));
  nor2   g22(.a(new_n47_), .b(new_n25_), .O(z13));
  nand3  g23(.a(new_n27_), .b(new_n33_), .c(new_n39_), .O(new_n49_));
  nor2   g24(.a(new_n49_), .b(new_n29_), .O(z14));
