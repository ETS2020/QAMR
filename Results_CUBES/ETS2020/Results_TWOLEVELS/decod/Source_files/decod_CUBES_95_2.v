...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n26_, new_n27_, new_n28_, new_n30_, new_n31_,
    new_n34_, new_n35_, new_n36_, new_n40_, new_n41_, new_n44_, new_n45_,
    new_n48_, new_n52_;
  ...
  nand2  g18(.a(x1), .b(new_n40_), .O(new_n44_));
  nand3  g19(.a(x4), .b(x3), .c(new_n26_), .O(new_n45_));
  nor2   g20(.a(new_n45_), .b(new_n44_), .O(z10));
  nand2  g21(.a(new_n34_), .b(new_n40_), .O(new_n48_));
  nor2   g22(.a(new_n48_), .b(new_n23_), .O(z12));
  nand3  g23(.a(x4), .b(new_n30_), .c(new_n26_), .O(new_n52_));
  nor2   g24(.a(new_n52_), .b(new_n48_), .O(z15));
  zero   g25(.O(z01));
  zero   g26(.O(z04));
  zero   g27(.O(z06));
  zero   g28(.O(z07));
