...
module FAU ( 
  ...
  nand3  g18(.a(new_n35_), .b(x1), .c(new_n39_), .O(new_n44_));
  nor2   g19(.a(new_n44_), .b(new_n23_), .O(z10));
  nor2   g20(.a(new_n44_), .b(new_n26_), .O(z11));
  nand2  g21(.a(new_n31_), .b(new_n39_), .O(new_n47_));
  nor2   g22(.a(new_n47_), .b(new_n41_), .O(z12));
  nand3  g23(.a(x4), .b(x3), .c(new_n35_), .O(new_n50_));
  nor2   g24(.a(new_n50_), .b(new_n47_), .O(z14));
  zero   g25(.O(z02));
  zero   g26(.O(z03));
  zero   g27(.O(z04));
  zero   g28(.O(z09));
