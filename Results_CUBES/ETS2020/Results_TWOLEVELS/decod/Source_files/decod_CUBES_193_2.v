...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n27_, new_n28_, new_n29_, new_n31_, new_n32_,
    new_n37_, new_n38_, new_n39_, new_n41_, new_n43_, new_n46_, new_n49_;
  ...
  nand2  g14(.a(x4), .b(new_n28_), .O(new_n41_));
  nor2   g15(.a(new_n41_), .b(new_n38_), .O(z09));
  nand3  g16(.a(new_n27_), .b(x1), .c(new_n37_), .O(new_n43_));
  nor2   g17(.a(new_n43_), .b(new_n39_), .O(z10));
  nor2   g18(.a(new_n43_), .b(new_n41_), .O(z11));
  nand2  g19(.a(new_n31_), .b(new_n37_), .O(new_n46_));
  nor2   g20(.a(new_n46_), .b(new_n23_), .O(z12));
  nand3  g21(.a(x4), .b(x3), .c(new_n27_), .O(new_n49_));
