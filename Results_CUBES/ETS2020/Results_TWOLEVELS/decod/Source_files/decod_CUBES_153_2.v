...
module FAU ( 
  ...
  nand3  g17(.a(new_n37_), .b(x1), .c(new_n40_), .O(new_n44_));
  nor2   g18(.a(new_n44_), .b(new_n30_), .O(z10));
  nor2   g19(.a(new_n44_), .b(new_n33_), .O(z11));
  nand3  g20(.a(x2), .b(new_n28_), .c(new_n40_), .O(new_n47_));
  nor2   g21(.a(new_n47_), .b(new_n30_), .O(z12));
