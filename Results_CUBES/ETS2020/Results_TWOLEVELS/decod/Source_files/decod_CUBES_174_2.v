...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n27_, new_n28_, new_n29_, new_n31_, new_n32_,
    new_n33_, new_n35_, new_n39_, new_n40_, new_n43_, new_n46_, new_n49_,
    new_n50_;
  ...
  nand3  g19(.a(x2), .b(new_n31_), .c(new_n39_), .O(new_n46_));
  nor2   g20(.a(new_n46_), .b(new_n33_), .O(z12));
  nor2   g21(.a(new_n46_), .b(new_n35_), .O(z13));
  nand2  g22(.a(new_n31_), .b(new_n39_), .O(new_n49_));
  nand3  g23(.a(x4), .b(x3), .c(new_n27_), .O(new_n50_));
