...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n32_,
    new_n33_, new_n36_, new_n37_, new_n40_, new_n41_, new_n42_, new_n46_,
    new_n48_, new_n51_;
  ...
  nand3  g23(.a(x2), .b(new_n32_), .c(new_n40_), .O(new_n48_));
  nor2   g24(.a(new_n48_), .b(new_n23_), .O(z12));
  nor2   g25(.a(new_n48_), .b(new_n26_), .O(z13));
  nand2  g26(.a(new_n32_), .b(new_n40_), .O(new_n51_));
  nor2   g27(.a(new_n51_), .b(new_n37_), .O(z14));
  zero   g28(.O(z07));
  zero   g29(.O(z09));
  zero   g30(.O(z10));
  zero   g31(.O(z15));
