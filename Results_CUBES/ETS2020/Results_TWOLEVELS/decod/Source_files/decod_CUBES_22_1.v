...
module FAU ( 
  ...
  nand3  g17(.a(x4), .b(x3), .c(new_n24_), .O(new_n43_));
  nor2   g18(.a(new_n43_), .b(new_n41_), .O(z10));
  nand3  g19(.a(x2), .b(new_n32_), .c(new_n40_), .O(new_n46_));
  nor2   g20(.a(new_n46_), .b(new_n26_), .O(z12));
  nor2   g21(.a(new_n46_), .b(new_n29_), .O(z13));
  nand3  g22(.a(new_n24_), .b(new_n32_), .c(new_n40_), .O(new_n49_));
  nor2   g23(.a(new_n49_), .b(new_n26_), .O(z14));
