...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n29_, new_n30_, new_n31_,
    new_n33_, new_n34_, new_n39_, new_n40_, new_n43_, new_n47_, new_n48_,
    new_n50_;
  ...
  nand3  g18(.a(new_n30_), .b(x1), .c(new_n39_), .O(new_n43_));
  ...
  nand3  g24(.a(new_n30_), .b(new_n33_), .c(new_n39_), .O(new_n50_));
