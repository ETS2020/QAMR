...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n33_,
    new_n34_, new_n35_, new_n39_, new_n40_, new_n44_, new_n45_, new_n49_;
  ...
  nand3  g19(.a(x4), .b(new_n25_), .c(new_n28_), .O(new_n45_));
  nor2   g20(.a(new_n45_), .b(new_n44_), .O(z11));
  nand3  g21(.a(new_n28_), .b(new_n33_), .c(new_n39_), .O(new_n49_));
