...
module FAU ( 
  ...
  wire new_n23_, new_n24_, new_n25_, new_n27_, new_n28_, new_n34_, new_n35_,
    new_n36_, new_n38_, new_n39_, new_n40_, new_n45_;
  ...
  nor2   g15(.a(new_n39_), .b(new_n28_), .O(z10));
  nand2  g16(.a(new_n34_), .b(new_n38_), .O(new_n45_));
  nor2   g17(.a(new_n45_), .b(new_n40_), .O(z12));
  nor2   g18(.a(new_n45_), .b(new_n28_), .O(z14));
  zero   g19(.O(z00));
  zero   g20(.O(z03));
  zero   g21(.O(z04));
  zero   g22(.O(z05));
