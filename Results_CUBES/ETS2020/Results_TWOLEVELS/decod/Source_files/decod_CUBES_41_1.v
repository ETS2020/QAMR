...
module FAU ( 
  ...
  nand3  g24(.a(x2), .b(new_n33_), .c(new_n41_), .O(new_n49_));
  nor2   g25(.a(new_n49_), .b(new_n29_), .O(z12));
  nor2   g26(.a(new_n49_), .b(new_n31_), .O(z13));
  nand3  g27(.a(new_n27_), .b(new_n33_), .c(new_n41_), .O(new_n52_));
  nor2   g28(.a(new_n52_), .b(new_n29_), .O(z14));
  nor2   g29(.a(new_n52_), .b(new_n31_), .O(z15));
  zero   g30(.O(z00));
  zero   g31(.O(z06));
  zero   g32(.O(z09));
endmodule
