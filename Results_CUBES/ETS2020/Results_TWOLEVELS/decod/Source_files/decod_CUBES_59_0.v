...
module FAU ( 
  ...
  wire new_n23_, new_n24_, new_n25_, new_n28_, new_n29_, new_n31_, new_n32_,
    new_n33_, new_n36_, new_n37_, new_n39_, new_n43_, new_n44_, new_n47_,
    new_n51_;
  ...
  inv1   g16(.a(x0), .O(new_n43_));
  nand3  g17(.a(new_n28_), .b(x1), .c(new_n43_), .O(new_n44_));
  nor2   g18(.a(new_n44_), .b(new_n37_), .O(z10));
  nor2   g19(.a(new_n44_), .b(new_n39_), .O(z11));
  nand3  g20(.a(x2), .b(new_n31_), .c(new_n43_), .O(new_n47_));
  nor2   g21(.a(new_n47_), .b(new_n37_), .O(z12));
  nor2   g22(.a(new_n47_), .b(new_n39_), .O(z13));
  nand2  g23(.a(new_n31_), .b(new_n43_), .O(new_n51_));
