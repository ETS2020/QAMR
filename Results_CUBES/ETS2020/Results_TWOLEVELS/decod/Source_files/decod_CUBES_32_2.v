...
module FAU ( 
  ...
  nand3  g16(.a(x4), .b(x3), .c(new_n27_), .O(new_n43_));
  nor2   g17(.a(new_n43_), .b(new_n40_), .O(z10));
  nand3  g18(.a(x2), .b(new_n31_), .c(new_n39_), .O(new_n46_));
  nor2   g19(.a(new_n46_), .b(new_n33_), .O(z12));
