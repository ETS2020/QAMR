...
module FAU ( 
  ...
  wire new_n24_, new_n25_, new_n26_, new_n28_, new_n29_, new_n32_, new_n33_,
    new_n34_, new_n37_, new_n39_, new_n40_, new_n43_, new_n46_, new_n49_;
  ...
  nand3  g11(.a(x4), .b(new_n28_), .c(new_n24_), .O(new_n37_));
  nor2   g12(.a(new_n37_), .b(new_n33_), .O(z07));
  inv1   g13(.a(x0), .O(new_n39_));
  nand3  g14(.a(x2), .b(x1), .c(new_n39_), .O(new_n40_));
  nor2   g15(.a(new_n40_), .b(new_n26_), .O(z08));
  nor2   g16(.a(new_n40_), .b(new_n29_), .O(z09));
  nand3  g17(.a(new_n24_), .b(x1), .c(new_n39_), .O(new_n43_));
  nor2   g18(.a(new_n43_), .b(new_n26_), .O(z10));
  nor2   g19(.a(new_n43_), .b(new_n29_), .O(z11));
  nand3  g20(.a(x2), .b(new_n32_), .c(new_n39_), .O(new_n46_));
  nor2   g21(.a(new_n46_), .b(new_n26_), .O(z12));
  nor2   g22(.a(new_n46_), .b(new_n29_), .O(z13));
  nand3  g23(.a(new_n24_), .b(new_n32_), .c(new_n39_), .O(new_n49_));
