...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n28_, new_n29_, new_n30_, new_n32_, new_n33_,
    new_n35_, new_n36_, new_n37_, new_n40_, new_n41_, new_n45_, new_n46_,
    new_n48_;
  ...
  nand3  g19(.a(x4), .b(new_n32_), .c(new_n36_), .O(new_n46_));
  nor2   g20(.a(new_n46_), .b(new_n45_), .O(z11));
  nand2  g21(.a(new_n28_), .b(new_n40_), .O(new_n48_));
  nor2   g22(.a(new_n48_), .b(new_n23_), .O(z12));
  nor2   g23(.a(new_n48_), .b(new_n37_), .O(z14));
  zero   g24(.O(z01));
  zero   g25(.O(z02));
  zero   g26(.O(z03));
  zero   g27(.O(z07));
