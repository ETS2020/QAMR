...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n26_, new_n27_, new_n28_, new_n30_, new_n31_,
    new_n34_, new_n35_, new_n36_, new_n40_, new_n41_, new_n46_;
  ...
  nand3  g17(.a(x2), .b(new_n34_), .c(new_n40_), .O(new_n46_));
  nor2   g18(.a(new_n46_), .b(new_n28_), .O(z12));
  nor2   g19(.a(new_n46_), .b(new_n31_), .O(z13));
  zero   g20(.O(z01));
  zero   g21(.O(z04));
  zero   g22(.O(z06));
  zero   g23(.O(z07));
