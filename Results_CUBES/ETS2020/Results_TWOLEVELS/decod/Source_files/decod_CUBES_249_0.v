...
module FAU ( 
  ...
  wire new_n23_, new_n24_, new_n25_, new_n27_, new_n28_, new_n29_, new_n31_,
    new_n34_, new_n35_, new_n37_, new_n41_, new_n42_, new_n44_, new_n48_,
    new_n50_;
  ...
  nand3  g19(.a(new_n27_), .b(x1), .c(new_n41_), .O(new_n44_));
  nor2   g20(.a(new_n44_), .b(new_n29_), .O(z10));
  nor2   g21(.a(new_n44_), .b(new_n31_), .O(z11));
  nand2  g22(.a(new_n34_), .b(new_n41_), .O(new_n48_));
  nor2   g23(.a(new_n48_), .b(new_n25_), .O(z13));
  nand3  g24(.a(new_n27_), .b(new_n34_), .c(new_n41_), .O(new_n50_));
