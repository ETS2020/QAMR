...
module FAU ( 
  ...
  nor2   g16(.a(new_n41_), .b(new_n35_), .O(z08));
  nand3  g17(.a(new_n30_), .b(x1), .c(new_n40_), .O(new_n44_));
  nor2   g18(.a(new_n44_), .b(new_n23_), .O(z10));
  nor2   g19(.a(new_n44_), .b(new_n26_), .O(z11));
  nand2  g20(.a(new_n33_), .b(new_n40_), .O(new_n47_));
  nor2   g21(.a(new_n47_), .b(new_n35_), .O(z12));
  nand3  g22(.a(new_n30_), .b(new_n33_), .c(new_n40_), .O(new_n50_));
