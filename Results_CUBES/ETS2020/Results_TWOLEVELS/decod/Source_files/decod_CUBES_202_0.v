// Benchmark "FAU" written by ABC on Tue Jul  7 10:46:43 2020
...
module FAU ( 
  ...
  nand3  g21(.a(new_n29_), .b(x1), .c(new_n42_), .O(new_n46_));
  ...
  nand3  g27(.a(new_n29_), .b(new_n33_), .c(new_n42_), .O(new_n52_));
