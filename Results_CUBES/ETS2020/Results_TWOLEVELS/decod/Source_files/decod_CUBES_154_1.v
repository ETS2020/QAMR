...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n32_,
    new_n33_, new_n38_, new_n39_, new_n40_, new_n43_, new_n46_, new_n50_,
    new_n51_;
  ...
  nand3  g21(.a(x2), .b(new_n32_), .c(new_n38_), .O(new_n46_));
  nor2   g22(.a(new_n46_), .b(new_n23_), .O(z12));
  nor2   g23(.a(new_n46_), .b(new_n26_), .O(z13));
  nand2  g24(.a(new_n32_), .b(new_n38_), .O(new_n50_));
  nand3  g25(.a(x4), .b(new_n25_), .c(new_n28_), .O(new_n51_));
