...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n32_,
    new_n33_, new_n37_, new_n38_, new_n41_, new_n42_, new_n43_, new_n45_,
    new_n49_;
  ...
  nand3  g15(.a(x4), .b(new_n25_), .c(new_n28_), .O(new_n38_));
  ...
  nand3  g21(.a(new_n28_), .b(x1), .c(new_n41_), .O(new_n45_));
  nor2   g22(.a(new_n45_), .b(new_n23_), .O(z10));
  nor2   g23(.a(new_n45_), .b(new_n26_), .O(z11));
  nand2  g24(.a(new_n32_), .b(new_n41_), .O(new_n49_));
  nor2   g25(.a(new_n49_), .b(new_n43_), .O(z13));
