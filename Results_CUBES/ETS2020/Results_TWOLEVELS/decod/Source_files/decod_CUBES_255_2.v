...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n29_, new_n30_, new_n31_,
    new_n34_, new_n35_, new_n36_, new_n38_, new_n41_, new_n42_, new_n45_,
  ...
  nand3  g14(.a(new_n30_), .b(new_n34_), .c(x0), .O(new_n38_));
  ...
  nand3  g24(.a(x2), .b(new_n34_), .c(new_n41_), .O(new_n48_));
  nor2   g25(.a(new_n48_), .b(new_n23_), .O(z12));
  nor2   g26(.a(new_n48_), .b(new_n26_), .O(z13));
  nand2  g27(.a(new_n34_), .b(new_n41_), .O(new_n51_));
  nand3  g28(.a(x4), .b(x3), .c(new_n30_), .O(new_n52_));
  nor2   g29(.a(new_n52_), .b(new_n51_), .O(z14));
  zero   g30(.O(z02));
  zero   g31(.O(z04));
  zero   g32(.O(z15));
endmodule
