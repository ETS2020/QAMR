// Benchmark "FAU" written by ABC on Wed Jul  8 08:51:08 2020
...
module FAU ( 
  ...
  wire new_n100_, new_n101_, new_n102_, new_n103_, new_n104_, new_n105_,
    ...
    new_n112_, new_n113_, new_n114_, new_n115_, new_n116_, new_n128_,
  ...
  inv1   g18(.a(x18), .O(new_n128_));
  nand3  g19(.a(x30), .b(x29), .c(new_n106_), .O(new_n129_));
  inv1   g20(.a(x19), .O(new_n130_));
  nand4  g21(.a(x26), .b(new_n115_), .c(x20), .d(new_n130_), .O(new_n131_));
  nor4   g22(.a(new_n131_), .b(new_n129_), .c(new_n128_), .d(x17), .O(z20));
  zero   g23(.O(z00));
  zero   g24(.O(z01));
  zero   g25(.O(z02));
  zero   g26(.O(z03));
