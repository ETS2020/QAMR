...
module FAU ( 
  ...
  wire new_n99_, new_n100_, new_n101_, new_n102_, new_n103_, new_n104_,
    ...
    new_n147_, new_n148_, new_n149_, new_n150_, new_n151_, new_n164_,
    new_n165_;
  ...
  nand3  g54(.a(x30), .b(x29), .c(new_n106_), .O(new_n164_));
  nand4  g55(.a(x26), .b(new_n111_), .c(x20), .d(new_n139_), .O(new_n165_));
  nor4   g56(.a(new_n165_), .b(new_n164_), .c(new_n99_), .d(x17), .O(z20));
  zero   g57(.O(z00));
  zero   g58(.O(z01));
  zero   g59(.O(z02));
  zero   g60(.O(z03));
