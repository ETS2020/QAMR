// Benchmark "FAU" written by ABC on Wed Jul  8 08:49:56 2020
...
module FAU ( 
  ...
  nand2  g0903(.a(new_n400_), .b(new_n366_), .O(new_n995_));
  nor3   g0904(.a(new_n995_), .b(new_n230_), .c(new_n386_), .O(z21));
  ...
  nand3  g1246(.a(new_n1087_), .b(new_n106_), .c(new_n105_), .O(new_n1338_));
  ...
  nand2  g1468(.a(new_n1338_), .b(new_n1294_), .O(new_n1560_));
  ...
  oai21  g1476(.a(new_n1542_), .b(new_n120_), .c(new_n1567_), .O(new_n1568_));
  ...
  nand2  g1516(.a(new_n1607_), .b(new_n1524_), .O(z37));
