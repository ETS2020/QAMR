// Benchmark "FAU" written by ABC on Wed Jul  8 08:48:24 2020
...
module FAU ( 
  ...
  wire new_n105_, new_n106_, new_n107_, new_n108_, new_n109_, new_n110_,
    ...
    new_n171_, new_n172_, new_n173_, new_n201_, new_n202_, new_n203_,
    new_n204_, new_n205_;
  ...
  nand2  g052(.a(new_n112_), .b(new_n156_), .O(new_n157_));
  nand2  g053(.a(x22), .b(x21), .O(new_n158_));
  nor4   g054(.a(new_n158_), .b(new_n157_), .c(x38), .d(x28), .O(new_n159_));
  aoi21  g055(.a(new_n159_), .b(new_n155_), .c(new_n152_), .O(new_n160_));
  nand2  g056(.a(new_n133_), .b(new_n106_), .O(new_n161_));
  nand4  g057(.a(new_n118_), .b(x25), .c(x21), .d(x11), .O(new_n162_));
  oai21  g058(.a(new_n122_), .b(x21), .c(new_n162_), .O(new_n163_));
  nor2   g059(.a(x30), .b(new_n133_), .O(new_n164_));
  ...
  nand4  g062(.a(new_n114_), .b(x27), .c(x20), .d(new_n127_), .O(new_n167_));
  oai21  g063(.a(new_n122_), .b(x20), .c(new_n167_), .O(new_n168_));
  nand2  g064(.a(new_n168_), .b(x19), .O(new_n169_));
  nand4  g065(.a(new_n123_), .b(x20), .c(new_n112_), .d(x17), .O(new_n170_));
  ...
  oai21  g069(.a(new_n149_), .b(new_n105_), .c(new_n173_), .O(z14));
  nand2  g070(.a(x20), .b(x19), .O(new_n201_));
  nand3  g071(.a(x30), .b(new_n114_), .c(new_n118_), .O(new_n202_));
  inv1   g072(.a(x05), .O(new_n203_));
  inv1   g073(.a(x15), .O(new_n204_));
  nand4  g074(.a(new_n106_), .b(new_n204_), .c(new_n203_), .d(x00), .O(new_n205_));
  nor4   g075(.a(new_n205_), .b(new_n202_), .c(new_n158_), .d(new_n201_), .O(z41));
  zero   g076(.O(z00));
  zero   g077(.O(z01));
  zero   g078(.O(z02));
  zero   g079(.O(z03));
