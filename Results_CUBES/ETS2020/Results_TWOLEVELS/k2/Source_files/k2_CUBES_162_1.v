// Benchmark "FAU" written by ABC on Wed Jul  8 08:49:55 2020
...
module FAU ( 
  ...
  inv1   g0903(.a(new_n669_), .O(new_n996_));
  nand2  g0904(.a(new_n996_), .b(new_n112_), .O(new_n997_));
  xnor2a g0905(.a(x44), .b(x43), .O(new_n998_));
  aoi21  g0906(.a(new_n998_), .b(new_n789_), .c(x42), .O(new_n999_));
  aoi21  g0907(.a(new_n999_), .b(new_n282_), .c(new_n284_), .O(new_n1000_));
  nand2  g0908(.a(new_n792_), .b(new_n351_), .O(new_n1001_));
  inv1   g0909(.a(new_n1001_), .O(new_n1002_));
  nand2  g0910(.a(new_n1002_), .b(new_n458_), .O(new_n1003_));
  oai21  g0911(.a(new_n1003_), .b(new_n1000_), .c(new_n997_), .O(new_n1004_));
  nor2   g0912(.a(new_n647_), .b(new_n112_), .O(new_n1005_));
  nand4  g0913(.a(new_n1005_), .b(new_n872_), .c(new_n801_), .d(new_n379_), .O(new_n1006_));
  inv1   g0914(.a(new_n1006_), .O(new_n1007_));
  aoi21  g0915(.a(new_n1004_), .b(new_n128_), .c(new_n1007_), .O(new_n1008_));
  nor4   g0916(.a(new_n182_), .b(x38), .c(new_n112_), .d(x09), .O(new_n1009_));
  aoi22  g0917(.a(new_n1009_), .b(new_n816_), .c(new_n455_), .d(new_n388_), .O(new_n1010_));
  oai21  g0918(.a(new_n1008_), .b(x19), .c(new_n1010_), .O(new_n1011_));
  inv1   g0919(.a(new_n296_), .O(new_n1012_));
  nand2  g0920(.a(new_n457_), .b(new_n112_), .O(new_n1013_));
  oai21  g0921(.a(new_n1013_), .b(new_n733_), .c(new_n1012_), .O(new_n1014_));
  nand2  g0922(.a(new_n1014_), .b(x19), .O(new_n1015_));
  oai21  g0923(.a(new_n928_), .b(x31), .c(x23), .O(new_n1016_));
  nand2  g0924(.a(new_n1016_), .b(new_n120_), .O(new_n1017_));
  aoi22  g0925(.a(new_n1017_), .b(x21), .c(new_n366_), .d(x24), .O(new_n1018_));
  oai21  g0926(.a(new_n1018_), .b(x19), .c(new_n1015_), .O(new_n1019_));
  aoi21  g0927(.a(new_n1011_), .b(new_n120_), .c(new_n1019_), .O(new_n1020_));
  inv1   g0928(.a(new_n602_), .O(new_n1021_));
  nand2  g0929(.a(new_n226_), .b(new_n96_), .O(new_n1022_));
  oai21  g0930(.a(new_n1021_), .b(new_n230_), .c(new_n1022_), .O(new_n1023_));
  nand2  g0931(.a(new_n1023_), .b(new_n120_), .O(new_n1024_));
  inv1   g0932(.a(new_n481_), .O(new_n1025_));
  nand3  g0933(.a(x25), .b(x21), .c(x11), .O(new_n1026_));
  oai21  g0934(.a(new_n1025_), .b(new_n326_), .c(new_n1026_), .O(new_n1027_));
  nand2  g0935(.a(new_n1027_), .b(new_n96_), .O(new_n1028_));
  aoi21  g0936(.a(new_n305_), .b(x21), .c(new_n602_), .O(new_n1029_));
  aoi21  g0937(.a(new_n1029_), .b(new_n1028_), .c(x28), .O(new_n1030_));
  aoi21  g0938(.a(new_n601_), .b(x04), .c(x21), .O(new_n1031_));
  nor2   g0939(.a(x21), .b(x19), .O(new_n1032_));
  nand2  g0940(.a(new_n1032_), .b(new_n236_), .O(new_n1033_));
  oai21  g0941(.a(new_n1031_), .b(new_n96_), .c(new_n1033_), .O(new_n1034_));
  oai21  g0942(.a(new_n1034_), .b(new_n1030_), .c(x20), .O(new_n1035_));
  nand2  g0943(.a(new_n1035_), .b(new_n1024_), .O(new_n1036_));
  aoi21  g0944(.a(new_n1036_), .b(x18), .c(new_n321_), .O(new_n1037_));
  oai21  g0945(.a(new_n1020_), .b(x18), .c(new_n1037_), .O(new_n1038_));
  aoi21  g0946(.a(new_n742_), .b(new_n499_), .c(new_n96_), .O(new_n1039_));
  nand2  g0947(.a(new_n429_), .b(new_n343_), .O(new_n1040_));
  inv1   g0948(.a(new_n1040_), .O(new_n1041_));
  oai21  g0949(.a(new_n1041_), .b(new_n1039_), .c(new_n112_), .O(new_n1042_));
  aoi21  g0950(.a(new_n1042_), .b(new_n377_), .c(new_n128_), .O(new_n1043_));
  aoi21  g0951(.a(x03), .b(new_n91_), .c(new_n364_), .O(new_n1044_));
  nand2  g0952(.a(new_n1044_), .b(new_n139_), .O(new_n1045_));
  inv1   g0953(.a(new_n1045_), .O(new_n1046_));
  oai21  g0954(.a(new_n1046_), .b(new_n1043_), .c(x18), .O(new_n1047_));
  nand2  g0955(.a(new_n633_), .b(x14), .O(new_n1048_));
  aoi21  g0956(.a(new_n1048_), .b(new_n1047_), .c(x29), .O(new_n1049_));
  aoi21  g0957(.a(new_n1038_), .b(x29), .c(new_n1049_), .O(new_n1050_));
  nand3  g0958(.a(new_n405_), .b(new_n344_), .c(x20), .O(new_n1051_));
  nand2  g0959(.a(new_n480_), .b(x18), .O(new_n1052_));
  nand2  g0960(.a(new_n522_), .b(new_n92_), .O(new_n1053_));
  nand3  g0961(.a(new_n1053_), .b(new_n1052_), .c(new_n1051_), .O(new_n1054_));
  nand2  g0962(.a(new_n1054_), .b(x29), .O(new_n1055_));
  nand3  g0963(.a(new_n526_), .b(new_n149_), .c(new_n538_), .O(new_n1056_));
  aoi21  g0964(.a(new_n1056_), .b(new_n243_), .c(new_n91_), .O(new_n1057_));
  nor2   g0965(.a(x33), .b(new_n376_), .O(new_n1058_));
  nand2  g0966(.a(new_n490_), .b(x22), .O(new_n1059_));
  nand3  g0967(.a(new_n526_), .b(new_n538_), .c(x05), .O(new_n1060_));
  oai21  g0968(.a(new_n1059_), .b(new_n1058_), .c(new_n1060_), .O(new_n1061_));
  oai21  g0969(.a(new_n1061_), .b(new_n1057_), .c(new_n162_), .O(new_n1062_));
  nand3  g0970(.a(new_n848_), .b(new_n490_), .c(new_n381_), .O(new_n1063_));
  nand3  g0971(.a(new_n1063_), .b(new_n1062_), .c(new_n1055_), .O(new_n1064_));
  nand2  g0972(.a(new_n162_), .b(x23), .O(new_n1065_));
  aoi21  g0973(.a(new_n1065_), .b(new_n552_), .c(x18), .O(new_n1066_));
  nand2  g0974(.a(new_n426_), .b(x18), .O(new_n1067_));
  inv1   g0975(.a(new_n1067_), .O(new_n1068_));
  oai21  g0976(.a(new_n1068_), .b(new_n1066_), .c(new_n120_), .O(new_n1069_));
  nand2  g0977(.a(x29), .b(x20), .O(new_n1070_));
  oai21  g0978(.a(new_n1070_), .b(x18), .c(new_n1069_), .O(new_n1071_));
  aoi21  g0979(.a(new_n1064_), .b(new_n128_), .c(new_n1071_), .O(new_n1072_));
  aoi21  g0980(.a(x22), .b(x20), .c(x28), .O(new_n1073_));
  nor2   g0981(.a(new_n1073_), .b(x18), .O(new_n1074_));
  oai21  g0982(.a(new_n1074_), .b(new_n362_), .c(x29), .O(new_n1075_));
  nand2  g0983(.a(new_n541_), .b(new_n92_), .O(new_n1076_));
  oai21  g0984(.a(new_n1076_), .b(x10), .c(new_n243_), .O(new_n1077_));
  nand2  g0985(.a(new_n1077_), .b(x25), .O(new_n1078_));
  nor2   g0986(.a(x26), .b(x22), .O(new_n1079_));
  inv1   g0987(.a(new_n1079_), .O(new_n1080_));
  nand2  g0988(.a(new_n1080_), .b(new_n244_), .O(new_n1081_));
  nand3  g0989(.a(new_n1081_), .b(new_n1078_), .c(new_n1075_), .O(new_n1082_));
  nand2  g0990(.a(new_n1082_), .b(x19), .O(new_n1083_));
  oai21  g0991(.a(new_n1072_), .b(x19), .c(new_n1083_), .O(new_n1084_));
  nand2  g0992(.a(new_n1084_), .b(x21), .O(new_n1085_));
  nor2   g0993(.a(x24), .b(x22), .O(new_n1086_));
  oai22  g0994(.a(new_n1086_), .b(new_n120_), .c(new_n568_), .d(x28), .O(new_n1087_));
  oai21  g0995(.a(new_n1087_), .b(new_n691_), .c(new_n96_), .O(new_n1088_));
  oai21  g0996(.a(new_n745_), .b(new_n319_), .c(new_n139_), .O(new_n1089_));
  aoi21  g0997(.a(new_n1089_), .b(new_n1088_), .c(x18), .O(new_n1090_));
  inv1   g0998(.a(new_n320_), .O(new_n1091_));
  oai21  g0999(.a(new_n914_), .b(new_n1091_), .c(x20), .O(new_n1092_));
  oai21  g1000(.a(new_n319_), .b(x22), .c(x19), .O(new_n1093_));
  nand2  g1001(.a(new_n1093_), .b(new_n304_), .O(new_n1094_));
  nand2  g1002(.a(new_n1094_), .b(new_n120_), .O(new_n1095_));
  aoi21  g1003(.a(new_n1095_), .b(new_n1092_), .c(new_n92_), .O(new_n1096_));
  oai21  g1004(.a(new_n1096_), .b(new_n1090_), .c(new_n162_), .O(new_n1097_));
  nand2  g1005(.a(x20), .b(new_n326_), .O(new_n1098_));
  oai22  g1006(.a(new_n1098_), .b(new_n910_), .c(new_n304_), .d(x20), .O(new_n1099_));
  nand2  g1007(.a(new_n1099_), .b(new_n96_), .O(new_n1100_));
  nor2   g1008(.a(new_n335_), .b(new_n319_), .O(new_n1101_));
  nor2   g1009(.a(new_n1101_), .b(x20), .O(new_n1102_));
  nor2   g1010(.a(new_n162_), .b(new_n96_), .O(new_n1103_));
  oai21  g1011(.a(new_n1102_), .b(new_n743_), .c(new_n1103_), .O(new_n1104_));
  nand2  g1012(.a(new_n1104_), .b(new_n1100_), .O(new_n1105_));
  nand2  g1013(.a(new_n474_), .b(x20), .O(new_n1106_));
  aoi21  g1014(.a(new_n1106_), .b(new_n903_), .c(new_n450_), .O(new_n1107_));
  aoi21  g1015(.a(new_n1105_), .b(x18), .c(new_n1107_), .O(new_n1108_));
  nand2  g1016(.a(new_n1108_), .b(new_n1097_), .O(new_n1109_));
  aoi21  g1017(.a(new_n1109_), .b(new_n112_), .c(new_n564_), .O(new_n1110_));
  nand2  g1018(.a(new_n1110_), .b(new_n1085_), .O(new_n1111_));
  nand2  g1019(.a(new_n522_), .b(new_n424_), .O(new_n1112_));
  nor2   g1020(.a(new_n1112_), .b(new_n719_), .O(new_n1113_));
  nand2  g1021(.a(new_n1113_), .b(new_n376_), .O(new_n1114_));
  nand2  g1022(.a(new_n526_), .b(new_n538_), .O(new_n1115_));
  nand2  g1023(.a(new_n100_), .b(x21), .O(new_n1116_));
  aoi21  g1024(.a(new_n1115_), .b(new_n1114_), .c(new_n1116_), .O(new_n1117_));
  aoi21  g1025(.a(new_n1111_), .b(x30), .c(new_n1117_), .O(new_n1118_));
  oai21  g1026(.a(new_n1050_), .b(x30), .c(new_n1118_), .O(z22));
  nand2  g1027(.a(new_n544_), .b(new_n163_), .O(new_n1120_));
  nor3   g1028(.a(new_n1120_), .b(new_n851_), .c(new_n558_), .O(z23));
  nor3   g1029(.a(new_n911_), .b(new_n860_), .c(new_n116_), .O(z24));
  aoi21  g1030(.a(new_n120_), .b(x19), .c(new_n647_), .O(new_n1123_));
  nor2   g1031(.a(new_n1079_), .b(new_n968_), .O(new_n1124_));
  ...
  nand3  g1053(.a(new_n1005_), .b(new_n100_), .c(new_n120_), .O(new_n1146_));
  ...
  nand4  g1075(.a(new_n996_), .b(new_n97_), .c(new_n122_), .d(x29), .O(new_n1168_));
  ...
  aoi22  g1110(.a(new_n1080_), .b(new_n244_), .c(new_n547_), .d(new_n92_), .O(new_n1203_));
  aoi21  g1111(.a(new_n1203_), .b(new_n1078_), .c(new_n122_), .O(new_n1204_));
  ...
  nand3  g1123(.a(new_n1080_), .b(new_n253_), .c(new_n162_), .O(new_n1216_));
  ...
  oai21  g1127(.a(new_n1219_), .b(new_n1217_), .c(new_n1032_), .O(new_n1220_));
  ...
  nand2  g1154(.a(new_n992_), .b(new_n1091_), .O(new_n1247_));
  ...
  oai22  g1193(.a(new_n1070_), .b(new_n96_), .c(new_n723_), .d(new_n1285_), .O(new_n1286_));
  ...
  inv1   g1199(.a(new_n999_), .O(new_n1292_));
  ...
  oai21  g1221(.a(new_n1025_), .b(new_n96_), .c(new_n347_), .O(new_n1314_));
  ...
  nand2  g1244(.a(new_n1086_), .b(new_n108_), .O(new_n1337_));
  ...
  nand3  g1311(.a(new_n1403_), .b(new_n1002_), .c(new_n355_), .O(new_n1404_));
  ...
  inv1   g1359(.a(new_n1070_), .O(new_n1452_));
  ...
  oai21  g1372(.a(new_n996_), .b(x00), .c(new_n1032_), .O(new_n1465_));
  oai21  g1373(.a(new_n1464_), .b(new_n1003_), .c(new_n1465_), .O(new_n1466_));
  nand2  g1374(.a(new_n1005_), .b(new_n96_), .O(new_n1467_));
  ...
  inv1   g1383(.a(new_n1032_), .O(new_n1476_));
  ...
  nand2  g1394(.a(new_n1486_), .b(new_n1033_), .O(new_n1487_));
  ...
  inv1   g1399(.a(new_n1022_), .O(new_n1492_));
  oai21  g1400(.a(new_n319_), .b(new_n238_), .c(x00), .O(new_n1493_));
  aoi21  g1401(.a(new_n1493_), .b(new_n230_), .c(new_n1021_), .O(new_n1494_));
  ...
  nand2  g1412(.a(new_n1044_), .b(x18), .O(new_n1505_));
  ...
  nand3  g1427(.a(new_n1519_), .b(new_n1518_), .c(new_n1048_), .O(new_n1520_));
  ...
  nor2   g1431(.a(new_n1079_), .b(x05), .O(new_n1524_));
  ...
  inv1   g1466(.a(new_n1086_), .O(new_n1559_));
  ...
  nand2  g1471(.a(new_n1094_), .b(new_n112_), .O(new_n1564_));
  aoi22  g1472(.a(new_n1023_), .b(x00), .c(new_n296_), .d(new_n96_), .O(new_n1565_));
  ...
  nand2  g1477(.a(new_n1054_), .b(x21), .O(new_n1570_));
  ...
  nand2  g1512(.a(new_n1113_), .b(new_n355_), .O(new_n1605_));
  ...
  aoi21  g1518(.a(new_n1086_), .b(new_n404_), .c(new_n308_), .O(new_n1611_));
  ...
  nor2   g1527(.a(new_n1012_), .b(x18), .O(new_n1620_));
  ...
  nand2  g1543(.a(new_n1102_), .b(x19), .O(new_n1636_));
  ...
  inv1   g1553(.a(new_n1031_), .O(new_n1646_));
  ...
  nand3  g1575(.a(new_n1667_), .b(new_n1032_), .c(new_n372_), .O(new_n1668_));
  ...
  oai21  g1591(.a(new_n1179_), .b(new_n1021_), .c(new_n1683_), .O(new_n1684_));
  ...
  nand2  g1596(.a(new_n366_), .b(new_n135_), .O(new_n1690_));
  nor3   g1597(.a(new_n1690_), .b(new_n1086_), .c(new_n116_), .O(z43));
  zero   g1598(.O(z02));
  zero   g1599(.O(z21));
  zero   g1600(.O(z42));
