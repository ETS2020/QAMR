...
module FAU ( 
  ...
  nor2   g066(.a(x25), .b(x24), .O(new_n120_));
  nor2   g067(.a(x28), .b(x27), .O(new_n121_));
  nand4  g068(.a(new_n121_), .b(new_n120_), .c(new_n119_), .d(new_n93_), .O(new_n122_));
  oai21  g069(.a(new_n122_), .b(new_n110_), .c(x29), .O(new_n123_));
  nor3   g070(.a(x29), .b(x28), .c(x27), .O(new_n124_));
  nand4  g071(.a(new_n124_), .b(new_n103_), .c(new_n83_), .d(new_n63_), .O(new_n125_));
  ...
  nand4  g080(.a(new_n133_), .b(new_n121_), .c(new_n132_), .d(new_n82_), .O(new_n134_));
  ...
  nand4  g096(.a(new_n149_), .b(new_n143_), .c(new_n142_), .d(new_n63_), .O(new_n150_));
  ...
  nand4  g104(.a(new_n157_), .b(new_n156_), .c(new_n111_), .d(new_n94_), .O(new_n158_));
  ...
  nand4  g110(.a(new_n163_), .b(new_n147_), .c(new_n119_), .d(new_n94_), .O(new_n164_));
  inv1   g111(.a(new_n164_), .O(new_n165_));
  nand4  g112(.a(new_n165_), .b(new_n162_), .c(new_n142_), .d(new_n63_), .O(new_n166_));
  ...
  nand4  g119(.a(new_n172_), .b(new_n133_), .c(new_n121_), .d(new_n132_), .O(new_n173_));
  oai21  g120(.a(new_n173_), .b(new_n86_), .c(x33), .O(new_n174_));
  inv1   g121(.a(x33), .O(new_n175_));
  nand4  g122(.a(new_n175_), .b(new_n163_), .c(new_n160_), .d(new_n119_), .O(new_n176_));
  inv1   g123(.a(new_n176_), .O(new_n177_));
  nand4  g124(.a(new_n177_), .b(new_n149_), .c(new_n96_), .d(new_n71_), .O(new_n178_));
  nand2  g125(.a(new_n178_), .b(new_n174_), .O(new_n179_));
