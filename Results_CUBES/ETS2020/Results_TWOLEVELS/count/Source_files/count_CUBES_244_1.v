// Benchmark "FAU" written by ABC on Tue Jul  7 19:21:04 2020
...
module FAU ( 
  ...
  aoi21  g065(.a(new_n59_), .b(new_n117_), .c(x18), .O(new_n118_));
  oai21  g066(.a(new_n116_), .b(new_n59_), .c(new_n118_), .O(z08));
  nor3   g067(.a(x27), .b(x26), .c(x25), .O(new_n120_));
  nand4  g068(.a(new_n120_), .b(new_n85_), .c(new_n72_), .d(new_n56_), .O(new_n121_));
  ...
  oai21  g076(.a(new_n126_), .b(new_n59_), .c(new_n128_), .O(z09));
  nor3   g077(.a(x29), .b(x28), .c(x27), .O(new_n131_));
  nand4  g078(.a(new_n131_), .b(new_n106_), .c(new_n78_), .d(new_n56_), .O(new_n132_));
  nand4  g079(.a(new_n102_), .b(new_n54_), .c(new_n65_), .d(new_n53_), .O(new_n133_));
  ...
  nand4  g090(.a(new_n144_), .b(new_n143_), .c(new_n113_), .d(new_n94_), .O(new_n145_));
  oai21  g091(.a(new_n145_), .b(new_n86_), .c(x32), .O(new_n146_));
  nor2   g092(.a(x32), .b(x31), .O(new_n147_));
  nand4  g093(.a(new_n147_), .b(new_n135_), .c(new_n122_), .d(new_n134_), .O(new_n148_));
  ...
  nand4  g103(.a(new_n157_), .b(new_n144_), .c(new_n143_), .d(new_n113_), .O(new_n158_));
  ...
  oai21  g111(.a(new_n158_), .b(new_n104_), .c(x34), .O(new_n166_));
  nand2  g112(.a(new_n143_), .b(new_n113_), .O(new_n167_));
