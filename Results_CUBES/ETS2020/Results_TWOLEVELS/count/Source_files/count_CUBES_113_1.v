...
module FAU ( 
  ...
  nand4  g106(.a(new_n159_), .b(new_n136_), .c(new_n119_), .d(new_n135_), .O(new_n160_));
  oai21  g107(.a(new_n160_), .b(new_n90_), .c(x33), .O(new_n161_));
  inv1   g108(.a(x27), .O(new_n162_));
  inv1   g109(.a(x32), .O(new_n163_));
  inv1   g110(.a(x33), .O(new_n164_));
  nand4  g111(.a(new_n164_), .b(new_n163_), .c(new_n162_), .d(new_n117_), .O(new_n165_));
  inv1   g112(.a(new_n165_), .O(new_n166_));
  nand4  g113(.a(new_n166_), .b(new_n151_), .c(new_n100_), .d(new_n71_), .O(new_n167_));
  nand2  g114(.a(new_n167_), .b(new_n161_), .O(new_n168_));
