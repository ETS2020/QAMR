...
module FAU ( 
  ...
  wire new_n52_, new_n53_, new_n54_, new_n55_, new_n56_, new_n57_, new_n58_,
    ...
    new_n127_, new_n128_, new_n134_, new_n135_, new_n136_, new_n137_,
  ...
  nand4  g054(.a(new_n106_), .b(new_n102_), .c(new_n67_), .d(new_n83_), .O(new_n107_));
  ...
  nand4  g068(.a(new_n120_), .b(new_n113_), .c(new_n72_), .d(new_n62_), .O(new_n121_));
  ...
  nor2   g077(.a(x30), .b(x29), .O(new_n134_));
  nor2   g078(.a(x32), .b(x31), .O(new_n135_));
  nand4  g079(.a(new_n135_), .b(new_n134_), .c(new_n122_), .d(new_n106_), .O(new_n136_));
  oai21  g080(.a(new_n136_), .b(new_n86_), .c(x33), .O(new_n137_));
  nor2   g081(.a(x29), .b(x28), .O(new_n138_));
  nor2   g082(.a(x31), .b(x30), .O(new_n139_));
  nor2   g083(.a(x33), .b(x32), .O(new_n140_));
  nand4  g084(.a(new_n140_), .b(new_n139_), .c(new_n138_), .d(new_n113_), .O(new_n141_));
  inv1   g085(.a(new_n141_), .O(new_n142_));
  nand2  g086(.a(new_n142_), .b(new_n96_), .O(new_n143_));
  nand2  g087(.a(new_n143_), .b(new_n137_), .O(new_n144_));
  nand2  g088(.a(new_n144_), .b(x16), .O(new_n145_));
  inv1   g089(.a(x01), .O(new_n146_));
  aoi21  g090(.a(new_n58_), .b(new_n146_), .c(x18), .O(new_n147_));
  nand2  g091(.a(new_n147_), .b(new_n145_), .O(z14));
  oai21  g092(.a(new_n141_), .b(new_n104_), .c(x34), .O(new_n149_));
  nand2  g093(.a(new_n138_), .b(new_n113_), .O(new_n150_));
  inv1   g094(.a(new_n150_), .O(new_n151_));
  inv1   g095(.a(x30), .O(new_n152_));
  inv1   g096(.a(x31), .O(new_n153_));
  nand2  g097(.a(new_n153_), .b(new_n152_), .O(new_n154_));
  inv1   g098(.a(x32), .O(new_n155_));
  inv1   g099(.a(x33), .O(new_n156_));
  inv1   g100(.a(x34), .O(new_n157_));
  nand3  g101(.a(new_n157_), .b(new_n156_), .c(new_n155_), .O(new_n158_));
  nor2   g102(.a(new_n158_), .b(new_n154_), .O(new_n159_));
  nand3  g103(.a(new_n159_), .b(new_n151_), .c(new_n96_), .O(new_n160_));
  nand2  g104(.a(new_n160_), .b(new_n149_), .O(new_n161_));
  nand2  g105(.a(new_n161_), .b(x16), .O(new_n162_));
  inv1   g106(.a(x00), .O(new_n163_));
  aoi21  g107(.a(new_n58_), .b(new_n163_), .c(x18), .O(new_n164_));
  nand2  g108(.a(new_n164_), .b(new_n162_), .O(z15));
  zero   g109(.O(z01));
  zero   g110(.O(z10));
  zero   g111(.O(z11));
  zero   g112(.O(z12));
