...
module FAU ( 
  ...
  nand4  g060(.a(new_n115_), .b(new_n98_), .c(new_n78_), .d(new_n62_), .O(new_n116_));
  nand4  g061(.a(new_n94_), .b(new_n55_), .c(new_n65_), .d(new_n64_), .O(new_n117_));
  nor2   g062(.a(x26), .b(x25), .O(new_n118_));
  nor2   g063(.a(x28), .b(x27), .O(new_n119_));
  nor2   g064(.a(x30), .b(x29), .O(new_n120_));
  nand4  g065(.a(new_n120_), .b(new_n119_), .c(new_n118_), .d(new_n83_), .O(new_n121_));
  nor2   g066(.a(new_n121_), .b(new_n117_), .O(new_n122_));
  aoi21  g067(.a(new_n116_), .b(x30), .c(new_n122_), .O(new_n123_));
  inv1   g068(.a(x04), .O(new_n124_));
  aoi21  g069(.a(new_n58_), .b(new_n124_), .c(x18), .O(new_n125_));
  oai21  g070(.a(new_n123_), .b(new_n58_), .c(new_n125_), .O(z11));
  oai21  g071(.a(new_n121_), .b(new_n117_), .c(x31), .O(new_n127_));
  ...
  nand3  g077(.a(new_n132_), .b(new_n128_), .c(new_n87_), .O(new_n133_));
  nand2  g078(.a(new_n133_), .b(new_n127_), .O(new_n134_));
  ...
  nand4  g084(.a(new_n140_), .b(new_n120_), .c(new_n119_), .d(new_n118_), .O(new_n141_));
  oai21  g085(.a(new_n141_), .b(new_n86_), .c(x33), .O(new_n142_));
  inv1   g086(.a(x22), .O(new_n143_));
  inv1   g087(.a(x23), .O(new_n144_));
  nand4  g088(.a(new_n105_), .b(new_n83_), .c(new_n144_), .d(new_n143_), .O(new_n145_));
  nor2   g089(.a(new_n145_), .b(new_n66_), .O(new_n146_));
  nor2   g090(.a(x33), .b(x32), .O(new_n147_));
  nand4  g091(.a(new_n147_), .b(new_n130_), .c(new_n129_), .d(new_n106_), .O(new_n148_));
  ...
  nand2  g100(.a(new_n129_), .b(new_n106_), .O(new_n157_));
  ...
  aoi21  g114(.a(new_n58_), .b(new_n170_), .c(x18), .O(new_n171_));
