...
module FAU ( 
  ...
  nand3  g052(.a(new_n72_), .b(new_n54_), .c(new_n53_), .O(new_n106_));
  inv1   g053(.a(x26), .O(new_n107_));
  inv1   g054(.a(x27), .O(new_n108_));
  nand4  g055(.a(new_n81_), .b(new_n108_), .c(new_n107_), .d(new_n90_), .O(new_n109_));
  nor2   g056(.a(new_n109_), .b(new_n106_), .O(new_n110_));
  aoi21  g057(.a(new_n100_), .b(x27), .c(new_n110_), .O(new_n111_));
  ...
  nand4  g062(.a(new_n115_), .b(new_n81_), .c(new_n72_), .d(new_n56_), .O(new_n116_));
  nor2   g063(.a(x25), .b(x24), .O(new_n117_));
  nor2   g064(.a(x28), .b(x27), .O(new_n118_));
  nand4  g065(.a(new_n118_), .b(new_n117_), .c(new_n107_), .d(new_n89_), .O(new_n119_));
  ...
  nand4  g072(.a(new_n126_), .b(new_n99_), .c(new_n79_), .d(new_n56_), .O(new_n127_));
  ...
  nand4  g091(.a(new_n145_), .b(new_n115_), .c(new_n139_), .d(new_n56_), .O(new_n146_));
  nand2  g092(.a(new_n146_), .b(new_n137_), .O(new_n147_));
  nand2  g093(.a(new_n147_), .b(x16), .O(new_n148_));
  inv1   g094(.a(x03), .O(new_n149_));
  aoi21  g095(.a(new_n59_), .b(new_n149_), .c(x18), .O(new_n150_));
  nand2  g096(.a(new_n150_), .b(new_n148_), .O(z12));
  nor2   g097(.a(x32), .b(x31), .O(new_n153_));
  nand4  g098(.a(new_n153_), .b(new_n130_), .c(new_n118_), .d(new_n129_), .O(new_n154_));
  oai21  g099(.a(new_n154_), .b(new_n82_), .c(x33), .O(new_n155_));
  inv1   g100(.a(x32), .O(new_n156_));
  inv1   g101(.a(x33), .O(new_n157_));
  nand4  g102(.a(new_n157_), .b(new_n156_), .c(new_n108_), .d(new_n107_), .O(new_n158_));
  inv1   g103(.a(new_n158_), .O(new_n159_));
  nand4  g104(.a(new_n159_), .b(new_n145_), .c(new_n92_), .d(new_n67_), .O(new_n160_));
  nand2  g105(.a(new_n160_), .b(new_n155_), .O(new_n161_));
