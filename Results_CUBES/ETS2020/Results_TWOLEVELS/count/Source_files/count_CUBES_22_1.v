...
module FAU ( 
  ...
  nand4  g071(.a(new_n126_), .b(new_n113_), .c(new_n125_), .d(new_n90_), .O(new_n127_));
  ...
  nor2   g077(.a(x27), .b(x26), .O(new_n134_));
  nor2   g078(.a(x29), .b(x28), .O(new_n135_));
  nor2   g079(.a(x31), .b(x30), .O(new_n136_));
  nand4  g080(.a(new_n136_), .b(new_n135_), .c(new_n134_), .d(new_n91_), .O(new_n137_));
  oai21  g081(.a(new_n137_), .b(new_n87_), .c(x32), .O(new_n138_));
  inv1   g082(.a(new_n87_), .O(new_n139_));
  nor2   g083(.a(x32), .b(x31), .O(new_n140_));
  nand4  g084(.a(new_n140_), .b(new_n126_), .c(new_n113_), .d(new_n125_), .O(new_n141_));
  inv1   g085(.a(new_n141_), .O(new_n142_));
  nand2  g086(.a(new_n142_), .b(new_n139_), .O(new_n143_));
  nand2  g087(.a(new_n143_), .b(new_n138_), .O(new_n144_));
  nand2  g088(.a(new_n144_), .b(x16), .O(new_n145_));
  inv1   g089(.a(x02), .O(new_n146_));
  aoi21  g090(.a(new_n59_), .b(new_n146_), .c(x18), .O(new_n147_));
  nand2  g091(.a(new_n147_), .b(new_n145_), .O(z13));
  oai21  g092(.a(new_n141_), .b(new_n87_), .c(x33), .O(new_n149_));
  nor2   g093(.a(x33), .b(x32), .O(new_n150_));
  nand4  g094(.a(new_n150_), .b(new_n136_), .c(new_n135_), .d(new_n134_), .O(new_n151_));
  inv1   g095(.a(new_n151_), .O(new_n152_));
  nand2  g096(.a(new_n152_), .b(new_n93_), .O(new_n153_));
  ...
  nand2  g103(.a(new_n135_), .b(new_n134_), .O(new_n160_));
  ...
  nand3  g113(.a(new_n169_), .b(new_n161_), .c(new_n93_), .O(new_n170_));
