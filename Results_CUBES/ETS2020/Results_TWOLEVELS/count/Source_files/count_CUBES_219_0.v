...
module FAU ( 
  ...
  nand4  g079(.a(new_n135_), .b(new_n134_), .c(new_n107_), .d(new_n87_), .O(new_n136_));
  oai21  g080(.a(new_n136_), .b(new_n79_), .c(x32), .O(new_n137_));
  nor2   g081(.a(x26), .b(x25), .O(new_n138_));
  nor2   g082(.a(x30), .b(x29), .O(new_n139_));
  nor2   g083(.a(x32), .b(x31), .O(new_n140_));
  nand4  g084(.a(new_n140_), .b(new_n139_), .c(new_n116_), .d(new_n138_), .O(new_n141_));
  inv1   g085(.a(new_n141_), .O(new_n142_));
  nand2  g086(.a(new_n142_), .b(new_n80_), .O(new_n143_));
  ...
  oai21  g092(.a(new_n141_), .b(new_n79_), .c(x33), .O(new_n149_));
  nor2   g093(.a(x33), .b(x32), .O(new_n150_));
  nand4  g094(.a(new_n150_), .b(new_n135_), .c(new_n134_), .d(new_n107_), .O(new_n151_));
  inv1   g095(.a(new_n151_), .O(new_n152_));
  nand2  g096(.a(new_n152_), .b(new_n89_), .O(new_n153_));
  ...
  oai21  g102(.a(new_n151_), .b(new_n97_), .c(x34), .O(new_n159_));
  nand2  g103(.a(new_n134_), .b(new_n107_), .O(new_n160_));
  ...
  nand3  g113(.a(new_n169_), .b(new_n161_), .c(new_n89_), .O(new_n170_));
