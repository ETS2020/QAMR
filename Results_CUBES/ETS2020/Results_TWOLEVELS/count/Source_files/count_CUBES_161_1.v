...
module FAU ( 
  ...
  nand4  g071(.a(new_n125_), .b(new_n106_), .c(new_n78_), .d(new_n56_), .O(new_n126_));
  nand4  g072(.a(new_n102_), .b(new_n54_), .c(new_n65_), .d(new_n53_), .O(new_n127_));
  nor2   g073(.a(x26), .b(x25), .O(new_n128_));
  nor2   g074(.a(x30), .b(x29), .O(new_n129_));
  nand4  g075(.a(new_n129_), .b(new_n116_), .c(new_n128_), .d(new_n83_), .O(new_n130_));
  ...
  nand3  g086(.a(new_n140_), .b(new_n114_), .c(new_n87_), .O(new_n141_));
  ...
  nand4  g093(.a(new_n148_), .b(new_n129_), .c(new_n116_), .d(new_n128_), .O(new_n149_));
  oai21  g094(.a(new_n149_), .b(new_n86_), .c(x33), .O(new_n150_));
  nor2   g095(.a(x27), .b(x26), .O(new_n151_));
  nor2   g096(.a(x33), .b(x32), .O(new_n152_));
  nand4  g097(.a(new_n152_), .b(new_n138_), .c(new_n137_), .d(new_n151_), .O(new_n153_));
  inv1   g098(.a(new_n153_), .O(new_n154_));
  nand2  g099(.a(new_n154_), .b(new_n96_), .O(new_n155_));
  nand2  g100(.a(new_n155_), .b(new_n150_), .O(new_n156_));
  ...
  oai21  g105(.a(new_n153_), .b(new_n104_), .c(x34), .O(new_n161_));
  nand2  g106(.a(new_n137_), .b(new_n151_), .O(new_n162_));
  ...
  nand3  g116(.a(new_n171_), .b(new_n163_), .c(new_n96_), .O(new_n172_));
