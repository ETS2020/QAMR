...
module FAU ( 
  ...
  nand4  g097(.a(new_n151_), .b(new_n131_), .c(new_n118_), .d(new_n130_), .O(new_n152_));
  oai21  g098(.a(new_n152_), .b(new_n90_), .c(x33), .O(new_n153_));
  ...
  nand4  g109(.a(new_n117_), .b(new_n106_), .c(new_n163_), .d(new_n55_), .O(new_n164_));
