// Benchmark "FAU" written by ABC on Tue Jul  7 19:19:49 2020
...
module FAU ( 
  ...
  wire new_n53_, new_n54_, new_n55_, new_n56_, new_n57_, new_n58_, new_n59_,
    ...
    new_n114_, new_n115_, new_n116_, new_n117_, new_n118_, new_n122_,
  ...
  nand4  g068(.a(new_n122_), .b(new_n106_), .c(new_n78_), .d(new_n56_), .O(new_n123_));
  nand4  g069(.a(new_n102_), .b(new_n54_), .c(new_n65_), .d(new_n53_), .O(new_n124_));
  nor2   g070(.a(x26), .b(x25), .O(new_n125_));
  nor2   g071(.a(x28), .b(x27), .O(new_n126_));
  nor2   g072(.a(x30), .b(x29), .O(new_n127_));
  nand4  g073(.a(new_n127_), .b(new_n126_), .c(new_n125_), .d(new_n83_), .O(new_n128_));
  nor2   g074(.a(new_n128_), .b(new_n124_), .O(new_n129_));
  aoi21  g075(.a(new_n123_), .b(x30), .c(new_n129_), .O(new_n130_));
  inv1   g076(.a(x04), .O(new_n131_));
  aoi21  g077(.a(new_n59_), .b(new_n131_), .c(x18), .O(new_n132_));
  oai21  g078(.a(new_n130_), .b(new_n59_), .c(new_n132_), .O(z11));
  oai21  g079(.a(new_n128_), .b(new_n124_), .c(x31), .O(new_n134_));
  ...
  nand3  g085(.a(new_n139_), .b(new_n135_), .c(new_n87_), .O(new_n140_));
  nand2  g086(.a(new_n140_), .b(new_n134_), .O(new_n141_));
  nand2  g087(.a(new_n141_), .b(x16), .O(new_n142_));
  inv1   g088(.a(x03), .O(new_n143_));
  aoi21  g089(.a(new_n59_), .b(new_n143_), .c(x18), .O(new_n144_));
  nand2  g090(.a(new_n144_), .b(new_n142_), .O(z12));
  nand4  g091(.a(new_n137_), .b(new_n136_), .c(new_n113_), .d(new_n94_), .O(new_n146_));
  oai21  g092(.a(new_n146_), .b(new_n86_), .c(x32), .O(new_n147_));
  nor2   g093(.a(x32), .b(x31), .O(new_n148_));
  nand4  g094(.a(new_n148_), .b(new_n127_), .c(new_n126_), .d(new_n125_), .O(new_n149_));
  ...
  aoi21  g100(.a(new_n59_), .b(new_n154_), .c(x18), .O(new_n155_));
