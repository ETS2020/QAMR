// Benchmark "FAU" written by ABC on Tue Jul  7 19:20:41 2020
...
module FAU ( 
  ...
  nand4  g045(.a(new_n100_), .b(new_n82_), .c(new_n73_), .d(new_n56_), .O(new_n101_));
  inv1   g046(.a(x26), .O(new_n102_));
  nor2   g047(.a(x25), .b(x24), .O(new_n103_));
  nor2   g048(.a(x28), .b(x27), .O(new_n104_));
  nand4  g049(.a(new_n104_), .b(new_n103_), .c(new_n102_), .d(new_n90_), .O(new_n105_));
  nor2   g050(.a(new_n105_), .b(new_n74_), .O(new_n106_));
  ...
  oai21  g055(.a(new_n105_), .b(new_n74_), .c(x29), .O(new_n111_));
  nor3   g056(.a(x26), .b(x25), .c(x24), .O(new_n112_));
  nor3   g057(.a(x29), .b(x28), .c(x27), .O(new_n113_));
  nand4  g058(.a(new_n113_), .b(new_n112_), .c(new_n75_), .d(new_n56_), .O(new_n114_));
  nand2  g059(.a(new_n114_), .b(new_n111_), .O(new_n115_));
  ...
  nor2   g064(.a(x23), .b(x22), .O(new_n121_));
  nand4  g065(.a(new_n121_), .b(new_n54_), .c(new_n65_), .d(new_n53_), .O(new_n122_));
  nor2   g066(.a(x26), .b(x25), .O(new_n123_));
  nor2   g067(.a(x30), .b(x29), .O(new_n124_));
  nand4  g068(.a(new_n124_), .b(new_n123_), .c(new_n104_), .d(new_n80_), .O(new_n125_));
  oai21  g069(.a(new_n125_), .b(new_n122_), .c(x31), .O(new_n126_));
  nand4  g070(.a(new_n80_), .b(new_n90_), .c(new_n89_), .d(new_n65_), .O(new_n127_));
  ...
  nand4  g078(.a(new_n134_), .b(new_n100_), .c(new_n128_), .d(new_n56_), .O(new_n135_));
  nand2  g079(.a(new_n135_), .b(new_n126_), .O(new_n136_));
  ...
  nor2   g084(.a(x32), .b(x31), .O(new_n142_));
  nand4  g085(.a(new_n142_), .b(new_n124_), .c(new_n123_), .d(new_n104_), .O(new_n143_));
  oai21  g086(.a(new_n143_), .b(new_n83_), .c(x33), .O(new_n144_));
  inv1   g087(.a(x27), .O(new_n145_));
  inv1   g088(.a(x32), .O(new_n146_));
  inv1   g089(.a(x33), .O(new_n147_));
  nand4  g090(.a(new_n147_), .b(new_n146_), .c(new_n145_), .d(new_n102_), .O(new_n148_));
  inv1   g091(.a(new_n148_), .O(new_n149_));
  nand4  g092(.a(new_n149_), .b(new_n134_), .c(new_n93_), .d(new_n67_), .O(new_n150_));
  nand2  g093(.a(new_n150_), .b(new_n144_), .O(new_n151_));
  nand2  g094(.a(new_n151_), .b(x16), .O(new_n152_));
  inv1   g095(.a(x01), .O(new_n153_));
  aoi21  g096(.a(new_n59_), .b(new_n153_), .c(x18), .O(new_n154_));
