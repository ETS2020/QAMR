...
module FAU ( 
  ...
  nand3  g067(.a(new_n120_), .b(new_n119_), .c(new_n107_), .O(new_n121_));
  oai21  g068(.a(new_n121_), .b(new_n81_), .c(x29), .O(new_n122_));
  nor3   g069(.a(x29), .b(x28), .c(x27), .O(new_n123_));
  nand4  g070(.a(new_n123_), .b(new_n110_), .c(new_n82_), .d(new_n63_), .O(new_n124_));
  ...
  nand4  g076(.a(new_n106_), .b(new_n55_), .c(new_n69_), .d(new_n61_), .O(new_n130_));
  nor2   g077(.a(x26), .b(x25), .O(new_n131_));
  nor2   g078(.a(x30), .b(x29), .O(new_n132_));
  nand4  g079(.a(new_n132_), .b(new_n119_), .c(new_n131_), .d(new_n87_), .O(new_n133_));
  ...
  nor3   g086(.a(x29), .b(x28), .c(x25), .O(new_n140_));
  nor2   g087(.a(x27), .b(x26), .O(new_n141_));
  ...
  nand4  g101(.a(new_n154_), .b(new_n132_), .c(new_n119_), .d(new_n131_), .O(new_n155_));
