...
module FAU ( 
  ...
  nand4  g069(.a(new_n88_), .b(new_n54_), .c(new_n65_), .d(new_n53_), .O(new_n124_));
  inv1   g070(.a(x24), .O(new_n125_));
  nor2   g071(.a(x26), .b(x25), .O(new_n126_));
  nor2   g072(.a(x30), .b(x29), .O(new_n127_));
  nand4  g073(.a(new_n127_), .b(new_n109_), .c(new_n126_), .d(new_n125_), .O(new_n128_));
  ...
  inv1   g080(.a(x22), .O(new_n135_));
  nand4  g081(.a(new_n125_), .b(new_n107_), .c(new_n135_), .d(new_n65_), .O(new_n136_));
  ...
  nand4  g089(.a(new_n143_), .b(new_n105_), .c(new_n137_), .d(new_n56_), .O(new_n144_));
  ...
  inv1   g095(.a(x25), .O(new_n150_));
  nor2   g096(.a(x27), .b(x26), .O(new_n151_));
  ...
  oai21  g100(.a(new_n154_), .b(new_n85_), .c(x32), .O(new_n155_));
  inv1   g101(.a(x27), .O(new_n156_));
  nand4  g102(.a(new_n140_), .b(new_n139_), .c(new_n138_), .d(new_n156_), .O(new_n157_));
  inv1   g103(.a(new_n157_), .O(new_n158_));
  inv1   g104(.a(x32), .O(new_n159_));
  nand4  g105(.a(new_n159_), .b(new_n141_), .c(new_n108_), .d(new_n150_), .O(new_n160_));
  inv1   g106(.a(new_n160_), .O(new_n161_));
  nand4  g107(.a(new_n161_), .b(new_n158_), .c(new_n137_), .d(new_n56_), .O(new_n162_));
  nand2  g108(.a(new_n162_), .b(new_n155_), .O(new_n163_));
  nand2  g109(.a(new_n163_), .b(x16), .O(new_n164_));
  inv1   g110(.a(x02), .O(new_n165_));
  aoi21  g111(.a(new_n59_), .b(new_n165_), .c(x18), .O(new_n166_));
  nand2  g112(.a(new_n166_), .b(new_n164_), .O(z13));
  nor2   g113(.a(x32), .b(x31), .O(new_n168_));
  nand4  g114(.a(new_n168_), .b(new_n127_), .c(new_n109_), .d(new_n126_), .O(new_n169_));
  oai21  g115(.a(new_n169_), .b(new_n85_), .c(x33), .O(new_n170_));
  nand4  g116(.a(new_n150_), .b(new_n125_), .c(new_n107_), .d(new_n135_), .O(new_n171_));
  inv1   g117(.a(new_n171_), .O(new_n172_));
  inv1   g118(.a(x33), .O(new_n173_));
  nand4  g119(.a(new_n173_), .b(new_n159_), .c(new_n156_), .d(new_n108_), .O(new_n174_));
  inv1   g120(.a(new_n174_), .O(new_n175_));
  nand4  g121(.a(new_n175_), .b(new_n143_), .c(new_n172_), .d(new_n67_), .O(new_n176_));
  nand2  g122(.a(new_n176_), .b(new_n170_), .O(new_n177_));
