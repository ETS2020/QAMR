...
module FAU ( 
  ...
  nand3  g052(.a(new_n105_), .b(new_n84_), .c(new_n104_), .O(new_n106_));
  ...
  nand4  g059(.a(new_n112_), .b(new_n84_), .c(new_n72_), .d(new_n56_), .O(new_n113_));
  inv1   g060(.a(x23), .O(new_n114_));
  inv1   g061(.a(x26), .O(new_n115_));
  nor2   g062(.a(x28), .b(x27), .O(new_n116_));
  nand4  g063(.a(new_n116_), .b(new_n89_), .c(new_n115_), .d(new_n114_), .O(new_n117_));
  ...
  oai21  g069(.a(new_n117_), .b(new_n77_), .c(x29), .O(new_n123_));
  nor3   g070(.a(x29), .b(x28), .c(x27), .O(new_n124_));
  nand4  g071(.a(new_n124_), .b(new_n97_), .c(new_n78_), .d(new_n56_), .O(new_n125_));
  ...
  nand4  g077(.a(new_n88_), .b(new_n54_), .c(new_n65_), .d(new_n53_), .O(new_n131_));
  ...
  oai21  g087(.a(new_n135_), .b(new_n131_), .c(x31), .O(new_n141_));
  inv1   g088(.a(x22), .O(new_n142_));
  nand4  g089(.a(new_n132_), .b(new_n114_), .c(new_n142_), .d(new_n65_), .O(new_n143_));
  ...
  nand4  g097(.a(new_n150_), .b(new_n112_), .c(new_n144_), .d(new_n56_), .O(new_n151_));
  nand2  g098(.a(new_n151_), .b(new_n141_), .O(new_n152_));
  nand2  g099(.a(new_n152_), .b(x16), .O(new_n153_));
  inv1   g100(.a(x03), .O(new_n154_));
  aoi21  g101(.a(new_n59_), .b(new_n154_), .c(x18), .O(new_n155_));
  nand2  g102(.a(new_n155_), .b(new_n153_), .O(z12));
  nor2   g103(.a(x29), .b(x28), .O(new_n157_));
  nor2   g104(.a(x31), .b(x30), .O(new_n158_));
  nand4  g105(.a(new_n158_), .b(new_n157_), .c(new_n105_), .d(new_n104_), .O(new_n159_));
  oai21  g106(.a(new_n159_), .b(new_n85_), .c(x32), .O(new_n160_));
  ...
  nand4  g111(.a(new_n164_), .b(new_n148_), .c(new_n115_), .d(new_n104_), .O(new_n165_));
  inv1   g112(.a(new_n165_), .O(new_n166_));
  nand4  g113(.a(new_n166_), .b(new_n163_), .c(new_n144_), .d(new_n56_), .O(new_n167_));
  nand2  g114(.a(new_n167_), .b(new_n160_), .O(new_n168_));
  nand2  g115(.a(new_n168_), .b(x16), .O(new_n169_));
  inv1   g116(.a(x02), .O(new_n170_));
  aoi21  g117(.a(new_n59_), .b(new_n170_), .c(x18), .O(new_n171_));
  nand2  g118(.a(new_n171_), .b(new_n169_), .O(z13));
  nor2   g119(.a(x32), .b(x31), .O(new_n173_));
  nand4  g120(.a(new_n173_), .b(new_n134_), .c(new_n116_), .d(new_n133_), .O(new_n174_));
  oai21  g121(.a(new_n174_), .b(new_n85_), .c(x33), .O(new_n175_));
  nand4  g122(.a(new_n104_), .b(new_n132_), .c(new_n114_), .d(new_n142_), .O(new_n176_));
  inv1   g123(.a(new_n176_), .O(new_n177_));
  inv1   g124(.a(x33), .O(new_n178_));
  nand4  g125(.a(new_n178_), .b(new_n164_), .c(new_n161_), .d(new_n115_), .O(new_n179_));
  inv1   g126(.a(new_n179_), .O(new_n180_));
  nand4  g127(.a(new_n180_), .b(new_n150_), .c(new_n177_), .d(new_n67_), .O(new_n181_));
  nand2  g128(.a(new_n181_), .b(new_n175_), .O(new_n182_));
  nand2  g129(.a(new_n182_), .b(x16), .O(new_n183_));
  inv1   g130(.a(x01), .O(new_n184_));
  aoi21  g131(.a(new_n59_), .b(new_n184_), .c(x18), .O(new_n185_));
  nand2  g132(.a(new_n185_), .b(new_n183_), .O(z14));
  zero   g133(.O(z00));
  zero   g134(.O(z05));
  zero   g135(.O(z15));
endmodule
