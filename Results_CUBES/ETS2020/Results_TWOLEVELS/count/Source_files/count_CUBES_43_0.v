...
module FAU ( 
  ...
  nand4  g096(.a(new_n150_), .b(new_n135_), .c(new_n117_), .d(new_n134_), .O(new_n151_));
  inv1   g097(.a(new_n151_), .O(new_n152_));
  nand2  g098(.a(new_n152_), .b(new_n81_), .O(new_n153_));
  ...
  oai21  g104(.a(new_n151_), .b(new_n80_), .c(x33), .O(new_n159_));
  nor2   g105(.a(x33), .b(x32), .O(new_n160_));
  nand4  g106(.a(new_n160_), .b(new_n139_), .c(new_n138_), .d(new_n107_), .O(new_n161_));
  ...
  nand4  g114(.a(new_n116_), .b(new_n99_), .c(new_n98_), .d(new_n55_), .O(new_n169_));
  oai21  g115(.a(new_n161_), .b(new_n169_), .c(x34), .O(new_n170_));
  nand2  g116(.a(new_n138_), .b(new_n107_), .O(new_n171_));
