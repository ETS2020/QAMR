// Benchmark "FAU" written by ABC on Tue Jul  7 19:19:24 2020
...
module FAU ( 
  ...
  inv1   g033(.a(new_n70_), .O(new_n87_));
  ...
  aoi22  g039(.a(new_n92_), .b(new_n87_), .c(new_n81_), .d(x25), .O(new_n93_));
  ...
  oai21  g043(.a(new_n91_), .b(new_n70_), .c(x26), .O(new_n97_));
  nor2   g044(.a(x23), .b(x22), .O(new_n98_));
  nor3   g045(.a(x26), .b(x25), .c(x24), .O(new_n99_));
  nand3  g046(.a(new_n99_), .b(new_n98_), .c(new_n87_), .O(new_n100_));
  ...
  nand3  g054(.a(new_n107_), .b(new_n80_), .c(new_n90_), .O(new_n108_));
  ...
  nand4  g061(.a(new_n116_), .b(new_n99_), .c(new_n78_), .d(new_n63_), .O(new_n117_));
  nand4  g062(.a(new_n98_), .b(new_n55_), .c(new_n69_), .d(new_n61_), .O(new_n118_));
  nor2   g063(.a(x26), .b(x25), .O(new_n119_));
  nor2   g064(.a(x28), .b(x27), .O(new_n120_));
  nor2   g065(.a(x30), .b(x29), .O(new_n121_));
  nand4  g066(.a(new_n121_), .b(new_n120_), .c(new_n119_), .d(new_n77_), .O(new_n122_));
  ...
  nand4  g073(.a(new_n77_), .b(new_n89_), .c(new_n88_), .d(new_n69_), .O(new_n129_));
  ...
  nand4  g082(.a(new_n137_), .b(new_n131_), .c(new_n130_), .d(new_n63_), .O(new_n138_));
  ...
  nor2   g088(.a(x29), .b(x28), .O(new_n144_));
  nor2   g089(.a(x31), .b(x30), .O(new_n145_));
  nand4  g090(.a(new_n145_), .b(new_n144_), .c(new_n107_), .d(new_n90_), .O(new_n146_));
  oai21  g091(.a(new_n146_), .b(new_n81_), .c(x32), .O(new_n147_));
  inv1   g092(.a(x27), .O(new_n148_));
  nand4  g093(.a(new_n134_), .b(new_n133_), .c(new_n132_), .d(new_n148_), .O(new_n149_));
  inv1   g094(.a(new_n149_), .O(new_n150_));
  inv1   g095(.a(x26), .O(new_n151_));
  inv1   g096(.a(x32), .O(new_n152_));
  nand4  g097(.a(new_n152_), .b(new_n135_), .c(new_n151_), .d(new_n90_), .O(new_n153_));
  inv1   g098(.a(new_n153_), .O(new_n154_));
  nand4  g099(.a(new_n154_), .b(new_n150_), .c(new_n130_), .d(new_n63_), .O(new_n155_));
  nand2  g100(.a(new_n155_), .b(new_n147_), .O(new_n156_));
  ...
  nor2   g105(.a(x32), .b(x31), .O(new_n161_));
  nand4  g106(.a(new_n161_), .b(new_n121_), .c(new_n120_), .d(new_n119_), .O(new_n162_));
  oai21  g107(.a(new_n162_), .b(new_n81_), .c(x33), .O(new_n163_));
  inv1   g108(.a(x33), .O(new_n164_));
  nand4  g109(.a(new_n164_), .b(new_n152_), .c(new_n148_), .d(new_n151_), .O(new_n165_));
  inv1   g110(.a(new_n165_), .O(new_n166_));
  nand4  g111(.a(new_n166_), .b(new_n137_), .c(new_n92_), .d(new_n87_), .O(new_n167_));
  nand2  g112(.a(new_n167_), .b(new_n163_), .O(new_n168_));
  nand2  g113(.a(new_n168_), .b(x16), .O(new_n169_));
  inv1   g114(.a(x01), .O(new_n170_));
  aoi21  g115(.a(new_n58_), .b(new_n170_), .c(x18), .O(new_n171_));
  nand2  g116(.a(new_n171_), .b(new_n169_), .O(z14));
  zero   g117(.O(z02));
  zero   g118(.O(z04));
  zero   g119(.O(z09));
  zero   g120(.O(z10));
