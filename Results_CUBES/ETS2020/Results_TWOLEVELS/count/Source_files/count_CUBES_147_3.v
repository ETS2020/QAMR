...
module FAU ( 
  ...
  nand4  g070(.a(new_n123_), .b(new_n107_), .c(new_n82_), .d(new_n63_), .O(new_n124_));
  nand4  g071(.a(new_n98_), .b(new_n55_), .c(new_n69_), .d(new_n61_), .O(new_n125_));
  inv1   g072(.a(x26), .O(new_n126_));
  nor2   g073(.a(x28), .b(x27), .O(new_n127_));
  nor2   g074(.a(x30), .b(x29), .O(new_n128_));
  nand4  g075(.a(new_n128_), .b(new_n127_), .c(new_n99_), .d(new_n126_), .O(new_n129_));
  nor2   g076(.a(new_n129_), .b(new_n125_), .O(new_n130_));
  ...
  oai21  g080(.a(new_n131_), .b(new_n58_), .c(new_n133_), .O(z11));
  oai21  g081(.a(new_n129_), .b(new_n125_), .c(x31), .O(new_n135_));
  inv1   g082(.a(new_n90_), .O(new_n136_));
  nor3   g083(.a(x27), .b(x26), .c(x25), .O(new_n137_));
  nor2   g084(.a(x29), .b(x28), .O(new_n138_));
  nor2   g085(.a(x31), .b(x30), .O(new_n139_));
  nand2  g086(.a(new_n139_), .b(new_n138_), .O(new_n140_));
  inv1   g087(.a(new_n140_), .O(new_n141_));
  nand4  g088(.a(new_n141_), .b(new_n137_), .c(new_n136_), .d(new_n63_), .O(new_n142_));
  nand2  g089(.a(new_n142_), .b(new_n135_), .O(new_n143_));
  nand2  g090(.a(new_n143_), .b(x16), .O(new_n144_));
  inv1   g091(.a(x03), .O(new_n145_));
  aoi21  g092(.a(new_n58_), .b(new_n145_), .c(x18), .O(new_n146_));
  nand2  g093(.a(new_n146_), .b(new_n144_), .O(z12));
  nor2   g094(.a(x33), .b(x32), .O(new_n150_));
  nand4  g095(.a(new_n150_), .b(new_n139_), .c(new_n138_), .d(new_n114_), .O(new_n151_));
  oai21  g096(.a(new_n151_), .b(new_n100_), .c(x34), .O(new_n152_));
  inv1   g097(.a(x22), .O(new_n153_));
  inv1   g098(.a(x23), .O(new_n154_));
  nand4  g099(.a(new_n96_), .b(new_n87_), .c(new_n154_), .d(new_n153_), .O(new_n155_));
  nor2   g100(.a(new_n155_), .b(new_n70_), .O(new_n156_));
  nand2  g101(.a(new_n138_), .b(new_n114_), .O(new_n157_));
  inv1   g102(.a(new_n157_), .O(new_n158_));
  inv1   g103(.a(x30), .O(new_n159_));
  inv1   g104(.a(x31), .O(new_n160_));
  nand2  g105(.a(new_n160_), .b(new_n159_), .O(new_n161_));
  inv1   g106(.a(x32), .O(new_n162_));
  inv1   g107(.a(x33), .O(new_n163_));
  inv1   g108(.a(x34), .O(new_n164_));
  nand3  g109(.a(new_n164_), .b(new_n163_), .c(new_n162_), .O(new_n165_));
  nor2   g110(.a(new_n165_), .b(new_n161_), .O(new_n166_));
  nand3  g111(.a(new_n166_), .b(new_n158_), .c(new_n156_), .O(new_n167_));
  nand2  g112(.a(new_n167_), .b(new_n152_), .O(new_n168_));
  nand2  g113(.a(new_n168_), .b(x16), .O(new_n169_));
  inv1   g114(.a(x00), .O(new_n170_));
  aoi21  g115(.a(new_n58_), .b(new_n170_), .c(x18), .O(new_n171_));
  nand2  g116(.a(new_n171_), .b(new_n169_), .O(z15));
  zero   g117(.O(z09));
  zero   g118(.O(z10));
  zero   g119(.O(z13));
  zero   g120(.O(z14));
