...
module FAU ( 
  ...
  nand4  g092(.a(new_n145_), .b(new_n144_), .c(new_n117_), .d(new_n98_), .O(new_n146_));
  oai21  g093(.a(new_n146_), .b(new_n90_), .c(x32), .O(new_n147_));
  inv1   g094(.a(x30), .O(new_n148_));
  inv1   g095(.a(x31), .O(new_n149_));
  inv1   g096(.a(x32), .O(new_n150_));
  nand4  g097(.a(new_n150_), .b(new_n149_), .c(new_n148_), .d(new_n134_), .O(new_n151_));
  nor2   g098(.a(x26), .b(x25), .O(new_n152_));
  nand2  g099(.a(new_n126_), .b(new_n152_), .O(new_n153_));
  nor2   g100(.a(new_n153_), .b(new_n151_), .O(new_n154_));
  nand2  g101(.a(new_n154_), .b(new_n91_), .O(new_n155_));
  nand2  g102(.a(new_n155_), .b(new_n147_), .O(new_n156_));
  ...
  nand4  g108(.a(new_n162_), .b(new_n145_), .c(new_n144_), .d(new_n117_), .O(new_n163_));
  oai21  g109(.a(new_n163_), .b(new_n108_), .c(x34), .O(new_n164_));
  nand2  g110(.a(new_n144_), .b(new_n117_), .O(new_n165_));
  inv1   g111(.a(new_n165_), .O(new_n166_));
  nand2  g112(.a(new_n149_), .b(new_n148_), .O(new_n167_));
  inv1   g113(.a(x33), .O(new_n168_));
  inv1   g114(.a(x34), .O(new_n169_));
  nand3  g115(.a(new_n169_), .b(new_n168_), .c(new_n150_), .O(new_n170_));
  nor2   g116(.a(new_n170_), .b(new_n167_), .O(new_n171_));
  nand3  g117(.a(new_n171_), .b(new_n166_), .c(new_n100_), .O(new_n172_));
  nand2  g118(.a(new_n172_), .b(new_n164_), .O(new_n173_));
  nand2  g119(.a(new_n173_), .b(x16), .O(new_n174_));
  inv1   g120(.a(x00), .O(new_n175_));
  aoi21  g121(.a(new_n58_), .b(new_n175_), .c(x18), .O(new_n176_));
  nand2  g122(.a(new_n176_), .b(new_n174_), .O(z15));
  zero   g123(.O(z11));
  zero   g124(.O(z12));
  zero   g125(.O(z14));
endmodule
