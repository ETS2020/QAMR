...
module FAU ( 
  ...
  nand4  g080(.a(new_n98_), .b(new_n55_), .c(new_n69_), .d(new_n61_), .O(new_n134_));
  nor2   g081(.a(x26), .b(x25), .O(new_n135_));
  nor2   g082(.a(x30), .b(x29), .O(new_n136_));
  nand4  g083(.a(new_n136_), .b(new_n118_), .c(new_n135_), .d(new_n89_), .O(new_n137_));
  ...
  oai21  g089(.a(new_n137_), .b(new_n134_), .c(x31), .O(new_n143_));
  nand2  g090(.a(new_n85_), .b(new_n77_), .O(new_n144_));
  inv1   g091(.a(new_n144_), .O(new_n145_));
  nor2   g092(.a(x29), .b(x28), .O(new_n146_));
  nor2   g093(.a(x31), .b(x30), .O(new_n147_));
  nand2  g094(.a(new_n147_), .b(new_n146_), .O(new_n148_));
  inv1   g095(.a(new_n148_), .O(new_n149_));
  nand4  g096(.a(new_n149_), .b(new_n116_), .c(new_n145_), .d(new_n63_), .O(new_n150_));
  nand2  g097(.a(new_n150_), .b(new_n143_), .O(new_n151_));
  nand2  g098(.a(new_n151_), .b(x16), .O(new_n152_));
  inv1   g099(.a(x03), .O(new_n153_));
  aoi21  g100(.a(new_n58_), .b(new_n153_), .c(x18), .O(new_n154_));
  nand2  g101(.a(new_n154_), .b(new_n152_), .O(z12));
  nand4  g102(.a(new_n147_), .b(new_n146_), .c(new_n109_), .d(new_n90_), .O(new_n156_));
  oai21  g103(.a(new_n156_), .b(new_n86_), .c(x32), .O(new_n157_));
  nand2  g104(.a(new_n136_), .b(new_n118_), .O(new_n158_));
  inv1   g105(.a(new_n158_), .O(new_n159_));
  nor2   g106(.a(x32), .b(x31), .O(new_n160_));
  nand2  g107(.a(new_n160_), .b(new_n135_), .O(new_n161_));
  inv1   g108(.a(new_n161_), .O(new_n162_));
  nand4  g109(.a(new_n162_), .b(new_n159_), .c(new_n145_), .d(new_n63_), .O(new_n163_));
  nand2  g110(.a(new_n163_), .b(new_n157_), .O(new_n164_));
  nand2  g111(.a(new_n164_), .b(x16), .O(new_n165_));
  inv1   g112(.a(x02), .O(new_n166_));
  aoi21  g113(.a(new_n58_), .b(new_n166_), .c(x18), .O(new_n167_));
  nand2  g114(.a(new_n167_), .b(new_n165_), .O(z13));
  nand4  g115(.a(new_n160_), .b(new_n136_), .c(new_n118_), .d(new_n135_), .O(new_n169_));
  oai21  g116(.a(new_n169_), .b(new_n86_), .c(x33), .O(new_n170_));
  nor2   g117(.a(x33), .b(x32), .O(new_n171_));
  nand4  g118(.a(new_n171_), .b(new_n147_), .c(new_n146_), .d(new_n109_), .O(new_n172_));
  inv1   g119(.a(new_n172_), .O(new_n173_));
  nand2  g120(.a(new_n173_), .b(new_n92_), .O(new_n174_));
  nand2  g121(.a(new_n174_), .b(new_n170_), .O(new_n175_));
  nand2  g122(.a(new_n175_), .b(x16), .O(new_n176_));
  inv1   g123(.a(x01), .O(new_n177_));
  aoi21  g124(.a(new_n58_), .b(new_n177_), .c(x18), .O(new_n178_));
  nand2  g125(.a(new_n178_), .b(new_n176_), .O(z14));
  oai21  g126(.a(new_n172_), .b(new_n100_), .c(x34), .O(new_n180_));
  nand2  g127(.a(new_n146_), .b(new_n109_), .O(new_n181_));
  inv1   g128(.a(new_n181_), .O(new_n182_));
  inv1   g129(.a(x30), .O(new_n183_));
  inv1   g130(.a(x31), .O(new_n184_));
  nand2  g131(.a(new_n184_), .b(new_n183_), .O(new_n185_));
  inv1   g132(.a(x32), .O(new_n186_));
  inv1   g133(.a(x33), .O(new_n187_));
  inv1   g134(.a(x34), .O(new_n188_));
  nand3  g135(.a(new_n188_), .b(new_n187_), .c(new_n186_), .O(new_n189_));
  nor2   g136(.a(new_n189_), .b(new_n185_), .O(new_n190_));
  nand3  g137(.a(new_n190_), .b(new_n182_), .c(new_n92_), .O(new_n191_));
  nand2  g138(.a(new_n191_), .b(new_n180_), .O(new_n192_));
  nand2  g139(.a(new_n192_), .b(x16), .O(new_n193_));
  inv1   g140(.a(x00), .O(new_n194_));
  aoi21  g141(.a(new_n58_), .b(new_n194_), .c(x18), .O(new_n195_));
  nand2  g142(.a(new_n195_), .b(new_n193_), .O(z15));
  zero   g143(.O(z03));
  zero   g144(.O(z05));
endmodule
