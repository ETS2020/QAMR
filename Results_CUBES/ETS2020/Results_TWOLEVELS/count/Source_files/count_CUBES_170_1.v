...
module FAU ( 
  ...
  nand4  g075(.a(new_n94_), .b(new_n54_), .c(new_n62_), .d(new_n53_), .O(new_n131_));
  ...
  nand4  g093(.a(new_n149_), .b(new_n133_), .c(new_n114_), .d(new_n132_), .O(new_n150_));
  oai21  g094(.a(new_n150_), .b(new_n82_), .c(x33), .O(new_n151_));
  nor2   g095(.a(x33), .b(x32), .O(new_n152_));
  nand4  g096(.a(new_n152_), .b(new_n139_), .c(new_n138_), .d(new_n105_), .O(new_n153_));
  inv1   g097(.a(new_n153_), .O(new_n154_));
  nand2  g098(.a(new_n154_), .b(new_n88_), .O(new_n155_));
  nand2  g099(.a(new_n155_), .b(new_n151_), .O(new_n156_));
  ...
  oai21  g104(.a(new_n153_), .b(new_n96_), .c(x34), .O(new_n161_));
  nand2  g105(.a(new_n138_), .b(new_n105_), .O(new_n162_));
  ...
  nand3  g115(.a(new_n171_), .b(new_n163_), .c(new_n88_), .O(new_n172_));
