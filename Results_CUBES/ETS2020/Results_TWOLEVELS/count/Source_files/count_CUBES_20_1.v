// Benchmark "FAU" written by ABC on Tue Jul  7 19:17:51 2020
...
module FAU ( 
  ...
  nor2   g097(.a(x27), .b(x26), .O(new_n151_));
  nand4  g098(.a(new_n142_), .b(new_n141_), .c(new_n151_), .d(new_n98_), .O(new_n152_));
  oai21  g099(.a(new_n152_), .b(new_n90_), .c(x32), .O(new_n153_));
  nor2   g100(.a(x32), .b(x31), .O(new_n154_));
  nand4  g101(.a(new_n154_), .b(new_n133_), .c(new_n120_), .d(new_n132_), .O(new_n155_));
  ...
  oai21  g109(.a(new_n155_), .b(new_n90_), .c(x33), .O(new_n163_));
  nor2   g110(.a(x33), .b(x32), .O(new_n164_));
  nand4  g111(.a(new_n164_), .b(new_n142_), .c(new_n141_), .d(new_n151_), .O(new_n165_));
  inv1   g112(.a(new_n165_), .O(new_n166_));
  nand2  g113(.a(new_n166_), .b(new_n100_), .O(new_n167_));
  nand2  g114(.a(new_n167_), .b(new_n163_), .O(new_n168_));
  nand2  g115(.a(new_n168_), .b(x16), .O(new_n169_));
  inv1   g116(.a(x01), .O(new_n170_));
  aoi21  g117(.a(new_n58_), .b(new_n170_), .c(x18), .O(new_n171_));
  nand2  g118(.a(new_n171_), .b(new_n169_), .O(z14));
  oai21  g119(.a(new_n165_), .b(new_n108_), .c(x34), .O(new_n173_));
  nand2  g120(.a(new_n141_), .b(new_n151_), .O(new_n174_));
  inv1   g121(.a(new_n174_), .O(new_n175_));
  inv1   g122(.a(x30), .O(new_n176_));
  inv1   g123(.a(x31), .O(new_n177_));
  nand2  g124(.a(new_n177_), .b(new_n176_), .O(new_n178_));
  inv1   g125(.a(x32), .O(new_n179_));
  inv1   g126(.a(x33), .O(new_n180_));
  inv1   g127(.a(x34), .O(new_n181_));
  nand3  g128(.a(new_n181_), .b(new_n180_), .c(new_n179_), .O(new_n182_));
  nor2   g129(.a(new_n182_), .b(new_n178_), .O(new_n183_));
  nand3  g130(.a(new_n183_), .b(new_n175_), .c(new_n100_), .O(new_n184_));
  nand2  g131(.a(new_n184_), .b(new_n173_), .O(new_n185_));
  nand2  g132(.a(new_n185_), .b(x16), .O(new_n186_));
  inv1   g133(.a(x00), .O(new_n187_));
  aoi21  g134(.a(new_n58_), .b(new_n187_), .c(x18), .O(new_n188_));
  nand2  g135(.a(new_n188_), .b(new_n186_), .O(z15));
  zero   g136(.O(z08));
  zero   g137(.O(z10));
endmodule
