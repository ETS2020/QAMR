...
module FAU ( 
  ...
  nand4  g027(.a(new_n79_), .b(new_n55_), .c(new_n65_), .d(new_n64_), .O(new_n80_));
  ...
  nand4  g034(.a(new_n86_), .b(new_n72_), .c(new_n55_), .d(new_n64_), .O(new_n87_));
  ...
  nand4  g059(.a(new_n112_), .b(new_n86_), .c(new_n72_), .d(new_n62_), .O(new_n113_));
  ...
  nand4  g080(.a(new_n135_), .b(new_n112_), .c(new_n129_), .d(new_n62_), .O(new_n136_));
  ...
  nand4  g087(.a(new_n143_), .b(new_n125_), .c(new_n116_), .d(new_n104_), .O(new_n144_));
  oai21  g088(.a(new_n144_), .b(new_n87_), .c(x33), .O(new_n145_));
  inv1   g089(.a(x27), .O(new_n146_));
  inv1   g090(.a(x32), .O(new_n147_));
  inv1   g091(.a(x33), .O(new_n148_));
  nand4  g092(.a(new_n148_), .b(new_n147_), .c(new_n146_), .d(new_n114_), .O(new_n149_));
  inv1   g093(.a(new_n149_), .O(new_n150_));
  nand4  g094(.a(new_n150_), .b(new_n135_), .c(new_n98_), .d(new_n67_), .O(new_n151_));
  nand2  g095(.a(new_n151_), .b(new_n145_), .O(new_n152_));
