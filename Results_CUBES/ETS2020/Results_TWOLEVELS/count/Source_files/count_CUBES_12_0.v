...
module FAU ( 
  ...
  wire new_n52_, new_n53_, new_n54_, new_n55_, new_n56_, new_n57_, new_n58_,
    ...
    new_n134_, new_n135_, new_n136_, new_n137_, new_n138_, new_n142_,
  ...
  nand4  g090(.a(new_n143_), .b(new_n142_), .c(new_n114_), .d(new_n98_), .O(new_n144_));
  oai21  g091(.a(new_n144_), .b(new_n90_), .c(x32), .O(new_n145_));
  nand4  g092(.a(new_n87_), .b(new_n97_), .c(new_n96_), .d(new_n69_), .O(new_n146_));
  inv1   g093(.a(new_n146_), .O(new_n147_));
  inv1   g094(.a(x29), .O(new_n148_));
  inv1   g095(.a(x30), .O(new_n149_));
  inv1   g096(.a(x31), .O(new_n150_));
  inv1   g097(.a(x32), .O(new_n151_));
  nand4  g098(.a(new_n151_), .b(new_n150_), .c(new_n149_), .d(new_n148_), .O(new_n152_));
  inv1   g099(.a(new_n152_), .O(new_n153_));
  inv1   g100(.a(x27), .O(new_n154_));
  inv1   g101(.a(x28), .O(new_n155_));
  nand4  g102(.a(new_n155_), .b(new_n154_), .c(new_n123_), .d(new_n98_), .O(new_n156_));
  inv1   g103(.a(new_n156_), .O(new_n157_));
  nand4  g104(.a(new_n157_), .b(new_n153_), .c(new_n147_), .d(new_n63_), .O(new_n158_));
  nand2  g105(.a(new_n158_), .b(new_n145_), .O(new_n159_));
  ...
  nor2   g110(.a(x26), .b(x25), .O(new_n164_));
  nor2   g111(.a(x30), .b(x29), .O(new_n165_));
  nor2   g112(.a(x32), .b(x31), .O(new_n166_));
  nand4  g113(.a(new_n166_), .b(new_n165_), .c(new_n125_), .d(new_n164_), .O(new_n167_));
  oai21  g114(.a(new_n167_), .b(new_n90_), .c(x33), .O(new_n168_));
  nand4  g115(.a(new_n150_), .b(new_n149_), .c(new_n148_), .d(new_n155_), .O(new_n169_));
  inv1   g116(.a(new_n169_), .O(new_n170_));
  inv1   g117(.a(x33), .O(new_n171_));
  nand4  g118(.a(new_n171_), .b(new_n151_), .c(new_n154_), .d(new_n123_), .O(new_n172_));
  inv1   g119(.a(new_n172_), .O(new_n173_));
  nand4  g120(.a(new_n173_), .b(new_n170_), .c(new_n100_), .d(new_n71_), .O(new_n174_));
  nand2  g121(.a(new_n174_), .b(new_n168_), .O(new_n175_));
