...
module FAU ( 
  ...
  nand4  g106(.a(new_n157_), .b(new_n122_), .c(new_n151_), .d(new_n63_), .O(new_n158_));
  ...
  nor2   g112(.a(x32), .b(x31), .O(new_n165_));
  nand4  g113(.a(new_n165_), .b(new_n142_), .c(new_n125_), .d(new_n141_), .O(new_n166_));
  oai21  g114(.a(new_n166_), .b(new_n90_), .c(x33), .O(new_n167_));
  inv1   g115(.a(x32), .O(new_n168_));
  inv1   g116(.a(x33), .O(new_n169_));
  nand4  g117(.a(new_n169_), .b(new_n168_), .c(new_n115_), .d(new_n114_), .O(new_n170_));
  inv1   g118(.a(new_n170_), .O(new_n171_));
  nand4  g119(.a(new_n171_), .b(new_n157_), .c(new_n100_), .d(new_n71_), .O(new_n172_));
  nand2  g120(.a(new_n172_), .b(new_n167_), .O(new_n173_));
