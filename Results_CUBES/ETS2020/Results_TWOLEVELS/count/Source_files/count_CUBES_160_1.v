// Benchmark "FAU" written by ABC on Tue Jul  7 19:19:40 2020
...
module FAU ( 
  ...
  aoi21  g055(.a(new_n59_), .b(new_n109_), .c(x18), .O(new_n110_));
  oai21  g056(.a(new_n108_), .b(new_n59_), .c(new_n110_), .O(z08));
  nor3   g057(.a(x27), .b(x26), .c(x25), .O(new_n112_));
  nand4  g058(.a(new_n112_), .b(new_n81_), .c(new_n73_), .d(new_n56_), .O(new_n113_));
  ...
  aoi21  g065(.a(new_n59_), .b(new_n119_), .c(x18), .O(new_n120_));
  oai21  g066(.a(new_n118_), .b(new_n59_), .c(new_n120_), .O(z09));
  inv1   g067(.a(x29), .O(new_n122_));
  nor3   g068(.a(x29), .b(x28), .c(x27), .O(new_n123_));
  nand4  g069(.a(new_n123_), .b(new_n98_), .c(new_n75_), .d(new_n56_), .O(new_n124_));
  ...
  aoi21  g073(.a(new_n59_), .b(new_n127_), .c(x18), .O(new_n128_));
  nand2  g074(.a(new_n128_), .b(new_n126_), .O(z10));
  nand4  g075(.a(new_n94_), .b(new_n54_), .c(new_n65_), .d(new_n53_), .O(new_n131_));
  nor2   g076(.a(x26), .b(x25), .O(new_n132_));
  nor2   g077(.a(x30), .b(x29), .O(new_n133_));
  nand4  g078(.a(new_n133_), .b(new_n114_), .c(new_n132_), .d(new_n85_), .O(new_n134_));
  oai21  g079(.a(new_n134_), .b(new_n131_), .c(x31), .O(new_n135_));
  nand2  g080(.a(new_n81_), .b(new_n73_), .O(new_n136_));
  inv1   g081(.a(new_n136_), .O(new_n137_));
  nor2   g082(.a(x29), .b(x28), .O(new_n138_));
  nor2   g083(.a(x31), .b(x30), .O(new_n139_));
  nand2  g084(.a(new_n139_), .b(new_n138_), .O(new_n140_));
  inv1   g085(.a(new_n140_), .O(new_n141_));
  nand4  g086(.a(new_n141_), .b(new_n112_), .c(new_n137_), .d(new_n56_), .O(new_n142_));
  nand2  g087(.a(new_n142_), .b(new_n135_), .O(new_n143_));
  ...
  nand4  g092(.a(new_n139_), .b(new_n138_), .c(new_n105_), .d(new_n86_), .O(new_n148_));
  oai21  g093(.a(new_n148_), .b(new_n82_), .c(x32), .O(new_n149_));
  nand2  g094(.a(new_n133_), .b(new_n114_), .O(new_n150_));
  inv1   g095(.a(new_n150_), .O(new_n151_));
  nor2   g096(.a(x32), .b(x31), .O(new_n152_));
  nand2  g097(.a(new_n152_), .b(new_n132_), .O(new_n153_));
  inv1   g098(.a(new_n153_), .O(new_n154_));
  nand4  g099(.a(new_n154_), .b(new_n151_), .c(new_n137_), .d(new_n56_), .O(new_n155_));
  nand2  g100(.a(new_n155_), .b(new_n149_), .O(new_n156_));
  ...
  nand4  g105(.a(new_n152_), .b(new_n133_), .c(new_n114_), .d(new_n132_), .O(new_n161_));
  oai21  g106(.a(new_n161_), .b(new_n82_), .c(x33), .O(new_n162_));
  nor2   g107(.a(x33), .b(x32), .O(new_n163_));
  nand4  g108(.a(new_n163_), .b(new_n139_), .c(new_n138_), .d(new_n105_), .O(new_n164_));
  inv1   g109(.a(new_n164_), .O(new_n165_));
  nand2  g110(.a(new_n165_), .b(new_n88_), .O(new_n166_));
  nand2  g111(.a(new_n166_), .b(new_n162_), .O(new_n167_));
  nand2  g112(.a(new_n167_), .b(x16), .O(new_n168_));
  inv1   g113(.a(x01), .O(new_n169_));
  aoi21  g114(.a(new_n59_), .b(new_n169_), .c(x18), .O(new_n170_));
  nand2  g115(.a(new_n170_), .b(new_n168_), .O(z14));
  oai21  g116(.a(new_n164_), .b(new_n96_), .c(x34), .O(new_n172_));
  nand2  g117(.a(new_n138_), .b(new_n105_), .O(new_n173_));
