...
module FAU ( 
  ...
  nand4  g046(.a(new_n99_), .b(new_n98_), .c(new_n97_), .d(new_n72_), .O(new_n100_));
  ...
  nand4  g056(.a(new_n110_), .b(new_n81_), .c(new_n67_), .d(new_n55_), .O(new_n111_));
  ...
  nand4  g067(.a(new_n121_), .b(new_n102_), .c(new_n74_), .d(new_n55_), .O(new_n122_));
  ...
  nand4  g073(.a(new_n98_), .b(new_n72_), .c(new_n60_), .d(new_n59_), .O(new_n128_));
  ...
  nand4  g094(.a(new_n149_), .b(new_n130_), .c(new_n112_), .d(new_n129_), .O(new_n150_));
  oai21  g095(.a(new_n150_), .b(new_n82_), .c(x33), .O(new_n151_));
