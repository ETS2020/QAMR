...
module FAU ( 
  ...
  nand4  g047(.a(new_n100_), .b(new_n96_), .c(new_n71_), .d(new_n87_), .O(new_n101_));
  ...
  nand4  g072(.a(new_n127_), .b(new_n117_), .c(new_n96_), .d(new_n69_), .O(new_n128_));
  nand4  g073(.a(new_n100_), .b(new_n55_), .c(new_n87_), .d(new_n61_), .O(new_n129_));
  oai21  g074(.a(new_n129_), .b(new_n128_), .c(x31), .O(new_n130_));
  nand2  g075(.a(new_n83_), .b(new_n76_), .O(new_n131_));
  ...
  nand4  g081(.a(new_n136_), .b(new_n115_), .c(new_n132_), .d(new_n63_), .O(new_n137_));
  ...
  nand4  g088(.a(new_n144_), .b(new_n127_), .c(new_n117_), .d(new_n100_), .O(new_n145_));
  oai21  g089(.a(new_n145_), .b(new_n84_), .c(x33), .O(new_n146_));
  nor2   g090(.a(x33), .b(x32), .O(new_n147_));
  nand4  g091(.a(new_n147_), .b(new_n134_), .c(new_n133_), .d(new_n108_), .O(new_n148_));
  inv1   g092(.a(new_n148_), .O(new_n149_));
  nand2  g093(.a(new_n149_), .b(new_n90_), .O(new_n150_));
  ...
  oai21  g099(.a(new_n148_), .b(new_n98_), .c(x34), .O(new_n156_));
  nand2  g100(.a(new_n133_), .b(new_n108_), .O(new_n157_));
  ...
  nand3  g110(.a(new_n166_), .b(new_n158_), .c(new_n90_), .O(new_n167_));
