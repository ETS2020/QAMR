...
module FAU ( 
  ...
  nand4  g065(.a(new_n120_), .b(new_n54_), .c(new_n65_), .d(new_n53_), .O(new_n121_));
  nor2   g066(.a(x26), .b(x25), .O(new_n122_));
  nor2   g067(.a(x30), .b(x29), .O(new_n123_));
  nand4  g068(.a(new_n123_), .b(new_n122_), .c(new_n103_), .d(new_n80_), .O(new_n124_));
  ...
  nand3  g079(.a(new_n134_), .b(new_n100_), .c(new_n84_), .O(new_n135_));
  ...
  nand4  g086(.a(new_n142_), .b(new_n123_), .c(new_n122_), .d(new_n103_), .O(new_n143_));
  oai21  g087(.a(new_n143_), .b(new_n83_), .c(x33), .O(new_n144_));
  ...
  nand2  g092(.a(new_n148_), .b(new_n93_), .O(new_n149_));
  ...
  nand4  g099(.a(new_n102_), .b(new_n120_), .c(new_n155_), .d(new_n54_), .O(new_n156_));
  ...
  nand3  g111(.a(new_n167_), .b(new_n159_), .c(new_n93_), .O(new_n168_));
