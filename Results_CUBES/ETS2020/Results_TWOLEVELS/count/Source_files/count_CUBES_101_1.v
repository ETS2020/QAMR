...
module FAU ( 
  ...
  nand4  g103(.a(new_n156_), .b(new_n137_), .c(new_n119_), .d(new_n136_), .O(new_n157_));
  oai21  g104(.a(new_n157_), .b(new_n90_), .c(x33), .O(new_n158_));
  inv1   g105(.a(x22), .O(new_n159_));
  inv1   g106(.a(x23), .O(new_n160_));
  nand4  g107(.a(new_n109_), .b(new_n87_), .c(new_n160_), .d(new_n159_), .O(new_n161_));
  nor2   g108(.a(new_n161_), .b(new_n70_), .O(new_n162_));
  nor2   g109(.a(x33), .b(x32), .O(new_n163_));
  nand4  g110(.a(new_n163_), .b(new_n146_), .c(new_n145_), .d(new_n110_), .O(new_n164_));
  inv1   g111(.a(new_n164_), .O(new_n165_));
  nand2  g112(.a(new_n165_), .b(new_n162_), .O(new_n166_));
  nand2  g113(.a(new_n166_), .b(new_n158_), .O(new_n167_));
  ...
  oai21  g118(.a(new_n164_), .b(new_n100_), .c(x34), .O(new_n172_));
  ...
  nand3  g129(.a(new_n182_), .b(new_n174_), .c(new_n162_), .O(new_n183_));
