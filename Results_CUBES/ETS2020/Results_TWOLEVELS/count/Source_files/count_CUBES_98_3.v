...
module FAU ( 
  ...
  nand4  g095(.a(new_n149_), .b(new_n128_), .c(new_n127_), .d(new_n126_), .O(new_n150_));
  inv1   g096(.a(new_n150_), .O(new_n151_));
  nand2  g097(.a(new_n151_), .b(new_n87_), .O(new_n152_));
  ...
  oai21  g103(.a(new_n150_), .b(new_n86_), .c(x33), .O(new_n158_));
  nor2   g104(.a(x33), .b(x32), .O(new_n159_));
  nand4  g105(.a(new_n159_), .b(new_n138_), .c(new_n137_), .d(new_n114_), .O(new_n160_));
  inv1   g106(.a(new_n160_), .O(new_n161_));
  nand2  g107(.a(new_n161_), .b(new_n96_), .O(new_n162_));
  ...
  oai21  g113(.a(new_n160_), .b(new_n104_), .c(x34), .O(new_n168_));
  nand2  g114(.a(new_n137_), .b(new_n114_), .O(new_n169_));
  ...
  nand3  g124(.a(new_n178_), .b(new_n170_), .c(new_n96_), .O(new_n179_));
