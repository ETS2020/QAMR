...
module FAU ( 
  ...
  nand4  g069(.a(new_n123_), .b(new_n54_), .c(new_n65_), .d(new_n53_), .O(new_n124_));
  ...
  nand4  g090(.a(new_n145_), .b(new_n126_), .c(new_n125_), .d(new_n106_), .O(new_n146_));
  oai21  g091(.a(new_n146_), .b(new_n86_), .c(x33), .O(new_n147_));
  nor2   g092(.a(x27), .b(x26), .O(new_n148_));
  nor2   g093(.a(x33), .b(x32), .O(new_n149_));
  nand4  g094(.a(new_n149_), .b(new_n135_), .c(new_n134_), .d(new_n148_), .O(new_n150_));
  ...
  nor2   g102(.a(x21), .b(x20), .O(new_n158_));
  nand4  g103(.a(new_n105_), .b(new_n123_), .c(new_n158_), .d(new_n54_), .O(new_n159_));
  oai21  g104(.a(new_n150_), .b(new_n159_), .c(x34), .O(new_n160_));
  nand2  g105(.a(new_n134_), .b(new_n148_), .O(new_n161_));
