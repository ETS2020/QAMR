...
module FAU ( 
  ...
  nand3  g062(.a(new_n116_), .b(new_n115_), .c(new_n103_), .O(new_n117_));
  oai21  g063(.a(new_n117_), .b(new_n77_), .c(x29), .O(new_n118_));
  nor3   g064(.a(x29), .b(x28), .c(x27), .O(new_n119_));
  nand4  g065(.a(new_n119_), .b(new_n106_), .c(new_n78_), .d(new_n71_), .O(new_n120_));
  ...
  nand4  g083(.a(new_n138_), .b(new_n137_), .c(new_n136_), .d(new_n94_), .O(new_n139_));
  oai21  g084(.a(new_n139_), .b(new_n86_), .c(x32), .O(new_n140_));
  nor2   g085(.a(x32), .b(x31), .O(new_n141_));
  nand4  g086(.a(new_n141_), .b(new_n128_), .c(new_n115_), .d(new_n127_), .O(new_n142_));
  ...
  nand4  g096(.a(new_n151_), .b(new_n138_), .c(new_n137_), .d(new_n136_), .O(new_n152_));
  inv1   g097(.a(new_n152_), .O(new_n153_));
  nand2  g098(.a(new_n153_), .b(new_n96_), .O(new_n154_));
  ...
  nand2  g105(.a(new_n137_), .b(new_n136_), .O(new_n161_));
  ...
  nand3  g115(.a(new_n170_), .b(new_n162_), .c(new_n96_), .O(new_n171_));
