// Benchmark "FAU" written by ABC on Tue Jul  7 19:19:54 2020
...
module FAU ( 
  ...
  nand4  g064(.a(new_n118_), .b(new_n98_), .c(new_n78_), .d(new_n56_), .O(new_n119_));
  ...
  nand4  g073(.a(new_n127_), .b(new_n114_), .c(new_n126_), .d(new_n83_), .O(new_n128_));
  ...
  nand4  g092(.a(new_n147_), .b(new_n127_), .c(new_n114_), .d(new_n126_), .O(new_n148_));
  oai21  g093(.a(new_n148_), .b(new_n86_), .c(x33), .O(new_n149_));
  inv1   g094(.a(x22), .O(new_n150_));
  inv1   g095(.a(x23), .O(new_n151_));
  nand4  g096(.a(new_n105_), .b(new_n83_), .c(new_n151_), .d(new_n150_), .O(new_n152_));
  nor2   g097(.a(new_n152_), .b(new_n66_), .O(new_n153_));
  nor2   g098(.a(x33), .b(x32), .O(new_n154_));
  nand4  g099(.a(new_n154_), .b(new_n137_), .c(new_n136_), .d(new_n106_), .O(new_n155_));
  inv1   g100(.a(new_n155_), .O(new_n156_));
  nand2  g101(.a(new_n156_), .b(new_n153_), .O(new_n157_));
  nand2  g102(.a(new_n157_), .b(new_n149_), .O(new_n158_));
  ...
  oai21  g107(.a(new_n155_), .b(new_n96_), .c(x34), .O(new_n163_));
  nand2  g108(.a(new_n136_), .b(new_n106_), .O(new_n164_));
  ...
  nand3  g118(.a(new_n173_), .b(new_n165_), .c(new_n153_), .O(new_n174_));
