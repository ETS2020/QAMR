...
module FAU ( 
  ...
  nand4  g056(.a(new_n111_), .b(new_n110_), .c(new_n109_), .d(new_n89_), .O(new_n112_));
  oai21  g057(.a(new_n112_), .b(new_n73_), .c(x29), .O(new_n113_));
  nor3   g058(.a(x29), .b(x28), .c(x27), .O(new_n114_));
  nand4  g059(.a(new_n114_), .b(new_n99_), .c(new_n74_), .d(new_n67_), .O(new_n115_));
  ...
  nand4  g065(.a(new_n98_), .b(new_n56_), .c(new_n60_), .d(new_n55_), .O(new_n121_));
  nor2   g066(.a(x26), .b(x25), .O(new_n122_));
  nor2   g067(.a(x30), .b(x29), .O(new_n123_));
  nand4  g068(.a(new_n123_), .b(new_n111_), .c(new_n122_), .d(new_n79_), .O(new_n124_));
  ...
  nand4  g086(.a(new_n133_), .b(new_n132_), .c(new_n101_), .d(new_n90_), .O(new_n142_));
  oai21  g087(.a(new_n142_), .b(new_n82_), .c(x32), .O(new_n143_));
  nand2  g088(.a(new_n123_), .b(new_n111_), .O(new_n144_));
  inv1   g089(.a(x31), .O(new_n145_));
  inv1   g090(.a(x32), .O(new_n146_));
  nand4  g091(.a(new_n146_), .b(new_n145_), .c(new_n109_), .d(new_n90_), .O(new_n147_));
  ...
  nand4  g100(.a(new_n110_), .b(new_n98_), .c(new_n156_), .d(new_n56_), .O(new_n157_));
  nor2   g101(.a(x33), .b(x32), .O(new_n158_));
  nand4  g102(.a(new_n158_), .b(new_n133_), .c(new_n132_), .d(new_n101_), .O(new_n159_));
  oai21  g103(.a(new_n159_), .b(new_n157_), .c(x34), .O(new_n160_));
  nand2  g104(.a(new_n132_), .b(new_n101_), .O(new_n161_));
  inv1   g105(.a(new_n161_), .O(new_n162_));
  inv1   g106(.a(x30), .O(new_n163_));
  nand2  g107(.a(new_n145_), .b(new_n163_), .O(new_n164_));
  inv1   g108(.a(x33), .O(new_n165_));
  inv1   g109(.a(x34), .O(new_n166_));
  nand3  g110(.a(new_n166_), .b(new_n165_), .c(new_n146_), .O(new_n167_));
  nor2   g111(.a(new_n167_), .b(new_n164_), .O(new_n168_));
  nand3  g112(.a(new_n168_), .b(new_n162_), .c(new_n92_), .O(new_n169_));
