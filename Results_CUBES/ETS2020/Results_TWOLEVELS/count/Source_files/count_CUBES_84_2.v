...
module FAU ( 
  ...
  nand3  g068(.a(new_n120_), .b(new_n119_), .c(new_n118_), .O(new_n121_));
  ...
  nand4  g076(.a(new_n128_), .b(new_n107_), .c(new_n82_), .d(new_n63_), .O(new_n129_));
  ...
  nand4  g082(.a(new_n106_), .b(new_n55_), .c(new_n69_), .d(new_n61_), .O(new_n136_));
  nor2   g083(.a(x26), .b(x25), .O(new_n137_));
  nor2   g084(.a(x30), .b(x29), .O(new_n138_));
  nand4  g085(.a(new_n138_), .b(new_n119_), .c(new_n137_), .d(new_n87_), .O(new_n139_));
  oai21  g086(.a(new_n139_), .b(new_n136_), .c(x31), .O(new_n140_));
  ...
  nand3  g091(.a(new_n144_), .b(new_n116_), .c(new_n91_), .O(new_n145_));
  ...
  nand4  g097(.a(new_n142_), .b(new_n141_), .c(new_n109_), .d(new_n98_), .O(new_n151_));
  oai21  g098(.a(new_n151_), .b(new_n90_), .c(x32), .O(new_n152_));
  nor2   g099(.a(x32), .b(x31), .O(new_n153_));
  nand4  g100(.a(new_n153_), .b(new_n138_), .c(new_n119_), .d(new_n137_), .O(new_n154_));
  ...
  oai21  g108(.a(new_n154_), .b(new_n90_), .c(x33), .O(new_n162_));
  nor2   g109(.a(x33), .b(x32), .O(new_n163_));
  nand4  g110(.a(new_n163_), .b(new_n142_), .c(new_n141_), .d(new_n109_), .O(new_n164_));
  inv1   g111(.a(new_n164_), .O(new_n165_));
  nand2  g112(.a(new_n165_), .b(new_n100_), .O(new_n166_));
  ...
  nand4  g119(.a(new_n118_), .b(new_n106_), .c(new_n172_), .d(new_n55_), .O(new_n173_));
  oai21  g120(.a(new_n164_), .b(new_n173_), .c(x34), .O(new_n174_));
  nand2  g121(.a(new_n141_), .b(new_n109_), .O(new_n175_));
  ...
  nand3  g131(.a(new_n184_), .b(new_n176_), .c(new_n100_), .O(new_n185_));
