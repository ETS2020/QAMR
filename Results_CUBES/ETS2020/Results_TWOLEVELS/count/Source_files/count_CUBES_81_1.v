...
module FAU ( 
  ...
  wire new_n52_, new_n53_, new_n54_, new_n55_, new_n56_, new_n57_, new_n58_,
    ...
    new_n121_, new_n122_, new_n123_, new_n124_, new_n125_, new_n131_,
  ...
  nor2   g062(.a(x27), .b(x26), .O(new_n115_));
  nor3   g063(.a(x25), .b(x24), .c(x23), .O(new_n116_));
  nand4  g064(.a(new_n116_), .b(new_n115_), .c(new_n76_), .d(new_n63_), .O(new_n117_));
  ...
  nor2   g074(.a(x30), .b(x29), .O(new_n131_));
  nor2   g075(.a(x32), .b(x31), .O(new_n132_));
  nand4  g076(.a(new_n132_), .b(new_n131_), .c(new_n120_), .d(new_n106_), .O(new_n133_));
  oai21  g077(.a(new_n133_), .b(new_n90_), .c(x33), .O(new_n134_));
  inv1   g078(.a(x30), .O(new_n135_));
  inv1   g079(.a(x31), .O(new_n136_));
  inv1   g080(.a(x32), .O(new_n137_));
  inv1   g081(.a(x33), .O(new_n138_));
  nand4  g082(.a(new_n138_), .b(new_n137_), .c(new_n136_), .d(new_n135_), .O(new_n139_));
  inv1   g083(.a(new_n139_), .O(new_n140_));
  inv1   g084(.a(x27), .O(new_n141_));
  inv1   g085(.a(x28), .O(new_n142_));
  inv1   g086(.a(x29), .O(new_n143_));
  nand4  g087(.a(new_n143_), .b(new_n142_), .c(new_n141_), .d(new_n118_), .O(new_n144_));
  inv1   g088(.a(new_n144_), .O(new_n145_));
  nand4  g089(.a(new_n145_), .b(new_n140_), .c(new_n100_), .d(new_n71_), .O(new_n146_));
  nand2  g090(.a(new_n146_), .b(new_n134_), .O(new_n147_));
