...
module FAU ( 
  ...
  nand2  g048(.a(new_n55_), .b(new_n61_), .O(new_n104_));
  inv1   g049(.a(new_n74_), .O(new_n105_));
  nor2   g050(.a(new_n105_), .b(new_n104_), .O(new_n106_));
  nor3   g051(.a(x27), .b(x26), .c(x25), .O(new_n107_));
  nand4  g052(.a(new_n107_), .b(new_n75_), .c(new_n74_), .d(new_n63_), .O(new_n108_));
  nor2   g053(.a(x25), .b(x24), .O(new_n109_));
  nor2   g054(.a(x28), .b(x27), .O(new_n110_));
  nand4  g055(.a(new_n110_), .b(new_n109_), .c(new_n93_), .d(new_n85_), .O(new_n111_));
  ...
  nand4  g062(.a(new_n118_), .b(new_n96_), .c(new_n72_), .d(new_n63_), .O(new_n119_));
  nand4  g063(.a(new_n94_), .b(new_n55_), .c(new_n82_), .d(new_n61_), .O(new_n120_));
  nor2   g064(.a(x26), .b(x25), .O(new_n121_));
  nor2   g065(.a(x30), .b(x29), .O(new_n122_));
  nand4  g066(.a(new_n122_), .b(new_n110_), .c(new_n121_), .d(new_n71_), .O(new_n123_));
  ...
  oai21  g071(.a(new_n125_), .b(new_n58_), .c(new_n127_), .O(z11));
  nor2   g072(.a(x27), .b(x26), .O(new_n130_));
  nor2   g073(.a(x29), .b(x28), .O(new_n131_));
  nor2   g074(.a(x31), .b(x30), .O(new_n132_));
  nand4  g075(.a(new_n132_), .b(new_n131_), .c(new_n130_), .d(new_n86_), .O(new_n133_));
  oai21  g076(.a(new_n133_), .b(new_n76_), .c(x32), .O(new_n134_));
  nor2   g077(.a(x32), .b(x31), .O(new_n135_));
  nand4  g078(.a(new_n135_), .b(new_n122_), .c(new_n110_), .d(new_n121_), .O(new_n136_));
  ...
  nand4  g088(.a(new_n145_), .b(new_n132_), .c(new_n131_), .d(new_n130_), .O(new_n146_));
  ...
  nand4  g096(.a(new_n109_), .b(new_n95_), .c(new_n94_), .d(new_n55_), .O(new_n154_));
  oai21  g097(.a(new_n146_), .b(new_n154_), .c(x34), .O(new_n155_));
  nand2  g098(.a(new_n131_), .b(new_n130_), .O(new_n156_));
  ...
  nand3  g108(.a(new_n165_), .b(new_n157_), .c(new_n88_), .O(new_n166_));
