// Benchmark "FAU" written by ABC on Tue Jul  7 19:19:21 2020
...
module FAU ( 
  ...
  nand4  g076(.a(new_n127_), .b(new_n107_), .c(new_n126_), .d(new_n97_), .O(new_n128_));
  ...
  nand4  g092(.a(new_n143_), .b(new_n127_), .c(new_n142_), .d(new_n98_), .O(new_n144_));
  ...
  nand4  g109(.a(new_n152_), .b(new_n151_), .c(new_n117_), .d(new_n99_), .O(new_n161_));
  oai21  g110(.a(new_n161_), .b(new_n90_), .c(x32), .O(new_n162_));
  nand2  g111(.a(new_n143_), .b(new_n127_), .O(new_n163_));
  inv1   g112(.a(x31), .O(new_n164_));
  inv1   g113(.a(x32), .O(new_n165_));
  nand4  g114(.a(new_n165_), .b(new_n164_), .c(new_n126_), .d(new_n99_), .O(new_n166_));
  ...
  nor2   g122(.a(x33), .b(x32), .O(new_n175_));
  nand4  g123(.a(new_n175_), .b(new_n152_), .c(new_n151_), .d(new_n117_), .O(new_n176_));
  oai21  g124(.a(new_n176_), .b(new_n108_), .c(x34), .O(new_n177_));
  nand2  g125(.a(new_n151_), .b(new_n117_), .O(new_n178_));
  inv1   g126(.a(new_n178_), .O(new_n179_));
  inv1   g127(.a(x30), .O(new_n180_));
  nand2  g128(.a(new_n164_), .b(new_n180_), .O(new_n181_));
  inv1   g129(.a(x33), .O(new_n182_));
  inv1   g130(.a(x34), .O(new_n183_));
  nand3  g131(.a(new_n183_), .b(new_n182_), .c(new_n165_), .O(new_n184_));
  nor2   g132(.a(new_n184_), .b(new_n181_), .O(new_n185_));
  nand3  g133(.a(new_n185_), .b(new_n179_), .c(new_n101_), .O(new_n186_));
  nand2  g134(.a(new_n186_), .b(new_n177_), .O(new_n187_));
  nand2  g135(.a(new_n187_), .b(x16), .O(new_n188_));
  inv1   g136(.a(x00), .O(new_n189_));
  aoi21  g137(.a(new_n58_), .b(new_n189_), .c(x18), .O(new_n190_));
  nand2  g138(.a(new_n190_), .b(new_n188_), .O(z15));
  zero   g139(.O(z14));
endmodule
