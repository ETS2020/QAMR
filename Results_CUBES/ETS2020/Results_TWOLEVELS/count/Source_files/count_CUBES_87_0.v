// Benchmark "FAU" written by ABC on Tue Jul  7 19:18:32 2020
...
module FAU ( 
  ...
  nor2   g077(.a(x27), .b(x26), .O(new_n133_));
  nor2   g078(.a(x29), .b(x28), .O(new_n134_));
  nor2   g079(.a(x31), .b(x30), .O(new_n135_));
  nand4  g080(.a(new_n135_), .b(new_n134_), .c(new_n133_), .d(new_n93_), .O(new_n136_));
  oai21  g081(.a(new_n136_), .b(new_n89_), .c(x32), .O(new_n137_));
  inv1   g082(.a(new_n89_), .O(new_n138_));
  nor2   g083(.a(x26), .b(x25), .O(new_n139_));
  nor2   g084(.a(x30), .b(x29), .O(new_n140_));
  nor2   g085(.a(x32), .b(x31), .O(new_n141_));
  nand4  g086(.a(new_n141_), .b(new_n140_), .c(new_n115_), .d(new_n139_), .O(new_n142_));
  inv1   g087(.a(new_n142_), .O(new_n143_));
  nand2  g088(.a(new_n143_), .b(new_n138_), .O(new_n144_));
  nand2  g089(.a(new_n144_), .b(new_n137_), .O(new_n145_));
  nand2  g090(.a(new_n145_), .b(x16), .O(new_n146_));
  inv1   g091(.a(x02), .O(new_n147_));
  aoi21  g092(.a(new_n58_), .b(new_n147_), .c(x18), .O(new_n148_));
  nand2  g093(.a(new_n148_), .b(new_n146_), .O(z13));
  oai21  g094(.a(new_n142_), .b(new_n89_), .c(x33), .O(new_n150_));
  nor2   g095(.a(x33), .b(x32), .O(new_n151_));
  nand4  g096(.a(new_n151_), .b(new_n135_), .c(new_n134_), .d(new_n133_), .O(new_n152_));
  inv1   g097(.a(new_n152_), .O(new_n153_));
  nand2  g098(.a(new_n153_), .b(new_n95_), .O(new_n154_));
  ...
  oai21  g104(.a(new_n152_), .b(new_n103_), .c(x34), .O(new_n160_));
  nand2  g105(.a(new_n134_), .b(new_n133_), .O(new_n161_));
  ...
  nand3  g115(.a(new_n170_), .b(new_n162_), .c(new_n95_), .O(new_n171_));
