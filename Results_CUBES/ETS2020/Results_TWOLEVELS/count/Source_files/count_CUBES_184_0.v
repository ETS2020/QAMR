...
module FAU ( 
  ...
  nand4  g082(.a(new_n102_), .b(new_n55_), .c(new_n69_), .d(new_n61_), .O(new_n136_));
  nor2   g083(.a(x26), .b(x25), .O(new_n137_));
  nor2   g084(.a(x30), .b(x29), .O(new_n138_));
  nand4  g085(.a(new_n138_), .b(new_n120_), .c(new_n137_), .d(new_n82_), .O(new_n139_));
  ...
  nand3  g091(.a(new_n144_), .b(new_n117_), .c(new_n86_), .O(new_n145_));
  ...
  nand4  g097(.a(new_n142_), .b(new_n141_), .c(new_n110_), .d(new_n93_), .O(new_n151_));
  oai21  g098(.a(new_n151_), .b(new_n85_), .c(x32), .O(new_n152_));
  nand2  g099(.a(new_n138_), .b(new_n120_), .O(new_n153_));
  inv1   g100(.a(x31), .O(new_n154_));
  inv1   g101(.a(x32), .O(new_n155_));
  nand4  g102(.a(new_n155_), .b(new_n154_), .c(new_n100_), .d(new_n93_), .O(new_n156_));
  nor2   g103(.a(new_n156_), .b(new_n153_), .O(new_n157_));
  nand2  g104(.a(new_n157_), .b(new_n86_), .O(new_n158_));
  ...
  nand4  g110(.a(new_n119_), .b(new_n102_), .c(new_n101_), .d(new_n55_), .O(new_n165_));
  nor2   g111(.a(x33), .b(x32), .O(new_n166_));
  nand4  g112(.a(new_n166_), .b(new_n142_), .c(new_n141_), .d(new_n110_), .O(new_n167_));
  oai21  g113(.a(new_n167_), .b(new_n165_), .c(x34), .O(new_n168_));
  nand2  g114(.a(new_n141_), .b(new_n110_), .O(new_n169_));
  ...
  nand3  g122(.a(new_n176_), .b(new_n170_), .c(new_n95_), .O(new_n177_));
