...
module FAU ( 
  ...
  nand4  g076(.a(new_n129_), .b(new_n110_), .c(new_n82_), .d(new_n63_), .O(new_n130_));
  nand4  g077(.a(new_n106_), .b(new_n55_), .c(new_n69_), .d(new_n61_), .O(new_n131_));
  nor2   g078(.a(x26), .b(x25), .O(new_n132_));
  nor2   g079(.a(x30), .b(x29), .O(new_n133_));
  nand4  g080(.a(new_n133_), .b(new_n120_), .c(new_n132_), .d(new_n87_), .O(new_n134_));
  ...
  nand3  g091(.a(new_n144_), .b(new_n118_), .c(new_n91_), .O(new_n145_));
  ...
  nand4  g098(.a(new_n152_), .b(new_n133_), .c(new_n120_), .d(new_n132_), .O(new_n153_));
  oai21  g099(.a(new_n153_), .b(new_n90_), .c(x33), .O(new_n154_));
  nor2   g100(.a(x27), .b(x26), .O(new_n155_));
  nor2   g101(.a(x33), .b(x32), .O(new_n156_));
  nand4  g102(.a(new_n156_), .b(new_n142_), .c(new_n141_), .d(new_n155_), .O(new_n157_));
  inv1   g103(.a(new_n157_), .O(new_n158_));
  nand2  g104(.a(new_n158_), .b(new_n100_), .O(new_n159_));
  nand2  g105(.a(new_n159_), .b(new_n154_), .O(new_n160_));
  ...
  oai21  g110(.a(new_n157_), .b(new_n108_), .c(x34), .O(new_n165_));
  nand2  g111(.a(new_n141_), .b(new_n155_), .O(new_n166_));
  inv1   g112(.a(new_n166_), .O(new_n167_));
  inv1   g113(.a(x30), .O(new_n168_));
  inv1   g114(.a(x31), .O(new_n169_));
  nand2  g115(.a(new_n169_), .b(new_n168_), .O(new_n170_));
  inv1   g116(.a(x32), .O(new_n171_));
  inv1   g117(.a(x33), .O(new_n172_));
  inv1   g118(.a(x34), .O(new_n173_));
  nand3  g119(.a(new_n173_), .b(new_n172_), .c(new_n171_), .O(new_n174_));
  nor2   g120(.a(new_n174_), .b(new_n170_), .O(new_n175_));
  nand3  g121(.a(new_n175_), .b(new_n167_), .c(new_n100_), .O(new_n176_));
  nand2  g122(.a(new_n176_), .b(new_n165_), .O(new_n177_));
  nand2  g123(.a(new_n177_), .b(x16), .O(new_n178_));
  inv1   g124(.a(x00), .O(new_n179_));
  aoi21  g125(.a(new_n58_), .b(new_n179_), .c(x18), .O(new_n180_));
  nand2  g126(.a(new_n180_), .b(new_n178_), .O(z15));
  zero   g127(.O(z08));
  zero   g128(.O(z10));
  zero   g129(.O(z13));
endmodule
