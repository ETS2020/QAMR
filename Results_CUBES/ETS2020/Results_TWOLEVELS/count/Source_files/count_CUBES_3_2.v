...
module FAU ( 
  ...
  nand4  g086(.a(new_n140_), .b(new_n139_), .c(new_n102_), .d(new_n101_), .O(new_n141_));
  oai21  g087(.a(new_n141_), .b(new_n90_), .c(x32), .O(new_n142_));
  nand2  g088(.a(new_n131_), .b(new_n113_), .O(new_n143_));
  inv1   g089(.a(x31), .O(new_n144_));
  inv1   g090(.a(x32), .O(new_n145_));
  nand4  g091(.a(new_n145_), .b(new_n144_), .c(new_n112_), .d(new_n101_), .O(new_n146_));
  nor2   g092(.a(new_n146_), .b(new_n143_), .O(new_n147_));
  nand2  g093(.a(new_n147_), .b(new_n91_), .O(new_n148_));
  nand2  g094(.a(new_n148_), .b(new_n142_), .O(new_n149_));
  nand2  g095(.a(new_n149_), .b(x16), .O(new_n150_));
  inv1   g096(.a(x02), .O(new_n151_));
  aoi21  g097(.a(new_n58_), .b(new_n151_), .c(x18), .O(new_n152_));
  nand2  g098(.a(new_n152_), .b(new_n150_), .O(z13));
  nor2   g099(.a(x21), .b(x20), .O(new_n155_));
  nand4  g100(.a(new_n114_), .b(new_n98_), .c(new_n155_), .d(new_n55_), .O(new_n156_));
  nor2   g101(.a(x33), .b(x32), .O(new_n157_));
  nand4  g102(.a(new_n157_), .b(new_n140_), .c(new_n139_), .d(new_n102_), .O(new_n158_));
  oai21  g103(.a(new_n158_), .b(new_n156_), .c(x34), .O(new_n159_));
  inv1   g104(.a(x22), .O(new_n160_));
  nand4  g105(.a(new_n101_), .b(new_n87_), .c(new_n111_), .d(new_n160_), .O(new_n161_));
  nor2   g106(.a(new_n161_), .b(new_n70_), .O(new_n162_));
  nand2  g107(.a(new_n139_), .b(new_n102_), .O(new_n163_));
  inv1   g108(.a(new_n163_), .O(new_n164_));
  inv1   g109(.a(x30), .O(new_n165_));
  nand2  g110(.a(new_n144_), .b(new_n165_), .O(new_n166_));
  inv1   g111(.a(x33), .O(new_n167_));
  inv1   g112(.a(x34), .O(new_n168_));
  nand3  g113(.a(new_n168_), .b(new_n167_), .c(new_n145_), .O(new_n169_));
  nor2   g114(.a(new_n169_), .b(new_n166_), .O(new_n170_));
  nand3  g115(.a(new_n170_), .b(new_n164_), .c(new_n162_), .O(new_n171_));
  nand2  g116(.a(new_n171_), .b(new_n159_), .O(new_n172_));
