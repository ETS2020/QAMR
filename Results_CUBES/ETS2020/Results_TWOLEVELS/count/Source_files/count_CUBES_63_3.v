...
module FAU ( 
  ...
  inv1   g051(.a(x26), .O(new_n105_));
  inv1   g052(.a(x27), .O(new_n106_));
  nand4  g053(.a(new_n85_), .b(new_n106_), .c(new_n105_), .d(new_n94_), .O(new_n107_));
  ...
  nand4  g061(.a(new_n115_), .b(new_n114_), .c(new_n105_), .d(new_n93_), .O(new_n116_));
  oai21  g062(.a(new_n116_), .b(new_n77_), .c(x29), .O(new_n117_));
  nor3   g063(.a(x29), .b(x28), .c(x27), .O(new_n118_));
  nand4  g064(.a(new_n118_), .b(new_n103_), .c(new_n78_), .d(new_n56_), .O(new_n119_));
  nand2  g065(.a(new_n119_), .b(new_n117_), .O(new_n120_));
  nand2  g066(.a(new_n120_), .b(x16), .O(new_n121_));
  inv1   g067(.a(x05), .O(new_n122_));
  aoi21  g068(.a(new_n59_), .b(new_n122_), .c(x18), .O(new_n123_));
  nand2  g069(.a(new_n123_), .b(new_n121_), .O(z10));
  nand4  g070(.a(new_n102_), .b(new_n54_), .c(new_n65_), .d(new_n53_), .O(new_n125_));
  nor2   g071(.a(x26), .b(x25), .O(new_n126_));
  nor2   g072(.a(x30), .b(x29), .O(new_n127_));
  nand4  g073(.a(new_n127_), .b(new_n115_), .c(new_n126_), .d(new_n83_), .O(new_n128_));
  ...
  nand4  g080(.a(new_n83_), .b(new_n93_), .c(new_n92_), .d(new_n65_), .O(new_n135_));
  ...
  nand2  g090(.a(new_n144_), .b(new_n134_), .O(new_n145_));
  ...
  nand4  g096(.a(new_n151_), .b(new_n127_), .c(new_n115_), .d(new_n126_), .O(new_n152_));
  oai21  g097(.a(new_n152_), .b(new_n86_), .c(x33), .O(new_n153_));
  inv1   g098(.a(x32), .O(new_n154_));
  inv1   g099(.a(x33), .O(new_n155_));
  nand4  g100(.a(new_n155_), .b(new_n154_), .c(new_n106_), .d(new_n105_), .O(new_n156_));
  inv1   g101(.a(new_n156_), .O(new_n157_));
  nand4  g102(.a(new_n157_), .b(new_n143_), .c(new_n96_), .d(new_n67_), .O(new_n158_));
