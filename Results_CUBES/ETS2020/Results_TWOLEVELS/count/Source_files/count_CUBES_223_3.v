...
module FAU ( 
  ...
  oai21  g038(.a(new_n87_), .b(new_n61_), .c(x26), .O(new_n93_));
  ...
  nand3  g047(.a(new_n67_), .b(new_n76_), .c(new_n59_), .O(new_n102_));
  nor2   g048(.a(x27), .b(x26), .O(new_n103_));
  nand3  g049(.a(new_n103_), .b(new_n77_), .c(new_n86_), .O(new_n104_));
  ...
  aoi21  g053(.a(new_n54_), .b(new_n107_), .c(x18), .O(new_n108_));
  oai21  g054(.a(new_n106_), .b(new_n54_), .c(new_n108_), .O(z08));
  inv1   g055(.a(x26), .O(new_n111_));
  nor2   g056(.a(x25), .b(x24), .O(new_n112_));
  nor2   g057(.a(x28), .b(x27), .O(new_n113_));
  nand4  g058(.a(new_n113_), .b(new_n112_), .c(new_n111_), .d(new_n85_), .O(new_n114_));
  oai21  g059(.a(new_n114_), .b(new_n102_), .c(x29), .O(new_n115_));
  nor3   g060(.a(x29), .b(x28), .c(x27), .O(new_n116_));
  nand4  g061(.a(new_n116_), .b(new_n95_), .c(new_n74_), .d(new_n55_), .O(new_n117_));
  ...
  nand4  g067(.a(new_n94_), .b(new_n76_), .c(new_n60_), .d(new_n59_), .O(new_n123_));
  ...
  nand4  g077(.a(new_n73_), .b(new_n85_), .c(new_n84_), .d(new_n60_), .O(new_n133_));
  ...
  nand4  g086(.a(new_n141_), .b(new_n135_), .c(new_n134_), .d(new_n55_), .O(new_n142_));
  ...
  nand4  g094(.a(new_n149_), .b(new_n148_), .c(new_n103_), .d(new_n86_), .O(new_n150_));
  ...
  nand4  g100(.a(new_n155_), .b(new_n139_), .c(new_n111_), .d(new_n86_), .O(new_n156_));
  inv1   g101(.a(new_n156_), .O(new_n157_));
  nand4  g102(.a(new_n157_), .b(new_n154_), .c(new_n134_), .d(new_n55_), .O(new_n158_));
  ...
  nand4  g112(.a(new_n167_), .b(new_n155_), .c(new_n152_), .d(new_n111_), .O(new_n168_));
