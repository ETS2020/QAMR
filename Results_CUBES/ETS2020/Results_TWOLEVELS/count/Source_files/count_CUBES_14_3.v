...
module FAU ( 
  ...
  nand4  g086(.a(new_n133_), .b(new_n132_), .c(new_n109_), .d(new_n89_), .O(new_n142_));
  oai21  g087(.a(new_n142_), .b(new_n81_), .c(x32), .O(new_n143_));
  nor2   g088(.a(x32), .b(x31), .O(new_n144_));
  nand4  g089(.a(new_n144_), .b(new_n123_), .c(new_n122_), .d(new_n121_), .O(new_n145_));
  inv1   g090(.a(new_n145_), .O(new_n146_));
  nand2  g091(.a(new_n146_), .b(new_n82_), .O(new_n147_));
  ...
  oai21  g097(.a(new_n145_), .b(new_n81_), .c(x33), .O(new_n153_));
  nor2   g098(.a(x33), .b(x32), .O(new_n154_));
  nand4  g099(.a(new_n154_), .b(new_n133_), .c(new_n132_), .d(new_n109_), .O(new_n155_));
  inv1   g100(.a(new_n155_), .O(new_n156_));
  nand2  g101(.a(new_n156_), .b(new_n91_), .O(new_n157_));
  ...
  oai21  g107(.a(new_n155_), .b(new_n99_), .c(x34), .O(new_n163_));
  nand2  g108(.a(new_n132_), .b(new_n109_), .O(new_n164_));
  ...
  nand3  g118(.a(new_n173_), .b(new_n165_), .c(new_n91_), .O(new_n174_));
