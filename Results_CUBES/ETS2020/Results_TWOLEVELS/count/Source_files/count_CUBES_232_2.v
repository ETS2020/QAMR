...
module FAU ( 
  ...
  nand3  g037(.a(new_n92_), .b(new_n91_), .c(new_n66_), .O(new_n93_));
  ...
  nand4  g052(.a(new_n108_), .b(new_n92_), .c(new_n75_), .d(new_n72_), .O(new_n109_));
  ...
  nand4  g058(.a(new_n91_), .b(new_n55_), .c(new_n64_), .d(new_n62_), .O(new_n115_));
  ...
  nor2   g094(.a(new_n150_), .b(new_n65_), .O(new_n151_));
  ...
  nand4  g105(.a(new_n104_), .b(new_n91_), .c(new_n161_), .d(new_n55_), .O(new_n162_));
