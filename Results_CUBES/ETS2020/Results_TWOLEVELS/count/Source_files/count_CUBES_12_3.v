...
module FAU ( 
  ...
  nor2   g072(.a(x28), .b(x27), .O(new_n125_));
  nor2   g073(.a(x26), .b(x23), .O(new_n126_));
  nand3  g074(.a(new_n126_), .b(new_n125_), .c(new_n107_), .O(new_n127_));
  oai21  g075(.a(new_n127_), .b(new_n81_), .c(x29), .O(new_n128_));
  ...
  nand4  g086(.a(new_n138_), .b(new_n125_), .c(new_n137_), .d(new_n87_), .O(new_n139_));
  ...
  nor3   g093(.a(x27), .b(x26), .c(x25), .O(new_n146_));
  nor2   g094(.a(x29), .b(x28), .O(new_n147_));
  nor2   g095(.a(x31), .b(x30), .O(new_n148_));
  nand2  g096(.a(new_n148_), .b(new_n147_), .O(new_n149_));
  inv1   g097(.a(new_n149_), .O(new_n150_));
  nand3  g098(.a(new_n150_), .b(new_n146_), .c(new_n91_), .O(new_n151_));
  nand2  g099(.a(new_n151_), .b(new_n145_), .O(new_n152_));
  nand2  g100(.a(new_n152_), .b(x16), .O(new_n153_));
  inv1   g101(.a(x03), .O(new_n154_));
  aoi21  g102(.a(new_n58_), .b(new_n154_), .c(x18), .O(new_n155_));
  nand2  g103(.a(new_n155_), .b(new_n153_), .O(z12));
  nand4  g104(.a(new_n148_), .b(new_n147_), .c(new_n117_), .d(new_n98_), .O(new_n157_));
  oai21  g105(.a(new_n157_), .b(new_n90_), .c(x32), .O(new_n158_));
  nor2   g106(.a(x32), .b(x31), .O(new_n159_));
  nand4  g107(.a(new_n159_), .b(new_n138_), .c(new_n125_), .d(new_n137_), .O(new_n160_));
  ...
  nand4  g117(.a(new_n169_), .b(new_n148_), .c(new_n147_), .d(new_n117_), .O(new_n170_));
  ...
  nand2  g126(.a(new_n147_), .b(new_n117_), .O(new_n179_));
