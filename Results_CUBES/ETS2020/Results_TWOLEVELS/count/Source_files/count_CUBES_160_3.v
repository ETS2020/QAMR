...
module FAU ( 
  ...
  inv1   g052(.a(x26), .O(new_n106_));
  inv1   g053(.a(x27), .O(new_n107_));
  nand4  g054(.a(new_n84_), .b(new_n107_), .c(new_n106_), .d(new_n94_), .O(new_n108_));
  ...
  nand4  g062(.a(new_n116_), .b(new_n115_), .c(new_n106_), .d(new_n93_), .O(new_n117_));
  ...
  nand4  g097(.a(new_n152_), .b(new_n128_), .c(new_n116_), .d(new_n127_), .O(new_n153_));
  oai21  g098(.a(new_n153_), .b(new_n85_), .c(x33), .O(new_n154_));
  inv1   g099(.a(new_n95_), .O(new_n155_));
  inv1   g100(.a(x32), .O(new_n156_));
  inv1   g101(.a(x33), .O(new_n157_));
  nand4  g102(.a(new_n157_), .b(new_n156_), .c(new_n107_), .d(new_n106_), .O(new_n158_));
  inv1   g103(.a(new_n158_), .O(new_n159_));
  nand4  g104(.a(new_n159_), .b(new_n144_), .c(new_n155_), .d(new_n97_), .O(new_n160_));
