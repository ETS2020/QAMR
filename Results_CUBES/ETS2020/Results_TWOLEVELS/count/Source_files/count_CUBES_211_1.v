...
module FAU ( 
  ...
  nand4  g055(.a(new_n109_), .b(new_n84_), .c(new_n72_), .d(new_n62_), .O(new_n110_));
  ...
  nand4  g066(.a(new_n120_), .b(new_n101_), .c(new_n78_), .d(new_n62_), .O(new_n121_));
  ...
  nand4  g072(.a(new_n97_), .b(new_n55_), .c(new_n65_), .d(new_n64_), .O(new_n127_));
  nor2   g073(.a(x26), .b(x25), .O(new_n128_));
  nor2   g074(.a(x30), .b(x29), .O(new_n129_));
  nand4  g075(.a(new_n129_), .b(new_n111_), .c(new_n128_), .d(new_n88_), .O(new_n130_));
  ...
  nand2  g082(.a(new_n84_), .b(new_n72_), .O(new_n137_));
  ...
  nand4  g088(.a(new_n142_), .b(new_n109_), .c(new_n138_), .d(new_n62_), .O(new_n143_));
  ...
  nand4  g095(.a(new_n150_), .b(new_n129_), .c(new_n111_), .d(new_n128_), .O(new_n151_));
  oai21  g096(.a(new_n151_), .b(new_n85_), .c(x33), .O(new_n152_));
