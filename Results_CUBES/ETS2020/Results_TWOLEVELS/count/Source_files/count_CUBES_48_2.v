...
module FAU ( 
  ...
  nand4  g088(.a(new_n142_), .b(new_n141_), .c(new_n105_), .d(new_n94_), .O(new_n143_));
  oai21  g089(.a(new_n143_), .b(new_n86_), .c(x32), .O(new_n144_));
  nand2  g090(.a(new_n133_), .b(new_n116_), .O(new_n145_));
  inv1   g091(.a(x31), .O(new_n146_));
  inv1   g092(.a(x32), .O(new_n147_));
  nand4  g093(.a(new_n147_), .b(new_n146_), .c(new_n114_), .d(new_n94_), .O(new_n148_));
  nor2   g094(.a(new_n148_), .b(new_n145_), .O(new_n149_));
  ...
  nor2   g101(.a(x21), .b(x20), .O(new_n157_));
  nand4  g102(.a(new_n115_), .b(new_n102_), .c(new_n157_), .d(new_n55_), .O(new_n158_));
  nor2   g103(.a(x33), .b(x32), .O(new_n159_));
  nand4  g104(.a(new_n159_), .b(new_n142_), .c(new_n141_), .d(new_n105_), .O(new_n160_));
  oai21  g105(.a(new_n160_), .b(new_n158_), .c(x34), .O(new_n161_));
  nand2  g106(.a(new_n141_), .b(new_n105_), .O(new_n162_));
  inv1   g107(.a(new_n162_), .O(new_n163_));
  inv1   g108(.a(x30), .O(new_n164_));
  nand2  g109(.a(new_n146_), .b(new_n164_), .O(new_n165_));
  inv1   g110(.a(x33), .O(new_n166_));
  inv1   g111(.a(x34), .O(new_n167_));
  nand3  g112(.a(new_n167_), .b(new_n166_), .c(new_n147_), .O(new_n168_));
  nor2   g113(.a(new_n168_), .b(new_n165_), .O(new_n169_));
  nand3  g114(.a(new_n169_), .b(new_n163_), .c(new_n96_), .O(new_n170_));
  nand2  g115(.a(new_n170_), .b(new_n161_), .O(new_n171_));
