...
module FAU ( 
  ...
  nor3   g047(.a(x27), .b(x26), .c(x25), .O(new_n102_));
  nand4  g048(.a(new_n102_), .b(new_n88_), .c(new_n76_), .d(new_n63_), .O(new_n103_));
  nor2   g049(.a(x25), .b(x24), .O(new_n104_));
  nor2   g050(.a(x28), .b(x27), .O(new_n105_));
  nor2   g051(.a(x26), .b(x23), .O(new_n106_));
  nand3  g052(.a(new_n106_), .b(new_n105_), .c(new_n104_), .O(new_n107_));
  nor2   g053(.a(new_n107_), .b(new_n81_), .O(new_n108_));
  aoi21  g054(.a(new_n103_), .b(x28), .c(new_n108_), .O(new_n109_));
  inv1   g055(.a(x06), .O(new_n110_));
  aoi21  g056(.a(new_n58_), .b(new_n110_), .c(x18), .O(new_n111_));
  oai21  g057(.a(new_n109_), .b(new_n58_), .c(new_n111_), .O(z09));
  inv1   g058(.a(x29), .O(new_n113_));
  nor3   g059(.a(x26), .b(x25), .c(x24), .O(new_n114_));
  nor3   g060(.a(x29), .b(x28), .c(x27), .O(new_n115_));
  nand4  g061(.a(new_n115_), .b(new_n114_), .c(new_n82_), .d(new_n63_), .O(new_n116_));
  oai21  g062(.a(new_n108_), .b(new_n113_), .c(new_n116_), .O(new_n117_));
  ...
  nor2   g067(.a(x23), .b(x22), .O(new_n123_));
  nand4  g068(.a(new_n123_), .b(new_n55_), .c(new_n69_), .d(new_n61_), .O(new_n124_));
  nor2   g069(.a(x26), .b(x25), .O(new_n125_));
  nor2   g070(.a(x30), .b(x29), .O(new_n126_));
  nand4  g071(.a(new_n126_), .b(new_n125_), .c(new_n105_), .d(new_n92_), .O(new_n127_));
  oai21  g072(.a(new_n127_), .b(new_n124_), .c(x31), .O(new_n128_));
  nand2  g073(.a(new_n88_), .b(new_n76_), .O(new_n129_));
  ...
  nand4  g079(.a(new_n134_), .b(new_n102_), .c(new_n130_), .d(new_n63_), .O(new_n135_));
  ...
  nand4  g086(.a(new_n142_), .b(new_n126_), .c(new_n125_), .d(new_n105_), .O(new_n143_));
  oai21  g087(.a(new_n143_), .b(new_n89_), .c(x33), .O(new_n144_));
  nor2   g088(.a(x27), .b(x26), .O(new_n145_));
  nor2   g089(.a(x33), .b(x32), .O(new_n146_));
  nand4  g090(.a(new_n146_), .b(new_n132_), .c(new_n131_), .d(new_n145_), .O(new_n147_));
  inv1   g091(.a(new_n147_), .O(new_n148_));
  nand2  g092(.a(new_n148_), .b(new_n95_), .O(new_n149_));
  nand2  g093(.a(new_n149_), .b(new_n144_), .O(new_n150_));
  ...
  nor2   g098(.a(x21), .b(x20), .O(new_n155_));
  nand4  g099(.a(new_n104_), .b(new_n123_), .c(new_n155_), .d(new_n55_), .O(new_n156_));
  oai21  g100(.a(new_n147_), .b(new_n156_), .c(x34), .O(new_n157_));
  nand2  g101(.a(new_n131_), .b(new_n145_), .O(new_n158_));
  ...
  nand3  g111(.a(new_n167_), .b(new_n159_), .c(new_n95_), .O(new_n168_));
