...
module FAU ( 
  ...
  nand4  g106(.a(new_n159_), .b(new_n145_), .c(new_n126_), .d(new_n144_), .O(new_n160_));
  oai21  g107(.a(new_n160_), .b(new_n90_), .c(x33), .O(new_n161_));
  nor2   g108(.a(x33), .b(x32), .O(new_n162_));
  nand4  g109(.a(new_n162_), .b(new_n149_), .c(new_n148_), .d(new_n117_), .O(new_n163_));
  ...
  nand2  g118(.a(new_n148_), .b(new_n117_), .O(new_n172_));
