...
module FAU ( 
  ...
  nor3   g057(.a(x27), .b(x26), .c(x25), .O(new_n110_));
  nand4  g058(.a(new_n110_), .b(new_n86_), .c(new_n73_), .d(new_n60_), .O(new_n111_));
  inv1   g059(.a(x23), .O(new_n112_));
  inv1   g060(.a(x26), .O(new_n113_));
  nor2   g061(.a(x28), .b(x27), .O(new_n114_));
  nand4  g062(.a(new_n114_), .b(new_n95_), .c(new_n113_), .d(new_n112_), .O(new_n115_));
  nor2   g063(.a(new_n115_), .b(new_n78_), .O(new_n116_));
  aoi21  g064(.a(new_n111_), .b(x28), .c(new_n116_), .O(new_n117_));
  inv1   g065(.a(x06), .O(new_n118_));
  aoi21  g066(.a(new_n52_), .b(new_n118_), .c(x18), .O(new_n119_));
  oai21  g067(.a(new_n117_), .b(new_n52_), .c(new_n119_), .O(z09));
  oai21  g068(.a(new_n115_), .b(new_n78_), .c(x29), .O(new_n121_));
  nor3   g069(.a(x29), .b(x28), .c(x27), .O(new_n122_));
  nand4  g070(.a(new_n122_), .b(new_n102_), .c(new_n79_), .d(new_n60_), .O(new_n123_));
  nand2  g071(.a(new_n123_), .b(new_n121_), .O(new_n124_));
  nand2  g072(.a(new_n124_), .b(x16), .O(new_n125_));
  inv1   g073(.a(x05), .O(new_n126_));
  aoi21  g074(.a(new_n52_), .b(new_n126_), .c(x18), .O(new_n127_));
  nand2  g075(.a(new_n127_), .b(new_n125_), .O(z10));
  inv1   g076(.a(x21), .O(new_n130_));
  nand4  g077(.a(new_n94_), .b(new_n58_), .c(new_n130_), .d(new_n57_), .O(new_n131_));
  nor2   g078(.a(x26), .b(x25), .O(new_n132_));
  nor2   g079(.a(x30), .b(x29), .O(new_n133_));
  nand4  g080(.a(new_n133_), .b(new_n114_), .c(new_n132_), .d(new_n84_), .O(new_n134_));
  oai21  g081(.a(new_n134_), .b(new_n131_), .c(x31), .O(new_n135_));
  inv1   g082(.a(x22), .O(new_n136_));
  nand4  g083(.a(new_n84_), .b(new_n112_), .c(new_n136_), .d(new_n130_), .O(new_n137_));
  ...
  nand4  g091(.a(new_n144_), .b(new_n110_), .c(new_n138_), .d(new_n60_), .O(new_n145_));
  ...
  nand4  g100(.a(new_n153_), .b(new_n152_), .c(new_n132_), .d(new_n151_), .O(new_n154_));
  oai21  g101(.a(new_n154_), .b(new_n87_), .c(x32), .O(new_n155_));
  nand4  g102(.a(new_n141_), .b(new_n140_), .c(new_n139_), .d(new_n151_), .O(new_n156_));
  inv1   g103(.a(new_n156_), .O(new_n157_));
  inv1   g104(.a(x25), .O(new_n158_));
  inv1   g105(.a(x32), .O(new_n159_));
  nand4  g106(.a(new_n159_), .b(new_n142_), .c(new_n113_), .d(new_n158_), .O(new_n160_));
