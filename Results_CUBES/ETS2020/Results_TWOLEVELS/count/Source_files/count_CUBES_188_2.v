// Benchmark "FAU" written by ABC on Tue Jul  7 19:20:08 2020
...
module FAU ( 
  ...
  nand3  g046(.a(new_n100_), .b(new_n99_), .c(new_n67_), .O(new_n101_));
  ...
  nand4  g055(.a(new_n109_), .b(new_n82_), .c(new_n73_), .d(new_n62_), .O(new_n110_));
  ...
  nand4  g066(.a(new_n121_), .b(new_n100_), .c(new_n75_), .d(new_n62_), .O(new_n122_));
  nand4  g067(.a(new_n99_), .b(new_n55_), .c(new_n65_), .d(new_n64_), .O(new_n123_));
  ...
  nand3  g081(.a(new_n136_), .b(new_n109_), .c(new_n84_), .O(new_n137_));
  ...
  nand4  g088(.a(new_n144_), .b(new_n125_), .c(new_n112_), .d(new_n124_), .O(new_n145_));
  oai21  g089(.a(new_n145_), .b(new_n83_), .c(x33), .O(new_n146_));
