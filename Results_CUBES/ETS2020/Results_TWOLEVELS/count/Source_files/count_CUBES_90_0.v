// Benchmark "FAU" written by ABC on Tue Jul  7 19:18:34 2020
...
module FAU ( 
  ...
  nand4  g072(.a(new_n124_), .b(new_n104_), .c(new_n123_), .d(new_n94_), .O(new_n125_));
  ...
  nand4  g089(.a(new_n141_), .b(new_n124_), .c(new_n140_), .d(new_n84_), .O(new_n142_));
  ...
  nand2  g099(.a(new_n141_), .b(new_n124_), .O(new_n153_));
  inv1   g100(.a(x31), .O(new_n154_));
  inv1   g101(.a(x32), .O(new_n155_));
  nand4  g102(.a(new_n155_), .b(new_n154_), .c(new_n123_), .d(new_n95_), .O(new_n156_));
  nor2   g103(.a(new_n156_), .b(new_n153_), .O(new_n157_));
  nand2  g104(.a(new_n157_), .b(new_n88_), .O(new_n158_));
  ...
  nand4  g111(.a(new_n165_), .b(new_n150_), .c(new_n149_), .d(new_n114_), .O(new_n166_));
  oai21  g112(.a(new_n166_), .b(new_n105_), .c(x34), .O(new_n167_));
  nand2  g113(.a(new_n149_), .b(new_n114_), .O(new_n168_));
  inv1   g114(.a(new_n168_), .O(new_n169_));
  inv1   g115(.a(x30), .O(new_n170_));
  nand2  g116(.a(new_n154_), .b(new_n170_), .O(new_n171_));
  inv1   g117(.a(x33), .O(new_n172_));
  inv1   g118(.a(x34), .O(new_n173_));
  nand3  g119(.a(new_n173_), .b(new_n172_), .c(new_n155_), .O(new_n174_));
  nor2   g120(.a(new_n174_), .b(new_n171_), .O(new_n175_));
  nand3  g121(.a(new_n175_), .b(new_n169_), .c(new_n97_), .O(new_n176_));
  nand2  g122(.a(new_n176_), .b(new_n167_), .O(new_n177_));
