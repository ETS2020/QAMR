...
module FAU ( 
  ...
  nor3   g057(.a(x25), .b(x24), .c(x23), .O(new_n111_));
  nand4  g058(.a(new_n111_), .b(new_n110_), .c(new_n76_), .d(new_n63_), .O(new_n112_));
  nor2   g059(.a(x28), .b(x27), .O(new_n113_));
  nor2   g060(.a(x26), .b(x23), .O(new_n114_));
  nand3  g061(.a(new_n114_), .b(new_n113_), .c(new_n99_), .O(new_n115_));
  nor2   g062(.a(new_n115_), .b(new_n81_), .O(new_n116_));
  aoi21  g063(.a(new_n112_), .b(x28), .c(new_n116_), .O(new_n117_));
  ...
  nor2   g075(.a(x26), .b(x25), .O(new_n132_));
  nor2   g076(.a(x30), .b(x29), .O(new_n133_));
  nor2   g077(.a(x32), .b(x31), .O(new_n134_));
  nand4  g078(.a(new_n134_), .b(new_n133_), .c(new_n113_), .d(new_n132_), .O(new_n135_));
  oai21  g079(.a(new_n135_), .b(new_n90_), .c(x33), .O(new_n136_));
  inv1   g080(.a(x22), .O(new_n137_));
  inv1   g081(.a(x23), .O(new_n138_));
  inv1   g082(.a(x25), .O(new_n139_));
  nand4  g083(.a(new_n139_), .b(new_n87_), .c(new_n138_), .d(new_n137_), .O(new_n140_));
  nor2   g084(.a(new_n140_), .b(new_n70_), .O(new_n141_));
  nor2   g085(.a(x29), .b(x28), .O(new_n142_));
  nor2   g086(.a(x31), .b(x30), .O(new_n143_));
  nor2   g087(.a(x33), .b(x32), .O(new_n144_));
  nand4  g088(.a(new_n144_), .b(new_n143_), .c(new_n142_), .d(new_n110_), .O(new_n145_));
  inv1   g089(.a(new_n145_), .O(new_n146_));
  nand2  g090(.a(new_n146_), .b(new_n141_), .O(new_n147_));
  nand2  g091(.a(new_n147_), .b(new_n136_), .O(new_n148_));
  ...
  oai21  g096(.a(new_n145_), .b(new_n100_), .c(x34), .O(new_n153_));
  nand2  g097(.a(new_n142_), .b(new_n110_), .O(new_n154_));
  ...
  nand3  g107(.a(new_n163_), .b(new_n155_), .c(new_n141_), .O(new_n164_));
  nand2  g108(.a(new_n164_), .b(new_n153_), .O(new_n165_));
