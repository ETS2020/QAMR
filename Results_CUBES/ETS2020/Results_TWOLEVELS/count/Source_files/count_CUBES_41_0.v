...
module FAU ( 
  ...
  nand4  g072(.a(new_n125_), .b(new_n99_), .c(new_n78_), .d(new_n63_), .O(new_n126_));
  ...
  nand4  g078(.a(new_n98_), .b(new_n55_), .c(new_n69_), .d(new_n61_), .O(new_n133_));
  ...
  nand3  g087(.a(new_n141_), .b(new_n114_), .c(new_n82_), .O(new_n142_));
  ...
  nand4  g093(.a(new_n139_), .b(new_n138_), .c(new_n107_), .d(new_n89_), .O(new_n148_));
  oai21  g094(.a(new_n148_), .b(new_n81_), .c(x32), .O(new_n149_));
  ...
  nand2  g098(.a(new_n152_), .b(new_n82_), .O(new_n153_));
  ...
  oai21  g104(.a(new_n151_), .b(new_n81_), .c(x33), .O(new_n159_));
  ...
  nand2  g108(.a(new_n162_), .b(new_n91_), .O(new_n163_));
  ...
  nand4  g114(.a(new_n116_), .b(new_n98_), .c(new_n97_), .d(new_n55_), .O(new_n169_));
  ...
  nand3  g126(.a(new_n180_), .b(new_n172_), .c(new_n91_), .O(new_n181_));
