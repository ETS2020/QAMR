...
module FAU ( 
  ...
  nand4  g070(.a(new_n124_), .b(new_n103_), .c(new_n78_), .d(new_n71_), .O(new_n125_));
  nand4  g071(.a(new_n102_), .b(new_n55_), .c(new_n64_), .d(new_n62_), .O(new_n126_));
  ...
  nand2  g093(.a(new_n128_), .b(new_n116_), .O(new_n148_));
  inv1   g094(.a(x31), .O(new_n149_));
  inv1   g095(.a(x32), .O(new_n150_));
  nand4  g096(.a(new_n150_), .b(new_n149_), .c(new_n114_), .d(new_n94_), .O(new_n151_));
  nor2   g097(.a(new_n151_), .b(new_n148_), .O(new_n152_));
  ...
  nand4  g105(.a(new_n115_), .b(new_n102_), .c(new_n160_), .d(new_n55_), .O(new_n161_));
  nor2   g106(.a(x33), .b(x32), .O(new_n162_));
  nand4  g107(.a(new_n162_), .b(new_n137_), .c(new_n136_), .d(new_n105_), .O(new_n163_));
  oai21  g108(.a(new_n163_), .b(new_n161_), .c(x34), .O(new_n164_));
  nand2  g109(.a(new_n136_), .b(new_n105_), .O(new_n165_));
  inv1   g110(.a(new_n165_), .O(new_n166_));
  inv1   g111(.a(x30), .O(new_n167_));
  nand2  g112(.a(new_n149_), .b(new_n167_), .O(new_n168_));
  inv1   g113(.a(x33), .O(new_n169_));
  inv1   g114(.a(x34), .O(new_n170_));
  nand3  g115(.a(new_n170_), .b(new_n169_), .c(new_n150_), .O(new_n171_));
  nor2   g116(.a(new_n171_), .b(new_n168_), .O(new_n172_));
  nand3  g117(.a(new_n172_), .b(new_n166_), .c(new_n96_), .O(new_n173_));
