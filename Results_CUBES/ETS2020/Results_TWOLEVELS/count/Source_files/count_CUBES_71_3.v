...
module FAU ( 
  ...
  nand3  g050(.a(new_n103_), .b(new_n102_), .c(new_n71_), .O(new_n104_));
  nand3  g051(.a(new_n76_), .b(new_n55_), .c(new_n61_), .O(new_n105_));
  nor2   g052(.a(x27), .b(x26), .O(new_n106_));
  nand3  g053(.a(new_n106_), .b(new_n85_), .c(new_n94_), .O(new_n107_));
  nor2   g054(.a(new_n107_), .b(new_n105_), .O(new_n108_));
  aoi21  g055(.a(new_n104_), .b(x27), .c(new_n108_), .O(new_n109_));
  ...
  nand4  g060(.a(new_n113_), .b(new_n85_), .c(new_n76_), .d(new_n63_), .O(new_n114_));
  nor2   g061(.a(x25), .b(x24), .O(new_n115_));
  nor2   g062(.a(x28), .b(x27), .O(new_n116_));
  nor2   g063(.a(x26), .b(x23), .O(new_n117_));
  nand3  g064(.a(new_n117_), .b(new_n116_), .c(new_n115_), .O(new_n118_));
  nor2   g065(.a(new_n118_), .b(new_n105_), .O(new_n119_));
  ...
  nand4  g072(.a(new_n125_), .b(new_n103_), .c(new_n83_), .d(new_n63_), .O(new_n126_));
  ...
  nand4  g078(.a(new_n102_), .b(new_n55_), .c(new_n69_), .d(new_n61_), .O(new_n132_));
  nor2   g079(.a(x26), .b(x25), .O(new_n133_));
  nor2   g080(.a(x30), .b(x29), .O(new_n134_));
  nand4  g081(.a(new_n134_), .b(new_n116_), .c(new_n133_), .d(new_n82_), .O(new_n135_));
  ...
  oai21  g087(.a(new_n135_), .b(new_n132_), .c(x31), .O(new_n141_));
  ...
  nand3  g092(.a(new_n145_), .b(new_n113_), .c(new_n87_), .O(new_n146_));
  nand2  g093(.a(new_n146_), .b(new_n141_), .O(new_n147_));
  ...
  nand4  g099(.a(new_n153_), .b(new_n134_), .c(new_n116_), .d(new_n133_), .O(new_n154_));
  oai21  g100(.a(new_n154_), .b(new_n86_), .c(x33), .O(new_n155_));
  nor2   g101(.a(x33), .b(x32), .O(new_n156_));
  nand4  g102(.a(new_n156_), .b(new_n143_), .c(new_n142_), .d(new_n106_), .O(new_n157_));
  inv1   g103(.a(new_n157_), .O(new_n158_));
  nand2  g104(.a(new_n158_), .b(new_n96_), .O(new_n159_));
  ...
  nor2   g110(.a(x21), .b(x20), .O(new_n165_));
  nand4  g111(.a(new_n115_), .b(new_n102_), .c(new_n165_), .d(new_n55_), .O(new_n166_));
  oai21  g112(.a(new_n157_), .b(new_n166_), .c(x34), .O(new_n167_));
  nand2  g113(.a(new_n142_), .b(new_n106_), .O(new_n168_));
