...
module FAU ( 
  ...
  nand4  g099(.a(new_n153_), .b(new_n152_), .c(new_n91_), .d(new_n84_), .O(new_n154_));
  inv1   g100(.a(new_n154_), .O(new_n155_));
  nand4  g101(.a(new_n155_), .b(new_n151_), .c(new_n137_), .d(new_n67_), .O(new_n156_));
  nand2  g102(.a(new_n156_), .b(new_n149_), .O(new_n157_));
  ...
  nand4  g107(.a(new_n110_), .b(new_n93_), .c(new_n92_), .d(new_n55_), .O(new_n163_));
  nor2   g108(.a(x33), .b(x32), .O(new_n164_));
  nand4  g109(.a(new_n164_), .b(new_n139_), .c(new_n138_), .d(new_n101_), .O(new_n165_));
  oai21  g110(.a(new_n165_), .b(new_n163_), .c(x34), .O(new_n166_));
  nand2  g111(.a(new_n138_), .b(new_n101_), .O(new_n167_));
  inv1   g112(.a(new_n167_), .O(new_n168_));
  inv1   g113(.a(x30), .O(new_n169_));
  nand2  g114(.a(new_n152_), .b(new_n169_), .O(new_n170_));
  inv1   g115(.a(x33), .O(new_n171_));
  inv1   g116(.a(x34), .O(new_n172_));
  nand3  g117(.a(new_n172_), .b(new_n171_), .c(new_n153_), .O(new_n173_));
  nor2   g118(.a(new_n173_), .b(new_n170_), .O(new_n174_));
  nand3  g119(.a(new_n174_), .b(new_n168_), .c(new_n86_), .O(new_n175_));
