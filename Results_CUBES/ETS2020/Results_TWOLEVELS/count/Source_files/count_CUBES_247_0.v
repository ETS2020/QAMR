...
module FAU ( 
  ...
  nand4  g088(.a(new_n142_), .b(new_n141_), .c(new_n114_), .d(new_n95_), .O(new_n143_));
  oai21  g089(.a(new_n143_), .b(new_n87_), .c(x32), .O(new_n144_));
  nor2   g090(.a(x26), .b(x25), .O(new_n145_));
  nor2   g091(.a(x30), .b(x29), .O(new_n146_));
  nor2   g092(.a(x32), .b(x31), .O(new_n147_));
  nand4  g093(.a(new_n147_), .b(new_n146_), .c(new_n123_), .d(new_n145_), .O(new_n148_));
  inv1   g094(.a(new_n148_), .O(new_n149_));
  nand2  g095(.a(new_n149_), .b(new_n88_), .O(new_n150_));
  nand2  g096(.a(new_n150_), .b(new_n144_), .O(new_n151_));
  ...
  nand4  g103(.a(new_n157_), .b(new_n142_), .c(new_n141_), .d(new_n114_), .O(new_n158_));
  inv1   g104(.a(new_n158_), .O(new_n159_));
  nand2  g105(.a(new_n159_), .b(new_n97_), .O(new_n160_));
  ...
  oai21  g111(.a(new_n158_), .b(new_n105_), .c(x34), .O(new_n166_));
  nand2  g112(.a(new_n141_), .b(new_n114_), .O(new_n167_));
  ...
  nand3  g122(.a(new_n176_), .b(new_n168_), .c(new_n97_), .O(new_n177_));
