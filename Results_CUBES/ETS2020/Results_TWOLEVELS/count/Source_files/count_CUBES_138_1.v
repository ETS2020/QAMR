// Benchmark "FAU" written by ABC on Tue Jul  7 19:19:18 2020
...
module FAU ( 
  ...
  nand4  g055(.a(new_n109_), .b(new_n84_), .c(new_n72_), .d(new_n56_), .O(new_n110_));
  nor2   g056(.a(x28), .b(x27), .O(new_n111_));
  nor2   g057(.a(x26), .b(x23), .O(new_n112_));
  nand3  g058(.a(new_n112_), .b(new_n111_), .c(new_n98_), .O(new_n113_));
  nor2   g059(.a(new_n113_), .b(new_n77_), .O(new_n114_));
  ...
  nand4  g066(.a(new_n120_), .b(new_n101_), .c(new_n78_), .d(new_n56_), .O(new_n121_));
  ...
  aoi21  g070(.a(new_n59_), .b(new_n124_), .c(x18), .O(new_n125_));
  nand2  g071(.a(new_n125_), .b(new_n123_), .O(z10));
  nand4  g072(.a(new_n97_), .b(new_n54_), .c(new_n65_), .d(new_n53_), .O(new_n128_));
  nor2   g073(.a(x26), .b(x25), .O(new_n129_));
  nor2   g074(.a(x30), .b(x29), .O(new_n130_));
  nand4  g075(.a(new_n130_), .b(new_n111_), .c(new_n129_), .d(new_n88_), .O(new_n131_));
  oai21  g076(.a(new_n131_), .b(new_n128_), .c(x31), .O(new_n132_));
  nand2  g077(.a(new_n84_), .b(new_n72_), .O(new_n133_));
  ...
  nand4  g083(.a(new_n138_), .b(new_n109_), .c(new_n134_), .d(new_n56_), .O(new_n139_));
  ...
  nand4  g090(.a(new_n136_), .b(new_n135_), .c(new_n145_), .d(new_n89_), .O(new_n146_));
  oai21  g091(.a(new_n146_), .b(new_n85_), .c(x32), .O(new_n147_));
  nand2  g092(.a(new_n130_), .b(new_n111_), .O(new_n148_));
  inv1   g093(.a(new_n148_), .O(new_n149_));
  nor2   g094(.a(x32), .b(x31), .O(new_n150_));
  nand2  g095(.a(new_n150_), .b(new_n129_), .O(new_n151_));
  inv1   g096(.a(new_n151_), .O(new_n152_));
  nand4  g097(.a(new_n152_), .b(new_n149_), .c(new_n134_), .d(new_n56_), .O(new_n153_));
  ...
  nand4  g103(.a(new_n150_), .b(new_n130_), .c(new_n111_), .d(new_n129_), .O(new_n159_));
  oai21  g104(.a(new_n159_), .b(new_n85_), .c(x33), .O(new_n160_));
