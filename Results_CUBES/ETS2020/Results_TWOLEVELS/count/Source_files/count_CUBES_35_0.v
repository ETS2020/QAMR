...
module FAU ( 
  ...
  nand4  g090(.a(new_n106_), .b(new_n55_), .c(new_n69_), .d(new_n61_), .O(new_n142_));
  nor2   g091(.a(x26), .b(x25), .O(new_n143_));
  nor2   g092(.a(x30), .b(x29), .O(new_n144_));
  nand4  g093(.a(new_n144_), .b(new_n127_), .c(new_n143_), .d(new_n87_), .O(new_n145_));
  ...
  nor2   g099(.a(x29), .b(x28), .O(new_n152_));
  nor2   g100(.a(x31), .b(x30), .O(new_n153_));
  nand4  g101(.a(new_n153_), .b(new_n152_), .c(new_n117_), .d(new_n98_), .O(new_n154_));
  oai21  g102(.a(new_n154_), .b(new_n90_), .c(x32), .O(new_n155_));
  nand2  g103(.a(new_n144_), .b(new_n127_), .O(new_n156_));
  inv1   g104(.a(x31), .O(new_n157_));
  inv1   g105(.a(x32), .O(new_n158_));
  nand4  g106(.a(new_n158_), .b(new_n157_), .c(new_n126_), .d(new_n98_), .O(new_n159_));
  ...
  nand4  g115(.a(new_n168_), .b(new_n153_), .c(new_n152_), .d(new_n117_), .O(new_n169_));
  oai21  g116(.a(new_n169_), .b(new_n108_), .c(x34), .O(new_n170_));
  nand2  g117(.a(new_n152_), .b(new_n117_), .O(new_n171_));
  inv1   g118(.a(new_n171_), .O(new_n172_));
  inv1   g119(.a(x30), .O(new_n173_));
  nand2  g120(.a(new_n157_), .b(new_n173_), .O(new_n174_));
  inv1   g121(.a(x33), .O(new_n175_));
  inv1   g122(.a(x34), .O(new_n176_));
  nand3  g123(.a(new_n176_), .b(new_n175_), .c(new_n158_), .O(new_n177_));
  nor2   g124(.a(new_n177_), .b(new_n174_), .O(new_n178_));
  nand3  g125(.a(new_n178_), .b(new_n172_), .c(new_n100_), .O(new_n179_));
  nand2  g126(.a(new_n179_), .b(new_n170_), .O(new_n180_));
  nand2  g127(.a(new_n180_), .b(x16), .O(new_n181_));
  inv1   g128(.a(x00), .O(new_n182_));
  aoi21  g129(.a(new_n58_), .b(new_n182_), .c(x18), .O(new_n183_));
  nand2  g130(.a(new_n183_), .b(new_n181_), .O(z15));
  zero   g131(.O(z12));
  zero   g132(.O(z14));
endmodule
