...
module FAU ( 
  ...
  nand4  g091(.a(new_n146_), .b(new_n126_), .c(new_n125_), .d(new_n124_), .O(new_n147_));
  oai21  g092(.a(new_n147_), .b(new_n85_), .c(x33), .O(new_n148_));
  nor2   g093(.a(x33), .b(x32), .O(new_n149_));
  nand4  g094(.a(new_n149_), .b(new_n136_), .c(new_n135_), .d(new_n112_), .O(new_n150_));
  inv1   g095(.a(new_n150_), .O(new_n151_));
  nand2  g096(.a(new_n151_), .b(new_n95_), .O(new_n152_));
  nand2  g097(.a(new_n152_), .b(new_n148_), .O(new_n153_));
  ...
  oai21  g102(.a(new_n150_), .b(new_n103_), .c(x34), .O(new_n158_));
  nand2  g103(.a(new_n135_), .b(new_n112_), .O(new_n159_));
  ...
  nand3  g113(.a(new_n168_), .b(new_n160_), .c(new_n95_), .O(new_n169_));
