// Benchmark "FAU" written by ABC on Tue Jul  7 19:19:48 2020
...
module FAU ( 
  ...
  nand4  g093(.a(new_n146_), .b(new_n145_), .c(new_n110_), .d(new_n93_), .O(new_n147_));
  oai21  g094(.a(new_n147_), .b(new_n85_), .c(x32), .O(new_n148_));
  nor2   g095(.a(x32), .b(x31), .O(new_n149_));
  nand4  g096(.a(new_n149_), .b(new_n137_), .c(new_n120_), .d(new_n136_), .O(new_n150_));
  inv1   g097(.a(new_n150_), .O(new_n151_));
  nand2  g098(.a(new_n151_), .b(new_n86_), .O(new_n152_));
  nand2  g099(.a(new_n152_), .b(new_n148_), .O(new_n153_));
  nand2  g100(.a(new_n153_), .b(x16), .O(new_n154_));
  inv1   g101(.a(x02), .O(new_n155_));
  aoi21  g102(.a(new_n58_), .b(new_n155_), .c(x18), .O(new_n156_));
  nand2  g103(.a(new_n156_), .b(new_n154_), .O(z13));
  oai21  g104(.a(new_n150_), .b(new_n85_), .c(x33), .O(new_n158_));
  nor2   g105(.a(x33), .b(x32), .O(new_n159_));
  nand4  g106(.a(new_n159_), .b(new_n146_), .c(new_n145_), .d(new_n110_), .O(new_n160_));
  inv1   g107(.a(new_n160_), .O(new_n161_));
  nand2  g108(.a(new_n161_), .b(new_n95_), .O(new_n162_));
  nand2  g109(.a(new_n162_), .b(new_n158_), .O(new_n163_));
  nand2  g110(.a(new_n163_), .b(x16), .O(new_n164_));
  inv1   g111(.a(x01), .O(new_n165_));
  aoi21  g112(.a(new_n58_), .b(new_n165_), .c(x18), .O(new_n166_));
  nand2  g113(.a(new_n166_), .b(new_n164_), .O(z14));
  nand4  g114(.a(new_n119_), .b(new_n102_), .c(new_n101_), .d(new_n55_), .O(new_n168_));
  oai21  g115(.a(new_n160_), .b(new_n168_), .c(x34), .O(new_n169_));
  nand2  g116(.a(new_n145_), .b(new_n110_), .O(new_n170_));
  inv1   g117(.a(new_n170_), .O(new_n171_));
  inv1   g118(.a(x30), .O(new_n172_));
  inv1   g119(.a(x31), .O(new_n173_));
  nand2  g120(.a(new_n173_), .b(new_n172_), .O(new_n174_));
  inv1   g121(.a(x32), .O(new_n175_));
  inv1   g122(.a(x33), .O(new_n176_));
  inv1   g123(.a(x34), .O(new_n177_));
  nand3  g124(.a(new_n177_), .b(new_n176_), .c(new_n175_), .O(new_n178_));
  nor2   g125(.a(new_n178_), .b(new_n174_), .O(new_n179_));
  nand3  g126(.a(new_n179_), .b(new_n171_), .c(new_n95_), .O(new_n180_));
  nand2  g127(.a(new_n180_), .b(new_n169_), .O(new_n181_));
  nand2  g128(.a(new_n181_), .b(x16), .O(new_n182_));
  inv1   g129(.a(x00), .O(new_n183_));
  aoi21  g130(.a(new_n58_), .b(new_n183_), .c(x18), .O(new_n184_));
  nand2  g131(.a(new_n184_), .b(new_n182_), .O(z15));
  zero   g132(.O(z02));
  zero   g133(.O(z12));
endmodule
