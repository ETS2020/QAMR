...
module FAU ( 
  ...
  nand4  g061(.a(new_n116_), .b(new_n99_), .c(new_n79_), .d(new_n63_), .O(new_n117_));
  nand4  g062(.a(new_n95_), .b(new_n55_), .c(new_n69_), .d(new_n61_), .O(new_n118_));
  nor2   g063(.a(x26), .b(x25), .O(new_n119_));
  nor2   g064(.a(x28), .b(x27), .O(new_n120_));
  nor2   g065(.a(x30), .b(x29), .O(new_n121_));
  nand4  g066(.a(new_n121_), .b(new_n120_), .c(new_n119_), .d(new_n84_), .O(new_n122_));
  ...
  nand4  g084(.a(new_n131_), .b(new_n130_), .c(new_n107_), .d(new_n106_), .O(new_n140_));
  oai21  g085(.a(new_n140_), .b(new_n87_), .c(x32), .O(new_n141_));
  nor2   g086(.a(x32), .b(x31), .O(new_n142_));
  nand4  g087(.a(new_n142_), .b(new_n121_), .c(new_n120_), .d(new_n119_), .O(new_n143_));
  ...
  nand4  g098(.a(new_n106_), .b(new_n84_), .c(new_n153_), .d(new_n152_), .O(new_n154_));
  nor2   g099(.a(new_n154_), .b(new_n70_), .O(new_n155_));
  nor2   g100(.a(x33), .b(x32), .O(new_n156_));
  nand4  g101(.a(new_n156_), .b(new_n131_), .c(new_n130_), .d(new_n107_), .O(new_n157_));
  ...
  oai21  g109(.a(new_n157_), .b(new_n97_), .c(x34), .O(new_n165_));
  nand2  g110(.a(new_n130_), .b(new_n107_), .O(new_n166_));
