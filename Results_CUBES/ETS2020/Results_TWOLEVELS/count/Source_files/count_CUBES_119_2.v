// Benchmark "FAU" written by ABC on Tue Jul  7 19:18:59 2020
...
module FAU ( 
  ...
  nand3  g039(.a(new_n94_), .b(new_n93_), .c(new_n62_), .O(new_n95_));
  nor2   g040(.a(x27), .b(x26), .O(new_n96_));
  nand3  g041(.a(new_n96_), .b(new_n80_), .c(new_n85_), .O(new_n97_));
  ...
  nand4  g048(.a(new_n103_), .b(new_n80_), .c(new_n67_), .d(new_n55_), .O(new_n104_));
  inv1   g049(.a(x26), .O(new_n105_));
  nor2   g050(.a(x25), .b(x24), .O(new_n106_));
  nor2   g051(.a(x28), .b(x27), .O(new_n107_));
  nand4  g052(.a(new_n107_), .b(new_n106_), .c(new_n105_), .d(new_n83_), .O(new_n108_));
  ...
  nand4  g060(.a(new_n115_), .b(new_n94_), .c(new_n74_), .d(new_n55_), .O(new_n116_));
  ...
  nand4  g066(.a(new_n93_), .b(new_n72_), .c(new_n60_), .d(new_n59_), .O(new_n123_));
  nor2   g067(.a(x26), .b(x25), .O(new_n124_));
  nor2   g068(.a(x30), .b(x29), .O(new_n125_));
  nand4  g069(.a(new_n125_), .b(new_n107_), .c(new_n124_), .d(new_n84_), .O(new_n126_));
  oai21  g070(.a(new_n126_), .b(new_n123_), .c(x31), .O(new_n127_));
  nand2  g071(.a(new_n80_), .b(new_n67_), .O(new_n128_));
  ...
  nand4  g077(.a(new_n133_), .b(new_n103_), .c(new_n129_), .d(new_n55_), .O(new_n134_));
  nand2  g078(.a(new_n134_), .b(new_n127_), .O(new_n135_));
  nand2  g079(.a(new_n135_), .b(x16), .O(new_n136_));
  inv1   g080(.a(x03), .O(new_n137_));
  aoi21  g081(.a(new_n54_), .b(new_n137_), .c(x18), .O(new_n138_));
  nand2  g082(.a(new_n138_), .b(new_n136_), .O(z12));
  nand4  g083(.a(new_n131_), .b(new_n130_), .c(new_n96_), .d(new_n85_), .O(new_n140_));
  oai21  g084(.a(new_n140_), .b(new_n81_), .c(x32), .O(new_n141_));
  nand2  g085(.a(new_n125_), .b(new_n107_), .O(new_n142_));
  inv1   g086(.a(new_n142_), .O(new_n143_));
  inv1   g087(.a(x31), .O(new_n144_));
  inv1   g088(.a(x32), .O(new_n145_));
  nand4  g089(.a(new_n145_), .b(new_n144_), .c(new_n105_), .d(new_n85_), .O(new_n146_));
  inv1   g090(.a(new_n146_), .O(new_n147_));
  nand4  g091(.a(new_n147_), .b(new_n143_), .c(new_n129_), .d(new_n55_), .O(new_n148_));
  nand2  g092(.a(new_n148_), .b(new_n141_), .O(new_n149_));
  nand2  g093(.a(new_n149_), .b(x16), .O(new_n150_));
  inv1   g094(.a(x02), .O(new_n151_));
  aoi21  g095(.a(new_n54_), .b(new_n151_), .c(x18), .O(new_n152_));
  nand2  g096(.a(new_n152_), .b(new_n150_), .O(z13));
  nor2   g097(.a(x21), .b(x20), .O(new_n155_));
  nand4  g098(.a(new_n106_), .b(new_n93_), .c(new_n155_), .d(new_n72_), .O(new_n156_));
