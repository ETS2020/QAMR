...
module FAU ( 
  ...
  nand4  g067(.a(new_n121_), .b(new_n95_), .c(new_n74_), .d(new_n67_), .O(new_n122_));
  ...
  nand4  g073(.a(new_n94_), .b(new_n55_), .c(new_n64_), .d(new_n63_), .O(new_n128_));
  ...
  nand3  g087(.a(new_n141_), .b(new_n110_), .c(new_n78_), .O(new_n142_));
  ...
  nand4  g093(.a(new_n139_), .b(new_n138_), .c(new_n103_), .d(new_n85_), .O(new_n148_));
  oai21  g094(.a(new_n148_), .b(new_n77_), .c(x32), .O(new_n149_));
  nor2   g095(.a(x32), .b(x31), .O(new_n150_));
  nand4  g096(.a(new_n150_), .b(new_n130_), .c(new_n113_), .d(new_n129_), .O(new_n151_));
  inv1   g097(.a(new_n151_), .O(new_n152_));
  nand2  g098(.a(new_n152_), .b(new_n78_), .O(new_n153_));
  ...
  oai21  g104(.a(new_n151_), .b(new_n77_), .c(x33), .O(new_n159_));
  nor2   g105(.a(x33), .b(x32), .O(new_n160_));
  nand4  g106(.a(new_n160_), .b(new_n139_), .c(new_n138_), .d(new_n103_), .O(new_n161_));
  inv1   g107(.a(new_n161_), .O(new_n162_));
  nand2  g108(.a(new_n162_), .b(new_n87_), .O(new_n163_));
  ...
  nand4  g114(.a(new_n112_), .b(new_n94_), .c(new_n93_), .d(new_n55_), .O(new_n169_));
  oai21  g115(.a(new_n161_), .b(new_n169_), .c(x34), .O(new_n170_));
  nand2  g116(.a(new_n138_), .b(new_n103_), .O(new_n171_));
  ...
  nand3  g126(.a(new_n180_), .b(new_n172_), .c(new_n87_), .O(new_n181_));
