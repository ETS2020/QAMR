...
module FAU ( 
  ...
  nand4  g060(.a(new_n113_), .b(new_n84_), .c(new_n72_), .d(new_n62_), .O(new_n114_));
  ...
  nand4  g071(.a(new_n124_), .b(new_n97_), .c(new_n78_), .d(new_n62_), .O(new_n125_));
  ...
  nand4  g077(.a(new_n88_), .b(new_n55_), .c(new_n65_), .d(new_n64_), .O(new_n132_));
  inv1   g078(.a(x24), .O(new_n133_));
  nor2   g079(.a(x26), .b(x25), .O(new_n134_));
  nor2   g080(.a(x30), .b(x29), .O(new_n135_));
  nand4  g081(.a(new_n135_), .b(new_n116_), .c(new_n134_), .d(new_n133_), .O(new_n136_));
  oai21  g082(.a(new_n136_), .b(new_n132_), .c(x31), .O(new_n137_));
  inv1   g083(.a(x22), .O(new_n138_));
  nand4  g084(.a(new_n133_), .b(new_n115_), .c(new_n138_), .d(new_n65_), .O(new_n139_));
  ...
  nand4  g092(.a(new_n146_), .b(new_n113_), .c(new_n140_), .d(new_n62_), .O(new_n147_));
  nand2  g093(.a(new_n147_), .b(new_n137_), .O(new_n148_));
  ...
  nand4  g099(.a(new_n154_), .b(new_n135_), .c(new_n116_), .d(new_n134_), .O(new_n155_));
  oai21  g100(.a(new_n155_), .b(new_n85_), .c(x33), .O(new_n156_));
  nand4  g101(.a(new_n104_), .b(new_n133_), .c(new_n115_), .d(new_n138_), .O(new_n157_));
  inv1   g102(.a(new_n157_), .O(new_n158_));
  inv1   g103(.a(x32), .O(new_n159_));
  inv1   g104(.a(x33), .O(new_n160_));
  nand4  g105(.a(new_n160_), .b(new_n159_), .c(new_n106_), .d(new_n105_), .O(new_n161_));
  inv1   g106(.a(new_n161_), .O(new_n162_));
  nand4  g107(.a(new_n162_), .b(new_n146_), .c(new_n158_), .d(new_n67_), .O(new_n163_));
  nand2  g108(.a(new_n163_), .b(new_n156_), .O(new_n164_));
