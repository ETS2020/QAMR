...
module FAU ( 
  ...
  nand4  g067(.a(new_n121_), .b(new_n99_), .c(new_n79_), .d(new_n71_), .O(new_n122_));
  ...
  nand4  g073(.a(new_n98_), .b(new_n55_), .c(new_n64_), .d(new_n62_), .O(new_n128_));
  nor2   g074(.a(x26), .b(x25), .O(new_n129_));
  nor2   g075(.a(x30), .b(x29), .O(new_n130_));
  nand4  g076(.a(new_n130_), .b(new_n112_), .c(new_n129_), .d(new_n78_), .O(new_n131_));
  ...
  nand3  g087(.a(new_n141_), .b(new_n109_), .c(new_n83_), .O(new_n142_));
  ...
  nand4  g093(.a(new_n139_), .b(new_n138_), .c(new_n102_), .d(new_n90_), .O(new_n148_));
  oai21  g094(.a(new_n148_), .b(new_n82_), .c(x32), .O(new_n149_));
  ...
  nand2  g098(.a(new_n152_), .b(new_n83_), .O(new_n153_));
  ...
  oai21  g104(.a(new_n151_), .b(new_n82_), .c(x33), .O(new_n159_));
  nor2   g105(.a(x33), .b(x32), .O(new_n160_));
  nand4  g106(.a(new_n160_), .b(new_n139_), .c(new_n138_), .d(new_n102_), .O(new_n161_));
  inv1   g107(.a(new_n161_), .O(new_n162_));
  nand2  g108(.a(new_n162_), .b(new_n92_), .O(new_n163_));
  nand2  g109(.a(new_n163_), .b(new_n159_), .O(new_n164_));
  ...
  nand4  g115(.a(new_n111_), .b(new_n98_), .c(new_n169_), .d(new_n55_), .O(new_n170_));
  oai21  g116(.a(new_n161_), .b(new_n170_), .c(x34), .O(new_n171_));
  nand2  g117(.a(new_n138_), .b(new_n102_), .O(new_n172_));
  ...
  aoi21  g131(.a(new_n58_), .b(new_n185_), .c(x18), .O(new_n186_));
