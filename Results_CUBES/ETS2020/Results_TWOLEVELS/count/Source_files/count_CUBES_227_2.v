...
module FAU ( 
  ...
  nand3  g046(.a(new_n72_), .b(new_n55_), .c(new_n64_), .O(new_n101_));
  ...
  nand4  g055(.a(new_n109_), .b(new_n81_), .c(new_n72_), .d(new_n62_), .O(new_n110_));
  ...
  oai21  g065(.a(new_n114_), .b(new_n101_), .c(x29), .O(new_n120_));
  nor3   g066(.a(x29), .b(x28), .c(x27), .O(new_n121_));
  nand4  g067(.a(new_n121_), .b(new_n99_), .c(new_n79_), .d(new_n62_), .O(new_n122_));
  ...
  nand4  g091(.a(new_n145_), .b(new_n109_), .c(new_n139_), .d(new_n62_), .O(new_n146_));
  ...
  nand4  g099(.a(new_n153_), .b(new_n152_), .c(new_n102_), .d(new_n90_), .O(new_n154_));
  ...
  nand4  g105(.a(new_n159_), .b(new_n143_), .c(new_n111_), .d(new_n90_), .O(new_n160_));
  ...
  nand4  g114(.a(new_n168_), .b(new_n130_), .c(new_n113_), .d(new_n129_), .O(new_n169_));
  oai21  g115(.a(new_n169_), .b(new_n82_), .c(x33), .O(new_n170_));
  inv1   g116(.a(x33), .O(new_n171_));
  nand4  g117(.a(new_n171_), .b(new_n159_), .c(new_n156_), .d(new_n111_), .O(new_n172_));
