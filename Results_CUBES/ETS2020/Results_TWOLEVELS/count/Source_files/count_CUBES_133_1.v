...
module FAU ( 
  ...
  nand4  g090(.a(new_n146_), .b(new_n130_), .c(new_n111_), .d(new_n129_), .O(new_n147_));
  oai21  g091(.a(new_n147_), .b(new_n85_), .c(x33), .O(new_n148_));
  ...
  nand2  g096(.a(new_n152_), .b(new_n91_), .O(new_n153_));
  ...
  oai21  g102(.a(new_n151_), .b(new_n99_), .c(x34), .O(new_n159_));
  ...
  nand3  g113(.a(new_n169_), .b(new_n161_), .c(new_n91_), .O(new_n170_));
