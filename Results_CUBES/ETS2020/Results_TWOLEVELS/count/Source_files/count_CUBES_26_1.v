...
module FAU ( 
  ...
  nand4  g091(.a(new_n145_), .b(new_n133_), .c(new_n115_), .d(new_n132_), .O(new_n146_));
  inv1   g092(.a(new_n146_), .O(new_n147_));
  nand2  g093(.a(new_n147_), .b(new_n87_), .O(new_n148_));
  nand2  g094(.a(new_n148_), .b(new_n144_), .O(new_n149_));
  nand2  g095(.a(new_n149_), .b(x16), .O(new_n150_));
  inv1   g096(.a(x02), .O(new_n151_));
  aoi21  g097(.a(new_n59_), .b(new_n151_), .c(x18), .O(new_n152_));
  nand2  g098(.a(new_n152_), .b(new_n150_), .O(z13));
  oai21  g099(.a(new_n146_), .b(new_n86_), .c(x33), .O(new_n154_));
