// Benchmark "FAU" written by ABC on Tue Jul  7 19:21:08 2020
...
module FAU ( 
  ...
  nand3  g045(.a(new_n99_), .b(new_n98_), .c(new_n66_), .O(new_n100_));
  ...
  inv1   g054(.a(x26), .O(new_n110_));
  nor2   g055(.a(x25), .b(x24), .O(new_n111_));
  nor2   g056(.a(x28), .b(x27), .O(new_n112_));
  nand4  g057(.a(new_n112_), .b(new_n111_), .c(new_n110_), .d(new_n89_), .O(new_n113_));
  ...
  nand4  g066(.a(new_n98_), .b(new_n55_), .c(new_n64_), .d(new_n62_), .O(new_n122_));
  nor2   g067(.a(x26), .b(x25), .O(new_n123_));
  nor2   g068(.a(x30), .b(x29), .O(new_n124_));
  nand4  g069(.a(new_n124_), .b(new_n112_), .c(new_n123_), .d(new_n78_), .O(new_n125_));
  ...
  aoi21  g073(.a(new_n58_), .b(new_n128_), .c(x18), .O(new_n129_));
  oai21  g074(.a(new_n127_), .b(new_n58_), .c(new_n129_), .O(z11));
  oai21  g075(.a(new_n125_), .b(new_n122_), .c(x31), .O(new_n131_));
  nor3   g076(.a(x27), .b(x26), .c(x25), .O(new_n132_));
  ...
  nand3  g081(.a(new_n136_), .b(new_n132_), .c(new_n83_), .O(new_n137_));
  nand2  g082(.a(new_n137_), .b(new_n131_), .O(new_n138_));
  ...
  oai21  g088(.a(new_n143_), .b(new_n82_), .c(x32), .O(new_n144_));
  nand2  g089(.a(new_n124_), .b(new_n112_), .O(new_n145_));
  inv1   g090(.a(x31), .O(new_n146_));
  inv1   g091(.a(x32), .O(new_n147_));
  nand4  g092(.a(new_n147_), .b(new_n146_), .c(new_n110_), .d(new_n90_), .O(new_n148_));
  nor2   g093(.a(new_n148_), .b(new_n145_), .O(new_n149_));
  nand2  g094(.a(new_n149_), .b(new_n83_), .O(new_n150_));
  nand2  g095(.a(new_n150_), .b(new_n144_), .O(new_n151_));
  ...
  nor2   g100(.a(x21), .b(x20), .O(new_n157_));
  nand4  g101(.a(new_n111_), .b(new_n98_), .c(new_n157_), .d(new_n55_), .O(new_n158_));
  nor2   g102(.a(x33), .b(x32), .O(new_n159_));
  nand4  g103(.a(new_n159_), .b(new_n134_), .c(new_n133_), .d(new_n102_), .O(new_n160_));
  oai21  g104(.a(new_n160_), .b(new_n158_), .c(x34), .O(new_n161_));
  nand2  g105(.a(new_n133_), .b(new_n102_), .O(new_n162_));
  inv1   g106(.a(new_n162_), .O(new_n163_));
  inv1   g107(.a(x30), .O(new_n164_));
  nand2  g108(.a(new_n146_), .b(new_n164_), .O(new_n165_));
  inv1   g109(.a(x33), .O(new_n166_));
  inv1   g110(.a(x34), .O(new_n167_));
  nand3  g111(.a(new_n167_), .b(new_n166_), .c(new_n147_), .O(new_n168_));
  nor2   g112(.a(new_n168_), .b(new_n165_), .O(new_n169_));
  nand3  g113(.a(new_n169_), .b(new_n163_), .c(new_n92_), .O(new_n170_));
