...
module FAU ( 
  ...
  nand4  g039(.a(new_n92_), .b(new_n91_), .c(new_n90_), .d(new_n55_), .O(new_n93_));
  ...
  nand2  g045(.a(new_n93_), .b(x26), .O(new_n99_));
  nor3   g046(.a(x26), .b(x25), .c(x24), .O(new_n100_));
  nand3  g047(.a(new_n100_), .b(new_n91_), .c(new_n66_), .O(new_n101_));
  ...
  nand3  g054(.a(new_n107_), .b(new_n82_), .c(new_n89_), .O(new_n108_));
  ...
  nand4  g061(.a(new_n114_), .b(new_n82_), .c(new_n73_), .d(new_n72_), .O(new_n115_));
  inv1   g062(.a(x23), .O(new_n116_));
  inv1   g063(.a(x26), .O(new_n117_));
  nor2   g064(.a(x28), .b(x27), .O(new_n118_));
  nand4  g065(.a(new_n118_), .b(new_n92_), .c(new_n117_), .d(new_n116_), .O(new_n119_));
  ...
  nand4  g073(.a(new_n126_), .b(new_n100_), .c(new_n75_), .d(new_n72_), .O(new_n127_));
  ...
  nand4  g079(.a(new_n91_), .b(new_n55_), .c(new_n64_), .d(new_n62_), .O(new_n133_));
  nor2   g080(.a(x30), .b(x29), .O(new_n134_));
  nand4  g081(.a(new_n134_), .b(new_n118_), .c(new_n92_), .d(new_n117_), .O(new_n135_));
  nor2   g082(.a(new_n135_), .b(new_n133_), .O(new_n136_));
  aoi21  g083(.a(new_n127_), .b(x30), .c(new_n136_), .O(new_n137_));
  ...
  oai21  g087(.a(new_n135_), .b(new_n133_), .c(x31), .O(new_n141_));
  inv1   g088(.a(new_n83_), .O(new_n142_));
  ...
  nand4  g093(.a(new_n146_), .b(new_n114_), .c(new_n142_), .d(new_n72_), .O(new_n147_));
  ...
  nand4  g100(.a(new_n155_), .b(new_n144_), .c(new_n143_), .d(new_n107_), .O(new_n156_));
  oai21  g101(.a(new_n156_), .b(new_n93_), .c(x34), .O(new_n157_));
  inv1   g102(.a(x22), .O(new_n158_));
  nand4  g103(.a(new_n89_), .b(new_n80_), .c(new_n116_), .d(new_n158_), .O(new_n159_));
  nor2   g104(.a(new_n159_), .b(new_n65_), .O(new_n160_));
  nand2  g105(.a(new_n143_), .b(new_n107_), .O(new_n161_));
  ...
  nand3  g115(.a(new_n170_), .b(new_n162_), .c(new_n160_), .O(new_n171_));
  nand2  g116(.a(new_n171_), .b(new_n157_), .O(new_n172_));
