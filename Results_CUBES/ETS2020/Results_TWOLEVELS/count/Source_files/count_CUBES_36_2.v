...
module FAU ( 
  ...
  nand4  g054(.a(new_n108_), .b(new_n81_), .c(new_n68_), .d(new_n67_), .O(new_n109_));
  ...
  nand4  g066(.a(new_n120_), .b(new_n99_), .c(new_n74_), .d(new_n67_), .O(new_n121_));
  ...
  nand4  g072(.a(new_n98_), .b(new_n56_), .c(new_n60_), .d(new_n55_), .O(new_n128_));
  ...
  nand3  g081(.a(new_n136_), .b(new_n108_), .c(new_n83_), .O(new_n137_));
  ...
  nand4  g087(.a(new_n134_), .b(new_n133_), .c(new_n101_), .d(new_n90_), .O(new_n143_));
  ...
  nand4  g101(.a(new_n111_), .b(new_n98_), .c(new_n157_), .d(new_n56_), .O(new_n158_));
  nor2   g102(.a(x33), .b(x32), .O(new_n159_));
  nand4  g103(.a(new_n159_), .b(new_n134_), .c(new_n133_), .d(new_n101_), .O(new_n160_));
  oai21  g104(.a(new_n160_), .b(new_n158_), .c(x34), .O(new_n161_));
  nand2  g105(.a(new_n133_), .b(new_n101_), .O(new_n162_));
