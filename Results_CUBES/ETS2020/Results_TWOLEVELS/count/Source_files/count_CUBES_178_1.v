...
module FAU ( 
  ...
  nand4  g077(.a(new_n98_), .b(new_n54_), .c(new_n65_), .d(new_n53_), .O(new_n132_));
  ...
  nand4  g093(.a(new_n148_), .b(new_n134_), .c(new_n116_), .d(new_n133_), .O(new_n149_));
  oai21  g094(.a(new_n149_), .b(new_n81_), .c(x33), .O(new_n150_));
  ...
  nand4  g104(.a(new_n115_), .b(new_n98_), .c(new_n97_), .d(new_n54_), .O(new_n160_));
  oai21  g105(.a(new_n152_), .b(new_n160_), .c(x34), .O(new_n161_));
  nand2  g106(.a(new_n137_), .b(new_n106_), .O(new_n162_));
