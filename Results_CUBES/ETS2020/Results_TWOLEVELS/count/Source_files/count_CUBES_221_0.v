...
module FAU ( 
  ...
  nor3   g072(.a(x23), .b(x22), .c(x21), .O(new_n126_));
  nor3   g073(.a(x29), .b(x28), .c(x27), .O(new_n127_));
  nand4  g074(.a(new_n127_), .b(new_n126_), .c(new_n100_), .d(new_n63_), .O(new_n128_));
  oai21  g075(.a(new_n120_), .b(new_n125_), .c(new_n128_), .O(new_n129_));
  ...
  nand4  g080(.a(new_n96_), .b(new_n55_), .c(new_n69_), .d(new_n61_), .O(new_n134_));
  nor2   g081(.a(x26), .b(x25), .O(new_n135_));
  nor2   g082(.a(x30), .b(x29), .O(new_n136_));
  nand4  g083(.a(new_n136_), .b(new_n117_), .c(new_n135_), .d(new_n87_), .O(new_n137_));
  ...
  nand4  g091(.a(new_n145_), .b(new_n144_), .c(new_n108_), .d(new_n88_), .O(new_n146_));
  oai21  g092(.a(new_n146_), .b(new_n84_), .c(x32), .O(new_n147_));
  inv1   g093(.a(new_n84_), .O(new_n148_));
  nor2   g094(.a(x32), .b(x31), .O(new_n149_));
  nand4  g095(.a(new_n149_), .b(new_n136_), .c(new_n117_), .d(new_n135_), .O(new_n150_));
  inv1   g096(.a(new_n150_), .O(new_n151_));
  nand2  g097(.a(new_n151_), .b(new_n148_), .O(new_n152_));
  nand2  g098(.a(new_n152_), .b(new_n147_), .O(new_n153_));
  ...
  oai21  g103(.a(new_n150_), .b(new_n84_), .c(x33), .O(new_n158_));
  nor2   g104(.a(x33), .b(x32), .O(new_n159_));
  nand4  g105(.a(new_n159_), .b(new_n145_), .c(new_n144_), .d(new_n108_), .O(new_n160_));
  ...
  oai21  g113(.a(new_n160_), .b(new_n98_), .c(x34), .O(new_n168_));
  nand2  g114(.a(new_n144_), .b(new_n108_), .O(new_n169_));
  ...
  nand3  g124(.a(new_n178_), .b(new_n170_), .c(new_n90_), .O(new_n179_));
