...
module FAU ( 
  ...
  nand3  g096(.a(new_n148_), .b(new_n116_), .c(new_n91_), .O(new_n149_));
  ...
  nand4  g106(.a(new_n159_), .b(new_n146_), .c(new_n145_), .d(new_n109_), .O(new_n160_));
  inv1   g107(.a(new_n160_), .O(new_n161_));
  nand2  g108(.a(new_n161_), .b(new_n100_), .O(new_n162_));
  ...
  nand4  g115(.a(new_n118_), .b(new_n106_), .c(new_n168_), .d(new_n55_), .O(new_n169_));
  oai21  g116(.a(new_n160_), .b(new_n169_), .c(x34), .O(new_n170_));
  nand2  g117(.a(new_n145_), .b(new_n109_), .O(new_n171_));
