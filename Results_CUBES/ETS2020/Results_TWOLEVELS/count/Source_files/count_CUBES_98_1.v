...
module FAU ( 
  ...
  nand4  g054(.a(new_n85_), .b(new_n107_), .c(new_n106_), .d(new_n95_), .O(new_n108_));
  ...
  nand4  g064(.a(new_n117_), .b(new_n116_), .c(new_n106_), .d(new_n94_), .O(new_n118_));
  ...
  nand4  g078(.a(new_n98_), .b(new_n55_), .c(new_n65_), .d(new_n64_), .O(new_n133_));
  nor2   g079(.a(x26), .b(x25), .O(new_n134_));
  nor2   g080(.a(x30), .b(x29), .O(new_n135_));
  nand4  g081(.a(new_n135_), .b(new_n117_), .c(new_n134_), .d(new_n83_), .O(new_n136_));
  oai21  g082(.a(new_n136_), .b(new_n133_), .c(x31), .O(new_n137_));
  nand4  g083(.a(new_n83_), .b(new_n94_), .c(new_n93_), .d(new_n65_), .O(new_n138_));
  ...
  nand4  g098(.a(new_n153_), .b(new_n135_), .c(new_n117_), .d(new_n134_), .O(new_n154_));
  oai21  g099(.a(new_n154_), .b(new_n86_), .c(x33), .O(new_n155_));
  inv1   g100(.a(new_n96_), .O(new_n156_));
  inv1   g101(.a(x32), .O(new_n157_));
  inv1   g102(.a(x33), .O(new_n158_));
  nand4  g103(.a(new_n158_), .b(new_n157_), .c(new_n107_), .d(new_n106_), .O(new_n159_));
  inv1   g104(.a(new_n159_), .O(new_n160_));
  nand4  g105(.a(new_n160_), .b(new_n145_), .c(new_n156_), .d(new_n67_), .O(new_n161_));
  nand2  g106(.a(new_n161_), .b(new_n155_), .O(new_n162_));
