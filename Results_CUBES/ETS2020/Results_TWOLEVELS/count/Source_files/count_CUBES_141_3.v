...
module FAU ( 
  ...
  inv1   g068(.a(x26), .O(new_n122_));
  nor2   g069(.a(x28), .b(x27), .O(new_n123_));
  nand4  g070(.a(new_n123_), .b(new_n103_), .c(new_n122_), .d(new_n93_), .O(new_n124_));
  oai21  g071(.a(new_n124_), .b(new_n113_), .c(x29), .O(new_n125_));
  nor3   g072(.a(x29), .b(x28), .c(x27), .O(new_n126_));
  nand4  g073(.a(new_n126_), .b(new_n106_), .c(new_n83_), .d(new_n63_), .O(new_n127_));
  ...
  nand4  g079(.a(new_n102_), .b(new_n55_), .c(new_n69_), .d(new_n61_), .O(new_n133_));
  nor2   g080(.a(x26), .b(x25), .O(new_n134_));
  nor2   g081(.a(x30), .b(x29), .O(new_n135_));
  nand4  g082(.a(new_n135_), .b(new_n123_), .c(new_n134_), .d(new_n82_), .O(new_n136_));
  ...
  nor3   g089(.a(x27), .b(x26), .c(x25), .O(new_n143_));
  nor2   g090(.a(x29), .b(x28), .O(new_n144_));
  nor2   g091(.a(x31), .b(x30), .O(new_n145_));
  nand2  g092(.a(new_n145_), .b(new_n144_), .O(new_n146_));
  inv1   g093(.a(new_n146_), .O(new_n147_));
  nand3  g094(.a(new_n147_), .b(new_n143_), .c(new_n87_), .O(new_n148_));
  nand2  g095(.a(new_n148_), .b(new_n142_), .O(new_n149_));
  ...
  nand4  g100(.a(new_n145_), .b(new_n144_), .c(new_n114_), .d(new_n94_), .O(new_n154_));
  oai21  g101(.a(new_n154_), .b(new_n86_), .c(x32), .O(new_n155_));
  nand2  g102(.a(new_n135_), .b(new_n123_), .O(new_n156_));
  inv1   g103(.a(x31), .O(new_n157_));
  inv1   g104(.a(x32), .O(new_n158_));
  nand4  g105(.a(new_n158_), .b(new_n157_), .c(new_n122_), .d(new_n94_), .O(new_n159_));
  nor2   g106(.a(new_n159_), .b(new_n156_), .O(new_n160_));
  nand2  g107(.a(new_n160_), .b(new_n87_), .O(new_n161_));
  ...
  nand4  g114(.a(new_n168_), .b(new_n145_), .c(new_n144_), .d(new_n114_), .O(new_n169_));
  oai21  g115(.a(new_n169_), .b(new_n104_), .c(x34), .O(new_n170_));
  nand2  g116(.a(new_n144_), .b(new_n114_), .O(new_n171_));
  inv1   g117(.a(new_n171_), .O(new_n172_));
  inv1   g118(.a(x30), .O(new_n173_));
  nand2  g119(.a(new_n157_), .b(new_n173_), .O(new_n174_));
  inv1   g120(.a(x33), .O(new_n175_));
  inv1   g121(.a(x34), .O(new_n176_));
  nand3  g122(.a(new_n176_), .b(new_n175_), .c(new_n158_), .O(new_n177_));
  nor2   g123(.a(new_n177_), .b(new_n174_), .O(new_n178_));
  nand3  g124(.a(new_n178_), .b(new_n172_), .c(new_n96_), .O(new_n179_));
