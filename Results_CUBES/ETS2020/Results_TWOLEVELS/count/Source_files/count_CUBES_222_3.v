...
module FAU ( 
  ...
  nand3  g057(.a(new_n76_), .b(new_n55_), .c(new_n61_), .O(new_n112_));
  inv1   g058(.a(x26), .O(new_n113_));
  nor2   g059(.a(x25), .b(x24), .O(new_n114_));
  nor2   g060(.a(x28), .b(x27), .O(new_n115_));
  nand4  g061(.a(new_n115_), .b(new_n114_), .c(new_n113_), .d(new_n93_), .O(new_n116_));
  oai21  g062(.a(new_n116_), .b(new_n112_), .c(x29), .O(new_n117_));
  nor3   g063(.a(x29), .b(x28), .c(x27), .O(new_n118_));
  nand4  g064(.a(new_n118_), .b(new_n103_), .c(new_n83_), .d(new_n63_), .O(new_n119_));
  ...
  nand4  g073(.a(new_n127_), .b(new_n115_), .c(new_n126_), .d(new_n82_), .O(new_n128_));
  ...
  nand4  g080(.a(new_n82_), .b(new_n93_), .c(new_n92_), .d(new_n69_), .O(new_n135_));
  inv1   g081(.a(new_n135_), .O(new_n136_));
  nor3   g082(.a(x29), .b(x28), .c(x25), .O(new_n137_));
  inv1   g083(.a(x27), .O(new_n138_));
  inv1   g084(.a(x30), .O(new_n139_));
  inv1   g085(.a(x31), .O(new_n140_));
  nand4  g086(.a(new_n140_), .b(new_n139_), .c(new_n138_), .d(new_n113_), .O(new_n141_));
  inv1   g087(.a(new_n141_), .O(new_n142_));
  nand4  g088(.a(new_n142_), .b(new_n137_), .c(new_n136_), .d(new_n63_), .O(new_n143_));
  nand2  g089(.a(new_n143_), .b(new_n134_), .O(new_n144_));
  ...
  nor2   g095(.a(x27), .b(x26), .O(new_n150_));
  nor2   g096(.a(x31), .b(x30), .O(new_n151_));
  nand4  g097(.a(new_n151_), .b(new_n150_), .c(new_n149_), .d(new_n94_), .O(new_n152_));
  oai21  g098(.a(new_n152_), .b(new_n86_), .c(x32), .O(new_n153_));
  inv1   g099(.a(x28), .O(new_n154_));
  inv1   g100(.a(x29), .O(new_n155_));
  nand4  g101(.a(new_n139_), .b(new_n155_), .c(new_n154_), .d(new_n138_), .O(new_n156_));
  inv1   g102(.a(new_n156_), .O(new_n157_));
  inv1   g103(.a(x32), .O(new_n158_));
  nand4  g104(.a(new_n158_), .b(new_n140_), .c(new_n113_), .d(new_n94_), .O(new_n159_));
  inv1   g105(.a(new_n159_), .O(new_n160_));
  nand4  g106(.a(new_n160_), .b(new_n157_), .c(new_n136_), .d(new_n63_), .O(new_n161_));
  nand2  g107(.a(new_n161_), .b(new_n153_), .O(new_n162_));
  ...
  nand4  g113(.a(new_n167_), .b(new_n127_), .c(new_n115_), .d(new_n126_), .O(new_n168_));
  oai21  g114(.a(new_n168_), .b(new_n86_), .c(x33), .O(new_n169_));
  inv1   g115(.a(x33), .O(new_n170_));
  nand4  g116(.a(new_n170_), .b(new_n158_), .c(new_n155_), .d(new_n154_), .O(new_n171_));
  inv1   g117(.a(new_n171_), .O(new_n172_));
  nand4  g118(.a(new_n172_), .b(new_n142_), .c(new_n96_), .d(new_n71_), .O(new_n173_));
