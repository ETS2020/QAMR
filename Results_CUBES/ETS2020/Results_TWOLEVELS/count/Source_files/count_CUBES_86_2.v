...
module FAU ( 
  ...
  nand4  g083(.a(new_n138_), .b(new_n137_), .c(new_n110_), .d(new_n91_), .O(new_n139_));
  oai21  g084(.a(new_n139_), .b(new_n83_), .c(x32), .O(new_n140_));
  nor2   g085(.a(x26), .b(x25), .O(new_n141_));
  nor2   g086(.a(x30), .b(x29), .O(new_n142_));
  nor2   g087(.a(x32), .b(x31), .O(new_n143_));
  nand4  g088(.a(new_n143_), .b(new_n142_), .c(new_n119_), .d(new_n141_), .O(new_n144_));
  inv1   g089(.a(new_n144_), .O(new_n145_));
  nand2  g090(.a(new_n145_), .b(new_n84_), .O(new_n146_));
  nand2  g091(.a(new_n146_), .b(new_n140_), .O(new_n147_));
  ...
  oai21  g096(.a(new_n144_), .b(new_n83_), .c(x33), .O(new_n152_));
  nor2   g097(.a(x33), .b(x32), .O(new_n153_));
  nand4  g098(.a(new_n153_), .b(new_n138_), .c(new_n137_), .d(new_n110_), .O(new_n154_));
  inv1   g099(.a(new_n154_), .O(new_n155_));
  nand2  g100(.a(new_n155_), .b(new_n93_), .O(new_n156_));
  ...
  oai21  g106(.a(new_n154_), .b(new_n101_), .c(x34), .O(new_n162_));
  nand2  g107(.a(new_n137_), .b(new_n110_), .O(new_n163_));
  ...
  nand3  g117(.a(new_n172_), .b(new_n164_), .c(new_n93_), .O(new_n173_));
