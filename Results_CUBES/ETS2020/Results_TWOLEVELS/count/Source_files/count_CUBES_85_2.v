...
module FAU ( 
  ...
  nand3  g041(.a(new_n95_), .b(new_n91_), .c(new_n71_), .O(new_n96_));
  ...
  nand3  g047(.a(new_n81_), .b(new_n55_), .c(new_n61_), .O(new_n102_));
  inv1   g048(.a(x25), .O(new_n103_));
  nor2   g049(.a(x27), .b(x26), .O(new_n104_));
  nand3  g050(.a(new_n104_), .b(new_n82_), .c(new_n103_), .O(new_n105_));
  nor2   g051(.a(new_n105_), .b(new_n102_), .O(new_n106_));
  aoi21  g052(.a(new_n96_), .b(x27), .c(new_n106_), .O(new_n107_));
  ...
  nor2   g057(.a(x26), .b(x23), .O(new_n113_));
  nand3  g058(.a(new_n113_), .b(new_n112_), .c(new_n92_), .O(new_n114_));
  oai21  g059(.a(new_n114_), .b(new_n102_), .c(x29), .O(new_n115_));
  nor3   g060(.a(x29), .b(x28), .c(x27), .O(new_n116_));
  nand4  g061(.a(new_n116_), .b(new_n95_), .c(new_n79_), .d(new_n63_), .O(new_n117_));
  ...
  nand4  g070(.a(new_n125_), .b(new_n112_), .c(new_n124_), .d(new_n78_), .O(new_n126_));
  ...
  nand4  g078(.a(new_n134_), .b(new_n133_), .c(new_n104_), .d(new_n103_), .O(new_n135_));
  ...
  nand4  g092(.a(new_n103_), .b(new_n78_), .c(new_n148_), .d(new_n147_), .O(new_n149_));
  nor2   g093(.a(new_n149_), .b(new_n70_), .O(new_n150_));
  nor2   g094(.a(x33), .b(x32), .O(new_n151_));
  nand4  g095(.a(new_n151_), .b(new_n134_), .c(new_n133_), .d(new_n104_), .O(new_n152_));
  ...
  oai21  g103(.a(new_n152_), .b(new_n93_), .c(x34), .O(new_n160_));
  nand2  g104(.a(new_n133_), .b(new_n104_), .O(new_n161_));
  ...
  nand3  g114(.a(new_n170_), .b(new_n162_), .c(new_n150_), .O(new_n171_));
