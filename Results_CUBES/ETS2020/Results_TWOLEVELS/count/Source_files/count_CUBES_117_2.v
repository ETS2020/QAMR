...
module FAU ( 
  ...
  nand4  g063(.a(new_n117_), .b(new_n96_), .c(new_n116_), .d(new_n86_), .O(new_n118_));
  ...
  nand4  g080(.a(new_n134_), .b(new_n117_), .c(new_n133_), .d(new_n73_), .O(new_n135_));
  ...
  nand2  g099(.a(new_n134_), .b(new_n117_), .O(new_n154_));
  inv1   g100(.a(x31), .O(new_n155_));
  inv1   g101(.a(x32), .O(new_n156_));
  nand4  g102(.a(new_n156_), .b(new_n155_), .c(new_n116_), .d(new_n87_), .O(new_n157_));
  nor2   g103(.a(new_n157_), .b(new_n154_), .O(new_n158_));
  nand2  g104(.a(new_n158_), .b(new_n80_), .O(new_n159_));
  ...
  nor2   g110(.a(x33), .b(x32), .O(new_n166_));
  nand4  g111(.a(new_n166_), .b(new_n143_), .c(new_n142_), .d(new_n107_), .O(new_n167_));
  oai21  g112(.a(new_n167_), .b(new_n97_), .c(x34), .O(new_n168_));
  nand2  g113(.a(new_n142_), .b(new_n107_), .O(new_n169_));
  inv1   g114(.a(new_n169_), .O(new_n170_));
  inv1   g115(.a(x30), .O(new_n171_));
  nand2  g116(.a(new_n155_), .b(new_n171_), .O(new_n172_));
  inv1   g117(.a(x33), .O(new_n173_));
  inv1   g118(.a(x34), .O(new_n174_));
  nand3  g119(.a(new_n174_), .b(new_n173_), .c(new_n156_), .O(new_n175_));
  nor2   g120(.a(new_n175_), .b(new_n172_), .O(new_n176_));
  nand3  g121(.a(new_n176_), .b(new_n170_), .c(new_n89_), .O(new_n177_));
  nand2  g122(.a(new_n177_), .b(new_n168_), .O(new_n178_));
