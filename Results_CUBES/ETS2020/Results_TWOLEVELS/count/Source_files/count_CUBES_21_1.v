...
module FAU ( 
  ...
  nor3   g076(.a(x29), .b(x28), .c(x27), .O(new_n130_));
  nand4  g077(.a(new_n130_), .b(new_n105_), .c(new_n82_), .d(new_n63_), .O(new_n131_));
  nand4  g078(.a(new_n101_), .b(new_n55_), .c(new_n69_), .d(new_n61_), .O(new_n132_));
  nor2   g079(.a(x26), .b(x25), .O(new_n133_));
  nor2   g080(.a(x30), .b(x29), .O(new_n134_));
  nand4  g081(.a(new_n134_), .b(new_n121_), .c(new_n133_), .d(new_n92_), .O(new_n135_));
  nor2   g082(.a(new_n135_), .b(new_n132_), .O(new_n136_));
  aoi21  g083(.a(new_n131_), .b(x30), .c(new_n136_), .O(new_n137_));
  ...
  nand2  g088(.a(new_n88_), .b(new_n76_), .O(new_n142_));
  ...
  nand4  g094(.a(new_n147_), .b(new_n119_), .c(new_n143_), .d(new_n63_), .O(new_n148_));
  nand2  g095(.a(new_n148_), .b(new_n141_), .O(new_n149_));
  ...
  nand4  g101(.a(new_n155_), .b(new_n134_), .c(new_n121_), .d(new_n133_), .O(new_n156_));
  oai21  g102(.a(new_n156_), .b(new_n89_), .c(x33), .O(new_n157_));
  nor2   g103(.a(x33), .b(x32), .O(new_n158_));
  nand4  g104(.a(new_n158_), .b(new_n145_), .c(new_n144_), .d(new_n112_), .O(new_n159_));
  inv1   g105(.a(new_n159_), .O(new_n160_));
  nand2  g106(.a(new_n160_), .b(new_n95_), .O(new_n161_));
  ...
  oai21  g112(.a(new_n159_), .b(new_n103_), .c(x34), .O(new_n167_));
  nand2  g113(.a(new_n144_), .b(new_n112_), .O(new_n168_));
  ...
  nand3  g123(.a(new_n177_), .b(new_n169_), .c(new_n95_), .O(new_n178_));
