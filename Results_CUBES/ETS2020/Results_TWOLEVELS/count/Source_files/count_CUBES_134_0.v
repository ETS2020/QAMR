// Benchmark "FAU" written by ABC on Tue Jul  7 19:19:14 2020
...
module FAU ( 
  ...
  nand4  g055(.a(new_n107_), .b(new_n103_), .c(new_n71_), .d(new_n84_), .O(new_n108_));
  ...
  nand4  g080(.a(new_n135_), .b(new_n134_), .c(new_n114_), .d(new_n95_), .O(new_n136_));
  oai21  g081(.a(new_n136_), .b(new_n87_), .c(x32), .O(new_n137_));
  inv1   g082(.a(x29), .O(new_n138_));
  inv1   g083(.a(x30), .O(new_n139_));
  ...
  nand2  g087(.a(new_n123_), .b(new_n107_), .O(new_n143_));
  nor2   g088(.a(new_n143_), .b(new_n142_), .O(new_n144_));
  ...
  nand4  g096(.a(new_n152_), .b(new_n135_), .c(new_n134_), .d(new_n114_), .O(new_n153_));
  oai21  g097(.a(new_n153_), .b(new_n105_), .c(x34), .O(new_n154_));
  nand2  g098(.a(new_n134_), .b(new_n114_), .O(new_n155_));
  inv1   g099(.a(new_n155_), .O(new_n156_));
  nand2  g100(.a(new_n140_), .b(new_n139_), .O(new_n157_));
  inv1   g101(.a(x33), .O(new_n158_));
  inv1   g102(.a(x34), .O(new_n159_));
  nand3  g103(.a(new_n159_), .b(new_n158_), .c(new_n141_), .O(new_n160_));
  nor2   g104(.a(new_n160_), .b(new_n157_), .O(new_n161_));
  nand3  g105(.a(new_n161_), .b(new_n156_), .c(new_n97_), .O(new_n162_));
  nand2  g106(.a(new_n162_), .b(new_n154_), .O(new_n163_));
