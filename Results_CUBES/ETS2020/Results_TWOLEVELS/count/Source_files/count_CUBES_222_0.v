...
module FAU ( 
  ...
  nand2  g104(.a(new_n137_), .b(new_n120_), .O(new_n157_));
  inv1   g105(.a(x31), .O(new_n158_));
  inv1   g106(.a(x32), .O(new_n159_));
  nand4  g107(.a(new_n159_), .b(new_n158_), .c(new_n100_), .d(new_n93_), .O(new_n160_));
  nor2   g108(.a(new_n160_), .b(new_n157_), .O(new_n161_));
  nand2  g109(.a(new_n161_), .b(new_n86_), .O(new_n162_));
  nand2  g110(.a(new_n162_), .b(new_n156_), .O(new_n163_));
  ...
  nand4  g115(.a(new_n119_), .b(new_n102_), .c(new_n101_), .d(new_n55_), .O(new_n169_));
  nor2   g116(.a(x33), .b(x32), .O(new_n170_));
  nand4  g117(.a(new_n170_), .b(new_n146_), .c(new_n145_), .d(new_n110_), .O(new_n171_));
  oai21  g118(.a(new_n171_), .b(new_n169_), .c(x34), .O(new_n172_));
  nand2  g119(.a(new_n145_), .b(new_n110_), .O(new_n173_));
  inv1   g120(.a(new_n173_), .O(new_n174_));
  inv1   g121(.a(x30), .O(new_n175_));
  nand2  g122(.a(new_n158_), .b(new_n175_), .O(new_n176_));
  inv1   g123(.a(x33), .O(new_n177_));
  inv1   g124(.a(x34), .O(new_n178_));
  nand3  g125(.a(new_n178_), .b(new_n177_), .c(new_n159_), .O(new_n179_));
  nor2   g126(.a(new_n179_), .b(new_n176_), .O(new_n180_));
  nand3  g127(.a(new_n180_), .b(new_n174_), .c(new_n95_), .O(new_n181_));
  nand2  g128(.a(new_n181_), .b(new_n172_), .O(new_n182_));
  nand2  g129(.a(new_n182_), .b(x16), .O(new_n183_));
  inv1   g130(.a(x00), .O(new_n184_));
  aoi21  g131(.a(new_n58_), .b(new_n184_), .c(x18), .O(new_n185_));
  nand2  g132(.a(new_n185_), .b(new_n183_), .O(z15));
  zero   g133(.O(z02));
  zero   g134(.O(z14));
endmodule
