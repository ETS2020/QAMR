...
module FAU ( 
  ...
  nand4  g100(.a(new_n154_), .b(new_n133_), .c(new_n115_), .d(new_n132_), .O(new_n155_));
  oai21  g101(.a(new_n155_), .b(new_n89_), .c(x33), .O(new_n156_));
  nor2   g102(.a(x27), .b(x26), .O(new_n157_));
  nor2   g103(.a(x33), .b(x32), .O(new_n158_));
  nand4  g104(.a(new_n158_), .b(new_n144_), .c(new_n143_), .d(new_n157_), .O(new_n159_));
  inv1   g105(.a(new_n159_), .O(new_n160_));
  nand2  g106(.a(new_n160_), .b(new_n95_), .O(new_n161_));
  nand2  g107(.a(new_n161_), .b(new_n156_), .O(new_n162_));
  ...
  nand2  g113(.a(new_n143_), .b(new_n157_), .O(new_n168_));
