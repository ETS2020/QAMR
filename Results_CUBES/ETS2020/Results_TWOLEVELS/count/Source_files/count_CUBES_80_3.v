...
module FAU ( 
  ...
  nand4  g059(.a(new_n85_), .b(new_n111_), .c(new_n110_), .d(new_n94_), .O(new_n112_));
  nor2   g060(.a(new_n112_), .b(new_n77_), .O(new_n113_));
  aoi21  g061(.a(new_n104_), .b(x27), .c(new_n113_), .O(new_n114_));
  inv1   g062(.a(x07), .O(new_n115_));
  aoi21  g063(.a(new_n59_), .b(new_n115_), .c(x18), .O(new_n116_));
  oai21  g064(.a(new_n114_), .b(new_n59_), .c(new_n116_), .O(z08));
  nor2   g065(.a(x25), .b(x24), .O(new_n119_));
  nor2   g066(.a(x28), .b(x27), .O(new_n120_));
  nand4  g067(.a(new_n120_), .b(new_n119_), .c(new_n110_), .d(new_n93_), .O(new_n121_));
  ...
  nand4  g086(.a(new_n141_), .b(new_n132_), .c(new_n120_), .d(new_n131_), .O(new_n142_));
  oai21  g087(.a(new_n142_), .b(new_n86_), .c(x33), .O(new_n143_));
  inv1   g088(.a(x30), .O(new_n144_));
  ...
  inv1   g094(.a(x28), .O(new_n150_));
  inv1   g095(.a(x29), .O(new_n151_));
  nand4  g096(.a(new_n151_), .b(new_n150_), .c(new_n111_), .d(new_n110_), .O(new_n152_));
  inv1   g097(.a(new_n152_), .O(new_n153_));
  nand4  g098(.a(new_n153_), .b(new_n149_), .c(new_n96_), .d(new_n67_), .O(new_n154_));
  nand2  g099(.a(new_n154_), .b(new_n143_), .O(new_n155_));
