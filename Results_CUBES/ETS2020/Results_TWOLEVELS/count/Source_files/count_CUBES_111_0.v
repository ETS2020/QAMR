...
module FAU ( 
  ...
  nand4  g025(.a(new_n79_), .b(new_n66_), .c(new_n55_), .d(new_n63_), .O(new_n80_));
  ...
  nand4  g054(.a(new_n108_), .b(new_n79_), .c(new_n67_), .d(new_n66_), .O(new_n109_));
  ...
  nand4  g065(.a(new_n119_), .b(new_n94_), .c(new_n73_), .d(new_n67_), .O(new_n120_));
  ...
  nand4  g071(.a(new_n93_), .b(new_n55_), .c(new_n64_), .d(new_n63_), .O(new_n126_));
  ...
  nand2  g081(.a(new_n79_), .b(new_n66_), .O(new_n136_));
  ...
  nand4  g087(.a(new_n141_), .b(new_n108_), .c(new_n137_), .d(new_n67_), .O(new_n142_));
  ...
  nand4  g100(.a(new_n154_), .b(new_n151_), .c(new_n137_), .d(new_n67_), .O(new_n155_));
  ...
  nand4  g117(.a(new_n110_), .b(new_n93_), .c(new_n92_), .d(new_n55_), .O(new_n172_));
