...
module FAU ( 
  ...
  nand3  g046(.a(new_n71_), .b(new_n55_), .c(new_n61_), .O(new_n101_));
  nor2   g047(.a(x27), .b(x26), .O(new_n102_));
  nand3  g048(.a(new_n102_), .b(new_n80_), .c(new_n89_), .O(new_n103_));
  ...
  nand4  g060(.a(new_n115_), .b(new_n99_), .c(new_n78_), .d(new_n63_), .O(new_n116_));
  ...
  nand4  g066(.a(new_n98_), .b(new_n55_), .c(new_n69_), .d(new_n61_), .O(new_n122_));
  nor2   g067(.a(x26), .b(x25), .O(new_n123_));
  nor2   g068(.a(x30), .b(x29), .O(new_n124_));
  nand4  g069(.a(new_n124_), .b(new_n111_), .c(new_n123_), .d(new_n77_), .O(new_n125_));
  ...
  nand3  g081(.a(new_n136_), .b(new_n132_), .c(new_n82_), .O(new_n137_));
  ...
  nand4  g087(.a(new_n134_), .b(new_n133_), .c(new_n102_), .d(new_n89_), .O(new_n143_));
  ...
  nand2  g092(.a(new_n147_), .b(new_n82_), .O(new_n148_));
  ...
  oai21  g098(.a(new_n146_), .b(new_n81_), .c(x33), .O(new_n154_));
  ...
  nand2  g102(.a(new_n157_), .b(new_n91_), .O(new_n158_));
  ...
  nand4  g108(.a(new_n110_), .b(new_n98_), .c(new_n97_), .d(new_n55_), .O(new_n164_));
  ...
  nand3  g120(.a(new_n175_), .b(new_n167_), .c(new_n91_), .O(new_n176_));
