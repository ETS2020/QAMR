...
module FAU ( 
  ...
  nand4  g070(.a(new_n124_), .b(new_n98_), .c(new_n78_), .d(new_n56_), .O(new_n125_));
  nand4  g071(.a(new_n94_), .b(new_n54_), .c(new_n65_), .d(new_n53_), .O(new_n126_));
  nor2   g072(.a(x26), .b(x25), .O(new_n127_));
  nor2   g073(.a(x30), .b(x29), .O(new_n128_));
  nand4  g074(.a(new_n128_), .b(new_n115_), .c(new_n127_), .d(new_n83_), .O(new_n129_));
  nor2   g075(.a(new_n129_), .b(new_n126_), .O(new_n130_));
  aoi21  g076(.a(new_n125_), .b(x30), .c(new_n130_), .O(new_n131_));
  ...
  nand3  g085(.a(new_n139_), .b(new_n113_), .c(new_n87_), .O(new_n140_));
  ...
  nand4  g091(.a(new_n137_), .b(new_n136_), .c(new_n106_), .d(new_n105_), .O(new_n146_));
  oai21  g092(.a(new_n146_), .b(new_n86_), .c(x32), .O(new_n147_));
  nor2   g093(.a(x32), .b(x31), .O(new_n148_));
  nand4  g094(.a(new_n148_), .b(new_n128_), .c(new_n115_), .d(new_n127_), .O(new_n149_));
  ...
  inv1   g103(.a(x22), .O(new_n158_));
  inv1   g104(.a(x23), .O(new_n159_));
  nand4  g105(.a(new_n105_), .b(new_n83_), .c(new_n159_), .d(new_n158_), .O(new_n160_));
  nor2   g106(.a(new_n160_), .b(new_n66_), .O(new_n161_));
  nor2   g107(.a(x33), .b(x32), .O(new_n162_));
  nand4  g108(.a(new_n162_), .b(new_n137_), .c(new_n136_), .d(new_n106_), .O(new_n163_));
  inv1   g109(.a(new_n163_), .O(new_n164_));
  nand2  g110(.a(new_n164_), .b(new_n161_), .O(new_n165_));
  nand2  g111(.a(new_n165_), .b(new_n157_), .O(new_n166_));
  ...
  oai21  g116(.a(new_n163_), .b(new_n96_), .c(x34), .O(new_n171_));
  nand2  g117(.a(new_n136_), .b(new_n106_), .O(new_n172_));
  ...
  nand3  g127(.a(new_n181_), .b(new_n173_), .c(new_n161_), .O(new_n182_));
