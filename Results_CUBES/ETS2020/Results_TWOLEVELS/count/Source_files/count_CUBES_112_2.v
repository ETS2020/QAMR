...
module FAU ( 
  ...
  oai21  g100(.a(new_n154_), .b(new_n87_), .c(x33), .O(new_n155_));
  inv1   g101(.a(x22), .O(new_n156_));
  inv1   g102(.a(x23), .O(new_n157_));
  nand4  g103(.a(new_n106_), .b(new_n84_), .c(new_n157_), .d(new_n156_), .O(new_n158_));
  nor2   g104(.a(new_n158_), .b(new_n70_), .O(new_n159_));
  nor2   g105(.a(x33), .b(x32), .O(new_n160_));
  nand4  g106(.a(new_n160_), .b(new_n143_), .c(new_n142_), .d(new_n107_), .O(new_n161_));
  ...
  oai21  g114(.a(new_n161_), .b(new_n97_), .c(x34), .O(new_n169_));
  nand2  g115(.a(new_n142_), .b(new_n107_), .O(new_n170_));
  ...
  nand3  g125(.a(new_n179_), .b(new_n171_), .c(new_n159_), .O(new_n180_));
