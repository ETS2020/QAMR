...
module FAU ( 
  ...
  nand4  g053(.a(new_n107_), .b(new_n86_), .c(new_n77_), .d(new_n63_), .O(new_n108_));
  nor2   g054(.a(x28), .b(x27), .O(new_n109_));
  nor2   g055(.a(x26), .b(x23), .O(new_n110_));
  nand3  g056(.a(new_n110_), .b(new_n109_), .c(new_n96_), .O(new_n111_));
  nor2   g057(.a(new_n111_), .b(new_n78_), .O(new_n112_));
  aoi21  g058(.a(new_n108_), .b(x28), .c(new_n112_), .O(new_n113_));
  ...
  nand4  g064(.a(new_n118_), .b(new_n99_), .c(new_n79_), .d(new_n63_), .O(new_n119_));
  ...
  nand4  g070(.a(new_n95_), .b(new_n55_), .c(new_n69_), .d(new_n61_), .O(new_n126_));
  nor2   g071(.a(x26), .b(x25), .O(new_n127_));
  nor2   g072(.a(x30), .b(x29), .O(new_n128_));
  nand4  g073(.a(new_n128_), .b(new_n109_), .c(new_n127_), .d(new_n84_), .O(new_n129_));
  oai21  g074(.a(new_n129_), .b(new_n126_), .c(x31), .O(new_n130_));
  ...
  nand3  g079(.a(new_n134_), .b(new_n107_), .c(new_n88_), .O(new_n135_));
  nand2  g080(.a(new_n135_), .b(new_n130_), .O(new_n136_));
  ...
  nand4  g087(.a(new_n132_), .b(new_n131_), .c(new_n142_), .d(new_n141_), .O(new_n143_));
  oai21  g088(.a(new_n143_), .b(new_n87_), .c(x32), .O(new_n144_));
  nor2   g089(.a(x32), .b(x31), .O(new_n145_));
  nand4  g090(.a(new_n145_), .b(new_n128_), .c(new_n109_), .d(new_n127_), .O(new_n146_));
  inv1   g091(.a(new_n146_), .O(new_n147_));
  nand2  g092(.a(new_n147_), .b(new_n88_), .O(new_n148_));
  ...
  oai21  g098(.a(new_n146_), .b(new_n87_), .c(x33), .O(new_n154_));
  inv1   g099(.a(x22), .O(new_n155_));
  inv1   g100(.a(x23), .O(new_n156_));
  nand4  g101(.a(new_n141_), .b(new_n84_), .c(new_n156_), .d(new_n155_), .O(new_n157_));
  nor2   g102(.a(new_n157_), .b(new_n70_), .O(new_n158_));
  nor2   g103(.a(x33), .b(x32), .O(new_n159_));
  nand4  g104(.a(new_n159_), .b(new_n132_), .c(new_n131_), .d(new_n142_), .O(new_n160_));
  ...
  oai21  g112(.a(new_n160_), .b(new_n97_), .c(x34), .O(new_n168_));
  nand2  g113(.a(new_n131_), .b(new_n142_), .O(new_n169_));
