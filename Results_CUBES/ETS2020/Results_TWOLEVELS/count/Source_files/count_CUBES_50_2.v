...
module FAU ( 
  ...
  nand3  g041(.a(new_n95_), .b(new_n94_), .c(new_n71_), .O(new_n96_));
  ...
  nor2   g058(.a(new_n112_), .b(new_n97_), .O(new_n113_));
  ...
  nand4  g065(.a(new_n119_), .b(new_n95_), .c(new_n83_), .d(new_n63_), .O(new_n120_));
  ...
  nand4  g071(.a(new_n94_), .b(new_n55_), .c(new_n69_), .d(new_n61_), .O(new_n126_));
  nor2   g072(.a(x26), .b(x25), .O(new_n127_));
  nor2   g073(.a(x30), .b(x29), .O(new_n128_));
  nand4  g074(.a(new_n128_), .b(new_n110_), .c(new_n127_), .d(new_n82_), .O(new_n129_));
  ...
  nand4  g082(.a(new_n137_), .b(new_n136_), .c(new_n99_), .d(new_n98_), .O(new_n138_));
  oai21  g083(.a(new_n138_), .b(new_n86_), .c(x32), .O(new_n139_));
  nand2  g084(.a(new_n128_), .b(new_n110_), .O(new_n140_));
  inv1   g085(.a(x31), .O(new_n141_));
  inv1   g086(.a(x32), .O(new_n142_));
  nand4  g087(.a(new_n142_), .b(new_n141_), .c(new_n109_), .d(new_n98_), .O(new_n143_));
  ...
  nor2   g095(.a(x21), .b(x20), .O(new_n152_));
  nand4  g096(.a(new_n111_), .b(new_n94_), .c(new_n152_), .d(new_n55_), .O(new_n153_));
  nor2   g097(.a(x33), .b(x32), .O(new_n154_));
  nand4  g098(.a(new_n154_), .b(new_n137_), .c(new_n136_), .d(new_n99_), .O(new_n155_));
  oai21  g099(.a(new_n155_), .b(new_n153_), .c(x34), .O(new_n156_));
  inv1   g100(.a(x22), .O(new_n157_));
  nand4  g101(.a(new_n98_), .b(new_n82_), .c(new_n108_), .d(new_n157_), .O(new_n158_));
  nor2   g102(.a(new_n158_), .b(new_n70_), .O(new_n159_));
  nand2  g103(.a(new_n136_), .b(new_n99_), .O(new_n160_));
  inv1   g104(.a(new_n160_), .O(new_n161_));
  inv1   g105(.a(x30), .O(new_n162_));
  nand2  g106(.a(new_n141_), .b(new_n162_), .O(new_n163_));
  inv1   g107(.a(x33), .O(new_n164_));
  inv1   g108(.a(x34), .O(new_n165_));
  nand3  g109(.a(new_n165_), .b(new_n164_), .c(new_n142_), .O(new_n166_));
  nor2   g110(.a(new_n166_), .b(new_n163_), .O(new_n167_));
  nand3  g111(.a(new_n167_), .b(new_n161_), .c(new_n159_), .O(new_n168_));
  nand2  g112(.a(new_n168_), .b(new_n156_), .O(new_n169_));
