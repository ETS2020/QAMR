...
module FAU ( 
  ...
  nand4  g071(.a(new_n106_), .b(new_n55_), .c(new_n69_), .d(new_n61_), .O(new_n125_));
  nor2   g072(.a(x26), .b(x25), .O(new_n126_));
  nor2   g073(.a(x28), .b(x27), .O(new_n127_));
  nor2   g074(.a(x30), .b(x29), .O(new_n128_));
  nand4  g075(.a(new_n128_), .b(new_n127_), .c(new_n126_), .d(new_n87_), .O(new_n129_));
  ...
  nand4  g082(.a(new_n87_), .b(new_n97_), .c(new_n96_), .d(new_n69_), .O(new_n136_));
  inv1   g083(.a(new_n136_), .O(new_n137_));
  nor3   g084(.a(x27), .b(x26), .c(x25), .O(new_n138_));
  ...
  nand4  g091(.a(new_n144_), .b(new_n138_), .c(new_n137_), .d(new_n63_), .O(new_n145_));
  ...
  nand4  g099(.a(new_n152_), .b(new_n151_), .c(new_n114_), .d(new_n98_), .O(new_n153_));
  oai21  g100(.a(new_n153_), .b(new_n90_), .c(x32), .O(new_n154_));
  inv1   g101(.a(x27), .O(new_n155_));
  nand4  g102(.a(new_n141_), .b(new_n140_), .c(new_n139_), .d(new_n155_), .O(new_n156_));
  inv1   g103(.a(new_n156_), .O(new_n157_));
  inv1   g104(.a(x26), .O(new_n158_));
  inv1   g105(.a(x32), .O(new_n159_));
  nand4  g106(.a(new_n159_), .b(new_n142_), .c(new_n158_), .d(new_n98_), .O(new_n160_));
  inv1   g107(.a(new_n160_), .O(new_n161_));
  nand4  g108(.a(new_n161_), .b(new_n157_), .c(new_n137_), .d(new_n63_), .O(new_n162_));
  nand2  g109(.a(new_n162_), .b(new_n154_), .O(new_n163_));
  ...
  nand4  g115(.a(new_n168_), .b(new_n128_), .c(new_n127_), .d(new_n126_), .O(new_n169_));
  oai21  g116(.a(new_n169_), .b(new_n90_), .c(x33), .O(new_n170_));
  inv1   g117(.a(x33), .O(new_n171_));
  nand4  g118(.a(new_n171_), .b(new_n159_), .c(new_n155_), .d(new_n158_), .O(new_n172_));
  inv1   g119(.a(new_n172_), .O(new_n173_));
  nand4  g120(.a(new_n173_), .b(new_n144_), .c(new_n100_), .d(new_n71_), .O(new_n174_));
