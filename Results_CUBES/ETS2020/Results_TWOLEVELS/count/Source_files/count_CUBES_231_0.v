...
module FAU ( 
  ...
  nand4  g079(.a(new_n97_), .b(new_n55_), .c(new_n65_), .d(new_n64_), .O(new_n134_));
  nor2   g080(.a(x26), .b(x25), .O(new_n135_));
  nor2   g081(.a(x30), .b(x29), .O(new_n136_));
  nand4  g082(.a(new_n136_), .b(new_n117_), .c(new_n135_), .d(new_n88_), .O(new_n137_));
  oai21  g083(.a(new_n137_), .b(new_n134_), .c(x31), .O(new_n138_));
  nand2  g084(.a(new_n84_), .b(new_n72_), .O(new_n139_));
  ...
  nand4  g090(.a(new_n144_), .b(new_n115_), .c(new_n140_), .d(new_n62_), .O(new_n145_));
  ...
  nand4  g096(.a(new_n142_), .b(new_n141_), .c(new_n108_), .d(new_n89_), .O(new_n151_));
  oai21  g097(.a(new_n151_), .b(new_n85_), .c(x32), .O(new_n152_));
  ...
  nand4  g103(.a(new_n157_), .b(new_n154_), .c(new_n140_), .d(new_n62_), .O(new_n158_));
  ...
  oai21  g110(.a(new_n164_), .b(new_n85_), .c(x33), .O(new_n165_));
  ...
  nand2  g114(.a(new_n168_), .b(new_n91_), .O(new_n169_));
  ...
  oai21  g120(.a(new_n167_), .b(new_n99_), .c(x34), .O(new_n175_));
  ...
  nand3  g131(.a(new_n185_), .b(new_n177_), .c(new_n91_), .O(new_n186_));
