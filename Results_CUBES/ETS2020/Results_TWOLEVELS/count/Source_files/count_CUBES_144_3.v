// Benchmark "FAU" written by ABC on Tue Jul  7 19:19:25 2020
...
module FAU ( 
  ...
  inv1   g062(.a(x23), .O(new_n116_));
  inv1   g063(.a(x26), .O(new_n117_));
  nor2   g064(.a(x28), .b(x27), .O(new_n118_));
  nand4  g065(.a(new_n118_), .b(new_n95_), .c(new_n117_), .d(new_n116_), .O(new_n119_));
  nor2   g066(.a(new_n119_), .b(new_n105_), .O(new_n120_));
  ...
  nand4  g073(.a(new_n126_), .b(new_n98_), .c(new_n83_), .d(new_n63_), .O(new_n127_));
  ...
  nand4  g079(.a(new_n94_), .b(new_n55_), .c(new_n69_), .d(new_n61_), .O(new_n133_));
  ...
  nand3  g093(.a(new_n146_), .b(new_n114_), .c(new_n87_), .O(new_n147_));
  ...
  nand4  g099(.a(new_n144_), .b(new_n143_), .c(new_n107_), .d(new_n106_), .O(new_n153_));
  oai21  g100(.a(new_n153_), .b(new_n86_), .c(x32), .O(new_n154_));
  nand2  g101(.a(new_n135_), .b(new_n118_), .O(new_n155_));
  inv1   g102(.a(x31), .O(new_n156_));
  inv1   g103(.a(x32), .O(new_n157_));
  nand4  g104(.a(new_n157_), .b(new_n156_), .c(new_n117_), .d(new_n106_), .O(new_n158_));
  ...
  nand4  g113(.a(new_n167_), .b(new_n144_), .c(new_n143_), .d(new_n107_), .O(new_n168_));
  oai21  g114(.a(new_n168_), .b(new_n96_), .c(x34), .O(new_n169_));
  inv1   g115(.a(x22), .O(new_n170_));
  nand4  g116(.a(new_n106_), .b(new_n82_), .c(new_n116_), .d(new_n170_), .O(new_n171_));
  nor2   g117(.a(new_n171_), .b(new_n70_), .O(new_n172_));
  nand2  g118(.a(new_n143_), .b(new_n107_), .O(new_n173_));
  inv1   g119(.a(new_n173_), .O(new_n174_));
  inv1   g120(.a(x30), .O(new_n175_));
  nand2  g121(.a(new_n156_), .b(new_n175_), .O(new_n176_));
  inv1   g122(.a(x33), .O(new_n177_));
  inv1   g123(.a(x34), .O(new_n178_));
  nand3  g124(.a(new_n178_), .b(new_n177_), .c(new_n157_), .O(new_n179_));
  nor2   g125(.a(new_n179_), .b(new_n176_), .O(new_n180_));
  nand3  g126(.a(new_n180_), .b(new_n174_), .c(new_n172_), .O(new_n181_));
  nand2  g127(.a(new_n181_), .b(new_n169_), .O(new_n182_));
