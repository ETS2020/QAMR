...
module FAU ( 
  ...
  inv1   g060(.a(x26), .O(new_n115_));
  nor2   g061(.a(x25), .b(x24), .O(new_n116_));
  nor2   g062(.a(x28), .b(x27), .O(new_n117_));
  nand4  g063(.a(new_n117_), .b(new_n116_), .c(new_n115_), .d(new_n89_), .O(new_n118_));
  oai21  g064(.a(new_n118_), .b(new_n106_), .c(x29), .O(new_n119_));
  nor3   g065(.a(x29), .b(x28), .c(x27), .O(new_n120_));
  nand4  g066(.a(new_n120_), .b(new_n99_), .c(new_n79_), .d(new_n62_), .O(new_n121_));
  ...
  nand4  g072(.a(new_n98_), .b(new_n55_), .c(new_n65_), .d(new_n64_), .O(new_n127_));
  nor2   g073(.a(x26), .b(x25), .O(new_n128_));
  nor2   g074(.a(x30), .b(x29), .O(new_n129_));
  nand4  g075(.a(new_n129_), .b(new_n117_), .c(new_n128_), .d(new_n78_), .O(new_n130_));
  ...
  nand4  g091(.a(new_n145_), .b(new_n139_), .c(new_n138_), .d(new_n62_), .O(new_n146_));
  nand2  g092(.a(new_n146_), .b(new_n136_), .O(new_n147_));
  ...
  nand4  g105(.a(new_n159_), .b(new_n143_), .c(new_n115_), .d(new_n90_), .O(new_n160_));
  inv1   g106(.a(new_n160_), .O(new_n161_));
  nand4  g107(.a(new_n161_), .b(new_n158_), .c(new_n138_), .d(new_n62_), .O(new_n162_));
  ...
  nand4  g114(.a(new_n168_), .b(new_n129_), .c(new_n117_), .d(new_n128_), .O(new_n169_));
  oai21  g115(.a(new_n169_), .b(new_n82_), .c(x33), .O(new_n170_));
  inv1   g116(.a(x33), .O(new_n171_));
  nand4  g117(.a(new_n171_), .b(new_n159_), .c(new_n156_), .d(new_n115_), .O(new_n172_));
