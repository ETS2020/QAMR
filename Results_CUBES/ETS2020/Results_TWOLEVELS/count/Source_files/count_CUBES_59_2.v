...
module FAU ( 
  ...
  nand4  g084(.a(new_n136_), .b(new_n119_), .c(new_n135_), .d(new_n98_), .O(new_n137_));
  nor2   g085(.a(new_n137_), .b(new_n88_), .O(new_n138_));
  aoi21  g086(.a(new_n129_), .b(x30), .c(new_n138_), .O(new_n139_));
  ...
  oai21  g090(.a(new_n137_), .b(new_n88_), .c(x31), .O(new_n143_));
  nor2   g091(.a(x29), .b(x28), .O(new_n144_));
  nor2   g092(.a(x31), .b(x30), .O(new_n145_));
  nand2  g093(.a(new_n145_), .b(new_n144_), .O(new_n146_));
  inv1   g094(.a(new_n146_), .O(new_n147_));
  nand3  g095(.a(new_n147_), .b(new_n116_), .c(new_n91_), .O(new_n148_));
  nand2  g096(.a(new_n148_), .b(new_n143_), .O(new_n149_));
  nand2  g097(.a(new_n149_), .b(x16), .O(new_n150_));
  inv1   g098(.a(x03), .O(new_n151_));
  aoi21  g099(.a(new_n58_), .b(new_n151_), .c(x18), .O(new_n152_));
  nand2  g100(.a(new_n152_), .b(new_n150_), .O(z12));
  nand4  g101(.a(new_n145_), .b(new_n144_), .c(new_n109_), .d(new_n99_), .O(new_n154_));
  oai21  g102(.a(new_n154_), .b(new_n90_), .c(x32), .O(new_n155_));
  nor2   g103(.a(x32), .b(x31), .O(new_n156_));
  nand4  g104(.a(new_n156_), .b(new_n136_), .c(new_n119_), .d(new_n135_), .O(new_n157_));
  inv1   g105(.a(new_n157_), .O(new_n158_));
  nand2  g106(.a(new_n158_), .b(new_n91_), .O(new_n159_));
  nand2  g107(.a(new_n159_), .b(new_n155_), .O(new_n160_));
  nand2  g108(.a(new_n160_), .b(x16), .O(new_n161_));
  inv1   g109(.a(x02), .O(new_n162_));
  aoi21  g110(.a(new_n58_), .b(new_n162_), .c(x18), .O(new_n163_));
  nand2  g111(.a(new_n163_), .b(new_n161_), .O(z13));
  oai21  g112(.a(new_n157_), .b(new_n90_), .c(x33), .O(new_n165_));
  nor2   g113(.a(x33), .b(x32), .O(new_n166_));
  nand4  g114(.a(new_n166_), .b(new_n145_), .c(new_n144_), .d(new_n109_), .O(new_n167_));
  inv1   g115(.a(new_n167_), .O(new_n168_));
  nand2  g116(.a(new_n168_), .b(new_n101_), .O(new_n169_));
  nand2  g117(.a(new_n169_), .b(new_n165_), .O(new_n170_));
  nand2  g118(.a(new_n170_), .b(x16), .O(new_n171_));
  inv1   g119(.a(x01), .O(new_n172_));
  aoi21  g120(.a(new_n58_), .b(new_n172_), .c(x18), .O(new_n173_));
  nand2  g121(.a(new_n173_), .b(new_n171_), .O(z14));
  nor2   g122(.a(x21), .b(x20), .O(new_n175_));
  nand4  g123(.a(new_n118_), .b(new_n87_), .c(new_n175_), .d(new_n55_), .O(new_n176_));
  oai21  g124(.a(new_n167_), .b(new_n176_), .c(x34), .O(new_n177_));
  nand2  g125(.a(new_n144_), .b(new_n109_), .O(new_n178_));
