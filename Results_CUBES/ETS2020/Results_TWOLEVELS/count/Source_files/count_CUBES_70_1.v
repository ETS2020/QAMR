...
module FAU ( 
  ...
  nand4  g063(.a(new_n116_), .b(new_n81_), .c(new_n67_), .d(new_n55_), .O(new_n117_));
  ...
  nand4  g074(.a(new_n127_), .b(new_n102_), .c(new_n74_), .d(new_n55_), .O(new_n128_));
  ...
  nand4  g080(.a(new_n98_), .b(new_n72_), .c(new_n60_), .d(new_n59_), .O(new_n134_));
  ...
  nand4  g101(.a(new_n155_), .b(new_n136_), .c(new_n118_), .d(new_n135_), .O(new_n156_));
  oai21  g102(.a(new_n156_), .b(new_n82_), .c(x33), .O(new_n157_));
  nor2   g103(.a(x33), .b(x32), .O(new_n158_));
  nand4  g104(.a(new_n158_), .b(new_n145_), .c(new_n144_), .d(new_n109_), .O(new_n159_));
  inv1   g105(.a(new_n159_), .O(new_n160_));
  nand2  g106(.a(new_n160_), .b(new_n92_), .O(new_n161_));
  ...
  nand2  g113(.a(new_n144_), .b(new_n109_), .O(new_n168_));
