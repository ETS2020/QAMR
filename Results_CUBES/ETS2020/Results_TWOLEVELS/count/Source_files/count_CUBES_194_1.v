...
module FAU ( 
  ...
  nand4  g053(.a(new_n84_), .b(new_n106_), .c(new_n105_), .d(new_n104_), .O(new_n107_));
  ...
  nand4  g060(.a(new_n113_), .b(new_n84_), .c(new_n72_), .d(new_n56_), .O(new_n114_));
  inv1   g061(.a(x23), .O(new_n115_));
  nor2   g062(.a(x28), .b(x27), .O(new_n116_));
  nand4  g063(.a(new_n116_), .b(new_n89_), .c(new_n105_), .d(new_n115_), .O(new_n117_));
  ...
  nand4  g089(.a(new_n132_), .b(new_n115_), .c(new_n142_), .d(new_n65_), .O(new_n143_));
  ...
  nand4  g097(.a(new_n150_), .b(new_n113_), .c(new_n144_), .d(new_n56_), .O(new_n151_));
  ...
  nand4  g104(.a(new_n158_), .b(new_n134_), .c(new_n116_), .d(new_n133_), .O(new_n159_));
  oai21  g105(.a(new_n159_), .b(new_n85_), .c(x33), .O(new_n160_));
  nand4  g106(.a(new_n104_), .b(new_n132_), .c(new_n115_), .d(new_n142_), .O(new_n161_));
  inv1   g107(.a(new_n161_), .O(new_n162_));
  inv1   g108(.a(x32), .O(new_n163_));
  inv1   g109(.a(x33), .O(new_n164_));
  nand4  g110(.a(new_n164_), .b(new_n163_), .c(new_n106_), .d(new_n105_), .O(new_n165_));
  inv1   g111(.a(new_n165_), .O(new_n166_));
  nand4  g112(.a(new_n166_), .b(new_n150_), .c(new_n162_), .d(new_n67_), .O(new_n167_));
