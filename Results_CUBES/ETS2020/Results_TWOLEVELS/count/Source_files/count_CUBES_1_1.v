...
module FAU ( 
  ...
  nand4  g062(.a(new_n115_), .b(new_n108_), .c(new_n72_), .d(new_n62_), .O(new_n116_));
  ...
  oai21  g090(.a(new_n145_), .b(new_n85_), .c(x33), .O(new_n146_));
  nor2   g091(.a(x29), .b(x28), .O(new_n147_));
  nor2   g092(.a(x31), .b(x30), .O(new_n148_));
  nor2   g093(.a(x33), .b(x32), .O(new_n149_));
  nand4  g094(.a(new_n149_), .b(new_n148_), .c(new_n147_), .d(new_n108_), .O(new_n150_));
  ...
  oai21  g102(.a(new_n150_), .b(new_n99_), .c(x34), .O(new_n158_));
  nand2  g103(.a(new_n147_), .b(new_n108_), .O(new_n159_));
  ...
  nand3  g113(.a(new_n168_), .b(new_n160_), .c(new_n91_), .O(new_n169_));
