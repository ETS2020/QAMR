...
module FAU ( 
  ...
  nand4  g085(.a(new_n137_), .b(new_n120_), .c(new_n136_), .d(new_n87_), .O(new_n138_));
  ...
  nand4  g100(.a(new_n152_), .b(new_n116_), .c(new_n146_), .d(new_n63_), .O(new_n153_));
  ...
  nand4  g108(.a(new_n160_), .b(new_n159_), .c(new_n109_), .d(new_n98_), .O(new_n161_));
  ...
  nand4  g114(.a(new_n166_), .b(new_n150_), .c(new_n118_), .d(new_n98_), .O(new_n167_));
  ...
  nand4  g123(.a(new_n175_), .b(new_n137_), .c(new_n120_), .d(new_n136_), .O(new_n176_));
  oai21  g124(.a(new_n176_), .b(new_n90_), .c(x33), .O(new_n177_));
  inv1   g125(.a(x33), .O(new_n178_));
  nand4  g126(.a(new_n178_), .b(new_n166_), .c(new_n163_), .d(new_n118_), .O(new_n179_));
