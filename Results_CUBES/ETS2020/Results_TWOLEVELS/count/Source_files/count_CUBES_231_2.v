...
module FAU ( 
  ...
  nand4  g080(.a(new_n136_), .b(new_n135_), .c(new_n99_), .d(new_n87_), .O(new_n137_));
  oai21  g081(.a(new_n137_), .b(new_n79_), .c(x32), .O(new_n138_));
  nor2   g082(.a(x32), .b(x31), .O(new_n139_));
  nand4  g083(.a(new_n139_), .b(new_n127_), .c(new_n109_), .d(new_n126_), .O(new_n140_));
  ...
  nand4  g093(.a(new_n149_), .b(new_n136_), .c(new_n135_), .d(new_n99_), .O(new_n150_));
  inv1   g094(.a(new_n150_), .O(new_n151_));
  nand2  g095(.a(new_n151_), .b(new_n89_), .O(new_n152_));
  ...
  nand4  g102(.a(new_n108_), .b(new_n95_), .c(new_n158_), .d(new_n54_), .O(new_n159_));
  oai21  g103(.a(new_n150_), .b(new_n159_), .c(x34), .O(new_n160_));
  nand2  g104(.a(new_n135_), .b(new_n99_), .O(new_n161_));
  ...
  nand3  g114(.a(new_n170_), .b(new_n162_), .c(new_n89_), .O(new_n171_));
