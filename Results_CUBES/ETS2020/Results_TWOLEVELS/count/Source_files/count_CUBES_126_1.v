...
module FAU ( 
  ...
  nand4  g053(.a(new_n107_), .b(new_n81_), .c(new_n72_), .d(new_n56_), .O(new_n108_));
  nand3  g054(.a(new_n72_), .b(new_n54_), .c(new_n53_), .O(new_n109_));
  inv1   g055(.a(x26), .O(new_n110_));
  nor2   g056(.a(x25), .b(x24), .O(new_n111_));
  nor2   g057(.a(x28), .b(x27), .O(new_n112_));
  nand4  g058(.a(new_n112_), .b(new_n111_), .c(new_n110_), .d(new_n89_), .O(new_n113_));
  nor2   g059(.a(new_n113_), .b(new_n109_), .O(new_n114_));
  aoi21  g060(.a(new_n108_), .b(x28), .c(new_n114_), .O(new_n115_));
  ...
  oai21  g064(.a(new_n113_), .b(new_n109_), .c(x29), .O(new_n119_));
  nor3   g065(.a(x29), .b(x28), .c(x27), .O(new_n120_));
  nand4  g066(.a(new_n120_), .b(new_n99_), .c(new_n79_), .d(new_n56_), .O(new_n121_));
  ...
  nand4  g072(.a(new_n98_), .b(new_n54_), .c(new_n65_), .d(new_n53_), .O(new_n127_));
  nor2   g073(.a(x26), .b(x25), .O(new_n128_));
  nor2   g074(.a(x30), .b(x29), .O(new_n129_));
  nand4  g075(.a(new_n129_), .b(new_n112_), .c(new_n128_), .d(new_n78_), .O(new_n130_));
  ...
  aoi21  g079(.a(new_n59_), .b(new_n133_), .c(x18), .O(new_n134_));
  oai21  g080(.a(new_n132_), .b(new_n59_), .c(new_n134_), .O(z11));
  oai21  g081(.a(new_n130_), .b(new_n127_), .c(x31), .O(new_n136_));
  nand4  g082(.a(new_n78_), .b(new_n89_), .c(new_n88_), .d(new_n65_), .O(new_n137_));
  ...
  nand4  g090(.a(new_n144_), .b(new_n107_), .c(new_n138_), .d(new_n56_), .O(new_n145_));
  nand2  g091(.a(new_n145_), .b(new_n136_), .O(new_n146_));
  nand2  g092(.a(new_n146_), .b(x16), .O(new_n147_));
  inv1   g093(.a(x03), .O(new_n148_));
  aoi21  g094(.a(new_n59_), .b(new_n148_), .c(x18), .O(new_n149_));
  nand2  g095(.a(new_n149_), .b(new_n147_), .O(z12));
  nor2   g096(.a(x32), .b(x31), .O(new_n152_));
  nand4  g097(.a(new_n152_), .b(new_n129_), .c(new_n112_), .d(new_n128_), .O(new_n153_));
  oai21  g098(.a(new_n153_), .b(new_n82_), .c(x33), .O(new_n154_));
  inv1   g099(.a(x27), .O(new_n155_));
  inv1   g100(.a(x32), .O(new_n156_));
  inv1   g101(.a(x33), .O(new_n157_));
  nand4  g102(.a(new_n157_), .b(new_n156_), .c(new_n155_), .d(new_n110_), .O(new_n158_));
  inv1   g103(.a(new_n158_), .O(new_n159_));
  nand4  g104(.a(new_n159_), .b(new_n144_), .c(new_n92_), .d(new_n67_), .O(new_n160_));
  nand2  g105(.a(new_n160_), .b(new_n154_), .O(new_n161_));
