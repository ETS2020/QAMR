// Benchmark "FAU" written by ABC on Tue Jul  7 19:18:55 2020
...
module FAU ( 
  ...
  aoi21  g026(.a(new_n79_), .b(new_n63_), .c(new_n78_), .O(new_n80_));
  nor2   g027(.a(x22), .b(x21), .O(new_n81_));
  nor2   g028(.a(x24), .b(x23), .O(new_n82_));
  nand4  g029(.a(new_n82_), .b(new_n81_), .c(new_n55_), .d(new_n61_), .O(new_n83_));
  inv1   g030(.a(new_n83_), .O(new_n84_));
  oai21  g031(.a(new_n84_), .b(new_n80_), .c(x16), .O(new_n85_));
  ...
  nand4  g038(.a(new_n91_), .b(new_n78_), .c(new_n90_), .d(new_n89_), .O(new_n92_));
  nor2   g039(.a(new_n92_), .b(new_n70_), .O(new_n93_));
  ...
  nand3  g050(.a(new_n103_), .b(new_n99_), .c(new_n71_), .O(new_n104_));
  ...
  nand4  g057(.a(new_n111_), .b(new_n82_), .c(new_n81_), .d(new_n63_), .O(new_n112_));
  nand3  g058(.a(new_n81_), .b(new_n55_), .c(new_n61_), .O(new_n113_));
  ...
  nor2   g062(.a(new_n116_), .b(new_n113_), .O(new_n117_));
  ...
  nand4  g068(.a(new_n123_), .b(new_n103_), .c(new_n79_), .d(new_n63_), .O(new_n124_));
  nand4  g069(.a(new_n99_), .b(new_n55_), .c(new_n69_), .d(new_n61_), .O(new_n125_));
  nor2   g070(.a(x26), .b(x25), .O(new_n126_));
  nor2   g071(.a(x30), .b(x29), .O(new_n127_));
  nand4  g072(.a(new_n127_), .b(new_n114_), .c(new_n126_), .d(new_n78_), .O(new_n128_));
  ...
  nand3  g083(.a(new_n138_), .b(new_n111_), .c(new_n84_), .O(new_n139_));
  ...
  nand4  g090(.a(new_n136_), .b(new_n135_), .c(new_n145_), .d(new_n91_), .O(new_n146_));
  oai21  g091(.a(new_n146_), .b(new_n83_), .c(x32), .O(new_n147_));
  ...
  nand2  g095(.a(new_n150_), .b(new_n84_), .O(new_n151_));
  ...
  oai21  g101(.a(new_n149_), .b(new_n83_), .c(x33), .O(new_n157_));
  nor2   g102(.a(x33), .b(x32), .O(new_n158_));
  nand4  g103(.a(new_n158_), .b(new_n136_), .c(new_n135_), .d(new_n145_), .O(new_n159_));
  inv1   g104(.a(new_n159_), .O(new_n160_));
  nand2  g105(.a(new_n160_), .b(new_n93_), .O(new_n161_));
  ...
  oai21  g111(.a(new_n159_), .b(new_n101_), .c(x34), .O(new_n167_));
  nand2  g112(.a(new_n135_), .b(new_n145_), .O(new_n168_));
