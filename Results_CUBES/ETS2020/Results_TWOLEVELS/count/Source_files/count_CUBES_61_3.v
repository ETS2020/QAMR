...
module FAU ( 
  ...
  inv1   g064(.a(x23), .O(new_n118_));
  inv1   g065(.a(x26), .O(new_n119_));
  nor2   g066(.a(x28), .b(x27), .O(new_n120_));
  nand4  g067(.a(new_n120_), .b(new_n99_), .c(new_n119_), .d(new_n118_), .O(new_n121_));
  oai21  g068(.a(new_n121_), .b(new_n81_), .c(x29), .O(new_n122_));
  nor3   g069(.a(x29), .b(x28), .c(x27), .O(new_n123_));
  nand4  g070(.a(new_n123_), .b(new_n102_), .c(new_n82_), .d(new_n63_), .O(new_n124_));
  ...
  nand4  g076(.a(new_n98_), .b(new_n55_), .c(new_n69_), .d(new_n61_), .O(new_n130_));
  nor2   g077(.a(x26), .b(x25), .O(new_n131_));
  nor2   g078(.a(x30), .b(x29), .O(new_n132_));
  nand4  g079(.a(new_n132_), .b(new_n120_), .c(new_n131_), .d(new_n87_), .O(new_n133_));
  ...
  nand3  g091(.a(new_n144_), .b(new_n140_), .c(new_n91_), .O(new_n145_));
  nand2  g092(.a(new_n145_), .b(new_n139_), .O(new_n146_));
  ...
  nand4  g097(.a(new_n142_), .b(new_n141_), .c(new_n110_), .d(new_n109_), .O(new_n151_));
  oai21  g098(.a(new_n151_), .b(new_n90_), .c(x32), .O(new_n152_));
  nand2  g099(.a(new_n132_), .b(new_n120_), .O(new_n153_));
  inv1   g100(.a(x31), .O(new_n154_));
  inv1   g101(.a(x32), .O(new_n155_));
  nand4  g102(.a(new_n155_), .b(new_n154_), .c(new_n119_), .d(new_n109_), .O(new_n156_));
  nor2   g103(.a(new_n156_), .b(new_n153_), .O(new_n157_));
  nand2  g104(.a(new_n157_), .b(new_n91_), .O(new_n158_));
  ...
  nand4  g111(.a(new_n165_), .b(new_n142_), .c(new_n141_), .d(new_n110_), .O(new_n166_));
  oai21  g112(.a(new_n166_), .b(new_n100_), .c(x34), .O(new_n167_));
  inv1   g113(.a(x22), .O(new_n168_));
  nand4  g114(.a(new_n109_), .b(new_n87_), .c(new_n118_), .d(new_n168_), .O(new_n169_));
  nor2   g115(.a(new_n169_), .b(new_n70_), .O(new_n170_));
  nand2  g116(.a(new_n141_), .b(new_n110_), .O(new_n171_));
  inv1   g117(.a(new_n171_), .O(new_n172_));
  inv1   g118(.a(x30), .O(new_n173_));
  nand2  g119(.a(new_n154_), .b(new_n173_), .O(new_n174_));
  inv1   g120(.a(x33), .O(new_n175_));
  inv1   g121(.a(x34), .O(new_n176_));
  nand3  g122(.a(new_n176_), .b(new_n175_), .c(new_n155_), .O(new_n177_));
