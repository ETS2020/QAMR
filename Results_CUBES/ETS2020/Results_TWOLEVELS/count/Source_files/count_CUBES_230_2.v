...
module FAU ( 
  ...
  nor3   g066(.a(x29), .b(x28), .c(x27), .O(new_n122_));
  nand4  g067(.a(new_n122_), .b(new_n94_), .c(new_n79_), .d(new_n71_), .O(new_n123_));
  nand4  g068(.a(new_n90_), .b(new_n55_), .c(new_n64_), .d(new_n62_), .O(new_n124_));
  nor2   g069(.a(x26), .b(x25), .O(new_n125_));
  nor2   g070(.a(x30), .b(x29), .O(new_n126_));
  nand4  g071(.a(new_n126_), .b(new_n114_), .c(new_n125_), .d(new_n78_), .O(new_n127_));
  nor2   g072(.a(new_n127_), .b(new_n124_), .O(new_n128_));
  aoi21  g073(.a(new_n123_), .b(x30), .c(new_n128_), .O(new_n129_));
  ...
  nand3  g082(.a(new_n137_), .b(new_n110_), .c(new_n83_), .O(new_n138_));
  ...
  nand4  g088(.a(new_n135_), .b(new_n134_), .c(new_n103_), .d(new_n102_), .O(new_n144_));
  oai21  g089(.a(new_n144_), .b(new_n82_), .c(x32), .O(new_n145_));
  nand2  g090(.a(new_n126_), .b(new_n114_), .O(new_n146_));
  inv1   g091(.a(x31), .O(new_n147_));
  inv1   g092(.a(x32), .O(new_n148_));
  nand4  g093(.a(new_n148_), .b(new_n147_), .c(new_n113_), .d(new_n102_), .O(new_n149_));
  nor2   g094(.a(new_n149_), .b(new_n146_), .O(new_n150_));
  nand2  g095(.a(new_n150_), .b(new_n83_), .O(new_n151_));
  ...
  nor2   g101(.a(x33), .b(x32), .O(new_n158_));
  nand4  g102(.a(new_n158_), .b(new_n135_), .c(new_n134_), .d(new_n103_), .O(new_n159_));
  oai21  g103(.a(new_n159_), .b(new_n92_), .c(x34), .O(new_n160_));
  inv1   g104(.a(x22), .O(new_n161_));
  nand4  g105(.a(new_n102_), .b(new_n78_), .c(new_n112_), .d(new_n161_), .O(new_n162_));
  nor2   g106(.a(new_n162_), .b(new_n65_), .O(new_n163_));
  nand2  g107(.a(new_n134_), .b(new_n103_), .O(new_n164_));
  inv1   g108(.a(new_n164_), .O(new_n165_));
  inv1   g109(.a(x30), .O(new_n166_));
  nand2  g110(.a(new_n147_), .b(new_n166_), .O(new_n167_));
  inv1   g111(.a(x33), .O(new_n168_));
  inv1   g112(.a(x34), .O(new_n169_));
  nand3  g113(.a(new_n169_), .b(new_n168_), .c(new_n148_), .O(new_n170_));
  nor2   g114(.a(new_n170_), .b(new_n167_), .O(new_n171_));
  nand3  g115(.a(new_n171_), .b(new_n165_), .c(new_n163_), .O(new_n172_));
  nand2  g116(.a(new_n172_), .b(new_n160_), .O(new_n173_));
