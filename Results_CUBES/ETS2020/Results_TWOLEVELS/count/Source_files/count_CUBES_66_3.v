// Benchmark "FAU" written by ABC on Tue Jul  7 19:18:19 2020
...
module FAU ( 
  ...
  nand4  g075(.a(new_n128_), .b(new_n103_), .c(new_n77_), .d(new_n63_), .O(new_n129_));
  nand4  g076(.a(new_n102_), .b(new_n55_), .c(new_n69_), .d(new_n61_), .O(new_n130_));
  nor2   g077(.a(x26), .b(x25), .O(new_n131_));
  nor2   g078(.a(x30), .b(x29), .O(new_n132_));
  nand4  g079(.a(new_n132_), .b(new_n120_), .c(new_n131_), .d(new_n82_), .O(new_n133_));
  nor2   g080(.a(new_n133_), .b(new_n130_), .O(new_n134_));
  aoi21  g081(.a(new_n129_), .b(x30), .c(new_n134_), .O(new_n135_));
  ...
  nand3  g090(.a(new_n143_), .b(new_n117_), .c(new_n86_), .O(new_n144_));
  nand2  g091(.a(new_n144_), .b(new_n139_), .O(new_n145_));
  ...
  nand4  g099(.a(new_n152_), .b(new_n132_), .c(new_n120_), .d(new_n131_), .O(new_n153_));
  ...
  nand4  g117(.a(new_n119_), .b(new_n102_), .c(new_n101_), .d(new_n55_), .O(new_n171_));
