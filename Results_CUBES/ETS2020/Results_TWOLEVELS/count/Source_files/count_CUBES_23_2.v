...
module FAU ( 
  ...
  nand4  g042(.a(new_n96_), .b(new_n95_), .c(new_n94_), .d(new_n56_), .O(new_n97_));
  nand2  g043(.a(new_n97_), .b(x26), .O(new_n98_));
  nor3   g044(.a(x26), .b(x25), .c(x24), .O(new_n99_));
  nand3  g045(.a(new_n99_), .b(new_n95_), .c(new_n62_), .O(new_n100_));
  nand2  g046(.a(new_n100_), .b(new_n98_), .O(new_n101_));
  nand2  g047(.a(new_n101_), .b(x16), .O(new_n102_));
  inv1   g048(.a(x08), .O(new_n103_));
  aoi21  g049(.a(new_n54_), .b(new_n103_), .c(x18), .O(new_n104_));
  nand2  g050(.a(new_n104_), .b(new_n102_), .O(z07));
  nor2   g051(.a(x27), .b(x26), .O(new_n106_));
  nand3  g052(.a(new_n106_), .b(new_n78_), .c(new_n87_), .O(new_n107_));
  nor2   g053(.a(new_n107_), .b(new_n70_), .O(new_n108_));
  aoi21  g054(.a(new_n100_), .b(x27), .c(new_n108_), .O(new_n109_));
  ...
  nor3   g058(.a(x27), .b(x26), .c(x25), .O(new_n113_));
  nand4  g059(.a(new_n113_), .b(new_n78_), .c(new_n69_), .d(new_n68_), .O(new_n114_));
  nor2   g060(.a(x28), .b(x27), .O(new_n115_));
  nor2   g061(.a(x26), .b(x23), .O(new_n116_));
  nand3  g062(.a(new_n116_), .b(new_n115_), .c(new_n96_), .O(new_n117_));
  nor2   g063(.a(new_n117_), .b(new_n70_), .O(new_n118_));
  aoi21  g064(.a(new_n114_), .b(x28), .c(new_n118_), .O(new_n119_));
  inv1   g065(.a(x06), .O(new_n120_));
  aoi21  g066(.a(new_n54_), .b(new_n120_), .c(x18), .O(new_n121_));
  oai21  g067(.a(new_n119_), .b(new_n54_), .c(new_n121_), .O(z09));
  inv1   g068(.a(x29), .O(new_n123_));
  nor3   g069(.a(x29), .b(x28), .c(x27), .O(new_n124_));
  nand4  g070(.a(new_n124_), .b(new_n99_), .c(new_n71_), .d(new_n68_), .O(new_n125_));
  oai21  g071(.a(new_n118_), .b(new_n123_), .c(new_n125_), .O(new_n126_));
  nand2  g072(.a(new_n126_), .b(x16), .O(new_n127_));
  inv1   g073(.a(x05), .O(new_n128_));
  aoi21  g074(.a(new_n54_), .b(new_n128_), .c(x18), .O(new_n129_));
  nand2  g075(.a(new_n129_), .b(new_n127_), .O(z10));
  nand4  g076(.a(new_n95_), .b(new_n56_), .c(new_n60_), .d(new_n55_), .O(new_n132_));
  nor2   g077(.a(x26), .b(x25), .O(new_n133_));
  nor2   g078(.a(x30), .b(x29), .O(new_n134_));
  nand4  g079(.a(new_n134_), .b(new_n115_), .c(new_n133_), .d(new_n76_), .O(new_n135_));
  oai21  g080(.a(new_n135_), .b(new_n132_), .c(x31), .O(new_n136_));
  nor2   g081(.a(x29), .b(x28), .O(new_n137_));
  nor2   g082(.a(x31), .b(x30), .O(new_n138_));
  nand2  g083(.a(new_n138_), .b(new_n137_), .O(new_n139_));
  inv1   g084(.a(new_n139_), .O(new_n140_));
  nand3  g085(.a(new_n140_), .b(new_n113_), .c(new_n80_), .O(new_n141_));
  nand2  g086(.a(new_n141_), .b(new_n136_), .O(new_n142_));
  ...
  nand4  g091(.a(new_n138_), .b(new_n137_), .c(new_n106_), .d(new_n87_), .O(new_n147_));
  oai21  g092(.a(new_n147_), .b(new_n79_), .c(x32), .O(new_n148_));
  nor2   g093(.a(x32), .b(x31), .O(new_n149_));
  nand4  g094(.a(new_n149_), .b(new_n134_), .c(new_n115_), .d(new_n133_), .O(new_n150_));
  inv1   g095(.a(new_n150_), .O(new_n151_));
  nand2  g096(.a(new_n151_), .b(new_n80_), .O(new_n152_));
  ...
  aoi21  g127(.a(new_n54_), .b(new_n182_), .c(x18), .O(new_n183_));
