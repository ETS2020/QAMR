...
module FAU ( 
  ...
  nand3  g054(.a(new_n107_), .b(new_n86_), .c(new_n96_), .O(new_n108_));
  ...
  nand4  g065(.a(new_n118_), .b(new_n117_), .c(new_n116_), .d(new_n95_), .O(new_n119_));
  ...
  oai21  g071(.a(new_n119_), .b(new_n78_), .c(x29), .O(new_n125_));
  nor3   g072(.a(x29), .b(x28), .c(x27), .O(new_n126_));
  nand4  g073(.a(new_n126_), .b(new_n100_), .c(new_n79_), .d(new_n63_), .O(new_n127_));
  ...
  nand4  g079(.a(new_n99_), .b(new_n55_), .c(new_n69_), .d(new_n61_), .O(new_n134_));
  nor2   g080(.a(x26), .b(x25), .O(new_n135_));
  nor2   g081(.a(x30), .b(x29), .O(new_n136_));
  nand4  g082(.a(new_n136_), .b(new_n118_), .c(new_n135_), .d(new_n84_), .O(new_n137_));
  oai21  g083(.a(new_n137_), .b(new_n134_), .c(x31), .O(new_n138_));
  nand4  g084(.a(new_n84_), .b(new_n95_), .c(new_n94_), .d(new_n69_), .O(new_n139_));
  ...
  nand4  g092(.a(new_n146_), .b(new_n114_), .c(new_n140_), .d(new_n63_), .O(new_n147_));
  ...
  nand4  g100(.a(new_n154_), .b(new_n153_), .c(new_n107_), .d(new_n96_), .O(new_n155_));
  oai21  g101(.a(new_n155_), .b(new_n87_), .c(x32), .O(new_n156_));
  ...
  nand4  g106(.a(new_n160_), .b(new_n144_), .c(new_n116_), .d(new_n96_), .O(new_n161_));
  inv1   g107(.a(new_n161_), .O(new_n162_));
  nand4  g108(.a(new_n162_), .b(new_n159_), .c(new_n140_), .d(new_n63_), .O(new_n163_));
  ...
  oai21  g116(.a(new_n170_), .b(new_n87_), .c(x33), .O(new_n171_));
  inv1   g117(.a(new_n97_), .O(new_n172_));
  inv1   g118(.a(x33), .O(new_n173_));
  nand4  g119(.a(new_n173_), .b(new_n160_), .c(new_n157_), .d(new_n116_), .O(new_n174_));
  inv1   g120(.a(new_n174_), .O(new_n175_));
  nand4  g121(.a(new_n175_), .b(new_n146_), .c(new_n172_), .d(new_n71_), .O(new_n176_));
  nand2  g122(.a(new_n176_), .b(new_n171_), .O(new_n177_));
