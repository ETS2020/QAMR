// Benchmark "FAU" written by ABC on Tue Jul  7 19:21:01 2020
...
module FAU ( 
  ...
  nand4  g053(.a(new_n107_), .b(new_n80_), .c(new_n71_), .d(new_n63_), .O(new_n108_));
  nand3  g054(.a(new_n71_), .b(new_n55_), .c(new_n61_), .O(new_n109_));
  nor2   g055(.a(x25), .b(x24), .O(new_n110_));
  nor2   g056(.a(x28), .b(x27), .O(new_n111_));
  nand4  g057(.a(new_n111_), .b(new_n110_), .c(new_n96_), .d(new_n88_), .O(new_n112_));
  nor2   g058(.a(new_n112_), .b(new_n109_), .O(new_n113_));
  ...
  nand4  g065(.a(new_n119_), .b(new_n99_), .c(new_n78_), .d(new_n63_), .O(new_n120_));
  ...
  nand4  g074(.a(new_n130_), .b(new_n129_), .c(new_n128_), .d(new_n89_), .O(new_n131_));
  oai21  g075(.a(new_n131_), .b(new_n81_), .c(x32), .O(new_n132_));
  nor2   g076(.a(x26), .b(x25), .O(new_n133_));
  nor2   g077(.a(x30), .b(x29), .O(new_n134_));
  nor2   g078(.a(x32), .b(x31), .O(new_n135_));
  nand4  g079(.a(new_n135_), .b(new_n134_), .c(new_n111_), .d(new_n133_), .O(new_n136_));
  inv1   g080(.a(new_n136_), .O(new_n137_));
  nand2  g081(.a(new_n137_), .b(new_n82_), .O(new_n138_));
  nand2  g082(.a(new_n138_), .b(new_n132_), .O(new_n139_));
  ...
  nand4  g089(.a(new_n145_), .b(new_n130_), .c(new_n129_), .d(new_n128_), .O(new_n146_));
  ...
  nand4  g097(.a(new_n110_), .b(new_n98_), .c(new_n97_), .d(new_n55_), .O(new_n154_));
  oai21  g098(.a(new_n146_), .b(new_n154_), .c(x34), .O(new_n155_));
  nand2  g099(.a(new_n129_), .b(new_n128_), .O(new_n156_));
