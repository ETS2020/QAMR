...
module FAU ( 
  ...
  nand4  g034(.a(new_n82_), .b(new_n86_), .c(new_n85_), .d(new_n69_), .O(new_n87_));
  nor2   g035(.a(new_n87_), .b(new_n68_), .O(new_n88_));
  oai21  g036(.a(new_n88_), .b(new_n84_), .c(x16), .O(new_n89_));
  ...
  nand3  g058(.a(new_n76_), .b(new_n55_), .c(new_n61_), .O(new_n113_));
  inv1   g059(.a(x26), .O(new_n114_));
  nor2   g060(.a(x28), .b(x27), .O(new_n115_));
  nand4  g061(.a(new_n115_), .b(new_n96_), .c(new_n114_), .d(new_n86_), .O(new_n116_));
  oai21  g062(.a(new_n116_), .b(new_n113_), .c(x29), .O(new_n117_));
  nor3   g063(.a(x29), .b(x28), .c(x27), .O(new_n118_));
  nand4  g064(.a(new_n118_), .b(new_n104_), .c(new_n83_), .d(new_n63_), .O(new_n119_));
  ...
  nand4  g072(.a(new_n126_), .b(new_n115_), .c(new_n96_), .d(new_n114_), .O(new_n127_));
  nor2   g073(.a(new_n127_), .b(new_n125_), .O(new_n128_));
  aoi21  g074(.a(new_n119_), .b(x30), .c(new_n128_), .O(new_n129_));
  ...
  inv1   g079(.a(new_n87_), .O(new_n134_));
  nor3   g080(.a(x29), .b(x28), .c(x25), .O(new_n135_));
  nor2   g081(.a(x27), .b(x26), .O(new_n136_));
  nor2   g082(.a(x31), .b(x30), .O(new_n137_));
  nand2  g083(.a(new_n137_), .b(new_n136_), .O(new_n138_));
  inv1   g084(.a(new_n138_), .O(new_n139_));
  nand4  g085(.a(new_n139_), .b(new_n135_), .c(new_n134_), .d(new_n63_), .O(new_n140_));
  ...
  nor2   g091(.a(x29), .b(x28), .O(new_n148_));
  nor2   g092(.a(x33), .b(x32), .O(new_n149_));
  nand4  g093(.a(new_n149_), .b(new_n137_), .c(new_n136_), .d(new_n148_), .O(new_n150_));
  oai21  g094(.a(new_n150_), .b(new_n97_), .c(x34), .O(new_n151_));
  nand4  g095(.a(new_n93_), .b(new_n82_), .c(new_n86_), .d(new_n85_), .O(new_n152_));
  nor2   g096(.a(new_n152_), .b(new_n70_), .O(new_n153_));
  nand2  g097(.a(new_n136_), .b(new_n148_), .O(new_n154_));
  ...
  nand2  g108(.a(new_n164_), .b(new_n151_), .O(new_n165_));
