...
module FAU ( 
  ...
  oai21  g066(.a(new_n120_), .b(new_n74_), .c(x29), .O(new_n121_));
  nor3   g067(.a(x29), .b(x28), .c(x27), .O(new_n122_));
  nand4  g068(.a(new_n122_), .b(new_n103_), .c(new_n75_), .d(new_n72_), .O(new_n123_));
  ...
  nand4  g074(.a(new_n99_), .b(new_n55_), .c(new_n64_), .d(new_n62_), .O(new_n129_));
  nor2   g075(.a(x26), .b(x25), .O(new_n130_));
  nor2   g076(.a(x30), .b(x29), .O(new_n131_));
  nand4  g077(.a(new_n131_), .b(new_n118_), .c(new_n130_), .d(new_n80_), .O(new_n132_));
  ...
  nand3  g089(.a(new_n143_), .b(new_n139_), .c(new_n84_), .O(new_n144_));
  ...
  nand2  g100(.a(new_n154_), .b(new_n84_), .O(new_n155_));
  ...
  oai21  g106(.a(new_n153_), .b(new_n83_), .c(x33), .O(new_n161_));
  ...
  nand2  g110(.a(new_n164_), .b(new_n93_), .O(new_n165_));
  ...
  oai21  g116(.a(new_n163_), .b(new_n101_), .c(x34), .O(new_n171_));
  ...
  nand3  g127(.a(new_n181_), .b(new_n173_), .c(new_n93_), .O(new_n182_));
