...
module FAU ( 
  ...
  nand4  g042(.a(new_n95_), .b(new_n82_), .c(new_n94_), .d(new_n93_), .O(new_n96_));
  oai21  g043(.a(new_n96_), .b(new_n70_), .c(x26), .O(new_n97_));
  ...
  nand3  g052(.a(new_n76_), .b(new_n55_), .c(new_n61_), .O(new_n106_));
  nor2   g053(.a(x27), .b(x26), .O(new_n107_));
  nand3  g054(.a(new_n107_), .b(new_n85_), .c(new_n95_), .O(new_n108_));
  ...
  nand4  g065(.a(new_n118_), .b(new_n117_), .c(new_n116_), .d(new_n94_), .O(new_n119_));
  ...
  oai21  g071(.a(new_n119_), .b(new_n106_), .c(x29), .O(new_n125_));
  nor3   g072(.a(x29), .b(x28), .c(x27), .O(new_n126_));
  nand4  g073(.a(new_n126_), .b(new_n99_), .c(new_n83_), .d(new_n63_), .O(new_n127_));
  ...
  nand4  g079(.a(new_n98_), .b(new_n55_), .c(new_n69_), .d(new_n61_), .O(new_n133_));
  nor2   g080(.a(x26), .b(x25), .O(new_n134_));
  nor2   g081(.a(x30), .b(x29), .O(new_n135_));
  nand4  g082(.a(new_n135_), .b(new_n118_), .c(new_n134_), .d(new_n82_), .O(new_n136_));
  ...
  nand4  g089(.a(new_n82_), .b(new_n94_), .c(new_n93_), .d(new_n69_), .O(new_n143_));
  ...
  nand4  g097(.a(new_n150_), .b(new_n114_), .c(new_n144_), .d(new_n63_), .O(new_n151_));
  ...
  nand4  g105(.a(new_n158_), .b(new_n157_), .c(new_n107_), .d(new_n95_), .O(new_n159_));
  oai21  g106(.a(new_n159_), .b(new_n86_), .c(x32), .O(new_n160_));
  ...
  nand4  g111(.a(new_n164_), .b(new_n148_), .c(new_n116_), .d(new_n95_), .O(new_n165_));
  ...
  nand4  g120(.a(new_n173_), .b(new_n135_), .c(new_n118_), .d(new_n134_), .O(new_n174_));
  oai21  g121(.a(new_n174_), .b(new_n86_), .c(x33), .O(new_n175_));
  inv1   g122(.a(new_n96_), .O(new_n176_));
  inv1   g123(.a(x33), .O(new_n177_));
  nand4  g124(.a(new_n177_), .b(new_n164_), .c(new_n161_), .d(new_n116_), .O(new_n178_));
  inv1   g125(.a(new_n178_), .O(new_n179_));
  nand4  g126(.a(new_n179_), .b(new_n150_), .c(new_n176_), .d(new_n71_), .O(new_n180_));
  nand2  g127(.a(new_n180_), .b(new_n175_), .O(new_n181_));
  nand2  g128(.a(new_n181_), .b(x16), .O(new_n182_));
  inv1   g129(.a(x01), .O(new_n183_));
  aoi21  g130(.a(new_n58_), .b(new_n183_), .c(x18), .O(new_n184_));
  nand2  g131(.a(new_n184_), .b(new_n182_), .O(z14));
  zero   g132(.O(z04));
  zero   g133(.O(z06));
  zero   g134(.O(z15));
endmodule
