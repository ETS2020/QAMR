...
module FAU ( 
  ...
  nand4  g077(.a(new_n102_), .b(new_n54_), .c(new_n65_), .d(new_n53_), .O(new_n132_));
  nor2   g078(.a(x26), .b(x25), .O(new_n133_));
  nor2   g079(.a(x30), .b(x29), .O(new_n134_));
  nand4  g080(.a(new_n134_), .b(new_n116_), .c(new_n133_), .d(new_n83_), .O(new_n135_));
  ...
  nand3  g086(.a(new_n140_), .b(new_n112_), .c(new_n87_), .O(new_n141_));
  ...
  nand4  g092(.a(new_n138_), .b(new_n137_), .c(new_n105_), .d(new_n94_), .O(new_n147_));
  ...
  nand4  g097(.a(new_n151_), .b(new_n150_), .c(new_n114_), .d(new_n94_), .O(new_n152_));
  ...
  nand4  g106(.a(new_n115_), .b(new_n102_), .c(new_n161_), .d(new_n54_), .O(new_n162_));
  nor2   g107(.a(x33), .b(x32), .O(new_n163_));
  nand4  g108(.a(new_n163_), .b(new_n138_), .c(new_n137_), .d(new_n105_), .O(new_n164_));
  oai21  g109(.a(new_n164_), .b(new_n162_), .c(x34), .O(new_n165_));
  nand2  g110(.a(new_n137_), .b(new_n105_), .O(new_n166_));
  ...
  nand3  g118(.a(new_n173_), .b(new_n167_), .c(new_n96_), .O(new_n174_));
