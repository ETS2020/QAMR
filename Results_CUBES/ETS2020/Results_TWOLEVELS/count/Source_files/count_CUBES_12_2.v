...
module FAU ( 
  ...
  nand4  g060(.a(new_n115_), .b(new_n92_), .c(new_n75_), .d(new_n56_), .O(new_n116_));
  ...
  nand4  g066(.a(new_n91_), .b(new_n54_), .c(new_n65_), .d(new_n53_), .O(new_n122_));
  nor2   g067(.a(x26), .b(x25), .O(new_n123_));
  nor2   g068(.a(x30), .b(x29), .O(new_n124_));
  nand4  g069(.a(new_n124_), .b(new_n106_), .c(new_n123_), .d(new_n80_), .O(new_n125_));
  ...
  aoi21  g073(.a(new_n59_), .b(new_n128_), .c(x18), .O(new_n129_));
  oai21  g074(.a(new_n127_), .b(new_n59_), .c(new_n129_), .O(z11));
  ...
  nand3  g080(.a(new_n135_), .b(new_n102_), .c(new_n84_), .O(new_n136_));
  ...
  nand4  g086(.a(new_n133_), .b(new_n132_), .c(new_n95_), .d(new_n94_), .O(new_n142_));
  oai21  g087(.a(new_n142_), .b(new_n83_), .c(x32), .O(new_n143_));
  nand2  g088(.a(new_n124_), .b(new_n106_), .O(new_n144_));
  inv1   g089(.a(x31), .O(new_n145_));
  inv1   g090(.a(x32), .O(new_n146_));
  nand4  g091(.a(new_n146_), .b(new_n145_), .c(new_n105_), .d(new_n94_), .O(new_n147_));
  nor2   g092(.a(new_n147_), .b(new_n144_), .O(new_n148_));
  nand2  g093(.a(new_n148_), .b(new_n84_), .O(new_n149_));
  nand2  g094(.a(new_n149_), .b(new_n143_), .O(new_n150_));
  ...
  nand4  g100(.a(new_n107_), .b(new_n91_), .c(new_n156_), .d(new_n54_), .O(new_n157_));
  nor2   g101(.a(x33), .b(x32), .O(new_n158_));
  nand4  g102(.a(new_n158_), .b(new_n133_), .c(new_n132_), .d(new_n95_), .O(new_n159_));
  oai21  g103(.a(new_n159_), .b(new_n157_), .c(x34), .O(new_n160_));
  inv1   g104(.a(x22), .O(new_n161_));
  nand4  g105(.a(new_n94_), .b(new_n80_), .c(new_n104_), .d(new_n161_), .O(new_n162_));
  nor2   g106(.a(new_n162_), .b(new_n66_), .O(new_n163_));
  nand2  g107(.a(new_n132_), .b(new_n95_), .O(new_n164_));
  inv1   g108(.a(new_n164_), .O(new_n165_));
  inv1   g109(.a(x30), .O(new_n166_));
  nand2  g110(.a(new_n145_), .b(new_n166_), .O(new_n167_));
  inv1   g111(.a(x33), .O(new_n168_));
  inv1   g112(.a(x34), .O(new_n169_));
  nand3  g113(.a(new_n169_), .b(new_n168_), .c(new_n146_), .O(new_n170_));
