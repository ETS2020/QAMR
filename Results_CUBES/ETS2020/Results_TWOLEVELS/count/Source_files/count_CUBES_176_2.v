// Benchmark "FAU" written by ABC on Tue Jul  7 19:19:57 2020
...
module FAU ( 
  ...
  nor2   g084(.a(x31), .b(x30), .O(new_n140_));
  nand4  g085(.a(new_n140_), .b(new_n139_), .c(new_n103_), .d(new_n102_), .O(new_n141_));
  oai21  g086(.a(new_n141_), .b(new_n82_), .c(x32), .O(new_n142_));
  nand2  g087(.a(new_n131_), .b(new_n114_), .O(new_n143_));
  inv1   g088(.a(x31), .O(new_n144_));
  inv1   g089(.a(x32), .O(new_n145_));
  nand4  g090(.a(new_n145_), .b(new_n144_), .c(new_n113_), .d(new_n102_), .O(new_n146_));
  nor2   g091(.a(new_n146_), .b(new_n143_), .O(new_n147_));
  nand2  g092(.a(new_n147_), .b(new_n83_), .O(new_n148_));
  nand2  g093(.a(new_n148_), .b(new_n142_), .O(new_n149_));
  ...
  nand4  g099(.a(new_n155_), .b(new_n140_), .c(new_n139_), .d(new_n103_), .O(new_n156_));
  oai21  g100(.a(new_n156_), .b(new_n92_), .c(x34), .O(new_n157_));
  inv1   g101(.a(x22), .O(new_n158_));
  nand4  g102(.a(new_n102_), .b(new_n78_), .c(new_n112_), .d(new_n158_), .O(new_n159_));
  nor2   g103(.a(new_n159_), .b(new_n65_), .O(new_n160_));
  nand2  g104(.a(new_n139_), .b(new_n103_), .O(new_n161_));
  inv1   g105(.a(new_n161_), .O(new_n162_));
  inv1   g106(.a(x30), .O(new_n163_));
  nand2  g107(.a(new_n144_), .b(new_n163_), .O(new_n164_));
  inv1   g108(.a(x33), .O(new_n165_));
  inv1   g109(.a(x34), .O(new_n166_));
  nand3  g110(.a(new_n166_), .b(new_n165_), .c(new_n145_), .O(new_n167_));
  nor2   g111(.a(new_n167_), .b(new_n164_), .O(new_n168_));
  nand3  g112(.a(new_n168_), .b(new_n162_), .c(new_n160_), .O(new_n169_));
  nand2  g113(.a(new_n169_), .b(new_n157_), .O(new_n170_));
