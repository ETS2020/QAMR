// Benchmark "FAU" written by ABC on Tue Jul  7 19:18:47 2020
...
module FAU ( 
  ...
  inv1   g048(.a(x26), .O(new_n102_));
  inv1   g049(.a(x27), .O(new_n103_));
  nand4  g050(.a(new_n89_), .b(new_n103_), .c(new_n102_), .d(new_n101_), .O(new_n104_));
  nor2   g051(.a(new_n104_), .b(new_n81_), .O(new_n105_));
  aoi21  g052(.a(new_n100_), .b(x27), .c(new_n105_), .O(new_n106_));
  inv1   g053(.a(x07), .O(new_n107_));
  aoi21  g054(.a(new_n58_), .b(new_n107_), .c(x18), .O(new_n108_));
  oai21  g055(.a(new_n106_), .b(new_n58_), .c(new_n108_), .O(z08));
  ...
  nand4  g061(.a(new_n114_), .b(new_n113_), .c(new_n102_), .d(new_n112_), .O(new_n115_));
  ...
  inv1   g085(.a(x22), .O(new_n139_));
  nand4  g086(.a(new_n87_), .b(new_n112_), .c(new_n139_), .d(new_n69_), .O(new_n140_));
  ...
  nand4  g094(.a(new_n147_), .b(new_n110_), .c(new_n141_), .d(new_n63_), .O(new_n148_));
  nand2  g095(.a(new_n148_), .b(new_n138_), .O(new_n149_));
  ...
  nand4  g101(.a(new_n155_), .b(new_n131_), .c(new_n113_), .d(new_n130_), .O(new_n156_));
  oai21  g102(.a(new_n156_), .b(new_n90_), .c(x33), .O(new_n157_));
  nand4  g103(.a(new_n103_), .b(new_n102_), .c(new_n101_), .d(new_n87_), .O(new_n158_));
  inv1   g104(.a(new_n158_), .O(new_n159_));
  inv1   g105(.a(x32), .O(new_n160_));
  inv1   g106(.a(x33), .O(new_n161_));
  nand4  g107(.a(new_n161_), .b(new_n160_), .c(new_n112_), .d(new_n139_), .O(new_n162_));
  inv1   g108(.a(new_n162_), .O(new_n163_));
  nand4  g109(.a(new_n163_), .b(new_n159_), .c(new_n147_), .d(new_n71_), .O(new_n164_));
  nand2  g110(.a(new_n164_), .b(new_n157_), .O(new_n165_));
