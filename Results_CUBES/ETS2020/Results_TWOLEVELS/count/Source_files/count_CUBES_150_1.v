...
module FAU ( 
  ...
  nor2   g045(.a(new_n97_), .b(new_n66_), .O(new_n98_));
  ...
  nand4  g051(.a(new_n104_), .b(new_n79_), .c(new_n67_), .d(new_n95_), .O(new_n105_));
  nor2   g052(.a(x27), .b(x26), .O(new_n106_));
  nand3  g053(.a(new_n106_), .b(new_n86_), .c(new_n96_), .O(new_n107_));
  ...
  nand4  g060(.a(new_n113_), .b(new_n86_), .c(new_n72_), .d(new_n56_), .O(new_n114_));
  ...
  nand4  g071(.a(new_n126_), .b(new_n116_), .c(new_n104_), .d(new_n95_), .O(new_n127_));
  ...
  nand3  g077(.a(new_n132_), .b(new_n113_), .c(new_n88_), .O(new_n133_));
  ...
  nand4  g083(.a(new_n130_), .b(new_n129_), .c(new_n106_), .d(new_n96_), .O(new_n139_));
  oai21  g084(.a(new_n139_), .b(new_n87_), .c(x32), .O(new_n140_));
  nor2   g085(.a(x32), .b(x31), .O(new_n141_));
  nand4  g086(.a(new_n141_), .b(new_n126_), .c(new_n116_), .d(new_n104_), .O(new_n142_));
  inv1   g087(.a(new_n142_), .O(new_n143_));
  nand2  g088(.a(new_n143_), .b(new_n88_), .O(new_n144_));
  nand2  g089(.a(new_n144_), .b(new_n140_), .O(new_n145_));
  ...
  oai21  g094(.a(new_n142_), .b(new_n87_), .c(x33), .O(new_n150_));
  nor2   g095(.a(x33), .b(x32), .O(new_n151_));
  nand4  g096(.a(new_n151_), .b(new_n130_), .c(new_n129_), .d(new_n106_), .O(new_n152_));
  inv1   g097(.a(new_n152_), .O(new_n153_));
  nand2  g098(.a(new_n153_), .b(new_n98_), .O(new_n154_));
  nand2  g099(.a(new_n154_), .b(new_n150_), .O(new_n155_));
  nand2  g100(.a(new_n155_), .b(x16), .O(new_n156_));
  inv1   g101(.a(x01), .O(new_n157_));
  aoi21  g102(.a(new_n59_), .b(new_n157_), .c(x18), .O(new_n158_));
  nand2  g103(.a(new_n158_), .b(new_n156_), .O(z14));
  nor2   g104(.a(x21), .b(x20), .O(new_n160_));
  nand4  g105(.a(new_n115_), .b(new_n79_), .c(new_n160_), .d(new_n54_), .O(new_n161_));
  oai21  g106(.a(new_n152_), .b(new_n161_), .c(x34), .O(new_n162_));
  nand2  g107(.a(new_n129_), .b(new_n106_), .O(new_n163_));
  ...
  nand3  g117(.a(new_n172_), .b(new_n164_), .c(new_n98_), .O(new_n173_));
