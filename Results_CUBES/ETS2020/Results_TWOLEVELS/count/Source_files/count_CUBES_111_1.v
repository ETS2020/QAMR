...
module FAU ( 
  ...
  inv1   g040(.a(x22), .O(new_n94_));
  inv1   g041(.a(x23), .O(new_n95_));
  inv1   g042(.a(x25), .O(new_n96_));
  nand4  g043(.a(new_n96_), .b(new_n84_), .c(new_n95_), .d(new_n94_), .O(new_n97_));
  oai21  g044(.a(new_n97_), .b(new_n70_), .c(x26), .O(new_n98_));
  nor2   g045(.a(x23), .b(x22), .O(new_n99_));
  nor3   g046(.a(x26), .b(x25), .c(x24), .O(new_n100_));
  nand3  g047(.a(new_n100_), .b(new_n99_), .c(new_n71_), .O(new_n101_));
  ...
  nand4  g054(.a(new_n108_), .b(new_n86_), .c(new_n77_), .d(new_n63_), .O(new_n109_));
  inv1   g055(.a(x26), .O(new_n110_));
  nor2   g056(.a(x25), .b(x24), .O(new_n111_));
  nor2   g057(.a(x28), .b(x27), .O(new_n112_));
  nand4  g058(.a(new_n112_), .b(new_n111_), .c(new_n110_), .d(new_n95_), .O(new_n113_));
  nor2   g059(.a(new_n113_), .b(new_n78_), .O(new_n114_));
  aoi21  g060(.a(new_n109_), .b(x28), .c(new_n114_), .O(new_n115_));
  ...
  oai21  g064(.a(new_n113_), .b(new_n78_), .c(x29), .O(new_n119_));
  nor3   g065(.a(x29), .b(x28), .c(x27), .O(new_n120_));
  nand4  g066(.a(new_n120_), .b(new_n100_), .c(new_n79_), .d(new_n63_), .O(new_n121_));
  ...
  nand4  g072(.a(new_n99_), .b(new_n55_), .c(new_n69_), .d(new_n61_), .O(new_n128_));
  nor2   g073(.a(x26), .b(x25), .O(new_n129_));
  nor2   g074(.a(x30), .b(x29), .O(new_n130_));
  nand4  g075(.a(new_n130_), .b(new_n112_), .c(new_n129_), .d(new_n84_), .O(new_n131_));
  oai21  g076(.a(new_n131_), .b(new_n128_), .c(x31), .O(new_n132_));
  nand4  g077(.a(new_n84_), .b(new_n95_), .c(new_n94_), .d(new_n69_), .O(new_n133_));
  inv1   g078(.a(new_n133_), .O(new_n134_));
  inv1   g079(.a(x28), .O(new_n135_));
  inv1   g080(.a(x29), .O(new_n136_));
  inv1   g081(.a(x30), .O(new_n137_));
  inv1   g082(.a(x31), .O(new_n138_));
  nand4  g083(.a(new_n138_), .b(new_n137_), .c(new_n136_), .d(new_n135_), .O(new_n139_));
  inv1   g084(.a(new_n139_), .O(new_n140_));
  nand4  g085(.a(new_n140_), .b(new_n108_), .c(new_n134_), .d(new_n63_), .O(new_n141_));
  nand2  g086(.a(new_n141_), .b(new_n132_), .O(new_n142_));
  nand2  g087(.a(new_n142_), .b(x16), .O(new_n143_));
  inv1   g088(.a(x03), .O(new_n144_));
  aoi21  g089(.a(new_n58_), .b(new_n144_), .c(x18), .O(new_n145_));
  nand2  g090(.a(new_n145_), .b(new_n143_), .O(z12));
  nor2   g091(.a(x32), .b(x31), .O(new_n148_));
  nand4  g092(.a(new_n148_), .b(new_n130_), .c(new_n112_), .d(new_n129_), .O(new_n149_));
  oai21  g093(.a(new_n149_), .b(new_n87_), .c(x33), .O(new_n150_));
  inv1   g094(.a(new_n97_), .O(new_n151_));
  inv1   g095(.a(x27), .O(new_n152_));
  inv1   g096(.a(x32), .O(new_n153_));
  inv1   g097(.a(x33), .O(new_n154_));
  nand4  g098(.a(new_n154_), .b(new_n153_), .c(new_n152_), .d(new_n110_), .O(new_n155_));
  inv1   g099(.a(new_n155_), .O(new_n156_));
  nand4  g100(.a(new_n156_), .b(new_n140_), .c(new_n151_), .d(new_n71_), .O(new_n157_));
  nand2  g101(.a(new_n157_), .b(new_n150_), .O(new_n158_));
