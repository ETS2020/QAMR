...
module FAU ( 
  ...
  oai21  g035(.a(new_n88_), .b(new_n67_), .c(x26), .O(new_n89_));
  nor3   g036(.a(x26), .b(x25), .c(x24), .O(new_n90_));
  nand3  g037(.a(new_n90_), .b(new_n86_), .c(new_n68_), .O(new_n91_));
  nand2  g038(.a(new_n91_), .b(new_n89_), .O(new_n92_));
  nand2  g039(.a(new_n92_), .b(x16), .O(new_n93_));
  inv1   g040(.a(x08), .O(new_n94_));
  aoi21  g041(.a(new_n52_), .b(new_n94_), .c(x18), .O(new_n95_));
  nand2  g042(.a(new_n95_), .b(new_n93_), .O(z07));
  inv1   g043(.a(x27), .O(new_n97_));
  nor2   g044(.a(x26), .b(x25), .O(new_n98_));
  nor2   g045(.a(x24), .b(x23), .O(new_n99_));
  nand3  g046(.a(new_n99_), .b(new_n98_), .c(new_n97_), .O(new_n100_));
  nor2   g047(.a(new_n100_), .b(new_n78_), .O(new_n101_));
  aoi21  g048(.a(new_n91_), .b(x27), .c(new_n101_), .O(new_n102_));
  inv1   g049(.a(x07), .O(new_n103_));
  aoi21  g050(.a(new_n52_), .b(new_n103_), .c(x18), .O(new_n104_));
  oai21  g051(.a(new_n102_), .b(new_n52_), .c(new_n104_), .O(z08));
  nor3   g052(.a(x27), .b(x26), .c(x25), .O(new_n106_));
  nand4  g053(.a(new_n106_), .b(new_n99_), .c(new_n73_), .d(new_n60_), .O(new_n107_));
  inv1   g054(.a(x23), .O(new_n108_));
  inv1   g055(.a(x26), .O(new_n109_));
  nor2   g056(.a(x28), .b(x27), .O(new_n110_));
  nand4  g057(.a(new_n110_), .b(new_n87_), .c(new_n109_), .d(new_n108_), .O(new_n111_));
  nor2   g058(.a(new_n111_), .b(new_n78_), .O(new_n112_));
  ...
  oai21  g063(.a(new_n111_), .b(new_n78_), .c(x29), .O(new_n117_));
  nor3   g064(.a(x29), .b(x28), .c(x27), .O(new_n118_));
  nand4  g065(.a(new_n118_), .b(new_n90_), .c(new_n79_), .d(new_n60_), .O(new_n119_));
  ...
  nand4  g072(.a(new_n86_), .b(new_n58_), .c(new_n125_), .d(new_n57_), .O(new_n126_));
  inv1   g073(.a(x24), .O(new_n127_));
  nor2   g074(.a(x30), .b(x29), .O(new_n128_));
  nand4  g075(.a(new_n128_), .b(new_n110_), .c(new_n98_), .d(new_n127_), .O(new_n129_));
  ...
  nand4  g081(.a(new_n99_), .b(new_n73_), .c(new_n58_), .d(new_n57_), .O(new_n136_));
  nor2   g082(.a(x29), .b(x28), .O(new_n137_));
  nor2   g083(.a(x31), .b(x30), .O(new_n138_));
  nand4  g084(.a(new_n138_), .b(new_n137_), .c(new_n98_), .d(new_n97_), .O(new_n139_));
  oai21  g085(.a(new_n139_), .b(new_n136_), .c(x32), .O(new_n140_));
  inv1   g086(.a(x28), .O(new_n141_));
  inv1   g087(.a(x29), .O(new_n142_));
  inv1   g088(.a(x30), .O(new_n143_));
  nand4  g089(.a(new_n143_), .b(new_n142_), .c(new_n141_), .d(new_n97_), .O(new_n144_));
  inv1   g090(.a(new_n144_), .O(new_n145_));
  inv1   g091(.a(x22), .O(new_n146_));
  nand4  g092(.a(new_n127_), .b(new_n108_), .c(new_n146_), .d(new_n125_), .O(new_n147_));
  ...
  nand4  g099(.a(new_n153_), .b(new_n148_), .c(new_n145_), .d(new_n60_), .O(new_n154_));
