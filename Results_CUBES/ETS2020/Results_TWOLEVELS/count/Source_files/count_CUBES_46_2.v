...
module FAU ( 
  ...
  nand4  g075(.a(new_n128_), .b(new_n102_), .c(new_n79_), .d(new_n71_), .O(new_n129_));
  ...
  nand4  g081(.a(new_n98_), .b(new_n55_), .c(new_n64_), .d(new_n62_), .O(new_n135_));
  nor2   g082(.a(x26), .b(x25), .O(new_n136_));
  nor2   g083(.a(x30), .b(x29), .O(new_n137_));
  nand4  g084(.a(new_n137_), .b(new_n120_), .c(new_n136_), .d(new_n78_), .O(new_n138_));
  ...
  nand3  g095(.a(new_n148_), .b(new_n117_), .c(new_n83_), .O(new_n149_));
  ...
  nand4  g101(.a(new_n146_), .b(new_n145_), .c(new_n110_), .d(new_n90_), .O(new_n155_));
  oai21  g102(.a(new_n155_), .b(new_n82_), .c(x32), .O(new_n156_));
  nand2  g103(.a(new_n137_), .b(new_n120_), .O(new_n157_));
  inv1   g104(.a(x31), .O(new_n158_));
  inv1   g105(.a(x32), .O(new_n159_));
  nand4  g106(.a(new_n159_), .b(new_n158_), .c(new_n119_), .d(new_n90_), .O(new_n160_));
  nor2   g107(.a(new_n160_), .b(new_n157_), .O(new_n161_));
  nand2  g108(.a(new_n161_), .b(new_n83_), .O(new_n162_));
  ...
  nor2   g114(.a(x33), .b(x32), .O(new_n169_));
  nand4  g115(.a(new_n169_), .b(new_n146_), .c(new_n145_), .d(new_n110_), .O(new_n170_));
  oai21  g116(.a(new_n170_), .b(new_n100_), .c(x34), .O(new_n171_));
  nand2  g117(.a(new_n145_), .b(new_n110_), .O(new_n172_));
  inv1   g118(.a(new_n172_), .O(new_n173_));
  inv1   g119(.a(x30), .O(new_n174_));
  nand2  g120(.a(new_n158_), .b(new_n174_), .O(new_n175_));
  inv1   g121(.a(x33), .O(new_n176_));
  inv1   g122(.a(x34), .O(new_n177_));
  nand3  g123(.a(new_n177_), .b(new_n176_), .c(new_n159_), .O(new_n178_));
  nor2   g124(.a(new_n178_), .b(new_n175_), .O(new_n179_));
  nand3  g125(.a(new_n179_), .b(new_n173_), .c(new_n92_), .O(new_n180_));
  nand2  g126(.a(new_n180_), .b(new_n171_), .O(new_n181_));
