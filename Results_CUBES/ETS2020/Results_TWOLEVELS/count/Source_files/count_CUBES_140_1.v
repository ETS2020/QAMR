// Benchmark "FAU" written by ABC on Tue Jul  7 19:19:20 2020
...
module FAU ( 
  ...
  nand4  g075(.a(new_n128_), .b(new_n101_), .c(new_n82_), .d(new_n63_), .O(new_n129_));
  nand4  g076(.a(new_n92_), .b(new_n55_), .c(new_n69_), .d(new_n61_), .O(new_n130_));
  inv1   g077(.a(x24), .O(new_n131_));
  nor2   g078(.a(x26), .b(x25), .O(new_n132_));
  nor2   g079(.a(x30), .b(x29), .O(new_n133_));
  nand4  g080(.a(new_n133_), .b(new_n120_), .c(new_n132_), .d(new_n131_), .O(new_n134_));
  nor2   g081(.a(new_n134_), .b(new_n130_), .O(new_n135_));
  aoi21  g082(.a(new_n129_), .b(x30), .c(new_n135_), .O(new_n136_));
  ...
  oai21  g086(.a(new_n134_), .b(new_n130_), .c(x31), .O(new_n140_));
  inv1   g087(.a(x22), .O(new_n141_));
  nand4  g088(.a(new_n131_), .b(new_n119_), .c(new_n141_), .d(new_n69_), .O(new_n142_));
  inv1   g089(.a(new_n142_), .O(new_n143_));
  inv1   g090(.a(x28), .O(new_n144_));
  inv1   g091(.a(x29), .O(new_n145_));
  inv1   g092(.a(x30), .O(new_n146_));
  inv1   g093(.a(x31), .O(new_n147_));
  nand4  g094(.a(new_n147_), .b(new_n146_), .c(new_n145_), .d(new_n144_), .O(new_n148_));
  inv1   g095(.a(new_n148_), .O(new_n149_));
  nand4  g096(.a(new_n149_), .b(new_n117_), .c(new_n143_), .d(new_n63_), .O(new_n150_));
  nand2  g097(.a(new_n150_), .b(new_n140_), .O(new_n151_));
  ...
  nor2   g102(.a(x32), .b(x31), .O(new_n157_));
  nand4  g103(.a(new_n157_), .b(new_n133_), .c(new_n120_), .d(new_n132_), .O(new_n158_));
  oai21  g104(.a(new_n158_), .b(new_n89_), .c(x33), .O(new_n159_));
  nand4  g105(.a(new_n108_), .b(new_n131_), .c(new_n119_), .d(new_n141_), .O(new_n160_));
  inv1   g106(.a(new_n160_), .O(new_n161_));
  inv1   g107(.a(x32), .O(new_n162_));
  inv1   g108(.a(x33), .O(new_n163_));
  nand4  g109(.a(new_n163_), .b(new_n162_), .c(new_n110_), .d(new_n109_), .O(new_n164_));
  inv1   g110(.a(new_n164_), .O(new_n165_));
  nand4  g111(.a(new_n165_), .b(new_n149_), .c(new_n161_), .d(new_n71_), .O(new_n166_));
  nand2  g112(.a(new_n166_), .b(new_n159_), .O(new_n167_));
  nand2  g113(.a(new_n167_), .b(x16), .O(new_n168_));
  inv1   g114(.a(x01), .O(new_n169_));
  aoi21  g115(.a(new_n58_), .b(new_n169_), .c(x18), .O(new_n170_));
