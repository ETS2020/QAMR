...
module FAU ( 
  ...
  nand3  g054(.a(new_n109_), .b(new_n108_), .c(new_n87_), .O(new_n110_));
  nor2   g055(.a(new_n110_), .b(new_n97_), .O(new_n111_));
  aoi21  g056(.a(new_n107_), .b(x28), .c(new_n111_), .O(new_n112_));
  ...
  nand4  g062(.a(new_n117_), .b(new_n90_), .c(new_n75_), .d(new_n67_), .O(new_n118_));
  ...
  nand4  g068(.a(new_n86_), .b(new_n56_), .c(new_n60_), .d(new_n55_), .O(new_n124_));
  ...
  nand4  g079(.a(new_n135_), .b(new_n134_), .c(new_n99_), .d(new_n98_), .O(new_n136_));
  oai21  g080(.a(new_n136_), .b(new_n78_), .c(x32), .O(new_n137_));
  nor2   g081(.a(x32), .b(x31), .O(new_n138_));
  nand4  g082(.a(new_n138_), .b(new_n126_), .c(new_n108_), .d(new_n125_), .O(new_n139_));
  inv1   g083(.a(new_n139_), .O(new_n140_));
  nand2  g084(.a(new_n140_), .b(new_n79_), .O(new_n141_));
  nand2  g085(.a(new_n141_), .b(new_n137_), .O(new_n142_));
  nand2  g086(.a(new_n142_), .b(x16), .O(new_n143_));
  inv1   g087(.a(x02), .O(new_n144_));
  aoi21  g088(.a(new_n54_), .b(new_n144_), .c(x18), .O(new_n145_));
  nand2  g089(.a(new_n145_), .b(new_n143_), .O(z13));
  oai21  g090(.a(new_n139_), .b(new_n78_), .c(x33), .O(new_n147_));
  inv1   g091(.a(x22), .O(new_n148_));
  inv1   g092(.a(x23), .O(new_n149_));
  nand4  g093(.a(new_n98_), .b(new_n74_), .c(new_n149_), .d(new_n148_), .O(new_n150_));
  nor2   g094(.a(new_n150_), .b(new_n61_), .O(new_n151_));
  nor2   g095(.a(x33), .b(x32), .O(new_n152_));
  nand4  g096(.a(new_n152_), .b(new_n135_), .c(new_n134_), .d(new_n99_), .O(new_n153_));
  ...
  nand2  g105(.a(new_n134_), .b(new_n99_), .O(new_n162_));
  ...
  aoi21  g119(.a(new_n54_), .b(new_n175_), .c(x18), .O(new_n176_));
