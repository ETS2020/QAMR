...
module FAU ( 
  ...
  nand4  g072(.a(new_n98_), .b(new_n72_), .c(new_n60_), .d(new_n59_), .O(new_n127_));
  nor2   g073(.a(x26), .b(x25), .O(new_n128_));
  nor2   g074(.a(x30), .b(x29), .O(new_n129_));
  nand4  g075(.a(new_n129_), .b(new_n112_), .c(new_n128_), .d(new_n79_), .O(new_n130_));
  ...
  nand4  g082(.a(new_n79_), .b(new_n89_), .c(new_n88_), .d(new_n60_), .O(new_n137_));
  ...
  nand4  g090(.a(new_n144_), .b(new_n108_), .c(new_n138_), .d(new_n55_), .O(new_n145_));
  ...
  nand4  g098(.a(new_n152_), .b(new_n151_), .c(new_n101_), .d(new_n90_), .O(new_n153_));
  oai21  g099(.a(new_n153_), .b(new_n82_), .c(x32), .O(new_n154_));
  ...
  nand4  g104(.a(new_n158_), .b(new_n142_), .c(new_n110_), .d(new_n90_), .O(new_n159_));
  inv1   g105(.a(new_n159_), .O(new_n160_));
  nand4  g106(.a(new_n160_), .b(new_n157_), .c(new_n138_), .d(new_n55_), .O(new_n161_));
  nand2  g107(.a(new_n161_), .b(new_n154_), .O(new_n162_));
  nand2  g108(.a(new_n162_), .b(x16), .O(new_n163_));
  inv1   g109(.a(x02), .O(new_n164_));
  aoi21  g110(.a(new_n54_), .b(new_n164_), .c(x18), .O(new_n165_));
  nand2  g111(.a(new_n165_), .b(new_n163_), .O(z13));
  nor2   g112(.a(x32), .b(x31), .O(new_n167_));
  nand4  g113(.a(new_n167_), .b(new_n129_), .c(new_n112_), .d(new_n128_), .O(new_n168_));
  oai21  g114(.a(new_n168_), .b(new_n82_), .c(x33), .O(new_n169_));
  inv1   g115(.a(x33), .O(new_n170_));
  nand4  g116(.a(new_n170_), .b(new_n158_), .c(new_n155_), .d(new_n110_), .O(new_n171_));
  inv1   g117(.a(new_n171_), .O(new_n172_));
  nand4  g118(.a(new_n172_), .b(new_n144_), .c(new_n92_), .d(new_n62_), .O(new_n173_));
  nand2  g119(.a(new_n173_), .b(new_n169_), .O(new_n174_));
  nand2  g120(.a(new_n174_), .b(x16), .O(new_n175_));
  inv1   g121(.a(x01), .O(new_n176_));
  aoi21  g122(.a(new_n54_), .b(new_n176_), .c(x18), .O(new_n177_));
