...
module FAU ( 
  ...
  nand3  g092(.a(new_n145_), .b(new_n114_), .c(new_n81_), .O(new_n146_));
  ...
  nand4  g098(.a(new_n143_), .b(new_n142_), .c(new_n107_), .d(new_n90_), .O(new_n152_));
  oai21  g099(.a(new_n152_), .b(new_n80_), .c(x32), .O(new_n153_));
  nor2   g100(.a(x32), .b(x31), .O(new_n154_));
  nand4  g101(.a(new_n154_), .b(new_n134_), .c(new_n117_), .d(new_n133_), .O(new_n155_));
  inv1   g102(.a(new_n155_), .O(new_n156_));
  nand2  g103(.a(new_n156_), .b(new_n81_), .O(new_n157_));
  ...
  oai21  g109(.a(new_n155_), .b(new_n80_), .c(x33), .O(new_n163_));
  nor2   g110(.a(x33), .b(x32), .O(new_n164_));
  nand4  g111(.a(new_n164_), .b(new_n143_), .c(new_n142_), .d(new_n107_), .O(new_n165_));
  inv1   g112(.a(new_n165_), .O(new_n166_));
  nand2  g113(.a(new_n166_), .b(new_n92_), .O(new_n167_));
  ...
  nand4  g119(.a(new_n116_), .b(new_n99_), .c(new_n98_), .d(new_n55_), .O(new_n173_));
  oai21  g120(.a(new_n165_), .b(new_n173_), .c(x34), .O(new_n174_));
  nand2  g121(.a(new_n142_), .b(new_n107_), .O(new_n175_));
  ...
  nand3  g131(.a(new_n184_), .b(new_n176_), .c(new_n92_), .O(new_n185_));
