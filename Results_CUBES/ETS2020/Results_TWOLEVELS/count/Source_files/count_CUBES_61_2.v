...
module FAU ( 
  ...
  nand4  g072(.a(new_n125_), .b(new_n104_), .c(new_n79_), .d(new_n63_), .O(new_n126_));
  ...
  nand4  g078(.a(new_n103_), .b(new_n55_), .c(new_n69_), .d(new_n61_), .O(new_n132_));
  ...
  nand3  g092(.a(new_n145_), .b(new_n113_), .c(new_n88_), .O(new_n146_));
  ...
  nand2  g104(.a(new_n158_), .b(new_n97_), .O(new_n159_));
  ...
  nand4  g111(.a(new_n115_), .b(new_n103_), .c(new_n165_), .d(new_n55_), .O(new_n166_));
