...
module FAU ( 
  ...
  nor2   g067(.a(x28), .b(x27), .O(new_n121_));
  nor2   g068(.a(x26), .b(x23), .O(new_n122_));
  nand3  g069(.a(new_n122_), .b(new_n121_), .c(new_n103_), .O(new_n123_));
  ...
  nand4  g078(.a(new_n102_), .b(new_n54_), .c(new_n65_), .d(new_n53_), .O(new_n132_));
  nor2   g079(.a(x26), .b(x25), .O(new_n133_));
  nor2   g080(.a(x30), .b(x29), .O(new_n134_));
  nand4  g081(.a(new_n134_), .b(new_n121_), .c(new_n133_), .d(new_n83_), .O(new_n135_));
  ...
  aoi21  g085(.a(new_n59_), .b(new_n138_), .c(x18), .O(new_n139_));
  oai21  g086(.a(new_n137_), .b(new_n59_), .c(new_n139_), .O(z11));
  ...
  nand4  g102(.a(new_n155_), .b(new_n134_), .c(new_n121_), .d(new_n133_), .O(new_n156_));
  ...
  aoi21  g108(.a(new_n59_), .b(new_n161_), .c(x18), .O(new_n162_));
  ...
  aoi21  g118(.a(new_n59_), .b(new_n171_), .c(x18), .O(new_n172_));
