// Benchmark "FAU" written by ABC on Tue Jul  7 19:19:33 2020
...
module FAU ( 
  ...
  nor3   g080(.a(x29), .b(x28), .c(x27), .O(new_n133_));
  nand4  g081(.a(new_n133_), .b(new_n107_), .c(new_n82_), .d(new_n63_), .O(new_n134_));
  nand4  g082(.a(new_n106_), .b(new_n55_), .c(new_n69_), .d(new_n61_), .O(new_n135_));
  nor2   g083(.a(x26), .b(x25), .O(new_n136_));
  nor2   g084(.a(x30), .b(x29), .O(new_n137_));
  nand4  g085(.a(new_n137_), .b(new_n125_), .c(new_n136_), .d(new_n87_), .O(new_n138_));
  nor2   g086(.a(new_n138_), .b(new_n135_), .O(new_n139_));
  aoi21  g087(.a(new_n134_), .b(x30), .c(new_n139_), .O(new_n140_));
  ...
  nand4  g092(.a(new_n87_), .b(new_n97_), .c(new_n96_), .d(new_n69_), .O(new_n145_));
  inv1   g093(.a(new_n145_), .O(new_n146_));
  inv1   g094(.a(x28), .O(new_n147_));
  inv1   g095(.a(x29), .O(new_n148_));
  inv1   g096(.a(x30), .O(new_n149_));
  inv1   g097(.a(x31), .O(new_n150_));
  nand4  g098(.a(new_n150_), .b(new_n149_), .c(new_n148_), .d(new_n147_), .O(new_n151_));
  inv1   g099(.a(new_n151_), .O(new_n152_));
  nand4  g100(.a(new_n152_), .b(new_n121_), .c(new_n146_), .d(new_n63_), .O(new_n153_));
  nand2  g101(.a(new_n153_), .b(new_n144_), .O(new_n154_));
  ...
  nor2   g106(.a(x29), .b(x28), .O(new_n159_));
  nor2   g107(.a(x31), .b(x30), .O(new_n160_));
  nand4  g108(.a(new_n160_), .b(new_n159_), .c(new_n114_), .d(new_n98_), .O(new_n161_));
  oai21  g109(.a(new_n161_), .b(new_n90_), .c(x32), .O(new_n162_));
  inv1   g110(.a(x27), .O(new_n163_));
  nand4  g111(.a(new_n149_), .b(new_n148_), .c(new_n147_), .d(new_n163_), .O(new_n164_));
  inv1   g112(.a(new_n164_), .O(new_n165_));
  inv1   g113(.a(x32), .O(new_n166_));
  nand4  g114(.a(new_n166_), .b(new_n150_), .c(new_n123_), .d(new_n98_), .O(new_n167_));
  inv1   g115(.a(new_n167_), .O(new_n168_));
  nand4  g116(.a(new_n168_), .b(new_n165_), .c(new_n146_), .d(new_n63_), .O(new_n169_));
  nand2  g117(.a(new_n169_), .b(new_n162_), .O(new_n170_));
  nand2  g118(.a(new_n170_), .b(x16), .O(new_n171_));
  inv1   g119(.a(x02), .O(new_n172_));
  aoi21  g120(.a(new_n58_), .b(new_n172_), .c(x18), .O(new_n173_));
  nand2  g121(.a(new_n173_), .b(new_n171_), .O(z13));
  nor2   g122(.a(x32), .b(x31), .O(new_n175_));
  nand4  g123(.a(new_n175_), .b(new_n137_), .c(new_n125_), .d(new_n136_), .O(new_n176_));
  oai21  g124(.a(new_n176_), .b(new_n90_), .c(x33), .O(new_n177_));
  inv1   g125(.a(x33), .O(new_n178_));
  nand4  g126(.a(new_n178_), .b(new_n166_), .c(new_n163_), .d(new_n123_), .O(new_n179_));
  inv1   g127(.a(new_n179_), .O(new_n180_));
  nand4  g128(.a(new_n180_), .b(new_n152_), .c(new_n100_), .d(new_n71_), .O(new_n181_));
  nand2  g129(.a(new_n181_), .b(new_n177_), .O(new_n182_));
  nand2  g130(.a(new_n182_), .b(x16), .O(new_n183_));
  inv1   g131(.a(x01), .O(new_n184_));
  aoi21  g132(.a(new_n58_), .b(new_n184_), .c(x18), .O(new_n185_));
  nand2  g133(.a(new_n185_), .b(new_n183_), .O(z14));
  zero   g134(.O(z10));
  zero   g135(.O(z15));
endmodule
