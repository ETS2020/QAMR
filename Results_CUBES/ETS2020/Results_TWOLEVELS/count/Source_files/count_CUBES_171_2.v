...
module FAU ( 
  ...
  nand3  g044(.a(new_n98_), .b(new_n84_), .c(new_n97_), .O(new_n99_));
  nor2   g045(.a(new_n99_), .b(new_n76_), .O(new_n100_));
  ...
  nand4  g051(.a(new_n105_), .b(new_n84_), .c(new_n71_), .d(new_n63_), .O(new_n106_));
  ...
  nand4  g063(.a(new_n117_), .b(new_n95_), .c(new_n77_), .d(new_n63_), .O(new_n118_));
  ...
  nand4  g072(.a(new_n127_), .b(new_n107_), .c(new_n126_), .d(new_n82_), .O(new_n128_));
  ...
  nand3  g078(.a(new_n133_), .b(new_n105_), .c(new_n86_), .O(new_n134_));
  ...
  oai21  g085(.a(new_n140_), .b(new_n85_), .c(x32), .O(new_n141_));
  nor2   g086(.a(x32), .b(x31), .O(new_n142_));
  nand4  g087(.a(new_n142_), .b(new_n127_), .c(new_n107_), .d(new_n126_), .O(new_n143_));
  ...
  oai21  g095(.a(new_n143_), .b(new_n85_), .c(x33), .O(new_n151_));
  inv1   g096(.a(x22), .O(new_n152_));
  inv1   g097(.a(x23), .O(new_n153_));
  nand4  g098(.a(new_n97_), .b(new_n82_), .c(new_n153_), .d(new_n152_), .O(new_n154_));
  nor2   g099(.a(new_n154_), .b(new_n70_), .O(new_n155_));
  nor2   g100(.a(x33), .b(x32), .O(new_n156_));
  nand4  g101(.a(new_n156_), .b(new_n131_), .c(new_n130_), .d(new_n98_), .O(new_n157_));
  ...
  nand4  g109(.a(new_n108_), .b(new_n94_), .c(new_n93_), .d(new_n55_), .O(new_n165_));
  oai21  g110(.a(new_n157_), .b(new_n165_), .c(x34), .O(new_n166_));
  nand2  g111(.a(new_n130_), .b(new_n98_), .O(new_n167_));
  ...
  nand3  g121(.a(new_n176_), .b(new_n168_), .c(new_n155_), .O(new_n177_));
