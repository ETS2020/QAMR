...
module FAU ( 
  ...
  nand3  g063(.a(new_n117_), .b(new_n116_), .c(new_n104_), .O(new_n118_));
  oai21  g064(.a(new_n118_), .b(new_n78_), .c(x29), .O(new_n119_));
  nor3   g065(.a(x29), .b(x28), .c(x27), .O(new_n120_));
  nand4  g066(.a(new_n120_), .b(new_n107_), .c(new_n79_), .d(new_n63_), .O(new_n121_));
  ...
  nand3  g087(.a(new_n141_), .b(new_n137_), .c(new_n88_), .O(new_n142_));
  ...
  nand4  g094(.a(new_n139_), .b(new_n138_), .c(new_n148_), .d(new_n95_), .O(new_n149_));
  oai21  g095(.a(new_n149_), .b(new_n87_), .c(x32), .O(new_n150_));
  ...
  oai21  g105(.a(new_n152_), .b(new_n87_), .c(x33), .O(new_n160_));
  ...
  nand2  g109(.a(new_n163_), .b(new_n97_), .O(new_n164_));
  ...
  oai21  g115(.a(new_n162_), .b(new_n105_), .c(x34), .O(new_n170_));
  ...
  nand3  g126(.a(new_n180_), .b(new_n172_), .c(new_n97_), .O(new_n181_));
