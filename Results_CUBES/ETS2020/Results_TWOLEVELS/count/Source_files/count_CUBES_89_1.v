...
module FAU ( 
  ...
  nand3  g020(.a(new_n73_), .b(new_n55_), .c(new_n65_), .O(new_n74_));
  nor3   g021(.a(x23), .b(x22), .c(x21), .O(new_n75_));
  aoi22  g022(.a(new_n75_), .b(new_n63_), .c(new_n74_), .d(x23), .O(new_n76_));
  ...
  nand4  g027(.a(new_n81_), .b(new_n73_), .c(new_n55_), .d(new_n65_), .O(new_n82_));
  ...
  nand4  g058(.a(new_n112_), .b(new_n81_), .c(new_n73_), .d(new_n63_), .O(new_n113_));
  ...
  nand4  g069(.a(new_n123_), .b(new_n98_), .c(new_n75_), .d(new_n63_), .O(new_n124_));
  ...
  nand4  g077(.a(new_n133_), .b(new_n132_), .c(new_n105_), .d(new_n86_), .O(new_n134_));
  oai21  g078(.a(new_n134_), .b(new_n82_), .c(x32), .O(new_n135_));
  nand2  g079(.a(new_n81_), .b(new_n73_), .O(new_n136_));
  inv1   g080(.a(new_n136_), .O(new_n137_));
  nor2   g081(.a(x30), .b(x29), .O(new_n138_));
  nor2   g082(.a(x32), .b(x31), .O(new_n139_));
  nand2  g083(.a(new_n139_), .b(new_n138_), .O(new_n140_));
  inv1   g084(.a(new_n140_), .O(new_n141_));
  nor2   g085(.a(x26), .b(x25), .O(new_n142_));
  nand2  g086(.a(new_n114_), .b(new_n142_), .O(new_n143_));
  inv1   g087(.a(new_n143_), .O(new_n144_));
  nand4  g088(.a(new_n144_), .b(new_n141_), .c(new_n137_), .d(new_n63_), .O(new_n145_));
  nand2  g089(.a(new_n145_), .b(new_n135_), .O(new_n146_));
  ...
  nand4  g094(.a(new_n139_), .b(new_n138_), .c(new_n114_), .d(new_n142_), .O(new_n151_));
  oai21  g095(.a(new_n151_), .b(new_n82_), .c(x33), .O(new_n152_));
  nor2   g096(.a(x33), .b(x32), .O(new_n153_));
  nand4  g097(.a(new_n153_), .b(new_n133_), .c(new_n132_), .d(new_n105_), .O(new_n154_));
  inv1   g098(.a(new_n154_), .O(new_n155_));
  nand2  g099(.a(new_n155_), .b(new_n88_), .O(new_n156_));
  ...
  oai21  g105(.a(new_n154_), .b(new_n96_), .c(x34), .O(new_n162_));
  nand2  g106(.a(new_n132_), .b(new_n105_), .O(new_n163_));
  inv1   g107(.a(new_n163_), .O(new_n164_));
  inv1   g108(.a(x30), .O(new_n165_));
  inv1   g109(.a(x31), .O(new_n166_));
  nand2  g110(.a(new_n166_), .b(new_n165_), .O(new_n167_));
  inv1   g111(.a(x32), .O(new_n168_));
  inv1   g112(.a(x33), .O(new_n169_));
  inv1   g113(.a(x34), .O(new_n170_));
  nand3  g114(.a(new_n170_), .b(new_n169_), .c(new_n168_), .O(new_n171_));
  nor2   g115(.a(new_n171_), .b(new_n167_), .O(new_n172_));
  nand3  g116(.a(new_n172_), .b(new_n164_), .c(new_n88_), .O(new_n173_));
  nand2  g117(.a(new_n173_), .b(new_n162_), .O(new_n174_));
  nand2  g118(.a(new_n174_), .b(x16), .O(new_n175_));
  inv1   g119(.a(x00), .O(new_n176_));
  aoi21  g120(.a(new_n58_), .b(new_n176_), .c(x18), .O(new_n177_));
