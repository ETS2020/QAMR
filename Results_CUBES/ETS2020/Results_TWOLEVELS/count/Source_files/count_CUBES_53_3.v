...
module FAU ( 
  ...
  oai21  g055(.a(new_n110_), .b(new_n97_), .c(x29), .O(new_n111_));
  nor3   g056(.a(x29), .b(x28), .c(x27), .O(new_n112_));
  nand4  g057(.a(new_n112_), .b(new_n95_), .c(new_n83_), .d(new_n63_), .O(new_n113_));
  ...
  nand4  g063(.a(new_n94_), .b(new_n55_), .c(new_n69_), .d(new_n61_), .O(new_n119_));
  nor2   g064(.a(x26), .b(x25), .O(new_n120_));
  nor2   g065(.a(x30), .b(x29), .O(new_n121_));
  nand4  g066(.a(new_n121_), .b(new_n107_), .c(new_n120_), .d(new_n82_), .O(new_n122_));
  ...
  nand4  g073(.a(new_n130_), .b(new_n121_), .c(new_n107_), .d(new_n120_), .O(new_n131_));
  oai21  g074(.a(new_n131_), .b(new_n86_), .c(x33), .O(new_n132_));
  inv1   g075(.a(x22), .O(new_n133_));
  inv1   g076(.a(x23), .O(new_n134_));
  nand4  g077(.a(new_n98_), .b(new_n82_), .c(new_n134_), .d(new_n133_), .O(new_n135_));
  nor2   g078(.a(new_n135_), .b(new_n70_), .O(new_n136_));
  nor2   g079(.a(x29), .b(x28), .O(new_n137_));
  nor2   g080(.a(x31), .b(x30), .O(new_n138_));
  nor2   g081(.a(x33), .b(x32), .O(new_n139_));
  nand4  g082(.a(new_n139_), .b(new_n138_), .c(new_n137_), .d(new_n99_), .O(new_n140_));
  inv1   g083(.a(new_n140_), .O(new_n141_));
  nand2  g084(.a(new_n141_), .b(new_n136_), .O(new_n142_));
  nand2  g085(.a(new_n142_), .b(new_n132_), .O(new_n143_));
  ...
  nand4  g091(.a(new_n108_), .b(new_n94_), .c(new_n148_), .d(new_n55_), .O(new_n149_));
  oai21  g092(.a(new_n140_), .b(new_n149_), .c(x34), .O(new_n150_));
  nand2  g093(.a(new_n137_), .b(new_n99_), .O(new_n151_));
  ...
  nand3  g103(.a(new_n160_), .b(new_n152_), .c(new_n136_), .O(new_n161_));
