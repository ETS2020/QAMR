...
module FAU ( 
  ...
  inv1   g042(.a(x25), .O(new_n97_));
  nor2   g043(.a(x27), .b(x26), .O(new_n98_));
  nand3  g044(.a(new_n98_), .b(new_n85_), .c(new_n97_), .O(new_n99_));
  nor2   g045(.a(new_n99_), .b(new_n77_), .O(new_n100_));
  aoi21  g046(.a(new_n96_), .b(x27), .c(new_n100_), .O(new_n101_));
  inv1   g047(.a(x07), .O(new_n102_));
  aoi21  g048(.a(new_n58_), .b(new_n102_), .c(x18), .O(new_n103_));
  oai21  g049(.a(new_n101_), .b(new_n58_), .c(new_n103_), .O(z08));
  nor3   g050(.a(x25), .b(x24), .c(x23), .O(new_n105_));
  nand4  g051(.a(new_n105_), .b(new_n98_), .c(new_n72_), .d(new_n62_), .O(new_n106_));
  nor2   g052(.a(x28), .b(x27), .O(new_n107_));
  nor2   g053(.a(x25), .b(x24), .O(new_n108_));
  nor2   g054(.a(x26), .b(x23), .O(new_n109_));
  nand3  g055(.a(new_n109_), .b(new_n108_), .c(new_n107_), .O(new_n110_));
  ...
  nand4  g063(.a(new_n117_), .b(new_n95_), .c(new_n78_), .d(new_n62_), .O(new_n118_));
  ...
  nand4  g069(.a(new_n94_), .b(new_n55_), .c(new_n65_), .d(new_n64_), .O(new_n124_));
  nor2   g070(.a(x26), .b(x25), .O(new_n125_));
  nor2   g071(.a(x30), .b(x29), .O(new_n126_));
  nand4  g072(.a(new_n126_), .b(new_n107_), .c(new_n125_), .d(new_n83_), .O(new_n127_));
  ...
  nand4  g079(.a(new_n135_), .b(new_n126_), .c(new_n107_), .d(new_n125_), .O(new_n136_));
  oai21  g080(.a(new_n136_), .b(new_n86_), .c(x33), .O(new_n137_));
  inv1   g081(.a(x22), .O(new_n138_));
  inv1   g082(.a(x23), .O(new_n139_));
  nand4  g083(.a(new_n97_), .b(new_n83_), .c(new_n139_), .d(new_n138_), .O(new_n140_));
  nor2   g084(.a(new_n140_), .b(new_n66_), .O(new_n141_));
  nor2   g085(.a(x29), .b(x28), .O(new_n142_));
  nor2   g086(.a(x31), .b(x30), .O(new_n143_));
  nor2   g087(.a(x33), .b(x32), .O(new_n144_));
  nand4  g088(.a(new_n144_), .b(new_n143_), .c(new_n142_), .d(new_n98_), .O(new_n145_));
  inv1   g089(.a(new_n145_), .O(new_n146_));
  nand2  g090(.a(new_n146_), .b(new_n141_), .O(new_n147_));
  nand2  g091(.a(new_n147_), .b(new_n137_), .O(new_n148_));
  ...
  nor2   g096(.a(x21), .b(x20), .O(new_n153_));
  nand4  g097(.a(new_n108_), .b(new_n94_), .c(new_n153_), .d(new_n55_), .O(new_n154_));
  oai21  g098(.a(new_n145_), .b(new_n154_), .c(x34), .O(new_n155_));
  nand2  g099(.a(new_n142_), .b(new_n98_), .O(new_n156_));
  ...
  nand3  g109(.a(new_n165_), .b(new_n157_), .c(new_n141_), .O(new_n166_));
