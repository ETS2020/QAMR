...
module FAU ( 
  ...
  nand4  g084(.a(new_n102_), .b(new_n55_), .c(new_n69_), .d(new_n61_), .O(new_n137_));
  nor2   g085(.a(x26), .b(x25), .O(new_n138_));
  nor2   g086(.a(x30), .b(x29), .O(new_n139_));
  nand4  g087(.a(new_n139_), .b(new_n122_), .c(new_n138_), .d(new_n82_), .O(new_n140_));
  ...
  nand4  g094(.a(new_n82_), .b(new_n93_), .c(new_n92_), .d(new_n69_), .O(new_n147_));
  ...
  nand4  g110(.a(new_n162_), .b(new_n161_), .c(new_n111_), .d(new_n94_), .O(new_n163_));
  oai21  g111(.a(new_n163_), .b(new_n86_), .c(x32), .O(new_n164_));
  ...
  nand4  g116(.a(new_n168_), .b(new_n152_), .c(new_n120_), .d(new_n94_), .O(new_n169_));
  ...
  oai21  g126(.a(new_n178_), .b(new_n86_), .c(x33), .O(new_n179_));
  ...
  nand4  g130(.a(new_n182_), .b(new_n154_), .c(new_n96_), .d(new_n71_), .O(new_n183_));
