...
module FAU ( 
  ...
  nand4  g056(.a(new_n110_), .b(new_n109_), .c(new_n108_), .d(new_n107_), .O(new_n111_));
  nor2   g057(.a(new_n111_), .b(new_n77_), .O(new_n112_));
  aoi21  g058(.a(new_n106_), .b(x28), .c(new_n112_), .O(new_n113_));
  inv1   g059(.a(x06), .O(new_n114_));
  aoi21  g060(.a(new_n59_), .b(new_n114_), .c(x18), .O(new_n115_));
  oai21  g061(.a(new_n113_), .b(new_n59_), .c(new_n115_), .O(z09));
  inv1   g062(.a(x29), .O(new_n117_));
  nor3   g063(.a(x29), .b(x28), .c(x27), .O(new_n118_));
  nand4  g064(.a(new_n118_), .b(new_n95_), .c(new_n78_), .d(new_n56_), .O(new_n119_));
  ...
  nand4  g070(.a(new_n94_), .b(new_n54_), .c(new_n65_), .d(new_n53_), .O(new_n125_));
  nor2   g071(.a(x26), .b(x25), .O(new_n126_));
  nor2   g072(.a(x30), .b(x29), .O(new_n127_));
  nand4  g073(.a(new_n127_), .b(new_n109_), .c(new_n126_), .d(new_n83_), .O(new_n128_));
  ...
  nand4  g081(.a(new_n136_), .b(new_n135_), .c(new_n98_), .d(new_n97_), .O(new_n137_));
  oai21  g082(.a(new_n137_), .b(new_n86_), .c(x32), .O(new_n138_));
  nand2  g083(.a(new_n127_), .b(new_n109_), .O(new_n139_));
  inv1   g084(.a(x31), .O(new_n140_));
  inv1   g085(.a(x32), .O(new_n141_));
  nand4  g086(.a(new_n141_), .b(new_n140_), .c(new_n108_), .d(new_n97_), .O(new_n142_));
  nor2   g087(.a(new_n142_), .b(new_n139_), .O(new_n143_));
  nand2  g088(.a(new_n143_), .b(new_n87_), .O(new_n144_));
  nand2  g089(.a(new_n144_), .b(new_n138_), .O(new_n145_));
  ...
  nor2   g094(.a(x21), .b(x20), .O(new_n151_));
  nand4  g095(.a(new_n110_), .b(new_n94_), .c(new_n151_), .d(new_n54_), .O(new_n152_));
  nor2   g096(.a(x33), .b(x32), .O(new_n153_));
  nand4  g097(.a(new_n153_), .b(new_n136_), .c(new_n135_), .d(new_n98_), .O(new_n154_));
  oai21  g098(.a(new_n154_), .b(new_n152_), .c(x34), .O(new_n155_));
  inv1   g099(.a(x22), .O(new_n156_));
  nand4  g100(.a(new_n97_), .b(new_n83_), .c(new_n107_), .d(new_n156_), .O(new_n157_));
  nor2   g101(.a(new_n157_), .b(new_n66_), .O(new_n158_));
  nand2  g102(.a(new_n135_), .b(new_n98_), .O(new_n159_));
  inv1   g103(.a(new_n159_), .O(new_n160_));
  inv1   g104(.a(x30), .O(new_n161_));
  nand2  g105(.a(new_n140_), .b(new_n161_), .O(new_n162_));
  inv1   g106(.a(x33), .O(new_n163_));
  inv1   g107(.a(x34), .O(new_n164_));
  nand3  g108(.a(new_n164_), .b(new_n163_), .c(new_n141_), .O(new_n165_));
  nor2   g109(.a(new_n165_), .b(new_n162_), .O(new_n166_));
  nand3  g110(.a(new_n166_), .b(new_n160_), .c(new_n158_), .O(new_n167_));
  nand2  g111(.a(new_n167_), .b(new_n155_), .O(new_n168_));
