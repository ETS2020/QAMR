...
module FAU ( 
  ...
  nand2  g019(.a(new_n72_), .b(x23), .O(new_n73_));
  nor2   g020(.a(x23), .b(x22), .O(new_n74_));
  nand4  g021(.a(new_n74_), .b(new_n54_), .c(new_n65_), .d(new_n53_), .O(new_n75_));
  and2   g022(.a(new_n75_), .b(new_n73_), .O(new_n76_));
  ...
  nand4  g027(.a(new_n81_), .b(new_n67_), .c(new_n54_), .d(new_n53_), .O(new_n82_));
  ...
  nand4  g040(.a(new_n94_), .b(new_n74_), .c(new_n93_), .d(new_n54_), .O(new_n95_));
  nand2  g041(.a(new_n95_), .b(x26), .O(new_n96_));
  inv1   g042(.a(new_n66_), .O(new_n97_));
  nor2   g043(.a(x26), .b(x25), .O(new_n98_));
  nand4  g044(.a(new_n98_), .b(new_n74_), .c(new_n97_), .d(new_n85_), .O(new_n99_));
  ...
  nor2   g052(.a(new_n106_), .b(new_n72_), .O(new_n107_));
  ...
  nand4  g058(.a(new_n112_), .b(new_n81_), .c(new_n67_), .d(new_n56_), .O(new_n113_));
  ...
  nor2   g062(.a(new_n116_), .b(new_n72_), .O(new_n117_));
  ...
  nand4  g068(.a(new_n124_), .b(new_n114_), .c(new_n98_), .d(new_n85_), .O(new_n125_));
  oai21  g069(.a(new_n125_), .b(new_n75_), .c(x31), .O(new_n126_));
  nand2  g070(.a(new_n81_), .b(new_n67_), .O(new_n127_));
  ...
  nand4  g076(.a(new_n132_), .b(new_n112_), .c(new_n128_), .d(new_n56_), .O(new_n133_));
  ...
  nand4  g083(.a(new_n140_), .b(new_n124_), .c(new_n114_), .d(new_n98_), .O(new_n141_));
  oai21  g084(.a(new_n141_), .b(new_n82_), .c(x33), .O(new_n142_));
  nor2   g085(.a(x33), .b(x32), .O(new_n143_));
  nand4  g086(.a(new_n143_), .b(new_n130_), .c(new_n129_), .d(new_n105_), .O(new_n144_));
  inv1   g087(.a(new_n144_), .O(new_n145_));
  nand2  g088(.a(new_n145_), .b(new_n88_), .O(new_n146_));
  nand2  g089(.a(new_n146_), .b(new_n142_), .O(new_n147_));
  ...
  oai21  g094(.a(new_n144_), .b(new_n95_), .c(x34), .O(new_n152_));
  nand2  g095(.a(new_n129_), .b(new_n105_), .O(new_n153_));
  ...
  nand3  g105(.a(new_n162_), .b(new_n154_), .c(new_n88_), .O(new_n163_));
