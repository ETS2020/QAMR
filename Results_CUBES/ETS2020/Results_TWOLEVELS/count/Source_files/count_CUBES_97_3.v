...
module FAU ( 
  ...
  wire new_n52_, new_n53_, new_n54_, new_n55_, new_n56_, new_n57_, new_n58_,
    ...
    new_n113_, new_n114_, new_n115_, new_n120_, new_n121_, new_n122_,
  ...
  nand4  g066(.a(new_n120_), .b(new_n110_), .c(new_n82_), .d(new_n63_), .O(new_n121_));
  nand4  g067(.a(new_n106_), .b(new_n55_), .c(new_n69_), .d(new_n61_), .O(new_n122_));
  nor2   g068(.a(x26), .b(x25), .O(new_n123_));
  nor2   g069(.a(x28), .b(x27), .O(new_n124_));
  nor2   g070(.a(x30), .b(x29), .O(new_n125_));
  nand4  g071(.a(new_n125_), .b(new_n124_), .c(new_n123_), .d(new_n87_), .O(new_n126_));
  ...
  nor3   g078(.a(x29), .b(x28), .c(x25), .O(new_n133_));
  nor2   g079(.a(x27), .b(x26), .O(new_n134_));
  ...
  nand4  g093(.a(new_n147_), .b(new_n125_), .c(new_n124_), .d(new_n123_), .O(new_n148_));
  ...
  nand2  g112(.a(new_n134_), .b(new_n144_), .O(new_n167_));
