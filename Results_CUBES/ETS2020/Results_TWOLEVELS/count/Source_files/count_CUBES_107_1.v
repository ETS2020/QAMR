...
module FAU ( 
  ...
  nand4  g052(.a(new_n104_), .b(new_n79_), .c(new_n103_), .d(new_n54_), .O(new_n105_));
  ...
  nand4  g062(.a(new_n115_), .b(new_n86_), .c(new_n72_), .d(new_n56_), .O(new_n116_));
  ...
  nand4  g072(.a(new_n127_), .b(new_n117_), .c(new_n107_), .d(new_n95_), .O(new_n128_));
  oai21  g073(.a(new_n128_), .b(new_n80_), .c(x31), .O(new_n129_));
  ...
  nand3  g078(.a(new_n133_), .b(new_n115_), .c(new_n88_), .O(new_n134_));
  ...
  nand4  g085(.a(new_n131_), .b(new_n130_), .c(new_n140_), .d(new_n96_), .O(new_n141_));
  oai21  g086(.a(new_n141_), .b(new_n87_), .c(x32), .O(new_n142_));
  nor2   g087(.a(x32), .b(x31), .O(new_n143_));
  nand4  g088(.a(new_n143_), .b(new_n127_), .c(new_n117_), .d(new_n107_), .O(new_n144_));
  inv1   g089(.a(new_n144_), .O(new_n145_));
  nand2  g090(.a(new_n145_), .b(new_n88_), .O(new_n146_));
  nand2  g091(.a(new_n146_), .b(new_n142_), .O(new_n147_));
  nand2  g092(.a(new_n147_), .b(x16), .O(new_n148_));
  inv1   g093(.a(x02), .O(new_n149_));
  aoi21  g094(.a(new_n59_), .b(new_n149_), .c(x18), .O(new_n150_));
  nand2  g095(.a(new_n150_), .b(new_n148_), .O(z13));
  oai21  g096(.a(new_n144_), .b(new_n87_), .c(x33), .O(new_n152_));
  ...
  nand2  g100(.a(new_n155_), .b(new_n98_), .O(new_n156_));
  ...
  oai21  g106(.a(new_n154_), .b(new_n105_), .c(x34), .O(new_n162_));
  nand2  g107(.a(new_n130_), .b(new_n140_), .O(new_n163_));
