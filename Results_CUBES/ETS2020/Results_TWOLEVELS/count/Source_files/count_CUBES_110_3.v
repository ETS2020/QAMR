...
module FAU ( 
  ...
  nand4  g059(.a(new_n89_), .b(new_n111_), .c(new_n110_), .d(new_n99_), .O(new_n112_));
  nor2   g060(.a(new_n112_), .b(new_n81_), .O(new_n113_));
  ...
  nand4  g067(.a(new_n120_), .b(new_n119_), .c(new_n110_), .d(new_n98_), .O(new_n121_));
  oai21  g068(.a(new_n121_), .b(new_n81_), .c(x29), .O(new_n122_));
  nor3   g069(.a(x29), .b(x28), .c(x27), .O(new_n123_));
  nand4  g070(.a(new_n123_), .b(new_n103_), .c(new_n82_), .d(new_n63_), .O(new_n124_));
  ...
  nand4  g086(.a(new_n87_), .b(new_n98_), .c(new_n97_), .d(new_n69_), .O(new_n140_));
  ...
  nand4  g095(.a(new_n148_), .b(new_n142_), .c(new_n141_), .d(new_n63_), .O(new_n149_));
  ...
  nand4  g102(.a(new_n156_), .b(new_n132_), .c(new_n120_), .d(new_n131_), .O(new_n157_));
  oai21  g103(.a(new_n157_), .b(new_n90_), .c(x33), .O(new_n158_));
  inv1   g104(.a(new_n100_), .O(new_n159_));
  inv1   g105(.a(x32), .O(new_n160_));
  inv1   g106(.a(x33), .O(new_n161_));
  nand4  g107(.a(new_n161_), .b(new_n160_), .c(new_n111_), .d(new_n110_), .O(new_n162_));
  inv1   g108(.a(new_n162_), .O(new_n163_));
  nand4  g109(.a(new_n163_), .b(new_n148_), .c(new_n159_), .d(new_n71_), .O(new_n164_));
  nand2  g110(.a(new_n164_), .b(new_n158_), .O(new_n165_));
