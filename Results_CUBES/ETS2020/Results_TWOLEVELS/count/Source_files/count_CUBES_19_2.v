...
module FAU ( 
  ...
  nand4  g041(.a(new_n95_), .b(new_n94_), .c(new_n93_), .d(new_n56_), .O(new_n96_));
  nand2  g042(.a(new_n96_), .b(x26), .O(new_n97_));
  nor3   g043(.a(x26), .b(x25), .c(x24), .O(new_n98_));
  nand3  g044(.a(new_n98_), .b(new_n94_), .c(new_n62_), .O(new_n99_));
  nand2  g045(.a(new_n99_), .b(new_n97_), .O(new_n100_));
  nand2  g046(.a(new_n100_), .b(x16), .O(new_n101_));
  inv1   g047(.a(x08), .O(new_n102_));
  aoi21  g048(.a(new_n54_), .b(new_n102_), .c(x18), .O(new_n103_));
  nand2  g049(.a(new_n103_), .b(new_n101_), .O(z07));
  nand3  g050(.a(new_n68_), .b(new_n56_), .c(new_n55_), .O(new_n105_));
  nor2   g051(.a(x27), .b(x26), .O(new_n106_));
  nand3  g052(.a(new_n106_), .b(new_n77_), .c(new_n86_), .O(new_n107_));
  nor2   g053(.a(new_n107_), .b(new_n105_), .O(new_n108_));
  aoi21  g054(.a(new_n99_), .b(x27), .c(new_n108_), .O(new_n109_));
  inv1   g055(.a(x07), .O(new_n110_));
  aoi21  g056(.a(new_n54_), .b(new_n110_), .c(x18), .O(new_n111_));
  oai21  g057(.a(new_n109_), .b(new_n54_), .c(new_n111_), .O(z08));
  nor2   g058(.a(x28), .b(x27), .O(new_n114_));
  nor2   g059(.a(x26), .b(x23), .O(new_n115_));
  nand3  g060(.a(new_n115_), .b(new_n114_), .c(new_n95_), .O(new_n116_));
  oai21  g061(.a(new_n116_), .b(new_n105_), .c(x29), .O(new_n117_));
  nor3   g062(.a(x29), .b(x28), .c(x27), .O(new_n118_));
  nand4  g063(.a(new_n118_), .b(new_n98_), .c(new_n75_), .d(new_n67_), .O(new_n119_));
  nand2  g064(.a(new_n119_), .b(new_n117_), .O(new_n120_));
  nand2  g065(.a(new_n120_), .b(x16), .O(new_n121_));
  inv1   g066(.a(x05), .O(new_n122_));
  aoi21  g067(.a(new_n54_), .b(new_n122_), .c(x18), .O(new_n123_));
  nand2  g068(.a(new_n123_), .b(new_n121_), .O(z10));
  nand4  g069(.a(new_n94_), .b(new_n56_), .c(new_n60_), .d(new_n55_), .O(new_n125_));
  nor2   g070(.a(x26), .b(x25), .O(new_n126_));
  nor2   g071(.a(x30), .b(x29), .O(new_n127_));
  nand4  g072(.a(new_n127_), .b(new_n114_), .c(new_n126_), .d(new_n74_), .O(new_n128_));
  ...
  nand3  g084(.a(new_n139_), .b(new_n135_), .c(new_n79_), .O(new_n140_));
  ...
  nand4  g090(.a(new_n137_), .b(new_n136_), .c(new_n106_), .d(new_n86_), .O(new_n146_));
  oai21  g091(.a(new_n146_), .b(new_n78_), .c(x32), .O(new_n147_));
  nor2   g092(.a(x32), .b(x31), .O(new_n148_));
  nand4  g093(.a(new_n148_), .b(new_n127_), .c(new_n114_), .d(new_n126_), .O(new_n149_));
  inv1   g094(.a(new_n149_), .O(new_n150_));
  nand2  g095(.a(new_n150_), .b(new_n79_), .O(new_n151_));
  nand2  g096(.a(new_n151_), .b(new_n147_), .O(new_n152_));
  ...
  oai21  g101(.a(new_n149_), .b(new_n78_), .c(x33), .O(new_n157_));
  nor2   g102(.a(x33), .b(x32), .O(new_n158_));
  nand4  g103(.a(new_n158_), .b(new_n137_), .c(new_n136_), .d(new_n106_), .O(new_n159_));
  inv1   g104(.a(new_n159_), .O(new_n160_));
  nand2  g105(.a(new_n160_), .b(new_n88_), .O(new_n161_));
  nand2  g106(.a(new_n161_), .b(new_n157_), .O(new_n162_));
  nand2  g107(.a(new_n162_), .b(x16), .O(new_n163_));
  inv1   g108(.a(x01), .O(new_n164_));
  aoi21  g109(.a(new_n54_), .b(new_n164_), .c(x18), .O(new_n165_));
  nand2  g110(.a(new_n165_), .b(new_n163_), .O(z14));
  oai21  g111(.a(new_n159_), .b(new_n96_), .c(x34), .O(new_n167_));
  nand2  g112(.a(new_n136_), .b(new_n106_), .O(new_n168_));
