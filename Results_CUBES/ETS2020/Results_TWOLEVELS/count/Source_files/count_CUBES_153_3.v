// Benchmark "FAU" written by ABC on Tue Jul  7 19:19:34 2020
...
module FAU ( 
  ...
  nand4  g037(.a(new_n91_), .b(new_n90_), .c(new_n89_), .d(new_n55_), .O(new_n92_));
  nand2  g038(.a(new_n92_), .b(x26), .O(new_n93_));
  nor3   g039(.a(x26), .b(x25), .c(x24), .O(new_n94_));
  nand3  g040(.a(new_n94_), .b(new_n90_), .c(new_n66_), .O(new_n95_));
  nand2  g041(.a(new_n95_), .b(new_n93_), .O(new_n96_));
  nand2  g042(.a(new_n96_), .b(x16), .O(new_n97_));
  inv1   g043(.a(x08), .O(new_n98_));
  aoi21  g044(.a(new_n58_), .b(new_n98_), .c(x18), .O(new_n99_));
  nand2  g045(.a(new_n99_), .b(new_n97_), .O(z07));
  nand3  g046(.a(new_n72_), .b(new_n55_), .c(new_n62_), .O(new_n101_));
  inv1   g047(.a(x25), .O(new_n102_));
  nor2   g048(.a(x27), .b(x26), .O(new_n103_));
  nand3  g049(.a(new_n103_), .b(new_n81_), .c(new_n102_), .O(new_n104_));
  nor2   g050(.a(new_n104_), .b(new_n101_), .O(new_n105_));
  aoi21  g051(.a(new_n95_), .b(x27), .c(new_n105_), .O(new_n106_));
  ...
  inv1   g057(.a(x23), .O(new_n112_));
  inv1   g058(.a(x26), .O(new_n113_));
  nor2   g059(.a(x28), .b(x27), .O(new_n114_));
  nand4  g060(.a(new_n114_), .b(new_n91_), .c(new_n113_), .d(new_n112_), .O(new_n115_));
  nor2   g061(.a(new_n115_), .b(new_n101_), .O(new_n116_));
  ...
  nand4  g068(.a(new_n122_), .b(new_n94_), .c(new_n79_), .d(new_n71_), .O(new_n123_));
  ...
  nand4  g074(.a(new_n90_), .b(new_n55_), .c(new_n64_), .d(new_n62_), .O(new_n129_));
  nor2   g075(.a(x26), .b(x25), .O(new_n130_));
  nor2   g076(.a(x30), .b(x29), .O(new_n131_));
  nand4  g077(.a(new_n131_), .b(new_n114_), .c(new_n130_), .d(new_n78_), .O(new_n132_));
  ...
  nand3  g088(.a(new_n142_), .b(new_n110_), .c(new_n83_), .O(new_n143_));
  nand2  g089(.a(new_n143_), .b(new_n138_), .O(new_n144_));
  ...
  nand4  g094(.a(new_n140_), .b(new_n139_), .c(new_n103_), .d(new_n102_), .O(new_n149_));
  oai21  g095(.a(new_n149_), .b(new_n82_), .c(x32), .O(new_n150_));
  nand2  g096(.a(new_n131_), .b(new_n114_), .O(new_n151_));
  inv1   g097(.a(x31), .O(new_n152_));
  inv1   g098(.a(x32), .O(new_n153_));
  nand4  g099(.a(new_n153_), .b(new_n152_), .c(new_n113_), .d(new_n102_), .O(new_n154_));
  nor2   g100(.a(new_n154_), .b(new_n151_), .O(new_n155_));
  nand2  g101(.a(new_n155_), .b(new_n83_), .O(new_n156_));
  ...
  nand4  g108(.a(new_n163_), .b(new_n140_), .c(new_n139_), .d(new_n103_), .O(new_n164_));
  oai21  g109(.a(new_n164_), .b(new_n92_), .c(x34), .O(new_n165_));
  inv1   g110(.a(x22), .O(new_n166_));
  nand4  g111(.a(new_n102_), .b(new_n78_), .c(new_n112_), .d(new_n166_), .O(new_n167_));
  nor2   g112(.a(new_n167_), .b(new_n65_), .O(new_n168_));
  nand2  g113(.a(new_n139_), .b(new_n103_), .O(new_n169_));
  inv1   g114(.a(new_n169_), .O(new_n170_));
  inv1   g115(.a(x30), .O(new_n171_));
  nand2  g116(.a(new_n152_), .b(new_n171_), .O(new_n172_));
  inv1   g117(.a(x33), .O(new_n173_));
  inv1   g118(.a(x34), .O(new_n174_));
  nand3  g119(.a(new_n174_), .b(new_n173_), .c(new_n153_), .O(new_n175_));
  nor2   g120(.a(new_n175_), .b(new_n172_), .O(new_n176_));
  nand3  g121(.a(new_n176_), .b(new_n170_), .c(new_n168_), .O(new_n177_));
  nand2  g122(.a(new_n177_), .b(new_n165_), .O(new_n178_));
  nand2  g123(.a(new_n178_), .b(x16), .O(new_n179_));
  inv1   g124(.a(x00), .O(new_n180_));
  aoi21  g125(.a(new_n58_), .b(new_n180_), .c(x18), .O(new_n181_));
  nand2  g126(.a(new_n181_), .b(new_n179_), .O(z15));
  zero   g127(.O(z01));
  zero   g128(.O(z04));
  zero   g129(.O(z06));
  zero   g130(.O(z14));
