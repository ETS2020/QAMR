...
module FAU ( 
  ...
  inv1   g044(.a(x22), .O(new_n97_));
  inv1   g045(.a(x23), .O(new_n98_));
  inv1   g046(.a(x25), .O(new_n99_));
  nand4  g047(.a(new_n99_), .b(new_n87_), .c(new_n98_), .d(new_n97_), .O(new_n100_));
  oai21  g048(.a(new_n100_), .b(new_n70_), .c(x26), .O(new_n101_));
  nor2   g049(.a(x23), .b(x22), .O(new_n102_));
  nor3   g050(.a(x26), .b(x25), .c(x24), .O(new_n103_));
  nand3  g051(.a(new_n103_), .b(new_n102_), .c(new_n71_), .O(new_n104_));
  ...
  nand3  g058(.a(new_n110_), .b(new_n89_), .c(new_n99_), .O(new_n111_));
  ...
  nand4  g069(.a(new_n121_), .b(new_n120_), .c(new_n119_), .d(new_n98_), .O(new_n122_));
  ...
  nor3   g075(.a(x29), .b(x28), .c(x27), .O(new_n129_));
  nand4  g076(.a(new_n129_), .b(new_n103_), .c(new_n82_), .d(new_n63_), .O(new_n130_));
  ...
  nand4  g080(.a(new_n133_), .b(new_n121_), .c(new_n132_), .d(new_n87_), .O(new_n134_));
  nor2   g081(.a(new_n134_), .b(new_n131_), .O(new_n135_));
  aoi21  g082(.a(new_n130_), .b(x30), .c(new_n135_), .O(new_n136_));
  ...
  nand4  g087(.a(new_n87_), .b(new_n98_), .c(new_n97_), .d(new_n69_), .O(new_n141_));
  ...
  nand4  g095(.a(new_n148_), .b(new_n117_), .c(new_n142_), .d(new_n63_), .O(new_n149_));
  ...
  nand4  g103(.a(new_n156_), .b(new_n155_), .c(new_n110_), .d(new_n99_), .O(new_n157_));
  oai21  g104(.a(new_n157_), .b(new_n90_), .c(x32), .O(new_n158_));
  ...
  nand4  g109(.a(new_n162_), .b(new_n146_), .c(new_n119_), .d(new_n99_), .O(new_n163_));
  ...
  nand4  g118(.a(new_n171_), .b(new_n133_), .c(new_n121_), .d(new_n132_), .O(new_n172_));
  oai21  g119(.a(new_n172_), .b(new_n90_), .c(x33), .O(new_n173_));
  inv1   g120(.a(new_n100_), .O(new_n174_));
  inv1   g121(.a(x33), .O(new_n175_));
  nand4  g122(.a(new_n175_), .b(new_n162_), .c(new_n159_), .d(new_n119_), .O(new_n176_));
  inv1   g123(.a(new_n176_), .O(new_n177_));
  nand4  g124(.a(new_n177_), .b(new_n148_), .c(new_n174_), .d(new_n71_), .O(new_n178_));
  nand2  g125(.a(new_n178_), .b(new_n173_), .O(new_n179_));
  nand2  g126(.a(new_n179_), .b(x16), .O(new_n180_));
  inv1   g127(.a(x01), .O(new_n181_));
  aoi21  g128(.a(new_n58_), .b(new_n181_), .c(x18), .O(new_n182_));
  nand2  g129(.a(new_n182_), .b(new_n180_), .O(z14));
  zero   g130(.O(z06));
  zero   g131(.O(z10));
  zero   g132(.O(z15));
endmodule
