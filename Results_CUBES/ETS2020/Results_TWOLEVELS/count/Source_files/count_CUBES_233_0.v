...
module FAU ( 
  ...
  nand4  g080(.a(new_n133_), .b(new_n115_), .c(new_n132_), .d(new_n82_), .O(new_n134_));
  ...
  nand3  g091(.a(new_n144_), .b(new_n112_), .c(new_n86_), .O(new_n145_));
  ...
  nand4  g097(.a(new_n142_), .b(new_n141_), .c(new_n105_), .d(new_n93_), .O(new_n151_));
  ...
  nand2  g102(.a(new_n155_), .b(new_n86_), .O(new_n156_));
  ...
  oai21  g108(.a(new_n154_), .b(new_n85_), .c(x33), .O(new_n162_));
  ...
  nand4  g118(.a(new_n114_), .b(new_n102_), .c(new_n101_), .d(new_n55_), .O(new_n172_));
  oai21  g119(.a(new_n164_), .b(new_n172_), .c(x34), .O(new_n173_));
  nand2  g120(.a(new_n141_), .b(new_n105_), .O(new_n174_));
  ...
  nand3  g130(.a(new_n183_), .b(new_n175_), .c(new_n95_), .O(new_n184_));
