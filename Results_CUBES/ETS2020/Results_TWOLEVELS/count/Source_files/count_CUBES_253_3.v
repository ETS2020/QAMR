...
module FAU ( 
  ...
  nand4  g093(.a(new_n82_), .b(new_n93_), .c(new_n92_), .d(new_n69_), .O(new_n146_));
  ...
  nand4  g101(.a(new_n153_), .b(new_n117_), .c(new_n147_), .d(new_n63_), .O(new_n154_));
  ...
  oai21  g110(.a(new_n162_), .b(new_n85_), .c(x32), .O(new_n163_));
  ...
  nand4  g117(.a(new_n169_), .b(new_n166_), .c(new_n147_), .d(new_n63_), .O(new_n170_));
  ...
  oai21  g125(.a(new_n177_), .b(new_n85_), .c(x33), .O(new_n178_));
  ...
  nand4  g129(.a(new_n181_), .b(new_n153_), .c(new_n96_), .d(new_n91_), .O(new_n182_));
