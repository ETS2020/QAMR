...
module FAU ( 
  ...
  nor2   g070(.a(x25), .b(x24), .O(new_n123_));
  nor2   g071(.a(x28), .b(x27), .O(new_n124_));
  nand4  g072(.a(new_n124_), .b(new_n123_), .c(new_n114_), .d(new_n97_), .O(new_n125_));
  ...
  nand4  g084(.a(new_n136_), .b(new_n124_), .c(new_n135_), .d(new_n87_), .O(new_n137_));
  ...
  nand4  g100(.a(new_n152_), .b(new_n146_), .c(new_n145_), .d(new_n63_), .O(new_n153_));
  nand2  g101(.a(new_n153_), .b(new_n143_), .O(new_n154_));
  ...
  nand4  g107(.a(new_n160_), .b(new_n136_), .c(new_n124_), .d(new_n135_), .O(new_n161_));
  oai21  g108(.a(new_n161_), .b(new_n90_), .c(x33), .O(new_n162_));
  inv1   g109(.a(x32), .O(new_n163_));
  inv1   g110(.a(x33), .O(new_n164_));
  nand4  g111(.a(new_n164_), .b(new_n163_), .c(new_n115_), .d(new_n114_), .O(new_n165_));
  inv1   g112(.a(new_n165_), .O(new_n166_));
  nand4  g113(.a(new_n166_), .b(new_n152_), .c(new_n100_), .d(new_n71_), .O(new_n167_));
  nand2  g114(.a(new_n167_), .b(new_n162_), .O(new_n168_));
