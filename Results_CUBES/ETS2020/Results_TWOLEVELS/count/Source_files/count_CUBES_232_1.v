// Benchmark "FAU" written by ABC on Tue Jul  7 19:20:52 2020
...
module FAU ( 
  ...
  nor3   g058(.a(x25), .b(x24), .c(x23), .O(new_n112_));
  nand4  g059(.a(new_n112_), .b(new_n105_), .c(new_n71_), .d(new_n63_), .O(new_n113_));
  ...
  nand4  g082(.a(new_n138_), .b(new_n129_), .c(new_n116_), .d(new_n128_), .O(new_n139_));
  oai21  g083(.a(new_n139_), .b(new_n84_), .c(x33), .O(new_n140_));
  inv1   g084(.a(x22), .O(new_n141_));
  nand4  g085(.a(new_n104_), .b(new_n127_), .c(new_n114_), .d(new_n141_), .O(new_n142_));
  inv1   g086(.a(new_n142_), .O(new_n143_));
  inv1   g087(.a(x30), .O(new_n144_));
  inv1   g088(.a(x31), .O(new_n145_));
  inv1   g089(.a(x32), .O(new_n146_));
  inv1   g090(.a(x33), .O(new_n147_));
  nand4  g091(.a(new_n147_), .b(new_n146_), .c(new_n145_), .d(new_n144_), .O(new_n148_));
  inv1   g092(.a(new_n148_), .O(new_n149_));
  inv1   g093(.a(x27), .O(new_n150_));
  inv1   g094(.a(x28), .O(new_n151_));
  inv1   g095(.a(x29), .O(new_n152_));
  nand4  g096(.a(new_n152_), .b(new_n151_), .c(new_n150_), .d(new_n115_), .O(new_n153_));
  inv1   g097(.a(new_n153_), .O(new_n154_));
  nand4  g098(.a(new_n154_), .b(new_n149_), .c(new_n143_), .d(new_n96_), .O(new_n155_));
  nand2  g099(.a(new_n155_), .b(new_n140_), .O(new_n156_));
