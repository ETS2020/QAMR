...
module FAU ( 
  ...
  nand4  g069(.a(new_n123_), .b(new_n98_), .c(new_n77_), .d(new_n63_), .O(new_n124_));
  nand4  g070(.a(new_n97_), .b(new_n55_), .c(new_n69_), .d(new_n61_), .O(new_n125_));
  nor2   g071(.a(x26), .b(x25), .O(new_n126_));
  nor2   g072(.a(x30), .b(x29), .O(new_n127_));
  nand4  g073(.a(new_n127_), .b(new_n115_), .c(new_n126_), .d(new_n87_), .O(new_n128_));
  nor2   g074(.a(new_n128_), .b(new_n125_), .O(new_n129_));
  aoi21  g075(.a(new_n124_), .b(x30), .c(new_n129_), .O(new_n130_));
  ...
  nand4  g081(.a(new_n136_), .b(new_n135_), .c(new_n105_), .d(new_n88_), .O(new_n137_));
  oai21  g082(.a(new_n137_), .b(new_n84_), .c(x32), .O(new_n138_));
  inv1   g083(.a(new_n84_), .O(new_n139_));
  nor2   g084(.a(x32), .b(x31), .O(new_n140_));
  nand4  g085(.a(new_n140_), .b(new_n127_), .c(new_n115_), .d(new_n126_), .O(new_n141_));
  inv1   g086(.a(new_n141_), .O(new_n142_));
  nand2  g087(.a(new_n142_), .b(new_n139_), .O(new_n143_));
  nand2  g088(.a(new_n143_), .b(new_n138_), .O(new_n144_));
  nand2  g089(.a(new_n144_), .b(x16), .O(new_n145_));
  inv1   g090(.a(x02), .O(new_n146_));
  aoi21  g091(.a(new_n58_), .b(new_n146_), .c(x18), .O(new_n147_));
  nand2  g092(.a(new_n147_), .b(new_n145_), .O(z13));
  oai21  g093(.a(new_n141_), .b(new_n84_), .c(x33), .O(new_n149_));
  nor2   g094(.a(x33), .b(x32), .O(new_n150_));
  nand4  g095(.a(new_n150_), .b(new_n136_), .c(new_n135_), .d(new_n105_), .O(new_n151_));
  inv1   g096(.a(new_n151_), .O(new_n152_));
  nand2  g097(.a(new_n152_), .b(new_n90_), .O(new_n153_));
  nand2  g098(.a(new_n153_), .b(new_n149_), .O(new_n154_));
  nand2  g099(.a(new_n154_), .b(x16), .O(new_n155_));
  inv1   g100(.a(x01), .O(new_n156_));
  aoi21  g101(.a(new_n58_), .b(new_n156_), .c(x18), .O(new_n157_));
  nand2  g102(.a(new_n157_), .b(new_n155_), .O(z14));
  nand4  g103(.a(new_n114_), .b(new_n97_), .c(new_n96_), .d(new_n55_), .O(new_n159_));
  oai21  g104(.a(new_n151_), .b(new_n159_), .c(x34), .O(new_n160_));
  nand2  g105(.a(new_n135_), .b(new_n105_), .O(new_n161_));
  ...
  nand3  g115(.a(new_n170_), .b(new_n162_), .c(new_n90_), .O(new_n171_));
