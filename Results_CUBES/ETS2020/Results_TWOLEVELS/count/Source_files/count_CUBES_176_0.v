...
module FAU ( 
  ...
  nand4  g102(.a(new_n156_), .b(new_n137_), .c(new_n119_), .d(new_n136_), .O(new_n157_));
  oai21  g103(.a(new_n157_), .b(new_n83_), .c(x33), .O(new_n158_));
  nor2   g104(.a(x33), .b(x32), .O(new_n159_));
  nand4  g105(.a(new_n159_), .b(new_n146_), .c(new_n145_), .d(new_n110_), .O(new_n160_));
  inv1   g106(.a(new_n160_), .O(new_n161_));
  nand2  g107(.a(new_n161_), .b(new_n93_), .O(new_n162_));
  ...
  oai21  g113(.a(new_n160_), .b(new_n101_), .c(x34), .O(new_n168_));
  nand2  g114(.a(new_n145_), .b(new_n110_), .O(new_n169_));
