// Benchmark "FAU" written by ABC on Tue Jul  7 19:18:52 2020
...
module FAU ( 
  ...
  nand4  g050(.a(new_n105_), .b(new_n80_), .c(new_n67_), .d(new_n55_), .O(new_n106_));
  nor2   g051(.a(x28), .b(x27), .O(new_n107_));
  nor2   g052(.a(x26), .b(x23), .O(new_n108_));
  nand3  g053(.a(new_n108_), .b(new_n107_), .c(new_n94_), .O(new_n109_));
  nor2   g054(.a(new_n109_), .b(new_n73_), .O(new_n110_));
  aoi21  g055(.a(new_n106_), .b(x28), .c(new_n110_), .O(new_n111_));
  inv1   g056(.a(x06), .O(new_n112_));
  aoi21  g057(.a(new_n54_), .b(new_n112_), .c(x18), .O(new_n113_));
  oai21  g058(.a(new_n111_), .b(new_n54_), .c(new_n113_), .O(z09));
  inv1   g059(.a(x29), .O(new_n115_));
  nor3   g060(.a(x29), .b(x28), .c(x27), .O(new_n116_));
  nand4  g061(.a(new_n116_), .b(new_n97_), .c(new_n74_), .d(new_n55_), .O(new_n117_));
  ...
  aoi21  g065(.a(new_n54_), .b(new_n120_), .c(x18), .O(new_n121_));
  nand2  g066(.a(new_n121_), .b(new_n119_), .O(z10));
  nand4  g067(.a(new_n93_), .b(new_n72_), .c(new_n60_), .d(new_n59_), .O(new_n123_));
  nor2   g068(.a(x26), .b(x25), .O(new_n124_));
  nor2   g069(.a(x30), .b(x29), .O(new_n125_));
  nand4  g070(.a(new_n125_), .b(new_n107_), .c(new_n124_), .d(new_n84_), .O(new_n126_));
  ...
  aoi21  g074(.a(new_n54_), .b(new_n129_), .c(x18), .O(new_n130_));
  oai21  g075(.a(new_n128_), .b(new_n54_), .c(new_n130_), .O(z11));
  oai21  g076(.a(new_n126_), .b(new_n123_), .c(x31), .O(new_n132_));
  nand2  g077(.a(new_n80_), .b(new_n67_), .O(new_n133_));
  ...
  nand4  g083(.a(new_n138_), .b(new_n105_), .c(new_n134_), .d(new_n55_), .O(new_n139_));
  nand2  g084(.a(new_n139_), .b(new_n132_), .O(new_n140_));
  ...
  nor2   g089(.a(x27), .b(x26), .O(new_n145_));
  nand4  g090(.a(new_n136_), .b(new_n135_), .c(new_n145_), .d(new_n85_), .O(new_n146_));
  oai21  g091(.a(new_n146_), .b(new_n81_), .c(x32), .O(new_n147_));
  nand2  g092(.a(new_n125_), .b(new_n107_), .O(new_n148_));
  inv1   g093(.a(new_n148_), .O(new_n149_));
  nor2   g094(.a(x32), .b(x31), .O(new_n150_));
  nand2  g095(.a(new_n150_), .b(new_n124_), .O(new_n151_));
  inv1   g096(.a(new_n151_), .O(new_n152_));
  nand4  g097(.a(new_n152_), .b(new_n149_), .c(new_n134_), .d(new_n55_), .O(new_n153_));
  nand2  g098(.a(new_n153_), .b(new_n147_), .O(new_n154_));
  nand2  g099(.a(new_n154_), .b(x16), .O(new_n155_));
  inv1   g100(.a(x02), .O(new_n156_));
  aoi21  g101(.a(new_n54_), .b(new_n156_), .c(x18), .O(new_n157_));
  nand2  g102(.a(new_n157_), .b(new_n155_), .O(z13));
  nand4  g103(.a(new_n150_), .b(new_n125_), .c(new_n107_), .d(new_n124_), .O(new_n159_));
  oai21  g104(.a(new_n159_), .b(new_n81_), .c(x33), .O(new_n160_));
  nor2   g105(.a(x33), .b(x32), .O(new_n161_));
  nand4  g106(.a(new_n161_), .b(new_n136_), .c(new_n135_), .d(new_n145_), .O(new_n162_));
  inv1   g107(.a(new_n162_), .O(new_n163_));
  nand2  g108(.a(new_n163_), .b(new_n87_), .O(new_n164_));
  nand2  g109(.a(new_n164_), .b(new_n160_), .O(new_n165_));
  nand2  g110(.a(new_n165_), .b(x16), .O(new_n166_));
  inv1   g111(.a(x01), .O(new_n167_));
  aoi21  g112(.a(new_n54_), .b(new_n167_), .c(x18), .O(new_n168_));
  nand2  g113(.a(new_n168_), .b(new_n166_), .O(z14));
  oai21  g114(.a(new_n162_), .b(new_n95_), .c(x34), .O(new_n170_));
  nand2  g115(.a(new_n135_), .b(new_n145_), .O(new_n171_));
