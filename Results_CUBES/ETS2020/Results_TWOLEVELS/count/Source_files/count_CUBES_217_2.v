...
module FAU ( 
  ...
  nand4  g071(.a(new_n125_), .b(new_n99_), .c(new_n79_), .d(new_n63_), .O(new_n126_));
  nand4  g072(.a(new_n95_), .b(new_n55_), .c(new_n69_), .d(new_n61_), .O(new_n127_));
  ...
  nand3  g086(.a(new_n140_), .b(new_n114_), .c(new_n88_), .O(new_n141_));
  ...
  nand4  g092(.a(new_n138_), .b(new_n137_), .c(new_n107_), .d(new_n106_), .O(new_n147_));
  oai21  g093(.a(new_n147_), .b(new_n87_), .c(x32), .O(new_n148_));
  nor2   g094(.a(x32), .b(x31), .O(new_n149_));
  nand4  g095(.a(new_n149_), .b(new_n129_), .c(new_n116_), .d(new_n128_), .O(new_n150_));
  inv1   g096(.a(new_n150_), .O(new_n151_));
  nand2  g097(.a(new_n151_), .b(new_n88_), .O(new_n152_));
  ...
  oai21  g103(.a(new_n150_), .b(new_n87_), .c(x33), .O(new_n158_));
  inv1   g104(.a(x22), .O(new_n159_));
  inv1   g105(.a(x23), .O(new_n160_));
  nand4  g106(.a(new_n106_), .b(new_n84_), .c(new_n160_), .d(new_n159_), .O(new_n161_));
  nor2   g107(.a(new_n161_), .b(new_n70_), .O(new_n162_));
  nor2   g108(.a(x33), .b(x32), .O(new_n163_));
  nand4  g109(.a(new_n163_), .b(new_n138_), .c(new_n137_), .d(new_n107_), .O(new_n164_));
  inv1   g110(.a(new_n164_), .O(new_n165_));
  nand2  g111(.a(new_n165_), .b(new_n162_), .O(new_n166_));
  nand2  g112(.a(new_n166_), .b(new_n158_), .O(new_n167_));
  ...
  oai21  g117(.a(new_n164_), .b(new_n97_), .c(x34), .O(new_n172_));
  nand2  g118(.a(new_n137_), .b(new_n107_), .O(new_n173_));
  ...
  nand3  g128(.a(new_n182_), .b(new_n174_), .c(new_n162_), .O(new_n183_));
