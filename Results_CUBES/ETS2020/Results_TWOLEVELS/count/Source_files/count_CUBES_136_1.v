...
module FAU ( 
  ...
  nand4  g073(.a(new_n98_), .b(new_n55_), .c(new_n69_), .d(new_n61_), .O(new_n128_));
  ...
  nand2  g083(.a(new_n85_), .b(new_n77_), .O(new_n138_));
  ...
  nand4  g089(.a(new_n143_), .b(new_n110_), .c(new_n139_), .d(new_n63_), .O(new_n144_));
  ...
  nand4  g096(.a(new_n141_), .b(new_n140_), .c(new_n150_), .d(new_n90_), .O(new_n151_));
  oai21  g097(.a(new_n151_), .b(new_n86_), .c(x32), .O(new_n152_));
  nand2  g098(.a(new_n130_), .b(new_n112_), .O(new_n153_));
  inv1   g099(.a(new_n153_), .O(new_n154_));
  nor2   g100(.a(x32), .b(x31), .O(new_n155_));
  nand2  g101(.a(new_n155_), .b(new_n129_), .O(new_n156_));
  inv1   g102(.a(new_n156_), .O(new_n157_));
  nand4  g103(.a(new_n157_), .b(new_n154_), .c(new_n139_), .d(new_n63_), .O(new_n158_));
  ...
  nand4  g109(.a(new_n155_), .b(new_n130_), .c(new_n112_), .d(new_n129_), .O(new_n164_));
  oai21  g110(.a(new_n164_), .b(new_n86_), .c(x33), .O(new_n165_));
  nor2   g111(.a(x33), .b(x32), .O(new_n166_));
  nand4  g112(.a(new_n166_), .b(new_n141_), .c(new_n140_), .d(new_n150_), .O(new_n167_));
  inv1   g113(.a(new_n167_), .O(new_n168_));
  nand2  g114(.a(new_n168_), .b(new_n92_), .O(new_n169_));
  ...
  oai21  g120(.a(new_n167_), .b(new_n100_), .c(x34), .O(new_n175_));
  nand2  g121(.a(new_n140_), .b(new_n150_), .O(new_n176_));
  ...
  nand3  g131(.a(new_n185_), .b(new_n177_), .c(new_n92_), .O(new_n186_));
