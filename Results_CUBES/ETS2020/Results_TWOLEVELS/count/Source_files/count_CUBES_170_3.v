...
module FAU ( 
  ...
  inv1   g038(.a(x22), .O(new_n92_));
  inv1   g039(.a(x23), .O(new_n93_));
  inv1   g040(.a(x25), .O(new_n94_));
  nand4  g041(.a(new_n94_), .b(new_n82_), .c(new_n93_), .d(new_n92_), .O(new_n95_));
  oai21  g042(.a(new_n95_), .b(new_n70_), .c(x26), .O(new_n96_));
  inv1   g043(.a(new_n70_), .O(new_n97_));
  nor2   g044(.a(x23), .b(x22), .O(new_n98_));
  nor3   g045(.a(x26), .b(x25), .c(x24), .O(new_n99_));
  nand3  g046(.a(new_n99_), .b(new_n98_), .c(new_n97_), .O(new_n100_));
  nand2  g047(.a(new_n100_), .b(new_n96_), .O(new_n101_));
  ...
  nand3  g053(.a(new_n106_), .b(new_n84_), .c(new_n94_), .O(new_n107_));
  nor2   g054(.a(new_n107_), .b(new_n76_), .O(new_n108_));
  ...
  nand4  g062(.a(new_n116_), .b(new_n115_), .c(new_n114_), .d(new_n93_), .O(new_n117_));
  oai21  g063(.a(new_n117_), .b(new_n76_), .c(x29), .O(new_n118_));
  nor3   g064(.a(x29), .b(x28), .c(x27), .O(new_n119_));
  nand4  g065(.a(new_n119_), .b(new_n99_), .c(new_n77_), .d(new_n63_), .O(new_n120_));
  ...
  nand4  g071(.a(new_n98_), .b(new_n55_), .c(new_n69_), .d(new_n61_), .O(new_n126_));
  ...
  nand4  g081(.a(new_n82_), .b(new_n93_), .c(new_n92_), .d(new_n69_), .O(new_n136_));
  ...
  nand4  g090(.a(new_n144_), .b(new_n138_), .c(new_n137_), .d(new_n63_), .O(new_n145_));
  ...
  nand4  g098(.a(new_n152_), .b(new_n151_), .c(new_n106_), .d(new_n94_), .O(new_n153_));
  oai21  g099(.a(new_n153_), .b(new_n85_), .c(x32), .O(new_n154_));
  ...
  nand4  g104(.a(new_n158_), .b(new_n142_), .c(new_n114_), .d(new_n94_), .O(new_n159_));
  inv1   g105(.a(new_n159_), .O(new_n160_));
  nand4  g106(.a(new_n160_), .b(new_n157_), .c(new_n137_), .d(new_n63_), .O(new_n161_));
  ...
  oai21  g114(.a(new_n168_), .b(new_n85_), .c(x33), .O(new_n169_));
  inv1   g115(.a(new_n95_), .O(new_n170_));
  ...
  nand4  g119(.a(new_n173_), .b(new_n144_), .c(new_n170_), .d(new_n97_), .O(new_n174_));
