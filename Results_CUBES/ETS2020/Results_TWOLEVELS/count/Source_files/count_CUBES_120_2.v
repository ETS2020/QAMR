...
module FAU ( 
  ...
  nand4  g064(.a(new_n119_), .b(new_n96_), .c(new_n79_), .d(new_n63_), .O(new_n120_));
  nand4  g065(.a(new_n95_), .b(new_n55_), .c(new_n69_), .d(new_n61_), .O(new_n121_));
  nor2   g066(.a(x26), .b(x25), .O(new_n122_));
  nor2   g067(.a(x30), .b(x29), .O(new_n123_));
  nand4  g068(.a(new_n123_), .b(new_n110_), .c(new_n122_), .d(new_n84_), .O(new_n124_));
  ...
  nand3  g079(.a(new_n134_), .b(new_n106_), .c(new_n88_), .O(new_n135_));
  ...
  nand4  g085(.a(new_n132_), .b(new_n131_), .c(new_n99_), .d(new_n98_), .O(new_n141_));
  oai21  g086(.a(new_n141_), .b(new_n87_), .c(x32), .O(new_n142_));
  nand2  g087(.a(new_n123_), .b(new_n110_), .O(new_n143_));
  inv1   g088(.a(x31), .O(new_n144_));
  inv1   g089(.a(x32), .O(new_n145_));
  nand4  g090(.a(new_n145_), .b(new_n144_), .c(new_n109_), .d(new_n98_), .O(new_n146_));
  ...
  nand4  g099(.a(new_n111_), .b(new_n95_), .c(new_n155_), .d(new_n55_), .O(new_n156_));
  nor2   g100(.a(x33), .b(x32), .O(new_n157_));
  nand4  g101(.a(new_n157_), .b(new_n132_), .c(new_n131_), .d(new_n99_), .O(new_n158_));
  oai21  g102(.a(new_n158_), .b(new_n156_), .c(x34), .O(new_n159_));
  inv1   g103(.a(x22), .O(new_n160_));
  nand4  g104(.a(new_n98_), .b(new_n84_), .c(new_n108_), .d(new_n160_), .O(new_n161_));
  nor2   g105(.a(new_n161_), .b(new_n70_), .O(new_n162_));
  nand2  g106(.a(new_n131_), .b(new_n99_), .O(new_n163_));
  inv1   g107(.a(new_n163_), .O(new_n164_));
  inv1   g108(.a(x30), .O(new_n165_));
  nand2  g109(.a(new_n144_), .b(new_n165_), .O(new_n166_));
  inv1   g110(.a(x33), .O(new_n167_));
  inv1   g111(.a(x34), .O(new_n168_));
  nand3  g112(.a(new_n168_), .b(new_n167_), .c(new_n145_), .O(new_n169_));
  nor2   g113(.a(new_n169_), .b(new_n166_), .O(new_n170_));
  nand3  g114(.a(new_n170_), .b(new_n164_), .c(new_n162_), .O(new_n171_));
  nand2  g115(.a(new_n171_), .b(new_n159_), .O(new_n172_));
