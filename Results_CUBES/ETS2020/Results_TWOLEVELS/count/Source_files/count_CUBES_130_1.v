...
module FAU ( 
  ...
  nand4  g087(.a(new_n141_), .b(new_n140_), .c(new_n113_), .d(new_n94_), .O(new_n142_));
  oai21  g088(.a(new_n142_), .b(new_n86_), .c(x32), .O(new_n143_));
  nor2   g089(.a(x26), .b(x25), .O(new_n144_));
  nor2   g090(.a(x30), .b(x29), .O(new_n145_));
  nor2   g091(.a(x32), .b(x31), .O(new_n146_));
  nand4  g092(.a(new_n146_), .b(new_n145_), .c(new_n122_), .d(new_n144_), .O(new_n147_));
  inv1   g093(.a(new_n147_), .O(new_n148_));
  nand2  g094(.a(new_n148_), .b(new_n87_), .O(new_n149_));
  nand2  g095(.a(new_n149_), .b(new_n143_), .O(new_n150_));
  ...
  nand4  g102(.a(new_n156_), .b(new_n141_), .c(new_n140_), .d(new_n113_), .O(new_n157_));
  ...
  oai21  g110(.a(new_n157_), .b(new_n104_), .c(x34), .O(new_n165_));
  nand2  g111(.a(new_n140_), .b(new_n113_), .O(new_n166_));
