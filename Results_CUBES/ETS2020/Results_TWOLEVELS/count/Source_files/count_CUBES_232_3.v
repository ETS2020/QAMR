...
module FAU ( 
  ...
  oai21  g095(.a(new_n142_), .b(new_n139_), .c(x31), .O(new_n148_));
  ...
  nand3  g100(.a(new_n152_), .b(new_n121_), .c(new_n87_), .O(new_n153_));
  nand2  g101(.a(new_n153_), .b(new_n148_), .O(new_n154_));
  ...
  nand4  g106(.a(new_n150_), .b(new_n149_), .c(new_n114_), .d(new_n94_), .O(new_n159_));
  oai21  g107(.a(new_n159_), .b(new_n86_), .c(x32), .O(new_n160_));
  nor2   g108(.a(x32), .b(x31), .O(new_n161_));
  nand4  g109(.a(new_n161_), .b(new_n141_), .c(new_n123_), .d(new_n140_), .O(new_n162_));
  inv1   g110(.a(new_n162_), .O(new_n163_));
  nand2  g111(.a(new_n163_), .b(new_n87_), .O(new_n164_));
  nand2  g112(.a(new_n164_), .b(new_n160_), .O(new_n165_));
  ...
  oai21  g117(.a(new_n162_), .b(new_n86_), .c(x33), .O(new_n170_));
  nor2   g118(.a(x33), .b(x32), .O(new_n171_));
  nand4  g119(.a(new_n171_), .b(new_n150_), .c(new_n149_), .d(new_n114_), .O(new_n172_));
  inv1   g120(.a(new_n172_), .O(new_n173_));
  nand2  g121(.a(new_n173_), .b(new_n96_), .O(new_n174_));
  ...
  oai21  g127(.a(new_n172_), .b(new_n104_), .c(x34), .O(new_n180_));
  nand2  g128(.a(new_n149_), .b(new_n114_), .O(new_n181_));
  ...
  nand3  g138(.a(new_n190_), .b(new_n182_), .c(new_n96_), .O(new_n191_));
