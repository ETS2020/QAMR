...
module FAU ( 
  ...
  nand3  g060(.a(new_n76_), .b(new_n55_), .c(new_n61_), .O(new_n115_));
  nor2   g061(.a(x28), .b(x27), .O(new_n116_));
  nor2   g062(.a(x26), .b(x23), .O(new_n117_));
  nand3  g063(.a(new_n117_), .b(new_n116_), .c(new_n103_), .O(new_n118_));
  oai21  g064(.a(new_n118_), .b(new_n115_), .c(x29), .O(new_n119_));
  nor3   g065(.a(x29), .b(x28), .c(x27), .O(new_n120_));
  nand4  g066(.a(new_n120_), .b(new_n106_), .c(new_n83_), .d(new_n63_), .O(new_n121_));
  ...
  nand4  g072(.a(new_n102_), .b(new_n55_), .c(new_n69_), .d(new_n61_), .O(new_n127_));
  nor2   g073(.a(x26), .b(x25), .O(new_n128_));
  nor2   g074(.a(x30), .b(x29), .O(new_n129_));
  nand4  g075(.a(new_n129_), .b(new_n116_), .c(new_n128_), .d(new_n82_), .O(new_n130_));
  ...
  nor3   g082(.a(x29), .b(x28), .c(x25), .O(new_n137_));
  nor2   g083(.a(x27), .b(x26), .O(new_n138_));
  ...
  nand4  g094(.a(new_n139_), .b(new_n138_), .c(new_n148_), .d(new_n94_), .O(new_n149_));
  oai21  g095(.a(new_n149_), .b(new_n86_), .c(x32), .O(new_n150_));
  nor2   g096(.a(x32), .b(x31), .O(new_n151_));
  nand4  g097(.a(new_n151_), .b(new_n129_), .c(new_n116_), .d(new_n128_), .O(new_n152_));
  inv1   g098(.a(new_n152_), .O(new_n153_));
  nand2  g099(.a(new_n153_), .b(new_n87_), .O(new_n154_));
  ...
  oai21  g105(.a(new_n152_), .b(new_n86_), .c(x33), .O(new_n160_));
