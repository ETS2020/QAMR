// Benchmark "FAU" written by ABC on Tue Jul  7 19:20:14 2020
...
module FAU ( 
  ...
  nand4  g054(.a(new_n107_), .b(new_n89_), .c(new_n76_), .d(new_n63_), .O(new_n108_));
  nor2   g055(.a(x25), .b(x24), .O(new_n109_));
  nor2   g056(.a(x28), .b(x27), .O(new_n110_));
  nor2   g057(.a(x26), .b(x23), .O(new_n111_));
  nand3  g058(.a(new_n111_), .b(new_n110_), .c(new_n109_), .O(new_n112_));
  nor2   g059(.a(new_n112_), .b(new_n81_), .O(new_n113_));
  ...
  nor3   g065(.a(x26), .b(x25), .c(x24), .O(new_n119_));
  nor3   g066(.a(x29), .b(x28), .c(x27), .O(new_n120_));
  nand4  g067(.a(new_n120_), .b(new_n119_), .c(new_n82_), .d(new_n63_), .O(new_n121_));
  oai21  g068(.a(new_n113_), .b(new_n118_), .c(new_n121_), .O(new_n122_));
  ...
  nor2   g073(.a(x23), .b(x22), .O(new_n128_));
  nand4  g074(.a(new_n128_), .b(new_n55_), .c(new_n74_), .d(new_n61_), .O(new_n129_));
  nor2   g075(.a(x26), .b(x25), .O(new_n130_));
  nor2   g076(.a(x30), .b(x29), .O(new_n131_));
  nand4  g077(.a(new_n131_), .b(new_n130_), .c(new_n110_), .d(new_n87_), .O(new_n132_));
  oai21  g078(.a(new_n132_), .b(new_n129_), .c(x31), .O(new_n133_));
  ...
  nand3  g083(.a(new_n137_), .b(new_n107_), .c(new_n91_), .O(new_n138_));
  ...
  nand4  g090(.a(new_n135_), .b(new_n134_), .c(new_n144_), .d(new_n98_), .O(new_n145_));
  oai21  g091(.a(new_n145_), .b(new_n90_), .c(x32), .O(new_n146_));
  nor2   g092(.a(x32), .b(x31), .O(new_n147_));
  nand4  g093(.a(new_n147_), .b(new_n131_), .c(new_n130_), .d(new_n110_), .O(new_n148_));
  inv1   g094(.a(new_n148_), .O(new_n149_));
  nand2  g095(.a(new_n149_), .b(new_n91_), .O(new_n150_));
  nand2  g096(.a(new_n150_), .b(new_n146_), .O(new_n151_));
  nand2  g097(.a(new_n151_), .b(x16), .O(new_n152_));
  inv1   g098(.a(x02), .O(new_n153_));
  aoi21  g099(.a(new_n58_), .b(new_n153_), .c(x18), .O(new_n154_));
  nand2  g100(.a(new_n154_), .b(new_n152_), .O(z13));
  oai21  g101(.a(new_n148_), .b(new_n90_), .c(x33), .O(new_n156_));
  ...
  nand2  g105(.a(new_n159_), .b(new_n100_), .O(new_n160_));
  ...
  nand4  g111(.a(new_n109_), .b(new_n128_), .c(new_n69_), .d(new_n55_), .O(new_n166_));
  ...
  nand3  g123(.a(new_n177_), .b(new_n169_), .c(new_n100_), .O(new_n178_));
