...
module FAU ( 
  ...
  nand4  g072(.a(new_n125_), .b(new_n106_), .c(new_n78_), .d(new_n62_), .O(new_n126_));
  ...
  nand4  g078(.a(new_n102_), .b(new_n55_), .c(new_n65_), .d(new_n64_), .O(new_n132_));
  ...
  nand4  g088(.a(new_n143_), .b(new_n134_), .c(new_n121_), .d(new_n133_), .O(new_n144_));
  oai21  g089(.a(new_n144_), .b(new_n86_), .c(x33), .O(new_n145_));
  nor2   g090(.a(x29), .b(x28), .O(new_n146_));
  nor2   g091(.a(x31), .b(x30), .O(new_n147_));
  nor2   g092(.a(x33), .b(x32), .O(new_n148_));
  nand4  g093(.a(new_n148_), .b(new_n147_), .c(new_n146_), .d(new_n113_), .O(new_n149_));
  inv1   g094(.a(new_n149_), .O(new_n150_));
  nand2  g095(.a(new_n150_), .b(new_n96_), .O(new_n151_));
  nand2  g096(.a(new_n151_), .b(new_n145_), .O(new_n152_));
  nand2  g097(.a(new_n152_), .b(x16), .O(new_n153_));
  inv1   g098(.a(x01), .O(new_n154_));
  aoi21  g099(.a(new_n58_), .b(new_n154_), .c(x18), .O(new_n155_));
  nand2  g100(.a(new_n155_), .b(new_n153_), .O(z14));
  oai21  g101(.a(new_n149_), .b(new_n104_), .c(x34), .O(new_n157_));
  nand2  g102(.a(new_n146_), .b(new_n113_), .O(new_n158_));
  inv1   g103(.a(new_n158_), .O(new_n159_));
  inv1   g104(.a(x30), .O(new_n160_));
  inv1   g105(.a(x31), .O(new_n161_));
  nand2  g106(.a(new_n161_), .b(new_n160_), .O(new_n162_));
  inv1   g107(.a(x32), .O(new_n163_));
  inv1   g108(.a(x33), .O(new_n164_));
  inv1   g109(.a(x34), .O(new_n165_));
  nand3  g110(.a(new_n165_), .b(new_n164_), .c(new_n163_), .O(new_n166_));
  nor2   g111(.a(new_n166_), .b(new_n162_), .O(new_n167_));
  nand3  g112(.a(new_n167_), .b(new_n159_), .c(new_n96_), .O(new_n168_));
  nand2  g113(.a(new_n168_), .b(new_n157_), .O(new_n169_));
  nand2  g114(.a(new_n169_), .b(x16), .O(new_n170_));
  inv1   g115(.a(x00), .O(new_n171_));
  aoi21  g116(.a(new_n58_), .b(new_n171_), .c(x18), .O(new_n172_));
  nand2  g117(.a(new_n172_), .b(new_n170_), .O(z15));
  zero   g118(.O(z01));
  zero   g119(.O(z09));
  zero   g120(.O(z12));
  zero   g121(.O(z13));
