// Benchmark "FAU" written by ABC on Tue Jul  7 19:19:00 2020
...
module FAU ( 
  ...
  nand4  g069(.a(new_n88_), .b(new_n54_), .c(new_n65_), .d(new_n53_), .O(new_n125_));
  inv1   g070(.a(x24), .O(new_n126_));
  nor2   g071(.a(x26), .b(x25), .O(new_n127_));
  nor2   g072(.a(x30), .b(x29), .O(new_n128_));
  nand4  g073(.a(new_n128_), .b(new_n109_), .c(new_n127_), .d(new_n126_), .O(new_n129_));
  oai21  g074(.a(new_n129_), .b(new_n125_), .c(x31), .O(new_n130_));
  inv1   g075(.a(x22), .O(new_n131_));
  nand4  g076(.a(new_n126_), .b(new_n107_), .c(new_n131_), .d(new_n65_), .O(new_n132_));
  ...
  nand4  g084(.a(new_n139_), .b(new_n105_), .c(new_n133_), .d(new_n56_), .O(new_n140_));
  ...
  inv1   g090(.a(x25), .O(new_n146_));
  nor2   g091(.a(x27), .b(x26), .O(new_n147_));
  nor2   g092(.a(x29), .b(x28), .O(new_n148_));
  nor2   g093(.a(x31), .b(x30), .O(new_n149_));
  nand4  g094(.a(new_n149_), .b(new_n148_), .c(new_n147_), .d(new_n146_), .O(new_n150_));
  oai21  g095(.a(new_n150_), .b(new_n85_), .c(x32), .O(new_n151_));
  inv1   g096(.a(x27), .O(new_n152_));
  nand4  g097(.a(new_n136_), .b(new_n135_), .c(new_n134_), .d(new_n152_), .O(new_n153_));
  inv1   g098(.a(new_n153_), .O(new_n154_));
  inv1   g099(.a(x32), .O(new_n155_));
  nand4  g100(.a(new_n155_), .b(new_n137_), .c(new_n108_), .d(new_n146_), .O(new_n156_));
  inv1   g101(.a(new_n156_), .O(new_n157_));
  nand4  g102(.a(new_n157_), .b(new_n154_), .c(new_n133_), .d(new_n56_), .O(new_n158_));
  ...
  nand4  g109(.a(new_n164_), .b(new_n128_), .c(new_n109_), .d(new_n127_), .O(new_n165_));
  oai21  g110(.a(new_n165_), .b(new_n85_), .c(x33), .O(new_n166_));
  nand4  g111(.a(new_n146_), .b(new_n126_), .c(new_n107_), .d(new_n131_), .O(new_n167_));
  inv1   g112(.a(new_n167_), .O(new_n168_));
  inv1   g113(.a(x33), .O(new_n169_));
  nand4  g114(.a(new_n169_), .b(new_n155_), .c(new_n152_), .d(new_n108_), .O(new_n170_));
  inv1   g115(.a(new_n170_), .O(new_n171_));
  nand4  g116(.a(new_n171_), .b(new_n139_), .c(new_n168_), .d(new_n67_), .O(new_n172_));
  nand2  g117(.a(new_n172_), .b(new_n166_), .O(new_n173_));
  nand2  g118(.a(new_n173_), .b(x16), .O(new_n174_));
  inv1   g119(.a(x01), .O(new_n175_));
  aoi21  g120(.a(new_n59_), .b(new_n175_), .c(x18), .O(new_n176_));
