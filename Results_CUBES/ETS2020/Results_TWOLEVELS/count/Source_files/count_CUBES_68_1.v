...
module FAU ( 
  ...
  nand4  g095(.a(new_n148_), .b(new_n113_), .c(new_n142_), .d(new_n56_), .O(new_n149_));
  ...
  nand4  g102(.a(new_n156_), .b(new_n133_), .c(new_n116_), .d(new_n132_), .O(new_n157_));
  oai21  g103(.a(new_n157_), .b(new_n86_), .c(x33), .O(new_n158_));
  inv1   g104(.a(x32), .O(new_n159_));
  inv1   g105(.a(x33), .O(new_n160_));
  nand4  g106(.a(new_n160_), .b(new_n159_), .c(new_n106_), .d(new_n105_), .O(new_n161_));
  inv1   g107(.a(new_n161_), .O(new_n162_));
  nand4  g108(.a(new_n162_), .b(new_n148_), .c(new_n96_), .d(new_n67_), .O(new_n163_));
  nand2  g109(.a(new_n163_), .b(new_n158_), .O(new_n164_));
