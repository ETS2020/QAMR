...
module FAU ( 
  ...
  wire new_n54_, new_n55_, new_n56_, new_n57_, new_n58_, new_n59_, new_n60_,
    ...
    new_n128_, new_n129_, new_n130_, new_n135_, new_n136_, new_n137_,
  ...
  aoi22  g039(.a(new_n92_), .b(new_n62_), .c(new_n82_), .d(x25), .O(new_n93_));
  ...
  oai21  g043(.a(new_n91_), .b(new_n61_), .c(x26), .O(new_n97_));
  nor2   g044(.a(x23), .b(x22), .O(new_n98_));
  nor3   g045(.a(x26), .b(x25), .c(x24), .O(new_n99_));
  nand3  g046(.a(new_n99_), .b(new_n98_), .c(new_n62_), .O(new_n100_));
  ...
  nand3  g053(.a(new_n106_), .b(new_n81_), .c(new_n90_), .O(new_n107_));
  ...
  nand4  g060(.a(new_n113_), .b(new_n106_), .c(new_n67_), .d(new_n55_), .O(new_n114_));
  inv1   g061(.a(x26), .O(new_n115_));
  nor2   g062(.a(x25), .b(x24), .O(new_n116_));
  nor2   g063(.a(x28), .b(x27), .O(new_n117_));
  nand4  g064(.a(new_n117_), .b(new_n116_), .c(new_n115_), .d(new_n89_), .O(new_n118_));
  ...
  oai21  g070(.a(new_n118_), .b(new_n73_), .c(x29), .O(new_n124_));
  nor3   g071(.a(x29), .b(x28), .c(x27), .O(new_n125_));
  nand4  g072(.a(new_n125_), .b(new_n99_), .c(new_n74_), .d(new_n55_), .O(new_n126_));
  ...
  nor2   g078(.a(x26), .b(x25), .O(new_n135_));
  nor2   g079(.a(x30), .b(x29), .O(new_n136_));
  nor2   g080(.a(x32), .b(x31), .O(new_n137_));
  nand4  g081(.a(new_n137_), .b(new_n136_), .c(new_n117_), .d(new_n135_), .O(new_n138_));
  oai21  g082(.a(new_n138_), .b(new_n82_), .c(x33), .O(new_n139_));
  inv1   g083(.a(x30), .O(new_n140_));
  inv1   g084(.a(x31), .O(new_n141_));
  inv1   g085(.a(x32), .O(new_n142_));
  inv1   g086(.a(x33), .O(new_n143_));
  nand4  g087(.a(new_n143_), .b(new_n142_), .c(new_n141_), .d(new_n140_), .O(new_n144_));
  inv1   g088(.a(new_n144_), .O(new_n145_));
  inv1   g089(.a(x27), .O(new_n146_));
  inv1   g090(.a(x28), .O(new_n147_));
  inv1   g091(.a(x29), .O(new_n148_));
  nand4  g092(.a(new_n148_), .b(new_n147_), .c(new_n146_), .d(new_n115_), .O(new_n149_));
  inv1   g093(.a(new_n149_), .O(new_n150_));
  nand4  g094(.a(new_n150_), .b(new_n145_), .c(new_n92_), .d(new_n62_), .O(new_n151_));
  nand2  g095(.a(new_n151_), .b(new_n139_), .O(new_n152_));
  nand2  g096(.a(new_n152_), .b(x16), .O(new_n153_));
  inv1   g097(.a(x01), .O(new_n154_));
  aoi21  g098(.a(new_n54_), .b(new_n154_), .c(x18), .O(new_n155_));
