...
module FAU ( 
  ...
  nand4  g069(.a(new_n121_), .b(new_n99_), .c(new_n120_), .d(new_n119_), .O(new_n122_));
  ...
  nand4  g076(.a(new_n129_), .b(new_n102_), .c(new_n82_), .d(new_n63_), .O(new_n130_));
  nand4  g077(.a(new_n98_), .b(new_n55_), .c(new_n69_), .d(new_n61_), .O(new_n131_));
  ...
  nand3  g091(.a(new_n144_), .b(new_n117_), .c(new_n91_), .O(new_n145_));
  ...
  nand2  g099(.a(new_n133_), .b(new_n121_), .O(new_n153_));
  inv1   g100(.a(x31), .O(new_n154_));
  inv1   g101(.a(x32), .O(new_n155_));
  nand4  g102(.a(new_n155_), .b(new_n154_), .c(new_n120_), .d(new_n109_), .O(new_n156_));
  ...
  nand4  g114(.a(new_n109_), .b(new_n87_), .c(new_n119_), .d(new_n168_), .O(new_n169_));
