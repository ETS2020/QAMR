...
module FAU ( 
  ...
  nand2  g095(.a(new_n136_), .b(new_n118_), .O(new_n150_));
  inv1   g096(.a(new_n150_), .O(new_n151_));
  nor2   g097(.a(x32), .b(x31), .O(new_n152_));
  nand2  g098(.a(new_n152_), .b(new_n135_), .O(new_n153_));
  inv1   g099(.a(new_n153_), .O(new_n154_));
  nand4  g100(.a(new_n154_), .b(new_n151_), .c(new_n149_), .d(new_n63_), .O(new_n155_));
  nand2  g101(.a(new_n155_), .b(new_n147_), .O(new_n156_));
  ...
  nand4  g106(.a(new_n152_), .b(new_n136_), .c(new_n118_), .d(new_n135_), .O(new_n161_));
  oai21  g107(.a(new_n161_), .b(new_n86_), .c(x33), .O(new_n162_));
  nor2   g108(.a(x33), .b(x32), .O(new_n163_));
  nand4  g109(.a(new_n163_), .b(new_n145_), .c(new_n144_), .d(new_n109_), .O(new_n164_));
  inv1   g110(.a(new_n164_), .O(new_n165_));
  nand2  g111(.a(new_n165_), .b(new_n92_), .O(new_n166_));
  ...
  oai21  g117(.a(new_n164_), .b(new_n100_), .c(x34), .O(new_n172_));
  nand2  g118(.a(new_n144_), .b(new_n109_), .O(new_n173_));
  ...
  nand3  g128(.a(new_n182_), .b(new_n174_), .c(new_n92_), .O(new_n183_));
