...
module FAU ( 
  ...
  nand4  g083(.a(new_n106_), .b(new_n55_), .c(new_n69_), .d(new_n61_), .O(new_n137_));
  nor2   g084(.a(x26), .b(x25), .O(new_n138_));
  nor2   g085(.a(x30), .b(x29), .O(new_n139_));
  nand4  g086(.a(new_n139_), .b(new_n120_), .c(new_n138_), .d(new_n87_), .O(new_n140_));
  oai21  g087(.a(new_n140_), .b(new_n137_), .c(x31), .O(new_n141_));
  ...
  nand3  g092(.a(new_n145_), .b(new_n118_), .c(new_n91_), .O(new_n146_));
  ...
  nand4  g099(.a(new_n153_), .b(new_n139_), .c(new_n120_), .d(new_n138_), .O(new_n154_));
  oai21  g100(.a(new_n154_), .b(new_n90_), .c(x33), .O(new_n155_));
  nor2   g101(.a(x27), .b(x26), .O(new_n156_));
  nor2   g102(.a(x33), .b(x32), .O(new_n157_));
  nand4  g103(.a(new_n157_), .b(new_n143_), .c(new_n142_), .d(new_n156_), .O(new_n158_));
  inv1   g104(.a(new_n158_), .O(new_n159_));
  nand2  g105(.a(new_n159_), .b(new_n100_), .O(new_n160_));
  nand2  g106(.a(new_n160_), .b(new_n155_), .O(new_n161_));
  ...
  oai21  g111(.a(new_n158_), .b(new_n108_), .c(x34), .O(new_n166_));
  nand2  g112(.a(new_n142_), .b(new_n156_), .O(new_n167_));
  ...
  nand3  g122(.a(new_n176_), .b(new_n168_), .c(new_n100_), .O(new_n177_));
