// Benchmark "FAU" written by ABC on Tue Jul  7 19:21:06 2020
...
module FAU ( 
  ...
  nand4  g066(.a(new_n121_), .b(new_n120_), .c(new_n106_), .d(new_n84_), .O(new_n122_));
  ...
  nor3   g073(.a(x29), .b(x28), .c(x25), .O(new_n129_));
  nor2   g074(.a(x27), .b(x26), .O(new_n130_));
  nor2   g075(.a(x31), .b(x30), .O(new_n131_));
  nand2  g076(.a(new_n131_), .b(new_n130_), .O(new_n132_));
  inv1   g077(.a(new_n132_), .O(new_n133_));
  nand3  g078(.a(new_n133_), .b(new_n129_), .c(new_n88_), .O(new_n134_));
  ...
  nand4  g085(.a(new_n141_), .b(new_n121_), .c(new_n120_), .d(new_n106_), .O(new_n142_));
  oai21  g086(.a(new_n142_), .b(new_n87_), .c(x33), .O(new_n143_));
  nor2   g087(.a(x29), .b(x28), .O(new_n144_));
  nor2   g088(.a(x33), .b(x32), .O(new_n145_));
  nand4  g089(.a(new_n145_), .b(new_n131_), .c(new_n130_), .d(new_n144_), .O(new_n146_));
  inv1   g090(.a(new_n146_), .O(new_n147_));
  nand2  g091(.a(new_n147_), .b(new_n97_), .O(new_n148_));
  nand2  g092(.a(new_n148_), .b(new_n143_), .O(new_n149_));
  ...
  nand4  g098(.a(new_n105_), .b(new_n118_), .c(new_n154_), .d(new_n55_), .O(new_n155_));
  oai21  g099(.a(new_n146_), .b(new_n155_), .c(x34), .O(new_n156_));
  nand2  g100(.a(new_n130_), .b(new_n144_), .O(new_n157_));
  ...
  nand3  g110(.a(new_n166_), .b(new_n158_), .c(new_n97_), .O(new_n167_));
