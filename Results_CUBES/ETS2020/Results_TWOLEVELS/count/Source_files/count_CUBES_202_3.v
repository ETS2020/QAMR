// Benchmark "FAU" written by ABC on Tue Jul  7 19:20:22 2020
...
module FAU ( 
  ...
  nand3  g053(.a(new_n106_), .b(new_n85_), .c(new_n95_), .O(new_n107_));
  ...
  nor2   g060(.a(x25), .b(x24), .O(new_n115_));
  nor2   g061(.a(x28), .b(x27), .O(new_n116_));
  nand4  g062(.a(new_n116_), .b(new_n115_), .c(new_n114_), .d(new_n94_), .O(new_n117_));
  oai21  g063(.a(new_n117_), .b(new_n77_), .c(x29), .O(new_n118_));
  nor3   g064(.a(x29), .b(x28), .c(x27), .O(new_n119_));
  nand4  g065(.a(new_n119_), .b(new_n99_), .c(new_n78_), .d(new_n62_), .O(new_n120_));
  ...
  nand4  g071(.a(new_n98_), .b(new_n55_), .c(new_n65_), .d(new_n64_), .O(new_n126_));
  nor2   g072(.a(x26), .b(x25), .O(new_n127_));
  nor2   g073(.a(x30), .b(x29), .O(new_n128_));
  nand4  g074(.a(new_n128_), .b(new_n116_), .c(new_n127_), .d(new_n83_), .O(new_n129_));
  ...
  nand4  g081(.a(new_n83_), .b(new_n94_), .c(new_n93_), .d(new_n65_), .O(new_n136_));
  inv1   g082(.a(new_n136_), .O(new_n137_));
  nor3   g083(.a(x27), .b(x26), .c(x25), .O(new_n138_));
  ...
  nand4  g090(.a(new_n144_), .b(new_n138_), .c(new_n137_), .d(new_n62_), .O(new_n145_));
  ...
  nand4  g098(.a(new_n152_), .b(new_n151_), .c(new_n106_), .d(new_n95_), .O(new_n153_));
  oai21  g099(.a(new_n153_), .b(new_n86_), .c(x32), .O(new_n154_));
  ...
  nand4  g104(.a(new_n158_), .b(new_n142_), .c(new_n114_), .d(new_n95_), .O(new_n159_));
  inv1   g105(.a(new_n159_), .O(new_n160_));
  nand4  g106(.a(new_n160_), .b(new_n157_), .c(new_n137_), .d(new_n62_), .O(new_n161_));
  ...
  nand4  g113(.a(new_n167_), .b(new_n128_), .c(new_n116_), .d(new_n127_), .O(new_n168_));
  oai21  g114(.a(new_n168_), .b(new_n86_), .c(x33), .O(new_n169_));
  inv1   g115(.a(new_n96_), .O(new_n170_));
  inv1   g116(.a(x33), .O(new_n171_));
  nand4  g117(.a(new_n171_), .b(new_n158_), .c(new_n155_), .d(new_n114_), .O(new_n172_));
  inv1   g118(.a(new_n172_), .O(new_n173_));
  nand4  g119(.a(new_n173_), .b(new_n144_), .c(new_n170_), .d(new_n67_), .O(new_n174_));
  nand2  g120(.a(new_n174_), .b(new_n169_), .O(new_n175_));
