// Benchmark "FAU" written by ABC on Tue Jul  7 19:20:43 2020
...
module FAU ( 
  ...
  inv1   g029(.a(x25), .O(new_n83_));
  nor2   g030(.a(x24), .b(x23), .O(new_n84_));
  nand2  g031(.a(new_n84_), .b(new_n71_), .O(new_n85_));
  inv1   g032(.a(new_n85_), .O(new_n86_));
  aoi21  g033(.a(new_n86_), .b(new_n63_), .c(new_n83_), .O(new_n87_));
  inv1   g034(.a(x22), .O(new_n88_));
  inv1   g035(.a(x23), .O(new_n89_));
  inv1   g036(.a(x24), .O(new_n90_));
  nand4  g037(.a(new_n83_), .b(new_n90_), .c(new_n89_), .d(new_n88_), .O(new_n91_));
  nor2   g038(.a(new_n91_), .b(new_n70_), .O(new_n92_));
  oai21  g039(.a(new_n92_), .b(new_n87_), .c(x16), .O(new_n93_));
  ...
  nand3  g054(.a(new_n107_), .b(new_n84_), .c(new_n83_), .O(new_n108_));
  ...
  nand4  g061(.a(new_n114_), .b(new_n84_), .c(new_n71_), .d(new_n63_), .O(new_n115_));
  ...
  nand4  g072(.a(new_n125_), .b(new_n100_), .c(new_n77_), .d(new_n63_), .O(new_n126_));
  ...
  nand4  g078(.a(new_n99_), .b(new_n55_), .c(new_n69_), .d(new_n61_), .O(new_n132_));
  nor2   g079(.a(x30), .b(x29), .O(new_n133_));
  nand4  g080(.a(new_n133_), .b(new_n117_), .c(new_n116_), .d(new_n97_), .O(new_n134_));
  ...
  nand4  g091(.a(new_n144_), .b(new_n114_), .c(new_n86_), .d(new_n63_), .O(new_n145_));
  ...
  nand4  g097(.a(new_n116_), .b(new_n99_), .c(new_n98_), .d(new_n55_), .O(new_n153_));
  nor2   g098(.a(x33), .b(x32), .O(new_n154_));
  nand4  g099(.a(new_n154_), .b(new_n142_), .c(new_n141_), .d(new_n107_), .O(new_n155_));
  oai21  g100(.a(new_n155_), .b(new_n153_), .c(x34), .O(new_n156_));
  nand2  g101(.a(new_n141_), .b(new_n107_), .O(new_n157_));
  ...
  nand3  g111(.a(new_n166_), .b(new_n158_), .c(new_n92_), .O(new_n167_));
  nand2  g112(.a(new_n167_), .b(new_n156_), .O(new_n168_));
