...
module FAU ( 
  ...
  nor3   g042(.a(x27), .b(x26), .c(x25), .O(new_n98_));
  nand4  g043(.a(new_n98_), .b(new_n80_), .c(new_n71_), .d(new_n63_), .O(new_n99_));
  nand3  g044(.a(new_n71_), .b(new_n55_), .c(new_n61_), .O(new_n100_));
  nor2   g045(.a(x25), .b(x24), .O(new_n101_));
  nor2   g046(.a(x28), .b(x27), .O(new_n102_));
  nor2   g047(.a(x26), .b(x23), .O(new_n103_));
  nand3  g048(.a(new_n103_), .b(new_n102_), .c(new_n101_), .O(new_n104_));
  nor2   g049(.a(new_n104_), .b(new_n100_), .O(new_n105_));
  aoi21  g050(.a(new_n99_), .b(x28), .c(new_n105_), .O(new_n106_));
  inv1   g051(.a(x06), .O(new_n107_));
  aoi21  g052(.a(new_n58_), .b(new_n107_), .c(x18), .O(new_n108_));
  oai21  g053(.a(new_n106_), .b(new_n58_), .c(new_n108_), .O(z09));
  inv1   g054(.a(x29), .O(new_n110_));
  nor3   g055(.a(x26), .b(x25), .c(x24), .O(new_n111_));
  nor3   g056(.a(x29), .b(x28), .c(x27), .O(new_n112_));
  nand4  g057(.a(new_n112_), .b(new_n111_), .c(new_n78_), .d(new_n63_), .O(new_n113_));
  oai21  g058(.a(new_n105_), .b(new_n110_), .c(new_n113_), .O(new_n114_));
  ...
  nor2   g063(.a(x23), .b(x22), .O(new_n119_));
  nand4  g064(.a(new_n119_), .b(new_n55_), .c(new_n69_), .d(new_n61_), .O(new_n120_));
  nor2   g065(.a(x26), .b(x25), .O(new_n121_));
  nor2   g066(.a(x30), .b(x29), .O(new_n122_));
  nand4  g067(.a(new_n122_), .b(new_n121_), .c(new_n102_), .d(new_n77_), .O(new_n123_));
  nor2   g068(.a(new_n123_), .b(new_n120_), .O(new_n124_));
  ...
  oai21  g073(.a(new_n123_), .b(new_n120_), .c(x31), .O(new_n129_));
  ...
  nand3  g078(.a(new_n133_), .b(new_n98_), .c(new_n82_), .O(new_n134_));
  nand2  g079(.a(new_n134_), .b(new_n129_), .O(new_n135_));
  nand2  g080(.a(new_n135_), .b(x16), .O(new_n136_));
  inv1   g081(.a(x03), .O(new_n137_));
  aoi21  g082(.a(new_n58_), .b(new_n137_), .c(x18), .O(new_n138_));
  nand2  g083(.a(new_n138_), .b(new_n136_), .O(z12));
  nor2   g084(.a(x27), .b(x26), .O(new_n140_));
  nand4  g085(.a(new_n131_), .b(new_n130_), .c(new_n140_), .d(new_n89_), .O(new_n141_));
  oai21  g086(.a(new_n141_), .b(new_n81_), .c(x32), .O(new_n142_));
  nor2   g087(.a(x32), .b(x31), .O(new_n143_));
  nand4  g088(.a(new_n143_), .b(new_n122_), .c(new_n121_), .d(new_n102_), .O(new_n144_));
  inv1   g089(.a(new_n144_), .O(new_n145_));
  nand2  g090(.a(new_n145_), .b(new_n82_), .O(new_n146_));
  nand2  g091(.a(new_n146_), .b(new_n142_), .O(new_n147_));
  nand2  g092(.a(new_n147_), .b(x16), .O(new_n148_));
  inv1   g093(.a(x02), .O(new_n149_));
  aoi21  g094(.a(new_n58_), .b(new_n149_), .c(x18), .O(new_n150_));
  nand2  g095(.a(new_n150_), .b(new_n148_), .O(z13));
  oai21  g096(.a(new_n144_), .b(new_n81_), .c(x33), .O(new_n152_));
  nor2   g097(.a(x33), .b(x32), .O(new_n153_));
  nand4  g098(.a(new_n153_), .b(new_n131_), .c(new_n130_), .d(new_n140_), .O(new_n154_));
  inv1   g099(.a(new_n154_), .O(new_n155_));
  nand2  g100(.a(new_n155_), .b(new_n91_), .O(new_n156_));
  nand2  g101(.a(new_n156_), .b(new_n152_), .O(new_n157_));
  ...
  nand4  g107(.a(new_n101_), .b(new_n119_), .c(new_n162_), .d(new_n55_), .O(new_n163_));
  oai21  g108(.a(new_n154_), .b(new_n163_), .c(x34), .O(new_n164_));
  nand2  g109(.a(new_n130_), .b(new_n140_), .O(new_n165_));
  ...
  nand3  g119(.a(new_n174_), .b(new_n166_), .c(new_n91_), .O(new_n175_));
