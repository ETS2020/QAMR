...
module FAU ( 
  ...
  nand4  g039(.a(new_n94_), .b(new_n84_), .c(new_n75_), .d(new_n63_), .O(new_n95_));
  ...
  nor2   g044(.a(new_n99_), .b(new_n76_), .O(new_n100_));
  ...
  inv1   g049(.a(x29), .O(new_n105_));
  nor3   g050(.a(x26), .b(x25), .c(x24), .O(new_n106_));
  nor3   g051(.a(x29), .b(x28), .c(x27), .O(new_n107_));
  nand4  g052(.a(new_n107_), .b(new_n106_), .c(new_n77_), .d(new_n63_), .O(new_n108_));
  oai21  g053(.a(new_n100_), .b(new_n105_), .c(new_n108_), .O(new_n109_));
  nand2  g054(.a(new_n109_), .b(x16), .O(new_n110_));
  inv1   g055(.a(x05), .O(new_n111_));
  aoi21  g056(.a(new_n58_), .b(new_n111_), .c(x18), .O(new_n112_));
  nand2  g057(.a(new_n112_), .b(new_n110_), .O(z10));
  inv1   g058(.a(x21), .O(new_n114_));
  nor2   g059(.a(x23), .b(x22), .O(new_n115_));
  nand4  g060(.a(new_n115_), .b(new_n55_), .c(new_n114_), .d(new_n61_), .O(new_n116_));
  nor2   g061(.a(x26), .b(x25), .O(new_n117_));
  nor2   g062(.a(x30), .b(x29), .O(new_n118_));
  nand4  g063(.a(new_n118_), .b(new_n117_), .c(new_n96_), .d(new_n82_), .O(new_n119_));
  nor2   g064(.a(new_n119_), .b(new_n116_), .O(new_n120_));
  aoi21  g065(.a(new_n108_), .b(x30), .c(new_n120_), .O(new_n121_));
  ...
  nor2   g075(.a(x32), .b(x31), .O(new_n132_));
  nand4  g076(.a(new_n132_), .b(new_n118_), .c(new_n117_), .d(new_n96_), .O(new_n133_));
  inv1   g077(.a(new_n133_), .O(new_n134_));
  nand2  g078(.a(new_n134_), .b(new_n86_), .O(new_n135_));
  nand2  g079(.a(new_n135_), .b(new_n131_), .O(new_n136_));
  ...
  oai21  g084(.a(new_n133_), .b(new_n85_), .c(x33), .O(new_n141_));
  nand4  g085(.a(new_n114_), .b(new_n61_), .c(new_n53_), .d(new_n52_), .O(new_n142_));
  inv1   g086(.a(x22), .O(new_n143_));
  inv1   g087(.a(x23), .O(new_n144_));
  nand4  g088(.a(new_n126_), .b(new_n82_), .c(new_n144_), .d(new_n143_), .O(new_n145_));
  nor2   g089(.a(new_n145_), .b(new_n142_), .O(new_n146_));
  nor2   g090(.a(x33), .b(x32), .O(new_n147_));
  nand4  g091(.a(new_n147_), .b(new_n129_), .c(new_n128_), .d(new_n127_), .O(new_n148_));
  inv1   g092(.a(new_n148_), .O(new_n149_));
  nand2  g093(.a(new_n149_), .b(new_n146_), .O(new_n150_));
  nand2  g094(.a(new_n150_), .b(new_n141_), .O(new_n151_));
  ...
  nand4  g099(.a(new_n97_), .b(new_n115_), .c(new_n69_), .d(new_n55_), .O(new_n156_));
  oai21  g100(.a(new_n148_), .b(new_n156_), .c(x34), .O(new_n157_));
  nand2  g101(.a(new_n128_), .b(new_n127_), .O(new_n158_));
  ...
  nand3  g111(.a(new_n167_), .b(new_n159_), .c(new_n146_), .O(new_n168_));
