...
module FAU ( 
  ...
  aoi22  g044(.a(new_n96_), .b(new_n71_), .c(new_n86_), .d(x25), .O(new_n97_));
  ...
  nand3  g057(.a(new_n76_), .b(new_n55_), .c(new_n61_), .O(new_n110_));
  nor2   g058(.a(x27), .b(x26), .O(new_n111_));
  nand3  g059(.a(new_n111_), .b(new_n85_), .c(new_n94_), .O(new_n112_));
  nor2   g060(.a(new_n112_), .b(new_n110_), .O(new_n113_));
  aoi21  g061(.a(new_n104_), .b(x27), .c(new_n113_), .O(new_n114_));
  ...
  nand4  g066(.a(new_n118_), .b(new_n85_), .c(new_n76_), .d(new_n63_), .O(new_n119_));
  inv1   g067(.a(x26), .O(new_n120_));
  nor2   g068(.a(x25), .b(x24), .O(new_n121_));
  nor2   g069(.a(x28), .b(x27), .O(new_n122_));
  nand4  g070(.a(new_n122_), .b(new_n121_), .c(new_n120_), .d(new_n93_), .O(new_n123_));
  nor2   g071(.a(new_n123_), .b(new_n110_), .O(new_n124_));
  ...
  oai21  g076(.a(new_n123_), .b(new_n110_), .c(x29), .O(new_n129_));
  nor3   g077(.a(x29), .b(x28), .c(x27), .O(new_n130_));
  nand4  g078(.a(new_n130_), .b(new_n103_), .c(new_n83_), .d(new_n63_), .O(new_n131_));
  ...
  nand4  g084(.a(new_n102_), .b(new_n55_), .c(new_n69_), .d(new_n61_), .O(new_n138_));
  nor2   g085(.a(x26), .b(x25), .O(new_n139_));
  nor2   g086(.a(x30), .b(x29), .O(new_n140_));
  nand4  g087(.a(new_n140_), .b(new_n122_), .c(new_n139_), .d(new_n82_), .O(new_n141_));
  oai21  g088(.a(new_n141_), .b(new_n138_), .c(x31), .O(new_n142_));
  nand4  g089(.a(new_n82_), .b(new_n93_), .c(new_n92_), .d(new_n69_), .O(new_n143_));
  ...
  nand4  g105(.a(new_n158_), .b(new_n157_), .c(new_n111_), .d(new_n94_), .O(new_n159_));
  ...
  nand4  g111(.a(new_n164_), .b(new_n148_), .c(new_n120_), .d(new_n94_), .O(new_n165_));
  ...
  nand4  g125(.a(new_n178_), .b(new_n150_), .c(new_n96_), .d(new_n71_), .O(new_n179_));
