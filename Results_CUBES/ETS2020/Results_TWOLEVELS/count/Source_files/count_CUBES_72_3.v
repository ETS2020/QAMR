...
module FAU ( 
  ...
  nand4  g070(.a(new_n121_), .b(new_n89_), .c(new_n76_), .d(new_n63_), .O(new_n122_));
  inv1   g071(.a(x23), .O(new_n123_));
  inv1   g072(.a(x26), .O(new_n124_));
  nor2   g073(.a(x28), .b(x27), .O(new_n125_));
  nand4  g074(.a(new_n125_), .b(new_n99_), .c(new_n124_), .d(new_n123_), .O(new_n126_));
  nor2   g075(.a(new_n126_), .b(new_n81_), .O(new_n127_));
  aoi21  g076(.a(new_n122_), .b(x28), .c(new_n127_), .O(new_n128_));
  ...
  nand4  g082(.a(new_n133_), .b(new_n107_), .c(new_n82_), .d(new_n63_), .O(new_n134_));
  ...
  nand4  g088(.a(new_n98_), .b(new_n55_), .c(new_n69_), .d(new_n61_), .O(new_n140_));
  nor2   g089(.a(x30), .b(x29), .O(new_n141_));
  nand4  g090(.a(new_n141_), .b(new_n125_), .c(new_n99_), .d(new_n124_), .O(new_n142_));
  ...
  oai21  g096(.a(new_n142_), .b(new_n140_), .c(x31), .O(new_n148_));
  ...
  nand4  g102(.a(new_n153_), .b(new_n121_), .c(new_n149_), .d(new_n63_), .O(new_n154_));
  ...
  nand4  g109(.a(new_n162_), .b(new_n151_), .c(new_n150_), .d(new_n114_), .O(new_n163_));
  oai21  g110(.a(new_n163_), .b(new_n100_), .c(x34), .O(new_n164_));
  inv1   g111(.a(x22), .O(new_n165_));
  nand4  g112(.a(new_n96_), .b(new_n87_), .c(new_n123_), .d(new_n165_), .O(new_n166_));
  nor2   g113(.a(new_n166_), .b(new_n70_), .O(new_n167_));
  nand2  g114(.a(new_n150_), .b(new_n114_), .O(new_n168_));
  inv1   g115(.a(new_n168_), .O(new_n169_));
  inv1   g116(.a(x30), .O(new_n170_));
  inv1   g117(.a(x31), .O(new_n171_));
  nand2  g118(.a(new_n171_), .b(new_n170_), .O(new_n172_));
  inv1   g119(.a(x32), .O(new_n173_));
  inv1   g120(.a(x33), .O(new_n174_));
  inv1   g121(.a(x34), .O(new_n175_));
  nand3  g122(.a(new_n175_), .b(new_n174_), .c(new_n173_), .O(new_n176_));
  nor2   g123(.a(new_n176_), .b(new_n172_), .O(new_n177_));
  nand3  g124(.a(new_n177_), .b(new_n169_), .c(new_n167_), .O(new_n178_));
  nand2  g125(.a(new_n178_), .b(new_n164_), .O(new_n179_));
  nand2  g126(.a(new_n179_), .b(x16), .O(new_n180_));
  inv1   g127(.a(x00), .O(new_n181_));
  aoi21  g128(.a(new_n58_), .b(new_n181_), .c(x18), .O(new_n182_));
  nand2  g129(.a(new_n182_), .b(new_n180_), .O(z15));
  zero   g130(.O(z13));
  zero   g131(.O(z14));
endmodule
