...
module FAU ( 
  ...
  nand4  g047(.a(new_n104_), .b(new_n91_), .c(new_n79_), .d(new_n56_), .O(new_n105_));
  nand4  g048(.a(new_n90_), .b(new_n54_), .c(new_n65_), .d(new_n53_), .O(new_n106_));
  nor2   g049(.a(x26), .b(x25), .O(new_n107_));
  nor2   g050(.a(x28), .b(x27), .O(new_n108_));
  nor2   g051(.a(x30), .b(x29), .O(new_n109_));
  nand4  g052(.a(new_n109_), .b(new_n108_), .c(new_n107_), .d(new_n78_), .O(new_n110_));
  nor2   g053(.a(new_n110_), .b(new_n106_), .O(new_n111_));
  aoi21  g054(.a(new_n105_), .b(x30), .c(new_n111_), .O(new_n112_));
  ...
  oai21  g058(.a(new_n110_), .b(new_n106_), .c(x31), .O(new_n116_));
  nor3   g059(.a(x27), .b(x26), .c(x25), .O(new_n117_));
  nor2   g060(.a(x29), .b(x28), .O(new_n118_));
  nor2   g061(.a(x31), .b(x30), .O(new_n119_));
  nand2  g062(.a(new_n119_), .b(new_n118_), .O(new_n120_));
  inv1   g063(.a(new_n120_), .O(new_n121_));
  nand3  g064(.a(new_n121_), .b(new_n117_), .c(new_n83_), .O(new_n122_));
  nand2  g065(.a(new_n122_), .b(new_n116_), .O(new_n123_));
  nand2  g066(.a(new_n123_), .b(x16), .O(new_n124_));
  inv1   g067(.a(x03), .O(new_n125_));
  aoi21  g068(.a(new_n59_), .b(new_n125_), .c(x18), .O(new_n126_));
  nand2  g069(.a(new_n126_), .b(new_n124_), .O(z12));
  nand4  g070(.a(new_n119_), .b(new_n118_), .c(new_n95_), .d(new_n94_), .O(new_n128_));
  oai21  g071(.a(new_n128_), .b(new_n82_), .c(x32), .O(new_n129_));
  nor2   g072(.a(x32), .b(x31), .O(new_n130_));
  nand4  g073(.a(new_n130_), .b(new_n109_), .c(new_n108_), .d(new_n107_), .O(new_n131_));
  ...
  nand4  g087(.a(new_n144_), .b(new_n119_), .c(new_n118_), .d(new_n95_), .O(new_n145_));
  ...
  nor2   g096(.a(x25), .b(x24), .O(new_n154_));
  nand4  g097(.a(new_n154_), .b(new_n90_), .c(new_n153_), .d(new_n54_), .O(new_n155_));
  oai21  g098(.a(new_n145_), .b(new_n155_), .c(x34), .O(new_n156_));
  nand2  g099(.a(new_n118_), .b(new_n95_), .O(new_n157_));
  ...
  nand3  g109(.a(new_n166_), .b(new_n158_), .c(new_n143_), .O(new_n167_));
