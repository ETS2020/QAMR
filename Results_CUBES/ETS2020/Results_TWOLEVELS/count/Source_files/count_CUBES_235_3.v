...
module FAU ( 
  ...
  nand3  g055(.a(new_n72_), .b(new_n55_), .c(new_n62_), .O(new_n109_));
  ...
  nand4  g064(.a(new_n117_), .b(new_n81_), .c(new_n72_), .d(new_n71_), .O(new_n118_));
  inv1   g065(.a(x26), .O(new_n119_));
  nor2   g066(.a(x28), .b(x27), .O(new_n120_));
  nand4  g067(.a(new_n120_), .b(new_n99_), .c(new_n119_), .d(new_n89_), .O(new_n121_));
  nor2   g068(.a(new_n121_), .b(new_n109_), .O(new_n122_));
  ...
  nand4  g074(.a(new_n128_), .b(new_n102_), .c(new_n79_), .d(new_n71_), .O(new_n129_));
  nand4  g075(.a(new_n98_), .b(new_n55_), .c(new_n64_), .d(new_n62_), .O(new_n130_));
  nor2   g076(.a(x26), .b(x25), .O(new_n131_));
  nor2   g077(.a(x30), .b(x29), .O(new_n132_));
  nand4  g078(.a(new_n132_), .b(new_n120_), .c(new_n131_), .d(new_n78_), .O(new_n133_));
  ...
  nand3  g089(.a(new_n143_), .b(new_n117_), .c(new_n83_), .O(new_n144_));
  ...
  nand4  g100(.a(new_n154_), .b(new_n153_), .c(new_n119_), .d(new_n90_), .O(new_n155_));
  nor2   g101(.a(new_n155_), .b(new_n152_), .O(new_n156_));
  nand2  g102(.a(new_n156_), .b(new_n83_), .O(new_n157_));
  ...
  oai21  g110(.a(new_n165_), .b(new_n100_), .c(x34), .O(new_n166_));
  ...
  nand3  g119(.a(new_n174_), .b(new_n168_), .c(new_n92_), .O(new_n175_));
