// Benchmark "FAU" written by ABC on Tue Jul  7 19:18:27 2020
...
module FAU ( 
  ...
  nand4  g080(.a(new_n98_), .b(new_n55_), .c(new_n68_), .d(new_n61_), .O(new_n135_));
  nor2   g081(.a(x26), .b(x25), .O(new_n136_));
  nor2   g082(.a(x30), .b(x29), .O(new_n137_));
  nand4  g083(.a(new_n137_), .b(new_n118_), .c(new_n136_), .d(new_n89_), .O(new_n138_));
  oai21  g084(.a(new_n138_), .b(new_n135_), .c(x31), .O(new_n139_));
  nand2  g085(.a(new_n85_), .b(new_n77_), .O(new_n140_));
  ...
  nand4  g091(.a(new_n145_), .b(new_n116_), .c(new_n141_), .d(new_n63_), .O(new_n146_));
  ...
  nor2   g097(.a(x32), .b(x31), .O(new_n153_));
  nand4  g098(.a(new_n153_), .b(new_n137_), .c(new_n118_), .d(new_n136_), .O(new_n154_));
  oai21  g099(.a(new_n154_), .b(new_n86_), .c(x33), .O(new_n155_));
  nor2   g100(.a(x33), .b(x32), .O(new_n156_));
  nand4  g101(.a(new_n156_), .b(new_n143_), .c(new_n142_), .d(new_n109_), .O(new_n157_));
  ...
  oai21  g109(.a(new_n157_), .b(new_n100_), .c(x34), .O(new_n165_));
  nand2  g110(.a(new_n142_), .b(new_n109_), .O(new_n166_));
