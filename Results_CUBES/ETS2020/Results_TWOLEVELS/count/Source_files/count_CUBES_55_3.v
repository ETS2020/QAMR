...
module FAU ( 
  ...
  nand4  g095(.a(new_n140_), .b(new_n139_), .c(new_n149_), .d(new_n90_), .O(new_n150_));
  oai21  g096(.a(new_n150_), .b(new_n82_), .c(x32), .O(new_n151_));
  nor2   g097(.a(x32), .b(x31), .O(new_n152_));
  nand4  g098(.a(new_n152_), .b(new_n131_), .c(new_n113_), .d(new_n130_), .O(new_n153_));
  ...
  nand4  g108(.a(new_n162_), .b(new_n140_), .c(new_n139_), .d(new_n149_), .O(new_n163_));
  ...
  nand2  g117(.a(new_n139_), .b(new_n149_), .O(new_n172_));
