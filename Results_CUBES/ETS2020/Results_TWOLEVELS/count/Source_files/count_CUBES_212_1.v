...
module FAU ( 
  ...
  inv1   g042(.a(x22), .O(new_n96_));
  inv1   g043(.a(x23), .O(new_n97_));
  inv1   g044(.a(x25), .O(new_n98_));
  nand4  g045(.a(new_n98_), .b(new_n85_), .c(new_n97_), .d(new_n96_), .O(new_n99_));
  nor2   g046(.a(new_n99_), .b(new_n70_), .O(new_n100_));
  ...
  oai21  g051(.a(new_n100_), .b(new_n95_), .c(new_n104_), .O(new_n105_));
  ...
  nand4  g057(.a(new_n111_), .b(new_n87_), .c(new_n72_), .d(new_n63_), .O(new_n112_));
  nor2   g058(.a(x25), .b(x24), .O(new_n113_));
  nor2   g059(.a(x28), .b(x27), .O(new_n114_));
  nand4  g060(.a(new_n114_), .b(new_n113_), .c(new_n95_), .d(new_n97_), .O(new_n115_));
  ...
  nand4  g067(.a(new_n122_), .b(new_n103_), .c(new_n80_), .d(new_n63_), .O(new_n123_));
  nand4  g068(.a(new_n102_), .b(new_n55_), .c(new_n69_), .d(new_n61_), .O(new_n124_));
  nor2   g069(.a(x26), .b(x25), .O(new_n125_));
  nor2   g070(.a(x30), .b(x29), .O(new_n126_));
  nand4  g071(.a(new_n126_), .b(new_n114_), .c(new_n125_), .d(new_n85_), .O(new_n127_));
  ...
  nand4  g080(.a(new_n136_), .b(new_n135_), .c(new_n134_), .d(new_n98_), .O(new_n137_));
  oai21  g081(.a(new_n137_), .b(new_n88_), .c(x32), .O(new_n138_));
  nor2   g082(.a(x32), .b(x31), .O(new_n139_));
  nand4  g083(.a(new_n139_), .b(new_n126_), .c(new_n114_), .d(new_n125_), .O(new_n140_));
  inv1   g084(.a(new_n140_), .O(new_n141_));
  nand2  g085(.a(new_n141_), .b(new_n89_), .O(new_n142_));
  ...
  oai21  g091(.a(new_n140_), .b(new_n88_), .c(x33), .O(new_n148_));
  nor2   g092(.a(x33), .b(x32), .O(new_n149_));
  nand4  g093(.a(new_n149_), .b(new_n136_), .c(new_n135_), .d(new_n134_), .O(new_n150_));
  inv1   g094(.a(new_n150_), .O(new_n151_));
  nand2  g095(.a(new_n151_), .b(new_n100_), .O(new_n152_));
  ...
  nand4  g101(.a(new_n113_), .b(new_n102_), .c(new_n101_), .d(new_n55_), .O(new_n158_));
  ...
  nand3  g113(.a(new_n169_), .b(new_n161_), .c(new_n100_), .O(new_n170_));
