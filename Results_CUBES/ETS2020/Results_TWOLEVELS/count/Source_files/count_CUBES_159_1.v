...
module FAU ( 
  ...
  nand4  g076(.a(new_n129_), .b(new_n103_), .c(new_n78_), .d(new_n62_), .O(new_n130_));
  nand4  g077(.a(new_n102_), .b(new_n55_), .c(new_n65_), .d(new_n64_), .O(new_n131_));
  nor2   g078(.a(x26), .b(x25), .O(new_n132_));
  nor2   g079(.a(x30), .b(x29), .O(new_n133_));
  nand4  g080(.a(new_n133_), .b(new_n121_), .c(new_n132_), .d(new_n83_), .O(new_n134_));
  ...
  nand4  g090(.a(new_n83_), .b(new_n93_), .c(new_n92_), .d(new_n65_), .O(new_n145_));
  ...
  nand4  g102(.a(new_n156_), .b(new_n152_), .c(new_n146_), .d(new_n62_), .O(new_n157_));
  ...
  nand4  g116(.a(new_n170_), .b(new_n167_), .c(new_n96_), .d(new_n67_), .O(new_n171_));
