...
module FAU ( 
  ...
  nor2   g092(.a(x27), .b(x26), .O(new_n146_));
  nor2   g093(.a(x29), .b(x28), .O(new_n147_));
  nor2   g094(.a(x31), .b(x30), .O(new_n148_));
  nand4  g095(.a(new_n148_), .b(new_n147_), .c(new_n146_), .d(new_n98_), .O(new_n149_));
  oai21  g096(.a(new_n149_), .b(new_n90_), .c(x32), .O(new_n150_));
  nor2   g097(.a(x32), .b(x31), .O(new_n151_));
  nand4  g098(.a(new_n151_), .b(new_n138_), .c(new_n120_), .d(new_n137_), .O(new_n152_));
  inv1   g099(.a(new_n152_), .O(new_n153_));
  nand2  g100(.a(new_n153_), .b(new_n91_), .O(new_n154_));
  nand2  g101(.a(new_n154_), .b(new_n150_), .O(new_n155_));
  nand2  g102(.a(new_n155_), .b(x16), .O(new_n156_));
  inv1   g103(.a(x02), .O(new_n157_));
  aoi21  g104(.a(new_n58_), .b(new_n157_), .c(x18), .O(new_n158_));
  nand2  g105(.a(new_n158_), .b(new_n156_), .O(z13));
  oai21  g106(.a(new_n152_), .b(new_n90_), .c(x33), .O(new_n160_));
  nor2   g107(.a(x33), .b(x32), .O(new_n161_));
  nand4  g108(.a(new_n161_), .b(new_n148_), .c(new_n147_), .d(new_n146_), .O(new_n162_));
  inv1   g109(.a(new_n162_), .O(new_n163_));
  nand2  g110(.a(new_n163_), .b(new_n100_), .O(new_n164_));
  nand2  g111(.a(new_n164_), .b(new_n160_), .O(new_n165_));
  nand2  g112(.a(new_n165_), .b(x16), .O(new_n166_));
  inv1   g113(.a(x01), .O(new_n167_));
  aoi21  g114(.a(new_n58_), .b(new_n167_), .c(x18), .O(new_n168_));
  nand2  g115(.a(new_n168_), .b(new_n166_), .O(z14));
  oai21  g116(.a(new_n162_), .b(new_n108_), .c(x34), .O(new_n170_));
  nand2  g117(.a(new_n147_), .b(new_n146_), .O(new_n171_));
  inv1   g118(.a(new_n171_), .O(new_n172_));
  inv1   g119(.a(x30), .O(new_n173_));
  inv1   g120(.a(x31), .O(new_n174_));
  nand2  g121(.a(new_n174_), .b(new_n173_), .O(new_n175_));
  inv1   g122(.a(x32), .O(new_n176_));
  inv1   g123(.a(x33), .O(new_n177_));
  inv1   g124(.a(x34), .O(new_n178_));
  nand3  g125(.a(new_n178_), .b(new_n177_), .c(new_n176_), .O(new_n179_));
  nor2   g126(.a(new_n179_), .b(new_n175_), .O(new_n180_));
  nand3  g127(.a(new_n180_), .b(new_n172_), .c(new_n100_), .O(new_n181_));
  nand2  g128(.a(new_n181_), .b(new_n170_), .O(new_n182_));
