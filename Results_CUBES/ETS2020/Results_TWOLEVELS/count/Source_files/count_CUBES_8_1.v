...
module FAU ( 
  ...
  nor2   g009(.a(x22), .b(x21), .O(new_n64_));
  nand3  g010(.a(new_n64_), .b(new_n54_), .c(new_n53_), .O(new_n65_));
  nor3   g011(.a(x23), .b(x22), .c(x21), .O(new_n66_));
  aoi22  g012(.a(new_n66_), .b(new_n56_), .c(new_n65_), .d(x23), .O(new_n67_));
  inv1   g013(.a(x11), .O(new_n68_));
  aoi21  g014(.a(new_n59_), .b(new_n68_), .c(x18), .O(new_n69_));
  oai21  g015(.a(new_n67_), .b(new_n59_), .c(new_n69_), .O(z04));
  inv1   g016(.a(x24), .O(new_n71_));
  aoi21  g017(.a(new_n66_), .b(new_n56_), .c(new_n71_), .O(new_n72_));
  nor2   g018(.a(x24), .b(x23), .O(new_n73_));
  nand4  g019(.a(new_n73_), .b(new_n64_), .c(new_n54_), .d(new_n53_), .O(new_n74_));
  inv1   g020(.a(new_n74_), .O(new_n75_));
  oai21  g021(.a(new_n75_), .b(new_n72_), .c(x16), .O(new_n76_));
  inv1   g022(.a(x10), .O(new_n77_));
  aoi21  g023(.a(new_n59_), .b(new_n77_), .c(x18), .O(new_n78_));
  nand2  g024(.a(new_n78_), .b(new_n76_), .O(z05));
  inv1   g025(.a(x17), .O(new_n80_));
  inv1   g026(.a(x19), .O(new_n81_));
  inv1   g027(.a(x21), .O(new_n82_));
  nand4  g028(.a(new_n82_), .b(new_n53_), .c(new_n81_), .d(new_n80_), .O(new_n83_));
  ...
  aoi21  g034(.a(new_n74_), .b(x25), .c(new_n88_), .O(new_n89_));
  inv1   g035(.a(x09), .O(new_n90_));
  aoi21  g036(.a(new_n59_), .b(new_n90_), .c(x18), .O(new_n91_));
  oai21  g037(.a(new_n89_), .b(new_n59_), .c(new_n91_), .O(z06));
  nor2   g038(.a(x23), .b(x22), .O(new_n94_));
  nor2   g039(.a(x21), .b(x20), .O(new_n95_));
  nor3   g040(.a(x26), .b(x25), .c(x24), .O(new_n96_));
  nand4  g041(.a(new_n96_), .b(new_n95_), .c(new_n94_), .d(new_n54_), .O(new_n97_));
  nor2   g042(.a(x27), .b(x26), .O(new_n98_));
  nand3  g043(.a(new_n98_), .b(new_n73_), .c(new_n86_), .O(new_n99_));
  nor2   g044(.a(new_n99_), .b(new_n65_), .O(new_n100_));
  ...
  nand4  g050(.a(new_n105_), .b(new_n73_), .c(new_n64_), .d(new_n56_), .O(new_n106_));
  ...
  nor2   g055(.a(new_n110_), .b(new_n65_), .O(new_n111_));
  aoi21  g056(.a(new_n106_), .b(x28), .c(new_n111_), .O(new_n112_));
  inv1   g057(.a(x06), .O(new_n113_));
  aoi21  g058(.a(new_n59_), .b(new_n113_), .c(x18), .O(new_n114_));
  oai21  g059(.a(new_n112_), .b(new_n59_), .c(new_n114_), .O(z09));
  inv1   g060(.a(x29), .O(new_n116_));
  nor3   g061(.a(x29), .b(x28), .c(x27), .O(new_n117_));
  nand4  g062(.a(new_n117_), .b(new_n96_), .c(new_n66_), .d(new_n56_), .O(new_n118_));
  ...
  nand4  g068(.a(new_n94_), .b(new_n54_), .c(new_n82_), .d(new_n53_), .O(new_n124_));
  nor2   g069(.a(x26), .b(x25), .O(new_n125_));
  nor2   g070(.a(x30), .b(x29), .O(new_n126_));
  nand4  g071(.a(new_n126_), .b(new_n108_), .c(new_n125_), .d(new_n71_), .O(new_n127_));
  ...
  nand3  g082(.a(new_n137_), .b(new_n105_), .c(new_n75_), .O(new_n138_));
  ...
  nand4  g089(.a(new_n145_), .b(new_n126_), .c(new_n108_), .d(new_n125_), .O(new_n146_));
  oai21  g090(.a(new_n146_), .b(new_n74_), .c(x33), .O(new_n147_));
  nor2   g091(.a(x33), .b(x32), .O(new_n148_));
  nand4  g092(.a(new_n148_), .b(new_n135_), .c(new_n134_), .d(new_n98_), .O(new_n149_));
  inv1   g093(.a(new_n149_), .O(new_n150_));
  nand2  g094(.a(new_n150_), .b(new_n88_), .O(new_n151_));
  nand2  g095(.a(new_n151_), .b(new_n147_), .O(new_n152_));
  nand2  g096(.a(new_n152_), .b(x16), .O(new_n153_));
  inv1   g097(.a(x01), .O(new_n154_));
  aoi21  g098(.a(new_n59_), .b(new_n154_), .c(x18), .O(new_n155_));
  nand2  g099(.a(new_n155_), .b(new_n153_), .O(z14));
  nand4  g100(.a(new_n107_), .b(new_n95_), .c(new_n94_), .d(new_n54_), .O(new_n157_));
  oai21  g101(.a(new_n149_), .b(new_n157_), .c(x34), .O(new_n158_));
  nand2  g102(.a(new_n134_), .b(new_n98_), .O(new_n159_));
  ...
  nand3  g112(.a(new_n168_), .b(new_n160_), .c(new_n88_), .O(new_n169_));
