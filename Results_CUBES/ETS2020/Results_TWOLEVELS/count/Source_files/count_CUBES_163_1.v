...
module FAU ( 
  ...
  nand4  g054(.a(new_n108_), .b(new_n79_), .c(new_n70_), .d(new_n63_), .O(new_n109_));
  nor2   g055(.a(x25), .b(x24), .O(new_n110_));
  nor2   g056(.a(x28), .b(x27), .O(new_n111_));
  nand4  g057(.a(new_n111_), .b(new_n110_), .c(new_n97_), .d(new_n89_), .O(new_n112_));
  nor2   g058(.a(new_n112_), .b(new_n71_), .O(new_n113_));
  ...
  nand4  g065(.a(new_n119_), .b(new_n100_), .c(new_n72_), .d(new_n63_), .O(new_n120_));
  ...
  nand4  g071(.a(new_n98_), .b(new_n55_), .c(new_n86_), .d(new_n61_), .O(new_n126_));
  nor2   g072(.a(x26), .b(x25), .O(new_n127_));
  nor2   g073(.a(x30), .b(x29), .O(new_n128_));
  nand4  g074(.a(new_n128_), .b(new_n111_), .c(new_n127_), .d(new_n77_), .O(new_n129_));
  ...
  nand3  g085(.a(new_n139_), .b(new_n108_), .c(new_n81_), .O(new_n140_));
  ...
  nand4  g092(.a(new_n137_), .b(new_n136_), .c(new_n146_), .d(new_n90_), .O(new_n147_));
  oai21  g093(.a(new_n147_), .b(new_n80_), .c(x32), .O(new_n148_));
  nor2   g094(.a(x32), .b(x31), .O(new_n149_));
  nand4  g095(.a(new_n149_), .b(new_n128_), .c(new_n111_), .d(new_n127_), .O(new_n150_));
  inv1   g096(.a(new_n150_), .O(new_n151_));
  nand2  g097(.a(new_n151_), .b(new_n81_), .O(new_n152_));
  ...
  oai21  g103(.a(new_n150_), .b(new_n80_), .c(x33), .O(new_n158_));
  nor2   g104(.a(x33), .b(x32), .O(new_n159_));
  nand4  g105(.a(new_n159_), .b(new_n137_), .c(new_n136_), .d(new_n146_), .O(new_n160_));
  inv1   g106(.a(new_n160_), .O(new_n161_));
  nand2  g107(.a(new_n161_), .b(new_n92_), .O(new_n162_));
  ...
  nand4  g113(.a(new_n110_), .b(new_n99_), .c(new_n98_), .d(new_n55_), .O(new_n168_));
  oai21  g114(.a(new_n160_), .b(new_n168_), .c(x34), .O(new_n169_));
  nand2  g115(.a(new_n136_), .b(new_n146_), .O(new_n170_));
  ...
  nand3  g125(.a(new_n179_), .b(new_n171_), .c(new_n92_), .O(new_n180_));
