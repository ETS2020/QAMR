...
module FAU ( 
  ...
  nand4  g091(.a(new_n145_), .b(new_n144_), .c(new_n114_), .d(new_n94_), .O(new_n146_));
  oai21  g092(.a(new_n146_), .b(new_n86_), .c(x32), .O(new_n147_));
  nor2   g093(.a(x32), .b(x31), .O(new_n148_));
  nand4  g094(.a(new_n148_), .b(new_n136_), .c(new_n123_), .d(new_n135_), .O(new_n149_));
  ...
  nand4  g104(.a(new_n158_), .b(new_n145_), .c(new_n144_), .d(new_n114_), .O(new_n159_));
  ...
  nand2  g113(.a(new_n144_), .b(new_n114_), .O(new_n168_));
