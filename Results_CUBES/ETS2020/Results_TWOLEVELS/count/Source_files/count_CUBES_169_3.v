...
module FAU ( 
  ...
  nand4  g089(.a(new_n143_), .b(new_n142_), .c(new_n113_), .d(new_n94_), .O(new_n144_));
  oai21  g090(.a(new_n144_), .b(new_n86_), .c(x32), .O(new_n145_));
  nor2   g091(.a(x32), .b(x31), .O(new_n146_));
  nand4  g092(.a(new_n146_), .b(new_n134_), .c(new_n121_), .d(new_n133_), .O(new_n147_));
  ...
  nand4  g102(.a(new_n156_), .b(new_n143_), .c(new_n142_), .d(new_n113_), .O(new_n157_));
  ...
  nand2  g111(.a(new_n142_), .b(new_n113_), .O(new_n166_));
