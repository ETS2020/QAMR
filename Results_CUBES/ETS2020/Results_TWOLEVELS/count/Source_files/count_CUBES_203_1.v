...
module FAU ( 
  ...
  nor2   g033(.a(x25), .b(x24), .O(new_n88_));
  nand4  g034(.a(new_n88_), .b(new_n79_), .c(new_n87_), .d(new_n54_), .O(new_n89_));
  nand2  g035(.a(new_n89_), .b(x26), .O(new_n90_));
  inv1   g036(.a(x24), .O(new_n91_));
  nor2   g037(.a(x26), .b(x25), .O(new_n92_));
  nand4  g038(.a(new_n92_), .b(new_n79_), .c(new_n67_), .d(new_n91_), .O(new_n93_));
  nand2  g039(.a(new_n93_), .b(new_n90_), .O(new_n94_));
  nand2  g040(.a(new_n94_), .b(x16), .O(new_n95_));
  inv1   g041(.a(x08), .O(new_n96_));
  aoi21  g042(.a(new_n59_), .b(new_n96_), .c(x18), .O(new_n97_));
  ...
  nor2   g048(.a(new_n102_), .b(new_n77_), .O(new_n103_));
  ...
  nand4  g054(.a(new_n108_), .b(new_n100_), .c(new_n72_), .d(new_n56_), .O(new_n109_));
  nor2   g055(.a(x28), .b(x27), .O(new_n110_));
  nor2   g056(.a(x26), .b(x23), .O(new_n111_));
  nand3  g057(.a(new_n111_), .b(new_n110_), .c(new_n88_), .O(new_n112_));
  ...
  nand4  g064(.a(new_n120_), .b(new_n110_), .c(new_n92_), .d(new_n91_), .O(new_n121_));
  oai21  g065(.a(new_n121_), .b(new_n80_), .c(x31), .O(new_n122_));
  ...
  nand4  g072(.a(new_n128_), .b(new_n124_), .c(new_n108_), .d(new_n56_), .O(new_n129_));
  ...
  nand4  g078(.a(new_n100_), .b(new_n72_), .c(new_n54_), .d(new_n53_), .O(new_n136_));
  nor2   g079(.a(x32), .b(x31), .O(new_n137_));
  nand4  g080(.a(new_n137_), .b(new_n120_), .c(new_n110_), .d(new_n92_), .O(new_n138_));
  oai21  g081(.a(new_n138_), .b(new_n136_), .c(x33), .O(new_n139_));
  inv1   g082(.a(x22), .O(new_n140_));
  inv1   g083(.a(x23), .O(new_n141_));
  nand4  g084(.a(new_n99_), .b(new_n91_), .c(new_n141_), .d(new_n140_), .O(new_n142_));
  nor2   g085(.a(new_n142_), .b(new_n66_), .O(new_n143_));
  nor2   g086(.a(x33), .b(x32), .O(new_n144_));
  nand4  g087(.a(new_n144_), .b(new_n126_), .c(new_n125_), .d(new_n101_), .O(new_n145_));
  ...
  oai21  g095(.a(new_n145_), .b(new_n89_), .c(x34), .O(new_n153_));
  nand2  g096(.a(new_n125_), .b(new_n101_), .O(new_n154_));
