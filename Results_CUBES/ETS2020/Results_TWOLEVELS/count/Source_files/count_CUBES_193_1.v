// Benchmark "FAU" written by ABC on Tue Jul  7 19:20:13 2020
...
module FAU ( 
  ...
  nand4  g098(.a(new_n152_), .b(new_n133_), .c(new_n116_), .d(new_n132_), .O(new_n153_));
  oai21  g099(.a(new_n153_), .b(new_n81_), .c(x33), .O(new_n154_));
  nor2   g100(.a(x33), .b(x32), .O(new_n155_));
  nand4  g101(.a(new_n155_), .b(new_n142_), .c(new_n141_), .d(new_n106_), .O(new_n156_));
  inv1   g102(.a(new_n156_), .O(new_n157_));
  nand2  g103(.a(new_n157_), .b(new_n91_), .O(new_n158_));
  ...
  nand4  g109(.a(new_n115_), .b(new_n98_), .c(new_n97_), .d(new_n54_), .O(new_n164_));
  oai21  g110(.a(new_n156_), .b(new_n164_), .c(x34), .O(new_n165_));
  nand2  g111(.a(new_n141_), .b(new_n106_), .O(new_n166_));
  ...
  nand3  g121(.a(new_n175_), .b(new_n167_), .c(new_n91_), .O(new_n176_));
