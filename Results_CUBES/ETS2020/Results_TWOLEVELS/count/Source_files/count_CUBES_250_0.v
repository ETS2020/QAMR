...
module FAU ( 
  ...
  nand4  g099(.a(new_n153_), .b(new_n132_), .c(new_n115_), .d(new_n131_), .O(new_n154_));
  oai21  g100(.a(new_n154_), .b(new_n84_), .c(x33), .O(new_n155_));
  nor2   g101(.a(x33), .b(x32), .O(new_n156_));
  nand4  g102(.a(new_n156_), .b(new_n143_), .c(new_n142_), .d(new_n105_), .O(new_n157_));
  inv1   g103(.a(new_n157_), .O(new_n158_));
  nand2  g104(.a(new_n158_), .b(new_n90_), .O(new_n159_));
  ...
  nand4  g110(.a(new_n114_), .b(new_n97_), .c(new_n96_), .d(new_n55_), .O(new_n165_));
  oai21  g111(.a(new_n157_), .b(new_n165_), .c(x34), .O(new_n166_));
  nand2  g112(.a(new_n142_), .b(new_n105_), .O(new_n167_));
  ...
  nand3  g122(.a(new_n176_), .b(new_n168_), .c(new_n90_), .O(new_n177_));
