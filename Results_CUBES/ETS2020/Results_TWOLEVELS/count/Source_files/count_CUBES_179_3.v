...
module FAU ( 
  ...
  nand4  g072(.a(new_n124_), .b(new_n123_), .c(new_n122_), .d(new_n97_), .O(new_n125_));
  ...
  nand4  g114(.a(new_n166_), .b(new_n150_), .c(new_n122_), .d(new_n98_), .O(new_n167_));
  ...
  nand4  g123(.a(new_n175_), .b(new_n136_), .c(new_n124_), .d(new_n135_), .O(new_n176_));
  oai21  g124(.a(new_n176_), .b(new_n90_), .c(x33), .O(new_n177_));
  inv1   g125(.a(x33), .O(new_n178_));
  nand4  g126(.a(new_n178_), .b(new_n166_), .c(new_n163_), .d(new_n122_), .O(new_n179_));
