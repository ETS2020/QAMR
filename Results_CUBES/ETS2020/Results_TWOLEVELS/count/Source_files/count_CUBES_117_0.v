// Benchmark "FAU" written by ABC on Tue Jul  7 19:18:57 2020
...
module FAU ( 
  ...
  oai21  g048(.a(new_n95_), .b(new_n70_), .c(x26), .O(new_n101_));
  nor2   g049(.a(x23), .b(x22), .O(new_n102_));
  nor3   g050(.a(x26), .b(x25), .c(x24), .O(new_n103_));
  nand3  g051(.a(new_n103_), .b(new_n102_), .c(new_n91_), .O(new_n104_));
  ...
  nand3  g058(.a(new_n110_), .b(new_n84_), .c(new_n94_), .O(new_n111_));
  ...
  nor2   g070(.a(new_n122_), .b(new_n76_), .O(new_n123_));
  ...
  oai21  g075(.a(new_n122_), .b(new_n76_), .c(x29), .O(new_n128_));
  nor3   g076(.a(x29), .b(x28), .c(x27), .O(new_n129_));
  nand4  g077(.a(new_n129_), .b(new_n103_), .c(new_n77_), .d(new_n63_), .O(new_n130_));
  ...
  nand4  g083(.a(new_n102_), .b(new_n55_), .c(new_n69_), .d(new_n61_), .O(new_n136_));
  nor2   g084(.a(x26), .b(x25), .O(new_n137_));
  nor2   g085(.a(x30), .b(x29), .O(new_n138_));
  nand4  g086(.a(new_n138_), .b(new_n121_), .c(new_n137_), .d(new_n82_), .O(new_n139_));
  ...
  nand4  g094(.a(new_n147_), .b(new_n146_), .c(new_n110_), .d(new_n94_), .O(new_n148_));
  oai21  g095(.a(new_n148_), .b(new_n85_), .c(x32), .O(new_n149_));
  nand4  g096(.a(new_n82_), .b(new_n93_), .c(new_n92_), .d(new_n69_), .O(new_n150_));
  inv1   g097(.a(new_n150_), .O(new_n151_));
  inv1   g098(.a(x27), .O(new_n152_));
  inv1   g099(.a(x28), .O(new_n153_));
  inv1   g100(.a(x29), .O(new_n154_));
  inv1   g101(.a(x30), .O(new_n155_));
  nand4  g102(.a(new_n155_), .b(new_n154_), .c(new_n153_), .d(new_n152_), .O(new_n156_));
  inv1   g103(.a(new_n156_), .O(new_n157_));
  inv1   g104(.a(x31), .O(new_n158_));
  inv1   g105(.a(x32), .O(new_n159_));
  nand4  g106(.a(new_n159_), .b(new_n158_), .c(new_n119_), .d(new_n94_), .O(new_n160_));
  inv1   g107(.a(new_n160_), .O(new_n161_));
  nand4  g108(.a(new_n161_), .b(new_n157_), .c(new_n151_), .d(new_n63_), .O(new_n162_));
  nand2  g109(.a(new_n162_), .b(new_n149_), .O(new_n163_));
  nand2  g110(.a(new_n163_), .b(x16), .O(new_n164_));
  inv1   g111(.a(x02), .O(new_n165_));
  aoi21  g112(.a(new_n58_), .b(new_n165_), .c(x18), .O(new_n166_));
  nand2  g113(.a(new_n166_), .b(new_n164_), .O(z13));
  nor2   g114(.a(x32), .b(x31), .O(new_n168_));
  nand4  g115(.a(new_n168_), .b(new_n138_), .c(new_n121_), .d(new_n137_), .O(new_n169_));
  oai21  g116(.a(new_n169_), .b(new_n85_), .c(x33), .O(new_n170_));
  nand4  g117(.a(new_n158_), .b(new_n155_), .c(new_n154_), .d(new_n153_), .O(new_n171_));
  inv1   g118(.a(new_n171_), .O(new_n172_));
  inv1   g119(.a(x33), .O(new_n173_));
  nand4  g120(.a(new_n173_), .b(new_n159_), .c(new_n152_), .d(new_n119_), .O(new_n174_));
  inv1   g121(.a(new_n174_), .O(new_n175_));
  nand4  g122(.a(new_n175_), .b(new_n172_), .c(new_n96_), .d(new_n91_), .O(new_n176_));
  nand2  g123(.a(new_n176_), .b(new_n170_), .O(new_n177_));
  nand2  g124(.a(new_n177_), .b(x16), .O(new_n178_));
  inv1   g125(.a(x01), .O(new_n179_));
  aoi21  g126(.a(new_n58_), .b(new_n179_), .c(x18), .O(new_n180_));
  nand2  g127(.a(new_n180_), .b(new_n178_), .O(z14));
  zero   g128(.O(z02));
  zero   g129(.O(z12));
  zero   g130(.O(z15));
endmodule
