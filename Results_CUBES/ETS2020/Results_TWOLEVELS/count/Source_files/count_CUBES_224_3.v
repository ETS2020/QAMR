...
module FAU ( 
  ...
  nand4  g066(.a(new_n120_), .b(new_n103_), .c(new_n83_), .d(new_n63_), .O(new_n121_));
  nand4  g067(.a(new_n94_), .b(new_n55_), .c(new_n69_), .d(new_n61_), .O(new_n122_));
  inv1   g068(.a(x26), .O(new_n123_));
  nor2   g069(.a(x28), .b(x27), .O(new_n124_));
  nor2   g070(.a(x30), .b(x29), .O(new_n125_));
  nand4  g071(.a(new_n125_), .b(new_n124_), .c(new_n95_), .d(new_n123_), .O(new_n126_));
  ...
  inv1   g078(.a(new_n86_), .O(new_n133_));
  ...
  oai21  g092(.a(new_n148_), .b(new_n96_), .c(x34), .O(new_n149_));
  inv1   g093(.a(x22), .O(new_n150_));
  inv1   g094(.a(x23), .O(new_n151_));
  nand4  g095(.a(new_n92_), .b(new_n82_), .c(new_n151_), .d(new_n150_), .O(new_n152_));
  nor2   g096(.a(new_n152_), .b(new_n70_), .O(new_n153_));
  nand2  g097(.a(new_n135_), .b(new_n111_), .O(new_n154_));
  ...
  nand2  g108(.a(new_n164_), .b(new_n149_), .O(new_n165_));
