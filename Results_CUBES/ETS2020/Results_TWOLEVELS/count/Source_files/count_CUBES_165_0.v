...
module FAU ( 
  ...
  nand4  g065(.a(new_n120_), .b(new_n95_), .c(new_n72_), .d(new_n63_), .O(new_n121_));
  nand4  g066(.a(new_n93_), .b(new_n55_), .c(new_n80_), .d(new_n61_), .O(new_n122_));
  nor2   g067(.a(x26), .b(x25), .O(new_n123_));
  nor2   g068(.a(x30), .b(x29), .O(new_n124_));
  nand4  g069(.a(new_n124_), .b(new_n112_), .c(new_n123_), .d(new_n84_), .O(new_n125_));
  ...
  nand4  g077(.a(new_n133_), .b(new_n132_), .c(new_n102_), .d(new_n85_), .O(new_n134_));
  oai21  g078(.a(new_n134_), .b(new_n79_), .c(x32), .O(new_n135_));
  nand2  g079(.a(new_n78_), .b(new_n70_), .O(new_n136_));
  inv1   g080(.a(new_n136_), .O(new_n137_));
  nand2  g081(.a(new_n124_), .b(new_n112_), .O(new_n138_));
  inv1   g082(.a(new_n138_), .O(new_n139_));
  nor2   g083(.a(x32), .b(x31), .O(new_n140_));
  nand2  g084(.a(new_n140_), .b(new_n123_), .O(new_n141_));
  inv1   g085(.a(new_n141_), .O(new_n142_));
  nand4  g086(.a(new_n142_), .b(new_n139_), .c(new_n137_), .d(new_n63_), .O(new_n143_));
  ...
  nand4  g092(.a(new_n140_), .b(new_n124_), .c(new_n112_), .d(new_n123_), .O(new_n149_));
  oai21  g093(.a(new_n149_), .b(new_n79_), .c(x33), .O(new_n150_));
  nor2   g094(.a(x33), .b(x32), .O(new_n151_));
  nand4  g095(.a(new_n151_), .b(new_n133_), .c(new_n132_), .d(new_n102_), .O(new_n152_));
  ...
  nand4  g103(.a(new_n111_), .b(new_n94_), .c(new_n93_), .d(new_n55_), .O(new_n160_));
  oai21  g104(.a(new_n152_), .b(new_n160_), .c(x34), .O(new_n161_));
  nand2  g105(.a(new_n132_), .b(new_n102_), .O(new_n162_));
