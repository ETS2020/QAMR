...
module FAU ( 
  ...
  nand4  g055(.a(new_n110_), .b(new_n109_), .c(new_n108_), .d(new_n86_), .O(new_n111_));
  ...
  nand4  g094(.a(new_n149_), .b(new_n148_), .c(new_n108_), .d(new_n87_), .O(new_n150_));
  ...
  nor2   g102(.a(x21), .b(x20), .O(new_n159_));
  nand4  g103(.a(new_n109_), .b(new_n95_), .c(new_n159_), .d(new_n54_), .O(new_n160_));
  nor2   g104(.a(x33), .b(x32), .O(new_n161_));
  nand4  g105(.a(new_n161_), .b(new_n136_), .c(new_n135_), .d(new_n99_), .O(new_n162_));
  oai21  g106(.a(new_n162_), .b(new_n160_), .c(x34), .O(new_n163_));
  nand2  g107(.a(new_n135_), .b(new_n99_), .O(new_n164_));
  inv1   g108(.a(new_n164_), .O(new_n165_));
  inv1   g109(.a(x30), .O(new_n166_));
  nand2  g110(.a(new_n148_), .b(new_n166_), .O(new_n167_));
  inv1   g111(.a(x33), .O(new_n168_));
  inv1   g112(.a(x34), .O(new_n169_));
  nand3  g113(.a(new_n169_), .b(new_n168_), .c(new_n149_), .O(new_n170_));
  nor2   g114(.a(new_n170_), .b(new_n167_), .O(new_n171_));
  nand3  g115(.a(new_n171_), .b(new_n165_), .c(new_n89_), .O(new_n172_));
