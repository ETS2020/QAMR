// Benchmark "FAU" written by ABC on Tue Jul  7 19:18:15 2020
...
module FAU ( 
  ...
  oai21  g059(.a(new_n109_), .b(new_n97_), .c(x29), .O(new_n115_));
  nor2   g060(.a(x29), .b(x28), .O(new_n116_));
  nor2   g061(.a(x27), .b(x21), .O(new_n117_));
  nand3  g062(.a(new_n117_), .b(new_n116_), .c(new_n89_), .O(new_n118_));
  inv1   g063(.a(new_n118_), .O(new_n119_));
  nand3  g064(.a(new_n119_), .b(new_n90_), .c(new_n63_), .O(new_n120_));
  nand2  g065(.a(new_n120_), .b(new_n115_), .O(new_n121_));
  nand2  g066(.a(new_n121_), .b(x16), .O(new_n122_));
  inv1   g067(.a(x05), .O(new_n123_));
  aoi21  g068(.a(new_n58_), .b(new_n123_), .c(x18), .O(new_n124_));
  nand2  g069(.a(new_n124_), .b(new_n122_), .O(z10));
  nor2   g070(.a(x31), .b(x30), .O(new_n128_));
  nand4  g071(.a(new_n128_), .b(new_n116_), .c(new_n98_), .d(new_n80_), .O(new_n129_));
  oai21  g072(.a(new_n129_), .b(new_n74_), .c(x32), .O(new_n130_));
  nand2  g073(.a(new_n73_), .b(new_n72_), .O(new_n131_));
  inv1   g074(.a(new_n131_), .O(new_n132_));
  nor2   g075(.a(x30), .b(x29), .O(new_n133_));
  nor2   g076(.a(x32), .b(x31), .O(new_n134_));
  nand2  g077(.a(new_n134_), .b(new_n133_), .O(new_n135_));
  inv1   g078(.a(new_n135_), .O(new_n136_));
  nor2   g079(.a(x26), .b(x25), .O(new_n137_));
  nand2  g080(.a(new_n108_), .b(new_n137_), .O(new_n138_));
  inv1   g081(.a(new_n138_), .O(new_n139_));
  nand4  g082(.a(new_n139_), .b(new_n136_), .c(new_n132_), .d(new_n63_), .O(new_n140_));
  nand2  g083(.a(new_n140_), .b(new_n130_), .O(new_n141_));
  nand2  g084(.a(new_n141_), .b(x16), .O(new_n142_));
  inv1   g085(.a(x02), .O(new_n143_));
  aoi21  g086(.a(new_n58_), .b(new_n143_), .c(x18), .O(new_n144_));
  nand2  g087(.a(new_n144_), .b(new_n142_), .O(z13));
  nand4  g088(.a(new_n134_), .b(new_n133_), .c(new_n108_), .d(new_n137_), .O(new_n146_));
  oai21  g089(.a(new_n146_), .b(new_n74_), .c(x33), .O(new_n147_));
  nor2   g090(.a(x33), .b(x32), .O(new_n148_));
  nand4  g091(.a(new_n148_), .b(new_n128_), .c(new_n116_), .d(new_n98_), .O(new_n149_));
  inv1   g092(.a(new_n149_), .O(new_n150_));
  nand2  g093(.a(new_n150_), .b(new_n82_), .O(new_n151_));
  nand2  g094(.a(new_n151_), .b(new_n147_), .O(new_n152_));
  nand2  g095(.a(new_n152_), .b(x16), .O(new_n153_));
  inv1   g096(.a(x01), .O(new_n154_));
  aoi21  g097(.a(new_n58_), .b(new_n154_), .c(x18), .O(new_n155_));
  nand2  g098(.a(new_n155_), .b(new_n153_), .O(z14));
  nand4  g099(.a(new_n107_), .b(new_n89_), .c(new_n88_), .d(new_n55_), .O(new_n157_));
  oai21  g100(.a(new_n149_), .b(new_n157_), .c(x34), .O(new_n158_));
  nand2  g101(.a(new_n116_), .b(new_n98_), .O(new_n159_));
  ...
  nand3  g111(.a(new_n168_), .b(new_n160_), .c(new_n82_), .O(new_n169_));
