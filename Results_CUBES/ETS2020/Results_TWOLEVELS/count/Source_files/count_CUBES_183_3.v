...
module FAU ( 
  ...
  nand4  g086(.a(new_n141_), .b(new_n120_), .c(new_n119_), .d(new_n118_), .O(new_n142_));
  ...
  nand4  g097(.a(new_n105_), .b(new_n83_), .c(new_n152_), .d(new_n151_), .O(new_n153_));
  nor2   g098(.a(new_n153_), .b(new_n65_), .O(new_n154_));
  nor2   g099(.a(x33), .b(x32), .O(new_n155_));
  nand4  g100(.a(new_n155_), .b(new_n130_), .c(new_n129_), .d(new_n106_), .O(new_n156_));
  ...
  oai21  g108(.a(new_n156_), .b(new_n96_), .c(x34), .O(new_n164_));
  nand2  g109(.a(new_n129_), .b(new_n106_), .O(new_n165_));
  ...
  nand3  g119(.a(new_n174_), .b(new_n166_), .c(new_n154_), .O(new_n175_));
