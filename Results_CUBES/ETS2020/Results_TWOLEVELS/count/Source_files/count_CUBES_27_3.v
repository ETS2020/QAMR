...
module FAU ( 
  ...
  nand4  g084(.a(new_n106_), .b(new_n55_), .c(new_n69_), .d(new_n61_), .O(new_n137_));
  nor2   g085(.a(x26), .b(x25), .O(new_n138_));
  nor2   g086(.a(x30), .b(x29), .O(new_n139_));
  nand4  g087(.a(new_n139_), .b(new_n126_), .c(new_n138_), .d(new_n87_), .O(new_n140_));
  nor2   g088(.a(new_n140_), .b(new_n137_), .O(new_n141_));
  aoi21  g089(.a(new_n136_), .b(x30), .c(new_n141_), .O(new_n142_));
  ...
  nand3  g098(.a(new_n150_), .b(new_n124_), .c(new_n91_), .O(new_n151_));
  nand2  g099(.a(new_n151_), .b(new_n146_), .O(new_n152_));
  ...
  nand4  g105(.a(new_n158_), .b(new_n139_), .c(new_n126_), .d(new_n138_), .O(new_n159_));
  oai21  g106(.a(new_n159_), .b(new_n90_), .c(x33), .O(new_n160_));
  nor2   g107(.a(x33), .b(x32), .O(new_n161_));
  nand4  g108(.a(new_n161_), .b(new_n148_), .c(new_n147_), .d(new_n117_), .O(new_n162_));
  ...
  nand2  g117(.a(new_n147_), .b(new_n117_), .O(new_n171_));
