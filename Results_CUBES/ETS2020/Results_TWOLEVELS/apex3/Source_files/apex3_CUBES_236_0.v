// Benchmark "FAU" written by ABC on Tue Jul  7 21:41:42 2020
...
module FAU ( 
  ...
  wire new_n130_, new_n131_, new_n132_, new_n133_, new_n134_, new_n135_,
    ...
    new_n165_, new_n166_, new_n168_, new_n173_, new_n174_, new_n177_,
    new_n178_, new_n184_, new_n185_, new_n186_, new_n187_;
  ...
  nand2  g35(.a(x51), .b(new_n134_), .O(new_n177_));
  nand3  g36(.a(new_n135_), .b(x49), .c(new_n136_), .O(new_n178_));
  nor3   g37(.a(new_n178_), .b(new_n177_), .c(new_n147_), .O(z43));
  nor2   g38(.a(new_n146_), .b(new_n165_), .O(z46));
  nand3  g39(.a(new_n156_), .b(x51), .c(new_n134_), .O(new_n184_));
  inv1   g40(.a(x43), .O(new_n185_));
  nand2  g41(.a(new_n185_), .b(x27), .O(new_n186_));
  nand4  g42(.a(new_n137_), .b(new_n136_), .c(x47), .d(new_n153_), .O(new_n187_));
  nor3   g43(.a(new_n187_), .b(new_n186_), .c(new_n184_), .O(z48));
  zero   g44(.O(z00));
  zero   g45(.O(z01));
  zero   g46(.O(z02));
  zero   g47(.O(z03));
