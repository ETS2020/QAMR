...
module FAU ( 
  ...
  oai21  g098(.a(new_n57_), .b(x14), .c(new_n79_), .O(new_n135_));
  aoi21  g099(.a(new_n135_), .b(new_n61_), .c(x03), .O(new_n136_));
  inv1   g100(.a(x03), .O(new_n137_));
  oai21  g101(.a(x20), .b(new_n63_), .c(x06), .O(new_n138_));
  aoi21  g102(.a(new_n138_), .b(x11), .c(new_n137_), .O(new_n139_));
  oai22  g103(.a(new_n139_), .b(new_n132_), .c(new_n136_), .d(new_n120_), .O(z6));
  inv1   g104(.a(new_n132_), .O(z7));
  zero   g105(.O(z0));
  zero   g106(.O(z2));
  zero   g107(.O(z3));
endmodule
