...
module FAU ( 
  ...
  wire new_n34_, new_n35_, new_n36_, new_n37_, new_n38_, new_n39_, new_n40_,
    ...
    new_n110_, new_n116_, new_n117_, new_n118_, new_n119_, new_n120_,
  ...
  inv1   g78(.a(x06), .O(new_n116_));
  oai21  g79(.a(new_n79_), .b(x14), .c(new_n116_), .O(new_n117_));
  aoi21  g80(.a(new_n117_), .b(new_n76_), .c(x03), .O(new_n118_));
  inv1   g81(.a(x03), .O(new_n119_));
  nand2  g82(.a(new_n79_), .b(x14), .O(new_n120_));
  aoi21  g83(.a(new_n120_), .b(x06), .c(new_n76_), .O(new_n121_));
  nand2  g84(.a(x24), .b(x18), .O(new_n122_));
  nand3  g85(.a(new_n36_), .b(x15), .c(x13), .O(new_n123_));
  aoi21  g86(.a(new_n123_), .b(new_n122_), .c(new_n34_), .O(new_n124_));
  nand3  g87(.a(new_n53_), .b(new_n36_), .c(x21), .O(new_n125_));
  nand3  g88(.a(x24), .b(x18), .c(x13), .O(new_n126_));
  nand2  g89(.a(new_n39_), .b(x15), .O(new_n127_));
  nand3  g90(.a(new_n127_), .b(new_n126_), .c(new_n125_), .O(new_n128_));
  oai22  g91(.a(new_n128_), .b(new_n124_), .c(new_n121_), .d(new_n119_), .O(new_n129_));
  oai21  g92(.a(new_n118_), .b(new_n46_), .c(new_n129_), .O(z6));
  zero   g93(.O(z2));
  zero   g94(.O(z3));
  zero   g95(.O(z4));
  zero   g96(.O(z5));
