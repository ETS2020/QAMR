...
module FAU ( 
  ...
  nand2  g21(.a(x20), .b(new_n52_), .O(new_n60_));
  aoi21  g22(.a(new_n60_), .b(new_n49_), .c(x11), .O(new_n61_));
  nand2  g23(.a(x24), .b(x07), .O(new_n62_));
  nand3  g24(.a(new_n38_), .b(x19), .c(x13), .O(new_n63_));
  aoi21  g25(.a(new_n63_), .b(new_n62_), .c(new_n36_), .O(new_n64_));
  nand3  g26(.a(x19), .b(new_n45_), .c(new_n36_), .O(new_n65_));
  nand3  g27(.a(x24), .b(x13), .c(x07), .O(new_n66_));
  nand4  g28(.a(new_n38_), .b(new_n42_), .c(new_n41_), .d(x00), .O(new_n67_));
  nand3  g29(.a(new_n67_), .b(new_n66_), .c(new_n65_), .O(new_n68_));
  oai22  g30(.a(new_n68_), .b(new_n64_), .c(new_n61_), .d(x03), .O(new_n69_));
  inv1   g31(.a(x03), .O(new_n70_));
  nand2  g32(.a(new_n53_), .b(x14), .O(new_n71_));
  aoi21  g33(.a(new_n71_), .b(x06), .c(new_n50_), .O(new_n72_));
  oai22  g34(.a(new_n72_), .b(new_n70_), .c(new_n47_), .d(new_n40_), .O(new_n73_));
  nand2  g35(.a(new_n73_), .b(new_n69_), .O(z6));
  inv1   g36(.a(new_n48_), .O(z7));
  zero   g37(.O(z0));
  zero   g38(.O(z1));
  zero   g39(.O(z3));
  zero   g40(.O(z4));
