// Benchmark "FAU" written by ABC on Tue Jul  7 17:33:53 2020
...
module FAU ( 
  ...
  nand2  g070(.a(x24), .b(x18), .O(new_n105_));
  nand2  g071(.a(x15), .b(x13), .O(new_n106_));
  oai21  g072(.a(new_n106_), .b(x24), .c(new_n105_), .O(new_n107_));
  nand2  g073(.a(new_n107_), .b(x05), .O(new_n108_));
  ...
  inv1   g079(.a(new_n40_), .O(new_n114_));
  nor2   g080(.a(new_n57_), .b(new_n63_), .O(new_n115_));
  nand4  g081(.a(new_n115_), .b(new_n114_), .c(x11), .d(x06), .O(new_n116_));
  aoi21  g082(.a(new_n113_), .b(new_n108_), .c(new_n116_), .O(z2));
  nand2  g083(.a(x20), .b(new_n63_), .O(new_n121_));
  aoi21  g084(.a(new_n121_), .b(new_n79_), .c(x11), .O(new_n122_));
  inv1   g085(.a(x05), .O(new_n123_));
  nand2  g086(.a(x24), .b(x07), .O(new_n124_));
  nand3  g087(.a(new_n35_), .b(x19), .c(x13), .O(new_n125_));
  aoi21  g088(.a(new_n125_), .b(new_n124_), .c(new_n123_), .O(new_n126_));
  nand2  g089(.a(new_n89_), .b(x19), .O(new_n127_));
  nand3  g090(.a(x24), .b(x13), .c(x07), .O(new_n128_));
  inv1   g091(.a(x02), .O(new_n129_));
  inv1   g092(.a(x10), .O(new_n130_));
  nand4  g093(.a(new_n35_), .b(new_n130_), .c(new_n129_), .d(x00), .O(new_n131_));
  nand3  g094(.a(new_n131_), .b(new_n128_), .c(new_n127_), .O(new_n132_));
  oai22  g095(.a(new_n132_), .b(new_n126_), .c(new_n122_), .d(x03), .O(new_n133_));
  nand2  g096(.a(new_n113_), .b(new_n108_), .O(z7));
  aoi21  g097(.a(new_n57_), .b(x14), .c(new_n79_), .O(new_n135_));
  oai21  g098(.a(new_n135_), .b(new_n61_), .c(x03), .O(new_n136_));
  nand2  g099(.a(new_n136_), .b(z7), .O(new_n137_));
  nand2  g100(.a(new_n137_), .b(new_n133_), .O(z6));
  zero   g101(.O(z0));
  zero   g102(.O(z3));
  zero   g103(.O(z4));
  zero   g104(.O(z5));
