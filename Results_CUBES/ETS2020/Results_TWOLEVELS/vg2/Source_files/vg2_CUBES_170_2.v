...
module FAU ( 
  ...
  oai21  g47(.a(new_n64_), .b(x14), .c(new_n47_), .O(new_n84_));
  aoi21  g48(.a(new_n84_), .b(new_n48_), .c(x03), .O(new_n85_));
  inv1   g49(.a(x03), .O(new_n86_));
  oai21  g50(.a(x20), .b(new_n63_), .c(x06), .O(new_n87_));
  aoi21  g51(.a(new_n87_), .b(x11), .c(new_n86_), .O(new_n88_));
  oai22  g52(.a(new_n88_), .b(new_n61_), .c(new_n85_), .d(new_n46_), .O(z6));
  zero   g53(.O(z1));
  zero   g54(.O(z3));
  zero   g55(.O(z5));
  zero   g56(.O(z7));
