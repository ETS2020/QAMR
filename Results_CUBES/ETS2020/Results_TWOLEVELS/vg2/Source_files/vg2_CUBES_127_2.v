...
module FAU ( 
  ...
  oai21  g72(.a(new_n78_), .b(x14), .c(new_n52_), .O(new_n109_));
  aoi21  g73(.a(new_n109_), .b(new_n53_), .c(x03), .O(new_n110_));
  oai21  g74(.a(x20), .b(new_n77_), .c(x06), .O(new_n111_));
  aoi21  g75(.a(new_n111_), .b(x11), .c(new_n50_), .O(new_n112_));
  oai22  g76(.a(new_n112_), .b(new_n48_), .c(new_n110_), .d(new_n100_), .O(z6));
  zero   g77(.O(z0));
  zero   g78(.O(z1));
  zero   g79(.O(z5));
  zero   g80(.O(z7));
