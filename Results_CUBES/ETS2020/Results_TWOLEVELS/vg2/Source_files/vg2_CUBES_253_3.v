...
module FAU ( 
  ...
  and2   g067(.a(x24), .b(x18), .O(new_n102_));
  nand2  g068(.a(x15), .b(x13), .O(new_n103_));
  nor2   g069(.a(new_n103_), .b(x24), .O(new_n104_));
  oai21  g070(.a(new_n104_), .b(new_n102_), .c(x05), .O(new_n105_));
  nand3  g071(.a(new_n37_), .b(new_n35_), .c(x21), .O(new_n106_));
  aoi22  g072(.a(new_n102_), .b(x13), .c(new_n84_), .d(x15), .O(new_n107_));
  nand2  g073(.a(new_n107_), .b(new_n106_), .O(new_n108_));
  inv1   g074(.a(new_n108_), .O(new_n109_));
  inv1   g075(.a(new_n40_), .O(new_n110_));
  nor2   g076(.a(new_n56_), .b(new_n63_), .O(new_n111_));
  nand4  g077(.a(new_n111_), .b(new_n110_), .c(x11), .d(x06), .O(new_n112_));
  aoi21  g078(.a(new_n109_), .b(new_n105_), .c(new_n112_), .O(z2));
  ...
  nand4  g083(.a(new_n117_), .b(new_n116_), .c(new_n50_), .d(new_n49_), .O(new_n118_));
  ...
  nand4  g087(.a(new_n56_), .b(new_n63_), .c(new_n61_), .d(new_n93_), .O(new_n122_));
  nand3  g088(.a(new_n50_), .b(x07), .c(new_n78_), .O(new_n123_));
  oai22  g089(.a(new_n123_), .b(new_n122_), .c(new_n121_), .d(new_n72_), .O(new_n124_));
  nand4  g090(.a(x20), .b(x15), .c(x14), .d(x11), .O(new_n125_));
  nand3  g091(.a(new_n50_), .b(new_n63_), .c(new_n61_), .O(new_n126_));
  oai22  g092(.a(new_n126_), .b(new_n94_), .c(new_n125_), .d(new_n72_), .O(new_n127_));
  aoi22  g093(.a(new_n127_), .b(new_n84_), .c(new_n124_), .d(new_n85_), .O(new_n128_));
  nand2  g094(.a(new_n128_), .b(new_n120_), .O(z3));
  nand2  g095(.a(x24), .b(x07), .O(new_n131_));
  nand2  g096(.a(x19), .b(x13), .O(new_n132_));
  oai21  g097(.a(new_n132_), .b(x24), .c(new_n131_), .O(new_n133_));
  nand2  g098(.a(new_n133_), .b(x05), .O(new_n134_));
  nand2  g099(.a(new_n84_), .b(x19), .O(new_n135_));
  nand3  g100(.a(x24), .b(x13), .c(x07), .O(new_n136_));
  inv1   g101(.a(x02), .O(new_n137_));
  inv1   g102(.a(x10), .O(new_n138_));
  nand4  g103(.a(new_n35_), .b(new_n138_), .c(new_n137_), .d(x00), .O(new_n139_));
  nand4  g104(.a(new_n139_), .b(new_n136_), .c(new_n135_), .d(new_n134_), .O(z5));
  nand2  g105(.a(new_n109_), .b(new_n105_), .O(z7));
  zero   g106(.O(z0));
  zero   g107(.O(z4));
  zero   g108(.O(z6));
endmodule
