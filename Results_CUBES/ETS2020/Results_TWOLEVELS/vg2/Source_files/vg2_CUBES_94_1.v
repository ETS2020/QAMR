...
module FAU ( 
  ...
  oai21  g68(.a(new_n62_), .b(x14), .c(new_n52_), .O(new_n105_));
  aoi21  g69(.a(new_n105_), .b(new_n60_), .c(x03), .O(new_n106_));
  oai21  g70(.a(x20), .b(new_n61_), .c(x06), .O(new_n107_));
  aoi21  g71(.a(new_n107_), .b(x11), .c(new_n51_), .O(new_n108_));
  oai22  g72(.a(new_n108_), .b(new_n102_), .c(new_n106_), .d(new_n88_), .O(z6));
  inv1   g73(.a(new_n102_), .O(z7));
  zero   g74(.O(z0));
  zero   g75(.O(z1));
  zero   g76(.O(z2));
endmodule
