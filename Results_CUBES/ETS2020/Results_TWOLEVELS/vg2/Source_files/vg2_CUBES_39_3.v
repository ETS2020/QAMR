...
module FAU ( 
  ...
  nor2   g059(.a(x12), .b(new_n34_), .O(new_n93_));
  nand4  g060(.a(new_n93_), .b(new_n68_), .c(new_n49_), .d(new_n48_), .O(new_n94_));
  ...
  nor2   g066(.a(new_n39_), .b(new_n35_), .O(new_n100_));
  ...
  nand4  g072(.a(new_n105_), .b(new_n96_), .c(new_n68_), .d(new_n48_), .O(new_n106_));
  nand4  g073(.a(new_n97_), .b(new_n95_), .c(new_n79_), .d(x19), .O(new_n107_));
  oai21  g074(.a(new_n107_), .b(new_n106_), .c(new_n104_), .O(new_n108_));
  nand2  g075(.a(new_n108_), .b(new_n39_), .O(new_n109_));
  nand3  g076(.a(new_n109_), .b(new_n101_), .c(new_n84_), .O(z1));
  nand2  g077(.a(x24), .b(x18), .O(new_n111_));
  nand2  g078(.a(x15), .b(x13), .O(new_n112_));
  oai21  g079(.a(new_n112_), .b(x24), .c(new_n111_), .O(new_n113_));
  nand2  g080(.a(new_n113_), .b(x05), .O(new_n114_));
  nand3  g081(.a(new_n53_), .b(new_n35_), .c(x21), .O(new_n115_));
  ...
  nor2   g087(.a(new_n79_), .b(new_n78_), .O(new_n121_));
  nand4  g088(.a(new_n121_), .b(new_n120_), .c(x11), .d(x06), .O(new_n122_));
  aoi21  g089(.a(new_n119_), .b(new_n114_), .c(new_n122_), .O(z2));
  nand2  g090(.a(new_n46_), .b(new_n38_), .O(z5));
  inv1   g091(.a(x03), .O(new_n127_));
  aoi21  g092(.a(x20), .b(new_n78_), .c(x06), .O(new_n128_));
  oai21  g093(.a(new_n128_), .b(x11), .c(new_n127_), .O(new_n129_));
  nand2  g094(.a(new_n129_), .b(z5), .O(new_n130_));
  nand2  g095(.a(new_n119_), .b(new_n114_), .O(z7));
  inv1   g096(.a(x06), .O(new_n132_));
  aoi21  g097(.a(new_n79_), .b(x14), .c(new_n132_), .O(new_n133_));
  oai21  g098(.a(new_n133_), .b(new_n76_), .c(x03), .O(new_n134_));
  nand2  g099(.a(new_n134_), .b(z7), .O(new_n135_));
  nand2  g100(.a(new_n135_), .b(new_n130_), .O(z6));
  zero   g101(.O(z3));
  zero   g102(.O(z4));
endmodule
