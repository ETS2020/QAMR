...
module FAU ( 
  ...
  nand2  g096(.a(x20), .b(new_n63_), .O(new_n133_));
  aoi21  g097(.a(new_n133_), .b(new_n78_), .c(x11), .O(new_n134_));
  inv1   g098(.a(x05), .O(new_n135_));
  nand2  g099(.a(x24), .b(x07), .O(new_n136_));
  nand3  g100(.a(new_n35_), .b(x19), .c(x13), .O(new_n137_));
  aoi21  g101(.a(new_n137_), .b(new_n136_), .c(new_n135_), .O(new_n138_));
  nand2  g102(.a(new_n84_), .b(x19), .O(new_n139_));
  nand3  g103(.a(x24), .b(x13), .c(x07), .O(new_n140_));
  inv1   g104(.a(x02), .O(new_n141_));
  inv1   g105(.a(x10), .O(new_n142_));
  nand4  g106(.a(new_n35_), .b(new_n142_), .c(new_n141_), .d(x00), .O(new_n143_));
  nand3  g107(.a(new_n143_), .b(new_n140_), .c(new_n139_), .O(new_n144_));
  oai22  g108(.a(new_n144_), .b(new_n138_), .c(new_n134_), .d(x03), .O(new_n145_));
  nand2  g109(.a(new_n110_), .b(new_n105_), .O(z7));
  aoi21  g110(.a(new_n56_), .b(x14), .c(new_n78_), .O(new_n147_));
  oai21  g111(.a(new_n147_), .b(new_n61_), .c(x03), .O(new_n148_));
  nand2  g112(.a(new_n148_), .b(z7), .O(new_n149_));
  nand2  g113(.a(new_n149_), .b(new_n145_), .O(z6));
  zero   g114(.O(z0));
  zero   g115(.O(z4));
  zero   g116(.O(z5));
endmodule
