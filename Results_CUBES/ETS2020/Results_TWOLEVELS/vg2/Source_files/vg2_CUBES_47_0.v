...
module FAU ( 
  ...
  inv1   g097(.a(x06), .O(new_n133_));
  oai21  g098(.a(new_n79_), .b(x14), .c(new_n133_), .O(new_n134_));
  aoi21  g099(.a(new_n134_), .b(new_n76_), .c(x03), .O(new_n135_));
  inv1   g100(.a(x03), .O(new_n136_));
  oai21  g101(.a(x20), .b(new_n78_), .c(x06), .O(new_n137_));
  aoi21  g102(.a(new_n137_), .b(x11), .c(new_n136_), .O(new_n138_));
  oai22  g103(.a(new_n138_), .b(new_n130_), .c(new_n135_), .d(new_n46_), .O(z6));
  inv1   g104(.a(new_n130_), .O(z7));
  zero   g105(.O(z2));
  zero   g106(.O(z3));
endmodule
