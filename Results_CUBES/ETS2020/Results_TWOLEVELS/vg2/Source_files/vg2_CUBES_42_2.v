// Benchmark "FAU" written by ABC on Tue Jul  7 17:33:38 2020
...
module FAU ( 
  ...
  nor2   g067(.a(new_n63_), .b(new_n61_), .O(new_n103_));
  nand4  g068(.a(new_n103_), .b(new_n73_), .c(new_n39_), .d(x20), .O(new_n104_));
  nor2   g069(.a(x08), .b(x06), .O(new_n105_));
  nor3   g070(.a(x20), .b(x14), .c(x11), .O(new_n106_));
  nand4  g071(.a(new_n106_), .b(new_n105_), .c(new_n50_), .d(new_n49_), .O(new_n107_));
  nand2  g072(.a(new_n107_), .b(new_n104_), .O(new_n108_));
  nand2  g073(.a(new_n108_), .b(new_n35_), .O(new_n109_));
  nand4  g074(.a(x20), .b(x18), .c(x14), .d(x11), .O(new_n110_));
  nand4  g075(.a(new_n56_), .b(new_n63_), .c(new_n61_), .d(new_n93_), .O(new_n111_));
  nand3  g076(.a(new_n50_), .b(x07), .c(new_n78_), .O(new_n112_));
  oai22  g077(.a(new_n112_), .b(new_n111_), .c(new_n110_), .d(new_n72_), .O(new_n113_));
  nand4  g078(.a(x20), .b(x15), .c(x14), .d(x11), .O(new_n114_));
  nand3  g079(.a(new_n50_), .b(new_n63_), .c(new_n61_), .O(new_n115_));
  oai22  g080(.a(new_n115_), .b(new_n94_), .c(new_n114_), .d(new_n72_), .O(new_n116_));
  aoi22  g081(.a(new_n116_), .b(new_n84_), .c(new_n113_), .d(new_n85_), .O(new_n117_));
  nand2  g082(.a(new_n117_), .b(new_n109_), .O(z3));
  inv1   g083(.a(x05), .O(new_n120_));
  nand2  g084(.a(x24), .b(x07), .O(new_n121_));
  nand3  g085(.a(new_n35_), .b(x19), .c(x13), .O(new_n122_));
  aoi21  g086(.a(new_n122_), .b(new_n121_), .c(new_n120_), .O(new_n123_));
  nand2  g087(.a(new_n84_), .b(x19), .O(new_n124_));
  nand3  g088(.a(x24), .b(x13), .c(x07), .O(new_n125_));
  inv1   g089(.a(x02), .O(new_n126_));
  inv1   g090(.a(x10), .O(new_n127_));
  nand4  g091(.a(new_n35_), .b(new_n127_), .c(new_n126_), .d(x00), .O(new_n128_));
  nand3  g092(.a(new_n128_), .b(new_n125_), .c(new_n124_), .O(new_n129_));
  or2    g093(.a(new_n129_), .b(new_n123_), .O(z5));
  nand2  g094(.a(x20), .b(new_n63_), .O(new_n131_));
  aoi21  g095(.a(new_n131_), .b(new_n78_), .c(x11), .O(new_n132_));
  oai22  g096(.a(new_n132_), .b(x03), .c(new_n129_), .d(new_n123_), .O(new_n133_));
  inv1   g097(.a(x03), .O(new_n134_));
  nand2  g098(.a(new_n56_), .b(x14), .O(new_n135_));
  aoi21  g099(.a(new_n135_), .b(x06), .c(new_n61_), .O(new_n136_));
  nand2  g100(.a(x24), .b(x18), .O(new_n137_));
  nand3  g101(.a(new_n35_), .b(x15), .c(x13), .O(new_n138_));
  aoi21  g102(.a(new_n138_), .b(new_n137_), .c(new_n120_), .O(new_n139_));
  nand3  g103(.a(new_n37_), .b(new_n35_), .c(x21), .O(new_n140_));
  nand3  g104(.a(x24), .b(x18), .c(x13), .O(new_n141_));
  nand2  g105(.a(new_n84_), .b(x15), .O(new_n142_));
  nand3  g106(.a(new_n142_), .b(new_n141_), .c(new_n140_), .O(new_n143_));
  oai22  g107(.a(new_n143_), .b(new_n139_), .c(new_n136_), .d(new_n134_), .O(new_n144_));
  nand2  g108(.a(new_n144_), .b(new_n133_), .O(z6));
  or2    g109(.a(new_n143_), .b(new_n139_), .O(z7));
  zero   g110(.O(z0));
  zero   g111(.O(z2));
  zero   g112(.O(z4));
endmodule
