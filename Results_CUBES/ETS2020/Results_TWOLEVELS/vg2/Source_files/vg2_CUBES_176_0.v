// Benchmark "FAU" written by ABC on Tue Jul  7 17:34:20 2020
...
module FAU ( 
  ...
  oai21  g113(.a(new_n78_), .b(x14), .c(new_n47_), .O(new_n149_));
  aoi21  g114(.a(new_n149_), .b(new_n48_), .c(x03), .O(new_n150_));
  inv1   g115(.a(x03), .O(new_n151_));
  oai21  g116(.a(x20), .b(new_n77_), .c(x06), .O(new_n152_));
  aoi21  g117(.a(new_n152_), .b(x11), .c(new_n151_), .O(new_n153_));
  oai22  g118(.a(new_n153_), .b(new_n146_), .c(new_n150_), .d(new_n46_), .O(z6));
  inv1   g119(.a(new_n146_), .O(z7));
  zero   g120(.O(z2));
  zero   g121(.O(z5));
endmodule
