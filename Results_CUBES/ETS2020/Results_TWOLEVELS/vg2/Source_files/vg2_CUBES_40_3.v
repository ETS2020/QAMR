...
module FAU ( 
  ...
  oai21  g112(.a(new_n57_), .b(x14), .c(new_n51_), .O(new_n148_));
  aoi21  g113(.a(new_n148_), .b(new_n61_), .c(x03), .O(new_n149_));
  inv1   g114(.a(x03), .O(new_n150_));
  oai21  g115(.a(x20), .b(new_n63_), .c(x06), .O(new_n151_));
  aoi21  g116(.a(new_n151_), .b(x11), .c(new_n150_), .O(new_n152_));
  oai22  g117(.a(new_n152_), .b(new_n111_), .c(new_n149_), .d(new_n142_), .O(z6));
  inv1   g118(.a(new_n111_), .O(z7));
  zero   g119(.O(z0));
  zero   g120(.O(z5));
endmodule
