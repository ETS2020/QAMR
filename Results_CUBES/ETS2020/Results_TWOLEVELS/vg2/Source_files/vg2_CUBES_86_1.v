...
module FAU ( 
  ...
  oai21  g097(.a(new_n78_), .b(x14), .c(new_n47_), .O(new_n134_));
  aoi21  g098(.a(new_n134_), .b(new_n48_), .c(x03), .O(new_n135_));
  inv1   g099(.a(x03), .O(new_n136_));
  nand2  g100(.a(new_n78_), .b(x14), .O(new_n137_));
  aoi21  g101(.a(new_n137_), .b(x06), .c(new_n48_), .O(new_n138_));
  nand2  g102(.a(x24), .b(x18), .O(new_n139_));
  nand3  g103(.a(new_n36_), .b(x15), .c(x13), .O(new_n140_));
  aoi21  g104(.a(new_n140_), .b(new_n139_), .c(new_n34_), .O(new_n141_));
  nand3  g105(.a(new_n54_), .b(new_n36_), .c(x21), .O(new_n142_));
  nand3  g106(.a(x24), .b(x18), .c(x13), .O(new_n143_));
  nand2  g107(.a(new_n39_), .b(x15), .O(new_n144_));
  nand3  g108(.a(new_n144_), .b(new_n143_), .c(new_n142_), .O(new_n145_));
  oai22  g109(.a(new_n145_), .b(new_n141_), .c(new_n138_), .d(new_n136_), .O(new_n146_));
  oai21  g110(.a(new_n135_), .b(new_n46_), .c(new_n146_), .O(z6));
  or2    g111(.a(new_n145_), .b(new_n141_), .O(z7));
  zero   g112(.O(z2));
  zero   g113(.O(z4));
  zero   g114(.O(z5));
endmodule
