...
module FAU ( 
  ...
  nand3  g083(.a(new_n53_), .b(new_n35_), .c(x21), .O(new_n117_));
  aoi22  g084(.a(new_n113_), .b(x13), .c(new_n38_), .d(x15), .O(new_n118_));
  nand2  g085(.a(new_n118_), .b(new_n117_), .O(new_n119_));
  inv1   g086(.a(new_n119_), .O(new_n120_));
  inv1   g087(.a(new_n56_), .O(new_n121_));
  nor2   g088(.a(new_n77_), .b(new_n76_), .O(new_n122_));
  ...
  nand4  g092(.a(new_n125_), .b(new_n86_), .c(new_n55_), .d(x20), .O(new_n126_));
  nor2   g093(.a(x08), .b(x06), .O(new_n127_));
  nor3   g094(.a(x20), .b(x14), .c(x11), .O(new_n128_));
  nand4  g095(.a(new_n128_), .b(new_n127_), .c(new_n65_), .d(new_n48_), .O(new_n129_));
  ...
  nand3  g099(.a(new_n49_), .b(new_n47_), .c(new_n106_), .O(new_n133_));
  nand3  g100(.a(new_n48_), .b(x07), .c(new_n46_), .O(new_n134_));
  oai22  g101(.a(new_n134_), .b(new_n133_), .c(new_n132_), .d(new_n85_), .O(new_n135_));
  nand4  g102(.a(x20), .b(x15), .c(x14), .d(x11), .O(new_n136_));
  nand3  g103(.a(new_n48_), .b(new_n76_), .c(new_n47_), .O(new_n137_));
  ...
  nand2  g107(.a(new_n120_), .b(new_n116_), .O(z7));
  zero   g108(.O(z4));
  zero   g109(.O(z5));
  zero   g110(.O(z6));
endmodule
