// Benchmark "FAU" written by ABC on Tue Jul  7 17:34:40 2020
...
module FAU ( 
  ...
  nand2  g33(.a(x20), .b(new_n63_), .O(new_n71_));
  aoi21  g34(.a(new_n71_), .b(new_n47_), .c(x11), .O(new_n72_));
  oai22  g35(.a(new_n72_), .b(x03), .c(new_n45_), .d(new_n38_), .O(new_n73_));
  inv1   g36(.a(x03), .O(new_n74_));
  nand2  g37(.a(new_n64_), .b(x14), .O(new_n75_));
  aoi21  g38(.a(new_n75_), .b(x06), .c(new_n48_), .O(new_n76_));
  oai22  g39(.a(new_n76_), .b(new_n74_), .c(new_n60_), .d(new_n56_), .O(new_n77_));
  nand2  g40(.a(new_n77_), .b(new_n73_), .O(z6));
  inv1   g41(.a(new_n61_), .O(z7));
  zero   g42(.O(z1));
  zero   g43(.O(z3));
  zero   g44(.O(z4));
  zero   g45(.O(z5));
