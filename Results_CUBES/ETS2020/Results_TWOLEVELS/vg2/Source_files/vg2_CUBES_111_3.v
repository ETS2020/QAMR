...
module FAU ( 
  ...
  oai21  g022(.a(new_n55_), .b(new_n53_), .c(new_n54_), .O(new_n56_));
  ...
  nand3  g080(.a(x20), .b(x14), .c(x11), .O(new_n115_));
  nor2   g081(.a(new_n115_), .b(new_n86_), .O(new_n116_));
  nand2  g082(.a(new_n116_), .b(new_n56_), .O(new_n117_));
  nor3   g083(.a(x20), .b(x14), .c(x11), .O(new_n118_));
  nand3  g084(.a(new_n49_), .b(new_n107_), .c(new_n47_), .O(new_n119_));
  inv1   g085(.a(new_n119_), .O(new_n120_));
  nand3  g086(.a(new_n120_), .b(new_n118_), .c(new_n66_), .O(new_n121_));
  nand2  g087(.a(new_n121_), .b(new_n117_), .O(new_n122_));
  nand2  g088(.a(new_n122_), .b(new_n35_), .O(new_n123_));
  nand4  g089(.a(x20), .b(x18), .c(x14), .d(x11), .O(new_n124_));
  nand3  g090(.a(new_n50_), .b(new_n48_), .c(new_n107_), .O(new_n125_));
  nand3  g091(.a(new_n49_), .b(x07), .c(new_n47_), .O(new_n126_));
  oai22  g092(.a(new_n126_), .b(new_n125_), .c(new_n124_), .d(new_n86_), .O(new_n127_));
  nand4  g093(.a(x20), .b(x15), .c(x14), .d(x11), .O(new_n128_));
  nand3  g094(.a(new_n49_), .b(new_n77_), .c(new_n48_), .O(new_n129_));
  oai22  g095(.a(new_n129_), .b(new_n108_), .c(new_n128_), .d(new_n86_), .O(new_n130_));
  aoi22  g096(.a(new_n130_), .b(new_n39_), .c(new_n127_), .d(new_n99_), .O(new_n131_));
  nand2  g097(.a(new_n131_), .b(new_n123_), .O(z3));
  nand2  g098(.a(new_n46_), .b(new_n38_), .O(z5));
  nand2  g099(.a(x24), .b(x18), .O(new_n136_));
  nand2  g100(.a(x15), .b(x13), .O(new_n137_));
  oai21  g101(.a(new_n137_), .b(x24), .c(new_n136_), .O(new_n138_));
  nand2  g102(.a(new_n138_), .b(x05), .O(new_n139_));
  nand4  g103(.a(new_n35_), .b(x21), .c(new_n43_), .d(new_n42_), .O(new_n140_));
  inv1   g104(.a(new_n136_), .O(new_n141_));
  aoi22  g105(.a(new_n141_), .b(x13), .c(new_n39_), .d(x15), .O(new_n142_));
  nand3  g106(.a(new_n142_), .b(new_n140_), .c(new_n139_), .O(z7));
  zero   g107(.O(z2));
  zero   g108(.O(z4));
  zero   g109(.O(z6));
endmodule
