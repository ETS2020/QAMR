// Benchmark "FAU" written by ABC on Tue Jul  7 17:33:41 2020
...
module FAU ( 
  ...
  inv1   g68(.a(x11), .O(new_n105_));
  inv1   g69(.a(x06), .O(new_n106_));
  oai21  g70(.a(new_n48_), .b(x14), .c(new_n106_), .O(new_n107_));
  aoi21  g71(.a(new_n107_), .b(new_n105_), .c(x03), .O(new_n108_));
  inv1   g72(.a(x03), .O(new_n109_));
  oai21  g73(.a(x20), .b(new_n47_), .c(x06), .O(new_n110_));
  aoi21  g74(.a(new_n110_), .b(x11), .c(new_n109_), .O(new_n111_));
  oai22  g75(.a(new_n111_), .b(new_n102_), .c(new_n108_), .d(new_n46_), .O(z6));
  inv1   g76(.a(new_n102_), .O(z7));
  zero   g77(.O(z1));
  zero   g78(.O(z2));
  zero   g79(.O(z5));
endmodule
