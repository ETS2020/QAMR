...
module FAU ( 
  ...
  and2   g48(.a(x24), .b(x18), .O(new_n87_));
  nand2  g49(.a(x15), .b(x13), .O(new_n88_));
  nor2   g50(.a(new_n88_), .b(x24), .O(new_n89_));
  oai21  g51(.a(new_n89_), .b(new_n87_), .c(x05), .O(new_n90_));
  nand4  g52(.a(new_n42_), .b(x21), .c(new_n41_), .d(new_n40_), .O(new_n91_));
  aoi22  g53(.a(new_n87_), .b(x13), .c(new_n37_), .d(x15), .O(new_n92_));
  nand3  g54(.a(new_n92_), .b(new_n91_), .c(new_n90_), .O(z7));
  zero   g55(.O(z1));
  zero   g56(.O(z2));
  zero   g57(.O(z4));
  zero   g58(.O(z5));
