// Benchmark "FAU" written by ABC on Tue Jul  7 17:34:00 2020
...
module FAU ( 
  ...
  nand4  g41(.a(new_n75_), .b(new_n50_), .c(new_n49_), .d(new_n48_), .O(new_n76_));
  aoi21  g42(.a(new_n74_), .b(new_n73_), .c(new_n76_), .O(new_n77_));
  oai21  g43(.a(new_n77_), .b(new_n72_), .c(new_n36_), .O(new_n78_));
  ...
  nand4  g52(.a(new_n48_), .b(new_n47_), .c(new_n86_), .d(x07), .O(new_n87_));
  oai22  g53(.a(new_n87_), .b(new_n83_), .c(new_n85_), .d(new_n84_), .O(new_n88_));
  nor2   g54(.a(new_n39_), .b(new_n36_), .O(new_n89_));
  nand4  g55(.a(x20), .b(x15), .c(x14), .d(x11), .O(new_n90_));
  nand4  g56(.a(new_n48_), .b(x19), .c(new_n47_), .d(new_n86_), .O(new_n91_));
  oai22  g57(.a(new_n91_), .b(new_n83_), .c(new_n90_), .d(new_n84_), .O(new_n92_));
  aoi22  g58(.a(new_n92_), .b(new_n39_), .c(new_n89_), .d(new_n88_), .O(new_n93_));
  nand2  g59(.a(new_n93_), .b(new_n78_), .O(z3));
  oai21  g60(.a(new_n48_), .b(x14), .c(new_n81_), .O(new_n97_));
  aoi21  g61(.a(new_n97_), .b(new_n82_), .c(x03), .O(new_n98_));
  oai21  g62(.a(x20), .b(new_n47_), .c(x06), .O(new_n99_));
  aoi21  g63(.a(new_n99_), .b(x11), .c(new_n80_), .O(new_n100_));
  oai22  g64(.a(new_n100_), .b(new_n62_), .c(new_n98_), .d(new_n46_), .O(z6));
  inv1   g65(.a(new_n62_), .O(z7));
  zero   g66(.O(z1));
  zero   g67(.O(z4));
  zero   g68(.O(z5));
endmodule
