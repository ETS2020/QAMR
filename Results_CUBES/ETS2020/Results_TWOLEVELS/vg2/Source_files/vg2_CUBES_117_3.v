...
module FAU ( 
  ...
  and2   g77(.a(x24), .b(x18), .O(new_n111_));
  nand2  g78(.a(x15), .b(x13), .O(new_n112_));
  nor2   g79(.a(new_n112_), .b(x24), .O(new_n113_));
  oai21  g80(.a(new_n113_), .b(new_n111_), .c(x05), .O(new_n114_));
  nand3  g81(.a(new_n53_), .b(new_n35_), .c(x21), .O(new_n115_));
  aoi22  g82(.a(new_n111_), .b(x13), .c(new_n39_), .d(x15), .O(new_n116_));
  nand2  g83(.a(new_n116_), .b(new_n115_), .O(new_n117_));
  inv1   g84(.a(new_n117_), .O(new_n118_));
  inv1   g85(.a(new_n56_), .O(new_n119_));
  nor2   g86(.a(new_n79_), .b(new_n78_), .O(new_n120_));
  nand4  g87(.a(new_n120_), .b(new_n119_), .c(x11), .d(x06), .O(new_n121_));
  aoi21  g88(.a(new_n118_), .b(new_n114_), .c(new_n121_), .O(z2));
  nand2  g89(.a(new_n46_), .b(new_n38_), .O(z5));
  nand2  g90(.a(new_n118_), .b(new_n114_), .O(z7));
  zero   g91(.O(z3));
  zero   g92(.O(z4));
  zero   g93(.O(z6));
endmodule
