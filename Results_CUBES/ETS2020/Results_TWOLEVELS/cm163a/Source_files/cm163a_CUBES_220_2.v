...
module FAU ( 
  ...
  and2   g01(.a(x03), .b(x02), .O(new_n24_));
  inv1   g02(.a(x09), .O(new_n25_));
  nand3  g03(.a(new_n25_), .b(x03), .c(x02), .O(new_n26_));
  nor2   g04(.a(x11), .b(x09), .O(new_n27_));
  aoi22  g05(.a(new_n27_), .b(new_n24_), .c(new_n26_), .d(x11), .O(new_n28_));
