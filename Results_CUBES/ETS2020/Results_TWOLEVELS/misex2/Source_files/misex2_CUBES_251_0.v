...
module FAU ( 
  ...
  nor3   g28(.a(new_n69_), .b(new_n55_), .c(new_n45_), .O(z05));
  ...
  nand4  g58(.a(new_n97_), .b(x21), .c(x18), .d(x01), .O(new_n104_));
  nand4  g59(.a(new_n99_), .b(x20), .c(new_n88_), .d(x15), .O(new_n105_));
  inv1   g60(.a(new_n105_), .O(new_n106_));
  nand3  g61(.a(new_n106_), .b(new_n95_), .c(new_n91_), .O(new_n107_));
  nand2  g62(.a(new_n100_), .b(new_n64_), .O(new_n108_));
  aoi21  g63(.a(new_n107_), .b(new_n104_), .c(new_n108_), .O(z11));
  nor3   g64(.a(new_n54_), .b(x19), .c(new_n48_), .O(z13));
  nand4  g65(.a(new_n50_), .b(new_n49_), .c(new_n48_), .d(new_n55_), .O(new_n112_));
  nor2   g66(.a(new_n112_), .b(new_n47_), .O(z14));
