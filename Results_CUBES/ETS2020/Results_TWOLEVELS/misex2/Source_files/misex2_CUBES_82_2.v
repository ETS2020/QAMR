...
module FAU ( 
  ...
  wire new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n53_, new_n54_,
    ...
    new_n99_, new_n101_, new_n103_, new_n104_, new_n107_;
  ...
  nand3  g19(.a(x20), .b(new_n68_), .c(new_n67_), .O(new_n69_));
  inv1   g20(.a(new_n69_), .O(new_n70_));
  nor2   g21(.a(new_n45_), .b(x01), .O(new_n71_));
  inv1   g22(.a(x13), .O(new_n72_));
  inv1   g23(.a(x14), .O(new_n73_));
  nand4  g24(.a(new_n73_), .b(new_n72_), .c(x12), .d(new_n58_), .O(new_n74_));
  inv1   g25(.a(new_n74_), .O(new_n75_));
  nand3  g26(.a(new_n75_), .b(new_n71_), .c(new_n70_), .O(new_n76_));
  ...
  nand3  g31(.a(new_n80_), .b(new_n79_), .c(new_n53_), .O(new_n81_));
  aoi21  g32(.a(new_n78_), .b(new_n76_), .c(new_n81_), .O(z09));
  nand4  g33(.a(new_n77_), .b(x21), .c(x18), .d(x01), .O(new_n84_));
  nand4  g34(.a(new_n79_), .b(x20), .c(new_n68_), .d(x15), .O(new_n85_));
  inv1   g35(.a(new_n85_), .O(new_n86_));
  nand3  g36(.a(new_n86_), .b(new_n75_), .c(new_n71_), .O(new_n87_));
  nand2  g37(.a(new_n80_), .b(new_n53_), .O(new_n88_));
  aoi21  g38(.a(new_n87_), .b(new_n84_), .c(new_n88_), .O(z11));
  oai21  g39(.a(new_n62_), .b(new_n45_), .c(new_n55_), .O(new_n90_));
  oai21  g40(.a(x19), .b(x02), .c(x23), .O(new_n91_));
  inv1   g41(.a(x19), .O(new_n92_));
  nand3  g42(.a(new_n92_), .b(x17), .c(new_n45_), .O(new_n93_));
  ...
  nor2   g49(.a(new_n99_), .b(new_n47_), .O(z13));
  nand3  g50(.a(new_n48_), .b(new_n62_), .c(new_n57_), .O(new_n101_));
  nor2   g51(.a(new_n101_), .b(new_n47_), .O(z14));
  aoi21  g52(.a(new_n62_), .b(x01), .c(new_n45_), .O(new_n103_));
  nand3  g53(.a(x19), .b(new_n45_), .c(new_n54_), .O(new_n104_));
  oai21  g54(.a(new_n103_), .b(new_n53_), .c(new_n104_), .O(z15));
  nor2   g55(.a(new_n54_), .b(x00), .O(z16));
  nand2  g56(.a(new_n46_), .b(x02), .O(new_n107_));
  inv1   g57(.a(new_n107_), .O(z17));
  zero   g58(.O(z00));
  zero   g59(.O(z02));
  zero   g60(.O(z03));
  zero   g61(.O(z06));
