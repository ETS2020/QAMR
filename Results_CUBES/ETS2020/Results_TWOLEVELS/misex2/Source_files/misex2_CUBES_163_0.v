...
module FAU ( 
  ...
  nor2   g49(.a(new_n70_), .b(x11), .O(new_n93_));
  ...
  nand4  g59(.a(new_n102_), .b(new_n58_), .c(x22), .d(x21), .O(new_n103_));
  inv1   g60(.a(x13), .O(new_n104_));
  nand3  g61(.a(new_n104_), .b(x12), .c(new_n61_), .O(new_n105_));
  ...
  oai21  g74(.a(new_n55_), .b(new_n44_), .c(new_n66_), .O(new_n118_));
  ...
  nor2   g82(.a(new_n56_), .b(new_n47_), .O(z14));
  zero   g83(.O(z13));
  zero   g84(.O(z15));
  zero   g85(.O(z16));
  zero   g86(.O(z17));
