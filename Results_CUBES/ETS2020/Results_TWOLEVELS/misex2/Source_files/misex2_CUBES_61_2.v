...
module FAU ( 
  ...
  nand2  g52(.a(new_n46_), .b(new_n45_), .O(new_n103_));
  nor2   g53(.a(x10), .b(x09), .O(new_n104_));
  nand4  g54(.a(new_n104_), .b(new_n50_), .c(new_n49_), .d(new_n48_), .O(new_n105_));
  nor2   g55(.a(new_n105_), .b(new_n103_), .O(z14));
  aoi21  g56(.a(new_n53_), .b(x01), .c(new_n45_), .O(new_n107_));
  nand3  g57(.a(x19), .b(new_n45_), .c(new_n58_), .O(new_n108_));
  oai21  g58(.a(new_n107_), .b(new_n57_), .c(new_n108_), .O(z15));
