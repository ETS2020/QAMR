...
module FAU ( 
  ...
  nand4  g44(.a(new_n89_), .b(new_n88_), .c(x12), .d(new_n61_), .O(new_n90_));
  ...
  nand4  g54(.a(new_n93_), .b(x21), .c(x18), .d(x01), .O(new_n101_));
  nand4  g55(.a(new_n96_), .b(x20), .c(new_n84_), .d(x15), .O(new_n102_));
  inv1   g56(.a(new_n102_), .O(new_n103_));
  nand3  g57(.a(new_n103_), .b(new_n91_), .c(new_n87_), .O(new_n104_));
  nand2  g58(.a(new_n97_), .b(new_n95_), .O(new_n105_));
  aoi21  g59(.a(new_n104_), .b(new_n101_), .c(new_n105_), .O(z11));
  oai21  g60(.a(new_n60_), .b(new_n44_), .c(new_n65_), .O(new_n107_));
  oai21  g61(.a(x19), .b(x02), .c(x23), .O(new_n108_));
  nand3  g62(.a(new_n50_), .b(x17), .c(new_n44_), .O(new_n109_));
  ...
  nand4  g69(.a(new_n50_), .b(new_n49_), .c(new_n48_), .d(new_n60_), .O(new_n116_));
  nor2   g70(.a(new_n116_), .b(new_n47_), .O(z14));
  aoi21  g71(.a(new_n60_), .b(x01), .c(new_n44_), .O(new_n118_));
  inv1   g72(.a(x01), .O(new_n119_));
  nand3  g73(.a(x19), .b(new_n44_), .c(new_n119_), .O(new_n120_));
  oai21  g74(.a(new_n118_), .b(new_n95_), .c(new_n120_), .O(z15));
  nor2   g75(.a(new_n119_), .b(x00), .O(z16));
