// Benchmark "FAU" written by ABC on Tue Jul  7 11:01:20 2020
...
module FAU ( 
  ...
  inv1   g43(.a(x01), .O(new_n88_));
  nand2  g44(.a(x02), .b(new_n88_), .O(new_n89_));
  inv1   g45(.a(new_n89_), .O(new_n90_));
  nor2   g46(.a(new_n73_), .b(x11), .O(new_n91_));
  nor2   g47(.a(x14), .b(x13), .O(new_n92_));
  nand4  g48(.a(new_n92_), .b(new_n91_), .c(new_n90_), .d(new_n87_), .O(new_n93_));
  nor2   g49(.a(x20), .b(x19), .O(new_n94_));
  nand3  g50(.a(new_n94_), .b(x18), .c(x01), .O(new_n95_));
  inv1   g51(.a(x00), .O(new_n96_));
  inv1   g52(.a(x21), .O(new_n97_));
  inv1   g53(.a(x22), .O(new_n98_));
  nand3  g54(.a(new_n98_), .b(new_n97_), .c(new_n96_), .O(new_n99_));
  aoi21  g55(.a(new_n95_), .b(new_n93_), .c(new_n99_), .O(z09));
  nor2   g56(.a(x20), .b(new_n88_), .O(new_n101_));
  nand4  g57(.a(new_n101_), .b(new_n57_), .c(x22), .d(x21), .O(new_n102_));
  inv1   g58(.a(x13), .O(new_n103_));
  nand3  g59(.a(new_n103_), .b(x12), .c(new_n62_), .O(new_n104_));
  nor2   g60(.a(new_n104_), .b(new_n89_), .O(new_n105_));
  nor2   g61(.a(new_n84_), .b(x14), .O(new_n106_));
  ...
  nand4  g66(.a(new_n94_), .b(x21), .c(x18), .d(x01), .O(new_n111_));
  nand3  g67(.a(new_n97_), .b(x20), .c(new_n85_), .O(new_n112_));
  inv1   g68(.a(new_n112_), .O(new_n113_));
  nand3  g69(.a(new_n113_), .b(new_n106_), .c(new_n105_), .O(new_n114_));
  nand2  g70(.a(new_n98_), .b(new_n96_), .O(new_n115_));
  ...
  nand3  g84(.a(x19), .b(new_n59_), .c(new_n88_), .O(new_n129_));
  oai21  g85(.a(new_n128_), .b(new_n96_), .c(new_n129_), .O(z15));
  nor2   g86(.a(new_n88_), .b(x00), .O(z16));
  inv1   g87(.a(new_n81_), .O(z17));
  zero   g88(.O(z04));
endmodule
