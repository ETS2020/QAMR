...
module FAU ( 
  ...
  nand4  g34(.a(x19), .b(new_n49_), .c(x17), .d(new_n78_), .O(new_n79_));
  ...
  nand3  g39(.a(new_n46_), .b(new_n83_), .c(x02), .O(new_n84_));
  ...
  nand2  g45(.a(x02), .b(new_n64_), .O(new_n90_));
  inv1   g46(.a(new_n90_), .O(new_n91_));
  nor2   g47(.a(new_n69_), .b(x11), .O(new_n92_));
  ...
  nor2   g56(.a(x20), .b(new_n64_), .O(new_n101_));
  nand4  g57(.a(new_n101_), .b(new_n56_), .c(x22), .d(x21), .O(new_n102_));
  inv1   g58(.a(x13), .O(new_n103_));
  nand3  g59(.a(new_n103_), .b(x12), .c(new_n59_), .O(new_n104_));
  ...
  nand2  g70(.a(new_n98_), .b(new_n63_), .O(new_n115_));
  aoi21  g71(.a(new_n114_), .b(new_n111_), .c(new_n115_), .O(z11));
  oai21  g72(.a(new_n53_), .b(new_n45_), .c(new_n65_), .O(new_n117_));
  oai21  g73(.a(x19), .b(x02), .c(x23), .O(new_n118_));
  nand3  g74(.a(new_n50_), .b(x17), .c(new_n45_), .O(new_n119_));
  ...
  nand2  g80(.a(new_n46_), .b(new_n45_), .O(new_n125_));
  nor3   g81(.a(new_n125_), .b(x19), .c(new_n48_), .O(z13));
  aoi21  g82(.a(new_n53_), .b(x01), .c(new_n45_), .O(new_n128_));
  nand3  g83(.a(x19), .b(new_n45_), .c(new_n64_), .O(new_n129_));
  oai21  g84(.a(new_n128_), .b(new_n63_), .c(new_n129_), .O(z15));
  zero   g85(.O(z00));
  zero   g86(.O(z14));
  zero   g87(.O(z16));
  zero   g88(.O(z17));
