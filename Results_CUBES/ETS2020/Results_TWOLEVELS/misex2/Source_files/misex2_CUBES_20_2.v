...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n73_, new_n74_, new_n75_, new_n76_, new_n80_, new_n81_, new_n82_,
  ...
  nand4  g31(.a(new_n80_), .b(x21), .c(x18), .d(x01), .O(new_n81_));
  inv1   g32(.a(x16), .O(new_n82_));
  inv1   g33(.a(x21), .O(new_n83_));
  nand4  g34(.a(new_n83_), .b(x20), .c(new_n82_), .d(x15), .O(new_n84_));
  inv1   g35(.a(new_n84_), .O(new_n85_));
  nor2   g36(.a(new_n44_), .b(x01), .O(new_n86_));
  inv1   g37(.a(x13), .O(new_n87_));
  inv1   g38(.a(x14), .O(new_n88_));
  nand4  g39(.a(new_n88_), .b(new_n87_), .c(x12), .d(new_n60_), .O(new_n89_));
  inv1   g40(.a(new_n89_), .O(new_n90_));
  nand3  g41(.a(new_n90_), .b(new_n86_), .c(new_n85_), .O(new_n91_));
  inv1   g42(.a(x22), .O(new_n92_));
  nand2  g43(.a(new_n92_), .b(new_n62_), .O(new_n93_));
  aoi21  g44(.a(new_n91_), .b(new_n81_), .c(new_n93_), .O(z11));
  oai21  g45(.a(new_n50_), .b(new_n44_), .c(new_n64_), .O(new_n95_));
  oai21  g46(.a(x19), .b(x02), .c(x23), .O(new_n96_));
  nand3  g47(.a(new_n49_), .b(x17), .c(new_n44_), .O(new_n97_));
  nand2  g48(.a(new_n97_), .b(new_n96_), .O(new_n98_));
  nand2  g49(.a(new_n98_), .b(new_n45_), .O(new_n99_));
  ...
  aoi21  g54(.a(new_n50_), .b(x01), .c(new_n44_), .O(new_n105_));
  nand3  g55(.a(x19), .b(new_n44_), .c(new_n63_), .O(new_n106_));
  oai21  g56(.a(new_n105_), .b(new_n62_), .c(new_n106_), .O(z15));
  nor2   g57(.a(new_n63_), .b(x00), .O(z16));
