...
module FAU ( 
  ...
  nand2  g80(.a(new_n46_), .b(new_n45_), .O(new_n126_));
  nor2   g81(.a(x10), .b(x09), .O(new_n127_));
  nand4  g82(.a(new_n127_), .b(new_n50_), .c(new_n49_), .d(new_n48_), .O(new_n128_));
  nor2   g83(.a(new_n128_), .b(new_n126_), .O(z14));
  aoi21  g84(.a(new_n53_), .b(x01), .c(new_n45_), .O(new_n130_));
  nand3  g85(.a(x19), .b(new_n45_), .c(new_n64_), .O(new_n131_));
  oai21  g86(.a(new_n130_), .b(new_n63_), .c(new_n131_), .O(z15));
  zero   g87(.O(z00));
  zero   g88(.O(z13));
  zero   g89(.O(z16));
  zero   g90(.O(z17));
