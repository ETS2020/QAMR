...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n88_, new_n89_, new_n96_, new_n97_, new_n98_;
  ...
  nor3   g44(.a(new_n46_), .b(x19), .c(new_n49_), .O(z13));
  aoi21  g45(.a(new_n57_), .b(x01), .c(new_n44_), .O(new_n96_));
  inv1   g46(.a(x01), .O(new_n97_));
  nand3  g47(.a(x19), .b(new_n44_), .c(new_n97_), .O(new_n98_));
