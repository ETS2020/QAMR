...
module FAU ( 
  ...
  nand4  g44(.a(new_n89_), .b(x21), .c(x18), .d(x01), .O(new_n90_));
  inv1   g45(.a(x16), .O(new_n91_));
  inv1   g46(.a(x21), .O(new_n92_));
  nand4  g47(.a(new_n92_), .b(x20), .c(new_n91_), .d(x15), .O(new_n93_));
  inv1   g48(.a(new_n93_), .O(new_n94_));
  nor2   g49(.a(new_n60_), .b(x01), .O(new_n95_));
  inv1   g50(.a(x13), .O(new_n96_));
  inv1   g51(.a(x14), .O(new_n97_));
  nand4  g52(.a(new_n97_), .b(new_n96_), .c(x12), .d(new_n62_), .O(new_n98_));
  inv1   g53(.a(new_n98_), .O(new_n99_));
  nand3  g54(.a(new_n99_), .b(new_n95_), .c(new_n94_), .O(new_n100_));
  inv1   g55(.a(x22), .O(new_n101_));
  nand2  g56(.a(new_n101_), .b(new_n45_), .O(new_n102_));
  aoi21  g57(.a(new_n100_), .b(new_n90_), .c(new_n102_), .O(z11));
  oai21  g58(.a(new_n57_), .b(new_n60_), .c(new_n65_), .O(new_n104_));
  oai21  g59(.a(x19), .b(x02), .c(x23), .O(new_n105_));
  nand3  g60(.a(new_n52_), .b(x17), .c(new_n60_), .O(new_n106_));
  nand2  g61(.a(new_n106_), .b(new_n105_), .O(new_n107_));
  nand2  g62(.a(new_n107_), .b(new_n84_), .O(new_n108_));
  inv1   g63(.a(x24), .O(new_n109_));
  nand2  g64(.a(new_n109_), .b(x09), .O(new_n110_));
  aoi21  g65(.a(new_n108_), .b(new_n104_), .c(new_n110_), .O(z12));
  nor4   g66(.a(new_n47_), .b(x19), .c(new_n50_), .d(x02), .O(z13));
  nor2   g67(.a(new_n58_), .b(new_n49_), .O(z14));
  aoi21  g68(.a(new_n57_), .b(x01), .c(new_n60_), .O(new_n114_));
  nand3  g69(.a(x19), .b(new_n60_), .c(new_n46_), .O(new_n115_));
  oai21  g70(.a(new_n114_), .b(new_n45_), .c(new_n115_), .O(z15));
