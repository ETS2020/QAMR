...
module FAU ( 
  ...
  nand3  g44(.a(new_n90_), .b(new_n89_), .c(new_n58_), .O(new_n91_));
  ...
  nand3  g48(.a(new_n94_), .b(x12), .c(new_n62_), .O(new_n95_));
  ...
  nand2  g59(.a(new_n90_), .b(new_n58_), .O(new_n106_));
  aoi21  g60(.a(new_n105_), .b(new_n102_), .c(new_n106_), .O(z11));
  inv1   g61(.a(x02), .O(new_n108_));
  oai21  g62(.a(new_n54_), .b(new_n108_), .c(new_n60_), .O(new_n109_));
  oai21  g63(.a(x19), .b(x02), .c(x23), .O(new_n110_));
  nand3  g64(.a(new_n49_), .b(x17), .c(new_n108_), .O(new_n111_));
  nand2  g65(.a(new_n111_), .b(new_n110_), .O(new_n112_));
  nand2  g66(.a(new_n112_), .b(new_n73_), .O(new_n113_));
  inv1   g67(.a(x24), .O(new_n114_));
  nand2  g68(.a(new_n114_), .b(x09), .O(new_n115_));
  aoi21  g69(.a(new_n113_), .b(new_n109_), .c(new_n115_), .O(z12));
  nor2   g70(.a(x19), .b(new_n47_), .O(new_n117_));
  and2   g71(.a(new_n117_), .b(new_n45_), .O(z13));
  nor2   g72(.a(new_n55_), .b(new_n46_), .O(z14));
  aoi21  g73(.a(new_n54_), .b(x01), .c(new_n108_), .O(new_n120_));
  nand3  g74(.a(x19), .b(new_n108_), .c(new_n59_), .O(new_n121_));
  oai21  g75(.a(new_n120_), .b(new_n58_), .c(new_n121_), .O(z15));
  nor2   g76(.a(new_n59_), .b(x00), .O(z16));
