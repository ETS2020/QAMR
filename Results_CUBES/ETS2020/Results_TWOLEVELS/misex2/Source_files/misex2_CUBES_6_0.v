...
module FAU ( 
  ...
  nand2  g76(.a(new_n46_), .b(new_n45_), .O(new_n123_));
  nor3   g77(.a(new_n123_), .b(x19), .c(new_n48_), .O(z13));
  nor2   g78(.a(x10), .b(x09), .O(new_n125_));
  nand4  g79(.a(new_n125_), .b(new_n50_), .c(new_n49_), .d(new_n48_), .O(new_n126_));
  nor2   g80(.a(new_n126_), .b(new_n123_), .O(z14));
