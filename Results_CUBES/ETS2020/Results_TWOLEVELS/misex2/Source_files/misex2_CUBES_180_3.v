...
module FAU ( 
  ...
  nand4  g58(.a(new_n96_), .b(x21), .c(x18), .d(x01), .O(new_n103_));
  nand4  g59(.a(new_n98_), .b(x20), .c(new_n87_), .d(x15), .O(new_n104_));
  inv1   g60(.a(new_n104_), .O(new_n105_));
  nand3  g61(.a(new_n105_), .b(new_n94_), .c(new_n90_), .O(new_n106_));
  nand2  g62(.a(new_n99_), .b(new_n45_), .O(new_n107_));
  aoi21  g63(.a(new_n106_), .b(new_n103_), .c(new_n107_), .O(z11));
  oai21  g64(.a(new_n57_), .b(new_n60_), .c(new_n65_), .O(new_n109_));
  oai21  g65(.a(x19), .b(x02), .c(x23), .O(new_n110_));
  nand3  g66(.a(new_n52_), .b(x17), .c(new_n60_), .O(new_n111_));
  nand2  g67(.a(new_n111_), .b(new_n110_), .O(new_n112_));
  nand2  g68(.a(new_n112_), .b(new_n82_), .O(new_n113_));
  ...
  aoi21  g74(.a(new_n57_), .b(x01), .c(new_n60_), .O(new_n119_));
  nand3  g75(.a(x19), .b(new_n60_), .c(new_n46_), .O(new_n120_));
  oai21  g76(.a(new_n119_), .b(new_n45_), .c(new_n120_), .O(z15));
