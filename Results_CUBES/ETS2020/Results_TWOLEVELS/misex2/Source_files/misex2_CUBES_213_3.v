...
module FAU ( 
  ...
  wire new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_, new_n51_,
    ...
    new_n123_, new_n125_, new_n126_, new_n128_, new_n129_;
  ...
  nand3  g20(.a(new_n64_), .b(new_n62_), .c(x02), .O(new_n65_));
  oai22  g21(.a(new_n65_), .b(new_n61_), .c(new_n58_), .d(new_n57_), .O(z03));
  nor4   g22(.a(new_n63_), .b(new_n53_), .c(new_n62_), .d(new_n45_), .O(z05));
  nand3  g23(.a(new_n60_), .b(new_n62_), .c(x02), .O(new_n69_));
  nor2   g24(.a(new_n69_), .b(new_n63_), .O(z06));
  inv1   g25(.a(x12), .O(new_n71_));
  nand4  g26(.a(new_n60_), .b(new_n71_), .c(new_n62_), .d(x01), .O(new_n72_));
  ...
  nor2   g43(.a(new_n71_), .b(x11), .O(new_n89_));
  ...
  nor2   g57(.a(new_n102_), .b(new_n87_), .O(new_n103_));
  nor2   g58(.a(new_n82_), .b(x14), .O(new_n104_));
  ...
  nand4  g63(.a(new_n92_), .b(x21), .c(x18), .d(x01), .O(new_n109_));
  nand3  g64(.a(new_n95_), .b(x20), .c(new_n83_), .O(new_n110_));
  inv1   g65(.a(new_n110_), .O(new_n111_));
  nand3  g66(.a(new_n111_), .b(new_n104_), .c(new_n103_), .O(new_n112_));
  nand2  g67(.a(new_n96_), .b(new_n94_), .O(new_n113_));
  aoi21  g68(.a(new_n112_), .b(new_n109_), .c(new_n113_), .O(z11));
  oai21  g69(.a(new_n53_), .b(new_n45_), .c(new_n64_), .O(new_n115_));
  ...
  aoi21  g82(.a(new_n53_), .b(x01), .c(new_n45_), .O(new_n128_));
  nand3  g83(.a(x19), .b(new_n45_), .c(new_n86_), .O(new_n129_));
  oai21  g84(.a(new_n128_), .b(new_n94_), .c(new_n129_), .O(z15));
  nor2   g85(.a(new_n86_), .b(x00), .O(z16));
  inv1   g86(.a(new_n79_), .O(z17));
  zero   g87(.O(z00));
  zero   g88(.O(z04));
endmodule
