...
module FAU ( 
  ...
  nand3  g38(.a(new_n87_), .b(new_n82_), .c(new_n80_), .O(new_n88_));
  inv1   g39(.a(x22), .O(new_n89_));
  nand2  g40(.a(new_n89_), .b(new_n59_), .O(new_n90_));
  aoi21  g41(.a(new_n88_), .b(new_n76_), .c(new_n90_), .O(z11));
  nand2  g42(.a(x10), .b(x02), .O(new_n92_));
  nand3  g43(.a(new_n92_), .b(x01), .c(x00), .O(new_n93_));
  oai21  g44(.a(x19), .b(x02), .c(x23), .O(new_n94_));
  nand3  g45(.a(new_n49_), .b(x17), .c(new_n81_), .O(new_n95_));
  ...
  aoi21  g54(.a(new_n54_), .b(x01), .c(new_n81_), .O(new_n104_));
  nand3  g55(.a(x19), .b(new_n81_), .c(new_n60_), .O(new_n105_));
