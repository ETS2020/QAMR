...
module FAU ( 
  ...
  nand3  g29(.a(new_n77_), .b(new_n76_), .c(x20), .O(new_n78_));
  inv1   g30(.a(new_n78_), .O(new_n79_));
  inv1   g31(.a(x13), .O(new_n80_));
  inv1   g32(.a(x14), .O(new_n81_));
  nand4  g33(.a(x16), .b(x15), .c(new_n81_), .d(new_n80_), .O(new_n82_));
  inv1   g34(.a(new_n82_), .O(new_n83_));
  inv1   g35(.a(x11), .O(new_n84_));
  nand4  g36(.a(x12), .b(new_n84_), .c(x02), .d(new_n72_), .O(new_n85_));
  inv1   g37(.a(new_n85_), .O(new_n86_));
  nand3  g38(.a(new_n86_), .b(new_n83_), .c(new_n79_), .O(new_n87_));
  ...
  inv1   g45(.a(x00), .O(new_n96_));
  aoi21  g46(.a(new_n53_), .b(x01), .c(new_n45_), .O(new_n97_));
  nand3  g47(.a(x19), .b(new_n45_), .c(new_n72_), .O(new_n98_));
  oai21  g48(.a(new_n97_), .b(new_n96_), .c(new_n98_), .O(z15));
  nor2   g49(.a(new_n72_), .b(x00), .O(z16));
