...
module FAU ( 
  ...
  inv1   g22(.a(x01), .O(new_n71_));
  nand2  g23(.a(x02), .b(new_n71_), .O(new_n72_));
  inv1   g24(.a(new_n72_), .O(new_n73_));
  inv1   g25(.a(x11), .O(new_n74_));
  inv1   g26(.a(x13), .O(new_n75_));
  inv1   g27(.a(x14), .O(new_n76_));
  nand4  g28(.a(new_n76_), .b(new_n75_), .c(x12), .d(new_n74_), .O(new_n77_));
  inv1   g29(.a(new_n77_), .O(new_n78_));
  nand3  g30(.a(new_n78_), .b(new_n73_), .c(new_n70_), .O(new_n79_));
  nor2   g31(.a(new_n54_), .b(new_n71_), .O(new_n80_));
  nor2   g32(.a(x20), .b(x19), .O(new_n81_));
  nand2  g33(.a(new_n81_), .b(new_n80_), .O(new_n82_));
  inv1   g34(.a(x00), .O(new_n83_));
  inv1   g35(.a(x21), .O(new_n84_));
  inv1   g36(.a(x22), .O(new_n85_));
  nand3  g37(.a(new_n85_), .b(new_n84_), .c(new_n83_), .O(new_n86_));
  aoi21  g38(.a(new_n82_), .b(new_n79_), .c(new_n86_), .O(z09));
  nand4  g39(.a(new_n81_), .b(new_n80_), .c(x22), .d(x21), .O(new_n88_));
  nand3  g40(.a(new_n75_), .b(x12), .c(new_n74_), .O(new_n89_));
  nor2   g41(.a(new_n89_), .b(new_n72_), .O(new_n90_));
  nor2   g42(.a(new_n67_), .b(x14), .O(new_n91_));
  nand4  g43(.a(new_n85_), .b(new_n84_), .c(x20), .d(x16), .O(new_n92_));
  inv1   g44(.a(new_n92_), .O(new_n93_));
  nand3  g45(.a(new_n93_), .b(new_n91_), .c(new_n90_), .O(new_n94_));
  aoi21  g46(.a(new_n94_), .b(new_n88_), .c(x00), .O(z10));
  nand3  g47(.a(new_n81_), .b(new_n80_), .c(x21), .O(new_n96_));
  nand3  g48(.a(new_n84_), .b(x20), .c(new_n68_), .O(new_n97_));
  inv1   g49(.a(new_n97_), .O(new_n98_));
  nand3  g50(.a(new_n98_), .b(new_n91_), .c(new_n90_), .O(new_n99_));
  nand2  g51(.a(new_n85_), .b(new_n83_), .O(new_n100_));
  aoi21  g52(.a(new_n99_), .b(new_n96_), .c(new_n100_), .O(z11));
  nand2  g53(.a(x10), .b(x02), .O(new_n102_));
  nand3  g54(.a(new_n102_), .b(x01), .c(x00), .O(new_n103_));
  oai21  g55(.a(x19), .b(x02), .c(x23), .O(new_n104_));
  nand3  g56(.a(new_n48_), .b(x17), .c(new_n44_), .O(new_n105_));
  ...
  nor3   g62(.a(new_n46_), .b(x19), .c(new_n53_), .O(z13));
  aoi21  g63(.a(new_n57_), .b(x01), .c(new_n44_), .O(new_n113_));
  nand3  g64(.a(x19), .b(new_n44_), .c(new_n71_), .O(new_n114_));
  oai21  g65(.a(new_n113_), .b(new_n83_), .c(new_n114_), .O(z15));
  nor2   g66(.a(new_n71_), .b(x00), .O(z16));
  nand2  g67(.a(new_n45_), .b(x02), .O(new_n117_));
