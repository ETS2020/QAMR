...
module FAU ( 
  ...
  aoi21  g57(.a(new_n52_), .b(x01), .c(new_n44_), .O(new_n108_));
  nand3  g58(.a(x19), .b(new_n44_), .c(new_n76_), .O(new_n109_));
  oai21  g59(.a(new_n108_), .b(new_n93_), .c(new_n109_), .O(z15));
  nor2   g60(.a(new_n76_), .b(x00), .O(z16));
