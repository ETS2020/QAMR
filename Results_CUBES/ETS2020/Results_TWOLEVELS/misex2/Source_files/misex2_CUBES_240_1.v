...
module FAU ( 
  ...
  nand3  g27(.a(new_n61_), .b(new_n45_), .c(x02), .O(new_n72_));
  nor3   g28(.a(new_n72_), .b(new_n64_), .c(new_n63_), .O(z06));
  nand4  g29(.a(new_n61_), .b(new_n68_), .c(new_n45_), .d(x01), .O(new_n74_));
  ...
  nand2  g36(.a(new_n46_), .b(x02), .O(new_n81_));
  nand3  g37(.a(x19), .b(new_n49_), .c(x17), .O(new_n82_));
  ...
  nor2   g43(.a(new_n44_), .b(x01), .O(new_n88_));
  inv1   g44(.a(x13), .O(new_n89_));
  inv1   g45(.a(x14), .O(new_n90_));
  nand4  g46(.a(new_n90_), .b(new_n89_), .c(x12), .d(new_n60_), .O(new_n91_));
  ...
  nand4  g55(.a(new_n94_), .b(x21), .c(x18), .d(x01), .O(new_n101_));
  nand4  g56(.a(new_n96_), .b(x20), .c(new_n85_), .d(x15), .O(new_n102_));
  inv1   g57(.a(new_n102_), .O(new_n103_));
  nand3  g58(.a(new_n103_), .b(new_n92_), .c(new_n88_), .O(new_n104_));
  nand2  g59(.a(new_n97_), .b(new_n63_), .O(new_n105_));
  aoi21  g60(.a(new_n104_), .b(new_n101_), .c(new_n105_), .O(z11));
  ...
  nand3  g71(.a(x19), .b(new_n44_), .c(new_n64_), .O(new_n118_));
  oai21  g72(.a(new_n117_), .b(new_n63_), .c(new_n118_), .O(z15));
  nor2   g73(.a(new_n64_), .b(x00), .O(z16));
  inv1   g74(.a(new_n81_), .O(z17));
  zero   g75(.O(z05));
  zero   g76(.O(z10));
  zero   g77(.O(z13));
endmodule
