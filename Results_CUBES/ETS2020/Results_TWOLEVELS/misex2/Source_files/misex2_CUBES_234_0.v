...
module FAU ( 
  ...
  nand4  g31(.a(x19), .b(new_n49_), .c(x17), .d(new_n77_), .O(new_n78_));
  ...
  nand3  g36(.a(new_n46_), .b(new_n82_), .c(x02), .O(new_n83_));
  ...
  nand2  g42(.a(x02), .b(new_n70_), .O(new_n89_));
  inv1   g43(.a(new_n89_), .O(new_n90_));
  nor2   g44(.a(new_n73_), .b(x11), .O(new_n91_));
  ...
  nand3  g51(.a(new_n97_), .b(new_n96_), .c(new_n69_), .O(new_n98_));
  aoi21  g52(.a(new_n95_), .b(new_n93_), .c(new_n98_), .O(z09));
  nor2   g53(.a(x20), .b(new_n70_), .O(new_n100_));
  nand4  g54(.a(new_n100_), .b(new_n59_), .c(x22), .d(x21), .O(new_n101_));
  inv1   g55(.a(x13), .O(new_n102_));
  nand3  g56(.a(new_n102_), .b(x12), .c(new_n62_), .O(new_n103_));
  ...
  nand2  g67(.a(new_n97_), .b(new_n69_), .O(new_n114_));
  aoi21  g68(.a(new_n113_), .b(new_n110_), .c(new_n114_), .O(z11));
  nand4  g69(.a(new_n50_), .b(new_n49_), .c(new_n48_), .d(new_n55_), .O(new_n118_));
  nor2   g70(.a(new_n118_), .b(new_n47_), .O(z14));
  nor2   g71(.a(new_n70_), .b(x00), .O(z16));
  zero   g72(.O(z01));
  zero   g73(.O(z04));
  zero   g74(.O(z05));
  zero   g75(.O(z12));
