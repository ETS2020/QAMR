...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n102_, new_n106_, new_n109_, new_n110_;
  ...
  aoi21  g61(.a(new_n54_), .b(x01), .c(new_n61_), .O(new_n109_));
  nand3  g62(.a(x19), .b(new_n61_), .c(new_n60_), .O(new_n110_));
  oai21  g63(.a(new_n109_), .b(new_n59_), .c(new_n110_), .O(z15));
