...
module FAU ( 
  ...
  oai22  g16(.a(new_n61_), .b(new_n59_), .c(new_n56_), .d(new_n53_), .O(z03));
  ...
  nand2  g31(.a(new_n47_), .b(x02), .O(new_n78_));
  ...
  nor3   g51(.a(new_n48_), .b(x19), .c(new_n54_), .O(z13));
  nand3  g52(.a(new_n50_), .b(new_n49_), .c(new_n60_), .O(new_n102_));
  nor2   g53(.a(new_n102_), .b(new_n48_), .O(z14));
  aoi21  g54(.a(new_n49_), .b(x01), .c(new_n46_), .O(new_n104_));
  nand3  g55(.a(x19), .b(new_n46_), .c(new_n68_), .O(new_n105_));
  oai21  g56(.a(new_n104_), .b(new_n67_), .c(new_n105_), .O(z15));
  nor2   g57(.a(new_n68_), .b(x00), .O(z16));
  inv1   g58(.a(new_n78_), .O(z17));
  zero   g59(.O(z00));
  zero   g60(.O(z01));
  zero   g61(.O(z05));
  zero   g62(.O(z10));
