...
module FAU ( 
  ...
  nand2  g29(.a(new_n46_), .b(x02), .O(new_n77_));
  inv1   g30(.a(x18), .O(new_n78_));
  nand3  g31(.a(x19), .b(new_n78_), .c(x17), .O(new_n79_));
  nor3   g32(.a(new_n79_), .b(new_n77_), .c(new_n76_), .O(z08));
  inv1   g33(.a(x15), .O(new_n81_));
  inv1   g34(.a(x16), .O(new_n82_));
  nand3  g35(.a(x20), .b(new_n82_), .c(new_n81_), .O(new_n83_));
  inv1   g36(.a(new_n83_), .O(new_n84_));
  nor2   g37(.a(new_n45_), .b(x01), .O(new_n85_));
  inv1   g38(.a(x13), .O(new_n86_));
  inv1   g39(.a(x14), .O(new_n87_));
  nand4  g40(.a(new_n87_), .b(new_n86_), .c(x12), .d(new_n57_), .O(new_n88_));
  inv1   g41(.a(new_n88_), .O(new_n89_));
  nand3  g42(.a(new_n89_), .b(new_n85_), .c(new_n84_), .O(new_n90_));
  inv1   g43(.a(x20), .O(new_n91_));
  nand4  g44(.a(new_n91_), .b(new_n52_), .c(x18), .d(x01), .O(new_n92_));
  inv1   g45(.a(x21), .O(new_n93_));
  inv1   g46(.a(x22), .O(new_n94_));
  nand3  g47(.a(new_n94_), .b(new_n93_), .c(new_n65_), .O(new_n95_));
  aoi21  g48(.a(new_n92_), .b(new_n90_), .c(new_n95_), .O(z09));
  nor2   g49(.a(x20), .b(new_n66_), .O(new_n97_));
  nor2   g50(.a(new_n94_), .b(new_n93_), .O(new_n98_));
  nand4  g51(.a(new_n98_), .b(new_n97_), .c(new_n52_), .d(x18), .O(new_n99_));
  nand3  g52(.a(new_n94_), .b(new_n93_), .c(x20), .O(new_n100_));
  inv1   g53(.a(new_n100_), .O(new_n101_));
  nand4  g54(.a(x16), .b(x15), .c(new_n87_), .d(new_n86_), .O(new_n102_));
  inv1   g55(.a(new_n102_), .O(new_n103_));
  nand4  g56(.a(x12), .b(new_n57_), .c(x02), .d(new_n66_), .O(new_n104_));
  inv1   g57(.a(new_n104_), .O(new_n105_));
  nand3  g58(.a(new_n105_), .b(new_n103_), .c(new_n101_), .O(new_n106_));
  aoi21  g59(.a(new_n106_), .b(new_n99_), .c(x00), .O(z10));
  nor3   g60(.a(new_n47_), .b(x19), .c(new_n54_), .O(z13));
  nand3  g61(.a(new_n48_), .b(new_n56_), .c(new_n60_), .O(new_n111_));
  nor2   g62(.a(new_n111_), .b(new_n47_), .O(z14));
  aoi21  g63(.a(new_n56_), .b(x01), .c(new_n45_), .O(new_n113_));
  nand3  g64(.a(x19), .b(new_n45_), .c(new_n66_), .O(new_n114_));
  oai21  g65(.a(new_n113_), .b(new_n65_), .c(new_n114_), .O(z15));
  nor2   g66(.a(new_n66_), .b(x00), .O(z16));
  inv1   g67(.a(new_n77_), .O(z17));
  zero   g68(.O(z00));
  zero   g69(.O(z02));
  zero   g70(.O(z04));
  zero   g71(.O(z05));
