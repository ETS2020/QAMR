...
module FAU ( 
  ...
  oai22  g16(.a(new_n61_), .b(new_n60_), .c(new_n56_), .d(new_n55_), .O(z03));
  inv1   g17(.a(x12), .O(new_n63_));
  nand3  g18(.a(new_n63_), .b(new_n58_), .c(x10), .O(new_n64_));
  nor2   g19(.a(new_n64_), .b(new_n61_), .O(z04));
  inv1   g20(.a(x00), .O(new_n67_));
  inv1   g21(.a(x01), .O(new_n68_));
  nand3  g22(.a(new_n59_), .b(new_n45_), .c(x02), .O(new_n69_));
  nor3   g23(.a(new_n69_), .b(new_n68_), .c(new_n67_), .O(z06));
  nand4  g24(.a(new_n59_), .b(new_n63_), .c(new_n45_), .d(x01), .O(new_n71_));
  ...
  nand4  g34(.a(new_n81_), .b(new_n80_), .c(x12), .d(new_n58_), .O(new_n82_));
  inv1   g35(.a(new_n82_), .O(new_n83_));
  nand3  g36(.a(new_n83_), .b(new_n79_), .c(new_n78_), .O(new_n84_));
  inv1   g37(.a(x20), .O(new_n85_));
  nand4  g38(.a(new_n85_), .b(new_n50_), .c(x18), .d(x01), .O(new_n86_));
  ...
  nand4  g43(.a(new_n50_), .b(new_n49_), .c(new_n48_), .d(new_n57_), .O(new_n95_));
  nor2   g44(.a(new_n95_), .b(new_n47_), .O(z14));
  aoi21  g45(.a(new_n57_), .b(x01), .c(new_n44_), .O(new_n97_));
  nand3  g46(.a(x19), .b(new_n44_), .c(new_n68_), .O(new_n98_));
