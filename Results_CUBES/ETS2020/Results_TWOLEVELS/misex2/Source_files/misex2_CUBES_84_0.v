...
module FAU ( 
  ...
  nand4  g49(.a(new_n95_), .b(new_n58_), .c(x22), .d(x21), .O(new_n96_));
  ...
  oai21  g64(.a(new_n61_), .b(new_n44_), .c(new_n67_), .O(new_n111_));
  ...
  nor3   g72(.a(new_n53_), .b(x19), .c(new_n48_), .O(z13));
  nand4  g73(.a(new_n50_), .b(new_n49_), .c(new_n48_), .d(new_n61_), .O(new_n120_));
  nor2   g74(.a(new_n120_), .b(new_n47_), .O(z14));
  aoi21  g75(.a(new_n61_), .b(x01), .c(new_n44_), .O(new_n122_));
  nand3  g76(.a(x19), .b(new_n44_), .c(new_n66_), .O(new_n123_));
  oai21  g77(.a(new_n122_), .b(new_n65_), .c(new_n123_), .O(z15));
  zero   g78(.O(z02));
  zero   g79(.O(z05));
  zero   g80(.O(z08));
  zero   g81(.O(z16));
