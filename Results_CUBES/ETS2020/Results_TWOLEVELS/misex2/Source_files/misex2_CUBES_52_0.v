...
module FAU ( 
  ...
  nand2  g60(.a(new_n46_), .b(new_n45_), .O(new_n108_));
  nor3   g61(.a(new_n108_), .b(x19), .c(new_n48_), .O(z13));
  nor2   g62(.a(x10), .b(x09), .O(new_n110_));
  nand4  g63(.a(new_n110_), .b(new_n50_), .c(new_n49_), .d(new_n48_), .O(new_n111_));
  nor2   g64(.a(new_n111_), .b(new_n108_), .O(z14));
  nor2   g65(.a(new_n84_), .b(x00), .O(z16));
  zero   g66(.O(z00));
  zero   g67(.O(z04));
  zero   g68(.O(z09));
  zero   g69(.O(z11));
