// Benchmark "FAU" written by ABC on Tue Jul  7 11:00:53 2020
...
module FAU ( 
  ...
  nand3  g13(.a(new_n57_), .b(new_n56_), .c(new_n45_), .O(new_n58_));
  ...
  oai21  g21(.a(new_n65_), .b(new_n61_), .c(new_n58_), .O(z03));
  ...
  nand4  g33(.a(x19), .b(new_n55_), .c(x17), .d(new_n77_), .O(new_n78_));
  inv1   g34(.a(x05), .O(new_n79_));
  nor2   g35(.a(x07), .b(x06), .O(new_n80_));
  nand3  g36(.a(new_n80_), .b(new_n79_), .c(x04), .O(new_n81_));
  inv1   g37(.a(x03), .O(new_n82_));
  nand3  g38(.a(new_n45_), .b(new_n82_), .c(x02), .O(new_n83_));
  nor3   g39(.a(new_n83_), .b(new_n81_), .c(new_n78_), .O(z08));
  ...
  nand2  g44(.a(x02), .b(new_n63_), .O(new_n89_));
  inv1   g45(.a(new_n89_), .O(new_n90_));
  nor2   g46(.a(new_n68_), .b(x11), .O(new_n91_));
  ...
  nand4  g56(.a(new_n100_), .b(new_n56_), .c(x22), .d(x21), .O(new_n101_));
  inv1   g57(.a(x13), .O(new_n102_));
  nand3  g58(.a(new_n102_), .b(x12), .c(new_n59_), .O(new_n103_));
  ...
  nand2  g69(.a(new_n97_), .b(new_n62_), .O(new_n114_));
  aoi21  g70(.a(new_n113_), .b(new_n110_), .c(new_n114_), .O(z11));
  oai21  g71(.a(new_n52_), .b(new_n44_), .c(new_n64_), .O(new_n116_));
  oai21  g72(.a(x19), .b(x02), .c(x23), .O(new_n117_));
  inv1   g73(.a(x19), .O(new_n118_));
  nand3  g74(.a(new_n118_), .b(x17), .c(new_n44_), .O(new_n119_));
  ...
  aoi21  g79(.a(new_n121_), .b(new_n116_), .c(new_n123_), .O(z12));
  zero   g80(.O(z01));
  zero   g81(.O(z13));
  zero   g82(.O(z14));
  zero   g83(.O(z15));
