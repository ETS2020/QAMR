...
module FAU ( 
  ...
  wire new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_, new_n51_,
    ...
    new_n96_, new_n97_, new_n98_, new_n102_, new_n104_, new_n105_,
    new_n107_, new_n108_;
  ...
  inv1   g23(.a(x15), .O(new_n71_));
  inv1   g24(.a(x16), .O(new_n72_));
  nand3  g25(.a(x20), .b(new_n72_), .c(new_n71_), .O(new_n73_));
  inv1   g26(.a(new_n73_), .O(new_n74_));
  nor2   g27(.a(new_n45_), .b(x01), .O(new_n75_));
  inv1   g28(.a(x11), .O(new_n76_));
  inv1   g29(.a(x13), .O(new_n77_));
  inv1   g30(.a(x14), .O(new_n78_));
  nand4  g31(.a(new_n78_), .b(new_n77_), .c(x12), .d(new_n76_), .O(new_n79_));
  inv1   g32(.a(new_n79_), .O(new_n80_));
  nand3  g33(.a(new_n80_), .b(new_n75_), .c(new_n74_), .O(new_n81_));
  inv1   g34(.a(x01), .O(new_n82_));
  nor2   g35(.a(new_n49_), .b(new_n82_), .O(new_n83_));
  nor2   g36(.a(x20), .b(x19), .O(new_n84_));
  nand2  g37(.a(new_n84_), .b(new_n83_), .O(new_n85_));
  ...
  aoi21  g42(.a(new_n85_), .b(new_n81_), .c(new_n89_), .O(z09));
  nand4  g43(.a(new_n84_), .b(new_n83_), .c(x22), .d(x21), .O(new_n91_));
  nand3  g44(.a(new_n88_), .b(new_n87_), .c(x20), .O(new_n92_));
  inv1   g45(.a(new_n92_), .O(new_n93_));
  nand4  g46(.a(x16), .b(x15), .c(new_n78_), .d(new_n77_), .O(new_n94_));
  inv1   g47(.a(new_n94_), .O(new_n95_));
  nand4  g48(.a(x12), .b(new_n76_), .c(x02), .d(new_n82_), .O(new_n96_));
  ...
  nand3  g58(.a(x19), .b(new_n45_), .c(new_n82_), .O(new_n108_));
  oai21  g59(.a(new_n107_), .b(new_n86_), .c(new_n108_), .O(z15));
  nor2   g60(.a(new_n82_), .b(x00), .O(z16));
  inv1   g61(.a(new_n68_), .O(z17));
  zero   g62(.O(z00));
  zero   g63(.O(z03));
  zero   g64(.O(z06));
  zero   g65(.O(z07));
