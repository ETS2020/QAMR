...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n103_, new_n104_, new_n105_, new_n106_, new_n107_, new_n114_;
  ...
  nand2  g22(.a(x01), .b(x00), .O(new_n67_));
  nor4   g23(.a(new_n67_), .b(new_n55_), .c(new_n45_), .d(new_n44_), .O(z05));
  nand3  g24(.a(new_n62_), .b(new_n45_), .c(x02), .O(new_n69_));
  nor2   g25(.a(new_n69_), .b(new_n67_), .O(z06));
  inv1   g26(.a(x12), .O(new_n71_));
  nand4  g27(.a(new_n62_), .b(new_n71_), .c(new_n45_), .d(x01), .O(new_n72_));
  ...
  nor2   g37(.a(new_n71_), .b(x11), .O(new_n83_));
  ...
  nand4  g48(.a(new_n93_), .b(new_n58_), .c(x22), .d(x21), .O(new_n94_));
  inv1   g49(.a(x13), .O(new_n95_));
  nand3  g50(.a(new_n95_), .b(x12), .c(new_n61_), .O(new_n96_));
  ...
  nor2   g63(.a(new_n56_), .b(new_n47_), .O(z14));
  nor2   g64(.a(new_n80_), .b(x00), .O(z16));
  nand2  g65(.a(new_n46_), .b(x02), .O(new_n114_));
