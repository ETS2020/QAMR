...
module FAU ( 
  ...
  aoi21  g45(.a(new_n87_), .b(new_n83_), .c(new_n91_), .O(z09));
  nand4  g46(.a(new_n86_), .b(new_n85_), .c(x22), .d(x21), .O(new_n93_));
  nand3  g47(.a(new_n90_), .b(new_n89_), .c(x20), .O(new_n94_));
  inv1   g48(.a(new_n94_), .O(new_n95_));
  nand4  g49(.a(x16), .b(x15), .c(new_n80_), .d(new_n79_), .O(new_n96_));
  inv1   g50(.a(new_n96_), .O(new_n97_));
  nand4  g51(.a(x12), .b(new_n78_), .c(x02), .d(new_n84_), .O(new_n98_));
  inv1   g52(.a(new_n98_), .O(new_n99_));
  nand3  g53(.a(new_n99_), .b(new_n97_), .c(new_n95_), .O(new_n100_));
  aoi21  g54(.a(new_n100_), .b(new_n93_), .c(x00), .O(z10));
  nand2  g55(.a(x10), .b(x02), .O(new_n103_));
  nand3  g56(.a(new_n103_), .b(x01), .c(x00), .O(new_n104_));
  ...
  aoi21  g64(.a(new_n57_), .b(x01), .c(new_n44_), .O(new_n114_));
  nand3  g65(.a(x19), .b(new_n44_), .c(new_n84_), .O(new_n115_));
  oai21  g66(.a(new_n114_), .b(new_n88_), .c(new_n115_), .O(z15));
  nor2   g67(.a(new_n84_), .b(x00), .O(z16));
  inv1   g68(.a(new_n70_), .O(z17));
  zero   g69(.O(z03));
  zero   g70(.O(z06));
  zero   g71(.O(z07));
  zero   g72(.O(z11));
