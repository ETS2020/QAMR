...
module FAU ( 
  ...
  nand2  g38(.a(new_n46_), .b(new_n45_), .O(new_n90_));
  nor3   g39(.a(new_n90_), .b(x19), .c(new_n48_), .O(z13));
  nor2   g40(.a(x10), .b(x09), .O(new_n92_));
  nand4  g41(.a(new_n92_), .b(new_n50_), .c(new_n49_), .d(new_n48_), .O(new_n93_));
  nor2   g42(.a(new_n93_), .b(new_n90_), .O(z14));
  aoi21  g43(.a(new_n53_), .b(x01), .c(new_n45_), .O(new_n95_));
  nand3  g44(.a(x19), .b(new_n45_), .c(new_n59_), .O(new_n96_));
  oai21  g45(.a(new_n95_), .b(new_n58_), .c(new_n96_), .O(z15));
  nor2   g46(.a(new_n59_), .b(x00), .O(z16));
