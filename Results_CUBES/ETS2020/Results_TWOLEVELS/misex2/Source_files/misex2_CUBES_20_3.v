// Benchmark "FAU" written by ABC on Tue Jul  7 11:00:19 2020
...
module FAU ( 
  ...
  nor2   g46(.a(new_n69_), .b(x11), .O(new_n91_));
  ...
  oai21  g71(.a(new_n53_), .b(new_n45_), .c(new_n65_), .O(new_n116_));
  oai21  g72(.a(x19), .b(x02), .c(x23), .O(new_n117_));
  nand3  g73(.a(new_n50_), .b(x17), .c(new_n45_), .O(new_n118_));
  ...
  nand2  g79(.a(new_n46_), .b(new_n45_), .O(new_n124_));
  nor3   g80(.a(new_n124_), .b(x19), .c(new_n48_), .O(z13));
  nor2   g81(.a(x10), .b(x09), .O(new_n126_));
  nand4  g82(.a(new_n126_), .b(new_n50_), .c(new_n49_), .d(new_n48_), .O(new_n127_));
  nor2   g83(.a(new_n127_), .b(new_n124_), .O(z14));
  aoi21  g84(.a(new_n53_), .b(x01), .c(new_n45_), .O(new_n129_));
  nand3  g85(.a(x19), .b(new_n45_), .c(new_n64_), .O(new_n130_));
  oai21  g86(.a(new_n129_), .b(new_n63_), .c(new_n130_), .O(z15));
  nor2   g87(.a(new_n64_), .b(x00), .O(z16));
  inv1   g88(.a(new_n82_), .O(z17));
  zero   g89(.O(z00));
endmodule
