...
module FAU ( 
  ...
  oai21  g67(.a(new_n52_), .b(new_n44_), .c(new_n64_), .O(new_n113_));
  oai21  g68(.a(x19), .b(x02), .c(x23), .O(new_n114_));
  nand3  g69(.a(new_n95_), .b(x17), .c(new_n44_), .O(new_n115_));
  nand2  g70(.a(new_n115_), .b(new_n114_), .O(new_n116_));
  nand2  g71(.a(new_n116_), .b(new_n45_), .O(new_n117_));
