...
module FAU ( 
  ...
  nand2  g42(.a(x02), .b(new_n64_), .O(new_n88_));
  inv1   g43(.a(new_n88_), .O(new_n89_));
  nor2   g44(.a(new_n68_), .b(x11), .O(new_n90_));
  ...
  nor2   g53(.a(x20), .b(new_n64_), .O(new_n99_));
  nand4  g54(.a(new_n99_), .b(new_n56_), .c(x22), .d(x21), .O(new_n100_));
  inv1   g55(.a(x13), .O(new_n101_));
  nand3  g56(.a(new_n101_), .b(x12), .c(new_n59_), .O(new_n102_));
  ...
  nand2  g67(.a(new_n96_), .b(new_n63_), .O(new_n113_));
  aoi21  g68(.a(new_n112_), .b(new_n109_), .c(new_n113_), .O(z11));
  oai21  g69(.a(new_n53_), .b(new_n45_), .c(new_n65_), .O(new_n115_));
  oai21  g70(.a(x19), .b(x02), .c(x23), .O(new_n116_));
  nand3  g71(.a(new_n50_), .b(x17), .c(new_n45_), .O(new_n117_));
  ...
  nand2  g77(.a(new_n46_), .b(new_n45_), .O(new_n123_));
  nor3   g78(.a(new_n123_), .b(x19), .c(new_n48_), .O(z13));
  nor2   g79(.a(x10), .b(x09), .O(new_n125_));
  nand4  g80(.a(new_n125_), .b(new_n50_), .c(new_n49_), .d(new_n48_), .O(new_n126_));
  nor2   g81(.a(new_n126_), .b(new_n123_), .O(z14));
  inv1   g82(.a(new_n81_), .O(z17));
  zero   g83(.O(z00));
  zero   g84(.O(z05));
  zero   g85(.O(z15));
  zero   g86(.O(z16));
