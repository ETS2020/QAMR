...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n52_,
    ...
    new_n104_, new_n105_, new_n106_, new_n112_;
  ...
  nand4  g37(.a(new_n83_), .b(new_n82_), .c(x12), .d(new_n59_), .O(new_n84_));
  ...
  nand2  g50(.a(new_n90_), .b(new_n62_), .O(new_n98_));
  ...
  nand3  g54(.a(new_n57_), .b(x17), .c(new_n44_), .O(new_n102_));
  ...
  nor3   g60(.a(new_n46_), .b(x19), .c(new_n56_), .O(z13));
  nor2   g61(.a(new_n63_), .b(x00), .O(z16));
  nand2  g62(.a(new_n45_), .b(x02), .O(new_n112_));
