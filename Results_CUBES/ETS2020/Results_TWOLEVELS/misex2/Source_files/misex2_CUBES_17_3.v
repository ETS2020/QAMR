...
module FAU ( 
  ...
  nor2   g15(.a(x19), .b(new_n48_), .O(new_n59_));
  inv1   g16(.a(new_n59_), .O(new_n60_));
  nand3  g17(.a(new_n45_), .b(new_n47_), .c(new_n44_), .O(new_n61_));
  ...
  nand2  g22(.a(new_n65_), .b(new_n51_), .O(new_n66_));
  oai22  g23(.a(new_n66_), .b(new_n62_), .c(new_n61_), .d(new_n60_), .O(z03));
  ...
  nor2   g30(.a(new_n73_), .b(new_n68_), .O(z05));
  nand3  g31(.a(new_n51_), .b(new_n70_), .c(x11), .O(new_n76_));
  ...
  nand2  g38(.a(new_n45_), .b(x02), .O(new_n83_));
  ...
  nand4  g57(.a(new_n101_), .b(new_n59_), .c(x22), .d(x21), .O(new_n102_));
  inv1   g58(.a(x13), .O(new_n103_));
  nand3  g59(.a(new_n103_), .b(x12), .c(new_n69_), .O(new_n104_));
  ...
  oai21  g72(.a(new_n50_), .b(new_n44_), .c(new_n65_), .O(new_n117_));
  oai21  g73(.a(x19), .b(x02), .c(x23), .O(new_n118_));
  nand3  g74(.a(new_n49_), .b(x17), .c(new_n44_), .O(new_n119_));
  ...
  aoi21  g80(.a(new_n50_), .b(x01), .c(new_n44_), .O(new_n127_));
  nand3  g81(.a(x19), .b(new_n44_), .c(new_n64_), .O(new_n128_));
