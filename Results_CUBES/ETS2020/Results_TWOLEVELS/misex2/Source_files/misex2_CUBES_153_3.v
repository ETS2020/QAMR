...
module FAU ( 
  ...
  nand4  g49(.a(new_n92_), .b(new_n91_), .c(x12), .d(new_n61_), .O(new_n93_));
  ...
  nand4  g59(.a(new_n102_), .b(new_n58_), .c(new_n96_), .d(x01), .O(new_n103_));
  nand3  g60(.a(new_n99_), .b(new_n98_), .c(x20), .O(new_n104_));
  inv1   g61(.a(new_n104_), .O(new_n105_));
  nand4  g62(.a(x16), .b(x15), .c(new_n92_), .d(new_n91_), .O(new_n106_));
  inv1   g63(.a(new_n106_), .O(new_n107_));
  nand4  g64(.a(x12), .b(new_n61_), .c(x02), .d(new_n65_), .O(new_n108_));
  ...
  oai21  g68(.a(new_n55_), .b(new_n44_), .c(new_n66_), .O(new_n113_));
  oai21  g69(.a(x19), .b(x02), .c(x23), .O(new_n114_));
  nand3  g70(.a(new_n50_), .b(x17), .c(new_n44_), .O(new_n115_));
  nand2  g71(.a(new_n115_), .b(new_n114_), .O(new_n116_));
  nand2  g72(.a(new_n116_), .b(new_n46_), .O(new_n117_));
  inv1   g73(.a(x24), .O(new_n118_));
  nand2  g74(.a(new_n118_), .b(x09), .O(new_n119_));
  aoi21  g75(.a(new_n117_), .b(new_n113_), .c(new_n119_), .O(z12));
  nor2   g76(.a(new_n56_), .b(new_n47_), .O(z14));
  aoi21  g77(.a(new_n55_), .b(x01), .c(new_n44_), .O(new_n123_));
  nand3  g78(.a(x19), .b(new_n44_), .c(new_n65_), .O(new_n124_));
  oai21  g79(.a(new_n123_), .b(new_n64_), .c(new_n124_), .O(z15));
