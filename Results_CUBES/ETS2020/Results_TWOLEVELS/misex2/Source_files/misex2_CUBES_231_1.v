...
module FAU ( 
  ...
  oai22  g21(.a(new_n65_), .b(new_n64_), .c(new_n60_), .d(new_n59_), .O(z03));
  nand2  g22(.a(x01), .b(x00), .O(new_n68_));
  nor4   g23(.a(new_n68_), .b(new_n61_), .c(new_n45_), .d(new_n44_), .O(z05));
  nand3  g24(.a(new_n63_), .b(new_n45_), .c(x02), .O(new_n70_));
  nor2   g25(.a(new_n70_), .b(new_n68_), .O(z06));
  inv1   g26(.a(x12), .O(new_n72_));
  nand4  g27(.a(new_n63_), .b(new_n72_), .c(new_n45_), .d(x01), .O(new_n73_));
  ...
  nand2  g42(.a(x02), .b(new_n87_), .O(new_n88_));
  inv1   g43(.a(new_n88_), .O(new_n89_));
  nor2   g44(.a(new_n72_), .b(x11), .O(new_n90_));
  nor2   g45(.a(x14), .b(x13), .O(new_n91_));
  nand4  g46(.a(new_n91_), .b(new_n90_), .c(new_n89_), .d(new_n86_), .O(new_n92_));
  nor2   g47(.a(x20), .b(x19), .O(new_n93_));
  nand3  g48(.a(new_n93_), .b(x18), .c(x01), .O(new_n94_));
  inv1   g49(.a(x00), .O(new_n95_));
  inv1   g50(.a(x21), .O(new_n96_));
  inv1   g51(.a(x22), .O(new_n97_));
  nand3  g52(.a(new_n97_), .b(new_n96_), .c(new_n95_), .O(new_n98_));
  aoi21  g53(.a(new_n94_), .b(new_n92_), .c(new_n98_), .O(z09));
  nor2   g54(.a(x20), .b(new_n87_), .O(new_n100_));
  nand4  g55(.a(new_n100_), .b(new_n58_), .c(x22), .d(x21), .O(new_n101_));
  inv1   g56(.a(x13), .O(new_n102_));
  nand3  g57(.a(new_n102_), .b(x12), .c(new_n62_), .O(new_n103_));
  nor2   g58(.a(new_n103_), .b(new_n88_), .O(new_n104_));
  nor2   g59(.a(new_n83_), .b(x14), .O(new_n105_));
  nand4  g60(.a(new_n97_), .b(new_n96_), .c(x20), .d(x16), .O(new_n106_));
  ...
  nand3  g65(.a(new_n96_), .b(x20), .c(new_n84_), .O(new_n111_));
  inv1   g66(.a(new_n111_), .O(new_n112_));
  nand3  g67(.a(new_n112_), .b(new_n105_), .c(new_n104_), .O(new_n113_));
  nand2  g68(.a(new_n97_), .b(new_n95_), .O(new_n114_));
  aoi21  g69(.a(new_n113_), .b(new_n110_), .c(new_n114_), .O(z11));
  nor3   g70(.a(new_n53_), .b(x19), .c(new_n48_), .O(z13));
  nand4  g71(.a(new_n50_), .b(new_n49_), .c(new_n48_), .d(new_n61_), .O(new_n118_));
  nor2   g72(.a(new_n118_), .b(new_n47_), .O(z14));
  aoi21  g73(.a(new_n61_), .b(x01), .c(new_n44_), .O(new_n120_));
  nand3  g74(.a(x19), .b(new_n44_), .c(new_n87_), .O(new_n121_));
  oai21  g75(.a(new_n120_), .b(new_n95_), .c(new_n121_), .O(z15));
  nor2   g76(.a(new_n87_), .b(x00), .O(z16));
  inv1   g77(.a(new_n80_), .O(z17));
  zero   g78(.O(z02));
  zero   g79(.O(z04));
  zero   g80(.O(z12));
endmodule
