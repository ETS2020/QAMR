...
module FAU ( 
  ...
  nand4  g55(.a(new_n98_), .b(new_n49_), .c(x18), .d(x01), .O(new_n99_));
  inv1   g56(.a(x21), .O(new_n100_));
  inv1   g57(.a(x22), .O(new_n101_));
  nand3  g58(.a(new_n101_), .b(new_n100_), .c(new_n65_), .O(new_n102_));
  aoi21  g59(.a(new_n99_), .b(new_n97_), .c(new_n102_), .O(z09));
  nor2   g60(.a(new_n101_), .b(new_n100_), .O(new_n104_));
  nand4  g61(.a(new_n104_), .b(new_n57_), .c(new_n98_), .d(x01), .O(new_n105_));
  nand3  g62(.a(new_n101_), .b(new_n100_), .c(x20), .O(new_n106_));
  inv1   g63(.a(new_n106_), .O(new_n107_));
  nand4  g64(.a(x16), .b(x15), .c(new_n94_), .d(new_n93_), .O(new_n108_));
  inv1   g65(.a(new_n108_), .O(new_n109_));
  nand4  g66(.a(x12), .b(new_n62_), .c(x02), .d(new_n66_), .O(new_n110_));
  inv1   g67(.a(new_n110_), .O(new_n111_));
  nand3  g68(.a(new_n111_), .b(new_n109_), .c(new_n107_), .O(new_n112_));
  aoi21  g69(.a(new_n112_), .b(new_n105_), .c(x00), .O(z10));
  oai21  g70(.a(new_n54_), .b(new_n59_), .c(new_n67_), .O(new_n115_));
