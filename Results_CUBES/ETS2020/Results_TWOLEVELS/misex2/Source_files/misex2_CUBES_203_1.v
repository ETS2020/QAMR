...
module FAU ( 
  ...
  nand4  g45(.a(new_n90_), .b(new_n89_), .c(x12), .d(new_n61_), .O(new_n91_));
  ...
  nand3  g52(.a(new_n97_), .b(new_n96_), .c(new_n70_), .O(new_n98_));
  ...
  nand2  g58(.a(new_n97_), .b(new_n70_), .O(new_n105_));
  aoi21  g59(.a(new_n104_), .b(new_n101_), .c(new_n105_), .O(z11));
  nor3   g60(.a(new_n54_), .b(x19), .c(new_n48_), .O(z13));
  nand4  g61(.a(new_n50_), .b(new_n49_), .c(new_n48_), .d(new_n55_), .O(new_n109_));
  nor2   g62(.a(new_n109_), .b(new_n47_), .O(z14));
  nor2   g63(.a(new_n71_), .b(x00), .O(z16));
