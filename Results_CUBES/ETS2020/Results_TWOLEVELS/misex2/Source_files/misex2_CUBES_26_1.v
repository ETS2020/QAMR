...
module FAU ( 
  ...
  nor2   g44(.a(new_n59_), .b(x01), .O(new_n90_));
  ...
  nand4  g51(.a(new_n96_), .b(new_n49_), .c(x18), .d(x01), .O(new_n97_));
  ...
  nand4  g57(.a(new_n102_), .b(new_n57_), .c(new_n96_), .d(x01), .O(new_n103_));
  ...
  oai21  g66(.a(new_n54_), .b(new_n59_), .c(new_n67_), .O(new_n113_));
  oai21  g67(.a(x19), .b(x02), .c(x23), .O(new_n114_));
  nand3  g68(.a(new_n49_), .b(x17), .c(new_n59_), .O(new_n115_));
  nand2  g69(.a(new_n115_), .b(new_n114_), .O(new_n116_));
  nand2  g70(.a(new_n116_), .b(new_n60_), .O(new_n117_));
  inv1   g71(.a(x24), .O(new_n118_));
  nand2  g72(.a(new_n118_), .b(x09), .O(new_n119_));
  aoi21  g73(.a(new_n117_), .b(new_n113_), .c(new_n119_), .O(z12));
  nor2   g74(.a(x19), .b(new_n47_), .O(new_n121_));
  and2   g75(.a(new_n121_), .b(new_n45_), .O(z13));
  nor2   g76(.a(new_n55_), .b(new_n46_), .O(z14));
  aoi21  g77(.a(new_n54_), .b(x01), .c(new_n59_), .O(new_n124_));
  nand3  g78(.a(x19), .b(new_n59_), .c(new_n66_), .O(new_n125_));
