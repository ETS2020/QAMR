...
module FAU ( 
  ...
  nand4  g30(.a(x19), .b(new_n49_), .c(x17), .d(new_n75_), .O(new_n76_));
  inv1   g31(.a(x05), .O(new_n77_));
  nor2   g32(.a(x07), .b(x06), .O(new_n78_));
  nand3  g33(.a(new_n78_), .b(new_n77_), .c(x04), .O(new_n79_));
  inv1   g34(.a(x03), .O(new_n80_));
  nand3  g35(.a(new_n46_), .b(new_n80_), .c(x02), .O(new_n81_));
  nor3   g36(.a(new_n81_), .b(new_n79_), .c(new_n76_), .O(z08));
  ...
  oai21  g70(.a(new_n53_), .b(new_n45_), .c(new_n64_), .O(new_n116_));
  ...
  aoi21  g78(.a(new_n53_), .b(x01), .c(new_n45_), .O(new_n126_));
  nand3  g79(.a(x19), .b(new_n45_), .c(new_n87_), .O(new_n127_));
  oai21  g80(.a(new_n126_), .b(new_n95_), .c(new_n127_), .O(z15));
  zero   g81(.O(z00));
  zero   g82(.O(z04));
  zero   g83(.O(z13));
  zero   g84(.O(z14));
