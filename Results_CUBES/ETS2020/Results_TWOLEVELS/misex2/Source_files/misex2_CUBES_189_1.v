...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n69_, new_n70_, new_n71_, new_n72_, new_n76_, new_n77_, new_n81_,
  ...
  nor2   g34(.a(x20), .b(new_n65_), .O(new_n81_));
  nand4  g35(.a(new_n81_), .b(new_n57_), .c(x22), .d(x21), .O(new_n82_));
  nand2  g36(.a(x02), .b(new_n65_), .O(new_n83_));
  inv1   g37(.a(x13), .O(new_n84_));
  nand3  g38(.a(new_n84_), .b(x12), .c(new_n70_), .O(new_n85_));
  ...
  nand3  g48(.a(new_n81_), .b(new_n57_), .c(x21), .O(new_n95_));
  ...
  nand2  g53(.a(new_n90_), .b(new_n64_), .O(new_n100_));
  aoi21  g54(.a(new_n99_), .b(new_n95_), .c(new_n100_), .O(z11));
  oai21  g55(.a(new_n54_), .b(new_n59_), .c(new_n66_), .O(new_n102_));
  ...
  nand3  g67(.a(x19), .b(new_n59_), .c(new_n65_), .O(new_n114_));
  oai21  g68(.a(new_n113_), .b(new_n64_), .c(new_n114_), .O(z15));
  nand2  g69(.a(new_n60_), .b(x02), .O(new_n117_));
