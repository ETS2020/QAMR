...
module FAU ( 
  ...
  nand2  g73(.a(new_n46_), .b(new_n45_), .O(new_n121_));
  nor2   g74(.a(x10), .b(x09), .O(new_n122_));
  nand4  g75(.a(new_n122_), .b(new_n50_), .c(new_n49_), .d(new_n48_), .O(new_n123_));
  nor2   g76(.a(new_n123_), .b(new_n121_), .O(z14));
  zero   g77(.O(z00));
  zero   g78(.O(z05));
  zero   g79(.O(z11));
  zero   g80(.O(z13));
