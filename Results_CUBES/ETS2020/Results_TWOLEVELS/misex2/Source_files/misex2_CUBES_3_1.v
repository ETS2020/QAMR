...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n116_, new_n117_, new_n118_, new_n121_, new_n125_;
  ...
  nand4  g75(.a(new_n50_), .b(new_n49_), .c(new_n48_), .d(new_n61_), .O(new_n121_));
  nor2   g76(.a(new_n121_), .b(new_n47_), .O(z14));
  nor2   g77(.a(new_n66_), .b(x00), .O(z16));
  nand2  g78(.a(new_n46_), .b(x02), .O(new_n125_));
