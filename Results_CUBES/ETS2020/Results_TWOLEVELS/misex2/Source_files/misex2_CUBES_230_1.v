...
module FAU ( 
  ...
  nand4  g42(.a(new_n87_), .b(new_n86_), .c(x12), .d(new_n62_), .O(new_n88_));
  inv1   g43(.a(new_n88_), .O(new_n89_));
  nand3  g44(.a(new_n89_), .b(new_n85_), .c(new_n84_), .O(new_n90_));
  inv1   g45(.a(x20), .O(new_n91_));
  nand4  g46(.a(new_n91_), .b(new_n50_), .c(x18), .d(x01), .O(new_n92_));
  inv1   g47(.a(x21), .O(new_n93_));
  inv1   g48(.a(x22), .O(new_n94_));
  nand3  g49(.a(new_n94_), .b(new_n93_), .c(new_n65_), .O(new_n95_));
  aoi21  g50(.a(new_n92_), .b(new_n90_), .c(new_n95_), .O(z09));
  nor2   g51(.a(new_n94_), .b(new_n93_), .O(new_n97_));
  nand4  g52(.a(new_n97_), .b(new_n59_), .c(new_n91_), .d(x01), .O(new_n98_));
  nand3  g53(.a(new_n94_), .b(new_n93_), .c(x20), .O(new_n99_));
  inv1   g54(.a(new_n99_), .O(new_n100_));
  nand4  g55(.a(x16), .b(x15), .c(new_n87_), .d(new_n86_), .O(new_n101_));
  inv1   g56(.a(new_n101_), .O(new_n102_));
  nand4  g57(.a(x12), .b(new_n62_), .c(x02), .d(new_n66_), .O(new_n103_));
  inv1   g58(.a(new_n103_), .O(new_n104_));
  nand3  g59(.a(new_n104_), .b(new_n102_), .c(new_n100_), .O(new_n105_));
  ...
  nand2  g72(.a(new_n46_), .b(x02), .O(new_n121_));
