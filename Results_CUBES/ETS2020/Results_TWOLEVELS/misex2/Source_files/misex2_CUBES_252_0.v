...
module FAU ( 
  ...
  nand3  g57(.a(new_n102_), .b(x12), .c(new_n60_), .O(new_n103_));
  ...
  oai21  g70(.a(new_n59_), .b(new_n44_), .c(new_n65_), .O(new_n116_));
  oai21  g71(.a(x19), .b(x02), .c(x23), .O(new_n117_));
  inv1   g72(.a(x19), .O(new_n118_));
  nand3  g73(.a(new_n118_), .b(x17), .c(new_n44_), .O(new_n119_));
  nand2  g74(.a(new_n119_), .b(new_n117_), .O(new_n120_));
  nand2  g75(.a(new_n120_), .b(new_n45_), .O(new_n121_));
  inv1   g76(.a(x24), .O(new_n122_));
  nand2  g77(.a(new_n122_), .b(x09), .O(new_n123_));
  aoi21  g78(.a(new_n121_), .b(new_n116_), .c(new_n123_), .O(z12));
  nor3   g79(.a(new_n46_), .b(x19), .c(new_n57_), .O(z13));
  zero   g80(.O(z02));
  zero   g81(.O(z05));
  zero   g82(.O(z14));
  zero   g83(.O(z15));
