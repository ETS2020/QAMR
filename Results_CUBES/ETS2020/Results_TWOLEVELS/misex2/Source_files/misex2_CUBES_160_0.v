...
module FAU ( 
  ...
  nand4  g53(.a(new_n99_), .b(new_n98_), .c(new_n48_), .d(x18), .O(new_n100_));
  ...
  oai21  g68(.a(new_n56_), .b(new_n45_), .c(new_n63_), .O(new_n115_));
  oai21  g69(.a(x19), .b(x02), .c(x23), .O(new_n116_));
  nand3  g70(.a(new_n48_), .b(x17), .c(new_n45_), .O(new_n117_));
  ...
  nor3   g76(.a(new_n47_), .b(x19), .c(new_n54_), .O(z13));
