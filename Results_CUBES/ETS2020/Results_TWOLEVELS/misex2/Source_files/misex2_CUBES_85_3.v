...
module FAU ( 
  ...
  oai22  g24(.a(new_n67_), .b(new_n64_), .c(new_n61_), .d(new_n47_), .O(z03));
  nor4   g25(.a(new_n65_), .b(new_n57_), .c(new_n44_), .d(new_n60_), .O(z05));
  ...
  nor2   g44(.a(new_n60_), .b(x01), .O(new_n89_));
  ...
  nand3  g54(.a(new_n98_), .b(new_n97_), .c(new_n45_), .O(new_n99_));
  ...
  nand2  g60(.a(new_n98_), .b(new_n45_), .O(new_n106_));
  aoi21  g61(.a(new_n105_), .b(new_n102_), .c(new_n106_), .O(z11));
  oai21  g62(.a(new_n57_), .b(new_n60_), .c(new_n66_), .O(new_n108_));
  oai21  g63(.a(x19), .b(x02), .c(x23), .O(new_n109_));
  nand3  g64(.a(new_n52_), .b(x17), .c(new_n60_), .O(new_n110_));
  nand2  g65(.a(new_n110_), .b(new_n109_), .O(new_n111_));
  nand2  g66(.a(new_n111_), .b(new_n81_), .O(new_n112_));
  inv1   g67(.a(x24), .O(new_n113_));
  nand2  g68(.a(new_n113_), .b(x09), .O(new_n114_));
  aoi21  g69(.a(new_n112_), .b(new_n108_), .c(new_n114_), .O(z12));
  nor4   g70(.a(new_n47_), .b(x19), .c(new_n50_), .d(x02), .O(z13));
  nor2   g71(.a(new_n58_), .b(new_n49_), .O(z14));
  aoi21  g72(.a(new_n57_), .b(x01), .c(new_n60_), .O(new_n118_));
  nand3  g73(.a(x19), .b(new_n60_), .c(new_n46_), .O(new_n119_));
  oai21  g74(.a(new_n118_), .b(new_n45_), .c(new_n119_), .O(z15));
