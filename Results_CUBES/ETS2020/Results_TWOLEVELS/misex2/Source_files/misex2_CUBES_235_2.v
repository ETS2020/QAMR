...
module FAU ( 
  ...
  nand2  g48(.a(new_n89_), .b(new_n57_), .O(new_n97_));
  aoi21  g49(.a(new_n96_), .b(new_n93_), .c(new_n97_), .O(z11));
  oai21  g50(.a(new_n53_), .b(new_n45_), .c(new_n59_), .O(new_n99_));
  oai21  g51(.a(x19), .b(x02), .c(x23), .O(new_n100_));
  nand3  g52(.a(new_n50_), .b(x17), .c(new_n45_), .O(new_n101_));
  ...
  nand2  g58(.a(new_n46_), .b(new_n45_), .O(new_n108_));
  nor2   g59(.a(x10), .b(x09), .O(new_n109_));
  nand4  g60(.a(new_n109_), .b(new_n50_), .c(new_n49_), .d(new_n48_), .O(new_n110_));
  nor2   g61(.a(new_n110_), .b(new_n108_), .O(z14));
  aoi21  g62(.a(new_n53_), .b(x01), .c(new_n45_), .O(new_n112_));
  nand3  g63(.a(x19), .b(new_n45_), .c(new_n58_), .O(new_n113_));
  oai21  g64(.a(new_n112_), .b(new_n57_), .c(new_n113_), .O(z15));
  nor2   g65(.a(new_n58_), .b(x00), .O(z16));
  inv1   g66(.a(new_n73_), .O(z17));
  zero   g67(.O(z00));
  zero   g68(.O(z03));
  zero   g69(.O(z06));
  zero   g70(.O(z07));
