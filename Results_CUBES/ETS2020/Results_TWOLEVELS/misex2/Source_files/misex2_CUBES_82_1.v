...
module FAU ( 
  ...
  nand2  g43(.a(x02), .b(new_n88_), .O(new_n89_));
  inv1   g44(.a(new_n89_), .O(new_n90_));
  nor2   g45(.a(new_n73_), .b(x11), .O(new_n91_));
  nor2   g46(.a(x14), .b(x13), .O(new_n92_));
  nand4  g47(.a(new_n92_), .b(new_n91_), .c(new_n90_), .d(new_n87_), .O(new_n93_));
  ...
  nor2   g55(.a(x20), .b(new_n88_), .O(new_n101_));
  nand4  g56(.a(new_n101_), .b(new_n59_), .c(x22), .d(x21), .O(new_n102_));
  inv1   g57(.a(x13), .O(new_n103_));
  nand3  g58(.a(new_n103_), .b(x12), .c(new_n62_), .O(new_n104_));
  nor2   g59(.a(new_n104_), .b(new_n89_), .O(new_n105_));
  ...
  nand4  g65(.a(new_n94_), .b(x21), .c(x18), .d(x01), .O(new_n111_));
  nand3  g66(.a(new_n97_), .b(x20), .c(new_n85_), .O(new_n112_));
  inv1   g67(.a(new_n112_), .O(new_n113_));
  nand3  g68(.a(new_n113_), .b(new_n106_), .c(new_n105_), .O(new_n114_));
  nand2  g69(.a(new_n98_), .b(new_n96_), .O(new_n115_));
  aoi21  g70(.a(new_n114_), .b(new_n111_), .c(new_n115_), .O(z11));
  oai21  g71(.a(new_n55_), .b(new_n44_), .c(new_n66_), .O(new_n117_));
  ...
  nor3   g79(.a(new_n54_), .b(x19), .c(new_n48_), .O(z13));
  nand4  g80(.a(new_n50_), .b(new_n49_), .c(new_n48_), .d(new_n55_), .O(new_n126_));
  nor2   g81(.a(new_n126_), .b(new_n47_), .O(z14));
  aoi21  g82(.a(new_n55_), .b(x01), .c(new_n44_), .O(new_n128_));
  nand3  g83(.a(x19), .b(new_n44_), .c(new_n88_), .O(new_n129_));
  oai21  g84(.a(new_n128_), .b(new_n96_), .c(new_n129_), .O(z15));
  nor2   g85(.a(new_n88_), .b(x00), .O(z16));
