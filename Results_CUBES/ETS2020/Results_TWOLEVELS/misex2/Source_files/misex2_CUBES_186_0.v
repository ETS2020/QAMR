...
module FAU ( 
  ...
  nand4  g48(.a(new_n92_), .b(new_n91_), .c(x12), .d(new_n59_), .O(new_n93_));
  inv1   g49(.a(new_n93_), .O(new_n94_));
  nand3  g50(.a(new_n94_), .b(new_n90_), .c(new_n89_), .O(new_n95_));
  inv1   g51(.a(x20), .O(new_n96_));
  nand4  g52(.a(new_n96_), .b(new_n50_), .c(x18), .d(x01), .O(new_n97_));
  ...
  nor2   g57(.a(new_n99_), .b(new_n98_), .O(new_n102_));
  nand4  g58(.a(new_n102_), .b(new_n56_), .c(new_n96_), .d(x01), .O(new_n103_));
  nand3  g59(.a(new_n99_), .b(new_n98_), .c(x20), .O(new_n104_));
  inv1   g60(.a(new_n104_), .O(new_n105_));
  nand4  g61(.a(x16), .b(x15), .c(new_n92_), .d(new_n91_), .O(new_n106_));
  inv1   g62(.a(new_n106_), .O(new_n107_));
  nand4  g63(.a(x12), .b(new_n59_), .c(x02), .d(new_n64_), .O(new_n108_));
  ...
  oai21  g67(.a(new_n53_), .b(new_n45_), .c(new_n65_), .O(new_n113_));
  oai21  g68(.a(x19), .b(x02), .c(x23), .O(new_n114_));
  nand3  g69(.a(new_n50_), .b(x17), .c(new_n45_), .O(new_n115_));
  nand2  g70(.a(new_n115_), .b(new_n114_), .O(new_n116_));
  nand2  g71(.a(new_n116_), .b(new_n46_), .O(new_n117_));
  inv1   g72(.a(x24), .O(new_n118_));
  nand2  g73(.a(new_n118_), .b(x09), .O(new_n119_));
  aoi21  g74(.a(new_n117_), .b(new_n113_), .c(new_n119_), .O(z12));
  nand2  g75(.a(new_n46_), .b(new_n45_), .O(new_n121_));
  nor3   g76(.a(new_n121_), .b(x19), .c(new_n48_), .O(z13));
  nor2   g77(.a(x10), .b(x09), .O(new_n123_));
  nand4  g78(.a(new_n123_), .b(new_n50_), .c(new_n49_), .d(new_n48_), .O(new_n124_));
  nor2   g79(.a(new_n124_), .b(new_n121_), .O(z14));
  nor2   g80(.a(new_n64_), .b(x00), .O(z16));
  zero   g81(.O(z00));
  zero   g82(.O(z11));
  zero   g83(.O(z15));
  zero   g84(.O(z17));
