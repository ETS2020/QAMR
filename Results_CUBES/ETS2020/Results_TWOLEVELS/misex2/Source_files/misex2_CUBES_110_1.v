...
module FAU ( 
  ...
  nor2   g54(.a(x10), .b(x09), .O(new_n103_));
  nand4  g55(.a(new_n103_), .b(new_n50_), .c(new_n49_), .d(new_n48_), .O(new_n104_));
  nor3   g56(.a(new_n104_), .b(new_n56_), .c(x02), .O(z14));
  aoi21  g57(.a(new_n53_), .b(x01), .c(new_n45_), .O(new_n106_));
  nand3  g58(.a(x19), .b(new_n45_), .c(new_n63_), .O(new_n107_));
  oai21  g59(.a(new_n106_), .b(new_n62_), .c(new_n107_), .O(z15));
  nor2   g60(.a(new_n63_), .b(x00), .O(z16));
  nand2  g61(.a(new_n46_), .b(x02), .O(new_n110_));
