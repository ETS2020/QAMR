...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n97_, new_n98_, new_n101_, new_n103_, new_n107_;
  ...
  nand3  g45(.a(new_n79_), .b(new_n55_), .c(x21), .O(new_n93_));
  ...
  nand2  g52(.a(new_n46_), .b(new_n44_), .O(new_n101_));
  nor3   g53(.a(new_n101_), .b(x19), .c(new_n48_), .O(z13));
  nand4  g54(.a(new_n50_), .b(new_n49_), .c(new_n48_), .d(new_n58_), .O(new_n103_));
  nor2   g55(.a(new_n103_), .b(new_n47_), .O(z14));
  nor2   g56(.a(new_n63_), .b(x00), .O(z16));
  nand2  g57(.a(new_n46_), .b(x02), .O(new_n107_));
  inv1   g58(.a(new_n107_), .O(z17));
  zero   g59(.O(z01));
  zero   g60(.O(z02));
  zero   g61(.O(z08));
  zero   g62(.O(z09));
