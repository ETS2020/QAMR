...
module FAU ( 
  ...
  nor2   g39(.a(x20), .b(new_n64_), .O(new_n86_));
  nand4  g40(.a(new_n86_), .b(new_n56_), .c(x22), .d(x21), .O(new_n87_));
  nand2  g41(.a(x02), .b(new_n64_), .O(new_n88_));
  inv1   g42(.a(x13), .O(new_n89_));
  nand3  g43(.a(new_n89_), .b(x12), .c(new_n59_), .O(new_n90_));
  ...
  nand3  g53(.a(new_n86_), .b(new_n56_), .c(x21), .O(new_n100_));
  ...
  nand2  g58(.a(new_n95_), .b(new_n63_), .O(new_n105_));
  aoi21  g59(.a(new_n104_), .b(new_n100_), .c(new_n105_), .O(z11));
  oai21  g60(.a(new_n53_), .b(new_n45_), .c(new_n65_), .O(new_n107_));
  oai21  g61(.a(x19), .b(x02), .c(x23), .O(new_n108_));
  nand3  g62(.a(new_n50_), .b(x17), .c(new_n45_), .O(new_n109_));
  ...
  nand2  g68(.a(new_n46_), .b(new_n45_), .O(new_n116_));
  nor2   g69(.a(x10), .b(x09), .O(new_n117_));
  nand4  g70(.a(new_n117_), .b(new_n50_), .c(new_n49_), .d(new_n48_), .O(new_n118_));
  nor2   g71(.a(new_n118_), .b(new_n116_), .O(z14));
  aoi21  g72(.a(new_n53_), .b(x01), .c(new_n45_), .O(new_n120_));
  nand3  g73(.a(x19), .b(new_n45_), .c(new_n64_), .O(new_n121_));
  oai21  g74(.a(new_n120_), .b(new_n63_), .c(new_n121_), .O(z15));
  nor2   g75(.a(new_n64_), .b(x00), .O(z16));
  zero   g76(.O(z00));
  zero   g77(.O(z05));
  zero   g78(.O(z09));
  zero   g79(.O(z13));
