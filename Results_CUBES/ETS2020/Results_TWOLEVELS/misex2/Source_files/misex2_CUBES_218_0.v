...
module FAU ( 
  ...
  oai22  g20(.a(new_n65_), .b(new_n60_), .c(new_n57_), .d(new_n55_), .O(z03));
  ...
  nor3   g25(.a(new_n67_), .b(new_n49_), .c(new_n61_), .O(z05));
  ...
  nand4  g32(.a(x19), .b(new_n53_), .c(x17), .d(new_n77_), .O(new_n78_));
  ...
  nand3  g37(.a(new_n47_), .b(new_n82_), .c(x02), .O(new_n83_));
  nor3   g38(.a(new_n83_), .b(new_n81_), .c(new_n78_), .O(z08));
  nor2   g39(.a(x20), .b(new_n63_), .O(new_n86_));
  nand4  g40(.a(new_n86_), .b(new_n54_), .c(x22), .d(x21), .O(new_n87_));
  nand2  g41(.a(x02), .b(new_n63_), .O(new_n88_));
  inv1   g42(.a(x13), .O(new_n89_));
  nand3  g43(.a(new_n89_), .b(x12), .c(new_n58_), .O(new_n90_));
  ...
  nand3  g53(.a(new_n86_), .b(new_n54_), .c(x21), .O(new_n100_));
  ...
  nand2  g58(.a(new_n95_), .b(new_n62_), .O(new_n105_));
  aoi21  g59(.a(new_n104_), .b(new_n100_), .c(new_n105_), .O(z11));
  oai21  g60(.a(new_n49_), .b(new_n46_), .c(new_n64_), .O(new_n107_));
  oai21  g61(.a(x19), .b(x02), .c(x23), .O(new_n108_));
  inv1   g62(.a(x19), .O(new_n109_));
  nand3  g63(.a(new_n109_), .b(x17), .c(new_n46_), .O(new_n110_));
  nand2  g64(.a(new_n110_), .b(new_n108_), .O(new_n111_));
  nand2  g65(.a(new_n111_), .b(new_n47_), .O(new_n112_));
  inv1   g66(.a(x24), .O(new_n113_));
  nand2  g67(.a(new_n113_), .b(x09), .O(new_n114_));
  aoi21  g68(.a(new_n112_), .b(new_n107_), .c(new_n114_), .O(z12));
  nor3   g69(.a(new_n48_), .b(x19), .c(new_n56_), .O(z13));
  nand3  g70(.a(new_n50_), .b(new_n49_), .c(new_n61_), .O(new_n117_));
  nor2   g71(.a(new_n117_), .b(new_n48_), .O(z14));
  zero   g72(.O(z00));
  zero   g73(.O(z01));
  zero   g74(.O(z09));
  zero   g75(.O(z15));
