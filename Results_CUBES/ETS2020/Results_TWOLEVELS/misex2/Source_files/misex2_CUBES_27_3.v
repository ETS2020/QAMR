...
module FAU ( 
  ...
  nand3  g39(.a(x19), .b(new_n50_), .c(x17), .O(new_n84_));
  ...
  nand4  g48(.a(new_n92_), .b(new_n91_), .c(x12), .d(new_n61_), .O(new_n93_));
  inv1   g49(.a(new_n93_), .O(new_n94_));
  nand3  g50(.a(new_n94_), .b(new_n90_), .c(new_n89_), .O(new_n95_));
  inv1   g51(.a(x20), .O(new_n96_));
  nand4  g52(.a(new_n96_), .b(new_n51_), .c(x18), .d(x01), .O(new_n97_));
  ...
  nand4  g58(.a(new_n102_), .b(new_n57_), .c(new_n96_), .d(x01), .O(new_n103_));
  ...
  nand4  g63(.a(x12), .b(new_n61_), .c(x02), .d(new_n65_), .O(new_n108_));
  ...
  oai21  g67(.a(new_n60_), .b(new_n44_), .c(new_n66_), .O(new_n113_));
  oai21  g68(.a(x19), .b(x02), .c(x23), .O(new_n114_));
  nand3  g69(.a(new_n51_), .b(x17), .c(new_n44_), .O(new_n115_));
  ...
  nor3   g75(.a(new_n46_), .b(x19), .c(new_n49_), .O(z13));
  aoi21  g76(.a(new_n60_), .b(x01), .c(new_n44_), .O(new_n123_));
  nand3  g77(.a(x19), .b(new_n44_), .c(new_n65_), .O(new_n124_));
  oai21  g78(.a(new_n123_), .b(new_n64_), .c(new_n124_), .O(z15));
