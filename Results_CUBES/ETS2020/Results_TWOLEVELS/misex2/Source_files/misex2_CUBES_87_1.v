...
module FAU ( 
  ...
  nand4  g17(.a(new_n49_), .b(new_n46_), .c(new_n45_), .d(new_n44_), .O(new_n61_));
  inv1   g18(.a(x11), .O(new_n62_));
  nor2   g19(.a(new_n62_), .b(new_n56_), .O(new_n63_));
  nand2  g20(.a(new_n63_), .b(x12), .O(new_n64_));
  nand4  g21(.a(new_n47_), .b(x02), .c(x01), .d(x00), .O(new_n65_));
  oai22  g22(.a(new_n65_), .b(new_n64_), .c(new_n61_), .d(new_n60_), .O(z03));
  nand2  g23(.a(x01), .b(x00), .O(new_n68_));
  nor4   g24(.a(new_n68_), .b(new_n56_), .c(new_n47_), .d(new_n46_), .O(z05));
  nand3  g25(.a(new_n63_), .b(new_n47_), .c(x02), .O(new_n70_));
  nor2   g26(.a(new_n70_), .b(new_n68_), .O(z06));
  inv1   g27(.a(x12), .O(new_n72_));
  nand4  g28(.a(new_n63_), .b(new_n72_), .c(new_n47_), .d(x01), .O(new_n73_));
  ...
  nand3  g44(.a(new_n89_), .b(new_n88_), .c(new_n44_), .O(new_n90_));
  aoi21  g45(.a(new_n87_), .b(new_n85_), .c(new_n90_), .O(z09));
  nor2   g46(.a(x20), .b(new_n45_), .O(new_n92_));
  nand4  g47(.a(new_n92_), .b(new_n59_), .c(x22), .d(x21), .O(new_n93_));
  inv1   g48(.a(x13), .O(new_n94_));
  nand3  g49(.a(new_n94_), .b(x12), .c(new_n62_), .O(new_n95_));
  ...
  nand2  g60(.a(new_n89_), .b(new_n44_), .O(new_n106_));
  aoi21  g61(.a(new_n105_), .b(new_n102_), .c(new_n106_), .O(z11));
  nor2   g62(.a(new_n57_), .b(new_n48_), .O(z14));
  aoi21  g63(.a(new_n56_), .b(x01), .c(new_n46_), .O(new_n111_));
  nand3  g64(.a(x19), .b(new_n46_), .c(new_n45_), .O(new_n112_));
  oai21  g65(.a(new_n111_), .b(new_n44_), .c(new_n112_), .O(z15));
  zero   g66(.O(z04));
  zero   g67(.O(z08));
  zero   g68(.O(z12));
  zero   g69(.O(z13));
