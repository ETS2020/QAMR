...
module FAU ( 
  ...
  nand4  g29(.a(x19), .b(new_n49_), .c(x17), .d(new_n75_), .O(new_n76_));
  ...
  nand4  g47(.a(x12), .b(new_n59_), .c(x02), .d(new_n84_), .O(new_n95_));
  ...
  oai21  g51(.a(new_n53_), .b(new_n45_), .c(new_n64_), .O(new_n100_));
  oai21  g52(.a(x19), .b(x02), .c(x23), .O(new_n101_));
  nand3  g53(.a(new_n50_), .b(x17), .c(new_n45_), .O(new_n102_));
