...
module FAU ( 
  ...
  nor2   g41(.a(new_n69_), .b(x11), .O(new_n88_));
  ...
  nor2   g56(.a(new_n102_), .b(new_n86_), .O(new_n103_));
  nor2   g57(.a(new_n81_), .b(x14), .O(new_n104_));
  ...
  nand4  g62(.a(new_n91_), .b(x21), .c(x18), .d(x01), .O(new_n109_));
  nand3  g63(.a(new_n94_), .b(x20), .c(new_n82_), .O(new_n110_));
  inv1   g64(.a(new_n110_), .O(new_n111_));
  nand3  g65(.a(new_n111_), .b(new_n104_), .c(new_n103_), .O(new_n112_));
  nand2  g66(.a(new_n95_), .b(new_n93_), .O(new_n113_));
  aoi21  g67(.a(new_n112_), .b(new_n109_), .c(new_n113_), .O(z11));
  oai21  g68(.a(new_n56_), .b(new_n45_), .c(new_n62_), .O(new_n115_));
  ...
  aoi21  g79(.a(new_n56_), .b(x01), .c(new_n45_), .O(new_n126_));
  nand3  g80(.a(x19), .b(new_n45_), .c(new_n85_), .O(new_n127_));
