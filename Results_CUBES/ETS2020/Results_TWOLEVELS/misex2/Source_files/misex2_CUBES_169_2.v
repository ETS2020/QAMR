...
module FAU ( 
  ...
  nand2  g15(.a(new_n59_), .b(x10), .O(new_n60_));
  inv1   g16(.a(x00), .O(new_n61_));
  inv1   g17(.a(x01), .O(new_n62_));
  nor2   g18(.a(new_n62_), .b(new_n61_), .O(new_n63_));
  nand3  g19(.a(new_n63_), .b(new_n45_), .c(x02), .O(new_n64_));
  nor3   g20(.a(new_n64_), .b(new_n60_), .c(x12), .O(z04));
  ...
  aoi21  g52(.a(new_n55_), .b(x01), .c(new_n44_), .O(new_n103_));
  nand3  g53(.a(x19), .b(new_n44_), .c(new_n62_), .O(new_n104_));
  oai21  g54(.a(new_n103_), .b(new_n61_), .c(new_n104_), .O(z15));
  nor2   g55(.a(new_n62_), .b(x00), .O(z16));
  inv1   g56(.a(new_n73_), .O(z17));
  zero   g57(.O(z03));
  zero   g58(.O(z05));
  zero   g59(.O(z06));
  zero   g60(.O(z07));
