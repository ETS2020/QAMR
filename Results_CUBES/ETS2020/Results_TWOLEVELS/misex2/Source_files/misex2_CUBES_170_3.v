...
module FAU ( 
  ...
  nand4  g76(.a(new_n50_), .b(new_n49_), .c(new_n48_), .d(new_n61_), .O(new_n123_));
  nor2   g77(.a(new_n123_), .b(new_n47_), .O(z14));
  aoi21  g78(.a(new_n61_), .b(x01), .c(new_n44_), .O(new_n125_));
  nand3  g79(.a(x19), .b(new_n44_), .c(new_n66_), .O(new_n126_));
  oai21  g80(.a(new_n125_), .b(new_n65_), .c(new_n126_), .O(z15));
