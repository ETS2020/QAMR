...
module FAU ( 
  ...
  inv1   g52(.a(x00), .O(new_n103_));
  aoi21  g53(.a(new_n57_), .b(x01), .c(new_n44_), .O(new_n104_));
  nand3  g54(.a(x19), .b(new_n44_), .c(new_n74_), .O(new_n105_));
  oai21  g55(.a(new_n104_), .b(new_n103_), .c(new_n105_), .O(z15));
  nor2   g56(.a(new_n74_), .b(x00), .O(z16));
