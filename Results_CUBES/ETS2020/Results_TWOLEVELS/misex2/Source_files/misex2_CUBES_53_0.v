...
module FAU ( 
  ...
  nand3  g48(.a(new_n92_), .b(x12), .c(new_n62_), .O(new_n93_));
  ...
  nand3  g58(.a(new_n89_), .b(new_n57_), .c(x21), .O(new_n103_));
  ...
  nand2  g63(.a(new_n98_), .b(new_n65_), .O(new_n108_));
  aoi21  g64(.a(new_n107_), .b(new_n103_), .c(new_n108_), .O(z11));
  oai21  g65(.a(new_n54_), .b(new_n59_), .c(new_n67_), .O(new_n110_));
  oai21  g66(.a(x19), .b(x02), .c(x23), .O(new_n111_));
  nand3  g67(.a(new_n49_), .b(x17), .c(new_n59_), .O(new_n112_));
  nand2  g68(.a(new_n112_), .b(new_n111_), .O(new_n113_));
  nand2  g69(.a(new_n113_), .b(new_n60_), .O(new_n114_));
  inv1   g70(.a(x24), .O(new_n115_));
  nand2  g71(.a(new_n115_), .b(x09), .O(new_n116_));
  aoi21  g72(.a(new_n114_), .b(new_n110_), .c(new_n116_), .O(z12));
  nor2   g73(.a(x19), .b(new_n47_), .O(new_n118_));
  and2   g74(.a(new_n118_), .b(new_n45_), .O(z13));
