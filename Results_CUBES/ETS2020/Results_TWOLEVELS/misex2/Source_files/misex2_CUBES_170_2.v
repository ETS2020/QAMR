...
module FAU ( 
  ...
  nand2  g58(.a(new_n46_), .b(new_n45_), .O(new_n107_));
  nor3   g59(.a(new_n107_), .b(x19), .c(new_n48_), .O(z13));
  aoi21  g60(.a(new_n53_), .b(x01), .c(new_n45_), .O(new_n110_));
  nand3  g61(.a(x19), .b(new_n45_), .c(new_n58_), .O(new_n111_));
  oai21  g62(.a(new_n110_), .b(new_n57_), .c(new_n111_), .O(z15));
  nor2   g63(.a(new_n58_), .b(x00), .O(z16));
  inv1   g64(.a(new_n73_), .O(z17));
  zero   g65(.O(z00));
  zero   g66(.O(z03));
  zero   g67(.O(z06));
  zero   g68(.O(z07));
