...
module FAU ( 
  ...
  nor2   g26(.a(new_n45_), .b(x01), .O(new_n75_));
  ...
  nand4  g34(.a(new_n82_), .b(new_n50_), .c(x18), .d(x01), .O(new_n83_));
  inv1   g35(.a(x21), .O(new_n84_));
  inv1   g36(.a(x22), .O(new_n85_));
  nand3  g37(.a(new_n85_), .b(new_n84_), .c(new_n58_), .O(new_n86_));
  ...
  nand3  g42(.a(new_n50_), .b(x17), .c(new_n45_), .O(new_n93_));
  nand2  g43(.a(new_n93_), .b(new_n92_), .O(new_n94_));
  nand2  g44(.a(new_n94_), .b(new_n46_), .O(new_n95_));
  inv1   g45(.a(x24), .O(new_n96_));
  nand2  g46(.a(new_n96_), .b(x09), .O(new_n97_));
  aoi21  g47(.a(new_n95_), .b(new_n91_), .c(new_n97_), .O(z12));
  nand2  g48(.a(new_n46_), .b(new_n45_), .O(new_n99_));
  nor3   g49(.a(new_n99_), .b(x19), .c(new_n48_), .O(z13));
  nor2   g50(.a(x10), .b(x09), .O(new_n101_));
  nand4  g51(.a(new_n101_), .b(new_n50_), .c(new_n49_), .d(new_n48_), .O(new_n102_));
  nor2   g52(.a(new_n102_), .b(new_n99_), .O(z14));
  aoi21  g53(.a(new_n53_), .b(x01), .c(new_n45_), .O(new_n104_));
  nand3  g54(.a(x19), .b(new_n45_), .c(new_n59_), .O(new_n105_));
  oai21  g55(.a(new_n104_), .b(new_n58_), .c(new_n105_), .O(z15));
  nor2   g56(.a(new_n59_), .b(x00), .O(z16));
  inv1   g57(.a(new_n68_), .O(z17));
  zero   g58(.O(z00));
  zero   g59(.O(z03));
  zero   g60(.O(z04));
  zero   g61(.O(z06));
