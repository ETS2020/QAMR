...
module FAU ( 
  ...
  nor2   g38(.a(x20), .b(new_n84_), .O(new_n85_));
  nand4  g39(.a(new_n85_), .b(new_n56_), .c(x22), .d(x21), .O(new_n86_));
  inv1   g40(.a(x21), .O(new_n87_));
  inv1   g41(.a(x22), .O(new_n88_));
  nand3  g42(.a(new_n88_), .b(new_n87_), .c(x20), .O(new_n89_));
  inv1   g43(.a(new_n89_), .O(new_n90_));
  inv1   g44(.a(x13), .O(new_n91_));
  inv1   g45(.a(x14), .O(new_n92_));
  nand4  g46(.a(x16), .b(x15), .c(new_n92_), .d(new_n91_), .O(new_n93_));
  inv1   g47(.a(new_n93_), .O(new_n94_));
  nand4  g48(.a(x12), .b(new_n59_), .c(x02), .d(new_n84_), .O(new_n95_));
  inv1   g49(.a(new_n95_), .O(new_n96_));
  nand3  g50(.a(new_n96_), .b(new_n94_), .c(new_n90_), .O(new_n97_));
  aoi21  g51(.a(new_n97_), .b(new_n86_), .c(x00), .O(z10));
  oai21  g52(.a(new_n53_), .b(new_n45_), .c(new_n64_), .O(new_n100_));
  oai21  g53(.a(x19), .b(x02), .c(x23), .O(new_n101_));
  nand3  g54(.a(new_n50_), .b(x17), .c(new_n45_), .O(new_n102_));
