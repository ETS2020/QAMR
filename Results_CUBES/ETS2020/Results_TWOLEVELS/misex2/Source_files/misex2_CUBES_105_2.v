...
module FAU ( 
  ...
  nand3  g13(.a(x12), .b(x11), .c(x10), .O(new_n58_));
  inv1   g14(.a(x09), .O(new_n59_));
  inv1   g15(.a(x00), .O(new_n60_));
  inv1   g16(.a(x01), .O(new_n61_));
  nor2   g17(.a(new_n61_), .b(new_n60_), .O(new_n62_));
  nand3  g18(.a(new_n62_), .b(new_n59_), .c(x02), .O(new_n63_));
  oai22  g19(.a(new_n63_), .b(new_n58_), .c(new_n57_), .d(new_n56_), .O(z03));
  ...
  nor3   g25(.a(new_n65_), .b(new_n53_), .c(new_n59_), .O(z05));
  ...
  oai21  g49(.a(new_n53_), .b(new_n45_), .c(new_n62_), .O(new_n98_));
  oai21  g50(.a(x19), .b(x02), .c(x23), .O(new_n99_));
  nand3  g51(.a(new_n50_), .b(x17), .c(new_n45_), .O(new_n100_));
  nand2  g52(.a(new_n100_), .b(new_n99_), .O(new_n101_));
  nand2  g53(.a(new_n101_), .b(new_n46_), .O(new_n102_));
  inv1   g54(.a(x24), .O(new_n103_));
  nand2  g55(.a(new_n103_), .b(x09), .O(new_n104_));
  aoi21  g56(.a(new_n102_), .b(new_n98_), .c(new_n104_), .O(z12));
  nand2  g57(.a(new_n46_), .b(new_n45_), .O(new_n106_));
  nor3   g58(.a(new_n106_), .b(x19), .c(new_n48_), .O(z13));
  nor2   g59(.a(x10), .b(x09), .O(new_n108_));
  nand4  g60(.a(new_n108_), .b(new_n50_), .c(new_n49_), .d(new_n48_), .O(new_n109_));
  nor2   g61(.a(new_n109_), .b(new_n106_), .O(z14));
  aoi21  g62(.a(new_n53_), .b(x01), .c(new_n45_), .O(new_n111_));
  nand3  g63(.a(x19), .b(new_n45_), .c(new_n61_), .O(new_n112_));
  oai21  g64(.a(new_n111_), .b(new_n60_), .c(new_n112_), .O(z15));
  nor2   g65(.a(new_n61_), .b(x00), .O(z16));
  inv1   g66(.a(new_n77_), .O(z17));
  zero   g67(.O(z00));
  zero   g68(.O(z06));
  zero   g69(.O(z07));
  zero   g70(.O(z10));
