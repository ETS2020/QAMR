...
module FAU ( 
  ...
  nor2   g45(.a(new_n44_), .b(x01), .O(new_n91_));
  inv1   g46(.a(x13), .O(new_n92_));
  inv1   g47(.a(x14), .O(new_n93_));
  nand4  g48(.a(new_n93_), .b(new_n92_), .c(x12), .d(new_n62_), .O(new_n94_));
  inv1   g49(.a(new_n94_), .O(new_n95_));
  nand3  g50(.a(new_n95_), .b(new_n91_), .c(new_n90_), .O(new_n96_));
  inv1   g51(.a(x20), .O(new_n97_));
  nand4  g52(.a(new_n97_), .b(new_n50_), .c(x18), .d(x01), .O(new_n98_));
  inv1   g53(.a(x21), .O(new_n99_));
  inv1   g54(.a(x22), .O(new_n100_));
  nand3  g55(.a(new_n100_), .b(new_n99_), .c(new_n65_), .O(new_n101_));
  aoi21  g56(.a(new_n98_), .b(new_n96_), .c(new_n101_), .O(z09));
  nor2   g57(.a(new_n100_), .b(new_n99_), .O(new_n103_));
  nand4  g58(.a(new_n103_), .b(new_n59_), .c(new_n97_), .d(x01), .O(new_n104_));
  nand3  g59(.a(new_n100_), .b(new_n99_), .c(x20), .O(new_n105_));
  inv1   g60(.a(new_n105_), .O(new_n106_));
  nand4  g61(.a(x16), .b(x15), .c(new_n93_), .d(new_n92_), .O(new_n107_));
  inv1   g62(.a(new_n107_), .O(new_n108_));
  nand4  g63(.a(x12), .b(new_n62_), .c(x02), .d(new_n66_), .O(new_n109_));
  inv1   g64(.a(new_n109_), .O(new_n110_));
  nand3  g65(.a(new_n110_), .b(new_n108_), .c(new_n106_), .O(new_n111_));
  aoi21  g66(.a(new_n111_), .b(new_n104_), .c(x00), .O(z10));
  oai21  g67(.a(new_n55_), .b(new_n44_), .c(new_n67_), .O(new_n114_));
  ...
  nor3   g75(.a(new_n54_), .b(x19), .c(new_n48_), .O(z13));
  nand4  g76(.a(new_n50_), .b(new_n49_), .c(new_n48_), .d(new_n55_), .O(new_n123_));
