...
module FAU ( 
  ...
  nand2  g43(.a(x02), .b(new_n69_), .O(new_n88_));
  inv1   g44(.a(new_n88_), .O(new_n89_));
  nor2   g45(.a(new_n72_), .b(x11), .O(new_n90_));
  ...
  nand3  g52(.a(new_n96_), .b(new_n95_), .c(new_n68_), .O(new_n97_));
  aoi21  g53(.a(new_n94_), .b(new_n92_), .c(new_n97_), .O(z09));
  nor2   g54(.a(x20), .b(new_n69_), .O(new_n99_));
  nand4  g55(.a(new_n99_), .b(new_n58_), .c(x22), .d(x21), .O(new_n100_));
  inv1   g56(.a(x13), .O(new_n101_));
  nand3  g57(.a(new_n101_), .b(x12), .c(new_n61_), .O(new_n102_));
  ...
  nand2  g68(.a(new_n96_), .b(new_n68_), .O(new_n113_));
