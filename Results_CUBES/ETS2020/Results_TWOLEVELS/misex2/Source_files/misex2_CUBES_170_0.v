...
module FAU ( 
  ...
  nand4  g33(.a(x19), .b(new_n48_), .c(x17), .d(new_n77_), .O(new_n78_));
  ...
  nand3  g38(.a(new_n60_), .b(new_n82_), .c(x02), .O(new_n83_));
  ...
  nand2  g44(.a(x02), .b(new_n70_), .O(new_n89_));
  ...
  nand3  g53(.a(new_n97_), .b(new_n96_), .c(new_n69_), .O(new_n98_));
  aoi21  g54(.a(new_n95_), .b(new_n93_), .c(new_n98_), .O(z09));
  nor2   g55(.a(x20), .b(new_n70_), .O(new_n100_));
  nand4  g56(.a(new_n100_), .b(new_n57_), .c(x22), .d(x21), .O(new_n101_));
  inv1   g57(.a(x13), .O(new_n102_));
  nand3  g58(.a(new_n102_), .b(x12), .c(new_n62_), .O(new_n103_));
  ...
  nand2  g69(.a(new_n97_), .b(new_n69_), .O(new_n114_));
  aoi21  g70(.a(new_n113_), .b(new_n110_), .c(new_n114_), .O(z11));
  nor2   g71(.a(x19), .b(new_n47_), .O(new_n117_));
  and2   g72(.a(new_n117_), .b(new_n45_), .O(z13));
  nor2   g73(.a(new_n55_), .b(new_n46_), .O(z14));
  nor2   g74(.a(new_n70_), .b(x00), .O(z16));
  zero   g75(.O(z05));
  zero   g76(.O(z12));
  zero   g77(.O(z15));
  zero   g78(.O(z17));
