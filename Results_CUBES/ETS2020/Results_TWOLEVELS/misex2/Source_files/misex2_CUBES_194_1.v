...
module FAU ( 
  ...
  nand2  g52(.a(new_n91_), .b(new_n63_), .O(new_n99_));
  aoi21  g53(.a(new_n98_), .b(new_n95_), .c(new_n99_), .O(z11));
  oai21  g54(.a(new_n55_), .b(new_n44_), .c(new_n65_), .O(new_n101_));
  oai21  g55(.a(x19), .b(x02), .c(x23), .O(new_n102_));
  nand3  g56(.a(new_n50_), .b(x17), .c(new_n44_), .O(new_n103_));
  nand2  g57(.a(new_n103_), .b(new_n102_), .O(new_n104_));
  nand2  g58(.a(new_n104_), .b(new_n46_), .O(new_n105_));
  ...
  nor2   g63(.a(new_n64_), .b(x00), .O(z16));
