...
module FAU ( 
  ...
  nor2   g44(.a(new_n45_), .b(x01), .O(new_n89_));
  ...
  nand4  g51(.a(new_n95_), .b(new_n50_), .c(x18), .d(x01), .O(new_n96_));
  ...
  nand4  g57(.a(new_n101_), .b(new_n56_), .c(new_n95_), .d(x01), .O(new_n102_));
  nand3  g58(.a(new_n98_), .b(new_n97_), .c(x20), .O(new_n103_));
  inv1   g59(.a(new_n103_), .O(new_n104_));
  nand4  g60(.a(x16), .b(x15), .c(new_n91_), .d(new_n90_), .O(new_n105_));
  inv1   g61(.a(new_n105_), .O(new_n106_));
  nand4  g62(.a(x12), .b(new_n59_), .c(x02), .d(new_n64_), .O(new_n107_));
  inv1   g63(.a(new_n107_), .O(new_n108_));
  nand3  g64(.a(new_n108_), .b(new_n106_), .c(new_n104_), .O(new_n109_));
  aoi21  g65(.a(new_n109_), .b(new_n102_), .c(x00), .O(z10));
  oai21  g66(.a(new_n53_), .b(new_n45_), .c(new_n65_), .O(new_n112_));
  oai21  g67(.a(x19), .b(x02), .c(x23), .O(new_n113_));
  nand3  g68(.a(new_n50_), .b(x17), .c(new_n45_), .O(new_n114_));
  ...
  nand2  g74(.a(new_n46_), .b(new_n45_), .O(new_n120_));
  nor3   g75(.a(new_n120_), .b(x19), .c(new_n48_), .O(z13));
  nor2   g76(.a(x10), .b(x09), .O(new_n122_));
  nand4  g77(.a(new_n122_), .b(new_n50_), .c(new_n49_), .d(new_n48_), .O(new_n123_));
  nor2   g78(.a(new_n123_), .b(new_n120_), .O(z14));
  aoi21  g79(.a(new_n53_), .b(x01), .c(new_n45_), .O(new_n125_));
  nand3  g80(.a(x19), .b(new_n45_), .c(new_n64_), .O(new_n126_));
  oai21  g81(.a(new_n125_), .b(new_n63_), .c(new_n126_), .O(z15));
