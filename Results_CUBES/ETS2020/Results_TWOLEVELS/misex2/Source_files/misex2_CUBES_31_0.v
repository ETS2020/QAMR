...
module FAU ( 
  ...
  nand2  g36(.a(x02), .b(new_n60_), .O(new_n82_));
  inv1   g37(.a(new_n82_), .O(new_n83_));
  nor2   g38(.a(new_n73_), .b(x11), .O(new_n84_));
  ...
  nand3  g45(.a(new_n90_), .b(new_n89_), .c(new_n59_), .O(new_n91_));
  aoi21  g46(.a(new_n88_), .b(new_n86_), .c(new_n91_), .O(z09));
  nor2   g47(.a(x20), .b(new_n60_), .O(new_n93_));
  nand4  g48(.a(new_n93_), .b(new_n57_), .c(x22), .d(x21), .O(new_n94_));
  inv1   g49(.a(x13), .O(new_n95_));
  nand3  g50(.a(new_n95_), .b(x12), .c(new_n63_), .O(new_n96_));
  nor2   g51(.a(new_n96_), .b(new_n82_), .O(new_n97_));
  nor2   g52(.a(new_n78_), .b(x14), .O(new_n98_));
  nand4  g53(.a(new_n90_), .b(new_n89_), .c(x20), .d(x16), .O(new_n99_));
  ...
  nand4  g57(.a(new_n87_), .b(x21), .c(x18), .d(x01), .O(new_n103_));
  nand3  g58(.a(new_n89_), .b(x20), .c(new_n79_), .O(new_n104_));
  inv1   g59(.a(new_n104_), .O(new_n105_));
  nand3  g60(.a(new_n105_), .b(new_n98_), .c(new_n97_), .O(new_n106_));
  nand2  g61(.a(new_n90_), .b(new_n59_), .O(new_n107_));
