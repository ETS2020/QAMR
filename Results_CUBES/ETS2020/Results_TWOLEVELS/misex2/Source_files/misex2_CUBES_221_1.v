...
module FAU ( 
  ...
  nand4  g55(.a(new_n101_), .b(new_n58_), .c(new_n95_), .d(x01), .O(new_n102_));
  ...
  oai21  g64(.a(new_n61_), .b(new_n44_), .c(new_n67_), .O(new_n112_));
  ...
  nand4  g73(.a(new_n50_), .b(new_n49_), .c(new_n48_), .d(new_n61_), .O(new_n121_));
