...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n109_, new_n110_, new_n111_, new_n116_, new_n118_, new_n119_;
  ...
  nor3   g68(.a(new_n53_), .b(x19), .c(new_n48_), .O(z13));
  nand4  g69(.a(new_n50_), .b(new_n49_), .c(new_n48_), .d(new_n61_), .O(new_n116_));
  nor2   g70(.a(new_n116_), .b(new_n47_), .O(z14));
  aoi21  g71(.a(new_n61_), .b(x01), .c(new_n44_), .O(new_n118_));
  nand3  g72(.a(x19), .b(new_n44_), .c(new_n66_), .O(new_n119_));
  oai21  g73(.a(new_n118_), .b(new_n65_), .c(new_n119_), .O(z15));
  nor2   g74(.a(new_n66_), .b(x00), .O(z16));
