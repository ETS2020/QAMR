...
module FAU ( 
  ...
  nor3   g26(.a(new_n70_), .b(new_n68_), .c(new_n48_), .O(z04));
  nor2   g27(.a(new_n68_), .b(new_n54_), .O(z05));
  ...
  nand4  g34(.a(x19), .b(new_n50_), .c(x17), .d(new_n78_), .O(new_n79_));
  ...
  oai21  g57(.a(new_n59_), .b(new_n44_), .c(new_n65_), .O(new_n104_));
  oai21  g58(.a(x19), .b(x02), .c(x23), .O(new_n105_));
  nand3  g59(.a(new_n51_), .b(x17), .c(new_n44_), .O(new_n106_));
  nand2  g60(.a(new_n106_), .b(new_n105_), .O(new_n107_));
  nand2  g61(.a(new_n107_), .b(new_n45_), .O(new_n108_));
  inv1   g62(.a(x24), .O(new_n109_));
  nand2  g63(.a(new_n109_), .b(x09), .O(new_n110_));
  aoi21  g64(.a(new_n108_), .b(new_n104_), .c(new_n110_), .O(z12));
  aoi21  g65(.a(new_n59_), .b(x01), .c(new_n44_), .O(new_n114_));
  nand3  g66(.a(x19), .b(new_n44_), .c(new_n64_), .O(new_n115_));
  oai21  g67(.a(new_n114_), .b(new_n63_), .c(new_n115_), .O(z15));
  zero   g68(.O(z02));
  zero   g69(.O(z10));
  zero   g70(.O(z11));
  zero   g71(.O(z13));
