// Benchmark "FAU" written by ABC on Tue Jul  7 11:01:31 2020
...
module FAU ( 
  ...
  nand4  g55(.a(new_n100_), .b(new_n99_), .c(new_n52_), .d(x18), .O(new_n101_));
  ...
  nor3   g70(.a(new_n47_), .b(x19), .c(new_n54_), .O(z13));
  nand3  g71(.a(new_n48_), .b(new_n56_), .c(new_n60_), .O(new_n118_));
  nor2   g72(.a(new_n118_), .b(new_n47_), .O(z14));
  aoi21  g73(.a(new_n56_), .b(x01), .c(new_n45_), .O(new_n120_));
  nand3  g74(.a(x19), .b(new_n45_), .c(new_n62_), .O(new_n121_));
  oai21  g75(.a(new_n120_), .b(new_n61_), .c(new_n121_), .O(z15));
  nor2   g76(.a(new_n62_), .b(x00), .O(z16));
