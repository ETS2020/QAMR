...
module FAU ( 
  ...
  nor4   g22(.a(new_n65_), .b(x12), .c(x11), .d(new_n55_), .O(z04));
  ...
  nand2  g35(.a(x02), .b(new_n70_), .O(new_n82_));
  inv1   g36(.a(new_n82_), .O(new_n83_));
  nor2   g37(.a(new_n73_), .b(x11), .O(new_n84_));
  ...
  nor2   g46(.a(x20), .b(new_n70_), .O(new_n93_));
  nand4  g47(.a(new_n93_), .b(new_n59_), .c(x22), .d(x21), .O(new_n94_));
  inv1   g48(.a(x13), .O(new_n95_));
  nand3  g49(.a(new_n95_), .b(x12), .c(new_n62_), .O(new_n96_));
  ...
  nand2  g60(.a(new_n90_), .b(new_n69_), .O(new_n107_));
  aoi21  g61(.a(new_n106_), .b(new_n103_), .c(new_n107_), .O(z11));
  nor3   g62(.a(new_n54_), .b(x19), .c(new_n48_), .O(z13));
  nand4  g63(.a(new_n50_), .b(new_n49_), .c(new_n48_), .d(new_n55_), .O(new_n111_));
  nor2   g64(.a(new_n111_), .b(new_n47_), .O(z14));
  aoi21  g65(.a(new_n55_), .b(x01), .c(new_n44_), .O(new_n113_));
  nand3  g66(.a(x19), .b(new_n44_), .c(new_n70_), .O(new_n114_));
  oai21  g67(.a(new_n113_), .b(new_n69_), .c(new_n114_), .O(z15));
  nor2   g68(.a(new_n70_), .b(x00), .O(z16));
  nand2  g69(.a(new_n46_), .b(x02), .O(new_n117_));
  inv1   g70(.a(new_n117_), .O(z17));
  zero   g71(.O(z01));
  zero   g72(.O(z05));
  zero   g73(.O(z08));
  zero   g74(.O(z12));
