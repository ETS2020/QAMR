...
module FAU ( 
  ...
  oai21  g64(.a(new_n55_), .b(new_n44_), .c(new_n66_), .O(new_n110_));
  ...
  nand4  g73(.a(new_n50_), .b(new_n49_), .c(new_n48_), .d(new_n55_), .O(new_n119_));
  nor2   g74(.a(new_n119_), .b(new_n47_), .O(z14));
  aoi21  g75(.a(new_n55_), .b(x01), .c(new_n44_), .O(new_n121_));
  nand3  g76(.a(x19), .b(new_n44_), .c(new_n65_), .O(new_n122_));
  oai21  g77(.a(new_n121_), .b(new_n64_), .c(new_n122_), .O(z15));
  zero   g78(.O(z01));
  zero   g79(.O(z10));
  zero   g80(.O(z16));
  zero   g81(.O(z17));
