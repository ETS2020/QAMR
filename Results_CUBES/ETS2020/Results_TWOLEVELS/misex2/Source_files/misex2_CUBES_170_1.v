...
module FAU ( 
  ...
  nor2   g32(.a(x20), .b(new_n79_), .O(new_n80_));
  nand4  g33(.a(new_n80_), .b(new_n59_), .c(x22), .d(x21), .O(new_n81_));
  nand2  g34(.a(x02), .b(new_n79_), .O(new_n82_));
  ...
  nand3  g46(.a(new_n80_), .b(new_n59_), .c(x21), .O(new_n94_));
  ...
  inv1   g51(.a(x00), .O(new_n99_));
  nand2  g52(.a(new_n89_), .b(new_n99_), .O(new_n100_));
  aoi21  g53(.a(new_n98_), .b(new_n94_), .c(new_n100_), .O(z11));
  oai21  g54(.a(new_n55_), .b(new_n44_), .c(new_n66_), .O(new_n102_));
  ...
  nand3  g66(.a(x19), .b(new_n44_), .c(new_n79_), .O(new_n114_));
  oai21  g67(.a(new_n113_), .b(new_n99_), .c(new_n114_), .O(z15));
