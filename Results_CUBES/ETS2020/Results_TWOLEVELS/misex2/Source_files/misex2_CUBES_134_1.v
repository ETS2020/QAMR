...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n102_, new_n103_, new_n107_, new_n112_;
  ...
  inv1   g27(.a(x01), .O(new_n72_));
  nand3  g28(.a(new_n63_), .b(new_n44_), .c(x02), .O(new_n73_));
  nor3   g29(.a(new_n73_), .b(new_n72_), .c(new_n71_), .O(z06));
  nand4  g30(.a(new_n63_), .b(new_n67_), .c(new_n44_), .d(x01), .O(new_n75_));
  ...
  nor2   g37(.a(new_n59_), .b(x01), .O(new_n83_));
  inv1   g38(.a(x13), .O(new_n84_));
  inv1   g39(.a(x14), .O(new_n85_));
  nand4  g40(.a(new_n85_), .b(new_n84_), .c(x12), .d(new_n62_), .O(new_n86_));
  inv1   g41(.a(new_n86_), .O(new_n87_));
  nand3  g42(.a(new_n87_), .b(new_n83_), .c(new_n82_), .O(new_n88_));
  inv1   g43(.a(x20), .O(new_n89_));
  nand4  g44(.a(new_n89_), .b(new_n49_), .c(x18), .d(x01), .O(new_n90_));
  inv1   g45(.a(x21), .O(new_n91_));
  inv1   g46(.a(x22), .O(new_n92_));
  nand3  g47(.a(new_n92_), .b(new_n91_), .c(new_n71_), .O(new_n93_));
  aoi21  g48(.a(new_n90_), .b(new_n88_), .c(new_n93_), .O(z09));
  nor2   g49(.a(new_n92_), .b(new_n91_), .O(new_n95_));
  nand4  g50(.a(new_n95_), .b(new_n57_), .c(new_n89_), .d(x01), .O(new_n96_));
  nand3  g51(.a(new_n92_), .b(new_n91_), .c(x20), .O(new_n97_));
  inv1   g52(.a(new_n97_), .O(new_n98_));
  nand4  g53(.a(x16), .b(x15), .c(new_n85_), .d(new_n84_), .O(new_n99_));
  inv1   g54(.a(new_n99_), .O(new_n100_));
  nand4  g55(.a(x12), .b(new_n62_), .c(x02), .d(new_n72_), .O(new_n101_));
  ...
  nor2   g59(.a(x19), .b(new_n47_), .O(new_n107_));
  and2   g60(.a(new_n107_), .b(new_n45_), .O(z13));
  nor2   g61(.a(new_n55_), .b(new_n46_), .O(z14));
  nor2   g62(.a(new_n72_), .b(x00), .O(z16));
  nand2  g63(.a(new_n60_), .b(x02), .O(new_n112_));
