...
module FAU ( 
  ...
  nand4  g23(.a(new_n72_), .b(x21), .c(x18), .d(x01), .O(new_n73_));
  inv1   g24(.a(x16), .O(new_n74_));
  inv1   g25(.a(x21), .O(new_n75_));
  nand4  g26(.a(new_n75_), .b(x20), .c(new_n74_), .d(x15), .O(new_n76_));
  inv1   g27(.a(new_n76_), .O(new_n77_));
  inv1   g28(.a(x02), .O(new_n78_));
  nor2   g29(.a(new_n78_), .b(x01), .O(new_n79_));
  inv1   g30(.a(x13), .O(new_n80_));
  inv1   g31(.a(x14), .O(new_n81_));
  nand4  g32(.a(new_n81_), .b(new_n80_), .c(x12), .d(new_n62_), .O(new_n82_));
  inv1   g33(.a(new_n82_), .O(new_n83_));
  nand3  g34(.a(new_n83_), .b(new_n79_), .c(new_n77_), .O(new_n84_));
  inv1   g35(.a(x22), .O(new_n85_));
  nand2  g36(.a(new_n85_), .b(new_n58_), .O(new_n86_));
  aoi21  g37(.a(new_n84_), .b(new_n73_), .c(new_n86_), .O(z11));
  oai21  g38(.a(new_n54_), .b(new_n78_), .c(new_n60_), .O(new_n88_));
  nor2   g39(.a(x01), .b(x00), .O(new_n89_));
  oai21  g40(.a(x19), .b(x02), .c(x23), .O(new_n90_));
  nand3  g41(.a(new_n49_), .b(x17), .c(new_n78_), .O(new_n91_));
  nand2  g42(.a(new_n91_), .b(new_n90_), .O(new_n92_));
  nand2  g43(.a(new_n92_), .b(new_n89_), .O(new_n93_));
  inv1   g44(.a(x24), .O(new_n94_));
  nand2  g45(.a(new_n94_), .b(x09), .O(new_n95_));
  aoi21  g46(.a(new_n93_), .b(new_n88_), .c(new_n95_), .O(z12));
  nor2   g47(.a(x19), .b(new_n47_), .O(new_n97_));
  and2   g48(.a(new_n97_), .b(new_n45_), .O(z13));
  nor2   g49(.a(new_n55_), .b(new_n46_), .O(z14));
  aoi21  g50(.a(new_n54_), .b(x01), .c(new_n78_), .O(new_n100_));
  nand3  g51(.a(x19), .b(new_n78_), .c(new_n59_), .O(new_n101_));
  oai21  g52(.a(new_n100_), .b(new_n58_), .c(new_n101_), .O(z15));
  nor2   g53(.a(new_n59_), .b(x00), .O(z16));
  nand2  g54(.a(new_n89_), .b(x02), .O(new_n104_));
  inv1   g55(.a(new_n104_), .O(z17));
  zero   g56(.O(z03));
  zero   g57(.O(z06));
  zero   g58(.O(z07));
  zero   g59(.O(z08));
