...
module FAU ( 
  ...
  nand2  g32(.a(new_n47_), .b(x02), .O(new_n79_));
  ...
  nand3  g38(.a(x20), .b(new_n84_), .c(new_n83_), .O(new_n85_));
  inv1   g39(.a(new_n85_), .O(new_n86_));
  nand2  g40(.a(x02), .b(new_n62_), .O(new_n87_));
  inv1   g41(.a(new_n87_), .O(new_n88_));
  nor2   g42(.a(new_n66_), .b(x11), .O(new_n89_));
  nor2   g43(.a(x14), .b(x13), .O(new_n90_));
  nand4  g44(.a(new_n90_), .b(new_n89_), .c(new_n88_), .d(new_n86_), .O(new_n91_));
  ...
  nand3  g49(.a(new_n95_), .b(new_n94_), .c(new_n61_), .O(new_n96_));
  aoi21  g50(.a(new_n93_), .b(new_n91_), .c(new_n96_), .O(z09));
  nor2   g51(.a(x20), .b(new_n62_), .O(new_n98_));
  nor2   g52(.a(new_n95_), .b(new_n94_), .O(new_n99_));
  nand4  g53(.a(new_n99_), .b(new_n98_), .c(new_n53_), .d(x18), .O(new_n100_));
  inv1   g54(.a(x13), .O(new_n101_));
  nand3  g55(.a(new_n101_), .b(x12), .c(new_n57_), .O(new_n102_));
  nor2   g56(.a(new_n102_), .b(new_n87_), .O(new_n103_));
  nor2   g57(.a(new_n83_), .b(x14), .O(new_n104_));
  nand4  g58(.a(new_n95_), .b(new_n94_), .c(x20), .d(x16), .O(new_n105_));
  ...
  nand4  g62(.a(new_n92_), .b(x21), .c(x18), .d(x01), .O(new_n109_));
  nand3  g63(.a(new_n94_), .b(x20), .c(new_n84_), .O(new_n110_));
  inv1   g64(.a(new_n110_), .O(new_n111_));
  nand3  g65(.a(new_n111_), .b(new_n104_), .c(new_n103_), .O(new_n112_));
  nand2  g66(.a(new_n95_), .b(new_n61_), .O(new_n113_));
  aoi21  g67(.a(new_n112_), .b(new_n109_), .c(new_n113_), .O(z11));
  oai21  g68(.a(new_n49_), .b(new_n46_), .c(new_n63_), .O(new_n115_));
  oai21  g69(.a(x19), .b(x02), .c(x23), .O(new_n116_));
  nand3  g70(.a(new_n53_), .b(x17), .c(new_n46_), .O(new_n117_));
  ...
  nor3   g76(.a(new_n48_), .b(x19), .c(new_n55_), .O(z13));
  nand3  g77(.a(new_n50_), .b(new_n49_), .c(new_n60_), .O(new_n124_));
  nor2   g78(.a(new_n124_), .b(new_n48_), .O(z14));
  nor2   g79(.a(new_n62_), .b(x00), .O(z16));
  inv1   g80(.a(new_n79_), .O(z17));
  zero   g81(.O(z00));
  zero   g82(.O(z01));
  zero   g83(.O(z05));
  zero   g84(.O(z15));
