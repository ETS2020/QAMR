...
module FAU ( 
  ...
  nor2   g35(.a(x20), .b(new_n66_), .O(new_n82_));
  nand4  g36(.a(new_n82_), .b(new_n59_), .c(x22), .d(x21), .O(new_n83_));
  nand2  g37(.a(x02), .b(new_n66_), .O(new_n84_));
  inv1   g38(.a(x13), .O(new_n85_));
  nand3  g39(.a(new_n85_), .b(x12), .c(new_n62_), .O(new_n86_));
  ...
  nand3  g49(.a(new_n82_), .b(new_n59_), .c(x21), .O(new_n96_));
  ...
  nand2  g54(.a(new_n91_), .b(new_n65_), .O(new_n101_));
  aoi21  g55(.a(new_n100_), .b(new_n96_), .c(new_n101_), .O(z11));
  nor3   g56(.a(new_n54_), .b(x19), .c(new_n48_), .O(z13));
  nand4  g57(.a(new_n50_), .b(new_n49_), .c(new_n48_), .d(new_n55_), .O(new_n105_));
  nor2   g58(.a(new_n105_), .b(new_n47_), .O(z14));
