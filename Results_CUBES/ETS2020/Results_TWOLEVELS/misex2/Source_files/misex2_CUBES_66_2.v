...
module FAU ( 
  ...
  wire new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_, new_n51_,
    ...
    new_n98_, new_n99_, new_n101_, new_n103_, new_n104_, new_n106_,
    new_n107_;
  ...
  nor2   g28(.a(new_n49_), .b(new_n58_), .O(new_n77_));
  nor2   g29(.a(x20), .b(x19), .O(new_n78_));
  nand4  g30(.a(new_n78_), .b(new_n77_), .c(x22), .d(x21), .O(new_n79_));
  inv1   g31(.a(x21), .O(new_n80_));
  inv1   g32(.a(x22), .O(new_n81_));
  nand3  g33(.a(new_n81_), .b(new_n80_), .c(x20), .O(new_n82_));
  inv1   g34(.a(new_n82_), .O(new_n83_));
  inv1   g35(.a(x13), .O(new_n84_));
  inv1   g36(.a(x14), .O(new_n85_));
  nand4  g37(.a(x16), .b(x15), .c(new_n85_), .d(new_n84_), .O(new_n86_));
  inv1   g38(.a(new_n86_), .O(new_n87_));
  nand4  g39(.a(x12), .b(new_n62_), .c(x02), .d(new_n58_), .O(new_n88_));
  inv1   g40(.a(new_n88_), .O(new_n89_));
  nand3  g41(.a(new_n89_), .b(new_n87_), .c(new_n83_), .O(new_n90_));
  aoi21  g42(.a(new_n90_), .b(new_n79_), .c(x00), .O(z10));
  ...
  nand2  g51(.a(new_n46_), .b(new_n45_), .O(new_n101_));
  nor3   g52(.a(new_n101_), .b(x19), .c(new_n48_), .O(z13));
  nor2   g53(.a(x10), .b(x09), .O(new_n103_));
  nand4  g54(.a(new_n103_), .b(new_n50_), .c(new_n49_), .d(new_n48_), .O(new_n104_));
  nor2   g55(.a(new_n104_), .b(new_n101_), .O(z14));
  aoi21  g56(.a(new_n53_), .b(x01), .c(new_n45_), .O(new_n106_));
  nand3  g57(.a(x19), .b(new_n45_), .c(new_n58_), .O(new_n107_));
  oai21  g58(.a(new_n106_), .b(new_n57_), .c(new_n107_), .O(z15));
  nor2   g59(.a(new_n58_), .b(x00), .O(z16));
  inv1   g60(.a(new_n73_), .O(z17));
  zero   g61(.O(z00));
  zero   g62(.O(z03));
  zero   g63(.O(z06));
  zero   g64(.O(z07));
