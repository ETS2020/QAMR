...
module FAU ( 
  ...
  wire new_n46_, new_n47_, new_n48_, new_n49_, new_n50_, new_n51_, new_n53_,
    ...
    new_n90_, new_n91_, new_n92_, new_n93_, new_n94_, new_n98_, new_n102_;
  ...
  nor2   g26(.a(x20), .b(new_n66_), .O(new_n75_));
  nand4  g27(.a(new_n75_), .b(new_n54_), .c(x22), .d(x21), .O(new_n76_));
  nand2  g28(.a(x02), .b(new_n66_), .O(new_n77_));
  inv1   g29(.a(x13), .O(new_n78_));
  nand3  g30(.a(new_n78_), .b(x12), .c(new_n57_), .O(new_n79_));
  nor2   g31(.a(new_n79_), .b(new_n77_), .O(new_n80_));
  ...
  nand3  g40(.a(new_n75_), .b(new_n54_), .c(x21), .O(new_n89_));
  ...
  nand2  g45(.a(new_n84_), .b(new_n65_), .O(new_n94_));
  aoi21  g46(.a(new_n93_), .b(new_n89_), .c(new_n94_), .O(z11));
  nand3  g47(.a(new_n50_), .b(new_n49_), .c(new_n60_), .O(new_n98_));
  nor2   g48(.a(new_n98_), .b(new_n48_), .O(z14));
  nand2  g49(.a(new_n47_), .b(x02), .O(new_n102_));
