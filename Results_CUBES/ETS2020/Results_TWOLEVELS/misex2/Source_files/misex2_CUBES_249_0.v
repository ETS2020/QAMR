...
module FAU ( 
  ...
  nand2  g41(.a(x02), .b(new_n67_), .O(new_n86_));
  inv1   g42(.a(new_n86_), .O(new_n87_));
  nor2   g43(.a(new_n72_), .b(x11), .O(new_n88_));
  nor2   g44(.a(x14), .b(x13), .O(new_n89_));
  nand4  g45(.a(new_n89_), .b(new_n88_), .c(new_n87_), .d(new_n85_), .O(new_n90_));
  nor2   g46(.a(x20), .b(x19), .O(new_n91_));
  nand3  g47(.a(new_n91_), .b(x18), .c(x01), .O(new_n92_));
  inv1   g48(.a(x21), .O(new_n93_));
  inv1   g49(.a(x22), .O(new_n94_));
  nand3  g50(.a(new_n94_), .b(new_n93_), .c(new_n66_), .O(new_n95_));
  aoi21  g51(.a(new_n92_), .b(new_n90_), .c(new_n95_), .O(z09));
  nor2   g52(.a(x20), .b(new_n67_), .O(new_n97_));
  nand4  g53(.a(new_n97_), .b(new_n60_), .c(x22), .d(x21), .O(new_n98_));
  inv1   g54(.a(x13), .O(new_n99_));
  nand3  g55(.a(new_n99_), .b(x12), .c(new_n63_), .O(new_n100_));
  nor2   g56(.a(new_n100_), .b(new_n86_), .O(new_n101_));
  nor2   g57(.a(new_n82_), .b(x14), .O(new_n102_));
  nand4  g58(.a(new_n94_), .b(new_n93_), .c(x20), .d(x16), .O(new_n103_));
  inv1   g59(.a(new_n103_), .O(new_n104_));
  nand3  g60(.a(new_n104_), .b(new_n102_), .c(new_n101_), .O(new_n105_));
  aoi21  g61(.a(new_n105_), .b(new_n98_), .c(x00), .O(z10));
  nand4  g62(.a(new_n91_), .b(x21), .c(x18), .d(x01), .O(new_n107_));
  nand3  g63(.a(new_n93_), .b(x20), .c(new_n83_), .O(new_n108_));
  inv1   g64(.a(new_n108_), .O(new_n109_));
  nand3  g65(.a(new_n109_), .b(new_n102_), .c(new_n101_), .O(new_n110_));
  nand2  g66(.a(new_n94_), .b(new_n66_), .O(new_n111_));
  aoi21  g67(.a(new_n110_), .b(new_n107_), .c(new_n111_), .O(z11));
  oai21  g68(.a(new_n57_), .b(new_n44_), .c(new_n68_), .O(new_n113_));
  oai21  g69(.a(x19), .b(x02), .c(x23), .O(new_n114_));
  nand3  g70(.a(new_n48_), .b(x17), .c(new_n44_), .O(new_n115_));
  ...
  aoi21  g75(.a(new_n117_), .b(new_n113_), .c(new_n119_), .O(z12));
  zero   g76(.O(z08));
  zero   g77(.O(z13));
  zero   g78(.O(z14));
  zero   g79(.O(z15));
