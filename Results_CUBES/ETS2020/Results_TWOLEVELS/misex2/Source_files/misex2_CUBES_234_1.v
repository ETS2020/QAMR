...
module FAU ( 
  ...
  nand4  g45(.a(new_n90_), .b(new_n89_), .c(x12), .d(new_n57_), .O(new_n91_));
  ...
  nand3  g52(.a(new_n97_), .b(new_n96_), .c(new_n61_), .O(new_n98_));
  aoi21  g53(.a(new_n95_), .b(new_n93_), .c(new_n98_), .O(z09));
  nand4  g54(.a(new_n94_), .b(x21), .c(x18), .d(x01), .O(new_n101_));
  nand4  g55(.a(new_n96_), .b(x20), .c(new_n85_), .d(x15), .O(new_n102_));
  inv1   g56(.a(new_n102_), .O(new_n103_));
  nand3  g57(.a(new_n103_), .b(new_n92_), .c(new_n88_), .O(new_n104_));
  nand2  g58(.a(new_n97_), .b(new_n61_), .O(new_n105_));
  ...
  nand3  g62(.a(new_n54_), .b(x17), .c(new_n45_), .O(new_n109_));
  ...
  nor3   g68(.a(new_n47_), .b(x19), .c(new_n53_), .O(z13));
