...
module FAU ( 
  ...
  nand2  g36(.a(x02), .b(new_n81_), .O(new_n82_));
  inv1   g37(.a(new_n82_), .O(new_n83_));
  nor2   g38(.a(new_n72_), .b(x11), .O(new_n84_));
  nor2   g39(.a(x14), .b(x13), .O(new_n85_));
  nand4  g40(.a(new_n85_), .b(new_n84_), .c(new_n83_), .d(new_n80_), .O(new_n86_));
  ...
  nor2   g48(.a(x20), .b(new_n81_), .O(new_n94_));
  nand4  g49(.a(new_n94_), .b(new_n58_), .c(x22), .d(x21), .O(new_n95_));
  inv1   g50(.a(x13), .O(new_n96_));
  nand3  g51(.a(new_n96_), .b(x12), .c(new_n61_), .O(new_n97_));
  nor2   g52(.a(new_n97_), .b(new_n82_), .O(new_n98_));
  nor2   g53(.a(new_n77_), .b(x14), .O(new_n99_));
  ...
  nand3  g59(.a(new_n90_), .b(x20), .c(new_n78_), .O(new_n105_));
  inv1   g60(.a(new_n105_), .O(new_n106_));
  nand3  g61(.a(new_n106_), .b(new_n99_), .c(new_n98_), .O(new_n107_));
  nand2  g62(.a(new_n91_), .b(new_n89_), .O(new_n108_));
  aoi21  g63(.a(new_n107_), .b(new_n104_), .c(new_n108_), .O(z11));
  oai21  g64(.a(new_n55_), .b(new_n44_), .c(new_n65_), .O(new_n110_));
  ...
  nor2   g73(.a(new_n81_), .b(x00), .O(z16));
  nand2  g74(.a(new_n46_), .b(x02), .O(new_n122_));
