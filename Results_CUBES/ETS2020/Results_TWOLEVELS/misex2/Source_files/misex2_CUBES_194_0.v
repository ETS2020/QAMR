...
module FAU ( 
  ...
  nand2  g78(.a(new_n46_), .b(new_n44_), .O(new_n124_));
  nor3   g79(.a(new_n124_), .b(x19), .c(new_n48_), .O(z13));
  nand4  g80(.a(new_n50_), .b(new_n49_), .c(new_n48_), .d(new_n58_), .O(new_n126_));
  nor2   g81(.a(new_n126_), .b(new_n47_), .O(z14));
  aoi21  g82(.a(new_n58_), .b(x01), .c(new_n44_), .O(new_n128_));
  nand3  g83(.a(x19), .b(new_n44_), .c(new_n63_), .O(new_n129_));
  oai21  g84(.a(new_n128_), .b(new_n62_), .c(new_n129_), .O(z15));
  zero   g85(.O(z01));
  zero   g86(.O(z02));
  zero   g87(.O(z16));
  zero   g88(.O(z17));
