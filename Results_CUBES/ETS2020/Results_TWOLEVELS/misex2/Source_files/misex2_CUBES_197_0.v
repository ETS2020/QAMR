...
module FAU ( 
  ...
  nand2  g46(.a(x02), .b(new_n65_), .O(new_n91_));
  inv1   g47(.a(new_n91_), .O(new_n92_));
  nor2   g48(.a(new_n70_), .b(x11), .O(new_n93_));
  ...
  nand3  g55(.a(new_n99_), .b(new_n98_), .c(new_n64_), .O(new_n100_));
  aoi21  g56(.a(new_n97_), .b(new_n95_), .c(new_n100_), .O(z09));
  nor2   g57(.a(x20), .b(new_n65_), .O(new_n102_));
  ...
  nand2  g71(.a(new_n99_), .b(new_n64_), .O(new_n116_));
  aoi21  g72(.a(new_n115_), .b(new_n112_), .c(new_n116_), .O(z11));
  oai21  g73(.a(new_n60_), .b(new_n44_), .c(new_n66_), .O(new_n118_));
  oai21  g74(.a(x19), .b(x02), .c(x23), .O(new_n119_));
  nand3  g75(.a(new_n51_), .b(x17), .c(new_n44_), .O(new_n120_));
  ...
  nor3   g81(.a(new_n46_), .b(x19), .c(new_n49_), .O(z13));
  aoi21  g82(.a(new_n60_), .b(x01), .c(new_n44_), .O(new_n128_));
  nand3  g83(.a(x19), .b(new_n44_), .c(new_n65_), .O(new_n129_));
  oai21  g84(.a(new_n128_), .b(new_n64_), .c(new_n129_), .O(z15));
  zero   g85(.O(z02));
  zero   g86(.O(z14));
  zero   g87(.O(z16));
  zero   g88(.O(z17));
