...
module FAU ( 
  ...
  nand4  g20(.a(new_n69_), .b(x21), .c(x18), .d(x01), .O(new_n70_));
  inv1   g21(.a(x16), .O(new_n71_));
  inv1   g22(.a(x21), .O(new_n72_));
  nand4  g23(.a(new_n72_), .b(x20), .c(new_n71_), .d(x15), .O(new_n73_));
  inv1   g24(.a(new_n73_), .O(new_n74_));
  nor2   g25(.a(new_n44_), .b(x01), .O(new_n75_));
  inv1   g26(.a(x11), .O(new_n76_));
  inv1   g27(.a(x13), .O(new_n77_));
  inv1   g28(.a(x14), .O(new_n78_));
  nand4  g29(.a(new_n78_), .b(new_n77_), .c(x12), .d(new_n76_), .O(new_n79_));
  inv1   g30(.a(new_n79_), .O(new_n80_));
  nand3  g31(.a(new_n80_), .b(new_n75_), .c(new_n74_), .O(new_n81_));
  inv1   g32(.a(x00), .O(new_n82_));
  inv1   g33(.a(x22), .O(new_n83_));
  nand2  g34(.a(new_n83_), .b(new_n82_), .O(new_n84_));
  aoi21  g35(.a(new_n81_), .b(new_n70_), .c(new_n84_), .O(z11));
  ...
  aoi21  g46(.a(new_n57_), .b(x01), .c(new_n44_), .O(new_n97_));
  inv1   g47(.a(x01), .O(new_n98_));
  nand3  g48(.a(x19), .b(new_n44_), .c(new_n98_), .O(new_n99_));
  oai21  g49(.a(new_n97_), .b(new_n82_), .c(new_n99_), .O(z15));
  nor2   g50(.a(new_n98_), .b(x00), .O(z16));
