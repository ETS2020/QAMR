...
module FAU ( 
  ...
  nand3  g75(.a(new_n50_), .b(x17), .c(new_n44_), .O(new_n119_));
  ...
  nor2   g81(.a(new_n56_), .b(new_n47_), .O(z14));
  aoi21  g82(.a(new_n55_), .b(x01), .c(new_n44_), .O(new_n127_));
  nand3  g83(.a(x19), .b(new_n44_), .c(new_n65_), .O(new_n128_));
  oai21  g84(.a(new_n127_), .b(new_n64_), .c(new_n128_), .O(z15));
  nor2   g85(.a(new_n65_), .b(x00), .O(z16));
