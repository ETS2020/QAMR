...
module FAU ( 
  ...
  nand3  g46(.a(new_n49_), .b(x17), .c(new_n77_), .O(new_n96_));
  nand2  g47(.a(new_n96_), .b(new_n95_), .O(new_n97_));
  nand2  g48(.a(new_n97_), .b(new_n69_), .O(new_n98_));
  inv1   g49(.a(x24), .O(new_n99_));
  nand2  g50(.a(new_n99_), .b(x09), .O(new_n100_));
  aoi21  g51(.a(new_n98_), .b(new_n94_), .c(new_n100_), .O(z12));
  nor2   g52(.a(x19), .b(new_n47_), .O(new_n102_));
  and2   g53(.a(new_n102_), .b(new_n45_), .O(z13));
  nor2   g54(.a(new_n55_), .b(new_n46_), .O(z14));
  aoi21  g55(.a(new_n54_), .b(x01), .c(new_n77_), .O(new_n105_));
  nand3  g56(.a(x19), .b(new_n77_), .c(new_n60_), .O(new_n106_));
  oai21  g57(.a(new_n105_), .b(new_n59_), .c(new_n106_), .O(z15));
  nor2   g58(.a(new_n60_), .b(x00), .O(z16));
  inv1   g59(.a(new_n70_), .O(z17));
  zero   g60(.O(z03));
  zero   g61(.O(z04));
  zero   g62(.O(z06));
  zero   g63(.O(z07));
