...
module FAU ( 
  ...
  inv1   g08(.a(new_n50_), .O(new_n54_));
  nand4  g09(.a(new_n47_), .b(x18), .c(new_n45_), .d(new_n49_), .O(new_n55_));
  ...
  oai22  g16(.a(new_n61_), .b(new_n59_), .c(new_n55_), .d(new_n54_), .O(z03));
  ...
  nand2  g31(.a(new_n50_), .b(x02), .O(new_n78_));
  nand3  g32(.a(x19), .b(new_n46_), .c(x17), .O(new_n79_));
  ...
  nor2   g38(.a(new_n49_), .b(x01), .O(new_n85_));
  inv1   g39(.a(x13), .O(new_n86_));
  inv1   g40(.a(x14), .O(new_n87_));
  nand4  g41(.a(new_n87_), .b(new_n86_), .c(x12), .d(new_n57_), .O(new_n88_));
  ...
  nand3  g48(.a(new_n94_), .b(new_n93_), .c(new_n67_), .O(new_n95_));
  aoi21  g49(.a(new_n92_), .b(new_n90_), .c(new_n95_), .O(z09));
  nand4  g50(.a(new_n91_), .b(x21), .c(x18), .d(x01), .O(new_n98_));
  nand4  g51(.a(new_n93_), .b(x20), .c(new_n82_), .d(x15), .O(new_n99_));
  inv1   g52(.a(new_n99_), .O(new_n100_));
  nand3  g53(.a(new_n100_), .b(new_n89_), .c(new_n85_), .O(new_n101_));
  nand2  g54(.a(new_n94_), .b(new_n67_), .O(new_n102_));
  aoi21  g55(.a(new_n101_), .b(new_n98_), .c(new_n102_), .O(z11));
  aoi21  g56(.a(new_n56_), .b(x01), .c(new_n49_), .O(new_n107_));
  nand3  g57(.a(x19), .b(new_n49_), .c(new_n68_), .O(new_n108_));
  oai21  g58(.a(new_n107_), .b(new_n67_), .c(new_n108_), .O(z15));
  nor2   g59(.a(new_n68_), .b(x00), .O(z16));
  inv1   g60(.a(new_n78_), .O(z17));
  zero   g61(.O(z00));
  zero   g62(.O(z02));
  zero   g63(.O(z05));
  zero   g64(.O(z10));
