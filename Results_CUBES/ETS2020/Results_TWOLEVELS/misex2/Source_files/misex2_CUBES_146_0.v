...
module FAU ( 
  ...
  nand3  g23(.a(new_n59_), .b(new_n47_), .c(x02), .O(new_n70_));
  nor3   g24(.a(new_n70_), .b(new_n62_), .c(new_n61_), .O(z06));
  nand4  g25(.a(new_n59_), .b(new_n66_), .c(new_n47_), .d(x01), .O(new_n72_));
  ...
  nand2  g32(.a(new_n45_), .b(x02), .O(new_n79_));
  ...
  nand3  g55(.a(new_n101_), .b(x12), .c(new_n58_), .O(new_n102_));
