...
module FAU ( 
  ...
  nand2  g33(.a(x02), .b(new_n59_), .O(new_n81_));
  inv1   g34(.a(x13), .O(new_n82_));
  nand3  g35(.a(new_n82_), .b(x12), .c(new_n62_), .O(new_n83_));
  ...
  nand2  g50(.a(new_n88_), .b(new_n58_), .O(new_n98_));
  aoi21  g51(.a(new_n97_), .b(new_n93_), .c(new_n98_), .O(z11));
  inv1   g52(.a(x02), .O(new_n100_));
  oai21  g53(.a(new_n54_), .b(new_n100_), .c(new_n60_), .O(new_n101_));
  oai21  g54(.a(x19), .b(x02), .c(x23), .O(new_n102_));
  nand3  g55(.a(new_n49_), .b(x17), .c(new_n100_), .O(new_n103_));
  ...
  aoi21  g64(.a(new_n54_), .b(x01), .c(new_n100_), .O(new_n112_));
  nand3  g65(.a(x19), .b(new_n100_), .c(new_n59_), .O(new_n113_));
