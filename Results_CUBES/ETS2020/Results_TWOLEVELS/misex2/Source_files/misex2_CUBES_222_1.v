...
module FAU ( 
  ...
  nor2   g31(.a(x06), .b(x05), .O(new_n78_));
  nor2   g32(.a(x08), .b(x07), .O(new_n79_));
  nand4  g33(.a(new_n79_), .b(new_n78_), .c(x04), .d(new_n77_), .O(new_n80_));
  nand2  g34(.a(new_n46_), .b(x02), .O(new_n81_));
  nand3  g35(.a(x19), .b(new_n49_), .c(x17), .O(new_n82_));
  nor3   g36(.a(new_n82_), .b(new_n81_), .c(new_n80_), .O(z08));
  ...
  nor2   g41(.a(new_n44_), .b(x01), .O(new_n88_));
  inv1   g42(.a(x13), .O(new_n89_));
  inv1   g43(.a(x14), .O(new_n90_));
  nand4  g44(.a(new_n90_), .b(new_n89_), .c(x12), .d(new_n61_), .O(new_n91_));
  inv1   g45(.a(new_n91_), .O(new_n92_));
  nand3  g46(.a(new_n92_), .b(new_n88_), .c(new_n87_), .O(new_n93_));
  inv1   g47(.a(x20), .O(new_n94_));
  nand4  g48(.a(new_n94_), .b(new_n50_), .c(x18), .d(x01), .O(new_n95_));
  inv1   g49(.a(x21), .O(new_n96_));
  inv1   g50(.a(x22), .O(new_n97_));
  nand3  g51(.a(new_n97_), .b(new_n96_), .c(new_n64_), .O(new_n98_));
  aoi21  g52(.a(new_n95_), .b(new_n93_), .c(new_n98_), .O(z09));
  oai21  g53(.a(new_n55_), .b(new_n44_), .c(new_n66_), .O(new_n102_));
  ...
  aoi21  g64(.a(new_n55_), .b(x01), .c(new_n44_), .O(new_n113_));
  nand3  g65(.a(x19), .b(new_n44_), .c(new_n65_), .O(new_n114_));
  oai21  g66(.a(new_n113_), .b(new_n64_), .c(new_n114_), .O(z15));
  nor2   g67(.a(new_n65_), .b(x00), .O(z16));
  inv1   g68(.a(new_n81_), .O(z17));
  zero   g69(.O(z01));
  zero   g70(.O(z04));
  zero   g71(.O(z05));
  zero   g72(.O(z10));
