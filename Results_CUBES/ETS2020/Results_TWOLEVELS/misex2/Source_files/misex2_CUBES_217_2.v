...
module FAU ( 
  ...
  nand3  g46(.a(new_n93_), .b(x12), .c(new_n62_), .O(new_n94_));
  nor2   g47(.a(new_n94_), .b(new_n80_), .O(new_n95_));
  nor2   g48(.a(new_n76_), .b(x14), .O(new_n96_));
  nand4  g49(.a(new_n89_), .b(new_n88_), .c(x20), .d(x16), .O(new_n97_));
  ...
  nand3  g53(.a(new_n86_), .b(new_n85_), .c(x21), .O(new_n101_));
  nand3  g54(.a(new_n88_), .b(x20), .c(new_n77_), .O(new_n102_));
  inv1   g55(.a(new_n102_), .O(new_n103_));
  nand3  g56(.a(new_n103_), .b(new_n96_), .c(new_n95_), .O(new_n104_));
  nand2  g57(.a(new_n89_), .b(new_n57_), .O(new_n105_));
  aoi21  g58(.a(new_n104_), .b(new_n101_), .c(new_n105_), .O(z11));
  oai21  g59(.a(new_n53_), .b(new_n45_), .c(new_n59_), .O(new_n107_));
  oai21  g60(.a(x19), .b(x02), .c(x23), .O(new_n108_));
  nand3  g61(.a(new_n50_), .b(x17), .c(new_n45_), .O(new_n109_));
  nand2  g62(.a(new_n109_), .b(new_n108_), .O(new_n110_));
  nand2  g63(.a(new_n110_), .b(new_n46_), .O(new_n111_));
  inv1   g64(.a(x24), .O(new_n112_));
  nand2  g65(.a(new_n112_), .b(x09), .O(new_n113_));
  aoi21  g66(.a(new_n111_), .b(new_n107_), .c(new_n113_), .O(z12));
  nand2  g67(.a(new_n46_), .b(new_n45_), .O(new_n115_));
  nor3   g68(.a(new_n115_), .b(x19), .c(new_n48_), .O(z13));
  aoi21  g69(.a(new_n53_), .b(x01), .c(new_n45_), .O(new_n118_));
  nand3  g70(.a(x19), .b(new_n45_), .c(new_n58_), .O(new_n119_));
  oai21  g71(.a(new_n118_), .b(new_n57_), .c(new_n119_), .O(z15));
  nor2   g72(.a(new_n58_), .b(x00), .O(z16));
  inv1   g73(.a(new_n73_), .O(z17));
  zero   g74(.O(z00));
  zero   g75(.O(z03));
  zero   g76(.O(z06));
  zero   g77(.O(z07));
