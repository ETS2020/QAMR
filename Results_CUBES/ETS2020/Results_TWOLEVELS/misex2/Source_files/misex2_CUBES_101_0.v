...
module FAU ( 
  ...
  wire new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_, new_n51_,
    ...
    new_n122_, new_n124_, new_n126_, new_n127_;
  ...
  nand3  g24(.a(new_n68_), .b(new_n59_), .c(x10), .O(new_n69_));
  nor2   g25(.a(new_n69_), .b(new_n66_), .O(z04));
  nand3  g26(.a(new_n60_), .b(new_n62_), .c(x02), .O(new_n72_));
  nor3   g27(.a(new_n72_), .b(new_n64_), .c(new_n63_), .O(z06));
  nand4  g28(.a(new_n60_), .b(new_n68_), .c(new_n62_), .d(x01), .O(new_n74_));
  ...
  nand2  g43(.a(x02), .b(new_n64_), .O(new_n89_));
  inv1   g44(.a(new_n89_), .O(new_n90_));
  nor2   g45(.a(new_n68_), .b(x11), .O(new_n91_));
  nor2   g46(.a(x14), .b(x13), .O(new_n92_));
  nand4  g47(.a(new_n92_), .b(new_n91_), .c(new_n90_), .d(new_n88_), .O(new_n93_));
  nor2   g48(.a(x20), .b(x19), .O(new_n94_));
  nand3  g49(.a(new_n94_), .b(x18), .c(x01), .O(new_n95_));
  ...
  nor2   g54(.a(x20), .b(new_n64_), .O(new_n100_));
  nand4  g55(.a(new_n100_), .b(new_n56_), .c(x22), .d(x21), .O(new_n101_));
  inv1   g56(.a(x13), .O(new_n102_));
  nand3  g57(.a(new_n102_), .b(x12), .c(new_n59_), .O(new_n103_));
  nor2   g58(.a(new_n103_), .b(new_n89_), .O(new_n104_));
  nor2   g59(.a(new_n85_), .b(x14), .O(new_n105_));
  ...
  nand4  g64(.a(new_n94_), .b(x21), .c(x18), .d(x01), .O(new_n110_));
  nand3  g65(.a(new_n96_), .b(x20), .c(new_n86_), .O(new_n111_));
  inv1   g66(.a(new_n111_), .O(new_n112_));
  nand3  g67(.a(new_n112_), .b(new_n105_), .c(new_n104_), .O(new_n113_));
  nand2  g68(.a(new_n97_), .b(new_n63_), .O(new_n114_));
  aoi21  g69(.a(new_n113_), .b(new_n110_), .c(new_n114_), .O(z11));
  oai21  g70(.a(new_n53_), .b(new_n45_), .c(new_n65_), .O(new_n116_));
  oai21  g71(.a(x19), .b(x02), .c(x23), .O(new_n117_));
  nand3  g72(.a(new_n50_), .b(x17), .c(new_n45_), .O(new_n118_));
  ...
  nand2  g78(.a(new_n46_), .b(new_n45_), .O(new_n124_));
  nor3   g79(.a(new_n124_), .b(x19), .c(new_n48_), .O(z13));
  nor2   g80(.a(x10), .b(x09), .O(new_n126_));
  nand4  g81(.a(new_n126_), .b(new_n50_), .c(new_n49_), .d(new_n48_), .O(new_n127_));
  nor2   g82(.a(new_n127_), .b(new_n124_), .O(z14));
  zero   g83(.O(z00));
  zero   g84(.O(z05));
  zero   g85(.O(z15));
  zero   g86(.O(z16));
