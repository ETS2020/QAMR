...
module FAU ( 
  ...
  nand4  g40(.a(new_n86_), .b(new_n59_), .c(x22), .d(x21), .O(new_n87_));
  nand2  g41(.a(x02), .b(new_n85_), .O(new_n88_));
  inv1   g42(.a(x13), .O(new_n89_));
  nand3  g43(.a(new_n89_), .b(x12), .c(new_n62_), .O(new_n90_));
  ...
  nand3  g53(.a(new_n86_), .b(new_n59_), .c(x21), .O(new_n100_));
  ...
  inv1   g58(.a(x00), .O(new_n105_));
  nand2  g59(.a(new_n95_), .b(new_n105_), .O(new_n106_));
  aoi21  g60(.a(new_n104_), .b(new_n100_), .c(new_n106_), .O(z11));
  nor3   g61(.a(new_n54_), .b(x19), .c(new_n48_), .O(z13));
  nand4  g62(.a(new_n50_), .b(new_n49_), .c(new_n48_), .d(new_n55_), .O(new_n110_));
  nor2   g63(.a(new_n110_), .b(new_n47_), .O(z14));
  aoi21  g64(.a(new_n55_), .b(x01), .c(new_n44_), .O(new_n112_));
  nand3  g65(.a(x19), .b(new_n44_), .c(new_n85_), .O(new_n113_));
  oai21  g66(.a(new_n112_), .b(new_n105_), .c(new_n113_), .O(z15));
  zero   g67(.O(z01));
  zero   g68(.O(z04));
  zero   g69(.O(z09));
  zero   g70(.O(z12));
