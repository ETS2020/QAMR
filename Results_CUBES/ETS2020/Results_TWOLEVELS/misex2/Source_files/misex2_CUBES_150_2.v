...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n104_, new_n105_, new_n107_, new_n110_, new_n111_;
  ...
  nand2  g28(.a(x02), .b(new_n60_), .O(new_n77_));
  ...
  nand4  g37(.a(new_n85_), .b(new_n84_), .c(x20), .d(x16), .O(new_n86_));
  inv1   g38(.a(new_n86_), .O(new_n87_));
  nand3  g39(.a(new_n87_), .b(new_n83_), .c(new_n81_), .O(new_n88_));
  aoi21  g40(.a(new_n88_), .b(new_n76_), .c(x00), .O(z10));
  nand3  g41(.a(new_n75_), .b(new_n74_), .c(x21), .O(new_n90_));
  inv1   g42(.a(x16), .O(new_n91_));
  nand3  g43(.a(new_n84_), .b(x20), .c(new_n91_), .O(new_n92_));
  inv1   g44(.a(new_n92_), .O(new_n93_));
  nand3  g45(.a(new_n93_), .b(new_n83_), .c(new_n81_), .O(new_n94_));
  nand2  g46(.a(new_n85_), .b(new_n59_), .O(new_n95_));
  aoi21  g47(.a(new_n94_), .b(new_n90_), .c(new_n95_), .O(z11));
  nand2  g48(.a(x10), .b(x02), .O(new_n97_));
  nand3  g49(.a(new_n97_), .b(x01), .c(x00), .O(new_n98_));
  oai21  g50(.a(x19), .b(x02), .c(x23), .O(new_n99_));
  inv1   g51(.a(x02), .O(new_n100_));
  nand3  g52(.a(new_n49_), .b(x17), .c(new_n100_), .O(new_n101_));
  nand2  g53(.a(new_n101_), .b(new_n99_), .O(new_n102_));
  nand2  g54(.a(new_n102_), .b(new_n69_), .O(new_n103_));
  inv1   g55(.a(x24), .O(new_n104_));
  nand2  g56(.a(new_n104_), .b(x09), .O(new_n105_));
  aoi21  g57(.a(new_n103_), .b(new_n98_), .c(new_n105_), .O(z12));
  nor2   g58(.a(x19), .b(new_n47_), .O(new_n107_));
  and2   g59(.a(new_n107_), .b(new_n45_), .O(z13));
  nor2   g60(.a(new_n55_), .b(new_n46_), .O(z14));
  aoi21  g61(.a(new_n54_), .b(x01), .c(new_n100_), .O(new_n110_));
  nand3  g62(.a(x19), .b(new_n100_), .c(new_n60_), .O(new_n111_));
  oai21  g63(.a(new_n110_), .b(new_n59_), .c(new_n111_), .O(z15));
  nor2   g64(.a(new_n60_), .b(x00), .O(z16));
