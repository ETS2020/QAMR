...
module FAU ( 
  ...
  nor2   g33(.a(new_n60_), .b(x01), .O(new_n80_));
  inv1   g34(.a(x13), .O(new_n81_));
  inv1   g35(.a(x14), .O(new_n82_));
  nand4  g36(.a(new_n82_), .b(new_n81_), .c(x12), .d(new_n62_), .O(new_n83_));
  ...
  nand2  g49(.a(new_n89_), .b(new_n45_), .O(new_n97_));
  aoi21  g50(.a(new_n96_), .b(new_n93_), .c(new_n97_), .O(z11));
  nor2   g51(.a(new_n58_), .b(new_n49_), .O(z14));
  nor2   g52(.a(new_n46_), .b(x00), .O(z16));
  nand3  g53(.a(x02), .b(new_n46_), .c(new_n45_), .O(new_n104_));
