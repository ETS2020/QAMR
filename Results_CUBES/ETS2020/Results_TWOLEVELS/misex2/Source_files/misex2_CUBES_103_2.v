...
module FAU ( 
  ...
  wire new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_, new_n51_,
    new_n55_, new_n56_, new_n57_, new_n58_, new_n59_, new_n61_, new_n64_,
  ...
  nand4  g12(.a(new_n58_), .b(new_n57_), .c(x10), .d(new_n56_), .O(new_n59_));
  nor2   g13(.a(new_n59_), .b(new_n55_), .O(z04));
  inv1   g14(.a(x10), .O(new_n61_));
  nor3   g15(.a(new_n55_), .b(new_n61_), .c(new_n56_), .O(z05));
  nand4  g16(.a(new_n58_), .b(x11), .c(x10), .d(new_n56_), .O(new_n64_));
  nand2  g17(.a(x02), .b(x00), .O(new_n65_));
  aoi21  g18(.a(new_n64_), .b(x01), .c(new_n65_), .O(z07));
  ...
  nand2  g23(.a(new_n50_), .b(x02), .O(new_n71_));
  nand3  g24(.a(x19), .b(new_n46_), .c(x17), .O(new_n72_));
  ...
  nor2   g30(.a(new_n49_), .b(x01), .O(new_n78_));
  inv1   g31(.a(x13), .O(new_n79_));
  inv1   g32(.a(x14), .O(new_n80_));
  nand4  g33(.a(new_n80_), .b(new_n79_), .c(x12), .d(new_n57_), .O(new_n81_));
  ...
  nand4  g44(.a(new_n87_), .b(x20), .c(new_n75_), .d(x15), .O(new_n93_));
  inv1   g45(.a(new_n93_), .O(new_n94_));
  nand3  g46(.a(new_n94_), .b(new_n82_), .c(new_n78_), .O(new_n95_));
  ...
  nand3  g52(.a(new_n47_), .b(x17), .c(new_n49_), .O(new_n101_));
  nand2  g53(.a(new_n101_), .b(new_n100_), .O(new_n102_));
  nand2  g54(.a(new_n102_), .b(new_n50_), .O(new_n103_));
  inv1   g55(.a(x24), .O(new_n104_));
  nand2  g56(.a(new_n104_), .b(x09), .O(new_n105_));
  aoi21  g57(.a(new_n103_), .b(new_n99_), .c(new_n105_), .O(z12));
  aoi21  g58(.a(new_n61_), .b(x01), .c(new_n49_), .O(new_n109_));
  inv1   g59(.a(x01), .O(new_n110_));
  nand3  g60(.a(x19), .b(new_n49_), .c(new_n110_), .O(new_n111_));
  oai21  g61(.a(new_n109_), .b(new_n86_), .c(new_n111_), .O(z15));
  nor2   g62(.a(new_n110_), .b(x00), .O(z16));
