...
module FAU ( 
  ...
  nand4  g22(.a(new_n67_), .b(new_n58_), .c(x10), .d(new_n45_), .O(new_n68_));
  nor2   g23(.a(new_n68_), .b(new_n66_), .O(z04));
  nor3   g24(.a(new_n66_), .b(new_n57_), .c(new_n45_), .O(z05));
  nand3  g25(.a(new_n59_), .b(new_n45_), .c(x02), .O(new_n71_));
  nor3   g26(.a(new_n71_), .b(new_n62_), .c(new_n61_), .O(z06));
  nand4  g27(.a(new_n59_), .b(new_n67_), .c(new_n45_), .d(x01), .O(new_n73_));
  ...
  nand4  g44(.a(new_n89_), .b(new_n88_), .c(x12), .d(new_n58_), .O(new_n90_));
  ...
  nand4  g53(.a(new_n93_), .b(x21), .c(x18), .d(x01), .O(new_n100_));
  nand4  g54(.a(new_n95_), .b(x20), .c(new_n84_), .d(x15), .O(new_n101_));
  inv1   g55(.a(new_n101_), .O(new_n102_));
  nand3  g56(.a(new_n102_), .b(new_n91_), .c(new_n87_), .O(new_n103_));
  nand2  g57(.a(new_n96_), .b(new_n61_), .O(new_n104_));
  aoi21  g58(.a(new_n103_), .b(new_n100_), .c(new_n104_), .O(z11));
  nand4  g59(.a(new_n50_), .b(new_n49_), .c(new_n48_), .d(new_n57_), .O(new_n108_));
  nor2   g60(.a(new_n108_), .b(new_n47_), .O(z14));
  aoi21  g61(.a(new_n57_), .b(x01), .c(new_n44_), .O(new_n110_));
  nand3  g62(.a(x19), .b(new_n44_), .c(new_n62_), .O(new_n111_));
  oai21  g63(.a(new_n110_), .b(new_n61_), .c(new_n111_), .O(z15));
  nor2   g64(.a(new_n62_), .b(x00), .O(z16));
  inv1   g65(.a(new_n80_), .O(z17));
  zero   g66(.O(z01));
  zero   g67(.O(z02));
  zero   g68(.O(z10));
  zero   g69(.O(z12));
