...
module FAU ( 
  ...
  wire new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n52_, new_n53_,
    ...
    new_n104_, new_n105_, new_n106_, new_n109_;
  ...
  nand4  g46(.a(x12), .b(new_n58_), .c(x02), .d(new_n83_), .O(new_n94_));
  ...
  oai21  g50(.a(new_n57_), .b(new_n45_), .c(new_n63_), .O(new_n99_));
  oai21  g51(.a(x19), .b(x02), .c(x23), .O(new_n100_));
  inv1   g52(.a(x19), .O(new_n101_));
  nand3  g53(.a(new_n101_), .b(x17), .c(new_n45_), .O(new_n102_));
  nand2  g54(.a(new_n102_), .b(new_n100_), .O(new_n103_));
  nand2  g55(.a(new_n103_), .b(new_n46_), .O(new_n104_));
  inv1   g56(.a(x24), .O(new_n105_));
  nand2  g57(.a(new_n105_), .b(x09), .O(new_n106_));
  aoi21  g58(.a(new_n104_), .b(new_n99_), .c(new_n106_), .O(z12));
  nor3   g59(.a(new_n47_), .b(x19), .c(new_n55_), .O(z13));
  nand3  g60(.a(new_n48_), .b(new_n57_), .c(new_n61_), .O(new_n109_));
