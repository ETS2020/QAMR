...
module FAU ( 
  ...
  nand3  g72(.a(x19), .b(new_n46_), .c(new_n62_), .O(new_n120_));
  oai21  g73(.a(new_n119_), .b(new_n61_), .c(new_n120_), .O(z15));
  nand2  g74(.a(new_n47_), .b(x02), .O(new_n123_));
  inv1   g75(.a(new_n123_), .O(z17));
  zero   g76(.O(z00));
  zero   g77(.O(z01));
  zero   g78(.O(z05));
  zero   g79(.O(z08));
