...
module FAU ( 
  ...
  nor2   g43(.a(x20), .b(new_n66_), .O(new_n88_));
  nand4  g44(.a(new_n88_), .b(new_n57_), .c(x22), .d(x21), .O(new_n89_));
  nand2  g45(.a(x02), .b(new_n66_), .O(new_n90_));
  inv1   g46(.a(x13), .O(new_n91_));
  nand3  g47(.a(new_n91_), .b(x12), .c(new_n62_), .O(new_n92_));
  ...
  nand3  g57(.a(new_n88_), .b(new_n57_), .c(x21), .O(new_n102_));
  ...
  nand2  g62(.a(new_n97_), .b(new_n65_), .O(new_n107_));
  aoi21  g63(.a(new_n106_), .b(new_n102_), .c(new_n107_), .O(z11));
  oai21  g64(.a(new_n54_), .b(new_n59_), .c(new_n67_), .O(new_n109_));
  oai21  g65(.a(x19), .b(x02), .c(x23), .O(new_n110_));
  nand3  g66(.a(new_n49_), .b(x17), .c(new_n59_), .O(new_n111_));
  nand2  g67(.a(new_n111_), .b(new_n110_), .O(new_n112_));
  nand2  g68(.a(new_n112_), .b(new_n60_), .O(new_n113_));
  inv1   g69(.a(x24), .O(new_n114_));
  nand2  g70(.a(new_n114_), .b(x09), .O(new_n115_));
  aoi21  g71(.a(new_n113_), .b(new_n109_), .c(new_n115_), .O(z12));
  nor2   g72(.a(x19), .b(new_n47_), .O(new_n117_));
  and2   g73(.a(new_n117_), .b(new_n45_), .O(z13));
  nor2   g74(.a(new_n55_), .b(new_n46_), .O(z14));
  aoi21  g75(.a(new_n54_), .b(x01), .c(new_n59_), .O(new_n120_));
  nand3  g76(.a(x19), .b(new_n59_), .c(new_n66_), .O(new_n121_));
  oai21  g77(.a(new_n120_), .b(new_n65_), .c(new_n121_), .O(z15));
  nor2   g78(.a(new_n66_), .b(x00), .O(z16));
  inv1   g79(.a(new_n84_), .O(z17));
  zero   g80(.O(z09));
endmodule
