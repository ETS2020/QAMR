...
module FAU ( 
  ...
  nand4  g43(.a(new_n89_), .b(new_n88_), .c(x12), .d(new_n57_), .O(new_n90_));
  ...
  nand3  g50(.a(new_n96_), .b(new_n95_), .c(new_n61_), .O(new_n97_));
  ...
  nand2  g56(.a(new_n96_), .b(new_n61_), .O(new_n104_));
  aoi21  g57(.a(new_n103_), .b(new_n100_), .c(new_n104_), .O(z11));
  oai21  g58(.a(new_n56_), .b(new_n45_), .c(new_n63_), .O(new_n106_));
  oai21  g59(.a(x19), .b(x02), .c(x23), .O(new_n107_));
  nand3  g60(.a(new_n48_), .b(x17), .c(new_n45_), .O(new_n108_));
  ...
  nor2   g67(.a(new_n62_), .b(x00), .O(z16));
  inv1   g68(.a(new_n79_), .O(z17));
  zero   g69(.O(z00));
  zero   g70(.O(z02));
  zero   g71(.O(z05));
  zero   g72(.O(z10));
