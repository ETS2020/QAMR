...
module FAU ( 
  ...
  nor2   g37(.a(x20), .b(new_n64_), .O(new_n85_));
  nand4  g38(.a(new_n85_), .b(new_n56_), .c(x22), .d(x21), .O(new_n86_));
  nand2  g39(.a(x02), .b(new_n64_), .O(new_n87_));
  inv1   g40(.a(x13), .O(new_n88_));
  nand3  g41(.a(new_n88_), .b(x12), .c(new_n59_), .O(new_n89_));
  nor2   g42(.a(new_n89_), .b(new_n87_), .O(new_n90_));
  inv1   g43(.a(x15), .O(new_n91_));
  nor2   g44(.a(new_n91_), .b(x14), .O(new_n92_));
  inv1   g45(.a(x21), .O(new_n93_));
  inv1   g46(.a(x22), .O(new_n94_));
  nand4  g47(.a(new_n94_), .b(new_n93_), .c(x20), .d(x16), .O(new_n95_));
  inv1   g48(.a(new_n95_), .O(new_n96_));
  nand3  g49(.a(new_n96_), .b(new_n92_), .c(new_n90_), .O(new_n97_));
  aoi21  g50(.a(new_n97_), .b(new_n86_), .c(x00), .O(z10));
  nand3  g51(.a(new_n85_), .b(new_n56_), .c(x21), .O(new_n99_));
  inv1   g52(.a(x16), .O(new_n100_));
  nand3  g53(.a(new_n93_), .b(x20), .c(new_n100_), .O(new_n101_));
  inv1   g54(.a(new_n101_), .O(new_n102_));
  nand3  g55(.a(new_n102_), .b(new_n92_), .c(new_n90_), .O(new_n103_));
  nand2  g56(.a(new_n94_), .b(new_n63_), .O(new_n104_));
  aoi21  g57(.a(new_n103_), .b(new_n99_), .c(new_n104_), .O(z11));
  oai21  g58(.a(new_n53_), .b(new_n45_), .c(new_n65_), .O(new_n106_));
  oai21  g59(.a(x19), .b(x02), .c(x23), .O(new_n107_));
  nand3  g60(.a(new_n50_), .b(x17), .c(new_n45_), .O(new_n108_));
