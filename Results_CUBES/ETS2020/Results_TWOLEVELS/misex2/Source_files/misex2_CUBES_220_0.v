...
module FAU ( 
  ...
  nor2   g45(.a(new_n44_), .b(x01), .O(new_n90_));
  inv1   g46(.a(x13), .O(new_n91_));
  inv1   g47(.a(x14), .O(new_n92_));
  nand4  g48(.a(new_n92_), .b(new_n91_), .c(x12), .d(new_n60_), .O(new_n93_));
  ...
  nand4  g53(.a(new_n97_), .b(new_n96_), .c(x18), .d(x01), .O(new_n98_));
  inv1   g54(.a(x21), .O(new_n99_));
  inv1   g55(.a(x22), .O(new_n100_));
  nand3  g56(.a(new_n100_), .b(new_n99_), .c(new_n63_), .O(new_n101_));
  aoi21  g57(.a(new_n98_), .b(new_n95_), .c(new_n101_), .O(z09));
  nor2   g58(.a(new_n100_), .b(new_n99_), .O(new_n103_));
  nand4  g59(.a(new_n103_), .b(new_n56_), .c(new_n97_), .d(x01), .O(new_n104_));
  nand3  g60(.a(new_n100_), .b(new_n99_), .c(x20), .O(new_n105_));
  inv1   g61(.a(new_n105_), .O(new_n106_));
  nand4  g62(.a(x16), .b(x15), .c(new_n92_), .d(new_n91_), .O(new_n107_));
  inv1   g63(.a(new_n107_), .O(new_n108_));
  nand4  g64(.a(x12), .b(new_n60_), .c(x02), .d(new_n64_), .O(new_n109_));
  ...
  oai21  g68(.a(new_n52_), .b(new_n44_), .c(new_n65_), .O(new_n114_));
  oai21  g69(.a(x19), .b(x02), .c(x23), .O(new_n115_));
  nand3  g70(.a(new_n96_), .b(x17), .c(new_n44_), .O(new_n116_));
  ...
  nor3   g76(.a(new_n46_), .b(x19), .c(new_n58_), .O(z13));
  zero   g77(.O(z01));
  zero   g78(.O(z11));
  zero   g79(.O(z14));
  zero   g80(.O(z15));
