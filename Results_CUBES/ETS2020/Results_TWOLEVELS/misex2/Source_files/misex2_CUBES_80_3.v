...
module FAU ( 
  ...
  nand3  g26(.a(new_n63_), .b(new_n44_), .c(x02), .O(new_n72_));
  nor3   g27(.a(new_n72_), .b(new_n66_), .c(new_n65_), .O(z06));
  inv1   g28(.a(x12), .O(new_n74_));
  nand4  g29(.a(new_n63_), .b(new_n74_), .c(new_n44_), .d(x01), .O(new_n75_));
  nand2  g30(.a(x02), .b(x00), .O(new_n76_));
  aoi21  g31(.a(new_n75_), .b(x01), .c(new_n76_), .O(z07));
  inv1   g32(.a(x03), .O(new_n78_));
  nor2   g33(.a(x06), .b(x05), .O(new_n79_));
  nor2   g34(.a(x08), .b(x07), .O(new_n80_));
  nand4  g35(.a(new_n80_), .b(new_n79_), .c(x04), .d(new_n78_), .O(new_n81_));
  nand2  g36(.a(new_n60_), .b(x02), .O(new_n82_));
  nand3  g37(.a(x19), .b(new_n48_), .c(x17), .O(new_n83_));
  nor3   g38(.a(new_n83_), .b(new_n82_), .c(new_n81_), .O(z08));
  ...
  nand2  g43(.a(x02), .b(new_n66_), .O(new_n89_));
  inv1   g44(.a(new_n89_), .O(new_n90_));
  nor2   g45(.a(new_n74_), .b(x11), .O(new_n91_));
  ...
  nand3  g52(.a(new_n97_), .b(new_n96_), .c(new_n65_), .O(new_n98_));
  aoi21  g53(.a(new_n95_), .b(new_n93_), .c(new_n98_), .O(z09));
  nor2   g54(.a(x20), .b(new_n66_), .O(new_n100_));
  nand4  g55(.a(new_n100_), .b(new_n57_), .c(x22), .d(x21), .O(new_n101_));
  ...
  nand2  g68(.a(new_n97_), .b(new_n65_), .O(new_n114_));
  aoi21  g69(.a(new_n113_), .b(new_n110_), .c(new_n114_), .O(z11));
  oai21  g70(.a(new_n54_), .b(new_n59_), .c(new_n67_), .O(new_n116_));
  oai21  g71(.a(x19), .b(x02), .c(x23), .O(new_n117_));
  nand3  g72(.a(new_n49_), .b(x17), .c(new_n59_), .O(new_n118_));
  ...
  nor2   g78(.a(x19), .b(new_n47_), .O(new_n124_));
  and2   g79(.a(new_n124_), .b(new_n45_), .O(z13));
  nor2   g80(.a(new_n55_), .b(new_n46_), .O(z14));
  aoi21  g81(.a(new_n54_), .b(x01), .c(new_n59_), .O(new_n127_));
  nand3  g82(.a(x19), .b(new_n59_), .c(new_n66_), .O(new_n128_));
  oai21  g83(.a(new_n127_), .b(new_n65_), .c(new_n128_), .O(z15));
  nor2   g84(.a(new_n66_), .b(x00), .O(z16));
