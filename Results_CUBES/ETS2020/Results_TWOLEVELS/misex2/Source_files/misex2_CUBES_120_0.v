// Benchmark "FAU" written by ABC on Tue Jul  7 11:01:02 2020
...
module FAU ( 
  ...
  nand4  g59(.a(new_n103_), .b(new_n59_), .c(x22), .d(x21), .O(new_n104_));
  ...
  oai21  g74(.a(new_n55_), .b(new_n44_), .c(new_n67_), .O(new_n119_));
  ...
  nor3   g82(.a(new_n54_), .b(x19), .c(new_n48_), .O(z13));
  nand4  g83(.a(new_n50_), .b(new_n49_), .c(new_n48_), .d(new_n55_), .O(new_n128_));
