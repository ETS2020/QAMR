...
module FAU ( 
  ...
  nand4  g26(.a(new_n69_), .b(new_n60_), .c(x10), .d(new_n45_), .O(new_n70_));
  nor2   g27(.a(new_n70_), .b(new_n68_), .O(z04));
  nor3   g28(.a(new_n68_), .b(new_n55_), .c(new_n45_), .O(z05));
  nand3  g29(.a(new_n61_), .b(new_n45_), .c(x02), .O(new_n73_));
  nor3   g30(.a(new_n73_), .b(new_n64_), .c(new_n63_), .O(z06));
  nand4  g31(.a(new_n61_), .b(new_n69_), .c(new_n45_), .d(x01), .O(new_n75_));
  ...
  nand3  g36(.a(x20), .b(new_n80_), .c(new_n79_), .O(new_n81_));
  inv1   g37(.a(new_n81_), .O(new_n82_));
  nor2   g38(.a(new_n44_), .b(x01), .O(new_n83_));
  inv1   g39(.a(x13), .O(new_n84_));
  inv1   g40(.a(x14), .O(new_n85_));
  nand4  g41(.a(new_n85_), .b(new_n84_), .c(x12), .d(new_n60_), .O(new_n86_));
  inv1   g42(.a(new_n86_), .O(new_n87_));
  nand3  g43(.a(new_n87_), .b(new_n83_), .c(new_n82_), .O(new_n88_));
  ...
  nand3  g48(.a(new_n92_), .b(new_n91_), .c(new_n63_), .O(new_n93_));
  aoi21  g49(.a(new_n90_), .b(new_n88_), .c(new_n93_), .O(z09));
  nand4  g50(.a(new_n89_), .b(x21), .c(x18), .d(x01), .O(new_n96_));
  nand4  g51(.a(new_n91_), .b(x20), .c(new_n80_), .d(x15), .O(new_n97_));
  inv1   g52(.a(new_n97_), .O(new_n98_));
  nand3  g53(.a(new_n98_), .b(new_n87_), .c(new_n83_), .O(new_n99_));
  nand2  g54(.a(new_n92_), .b(new_n63_), .O(new_n100_));
  aoi21  g55(.a(new_n99_), .b(new_n96_), .c(new_n100_), .O(z11));
  oai21  g56(.a(new_n55_), .b(new_n44_), .c(new_n65_), .O(new_n102_));
  oai21  g57(.a(x19), .b(x02), .c(x23), .O(new_n103_));
  nand3  g58(.a(new_n50_), .b(x17), .c(new_n44_), .O(new_n104_));
  ...
  aoi21  g63(.a(new_n106_), .b(new_n102_), .c(new_n108_), .O(z12));
  nor2   g64(.a(new_n56_), .b(new_n47_), .O(z14));
  aoi21  g65(.a(new_n55_), .b(x01), .c(new_n44_), .O(new_n112_));
  nand3  g66(.a(x19), .b(new_n44_), .c(new_n64_), .O(new_n113_));
  oai21  g67(.a(new_n112_), .b(new_n63_), .c(new_n113_), .O(z15));
  nor2   g68(.a(new_n64_), .b(x00), .O(z16));
  nand2  g69(.a(new_n46_), .b(x02), .O(new_n116_));
