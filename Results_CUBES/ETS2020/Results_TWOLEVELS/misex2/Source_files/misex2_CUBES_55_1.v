...
module FAU ( 
  ...
  nor2   g65(.a(x10), .b(x09), .O(new_n113_));
  nand4  g66(.a(new_n113_), .b(new_n50_), .c(new_n49_), .d(new_n48_), .O(new_n114_));
  nor2   g67(.a(new_n114_), .b(new_n112_), .O(z14));
  aoi21  g68(.a(new_n53_), .b(x01), .c(new_n45_), .O(new_n116_));
  nand3  g69(.a(x19), .b(new_n45_), .c(new_n64_), .O(new_n117_));
  oai21  g70(.a(new_n116_), .b(new_n63_), .c(new_n117_), .O(z15));
  nor2   g71(.a(new_n64_), .b(x00), .O(z16));
  nand2  g72(.a(new_n46_), .b(x02), .O(new_n120_));
  inv1   g73(.a(new_n120_), .O(z17));
  zero   g74(.O(z00));
  zero   g75(.O(z08));
  zero   g76(.O(z12));
  zero   g77(.O(z13));
