...
module FAU ( 
  ...
  nand4  g65(.a(x12), .b(new_n62_), .c(x02), .d(new_n66_), .O(new_n110_));
  ...
  oai21  g69(.a(new_n55_), .b(new_n44_), .c(new_n67_), .O(new_n115_));
  ...
  nand4  g77(.a(new_n50_), .b(new_n49_), .c(new_n48_), .d(new_n55_), .O(new_n124_));
  nor2   g78(.a(new_n124_), .b(new_n47_), .O(z14));
  aoi21  g79(.a(new_n55_), .b(x01), .c(new_n44_), .O(new_n126_));
  nand3  g80(.a(x19), .b(new_n44_), .c(new_n66_), .O(new_n127_));
  oai21  g81(.a(new_n126_), .b(new_n65_), .c(new_n127_), .O(z15));
