...
module FAU ( 
  ...
  inv1   g31(.a(x01), .O(new_n79_));
  nand2  g32(.a(x02), .b(new_n79_), .O(new_n80_));
  inv1   g33(.a(new_n80_), .O(new_n81_));
  nor2   g34(.a(new_n70_), .b(x11), .O(new_n82_));
  nor2   g35(.a(x14), .b(x13), .O(new_n83_));
  nand4  g36(.a(new_n83_), .b(new_n82_), .c(new_n81_), .d(new_n78_), .O(new_n84_));
  ...
  nor2   g44(.a(x20), .b(new_n79_), .O(new_n92_));
  ...
  nor2   g49(.a(new_n75_), .b(x14), .O(new_n97_));
  ...
  nand3  g55(.a(new_n88_), .b(x20), .c(new_n76_), .O(new_n103_));
  inv1   g56(.a(new_n103_), .O(new_n104_));
  nand3  g57(.a(new_n104_), .b(new_n97_), .c(new_n96_), .O(new_n105_));
  nand2  g58(.a(new_n89_), .b(new_n87_), .O(new_n106_));
  aoi21  g59(.a(new_n105_), .b(new_n102_), .c(new_n106_), .O(z11));
  oai21  g60(.a(new_n58_), .b(new_n44_), .c(new_n63_), .O(new_n108_));
  ...
  nand3  g73(.a(x19), .b(new_n44_), .c(new_n79_), .O(new_n121_));
  oai21  g74(.a(new_n120_), .b(new_n87_), .c(new_n121_), .O(z15));
  nor2   g75(.a(new_n79_), .b(x00), .O(z16));
