...
module FAU ( 
  ...
  nand4  g33(.a(x19), .b(new_n51_), .c(x17), .d(new_n77_), .O(new_n78_));
  ...
  nor2   g38(.a(x01), .b(x00), .O(new_n83_));
  nand3  g39(.a(new_n83_), .b(new_n82_), .c(x02), .O(new_n84_));
  nor3   g40(.a(new_n84_), .b(new_n81_), .c(new_n78_), .O(z08));
  ...
  nor2   g45(.a(new_n60_), .b(x01), .O(new_n90_));
  inv1   g46(.a(x13), .O(new_n91_));
  inv1   g47(.a(x14), .O(new_n92_));
  nand4  g48(.a(new_n92_), .b(new_n91_), .c(x12), .d(new_n62_), .O(new_n93_));
  ...
  nand3  g55(.a(new_n99_), .b(new_n98_), .c(new_n45_), .O(new_n100_));
  aoi21  g56(.a(new_n97_), .b(new_n95_), .c(new_n100_), .O(z09));
  nand4  g57(.a(new_n96_), .b(x21), .c(x18), .d(x01), .O(new_n103_));
  nand4  g58(.a(new_n98_), .b(x20), .c(new_n87_), .d(x15), .O(new_n104_));
  inv1   g59(.a(new_n104_), .O(new_n105_));
  nand3  g60(.a(new_n105_), .b(new_n94_), .c(new_n90_), .O(new_n106_));
  nand2  g61(.a(new_n99_), .b(new_n45_), .O(new_n107_));
  aoi21  g62(.a(new_n106_), .b(new_n103_), .c(new_n107_), .O(z11));
  oai21  g63(.a(new_n57_), .b(new_n60_), .c(new_n65_), .O(new_n109_));
  oai21  g64(.a(x19), .b(x02), .c(x23), .O(new_n110_));
  nand3  g65(.a(new_n52_), .b(x17), .c(new_n60_), .O(new_n111_));
  nand2  g66(.a(new_n111_), .b(new_n110_), .O(new_n112_));
  nand2  g67(.a(new_n112_), .b(new_n83_), .O(new_n113_));
