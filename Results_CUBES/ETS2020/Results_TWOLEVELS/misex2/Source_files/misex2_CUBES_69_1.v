...
module FAU ( 
  ...
  inv1   g36(.a(x01), .O(new_n82_));
  nand2  g37(.a(x02), .b(new_n82_), .O(new_n83_));
  inv1   g38(.a(new_n83_), .O(new_n84_));
  nor2   g39(.a(new_n73_), .b(x11), .O(new_n85_));
  nor2   g40(.a(x14), .b(x13), .O(new_n86_));
  nand4  g41(.a(new_n86_), .b(new_n85_), .c(new_n84_), .d(new_n81_), .O(new_n87_));
  nor2   g42(.a(x20), .b(x19), .O(new_n88_));
  nand3  g43(.a(new_n88_), .b(x18), .c(x01), .O(new_n89_));
  inv1   g44(.a(x00), .O(new_n90_));
  inv1   g45(.a(x21), .O(new_n91_));
  inv1   g46(.a(x22), .O(new_n92_));
  nand3  g47(.a(new_n92_), .b(new_n91_), .c(new_n90_), .O(new_n93_));
  aoi21  g48(.a(new_n89_), .b(new_n87_), .c(new_n93_), .O(z09));
  nor2   g49(.a(x20), .b(new_n82_), .O(new_n95_));
  ...
  nor2   g53(.a(new_n98_), .b(new_n83_), .O(new_n99_));
  nor2   g54(.a(new_n78_), .b(x14), .O(new_n100_));
  ...
  nand4  g59(.a(new_n88_), .b(x21), .c(x18), .d(x01), .O(new_n105_));
  nand3  g60(.a(new_n91_), .b(x20), .c(new_n79_), .O(new_n106_));
  inv1   g61(.a(new_n106_), .O(new_n107_));
  nand3  g62(.a(new_n107_), .b(new_n100_), .c(new_n99_), .O(new_n108_));
  nand2  g63(.a(new_n92_), .b(new_n90_), .O(new_n109_));
  aoi21  g64(.a(new_n108_), .b(new_n105_), .c(new_n109_), .O(z11));
  oai21  g65(.a(new_n54_), .b(new_n59_), .c(new_n66_), .O(new_n111_));
  ...
  nor2   g76(.a(new_n82_), .b(x00), .O(z16));
  zero   g77(.O(z04));
  zero   g78(.O(z08));
  zero   g79(.O(z15));
  zero   g80(.O(z17));
