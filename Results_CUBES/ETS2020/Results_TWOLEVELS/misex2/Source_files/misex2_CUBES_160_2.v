...
module FAU ( 
  ...
  inv1   g19(.a(x08), .O(new_n67_));
  nand4  g20(.a(x19), .b(new_n50_), .c(x17), .d(new_n67_), .O(new_n68_));
  inv1   g21(.a(x05), .O(new_n69_));
  nor2   g22(.a(x07), .b(x06), .O(new_n70_));
  nand3  g23(.a(new_n70_), .b(new_n69_), .c(x04), .O(new_n71_));
  inv1   g24(.a(x03), .O(new_n72_));
  nand4  g25(.a(new_n72_), .b(x02), .c(new_n45_), .d(new_n44_), .O(new_n73_));
  nor3   g26(.a(new_n73_), .b(new_n71_), .c(new_n68_), .O(z08));
  ...
  nand3  g37(.a(new_n84_), .b(new_n79_), .c(new_n78_), .O(new_n85_));
  inv1   g38(.a(x20), .O(new_n86_));
  nand4  g39(.a(new_n86_), .b(new_n51_), .c(x18), .d(x01), .O(new_n87_));
  inv1   g40(.a(x21), .O(new_n88_));
  inv1   g41(.a(x22), .O(new_n89_));
  nand3  g42(.a(new_n89_), .b(new_n88_), .c(new_n44_), .O(new_n90_));
  aoi21  g43(.a(new_n87_), .b(new_n85_), .c(new_n90_), .O(z09));
  nand4  g44(.a(new_n51_), .b(new_n50_), .c(new_n49_), .d(new_n55_), .O(new_n96_));
  nor2   g45(.a(new_n96_), .b(new_n48_), .O(z14));
  aoi21  g46(.a(new_n55_), .b(x01), .c(new_n46_), .O(new_n98_));
  nand3  g47(.a(x19), .b(new_n46_), .c(new_n45_), .O(new_n99_));
  oai21  g48(.a(new_n98_), .b(new_n44_), .c(new_n99_), .O(z15));
