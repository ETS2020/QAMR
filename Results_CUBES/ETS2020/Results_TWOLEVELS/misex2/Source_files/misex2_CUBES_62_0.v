...
module FAU ( 
  ...
  nand4  g16(.a(new_n49_), .b(new_n46_), .c(new_n45_), .d(new_n44_), .O(new_n61_));
  ...
  oai22  g22(.a(new_n66_), .b(new_n64_), .c(new_n61_), .d(new_n60_), .O(z03));
  nor4   g23(.a(new_n66_), .b(x12), .c(x11), .d(new_n55_), .O(z04));
  nand3  g24(.a(new_n63_), .b(new_n65_), .c(x02), .O(new_n70_));
  nor3   g25(.a(new_n70_), .b(new_n45_), .c(new_n44_), .O(z06));
  inv1   g26(.a(x12), .O(new_n72_));
  nand4  g27(.a(new_n63_), .b(new_n72_), .c(new_n65_), .d(x01), .O(new_n73_));
  ...
  nand2  g34(.a(x02), .b(new_n45_), .O(new_n81_));
  inv1   g35(.a(new_n81_), .O(new_n82_));
  nor2   g36(.a(new_n72_), .b(x11), .O(new_n83_));
  ...
  nand3  g43(.a(new_n89_), .b(new_n88_), .c(new_n44_), .O(new_n90_));
  aoi21  g44(.a(new_n87_), .b(new_n85_), .c(new_n90_), .O(z09));
  nor2   g45(.a(x20), .b(new_n45_), .O(new_n92_));
  nand4  g46(.a(new_n92_), .b(new_n59_), .c(x22), .d(x21), .O(new_n93_));
  ...
  nand2  g59(.a(new_n89_), .b(new_n44_), .O(new_n106_));
  aoi21  g60(.a(new_n105_), .b(new_n102_), .c(new_n106_), .O(z11));
  nor3   g61(.a(new_n47_), .b(x19), .c(new_n49_), .O(z13));
  nand4  g62(.a(new_n51_), .b(new_n50_), .c(new_n49_), .d(new_n55_), .O(new_n110_));
  nor2   g63(.a(new_n110_), .b(new_n48_), .O(z14));
  zero   g64(.O(z01));
  zero   g65(.O(z05));
  zero   g66(.O(z08));
  zero   g67(.O(z12));
