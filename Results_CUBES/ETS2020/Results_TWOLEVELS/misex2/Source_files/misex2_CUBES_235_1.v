...
module FAU ( 
  ...
  nand4  g44(.a(new_n90_), .b(new_n89_), .c(x12), .d(new_n62_), .O(new_n91_));
  ...
  nor2   g53(.a(new_n97_), .b(new_n96_), .O(new_n100_));
  nand4  g54(.a(new_n100_), .b(new_n58_), .c(new_n94_), .d(x01), .O(new_n101_));
  nand3  g55(.a(new_n97_), .b(new_n96_), .c(x20), .O(new_n102_));
  inv1   g56(.a(new_n102_), .O(new_n103_));
  nand4  g57(.a(x16), .b(x15), .c(new_n90_), .d(new_n89_), .O(new_n104_));
  inv1   g58(.a(new_n104_), .O(new_n105_));
  nand4  g59(.a(x12), .b(new_n62_), .c(x02), .d(new_n70_), .O(new_n106_));
  inv1   g60(.a(new_n106_), .O(new_n107_));
  nand3  g61(.a(new_n107_), .b(new_n105_), .c(new_n103_), .O(new_n108_));
  aoi21  g62(.a(new_n108_), .b(new_n101_), .c(x00), .O(z10));
  nor3   g63(.a(new_n53_), .b(x19), .c(new_n48_), .O(z13));
  nand4  g64(.a(new_n50_), .b(new_n49_), .c(new_n48_), .d(new_n61_), .O(new_n113_));
  nor2   g65(.a(new_n113_), .b(new_n47_), .O(z14));
  aoi21  g66(.a(new_n61_), .b(x01), .c(new_n44_), .O(new_n115_));
  nand3  g67(.a(x19), .b(new_n44_), .c(new_n70_), .O(new_n116_));
  oai21  g68(.a(new_n115_), .b(new_n69_), .c(new_n116_), .O(z15));
  nor2   g69(.a(new_n70_), .b(x00), .O(z16));
  inv1   g70(.a(new_n81_), .O(z17));
  zero   g71(.O(z02));
  zero   g72(.O(z04));
  zero   g73(.O(z05));
  zero   g74(.O(z11));
