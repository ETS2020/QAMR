...
module FAU ( 
  ...
  nand2  g27(.a(new_n46_), .b(x02), .O(new_n75_));
  nand3  g28(.a(x19), .b(new_n49_), .c(x17), .O(new_n76_));
  nor3   g29(.a(new_n76_), .b(new_n75_), .c(new_n74_), .O(z08));
  nor2   g30(.a(new_n49_), .b(new_n61_), .O(new_n79_));
  nor2   g31(.a(x20), .b(x19), .O(new_n80_));
  nand4  g32(.a(new_n80_), .b(new_n79_), .c(x22), .d(x21), .O(new_n81_));
  nand2  g33(.a(x02), .b(new_n61_), .O(new_n82_));
  inv1   g34(.a(x13), .O(new_n83_));
  nand3  g35(.a(new_n83_), .b(x12), .c(new_n64_), .O(new_n84_));
  nor2   g36(.a(new_n84_), .b(new_n82_), .O(new_n85_));
  inv1   g37(.a(x15), .O(new_n86_));
  nor2   g38(.a(new_n86_), .b(x14), .O(new_n87_));
  inv1   g39(.a(x21), .O(new_n88_));
  inv1   g40(.a(x22), .O(new_n89_));
  nand4  g41(.a(new_n89_), .b(new_n88_), .c(x20), .d(x16), .O(new_n90_));
  inv1   g42(.a(new_n90_), .O(new_n91_));
  nand3  g43(.a(new_n91_), .b(new_n87_), .c(new_n85_), .O(new_n92_));
  aoi21  g44(.a(new_n92_), .b(new_n81_), .c(x00), .O(z10));
  nand3  g45(.a(new_n80_), .b(new_n79_), .c(x21), .O(new_n94_));
  inv1   g46(.a(x16), .O(new_n95_));
  nand3  g47(.a(new_n88_), .b(x20), .c(new_n95_), .O(new_n96_));
  inv1   g48(.a(new_n96_), .O(new_n97_));
  nand3  g49(.a(new_n97_), .b(new_n87_), .c(new_n85_), .O(new_n98_));
  nand2  g50(.a(new_n89_), .b(new_n60_), .O(new_n99_));
  aoi21  g51(.a(new_n98_), .b(new_n94_), .c(new_n99_), .O(z11));
  oai21  g52(.a(new_n55_), .b(new_n44_), .c(new_n62_), .O(new_n101_));
  ...
  nand3  g64(.a(x19), .b(new_n44_), .c(new_n61_), .O(new_n113_));
  oai21  g65(.a(new_n112_), .b(new_n60_), .c(new_n113_), .O(z15));
  nor2   g66(.a(new_n61_), .b(x00), .O(z16));
  inv1   g67(.a(new_n75_), .O(z17));
  zero   g68(.O(z01));
  zero   g69(.O(z03));
  zero   g70(.O(z06));
  zero   g71(.O(z07));
