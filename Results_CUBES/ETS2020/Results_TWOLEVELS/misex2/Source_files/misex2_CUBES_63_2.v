...
module FAU ( 
  ...
  inv1   g41(.a(x19), .O(new_n92_));
  nand3  g42(.a(new_n92_), .b(x17), .c(new_n44_), .O(new_n93_));
  nand2  g43(.a(new_n93_), .b(new_n91_), .O(new_n94_));
  nand2  g44(.a(new_n94_), .b(new_n45_), .O(new_n95_));
  inv1   g45(.a(x24), .O(new_n96_));
  nand2  g46(.a(new_n96_), .b(x09), .O(new_n97_));
  aoi21  g47(.a(new_n95_), .b(new_n90_), .c(new_n97_), .O(z12));
  nand2  g48(.a(new_n92_), .b(x17), .O(new_n99_));
  nor2   g49(.a(new_n99_), .b(new_n46_), .O(z13));
  aoi21  g50(.a(new_n47_), .b(x01), .c(new_n44_), .O(new_n102_));
  nand3  g51(.a(x19), .b(new_n44_), .c(new_n58_), .O(new_n103_));
  oai21  g52(.a(new_n102_), .b(new_n57_), .c(new_n103_), .O(z15));
  nor2   g53(.a(new_n58_), .b(x00), .O(z16));
  inv1   g54(.a(new_n67_), .O(z17));
  zero   g55(.O(z02));
  zero   g56(.O(z03));
  zero   g57(.O(z04));
  zero   g58(.O(z06));
