...
module FAU ( 
  ...
  nor3   g61(.a(new_n46_), .b(x19), .c(new_n49_), .O(z13));
  aoi21  g62(.a(new_n57_), .b(x01), .c(new_n44_), .O(new_n111_));
  nand3  g63(.a(x19), .b(new_n44_), .c(new_n77_), .O(new_n112_));
  oai21  g64(.a(new_n111_), .b(new_n89_), .c(new_n112_), .O(z15));
  nor2   g65(.a(new_n77_), .b(x00), .O(z16));
