...
module FAU ( 
  ...
  aoi21  g76(.a(new_n57_), .b(x01), .c(new_n44_), .O(new_n123_));
  nand3  g77(.a(x19), .b(new_n44_), .c(new_n67_), .O(new_n124_));
  oai21  g78(.a(new_n123_), .b(new_n66_), .c(new_n124_), .O(z15));
  nand2  g79(.a(new_n45_), .b(x02), .O(new_n127_));
