...
module FAU ( 
  ...
  nand3  g11(.a(new_n51_), .b(new_n50_), .c(new_n49_), .O(new_n55_));
  ...
  nor4   g18(.a(new_n63_), .b(new_n60_), .c(new_n59_), .d(x09), .O(z04));
  nor2   g19(.a(new_n60_), .b(new_n54_), .O(z05));
  nor2   g20(.a(x20), .b(x19), .O(new_n71_));
  nand4  g21(.a(new_n71_), .b(x21), .c(x18), .d(x01), .O(new_n72_));
  inv1   g22(.a(x16), .O(new_n73_));
  inv1   g23(.a(x21), .O(new_n74_));
  nand4  g24(.a(new_n74_), .b(x20), .c(new_n73_), .d(x15), .O(new_n75_));
  inv1   g25(.a(new_n75_), .O(new_n76_));
  nor2   g26(.a(new_n46_), .b(x01), .O(new_n77_));
  inv1   g27(.a(x13), .O(new_n78_));
  inv1   g28(.a(x14), .O(new_n79_));
  nand4  g29(.a(new_n79_), .b(new_n78_), .c(x12), .d(new_n61_), .O(new_n80_));
  inv1   g30(.a(new_n80_), .O(new_n81_));
  nand3  g31(.a(new_n81_), .b(new_n77_), .c(new_n76_), .O(new_n82_));
  inv1   g32(.a(x22), .O(new_n83_));
  nand2  g33(.a(new_n83_), .b(new_n44_), .O(new_n84_));
  aoi21  g34(.a(new_n82_), .b(new_n72_), .c(new_n84_), .O(z11));
  nor3   g35(.a(new_n47_), .b(x19), .c(new_n49_), .O(z13));
  nand4  g36(.a(new_n51_), .b(new_n50_), .c(new_n49_), .d(new_n59_), .O(new_n88_));
  nor2   g37(.a(new_n88_), .b(new_n48_), .O(z14));
  aoi21  g38(.a(new_n59_), .b(x01), .c(new_n46_), .O(new_n90_));
