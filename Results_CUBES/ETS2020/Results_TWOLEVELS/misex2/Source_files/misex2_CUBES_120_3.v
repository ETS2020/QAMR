...
module FAU ( 
  ...
  aoi21  g81(.a(new_n57_), .b(x01), .c(new_n44_), .O(new_n128_));
  nand3  g82(.a(x19), .b(new_n44_), .c(new_n89_), .O(new_n129_));
  oai21  g83(.a(new_n128_), .b(new_n97_), .c(new_n129_), .O(z15));
  nor2   g84(.a(new_n89_), .b(x00), .O(z16));
