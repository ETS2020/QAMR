...
module FAU ( 
  ...
  nand4  g17(.a(new_n48_), .b(x18), .c(new_n53_), .d(new_n44_), .O(new_n61_));
  ...
  oai22  g25(.a(new_n68_), .b(new_n64_), .c(new_n61_), .d(new_n60_), .O(z03));
  nand2  g26(.a(new_n67_), .b(x02), .O(new_n70_));
  inv1   g27(.a(x12), .O(new_n71_));
  nand4  g28(.a(new_n71_), .b(new_n62_), .c(x10), .d(new_n47_), .O(new_n72_));
  nor2   g29(.a(new_n72_), .b(new_n70_), .O(z04));
  nor3   g30(.a(new_n70_), .b(new_n57_), .c(new_n47_), .O(z05));
  nand3  g31(.a(new_n63_), .b(new_n47_), .c(x02), .O(new_n75_));
  nor3   g32(.a(new_n75_), .b(new_n66_), .c(new_n65_), .O(z06));
  nand4  g33(.a(new_n63_), .b(new_n71_), .c(new_n47_), .d(x01), .O(new_n77_));
  nand2  g34(.a(x02), .b(x00), .O(new_n78_));
  aoi21  g35(.a(new_n77_), .b(x01), .c(new_n78_), .O(z07));
  inv1   g36(.a(x08), .O(new_n80_));
  nand4  g37(.a(x19), .b(new_n54_), .c(x17), .d(new_n80_), .O(new_n81_));
  ...
  nand3  g42(.a(new_n45_), .b(new_n85_), .c(x02), .O(new_n86_));
  ...
  nor2   g48(.a(new_n44_), .b(x01), .O(new_n92_));
  ...
  nand4  g60(.a(new_n98_), .b(x21), .c(x18), .d(x01), .O(new_n105_));
  nand4  g61(.a(new_n100_), .b(x20), .c(new_n89_), .d(x15), .O(new_n106_));
  inv1   g62(.a(new_n106_), .O(new_n107_));
  nand3  g63(.a(new_n107_), .b(new_n96_), .c(new_n92_), .O(new_n108_));
  nand2  g64(.a(new_n101_), .b(new_n65_), .O(new_n109_));
  aoi21  g65(.a(new_n108_), .b(new_n105_), .c(new_n109_), .O(z11));
  oai21  g66(.a(new_n57_), .b(new_n44_), .c(new_n67_), .O(new_n111_));
  oai21  g67(.a(x19), .b(x02), .c(x23), .O(new_n112_));
  nand3  g68(.a(new_n48_), .b(x17), .c(new_n44_), .O(new_n113_));
  nand2  g69(.a(new_n113_), .b(new_n112_), .O(new_n114_));
  nand2  g70(.a(new_n114_), .b(new_n45_), .O(new_n115_));
  inv1   g71(.a(x24), .O(new_n116_));
  nand2  g72(.a(new_n116_), .b(x09), .O(new_n117_));
  aoi21  g73(.a(new_n115_), .b(new_n111_), .c(new_n117_), .O(z12));
  nor3   g74(.a(new_n46_), .b(x19), .c(new_n53_), .O(z13));
  zero   g75(.O(z10));
  zero   g76(.O(z14));
  zero   g77(.O(z15));
  zero   g78(.O(z16));
