...
module FAU ( 
  ...
  nor2   g08(.a(x17), .b(x02), .O(new_n54_));
  nand3  g09(.a(new_n54_), .b(new_n53_), .c(new_n46_), .O(new_n55_));
  ...
  nand4  g46(.a(new_n92_), .b(new_n53_), .c(x22), .d(x21), .O(new_n93_));
  inv1   g47(.a(x13), .O(new_n94_));
  nand3  g48(.a(new_n94_), .b(x12), .c(new_n57_), .O(new_n95_));
  ...
  nand2  g59(.a(new_n89_), .b(new_n61_), .O(new_n106_));
  aoi21  g60(.a(new_n105_), .b(new_n102_), .c(new_n106_), .O(z11));
  nand3  g61(.a(new_n48_), .b(new_n56_), .c(new_n60_), .O(new_n110_));
  nor2   g62(.a(new_n110_), .b(new_n47_), .O(z14));
  aoi21  g63(.a(new_n56_), .b(x01), .c(new_n45_), .O(new_n112_));
  nand3  g64(.a(x19), .b(new_n45_), .c(new_n62_), .O(new_n113_));
  oai21  g65(.a(new_n112_), .b(new_n61_), .c(new_n113_), .O(z15));
