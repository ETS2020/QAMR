...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    new_n53_, new_n57_, new_n58_, new_n59_, new_n63_, new_n64_, new_n65_,
  ...
  nand3  g08(.a(new_n49_), .b(new_n47_), .c(x09), .O(new_n53_));
  ...
  nand3  g24(.a(x20), .b(new_n72_), .c(new_n71_), .O(new_n73_));
  inv1   g25(.a(new_n73_), .O(new_n74_));
  nor2   g26(.a(new_n44_), .b(x01), .O(new_n75_));
  inv1   g27(.a(x11), .O(new_n76_));
  inv1   g28(.a(x13), .O(new_n77_));
  inv1   g29(.a(x14), .O(new_n78_));
  nand4  g30(.a(new_n78_), .b(new_n77_), .c(x12), .d(new_n76_), .O(new_n79_));
  inv1   g31(.a(new_n79_), .O(new_n80_));
  nand3  g32(.a(new_n80_), .b(new_n75_), .c(new_n74_), .O(new_n81_));
  ...
  nand3  g37(.a(new_n85_), .b(new_n84_), .c(new_n57_), .O(new_n86_));
  aoi21  g38(.a(new_n83_), .b(new_n81_), .c(new_n86_), .O(z09));
  nand4  g39(.a(new_n82_), .b(x21), .c(x18), .d(x01), .O(new_n89_));
  nand4  g40(.a(new_n84_), .b(x20), .c(new_n72_), .d(x15), .O(new_n90_));
  inv1   g41(.a(new_n90_), .O(new_n91_));
  nand3  g42(.a(new_n91_), .b(new_n80_), .c(new_n75_), .O(new_n92_));
  nand2  g43(.a(new_n85_), .b(new_n57_), .O(new_n93_));
  ...
  aoi21  g55(.a(new_n47_), .b(x01), .c(new_n44_), .O(new_n107_));
  nand3  g56(.a(x19), .b(new_n44_), .c(new_n58_), .O(new_n108_));
  oai21  g57(.a(new_n107_), .b(new_n57_), .c(new_n108_), .O(z15));
  nor2   g58(.a(new_n58_), .b(x00), .O(z16));
  inv1   g59(.a(new_n67_), .O(z17));
  zero   g60(.O(z01));
  zero   g61(.O(z03));
  zero   g62(.O(z04));
  zero   g63(.O(z06));
