...
module FAU ( 
  ...
  nor2   g56(.a(new_n98_), .b(new_n97_), .O(new_n101_));
  nand4  g57(.a(new_n101_), .b(new_n57_), .c(new_n94_), .d(x01), .O(new_n102_));
  nand3  g58(.a(new_n98_), .b(new_n97_), .c(x20), .O(new_n103_));
  inv1   g59(.a(new_n103_), .O(new_n104_));
  nand4  g60(.a(x16), .b(x15), .c(new_n90_), .d(new_n89_), .O(new_n105_));
  inv1   g61(.a(new_n105_), .O(new_n106_));
  inv1   g62(.a(x01), .O(new_n107_));
  nand4  g63(.a(x12), .b(new_n62_), .c(x02), .d(new_n107_), .O(new_n108_));
  inv1   g64(.a(new_n108_), .O(new_n109_));
  nand3  g65(.a(new_n109_), .b(new_n106_), .c(new_n104_), .O(new_n110_));
  aoi21  g66(.a(new_n110_), .b(new_n102_), .c(x00), .O(z10));
  oai21  g67(.a(new_n54_), .b(new_n59_), .c(new_n66_), .O(new_n113_));
  ...
  nand3  g79(.a(x19), .b(new_n59_), .c(new_n107_), .O(new_n125_));
  oai21  g80(.a(new_n124_), .b(new_n96_), .c(new_n125_), .O(z15));
  nor2   g81(.a(new_n107_), .b(x00), .O(z16));
