...
module FAU ( 
  ...
  nor2   g41(.a(new_n48_), .b(new_n59_), .O(new_n88_));
  ...
  oai21  g57(.a(new_n54_), .b(new_n81_), .c(new_n60_), .O(new_n105_));
  oai21  g58(.a(x19), .b(x02), .c(x23), .O(new_n106_));
  nand3  g59(.a(new_n49_), .b(x17), .c(new_n81_), .O(new_n107_));
  nand2  g60(.a(new_n107_), .b(new_n106_), .O(new_n108_));
  nand2  g61(.a(new_n108_), .b(new_n73_), .O(new_n109_));
  inv1   g62(.a(x24), .O(new_n110_));
  nand2  g63(.a(new_n110_), .b(x09), .O(new_n111_));
  aoi21  g64(.a(new_n109_), .b(new_n105_), .c(new_n111_), .O(z12));
  nor2   g65(.a(x19), .b(new_n47_), .O(new_n113_));
  and2   g66(.a(new_n113_), .b(new_n45_), .O(z13));
  nor2   g67(.a(new_n55_), .b(new_n46_), .O(z14));
  aoi21  g68(.a(new_n54_), .b(x01), .c(new_n81_), .O(new_n116_));
  nand3  g69(.a(x19), .b(new_n81_), .c(new_n59_), .O(new_n117_));
  oai21  g70(.a(new_n116_), .b(new_n58_), .c(new_n117_), .O(z15));
  nor2   g71(.a(new_n59_), .b(x00), .O(z16));
  inv1   g72(.a(new_n74_), .O(z17));
  zero   g73(.O(z03));
  zero   g74(.O(z06));
  zero   g75(.O(z07));
  zero   g76(.O(z11));
