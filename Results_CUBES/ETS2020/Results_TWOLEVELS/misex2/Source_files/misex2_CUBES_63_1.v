...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n109_, new_n110_, new_n111_, new_n116_;
  ...
  nand4  g59(.a(new_n103_), .b(new_n59_), .c(new_n97_), .d(x01), .O(new_n104_));
  ...
  nor3   g68(.a(new_n54_), .b(x19), .c(new_n48_), .O(z13));
  nand4  g69(.a(new_n50_), .b(new_n49_), .c(new_n48_), .d(new_n55_), .O(new_n116_));
  nor2   g70(.a(new_n116_), .b(new_n47_), .O(z14));
  inv1   g71(.a(new_n84_), .O(z17));
  zero   g72(.O(z01));
  zero   g73(.O(z11));
  zero   g74(.O(z12));
  zero   g75(.O(z15));
