...
module FAU ( 
  ...
  nand4  g45(.a(new_n92_), .b(new_n91_), .c(new_n48_), .d(x18), .O(new_n93_));
  ...
  oai21  g60(.a(new_n56_), .b(new_n45_), .c(new_n63_), .O(new_n108_));
  oai21  g61(.a(x19), .b(x02), .c(x23), .O(new_n109_));
  nand3  g62(.a(new_n48_), .b(x17), .c(new_n45_), .O(new_n110_));
