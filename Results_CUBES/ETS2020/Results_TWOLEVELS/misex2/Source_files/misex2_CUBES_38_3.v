...
module FAU ( 
  ...
  nor2   g42(.a(x20), .b(new_n65_), .O(new_n87_));
  nand4  g43(.a(new_n87_), .b(new_n58_), .c(x22), .d(x21), .O(new_n88_));
  nand2  g44(.a(x02), .b(new_n65_), .O(new_n89_));
  inv1   g45(.a(x13), .O(new_n90_));
  nand3  g46(.a(new_n90_), .b(x12), .c(new_n61_), .O(new_n91_));
  ...
  nand4  g52(.a(new_n96_), .b(new_n95_), .c(x20), .d(x16), .O(new_n97_));
  inv1   g53(.a(new_n97_), .O(new_n98_));
  nand3  g54(.a(new_n98_), .b(new_n94_), .c(new_n92_), .O(new_n99_));
  aoi21  g55(.a(new_n99_), .b(new_n88_), .c(x00), .O(z10));
  nand3  g56(.a(new_n87_), .b(new_n58_), .c(x21), .O(new_n101_));
  inv1   g57(.a(x16), .O(new_n102_));
  nand3  g58(.a(new_n95_), .b(x20), .c(new_n102_), .O(new_n103_));
  inv1   g59(.a(new_n103_), .O(new_n104_));
  nand3  g60(.a(new_n104_), .b(new_n94_), .c(new_n92_), .O(new_n105_));
  nand2  g61(.a(new_n96_), .b(new_n64_), .O(new_n106_));
  aoi21  g62(.a(new_n105_), .b(new_n101_), .c(new_n106_), .O(z11));
  oai21  g63(.a(new_n55_), .b(new_n44_), .c(new_n66_), .O(new_n108_));
  oai21  g64(.a(x19), .b(x02), .c(x23), .O(new_n109_));
  nand3  g65(.a(new_n50_), .b(x17), .c(new_n44_), .O(new_n110_));
  nand2  g66(.a(new_n110_), .b(new_n109_), .O(new_n111_));
  nand2  g67(.a(new_n111_), .b(new_n46_), .O(new_n112_));
  inv1   g68(.a(x24), .O(new_n113_));
  nand2  g69(.a(new_n113_), .b(x09), .O(new_n114_));
  aoi21  g70(.a(new_n112_), .b(new_n108_), .c(new_n114_), .O(z12));
  nor2   g71(.a(new_n56_), .b(new_n47_), .O(z14));
  aoi21  g72(.a(new_n55_), .b(x01), .c(new_n44_), .O(new_n118_));
  nand3  g73(.a(x19), .b(new_n44_), .c(new_n65_), .O(new_n119_));
  oai21  g74(.a(new_n118_), .b(new_n64_), .c(new_n119_), .O(z15));
  nor2   g75(.a(new_n65_), .b(x00), .O(z16));
