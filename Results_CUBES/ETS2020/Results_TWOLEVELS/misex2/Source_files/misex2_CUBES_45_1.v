...
module FAU ( 
  ...
  nand3  g68(.a(new_n48_), .b(new_n56_), .c(new_n60_), .O(new_n116_));
  nor2   g69(.a(new_n116_), .b(new_n47_), .O(z14));
  aoi21  g70(.a(new_n56_), .b(x01), .c(new_n45_), .O(new_n118_));
  nand3  g71(.a(x19), .b(new_n45_), .c(new_n62_), .O(new_n119_));
  oai21  g72(.a(new_n118_), .b(new_n61_), .c(new_n119_), .O(z15));
  nor2   g73(.a(new_n62_), .b(x00), .O(z16));
