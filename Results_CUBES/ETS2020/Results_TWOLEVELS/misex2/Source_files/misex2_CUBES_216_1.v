...
module FAU ( 
  ...
  oai22  g20(.a(new_n64_), .b(new_n63_), .c(new_n59_), .d(new_n58_), .O(z03));
  ...
  nand4  g36(.a(new_n83_), .b(new_n82_), .c(x12), .d(new_n61_), .O(new_n84_));
  ...
  nand3  g43(.a(new_n90_), .b(new_n89_), .c(new_n68_), .O(new_n91_));
  aoi21  g44(.a(new_n88_), .b(new_n86_), .c(new_n91_), .O(z09));
  nor3   g45(.a(new_n53_), .b(x19), .c(new_n48_), .O(z13));
  nand4  g46(.a(new_n50_), .b(new_n49_), .c(new_n48_), .d(new_n60_), .O(new_n97_));
  nor2   g47(.a(new_n97_), .b(new_n47_), .O(z14));
  aoi21  g48(.a(new_n60_), .b(x01), .c(new_n44_), .O(new_n99_));
  nand3  g49(.a(x19), .b(new_n44_), .c(new_n69_), .O(new_n100_));
  oai21  g50(.a(new_n99_), .b(new_n68_), .c(new_n100_), .O(z15));
  nor2   g51(.a(new_n69_), .b(x00), .O(z16));
