...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n69_, new_n70_, new_n71_, new_n74_, new_n76_, new_n77_, new_n80_,
  ...
  nand3  g10(.a(new_n47_), .b(new_n46_), .c(new_n45_), .O(new_n55_));
  nor2   g11(.a(x18), .b(x17), .O(new_n56_));
  nand4  g12(.a(new_n56_), .b(new_n51_), .c(new_n44_), .d(x09), .O(new_n57_));
  nor2   g13(.a(new_n57_), .b(new_n55_), .O(z02));
  nor2   g14(.a(x19), .b(new_n50_), .O(new_n59_));
  inv1   g15(.a(new_n59_), .O(new_n60_));
  inv1   g16(.a(x17), .O(new_n61_));
  nand4  g17(.a(new_n61_), .b(new_n47_), .c(new_n46_), .d(new_n45_), .O(new_n62_));
  inv1   g18(.a(x11), .O(new_n63_));
  nor2   g19(.a(new_n63_), .b(new_n44_), .O(new_n64_));
  nand2  g20(.a(new_n64_), .b(x12), .O(new_n65_));
  nor2   g21(.a(new_n46_), .b(new_n45_), .O(new_n66_));
  nand3  g22(.a(new_n66_), .b(new_n48_), .c(x02), .O(new_n67_));
  oai22  g23(.a(new_n67_), .b(new_n65_), .c(new_n62_), .d(new_n60_), .O(z03));
  nand2  g24(.a(new_n66_), .b(x02), .O(new_n69_));
  inv1   g25(.a(x12), .O(new_n70_));
  nand4  g26(.a(new_n70_), .b(new_n63_), .c(x10), .d(new_n48_), .O(new_n71_));
  nor2   g27(.a(new_n71_), .b(new_n69_), .O(z04));
  nor3   g28(.a(new_n69_), .b(new_n44_), .c(new_n48_), .O(z05));
  nand3  g29(.a(new_n64_), .b(new_n48_), .c(x02), .O(new_n74_));
  nor3   g30(.a(new_n74_), .b(new_n46_), .c(new_n45_), .O(z06));
  nand4  g31(.a(new_n64_), .b(new_n70_), .c(new_n48_), .d(x01), .O(new_n76_));
  ...
  nand2  g38(.a(x02), .b(new_n46_), .O(new_n84_));
  ...
  nand3  g47(.a(new_n92_), .b(new_n91_), .c(new_n45_), .O(new_n93_));
  aoi21  g48(.a(new_n90_), .b(new_n88_), .c(new_n93_), .O(z09));
  nor2   g49(.a(x20), .b(new_n46_), .O(new_n95_));
  nand4  g50(.a(new_n95_), .b(new_n59_), .c(x22), .d(x21), .O(new_n96_));
  inv1   g51(.a(x13), .O(new_n97_));
  nand3  g52(.a(new_n97_), .b(x12), .c(new_n63_), .O(new_n98_));
  ...
  nand2  g63(.a(new_n92_), .b(new_n45_), .O(new_n109_));
  aoi21  g64(.a(new_n108_), .b(new_n105_), .c(new_n109_), .O(z11));
  nor4   g65(.a(new_n52_), .b(new_n49_), .c(x17), .d(x10), .O(z14));
  aoi21  g66(.a(new_n44_), .b(x01), .c(new_n47_), .O(new_n114_));
  nand3  g67(.a(x19), .b(new_n47_), .c(new_n46_), .O(new_n115_));
  oai21  g68(.a(new_n114_), .b(new_n45_), .c(new_n115_), .O(z15));
  zero   g69(.O(z01));
  zero   g70(.O(z08));
  zero   g71(.O(z12));
  zero   g72(.O(z13));
