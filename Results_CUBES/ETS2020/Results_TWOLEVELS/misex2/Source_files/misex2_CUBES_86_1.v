...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n108_, new_n109_, new_n114_, new_n116_, new_n117_;
  ...
  nand4  g44(.a(new_n89_), .b(new_n88_), .c(x12), .d(new_n62_), .O(new_n90_));
  ...
  nand4  g55(.a(new_n100_), .b(new_n59_), .c(new_n93_), .d(x01), .O(new_n101_));
  nand3  g56(.a(new_n97_), .b(new_n96_), .c(x20), .O(new_n102_));
  inv1   g57(.a(new_n102_), .O(new_n103_));
  nand4  g58(.a(x16), .b(x15), .c(new_n89_), .d(new_n88_), .O(new_n104_));
  inv1   g59(.a(new_n104_), .O(new_n105_));
  inv1   g60(.a(x01), .O(new_n106_));
  nand4  g61(.a(x12), .b(new_n62_), .c(x02), .d(new_n106_), .O(new_n107_));
  inv1   g62(.a(new_n107_), .O(new_n108_));
  nand3  g63(.a(new_n108_), .b(new_n105_), .c(new_n103_), .O(new_n109_));
  aoi21  g64(.a(new_n109_), .b(new_n101_), .c(x00), .O(z10));
  ...
  nand3  g69(.a(x19), .b(new_n44_), .c(new_n106_), .O(new_n117_));
  oai21  g70(.a(new_n116_), .b(new_n95_), .c(new_n117_), .O(z15));
  nor2   g71(.a(new_n106_), .b(x00), .O(z16));
