// Benchmark "FAU" written by ABC on Sun Aug  2 12:30:24 2020
...
module FAU ( 
  ...
  inv1   g261(.a(new_n103_), .O(new_n363_));
  nand3  g262(.a(new_n363_), .b(new_n102_), .c(x00), .O(new_n364_));
  ...
  nand2  g347(.a(x15), .b(x00), .O(new_n449_));
  xor2a  g348(.a(new_n449_), .b(x14), .O(new_n450_));
  nor2   g349(.a(new_n450_), .b(new_n113_), .O(new_n451_));
  nand2  g350(.a(new_n212_), .b(x62), .O(new_n452_));
  nand2  g351(.a(x74), .b(x57), .O(new_n453_));
  nand2  g352(.a(new_n204_), .b(x58), .O(new_n454_));
  aoi21  g353(.a(new_n454_), .b(new_n453_), .c(x73), .O(new_n455_));
  nand3  g354(.a(new_n204_), .b(x73), .c(x54), .O(new_n456_));
  inv1   g355(.a(new_n456_), .O(new_n457_));
  oai21  g356(.a(new_n457_), .b(new_n455_), .c(x72), .O(new_n458_));
  nand2  g357(.a(x74), .b(x59), .O(new_n459_));
  nand2  g358(.a(new_n204_), .b(x60), .O(new_n460_));
  aoi21  g359(.a(new_n460_), .b(new_n459_), .c(new_n202_), .O(new_n461_));
  nand3  g360(.a(x74), .b(new_n202_), .c(x61), .O(new_n462_));
  inv1   g361(.a(new_n462_), .O(new_n463_));
  oai21  g362(.a(new_n463_), .b(new_n461_), .c(new_n201_), .O(new_n464_));
  nand3  g363(.a(new_n464_), .b(new_n458_), .c(new_n452_), .O(new_n465_));
  aoi22  g364(.a(new_n465_), .b(new_n290_), .c(new_n451_), .d(new_n138_), .O(new_n466_));
  nand2  g365(.a(new_n212_), .b(x30), .O(new_n467_));
  nand2  g366(.a(x74), .b(x25), .O(new_n468_));
  oai21  g367(.a(x74), .b(new_n317_), .c(new_n468_), .O(new_n469_));
  nand2  g368(.a(new_n469_), .b(new_n202_), .O(new_n470_));
  nand3  g369(.a(new_n204_), .b(x73), .c(x22), .O(new_n471_));
  nand2  g370(.a(new_n471_), .b(new_n470_), .O(new_n472_));
  nand2  g371(.a(new_n472_), .b(x72), .O(new_n473_));
  inv1   g372(.a(x28), .O(new_n474_));
  nand2  g373(.a(x74), .b(x27), .O(new_n475_));
  oai21  g374(.a(x74), .b(new_n474_), .c(new_n475_), .O(new_n476_));
  nand2  g375(.a(new_n476_), .b(x73), .O(new_n477_));
  nand3  g376(.a(x74), .b(new_n202_), .c(x29), .O(new_n478_));
  nand2  g377(.a(new_n478_), .b(new_n477_), .O(new_n479_));
  nand2  g378(.a(new_n479_), .b(new_n201_), .O(new_n480_));
  nand3  g379(.a(new_n480_), .b(new_n473_), .c(new_n467_), .O(new_n481_));
  nand2  g380(.a(new_n481_), .b(new_n310_), .O(new_n482_));
  oai21  g381(.a(new_n466_), .b(new_n145_), .c(new_n482_), .O(new_n483_));
  nand2  g382(.a(new_n483_), .b(new_n95_), .O(new_n484_));
  aoi21  g383(.a(new_n471_), .b(new_n470_), .c(new_n201_), .O(new_n485_));
  aoi21  g384(.a(new_n478_), .b(new_n477_), .c(x72), .O(new_n486_));
  oai21  g385(.a(new_n486_), .b(new_n485_), .c(new_n113_), .O(new_n487_));
  inv1   g386(.a(x30), .O(new_n488_));
  nand2  g387(.a(x71), .b(x62), .O(new_n489_));
  oai21  g388(.a(x71), .b(new_n488_), .c(new_n489_), .O(new_n490_));
  nand2  g389(.a(new_n490_), .b(new_n212_), .O(new_n491_));
  inv1   g390(.a(x58), .O(new_n492_));
  oai21  g391(.a(x74), .b(new_n492_), .c(new_n453_), .O(new_n493_));
  nand2  g392(.a(new_n493_), .b(new_n202_), .O(new_n494_));
  aoi21  g393(.a(new_n456_), .b(new_n494_), .c(new_n201_), .O(new_n495_));
  inv1   g394(.a(x60), .O(new_n496_));
  oai21  g395(.a(x74), .b(new_n496_), .c(new_n459_), .O(new_n497_));
  nand2  g396(.a(new_n497_), .b(x73), .O(new_n498_));
  aoi21  g397(.a(new_n462_), .b(new_n498_), .c(x72), .O(new_n499_));
  oai21  g398(.a(new_n499_), .b(new_n495_), .c(x71), .O(new_n500_));
  nand3  g399(.a(new_n500_), .b(new_n491_), .c(new_n487_), .O(new_n501_));
  nand2  g400(.a(new_n501_), .b(new_n313_), .O(new_n502_));
  nand2  g401(.a(x47), .b(x32), .O(new_n503_));
  xor2a  g402(.a(new_n503_), .b(x46), .O(new_n504_));
  nor2   g403(.a(new_n504_), .b(x71), .O(new_n505_));
  nand2  g404(.a(new_n505_), .b(new_n332_), .O(new_n506_));
  nand2  g405(.a(new_n506_), .b(new_n502_), .O(new_n507_));
  nand2  g406(.a(new_n507_), .b(x70), .O(new_n508_));
  aoi21  g407(.a(new_n508_), .b(new_n484_), .c(new_n93_), .O(new_n509_));
  nand2  g408(.a(new_n451_), .b(new_n95_), .O(new_n510_));
  nand2  g409(.a(new_n505_), .b(x70), .O(new_n511_));
  aoi21  g410(.a(new_n511_), .b(new_n510_), .c(new_n245_), .O(new_n512_));
  oai21  g411(.a(new_n512_), .b(new_n509_), .c(new_n92_), .O(new_n513_));
  nand2  g412(.a(x71), .b(x46), .O(new_n514_));
  oai21  g413(.a(new_n161_), .b(new_n488_), .c(new_n514_), .O(new_n515_));
  nand2  g414(.a(new_n515_), .b(x70), .O(new_n516_));
  nand2  g415(.a(new_n164_), .b(x14), .O(new_n517_));
  nand3  g416(.a(new_n132_), .b(x69), .c(x62), .O(new_n518_));
  nand3  g417(.a(new_n518_), .b(new_n517_), .c(new_n516_), .O(new_n519_));
  and2   g418(.a(new_n519_), .b(x67), .O(new_n520_));
  nand2  g419(.a(new_n481_), .b(new_n147_), .O(new_n521_));
  nand2  g420(.a(new_n465_), .b(new_n240_), .O(new_n522_));
  aoi21  g421(.a(new_n522_), .b(new_n521_), .c(new_n349_), .O(new_n523_));
  oai21  g422(.a(new_n523_), .b(new_n520_), .c(new_n143_), .O(new_n524_));
  nand2  g423(.a(new_n465_), .b(new_n137_), .O(new_n525_));
  nand2  g424(.a(x67), .b(x46), .O(new_n526_));
  nand2  g425(.a(new_n526_), .b(new_n525_), .O(new_n527_));
  nand2  g426(.a(new_n527_), .b(new_n259_), .O(new_n528_));
  aoi21  g427(.a(new_n528_), .b(new_n524_), .c(x66), .O(new_n529_));
  nand2  g428(.a(new_n519_), .b(new_n143_), .O(new_n530_));
  nand3  g429(.a(new_n169_), .b(x68), .c(x46), .O(new_n531_));
  aoi21  g430(.a(new_n531_), .b(new_n530_), .c(new_n262_), .O(new_n532_));
  oai21  g431(.a(new_n532_), .b(new_n529_), .c(new_n176_), .O(new_n533_));
  nand2  g432(.a(new_n533_), .b(new_n513_), .O(z14));
  inv1   g433(.a(x31), .O(new_n535_));
  inv1   g434(.a(x47), .O(new_n536_));
  oai22  g435(.a(new_n161_), .b(new_n535_), .c(new_n113_), .d(new_n536_), .O(new_n537_));
  nand2  g436(.a(new_n537_), .b(x70), .O(new_n538_));
  nand2  g437(.a(new_n164_), .b(x15), .O(new_n539_));
  nand3  g438(.a(new_n132_), .b(x69), .c(x63), .O(new_n540_));
  nand3  g439(.a(new_n540_), .b(new_n539_), .c(new_n538_), .O(new_n541_));
  and2   g440(.a(new_n541_), .b(x67), .O(new_n542_));
  nand2  g441(.a(x74), .b(x28), .O(new_n543_));
  nand2  g442(.a(new_n204_), .b(x29), .O(new_n544_));
  aoi21  g443(.a(new_n544_), .b(new_n543_), .c(new_n202_), .O(new_n545_));
  nand3  g444(.a(x74), .b(new_n202_), .c(x30), .O(new_n546_));
  inv1   g445(.a(new_n546_), .O(new_n547_));
  oai21  g446(.a(new_n547_), .b(new_n545_), .c(new_n201_), .O(new_n548_));
  nand2  g447(.a(new_n212_), .b(x31), .O(new_n549_));
  nand2  g448(.a(new_n204_), .b(x27), .O(new_n550_));
  aoi21  g449(.a(new_n550_), .b(new_n390_), .c(x73), .O(new_n551_));
  nand3  g450(.a(new_n204_), .b(x73), .c(x23), .O(new_n552_));
  inv1   g451(.a(new_n552_), .O(new_n553_));
  oai21  g452(.a(new_n553_), .b(new_n551_), .c(x72), .O(new_n554_));
  nand3  g453(.a(new_n554_), .b(new_n549_), .c(new_n548_), .O(new_n555_));
  nand2  g454(.a(new_n555_), .b(new_n147_), .O(new_n556_));
  nand2  g455(.a(x74), .b(x60), .O(new_n557_));
  nand2  g456(.a(new_n204_), .b(x61), .O(new_n558_));
  aoi21  g457(.a(new_n558_), .b(new_n557_), .c(new_n202_), .O(new_n559_));
  nand3  g458(.a(x74), .b(new_n202_), .c(x62), .O(new_n560_));
  inv1   g459(.a(new_n560_), .O(new_n561_));
  oai21  g460(.a(new_n561_), .b(new_n559_), .c(new_n201_), .O(new_n562_));
  nand2  g461(.a(new_n212_), .b(x63), .O(new_n563_));
  aoi21  g462(.a(new_n375_), .b(new_n374_), .c(x73), .O(new_n564_));
  nand3  g463(.a(new_n204_), .b(x73), .c(x55), .O(new_n565_));
  inv1   g464(.a(new_n565_), .O(new_n566_));
  oai21  g465(.a(new_n566_), .b(new_n564_), .c(x72), .O(new_n567_));
  nand3  g466(.a(new_n567_), .b(new_n563_), .c(new_n562_), .O(new_n568_));
  nand2  g467(.a(new_n568_), .b(new_n240_), .O(new_n569_));
  aoi21  g468(.a(new_n569_), .b(new_n556_), .c(new_n349_), .O(new_n570_));
  oai21  g469(.a(new_n570_), .b(new_n542_), .c(new_n156_), .O(new_n571_));
  nand2  g470(.a(new_n541_), .b(new_n157_), .O(new_n572_));
  aoi21  g471(.a(new_n572_), .b(new_n571_), .c(new_n187_), .O(new_n573_));
  nand4  g472(.a(new_n94_), .b(x69), .c(x65), .d(new_n92_), .O(new_n574_));
  aoi21  g473(.a(new_n569_), .b(new_n556_), .c(new_n574_), .O(new_n575_));
  oai21  g474(.a(new_n575_), .b(new_n573_), .c(new_n143_), .O(new_n576_));
  nand3  g475(.a(x71), .b(new_n138_), .c(x15), .O(new_n577_));
  inv1   g476(.a(new_n577_), .O(new_n578_));
  aoi21  g477(.a(new_n568_), .b(new_n290_), .c(new_n578_), .O(new_n579_));
  nand3  g478(.a(new_n115_), .b(new_n138_), .c(x47), .O(new_n580_));
  oai21  g479(.a(new_n579_), .b(x70), .c(new_n580_), .O(new_n581_));
  inv1   g480(.a(x15), .O(new_n582_));
  oai22  g481(.a(new_n114_), .b(new_n536_), .c(new_n96_), .d(new_n582_), .O(new_n583_));
  aoi22  g482(.a(new_n583_), .b(new_n141_), .c(new_n581_), .d(new_n94_), .O(new_n584_));
  nand2  g483(.a(new_n568_), .b(new_n93_), .O(new_n585_));
  oai21  g484(.a(new_n158_), .b(new_n536_), .c(new_n585_), .O(new_n586_));
  nand3  g485(.a(new_n586_), .b(new_n176_), .c(new_n132_), .O(new_n587_));
  oai21  g486(.a(new_n584_), .b(x64), .c(new_n587_), .O(new_n588_));
  nand2  g487(.a(new_n588_), .b(new_n144_), .O(new_n589_));
  nand2  g488(.a(new_n589_), .b(new_n576_), .O(z15));
  zero   g489(.O(z01));
  zero   g490(.O(z02));
  zero   g491(.O(z03));
  zero   g492(.O(z04));
