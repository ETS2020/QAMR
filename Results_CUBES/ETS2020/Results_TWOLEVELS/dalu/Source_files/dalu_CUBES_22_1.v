// Benchmark "FAU" written by ABC on Sun Aug  2 10:48:19 2020
...
module FAU ( 
  ...
  wire new_n93_, new_n94_, new_n95_, new_n96_, new_n97_, new_n98_, new_n99_,
    ...
    new_n653_, new_n657_, new_n658_, new_n659_, new_n660_, new_n661_,
  ...
  nor3   g178(.a(x12), .b(x11), .c(x10), .O(new_n271_));
  ...
  nor3   g189(.a(x44), .b(x43), .c(x42), .O(new_n282_));
  ...
  oai21  g562(.a(new_n441_), .b(new_n107_), .c(x11), .O(new_n657_));
  nand3  g563(.a(new_n366_), .b(new_n95_), .c(x00), .O(new_n658_));
  aoi21  g564(.a(new_n658_), .b(new_n657_), .c(new_n131_), .O(new_n659_));
  nand2  g565(.a(new_n659_), .b(new_n136_), .O(new_n660_));
  nand2  g566(.a(new_n141_), .b(x59), .O(new_n661_));
  inv1   g567(.a(x55), .O(new_n662_));
  nand2  g568(.a(x74), .b(x54), .O(new_n663_));
  oai21  g569(.a(x74), .b(new_n662_), .c(new_n663_), .O(new_n664_));
  nand2  g570(.a(new_n664_), .b(new_n146_), .O(new_n665_));
  nor2   g571(.a(x74), .b(new_n146_), .O(new_n666_));
  nand2  g572(.a(new_n666_), .b(x51), .O(new_n667_));
  nand2  g573(.a(new_n667_), .b(new_n665_), .O(new_n668_));
  nand2  g574(.a(new_n668_), .b(x72), .O(new_n669_));
  inv1   g575(.a(x57), .O(new_n670_));
  nand2  g576(.a(x74), .b(x56), .O(new_n671_));
  oai21  g577(.a(x74), .b(new_n670_), .c(new_n671_), .O(new_n672_));
  nand2  g578(.a(new_n672_), .b(x73), .O(new_n673_));
  nand2  g579(.a(new_n228_), .b(x58), .O(new_n674_));
  nand2  g580(.a(new_n674_), .b(new_n673_), .O(new_n675_));
  nand2  g581(.a(new_n675_), .b(new_n137_), .O(new_n676_));
  nand3  g582(.a(new_n676_), .b(new_n669_), .c(new_n661_), .O(new_n677_));
  nor2   g583(.a(x71), .b(new_n136_), .O(new_n678_));
  nand2  g584(.a(new_n678_), .b(new_n677_), .O(new_n679_));
  aoi21  g585(.a(new_n679_), .b(new_n660_), .c(new_n155_), .O(new_n680_));
  nand2  g586(.a(new_n141_), .b(x27), .O(new_n681_));
  nand2  g587(.a(x74), .b(x22), .O(new_n682_));
  oai21  g588(.a(x74), .b(new_n577_), .c(new_n682_), .O(new_n683_));
  nand2  g589(.a(new_n683_), .b(new_n146_), .O(new_n684_));
  nand2  g590(.a(new_n666_), .b(x19), .O(new_n685_));
  nand2  g591(.a(new_n685_), .b(new_n684_), .O(new_n686_));
  nand2  g592(.a(new_n686_), .b(x72), .O(new_n687_));
  inv1   g593(.a(x25), .O(new_n688_));
  nand2  g594(.a(x74), .b(x24), .O(new_n689_));
  oai21  g595(.a(x74), .b(new_n688_), .c(new_n689_), .O(new_n690_));
  nand2  g596(.a(new_n690_), .b(x73), .O(new_n691_));
  nand2  g597(.a(new_n228_), .b(x26), .O(new_n692_));
  nand2  g598(.a(new_n692_), .b(new_n691_), .O(new_n693_));
  nand2  g599(.a(new_n693_), .b(new_n137_), .O(new_n694_));
  nand3  g600(.a(new_n694_), .b(new_n687_), .c(new_n681_), .O(new_n695_));
  inv1   g601(.a(new_n695_), .O(new_n696_));
  nand3  g602(.a(new_n163_), .b(x71), .c(x69), .O(new_n697_));
  nor2   g603(.a(new_n697_), .b(new_n696_), .O(new_n698_));
  oai21  g604(.a(new_n698_), .b(new_n680_), .c(new_n111_), .O(new_n699_));
  aoi21  g605(.a(new_n685_), .b(new_n684_), .c(new_n137_), .O(new_n700_));
  aoi21  g606(.a(new_n692_), .b(new_n691_), .c(x72), .O(new_n701_));
  oai21  g607(.a(new_n701_), .b(new_n700_), .c(new_n131_), .O(new_n702_));
  inv1   g608(.a(x27), .O(new_n703_));
  nand2  g609(.a(x71), .b(x59), .O(new_n704_));
  oai21  g610(.a(x71), .b(new_n703_), .c(new_n704_), .O(new_n705_));
  nand2  g611(.a(new_n705_), .b(new_n141_), .O(new_n706_));
  aoi21  g612(.a(new_n667_), .b(new_n665_), .c(new_n137_), .O(new_n707_));
  aoi21  g613(.a(new_n674_), .b(new_n673_), .c(x72), .O(new_n708_));
  oai21  g614(.a(new_n708_), .b(new_n707_), .c(x71), .O(new_n709_));
  nand3  g615(.a(new_n709_), .b(new_n706_), .c(new_n702_), .O(new_n710_));
  nand2  g616(.a(new_n710_), .b(new_n165_), .O(new_n711_));
  oai21  g617(.a(new_n449_), .b(new_n127_), .c(x43), .O(new_n712_));
  nand3  g618(.a(new_n373_), .b(new_n115_), .c(x32), .O(new_n713_));
  aoi21  g619(.a(new_n713_), .b(new_n712_), .c(x71), .O(new_n714_));
  nand3  g620(.a(new_n169_), .b(x68), .c(new_n136_), .O(new_n715_));
  inv1   g621(.a(new_n715_), .O(new_n716_));
  nand2  g622(.a(new_n716_), .b(new_n714_), .O(new_n717_));
  nand2  g623(.a(new_n717_), .b(new_n711_), .O(new_n718_));
  nand2  g624(.a(new_n718_), .b(x70), .O(new_n719_));
  aoi21  g625(.a(new_n719_), .b(new_n699_), .c(new_n93_), .O(new_n720_));
  nand2  g626(.a(new_n659_), .b(new_n111_), .O(new_n721_));
  nand2  g627(.a(new_n714_), .b(x70), .O(new_n722_));
  aoi21  g628(.a(new_n722_), .b(new_n721_), .c(new_n171_), .O(new_n723_));
  oai21  g629(.a(new_n723_), .b(new_n720_), .c(new_n203_), .O(new_n724_));
  oai22  g630(.a(new_n176_), .b(new_n703_), .c(new_n131_), .d(new_n115_), .O(new_n725_));
  nand2  g631(.a(new_n725_), .b(x70), .O(new_n726_));
  nand2  g632(.a(new_n179_), .b(x11), .O(new_n727_));
  nand3  g633(.a(new_n181_), .b(x69), .c(x59), .O(new_n728_));
  nand3  g634(.a(new_n728_), .b(new_n727_), .c(new_n726_), .O(new_n729_));
  and2   g635(.a(new_n729_), .b(x67), .O(new_n730_));
  nand2  g636(.a(new_n695_), .b(new_n158_), .O(new_n731_));
  nand2  g637(.a(new_n677_), .b(new_n159_), .O(new_n732_));
  nand2  g638(.a(x69), .b(new_n168_), .O(new_n733_));
  aoi21  g639(.a(new_n732_), .b(new_n731_), .c(new_n733_), .O(new_n734_));
  oai21  g640(.a(new_n734_), .b(new_n730_), .c(new_n153_), .O(new_n735_));
  nand2  g641(.a(new_n677_), .b(new_n168_), .O(new_n736_));
  oai21  g642(.a(new_n168_), .b(new_n115_), .c(new_n736_), .O(new_n737_));
  nand2  g643(.a(new_n737_), .b(new_n324_), .O(new_n738_));
  aoi21  g644(.a(new_n738_), .b(new_n735_), .c(x66), .O(new_n739_));
  nand2  g645(.a(new_n729_), .b(new_n153_), .O(new_n740_));
  nand3  g646(.a(new_n186_), .b(x68), .c(x43), .O(new_n741_));
  aoi21  g647(.a(new_n741_), .b(new_n740_), .c(new_n329_), .O(new_n742_));
  oai21  g648(.a(new_n742_), .b(new_n739_), .c(new_n204_), .O(new_n743_));
  nand2  g649(.a(new_n743_), .b(new_n724_), .O(z11));
  oai21  g650(.a(new_n270_), .b(new_n107_), .c(x12), .O(new_n745_));
  inv1   g651(.a(new_n270_), .O(new_n746_));
  nor2   g652(.a(x12), .b(new_n107_), .O(new_n747_));
  nand2  g653(.a(new_n747_), .b(new_n746_), .O(new_n748_));
  aoi21  g654(.a(new_n748_), .b(new_n745_), .c(new_n131_), .O(new_n749_));
  nand2  g655(.a(new_n749_), .b(new_n136_), .O(new_n750_));
  nand2  g656(.a(new_n141_), .b(x60), .O(new_n751_));
  inv1   g657(.a(x56), .O(new_n752_));
  nand2  g658(.a(x74), .b(x55), .O(new_n753_));
  oai21  g659(.a(x74), .b(new_n752_), .c(new_n753_), .O(new_n754_));
  nand2  g660(.a(new_n754_), .b(new_n146_), .O(new_n755_));
  nand2  g661(.a(new_n666_), .b(x52), .O(new_n756_));
  nand2  g662(.a(new_n756_), .b(new_n755_), .O(new_n757_));
  nand2  g663(.a(new_n757_), .b(x72), .O(new_n758_));
  inv1   g664(.a(x58), .O(new_n759_));
  nand2  g665(.a(x74), .b(x57), .O(new_n760_));
  oai21  g666(.a(x74), .b(new_n759_), .c(new_n760_), .O(new_n761_));
  nand2  g667(.a(new_n761_), .b(x73), .O(new_n762_));
  nand2  g668(.a(new_n228_), .b(x59), .O(new_n763_));
  nand2  g669(.a(new_n763_), .b(new_n762_), .O(new_n764_));
  nand2  g670(.a(new_n764_), .b(new_n137_), .O(new_n765_));
  nand3  g671(.a(new_n765_), .b(new_n758_), .c(new_n751_), .O(new_n766_));
  nand2  g672(.a(new_n766_), .b(new_n678_), .O(new_n767_));
  aoi21  g673(.a(new_n767_), .b(new_n750_), .c(new_n155_), .O(new_n768_));
  nand2  g674(.a(new_n141_), .b(x28), .O(new_n769_));
  nand2  g675(.a(x74), .b(x23), .O(new_n770_));
  oai21  g676(.a(x74), .b(new_n638_), .c(new_n770_), .O(new_n771_));
  nand2  g677(.a(new_n771_), .b(new_n146_), .O(new_n772_));
  nand2  g678(.a(new_n666_), .b(x20), .O(new_n773_));
  nand2  g679(.a(new_n773_), .b(new_n772_), .O(new_n774_));
  nand2  g680(.a(new_n774_), .b(x72), .O(new_n775_));
  inv1   g681(.a(x26), .O(new_n776_));
  nand2  g682(.a(x74), .b(x25), .O(new_n777_));
  oai21  g683(.a(x74), .b(new_n776_), .c(new_n777_), .O(new_n778_));
  nand2  g684(.a(new_n778_), .b(x73), .O(new_n779_));
  nand2  g685(.a(new_n228_), .b(x27), .O(new_n780_));
  nand2  g686(.a(new_n780_), .b(new_n779_), .O(new_n781_));
  nand2  g687(.a(new_n781_), .b(new_n137_), .O(new_n782_));
  nand3  g688(.a(new_n782_), .b(new_n775_), .c(new_n769_), .O(new_n783_));
  inv1   g689(.a(new_n783_), .O(new_n784_));
  nor2   g690(.a(new_n784_), .b(new_n697_), .O(new_n785_));
  oai21  g691(.a(new_n785_), .b(new_n768_), .c(new_n111_), .O(new_n786_));
  aoi21  g692(.a(new_n773_), .b(new_n772_), .c(new_n137_), .O(new_n787_));
  aoi21  g693(.a(new_n780_), .b(new_n779_), .c(x72), .O(new_n788_));
  oai21  g694(.a(new_n788_), .b(new_n787_), .c(new_n131_), .O(new_n789_));
  inv1   g695(.a(x28), .O(new_n790_));
  nand2  g696(.a(x71), .b(x60), .O(new_n791_));
  oai21  g697(.a(x71), .b(new_n790_), .c(new_n791_), .O(new_n792_));
  nand2  g698(.a(new_n792_), .b(new_n141_), .O(new_n793_));
  aoi21  g699(.a(new_n756_), .b(new_n755_), .c(new_n137_), .O(new_n794_));
  aoi21  g700(.a(new_n763_), .b(new_n762_), .c(x72), .O(new_n795_));
  oai21  g701(.a(new_n795_), .b(new_n794_), .c(x71), .O(new_n796_));
  nand3  g702(.a(new_n796_), .b(new_n793_), .c(new_n789_), .O(new_n797_));
  nand2  g703(.a(new_n797_), .b(new_n165_), .O(new_n798_));
  oai21  g704(.a(new_n281_), .b(new_n127_), .c(x44), .O(new_n799_));
  inv1   g705(.a(x44), .O(new_n800_));
  inv1   g706(.a(new_n281_), .O(new_n801_));
  nand3  g707(.a(new_n801_), .b(new_n800_), .c(x32), .O(new_n802_));
  aoi21  g708(.a(new_n802_), .b(new_n799_), .c(x71), .O(new_n803_));
  nand2  g709(.a(new_n803_), .b(new_n716_), .O(new_n804_));
  nand2  g710(.a(new_n804_), .b(new_n798_), .O(new_n805_));
  nand2  g711(.a(new_n805_), .b(x70), .O(new_n806_));
  aoi21  g712(.a(new_n806_), .b(new_n786_), .c(new_n93_), .O(new_n807_));
  nand2  g713(.a(new_n749_), .b(new_n111_), .O(new_n808_));
  nand2  g714(.a(new_n803_), .b(x70), .O(new_n809_));
  aoi21  g715(.a(new_n809_), .b(new_n808_), .c(new_n171_), .O(new_n810_));
  oai21  g716(.a(new_n810_), .b(new_n807_), .c(new_n203_), .O(new_n811_));
  oai22  g717(.a(new_n176_), .b(new_n790_), .c(new_n131_), .d(new_n800_), .O(new_n812_));
  nand2  g718(.a(new_n812_), .b(x70), .O(new_n813_));
  nand2  g719(.a(new_n179_), .b(x12), .O(new_n814_));
  nand3  g720(.a(new_n181_), .b(x69), .c(x60), .O(new_n815_));
  nand3  g721(.a(new_n815_), .b(new_n814_), .c(new_n813_), .O(new_n816_));
  and2   g722(.a(new_n816_), .b(x67), .O(new_n817_));
  nand2  g723(.a(new_n783_), .b(new_n158_), .O(new_n818_));
  nand2  g724(.a(new_n766_), .b(new_n159_), .O(new_n819_));
  aoi21  g725(.a(new_n819_), .b(new_n818_), .c(new_n733_), .O(new_n820_));
  oai21  g726(.a(new_n820_), .b(new_n817_), .c(new_n153_), .O(new_n821_));
  nand2  g727(.a(new_n766_), .b(new_n168_), .O(new_n822_));
  oai21  g728(.a(new_n168_), .b(new_n800_), .c(new_n822_), .O(new_n823_));
  nand2  g729(.a(new_n823_), .b(new_n324_), .O(new_n824_));
  aoi21  g730(.a(new_n824_), .b(new_n821_), .c(x66), .O(new_n825_));
  nand2  g731(.a(new_n816_), .b(new_n153_), .O(new_n826_));
  nand3  g732(.a(new_n186_), .b(x68), .c(x44), .O(new_n827_));
  aoi21  g733(.a(new_n827_), .b(new_n826_), .c(new_n329_), .O(new_n828_));
  oai21  g734(.a(new_n828_), .b(new_n825_), .c(new_n204_), .O(new_n829_));
  nand2  g735(.a(new_n829_), .b(new_n811_), .O(z12));
  inv1   g736(.a(x31), .O(new_n833_));
  inv1   g737(.a(x47), .O(new_n834_));
  oai22  g738(.a(new_n176_), .b(new_n833_), .c(new_n131_), .d(new_n834_), .O(new_n835_));
  nand2  g739(.a(new_n835_), .b(x70), .O(new_n836_));
  nand2  g740(.a(new_n179_), .b(x15), .O(new_n837_));
  nand3  g741(.a(new_n181_), .b(x69), .c(x63), .O(new_n838_));
  nand3  g742(.a(new_n838_), .b(new_n837_), .c(new_n836_), .O(new_n839_));
  and2   g743(.a(new_n839_), .b(x67), .O(new_n840_));
  nand2  g744(.a(x74), .b(x28), .O(new_n841_));
  nand2  g745(.a(new_n143_), .b(x29), .O(new_n842_));
  aoi21  g746(.a(new_n842_), .b(new_n841_), .c(new_n146_), .O(new_n843_));
  nand2  g747(.a(new_n228_), .b(x30), .O(new_n844_));
  inv1   g748(.a(new_n844_), .O(new_n845_));
  oai21  g749(.a(new_n845_), .b(new_n843_), .c(new_n137_), .O(new_n846_));
  nand2  g750(.a(new_n141_), .b(x31), .O(new_n847_));
  nand2  g751(.a(x74), .b(x26), .O(new_n848_));
  nand2  g752(.a(new_n143_), .b(x27), .O(new_n849_));
  aoi21  g753(.a(new_n849_), .b(new_n848_), .c(x73), .O(new_n850_));
  nand2  g754(.a(new_n666_), .b(x23), .O(new_n851_));
  inv1   g755(.a(new_n851_), .O(new_n852_));
  oai21  g756(.a(new_n852_), .b(new_n850_), .c(x72), .O(new_n853_));
  nand3  g757(.a(new_n853_), .b(new_n847_), .c(new_n846_), .O(new_n854_));
  nand2  g758(.a(new_n854_), .b(new_n158_), .O(new_n855_));
  nand2  g759(.a(x74), .b(x60), .O(new_n856_));
  nand2  g760(.a(new_n143_), .b(x61), .O(new_n857_));
  aoi21  g761(.a(new_n857_), .b(new_n856_), .c(new_n146_), .O(new_n858_));
  nand2  g762(.a(new_n228_), .b(x62), .O(new_n859_));
  inv1   g763(.a(new_n859_), .O(new_n860_));
  oai21  g764(.a(new_n860_), .b(new_n858_), .c(new_n137_), .O(new_n861_));
  nand2  g765(.a(new_n141_), .b(x63), .O(new_n862_));
  nand2  g766(.a(x74), .b(x58), .O(new_n863_));
  nand2  g767(.a(new_n143_), .b(x59), .O(new_n864_));
  aoi21  g768(.a(new_n864_), .b(new_n863_), .c(x73), .O(new_n865_));
  nand2  g769(.a(new_n666_), .b(x55), .O(new_n866_));
  inv1   g770(.a(new_n866_), .O(new_n867_));
  oai21  g771(.a(new_n867_), .b(new_n865_), .c(x72), .O(new_n868_));
  nand3  g772(.a(new_n868_), .b(new_n862_), .c(new_n861_), .O(new_n869_));
  nand2  g773(.a(new_n869_), .b(new_n159_), .O(new_n870_));
  aoi21  g774(.a(new_n870_), .b(new_n855_), .c(new_n733_), .O(new_n871_));
  oai21  g775(.a(new_n871_), .b(new_n840_), .c(new_n189_), .O(new_n872_));
  nand2  g776(.a(new_n839_), .b(new_n190_), .O(new_n873_));
  aoi21  g777(.a(new_n873_), .b(new_n872_), .c(new_n596_), .O(new_n874_));
  nand4  g778(.a(new_n94_), .b(x69), .c(x65), .d(new_n203_), .O(new_n875_));
  aoi21  g779(.a(new_n870_), .b(new_n855_), .c(new_n875_), .O(new_n876_));
  oai21  g780(.a(new_n876_), .b(new_n874_), .c(new_n153_), .O(new_n877_));
  nand3  g781(.a(x71), .b(new_n136_), .c(x15), .O(new_n878_));
  inv1   g782(.a(new_n878_), .O(new_n879_));
  aoi21  g783(.a(new_n869_), .b(new_n678_), .c(new_n879_), .O(new_n880_));
  nand3  g784(.a(new_n133_), .b(new_n136_), .c(x47), .O(new_n881_));
  oai21  g785(.a(new_n880_), .b(x70), .c(new_n881_), .O(new_n882_));
  nand2  g786(.a(new_n113_), .b(x15), .O(new_n883_));
  nand2  g787(.a(new_n133_), .b(x47), .O(new_n884_));
  aoi21  g788(.a(new_n884_), .b(new_n883_), .c(new_n384_), .O(new_n885_));
  aoi21  g789(.a(new_n882_), .b(new_n94_), .c(new_n885_), .O(new_n886_));
  nand2  g790(.a(new_n869_), .b(new_n93_), .O(new_n887_));
  oai21  g791(.a(new_n191_), .b(new_n834_), .c(new_n887_), .O(new_n888_));
  nand3  g792(.a(new_n888_), .b(new_n204_), .c(new_n181_), .O(new_n889_));
  oai21  g793(.a(new_n886_), .b(x64), .c(new_n889_), .O(new_n890_));
  nand2  g794(.a(new_n890_), .b(new_n154_), .O(new_n891_));
  nand2  g795(.a(new_n891_), .b(new_n877_), .O(z15));
  zero   g796(.O(z00));
  zero   g797(.O(z09));
  zero   g798(.O(z10));
  zero   g799(.O(z13));
