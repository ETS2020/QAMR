// Benchmark "FAU" written by ABC on Sun Aug  2 11:51:08 2020
...
module FAU ( 
  ...
  wire new_n92_, new_n93_, new_n94_, new_n95_, new_n96_, new_n97_, new_n98_,
    ...
    new_n446_, new_n451_, new_n452_, new_n453_, new_n454_, new_n455_,
  ...
  inv1   g209(.a(new_n308_), .O(new_n309_));
  nand3  g210(.a(new_n151_), .b(x71), .c(x69), .O(new_n310_));
  nor2   g211(.a(new_n310_), .b(new_n309_), .O(new_n311_));
  ...
  nor2   g300(.a(new_n399_), .b(new_n310_), .O(new_n400_));
  oai21  g301(.a(new_n400_), .b(new_n384_), .c(new_n95_), .O(new_n401_));
  aoi21  g302(.a(new_n389_), .b(new_n388_), .c(new_n201_), .O(new_n402_));
  aoi21  g303(.a(new_n395_), .b(new_n394_), .c(x72), .O(new_n403_));
  oai21  g304(.a(new_n403_), .b(new_n402_), .c(new_n113_), .O(new_n404_));
  inv1   g305(.a(x27), .O(new_n405_));
  nand2  g306(.a(x71), .b(x59), .O(new_n406_));
  oai21  g307(.a(x71), .b(new_n405_), .c(new_n406_), .O(new_n407_));
  nand2  g308(.a(new_n407_), .b(new_n212_), .O(new_n408_));
  aoi21  g309(.a(new_n372_), .b(new_n371_), .c(new_n201_), .O(new_n409_));
  aoi21  g310(.a(new_n379_), .b(new_n378_), .c(x72), .O(new_n410_));
  oai21  g311(.a(new_n410_), .b(new_n409_), .c(x71), .O(new_n411_));
  nand3  g312(.a(new_n411_), .b(new_n408_), .c(new_n404_), .O(new_n412_));
  nand2  g313(.a(new_n412_), .b(new_n313_), .O(new_n413_));
  inv1   g314(.a(x43), .O(new_n414_));
  nor2   g315(.a(x45), .b(x44), .O(new_n415_));
  aoi21  g316(.a(new_n415_), .b(new_n121_), .c(new_n117_), .O(new_n416_));
  nand2  g317(.a(new_n415_), .b(new_n121_), .O(new_n417_));
  nand3  g318(.a(new_n417_), .b(new_n414_), .c(x32), .O(new_n418_));
  oai21  g319(.a(new_n416_), .b(new_n414_), .c(new_n418_), .O(new_n419_));
  and2   g320(.a(new_n419_), .b(new_n113_), .O(new_n420_));
  nand2  g321(.a(new_n420_), .b(new_n332_), .O(new_n421_));
  nand2  g322(.a(new_n421_), .b(new_n413_), .O(new_n422_));
  nand2  g323(.a(new_n422_), .b(x70), .O(new_n423_));
  aoi21  g324(.a(new_n423_), .b(new_n401_), .c(new_n93_), .O(new_n424_));
  nand3  g325(.a(new_n366_), .b(x71), .c(new_n95_), .O(new_n425_));
  nand2  g326(.a(new_n420_), .b(x70), .O(new_n426_));
  aoi21  g327(.a(new_n426_), .b(new_n425_), .c(new_n245_), .O(new_n427_));
  oai21  g328(.a(new_n427_), .b(new_n424_), .c(new_n92_), .O(new_n428_));
  oai22  g329(.a(new_n161_), .b(new_n405_), .c(new_n113_), .d(new_n414_), .O(new_n429_));
  nand2  g330(.a(new_n429_), .b(x70), .O(new_n430_));
  nand2  g331(.a(new_n164_), .b(x11), .O(new_n431_));
  nand3  g332(.a(new_n132_), .b(x69), .c(x59), .O(new_n432_));
  nand3  g333(.a(new_n432_), .b(new_n431_), .c(new_n430_), .O(new_n433_));
  and2   g334(.a(new_n433_), .b(x67), .O(new_n434_));
  nand2  g335(.a(new_n398_), .b(new_n147_), .O(new_n435_));
  nand2  g336(.a(new_n382_), .b(new_n240_), .O(new_n436_));
  aoi21  g337(.a(new_n436_), .b(new_n435_), .c(new_n349_), .O(new_n437_));
  oai21  g338(.a(new_n437_), .b(new_n434_), .c(new_n143_), .O(new_n438_));
  nand2  g339(.a(new_n382_), .b(new_n137_), .O(new_n439_));
  oai21  g340(.a(new_n137_), .b(new_n414_), .c(new_n439_), .O(new_n440_));
  nand2  g341(.a(new_n440_), .b(new_n259_), .O(new_n441_));
  aoi21  g342(.a(new_n441_), .b(new_n438_), .c(x66), .O(new_n442_));
  nand2  g343(.a(new_n433_), .b(new_n143_), .O(new_n443_));
  nand3  g344(.a(new_n169_), .b(x68), .c(x43), .O(new_n444_));
  aoi21  g345(.a(new_n444_), .b(new_n443_), .c(new_n262_), .O(new_n445_));
  oai21  g346(.a(new_n445_), .b(new_n442_), .c(new_n176_), .O(new_n446_));
  nand2  g347(.a(new_n446_), .b(new_n428_), .O(z11));
  inv1   g348(.a(x31), .O(new_n451_));
  inv1   g349(.a(x47), .O(new_n452_));
  oai22  g350(.a(new_n161_), .b(new_n451_), .c(new_n113_), .d(new_n452_), .O(new_n453_));
  nand2  g351(.a(new_n453_), .b(x70), .O(new_n454_));
  nand2  g352(.a(new_n164_), .b(x15), .O(new_n455_));
  nand3  g353(.a(new_n132_), .b(x69), .c(x63), .O(new_n456_));
  nand3  g354(.a(new_n456_), .b(new_n455_), .c(new_n454_), .O(new_n457_));
  and2   g355(.a(new_n457_), .b(x67), .O(new_n458_));
  nand2  g356(.a(x74), .b(x28), .O(new_n459_));
  nand2  g357(.a(new_n204_), .b(x29), .O(new_n460_));
  aoi21  g358(.a(new_n460_), .b(new_n459_), .c(new_n202_), .O(new_n461_));
  nand3  g359(.a(x74), .b(new_n202_), .c(x30), .O(new_n462_));
  inv1   g360(.a(new_n462_), .O(new_n463_));
  oai21  g361(.a(new_n463_), .b(new_n461_), .c(new_n201_), .O(new_n464_));
  nand2  g362(.a(new_n212_), .b(x31), .O(new_n465_));
  nand2  g363(.a(x74), .b(x26), .O(new_n466_));
  nand2  g364(.a(new_n204_), .b(x27), .O(new_n467_));
  aoi21  g365(.a(new_n467_), .b(new_n466_), .c(x73), .O(new_n468_));
  nand3  g366(.a(new_n204_), .b(x73), .c(x23), .O(new_n469_));
  inv1   g367(.a(new_n469_), .O(new_n470_));
  oai21  g368(.a(new_n470_), .b(new_n468_), .c(x72), .O(new_n471_));
  nand3  g369(.a(new_n471_), .b(new_n465_), .c(new_n464_), .O(new_n472_));
  nand2  g370(.a(new_n472_), .b(new_n147_), .O(new_n473_));
  nand2  g371(.a(x74), .b(x60), .O(new_n474_));
  nand2  g372(.a(new_n204_), .b(x61), .O(new_n475_));
  aoi21  g373(.a(new_n475_), .b(new_n474_), .c(new_n202_), .O(new_n476_));
  nand3  g374(.a(x74), .b(new_n202_), .c(x62), .O(new_n477_));
  inv1   g375(.a(new_n477_), .O(new_n478_));
  oai21  g376(.a(new_n478_), .b(new_n476_), .c(new_n201_), .O(new_n479_));
  nand2  g377(.a(new_n212_), .b(x63), .O(new_n480_));
  nand2  g378(.a(x74), .b(x58), .O(new_n481_));
  nand2  g379(.a(new_n204_), .b(x59), .O(new_n482_));
  aoi21  g380(.a(new_n482_), .b(new_n481_), .c(x73), .O(new_n483_));
  nand3  g381(.a(new_n204_), .b(x73), .c(x55), .O(new_n484_));
  inv1   g382(.a(new_n484_), .O(new_n485_));
  oai21  g383(.a(new_n485_), .b(new_n483_), .c(x72), .O(new_n486_));
  nand3  g384(.a(new_n486_), .b(new_n480_), .c(new_n479_), .O(new_n487_));
  nand2  g385(.a(new_n487_), .b(new_n240_), .O(new_n488_));
  aoi21  g386(.a(new_n488_), .b(new_n473_), .c(new_n349_), .O(new_n489_));
  oai21  g387(.a(new_n489_), .b(new_n458_), .c(new_n156_), .O(new_n490_));
  nand2  g388(.a(new_n457_), .b(new_n157_), .O(new_n491_));
  aoi21  g389(.a(new_n491_), .b(new_n490_), .c(new_n187_), .O(new_n492_));
  nand4  g390(.a(new_n94_), .b(x69), .c(x65), .d(new_n92_), .O(new_n493_));
  aoi21  g391(.a(new_n488_), .b(new_n473_), .c(new_n493_), .O(new_n494_));
  oai21  g392(.a(new_n494_), .b(new_n492_), .c(new_n143_), .O(new_n495_));
  nand3  g393(.a(x71), .b(new_n138_), .c(x15), .O(new_n496_));
  inv1   g394(.a(new_n496_), .O(new_n497_));
  aoi21  g395(.a(new_n487_), .b(new_n290_), .c(new_n497_), .O(new_n498_));
  nand3  g396(.a(new_n115_), .b(new_n138_), .c(x47), .O(new_n499_));
  oai21  g397(.a(new_n498_), .b(x70), .c(new_n499_), .O(new_n500_));
  inv1   g398(.a(x15), .O(new_n501_));
  oai22  g399(.a(new_n114_), .b(new_n452_), .c(new_n96_), .d(new_n501_), .O(new_n502_));
  aoi22  g400(.a(new_n502_), .b(new_n141_), .c(new_n500_), .d(new_n94_), .O(new_n503_));
  nand2  g401(.a(new_n487_), .b(new_n93_), .O(new_n504_));
  oai21  g402(.a(new_n158_), .b(new_n452_), .c(new_n504_), .O(new_n505_));
  nand3  g403(.a(new_n505_), .b(new_n176_), .c(new_n132_), .O(new_n506_));
  oai21  g404(.a(new_n503_), .b(x64), .c(new_n506_), .O(new_n507_));
  nand2  g405(.a(new_n507_), .b(new_n144_), .O(new_n508_));
  nand2  g406(.a(new_n508_), .b(new_n495_), .O(z15));
  zero   g407(.O(z01));
  zero   g408(.O(z02));
  zero   g409(.O(z03));
  zero   g410(.O(z04));
