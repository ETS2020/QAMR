// Benchmark "FAU" written by ABC on Sun Aug  2 10:38:11 2020
...
module FAU ( 
  ...
  nor2   g670(.a(x74), .b(new_n212_), .O(new_n763_));
  ...
  nand2  g845(.a(x74), .b(x58), .O(new_n938_));
  nand2  g846(.a(new_n209_), .b(x59), .O(new_n939_));
  nand2  g847(.a(new_n939_), .b(new_n938_), .O(new_n940_));
  ...
  nand2  g860(.a(new_n209_), .b(x27), .O(new_n953_));
  nand2  g861(.a(new_n953_), .b(new_n952_), .O(new_n954_));
  nand2  g862(.a(new_n954_), .b(x73), .O(new_n955_));
  nand2  g863(.a(new_n268_), .b(x28), .O(new_n956_));
  nand2  g864(.a(new_n956_), .b(new_n955_), .O(new_n957_));
  nand2  g865(.a(new_n957_), .b(new_n203_), .O(new_n958_));
  nand3  g866(.a(new_n958_), .b(new_n951_), .c(new_n947_), .O(new_n959_));
  nand2  g867(.a(new_n959_), .b(new_n792_), .O(new_n960_));
  oai21  g868(.a(new_n946_), .b(new_n141_), .c(new_n960_), .O(new_n961_));
  nand2  g869(.a(new_n961_), .b(new_n100_), .O(new_n962_));
  aoi21  g870(.a(new_n949_), .b(new_n948_), .c(new_n203_), .O(new_n963_));
  aoi21  g871(.a(new_n956_), .b(new_n955_), .c(x72), .O(new_n964_));
  oai21  g872(.a(new_n964_), .b(new_n963_), .c(new_n116_), .O(new_n965_));
  inv1   g873(.a(x29), .O(new_n966_));
  nand2  g874(.a(x71), .b(x61), .O(new_n967_));
  oai21  g875(.a(x71), .b(new_n966_), .c(new_n967_), .O(new_n968_));
  nand2  g876(.a(new_n968_), .b(new_n207_), .O(new_n969_));
  aoi21  g877(.a(new_n935_), .b(new_n934_), .c(new_n203_), .O(new_n970_));
  aoi21  g878(.a(new_n942_), .b(new_n941_), .c(x72), .O(new_n971_));
  oai21  g879(.a(new_n971_), .b(new_n970_), .c(x71), .O(new_n972_));
  nand3  g880(.a(new_n972_), .b(new_n969_), .c(new_n965_), .O(new_n973_));
  nand2  g881(.a(new_n973_), .b(new_n219_), .O(new_n974_));
  nor2   g882(.a(x45), .b(new_n112_), .O(new_n975_));
  oai21  g883(.a(x47), .b(x46), .c(new_n975_), .O(new_n976_));
  oai21  g884(.a(new_n190_), .b(new_n112_), .c(x45), .O(new_n977_));
  aoi21  g885(.a(new_n977_), .b(new_n976_), .c(x71), .O(new_n978_));
  nand2  g886(.a(new_n978_), .b(new_n811_), .O(new_n979_));
  nand2  g887(.a(new_n979_), .b(new_n974_), .O(new_n980_));
  nand2  g888(.a(new_n980_), .b(x70), .O(new_n981_));
  aoi21  g889(.a(new_n981_), .b(new_n962_), .c(new_n93_), .O(new_n982_));
  nand2  g890(.a(new_n930_), .b(new_n100_), .O(new_n983_));
  nand2  g891(.a(new_n978_), .b(x70), .O(new_n984_));
  aoi21  g892(.a(new_n984_), .b(new_n983_), .c(new_n226_), .O(new_n985_));
  oai21  g893(.a(new_n985_), .b(new_n982_), .c(new_n92_), .O(new_n986_));
  oai22  g894(.a(new_n156_), .b(new_n966_), .c(new_n116_), .d(new_n319_), .O(new_n987_));
  nand2  g895(.a(new_n987_), .b(x70), .O(new_n988_));
  nand2  g896(.a(new_n159_), .b(x13), .O(new_n989_));
  nand3  g897(.a(new_n128_), .b(x69), .c(x61), .O(new_n990_));
  nand3  g898(.a(new_n990_), .b(new_n989_), .c(new_n988_), .O(new_n991_));
  and2   g899(.a(new_n991_), .b(x67), .O(new_n992_));
  nand2  g900(.a(new_n959_), .b(new_n143_), .O(new_n993_));
  nand2  g901(.a(new_n945_), .b(new_n144_), .O(new_n994_));
  aoi21  g902(.a(new_n994_), .b(new_n993_), .c(new_n828_), .O(new_n995_));
  oai21  g903(.a(new_n995_), .b(new_n992_), .c(new_n139_), .O(new_n996_));
  nand2  g904(.a(new_n945_), .b(new_n133_), .O(new_n997_));
  oai21  g905(.a(new_n133_), .b(new_n319_), .c(new_n997_), .O(new_n998_));
  nand2  g906(.a(new_n998_), .b(new_n365_), .O(new_n999_));
  aoi21  g907(.a(new_n999_), .b(new_n996_), .c(x66), .O(new_n1000_));
  nand2  g908(.a(new_n991_), .b(new_n139_), .O(new_n1001_));
  nand3  g909(.a(new_n165_), .b(x68), .c(x45), .O(new_n1002_));
  aoi21  g910(.a(new_n1002_), .b(new_n1001_), .c(new_n370_), .O(new_n1003_));
  oai21  g911(.a(new_n1003_), .b(new_n1000_), .c(new_n173_), .O(new_n1004_));
  nand2  g912(.a(new_n1004_), .b(new_n986_), .O(z13));
  inv1   g913(.a(x31), .O(new_n1007_));
  inv1   g914(.a(x47), .O(new_n1008_));
  oai22  g915(.a(new_n156_), .b(new_n1007_), .c(new_n116_), .d(new_n1008_), .O(new_n1009_));
  nand2  g916(.a(new_n1009_), .b(x70), .O(new_n1010_));
  nand2  g917(.a(new_n159_), .b(x15), .O(new_n1011_));
  nand3  g918(.a(new_n128_), .b(x69), .c(x63), .O(new_n1012_));
  nand3  g919(.a(new_n1012_), .b(new_n1011_), .c(new_n1010_), .O(new_n1013_));
  and2   g920(.a(new_n1013_), .b(x67), .O(new_n1014_));
  nand2  g921(.a(x74), .b(x28), .O(new_n1015_));
  nand2  g922(.a(new_n209_), .b(x29), .O(new_n1016_));
  aoi21  g923(.a(new_n1016_), .b(new_n1015_), .c(new_n212_), .O(new_n1017_));
  nand2  g924(.a(new_n268_), .b(x30), .O(new_n1018_));
  inv1   g925(.a(new_n1018_), .O(new_n1019_));
  oai21  g926(.a(new_n1019_), .b(new_n1017_), .c(new_n203_), .O(new_n1020_));
  nand2  g927(.a(new_n207_), .b(x31), .O(new_n1021_));
  aoi21  g928(.a(new_n953_), .b(new_n952_), .c(x73), .O(new_n1022_));
  nand2  g929(.a(new_n763_), .b(x23), .O(new_n1023_));
  inv1   g930(.a(new_n1023_), .O(new_n1024_));
  oai21  g931(.a(new_n1024_), .b(new_n1022_), .c(x72), .O(new_n1025_));
  nand3  g932(.a(new_n1025_), .b(new_n1021_), .c(new_n1020_), .O(new_n1026_));
  nand2  g933(.a(new_n1026_), .b(new_n143_), .O(new_n1027_));
  nand2  g934(.a(x74), .b(x60), .O(new_n1028_));
  nand2  g935(.a(new_n209_), .b(x61), .O(new_n1029_));
  aoi21  g936(.a(new_n1029_), .b(new_n1028_), .c(new_n212_), .O(new_n1030_));
  nand2  g937(.a(new_n268_), .b(x62), .O(new_n1031_));
  inv1   g938(.a(new_n1031_), .O(new_n1032_));
  oai21  g939(.a(new_n1032_), .b(new_n1030_), .c(new_n203_), .O(new_n1033_));
  nand2  g940(.a(new_n207_), .b(x63), .O(new_n1034_));
  aoi21  g941(.a(new_n939_), .b(new_n938_), .c(x73), .O(new_n1035_));
  nand2  g942(.a(new_n763_), .b(x55), .O(new_n1036_));
  inv1   g943(.a(new_n1036_), .O(new_n1037_));
  oai21  g944(.a(new_n1037_), .b(new_n1035_), .c(x72), .O(new_n1038_));
  nand3  g945(.a(new_n1038_), .b(new_n1034_), .c(new_n1033_), .O(new_n1039_));
  nand2  g946(.a(new_n1039_), .b(new_n144_), .O(new_n1040_));
  aoi21  g947(.a(new_n1040_), .b(new_n1027_), .c(new_n828_), .O(new_n1041_));
  oai21  g948(.a(new_n1041_), .b(new_n1014_), .c(new_n151_), .O(new_n1042_));
  nand2  g949(.a(new_n1013_), .b(new_n152_), .O(new_n1043_));
  aoi21  g950(.a(new_n1043_), .b(new_n1042_), .c(new_n636_), .O(new_n1044_));
  nand4  g951(.a(new_n94_), .b(x69), .c(x65), .d(new_n92_), .O(new_n1045_));
  aoi21  g952(.a(new_n1040_), .b(new_n1027_), .c(new_n1045_), .O(new_n1046_));
  oai21  g953(.a(new_n1046_), .b(new_n1044_), .c(new_n139_), .O(new_n1047_));
  nand3  g954(.a(x71), .b(new_n134_), .c(x15), .O(new_n1048_));
  inv1   g955(.a(new_n1048_), .O(new_n1049_));
  aoi21  g956(.a(new_n1039_), .b(new_n775_), .c(new_n1049_), .O(new_n1050_));
  nand3  g957(.a(new_n118_), .b(new_n134_), .c(x47), .O(new_n1051_));
  oai21  g958(.a(new_n1050_), .b(x70), .c(new_n1051_), .O(new_n1052_));
  nand2  g959(.a(new_n102_), .b(x15), .O(new_n1053_));
  nand2  g960(.a(new_n118_), .b(x47), .O(new_n1054_));
  aoi21  g961(.a(new_n1054_), .b(new_n1053_), .c(new_n136_), .O(new_n1055_));
  aoi21  g962(.a(new_n1052_), .b(new_n94_), .c(new_n1055_), .O(new_n1056_));
  nand2  g963(.a(new_n1039_), .b(new_n93_), .O(new_n1057_));
  oai21  g964(.a(new_n153_), .b(new_n1008_), .c(new_n1057_), .O(new_n1058_));
  nand3  g965(.a(new_n1058_), .b(new_n173_), .c(new_n128_), .O(new_n1059_));
  oai21  g966(.a(new_n1056_), .b(x64), .c(new_n1059_), .O(new_n1060_));
  nand2  g967(.a(new_n1060_), .b(new_n140_), .O(new_n1061_));
  nand2  g968(.a(new_n1061_), .b(new_n1047_), .O(z15));
  zero   g969(.O(z10));
  zero   g970(.O(z14));
endmodule
