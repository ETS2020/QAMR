// Benchmark "FAU" written by ABC on Sun Aug  2 10:41:41 2020
...
module FAU ( 
  ...
  oai21  g753(.a(new_n481_), .b(new_n96_), .c(x11), .O(new_n845_));
  nand3  g754(.a(new_n407_), .b(new_n175_), .c(x00), .O(new_n846_));
  aoi21  g755(.a(new_n846_), .b(new_n845_), .c(new_n116_), .O(new_n847_));
  nand2  g756(.a(new_n847_), .b(new_n132_), .O(new_n848_));
  nand2  g757(.a(new_n207_), .b(x59), .O(new_n849_));
  nand2  g758(.a(new_n707_), .b(new_n706_), .O(new_n850_));
  nand2  g759(.a(new_n850_), .b(new_n212_), .O(new_n851_));
  nand2  g760(.a(new_n765_), .b(x51), .O(new_n852_));
  nand2  g761(.a(new_n852_), .b(new_n851_), .O(new_n853_));
  nand2  g762(.a(new_n853_), .b(x72), .O(new_n854_));
  inv1   g763(.a(x57), .O(new_n855_));
  nand2  g764(.a(x74), .b(x56), .O(new_n856_));
  oai21  g765(.a(x74), .b(new_n855_), .c(new_n856_), .O(new_n857_));
  nand2  g766(.a(new_n857_), .b(x73), .O(new_n858_));
  nand2  g767(.a(new_n268_), .b(x58), .O(new_n859_));
  nand2  g768(.a(new_n859_), .b(new_n858_), .O(new_n860_));
  nand2  g769(.a(new_n860_), .b(new_n203_), .O(new_n861_));
  nand3  g770(.a(new_n861_), .b(new_n854_), .c(new_n849_), .O(new_n862_));
  nand2  g771(.a(new_n862_), .b(new_n777_), .O(new_n863_));
  aoi21  g772(.a(new_n863_), .b(new_n848_), .c(new_n139_), .O(new_n864_));
  nand2  g773(.a(new_n207_), .b(x27), .O(new_n865_));
  nand2  g774(.a(new_n721_), .b(new_n720_), .O(new_n866_));
  nand2  g775(.a(new_n866_), .b(new_n212_), .O(new_n867_));
  nand2  g776(.a(new_n765_), .b(x19), .O(new_n868_));
  nand2  g777(.a(new_n868_), .b(new_n867_), .O(new_n869_));
  nand2  g778(.a(new_n869_), .b(x72), .O(new_n870_));
  nand2  g779(.a(x74), .b(x24), .O(new_n871_));
  oai21  g780(.a(x74), .b(new_n738_), .c(new_n871_), .O(new_n872_));
  nand2  g781(.a(new_n872_), .b(x73), .O(new_n873_));
  nand2  g782(.a(new_n268_), .b(x26), .O(new_n874_));
  nand2  g783(.a(new_n874_), .b(new_n873_), .O(new_n875_));
  nand2  g784(.a(new_n875_), .b(new_n203_), .O(new_n876_));
  nand3  g785(.a(new_n876_), .b(new_n870_), .c(new_n865_), .O(new_n877_));
  and2   g786(.a(new_n877_), .b(new_n794_), .O(new_n878_));
  oai21  g787(.a(new_n878_), .b(new_n864_), .c(new_n101_), .O(new_n879_));
  aoi21  g788(.a(new_n868_), .b(new_n867_), .c(new_n203_), .O(new_n880_));
  aoi21  g789(.a(new_n874_), .b(new_n873_), .c(x72), .O(new_n881_));
  oai21  g790(.a(new_n881_), .b(new_n880_), .c(new_n116_), .O(new_n882_));
  inv1   g791(.a(x27), .O(new_n883_));
  nand2  g792(.a(x71), .b(x59), .O(new_n884_));
  oai21  g793(.a(x71), .b(new_n883_), .c(new_n884_), .O(new_n885_));
  nand2  g794(.a(new_n885_), .b(new_n207_), .O(new_n886_));
  aoi21  g795(.a(new_n852_), .b(new_n851_), .c(new_n203_), .O(new_n887_));
  aoi21  g796(.a(new_n859_), .b(new_n858_), .c(x72), .O(new_n888_));
  oai21  g797(.a(new_n888_), .b(new_n887_), .c(x71), .O(new_n889_));
  nand3  g798(.a(new_n889_), .b(new_n886_), .c(new_n882_), .O(new_n890_));
  nand2  g799(.a(new_n890_), .b(new_n219_), .O(new_n891_));
  oai21  g800(.a(new_n489_), .b(new_n111_), .c(x43), .O(new_n892_));
  nand3  g801(.a(new_n414_), .b(new_n189_), .c(x32), .O(new_n893_));
  aoi21  g802(.a(new_n893_), .b(new_n892_), .c(x71), .O(new_n894_));
  nand2  g803(.a(new_n894_), .b(new_n816_), .O(new_n895_));
  nand2  g804(.a(new_n895_), .b(new_n891_), .O(new_n896_));
  nand2  g805(.a(new_n896_), .b(x70), .O(new_n897_));
  aoi21  g806(.a(new_n897_), .b(new_n879_), .c(new_n93_), .O(new_n898_));
  nand2  g807(.a(new_n847_), .b(new_n101_), .O(new_n899_));
  nand2  g808(.a(new_n894_), .b(x70), .O(new_n900_));
  aoi21  g809(.a(new_n900_), .b(new_n899_), .c(new_n226_), .O(new_n901_));
  oai21  g810(.a(new_n901_), .b(new_n898_), .c(new_n92_), .O(new_n902_));
  oai22  g811(.a(new_n154_), .b(new_n883_), .c(new_n116_), .d(new_n189_), .O(new_n903_));
  nand2  g812(.a(new_n903_), .b(x70), .O(new_n904_));
  nand2  g813(.a(new_n157_), .b(x11), .O(new_n905_));
  nand3  g814(.a(new_n126_), .b(x69), .c(x59), .O(new_n906_));
  nand3  g815(.a(new_n906_), .b(new_n905_), .c(new_n904_), .O(new_n907_));
  and2   g816(.a(new_n907_), .b(x67), .O(new_n908_));
  nand2  g817(.a(new_n877_), .b(new_n141_), .O(new_n909_));
  nand2  g818(.a(new_n862_), .b(new_n142_), .O(new_n910_));
  aoi21  g819(.a(new_n910_), .b(new_n909_), .c(new_n833_), .O(new_n911_));
  oai21  g820(.a(new_n911_), .b(new_n908_), .c(new_n137_), .O(new_n912_));
  nand2  g821(.a(new_n862_), .b(new_n131_), .O(new_n913_));
  oai21  g822(.a(new_n131_), .b(new_n189_), .c(new_n913_), .O(new_n914_));
  nand2  g823(.a(new_n914_), .b(new_n365_), .O(new_n915_));
  aoi21  g824(.a(new_n915_), .b(new_n912_), .c(x66), .O(new_n916_));
  nand2  g825(.a(new_n907_), .b(new_n137_), .O(new_n917_));
  nand3  g826(.a(new_n163_), .b(x68), .c(x43), .O(new_n918_));
  aoi21  g827(.a(new_n918_), .b(new_n917_), .c(new_n370_), .O(new_n919_));
  oai21  g828(.a(new_n919_), .b(new_n916_), .c(new_n171_), .O(new_n920_));
  nand2  g829(.a(new_n920_), .b(new_n902_), .O(z11));
  nand2  g830(.a(new_n755_), .b(x00), .O(new_n922_));
  nand2  g831(.a(new_n922_), .b(x12), .O(new_n923_));
  nor2   g832(.a(x12), .b(new_n96_), .O(new_n924_));
  nand2  g833(.a(new_n924_), .b(new_n755_), .O(new_n925_));
  aoi21  g834(.a(new_n925_), .b(new_n923_), .c(new_n116_), .O(new_n926_));
  nand2  g835(.a(new_n926_), .b(new_n132_), .O(new_n927_));
  nand2  g836(.a(new_n207_), .b(x60), .O(new_n928_));
  nand2  g837(.a(new_n771_), .b(new_n212_), .O(new_n929_));
  nand2  g838(.a(new_n765_), .b(x52), .O(new_n930_));
  nand2  g839(.a(new_n930_), .b(new_n929_), .O(new_n931_));
  nand2  g840(.a(new_n931_), .b(x72), .O(new_n932_));
  inv1   g841(.a(x58), .O(new_n933_));
  nand2  g842(.a(x74), .b(x57), .O(new_n934_));
  oai21  g843(.a(x74), .b(new_n933_), .c(new_n934_), .O(new_n935_));
  nand2  g844(.a(new_n935_), .b(x73), .O(new_n936_));
  nand2  g845(.a(new_n268_), .b(x59), .O(new_n937_));
  nand2  g846(.a(new_n937_), .b(new_n936_), .O(new_n938_));
  nand2  g847(.a(new_n938_), .b(new_n203_), .O(new_n939_));
  nand3  g848(.a(new_n939_), .b(new_n932_), .c(new_n928_), .O(new_n940_));
  nand2  g849(.a(new_n940_), .b(new_n777_), .O(new_n941_));
  aoi21  g850(.a(new_n941_), .b(new_n927_), .c(new_n139_), .O(new_n942_));
  nand2  g851(.a(new_n207_), .b(x28), .O(new_n943_));
  nand2  g852(.a(new_n787_), .b(new_n212_), .O(new_n944_));
  nand2  g853(.a(new_n765_), .b(x20), .O(new_n945_));
  nand2  g854(.a(new_n945_), .b(new_n944_), .O(new_n946_));
  nand2  g855(.a(new_n946_), .b(x72), .O(new_n947_));
  nand2  g856(.a(x74), .b(x25), .O(new_n948_));
  oai21  g857(.a(x74), .b(new_n800_), .c(new_n948_), .O(new_n949_));
  nand2  g858(.a(new_n949_), .b(x73), .O(new_n950_));
  nand2  g859(.a(new_n268_), .b(x27), .O(new_n951_));
  nand2  g860(.a(new_n951_), .b(new_n950_), .O(new_n952_));
  nand2  g861(.a(new_n952_), .b(new_n203_), .O(new_n953_));
  nand3  g862(.a(new_n953_), .b(new_n947_), .c(new_n943_), .O(new_n954_));
  and2   g863(.a(new_n954_), .b(new_n794_), .O(new_n955_));
  oai21  g864(.a(new_n955_), .b(new_n942_), .c(new_n101_), .O(new_n956_));
  aoi21  g865(.a(new_n945_), .b(new_n944_), .c(new_n203_), .O(new_n957_));
  aoi21  g866(.a(new_n951_), .b(new_n950_), .c(x72), .O(new_n958_));
  oai21  g867(.a(new_n958_), .b(new_n957_), .c(new_n116_), .O(new_n959_));
  inv1   g868(.a(x28), .O(new_n960_));
  nand2  g869(.a(x71), .b(x60), .O(new_n961_));
  oai21  g870(.a(x71), .b(new_n960_), .c(new_n961_), .O(new_n962_));
  nand2  g871(.a(new_n962_), .b(new_n207_), .O(new_n963_));
  aoi21  g872(.a(new_n930_), .b(new_n929_), .c(new_n203_), .O(new_n964_));
  aoi21  g873(.a(new_n937_), .b(new_n936_), .c(x72), .O(new_n965_));
  oai21  g874(.a(new_n965_), .b(new_n964_), .c(x71), .O(new_n966_));
  nand3  g875(.a(new_n966_), .b(new_n963_), .c(new_n959_), .O(new_n967_));
  nand2  g876(.a(new_n967_), .b(new_n219_), .O(new_n968_));
  nand2  g877(.a(new_n809_), .b(x32), .O(new_n969_));
  nand2  g878(.a(new_n969_), .b(x44), .O(new_n970_));
  inv1   g879(.a(x44), .O(new_n971_));
  nand3  g880(.a(new_n809_), .b(new_n971_), .c(x32), .O(new_n972_));
  aoi21  g881(.a(new_n972_), .b(new_n970_), .c(x71), .O(new_n973_));
  nand2  g882(.a(new_n973_), .b(new_n816_), .O(new_n974_));
  nand2  g883(.a(new_n974_), .b(new_n968_), .O(new_n975_));
  nand2  g884(.a(new_n975_), .b(x70), .O(new_n976_));
  aoi21  g885(.a(new_n976_), .b(new_n956_), .c(new_n93_), .O(new_n977_));
  nand2  g886(.a(new_n926_), .b(new_n101_), .O(new_n978_));
  nand2  g887(.a(new_n973_), .b(x70), .O(new_n979_));
  aoi21  g888(.a(new_n979_), .b(new_n978_), .c(new_n226_), .O(new_n980_));
  oai21  g889(.a(new_n980_), .b(new_n977_), .c(new_n92_), .O(new_n981_));
  oai22  g890(.a(new_n154_), .b(new_n960_), .c(new_n116_), .d(new_n971_), .O(new_n982_));
  nand2  g891(.a(new_n982_), .b(x70), .O(new_n983_));
  nand2  g892(.a(new_n157_), .b(x12), .O(new_n984_));
  nand3  g893(.a(new_n126_), .b(x69), .c(x60), .O(new_n985_));
  nand3  g894(.a(new_n985_), .b(new_n984_), .c(new_n983_), .O(new_n986_));
  and2   g895(.a(new_n986_), .b(x67), .O(new_n987_));
  nand2  g896(.a(new_n954_), .b(new_n141_), .O(new_n988_));
  nand2  g897(.a(new_n940_), .b(new_n142_), .O(new_n989_));
  aoi21  g898(.a(new_n989_), .b(new_n988_), .c(new_n833_), .O(new_n990_));
  oai21  g899(.a(new_n990_), .b(new_n987_), .c(new_n137_), .O(new_n991_));
  nand2  g900(.a(new_n940_), .b(new_n131_), .O(new_n992_));
  oai21  g901(.a(new_n131_), .b(new_n971_), .c(new_n992_), .O(new_n993_));
  nand2  g902(.a(new_n993_), .b(new_n365_), .O(new_n994_));
  aoi21  g903(.a(new_n994_), .b(new_n991_), .c(x66), .O(new_n995_));
  nand2  g904(.a(new_n986_), .b(new_n137_), .O(new_n996_));
  nand3  g905(.a(new_n163_), .b(x68), .c(x44), .O(new_n997_));
  aoi21  g906(.a(new_n997_), .b(new_n996_), .c(new_n370_), .O(new_n998_));
  oai21  g907(.a(new_n998_), .b(new_n995_), .c(new_n171_), .O(new_n999_));
  nand2  g908(.a(new_n999_), .b(new_n981_), .O(z12));
  inv1   g909(.a(new_n176_), .O(new_n1001_));
  nand3  g910(.a(new_n1001_), .b(new_n308_), .c(x00), .O(new_n1002_));
  oai21  g911(.a(new_n176_), .b(new_n96_), .c(x13), .O(new_n1003_));
  aoi21  g912(.a(new_n1003_), .b(new_n1002_), .c(new_n116_), .O(new_n1004_));
  nand2  g913(.a(new_n1004_), .b(new_n132_), .O(new_n1005_));
  inv1   g914(.a(new_n1005_), .O(new_n1006_));
  nand2  g915(.a(new_n207_), .b(x61), .O(new_n1007_));
  nand2  g916(.a(new_n857_), .b(new_n212_), .O(new_n1008_));
  nand2  g917(.a(new_n765_), .b(x53), .O(new_n1009_));
  nand2  g918(.a(new_n1009_), .b(new_n1008_), .O(new_n1010_));
  nand2  g919(.a(new_n1010_), .b(x72), .O(new_n1011_));
  inv1   g920(.a(x59), .O(new_n1012_));
  nand2  g921(.a(x74), .b(x58), .O(new_n1013_));
  oai21  g922(.a(x74), .b(new_n1012_), .c(new_n1013_), .O(new_n1014_));
  nand2  g923(.a(new_n1014_), .b(x73), .O(new_n1015_));
  nand2  g924(.a(new_n268_), .b(x60), .O(new_n1016_));
  nand2  g925(.a(new_n1016_), .b(new_n1015_), .O(new_n1017_));
  nand2  g926(.a(new_n1017_), .b(new_n203_), .O(new_n1018_));
  nand3  g927(.a(new_n1018_), .b(new_n1011_), .c(new_n1007_), .O(new_n1019_));
  aoi21  g928(.a(new_n1019_), .b(new_n777_), .c(new_n1006_), .O(new_n1020_));
  nand2  g929(.a(new_n207_), .b(x29), .O(new_n1021_));
  nand2  g930(.a(new_n872_), .b(new_n212_), .O(new_n1022_));
  nand2  g931(.a(new_n765_), .b(x21), .O(new_n1023_));
  nand2  g932(.a(new_n1023_), .b(new_n1022_), .O(new_n1024_));
  nand2  g933(.a(new_n1024_), .b(x72), .O(new_n1025_));
  nand2  g934(.a(x74), .b(x26), .O(new_n1026_));
  oai21  g935(.a(x74), .b(new_n883_), .c(new_n1026_), .O(new_n1027_));
  nand2  g936(.a(new_n1027_), .b(x73), .O(new_n1028_));
  nand2  g937(.a(new_n268_), .b(x28), .O(new_n1029_));
  nand2  g938(.a(new_n1029_), .b(new_n1028_), .O(new_n1030_));
  nand2  g939(.a(new_n1030_), .b(new_n203_), .O(new_n1031_));
  nand3  g940(.a(new_n1031_), .b(new_n1025_), .c(new_n1021_), .O(new_n1032_));
  nand2  g941(.a(new_n1032_), .b(new_n794_), .O(new_n1033_));
  oai21  g942(.a(new_n1020_), .b(new_n139_), .c(new_n1033_), .O(new_n1034_));
  nand2  g943(.a(new_n1034_), .b(new_n101_), .O(new_n1035_));
  aoi21  g944(.a(new_n1023_), .b(new_n1022_), .c(new_n203_), .O(new_n1036_));
  aoi21  g945(.a(new_n1029_), .b(new_n1028_), .c(x72), .O(new_n1037_));
  oai21  g946(.a(new_n1037_), .b(new_n1036_), .c(new_n116_), .O(new_n1038_));
  inv1   g947(.a(x29), .O(new_n1039_));
  nand2  g948(.a(x71), .b(x61), .O(new_n1040_));
  oai21  g949(.a(x71), .b(new_n1039_), .c(new_n1040_), .O(new_n1041_));
  nand2  g950(.a(new_n1041_), .b(new_n207_), .O(new_n1042_));
  aoi21  g951(.a(new_n1009_), .b(new_n1008_), .c(new_n203_), .O(new_n1043_));
  aoi21  g952(.a(new_n1016_), .b(new_n1015_), .c(x72), .O(new_n1044_));
  oai21  g953(.a(new_n1044_), .b(new_n1043_), .c(x71), .O(new_n1045_));
  nand3  g954(.a(new_n1045_), .b(new_n1042_), .c(new_n1038_), .O(new_n1046_));
  nand2  g955(.a(new_n1046_), .b(new_n219_), .O(new_n1047_));
  nor2   g956(.a(x45), .b(new_n111_), .O(new_n1048_));
  oai21  g957(.a(x47), .b(x46), .c(new_n1048_), .O(new_n1049_));
  oai21  g958(.a(new_n190_), .b(new_n111_), .c(x45), .O(new_n1050_));
  aoi21  g959(.a(new_n1050_), .b(new_n1049_), .c(x71), .O(new_n1051_));
  nand2  g960(.a(new_n1051_), .b(new_n816_), .O(new_n1052_));
  nand2  g961(.a(new_n1052_), .b(new_n1047_), .O(new_n1053_));
  nand2  g962(.a(new_n1053_), .b(x70), .O(new_n1054_));
  aoi21  g963(.a(new_n1054_), .b(new_n1035_), .c(new_n93_), .O(new_n1055_));
  nand2  g964(.a(new_n1004_), .b(new_n101_), .O(new_n1056_));
  nand2  g965(.a(new_n1051_), .b(x70), .O(new_n1057_));
  aoi21  g966(.a(new_n1057_), .b(new_n1056_), .c(new_n226_), .O(new_n1058_));
  oai21  g967(.a(new_n1058_), .b(new_n1055_), .c(new_n92_), .O(new_n1059_));
  oai22  g968(.a(new_n154_), .b(new_n1039_), .c(new_n116_), .d(new_n319_), .O(new_n1060_));
  nand2  g969(.a(new_n1060_), .b(x70), .O(new_n1061_));
  nand2  g970(.a(new_n157_), .b(x13), .O(new_n1062_));
  nand3  g971(.a(new_n126_), .b(x69), .c(x61), .O(new_n1063_));
  nand3  g972(.a(new_n1063_), .b(new_n1062_), .c(new_n1061_), .O(new_n1064_));
  and2   g973(.a(new_n1064_), .b(x67), .O(new_n1065_));
  nand2  g974(.a(new_n1032_), .b(new_n141_), .O(new_n1066_));
  nand2  g975(.a(new_n1019_), .b(new_n142_), .O(new_n1067_));
  aoi21  g976(.a(new_n1067_), .b(new_n1066_), .c(new_n833_), .O(new_n1068_));
  oai21  g977(.a(new_n1068_), .b(new_n1065_), .c(new_n137_), .O(new_n1069_));
  nand2  g978(.a(new_n1019_), .b(new_n131_), .O(new_n1070_));
  oai21  g979(.a(new_n131_), .b(new_n319_), .c(new_n1070_), .O(new_n1071_));
  nand2  g980(.a(new_n1071_), .b(new_n365_), .O(new_n1072_));
  aoi21  g981(.a(new_n1072_), .b(new_n1069_), .c(x66), .O(new_n1073_));
  nand2  g982(.a(new_n1064_), .b(new_n137_), .O(new_n1074_));
  nand3  g983(.a(new_n163_), .b(x68), .c(x45), .O(new_n1075_));
  aoi21  g984(.a(new_n1075_), .b(new_n1074_), .c(new_n370_), .O(new_n1076_));
  oai21  g985(.a(new_n1076_), .b(new_n1073_), .c(new_n171_), .O(new_n1077_));
  nand2  g986(.a(new_n1077_), .b(new_n1059_), .O(z13));
  zero   g987(.O(z14));
  zero   g988(.O(z15));
endmodule
