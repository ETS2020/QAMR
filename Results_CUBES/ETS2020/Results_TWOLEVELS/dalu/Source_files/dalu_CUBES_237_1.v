// Benchmark "FAU" written by ABC on Sun Aug  2 12:43:04 2020
...
module FAU ( 
  ...
  wire new_n92_, new_n93_, new_n94_, new_n95_, new_n96_, new_n97_, new_n98_,
    ...
    new_n830_, new_n831_, new_n832_, new_n833_, new_n834_, new_n839_,
  ...
  oai21  g661(.a(new_n479_), .b(new_n96_), .c(x11), .O(new_n754_));
  nand3  g662(.a(new_n405_), .b(new_n176_), .c(x00), .O(new_n755_));
  aoi21  g663(.a(new_n755_), .b(new_n754_), .c(new_n116_), .O(new_n756_));
  nand2  g664(.a(new_n756_), .b(new_n134_), .O(new_n757_));
  nand2  g665(.a(new_n207_), .b(x59), .O(new_n758_));
  nand2  g666(.a(new_n705_), .b(new_n704_), .O(new_n759_));
  nand2  g667(.a(new_n759_), .b(new_n212_), .O(new_n760_));
  nor2   g668(.a(x74), .b(new_n212_), .O(new_n761_));
  nand2  g669(.a(new_n761_), .b(x51), .O(new_n762_));
  nand2  g670(.a(new_n762_), .b(new_n760_), .O(new_n763_));
  nand2  g671(.a(new_n763_), .b(x72), .O(new_n764_));
  inv1   g672(.a(x57), .O(new_n765_));
  nand2  g673(.a(x74), .b(x56), .O(new_n766_));
  oai21  g674(.a(x74), .b(new_n765_), .c(new_n766_), .O(new_n767_));
  nand2  g675(.a(new_n767_), .b(x73), .O(new_n768_));
  nand2  g676(.a(new_n268_), .b(x58), .O(new_n769_));
  nand2  g677(.a(new_n769_), .b(new_n768_), .O(new_n770_));
  nand2  g678(.a(new_n770_), .b(new_n203_), .O(new_n771_));
  nand3  g679(.a(new_n771_), .b(new_n764_), .c(new_n758_), .O(new_n772_));
  nor2   g680(.a(x71), .b(new_n134_), .O(new_n773_));
  nand2  g681(.a(new_n773_), .b(new_n772_), .O(new_n774_));
  aoi21  g682(.a(new_n774_), .b(new_n757_), .c(new_n141_), .O(new_n775_));
  nand2  g683(.a(new_n207_), .b(x27), .O(new_n776_));
  nand2  g684(.a(new_n719_), .b(new_n718_), .O(new_n777_));
  nand2  g685(.a(new_n777_), .b(new_n212_), .O(new_n778_));
  nand2  g686(.a(new_n761_), .b(x19), .O(new_n779_));
  nand2  g687(.a(new_n779_), .b(new_n778_), .O(new_n780_));
  nand2  g688(.a(new_n780_), .b(x72), .O(new_n781_));
  nand2  g689(.a(x74), .b(x24), .O(new_n782_));
  oai21  g690(.a(x74), .b(new_n736_), .c(new_n782_), .O(new_n783_));
  nand2  g691(.a(new_n783_), .b(x73), .O(new_n784_));
  nand2  g692(.a(new_n268_), .b(x26), .O(new_n785_));
  nand2  g693(.a(new_n785_), .b(new_n784_), .O(new_n786_));
  nand2  g694(.a(new_n786_), .b(new_n203_), .O(new_n787_));
  nand3  g695(.a(new_n787_), .b(new_n781_), .c(new_n776_), .O(new_n788_));
  inv1   g696(.a(new_n788_), .O(new_n789_));
  nand3  g697(.a(new_n146_), .b(x71), .c(x69), .O(new_n790_));
  nor2   g698(.a(new_n790_), .b(new_n789_), .O(new_n791_));
  oai21  g699(.a(new_n791_), .b(new_n775_), .c(new_n100_), .O(new_n792_));
  aoi21  g700(.a(new_n779_), .b(new_n778_), .c(new_n203_), .O(new_n793_));
  aoi21  g701(.a(new_n785_), .b(new_n784_), .c(x72), .O(new_n794_));
  oai21  g702(.a(new_n794_), .b(new_n793_), .c(new_n116_), .O(new_n795_));
  inv1   g703(.a(x27), .O(new_n796_));
  nand2  g704(.a(x71), .b(x59), .O(new_n797_));
  oai21  g705(.a(x71), .b(new_n796_), .c(new_n797_), .O(new_n798_));
  nand2  g706(.a(new_n798_), .b(new_n207_), .O(new_n799_));
  aoi21  g707(.a(new_n762_), .b(new_n760_), .c(new_n203_), .O(new_n800_));
  aoi21  g708(.a(new_n769_), .b(new_n768_), .c(x72), .O(new_n801_));
  oai21  g709(.a(new_n801_), .b(new_n800_), .c(x71), .O(new_n802_));
  nand3  g710(.a(new_n802_), .b(new_n799_), .c(new_n795_), .O(new_n803_));
  nand2  g711(.a(new_n803_), .b(new_n219_), .O(new_n804_));
  oai21  g712(.a(new_n487_), .b(new_n112_), .c(x43), .O(new_n805_));
  nand3  g713(.a(new_n412_), .b(new_n189_), .c(x32), .O(new_n806_));
  aoi21  g714(.a(new_n806_), .b(new_n805_), .c(x71), .O(new_n807_));
  nand4  g715(.a(new_n807_), .b(new_n155_), .c(x68), .d(new_n134_), .O(new_n808_));
  nand2  g716(.a(new_n808_), .b(new_n804_), .O(new_n809_));
  nand2  g717(.a(new_n809_), .b(x70), .O(new_n810_));
  aoi21  g718(.a(new_n810_), .b(new_n792_), .c(new_n93_), .O(new_n811_));
  nand2  g719(.a(new_n756_), .b(new_n100_), .O(new_n812_));
  nand2  g720(.a(new_n807_), .b(x70), .O(new_n813_));
  aoi21  g721(.a(new_n813_), .b(new_n812_), .c(new_n226_), .O(new_n814_));
  oai21  g722(.a(new_n814_), .b(new_n811_), .c(new_n92_), .O(new_n815_));
  oai22  g723(.a(new_n156_), .b(new_n796_), .c(new_n116_), .d(new_n189_), .O(new_n816_));
  nand2  g724(.a(new_n816_), .b(x70), .O(new_n817_));
  nand2  g725(.a(new_n159_), .b(x11), .O(new_n818_));
  nand3  g726(.a(new_n128_), .b(x69), .c(x59), .O(new_n819_));
  nand3  g727(.a(new_n819_), .b(new_n818_), .c(new_n817_), .O(new_n820_));
  and2   g728(.a(new_n820_), .b(x67), .O(new_n821_));
  nand2  g729(.a(new_n788_), .b(new_n143_), .O(new_n822_));
  nand2  g730(.a(new_n772_), .b(new_n144_), .O(new_n823_));
  nand2  g731(.a(x69), .b(new_n133_), .O(new_n824_));
  aoi21  g732(.a(new_n823_), .b(new_n822_), .c(new_n824_), .O(new_n825_));
  oai21  g733(.a(new_n825_), .b(new_n821_), .c(new_n139_), .O(new_n826_));
  nand2  g734(.a(new_n772_), .b(new_n133_), .O(new_n827_));
  oai21  g735(.a(new_n133_), .b(new_n189_), .c(new_n827_), .O(new_n828_));
  nand2  g736(.a(new_n828_), .b(new_n363_), .O(new_n829_));
  aoi21  g737(.a(new_n829_), .b(new_n826_), .c(x66), .O(new_n830_));
  nand2  g738(.a(new_n820_), .b(new_n139_), .O(new_n831_));
  nand3  g739(.a(new_n165_), .b(x68), .c(x43), .O(new_n832_));
  aoi21  g740(.a(new_n832_), .b(new_n831_), .c(new_n368_), .O(new_n833_));
  oai21  g741(.a(new_n833_), .b(new_n830_), .c(new_n173_), .O(new_n834_));
  nand2  g742(.a(new_n834_), .b(new_n815_), .O(z11));
  inv1   g743(.a(x31), .O(new_n839_));
  inv1   g744(.a(x47), .O(new_n840_));
  oai22  g745(.a(new_n156_), .b(new_n839_), .c(new_n116_), .d(new_n840_), .O(new_n841_));
  nand2  g746(.a(new_n841_), .b(x70), .O(new_n842_));
  nand2  g747(.a(new_n159_), .b(x15), .O(new_n843_));
  nand3  g748(.a(new_n128_), .b(x69), .c(x63), .O(new_n844_));
  nand3  g749(.a(new_n844_), .b(new_n843_), .c(new_n842_), .O(new_n845_));
  and2   g750(.a(new_n845_), .b(x67), .O(new_n846_));
  nand2  g751(.a(x74), .b(x28), .O(new_n847_));
  nand2  g752(.a(new_n209_), .b(x29), .O(new_n848_));
  aoi21  g753(.a(new_n848_), .b(new_n847_), .c(new_n212_), .O(new_n849_));
  nand2  g754(.a(new_n268_), .b(x30), .O(new_n850_));
  inv1   g755(.a(new_n850_), .O(new_n851_));
  oai21  g756(.a(new_n851_), .b(new_n849_), .c(new_n203_), .O(new_n852_));
  nand2  g757(.a(new_n207_), .b(x31), .O(new_n853_));
  nand2  g758(.a(x74), .b(x26), .O(new_n854_));
  nand2  g759(.a(new_n209_), .b(x27), .O(new_n855_));
  aoi21  g760(.a(new_n855_), .b(new_n854_), .c(x73), .O(new_n856_));
  nand2  g761(.a(new_n761_), .b(x23), .O(new_n857_));
  inv1   g762(.a(new_n857_), .O(new_n858_));
  oai21  g763(.a(new_n858_), .b(new_n856_), .c(x72), .O(new_n859_));
  nand3  g764(.a(new_n859_), .b(new_n853_), .c(new_n852_), .O(new_n860_));
  nand2  g765(.a(new_n860_), .b(new_n143_), .O(new_n861_));
  nand2  g766(.a(x74), .b(x60), .O(new_n862_));
  nand2  g767(.a(new_n209_), .b(x61), .O(new_n863_));
  aoi21  g768(.a(new_n863_), .b(new_n862_), .c(new_n212_), .O(new_n864_));
  nand2  g769(.a(new_n268_), .b(x62), .O(new_n865_));
  inv1   g770(.a(new_n865_), .O(new_n866_));
  oai21  g771(.a(new_n866_), .b(new_n864_), .c(new_n203_), .O(new_n867_));
  nand2  g772(.a(new_n207_), .b(x63), .O(new_n868_));
  nand2  g773(.a(x74), .b(x58), .O(new_n869_));
  nand2  g774(.a(new_n209_), .b(x59), .O(new_n870_));
  aoi21  g775(.a(new_n870_), .b(new_n869_), .c(x73), .O(new_n871_));
  nand2  g776(.a(new_n761_), .b(x55), .O(new_n872_));
  inv1   g777(.a(new_n872_), .O(new_n873_));
  oai21  g778(.a(new_n873_), .b(new_n871_), .c(x72), .O(new_n874_));
  nand3  g779(.a(new_n874_), .b(new_n868_), .c(new_n867_), .O(new_n875_));
  nand2  g780(.a(new_n875_), .b(new_n144_), .O(new_n876_));
  aoi21  g781(.a(new_n876_), .b(new_n861_), .c(new_n824_), .O(new_n877_));
  oai21  g782(.a(new_n877_), .b(new_n846_), .c(new_n151_), .O(new_n878_));
  nand2  g783(.a(new_n845_), .b(new_n152_), .O(new_n879_));
  aoi21  g784(.a(new_n879_), .b(new_n878_), .c(new_n634_), .O(new_n880_));
  nand4  g785(.a(new_n94_), .b(x69), .c(x65), .d(new_n92_), .O(new_n881_));
  aoi21  g786(.a(new_n876_), .b(new_n861_), .c(new_n881_), .O(new_n882_));
  oai21  g787(.a(new_n882_), .b(new_n880_), .c(new_n139_), .O(new_n883_));
  nand3  g788(.a(x71), .b(new_n134_), .c(x15), .O(new_n884_));
  inv1   g789(.a(new_n884_), .O(new_n885_));
  aoi21  g790(.a(new_n875_), .b(new_n773_), .c(new_n885_), .O(new_n886_));
  nand3  g791(.a(new_n118_), .b(new_n134_), .c(x47), .O(new_n887_));
  oai21  g792(.a(new_n886_), .b(x70), .c(new_n887_), .O(new_n888_));
  nand2  g793(.a(new_n102_), .b(x15), .O(new_n889_));
  nand2  g794(.a(new_n118_), .b(x47), .O(new_n890_));
  aoi21  g795(.a(new_n890_), .b(new_n889_), .c(new_n136_), .O(new_n891_));
  aoi21  g796(.a(new_n888_), .b(new_n94_), .c(new_n891_), .O(new_n892_));
  nand2  g797(.a(new_n875_), .b(new_n93_), .O(new_n893_));
  oai21  g798(.a(new_n153_), .b(new_n840_), .c(new_n893_), .O(new_n894_));
  nand3  g799(.a(new_n894_), .b(new_n173_), .c(new_n128_), .O(new_n895_));
  oai21  g800(.a(new_n892_), .b(x64), .c(new_n895_), .O(new_n896_));
  nand2  g801(.a(new_n896_), .b(new_n140_), .O(new_n897_));
  nand2  g802(.a(new_n897_), .b(new_n883_), .O(z15));
  zero   g803(.O(z10));
  zero   g804(.O(z12));
  zero   g805(.O(z13));
  zero   g806(.O(z14));
