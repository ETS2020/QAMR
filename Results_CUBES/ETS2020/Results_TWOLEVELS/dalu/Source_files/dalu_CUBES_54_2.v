...
module FAU ( 
  ...
  inv1   g841(.a(x31), .O(new_n936_));
  inv1   g842(.a(x47), .O(new_n937_));
  oai22  g843(.a(new_n156_), .b(new_n936_), .c(new_n116_), .d(new_n937_), .O(new_n938_));
  nand2  g844(.a(new_n938_), .b(x70), .O(new_n939_));
  nand2  g845(.a(new_n159_), .b(x15), .O(new_n940_));
  nand3  g846(.a(new_n128_), .b(x69), .c(x63), .O(new_n941_));
  nand3  g847(.a(new_n941_), .b(new_n940_), .c(new_n939_), .O(new_n942_));
  and2   g848(.a(new_n942_), .b(x67), .O(new_n943_));
  nand2  g849(.a(x74), .b(x28), .O(new_n944_));
  nand2  g850(.a(new_n209_), .b(x29), .O(new_n945_));
  aoi21  g851(.a(new_n945_), .b(new_n944_), .c(new_n212_), .O(new_n946_));
  nand2  g852(.a(new_n268_), .b(x30), .O(new_n947_));
  inv1   g853(.a(new_n947_), .O(new_n948_));
  oai21  g854(.a(new_n948_), .b(new_n946_), .c(new_n203_), .O(new_n949_));
  nand2  g855(.a(new_n207_), .b(x31), .O(new_n950_));
  aoi21  g856(.a(new_n882_), .b(new_n881_), .c(x73), .O(new_n951_));
  nand2  g857(.a(new_n769_), .b(x23), .O(new_n952_));
  inv1   g858(.a(new_n952_), .O(new_n953_));
  oai21  g859(.a(new_n953_), .b(new_n951_), .c(x72), .O(new_n954_));
  nand3  g860(.a(new_n954_), .b(new_n950_), .c(new_n949_), .O(new_n955_));
  nand2  g861(.a(new_n955_), .b(new_n143_), .O(new_n956_));
  nand2  g862(.a(x74), .b(x60), .O(new_n957_));
  nand2  g863(.a(new_n209_), .b(x61), .O(new_n958_));
  aoi21  g864(.a(new_n958_), .b(new_n957_), .c(new_n212_), .O(new_n959_));
  nand2  g865(.a(new_n268_), .b(x62), .O(new_n960_));
  inv1   g866(.a(new_n960_), .O(new_n961_));
  oai21  g867(.a(new_n961_), .b(new_n959_), .c(new_n203_), .O(new_n962_));
  nand2  g868(.a(new_n207_), .b(x63), .O(new_n963_));
  aoi21  g869(.a(new_n866_), .b(new_n865_), .c(x73), .O(new_n964_));
  nand2  g870(.a(new_n769_), .b(x55), .O(new_n965_));
  inv1   g871(.a(new_n965_), .O(new_n966_));
  oai21  g872(.a(new_n966_), .b(new_n964_), .c(x72), .O(new_n967_));
  nand3  g873(.a(new_n967_), .b(new_n963_), .c(new_n962_), .O(new_n968_));
  nand2  g874(.a(new_n968_), .b(new_n144_), .O(new_n969_));
  aoi21  g875(.a(new_n969_), .b(new_n956_), .c(new_n839_), .O(new_n970_));
  oai21  g876(.a(new_n970_), .b(new_n943_), .c(new_n151_), .O(new_n971_));
  nand2  g877(.a(new_n942_), .b(new_n152_), .O(new_n972_));
  aoi21  g878(.a(new_n972_), .b(new_n971_), .c(new_n636_), .O(new_n973_));
  nand4  g879(.a(new_n94_), .b(x69), .c(x65), .d(new_n92_), .O(new_n974_));
  aoi21  g880(.a(new_n969_), .b(new_n956_), .c(new_n974_), .O(new_n975_));
  oai21  g881(.a(new_n975_), .b(new_n973_), .c(new_n139_), .O(new_n976_));
  nand3  g882(.a(x71), .b(new_n134_), .c(x15), .O(new_n977_));
  inv1   g883(.a(new_n977_), .O(new_n978_));
  aoi21  g884(.a(new_n968_), .b(new_n781_), .c(new_n978_), .O(new_n979_));
  nand3  g885(.a(new_n118_), .b(new_n134_), .c(x47), .O(new_n980_));
  oai21  g886(.a(new_n979_), .b(x70), .c(new_n980_), .O(new_n981_));
  nand2  g887(.a(new_n102_), .b(x15), .O(new_n982_));
  nand2  g888(.a(new_n118_), .b(x47), .O(new_n983_));
  aoi21  g889(.a(new_n983_), .b(new_n982_), .c(new_n136_), .O(new_n984_));
  aoi21  g890(.a(new_n981_), .b(new_n94_), .c(new_n984_), .O(new_n985_));
  nand2  g891(.a(new_n968_), .b(new_n93_), .O(new_n986_));
  oai21  g892(.a(new_n153_), .b(new_n937_), .c(new_n986_), .O(new_n987_));
  nand3  g893(.a(new_n987_), .b(new_n173_), .c(new_n128_), .O(new_n988_));
  oai21  g894(.a(new_n985_), .b(x64), .c(new_n988_), .O(new_n989_));
  nand2  g895(.a(new_n989_), .b(new_n140_), .O(new_n990_));
  nand2  g896(.a(new_n990_), .b(new_n976_), .O(z15));
  zero   g897(.O(z10));
  zero   g898(.O(z11));
  zero   g899(.O(z14));
endmodule
