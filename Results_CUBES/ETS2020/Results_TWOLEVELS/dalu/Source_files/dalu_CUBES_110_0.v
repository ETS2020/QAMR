// Benchmark "FAU" written by ABC on Sun Aug  2 11:33:41 2020
...
module FAU ( 
  ...
  inv1   g171(.a(new_n118_), .O(new_n272_));
  inv1   g172(.a(new_n119_), .O(new_n273_));
  oai21  g173(.a(new_n273_), .b(new_n272_), .c(x32), .O(new_n274_));
  nand2  g174(.a(new_n274_), .b(x42), .O(new_n275_));
  nand2  g175(.a(new_n119_), .b(new_n118_), .O(new_n276_));
  nand3  g176(.a(new_n276_), .b(new_n117_), .c(x32), .O(new_n277_));
  aoi21  g177(.a(new_n277_), .b(new_n275_), .c(x71), .O(new_n278_));
  nand3  g178(.a(new_n156_), .b(x68), .c(new_n176_), .O(new_n279_));
  inv1   g179(.a(new_n279_), .O(new_n280_));
  nand2  g180(.a(new_n280_), .b(new_n278_), .O(new_n281_));
  nand2  g181(.a(new_n281_), .b(new_n271_), .O(new_n282_));
  nand2  g182(.a(new_n282_), .b(x70), .O(new_n283_));
  aoi21  g183(.a(new_n283_), .b(new_n257_), .c(new_n102_), .O(new_n284_));
  nand3  g184(.a(new_n217_), .b(x71), .c(new_n112_), .O(new_n285_));
  nand2  g185(.a(new_n278_), .b(x70), .O(new_n286_));
  aoi21  g186(.a(new_n286_), .b(new_n285_), .c(new_n182_), .O(new_n287_));
  oai21  g187(.a(new_n287_), .b(new_n284_), .c(new_n101_), .O(new_n288_));
  oai22  g188(.a(new_n187_), .b(new_n261_), .c(new_n125_), .d(new_n117_), .O(new_n289_));
  nand2  g189(.a(new_n289_), .b(x70), .O(new_n290_));
  nand2  g190(.a(new_n190_), .b(x10), .O(new_n291_));
  nand3  g191(.a(new_n192_), .b(x69), .c(x58), .O(new_n292_));
  nand3  g192(.a(new_n292_), .b(new_n291_), .c(new_n290_), .O(new_n293_));
  and2   g193(.a(new_n293_), .b(x67), .O(new_n294_));
  nand2  g194(.a(new_n253_), .b(new_n157_), .O(new_n295_));
  nand2  g195(.a(new_n234_), .b(new_n173_), .O(new_n296_));
  nand2  g196(.a(x69), .b(new_n180_), .O(new_n297_));
  aoi21  g197(.a(new_n296_), .b(new_n295_), .c(new_n297_), .O(new_n298_));
  oai21  g198(.a(new_n298_), .b(new_n294_), .c(new_n153_), .O(new_n299_));
  nand2  g199(.a(new_n234_), .b(new_n180_), .O(new_n300_));
  oai21  g200(.a(new_n180_), .b(new_n117_), .c(new_n300_), .O(new_n301_));
  nand2  g201(.a(new_n301_), .b(new_n200_), .O(new_n302_));
  aoi21  g202(.a(new_n302_), .b(new_n299_), .c(x66), .O(new_n303_));
  nand2  g203(.a(new_n293_), .b(new_n153_), .O(new_n304_));
  nand3  g204(.a(new_n204_), .b(x68), .c(x42), .O(new_n305_));
  aoi21  g205(.a(new_n305_), .b(new_n304_), .c(new_n207_), .O(new_n306_));
  oai21  g206(.a(new_n306_), .b(new_n303_), .c(new_n210_), .O(new_n307_));
  nand2  g207(.a(new_n307_), .b(new_n288_), .O(z10));
  nand2  g208(.a(x15), .b(x00), .O(new_n312_));
  xor2a  g209(.a(new_n312_), .b(x14), .O(new_n313_));
  nor2   g210(.a(new_n313_), .b(new_n125_), .O(new_n314_));
  nand2  g211(.a(new_n141_), .b(x62), .O(new_n315_));
  nand2  g212(.a(x74), .b(x57), .O(new_n316_));
  nand2  g213(.a(new_n133_), .b(x58), .O(new_n317_));
  aoi21  g214(.a(new_n317_), .b(new_n316_), .c(x73), .O(new_n318_));
  nand3  g215(.a(new_n133_), .b(x73), .c(x54), .O(new_n319_));
  inv1   g216(.a(new_n319_), .O(new_n320_));
  oai21  g217(.a(new_n320_), .b(new_n318_), .c(x72), .O(new_n321_));
  nand2  g218(.a(x74), .b(x59), .O(new_n322_));
  nand2  g219(.a(new_n133_), .b(x60), .O(new_n323_));
  aoi21  g220(.a(new_n323_), .b(new_n322_), .c(new_n131_), .O(new_n324_));
  nand3  g221(.a(x74), .b(new_n131_), .c(x61), .O(new_n325_));
  inv1   g222(.a(new_n325_), .O(new_n326_));
  oai21  g223(.a(new_n326_), .b(new_n324_), .c(new_n130_), .O(new_n327_));
  nand3  g224(.a(new_n327_), .b(new_n321_), .c(new_n315_), .O(new_n328_));
  aoi22  g225(.a(new_n328_), .b(new_n235_), .c(new_n314_), .d(new_n176_), .O(new_n329_));
  nand2  g226(.a(new_n141_), .b(x30), .O(new_n330_));
  nand2  g227(.a(x74), .b(x25), .O(new_n331_));
  oai21  g228(.a(x74), .b(new_n261_), .c(new_n331_), .O(new_n332_));
  nand2  g229(.a(new_n332_), .b(new_n131_), .O(new_n333_));
  nand3  g230(.a(new_n133_), .b(x73), .c(x22), .O(new_n334_));
  nand2  g231(.a(new_n334_), .b(new_n333_), .O(new_n335_));
  nand2  g232(.a(new_n335_), .b(x72), .O(new_n336_));
  inv1   g233(.a(x28), .O(new_n337_));
  nand2  g234(.a(x74), .b(x27), .O(new_n338_));
  oai21  g235(.a(x74), .b(new_n337_), .c(new_n338_), .O(new_n339_));
  nand2  g236(.a(new_n339_), .b(x73), .O(new_n340_));
  nand3  g237(.a(x74), .b(new_n131_), .c(x29), .O(new_n341_));
  nand2  g238(.a(new_n341_), .b(new_n340_), .O(new_n342_));
  nand2  g239(.a(new_n342_), .b(new_n130_), .O(new_n343_));
  nand3  g240(.a(new_n343_), .b(new_n336_), .c(new_n330_), .O(new_n344_));
  nand2  g241(.a(new_n344_), .b(new_n255_), .O(new_n345_));
  oai21  g242(.a(new_n329_), .b(new_n213_), .c(new_n345_), .O(new_n346_));
  nand2  g243(.a(new_n346_), .b(new_n112_), .O(new_n347_));
  aoi21  g244(.a(new_n334_), .b(new_n333_), .c(new_n130_), .O(new_n348_));
  aoi21  g245(.a(new_n341_), .b(new_n340_), .c(x72), .O(new_n349_));
  oai21  g246(.a(new_n349_), .b(new_n348_), .c(new_n125_), .O(new_n350_));
  inv1   g247(.a(x30), .O(new_n351_));
  nand2  g248(.a(x71), .b(x62), .O(new_n352_));
  oai21  g249(.a(x71), .b(new_n351_), .c(new_n352_), .O(new_n353_));
  nand2  g250(.a(new_n353_), .b(new_n141_), .O(new_n354_));
  inv1   g251(.a(x58), .O(new_n355_));
  oai21  g252(.a(x74), .b(new_n355_), .c(new_n316_), .O(new_n356_));
  nand2  g253(.a(new_n356_), .b(new_n131_), .O(new_n357_));
  aoi21  g254(.a(new_n319_), .b(new_n357_), .c(new_n130_), .O(new_n358_));
  inv1   g255(.a(x60), .O(new_n359_));
  oai21  g256(.a(x74), .b(new_n359_), .c(new_n322_), .O(new_n360_));
  nand2  g257(.a(new_n360_), .b(x73), .O(new_n361_));
  aoi21  g258(.a(new_n325_), .b(new_n361_), .c(x72), .O(new_n362_));
  oai21  g259(.a(new_n362_), .b(new_n358_), .c(x71), .O(new_n363_));
  nand3  g260(.a(new_n363_), .b(new_n354_), .c(new_n350_), .O(new_n364_));
  nand2  g261(.a(new_n364_), .b(new_n270_), .O(new_n365_));
  nand2  g262(.a(x47), .b(x32), .O(new_n366_));
  xor2a  g263(.a(new_n366_), .b(x46), .O(new_n367_));
  nor2   g264(.a(new_n367_), .b(x71), .O(new_n368_));
  nand2  g265(.a(new_n368_), .b(new_n280_), .O(new_n369_));
  nand2  g266(.a(new_n369_), .b(new_n365_), .O(new_n370_));
  nand2  g267(.a(new_n370_), .b(x70), .O(new_n371_));
  aoi21  g268(.a(new_n371_), .b(new_n347_), .c(new_n102_), .O(new_n372_));
  nand2  g269(.a(new_n314_), .b(new_n112_), .O(new_n373_));
  nand2  g270(.a(new_n368_), .b(x70), .O(new_n374_));
  aoi21  g271(.a(new_n374_), .b(new_n373_), .c(new_n182_), .O(new_n375_));
  oai21  g272(.a(new_n375_), .b(new_n372_), .c(new_n101_), .O(new_n376_));
  inv1   g273(.a(x46), .O(new_n377_));
  oai22  g274(.a(new_n187_), .b(new_n351_), .c(new_n125_), .d(new_n377_), .O(new_n378_));
  nand2  g275(.a(new_n378_), .b(x70), .O(new_n379_));
  nand2  g276(.a(new_n190_), .b(x14), .O(new_n380_));
  nand3  g277(.a(new_n192_), .b(x69), .c(x62), .O(new_n381_));
  nand3  g278(.a(new_n381_), .b(new_n380_), .c(new_n379_), .O(new_n382_));
  and2   g279(.a(new_n382_), .b(x67), .O(new_n383_));
  nand2  g280(.a(new_n344_), .b(new_n157_), .O(new_n384_));
  nand2  g281(.a(new_n328_), .b(new_n173_), .O(new_n385_));
  aoi21  g282(.a(new_n385_), .b(new_n384_), .c(new_n297_), .O(new_n386_));
  oai21  g283(.a(new_n386_), .b(new_n383_), .c(new_n153_), .O(new_n387_));
  nand2  g284(.a(new_n328_), .b(new_n180_), .O(new_n388_));
  oai21  g285(.a(new_n180_), .b(new_n377_), .c(new_n388_), .O(new_n389_));
  nand2  g286(.a(new_n389_), .b(new_n200_), .O(new_n390_));
  aoi21  g287(.a(new_n390_), .b(new_n387_), .c(x66), .O(new_n391_));
  nand2  g288(.a(new_n382_), .b(new_n153_), .O(new_n392_));
  nand3  g289(.a(new_n204_), .b(x68), .c(x46), .O(new_n393_));
  aoi21  g290(.a(new_n393_), .b(new_n392_), .c(new_n207_), .O(new_n394_));
  oai21  g291(.a(new_n394_), .b(new_n391_), .c(new_n210_), .O(new_n395_));
  nand2  g292(.a(new_n395_), .b(new_n376_), .O(z14));
  inv1   g293(.a(x31), .O(new_n397_));
  nand2  g294(.a(x71), .b(x47), .O(new_n398_));
  oai21  g295(.a(new_n187_), .b(new_n397_), .c(new_n398_), .O(new_n399_));
  nand2  g296(.a(new_n399_), .b(x70), .O(new_n400_));
  nand2  g297(.a(new_n190_), .b(x15), .O(new_n401_));
  nand3  g298(.a(new_n192_), .b(x69), .c(x63), .O(new_n402_));
  nand3  g299(.a(new_n402_), .b(new_n401_), .c(new_n400_), .O(new_n403_));
  and2   g300(.a(new_n403_), .b(x67), .O(new_n404_));
  nand2  g301(.a(x74), .b(x28), .O(new_n405_));
  nand2  g302(.a(new_n133_), .b(x29), .O(new_n406_));
  aoi21  g303(.a(new_n406_), .b(new_n405_), .c(new_n131_), .O(new_n407_));
  nand3  g304(.a(x74), .b(new_n131_), .c(x30), .O(new_n408_));
  inv1   g305(.a(new_n408_), .O(new_n409_));
  oai21  g306(.a(new_n409_), .b(new_n407_), .c(new_n130_), .O(new_n410_));
  nand2  g307(.a(new_n141_), .b(x31), .O(new_n411_));
  nand2  g308(.a(x74), .b(x26), .O(new_n412_));
  nand2  g309(.a(new_n133_), .b(x27), .O(new_n413_));
  aoi21  g310(.a(new_n413_), .b(new_n412_), .c(x73), .O(new_n414_));
  nand3  g311(.a(new_n133_), .b(x73), .c(x23), .O(new_n415_));
  inv1   g312(.a(new_n415_), .O(new_n416_));
  oai21  g313(.a(new_n416_), .b(new_n414_), .c(x72), .O(new_n417_));
  nand3  g314(.a(new_n417_), .b(new_n411_), .c(new_n410_), .O(new_n418_));
  nand2  g315(.a(new_n418_), .b(new_n157_), .O(new_n419_));
  nand2  g316(.a(x74), .b(x60), .O(new_n420_));
  nand2  g317(.a(new_n133_), .b(x61), .O(new_n421_));
  aoi21  g318(.a(new_n421_), .b(new_n420_), .c(new_n131_), .O(new_n422_));
  nand3  g319(.a(x74), .b(new_n131_), .c(x62), .O(new_n423_));
  inv1   g320(.a(new_n423_), .O(new_n424_));
  oai21  g321(.a(new_n424_), .b(new_n422_), .c(new_n130_), .O(new_n425_));
  nand2  g322(.a(new_n141_), .b(x63), .O(new_n426_));
  nand2  g323(.a(x74), .b(x58), .O(new_n427_));
  nand2  g324(.a(new_n133_), .b(x59), .O(new_n428_));
  aoi21  g325(.a(new_n428_), .b(new_n427_), .c(x73), .O(new_n429_));
  nand3  g326(.a(new_n133_), .b(x73), .c(x55), .O(new_n430_));
  inv1   g327(.a(new_n430_), .O(new_n431_));
  oai21  g328(.a(new_n431_), .b(new_n429_), .c(x72), .O(new_n432_));
  nand3  g329(.a(new_n432_), .b(new_n426_), .c(new_n425_), .O(new_n433_));
  nand2  g330(.a(new_n433_), .b(new_n173_), .O(new_n434_));
  aoi21  g331(.a(new_n434_), .b(new_n419_), .c(new_n297_), .O(new_n435_));
  oai21  g332(.a(new_n435_), .b(new_n404_), .c(new_n185_), .O(new_n436_));
  nand2  g333(.a(new_n403_), .b(new_n206_), .O(new_n437_));
  aoi21  g334(.a(new_n437_), .b(new_n436_), .c(new_n211_), .O(new_n438_));
  inv1   g335(.a(new_n102_), .O(new_n439_));
  nand4  g336(.a(new_n439_), .b(x69), .c(x65), .d(new_n101_), .O(new_n440_));
  aoi21  g337(.a(new_n434_), .b(new_n419_), .c(new_n440_), .O(new_n441_));
  oai21  g338(.a(new_n441_), .b(new_n438_), .c(new_n153_), .O(new_n442_));
  nand3  g339(.a(x71), .b(new_n176_), .c(x15), .O(new_n443_));
  inv1   g340(.a(new_n443_), .O(new_n444_));
  aoi21  g341(.a(new_n433_), .b(new_n235_), .c(new_n444_), .O(new_n445_));
  nand3  g342(.a(new_n127_), .b(new_n176_), .c(x47), .O(new_n446_));
  oai21  g343(.a(new_n445_), .b(x70), .c(new_n446_), .O(new_n447_));
  aoi22  g344(.a(new_n127_), .b(x47), .c(new_n114_), .d(x15), .O(new_n448_));
  nand2  g345(.a(new_n181_), .b(new_n180_), .O(new_n449_));
  nor2   g346(.a(new_n449_), .b(new_n448_), .O(new_n450_));
  aoi21  g347(.a(new_n447_), .b(new_n439_), .c(new_n450_), .O(new_n451_));
  nor2   g348(.a(new_n180_), .b(x66), .O(new_n452_));
  oai21  g349(.a(new_n452_), .b(new_n206_), .c(x47), .O(new_n453_));
  nand2  g350(.a(new_n433_), .b(new_n102_), .O(new_n454_));
  nand2  g351(.a(new_n454_), .b(new_n453_), .O(new_n455_));
  nand3  g352(.a(new_n455_), .b(new_n210_), .c(new_n192_), .O(new_n456_));
  oai21  g353(.a(new_n451_), .b(x64), .c(new_n456_), .O(new_n457_));
  nand2  g354(.a(new_n457_), .b(new_n154_), .O(new_n458_));
  nand2  g355(.a(new_n458_), .b(new_n442_), .O(z15));
  zero   g356(.O(z00));
  zero   g357(.O(z01));
  zero   g358(.O(z02));
  zero   g359(.O(z03));
