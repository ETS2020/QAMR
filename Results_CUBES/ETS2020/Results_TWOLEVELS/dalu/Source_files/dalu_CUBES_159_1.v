...
module FAU ( 
  ...
  wire new_n92_, new_n93_, new_n94_, new_n95_, new_n96_, new_n97_, new_n98_,
    ...
    new_n921_, new_n922_, new_n926_, new_n927_, new_n928_, new_n929_,
  ...
  inv1   g784(.a(new_n876_), .O(new_n877_));
  nor2   g785(.a(new_n877_), .b(new_n793_), .O(new_n878_));
  oai21  g786(.a(new_n878_), .b(new_n864_), .c(new_n100_), .O(new_n879_));
  aoi21  g787(.a(new_n867_), .b(new_n866_), .c(new_n203_), .O(new_n880_));
  aoi21  g788(.a(new_n873_), .b(new_n872_), .c(x72), .O(new_n881_));
  oai21  g789(.a(new_n881_), .b(new_n880_), .c(new_n116_), .O(new_n882_));
  inv1   g790(.a(x28), .O(new_n883_));
  nand2  g791(.a(x71), .b(x60), .O(new_n884_));
  oai21  g792(.a(x71), .b(new_n883_), .c(new_n884_), .O(new_n885_));
  nand2  g793(.a(new_n885_), .b(new_n207_), .O(new_n886_));
  aoi21  g794(.a(new_n852_), .b(new_n851_), .c(new_n203_), .O(new_n887_));
  aoi21  g795(.a(new_n859_), .b(new_n858_), .c(x72), .O(new_n888_));
  oai21  g796(.a(new_n888_), .b(new_n887_), .c(x71), .O(new_n889_));
  nand3  g797(.a(new_n889_), .b(new_n886_), .c(new_n882_), .O(new_n890_));
  nand2  g798(.a(new_n890_), .b(new_n219_), .O(new_n891_));
  oai21  g799(.a(new_n319_), .b(new_n112_), .c(x44), .O(new_n892_));
  inv1   g800(.a(x44), .O(new_n893_));
  inv1   g801(.a(new_n319_), .O(new_n894_));
  nand3  g802(.a(new_n894_), .b(new_n893_), .c(x32), .O(new_n895_));
  aoi21  g803(.a(new_n895_), .b(new_n892_), .c(x71), .O(new_n896_));
  nand2  g804(.a(new_n896_), .b(new_n814_), .O(new_n897_));
  nand2  g805(.a(new_n897_), .b(new_n891_), .O(new_n898_));
  nand2  g806(.a(new_n898_), .b(x70), .O(new_n899_));
  aoi21  g807(.a(new_n899_), .b(new_n879_), .c(new_n93_), .O(new_n900_));
  nand2  g808(.a(new_n848_), .b(new_n100_), .O(new_n901_));
  nand2  g809(.a(new_n896_), .b(x70), .O(new_n902_));
  aoi21  g810(.a(new_n902_), .b(new_n901_), .c(new_n226_), .O(new_n903_));
  oai21  g811(.a(new_n903_), .b(new_n900_), .c(new_n92_), .O(new_n904_));
  oai22  g812(.a(new_n156_), .b(new_n883_), .c(new_n116_), .d(new_n893_), .O(new_n905_));
  nand2  g813(.a(new_n905_), .b(x70), .O(new_n906_));
  nand2  g814(.a(new_n159_), .b(x12), .O(new_n907_));
  nand3  g815(.a(new_n128_), .b(x69), .c(x60), .O(new_n908_));
  nand3  g816(.a(new_n908_), .b(new_n907_), .c(new_n906_), .O(new_n909_));
  and2   g817(.a(new_n909_), .b(x67), .O(new_n910_));
  nand2  g818(.a(new_n876_), .b(new_n143_), .O(new_n911_));
  nand2  g819(.a(new_n862_), .b(new_n144_), .O(new_n912_));
  aoi21  g820(.a(new_n912_), .b(new_n911_), .c(new_n831_), .O(new_n913_));
  oai21  g821(.a(new_n913_), .b(new_n910_), .c(new_n139_), .O(new_n914_));
  nand2  g822(.a(new_n862_), .b(new_n133_), .O(new_n915_));
  oai21  g823(.a(new_n133_), .b(new_n893_), .c(new_n915_), .O(new_n916_));
  nand2  g824(.a(new_n916_), .b(new_n365_), .O(new_n917_));
  aoi21  g825(.a(new_n917_), .b(new_n914_), .c(x66), .O(new_n918_));
  nand2  g826(.a(new_n909_), .b(new_n139_), .O(new_n919_));
  nand3  g827(.a(new_n165_), .b(x68), .c(x44), .O(new_n920_));
  aoi21  g828(.a(new_n920_), .b(new_n919_), .c(new_n370_), .O(new_n921_));
  oai21  g829(.a(new_n921_), .b(new_n918_), .c(new_n173_), .O(new_n922_));
  nand2  g830(.a(new_n922_), .b(new_n904_), .O(z12));
  ...
  nand2  g849(.a(new_n764_), .b(x23), .O(new_n944_));
  ...
  nand2  g864(.a(new_n764_), .b(x55), .O(new_n959_));
  ...
  aoi21  g869(.a(new_n963_), .b(new_n948_), .c(new_n831_), .O(new_n964_));
  ...
  aoi21  g878(.a(new_n962_), .b(new_n776_), .c(new_n972_), .O(new_n973_));
