// Benchmark "FAU" written by ABC on Sun Aug  2 12:00:39 2020
...
module FAU ( 
  ...
  wire new_n93_, new_n94_, new_n95_, new_n96_, new_n97_, new_n98_, new_n99_,
    ...
    new_n714_, new_n715_, new_n716_, new_n720_, new_n721_, new_n722_,
  ...
  nand2  g625(.a(new_n96_), .b(new_n268_), .O(new_n720_));
  nand2  g626(.a(new_n720_), .b(x00), .O(new_n721_));
  nand2  g627(.a(new_n721_), .b(x12), .O(new_n722_));
  nand3  g628(.a(new_n720_), .b(new_n267_), .c(x00), .O(new_n723_));
  aoi21  g629(.a(new_n723_), .b(new_n722_), .c(new_n131_), .O(new_n724_));
  nand2  g630(.a(new_n724_), .b(new_n136_), .O(new_n725_));
  nand2  g631(.a(new_n141_), .b(x60), .O(new_n726_));
  inv1   g632(.a(x56), .O(new_n727_));
  nand2  g633(.a(x74), .b(x55), .O(new_n728_));
  oai21  g634(.a(x74), .b(new_n727_), .c(new_n728_), .O(new_n729_));
  nand2  g635(.a(new_n729_), .b(new_n146_), .O(new_n730_));
  inv1   g636(.a(new_n411_), .O(new_n731_));
  nand2  g637(.a(new_n731_), .b(x52), .O(new_n732_));
  nand2  g638(.a(new_n732_), .b(new_n730_), .O(new_n733_));
  nand2  g639(.a(new_n733_), .b(x72), .O(new_n734_));
  inv1   g640(.a(x58), .O(new_n735_));
  nand2  g641(.a(x74), .b(x57), .O(new_n736_));
  oai21  g642(.a(x74), .b(new_n735_), .c(new_n736_), .O(new_n737_));
  nand2  g643(.a(new_n737_), .b(x73), .O(new_n738_));
  nand2  g644(.a(new_n228_), .b(x59), .O(new_n739_));
  nand2  g645(.a(new_n739_), .b(new_n738_), .O(new_n740_));
  nand2  g646(.a(new_n740_), .b(new_n137_), .O(new_n741_));
  nand3  g647(.a(new_n741_), .b(new_n734_), .c(new_n726_), .O(new_n742_));
  nor2   g648(.a(x71), .b(new_n136_), .O(new_n743_));
  nand2  g649(.a(new_n743_), .b(new_n742_), .O(new_n744_));
  aoi21  g650(.a(new_n744_), .b(new_n725_), .c(new_n155_), .O(new_n745_));
  nand2  g651(.a(new_n141_), .b(x28), .O(new_n746_));
  nand2  g652(.a(x74), .b(x23), .O(new_n747_));
  oai21  g653(.a(x74), .b(new_n641_), .c(new_n747_), .O(new_n748_));
  nand2  g654(.a(new_n748_), .b(new_n146_), .O(new_n749_));
  nand2  g655(.a(new_n731_), .b(x20), .O(new_n750_));
  nand2  g656(.a(new_n750_), .b(new_n749_), .O(new_n751_));
  nand2  g657(.a(new_n751_), .b(x72), .O(new_n752_));
  inv1   g658(.a(x26), .O(new_n753_));
  nand2  g659(.a(x74), .b(x25), .O(new_n754_));
  oai21  g660(.a(x74), .b(new_n753_), .c(new_n754_), .O(new_n755_));
  nand2  g661(.a(new_n755_), .b(x73), .O(new_n756_));
  nand2  g662(.a(new_n228_), .b(x27), .O(new_n757_));
  nand2  g663(.a(new_n757_), .b(new_n756_), .O(new_n758_));
  nand2  g664(.a(new_n758_), .b(new_n137_), .O(new_n759_));
  nand3  g665(.a(new_n759_), .b(new_n752_), .c(new_n746_), .O(new_n760_));
  nand3  g666(.a(new_n163_), .b(x71), .c(x69), .O(new_n761_));
  inv1   g667(.a(new_n761_), .O(new_n762_));
  and2   g668(.a(new_n762_), .b(new_n760_), .O(new_n763_));
  oai21  g669(.a(new_n763_), .b(new_n745_), .c(new_n111_), .O(new_n764_));
  aoi21  g670(.a(new_n750_), .b(new_n749_), .c(new_n137_), .O(new_n765_));
  aoi21  g671(.a(new_n757_), .b(new_n756_), .c(x72), .O(new_n766_));
  oai21  g672(.a(new_n766_), .b(new_n765_), .c(new_n131_), .O(new_n767_));
  inv1   g673(.a(x28), .O(new_n768_));
  nand2  g674(.a(x71), .b(x60), .O(new_n769_));
  oai21  g675(.a(x71), .b(new_n768_), .c(new_n769_), .O(new_n770_));
  nand2  g676(.a(new_n770_), .b(new_n141_), .O(new_n771_));
  aoi21  g677(.a(new_n732_), .b(new_n730_), .c(new_n137_), .O(new_n772_));
  aoi21  g678(.a(new_n739_), .b(new_n738_), .c(x72), .O(new_n773_));
  oai21  g679(.a(new_n773_), .b(new_n772_), .c(x71), .O(new_n774_));
  nand3  g680(.a(new_n774_), .b(new_n771_), .c(new_n767_), .O(new_n775_));
  nand2  g681(.a(new_n775_), .b(new_n165_), .O(new_n776_));
  nand2  g682(.a(new_n116_), .b(new_n280_), .O(new_n777_));
  nand2  g683(.a(new_n777_), .b(x32), .O(new_n778_));
  nand2  g684(.a(new_n778_), .b(x44), .O(new_n779_));
  nand3  g685(.a(new_n777_), .b(new_n279_), .c(x32), .O(new_n780_));
  aoi21  g686(.a(new_n780_), .b(new_n779_), .c(x71), .O(new_n781_));
  nand3  g687(.a(new_n169_), .b(x68), .c(new_n136_), .O(new_n782_));
  inv1   g688(.a(new_n782_), .O(new_n783_));
  nand2  g689(.a(new_n783_), .b(new_n781_), .O(new_n784_));
  nand2  g690(.a(new_n784_), .b(new_n776_), .O(new_n785_));
  nand2  g691(.a(new_n785_), .b(x70), .O(new_n786_));
  aoi21  g692(.a(new_n786_), .b(new_n764_), .c(new_n93_), .O(new_n787_));
  nand2  g693(.a(new_n724_), .b(new_n111_), .O(new_n788_));
  nand2  g694(.a(new_n781_), .b(x70), .O(new_n789_));
  aoi21  g695(.a(new_n789_), .b(new_n788_), .c(new_n171_), .O(new_n790_));
  oai21  g696(.a(new_n790_), .b(new_n787_), .c(new_n203_), .O(new_n791_));
  oai22  g697(.a(new_n176_), .b(new_n768_), .c(new_n131_), .d(new_n279_), .O(new_n792_));
  nand2  g698(.a(new_n792_), .b(x70), .O(new_n793_));
  nand2  g699(.a(new_n179_), .b(x12), .O(new_n794_));
  nand3  g700(.a(new_n181_), .b(x69), .c(x60), .O(new_n795_));
  nand3  g701(.a(new_n795_), .b(new_n794_), .c(new_n793_), .O(new_n796_));
  and2   g702(.a(new_n796_), .b(x67), .O(new_n797_));
  nand2  g703(.a(new_n760_), .b(new_n158_), .O(new_n798_));
  nand2  g704(.a(new_n742_), .b(new_n159_), .O(new_n799_));
  nand2  g705(.a(x69), .b(new_n168_), .O(new_n800_));
  aoi21  g706(.a(new_n799_), .b(new_n798_), .c(new_n800_), .O(new_n801_));
  oai21  g707(.a(new_n801_), .b(new_n797_), .c(new_n153_), .O(new_n802_));
  nand2  g708(.a(new_n742_), .b(new_n168_), .O(new_n803_));
  oai21  g709(.a(new_n168_), .b(new_n279_), .c(new_n803_), .O(new_n804_));
  nand2  g710(.a(new_n804_), .b(new_n327_), .O(new_n805_));
  aoi21  g711(.a(new_n805_), .b(new_n802_), .c(x66), .O(new_n806_));
  nand2  g712(.a(new_n796_), .b(new_n153_), .O(new_n807_));
  nand3  g713(.a(new_n186_), .b(x68), .c(x44), .O(new_n808_));
  aoi21  g714(.a(new_n808_), .b(new_n807_), .c(new_n191_), .O(new_n809_));
  oai21  g715(.a(new_n809_), .b(new_n806_), .c(new_n204_), .O(new_n810_));
  nand2  g716(.a(new_n810_), .b(new_n791_), .O(z12));
  inv1   g717(.a(new_n96_), .O(new_n812_));
  nand3  g718(.a(new_n812_), .b(new_n268_), .c(x00), .O(new_n813_));
  oai21  g719(.a(new_n96_), .b(new_n107_), .c(x13), .O(new_n814_));
  aoi21  g720(.a(new_n814_), .b(new_n813_), .c(new_n131_), .O(new_n815_));
  nand2  g721(.a(new_n815_), .b(new_n136_), .O(new_n816_));
  inv1   g722(.a(new_n816_), .O(new_n817_));
  nand2  g723(.a(new_n141_), .b(x61), .O(new_n818_));
  inv1   g724(.a(x57), .O(new_n819_));
  nand2  g725(.a(x74), .b(x56), .O(new_n820_));
  oai21  g726(.a(x74), .b(new_n819_), .c(new_n820_), .O(new_n821_));
  nand2  g727(.a(new_n821_), .b(new_n146_), .O(new_n822_));
  nand2  g728(.a(new_n731_), .b(x53), .O(new_n823_));
  nand2  g729(.a(new_n823_), .b(new_n822_), .O(new_n824_));
  nand2  g730(.a(new_n824_), .b(x72), .O(new_n825_));
  inv1   g731(.a(x59), .O(new_n826_));
  nand2  g732(.a(x74), .b(x58), .O(new_n827_));
  oai21  g733(.a(x74), .b(new_n826_), .c(new_n827_), .O(new_n828_));
  nand2  g734(.a(new_n828_), .b(x73), .O(new_n829_));
  nand2  g735(.a(new_n228_), .b(x60), .O(new_n830_));
  nand2  g736(.a(new_n830_), .b(new_n829_), .O(new_n831_));
  nand2  g737(.a(new_n831_), .b(new_n137_), .O(new_n832_));
  nand3  g738(.a(new_n832_), .b(new_n825_), .c(new_n818_), .O(new_n833_));
  aoi21  g739(.a(new_n833_), .b(new_n743_), .c(new_n817_), .O(new_n834_));
  nand2  g740(.a(new_n141_), .b(x29), .O(new_n835_));
  nand2  g741(.a(x74), .b(x24), .O(new_n836_));
  oai21  g742(.a(x74), .b(new_n701_), .c(new_n836_), .O(new_n837_));
  nand2  g743(.a(new_n837_), .b(new_n146_), .O(new_n838_));
  nand2  g744(.a(new_n731_), .b(x21), .O(new_n839_));
  nand2  g745(.a(new_n839_), .b(new_n838_), .O(new_n840_));
  nand2  g746(.a(new_n840_), .b(x72), .O(new_n841_));
  inv1   g747(.a(x27), .O(new_n842_));
  nand2  g748(.a(x74), .b(x26), .O(new_n843_));
  oai21  g749(.a(x74), .b(new_n842_), .c(new_n843_), .O(new_n844_));
  nand2  g750(.a(new_n844_), .b(x73), .O(new_n845_));
  nand2  g751(.a(new_n228_), .b(x28), .O(new_n846_));
  nand2  g752(.a(new_n846_), .b(new_n845_), .O(new_n847_));
  nand2  g753(.a(new_n847_), .b(new_n137_), .O(new_n848_));
  nand3  g754(.a(new_n848_), .b(new_n841_), .c(new_n835_), .O(new_n849_));
  nand2  g755(.a(new_n849_), .b(new_n762_), .O(new_n850_));
  oai21  g756(.a(new_n834_), .b(new_n155_), .c(new_n850_), .O(new_n851_));
  nand2  g757(.a(new_n851_), .b(new_n111_), .O(new_n852_));
  aoi21  g758(.a(new_n839_), .b(new_n838_), .c(new_n137_), .O(new_n853_));
  aoi21  g759(.a(new_n846_), .b(new_n845_), .c(x72), .O(new_n854_));
  oai21  g760(.a(new_n854_), .b(new_n853_), .c(new_n131_), .O(new_n855_));
  inv1   g761(.a(x29), .O(new_n856_));
  nand2  g762(.a(x71), .b(x61), .O(new_n857_));
  oai21  g763(.a(x71), .b(new_n856_), .c(new_n857_), .O(new_n858_));
  nand2  g764(.a(new_n858_), .b(new_n141_), .O(new_n859_));
  aoi21  g765(.a(new_n823_), .b(new_n822_), .c(new_n137_), .O(new_n860_));
  aoi21  g766(.a(new_n830_), .b(new_n829_), .c(x72), .O(new_n861_));
  oai21  g767(.a(new_n861_), .b(new_n860_), .c(x71), .O(new_n862_));
  nand3  g768(.a(new_n862_), .b(new_n859_), .c(new_n855_), .O(new_n863_));
  nand2  g769(.a(new_n863_), .b(new_n165_), .O(new_n864_));
  nor2   g770(.a(x45), .b(new_n127_), .O(new_n865_));
  oai21  g771(.a(x47), .b(x46), .c(new_n865_), .O(new_n866_));
  oai21  g772(.a(new_n116_), .b(new_n127_), .c(x45), .O(new_n867_));
  aoi21  g773(.a(new_n867_), .b(new_n866_), .c(x71), .O(new_n868_));
  nand2  g774(.a(new_n868_), .b(new_n783_), .O(new_n869_));
  nand2  g775(.a(new_n869_), .b(new_n864_), .O(new_n870_));
  nand2  g776(.a(new_n870_), .b(x70), .O(new_n871_));
  aoi21  g777(.a(new_n871_), .b(new_n852_), .c(new_n93_), .O(new_n872_));
  nand2  g778(.a(new_n815_), .b(new_n111_), .O(new_n873_));
  nand2  g779(.a(new_n868_), .b(x70), .O(new_n874_));
  aoi21  g780(.a(new_n874_), .b(new_n873_), .c(new_n171_), .O(new_n875_));
  oai21  g781(.a(new_n875_), .b(new_n872_), .c(new_n203_), .O(new_n876_));
  oai22  g782(.a(new_n176_), .b(new_n856_), .c(new_n131_), .d(new_n280_), .O(new_n877_));
  nand2  g783(.a(new_n877_), .b(x70), .O(new_n878_));
  nand2  g784(.a(new_n179_), .b(x13), .O(new_n879_));
  nand3  g785(.a(new_n181_), .b(x69), .c(x61), .O(new_n880_));
  nand3  g786(.a(new_n880_), .b(new_n879_), .c(new_n878_), .O(new_n881_));
  and2   g787(.a(new_n881_), .b(x67), .O(new_n882_));
  nand2  g788(.a(new_n849_), .b(new_n158_), .O(new_n883_));
  nand2  g789(.a(new_n833_), .b(new_n159_), .O(new_n884_));
  aoi21  g790(.a(new_n884_), .b(new_n883_), .c(new_n800_), .O(new_n885_));
  oai21  g791(.a(new_n885_), .b(new_n882_), .c(new_n153_), .O(new_n886_));
  nand2  g792(.a(new_n833_), .b(new_n168_), .O(new_n887_));
  oai21  g793(.a(new_n168_), .b(new_n280_), .c(new_n887_), .O(new_n888_));
  nand2  g794(.a(new_n888_), .b(new_n327_), .O(new_n889_));
  aoi21  g795(.a(new_n889_), .b(new_n886_), .c(x66), .O(new_n890_));
  nand2  g796(.a(new_n881_), .b(new_n153_), .O(new_n891_));
  nand3  g797(.a(new_n186_), .b(x68), .c(x45), .O(new_n892_));
  aoi21  g798(.a(new_n892_), .b(new_n891_), .c(new_n191_), .O(new_n893_));
  oai21  g799(.a(new_n893_), .b(new_n890_), .c(new_n204_), .O(new_n894_));
  nand2  g800(.a(new_n894_), .b(new_n876_), .O(z13));
  nand2  g801(.a(x15), .b(x00), .O(new_n896_));
  xor2a  g802(.a(new_n896_), .b(x14), .O(new_n897_));
  nor2   g803(.a(new_n897_), .b(new_n131_), .O(new_n898_));
  nand2  g804(.a(new_n898_), .b(new_n136_), .O(new_n899_));
  inv1   g805(.a(new_n899_), .O(new_n900_));
  nand2  g806(.a(new_n141_), .b(x62), .O(new_n901_));
  nand2  g807(.a(new_n737_), .b(new_n146_), .O(new_n902_));
  nand2  g808(.a(new_n731_), .b(x54), .O(new_n903_));
  nand2  g809(.a(new_n903_), .b(new_n902_), .O(new_n904_));
  nand2  g810(.a(new_n904_), .b(x72), .O(new_n905_));
  inv1   g811(.a(x60), .O(new_n906_));
  nand2  g812(.a(x74), .b(x59), .O(new_n907_));
  oai21  g813(.a(x74), .b(new_n906_), .c(new_n907_), .O(new_n908_));
  nand2  g814(.a(new_n908_), .b(x73), .O(new_n909_));
  nand2  g815(.a(new_n228_), .b(x61), .O(new_n910_));
  nand2  g816(.a(new_n910_), .b(new_n909_), .O(new_n911_));
  nand2  g817(.a(new_n911_), .b(new_n137_), .O(new_n912_));
  nand3  g818(.a(new_n912_), .b(new_n905_), .c(new_n901_), .O(new_n913_));
  aoi21  g819(.a(new_n913_), .b(new_n743_), .c(new_n900_), .O(new_n914_));
  nand2  g820(.a(new_n141_), .b(x30), .O(new_n915_));
  nand2  g821(.a(new_n755_), .b(new_n146_), .O(new_n916_));
  nand2  g822(.a(new_n731_), .b(x22), .O(new_n917_));
  nand2  g823(.a(new_n917_), .b(new_n916_), .O(new_n918_));
  nand2  g824(.a(new_n918_), .b(x72), .O(new_n919_));
  nand2  g825(.a(x74), .b(x27), .O(new_n920_));
  oai21  g826(.a(x74), .b(new_n768_), .c(new_n920_), .O(new_n921_));
  nand2  g827(.a(new_n921_), .b(x73), .O(new_n922_));
  nand2  g828(.a(new_n228_), .b(x29), .O(new_n923_));
  nand2  g829(.a(new_n923_), .b(new_n922_), .O(new_n924_));
  nand2  g830(.a(new_n924_), .b(new_n137_), .O(new_n925_));
  nand3  g831(.a(new_n925_), .b(new_n919_), .c(new_n915_), .O(new_n926_));
  nand2  g832(.a(new_n926_), .b(new_n762_), .O(new_n927_));
  oai21  g833(.a(new_n914_), .b(new_n155_), .c(new_n927_), .O(new_n928_));
  nand2  g834(.a(new_n928_), .b(new_n111_), .O(new_n929_));
  aoi21  g835(.a(new_n917_), .b(new_n916_), .c(new_n137_), .O(new_n930_));
  aoi21  g836(.a(new_n923_), .b(new_n922_), .c(x72), .O(new_n931_));
  oai21  g837(.a(new_n931_), .b(new_n930_), .c(new_n131_), .O(new_n932_));
  inv1   g838(.a(x30), .O(new_n933_));
  nand2  g839(.a(x71), .b(x62), .O(new_n934_));
  oai21  g840(.a(x71), .b(new_n933_), .c(new_n934_), .O(new_n935_));
  nand2  g841(.a(new_n935_), .b(new_n141_), .O(new_n936_));
  aoi21  g842(.a(new_n903_), .b(new_n902_), .c(new_n137_), .O(new_n937_));
  aoi21  g843(.a(new_n910_), .b(new_n909_), .c(x72), .O(new_n938_));
  oai21  g844(.a(new_n938_), .b(new_n937_), .c(x71), .O(new_n939_));
  nand3  g845(.a(new_n939_), .b(new_n936_), .c(new_n932_), .O(new_n940_));
  nand2  g846(.a(new_n940_), .b(new_n165_), .O(new_n941_));
  nand2  g847(.a(x47), .b(x32), .O(new_n942_));
  xor2a  g848(.a(new_n942_), .b(x46), .O(new_n943_));
  nor2   g849(.a(new_n943_), .b(x71), .O(new_n944_));
  nand2  g850(.a(new_n944_), .b(new_n783_), .O(new_n945_));
  nand2  g851(.a(new_n945_), .b(new_n941_), .O(new_n946_));
  nand2  g852(.a(new_n946_), .b(x70), .O(new_n947_));
  aoi21  g853(.a(new_n947_), .b(new_n929_), .c(new_n93_), .O(new_n948_));
  nand2  g854(.a(new_n898_), .b(new_n111_), .O(new_n949_));
  nand2  g855(.a(new_n944_), .b(x70), .O(new_n950_));
  aoi21  g856(.a(new_n950_), .b(new_n949_), .c(new_n171_), .O(new_n951_));
  oai21  g857(.a(new_n951_), .b(new_n948_), .c(new_n203_), .O(new_n952_));
  nand2  g858(.a(x71), .b(x46), .O(new_n953_));
  oai21  g859(.a(new_n176_), .b(new_n933_), .c(new_n953_), .O(new_n954_));
  nand2  g860(.a(new_n954_), .b(x70), .O(new_n955_));
  nand2  g861(.a(new_n179_), .b(x14), .O(new_n956_));
  nand3  g862(.a(new_n181_), .b(x69), .c(x62), .O(new_n957_));
  nand3  g863(.a(new_n957_), .b(new_n956_), .c(new_n955_), .O(new_n958_));
  and2   g864(.a(new_n958_), .b(x67), .O(new_n959_));
  nand2  g865(.a(new_n926_), .b(new_n158_), .O(new_n960_));
  nand2  g866(.a(new_n913_), .b(new_n159_), .O(new_n961_));
  aoi21  g867(.a(new_n961_), .b(new_n960_), .c(new_n800_), .O(new_n962_));
  oai21  g868(.a(new_n962_), .b(new_n959_), .c(new_n153_), .O(new_n963_));
  nand2  g869(.a(new_n913_), .b(new_n168_), .O(new_n964_));
  nand2  g870(.a(x67), .b(x46), .O(new_n965_));
  nand2  g871(.a(new_n965_), .b(new_n964_), .O(new_n966_));
  nand2  g872(.a(new_n966_), .b(new_n327_), .O(new_n967_));
  aoi21  g873(.a(new_n967_), .b(new_n963_), .c(x66), .O(new_n968_));
  nand2  g874(.a(new_n958_), .b(new_n153_), .O(new_n969_));
  nand3  g875(.a(new_n186_), .b(x68), .c(x46), .O(new_n970_));
  aoi21  g876(.a(new_n970_), .b(new_n969_), .c(new_n191_), .O(new_n971_));
  oai21  g877(.a(new_n971_), .b(new_n968_), .c(new_n204_), .O(new_n972_));
  nand2  g878(.a(new_n972_), .b(new_n952_), .O(z14));
  zero   g879(.O(z00));
  zero   g880(.O(z10));
  zero   g881(.O(z11));
  zero   g882(.O(z15));
