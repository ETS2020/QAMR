// Benchmark "FAU" written by ABC on Sun Aug  2 12:19:48 2020
...
module FAU ( 
  ...
  nand3  g699(.a(new_n146_), .b(x71), .c(x69), .O(new_n792_));
  nor2   g700(.a(new_n792_), .b(new_n791_), .O(new_n793_));
  ...
  inv1   g786(.a(new_n878_), .O(new_n879_));
  nor2   g787(.a(new_n879_), .b(new_n792_), .O(new_n880_));
  oai21  g788(.a(new_n880_), .b(new_n863_), .c(new_n100_), .O(new_n881_));
  aoi21  g789(.a(new_n868_), .b(new_n867_), .c(new_n203_), .O(new_n882_));
  aoi21  g790(.a(new_n875_), .b(new_n874_), .c(x72), .O(new_n883_));
  ...
  aoi21  g796(.a(new_n851_), .b(new_n850_), .c(new_n203_), .O(new_n889_));
  aoi21  g797(.a(new_n858_), .b(new_n857_), .c(x72), .O(new_n890_));
  ...
  oai21  g801(.a(new_n319_), .b(new_n112_), .c(x44), .O(new_n894_));
  inv1   g802(.a(x44), .O(new_n895_));
  inv1   g803(.a(new_n319_), .O(new_n896_));
  nand3  g804(.a(new_n896_), .b(new_n895_), .c(x32), .O(new_n897_));
  aoi21  g805(.a(new_n897_), .b(new_n894_), .c(x71), .O(new_n898_));
  nand2  g806(.a(new_n898_), .b(new_n811_), .O(new_n899_));
  nand2  g807(.a(new_n899_), .b(new_n893_), .O(new_n900_));
  nand2  g808(.a(new_n900_), .b(x70), .O(new_n901_));
  aoi21  g809(.a(new_n901_), .b(new_n881_), .c(new_n93_), .O(new_n902_));
  nand2  g810(.a(new_n844_), .b(new_n100_), .O(new_n903_));
  nand2  g811(.a(new_n898_), .b(x70), .O(new_n904_));
  aoi21  g812(.a(new_n904_), .b(new_n903_), .c(new_n226_), .O(new_n905_));
  oai21  g813(.a(new_n905_), .b(new_n902_), .c(new_n92_), .O(new_n906_));
  oai22  g814(.a(new_n156_), .b(new_n885_), .c(new_n116_), .d(new_n895_), .O(new_n907_));
  nand2  g815(.a(new_n907_), .b(x70), .O(new_n908_));
  nand2  g816(.a(new_n159_), .b(x12), .O(new_n909_));
  nand3  g817(.a(new_n128_), .b(x69), .c(x60), .O(new_n910_));
  nand3  g818(.a(new_n910_), .b(new_n909_), .c(new_n908_), .O(new_n911_));
  and2   g819(.a(new_n911_), .b(x67), .O(new_n912_));
  nand2  g820(.a(new_n878_), .b(new_n143_), .O(new_n913_));
  nand2  g821(.a(new_n861_), .b(new_n144_), .O(new_n914_));
  aoi21  g822(.a(new_n914_), .b(new_n913_), .c(new_n828_), .O(new_n915_));
  oai21  g823(.a(new_n915_), .b(new_n912_), .c(new_n139_), .O(new_n916_));
  nand2  g824(.a(new_n861_), .b(new_n133_), .O(new_n917_));
  oai21  g825(.a(new_n133_), .b(new_n895_), .c(new_n917_), .O(new_n918_));
  nand2  g826(.a(new_n918_), .b(new_n365_), .O(new_n919_));
  aoi21  g827(.a(new_n919_), .b(new_n916_), .c(x66), .O(new_n920_));
  nand2  g828(.a(new_n911_), .b(new_n139_), .O(new_n921_));
  nand3  g829(.a(new_n165_), .b(x68), .c(x44), .O(new_n922_));
  aoi21  g830(.a(new_n922_), .b(new_n921_), .c(new_n370_), .O(new_n923_));
  oai21  g831(.a(new_n923_), .b(new_n920_), .c(new_n173_), .O(new_n924_));
  nand2  g832(.a(new_n924_), .b(new_n906_), .O(z12));
  inv1   g833(.a(x31), .O(new_n928_));
  inv1   g834(.a(x47), .O(new_n929_));
  oai22  g835(.a(new_n156_), .b(new_n928_), .c(new_n116_), .d(new_n929_), .O(new_n930_));
  nand2  g836(.a(new_n930_), .b(x70), .O(new_n931_));
  nand2  g837(.a(new_n159_), .b(x15), .O(new_n932_));
  nand3  g838(.a(new_n128_), .b(x69), .c(x63), .O(new_n933_));
  nand3  g839(.a(new_n933_), .b(new_n932_), .c(new_n931_), .O(new_n934_));
  and2   g840(.a(new_n934_), .b(x67), .O(new_n935_));
  nand2  g841(.a(x74), .b(x28), .O(new_n936_));
  nand2  g842(.a(new_n209_), .b(x29), .O(new_n937_));
  aoi21  g843(.a(new_n937_), .b(new_n936_), .c(new_n212_), .O(new_n938_));
  nand2  g844(.a(new_n268_), .b(x30), .O(new_n939_));
  inv1   g845(.a(new_n939_), .O(new_n940_));
  oai21  g846(.a(new_n940_), .b(new_n938_), .c(new_n203_), .O(new_n941_));
  nand2  g847(.a(new_n207_), .b(x31), .O(new_n942_));
  nand2  g848(.a(x74), .b(x26), .O(new_n943_));
  nand2  g849(.a(new_n209_), .b(x27), .O(new_n944_));
  aoi21  g850(.a(new_n944_), .b(new_n943_), .c(x73), .O(new_n945_));
  nand2  g851(.a(new_n763_), .b(x23), .O(new_n946_));
  inv1   g852(.a(new_n946_), .O(new_n947_));
  oai21  g853(.a(new_n947_), .b(new_n945_), .c(x72), .O(new_n948_));
  nand3  g854(.a(new_n948_), .b(new_n942_), .c(new_n941_), .O(new_n949_));
  nand2  g855(.a(new_n949_), .b(new_n143_), .O(new_n950_));
  nand2  g856(.a(x74), .b(x60), .O(new_n951_));
  nand2  g857(.a(new_n209_), .b(x61), .O(new_n952_));
  aoi21  g858(.a(new_n952_), .b(new_n951_), .c(new_n212_), .O(new_n953_));
  nand2  g859(.a(new_n268_), .b(x62), .O(new_n954_));
  inv1   g860(.a(new_n954_), .O(new_n955_));
  oai21  g861(.a(new_n955_), .b(new_n953_), .c(new_n203_), .O(new_n956_));
  nand2  g862(.a(new_n207_), .b(x63), .O(new_n957_));
  nand2  g863(.a(x74), .b(x58), .O(new_n958_));
  nand2  g864(.a(new_n209_), .b(x59), .O(new_n959_));
  aoi21  g865(.a(new_n959_), .b(new_n958_), .c(x73), .O(new_n960_));
  nand2  g866(.a(new_n763_), .b(x55), .O(new_n961_));
  ...
  aoi21  g871(.a(new_n965_), .b(new_n950_), .c(new_n828_), .O(new_n966_));
  oai21  g872(.a(new_n966_), .b(new_n935_), .c(new_n151_), .O(new_n967_));
  nand2  g873(.a(new_n934_), .b(new_n152_), .O(new_n968_));
  aoi21  g874(.a(new_n968_), .b(new_n967_), .c(new_n636_), .O(new_n969_));
  nand4  g875(.a(new_n94_), .b(x69), .c(x65), .d(new_n92_), .O(new_n970_));
  aoi21  g876(.a(new_n965_), .b(new_n950_), .c(new_n970_), .O(new_n971_));
  ...
  aoi21  g880(.a(new_n964_), .b(new_n775_), .c(new_n974_), .O(new_n975_));
  ...
  oai21  g888(.a(new_n153_), .b(new_n929_), .c(new_n982_), .O(new_n983_));
