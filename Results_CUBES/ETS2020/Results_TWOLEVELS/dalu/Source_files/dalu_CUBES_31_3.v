// Benchmark "FAU" written by ABC on Sun Aug  2 10:53:20 2020
...
module FAU ( 
  ...
  wire new_n92_, new_n93_, new_n94_, new_n95_, new_n96_, new_n97_, new_n98_,
    ...
    new_n689_, new_n690_, new_n691_, new_n695_, new_n696_, new_n697_,
  ...
  oai21  g601(.a(new_n479_), .b(new_n96_), .c(x11), .O(new_n695_));
  nand3  g602(.a(new_n406_), .b(new_n176_), .c(x00), .O(new_n696_));
  aoi21  g603(.a(new_n696_), .b(new_n695_), .c(new_n116_), .O(new_n697_));
  nand2  g604(.a(new_n697_), .b(new_n134_), .O(new_n698_));
  nand2  g605(.a(new_n207_), .b(x59), .O(new_n699_));
  inv1   g606(.a(x55), .O(new_n700_));
  nand2  g607(.a(x74), .b(x54), .O(new_n701_));
  oai21  g608(.a(x74), .b(new_n700_), .c(new_n701_), .O(new_n702_));
  nand2  g609(.a(new_n702_), .b(new_n212_), .O(new_n703_));
  nor2   g610(.a(x74), .b(new_n212_), .O(new_n704_));
  nand2  g611(.a(new_n704_), .b(x51), .O(new_n705_));
  nand2  g612(.a(new_n705_), .b(new_n703_), .O(new_n706_));
  nand2  g613(.a(new_n706_), .b(x72), .O(new_n707_));
  inv1   g614(.a(x57), .O(new_n708_));
  nand2  g615(.a(x74), .b(x56), .O(new_n709_));
  oai21  g616(.a(x74), .b(new_n708_), .c(new_n709_), .O(new_n710_));
  nand2  g617(.a(new_n710_), .b(x73), .O(new_n711_));
  nand2  g618(.a(new_n268_), .b(x58), .O(new_n712_));
  nand2  g619(.a(new_n712_), .b(new_n711_), .O(new_n713_));
  nand2  g620(.a(new_n713_), .b(new_n203_), .O(new_n714_));
  nand3  g621(.a(new_n714_), .b(new_n707_), .c(new_n699_), .O(new_n715_));
  nor2   g622(.a(x71), .b(new_n134_), .O(new_n716_));
  nand2  g623(.a(new_n716_), .b(new_n715_), .O(new_n717_));
  aoi21  g624(.a(new_n717_), .b(new_n698_), .c(new_n141_), .O(new_n718_));
  nand2  g625(.a(new_n207_), .b(x27), .O(new_n719_));
  nand2  g626(.a(x74), .b(x22), .O(new_n720_));
  oai21  g627(.a(x74), .b(new_n615_), .c(new_n720_), .O(new_n721_));
  nand2  g628(.a(new_n721_), .b(new_n212_), .O(new_n722_));
  nand2  g629(.a(new_n704_), .b(x19), .O(new_n723_));
  nand2  g630(.a(new_n723_), .b(new_n722_), .O(new_n724_));
  nand2  g631(.a(new_n724_), .b(x72), .O(new_n725_));
  inv1   g632(.a(x25), .O(new_n726_));
  nand2  g633(.a(x74), .b(x24), .O(new_n727_));
  oai21  g634(.a(x74), .b(new_n726_), .c(new_n727_), .O(new_n728_));
  nand2  g635(.a(new_n728_), .b(x73), .O(new_n729_));
  nand2  g636(.a(new_n268_), .b(x26), .O(new_n730_));
  nand2  g637(.a(new_n730_), .b(new_n729_), .O(new_n731_));
  nand2  g638(.a(new_n731_), .b(new_n203_), .O(new_n732_));
  nand3  g639(.a(new_n732_), .b(new_n725_), .c(new_n719_), .O(new_n733_));
  nand3  g640(.a(new_n146_), .b(x71), .c(x69), .O(new_n734_));
  inv1   g641(.a(new_n734_), .O(new_n735_));
  and2   g642(.a(new_n735_), .b(new_n733_), .O(new_n736_));
  oai21  g643(.a(new_n736_), .b(new_n718_), .c(new_n100_), .O(new_n737_));
  aoi21  g644(.a(new_n723_), .b(new_n722_), .c(new_n203_), .O(new_n738_));
  aoi21  g645(.a(new_n730_), .b(new_n729_), .c(x72), .O(new_n739_));
  oai21  g646(.a(new_n739_), .b(new_n738_), .c(new_n116_), .O(new_n740_));
  inv1   g647(.a(x27), .O(new_n741_));
  nand2  g648(.a(x71), .b(x59), .O(new_n742_));
  oai21  g649(.a(x71), .b(new_n741_), .c(new_n742_), .O(new_n743_));
  nand2  g650(.a(new_n743_), .b(new_n207_), .O(new_n744_));
  aoi21  g651(.a(new_n705_), .b(new_n703_), .c(new_n203_), .O(new_n745_));
  aoi21  g652(.a(new_n712_), .b(new_n711_), .c(x72), .O(new_n746_));
  oai21  g653(.a(new_n746_), .b(new_n745_), .c(x71), .O(new_n747_));
  nand3  g654(.a(new_n747_), .b(new_n744_), .c(new_n740_), .O(new_n748_));
  nand2  g655(.a(new_n748_), .b(new_n219_), .O(new_n749_));
  oai21  g656(.a(new_n487_), .b(new_n112_), .c(x43), .O(new_n750_));
  nand3  g657(.a(new_n413_), .b(new_n189_), .c(x32), .O(new_n751_));
  aoi21  g658(.a(new_n751_), .b(new_n750_), .c(x71), .O(new_n752_));
  nand3  g659(.a(new_n155_), .b(x68), .c(new_n134_), .O(new_n753_));
  inv1   g660(.a(new_n753_), .O(new_n754_));
  nand2  g661(.a(new_n754_), .b(new_n752_), .O(new_n755_));
  nand2  g662(.a(new_n755_), .b(new_n749_), .O(new_n756_));
  nand2  g663(.a(new_n756_), .b(x70), .O(new_n757_));
  aoi21  g664(.a(new_n757_), .b(new_n737_), .c(new_n93_), .O(new_n758_));
  nand2  g665(.a(new_n697_), .b(new_n100_), .O(new_n759_));
  nand2  g666(.a(new_n752_), .b(x70), .O(new_n760_));
  aoi21  g667(.a(new_n760_), .b(new_n759_), .c(new_n226_), .O(new_n761_));
  oai21  g668(.a(new_n761_), .b(new_n758_), .c(new_n92_), .O(new_n762_));
  oai22  g669(.a(new_n156_), .b(new_n741_), .c(new_n116_), .d(new_n189_), .O(new_n763_));
  nand2  g670(.a(new_n763_), .b(x70), .O(new_n764_));
  nand2  g671(.a(new_n159_), .b(x11), .O(new_n765_));
  nand3  g672(.a(new_n128_), .b(x69), .c(x59), .O(new_n766_));
  nand3  g673(.a(new_n766_), .b(new_n765_), .c(new_n764_), .O(new_n767_));
  and2   g674(.a(new_n767_), .b(x67), .O(new_n768_));
  nand2  g675(.a(new_n733_), .b(new_n143_), .O(new_n769_));
  nand2  g676(.a(new_n715_), .b(new_n144_), .O(new_n770_));
  nand2  g677(.a(x69), .b(new_n133_), .O(new_n771_));
  aoi21  g678(.a(new_n770_), .b(new_n769_), .c(new_n771_), .O(new_n772_));
  oai21  g679(.a(new_n772_), .b(new_n768_), .c(new_n139_), .O(new_n773_));
  nand2  g680(.a(new_n715_), .b(new_n133_), .O(new_n774_));
  oai21  g681(.a(new_n133_), .b(new_n189_), .c(new_n774_), .O(new_n775_));
  nand2  g682(.a(new_n775_), .b(new_n364_), .O(new_n776_));
  aoi21  g683(.a(new_n776_), .b(new_n773_), .c(x66), .O(new_n777_));
  nand2  g684(.a(new_n767_), .b(new_n139_), .O(new_n778_));
  nand3  g685(.a(new_n165_), .b(x68), .c(x43), .O(new_n779_));
  aoi21  g686(.a(new_n779_), .b(new_n778_), .c(new_n369_), .O(new_n780_));
  oai21  g687(.a(new_n780_), .b(new_n777_), .c(new_n173_), .O(new_n781_));
  nand2  g688(.a(new_n781_), .b(new_n762_), .O(z11));
  nand2  g689(.a(new_n177_), .b(new_n310_), .O(new_n783_));
  nand2  g690(.a(new_n783_), .b(x00), .O(new_n784_));
  nand2  g691(.a(new_n784_), .b(x12), .O(new_n785_));
  nor2   g692(.a(x12), .b(new_n96_), .O(new_n786_));
  nand2  g693(.a(new_n786_), .b(new_n783_), .O(new_n787_));
  aoi21  g694(.a(new_n787_), .b(new_n785_), .c(new_n116_), .O(new_n788_));
  nand2  g695(.a(new_n788_), .b(new_n134_), .O(new_n789_));
  nand2  g696(.a(new_n207_), .b(x60), .O(new_n790_));
  inv1   g697(.a(x56), .O(new_n791_));
  nand2  g698(.a(x74), .b(x55), .O(new_n792_));
  oai21  g699(.a(x74), .b(new_n791_), .c(new_n792_), .O(new_n793_));
  nand2  g700(.a(new_n793_), .b(new_n212_), .O(new_n794_));
  nand2  g701(.a(new_n704_), .b(x52), .O(new_n795_));
  nand2  g702(.a(new_n795_), .b(new_n794_), .O(new_n796_));
  nand2  g703(.a(new_n796_), .b(x72), .O(new_n797_));
  inv1   g704(.a(x58), .O(new_n798_));
  nand2  g705(.a(x74), .b(x57), .O(new_n799_));
  oai21  g706(.a(x74), .b(new_n798_), .c(new_n799_), .O(new_n800_));
  nand2  g707(.a(new_n800_), .b(x73), .O(new_n801_));
  nand2  g708(.a(new_n268_), .b(x59), .O(new_n802_));
  nand2  g709(.a(new_n802_), .b(new_n801_), .O(new_n803_));
  nand2  g710(.a(new_n803_), .b(new_n203_), .O(new_n804_));
  nand3  g711(.a(new_n804_), .b(new_n797_), .c(new_n790_), .O(new_n805_));
  nand2  g712(.a(new_n805_), .b(new_n716_), .O(new_n806_));
  aoi21  g713(.a(new_n806_), .b(new_n789_), .c(new_n141_), .O(new_n807_));
  nand2  g714(.a(new_n207_), .b(x28), .O(new_n808_));
  nand2  g715(.a(x74), .b(x23), .O(new_n809_));
  oai21  g716(.a(x74), .b(new_n676_), .c(new_n809_), .O(new_n810_));
  nand2  g717(.a(new_n810_), .b(new_n212_), .O(new_n811_));
  nand2  g718(.a(new_n704_), .b(x20), .O(new_n812_));
  nand2  g719(.a(new_n812_), .b(new_n811_), .O(new_n813_));
  nand2  g720(.a(new_n813_), .b(x72), .O(new_n814_));
  inv1   g721(.a(x26), .O(new_n815_));
  ...
  nand2  g725(.a(new_n268_), .b(x27), .O(new_n819_));
  nand2  g726(.a(new_n819_), .b(new_n818_), .O(new_n820_));
  nand2  g727(.a(new_n820_), .b(new_n203_), .O(new_n821_));
  nand3  g728(.a(new_n821_), .b(new_n814_), .c(new_n808_), .O(new_n822_));
  and2   g729(.a(new_n822_), .b(new_n735_), .O(new_n823_));
  oai21  g730(.a(new_n823_), .b(new_n807_), .c(new_n100_), .O(new_n824_));
  aoi21  g731(.a(new_n812_), .b(new_n811_), .c(new_n203_), .O(new_n825_));
  ...
  nand2  g737(.a(new_n830_), .b(new_n207_), .O(new_n831_));
  aoi21  g738(.a(new_n795_), .b(new_n794_), .c(new_n203_), .O(new_n832_));
  aoi21  g739(.a(new_n802_), .b(new_n801_), .c(x72), .O(new_n833_));
  oai21  g740(.a(new_n833_), .b(new_n832_), .c(x71), .O(new_n834_));
  nand3  g741(.a(new_n834_), .b(new_n831_), .c(new_n827_), .O(new_n835_));
  nand2  g742(.a(new_n835_), .b(new_n219_), .O(new_n836_));
  nand2  g743(.a(new_n190_), .b(new_n321_), .O(new_n837_));
  nand2  g744(.a(new_n837_), .b(x32), .O(new_n838_));
  nand2  g745(.a(new_n838_), .b(x44), .O(new_n839_));
  inv1   g746(.a(x44), .O(new_n840_));
  nand3  g747(.a(new_n837_), .b(new_n840_), .c(x32), .O(new_n841_));
  aoi21  g748(.a(new_n841_), .b(new_n839_), .c(x71), .O(new_n842_));
  nand2  g749(.a(new_n842_), .b(new_n754_), .O(new_n843_));
  nand2  g750(.a(new_n843_), .b(new_n836_), .O(new_n844_));
  nand2  g751(.a(new_n844_), .b(x70), .O(new_n845_));
  aoi21  g752(.a(new_n845_), .b(new_n824_), .c(new_n93_), .O(new_n846_));
  nand2  g753(.a(new_n788_), .b(new_n100_), .O(new_n847_));
  nand2  g754(.a(new_n842_), .b(x70), .O(new_n848_));
  aoi21  g755(.a(new_n848_), .b(new_n847_), .c(new_n226_), .O(new_n849_));
  oai21  g756(.a(new_n849_), .b(new_n846_), .c(new_n92_), .O(new_n850_));
  oai22  g757(.a(new_n156_), .b(new_n828_), .c(new_n116_), .d(new_n840_), .O(new_n851_));
  nand2  g758(.a(new_n851_), .b(x70), .O(new_n852_));
  nand2  g759(.a(new_n159_), .b(x12), .O(new_n853_));
  nand3  g760(.a(new_n128_), .b(x69), .c(x60), .O(new_n854_));
  nand3  g761(.a(new_n854_), .b(new_n853_), .c(new_n852_), .O(new_n855_));
  and2   g762(.a(new_n855_), .b(x67), .O(new_n856_));
  nand2  g763(.a(new_n822_), .b(new_n143_), .O(new_n857_));
  nand2  g764(.a(new_n805_), .b(new_n144_), .O(new_n858_));
  aoi21  g765(.a(new_n858_), .b(new_n857_), .c(new_n771_), .O(new_n859_));
  oai21  g766(.a(new_n859_), .b(new_n856_), .c(new_n139_), .O(new_n860_));
  nand2  g767(.a(new_n805_), .b(new_n133_), .O(new_n861_));
  oai21  g768(.a(new_n133_), .b(new_n840_), .c(new_n861_), .O(new_n862_));
  nand2  g769(.a(new_n862_), .b(new_n364_), .O(new_n863_));
  aoi21  g770(.a(new_n863_), .b(new_n860_), .c(x66), .O(new_n864_));
  nand2  g771(.a(new_n855_), .b(new_n139_), .O(new_n865_));
  nand3  g772(.a(new_n165_), .b(x68), .c(x44), .O(new_n866_));
  aoi21  g773(.a(new_n866_), .b(new_n865_), .c(new_n369_), .O(new_n867_));
  oai21  g774(.a(new_n867_), .b(new_n864_), .c(new_n173_), .O(new_n868_));
  nand2  g775(.a(new_n868_), .b(new_n850_), .O(z12));
  inv1   g776(.a(new_n177_), .O(new_n870_));
  nand3  g777(.a(new_n870_), .b(new_n310_), .c(x00), .O(new_n871_));
  oai21  g778(.a(new_n177_), .b(new_n96_), .c(x13), .O(new_n872_));
  aoi21  g779(.a(new_n872_), .b(new_n871_), .c(new_n116_), .O(new_n873_));
  nand2  g780(.a(new_n873_), .b(new_n134_), .O(new_n874_));
  inv1   g781(.a(new_n874_), .O(new_n875_));
  nand2  g782(.a(new_n207_), .b(x61), .O(new_n876_));
  nand2  g783(.a(new_n710_), .b(new_n212_), .O(new_n877_));
  nand2  g784(.a(new_n704_), .b(x53), .O(new_n878_));
  nand2  g785(.a(new_n878_), .b(new_n877_), .O(new_n879_));
  nand2  g786(.a(new_n879_), .b(x72), .O(new_n880_));
  nand2  g787(.a(x74), .b(x58), .O(new_n881_));
  nand2  g788(.a(new_n209_), .b(x59), .O(new_n882_));
  nand2  g789(.a(new_n882_), .b(new_n881_), .O(new_n883_));
  nand2  g790(.a(new_n883_), .b(x73), .O(new_n884_));
  nand2  g791(.a(new_n268_), .b(x60), .O(new_n885_));
  nand2  g792(.a(new_n885_), .b(new_n884_), .O(new_n886_));
  nand2  g793(.a(new_n886_), .b(new_n203_), .O(new_n887_));
  nand3  g794(.a(new_n887_), .b(new_n880_), .c(new_n876_), .O(new_n888_));
  aoi21  g795(.a(new_n888_), .b(new_n716_), .c(new_n875_), .O(new_n889_));
  nand2  g796(.a(new_n207_), .b(x29), .O(new_n890_));
  nand2  g797(.a(new_n728_), .b(new_n212_), .O(new_n891_));
  ...
  nand2  g801(.a(x74), .b(x26), .O(new_n895_));
  nand2  g802(.a(new_n209_), .b(x27), .O(new_n896_));
  nand2  g803(.a(new_n896_), .b(new_n895_), .O(new_n897_));
  ...
  nand3  g808(.a(new_n901_), .b(new_n894_), .c(new_n890_), .O(new_n902_));
  nand2  g809(.a(new_n902_), .b(new_n735_), .O(new_n903_));
  oai21  g810(.a(new_n889_), .b(new_n141_), .c(new_n903_), .O(new_n904_));
  nand2  g811(.a(new_n904_), .b(new_n100_), .O(new_n905_));
  ...
  aoi21  g819(.a(new_n878_), .b(new_n877_), .c(new_n203_), .O(new_n913_));
  aoi21  g820(.a(new_n885_), .b(new_n884_), .c(x72), .O(new_n914_));
  ...
  inv1   g824(.a(new_n190_), .O(new_n918_));
  nand3  g825(.a(new_n918_), .b(new_n321_), .c(x32), .O(new_n919_));
  oai21  g826(.a(new_n190_), .b(new_n112_), .c(x45), .O(new_n920_));
  aoi21  g827(.a(new_n920_), .b(new_n919_), .c(x71), .O(new_n921_));
  nand2  g828(.a(new_n921_), .b(new_n754_), .O(new_n922_));
  ...
  nand2  g832(.a(new_n873_), .b(new_n100_), .O(new_n926_));
  ...
  oai22  g836(.a(new_n156_), .b(new_n909_), .c(new_n116_), .d(new_n321_), .O(new_n930_));
  nand2  g837(.a(new_n930_), .b(x70), .O(new_n931_));
  nand2  g838(.a(new_n159_), .b(x13), .O(new_n932_));
  nand3  g839(.a(new_n128_), .b(x69), .c(x61), .O(new_n933_));
  nand3  g840(.a(new_n933_), .b(new_n932_), .c(new_n931_), .O(new_n934_));
  and2   g841(.a(new_n934_), .b(x67), .O(new_n935_));
  nand2  g842(.a(new_n902_), .b(new_n143_), .O(new_n936_));
  nand2  g843(.a(new_n888_), .b(new_n144_), .O(new_n937_));
  aoi21  g844(.a(new_n937_), .b(new_n936_), .c(new_n771_), .O(new_n938_));
  oai21  g845(.a(new_n938_), .b(new_n935_), .c(new_n139_), .O(new_n939_));
  nand2  g846(.a(new_n888_), .b(new_n133_), .O(new_n940_));
  oai21  g847(.a(new_n133_), .b(new_n321_), .c(new_n940_), .O(new_n941_));
  nand2  g848(.a(new_n941_), .b(new_n364_), .O(new_n942_));
  aoi21  g849(.a(new_n942_), .b(new_n939_), .c(x66), .O(new_n943_));
  nand2  g850(.a(new_n934_), .b(new_n139_), .O(new_n944_));
  nand3  g851(.a(new_n165_), .b(x68), .c(x45), .O(new_n945_));
  aoi21  g852(.a(new_n945_), .b(new_n944_), .c(new_n369_), .O(new_n946_));
  oai21  g853(.a(new_n946_), .b(new_n943_), .c(new_n173_), .O(new_n947_));
  ...
  nand2  g858(.a(new_n207_), .b(x62), .O(new_n952_));
  nand2  g859(.a(new_n800_), .b(new_n212_), .O(new_n953_));
  nand2  g860(.a(new_n704_), .b(x54), .O(new_n954_));
  ...
  nand2  g867(.a(new_n268_), .b(x61), .O(new_n961_));
  nand2  g868(.a(new_n961_), .b(new_n960_), .O(new_n962_));
  nand2  g869(.a(new_n962_), .b(new_n203_), .O(new_n963_));
  nand3  g870(.a(new_n963_), .b(new_n956_), .c(new_n952_), .O(new_n964_));
  aoi22  g871(.a(new_n964_), .b(new_n716_), .c(new_n951_), .d(new_n134_), .O(new_n965_));
  nand2  g872(.a(new_n207_), .b(x30), .O(new_n966_));
  nand2  g873(.a(new_n817_), .b(new_n212_), .O(new_n967_));
  nand2  g874(.a(new_n704_), .b(x22), .O(new_n968_));
  ...
  nand2  g884(.a(new_n977_), .b(new_n735_), .O(new_n978_));
  oai21  g885(.a(new_n965_), .b(new_n141_), .c(new_n978_), .O(new_n979_));
  nand2  g886(.a(new_n979_), .b(new_n100_), .O(new_n980_));
  aoi21  g887(.a(new_n968_), .b(new_n967_), .c(new_n203_), .O(new_n981_));
  ...
  aoi21  g894(.a(new_n954_), .b(new_n953_), .c(new_n203_), .O(new_n988_));
  ...
  nand2  g902(.a(new_n995_), .b(new_n754_), .O(new_n996_));
  ...
  nand2  g906(.a(new_n951_), .b(new_n100_), .O(new_n1000_));
  ...
  nand2  g918(.a(new_n964_), .b(new_n144_), .O(new_n1012_));
  aoi21  g919(.a(new_n1012_), .b(new_n1011_), .c(new_n771_), .O(new_n1013_));
  oai21  g920(.a(new_n1013_), .b(new_n1010_), .c(new_n139_), .O(new_n1014_));
  nand2  g921(.a(new_n964_), .b(new_n133_), .O(new_n1015_));
  ...
  aoi21  g945(.a(new_n896_), .b(new_n895_), .c(x73), .O(new_n1039_));
  ...
  aoi21  g958(.a(new_n882_), .b(new_n881_), .c(x73), .O(new_n1052_));
  ...
  aoi21  g964(.a(new_n1057_), .b(new_n1044_), .c(new_n771_), .O(new_n1058_));
