// Benchmark "FAU" written by ABC on Sun Aug  2 12:25:49 2020
...
module FAU ( 
  ...
  nand2  g448(.a(x74), .b(x26), .O(new_n550_));
  nand2  g449(.a(new_n204_), .b(x27), .O(new_n551_));
  aoi21  g450(.a(new_n551_), .b(new_n550_), .c(x73), .O(new_n552_));
  nand3  g451(.a(new_n204_), .b(x73), .c(x23), .O(new_n553_));
  inv1   g452(.a(new_n553_), .O(new_n554_));
  oai21  g453(.a(new_n554_), .b(new_n552_), .c(x72), .O(new_n555_));
  nand3  g454(.a(new_n555_), .b(new_n549_), .c(new_n548_), .O(new_n556_));
  nand2  g455(.a(new_n556_), .b(new_n147_), .O(new_n557_));
  nand2  g456(.a(x74), .b(x60), .O(new_n558_));
  nand2  g457(.a(new_n204_), .b(x61), .O(new_n559_));
  aoi21  g458(.a(new_n559_), .b(new_n558_), .c(new_n202_), .O(new_n560_));
  nand3  g459(.a(x74), .b(new_n202_), .c(x62), .O(new_n561_));
  inv1   g460(.a(new_n561_), .O(new_n562_));
  oai21  g461(.a(new_n562_), .b(new_n560_), .c(new_n201_), .O(new_n563_));
  nand2  g462(.a(new_n212_), .b(x63), .O(new_n564_));
  nand2  g463(.a(x74), .b(x58), .O(new_n565_));
  nand2  g464(.a(new_n204_), .b(x59), .O(new_n566_));
  aoi21  g465(.a(new_n566_), .b(new_n565_), .c(x73), .O(new_n567_));
  nand3  g466(.a(new_n204_), .b(x73), .c(x55), .O(new_n568_));
  inv1   g467(.a(new_n568_), .O(new_n569_));
  oai21  g468(.a(new_n569_), .b(new_n567_), .c(x72), .O(new_n570_));
  nand3  g469(.a(new_n570_), .b(new_n564_), .c(new_n563_), .O(new_n571_));
  nand2  g470(.a(new_n571_), .b(new_n240_), .O(new_n572_));
  aoi21  g471(.a(new_n572_), .b(new_n557_), .c(new_n349_), .O(new_n573_));
  oai21  g472(.a(new_n573_), .b(new_n542_), .c(new_n156_), .O(new_n574_));
  nand2  g473(.a(new_n541_), .b(new_n157_), .O(new_n575_));
  aoi21  g474(.a(new_n575_), .b(new_n574_), .c(new_n187_), .O(new_n576_));
  nand4  g475(.a(new_n94_), .b(x69), .c(x65), .d(new_n92_), .O(new_n577_));
  aoi21  g476(.a(new_n572_), .b(new_n557_), .c(new_n577_), .O(new_n578_));
  oai21  g477(.a(new_n578_), .b(new_n576_), .c(new_n143_), .O(new_n579_));
  nand3  g478(.a(x71), .b(new_n138_), .c(x15), .O(new_n580_));
  inv1   g479(.a(new_n580_), .O(new_n581_));
  aoi21  g480(.a(new_n571_), .b(new_n290_), .c(new_n581_), .O(new_n582_));
  nand3  g481(.a(new_n115_), .b(new_n138_), .c(x47), .O(new_n583_));
  oai21  g482(.a(new_n582_), .b(x70), .c(new_n583_), .O(new_n584_));
  inv1   g483(.a(x15), .O(new_n585_));
  oai22  g484(.a(new_n114_), .b(new_n536_), .c(new_n96_), .d(new_n585_), .O(new_n586_));
  aoi22  g485(.a(new_n586_), .b(new_n141_), .c(new_n584_), .d(new_n94_), .O(new_n587_));
  nand2  g486(.a(new_n571_), .b(new_n93_), .O(new_n588_));
  oai21  g487(.a(new_n158_), .b(new_n536_), .c(new_n588_), .O(new_n589_));
  nand3  g488(.a(new_n589_), .b(new_n176_), .c(new_n132_), .O(new_n590_));
  oai21  g489(.a(new_n587_), .b(x64), .c(new_n590_), .O(new_n591_));
  nand2  g490(.a(new_n591_), .b(new_n144_), .O(new_n592_));
  nand2  g491(.a(new_n592_), .b(new_n579_), .O(z15));
  zero   g492(.O(z01));
  zero   g493(.O(z02));
  zero   g494(.O(z03));
  zero   g495(.O(z04));
