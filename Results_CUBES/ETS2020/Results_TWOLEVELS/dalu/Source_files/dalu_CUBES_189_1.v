// Benchmark "FAU" written by ABC on Sun Aug  2 12:17:05 2020
...
module FAU ( 
  ...
  wire new_n93_, new_n94_, new_n95_, new_n96_, new_n97_, new_n98_, new_n99_,
    ...
    new_n878_, new_n879_, new_n880_, new_n881_, new_n882_, new_n886_,
  ...
  nand3  g626(.a(new_n269_), .b(new_n96_), .c(new_n268_), .O(new_n719_));
  ...
  inv1   g664(.a(new_n756_), .O(new_n757_));
  and2   g665(.a(new_n757_), .b(new_n755_), .O(new_n758_));
  ...
  nand3  g679(.a(new_n281_), .b(new_n116_), .c(new_n280_), .O(new_n772_));
  ...
  and2   g747(.a(new_n839_), .b(new_n757_), .O(new_n840_));
  ...
  oai21  g761(.a(new_n453_), .b(new_n127_), .c(x43), .O(new_n854_));
  nand3  g762(.a(new_n376_), .b(new_n115_), .c(x32), .O(new_n855_));
  ...
  aoi21  g788(.a(new_n880_), .b(new_n879_), .c(new_n332_), .O(new_n881_));
  oai21  g789(.a(new_n881_), .b(new_n878_), .c(new_n204_), .O(new_n882_));
  nand2  g790(.a(new_n882_), .b(new_n864_), .O(z11));
  nand2  g791(.a(x15), .b(x00), .O(new_n886_));
  xor2a  g792(.a(new_n886_), .b(x14), .O(new_n887_));
  nor2   g793(.a(new_n887_), .b(new_n131_), .O(new_n888_));
  nand2  g794(.a(new_n141_), .b(x62), .O(new_n889_));
  inv1   g795(.a(x58), .O(new_n890_));
  nand2  g796(.a(x74), .b(x57), .O(new_n891_));
  oai21  g797(.a(x74), .b(new_n890_), .c(new_n891_), .O(new_n892_));
  nand2  g798(.a(new_n892_), .b(new_n146_), .O(new_n893_));
  nand2  g799(.a(new_n728_), .b(x54), .O(new_n894_));
  nand2  g800(.a(new_n894_), .b(new_n893_), .O(new_n895_));
  nand2  g801(.a(new_n895_), .b(x72), .O(new_n896_));
  inv1   g802(.a(x60), .O(new_n897_));
  nand2  g803(.a(x74), .b(x59), .O(new_n898_));
  oai21  g804(.a(x74), .b(new_n897_), .c(new_n898_), .O(new_n899_));
  nand2  g805(.a(new_n899_), .b(x73), .O(new_n900_));
  nand2  g806(.a(new_n228_), .b(x61), .O(new_n901_));
  nand2  g807(.a(new_n901_), .b(new_n900_), .O(new_n902_));
  nand2  g808(.a(new_n902_), .b(new_n137_), .O(new_n903_));
  nand3  g809(.a(new_n903_), .b(new_n896_), .c(new_n889_), .O(new_n904_));
  aoi22  g810(.a(new_n904_), .b(new_n740_), .c(new_n888_), .d(new_n136_), .O(new_n905_));
  nand2  g811(.a(new_n141_), .b(x30), .O(new_n906_));
  nand2  g812(.a(x74), .b(x25), .O(new_n907_));
  oai21  g813(.a(x74), .b(new_n763_), .c(new_n907_), .O(new_n908_));
  nand2  g814(.a(new_n908_), .b(new_n146_), .O(new_n909_));
  nand2  g815(.a(new_n728_), .b(x22), .O(new_n910_));
  nand2  g816(.a(new_n910_), .b(new_n909_), .O(new_n911_));
  nand2  g817(.a(new_n911_), .b(x72), .O(new_n912_));
  inv1   g818(.a(x28), .O(new_n913_));
  nand2  g819(.a(x74), .b(x27), .O(new_n914_));
  oai21  g820(.a(x74), .b(new_n913_), .c(new_n914_), .O(new_n915_));
  nand2  g821(.a(new_n915_), .b(x73), .O(new_n916_));
  nand2  g822(.a(new_n228_), .b(x29), .O(new_n917_));
  nand2  g823(.a(new_n917_), .b(new_n916_), .O(new_n918_));
  nand2  g824(.a(new_n918_), .b(new_n137_), .O(new_n919_));
  nand3  g825(.a(new_n919_), .b(new_n912_), .c(new_n906_), .O(new_n920_));
  nand2  g826(.a(new_n920_), .b(new_n757_), .O(new_n921_));
  oai21  g827(.a(new_n905_), .b(new_n155_), .c(new_n921_), .O(new_n922_));
  nand2  g828(.a(new_n922_), .b(new_n111_), .O(new_n923_));
  aoi21  g829(.a(new_n910_), .b(new_n909_), .c(new_n137_), .O(new_n924_));
  aoi21  g830(.a(new_n917_), .b(new_n916_), .c(x72), .O(new_n925_));
  oai21  g831(.a(new_n925_), .b(new_n924_), .c(new_n131_), .O(new_n926_));
  inv1   g832(.a(x30), .O(new_n927_));
  nand2  g833(.a(x71), .b(x62), .O(new_n928_));
  oai21  g834(.a(x71), .b(new_n927_), .c(new_n928_), .O(new_n929_));
  nand2  g835(.a(new_n929_), .b(new_n141_), .O(new_n930_));
  aoi21  g836(.a(new_n894_), .b(new_n893_), .c(new_n137_), .O(new_n931_));
  aoi21  g837(.a(new_n901_), .b(new_n900_), .c(x72), .O(new_n932_));
  oai21  g838(.a(new_n932_), .b(new_n931_), .c(x71), .O(new_n933_));
  nand3  g839(.a(new_n933_), .b(new_n930_), .c(new_n926_), .O(new_n934_));
  nand2  g840(.a(new_n934_), .b(new_n165_), .O(new_n935_));
  nand2  g841(.a(x47), .b(x32), .O(new_n936_));
  xor2a  g842(.a(new_n936_), .b(x46), .O(new_n937_));
  nor2   g843(.a(new_n937_), .b(x71), .O(new_n938_));
  nand2  g844(.a(new_n938_), .b(new_n778_), .O(new_n939_));
  nand2  g845(.a(new_n939_), .b(new_n935_), .O(new_n940_));
  nand2  g846(.a(new_n940_), .b(x70), .O(new_n941_));
  aoi21  g847(.a(new_n941_), .b(new_n923_), .c(new_n93_), .O(new_n942_));
  nand2  g848(.a(new_n888_), .b(new_n111_), .O(new_n943_));
  nand2  g849(.a(new_n938_), .b(x70), .O(new_n944_));
  aoi21  g850(.a(new_n944_), .b(new_n943_), .c(new_n171_), .O(new_n945_));
  oai21  g851(.a(new_n945_), .b(new_n942_), .c(new_n203_), .O(new_n946_));
  nand2  g852(.a(x71), .b(x46), .O(new_n947_));
  oai21  g853(.a(new_n176_), .b(new_n927_), .c(new_n947_), .O(new_n948_));
  nand2  g854(.a(new_n948_), .b(x70), .O(new_n949_));
  nand2  g855(.a(new_n179_), .b(x14), .O(new_n950_));
  nand3  g856(.a(new_n181_), .b(x69), .c(x62), .O(new_n951_));
  nand3  g857(.a(new_n951_), .b(new_n950_), .c(new_n949_), .O(new_n952_));
  and2   g858(.a(new_n952_), .b(x67), .O(new_n953_));
  nand2  g859(.a(new_n920_), .b(new_n158_), .O(new_n954_));
  nand2  g860(.a(new_n904_), .b(new_n159_), .O(new_n955_));
  aoi21  g861(.a(new_n955_), .b(new_n954_), .c(new_n795_), .O(new_n956_));
  oai21  g862(.a(new_n956_), .b(new_n953_), .c(new_n153_), .O(new_n957_));
  nand2  g863(.a(new_n904_), .b(new_n168_), .O(new_n958_));
  nand2  g864(.a(x67), .b(x46), .O(new_n959_));
  nand2  g865(.a(new_n959_), .b(new_n958_), .O(new_n960_));
  nand2  g866(.a(new_n960_), .b(new_n327_), .O(new_n961_));
  aoi21  g867(.a(new_n961_), .b(new_n957_), .c(x66), .O(new_n962_));
  nand2  g868(.a(new_n952_), .b(new_n153_), .O(new_n963_));
  nand3  g869(.a(new_n186_), .b(x68), .c(x46), .O(new_n964_));
  aoi21  g870(.a(new_n964_), .b(new_n963_), .c(new_n332_), .O(new_n965_));
  oai21  g871(.a(new_n965_), .b(new_n962_), .c(new_n204_), .O(new_n966_));
  nand2  g872(.a(new_n966_), .b(new_n946_), .O(z14));
  inv1   g873(.a(x31), .O(new_n968_));
  inv1   g874(.a(x47), .O(new_n969_));
  oai22  g875(.a(new_n176_), .b(new_n968_), .c(new_n131_), .d(new_n969_), .O(new_n970_));
  nand2  g876(.a(new_n970_), .b(x70), .O(new_n971_));
  nand2  g877(.a(new_n179_), .b(x15), .O(new_n972_));
  nand3  g878(.a(new_n181_), .b(x69), .c(x63), .O(new_n973_));
  nand3  g879(.a(new_n973_), .b(new_n972_), .c(new_n971_), .O(new_n974_));
  and2   g880(.a(new_n974_), .b(x67), .O(new_n975_));
  nand2  g881(.a(x74), .b(x28), .O(new_n976_));
  nand2  g882(.a(new_n143_), .b(x29), .O(new_n977_));
  aoi21  g883(.a(new_n977_), .b(new_n976_), .c(new_n146_), .O(new_n978_));
  nand2  g884(.a(new_n228_), .b(x30), .O(new_n979_));
  inv1   g885(.a(new_n979_), .O(new_n980_));
  oai21  g886(.a(new_n980_), .b(new_n978_), .c(new_n137_), .O(new_n981_));
  nand2  g887(.a(new_n141_), .b(x31), .O(new_n982_));
  nand2  g888(.a(x74), .b(x26), .O(new_n983_));
  nand2  g889(.a(new_n143_), .b(x27), .O(new_n984_));
  aoi21  g890(.a(new_n984_), .b(new_n983_), .c(x73), .O(new_n985_));
  nand2  g891(.a(new_n728_), .b(x23), .O(new_n986_));
  inv1   g892(.a(new_n986_), .O(new_n987_));
  oai21  g893(.a(new_n987_), .b(new_n985_), .c(x72), .O(new_n988_));
  nand3  g894(.a(new_n988_), .b(new_n982_), .c(new_n981_), .O(new_n989_));
  nand2  g895(.a(new_n989_), .b(new_n158_), .O(new_n990_));
  nand2  g896(.a(x74), .b(x60), .O(new_n991_));
  nand2  g897(.a(new_n143_), .b(x61), .O(new_n992_));
  aoi21  g898(.a(new_n992_), .b(new_n991_), .c(new_n146_), .O(new_n993_));
  nand2  g899(.a(new_n228_), .b(x62), .O(new_n994_));
  inv1   g900(.a(new_n994_), .O(new_n995_));
  oai21  g901(.a(new_n995_), .b(new_n993_), .c(new_n137_), .O(new_n996_));
  nand2  g902(.a(new_n141_), .b(x63), .O(new_n997_));
  nand2  g903(.a(x74), .b(x58), .O(new_n998_));
  nand2  g904(.a(new_n143_), .b(x59), .O(new_n999_));
  aoi21  g905(.a(new_n999_), .b(new_n998_), .c(x73), .O(new_n1000_));
  nand2  g906(.a(new_n728_), .b(x55), .O(new_n1001_));
  inv1   g907(.a(new_n1001_), .O(new_n1002_));
  oai21  g908(.a(new_n1002_), .b(new_n1000_), .c(x72), .O(new_n1003_));
  nand3  g909(.a(new_n1003_), .b(new_n997_), .c(new_n996_), .O(new_n1004_));
  nand2  g910(.a(new_n1004_), .b(new_n159_), .O(new_n1005_));
  aoi21  g911(.a(new_n1005_), .b(new_n990_), .c(new_n795_), .O(new_n1006_));
  oai21  g912(.a(new_n1006_), .b(new_n975_), .c(new_n189_), .O(new_n1007_));
  nand2  g913(.a(new_n974_), .b(new_n190_), .O(new_n1008_));
  aoi21  g914(.a(new_n1008_), .b(new_n1007_), .c(new_n600_), .O(new_n1009_));
  nand4  g915(.a(new_n94_), .b(x69), .c(x65), .d(new_n203_), .O(new_n1010_));
  aoi21  g916(.a(new_n1005_), .b(new_n990_), .c(new_n1010_), .O(new_n1011_));
  oai21  g917(.a(new_n1011_), .b(new_n1009_), .c(new_n153_), .O(new_n1012_));
  nand3  g918(.a(x71), .b(new_n136_), .c(x15), .O(new_n1013_));
  inv1   g919(.a(new_n1013_), .O(new_n1014_));
  aoi21  g920(.a(new_n1004_), .b(new_n740_), .c(new_n1014_), .O(new_n1015_));
  nand3  g921(.a(new_n133_), .b(new_n136_), .c(x47), .O(new_n1016_));
  oai21  g922(.a(new_n1015_), .b(x70), .c(new_n1016_), .O(new_n1017_));
  nand2  g923(.a(new_n113_), .b(x15), .O(new_n1018_));
  nand2  g924(.a(new_n133_), .b(x47), .O(new_n1019_));
  aoi21  g925(.a(new_n1019_), .b(new_n1018_), .c(new_n387_), .O(new_n1020_));
  aoi21  g926(.a(new_n1017_), .b(new_n94_), .c(new_n1020_), .O(new_n1021_));
  nand2  g927(.a(new_n1004_), .b(new_n93_), .O(new_n1022_));
  oai21  g928(.a(new_n191_), .b(new_n969_), .c(new_n1022_), .O(new_n1023_));
  nand3  g929(.a(new_n1023_), .b(new_n204_), .c(new_n181_), .O(new_n1024_));
  oai21  g930(.a(new_n1021_), .b(x64), .c(new_n1024_), .O(new_n1025_));
  nand2  g931(.a(new_n1025_), .b(new_n154_), .O(new_n1026_));
  nand2  g932(.a(new_n1026_), .b(new_n1012_), .O(z15));
  zero   g933(.O(z00));
  zero   g934(.O(z12));
  zero   g935(.O(z13));
endmodule
