// Benchmark "FAU" written by ABC on Sun Aug  2 12:13:49 2020
...
module FAU ( 
  ...
  nand2  g893(.a(x15), .b(x00), .O(new_n987_));
  xor2a  g894(.a(new_n987_), .b(x14), .O(new_n988_));
  nor2   g895(.a(new_n988_), .b(new_n131_), .O(new_n989_));
  nand2  g896(.a(new_n989_), .b(new_n136_), .O(new_n990_));
  inv1   g897(.a(new_n990_), .O(new_n991_));
  nand2  g898(.a(new_n141_), .b(x62), .O(new_n992_));
  nand2  g899(.a(new_n844_), .b(new_n146_), .O(new_n993_));
  nand2  g900(.a(new_n666_), .b(x54), .O(new_n994_));
  nand2  g901(.a(new_n994_), .b(new_n993_), .O(new_n995_));
  nand2  g902(.a(new_n995_), .b(x72), .O(new_n996_));
  inv1   g903(.a(x60), .O(new_n997_));
  nand2  g904(.a(x74), .b(x59), .O(new_n998_));
  oai21  g905(.a(x74), .b(new_n997_), .c(new_n998_), .O(new_n999_));
  nand2  g906(.a(new_n999_), .b(x73), .O(new_n1000_));
  nand2  g907(.a(new_n228_), .b(x61), .O(new_n1001_));
  nand2  g908(.a(new_n1001_), .b(new_n1000_), .O(new_n1002_));
  nand2  g909(.a(new_n1002_), .b(new_n137_), .O(new_n1003_));
  nand3  g910(.a(new_n1003_), .b(new_n996_), .c(new_n992_), .O(new_n1004_));
  aoi21  g911(.a(new_n1004_), .b(new_n678_), .c(new_n991_), .O(new_n1005_));
  nand2  g912(.a(new_n141_), .b(x30), .O(new_n1006_));
  nand2  g913(.a(new_n858_), .b(new_n146_), .O(new_n1007_));
  nand2  g914(.a(new_n666_), .b(x22), .O(new_n1008_));
  nand2  g915(.a(new_n1008_), .b(new_n1007_), .O(new_n1009_));
  nand2  g916(.a(new_n1009_), .b(x72), .O(new_n1010_));
  nand2  g917(.a(x74), .b(x27), .O(new_n1011_));
  oai21  g918(.a(x74), .b(new_n869_), .c(new_n1011_), .O(new_n1012_));
  nand2  g919(.a(new_n1012_), .b(x73), .O(new_n1013_));
  nand2  g920(.a(new_n228_), .b(x29), .O(new_n1014_));
  nand2  g921(.a(new_n1014_), .b(new_n1013_), .O(new_n1015_));
  nand2  g922(.a(new_n1015_), .b(new_n137_), .O(new_n1016_));
  nand3  g923(.a(new_n1016_), .b(new_n1010_), .c(new_n1006_), .O(new_n1017_));
  nand2  g924(.a(new_n1017_), .b(new_n695_), .O(new_n1018_));
  oai21  g925(.a(new_n1005_), .b(new_n155_), .c(new_n1018_), .O(new_n1019_));
  nand2  g926(.a(new_n1019_), .b(new_n111_), .O(new_n1020_));
  aoi21  g927(.a(new_n1008_), .b(new_n1007_), .c(new_n137_), .O(new_n1021_));
  aoi21  g928(.a(new_n1014_), .b(new_n1013_), .c(x72), .O(new_n1022_));
  oai21  g929(.a(new_n1022_), .b(new_n1021_), .c(new_n131_), .O(new_n1023_));
  inv1   g930(.a(x30), .O(new_n1024_));
  nand2  g931(.a(x71), .b(x62), .O(new_n1025_));
  oai21  g932(.a(x71), .b(new_n1024_), .c(new_n1025_), .O(new_n1026_));
  nand2  g933(.a(new_n1026_), .b(new_n141_), .O(new_n1027_));
  aoi21  g934(.a(new_n994_), .b(new_n993_), .c(new_n137_), .O(new_n1028_));
  aoi21  g935(.a(new_n1001_), .b(new_n1000_), .c(x72), .O(new_n1029_));
  oai21  g936(.a(new_n1029_), .b(new_n1028_), .c(x71), .O(new_n1030_));
  nand3  g937(.a(new_n1030_), .b(new_n1027_), .c(new_n1023_), .O(new_n1031_));
  nand2  g938(.a(new_n1031_), .b(new_n165_), .O(new_n1032_));
  nand2  g939(.a(x47), .b(x32), .O(new_n1033_));
  xor2a  g940(.a(new_n1033_), .b(x46), .O(new_n1034_));
  nor2   g941(.a(new_n1034_), .b(x71), .O(new_n1035_));
  nand2  g942(.a(new_n1035_), .b(new_n720_), .O(new_n1036_));
  nand2  g943(.a(new_n1036_), .b(new_n1032_), .O(new_n1037_));
  nand2  g944(.a(new_n1037_), .b(x70), .O(new_n1038_));
  aoi21  g945(.a(new_n1038_), .b(new_n1020_), .c(new_n93_), .O(new_n1039_));
  nand2  g946(.a(new_n989_), .b(new_n111_), .O(new_n1040_));
  nand2  g947(.a(new_n1035_), .b(x70), .O(new_n1041_));
  aoi21  g948(.a(new_n1041_), .b(new_n1040_), .c(new_n171_), .O(new_n1042_));
  oai21  g949(.a(new_n1042_), .b(new_n1039_), .c(new_n203_), .O(new_n1043_));
  oai22  g950(.a(new_n176_), .b(new_n1024_), .c(new_n131_), .d(new_n710_), .O(new_n1044_));
  nand2  g951(.a(new_n1044_), .b(x70), .O(new_n1045_));
  nand2  g952(.a(new_n179_), .b(x14), .O(new_n1046_));
  nand3  g953(.a(new_n181_), .b(x69), .c(x62), .O(new_n1047_));
  nand3  g954(.a(new_n1047_), .b(new_n1046_), .c(new_n1045_), .O(new_n1048_));
  and2   g955(.a(new_n1048_), .b(x67), .O(new_n1049_));
  nand2  g956(.a(new_n1017_), .b(new_n158_), .O(new_n1050_));
  nand2  g957(.a(new_n1004_), .b(new_n159_), .O(new_n1051_));
  aoi21  g958(.a(new_n1051_), .b(new_n1050_), .c(new_n737_), .O(new_n1052_));
  oai21  g959(.a(new_n1052_), .b(new_n1049_), .c(new_n153_), .O(new_n1053_));
  nand2  g960(.a(new_n1004_), .b(new_n168_), .O(new_n1054_));
  oai21  g961(.a(new_n168_), .b(new_n710_), .c(new_n1054_), .O(new_n1055_));
  nand2  g962(.a(new_n1055_), .b(new_n326_), .O(new_n1056_));
  aoi21  g963(.a(new_n1056_), .b(new_n1053_), .c(x66), .O(new_n1057_));
  nand2  g964(.a(new_n1048_), .b(new_n153_), .O(new_n1058_));
  nand3  g965(.a(new_n186_), .b(x68), .c(x46), .O(new_n1059_));
  aoi21  g966(.a(new_n1059_), .b(new_n1058_), .c(new_n191_), .O(new_n1060_));
  oai21  g967(.a(new_n1060_), .b(new_n1057_), .c(new_n204_), .O(new_n1061_));
  nand2  g968(.a(new_n1061_), .b(new_n1043_), .O(z14));
  zero   g969(.O(z00));
  zero   g970(.O(z09));
  zero   g971(.O(z15));
endmodule
