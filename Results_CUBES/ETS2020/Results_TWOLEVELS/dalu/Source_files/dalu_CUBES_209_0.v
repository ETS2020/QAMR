// Benchmark "FAU" written by ABC on Sun Aug  2 12:27:31 2020
...
module FAU ( 
  ...
  nor2   g347(.a(x13), .b(new_n99_), .O(new_n448_));
  oai21  g348(.a(x15), .b(x14), .c(new_n448_), .O(new_n449_));
  ...
  inv1   g427(.a(x31), .O(new_n529_));
  inv1   g428(.a(x47), .O(new_n530_));
  oai22  g429(.a(new_n161_), .b(new_n529_), .c(new_n113_), .d(new_n530_), .O(new_n531_));
  nand2  g430(.a(new_n531_), .b(x70), .O(new_n532_));
  nand2  g431(.a(new_n164_), .b(x15), .O(new_n533_));
  nand3  g432(.a(new_n132_), .b(x69), .c(x63), .O(new_n534_));
  nand3  g433(.a(new_n534_), .b(new_n533_), .c(new_n532_), .O(new_n535_));
  and2   g434(.a(new_n535_), .b(x67), .O(new_n536_));
  nand2  g435(.a(x74), .b(x28), .O(new_n537_));
  nand2  g436(.a(new_n204_), .b(x29), .O(new_n538_));
  aoi21  g437(.a(new_n538_), .b(new_n537_), .c(new_n202_), .O(new_n539_));
  nand3  g438(.a(x74), .b(new_n202_), .c(x30), .O(new_n540_));
  inv1   g439(.a(new_n540_), .O(new_n541_));
  oai21  g440(.a(new_n541_), .b(new_n539_), .c(new_n201_), .O(new_n542_));
  nand2  g441(.a(new_n212_), .b(x31), .O(new_n543_));
  nand2  g442(.a(new_n204_), .b(x27), .O(new_n544_));
  aoi21  g443(.a(new_n544_), .b(new_n471_), .c(x73), .O(new_n545_));
  nand3  g444(.a(new_n204_), .b(x73), .c(x23), .O(new_n546_));
  inv1   g445(.a(new_n546_), .O(new_n547_));
  oai21  g446(.a(new_n547_), .b(new_n545_), .c(x72), .O(new_n548_));
  nand3  g447(.a(new_n548_), .b(new_n543_), .c(new_n542_), .O(new_n549_));
  nand2  g448(.a(new_n549_), .b(new_n147_), .O(new_n550_));
  nand2  g449(.a(x74), .b(x60), .O(new_n551_));
  nand2  g450(.a(new_n204_), .b(x61), .O(new_n552_));
  aoi21  g451(.a(new_n552_), .b(new_n551_), .c(new_n202_), .O(new_n553_));
  nand3  g452(.a(x74), .b(new_n202_), .c(x62), .O(new_n554_));
  inv1   g453(.a(new_n554_), .O(new_n555_));
  oai21  g454(.a(new_n555_), .b(new_n553_), .c(new_n201_), .O(new_n556_));
  nand2  g455(.a(new_n212_), .b(x63), .O(new_n557_));
  aoi21  g456(.a(new_n459_), .b(new_n458_), .c(x73), .O(new_n558_));
  nand3  g457(.a(new_n204_), .b(x73), .c(x55), .O(new_n559_));
  inv1   g458(.a(new_n559_), .O(new_n560_));
  oai21  g459(.a(new_n560_), .b(new_n558_), .c(x72), .O(new_n561_));
  nand3  g460(.a(new_n561_), .b(new_n557_), .c(new_n556_), .O(new_n562_));
  nand2  g461(.a(new_n562_), .b(new_n240_), .O(new_n563_));
  aoi21  g462(.a(new_n563_), .b(new_n550_), .c(new_n349_), .O(new_n564_));
  oai21  g463(.a(new_n564_), .b(new_n536_), .c(new_n156_), .O(new_n565_));
  nand2  g464(.a(new_n535_), .b(new_n157_), .O(new_n566_));
  aoi21  g465(.a(new_n566_), .b(new_n565_), .c(new_n187_), .O(new_n567_));
  nand4  g466(.a(new_n94_), .b(x69), .c(x65), .d(new_n92_), .O(new_n568_));
  aoi21  g467(.a(new_n563_), .b(new_n550_), .c(new_n568_), .O(new_n569_));
  oai21  g468(.a(new_n569_), .b(new_n567_), .c(new_n143_), .O(new_n570_));
  nand3  g469(.a(x71), .b(new_n138_), .c(x15), .O(new_n571_));
  inv1   g470(.a(new_n571_), .O(new_n572_));
  aoi21  g471(.a(new_n562_), .b(new_n290_), .c(new_n572_), .O(new_n573_));
  nand3  g472(.a(new_n115_), .b(new_n138_), .c(x47), .O(new_n574_));
  oai21  g473(.a(new_n573_), .b(x70), .c(new_n574_), .O(new_n575_));
  inv1   g474(.a(x15), .O(new_n576_));
  oai22  g475(.a(new_n114_), .b(new_n530_), .c(new_n96_), .d(new_n576_), .O(new_n577_));
  aoi22  g476(.a(new_n577_), .b(new_n141_), .c(new_n575_), .d(new_n94_), .O(new_n578_));
  nand2  g477(.a(new_n562_), .b(new_n93_), .O(new_n579_));
  oai21  g478(.a(new_n158_), .b(new_n530_), .c(new_n579_), .O(new_n580_));
  nand3  g479(.a(new_n580_), .b(new_n176_), .c(new_n132_), .O(new_n581_));
  oai21  g480(.a(new_n578_), .b(x64), .c(new_n581_), .O(new_n582_));
  nand2  g481(.a(new_n582_), .b(new_n144_), .O(new_n583_));
  nand2  g482(.a(new_n583_), .b(new_n570_), .O(z15));
  zero   g483(.O(z01));
  zero   g484(.O(z02));
  zero   g485(.O(z03));
  zero   g486(.O(z04));
