// Benchmark "FAU" written by ABC on Sun Aug  2 12:22:31 2020
...
module FAU ( 
  ...
  oai21  g294(.a(new_n105_), .b(new_n109_), .c(x12), .O(new_n395_));
  inv1   g295(.a(new_n105_), .O(new_n396_));
  nor2   g296(.a(x12), .b(new_n109_), .O(new_n397_));
  nand2  g297(.a(new_n397_), .b(new_n396_), .O(new_n398_));
  aoi21  g298(.a(new_n398_), .b(new_n395_), .c(new_n125_), .O(new_n399_));
  nand2  g299(.a(new_n399_), .b(new_n176_), .O(new_n400_));
  nand2  g300(.a(new_n141_), .b(x60), .O(new_n401_));
  nand2  g301(.a(new_n229_), .b(new_n131_), .O(new_n402_));
  nand3  g302(.a(new_n133_), .b(x73), .c(x52), .O(new_n403_));
  nand2  g303(.a(new_n403_), .b(new_n402_), .O(new_n404_));
  nand2  g304(.a(new_n404_), .b(x72), .O(new_n405_));
  inv1   g305(.a(x58), .O(new_n406_));
  nand2  g306(.a(x74), .b(x57), .O(new_n407_));
  oai21  g307(.a(x74), .b(new_n406_), .c(new_n407_), .O(new_n408_));
  nand2  g308(.a(new_n408_), .b(x73), .O(new_n409_));
  nand3  g309(.a(x74), .b(new_n131_), .c(x59), .O(new_n410_));
  nand2  g310(.a(new_n410_), .b(new_n409_), .O(new_n411_));
  nand2  g311(.a(new_n411_), .b(new_n130_), .O(new_n412_));
  nand3  g312(.a(new_n412_), .b(new_n405_), .c(new_n401_), .O(new_n413_));
  nand2  g313(.a(new_n413_), .b(new_n235_), .O(new_n414_));
  aoi21  g314(.a(new_n414_), .b(new_n400_), .c(new_n213_), .O(new_n415_));
  nand2  g315(.a(new_n141_), .b(x28), .O(new_n416_));
  nand2  g316(.a(new_n248_), .b(new_n131_), .O(new_n417_));
  nand3  g317(.a(new_n133_), .b(x73), .c(x20), .O(new_n418_));
  nand2  g318(.a(new_n418_), .b(new_n417_), .O(new_n419_));
  nand2  g319(.a(new_n419_), .b(x72), .O(new_n420_));
  nand2  g320(.a(x74), .b(x25), .O(new_n421_));
  oai21  g321(.a(x74), .b(new_n261_), .c(new_n421_), .O(new_n422_));
  nand2  g322(.a(new_n422_), .b(x73), .O(new_n423_));
  nand3  g323(.a(x74), .b(new_n131_), .c(x27), .O(new_n424_));
  nand2  g324(.a(new_n424_), .b(new_n423_), .O(new_n425_));
  nand2  g325(.a(new_n425_), .b(new_n130_), .O(new_n426_));
  nand3  g326(.a(new_n426_), .b(new_n420_), .c(new_n416_), .O(new_n427_));
  and2   g327(.a(new_n427_), .b(new_n255_), .O(new_n428_));
  oai21  g328(.a(new_n428_), .b(new_n415_), .c(new_n112_), .O(new_n429_));
  aoi21  g329(.a(new_n418_), .b(new_n417_), .c(new_n130_), .O(new_n430_));
  aoi21  g330(.a(new_n424_), .b(new_n423_), .c(x72), .O(new_n431_));
  oai21  g331(.a(new_n431_), .b(new_n430_), .c(new_n125_), .O(new_n432_));
  inv1   g332(.a(x28), .O(new_n433_));
  nand2  g333(.a(x71), .b(x60), .O(new_n434_));
  oai21  g334(.a(x71), .b(new_n433_), .c(new_n434_), .O(new_n435_));
  nand2  g335(.a(new_n435_), .b(new_n141_), .O(new_n436_));
  aoi21  g336(.a(new_n403_), .b(new_n402_), .c(new_n130_), .O(new_n437_));
  aoi21  g337(.a(new_n410_), .b(new_n409_), .c(x72), .O(new_n438_));
  oai21  g338(.a(new_n438_), .b(new_n437_), .c(x71), .O(new_n439_));
  nand3  g339(.a(new_n439_), .b(new_n436_), .c(new_n432_), .O(new_n440_));
  nand2  g340(.a(new_n440_), .b(new_n270_), .O(new_n441_));
  oai21  g341(.a(new_n118_), .b(new_n122_), .c(x44), .O(new_n442_));
  inv1   g342(.a(x44), .O(new_n443_));
  inv1   g343(.a(new_n118_), .O(new_n444_));
  nand3  g344(.a(new_n444_), .b(new_n443_), .c(x32), .O(new_n445_));
  aoi21  g345(.a(new_n445_), .b(new_n442_), .c(x71), .O(new_n446_));
  nand2  g346(.a(new_n446_), .b(new_n278_), .O(new_n447_));
  nand2  g347(.a(new_n447_), .b(new_n441_), .O(new_n448_));
  nand2  g348(.a(new_n448_), .b(x70), .O(new_n449_));
  aoi21  g349(.a(new_n449_), .b(new_n429_), .c(new_n102_), .O(new_n450_));
  nand2  g350(.a(new_n399_), .b(new_n112_), .O(new_n451_));
  nand2  g351(.a(new_n446_), .b(x70), .O(new_n452_));
  aoi21  g352(.a(new_n452_), .b(new_n451_), .c(new_n182_), .O(new_n453_));
  oai21  g353(.a(new_n453_), .b(new_n450_), .c(new_n101_), .O(new_n454_));
  oai22  g354(.a(new_n187_), .b(new_n433_), .c(new_n125_), .d(new_n443_), .O(new_n455_));
  nand2  g355(.a(new_n455_), .b(x70), .O(new_n456_));
  nand2  g356(.a(new_n190_), .b(x12), .O(new_n457_));
  nand3  g357(.a(new_n192_), .b(x69), .c(x60), .O(new_n458_));
  nand3  g358(.a(new_n458_), .b(new_n457_), .c(new_n456_), .O(new_n459_));
  and2   g359(.a(new_n459_), .b(x67), .O(new_n460_));
  nand2  g360(.a(new_n427_), .b(new_n157_), .O(new_n461_));
  nand2  g361(.a(new_n413_), .b(new_n173_), .O(new_n462_));
  aoi21  g362(.a(new_n462_), .b(new_n461_), .c(new_n295_), .O(new_n463_));
  oai21  g363(.a(new_n463_), .b(new_n460_), .c(new_n153_), .O(new_n464_));
  nand2  g364(.a(new_n413_), .b(new_n180_), .O(new_n465_));
  oai21  g365(.a(new_n180_), .b(new_n443_), .c(new_n465_), .O(new_n466_));
  nand2  g366(.a(new_n466_), .b(new_n200_), .O(new_n467_));
  aoi21  g367(.a(new_n467_), .b(new_n464_), .c(x66), .O(new_n468_));
  nand2  g368(.a(new_n459_), .b(new_n153_), .O(new_n469_));
  nand3  g369(.a(new_n204_), .b(x68), .c(x44), .O(new_n470_));
  aoi21  g370(.a(new_n470_), .b(new_n469_), .c(new_n207_), .O(new_n471_));
  oai21  g371(.a(new_n471_), .b(new_n468_), .c(new_n210_), .O(new_n472_));
  nand2  g372(.a(new_n472_), .b(new_n454_), .O(z12));
  nand2  g373(.a(x15), .b(x00), .O(new_n475_));
  xor2a  g374(.a(new_n475_), .b(x14), .O(new_n476_));
  nor2   g375(.a(new_n476_), .b(new_n125_), .O(new_n477_));
  nand2  g376(.a(new_n141_), .b(x62), .O(new_n478_));
  nand2  g377(.a(new_n133_), .b(x58), .O(new_n479_));
  aoi21  g378(.a(new_n479_), .b(new_n407_), .c(x73), .O(new_n480_));
  nand3  g379(.a(new_n133_), .b(x73), .c(x54), .O(new_n481_));
  inv1   g380(.a(new_n481_), .O(new_n482_));
  oai21  g381(.a(new_n482_), .b(new_n480_), .c(x72), .O(new_n483_));
  nand2  g382(.a(x74), .b(x59), .O(new_n484_));
  nand2  g383(.a(new_n133_), .b(x60), .O(new_n485_));
  aoi21  g384(.a(new_n485_), .b(new_n484_), .c(new_n131_), .O(new_n486_));
  nand3  g385(.a(x74), .b(new_n131_), .c(x61), .O(new_n487_));
  inv1   g386(.a(new_n487_), .O(new_n488_));
  oai21  g387(.a(new_n488_), .b(new_n486_), .c(new_n130_), .O(new_n489_));
  nand3  g388(.a(new_n489_), .b(new_n483_), .c(new_n478_), .O(new_n490_));
  aoi22  g389(.a(new_n490_), .b(new_n235_), .c(new_n477_), .d(new_n176_), .O(new_n491_));
  nand2  g390(.a(new_n141_), .b(x30), .O(new_n492_));
  nand2  g391(.a(new_n422_), .b(new_n131_), .O(new_n493_));
  nand3  g392(.a(new_n133_), .b(x73), .c(x22), .O(new_n494_));
  nand2  g393(.a(new_n494_), .b(new_n493_), .O(new_n495_));
  nand2  g394(.a(new_n495_), .b(x72), .O(new_n496_));
  nand2  g395(.a(x74), .b(x27), .O(new_n497_));
  oai21  g396(.a(x74), .b(new_n433_), .c(new_n497_), .O(new_n498_));
  nand2  g397(.a(new_n498_), .b(x73), .O(new_n499_));
  nand3  g398(.a(x74), .b(new_n131_), .c(x29), .O(new_n500_));
  nand2  g399(.a(new_n500_), .b(new_n499_), .O(new_n501_));
  nand2  g400(.a(new_n501_), .b(new_n130_), .O(new_n502_));
  nand3  g401(.a(new_n502_), .b(new_n496_), .c(new_n492_), .O(new_n503_));
  nand2  g402(.a(new_n503_), .b(new_n255_), .O(new_n504_));
  oai21  g403(.a(new_n491_), .b(new_n213_), .c(new_n504_), .O(new_n505_));
  nand2  g404(.a(new_n505_), .b(new_n112_), .O(new_n506_));
  aoi21  g405(.a(new_n494_), .b(new_n493_), .c(new_n130_), .O(new_n507_));
  aoi21  g406(.a(new_n500_), .b(new_n499_), .c(x72), .O(new_n508_));
  oai21  g407(.a(new_n508_), .b(new_n507_), .c(new_n125_), .O(new_n509_));
  inv1   g408(.a(x30), .O(new_n510_));
  nand2  g409(.a(x71), .b(x62), .O(new_n511_));
  oai21  g410(.a(x71), .b(new_n510_), .c(new_n511_), .O(new_n512_));
  nand2  g411(.a(new_n512_), .b(new_n141_), .O(new_n513_));
  nand2  g412(.a(new_n408_), .b(new_n131_), .O(new_n514_));
  aoi21  g413(.a(new_n481_), .b(new_n514_), .c(new_n130_), .O(new_n515_));
  inv1   g414(.a(x60), .O(new_n516_));
  oai21  g415(.a(x74), .b(new_n516_), .c(new_n484_), .O(new_n517_));
  nand2  g416(.a(new_n517_), .b(x73), .O(new_n518_));
  aoi21  g417(.a(new_n487_), .b(new_n518_), .c(x72), .O(new_n519_));
  oai21  g418(.a(new_n519_), .b(new_n515_), .c(x71), .O(new_n520_));
  nand3  g419(.a(new_n520_), .b(new_n513_), .c(new_n509_), .O(new_n521_));
  nand2  g420(.a(new_n521_), .b(new_n270_), .O(new_n522_));
  nand2  g421(.a(x47), .b(x32), .O(new_n523_));
  xor2a  g422(.a(new_n523_), .b(x46), .O(new_n524_));
  nor2   g423(.a(new_n524_), .b(x71), .O(new_n525_));
  nand2  g424(.a(new_n525_), .b(new_n278_), .O(new_n526_));
  nand2  g425(.a(new_n526_), .b(new_n522_), .O(new_n527_));
  nand2  g426(.a(new_n527_), .b(x70), .O(new_n528_));
  aoi21  g427(.a(new_n528_), .b(new_n506_), .c(new_n102_), .O(new_n529_));
  nand2  g428(.a(new_n477_), .b(new_n112_), .O(new_n530_));
  nand2  g429(.a(new_n525_), .b(x70), .O(new_n531_));
  aoi21  g430(.a(new_n531_), .b(new_n530_), .c(new_n182_), .O(new_n532_));
  oai21  g431(.a(new_n532_), .b(new_n529_), .c(new_n101_), .O(new_n533_));
  nand2  g432(.a(x71), .b(x46), .O(new_n534_));
  oai21  g433(.a(new_n187_), .b(new_n510_), .c(new_n534_), .O(new_n535_));
  nand2  g434(.a(new_n535_), .b(x70), .O(new_n536_));
  nand2  g435(.a(new_n190_), .b(x14), .O(new_n537_));
  nand3  g436(.a(new_n192_), .b(x69), .c(x62), .O(new_n538_));
  nand3  g437(.a(new_n538_), .b(new_n537_), .c(new_n536_), .O(new_n539_));
  and2   g438(.a(new_n539_), .b(x67), .O(new_n540_));
  nand2  g439(.a(new_n503_), .b(new_n157_), .O(new_n541_));
  nand2  g440(.a(new_n490_), .b(new_n173_), .O(new_n542_));
  aoi21  g441(.a(new_n542_), .b(new_n541_), .c(new_n295_), .O(new_n543_));
  oai21  g442(.a(new_n543_), .b(new_n540_), .c(new_n153_), .O(new_n544_));
  nand2  g443(.a(new_n490_), .b(new_n180_), .O(new_n545_));
  nand2  g444(.a(x67), .b(x46), .O(new_n546_));
  nand2  g445(.a(new_n546_), .b(new_n545_), .O(new_n547_));
  nand2  g446(.a(new_n547_), .b(new_n200_), .O(new_n548_));
  aoi21  g447(.a(new_n548_), .b(new_n544_), .c(x66), .O(new_n549_));
  nand2  g448(.a(new_n539_), .b(new_n153_), .O(new_n550_));
  nand3  g449(.a(new_n204_), .b(x68), .c(x46), .O(new_n551_));
  aoi21  g450(.a(new_n551_), .b(new_n550_), .c(new_n207_), .O(new_n552_));
  oai21  g451(.a(new_n552_), .b(new_n549_), .c(new_n210_), .O(new_n553_));
  nand2  g452(.a(new_n553_), .b(new_n533_), .O(z14));
  inv1   g453(.a(x31), .O(new_n555_));
  nand2  g454(.a(x71), .b(x47), .O(new_n556_));
  oai21  g455(.a(new_n187_), .b(new_n555_), .c(new_n556_), .O(new_n557_));
  nand2  g456(.a(new_n557_), .b(x70), .O(new_n558_));
  nand2  g457(.a(new_n190_), .b(x15), .O(new_n559_));
  nand3  g458(.a(new_n192_), .b(x69), .c(x63), .O(new_n560_));
  nand3  g459(.a(new_n560_), .b(new_n559_), .c(new_n558_), .O(new_n561_));
  and2   g460(.a(new_n561_), .b(x67), .O(new_n562_));
  nand2  g461(.a(x74), .b(x28), .O(new_n563_));
  nand2  g462(.a(new_n133_), .b(x29), .O(new_n564_));
  aoi21  g463(.a(new_n564_), .b(new_n563_), .c(new_n131_), .O(new_n565_));
  nand3  g464(.a(x74), .b(new_n131_), .c(x30), .O(new_n566_));
  inv1   g465(.a(new_n566_), .O(new_n567_));
  oai21  g466(.a(new_n567_), .b(new_n565_), .c(new_n130_), .O(new_n568_));
  nand2  g467(.a(new_n141_), .b(x31), .O(new_n569_));
  nand2  g468(.a(x74), .b(x26), .O(new_n570_));
  nand2  g469(.a(new_n133_), .b(x27), .O(new_n571_));
  aoi21  g470(.a(new_n571_), .b(new_n570_), .c(x73), .O(new_n572_));
  nand3  g471(.a(new_n133_), .b(x73), .c(x23), .O(new_n573_));
  inv1   g472(.a(new_n573_), .O(new_n574_));
  oai21  g473(.a(new_n574_), .b(new_n572_), .c(x72), .O(new_n575_));
  nand3  g474(.a(new_n575_), .b(new_n569_), .c(new_n568_), .O(new_n576_));
  nand2  g475(.a(new_n576_), .b(new_n157_), .O(new_n577_));
  nand2  g476(.a(x74), .b(x60), .O(new_n578_));
  nand2  g477(.a(new_n133_), .b(x61), .O(new_n579_));
  aoi21  g478(.a(new_n579_), .b(new_n578_), .c(new_n131_), .O(new_n580_));
  nand3  g479(.a(x74), .b(new_n131_), .c(x62), .O(new_n581_));
  inv1   g480(.a(new_n581_), .O(new_n582_));
  oai21  g481(.a(new_n582_), .b(new_n580_), .c(new_n130_), .O(new_n583_));
  nand2  g482(.a(new_n141_), .b(x63), .O(new_n584_));
  nand2  g483(.a(x74), .b(x58), .O(new_n585_));
  nand2  g484(.a(new_n133_), .b(x59), .O(new_n586_));
  aoi21  g485(.a(new_n586_), .b(new_n585_), .c(x73), .O(new_n587_));
  nand3  g486(.a(new_n133_), .b(x73), .c(x55), .O(new_n588_));
  inv1   g487(.a(new_n588_), .O(new_n589_));
  oai21  g488(.a(new_n589_), .b(new_n587_), .c(x72), .O(new_n590_));
  nand3  g489(.a(new_n590_), .b(new_n584_), .c(new_n583_), .O(new_n591_));
  nand2  g490(.a(new_n591_), .b(new_n173_), .O(new_n592_));
  aoi21  g491(.a(new_n592_), .b(new_n577_), .c(new_n295_), .O(new_n593_));
  oai21  g492(.a(new_n593_), .b(new_n562_), .c(new_n185_), .O(new_n594_));
  nand2  g493(.a(new_n561_), .b(new_n206_), .O(new_n595_));
  aoi21  g494(.a(new_n595_), .b(new_n594_), .c(new_n211_), .O(new_n596_));
  inv1   g495(.a(new_n102_), .O(new_n597_));
  nand4  g496(.a(new_n597_), .b(x69), .c(x65), .d(new_n101_), .O(new_n598_));
  aoi21  g497(.a(new_n592_), .b(new_n577_), .c(new_n598_), .O(new_n599_));
  oai21  g498(.a(new_n599_), .b(new_n596_), .c(new_n153_), .O(new_n600_));
  nand3  g499(.a(x71), .b(new_n176_), .c(x15), .O(new_n601_));
  inv1   g500(.a(new_n601_), .O(new_n602_));
  aoi21  g501(.a(new_n591_), .b(new_n235_), .c(new_n602_), .O(new_n603_));
  nand3  g502(.a(new_n127_), .b(new_n176_), .c(x47), .O(new_n604_));
  oai21  g503(.a(new_n603_), .b(x70), .c(new_n604_), .O(new_n605_));
  aoi22  g504(.a(new_n127_), .b(x47), .c(new_n114_), .d(x15), .O(new_n606_));
  nand2  g505(.a(new_n181_), .b(new_n180_), .O(new_n607_));
  nor2   g506(.a(new_n607_), .b(new_n606_), .O(new_n608_));
  aoi21  g507(.a(new_n605_), .b(new_n597_), .c(new_n608_), .O(new_n609_));
  nor2   g508(.a(new_n180_), .b(x66), .O(new_n610_));
  oai21  g509(.a(new_n610_), .b(new_n206_), .c(x47), .O(new_n611_));
  nand2  g510(.a(new_n591_), .b(new_n102_), .O(new_n612_));
  nand2  g511(.a(new_n612_), .b(new_n611_), .O(new_n613_));
  nand3  g512(.a(new_n613_), .b(new_n210_), .c(new_n192_), .O(new_n614_));
  oai21  g513(.a(new_n609_), .b(x64), .c(new_n614_), .O(new_n615_));
  nand2  g514(.a(new_n615_), .b(new_n154_), .O(new_n616_));
  nand2  g515(.a(new_n616_), .b(new_n600_), .O(z15));
  zero   g516(.O(z00));
  zero   g517(.O(z01));
  zero   g518(.O(z02));
  zero   g519(.O(z03));
