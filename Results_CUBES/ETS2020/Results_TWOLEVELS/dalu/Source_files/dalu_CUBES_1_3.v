// Benchmark "FAU" written by ABC on Sun Aug  2 10:36:52 2020
...
module FAU ( 
  ...
  nor2   g0957(.a(x45), .b(new_n111_), .O(new_n1049_));
  oai21  g0958(.a(x47), .b(x46), .c(new_n1049_), .O(new_n1050_));
  ...
  oai22  g0990(.a(new_n154_), .b(new_n1081_), .c(new_n116_), .d(new_n1082_), .O(new_n1083_));
  nand2  g0991(.a(new_n1083_), .b(x70), .O(new_n1084_));
  nand2  g0992(.a(new_n157_), .b(x15), .O(new_n1085_));
  nand3  g0993(.a(new_n126_), .b(x69), .c(x63), .O(new_n1086_));
  ...
  aoi21  g1003(.a(new_n1027_), .b(new_n1026_), .c(x73), .O(new_n1096_));
  nand2  g1004(.a(new_n765_), .b(x23), .O(new_n1097_));
  ...
  nand2  g1008(.a(new_n1100_), .b(new_n141_), .O(new_n1101_));
  ...
  aoi21  g1016(.a(new_n1013_), .b(new_n1012_), .c(x73), .O(new_n1109_));
  nand2  g1017(.a(new_n765_), .b(x55), .O(new_n1110_));
  ...
  nand2  g1021(.a(new_n1113_), .b(new_n142_), .O(new_n1114_));
  aoi21  g1022(.a(new_n1114_), .b(new_n1101_), .c(new_n833_), .O(new_n1115_));
  oai21  g1023(.a(new_n1115_), .b(new_n1088_), .c(new_n149_), .O(new_n1116_));
  nand2  g1024(.a(new_n1087_), .b(new_n150_), .O(new_n1117_));
  ...
  oai21  g1028(.a(new_n1120_), .b(new_n1118_), .c(new_n137_), .O(new_n1121_));
  nand3  g1029(.a(x71), .b(new_n132_), .c(x15), .O(new_n1122_));
  inv1   g1030(.a(new_n1122_), .O(new_n1123_));
  aoi21  g1031(.a(new_n1113_), .b(new_n777_), .c(new_n1123_), .O(new_n1124_));
  nand3  g1032(.a(new_n188_), .b(new_n132_), .c(x47), .O(new_n1125_));
  oai21  g1033(.a(new_n1124_), .b(x70), .c(new_n1125_), .O(new_n1126_));
  nand2  g1034(.a(new_n174_), .b(x15), .O(new_n1127_));
  nand2  g1035(.a(new_n188_), .b(x47), .O(new_n1128_));
  aoi21  g1036(.a(new_n1128_), .b(new_n1127_), .c(new_n134_), .O(new_n1129_));
  aoi21  g1037(.a(new_n1126_), .b(new_n94_), .c(new_n1129_), .O(new_n1130_));
  nand2  g1038(.a(new_n1113_), .b(new_n93_), .O(new_n1131_));
  oai21  g1039(.a(new_n151_), .b(new_n1082_), .c(new_n1131_), .O(new_n1132_));
  nand3  g1040(.a(new_n1132_), .b(new_n171_), .c(new_n126_), .O(new_n1133_));
  oai21  g1041(.a(new_n1130_), .b(x64), .c(new_n1133_), .O(new_n1134_));
  nand2  g1042(.a(new_n1134_), .b(new_n138_), .O(new_n1135_));
