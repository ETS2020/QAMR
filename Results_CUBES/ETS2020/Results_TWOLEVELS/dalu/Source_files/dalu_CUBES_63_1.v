// Benchmark "FAU" written by ABC on Sun Aug  2 11:10:05 2020
...
module FAU ( 
  ...
  inv1   g175(.a(x13), .O(new_n268_));
  nor2   g176(.a(x12), .b(x11), .O(new_n269_));
  nand4  g177(.a(new_n269_), .b(new_n96_), .c(new_n268_), .d(new_n267_), .O(new_n270_));
  ...
  inv1   g187(.a(x45), .O(new_n280_));
  nor2   g188(.a(x44), .b(x43), .O(new_n281_));
  nand4  g189(.a(new_n281_), .b(new_n116_), .c(new_n280_), .d(new_n279_), .O(new_n282_));
  ...
  nand3  g625(.a(new_n269_), .b(new_n96_), .c(new_n268_), .O(new_n718_));
  ...
  nand3  g662(.a(new_n163_), .b(x71), .c(x69), .O(new_n755_));
  inv1   g663(.a(new_n755_), .O(new_n756_));
  and2   g664(.a(new_n756_), .b(new_n754_), .O(new_n757_));
  ...
  inv1   g678(.a(new_n116_), .O(new_n771_));
  nor2   g679(.a(new_n771_), .b(x45), .O(new_n772_));
  aoi21  g680(.a(new_n281_), .b(new_n772_), .c(new_n127_), .O(new_n773_));
  nand2  g681(.a(new_n281_), .b(new_n772_), .O(new_n774_));
  nand3  g682(.a(new_n774_), .b(new_n279_), .c(x32), .O(new_n775_));
  oai21  g683(.a(new_n773_), .b(new_n279_), .c(new_n775_), .O(new_n776_));
  nand3  g684(.a(new_n169_), .b(x68), .c(new_n136_), .O(new_n777_));
  inv1   g685(.a(new_n777_), .O(new_n778_));
  nand3  g686(.a(new_n778_), .b(new_n776_), .c(new_n131_), .O(new_n779_));
  nand2  g687(.a(new_n779_), .b(new_n770_), .O(new_n780_));
  nand2  g688(.a(new_n780_), .b(x70), .O(new_n781_));
  aoi21  g689(.a(new_n781_), .b(new_n758_), .c(new_n93_), .O(new_n782_));
  nand2  g690(.a(new_n722_), .b(new_n111_), .O(new_n783_));
  nand3  g691(.a(new_n776_), .b(new_n131_), .c(x70), .O(new_n784_));
  aoi21  g692(.a(new_n784_), .b(new_n783_), .c(new_n171_), .O(new_n785_));
  oai21  g693(.a(new_n785_), .b(new_n782_), .c(new_n203_), .O(new_n786_));
  oai22  g694(.a(new_n176_), .b(new_n762_), .c(new_n131_), .d(new_n279_), .O(new_n787_));
  ...
  nand2  g700(.a(new_n754_), .b(new_n158_), .O(new_n793_));
  nand2  g701(.a(new_n738_), .b(new_n159_), .O(new_n794_));
  ...
  nand2  g705(.a(new_n738_), .b(new_n168_), .O(new_n798_));
  ...
  aoi21  g711(.a(new_n803_), .b(new_n802_), .c(new_n191_), .O(new_n804_));
  oai21  g712(.a(new_n804_), .b(new_n801_), .c(new_n204_), .O(new_n805_));
  nand2  g713(.a(new_n805_), .b(new_n786_), .O(z10));
  oai21  g714(.a(new_n444_), .b(new_n107_), .c(x11), .O(new_n807_));
  nand3  g715(.a(new_n368_), .b(new_n95_), .c(x00), .O(new_n808_));
  ...
  nand2  g719(.a(new_n670_), .b(new_n669_), .O(new_n812_));
  nand2  g720(.a(new_n812_), .b(new_n146_), .O(new_n813_));
  nand2  g721(.a(new_n727_), .b(x51), .O(new_n814_));
  ...
  and2   g747(.a(new_n839_), .b(new_n756_), .O(new_n840_));
  oai21  g748(.a(new_n840_), .b(new_n826_), .c(new_n111_), .O(new_n841_));
  aoi21  g749(.a(new_n830_), .b(new_n829_), .c(new_n137_), .O(new_n842_));
  aoi21  g750(.a(new_n836_), .b(new_n835_), .c(x72), .O(new_n843_));
  ...
  aoi21  g756(.a(new_n814_), .b(new_n813_), .c(new_n137_), .O(new_n849_));
  aoi21  g757(.a(new_n821_), .b(new_n820_), .c(x72), .O(new_n850_));
  ...
  nand2  g764(.a(new_n856_), .b(new_n778_), .O(new_n857_));
  ...
  nand2  g768(.a(new_n809_), .b(new_n111_), .O(new_n861_));
  ...
  nand2  g778(.a(new_n839_), .b(new_n158_), .O(new_n871_));
  nand2  g779(.a(new_n824_), .b(new_n159_), .O(new_n872_));
  aoi21  g780(.a(new_n872_), .b(new_n871_), .c(new_n795_), .O(new_n873_));
  oai21  g781(.a(new_n873_), .b(new_n870_), .c(new_n153_), .O(new_n874_));
  nand2  g782(.a(new_n824_), .b(new_n168_), .O(new_n875_));
  ...
  nand2  g791(.a(new_n96_), .b(new_n268_), .O(new_n884_));
  nand2  g792(.a(new_n884_), .b(x00), .O(new_n885_));
  nand2  g793(.a(new_n885_), .b(x12), .O(new_n886_));
  nor2   g794(.a(x12), .b(new_n107_), .O(new_n887_));
  nand2  g795(.a(new_n887_), .b(new_n884_), .O(new_n888_));
  aoi21  g796(.a(new_n888_), .b(new_n886_), .c(new_n131_), .O(new_n889_));
  nand2  g797(.a(new_n889_), .b(new_n136_), .O(new_n890_));
  nand2  g798(.a(new_n141_), .b(x60), .O(new_n891_));
  nand2  g799(.a(new_n733_), .b(new_n146_), .O(new_n892_));
  nand2  g800(.a(new_n727_), .b(x52), .O(new_n893_));
  ...
  and2   g825(.a(new_n917_), .b(new_n756_), .O(new_n918_));
  oai21  g826(.a(new_n918_), .b(new_n905_), .c(new_n111_), .O(new_n919_));
  aoi21  g827(.a(new_n908_), .b(new_n907_), .c(new_n137_), .O(new_n920_));
  aoi21  g828(.a(new_n914_), .b(new_n913_), .c(x72), .O(new_n921_));
  ...
  aoi21  g834(.a(new_n893_), .b(new_n892_), .c(new_n137_), .O(new_n927_));
  aoi21  g835(.a(new_n900_), .b(new_n899_), .c(x72), .O(new_n928_));
  ...
  oai21  g839(.a(new_n772_), .b(new_n127_), .c(x44), .O(new_n932_));
  inv1   g840(.a(x44), .O(new_n933_));
  inv1   g841(.a(new_n772_), .O(new_n934_));
  nand3  g842(.a(new_n934_), .b(new_n933_), .c(x32), .O(new_n935_));
  aoi21  g843(.a(new_n935_), .b(new_n932_), .c(x71), .O(new_n936_));
  nand2  g844(.a(new_n936_), .b(new_n778_), .O(new_n937_));
  ...
  nand2  g848(.a(new_n889_), .b(new_n111_), .O(new_n941_));
  ...
  nand2  g858(.a(new_n917_), .b(new_n158_), .O(new_n951_));
  nand2  g859(.a(new_n903_), .b(new_n159_), .O(new_n952_));
  aoi21  g860(.a(new_n952_), .b(new_n951_), .c(new_n795_), .O(new_n953_));
  oai21  g861(.a(new_n953_), .b(new_n950_), .c(new_n153_), .O(new_n954_));
  nand2  g862(.a(new_n903_), .b(new_n168_), .O(new_n955_));
  ...
  inv1   g871(.a(new_n96_), .O(new_n964_));
  nand3  g872(.a(new_n964_), .b(new_n268_), .c(x00), .O(new_n965_));
  oai21  g873(.a(new_n96_), .b(new_n107_), .c(x13), .O(new_n966_));
  aoi21  g874(.a(new_n966_), .b(new_n965_), .c(new_n131_), .O(new_n967_));
  nand2  g875(.a(new_n967_), .b(new_n136_), .O(new_n968_));
  inv1   g876(.a(new_n968_), .O(new_n969_));
  nand2  g877(.a(new_n141_), .b(x61), .O(new_n970_));
  nand2  g878(.a(new_n819_), .b(new_n146_), .O(new_n971_));
  nand2  g879(.a(new_n727_), .b(x53), .O(new_n972_));
  nand2  g880(.a(new_n972_), .b(new_n971_), .O(new_n973_));
  nand2  g881(.a(new_n973_), .b(x72), .O(new_n974_));
  inv1   g882(.a(x59), .O(new_n975_));
  nand2  g883(.a(x74), .b(x58), .O(new_n976_));
  oai21  g884(.a(x74), .b(new_n975_), .c(new_n976_), .O(new_n977_));
  nand2  g885(.a(new_n977_), .b(x73), .O(new_n978_));
  nand2  g886(.a(new_n228_), .b(x60), .O(new_n979_));
  nand2  g887(.a(new_n979_), .b(new_n978_), .O(new_n980_));
  nand2  g888(.a(new_n980_), .b(new_n137_), .O(new_n981_));
  nand3  g889(.a(new_n981_), .b(new_n974_), .c(new_n970_), .O(new_n982_));
  aoi21  g890(.a(new_n982_), .b(new_n739_), .c(new_n969_), .O(new_n983_));
  nand2  g891(.a(new_n141_), .b(x29), .O(new_n984_));
  nand2  g892(.a(new_n834_), .b(new_n146_), .O(new_n985_));
  nand2  g893(.a(new_n727_), .b(x21), .O(new_n986_));
  nand2  g894(.a(new_n986_), .b(new_n985_), .O(new_n987_));
  nand2  g895(.a(new_n987_), .b(x72), .O(new_n988_));
  nand2  g896(.a(x74), .b(x26), .O(new_n989_));
  oai21  g897(.a(x74), .b(new_n845_), .c(new_n989_), .O(new_n990_));
  nand2  g898(.a(new_n990_), .b(x73), .O(new_n991_));
  nand2  g899(.a(new_n228_), .b(x28), .O(new_n992_));
  nand2  g900(.a(new_n992_), .b(new_n991_), .O(new_n993_));
  nand2  g901(.a(new_n993_), .b(new_n137_), .O(new_n994_));
  nand3  g902(.a(new_n994_), .b(new_n988_), .c(new_n984_), .O(new_n995_));
  nand2  g903(.a(new_n995_), .b(new_n756_), .O(new_n996_));
  oai21  g904(.a(new_n983_), .b(new_n155_), .c(new_n996_), .O(new_n997_));
  nand2  g905(.a(new_n997_), .b(new_n111_), .O(new_n998_));
  aoi21  g906(.a(new_n986_), .b(new_n985_), .c(new_n137_), .O(new_n999_));
  aoi21  g907(.a(new_n992_), .b(new_n991_), .c(x72), .O(new_n1000_));
  oai21  g908(.a(new_n1000_), .b(new_n999_), .c(new_n131_), .O(new_n1001_));
  inv1   g909(.a(x29), .O(new_n1002_));
  nand2  g910(.a(x71), .b(x61), .O(new_n1003_));
  oai21  g911(.a(x71), .b(new_n1002_), .c(new_n1003_), .O(new_n1004_));
  nand2  g912(.a(new_n1004_), .b(new_n141_), .O(new_n1005_));
  aoi21  g913(.a(new_n972_), .b(new_n971_), .c(new_n137_), .O(new_n1006_));
  aoi21  g914(.a(new_n979_), .b(new_n978_), .c(x72), .O(new_n1007_));
  oai21  g915(.a(new_n1007_), .b(new_n1006_), .c(x71), .O(new_n1008_));
  nand3  g916(.a(new_n1008_), .b(new_n1005_), .c(new_n1001_), .O(new_n1009_));
  nand2  g917(.a(new_n1009_), .b(new_n165_), .O(new_n1010_));
  nand3  g918(.a(new_n771_), .b(new_n280_), .c(x32), .O(new_n1011_));
  oai21  g919(.a(new_n116_), .b(new_n127_), .c(x45), .O(new_n1012_));
  aoi21  g920(.a(new_n1012_), .b(new_n1011_), .c(x71), .O(new_n1013_));
  nand2  g921(.a(new_n1013_), .b(new_n778_), .O(new_n1014_));
  nand2  g922(.a(new_n1014_), .b(new_n1010_), .O(new_n1015_));
  nand2  g923(.a(new_n1015_), .b(x70), .O(new_n1016_));
  aoi21  g924(.a(new_n1016_), .b(new_n998_), .c(new_n93_), .O(new_n1017_));
  nand2  g925(.a(new_n967_), .b(new_n111_), .O(new_n1018_));
  nand2  g926(.a(new_n1013_), .b(x70), .O(new_n1019_));
  aoi21  g927(.a(new_n1019_), .b(new_n1018_), .c(new_n171_), .O(new_n1020_));
  oai21  g928(.a(new_n1020_), .b(new_n1017_), .c(new_n203_), .O(new_n1021_));
  oai22  g929(.a(new_n176_), .b(new_n1002_), .c(new_n131_), .d(new_n280_), .O(new_n1022_));
  nand2  g930(.a(new_n1022_), .b(x70), .O(new_n1023_));
  nand2  g931(.a(new_n179_), .b(x13), .O(new_n1024_));
  nand3  g932(.a(new_n181_), .b(x69), .c(x61), .O(new_n1025_));
  nand3  g933(.a(new_n1025_), .b(new_n1024_), .c(new_n1023_), .O(new_n1026_));
  and2   g934(.a(new_n1026_), .b(x67), .O(new_n1027_));
  nand2  g935(.a(new_n995_), .b(new_n158_), .O(new_n1028_));
  nand2  g936(.a(new_n982_), .b(new_n159_), .O(new_n1029_));
  aoi21  g937(.a(new_n1029_), .b(new_n1028_), .c(new_n795_), .O(new_n1030_));
  oai21  g938(.a(new_n1030_), .b(new_n1027_), .c(new_n153_), .O(new_n1031_));
  nand2  g939(.a(new_n982_), .b(new_n168_), .O(new_n1032_));
  oai21  g940(.a(new_n168_), .b(new_n280_), .c(new_n1032_), .O(new_n1033_));
  nand2  g941(.a(new_n1033_), .b(new_n327_), .O(new_n1034_));
  aoi21  g942(.a(new_n1034_), .b(new_n1031_), .c(x66), .O(new_n1035_));
  nand2  g943(.a(new_n1026_), .b(new_n153_), .O(new_n1036_));
  nand3  g944(.a(new_n186_), .b(x68), .c(x45), .O(new_n1037_));
  aoi21  g945(.a(new_n1037_), .b(new_n1036_), .c(new_n191_), .O(new_n1038_));
  oai21  g946(.a(new_n1038_), .b(new_n1035_), .c(new_n204_), .O(new_n1039_));
  nand2  g947(.a(new_n1039_), .b(new_n1021_), .O(z13));
  zero   g948(.O(z00));
  zero   g949(.O(z14));
  zero   g950(.O(z15));
endmodule
