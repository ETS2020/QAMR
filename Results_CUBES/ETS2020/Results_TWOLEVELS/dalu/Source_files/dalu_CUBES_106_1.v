// Benchmark "FAU" written by ABC on Sun Aug  2 11:31:47 2020
...
module FAU ( 
  ...
  nor2   g609(.a(x74), .b(new_n212_), .O(new_n702_));
  ...
  oai21  g689(.a(new_n477_), .b(new_n96_), .c(x11), .O(new_n782_));
  nand3  g690(.a(new_n404_), .b(new_n176_), .c(x00), .O(new_n783_));
  ...
  nand2  g698(.a(new_n702_), .b(x51), .O(new_n791_));
  ...
  nand2  g709(.a(new_n801_), .b(new_n714_), .O(new_n802_));
  ...
  oai21  g713(.a(x74), .b(new_n613_), .c(new_n805_), .O(new_n806_));
  nand2  g714(.a(new_n806_), .b(new_n212_), .O(new_n807_));
  nand2  g715(.a(new_n702_), .b(x19), .O(new_n808_));
  ...
  nor2   g727(.a(new_n819_), .b(new_n731_), .O(new_n820_));
  ...
  oai21  g741(.a(new_n485_), .b(new_n112_), .c(x43), .O(new_n834_));
  nand3  g742(.a(new_n411_), .b(new_n189_), .c(x32), .O(new_n835_));
  ...
  nand2  g764(.a(new_n856_), .b(new_n362_), .O(new_n857_));
  ...
  aoi21  g768(.a(new_n860_), .b(new_n859_), .c(new_n367_), .O(new_n861_));
  oai21  g769(.a(new_n861_), .b(new_n858_), .c(new_n173_), .O(new_n862_));
  nand2  g770(.a(new_n862_), .b(new_n844_), .O(z11));
  oai21  g771(.a(new_n309_), .b(new_n96_), .c(x12), .O(new_n864_));
  inv1   g772(.a(new_n309_), .O(new_n865_));
  nor2   g773(.a(x12), .b(new_n96_), .O(new_n866_));
  nand2  g774(.a(new_n866_), .b(new_n865_), .O(new_n867_));
  aoi21  g775(.a(new_n867_), .b(new_n864_), .c(new_n116_), .O(new_n868_));
  nand2  g776(.a(new_n868_), .b(new_n134_), .O(new_n869_));
  nand2  g777(.a(new_n207_), .b(x60), .O(new_n870_));
  nand2  g778(.a(new_n708_), .b(new_n212_), .O(new_n871_));
  nand2  g779(.a(new_n702_), .b(x52), .O(new_n872_));
  nand2  g780(.a(new_n872_), .b(new_n871_), .O(new_n873_));
  nand2  g781(.a(new_n873_), .b(x72), .O(new_n874_));
  inv1   g782(.a(x58), .O(new_n875_));
  nand2  g783(.a(x74), .b(x57), .O(new_n876_));
  oai21  g784(.a(x74), .b(new_n875_), .c(new_n876_), .O(new_n877_));
  nand2  g785(.a(new_n877_), .b(x73), .O(new_n878_));
  nand2  g786(.a(new_n268_), .b(x59), .O(new_n879_));
  nand2  g787(.a(new_n879_), .b(new_n878_), .O(new_n880_));
  nand2  g788(.a(new_n880_), .b(new_n203_), .O(new_n881_));
  nand3  g789(.a(new_n881_), .b(new_n874_), .c(new_n870_), .O(new_n882_));
  nand2  g790(.a(new_n882_), .b(new_n714_), .O(new_n883_));
  aoi21  g791(.a(new_n883_), .b(new_n869_), .c(new_n141_), .O(new_n884_));
  nand2  g792(.a(new_n207_), .b(x28), .O(new_n885_));
  nand2  g793(.a(new_n724_), .b(new_n212_), .O(new_n886_));
  nand2  g794(.a(new_n702_), .b(x20), .O(new_n887_));
  nand2  g795(.a(new_n887_), .b(new_n886_), .O(new_n888_));
  nand2  g796(.a(new_n888_), .b(x72), .O(new_n889_));
  nand2  g797(.a(x74), .b(x25), .O(new_n890_));
  oai21  g798(.a(x74), .b(new_n737_), .c(new_n890_), .O(new_n891_));
  nand2  g799(.a(new_n891_), .b(x73), .O(new_n892_));
  nand2  g800(.a(new_n268_), .b(x27), .O(new_n893_));
  nand2  g801(.a(new_n893_), .b(new_n892_), .O(new_n894_));
  nand2  g802(.a(new_n894_), .b(new_n203_), .O(new_n895_));
  nand3  g803(.a(new_n895_), .b(new_n889_), .c(new_n885_), .O(new_n896_));
  inv1   g804(.a(new_n896_), .O(new_n897_));
  nor2   g805(.a(new_n897_), .b(new_n731_), .O(new_n898_));
  oai21  g806(.a(new_n898_), .b(new_n884_), .c(new_n100_), .O(new_n899_));
  aoi21  g807(.a(new_n887_), .b(new_n886_), .c(new_n203_), .O(new_n900_));
  aoi21  g808(.a(new_n893_), .b(new_n892_), .c(x72), .O(new_n901_));
  ...
  aoi21  g814(.a(new_n872_), .b(new_n871_), .c(new_n203_), .O(new_n907_));
  aoi21  g815(.a(new_n879_), .b(new_n878_), .c(x72), .O(new_n908_));
  ...
  oai21  g819(.a(new_n319_), .b(new_n112_), .c(x44), .O(new_n912_));
  inv1   g820(.a(x44), .O(new_n913_));
  inv1   g821(.a(new_n319_), .O(new_n914_));
  nand3  g822(.a(new_n914_), .b(new_n913_), .c(x32), .O(new_n915_));
  aoi21  g823(.a(new_n915_), .b(new_n912_), .c(x71), .O(new_n916_));
  nand2  g824(.a(new_n916_), .b(new_n753_), .O(new_n917_));
  ...
  nand2  g828(.a(new_n868_), .b(new_n100_), .O(new_n921_));
  ...
  oai22  g832(.a(new_n156_), .b(new_n903_), .c(new_n116_), .d(new_n913_), .O(new_n925_));
  nand2  g833(.a(new_n925_), .b(x70), .O(new_n926_));
  nand2  g834(.a(new_n159_), .b(x12), .O(new_n927_));
  nand3  g835(.a(new_n128_), .b(x69), .c(x60), .O(new_n928_));
  nand3  g836(.a(new_n928_), .b(new_n927_), .c(new_n926_), .O(new_n929_));
  and2   g837(.a(new_n929_), .b(x67), .O(new_n930_));
  nand2  g838(.a(new_n896_), .b(new_n143_), .O(new_n931_));
  nand2  g839(.a(new_n882_), .b(new_n144_), .O(new_n932_));
  aoi21  g840(.a(new_n932_), .b(new_n931_), .c(new_n770_), .O(new_n933_));
  oai21  g841(.a(new_n933_), .b(new_n930_), .c(new_n139_), .O(new_n934_));
  nand2  g842(.a(new_n882_), .b(new_n133_), .O(new_n935_));
  oai21  g843(.a(new_n133_), .b(new_n913_), .c(new_n935_), .O(new_n936_));
  nand2  g844(.a(new_n936_), .b(new_n362_), .O(new_n937_));
  aoi21  g845(.a(new_n937_), .b(new_n934_), .c(x66), .O(new_n938_));
  nand2  g846(.a(new_n929_), .b(new_n139_), .O(new_n939_));
  nand3  g847(.a(new_n165_), .b(x68), .c(x44), .O(new_n940_));
  aoi21  g848(.a(new_n940_), .b(new_n939_), .c(new_n367_), .O(new_n941_));
  oai21  g849(.a(new_n941_), .b(new_n938_), .c(new_n173_), .O(new_n942_));
  nand2  g850(.a(new_n942_), .b(new_n924_), .O(z12));
  inv1   g851(.a(x31), .O(new_n946_));
  inv1   g852(.a(x47), .O(new_n947_));
  oai22  g853(.a(new_n156_), .b(new_n946_), .c(new_n116_), .d(new_n947_), .O(new_n948_));
  nand2  g854(.a(new_n948_), .b(x70), .O(new_n949_));
  nand2  g855(.a(new_n159_), .b(x15), .O(new_n950_));
  nand3  g856(.a(new_n128_), .b(x69), .c(x63), .O(new_n951_));
  nand3  g857(.a(new_n951_), .b(new_n950_), .c(new_n949_), .O(new_n952_));
  and2   g858(.a(new_n952_), .b(x67), .O(new_n953_));
  nand2  g859(.a(x74), .b(x28), .O(new_n954_));
  nand2  g860(.a(new_n209_), .b(x29), .O(new_n955_));
  aoi21  g861(.a(new_n955_), .b(new_n954_), .c(new_n212_), .O(new_n956_));
  nand2  g862(.a(new_n268_), .b(x30), .O(new_n957_));
  inv1   g863(.a(new_n957_), .O(new_n958_));
  oai21  g864(.a(new_n958_), .b(new_n956_), .c(new_n203_), .O(new_n959_));
  nand2  g865(.a(new_n207_), .b(x31), .O(new_n960_));
  nand2  g866(.a(x74), .b(x26), .O(new_n961_));
  nand2  g867(.a(new_n209_), .b(x27), .O(new_n962_));
  aoi21  g868(.a(new_n962_), .b(new_n961_), .c(x73), .O(new_n963_));
  nand2  g869(.a(new_n702_), .b(x23), .O(new_n964_));
  inv1   g870(.a(new_n964_), .O(new_n965_));
  oai21  g871(.a(new_n965_), .b(new_n963_), .c(x72), .O(new_n966_));
  nand3  g872(.a(new_n966_), .b(new_n960_), .c(new_n959_), .O(new_n967_));
  nand2  g873(.a(new_n967_), .b(new_n143_), .O(new_n968_));
  nand2  g874(.a(x74), .b(x60), .O(new_n969_));
  nand2  g875(.a(new_n209_), .b(x61), .O(new_n970_));
  aoi21  g876(.a(new_n970_), .b(new_n969_), .c(new_n212_), .O(new_n971_));
  nand2  g877(.a(new_n268_), .b(x62), .O(new_n972_));
  inv1   g878(.a(new_n972_), .O(new_n973_));
  oai21  g879(.a(new_n973_), .b(new_n971_), .c(new_n203_), .O(new_n974_));
  nand2  g880(.a(new_n207_), .b(x63), .O(new_n975_));
  nand2  g881(.a(x74), .b(x58), .O(new_n976_));
  nand2  g882(.a(new_n209_), .b(x59), .O(new_n977_));
  aoi21  g883(.a(new_n977_), .b(new_n976_), .c(x73), .O(new_n978_));
  nand2  g884(.a(new_n702_), .b(x55), .O(new_n979_));
  inv1   g885(.a(new_n979_), .O(new_n980_));
  oai21  g886(.a(new_n980_), .b(new_n978_), .c(x72), .O(new_n981_));
  nand3  g887(.a(new_n981_), .b(new_n975_), .c(new_n974_), .O(new_n982_));
  nand2  g888(.a(new_n982_), .b(new_n144_), .O(new_n983_));
  aoi21  g889(.a(new_n983_), .b(new_n968_), .c(new_n770_), .O(new_n984_));
  oai21  g890(.a(new_n984_), .b(new_n953_), .c(new_n151_), .O(new_n985_));
  nand2  g891(.a(new_n952_), .b(new_n152_), .O(new_n986_));
  aoi21  g892(.a(new_n986_), .b(new_n985_), .c(new_n632_), .O(new_n987_));
  nand4  g893(.a(new_n94_), .b(x69), .c(x65), .d(new_n92_), .O(new_n988_));
  aoi21  g894(.a(new_n983_), .b(new_n968_), .c(new_n988_), .O(new_n989_));
  oai21  g895(.a(new_n989_), .b(new_n987_), .c(new_n139_), .O(new_n990_));
  nand3  g896(.a(x71), .b(new_n134_), .c(x15), .O(new_n991_));
  inv1   g897(.a(new_n991_), .O(new_n992_));
  aoi21  g898(.a(new_n982_), .b(new_n714_), .c(new_n992_), .O(new_n993_));
  nand3  g899(.a(new_n118_), .b(new_n134_), .c(x47), .O(new_n994_));
  oai21  g900(.a(new_n993_), .b(x70), .c(new_n994_), .O(new_n995_));
  nand2  g901(.a(new_n102_), .b(x15), .O(new_n996_));
  nand2  g902(.a(new_n118_), .b(x47), .O(new_n997_));
  aoi21  g903(.a(new_n997_), .b(new_n996_), .c(new_n136_), .O(new_n998_));
  aoi21  g904(.a(new_n995_), .b(new_n94_), .c(new_n998_), .O(new_n999_));
  nand2  g905(.a(new_n982_), .b(new_n93_), .O(new_n1000_));
  oai21  g906(.a(new_n153_), .b(new_n947_), .c(new_n1000_), .O(new_n1001_));
  nand3  g907(.a(new_n1001_), .b(new_n173_), .c(new_n128_), .O(new_n1002_));
  oai21  g908(.a(new_n999_), .b(x64), .c(new_n1002_), .O(new_n1003_));
  nand2  g909(.a(new_n1003_), .b(new_n140_), .O(new_n1004_));
  nand2  g910(.a(new_n1004_), .b(new_n990_), .O(z15));
  zero   g911(.O(z09));
  zero   g912(.O(z13));
  zero   g913(.O(z14));
endmodule
