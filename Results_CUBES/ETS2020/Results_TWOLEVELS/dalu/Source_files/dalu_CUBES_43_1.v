// Benchmark "FAU" written by ABC on Sun Aug  2 10:59:18 2020
...
module FAU ( 
  ...
  inv1   g0953(.a(x31), .O(new_n1047_));
  oai22  g0954(.a(new_n176_), .b(new_n1047_), .c(new_n131_), .d(new_n773_), .O(new_n1048_));
  nand2  g0955(.a(new_n1048_), .b(x70), .O(new_n1049_));
  nand2  g0956(.a(new_n179_), .b(x15), .O(new_n1050_));
  nand3  g0957(.a(new_n181_), .b(x69), .c(x63), .O(new_n1051_));
  nand3  g0958(.a(new_n1051_), .b(new_n1050_), .c(new_n1049_), .O(new_n1052_));
  and2   g0959(.a(new_n1052_), .b(x67), .O(new_n1053_));
  nand2  g0960(.a(x74), .b(x28), .O(new_n1054_));
  nand2  g0961(.a(new_n143_), .b(x29), .O(new_n1055_));
  aoi21  g0962(.a(new_n1055_), .b(new_n1054_), .c(new_n146_), .O(new_n1056_));
  nand2  g0963(.a(new_n228_), .b(x30), .O(new_n1057_));
  inv1   g0964(.a(new_n1057_), .O(new_n1058_));
  oai21  g0965(.a(new_n1058_), .b(new_n1056_), .c(new_n137_), .O(new_n1059_));
  nand2  g0966(.a(new_n141_), .b(x31), .O(new_n1060_));
  aoi21  g0967(.a(new_n994_), .b(new_n993_), .c(x73), .O(new_n1061_));
  nand2  g0968(.a(new_n728_), .b(x23), .O(new_n1062_));
  inv1   g0969(.a(new_n1062_), .O(new_n1063_));
  oai21  g0970(.a(new_n1063_), .b(new_n1061_), .c(x72), .O(new_n1064_));
  nand3  g0971(.a(new_n1064_), .b(new_n1060_), .c(new_n1059_), .O(new_n1065_));
  nand2  g0972(.a(new_n1065_), .b(new_n158_), .O(new_n1066_));
  nand2  g0973(.a(x74), .b(x60), .O(new_n1067_));
  nand2  g0974(.a(new_n143_), .b(x61), .O(new_n1068_));
  aoi21  g0975(.a(new_n1068_), .b(new_n1067_), .c(new_n146_), .O(new_n1069_));
  nand2  g0976(.a(new_n228_), .b(x62), .O(new_n1070_));
  inv1   g0977(.a(new_n1070_), .O(new_n1071_));
  oai21  g0978(.a(new_n1071_), .b(new_n1069_), .c(new_n137_), .O(new_n1072_));
  nand2  g0979(.a(new_n141_), .b(x63), .O(new_n1073_));
  aoi21  g0980(.a(new_n980_), .b(new_n979_), .c(x73), .O(new_n1074_));
  nand2  g0981(.a(new_n728_), .b(x55), .O(new_n1075_));
  inv1   g0982(.a(new_n1075_), .O(new_n1076_));
  oai21  g0983(.a(new_n1076_), .b(new_n1074_), .c(x72), .O(new_n1077_));
  nand3  g0984(.a(new_n1077_), .b(new_n1073_), .c(new_n1072_), .O(new_n1078_));
  nand2  g0985(.a(new_n1078_), .b(new_n159_), .O(new_n1079_));
  aoi21  g0986(.a(new_n1079_), .b(new_n1066_), .c(new_n799_), .O(new_n1080_));
  oai21  g0987(.a(new_n1080_), .b(new_n1053_), .c(new_n189_), .O(new_n1081_));
  nand2  g0988(.a(new_n1052_), .b(new_n190_), .O(new_n1082_));
  aoi21  g0989(.a(new_n1082_), .b(new_n1081_), .c(new_n600_), .O(new_n1083_));
  nand4  g0990(.a(new_n94_), .b(x69), .c(x65), .d(new_n203_), .O(new_n1084_));
  aoi21  g0991(.a(new_n1079_), .b(new_n1066_), .c(new_n1084_), .O(new_n1085_));
  oai21  g0992(.a(new_n1085_), .b(new_n1083_), .c(new_n153_), .O(new_n1086_));
  nand3  g0993(.a(x71), .b(new_n136_), .c(x15), .O(new_n1087_));
  inv1   g0994(.a(new_n1087_), .O(new_n1088_));
  aoi21  g0995(.a(new_n1078_), .b(new_n740_), .c(new_n1088_), .O(new_n1089_));
  nand3  g0996(.a(new_n133_), .b(new_n136_), .c(x47), .O(new_n1090_));
  oai21  g0997(.a(new_n1089_), .b(x70), .c(new_n1090_), .O(new_n1091_));
  nand2  g0998(.a(new_n113_), .b(x15), .O(new_n1092_));
  nand2  g0999(.a(new_n133_), .b(x47), .O(new_n1093_));
  aoi21  g1000(.a(new_n1093_), .b(new_n1092_), .c(new_n387_), .O(new_n1094_));
  aoi21  g1001(.a(new_n1091_), .b(new_n94_), .c(new_n1094_), .O(new_n1095_));
  nand2  g1002(.a(new_n1078_), .b(new_n93_), .O(new_n1096_));
  oai21  g1003(.a(new_n191_), .b(new_n773_), .c(new_n1096_), .O(new_n1097_));
  nand3  g1004(.a(new_n1097_), .b(new_n204_), .c(new_n181_), .O(new_n1098_));
  oai21  g1005(.a(new_n1095_), .b(x64), .c(new_n1098_), .O(new_n1099_));
  nand2  g1006(.a(new_n1099_), .b(new_n154_), .O(new_n1100_));
  nand2  g1007(.a(new_n1100_), .b(new_n1086_), .O(z15));
  zero   g1008(.O(z00));
  zero   g1009(.O(z14));
endmodule
