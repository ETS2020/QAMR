// Benchmark "FAU" written by ABC on Sun Aug  2 12:12:11 2020
...
module FAU ( 
  ...
  oai21  g663(.a(new_n308_), .b(new_n96_), .c(x12), .O(new_n757_));
  inv1   g664(.a(new_n308_), .O(new_n758_));
  nor2   g665(.a(x12), .b(new_n96_), .O(new_n759_));
  nand2  g666(.a(new_n759_), .b(new_n758_), .O(new_n760_));
  aoi21  g667(.a(new_n760_), .b(new_n757_), .c(new_n116_), .O(new_n761_));
  nand2  g668(.a(new_n761_), .b(new_n134_), .O(new_n762_));
  nand2  g669(.a(new_n207_), .b(x60), .O(new_n763_));
  inv1   g670(.a(x56), .O(new_n764_));
  nand2  g671(.a(x74), .b(x55), .O(new_n765_));
  oai21  g672(.a(x74), .b(new_n764_), .c(new_n765_), .O(new_n766_));
  nand2  g673(.a(new_n766_), .b(new_n212_), .O(new_n767_));
  inv1   g674(.a(new_n448_), .O(new_n768_));
  nand2  g675(.a(new_n768_), .b(x52), .O(new_n769_));
  nand2  g676(.a(new_n769_), .b(new_n767_), .O(new_n770_));
  nand2  g677(.a(new_n770_), .b(x72), .O(new_n771_));
  inv1   g678(.a(x58), .O(new_n772_));
  nand2  g679(.a(x74), .b(x57), .O(new_n773_));
  oai21  g680(.a(x74), .b(new_n772_), .c(new_n773_), .O(new_n774_));
  nand2  g681(.a(new_n774_), .b(x73), .O(new_n775_));
  nand2  g682(.a(new_n268_), .b(x59), .O(new_n776_));
  nand2  g683(.a(new_n776_), .b(new_n775_), .O(new_n777_));
  nand2  g684(.a(new_n777_), .b(new_n203_), .O(new_n778_));
  nand3  g685(.a(new_n778_), .b(new_n771_), .c(new_n763_), .O(new_n779_));
  nor2   g686(.a(x71), .b(new_n134_), .O(new_n780_));
  nand2  g687(.a(new_n780_), .b(new_n779_), .O(new_n781_));
  aoi21  g688(.a(new_n781_), .b(new_n762_), .c(new_n141_), .O(new_n782_));
  nand2  g689(.a(new_n207_), .b(x28), .O(new_n783_));
  nand2  g690(.a(x74), .b(x23), .O(new_n784_));
  oai21  g691(.a(x74), .b(new_n678_), .c(new_n784_), .O(new_n785_));
  nand2  g692(.a(new_n785_), .b(new_n212_), .O(new_n786_));
  nand2  g693(.a(new_n768_), .b(x20), .O(new_n787_));
  nand2  g694(.a(new_n787_), .b(new_n786_), .O(new_n788_));
  nand2  g695(.a(new_n788_), .b(x72), .O(new_n789_));
  inv1   g696(.a(x26), .O(new_n790_));
  nand2  g697(.a(x74), .b(x25), .O(new_n791_));
  oai21  g698(.a(x74), .b(new_n790_), .c(new_n791_), .O(new_n792_));
  nand2  g699(.a(new_n792_), .b(x73), .O(new_n793_));
  nand2  g700(.a(new_n268_), .b(x27), .O(new_n794_));
  nand2  g701(.a(new_n794_), .b(new_n793_), .O(new_n795_));
  nand2  g702(.a(new_n795_), .b(new_n203_), .O(new_n796_));
  nand3  g703(.a(new_n796_), .b(new_n789_), .c(new_n783_), .O(new_n797_));
  nand3  g704(.a(new_n146_), .b(x71), .c(x69), .O(new_n798_));
  inv1   g705(.a(new_n798_), .O(new_n799_));
  and2   g706(.a(new_n799_), .b(new_n797_), .O(new_n800_));
  oai21  g707(.a(new_n800_), .b(new_n782_), .c(new_n100_), .O(new_n801_));
  aoi21  g708(.a(new_n787_), .b(new_n786_), .c(new_n203_), .O(new_n802_));
  aoi21  g709(.a(new_n794_), .b(new_n793_), .c(x72), .O(new_n803_));
  oai21  g710(.a(new_n803_), .b(new_n802_), .c(new_n116_), .O(new_n804_));
  inv1   g711(.a(x28), .O(new_n805_));
  nand2  g712(.a(x71), .b(x60), .O(new_n806_));
  oai21  g713(.a(x71), .b(new_n805_), .c(new_n806_), .O(new_n807_));
  nand2  g714(.a(new_n807_), .b(new_n207_), .O(new_n808_));
  aoi21  g715(.a(new_n769_), .b(new_n767_), .c(new_n203_), .O(new_n809_));
  aoi21  g716(.a(new_n776_), .b(new_n775_), .c(x72), .O(new_n810_));
  oai21  g717(.a(new_n810_), .b(new_n809_), .c(x71), .O(new_n811_));
  nand3  g718(.a(new_n811_), .b(new_n808_), .c(new_n804_), .O(new_n812_));
  nand2  g719(.a(new_n812_), .b(new_n219_), .O(new_n813_));
  oai21  g720(.a(new_n319_), .b(new_n112_), .c(x44), .O(new_n814_));
  inv1   g721(.a(x44), .O(new_n815_));
  inv1   g722(.a(new_n319_), .O(new_n816_));
  nand3  g723(.a(new_n816_), .b(new_n815_), .c(x32), .O(new_n817_));
  aoi21  g724(.a(new_n817_), .b(new_n814_), .c(x71), .O(new_n818_));
  nand3  g725(.a(new_n155_), .b(x68), .c(new_n134_), .O(new_n819_));
  inv1   g726(.a(new_n819_), .O(new_n820_));
  nand2  g727(.a(new_n820_), .b(new_n818_), .O(new_n821_));
  nand2  g728(.a(new_n821_), .b(new_n813_), .O(new_n822_));
  nand2  g729(.a(new_n822_), .b(x70), .O(new_n823_));
  aoi21  g730(.a(new_n823_), .b(new_n801_), .c(new_n93_), .O(new_n824_));
  nand2  g731(.a(new_n761_), .b(new_n100_), .O(new_n825_));
  nand2  g732(.a(new_n818_), .b(x70), .O(new_n826_));
  aoi21  g733(.a(new_n826_), .b(new_n825_), .c(new_n226_), .O(new_n827_));
  oai21  g734(.a(new_n827_), .b(new_n824_), .c(new_n92_), .O(new_n828_));
  oai22  g735(.a(new_n156_), .b(new_n805_), .c(new_n116_), .d(new_n815_), .O(new_n829_));
  nand2  g736(.a(new_n829_), .b(x70), .O(new_n830_));
  nand2  g737(.a(new_n159_), .b(x12), .O(new_n831_));
  nand3  g738(.a(new_n128_), .b(x69), .c(x60), .O(new_n832_));
  nand3  g739(.a(new_n832_), .b(new_n831_), .c(new_n830_), .O(new_n833_));
  and2   g740(.a(new_n833_), .b(x67), .O(new_n834_));
  nand2  g741(.a(new_n797_), .b(new_n143_), .O(new_n835_));
  nand2  g742(.a(new_n779_), .b(new_n144_), .O(new_n836_));
  nand2  g743(.a(x69), .b(new_n133_), .O(new_n837_));
  aoi21  g744(.a(new_n836_), .b(new_n835_), .c(new_n837_), .O(new_n838_));
  oai21  g745(.a(new_n838_), .b(new_n834_), .c(new_n139_), .O(new_n839_));
  nand2  g746(.a(new_n779_), .b(new_n133_), .O(new_n840_));
  oai21  g747(.a(new_n133_), .b(new_n815_), .c(new_n840_), .O(new_n841_));
  nand2  g748(.a(new_n841_), .b(new_n365_), .O(new_n842_));
  aoi21  g749(.a(new_n842_), .b(new_n839_), .c(x66), .O(new_n843_));
  nand2  g750(.a(new_n833_), .b(new_n139_), .O(new_n844_));
  nand3  g751(.a(new_n165_), .b(x68), .c(x44), .O(new_n845_));
  aoi21  g752(.a(new_n845_), .b(new_n844_), .c(new_n370_), .O(new_n846_));
  oai21  g753(.a(new_n846_), .b(new_n843_), .c(new_n173_), .O(new_n847_));
  nand2  g754(.a(new_n847_), .b(new_n828_), .O(z12));
  nand2  g755(.a(x15), .b(x00), .O(new_n850_));
  xor2a  g756(.a(new_n850_), .b(x14), .O(new_n851_));
  nor2   g757(.a(new_n851_), .b(new_n116_), .O(new_n852_));
  nand2  g758(.a(new_n852_), .b(new_n134_), .O(new_n853_));
  inv1   g759(.a(new_n853_), .O(new_n854_));
  nand2  g760(.a(new_n207_), .b(x62), .O(new_n855_));
  nand2  g761(.a(new_n774_), .b(new_n212_), .O(new_n856_));
  ...
  nand3  g772(.a(new_n866_), .b(new_n859_), .c(new_n855_), .O(new_n867_));
  aoi21  g773(.a(new_n867_), .b(new_n780_), .c(new_n854_), .O(new_n868_));
  nand2  g774(.a(new_n207_), .b(x30), .O(new_n869_));
  nand2  g775(.a(new_n792_), .b(new_n212_), .O(new_n870_));
  nand2  g776(.a(new_n768_), .b(x22), .O(new_n871_));
  nand2  g777(.a(new_n871_), .b(new_n870_), .O(new_n872_));
  nand2  g778(.a(new_n872_), .b(x72), .O(new_n873_));
  nand2  g779(.a(x74), .b(x27), .O(new_n874_));
  oai21  g780(.a(x74), .b(new_n805_), .c(new_n874_), .O(new_n875_));
  nand2  g781(.a(new_n875_), .b(x73), .O(new_n876_));
  nand2  g782(.a(new_n268_), .b(x29), .O(new_n877_));
  nand2  g783(.a(new_n877_), .b(new_n876_), .O(new_n878_));
  nand2  g784(.a(new_n878_), .b(new_n203_), .O(new_n879_));
  nand3  g785(.a(new_n879_), .b(new_n873_), .c(new_n869_), .O(new_n880_));
  nand2  g786(.a(new_n880_), .b(new_n799_), .O(new_n881_));
  oai21  g787(.a(new_n868_), .b(new_n141_), .c(new_n881_), .O(new_n882_));
  nand2  g788(.a(new_n882_), .b(new_n100_), .O(new_n883_));
  aoi21  g789(.a(new_n871_), .b(new_n870_), .c(new_n203_), .O(new_n884_));
  aoi21  g790(.a(new_n877_), .b(new_n876_), .c(x72), .O(new_n885_));
  oai21  g791(.a(new_n885_), .b(new_n884_), .c(new_n116_), .O(new_n886_));
  inv1   g792(.a(x30), .O(new_n887_));
  nand2  g793(.a(x71), .b(x62), .O(new_n888_));
  oai21  g794(.a(x71), .b(new_n887_), .c(new_n888_), .O(new_n889_));
  nand2  g795(.a(new_n889_), .b(new_n207_), .O(new_n890_));
  aoi21  g796(.a(new_n857_), .b(new_n856_), .c(new_n203_), .O(new_n891_));
  aoi21  g797(.a(new_n864_), .b(new_n863_), .c(x72), .O(new_n892_));
  oai21  g798(.a(new_n892_), .b(new_n891_), .c(x71), .O(new_n893_));
  nand3  g799(.a(new_n893_), .b(new_n890_), .c(new_n886_), .O(new_n894_));
  nand2  g800(.a(new_n894_), .b(new_n219_), .O(new_n895_));
  nand2  g801(.a(x47), .b(x32), .O(new_n896_));
  xor2a  g802(.a(new_n896_), .b(x46), .O(new_n897_));
  nor2   g803(.a(new_n897_), .b(x71), .O(new_n898_));
  nand2  g804(.a(new_n898_), .b(new_n820_), .O(new_n899_));
  nand2  g805(.a(new_n899_), .b(new_n895_), .O(new_n900_));
  nand2  g806(.a(new_n900_), .b(x70), .O(new_n901_));
  aoi21  g807(.a(new_n901_), .b(new_n883_), .c(new_n93_), .O(new_n902_));
  nand2  g808(.a(new_n852_), .b(new_n100_), .O(new_n903_));
  nand2  g809(.a(new_n898_), .b(x70), .O(new_n904_));
  aoi21  g810(.a(new_n904_), .b(new_n903_), .c(new_n226_), .O(new_n905_));
  oai21  g811(.a(new_n905_), .b(new_n902_), .c(new_n92_), .O(new_n906_));
  nand2  g812(.a(x71), .b(x46), .O(new_n907_));
  oai21  g813(.a(new_n156_), .b(new_n887_), .c(new_n907_), .O(new_n908_));
  nand2  g814(.a(new_n908_), .b(x70), .O(new_n909_));
  nand2  g815(.a(new_n159_), .b(x14), .O(new_n910_));
  nand3  g816(.a(new_n128_), .b(x69), .c(x62), .O(new_n911_));
  nand3  g817(.a(new_n911_), .b(new_n910_), .c(new_n909_), .O(new_n912_));
  and2   g818(.a(new_n912_), .b(x67), .O(new_n913_));
  nand2  g819(.a(new_n880_), .b(new_n143_), .O(new_n914_));
  nand2  g820(.a(new_n867_), .b(new_n144_), .O(new_n915_));
  aoi21  g821(.a(new_n915_), .b(new_n914_), .c(new_n837_), .O(new_n916_));
  oai21  g822(.a(new_n916_), .b(new_n913_), .c(new_n139_), .O(new_n917_));
  nand2  g823(.a(new_n867_), .b(new_n133_), .O(new_n918_));
  nand2  g824(.a(x67), .b(x46), .O(new_n919_));
  nand2  g825(.a(new_n919_), .b(new_n918_), .O(new_n920_));
  nand2  g826(.a(new_n920_), .b(new_n365_), .O(new_n921_));
  aoi21  g827(.a(new_n921_), .b(new_n917_), .c(x66), .O(new_n922_));
  nand2  g828(.a(new_n912_), .b(new_n139_), .O(new_n923_));
  nand3  g829(.a(new_n165_), .b(x68), .c(x46), .O(new_n924_));
  aoi21  g830(.a(new_n924_), .b(new_n923_), .c(new_n370_), .O(new_n925_));
  oai21  g831(.a(new_n925_), .b(new_n922_), .c(new_n173_), .O(new_n926_));
  nand2  g832(.a(new_n926_), .b(new_n906_), .O(z14));
  zero   g833(.O(z10));
  zero   g834(.O(z11));
  zero   g835(.O(z13));
  zero   g836(.O(z15));
