// Benchmark "FAU" written by ABC on Sun Aug  2 11:01:32 2020
...
module FAU ( 
  ...
  inv1   g130(.a(new_n230_), .O(new_n231_));
  nand4  g131(.a(x71), .b(x69), .c(new_n141_), .d(x65), .O(new_n232_));
  nor2   g132(.a(new_n232_), .b(new_n231_), .O(new_n233_));
  ...
  inv1   g227(.a(new_n327_), .O(new_n328_));
  nor2   g228(.a(new_n328_), .b(new_n232_), .O(new_n329_));
  oai21  g229(.a(new_n329_), .b(new_n311_), .c(new_n95_), .O(new_n330_));
  aoi21  g230(.a(new_n317_), .b(new_n316_), .c(new_n191_), .O(new_n331_));
  aoi21  g231(.a(new_n324_), .b(new_n323_), .c(x72), .O(new_n332_));
  ...
  aoi21  g237(.a(new_n299_), .b(new_n298_), .c(new_n191_), .O(new_n338_));
  aoi21  g238(.a(new_n306_), .b(new_n305_), .c(x72), .O(new_n339_));
  ...
  nor2   g243(.a(x45), .b(x44), .O(new_n344_));
  aoi21  g244(.a(new_n344_), .b(new_n121_), .c(new_n117_), .O(new_n345_));
  nand2  g245(.a(new_n344_), .b(new_n121_), .O(new_n346_));
  nand3  g246(.a(new_n346_), .b(new_n343_), .c(x32), .O(new_n347_));
  oai21  g247(.a(new_n345_), .b(new_n343_), .c(new_n347_), .O(new_n348_));
  and2   g248(.a(new_n348_), .b(new_n113_), .O(new_n349_));
  nand2  g249(.a(new_n349_), .b(new_n254_), .O(new_n350_));
  ...
  nand3  g253(.a(new_n292_), .b(x71), .c(new_n95_), .O(new_n354_));
  nand2  g254(.a(new_n349_), .b(x70), .O(new_n355_));
  aoi21  g255(.a(new_n355_), .b(new_n354_), .c(new_n261_), .O(new_n356_));
  ...
  nand2  g263(.a(new_n327_), .b(new_n145_), .O(new_n364_));
  nand2  g264(.a(new_n309_), .b(new_n271_), .O(new_n365_));
  aoi21  g265(.a(new_n365_), .b(new_n364_), .c(new_n273_), .O(new_n366_));
  oai21  g266(.a(new_n366_), .b(new_n363_), .c(new_n141_), .O(new_n367_));
  nand2  g267(.a(new_n309_), .b(new_n136_), .O(new_n368_));
  oai21  g268(.a(new_n136_), .b(new_n343_), .c(new_n368_), .O(new_n369_));
  nand2  g269(.a(new_n369_), .b(new_n279_), .O(new_n370_));
