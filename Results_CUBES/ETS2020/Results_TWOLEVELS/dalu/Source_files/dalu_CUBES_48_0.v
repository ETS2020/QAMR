// Benchmark "FAU" written by ABC on Sun Aug  2 11:02:05 2020
...
module FAU ( 
  ...
  wire new_n101_, new_n102_, new_n103_, new_n104_, new_n105_, new_n106_,
    ...
    new_n391_, new_n392_, new_n393_, new_n394_, new_n399_, new_n400_,
  ...
  nand3  g154(.a(new_n177_), .b(x71), .c(x69), .O(new_n255_));
  nor2   g155(.a(new_n255_), .b(new_n254_), .O(new_n256_));
  ...
  nor2   g246(.a(new_n346_), .b(new_n255_), .O(new_n347_));
  oai21  g247(.a(new_n347_), .b(new_n331_), .c(new_n112_), .O(new_n348_));
  aoi21  g248(.a(new_n336_), .b(new_n335_), .c(new_n130_), .O(new_n349_));
  aoi21  g249(.a(new_n342_), .b(new_n341_), .c(x72), .O(new_n350_));
  oai21  g250(.a(new_n350_), .b(new_n349_), .c(new_n125_), .O(new_n351_));
  inv1   g251(.a(x27), .O(new_n352_));
  nand2  g252(.a(x71), .b(x59), .O(new_n353_));
  oai21  g253(.a(x71), .b(new_n352_), .c(new_n353_), .O(new_n354_));
  nand2  g254(.a(new_n354_), .b(new_n141_), .O(new_n355_));
  aoi21  g255(.a(new_n319_), .b(new_n318_), .c(new_n130_), .O(new_n356_));
  aoi21  g256(.a(new_n326_), .b(new_n325_), .c(x72), .O(new_n357_));
  oai21  g257(.a(new_n357_), .b(new_n356_), .c(x71), .O(new_n358_));
  nand3  g258(.a(new_n358_), .b(new_n355_), .c(new_n351_), .O(new_n359_));
  nand2  g259(.a(new_n359_), .b(new_n270_), .O(new_n360_));
  inv1   g260(.a(x43), .O(new_n361_));
  nor2   g261(.a(x47), .b(x46), .O(new_n362_));
  nor2   g262(.a(x45), .b(x44), .O(new_n363_));
  aoi21  g263(.a(new_n363_), .b(new_n362_), .c(new_n122_), .O(new_n364_));
  nand2  g264(.a(new_n363_), .b(new_n362_), .O(new_n365_));
  nand3  g265(.a(new_n365_), .b(new_n361_), .c(x32), .O(new_n366_));
  oai21  g266(.a(new_n364_), .b(new_n361_), .c(new_n366_), .O(new_n367_));
  and2   g267(.a(new_n367_), .b(new_n125_), .O(new_n368_));
  nand2  g268(.a(new_n368_), .b(new_n278_), .O(new_n369_));
  nand2  g269(.a(new_n369_), .b(new_n360_), .O(new_n370_));
  nand2  g270(.a(new_n370_), .b(x70), .O(new_n371_));
  aoi21  g271(.a(new_n371_), .b(new_n348_), .c(new_n102_), .O(new_n372_));
  nand3  g272(.a(new_n313_), .b(x71), .c(new_n112_), .O(new_n373_));
  nand2  g273(.a(new_n368_), .b(x70), .O(new_n374_));
  aoi21  g274(.a(new_n374_), .b(new_n373_), .c(new_n182_), .O(new_n375_));
  oai21  g275(.a(new_n375_), .b(new_n372_), .c(new_n101_), .O(new_n376_));
  oai22  g276(.a(new_n187_), .b(new_n352_), .c(new_n125_), .d(new_n361_), .O(new_n377_));
  nand2  g277(.a(new_n377_), .b(x70), .O(new_n378_));
  nand2  g278(.a(new_n190_), .b(x11), .O(new_n379_));
  nand3  g279(.a(new_n192_), .b(x69), .c(x59), .O(new_n380_));
  nand3  g280(.a(new_n380_), .b(new_n379_), .c(new_n378_), .O(new_n381_));
  and2   g281(.a(new_n381_), .b(x67), .O(new_n382_));
  nand2  g282(.a(new_n345_), .b(new_n157_), .O(new_n383_));
  nand2  g283(.a(new_n329_), .b(new_n173_), .O(new_n384_));
  aoi21  g284(.a(new_n384_), .b(new_n383_), .c(new_n295_), .O(new_n385_));
  oai21  g285(.a(new_n385_), .b(new_n382_), .c(new_n153_), .O(new_n386_));
  nand2  g286(.a(new_n329_), .b(new_n180_), .O(new_n387_));
  oai21  g287(.a(new_n180_), .b(new_n361_), .c(new_n387_), .O(new_n388_));
  nand2  g288(.a(new_n388_), .b(new_n200_), .O(new_n389_));
  aoi21  g289(.a(new_n389_), .b(new_n386_), .c(x66), .O(new_n390_));
  nand2  g290(.a(new_n381_), .b(new_n153_), .O(new_n391_));
  nand3  g291(.a(new_n204_), .b(x68), .c(x43), .O(new_n392_));
  aoi21  g292(.a(new_n392_), .b(new_n391_), .c(new_n207_), .O(new_n393_));
  oai21  g293(.a(new_n393_), .b(new_n390_), .c(new_n210_), .O(new_n394_));
  nand2  g294(.a(new_n394_), .b(new_n376_), .O(z11));
  inv1   g295(.a(x31), .O(new_n399_));
  nand2  g296(.a(x71), .b(x47), .O(new_n400_));
  oai21  g297(.a(new_n187_), .b(new_n399_), .c(new_n400_), .O(new_n401_));
  nand2  g298(.a(new_n401_), .b(x70), .O(new_n402_));
  nand2  g299(.a(new_n190_), .b(x15), .O(new_n403_));
  nand3  g300(.a(new_n192_), .b(x69), .c(x63), .O(new_n404_));
  nand3  g301(.a(new_n404_), .b(new_n403_), .c(new_n402_), .O(new_n405_));
  and2   g302(.a(new_n405_), .b(x67), .O(new_n406_));
  nand2  g303(.a(x74), .b(x28), .O(new_n407_));
  nand2  g304(.a(new_n133_), .b(x29), .O(new_n408_));
  aoi21  g305(.a(new_n408_), .b(new_n407_), .c(new_n131_), .O(new_n409_));
  nand3  g306(.a(x74), .b(new_n131_), .c(x30), .O(new_n410_));
  inv1   g307(.a(new_n410_), .O(new_n411_));
  oai21  g308(.a(new_n411_), .b(new_n409_), .c(new_n130_), .O(new_n412_));
  nand2  g309(.a(new_n141_), .b(x31), .O(new_n413_));
  nand2  g310(.a(x74), .b(x26), .O(new_n414_));
  nand2  g311(.a(new_n133_), .b(x27), .O(new_n415_));
  aoi21  g312(.a(new_n415_), .b(new_n414_), .c(x73), .O(new_n416_));
  nand3  g313(.a(new_n133_), .b(x73), .c(x23), .O(new_n417_));
  inv1   g314(.a(new_n417_), .O(new_n418_));
  oai21  g315(.a(new_n418_), .b(new_n416_), .c(x72), .O(new_n419_));
  nand3  g316(.a(new_n419_), .b(new_n413_), .c(new_n412_), .O(new_n420_));
  nand2  g317(.a(new_n420_), .b(new_n157_), .O(new_n421_));
  nand2  g318(.a(x74), .b(x60), .O(new_n422_));
  nand2  g319(.a(new_n133_), .b(x61), .O(new_n423_));
  aoi21  g320(.a(new_n423_), .b(new_n422_), .c(new_n131_), .O(new_n424_));
  nand3  g321(.a(x74), .b(new_n131_), .c(x62), .O(new_n425_));
  inv1   g322(.a(new_n425_), .O(new_n426_));
  oai21  g323(.a(new_n426_), .b(new_n424_), .c(new_n130_), .O(new_n427_));
  nand2  g324(.a(new_n141_), .b(x63), .O(new_n428_));
  nand2  g325(.a(x74), .b(x58), .O(new_n429_));
  nand2  g326(.a(new_n133_), .b(x59), .O(new_n430_));
  aoi21  g327(.a(new_n430_), .b(new_n429_), .c(x73), .O(new_n431_));
  nand3  g328(.a(new_n133_), .b(x73), .c(x55), .O(new_n432_));
  inv1   g329(.a(new_n432_), .O(new_n433_));
  oai21  g330(.a(new_n433_), .b(new_n431_), .c(x72), .O(new_n434_));
  nand3  g331(.a(new_n434_), .b(new_n428_), .c(new_n427_), .O(new_n435_));
  nand2  g332(.a(new_n435_), .b(new_n173_), .O(new_n436_));
  aoi21  g333(.a(new_n436_), .b(new_n421_), .c(new_n295_), .O(new_n437_));
  oai21  g334(.a(new_n437_), .b(new_n406_), .c(new_n185_), .O(new_n438_));
  nand2  g335(.a(new_n405_), .b(new_n206_), .O(new_n439_));
  aoi21  g336(.a(new_n439_), .b(new_n438_), .c(new_n211_), .O(new_n440_));
  inv1   g337(.a(new_n102_), .O(new_n441_));
  nand4  g338(.a(new_n441_), .b(x69), .c(x65), .d(new_n101_), .O(new_n442_));
  aoi21  g339(.a(new_n436_), .b(new_n421_), .c(new_n442_), .O(new_n443_));
  oai21  g340(.a(new_n443_), .b(new_n440_), .c(new_n153_), .O(new_n444_));
  nand3  g341(.a(x71), .b(new_n176_), .c(x15), .O(new_n445_));
  inv1   g342(.a(new_n445_), .O(new_n446_));
  aoi21  g343(.a(new_n435_), .b(new_n235_), .c(new_n446_), .O(new_n447_));
  nand3  g344(.a(new_n127_), .b(new_n176_), .c(x47), .O(new_n448_));
  oai21  g345(.a(new_n447_), .b(x70), .c(new_n448_), .O(new_n449_));
  aoi22  g346(.a(new_n127_), .b(x47), .c(new_n114_), .d(x15), .O(new_n450_));
  nand2  g347(.a(new_n181_), .b(new_n180_), .O(new_n451_));
  nor2   g348(.a(new_n451_), .b(new_n450_), .O(new_n452_));
  aoi21  g349(.a(new_n449_), .b(new_n441_), .c(new_n452_), .O(new_n453_));
  nor2   g350(.a(new_n180_), .b(x66), .O(new_n454_));
  oai21  g351(.a(new_n454_), .b(new_n206_), .c(x47), .O(new_n455_));
  nand2  g352(.a(new_n435_), .b(new_n102_), .O(new_n456_));
  nand2  g353(.a(new_n456_), .b(new_n455_), .O(new_n457_));
  nand3  g354(.a(new_n457_), .b(new_n210_), .c(new_n192_), .O(new_n458_));
  oai21  g355(.a(new_n453_), .b(x64), .c(new_n458_), .O(new_n459_));
  nand2  g356(.a(new_n459_), .b(new_n154_), .O(new_n460_));
  nand2  g357(.a(new_n460_), .b(new_n444_), .O(z15));
  zero   g358(.O(z00));
  zero   g359(.O(z01));
  zero   g360(.O(z02));
  zero   g361(.O(z03));
