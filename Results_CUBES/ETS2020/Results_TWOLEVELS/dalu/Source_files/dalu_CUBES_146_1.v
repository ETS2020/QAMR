// Benchmark "FAU" written by ABC on Sun Aug  2 11:54:17 2020
...
module FAU ( 
  ...
  nand3  g599(.a(new_n163_), .b(x71), .c(x69), .O(new_n693_));
  inv1   g600(.a(new_n693_), .O(new_n694_));
  and2   g601(.a(new_n694_), .b(new_n692_), .O(new_n695_));
  ...
  and2   g688(.a(new_n781_), .b(new_n694_), .O(new_n782_));
  oai21  g689(.a(new_n782_), .b(new_n766_), .c(new_n111_), .O(new_n783_));
  aoi21  g690(.a(new_n771_), .b(new_n770_), .c(new_n137_), .O(new_n784_));
  aoi21  g691(.a(new_n778_), .b(new_n777_), .c(x72), .O(new_n785_));
  oai21  g692(.a(new_n785_), .b(new_n784_), .c(new_n131_), .O(new_n786_));
  inv1   g693(.a(x27), .O(new_n787_));
  nand2  g694(.a(x71), .b(x59), .O(new_n788_));
  oai21  g695(.a(x71), .b(new_n787_), .c(new_n788_), .O(new_n789_));
  nand2  g696(.a(new_n789_), .b(new_n141_), .O(new_n790_));
  aoi21  g697(.a(new_n754_), .b(new_n753_), .c(new_n137_), .O(new_n791_));
  aoi21  g698(.a(new_n761_), .b(new_n760_), .c(x72), .O(new_n792_));
  oai21  g699(.a(new_n792_), .b(new_n791_), .c(x71), .O(new_n793_));
  nand3  g700(.a(new_n793_), .b(new_n790_), .c(new_n786_), .O(new_n794_));
  nand2  g701(.a(new_n794_), .b(new_n165_), .O(new_n795_));
  oai21  g702(.a(new_n448_), .b(new_n127_), .c(x43), .O(new_n796_));
  nand3  g703(.a(new_n372_), .b(new_n115_), .c(x32), .O(new_n797_));
  aoi21  g704(.a(new_n797_), .b(new_n796_), .c(x71), .O(new_n798_));
  nand2  g705(.a(new_n798_), .b(new_n716_), .O(new_n799_));
  nand2  g706(.a(new_n799_), .b(new_n795_), .O(new_n800_));
  nand2  g707(.a(new_n800_), .b(x70), .O(new_n801_));
  aoi21  g708(.a(new_n801_), .b(new_n783_), .c(new_n93_), .O(new_n802_));
  nand2  g709(.a(new_n747_), .b(new_n111_), .O(new_n803_));
  nand2  g710(.a(new_n798_), .b(x70), .O(new_n804_));
  aoi21  g711(.a(new_n804_), .b(new_n803_), .c(new_n171_), .O(new_n805_));
  oai21  g712(.a(new_n805_), .b(new_n802_), .c(new_n203_), .O(new_n806_));
  oai22  g713(.a(new_n176_), .b(new_n787_), .c(new_n131_), .d(new_n115_), .O(new_n807_));
  nand2  g714(.a(new_n807_), .b(x70), .O(new_n808_));
  nand2  g715(.a(new_n179_), .b(x11), .O(new_n809_));
  nand3  g716(.a(new_n181_), .b(x69), .c(x59), .O(new_n810_));
  nand3  g717(.a(new_n810_), .b(new_n809_), .c(new_n808_), .O(new_n811_));
  and2   g718(.a(new_n811_), .b(x67), .O(new_n812_));
  nand2  g719(.a(new_n781_), .b(new_n158_), .O(new_n813_));
  nand2  g720(.a(new_n764_), .b(new_n159_), .O(new_n814_));
  aoi21  g721(.a(new_n814_), .b(new_n813_), .c(new_n733_), .O(new_n815_));
  oai21  g722(.a(new_n815_), .b(new_n812_), .c(new_n153_), .O(new_n816_));
  nand2  g723(.a(new_n764_), .b(new_n168_), .O(new_n817_));
  oai21  g724(.a(new_n168_), .b(new_n115_), .c(new_n817_), .O(new_n818_));
  nand2  g725(.a(new_n818_), .b(new_n324_), .O(new_n819_));
  aoi21  g726(.a(new_n819_), .b(new_n816_), .c(x66), .O(new_n820_));
  nand2  g727(.a(new_n811_), .b(new_n153_), .O(new_n821_));
  nand3  g728(.a(new_n186_), .b(x68), .c(x43), .O(new_n822_));
  aoi21  g729(.a(new_n822_), .b(new_n821_), .c(new_n191_), .O(new_n823_));
  oai21  g730(.a(new_n823_), .b(new_n820_), .c(new_n204_), .O(new_n824_));
  nand2  g731(.a(new_n824_), .b(new_n806_), .O(z11));
  oai21  g732(.a(new_n270_), .b(new_n107_), .c(x12), .O(new_n826_));
  inv1   g733(.a(new_n270_), .O(new_n827_));
  nor2   g734(.a(x12), .b(new_n107_), .O(new_n828_));
  nand2  g735(.a(new_n828_), .b(new_n827_), .O(new_n829_));
  aoi21  g736(.a(new_n829_), .b(new_n826_), .c(new_n131_), .O(new_n830_));
  nand2  g737(.a(new_n830_), .b(new_n136_), .O(new_n831_));
  nand2  g738(.a(new_n141_), .b(x60), .O(new_n832_));
  nand2  g739(.a(new_n671_), .b(new_n146_), .O(new_n833_));
  nand2  g740(.a(new_n665_), .b(x52), .O(new_n834_));
  nand2  g741(.a(new_n834_), .b(new_n833_), .O(new_n835_));
  nand2  g742(.a(new_n835_), .b(x72), .O(new_n836_));
  inv1   g743(.a(x58), .O(new_n837_));
  nand2  g744(.a(x74), .b(x57), .O(new_n838_));
  oai21  g745(.a(x74), .b(new_n837_), .c(new_n838_), .O(new_n839_));
  nand2  g746(.a(new_n839_), .b(x73), .O(new_n840_));
  nand2  g747(.a(new_n228_), .b(x59), .O(new_n841_));
  nand2  g748(.a(new_n841_), .b(new_n840_), .O(new_n842_));
  nand2  g749(.a(new_n842_), .b(new_n137_), .O(new_n843_));
  nand3  g750(.a(new_n843_), .b(new_n836_), .c(new_n832_), .O(new_n844_));
  nand2  g751(.a(new_n844_), .b(new_n677_), .O(new_n845_));
  aoi21  g752(.a(new_n845_), .b(new_n831_), .c(new_n155_), .O(new_n846_));
  nand2  g753(.a(new_n141_), .b(x28), .O(new_n847_));
  nand2  g754(.a(new_n687_), .b(new_n146_), .O(new_n848_));
  nand2  g755(.a(new_n665_), .b(x20), .O(new_n849_));
  nand2  g756(.a(new_n849_), .b(new_n848_), .O(new_n850_));
  nand2  g757(.a(new_n850_), .b(x72), .O(new_n851_));
  nand2  g758(.a(x74), .b(x25), .O(new_n852_));
  oai21  g759(.a(x74), .b(new_n700_), .c(new_n852_), .O(new_n853_));
  nand2  g760(.a(new_n853_), .b(x73), .O(new_n854_));
  nand2  g761(.a(new_n228_), .b(x27), .O(new_n855_));
  nand2  g762(.a(new_n855_), .b(new_n854_), .O(new_n856_));
  nand2  g763(.a(new_n856_), .b(new_n137_), .O(new_n857_));
  nand3  g764(.a(new_n857_), .b(new_n851_), .c(new_n847_), .O(new_n858_));
  and2   g765(.a(new_n858_), .b(new_n694_), .O(new_n859_));
  oai21  g766(.a(new_n859_), .b(new_n846_), .c(new_n111_), .O(new_n860_));
  aoi21  g767(.a(new_n849_), .b(new_n848_), .c(new_n137_), .O(new_n861_));
  aoi21  g768(.a(new_n855_), .b(new_n854_), .c(x72), .O(new_n862_));
  oai21  g769(.a(new_n862_), .b(new_n861_), .c(new_n131_), .O(new_n863_));
  inv1   g770(.a(x28), .O(new_n864_));
  nand2  g771(.a(x71), .b(x60), .O(new_n865_));
  oai21  g772(.a(x71), .b(new_n864_), .c(new_n865_), .O(new_n866_));
  nand2  g773(.a(new_n866_), .b(new_n141_), .O(new_n867_));
  aoi21  g774(.a(new_n834_), .b(new_n833_), .c(new_n137_), .O(new_n868_));
  aoi21  g775(.a(new_n841_), .b(new_n840_), .c(x72), .O(new_n869_));
  oai21  g776(.a(new_n869_), .b(new_n868_), .c(x71), .O(new_n870_));
  nand3  g777(.a(new_n870_), .b(new_n867_), .c(new_n863_), .O(new_n871_));
  nand2  g778(.a(new_n871_), .b(new_n165_), .O(new_n872_));
  oai21  g779(.a(new_n281_), .b(new_n127_), .c(x44), .O(new_n873_));
  inv1   g780(.a(x44), .O(new_n874_));
  inv1   g781(.a(new_n281_), .O(new_n875_));
  nand3  g782(.a(new_n875_), .b(new_n874_), .c(x32), .O(new_n876_));
  aoi21  g783(.a(new_n876_), .b(new_n873_), .c(x71), .O(new_n877_));
  nand2  g784(.a(new_n877_), .b(new_n716_), .O(new_n878_));
  nand2  g785(.a(new_n878_), .b(new_n872_), .O(new_n879_));
  nand2  g786(.a(new_n879_), .b(x70), .O(new_n880_));
  aoi21  g787(.a(new_n880_), .b(new_n860_), .c(new_n93_), .O(new_n881_));
  nand2  g788(.a(new_n830_), .b(new_n111_), .O(new_n882_));
  nand2  g789(.a(new_n877_), .b(x70), .O(new_n883_));
  aoi21  g790(.a(new_n883_), .b(new_n882_), .c(new_n171_), .O(new_n884_));
  oai21  g791(.a(new_n884_), .b(new_n881_), .c(new_n203_), .O(new_n885_));
  oai22  g792(.a(new_n176_), .b(new_n864_), .c(new_n131_), .d(new_n874_), .O(new_n886_));
  nand2  g793(.a(new_n886_), .b(x70), .O(new_n887_));
  nand2  g794(.a(new_n179_), .b(x12), .O(new_n888_));
  nand3  g795(.a(new_n181_), .b(x69), .c(x60), .O(new_n889_));
  nand3  g796(.a(new_n889_), .b(new_n888_), .c(new_n887_), .O(new_n890_));
  and2   g797(.a(new_n890_), .b(x67), .O(new_n891_));
  nand2  g798(.a(new_n858_), .b(new_n158_), .O(new_n892_));
  nand2  g799(.a(new_n844_), .b(new_n159_), .O(new_n893_));
  aoi21  g800(.a(new_n893_), .b(new_n892_), .c(new_n733_), .O(new_n894_));
  oai21  g801(.a(new_n894_), .b(new_n891_), .c(new_n153_), .O(new_n895_));
  nand2  g802(.a(new_n844_), .b(new_n168_), .O(new_n896_));
  oai21  g803(.a(new_n168_), .b(new_n874_), .c(new_n896_), .O(new_n897_));
  nand2  g804(.a(new_n897_), .b(new_n324_), .O(new_n898_));
  aoi21  g805(.a(new_n898_), .b(new_n895_), .c(x66), .O(new_n899_));
  nand2  g806(.a(new_n890_), .b(new_n153_), .O(new_n900_));
  nand3  g807(.a(new_n186_), .b(x68), .c(x44), .O(new_n901_));
  aoi21  g808(.a(new_n901_), .b(new_n900_), .c(new_n191_), .O(new_n902_));
  oai21  g809(.a(new_n902_), .b(new_n899_), .c(new_n204_), .O(new_n903_));
  nand2  g810(.a(new_n903_), .b(new_n885_), .O(z12));
  nand2  g811(.a(x15), .b(x00), .O(new_n906_));
  xor2a  g812(.a(new_n906_), .b(x14), .O(new_n907_));
  nor2   g813(.a(new_n907_), .b(new_n131_), .O(new_n908_));
  nand2  g814(.a(new_n908_), .b(new_n136_), .O(new_n909_));
  inv1   g815(.a(new_n909_), .O(new_n910_));
  nand2  g816(.a(new_n141_), .b(x62), .O(new_n911_));
  nand2  g817(.a(new_n839_), .b(new_n146_), .O(new_n912_));
  nand2  g818(.a(new_n665_), .b(x54), .O(new_n913_));
  nand2  g819(.a(new_n913_), .b(new_n912_), .O(new_n914_));
  nand2  g820(.a(new_n914_), .b(x72), .O(new_n915_));
  inv1   g821(.a(x60), .O(new_n916_));
  nand2  g822(.a(x74), .b(x59), .O(new_n917_));
  oai21  g823(.a(x74), .b(new_n916_), .c(new_n917_), .O(new_n918_));
  nand2  g824(.a(new_n918_), .b(x73), .O(new_n919_));
  nand2  g825(.a(new_n228_), .b(x61), .O(new_n920_));
  nand2  g826(.a(new_n920_), .b(new_n919_), .O(new_n921_));
  nand2  g827(.a(new_n921_), .b(new_n137_), .O(new_n922_));
  nand3  g828(.a(new_n922_), .b(new_n915_), .c(new_n911_), .O(new_n923_));
  aoi21  g829(.a(new_n923_), .b(new_n677_), .c(new_n910_), .O(new_n924_));
  nand2  g830(.a(new_n141_), .b(x30), .O(new_n925_));
  nand2  g831(.a(new_n853_), .b(new_n146_), .O(new_n926_));
  nand2  g832(.a(new_n665_), .b(x22), .O(new_n927_));
  nand2  g833(.a(new_n927_), .b(new_n926_), .O(new_n928_));
  nand2  g834(.a(new_n928_), .b(x72), .O(new_n929_));
  nand2  g835(.a(x74), .b(x27), .O(new_n930_));
  oai21  g836(.a(x74), .b(new_n864_), .c(new_n930_), .O(new_n931_));
  nand2  g837(.a(new_n931_), .b(x73), .O(new_n932_));
  nand2  g838(.a(new_n228_), .b(x29), .O(new_n933_));
  nand2  g839(.a(new_n933_), .b(new_n932_), .O(new_n934_));
  nand2  g840(.a(new_n934_), .b(new_n137_), .O(new_n935_));
  nand3  g841(.a(new_n935_), .b(new_n929_), .c(new_n925_), .O(new_n936_));
  nand2  g842(.a(new_n936_), .b(new_n694_), .O(new_n937_));
  oai21  g843(.a(new_n924_), .b(new_n155_), .c(new_n937_), .O(new_n938_));
  nand2  g844(.a(new_n938_), .b(new_n111_), .O(new_n939_));
  aoi21  g845(.a(new_n927_), .b(new_n926_), .c(new_n137_), .O(new_n940_));
  aoi21  g846(.a(new_n933_), .b(new_n932_), .c(x72), .O(new_n941_));
  oai21  g847(.a(new_n941_), .b(new_n940_), .c(new_n131_), .O(new_n942_));
  inv1   g848(.a(x30), .O(new_n943_));
  nand2  g849(.a(x71), .b(x62), .O(new_n944_));
  oai21  g850(.a(x71), .b(new_n943_), .c(new_n944_), .O(new_n945_));
  nand2  g851(.a(new_n945_), .b(new_n141_), .O(new_n946_));
  aoi21  g852(.a(new_n913_), .b(new_n912_), .c(new_n137_), .O(new_n947_));
  aoi21  g853(.a(new_n920_), .b(new_n919_), .c(x72), .O(new_n948_));
  oai21  g854(.a(new_n948_), .b(new_n947_), .c(x71), .O(new_n949_));
  nand3  g855(.a(new_n949_), .b(new_n946_), .c(new_n942_), .O(new_n950_));
  nand2  g856(.a(new_n950_), .b(new_n165_), .O(new_n951_));
  nand2  g857(.a(x47), .b(x32), .O(new_n952_));
  xor2a  g858(.a(new_n952_), .b(x46), .O(new_n953_));
  nor2   g859(.a(new_n953_), .b(x71), .O(new_n954_));
  nand2  g860(.a(new_n954_), .b(new_n716_), .O(new_n955_));
  nand2  g861(.a(new_n955_), .b(new_n951_), .O(new_n956_));
  nand2  g862(.a(new_n956_), .b(x70), .O(new_n957_));
  aoi21  g863(.a(new_n957_), .b(new_n939_), .c(new_n93_), .O(new_n958_));
  nand2  g864(.a(new_n908_), .b(new_n111_), .O(new_n959_));
  nand2  g865(.a(new_n954_), .b(x70), .O(new_n960_));
  aoi21  g866(.a(new_n960_), .b(new_n959_), .c(new_n171_), .O(new_n961_));
  oai21  g867(.a(new_n961_), .b(new_n958_), .c(new_n203_), .O(new_n962_));
  nand2  g868(.a(x71), .b(x46), .O(new_n963_));
  oai21  g869(.a(new_n176_), .b(new_n943_), .c(new_n963_), .O(new_n964_));
  nand2  g870(.a(new_n964_), .b(x70), .O(new_n965_));
  nand2  g871(.a(new_n179_), .b(x14), .O(new_n966_));
  nand3  g872(.a(new_n181_), .b(x69), .c(x62), .O(new_n967_));
  nand3  g873(.a(new_n967_), .b(new_n966_), .c(new_n965_), .O(new_n968_));
  and2   g874(.a(new_n968_), .b(x67), .O(new_n969_));
  nand2  g875(.a(new_n936_), .b(new_n158_), .O(new_n970_));
  nand2  g876(.a(new_n923_), .b(new_n159_), .O(new_n971_));
  aoi21  g877(.a(new_n971_), .b(new_n970_), .c(new_n733_), .O(new_n972_));
  oai21  g878(.a(new_n972_), .b(new_n969_), .c(new_n153_), .O(new_n973_));
  nand2  g879(.a(new_n923_), .b(new_n168_), .O(new_n974_));
  nand2  g880(.a(x67), .b(x46), .O(new_n975_));
  nand2  g881(.a(new_n975_), .b(new_n974_), .O(new_n976_));
  nand2  g882(.a(new_n976_), .b(new_n324_), .O(new_n977_));
  aoi21  g883(.a(new_n977_), .b(new_n973_), .c(x66), .O(new_n978_));
  nand2  g884(.a(new_n968_), .b(new_n153_), .O(new_n979_));
  nand3  g885(.a(new_n186_), .b(x68), .c(x46), .O(new_n980_));
  aoi21  g886(.a(new_n980_), .b(new_n979_), .c(new_n191_), .O(new_n981_));
  oai21  g887(.a(new_n981_), .b(new_n978_), .c(new_n204_), .O(new_n982_));
  nand2  g888(.a(new_n982_), .b(new_n962_), .O(z14));
  zero   g889(.O(z00));
  zero   g890(.O(z09));
  zero   g891(.O(z13));
  zero   g892(.O(z15));
