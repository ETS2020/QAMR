// Benchmark "FAU" written by ABC on Sun Aug  2 12:24:12 2020
...
module FAU ( 
  ...
  nor2   g673(.a(x74), .b(new_n212_), .O(new_n765_));
  ...
  nand2  g846(.a(x74), .b(x58), .O(new_n939_));
  nand2  g847(.a(new_n209_), .b(x59), .O(new_n940_));
  nand2  g848(.a(new_n940_), .b(new_n939_), .O(new_n941_));
  ...
  nand2  g862(.a(x74), .b(x26), .O(new_n955_));
  nand2  g863(.a(new_n209_), .b(x27), .O(new_n956_));
  ...
  oai22  g918(.a(new_n154_), .b(new_n1010_), .c(new_n116_), .d(new_n1011_), .O(new_n1012_));
  nand2  g919(.a(new_n1012_), .b(x70), .O(new_n1013_));
  nand2  g920(.a(new_n157_), .b(x15), .O(new_n1014_));
  nand3  g921(.a(new_n126_), .b(x69), .c(x63), .O(new_n1015_));
  ...
  aoi21  g931(.a(new_n956_), .b(new_n955_), .c(x73), .O(new_n1025_));
  nand2  g932(.a(new_n765_), .b(x23), .O(new_n1026_));
  ...
  nand2  g936(.a(new_n1029_), .b(new_n141_), .O(new_n1030_));
  ...
  aoi21  g944(.a(new_n940_), .b(new_n939_), .c(x73), .O(new_n1038_));
  nand2  g945(.a(new_n765_), .b(x55), .O(new_n1039_));
  ...
  nand2  g949(.a(new_n1042_), .b(new_n142_), .O(new_n1043_));
  aoi21  g950(.a(new_n1043_), .b(new_n1030_), .c(new_n833_), .O(new_n1044_));
  oai21  g951(.a(new_n1044_), .b(new_n1017_), .c(new_n149_), .O(new_n1045_));
  nand2  g952(.a(new_n1016_), .b(new_n150_), .O(new_n1046_));
  ...
  oai21  g956(.a(new_n1049_), .b(new_n1047_), .c(new_n137_), .O(new_n1050_));
  nand3  g957(.a(x71), .b(new_n132_), .c(x15), .O(new_n1051_));
  inv1   g958(.a(new_n1051_), .O(new_n1052_));
  aoi21  g959(.a(new_n1042_), .b(new_n777_), .c(new_n1052_), .O(new_n1053_));
  nand3  g960(.a(new_n188_), .b(new_n132_), .c(x47), .O(new_n1054_));
  oai21  g961(.a(new_n1053_), .b(x70), .c(new_n1054_), .O(new_n1055_));
  nand2  g962(.a(new_n174_), .b(x15), .O(new_n1056_));
  nand2  g963(.a(new_n188_), .b(x47), .O(new_n1057_));
  aoi21  g964(.a(new_n1057_), .b(new_n1056_), .c(new_n134_), .O(new_n1058_));
  aoi21  g965(.a(new_n1055_), .b(new_n94_), .c(new_n1058_), .O(new_n1059_));
  nand2  g966(.a(new_n1042_), .b(new_n93_), .O(new_n1060_));
  oai21  g967(.a(new_n151_), .b(new_n1011_), .c(new_n1060_), .O(new_n1061_));
  nand3  g968(.a(new_n1061_), .b(new_n171_), .c(new_n126_), .O(new_n1062_));
  oai21  g969(.a(new_n1059_), .b(x64), .c(new_n1062_), .O(new_n1063_));
  nand2  g970(.a(new_n1063_), .b(new_n138_), .O(new_n1064_));
