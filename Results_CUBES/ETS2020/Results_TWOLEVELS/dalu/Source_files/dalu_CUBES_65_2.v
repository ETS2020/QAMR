// Benchmark "FAU" written by ABC on Sun Aug  2 11:11:01 2020
...
module FAU ( 
  ...
  wire new_n93_, new_n94_, new_n95_, new_n96_, new_n97_, new_n98_, new_n99_,
    ...
    new_n714_, new_n715_, new_n716_, new_n717_, new_n721_, new_n722_,
  ...
  nand2  g626(.a(new_n96_), .b(new_n268_), .O(new_n721_));
  nand2  g627(.a(new_n721_), .b(x00), .O(new_n722_));
  nand2  g628(.a(new_n722_), .b(x12), .O(new_n723_));
  nand3  g629(.a(new_n721_), .b(new_n267_), .c(x00), .O(new_n724_));
  aoi21  g630(.a(new_n724_), .b(new_n723_), .c(new_n131_), .O(new_n725_));
  nand2  g631(.a(new_n725_), .b(new_n136_), .O(new_n726_));
  nand2  g632(.a(new_n141_), .b(x60), .O(new_n727_));
  inv1   g633(.a(x56), .O(new_n728_));
  nand2  g634(.a(x74), .b(x55), .O(new_n729_));
  oai21  g635(.a(x74), .b(new_n728_), .c(new_n729_), .O(new_n730_));
  nand2  g636(.a(new_n730_), .b(new_n146_), .O(new_n731_));
  nor2   g637(.a(x74), .b(new_n146_), .O(new_n732_));
  nand2  g638(.a(new_n732_), .b(x52), .O(new_n733_));
  nand2  g639(.a(new_n733_), .b(new_n731_), .O(new_n734_));
  nand2  g640(.a(new_n734_), .b(x72), .O(new_n735_));
  inv1   g641(.a(x58), .O(new_n736_));
  nand2  g642(.a(x74), .b(x57), .O(new_n737_));
  oai21  g643(.a(x74), .b(new_n736_), .c(new_n737_), .O(new_n738_));
  nand2  g644(.a(new_n738_), .b(x73), .O(new_n739_));
  nand2  g645(.a(new_n228_), .b(x59), .O(new_n740_));
  nand2  g646(.a(new_n740_), .b(new_n739_), .O(new_n741_));
  nand2  g647(.a(new_n741_), .b(new_n137_), .O(new_n742_));
  nand3  g648(.a(new_n742_), .b(new_n735_), .c(new_n727_), .O(new_n743_));
  nor2   g649(.a(x71), .b(new_n136_), .O(new_n744_));
  nand2  g650(.a(new_n744_), .b(new_n743_), .O(new_n745_));
  aoi21  g651(.a(new_n745_), .b(new_n726_), .c(new_n155_), .O(new_n746_));
  nand2  g652(.a(new_n141_), .b(x28), .O(new_n747_));
  nand2  g653(.a(x74), .b(x23), .O(new_n748_));
  oai21  g654(.a(x74), .b(new_n642_), .c(new_n748_), .O(new_n749_));
  nand2  g655(.a(new_n749_), .b(new_n146_), .O(new_n750_));
  nand2  g656(.a(new_n732_), .b(x20), .O(new_n751_));
  nand2  g657(.a(new_n751_), .b(new_n750_), .O(new_n752_));
  nand2  g658(.a(new_n752_), .b(x72), .O(new_n753_));
  inv1   g659(.a(x26), .O(new_n754_));
  nand2  g660(.a(x74), .b(x25), .O(new_n755_));
  oai21  g661(.a(x74), .b(new_n754_), .c(new_n755_), .O(new_n756_));
  nand2  g662(.a(new_n756_), .b(x73), .O(new_n757_));
  nand2  g663(.a(new_n228_), .b(x27), .O(new_n758_));
  nand2  g664(.a(new_n758_), .b(new_n757_), .O(new_n759_));
  nand2  g665(.a(new_n759_), .b(new_n137_), .O(new_n760_));
  nand3  g666(.a(new_n760_), .b(new_n753_), .c(new_n747_), .O(new_n761_));
  nand3  g667(.a(new_n163_), .b(x71), .c(x69), .O(new_n762_));
  inv1   g668(.a(new_n762_), .O(new_n763_));
  and2   g669(.a(new_n763_), .b(new_n761_), .O(new_n764_));
  oai21  g670(.a(new_n764_), .b(new_n746_), .c(new_n111_), .O(new_n765_));
  aoi21  g671(.a(new_n751_), .b(new_n750_), .c(new_n137_), .O(new_n766_));
  aoi21  g672(.a(new_n758_), .b(new_n757_), .c(x72), .O(new_n767_));
  oai21  g673(.a(new_n767_), .b(new_n766_), .c(new_n131_), .O(new_n768_));
  inv1   g674(.a(x28), .O(new_n769_));
  nand2  g675(.a(x71), .b(x60), .O(new_n770_));
  oai21  g676(.a(x71), .b(new_n769_), .c(new_n770_), .O(new_n771_));
  nand2  g677(.a(new_n771_), .b(new_n141_), .O(new_n772_));
  aoi21  g678(.a(new_n733_), .b(new_n731_), .c(new_n137_), .O(new_n773_));
  aoi21  g679(.a(new_n740_), .b(new_n739_), .c(x72), .O(new_n774_));
  oai21  g680(.a(new_n774_), .b(new_n773_), .c(x71), .O(new_n775_));
  nand3  g681(.a(new_n775_), .b(new_n772_), .c(new_n768_), .O(new_n776_));
  nand2  g682(.a(new_n776_), .b(new_n165_), .O(new_n777_));
  nand2  g683(.a(new_n116_), .b(new_n280_), .O(new_n778_));
  nand2  g684(.a(new_n778_), .b(x32), .O(new_n779_));
  nand2  g685(.a(new_n779_), .b(x44), .O(new_n780_));
  nand3  g686(.a(new_n778_), .b(new_n279_), .c(x32), .O(new_n781_));
  aoi21  g687(.a(new_n781_), .b(new_n780_), .c(x71), .O(new_n782_));
  nand3  g688(.a(new_n169_), .b(x68), .c(new_n136_), .O(new_n783_));
  inv1   g689(.a(new_n783_), .O(new_n784_));
  nand2  g690(.a(new_n784_), .b(new_n782_), .O(new_n785_));
  nand2  g691(.a(new_n785_), .b(new_n777_), .O(new_n786_));
  nand2  g692(.a(new_n786_), .b(x70), .O(new_n787_));
  aoi21  g693(.a(new_n787_), .b(new_n765_), .c(new_n93_), .O(new_n788_));
  nand2  g694(.a(new_n725_), .b(new_n111_), .O(new_n789_));
  nand2  g695(.a(new_n782_), .b(x70), .O(new_n790_));
  aoi21  g696(.a(new_n790_), .b(new_n789_), .c(new_n171_), .O(new_n791_));
  oai21  g697(.a(new_n791_), .b(new_n788_), .c(new_n203_), .O(new_n792_));
  oai22  g698(.a(new_n176_), .b(new_n769_), .c(new_n131_), .d(new_n279_), .O(new_n793_));
  nand2  g699(.a(new_n793_), .b(x70), .O(new_n794_));
  nand2  g700(.a(new_n179_), .b(x12), .O(new_n795_));
  nand3  g701(.a(new_n181_), .b(x69), .c(x60), .O(new_n796_));
  nand3  g702(.a(new_n796_), .b(new_n795_), .c(new_n794_), .O(new_n797_));
  and2   g703(.a(new_n797_), .b(x67), .O(new_n798_));
  nand2  g704(.a(new_n761_), .b(new_n158_), .O(new_n799_));
  nand2  g705(.a(new_n743_), .b(new_n159_), .O(new_n800_));
  nand2  g706(.a(x69), .b(new_n168_), .O(new_n801_));
  aoi21  g707(.a(new_n800_), .b(new_n799_), .c(new_n801_), .O(new_n802_));
  oai21  g708(.a(new_n802_), .b(new_n798_), .c(new_n153_), .O(new_n803_));
  nand2  g709(.a(new_n743_), .b(new_n168_), .O(new_n804_));
  oai21  g710(.a(new_n168_), .b(new_n279_), .c(new_n804_), .O(new_n805_));
  nand2  g711(.a(new_n805_), .b(new_n327_), .O(new_n806_));
  aoi21  g712(.a(new_n806_), .b(new_n803_), .c(x66), .O(new_n807_));
  nand2  g713(.a(new_n797_), .b(new_n153_), .O(new_n808_));
  nand3  g714(.a(new_n186_), .b(x68), .c(x44), .O(new_n809_));
  aoi21  g715(.a(new_n809_), .b(new_n808_), .c(new_n332_), .O(new_n810_));
  oai21  g716(.a(new_n810_), .b(new_n807_), .c(new_n204_), .O(new_n811_));
  nand2  g717(.a(new_n811_), .b(new_n792_), .O(z12));
  inv1   g718(.a(new_n96_), .O(new_n813_));
  nand3  g719(.a(new_n813_), .b(new_n268_), .c(x00), .O(new_n814_));
  oai21  g720(.a(new_n96_), .b(new_n107_), .c(x13), .O(new_n815_));
  aoi21  g721(.a(new_n815_), .b(new_n814_), .c(new_n131_), .O(new_n816_));
  nand2  g722(.a(new_n816_), .b(new_n136_), .O(new_n817_));
  inv1   g723(.a(new_n817_), .O(new_n818_));
  nand2  g724(.a(new_n141_), .b(x61), .O(new_n819_));
  inv1   g725(.a(x57), .O(new_n820_));
  nand2  g726(.a(x74), .b(x56), .O(new_n821_));
  oai21  g727(.a(x74), .b(new_n820_), .c(new_n821_), .O(new_n822_));
  nand2  g728(.a(new_n822_), .b(new_n146_), .O(new_n823_));
  nand2  g729(.a(new_n732_), .b(x53), .O(new_n824_));
  nand2  g730(.a(new_n824_), .b(new_n823_), .O(new_n825_));
  nand2  g731(.a(new_n825_), .b(x72), .O(new_n826_));
  nand2  g732(.a(x74), .b(x58), .O(new_n827_));
  nand2  g733(.a(new_n143_), .b(x59), .O(new_n828_));
  nand2  g734(.a(new_n828_), .b(new_n827_), .O(new_n829_));
  nand2  g735(.a(new_n829_), .b(x73), .O(new_n830_));
  nand2  g736(.a(new_n228_), .b(x60), .O(new_n831_));
  nand2  g737(.a(new_n831_), .b(new_n830_), .O(new_n832_));
  nand2  g738(.a(new_n832_), .b(new_n137_), .O(new_n833_));
  nand3  g739(.a(new_n833_), .b(new_n826_), .c(new_n819_), .O(new_n834_));
  aoi21  g740(.a(new_n834_), .b(new_n744_), .c(new_n818_), .O(new_n835_));
  nand2  g741(.a(new_n141_), .b(x29), .O(new_n836_));
  nand2  g742(.a(x74), .b(x24), .O(new_n837_));
  oai21  g743(.a(x74), .b(new_n702_), .c(new_n837_), .O(new_n838_));
  nand2  g744(.a(new_n838_), .b(new_n146_), .O(new_n839_));
  nand2  g745(.a(new_n732_), .b(x21), .O(new_n840_));
  nand2  g746(.a(new_n840_), .b(new_n839_), .O(new_n841_));
  nand2  g747(.a(new_n841_), .b(x72), .O(new_n842_));
  nand2  g748(.a(x74), .b(x26), .O(new_n843_));
  nand2  g749(.a(new_n143_), .b(x27), .O(new_n844_));
  nand2  g750(.a(new_n844_), .b(new_n843_), .O(new_n845_));
  nand2  g751(.a(new_n845_), .b(x73), .O(new_n846_));
  nand2  g752(.a(new_n228_), .b(x28), .O(new_n847_));
  nand2  g753(.a(new_n847_), .b(new_n846_), .O(new_n848_));
  nand2  g754(.a(new_n848_), .b(new_n137_), .O(new_n849_));
  nand3  g755(.a(new_n849_), .b(new_n842_), .c(new_n836_), .O(new_n850_));
  nand2  g756(.a(new_n850_), .b(new_n763_), .O(new_n851_));
  oai21  g757(.a(new_n835_), .b(new_n155_), .c(new_n851_), .O(new_n852_));
  nand2  g758(.a(new_n852_), .b(new_n111_), .O(new_n853_));
  aoi21  g759(.a(new_n840_), .b(new_n839_), .c(new_n137_), .O(new_n854_));
  aoi21  g760(.a(new_n847_), .b(new_n846_), .c(x72), .O(new_n855_));
  oai21  g761(.a(new_n855_), .b(new_n854_), .c(new_n131_), .O(new_n856_));
  inv1   g762(.a(x29), .O(new_n857_));
  nand2  g763(.a(x71), .b(x61), .O(new_n858_));
  oai21  g764(.a(x71), .b(new_n857_), .c(new_n858_), .O(new_n859_));
  nand2  g765(.a(new_n859_), .b(new_n141_), .O(new_n860_));
  aoi21  g766(.a(new_n824_), .b(new_n823_), .c(new_n137_), .O(new_n861_));
  aoi21  g767(.a(new_n831_), .b(new_n830_), .c(x72), .O(new_n862_));
  oai21  g768(.a(new_n862_), .b(new_n861_), .c(x71), .O(new_n863_));
  nand3  g769(.a(new_n863_), .b(new_n860_), .c(new_n856_), .O(new_n864_));
  nand2  g770(.a(new_n864_), .b(new_n165_), .O(new_n865_));
  inv1   g771(.a(new_n116_), .O(new_n866_));
  nand3  g772(.a(new_n866_), .b(new_n280_), .c(x32), .O(new_n867_));
  oai21  g773(.a(new_n116_), .b(new_n127_), .c(x45), .O(new_n868_));
  aoi21  g774(.a(new_n868_), .b(new_n867_), .c(x71), .O(new_n869_));
  nand2  g775(.a(new_n869_), .b(new_n784_), .O(new_n870_));
  nand2  g776(.a(new_n870_), .b(new_n865_), .O(new_n871_));
  nand2  g777(.a(new_n871_), .b(x70), .O(new_n872_));
  aoi21  g778(.a(new_n872_), .b(new_n853_), .c(new_n93_), .O(new_n873_));
  nand2  g779(.a(new_n816_), .b(new_n111_), .O(new_n874_));
  nand2  g780(.a(new_n869_), .b(x70), .O(new_n875_));
  aoi21  g781(.a(new_n875_), .b(new_n874_), .c(new_n171_), .O(new_n876_));
  oai21  g782(.a(new_n876_), .b(new_n873_), .c(new_n203_), .O(new_n877_));
  oai22  g783(.a(new_n176_), .b(new_n857_), .c(new_n131_), .d(new_n280_), .O(new_n878_));
  nand2  g784(.a(new_n878_), .b(x70), .O(new_n879_));
  nand2  g785(.a(new_n179_), .b(x13), .O(new_n880_));
  nand3  g786(.a(new_n181_), .b(x69), .c(x61), .O(new_n881_));
  nand3  g787(.a(new_n881_), .b(new_n880_), .c(new_n879_), .O(new_n882_));
  and2   g788(.a(new_n882_), .b(x67), .O(new_n883_));
  nand2  g789(.a(new_n850_), .b(new_n158_), .O(new_n884_));
  nand2  g790(.a(new_n834_), .b(new_n159_), .O(new_n885_));
  aoi21  g791(.a(new_n885_), .b(new_n884_), .c(new_n801_), .O(new_n886_));
  oai21  g792(.a(new_n886_), .b(new_n883_), .c(new_n153_), .O(new_n887_));
  nand2  g793(.a(new_n834_), .b(new_n168_), .O(new_n888_));
  oai21  g794(.a(new_n168_), .b(new_n280_), .c(new_n888_), .O(new_n889_));
  nand2  g795(.a(new_n889_), .b(new_n327_), .O(new_n890_));
  aoi21  g796(.a(new_n890_), .b(new_n887_), .c(x66), .O(new_n891_));
  nand2  g797(.a(new_n882_), .b(new_n153_), .O(new_n892_));
  nand3  g798(.a(new_n186_), .b(x68), .c(x45), .O(new_n893_));
  aoi21  g799(.a(new_n893_), .b(new_n892_), .c(new_n332_), .O(new_n894_));
  oai21  g800(.a(new_n894_), .b(new_n891_), .c(new_n204_), .O(new_n895_));
  nand2  g801(.a(new_n895_), .b(new_n877_), .O(z13));
  nand2  g802(.a(x15), .b(x00), .O(new_n897_));
  xor2a  g803(.a(new_n897_), .b(x14), .O(new_n898_));
  nor2   g804(.a(new_n898_), .b(new_n131_), .O(new_n899_));
  nand2  g805(.a(new_n141_), .b(x62), .O(new_n900_));
  nand2  g806(.a(new_n738_), .b(new_n146_), .O(new_n901_));
  nand2  g807(.a(new_n732_), .b(x54), .O(new_n902_));
  nand2  g808(.a(new_n902_), .b(new_n901_), .O(new_n903_));
  nand2  g809(.a(new_n903_), .b(x72), .O(new_n904_));
  inv1   g810(.a(x60), .O(new_n905_));
  nand2  g811(.a(x74), .b(x59), .O(new_n906_));
  oai21  g812(.a(x74), .b(new_n905_), .c(new_n906_), .O(new_n907_));
  nand2  g813(.a(new_n907_), .b(x73), .O(new_n908_));
  nand2  g814(.a(new_n228_), .b(x61), .O(new_n909_));
  nand2  g815(.a(new_n909_), .b(new_n908_), .O(new_n910_));
  nand2  g816(.a(new_n910_), .b(new_n137_), .O(new_n911_));
  nand3  g817(.a(new_n911_), .b(new_n904_), .c(new_n900_), .O(new_n912_));
  aoi22  g818(.a(new_n912_), .b(new_n744_), .c(new_n899_), .d(new_n136_), .O(new_n913_));
  nand2  g819(.a(new_n141_), .b(x30), .O(new_n914_));
  nand2  g820(.a(new_n756_), .b(new_n146_), .O(new_n915_));
  nand2  g821(.a(new_n732_), .b(x22), .O(new_n916_));
  nand2  g822(.a(new_n916_), .b(new_n915_), .O(new_n917_));
  nand2  g823(.a(new_n917_), .b(x72), .O(new_n918_));
  nand2  g824(.a(x74), .b(x27), .O(new_n919_));
  oai21  g825(.a(x74), .b(new_n769_), .c(new_n919_), .O(new_n920_));
  nand2  g826(.a(new_n920_), .b(x73), .O(new_n921_));
  nand2  g827(.a(new_n228_), .b(x29), .O(new_n922_));
  nand2  g828(.a(new_n922_), .b(new_n921_), .O(new_n923_));
  nand2  g829(.a(new_n923_), .b(new_n137_), .O(new_n924_));
  nand3  g830(.a(new_n924_), .b(new_n918_), .c(new_n914_), .O(new_n925_));
  nand2  g831(.a(new_n925_), .b(new_n763_), .O(new_n926_));
  oai21  g832(.a(new_n913_), .b(new_n155_), .c(new_n926_), .O(new_n927_));
  nand2  g833(.a(new_n927_), .b(new_n111_), .O(new_n928_));
  aoi21  g834(.a(new_n916_), .b(new_n915_), .c(new_n137_), .O(new_n929_));
  aoi21  g835(.a(new_n922_), .b(new_n921_), .c(x72), .O(new_n930_));
  oai21  g836(.a(new_n930_), .b(new_n929_), .c(new_n131_), .O(new_n931_));
  inv1   g837(.a(x30), .O(new_n932_));
  nand2  g838(.a(x71), .b(x62), .O(new_n933_));
  oai21  g839(.a(x71), .b(new_n932_), .c(new_n933_), .O(new_n934_));
  nand2  g840(.a(new_n934_), .b(new_n141_), .O(new_n935_));
  aoi21  g841(.a(new_n902_), .b(new_n901_), .c(new_n137_), .O(new_n936_));
  aoi21  g842(.a(new_n909_), .b(new_n908_), .c(x72), .O(new_n937_));
  oai21  g843(.a(new_n937_), .b(new_n936_), .c(x71), .O(new_n938_));
  nand3  g844(.a(new_n938_), .b(new_n935_), .c(new_n931_), .O(new_n939_));
  nand2  g845(.a(new_n939_), .b(new_n165_), .O(new_n940_));
  nand2  g846(.a(x47), .b(x32), .O(new_n941_));
  xor2a  g847(.a(new_n941_), .b(x46), .O(new_n942_));
  nor2   g848(.a(new_n942_), .b(x71), .O(new_n943_));
  nand2  g849(.a(new_n943_), .b(new_n784_), .O(new_n944_));
  nand2  g850(.a(new_n944_), .b(new_n940_), .O(new_n945_));
  nand2  g851(.a(new_n945_), .b(x70), .O(new_n946_));
  aoi21  g852(.a(new_n946_), .b(new_n928_), .c(new_n93_), .O(new_n947_));
  nand2  g853(.a(new_n899_), .b(new_n111_), .O(new_n948_));
  nand2  g854(.a(new_n943_), .b(x70), .O(new_n949_));
  aoi21  g855(.a(new_n949_), .b(new_n948_), .c(new_n171_), .O(new_n950_));
  oai21  g856(.a(new_n950_), .b(new_n947_), .c(new_n203_), .O(new_n951_));
  inv1   g857(.a(x46), .O(new_n952_));
  oai22  g858(.a(new_n176_), .b(new_n932_), .c(new_n131_), .d(new_n952_), .O(new_n953_));
  nand2  g859(.a(new_n953_), .b(x70), .O(new_n954_));
  nand2  g860(.a(new_n179_), .b(x14), .O(new_n955_));
  nand3  g861(.a(new_n181_), .b(x69), .c(x62), .O(new_n956_));
  nand3  g862(.a(new_n956_), .b(new_n955_), .c(new_n954_), .O(new_n957_));
  and2   g863(.a(new_n957_), .b(x67), .O(new_n958_));
  nand2  g864(.a(new_n925_), .b(new_n158_), .O(new_n959_));
  nand2  g865(.a(new_n912_), .b(new_n159_), .O(new_n960_));
  aoi21  g866(.a(new_n960_), .b(new_n959_), .c(new_n801_), .O(new_n961_));
  oai21  g867(.a(new_n961_), .b(new_n958_), .c(new_n153_), .O(new_n962_));
  nand2  g868(.a(new_n912_), .b(new_n168_), .O(new_n963_));
  oai21  g869(.a(new_n168_), .b(new_n952_), .c(new_n963_), .O(new_n964_));
  nand2  g870(.a(new_n964_), .b(new_n327_), .O(new_n965_));
  aoi21  g871(.a(new_n965_), .b(new_n962_), .c(x66), .O(new_n966_));
  nand2  g872(.a(new_n957_), .b(new_n153_), .O(new_n967_));
  nand3  g873(.a(new_n186_), .b(x68), .c(x46), .O(new_n968_));
  aoi21  g874(.a(new_n968_), .b(new_n967_), .c(new_n332_), .O(new_n969_));
  oai21  g875(.a(new_n969_), .b(new_n966_), .c(new_n204_), .O(new_n970_));
  nand2  g876(.a(new_n970_), .b(new_n951_), .O(z14));
  inv1   g877(.a(x31), .O(new_n972_));
  inv1   g878(.a(x47), .O(new_n973_));
  oai22  g879(.a(new_n176_), .b(new_n972_), .c(new_n131_), .d(new_n973_), .O(new_n974_));
  nand2  g880(.a(new_n974_), .b(x70), .O(new_n975_));
  nand2  g881(.a(new_n179_), .b(x15), .O(new_n976_));
  nand3  g882(.a(new_n181_), .b(x69), .c(x63), .O(new_n977_));
  nand3  g883(.a(new_n977_), .b(new_n976_), .c(new_n975_), .O(new_n978_));
  and2   g884(.a(new_n978_), .b(x67), .O(new_n979_));
  nand2  g885(.a(x74), .b(x28), .O(new_n980_));
  nand2  g886(.a(new_n143_), .b(x29), .O(new_n981_));
  aoi21  g887(.a(new_n981_), .b(new_n980_), .c(new_n146_), .O(new_n982_));
  nand2  g888(.a(new_n228_), .b(x30), .O(new_n983_));
  inv1   g889(.a(new_n983_), .O(new_n984_));
  oai21  g890(.a(new_n984_), .b(new_n982_), .c(new_n137_), .O(new_n985_));
  nand2  g891(.a(new_n141_), .b(x31), .O(new_n986_));
  aoi21  g892(.a(new_n844_), .b(new_n843_), .c(x73), .O(new_n987_));
  nand2  g893(.a(new_n732_), .b(x23), .O(new_n988_));
  inv1   g894(.a(new_n988_), .O(new_n989_));
  oai21  g895(.a(new_n989_), .b(new_n987_), .c(x72), .O(new_n990_));
  nand3  g896(.a(new_n990_), .b(new_n986_), .c(new_n985_), .O(new_n991_));
  nand2  g897(.a(new_n991_), .b(new_n158_), .O(new_n992_));
  nand2  g898(.a(x74), .b(x60), .O(new_n993_));
  nand2  g899(.a(new_n143_), .b(x61), .O(new_n994_));
  aoi21  g900(.a(new_n994_), .b(new_n993_), .c(new_n146_), .O(new_n995_));
  nand2  g901(.a(new_n228_), .b(x62), .O(new_n996_));
  inv1   g902(.a(new_n996_), .O(new_n997_));
  oai21  g903(.a(new_n997_), .b(new_n995_), .c(new_n137_), .O(new_n998_));
  nand2  g904(.a(new_n141_), .b(x63), .O(new_n999_));
  aoi21  g905(.a(new_n828_), .b(new_n827_), .c(x73), .O(new_n1000_));
  nand2  g906(.a(new_n732_), .b(x55), .O(new_n1001_));
  inv1   g907(.a(new_n1001_), .O(new_n1002_));
  oai21  g908(.a(new_n1002_), .b(new_n1000_), .c(x72), .O(new_n1003_));
  nand3  g909(.a(new_n1003_), .b(new_n999_), .c(new_n998_), .O(new_n1004_));
  nand2  g910(.a(new_n1004_), .b(new_n159_), .O(new_n1005_));
  aoi21  g911(.a(new_n1005_), .b(new_n992_), .c(new_n801_), .O(new_n1006_));
  oai21  g912(.a(new_n1006_), .b(new_n979_), .c(new_n189_), .O(new_n1007_));
  nand2  g913(.a(new_n978_), .b(new_n190_), .O(new_n1008_));
  aoi21  g914(.a(new_n1008_), .b(new_n1007_), .c(new_n600_), .O(new_n1009_));
  nand4  g915(.a(new_n94_), .b(x69), .c(x65), .d(new_n203_), .O(new_n1010_));
  aoi21  g916(.a(new_n1005_), .b(new_n992_), .c(new_n1010_), .O(new_n1011_));
  ...
  aoi21  g920(.a(new_n1004_), .b(new_n744_), .c(new_n1014_), .O(new_n1015_));
  ...
  oai21  g928(.a(new_n191_), .b(new_n973_), .c(new_n1022_), .O(new_n1023_));
