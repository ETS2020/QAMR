// Benchmark "FAU" written by ABC on Sun Aug  2 11:15:06 2020
...
module FAU ( 
  ...
  oai21  g714(.a(new_n268_), .b(new_n107_), .c(x12), .O(new_n808_));
  inv1   g715(.a(new_n268_), .O(new_n809_));
  nor2   g716(.a(x12), .b(new_n107_), .O(new_n810_));
  nand2  g717(.a(new_n810_), .b(new_n809_), .O(new_n811_));
  aoi21  g718(.a(new_n811_), .b(new_n808_), .c(new_n131_), .O(new_n812_));
  nand2  g719(.a(new_n812_), .b(new_n136_), .O(new_n813_));
  nand2  g720(.a(new_n141_), .b(x60), .O(new_n814_));
  nand2  g721(.a(new_n734_), .b(new_n146_), .O(new_n815_));
  nand2  g722(.a(new_n728_), .b(x52), .O(new_n816_));
  nand2  g723(.a(new_n816_), .b(new_n815_), .O(new_n817_));
  nand2  g724(.a(new_n817_), .b(x72), .O(new_n818_));
  inv1   g725(.a(x58), .O(new_n819_));
  nand2  g726(.a(x74), .b(x57), .O(new_n820_));
  oai21  g727(.a(x74), .b(new_n819_), .c(new_n820_), .O(new_n821_));
  nand2  g728(.a(new_n821_), .b(x73), .O(new_n822_));
  nand2  g729(.a(new_n228_), .b(x59), .O(new_n823_));
  nand2  g730(.a(new_n823_), .b(new_n822_), .O(new_n824_));
  nand2  g731(.a(new_n824_), .b(new_n137_), .O(new_n825_));
  nand3  g732(.a(new_n825_), .b(new_n818_), .c(new_n814_), .O(new_n826_));
  nand2  g733(.a(new_n826_), .b(new_n740_), .O(new_n827_));
  aoi21  g734(.a(new_n827_), .b(new_n813_), .c(new_n155_), .O(new_n828_));
  nand2  g735(.a(new_n141_), .b(x28), .O(new_n829_));
  nand2  g736(.a(new_n750_), .b(new_n146_), .O(new_n830_));
  nand2  g737(.a(new_n728_), .b(x20), .O(new_n831_));
  nand2  g738(.a(new_n831_), .b(new_n830_), .O(new_n832_));
  nand2  g739(.a(new_n832_), .b(x72), .O(new_n833_));
  nand2  g740(.a(x74), .b(x25), .O(new_n834_));
  oai21  g741(.a(x74), .b(new_n763_), .c(new_n834_), .O(new_n835_));
  ...
  nand3  g746(.a(new_n839_), .b(new_n833_), .c(new_n829_), .O(new_n840_));
  inv1   g747(.a(new_n840_), .O(new_n841_));
  nor2   g748(.a(new_n841_), .b(new_n757_), .O(new_n842_));
  oai21  g749(.a(new_n842_), .b(new_n828_), .c(new_n111_), .O(new_n843_));
  aoi21  g750(.a(new_n831_), .b(new_n830_), .c(new_n137_), .O(new_n844_));
  ...
  aoi21  g757(.a(new_n816_), .b(new_n815_), .c(new_n137_), .O(new_n851_));
  aoi21  g758(.a(new_n823_), .b(new_n822_), .c(x72), .O(new_n852_));
  ...
  oai21  g762(.a(new_n280_), .b(new_n127_), .c(x44), .O(new_n856_));
  inv1   g763(.a(x44), .O(new_n857_));
  inv1   g764(.a(new_n280_), .O(new_n858_));
  nand3  g765(.a(new_n858_), .b(new_n857_), .c(x32), .O(new_n859_));
  aoi21  g766(.a(new_n859_), .b(new_n856_), .c(x71), .O(new_n860_));
  nand2  g767(.a(new_n860_), .b(new_n778_), .O(new_n861_));
  ...
  nand2  g771(.a(new_n812_), .b(new_n111_), .O(new_n865_));
  ...
  nand2  g782(.a(new_n826_), .b(new_n159_), .O(new_n876_));
  aoi21  g783(.a(new_n876_), .b(new_n875_), .c(new_n795_), .O(new_n877_));
  oai21  g784(.a(new_n877_), .b(new_n874_), .c(new_n153_), .O(new_n878_));
  nand2  g785(.a(new_n826_), .b(new_n168_), .O(new_n879_));
  oai21  g786(.a(new_n168_), .b(new_n857_), .c(new_n879_), .O(new_n880_));
  nand2  g787(.a(new_n880_), .b(new_n327_), .O(new_n881_));
  ...
  aoi21  g791(.a(new_n884_), .b(new_n883_), .c(new_n332_), .O(new_n885_));
  ...
  nand2  g812(.a(new_n728_), .b(x23), .O(new_n908_));
  ...
  nand2  g827(.a(new_n728_), .b(x55), .O(new_n923_));
  ...
  aoi21  g832(.a(new_n927_), .b(new_n912_), .c(new_n795_), .O(new_n928_));
  oai21  g833(.a(new_n928_), .b(new_n897_), .c(new_n189_), .O(new_n929_));
  nand2  g834(.a(new_n896_), .b(new_n190_), .O(new_n930_));
  aoi21  g835(.a(new_n930_), .b(new_n929_), .c(new_n600_), .O(new_n931_));
  ...
  aoi21  g841(.a(new_n926_), .b(new_n740_), .c(new_n936_), .O(new_n937_));
  ...
  aoi21  g846(.a(new_n941_), .b(new_n940_), .c(new_n387_), .O(new_n942_));
