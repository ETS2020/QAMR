// Benchmark "FAU" written by ABC on Sun Aug  2 12:28:30 2020
...
module FAU ( 
  ...
  and2   g661(.a(new_n754_), .b(new_n752_), .O(new_n755_));
  ...
  and2   g747(.a(new_n840_), .b(new_n754_), .O(new_n841_));
  oai21  g748(.a(new_n841_), .b(new_n825_), .c(new_n111_), .O(new_n842_));
  aoi21  g749(.a(new_n830_), .b(new_n829_), .c(new_n137_), .O(new_n843_));
  aoi21  g750(.a(new_n837_), .b(new_n836_), .c(x72), .O(new_n844_));
  ...
  aoi21  g756(.a(new_n813_), .b(new_n812_), .c(new_n137_), .O(new_n850_));
  aoi21  g757(.a(new_n820_), .b(new_n819_), .c(x72), .O(new_n851_));
  ...
  nand2  g766(.a(new_n859_), .b(new_n773_), .O(new_n860_));
  ...
  nand2  g770(.a(new_n806_), .b(new_n111_), .O(new_n864_));
  ...
  nand2  g780(.a(new_n840_), .b(new_n158_), .O(new_n874_));
  nand2  g781(.a(new_n823_), .b(new_n159_), .O(new_n875_));
  aoi21  g782(.a(new_n875_), .b(new_n874_), .c(new_n790_), .O(new_n876_));
  oai21  g783(.a(new_n876_), .b(new_n873_), .c(new_n153_), .O(new_n877_));
  nand2  g784(.a(new_n823_), .b(new_n168_), .O(new_n878_));
  ...
  aoi21  g790(.a(new_n883_), .b(new_n882_), .c(new_n330_), .O(new_n884_));
  oai21  g791(.a(new_n884_), .b(new_n881_), .c(new_n204_), .O(new_n885_));
  nand2  g792(.a(new_n885_), .b(new_n867_), .O(z12));
  nand2  g793(.a(x15), .b(x00), .O(new_n888_));
  xor2a  g794(.a(new_n888_), .b(x14), .O(new_n889_));
  nor2   g795(.a(new_n889_), .b(new_n131_), .O(new_n890_));
  nand2  g796(.a(new_n141_), .b(x62), .O(new_n891_));
  nand2  g797(.a(new_n818_), .b(new_n146_), .O(new_n892_));
  nand2  g798(.a(new_n725_), .b(x54), .O(new_n893_));
  nand2  g799(.a(new_n893_), .b(new_n892_), .O(new_n894_));
  nand2  g800(.a(new_n894_), .b(x72), .O(new_n895_));
  inv1   g801(.a(x60), .O(new_n896_));
  nand2  g802(.a(x74), .b(x59), .O(new_n897_));
  oai21  g803(.a(x74), .b(new_n896_), .c(new_n897_), .O(new_n898_));
  nand2  g804(.a(new_n898_), .b(x73), .O(new_n899_));
  nand2  g805(.a(new_n228_), .b(x61), .O(new_n900_));
  nand2  g806(.a(new_n900_), .b(new_n899_), .O(new_n901_));
  nand2  g807(.a(new_n901_), .b(new_n137_), .O(new_n902_));
  nand3  g808(.a(new_n902_), .b(new_n895_), .c(new_n891_), .O(new_n903_));
  aoi22  g809(.a(new_n903_), .b(new_n737_), .c(new_n890_), .d(new_n136_), .O(new_n904_));
  nand2  g810(.a(new_n141_), .b(x30), .O(new_n905_));
  nand2  g811(.a(new_n835_), .b(new_n146_), .O(new_n906_));
  nand2  g812(.a(new_n725_), .b(x22), .O(new_n907_));
  nand2  g813(.a(new_n907_), .b(new_n906_), .O(new_n908_));
  nand2  g814(.a(new_n908_), .b(x72), .O(new_n909_));
  nand2  g815(.a(x74), .b(x27), .O(new_n910_));
  oai21  g816(.a(x74), .b(new_n846_), .c(new_n910_), .O(new_n911_));
  nand2  g817(.a(new_n911_), .b(x73), .O(new_n912_));
  nand2  g818(.a(new_n228_), .b(x29), .O(new_n913_));
  nand2  g819(.a(new_n913_), .b(new_n912_), .O(new_n914_));
  nand2  g820(.a(new_n914_), .b(new_n137_), .O(new_n915_));
  nand3  g821(.a(new_n915_), .b(new_n909_), .c(new_n905_), .O(new_n916_));
  nand2  g822(.a(new_n916_), .b(new_n754_), .O(new_n917_));
  oai21  g823(.a(new_n904_), .b(new_n155_), .c(new_n917_), .O(new_n918_));
  nand2  g824(.a(new_n918_), .b(new_n111_), .O(new_n919_));
  aoi21  g825(.a(new_n907_), .b(new_n906_), .c(new_n137_), .O(new_n920_));
  aoi21  g826(.a(new_n913_), .b(new_n912_), .c(x72), .O(new_n921_));
  oai21  g827(.a(new_n921_), .b(new_n920_), .c(new_n131_), .O(new_n922_));
  inv1   g828(.a(x30), .O(new_n923_));
  nand2  g829(.a(x71), .b(x62), .O(new_n924_));
  oai21  g830(.a(x71), .b(new_n923_), .c(new_n924_), .O(new_n925_));
  nand2  g831(.a(new_n925_), .b(new_n141_), .O(new_n926_));
  aoi21  g832(.a(new_n893_), .b(new_n892_), .c(new_n137_), .O(new_n927_));
  aoi21  g833(.a(new_n900_), .b(new_n899_), .c(x72), .O(new_n928_));
  oai21  g834(.a(new_n928_), .b(new_n927_), .c(x71), .O(new_n929_));
  nand3  g835(.a(new_n929_), .b(new_n926_), .c(new_n922_), .O(new_n930_));
  nand2  g836(.a(new_n930_), .b(new_n165_), .O(new_n931_));
  nand2  g837(.a(x47), .b(x32), .O(new_n932_));
  xor2a  g838(.a(new_n932_), .b(x46), .O(new_n933_));
  nor2   g839(.a(new_n933_), .b(x71), .O(new_n934_));
  nand2  g840(.a(new_n934_), .b(new_n773_), .O(new_n935_));
  nand2  g841(.a(new_n935_), .b(new_n931_), .O(new_n936_));
  nand2  g842(.a(new_n936_), .b(x70), .O(new_n937_));
  aoi21  g843(.a(new_n937_), .b(new_n919_), .c(new_n93_), .O(new_n938_));
  nand2  g844(.a(new_n890_), .b(new_n111_), .O(new_n939_));
  nand2  g845(.a(new_n934_), .b(x70), .O(new_n940_));
  aoi21  g846(.a(new_n940_), .b(new_n939_), .c(new_n171_), .O(new_n941_));
  oai21  g847(.a(new_n941_), .b(new_n938_), .c(new_n203_), .O(new_n942_));
  nand2  g848(.a(x71), .b(x46), .O(new_n943_));
  oai21  g849(.a(new_n176_), .b(new_n923_), .c(new_n943_), .O(new_n944_));
  nand2  g850(.a(new_n944_), .b(x70), .O(new_n945_));
  nand2  g851(.a(new_n179_), .b(x14), .O(new_n946_));
  nand3  g852(.a(new_n181_), .b(x69), .c(x62), .O(new_n947_));
  nand3  g853(.a(new_n947_), .b(new_n946_), .c(new_n945_), .O(new_n948_));
  and2   g854(.a(new_n948_), .b(x67), .O(new_n949_));
  nand2  g855(.a(new_n916_), .b(new_n158_), .O(new_n950_));
  nand2  g856(.a(new_n903_), .b(new_n159_), .O(new_n951_));
  aoi21  g857(.a(new_n951_), .b(new_n950_), .c(new_n790_), .O(new_n952_));
  oai21  g858(.a(new_n952_), .b(new_n949_), .c(new_n153_), .O(new_n953_));
  nand2  g859(.a(new_n903_), .b(new_n168_), .O(new_n954_));
  nand2  g860(.a(x67), .b(x46), .O(new_n955_));
  nand2  g861(.a(new_n955_), .b(new_n954_), .O(new_n956_));
  nand2  g862(.a(new_n956_), .b(new_n325_), .O(new_n957_));
  aoi21  g863(.a(new_n957_), .b(new_n953_), .c(x66), .O(new_n958_));
  nand2  g864(.a(new_n948_), .b(new_n153_), .O(new_n959_));
  nand3  g865(.a(new_n186_), .b(x68), .c(x46), .O(new_n960_));
  aoi21  g866(.a(new_n960_), .b(new_n959_), .c(new_n330_), .O(new_n961_));
  oai21  g867(.a(new_n961_), .b(new_n958_), .c(new_n204_), .O(new_n962_));
  nand2  g868(.a(new_n962_), .b(new_n942_), .O(z14));
  inv1   g869(.a(x31), .O(new_n964_));
  inv1   g870(.a(x47), .O(new_n965_));
  oai22  g871(.a(new_n176_), .b(new_n964_), .c(new_n131_), .d(new_n965_), .O(new_n966_));
  nand2  g872(.a(new_n966_), .b(x70), .O(new_n967_));
  nand2  g873(.a(new_n179_), .b(x15), .O(new_n968_));
  nand3  g874(.a(new_n181_), .b(x69), .c(x63), .O(new_n969_));
  nand3  g875(.a(new_n969_), .b(new_n968_), .c(new_n967_), .O(new_n970_));
  and2   g876(.a(new_n970_), .b(x67), .O(new_n971_));
  nand2  g877(.a(x74), .b(x28), .O(new_n972_));
  nand2  g878(.a(new_n143_), .b(x29), .O(new_n973_));
  aoi21  g879(.a(new_n973_), .b(new_n972_), .c(new_n146_), .O(new_n974_));
  nand2  g880(.a(new_n228_), .b(x30), .O(new_n975_));
  inv1   g881(.a(new_n975_), .O(new_n976_));
  oai21  g882(.a(new_n976_), .b(new_n974_), .c(new_n137_), .O(new_n977_));
  nand2  g883(.a(new_n141_), .b(x31), .O(new_n978_));
  nand2  g884(.a(x74), .b(x26), .O(new_n979_));
  nand2  g885(.a(new_n143_), .b(x27), .O(new_n980_));
  aoi21  g886(.a(new_n980_), .b(new_n979_), .c(x73), .O(new_n981_));
  nand2  g887(.a(new_n725_), .b(x23), .O(new_n982_));
  inv1   g888(.a(new_n982_), .O(new_n983_));
  oai21  g889(.a(new_n983_), .b(new_n981_), .c(x72), .O(new_n984_));
  nand3  g890(.a(new_n984_), .b(new_n978_), .c(new_n977_), .O(new_n985_));
  nand2  g891(.a(new_n985_), .b(new_n158_), .O(new_n986_));
  nand2  g892(.a(x74), .b(x60), .O(new_n987_));
  nand2  g893(.a(new_n143_), .b(x61), .O(new_n988_));
  aoi21  g894(.a(new_n988_), .b(new_n987_), .c(new_n146_), .O(new_n989_));
  nand2  g895(.a(new_n228_), .b(x62), .O(new_n990_));
  inv1   g896(.a(new_n990_), .O(new_n991_));
  oai21  g897(.a(new_n991_), .b(new_n989_), .c(new_n137_), .O(new_n992_));
  nand2  g898(.a(new_n141_), .b(x63), .O(new_n993_));
  nand2  g899(.a(x74), .b(x58), .O(new_n994_));
  nand2  g900(.a(new_n143_), .b(x59), .O(new_n995_));
  aoi21  g901(.a(new_n995_), .b(new_n994_), .c(x73), .O(new_n996_));
  nand2  g902(.a(new_n725_), .b(x55), .O(new_n997_));
  inv1   g903(.a(new_n997_), .O(new_n998_));
  oai21  g904(.a(new_n998_), .b(new_n996_), .c(x72), .O(new_n999_));
  nand3  g905(.a(new_n999_), .b(new_n993_), .c(new_n992_), .O(new_n1000_));
  nand2  g906(.a(new_n1000_), .b(new_n159_), .O(new_n1001_));
  aoi21  g907(.a(new_n1001_), .b(new_n986_), .c(new_n790_), .O(new_n1002_));
  oai21  g908(.a(new_n1002_), .b(new_n971_), .c(new_n189_), .O(new_n1003_));
  nand2  g909(.a(new_n970_), .b(new_n190_), .O(new_n1004_));
  aoi21  g910(.a(new_n1004_), .b(new_n1003_), .c(new_n598_), .O(new_n1005_));
  nand4  g911(.a(new_n94_), .b(x69), .c(x65), .d(new_n203_), .O(new_n1006_));
  aoi21  g912(.a(new_n1001_), .b(new_n986_), .c(new_n1006_), .O(new_n1007_));
  oai21  g913(.a(new_n1007_), .b(new_n1005_), .c(new_n153_), .O(new_n1008_));
  nand3  g914(.a(x71), .b(new_n136_), .c(x15), .O(new_n1009_));
  inv1   g915(.a(new_n1009_), .O(new_n1010_));
  aoi21  g916(.a(new_n1000_), .b(new_n737_), .c(new_n1010_), .O(new_n1011_));
  nand3  g917(.a(new_n133_), .b(new_n136_), .c(x47), .O(new_n1012_));
  oai21  g918(.a(new_n1011_), .b(x70), .c(new_n1012_), .O(new_n1013_));
  nand2  g919(.a(new_n113_), .b(x15), .O(new_n1014_));
  nand2  g920(.a(new_n133_), .b(x47), .O(new_n1015_));
  aoi21  g921(.a(new_n1015_), .b(new_n1014_), .c(new_n385_), .O(new_n1016_));
  aoi21  g922(.a(new_n1013_), .b(new_n94_), .c(new_n1016_), .O(new_n1017_));
  nand2  g923(.a(new_n1000_), .b(new_n93_), .O(new_n1018_));
  oai21  g924(.a(new_n191_), .b(new_n965_), .c(new_n1018_), .O(new_n1019_));
  nand3  g925(.a(new_n1019_), .b(new_n204_), .c(new_n181_), .O(new_n1020_));
  oai21  g926(.a(new_n1017_), .b(x64), .c(new_n1020_), .O(new_n1021_));
  nand2  g927(.a(new_n1021_), .b(new_n154_), .O(new_n1022_));
  nand2  g928(.a(new_n1022_), .b(new_n1008_), .O(z15));
  zero   g929(.O(z00));
  zero   g930(.O(z10));
  zero   g931(.O(z13));
endmodule
