// Benchmark "FAU" written by ABC on Sun Aug  2 10:54:47 2020
...
module FAU ( 
  ...
  nor2   g257(.a(x13), .b(new_n99_), .O(new_n359_));
  oai21  g258(.a(x15), .b(x14), .c(new_n359_), .O(new_n360_));
  oai21  g259(.a(new_n103_), .b(new_n99_), .c(x13), .O(new_n361_));
  aoi21  g260(.a(new_n361_), .b(new_n360_), .c(new_n113_), .O(new_n362_));
  nand2  g261(.a(new_n209_), .b(x61), .O(new_n363_));
  nand2  g262(.a(x74), .b(x56), .O(new_n364_));
  nand2  g263(.a(new_n201_), .b(x57), .O(new_n365_));
  aoi21  g264(.a(new_n365_), .b(new_n364_), .c(x73), .O(new_n366_));
  nand3  g265(.a(new_n201_), .b(x73), .c(x53), .O(new_n367_));
  inv1   g266(.a(new_n367_), .O(new_n368_));
  oai21  g267(.a(new_n368_), .b(new_n366_), .c(x72), .O(new_n369_));
  nand2  g268(.a(x74), .b(x58), .O(new_n370_));
  nand2  g269(.a(new_n201_), .b(x59), .O(new_n371_));
  aoi21  g270(.a(new_n371_), .b(new_n370_), .c(new_n199_), .O(new_n372_));
  nand3  g271(.a(x74), .b(new_n199_), .c(x60), .O(new_n373_));
  inv1   g272(.a(new_n373_), .O(new_n374_));
  oai21  g273(.a(new_n374_), .b(new_n372_), .c(new_n198_), .O(new_n375_));
  nand3  g274(.a(new_n375_), .b(new_n369_), .c(new_n363_), .O(new_n376_));
  aoi22  g275(.a(new_n376_), .b(new_n286_), .c(new_n362_), .d(new_n138_), .O(new_n377_));
  nand2  g276(.a(new_n209_), .b(x29), .O(new_n378_));
  nand2  g277(.a(x74), .b(x24), .O(new_n379_));
  oai21  g278(.a(x74), .b(new_n245_), .c(new_n379_), .O(new_n380_));
  nand2  g279(.a(new_n380_), .b(new_n199_), .O(new_n381_));
  nand3  g280(.a(new_n201_), .b(x73), .c(x21), .O(new_n382_));
  nand2  g281(.a(new_n382_), .b(new_n381_), .O(new_n383_));
  nand2  g282(.a(new_n383_), .b(x72), .O(new_n384_));
  inv1   g283(.a(x27), .O(new_n385_));
  nand2  g284(.a(x74), .b(x26), .O(new_n386_));
  oai21  g285(.a(x74), .b(new_n385_), .c(new_n386_), .O(new_n387_));
  nand2  g286(.a(new_n387_), .b(x73), .O(new_n388_));
  nand3  g287(.a(x74), .b(new_n199_), .c(x28), .O(new_n389_));
  nand2  g288(.a(new_n389_), .b(new_n388_), .O(new_n390_));
  nand2  g289(.a(new_n390_), .b(new_n198_), .O(new_n391_));
  nand3  g290(.a(new_n391_), .b(new_n384_), .c(new_n378_), .O(new_n392_));
  nand2  g291(.a(new_n392_), .b(new_n306_), .O(new_n393_));
  oai21  g292(.a(new_n377_), .b(new_n143_), .c(new_n393_), .O(new_n394_));
  nand2  g293(.a(new_n394_), .b(new_n95_), .O(new_n395_));
  aoi21  g294(.a(new_n382_), .b(new_n381_), .c(new_n198_), .O(new_n396_));
  aoi21  g295(.a(new_n389_), .b(new_n388_), .c(x72), .O(new_n397_));
  oai21  g296(.a(new_n397_), .b(new_n396_), .c(new_n113_), .O(new_n398_));
  inv1   g297(.a(x29), .O(new_n399_));
  nand2  g298(.a(x71), .b(x61), .O(new_n400_));
  oai21  g299(.a(x71), .b(new_n399_), .c(new_n400_), .O(new_n401_));
  nand2  g300(.a(new_n401_), .b(new_n209_), .O(new_n402_));
  inv1   g301(.a(x57), .O(new_n403_));
  oai21  g302(.a(x74), .b(new_n403_), .c(new_n364_), .O(new_n404_));
  nand2  g303(.a(new_n404_), .b(new_n199_), .O(new_n405_));
  aoi21  g304(.a(new_n367_), .b(new_n405_), .c(new_n198_), .O(new_n406_));
  inv1   g305(.a(x59), .O(new_n407_));
  oai21  g306(.a(x74), .b(new_n407_), .c(new_n370_), .O(new_n408_));
  nand2  g307(.a(new_n408_), .b(x73), .O(new_n409_));
  aoi21  g308(.a(new_n373_), .b(new_n409_), .c(x72), .O(new_n410_));
  oai21  g309(.a(new_n410_), .b(new_n406_), .c(x71), .O(new_n411_));
  nand3  g310(.a(new_n411_), .b(new_n402_), .c(new_n398_), .O(new_n412_));
  nand2  g311(.a(new_n412_), .b(new_n309_), .O(new_n413_));
  inv1   g312(.a(new_n121_), .O(new_n414_));
  nand3  g313(.a(new_n414_), .b(new_n120_), .c(x32), .O(new_n415_));
  oai21  g314(.a(new_n121_), .b(new_n117_), .c(x45), .O(new_n416_));
  aoi21  g315(.a(new_n416_), .b(new_n415_), .c(x71), .O(new_n417_));
  nand2  g316(.a(new_n417_), .b(new_n328_), .O(new_n418_));
  nand2  g317(.a(new_n418_), .b(new_n413_), .O(new_n419_));
  nand2  g318(.a(new_n419_), .b(x70), .O(new_n420_));
  aoi21  g319(.a(new_n420_), .b(new_n395_), .c(new_n93_), .O(new_n421_));
  nand2  g320(.a(new_n362_), .b(new_n95_), .O(new_n422_));
  nand2  g321(.a(new_n417_), .b(x70), .O(new_n423_));
  aoi21  g322(.a(new_n423_), .b(new_n422_), .c(new_n242_), .O(new_n424_));
  oai21  g323(.a(new_n424_), .b(new_n421_), .c(new_n92_), .O(new_n425_));
  oai22  g324(.a(new_n158_), .b(new_n399_), .c(new_n113_), .d(new_n120_), .O(new_n426_));
  nand2  g325(.a(new_n426_), .b(x70), .O(new_n427_));
  nand2  g326(.a(new_n161_), .b(x13), .O(new_n428_));
  nand3  g327(.a(new_n132_), .b(x69), .c(x61), .O(new_n429_));
  nand3  g328(.a(new_n429_), .b(new_n428_), .c(new_n427_), .O(new_n430_));
  and2   g329(.a(new_n430_), .b(x67), .O(new_n431_));
  nand2  g330(.a(new_n392_), .b(new_n145_), .O(new_n432_));
  nand2  g331(.a(new_n376_), .b(new_n237_), .O(new_n433_));
  aoi21  g332(.a(new_n433_), .b(new_n432_), .c(new_n345_), .O(new_n434_));
  oai21  g333(.a(new_n434_), .b(new_n431_), .c(new_n141_), .O(new_n435_));
  nand2  g334(.a(new_n376_), .b(new_n136_), .O(new_n436_));
  oai21  g335(.a(new_n136_), .b(new_n120_), .c(new_n436_), .O(new_n437_));
  nand2  g336(.a(new_n437_), .b(new_n256_), .O(new_n438_));
  aoi21  g337(.a(new_n438_), .b(new_n435_), .c(x66), .O(new_n439_));
  nand2  g338(.a(new_n430_), .b(new_n141_), .O(new_n440_));
  nand3  g339(.a(new_n166_), .b(x68), .c(x45), .O(new_n441_));
  aoi21  g340(.a(new_n441_), .b(new_n440_), .c(new_n155_), .O(new_n442_));
  oai21  g341(.a(new_n442_), .b(new_n439_), .c(new_n173_), .O(new_n443_));
  nand2  g342(.a(new_n443_), .b(new_n425_), .O(z13));
