// Benchmark "FAU" written by ABC on Sun Aug  2 12:05:49 2020
...
module FAU ( 
  ...
  wire new_n92_, new_n93_, new_n94_, new_n95_, new_n96_, new_n97_, new_n98_,
    ...
    new_n440_, new_n441_, new_n445_, new_n446_, new_n447_, new_n448_,
  ...
  nand2  g343(.a(x15), .b(x00), .O(new_n445_));
  xor2a  g344(.a(new_n445_), .b(x14), .O(new_n446_));
  nor2   g345(.a(new_n446_), .b(new_n113_), .O(new_n447_));
  nand2  g346(.a(new_n209_), .b(x62), .O(new_n448_));
  nand2  g347(.a(x74), .b(x57), .O(new_n449_));
  nand2  g348(.a(new_n201_), .b(x58), .O(new_n450_));
  aoi21  g349(.a(new_n450_), .b(new_n449_), .c(x73), .O(new_n451_));
  nand3  g350(.a(new_n201_), .b(x73), .c(x54), .O(new_n452_));
  inv1   g351(.a(new_n452_), .O(new_n453_));
  oai21  g352(.a(new_n453_), .b(new_n451_), .c(x72), .O(new_n454_));
  nand2  g353(.a(x74), .b(x59), .O(new_n455_));
  nand2  g354(.a(new_n201_), .b(x60), .O(new_n456_));
  aoi21  g355(.a(new_n456_), .b(new_n455_), .c(new_n199_), .O(new_n457_));
  nand3  g356(.a(x74), .b(new_n199_), .c(x61), .O(new_n458_));
  inv1   g357(.a(new_n458_), .O(new_n459_));
  oai21  g358(.a(new_n459_), .b(new_n457_), .c(new_n198_), .O(new_n460_));
  nand3  g359(.a(new_n460_), .b(new_n454_), .c(new_n448_), .O(new_n461_));
  aoi22  g360(.a(new_n461_), .b(new_n286_), .c(new_n447_), .d(new_n138_), .O(new_n462_));
  nand2  g361(.a(new_n209_), .b(x30), .O(new_n463_));
  nand2  g362(.a(x74), .b(x25), .O(new_n464_));
  oai21  g363(.a(x74), .b(new_n313_), .c(new_n464_), .O(new_n465_));
  nand2  g364(.a(new_n465_), .b(new_n199_), .O(new_n466_));
  nand3  g365(.a(new_n201_), .b(x73), .c(x22), .O(new_n467_));
  nand2  g366(.a(new_n467_), .b(new_n466_), .O(new_n468_));
  nand2  g367(.a(new_n468_), .b(x72), .O(new_n469_));
  inv1   g368(.a(x28), .O(new_n470_));
  nand2  g369(.a(x74), .b(x27), .O(new_n471_));
  oai21  g370(.a(x74), .b(new_n470_), .c(new_n471_), .O(new_n472_));
  nand2  g371(.a(new_n472_), .b(x73), .O(new_n473_));
  nand3  g372(.a(x74), .b(new_n199_), .c(x29), .O(new_n474_));
  nand2  g373(.a(new_n474_), .b(new_n473_), .O(new_n475_));
  nand2  g374(.a(new_n475_), .b(new_n198_), .O(new_n476_));
  nand3  g375(.a(new_n476_), .b(new_n469_), .c(new_n463_), .O(new_n477_));
  nand2  g376(.a(new_n477_), .b(new_n306_), .O(new_n478_));
  oai21  g377(.a(new_n462_), .b(new_n143_), .c(new_n478_), .O(new_n479_));
  nand2  g378(.a(new_n479_), .b(new_n95_), .O(new_n480_));
  aoi21  g379(.a(new_n467_), .b(new_n466_), .c(new_n198_), .O(new_n481_));
  aoi21  g380(.a(new_n474_), .b(new_n473_), .c(x72), .O(new_n482_));
  oai21  g381(.a(new_n482_), .b(new_n481_), .c(new_n113_), .O(new_n483_));
  inv1   g382(.a(x30), .O(new_n484_));
  nand2  g383(.a(x71), .b(x62), .O(new_n485_));
  oai21  g384(.a(x71), .b(new_n484_), .c(new_n485_), .O(new_n486_));
  nand2  g385(.a(new_n486_), .b(new_n209_), .O(new_n487_));
  inv1   g386(.a(x58), .O(new_n488_));
  oai21  g387(.a(x74), .b(new_n488_), .c(new_n449_), .O(new_n489_));
  nand2  g388(.a(new_n489_), .b(new_n199_), .O(new_n490_));
  aoi21  g389(.a(new_n452_), .b(new_n490_), .c(new_n198_), .O(new_n491_));
  inv1   g390(.a(x60), .O(new_n492_));
  oai21  g391(.a(x74), .b(new_n492_), .c(new_n455_), .O(new_n493_));
  nand2  g392(.a(new_n493_), .b(x73), .O(new_n494_));
  aoi21  g393(.a(new_n458_), .b(new_n494_), .c(x72), .O(new_n495_));
  oai21  g394(.a(new_n495_), .b(new_n491_), .c(x71), .O(new_n496_));
  nand3  g395(.a(new_n496_), .b(new_n487_), .c(new_n483_), .O(new_n497_));
  nand2  g396(.a(new_n497_), .b(new_n309_), .O(new_n498_));
  nand2  g397(.a(x47), .b(x32), .O(new_n499_));
  xor2a  g398(.a(new_n499_), .b(x46), .O(new_n500_));
  nor2   g399(.a(new_n500_), .b(x71), .O(new_n501_));
  nand2  g400(.a(new_n501_), .b(new_n328_), .O(new_n502_));
  nand2  g401(.a(new_n502_), .b(new_n498_), .O(new_n503_));
  nand2  g402(.a(new_n503_), .b(x70), .O(new_n504_));
  aoi21  g403(.a(new_n504_), .b(new_n480_), .c(new_n93_), .O(new_n505_));
  nand2  g404(.a(new_n447_), .b(new_n95_), .O(new_n506_));
  nand2  g405(.a(new_n501_), .b(x70), .O(new_n507_));
  aoi21  g406(.a(new_n507_), .b(new_n506_), .c(new_n242_), .O(new_n508_));
  oai21  g407(.a(new_n508_), .b(new_n505_), .c(new_n92_), .O(new_n509_));
  nand2  g408(.a(x71), .b(x46), .O(new_n510_));
  oai21  g409(.a(new_n158_), .b(new_n484_), .c(new_n510_), .O(new_n511_));
  nand2  g410(.a(new_n511_), .b(x70), .O(new_n512_));
  nand2  g411(.a(new_n161_), .b(x14), .O(new_n513_));
  nand3  g412(.a(new_n132_), .b(x69), .c(x62), .O(new_n514_));
  nand3  g413(.a(new_n514_), .b(new_n513_), .c(new_n512_), .O(new_n515_));
  and2   g414(.a(new_n515_), .b(x67), .O(new_n516_));
  nand2  g415(.a(new_n477_), .b(new_n145_), .O(new_n517_));
  nand2  g416(.a(new_n461_), .b(new_n237_), .O(new_n518_));
  aoi21  g417(.a(new_n518_), .b(new_n517_), .c(new_n345_), .O(new_n519_));
  oai21  g418(.a(new_n519_), .b(new_n516_), .c(new_n141_), .O(new_n520_));
  nand2  g419(.a(new_n461_), .b(new_n136_), .O(new_n521_));
  nand2  g420(.a(x67), .b(x46), .O(new_n522_));
  nand2  g421(.a(new_n522_), .b(new_n521_), .O(new_n523_));
  nand2  g422(.a(new_n523_), .b(new_n256_), .O(new_n524_));
  aoi21  g423(.a(new_n524_), .b(new_n520_), .c(x66), .O(new_n525_));
  nand2  g424(.a(new_n515_), .b(new_n141_), .O(new_n526_));
  nand3  g425(.a(new_n166_), .b(x68), .c(x46), .O(new_n527_));
  aoi21  g426(.a(new_n527_), .b(new_n526_), .c(new_n155_), .O(new_n528_));
  oai21  g427(.a(new_n528_), .b(new_n525_), .c(new_n173_), .O(new_n529_));
  nand2  g428(.a(new_n529_), .b(new_n509_), .O(z14));
  zero   g429(.O(z01));
  zero   g430(.O(z02));
  zero   g431(.O(z03));
  zero   g432(.O(z04));
