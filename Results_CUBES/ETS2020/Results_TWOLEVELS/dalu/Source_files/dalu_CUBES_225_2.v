// Benchmark "FAU" written by ABC on Sun Aug  2 12:36:20 2020
...
module FAU ( 
  ...
  nand3  g217(.a(new_n308_), .b(new_n99_), .c(new_n307_), .O(new_n309_));
  ...
  nand3  g228(.a(new_n319_), .b(new_n115_), .c(new_n318_), .O(new_n320_));
  ...
  oai21  g747(.a(new_n308_), .b(new_n96_), .c(x12), .O(new_n840_));
  inv1   g748(.a(new_n308_), .O(new_n841_));
  nor2   g749(.a(x12), .b(new_n96_), .O(new_n842_));
  nand2  g750(.a(new_n842_), .b(new_n841_), .O(new_n843_));
  aoi21  g751(.a(new_n843_), .b(new_n840_), .c(new_n116_), .O(new_n844_));
  nand2  g752(.a(new_n844_), .b(new_n134_), .O(new_n845_));
  nand2  g753(.a(new_n207_), .b(x60), .O(new_n846_));
  inv1   g754(.a(x56), .O(new_n847_));
  nand2  g755(.a(x74), .b(x55), .O(new_n848_));
  oai21  g756(.a(x74), .b(new_n847_), .c(new_n848_), .O(new_n849_));
  nand2  g757(.a(new_n849_), .b(new_n212_), .O(new_n850_));
  nand2  g758(.a(new_n763_), .b(x52), .O(new_n851_));
  nand2  g759(.a(new_n851_), .b(new_n850_), .O(new_n852_));
  nand2  g760(.a(new_n852_), .b(x72), .O(new_n853_));
  inv1   g761(.a(x58), .O(new_n854_));
  nand2  g762(.a(x74), .b(x57), .O(new_n855_));
  oai21  g763(.a(x74), .b(new_n854_), .c(new_n855_), .O(new_n856_));
  nand2  g764(.a(new_n856_), .b(x73), .O(new_n857_));
  nand2  g765(.a(new_n268_), .b(x59), .O(new_n858_));
  nand2  g766(.a(new_n858_), .b(new_n857_), .O(new_n859_));
  nand2  g767(.a(new_n859_), .b(new_n203_), .O(new_n860_));
  nand3  g768(.a(new_n860_), .b(new_n853_), .c(new_n846_), .O(new_n861_));
  nand2  g769(.a(new_n861_), .b(new_n775_), .O(new_n862_));
  aoi21  g770(.a(new_n862_), .b(new_n845_), .c(new_n141_), .O(new_n863_));
  nand2  g771(.a(new_n207_), .b(x28), .O(new_n864_));
  nand2  g772(.a(x74), .b(x23), .O(new_n865_));
  oai21  g773(.a(x74), .b(new_n678_), .c(new_n865_), .O(new_n866_));
  nand2  g774(.a(new_n866_), .b(new_n212_), .O(new_n867_));
  nand2  g775(.a(new_n763_), .b(x20), .O(new_n868_));
  nand2  g776(.a(new_n868_), .b(new_n867_), .O(new_n869_));
  nand2  g777(.a(new_n869_), .b(x72), .O(new_n870_));
  inv1   g778(.a(x26), .O(new_n871_));
  nand2  g779(.a(x74), .b(x25), .O(new_n872_));
  oai21  g780(.a(x74), .b(new_n871_), .c(new_n872_), .O(new_n873_));
  ...
  nand3  g785(.a(new_n877_), .b(new_n870_), .c(new_n864_), .O(new_n878_));
  and2   g786(.a(new_n878_), .b(new_n792_), .O(new_n879_));
  oai21  g787(.a(new_n879_), .b(new_n863_), .c(new_n100_), .O(new_n880_));
  aoi21  g788(.a(new_n868_), .b(new_n867_), .c(new_n203_), .O(new_n881_));
  ...
  aoi21  g795(.a(new_n851_), .b(new_n850_), .c(new_n203_), .O(new_n888_));
  aoi21  g796(.a(new_n858_), .b(new_n857_), .c(x72), .O(new_n889_));
  ...
  oai21  g800(.a(new_n319_), .b(new_n112_), .c(x44), .O(new_n893_));
  inv1   g801(.a(x44), .O(new_n894_));
  inv1   g802(.a(new_n319_), .O(new_n895_));
  nand3  g803(.a(new_n895_), .b(new_n894_), .c(x32), .O(new_n896_));
  aoi21  g804(.a(new_n896_), .b(new_n893_), .c(x71), .O(new_n897_));
  nand2  g805(.a(new_n897_), .b(new_n811_), .O(new_n898_));
  ...
  nand2  g809(.a(new_n844_), .b(new_n100_), .O(new_n902_));
  ...
  oai22  g813(.a(new_n156_), .b(new_n884_), .c(new_n116_), .d(new_n894_), .O(new_n906_));
  nand2  g814(.a(new_n906_), .b(x70), .O(new_n907_));
  nand2  g815(.a(new_n159_), .b(x12), .O(new_n908_));
  nand3  g816(.a(new_n128_), .b(x69), .c(x60), .O(new_n909_));
  nand3  g817(.a(new_n909_), .b(new_n908_), .c(new_n907_), .O(new_n910_));
  and2   g818(.a(new_n910_), .b(x67), .O(new_n911_));
  nand2  g819(.a(new_n878_), .b(new_n143_), .O(new_n912_));
  nand2  g820(.a(new_n861_), .b(new_n144_), .O(new_n913_));
  aoi21  g821(.a(new_n913_), .b(new_n912_), .c(new_n828_), .O(new_n914_));
  oai21  g822(.a(new_n914_), .b(new_n911_), .c(new_n139_), .O(new_n915_));
  nand2  g823(.a(new_n861_), .b(new_n133_), .O(new_n916_));
  oai21  g824(.a(new_n133_), .b(new_n894_), .c(new_n916_), .O(new_n917_));
  nand2  g825(.a(new_n917_), .b(new_n365_), .O(new_n918_));
  aoi21  g826(.a(new_n918_), .b(new_n915_), .c(x66), .O(new_n919_));
  nand2  g827(.a(new_n910_), .b(new_n139_), .O(new_n920_));
  nand3  g828(.a(new_n165_), .b(x68), .c(x44), .O(new_n921_));
  aoi21  g829(.a(new_n921_), .b(new_n920_), .c(new_n370_), .O(new_n922_));
  oai21  g830(.a(new_n922_), .b(new_n919_), .c(new_n173_), .O(new_n923_));
  nand2  g831(.a(new_n923_), .b(new_n905_), .O(z12));
  nand2  g832(.a(x15), .b(x00), .O(new_n926_));
  xor2a  g833(.a(new_n926_), .b(x14), .O(new_n927_));
  nor2   g834(.a(new_n927_), .b(new_n116_), .O(new_n928_));
  nand2  g835(.a(new_n207_), .b(x62), .O(new_n929_));
  nand2  g836(.a(new_n856_), .b(new_n212_), .O(new_n930_));
  nand2  g837(.a(new_n763_), .b(x54), .O(new_n931_));
  nand2  g838(.a(new_n931_), .b(new_n930_), .O(new_n932_));
  nand2  g839(.a(new_n932_), .b(x72), .O(new_n933_));
  inv1   g840(.a(x60), .O(new_n934_));
  nand2  g841(.a(x74), .b(x59), .O(new_n935_));
  oai21  g842(.a(x74), .b(new_n934_), .c(new_n935_), .O(new_n936_));
  nand2  g843(.a(new_n936_), .b(x73), .O(new_n937_));
  nand2  g844(.a(new_n268_), .b(x61), .O(new_n938_));
  nand2  g845(.a(new_n938_), .b(new_n937_), .O(new_n939_));
  nand2  g846(.a(new_n939_), .b(new_n203_), .O(new_n940_));
  nand3  g847(.a(new_n940_), .b(new_n933_), .c(new_n929_), .O(new_n941_));
  aoi22  g848(.a(new_n941_), .b(new_n775_), .c(new_n928_), .d(new_n134_), .O(new_n942_));
  nand2  g849(.a(new_n207_), .b(x30), .O(new_n943_));
  nand2  g850(.a(new_n873_), .b(new_n212_), .O(new_n944_));
  nand2  g851(.a(new_n763_), .b(x22), .O(new_n945_));
  nand2  g852(.a(new_n945_), .b(new_n944_), .O(new_n946_));
  nand2  g853(.a(new_n946_), .b(x72), .O(new_n947_));
  nand2  g854(.a(x74), .b(x27), .O(new_n948_));
  oai21  g855(.a(x74), .b(new_n884_), .c(new_n948_), .O(new_n949_));
  nand2  g856(.a(new_n949_), .b(x73), .O(new_n950_));
  nand2  g857(.a(new_n268_), .b(x29), .O(new_n951_));
  nand2  g858(.a(new_n951_), .b(new_n950_), .O(new_n952_));
  nand2  g859(.a(new_n952_), .b(new_n203_), .O(new_n953_));
  nand3  g860(.a(new_n953_), .b(new_n947_), .c(new_n943_), .O(new_n954_));
  nand2  g861(.a(new_n954_), .b(new_n792_), .O(new_n955_));
  oai21  g862(.a(new_n942_), .b(new_n141_), .c(new_n955_), .O(new_n956_));
  nand2  g863(.a(new_n956_), .b(new_n100_), .O(new_n957_));
  aoi21  g864(.a(new_n945_), .b(new_n944_), .c(new_n203_), .O(new_n958_));
  aoi21  g865(.a(new_n951_), .b(new_n950_), .c(x72), .O(new_n959_));
  oai21  g866(.a(new_n959_), .b(new_n958_), .c(new_n116_), .O(new_n960_));
  inv1   g867(.a(x30), .O(new_n961_));
  nand2  g868(.a(x71), .b(x62), .O(new_n962_));
  oai21  g869(.a(x71), .b(new_n961_), .c(new_n962_), .O(new_n963_));
  nand2  g870(.a(new_n963_), .b(new_n207_), .O(new_n964_));
  aoi21  g871(.a(new_n931_), .b(new_n930_), .c(new_n203_), .O(new_n965_));
  aoi21  g872(.a(new_n938_), .b(new_n937_), .c(x72), .O(new_n966_));
  oai21  g873(.a(new_n966_), .b(new_n965_), .c(x71), .O(new_n967_));
  nand3  g874(.a(new_n967_), .b(new_n964_), .c(new_n960_), .O(new_n968_));
  nand2  g875(.a(new_n968_), .b(new_n219_), .O(new_n969_));
  nand2  g876(.a(x47), .b(x32), .O(new_n970_));
  xor2a  g877(.a(new_n970_), .b(x46), .O(new_n971_));
  nor2   g878(.a(new_n971_), .b(x71), .O(new_n972_));
  nand2  g879(.a(new_n972_), .b(new_n811_), .O(new_n973_));
  nand2  g880(.a(new_n973_), .b(new_n969_), .O(new_n974_));
  nand2  g881(.a(new_n974_), .b(x70), .O(new_n975_));
  aoi21  g882(.a(new_n975_), .b(new_n957_), .c(new_n93_), .O(new_n976_));
  nand2  g883(.a(new_n928_), .b(new_n100_), .O(new_n977_));
  nand2  g884(.a(new_n972_), .b(x70), .O(new_n978_));
  aoi21  g885(.a(new_n978_), .b(new_n977_), .c(new_n226_), .O(new_n979_));
  oai21  g886(.a(new_n979_), .b(new_n976_), .c(new_n92_), .O(new_n980_));
  nand2  g887(.a(x71), .b(x46), .O(new_n981_));
  oai21  g888(.a(new_n156_), .b(new_n961_), .c(new_n981_), .O(new_n982_));
  nand2  g889(.a(new_n982_), .b(x70), .O(new_n983_));
  nand2  g890(.a(new_n159_), .b(x14), .O(new_n984_));
  nand3  g891(.a(new_n128_), .b(x69), .c(x62), .O(new_n985_));
  nand3  g892(.a(new_n985_), .b(new_n984_), .c(new_n983_), .O(new_n986_));
  and2   g893(.a(new_n986_), .b(x67), .O(new_n987_));
  nand2  g894(.a(new_n954_), .b(new_n143_), .O(new_n988_));
  nand2  g895(.a(new_n941_), .b(new_n144_), .O(new_n989_));
  aoi21  g896(.a(new_n989_), .b(new_n988_), .c(new_n828_), .O(new_n990_));
  oai21  g897(.a(new_n990_), .b(new_n987_), .c(new_n139_), .O(new_n991_));
  nand2  g898(.a(new_n941_), .b(new_n133_), .O(new_n992_));
  nand2  g899(.a(x67), .b(x46), .O(new_n993_));
  nand2  g900(.a(new_n993_), .b(new_n992_), .O(new_n994_));
  nand2  g901(.a(new_n994_), .b(new_n365_), .O(new_n995_));
  aoi21  g902(.a(new_n995_), .b(new_n991_), .c(x66), .O(new_n996_));
  nand2  g903(.a(new_n986_), .b(new_n139_), .O(new_n997_));
  nand3  g904(.a(new_n165_), .b(x68), .c(x46), .O(new_n998_));
  aoi21  g905(.a(new_n998_), .b(new_n997_), .c(new_n370_), .O(new_n999_));
  oai21  g906(.a(new_n999_), .b(new_n996_), .c(new_n173_), .O(new_n1000_));
  nand2  g907(.a(new_n1000_), .b(new_n980_), .O(z14));
  inv1   g908(.a(x31), .O(new_n1002_));
  inv1   g909(.a(x47), .O(new_n1003_));
  oai22  g910(.a(new_n156_), .b(new_n1002_), .c(new_n116_), .d(new_n1003_), .O(new_n1004_));
  nand2  g911(.a(new_n1004_), .b(x70), .O(new_n1005_));
  nand2  g912(.a(new_n159_), .b(x15), .O(new_n1006_));
  nand3  g913(.a(new_n128_), .b(x69), .c(x63), .O(new_n1007_));
  nand3  g914(.a(new_n1007_), .b(new_n1006_), .c(new_n1005_), .O(new_n1008_));
  and2   g915(.a(new_n1008_), .b(x67), .O(new_n1009_));
  nand2  g916(.a(x74), .b(x28), .O(new_n1010_));
  nand2  g917(.a(new_n209_), .b(x29), .O(new_n1011_));
  aoi21  g918(.a(new_n1011_), .b(new_n1010_), .c(new_n212_), .O(new_n1012_));
  nand2  g919(.a(new_n268_), .b(x30), .O(new_n1013_));
  inv1   g920(.a(new_n1013_), .O(new_n1014_));
  oai21  g921(.a(new_n1014_), .b(new_n1012_), .c(new_n203_), .O(new_n1015_));
  nand2  g922(.a(new_n207_), .b(x31), .O(new_n1016_));
  nand2  g923(.a(x74), .b(x26), .O(new_n1017_));
  nand2  g924(.a(new_n209_), .b(x27), .O(new_n1018_));
  aoi21  g925(.a(new_n1018_), .b(new_n1017_), .c(x73), .O(new_n1019_));
  nand2  g926(.a(new_n763_), .b(x23), .O(new_n1020_));
  inv1   g927(.a(new_n1020_), .O(new_n1021_));
  oai21  g928(.a(new_n1021_), .b(new_n1019_), .c(x72), .O(new_n1022_));
  nand3  g929(.a(new_n1022_), .b(new_n1016_), .c(new_n1015_), .O(new_n1023_));
  nand2  g930(.a(new_n1023_), .b(new_n143_), .O(new_n1024_));
  nand2  g931(.a(x74), .b(x60), .O(new_n1025_));
  nand2  g932(.a(new_n209_), .b(x61), .O(new_n1026_));
  aoi21  g933(.a(new_n1026_), .b(new_n1025_), .c(new_n212_), .O(new_n1027_));
  nand2  g934(.a(new_n268_), .b(x62), .O(new_n1028_));
  inv1   g935(.a(new_n1028_), .O(new_n1029_));
  oai21  g936(.a(new_n1029_), .b(new_n1027_), .c(new_n203_), .O(new_n1030_));
  nand2  g937(.a(new_n207_), .b(x63), .O(new_n1031_));
  nand2  g938(.a(x74), .b(x58), .O(new_n1032_));
  nand2  g939(.a(new_n209_), .b(x59), .O(new_n1033_));
  aoi21  g940(.a(new_n1033_), .b(new_n1032_), .c(x73), .O(new_n1034_));
  nand2  g941(.a(new_n763_), .b(x55), .O(new_n1035_));
  inv1   g942(.a(new_n1035_), .O(new_n1036_));
  oai21  g943(.a(new_n1036_), .b(new_n1034_), .c(x72), .O(new_n1037_));
  nand3  g944(.a(new_n1037_), .b(new_n1031_), .c(new_n1030_), .O(new_n1038_));
  nand2  g945(.a(new_n1038_), .b(new_n144_), .O(new_n1039_));
  aoi21  g946(.a(new_n1039_), .b(new_n1024_), .c(new_n828_), .O(new_n1040_));
  oai21  g947(.a(new_n1040_), .b(new_n1009_), .c(new_n151_), .O(new_n1041_));
  nand2  g948(.a(new_n1008_), .b(new_n152_), .O(new_n1042_));
  aoi21  g949(.a(new_n1042_), .b(new_n1041_), .c(new_n636_), .O(new_n1043_));
  nand4  g950(.a(new_n94_), .b(x69), .c(x65), .d(new_n92_), .O(new_n1044_));
  aoi21  g951(.a(new_n1039_), .b(new_n1024_), .c(new_n1044_), .O(new_n1045_));
  oai21  g952(.a(new_n1045_), .b(new_n1043_), .c(new_n139_), .O(new_n1046_));
  nand3  g953(.a(x71), .b(new_n134_), .c(x15), .O(new_n1047_));
  inv1   g954(.a(new_n1047_), .O(new_n1048_));
  aoi21  g955(.a(new_n1038_), .b(new_n775_), .c(new_n1048_), .O(new_n1049_));
  nand3  g956(.a(new_n118_), .b(new_n134_), .c(x47), .O(new_n1050_));
  oai21  g957(.a(new_n1049_), .b(x70), .c(new_n1050_), .O(new_n1051_));
  nand2  g958(.a(new_n102_), .b(x15), .O(new_n1052_));
  nand2  g959(.a(new_n118_), .b(x47), .O(new_n1053_));
  aoi21  g960(.a(new_n1053_), .b(new_n1052_), .c(new_n136_), .O(new_n1054_));
  aoi21  g961(.a(new_n1051_), .b(new_n94_), .c(new_n1054_), .O(new_n1055_));
  nand2  g962(.a(new_n1038_), .b(new_n93_), .O(new_n1056_));
  oai21  g963(.a(new_n153_), .b(new_n1003_), .c(new_n1056_), .O(new_n1057_));
  nand3  g964(.a(new_n1057_), .b(new_n173_), .c(new_n128_), .O(new_n1058_));
  oai21  g965(.a(new_n1055_), .b(x64), .c(new_n1058_), .O(new_n1059_));
  nand2  g966(.a(new_n1059_), .b(new_n140_), .O(new_n1060_));
  nand2  g967(.a(new_n1060_), .b(new_n1046_), .O(z15));
  zero   g968(.O(z10));
  zero   g969(.O(z13));
endmodule
