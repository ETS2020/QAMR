...
module FAU ( 
  ...
  wire new_n92_, new_n93_, new_n94_, new_n95_, new_n96_, new_n97_, new_n98_,
    ...
    new_n946_, new_n947_, new_n950_, new_n951_, new_n952_, new_n953_,
  ...
  nand2  g784(.a(x74), .b(x58), .O(new_n878_));
  nand2  g785(.a(new_n209_), .b(x59), .O(new_n879_));
  ...
  inv1   g855(.a(x31), .O(new_n950_));
  inv1   g856(.a(x47), .O(new_n951_));
  oai22  g857(.a(new_n154_), .b(new_n950_), .c(new_n116_), .d(new_n951_), .O(new_n952_));
  nand2  g858(.a(new_n952_), .b(x70), .O(new_n953_));
  nand2  g859(.a(new_n157_), .b(x15), .O(new_n954_));
  nand3  g860(.a(new_n126_), .b(x69), .c(x63), .O(new_n955_));
  nand3  g861(.a(new_n955_), .b(new_n954_), .c(new_n953_), .O(new_n956_));
  and2   g862(.a(new_n956_), .b(x67), .O(new_n957_));
  nand2  g863(.a(x74), .b(x28), .O(new_n958_));
  nand2  g864(.a(new_n209_), .b(x29), .O(new_n959_));
  aoi21  g865(.a(new_n959_), .b(new_n958_), .c(new_n212_), .O(new_n960_));
  nand2  g866(.a(new_n268_), .b(x30), .O(new_n961_));
  inv1   g867(.a(new_n961_), .O(new_n962_));
  oai21  g868(.a(new_n962_), .b(new_n960_), .c(new_n203_), .O(new_n963_));
  nand2  g869(.a(new_n207_), .b(x31), .O(new_n964_));
  aoi21  g870(.a(new_n896_), .b(new_n895_), .c(x73), .O(new_n965_));
  nand2  g871(.a(new_n704_), .b(x23), .O(new_n966_));
  inv1   g872(.a(new_n966_), .O(new_n967_));
  oai21  g873(.a(new_n967_), .b(new_n965_), .c(x72), .O(new_n968_));
  nand3  g874(.a(new_n968_), .b(new_n964_), .c(new_n963_), .O(new_n969_));
  nand2  g875(.a(new_n969_), .b(new_n141_), .O(new_n970_));
  nand2  g876(.a(x74), .b(x60), .O(new_n971_));
  nand2  g877(.a(new_n209_), .b(x61), .O(new_n972_));
  aoi21  g878(.a(new_n972_), .b(new_n971_), .c(new_n212_), .O(new_n973_));
  nand2  g879(.a(new_n268_), .b(x62), .O(new_n974_));
  inv1   g880(.a(new_n974_), .O(new_n975_));
  oai21  g881(.a(new_n975_), .b(new_n973_), .c(new_n203_), .O(new_n976_));
  nand2  g882(.a(new_n207_), .b(x63), .O(new_n977_));
  aoi21  g883(.a(new_n879_), .b(new_n878_), .c(x73), .O(new_n978_));
  nand2  g884(.a(new_n704_), .b(x55), .O(new_n979_));
  inv1   g885(.a(new_n979_), .O(new_n980_));
  oai21  g886(.a(new_n980_), .b(new_n978_), .c(x72), .O(new_n981_));
  nand3  g887(.a(new_n981_), .b(new_n977_), .c(new_n976_), .O(new_n982_));
  nand2  g888(.a(new_n982_), .b(new_n142_), .O(new_n983_));
  aoi21  g889(.a(new_n983_), .b(new_n970_), .c(new_n772_), .O(new_n984_));
  oai21  g890(.a(new_n984_), .b(new_n957_), .c(new_n149_), .O(new_n985_));
  nand2  g891(.a(new_n956_), .b(new_n150_), .O(new_n986_));
  aoi21  g892(.a(new_n986_), .b(new_n985_), .c(new_n634_), .O(new_n987_));
  nand4  g893(.a(new_n94_), .b(x69), .c(x65), .d(new_n92_), .O(new_n988_));
  aoi21  g894(.a(new_n983_), .b(new_n970_), .c(new_n988_), .O(new_n989_));
  oai21  g895(.a(new_n989_), .b(new_n987_), .c(new_n137_), .O(new_n990_));
  nand3  g896(.a(x71), .b(new_n132_), .c(x15), .O(new_n991_));
  inv1   g897(.a(new_n991_), .O(new_n992_));
  aoi21  g898(.a(new_n982_), .b(new_n716_), .c(new_n992_), .O(new_n993_));
  nand3  g899(.a(new_n188_), .b(new_n132_), .c(x47), .O(new_n994_));
  oai21  g900(.a(new_n993_), .b(x70), .c(new_n994_), .O(new_n995_));
  nand2  g901(.a(new_n174_), .b(x15), .O(new_n996_));
  nand2  g902(.a(new_n188_), .b(x47), .O(new_n997_));
  aoi21  g903(.a(new_n997_), .b(new_n996_), .c(new_n134_), .O(new_n998_));
  aoi21  g904(.a(new_n995_), .b(new_n94_), .c(new_n998_), .O(new_n999_));
  nand2  g905(.a(new_n982_), .b(new_n93_), .O(new_n1000_));
  oai21  g906(.a(new_n151_), .b(new_n951_), .c(new_n1000_), .O(new_n1001_));
  nand3  g907(.a(new_n1001_), .b(new_n171_), .c(new_n126_), .O(new_n1002_));
  oai21  g908(.a(new_n999_), .b(x64), .c(new_n1002_), .O(new_n1003_));
  nand2  g909(.a(new_n1003_), .b(new_n138_), .O(new_n1004_));
