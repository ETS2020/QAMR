// Benchmark "FAU" written by ABC on Sun Aug  2 12:24:43 2020
...
module FAU ( 
  ...
  nor2   g186(.a(x13), .b(new_n99_), .O(new_n289_));
  oai21  g187(.a(x15), .b(x14), .c(new_n289_), .O(new_n290_));
  oai21  g188(.a(new_n103_), .b(new_n99_), .c(x13), .O(new_n291_));
  aoi21  g189(.a(new_n291_), .b(new_n290_), .c(new_n113_), .O(new_n292_));
  nand2  g190(.a(new_n195_), .b(x61), .O(new_n293_));
  nand2  g191(.a(x74), .b(x56), .O(new_n294_));
  nand2  g192(.a(new_n193_), .b(x57), .O(new_n295_));
  aoi21  g193(.a(new_n295_), .b(new_n294_), .c(x73), .O(new_n296_));
  nand3  g194(.a(new_n193_), .b(x73), .c(x53), .O(new_n297_));
  inv1   g195(.a(new_n297_), .O(new_n298_));
  oai21  g196(.a(new_n298_), .b(new_n296_), .c(x72), .O(new_n299_));
  nand2  g197(.a(x74), .b(x58), .O(new_n300_));
  nand2  g198(.a(new_n193_), .b(x59), .O(new_n301_));
  aoi21  g199(.a(new_n301_), .b(new_n300_), .c(new_n192_), .O(new_n302_));
  nand3  g200(.a(x74), .b(new_n192_), .c(x60), .O(new_n303_));
  inv1   g201(.a(new_n303_), .O(new_n304_));
  oai21  g202(.a(new_n304_), .b(new_n302_), .c(new_n191_), .O(new_n305_));
  nand3  g203(.a(new_n305_), .b(new_n299_), .c(new_n293_), .O(new_n306_));
  aoi22  g204(.a(new_n306_), .b(new_n212_), .c(new_n292_), .d(new_n138_), .O(new_n307_));
  nand2  g205(.a(new_n195_), .b(x29), .O(new_n308_));
  inv1   g206(.a(x25), .O(new_n309_));
  nand2  g207(.a(x74), .b(x24), .O(new_n310_));
  oai21  g208(.a(x74), .b(new_n309_), .c(new_n310_), .O(new_n311_));
  nand2  g209(.a(new_n311_), .b(new_n192_), .O(new_n312_));
  nand3  g210(.a(new_n193_), .b(x73), .c(x21), .O(new_n313_));
  nand2  g211(.a(new_n313_), .b(new_n312_), .O(new_n314_));
  nand2  g212(.a(new_n314_), .b(x72), .O(new_n315_));
  inv1   g213(.a(x27), .O(new_n316_));
  nand2  g214(.a(x74), .b(x26), .O(new_n317_));
  oai21  g215(.a(x74), .b(new_n316_), .c(new_n317_), .O(new_n318_));
  nand2  g216(.a(new_n318_), .b(x73), .O(new_n319_));
  nand3  g217(.a(x74), .b(new_n192_), .c(x28), .O(new_n320_));
  nand2  g218(.a(new_n320_), .b(new_n319_), .O(new_n321_));
  nand2  g219(.a(new_n321_), .b(new_n191_), .O(new_n322_));
  nand3  g220(.a(new_n322_), .b(new_n315_), .c(new_n308_), .O(new_n323_));
  nand2  g221(.a(new_n323_), .b(new_n232_), .O(new_n324_));
  oai21  g222(.a(new_n307_), .b(new_n143_), .c(new_n324_), .O(new_n325_));
  nand2  g223(.a(new_n325_), .b(new_n95_), .O(new_n326_));
  aoi21  g224(.a(new_n313_), .b(new_n312_), .c(new_n191_), .O(new_n327_));
  aoi21  g225(.a(new_n320_), .b(new_n319_), .c(x72), .O(new_n328_));
  oai21  g226(.a(new_n328_), .b(new_n327_), .c(new_n113_), .O(new_n329_));
  inv1   g227(.a(x29), .O(new_n330_));
  nand2  g228(.a(x71), .b(x61), .O(new_n331_));
  oai21  g229(.a(x71), .b(new_n330_), .c(new_n331_), .O(new_n332_));
  nand2  g230(.a(new_n332_), .b(new_n195_), .O(new_n333_));
  inv1   g231(.a(x57), .O(new_n334_));
  oai21  g232(.a(x74), .b(new_n334_), .c(new_n294_), .O(new_n335_));
  nand2  g233(.a(new_n335_), .b(new_n192_), .O(new_n336_));
  aoi21  g234(.a(new_n297_), .b(new_n336_), .c(new_n191_), .O(new_n337_));
  inv1   g235(.a(x59), .O(new_n338_));
  oai21  g236(.a(x74), .b(new_n338_), .c(new_n300_), .O(new_n339_));
  nand2  g237(.a(new_n339_), .b(x73), .O(new_n340_));
  aoi21  g238(.a(new_n303_), .b(new_n340_), .c(x72), .O(new_n341_));
  oai21  g239(.a(new_n341_), .b(new_n337_), .c(x71), .O(new_n342_));
  nand3  g240(.a(new_n342_), .b(new_n333_), .c(new_n329_), .O(new_n343_));
  nand2  g241(.a(new_n343_), .b(new_n235_), .O(new_n344_));
  inv1   g242(.a(new_n121_), .O(new_n345_));
  nand3  g243(.a(new_n345_), .b(new_n120_), .c(x32), .O(new_n346_));
  oai21  g244(.a(new_n121_), .b(new_n117_), .c(x45), .O(new_n347_));
  aoi21  g245(.a(new_n347_), .b(new_n346_), .c(x71), .O(new_n348_));
  nand2  g246(.a(new_n348_), .b(new_n254_), .O(new_n349_));
  nand2  g247(.a(new_n349_), .b(new_n344_), .O(new_n350_));
  nand2  g248(.a(new_n350_), .b(x70), .O(new_n351_));
  aoi21  g249(.a(new_n351_), .b(new_n326_), .c(new_n93_), .O(new_n352_));
  nand2  g250(.a(new_n292_), .b(new_n95_), .O(new_n353_));
  nand2  g251(.a(new_n348_), .b(x70), .O(new_n354_));
  aoi21  g252(.a(new_n354_), .b(new_n353_), .c(new_n261_), .O(new_n355_));
  oai21  g253(.a(new_n355_), .b(new_n352_), .c(new_n92_), .O(new_n356_));
  oai22  g254(.a(new_n157_), .b(new_n330_), .c(new_n113_), .d(new_n120_), .O(new_n357_));
  nand2  g255(.a(new_n357_), .b(x70), .O(new_n358_));
  nand2  g256(.a(new_n160_), .b(x13), .O(new_n359_));
  nand3  g257(.a(new_n132_), .b(x69), .c(x61), .O(new_n360_));
  nand3  g258(.a(new_n360_), .b(new_n359_), .c(new_n358_), .O(new_n361_));
  and2   g259(.a(new_n361_), .b(x67), .O(new_n362_));
  nand2  g260(.a(new_n323_), .b(new_n145_), .O(new_n363_));
  nand2  g261(.a(new_n306_), .b(new_n271_), .O(new_n364_));
  aoi21  g262(.a(new_n364_), .b(new_n363_), .c(new_n273_), .O(new_n365_));
  oai21  g263(.a(new_n365_), .b(new_n362_), .c(new_n141_), .O(new_n366_));
  nand2  g264(.a(new_n306_), .b(new_n136_), .O(new_n367_));
  oai21  g265(.a(new_n136_), .b(new_n120_), .c(new_n367_), .O(new_n368_));
  nand2  g266(.a(new_n368_), .b(new_n279_), .O(new_n369_));
  aoi21  g267(.a(new_n369_), .b(new_n366_), .c(x66), .O(new_n370_));
  nand2  g268(.a(new_n361_), .b(new_n141_), .O(new_n371_));
  nand3  g269(.a(new_n165_), .b(x68), .c(x45), .O(new_n372_));
  aoi21  g270(.a(new_n372_), .b(new_n371_), .c(new_n154_), .O(new_n373_));
  oai21  g271(.a(new_n373_), .b(new_n370_), .c(new_n172_), .O(new_n374_));
  nand2  g272(.a(new_n374_), .b(new_n356_), .O(z13));
  nand2  g273(.a(x15), .b(x00), .O(new_n376_));
  xor2a  g274(.a(new_n376_), .b(x14), .O(new_n377_));
  nor2   g275(.a(new_n377_), .b(new_n113_), .O(new_n378_));
  nand2  g276(.a(new_n195_), .b(x62), .O(new_n379_));
  nand2  g277(.a(x74), .b(x57), .O(new_n380_));
  nand2  g278(.a(new_n193_), .b(x58), .O(new_n381_));
  aoi21  g279(.a(new_n381_), .b(new_n380_), .c(x73), .O(new_n382_));
  nand3  g280(.a(new_n193_), .b(x73), .c(x54), .O(new_n383_));
  inv1   g281(.a(new_n383_), .O(new_n384_));
  oai21  g282(.a(new_n384_), .b(new_n382_), .c(x72), .O(new_n385_));
  nand2  g283(.a(x74), .b(x59), .O(new_n386_));
  nand2  g284(.a(new_n193_), .b(x60), .O(new_n387_));
  aoi21  g285(.a(new_n387_), .b(new_n386_), .c(new_n192_), .O(new_n388_));
  nand3  g286(.a(x74), .b(new_n192_), .c(x61), .O(new_n389_));
  inv1   g287(.a(new_n389_), .O(new_n390_));
  oai21  g288(.a(new_n390_), .b(new_n388_), .c(new_n191_), .O(new_n391_));
  nand3  g289(.a(new_n391_), .b(new_n385_), .c(new_n379_), .O(new_n392_));
  aoi22  g290(.a(new_n392_), .b(new_n212_), .c(new_n378_), .d(new_n138_), .O(new_n393_));
  nand2  g291(.a(new_n195_), .b(x30), .O(new_n394_));
  nand2  g292(.a(x74), .b(x25), .O(new_n395_));
  oai21  g293(.a(x74), .b(new_n239_), .c(new_n395_), .O(new_n396_));
  nand2  g294(.a(new_n396_), .b(new_n192_), .O(new_n397_));
  nand3  g295(.a(new_n193_), .b(x73), .c(x22), .O(new_n398_));
  nand2  g296(.a(new_n398_), .b(new_n397_), .O(new_n399_));
  nand2  g297(.a(new_n399_), .b(x72), .O(new_n400_));
  inv1   g298(.a(x28), .O(new_n401_));
  nand2  g299(.a(x74), .b(x27), .O(new_n402_));
  oai21  g300(.a(x74), .b(new_n401_), .c(new_n402_), .O(new_n403_));
  nand2  g301(.a(new_n403_), .b(x73), .O(new_n404_));
  nand3  g302(.a(x74), .b(new_n192_), .c(x29), .O(new_n405_));
  nand2  g303(.a(new_n405_), .b(new_n404_), .O(new_n406_));
  nand2  g304(.a(new_n406_), .b(new_n191_), .O(new_n407_));
  nand3  g305(.a(new_n407_), .b(new_n400_), .c(new_n394_), .O(new_n408_));
  nand2  g306(.a(new_n408_), .b(new_n232_), .O(new_n409_));
  oai21  g307(.a(new_n393_), .b(new_n143_), .c(new_n409_), .O(new_n410_));
  nand2  g308(.a(new_n410_), .b(new_n95_), .O(new_n411_));
  aoi21  g309(.a(new_n398_), .b(new_n397_), .c(new_n191_), .O(new_n412_));
  aoi21  g310(.a(new_n405_), .b(new_n404_), .c(x72), .O(new_n413_));
  oai21  g311(.a(new_n413_), .b(new_n412_), .c(new_n113_), .O(new_n414_));
  inv1   g312(.a(x30), .O(new_n415_));
  nand2  g313(.a(x71), .b(x62), .O(new_n416_));
  oai21  g314(.a(x71), .b(new_n415_), .c(new_n416_), .O(new_n417_));
  nand2  g315(.a(new_n417_), .b(new_n195_), .O(new_n418_));
  inv1   g316(.a(x58), .O(new_n419_));
  oai21  g317(.a(x74), .b(new_n419_), .c(new_n380_), .O(new_n420_));
  nand2  g318(.a(new_n420_), .b(new_n192_), .O(new_n421_));
  aoi21  g319(.a(new_n383_), .b(new_n421_), .c(new_n191_), .O(new_n422_));
  inv1   g320(.a(x60), .O(new_n423_));
  oai21  g321(.a(x74), .b(new_n423_), .c(new_n386_), .O(new_n424_));
  nand2  g322(.a(new_n424_), .b(x73), .O(new_n425_));
  aoi21  g323(.a(new_n389_), .b(new_n425_), .c(x72), .O(new_n426_));
  oai21  g324(.a(new_n426_), .b(new_n422_), .c(x71), .O(new_n427_));
  nand3  g325(.a(new_n427_), .b(new_n418_), .c(new_n414_), .O(new_n428_));
  nand2  g326(.a(new_n428_), .b(new_n235_), .O(new_n429_));
  nand2  g327(.a(x47), .b(x32), .O(new_n430_));
  xor2a  g328(.a(new_n430_), .b(x46), .O(new_n431_));
  nor2   g329(.a(new_n431_), .b(x71), .O(new_n432_));
  nand2  g330(.a(new_n432_), .b(new_n254_), .O(new_n433_));
  nand2  g331(.a(new_n433_), .b(new_n429_), .O(new_n434_));
  nand2  g332(.a(new_n434_), .b(x70), .O(new_n435_));
  aoi21  g333(.a(new_n435_), .b(new_n411_), .c(new_n93_), .O(new_n436_));
  nand2  g334(.a(new_n378_), .b(new_n95_), .O(new_n437_));
  nand2  g335(.a(new_n432_), .b(x70), .O(new_n438_));
  aoi21  g336(.a(new_n438_), .b(new_n437_), .c(new_n261_), .O(new_n439_));
  oai21  g337(.a(new_n439_), .b(new_n436_), .c(new_n92_), .O(new_n440_));
  nand2  g338(.a(x71), .b(x46), .O(new_n441_));
  oai21  g339(.a(new_n157_), .b(new_n415_), .c(new_n441_), .O(new_n442_));
  nand2  g340(.a(new_n442_), .b(x70), .O(new_n443_));
  nand2  g341(.a(new_n160_), .b(x14), .O(new_n444_));
  nand3  g342(.a(new_n132_), .b(x69), .c(x62), .O(new_n445_));
  nand3  g343(.a(new_n445_), .b(new_n444_), .c(new_n443_), .O(new_n446_));
  and2   g344(.a(new_n446_), .b(x67), .O(new_n447_));
  nand2  g345(.a(new_n408_), .b(new_n145_), .O(new_n448_));
  nand2  g346(.a(new_n392_), .b(new_n271_), .O(new_n449_));
  aoi21  g347(.a(new_n449_), .b(new_n448_), .c(new_n273_), .O(new_n450_));
  oai21  g348(.a(new_n450_), .b(new_n447_), .c(new_n141_), .O(new_n451_));
  nand2  g349(.a(new_n392_), .b(new_n136_), .O(new_n452_));
  nand2  g350(.a(x67), .b(x46), .O(new_n453_));
  nand2  g351(.a(new_n453_), .b(new_n452_), .O(new_n454_));
  nand2  g352(.a(new_n454_), .b(new_n279_), .O(new_n455_));
  aoi21  g353(.a(new_n455_), .b(new_n451_), .c(x66), .O(new_n456_));
  nand2  g354(.a(new_n446_), .b(new_n141_), .O(new_n457_));
  nand3  g355(.a(new_n165_), .b(x68), .c(x46), .O(new_n458_));
  aoi21  g356(.a(new_n458_), .b(new_n457_), .c(new_n154_), .O(new_n459_));
  oai21  g357(.a(new_n459_), .b(new_n456_), .c(new_n172_), .O(new_n460_));
  nand2  g358(.a(new_n460_), .b(new_n440_), .O(z14));
  zero   g359(.O(z01));
  zero   g360(.O(z02));
  zero   g361(.O(z03));
  zero   g362(.O(z04));
