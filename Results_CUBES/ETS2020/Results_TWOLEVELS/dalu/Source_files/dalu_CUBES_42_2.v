// Benchmark "FAU" written by ABC on Sun Aug  2 10:58:44 2020
...
module FAU ( 
  ...
  wire new_n92_, new_n93_, new_n94_, new_n95_, new_n96_, new_n97_, new_n98_,
    ...
    new_n689_, new_n694_, new_n695_, new_n696_, new_n697_, new_n698_,
    ...
    new_n918_, new_n919_, new_n920_, new_n921_;
  ...
  oai21  g599(.a(new_n309_), .b(new_n96_), .c(x12), .O(new_n694_));
  inv1   g600(.a(new_n309_), .O(new_n695_));
  nor2   g601(.a(x12), .b(new_n96_), .O(new_n696_));
  nand2  g602(.a(new_n696_), .b(new_n695_), .O(new_n697_));
  aoi21  g603(.a(new_n697_), .b(new_n694_), .c(new_n116_), .O(new_n698_));
  nand2  g604(.a(new_n698_), .b(new_n134_), .O(new_n699_));
  nand2  g605(.a(new_n207_), .b(x60), .O(new_n700_));
  inv1   g606(.a(x56), .O(new_n701_));
  nand2  g607(.a(x74), .b(x55), .O(new_n702_));
  oai21  g608(.a(x74), .b(new_n701_), .c(new_n702_), .O(new_n703_));
  nand2  g609(.a(new_n703_), .b(new_n212_), .O(new_n704_));
  nor2   g610(.a(x74), .b(new_n212_), .O(new_n705_));
  nand2  g611(.a(new_n705_), .b(x52), .O(new_n706_));
  nand2  g612(.a(new_n706_), .b(new_n704_), .O(new_n707_));
  nand2  g613(.a(new_n707_), .b(x72), .O(new_n708_));
  inv1   g614(.a(x58), .O(new_n709_));
  nand2  g615(.a(x74), .b(x57), .O(new_n710_));
  oai21  g616(.a(x74), .b(new_n709_), .c(new_n710_), .O(new_n711_));
  nand2  g617(.a(new_n711_), .b(x73), .O(new_n712_));
  nand2  g618(.a(new_n268_), .b(x59), .O(new_n713_));
  nand2  g619(.a(new_n713_), .b(new_n712_), .O(new_n714_));
  nand2  g620(.a(new_n714_), .b(new_n203_), .O(new_n715_));
  nand3  g621(.a(new_n715_), .b(new_n708_), .c(new_n700_), .O(new_n716_));
  nor2   g622(.a(x71), .b(new_n134_), .O(new_n717_));
  nand2  g623(.a(new_n717_), .b(new_n716_), .O(new_n718_));
  aoi21  g624(.a(new_n718_), .b(new_n699_), .c(new_n141_), .O(new_n719_));
  nand2  g625(.a(new_n207_), .b(x28), .O(new_n720_));
  nand2  g626(.a(x74), .b(x23), .O(new_n721_));
  oai21  g627(.a(x74), .b(new_n674_), .c(new_n721_), .O(new_n722_));
  nand2  g628(.a(new_n722_), .b(new_n212_), .O(new_n723_));
  nand2  g629(.a(new_n705_), .b(x20), .O(new_n724_));
  nand2  g630(.a(new_n724_), .b(new_n723_), .O(new_n725_));
  nand2  g631(.a(new_n725_), .b(x72), .O(new_n726_));
  inv1   g632(.a(x26), .O(new_n727_));
  nand2  g633(.a(x74), .b(x25), .O(new_n728_));
  oai21  g634(.a(x74), .b(new_n727_), .c(new_n728_), .O(new_n729_));
  nand2  g635(.a(new_n729_), .b(x73), .O(new_n730_));
  nand2  g636(.a(new_n268_), .b(x27), .O(new_n731_));
  nand2  g637(.a(new_n731_), .b(new_n730_), .O(new_n732_));
  nand2  g638(.a(new_n732_), .b(new_n203_), .O(new_n733_));
  nand3  g639(.a(new_n733_), .b(new_n726_), .c(new_n720_), .O(new_n734_));
  nand3  g640(.a(new_n146_), .b(x71), .c(x69), .O(new_n735_));
  inv1   g641(.a(new_n735_), .O(new_n736_));
  and2   g642(.a(new_n736_), .b(new_n734_), .O(new_n737_));
  oai21  g643(.a(new_n737_), .b(new_n719_), .c(new_n100_), .O(new_n738_));
  aoi21  g644(.a(new_n724_), .b(new_n723_), .c(new_n203_), .O(new_n739_));
  aoi21  g645(.a(new_n731_), .b(new_n730_), .c(x72), .O(new_n740_));
  oai21  g646(.a(new_n740_), .b(new_n739_), .c(new_n116_), .O(new_n741_));
  inv1   g647(.a(x28), .O(new_n742_));
  nand2  g648(.a(x71), .b(x60), .O(new_n743_));
  oai21  g649(.a(x71), .b(new_n742_), .c(new_n743_), .O(new_n744_));
  nand2  g650(.a(new_n744_), .b(new_n207_), .O(new_n745_));
  aoi21  g651(.a(new_n706_), .b(new_n704_), .c(new_n203_), .O(new_n746_));
  aoi21  g652(.a(new_n713_), .b(new_n712_), .c(x72), .O(new_n747_));
  oai21  g653(.a(new_n747_), .b(new_n746_), .c(x71), .O(new_n748_));
  nand3  g654(.a(new_n748_), .b(new_n745_), .c(new_n741_), .O(new_n749_));
  nand2  g655(.a(new_n749_), .b(new_n219_), .O(new_n750_));
  oai21  g656(.a(new_n319_), .b(new_n112_), .c(x44), .O(new_n751_));
  inv1   g657(.a(x44), .O(new_n752_));
  inv1   g658(.a(new_n319_), .O(new_n753_));
  nand3  g659(.a(new_n753_), .b(new_n752_), .c(x32), .O(new_n754_));
  aoi21  g660(.a(new_n754_), .b(new_n751_), .c(x71), .O(new_n755_));
  nand3  g661(.a(new_n155_), .b(x68), .c(new_n134_), .O(new_n756_));
  inv1   g662(.a(new_n756_), .O(new_n757_));
  nand2  g663(.a(new_n757_), .b(new_n755_), .O(new_n758_));
  nand2  g664(.a(new_n758_), .b(new_n750_), .O(new_n759_));
  nand2  g665(.a(new_n759_), .b(x70), .O(new_n760_));
  aoi21  g666(.a(new_n760_), .b(new_n738_), .c(new_n93_), .O(new_n761_));
  nand2  g667(.a(new_n698_), .b(new_n100_), .O(new_n762_));
  nand2  g668(.a(new_n755_), .b(x70), .O(new_n763_));
  aoi21  g669(.a(new_n763_), .b(new_n762_), .c(new_n226_), .O(new_n764_));
  oai21  g670(.a(new_n764_), .b(new_n761_), .c(new_n92_), .O(new_n765_));
  oai22  g671(.a(new_n156_), .b(new_n742_), .c(new_n116_), .d(new_n752_), .O(new_n766_));
  nand2  g672(.a(new_n766_), .b(x70), .O(new_n767_));
  nand2  g673(.a(new_n159_), .b(x12), .O(new_n768_));
  nand3  g674(.a(new_n128_), .b(x69), .c(x60), .O(new_n769_));
  nand3  g675(.a(new_n769_), .b(new_n768_), .c(new_n767_), .O(new_n770_));
  and2   g676(.a(new_n770_), .b(x67), .O(new_n771_));
  nand2  g677(.a(new_n734_), .b(new_n143_), .O(new_n772_));
  nand2  g678(.a(new_n716_), .b(new_n144_), .O(new_n773_));
  nand2  g679(.a(x69), .b(new_n133_), .O(new_n774_));
  aoi21  g680(.a(new_n773_), .b(new_n772_), .c(new_n774_), .O(new_n775_));
  oai21  g681(.a(new_n775_), .b(new_n771_), .c(new_n139_), .O(new_n776_));
  nand2  g682(.a(new_n716_), .b(new_n133_), .O(new_n777_));
  oai21  g683(.a(new_n133_), .b(new_n752_), .c(new_n777_), .O(new_n778_));
  nand2  g684(.a(new_n778_), .b(new_n362_), .O(new_n779_));
  aoi21  g685(.a(new_n779_), .b(new_n776_), .c(x66), .O(new_n780_));
  nand2  g686(.a(new_n770_), .b(new_n139_), .O(new_n781_));
  nand3  g687(.a(new_n165_), .b(x68), .c(x44), .O(new_n782_));
  aoi21  g688(.a(new_n782_), .b(new_n781_), .c(new_n367_), .O(new_n783_));
  oai21  g689(.a(new_n783_), .b(new_n780_), .c(new_n173_), .O(new_n784_));
  nand2  g690(.a(new_n784_), .b(new_n765_), .O(z12));
  nand2  g691(.a(x15), .b(x00), .O(new_n787_));
  xor2a  g692(.a(new_n787_), .b(x14), .O(new_n788_));
  nor2   g693(.a(new_n788_), .b(new_n116_), .O(new_n789_));
  nand2  g694(.a(new_n207_), .b(x62), .O(new_n790_));
  nand2  g695(.a(new_n711_), .b(new_n212_), .O(new_n791_));
  nand2  g696(.a(new_n705_), .b(x54), .O(new_n792_));
  nand2  g697(.a(new_n792_), .b(new_n791_), .O(new_n793_));
  nand2  g698(.a(new_n793_), .b(x72), .O(new_n794_));
  inv1   g699(.a(x60), .O(new_n795_));
  nand2  g700(.a(x74), .b(x59), .O(new_n796_));
  oai21  g701(.a(x74), .b(new_n795_), .c(new_n796_), .O(new_n797_));
  nand2  g702(.a(new_n797_), .b(x73), .O(new_n798_));
  nand2  g703(.a(new_n268_), .b(x61), .O(new_n799_));
  nand2  g704(.a(new_n799_), .b(new_n798_), .O(new_n800_));
  nand2  g705(.a(new_n800_), .b(new_n203_), .O(new_n801_));
  nand3  g706(.a(new_n801_), .b(new_n794_), .c(new_n790_), .O(new_n802_));
  aoi22  g707(.a(new_n802_), .b(new_n717_), .c(new_n789_), .d(new_n134_), .O(new_n803_));
  nand2  g708(.a(new_n207_), .b(x30), .O(new_n804_));
  nand2  g709(.a(new_n729_), .b(new_n212_), .O(new_n805_));
  nand2  g710(.a(new_n705_), .b(x22), .O(new_n806_));
  nand2  g711(.a(new_n806_), .b(new_n805_), .O(new_n807_));
  nand2  g712(.a(new_n807_), .b(x72), .O(new_n808_));
  nand2  g713(.a(x74), .b(x27), .O(new_n809_));
  oai21  g714(.a(x74), .b(new_n742_), .c(new_n809_), .O(new_n810_));
  nand2  g715(.a(new_n810_), .b(x73), .O(new_n811_));
  nand2  g716(.a(new_n268_), .b(x29), .O(new_n812_));
  nand2  g717(.a(new_n812_), .b(new_n811_), .O(new_n813_));
  nand2  g718(.a(new_n813_), .b(new_n203_), .O(new_n814_));
  nand3  g719(.a(new_n814_), .b(new_n808_), .c(new_n804_), .O(new_n815_));
  nand2  g720(.a(new_n815_), .b(new_n736_), .O(new_n816_));
  oai21  g721(.a(new_n803_), .b(new_n141_), .c(new_n816_), .O(new_n817_));
  nand2  g722(.a(new_n817_), .b(new_n100_), .O(new_n818_));
  aoi21  g723(.a(new_n806_), .b(new_n805_), .c(new_n203_), .O(new_n819_));
  aoi21  g724(.a(new_n812_), .b(new_n811_), .c(x72), .O(new_n820_));
  oai21  g725(.a(new_n820_), .b(new_n819_), .c(new_n116_), .O(new_n821_));
  inv1   g726(.a(x30), .O(new_n822_));
  nand2  g727(.a(x71), .b(x62), .O(new_n823_));
  oai21  g728(.a(x71), .b(new_n822_), .c(new_n823_), .O(new_n824_));
  nand2  g729(.a(new_n824_), .b(new_n207_), .O(new_n825_));
  aoi21  g730(.a(new_n792_), .b(new_n791_), .c(new_n203_), .O(new_n826_));
  aoi21  g731(.a(new_n799_), .b(new_n798_), .c(x72), .O(new_n827_));
  oai21  g732(.a(new_n827_), .b(new_n826_), .c(x71), .O(new_n828_));
  nand3  g733(.a(new_n828_), .b(new_n825_), .c(new_n821_), .O(new_n829_));
  nand2  g734(.a(new_n829_), .b(new_n219_), .O(new_n830_));
  nand2  g735(.a(x47), .b(x32), .O(new_n831_));
  xor2a  g736(.a(new_n831_), .b(x46), .O(new_n832_));
  nor2   g737(.a(new_n832_), .b(x71), .O(new_n833_));
  nand2  g738(.a(new_n833_), .b(new_n757_), .O(new_n834_));
  nand2  g739(.a(new_n834_), .b(new_n830_), .O(new_n835_));
  nand2  g740(.a(new_n835_), .b(x70), .O(new_n836_));
  aoi21  g741(.a(new_n836_), .b(new_n818_), .c(new_n93_), .O(new_n837_));
  nand2  g742(.a(new_n789_), .b(new_n100_), .O(new_n838_));
  nand2  g743(.a(new_n833_), .b(x70), .O(new_n839_));
  aoi21  g744(.a(new_n839_), .b(new_n838_), .c(new_n226_), .O(new_n840_));
  oai21  g745(.a(new_n840_), .b(new_n837_), .c(new_n92_), .O(new_n841_));
  nand2  g746(.a(x71), .b(x46), .O(new_n842_));
  oai21  g747(.a(new_n156_), .b(new_n822_), .c(new_n842_), .O(new_n843_));
  nand2  g748(.a(new_n843_), .b(x70), .O(new_n844_));
  nand2  g749(.a(new_n159_), .b(x14), .O(new_n845_));
  nand3  g750(.a(new_n128_), .b(x69), .c(x62), .O(new_n846_));
  nand3  g751(.a(new_n846_), .b(new_n845_), .c(new_n844_), .O(new_n847_));
  and2   g752(.a(new_n847_), .b(x67), .O(new_n848_));
  nand2  g753(.a(new_n815_), .b(new_n143_), .O(new_n849_));
  nand2  g754(.a(new_n802_), .b(new_n144_), .O(new_n850_));
  aoi21  g755(.a(new_n850_), .b(new_n849_), .c(new_n774_), .O(new_n851_));
  oai21  g756(.a(new_n851_), .b(new_n848_), .c(new_n139_), .O(new_n852_));
  nand2  g757(.a(new_n802_), .b(new_n133_), .O(new_n853_));
  nand2  g758(.a(x67), .b(x46), .O(new_n854_));
  nand2  g759(.a(new_n854_), .b(new_n853_), .O(new_n855_));
  nand2  g760(.a(new_n855_), .b(new_n362_), .O(new_n856_));
  aoi21  g761(.a(new_n856_), .b(new_n852_), .c(x66), .O(new_n857_));
  nand2  g762(.a(new_n847_), .b(new_n139_), .O(new_n858_));
  nand3  g763(.a(new_n165_), .b(x68), .c(x46), .O(new_n859_));
  aoi21  g764(.a(new_n859_), .b(new_n858_), .c(new_n367_), .O(new_n860_));
  oai21  g765(.a(new_n860_), .b(new_n857_), .c(new_n173_), .O(new_n861_));
  nand2  g766(.a(new_n861_), .b(new_n841_), .O(z14));
  inv1   g767(.a(x31), .O(new_n863_));
  inv1   g768(.a(x47), .O(new_n864_));
  oai22  g769(.a(new_n156_), .b(new_n863_), .c(new_n116_), .d(new_n864_), .O(new_n865_));
  nand2  g770(.a(new_n865_), .b(x70), .O(new_n866_));
  nand2  g771(.a(new_n159_), .b(x15), .O(new_n867_));
  nand3  g772(.a(new_n128_), .b(x69), .c(x63), .O(new_n868_));
  nand3  g773(.a(new_n868_), .b(new_n867_), .c(new_n866_), .O(new_n869_));
  and2   g774(.a(new_n869_), .b(x67), .O(new_n870_));
  nand2  g775(.a(x74), .b(x28), .O(new_n871_));
  nand2  g776(.a(new_n209_), .b(x29), .O(new_n872_));
  aoi21  g777(.a(new_n872_), .b(new_n871_), .c(new_n212_), .O(new_n873_));
  nand2  g778(.a(new_n268_), .b(x30), .O(new_n874_));
  inv1   g779(.a(new_n874_), .O(new_n875_));
  oai21  g780(.a(new_n875_), .b(new_n873_), .c(new_n203_), .O(new_n876_));
  nand2  g781(.a(new_n207_), .b(x31), .O(new_n877_));
  nand2  g782(.a(x74), .b(x26), .O(new_n878_));
  nand2  g783(.a(new_n209_), .b(x27), .O(new_n879_));
  aoi21  g784(.a(new_n879_), .b(new_n878_), .c(x73), .O(new_n880_));
  nand2  g785(.a(new_n705_), .b(x23), .O(new_n881_));
  inv1   g786(.a(new_n881_), .O(new_n882_));
  oai21  g787(.a(new_n882_), .b(new_n880_), .c(x72), .O(new_n883_));
  nand3  g788(.a(new_n883_), .b(new_n877_), .c(new_n876_), .O(new_n884_));
  nand2  g789(.a(new_n884_), .b(new_n143_), .O(new_n885_));
  nand2  g790(.a(x74), .b(x60), .O(new_n886_));
  nand2  g791(.a(new_n209_), .b(x61), .O(new_n887_));
  aoi21  g792(.a(new_n887_), .b(new_n886_), .c(new_n212_), .O(new_n888_));
  nand2  g793(.a(new_n268_), .b(x62), .O(new_n889_));
  inv1   g794(.a(new_n889_), .O(new_n890_));
  oai21  g795(.a(new_n890_), .b(new_n888_), .c(new_n203_), .O(new_n891_));
  nand2  g796(.a(new_n207_), .b(x63), .O(new_n892_));
  nand2  g797(.a(x74), .b(x58), .O(new_n893_));
  nand2  g798(.a(new_n209_), .b(x59), .O(new_n894_));
  aoi21  g799(.a(new_n894_), .b(new_n893_), .c(x73), .O(new_n895_));
  nand2  g800(.a(new_n705_), .b(x55), .O(new_n896_));
  inv1   g801(.a(new_n896_), .O(new_n897_));
  oai21  g802(.a(new_n897_), .b(new_n895_), .c(x72), .O(new_n898_));
  nand3  g803(.a(new_n898_), .b(new_n892_), .c(new_n891_), .O(new_n899_));
  nand2  g804(.a(new_n899_), .b(new_n144_), .O(new_n900_));
  aoi21  g805(.a(new_n900_), .b(new_n885_), .c(new_n774_), .O(new_n901_));
  oai21  g806(.a(new_n901_), .b(new_n870_), .c(new_n151_), .O(new_n902_));
  nand2  g807(.a(new_n869_), .b(new_n152_), .O(new_n903_));
  aoi21  g808(.a(new_n903_), .b(new_n902_), .c(new_n632_), .O(new_n904_));
  nand4  g809(.a(new_n94_), .b(x69), .c(x65), .d(new_n92_), .O(new_n905_));
  aoi21  g810(.a(new_n900_), .b(new_n885_), .c(new_n905_), .O(new_n906_));
  oai21  g811(.a(new_n906_), .b(new_n904_), .c(new_n139_), .O(new_n907_));
  nand3  g812(.a(x71), .b(new_n134_), .c(x15), .O(new_n908_));
  inv1   g813(.a(new_n908_), .O(new_n909_));
  aoi21  g814(.a(new_n899_), .b(new_n717_), .c(new_n909_), .O(new_n910_));
  nand3  g815(.a(new_n118_), .b(new_n134_), .c(x47), .O(new_n911_));
  oai21  g816(.a(new_n910_), .b(x70), .c(new_n911_), .O(new_n912_));
  nand2  g817(.a(new_n102_), .b(x15), .O(new_n913_));
  nand2  g818(.a(new_n118_), .b(x47), .O(new_n914_));
  aoi21  g819(.a(new_n914_), .b(new_n913_), .c(new_n136_), .O(new_n915_));
  aoi21  g820(.a(new_n912_), .b(new_n94_), .c(new_n915_), .O(new_n916_));
  nand2  g821(.a(new_n899_), .b(new_n93_), .O(new_n917_));
  oai21  g822(.a(new_n153_), .b(new_n864_), .c(new_n917_), .O(new_n918_));
  nand3  g823(.a(new_n918_), .b(new_n173_), .c(new_n128_), .O(new_n919_));
  oai21  g824(.a(new_n916_), .b(x64), .c(new_n919_), .O(new_n920_));
  nand2  g825(.a(new_n920_), .b(new_n140_), .O(new_n921_));
  nand2  g826(.a(new_n921_), .b(new_n907_), .O(z15));
  zero   g827(.O(z09));
  zero   g828(.O(z10));
  zero   g829(.O(z11));
  zero   g830(.O(z13));
