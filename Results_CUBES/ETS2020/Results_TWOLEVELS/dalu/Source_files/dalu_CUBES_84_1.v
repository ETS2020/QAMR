// Benchmark "FAU" written by ABC on Sun Aug  2 11:20:33 2020
...
module FAU ( 
  ...
  and2   g747(.a(new_n840_), .b(new_n757_), .O(new_n841_));
  oai21  g748(.a(new_n841_), .b(new_n828_), .c(new_n111_), .O(new_n842_));
  aoi21  g749(.a(new_n831_), .b(new_n830_), .c(new_n137_), .O(new_n843_));
  ...
  aoi21  g756(.a(new_n816_), .b(new_n815_), .c(new_n137_), .O(new_n850_));
  aoi21  g757(.a(new_n823_), .b(new_n822_), .c(x72), .O(new_n851_));
  ...
  oai21  g761(.a(new_n280_), .b(new_n127_), .c(x44), .O(new_n855_));
  inv1   g762(.a(x44), .O(new_n856_));
  inv1   g763(.a(new_n280_), .O(new_n857_));
  nand3  g764(.a(new_n857_), .b(new_n856_), .c(x32), .O(new_n858_));
  aoi21  g765(.a(new_n858_), .b(new_n855_), .c(x71), .O(new_n859_));
  nand2  g766(.a(new_n859_), .b(new_n778_), .O(new_n860_));
  ...
  nand2  g770(.a(new_n812_), .b(new_n111_), .O(new_n864_));
  ...
  nand2  g781(.a(new_n826_), .b(new_n159_), .O(new_n875_));
  aoi21  g782(.a(new_n875_), .b(new_n874_), .c(new_n795_), .O(new_n876_));
  oai21  g783(.a(new_n876_), .b(new_n873_), .c(new_n153_), .O(new_n877_));
  nand2  g784(.a(new_n826_), .b(new_n168_), .O(new_n878_));
  oai21  g785(.a(new_n168_), .b(new_n856_), .c(new_n878_), .O(new_n879_));
  nand2  g786(.a(new_n879_), .b(new_n327_), .O(new_n880_));
  ...
  aoi21  g790(.a(new_n883_), .b(new_n882_), .c(new_n332_), .O(new_n884_));
  ...
  nand2  g797(.a(new_n821_), .b(new_n146_), .O(new_n892_));
  nand2  g798(.a(new_n728_), .b(x54), .O(new_n893_));
  ...
  aoi22  g809(.a(new_n903_), .b(new_n740_), .c(new_n890_), .d(new_n136_), .O(new_n904_));
  nand2  g810(.a(new_n141_), .b(x30), .O(new_n905_));
  nand2  g811(.a(new_n835_), .b(new_n146_), .O(new_n906_));
  nand2  g812(.a(new_n728_), .b(x22), .O(new_n907_));
  ...
  nand2  g822(.a(new_n916_), .b(new_n757_), .O(new_n917_));
  ...
  nand2  g840(.a(new_n934_), .b(new_n778_), .O(new_n935_));
  ...
  aoi21  g857(.a(new_n951_), .b(new_n950_), .c(new_n795_), .O(new_n952_));
  ...
  nand2  g862(.a(new_n956_), .b(new_n327_), .O(new_n957_));
  ...
  aoi21  g866(.a(new_n960_), .b(new_n959_), .c(new_n332_), .O(new_n961_));
  ...
  nand2  g887(.a(new_n728_), .b(x23), .O(new_n982_));
  ...
  nand2  g902(.a(new_n728_), .b(x55), .O(new_n997_));
  ...
  aoi21  g907(.a(new_n1001_), .b(new_n986_), .c(new_n795_), .O(new_n1002_));
  oai21  g908(.a(new_n1002_), .b(new_n971_), .c(new_n189_), .O(new_n1003_));
  nand2  g909(.a(new_n970_), .b(new_n190_), .O(new_n1004_));
  aoi21  g910(.a(new_n1004_), .b(new_n1003_), .c(new_n600_), .O(new_n1005_));
  ...
  aoi21  g916(.a(new_n1000_), .b(new_n740_), .c(new_n1010_), .O(new_n1011_));
  ...
  aoi21  g921(.a(new_n1015_), .b(new_n1014_), .c(new_n387_), .O(new_n1016_));
