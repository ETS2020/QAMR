...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n114_, new_n119_, new_n121_, new_n124_, new_n125_, new_n126_,
  ...
  inv1   g10(.a(x35), .O(new_n74_));
  nor2   g11(.a(new_n74_), .b(x28), .O(new_n75_));
  oai21  g12(.a(x27), .b(x08), .c(new_n75_), .O(new_n76_));
  nand2  g13(.a(new_n76_), .b(x04), .O(new_n77_));
  ...
  oai21  g19(.a(new_n74_), .b(new_n82_), .c(x27), .O(new_n83_));
  ...
  oai21  g43(.a(new_n84_), .b(new_n64_), .c(new_n75_), .O(new_n108_));
  nand2  g44(.a(new_n108_), .b(new_n107_), .O(new_n109_));
  inv1   g45(.a(x08), .O(new_n110_));
  nand3  g46(.a(new_n75_), .b(x27), .c(new_n64_), .O(new_n111_));
  ...
  nand4  g51(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n119_));
  inv1   g52(.a(new_n119_), .O(z15));
  nand2  g53(.a(x22), .b(x01), .O(new_n121_));
  nor2   g54(.a(new_n121_), .b(x23), .O(z16));
  nand2  g55(.a(new_n75_), .b(new_n84_), .O(new_n124_));
  nand2  g56(.a(new_n124_), .b(new_n107_), .O(new_n125_));
  nand2  g57(.a(new_n125_), .b(x08), .O(new_n126_));
  nand3  g58(.a(new_n126_), .b(new_n113_), .c(new_n111_), .O(z18));
  oai21  g59(.a(new_n74_), .b(new_n84_), .c(new_n110_), .O(new_n128_));
  oai21  g60(.a(new_n82_), .b(x27), .c(x35), .O(new_n129_));
  nand2  g61(.a(new_n129_), .b(new_n107_), .O(new_n130_));
  aoi21  g62(.a(new_n130_), .b(new_n128_), .c(new_n114_), .O(z20));
  zero   g63(.O(z01));
  zero   g64(.O(z10));
  zero   g65(.O(z12));
  zero   g66(.O(z13));
  zero   g67(.O(z14));
  zero   g68(.O(z17));
  aoi21  g69(.a(new_n112_), .b(new_n109_), .c(new_n114_), .O(z19));
endmodule
