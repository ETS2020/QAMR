...
module FAU ( 
  ...
  nand3  g80(.a(x35), .b(new_n66_), .c(new_n64_), .O(new_n147_));
  nand2  g81(.a(new_n147_), .b(new_n104_), .O(new_n148_));
  nand2  g82(.a(new_n148_), .b(x08), .O(new_n149_));
  nand3  g83(.a(new_n149_), .b(new_n111_), .c(new_n109_), .O(z18));
  oai21  g84(.a(new_n136_), .b(new_n64_), .c(new_n108_), .O(new_n151_));
  oai21  g85(.a(new_n66_), .b(x27), .c(x35), .O(new_n152_));
  nand2  g86(.a(new_n152_), .b(new_n104_), .O(new_n153_));
  aoi21  g87(.a(new_n153_), .b(new_n151_), .c(new_n112_), .O(z20));
  zero   g88(.O(z00));
  zero   g89(.O(z05));
  zero   g90(.O(z10));
  zero   g91(.O(z17));
  aoi21  g92(.a(new_n110_), .b(new_n107_), .c(new_n112_), .O(z19));
endmodule
