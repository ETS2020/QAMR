// Benchmark "FAU" written by ABC on Thu Jul  9 22:58:25 2020
...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n138_, new_n139_, new_n142_, new_n143_, new_n144_;
  ...
  nand2  g51(.a(x27), .b(new_n64_), .O(new_n116_));
  oai21  g52(.a(new_n116_), .b(new_n105_), .c(new_n115_), .O(new_n117_));
  or2    g53(.a(x30), .b(x09), .O(new_n118_));
  aoi21  g54(.a(new_n117_), .b(new_n114_), .c(new_n118_), .O(z11));
  inv1   g55(.a(x13), .O(new_n121_));
  inv1   g56(.a(x39), .O(new_n122_));
  nor2   g57(.a(new_n122_), .b(x04), .O(new_n123_));
  oai21  g58(.a(new_n104_), .b(new_n75_), .c(x28), .O(new_n124_));
  nand4  g59(.a(new_n124_), .b(new_n123_), .c(x40), .d(new_n121_), .O(new_n125_));
  inv1   g60(.a(new_n66_), .O(new_n126_));
  nor2   g61(.a(x19), .b(x18), .O(new_n127_));
  nand3  g62(.a(new_n127_), .b(new_n126_), .c(x20), .O(new_n128_));
  nand2  g63(.a(new_n128_), .b(new_n125_), .O(new_n129_));
  nand2  g64(.a(new_n129_), .b(x27), .O(new_n130_));
  nor2   g65(.a(new_n107_), .b(new_n97_), .O(new_n131_));
  nand3  g66(.a(new_n131_), .b(new_n121_), .c(new_n64_), .O(new_n132_));
  nand2  g67(.a(new_n132_), .b(new_n130_), .O(z13));
  ...
  oai21  g73(.a(new_n75_), .b(new_n77_), .c(new_n115_), .O(new_n142_));
  oai21  g74(.a(new_n74_), .b(x27), .c(x35), .O(new_n143_));
  nand2  g75(.a(new_n143_), .b(new_n112_), .O(new_n144_));
  aoi21  g76(.a(new_n144_), .b(new_n142_), .c(new_n118_), .O(z20));
  zero   g77(.O(z01));
  zero   g78(.O(z02));
  zero   g79(.O(z12));
  zero   g80(.O(z14));
  zero   g81(.O(z16));
  zero   g82(.O(z18));
  aoi21  g83(.a(new_n117_), .b(new_n114_), .c(new_n118_), .O(z19));
endmodule
