...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n128_, new_n131_, new_n133_, new_n136_, new_n137_, new_n138_,
  ...
  nand2  g67(.a(new_n74_), .b(new_n84_), .O(new_n136_));
  nand2  g68(.a(new_n136_), .b(new_n107_), .O(new_n137_));
  nand2  g69(.a(new_n137_), .b(x08), .O(new_n138_));
  nand3  g70(.a(new_n138_), .b(new_n113_), .c(new_n111_), .O(z18));
  oai21  g71(.a(new_n73_), .b(new_n84_), .c(new_n110_), .O(new_n140_));
  oai21  g72(.a(new_n82_), .b(x27), .c(x35), .O(new_n141_));
  nand2  g73(.a(new_n141_), .b(new_n107_), .O(new_n142_));
  aoi21  g74(.a(new_n142_), .b(new_n140_), .c(new_n114_), .O(z20));
  zero   g75(.O(z01));
  zero   g76(.O(z09));
  zero   g77(.O(z10));
  zero   g78(.O(z12));
  zero   g79(.O(z14));
  zero   g80(.O(z17));
  aoi21  g81(.a(new_n112_), .b(new_n109_), .c(new_n114_), .O(z19));
endmodule
