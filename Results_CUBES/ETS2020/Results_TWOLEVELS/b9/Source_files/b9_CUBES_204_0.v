// Benchmark "FAU" written by ABC on Thu Jul  9 23:02:07 2020
...
module FAU ( 
  ...
  nand3  g39(.a(x40), .b(x39), .c(x29), .O(new_n104_));
  ...
  aoi21  g51(.a(x35), .b(x28), .c(x37), .O(new_n116_));
  nor2   g52(.a(new_n116_), .b(new_n64_), .O(new_n117_));
  nor2   g53(.a(new_n76_), .b(x04), .O(new_n118_));
  oai22  g54(.a(new_n118_), .b(new_n117_), .c(new_n115_), .d(x10), .O(z12));
  nor2   g55(.a(x19), .b(x18), .O(new_n121_));
  nand2  g56(.a(new_n121_), .b(x20), .O(new_n122_));
  nand2  g57(.a(x36), .b(x35), .O(new_n123_));
  nand4  g58(.a(new_n123_), .b(new_n70_), .c(new_n69_), .d(x28), .O(new_n124_));
  nor2   g59(.a(x13), .b(x04), .O(new_n125_));
  nand3  g60(.a(new_n125_), .b(new_n124_), .c(z08), .O(new_n126_));
  nand2  g61(.a(new_n126_), .b(new_n122_), .O(new_n127_));
  nand3  g62(.a(new_n81_), .b(new_n79_), .c(x28), .O(new_n128_));
  nand2  g63(.a(new_n128_), .b(x27), .O(new_n129_));
  nand3  g64(.a(new_n129_), .b(new_n70_), .c(new_n69_), .O(new_n130_));
  nand2  g65(.a(new_n125_), .b(z08), .O(new_n131_));
  oai21  g66(.a(new_n116_), .b(new_n64_), .c(new_n131_), .O(new_n132_));
  nand3  g67(.a(new_n132_), .b(new_n130_), .c(new_n127_), .O(z14));
  ...
  oai21  g73(.a(new_n67_), .b(x27), .c(new_n104_), .O(new_n140_));
  nand2  g74(.a(new_n140_), .b(x08), .O(new_n141_));
  nand3  g75(.a(new_n141_), .b(new_n111_), .c(new_n109_), .O(z18));
  oai21  g76(.a(new_n79_), .b(new_n64_), .c(new_n108_), .O(new_n143_));
  oai21  g77(.a(new_n66_), .b(x27), .c(x35), .O(new_n144_));
  nand2  g78(.a(new_n144_), .b(new_n104_), .O(new_n145_));
  aoi21  g79(.a(new_n145_), .b(new_n143_), .c(new_n112_), .O(z20));
  zero   g80(.O(z00));
  zero   g81(.O(z10));
  zero   g82(.O(z13));
  zero   g83(.O(z15));
