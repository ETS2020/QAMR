...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n120_, new_n121_, new_n122_, new_n128_, new_n130_, new_n131_,
  ...
  inv1   g42(.a(x30), .O(new_n107_));
  inv1   g43(.a(x32), .O(new_n108_));
  nand3  g44(.a(x40), .b(x39), .c(x05), .O(new_n109_));
  aoi21  g45(.a(new_n108_), .b(new_n107_), .c(new_n109_), .O(new_n110_));
  aoi21  g46(.a(new_n106_), .b(new_n103_), .c(new_n110_), .O(new_n111_));
  nand3  g47(.a(x37), .b(x27), .c(x06), .O(new_n112_));
  oai21  g48(.a(new_n111_), .b(x04), .c(new_n112_), .O(z10));
  nand2  g49(.a(z08), .b(x29), .O(new_n114_));
  nor2   g50(.a(new_n77_), .b(new_n64_), .O(new_n115_));
  oai21  g51(.a(new_n115_), .b(new_n105_), .c(new_n114_), .O(new_n116_));
  inv1   g52(.a(x08), .O(new_n117_));
  nor2   g53(.a(new_n75_), .b(x28), .O(new_n118_));
  nand3  g54(.a(new_n118_), .b(x27), .c(new_n64_), .O(new_n119_));
  nand2  g55(.a(new_n119_), .b(new_n117_), .O(new_n120_));
  inv1   g56(.a(x09), .O(new_n121_));
  nand2  g57(.a(new_n107_), .b(new_n121_), .O(new_n122_));
  aoi21  g58(.a(new_n120_), .b(new_n116_), .c(new_n122_), .O(z11));
  nand2  g59(.a(x22), .b(x01), .O(new_n128_));
  nor2   g60(.a(new_n128_), .b(x23), .O(z16));
  inv1   g61(.a(x24), .O(new_n130_));
  nand4  g62(.a(new_n130_), .b(x23), .c(x22), .d(x01), .O(new_n131_));
  inv1   g63(.a(new_n131_), .O(z17));
  nand2  g64(.a(new_n118_), .b(new_n77_), .O(new_n133_));
  nand2  g65(.a(new_n133_), .b(new_n114_), .O(new_n134_));
  nand2  g66(.a(new_n134_), .b(x08), .O(new_n135_));
  nand4  g67(.a(new_n135_), .b(new_n119_), .c(new_n107_), .d(new_n121_), .O(z18));
  oai21  g68(.a(new_n75_), .b(new_n77_), .c(new_n117_), .O(new_n137_));
  oai21  g69(.a(new_n74_), .b(x27), .c(x35), .O(new_n138_));
  nand2  g70(.a(new_n138_), .b(new_n114_), .O(new_n139_));
  aoi21  g71(.a(new_n139_), .b(new_n137_), .c(new_n122_), .O(z20));
  zero   g72(.O(z01));
  zero   g73(.O(z02));
  zero   g74(.O(z12));
  zero   g75(.O(z13));
  zero   g76(.O(z14));
  zero   g77(.O(z15));
  aoi21  g78(.a(new_n120_), .b(new_n116_), .c(new_n122_), .O(z19));
endmodule
