// Benchmark "FAU" written by ABC on Thu Jul  9 22:50:53 2020
...
module FAU ( 
  ...
  nand2  g29(.a(x27), .b(new_n93_), .O(new_n97_));
  oai21  g30(.a(new_n97_), .b(new_n67_), .c(new_n96_), .O(new_n98_));
  inv1   g31(.a(x09), .O(new_n99_));
  nand2  g32(.a(new_n69_), .b(new_n99_), .O(new_n100_));
  ...
  oai21  g58(.a(new_n79_), .b(new_n64_), .c(new_n96_), .O(new_n129_));
  oai21  g59(.a(new_n66_), .b(x27), .c(x35), .O(new_n130_));
  nand2  g60(.a(new_n130_), .b(new_n92_), .O(new_n131_));
  aoi21  g61(.a(new_n131_), .b(new_n129_), .c(new_n100_), .O(z20));
  zero   g62(.O(z00));
  zero   g63(.O(z05));
  zero   g64(.O(z07));
  zero   g65(.O(z09));
  ...
  zero   g68(.O(z15));
  zero   g69(.O(z18));
  aoi21  g70(.a(new_n98_), .b(new_n95_), .c(new_n100_), .O(z19));
endmodule
