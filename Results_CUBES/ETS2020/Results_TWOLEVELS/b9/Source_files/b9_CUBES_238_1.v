...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n130_, new_n132_, new_n134_, new_n135_, new_n138_, new_n139_,
    new_n140_;
  ...
  nand2  g56(.a(x27), .b(new_n64_), .O(new_n122_));
  oai21  g57(.a(new_n122_), .b(new_n75_), .c(new_n121_), .O(new_n123_));
  inv1   g58(.a(x09), .O(new_n124_));
  nand2  g59(.a(new_n111_), .b(new_n124_), .O(new_n125_));
  aoi21  g60(.a(new_n123_), .b(new_n120_), .c(new_n125_), .O(z11));
  nand4  g61(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n130_));
  inv1   g62(.a(new_n130_), .O(z15));
  ...
  oai21  g68(.a(new_n81_), .b(new_n83_), .c(new_n121_), .O(new_n138_));
  oai21  g69(.a(new_n74_), .b(x27), .c(x35), .O(new_n139_));
  nand2  g70(.a(new_n139_), .b(new_n118_), .O(new_n140_));
  aoi21  g71(.a(new_n140_), .b(new_n138_), .c(new_n125_), .O(z20));
  zero   g72(.O(z01));
  zero   g73(.O(z05));
  zero   g74(.O(z08));
  zero   g75(.O(z12));
  ...
  zero   g77(.O(z14));
  zero   g78(.O(z18));
  aoi21  g79(.a(new_n123_), .b(new_n120_), .c(new_n125_), .O(z19));
endmodule
