// Benchmark "FAU" written by ABC on Thu Jul  9 22:50:14 2020
...
module FAU ( 
  ...
  nand2  g32(.a(x27), .b(new_n94_), .O(new_n98_));
  oai21  g33(.a(new_n98_), .b(new_n67_), .c(new_n97_), .O(new_n99_));
  inv1   g34(.a(x09), .O(new_n100_));
  nand2  g35(.a(new_n69_), .b(new_n100_), .O(new_n101_));
  ...
  oai21  g61(.a(new_n79_), .b(new_n64_), .c(new_n97_), .O(new_n130_));
  oai21  g62(.a(new_n66_), .b(x27), .c(x35), .O(new_n131_));
  nand2  g63(.a(new_n131_), .b(new_n93_), .O(new_n132_));
  aoi21  g64(.a(new_n132_), .b(new_n130_), .c(new_n101_), .O(z20));
  zero   g65(.O(z00));
  zero   g66(.O(z07));
  zero   g67(.O(z10));
  zero   g68(.O(z13));
