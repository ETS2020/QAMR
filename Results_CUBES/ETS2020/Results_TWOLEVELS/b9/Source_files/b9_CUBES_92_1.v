// Benchmark "FAU" written by ABC on Thu Jul  9 22:54:19 2020
...
module FAU ( 
  ...
  oai21  g74(.a(new_n105_), .b(x27), .c(new_n112_), .O(new_n142_));
  nand2  g75(.a(new_n142_), .b(x08), .O(new_n143_));
  nand3  g76(.a(new_n143_), .b(new_n119_), .c(new_n117_), .O(z18));
  oai21  g77(.a(new_n75_), .b(new_n77_), .c(new_n115_), .O(new_n145_));
  oai21  g78(.a(new_n74_), .b(x27), .c(x35), .O(new_n146_));
  nand2  g79(.a(new_n146_), .b(new_n112_), .O(new_n147_));
  aoi21  g80(.a(new_n147_), .b(new_n145_), .c(new_n120_), .O(z20));
  zero   g81(.O(z01));
  zero   g82(.O(z02));
  zero   g83(.O(z12));
  zero   g84(.O(z14));
