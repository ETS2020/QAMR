...
module FAU ( 
  ...
  inv1   g75(.a(x29), .O(new_n143_));
  oai22  g76(.a(new_n75_), .b(x27), .c(new_n82_), .d(new_n143_), .O(new_n144_));
  nand2  g77(.a(new_n144_), .b(x08), .O(new_n145_));
  nand4  g78(.a(x35), .b(new_n74_), .c(x27), .d(new_n64_), .O(new_n146_));
  nor2   g79(.a(x30), .b(x09), .O(new_n147_));
  nand3  g80(.a(new_n147_), .b(new_n146_), .c(new_n145_), .O(z18));
  zero   g81(.O(z03));
  zero   g82(.O(z04));
  zero   g83(.O(z06));
  zero   g84(.O(z11));
