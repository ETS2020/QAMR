...
module FAU ( 
  ...
  nand3  g84(.a(x35), .b(new_n66_), .c(new_n64_), .O(new_n149_));
  nand2  g85(.a(new_n149_), .b(new_n104_), .O(new_n150_));
  nand2  g86(.a(new_n150_), .b(x08), .O(new_n151_));
  nand3  g87(.a(new_n151_), .b(new_n111_), .c(new_n109_), .O(z18));
  oai21  g88(.a(new_n136_), .b(new_n64_), .c(new_n108_), .O(new_n153_));
  oai21  g89(.a(new_n66_), .b(x27), .c(x35), .O(new_n154_));
  nand2  g90(.a(new_n154_), .b(new_n104_), .O(new_n155_));
  aoi21  g91(.a(new_n155_), .b(new_n153_), .c(new_n112_), .O(z20));
  zero   g92(.O(z00));
  zero   g93(.O(z10));
