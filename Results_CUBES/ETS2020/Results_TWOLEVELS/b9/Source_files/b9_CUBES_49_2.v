...
module FAU ( 
  ...
  inv1   g70(.a(x09), .O(new_n140_));
  nor2   g71(.a(new_n130_), .b(x28), .O(new_n141_));
  nand2  g72(.a(new_n141_), .b(new_n72_), .O(new_n142_));
  nand2  g73(.a(z08), .b(x29), .O(new_n143_));
  nand2  g74(.a(new_n143_), .b(new_n142_), .O(new_n144_));
  nand2  g75(.a(new_n144_), .b(x08), .O(new_n145_));
  nand3  g76(.a(new_n141_), .b(x27), .c(new_n64_), .O(new_n146_));
  nand4  g77(.a(new_n146_), .b(new_n145_), .c(new_n122_), .d(new_n140_), .O(z18));
  nand2  g78(.a(new_n122_), .b(new_n140_), .O(new_n148_));
  nor2   g79(.a(new_n72_), .b(new_n64_), .O(new_n149_));
  oai21  g80(.a(new_n149_), .b(new_n75_), .c(new_n143_), .O(new_n150_));
  inv1   g81(.a(x08), .O(new_n151_));
  nand2  g82(.a(new_n146_), .b(new_n151_), .O(new_n152_));
  aoi21  g83(.a(new_n152_), .b(new_n150_), .c(new_n148_), .O(z19));
  zero   g84(.O(z03));
  zero   g85(.O(z04));
  zero   g86(.O(z06));
  zero   g87(.O(z11));
