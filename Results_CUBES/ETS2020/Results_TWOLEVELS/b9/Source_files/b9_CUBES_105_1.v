...
module FAU ( 
  ...
  or2    g48(.a(x30), .b(x09), .O(new_n114_));
  aoi21  g49(.a(new_n113_), .b(new_n110_), .c(new_n114_), .O(z11));
  ...
  oai21  g70(.a(new_n73_), .b(new_n84_), .c(new_n111_), .O(new_n139_));
  oai21  g71(.a(new_n82_), .b(x27), .c(x35), .O(new_n140_));
  nand2  g72(.a(new_n140_), .b(new_n108_), .O(new_n141_));
  aoi21  g73(.a(new_n141_), .b(new_n139_), .c(new_n114_), .O(z20));
  zero   g74(.O(z01));
  zero   g75(.O(z08));
  zero   g76(.O(z10));
  zero   g77(.O(z12));
