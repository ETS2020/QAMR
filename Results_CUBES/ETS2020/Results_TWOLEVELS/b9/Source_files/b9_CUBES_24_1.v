// Benchmark "FAU" written by ABC on Thu Jul  9 22:49:28 2020
...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n134_, new_n135_, new_n136_, new_n137_, new_n141_, new_n144_,
  ...
  oai21  g75(.a(new_n75_), .b(x27), .c(new_n116_), .O(new_n144_));
  nand2  g76(.a(new_n144_), .b(x08), .O(new_n145_));
  nand3  g77(.a(new_n145_), .b(new_n122_), .c(new_n120_), .O(z18));
  oai21  g78(.a(new_n81_), .b(new_n83_), .c(new_n119_), .O(new_n147_));
  oai21  g79(.a(new_n74_), .b(x27), .c(x35), .O(new_n148_));
  nand2  g80(.a(new_n148_), .b(new_n116_), .O(new_n149_));
  aoi21  g81(.a(new_n149_), .b(new_n147_), .c(new_n123_), .O(z20));
  zero   g82(.O(z01));
  zero   g83(.O(z08));
  zero   g84(.O(z12));
  zero   g85(.O(z14));
  zero   g86(.O(z15));
  zero   g87(.O(z17));
  aoi21  g88(.a(new_n121_), .b(new_n118_), .c(new_n123_), .O(z19));
endmodule
