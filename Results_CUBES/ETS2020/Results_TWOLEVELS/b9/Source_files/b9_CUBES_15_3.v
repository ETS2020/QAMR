// Benchmark "FAU" written by ABC on Thu Jul  9 22:48:51 2020
...
module FAU ( 
  ...
  oai21  g094(.a(new_n75_), .b(x27), .c(new_n113_), .O(new_n159_));
  nand2  g095(.a(new_n159_), .b(x08), .O(new_n160_));
  nand3  g096(.a(new_n160_), .b(new_n120_), .c(new_n118_), .O(z18));
  oai21  g097(.a(new_n81_), .b(new_n72_), .c(new_n116_), .O(new_n162_));
  oai21  g098(.a(new_n74_), .b(x27), .c(x35), .O(new_n163_));
  nand2  g099(.a(new_n163_), .b(new_n113_), .O(new_n164_));
  aoi21  g100(.a(new_n164_), .b(new_n162_), .c(new_n121_), .O(z20));
  zero   g101(.O(z02));
  zero   g102(.O(z17));
  aoi21  g103(.a(new_n119_), .b(new_n115_), .c(new_n121_), .O(z19));
endmodule
