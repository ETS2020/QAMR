...
module FAU ( 
  ...
  oai21  g72(.a(new_n67_), .b(x27), .c(new_n104_), .O(new_n139_));
  nand2  g73(.a(new_n139_), .b(x08), .O(new_n140_));
  nand3  g74(.a(new_n140_), .b(new_n111_), .c(new_n109_), .O(z18));
  oai21  g75(.a(new_n79_), .b(new_n64_), .c(new_n108_), .O(new_n142_));
  oai21  g76(.a(new_n66_), .b(x27), .c(x35), .O(new_n143_));
  nand2  g77(.a(new_n143_), .b(new_n104_), .O(new_n144_));
  aoi21  g78(.a(new_n144_), .b(new_n142_), .c(new_n112_), .O(z20));
  zero   g79(.O(z00));
  zero   g80(.O(z10));
  zero   g81(.O(z13));
  zero   g82(.O(z17));
