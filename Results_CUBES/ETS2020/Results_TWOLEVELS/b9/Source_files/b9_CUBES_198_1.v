// Benchmark "FAU" written by ABC on Thu Jul  9 23:01:39 2020
...
module FAU ( 
  ...
  nand2  g57(.a(x27), .b(new_n64_), .O(new_n122_));
  oai21  g58(.a(new_n122_), .b(new_n75_), .c(new_n121_), .O(new_n123_));
  inv1   g59(.a(x09), .O(new_n124_));
  nand2  g60(.a(new_n111_), .b(new_n124_), .O(new_n125_));
  aoi21  g61(.a(new_n123_), .b(new_n120_), .c(new_n125_), .O(z11));
  ...
  oai21  g69(.a(new_n81_), .b(new_n83_), .c(new_n121_), .O(new_n138_));
  oai21  g70(.a(new_n74_), .b(x27), .c(x35), .O(new_n139_));
  nand2  g71(.a(new_n139_), .b(new_n118_), .O(new_n140_));
  aoi21  g72(.a(new_n140_), .b(new_n138_), .c(new_n125_), .O(z20));
  zero   g73(.O(z01));
  zero   g74(.O(z08));
  zero   g75(.O(z12));
  zero   g76(.O(z13));
