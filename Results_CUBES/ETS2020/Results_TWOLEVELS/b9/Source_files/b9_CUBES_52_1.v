...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n128_, new_n129_, new_n132_, new_n135_, new_n136_, new_n138_,
  ...
  nand2  g69(.a(new_n74_), .b(new_n84_), .O(new_n138_));
  nand2  g70(.a(new_n138_), .b(new_n108_), .O(new_n139_));
  nand2  g71(.a(new_n139_), .b(x08), .O(new_n140_));
  nand3  g72(.a(new_n140_), .b(new_n114_), .c(new_n112_), .O(z18));
  oai21  g73(.a(new_n73_), .b(new_n84_), .c(new_n111_), .O(new_n142_));
  oai21  g74(.a(new_n82_), .b(x27), .c(x35), .O(new_n143_));
  nand2  g75(.a(new_n143_), .b(new_n108_), .O(new_n144_));
  aoi21  g76(.a(new_n144_), .b(new_n142_), .c(new_n115_), .O(z20));
  zero   g77(.O(z01));
  zero   g78(.O(z08));
  zero   g79(.O(z10));
  zero   g80(.O(z12));
  zero   g81(.O(z14));
  zero   g82(.O(z16));
  aoi21  g83(.a(new_n113_), .b(new_n110_), .c(new_n115_), .O(z19));
endmodule
