// Benchmark "FAU" written by ABC on Thu Jul  9 22:53:36 2020
...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n114_, new_n115_, new_n120_, new_n122_, new_n125_, new_n126_,
  ...
  nand4  g51(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n120_));
  inv1   g52(.a(new_n120_), .O(z15));
  nand2  g53(.a(x22), .b(x01), .O(new_n122_));
  nor2   g54(.a(new_n122_), .b(x23), .O(z16));
  nand2  g55(.a(new_n111_), .b(new_n83_), .O(new_n125_));
  nand2  g56(.a(new_n125_), .b(new_n107_), .O(new_n126_));
  nand2  g57(.a(new_n126_), .b(x08), .O(new_n127_));
  nand4  g58(.a(new_n127_), .b(new_n112_), .c(new_n100_), .d(new_n114_), .O(z18));
  oai21  g59(.a(new_n81_), .b(new_n83_), .c(new_n110_), .O(new_n129_));
  oai21  g60(.a(new_n74_), .b(x27), .c(x35), .O(new_n130_));
  nand2  g61(.a(new_n130_), .b(new_n107_), .O(new_n131_));
  aoi21  g62(.a(new_n131_), .b(new_n129_), .c(new_n115_), .O(z20));
  zero   g63(.O(z01));
  zero   g64(.O(z05));
  zero   g65(.O(z07));
  zero   g66(.O(z12));
  ...
  zero   g68(.O(z14));
  zero   g69(.O(z17));
  aoi21  g70(.a(new_n113_), .b(new_n109_), .c(new_n115_), .O(z19));
endmodule
