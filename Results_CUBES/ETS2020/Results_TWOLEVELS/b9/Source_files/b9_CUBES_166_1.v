// Benchmark "FAU" written by ABC on Thu Jul  9 22:59:27 2020
...
module FAU ( 
  ...
  nand3  g51(.a(x40), .b(x39), .c(x29), .O(new_n116_));
  ...
  nand4  g55(.a(x35), .b(new_n74_), .c(x27), .d(new_n64_), .O(new_n120_));
  nand2  g56(.a(new_n120_), .b(new_n119_), .O(new_n121_));
  nor2   g57(.a(x30), .b(x09), .O(new_n122_));
  inv1   g58(.a(new_n122_), .O(new_n123_));
  aoi21  g59(.a(new_n121_), .b(new_n118_), .c(new_n123_), .O(z11));
  inv1   g60(.a(x13), .O(new_n126_));
  inv1   g61(.a(x39), .O(new_n127_));
  nor2   g62(.a(new_n127_), .b(x04), .O(new_n128_));
  oai21  g63(.a(new_n109_), .b(new_n81_), .c(x28), .O(new_n129_));
  nand4  g64(.a(new_n129_), .b(new_n128_), .c(x40), .d(new_n126_), .O(new_n130_));
  inv1   g65(.a(new_n66_), .O(new_n131_));
  nor2   g66(.a(x19), .b(x18), .O(new_n132_));
  nand3  g67(.a(new_n132_), .b(new_n131_), .c(x20), .O(new_n133_));
  nand2  g68(.a(new_n133_), .b(new_n130_), .O(new_n134_));
  nand2  g69(.a(new_n134_), .b(x27), .O(new_n135_));
  nor2   g70(.a(new_n111_), .b(new_n77_), .O(new_n136_));
  nand3  g71(.a(new_n136_), .b(new_n126_), .c(new_n64_), .O(new_n137_));
  nand2  g72(.a(new_n137_), .b(new_n135_), .O(z13));
  nand4  g73(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n140_));
  inv1   g74(.a(new_n140_), .O(z15));
  ...
  oai21  g80(.a(new_n75_), .b(x27), .c(new_n116_), .O(new_n147_));
  nand2  g81(.a(new_n147_), .b(x08), .O(new_n148_));
  nand3  g82(.a(new_n148_), .b(new_n122_), .c(new_n120_), .O(z18));
  oai21  g83(.a(new_n81_), .b(new_n83_), .c(new_n119_), .O(new_n150_));
  oai21  g84(.a(new_n74_), .b(x27), .c(x35), .O(new_n151_));
  nand2  g85(.a(new_n151_), .b(new_n116_), .O(new_n152_));
  aoi21  g86(.a(new_n152_), .b(new_n150_), .c(new_n123_), .O(z20));
  zero   g87(.O(z01));
  zero   g88(.O(z08));
  zero   g89(.O(z12));
  zero   g90(.O(z14));
