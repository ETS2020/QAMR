...
module FAU ( 
  ...
  nand2  g32(.a(new_n70_), .b(x07), .O(new_n98_));
  ...
  nor2   g39(.a(new_n104_), .b(new_n103_), .O(new_n105_));
  aoi21  g40(.a(new_n102_), .b(new_n100_), .c(new_n105_), .O(new_n106_));
  ...
  oai21  g57(.a(new_n67_), .b(x27), .c(new_n109_), .O(new_n127_));
  nand2  g58(.a(new_n127_), .b(x08), .O(new_n128_));
  nand3  g59(.a(new_n128_), .b(new_n116_), .c(new_n114_), .O(z18));
  oai21  g60(.a(new_n73_), .b(new_n75_), .c(new_n113_), .O(new_n130_));
  oai21  g61(.a(new_n66_), .b(x27), .c(x35), .O(new_n131_));
  nand2  g62(.a(new_n131_), .b(new_n109_), .O(new_n132_));
  aoi21  g63(.a(new_n132_), .b(new_n130_), .c(new_n117_), .O(z20));
  zero   g64(.O(z00));
  zero   g65(.O(z01));
  zero   g66(.O(z08));
  zero   g67(.O(z12));
