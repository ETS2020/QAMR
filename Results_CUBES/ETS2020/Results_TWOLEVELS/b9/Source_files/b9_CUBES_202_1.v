// Benchmark "FAU" written by ABC on Thu Jul  9 23:01:57 2020
...
module FAU ( 
  ...
  aoi21  g57(.a(new_n63_), .b(new_n78_), .c(new_n77_), .O(new_n122_));
  oai22  g58(.a(new_n97_), .b(x04), .c(new_n66_), .d(new_n77_), .O(new_n123_));
  oai21  g59(.a(new_n122_), .b(x10), .c(new_n123_), .O(z12));
  inv1   g60(.a(x13), .O(new_n125_));
  inv1   g61(.a(x39), .O(new_n126_));
  nor2   g62(.a(new_n126_), .b(x04), .O(new_n127_));
  oai21  g63(.a(new_n104_), .b(new_n75_), .c(x28), .O(new_n128_));
  nand4  g64(.a(new_n128_), .b(new_n127_), .c(x40), .d(new_n125_), .O(new_n129_));
  inv1   g65(.a(new_n66_), .O(new_n130_));
  nor2   g66(.a(x19), .b(x18), .O(new_n131_));
  nand3  g67(.a(new_n131_), .b(new_n130_), .c(x20), .O(new_n132_));
  nand2  g68(.a(new_n132_), .b(new_n129_), .O(new_n133_));
  nand2  g69(.a(new_n133_), .b(x27), .O(new_n134_));
  nor2   g70(.a(new_n107_), .b(new_n97_), .O(new_n135_));
  nand3  g71(.a(new_n135_), .b(new_n125_), .c(new_n64_), .O(new_n136_));
  nand2  g72(.a(new_n136_), .b(new_n134_), .O(z13));
  nand4  g73(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n139_));
  inv1   g74(.a(new_n139_), .O(z15));
  nand2  g75(.a(x22), .b(x01), .O(new_n141_));
  nor2   g76(.a(new_n141_), .b(x23), .O(z16));
  inv1   g77(.a(x24), .O(new_n143_));
  nand4  g78(.a(new_n143_), .b(x23), .c(x22), .d(x01), .O(new_n144_));
  inv1   g79(.a(new_n144_), .O(z17));
  oai21  g80(.a(new_n105_), .b(x27), .c(new_n112_), .O(new_n146_));
  nand2  g81(.a(new_n146_), .b(x08), .O(new_n147_));
  nand3  g82(.a(new_n147_), .b(new_n119_), .c(new_n117_), .O(z18));
  oai21  g83(.a(new_n75_), .b(new_n77_), .c(new_n115_), .O(new_n149_));
  oai21  g84(.a(new_n74_), .b(x27), .c(x35), .O(new_n150_));
  nand2  g85(.a(new_n150_), .b(new_n112_), .O(new_n151_));
  aoi21  g86(.a(new_n151_), .b(new_n149_), .c(new_n120_), .O(z20));
  zero   g87(.O(z01));
  zero   g88(.O(z02));
  zero   g89(.O(z14));
  aoi21  g90(.a(new_n118_), .b(new_n114_), .c(new_n120_), .O(z19));
endmodule
