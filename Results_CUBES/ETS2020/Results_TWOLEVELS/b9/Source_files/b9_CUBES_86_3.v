// Benchmark "FAU" written by ABC on Thu Jul  9 22:53:54 2020
...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n155_, new_n159_, new_n160_, new_n161_;
  ...
  oai21  g093(.a(new_n81_), .b(new_n72_), .c(new_n116_), .O(new_n159_));
  oai21  g094(.a(new_n74_), .b(x27), .c(x35), .O(new_n160_));
  nand2  g095(.a(new_n160_), .b(new_n113_), .O(new_n161_));
  aoi21  g096(.a(new_n161_), .b(new_n159_), .c(new_n121_), .O(z20));
  zero   g097(.O(z02));
  zero   g098(.O(z17));
  zero   g099(.O(z18));
  aoi21  g100(.a(new_n118_), .b(new_n115_), .c(new_n121_), .O(z19));
endmodule
