// Benchmark "FAU" written by ABC on Thu Jul  9 23:05:49 2020
...
module FAU ( 
  ...
  nand2  g81(.a(x22), .b(x01), .O(new_n147_));
  nor2   g82(.a(new_n147_), .b(x23), .O(z16));
  inv1   g83(.a(x24), .O(new_n149_));
  nand4  g84(.a(new_n149_), .b(x23), .c(x22), .d(x01), .O(new_n150_));
  inv1   g85(.a(new_n150_), .O(z17));
  nand2  g86(.a(new_n75_), .b(new_n72_), .O(new_n152_));
  nand2  g87(.a(new_n152_), .b(new_n113_), .O(new_n153_));
  nand2  g88(.a(new_n153_), .b(x08), .O(new_n154_));
  nand4  g89(.a(new_n154_), .b(new_n117_), .c(new_n78_), .d(new_n119_), .O(z18));
  oai21  g90(.a(new_n74_), .b(new_n72_), .c(new_n116_), .O(new_n156_));
  oai21  g91(.a(new_n88_), .b(x27), .c(x35), .O(new_n157_));
  nand2  g92(.a(new_n157_), .b(new_n113_), .O(new_n158_));
  aoi21  g93(.a(new_n158_), .b(new_n156_), .c(new_n120_), .O(z20));
  zero   g94(.O(z05));
  zero   g95(.O(z10));
  zero   g96(.O(z15));
  aoi21  g97(.a(new_n118_), .b(new_n115_), .c(new_n120_), .O(z19));
endmodule
