// Benchmark "FAU" written by ABC on Thu Jul  9 22:52:04 2020
...
module FAU ( 
  ...
  wire new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_, new_n70_,
    ...
    new_n129_, new_n130_, new_n131_, new_n134_, new_n137_, new_n138_,
  ...
  oai21  g67(.a(new_n67_), .b(x27), .c(new_n103_), .O(new_n137_));
  nand2  g68(.a(new_n137_), .b(x08), .O(new_n138_));
  nand3  g69(.a(new_n138_), .b(new_n110_), .c(new_n108_), .O(z18));
  oai21  g70(.a(new_n79_), .b(new_n64_), .c(new_n107_), .O(new_n140_));
  oai21  g71(.a(new_n66_), .b(x27), .c(x35), .O(new_n141_));
  nand2  g72(.a(new_n141_), .b(new_n103_), .O(new_n142_));
  aoi21  g73(.a(new_n142_), .b(new_n140_), .c(new_n111_), .O(z20));
  zero   g74(.O(z00));
  zero   g75(.O(z05));
  zero   g76(.O(z09));
  zero   g77(.O(z10));
  ...
  zero   g79(.O(z15));
  zero   g80(.O(z17));
  aoi21  g81(.a(new_n109_), .b(new_n106_), .c(new_n111_), .O(z19));
endmodule
