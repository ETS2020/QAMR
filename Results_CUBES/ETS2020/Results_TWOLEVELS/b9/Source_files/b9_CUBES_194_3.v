...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n141_, new_n143_, new_n145_, new_n148_, new_n149_, new_n151_,
    new_n152_, new_n153_;
  ...
  oai21  g82(.a(new_n75_), .b(x27), .c(new_n102_), .O(new_n148_));
  nand2  g83(.a(new_n148_), .b(x08), .O(new_n149_));
  nand3  g84(.a(new_n149_), .b(new_n109_), .c(new_n107_), .O(z18));
  oai21  g85(.a(new_n81_), .b(new_n72_), .c(new_n105_), .O(new_n151_));
  oai21  g86(.a(new_n74_), .b(x27), .c(x35), .O(new_n152_));
  nand2  g87(.a(new_n152_), .b(new_n102_), .O(new_n153_));
  aoi21  g88(.a(new_n153_), .b(new_n151_), .c(new_n110_), .O(z20));
  zero   g89(.O(z02));
  zero   g90(.O(z07));
  zero   g91(.O(z17));
  aoi21  g92(.a(new_n108_), .b(new_n104_), .c(new_n110_), .O(z19));
endmodule
