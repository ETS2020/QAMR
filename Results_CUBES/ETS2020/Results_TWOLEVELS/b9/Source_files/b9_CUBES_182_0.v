...
module FAU ( 
  ...
  wire new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_, new_n70_,
    ...
    new_n117_, new_n118_, new_n119_, new_n120_, new_n123_, new_n127_,
    new_n128_, new_n129_;
  ...
  oai21  g55(.a(new_n79_), .b(new_n64_), .c(new_n96_), .O(new_n127_));
  oai21  g56(.a(new_n66_), .b(x27), .c(x35), .O(new_n128_));
  nand2  g57(.a(new_n128_), .b(new_n92_), .O(new_n129_));
  aoi21  g58(.a(new_n129_), .b(new_n127_), .c(new_n100_), .O(z20));
  zero   g59(.O(z00));
  zero   g60(.O(z05));
  zero   g61(.O(z07));
  zero   g62(.O(z09));
  ...
  zero   g66(.O(z17));
  zero   g67(.O(z18));
  aoi21  g68(.a(new_n98_), .b(new_n95_), .c(new_n100_), .O(z19));
endmodule
