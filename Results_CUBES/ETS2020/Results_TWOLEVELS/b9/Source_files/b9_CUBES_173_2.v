// Benchmark "FAU" written by ABC on Thu Jul  9 22:59:54 2020
...
module FAU ( 
  ...
  nand3  g42(.a(x40), .b(x39), .c(x05), .O(new_n109_));
  nor2   g43(.a(new_n109_), .b(new_n77_), .O(new_n110_));
  aoi21  g44(.a(new_n108_), .b(new_n76_), .c(new_n110_), .O(new_n111_));
  nand3  g45(.a(x37), .b(x27), .c(x06), .O(new_n112_));
  oai21  g46(.a(new_n111_), .b(x04), .c(new_n112_), .O(z10));
  aoi21  g47(.a(new_n63_), .b(new_n88_), .c(new_n72_), .O(new_n115_));
  nor2   g48(.a(new_n66_), .b(new_n72_), .O(new_n116_));
  nor2   g49(.a(new_n82_), .b(x04), .O(new_n117_));
  oai22  g50(.a(new_n117_), .b(new_n116_), .c(new_n115_), .d(x10), .O(z12));
  ...
  nand2  g55(.a(x36), .b(x35), .O(new_n124_));
  nand4  g56(.a(new_n124_), .b(new_n123_), .c(new_n122_), .d(x28), .O(new_n125_));
  inv1   g57(.a(new_n125_), .O(new_n126_));
  inv1   g58(.a(x13), .O(new_n127_));
  nand4  g59(.a(x40), .b(x39), .c(new_n127_), .d(new_n64_), .O(new_n128_));
  oai21  g60(.a(new_n128_), .b(new_n126_), .c(new_n121_), .O(new_n129_));
