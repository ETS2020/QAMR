...
module FAU ( 
  ...
  oai21  g41(.a(new_n84_), .b(new_n64_), .c(new_n75_), .O(new_n107_));
  nand2  g42(.a(new_n107_), .b(new_n106_), .O(new_n108_));
  inv1   g43(.a(x08), .O(new_n109_));
  nand3  g44(.a(new_n75_), .b(x27), .c(new_n64_), .O(new_n110_));
  ...
  inv1   g51(.a(x24), .O(new_n121_));
  nand4  g52(.a(new_n121_), .b(x23), .c(x22), .d(x01), .O(new_n122_));
  inv1   g53(.a(new_n122_), .O(z17));
  nand2  g54(.a(new_n75_), .b(new_n84_), .O(new_n124_));
  nand2  g55(.a(new_n124_), .b(new_n106_), .O(new_n125_));
  nand2  g56(.a(new_n125_), .b(x08), .O(new_n126_));
  nand3  g57(.a(new_n126_), .b(new_n112_), .c(new_n110_), .O(z18));
  oai21  g58(.a(new_n74_), .b(new_n84_), .c(new_n109_), .O(new_n128_));
  oai21  g59(.a(new_n82_), .b(x27), .c(x35), .O(new_n129_));
  nand2  g60(.a(new_n129_), .b(new_n106_), .O(new_n130_));
  aoi21  g61(.a(new_n130_), .b(new_n128_), .c(new_n113_), .O(z20));
  zero   g62(.O(z01));
  zero   g63(.O(z09));
  zero   g64(.O(z10));
  zero   g65(.O(z12));
  ...
  zero   g67(.O(z14));
  zero   g68(.O(z16));
  aoi21  g69(.a(new_n111_), .b(new_n108_), .c(new_n113_), .O(z19));
endmodule
