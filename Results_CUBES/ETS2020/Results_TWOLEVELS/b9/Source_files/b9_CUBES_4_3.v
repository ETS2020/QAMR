...
module FAU ( 
  ...
  nand2  g41(.a(x27), .b(new_n64_), .O(new_n106_));
  ...
  aoi21  g46(.a(new_n107_), .b(new_n104_), .c(new_n110_), .O(z11));
  ...
  inv1   g67(.a(x32), .O(new_n132_));
  nand4  g68(.a(new_n117_), .b(new_n132_), .c(new_n109_), .d(x28), .O(new_n133_));
  inv1   g69(.a(new_n133_), .O(new_n134_));
  nand2  g70(.a(new_n129_), .b(z08), .O(new_n135_));
  oai21  g71(.a(new_n135_), .b(new_n134_), .c(new_n124_), .O(new_n136_));
  nand3  g72(.a(new_n83_), .b(new_n81_), .c(x28), .O(new_n137_));
  nand2  g73(.a(new_n137_), .b(x27), .O(new_n138_));
  nand2  g74(.a(new_n138_), .b(new_n77_), .O(new_n139_));
  nand2  g75(.a(new_n135_), .b(new_n114_), .O(new_n140_));
  nand3  g76(.a(new_n140_), .b(new_n139_), .c(new_n136_), .O(z14));
  nand4  g77(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n142_));
  inv1   g78(.a(new_n142_), .O(z15));
  ...
  oai21  g84(.a(new_n81_), .b(new_n72_), .c(new_n105_), .O(new_n150_));
  oai21  g85(.a(new_n74_), .b(x27), .c(x35), .O(new_n151_));
  nand2  g86(.a(new_n151_), .b(new_n102_), .O(new_n152_));
  aoi21  g87(.a(new_n152_), .b(new_n150_), .c(new_n110_), .O(z20));
  zero   g88(.O(z02));
  zero   g89(.O(z07));
  zero   g90(.O(z18));
  aoi21  g91(.a(new_n107_), .b(new_n104_), .c(new_n110_), .O(z19));
endmodule
