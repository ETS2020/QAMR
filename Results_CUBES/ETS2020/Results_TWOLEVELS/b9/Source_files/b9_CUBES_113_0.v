// Benchmark "FAU" written by ABC on Thu Jul  9 22:55:48 2020
...
module FAU ( 
  ...
  nand2  g41(.a(x27), .b(new_n104_), .O(new_n108_));
  oai21  g42(.a(new_n108_), .b(new_n67_), .c(new_n107_), .O(new_n109_));
  inv1   g43(.a(x09), .O(new_n110_));
  nand2  g44(.a(new_n69_), .b(new_n110_), .O(new_n111_));
