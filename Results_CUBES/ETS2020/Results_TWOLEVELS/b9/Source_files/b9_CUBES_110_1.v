// Benchmark "FAU" written by ABC on Thu Jul  9 22:55:35 2020
...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n120_, new_n121_, new_n122_, new_n127_, new_n129_, new_n131_,
  ...
  nand4  g59(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n127_));
  inv1   g60(.a(new_n127_), .O(z15));
  nand2  g61(.a(x22), .b(x01), .O(new_n129_));
  nor2   g62(.a(new_n129_), .b(x23), .O(z16));
  inv1   g63(.a(x24), .O(new_n131_));
  nand4  g64(.a(new_n131_), .b(x23), .c(x22), .d(x01), .O(new_n132_));
  inv1   g65(.a(new_n132_), .O(z17));
  nand2  g66(.a(new_n118_), .b(new_n77_), .O(new_n134_));
  nand2  g67(.a(new_n134_), .b(new_n114_), .O(new_n135_));
  nand2  g68(.a(new_n135_), .b(x08), .O(new_n136_));
  nand4  g69(.a(new_n136_), .b(new_n119_), .c(new_n107_), .d(new_n121_), .O(z18));
  oai21  g70(.a(new_n75_), .b(new_n77_), .c(new_n117_), .O(new_n138_));
  oai21  g71(.a(new_n74_), .b(x27), .c(x35), .O(new_n139_));
  nand2  g72(.a(new_n139_), .b(new_n114_), .O(new_n140_));
  aoi21  g73(.a(new_n140_), .b(new_n138_), .c(new_n122_), .O(z20));
  zero   g74(.O(z01));
  zero   g75(.O(z02));
  zero   g76(.O(z12));
  zero   g77(.O(z13));
  zero   g78(.O(z14));
  aoi21  g79(.a(new_n120_), .b(new_n116_), .c(new_n122_), .O(z19));
endmodule
