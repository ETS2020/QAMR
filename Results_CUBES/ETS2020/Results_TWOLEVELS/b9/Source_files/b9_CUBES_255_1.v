...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n68_, new_n69_, new_n70_, new_n71_,
    ...
    new_n128_, new_n129_, new_n132_, new_n134_, new_n137_, new_n138_,
  ...
  oai21  g69(.a(new_n67_), .b(x27), .c(new_n108_), .O(new_n137_));
  nand2  g70(.a(new_n137_), .b(x08), .O(new_n138_));
  nand3  g71(.a(new_n138_), .b(new_n115_), .c(new_n113_), .O(z18));
  oai21  g72(.a(new_n119_), .b(new_n75_), .c(new_n112_), .O(new_n140_));
  oai21  g73(.a(new_n66_), .b(x27), .c(x35), .O(new_n141_));
  nand2  g74(.a(new_n141_), .b(new_n108_), .O(new_n142_));
  aoi21  g75(.a(new_n142_), .b(new_n140_), .c(new_n116_), .O(z20));
  zero   g76(.O(z00));
  zero   g77(.O(z01));
  zero   g78(.O(z12));
  zero   g79(.O(z14));
  zero   g80(.O(z17));
  aoi21  g81(.a(new_n114_), .b(new_n111_), .c(new_n116_), .O(z19));
endmodule
