// Benchmark "FAU" written by ABC on Thu Jul  9 22:58:32 2020
...
module FAU ( 
  ...
  oai21  g54(.a(new_n86_), .b(x27), .c(new_n94_), .O(new_n125_));
  nand2  g55(.a(new_n125_), .b(x08), .O(new_n126_));
  nand3  g56(.a(new_n126_), .b(new_n102_), .c(new_n100_), .O(z18));
  oai21  g57(.a(new_n106_), .b(new_n68_), .c(new_n98_), .O(new_n128_));
  oai21  g58(.a(new_n85_), .b(x27), .c(x35), .O(new_n129_));
  nand2  g59(.a(new_n129_), .b(new_n94_), .O(new_n130_));
  aoi21  g60(.a(new_n130_), .b(new_n128_), .c(new_n103_), .O(z20));
  zero   g61(.O(z00));
  zero   g62(.O(z01));
  zero   g63(.O(z02));
  zero   g64(.O(z07));
