...
module FAU ( 
  ...
  nand2  g69(.a(x22), .b(x01), .O(new_n138_));
  nor2   g70(.a(new_n138_), .b(x23), .O(z16));
  inv1   g71(.a(x29), .O(new_n141_));
  oai22  g72(.a(new_n75_), .b(x27), .c(new_n82_), .d(new_n141_), .O(new_n142_));
  nand2  g73(.a(new_n142_), .b(x08), .O(new_n143_));
  nand4  g74(.a(x35), .b(new_n74_), .c(x27), .d(new_n64_), .O(new_n144_));
  nor2   g75(.a(x30), .b(x09), .O(new_n145_));
  nand3  g76(.a(new_n145_), .b(new_n144_), .c(new_n143_), .O(z18));
  zero   g77(.O(z03));
  zero   g78(.O(z04));
  zero   g79(.O(z06));
  zero   g80(.O(z07));
