// Benchmark "FAU" written by ABC on Thu Jul  9 23:05:44 2020
...
module FAU ( 
  ...
  inv1   g81(.a(x29), .O(new_n150_));
  oai22  g82(.a(new_n75_), .b(x27), .c(new_n82_), .d(new_n150_), .O(new_n151_));
  nand2  g83(.a(new_n151_), .b(x08), .O(new_n152_));
  nand4  g84(.a(x35), .b(new_n74_), .c(x27), .d(new_n64_), .O(new_n153_));
  nor2   g85(.a(x30), .b(x09), .O(new_n154_));
  nand3  g86(.a(new_n154_), .b(new_n153_), .c(new_n152_), .O(z18));
  zero   g87(.O(z03));
  zero   g88(.O(z04));
  zero   g89(.O(z06));
  zero   g90(.O(z11));
