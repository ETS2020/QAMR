...
module FAU ( 
  ...
  wire new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_, new_n70_,
    ...
    new_n144_, new_n145_, new_n148_, new_n149_, new_n150_;
  ...
  oai21  g79(.a(new_n135_), .b(new_n64_), .c(new_n107_), .O(new_n148_));
  oai21  g80(.a(new_n66_), .b(x27), .c(x35), .O(new_n149_));
  nand2  g81(.a(new_n149_), .b(new_n103_), .O(new_n150_));
  aoi21  g82(.a(new_n150_), .b(new_n148_), .c(new_n111_), .O(z20));
  zero   g83(.O(z00));
  zero   g84(.O(z05));
  zero   g85(.O(z09));
  zero   g86(.O(z10));
  zero   g87(.O(z15));
  zero   g88(.O(z18));
  aoi21  g89(.a(new_n109_), .b(new_n106_), .c(new_n111_), .O(z19));
endmodule
