...
module FAU ( 
  ...
  inv1   g091(.a(x24), .O(new_n156_));
  nand4  g092(.a(new_n156_), .b(x23), .c(x22), .d(x01), .O(new_n157_));
  inv1   g093(.a(new_n157_), .O(z17));
  oai21  g094(.a(new_n81_), .b(new_n72_), .c(new_n116_), .O(new_n160_));
  oai21  g095(.a(new_n74_), .b(x27), .c(x35), .O(new_n161_));
  nand2  g096(.a(new_n161_), .b(new_n113_), .O(new_n162_));
  aoi21  g097(.a(new_n162_), .b(new_n160_), .c(new_n121_), .O(z20));
  zero   g098(.O(z02));
  zero   g099(.O(z16));
  zero   g100(.O(z18));
  aoi21  g101(.a(new_n118_), .b(new_n115_), .c(new_n121_), .O(z19));
endmodule
