...
module FAU ( 
  ...
  nor2   g37(.a(x30), .b(x09), .O(new_n103_));
  inv1   g38(.a(new_n103_), .O(new_n104_));
  aoi21  g39(.a(new_n102_), .b(new_n99_), .c(new_n104_), .O(z11));
  nor2   g40(.a(new_n77_), .b(x04), .O(new_n107_));
  nand2  g41(.a(x36), .b(x35), .O(new_n108_));
  nand2  g42(.a(new_n108_), .b(x28), .O(new_n109_));
  nor2   g43(.a(new_n78_), .b(x13), .O(new_n110_));
  nand3  g44(.a(new_n110_), .b(new_n109_), .c(new_n107_), .O(new_n111_));
  ...
  or2    g50(.a(x32), .b(x30), .O(new_n117_));
  nand3  g51(.a(new_n117_), .b(new_n110_), .c(new_n107_), .O(new_n118_));
  ...
  nand2  g60(.a(new_n74_), .b(new_n84_), .O(new_n128_));
  nand2  g61(.a(new_n128_), .b(new_n97_), .O(new_n129_));
  nand2  g62(.a(new_n129_), .b(x08), .O(new_n130_));
  nand3  g63(.a(new_n130_), .b(new_n103_), .c(new_n101_), .O(z18));
  oai21  g64(.a(new_n73_), .b(new_n84_), .c(new_n100_), .O(new_n132_));
  oai21  g65(.a(new_n82_), .b(x27), .c(x35), .O(new_n133_));
  nand2  g66(.a(new_n133_), .b(new_n97_), .O(new_n134_));
  aoi21  g67(.a(new_n134_), .b(new_n132_), .c(new_n104_), .O(z20));
  zero   g68(.O(z01));
  zero   g69(.O(z07));
  zero   g70(.O(z10));
  zero   g71(.O(z12));
  zero   g72(.O(z14));
  aoi21  g73(.a(new_n102_), .b(new_n99_), .c(new_n104_), .O(z19));
endmodule
