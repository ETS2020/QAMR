// Benchmark "FAU" written by ABC on Thu Jul  9 22:52:42 2020
...
module FAU ( 
  ...
  nand3  g38(.a(x40), .b(x39), .c(x29), .O(new_n104_));
  inv1   g39(.a(x04), .O(new_n105_));
  nor2   g40(.a(new_n64_), .b(new_n105_), .O(new_n106_));
  oai21  g41(.a(new_n106_), .b(new_n67_), .c(new_n104_), .O(new_n107_));
  inv1   g42(.a(x08), .O(new_n108_));
  nand4  g43(.a(x35), .b(new_n66_), .c(x27), .d(new_n105_), .O(new_n109_));
  nand2  g44(.a(new_n109_), .b(new_n108_), .O(new_n110_));
  nor2   g45(.a(x30), .b(x09), .O(new_n111_));
  inv1   g46(.a(new_n111_), .O(new_n112_));
  aoi21  g47(.a(new_n110_), .b(new_n107_), .c(new_n112_), .O(z11));
  nor2   g48(.a(x36), .b(x35), .O(new_n114_));
  aoi21  g49(.a(new_n114_), .b(new_n81_), .c(new_n64_), .O(new_n115_));
  aoi21  g50(.a(x35), .b(x28), .c(x37), .O(new_n116_));
  nor2   g51(.a(new_n116_), .b(new_n64_), .O(new_n117_));
  nor2   g52(.a(new_n76_), .b(x04), .O(new_n118_));
  oai22  g53(.a(new_n118_), .b(new_n117_), .c(new_n115_), .d(x10), .O(z12));
  nor2   g54(.a(x19), .b(x18), .O(new_n121_));
  nand2  g55(.a(new_n121_), .b(x20), .O(new_n122_));
  nand2  g56(.a(x36), .b(x35), .O(new_n123_));
  nand4  g57(.a(new_n123_), .b(new_n70_), .c(new_n69_), .d(x28), .O(new_n124_));
  nor2   g58(.a(x13), .b(x04), .O(new_n125_));
  nand3  g59(.a(new_n125_), .b(new_n124_), .c(z08), .O(new_n126_));
  nand2  g60(.a(new_n126_), .b(new_n122_), .O(new_n127_));
  nand3  g61(.a(new_n81_), .b(new_n79_), .c(x28), .O(new_n128_));
  nand2  g62(.a(new_n128_), .b(x27), .O(new_n129_));
  nand3  g63(.a(new_n129_), .b(new_n70_), .c(new_n69_), .O(new_n130_));
  nand2  g64(.a(new_n125_), .b(z08), .O(new_n131_));
  oai21  g65(.a(new_n116_), .b(new_n64_), .c(new_n131_), .O(new_n132_));
  nand3  g66(.a(new_n132_), .b(new_n130_), .c(new_n127_), .O(z14));
  nand4  g67(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n134_));
  inv1   g68(.a(new_n134_), .O(z15));
  nand2  g69(.a(x22), .b(x01), .O(new_n136_));
  nor2   g70(.a(new_n136_), .b(x23), .O(z16));
  inv1   g71(.a(x24), .O(new_n138_));
  nand4  g72(.a(new_n138_), .b(x23), .c(x22), .d(x01), .O(new_n139_));
  inv1   g73(.a(new_n139_), .O(z17));
  oai21  g74(.a(new_n67_), .b(x27), .c(new_n104_), .O(new_n141_));
  nand2  g75(.a(new_n141_), .b(x08), .O(new_n142_));
  nand3  g76(.a(new_n142_), .b(new_n111_), .c(new_n109_), .O(z18));
  oai21  g77(.a(new_n79_), .b(new_n64_), .c(new_n108_), .O(new_n144_));
  oai21  g78(.a(new_n66_), .b(x27), .c(x35), .O(new_n145_));
  nand2  g79(.a(new_n145_), .b(new_n104_), .O(new_n146_));
  aoi21  g80(.a(new_n146_), .b(new_n144_), .c(new_n112_), .O(z20));
  zero   g81(.O(z00));
  zero   g82(.O(z05));
  zero   g83(.O(z10));
  zero   g84(.O(z13));
  aoi21  g85(.a(new_n110_), .b(new_n107_), .c(new_n112_), .O(z19));
endmodule
