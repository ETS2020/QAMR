// Benchmark "FAU" written by ABC on Thu Jul  9 23:02:11 2020
...
module FAU ( 
  ...
  nand3  g27(.a(x40), .b(x39), .c(x29), .O(new_n93_));
  ...
  aoi21  g39(.a(x35), .b(x28), .c(x37), .O(new_n105_));
  nor2   g40(.a(new_n105_), .b(new_n64_), .O(new_n106_));
  nor2   g41(.a(new_n76_), .b(x04), .O(new_n107_));
  oai22  g42(.a(new_n107_), .b(new_n106_), .c(new_n104_), .d(x10), .O(z12));
  nor2   g43(.a(x19), .b(x18), .O(new_n110_));
  nand2  g44(.a(new_n110_), .b(x20), .O(new_n111_));
  nand2  g45(.a(x36), .b(x35), .O(new_n112_));
  nand4  g46(.a(new_n112_), .b(new_n70_), .c(new_n69_), .d(x28), .O(new_n113_));
  nor2   g47(.a(x13), .b(x04), .O(new_n114_));
  nand3  g48(.a(new_n114_), .b(new_n113_), .c(z08), .O(new_n115_));
  nand2  g49(.a(new_n115_), .b(new_n111_), .O(new_n116_));
  nand3  g50(.a(new_n81_), .b(new_n79_), .c(x28), .O(new_n117_));
  nand2  g51(.a(new_n117_), .b(x27), .O(new_n118_));
  nand3  g52(.a(new_n118_), .b(new_n70_), .c(new_n69_), .O(new_n119_));
  nand2  g53(.a(new_n114_), .b(z08), .O(new_n120_));
  oai21  g54(.a(new_n105_), .b(new_n64_), .c(new_n120_), .O(new_n121_));
  nand3  g55(.a(new_n121_), .b(new_n119_), .c(new_n116_), .O(z14));
  ...
  oai21  g63(.a(new_n67_), .b(x27), .c(new_n93_), .O(new_n130_));
  nand2  g64(.a(new_n130_), .b(x08), .O(new_n131_));
  nand3  g65(.a(new_n131_), .b(new_n100_), .c(new_n98_), .O(z18));
  oai21  g66(.a(new_n79_), .b(new_n64_), .c(new_n97_), .O(new_n133_));
  oai21  g67(.a(new_n66_), .b(x27), .c(x35), .O(new_n134_));
  nand2  g68(.a(new_n134_), .b(new_n93_), .O(new_n135_));
  aoi21  g69(.a(new_n135_), .b(new_n133_), .c(new_n101_), .O(z20));
  zero   g70(.O(z00));
  zero   g71(.O(z07));
  zero   g72(.O(z10));
  zero   g73(.O(z13));
  aoi21  g74(.a(new_n99_), .b(new_n96_), .c(new_n101_), .O(z19));
endmodule
