...
module FAU ( 
  ...
  nand2  g46(.a(z08), .b(x29), .O(new_n111_));
  nor2   g47(.a(new_n72_), .b(new_n64_), .O(new_n112_));
  oai21  g48(.a(new_n112_), .b(new_n76_), .c(new_n111_), .O(new_n113_));
  inv1   g49(.a(x08), .O(new_n114_));
  nand3  g50(.a(new_n75_), .b(x27), .c(new_n64_), .O(new_n115_));
  nand2  g51(.a(new_n115_), .b(new_n114_), .O(new_n116_));
  inv1   g52(.a(x09), .O(new_n117_));
  inv1   g53(.a(x30), .O(new_n118_));
  nand2  g54(.a(new_n118_), .b(new_n117_), .O(new_n119_));
  aoi21  g55(.a(new_n116_), .b(new_n113_), .c(new_n119_), .O(z11));
  aoi21  g56(.a(new_n63_), .b(new_n89_), .c(new_n72_), .O(new_n121_));
  nor2   g57(.a(new_n66_), .b(new_n72_), .O(new_n122_));
  nor2   g58(.a(new_n83_), .b(x04), .O(new_n123_));
  oai22  g59(.a(new_n123_), .b(new_n122_), .c(new_n121_), .d(x10), .O(z12));
  nor2   g60(.a(x19), .b(x18), .O(new_n126_));
  nand2  g61(.a(new_n126_), .b(x20), .O(new_n127_));
  inv1   g62(.a(x32), .O(new_n128_));
  nand2  g63(.a(x36), .b(x35), .O(new_n129_));
  nand4  g64(.a(new_n129_), .b(new_n128_), .c(new_n118_), .d(x28), .O(new_n130_));
  inv1   g65(.a(new_n130_), .O(new_n131_));
  nor2   g66(.a(x13), .b(x04), .O(new_n132_));
  nand2  g67(.a(new_n132_), .b(z08), .O(new_n133_));
  oai21  g68(.a(new_n133_), .b(new_n131_), .c(new_n127_), .O(new_n134_));
  nand3  g69(.a(new_n89_), .b(new_n74_), .c(x28), .O(new_n135_));
  nand2  g70(.a(new_n135_), .b(x27), .O(new_n136_));
  nand2  g71(.a(new_n136_), .b(new_n78_), .O(new_n137_));
  oai21  g72(.a(new_n66_), .b(new_n72_), .c(new_n133_), .O(new_n138_));
  nand3  g73(.a(new_n138_), .b(new_n137_), .c(new_n134_), .O(z14));
  ...
  nand2  g79(.a(new_n75_), .b(new_n72_), .O(new_n146_));
  nand2  g80(.a(new_n146_), .b(new_n111_), .O(new_n147_));
  nand2  g81(.a(new_n147_), .b(x08), .O(new_n148_));
  nand4  g82(.a(new_n148_), .b(new_n115_), .c(new_n118_), .d(new_n117_), .O(z18));
  oai21  g83(.a(new_n74_), .b(new_n72_), .c(new_n114_), .O(new_n150_));
  oai21  g84(.a(new_n87_), .b(x27), .c(x35), .O(new_n151_));
  nand2  g85(.a(new_n151_), .b(new_n111_), .O(new_n152_));
  aoi21  g86(.a(new_n152_), .b(new_n150_), .c(new_n119_), .O(z20));
  zero   g87(.O(z09));
  zero   g88(.O(z10));
  zero   g89(.O(z13));
  zero   g90(.O(z15));
