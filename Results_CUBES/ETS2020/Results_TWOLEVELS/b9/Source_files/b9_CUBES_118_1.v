...
module FAU ( 
  ...
  oai21  g83(.a(new_n81_), .b(new_n83_), .c(new_n119_), .O(new_n151_));
  oai21  g84(.a(new_n74_), .b(x27), .c(x35), .O(new_n152_));
  nand2  g85(.a(new_n152_), .b(new_n116_), .O(new_n153_));
  aoi21  g86(.a(new_n153_), .b(new_n151_), .c(new_n123_), .O(z20));
  zero   g87(.O(z01));
  zero   g88(.O(z08));
  zero   g89(.O(z12));
  zero   g90(.O(z14));
