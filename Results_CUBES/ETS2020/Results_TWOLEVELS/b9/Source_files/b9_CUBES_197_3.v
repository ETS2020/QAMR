// Benchmark "FAU" written by ABC on Thu Jul  9 23:01:36 2020
...
module FAU ( 
  ...
  nand4  g78(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n143_));
  inv1   g79(.a(new_n143_), .O(z15));
  nand2  g80(.a(x22), .b(x01), .O(new_n145_));
  nor2   g81(.a(new_n145_), .b(x23), .O(z16));
  inv1   g82(.a(x24), .O(new_n147_));
  nand4  g83(.a(new_n147_), .b(x23), .c(x22), .d(x01), .O(new_n148_));
  inv1   g84(.a(new_n148_), .O(z17));
  oai21  g85(.a(new_n75_), .b(x27), .c(new_n102_), .O(new_n150_));
  nand2  g86(.a(new_n150_), .b(x08), .O(new_n151_));
  nand3  g87(.a(new_n151_), .b(new_n109_), .c(new_n107_), .O(z18));
  oai21  g88(.a(new_n81_), .b(new_n72_), .c(new_n105_), .O(new_n153_));
  oai21  g89(.a(new_n74_), .b(x27), .c(x35), .O(new_n154_));
  nand2  g90(.a(new_n154_), .b(new_n102_), .O(new_n155_));
  aoi21  g91(.a(new_n155_), .b(new_n153_), .c(new_n110_), .O(z20));
  zero   g92(.O(z02));
  zero   g93(.O(z07));
  aoi21  g94(.a(new_n108_), .b(new_n104_), .c(new_n110_), .O(z19));
endmodule
