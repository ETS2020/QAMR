...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n141_, new_n142_, new_n143_, new_n144_, new_n146_, new_n149_,
  ...
  inv1   g81(.a(x24), .O(new_n149_));
  nand4  g82(.a(new_n149_), .b(x23), .c(x22), .d(x01), .O(new_n150_));
  inv1   g83(.a(new_n150_), .O(z17));
  inv1   g84(.a(x29), .O(new_n152_));
  oai22  g85(.a(new_n75_), .b(x27), .c(new_n82_), .d(new_n152_), .O(new_n153_));
  nand2  g86(.a(new_n153_), .b(x08), .O(new_n154_));
  nand4  g87(.a(x35), .b(new_n74_), .c(x27), .d(new_n64_), .O(new_n155_));
  nor2   g88(.a(x30), .b(x09), .O(new_n156_));
  nand3  g89(.a(new_n156_), .b(new_n155_), .c(new_n154_), .O(z18));
  zero   g90(.O(z03));
  zero   g91(.O(z04));
  zero   g92(.O(z06));
  zero   g93(.O(z11));
