...
module FAU ( 
  ...
  aoi21  g59(.a(x36), .b(x35), .c(new_n74_), .O(new_n126_));
  inv1   g60(.a(x13), .O(new_n127_));
  nand4  g61(.a(x40), .b(x39), .c(new_n127_), .d(new_n64_), .O(new_n128_));
  nor2   g62(.a(x19), .b(x18), .O(new_n129_));
  nand2  g63(.a(new_n129_), .b(x20), .O(new_n130_));
  oai22  g64(.a(new_n130_), .b(new_n66_), .c(new_n128_), .d(new_n126_), .O(new_n131_));
  nand2  g65(.a(new_n131_), .b(x27), .O(new_n132_));
  nor2   g66(.a(new_n111_), .b(new_n77_), .O(new_n133_));
  nand3  g67(.a(new_n133_), .b(new_n127_), .c(new_n64_), .O(new_n134_));
  ...
  oai21  g76(.a(new_n75_), .b(x27), .c(new_n116_), .O(new_n144_));
  nand2  g77(.a(new_n144_), .b(x08), .O(new_n145_));
  nand3  g78(.a(new_n145_), .b(new_n122_), .c(new_n120_), .O(z18));
  zero   g79(.O(z01));
  zero   g80(.O(z05));
  zero   g81(.O(z08));
  zero   g82(.O(z12));
  zero   g83(.O(z14));
  zero   g84(.O(z20));
  aoi21  g85(.a(new_n121_), .b(new_n118_), .c(new_n123_), .O(z19));
endmodule
