...
module FAU ( 
  ...
  oai21  g61(.a(new_n67_), .b(x27), .c(new_n93_), .O(new_n129_));
  nand2  g62(.a(new_n129_), .b(x08), .O(new_n130_));
  nand3  g63(.a(new_n130_), .b(new_n100_), .c(new_n98_), .O(z18));
  oai21  g64(.a(new_n79_), .b(new_n64_), .c(new_n97_), .O(new_n132_));
  oai21  g65(.a(new_n66_), .b(x27), .c(x35), .O(new_n133_));
  nand2  g66(.a(new_n133_), .b(new_n93_), .O(new_n134_));
  aoi21  g67(.a(new_n134_), .b(new_n132_), .c(new_n101_), .O(z20));
  zero   g68(.O(z00));
  zero   g69(.O(z07));
  zero   g70(.O(z10));
  zero   g71(.O(z13));
