...
module FAU ( 
  ...
  aoi21  g54(.a(new_n118_), .b(new_n76_), .c(new_n75_), .O(new_n119_));
  nand2  g55(.a(new_n73_), .b(new_n76_), .O(new_n120_));
  nand2  g56(.a(new_n120_), .b(x27), .O(new_n121_));
  oai21  g57(.a(new_n70_), .b(x04), .c(new_n121_), .O(new_n122_));
  oai21  g58(.a(new_n119_), .b(x10), .c(new_n122_), .O(z12));
  inv1   g59(.a(x35), .O(new_n124_));
  oai21  g60(.a(new_n101_), .b(new_n124_), .c(x28), .O(new_n125_));
  nor2   g61(.a(x13), .b(x04), .O(new_n126_));
  nand3  g62(.a(new_n126_), .b(new_n125_), .c(z08), .O(new_n127_));
  nor2   g63(.a(x19), .b(x18), .O(new_n128_));
  nand3  g64(.a(new_n128_), .b(new_n120_), .c(x20), .O(new_n129_));
  nand2  g65(.a(new_n129_), .b(new_n127_), .O(new_n130_));
  nand2  g66(.a(new_n130_), .b(x27), .O(new_n131_));
  nor2   g67(.a(new_n103_), .b(new_n70_), .O(new_n132_));
  nand2  g68(.a(new_n126_), .b(new_n132_), .O(new_n133_));
  nand2  g69(.a(new_n133_), .b(new_n131_), .O(z13));
  ...
  oai21  g75(.a(new_n67_), .b(x27), .c(new_n108_), .O(new_n142_));
  nand2  g76(.a(new_n142_), .b(x08), .O(new_n143_));
  nand3  g77(.a(new_n143_), .b(new_n115_), .c(new_n113_), .O(z18));
  oai21  g78(.a(new_n124_), .b(new_n75_), .c(new_n112_), .O(new_n145_));
  oai21  g79(.a(new_n66_), .b(x27), .c(x35), .O(new_n146_));
  nand2  g80(.a(new_n146_), .b(new_n108_), .O(new_n147_));
  aoi21  g81(.a(new_n147_), .b(new_n145_), .c(new_n116_), .O(z20));
  zero   g82(.O(z00));
  zero   g83(.O(z01));
  zero   g84(.O(z14));
  zero   g85(.O(z15));
  aoi21  g86(.a(new_n114_), .b(new_n111_), .c(new_n116_), .O(z19));
endmodule
