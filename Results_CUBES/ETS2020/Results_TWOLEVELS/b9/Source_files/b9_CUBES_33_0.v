...
module FAU ( 
  ...
  nand2  g83(.a(new_n148_), .b(new_n103_), .O(new_n149_));
  nand2  g84(.a(new_n149_), .b(x08), .O(new_n150_));
  nand3  g85(.a(new_n150_), .b(new_n110_), .c(new_n108_), .O(z18));
  oai21  g86(.a(new_n135_), .b(new_n64_), .c(new_n107_), .O(new_n152_));
  oai21  g87(.a(new_n66_), .b(x27), .c(x35), .O(new_n153_));
  nand2  g88(.a(new_n153_), .b(new_n103_), .O(new_n154_));
  aoi21  g89(.a(new_n154_), .b(new_n152_), .c(new_n111_), .O(z20));
  zero   g90(.O(z00));
  zero   g91(.O(z09));
  zero   g92(.O(z10));
