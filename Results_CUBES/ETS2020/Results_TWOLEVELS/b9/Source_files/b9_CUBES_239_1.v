// Benchmark "FAU" written by ABC on Thu Jul  9 23:04:40 2020
...
module FAU ( 
  ...
  nand4  g70(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n137_));
  inv1   g71(.a(new_n137_), .O(z15));
  nand2  g72(.a(x22), .b(x01), .O(new_n139_));
  nor2   g73(.a(new_n139_), .b(x23), .O(z16));
  inv1   g74(.a(x24), .O(new_n141_));
  nand4  g75(.a(new_n141_), .b(x23), .c(x22), .d(x01), .O(new_n142_));
  inv1   g76(.a(new_n142_), .O(z17));
  oai21  g77(.a(new_n105_), .b(x27), .c(new_n112_), .O(new_n144_));
  nand2  g78(.a(new_n144_), .b(x08), .O(new_n145_));
  nand3  g79(.a(new_n145_), .b(new_n119_), .c(new_n117_), .O(z18));
  oai21  g80(.a(new_n75_), .b(new_n77_), .c(new_n115_), .O(new_n147_));
  oai21  g81(.a(new_n74_), .b(x27), .c(x35), .O(new_n148_));
  nand2  g82(.a(new_n148_), .b(new_n112_), .O(new_n149_));
  aoi21  g83(.a(new_n149_), .b(new_n147_), .c(new_n120_), .O(z20));
  zero   g84(.O(z01));
  zero   g85(.O(z02));
  zero   g86(.O(z12));
  zero   g87(.O(z14));
  aoi21  g88(.a(new_n118_), .b(new_n114_), .c(new_n120_), .O(z19));
endmodule
