...
module FAU ( 
  ...
  nand3  g20(.a(new_n61_), .b(x10), .c(x08), .O(new_n64_));
  nand3  g21(.a(new_n64_), .b(x16), .c(new_n43_), .O(new_n65_));
  nand4  g22(.a(new_n61_), .b(x10), .c(x08), .d(x03), .O(new_n66_));
  aoi21  g23(.a(new_n66_), .b(new_n65_), .c(new_n54_), .O(z15));
  nand2  g24(.a(new_n64_), .b(x17), .O(new_n68_));
  nand4  g25(.a(new_n61_), .b(x10), .c(x08), .d(x04), .O(new_n69_));
  aoi21  g26(.a(new_n69_), .b(new_n68_), .c(new_n54_), .O(z16));
  nand2  g27(.a(new_n64_), .b(x18), .O(new_n71_));
  nand4  g28(.a(new_n61_), .b(x10), .c(x08), .d(x05), .O(new_n72_));
  aoi21  g29(.a(new_n72_), .b(new_n71_), .c(new_n54_), .O(z17));
  nand2  g30(.a(new_n64_), .b(x19), .O(new_n74_));
  nand4  g31(.a(new_n61_), .b(x10), .c(x08), .d(x06), .O(new_n75_));
  aoi21  g32(.a(new_n75_), .b(new_n74_), .c(new_n54_), .O(z18));
  nand2  g33(.a(new_n64_), .b(x20), .O(new_n77_));
  nand4  g34(.a(new_n61_), .b(x10), .c(x08), .d(x07), .O(new_n78_));
  aoi21  g35(.a(new_n78_), .b(new_n77_), .c(new_n54_), .O(z19));
  zero   g36(.O(z02));
  zero   g37(.O(z12));
  buf    g38(.a(x19), .O(z05));
  buf    g39(.a(x15), .O(z06));
