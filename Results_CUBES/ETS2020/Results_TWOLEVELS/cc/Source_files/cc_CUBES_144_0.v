...
module FAU ( 
  ...
  nand2  g25(.a(new_n47_), .b(x19), .O(new_n73_));
  nand4  g26(.a(new_n46_), .b(x10), .c(x08), .d(x06), .O(new_n74_));
  aoi21  g27(.a(new_n74_), .b(new_n73_), .c(new_n58_), .O(z18));
  nand2  g28(.a(new_n47_), .b(x20), .O(new_n76_));
  nand4  g29(.a(new_n46_), .b(x10), .c(x08), .d(x07), .O(new_n77_));
  aoi21  g30(.a(new_n77_), .b(new_n76_), .c(new_n58_), .O(z19));
  zero   g31(.O(z09));
  zero   g32(.O(z10));
  zero   g33(.O(z11));
  zero   g34(.O(z15));
