...
module FAU ( 
  ...
  wire new_n43_, new_n44_, new_n47_, new_n48_, new_n55_, new_n56_, new_n57_,
    ...
    new_n68_, new_n71_, new_n72_, new_n75_, new_n76_;
  ...
  nand2  g24(.a(new_n57_), .b(x18), .O(new_n71_));
  nand4  g25(.a(new_n56_), .b(x10), .c(x08), .d(x05), .O(new_n72_));
  aoi21  g26(.a(new_n72_), .b(new_n71_), .c(new_n55_), .O(z17));
  nand2  g27(.a(new_n57_), .b(x20), .O(new_n75_));
  nand4  g28(.a(new_n56_), .b(x10), .c(x08), .d(x07), .O(new_n76_));
  aoi21  g29(.a(new_n76_), .b(new_n75_), .c(new_n55_), .O(z19));
  zero   g30(.O(z02));
  zero   g31(.O(z05));
  zero   g32(.O(z11));
  zero   g33(.O(z14));
