...
module FAU ( 
  ...
  nand2  g12(.a(new_n50_), .b(new_n44_), .O(new_n59_));
  nand2  g13(.a(new_n59_), .b(x15), .O(new_n60_));
  inv1   g14(.a(x01), .O(new_n61_));
  oai21  g15(.a(new_n50_), .b(new_n61_), .c(x14), .O(new_n62_));
  aoi21  g16(.a(new_n62_), .b(new_n60_), .c(new_n58_), .O(z13));
  nand2  g17(.a(new_n50_), .b(x15), .O(new_n64_));
  nand4  g18(.a(new_n45_), .b(x10), .c(x08), .d(x02), .O(new_n65_));
  aoi21  g19(.a(new_n65_), .b(new_n64_), .c(new_n58_), .O(z14));
  nand2  g20(.a(new_n46_), .b(x17), .O(new_n68_));
  nand4  g21(.a(new_n45_), .b(x10), .c(x08), .d(x04), .O(new_n69_));
  aoi21  g22(.a(new_n69_), .b(new_n68_), .c(new_n58_), .O(z16));
  ...
  aoi21  g28(.a(new_n76_), .b(new_n75_), .c(new_n58_), .O(z19));
  zero   g29(.O(z01));
  zero   g30(.O(z09));
  zero   g31(.O(z10));
  zero   g32(.O(z11));
