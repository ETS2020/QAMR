// Benchmark "FAU" written by ABC on Mon Jul  6 17:27:44 2020
...
module FAU ( 
  ...
  aoi21  g27(.a(new_n73_), .b(new_n72_), .c(new_n59_), .O(z16));
  nand2  g28(.a(new_n47_), .b(x19), .O(new_n76_));
  nand4  g29(.a(new_n46_), .b(x10), .c(x08), .d(x06), .O(new_n77_));
  aoi21  g30(.a(new_n77_), .b(new_n76_), .c(new_n59_), .O(z18));
  nand2  g31(.a(new_n47_), .b(x20), .O(new_n79_));
  nand4  g32(.a(new_n46_), .b(x10), .c(x08), .d(x07), .O(new_n80_));
  aoi21  g33(.a(new_n80_), .b(new_n79_), .c(new_n59_), .O(z19));
  zero   g34(.O(z04));
  zero   g35(.O(z08));
  zero   g36(.O(z10));
  zero   g37(.O(z11));
