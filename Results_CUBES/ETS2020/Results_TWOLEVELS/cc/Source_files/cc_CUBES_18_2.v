...
module FAU ( 
  ...
  nand4  g12(.a(new_n46_), .b(x10), .c(x08), .d(x00), .O(new_n59_));
  aoi21  g13(.a(new_n59_), .b(new_n58_), .c(new_n57_), .O(z12));
  nand3  g14(.a(new_n47_), .b(x16), .c(new_n43_), .O(new_n63_));
  nand4  g15(.a(new_n46_), .b(x10), .c(x08), .d(x03), .O(new_n64_));
  aoi21  g16(.a(new_n64_), .b(new_n63_), .c(new_n57_), .O(z15));
  nand2  g17(.a(new_n47_), .b(x18), .O(new_n67_));
  nand4  g18(.a(new_n46_), .b(x10), .c(x08), .d(x05), .O(new_n68_));
  aoi21  g19(.a(new_n68_), .b(new_n67_), .c(new_n57_), .O(z17));
  nand2  g20(.a(new_n47_), .b(x19), .O(new_n70_));
  nand4  g21(.a(new_n46_), .b(x10), .c(x08), .d(x06), .O(new_n71_));
  aoi21  g22(.a(new_n71_), .b(new_n70_), .c(new_n57_), .O(z18));
  zero   g23(.O(z00));
  zero   g24(.O(z03));
  zero   g25(.O(z04));
  zero   g26(.O(z06));
