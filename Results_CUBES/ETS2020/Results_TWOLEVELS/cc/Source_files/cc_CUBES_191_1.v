...
module FAU ( 
  ...
  nand2  g25(.a(new_n47_), .b(x17), .O(new_n70_));
  nand4  g26(.a(new_n46_), .b(x10), .c(x08), .d(x04), .O(new_n71_));
  aoi21  g27(.a(new_n71_), .b(new_n70_), .c(new_n57_), .O(z16));
  nand2  g28(.a(new_n47_), .b(x18), .O(new_n73_));
  nand4  g29(.a(new_n46_), .b(x10), .c(x08), .d(x05), .O(new_n74_));
  aoi21  g30(.a(new_n74_), .b(new_n73_), .c(new_n57_), .O(z17));
  nand2  g31(.a(new_n47_), .b(x19), .O(new_n76_));
  nand4  g32(.a(new_n46_), .b(x10), .c(x08), .d(x06), .O(new_n77_));
  aoi21  g33(.a(new_n77_), .b(new_n76_), .c(new_n57_), .O(z18));
  nand2  g34(.a(new_n47_), .b(x20), .O(new_n79_));
  nand4  g35(.a(new_n46_), .b(x10), .c(x08), .d(x07), .O(new_n80_));
