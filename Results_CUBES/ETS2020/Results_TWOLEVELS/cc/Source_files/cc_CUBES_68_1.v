...
module FAU ( 
  ...
  nand3  g18(.a(new_n60_), .b(x10), .c(x08), .O(new_n63_));
  nand3  g19(.a(new_n63_), .b(x16), .c(new_n46_), .O(new_n64_));
  nand4  g20(.a(new_n60_), .b(x10), .c(x08), .d(x03), .O(new_n65_));
  aoi21  g21(.a(new_n65_), .b(new_n64_), .c(new_n53_), .O(z15));
  nand2  g22(.a(new_n63_), .b(x19), .O(new_n69_));
  nand4  g23(.a(new_n60_), .b(x10), .c(x08), .d(x06), .O(new_n70_));
  aoi21  g24(.a(new_n70_), .b(new_n69_), .c(new_n53_), .O(z18));
  nand2  g25(.a(new_n63_), .b(x20), .O(new_n72_));
