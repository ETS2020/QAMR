...
module FAU ( 
  ...
  nand2  g17(.a(new_n60_), .b(x17), .O(new_n64_));
  nand4  g18(.a(new_n57_), .b(x10), .c(x08), .d(x04), .O(new_n65_));
  aoi21  g19(.a(new_n65_), .b(new_n64_), .c(new_n54_), .O(z16));
  nand2  g20(.a(new_n60_), .b(x18), .O(new_n67_));
  nand4  g21(.a(new_n57_), .b(x10), .c(x08), .d(x05), .O(new_n68_));
  aoi21  g22(.a(new_n68_), .b(new_n67_), .c(new_n54_), .O(z17));
  nand2  g23(.a(new_n60_), .b(x19), .O(new_n70_));
  nand4  g24(.a(new_n57_), .b(x10), .c(x08), .d(x06), .O(new_n71_));
