// Benchmark "FAU" written by ABC on Mon Jul  6 17:27:47 2020
...
module FAU ( 
  ...
  nand2  g24(.a(new_n56_), .b(x19), .O(new_n75_));
  nand4  g25(.a(new_n55_), .b(x10), .c(x08), .d(x06), .O(new_n76_));
  aoi21  g26(.a(new_n76_), .b(new_n75_), .c(new_n54_), .O(z18));
  nand2  g27(.a(new_n56_), .b(x20), .O(new_n78_));
  nand4  g28(.a(new_n55_), .b(x10), .c(x08), .d(x07), .O(new_n79_));
  aoi21  g29(.a(new_n79_), .b(new_n78_), .c(new_n54_), .O(z19));
  zero   g30(.O(z00));
  zero   g31(.O(z01));
  zero   g32(.O(z02));
  zero   g33(.O(z04));
