...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n50_, new_n51_,
    ...
    new_n67_, new_n68_, new_n71_, new_n72_, new_n76_, new_n77_;
  ...
  nand2  g20(.a(new_n50_), .b(x15), .O(new_n67_));
  nand4  g21(.a(new_n45_), .b(x10), .c(x08), .d(x02), .O(new_n68_));
  aoi21  g22(.a(new_n68_), .b(new_n67_), .c(new_n58_), .O(z14));
  nand2  g23(.a(new_n46_), .b(x17), .O(new_n71_));
  nand4  g24(.a(new_n45_), .b(x10), .c(x08), .d(x04), .O(new_n72_));
