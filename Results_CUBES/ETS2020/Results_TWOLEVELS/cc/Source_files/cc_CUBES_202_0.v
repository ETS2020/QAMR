...
module FAU ( 
  ...
  wire new_n43_, new_n44_, new_n47_, new_n48_, new_n55_, new_n56_, new_n57_,
    ...
    new_n67_, new_n72_, new_n73_, new_n75_, new_n76_;
  ...
  nand2  g21(.a(new_n57_), .b(x19), .O(new_n72_));
  nand4  g22(.a(new_n56_), .b(x10), .c(x08), .d(x06), .O(new_n73_));
  aoi21  g23(.a(new_n73_), .b(new_n72_), .c(new_n55_), .O(z18));
