...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n50_, new_n51_,
    ...
    new_n67_, new_n68_, new_n70_, new_n71_, new_n73_, new_n74_, new_n78_,
    new_n79_;
  ...
  nand3  g22(.a(new_n46_), .b(x16), .c(new_n44_), .O(new_n70_));
  nand4  g23(.a(new_n45_), .b(x10), .c(x08), .d(x03), .O(new_n71_));
  aoi21  g24(.a(new_n71_), .b(new_n70_), .c(new_n58_), .O(z15));
  nand2  g25(.a(new_n46_), .b(x17), .O(new_n73_));
  nand4  g26(.a(new_n45_), .b(x10), .c(x08), .d(x04), .O(new_n74_));
  aoi21  g27(.a(new_n74_), .b(new_n73_), .c(new_n58_), .O(z16));
