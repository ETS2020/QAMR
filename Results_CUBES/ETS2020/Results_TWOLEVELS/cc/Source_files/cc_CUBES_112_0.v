...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n50_, new_n51_,
    ...
    new_n67_, new_n68_, new_n72_, new_n73_, new_n75_, new_n76_, new_n78_,
    new_n79_;
  ...
  nand2  g22(.a(new_n46_), .b(x18), .O(new_n72_));
  nand4  g23(.a(new_n45_), .b(x10), .c(x08), .d(x05), .O(new_n73_));
  aoi21  g24(.a(new_n73_), .b(new_n72_), .c(new_n58_), .O(z17));
