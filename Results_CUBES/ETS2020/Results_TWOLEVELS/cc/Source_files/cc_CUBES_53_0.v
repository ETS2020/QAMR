// Benchmark "FAU" written by ABC on Mon Jul  6 17:27:26 2020
...
module FAU ( 
  ...
  nand2  g21(.a(new_n55_), .b(x19), .O(new_n72_));
  nand4  g22(.a(new_n54_), .b(x10), .c(x08), .d(x06), .O(new_n73_));
  aoi21  g23(.a(new_n73_), .b(new_n72_), .c(new_n53_), .O(z18));
  nand2  g24(.a(new_n55_), .b(x20), .O(new_n75_));
  nand4  g25(.a(new_n54_), .b(x10), .c(x08), .d(x07), .O(new_n76_));
  aoi21  g26(.a(new_n76_), .b(new_n75_), .c(new_n53_), .O(z19));
  zero   g27(.O(z00));
  zero   g28(.O(z01));
  zero   g29(.O(z02));
  zero   g30(.O(z04));
