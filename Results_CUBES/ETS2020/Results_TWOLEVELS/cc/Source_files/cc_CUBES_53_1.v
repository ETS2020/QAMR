...
module FAU ( 
  ...
  wire new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_, new_n51_,
    ...
    new_n64_, new_n67_, new_n68_, new_n71_, new_n72_, new_n75_, new_n76_;
  ...
  nand2  g27(.a(new_n47_), .b(x18), .O(new_n71_));
  nand4  g28(.a(new_n46_), .b(x10), .c(x08), .d(x05), .O(new_n72_));
  aoi21  g29(.a(new_n72_), .b(new_n71_), .c(new_n57_), .O(z17));
  nand2  g30(.a(new_n47_), .b(x20), .O(new_n75_));
  nand4  g31(.a(new_n46_), .b(x10), .c(x08), .d(x07), .O(new_n76_));
  aoi21  g32(.a(new_n76_), .b(new_n75_), .c(new_n57_), .O(z19));
  zero   g33(.O(z14));
  zero   g34(.O(z16));
  zero   g35(.O(z18));
  buf    g36(.a(x19), .O(z05));
