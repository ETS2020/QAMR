...
module FAU ( 
  ...
  wire new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_, new_n51_,
    ...
    new_n66_, new_n70_, new_n71_, new_n73_, new_n74_, new_n77_, new_n78_;
  ...
  nand2  g24(.a(new_n47_), .b(x18), .O(new_n73_));
  nand4  g25(.a(new_n46_), .b(x10), .c(x08), .d(x05), .O(new_n74_));
  aoi21  g26(.a(new_n74_), .b(new_n73_), .c(new_n59_), .O(z17));
