// Benchmark "FAU" written by ABC on Mon Jul  6 17:27:33 2020
...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n55_, new_n56_,
    new_n57_, new_n60_, new_n61_, new_n62_, new_n64_, new_n65_, new_n68_,
  ...
  nand2  g21(.a(new_n46_), .b(x18), .O(new_n68_));
  nand4  g22(.a(new_n45_), .b(x10), .c(x08), .d(x05), .O(new_n69_));
  aoi21  g23(.a(new_n69_), .b(new_n68_), .c(new_n55_), .O(z17));
  nand2  g24(.a(new_n46_), .b(x19), .O(new_n71_));
  nand4  g25(.a(new_n45_), .b(x10), .c(x08), .d(x06), .O(new_n72_));
  aoi21  g26(.a(new_n72_), .b(new_n71_), .c(new_n55_), .O(z18));
  nand2  g27(.a(new_n46_), .b(x20), .O(new_n74_));
  nand4  g28(.a(new_n45_), .b(x10), .c(x08), .d(x07), .O(new_n75_));
  aoi21  g29(.a(new_n75_), .b(new_n74_), .c(new_n55_), .O(z19));
  zero   g30(.O(z01));
  zero   g31(.O(z03));
  zero   g32(.O(z06));
  zero   g33(.O(z13));
