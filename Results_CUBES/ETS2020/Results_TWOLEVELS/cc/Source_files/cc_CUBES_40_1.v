// Benchmark "FAU" written by ABC on Mon Jul  6 17:27:20 2020
...
module FAU ( 
  ...
  nand2  g23(.a(new_n64_), .b(x17), .O(new_n68_));
  nand4  g24(.a(new_n61_), .b(x10), .c(x08), .d(x04), .O(new_n69_));
  aoi21  g25(.a(new_n69_), .b(new_n68_), .c(new_n54_), .O(z16));
  nand2  g26(.a(new_n64_), .b(x18), .O(new_n71_));
  nand4  g27(.a(new_n61_), .b(x10), .c(x08), .d(x05), .O(new_n72_));
  aoi21  g28(.a(new_n72_), .b(new_n71_), .c(new_n54_), .O(z17));
  nand2  g29(.a(new_n64_), .b(x19), .O(new_n74_));
  nand4  g30(.a(new_n61_), .b(x10), .c(x08), .d(x06), .O(new_n75_));
  aoi21  g31(.a(new_n75_), .b(new_n74_), .c(new_n54_), .O(z18));
  zero   g32(.O(z00));
  zero   g33(.O(z02));
  zero   g34(.O(z12));
  zero   g35(.O(z19));
