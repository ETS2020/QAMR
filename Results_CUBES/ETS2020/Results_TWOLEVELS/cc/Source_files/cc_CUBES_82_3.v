...
module FAU ( 
  ...
  aoi21  g29(.a(new_n73_), .b(new_n72_), .c(new_n59_), .O(z16));
  nand2  g30(.a(new_n47_), .b(x18), .O(new_n75_));
  nand4  g31(.a(new_n46_), .b(x10), .c(x08), .d(x05), .O(new_n76_));
  aoi21  g32(.a(new_n76_), .b(new_n75_), .c(new_n59_), .O(z17));
  nand2  g33(.a(new_n47_), .b(x20), .O(new_n79_));
  nand4  g34(.a(new_n46_), .b(x10), .c(x08), .d(x07), .O(new_n80_));
  aoi21  g35(.a(new_n80_), .b(new_n79_), .c(new_n59_), .O(z19));
  zero   g36(.O(z06));
  zero   g37(.O(z07));
  zero   g38(.O(z14));
  zero   g39(.O(z18));
