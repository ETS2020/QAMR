...
module FAU ( 
  ...
  nand3  g22(.a(new_n46_), .b(x16), .c(new_n44_), .O(new_n69_));
  nand4  g23(.a(new_n45_), .b(x10), .c(x08), .d(x03), .O(new_n70_));
  aoi21  g24(.a(new_n70_), .b(new_n69_), .c(new_n57_), .O(z15));
  nand2  g25(.a(new_n46_), .b(x17), .O(new_n72_));
  nand4  g26(.a(new_n45_), .b(x10), .c(x08), .d(x04), .O(new_n73_));
  aoi21  g27(.a(new_n73_), .b(new_n72_), .c(new_n57_), .O(z16));
  nand2  g28(.a(new_n46_), .b(x19), .O(new_n76_));
  nand4  g29(.a(new_n45_), .b(x10), .c(x08), .d(x06), .O(new_n77_));
  aoi21  g30(.a(new_n77_), .b(new_n76_), .c(new_n57_), .O(z18));
  nand2  g31(.a(new_n46_), .b(x20), .O(new_n79_));
  nand4  g32(.a(new_n45_), .b(x10), .c(x08), .d(x07), .O(new_n80_));
  aoi21  g33(.a(new_n80_), .b(new_n79_), .c(new_n57_), .O(z19));
  zero   g34(.O(z01));
  zero   g35(.O(z04));
  zero   g36(.O(z06));
  zero   g37(.O(z09));
