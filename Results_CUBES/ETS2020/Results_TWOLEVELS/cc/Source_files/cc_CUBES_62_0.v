...
module FAU ( 
  ...
  nand2  g18(.a(new_n57_), .b(x17), .O(new_n68_));
  nand4  g19(.a(new_n56_), .b(x10), .c(x08), .d(x04), .O(new_n69_));
  aoi21  g20(.a(new_n69_), .b(new_n68_), .c(new_n55_), .O(z16));
  nand2  g21(.a(new_n57_), .b(x18), .O(new_n71_));
  nand4  g22(.a(new_n56_), .b(x10), .c(x08), .d(x05), .O(new_n72_));
  aoi21  g23(.a(new_n72_), .b(new_n71_), .c(new_n55_), .O(z17));
  nand2  g24(.a(new_n57_), .b(x20), .O(new_n75_));
  nand4  g25(.a(new_n56_), .b(x10), .c(x08), .d(x07), .O(new_n76_));
  aoi21  g26(.a(new_n76_), .b(new_n75_), .c(new_n55_), .O(z19));
  zero   g27(.O(z02));
  zero   g28(.O(z04));
  zero   g29(.O(z08));
  zero   g30(.O(z09));
