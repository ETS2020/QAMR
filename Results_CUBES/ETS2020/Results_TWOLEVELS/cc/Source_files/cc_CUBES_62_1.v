...
module FAU ( 
  ...
  wire new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_, new_n51_,
    ...
    new_n64_, new_n66_, new_n67_, new_n69_, new_n70_, new_n74_, new_n75_,
    new_n77_, new_n78_;
  ...
  nand2  g30(.a(new_n47_), .b(x19), .O(new_n74_));
  nand4  g31(.a(new_n46_), .b(x10), .c(x08), .d(x06), .O(new_n75_));
  aoi21  g32(.a(new_n75_), .b(new_n74_), .c(new_n57_), .O(z18));
  nand2  g33(.a(new_n47_), .b(x20), .O(new_n77_));
  nand4  g34(.a(new_n46_), .b(x10), .c(x08), .d(x07), .O(new_n78_));
  aoi21  g35(.a(new_n78_), .b(new_n77_), .c(new_n57_), .O(z19));
  zero   g36(.O(z16));
  zero   g37(.O(z17));
  buf    g38(.a(x19), .O(z05));
  buf    g39(.a(x15), .O(z06));
