// Benchmark "FAU" written by ABC on Mon Jul  6 17:27:51 2020
...
module FAU ( 
  ...
  nand3  g18(.a(new_n62_), .b(x10), .c(x08), .O(new_n65_));
  nand3  g19(.a(new_n65_), .b(x16), .c(new_n43_), .O(new_n66_));
  nand4  g20(.a(new_n62_), .b(x10), .c(x08), .d(x03), .O(new_n67_));
  aoi21  g21(.a(new_n67_), .b(new_n66_), .c(new_n55_), .O(z15));
  nand2  g22(.a(new_n65_), .b(x17), .O(new_n69_));
  nand4  g23(.a(new_n62_), .b(x10), .c(x08), .d(x04), .O(new_n70_));
  aoi21  g24(.a(new_n70_), .b(new_n69_), .c(new_n55_), .O(z16));
  nand2  g25(.a(new_n65_), .b(x18), .O(new_n72_));
  nand4  g26(.a(new_n62_), .b(x10), .c(x08), .d(x05), .O(new_n73_));
  aoi21  g27(.a(new_n73_), .b(new_n72_), .c(new_n55_), .O(z17));
  nand2  g28(.a(new_n65_), .b(x19), .O(new_n75_));
  nand4  g29(.a(new_n62_), .b(x10), .c(x08), .d(x06), .O(new_n76_));
  aoi21  g30(.a(new_n76_), .b(new_n75_), .c(new_n55_), .O(z18));
  nand2  g31(.a(new_n65_), .b(x20), .O(new_n78_));
  nand4  g32(.a(new_n62_), .b(x10), .c(x08), .d(x07), .O(new_n79_));
  aoi21  g33(.a(new_n79_), .b(new_n78_), .c(new_n55_), .O(z19));
  zero   g34(.O(z00));
  zero   g35(.O(z02));
  zero   g36(.O(z06));
  zero   g37(.O(z09));
