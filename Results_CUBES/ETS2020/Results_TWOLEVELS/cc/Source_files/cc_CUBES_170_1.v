...
module FAU ( 
  ...
  nand2  g26(.a(new_n64_), .b(x19), .O(new_n72_));
  nand4  g27(.a(new_n61_), .b(x10), .c(x08), .d(x06), .O(new_n73_));
  aoi21  g28(.a(new_n73_), .b(new_n72_), .c(new_n54_), .O(z18));
  nand2  g29(.a(new_n64_), .b(x20), .O(new_n75_));
  nand4  g30(.a(new_n61_), .b(x10), .c(x08), .d(x07), .O(new_n76_));
  aoi21  g31(.a(new_n76_), .b(new_n75_), .c(new_n54_), .O(z19));
  zero   g32(.O(z02));
  zero   g33(.O(z04));
  zero   g34(.O(z12));
  zero   g35(.O(z17));
