...
module FAU ( 
  ...
  nand2  g19(.a(new_n45_), .b(x15), .O(new_n64_));
  nand4  g20(.a(new_n54_), .b(x10), .c(x08), .d(x02), .O(new_n65_));
  aoi21  g21(.a(new_n65_), .b(new_n64_), .c(new_n53_), .O(z14));
  nand3  g22(.a(new_n55_), .b(x16), .c(new_n46_), .O(new_n67_));
  nand4  g23(.a(new_n54_), .b(x10), .c(x08), .d(x03), .O(new_n68_));
  aoi21  g24(.a(new_n68_), .b(new_n67_), .c(new_n53_), .O(z15));
  nand2  g25(.a(new_n55_), .b(x17), .O(new_n70_));
  nand4  g26(.a(new_n54_), .b(x10), .c(x08), .d(x04), .O(new_n71_));
  aoi21  g27(.a(new_n71_), .b(new_n70_), .c(new_n53_), .O(z16));
  nand2  g28(.a(new_n55_), .b(x18), .O(new_n73_));
  nand4  g29(.a(new_n54_), .b(x10), .c(x08), .d(x05), .O(new_n74_));
  aoi21  g30(.a(new_n74_), .b(new_n73_), .c(new_n53_), .O(z17));
  nand2  g31(.a(new_n55_), .b(x19), .O(new_n76_));
  nand4  g32(.a(new_n54_), .b(x10), .c(x08), .d(x06), .O(new_n77_));
  aoi21  g33(.a(new_n77_), .b(new_n76_), .c(new_n53_), .O(z18));
  nand2  g34(.a(new_n55_), .b(x20), .O(new_n79_));
  nand4  g35(.a(new_n54_), .b(x10), .c(x08), .d(x07), .O(new_n80_));
  aoi21  g36(.a(new_n80_), .b(new_n79_), .c(new_n53_), .O(z19));
  zero   g37(.O(z01));
  zero   g38(.O(z02));
  zero   g39(.O(z06));
  buf    g40(.a(x19), .O(z05));
