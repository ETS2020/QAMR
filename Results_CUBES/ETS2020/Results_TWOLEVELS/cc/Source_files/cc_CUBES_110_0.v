...
module FAU ( 
  ...
  nand3  g19(.a(new_n55_), .b(x16), .c(new_n46_), .O(new_n67_));
  nand4  g20(.a(new_n54_), .b(x10), .c(x08), .d(x03), .O(new_n68_));
  aoi21  g21(.a(new_n68_), .b(new_n67_), .c(new_n53_), .O(z15));
  nand2  g22(.a(new_n55_), .b(x17), .O(new_n70_));
  nand4  g23(.a(new_n54_), .b(x10), .c(x08), .d(x04), .O(new_n71_));
  aoi21  g24(.a(new_n71_), .b(new_n70_), .c(new_n53_), .O(z16));
  nand2  g25(.a(new_n55_), .b(x18), .O(new_n73_));
  nand4  g26(.a(new_n54_), .b(x10), .c(x08), .d(x05), .O(new_n74_));
  aoi21  g27(.a(new_n74_), .b(new_n73_), .c(new_n53_), .O(z17));
  zero   g28(.O(z01));
  zero   g29(.O(z02));
  zero   g30(.O(z04));
  zero   g31(.O(z09));
