...
module FAU ( 
  ...
  wire new_n43_, new_n44_, new_n47_, new_n48_, new_n55_, new_n56_, new_n57_,
    new_n58_, new_n59_, new_n61_, new_n62_, new_n63_, new_n64_, new_n69_,
  ...
  nand2  g20(.a(new_n57_), .b(x18), .O(new_n69_));
  nand4  g21(.a(new_n56_), .b(x10), .c(x08), .d(x05), .O(new_n70_));
  aoi21  g22(.a(new_n70_), .b(new_n69_), .c(new_n55_), .O(z17));
  nand2  g23(.a(new_n57_), .b(x19), .O(new_n72_));
  nand4  g24(.a(new_n56_), .b(x10), .c(x08), .d(x06), .O(new_n73_));
  aoi21  g25(.a(new_n73_), .b(new_n72_), .c(new_n55_), .O(z18));
