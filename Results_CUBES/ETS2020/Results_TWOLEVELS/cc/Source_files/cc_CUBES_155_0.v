...
module FAU ( 
  ...
  nand2  g21(.a(new_n46_), .b(x18), .O(new_n72_));
  nand4  g22(.a(new_n45_), .b(x10), .c(x08), .d(x05), .O(new_n73_));
  aoi21  g23(.a(new_n73_), .b(new_n72_), .c(new_n58_), .O(z17));
  nand2  g24(.a(new_n46_), .b(x19), .O(new_n75_));
  nand4  g25(.a(new_n45_), .b(x10), .c(x08), .d(x06), .O(new_n76_));
  aoi21  g26(.a(new_n76_), .b(new_n75_), .c(new_n58_), .O(z18));
  nand2  g27(.a(new_n46_), .b(x20), .O(new_n78_));
  nand4  g28(.a(new_n45_), .b(x10), .c(x08), .d(x07), .O(new_n79_));
  aoi21  g29(.a(new_n79_), .b(new_n78_), .c(new_n58_), .O(z19));
  zero   g30(.O(z00));
  zero   g31(.O(z01));
  zero   g32(.O(z04));
  zero   g33(.O(z05));
