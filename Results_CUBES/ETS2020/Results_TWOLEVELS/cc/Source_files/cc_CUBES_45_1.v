...
module FAU ( 
  ...
  wire new_n43_, new_n44_, new_n47_, new_n48_, new_n55_, new_n56_, new_n57_,
    new_n58_, new_n59_, new_n61_, new_n62_, new_n63_, new_n67_, new_n68_,
  ...
  nand3  g18(.a(new_n62_), .b(x10), .c(x08), .O(new_n67_));
  nand2  g19(.a(new_n67_), .b(x18), .O(new_n68_));
  nand4  g20(.a(new_n62_), .b(x10), .c(x08), .d(x05), .O(new_n69_));
  aoi21  g21(.a(new_n69_), .b(new_n68_), .c(new_n55_), .O(z17));
  nand2  g22(.a(new_n67_), .b(x19), .O(new_n71_));
  nand4  g23(.a(new_n62_), .b(x10), .c(x08), .d(x06), .O(new_n72_));
  aoi21  g24(.a(new_n72_), .b(new_n71_), .c(new_n55_), .O(z18));
  nand2  g25(.a(new_n67_), .b(x20), .O(new_n74_));
  nand4  g26(.a(new_n62_), .b(x10), .c(x08), .d(x07), .O(new_n75_));
  aoi21  g27(.a(new_n75_), .b(new_n74_), .c(new_n55_), .O(z19));
  zero   g28(.O(z00));
  zero   g29(.O(z02));
  zero   g30(.O(z07));
  zero   g31(.O(z09));
