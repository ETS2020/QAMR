...
module FAU ( 
  ...
  wire new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_, new_n51_,
    ...
    new_n66_, new_n69_, new_n70_, new_n73_, new_n74_, new_n77_, new_n78_;
  ...
  aoi21  g26(.a(new_n70_), .b(new_n69_), .c(new_n59_), .O(z15));
  nand2  g27(.a(new_n47_), .b(x18), .O(new_n73_));
  nand4  g28(.a(new_n46_), .b(x10), .c(x08), .d(x05), .O(new_n74_));
  aoi21  g29(.a(new_n74_), .b(new_n73_), .c(new_n59_), .O(z17));
  nand2  g30(.a(new_n47_), .b(x20), .O(new_n77_));
  nand4  g31(.a(new_n46_), .b(x10), .c(x08), .d(x07), .O(new_n78_));
  aoi21  g32(.a(new_n78_), .b(new_n77_), .c(new_n59_), .O(z19));
  zero   g33(.O(z05));
  zero   g34(.O(z07));
  zero   g35(.O(z14));
  zero   g36(.O(z16));
