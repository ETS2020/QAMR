...
module FAU ( 
  ...
  nand2  g28(.a(new_n46_), .b(x19), .O(new_n77_));
  nand4  g29(.a(new_n45_), .b(x10), .c(x08), .d(x06), .O(new_n78_));
  aoi21  g30(.a(new_n78_), .b(new_n77_), .c(new_n58_), .O(z18));
  nand2  g31(.a(new_n46_), .b(x20), .O(new_n80_));
  nand4  g32(.a(new_n45_), .b(x10), .c(x08), .d(x07), .O(new_n81_));
  aoi21  g33(.a(new_n81_), .b(new_n80_), .c(new_n58_), .O(z19));
  zero   g34(.O(z01));
  zero   g35(.O(z04));
  zero   g36(.O(z08));
  zero   g37(.O(z09));
