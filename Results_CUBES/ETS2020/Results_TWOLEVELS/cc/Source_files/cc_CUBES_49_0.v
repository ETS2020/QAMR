// Benchmark "FAU" written by ABC on Mon Jul  6 17:27:24 2020
...
module FAU ( 
  ...
  wire new_n45_, new_n46_, new_n47_, new_n54_, new_n55_, new_n56_, new_n57_,
    ...
    new_n69_, new_n70_, new_n74_, new_n75_;
  ...
  nand2  g22(.a(new_n56_), .b(x20), .O(new_n74_));
  nand4  g23(.a(new_n55_), .b(x10), .c(x08), .d(x07), .O(new_n75_));
  aoi21  g24(.a(new_n75_), .b(new_n74_), .c(new_n54_), .O(z19));
  zero   g25(.O(z01));
  zero   g26(.O(z02));
  zero   g27(.O(z04));
  zero   g28(.O(z08));
