...
module FAU ( 
  ...
  wire new_n100_, new_n101_, new_n102_, new_n103_, new_n104_, new_n105_,
    ...
    new_n247_, new_n248_, new_n249_, new_n250_, new_n256_, new_n257_,
    new_n258_, new_n259_;
  ...
  nand3  g126(.a(x30), .b(new_n181_), .c(new_n107_), .O(new_n256_));
  nand3  g127(.a(new_n222_), .b(x21), .c(x20), .O(new_n257_));
  inv1   g128(.a(x15), .O(new_n258_));
  nand4  g129(.a(new_n110_), .b(new_n258_), .c(new_n207_), .d(x00), .O(new_n259_));
  nor3   g130(.a(new_n259_), .b(new_n257_), .c(new_n256_), .O(z41));
  zero   g131(.O(z00));
  zero   g132(.O(z01));
  zero   g133(.O(z02));
  zero   g134(.O(z03));
