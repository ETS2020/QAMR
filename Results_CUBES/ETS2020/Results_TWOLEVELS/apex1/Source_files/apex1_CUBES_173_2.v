...
module FAU ( 
  ...
  wire new_n103_, new_n104_, new_n105_, new_n106_, new_n107_, new_n108_,
    ...
    new_n175_, new_n176_, new_n177_, new_n178_, new_n211_;
  ...
  nand4  g077(.a(new_n174_), .b(new_n112_), .c(new_n103_), .d(new_n104_), .O(new_n211_));
  nor2   g078(.a(new_n211_), .b(new_n114_), .O(z44));
  zero   g079(.O(z00));
  zero   g080(.O(z01));
  zero   g081(.O(z02));
  zero   g082(.O(z03));
