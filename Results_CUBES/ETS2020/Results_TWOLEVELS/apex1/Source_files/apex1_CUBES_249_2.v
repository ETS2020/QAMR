...
module FAU ( 
  ...
  wire new_n99_, new_n100_, new_n101_, new_n102_, new_n103_, new_n104_,
    ...
    new_n153_, new_n154_, new_n180_, new_n181_, new_n182_, new_n183_,
    new_n184_, new_n185_;
  ...
  inv1   g048(.a(x27), .O(new_n147_));
  inv1   g049(.a(new_n136_), .O(new_n148_));
  nor2   g050(.a(x21), .b(new_n102_), .O(new_n149_));
  inv1   g051(.a(x00), .O(new_n150_));
  inv1   g052(.a(x04), .O(new_n151_));
  nand4  g053(.a(x19), .b(x18), .c(new_n151_), .d(new_n150_), .O(new_n152_));
  inv1   g054(.a(new_n152_), .O(new_n153_));
  nand4  g055(.a(new_n153_), .b(new_n149_), .c(new_n148_), .d(new_n147_), .O(new_n154_));
  nand2  g056(.a(new_n154_), .b(new_n146_), .O(z08));
  oai21  g057(.a(new_n110_), .b(new_n150_), .c(new_n100_), .O(new_n180_));
  nand3  g058(.a(new_n180_), .b(new_n107_), .c(x27), .O(new_n181_));
  oai21  g059(.a(x30), .b(x04), .c(x28), .O(new_n182_));
  oai21  g060(.a(new_n100_), .b(new_n105_), .c(new_n182_), .O(new_n183_));
  nand3  g061(.a(new_n183_), .b(x29), .c(new_n147_), .O(new_n184_));
  nand3  g062(.a(new_n149_), .b(x19), .c(x18), .O(new_n185_));
  aoi21  g063(.a(new_n184_), .b(new_n181_), .c(new_n185_), .O(z33));
  zero   g064(.O(z00));
  zero   g065(.O(z01));
  zero   g066(.O(z02));
  zero   g067(.O(z03));
