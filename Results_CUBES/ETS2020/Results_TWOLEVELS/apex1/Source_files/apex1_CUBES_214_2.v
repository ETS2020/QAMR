// Benchmark "FAU" written by ABC on Tue Jul  7 14:36:05 2020
...
module FAU ( 
  ...
  nand3  g051(.a(x30), .b(x29), .c(new_n102_), .O(new_n153_));
  nand3  g052(.a(new_n132_), .b(new_n104_), .c(x28), .O(new_n154_));
  nand2  g053(.a(new_n154_), .b(new_n153_), .O(new_n155_));
  nand4  g054(.a(new_n155_), .b(new_n147_), .c(x26), .d(new_n103_), .O(new_n156_));
  nand2  g055(.a(new_n156_), .b(new_n152_), .O(new_n157_));
  xor2a  g056(.a(x30), .b(x28), .O(new_n158_));
  nand3  g057(.a(new_n158_), .b(new_n142_), .c(new_n111_), .O(new_n159_));
  nand4  g058(.a(x30), .b(new_n102_), .c(x22), .d(x20), .O(new_n160_));
  nand2  g059(.a(x29), .b(new_n106_), .O(new_n161_));
  aoi21  g060(.a(new_n160_), .b(new_n159_), .c(new_n161_), .O(new_n162_));
  aoi21  g061(.a(new_n157_), .b(x18), .c(new_n162_), .O(new_n163_));
  nand2  g062(.a(new_n163_), .b(new_n140_), .O(z11));
  nand4  g063(.a(x26), .b(new_n142_), .c(x20), .d(new_n111_), .O(new_n173_));
  nor4   g064(.a(new_n173_), .b(new_n153_), .c(new_n106_), .d(x17), .O(z20));
  zero   g065(.O(z00));
  zero   g066(.O(z01));
  zero   g067(.O(z02));
  zero   g068(.O(z03));
