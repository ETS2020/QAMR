// Benchmark "FAU" written by ABC on Wed Jul  8 20:50:31 2020
...
module FAU ( 
  ...
  nand3  g32(.a(new_n129_), .b(new_n102_), .c(new_n111_), .O(new_n130_));
  oai21  g33(.a(new_n130_), .b(new_n123_), .c(new_n116_), .O(new_n131_));
  ...
  inv1   g38(.a(x36), .O(new_n136_));
  nor2   g39(.a(x37), .b(new_n136_), .O(new_n137_));
  nand3  g40(.a(new_n137_), .b(new_n135_), .c(x32), .O(new_n138_));
  aoi21  g41(.a(new_n138_), .b(new_n134_), .c(x35), .O(new_n139_));
  oai21  g42(.a(new_n139_), .b(new_n127_), .c(new_n98_), .O(new_n140_));
  nand2  g43(.a(new_n140_), .b(x33), .O(z21));
  inv1   g44(.a(x01), .O(new_n148_));
  nand2  g45(.a(new_n133_), .b(new_n99_), .O(new_n149_));
  nand2  g46(.a(x35), .b(new_n132_), .O(new_n150_));
  nand3  g47(.a(x38), .b(x37), .c(x36), .O(new_n151_));
  oai22  g48(.a(new_n151_), .b(new_n150_), .c(new_n149_), .d(new_n130_), .O(new_n152_));
  inv1   g49(.a(x03), .O(new_n153_));
  nand3  g50(.a(x04), .b(new_n153_), .c(x02), .O(new_n154_));
  inv1   g51(.a(new_n154_), .O(new_n155_));
  nand4  g52(.a(new_n155_), .b(new_n152_), .c(new_n148_), .d(x00), .O(new_n156_));
  nor2   g53(.a(x35), .b(x34), .O(new_n157_));
  nand4  g54(.a(new_n104_), .b(new_n103_), .c(x27), .d(x10), .O(new_n158_));
  inv1   g55(.a(new_n158_), .O(new_n159_));
  nand4  g56(.a(new_n159_), .b(new_n157_), .c(new_n137_), .d(x38), .O(new_n160_));
  nand3  g57(.a(x33), .b(new_n116_), .c(new_n98_), .O(new_n161_));
  aoi21  g58(.a(new_n160_), .b(new_n156_), .c(new_n161_), .O(z28));
  zero   g59(.O(z00));
  zero   g60(.O(z01));
  zero   g61(.O(z02));
  zero   g62(.O(z03));
