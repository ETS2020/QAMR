// Benchmark "FAU" written by ABC on Wed Jul  8 20:52:49 2020
...
module FAU ( 
  ...
  wire new_n94_, new_n95_, new_n96_, new_n97_, new_n98_, new_n99_, new_n100_,
    ...
    new_n225_, new_n226_, new_n227_, new_n228_, new_n229_, new_n241_,
    new_n242_, new_n243_;
  ...
  inv1   g134(.a(x36), .O(new_n241_));
  nand4  g135(.a(new_n102_), .b(new_n116_), .c(x38), .d(new_n241_), .O(new_n242_));
  nand3  g136(.a(new_n184_), .b(new_n98_), .c(x33), .O(new_n243_));
  nor4   g137(.a(new_n243_), .b(new_n242_), .c(x32), .d(x07), .O(z32));
  zero   g138(.O(z00));
  zero   g139(.O(z01));
  zero   g140(.O(z02));
  zero   g141(.O(z03));
