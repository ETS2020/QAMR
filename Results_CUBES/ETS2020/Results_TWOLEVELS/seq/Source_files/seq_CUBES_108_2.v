...
module FAU ( 
  ...
  wire new_n98_, new_n99_, new_n100_, new_n101_, new_n102_, new_n103_,
    ...
    new_n134_, new_n135_, new_n136_, new_n137_, new_n138_, new_n150_,
    new_n151_, new_n152_;
  ...
  nand4  g42(.a(new_n104_), .b(new_n103_), .c(x38), .d(x37), .O(new_n150_));
  inv1   g43(.a(x36), .O(new_n151_));
  nand4  g44(.a(new_n151_), .b(x35), .c(new_n132_), .d(x33), .O(new_n152_));
  nor4   g45(.a(new_n152_), .b(new_n150_), .c(x32), .d(x07), .O(z32));
  zero   g46(.O(z00));
  zero   g47(.O(z01));
  zero   g48(.O(z02));
  zero   g49(.O(z03));
