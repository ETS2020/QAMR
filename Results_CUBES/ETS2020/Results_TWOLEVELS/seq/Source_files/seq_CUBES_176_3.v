// Benchmark "FAU" written by ABC on Wed Jul  8 20:51:00 2020
...
module FAU ( 
  ...
  nor2   g0807(.a(new_n817_), .b(new_n359_), .O(new_n885_));
  nor3   g0808(.a(new_n885_), .b(x36), .c(x07), .O(new_n886_));
  nand3  g0809(.a(new_n241_), .b(x36), .c(x13), .O(new_n887_));
  inv1   g0810(.a(new_n887_), .O(new_n888_));
  nand3  g0811(.a(new_n375_), .b(new_n246_), .c(new_n462_), .O(new_n889_));
  inv1   g0812(.a(new_n889_), .O(new_n890_));
  oai21  g0813(.a(new_n888_), .b(new_n886_), .c(new_n890_), .O(new_n891_));
  aoi21  g0814(.a(new_n891_), .b(new_n307_), .c(new_n308_), .O(z14));
  ...
  inv1   g1337(.a(new_n885_), .O(new_n1415_));
  inv1   g1338(.a(new_n1411_), .O(new_n1416_));
  inv1   g1339(.a(new_n1221_), .O(new_n1417_));
  nor2   g1340(.a(x38), .b(new_n212_), .O(new_n1418_));
  aoi22  g1341(.a(new_n1418_), .b(new_n128_), .c(new_n1417_), .d(new_n710_), .O(new_n1419_));
  oai22  g1342(.a(new_n1419_), .b(new_n1416_), .c(new_n745_), .d(new_n341_), .O(new_n1420_));
  aoi21  g1343(.a(new_n1420_), .b(new_n78_), .c(new_n1415_), .O(new_n1421_));
