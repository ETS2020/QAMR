...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n284_, new_n286_, new_n288_, new_n291_, new_n293_, new_n300_,
  ...
  nand2  g112(.a(new_n272_), .b(new_n243_), .O(new_n273_));
  nand3  g113(.a(x83), .b(x81), .c(x42), .O(new_n274_));
  nand2  g114(.a(new_n274_), .b(new_n273_), .O(new_n275_));
  and2   g115(.a(new_n275_), .b(new_n244_), .O(new_n276_));
  nand2  g116(.a(new_n272_), .b(x81), .O(new_n277_));
  nand2  g117(.a(new_n259_), .b(x42), .O(new_n278_));
  aoi21  g118(.a(new_n278_), .b(new_n277_), .c(new_n240_), .O(new_n279_));
  oai21  g119(.a(new_n279_), .b(new_n276_), .c(new_n269_), .O(new_n280_));
  nand2  g120(.a(new_n235_), .b(x52), .O(new_n281_));
  nor2   g121(.a(new_n281_), .b(new_n280_), .O(z34));
  nand2  g122(.a(new_n235_), .b(x54), .O(new_n284_));
  nor2   g123(.a(new_n284_), .b(new_n280_), .O(z36));
  nand2  g124(.a(new_n235_), .b(x55), .O(new_n286_));
  nor2   g125(.a(new_n286_), .b(new_n280_), .O(z37));
  nand2  g126(.a(new_n235_), .b(x56), .O(new_n288_));
  nor2   g127(.a(new_n288_), .b(new_n280_), .O(z38));
  inv1   g128(.a(new_n235_), .O(new_n291_));
  nor3   g129(.a(new_n280_), .b(new_n291_), .c(new_n188_), .O(z40));
  nand2  g130(.a(new_n235_), .b(x59), .O(new_n293_));
  nor2   g131(.a(new_n293_), .b(new_n280_), .O(z41));
  nor3   g132(.a(new_n280_), .b(new_n291_), .c(new_n184_), .O(z42));
  nor3   g133(.a(new_n280_), .b(new_n291_), .c(new_n181_), .O(z43));
  nor3   g134(.a(new_n280_), .b(new_n291_), .c(new_n172_), .O(z46));
  inv1   g135(.a(x07), .O(new_n300_));
  nand2  g136(.a(x52), .b(x15), .O(new_n301_));
  oai21  g137(.a(x52), .b(new_n300_), .c(new_n301_), .O(new_n302_));
  nand3  g138(.a(new_n225_), .b(new_n154_), .c(new_n159_), .O(new_n303_));
  ...
  nand2  g145(.a(new_n309_), .b(new_n215_), .O(new_n310_));
  ...
  inv1   g151(.a(new_n215_), .O(new_n316_));
  ...
  nand2  g158(.a(new_n323_), .b(new_n304_), .O(new_n324_));
  nand2  g159(.a(new_n317_), .b(x70), .O(new_n325_));
  aoi21  g160(.a(new_n325_), .b(new_n324_), .c(x01), .O(z50));
  inv1   g161(.a(x11), .O(new_n327_));
  nand2  g162(.a(x52), .b(x19), .O(new_n328_));
  oai21  g163(.a(x52), .b(new_n327_), .c(new_n328_), .O(new_n329_));
  nand2  g164(.a(new_n329_), .b(new_n304_), .O(new_n330_));
  nand2  g165(.a(new_n317_), .b(x71), .O(new_n331_));
  aoi21  g166(.a(new_n331_), .b(new_n330_), .c(x01), .O(z51));
  inv1   g167(.a(x82), .O(new_n336_));
  nand3  g168(.a(new_n259_), .b(x84), .c(new_n336_), .O(new_n337_));
  inv1   g169(.a(x80), .O(new_n338_));
  nand4  g170(.a(new_n235_), .b(new_n161_), .c(new_n338_), .d(x79), .O(new_n339_));
  nor2   g171(.a(new_n339_), .b(new_n337_), .O(z55));
  nand2  g172(.a(new_n233_), .b(x76), .O(new_n341_));
  xnor2a g173(.a(x84), .b(x81), .O(new_n342_));
  aoi21  g174(.a(new_n213_), .b(new_n212_), .c(new_n342_), .O(new_n343_));
  ...
  nand3  g179(.a(new_n347_), .b(new_n346_), .c(new_n231_), .O(z56));
  inv1   g180(.a(x02), .O(new_n349_));
  nand3  g181(.a(new_n231_), .b(x03), .c(new_n349_), .O(new_n350_));
  inv1   g182(.a(new_n350_), .O(z57));
  nand4  g183(.a(x80), .b(new_n220_), .c(x43), .d(new_n239_), .O(new_n352_));
  oai22  g184(.a(new_n352_), .b(new_n219_), .c(new_n239_), .d(x40), .O(new_n353_));
  nand3  g185(.a(new_n353_), .b(new_n225_), .c(x79), .O(new_n354_));
  nor2   g186(.a(x79), .b(x78), .O(new_n355_));
  nand3  g187(.a(new_n355_), .b(new_n239_), .c(x40), .O(new_n356_));
  nand2  g188(.a(new_n356_), .b(new_n354_), .O(new_n357_));
  nand2  g189(.a(new_n357_), .b(x77), .O(new_n358_));
  inv1   g190(.a(new_n212_), .O(new_n359_));
  oai21  g191(.a(new_n359_), .b(new_n228_), .c(new_n154_), .O(new_n360_));
  aoi21  g192(.a(new_n360_), .b(new_n358_), .c(x01), .O(z58));
  inv1   g193(.a(new_n355_), .O(new_n362_));
  aoi21  g194(.a(new_n224_), .b(new_n362_), .c(new_n152_), .O(new_n363_));
  oai21  g195(.a(new_n221_), .b(new_n219_), .c(new_n239_), .O(new_n364_));
  aoi21  g196(.a(new_n364_), .b(x79), .c(new_n224_), .O(new_n365_));
  ...
  aoi21  g201(.a(new_n343_), .b(x79), .c(new_n367_), .O(new_n370_));
  aoi21  g202(.a(new_n370_), .b(new_n226_), .c(x01), .O(z60));
  nand2  g203(.a(new_n213_), .b(new_n212_), .O(new_n372_));
  aoi22  g204(.a(new_n372_), .b(new_n215_), .c(new_n161_), .d(new_n228_), .O(new_n373_));
  nor2   g205(.a(new_n154_), .b(x01), .O(new_n374_));
  inv1   g206(.a(new_n374_), .O(new_n375_));
  nor3   g207(.a(new_n375_), .b(new_n373_), .c(new_n338_), .O(z61));
  nand3  g208(.a(x84), .b(x81), .c(x79), .O(new_n377_));
  oai21  g209(.a(x79), .b(new_n228_), .c(new_n377_), .O(new_n378_));
  nand2  g210(.a(new_n378_), .b(new_n159_), .O(new_n379_));
  nand2  g211(.a(new_n364_), .b(x79), .O(new_n380_));
  nand3  g212(.a(x81), .b(x79), .c(new_n228_), .O(new_n381_));
  ...
  nand2  g218(.a(new_n386_), .b(new_n307_), .O(new_n387_));
  aoi21  g219(.a(new_n387_), .b(new_n385_), .c(x01), .O(z62));
  nor3   g220(.a(new_n375_), .b(new_n373_), .c(new_n336_), .O(z63));
  nand2  g221(.a(x83), .b(x79), .O(new_n390_));
  or2    g222(.a(new_n390_), .b(new_n373_), .O(new_n391_));
  aoi21  g223(.a(new_n391_), .b(new_n303_), .c(x01), .O(z64));
  nor2   g224(.a(new_n160_), .b(x04), .O(new_n393_));
  nor2   g225(.a(new_n243_), .b(x78), .O(new_n394_));
  oai21  g226(.a(new_n394_), .b(new_n393_), .c(x77), .O(new_n395_));
  nand2  g227(.a(new_n359_), .b(x81), .O(new_n396_));
