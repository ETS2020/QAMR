...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n251_, new_n254_, new_n258_, new_n263_, new_n264_, new_n265_,
    new_n266_, new_n267_, new_n268_, new_n269_, new_n270_, new_n271_,
    new_n272_, new_n273_, new_n275_, new_n278_, new_n280_, new_n287_,
  ...
  nor2   g101(.a(new_n219_), .b(new_n239_), .O(new_n264_));
  inv1   g102(.a(new_n264_), .O(new_n265_));
  nand2  g103(.a(new_n265_), .b(new_n240_), .O(new_n266_));
  nand2  g104(.a(new_n264_), .b(x81), .O(new_n267_));
  aoi21  g105(.a(new_n267_), .b(new_n266_), .c(new_n243_), .O(new_n268_));
  nand2  g106(.a(new_n265_), .b(x81), .O(new_n269_));
  nand2  g107(.a(new_n264_), .b(new_n240_), .O(new_n270_));
  aoi21  g108(.a(new_n270_), .b(new_n269_), .c(new_n241_), .O(new_n271_));
  oai21  g109(.a(new_n271_), .b(new_n268_), .c(new_n263_), .O(new_n272_));
  nand2  g110(.a(new_n236_), .b(x54), .O(new_n273_));
  nor2   g111(.a(new_n273_), .b(new_n272_), .O(z36));
  nand2  g112(.a(new_n236_), .b(x55), .O(new_n275_));
  nor2   g113(.a(new_n275_), .b(new_n272_), .O(z37));
  inv1   g114(.a(new_n236_), .O(new_n278_));
  nor3   g115(.a(new_n272_), .b(new_n278_), .c(new_n193_), .O(z39));
  nand2  g116(.a(new_n236_), .b(x58), .O(new_n280_));
  nor2   g117(.a(new_n280_), .b(new_n272_), .O(z40));
  nor3   g118(.a(new_n272_), .b(new_n278_), .c(new_n189_), .O(z41));
  nor3   g119(.a(new_n272_), .b(new_n278_), .c(new_n186_), .O(z42));
  nor3   g120(.a(new_n272_), .b(new_n278_), .c(new_n183_), .O(z43));
  nand2  g121(.a(new_n236_), .b(x64), .O(new_n287_));
  nor2   g122(.a(new_n287_), .b(new_n272_), .O(z46));
  ...
  inv1   g140(.a(new_n216_), .O(new_n306_));
  ...
  nand2  g147(.a(new_n313_), .b(new_n294_), .O(new_n314_));
  nand2  g148(.a(new_n307_), .b(x70), .O(new_n315_));
  ...
  nand2  g153(.a(new_n319_), .b(new_n294_), .O(new_n320_));
  nand2  g154(.a(new_n307_), .b(x71), .O(new_n321_));
  ...
  nor2   g167(.a(new_n334_), .b(new_n332_), .O(z54));
  inv1   g168(.a(x82), .O(new_n336_));
  nand4  g169(.a(x84), .b(x83), .c(new_n336_), .d(new_n240_), .O(new_n337_));
  inv1   g170(.a(x80), .O(new_n338_));
  nand4  g171(.a(new_n236_), .b(new_n161_), .c(new_n338_), .d(x79), .O(new_n339_));
  nor2   g172(.a(new_n339_), .b(new_n337_), .O(z55));
  nand2  g173(.a(new_n234_), .b(x76), .O(new_n341_));
  ...
  nand3  g180(.a(new_n347_), .b(new_n346_), .c(new_n232_), .O(z56));
  inv1   g181(.a(x02), .O(new_n349_));
  nand3  g182(.a(new_n232_), .b(x03), .c(new_n349_), .O(new_n350_));
  inv1   g183(.a(new_n350_), .O(z57));
  nand4  g184(.a(x80), .b(new_n221_), .c(x43), .d(new_n239_), .O(new_n352_));
  oai22  g185(.a(new_n352_), .b(new_n220_), .c(new_n239_), .d(x40), .O(new_n353_));
  nand3  g186(.a(new_n353_), .b(new_n226_), .c(x79), .O(new_n354_));
  nor2   g187(.a(x79), .b(x78), .O(new_n355_));
  nand3  g188(.a(new_n355_), .b(new_n239_), .c(x40), .O(new_n356_));
  nand2  g189(.a(new_n356_), .b(new_n354_), .O(new_n357_));
  nand2  g190(.a(new_n357_), .b(x77), .O(new_n358_));
  oai21  g191(.a(new_n333_), .b(new_n229_), .c(new_n154_), .O(new_n359_));
  aoi21  g192(.a(new_n359_), .b(new_n358_), .c(x01), .O(z58));
  inv1   g193(.a(new_n355_), .O(new_n361_));
  aoi21  g194(.a(new_n225_), .b(new_n361_), .c(new_n152_), .O(new_n362_));
  oai21  g195(.a(new_n222_), .b(new_n220_), .c(new_n239_), .O(new_n363_));
  aoi21  g196(.a(new_n363_), .b(x79), .c(new_n225_), .O(new_n364_));
  ...
  nand2  g217(.a(new_n384_), .b(new_n297_), .O(new_n385_));
  ...
  aoi21  g222(.a(new_n389_), .b(new_n293_), .c(x01), .O(z64));
  nor2   g223(.a(new_n160_), .b(x04), .O(new_n391_));
  nor2   g224(.a(new_n240_), .b(x78), .O(new_n392_));
