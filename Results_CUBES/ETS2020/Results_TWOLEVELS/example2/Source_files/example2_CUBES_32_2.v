...
module FAU ( 
  ...
  wire new_n154_, new_n155_, new_n156_, new_n157_, new_n158_, new_n159_,
    ...
    new_n252_, new_n253_, new_n254_, new_n255_, new_n256_, new_n260_,
  ...
  inv1   g068(.a(new_n208_), .O(new_n236_));
  xnor2a g069(.a(x83), .b(x81), .O(new_n237_));
  nand2  g070(.a(x42), .b(x05), .O(new_n238_));
  nand2  g071(.a(x51), .b(new_n214_), .O(new_n239_));
  oai22  g072(.a(new_n239_), .b(new_n207_), .c(new_n238_), .d(new_n237_), .O(new_n240_));
  nand2  g073(.a(new_n240_), .b(new_n236_), .O(new_n241_));
  xor2a  g074(.a(x83), .b(x81), .O(new_n242_));
  oai22  g075(.a(new_n242_), .b(new_n238_), .c(new_n239_), .d(x81), .O(new_n243_));
  nand2  g076(.a(new_n243_), .b(new_n209_), .O(new_n244_));
  nand2  g077(.a(new_n215_), .b(new_n213_), .O(new_n245_));
  aoi21  g078(.a(new_n244_), .b(new_n241_), .c(new_n245_), .O(z33));
  xnor2a g079(.a(x84), .b(x82), .O(new_n247_));
  nand2  g080(.a(x83), .b(x42), .O(new_n248_));
  nand2  g081(.a(new_n248_), .b(new_n207_), .O(new_n249_));
  nand3  g082(.a(x83), .b(x81), .c(x42), .O(new_n250_));
  aoi21  g083(.a(new_n250_), .b(new_n249_), .c(new_n247_), .O(new_n251_));
  nand2  g084(.a(new_n248_), .b(x81), .O(new_n252_));
  nand3  g085(.a(x83), .b(new_n207_), .c(x42), .O(new_n253_));
  aoi21  g086(.a(new_n253_), .b(new_n252_), .c(new_n208_), .O(new_n254_));
  oai21  g087(.a(new_n254_), .b(new_n251_), .c(new_n213_), .O(new_n255_));
  nand2  g088(.a(new_n215_), .b(x52), .O(new_n256_));
  nor2   g089(.a(new_n256_), .b(new_n255_), .O(z34));
  nand2  g090(.a(new_n215_), .b(x55), .O(new_n260_));
  nor2   g091(.a(new_n260_), .b(new_n255_), .O(z37));
  nand2  g092(.a(new_n215_), .b(x56), .O(new_n262_));
  nor2   g093(.a(new_n262_), .b(new_n255_), .O(z38));
  nand2  g094(.a(new_n215_), .b(x57), .O(new_n264_));
  nor2   g095(.a(new_n264_), .b(new_n255_), .O(z39));
  nand2  g096(.a(new_n215_), .b(x58), .O(new_n266_));
  nor2   g097(.a(new_n266_), .b(new_n255_), .O(z40));
  nand2  g098(.a(new_n215_), .b(x59), .O(new_n268_));
  nor2   g099(.a(new_n268_), .b(new_n255_), .O(z41));
  nand2  g100(.a(new_n215_), .b(x60), .O(new_n270_));
  nor2   g101(.a(new_n270_), .b(new_n255_), .O(z42));
  nand2  g102(.a(new_n215_), .b(x61), .O(new_n272_));
  nor2   g103(.a(new_n272_), .b(new_n255_), .O(z43));
  nand2  g104(.a(new_n215_), .b(x62), .O(new_n274_));
  nor2   g105(.a(new_n274_), .b(new_n255_), .O(z44));
  nand2  g106(.a(new_n215_), .b(x63), .O(new_n276_));
  nor2   g107(.a(new_n276_), .b(new_n255_), .O(z45));
  inv1   g108(.a(x07), .O(new_n279_));
  nand2  g109(.a(x52), .b(x15), .O(new_n280_));
  oai21  g110(.a(x52), .b(new_n279_), .c(new_n280_), .O(new_n281_));
  inv1   g111(.a(x04), .O(new_n282_));
  nor2   g112(.a(x77), .b(new_n282_), .O(new_n283_));
  nor2   g113(.a(x79), .b(new_n156_), .O(new_n284_));
  nand3  g114(.a(new_n284_), .b(new_n283_), .c(new_n281_), .O(new_n285_));
  xnor2a g115(.a(x84), .b(x81), .O(new_n286_));
  or2    g116(.a(x75), .b(x67), .O(new_n287_));
  nor2   g117(.a(x78), .b(new_n154_), .O(new_n288_));
  nand4  g118(.a(new_n288_), .b(new_n287_), .c(new_n286_), .d(x79), .O(new_n289_));
  aoi21  g119(.a(new_n289_), .b(new_n285_), .c(x01), .O(z47));
  inv1   g120(.a(x09), .O(new_n292_));
  nand2  g121(.a(x52), .b(x17), .O(new_n293_));
  oai21  g122(.a(x52), .b(new_n292_), .c(new_n293_), .O(new_n294_));
  nand3  g123(.a(new_n294_), .b(new_n284_), .c(new_n283_), .O(new_n295_));
  nand4  g124(.a(new_n288_), .b(new_n286_), .c(x79), .d(x69), .O(new_n296_));
  ...
  nand3  g129(.a(new_n300_), .b(new_n284_), .c(new_n283_), .O(new_n301_));
  nand4  g130(.a(new_n288_), .b(new_n286_), .c(x79), .d(x70), .O(new_n302_));
  ...
  nand3  g135(.a(new_n306_), .b(new_n284_), .c(new_n283_), .O(new_n307_));
  nand4  g136(.a(new_n288_), .b(new_n286_), .c(x79), .d(x71), .O(new_n308_));
  ...
  nand3  g141(.a(new_n312_), .b(new_n284_), .c(new_n283_), .O(new_n313_));
  nand4  g142(.a(new_n288_), .b(new_n286_), .c(x79), .d(x72), .O(new_n314_));
  ...
  nand3  g147(.a(new_n318_), .b(new_n284_), .c(new_n283_), .O(new_n319_));
  nand4  g148(.a(new_n288_), .b(new_n286_), .c(x79), .d(x73), .O(new_n320_));
  ...
  inv1   g153(.a(x79), .O(new_n325_));
  nor2   g154(.a(new_n282_), .b(x01), .O(new_n326_));
  nand4  g155(.a(new_n326_), .b(new_n325_), .c(x78), .d(new_n154_), .O(new_n327_));
  nor2   g156(.a(new_n327_), .b(new_n324_), .O(z54));
