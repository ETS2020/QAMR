...
module FAU ( 
  ...
  nand3  g069(.a(new_n212_), .b(x47), .c(new_n224_), .O(new_n233_));
  inv1   g070(.a(new_n233_), .O(new_n234_));
  nand3  g071(.a(new_n234_), .b(new_n223_), .c(new_n221_), .O(new_n235_));
  inv1   g072(.a(new_n235_), .O(z29));
  nand3  g073(.a(new_n212_), .b(x48), .c(new_n224_), .O(new_n237_));
  inv1   g074(.a(new_n237_), .O(new_n238_));
  nand3  g075(.a(new_n238_), .b(new_n223_), .c(new_n221_), .O(new_n239_));
  ...
  nand2  g090(.a(new_n255_), .b(new_n217_), .O(new_n256_));
  ...
  nand3  g094(.a(x83), .b(new_n217_), .c(x42), .O(new_n260_));
  aoi21  g095(.a(new_n260_), .b(new_n259_), .c(new_n218_), .O(new_n261_));
  oai21  g096(.a(new_n261_), .b(new_n258_), .c(new_n223_), .O(new_n262_));
  nand2  g097(.a(new_n212_), .b(x52), .O(new_n263_));
  nor2   g098(.a(new_n263_), .b(new_n262_), .O(z34));
  nand2  g099(.a(new_n212_), .b(x54), .O(new_n266_));
  nor2   g100(.a(new_n266_), .b(new_n262_), .O(z36));
  nand2  g101(.a(new_n212_), .b(x56), .O(new_n269_));
  nor2   g102(.a(new_n269_), .b(new_n262_), .O(z38));
  nand2  g103(.a(new_n212_), .b(x57), .O(new_n271_));
  nor2   g104(.a(new_n271_), .b(new_n262_), .O(z39));
  nand2  g105(.a(new_n212_), .b(x58), .O(new_n273_));
  nor2   g106(.a(new_n273_), .b(new_n262_), .O(z40));
  nand2  g107(.a(new_n212_), .b(x59), .O(new_n275_));
  nor2   g108(.a(new_n275_), .b(new_n262_), .O(z41));
  nand2  g109(.a(new_n212_), .b(x60), .O(new_n277_));
  nor2   g110(.a(new_n277_), .b(new_n262_), .O(z42));
  nand2  g111(.a(new_n212_), .b(x62), .O(new_n280_));
  nor2   g112(.a(new_n280_), .b(new_n262_), .O(z44));
  nand2  g113(.a(new_n212_), .b(x63), .O(new_n282_));
  nor2   g114(.a(new_n282_), .b(new_n262_), .O(z45));
  nand2  g115(.a(new_n212_), .b(x64), .O(new_n284_));
  ...
  nand4  g120(.a(new_n208_), .b(x78), .c(new_n154_), .d(x04), .O(new_n289_));
  ...
  nand2  g133(.a(new_n302_), .b(new_n290_), .O(new_n303_));
  ...
  nand2  g157(.a(x83), .b(new_n217_), .O(new_n329_));
  nor2   g158(.a(x80), .b(new_n208_), .O(new_n330_));
  nand3  g159(.a(new_n330_), .b(new_n212_), .c(new_n209_), .O(new_n331_));
