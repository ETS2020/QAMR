...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n197_, new_n198_, new_n200_, new_n201_, new_n207_, new_n208_,
    new_n210_, new_n211_, new_n212_, new_n213_, new_n214_, new_n215_,
    new_n216_, new_n217_, new_n218_, new_n219_, new_n220_, new_n221_,
    new_n222_, new_n223_, new_n224_, new_n225_, new_n226_, new_n228_,
    new_n229_, new_n230_, new_n231_, new_n233_, new_n234_, new_n235_,
    new_n236_, new_n238_, new_n239_, new_n240_, new_n241_, new_n242_,
    new_n243_, new_n244_, new_n245_, new_n246_, new_n248_, new_n253_,
    new_n255_, new_n257_, new_n259_, new_n260_, new_n261_, new_n262_,
    new_n263_, new_n264_, new_n265_, new_n266_, new_n267_, new_n268_,
    new_n269_, new_n270_, new_n272_, new_n273_, new_n274_, new_n275_,
    new_n276_, new_n277_, new_n278_, new_n279_, new_n280_, new_n281_,
    new_n282_, new_n284_, new_n286_, new_n288_, new_n290_, new_n300_,
  ...
  nand4  g092(.a(new_n245_), .b(new_n235_), .c(x48), .d(new_n238_), .O(new_n253_));
  inv1   g093(.a(new_n253_), .O(z30));
  nand4  g094(.a(new_n245_), .b(new_n235_), .c(x49), .d(new_n238_), .O(new_n255_));
  inv1   g095(.a(new_n255_), .O(z31));
  nand4  g096(.a(new_n245_), .b(new_n235_), .c(x50), .d(new_n238_), .O(new_n257_));
  inv1   g097(.a(new_n257_), .O(z32));
  nor2   g098(.a(new_n218_), .b(x81), .O(new_n259_));
  nor2   g099(.a(x83), .b(new_n242_), .O(new_n260_));
  nor2   g100(.a(new_n260_), .b(new_n259_), .O(new_n261_));
  nand2  g101(.a(x42), .b(x05), .O(new_n262_));
  nand2  g102(.a(x51), .b(new_n238_), .O(new_n263_));
  oai22  g103(.a(new_n263_), .b(new_n242_), .c(new_n262_), .d(new_n261_), .O(new_n264_));
  ...
  nand2  g107(.a(new_n267_), .b(new_n243_), .O(new_n268_));
  inv1   g108(.a(new_n162_), .O(new_n269_));
  nand2  g109(.a(new_n235_), .b(new_n269_), .O(new_n270_));
  aoi21  g110(.a(new_n268_), .b(new_n265_), .c(new_n270_), .O(z33));
  inv1   g111(.a(x52), .O(new_n272_));
  inv1   g112(.a(new_n235_), .O(new_n273_));
  nand2  g113(.a(x83), .b(x42), .O(new_n274_));
  nand2  g114(.a(new_n274_), .b(new_n242_), .O(new_n275_));
  nand3  g115(.a(x83), .b(x81), .c(x42), .O(new_n276_));
  nand2  g116(.a(new_n276_), .b(new_n275_), .O(new_n277_));
  and2   g117(.a(new_n277_), .b(new_n243_), .O(new_n278_));
  nand2  g118(.a(new_n274_), .b(x81), .O(new_n279_));
  nand2  g119(.a(new_n259_), .b(x42), .O(new_n280_));
  aoi21  g120(.a(new_n280_), .b(new_n279_), .c(new_n239_), .O(new_n281_));
  oai21  g121(.a(new_n281_), .b(new_n278_), .c(new_n269_), .O(new_n282_));
  nor3   g122(.a(new_n282_), .b(new_n273_), .c(new_n272_), .O(z34));
  nand2  g123(.a(new_n235_), .b(x53), .O(new_n284_));
  nor2   g124(.a(new_n284_), .b(new_n282_), .O(z35));
  nand2  g125(.a(new_n235_), .b(x54), .O(new_n286_));
  nor2   g126(.a(new_n286_), .b(new_n282_), .O(z36));
  nand2  g127(.a(new_n235_), .b(x55), .O(new_n288_));
  nor2   g128(.a(new_n288_), .b(new_n282_), .O(z37));
  nand2  g129(.a(new_n235_), .b(x56), .O(new_n290_));
  nor2   g130(.a(new_n290_), .b(new_n282_), .O(z38));
  nor3   g131(.a(new_n282_), .b(new_n273_), .c(new_n191_), .O(z39));
  nor3   g132(.a(new_n282_), .b(new_n273_), .c(new_n188_), .O(z40));
  nor3   g133(.a(new_n282_), .b(new_n273_), .c(new_n185_), .O(z41));
  nor3   g134(.a(new_n282_), .b(new_n273_), .c(new_n179_), .O(z43));
  nor3   g135(.a(new_n282_), .b(new_n273_), .c(new_n176_), .O(z44));
  nor3   g136(.a(new_n282_), .b(new_n273_), .c(new_n172_), .O(z46));
  ...
  nand2  g179(.a(new_n341_), .b(new_n305_), .O(new_n342_));
  nand2  g180(.a(new_n318_), .b(x72), .O(new_n343_));
  ...
  nand2  g185(.a(new_n347_), .b(new_n305_), .O(new_n348_));
  nand2  g186(.a(new_n318_), .b(x73), .O(new_n349_));
  aoi21  g187(.a(new_n349_), .b(new_n348_), .c(x01), .O(z53));
  nand2  g188(.a(x52), .b(x22), .O(new_n351_));
  nand2  g189(.a(new_n272_), .b(x14), .O(new_n352_));
  inv1   g190(.a(new_n212_), .O(new_n353_));
  nand4  g191(.a(new_n353_), .b(new_n154_), .c(x04), .d(new_n153_), .O(new_n354_));
  aoi21  g192(.a(new_n352_), .b(new_n351_), .c(new_n354_), .O(z54));
  inv1   g193(.a(x82), .O(new_n356_));
  nand3  g194(.a(new_n259_), .b(x84), .c(new_n356_), .O(new_n357_));
  inv1   g195(.a(x80), .O(new_n358_));
  nand4  g196(.a(new_n235_), .b(new_n161_), .c(new_n358_), .d(x79), .O(new_n359_));
  nor2   g197(.a(new_n359_), .b(new_n357_), .O(z55));
  nand2  g198(.a(new_n233_), .b(x76), .O(new_n361_));
  xnor2a g199(.a(x84), .b(x81), .O(new_n362_));
  aoi21  g200(.a(new_n213_), .b(new_n212_), .c(new_n362_), .O(new_n363_));
  ...
  nand3  g204(.a(new_n160_), .b(new_n159_), .c(new_n153_), .O(new_n367_));
  nand3  g205(.a(new_n367_), .b(new_n366_), .c(new_n231_), .O(z56));
  inv1   g206(.a(x02), .O(new_n369_));
  nand3  g207(.a(new_n231_), .b(x03), .c(new_n369_), .O(new_n370_));
  inv1   g208(.a(new_n370_), .O(z57));
  nand4  g209(.a(x80), .b(new_n220_), .c(x43), .d(new_n238_), .O(new_n372_));
  oai22  g210(.a(new_n372_), .b(new_n219_), .c(new_n238_), .d(x40), .O(new_n373_));
  nand3  g211(.a(new_n373_), .b(new_n225_), .c(x79), .O(new_n374_));
  nor2   g212(.a(x79), .b(x78), .O(new_n375_));
  nand3  g213(.a(new_n375_), .b(new_n238_), .c(x40), .O(new_n376_));
  nand2  g214(.a(new_n376_), .b(new_n374_), .O(new_n377_));
  nand2  g215(.a(new_n377_), .b(x77), .O(new_n378_));
  oai21  g216(.a(new_n353_), .b(new_n228_), .c(new_n154_), .O(new_n379_));
  aoi21  g217(.a(new_n379_), .b(new_n378_), .c(x01), .O(z58));
  inv1   g218(.a(new_n375_), .O(new_n381_));
  aoi21  g219(.a(new_n224_), .b(new_n381_), .c(new_n152_), .O(new_n382_));
  oai21  g220(.a(new_n221_), .b(new_n219_), .c(new_n238_), .O(new_n383_));
  aoi21  g221(.a(new_n383_), .b(x79), .c(new_n224_), .O(new_n384_));
  ...
  aoi21  g226(.a(new_n363_), .b(x79), .c(new_n386_), .O(new_n389_));
  aoi21  g227(.a(new_n389_), .b(new_n226_), .c(x01), .O(z60));
  nand2  g228(.a(new_n213_), .b(new_n212_), .O(new_n391_));
  aoi22  g229(.a(new_n391_), .b(new_n215_), .c(new_n161_), .d(new_n228_), .O(new_n392_));
  nor2   g230(.a(new_n154_), .b(x01), .O(new_n393_));
  inv1   g231(.a(new_n393_), .O(new_n394_));
  nor3   g232(.a(new_n394_), .b(new_n392_), .c(new_n358_), .O(z61));
  nand3  g233(.a(x84), .b(x81), .c(x79), .O(new_n396_));
  oai21  g234(.a(x79), .b(new_n228_), .c(new_n396_), .O(new_n397_));
  nand2  g235(.a(new_n397_), .b(new_n159_), .O(new_n398_));
  nand2  g236(.a(new_n383_), .b(x79), .O(new_n399_));
  nand3  g237(.a(x81), .b(x79), .c(new_n228_), .O(new_n400_));
  ...
  nand2  g243(.a(new_n405_), .b(new_n308_), .O(new_n406_));
  aoi21  g244(.a(new_n406_), .b(new_n404_), .c(x01), .O(z62));
  nor3   g245(.a(new_n394_), .b(new_n392_), .c(new_n356_), .O(z63));
  nand2  g246(.a(x83), .b(x79), .O(new_n409_));
  or2    g247(.a(new_n409_), .b(new_n392_), .O(new_n410_));
  aoi21  g248(.a(new_n410_), .b(new_n304_), .c(x01), .O(z64));
  nor2   g249(.a(new_n160_), .b(x04), .O(new_n412_));
  nor2   g250(.a(new_n242_), .b(x78), .O(new_n413_));
  oai21  g251(.a(new_n413_), .b(new_n412_), .c(x77), .O(new_n414_));
  nand2  g252(.a(new_n353_), .b(x81), .O(new_n415_));
  nand2  g253(.a(new_n393_), .b(x84), .O(new_n416_));
