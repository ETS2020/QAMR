...
module FAU ( 
  ...
  nor3   g146(.a(new_n294_), .b(new_n285_), .c(new_n202_), .O(z39));
  nor3   g147(.a(new_n294_), .b(new_n285_), .c(new_n195_), .O(z42));
  nor3   g148(.a(new_n294_), .b(new_n285_), .c(new_n191_), .O(z44));
  nor3   g149(.a(new_n294_), .b(new_n285_), .c(new_n188_), .O(z45));
  nor3   g150(.a(new_n294_), .b(new_n285_), .c(new_n185_), .O(z46));
  ...
  inv1   g167(.a(new_n229_), .O(new_n327_));
  ...
  nand2  g196(.a(new_n284_), .b(x14), .O(new_n357_));
  ...
  nand3  g201(.a(new_n271_), .b(x84), .c(new_n361_), .O(new_n362_));
  ...
  nand3  g219(.a(new_n178_), .b(new_n246_), .c(x40), .O(new_n380_));
  ...
  aoi21  g224(.a(new_n163_), .b(new_n179_), .c(new_n152_), .O(new_n385_));
  ...
  nand3  g252(.a(new_n175_), .b(new_n159_), .c(x04), .O(new_n413_));
