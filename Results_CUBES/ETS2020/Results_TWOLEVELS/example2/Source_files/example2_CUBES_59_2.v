...
module FAU ( 
  ...
  wire new_n154_, new_n155_, new_n156_, new_n157_, new_n158_, new_n159_,
    ...
    new_n170_, new_n171_, new_n176_, new_n177_, new_n179_, new_n180_,
    ...
    new_n271_, new_n276_, new_n278_, new_n280_, new_n283_, new_n285_,
  ...
  oai21  g061(.a(new_n220_), .b(new_n219_), .c(new_n222_), .O(new_n223_));
  nand3  g062(.a(x79), .b(x78), .c(x77), .O(new_n224_));
  inv1   g063(.a(new_n224_), .O(new_n225_));
  inv1   g064(.a(x42), .O(new_n226_));
  nand3  g065(.a(new_n215_), .b(x44), .c(new_n226_), .O(new_n227_));
  inv1   g066(.a(new_n227_), .O(new_n228_));
  nand3  g067(.a(new_n228_), .b(new_n225_), .c(new_n223_), .O(new_n229_));
  inv1   g068(.a(new_n229_), .O(z26));
  nand3  g069(.a(new_n215_), .b(x45), .c(new_n226_), .O(new_n231_));
  inv1   g070(.a(new_n231_), .O(new_n232_));
  nand3  g071(.a(new_n232_), .b(new_n225_), .c(new_n223_), .O(new_n233_));
  inv1   g072(.a(new_n233_), .O(z27));
  nand3  g073(.a(new_n215_), .b(x46), .c(new_n226_), .O(new_n235_));
  inv1   g074(.a(new_n235_), .O(new_n236_));
  nand3  g075(.a(new_n236_), .b(new_n225_), .c(new_n223_), .O(new_n237_));
  inv1   g076(.a(new_n237_), .O(z28));
  nand3  g077(.a(new_n215_), .b(x48), .c(new_n226_), .O(new_n240_));
  inv1   g078(.a(new_n240_), .O(new_n241_));
  nand3  g079(.a(new_n241_), .b(new_n225_), .c(new_n223_), .O(new_n242_));
  inv1   g080(.a(new_n242_), .O(z30));
  nand3  g081(.a(new_n215_), .b(x49), .c(new_n226_), .O(new_n244_));
  inv1   g082(.a(new_n244_), .O(new_n245_));
  nand3  g083(.a(new_n245_), .b(new_n225_), .c(new_n223_), .O(new_n246_));
  inv1   g084(.a(new_n246_), .O(z31));
  inv1   g085(.a(new_n220_), .O(new_n249_));
  xnor2a g086(.a(x83), .b(x81), .O(new_n250_));
  nand2  g087(.a(x42), .b(x05), .O(new_n251_));
  nand2  g088(.a(x51), .b(new_n226_), .O(new_n252_));
  oai22  g089(.a(new_n252_), .b(new_n219_), .c(new_n251_), .d(new_n250_), .O(new_n253_));
  ...
  nand2  g093(.a(new_n256_), .b(new_n221_), .O(new_n257_));
  nand2  g094(.a(new_n225_), .b(new_n215_), .O(new_n258_));
  ...
  nand2  g098(.a(new_n261_), .b(new_n219_), .O(new_n262_));
  ...
  nand3  g102(.a(x83), .b(new_n219_), .c(x42), .O(new_n266_));
  aoi21  g103(.a(new_n266_), .b(new_n265_), .c(new_n220_), .O(new_n267_));
  oai21  g104(.a(new_n267_), .b(new_n264_), .c(new_n225_), .O(new_n268_));
  nand2  g105(.a(new_n215_), .b(x52), .O(new_n269_));
  nor2   g106(.a(new_n269_), .b(new_n268_), .O(z34));
  nand2  g107(.a(new_n215_), .b(x53), .O(new_n271_));
  nor2   g108(.a(new_n271_), .b(new_n268_), .O(z35));
  nand2  g109(.a(new_n215_), .b(x57), .O(new_n276_));
  nor2   g110(.a(new_n276_), .b(new_n268_), .O(z39));
  nand2  g111(.a(new_n215_), .b(x58), .O(new_n278_));
  nor2   g112(.a(new_n278_), .b(new_n268_), .O(z40));
  nand2  g113(.a(new_n215_), .b(x59), .O(new_n280_));
  nor2   g114(.a(new_n280_), .b(new_n268_), .O(z41));
  nand2  g115(.a(new_n215_), .b(x61), .O(new_n283_));
  nor2   g116(.a(new_n283_), .b(new_n268_), .O(z43));
  nand2  g117(.a(new_n215_), .b(x62), .O(new_n285_));
  nor2   g118(.a(new_n285_), .b(new_n268_), .O(z44));
  nand2  g119(.a(new_n215_), .b(x63), .O(new_n287_));
  nor2   g120(.a(new_n287_), .b(new_n268_), .O(z45));
  inv1   g121(.a(x07), .O(new_n290_));
  nand2  g122(.a(x52), .b(x15), .O(new_n291_));
  oai21  g123(.a(x52), .b(new_n290_), .c(new_n291_), .O(new_n292_));
  inv1   g124(.a(x04), .O(new_n293_));
  nor2   g125(.a(x77), .b(new_n293_), .O(new_n294_));
  nand3  g126(.a(new_n294_), .b(new_n292_), .c(new_n163_), .O(new_n295_));
  ...
  nand3  g134(.a(new_n302_), .b(new_n294_), .c(new_n163_), .O(new_n303_));
  nand4  g135(.a(new_n296_), .b(new_n158_), .c(x79), .d(x68), .O(new_n304_));
  aoi21  g136(.a(new_n304_), .b(new_n303_), .c(x01), .O(z48));
  inv1   g137(.a(x11), .O(new_n308_));
  nand2  g138(.a(x52), .b(x19), .O(new_n309_));
  oai21  g139(.a(x52), .b(new_n308_), .c(new_n309_), .O(new_n310_));
  nand3  g140(.a(new_n310_), .b(new_n294_), .c(new_n163_), .O(new_n311_));
  nand4  g141(.a(new_n296_), .b(new_n158_), .c(x79), .d(x71), .O(new_n312_));
  aoi21  g142(.a(new_n312_), .b(new_n311_), .c(x01), .O(z51));
  inv1   g143(.a(x12), .O(new_n314_));
  nand2  g144(.a(x52), .b(x20), .O(new_n315_));
  oai21  g145(.a(x52), .b(new_n314_), .c(new_n315_), .O(new_n316_));
  nand3  g146(.a(new_n316_), .b(new_n294_), .c(new_n163_), .O(new_n317_));
  nand4  g147(.a(new_n296_), .b(new_n158_), .c(x79), .d(x72), .O(new_n318_));
  ...
  nand3  g152(.a(new_n322_), .b(new_n294_), .c(new_n163_), .O(new_n323_));
  nand4  g153(.a(new_n296_), .b(new_n158_), .c(x79), .d(x73), .O(new_n324_));
  aoi21  g154(.a(new_n324_), .b(new_n323_), .c(x01), .O(z53));
  inv1   g155(.a(x82), .O(new_n327_));
  nand2  g156(.a(x84), .b(new_n327_), .O(new_n328_));
  nand2  g157(.a(x83), .b(new_n219_), .O(new_n329_));
  inv1   g158(.a(x80), .O(new_n330_));
  nand4  g159(.a(new_n215_), .b(new_n212_), .c(new_n330_), .d(x79), .O(new_n331_));
  nor3   g160(.a(new_n331_), .b(new_n329_), .c(new_n328_), .O(z55));
  inv1   g161(.a(x02), .O(new_n334_));
  nand4  g162(.a(x03), .b(new_n334_), .c(new_n160_), .d(x00), .O(new_n335_));
  inv1   g163(.a(new_n335_), .O(z57));
  oai21  g164(.a(new_n158_), .b(new_n155_), .c(new_n296_), .O(new_n342_));
  nand2  g165(.a(new_n212_), .b(new_n293_), .O(new_n343_));
  nand3  g166(.a(x82), .b(x79), .c(new_n160_), .O(new_n344_));
  aoi21  g167(.a(new_n343_), .b(new_n342_), .c(new_n344_), .O(z63));
  zero   g168(.O(z00));
  zero   g169(.O(z01));
  zero   g170(.O(z04));
  zero   g171(.O(z07));
