// Benchmark "FAU" written by ABC on Fri Jul 10 18:24:27 2020
...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n283_, new_n285_, new_n287_, new_n289_, new_n294_, new_n301_,
  ...
  nand2  g128(.a(new_n234_), .b(x56), .O(new_n289_));
  nor2   g129(.a(new_n289_), .b(new_n281_), .O(z38));
  nor3   g130(.a(new_n281_), .b(new_n272_), .c(new_n194_), .O(z40));
  nor3   g131(.a(new_n281_), .b(new_n272_), .c(new_n191_), .O(z41));
  nand2  g132(.a(new_n234_), .b(x60), .O(new_n294_));
  nor2   g133(.a(new_n294_), .b(new_n281_), .O(z42));
  nor3   g134(.a(new_n281_), .b(new_n272_), .c(new_n187_), .O(z43));
  nor3   g135(.a(new_n281_), .b(new_n272_), .c(new_n178_), .O(z46));
  inv1   g136(.a(x08), .O(new_n301_));
  nand2  g137(.a(x52), .b(x16), .O(new_n302_));
  oai21  g138(.a(x52), .b(new_n301_), .c(new_n302_), .O(new_n303_));
  nand3  g139(.a(new_n224_), .b(new_n154_), .c(new_n159_), .O(new_n304_));
  inv1   g140(.a(new_n304_), .O(new_n305_));
  nand2  g141(.a(new_n305_), .b(new_n303_), .O(new_n306_));
  inv1   g142(.a(new_n168_), .O(new_n307_));
  nand2  g143(.a(new_n307_), .b(x79), .O(new_n308_));
  inv1   g144(.a(new_n308_), .O(new_n309_));
  and2   g145(.a(new_n309_), .b(new_n214_), .O(new_n310_));
  nand2  g146(.a(new_n310_), .b(x68), .O(new_n311_));
  aoi21  g147(.a(new_n311_), .b(new_n306_), .c(x01), .O(z48));
  inv1   g148(.a(x09), .O(new_n313_));
  nand2  g149(.a(x52), .b(x17), .O(new_n314_));
  oai21  g150(.a(x52), .b(new_n313_), .c(new_n314_), .O(new_n315_));
  nand2  g151(.a(new_n315_), .b(new_n305_), .O(new_n316_));
  nand2  g152(.a(new_n310_), .b(x69), .O(new_n317_));
  aoi21  g153(.a(new_n317_), .b(new_n316_), .c(x01), .O(z49));
  inv1   g154(.a(x10), .O(new_n319_));
  nand2  g155(.a(x52), .b(x18), .O(new_n320_));
  oai21  g156(.a(x52), .b(new_n319_), .c(new_n320_), .O(new_n321_));
  nand2  g157(.a(new_n321_), .b(new_n305_), .O(new_n322_));
  nand2  g158(.a(new_n310_), .b(x70), .O(new_n323_));
  aoi21  g159(.a(new_n323_), .b(new_n322_), .c(x01), .O(z50));
  ...
  nand2  g167(.a(new_n271_), .b(x14), .O(new_n334_));
  ...
  nand3  g172(.a(new_n258_), .b(x84), .c(new_n338_), .O(new_n339_));
  inv1   g173(.a(x80), .O(new_n340_));
  nand4  g174(.a(new_n234_), .b(new_n161_), .c(new_n340_), .d(x79), .O(new_n341_));
  nor2   g175(.a(new_n341_), .b(new_n339_), .O(z55));
  nand2  g176(.a(new_n232_), .b(x76), .O(new_n343_));
  ...
  nand3  g183(.a(new_n349_), .b(new_n348_), .c(new_n230_), .O(z56));
  inv1   g184(.a(x02), .O(new_n351_));
  nand3  g185(.a(new_n230_), .b(x03), .c(new_n351_), .O(new_n352_));
  inv1   g186(.a(new_n352_), .O(z57));
  nand4  g187(.a(x80), .b(new_n219_), .c(x43), .d(new_n238_), .O(new_n354_));
  oai22  g188(.a(new_n354_), .b(new_n218_), .c(new_n238_), .d(x40), .O(new_n355_));
  nand3  g189(.a(new_n355_), .b(new_n224_), .c(x79), .O(new_n356_));
  ...
  oai21  g194(.a(new_n335_), .b(new_n227_), .c(new_n154_), .O(new_n361_));
  aoi21  g195(.a(new_n361_), .b(new_n360_), .c(x01), .O(z58));
  inv1   g196(.a(new_n357_), .O(new_n363_));
  aoi21  g197(.a(new_n223_), .b(new_n363_), .c(new_n152_), .O(new_n364_));
  oai21  g198(.a(new_n220_), .b(new_n218_), .c(new_n238_), .O(new_n365_));
  aoi21  g199(.a(new_n365_), .b(x79), .c(new_n223_), .O(new_n366_));
  ...
  aoi21  g205(.a(new_n371_), .b(new_n225_), .c(x01), .O(z60));
  inv1   g206(.a(new_n170_), .O(new_n373_));
  nand2  g207(.a(new_n168_), .b(new_n167_), .O(new_n374_));
  aoi22  g208(.a(new_n374_), .b(new_n214_), .c(new_n161_), .d(new_n227_), .O(new_n375_));
  nor3   g209(.a(new_n375_), .b(new_n373_), .c(new_n340_), .O(z61));
  nand3  g210(.a(x84), .b(x81), .c(x79), .O(new_n377_));
  oai21  g211(.a(x79), .b(new_n227_), .c(new_n377_), .O(new_n378_));
  nand2  g212(.a(new_n378_), .b(new_n159_), .O(new_n379_));
  nand2  g213(.a(new_n365_), .b(x79), .O(new_n380_));
  nand3  g214(.a(x81), .b(x79), .c(new_n227_), .O(new_n381_));
  inv1   g215(.a(new_n381_), .O(new_n382_));
  aoi21  g216(.a(new_n380_), .b(x04), .c(new_n382_), .O(new_n383_));
  oai21  g217(.a(new_n383_), .b(new_n159_), .c(new_n379_), .O(new_n384_));
  nand2  g218(.a(new_n384_), .b(x78), .O(new_n385_));
  inv1   g219(.a(new_n377_), .O(new_n386_));
  nand2  g220(.a(new_n386_), .b(new_n307_), .O(new_n387_));
  aoi21  g221(.a(new_n387_), .b(new_n385_), .c(x01), .O(z62));
  nor3   g222(.a(new_n375_), .b(new_n373_), .c(new_n338_), .O(z63));
  nand2  g223(.a(x83), .b(x79), .O(new_n390_));
  or2    g224(.a(new_n390_), .b(new_n375_), .O(new_n391_));
  aoi21  g225(.a(new_n391_), .b(new_n304_), .c(x01), .O(z64));
  nor2   g226(.a(new_n160_), .b(x04), .O(new_n393_));
  nor2   g227(.a(new_n242_), .b(x78), .O(new_n394_));
  oai21  g228(.a(new_n394_), .b(new_n393_), .c(x77), .O(new_n395_));
  nand2  g229(.a(new_n335_), .b(x81), .O(new_n396_));
  nand2  g230(.a(new_n170_), .b(x84), .O(new_n397_));
  aoi21  g231(.a(new_n396_), .b(new_n395_), .c(new_n397_), .O(z65));
  zero   g232(.O(z10));
  zero   g233(.O(z13));
  zero   g234(.O(z15));
  zero   g235(.O(z17));
