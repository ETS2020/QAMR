...
module FAU ( 
  ...
  wire new_n154_, new_n155_, new_n156_, new_n157_, new_n158_, new_n159_,
    ...
    new_n242_, new_n245_, new_n246_, new_n247_, new_n251_, new_n252_,
    new_n253_, new_n254_, new_n255_, new_n256_, new_n257_, new_n258_,
    new_n259_, new_n260_, new_n262_, new_n264_, new_n266_, new_n268_,
    new_n270_, new_n273_, new_n275_, new_n278_, new_n281_, new_n282_,
  ...
  nand3  g080(.a(new_n212_), .b(x50), .c(new_n222_), .O(new_n245_));
  inv1   g081(.a(new_n245_), .O(new_n246_));
  nand3  g082(.a(new_n246_), .b(new_n221_), .c(new_n219_), .O(new_n247_));
  ...
  nand3  g090(.a(x83), .b(new_n215_), .c(x42), .O(new_n257_));
  aoi21  g091(.a(new_n257_), .b(new_n256_), .c(new_n216_), .O(new_n258_));
  oai21  g092(.a(new_n258_), .b(new_n255_), .c(new_n221_), .O(new_n259_));
  nand2  g093(.a(new_n212_), .b(x53), .O(new_n260_));
  nor2   g094(.a(new_n260_), .b(new_n259_), .O(z35));
  nand2  g095(.a(new_n212_), .b(x54), .O(new_n262_));
  nor2   g096(.a(new_n262_), .b(new_n259_), .O(z36));
  nand2  g097(.a(new_n212_), .b(x55), .O(new_n264_));
  nor2   g098(.a(new_n264_), .b(new_n259_), .O(z37));
  nand2  g099(.a(new_n212_), .b(x56), .O(new_n266_));
  nor2   g100(.a(new_n266_), .b(new_n259_), .O(z38));
  nand2  g101(.a(new_n212_), .b(x57), .O(new_n268_));
  nor2   g102(.a(new_n268_), .b(new_n259_), .O(z39));
  nand2  g103(.a(new_n212_), .b(x58), .O(new_n270_));
  nor2   g104(.a(new_n270_), .b(new_n259_), .O(z40));
  nand2  g105(.a(new_n212_), .b(x60), .O(new_n273_));
  nor2   g106(.a(new_n273_), .b(new_n259_), .O(z42));
  nand2  g107(.a(new_n212_), .b(x61), .O(new_n275_));
  nor2   g108(.a(new_n275_), .b(new_n259_), .O(z43));
  nand2  g109(.a(new_n212_), .b(x63), .O(new_n278_));
  nor2   g110(.a(new_n278_), .b(new_n259_), .O(z45));
  inv1   g111(.a(x07), .O(new_n281_));
  nand2  g112(.a(x52), .b(x15), .O(new_n282_));
  oai21  g113(.a(x52), .b(new_n281_), .c(new_n282_), .O(new_n283_));
  nand4  g114(.a(new_n208_), .b(x78), .c(new_n157_), .d(x04), .O(new_n284_));
  inv1   g115(.a(new_n284_), .O(new_n285_));
  nand2  g116(.a(new_n285_), .b(new_n283_), .O(new_n286_));
  ...
  nand2  g122(.a(x52), .b(x19), .O(new_n295_));
  oai21  g123(.a(x52), .b(new_n294_), .c(new_n295_), .O(new_n296_));
  nand2  g124(.a(new_n296_), .b(new_n285_), .O(new_n297_));
  nand4  g125(.a(new_n287_), .b(new_n158_), .c(x79), .d(x71), .O(new_n298_));
  aoi21  g126(.a(new_n298_), .b(new_n297_), .c(x01), .O(z51));
  inv1   g127(.a(x12), .O(new_n300_));
  nand2  g128(.a(x52), .b(x20), .O(new_n301_));
  oai21  g129(.a(x52), .b(new_n300_), .c(new_n301_), .O(new_n302_));
  nand2  g130(.a(new_n302_), .b(new_n285_), .O(new_n303_));
  nand4  g131(.a(new_n287_), .b(new_n158_), .c(x79), .d(x72), .O(new_n304_));
  aoi21  g132(.a(new_n304_), .b(new_n303_), .c(x01), .O(z52));
  inv1   g133(.a(x13), .O(new_n306_));
  nand2  g134(.a(x52), .b(x21), .O(new_n307_));
  oai21  g135(.a(x52), .b(new_n306_), .c(new_n307_), .O(new_n308_));
  nand2  g136(.a(new_n308_), .b(new_n285_), .O(new_n309_));
  nand4  g137(.a(new_n287_), .b(new_n158_), .c(x79), .d(x73), .O(new_n310_));
  aoi21  g138(.a(new_n310_), .b(new_n309_), .c(x01), .O(z53));
  inv1   g139(.a(x14), .O(new_n312_));
  nor2   g140(.a(x52), .b(new_n312_), .O(new_n313_));
  aoi21  g141(.a(x52), .b(x22), .c(new_n313_), .O(new_n314_));
  nand4  g142(.a(new_n155_), .b(new_n208_), .c(x04), .d(new_n160_), .O(new_n315_));
  nor2   g143(.a(new_n315_), .b(new_n314_), .O(z54));
  inv1   g144(.a(x02), .O(new_n319_));
  nand4  g145(.a(x03), .b(new_n319_), .c(new_n160_), .d(x00), .O(new_n320_));
  inv1   g146(.a(new_n320_), .O(z57));
  oai21  g147(.a(new_n158_), .b(new_n155_), .c(new_n287_), .O(new_n327_));
  inv1   g148(.a(x04), .O(new_n328_));
  nand2  g149(.a(new_n209_), .b(new_n328_), .O(new_n329_));
  nand3  g150(.a(x82), .b(x79), .c(new_n160_), .O(new_n330_));
  aoi21  g151(.a(new_n329_), .b(new_n327_), .c(new_n330_), .O(z63));
  zero   g152(.O(z00));
  zero   g153(.O(z01));
  zero   g154(.O(z03));
  zero   g155(.O(z04));
