...
module FAU ( 
  ...
  nand2  g142(.a(new_n255_), .b(x54), .O(new_n298_));
  ...
  nor3   g148(.a(new_n294_), .b(new_n285_), .c(new_n204_), .O(z39));
  nor3   g149(.a(new_n294_), .b(new_n285_), .c(new_n201_), .O(z40));
  nor3   g150(.a(new_n294_), .b(new_n285_), .c(new_n198_), .O(z41));
  nor3   g151(.a(new_n294_), .b(new_n285_), .c(new_n195_), .O(z42));
  nor3   g152(.a(new_n294_), .b(new_n285_), .c(new_n192_), .O(z43));
  nor3   g153(.a(new_n294_), .b(new_n285_), .c(new_n189_), .O(z44));
  nor3   g154(.a(new_n294_), .b(new_n285_), .c(new_n186_), .O(z45));
  ...
  nand2  g170(.a(new_n327_), .b(new_n316_), .O(new_n328_));
  ...
  nand2  g178(.a(new_n335_), .b(new_n316_), .O(new_n336_));
  nand2  g179(.a(new_n330_), .b(x70), .O(new_n337_));
  ...
  nand2  g184(.a(new_n342_), .b(new_n316_), .O(new_n343_));
  ...
  nand3  g199(.a(new_n271_), .b(x84), .c(new_n357_), .O(new_n358_));
  inv1   g200(.a(x80), .O(new_n359_));
  nand4  g201(.a(new_n255_), .b(new_n165_), .c(new_n359_), .d(x79), .O(new_n360_));
  nor2   g202(.a(new_n360_), .b(new_n358_), .O(z55));
  inv1   g203(.a(x76), .O(new_n362_));
  nor2   g204(.a(new_n165_), .b(new_n362_), .O(new_n363_));
  xnor2a g205(.a(x84), .b(x81), .O(new_n364_));
  aoi21  g206(.a(new_n171_), .b(new_n170_), .c(new_n364_), .O(new_n365_));
  aoi21  g207(.a(new_n365_), .b(new_n153_), .c(new_n363_), .O(new_n366_));
  nor2   g208(.a(x77), .b(x01), .O(new_n367_));
  aoi21  g209(.a(new_n367_), .b(new_n164_), .c(new_n242_), .O(new_n368_));
  oai21  g210(.a(new_n366_), .b(new_n154_), .c(new_n368_), .O(z56));
  inv1   g211(.a(x02), .O(new_n370_));
  nand3  g212(.a(new_n243_), .b(x03), .c(new_n370_), .O(new_n371_));
  inv1   g213(.a(new_n371_), .O(z57));
  nand4  g214(.a(x80), .b(new_n235_), .c(x43), .d(new_n246_), .O(new_n373_));
  oai22  g215(.a(new_n373_), .b(new_n234_), .c(new_n246_), .d(x40), .O(new_n374_));
  nand3  g216(.a(new_n374_), .b(new_n232_), .c(x79), .O(new_n375_));
  nand3  g217(.a(new_n176_), .b(new_n246_), .c(x40), .O(new_n376_));
  nand2  g218(.a(new_n376_), .b(new_n375_), .O(new_n377_));
  nand2  g219(.a(new_n377_), .b(x77), .O(new_n378_));
  oai21  g220(.a(new_n354_), .b(new_n160_), .c(new_n154_), .O(new_n379_));
  aoi21  g221(.a(new_n379_), .b(new_n378_), .c(x01), .O(z58));
  aoi21  g222(.a(new_n163_), .b(new_n177_), .c(new_n152_), .O(new_n381_));
  oai21  g223(.a(new_n236_), .b(new_n234_), .c(new_n246_), .O(new_n382_));
  aoi21  g224(.a(new_n382_), .b(x79), .c(new_n163_), .O(new_n383_));
  oai21  g225(.a(new_n383_), .b(new_n381_), .c(x77), .O(new_n384_));
  nor2   g226(.a(x79), .b(x04), .O(new_n385_));
  inv1   g227(.a(new_n385_), .O(new_n386_));
  aoi21  g228(.a(new_n386_), .b(new_n384_), .c(x01), .O(z59));
  aoi21  g229(.a(new_n365_), .b(x79), .c(new_n385_), .O(new_n388_));
  aoi21  g230(.a(new_n388_), .b(new_n239_), .c(x01), .O(z60));
  inv1   g231(.a(new_n173_), .O(new_n390_));
  nand2  g232(.a(new_n171_), .b(new_n170_), .O(new_n391_));
  aoi22  g233(.a(new_n391_), .b(new_n229_), .c(new_n165_), .d(new_n160_), .O(new_n392_));
  nor3   g234(.a(new_n392_), .b(new_n390_), .c(new_n359_), .O(z61));
  nand3  g235(.a(x84), .b(x81), .c(x79), .O(new_n394_));
  oai21  g236(.a(x79), .b(new_n160_), .c(new_n394_), .O(new_n395_));
  nand2  g237(.a(new_n395_), .b(new_n159_), .O(new_n396_));
  nand2  g238(.a(new_n382_), .b(x79), .O(new_n397_));
  nand3  g239(.a(x81), .b(x79), .c(new_n160_), .O(new_n398_));
  inv1   g240(.a(new_n398_), .O(new_n399_));
  aoi21  g241(.a(new_n397_), .b(x04), .c(new_n399_), .O(new_n400_));
  oai21  g242(.a(new_n400_), .b(new_n159_), .c(new_n396_), .O(new_n401_));
  nand2  g243(.a(new_n401_), .b(x78), .O(new_n402_));
  inv1   g244(.a(new_n394_), .O(new_n403_));
  nand2  g245(.a(new_n403_), .b(new_n319_), .O(new_n404_));
  aoi21  g246(.a(new_n404_), .b(new_n402_), .c(x01), .O(z62));
  nor3   g247(.a(new_n392_), .b(new_n390_), .c(new_n357_), .O(z63));
  nand2  g248(.a(x83), .b(x79), .O(new_n407_));
  or2    g249(.a(new_n407_), .b(new_n392_), .O(new_n408_));
  ...
  nor2   g253(.a(new_n250_), .b(x78), .O(new_n412_));
  oai21  g254(.a(new_n412_), .b(new_n411_), .c(x77), .O(new_n413_));
  nand2  g255(.a(new_n354_), .b(x81), .O(new_n414_));
