...
module FAU ( 
  ...
  nand4  g097(.a(new_n245_), .b(new_n235_), .c(x49), .d(new_n238_), .O(new_n256_));
  ...
  nor3   g132(.a(new_n283_), .b(new_n274_), .c(new_n191_), .O(z39));
  nor3   g133(.a(new_n283_), .b(new_n274_), .c(new_n188_), .O(z40));
  nor3   g134(.a(new_n283_), .b(new_n274_), .c(new_n185_), .O(z41));
  nor3   g135(.a(new_n283_), .b(new_n274_), .c(new_n182_), .O(z42));
  nor3   g136(.a(new_n283_), .b(new_n274_), .c(new_n179_), .O(z43));
  nor3   g137(.a(new_n283_), .b(new_n274_), .c(new_n173_), .O(z45));
  inv1   g138(.a(x08), .O(new_n301_));
  nand2  g139(.a(x52), .b(x16), .O(new_n302_));
  ...
  inv1   g145(.a(new_n215_), .O(new_n308_));
  nand2  g146(.a(new_n308_), .b(x79), .O(new_n309_));
  inv1   g147(.a(new_n309_), .O(new_n310_));
  and2   g148(.a(new_n310_), .b(new_n217_), .O(new_n311_));
  nand2  g149(.a(new_n311_), .b(x68), .O(new_n312_));
  aoi21  g150(.a(new_n312_), .b(new_n307_), .c(x01), .O(z48));
  inv1   g151(.a(x10), .O(new_n315_));
  nand2  g152(.a(x52), .b(x18), .O(new_n316_));
  oai21  g153(.a(x52), .b(new_n315_), .c(new_n316_), .O(new_n317_));
  nand2  g154(.a(new_n317_), .b(new_n306_), .O(new_n318_));
  nand2  g155(.a(new_n311_), .b(x70), .O(new_n319_));
  aoi21  g156(.a(new_n319_), .b(new_n318_), .c(x01), .O(z50));
  inv1   g157(.a(x11), .O(new_n321_));
  nand2  g158(.a(x52), .b(x19), .O(new_n322_));
  oai21  g159(.a(x52), .b(new_n321_), .c(new_n322_), .O(new_n323_));
  nand2  g160(.a(new_n323_), .b(new_n306_), .O(new_n324_));
  nand2  g161(.a(new_n311_), .b(x71), .O(new_n325_));
  aoi21  g162(.a(new_n325_), .b(new_n324_), .c(x01), .O(z51));
  inv1   g163(.a(x12), .O(new_n327_));
  nand2  g164(.a(x52), .b(x20), .O(new_n328_));
  oai21  g165(.a(x52), .b(new_n327_), .c(new_n328_), .O(new_n329_));
  nand2  g166(.a(new_n329_), .b(new_n306_), .O(new_n330_));
  nand2  g167(.a(new_n311_), .b(x72), .O(new_n331_));
  aoi21  g168(.a(new_n331_), .b(new_n330_), .c(x01), .O(z52));
  inv1   g169(.a(x13), .O(new_n333_));
  nand2  g170(.a(x52), .b(x21), .O(new_n334_));
  oai21  g171(.a(x52), .b(new_n333_), .c(new_n334_), .O(new_n335_));
  nand2  g172(.a(new_n335_), .b(new_n306_), .O(new_n336_));
  nand2  g173(.a(new_n311_), .b(x73), .O(new_n337_));
  aoi21  g174(.a(new_n337_), .b(new_n336_), .c(x01), .O(z53));
  nand2  g175(.a(x52), .b(x22), .O(new_n339_));
  nand2  g176(.a(new_n273_), .b(x14), .O(new_n340_));
  inv1   g177(.a(new_n214_), .O(new_n341_));
  nand4  g178(.a(new_n341_), .b(new_n154_), .c(x04), .d(new_n153_), .O(new_n342_));
  aoi21  g179(.a(new_n340_), .b(new_n339_), .c(new_n342_), .O(z54));
  inv1   g180(.a(x82), .O(new_n344_));
  nand3  g181(.a(new_n260_), .b(x84), .c(new_n344_), .O(new_n345_));
  nor2   g182(.a(x80), .b(new_n154_), .O(new_n346_));
  nand3  g183(.a(new_n346_), .b(new_n235_), .c(new_n161_), .O(new_n347_));
  nor2   g184(.a(new_n347_), .b(new_n345_), .O(z55));
  nand2  g185(.a(new_n160_), .b(new_n159_), .O(new_n349_));
  nand2  g186(.a(new_n233_), .b(x76), .O(new_n350_));
  xnor2a g187(.a(x84), .b(x81), .O(new_n351_));
  aoi21  g188(.a(new_n215_), .b(new_n214_), .c(new_n351_), .O(new_n352_));
  nand2  g189(.a(new_n352_), .b(new_n153_), .O(new_n353_));
  nand2  g190(.a(new_n353_), .b(new_n350_), .O(new_n354_));
  nand2  g191(.a(new_n354_), .b(x79), .O(new_n355_));
  nand4  g192(.a(new_n355_), .b(new_n349_), .c(new_n153_), .d(x00), .O(z56));
  nand4  g193(.a(x80), .b(new_n222_), .c(x43), .d(new_n238_), .O(new_n358_));
  oai22  g194(.a(new_n358_), .b(new_n221_), .c(new_n238_), .d(x40), .O(new_n359_));
  nand3  g195(.a(new_n359_), .b(new_n227_), .c(x79), .O(new_n360_));
  nor2   g196(.a(x79), .b(x78), .O(new_n361_));
  nand3  g197(.a(new_n361_), .b(new_n238_), .c(x40), .O(new_n362_));
  nand2  g198(.a(new_n362_), .b(new_n360_), .O(new_n363_));
  nand2  g199(.a(new_n363_), .b(x77), .O(new_n364_));
  oai21  g200(.a(new_n341_), .b(new_n230_), .c(new_n154_), .O(new_n365_));
  aoi21  g201(.a(new_n365_), .b(new_n364_), .c(x01), .O(z58));
  inv1   g202(.a(new_n361_), .O(new_n367_));
  aoi21  g203(.a(new_n226_), .b(new_n367_), .c(new_n152_), .O(new_n368_));
  oai21  g204(.a(new_n223_), .b(new_n221_), .c(new_n238_), .O(new_n369_));
  aoi21  g205(.a(new_n369_), .b(x79), .c(new_n226_), .O(new_n370_));
  oai21  g206(.a(new_n370_), .b(new_n368_), .c(x77), .O(new_n371_));
  nor2   g207(.a(x79), .b(x04), .O(new_n372_));
  inv1   g208(.a(new_n372_), .O(new_n373_));
  aoi21  g209(.a(new_n373_), .b(new_n371_), .c(x01), .O(z59));
  aoi21  g210(.a(new_n352_), .b(x79), .c(new_n372_), .O(new_n375_));
  aoi21  g211(.a(new_n375_), .b(new_n228_), .c(x01), .O(z60));
  nand3  g212(.a(x84), .b(x81), .c(x79), .O(new_n378_));
  oai21  g213(.a(x79), .b(new_n230_), .c(new_n378_), .O(new_n379_));
  nand2  g214(.a(new_n379_), .b(new_n159_), .O(new_n380_));
  nand2  g215(.a(new_n369_), .b(x79), .O(new_n381_));
  nand3  g216(.a(x81), .b(x79), .c(new_n230_), .O(new_n382_));
  ...
  nand2  g222(.a(new_n387_), .b(new_n308_), .O(new_n388_));
  aoi21  g223(.a(new_n388_), .b(new_n386_), .c(x01), .O(z62));
  oai21  g224(.a(new_n308_), .b(new_n341_), .c(new_n217_), .O(new_n390_));
  oai21  g225(.a(new_n233_), .b(x04), .c(new_n390_), .O(new_n391_));
  nand3  g226(.a(x82), .b(x79), .c(new_n153_), .O(new_n392_));
  inv1   g227(.a(new_n392_), .O(new_n393_));
  and2   g228(.a(new_n393_), .b(new_n391_), .O(z63));
  nand3  g229(.a(new_n391_), .b(x83), .c(x79), .O(new_n395_));
  aoi21  g230(.a(new_n395_), .b(new_n305_), .c(x01), .O(z64));
  nor2   g231(.a(new_n160_), .b(x04), .O(new_n397_));
  nor2   g232(.a(new_n242_), .b(x78), .O(new_n398_));
  oai21  g233(.a(new_n398_), .b(new_n397_), .c(x77), .O(new_n399_));
  nand2  g234(.a(new_n341_), .b(x81), .O(new_n400_));
  nand3  g235(.a(x84), .b(x79), .c(new_n153_), .O(new_n401_));
  aoi21  g236(.a(new_n400_), .b(new_n399_), .c(new_n401_), .O(z65));
  zero   g237(.O(z02));
  zero   g238(.O(z05));
  zero   g239(.O(z17));
  zero   g240(.O(z19));
