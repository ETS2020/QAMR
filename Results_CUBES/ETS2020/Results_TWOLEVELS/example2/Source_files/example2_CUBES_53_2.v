...
module FAU ( 
  ...
  wire new_n154_, new_n155_, new_n156_, new_n157_, new_n158_, new_n159_,
    ...
    new_n234_, new_n236_, new_n237_, new_n238_, new_n244_, new_n245_,
    new_n246_, new_n247_, new_n248_, new_n249_, new_n250_, new_n251_,
    new_n252_, new_n253_, new_n258_, new_n260_, new_n262_, new_n266_,
  ...
  xnor2a g077(.a(x84), .b(x82), .O(new_n244_));
  nand2  g078(.a(x83), .b(x42), .O(new_n245_));
  nand2  g079(.a(new_n245_), .b(new_n212_), .O(new_n246_));
  nand3  g080(.a(x83), .b(x81), .c(x42), .O(new_n247_));
  aoi21  g081(.a(new_n247_), .b(new_n246_), .c(new_n244_), .O(new_n248_));
  nand2  g082(.a(new_n245_), .b(x81), .O(new_n249_));
  nand3  g083(.a(x83), .b(new_n212_), .c(x42), .O(new_n250_));
  aoi21  g084(.a(new_n250_), .b(new_n249_), .c(new_n213_), .O(new_n251_));
  oai21  g085(.a(new_n251_), .b(new_n248_), .c(new_n218_), .O(new_n252_));
  nand2  g086(.a(new_n209_), .b(x52), .O(new_n253_));
  nor2   g087(.a(new_n253_), .b(new_n252_), .O(z34));
  nand2  g088(.a(new_n209_), .b(x56), .O(new_n258_));
  nor2   g089(.a(new_n258_), .b(new_n252_), .O(z38));
  nand2  g090(.a(new_n209_), .b(x57), .O(new_n260_));
  nor2   g091(.a(new_n260_), .b(new_n252_), .O(z39));
  nand2  g092(.a(new_n209_), .b(x58), .O(new_n262_));
  nor2   g093(.a(new_n262_), .b(new_n252_), .O(z40));
  nand2  g094(.a(new_n209_), .b(x61), .O(new_n266_));
  nor2   g095(.a(new_n266_), .b(new_n252_), .O(z43));
  nand2  g096(.a(new_n209_), .b(x62), .O(new_n268_));
  nor2   g097(.a(new_n268_), .b(new_n252_), .O(z44));
  nand2  g098(.a(new_n209_), .b(x63), .O(new_n270_));
  nor2   g099(.a(new_n270_), .b(new_n252_), .O(z45));
  inv1   g100(.a(x07), .O(new_n273_));
  nand2  g101(.a(x52), .b(x15), .O(new_n274_));
  oai21  g102(.a(x52), .b(new_n273_), .c(new_n274_), .O(new_n275_));
  inv1   g103(.a(x04), .O(new_n276_));
  nor2   g104(.a(x77), .b(new_n276_), .O(new_n277_));
  nor2   g105(.a(x79), .b(new_n156_), .O(new_n278_));
  nand3  g106(.a(new_n278_), .b(new_n277_), .c(new_n275_), .O(new_n279_));
  xnor2a g107(.a(x84), .b(x81), .O(new_n280_));
  or2    g108(.a(x75), .b(x67), .O(new_n281_));
  nor2   g109(.a(x78), .b(new_n154_), .O(new_n282_));
  nand4  g110(.a(new_n282_), .b(new_n281_), .c(new_n280_), .d(x79), .O(new_n283_));
  aoi21  g111(.a(new_n283_), .b(new_n279_), .c(x01), .O(z47));
  inv1   g112(.a(x09), .O(new_n286_));
  nand2  g113(.a(x52), .b(x17), .O(new_n287_));
  oai21  g114(.a(x52), .b(new_n286_), .c(new_n287_), .O(new_n288_));
  nand3  g115(.a(new_n288_), .b(new_n278_), .c(new_n277_), .O(new_n289_));
  nand4  g116(.a(new_n282_), .b(new_n280_), .c(x79), .d(x69), .O(new_n290_));
  aoi21  g117(.a(new_n290_), .b(new_n289_), .c(x01), .O(z49));
  inv1   g118(.a(x10), .O(new_n292_));
  nand2  g119(.a(x52), .b(x18), .O(new_n293_));
  oai21  g120(.a(x52), .b(new_n292_), .c(new_n293_), .O(new_n294_));
  nand3  g121(.a(new_n294_), .b(new_n278_), .c(new_n277_), .O(new_n295_));
  nand4  g122(.a(new_n282_), .b(new_n280_), .c(x79), .d(x70), .O(new_n296_));
  aoi21  g123(.a(new_n296_), .b(new_n295_), .c(x01), .O(z50));
  inv1   g124(.a(x11), .O(new_n298_));
  nand2  g125(.a(x52), .b(x19), .O(new_n299_));
  oai21  g126(.a(x52), .b(new_n298_), .c(new_n299_), .O(new_n300_));
  nand3  g127(.a(new_n300_), .b(new_n278_), .c(new_n277_), .O(new_n301_));
  nand4  g128(.a(new_n282_), .b(new_n280_), .c(x79), .d(x71), .O(new_n302_));
  aoi21  g129(.a(new_n302_), .b(new_n301_), .c(x01), .O(z51));
  inv1   g130(.a(x12), .O(new_n304_));
  nand2  g131(.a(x52), .b(x20), .O(new_n305_));
  oai21  g132(.a(x52), .b(new_n304_), .c(new_n305_), .O(new_n306_));
  nand3  g133(.a(new_n306_), .b(new_n278_), .c(new_n277_), .O(new_n307_));
  nand4  g134(.a(new_n282_), .b(new_n280_), .c(x79), .d(x72), .O(new_n308_));
  aoi21  g135(.a(new_n308_), .b(new_n307_), .c(x01), .O(z52));
  inv1   g136(.a(x13), .O(new_n310_));
  nand2  g137(.a(x52), .b(x21), .O(new_n311_));
  oai21  g138(.a(x52), .b(new_n310_), .c(new_n311_), .O(new_n312_));
  nand3  g139(.a(new_n312_), .b(new_n278_), .c(new_n277_), .O(new_n313_));
  nand4  g140(.a(new_n282_), .b(new_n280_), .c(x79), .d(x73), .O(new_n314_));
  aoi21  g141(.a(new_n314_), .b(new_n313_), .c(x01), .O(z53));
  inv1   g142(.a(x14), .O(new_n316_));
  nor2   g143(.a(x52), .b(new_n316_), .O(new_n317_));
  aoi21  g144(.a(x52), .b(x22), .c(new_n317_), .O(new_n318_));
  nor2   g145(.a(new_n276_), .b(x01), .O(new_n319_));
  nand4  g146(.a(new_n319_), .b(new_n206_), .c(x78), .d(new_n154_), .O(new_n320_));
  nor2   g147(.a(new_n320_), .b(new_n318_), .O(z54));
  inv1   g148(.a(x02), .O(new_n324_));
  nand4  g149(.a(x03), .b(new_n324_), .c(new_n158_), .d(x00), .O(new_n325_));
  inv1   g150(.a(new_n325_), .O(z57));
  zero   g151(.O(z00));
  zero   g152(.O(z01));
  zero   g153(.O(z03));
  zero   g154(.O(z04));
