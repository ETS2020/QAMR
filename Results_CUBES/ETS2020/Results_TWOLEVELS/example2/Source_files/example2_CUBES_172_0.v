// Benchmark "FAU" written by ABC on Fri Jul 10 18:21:50 2020
...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n190_, new_n191_, new_n193_, new_n194_, new_n200_, new_n201_,
    ...
    new_n246_, new_n248_, new_n250_, new_n253_, new_n255_, new_n256_,
  ...
  nand2  g102(.a(new_n229_), .b(new_n263_), .O(new_n264_));
  aoi21  g103(.a(new_n262_), .b(new_n259_), .c(new_n264_), .O(z33));
  inv1   g104(.a(x52), .O(new_n266_));
  inv1   g105(.a(new_n229_), .O(new_n267_));
  ...
  nand3  g112(.a(x83), .b(new_n236_), .c(x42), .O(new_n274_));
  ...
  nand2  g116(.a(new_n229_), .b(x53), .O(new_n278_));
  nor2   g117(.a(new_n278_), .b(new_n276_), .O(z35));
  nand2  g118(.a(new_n229_), .b(x54), .O(new_n280_));
  nor2   g119(.a(new_n280_), .b(new_n276_), .O(z36));
  nand2  g120(.a(new_n229_), .b(x55), .O(new_n282_));
  nor2   g121(.a(new_n282_), .b(new_n276_), .O(z37));
  nand2  g122(.a(new_n229_), .b(x58), .O(new_n286_));
  nor2   g123(.a(new_n286_), .b(new_n276_), .O(z40));
  nand2  g124(.a(new_n229_), .b(x59), .O(new_n288_));
  nor2   g125(.a(new_n288_), .b(new_n276_), .O(z41));
  nor3   g126(.a(new_n276_), .b(new_n267_), .c(new_n179_), .O(z43));
  nor3   g127(.a(new_n276_), .b(new_n267_), .c(new_n172_), .O(z46));
  ...
  inv1   g145(.a(new_n209_), .O(new_n312_));
  ...
  inv1   g167(.a(x13), .O(new_n335_));
  nand2  g168(.a(x52), .b(x21), .O(new_n336_));
  oai21  g169(.a(x52), .b(new_n335_), .c(new_n336_), .O(new_n337_));
  nand2  g170(.a(new_n337_), .b(new_n300_), .O(new_n338_));
  nand2  g171(.a(new_n313_), .b(x73), .O(new_n339_));
  aoi21  g172(.a(new_n339_), .b(new_n338_), .c(x01), .O(z53));
  nand2  g173(.a(x52), .b(x22), .O(new_n341_));
  nand2  g174(.a(new_n266_), .b(x14), .O(new_n342_));
  inv1   g175(.a(new_n206_), .O(new_n343_));
  nand4  g176(.a(new_n343_), .b(new_n154_), .c(x04), .d(new_n153_), .O(new_n344_));
  aoi21  g177(.a(new_n342_), .b(new_n341_), .c(new_n344_), .O(z54));
  nand2  g178(.a(new_n227_), .b(x76), .O(new_n347_));
  xnor2a g179(.a(x84), .b(x81), .O(new_n348_));
  aoi21  g180(.a(new_n207_), .b(new_n206_), .c(new_n348_), .O(new_n349_));
  nand2  g181(.a(new_n349_), .b(new_n153_), .O(new_n350_));
  nand2  g182(.a(new_n350_), .b(new_n347_), .O(new_n351_));
  nand2  g183(.a(new_n351_), .b(x79), .O(new_n352_));
  nand3  g184(.a(new_n160_), .b(new_n159_), .c(new_n153_), .O(new_n353_));
  nand3  g185(.a(new_n353_), .b(new_n352_), .c(new_n225_), .O(z56));
  inv1   g186(.a(x02), .O(new_n355_));
  nand3  g187(.a(new_n225_), .b(x03), .c(new_n355_), .O(new_n356_));
  inv1   g188(.a(new_n356_), .O(z57));
  nand4  g189(.a(x80), .b(new_n214_), .c(x43), .d(new_n232_), .O(new_n358_));
  oai22  g190(.a(new_n358_), .b(new_n213_), .c(new_n232_), .d(x40), .O(new_n359_));
  nand3  g191(.a(new_n359_), .b(new_n219_), .c(x79), .O(new_n360_));
  nor2   g192(.a(x79), .b(x78), .O(new_n361_));
  nand3  g193(.a(new_n361_), .b(new_n232_), .c(x40), .O(new_n362_));
  nand2  g194(.a(new_n362_), .b(new_n360_), .O(new_n363_));
  nand2  g195(.a(new_n363_), .b(x77), .O(new_n364_));
  oai21  g196(.a(new_n343_), .b(new_n222_), .c(new_n154_), .O(new_n365_));
  aoi21  g197(.a(new_n365_), .b(new_n364_), .c(x01), .O(z58));
  inv1   g198(.a(new_n361_), .O(new_n367_));
  aoi21  g199(.a(new_n218_), .b(new_n367_), .c(new_n152_), .O(new_n368_));
  oai21  g200(.a(new_n215_), .b(new_n213_), .c(new_n232_), .O(new_n369_));
  aoi21  g201(.a(new_n369_), .b(x79), .c(new_n218_), .O(new_n370_));
  oai21  g202(.a(new_n370_), .b(new_n368_), .c(x77), .O(new_n371_));
  nor2   g203(.a(x79), .b(x04), .O(new_n372_));
  inv1   g204(.a(new_n372_), .O(new_n373_));
  aoi21  g205(.a(new_n373_), .b(new_n371_), .c(x01), .O(z59));
  aoi21  g206(.a(new_n349_), .b(x79), .c(new_n372_), .O(new_n375_));
  aoi21  g207(.a(new_n375_), .b(new_n220_), .c(x01), .O(z60));
  nand2  g208(.a(new_n207_), .b(new_n206_), .O(new_n377_));
  aoi22  g209(.a(new_n377_), .b(new_n209_), .c(new_n161_), .d(new_n222_), .O(new_n378_));
  nor2   g210(.a(new_n154_), .b(x01), .O(new_n379_));
  nand2  g211(.a(new_n379_), .b(x80), .O(new_n380_));
  nor2   g212(.a(new_n380_), .b(new_n378_), .O(z61));
  nand3  g213(.a(x84), .b(x81), .c(x79), .O(new_n382_));
  oai21  g214(.a(x79), .b(new_n222_), .c(new_n382_), .O(new_n383_));
  nand2  g215(.a(new_n383_), .b(new_n159_), .O(new_n384_));
  nand2  g216(.a(new_n369_), .b(x79), .O(new_n385_));
  nand3  g217(.a(x81), .b(x79), .c(new_n222_), .O(new_n386_));
  inv1   g218(.a(new_n386_), .O(new_n387_));
  aoi21  g219(.a(new_n385_), .b(x04), .c(new_n387_), .O(new_n388_));
  oai21  g220(.a(new_n388_), .b(new_n159_), .c(new_n384_), .O(new_n389_));
  nand2  g221(.a(new_n389_), .b(x78), .O(new_n390_));
  inv1   g222(.a(new_n382_), .O(new_n391_));
  nand2  g223(.a(new_n391_), .b(new_n303_), .O(new_n392_));
  aoi21  g224(.a(new_n392_), .b(new_n390_), .c(x01), .O(z62));
  nand2  g225(.a(new_n379_), .b(x82), .O(new_n394_));
  nor2   g226(.a(new_n394_), .b(new_n378_), .O(z63));
  nand2  g227(.a(x83), .b(x79), .O(new_n396_));
  or2    g228(.a(new_n396_), .b(new_n378_), .O(new_n397_));
  aoi21  g229(.a(new_n397_), .b(new_n299_), .c(x01), .O(z64));
  nor2   g230(.a(new_n160_), .b(x04), .O(new_n399_));
  nor2   g231(.a(new_n236_), .b(x78), .O(new_n400_));
  oai21  g232(.a(new_n400_), .b(new_n399_), .c(x77), .O(new_n401_));
  nand2  g233(.a(new_n343_), .b(x81), .O(new_n402_));
  nand2  g234(.a(new_n379_), .b(x84), .O(new_n403_));
  aoi21  g235(.a(new_n402_), .b(new_n401_), .c(new_n403_), .O(z65));
  zero   g236(.O(z02));
  zero   g237(.O(z07));
  zero   g238(.O(z11));
  zero   g239(.O(z12));
