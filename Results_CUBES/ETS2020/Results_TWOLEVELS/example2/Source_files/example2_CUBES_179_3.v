...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n294_, new_n295_, new_n297_, new_n299_, new_n302_, new_n306_,
  ...
  nand2  g148(.a(new_n256_), .b(x59), .O(new_n306_));
  nor2   g149(.a(new_n306_), .b(new_n295_), .O(z41));
  nor3   g150(.a(new_n295_), .b(new_n286_), .c(new_n198_), .O(z42));
  nor3   g151(.a(new_n295_), .b(new_n286_), .c(new_n195_), .O(z43));
  nor3   g152(.a(new_n295_), .b(new_n286_), .c(new_n192_), .O(z44));
  ...
  nand2  g199(.a(new_n285_), .b(x14), .O(new_n358_));
  ...
  inv1   g203(.a(new_n272_), .O(new_n362_));
  ...
  oai21  g238(.a(new_n171_), .b(new_n169_), .c(new_n230_), .O(new_n397_));
  oai21  g239(.a(new_n366_), .b(x04), .c(new_n397_), .O(new_n398_));
  nand2  g240(.a(new_n174_), .b(x80), .O(new_n399_));
  inv1   g241(.a(new_n399_), .O(new_n400_));
  and2   g242(.a(new_n400_), .b(new_n398_), .O(z61));
  ...
  nand2  g246(.a(new_n389_), .b(x79), .O(new_n405_));
  ...
  nand2  g253(.a(new_n411_), .b(new_n171_), .O(new_n412_));
  aoi21  g254(.a(new_n412_), .b(new_n410_), .c(x01), .O(z62));
  nand3  g255(.a(new_n398_), .b(x83), .c(x79), .O(new_n415_));
