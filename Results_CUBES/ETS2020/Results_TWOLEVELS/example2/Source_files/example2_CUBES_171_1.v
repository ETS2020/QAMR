...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n249_, new_n250_, new_n251_, new_n254_, new_n256_, new_n258_,
    new_n260_, new_n263_, new_n269_, new_n270_, new_n271_, new_n272_,
    new_n273_, new_n274_, new_n275_, new_n276_, new_n277_, new_n278_,
    new_n279_, new_n281_, new_n283_, new_n291_, new_n294_, new_n295_,
  ...
  nor2   g091(.a(new_n245_), .b(new_n244_), .O(new_n246_));
  xnor2a g092(.a(x84), .b(x82), .O(new_n247_));
  nor2   g093(.a(new_n247_), .b(x81), .O(new_n248_));
  nor2   g094(.a(new_n248_), .b(new_n246_), .O(new_n249_));
  nor2   g095(.a(new_n249_), .b(new_n162_), .O(new_n250_));
  nand4  g096(.a(new_n250_), .b(new_n240_), .c(new_n243_), .d(x05), .O(new_n251_));
  inv1   g097(.a(new_n251_), .O(z25));
  nand4  g098(.a(new_n250_), .b(new_n240_), .c(x45), .d(new_n243_), .O(new_n254_));
  ...
  nor2   g109(.a(new_n223_), .b(new_n243_), .O(new_n270_));
  inv1   g110(.a(new_n270_), .O(new_n271_));
  nand2  g111(.a(new_n271_), .b(new_n244_), .O(new_n272_));
  nand2  g112(.a(new_n270_), .b(x81), .O(new_n273_));
  aoi21  g113(.a(new_n273_), .b(new_n272_), .c(new_n247_), .O(new_n274_));
  nand2  g114(.a(new_n271_), .b(x81), .O(new_n275_));
  nand2  g115(.a(new_n270_), .b(new_n244_), .O(new_n276_));
  aoi21  g116(.a(new_n276_), .b(new_n275_), .c(new_n245_), .O(new_n277_));
  oai21  g117(.a(new_n277_), .b(new_n274_), .c(new_n269_), .O(new_n278_));
  nand2  g118(.a(new_n240_), .b(x55), .O(new_n279_));
  nor2   g119(.a(new_n279_), .b(new_n278_), .O(z37));
  nand2  g120(.a(new_n240_), .b(x56), .O(new_n281_));
  nor2   g121(.a(new_n281_), .b(new_n278_), .O(z38));
  inv1   g122(.a(new_n240_), .O(new_n283_));
  nor3   g123(.a(new_n278_), .b(new_n283_), .c(new_n197_), .O(z39));
  nor3   g124(.a(new_n278_), .b(new_n283_), .c(new_n194_), .O(z40));
  nor3   g125(.a(new_n278_), .b(new_n283_), .c(new_n191_), .O(z41));
  nor3   g126(.a(new_n278_), .b(new_n283_), .c(new_n188_), .O(z42));
  nor3   g127(.a(new_n278_), .b(new_n283_), .c(new_n185_), .O(z43));
  nor3   g128(.a(new_n278_), .b(new_n283_), .c(new_n182_), .O(z44));
  nand2  g129(.a(new_n240_), .b(x64), .O(new_n291_));
  nor2   g130(.a(new_n291_), .b(new_n278_), .O(z46));
  ...
  nand2  g135(.a(new_n297_), .b(new_n230_), .O(new_n298_));
  ...
  and2   g141(.a(new_n303_), .b(new_n220_), .O(new_n304_));
  ...
  inv1   g168(.a(x13), .O(new_n331_));
  nand2  g169(.a(x52), .b(x21), .O(new_n332_));
  oai21  g170(.a(x52), .b(new_n331_), .c(new_n332_), .O(new_n333_));
  nand2  g171(.a(new_n333_), .b(new_n299_), .O(new_n334_));
  nand2  g172(.a(new_n304_), .b(x73), .O(new_n335_));
  aoi21  g173(.a(new_n335_), .b(new_n334_), .c(x01), .O(z53));
  inv1   g174(.a(x14), .O(new_n337_));
  nor2   g175(.a(x52), .b(new_n337_), .O(new_n338_));
  aoi21  g176(.a(x52), .b(x22), .c(new_n338_), .O(new_n339_));
  inv1   g177(.a(new_n167_), .O(new_n340_));
  nand4  g178(.a(new_n340_), .b(new_n154_), .c(x04), .d(new_n153_), .O(new_n341_));
  nor2   g179(.a(new_n341_), .b(new_n339_), .O(z54));
  inv1   g180(.a(x82), .O(new_n343_));
  nand4  g181(.a(x84), .b(x83), .c(new_n343_), .d(new_n244_), .O(new_n344_));
  inv1   g182(.a(x80), .O(new_n345_));
  nand4  g183(.a(new_n240_), .b(new_n161_), .c(new_n345_), .d(x79), .O(new_n346_));
  nor2   g184(.a(new_n346_), .b(new_n344_), .O(z55));
  nand2  g185(.a(new_n238_), .b(x76), .O(new_n348_));
  xnor2a g186(.a(x84), .b(x81), .O(new_n349_));
  aoi21  g187(.a(new_n168_), .b(new_n167_), .c(new_n349_), .O(new_n350_));
  ...
  nand3  g191(.a(new_n160_), .b(new_n159_), .c(new_n153_), .O(new_n354_));
  nand3  g192(.a(new_n354_), .b(new_n353_), .c(new_n236_), .O(z56));
  inv1   g193(.a(x02), .O(new_n356_));
  nand3  g194(.a(new_n236_), .b(x03), .c(new_n356_), .O(new_n357_));
  inv1   g195(.a(new_n357_), .O(z57));
  nand4  g196(.a(x80), .b(new_n225_), .c(x43), .d(new_n243_), .O(new_n359_));
  oai22  g197(.a(new_n359_), .b(new_n224_), .c(new_n243_), .d(x40), .O(new_n360_));
  nand3  g198(.a(new_n360_), .b(new_n230_), .c(x79), .O(new_n361_));
  nor2   g199(.a(x79), .b(x78), .O(new_n362_));
  nand3  g200(.a(new_n362_), .b(new_n243_), .c(x40), .O(new_n363_));
  nand2  g201(.a(new_n363_), .b(new_n361_), .O(new_n364_));
  nand2  g202(.a(new_n364_), .b(x77), .O(new_n365_));
  oai21  g203(.a(new_n340_), .b(new_n233_), .c(new_n154_), .O(new_n366_));
  aoi21  g204(.a(new_n366_), .b(new_n365_), .c(x01), .O(z58));
  inv1   g205(.a(new_n362_), .O(new_n368_));
  aoi21  g206(.a(new_n229_), .b(new_n368_), .c(new_n152_), .O(new_n369_));
  oai21  g207(.a(new_n226_), .b(new_n224_), .c(new_n243_), .O(new_n370_));
  aoi21  g208(.a(new_n370_), .b(x79), .c(new_n229_), .O(new_n371_));
  oai21  g209(.a(new_n371_), .b(new_n369_), .c(x77), .O(new_n372_));
  nor2   g210(.a(x79), .b(x04), .O(new_n373_));
  inv1   g211(.a(new_n373_), .O(new_n374_));
  aoi21  g212(.a(new_n374_), .b(new_n372_), .c(x01), .O(z59));
  aoi21  g213(.a(new_n350_), .b(x79), .c(new_n373_), .O(new_n376_));
  aoi21  g214(.a(new_n376_), .b(new_n231_), .c(x01), .O(z60));
  inv1   g215(.a(new_n170_), .O(new_n378_));
  nand2  g216(.a(new_n168_), .b(new_n167_), .O(new_n379_));
  aoi22  g217(.a(new_n379_), .b(new_n220_), .c(new_n161_), .d(new_n233_), .O(new_n380_));
  nor3   g218(.a(new_n380_), .b(new_n378_), .c(new_n345_), .O(z61));
  nand3  g219(.a(x84), .b(x81), .c(x79), .O(new_n382_));
  oai21  g220(.a(x79), .b(new_n233_), .c(new_n382_), .O(new_n383_));
  nand2  g221(.a(new_n383_), .b(new_n159_), .O(new_n384_));
  nand2  g222(.a(new_n370_), .b(x79), .O(new_n385_));
  nand3  g223(.a(x81), .b(x79), .c(new_n233_), .O(new_n386_));
  inv1   g224(.a(new_n386_), .O(new_n387_));
  aoi21  g225(.a(new_n385_), .b(x04), .c(new_n387_), .O(new_n388_));
  oai21  g226(.a(new_n388_), .b(new_n159_), .c(new_n384_), .O(new_n389_));
  nand2  g227(.a(new_n389_), .b(x78), .O(new_n390_));
  inv1   g228(.a(new_n382_), .O(new_n391_));
  nand2  g229(.a(new_n391_), .b(new_n301_), .O(new_n392_));
  aoi21  g230(.a(new_n392_), .b(new_n390_), .c(x01), .O(z62));
  nor3   g231(.a(new_n380_), .b(new_n378_), .c(new_n343_), .O(z63));
  nand2  g232(.a(x83), .b(x79), .O(new_n395_));
  or2    g233(.a(new_n395_), .b(new_n380_), .O(new_n396_));
  aoi21  g234(.a(new_n396_), .b(new_n298_), .c(x01), .O(z64));
  nor2   g235(.a(new_n160_), .b(x04), .O(new_n398_));
  nor2   g236(.a(new_n244_), .b(x78), .O(new_n399_));
  oai21  g237(.a(new_n399_), .b(new_n398_), .c(x77), .O(new_n400_));
  nand2  g238(.a(new_n340_), .b(x81), .O(new_n401_));
  nand2  g239(.a(new_n170_), .b(x84), .O(new_n402_));
