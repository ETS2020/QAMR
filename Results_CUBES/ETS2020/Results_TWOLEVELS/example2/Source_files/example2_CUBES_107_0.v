...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n203_, new_n204_, new_n209_, new_n210_, new_n212_, new_n213_,
    ...
    new_n282_, new_n283_, new_n284_, new_n286_, new_n289_, new_n299_,
  ...
  nor3   g131(.a(new_n284_), .b(new_n275_), .c(new_n197_), .O(z39));
  nor3   g132(.a(new_n284_), .b(new_n275_), .c(new_n194_), .O(z40));
  nor3   g133(.a(new_n284_), .b(new_n275_), .c(new_n191_), .O(z41));
  nor3   g134(.a(new_n284_), .b(new_n275_), .c(new_n188_), .O(z42));
  nor3   g135(.a(new_n284_), .b(new_n275_), .c(new_n185_), .O(z43));
  nor3   g136(.a(new_n284_), .b(new_n275_), .c(new_n182_), .O(z44));
  nand2  g137(.a(new_n236_), .b(x64), .O(new_n299_));
  nor2   g138(.a(new_n299_), .b(new_n284_), .O(z46));
  inv1   g139(.a(x07), .O(new_n301_));
  nand2  g140(.a(x52), .b(x15), .O(new_n302_));
  oai21  g141(.a(x52), .b(new_n301_), .c(new_n302_), .O(new_n303_));
  nor2   g142(.a(x79), .b(x77), .O(new_n304_));
  nand2  g143(.a(new_n304_), .b(new_n226_), .O(new_n305_));
  inv1   g144(.a(new_n305_), .O(new_n306_));
  nand2  g145(.a(new_n306_), .b(new_n303_), .O(new_n307_));
  nor2   g146(.a(x75), .b(x67), .O(new_n308_));
  inv1   g147(.a(new_n168_), .O(new_n309_));
  nand2  g148(.a(new_n309_), .b(x79), .O(new_n310_));
  nor2   g149(.a(new_n310_), .b(new_n308_), .O(new_n311_));
  nand2  g150(.a(new_n311_), .b(new_n216_), .O(new_n312_));
  aoi21  g151(.a(new_n312_), .b(new_n307_), .c(x01), .O(z47));
  inv1   g152(.a(x08), .O(new_n314_));
  nand2  g153(.a(x52), .b(x16), .O(new_n315_));
  oai21  g154(.a(x52), .b(new_n314_), .c(new_n315_), .O(new_n316_));
  nand2  g155(.a(new_n316_), .b(new_n306_), .O(new_n317_));
  inv1   g156(.a(new_n216_), .O(new_n318_));
  nor2   g157(.a(new_n310_), .b(new_n318_), .O(new_n319_));
  nand2  g158(.a(new_n319_), .b(x68), .O(new_n320_));
  aoi21  g159(.a(new_n320_), .b(new_n317_), .c(x01), .O(z48));
  inv1   g160(.a(x10), .O(new_n323_));
  nand2  g161(.a(x52), .b(x18), .O(new_n324_));
  oai21  g162(.a(x52), .b(new_n323_), .c(new_n324_), .O(new_n325_));
  nand2  g163(.a(new_n325_), .b(new_n306_), .O(new_n326_));
  nand2  g164(.a(new_n319_), .b(x70), .O(new_n327_));
  aoi21  g165(.a(new_n327_), .b(new_n326_), .c(x01), .O(z50));
  inv1   g166(.a(x11), .O(new_n329_));
  nand2  g167(.a(x52), .b(x19), .O(new_n330_));
  oai21  g168(.a(x52), .b(new_n329_), .c(new_n330_), .O(new_n331_));
  nand2  g169(.a(new_n331_), .b(new_n306_), .O(new_n332_));
  nand2  g170(.a(new_n319_), .b(x71), .O(new_n333_));
  aoi21  g171(.a(new_n333_), .b(new_n332_), .c(x01), .O(z51));
  inv1   g172(.a(x12), .O(new_n335_));
  nand2  g173(.a(x52), .b(x20), .O(new_n336_));
  oai21  g174(.a(x52), .b(new_n335_), .c(new_n336_), .O(new_n337_));
  nand2  g175(.a(new_n337_), .b(new_n306_), .O(new_n338_));
  nand2  g176(.a(new_n319_), .b(x72), .O(new_n339_));
  aoi21  g177(.a(new_n339_), .b(new_n338_), .c(x01), .O(z52));
  nand2  g178(.a(x52), .b(x22), .O(new_n342_));
  nand2  g179(.a(new_n274_), .b(x14), .O(new_n343_));
  ...
  nand3  g184(.a(new_n261_), .b(x84), .c(new_n347_), .O(new_n348_));
  ...
  nand4  g199(.a(x80), .b(new_n221_), .c(x43), .d(new_n240_), .O(new_n363_));
  oai22  g200(.a(new_n363_), .b(new_n220_), .c(new_n240_), .d(x40), .O(new_n364_));
  nand3  g201(.a(new_n364_), .b(new_n226_), .c(x79), .O(new_n365_));
  nor2   g202(.a(x79), .b(x78), .O(new_n366_));
  nand3  g203(.a(new_n366_), .b(new_n240_), .c(x40), .O(new_n367_));
  ...
  oai21  g210(.a(new_n222_), .b(new_n220_), .c(new_n240_), .O(new_n374_));
  ...
  aoi21  g237(.a(new_n400_), .b(new_n305_), .c(x01), .O(z64));
  nor2   g238(.a(new_n160_), .b(x04), .O(new_n402_));
  nor2   g239(.a(new_n244_), .b(x78), .O(new_n403_));
