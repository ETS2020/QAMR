...
module FAU ( 
  ...
  nor3   g150(.a(new_n295_), .b(new_n286_), .c(new_n199_), .O(z41));
  ...
  nor3   g154(.a(new_n295_), .b(new_n286_), .c(new_n192_), .O(z44));
  ...
  inv1   g172(.a(new_n230_), .O(new_n329_));
  ...
  nand2  g191(.a(new_n347_), .b(new_n318_), .O(new_n348_));
  ...
  nand2  g197(.a(new_n353_), .b(new_n318_), .O(new_n354_));
  ...
  nand2  g207(.a(new_n285_), .b(x14), .O(new_n364_));
  nand4  g208(.a(new_n169_), .b(new_n154_), .c(x04), .d(new_n153_), .O(new_n365_));
  aoi21  g209(.a(new_n364_), .b(new_n363_), .c(new_n365_), .O(z54));
  inv1   g210(.a(x84), .O(new_n367_));
  inv1   g211(.a(new_n272_), .O(new_n368_));
  nor2   g212(.a(x80), .b(new_n154_), .O(new_n369_));
  nand3  g213(.a(new_n369_), .b(new_n256_), .c(new_n165_), .O(new_n370_));
  nor4   g214(.a(new_n370_), .b(new_n368_), .c(new_n367_), .d(x82), .O(z55));
  inv1   g215(.a(new_n165_), .O(new_n372_));
  nand2  g216(.a(new_n372_), .b(x76), .O(new_n373_));
  ...
  aoi21  g224(.a(new_n380_), .b(new_n164_), .c(new_n243_), .O(new_n381_));
  nand2  g225(.a(new_n381_), .b(new_n379_), .O(z56));
  inv1   g226(.a(x02), .O(new_n383_));
  nand3  g227(.a(new_n244_), .b(x03), .c(new_n383_), .O(new_n384_));
  inv1   g228(.a(new_n384_), .O(z57));
  nand4  g229(.a(x80), .b(new_n236_), .c(x43), .d(new_n247_), .O(new_n386_));
  oai22  g230(.a(new_n386_), .b(new_n235_), .c(new_n247_), .d(x40), .O(new_n387_));
  nand3  g231(.a(new_n387_), .b(new_n233_), .c(x79), .O(new_n388_));
  nand3  g232(.a(new_n179_), .b(new_n247_), .c(x40), .O(new_n389_));
  ...
  aoi21  g237(.a(new_n163_), .b(new_n180_), .c(new_n152_), .O(new_n394_));
  oai21  g238(.a(new_n237_), .b(new_n235_), .c(new_n247_), .O(new_n395_));
  ...
  aoi21  g245(.a(new_n401_), .b(new_n240_), .c(x01), .O(z60));
  oai21  g246(.a(new_n171_), .b(new_n169_), .c(new_n230_), .O(new_n403_));
  oai21  g247(.a(new_n372_), .b(x04), .c(new_n403_), .O(new_n404_));
  ...
  nand3  g264(.a(new_n176_), .b(new_n159_), .c(x04), .O(new_n422_));
  aoi21  g265(.a(new_n422_), .b(new_n421_), .c(x01), .O(z64));
  nor2   g266(.a(new_n164_), .b(x04), .O(new_n424_));
  nor2   g267(.a(new_n251_), .b(x78), .O(new_n425_));
