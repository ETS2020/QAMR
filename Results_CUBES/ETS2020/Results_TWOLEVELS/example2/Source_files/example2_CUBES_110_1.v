// Benchmark "FAU" written by ABC on Fri Jul 10 18:17:32 2020
...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n251_, new_n253_, new_n255_, new_n257_, new_n260_, new_n264_,
    new_n265_, new_n266_, new_n267_, new_n268_, new_n269_, new_n270_,
    new_n271_, new_n272_, new_n273_, new_n274_, new_n276_, new_n279_,
    new_n281_, new_n289_, new_n291_, new_n292_, new_n293_, new_n294_,
  ...
  inv1   g105(.a(new_n162_), .O(new_n264_));
  nor2   g106(.a(new_n221_), .b(new_n239_), .O(new_n265_));
  inv1   g107(.a(new_n265_), .O(new_n266_));
  nand2  g108(.a(new_n266_), .b(new_n240_), .O(new_n267_));
  nand2  g109(.a(new_n265_), .b(x81), .O(new_n268_));
  aoi21  g110(.a(new_n268_), .b(new_n267_), .c(new_n243_), .O(new_n269_));
  nand2  g111(.a(new_n266_), .b(x81), .O(new_n270_));
  nand2  g112(.a(new_n265_), .b(new_n240_), .O(new_n271_));
  aoi21  g113(.a(new_n271_), .b(new_n270_), .c(new_n241_), .O(new_n272_));
  oai21  g114(.a(new_n272_), .b(new_n269_), .c(new_n264_), .O(new_n273_));
  nand2  g115(.a(new_n236_), .b(x53), .O(new_n274_));
  nor2   g116(.a(new_n274_), .b(new_n273_), .O(z35));
  nand2  g117(.a(new_n236_), .b(x54), .O(new_n276_));
  nor2   g118(.a(new_n276_), .b(new_n273_), .O(z36));
  nand2  g119(.a(new_n236_), .b(x56), .O(new_n279_));
  nor2   g120(.a(new_n279_), .b(new_n273_), .O(z38));
  inv1   g121(.a(new_n236_), .O(new_n281_));
  nor3   g122(.a(new_n273_), .b(new_n281_), .c(new_n197_), .O(z39));
  nor3   g123(.a(new_n273_), .b(new_n281_), .c(new_n194_), .O(z40));
  nor3   g124(.a(new_n273_), .b(new_n281_), .c(new_n191_), .O(z41));
  nor3   g125(.a(new_n273_), .b(new_n281_), .c(new_n185_), .O(z43));
  nor3   g126(.a(new_n273_), .b(new_n281_), .c(new_n182_), .O(z44));
  nand2  g127(.a(new_n236_), .b(x64), .O(new_n289_));
  nor2   g128(.a(new_n289_), .b(new_n273_), .O(z46));
  inv1   g129(.a(x07), .O(new_n291_));
  nand2  g130(.a(x52), .b(x15), .O(new_n292_));
  oai21  g131(.a(x52), .b(new_n291_), .c(new_n292_), .O(new_n293_));
  nand3  g132(.a(new_n228_), .b(new_n154_), .c(new_n159_), .O(new_n294_));
  inv1   g133(.a(new_n294_), .O(new_n295_));
  nand2  g134(.a(new_n295_), .b(new_n293_), .O(new_n296_));
  ...
  nand2  g152(.a(new_n314_), .b(new_n295_), .O(new_n315_));
  nand2  g153(.a(new_n308_), .b(x70), .O(new_n316_));
  aoi21  g154(.a(new_n316_), .b(new_n315_), .c(x01), .O(z50));
  inv1   g155(.a(x11), .O(new_n318_));
  nand2  g156(.a(x52), .b(x19), .O(new_n319_));
  oai21  g157(.a(x52), .b(new_n318_), .c(new_n319_), .O(new_n320_));
  nand2  g158(.a(new_n320_), .b(new_n295_), .O(new_n321_));
  nand2  g159(.a(new_n308_), .b(x71), .O(new_n322_));
  aoi21  g160(.a(new_n322_), .b(new_n321_), .c(x01), .O(z51));
  inv1   g161(.a(x14), .O(new_n326_));
  nor2   g162(.a(x52), .b(new_n326_), .O(new_n327_));
  aoi21  g163(.a(x52), .b(x22), .c(new_n327_), .O(new_n328_));
  inv1   g164(.a(new_n167_), .O(new_n329_));
  nand4  g165(.a(new_n329_), .b(new_n154_), .c(x04), .d(new_n153_), .O(new_n330_));
  nor2   g166(.a(new_n330_), .b(new_n328_), .O(z54));
  inv1   g167(.a(x82), .O(new_n332_));
  nand4  g168(.a(x84), .b(x83), .c(new_n332_), .d(new_n240_), .O(new_n333_));
  ...
  nand4  g180(.a(x80), .b(new_n223_), .c(x43), .d(new_n239_), .O(new_n346_));
  oai22  g181(.a(new_n346_), .b(new_n222_), .c(new_n239_), .d(x40), .O(new_n347_));
  nand3  g182(.a(new_n347_), .b(new_n228_), .c(x79), .O(new_n348_));
  nor2   g183(.a(x79), .b(x78), .O(new_n349_));
  nand3  g184(.a(new_n349_), .b(new_n239_), .c(x40), .O(new_n350_));
  nand2  g185(.a(new_n350_), .b(new_n348_), .O(new_n351_));
  nand2  g186(.a(new_n351_), .b(x77), .O(new_n352_));
  oai21  g187(.a(new_n329_), .b(new_n231_), .c(new_n154_), .O(new_n353_));
  aoi21  g188(.a(new_n353_), .b(new_n352_), .c(x01), .O(z58));
  inv1   g189(.a(new_n349_), .O(new_n355_));
  aoi21  g190(.a(new_n227_), .b(new_n355_), .c(new_n152_), .O(new_n356_));
  oai21  g191(.a(new_n224_), .b(new_n222_), .c(new_n239_), .O(new_n357_));
  aoi21  g192(.a(new_n357_), .b(x79), .c(new_n227_), .O(new_n358_));
  oai21  g193(.a(new_n358_), .b(new_n356_), .c(x77), .O(new_n359_));
  nor2   g194(.a(x79), .b(x04), .O(new_n360_));
  inv1   g195(.a(new_n360_), .O(new_n361_));
  aoi21  g196(.a(new_n361_), .b(new_n359_), .c(x01), .O(z59));
  aoi21  g197(.a(new_n340_), .b(x79), .c(new_n360_), .O(new_n363_));
  aoi21  g198(.a(new_n363_), .b(new_n229_), .c(x01), .O(z60));
  inv1   g199(.a(new_n170_), .O(new_n365_));
  nand2  g200(.a(new_n168_), .b(new_n167_), .O(new_n366_));
  aoi22  g201(.a(new_n366_), .b(new_n218_), .c(new_n161_), .d(new_n231_), .O(new_n367_));
  nor3   g202(.a(new_n367_), .b(new_n365_), .c(new_n334_), .O(z61));
  ...
  nand2  g206(.a(new_n357_), .b(x79), .O(new_n372_));
  ...
  nand2  g213(.a(new_n378_), .b(new_n298_), .O(new_n379_));
  aoi21  g214(.a(new_n379_), .b(new_n377_), .c(x01), .O(z62));
  nor3   g215(.a(new_n367_), .b(new_n365_), .c(new_n332_), .O(z63));
  nand2  g216(.a(x83), .b(x79), .O(new_n382_));
  or2    g217(.a(new_n382_), .b(new_n367_), .O(new_n383_));
  aoi21  g218(.a(new_n383_), .b(new_n294_), .c(x01), .O(z64));
  nor2   g219(.a(new_n160_), .b(x04), .O(new_n385_));
  nor2   g220(.a(new_n240_), .b(x78), .O(new_n386_));
  oai21  g221(.a(new_n386_), .b(new_n385_), .c(x77), .O(new_n387_));
  nand2  g222(.a(new_n329_), .b(x81), .O(new_n388_));
  nand2  g223(.a(new_n170_), .b(x84), .O(new_n389_));
  aoi21  g224(.a(new_n388_), .b(new_n387_), .c(new_n389_), .O(z65));
  zero   g225(.O(z06));
  zero   g226(.O(z15));
  zero   g227(.O(z18));
  zero   g228(.O(z20));
