// Benchmark "FAU" written by ABC on Fri Jul 10 18:26:25 2020
...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n295_, new_n298_, new_n302_, new_n306_, new_n308_, new_n312_,
  ...
  nor2   g142(.a(new_n298_), .b(new_n293_), .O(z37));
  nor3   g143(.a(new_n293_), .b(new_n284_), .c(new_n200_), .O(z39));
  nand2  g144(.a(new_n253_), .b(x58), .O(new_n302_));
  nor2   g145(.a(new_n302_), .b(new_n293_), .O(z40));
  nor3   g146(.a(new_n293_), .b(new_n284_), .c(new_n193_), .O(z42));
  nand2  g147(.a(new_n253_), .b(x61), .O(new_n306_));
  nor2   g148(.a(new_n306_), .b(new_n293_), .O(z43));
  nand2  g149(.a(new_n253_), .b(x62), .O(new_n308_));
  nor2   g150(.a(new_n308_), .b(new_n293_), .O(z44));
  ...
  nand3  g155(.a(new_n230_), .b(new_n154_), .c(new_n159_), .O(new_n315_));
  inv1   g156(.a(new_n315_), .O(new_n316_));
  nand2  g157(.a(new_n316_), .b(new_n314_), .O(new_n317_));
  nor2   g158(.a(x75), .b(x67), .O(new_n318_));
  inv1   g159(.a(new_n171_), .O(new_n319_));
  nand2  g160(.a(new_n319_), .b(x79), .O(new_n320_));
  nor2   g161(.a(new_n320_), .b(new_n318_), .O(new_n321_));
  nand2  g162(.a(new_n321_), .b(new_n227_), .O(new_n322_));
  aoi21  g163(.a(new_n322_), .b(new_n317_), .c(x01), .O(z47));
  inv1   g164(.a(x08), .O(new_n324_));
  nand2  g165(.a(x52), .b(x16), .O(new_n325_));
  ...
  nor2   g169(.a(new_n320_), .b(new_n328_), .O(new_n329_));
  nand2  g170(.a(new_n329_), .b(x68), .O(new_n330_));
  aoi21  g171(.a(new_n330_), .b(new_n327_), .c(x01), .O(z48));
  inv1   g172(.a(x09), .O(new_n332_));
  nand2  g173(.a(x52), .b(x17), .O(new_n333_));
  oai21  g174(.a(x52), .b(new_n332_), .c(new_n333_), .O(new_n334_));
  nand2  g175(.a(new_n334_), .b(new_n316_), .O(new_n335_));
  nand2  g176(.a(new_n329_), .b(x69), .O(new_n336_));
  aoi21  g177(.a(new_n336_), .b(new_n335_), .c(x01), .O(z49));
  inv1   g178(.a(x11), .O(new_n339_));
  nand2  g179(.a(x52), .b(x19), .O(new_n340_));
  oai21  g180(.a(x52), .b(new_n339_), .c(new_n340_), .O(new_n341_));
  nand2  g181(.a(new_n341_), .b(new_n316_), .O(new_n342_));
  nand2  g182(.a(new_n329_), .b(x71), .O(new_n343_));
  aoi21  g183(.a(new_n343_), .b(new_n342_), .c(x01), .O(z51));
  inv1   g184(.a(x12), .O(new_n345_));
  nand2  g185(.a(x52), .b(x20), .O(new_n346_));
  oai21  g186(.a(x52), .b(new_n345_), .c(new_n346_), .O(new_n347_));
  nand2  g187(.a(new_n347_), .b(new_n316_), .O(new_n348_));
  nand2  g188(.a(new_n329_), .b(x72), .O(new_n349_));
  aoi21  g189(.a(new_n349_), .b(new_n348_), .c(x01), .O(z52));
  inv1   g190(.a(x13), .O(new_n351_));
  nand2  g191(.a(x52), .b(x21), .O(new_n352_));
  oai21  g192(.a(x52), .b(new_n351_), .c(new_n352_), .O(new_n353_));
  nand2  g193(.a(new_n353_), .b(new_n316_), .O(new_n354_));
  nand2  g194(.a(new_n329_), .b(x73), .O(new_n355_));
  aoi21  g195(.a(new_n355_), .b(new_n354_), .c(x01), .O(z53));
  nand2  g196(.a(x52), .b(x22), .O(new_n357_));
  nand2  g197(.a(new_n283_), .b(x14), .O(new_n358_));
  inv1   g198(.a(new_n170_), .O(new_n359_));
  nand4  g199(.a(new_n359_), .b(new_n154_), .c(x04), .d(new_n153_), .O(new_n360_));
  aoi21  g200(.a(new_n358_), .b(new_n357_), .c(new_n360_), .O(z54));
  inv1   g201(.a(x82), .O(new_n362_));
  nand3  g202(.a(new_n270_), .b(x84), .c(new_n362_), .O(new_n363_));
  inv1   g203(.a(x80), .O(new_n364_));
  nand4  g204(.a(new_n253_), .b(new_n165_), .c(new_n364_), .d(x79), .O(new_n365_));
  nor2   g205(.a(new_n365_), .b(new_n363_), .O(z55));
  inv1   g206(.a(x76), .O(new_n367_));
  nor2   g207(.a(new_n165_), .b(new_n367_), .O(new_n368_));
  xnor2a g208(.a(x84), .b(x81), .O(new_n369_));
  aoi21  g209(.a(new_n171_), .b(new_n170_), .c(new_n369_), .O(new_n370_));
  aoi21  g210(.a(new_n370_), .b(new_n153_), .c(new_n368_), .O(new_n371_));
  nor2   g211(.a(x77), .b(x01), .O(new_n372_));
  aoi21  g212(.a(new_n372_), .b(new_n164_), .c(new_n240_), .O(new_n373_));
  oai21  g213(.a(new_n371_), .b(new_n154_), .c(new_n373_), .O(z56));
  inv1   g214(.a(x02), .O(new_n375_));
  nand3  g215(.a(new_n241_), .b(x03), .c(new_n375_), .O(new_n376_));
  inv1   g216(.a(new_n376_), .O(z57));
  nand4  g217(.a(x80), .b(new_n233_), .c(x43), .d(new_n244_), .O(new_n378_));
  oai22  g218(.a(new_n378_), .b(new_n232_), .c(new_n244_), .d(x40), .O(new_n379_));
  nand3  g219(.a(new_n379_), .b(new_n230_), .c(x79), .O(new_n380_));
  nand3  g220(.a(new_n178_), .b(new_n244_), .c(x40), .O(new_n381_));
  nand2  g221(.a(new_n381_), .b(new_n380_), .O(new_n382_));
  nand2  g222(.a(new_n382_), .b(x77), .O(new_n383_));
  oai21  g223(.a(new_n359_), .b(new_n160_), .c(new_n154_), .O(new_n384_));
  aoi21  g224(.a(new_n384_), .b(new_n383_), .c(x01), .O(z58));
  aoi21  g225(.a(new_n163_), .b(new_n179_), .c(new_n152_), .O(new_n386_));
  oai21  g226(.a(new_n234_), .b(new_n232_), .c(new_n244_), .O(new_n387_));
  ...
  aoi21  g232(.a(new_n370_), .b(x79), .c(new_n390_), .O(new_n393_));
  aoi21  g233(.a(new_n393_), .b(new_n237_), .c(x01), .O(z60));
  inv1   g234(.a(new_n173_), .O(new_n395_));
  nand2  g235(.a(new_n171_), .b(new_n170_), .O(new_n396_));
  aoi22  g236(.a(new_n396_), .b(new_n227_), .c(new_n165_), .d(new_n160_), .O(new_n397_));
  nor3   g237(.a(new_n397_), .b(new_n395_), .c(new_n364_), .O(z61));
