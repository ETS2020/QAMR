...
module FAU ( 
  ...
  wire new_n154_, new_n155_, new_n156_, new_n157_, new_n158_, new_n159_,
    ...
    new_n179_, new_n180_, new_n183_, new_n184_, new_n188_, new_n189_,
    ...
    new_n264_, new_n265_, new_n266_, new_n267_, new_n271_, new_n274_,
  ...
  nand3  g062(.a(new_n224_), .b(x44), .c(new_n223_), .O(new_n225_));
  inv1   g063(.a(new_n225_), .O(new_n226_));
  nand3  g064(.a(new_n226_), .b(new_n222_), .c(new_n220_), .O(new_n227_));
  inv1   g065(.a(new_n227_), .O(z26));
  nand3  g066(.a(new_n224_), .b(x45), .c(new_n223_), .O(new_n229_));
  inv1   g067(.a(new_n229_), .O(new_n230_));
  nand3  g068(.a(new_n230_), .b(new_n222_), .c(new_n220_), .O(new_n231_));
  inv1   g069(.a(new_n231_), .O(z27));
  nand3  g070(.a(new_n224_), .b(x47), .c(new_n223_), .O(new_n234_));
  inv1   g071(.a(new_n234_), .O(new_n235_));
  nand3  g072(.a(new_n235_), .b(new_n222_), .c(new_n220_), .O(new_n236_));
  inv1   g073(.a(new_n236_), .O(z29));
  nand3  g074(.a(new_n224_), .b(x48), .c(new_n223_), .O(new_n238_));
  inv1   g075(.a(new_n238_), .O(new_n239_));
  nand3  g076(.a(new_n239_), .b(new_n222_), .c(new_n220_), .O(new_n240_));
  inv1   g077(.a(new_n240_), .O(z30));
  nand3  g078(.a(new_n224_), .b(x49), .c(new_n223_), .O(new_n242_));
  ...
  nand2  g091(.a(new_n224_), .b(new_n222_), .O(new_n256_));
  ...
  nand2  g102(.a(new_n224_), .b(x52), .O(new_n267_));
  nor2   g103(.a(new_n267_), .b(new_n266_), .O(z34));
  nand2  g104(.a(new_n224_), .b(x55), .O(new_n271_));
  nor2   g105(.a(new_n271_), .b(new_n266_), .O(z37));
  nand2  g106(.a(new_n224_), .b(x57), .O(new_n274_));
  nor2   g107(.a(new_n274_), .b(new_n266_), .O(z39));
  nand2  g108(.a(new_n224_), .b(x58), .O(new_n276_));
  nor2   g109(.a(new_n276_), .b(new_n266_), .O(z40));
  nand2  g110(.a(new_n224_), .b(x59), .O(new_n278_));
  nor2   g111(.a(new_n278_), .b(new_n266_), .O(z41));
  nand2  g112(.a(new_n224_), .b(x60), .O(new_n280_));
  nor2   g113(.a(new_n280_), .b(new_n266_), .O(z42));
  nand2  g114(.a(new_n224_), .b(x62), .O(new_n283_));
  nor2   g115(.a(new_n283_), .b(new_n266_), .O(z44));
  nand2  g116(.a(new_n224_), .b(x63), .O(new_n285_));
  nor2   g117(.a(new_n285_), .b(new_n266_), .O(z45));
  nand2  g118(.a(new_n224_), .b(x64), .O(new_n287_));
  ...
  nand3  g133(.a(new_n301_), .b(new_n293_), .c(new_n165_), .O(new_n302_));
  ...
  nand3  g139(.a(new_n307_), .b(new_n293_), .c(new_n165_), .O(new_n308_));
  ...
  nand3  g145(.a(new_n313_), .b(new_n293_), .c(new_n165_), .O(new_n314_));
  ...
  nand3  g151(.a(new_n319_), .b(new_n293_), .c(new_n165_), .O(new_n320_));
  ...
  nand3  g157(.a(new_n325_), .b(new_n293_), .c(new_n165_), .O(new_n326_));
  ...
  nand3  g163(.a(new_n331_), .b(new_n293_), .c(new_n165_), .O(new_n332_));
  ...
  nand4  g169(.a(new_n155_), .b(new_n160_), .c(x04), .d(new_n164_), .O(new_n338_));
  nor2   g170(.a(new_n338_), .b(new_n337_), .O(z54));
  inv1   g171(.a(x02), .O(new_n342_));
  nand4  g172(.a(x03), .b(new_n342_), .c(new_n164_), .d(x00), .O(new_n343_));
  inv1   g173(.a(new_n343_), .O(z57));
  oai21  g174(.a(new_n158_), .b(new_n155_), .c(new_n295_), .O(new_n348_));
  nand3  g175(.a(x78), .b(x77), .c(new_n292_), .O(new_n349_));
  nand2  g176(.a(new_n161_), .b(x80), .O(new_n350_));
  aoi21  g177(.a(new_n349_), .b(new_n348_), .c(new_n350_), .O(z61));
  nand2  g178(.a(new_n161_), .b(x82), .O(new_n353_));
  aoi21  g179(.a(new_n349_), .b(new_n348_), .c(new_n353_), .O(z63));
  zero   g180(.O(z00));
  zero   g181(.O(z01));
  zero   g182(.O(z04));
  zero   g183(.O(z06));
