...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n284_, new_n286_, new_n290_, new_n293_, new_n299_, new_n300_,
  ...
  inv1   g127(.a(new_n233_), .O(new_n290_));
  nor3   g128(.a(new_n279_), .b(new_n290_), .c(new_n184_), .O(z40));
  nor3   g129(.a(new_n279_), .b(new_n290_), .c(new_n181_), .O(z41));
  nand2  g130(.a(new_n233_), .b(x60), .O(new_n293_));
  nor2   g131(.a(new_n293_), .b(new_n279_), .O(z42));
  nor3   g132(.a(new_n279_), .b(new_n290_), .c(new_n177_), .O(z43));
  nor3   g133(.a(new_n279_), .b(new_n290_), .c(new_n174_), .O(z44));
  nor3   g134(.a(new_n279_), .b(new_n290_), .c(new_n170_), .O(z46));
  ...
  inv1   g152(.a(new_n213_), .O(new_n316_));
  ...
  nand2  g171(.a(new_n334_), .b(new_n304_), .O(new_n335_));
  ...
  nand3  g181(.a(new_n258_), .b(x84), .c(new_n346_), .O(new_n347_));
  inv1   g182(.a(x80), .O(new_n348_));
  nand4  g183(.a(new_n233_), .b(new_n161_), .c(new_n348_), .d(x79), .O(new_n349_));
  nor2   g184(.a(new_n349_), .b(new_n347_), .O(z55));
  nand2  g185(.a(new_n231_), .b(x76), .O(new_n351_));
  ...
  nand3  g192(.a(new_n357_), .b(new_n356_), .c(new_n229_), .O(z56));
  inv1   g193(.a(x02), .O(new_n359_));
  nand3  g194(.a(new_n229_), .b(x03), .c(new_n359_), .O(new_n360_));
  inv1   g195(.a(new_n360_), .O(z57));
  nand4  g196(.a(x80), .b(new_n218_), .c(x43), .d(new_n236_), .O(new_n362_));
  oai22  g197(.a(new_n362_), .b(new_n217_), .c(new_n236_), .d(x40), .O(new_n363_));
  nand3  g198(.a(new_n363_), .b(new_n223_), .c(x79), .O(new_n364_));
  nor2   g199(.a(x79), .b(x78), .O(new_n365_));
  nand3  g200(.a(new_n365_), .b(new_n236_), .c(x40), .O(new_n366_));
  nand2  g201(.a(new_n366_), .b(new_n364_), .O(new_n367_));
  nand2  g202(.a(new_n367_), .b(x77), .O(new_n368_));
  inv1   g203(.a(new_n210_), .O(new_n369_));
  oai21  g204(.a(new_n369_), .b(new_n226_), .c(new_n154_), .O(new_n370_));
