...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n204_, new_n206_, new_n207_, new_n210_, new_n211_, new_n214_,
    new_n215_, new_n217_, new_n218_, new_n219_, new_n220_, new_n221_,
    new_n222_, new_n223_, new_n224_, new_n225_, new_n226_, new_n227_,
    new_n228_, new_n230_, new_n231_, new_n233_, new_n234_, new_n235_,
    new_n236_, new_n238_, new_n239_, new_n240_, new_n241_, new_n242_,
    new_n243_, new_n244_, new_n245_, new_n246_, new_n249_, new_n252_,
    new_n255_, new_n257_, new_n260_, new_n261_, new_n262_, new_n263_,
    new_n264_, new_n265_, new_n266_, new_n267_, new_n268_, new_n269_,
    new_n270_, new_n273_, new_n276_, new_n278_, new_n281_, new_n286_,
  ...
  nand4  g095(.a(new_n245_), .b(new_n235_), .c(x49), .d(new_n238_), .O(new_n255_));
  ...
  nor2   g100(.a(new_n220_), .b(new_n238_), .O(new_n261_));
  inv1   g101(.a(new_n261_), .O(new_n262_));
  nand2  g102(.a(new_n262_), .b(new_n239_), .O(new_n263_));
  nand2  g103(.a(new_n261_), .b(x81), .O(new_n264_));
  aoi21  g104(.a(new_n264_), .b(new_n263_), .c(new_n242_), .O(new_n265_));
  nand2  g105(.a(new_n262_), .b(x81), .O(new_n266_));
  nand2  g106(.a(new_n261_), .b(new_n239_), .O(new_n267_));
  aoi21  g107(.a(new_n267_), .b(new_n266_), .c(new_n240_), .O(new_n268_));
  oai21  g108(.a(new_n268_), .b(new_n265_), .c(new_n260_), .O(new_n269_));
  nand2  g109(.a(new_n235_), .b(x52), .O(new_n270_));
  nor2   g110(.a(new_n270_), .b(new_n269_), .O(z34));
  nand2  g111(.a(new_n235_), .b(x54), .O(new_n273_));
  ...
  nor3   g116(.a(new_n269_), .b(new_n278_), .c(new_n194_), .O(z39));
  nor3   g117(.a(new_n269_), .b(new_n278_), .c(new_n191_), .O(z40));
  nand2  g118(.a(new_n235_), .b(x59), .O(new_n281_));
  nor2   g119(.a(new_n281_), .b(new_n269_), .O(z41));
  nor3   g120(.a(new_n269_), .b(new_n278_), .c(new_n184_), .O(z43));
  nor3   g121(.a(new_n269_), .b(new_n278_), .c(new_n181_), .O(z44));
  nand2  g122(.a(new_n235_), .b(x63), .O(new_n286_));
  nor2   g123(.a(new_n286_), .b(new_n269_), .O(z45));
  nor3   g124(.a(new_n269_), .b(new_n278_), .c(new_n177_), .O(z46));
  inv1   g125(.a(x07), .O(new_n289_));
  nand2  g126(.a(x52), .b(x15), .O(new_n290_));
  oai21  g127(.a(x52), .b(new_n289_), .c(new_n290_), .O(new_n291_));
  nor2   g128(.a(x79), .b(x77), .O(new_n292_));
  nand2  g129(.a(new_n292_), .b(new_n227_), .O(new_n293_));
  inv1   g130(.a(new_n293_), .O(new_n294_));
  nand2  g131(.a(new_n294_), .b(new_n291_), .O(new_n295_));
  nor2   g132(.a(x75), .b(x67), .O(new_n296_));
  nand2  g133(.a(new_n168_), .b(x79), .O(new_n297_));
  nor2   g134(.a(new_n297_), .b(new_n296_), .O(new_n298_));
  nand2  g135(.a(new_n298_), .b(new_n217_), .O(new_n299_));
  aoi21  g136(.a(new_n299_), .b(new_n295_), .c(x01), .O(z47));
  inv1   g137(.a(x08), .O(new_n301_));
  nand2  g138(.a(x52), .b(x16), .O(new_n302_));
  oai21  g139(.a(x52), .b(new_n301_), .c(new_n302_), .O(new_n303_));
  nand2  g140(.a(new_n303_), .b(new_n294_), .O(new_n304_));
  inv1   g141(.a(new_n217_), .O(new_n305_));
  nor2   g142(.a(new_n297_), .b(new_n305_), .O(new_n306_));
  nand2  g143(.a(new_n306_), .b(x68), .O(new_n307_));
  aoi21  g144(.a(new_n307_), .b(new_n304_), .c(x01), .O(z48));
  ...
  nand2  g149(.a(new_n306_), .b(x70), .O(new_n314_));
  ...
  nand2  g155(.a(new_n306_), .b(x71), .O(new_n320_));
  ...
  nand2  g161(.a(new_n306_), .b(x72), .O(new_n326_));
  aoi21  g162(.a(new_n326_), .b(new_n325_), .c(x01), .O(z52));
  nand2  g163(.a(x84), .b(x83), .O(new_n330_));
  nor2   g164(.a(x80), .b(new_n154_), .O(new_n331_));
  nand3  g165(.a(new_n331_), .b(new_n235_), .c(new_n161_), .O(new_n332_));
  nor4   g166(.a(new_n332_), .b(new_n330_), .c(x82), .d(x81), .O(z55));
  nand2  g167(.a(new_n160_), .b(new_n159_), .O(new_n334_));
  nand2  g168(.a(new_n233_), .b(x76), .O(new_n335_));
  inv1   g169(.a(new_n168_), .O(new_n336_));
  xnor2a g170(.a(x84), .b(x81), .O(new_n337_));
  aoi21  g171(.a(new_n336_), .b(new_n167_), .c(new_n337_), .O(new_n338_));
  nand2  g172(.a(new_n338_), .b(new_n153_), .O(new_n339_));
  nand2  g173(.a(new_n339_), .b(new_n335_), .O(new_n340_));
  nand2  g174(.a(new_n340_), .b(x79), .O(new_n341_));
  nand4  g175(.a(new_n341_), .b(new_n334_), .c(new_n153_), .d(x00), .O(z56));
  nand4  g176(.a(x80), .b(new_n222_), .c(x43), .d(new_n238_), .O(new_n344_));
  oai22  g177(.a(new_n344_), .b(new_n221_), .c(new_n238_), .d(x40), .O(new_n345_));
  nand3  g178(.a(new_n345_), .b(new_n227_), .c(x79), .O(new_n346_));
  nor2   g179(.a(x79), .b(x78), .O(new_n347_));
  nand3  g180(.a(new_n347_), .b(new_n238_), .c(x40), .O(new_n348_));
  nand2  g181(.a(new_n348_), .b(new_n346_), .O(new_n349_));
  nand2  g182(.a(new_n349_), .b(x77), .O(new_n350_));
  oai21  g183(.a(new_n166_), .b(new_n230_), .c(new_n154_), .O(new_n351_));
  aoi21  g184(.a(new_n351_), .b(new_n350_), .c(x01), .O(z58));
  inv1   g185(.a(new_n347_), .O(new_n353_));
  aoi21  g186(.a(new_n226_), .b(new_n353_), .c(new_n152_), .O(new_n354_));
  oai21  g187(.a(new_n223_), .b(new_n221_), .c(new_n238_), .O(new_n355_));
  aoi21  g188(.a(new_n355_), .b(x79), .c(new_n226_), .O(new_n356_));
  oai21  g189(.a(new_n356_), .b(new_n354_), .c(x77), .O(new_n357_));
  nor2   g190(.a(x79), .b(x04), .O(new_n358_));
  inv1   g191(.a(new_n358_), .O(new_n359_));
  aoi21  g192(.a(new_n359_), .b(new_n357_), .c(x01), .O(z59));
  aoi21  g193(.a(new_n338_), .b(x79), .c(new_n358_), .O(new_n361_));
  aoi21  g194(.a(new_n361_), .b(new_n228_), .c(x01), .O(z60));
  nand3  g195(.a(x84), .b(x81), .c(x79), .O(new_n364_));
  oai21  g196(.a(x79), .b(new_n230_), .c(new_n364_), .O(new_n365_));
  nand2  g197(.a(new_n365_), .b(new_n159_), .O(new_n366_));
  nand2  g198(.a(new_n355_), .b(x79), .O(new_n367_));
  nand3  g199(.a(x81), .b(x79), .c(new_n230_), .O(new_n368_));
  ...
  nand2  g205(.a(new_n373_), .b(new_n168_), .O(new_n374_));
  aoi21  g206(.a(new_n374_), .b(new_n372_), .c(x01), .O(z62));
  oai21  g207(.a(new_n168_), .b(new_n166_), .c(new_n217_), .O(new_n376_));
  oai21  g208(.a(new_n233_), .b(x04), .c(new_n376_), .O(new_n377_));
  nand2  g209(.a(new_n171_), .b(x82), .O(new_n378_));
  inv1   g210(.a(new_n378_), .O(new_n379_));
  and2   g211(.a(new_n379_), .b(new_n377_), .O(z63));
  nand3  g212(.a(new_n377_), .b(x83), .c(x79), .O(new_n381_));
  aoi21  g213(.a(new_n381_), .b(new_n293_), .c(x01), .O(z64));
  nor2   g214(.a(new_n160_), .b(x04), .O(new_n383_));
  nor2   g215(.a(new_n239_), .b(x78), .O(new_n384_));
  oai21  g216(.a(new_n384_), .b(new_n383_), .c(x77), .O(new_n385_));
  nand2  g217(.a(new_n166_), .b(x81), .O(new_n386_));
  nand2  g218(.a(new_n171_), .b(x84), .O(new_n387_));
