// Benchmark "FAU" written by ABC on Fri Jul 10 18:19:03 2020
...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n289_, new_n291_, new_n293_, new_n299_, new_n306_, new_n307_,
  ...
  nor2   g107(.a(new_n221_), .b(x81), .O(new_n264_));
  ...
  inv1   g121(.a(new_n238_), .O(new_n278_));
  nand2  g122(.a(x83), .b(x42), .O(new_n279_));
  nand2  g123(.a(new_n279_), .b(new_n245_), .O(new_n280_));
  nand3  g124(.a(x83), .b(x81), .c(x42), .O(new_n281_));
  nand2  g125(.a(new_n281_), .b(new_n280_), .O(new_n282_));
  and2   g126(.a(new_n282_), .b(new_n246_), .O(new_n283_));
  nand2  g127(.a(new_n279_), .b(x81), .O(new_n284_));
  nand2  g128(.a(new_n264_), .b(x42), .O(new_n285_));
  aoi21  g129(.a(new_n285_), .b(new_n284_), .c(new_n242_), .O(new_n286_));
  oai21  g130(.a(new_n286_), .b(new_n283_), .c(new_n274_), .O(new_n287_));
  nor3   g131(.a(new_n287_), .b(new_n278_), .c(new_n277_), .O(z34));
  nand2  g132(.a(new_n238_), .b(x53), .O(new_n289_));
  nor2   g133(.a(new_n289_), .b(new_n287_), .O(z35));
  nand2  g134(.a(new_n238_), .b(x54), .O(new_n291_));
  nor2   g135(.a(new_n291_), .b(new_n287_), .O(z36));
  nand2  g136(.a(new_n238_), .b(x55), .O(new_n293_));
  nor2   g137(.a(new_n293_), .b(new_n287_), .O(z37));
  nor3   g138(.a(new_n287_), .b(new_n278_), .c(new_n197_), .O(z39));
  nor3   g139(.a(new_n287_), .b(new_n278_), .c(new_n194_), .O(z40));
  nor3   g140(.a(new_n287_), .b(new_n278_), .c(new_n191_), .O(z41));
  nand2  g141(.a(new_n238_), .b(x60), .O(new_n299_));
  nor2   g142(.a(new_n299_), .b(new_n287_), .O(z42));
  nor3   g143(.a(new_n287_), .b(new_n278_), .c(new_n187_), .O(z43));
  nor3   g144(.a(new_n287_), .b(new_n278_), .c(new_n184_), .O(z44));
  nor3   g145(.a(new_n287_), .b(new_n278_), .c(new_n178_), .O(z46));
  inv1   g146(.a(x08), .O(new_n306_));
  nand2  g147(.a(x52), .b(x16), .O(new_n307_));
  oai21  g148(.a(x52), .b(new_n306_), .c(new_n307_), .O(new_n308_));
  nor2   g149(.a(x79), .b(x77), .O(new_n309_));
  nand2  g150(.a(new_n309_), .b(new_n228_), .O(new_n310_));
  inv1   g151(.a(new_n310_), .O(new_n311_));
  nand2  g152(.a(new_n311_), .b(new_n308_), .O(new_n312_));
  inv1   g153(.a(new_n168_), .O(new_n313_));
  nand2  g154(.a(new_n313_), .b(x79), .O(new_n314_));
  inv1   g155(.a(new_n314_), .O(new_n315_));
  and2   g156(.a(new_n315_), .b(new_n218_), .O(new_n316_));
  nand2  g157(.a(new_n316_), .b(x68), .O(new_n317_));
  aoi21  g158(.a(new_n317_), .b(new_n312_), .c(x01), .O(z48));
  ...
  nand2  g166(.a(x52), .b(x18), .O(new_n326_));
  oai21  g167(.a(x52), .b(new_n325_), .c(new_n326_), .O(new_n327_));
  nand2  g168(.a(new_n327_), .b(new_n311_), .O(new_n328_));
  nand2  g169(.a(new_n316_), .b(x70), .O(new_n329_));
  aoi21  g170(.a(new_n329_), .b(new_n328_), .c(x01), .O(z50));
  inv1   g171(.a(x12), .O(new_n332_));
  nand2  g172(.a(x52), .b(x20), .O(new_n333_));
  oai21  g173(.a(x52), .b(new_n332_), .c(new_n333_), .O(new_n334_));
  nand2  g174(.a(new_n334_), .b(new_n311_), .O(new_n335_));
  ...
  nand2  g180(.a(new_n340_), .b(new_n311_), .O(new_n341_));
  nand2  g181(.a(new_n316_), .b(x73), .O(new_n342_));
  aoi21  g182(.a(new_n342_), .b(new_n341_), .c(x01), .O(z53));
  nand2  g183(.a(x52), .b(x22), .O(new_n344_));
  nand2  g184(.a(new_n277_), .b(x14), .O(new_n345_));
  inv1   g185(.a(new_n167_), .O(new_n346_));
  nand4  g186(.a(new_n346_), .b(new_n154_), .c(x04), .d(new_n153_), .O(new_n347_));
  aoi21  g187(.a(new_n345_), .b(new_n344_), .c(new_n347_), .O(z54));
  inv1   g188(.a(x82), .O(new_n349_));
  nand3  g189(.a(new_n264_), .b(x84), .c(new_n349_), .O(new_n350_));
  inv1   g190(.a(x80), .O(new_n351_));
  nand4  g191(.a(new_n238_), .b(new_n161_), .c(new_n351_), .d(x79), .O(new_n352_));
  nor2   g192(.a(new_n352_), .b(new_n350_), .O(z55));
  nand2  g193(.a(new_n236_), .b(x76), .O(new_n354_));
  xnor2a g194(.a(x84), .b(x81), .O(new_n355_));
  aoi21  g195(.a(new_n168_), .b(new_n167_), .c(new_n355_), .O(new_n356_));
  nand2  g196(.a(new_n356_), .b(new_n153_), .O(new_n357_));
  nand2  g197(.a(new_n357_), .b(new_n354_), .O(new_n358_));
  nand2  g198(.a(new_n358_), .b(x79), .O(new_n359_));
  nand3  g199(.a(new_n160_), .b(new_n159_), .c(new_n153_), .O(new_n360_));
  nand3  g200(.a(new_n360_), .b(new_n359_), .c(new_n234_), .O(z56));
  inv1   g201(.a(x02), .O(new_n362_));
  nand3  g202(.a(new_n234_), .b(x03), .c(new_n362_), .O(new_n363_));
  inv1   g203(.a(new_n363_), .O(z57));
  nand4  g204(.a(x80), .b(new_n223_), .c(x43), .d(new_n241_), .O(new_n365_));
  oai22  g205(.a(new_n365_), .b(new_n222_), .c(new_n241_), .d(x40), .O(new_n366_));
  nand3  g206(.a(new_n366_), .b(new_n228_), .c(x79), .O(new_n367_));
  nor2   g207(.a(x79), .b(x78), .O(new_n368_));
  nand3  g208(.a(new_n368_), .b(new_n241_), .c(x40), .O(new_n369_));
  nand2  g209(.a(new_n369_), .b(new_n367_), .O(new_n370_));
  nand2  g210(.a(new_n370_), .b(x77), .O(new_n371_));
  oai21  g211(.a(new_n346_), .b(new_n231_), .c(new_n154_), .O(new_n372_));
  aoi21  g212(.a(new_n372_), .b(new_n371_), .c(x01), .O(z58));
  inv1   g213(.a(new_n368_), .O(new_n374_));
  aoi21  g214(.a(new_n227_), .b(new_n374_), .c(new_n152_), .O(new_n375_));
  oai21  g215(.a(new_n224_), .b(new_n222_), .c(new_n241_), .O(new_n376_));
  aoi21  g216(.a(new_n376_), .b(x79), .c(new_n227_), .O(new_n377_));
  oai21  g217(.a(new_n377_), .b(new_n375_), .c(x77), .O(new_n378_));
  nor2   g218(.a(x79), .b(x04), .O(new_n379_));
  inv1   g219(.a(new_n379_), .O(new_n380_));
  aoi21  g220(.a(new_n380_), .b(new_n378_), .c(x01), .O(z59));
  aoi21  g221(.a(new_n356_), .b(x79), .c(new_n379_), .O(new_n382_));
  aoi21  g222(.a(new_n382_), .b(new_n229_), .c(x01), .O(z60));
  inv1   g223(.a(new_n170_), .O(new_n384_));
  nand2  g224(.a(new_n168_), .b(new_n167_), .O(new_n385_));
  aoi22  g225(.a(new_n385_), .b(new_n218_), .c(new_n161_), .d(new_n231_), .O(new_n386_));
  nor3   g226(.a(new_n386_), .b(new_n384_), .c(new_n351_), .O(z61));
  nand3  g227(.a(x84), .b(x81), .c(x79), .O(new_n388_));
  oai21  g228(.a(x79), .b(new_n231_), .c(new_n388_), .O(new_n389_));
  nand2  g229(.a(new_n389_), .b(new_n159_), .O(new_n390_));
  nand2  g230(.a(new_n376_), .b(x79), .O(new_n391_));
  nand3  g231(.a(x81), .b(x79), .c(new_n231_), .O(new_n392_));
  ...
  nand2  g237(.a(new_n397_), .b(new_n313_), .O(new_n398_));
  aoi21  g238(.a(new_n398_), .b(new_n396_), .c(x01), .O(z62));
  nor3   g239(.a(new_n386_), .b(new_n384_), .c(new_n349_), .O(z63));
  nand2  g240(.a(x83), .b(x79), .O(new_n401_));
  or2    g241(.a(new_n401_), .b(new_n386_), .O(new_n402_));
  aoi21  g242(.a(new_n402_), .b(new_n310_), .c(x01), .O(z64));
  nor2   g243(.a(new_n160_), .b(x04), .O(new_n404_));
  nor2   g244(.a(new_n245_), .b(x78), .O(new_n405_));
  oai21  g245(.a(new_n405_), .b(new_n404_), .c(x77), .O(new_n406_));
  nand2  g246(.a(new_n346_), .b(x81), .O(new_n407_));
  nand2  g247(.a(new_n170_), .b(x84), .O(new_n408_));
  aoi21  g248(.a(new_n407_), .b(new_n406_), .c(new_n408_), .O(z65));
  zero   g249(.O(z10));
  zero   g250(.O(z17));
  zero   g251(.O(z19));
  zero   g252(.O(z21));
