// Benchmark "FAU" written by ABC on Fri Jul 10 18:20:49 2020
...
module FAU ( 
  ...
  wire new_n154_, new_n155_, new_n156_, new_n157_, new_n158_, new_n159_,
    ...
    new_n235_, new_n236_, new_n239_, new_n240_, new_n241_, new_n245_,
    new_n246_, new_n247_, new_n248_, new_n249_, new_n250_, new_n251_,
    new_n252_, new_n253_, new_n254_, new_n256_, new_n258_, new_n261_,
    new_n263_, new_n265_, new_n268_, new_n271_, new_n273_, new_n275_,
    ...
    new_n333_, new_n336_, new_n337_, new_n344_, new_n345_, new_n346_;
  ...
  xnor2a g078(.a(x84), .b(x82), .O(new_n245_));
  nand2  g079(.a(x83), .b(x42), .O(new_n246_));
  nand2  g080(.a(new_n246_), .b(new_n209_), .O(new_n247_));
  nand3  g081(.a(x83), .b(x81), .c(x42), .O(new_n248_));
  aoi21  g082(.a(new_n248_), .b(new_n247_), .c(new_n245_), .O(new_n249_));
  nand2  g083(.a(new_n246_), .b(x81), .O(new_n250_));
  nand3  g084(.a(x83), .b(new_n209_), .c(x42), .O(new_n251_));
  aoi21  g085(.a(new_n251_), .b(new_n250_), .c(new_n210_), .O(new_n252_));
  oai21  g086(.a(new_n252_), .b(new_n249_), .c(new_n215_), .O(new_n253_));
  nand2  g087(.a(new_n217_), .b(x52), .O(new_n254_));
  nor2   g088(.a(new_n254_), .b(new_n253_), .O(z34));
  nand2  g089(.a(new_n217_), .b(x53), .O(new_n256_));
  nor2   g090(.a(new_n256_), .b(new_n253_), .O(z35));
  nand2  g091(.a(new_n217_), .b(x54), .O(new_n258_));
  nor2   g092(.a(new_n258_), .b(new_n253_), .O(z36));
  nand2  g093(.a(new_n217_), .b(x56), .O(new_n261_));
  nor2   g094(.a(new_n261_), .b(new_n253_), .O(z38));
  nand2  g095(.a(new_n217_), .b(x57), .O(new_n263_));
  nor2   g096(.a(new_n263_), .b(new_n253_), .O(z39));
  nand2  g097(.a(new_n217_), .b(x58), .O(new_n265_));
  nor2   g098(.a(new_n265_), .b(new_n253_), .O(z40));
  nand2  g099(.a(new_n217_), .b(x60), .O(new_n268_));
  nor2   g100(.a(new_n268_), .b(new_n253_), .O(z42));
  nand2  g101(.a(new_n217_), .b(x62), .O(new_n271_));
  nor2   g102(.a(new_n271_), .b(new_n253_), .O(z44));
  nand2  g103(.a(new_n217_), .b(x63), .O(new_n273_));
  nor2   g104(.a(new_n273_), .b(new_n253_), .O(z45));
  nand2  g105(.a(new_n217_), .b(x64), .O(new_n275_));
  nor2   g106(.a(new_n275_), .b(new_n253_), .O(z46));
  inv1   g107(.a(x07), .O(new_n277_));
  nand2  g108(.a(x52), .b(x15), .O(new_n278_));
  oai21  g109(.a(x52), .b(new_n277_), .c(new_n278_), .O(new_n279_));
  inv1   g110(.a(x04), .O(new_n280_));
  nor2   g111(.a(x77), .b(new_n280_), .O(new_n281_));
  nor2   g112(.a(x79), .b(new_n154_), .O(new_n282_));
  nand3  g113(.a(new_n282_), .b(new_n281_), .c(new_n279_), .O(new_n283_));
  xnor2a g114(.a(x84), .b(x81), .O(new_n284_));
  or2    g115(.a(x75), .b(x67), .O(new_n285_));
  nand4  g116(.a(new_n285_), .b(new_n284_), .c(new_n158_), .d(x79), .O(new_n286_));
  aoi21  g117(.a(new_n286_), .b(new_n283_), .c(x01), .O(z47));
  inv1   g118(.a(x08), .O(new_n288_));
  nand2  g119(.a(x52), .b(x16), .O(new_n289_));
  oai21  g120(.a(x52), .b(new_n288_), .c(new_n289_), .O(new_n290_));
  nand3  g121(.a(new_n290_), .b(new_n282_), .c(new_n281_), .O(new_n291_));
  nand4  g122(.a(new_n284_), .b(new_n158_), .c(x79), .d(x68), .O(new_n292_));
  aoi21  g123(.a(new_n292_), .b(new_n291_), .c(x01), .O(z48));
  inv1   g124(.a(x09), .O(new_n294_));
  nand2  g125(.a(x52), .b(x17), .O(new_n295_));
  oai21  g126(.a(x52), .b(new_n294_), .c(new_n295_), .O(new_n296_));
  nand3  g127(.a(new_n296_), .b(new_n282_), .c(new_n281_), .O(new_n297_));
  nand4  g128(.a(new_n284_), .b(new_n158_), .c(x79), .d(x69), .O(new_n298_));
  aoi21  g129(.a(new_n298_), .b(new_n297_), .c(x01), .O(z49));
  inv1   g130(.a(x10), .O(new_n300_));
  nand2  g131(.a(x52), .b(x18), .O(new_n301_));
  oai21  g132(.a(x52), .b(new_n300_), .c(new_n301_), .O(new_n302_));
  nand3  g133(.a(new_n302_), .b(new_n282_), .c(new_n281_), .O(new_n303_));
  nand4  g134(.a(new_n284_), .b(new_n158_), .c(x79), .d(x70), .O(new_n304_));
  ...
  nand3  g139(.a(new_n308_), .b(new_n282_), .c(new_n281_), .O(new_n309_));
  nand4  g140(.a(new_n284_), .b(new_n158_), .c(x79), .d(x71), .O(new_n310_));
  ...
  nand3  g145(.a(new_n314_), .b(new_n282_), .c(new_n281_), .O(new_n315_));
  nand4  g146(.a(new_n284_), .b(new_n158_), .c(x79), .d(x72), .O(new_n316_));
  ...
  nand3  g151(.a(new_n320_), .b(new_n282_), .c(new_n281_), .O(new_n321_));
  nand4  g152(.a(new_n284_), .b(new_n158_), .c(x79), .d(x73), .O(new_n322_));
  ...
  inv1   g157(.a(x79), .O(new_n327_));
  nand4  g158(.a(new_n155_), .b(new_n327_), .c(x04), .d(new_n160_), .O(new_n328_));
  nor2   g159(.a(new_n328_), .b(new_n326_), .O(z54));
  inv1   g160(.a(x82), .O(new_n330_));
  nand4  g161(.a(x84), .b(x83), .c(new_n330_), .d(new_n209_), .O(new_n331_));
  inv1   g162(.a(x80), .O(new_n332_));
  nand4  g163(.a(new_n332_), .b(x79), .c(x78), .d(x77), .O(new_n333_));
  nor4   g164(.a(new_n333_), .b(new_n331_), .c(x04), .d(x01), .O(z55));
  inv1   g165(.a(x02), .O(new_n336_));
  nand4  g166(.a(x03), .b(new_n336_), .c(new_n160_), .d(x00), .O(new_n337_));
  inv1   g167(.a(new_n337_), .O(z57));
  oai21  g168(.a(new_n158_), .b(new_n155_), .c(new_n284_), .O(new_n344_));
  nand3  g169(.a(x78), .b(x77), .c(new_n280_), .O(new_n345_));
