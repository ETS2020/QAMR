...
module FAU ( 
  ...
  nand2  g130(.a(new_n234_), .b(x57), .O(new_n290_));
  nor2   g131(.a(new_n290_), .b(new_n280_), .O(z39));
  nand2  g132(.a(new_n234_), .b(x58), .O(new_n292_));
  nor2   g133(.a(new_n292_), .b(new_n280_), .O(z40));
  inv1   g134(.a(new_n234_), .O(new_n294_));
  nor3   g135(.a(new_n280_), .b(new_n294_), .c(new_n191_), .O(z41));
  nor3   g136(.a(new_n280_), .b(new_n294_), .c(new_n188_), .O(z42));
  nor3   g137(.a(new_n280_), .b(new_n294_), .c(new_n185_), .O(z43));
  nor3   g138(.a(new_n280_), .b(new_n294_), .c(new_n179_), .O(z45));
  nor3   g139(.a(new_n280_), .b(new_n294_), .c(new_n176_), .O(z46));
  ...
  nand4  g188(.a(new_n234_), .b(new_n161_), .c(new_n350_), .d(x79), .O(new_n351_));
  ...
  oai21  g206(.a(new_n369_), .b(new_n229_), .c(new_n154_), .O(new_n370_));
  ...
  oai21  g210(.a(new_n222_), .b(new_n220_), .c(new_n237_), .O(new_n374_));
  ...
  aoi21  g216(.a(new_n356_), .b(x79), .c(new_n377_), .O(new_n380_));
