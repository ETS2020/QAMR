...
module FAU ( 
  ...
  wire new_n154_, new_n155_, new_n156_, new_n157_, new_n158_, new_n159_,
    ...
    new_n246_, new_n247_, new_n248_, new_n249_, new_n251_, new_n255_,
    new_n257_, new_n259_, new_n263_, new_n265_, new_n267_, new_n269_,
    new_n273_, new_n274_, new_n275_, new_n276_, new_n277_, new_n278_,
    new_n279_, new_n280_, new_n281_, new_n283_, new_n284_, new_n285_,
    new_n286_, new_n287_, new_n289_, new_n290_, new_n291_, new_n292_,
    new_n293_, new_n295_, new_n296_, new_n297_, new_n298_, new_n299_,
    new_n301_, new_n302_, new_n303_, new_n304_, new_n305_, new_n307_,
    new_n308_, new_n309_, new_n310_, new_n314_, new_n315_, new_n322_,
  ...
  xnor2a g071(.a(x84), .b(x82), .O(new_n240_));
  nand2  g072(.a(x83), .b(x42), .O(new_n241_));
  nand2  g073(.a(new_n241_), .b(new_n207_), .O(new_n242_));
  nand3  g074(.a(x83), .b(x81), .c(x42), .O(new_n243_));
  aoi21  g075(.a(new_n243_), .b(new_n242_), .c(new_n240_), .O(new_n244_));
  nand2  g076(.a(new_n241_), .b(x81), .O(new_n245_));
  nand3  g077(.a(x83), .b(new_n207_), .c(x42), .O(new_n246_));
  aoi21  g078(.a(new_n246_), .b(new_n245_), .c(new_n208_), .O(new_n247_));
  oai21  g079(.a(new_n247_), .b(new_n244_), .c(new_n213_), .O(new_n248_));
  nand2  g080(.a(new_n215_), .b(x52), .O(new_n249_));
  nor2   g081(.a(new_n249_), .b(new_n248_), .O(z34));
  nand2  g082(.a(new_n215_), .b(x53), .O(new_n251_));
  nor2   g083(.a(new_n251_), .b(new_n248_), .O(z35));
  nand2  g084(.a(new_n215_), .b(x56), .O(new_n255_));
  nor2   g085(.a(new_n255_), .b(new_n248_), .O(z38));
  nand2  g086(.a(new_n215_), .b(x57), .O(new_n257_));
  nor2   g087(.a(new_n257_), .b(new_n248_), .O(z39));
  nand2  g088(.a(new_n215_), .b(x58), .O(new_n259_));
  nor2   g089(.a(new_n259_), .b(new_n248_), .O(z40));
  ...
  nand2  g096(.a(new_n215_), .b(x64), .O(new_n269_));
  nor2   g097(.a(new_n269_), .b(new_n248_), .O(z46));
  inv1   g098(.a(x09), .O(new_n273_));
  nand2  g099(.a(x52), .b(x17), .O(new_n274_));
  oai21  g100(.a(x52), .b(new_n273_), .c(new_n274_), .O(new_n275_));
  inv1   g101(.a(x79), .O(new_n276_));
  nand4  g102(.a(new_n276_), .b(x78), .c(new_n157_), .d(x04), .O(new_n277_));
  inv1   g103(.a(new_n277_), .O(new_n278_));
  nand2  g104(.a(new_n278_), .b(new_n275_), .O(new_n279_));
  xnor2a g105(.a(x84), .b(x81), .O(new_n280_));
  nand4  g106(.a(new_n280_), .b(new_n158_), .c(x79), .d(x69), .O(new_n281_));
  aoi21  g107(.a(new_n281_), .b(new_n279_), .c(x01), .O(z49));
  inv1   g108(.a(x10), .O(new_n283_));
  nand2  g109(.a(x52), .b(x18), .O(new_n284_));
  oai21  g110(.a(x52), .b(new_n283_), .c(new_n284_), .O(new_n285_));
  nand2  g111(.a(new_n285_), .b(new_n278_), .O(new_n286_));
  nand4  g112(.a(new_n280_), .b(new_n158_), .c(x79), .d(x70), .O(new_n287_));
  aoi21  g113(.a(new_n287_), .b(new_n286_), .c(x01), .O(z50));
  inv1   g114(.a(x11), .O(new_n289_));
  nand2  g115(.a(x52), .b(x19), .O(new_n290_));
  oai21  g116(.a(x52), .b(new_n289_), .c(new_n290_), .O(new_n291_));
  nand2  g117(.a(new_n291_), .b(new_n278_), .O(new_n292_));
  nand4  g118(.a(new_n280_), .b(new_n158_), .c(x79), .d(x71), .O(new_n293_));
  aoi21  g119(.a(new_n293_), .b(new_n292_), .c(x01), .O(z51));
  inv1   g120(.a(x12), .O(new_n295_));
  nand2  g121(.a(x52), .b(x20), .O(new_n296_));
  oai21  g122(.a(x52), .b(new_n295_), .c(new_n296_), .O(new_n297_));
  nand2  g123(.a(new_n297_), .b(new_n278_), .O(new_n298_));
  nand4  g124(.a(new_n280_), .b(new_n158_), .c(x79), .d(x72), .O(new_n299_));
  aoi21  g125(.a(new_n299_), .b(new_n298_), .c(x01), .O(z52));
  inv1   g126(.a(x13), .O(new_n301_));
  nand2  g127(.a(x52), .b(x21), .O(new_n302_));
  oai21  g128(.a(x52), .b(new_n301_), .c(new_n302_), .O(new_n303_));
  nand2  g129(.a(new_n303_), .b(new_n278_), .O(new_n304_));
  nand4  g130(.a(new_n280_), .b(new_n158_), .c(x79), .d(x73), .O(new_n305_));
  aoi21  g131(.a(new_n305_), .b(new_n304_), .c(x01), .O(z53));
  inv1   g132(.a(x14), .O(new_n307_));
  nor2   g133(.a(x52), .b(new_n307_), .O(new_n308_));
  aoi21  g134(.a(x52), .b(x22), .c(new_n308_), .O(new_n309_));
  nand4  g135(.a(new_n155_), .b(new_n276_), .c(x04), .d(new_n160_), .O(new_n310_));
  nor2   g136(.a(new_n310_), .b(new_n309_), .O(z54));
  inv1   g137(.a(x02), .O(new_n314_));
  nand4  g138(.a(x03), .b(new_n314_), .c(new_n160_), .d(x00), .O(new_n315_));
  inv1   g139(.a(new_n315_), .O(z57));
  oai21  g140(.a(new_n158_), .b(new_n155_), .c(new_n280_), .O(new_n322_));
  inv1   g141(.a(x04), .O(new_n323_));
  nand3  g142(.a(x78), .b(x77), .c(new_n323_), .O(new_n324_));
  nand3  g143(.a(x82), .b(x79), .c(new_n160_), .O(new_n325_));
  aoi21  g144(.a(new_n324_), .b(new_n322_), .c(new_n325_), .O(z63));
  zero   g145(.O(z00));
  zero   g146(.O(z01));
  zero   g147(.O(z03));
  zero   g148(.O(z04));
