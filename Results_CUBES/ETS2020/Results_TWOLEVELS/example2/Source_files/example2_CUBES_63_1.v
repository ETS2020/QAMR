...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n286_, new_n288_, new_n290_, new_n297_, new_n299_, new_n300_,
  ...
  nand2  g110(.a(x83), .b(x42), .O(new_n271_));
  nand2  g111(.a(new_n271_), .b(new_n239_), .O(new_n272_));
  nand3  g112(.a(x83), .b(x81), .c(x42), .O(new_n273_));
  nand2  g113(.a(new_n273_), .b(new_n272_), .O(new_n274_));
  and2   g114(.a(new_n274_), .b(new_n240_), .O(new_n275_));
  nand2  g115(.a(new_n271_), .b(x81), .O(new_n276_));
  nand2  g116(.a(new_n257_), .b(x42), .O(new_n277_));
  aoi21  g117(.a(new_n277_), .b(new_n276_), .c(new_n236_), .O(new_n278_));
  oai21  g118(.a(new_n278_), .b(new_n275_), .c(new_n267_), .O(new_n279_));
  nand2  g119(.a(new_n232_), .b(x53), .O(new_n280_));
  nor2   g120(.a(new_n280_), .b(new_n279_), .O(z35));
  nand2  g121(.a(new_n232_), .b(x54), .O(new_n282_));
  nor2   g122(.a(new_n282_), .b(new_n279_), .O(z36));
  nand2  g123(.a(new_n232_), .b(x55), .O(new_n284_));
  nor2   g124(.a(new_n284_), .b(new_n279_), .O(z37));
  nand2  g125(.a(new_n232_), .b(x56), .O(new_n286_));
  nor2   g126(.a(new_n286_), .b(new_n279_), .O(z38));
  inv1   g127(.a(new_n232_), .O(new_n288_));
  nor3   g128(.a(new_n279_), .b(new_n288_), .c(new_n193_), .O(z39));
  nand2  g129(.a(new_n232_), .b(x58), .O(new_n290_));
  nor2   g130(.a(new_n290_), .b(new_n279_), .O(z40));
  nor3   g131(.a(new_n279_), .b(new_n288_), .c(new_n189_), .O(z41));
  nor3   g132(.a(new_n279_), .b(new_n288_), .c(new_n186_), .O(z42));
  nor3   g133(.a(new_n279_), .b(new_n288_), .c(new_n183_), .O(z43));
  nor3   g134(.a(new_n279_), .b(new_n288_), .c(new_n180_), .O(z44));
  nand2  g135(.a(new_n232_), .b(x64), .O(new_n297_));
  nor2   g136(.a(new_n297_), .b(new_n279_), .O(z46));
  ...
  nand4  g194(.a(new_n357_), .b(new_n351_), .c(new_n153_), .d(x00), .O(z56));
  nand4  g195(.a(x80), .b(new_n219_), .c(x43), .d(new_n235_), .O(new_n360_));
  oai22  g196(.a(new_n360_), .b(new_n218_), .c(new_n235_), .d(x40), .O(new_n361_));
  nand3  g197(.a(new_n361_), .b(new_n224_), .c(x79), .O(new_n362_));
  nor2   g198(.a(x79), .b(x78), .O(new_n363_));
  nand3  g199(.a(new_n363_), .b(new_n235_), .c(x40), .O(new_n364_));
  nand2  g200(.a(new_n364_), .b(new_n362_), .O(new_n365_));
  nand2  g201(.a(new_n365_), .b(x77), .O(new_n366_));
  oai21  g202(.a(new_n343_), .b(new_n227_), .c(new_n154_), .O(new_n367_));
  aoi21  g203(.a(new_n367_), .b(new_n366_), .c(x01), .O(z58));
  inv1   g204(.a(new_n363_), .O(new_n369_));
  aoi21  g205(.a(new_n223_), .b(new_n369_), .c(new_n152_), .O(new_n370_));
  oai21  g206(.a(new_n220_), .b(new_n218_), .c(new_n235_), .O(new_n371_));
  aoi21  g207(.a(new_n371_), .b(x79), .c(new_n223_), .O(new_n372_));
  ...
  aoi21  g213(.a(new_n377_), .b(new_n225_), .c(x01), .O(z60));
  inv1   g214(.a(new_n170_), .O(new_n379_));
  nand2  g215(.a(new_n168_), .b(new_n167_), .O(new_n380_));
  aoi22  g216(.a(new_n380_), .b(new_n214_), .c(new_n161_), .d(new_n227_), .O(new_n381_));
  nor3   g217(.a(new_n381_), .b(new_n379_), .c(new_n348_), .O(z61));
  nand3  g218(.a(x84), .b(x81), .c(x79), .O(new_n383_));
  oai21  g219(.a(x79), .b(new_n227_), .c(new_n383_), .O(new_n384_));
  nand2  g220(.a(new_n384_), .b(new_n159_), .O(new_n385_));
  nand2  g221(.a(new_n371_), .b(x79), .O(new_n386_));
  nand3  g222(.a(x81), .b(x79), .c(new_n227_), .O(new_n387_));
  ...
  nand2  g228(.a(new_n392_), .b(new_n307_), .O(new_n393_));
  aoi21  g229(.a(new_n393_), .b(new_n391_), .c(x01), .O(z62));
  nor3   g230(.a(new_n381_), .b(new_n379_), .c(new_n346_), .O(z63));
  nand2  g231(.a(x83), .b(x79), .O(new_n396_));
  or2    g232(.a(new_n396_), .b(new_n381_), .O(new_n397_));
  aoi21  g233(.a(new_n397_), .b(new_n303_), .c(x01), .O(z64));
  nor2   g234(.a(new_n160_), .b(x04), .O(new_n399_));
  nor2   g235(.a(new_n239_), .b(x78), .O(new_n400_));
  oai21  g236(.a(new_n400_), .b(new_n399_), .c(x77), .O(new_n401_));
  nand2  g237(.a(new_n343_), .b(x81), .O(new_n402_));
  nand2  g238(.a(new_n170_), .b(x84), .O(new_n403_));
  aoi21  g239(.a(new_n402_), .b(new_n401_), .c(new_n403_), .O(z65));
  zero   g240(.O(z06));
  zero   g241(.O(z07));
  zero   g242(.O(z12));
  zero   g243(.O(z16));
