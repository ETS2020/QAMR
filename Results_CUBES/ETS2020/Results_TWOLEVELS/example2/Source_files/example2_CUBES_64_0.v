...
module FAU ( 
  ...
  inv1   g145(.a(new_n217_), .O(new_n307_));
  ...
  nand2  g168(.a(new_n262_), .b(x14), .O(new_n332_));
  ...
  nand2  g219(.a(new_n383_), .b(new_n298_), .O(new_n384_));
  ...
  aoi21  g224(.a(new_n388_), .b(new_n294_), .c(x01), .O(z64));
