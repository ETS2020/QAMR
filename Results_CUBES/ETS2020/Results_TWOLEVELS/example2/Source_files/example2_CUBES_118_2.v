// Benchmark "FAU" written by ABC on Fri Jul 10 18:18:05 2020
...
module FAU ( 
  ...
  nand3  g072(.a(new_n221_), .b(x50), .c(new_n220_), .O(new_n238_));
  inv1   g073(.a(new_n238_), .O(new_n239_));
  nand3  g074(.a(new_n239_), .b(new_n219_), .c(new_n217_), .O(new_n240_));
  inv1   g075(.a(new_n240_), .O(z32));
  inv1   g076(.a(new_n214_), .O(new_n242_));
  xnor2a g077(.a(x83), .b(x81), .O(new_n243_));
  nand2  g078(.a(x42), .b(x05), .O(new_n244_));
  nand2  g079(.a(x51), .b(new_n220_), .O(new_n245_));
  oai22  g080(.a(new_n245_), .b(new_n213_), .c(new_n244_), .d(new_n243_), .O(new_n246_));
  ...
  nand2  g084(.a(new_n249_), .b(new_n215_), .O(new_n250_));
  nand2  g085(.a(new_n221_), .b(new_n219_), .O(new_n251_));
  ...
  nand2  g089(.a(new_n254_), .b(new_n213_), .O(new_n255_));
  ...
  nand3  g093(.a(x83), .b(new_n213_), .c(x42), .O(new_n259_));
  aoi21  g094(.a(new_n259_), .b(new_n258_), .c(new_n214_), .O(new_n260_));
  oai21  g095(.a(new_n260_), .b(new_n257_), .c(new_n219_), .O(new_n261_));
  nand2  g096(.a(new_n221_), .b(x52), .O(new_n262_));
  nor2   g097(.a(new_n262_), .b(new_n261_), .O(z34));
  nand2  g098(.a(new_n221_), .b(x56), .O(new_n267_));
  nor2   g099(.a(new_n267_), .b(new_n261_), .O(z38));
  nand2  g100(.a(new_n221_), .b(x57), .O(new_n269_));
  nor2   g101(.a(new_n269_), .b(new_n261_), .O(z39));
  nand2  g102(.a(new_n221_), .b(x58), .O(new_n271_));
  nor2   g103(.a(new_n271_), .b(new_n261_), .O(z40));
  nand2  g104(.a(new_n221_), .b(x59), .O(new_n273_));
  nor2   g105(.a(new_n273_), .b(new_n261_), .O(z41));
  nand2  g106(.a(new_n221_), .b(x60), .O(new_n275_));
  nor2   g107(.a(new_n275_), .b(new_n261_), .O(z42));
  nand2  g108(.a(new_n221_), .b(x61), .O(new_n277_));
  nor2   g109(.a(new_n277_), .b(new_n261_), .O(z43));
  nand2  g110(.a(new_n221_), .b(x62), .O(new_n279_));
  nor2   g111(.a(new_n279_), .b(new_n261_), .O(z44));
  nand2  g112(.a(new_n221_), .b(x63), .O(new_n281_));
  ...
  nand3  g139(.a(new_n308_), .b(new_n288_), .c(new_n163_), .O(new_n309_));
  nand4  g140(.a(new_n290_), .b(new_n158_), .c(x79), .d(x70), .O(new_n310_));
  ...
  nand3  g145(.a(new_n315_), .b(new_n288_), .c(new_n163_), .O(new_n316_));
  nand4  g146(.a(new_n290_), .b(new_n158_), .c(x79), .d(x72), .O(new_n317_));
  ...
  nand3  g151(.a(new_n321_), .b(new_n288_), .c(new_n163_), .O(new_n322_));
  nand4  g152(.a(new_n290_), .b(new_n158_), .c(x79), .d(x73), .O(new_n323_));
  aoi21  g153(.a(new_n323_), .b(new_n322_), .c(x01), .O(z53));
  inv1   g154(.a(x82), .O(new_n326_));
  nand2  g155(.a(x84), .b(new_n326_), .O(new_n327_));
  inv1   g156(.a(new_n221_), .O(new_n328_));
  nand2  g157(.a(x83), .b(new_n213_), .O(new_n329_));
  ...
  oai21  g164(.a(new_n158_), .b(new_n155_), .c(new_n290_), .O(new_n340_));
  nand3  g165(.a(x78), .b(x77), .c(new_n287_), .O(new_n341_));
  nand3  g166(.a(x80), .b(x79), .c(new_n160_), .O(new_n342_));
