...
module FAU ( 
  ...
  wire new_n154_, new_n155_, new_n156_, new_n157_, new_n158_, new_n159_,
    ...
    new_n242_, new_n245_, new_n246_, new_n247_, new_n250_, new_n251_,
    new_n252_, new_n253_, new_n254_, new_n255_, new_n256_, new_n257_,
    new_n258_, new_n259_, new_n262_, new_n265_, new_n267_, new_n269_,
  ...
  inv1   g007(.a(x24), .O(new_n164_));
  nand2  g008(.a(x64), .b(x40), .O(new_n165_));
  oai21  g009(.a(x40), .b(new_n164_), .c(new_n165_), .O(z06));
  inv1   g010(.a(x25), .O(new_n167_));
  nand2  g011(.a(x63), .b(x40), .O(new_n168_));
  oai21  g012(.a(x40), .b(new_n167_), .c(new_n168_), .O(z07));
  inv1   g013(.a(x28), .O(new_n172_));
  nand2  g014(.a(x60), .b(x40), .O(new_n173_));
  oai21  g015(.a(x40), .b(new_n172_), .c(new_n173_), .O(z10));
  ...
  nand3  g081(.a(new_n209_), .b(x50), .c(new_n219_), .O(new_n245_));
  inv1   g082(.a(new_n245_), .O(new_n246_));
  nand3  g083(.a(new_n246_), .b(new_n218_), .c(new_n216_), .O(new_n247_));
  inv1   g084(.a(new_n247_), .O(z32));
  xnor2a g085(.a(x84), .b(x82), .O(new_n250_));
  nand2  g086(.a(x83), .b(x42), .O(new_n251_));
  nand2  g087(.a(new_n251_), .b(new_n212_), .O(new_n252_));
  nand3  g088(.a(x83), .b(x81), .c(x42), .O(new_n253_));
  aoi21  g089(.a(new_n253_), .b(new_n252_), .c(new_n250_), .O(new_n254_));
  nand2  g090(.a(new_n251_), .b(x81), .O(new_n255_));
  nand3  g091(.a(x83), .b(new_n212_), .c(x42), .O(new_n256_));
  aoi21  g092(.a(new_n256_), .b(new_n255_), .c(new_n213_), .O(new_n257_));
  oai21  g093(.a(new_n257_), .b(new_n254_), .c(new_n218_), .O(new_n258_));
  nand2  g094(.a(new_n209_), .b(x52), .O(new_n259_));
  nor2   g095(.a(new_n259_), .b(new_n258_), .O(z34));
  nand2  g096(.a(new_n209_), .b(x54), .O(new_n262_));
  nor2   g097(.a(new_n262_), .b(new_n258_), .O(z36));
  nand2  g098(.a(new_n209_), .b(x56), .O(new_n265_));
  nor2   g099(.a(new_n265_), .b(new_n258_), .O(z38));
  nand2  g100(.a(new_n209_), .b(x57), .O(new_n267_));
  nor2   g101(.a(new_n267_), .b(new_n258_), .O(z39));
  nand2  g102(.a(new_n209_), .b(x58), .O(new_n269_));
  nor2   g103(.a(new_n269_), .b(new_n258_), .O(z40));
  nand2  g104(.a(new_n209_), .b(x59), .O(new_n271_));
  nor2   g105(.a(new_n271_), .b(new_n258_), .O(z41));
  nand2  g106(.a(new_n209_), .b(x60), .O(new_n273_));
  nor2   g107(.a(new_n273_), .b(new_n258_), .O(z42));
  nand2  g108(.a(new_n209_), .b(x61), .O(new_n275_));
  nor2   g109(.a(new_n275_), .b(new_n258_), .O(z43));
  nand2  g110(.a(new_n209_), .b(x62), .O(new_n277_));
  nor2   g111(.a(new_n277_), .b(new_n258_), .O(z44));
  nand2  g112(.a(new_n209_), .b(x63), .O(new_n279_));
  nor2   g113(.a(new_n279_), .b(new_n258_), .O(z45));
  nand2  g114(.a(new_n209_), .b(x64), .O(new_n281_));
  nor2   g115(.a(new_n281_), .b(new_n258_), .O(z46));
  inv1   g116(.a(x07), .O(new_n283_));
  nand2  g117(.a(x52), .b(x15), .O(new_n284_));
  oai21  g118(.a(x52), .b(new_n283_), .c(new_n284_), .O(new_n285_));
  nand4  g119(.a(new_n206_), .b(x78), .c(new_n154_), .d(x04), .O(new_n286_));
  inv1   g120(.a(new_n286_), .O(new_n287_));
  nand2  g121(.a(new_n287_), .b(new_n285_), .O(new_n288_));
  xor2a  g122(.a(x84), .b(x81), .O(new_n289_));
  inv1   g123(.a(new_n289_), .O(new_n290_));
  nor2   g124(.a(x75), .b(x67), .O(new_n291_));
  nand3  g125(.a(x79), .b(new_n156_), .c(x77), .O(new_n292_));
  nor2   g126(.a(new_n292_), .b(new_n291_), .O(new_n293_));
  nand2  g127(.a(new_n293_), .b(new_n290_), .O(new_n294_));
  aoi21  g128(.a(new_n294_), .b(new_n288_), .c(x01), .O(z47));
  inv1   g129(.a(x10), .O(new_n298_));
  nand2  g130(.a(x52), .b(x18), .O(new_n299_));
  oai21  g131(.a(x52), .b(new_n298_), .c(new_n299_), .O(new_n300_));
  nand2  g132(.a(new_n300_), .b(new_n287_), .O(new_n301_));
  nor2   g133(.a(new_n292_), .b(new_n289_), .O(new_n302_));
  nand2  g134(.a(new_n302_), .b(x70), .O(new_n303_));
  aoi21  g135(.a(new_n303_), .b(new_n301_), .c(x01), .O(z50));
  inv1   g136(.a(x11), .O(new_n305_));
  nand2  g137(.a(x52), .b(x19), .O(new_n306_));
  oai21  g138(.a(x52), .b(new_n305_), .c(new_n306_), .O(new_n307_));
  nand2  g139(.a(new_n307_), .b(new_n287_), .O(new_n308_));
  nand2  g140(.a(new_n302_), .b(x71), .O(new_n309_));
  aoi21  g141(.a(new_n309_), .b(new_n308_), .c(x01), .O(z51));
  inv1   g142(.a(x12), .O(new_n311_));
  nand2  g143(.a(x52), .b(x20), .O(new_n312_));
  oai21  g144(.a(x52), .b(new_n311_), .c(new_n312_), .O(new_n313_));
  nand2  g145(.a(new_n313_), .b(new_n287_), .O(new_n314_));
  nand2  g146(.a(new_n302_), .b(x72), .O(new_n315_));
  aoi21  g147(.a(new_n315_), .b(new_n314_), .c(x01), .O(z52));
  inv1   g148(.a(x13), .O(new_n317_));
  nand2  g149(.a(x52), .b(x21), .O(new_n318_));
  oai21  g150(.a(x52), .b(new_n317_), .c(new_n318_), .O(new_n319_));
  nand2  g151(.a(new_n319_), .b(new_n287_), .O(new_n320_));
  nand2  g152(.a(new_n302_), .b(x73), .O(new_n321_));
  aoi21  g153(.a(new_n321_), .b(new_n320_), .c(x01), .O(z53));
  inv1   g154(.a(x14), .O(new_n323_));
  nor2   g155(.a(x52), .b(new_n323_), .O(new_n324_));
  aoi21  g156(.a(x52), .b(x22), .c(new_n324_), .O(new_n325_));
  nor2   g157(.a(new_n156_), .b(x77), .O(new_n326_));
  nand4  g158(.a(new_n326_), .b(new_n206_), .c(x04), .d(new_n158_), .O(new_n327_));
  nor2   g159(.a(new_n327_), .b(new_n325_), .O(z54));
