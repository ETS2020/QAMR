...
module FAU ( 
  ...
  inv1   g016(.a(x63), .O(new_n171_));
  nand2  g017(.a(new_n152_), .b(x25), .O(new_n172_));
  oai21  g018(.a(new_n171_), .b(new_n152_), .c(new_n172_), .O(z07));
  ...
  nand2  g130(.a(new_n235_), .b(x56), .O(new_n290_));
  nor2   g131(.a(new_n290_), .b(new_n281_), .O(z38));
  inv1   g132(.a(new_n235_), .O(new_n292_));
  nor3   g133(.a(new_n281_), .b(new_n292_), .c(new_n189_), .O(z39));
  nor3   g134(.a(new_n281_), .b(new_n292_), .c(new_n186_), .O(z40));
  nor3   g135(.a(new_n281_), .b(new_n292_), .c(new_n183_), .O(z41));
  nor3   g136(.a(new_n281_), .b(new_n292_), .c(new_n180_), .O(z42));
  nor3   g137(.a(new_n281_), .b(new_n292_), .c(new_n177_), .O(z43));
  nor3   g138(.a(new_n281_), .b(new_n292_), .c(new_n171_), .O(z45));
  nand2  g139(.a(new_n235_), .b(x64), .O(new_n300_));
  nor2   g140(.a(new_n300_), .b(new_n281_), .O(z46));
  inv1   g141(.a(x08), .O(new_n303_));
  nand2  g142(.a(x52), .b(x16), .O(new_n304_));
  oai21  g143(.a(x52), .b(new_n303_), .c(new_n304_), .O(new_n305_));
  nand3  g144(.a(new_n225_), .b(new_n154_), .c(new_n159_), .O(new_n306_));
  inv1   g145(.a(new_n306_), .O(new_n307_));
  nand2  g146(.a(new_n307_), .b(new_n305_), .O(new_n308_));
  inv1   g147(.a(new_n213_), .O(new_n309_));
  nand2  g148(.a(new_n309_), .b(x79), .O(new_n310_));
  inv1   g149(.a(new_n310_), .O(new_n311_));
  and2   g150(.a(new_n311_), .b(new_n215_), .O(new_n312_));
  ...
  nand2  g156(.a(new_n318_), .b(new_n307_), .O(new_n319_));
  nand2  g157(.a(new_n312_), .b(x70), .O(new_n320_));
  ...
  nand2  g162(.a(new_n324_), .b(new_n307_), .O(new_n325_));
  nand2  g163(.a(new_n312_), .b(x71), .O(new_n326_));
  aoi21  g164(.a(new_n326_), .b(new_n325_), .c(x01), .O(z51));
  inv1   g165(.a(x13), .O(new_n329_));
  nand2  g166(.a(x52), .b(x21), .O(new_n330_));
  oai21  g167(.a(x52), .b(new_n329_), .c(new_n330_), .O(new_n331_));
  nand2  g168(.a(new_n331_), .b(new_n307_), .O(new_n332_));
  nand2  g169(.a(new_n312_), .b(x73), .O(new_n333_));
  aoi21  g170(.a(new_n333_), .b(new_n332_), .c(x01), .O(z53));
  inv1   g171(.a(x82), .O(new_n336_));
  nand3  g172(.a(new_n260_), .b(x84), .c(new_n336_), .O(new_n337_));
  inv1   g173(.a(x80), .O(new_n338_));
  nand4  g174(.a(new_n235_), .b(new_n161_), .c(new_n338_), .d(x79), .O(new_n339_));
  nor2   g175(.a(new_n339_), .b(new_n337_), .O(z55));
  nand2  g176(.a(new_n233_), .b(x76), .O(new_n341_));
  xnor2a g177(.a(x84), .b(x81), .O(new_n342_));
  aoi21  g178(.a(new_n213_), .b(new_n212_), .c(new_n342_), .O(new_n343_));
  ...
  nand3  g183(.a(new_n347_), .b(new_n346_), .c(new_n231_), .O(z56));
  inv1   g184(.a(x02), .O(new_n349_));
  nand3  g185(.a(new_n231_), .b(x03), .c(new_n349_), .O(new_n350_));
  inv1   g186(.a(new_n350_), .O(z57));
  nand4  g187(.a(x80), .b(new_n220_), .c(x43), .d(new_n238_), .O(new_n352_));
  oai22  g188(.a(new_n352_), .b(new_n219_), .c(new_n238_), .d(x40), .O(new_n353_));
  nand3  g189(.a(new_n353_), .b(new_n225_), .c(x79), .O(new_n354_));
  nor2   g190(.a(x79), .b(x78), .O(new_n355_));
  nand3  g191(.a(new_n355_), .b(new_n238_), .c(x40), .O(new_n356_));
  nand2  g192(.a(new_n356_), .b(new_n354_), .O(new_n357_));
  nand2  g193(.a(new_n357_), .b(x77), .O(new_n358_));
  inv1   g194(.a(new_n212_), .O(new_n359_));
  oai21  g195(.a(new_n359_), .b(new_n228_), .c(new_n154_), .O(new_n360_));
  aoi21  g196(.a(new_n360_), .b(new_n358_), .c(x01), .O(z58));
  inv1   g197(.a(new_n355_), .O(new_n362_));
  aoi21  g198(.a(new_n224_), .b(new_n362_), .c(new_n152_), .O(new_n363_));
  oai21  g199(.a(new_n221_), .b(new_n219_), .c(new_n238_), .O(new_n364_));
  aoi21  g200(.a(new_n364_), .b(x79), .c(new_n224_), .O(new_n365_));
  ...
  aoi21  g206(.a(new_n370_), .b(new_n226_), .c(x01), .O(z60));
  nand2  g207(.a(new_n213_), .b(new_n212_), .O(new_n372_));
  aoi22  g208(.a(new_n372_), .b(new_n215_), .c(new_n161_), .d(new_n228_), .O(new_n373_));
  ...
  oai21  g213(.a(x79), .b(new_n228_), .c(new_n377_), .O(new_n378_));
  nand2  g214(.a(new_n378_), .b(new_n159_), .O(new_n379_));
  nand2  g215(.a(new_n364_), .b(x79), .O(new_n380_));
  nand3  g216(.a(x81), .b(x79), .c(new_n228_), .O(new_n381_));
  ...
  nor2   g229(.a(new_n242_), .b(x78), .O(new_n394_));
