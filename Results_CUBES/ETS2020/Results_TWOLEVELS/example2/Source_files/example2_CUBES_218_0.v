...
module FAU ( 
  ...
  inv1   g117(.a(new_n236_), .O(new_n275_));
  nand2  g118(.a(x83), .b(x42), .O(new_n276_));
  nand2  g119(.a(new_n276_), .b(new_n244_), .O(new_n277_));
  nand3  g120(.a(x83), .b(x81), .c(x42), .O(new_n278_));
  nand2  g121(.a(new_n278_), .b(new_n277_), .O(new_n279_));
  and2   g122(.a(new_n279_), .b(new_n245_), .O(new_n280_));
  nand2  g123(.a(new_n276_), .b(x81), .O(new_n281_));
  nand2  g124(.a(new_n261_), .b(x42), .O(new_n282_));
  aoi21  g125(.a(new_n282_), .b(new_n281_), .c(new_n241_), .O(new_n283_));
  oai21  g126(.a(new_n283_), .b(new_n280_), .c(new_n271_), .O(new_n284_));
  nor3   g127(.a(new_n284_), .b(new_n275_), .c(new_n274_), .O(z34));
  nand2  g128(.a(new_n236_), .b(x53), .O(new_n286_));
  nor2   g129(.a(new_n286_), .b(new_n284_), .O(z35));
  nand2  g130(.a(new_n236_), .b(x54), .O(new_n288_));
  nor2   g131(.a(new_n288_), .b(new_n284_), .O(z36));
  nand2  g132(.a(new_n236_), .b(x55), .O(new_n290_));
  nor2   g133(.a(new_n290_), .b(new_n284_), .O(z37));
  nor3   g134(.a(new_n284_), .b(new_n275_), .c(new_n194_), .O(z40));
  nor3   g135(.a(new_n284_), .b(new_n275_), .c(new_n191_), .O(z41));
  nor3   g136(.a(new_n284_), .b(new_n275_), .c(new_n185_), .O(z43));
  nand2  g137(.a(new_n236_), .b(x63), .O(new_n299_));
  nor2   g138(.a(new_n299_), .b(new_n284_), .O(z45));
  nor3   g139(.a(new_n284_), .b(new_n275_), .c(new_n178_), .O(z46));
  inv1   g140(.a(x08), .O(new_n303_));
  nand2  g141(.a(x52), .b(x16), .O(new_n304_));
  oai21  g142(.a(x52), .b(new_n303_), .c(new_n304_), .O(new_n305_));
  nand3  g143(.a(new_n228_), .b(new_n154_), .c(new_n159_), .O(new_n306_));
  inv1   g144(.a(new_n306_), .O(new_n307_));
  nand2  g145(.a(new_n307_), .b(new_n305_), .O(new_n308_));
  inv1   g146(.a(new_n168_), .O(new_n309_));
  nand2  g147(.a(new_n309_), .b(x79), .O(new_n310_));
  inv1   g148(.a(new_n310_), .O(new_n311_));
  and2   g149(.a(new_n311_), .b(new_n218_), .O(new_n312_));
  ...
  inv1   g158(.a(x11), .O(new_n322_));
  nand2  g159(.a(x52), .b(x19), .O(new_n323_));
  oai21  g160(.a(x52), .b(new_n322_), .c(new_n323_), .O(new_n324_));
  nand2  g161(.a(new_n324_), .b(new_n307_), .O(new_n325_));
  nand2  g162(.a(new_n312_), .b(x71), .O(new_n326_));
  aoi21  g163(.a(new_n326_), .b(new_n325_), .c(x01), .O(z51));
  ...
  nand2  g171(.a(new_n274_), .b(x14), .O(new_n336_));
  inv1   g172(.a(new_n167_), .O(new_n337_));
  ...
  nand3  g176(.a(new_n261_), .b(x84), .c(new_n340_), .O(new_n341_));
  inv1   g177(.a(x80), .O(new_n342_));
  nand4  g178(.a(new_n236_), .b(new_n161_), .c(new_n342_), .d(x79), .O(new_n343_));
  nor2   g179(.a(new_n343_), .b(new_n341_), .O(z55));
  nand2  g180(.a(new_n160_), .b(new_n159_), .O(new_n345_));
  nand2  g181(.a(new_n234_), .b(x76), .O(new_n346_));
  xnor2a g182(.a(x84), .b(x81), .O(new_n347_));
  aoi21  g183(.a(new_n168_), .b(new_n167_), .c(new_n347_), .O(new_n348_));
  nand2  g184(.a(new_n348_), .b(new_n153_), .O(new_n349_));
  nand2  g185(.a(new_n349_), .b(new_n346_), .O(new_n350_));
  nand2  g186(.a(new_n350_), .b(x79), .O(new_n351_));
  nand4  g187(.a(new_n351_), .b(new_n345_), .c(new_n153_), .d(x00), .O(z56));
  nand4  g188(.a(x80), .b(new_n223_), .c(x43), .d(new_n240_), .O(new_n354_));
  oai22  g189(.a(new_n354_), .b(new_n222_), .c(new_n240_), .d(x40), .O(new_n355_));
  nand3  g190(.a(new_n355_), .b(new_n228_), .c(x79), .O(new_n356_));
  nor2   g191(.a(x79), .b(x78), .O(new_n357_));
  nand3  g192(.a(new_n357_), .b(new_n240_), .c(x40), .O(new_n358_));
  nand2  g193(.a(new_n358_), .b(new_n356_), .O(new_n359_));
  nand2  g194(.a(new_n359_), .b(x77), .O(new_n360_));
  oai21  g195(.a(new_n337_), .b(new_n231_), .c(new_n154_), .O(new_n361_));
  aoi21  g196(.a(new_n361_), .b(new_n360_), .c(x01), .O(z58));
  inv1   g197(.a(new_n357_), .O(new_n363_));
  aoi21  g198(.a(new_n227_), .b(new_n363_), .c(new_n152_), .O(new_n364_));
  oai21  g199(.a(new_n224_), .b(new_n222_), .c(new_n240_), .O(new_n365_));
  aoi21  g200(.a(new_n365_), .b(x79), .c(new_n227_), .O(new_n366_));
  ...
  aoi21  g205(.a(new_n348_), .b(x79), .c(new_n368_), .O(new_n371_));
  aoi21  g206(.a(new_n371_), .b(new_n229_), .c(x01), .O(z60));
  inv1   g207(.a(new_n170_), .O(new_n373_));
  nand2  g208(.a(new_n168_), .b(new_n167_), .O(new_n374_));
  aoi22  g209(.a(new_n374_), .b(new_n218_), .c(new_n161_), .d(new_n231_), .O(new_n375_));
  nor3   g210(.a(new_n375_), .b(new_n373_), .c(new_n342_), .O(z61));
  nand3  g211(.a(x84), .b(x81), .c(x79), .O(new_n377_));
  oai21  g212(.a(x79), .b(new_n231_), .c(new_n377_), .O(new_n378_));
  nand2  g213(.a(new_n378_), .b(new_n159_), .O(new_n379_));
  nand2  g214(.a(new_n365_), .b(x79), .O(new_n380_));
  nand3  g215(.a(x81), .b(x79), .c(new_n231_), .O(new_n381_));
  ...
  nor3   g223(.a(new_n375_), .b(new_n373_), .c(new_n340_), .O(z63));
  ...
  nand2  g230(.a(new_n337_), .b(x81), .O(new_n396_));
