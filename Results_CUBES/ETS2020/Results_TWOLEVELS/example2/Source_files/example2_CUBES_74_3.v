...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n189_, new_n190_, new_n196_, new_n197_, new_n199_, new_n200_,
    ...
    new_n294_, new_n295_, new_n297_, new_n300_, new_n302_, new_n306_,
    new_n308_, new_n310_, new_n312_, new_n316_, new_n317_, new_n318_,
  ...
  inv1   g040(.a(x30), .O(new_n196_));
  nand2  g041(.a(x58), .b(x40), .O(new_n197_));
  oai21  g042(.a(x40), .b(new_n196_), .c(new_n197_), .O(z12));
  ...
  nand2  g148(.a(new_n244_), .b(x59), .O(new_n306_));
  nor2   g149(.a(new_n306_), .b(new_n295_), .O(z41));
  nand2  g150(.a(new_n244_), .b(x60), .O(new_n308_));
  nor2   g151(.a(new_n308_), .b(new_n295_), .O(z42));
  nand2  g152(.a(new_n244_), .b(x61), .O(new_n310_));
  nor2   g153(.a(new_n310_), .b(new_n295_), .O(z43));
  nand2  g154(.a(new_n244_), .b(x62), .O(new_n312_));
  nor2   g155(.a(new_n312_), .b(new_n295_), .O(z44));
  nor3   g156(.a(new_n295_), .b(new_n286_), .c(new_n189_), .O(z45));
  nor3   g157(.a(new_n295_), .b(new_n286_), .c(new_n186_), .O(z46));
  inv1   g158(.a(x07), .O(new_n316_));
  nand2  g159(.a(x52), .b(x15), .O(new_n317_));
  oai21  g160(.a(x52), .b(new_n316_), .c(new_n317_), .O(new_n318_));
  nand3  g161(.a(new_n229_), .b(new_n154_), .c(new_n159_), .O(new_n319_));
  inv1   g162(.a(new_n319_), .O(new_n320_));
  nand2  g163(.a(new_n320_), .b(new_n318_), .O(new_n321_));
  nor2   g164(.a(x75), .b(x67), .O(new_n322_));
  nand2  g165(.a(new_n171_), .b(x79), .O(new_n323_));
  nor2   g166(.a(new_n323_), .b(new_n322_), .O(new_n324_));
  nand2  g167(.a(new_n324_), .b(new_n226_), .O(new_n325_));
  aoi21  g168(.a(new_n325_), .b(new_n321_), .c(x01), .O(z47));
  inv1   g169(.a(x08), .O(new_n327_));
  nand2  g170(.a(x52), .b(x16), .O(new_n328_));
  oai21  g171(.a(x52), .b(new_n327_), .c(new_n328_), .O(new_n329_));
  nand2  g172(.a(new_n329_), .b(new_n320_), .O(new_n330_));
  inv1   g173(.a(new_n226_), .O(new_n331_));
  nor2   g174(.a(new_n323_), .b(new_n331_), .O(new_n332_));
  nand2  g175(.a(new_n332_), .b(x68), .O(new_n333_));
  aoi21  g176(.a(new_n333_), .b(new_n330_), .c(x01), .O(z48));
  inv1   g177(.a(x09), .O(new_n335_));
  nand2  g178(.a(x52), .b(x17), .O(new_n336_));
  oai21  g179(.a(x52), .b(new_n335_), .c(new_n336_), .O(new_n337_));
  nand2  g180(.a(new_n337_), .b(new_n320_), .O(new_n338_));
  nand2  g181(.a(new_n332_), .b(x69), .O(new_n339_));
  aoi21  g182(.a(new_n339_), .b(new_n338_), .c(x01), .O(z49));
  inv1   g183(.a(x11), .O(new_n342_));
  nand2  g184(.a(x52), .b(x19), .O(new_n343_));
  oai21  g185(.a(x52), .b(new_n342_), .c(new_n343_), .O(new_n344_));
  nand2  g186(.a(new_n344_), .b(new_n320_), .O(new_n345_));
  nand2  g187(.a(new_n332_), .b(x71), .O(new_n346_));
  aoi21  g188(.a(new_n346_), .b(new_n345_), .c(x01), .O(z51));
  inv1   g189(.a(x12), .O(new_n348_));
  nand2  g190(.a(x52), .b(x20), .O(new_n349_));
  oai21  g191(.a(x52), .b(new_n348_), .c(new_n349_), .O(new_n350_));
  nand2  g192(.a(new_n350_), .b(new_n320_), .O(new_n351_));
  nand2  g193(.a(new_n332_), .b(x72), .O(new_n352_));
  aoi21  g194(.a(new_n352_), .b(new_n351_), .c(x01), .O(z52));
  inv1   g195(.a(x13), .O(new_n354_));
  nand2  g196(.a(x52), .b(x21), .O(new_n355_));
  oai21  g197(.a(x52), .b(new_n354_), .c(new_n355_), .O(new_n356_));
  nand2  g198(.a(new_n356_), .b(new_n320_), .O(new_n357_));
  nand2  g199(.a(new_n332_), .b(x73), .O(new_n358_));
  aoi21  g200(.a(new_n358_), .b(new_n357_), .c(x01), .O(z53));
  nand2  g201(.a(x52), .b(x22), .O(new_n360_));
  nand2  g202(.a(new_n285_), .b(x14), .O(new_n361_));
  nand4  g203(.a(new_n169_), .b(new_n154_), .c(x04), .d(new_n153_), .O(new_n362_));
  aoi21  g204(.a(new_n361_), .b(new_n360_), .c(new_n362_), .O(z54));
  inv1   g205(.a(x84), .O(new_n364_));
  inv1   g206(.a(new_n272_), .O(new_n365_));
  nor2   g207(.a(x80), .b(new_n154_), .O(new_n366_));
  nand3  g208(.a(new_n366_), .b(new_n244_), .c(new_n165_), .O(new_n367_));
  nor4   g209(.a(new_n367_), .b(new_n365_), .c(new_n364_), .d(x82), .O(z55));
  nand2  g210(.a(new_n242_), .b(x76), .O(new_n369_));
  inv1   g211(.a(new_n171_), .O(new_n370_));
  xnor2a g212(.a(x84), .b(x81), .O(new_n371_));
  aoi21  g213(.a(new_n370_), .b(new_n170_), .c(new_n371_), .O(new_n372_));
  ...
  nor2   g217(.a(x77), .b(x01), .O(new_n376_));
  aoi21  g218(.a(new_n376_), .b(new_n164_), .c(new_n239_), .O(new_n377_));
  nand2  g219(.a(new_n377_), .b(new_n375_), .O(z56));
  inv1   g220(.a(x02), .O(new_n379_));
  nand3  g221(.a(new_n240_), .b(x03), .c(new_n379_), .O(new_n380_));
  inv1   g222(.a(new_n380_), .O(z57));
  nand4  g223(.a(x80), .b(new_n232_), .c(x43), .d(new_n247_), .O(new_n382_));
  oai22  g224(.a(new_n382_), .b(new_n231_), .c(new_n247_), .d(x40), .O(new_n383_));
  nand3  g225(.a(new_n383_), .b(new_n229_), .c(x79), .O(new_n384_));
  nand3  g226(.a(new_n179_), .b(new_n247_), .c(x40), .O(new_n385_));
  nand2  g227(.a(new_n385_), .b(new_n384_), .O(new_n386_));
  nand2  g228(.a(new_n386_), .b(x77), .O(new_n387_));
  oai21  g229(.a(new_n169_), .b(new_n160_), .c(new_n154_), .O(new_n388_));
  aoi21  g230(.a(new_n388_), .b(new_n387_), .c(x01), .O(z58));
  aoi21  g231(.a(new_n163_), .b(new_n180_), .c(new_n152_), .O(new_n390_));
  oai21  g232(.a(new_n233_), .b(new_n231_), .c(new_n247_), .O(new_n391_));
  aoi21  g233(.a(new_n391_), .b(x79), .c(new_n163_), .O(new_n392_));
  ...
  aoi21  g238(.a(new_n372_), .b(x79), .c(new_n394_), .O(new_n397_));
  aoi21  g239(.a(new_n397_), .b(new_n236_), .c(x01), .O(z60));
  oai21  g240(.a(new_n171_), .b(new_n169_), .c(new_n226_), .O(new_n399_));
  oai21  g241(.a(new_n242_), .b(x04), .c(new_n399_), .O(new_n400_));
  nand2  g242(.a(new_n174_), .b(x80), .O(new_n401_));
  inv1   g243(.a(new_n401_), .O(new_n402_));
  and2   g244(.a(new_n402_), .b(new_n400_), .O(z61));
  ...
  nand2  g248(.a(new_n391_), .b(x79), .O(new_n407_));
  ...
  nand3  g257(.a(new_n400_), .b(x83), .c(x79), .O(new_n417_));
  nand3  g258(.a(new_n176_), .b(new_n159_), .c(x04), .O(new_n418_));
  aoi21  g259(.a(new_n418_), .b(new_n417_), .c(x01), .O(z64));
  nor2   g260(.a(new_n164_), .b(x04), .O(new_n420_));
  nor2   g261(.a(new_n251_), .b(x78), .O(new_n421_));
  oai21  g262(.a(new_n421_), .b(new_n420_), .c(x77), .O(new_n422_));
  nand2  g263(.a(new_n169_), .b(x81), .O(new_n423_));
  nand2  g264(.a(new_n174_), .b(x84), .O(new_n424_));
  aoi21  g265(.a(new_n423_), .b(new_n422_), .c(new_n424_), .O(z65));
  zero   g266(.O(z08));
  zero   g267(.O(z09));
  zero   g268(.O(z10));
  zero   g269(.O(z11));
