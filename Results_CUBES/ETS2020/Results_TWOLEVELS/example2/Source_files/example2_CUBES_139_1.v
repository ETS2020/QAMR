...
module FAU ( 
  ...
  nand2  g142(.a(new_n303_), .b(new_n226_), .O(new_n304_));
  ...
  nand2  g149(.a(new_n310_), .b(new_n216_), .O(new_n311_));
  ...
  inv1   g155(.a(new_n216_), .O(new_n317_));
  ...
  nand2  g174(.a(new_n337_), .b(new_n305_), .O(new_n338_));
  nand2  g175(.a(new_n318_), .b(x73), .O(new_n339_));
  aoi21  g176(.a(new_n339_), .b(new_n338_), .c(x01), .O(z53));
  inv1   g177(.a(x82), .O(new_n342_));
  nand3  g178(.a(new_n261_), .b(x84), .c(new_n342_), .O(new_n343_));
  inv1   g179(.a(x80), .O(new_n344_));
  nand4  g180(.a(new_n234_), .b(new_n161_), .c(new_n344_), .d(x79), .O(new_n345_));
  nor2   g181(.a(new_n345_), .b(new_n343_), .O(z55));
  nand2  g182(.a(new_n160_), .b(new_n159_), .O(new_n347_));
  nand2  g183(.a(new_n232_), .b(x76), .O(new_n348_));
  ...
  nand4  g190(.a(x80), .b(new_n221_), .c(x43), .d(new_n237_), .O(new_n356_));
  oai22  g191(.a(new_n356_), .b(new_n220_), .c(new_n237_), .d(x40), .O(new_n357_));
  nand3  g192(.a(new_n357_), .b(new_n226_), .c(x79), .O(new_n358_));
  ...
  inv1   g197(.a(new_n167_), .O(new_n363_));
  oai21  g198(.a(new_n363_), .b(new_n229_), .c(new_n154_), .O(new_n364_));
  aoi21  g199(.a(new_n364_), .b(new_n362_), .c(x01), .O(z58));
  inv1   g200(.a(new_n359_), .O(new_n366_));
  aoi21  g201(.a(new_n225_), .b(new_n366_), .c(new_n152_), .O(new_n367_));
  oai21  g202(.a(new_n222_), .b(new_n220_), .c(new_n237_), .O(new_n368_));
  aoi21  g203(.a(new_n368_), .b(x79), .c(new_n225_), .O(new_n369_));
  oai21  g204(.a(new_n369_), .b(new_n367_), .c(x77), .O(new_n370_));
  nor2   g205(.a(x79), .b(x04), .O(new_n371_));
  inv1   g206(.a(new_n371_), .O(new_n372_));
  aoi21  g207(.a(new_n372_), .b(new_n370_), .c(x01), .O(z59));
  aoi21  g208(.a(new_n350_), .b(x79), .c(new_n371_), .O(new_n374_));
  aoi21  g209(.a(new_n374_), .b(new_n227_), .c(x01), .O(z60));
  inv1   g210(.a(new_n170_), .O(new_n376_));
  nand2  g211(.a(new_n168_), .b(new_n167_), .O(new_n377_));
  aoi22  g212(.a(new_n377_), .b(new_n216_), .c(new_n161_), .d(new_n229_), .O(new_n378_));
  nor3   g213(.a(new_n378_), .b(new_n376_), .c(new_n344_), .O(z61));
  nand3  g214(.a(x84), .b(x81), .c(x79), .O(new_n380_));
  oai21  g215(.a(x79), .b(new_n229_), .c(new_n380_), .O(new_n381_));
  nand2  g216(.a(new_n381_), .b(new_n159_), .O(new_n382_));
  nand2  g217(.a(new_n368_), .b(x79), .O(new_n383_));
  nand3  g218(.a(x81), .b(x79), .c(new_n229_), .O(new_n384_));
  inv1   g219(.a(new_n384_), .O(new_n385_));
  aoi21  g220(.a(new_n383_), .b(x04), .c(new_n385_), .O(new_n386_));
  oai21  g221(.a(new_n386_), .b(new_n159_), .c(new_n382_), .O(new_n387_));
  nand2  g222(.a(new_n387_), .b(x78), .O(new_n388_));
  inv1   g223(.a(new_n380_), .O(new_n389_));
  nand2  g224(.a(new_n389_), .b(new_n308_), .O(new_n390_));
  aoi21  g225(.a(new_n390_), .b(new_n388_), .c(x01), .O(z62));
  nor3   g226(.a(new_n378_), .b(new_n376_), .c(new_n342_), .O(z63));
  nand2  g227(.a(x83), .b(x79), .O(new_n393_));
  or2    g228(.a(new_n393_), .b(new_n378_), .O(new_n394_));
  aoi21  g229(.a(new_n394_), .b(new_n304_), .c(x01), .O(z64));
  nor2   g230(.a(new_n160_), .b(x04), .O(new_n396_));
  nor2   g231(.a(new_n241_), .b(x78), .O(new_n397_));
  oai21  g232(.a(new_n397_), .b(new_n396_), .c(x77), .O(new_n398_));
  nand2  g233(.a(new_n363_), .b(x81), .O(new_n399_));
