...
module FAU ( 
  ...
  nand3  g081(.a(new_n213_), .b(x48), .c(new_n223_), .O(new_n244_));
  inv1   g082(.a(new_n244_), .O(new_n245_));
  nand3  g083(.a(new_n245_), .b(new_n222_), .c(new_n220_), .O(new_n246_));
  inv1   g084(.a(new_n246_), .O(z30));
  nand3  g085(.a(new_n213_), .b(x49), .c(new_n223_), .O(new_n248_));
  inv1   g086(.a(new_n248_), .O(new_n249_));
  nand3  g087(.a(new_n249_), .b(new_n222_), .c(new_n220_), .O(new_n250_));
  ...
  nand2  g111(.a(new_n213_), .b(x55), .O(new_n277_));
  nor2   g112(.a(new_n277_), .b(new_n272_), .O(z37));
  nand2  g113(.a(new_n213_), .b(x56), .O(new_n279_));
  nor2   g114(.a(new_n279_), .b(new_n272_), .O(z38));
  nand2  g115(.a(new_n213_), .b(x57), .O(new_n281_));
  nor2   g116(.a(new_n281_), .b(new_n272_), .O(z39));
  nand2  g117(.a(new_n213_), .b(x58), .O(new_n283_));
  nor2   g118(.a(new_n283_), .b(new_n272_), .O(z40));
  nand2  g119(.a(new_n213_), .b(x59), .O(new_n285_));
  nor2   g120(.a(new_n285_), .b(new_n272_), .O(z41));
  nand2  g121(.a(new_n213_), .b(x60), .O(new_n287_));
  nor2   g122(.a(new_n287_), .b(new_n272_), .O(z42));
  nand2  g123(.a(new_n213_), .b(x62), .O(new_n290_));
  nor2   g124(.a(new_n290_), .b(new_n272_), .O(z44));
  nand2  g125(.a(new_n213_), .b(x63), .O(new_n292_));
  nor2   g126(.a(new_n292_), .b(new_n272_), .O(z45));
  inv1   g127(.a(x07), .O(new_n295_));
  nand2  g128(.a(x52), .b(x15), .O(new_n296_));
  oai21  g129(.a(x52), .b(new_n295_), .c(new_n296_), .O(new_n297_));
  inv1   g130(.a(x04), .O(new_n298_));
  nor2   g131(.a(x77), .b(new_n298_), .O(new_n299_));
  nand3  g132(.a(new_n299_), .b(new_n297_), .c(new_n165_), .O(new_n300_));
  xnor2a g133(.a(x84), .b(x81), .O(new_n301_));
  or2    g134(.a(x75), .b(x67), .O(new_n302_));
  nand4  g135(.a(new_n302_), .b(new_n301_), .c(new_n158_), .d(x79), .O(new_n303_));
  ...
  nand3  g140(.a(new_n307_), .b(new_n299_), .c(new_n165_), .O(new_n308_));
  nand4  g141(.a(new_n301_), .b(new_n158_), .c(x79), .d(x68), .O(new_n309_));
  aoi21  g142(.a(new_n309_), .b(new_n308_), .c(x01), .O(z48));
  inv1   g143(.a(x10), .O(new_n312_));
  nand2  g144(.a(x52), .b(x18), .O(new_n313_));
  oai21  g145(.a(x52), .b(new_n312_), .c(new_n313_), .O(new_n314_));
  nand3  g146(.a(new_n314_), .b(new_n299_), .c(new_n165_), .O(new_n315_));
  nand4  g147(.a(new_n301_), .b(new_n158_), .c(x79), .d(x70), .O(new_n316_));
  ...
  nand3  g152(.a(new_n321_), .b(new_n299_), .c(new_n165_), .O(new_n322_));
  nand4  g153(.a(new_n301_), .b(new_n158_), .c(x79), .d(x72), .O(new_n323_));
  ...
  nand3  g158(.a(new_n327_), .b(new_n299_), .c(new_n165_), .O(new_n328_));
  nand4  g159(.a(new_n301_), .b(new_n158_), .c(x79), .d(x73), .O(new_n329_));
  ...
  nand4  g164(.a(new_n155_), .b(new_n160_), .c(x04), .d(new_n164_), .O(new_n334_));
  nor2   g165(.a(new_n334_), .b(new_n333_), .O(z54));
  inv1   g166(.a(x82), .O(new_n336_));
  nand2  g167(.a(x84), .b(new_n336_), .O(new_n337_));
  nand2  g168(.a(x83), .b(new_n216_), .O(new_n338_));
  nor2   g169(.a(x80), .b(new_n160_), .O(new_n339_));
  nand3  g170(.a(new_n339_), .b(new_n213_), .c(new_n210_), .O(new_n340_));
  nor3   g171(.a(new_n340_), .b(new_n338_), .c(new_n337_), .O(z55));
  inv1   g172(.a(x02), .O(new_n343_));
  nand4  g173(.a(x03), .b(new_n343_), .c(new_n164_), .d(x00), .O(new_n344_));
  inv1   g174(.a(new_n344_), .O(z57));
  oai21  g175(.a(new_n158_), .b(new_n155_), .c(new_n301_), .O(new_n349_));
  nand2  g176(.a(new_n210_), .b(new_n298_), .O(new_n350_));
