...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n273_, new_n277_, new_n282_, new_n284_, new_n287_, new_n288_,
  ...
  inv1   g113(.a(new_n232_), .O(new_n277_));
  nor3   g114(.a(new_n270_), .b(new_n277_), .c(new_n188_), .O(z40));
  nor3   g115(.a(new_n270_), .b(new_n277_), .c(new_n185_), .O(z41));
  nor3   g116(.a(new_n270_), .b(new_n277_), .c(new_n182_), .O(z42));
  nand2  g117(.a(new_n232_), .b(x62), .O(new_n282_));
  nor2   g118(.a(new_n282_), .b(new_n270_), .O(z44));
  ...
  nand2  g145(.a(new_n311_), .b(new_n292_), .O(new_n312_));
  nand2  g146(.a(new_n305_), .b(x70), .O(new_n313_));
  ...
  nand2  g151(.a(new_n317_), .b(new_n292_), .O(new_n318_));
  nand2  g152(.a(new_n305_), .b(x71), .O(new_n319_));
  ...
  nand2  g157(.a(new_n324_), .b(new_n292_), .O(new_n325_));
  nand2  g158(.a(new_n305_), .b(x73), .O(new_n326_));
  aoi21  g159(.a(new_n326_), .b(new_n325_), .c(x01), .O(z53));
  inv1   g160(.a(x82), .O(new_n329_));
  nand4  g161(.a(x84), .b(x83), .c(new_n329_), .d(new_n236_), .O(new_n330_));
  inv1   g162(.a(x80), .O(new_n331_));
  nand4  g163(.a(new_n232_), .b(new_n161_), .c(new_n331_), .d(x79), .O(new_n332_));
  nor2   g164(.a(new_n332_), .b(new_n330_), .O(z55));
  nand2  g165(.a(new_n160_), .b(new_n159_), .O(new_n334_));
  nand2  g166(.a(new_n230_), .b(x76), .O(new_n335_));
  xnor2a g167(.a(x84), .b(x81), .O(new_n336_));
  aoi21  g168(.a(new_n168_), .b(new_n167_), .c(new_n336_), .O(new_n337_));
  ...
  nand4  g172(.a(new_n340_), .b(new_n334_), .c(new_n153_), .d(x00), .O(z56));
  nand4  g173(.a(x80), .b(new_n219_), .c(x43), .d(new_n235_), .O(new_n343_));
  oai22  g174(.a(new_n343_), .b(new_n218_), .c(new_n235_), .d(x40), .O(new_n344_));
  nand3  g175(.a(new_n344_), .b(new_n224_), .c(x79), .O(new_n345_));
  nor2   g176(.a(x79), .b(x78), .O(new_n346_));
  nand3  g177(.a(new_n346_), .b(new_n235_), .c(x40), .O(new_n347_));
  nand2  g178(.a(new_n347_), .b(new_n345_), .O(new_n348_));
  nand2  g179(.a(new_n348_), .b(x77), .O(new_n349_));
  inv1   g180(.a(new_n167_), .O(new_n350_));
  oai21  g181(.a(new_n350_), .b(new_n227_), .c(new_n154_), .O(new_n351_));
  aoi21  g182(.a(new_n351_), .b(new_n349_), .c(x01), .O(z58));
  inv1   g183(.a(new_n346_), .O(new_n353_));
  aoi21  g184(.a(new_n223_), .b(new_n353_), .c(new_n152_), .O(new_n354_));
  oai21  g185(.a(new_n220_), .b(new_n218_), .c(new_n235_), .O(new_n355_));
  aoi21  g186(.a(new_n355_), .b(x79), .c(new_n223_), .O(new_n356_));
  oai21  g187(.a(new_n356_), .b(new_n354_), .c(x77), .O(new_n357_));
  nor2   g188(.a(x79), .b(x04), .O(new_n358_));
  inv1   g189(.a(new_n358_), .O(new_n359_));
  aoi21  g190(.a(new_n359_), .b(new_n357_), .c(x01), .O(z59));
  aoi21  g191(.a(new_n337_), .b(x79), .c(new_n358_), .O(new_n361_));
  aoi21  g192(.a(new_n361_), .b(new_n225_), .c(x01), .O(z60));
  inv1   g193(.a(new_n170_), .O(new_n363_));
  nand2  g194(.a(new_n168_), .b(new_n167_), .O(new_n364_));
  aoi22  g195(.a(new_n364_), .b(new_n214_), .c(new_n161_), .d(new_n227_), .O(new_n365_));
  nor3   g196(.a(new_n365_), .b(new_n363_), .c(new_n331_), .O(z61));
  nand3  g197(.a(x84), .b(x81), .c(x79), .O(new_n367_));
  oai21  g198(.a(x79), .b(new_n227_), .c(new_n367_), .O(new_n368_));
  nand2  g199(.a(new_n368_), .b(new_n159_), .O(new_n369_));
  nand2  g200(.a(new_n355_), .b(x79), .O(new_n370_));
  nand3  g201(.a(x81), .b(x79), .c(new_n227_), .O(new_n371_));
  ...
  inv1   g206(.a(new_n367_), .O(new_n376_));
  nand2  g207(.a(new_n376_), .b(new_n295_), .O(new_n377_));
  aoi21  g208(.a(new_n377_), .b(new_n375_), .c(x01), .O(z62));
  nor3   g209(.a(new_n365_), .b(new_n363_), .c(new_n329_), .O(z63));
  nand2  g210(.a(x83), .b(x79), .O(new_n380_));
  or2    g211(.a(new_n380_), .b(new_n365_), .O(new_n381_));
  aoi21  g212(.a(new_n381_), .b(new_n291_), .c(x01), .O(z64));
  nor2   g213(.a(new_n160_), .b(x04), .O(new_n383_));
  nor2   g214(.a(new_n236_), .b(x78), .O(new_n384_));
  oai21  g215(.a(new_n384_), .b(new_n383_), .c(x77), .O(new_n385_));
  nand2  g216(.a(new_n350_), .b(x81), .O(new_n386_));
