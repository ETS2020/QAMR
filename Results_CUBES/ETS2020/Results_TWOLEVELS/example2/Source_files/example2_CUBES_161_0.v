...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n249_, new_n250_, new_n252_, new_n255_, new_n257_, new_n260_,
  ...
  nand2  g131(.a(new_n239_), .b(x55), .O(new_n290_));
  nor2   g132(.a(new_n290_), .b(new_n285_), .O(z37));
  nand2  g133(.a(new_n239_), .b(x56), .O(new_n292_));
  nor2   g134(.a(new_n292_), .b(new_n285_), .O(z38));
  nor3   g135(.a(new_n285_), .b(new_n276_), .c(new_n188_), .O(z40));
  nor3   g136(.a(new_n285_), .b(new_n276_), .c(new_n185_), .O(z41));
  nand2  g137(.a(new_n239_), .b(x60), .O(new_n297_));
  nor2   g138(.a(new_n297_), .b(new_n285_), .O(z42));
  nor3   g139(.a(new_n285_), .b(new_n276_), .c(new_n181_), .O(z43));
  ...
  nand3  g190(.a(new_n354_), .b(new_n353_), .c(new_n235_), .O(z56));
  inv1   g191(.a(x02), .O(new_n356_));
  nand3  g192(.a(new_n235_), .b(x03), .c(new_n356_), .O(new_n357_));
  inv1   g193(.a(new_n357_), .O(z57));
  nand4  g194(.a(x80), .b(new_n224_), .c(x43), .d(new_n242_), .O(new_n359_));
  oai22  g195(.a(new_n359_), .b(new_n223_), .c(new_n242_), .d(x40), .O(new_n360_));
  nand3  g196(.a(new_n360_), .b(new_n229_), .c(x79), .O(new_n361_));
  nor2   g197(.a(x79), .b(x78), .O(new_n362_));
  nand3  g198(.a(new_n362_), .b(new_n242_), .c(x40), .O(new_n363_));
  nand2  g199(.a(new_n363_), .b(new_n361_), .O(new_n364_));
  nand2  g200(.a(new_n364_), .b(x77), .O(new_n365_));
  oai21  g201(.a(new_n344_), .b(new_n232_), .c(new_n154_), .O(new_n366_));
  ...
  nor2   g236(.a(new_n246_), .b(x78), .O(new_n401_));
