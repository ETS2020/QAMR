// Benchmark "FAU" written by ABC on Fri Jul 10 18:26:37 2020
...
module FAU ( 
  ...
  nor3   g135(.a(new_n284_), .b(new_n275_), .c(new_n177_), .O(z43));
  nand2  g136(.a(new_n235_), .b(x63), .O(new_n299_));
  nor2   g137(.a(new_n299_), .b(new_n284_), .O(z45));
  ...
  nand2  g155(.a(new_n319_), .b(new_n308_), .O(new_n320_));
  nand2  g156(.a(new_n313_), .b(x70), .O(new_n321_));
  ...
  nand2  g161(.a(new_n325_), .b(new_n308_), .O(new_n326_));
  nand2  g162(.a(new_n313_), .b(x71), .O(new_n327_));
  aoi21  g163(.a(new_n327_), .b(new_n326_), .c(x01), .O(z51));
  inv1   g164(.a(x12), .O(new_n329_));
  nand2  g165(.a(x52), .b(x20), .O(new_n330_));
  oai21  g166(.a(x52), .b(new_n329_), .c(new_n330_), .O(new_n331_));
  nand2  g167(.a(new_n331_), .b(new_n308_), .O(new_n332_));
  nand2  g168(.a(new_n313_), .b(x72), .O(new_n333_));
  aoi21  g169(.a(new_n333_), .b(new_n332_), .c(x01), .O(z52));
  inv1   g170(.a(x13), .O(new_n335_));
  nand2  g171(.a(x52), .b(x21), .O(new_n336_));
  oai21  g172(.a(x52), .b(new_n335_), .c(new_n336_), .O(new_n337_));
  nand2  g173(.a(new_n337_), .b(new_n308_), .O(new_n338_));
  nand2  g174(.a(new_n313_), .b(x73), .O(new_n339_));
  aoi21  g175(.a(new_n339_), .b(new_n338_), .c(x01), .O(z53));
  nand2  g176(.a(x52), .b(x22), .O(new_n341_));
  nand2  g177(.a(new_n274_), .b(x14), .O(new_n342_));
  ...
  nand3  g182(.a(new_n261_), .b(x84), .c(new_n346_), .O(new_n347_));
