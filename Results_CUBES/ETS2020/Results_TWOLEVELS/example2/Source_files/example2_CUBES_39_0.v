...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n283_, new_n285_, new_n287_, new_n292_, new_n297_, new_n300_,
  ...
  nor2   g100(.a(x83), .b(new_n239_), .O(new_n259_));
  nor2   g101(.a(new_n259_), .b(new_n258_), .O(new_n260_));
  nand2  g102(.a(x42), .b(x05), .O(new_n261_));
  nand2  g103(.a(x51), .b(new_n235_), .O(new_n262_));
  oai22  g104(.a(new_n262_), .b(new_n239_), .c(new_n261_), .d(new_n260_), .O(new_n263_));
  ...
  inv1   g113(.a(new_n232_), .O(new_n272_));
  nand2  g114(.a(x83), .b(x42), .O(new_n273_));
  nand2  g115(.a(new_n273_), .b(new_n239_), .O(new_n274_));
  nand3  g116(.a(x83), .b(x81), .c(x42), .O(new_n275_));
  nand2  g117(.a(new_n275_), .b(new_n274_), .O(new_n276_));
  and2   g118(.a(new_n276_), .b(new_n240_), .O(new_n277_));
  nand2  g119(.a(new_n273_), .b(x81), .O(new_n278_));
  nand2  g120(.a(new_n258_), .b(x42), .O(new_n279_));
  aoi21  g121(.a(new_n279_), .b(new_n278_), .c(new_n236_), .O(new_n280_));
  oai21  g122(.a(new_n280_), .b(new_n277_), .c(new_n268_), .O(new_n281_));
  nor3   g123(.a(new_n281_), .b(new_n272_), .c(new_n271_), .O(z34));
  nand2  g124(.a(new_n232_), .b(x53), .O(new_n283_));
  nor2   g125(.a(new_n283_), .b(new_n281_), .O(z35));
  nand2  g126(.a(new_n232_), .b(x54), .O(new_n285_));
  nor2   g127(.a(new_n285_), .b(new_n281_), .O(z36));
  nand2  g128(.a(new_n232_), .b(x55), .O(new_n287_));
  nor2   g129(.a(new_n287_), .b(new_n281_), .O(z37));
  nor3   g130(.a(new_n281_), .b(new_n272_), .c(new_n193_), .O(z39));
  nand2  g131(.a(new_n232_), .b(x59), .O(new_n292_));
  nor2   g132(.a(new_n292_), .b(new_n281_), .O(z41));
  nor3   g133(.a(new_n281_), .b(new_n272_), .c(new_n183_), .O(z43));
  nand2  g134(.a(new_n232_), .b(x63), .O(new_n297_));
  nor2   g135(.a(new_n297_), .b(new_n281_), .O(z45));
  nor3   g136(.a(new_n281_), .b(new_n272_), .c(new_n176_), .O(z46));
  ...
  nand2  g141(.a(new_n303_), .b(new_n224_), .O(new_n304_));
  ...
  nand2  g148(.a(new_n310_), .b(new_n214_), .O(new_n311_));
  ...
  inv1   g154(.a(new_n214_), .O(new_n317_));
  ...
  nand2  g173(.a(new_n336_), .b(new_n305_), .O(new_n337_));
  nand2  g174(.a(new_n318_), .b(x72), .O(new_n338_));
  ...
  nand2  g183(.a(new_n271_), .b(x14), .O(new_n347_));
  ...
  nand4  g190(.a(new_n232_), .b(new_n161_), .c(new_n353_), .d(x79), .O(new_n354_));
  nor2   g191(.a(new_n354_), .b(new_n352_), .O(z55));
  nand2  g192(.a(new_n160_), .b(new_n159_), .O(new_n356_));
  nand2  g193(.a(new_n230_), .b(x76), .O(new_n357_));
  ...
  nand4  g200(.a(x80), .b(new_n219_), .c(x43), .d(new_n235_), .O(new_n365_));
  oai22  g201(.a(new_n365_), .b(new_n218_), .c(new_n235_), .d(x40), .O(new_n366_));
  nand3  g202(.a(new_n366_), .b(new_n224_), .c(x79), .O(new_n367_));
  nor2   g203(.a(x79), .b(x78), .O(new_n368_));
  nand3  g204(.a(new_n368_), .b(new_n235_), .c(x40), .O(new_n369_));
  nand2  g205(.a(new_n369_), .b(new_n367_), .O(new_n370_));
  nand2  g206(.a(new_n370_), .b(x77), .O(new_n371_));
  oai21  g207(.a(new_n348_), .b(new_n227_), .c(new_n154_), .O(new_n372_));
  aoi21  g208(.a(new_n372_), .b(new_n371_), .c(x01), .O(z58));
  inv1   g209(.a(new_n368_), .O(new_n374_));
  aoi21  g210(.a(new_n223_), .b(new_n374_), .c(new_n152_), .O(new_n375_));
  oai21  g211(.a(new_n220_), .b(new_n218_), .c(new_n235_), .O(new_n376_));
  aoi21  g212(.a(new_n376_), .b(x79), .c(new_n223_), .O(new_n377_));
  ...
  nand2  g233(.a(new_n397_), .b(new_n308_), .O(new_n398_));
  ...
  nor2   g240(.a(new_n239_), .b(x78), .O(new_n405_));
