// Benchmark "FAU" written by ABC on Fri Jul 10 18:12:54 2020
...
module FAU ( 
  ...
  nand4  g095(.a(new_n245_), .b(new_n234_), .c(x48), .d(new_n238_), .O(new_n254_));
  inv1   g096(.a(new_n254_), .O(z30));
  nand4  g097(.a(new_n245_), .b(new_n234_), .c(x49), .d(new_n238_), .O(new_n256_));
  inv1   g098(.a(new_n256_), .O(z31));
  nand4  g099(.a(new_n245_), .b(new_n234_), .c(x50), .d(new_n238_), .O(new_n258_));
  ...
  inv1   g115(.a(new_n234_), .O(new_n274_));
  ...
  nor3   g132(.a(new_n283_), .b(new_n274_), .c(new_n190_), .O(z40));
  nor3   g133(.a(new_n283_), .b(new_n274_), .c(new_n187_), .O(z41));
  nand2  g134(.a(new_n234_), .b(x60), .O(new_n295_));
  nor2   g135(.a(new_n295_), .b(new_n283_), .O(z42));
  nor3   g136(.a(new_n283_), .b(new_n274_), .c(new_n183_), .O(z43));
  nor3   g137(.a(new_n283_), .b(new_n274_), .c(new_n176_), .O(z46));
  ...
  nand2  g142(.a(new_n305_), .b(new_n224_), .O(new_n306_));
  ...
  and2   g148(.a(new_n311_), .b(new_n214_), .O(new_n312_));
  ...
  nand2  g166(.a(new_n329_), .b(new_n307_), .O(new_n330_));
  nand2  g167(.a(new_n312_), .b(x71), .O(new_n331_));
  ...
  nand2  g172(.a(new_n336_), .b(new_n307_), .O(new_n337_));
  nand2  g173(.a(new_n312_), .b(x73), .O(new_n338_));
  aoi21  g174(.a(new_n338_), .b(new_n337_), .c(x01), .O(z53));
  nand2  g175(.a(x52), .b(x22), .O(new_n340_));
  nand2  g176(.a(new_n273_), .b(x14), .O(new_n341_));
  inv1   g177(.a(new_n167_), .O(new_n342_));
  nand4  g178(.a(new_n342_), .b(new_n154_), .c(x04), .d(new_n153_), .O(new_n343_));
  aoi21  g179(.a(new_n341_), .b(new_n340_), .c(new_n343_), .O(z54));
  inv1   g180(.a(x82), .O(new_n345_));
  nand3  g181(.a(new_n260_), .b(x84), .c(new_n345_), .O(new_n346_));
  inv1   g182(.a(x80), .O(new_n347_));
  nand4  g183(.a(new_n234_), .b(new_n161_), .c(new_n347_), .d(x79), .O(new_n348_));
  nor2   g184(.a(new_n348_), .b(new_n346_), .O(z55));
  nand2  g185(.a(new_n232_), .b(x76), .O(new_n350_));
  xnor2a g186(.a(x84), .b(x81), .O(new_n351_));
  aoi21  g187(.a(new_n168_), .b(new_n167_), .c(new_n351_), .O(new_n352_));
  nand2  g188(.a(new_n352_), .b(new_n153_), .O(new_n353_));
  nand2  g189(.a(new_n353_), .b(new_n350_), .O(new_n354_));
  nand2  g190(.a(new_n354_), .b(x79), .O(new_n355_));
  nand3  g191(.a(new_n160_), .b(new_n159_), .c(new_n153_), .O(new_n356_));
  nand3  g192(.a(new_n356_), .b(new_n355_), .c(new_n230_), .O(z56));
  inv1   g193(.a(x02), .O(new_n358_));
  nand3  g194(.a(new_n230_), .b(x03), .c(new_n358_), .O(new_n359_));
  inv1   g195(.a(new_n359_), .O(z57));
  nand4  g196(.a(x80), .b(new_n219_), .c(x43), .d(new_n238_), .O(new_n361_));
  oai22  g197(.a(new_n361_), .b(new_n218_), .c(new_n238_), .d(x40), .O(new_n362_));
  nand3  g198(.a(new_n362_), .b(new_n224_), .c(x79), .O(new_n363_));
  nor2   g199(.a(x79), .b(x78), .O(new_n364_));
  nand3  g200(.a(new_n364_), .b(new_n238_), .c(x40), .O(new_n365_));
  nand2  g201(.a(new_n365_), .b(new_n363_), .O(new_n366_));
  nand2  g202(.a(new_n366_), .b(x77), .O(new_n367_));
  oai21  g203(.a(new_n342_), .b(new_n227_), .c(new_n154_), .O(new_n368_));
  aoi21  g204(.a(new_n368_), .b(new_n367_), .c(x01), .O(z58));
  inv1   g205(.a(new_n364_), .O(new_n370_));
  aoi21  g206(.a(new_n223_), .b(new_n370_), .c(new_n152_), .O(new_n371_));
  oai21  g207(.a(new_n220_), .b(new_n218_), .c(new_n238_), .O(new_n372_));
  aoi21  g208(.a(new_n372_), .b(x79), .c(new_n223_), .O(new_n373_));
  oai21  g209(.a(new_n373_), .b(new_n371_), .c(x77), .O(new_n374_));
  nor2   g210(.a(x79), .b(x04), .O(new_n375_));
  inv1   g211(.a(new_n375_), .O(new_n376_));
  aoi21  g212(.a(new_n376_), .b(new_n374_), .c(x01), .O(z59));
  aoi21  g213(.a(new_n352_), .b(x79), .c(new_n375_), .O(new_n378_));
  aoi21  g214(.a(new_n378_), .b(new_n225_), .c(x01), .O(z60));
  inv1   g215(.a(new_n170_), .O(new_n380_));
  nand2  g216(.a(new_n168_), .b(new_n167_), .O(new_n381_));
  aoi22  g217(.a(new_n381_), .b(new_n214_), .c(new_n161_), .d(new_n227_), .O(new_n382_));
  nor3   g218(.a(new_n382_), .b(new_n380_), .c(new_n347_), .O(z61));
  nand3  g219(.a(x84), .b(x81), .c(x79), .O(new_n384_));
  oai21  g220(.a(x79), .b(new_n227_), .c(new_n384_), .O(new_n385_));
  nand2  g221(.a(new_n385_), .b(new_n159_), .O(new_n386_));
  nand2  g222(.a(new_n372_), .b(x79), .O(new_n387_));
  nand3  g223(.a(x81), .b(x79), .c(new_n227_), .O(new_n388_));
  inv1   g224(.a(new_n388_), .O(new_n389_));
  aoi21  g225(.a(new_n387_), .b(x04), .c(new_n389_), .O(new_n390_));
  oai21  g226(.a(new_n390_), .b(new_n159_), .c(new_n386_), .O(new_n391_));
  nand2  g227(.a(new_n391_), .b(x78), .O(new_n392_));
  inv1   g228(.a(new_n384_), .O(new_n393_));
  nand2  g229(.a(new_n393_), .b(new_n309_), .O(new_n394_));
  aoi21  g230(.a(new_n394_), .b(new_n392_), .c(x01), .O(z62));
  nor3   g231(.a(new_n382_), .b(new_n380_), .c(new_n345_), .O(z63));
  nand2  g232(.a(x83), .b(x79), .O(new_n397_));
  or2    g233(.a(new_n397_), .b(new_n382_), .O(new_n398_));
  aoi21  g234(.a(new_n398_), .b(new_n306_), .c(x01), .O(z64));
  nor2   g235(.a(new_n160_), .b(x04), .O(new_n400_));
  nor2   g236(.a(new_n242_), .b(x78), .O(new_n401_));
  oai21  g237(.a(new_n401_), .b(new_n400_), .c(x77), .O(new_n402_));
  nand2  g238(.a(new_n342_), .b(x81), .O(new_n403_));
  nand2  g239(.a(new_n170_), .b(x84), .O(new_n404_));
  aoi21  g240(.a(new_n403_), .b(new_n402_), .c(new_n404_), .O(z65));
  zero   g241(.O(z05));
  zero   g242(.O(z07));
  zero   g243(.O(z10));
  zero   g244(.O(z15));
