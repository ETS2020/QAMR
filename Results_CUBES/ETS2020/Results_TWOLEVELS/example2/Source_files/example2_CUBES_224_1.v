...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n253_, new_n257_, new_n262_, new_n263_, new_n264_, new_n265_,
    new_n266_, new_n267_, new_n268_, new_n269_, new_n270_, new_n271_,
    new_n272_, new_n275_, new_n277_, new_n282_, new_n286_, new_n288_,
  ...
  nor2   g101(.a(new_n219_), .b(new_n237_), .O(new_n263_));
  inv1   g102(.a(new_n263_), .O(new_n264_));
  nand2  g103(.a(new_n264_), .b(new_n238_), .O(new_n265_));
  nand2  g104(.a(new_n263_), .b(x81), .O(new_n266_));
  aoi21  g105(.a(new_n266_), .b(new_n265_), .c(new_n241_), .O(new_n267_));
  nand2  g106(.a(new_n264_), .b(x81), .O(new_n268_));
  nand2  g107(.a(new_n263_), .b(new_n238_), .O(new_n269_));
  aoi21  g108(.a(new_n269_), .b(new_n268_), .c(new_n239_), .O(new_n270_));
  oai21  g109(.a(new_n270_), .b(new_n267_), .c(new_n262_), .O(new_n271_));
  nand2  g110(.a(new_n234_), .b(x54), .O(new_n272_));
  nor2   g111(.a(new_n272_), .b(new_n271_), .O(z36));
  nand2  g112(.a(new_n234_), .b(x56), .O(new_n275_));
  nor2   g113(.a(new_n275_), .b(new_n271_), .O(z38));
  inv1   g114(.a(new_n234_), .O(new_n277_));
  nor3   g115(.a(new_n271_), .b(new_n277_), .c(new_n195_), .O(z39));
  nor3   g116(.a(new_n271_), .b(new_n277_), .c(new_n192_), .O(z40));
  nand2  g117(.a(new_n234_), .b(x61), .O(new_n282_));
  nor2   g118(.a(new_n282_), .b(new_n271_), .O(z43));
  nor3   g119(.a(new_n271_), .b(new_n277_), .c(new_n182_), .O(z44));
  nand2  g120(.a(new_n234_), .b(x64), .O(new_n286_));
  nor2   g121(.a(new_n286_), .b(new_n271_), .O(z46));
  ...
  inv1   g139(.a(new_n216_), .O(new_n305_));
  ...
  inv1   g164(.a(new_n167_), .O(new_n332_));
  nand4  g165(.a(new_n332_), .b(new_n154_), .c(x04), .d(new_n153_), .O(new_n333_));
  nor2   g166(.a(new_n333_), .b(new_n331_), .O(z54));
  inv1   g167(.a(x82), .O(new_n335_));
  nand4  g168(.a(x84), .b(x83), .c(new_n335_), .d(new_n238_), .O(new_n336_));
  inv1   g169(.a(x80), .O(new_n337_));
  nand4  g170(.a(new_n234_), .b(new_n161_), .c(new_n337_), .d(x79), .O(new_n338_));
  nor2   g171(.a(new_n338_), .b(new_n336_), .O(z55));
  nand2  g172(.a(new_n160_), .b(new_n159_), .O(new_n340_));
  ...
  nand4  g179(.a(new_n346_), .b(new_n340_), .c(new_n153_), .d(x00), .O(z56));
  nand4  g180(.a(x80), .b(new_n221_), .c(x43), .d(new_n237_), .O(new_n349_));
  oai22  g181(.a(new_n349_), .b(new_n220_), .c(new_n237_), .d(x40), .O(new_n350_));
  nand3  g182(.a(new_n350_), .b(new_n226_), .c(x79), .O(new_n351_));
  nor2   g183(.a(x79), .b(x78), .O(new_n352_));
  nand3  g184(.a(new_n352_), .b(new_n237_), .c(x40), .O(new_n353_));
  nand2  g185(.a(new_n353_), .b(new_n351_), .O(new_n354_));
  nand2  g186(.a(new_n354_), .b(x77), .O(new_n355_));
  oai21  g187(.a(new_n332_), .b(new_n229_), .c(new_n154_), .O(new_n356_));
  aoi21  g188(.a(new_n356_), .b(new_n355_), .c(x01), .O(z58));
  inv1   g189(.a(new_n352_), .O(new_n358_));
  aoi21  g190(.a(new_n225_), .b(new_n358_), .c(new_n152_), .O(new_n359_));
  oai21  g191(.a(new_n222_), .b(new_n220_), .c(new_n237_), .O(new_n360_));
  aoi21  g192(.a(new_n360_), .b(x79), .c(new_n225_), .O(new_n361_));
  ...
  aoi21  g197(.a(new_n343_), .b(x79), .c(new_n363_), .O(new_n366_));
  aoi21  g198(.a(new_n366_), .b(new_n227_), .c(x01), .O(z60));
  inv1   g199(.a(new_n170_), .O(new_n368_));
  nand2  g200(.a(new_n168_), .b(new_n167_), .O(new_n369_));
  aoi22  g201(.a(new_n369_), .b(new_n216_), .c(new_n161_), .d(new_n229_), .O(new_n370_));
  nor3   g202(.a(new_n370_), .b(new_n368_), .c(new_n337_), .O(z61));
  nand3  g203(.a(x84), .b(x81), .c(x79), .O(new_n372_));
  oai21  g204(.a(x79), .b(new_n229_), .c(new_n372_), .O(new_n373_));
  nand2  g205(.a(new_n373_), .b(new_n159_), .O(new_n374_));
  nand2  g206(.a(new_n360_), .b(x79), .O(new_n375_));
  nand3  g207(.a(x81), .b(x79), .c(new_n229_), .O(new_n376_));
  ...
  nand2  g213(.a(new_n381_), .b(new_n296_), .O(new_n382_));
  aoi21  g214(.a(new_n382_), .b(new_n380_), .c(x01), .O(z62));
  nor3   g215(.a(new_n370_), .b(new_n368_), .c(new_n335_), .O(z63));
  nand2  g216(.a(x83), .b(x79), .O(new_n385_));
  or2    g217(.a(new_n385_), .b(new_n370_), .O(new_n386_));
  aoi21  g218(.a(new_n386_), .b(new_n292_), .c(x01), .O(z64));
  ...
  nand2  g222(.a(new_n332_), .b(x81), .O(new_n391_));
