// Benchmark "FAU" written by ABC on Fri Jul 10 18:16:49 2020
...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n195_, new_n196_, new_n205_, new_n206_, new_n208_, new_n209_,
    new_n210_, new_n211_, new_n212_, new_n213_, new_n214_, new_n215_,
    new_n216_, new_n217_, new_n218_, new_n219_, new_n221_, new_n222_,
    new_n224_, new_n225_, new_n226_, new_n227_, new_n229_, new_n230_,
    new_n231_, new_n232_, new_n233_, new_n234_, new_n235_, new_n236_,
    new_n237_, new_n239_, new_n241_, new_n245_, new_n248_, new_n251_,
    new_n252_, new_n253_, new_n254_, new_n255_, new_n256_, new_n257_,
    new_n258_, new_n259_, new_n260_, new_n261_, new_n264_, new_n266_,
    new_n268_, new_n270_, new_n275_, new_n280_, new_n281_, new_n282_,
  ...
  nand4  g076(.a(new_n236_), .b(new_n226_), .c(new_n229_), .d(x05), .O(new_n237_));
  inv1   g077(.a(new_n237_), .O(z25));
  nand4  g078(.a(new_n236_), .b(new_n226_), .c(x44), .d(new_n229_), .O(new_n239_));
  inv1   g079(.a(new_n239_), .O(z26));
  nand4  g080(.a(new_n236_), .b(new_n226_), .c(x45), .d(new_n229_), .O(new_n241_));
  inv1   g081(.a(new_n241_), .O(z27));
  nand4  g082(.a(new_n236_), .b(new_n226_), .c(x48), .d(new_n229_), .O(new_n245_));
  inv1   g083(.a(new_n245_), .O(z30));
  nand4  g084(.a(new_n236_), .b(new_n226_), .c(x50), .d(new_n229_), .O(new_n248_));
  inv1   g085(.a(new_n248_), .O(z32));
  inv1   g086(.a(new_n162_), .O(new_n251_));
  nor2   g087(.a(new_n211_), .b(new_n229_), .O(new_n252_));
  inv1   g088(.a(new_n252_), .O(new_n253_));
  nand2  g089(.a(new_n253_), .b(new_n230_), .O(new_n254_));
  nand2  g090(.a(new_n252_), .b(x81), .O(new_n255_));
  aoi21  g091(.a(new_n255_), .b(new_n254_), .c(new_n233_), .O(new_n256_));
  nand2  g092(.a(new_n253_), .b(x81), .O(new_n257_));
  nand2  g093(.a(new_n252_), .b(new_n230_), .O(new_n258_));
  aoi21  g094(.a(new_n258_), .b(new_n257_), .c(new_n231_), .O(new_n259_));
  oai21  g095(.a(new_n259_), .b(new_n256_), .c(new_n251_), .O(new_n260_));
  nand2  g096(.a(new_n226_), .b(x52), .O(new_n261_));
  ...
  nor2   g101(.a(new_n266_), .b(new_n260_), .O(z37));
  nand2  g102(.a(new_n226_), .b(x56), .O(new_n268_));
  nor2   g103(.a(new_n268_), .b(new_n260_), .O(z38));
  inv1   g104(.a(new_n226_), .O(new_n270_));
  nor3   g105(.a(new_n260_), .b(new_n270_), .c(new_n195_), .O(z39));
  nor3   g106(.a(new_n260_), .b(new_n270_), .c(new_n192_), .O(z40));
  nor3   g107(.a(new_n260_), .b(new_n270_), .c(new_n189_), .O(z41));
  nand2  g108(.a(new_n226_), .b(x61), .O(new_n275_));
  nor2   g109(.a(new_n275_), .b(new_n260_), .O(z43));
  nor3   g110(.a(new_n260_), .b(new_n270_), .c(new_n182_), .O(z44));
  ...
  nand2  g115(.a(new_n283_), .b(new_n218_), .O(new_n284_));
  inv1   g116(.a(new_n284_), .O(new_n285_));
  nand2  g117(.a(new_n285_), .b(new_n282_), .O(new_n286_));
  nor2   g118(.a(x75), .b(x67), .O(new_n287_));
  inv1   g119(.a(new_n168_), .O(new_n288_));
  nand2  g120(.a(new_n288_), .b(x79), .O(new_n289_));
  nor2   g121(.a(new_n289_), .b(new_n287_), .O(new_n290_));
  nand2  g122(.a(new_n290_), .b(new_n208_), .O(new_n291_));
  ...
  inv1   g128(.a(new_n208_), .O(new_n297_));
  ...
  nand2  g153(.a(new_n322_), .b(new_n285_), .O(new_n323_));
  nand2  g154(.a(new_n298_), .b(x73), .O(new_n324_));
  aoi21  g155(.a(new_n324_), .b(new_n323_), .c(x01), .O(z53));
  inv1   g156(.a(x82), .O(new_n327_));
  nand4  g157(.a(x84), .b(x83), .c(new_n327_), .d(new_n230_), .O(new_n328_));
  inv1   g158(.a(x80), .O(new_n329_));
  nand4  g159(.a(new_n226_), .b(new_n161_), .c(new_n329_), .d(x79), .O(new_n330_));
  nor2   g160(.a(new_n330_), .b(new_n328_), .O(z55));
  nand2  g161(.a(new_n160_), .b(new_n159_), .O(new_n332_));
  nand2  g162(.a(new_n224_), .b(x76), .O(new_n333_));
  xnor2a g163(.a(x84), .b(x81), .O(new_n334_));
  aoi21  g164(.a(new_n168_), .b(new_n167_), .c(new_n334_), .O(new_n335_));
  nand2  g165(.a(new_n335_), .b(new_n153_), .O(new_n336_));
  nand2  g166(.a(new_n336_), .b(new_n333_), .O(new_n337_));
  nand2  g167(.a(new_n337_), .b(x79), .O(new_n338_));
  nand4  g168(.a(new_n338_), .b(new_n332_), .c(new_n153_), .d(x00), .O(z56));
  nand4  g169(.a(x80), .b(new_n213_), .c(x43), .d(new_n229_), .O(new_n341_));
  oai22  g170(.a(new_n341_), .b(new_n212_), .c(new_n229_), .d(x40), .O(new_n342_));
  nand3  g171(.a(new_n342_), .b(new_n218_), .c(x79), .O(new_n343_));
  nor2   g172(.a(x79), .b(x78), .O(new_n344_));
  nand3  g173(.a(new_n344_), .b(new_n229_), .c(x40), .O(new_n345_));
  nand2  g174(.a(new_n345_), .b(new_n343_), .O(new_n346_));
  nand2  g175(.a(new_n346_), .b(x77), .O(new_n347_));
  inv1   g176(.a(new_n167_), .O(new_n348_));
  oai21  g177(.a(new_n348_), .b(new_n221_), .c(new_n154_), .O(new_n349_));
  aoi21  g178(.a(new_n349_), .b(new_n347_), .c(x01), .O(z58));
  inv1   g179(.a(new_n344_), .O(new_n351_));
  aoi21  g180(.a(new_n217_), .b(new_n351_), .c(new_n152_), .O(new_n352_));
  oai21  g181(.a(new_n214_), .b(new_n212_), .c(new_n229_), .O(new_n353_));
  aoi21  g182(.a(new_n353_), .b(x79), .c(new_n217_), .O(new_n354_));
  ...
  aoi21  g187(.a(new_n335_), .b(x79), .c(new_n356_), .O(new_n359_));
  aoi21  g188(.a(new_n359_), .b(new_n219_), .c(x01), .O(z60));
  inv1   g189(.a(new_n170_), .O(new_n361_));
  nand2  g190(.a(new_n168_), .b(new_n167_), .O(new_n362_));
  aoi22  g191(.a(new_n362_), .b(new_n208_), .c(new_n161_), .d(new_n221_), .O(new_n363_));
  nor3   g192(.a(new_n363_), .b(new_n361_), .c(new_n329_), .O(z61));
  nand3  g193(.a(x84), .b(x81), .c(x79), .O(new_n365_));
  oai21  g194(.a(x79), .b(new_n221_), .c(new_n365_), .O(new_n366_));
  nand2  g195(.a(new_n366_), .b(new_n159_), .O(new_n367_));
  nand2  g196(.a(new_n353_), .b(x79), .O(new_n368_));
  nand3  g197(.a(x81), .b(x79), .c(new_n221_), .O(new_n369_));
  ...
  nand2  g203(.a(new_n374_), .b(new_n288_), .O(new_n375_));
  aoi21  g204(.a(new_n375_), .b(new_n373_), .c(x01), .O(z62));
  nor3   g205(.a(new_n363_), .b(new_n361_), .c(new_n327_), .O(z63));
  nand2  g206(.a(x83), .b(x79), .O(new_n378_));
  or2    g207(.a(new_n378_), .b(new_n363_), .O(new_n379_));
  aoi21  g208(.a(new_n379_), .b(new_n284_), .c(x01), .O(z64));
  nor2   g209(.a(new_n160_), .b(x04), .O(new_n381_));
  nor2   g210(.a(new_n230_), .b(x78), .O(new_n382_));
  oai21  g211(.a(new_n382_), .b(new_n381_), .c(x77), .O(new_n383_));
  nand2  g212(.a(new_n348_), .b(x81), .O(new_n384_));
  nand2  g213(.a(new_n170_), .b(x84), .O(new_n385_));
  aoi21  g214(.a(new_n384_), .b(new_n383_), .c(new_n385_), .O(z65));
  zero   g215(.O(z06));
  zero   g216(.O(z09));
  zero   g217(.O(z14));
  zero   g218(.O(z15));
