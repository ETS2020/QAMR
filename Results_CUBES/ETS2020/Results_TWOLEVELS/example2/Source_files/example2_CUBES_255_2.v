...
module FAU ( 
  ...
  nand3  g071(.a(new_n215_), .b(x48), .c(new_n214_), .O(new_n236_));
  inv1   g072(.a(new_n236_), .O(new_n237_));
  nand3  g073(.a(new_n237_), .b(new_n213_), .c(new_n211_), .O(new_n238_));
  inv1   g074(.a(new_n238_), .O(z30));
  nand3  g075(.a(new_n215_), .b(x49), .c(new_n214_), .O(new_n240_));
  inv1   g076(.a(new_n240_), .O(new_n241_));
  nand3  g077(.a(new_n241_), .b(new_n213_), .c(new_n211_), .O(new_n242_));
  inv1   g078(.a(new_n242_), .O(z31));
  xnor2a g079(.a(x84), .b(x82), .O(new_n246_));
  nand2  g080(.a(x83), .b(x42), .O(new_n247_));
  nand2  g081(.a(new_n247_), .b(new_n207_), .O(new_n248_));
  nand3  g082(.a(x83), .b(x81), .c(x42), .O(new_n249_));
  aoi21  g083(.a(new_n249_), .b(new_n248_), .c(new_n246_), .O(new_n250_));
  nand2  g084(.a(new_n247_), .b(x81), .O(new_n251_));
  nand3  g085(.a(x83), .b(new_n207_), .c(x42), .O(new_n252_));
  aoi21  g086(.a(new_n252_), .b(new_n251_), .c(new_n208_), .O(new_n253_));
  oai21  g087(.a(new_n253_), .b(new_n250_), .c(new_n213_), .O(new_n254_));
  nand2  g088(.a(new_n215_), .b(x52), .O(new_n255_));
  nor2   g089(.a(new_n255_), .b(new_n254_), .O(z34));
  nand2  g090(.a(new_n215_), .b(x53), .O(new_n257_));
  nor2   g091(.a(new_n257_), .b(new_n254_), .O(z35));
  nand2  g092(.a(new_n215_), .b(x54), .O(new_n259_));
  nor2   g093(.a(new_n259_), .b(new_n254_), .O(z36));
  nand2  g094(.a(new_n215_), .b(x56), .O(new_n262_));
  nor2   g095(.a(new_n262_), .b(new_n254_), .O(z38));
  nand2  g096(.a(new_n215_), .b(x57), .O(new_n264_));
  nor2   g097(.a(new_n264_), .b(new_n254_), .O(z39));
  nand2  g098(.a(new_n215_), .b(x58), .O(new_n266_));
  nor2   g099(.a(new_n266_), .b(new_n254_), .O(z40));
  nand2  g100(.a(new_n215_), .b(x59), .O(new_n268_));
  nor2   g101(.a(new_n268_), .b(new_n254_), .O(z41));
  nand2  g102(.a(new_n215_), .b(x60), .O(new_n270_));
  nor2   g103(.a(new_n270_), .b(new_n254_), .O(z42));
  nand2  g104(.a(new_n215_), .b(x61), .O(new_n272_));
  nor2   g105(.a(new_n272_), .b(new_n254_), .O(z43));
  nand2  g106(.a(new_n215_), .b(x62), .O(new_n274_));
  nor2   g107(.a(new_n274_), .b(new_n254_), .O(z44));
  nand2  g108(.a(new_n215_), .b(x63), .O(new_n276_));
  nor2   g109(.a(new_n276_), .b(new_n254_), .O(z45));
  nand2  g110(.a(new_n215_), .b(x64), .O(new_n278_));
  nor2   g111(.a(new_n278_), .b(new_n254_), .O(z46));
  ...
  inv1   g159(.a(x82), .O(new_n328_));
  nand4  g160(.a(x84), .b(x83), .c(new_n328_), .d(new_n207_), .O(new_n329_));
  inv1   g161(.a(x80), .O(new_n330_));
  nand4  g162(.a(new_n330_), .b(x79), .c(x78), .d(x77), .O(new_n331_));
  nor4   g163(.a(new_n331_), .b(new_n329_), .c(x04), .d(x01), .O(z55));
  inv1   g164(.a(x02), .O(new_n334_));
  nand4  g165(.a(x03), .b(new_n334_), .c(new_n160_), .d(x00), .O(new_n335_));
  inv1   g166(.a(new_n335_), .O(z57));
  oai21  g167(.a(new_n158_), .b(new_n155_), .c(new_n287_), .O(new_n340_));
  nand3  g168(.a(x78), .b(x77), .c(new_n283_), .O(new_n341_));
  nand3  g169(.a(x80), .b(x79), .c(new_n160_), .O(new_n342_));
  aoi21  g170(.a(new_n341_), .b(new_n340_), .c(new_n342_), .O(z61));
  zero   g171(.O(z00));
  zero   g172(.O(z01));
  zero   g173(.O(z03));
  zero   g174(.O(z04));
