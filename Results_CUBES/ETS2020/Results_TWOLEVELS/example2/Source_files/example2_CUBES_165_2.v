...
module FAU ( 
  ...
  wire new_n154_, new_n155_, new_n156_, new_n157_, new_n158_, new_n159_,
    ...
    new_n270_, new_n272_, new_n274_, new_n277_, new_n279_, new_n281_,
  ...
  inv1   g028(.a(x32), .O(new_n187_));
  nand2  g029(.a(x51), .b(x40), .O(new_n188_));
  oai21  g030(.a(x40), .b(new_n187_), .c(new_n188_), .O(z14));
  ...
  nand2  g088(.a(new_n253_), .b(new_n219_), .O(new_n254_));
  ...
  nand3  g092(.a(x83), .b(new_n219_), .c(x42), .O(new_n258_));
  aoi21  g093(.a(new_n258_), .b(new_n257_), .c(new_n220_), .O(new_n259_));
  oai21  g094(.a(new_n259_), .b(new_n256_), .c(new_n225_), .O(new_n260_));
  nand2  g095(.a(new_n216_), .b(x53), .O(new_n261_));
  nor2   g096(.a(new_n261_), .b(new_n260_), .O(z35));
  nand2  g097(.a(new_n216_), .b(x54), .O(new_n263_));
  nor2   g098(.a(new_n263_), .b(new_n260_), .O(z36));
  nand2  g099(.a(new_n216_), .b(x56), .O(new_n266_));
  nor2   g100(.a(new_n266_), .b(new_n260_), .O(z38));
  nand2  g101(.a(new_n216_), .b(x57), .O(new_n268_));
  nor2   g102(.a(new_n268_), .b(new_n260_), .O(z39));
  nand2  g103(.a(new_n216_), .b(x58), .O(new_n270_));
  nor2   g104(.a(new_n270_), .b(new_n260_), .O(z40));
  nand2  g105(.a(new_n216_), .b(x59), .O(new_n272_));
  nor2   g106(.a(new_n272_), .b(new_n260_), .O(z41));
  nand2  g107(.a(new_n216_), .b(x60), .O(new_n274_));
  nor2   g108(.a(new_n274_), .b(new_n260_), .O(z42));
  nand2  g109(.a(new_n216_), .b(x62), .O(new_n277_));
  nor2   g110(.a(new_n277_), .b(new_n260_), .O(z44));
  nand2  g111(.a(new_n216_), .b(x63), .O(new_n279_));
  nor2   g112(.a(new_n279_), .b(new_n260_), .O(z45));
  nand2  g113(.a(new_n216_), .b(x64), .O(new_n281_));
  nor2   g114(.a(new_n281_), .b(new_n260_), .O(z46));
  inv1   g115(.a(x07), .O(new_n283_));
  nand2  g116(.a(x52), .b(x15), .O(new_n284_));
  oai21  g117(.a(x52), .b(new_n283_), .c(new_n284_), .O(new_n285_));
  nand4  g118(.a(new_n160_), .b(x78), .c(new_n157_), .d(x04), .O(new_n286_));
  inv1   g119(.a(new_n286_), .O(new_n287_));
  nand2  g120(.a(new_n287_), .b(new_n285_), .O(new_n288_));
  xnor2a g121(.a(x84), .b(x81), .O(new_n289_));
  or2    g122(.a(x75), .b(x67), .O(new_n290_));
  nand4  g123(.a(new_n290_), .b(new_n289_), .c(new_n158_), .d(x79), .O(new_n291_));
  aoi21  g124(.a(new_n291_), .b(new_n288_), .c(x01), .O(z47));
  ...
  nand4  g129(.a(new_n289_), .b(new_n158_), .c(x79), .d(x70), .O(new_n299_));
  ...
  nand2  g134(.a(new_n303_), .b(new_n287_), .O(new_n304_));
  nand4  g135(.a(new_n289_), .b(new_n158_), .c(x79), .d(x71), .O(new_n305_));
  aoi21  g136(.a(new_n305_), .b(new_n304_), .c(x01), .O(z51));
  inv1   g137(.a(x12), .O(new_n307_));
  nand2  g138(.a(x52), .b(x20), .O(new_n308_));
  oai21  g139(.a(x52), .b(new_n307_), .c(new_n308_), .O(new_n309_));
  nand2  g140(.a(new_n309_), .b(new_n287_), .O(new_n310_));
  nand4  g141(.a(new_n289_), .b(new_n158_), .c(x79), .d(x72), .O(new_n311_));
  aoi21  g142(.a(new_n311_), .b(new_n310_), .c(x01), .O(z52));
  inv1   g143(.a(x13), .O(new_n313_));
  nand2  g144(.a(x52), .b(x21), .O(new_n314_));
  oai21  g145(.a(x52), .b(new_n313_), .c(new_n314_), .O(new_n315_));
  nand2  g146(.a(new_n315_), .b(new_n287_), .O(new_n316_));
  nand4  g147(.a(new_n289_), .b(new_n158_), .c(x79), .d(x73), .O(new_n317_));
  aoi21  g148(.a(new_n317_), .b(new_n316_), .c(x01), .O(z53));
  inv1   g149(.a(x14), .O(new_n319_));
  nor2   g150(.a(x52), .b(new_n319_), .O(new_n320_));
  aoi21  g151(.a(x52), .b(x22), .c(new_n320_), .O(new_n321_));
  inv1   g152(.a(x01), .O(new_n322_));
  nand4  g153(.a(new_n155_), .b(new_n160_), .c(x04), .d(new_n322_), .O(new_n323_));
  nor2   g154(.a(new_n323_), .b(new_n321_), .O(z54));
  inv1   g155(.a(x82), .O(new_n325_));
  nand4  g156(.a(x84), .b(x83), .c(new_n325_), .d(new_n219_), .O(new_n326_));
  nor2   g157(.a(x80), .b(new_n160_), .O(new_n327_));
  nand3  g158(.a(new_n327_), .b(new_n216_), .c(new_n213_), .O(new_n328_));
  nor2   g159(.a(new_n328_), .b(new_n326_), .O(z55));
  inv1   g160(.a(x02), .O(new_n331_));
  nand4  g161(.a(x03), .b(new_n331_), .c(new_n322_), .d(x00), .O(new_n332_));
  inv1   g162(.a(new_n332_), .O(z57));
  oai21  g163(.a(new_n158_), .b(new_n155_), .c(new_n289_), .O(new_n337_));
  inv1   g164(.a(x04), .O(new_n338_));
  nand2  g165(.a(new_n213_), .b(new_n338_), .O(new_n339_));
  nand2  g166(.a(new_n161_), .b(x80), .O(new_n340_));
  aoi21  g167(.a(new_n339_), .b(new_n337_), .c(new_n340_), .O(z61));
  nand2  g168(.a(new_n161_), .b(x82), .O(new_n343_));
  aoi21  g169(.a(new_n339_), .b(new_n337_), .c(new_n343_), .O(z63));
  zero   g170(.O(z00));
  zero   g171(.O(z01));
  zero   g172(.O(z03));
  zero   g173(.O(z04));
