...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n198_, new_n201_, new_n202_, new_n205_, new_n206_, new_n208_,
    ...
    new_n305_, new_n314_, new_n315_, new_n316_, new_n317_, new_n318_,
  ...
  nand4  g107(.a(new_n258_), .b(new_n247_), .c(x44), .d(new_n250_), .O(new_n261_));
  ...
  nand2  g148(.a(new_n247_), .b(x57), .O(new_n305_));
  nor2   g149(.a(new_n305_), .b(new_n296_), .O(z39));
  nor3   g150(.a(new_n296_), .b(new_n287_), .c(new_n197_), .O(z42));
  nor3   g151(.a(new_n296_), .b(new_n287_), .c(new_n194_), .O(z43));
  ...
  nand3  g158(.a(new_n232_), .b(new_n154_), .c(new_n159_), .O(new_n317_));
  ...
  nand2  g165(.a(new_n323_), .b(new_n229_), .O(new_n324_));
  aoi21  g166(.a(new_n324_), .b(new_n319_), .c(x01), .O(z47));
  inv1   g167(.a(x08), .O(new_n326_));
  nand2  g168(.a(x52), .b(x16), .O(new_n327_));
  oai21  g169(.a(x52), .b(new_n326_), .c(new_n327_), .O(new_n328_));
  nand2  g170(.a(new_n328_), .b(new_n318_), .O(new_n329_));
  inv1   g171(.a(new_n229_), .O(new_n330_));
  nor2   g172(.a(new_n322_), .b(new_n330_), .O(new_n331_));
  nand2  g173(.a(new_n331_), .b(x68), .O(new_n332_));
  aoi21  g174(.a(new_n332_), .b(new_n329_), .c(x01), .O(z48));
  inv1   g175(.a(x09), .O(new_n334_));
  nand2  g176(.a(x52), .b(x17), .O(new_n335_));
  oai21  g177(.a(x52), .b(new_n334_), .c(new_n335_), .O(new_n336_));
  nand2  g178(.a(new_n336_), .b(new_n318_), .O(new_n337_));
  nand2  g179(.a(new_n331_), .b(x69), .O(new_n338_));
  aoi21  g180(.a(new_n338_), .b(new_n337_), .c(x01), .O(z49));
  inv1   g181(.a(x11), .O(new_n341_));
  nand2  g182(.a(x52), .b(x19), .O(new_n342_));
  oai21  g183(.a(x52), .b(new_n341_), .c(new_n342_), .O(new_n343_));
  nand2  g184(.a(new_n343_), .b(new_n318_), .O(new_n344_));
  nand2  g185(.a(new_n331_), .b(x71), .O(new_n345_));
  aoi21  g186(.a(new_n345_), .b(new_n344_), .c(x01), .O(z51));
  inv1   g187(.a(x12), .O(new_n347_));
  nand2  g188(.a(x52), .b(x20), .O(new_n348_));
  oai21  g189(.a(x52), .b(new_n347_), .c(new_n348_), .O(new_n349_));
  nand2  g190(.a(new_n349_), .b(new_n318_), .O(new_n350_));
  nand2  g191(.a(new_n331_), .b(x72), .O(new_n351_));
  aoi21  g192(.a(new_n351_), .b(new_n350_), .c(x01), .O(z52));
  inv1   g193(.a(x13), .O(new_n353_));
  nand2  g194(.a(x52), .b(x21), .O(new_n354_));
  oai21  g195(.a(x52), .b(new_n353_), .c(new_n354_), .O(new_n355_));
  nand2  g196(.a(new_n355_), .b(new_n318_), .O(new_n356_));
  nand2  g197(.a(new_n331_), .b(x73), .O(new_n357_));
  aoi21  g198(.a(new_n357_), .b(new_n356_), .c(x01), .O(z53));
  nand2  g199(.a(x52), .b(x22), .O(new_n359_));
  nand2  g200(.a(new_n286_), .b(x14), .O(new_n360_));
  inv1   g201(.a(new_n170_), .O(new_n361_));
  nand4  g202(.a(new_n361_), .b(new_n154_), .c(x04), .d(new_n153_), .O(new_n362_));
  aoi21  g203(.a(new_n360_), .b(new_n359_), .c(new_n362_), .O(z54));
  inv1   g204(.a(x82), .O(new_n364_));
  nand3  g205(.a(new_n273_), .b(x84), .c(new_n364_), .O(new_n365_));
  inv1   g206(.a(x80), .O(new_n366_));
  nand4  g207(.a(new_n247_), .b(new_n165_), .c(new_n366_), .d(x79), .O(new_n367_));
  nor2   g208(.a(new_n367_), .b(new_n365_), .O(z55));
  nand2  g209(.a(new_n245_), .b(x76), .O(new_n369_));
  xnor2a g210(.a(x84), .b(x81), .O(new_n370_));
  aoi21  g211(.a(new_n171_), .b(new_n170_), .c(new_n370_), .O(new_n371_));
  nand2  g212(.a(new_n371_), .b(new_n153_), .O(new_n372_));
  nand2  g213(.a(new_n372_), .b(new_n369_), .O(new_n373_));
  nand2  g214(.a(new_n373_), .b(x79), .O(new_n374_));
  nor2   g215(.a(x77), .b(x01), .O(new_n375_));
  aoi21  g216(.a(new_n375_), .b(new_n164_), .c(new_n242_), .O(new_n376_));
  nand2  g217(.a(new_n376_), .b(new_n374_), .O(z56));
  inv1   g218(.a(x02), .O(new_n378_));
  nand3  g219(.a(new_n243_), .b(x03), .c(new_n378_), .O(new_n379_));
  inv1   g220(.a(new_n379_), .O(z57));
  nand4  g221(.a(x80), .b(new_n235_), .c(x43), .d(new_n250_), .O(new_n381_));
  oai22  g222(.a(new_n381_), .b(new_n234_), .c(new_n250_), .d(x40), .O(new_n382_));
  nand3  g223(.a(new_n382_), .b(new_n232_), .c(x79), .O(new_n383_));
  nand3  g224(.a(new_n178_), .b(new_n250_), .c(x40), .O(new_n384_));
  nand2  g225(.a(new_n384_), .b(new_n383_), .O(new_n385_));
  nand2  g226(.a(new_n385_), .b(x77), .O(new_n386_));
  oai21  g227(.a(new_n361_), .b(new_n160_), .c(new_n154_), .O(new_n387_));
  aoi21  g228(.a(new_n387_), .b(new_n386_), .c(x01), .O(z58));
  aoi21  g229(.a(new_n163_), .b(new_n179_), .c(new_n152_), .O(new_n389_));
  oai21  g230(.a(new_n236_), .b(new_n234_), .c(new_n250_), .O(new_n390_));
  ...
  aoi21  g236(.a(new_n371_), .b(x79), .c(new_n393_), .O(new_n396_));
  ...
  nor3   g241(.a(new_n400_), .b(new_n398_), .c(new_n366_), .O(z61));
