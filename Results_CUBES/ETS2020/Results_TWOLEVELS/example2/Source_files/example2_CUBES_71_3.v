...
module FAU ( 
  ...
  nand4  g114(.a(new_n256_), .b(new_n255_), .c(x50), .d(new_n247_), .O(new_n270_));
  inv1   g115(.a(new_n270_), .O(z32));
  nor2   g116(.a(new_n234_), .b(x81), .O(new_n272_));
  ...
  nand2  g127(.a(new_n256_), .b(new_n282_), .O(new_n283_));
  aoi21  g128(.a(new_n281_), .b(new_n278_), .c(new_n283_), .O(z33));
  inv1   g129(.a(x52), .O(new_n285_));
  inv1   g130(.a(new_n256_), .O(new_n286_));
  ...
  nand2  g141(.a(new_n256_), .b(x53), .O(new_n297_));
  ...
  nor3   g147(.a(new_n295_), .b(new_n286_), .c(new_n205_), .O(z39));
  nor3   g148(.a(new_n295_), .b(new_n286_), .c(new_n202_), .O(z40));
  nor3   g149(.a(new_n295_), .b(new_n286_), .c(new_n199_), .O(z41));
  nor3   g150(.a(new_n295_), .b(new_n286_), .c(new_n196_), .O(z42));
  nor3   g151(.a(new_n295_), .b(new_n286_), .c(new_n193_), .O(z43));
  nand2  g152(.a(new_n256_), .b(x62), .O(new_n309_));
  nor2   g153(.a(new_n309_), .b(new_n295_), .O(z44));
  nor3   g154(.a(new_n295_), .b(new_n286_), .c(new_n189_), .O(z45));
  nor3   g155(.a(new_n295_), .b(new_n286_), .c(new_n186_), .O(z46));
  ...
  inv1   g171(.a(new_n230_), .O(new_n329_));
  nor2   g172(.a(new_n320_), .b(new_n329_), .O(new_n330_));
  nand2  g173(.a(new_n330_), .b(x69), .O(new_n331_));
  aoi21  g174(.a(new_n331_), .b(new_n328_), .c(x01), .O(z49));
  inv1   g175(.a(x11), .O(new_n334_));
  nand2  g176(.a(x52), .b(x19), .O(new_n335_));
  oai21  g177(.a(x52), .b(new_n334_), .c(new_n335_), .O(new_n336_));
  nand2  g178(.a(new_n336_), .b(new_n317_), .O(new_n337_));
  nand2  g179(.a(new_n330_), .b(x71), .O(new_n338_));
  ...
  nand2  g185(.a(new_n330_), .b(x72), .O(new_n344_));
  ...
  nand2  g191(.a(new_n330_), .b(x73), .O(new_n350_));
  aoi21  g192(.a(new_n350_), .b(new_n349_), .c(x01), .O(z53));
  nand2  g193(.a(x52), .b(x22), .O(new_n352_));
  nand2  g194(.a(new_n285_), .b(x14), .O(new_n353_));
  ...
  inv1   g198(.a(new_n272_), .O(new_n357_));
