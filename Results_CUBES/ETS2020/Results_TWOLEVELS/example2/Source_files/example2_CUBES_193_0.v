...
module FAU ( 
  ...
  nand3  g117(.a(x83), .b(new_n242_), .c(x42), .O(new_n277_));
  aoi21  g118(.a(new_n277_), .b(new_n276_), .c(new_n239_), .O(new_n278_));
  oai21  g119(.a(new_n278_), .b(new_n275_), .c(new_n268_), .O(new_n279_));
  nand2  g120(.a(new_n235_), .b(x52), .O(new_n280_));
  nor2   g121(.a(new_n280_), .b(new_n279_), .O(z34));
  nand2  g122(.a(new_n235_), .b(x53), .O(new_n282_));
  nor2   g123(.a(new_n282_), .b(new_n279_), .O(z35));
  nand2  g124(.a(new_n235_), .b(x54), .O(new_n284_));
  nor2   g125(.a(new_n284_), .b(new_n279_), .O(z36));
  nand2  g126(.a(new_n235_), .b(x55), .O(new_n286_));
  nor2   g127(.a(new_n286_), .b(new_n279_), .O(z37));
  inv1   g128(.a(new_n235_), .O(new_n290_));
  nor3   g129(.a(new_n279_), .b(new_n290_), .c(new_n188_), .O(z40));
  nor3   g130(.a(new_n279_), .b(new_n290_), .c(new_n185_), .O(z41));
  nor3   g131(.a(new_n279_), .b(new_n290_), .c(new_n179_), .O(z43));
  nor3   g132(.a(new_n279_), .b(new_n290_), .c(new_n176_), .O(z44));
  nor3   g133(.a(new_n279_), .b(new_n290_), .c(new_n170_), .O(z46));
  ...
  nand2  g162(.a(new_n327_), .b(new_n304_), .O(new_n328_));
  nand2  g163(.a(new_n309_), .b(x72), .O(new_n329_));
  aoi21  g164(.a(new_n329_), .b(new_n328_), .c(x01), .O(z52));
  inv1   g165(.a(x13), .O(new_n331_));
  nand2  g166(.a(x52), .b(x21), .O(new_n332_));
  oai21  g167(.a(x52), .b(new_n331_), .c(new_n332_), .O(new_n333_));
  nand2  g168(.a(new_n333_), .b(new_n304_), .O(new_n334_));
  nand2  g169(.a(new_n309_), .b(x73), .O(new_n335_));
  aoi21  g170(.a(new_n335_), .b(new_n334_), .c(x01), .O(z53));
  nand2  g171(.a(new_n233_), .b(x76), .O(new_n339_));
  xnor2a g172(.a(x84), .b(x81), .O(new_n340_));
  aoi21  g173(.a(new_n213_), .b(new_n212_), .c(new_n340_), .O(new_n341_));
  ...
  nand3  g178(.a(new_n345_), .b(new_n344_), .c(new_n231_), .O(z56));
  inv1   g179(.a(x02), .O(new_n347_));
  nand3  g180(.a(new_n231_), .b(x03), .c(new_n347_), .O(new_n348_));
  inv1   g181(.a(new_n348_), .O(z57));
  nand4  g182(.a(x80), .b(new_n220_), .c(x43), .d(new_n238_), .O(new_n350_));
  oai22  g183(.a(new_n350_), .b(new_n219_), .c(new_n238_), .d(x40), .O(new_n351_));
  nand3  g184(.a(new_n351_), .b(new_n225_), .c(x79), .O(new_n352_));
  ...
  inv1   g189(.a(new_n212_), .O(new_n357_));
  oai21  g190(.a(new_n357_), .b(new_n228_), .c(new_n154_), .O(new_n358_));
  aoi21  g191(.a(new_n358_), .b(new_n356_), .c(x01), .O(z58));
  inv1   g192(.a(new_n353_), .O(new_n360_));
  aoi21  g193(.a(new_n224_), .b(new_n360_), .c(new_n152_), .O(new_n361_));
  oai21  g194(.a(new_n221_), .b(new_n219_), .c(new_n238_), .O(new_n362_));
  aoi21  g195(.a(new_n362_), .b(x79), .c(new_n224_), .O(new_n363_));
  ...
  aoi21  g200(.a(new_n341_), .b(x79), .c(new_n365_), .O(new_n368_));
  aoi21  g201(.a(new_n368_), .b(new_n226_), .c(x01), .O(z60));
  nand2  g202(.a(new_n213_), .b(new_n212_), .O(new_n370_));
  aoi22  g203(.a(new_n370_), .b(new_n215_), .c(new_n161_), .d(new_n228_), .O(new_n371_));
  nor2   g204(.a(new_n154_), .b(x01), .O(new_n372_));
  nand2  g205(.a(new_n372_), .b(x80), .O(new_n373_));
  nor2   g206(.a(new_n373_), .b(new_n371_), .O(z61));
  nand3  g207(.a(x84), .b(x81), .c(x79), .O(new_n375_));
  oai21  g208(.a(x79), .b(new_n228_), .c(new_n375_), .O(new_n376_));
  nand2  g209(.a(new_n376_), .b(new_n159_), .O(new_n377_));
  nand2  g210(.a(new_n362_), .b(x79), .O(new_n378_));
  nand3  g211(.a(x81), .b(x79), .c(new_n228_), .O(new_n379_));
  ...
  nand2  g217(.a(new_n384_), .b(new_n306_), .O(new_n385_));
  aoi21  g218(.a(new_n385_), .b(new_n383_), .c(x01), .O(z62));
  nand2  g219(.a(new_n372_), .b(x82), .O(new_n387_));
  nor2   g220(.a(new_n387_), .b(new_n371_), .O(z63));
  nand2  g221(.a(x83), .b(x79), .O(new_n389_));
  or2    g222(.a(new_n389_), .b(new_n371_), .O(new_n390_));
  aoi21  g223(.a(new_n390_), .b(new_n303_), .c(x01), .O(z64));
  nor2   g224(.a(new_n160_), .b(x04), .O(new_n392_));
  nor2   g225(.a(new_n242_), .b(x78), .O(new_n393_));
  oai21  g226(.a(new_n393_), .b(new_n392_), .c(x77), .O(new_n394_));
  nand2  g227(.a(new_n357_), .b(x81), .O(new_n395_));
  nand2  g228(.a(new_n372_), .b(x84), .O(new_n396_));
