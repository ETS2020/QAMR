...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n175_, new_n176_, new_n179_, new_n180_, new_n184_, new_n185_,
    ...
    new_n284_, new_n286_, new_n288_, new_n290_, new_n295_, new_n300_,
  ...
  nor2   g101(.a(x83), .b(new_n241_), .O(new_n260_));
  nor2   g102(.a(new_n260_), .b(new_n259_), .O(new_n261_));
  nand2  g103(.a(x42), .b(x05), .O(new_n262_));
  nand2  g104(.a(x51), .b(new_n237_), .O(new_n263_));
  oai22  g105(.a(new_n263_), .b(new_n241_), .c(new_n262_), .d(new_n261_), .O(new_n264_));
  nand2  g106(.a(new_n264_), .b(new_n239_), .O(new_n265_));
  xor2a  g107(.a(x83), .b(x81), .O(new_n266_));
  oai22  g108(.a(new_n266_), .b(new_n262_), .c(new_n263_), .d(x81), .O(new_n267_));
  nand2  g109(.a(new_n267_), .b(new_n242_), .O(new_n268_));
  ...
  nand2  g114(.a(new_n272_), .b(new_n241_), .O(new_n273_));
  nand3  g115(.a(x83), .b(x81), .c(x42), .O(new_n274_));
  nand2  g116(.a(new_n274_), .b(new_n273_), .O(new_n275_));
  and2   g117(.a(new_n275_), .b(new_n242_), .O(new_n276_));
  nand2  g118(.a(new_n272_), .b(x81), .O(new_n277_));
  nand2  g119(.a(new_n259_), .b(x42), .O(new_n278_));
  aoi21  g120(.a(new_n278_), .b(new_n277_), .c(new_n238_), .O(new_n279_));
  oai21  g121(.a(new_n279_), .b(new_n276_), .c(new_n269_), .O(new_n280_));
  nand2  g122(.a(new_n234_), .b(x52), .O(new_n281_));
  nor2   g123(.a(new_n281_), .b(new_n280_), .O(z34));
  nand2  g124(.a(new_n234_), .b(x54), .O(new_n284_));
  nor2   g125(.a(new_n284_), .b(new_n280_), .O(z36));
  nand2  g126(.a(new_n234_), .b(x55), .O(new_n286_));
  nor2   g127(.a(new_n286_), .b(new_n280_), .O(z37));
  nand2  g128(.a(new_n234_), .b(x56), .O(new_n288_));
  nor2   g129(.a(new_n288_), .b(new_n280_), .O(z38));
  inv1   g130(.a(new_n234_), .O(new_n290_));
  nor3   g131(.a(new_n280_), .b(new_n290_), .c(new_n193_), .O(z39));
  nor3   g132(.a(new_n280_), .b(new_n290_), .c(new_n190_), .O(z40));
  nor3   g133(.a(new_n280_), .b(new_n290_), .c(new_n187_), .O(z41));
  nand2  g134(.a(new_n234_), .b(x61), .O(new_n295_));
  nor2   g135(.a(new_n295_), .b(new_n280_), .O(z43));
  nor3   g136(.a(new_n280_), .b(new_n290_), .c(new_n179_), .O(z45));
  ...
  inv1   g154(.a(new_n216_), .O(new_n317_));
  ...
  nand3  g183(.a(new_n259_), .b(x84), .c(new_n347_), .O(new_n348_));
  inv1   g184(.a(x80), .O(new_n349_));
  nand4  g185(.a(new_n234_), .b(new_n161_), .c(new_n349_), .d(x79), .O(new_n350_));
  nor2   g186(.a(new_n350_), .b(new_n348_), .O(z55));
  nand2  g187(.a(new_n160_), .b(new_n159_), .O(new_n352_));
  nand2  g188(.a(new_n232_), .b(x76), .O(new_n353_));
  xnor2a g189(.a(x84), .b(x81), .O(new_n354_));
  aoi21  g190(.a(new_n168_), .b(new_n167_), .c(new_n354_), .O(new_n355_));
  ...
  nand4  g195(.a(x80), .b(new_n221_), .c(x43), .d(new_n237_), .O(new_n361_));
  oai22  g196(.a(new_n361_), .b(new_n220_), .c(new_n237_), .d(x40), .O(new_n362_));
  nand3  g197(.a(new_n362_), .b(new_n226_), .c(x79), .O(new_n363_));
  nor2   g198(.a(x79), .b(x78), .O(new_n364_));
  nand3  g199(.a(new_n364_), .b(new_n237_), .c(x40), .O(new_n365_));
  nand2  g200(.a(new_n365_), .b(new_n363_), .O(new_n366_));
  nand2  g201(.a(new_n366_), .b(x77), .O(new_n367_));
  inv1   g202(.a(new_n167_), .O(new_n368_));
  oai21  g203(.a(new_n368_), .b(new_n229_), .c(new_n154_), .O(new_n369_));
  aoi21  g204(.a(new_n369_), .b(new_n367_), .c(x01), .O(z58));
  inv1   g205(.a(new_n364_), .O(new_n371_));
  aoi21  g206(.a(new_n225_), .b(new_n371_), .c(new_n152_), .O(new_n372_));
  oai21  g207(.a(new_n222_), .b(new_n220_), .c(new_n237_), .O(new_n373_));
  aoi21  g208(.a(new_n373_), .b(x79), .c(new_n225_), .O(new_n374_));
  oai21  g209(.a(new_n374_), .b(new_n372_), .c(x77), .O(new_n375_));
  nor2   g210(.a(x79), .b(x04), .O(new_n376_));
  inv1   g211(.a(new_n376_), .O(new_n377_));
  aoi21  g212(.a(new_n377_), .b(new_n375_), .c(x01), .O(z59));
  aoi21  g213(.a(new_n355_), .b(x79), .c(new_n376_), .O(new_n379_));
  aoi21  g214(.a(new_n379_), .b(new_n227_), .c(x01), .O(z60));
  inv1   g215(.a(new_n170_), .O(new_n381_));
  nand2  g216(.a(new_n168_), .b(new_n167_), .O(new_n382_));
  aoi22  g217(.a(new_n382_), .b(new_n216_), .c(new_n161_), .d(new_n229_), .O(new_n383_));
  nor3   g218(.a(new_n383_), .b(new_n381_), .c(new_n349_), .O(z61));
  nand3  g219(.a(x84), .b(x81), .c(x79), .O(new_n385_));
  oai21  g220(.a(x79), .b(new_n229_), .c(new_n385_), .O(new_n386_));
  nand2  g221(.a(new_n386_), .b(new_n159_), .O(new_n387_));
  nand2  g222(.a(new_n373_), .b(x79), .O(new_n388_));
  nand3  g223(.a(x81), .b(x79), .c(new_n229_), .O(new_n389_));
  ...
  nand2  g229(.a(new_n394_), .b(new_n308_), .O(new_n395_));
  ...
  or2    g233(.a(new_n398_), .b(new_n383_), .O(new_n399_));
  aoi21  g234(.a(new_n399_), .b(new_n304_), .c(x01), .O(z64));
  nor2   g235(.a(new_n160_), .b(x04), .O(new_n401_));
  nor2   g236(.a(new_n241_), .b(x78), .O(new_n402_));
  oai21  g237(.a(new_n402_), .b(new_n401_), .c(x77), .O(new_n403_));
  nand2  g238(.a(new_n368_), .b(x81), .O(new_n404_));
  nand2  g239(.a(new_n170_), .b(x84), .O(new_n405_));
