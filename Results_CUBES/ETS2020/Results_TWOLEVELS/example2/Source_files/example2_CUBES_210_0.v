...
module FAU ( 
  ...
  nand2  g154(.a(new_n318_), .b(new_n307_), .O(new_n319_));
  ...
  nand2  g160(.a(new_n325_), .b(new_n307_), .O(new_n326_));
  nand2  g161(.a(new_n312_), .b(x72), .O(new_n327_));
  ...
  nand2  g170(.a(new_n275_), .b(x14), .O(new_n336_));
  inv1   g171(.a(new_n216_), .O(new_n337_));
  ...
  aoi21  g176(.a(new_n217_), .b(new_n216_), .c(new_n342_), .O(new_n343_));
  ...
  nand3  g181(.a(new_n347_), .b(new_n346_), .c(new_n235_), .O(z56));
  inv1   g182(.a(x02), .O(new_n349_));
  nand3  g183(.a(new_n235_), .b(x03), .c(new_n349_), .O(new_n350_));
  inv1   g184(.a(new_n350_), .O(z57));
  nand4  g185(.a(x80), .b(new_n224_), .c(x43), .d(new_n242_), .O(new_n352_));
  oai22  g186(.a(new_n352_), .b(new_n223_), .c(new_n242_), .d(x40), .O(new_n353_));
  nand3  g187(.a(new_n353_), .b(new_n229_), .c(x79), .O(new_n354_));
  nor2   g188(.a(x79), .b(x78), .O(new_n355_));
  nand3  g189(.a(new_n355_), .b(new_n242_), .c(x40), .O(new_n356_));
  nand2  g190(.a(new_n356_), .b(new_n354_), .O(new_n357_));
  nand2  g191(.a(new_n357_), .b(x77), .O(new_n358_));
  oai21  g192(.a(new_n337_), .b(new_n232_), .c(new_n154_), .O(new_n359_));
  aoi21  g193(.a(new_n359_), .b(new_n358_), .c(x01), .O(z58));
  inv1   g194(.a(new_n355_), .O(new_n361_));
  aoi21  g195(.a(new_n228_), .b(new_n361_), .c(new_n152_), .O(new_n362_));
  oai21  g196(.a(new_n225_), .b(new_n223_), .c(new_n242_), .O(new_n363_));
  aoi21  g197(.a(new_n363_), .b(x79), .c(new_n228_), .O(new_n364_));
  ...
  aoi21  g203(.a(new_n369_), .b(new_n230_), .c(x01), .O(z60));
  nand2  g204(.a(new_n217_), .b(new_n216_), .O(new_n371_));
  aoi22  g205(.a(new_n371_), .b(new_n219_), .c(new_n161_), .d(new_n232_), .O(new_n372_));
  nor2   g206(.a(new_n154_), .b(x01), .O(new_n373_));
  nand2  g207(.a(new_n373_), .b(x80), .O(new_n374_));
  nor2   g208(.a(new_n374_), .b(new_n372_), .O(z61));
  nand3  g209(.a(x84), .b(x81), .c(x79), .O(new_n376_));
  oai21  g210(.a(x79), .b(new_n232_), .c(new_n376_), .O(new_n377_));
  nand2  g211(.a(new_n377_), .b(new_n159_), .O(new_n378_));
  nand2  g212(.a(new_n363_), .b(x79), .O(new_n379_));
  nand3  g213(.a(x81), .b(x79), .c(new_n232_), .O(new_n380_));
  inv1   g214(.a(new_n380_), .O(new_n381_));
  aoi21  g215(.a(new_n379_), .b(x04), .c(new_n381_), .O(new_n382_));
  oai21  g216(.a(new_n382_), .b(new_n159_), .c(new_n378_), .O(new_n383_));
  nand2  g217(.a(new_n383_), .b(x78), .O(new_n384_));
  inv1   g218(.a(new_n376_), .O(new_n385_));
  nand2  g219(.a(new_n385_), .b(new_n309_), .O(new_n386_));
  aoi21  g220(.a(new_n386_), .b(new_n384_), .c(x01), .O(z62));
  nand2  g221(.a(new_n373_), .b(x82), .O(new_n388_));
  nor2   g222(.a(new_n388_), .b(new_n372_), .O(z63));
  nand2  g223(.a(x83), .b(x79), .O(new_n390_));
  or2    g224(.a(new_n390_), .b(new_n372_), .O(new_n391_));
  aoi21  g225(.a(new_n391_), .b(new_n306_), .c(x01), .O(z64));
  nor2   g226(.a(new_n160_), .b(x04), .O(new_n393_));
  nor2   g227(.a(new_n246_), .b(x78), .O(new_n394_));
  oai21  g228(.a(new_n394_), .b(new_n393_), .c(x77), .O(new_n395_));
  nand2  g229(.a(new_n337_), .b(x81), .O(new_n396_));
  nand2  g230(.a(new_n373_), .b(x84), .O(new_n397_));
