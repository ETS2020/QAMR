...
module FAU ( 
  ...
  wire new_n154_, new_n155_, new_n156_, new_n157_, new_n158_, new_n159_,
    ...
    new_n172_, new_n173_, new_n175_, new_n176_, new_n180_, new_n181_,
    ...
    new_n219_, new_n220_, new_n223_, new_n224_, new_n225_, new_n228_,
    new_n229_, new_n230_, new_n233_, new_n234_, new_n235_, new_n238_,
    new_n239_, new_n240_, new_n241_, new_n242_, new_n243_, new_n244_,
    new_n245_, new_n246_, new_n247_, new_n249_, new_n250_, new_n251_,
    new_n252_, new_n253_, new_n254_, new_n255_, new_n256_, new_n257_,
    new_n258_, new_n260_, new_n262_, new_n265_, new_n267_, new_n269_,
    new_n272_, new_n275_, new_n277_, new_n279_, new_n282_, new_n283_,
  ...
  nor2   g054(.a(x04), .b(x01), .O(new_n217_));
  nand3  g055(.a(new_n217_), .b(new_n216_), .c(x05), .O(new_n218_));
  inv1   g056(.a(new_n218_), .O(new_n219_));
  nand3  g057(.a(new_n219_), .b(new_n215_), .c(new_n213_), .O(new_n220_));
  inv1   g058(.a(new_n220_), .O(z25));
  nand3  g059(.a(new_n217_), .b(x45), .c(new_n216_), .O(new_n223_));
  inv1   g060(.a(new_n223_), .O(new_n224_));
  nand3  g061(.a(new_n224_), .b(new_n215_), .c(new_n213_), .O(new_n225_));
  inv1   g062(.a(new_n225_), .O(z27));
  nand3  g063(.a(new_n217_), .b(x47), .c(new_n216_), .O(new_n228_));
  inv1   g064(.a(new_n228_), .O(new_n229_));
  nand3  g065(.a(new_n229_), .b(new_n215_), .c(new_n213_), .O(new_n230_));
  inv1   g066(.a(new_n230_), .O(z29));
  nand3  g067(.a(new_n217_), .b(x49), .c(new_n216_), .O(new_n233_));
  inv1   g068(.a(new_n233_), .O(new_n234_));
  nand3  g069(.a(new_n234_), .b(new_n215_), .c(new_n213_), .O(new_n235_));
  inv1   g070(.a(new_n235_), .O(z31));
  inv1   g071(.a(new_n210_), .O(new_n238_));
  xnor2a g072(.a(x83), .b(x81), .O(new_n239_));
  nand2  g073(.a(x42), .b(x05), .O(new_n240_));
  nand2  g074(.a(x51), .b(new_n216_), .O(new_n241_));
  oai22  g075(.a(new_n241_), .b(new_n209_), .c(new_n240_), .d(new_n239_), .O(new_n242_));
  nand2  g076(.a(new_n242_), .b(new_n238_), .O(new_n243_));
  xor2a  g077(.a(x83), .b(x81), .O(new_n244_));
  oai22  g078(.a(new_n244_), .b(new_n240_), .c(new_n241_), .d(x81), .O(new_n245_));
  nand2  g079(.a(new_n245_), .b(new_n211_), .O(new_n246_));
  nand2  g080(.a(new_n217_), .b(new_n215_), .O(new_n247_));
  aoi21  g081(.a(new_n246_), .b(new_n243_), .c(new_n247_), .O(z33));
  xnor2a g082(.a(x84), .b(x82), .O(new_n249_));
  nand2  g083(.a(x83), .b(x42), .O(new_n250_));
  nand2  g084(.a(new_n250_), .b(new_n209_), .O(new_n251_));
  ...
  nand3  g088(.a(x83), .b(new_n209_), .c(x42), .O(new_n255_));
  aoi21  g089(.a(new_n255_), .b(new_n254_), .c(new_n210_), .O(new_n256_));
  oai21  g090(.a(new_n256_), .b(new_n253_), .c(new_n215_), .O(new_n257_));
  nand2  g091(.a(new_n217_), .b(x52), .O(new_n258_));
  nor2   g092(.a(new_n258_), .b(new_n257_), .O(z34));
  nand2  g093(.a(new_n217_), .b(x53), .O(new_n260_));
  nor2   g094(.a(new_n260_), .b(new_n257_), .O(z35));
  nand2  g095(.a(new_n217_), .b(x54), .O(new_n262_));
  nor2   g096(.a(new_n262_), .b(new_n257_), .O(z36));
  nand2  g097(.a(new_n217_), .b(x56), .O(new_n265_));
  nor2   g098(.a(new_n265_), .b(new_n257_), .O(z38));
  nand2  g099(.a(new_n217_), .b(x57), .O(new_n267_));
  nor2   g100(.a(new_n267_), .b(new_n257_), .O(z39));
  nand2  g101(.a(new_n217_), .b(x58), .O(new_n269_));
  nor2   g102(.a(new_n269_), .b(new_n257_), .O(z40));
  nand2  g103(.a(new_n217_), .b(x60), .O(new_n272_));
  nor2   g104(.a(new_n272_), .b(new_n257_), .O(z42));
  nand2  g105(.a(new_n217_), .b(x62), .O(new_n275_));
  nor2   g106(.a(new_n275_), .b(new_n257_), .O(z44));
  nand2  g107(.a(new_n217_), .b(x63), .O(new_n277_));
  nor2   g108(.a(new_n277_), .b(new_n257_), .O(z45));
  nand2  g109(.a(new_n217_), .b(x64), .O(new_n279_));
  nor2   g110(.a(new_n279_), .b(new_n257_), .O(z46));
  inv1   g111(.a(x08), .O(new_n282_));
  nand2  g112(.a(x52), .b(x16), .O(new_n283_));
  oai21  g113(.a(x52), .b(new_n282_), .c(new_n283_), .O(new_n284_));
  inv1   g114(.a(x04), .O(new_n285_));
  nor2   g115(.a(x77), .b(new_n285_), .O(new_n286_));
  nor2   g116(.a(x79), .b(new_n156_), .O(new_n287_));
  nand3  g117(.a(new_n287_), .b(new_n286_), .c(new_n284_), .O(new_n288_));
  xnor2a g118(.a(x84), .b(x81), .O(new_n289_));
  nor2   g119(.a(x78), .b(new_n154_), .O(new_n290_));
  nand4  g120(.a(new_n290_), .b(new_n289_), .c(x79), .d(x68), .O(new_n291_));
  aoi21  g121(.a(new_n291_), .b(new_n288_), .c(x01), .O(z48));
  inv1   g122(.a(x09), .O(new_n293_));
  nand2  g123(.a(x52), .b(x17), .O(new_n294_));
  oai21  g124(.a(x52), .b(new_n293_), .c(new_n294_), .O(new_n295_));
  nand3  g125(.a(new_n295_), .b(new_n287_), .c(new_n286_), .O(new_n296_));
  nand4  g126(.a(new_n290_), .b(new_n289_), .c(x79), .d(x69), .O(new_n297_));
  ...
  nand3  g131(.a(new_n301_), .b(new_n287_), .c(new_n286_), .O(new_n302_));
  nand4  g132(.a(new_n290_), .b(new_n289_), .c(x79), .d(x70), .O(new_n303_));
  ...
  nand3  g137(.a(new_n307_), .b(new_n287_), .c(new_n286_), .O(new_n308_));
  nand4  g138(.a(new_n290_), .b(new_n289_), .c(x79), .d(x71), .O(new_n309_));
  ...
  nand3  g143(.a(new_n313_), .b(new_n287_), .c(new_n286_), .O(new_n314_));
  nand4  g144(.a(new_n290_), .b(new_n289_), .c(x79), .d(x72), .O(new_n315_));
  ...
  nand3  g149(.a(new_n319_), .b(new_n287_), .c(new_n286_), .O(new_n320_));
  nand4  g150(.a(new_n290_), .b(new_n289_), .c(x79), .d(x73), .O(new_n321_));
  aoi21  g151(.a(new_n321_), .b(new_n320_), .c(x01), .O(z53));
  inv1   g152(.a(x14), .O(new_n323_));
  nor2   g153(.a(x52), .b(new_n323_), .O(new_n324_));
  aoi21  g154(.a(x52), .b(x22), .c(new_n324_), .O(new_n325_));
  inv1   g155(.a(x79), .O(new_n326_));
  nor2   g156(.a(new_n285_), .b(x01), .O(new_n327_));
  nand4  g157(.a(new_n327_), .b(new_n326_), .c(x78), .d(new_n154_), .O(new_n328_));
  nor2   g158(.a(new_n328_), .b(new_n325_), .O(z54));
