// Benchmark "FAU" written by ABC on Fri Jul 10 18:25:30 2020
...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n282_, new_n283_, new_n285_, new_n287_, new_n289_, new_n298_,
  ...
  nor3   g133(.a(new_n283_), .b(new_n274_), .c(new_n180_), .O(z42));
  nor3   g134(.a(new_n283_), .b(new_n274_), .c(new_n177_), .O(z43));
  nand2  g135(.a(new_n235_), .b(x63), .O(new_n298_));
  nor2   g136(.a(new_n298_), .b(new_n283_), .O(z45));
  inv1   g137(.a(x08), .O(new_n302_));
  nand2  g138(.a(x52), .b(x16), .O(new_n303_));
  oai21  g139(.a(x52), .b(new_n302_), .c(new_n303_), .O(new_n304_));
  nor2   g140(.a(x79), .b(x77), .O(new_n305_));
  nand2  g141(.a(new_n305_), .b(new_n225_), .O(new_n306_));
  inv1   g142(.a(new_n306_), .O(new_n307_));
  nand2  g143(.a(new_n307_), .b(new_n304_), .O(new_n308_));
  inv1   g144(.a(new_n213_), .O(new_n309_));
  nand2  g145(.a(new_n309_), .b(x79), .O(new_n310_));
  inv1   g146(.a(new_n310_), .O(new_n311_));
  and2   g147(.a(new_n311_), .b(new_n215_), .O(new_n312_));
  ...
  nand2  g154(.a(new_n312_), .b(x69), .O(new_n319_));
  ...
  nand2  g159(.a(new_n323_), .b(new_n307_), .O(new_n324_));
  nand2  g160(.a(new_n312_), .b(x70), .O(new_n325_));
  ...
  nand2  g165(.a(new_n329_), .b(new_n307_), .O(new_n330_));
  nand2  g166(.a(new_n312_), .b(x71), .O(new_n331_));
  ...
  nand2  g171(.a(new_n335_), .b(new_n307_), .O(new_n336_));
  nand2  g172(.a(new_n312_), .b(x72), .O(new_n337_));
  ...
  nand2  g177(.a(new_n341_), .b(new_n307_), .O(new_n342_));
  nand2  g178(.a(new_n312_), .b(x73), .O(new_n343_));
  aoi21  g179(.a(new_n343_), .b(new_n342_), .c(x01), .O(z53));
  nand2  g180(.a(x52), .b(x22), .O(new_n345_));
  nand2  g181(.a(new_n273_), .b(x14), .O(new_n346_));
  inv1   g182(.a(new_n212_), .O(new_n347_));
  nand4  g183(.a(new_n347_), .b(new_n154_), .c(x04), .d(new_n153_), .O(new_n348_));
  aoi21  g184(.a(new_n346_), .b(new_n345_), .c(new_n348_), .O(z54));
  inv1   g185(.a(x82), .O(new_n350_));
  nand3  g186(.a(new_n260_), .b(x84), .c(new_n350_), .O(new_n351_));
  inv1   g187(.a(x80), .O(new_n352_));
  nand4  g188(.a(new_n235_), .b(new_n161_), .c(new_n352_), .d(x79), .O(new_n353_));
  nor2   g189(.a(new_n353_), .b(new_n351_), .O(z55));
  nand2  g190(.a(new_n233_), .b(x76), .O(new_n355_));
  xnor2a g191(.a(x84), .b(x81), .O(new_n356_));
  aoi21  g192(.a(new_n213_), .b(new_n212_), .c(new_n356_), .O(new_n357_));
  nand2  g193(.a(new_n357_), .b(new_n153_), .O(new_n358_));
  nand2  g194(.a(new_n358_), .b(new_n355_), .O(new_n359_));
  nand2  g195(.a(new_n359_), .b(x79), .O(new_n360_));
  nand3  g196(.a(new_n160_), .b(new_n159_), .c(new_n153_), .O(new_n361_));
  nand3  g197(.a(new_n361_), .b(new_n360_), .c(new_n231_), .O(z56));
  inv1   g198(.a(x02), .O(new_n363_));
  nand3  g199(.a(new_n231_), .b(x03), .c(new_n363_), .O(new_n364_));
  inv1   g200(.a(new_n364_), .O(z57));
  nand4  g201(.a(x80), .b(new_n220_), .c(x43), .d(new_n238_), .O(new_n366_));
  oai22  g202(.a(new_n366_), .b(new_n219_), .c(new_n238_), .d(x40), .O(new_n367_));
  nand3  g203(.a(new_n367_), .b(new_n225_), .c(x79), .O(new_n368_));
  nor2   g204(.a(x79), .b(x78), .O(new_n369_));
  nand3  g205(.a(new_n369_), .b(new_n238_), .c(x40), .O(new_n370_));
  nand2  g206(.a(new_n370_), .b(new_n368_), .O(new_n371_));
  nand2  g207(.a(new_n371_), .b(x77), .O(new_n372_));
  oai21  g208(.a(new_n347_), .b(new_n228_), .c(new_n154_), .O(new_n373_));
  aoi21  g209(.a(new_n373_), .b(new_n372_), .c(x01), .O(z58));
  inv1   g210(.a(new_n369_), .O(new_n375_));
  aoi21  g211(.a(new_n224_), .b(new_n375_), .c(new_n152_), .O(new_n376_));
  oai21  g212(.a(new_n221_), .b(new_n219_), .c(new_n238_), .O(new_n377_));
  aoi21  g213(.a(new_n377_), .b(x79), .c(new_n224_), .O(new_n378_));
  oai21  g214(.a(new_n378_), .b(new_n376_), .c(x77), .O(new_n379_));
  nor2   g215(.a(x79), .b(x04), .O(new_n380_));
  inv1   g216(.a(new_n380_), .O(new_n381_));
  aoi21  g217(.a(new_n381_), .b(new_n379_), .c(x01), .O(z59));
  aoi21  g218(.a(new_n357_), .b(x79), .c(new_n380_), .O(new_n383_));
  aoi21  g219(.a(new_n383_), .b(new_n226_), .c(x01), .O(z60));
  nand2  g220(.a(new_n213_), .b(new_n212_), .O(new_n385_));
  aoi22  g221(.a(new_n385_), .b(new_n215_), .c(new_n161_), .d(new_n228_), .O(new_n386_));
  nor2   g222(.a(new_n154_), .b(x01), .O(new_n387_));
  inv1   g223(.a(new_n387_), .O(new_n388_));
  nor3   g224(.a(new_n388_), .b(new_n386_), .c(new_n352_), .O(z61));
  nand3  g225(.a(x84), .b(x81), .c(x79), .O(new_n390_));
  oai21  g226(.a(x79), .b(new_n228_), .c(new_n390_), .O(new_n391_));
  nand2  g227(.a(new_n391_), .b(new_n159_), .O(new_n392_));
  nand2  g228(.a(new_n377_), .b(x79), .O(new_n393_));
  nand3  g229(.a(x81), .b(x79), .c(new_n228_), .O(new_n394_));
  inv1   g230(.a(new_n394_), .O(new_n395_));
  aoi21  g231(.a(new_n393_), .b(x04), .c(new_n395_), .O(new_n396_));
  oai21  g232(.a(new_n396_), .b(new_n159_), .c(new_n392_), .O(new_n397_));
  nand2  g233(.a(new_n397_), .b(x78), .O(new_n398_));
  inv1   g234(.a(new_n390_), .O(new_n399_));
  nand2  g235(.a(new_n399_), .b(new_n309_), .O(new_n400_));
  aoi21  g236(.a(new_n400_), .b(new_n398_), .c(x01), .O(z62));
  nor3   g237(.a(new_n388_), .b(new_n386_), .c(new_n350_), .O(z63));
  nand2  g238(.a(x83), .b(x79), .O(new_n403_));
  or2    g239(.a(new_n403_), .b(new_n386_), .O(new_n404_));
  aoi21  g240(.a(new_n404_), .b(new_n306_), .c(x01), .O(z64));
  nor2   g241(.a(new_n160_), .b(x04), .O(new_n406_));
  nor2   g242(.a(new_n242_), .b(x78), .O(new_n407_));
  oai21  g243(.a(new_n407_), .b(new_n406_), .c(x77), .O(new_n408_));
  nand2  g244(.a(new_n347_), .b(x81), .O(new_n409_));
  nand2  g245(.a(new_n387_), .b(x84), .O(new_n410_));
