...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n270_, new_n271_, new_n274_, new_n277_, new_n286_, new_n289_,
  ...
  nor3   g117(.a(new_n271_), .b(new_n261_), .c(new_n192_), .O(z40));
  nor3   g118(.a(new_n271_), .b(new_n261_), .c(new_n189_), .O(z41));
  nor3   g119(.a(new_n271_), .b(new_n261_), .c(new_n183_), .O(z43));
  nor3   g120(.a(new_n271_), .b(new_n261_), .c(new_n180_), .O(z44));
  nand2  g121(.a(new_n234_), .b(x64), .O(new_n286_));
  nor2   g122(.a(new_n286_), .b(new_n271_), .O(z46));
  inv1   g123(.a(x08), .O(new_n289_));
  nand2  g124(.a(x52), .b(x16), .O(new_n290_));
  oai21  g125(.a(x52), .b(new_n289_), .c(new_n290_), .O(new_n291_));
  nand3  g126(.a(new_n226_), .b(new_n154_), .c(new_n159_), .O(new_n292_));
  ...
  and2   g132(.a(new_n297_), .b(new_n216_), .O(new_n298_));
  nand2  g133(.a(new_n298_), .b(x68), .O(new_n299_));
  aoi21  g134(.a(new_n299_), .b(new_n294_), .c(x01), .O(z48));
  inv1   g135(.a(x09), .O(new_n301_));
  nand2  g136(.a(x52), .b(x17), .O(new_n302_));
  oai21  g137(.a(x52), .b(new_n301_), .c(new_n302_), .O(new_n303_));
  nand2  g138(.a(new_n303_), .b(new_n293_), .O(new_n304_));
  nand2  g139(.a(new_n298_), .b(x69), .O(new_n305_));
  aoi21  g140(.a(new_n305_), .b(new_n304_), .c(x01), .O(z49));
  inv1   g141(.a(x11), .O(new_n308_));
  nand2  g142(.a(x52), .b(x19), .O(new_n309_));
  oai21  g143(.a(x52), .b(new_n308_), .c(new_n309_), .O(new_n310_));
  nand2  g144(.a(new_n310_), .b(new_n293_), .O(new_n311_));
  nand2  g145(.a(new_n298_), .b(x71), .O(new_n312_));
  aoi21  g146(.a(new_n312_), .b(new_n311_), .c(x01), .O(z51));
  inv1   g147(.a(x13), .O(new_n315_));
  nand2  g148(.a(x52), .b(x21), .O(new_n316_));
  oai21  g149(.a(x52), .b(new_n315_), .c(new_n316_), .O(new_n317_));
  nand2  g150(.a(new_n317_), .b(new_n293_), .O(new_n318_));
  nand2  g151(.a(new_n298_), .b(x73), .O(new_n319_));
  aoi21  g152(.a(new_n319_), .b(new_n318_), .c(x01), .O(z53));
  nand2  g153(.a(x52), .b(x22), .O(new_n321_));
  nand2  g154(.a(new_n260_), .b(x14), .O(new_n322_));
  inv1   g155(.a(new_n167_), .O(new_n323_));
  nand4  g156(.a(new_n323_), .b(new_n154_), .c(x04), .d(new_n153_), .O(new_n324_));
  aoi21  g157(.a(new_n322_), .b(new_n321_), .c(new_n324_), .O(z54));
  nand2  g158(.a(new_n160_), .b(new_n159_), .O(new_n327_));
  nand2  g159(.a(new_n232_), .b(x76), .O(new_n328_));
  xnor2a g160(.a(x84), .b(x81), .O(new_n329_));
  aoi21  g161(.a(new_n168_), .b(new_n167_), .c(new_n329_), .O(new_n330_));
  nand2  g162(.a(new_n330_), .b(new_n153_), .O(new_n331_));
  nand2  g163(.a(new_n331_), .b(new_n328_), .O(new_n332_));
  nand2  g164(.a(new_n332_), .b(x79), .O(new_n333_));
  nand4  g165(.a(new_n333_), .b(new_n327_), .c(new_n153_), .d(x00), .O(z56));
  nand4  g166(.a(x80), .b(new_n221_), .c(x43), .d(new_n237_), .O(new_n336_));
  oai22  g167(.a(new_n336_), .b(new_n220_), .c(new_n237_), .d(x40), .O(new_n337_));
  nand3  g168(.a(new_n337_), .b(new_n226_), .c(x79), .O(new_n338_));
  ...
  oai21  g173(.a(new_n323_), .b(new_n229_), .c(new_n154_), .O(new_n343_));
  aoi21  g174(.a(new_n343_), .b(new_n342_), .c(x01), .O(z58));
  inv1   g175(.a(new_n339_), .O(new_n345_));
  aoi21  g176(.a(new_n225_), .b(new_n345_), .c(new_n152_), .O(new_n346_));
  oai21  g177(.a(new_n222_), .b(new_n220_), .c(new_n237_), .O(new_n347_));
  aoi21  g178(.a(new_n347_), .b(x79), .c(new_n225_), .O(new_n348_));
  oai21  g179(.a(new_n348_), .b(new_n346_), .c(x77), .O(new_n349_));
  nor2   g180(.a(x79), .b(x04), .O(new_n350_));
  inv1   g181(.a(new_n350_), .O(new_n351_));
  aoi21  g182(.a(new_n351_), .b(new_n349_), .c(x01), .O(z59));
  aoi21  g183(.a(new_n330_), .b(x79), .c(new_n350_), .O(new_n353_));
  aoi21  g184(.a(new_n353_), .b(new_n227_), .c(x01), .O(z60));
  nand2  g185(.a(new_n168_), .b(new_n167_), .O(new_n355_));
  aoi22  g186(.a(new_n355_), .b(new_n216_), .c(new_n161_), .d(new_n229_), .O(new_n356_));
  nand2  g187(.a(new_n170_), .b(x80), .O(new_n357_));
  nor2   g188(.a(new_n357_), .b(new_n356_), .O(z61));
  nand3  g189(.a(x84), .b(x81), .c(x79), .O(new_n359_));
  oai21  g190(.a(x79), .b(new_n229_), .c(new_n359_), .O(new_n360_));
  nand2  g191(.a(new_n360_), .b(new_n159_), .O(new_n361_));
  nand2  g192(.a(new_n347_), .b(x79), .O(new_n362_));
  nand3  g193(.a(x81), .b(x79), .c(new_n229_), .O(new_n363_));
  inv1   g194(.a(new_n363_), .O(new_n364_));
  aoi21  g195(.a(new_n362_), .b(x04), .c(new_n364_), .O(new_n365_));
  oai21  g196(.a(new_n365_), .b(new_n159_), .c(new_n361_), .O(new_n366_));
  nand2  g197(.a(new_n366_), .b(x78), .O(new_n367_));
  inv1   g198(.a(new_n359_), .O(new_n368_));
  nand2  g199(.a(new_n368_), .b(new_n295_), .O(new_n369_));
  aoi21  g200(.a(new_n369_), .b(new_n367_), .c(x01), .O(z62));
  nand2  g201(.a(new_n170_), .b(x82), .O(new_n371_));
  nor2   g202(.a(new_n371_), .b(new_n356_), .O(z63));
  nand2  g203(.a(x83), .b(x79), .O(new_n373_));
  or2    g204(.a(new_n373_), .b(new_n356_), .O(new_n374_));
  ...
  nand2  g209(.a(new_n323_), .b(x81), .O(new_n379_));
