...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n286_, new_n289_, new_n296_, new_n299_, new_n300_, new_n301_,
  ...
  inv1   g080(.a(x42), .O(new_n241_));
  xor2a  g081(.a(x84), .b(x82), .O(new_n242_));
  inv1   g082(.a(new_n242_), .O(new_n243_));
  nand2  g083(.a(new_n243_), .b(x81), .O(new_n244_));
  inv1   g084(.a(x81), .O(new_n245_));
  xor2a  g085(.a(x84), .b(x82), .O(new_n246_));
  nand2  g086(.a(new_n246_), .b(new_n245_), .O(new_n247_));
  aoi21  g087(.a(new_n247_), .b(new_n244_), .c(new_n162_), .O(new_n248_));
  nand4  g088(.a(new_n248_), .b(new_n234_), .c(x47), .d(new_n241_), .O(new_n249_));
  inv1   g089(.a(new_n249_), .O(z29));
  nand4  g090(.a(new_n248_), .b(new_n234_), .c(x48), .d(new_n241_), .O(new_n251_));
  inv1   g091(.a(new_n251_), .O(z30));
  nand4  g092(.a(new_n248_), .b(new_n234_), .c(x50), .d(new_n241_), .O(new_n254_));
  inv1   g093(.a(new_n254_), .O(z32));
  nor2   g094(.a(new_n219_), .b(x81), .O(new_n256_));
  nor2   g095(.a(x83), .b(new_n245_), .O(new_n257_));
  nor2   g096(.a(new_n257_), .b(new_n256_), .O(new_n258_));
  nand2  g097(.a(x42), .b(x05), .O(new_n259_));
  nand2  g098(.a(x51), .b(new_n241_), .O(new_n260_));
  oai22  g099(.a(new_n260_), .b(new_n245_), .c(new_n259_), .d(new_n258_), .O(new_n261_));
  nand2  g100(.a(new_n261_), .b(new_n243_), .O(new_n262_));
  xor2a  g101(.a(x83), .b(x81), .O(new_n263_));
  oai22  g102(.a(new_n263_), .b(new_n259_), .c(new_n260_), .d(x81), .O(new_n264_));
  nand2  g103(.a(new_n264_), .b(new_n246_), .O(new_n265_));
  inv1   g104(.a(new_n162_), .O(new_n266_));
  nand2  g105(.a(new_n234_), .b(new_n266_), .O(new_n267_));
  aoi21  g106(.a(new_n265_), .b(new_n262_), .c(new_n267_), .O(z33));
  nand2  g107(.a(x83), .b(x42), .O(new_n269_));
  nand2  g108(.a(new_n269_), .b(new_n245_), .O(new_n270_));
  nand3  g109(.a(x83), .b(x81), .c(x42), .O(new_n271_));
  nand2  g110(.a(new_n271_), .b(new_n270_), .O(new_n272_));
  and2   g111(.a(new_n272_), .b(new_n246_), .O(new_n273_));
  nand2  g112(.a(new_n269_), .b(x81), .O(new_n274_));
  nand2  g113(.a(new_n256_), .b(x42), .O(new_n275_));
  aoi21  g114(.a(new_n275_), .b(new_n274_), .c(new_n242_), .O(new_n276_));
  oai21  g115(.a(new_n276_), .b(new_n273_), .c(new_n266_), .O(new_n277_));
  nand2  g116(.a(new_n234_), .b(x52), .O(new_n278_));
  nor2   g117(.a(new_n278_), .b(new_n277_), .O(z34));
  nand2  g118(.a(new_n234_), .b(x53), .O(new_n280_));
  nor2   g119(.a(new_n280_), .b(new_n277_), .O(z35));
  nand2  g120(.a(new_n234_), .b(x54), .O(new_n282_));
  nor2   g121(.a(new_n282_), .b(new_n277_), .O(z36));
  nand2  g122(.a(new_n234_), .b(x55), .O(new_n284_));
  nor2   g123(.a(new_n284_), .b(new_n277_), .O(z37));
  nand2  g124(.a(new_n234_), .b(x56), .O(new_n286_));
  nor2   g125(.a(new_n286_), .b(new_n277_), .O(z38));
  inv1   g126(.a(new_n234_), .O(new_n289_));
  nor3   g127(.a(new_n277_), .b(new_n289_), .c(new_n194_), .O(z40));
  nor3   g128(.a(new_n277_), .b(new_n289_), .c(new_n191_), .O(z41));
  nor3   g129(.a(new_n277_), .b(new_n289_), .c(new_n188_), .O(z42));
  nor3   g130(.a(new_n277_), .b(new_n289_), .c(new_n182_), .O(z44));
  nand2  g131(.a(new_n234_), .b(x64), .O(new_n296_));
  nor2   g132(.a(new_n296_), .b(new_n277_), .O(z46));
  inv1   g133(.a(x08), .O(new_n299_));
  nand2  g134(.a(x52), .b(x16), .O(new_n300_));
  oai21  g135(.a(x52), .b(new_n299_), .c(new_n300_), .O(new_n301_));
  nand3  g136(.a(new_n226_), .b(new_n154_), .c(new_n159_), .O(new_n302_));
  ...
  and2   g142(.a(new_n307_), .b(new_n216_), .O(new_n308_));
  ...
  nand3  g158(.a(new_n256_), .b(x84), .c(new_n327_), .O(new_n328_));
  inv1   g159(.a(x80), .O(new_n329_));
  nand4  g160(.a(new_n234_), .b(new_n161_), .c(new_n329_), .d(x79), .O(new_n330_));
  nor2   g161(.a(new_n330_), .b(new_n328_), .O(z55));
  nand2  g162(.a(new_n160_), .b(new_n159_), .O(new_n332_));
  nand2  g163(.a(new_n232_), .b(x76), .O(new_n333_));
  xnor2a g164(.a(x84), .b(x81), .O(new_n334_));
  aoi21  g165(.a(new_n168_), .b(new_n167_), .c(new_n334_), .O(new_n335_));
  nand2  g166(.a(new_n335_), .b(new_n153_), .O(new_n336_));
  nand2  g167(.a(new_n336_), .b(new_n333_), .O(new_n337_));
  nand2  g168(.a(new_n337_), .b(x79), .O(new_n338_));
  nand4  g169(.a(new_n338_), .b(new_n332_), .c(new_n153_), .d(x00), .O(z56));
  nand4  g170(.a(x80), .b(new_n221_), .c(x43), .d(new_n241_), .O(new_n341_));
  oai22  g171(.a(new_n341_), .b(new_n220_), .c(new_n241_), .d(x40), .O(new_n342_));
  nand3  g172(.a(new_n342_), .b(new_n226_), .c(x79), .O(new_n343_));
  nor2   g173(.a(x79), .b(x78), .O(new_n344_));
  nand3  g174(.a(new_n344_), .b(new_n241_), .c(x40), .O(new_n345_));
  nand2  g175(.a(new_n345_), .b(new_n343_), .O(new_n346_));
  nand2  g176(.a(new_n346_), .b(x77), .O(new_n347_));
  inv1   g177(.a(new_n167_), .O(new_n348_));
  oai21  g178(.a(new_n348_), .b(new_n229_), .c(new_n154_), .O(new_n349_));
  aoi21  g179(.a(new_n349_), .b(new_n347_), .c(x01), .O(z58));
  inv1   g180(.a(new_n344_), .O(new_n351_));
  aoi21  g181(.a(new_n225_), .b(new_n351_), .c(new_n152_), .O(new_n352_));
  oai21  g182(.a(new_n222_), .b(new_n220_), .c(new_n241_), .O(new_n353_));
  aoi21  g183(.a(new_n353_), .b(x79), .c(new_n225_), .O(new_n354_));
  ...
  aoi21  g188(.a(new_n335_), .b(x79), .c(new_n356_), .O(new_n359_));
  aoi21  g189(.a(new_n359_), .b(new_n227_), .c(x01), .O(z60));
  inv1   g190(.a(new_n170_), .O(new_n361_));
  nand2  g191(.a(new_n168_), .b(new_n167_), .O(new_n362_));
  aoi22  g192(.a(new_n362_), .b(new_n216_), .c(new_n161_), .d(new_n229_), .O(new_n363_));
  nor3   g193(.a(new_n363_), .b(new_n361_), .c(new_n329_), .O(z61));
  nand3  g194(.a(x84), .b(x81), .c(x79), .O(new_n365_));
  oai21  g195(.a(x79), .b(new_n229_), .c(new_n365_), .O(new_n366_));
  nand2  g196(.a(new_n366_), .b(new_n159_), .O(new_n367_));
  nand2  g197(.a(new_n353_), .b(x79), .O(new_n368_));
  nand3  g198(.a(x81), .b(x79), .c(new_n229_), .O(new_n369_));
  ...
  nand2  g204(.a(new_n374_), .b(new_n305_), .O(new_n375_));
  aoi21  g205(.a(new_n375_), .b(new_n373_), .c(x01), .O(z62));
  nor3   g206(.a(new_n363_), .b(new_n361_), .c(new_n327_), .O(z63));
  nand2  g207(.a(x83), .b(x79), .O(new_n378_));
  or2    g208(.a(new_n378_), .b(new_n363_), .O(new_n379_));
  aoi21  g209(.a(new_n379_), .b(new_n302_), .c(x01), .O(z64));
  nor2   g210(.a(new_n160_), .b(x04), .O(new_n381_));
  nor2   g211(.a(new_n245_), .b(x78), .O(new_n382_));
  oai21  g212(.a(new_n382_), .b(new_n381_), .c(x77), .O(new_n383_));
  nand2  g213(.a(new_n348_), .b(x81), .O(new_n384_));
  nand2  g214(.a(new_n170_), .b(x84), .O(new_n385_));
