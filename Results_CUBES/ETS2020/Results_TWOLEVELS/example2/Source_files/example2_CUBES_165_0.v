// Benchmark "FAU" written by ABC on Fri Jul 10 18:21:21 2020
...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n284_, new_n286_, new_n290_, new_n293_, new_n300_, new_n301_,
    new_n302_, new_n303_, new_n304_, new_n305_, new_n306_, new_n307_,
    new_n308_, new_n309_, new_n310_, new_n312_, new_n313_, new_n314_,
    new_n315_, new_n316_, new_n318_, new_n319_, new_n320_, new_n321_,
    new_n322_, new_n327_, new_n328_, new_n329_, new_n330_, new_n332_,
  ...
  nand2  g122(.a(new_n233_), .b(x54), .O(new_n284_));
  nor2   g123(.a(new_n284_), .b(new_n281_), .O(z36));
  nand2  g124(.a(new_n233_), .b(x55), .O(new_n286_));
  nor2   g125(.a(new_n286_), .b(new_n281_), .O(z37));
  nand2  g126(.a(new_n233_), .b(x58), .O(new_n290_));
  nor2   g127(.a(new_n290_), .b(new_n281_), .O(z40));
  nor3   g128(.a(new_n281_), .b(new_n272_), .c(new_n183_), .O(z41));
  nand2  g129(.a(new_n233_), .b(x60), .O(new_n293_));
  nor2   g130(.a(new_n293_), .b(new_n281_), .O(z42));
  ...
  nand2  g148(.a(new_n314_), .b(new_n304_), .O(new_n315_));
  nand2  g149(.a(new_n309_), .b(x69), .O(new_n316_));
  ...
  nand2  g154(.a(new_n320_), .b(new_n304_), .O(new_n321_));
  nand2  g155(.a(new_n309_), .b(x70), .O(new_n322_));
  aoi21  g156(.a(new_n322_), .b(new_n321_), .c(x01), .O(z50));
  nand2  g157(.a(x52), .b(x22), .O(new_n327_));
  nand2  g158(.a(new_n271_), .b(x14), .O(new_n328_));
  inv1   g159(.a(new_n210_), .O(new_n329_));
  ...
  nand3  g163(.a(new_n258_), .b(x84), .c(new_n332_), .O(new_n333_));
  ...
  nand2  g167(.a(new_n231_), .b(x76), .O(new_n337_));
  xnor2a g168(.a(x84), .b(x81), .O(new_n338_));
  aoi21  g169(.a(new_n211_), .b(new_n210_), .c(new_n338_), .O(new_n339_));
  ...
  nand3  g174(.a(new_n343_), .b(new_n342_), .c(new_n229_), .O(z56));
  inv1   g175(.a(x02), .O(new_n345_));
  nand3  g176(.a(new_n229_), .b(x03), .c(new_n345_), .O(new_n346_));
  inv1   g177(.a(new_n346_), .O(z57));
  nand4  g178(.a(x80), .b(new_n218_), .c(x43), .d(new_n236_), .O(new_n348_));
  oai22  g179(.a(new_n348_), .b(new_n217_), .c(new_n236_), .d(x40), .O(new_n349_));
  nand3  g180(.a(new_n349_), .b(new_n223_), .c(x79), .O(new_n350_));
  ...
  oai21  g185(.a(new_n329_), .b(new_n226_), .c(new_n154_), .O(new_n355_));
  aoi21  g186(.a(new_n355_), .b(new_n354_), .c(x01), .O(z58));
  inv1   g187(.a(new_n351_), .O(new_n357_));
  aoi21  g188(.a(new_n222_), .b(new_n357_), .c(new_n152_), .O(new_n358_));
  oai21  g189(.a(new_n219_), .b(new_n217_), .c(new_n236_), .O(new_n359_));
  aoi21  g190(.a(new_n359_), .b(x79), .c(new_n222_), .O(new_n360_));
  oai21  g191(.a(new_n360_), .b(new_n358_), .c(x77), .O(new_n361_));
  nor2   g192(.a(x79), .b(x04), .O(new_n362_));
  inv1   g193(.a(new_n362_), .O(new_n363_));
  aoi21  g194(.a(new_n363_), .b(new_n361_), .c(x01), .O(z59));
  aoi21  g195(.a(new_n339_), .b(x79), .c(new_n362_), .O(new_n365_));
  aoi21  g196(.a(new_n365_), .b(new_n224_), .c(x01), .O(z60));
  nand2  g197(.a(new_n211_), .b(new_n210_), .O(new_n367_));
  aoi22  g198(.a(new_n367_), .b(new_n213_), .c(new_n161_), .d(new_n226_), .O(new_n368_));
  nor2   g199(.a(new_n154_), .b(x01), .O(new_n369_));
  ...
  oai21  g203(.a(x79), .b(new_n226_), .c(new_n372_), .O(new_n373_));
  nand2  g204(.a(new_n373_), .b(new_n159_), .O(new_n374_));
  nand2  g205(.a(new_n359_), .b(x79), .O(new_n375_));
  nand3  g206(.a(x81), .b(x79), .c(new_n226_), .O(new_n376_));
  ...
  or2    g216(.a(new_n385_), .b(new_n368_), .O(new_n386_));
  ...
  nand2  g221(.a(new_n329_), .b(x81), .O(new_n391_));
  nand2  g222(.a(new_n369_), .b(x84), .O(new_n392_));
