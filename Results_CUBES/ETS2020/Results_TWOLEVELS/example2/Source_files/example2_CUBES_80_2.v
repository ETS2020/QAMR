...
module FAU ( 
  ...
  wire new_n154_, new_n155_, new_n156_, new_n157_, new_n158_, new_n159_,
    ...
    new_n172_, new_n173_, new_n176_, new_n177_, new_n181_, new_n182_,
  ...
  nand3  g071(.a(new_n218_), .b(x48), .c(new_n217_), .O(new_n235_));
  inv1   g072(.a(new_n235_), .O(new_n236_));
  nand3  g073(.a(new_n236_), .b(new_n216_), .c(new_n214_), .O(new_n237_));
  inv1   g074(.a(new_n237_), .O(z30));
  nand3  g075(.a(new_n218_), .b(x49), .c(new_n217_), .O(new_n239_));
  inv1   g076(.a(new_n239_), .O(new_n240_));
  nand3  g077(.a(new_n240_), .b(new_n216_), .c(new_n214_), .O(new_n241_));
  inv1   g078(.a(new_n241_), .O(z31));
  nand3  g079(.a(new_n218_), .b(x50), .c(new_n217_), .O(new_n243_));
  inv1   g080(.a(new_n243_), .O(new_n244_));
  nand3  g081(.a(new_n244_), .b(new_n216_), .c(new_n214_), .O(new_n245_));
  inv1   g082(.a(new_n245_), .O(z32));
  inv1   g083(.a(new_n211_), .O(new_n247_));
  xnor2a g084(.a(x83), .b(x81), .O(new_n248_));
  nand2  g085(.a(x42), .b(x05), .O(new_n249_));
  nand2  g086(.a(x51), .b(new_n217_), .O(new_n250_));
  oai22  g087(.a(new_n250_), .b(new_n210_), .c(new_n249_), .d(new_n248_), .O(new_n251_));
  ...
  nand2  g091(.a(new_n254_), .b(new_n212_), .O(new_n255_));
  nand2  g092(.a(new_n218_), .b(new_n216_), .O(new_n256_));
  ...
  nand2  g096(.a(new_n260_), .b(new_n210_), .O(new_n261_));
  ...
  nand3  g100(.a(x83), .b(new_n210_), .c(x42), .O(new_n265_));
  aoi21  g101(.a(new_n265_), .b(new_n264_), .c(new_n211_), .O(new_n266_));
  oai21  g102(.a(new_n266_), .b(new_n263_), .c(new_n216_), .O(new_n267_));
  nand2  g103(.a(new_n218_), .b(x53), .O(new_n268_));
  nor2   g104(.a(new_n268_), .b(new_n267_), .O(z35));
  nand2  g105(.a(new_n218_), .b(x54), .O(new_n270_));
  nor2   g106(.a(new_n270_), .b(new_n267_), .O(z36));
  nand2  g107(.a(new_n218_), .b(x56), .O(new_n273_));
  nor2   g108(.a(new_n273_), .b(new_n267_), .O(z38));
  nand2  g109(.a(new_n218_), .b(x57), .O(new_n275_));
  nor2   g110(.a(new_n275_), .b(new_n267_), .O(z39));
  nand2  g111(.a(new_n218_), .b(x58), .O(new_n277_));
  nor2   g112(.a(new_n277_), .b(new_n267_), .O(z40));
  nand2  g113(.a(new_n218_), .b(x59), .O(new_n279_));
  nor2   g114(.a(new_n279_), .b(new_n267_), .O(z41));
  nand2  g115(.a(new_n218_), .b(x60), .O(new_n281_));
  nor2   g116(.a(new_n281_), .b(new_n267_), .O(z42));
  nand2  g117(.a(new_n218_), .b(x61), .O(new_n283_));
  nor2   g118(.a(new_n283_), .b(new_n267_), .O(z43));
  nand2  g119(.a(new_n218_), .b(x62), .O(new_n285_));
  nor2   g120(.a(new_n285_), .b(new_n267_), .O(z44));
  nand2  g121(.a(new_n218_), .b(x63), .O(new_n287_));
  nor2   g122(.a(new_n287_), .b(new_n267_), .O(z45));
  nand2  g123(.a(new_n218_), .b(x64), .O(new_n289_));
  nor2   g124(.a(new_n289_), .b(new_n267_), .O(z46));
  inv1   g125(.a(x07), .O(new_n291_));
  nand2  g126(.a(x52), .b(x15), .O(new_n292_));
  oai21  g127(.a(x52), .b(new_n291_), .c(new_n292_), .O(new_n293_));
  inv1   g128(.a(x79), .O(new_n294_));
  nand4  g129(.a(new_n294_), .b(x78), .c(new_n154_), .d(x04), .O(new_n295_));
  inv1   g130(.a(new_n295_), .O(new_n296_));
  nand2  g131(.a(new_n296_), .b(new_n293_), .O(new_n297_));
  xor2a  g132(.a(x84), .b(x81), .O(new_n298_));
  inv1   g133(.a(new_n298_), .O(new_n299_));
  nor2   g134(.a(x75), .b(x67), .O(new_n300_));
  nand3  g135(.a(x79), .b(new_n156_), .c(x77), .O(new_n301_));
  nor2   g136(.a(new_n301_), .b(new_n300_), .O(new_n302_));
  nand2  g137(.a(new_n302_), .b(new_n299_), .O(new_n303_));
  aoi21  g138(.a(new_n303_), .b(new_n297_), .c(x01), .O(z47));
  inv1   g139(.a(x10), .O(new_n307_));
  nand2  g140(.a(x52), .b(x18), .O(new_n308_));
  oai21  g141(.a(x52), .b(new_n307_), .c(new_n308_), .O(new_n309_));
  nand2  g142(.a(new_n309_), .b(new_n296_), .O(new_n310_));
  nor2   g143(.a(new_n301_), .b(new_n298_), .O(new_n311_));
  nand2  g144(.a(new_n311_), .b(x70), .O(new_n312_));
  aoi21  g145(.a(new_n312_), .b(new_n310_), .c(x01), .O(z50));
  inv1   g146(.a(x11), .O(new_n314_));
  nand2  g147(.a(x52), .b(x19), .O(new_n315_));
  oai21  g148(.a(x52), .b(new_n314_), .c(new_n315_), .O(new_n316_));
  nand2  g149(.a(new_n316_), .b(new_n296_), .O(new_n317_));
  nand2  g150(.a(new_n311_), .b(x71), .O(new_n318_));
  ...
  nand2  g155(.a(new_n322_), .b(new_n296_), .O(new_n323_));
  nand2  g156(.a(new_n311_), .b(x72), .O(new_n324_));
  ...
  nand2  g161(.a(new_n328_), .b(new_n296_), .O(new_n329_));
  nand2  g162(.a(new_n311_), .b(x73), .O(new_n330_));
  aoi21  g163(.a(new_n330_), .b(new_n329_), .c(x01), .O(z53));
  inv1   g164(.a(x82), .O(new_n333_));
  nand2  g165(.a(x84), .b(new_n333_), .O(new_n334_));
  nand2  g166(.a(x83), .b(new_n210_), .O(new_n335_));
  nor2   g167(.a(x80), .b(new_n294_), .O(new_n336_));
  nand4  g168(.a(new_n336_), .b(new_n218_), .c(x78), .d(x77), .O(new_n337_));
  nor3   g169(.a(new_n337_), .b(new_n335_), .c(new_n334_), .O(z55));
  inv1   g170(.a(x02), .O(new_n340_));
  nand4  g171(.a(x03), .b(new_n340_), .c(new_n158_), .d(x00), .O(new_n341_));
