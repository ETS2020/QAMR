...
module FAU ( 
  ...
  nor3   g147(.a(new_n294_), .b(new_n285_), .c(new_n201_), .O(z39));
  ...
  nand3  g196(.a(new_n271_), .b(x84), .c(new_n356_), .O(new_n357_));
  ...
  oai21  g231(.a(x79), .b(new_n160_), .c(new_n392_), .O(new_n393_));
  nand2  g232(.a(new_n393_), .b(new_n159_), .O(new_n394_));
  nand2  g233(.a(new_n383_), .b(x79), .O(new_n395_));
  nand3  g234(.a(x81), .b(x79), .c(new_n160_), .O(new_n396_));
  ...
  nand2  g240(.a(new_n401_), .b(new_n171_), .O(new_n402_));
  aoi21  g241(.a(new_n402_), .b(new_n400_), .c(x01), .O(z62));
  oai21  g242(.a(new_n171_), .b(new_n169_), .c(new_n226_), .O(new_n404_));
  oai21  g243(.a(new_n242_), .b(x04), .c(new_n404_), .O(new_n405_));
  nand2  g244(.a(new_n174_), .b(x82), .O(new_n406_));
  inv1   g245(.a(new_n406_), .O(new_n407_));
  and2   g246(.a(new_n407_), .b(new_n405_), .O(z63));
  nand3  g247(.a(new_n405_), .b(x83), .c(x79), .O(new_n409_));
