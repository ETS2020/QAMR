...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n284_, new_n286_, new_n288_, new_n290_, new_n299_, new_n300_,
  ...
  nand2  g129(.a(new_n233_), .b(x56), .O(new_n288_));
  nor2   g130(.a(new_n288_), .b(new_n280_), .O(z38));
  nand2  g131(.a(new_n233_), .b(x57), .O(new_n290_));
  nor2   g132(.a(new_n290_), .b(new_n280_), .O(z39));
  nor3   g133(.a(new_n280_), .b(new_n271_), .c(new_n190_), .O(z40));
  nor3   g134(.a(new_n280_), .b(new_n271_), .c(new_n187_), .O(z41));
  nor3   g135(.a(new_n280_), .b(new_n271_), .c(new_n172_), .O(z46));
  inv1   g136(.a(x07), .O(new_n299_));
  nand2  g137(.a(x52), .b(x15), .O(new_n300_));
  oai21  g138(.a(x52), .b(new_n299_), .c(new_n300_), .O(new_n301_));
  nand3  g139(.a(new_n225_), .b(new_n154_), .c(new_n159_), .O(new_n302_));
  inv1   g140(.a(new_n302_), .O(new_n303_));
  nand2  g141(.a(new_n303_), .b(new_n301_), .O(new_n304_));
  nor2   g142(.a(x75), .b(x67), .O(new_n305_));
  inv1   g143(.a(new_n213_), .O(new_n306_));
  ...
  inv1   g152(.a(new_n215_), .O(new_n315_));
  ...
  nand2  g165(.a(new_n329_), .b(new_n303_), .O(new_n330_));
  nand2  g166(.a(new_n316_), .b(x72), .O(new_n331_));
  aoi21  g167(.a(new_n331_), .b(new_n330_), .c(x01), .O(z52));
  nand2  g168(.a(x52), .b(x22), .O(new_n334_));
  nand2  g169(.a(new_n270_), .b(x14), .O(new_n335_));
  inv1   g170(.a(new_n212_), .O(new_n336_));
  ...
  nand2  g174(.a(new_n231_), .b(x76), .O(new_n341_));
  xnor2a g175(.a(x84), .b(x81), .O(new_n342_));
  aoi21  g176(.a(new_n213_), .b(new_n212_), .c(new_n342_), .O(new_n343_));
  ...
  oai21  g188(.a(new_n336_), .b(new_n228_), .c(new_n154_), .O(new_n356_));
  ...
  nand2  g200(.a(new_n213_), .b(new_n212_), .O(new_n368_));
  aoi22  g201(.a(new_n368_), .b(new_n215_), .c(new_n161_), .d(new_n228_), .O(new_n369_));
  ...
  oai21  g206(.a(x79), .b(new_n228_), .c(new_n373_), .O(new_n374_));
  nand2  g207(.a(new_n374_), .b(new_n159_), .O(new_n375_));
  nand2  g208(.a(new_n360_), .b(x79), .O(new_n376_));
  nand3  g209(.a(x81), .b(x79), .c(new_n228_), .O(new_n377_));
