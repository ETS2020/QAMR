// Benchmark "FAU" written by ABC on Fri Jul 10 18:19:41 2020
...
module FAU ( 
  ...
  wire new_n154_, new_n155_, new_n156_, new_n157_, new_n158_, new_n159_,
    ...
    new_n225_, new_n226_, new_n227_, new_n231_, new_n232_, new_n233_,
    new_n235_, new_n236_, new_n237_, new_n239_, new_n240_, new_n241_,
    new_n243_, new_n244_, new_n245_, new_n249_, new_n250_, new_n251_,
  ...
  nand3  g067(.a(new_n214_), .b(x46), .c(new_n224_), .O(new_n231_));
  inv1   g068(.a(new_n231_), .O(new_n232_));
  nand3  g069(.a(new_n232_), .b(new_n223_), .c(new_n221_), .O(new_n233_));
  inv1   g070(.a(new_n233_), .O(z28));
  nand3  g071(.a(new_n214_), .b(x47), .c(new_n224_), .O(new_n235_));
  inv1   g072(.a(new_n235_), .O(new_n236_));
  nand3  g073(.a(new_n236_), .b(new_n223_), .c(new_n221_), .O(new_n237_));
  ...
  xnor2a g083(.a(x84), .b(x82), .O(new_n249_));
  nand2  g084(.a(x83), .b(x42), .O(new_n250_));
  nand2  g085(.a(new_n250_), .b(new_n217_), .O(new_n251_));
  nand3  g086(.a(x83), .b(x81), .c(x42), .O(new_n252_));
  aoi21  g087(.a(new_n252_), .b(new_n251_), .c(new_n249_), .O(new_n253_));
  nand2  g088(.a(new_n250_), .b(x81), .O(new_n254_));
  nand3  g089(.a(x83), .b(new_n217_), .c(x42), .O(new_n255_));
  aoi21  g090(.a(new_n255_), .b(new_n254_), .c(new_n218_), .O(new_n256_));
  oai21  g091(.a(new_n256_), .b(new_n253_), .c(new_n223_), .O(new_n257_));
  nand2  g092(.a(new_n214_), .b(x52), .O(new_n258_));
  nor2   g093(.a(new_n258_), .b(new_n257_), .O(z34));
  nand2  g094(.a(new_n214_), .b(x53), .O(new_n260_));
  nor2   g095(.a(new_n260_), .b(new_n257_), .O(z35));
  nand2  g096(.a(new_n214_), .b(x55), .O(new_n263_));
  nor2   g097(.a(new_n263_), .b(new_n257_), .O(z37));
  nand2  g098(.a(new_n214_), .b(x56), .O(new_n265_));
  nor2   g099(.a(new_n265_), .b(new_n257_), .O(z38));
  nand2  g100(.a(new_n214_), .b(x57), .O(new_n267_));
  nor2   g101(.a(new_n267_), .b(new_n257_), .O(z39));
  nand2  g102(.a(new_n214_), .b(x59), .O(new_n270_));
  nor2   g103(.a(new_n270_), .b(new_n257_), .O(z41));
  nand2  g104(.a(new_n214_), .b(x60), .O(new_n272_));
  nor2   g105(.a(new_n272_), .b(new_n257_), .O(z42));
  nand2  g106(.a(new_n214_), .b(x61), .O(new_n274_));
  nor2   g107(.a(new_n274_), .b(new_n257_), .O(z43));
  nand2  g108(.a(new_n214_), .b(x62), .O(new_n276_));
  nor2   g109(.a(new_n276_), .b(new_n257_), .O(z44));
  nand2  g110(.a(new_n214_), .b(x63), .O(new_n278_));
  nor2   g111(.a(new_n278_), .b(new_n257_), .O(z45));
  ...
  nor2   g117(.a(x79), .b(new_n154_), .O(new_n286_));
  nand3  g118(.a(new_n286_), .b(new_n285_), .c(new_n283_), .O(new_n287_));
  ...
  nand3  g126(.a(new_n295_), .b(new_n286_), .c(new_n285_), .O(new_n296_));
  nand4  g127(.a(new_n288_), .b(new_n158_), .c(x79), .d(x69), .O(new_n297_));
  aoi21  g128(.a(new_n297_), .b(new_n296_), .c(x01), .O(z49));
  inv1   g129(.a(x10), .O(new_n299_));
  nand2  g130(.a(x52), .b(x18), .O(new_n300_));
  oai21  g131(.a(x52), .b(new_n299_), .c(new_n300_), .O(new_n301_));
  nand3  g132(.a(new_n301_), .b(new_n286_), .c(new_n285_), .O(new_n302_));
  nand4  g133(.a(new_n288_), .b(new_n158_), .c(x79), .d(x70), .O(new_n303_));
  aoi21  g134(.a(new_n303_), .b(new_n302_), .c(x01), .O(z50));
  inv1   g135(.a(x11), .O(new_n305_));
  nand2  g136(.a(x52), .b(x19), .O(new_n306_));
  oai21  g137(.a(x52), .b(new_n305_), .c(new_n306_), .O(new_n307_));
  nand3  g138(.a(new_n307_), .b(new_n286_), .c(new_n285_), .O(new_n308_));
  nand4  g139(.a(new_n288_), .b(new_n158_), .c(x79), .d(x71), .O(new_n309_));
  aoi21  g140(.a(new_n309_), .b(new_n308_), .c(x01), .O(z51));
  inv1   g141(.a(x12), .O(new_n311_));
  nand2  g142(.a(x52), .b(x20), .O(new_n312_));
  oai21  g143(.a(x52), .b(new_n311_), .c(new_n312_), .O(new_n313_));
  nand3  g144(.a(new_n313_), .b(new_n286_), .c(new_n285_), .O(new_n314_));
  nand4  g145(.a(new_n288_), .b(new_n158_), .c(x79), .d(x72), .O(new_n315_));
  aoi21  g146(.a(new_n315_), .b(new_n314_), .c(x01), .O(z52));
  inv1   g147(.a(x13), .O(new_n317_));
  nand2  g148(.a(x52), .b(x21), .O(new_n318_));
  oai21  g149(.a(x52), .b(new_n317_), .c(new_n318_), .O(new_n319_));
  nand3  g150(.a(new_n319_), .b(new_n286_), .c(new_n285_), .O(new_n320_));
  nand4  g151(.a(new_n288_), .b(new_n158_), .c(x79), .d(x73), .O(new_n321_));
  aoi21  g152(.a(new_n321_), .b(new_n320_), .c(x01), .O(z53));
  inv1   g153(.a(x14), .O(new_n323_));
  nor2   g154(.a(x52), .b(new_n323_), .O(new_n324_));
  aoi21  g155(.a(x52), .b(x22), .c(new_n324_), .O(new_n325_));
  nand4  g156(.a(new_n155_), .b(new_n210_), .c(x04), .d(new_n160_), .O(new_n326_));
  nor2   g157(.a(new_n326_), .b(new_n325_), .O(z54));
  inv1   g158(.a(x82), .O(new_n328_));
  nand4  g159(.a(x84), .b(x83), .c(new_n328_), .d(new_n217_), .O(new_n329_));
  nor2   g160(.a(x80), .b(new_n210_), .O(new_n330_));
  nand3  g161(.a(new_n330_), .b(new_n214_), .c(new_n211_), .O(new_n331_));
  nor2   g162(.a(new_n331_), .b(new_n329_), .O(z55));
  inv1   g163(.a(x02), .O(new_n334_));
  nand4  g164(.a(x03), .b(new_n334_), .c(new_n160_), .d(x00), .O(new_n335_));
  inv1   g165(.a(new_n335_), .O(z57));
  oai21  g166(.a(new_n158_), .b(new_n155_), .c(new_n288_), .O(new_n342_));
  nand2  g167(.a(new_n211_), .b(new_n284_), .O(new_n343_));
  nand3  g168(.a(x82), .b(x79), .c(new_n160_), .O(new_n344_));
