// Benchmark "FAU" written by ABC on Fri Jul 10 18:22:03 2020
...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n283_, new_n285_, new_n287_, new_n295_, new_n297_, new_n301_,
  ...
  nor3   g128(.a(new_n281_), .b(new_n272_), .c(new_n187_), .O(z39));
  nor3   g129(.a(new_n281_), .b(new_n272_), .c(new_n177_), .O(z43));
  nand2  g130(.a(new_n233_), .b(x62), .O(new_n295_));
  nor2   g131(.a(new_n295_), .b(new_n281_), .O(z44));
  nand2  g132(.a(new_n233_), .b(x63), .O(new_n297_));
  nor2   g133(.a(new_n297_), .b(new_n281_), .O(z45));
  nor3   g134(.a(new_n281_), .b(new_n272_), .c(new_n172_), .O(z46));
  ...
  nand3  g178(.a(new_n258_), .b(x84), .c(new_n344_), .O(new_n345_));
