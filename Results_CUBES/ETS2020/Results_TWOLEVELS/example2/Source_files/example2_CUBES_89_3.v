// Benchmark "FAU" written by ABC on Fri Jul 10 18:16:03 2020
...
module FAU ( 
  ...
  nand2  g138(.a(new_n251_), .b(x54), .O(new_n295_));
  nor2   g139(.a(new_n295_), .b(new_n291_), .O(z36));
  nand2  g140(.a(new_n251_), .b(x55), .O(new_n297_));
  nor2   g141(.a(new_n297_), .b(new_n291_), .O(z37));
  nand2  g142(.a(new_n251_), .b(x56), .O(new_n299_));
  nor2   g143(.a(new_n299_), .b(new_n291_), .O(z38));
  nor3   g144(.a(new_n291_), .b(new_n282_), .c(new_n202_), .O(z39));
  nor3   g145(.a(new_n291_), .b(new_n282_), .c(new_n195_), .O(z42));
  nor3   g146(.a(new_n291_), .b(new_n282_), .c(new_n192_), .O(z43));
  nor3   g147(.a(new_n291_), .b(new_n282_), .c(new_n189_), .O(z44));
  nor3   g148(.a(new_n291_), .b(new_n282_), .c(new_n186_), .O(z45));
  nor3   g149(.a(new_n291_), .b(new_n282_), .c(new_n183_), .O(z46));
  inv1   g150(.a(x07), .O(new_n309_));
  nand2  g151(.a(x52), .b(x15), .O(new_n310_));
  oai21  g152(.a(x52), .b(new_n309_), .c(new_n310_), .O(new_n311_));
  nand3  g153(.a(new_n228_), .b(new_n154_), .c(new_n159_), .O(new_n312_));
  ...
  nand2  g160(.a(new_n318_), .b(new_n225_), .O(new_n319_));
  ...
  inv1   g166(.a(new_n225_), .O(new_n325_));
  ...
  nand2  g195(.a(new_n281_), .b(x14), .O(new_n355_));
  ...
  inv1   g199(.a(x82), .O(new_n359_));
  nand3  g200(.a(new_n268_), .b(x84), .c(new_n359_), .O(new_n360_));
  inv1   g201(.a(x80), .O(new_n361_));
  nand4  g202(.a(new_n251_), .b(new_n165_), .c(new_n361_), .d(x79), .O(new_n362_));
  nor2   g203(.a(new_n362_), .b(new_n360_), .O(z55));
  inv1   g204(.a(x76), .O(new_n364_));
  nor2   g205(.a(new_n165_), .b(new_n364_), .O(new_n365_));
  xnor2a g206(.a(x84), .b(x81), .O(new_n366_));
  aoi21  g207(.a(new_n171_), .b(new_n170_), .c(new_n366_), .O(new_n367_));
  aoi21  g208(.a(new_n367_), .b(new_n153_), .c(new_n365_), .O(new_n368_));
  nor2   g209(.a(x77), .b(x01), .O(new_n369_));
  aoi21  g210(.a(new_n369_), .b(new_n164_), .c(new_n238_), .O(new_n370_));
  oai21  g211(.a(new_n368_), .b(new_n154_), .c(new_n370_), .O(z56));
  inv1   g212(.a(x02), .O(new_n372_));
  nand3  g213(.a(new_n239_), .b(x03), .c(new_n372_), .O(new_n373_));
  inv1   g214(.a(new_n373_), .O(z57));
  nand4  g215(.a(x80), .b(new_n231_), .c(x43), .d(new_n242_), .O(new_n375_));
  oai22  g216(.a(new_n375_), .b(new_n230_), .c(new_n242_), .d(x40), .O(new_n376_));
  nand3  g217(.a(new_n376_), .b(new_n228_), .c(x79), .O(new_n377_));
  nand3  g218(.a(new_n176_), .b(new_n242_), .c(x40), .O(new_n378_));
  nand2  g219(.a(new_n378_), .b(new_n377_), .O(new_n379_));
  nand2  g220(.a(new_n379_), .b(x77), .O(new_n380_));
  oai21  g221(.a(new_n356_), .b(new_n160_), .c(new_n154_), .O(new_n381_));
  aoi21  g222(.a(new_n381_), .b(new_n380_), .c(x01), .O(z58));
  aoi21  g223(.a(new_n163_), .b(new_n177_), .c(new_n152_), .O(new_n383_));
  oai21  g224(.a(new_n232_), .b(new_n230_), .c(new_n242_), .O(new_n384_));
  ...
  aoi21  g230(.a(new_n367_), .b(x79), .c(new_n387_), .O(new_n390_));
  aoi21  g231(.a(new_n390_), .b(new_n235_), .c(x01), .O(z60));
  inv1   g232(.a(new_n173_), .O(new_n392_));
  nand2  g233(.a(new_n171_), .b(new_n170_), .O(new_n393_));
  aoi22  g234(.a(new_n393_), .b(new_n225_), .c(new_n165_), .d(new_n160_), .O(new_n394_));
  nor3   g235(.a(new_n394_), .b(new_n392_), .c(new_n361_), .O(z61));
  ...
  nand2  g246(.a(new_n405_), .b(new_n316_), .O(new_n406_));
  aoi21  g247(.a(new_n406_), .b(new_n404_), .c(x01), .O(z62));
  nor3   g248(.a(new_n394_), .b(new_n392_), .c(new_n359_), .O(z63));
  ...
  nor2   g254(.a(new_n246_), .b(x78), .O(new_n414_));
  oai21  g255(.a(new_n414_), .b(new_n413_), .c(x77), .O(new_n415_));
  nand2  g256(.a(new_n356_), .b(x81), .O(new_n416_));
