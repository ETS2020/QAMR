...
module FAU ( 
  ...
  wire new_n154_, new_n155_, new_n156_, new_n157_, new_n158_, new_n159_,
    ...
    new_n268_, new_n270_, new_n274_, new_n276_, new_n278_, new_n280_,
  ...
  nand2  g099(.a(new_n219_), .b(x56), .O(new_n268_));
  nor2   g100(.a(new_n268_), .b(new_n262_), .O(z38));
  nand2  g101(.a(new_n219_), .b(x57), .O(new_n270_));
  nor2   g102(.a(new_n270_), .b(new_n262_), .O(z39));
  nand2  g103(.a(new_n219_), .b(x60), .O(new_n274_));
  nor2   g104(.a(new_n274_), .b(new_n262_), .O(z42));
  nand2  g105(.a(new_n219_), .b(x61), .O(new_n276_));
  nor2   g106(.a(new_n276_), .b(new_n262_), .O(z43));
  nand2  g107(.a(new_n219_), .b(x62), .O(new_n278_));
  nor2   g108(.a(new_n278_), .b(new_n262_), .O(z44));
  nand2  g109(.a(new_n219_), .b(x63), .O(new_n280_));
  nor2   g110(.a(new_n280_), .b(new_n262_), .O(z45));
  nand2  g111(.a(new_n219_), .b(x64), .O(new_n282_));
  nor2   g112(.a(new_n282_), .b(new_n262_), .O(z46));
