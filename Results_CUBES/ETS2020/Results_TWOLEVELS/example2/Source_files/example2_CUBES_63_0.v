// Benchmark "FAU" written by ABC on Fri Jul 10 18:14:15 2020
...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n294_, new_n303_, new_n304_, new_n305_, new_n306_, new_n307_,
  ...
  nand4  g095(.a(new_n248_), .b(new_n237_), .c(x46), .d(new_n241_), .O(new_n253_));
  inv1   g096(.a(new_n253_), .O(z28));
  nand4  g097(.a(new_n248_), .b(new_n237_), .c(x47), .d(new_n241_), .O(new_n255_));
  inv1   g098(.a(new_n255_), .O(z29));
  nand4  g099(.a(new_n248_), .b(new_n237_), .c(x48), .d(new_n241_), .O(new_n257_));
  inv1   g100(.a(new_n257_), .O(z30));
  nand4  g101(.a(new_n248_), .b(new_n237_), .c(x49), .d(new_n241_), .O(new_n259_));
  inv1   g102(.a(new_n259_), .O(z31));
  nand4  g103(.a(new_n248_), .b(new_n237_), .c(x50), .d(new_n241_), .O(new_n261_));
  inv1   g104(.a(new_n261_), .O(z32));
  nor2   g105(.a(new_n220_), .b(x81), .O(new_n263_));
  nor2   g106(.a(x83), .b(new_n245_), .O(new_n264_));
  nor2   g107(.a(new_n264_), .b(new_n263_), .O(new_n265_));
  nand2  g108(.a(x42), .b(x05), .O(new_n266_));
  nand2  g109(.a(x51), .b(new_n241_), .O(new_n267_));
  oai22  g110(.a(new_n267_), .b(new_n245_), .c(new_n266_), .d(new_n265_), .O(new_n268_));
  nand2  g111(.a(new_n268_), .b(new_n243_), .O(new_n269_));
  xor2a  g112(.a(x83), .b(x81), .O(new_n270_));
  oai22  g113(.a(new_n270_), .b(new_n266_), .c(new_n267_), .d(x81), .O(new_n271_));
  nand2  g114(.a(new_n271_), .b(new_n246_), .O(new_n272_));
  ...
  nand2  g124(.a(new_n263_), .b(x42), .O(new_n282_));
  aoi21  g125(.a(new_n282_), .b(new_n281_), .c(new_n242_), .O(new_n283_));
  oai21  g126(.a(new_n283_), .b(new_n280_), .c(new_n273_), .O(new_n284_));
  nand2  g127(.a(new_n237_), .b(x52), .O(new_n285_));
  nor2   g128(.a(new_n285_), .b(new_n284_), .O(z34));
  nand2  g129(.a(new_n237_), .b(x54), .O(new_n288_));
  nor2   g130(.a(new_n288_), .b(new_n284_), .O(z36));
  nand2  g131(.a(new_n237_), .b(x55), .O(new_n290_));
  nor2   g132(.a(new_n290_), .b(new_n284_), .O(z37));
  inv1   g133(.a(new_n237_), .O(new_n294_));
  nor3   g134(.a(new_n284_), .b(new_n294_), .c(new_n188_), .O(z40));
  nor3   g135(.a(new_n284_), .b(new_n294_), .c(new_n185_), .O(z41));
  nor3   g136(.a(new_n284_), .b(new_n294_), .c(new_n182_), .O(z42));
  nor3   g137(.a(new_n284_), .b(new_n294_), .c(new_n179_), .O(z43));
  nor3   g138(.a(new_n284_), .b(new_n294_), .c(new_n176_), .O(z44));
  nor3   g139(.a(new_n284_), .b(new_n294_), .c(new_n173_), .O(z45));
  inv1   g140(.a(x08), .O(new_n303_));
  nand2  g141(.a(x52), .b(x16), .O(new_n304_));
  oai21  g142(.a(x52), .b(new_n303_), .c(new_n304_), .O(new_n305_));
  nand3  g143(.a(new_n227_), .b(new_n154_), .c(new_n159_), .O(new_n306_));
  inv1   g144(.a(new_n306_), .O(new_n307_));
  nand2  g145(.a(new_n307_), .b(new_n305_), .O(new_n308_));
  inv1   g146(.a(new_n215_), .O(new_n309_));
  nand2  g147(.a(new_n309_), .b(x79), .O(new_n310_));
  inv1   g148(.a(new_n310_), .O(new_n311_));
  and2   g149(.a(new_n311_), .b(new_n217_), .O(new_n312_));
  nand2  g150(.a(new_n312_), .b(x68), .O(new_n313_));
  aoi21  g151(.a(new_n313_), .b(new_n308_), .c(x01), .O(z48));
  inv1   g152(.a(x10), .O(new_n316_));
  nand2  g153(.a(x52), .b(x18), .O(new_n317_));
  oai21  g154(.a(x52), .b(new_n316_), .c(new_n317_), .O(new_n318_));
  nand2  g155(.a(new_n318_), .b(new_n307_), .O(new_n319_));
  nand2  g156(.a(new_n312_), .b(x70), .O(new_n320_));
  aoi21  g157(.a(new_n320_), .b(new_n319_), .c(x01), .O(z50));
  inv1   g158(.a(x12), .O(new_n323_));
  nand2  g159(.a(x52), .b(x20), .O(new_n324_));
  oai21  g160(.a(x52), .b(new_n323_), .c(new_n324_), .O(new_n325_));
  nand2  g161(.a(new_n325_), .b(new_n307_), .O(new_n326_));
  nand2  g162(.a(new_n312_), .b(x72), .O(new_n327_));
  ...
  nand2  g167(.a(new_n331_), .b(new_n307_), .O(new_n332_));
  nand2  g168(.a(new_n312_), .b(x73), .O(new_n333_));
  aoi21  g169(.a(new_n333_), .b(new_n332_), .c(x01), .O(z53));
  inv1   g170(.a(x82), .O(new_n336_));
  nand3  g171(.a(new_n263_), .b(x84), .c(new_n336_), .O(new_n337_));
  inv1   g172(.a(x80), .O(new_n338_));
  nand4  g173(.a(new_n237_), .b(new_n161_), .c(new_n338_), .d(x79), .O(new_n339_));
  nor2   g174(.a(new_n339_), .b(new_n337_), .O(z55));
  nand2  g175(.a(new_n235_), .b(x76), .O(new_n341_));
  xnor2a g176(.a(x84), .b(x81), .O(new_n342_));
  aoi21  g177(.a(new_n215_), .b(new_n214_), .c(new_n342_), .O(new_n343_));
  nand2  g178(.a(new_n343_), .b(new_n153_), .O(new_n344_));
  nand2  g179(.a(new_n344_), .b(new_n341_), .O(new_n345_));
  nand2  g180(.a(new_n345_), .b(x79), .O(new_n346_));
  nand3  g181(.a(new_n160_), .b(new_n159_), .c(new_n153_), .O(new_n347_));
  nand3  g182(.a(new_n347_), .b(new_n346_), .c(new_n233_), .O(z56));
  inv1   g183(.a(x02), .O(new_n349_));
  nand3  g184(.a(new_n233_), .b(x03), .c(new_n349_), .O(new_n350_));
  inv1   g185(.a(new_n350_), .O(z57));
  nand4  g186(.a(x80), .b(new_n222_), .c(x43), .d(new_n241_), .O(new_n352_));
  oai22  g187(.a(new_n352_), .b(new_n221_), .c(new_n241_), .d(x40), .O(new_n353_));
  nand3  g188(.a(new_n353_), .b(new_n227_), .c(x79), .O(new_n354_));
  nor2   g189(.a(x79), .b(x78), .O(new_n355_));
  nand3  g190(.a(new_n355_), .b(new_n241_), .c(x40), .O(new_n356_));
  nand2  g191(.a(new_n356_), .b(new_n354_), .O(new_n357_));
  nand2  g192(.a(new_n357_), .b(x77), .O(new_n358_));
  inv1   g193(.a(new_n214_), .O(new_n359_));
  oai21  g194(.a(new_n359_), .b(new_n230_), .c(new_n154_), .O(new_n360_));
  aoi21  g195(.a(new_n360_), .b(new_n358_), .c(x01), .O(z58));
  inv1   g196(.a(new_n355_), .O(new_n362_));
  aoi21  g197(.a(new_n226_), .b(new_n362_), .c(new_n152_), .O(new_n363_));
  oai21  g198(.a(new_n223_), .b(new_n221_), .c(new_n241_), .O(new_n364_));
  ...
  aoi21  g204(.a(new_n343_), .b(x79), .c(new_n367_), .O(new_n370_));
  ...
  nor3   g210(.a(new_n375_), .b(new_n373_), .c(new_n338_), .O(z61));
  ...
  nand2  g221(.a(new_n386_), .b(new_n309_), .O(new_n387_));
  aoi21  g222(.a(new_n387_), .b(new_n385_), .c(x01), .O(z62));
  nor3   g223(.a(new_n375_), .b(new_n373_), .c(new_n336_), .O(z63));
  nand2  g224(.a(x83), .b(x79), .O(new_n390_));
  or2    g225(.a(new_n390_), .b(new_n373_), .O(new_n391_));
  aoi21  g226(.a(new_n391_), .b(new_n306_), .c(x01), .O(z64));
  nor2   g227(.a(new_n160_), .b(x04), .O(new_n393_));
  nor2   g228(.a(new_n245_), .b(x78), .O(new_n394_));
  oai21  g229(.a(new_n394_), .b(new_n393_), .c(x77), .O(new_n395_));
  nand2  g230(.a(new_n359_), .b(x81), .O(new_n396_));
