...
module FAU ( 
  ...
  nor2   g32(.a(x12), .b(x10), .O(new_n59_));
  nand4  g33(.a(new_n59_), .b(x13), .c(new_n40_), .d(new_n58_), .O(z5));
  inv1   g34(.a(x08), .O(new_n61_));
  aoi21  g35(.a(x09), .b(new_n34_), .c(x02), .O(new_n62_));
  nand2  g36(.a(x03), .b(new_n30_), .O(new_n63_));
  oai22  g37(.a(new_n63_), .b(x09), .c(new_n62_), .d(x01), .O(new_n64_));
  oai21  g38(.a(new_n61_), .b(new_n58_), .c(new_n64_), .O(new_n65_));
  inv1   g39(.a(x14), .O(new_n66_));
  nand2  g40(.a(new_n30_), .b(new_n58_), .O(new_n67_));
  oai21  g41(.a(x08), .b(new_n58_), .c(new_n67_), .O(new_n68_));
  ...
  nand4  g46(.a(new_n41_), .b(new_n61_), .c(new_n40_), .d(x02), .O(new_n73_));
  oai21  g47(.a(new_n63_), .b(new_n72_), .c(new_n73_), .O(new_n74_));
  nand2  g48(.a(new_n74_), .b(new_n25_), .O(new_n75_));
  nand2  g49(.a(x03), .b(new_n25_), .O(new_n76_));
  aoi21  g50(.a(new_n76_), .b(new_n61_), .c(new_n45_), .O(new_n77_));
