...
module FAU ( 
  ...
  nor2   g30(.a(x07), .b(x00), .O(new_n57_));
  nand4  g31(.a(new_n57_), .b(x13), .c(new_n56_), .d(new_n46_), .O(z5));
  nor2   g32(.a(x07), .b(new_n30_), .O(new_n60_));
  nand2  g33(.a(x03), .b(new_n25_), .O(new_n61_));
  oai21  g34(.a(new_n61_), .b(new_n60_), .c(new_n49_), .O(new_n62_));
  nor2   g35(.a(x02), .b(x01), .O(new_n63_));
  and2   g36(.a(x09), .b(x03), .O(new_n64_));
  nand2  g37(.a(new_n46_), .b(new_n45_), .O(new_n65_));
  aoi21  g38(.a(new_n64_), .b(new_n63_), .c(new_n65_), .O(new_n66_));
  nand2  g39(.a(new_n66_), .b(new_n62_), .O(z7));
  nand3  g40(.a(new_n63_), .b(new_n56_), .c(x03), .O(new_n68_));
  nand2  g41(.a(new_n68_), .b(x09), .O(new_n69_));
  nor2   g42(.a(x09), .b(x00), .O(new_n70_));
  nor2   g43(.a(new_n70_), .b(new_n65_), .O(new_n71_));
  nand2  g44(.a(new_n71_), .b(new_n69_), .O(z8));
  zero   g45(.O(z3));
  zero   g46(.O(z4));
  zero   g47(.O(z6));
endmodule
