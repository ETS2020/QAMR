// Benchmark "FAU" written by ABC on Mon Jul  6 16:20:28 2020
...
module FAU ( 
  ...
  inv1   g31(.a(x00), .O(new_n59_));
  inv1   g32(.a(x08), .O(new_n60_));
  aoi21  g33(.a(x09), .b(new_n34_), .c(x02), .O(new_n61_));
  inv1   g34(.a(x09), .O(new_n62_));
  nand3  g35(.a(new_n62_), .b(x03), .c(new_n30_), .O(new_n63_));
  oai21  g36(.a(new_n61_), .b(x01), .c(new_n63_), .O(new_n64_));
  oai21  g37(.a(new_n60_), .b(new_n59_), .c(new_n64_), .O(new_n65_));
  inv1   g38(.a(x14), .O(new_n66_));
  nand2  g39(.a(new_n30_), .b(new_n59_), .O(new_n67_));
  oai21  g40(.a(x08), .b(new_n59_), .c(new_n67_), .O(new_n68_));
  nor2   g41(.a(new_n30_), .b(x00), .O(new_n69_));
  aoi22  g42(.a(new_n69_), .b(new_n66_), .c(new_n68_), .d(x01), .O(new_n70_));
  aoi21  g43(.a(new_n70_), .b(new_n65_), .c(new_n45_), .O(z6));
  nand3  g44(.a(x09), .b(x03), .c(new_n30_), .O(new_n72_));
  nand4  g45(.a(new_n41_), .b(new_n60_), .c(new_n40_), .d(x02), .O(new_n73_));
  nand2  g46(.a(new_n73_), .b(new_n72_), .O(new_n74_));
  nand2  g47(.a(new_n74_), .b(new_n25_), .O(new_n75_));
  nand2  g48(.a(x03), .b(new_n25_), .O(new_n76_));
  aoi21  g49(.a(new_n76_), .b(new_n60_), .c(new_n45_), .O(new_n77_));
  nand2  g50(.a(new_n77_), .b(new_n75_), .O(z7));
  inv1   g51(.a(x12), .O(new_n79_));
  nand2  g52(.a(new_n79_), .b(new_n30_), .O(new_n80_));
  oai21  g53(.a(new_n80_), .b(new_n76_), .c(x09), .O(new_n81_));
  aoi21  g54(.a(new_n62_), .b(new_n59_), .c(new_n45_), .O(new_n82_));
  nand2  g55(.a(new_n82_), .b(new_n81_), .O(z8));
  zero   g56(.O(z3));
  zero   g57(.O(z4));
  zero   g58(.O(z5));
endmodule
