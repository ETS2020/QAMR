// Benchmark "FAU" written by ABC on Mon Jul  6 16:20:37 2020
...
module FAU ( 
  ...
  oai21  g37(.a(new_n58_), .b(x03), .c(new_n30_), .O(new_n63_));
  nand3  g38(.a(new_n63_), .b(new_n59_), .c(new_n25_), .O(new_n64_));
  inv1   g39(.a(x14), .O(new_n65_));
  oai21  g40(.a(x09), .b(new_n34_), .c(new_n25_), .O(new_n66_));
  nand2  g41(.a(new_n30_), .b(new_n56_), .O(new_n67_));
  oai21  g42(.a(x08), .b(new_n56_), .c(new_n67_), .O(new_n68_));
  nor2   g43(.a(new_n30_), .b(x00), .O(new_n69_));
  aoi22  g44(.a(new_n69_), .b(new_n65_), .c(new_n68_), .d(new_n66_), .O(new_n70_));
  aoi21  g45(.a(new_n70_), .b(new_n64_), .c(new_n45_), .O(z6));
  nand2  g46(.a(x03), .b(new_n25_), .O(new_n72_));
  aoi21  g47(.a(new_n40_), .b(x02), .c(new_n72_), .O(new_n73_));
  nor2   g48(.a(x02), .b(x01), .O(new_n74_));
  nor2   g49(.a(new_n58_), .b(new_n34_), .O(new_n75_));
  aoi21  g50(.a(new_n75_), .b(new_n74_), .c(new_n45_), .O(new_n76_));
  oai21  g51(.a(new_n73_), .b(x08), .c(new_n76_), .O(z7));
  inv1   g52(.a(x12), .O(new_n78_));
  nand3  g53(.a(new_n74_), .b(new_n78_), .c(x03), .O(new_n79_));
  nand2  g54(.a(new_n79_), .b(x09), .O(new_n80_));
  aoi21  g55(.a(new_n58_), .b(new_n56_), .c(new_n45_), .O(new_n81_));
  nand2  g56(.a(new_n81_), .b(new_n80_), .O(z8));
  zero   g57(.O(z5));
endmodule
