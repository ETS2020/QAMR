// Benchmark "FAU" written by ABC on Mon Jul  6 16:20:55 2020
...
module FAU ( 
  ...
  nand4  g35(.a(new_n60_), .b(new_n41_), .c(new_n40_), .d(new_n56_), .O(z5));
  inv1   g36(.a(x09), .O(new_n62_));
  oai21  g37(.a(new_n62_), .b(x03), .c(new_n30_), .O(new_n63_));
  aoi21  g38(.a(x08), .b(x00), .c(x01), .O(new_n64_));
  nand2  g39(.a(new_n64_), .b(new_n63_), .O(new_n65_));
  inv1   g40(.a(x14), .O(new_n66_));
  oai21  g41(.a(x09), .b(new_n34_), .c(new_n25_), .O(new_n67_));
  nand2  g42(.a(new_n30_), .b(new_n56_), .O(new_n68_));
  oai21  g43(.a(x08), .b(new_n56_), .c(new_n68_), .O(new_n69_));
  nor2   g44(.a(new_n25_), .b(x00), .O(new_n70_));
  aoi22  g45(.a(new_n70_), .b(new_n66_), .c(new_n69_), .d(new_n67_), .O(new_n71_));
  aoi21  g46(.a(new_n71_), .b(new_n65_), .c(new_n45_), .O(z6));
  nand3  g47(.a(x09), .b(x03), .c(new_n30_), .O(new_n73_));
  inv1   g48(.a(x08), .O(new_n74_));
  nand4  g49(.a(new_n41_), .b(new_n74_), .c(new_n40_), .d(x02), .O(new_n75_));
  nand2  g50(.a(new_n75_), .b(new_n73_), .O(new_n76_));
  nand2  g51(.a(new_n76_), .b(new_n25_), .O(new_n77_));
  nand2  g52(.a(x03), .b(new_n25_), .O(new_n78_));
  aoi21  g53(.a(new_n78_), .b(new_n74_), .c(new_n45_), .O(new_n79_));
  nand2  g54(.a(new_n79_), .b(new_n77_), .O(z7));
  inv1   g55(.a(x12), .O(new_n81_));
  nand2  g56(.a(new_n81_), .b(new_n30_), .O(new_n82_));
  oai21  g57(.a(new_n82_), .b(new_n78_), .c(x09), .O(new_n83_));
  aoi21  g58(.a(new_n62_), .b(new_n56_), .c(new_n45_), .O(new_n84_));
  nand2  g59(.a(new_n84_), .b(new_n83_), .O(z8));
  zero   g60(.O(z4));
endmodule
