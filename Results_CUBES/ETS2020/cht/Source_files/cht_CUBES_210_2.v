...
module FAU ( 
  ...
  nor2   g084(.a(x14), .b(new_n140_), .O(new_n173_));
  nand2  g085(.a(new_n173_), .b(x42), .O(new_n174_));
  aoi21  g086(.a(new_n174_), .b(new_n172_), .c(x10), .O(z30));
  nand2  g087(.a(new_n171_), .b(x44), .O(new_n178_));
  nand2  g088(.a(new_n173_), .b(x45), .O(new_n179_));
  aoi21  g089(.a(new_n179_), .b(new_n178_), .c(x10), .O(z33));
  nand2  g090(.a(new_n171_), .b(x46), .O(new_n182_));
  nand2  g091(.a(new_n173_), .b(x00), .O(new_n183_));
