// Benchmark "FAU" written by ABC on Mon Jul  6 19:23:59 2020
...
module FAU ( 
  ...
  inv1   g078(.a(x14), .O(new_n167_));
  nand2  g079(.a(new_n167_), .b(x09), .O(new_n168_));
  nand2  g080(.a(new_n168_), .b(x40), .O(new_n169_));
  nor2   g081(.a(x14), .b(new_n142_), .O(new_n170_));
  nand2  g082(.a(new_n170_), .b(x41), .O(new_n171_));
  aoi21  g083(.a(new_n171_), .b(new_n169_), .c(x10), .O(z29));
  nand2  g084(.a(new_n168_), .b(x41), .O(new_n173_));
  nand2  g085(.a(new_n170_), .b(x42), .O(new_n174_));
  aoi21  g086(.a(new_n174_), .b(new_n173_), .c(x10), .O(z30));
  nand2  g087(.a(new_n168_), .b(x42), .O(new_n176_));
  nand2  g088(.a(new_n170_), .b(x43), .O(new_n177_));
  aoi21  g089(.a(new_n177_), .b(new_n176_), .c(x10), .O(z31));
  nand2  g090(.a(new_n168_), .b(x43), .O(new_n179_));
  nand2  g091(.a(new_n170_), .b(x44), .O(new_n180_));
  aoi21  g092(.a(new_n180_), .b(new_n179_), .c(x10), .O(z32));
  nand2  g093(.a(new_n168_), .b(x45), .O(new_n183_));
  nand2  g094(.a(new_n170_), .b(x46), .O(new_n184_));
  aoi21  g095(.a(new_n184_), .b(new_n183_), .c(x10), .O(z34));
  nand2  g096(.a(new_n168_), .b(x46), .O(new_n186_));
  nand2  g097(.a(new_n170_), .b(x00), .O(new_n187_));
