...
module FAU ( 
  ...
  wire new_n85_, new_n86_, new_n87_, new_n89_, new_n90_, new_n92_, new_n93_,
    ...
    new_n127_, new_n130_, new_n131_, new_n132_, new_n137_, new_n138_,
  ...
  nand2  g69(.a(new_n153_), .b(x43), .O(new_n165_));
  nand2  g70(.a(new_n155_), .b(x44), .O(new_n166_));
  aoi21  g71(.a(new_n166_), .b(new_n165_), .c(x10), .O(z32));
  nand2  g72(.a(new_n153_), .b(x44), .O(new_n168_));
  nand2  g73(.a(new_n155_), .b(x45), .O(new_n169_));
  aoi21  g74(.a(new_n169_), .b(new_n168_), .c(x10), .O(z33));
  nand2  g75(.a(new_n153_), .b(x46), .O(new_n172_));
  nand2  g76(.a(new_n155_), .b(x00), .O(new_n173_));
