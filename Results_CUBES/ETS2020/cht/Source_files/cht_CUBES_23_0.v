...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n88_, new_n89_, new_n91_, new_n92_,
    ...
    new_n168_, new_n171_, new_n172_, new_n174_, new_n175_, new_n178_,
    new_n179_;
  ...
  oai21  g79(.a(x14), .b(new_n140_), .c(x40), .O(new_n167_));
  ...
  nand3  g83(.a(x43), .b(new_n164_), .c(x09), .O(new_n172_));
  aoi21  g84(.a(new_n172_), .b(new_n171_), .c(x10), .O(z31));
  oai21  g85(.a(x14), .b(new_n140_), .c(x43), .O(new_n174_));
  nand3  g86(.a(x44), .b(new_n164_), .c(x09), .O(new_n175_));
