...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n88_, new_n89_, new_n91_, new_n92_,
    ...
    new_n136_, new_n137_, new_n143_, new_n144_, new_n148_, new_n149_,
    new_n150_, new_n152_, new_n153_, new_n155_, new_n156_, new_n158_,
    new_n159_, new_n162_, new_n163_, new_n165_, new_n166_;
  ...
  oai21  g51(.a(x14), .b(new_n132_), .c(x40), .O(new_n148_));
  ...
  nand3  g65(.a(x46), .b(new_n149_), .c(x09), .O(new_n163_));
  aoi21  g66(.a(new_n163_), .b(new_n162_), .c(x10), .O(z34));
  oai21  g67(.a(x14), .b(new_n132_), .c(x46), .O(new_n165_));
  nand3  g68(.a(new_n149_), .b(x09), .c(x00), .O(new_n166_));
