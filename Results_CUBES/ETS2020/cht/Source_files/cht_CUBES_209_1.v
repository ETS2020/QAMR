...
module FAU ( 
  ...
  wire new_n85_, new_n86_, new_n87_, new_n89_, new_n90_, new_n93_, new_n94_,
    ...
    new_n105_, new_n108_, new_n109_, new_n111_, new_n112_, new_n115_,
    new_n116_, new_n119_, new_n120_, new_n122_, new_n123_, new_n127_,
    new_n128_, new_n130_, new_n131_, new_n132_, new_n135_, new_n136_,
    new_n138_, new_n139_, new_n143_, new_n144_, new_n146_, new_n147_,
  ...
  nand2  g45(.a(x34), .b(new_n130_), .O(new_n138_));
  nand2  g46(.a(x35), .b(x09), .O(new_n139_));
  aoi21  g47(.a(new_n139_), .b(new_n138_), .c(x10), .O(z23));
  nand2  g48(.a(x37), .b(new_n130_), .O(new_n143_));
  ...
  nand2  g55(.a(x38), .b(new_n130_), .O(new_n150_));
  ...
  nor2   g60(.a(x14), .b(new_n130_), .O(new_n155_));
  ...
  nand2  g81(.a(new_n153_), .b(x46), .O(new_n176_));
  nand2  g82(.a(new_n155_), .b(x00), .O(new_n177_));
