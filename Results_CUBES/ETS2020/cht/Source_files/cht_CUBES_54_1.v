...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n88_, new_n89_, new_n91_, new_n92_,
    ...
    new_n103_, new_n108_, new_n109_, new_n115_, new_n116_, new_n118_,
    new_n119_, new_n121_, new_n122_, new_n125_, new_n126_, new_n129_,
    new_n130_, new_n131_, new_n133_, new_n134_, new_n136_, new_n137_,
    new_n141_, new_n142_, new_n146_, new_n147_, new_n148_, new_n150_,
  ...
  inv1   g35(.a(x09), .O(new_n129_));
  nand2  g36(.a(x32), .b(new_n129_), .O(new_n130_));
  nand2  g37(.a(x33), .b(x09), .O(new_n131_));
  aoi21  g38(.a(new_n131_), .b(new_n130_), .c(x10), .O(z21));
  nand2  g39(.a(x33), .b(new_n129_), .O(new_n133_));
  nand2  g40(.a(x34), .b(x09), .O(new_n134_));
  aoi21  g41(.a(new_n134_), .b(new_n133_), .c(x10), .O(z22));
  nand2  g42(.a(x34), .b(new_n129_), .O(new_n136_));
  nand2  g43(.a(x35), .b(x09), .O(new_n137_));
  aoi21  g44(.a(new_n137_), .b(new_n136_), .c(x10), .O(z23));
  nand2  g45(.a(x37), .b(new_n129_), .O(new_n141_));
  nand2  g46(.a(x38), .b(x09), .O(new_n142_));
  aoi21  g47(.a(new_n142_), .b(new_n141_), .c(x10), .O(z26));
  oai21  g48(.a(x14), .b(new_n129_), .c(x40), .O(new_n146_));
  inv1   g49(.a(x14), .O(new_n147_));
  nand3  g50(.a(x41), .b(new_n147_), .c(x09), .O(new_n148_));
  aoi21  g51(.a(new_n148_), .b(new_n146_), .c(x10), .O(z29));
  oai21  g52(.a(x14), .b(new_n129_), .c(x41), .O(new_n150_));
  nand3  g53(.a(x42), .b(new_n147_), .c(x09), .O(new_n151_));
  aoi21  g54(.a(new_n151_), .b(new_n150_), .c(x10), .O(z30));
  oai21  g55(.a(x14), .b(new_n129_), .c(x42), .O(new_n153_));
  nand3  g56(.a(x43), .b(new_n147_), .c(x09), .O(new_n154_));
