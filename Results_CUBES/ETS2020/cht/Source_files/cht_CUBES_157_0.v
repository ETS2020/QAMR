...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n88_, new_n89_, new_n92_, new_n93_,
    ...
    new_n122_, new_n125_, new_n126_, new_n128_, new_n129_, new_n131_,
    ...
    new_n170_, new_n172_, new_n173_, new_n176_, new_n177_, new_n179_,
    new_n180_;
  ...
  nand2  g66(.a(x36), .b(new_n140_), .O(new_n154_));
  nand2  g67(.a(x37), .b(x09), .O(new_n155_));
  aoi21  g68(.a(new_n155_), .b(new_n154_), .c(x10), .O(z25));
  nand2  g69(.a(x37), .b(new_n140_), .O(new_n157_));
  ...
  oai21  g79(.a(x14), .b(new_n140_), .c(x42), .O(new_n169_));
  ...
  nand3  g89(.a(new_n162_), .b(x09), .c(x00), .O(new_n180_));
