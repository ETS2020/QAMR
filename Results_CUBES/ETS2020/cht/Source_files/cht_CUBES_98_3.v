...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n88_, new_n89_, new_n91_, new_n92_,
    ...
    new_n162_, new_n164_, new_n165_, new_n168_, new_n169_, new_n171_,
  ...
  oai21  g69(.a(x14), .b(new_n141_), .c(x40), .O(new_n160_));
  inv1   g70(.a(x14), .O(new_n161_));
  nand3  g71(.a(x41), .b(new_n161_), .c(x09), .O(new_n162_));
  aoi21  g72(.a(new_n162_), .b(new_n160_), .c(x10), .O(z29));
  oai21  g73(.a(x14), .b(new_n141_), .c(x41), .O(new_n164_));
  nand3  g74(.a(x42), .b(new_n161_), .c(x09), .O(new_n165_));
  aoi21  g75(.a(new_n165_), .b(new_n164_), .c(x10), .O(z30));
  oai21  g76(.a(x14), .b(new_n141_), .c(x43), .O(new_n168_));
  nand3  g77(.a(x44), .b(new_n161_), .c(x09), .O(new_n169_));
  aoi21  g78(.a(new_n169_), .b(new_n168_), .c(x10), .O(z32));
  oai21  g79(.a(x14), .b(new_n141_), .c(x44), .O(new_n171_));
  nand3  g80(.a(x45), .b(new_n161_), .c(x09), .O(new_n172_));
  aoi21  g81(.a(new_n172_), .b(new_n171_), .c(x10), .O(z33));
  oai21  g82(.a(x14), .b(new_n141_), .c(x45), .O(new_n174_));
  nand3  g83(.a(x46), .b(new_n161_), .c(x09), .O(new_n175_));
  aoi21  g84(.a(new_n175_), .b(new_n174_), .c(x10), .O(z34));
  oai21  g85(.a(x14), .b(new_n141_), .c(x46), .O(new_n177_));
  nand3  g86(.a(new_n161_), .b(x09), .c(x00), .O(new_n178_));
