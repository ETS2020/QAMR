...
module FAU ( 
  ...
  wire new_n85_, new_n86_, new_n87_, new_n90_, new_n91_, new_n93_, new_n94_,
    ...
    new_n115_, new_n117_, new_n118_, new_n120_, new_n121_, new_n126_,
    new_n127_, new_n130_, new_n131_, new_n132_, new_n134_, new_n135_,
    new_n137_, new_n138_, new_n141_, new_n142_, new_n144_, new_n145_,
    new_n147_, new_n148_, new_n153_, new_n154_, new_n155_, new_n157_,
  ...
  oai21  g57(.a(x14), .b(new_n130_), .c(x41), .O(new_n153_));
  inv1   g58(.a(x14), .O(new_n154_));
  nand3  g59(.a(x42), .b(new_n154_), .c(x09), .O(new_n155_));
  aoi21  g60(.a(new_n155_), .b(new_n153_), .c(x10), .O(z30));
  oai21  g61(.a(x14), .b(new_n130_), .c(x42), .O(new_n157_));
  nand3  g62(.a(x43), .b(new_n154_), .c(x09), .O(new_n158_));
  aoi21  g63(.a(new_n158_), .b(new_n157_), .c(x10), .O(z31));
  oai21  g64(.a(x14), .b(new_n130_), .c(x44), .O(new_n161_));
  nand3  g65(.a(x45), .b(new_n154_), .c(x09), .O(new_n162_));
  aoi21  g66(.a(new_n162_), .b(new_n161_), .c(x10), .O(z33));
  oai21  g67(.a(x14), .b(new_n130_), .c(x46), .O(new_n165_));
  nand3  g68(.a(new_n154_), .b(x09), .c(x00), .O(new_n166_));
