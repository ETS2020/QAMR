...
module FAU ( 
  ...
  nand2  g60(.a(x34), .b(new_n142_), .O(new_n148_));
  nand2  g61(.a(x35), .b(x09), .O(new_n149_));
  aoi21  g62(.a(new_n149_), .b(new_n148_), .c(x10), .O(z23));
  nand2  g63(.a(x36), .b(new_n142_), .O(new_n152_));
