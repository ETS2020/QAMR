// Benchmark "FAU" written by ABC on Mon Jul  6 19:22:16 2020
...
module FAU ( 
  ...
  nand2  g70(.a(x38), .b(new_n136_), .O(new_n160_));
  ...
  nor2   g75(.a(x14), .b(new_n136_), .O(new_n165_));
  nand2  g76(.a(new_n165_), .b(x40), .O(new_n166_));
  aoi21  g77(.a(new_n166_), .b(new_n164_), .c(x10), .O(z28));
  nand2  g78(.a(new_n163_), .b(x40), .O(new_n168_));
  nand2  g79(.a(new_n165_), .b(x41), .O(new_n169_));
  aoi21  g80(.a(new_n169_), .b(new_n168_), .c(x10), .O(z29));
  nand2  g81(.a(new_n163_), .b(x42), .O(new_n172_));
  nand2  g82(.a(new_n165_), .b(x43), .O(new_n173_));
  aoi21  g83(.a(new_n173_), .b(new_n172_), .c(x10), .O(z31));
  nand2  g84(.a(new_n163_), .b(x43), .O(new_n175_));
  nand2  g85(.a(new_n165_), .b(x44), .O(new_n176_));
  aoi21  g86(.a(new_n176_), .b(new_n175_), .c(x10), .O(z32));
  nand2  g87(.a(new_n163_), .b(x44), .O(new_n178_));
  nand2  g88(.a(new_n165_), .b(x45), .O(new_n179_));
  aoi21  g89(.a(new_n179_), .b(new_n178_), .c(x10), .O(z33));
  zero   g90(.O(z01));
  zero   g91(.O(z04));
  zero   g92(.O(z09));
  zero   g93(.O(z14));
