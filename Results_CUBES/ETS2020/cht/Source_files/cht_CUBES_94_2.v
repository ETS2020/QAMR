// Benchmark "FAU" written by ABC on Mon Jul  6 19:22:44 2020
...
module FAU ( 
  ...
  wire new_n85_, new_n86_, new_n87_, new_n89_, new_n90_, new_n92_, new_n93_,
    ...
    new_n103_, new_n106_, new_n107_, new_n109_, new_n110_, new_n114_,
  ...
  nand2  g020(.a(x19), .b(new_n101_), .O(new_n106_));
  ...
  nand2  g026(.a(x23), .b(new_n101_), .O(new_n114_));
  ...
  nand2  g070(.a(x38), .b(new_n138_), .O(new_n160_));
  ...
  nor2   g075(.a(x14), .b(new_n138_), .O(new_n165_));
  ...
  nand2  g081(.a(new_n163_), .b(x43), .O(new_n173_));
  nand2  g082(.a(new_n165_), .b(x44), .O(new_n174_));
  aoi21  g083(.a(new_n174_), .b(new_n173_), .c(x10), .O(z32));
  nand2  g084(.a(new_n163_), .b(x44), .O(new_n176_));
  nand2  g085(.a(new_n165_), .b(x45), .O(new_n177_));
  aoi21  g086(.a(new_n177_), .b(new_n176_), .c(x10), .O(z33));
  nand2  g087(.a(new_n163_), .b(x45), .O(new_n179_));
  nand2  g088(.a(new_n165_), .b(x46), .O(new_n180_));
  aoi21  g089(.a(new_n180_), .b(new_n179_), .c(x10), .O(z34));
  nand2  g090(.a(new_n163_), .b(x46), .O(new_n182_));
  nand2  g091(.a(new_n165_), .b(x00), .O(new_n183_));
