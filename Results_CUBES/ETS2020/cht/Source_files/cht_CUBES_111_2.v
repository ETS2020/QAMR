...
module FAU ( 
  ...
  nor2   g75(.a(x14), .b(new_n138_), .O(new_n166_));
  ...
  nand2  g81(.a(new_n164_), .b(x42), .O(new_n172_));
  nand2  g82(.a(new_n166_), .b(x43), .O(new_n173_));
  aoi21  g83(.a(new_n173_), .b(new_n172_), .c(x10), .O(z31));
  nand2  g84(.a(new_n164_), .b(x46), .O(new_n178_));
  nand2  g85(.a(new_n166_), .b(x00), .O(new_n179_));
