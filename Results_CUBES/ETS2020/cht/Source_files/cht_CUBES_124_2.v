...
module FAU ( 
  ...
  wire new_n85_, new_n86_, new_n87_, new_n90_, new_n91_, new_n94_, new_n95_,
    ...
    new_n164_, new_n167_, new_n168_, new_n171_, new_n172_;
  ...
  oai21  g63(.a(x14), .b(new_n134_), .c(x40), .O(new_n156_));
  ...
  nand3  g68(.a(x42), .b(new_n157_), .c(x09), .O(new_n161_));
  aoi21  g69(.a(new_n161_), .b(new_n160_), .c(x10), .O(z30));
  oai21  g70(.a(x14), .b(new_n134_), .c(x42), .O(new_n163_));
  nand3  g71(.a(x43), .b(new_n157_), .c(x09), .O(new_n164_));
  aoi21  g72(.a(new_n164_), .b(new_n163_), .c(x10), .O(z31));
  oai21  g73(.a(x14), .b(new_n134_), .c(x44), .O(new_n167_));
  nand3  g74(.a(x45), .b(new_n157_), .c(x09), .O(new_n168_));
  aoi21  g75(.a(new_n168_), .b(new_n167_), .c(x10), .O(z33));
  oai21  g76(.a(x14), .b(new_n134_), .c(x46), .O(new_n171_));
  nand3  g77(.a(new_n157_), .b(x09), .c(x00), .O(new_n172_));
