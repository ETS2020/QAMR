...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n88_, new_n89_, new_n91_, new_n92_,
    ...
    new_n103_, new_n106_, new_n107_, new_n110_, new_n111_, new_n115_,
    new_n116_, new_n118_, new_n119_, new_n121_, new_n122_, new_n124_,
    new_n125_, new_n127_, new_n128_, new_n132_, new_n133_, new_n134_,
    new_n137_, new_n138_, new_n143_, new_n144_, new_n147_, new_n148_,
  ...
  oai21  g55(.a(x14), .b(new_n132_), .c(x40), .O(new_n151_));
  ...
  oai21  g70(.a(x14), .b(new_n132_), .c(x45), .O(new_n166_));
  nand3  g71(.a(x46), .b(new_n148_), .c(x09), .O(new_n167_));
  aoi21  g72(.a(new_n167_), .b(new_n166_), .c(x10), .O(z34));
  oai21  g73(.a(x14), .b(new_n132_), .c(x46), .O(new_n169_));
