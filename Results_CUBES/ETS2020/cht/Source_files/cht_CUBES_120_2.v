...
module FAU ( 
  ...
  wire new_n85_, new_n86_, new_n87_, new_n89_, new_n90_, new_n92_, new_n93_,
    ...
    new_n133_, new_n137_, new_n138_, new_n139_, new_n143_, new_n144_,
  ...
  nor2   g66(.a(x14), .b(new_n137_), .O(new_n160_));
  ...
  nand2  g75(.a(new_n158_), .b(x45), .O(new_n171_));
  nand2  g76(.a(new_n160_), .b(x46), .O(new_n172_));
