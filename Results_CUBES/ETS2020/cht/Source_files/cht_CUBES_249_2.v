...
module FAU ( 
  ...
  nor2   g69(.a(x14), .b(new_n134_), .O(new_n163_));
  nand2  g70(.a(new_n163_), .b(x42), .O(new_n164_));
  aoi21  g71(.a(new_n164_), .b(new_n162_), .c(x10), .O(z30));
  nand2  g72(.a(new_n161_), .b(x43), .O(new_n167_));
  nand2  g73(.a(new_n163_), .b(x44), .O(new_n168_));
  ...
  nand2  g78(.a(new_n161_), .b(x46), .O(new_n174_));
  nand2  g79(.a(new_n163_), .b(x00), .O(new_n175_));
