...
module FAU ( 
  ...
  inv1   g084(.a(x14), .O(new_n171_));
  nand2  g085(.a(new_n171_), .b(x09), .O(new_n172_));
  nand2  g086(.a(new_n172_), .b(x40), .O(new_n173_));
  nor2   g087(.a(x14), .b(new_n142_), .O(new_n174_));
  nand2  g088(.a(new_n174_), .b(x41), .O(new_n175_));
  aoi21  g089(.a(new_n175_), .b(new_n173_), .c(x10), .O(z29));
  nand2  g090(.a(new_n172_), .b(x41), .O(new_n177_));
  nand2  g091(.a(new_n174_), .b(x42), .O(new_n178_));
  aoi21  g092(.a(new_n178_), .b(new_n177_), .c(x10), .O(z30));
  nand2  g093(.a(new_n172_), .b(x42), .O(new_n180_));
  nand2  g094(.a(new_n174_), .b(x43), .O(new_n181_));
  aoi21  g095(.a(new_n181_), .b(new_n180_), .c(x10), .O(z31));
  nand2  g096(.a(new_n172_), .b(x43), .O(new_n183_));
  nand2  g097(.a(new_n174_), .b(x44), .O(new_n184_));
  aoi21  g098(.a(new_n184_), .b(new_n183_), .c(x10), .O(z32));
  nand2  g099(.a(new_n172_), .b(x44), .O(new_n186_));
  nand2  g100(.a(new_n174_), .b(x45), .O(new_n187_));
  aoi21  g101(.a(new_n187_), .b(new_n186_), .c(x10), .O(z33));
  nand2  g102(.a(new_n172_), .b(x45), .O(new_n189_));
  nand2  g103(.a(new_n174_), .b(x46), .O(new_n190_));
  aoi21  g104(.a(new_n190_), .b(new_n189_), .c(x10), .O(z34));
  nand2  g105(.a(new_n172_), .b(x46), .O(new_n192_));
  nand2  g106(.a(new_n174_), .b(x00), .O(new_n193_));
