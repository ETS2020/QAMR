// Benchmark "FAU" written by ABC on Mon Jul  6 19:23:40 2020
...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n88_, new_n89_, new_n91_, new_n92_,
    ...
    new_n111_, new_n113_, new_n114_, new_n118_, new_n119_, new_n121_,
  ...
  nand2  g087(.a(new_n167_), .b(x43), .O(new_n177_));
  nand2  g088(.a(new_n169_), .b(x44), .O(new_n178_));
  aoi21  g089(.a(new_n178_), .b(new_n177_), .c(x10), .O(z32));
  nand2  g090(.a(new_n167_), .b(x44), .O(new_n180_));
  nand2  g091(.a(new_n169_), .b(x45), .O(new_n181_));
  aoi21  g092(.a(new_n181_), .b(new_n180_), .c(x10), .O(z33));
  nand2  g093(.a(new_n167_), .b(x45), .O(new_n183_));
  nand2  g094(.a(new_n169_), .b(x46), .O(new_n184_));
  aoi21  g095(.a(new_n184_), .b(new_n183_), .c(x10), .O(z34));
  nand2  g096(.a(new_n167_), .b(x46), .O(new_n186_));
  nand2  g097(.a(new_n169_), .b(x00), .O(new_n187_));
