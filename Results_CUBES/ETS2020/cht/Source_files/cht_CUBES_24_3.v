...
module FAU ( 
  ...
  nand2  g099(.a(new_n173_), .b(x43), .O(new_n185_));
  nand2  g100(.a(new_n175_), .b(x44), .O(new_n186_));
  aoi21  g101(.a(new_n186_), .b(new_n185_), .c(x10), .O(z32));
  nand2  g102(.a(new_n173_), .b(x44), .O(new_n188_));
  nand2  g103(.a(new_n175_), .b(x45), .O(new_n189_));
  aoi21  g104(.a(new_n189_), .b(new_n188_), .c(x10), .O(z33));
  nand2  g105(.a(new_n173_), .b(x45), .O(new_n191_));
  nand2  g106(.a(new_n175_), .b(x46), .O(new_n192_));
