// Benchmark "FAU" written by ABC on Mon Jul  6 19:22:38 2020
...
module FAU ( 
  ...
  wire new_n86_, new_n87_, new_n88_, new_n90_, new_n91_, new_n93_, new_n94_,
    ...
    new_n186_, new_n187_;
  nand2  g000(.a(x07), .b(x06), .O(new_n86_));
  inv1   g001(.a(x07), .O(new_n87_));
  nand2  g002(.a(x13), .b(new_n87_), .O(new_n88_));
  aoi21  g003(.a(new_n88_), .b(new_n86_), .c(x10), .O(z02));
  nand2  g004(.a(x07), .b(x01), .O(new_n90_));
  nand2  g005(.a(x14), .b(new_n87_), .O(new_n91_));
  aoi21  g006(.a(new_n91_), .b(new_n90_), .c(x10), .O(z03));
  nand2  g007(.a(x07), .b(x02), .O(new_n93_));
  nand2  g008(.a(x15), .b(new_n87_), .O(new_n94_));
  aoi21  g009(.a(new_n94_), .b(new_n93_), .c(x10), .O(z04));
  nand2  g010(.a(x07), .b(x03), .O(new_n96_));
  nand2  g011(.a(x16), .b(new_n87_), .O(new_n97_));
  ...
  nor2   g078(.a(x14), .b(new_n139_), .O(new_n167_));
  ...
  nand2  g096(.a(new_n165_), .b(x46), .O(new_n186_));
  nand2  g097(.a(new_n167_), .b(x00), .O(new_n187_));
