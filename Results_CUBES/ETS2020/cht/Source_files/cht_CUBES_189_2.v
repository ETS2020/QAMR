...
module FAU ( 
  ...
  nand2  g082(.a(x38), .b(new_n146_), .O(new_n168_));
  aoi21  g083(.a(new_n168_), .b(new_n167_), .c(x10), .O(z27));
  inv1   g084(.a(x14), .O(new_n172_));
  nand2  g085(.a(new_n172_), .b(x09), .O(new_n173_));
  nand2  g086(.a(new_n173_), .b(x41), .O(new_n174_));
  nor2   g087(.a(x14), .b(new_n146_), .O(new_n175_));
  nand2  g088(.a(new_n175_), .b(x42), .O(new_n176_));
  aoi21  g089(.a(new_n176_), .b(new_n174_), .c(x10), .O(z30));
  nand2  g090(.a(new_n173_), .b(x43), .O(new_n179_));
  nand2  g091(.a(new_n175_), .b(x44), .O(new_n180_));
  aoi21  g092(.a(new_n180_), .b(new_n179_), .c(x10), .O(z32));
  nand2  g093(.a(new_n173_), .b(x44), .O(new_n182_));
  nand2  g094(.a(new_n175_), .b(x45), .O(new_n183_));
  aoi21  g095(.a(new_n183_), .b(new_n182_), .c(x10), .O(z33));
  nand2  g096(.a(new_n173_), .b(x45), .O(new_n185_));
  nand2  g097(.a(new_n175_), .b(x46), .O(new_n186_));
  aoi21  g098(.a(new_n186_), .b(new_n185_), .c(x10), .O(z34));
  nand2  g099(.a(new_n173_), .b(x46), .O(new_n188_));
  nand2  g100(.a(new_n175_), .b(x00), .O(new_n189_));
