...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n89_, new_n90_, new_n93_, new_n94_,
    ...
    new_n107_, new_n110_, new_n111_, new_n113_, new_n114_, new_n117_,
    new_n118_, new_n120_, new_n121_, new_n125_, new_n126_, new_n129_,
  ...
  nand2  g42(.a(x35), .b(new_n129_), .O(new_n137_));
  nand2  g43(.a(x36), .b(x09), .O(new_n138_));
  aoi21  g44(.a(new_n138_), .b(new_n137_), .c(x10), .O(z24));
  nand2  g45(.a(x36), .b(new_n129_), .O(new_n140_));
  ...
  nand2  g55(.a(x38), .b(new_n129_), .O(new_n150_));
  ...
  nor2   g60(.a(x14), .b(new_n129_), .O(new_n155_));
  ...
  nand2  g75(.a(new_n153_), .b(x45), .O(new_n171_));
  nand2  g76(.a(new_n155_), .b(x46), .O(new_n172_));
