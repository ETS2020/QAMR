...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n88_, new_n89_, new_n93_, new_n94_,
    new_n97_, new_n98_, new_n99_, new_n104_, new_n105_, new_n110_,
  ...
  nand2  g17(.a(x25), .b(new_n97_), .O(new_n110_));
  ...
  nand2  g42(.a(x36), .b(new_n127_), .O(new_n138_));
