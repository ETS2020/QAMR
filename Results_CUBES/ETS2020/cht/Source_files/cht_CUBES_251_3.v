// Benchmark "FAU" written by ABC on Mon Jul  6 19:24:13 2020
...
module FAU ( 
  ...
  wire new_n85_, new_n86_, new_n87_, new_n89_, new_n90_, new_n92_, new_n93_,
    ...
    new_n123_, new_n126_, new_n127_, new_n130_, new_n131_, new_n133_,
  ...
  nand2  g032(.a(x24), .b(new_n102_), .O(new_n119_));
  nand2  g033(.a(x25), .b(x08), .O(new_n120_));
  aoi21  g034(.a(new_n120_), .b(new_n119_), .c(x10), .O(z13));
  nand2  g035(.a(x25), .b(new_n102_), .O(new_n122_));
