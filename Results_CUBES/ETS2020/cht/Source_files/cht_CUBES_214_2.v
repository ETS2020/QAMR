...
module FAU ( 
  ...
  wire new_n85_, new_n86_, new_n87_, new_n90_, new_n91_, new_n95_, new_n96_,
    new_n97_, new_n101_, new_n102_, new_n104_, new_n105_, new_n108_,
    new_n109_, new_n111_, new_n112_, new_n114_, new_n115_, new_n117_,
    new_n118_, new_n120_, new_n121_, new_n124_, new_n125_, new_n128_,
  ...
  nor2   g63(.a(x14), .b(new_n128_), .O(new_n160_));
  ...
  nand2  g69(.a(new_n158_), .b(x45), .O(new_n167_));
  nand2  g70(.a(new_n160_), .b(x46), .O(new_n168_));
