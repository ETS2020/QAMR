// Benchmark "FAU" written by ABC on Mon Jul  6 19:22:18 2020
...
module FAU ( 
  ...
  nand2  g26(.a(x23), .b(new_n102_), .O(new_n114_));
  nand2  g27(.a(x24), .b(x08), .O(new_n115_));
  aoi21  g28(.a(new_n115_), .b(new_n114_), .c(x10), .O(z12));
  nand2  g29(.a(x24), .b(new_n102_), .O(new_n117_));
  ...
  nand2  g48(.a(x30), .b(new_n102_), .O(new_n136_));
  ...
  nand2  g67(.a(x38), .b(new_n139_), .O(new_n158_));
  ...
  nor2   g72(.a(x14), .b(new_n139_), .O(new_n164_));
  ...
  nand2  g78(.a(new_n162_), .b(x46), .O(new_n174_));
  nand2  g79(.a(new_n164_), .b(x00), .O(new_n175_));
