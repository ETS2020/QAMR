...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n89_, new_n90_, new_n92_, new_n93_,
    ...
    new_n156_, new_n157_, new_n160_, new_n161_, new_n166_, new_n167_;
  ...
  nand2  g23(.a(x24), .b(new_n99_), .O(new_n113_));
  ...
  nor2   g60(.a(x14), .b(new_n132_), .O(new_n156_));
  nand2  g61(.a(new_n156_), .b(x41), .O(new_n157_));
  aoi21  g62(.a(new_n157_), .b(new_n155_), .c(x10), .O(z29));
  nand2  g63(.a(new_n154_), .b(x42), .O(new_n160_));
  nand2  g64(.a(new_n156_), .b(x43), .O(new_n161_));
  aoi21  g65(.a(new_n161_), .b(new_n160_), .c(x10), .O(z31));
  nand2  g66(.a(new_n154_), .b(x46), .O(new_n166_));
  nand2  g67(.a(new_n156_), .b(x00), .O(new_n167_));
