...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n88_, new_n89_, new_n91_, new_n92_,
    ...
    new_n111_, new_n113_, new_n114_, new_n117_, new_n118_, new_n122_,
  ...
  nand2  g060(.a(x36), .b(new_n139_), .O(new_n150_));
  nand2  g061(.a(x37), .b(x09), .O(new_n151_));
  aoi21  g062(.a(new_n151_), .b(new_n150_), .c(x10), .O(z25));
  nand2  g063(.a(x37), .b(new_n139_), .O(new_n153_));
  ...
  nand2  g070(.a(x38), .b(new_n139_), .O(new_n160_));
  ...
  nor2   g075(.a(x14), .b(new_n139_), .O(new_n165_));
