...
module FAU ( 
  ...
  wire new_n85_, new_n86_, new_n87_, new_n89_, new_n90_, new_n92_, new_n93_,
    ...
    new_n151_, new_n152_, new_n154_, new_n155_, new_n159_, new_n160_,
  ...
  nand2  g44(.a(x27), .b(new_n102_), .O(new_n130_));
  ...
  oai21  g76(.a(x14), .b(new_n138_), .c(x41), .O(new_n166_));
  nand3  g77(.a(x42), .b(new_n160_), .c(x09), .O(new_n167_));
  aoi21  g78(.a(new_n167_), .b(new_n166_), .c(x10), .O(z30));
  ...
  oai21  g88(.a(x14), .b(new_n138_), .c(x46), .O(new_n179_));
  nand3  g89(.a(new_n160_), .b(x09), .c(x00), .O(new_n180_));
