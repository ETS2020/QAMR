...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n88_, new_n89_, new_n93_, new_n94_,
    ...
    new_n128_, new_n130_, new_n131_, new_n132_, new_n138_, new_n139_,
  ...
  nand3  g65(.a(new_n147_), .b(x09), .c(x00), .O(new_n164_));
