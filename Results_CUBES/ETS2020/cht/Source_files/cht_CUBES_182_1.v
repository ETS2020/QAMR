...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n88_, new_n89_, new_n95_, new_n96_,
    ...
    new_n117_, new_n120_, new_n121_, new_n125_, new_n126_, new_n128_,
    new_n129_, new_n130_, new_n133_, new_n134_, new_n137_, new_n138_,
  ...
  nand2  g26(.a(x25), .b(new_n95_), .O(new_n116_));
