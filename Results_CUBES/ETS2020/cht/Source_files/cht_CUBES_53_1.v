...
module FAU ( 
  ...
  nand2  g48(.a(x36), .b(new_n133_), .O(new_n142_));
  ...
  inv1   g57(.a(x14), .O(new_n154_));
  nand2  g58(.a(new_n154_), .b(x09), .O(new_n155_));
  nand2  g59(.a(new_n155_), .b(x41), .O(new_n156_));
  nor2   g60(.a(x14), .b(new_n133_), .O(new_n157_));
  nand2  g61(.a(new_n157_), .b(x42), .O(new_n158_));
  aoi21  g62(.a(new_n158_), .b(new_n156_), .c(x10), .O(z30));
  nand2  g63(.a(new_n155_), .b(x42), .O(new_n160_));
  nand2  g64(.a(new_n157_), .b(x43), .O(new_n161_));
  aoi21  g65(.a(new_n161_), .b(new_n160_), .c(x10), .O(z31));
  nand2  g66(.a(new_n155_), .b(x43), .O(new_n163_));
  nand2  g67(.a(new_n157_), .b(x44), .O(new_n164_));
  aoi21  g68(.a(new_n164_), .b(new_n163_), .c(x10), .O(z32));
  nand2  g69(.a(new_n155_), .b(x44), .O(new_n166_));
  nand2  g70(.a(new_n157_), .b(x45), .O(new_n167_));
