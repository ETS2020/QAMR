...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n88_, new_n89_, new_n91_, new_n92_,
    ...
    new_n155_, new_n157_, new_n158_, new_n161_, new_n162_, new_n165_,
  ...
  oai21  g64(.a(x14), .b(new_n136_), .c(x40), .O(new_n157_));
  ...
  nand3  g71(.a(x45), .b(new_n154_), .c(x09), .O(new_n166_));
  aoi21  g72(.a(new_n166_), .b(new_n165_), .c(x10), .O(z33));
  oai21  g73(.a(x14), .b(new_n136_), .c(x45), .O(new_n168_));
  nand3  g74(.a(x46), .b(new_n154_), .c(x09), .O(new_n169_));
