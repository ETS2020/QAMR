...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n88_, new_n89_, new_n92_, new_n93_,
    ...
    new_n104_, new_n106_, new_n107_, new_n112_, new_n113_, new_n115_,
    ...
    new_n163_, new_n164_, new_n170_, new_n171_;
  ...
  nand2  g29(.a(x25), .b(new_n99_), .O(new_n118_));
  ...
  nand2  g72(.a(new_n158_), .b(x46), .O(new_n170_));
  nand2  g73(.a(new_n160_), .b(x00), .O(new_n171_));
