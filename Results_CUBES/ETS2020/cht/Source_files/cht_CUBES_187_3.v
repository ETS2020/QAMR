...
module FAU ( 
  ...
  nand2  g102(.a(new_n175_), .b(x44), .O(new_n188_));
  nand2  g103(.a(new_n177_), .b(x45), .O(new_n189_));
  aoi21  g104(.a(new_n189_), .b(new_n188_), .c(x10), .O(z33));
  nand2  g105(.a(new_n175_), .b(x45), .O(new_n191_));
  nand2  g106(.a(new_n177_), .b(x46), .O(new_n192_));
  aoi21  g107(.a(new_n192_), .b(new_n191_), .c(x10), .O(z34));
  nand2  g108(.a(new_n175_), .b(x46), .O(new_n194_));
  nand2  g109(.a(new_n177_), .b(x00), .O(new_n195_));
