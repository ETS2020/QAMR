// Benchmark "FAU" written by ABC on Mon Jul  6 19:23:00 2020
...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n88_, new_n89_, new_n91_, new_n92_,
    ...
    new_n159_, new_n160_, new_n163_, new_n164_, new_n165_, new_n169_,
  ...
  nand3  g80(.a(x43), .b(new_n164_), .c(x09), .O(new_n170_));
  aoi21  g81(.a(new_n170_), .b(new_n169_), .c(x10), .O(z31));
  oai21  g82(.a(x14), .b(new_n142_), .c(x43), .O(new_n172_));
  nand3  g83(.a(x44), .b(new_n164_), .c(x09), .O(new_n173_));
  aoi21  g84(.a(new_n173_), .b(new_n172_), .c(x10), .O(z32));
  oai21  g85(.a(x14), .b(new_n142_), .c(x44), .O(new_n175_));
  nand3  g86(.a(x45), .b(new_n164_), .c(x09), .O(new_n176_));
  aoi21  g87(.a(new_n176_), .b(new_n175_), .c(x10), .O(z33));
  oai21  g88(.a(x14), .b(new_n142_), .c(x45), .O(new_n178_));
  nand3  g89(.a(x46), .b(new_n164_), .c(x09), .O(new_n179_));
