...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n88_, new_n89_, new_n92_, new_n93_,
    ...
    new_n154_, new_n155_, new_n156_, new_n165_, new_n166_, new_n167_;
  ...
  oai21  g66(.a(x14), .b(new_n134_), .c(x46), .O(new_n165_));
  inv1   g67(.a(x14), .O(new_n166_));
  nand3  g68(.a(new_n166_), .b(x09), .c(x00), .O(new_n167_));
  aoi21  g69(.a(new_n167_), .b(new_n165_), .c(x10), .O(z35));
  zero   g70(.O(z02));
  zero   g71(.O(z05));
  zero   g72(.O(z06));
  zero   g73(.O(z15));
