...
module FAU ( 
  ...
  nand2  g008(.a(x15), .b(new_n85_), .O(new_n94_));
  ...
  nand2  g066(.a(x37), .b(new_n140_), .O(new_n155_));
  ...
  nor2   g078(.a(x14), .b(new_n140_), .O(new_n167_));
