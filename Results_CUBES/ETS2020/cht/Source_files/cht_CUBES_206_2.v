...
module FAU ( 
  ...
  inv1   g63(.a(x14), .O(new_n159_));
  nand2  g64(.a(new_n159_), .b(x09), .O(new_n160_));
  nand2  g65(.a(new_n160_), .b(x42), .O(new_n161_));
  nor2   g66(.a(x14), .b(new_n140_), .O(new_n162_));
  nand2  g67(.a(new_n162_), .b(x43), .O(new_n163_));
  aoi21  g68(.a(new_n163_), .b(new_n161_), .c(x10), .O(z31));
  nand2  g69(.a(new_n160_), .b(x43), .O(new_n165_));
  nand2  g70(.a(new_n162_), .b(x44), .O(new_n166_));
  ...
  nand2  g75(.a(new_n160_), .b(x46), .O(new_n172_));
  nand2  g76(.a(new_n162_), .b(x00), .O(new_n173_));
