// Benchmark "FAU" written by ABC on Mon Jul  6 19:21:56 2020
...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n88_, new_n89_, new_n91_, new_n92_,
    ...
    new_n148_, new_n149_, new_n152_, new_n153_, new_n156_, new_n157_,
  ...
  nand2  g069(.a(x36), .b(new_n144_), .O(new_n156_));
  nand2  g070(.a(x37), .b(x09), .O(new_n157_));
  aoi21  g071(.a(new_n157_), .b(new_n156_), .c(x10), .O(z25));
  nand2  g072(.a(x37), .b(new_n144_), .O(new_n159_));
  ...
  nand2  g079(.a(x38), .b(new_n144_), .O(new_n166_));
  ...
  nor2   g084(.a(x14), .b(new_n144_), .O(new_n171_));
