...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n88_, new_n89_, new_n91_, new_n92_,
    ...
    new_n167_, new_n168_, new_n171_, new_n172_, new_n176_, new_n177_,
  ...
  nand2  g084(.a(new_n165_), .b(x44), .O(new_n176_));
  nand2  g085(.a(new_n167_), .b(x45), .O(new_n177_));
  aoi21  g086(.a(new_n177_), .b(new_n176_), .c(x10), .O(z33));
  nand2  g087(.a(new_n165_), .b(x45), .O(new_n179_));
  nand2  g088(.a(new_n167_), .b(x46), .O(new_n180_));
  aoi21  g089(.a(new_n180_), .b(new_n179_), .c(x10), .O(z34));
  nand2  g090(.a(new_n165_), .b(x46), .O(new_n182_));
  nand2  g091(.a(new_n167_), .b(x00), .O(new_n183_));
