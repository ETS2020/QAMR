// Benchmark "FAU" written by ABC on Mon Jul  6 19:23:34 2020
...
module FAU ( 
  ...
  nand2  g69(.a(x35), .b(new_n144_), .O(new_n155_));
  ...
  oai21  g91(.a(x14), .b(new_n144_), .c(x44), .O(new_n179_));
  nand3  g92(.a(x45), .b(new_n166_), .c(x09), .O(new_n180_));
  aoi21  g93(.a(new_n180_), .b(new_n179_), .c(x10), .O(z33));
  zero   g94(.O(z01));
  zero   g95(.O(z21));
  zero   g96(.O(z27));
  zero   g97(.O(z30));
