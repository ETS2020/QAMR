...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n88_, new_n89_, new_n93_, new_n94_,
    new_n96_, new_n97_, new_n99_, new_n100_, new_n101_, new_n105_,
    ...
    new_n134_, new_n142_, new_n143_, new_n144_, new_n146_, new_n147_,
  ...
  inv1   g47(.a(x09), .O(new_n142_));
  nand2  g48(.a(x37), .b(new_n142_), .O(new_n143_));
  ...
  nand2  g55(.a(x38), .b(new_n142_), .O(new_n150_));
  ...
  nor2   g60(.a(x14), .b(new_n142_), .O(new_n156_));
