...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16, z17, z18, z19, z20, z21, z22, z23, z24, z25, z26, z27,
    z28, z29, z30, z31, z32, z33, z34, z35;
  wire new_n88_, new_n89_, new_n90_, new_n92_, new_n93_, new_n95_, new_n96_,
  ...
  nand2  g00(.a(x07), .b(x02), .O(new_n88_));
  inv1   g01(.a(x07), .O(new_n89_));
  nand2  g02(.a(x15), .b(new_n89_), .O(new_n90_));
  aoi21  g03(.a(new_n90_), .b(new_n88_), .c(x10), .O(z04));
  nand2  g04(.a(x07), .b(x03), .O(new_n92_));
  nand2  g05(.a(x16), .b(new_n89_), .O(new_n93_));
  ...
  nand2  g58(.a(x38), .b(new_n133_), .O(new_n152_));
  ...
  nor2   g63(.a(x14), .b(new_n133_), .O(new_n157_));
  ...
  nand2  g78(.a(new_n155_), .b(x45), .O(new_n173_));
  nand2  g79(.a(new_n157_), .b(x46), .O(new_n174_));
  aoi21  g80(.a(new_n174_), .b(new_n173_), .c(x10), .O(z34));
  nand2  g81(.a(new_n155_), .b(x46), .O(new_n176_));
  nand2  g82(.a(new_n157_), .b(x00), .O(new_n177_));
