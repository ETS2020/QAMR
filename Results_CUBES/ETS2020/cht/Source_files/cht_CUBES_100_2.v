// Benchmark "FAU" written by ABC on Mon Jul  6 19:22:48 2020
...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n89_, new_n90_, new_n92_, new_n93_,
    ...
    new_n132_, new_n137_, new_n138_, new_n139_, new_n142_, new_n143_,
  ...
  nand2  g60(.a(x37), .b(new_n137_), .O(new_n151_));
  ...
  nor2   g72(.a(x14), .b(new_n137_), .O(new_n164_));
