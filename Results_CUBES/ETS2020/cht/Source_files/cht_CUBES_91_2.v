// Benchmark "FAU" written by ABC on Mon Jul  6 19:22:42 2020
...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n88_, new_n89_, new_n91_, new_n92_,
    ...
    new_n134_, new_n137_, new_n138_, new_n139_, new_n143_, new_n144_,
  ...
  nand2  g51(.a(x35), .b(new_n137_), .O(new_n143_));
  ...
  nand2  g61(.a(x38), .b(new_n137_), .O(new_n154_));
  ...
  nor2   g66(.a(x14), .b(new_n137_), .O(new_n161_));
  ...
  nand2  g78(.a(new_n159_), .b(x45), .O(new_n173_));
  nand2  g79(.a(new_n161_), .b(x46), .O(new_n174_));
  aoi21  g80(.a(new_n174_), .b(new_n173_), .c(x10), .O(z34));
  nand2  g81(.a(new_n159_), .b(x46), .O(new_n176_));
  nand2  g82(.a(new_n161_), .b(x00), .O(new_n177_));
