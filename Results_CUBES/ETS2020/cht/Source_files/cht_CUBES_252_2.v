...
module FAU ( 
  ...
  inv1   g60(.a(x14), .O(new_n157_));
  nand2  g61(.a(new_n157_), .b(x09), .O(new_n158_));
  nand2  g62(.a(new_n158_), .b(x42), .O(new_n159_));
  nor2   g63(.a(x14), .b(new_n132_), .O(new_n160_));
  nand2  g64(.a(new_n160_), .b(x43), .O(new_n161_));
  aoi21  g65(.a(new_n161_), .b(new_n159_), .c(x10), .O(z31));
  nand2  g66(.a(new_n158_), .b(x43), .O(new_n163_));
  nand2  g67(.a(new_n160_), .b(x44), .O(new_n164_));
  aoi21  g68(.a(new_n164_), .b(new_n163_), .c(x10), .O(z32));
  nand2  g69(.a(new_n158_), .b(x44), .O(new_n166_));
  nand2  g70(.a(new_n160_), .b(x45), .O(new_n167_));
