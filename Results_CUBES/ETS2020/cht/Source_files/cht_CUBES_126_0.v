...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n89_, new_n90_, new_n93_, new_n94_,
    new_n96_, new_n97_, new_n99_, new_n100_, new_n101_, new_n107_,
    new_n108_, new_n111_, new_n112_, new_n115_, new_n116_, new_n119_,
  ...
  nand2  g66(.a(new_n153_), .b(x42), .O(new_n162_));
  nand2  g67(.a(new_n155_), .b(x43), .O(new_n163_));
