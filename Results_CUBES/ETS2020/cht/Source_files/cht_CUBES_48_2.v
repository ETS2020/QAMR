...
module FAU ( 
  ...
  inv1   g75(.a(x14), .O(new_n166_));
  nand2  g76(.a(new_n166_), .b(x09), .O(new_n167_));
  nand2  g77(.a(new_n167_), .b(x41), .O(new_n168_));
  nor2   g78(.a(x14), .b(new_n140_), .O(new_n169_));
  nand2  g79(.a(new_n169_), .b(x42), .O(new_n170_));
  aoi21  g80(.a(new_n170_), .b(new_n168_), .c(x10), .O(z30));
  nand2  g81(.a(new_n167_), .b(x44), .O(new_n174_));
  nand2  g82(.a(new_n169_), .b(x45), .O(new_n175_));
  aoi21  g83(.a(new_n175_), .b(new_n174_), .c(x10), .O(z33));
  nand2  g84(.a(new_n167_), .b(x45), .O(new_n177_));
  nand2  g85(.a(new_n169_), .b(x46), .O(new_n178_));
  aoi21  g86(.a(new_n178_), .b(new_n177_), .c(x10), .O(z34));
  nand2  g87(.a(new_n167_), .b(x46), .O(new_n180_));
  nand2  g88(.a(new_n169_), .b(x00), .O(new_n181_));
