...
module FAU ( 
  ...
  nand2  g35(.a(x27), .b(new_n100_), .O(new_n124_));
  nand2  g36(.a(x28), .b(x08), .O(new_n125_));
  aoi21  g37(.a(new_n125_), .b(new_n124_), .c(x10), .O(z16));
  nand2  g38(.a(x28), .b(new_n100_), .O(new_n127_));
  ...
  nand2  g63(.a(x37), .b(new_n134_), .O(new_n153_));
  ...
  nand2  g70(.a(x38), .b(new_n134_), .O(new_n160_));
  aoi21  g71(.a(new_n160_), .b(new_n159_), .c(x10), .O(z27));
  inv1   g72(.a(x14), .O(new_n163_));
  nand2  g73(.a(new_n163_), .b(x09), .O(new_n164_));
  nand2  g74(.a(new_n164_), .b(x40), .O(new_n165_));
  nor2   g75(.a(x14), .b(new_n134_), .O(new_n166_));
  nand2  g76(.a(new_n166_), .b(x41), .O(new_n167_));
  aoi21  g77(.a(new_n167_), .b(new_n165_), .c(x10), .O(z29));
  nand2  g78(.a(new_n164_), .b(x41), .O(new_n169_));
  nand2  g79(.a(new_n166_), .b(x42), .O(new_n170_));
  aoi21  g80(.a(new_n170_), .b(new_n169_), .c(x10), .O(z30));
  nand2  g81(.a(new_n164_), .b(x43), .O(new_n173_));
  nand2  g82(.a(new_n166_), .b(x44), .O(new_n174_));
  aoi21  g83(.a(new_n174_), .b(new_n173_), .c(x10), .O(z32));
  nand2  g84(.a(new_n164_), .b(x45), .O(new_n177_));
  nand2  g85(.a(new_n166_), .b(x46), .O(new_n178_));
  aoi21  g86(.a(new_n178_), .b(new_n177_), .c(x10), .O(z34));
  nand2  g87(.a(new_n164_), .b(x46), .O(new_n180_));
  nand2  g88(.a(new_n166_), .b(x00), .O(new_n181_));
