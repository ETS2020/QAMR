// Benchmark "FAU" written by ABC on Mon Jul  6 19:23:47 2020
...
module FAU ( 
  ...
  wire new_n85_, new_n86_, new_n87_, new_n90_, new_n91_, new_n94_, new_n95_,
    ...
    new_n106_, new_n108_, new_n109_, new_n112_, new_n113_, new_n116_,
  ...
  nand2  g20(.a(x21), .b(new_n98_), .O(new_n108_));
  ...
  nand2  g45(.a(x34), .b(new_n132_), .O(new_n138_));
  ...
  nand2  g69(.a(new_n156_), .b(x43), .O(new_n165_));
  nand2  g70(.a(new_n158_), .b(x44), .O(new_n166_));
  aoi21  g71(.a(new_n166_), .b(new_n165_), .c(x10), .O(z32));
  nand2  g72(.a(new_n156_), .b(x46), .O(new_n170_));
  nand2  g73(.a(new_n158_), .b(x00), .O(new_n171_));
