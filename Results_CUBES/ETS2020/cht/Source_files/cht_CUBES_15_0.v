...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n88_, new_n89_, new_n91_, new_n92_,
    ...
    new_n171_, new_n172_, new_n175_, new_n176_;
  ...
  nand2  g75(.a(new_n161_), .b(x42), .O(new_n168_));
  nand2  g76(.a(new_n163_), .b(x43), .O(new_n169_));
  aoi21  g77(.a(new_n169_), .b(new_n168_), .c(x10), .O(z31));
  nand2  g78(.a(new_n161_), .b(x43), .O(new_n171_));
  nand2  g79(.a(new_n163_), .b(x44), .O(new_n172_));
  aoi21  g80(.a(new_n172_), .b(new_n171_), .c(x10), .O(z32));
  nand2  g81(.a(new_n161_), .b(x45), .O(new_n175_));
  nand2  g82(.a(new_n163_), .b(x46), .O(new_n176_));
