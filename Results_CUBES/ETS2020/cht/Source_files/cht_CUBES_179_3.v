...
module FAU ( 
  ...
  inv1   g72(.a(x14), .O(new_n164_));
  nand2  g73(.a(new_n164_), .b(x09), .O(new_n165_));
  nand2  g74(.a(new_n165_), .b(x41), .O(new_n166_));
  nor2   g75(.a(x14), .b(new_n136_), .O(new_n167_));
  nand2  g76(.a(new_n167_), .b(x42), .O(new_n168_));
  aoi21  g77(.a(new_n168_), .b(new_n166_), .c(x10), .O(z30));
  nand2  g78(.a(new_n165_), .b(x43), .O(new_n171_));
  nand2  g79(.a(new_n167_), .b(x44), .O(new_n172_));
  aoi21  g80(.a(new_n172_), .b(new_n171_), .c(x10), .O(z32));
  nand2  g81(.a(new_n165_), .b(x44), .O(new_n174_));
  nand2  g82(.a(new_n167_), .b(x45), .O(new_n175_));
  aoi21  g83(.a(new_n175_), .b(new_n174_), .c(x10), .O(z33));
  nand2  g84(.a(new_n165_), .b(x45), .O(new_n177_));
  nand2  g85(.a(new_n167_), .b(x46), .O(new_n178_));
  aoi21  g86(.a(new_n178_), .b(new_n177_), .c(x10), .O(z34));
  nand2  g87(.a(new_n165_), .b(x46), .O(new_n180_));
  nand2  g88(.a(new_n167_), .b(x00), .O(new_n181_));
