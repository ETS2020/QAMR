...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n88_, new_n89_, new_n91_, new_n92_,
    ...
    new_n104_, new_n106_, new_n107_, new_n109_, new_n110_, new_n114_,
  ...
  nand2  g26(.a(x23), .b(new_n99_), .O(new_n114_));
  ...
  nand2  g41(.a(x28), .b(new_n99_), .O(new_n129_));
  ...
  nand2  g57(.a(x35), .b(new_n137_), .O(new_n147_));
  nand2  g58(.a(x36), .b(x09), .O(new_n148_));
  aoi21  g59(.a(new_n148_), .b(new_n147_), .c(x10), .O(z24));
  nand2  g60(.a(x36), .b(new_n137_), .O(new_n150_));
  ...
  nand2  g67(.a(x38), .b(new_n137_), .O(new_n158_));
  ...
  nor2   g72(.a(x14), .b(new_n137_), .O(new_n163_));
  nand2  g73(.a(new_n163_), .b(x40), .O(new_n164_));
  aoi21  g74(.a(new_n164_), .b(new_n162_), .c(x10), .O(z28));
  nand2  g75(.a(new_n161_), .b(x41), .O(new_n167_));
  nand2  g76(.a(new_n163_), .b(x42), .O(new_n168_));
  aoi21  g77(.a(new_n168_), .b(new_n167_), .c(x10), .O(z30));
  nand2  g78(.a(new_n161_), .b(x42), .O(new_n170_));
  nand2  g79(.a(new_n163_), .b(x43), .O(new_n171_));
  aoi21  g80(.a(new_n171_), .b(new_n170_), .c(x10), .O(z31));
  nand2  g81(.a(new_n161_), .b(x43), .O(new_n173_));
  nand2  g82(.a(new_n163_), .b(x44), .O(new_n174_));
  aoi21  g83(.a(new_n174_), .b(new_n173_), .c(x10), .O(z32));
  nand2  g84(.a(new_n161_), .b(x44), .O(new_n176_));
  nand2  g85(.a(new_n163_), .b(x45), .O(new_n177_));
  aoi21  g86(.a(new_n177_), .b(new_n176_), .c(x10), .O(z33));
  nand2  g87(.a(new_n161_), .b(x46), .O(new_n180_));
  nand2  g88(.a(new_n163_), .b(x00), .O(new_n181_));
