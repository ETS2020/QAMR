// Benchmark "FAU" written by ABC on Mon Jul  6 19:23:42 2020
...
module FAU ( 
  ...
  inv1   g56(.a(x09), .O(new_n144_));
  nand2  g57(.a(x33), .b(new_n144_), .O(new_n145_));
  nand2  g58(.a(x34), .b(x09), .O(new_n146_));
  aoi21  g59(.a(new_n146_), .b(new_n145_), .c(x10), .O(z22));
  nand2  g60(.a(x36), .b(new_n144_), .O(new_n150_));
  ...
  nand2  g67(.a(x38), .b(new_n144_), .O(new_n158_));
  ...
  nor2   g72(.a(x14), .b(new_n144_), .O(new_n164_));
  ...
  nand2  g81(.a(new_n162_), .b(x46), .O(new_n176_));
  nand2  g82(.a(new_n164_), .b(x00), .O(new_n177_));
