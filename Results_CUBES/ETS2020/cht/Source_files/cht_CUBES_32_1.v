// Benchmark "FAU" written by ABC on Mon Jul  6 19:22:08 2020
...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n88_, new_n89_, new_n91_, new_n92_,
    ...
    new_n115_, new_n117_, new_n118_, new_n123_, new_n124_, new_n127_,
  ...
  nand2  g36(.a(x30), .b(new_n103_), .O(new_n128_));
  ...
  nor2   g57(.a(x14), .b(new_n130_), .O(new_n153_));
  ...
  nand2  g69(.a(new_n151_), .b(x44), .O(new_n166_));
  nand2  g70(.a(new_n153_), .b(x45), .O(new_n167_));
