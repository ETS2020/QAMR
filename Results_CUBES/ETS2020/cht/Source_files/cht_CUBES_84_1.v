...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n88_, new_n89_, new_n93_, new_n94_,
    new_n97_, new_n98_, new_n99_, new_n101_, new_n102_, new_n105_,
    ...
    new_n137_, new_n138_, new_n142_, new_n143_, new_n145_, new_n146_,
  ...
  nand2  g48(.a(x36), .b(new_n130_), .O(new_n142_));
  nand2  g49(.a(x37), .b(x09), .O(new_n143_));
  aoi21  g50(.a(new_n143_), .b(new_n142_), .c(x10), .O(z25));
  nand2  g51(.a(x37), .b(new_n130_), .O(new_n145_));
  ...
  nand2  g58(.a(x38), .b(new_n130_), .O(new_n152_));
  ...
  nor2   g63(.a(x14), .b(new_n130_), .O(new_n157_));
