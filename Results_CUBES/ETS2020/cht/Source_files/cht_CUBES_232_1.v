...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n92_, new_n93_, new_n95_, new_n96_,
    new_n97_, new_n101_, new_n102_, new_n106_, new_n107_, new_n109_,
  ...
  nand2  g11(.a(x20), .b(new_n95_), .O(new_n101_));
  ...
  nand2  g30(.a(x30), .b(new_n95_), .O(new_n124_));
