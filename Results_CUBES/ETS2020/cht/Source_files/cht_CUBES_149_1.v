...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n89_, new_n90_, new_n95_, new_n96_,
    ...
    new_n108_, new_n112_, new_n113_, new_n116_, new_n117_, new_n120_,
    ...
    new_n149_, new_n151_, new_n152_, new_n155_, new_n156_, new_n159_,
  ...
  nand2  g26(.a(x29), .b(new_n95_), .O(new_n120_));
  ...
  oai21  g58(.a(x14), .b(new_n126_), .c(x42), .O(new_n155_));
  ...
  nand3  g62(.a(x45), .b(new_n148_), .c(x09), .O(new_n160_));
