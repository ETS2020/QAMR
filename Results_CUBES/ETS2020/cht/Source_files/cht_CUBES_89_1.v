...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n88_, new_n89_, new_n91_, new_n92_,
    ...
    new_n135_, new_n136_, new_n139_, new_n140_, new_n144_, new_n145_,
  ...
  nand2  g48(.a(x33), .b(new_n134_), .O(new_n139_));
  ...
  nor2   g66(.a(x14), .b(new_n134_), .O(new_n160_));
  nand2  g67(.a(new_n160_), .b(x41), .O(new_n161_));
  aoi21  g68(.a(new_n161_), .b(new_n159_), .c(x10), .O(z29));
  nand2  g69(.a(new_n158_), .b(x41), .O(new_n163_));
  nand2  g70(.a(new_n160_), .b(x42), .O(new_n164_));
  aoi21  g71(.a(new_n164_), .b(new_n163_), .c(x10), .O(z30));
  nand2  g72(.a(new_n158_), .b(x42), .O(new_n166_));
  nand2  g73(.a(new_n160_), .b(x43), .O(new_n167_));
  ...
  nand2  g78(.a(new_n158_), .b(x46), .O(new_n174_));
  nand2  g79(.a(new_n160_), .b(x00), .O(new_n175_));
