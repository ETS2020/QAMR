...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n88_, new_n89_, new_n91_, new_n92_,
    ...
    new_n132_, new_n134_, new_n135_, new_n140_, new_n141_, new_n142_,
  ...
  nand2  g44(.a(x28), .b(new_n104_), .O(new_n131_));
  nand2  g45(.a(x29), .b(x08), .O(new_n132_));
  aoi21  g46(.a(new_n132_), .b(new_n131_), .c(x10), .O(z17));
  nand2  g47(.a(x29), .b(new_n104_), .O(new_n134_));
  ...
  nand2  g67(.a(x38), .b(new_n140_), .O(new_n158_));
  ...
  nor2   g72(.a(x14), .b(new_n140_), .O(new_n164_));
  ...
  nand2  g78(.a(new_n162_), .b(x42), .O(new_n170_));
  nand2  g79(.a(new_n164_), .b(x43), .O(new_n171_));
  aoi21  g80(.a(new_n171_), .b(new_n170_), .c(x10), .O(z31));
  nand2  g81(.a(new_n162_), .b(x43), .O(new_n173_));
  nand2  g82(.a(new_n164_), .b(x44), .O(new_n174_));
