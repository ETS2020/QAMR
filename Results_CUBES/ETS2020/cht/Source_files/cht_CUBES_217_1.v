...
module FAU ( 
  ...
  wire new_n85_, new_n86_, new_n87_, new_n92_, new_n93_, new_n95_, new_n96_,
    new_n97_, new_n103_, new_n104_, new_n106_, new_n107_, new_n110_,
    new_n111_, new_n113_, new_n114_, new_n117_, new_n118_, new_n121_,
    new_n122_, new_n126_, new_n127_, new_n128_, new_n130_, new_n131_,
  ...
  nand2  g11(.a(x22), .b(new_n95_), .O(new_n103_));
  ...
  nand2  g17(.a(x25), .b(new_n95_), .O(new_n110_));
  ...
  nand2  g33(.a(x34), .b(new_n126_), .O(new_n130_));
  nand2  g34(.a(x35), .b(x09), .O(new_n131_));
  aoi21  g35(.a(new_n131_), .b(new_n130_), .c(x10), .O(z23));
  nand2  g36(.a(x36), .b(new_n126_), .O(new_n134_));
  ...
  inv1   g45(.a(x14), .O(new_n146_));
  nand2  g46(.a(new_n146_), .b(x09), .O(new_n147_));
  nand2  g47(.a(new_n147_), .b(x41), .O(new_n148_));
  nor2   g48(.a(x14), .b(new_n126_), .O(new_n149_));
  nand2  g49(.a(new_n149_), .b(x42), .O(new_n150_));
  aoi21  g50(.a(new_n150_), .b(new_n148_), .c(x10), .O(z30));
  nand2  g51(.a(new_n147_), .b(x42), .O(new_n152_));
  nand2  g52(.a(new_n149_), .b(x43), .O(new_n153_));
  aoi21  g53(.a(new_n153_), .b(new_n152_), .c(x10), .O(z31));
  nand2  g54(.a(new_n147_), .b(x43), .O(new_n155_));
  nand2  g55(.a(new_n149_), .b(x44), .O(new_n156_));
  aoi21  g56(.a(new_n156_), .b(new_n155_), .c(x10), .O(z32));
  nand2  g57(.a(new_n147_), .b(x44), .O(new_n158_));
  nand2  g58(.a(new_n149_), .b(x45), .O(new_n159_));
  aoi21  g59(.a(new_n159_), .b(new_n158_), .c(x10), .O(z33));
  nand2  g60(.a(new_n147_), .b(x45), .O(new_n161_));
  nand2  g61(.a(new_n149_), .b(x46), .O(new_n162_));
  aoi21  g62(.a(new_n162_), .b(new_n161_), .c(x10), .O(z34));
  nand2  g63(.a(new_n147_), .b(x46), .O(new_n164_));
  nand2  g64(.a(new_n149_), .b(x00), .O(new_n165_));
