...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n89_, new_n90_, new_n92_, new_n93_,
    new_n96_, new_n97_, new_n100_, new_n101_, new_n102_, new_n106_,
    new_n107_, new_n109_, new_n110_, new_n112_, new_n113_, new_n117_,
  ...
  nand2  g26(.a(x26), .b(new_n100_), .O(new_n117_));
  ...
  nand2  g36(.a(x30), .b(new_n100_), .O(new_n128_));
