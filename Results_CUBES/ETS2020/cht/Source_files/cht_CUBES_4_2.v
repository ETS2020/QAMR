...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n88_, new_n89_, new_n91_, new_n92_,
    ...
    new_n163_, new_n164_, new_n165_, new_n166_, new_n170_, new_n171_,
    new_n174_, new_n175_;
  ...
  inv1   g69(.a(x14), .O(new_n162_));
  nand2  g70(.a(new_n162_), .b(x09), .O(new_n163_));
  nand2  g71(.a(new_n163_), .b(x41), .O(new_n164_));
  nor2   g72(.a(x14), .b(new_n137_), .O(new_n165_));
  nand2  g73(.a(new_n165_), .b(x42), .O(new_n166_));
  aoi21  g74(.a(new_n166_), .b(new_n164_), .c(x10), .O(z30));
  nand2  g75(.a(new_n163_), .b(x44), .O(new_n170_));
  nand2  g76(.a(new_n165_), .b(x45), .O(new_n171_));
  aoi21  g77(.a(new_n171_), .b(new_n170_), .c(x10), .O(z33));
  nand2  g78(.a(new_n163_), .b(x46), .O(new_n174_));
  nand2  g79(.a(new_n165_), .b(x00), .O(new_n175_));
