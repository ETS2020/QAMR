...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n88_, new_n89_, new_n93_, new_n94_,
    ...
    new_n123_, new_n126_, new_n127_, new_n130_, new_n131_, new_n135_,
    new_n136_, new_n137_, new_n139_, new_n140_, new_n142_, new_n143_,
    new_n145_, new_n146_, new_n148_, new_n149_, new_n155_, new_n156_,
  ...
  oai21  g60(.a(x14), .b(new_n135_), .c(x41), .O(new_n155_));
  ...
  oai21  g67(.a(x14), .b(new_n135_), .c(x43), .O(new_n162_));
  ...
  nand3  g71(.a(x46), .b(new_n156_), .c(x09), .O(new_n167_));
  aoi21  g72(.a(new_n167_), .b(new_n166_), .c(x10), .O(z34));
  oai21  g73(.a(x14), .b(new_n135_), .c(x46), .O(new_n169_));
  nand3  g74(.a(new_n156_), .b(x09), .c(x00), .O(new_n170_));
