...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n88_, new_n89_, new_n93_, new_n94_,
    new_n96_, new_n97_, new_n101_, new_n102_, new_n103_, new_n105_,
    ...
    new_n136_, new_n137_, new_n140_, new_n141_, new_n145_, new_n146_,
  ...
  inv1   g13(.a(x08), .O(new_n101_));
  nand2  g14(.a(x19), .b(new_n101_), .O(new_n102_));
  nand2  g15(.a(x20), .b(x08), .O(new_n103_));
  aoi21  g16(.a(new_n103_), .b(new_n102_), .c(x10), .O(z08));
  nand2  g17(.a(x20), .b(new_n101_), .O(new_n105_));
  ...
  oai21  g54(.a(x14), .b(new_n135_), .c(x40), .O(new_n150_));
  inv1   g55(.a(x14), .O(new_n151_));
  nand3  g56(.a(x41), .b(new_n151_), .c(x09), .O(new_n152_));
  aoi21  g57(.a(new_n152_), .b(new_n150_), .c(x10), .O(z29));
  oai21  g58(.a(x14), .b(new_n135_), .c(x41), .O(new_n154_));
  nand3  g59(.a(x42), .b(new_n151_), .c(x09), .O(new_n155_));
  aoi21  g60(.a(new_n155_), .b(new_n154_), .c(x10), .O(z30));
  oai21  g61(.a(x14), .b(new_n135_), .c(x42), .O(new_n157_));
  nand3  g62(.a(x43), .b(new_n151_), .c(x09), .O(new_n158_));
  aoi21  g63(.a(new_n158_), .b(new_n157_), .c(x10), .O(z31));
  oai21  g64(.a(x14), .b(new_n135_), .c(x43), .O(new_n160_));
  nand3  g65(.a(x44), .b(new_n151_), .c(x09), .O(new_n161_));
  aoi21  g66(.a(new_n161_), .b(new_n160_), .c(x10), .O(z32));
  oai21  g67(.a(x14), .b(new_n135_), .c(x44), .O(new_n163_));
  nand3  g68(.a(x45), .b(new_n151_), .c(x09), .O(new_n164_));
  aoi21  g69(.a(new_n164_), .b(new_n163_), .c(x10), .O(z33));
  oai21  g70(.a(x14), .b(new_n135_), .c(x45), .O(new_n166_));
  nand3  g71(.a(x46), .b(new_n151_), .c(x09), .O(new_n167_));
  aoi21  g72(.a(new_n167_), .b(new_n166_), .c(x10), .O(z34));
  oai21  g73(.a(x14), .b(new_n135_), .c(x46), .O(new_n169_));
  nand3  g74(.a(new_n151_), .b(x09), .c(x00), .O(new_n170_));
