// Benchmark "FAU" written by ABC on Mon Jul  6 19:22:36 2020
...
module FAU ( 
  ...
  nor2   g078(.a(x14), .b(new_n138_), .O(new_n168_));
  ...
  nand2  g084(.a(new_n166_), .b(x42), .O(new_n174_));
  nand2  g085(.a(new_n168_), .b(x43), .O(new_n175_));
  aoi21  g086(.a(new_n175_), .b(new_n174_), .c(x10), .O(z31));
  nand2  g087(.a(new_n166_), .b(x43), .O(new_n177_));
  nand2  g088(.a(new_n168_), .b(x44), .O(new_n178_));
  aoi21  g089(.a(new_n178_), .b(new_n177_), .c(x10), .O(z32));
  nand2  g090(.a(new_n166_), .b(x44), .O(new_n180_));
  nand2  g091(.a(new_n168_), .b(x45), .O(new_n181_));
  aoi21  g092(.a(new_n181_), .b(new_n180_), .c(x10), .O(z33));
  nand2  g093(.a(new_n166_), .b(x45), .O(new_n183_));
  nand2  g094(.a(new_n168_), .b(x46), .O(new_n184_));
  aoi21  g095(.a(new_n184_), .b(new_n183_), .c(x10), .O(z34));
  nand2  g096(.a(new_n166_), .b(x46), .O(new_n186_));
  nand2  g097(.a(new_n168_), .b(x00), .O(new_n187_));
