...
module FAU ( 
  ...
  wire new_n85_, new_n86_, new_n87_, new_n89_, new_n90_, new_n92_, new_n93_,
    new_n95_, new_n96_, new_n100_, new_n101_, new_n102_, new_n105_,
    new_n106_, new_n109_, new_n110_, new_n112_, new_n113_, new_n115_,
  ...
  nand2  g20(.a(x22), .b(new_n100_), .O(new_n109_));
