...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n88_, new_n89_, new_n91_, new_n92_,
    ...
    new_n143_, new_n144_, new_n149_, new_n150_, new_n153_, new_n154_,
    new_n155_, new_n158_, new_n159_, new_n161_, new_n162_, new_n166_,
  ...
  oai21  g64(.a(x14), .b(new_n138_), .c(x41), .O(new_n158_));
  nand3  g65(.a(x42), .b(new_n154_), .c(x09), .O(new_n159_));
  aoi21  g66(.a(new_n159_), .b(new_n158_), .c(x10), .O(z30));
  oai21  g67(.a(x14), .b(new_n138_), .c(x42), .O(new_n161_));
  nand3  g68(.a(x43), .b(new_n154_), .c(x09), .O(new_n162_));
  aoi21  g69(.a(new_n162_), .b(new_n161_), .c(x10), .O(z31));
  oai21  g70(.a(x14), .b(new_n138_), .c(x45), .O(new_n166_));
  nand3  g71(.a(x46), .b(new_n154_), .c(x09), .O(new_n167_));
  aoi21  g72(.a(new_n167_), .b(new_n166_), .c(x10), .O(z34));
  oai21  g73(.a(x14), .b(new_n138_), .c(x46), .O(new_n169_));
  nand3  g74(.a(new_n154_), .b(x09), .c(x00), .O(new_n170_));
