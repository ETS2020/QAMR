...
module FAU ( 
  ...
  wire new_n86_, new_n87_, new_n88_, new_n90_, new_n91_, new_n93_, new_n94_,
    ...
    new_n167_, new_n168_, new_n171_, new_n172_, new_n175_, new_n176_,
  ...
  nand2  g081(.a(new_n165_), .b(x41), .O(new_n171_));
  nand2  g082(.a(new_n167_), .b(x42), .O(new_n172_));
  aoi21  g083(.a(new_n172_), .b(new_n171_), .c(x10), .O(z30));
  nand2  g084(.a(new_n165_), .b(x43), .O(new_n175_));
  nand2  g085(.a(new_n167_), .b(x44), .O(new_n176_));
  aoi21  g086(.a(new_n176_), .b(new_n175_), .c(x10), .O(z32));
  nand2  g087(.a(new_n165_), .b(x44), .O(new_n178_));
  nand2  g088(.a(new_n167_), .b(x45), .O(new_n179_));
