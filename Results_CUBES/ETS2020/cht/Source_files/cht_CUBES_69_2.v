// Benchmark "FAU" written by ABC on Mon Jul  6 19:22:29 2020
...
module FAU ( 
  ...
  wire new_n85_, new_n86_, new_n87_, new_n90_, new_n91_, new_n93_, new_n94_,
    new_n96_, new_n97_, new_n100_, new_n101_, new_n102_, new_n105_,
  ...
  nand2  g17(.a(x20), .b(new_n100_), .O(new_n105_));
  nand2  g18(.a(x21), .b(x08), .O(new_n106_));
  aoi21  g19(.a(new_n106_), .b(new_n105_), .c(x10), .O(z09));
  nand2  g20(.a(x21), .b(new_n100_), .O(new_n108_));
  ...
  inv1   g72(.a(x14), .O(new_n165_));
  nand2  g73(.a(new_n165_), .b(x09), .O(new_n166_));
  nand2  g74(.a(new_n166_), .b(x42), .O(new_n167_));
  nor2   g75(.a(x14), .b(new_n138_), .O(new_n168_));
  nand2  g76(.a(new_n168_), .b(x43), .O(new_n169_));
  aoi21  g77(.a(new_n169_), .b(new_n167_), .c(x10), .O(z31));
  nand2  g78(.a(new_n166_), .b(x43), .O(new_n171_));
  nand2  g79(.a(new_n168_), .b(x44), .O(new_n172_));
  aoi21  g80(.a(new_n172_), .b(new_n171_), .c(x10), .O(z32));
  nand2  g81(.a(new_n166_), .b(x44), .O(new_n174_));
  nand2  g82(.a(new_n168_), .b(x45), .O(new_n175_));
  aoi21  g83(.a(new_n175_), .b(new_n174_), .c(x10), .O(z33));
  nand2  g84(.a(new_n166_), .b(x45), .O(new_n177_));
  nand2  g85(.a(new_n168_), .b(x46), .O(new_n178_));
  aoi21  g86(.a(new_n178_), .b(new_n177_), .c(x10), .O(z34));
  nand2  g87(.a(new_n166_), .b(x46), .O(new_n180_));
  nand2  g88(.a(new_n168_), .b(x00), .O(new_n181_));
