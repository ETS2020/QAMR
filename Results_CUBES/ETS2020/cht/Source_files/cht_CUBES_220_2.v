...
module FAU ( 
  ...
  wire new_n85_, new_n86_, new_n87_, new_n89_, new_n90_, new_n92_, new_n93_,
    ...
    new_n168_, new_n169_, new_n171_, new_n172_, new_n178_, new_n179_;
  ...
  nand2  g63(.a(x35), .b(new_n140_), .O(new_n151_));
  ...
  nand2  g73(.a(x38), .b(new_n140_), .O(new_n162_));
  aoi21  g74(.a(new_n162_), .b(new_n161_), .c(x10), .O(z27));
  inv1   g75(.a(x14), .O(new_n165_));
  nand2  g76(.a(new_n165_), .b(x09), .O(new_n166_));
  nand2  g77(.a(new_n166_), .b(x40), .O(new_n167_));
  nor2   g78(.a(x14), .b(new_n140_), .O(new_n168_));
  nand2  g79(.a(new_n168_), .b(x41), .O(new_n169_));
  aoi21  g80(.a(new_n169_), .b(new_n167_), .c(x10), .O(z29));
  nand2  g81(.a(new_n166_), .b(x41), .O(new_n171_));
  nand2  g82(.a(new_n168_), .b(x42), .O(new_n172_));
  aoi21  g83(.a(new_n172_), .b(new_n171_), .c(x10), .O(z30));
  nand2  g84(.a(new_n166_), .b(x46), .O(new_n178_));
  nand2  g85(.a(new_n168_), .b(x00), .O(new_n179_));
