// Benchmark "FAU" written by ABC on Mon Jul  6 19:22:14 2020
...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n89_, new_n90_, new_n92_, new_n93_,
    ...
    new_n113_, new_n116_, new_n117_, new_n119_, new_n120_, new_n123_,
  ...
  nand2  g32(.a(x24), .b(new_n99_), .O(new_n119_));
  ...
  oai21  g73(.a(x14), .b(new_n136_), .c(x42), .O(new_n165_));
  nand3  g74(.a(x43), .b(new_n158_), .c(x09), .O(new_n166_));
  aoi21  g75(.a(new_n166_), .b(new_n165_), .c(x10), .O(z31));
  oai21  g76(.a(x14), .b(new_n136_), .c(x43), .O(new_n168_));
  nand3  g77(.a(x44), .b(new_n158_), .c(x09), .O(new_n169_));
  aoi21  g78(.a(new_n169_), .b(new_n168_), .c(x10), .O(z32));
  oai21  g79(.a(x14), .b(new_n136_), .c(x44), .O(new_n171_));
  nand3  g80(.a(x45), .b(new_n158_), .c(x09), .O(new_n172_));
