...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n88_, new_n89_, new_n92_, new_n93_,
    ...
    new_n107_, new_n111_, new_n112_, new_n115_, new_n116_, new_n122_,
  ...
  nand2  g20(.a(x24), .b(new_n102_), .O(new_n111_));
  ...
  nand2  g43(.a(x38), .b(new_n122_), .O(new_n142_));
  ...
  nor2   g48(.a(x14), .b(new_n122_), .O(new_n147_));
