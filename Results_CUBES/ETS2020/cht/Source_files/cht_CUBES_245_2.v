...
module FAU ( 
  ...
  nand2  g78(.a(new_n163_), .b(x43), .O(new_n171_));
  nand2  g79(.a(new_n165_), .b(x44), .O(new_n172_));
  aoi21  g80(.a(new_n172_), .b(new_n171_), .c(x10), .O(z32));
  nand2  g81(.a(new_n163_), .b(x45), .O(new_n175_));
  nand2  g82(.a(new_n165_), .b(x46), .O(new_n176_));
