...
module FAU ( 
  ...
  oai21  g82(.a(x14), .b(new_n142_), .c(x42), .O(new_n171_));
  nand3  g83(.a(x43), .b(new_n164_), .c(x09), .O(new_n172_));
  aoi21  g84(.a(new_n172_), .b(new_n171_), .c(x10), .O(z31));
  oai21  g85(.a(x14), .b(new_n142_), .c(x43), .O(new_n174_));
  nand3  g86(.a(x44), .b(new_n164_), .c(x09), .O(new_n175_));
  aoi21  g87(.a(new_n175_), .b(new_n174_), .c(x10), .O(z32));
  oai21  g88(.a(x14), .b(new_n142_), .c(x44), .O(new_n177_));
  nand3  g89(.a(x45), .b(new_n164_), .c(x09), .O(new_n178_));
