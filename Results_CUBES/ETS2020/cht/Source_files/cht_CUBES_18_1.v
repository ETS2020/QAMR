...
module FAU ( 
  ...
  nand2  g72(.a(new_n151_), .b(x45), .O(new_n169_));
  nand2  g73(.a(new_n153_), .b(x46), .O(new_n170_));
  aoi21  g74(.a(new_n170_), .b(new_n169_), .c(x10), .O(z34));
  nand2  g75(.a(new_n151_), .b(x46), .O(new_n172_));
  nand2  g76(.a(new_n153_), .b(x00), .O(new_n173_));
