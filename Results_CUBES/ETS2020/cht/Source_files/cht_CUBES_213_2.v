...
module FAU ( 
  ...
  wire new_n85_, new_n86_, new_n87_, new_n90_, new_n91_, new_n94_, new_n95_,
    ...
    new_n126_, new_n128_, new_n129_, new_n134_, new_n135_, new_n136_,
  ...
  nand2  g45(.a(x35), .b(new_n134_), .O(new_n139_));
  nand2  g46(.a(x36), .b(x09), .O(new_n140_));
  aoi21  g47(.a(new_n140_), .b(new_n139_), .c(x10), .O(z24));
  nand2  g48(.a(x36), .b(new_n134_), .O(new_n142_));
  ...
  nand2  g58(.a(x38), .b(new_n134_), .O(new_n152_));
  ...
  nor2   g63(.a(x14), .b(new_n134_), .O(new_n157_));
