...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n88_, new_n89_, new_n91_, new_n92_,
    ...
    new_n158_, new_n159_, new_n163_, new_n164_, new_n165_, new_n167_,
  ...
  oai21  g075(.a(x14), .b(new_n142_), .c(x39), .O(new_n163_));
  inv1   g076(.a(x14), .O(new_n164_));
  nand3  g077(.a(x40), .b(new_n164_), .c(x09), .O(new_n165_));
  aoi21  g078(.a(new_n165_), .b(new_n163_), .c(x10), .O(z28));
  oai21  g079(.a(x14), .b(new_n142_), .c(x40), .O(new_n167_));
  nand3  g080(.a(x41), .b(new_n164_), .c(x09), .O(new_n168_));
  aoi21  g081(.a(new_n168_), .b(new_n167_), .c(x10), .O(z29));
  oai21  g082(.a(x14), .b(new_n142_), .c(x41), .O(new_n170_));
  nand3  g083(.a(x42), .b(new_n164_), .c(x09), .O(new_n171_));
  aoi21  g084(.a(new_n171_), .b(new_n170_), .c(x10), .O(z30));
  oai21  g085(.a(x14), .b(new_n142_), .c(x43), .O(new_n174_));
  nand3  g086(.a(x44), .b(new_n164_), .c(x09), .O(new_n175_));
  aoi21  g087(.a(new_n175_), .b(new_n174_), .c(x10), .O(z32));
  oai21  g088(.a(x14), .b(new_n142_), .c(x44), .O(new_n177_));
  nand3  g089(.a(x45), .b(new_n164_), .c(x09), .O(new_n178_));
  aoi21  g090(.a(new_n178_), .b(new_n177_), .c(x10), .O(z33));
  oai21  g091(.a(x14), .b(new_n142_), .c(x45), .O(new_n180_));
  nand3  g092(.a(x46), .b(new_n164_), .c(x09), .O(new_n181_));
  aoi21  g093(.a(new_n181_), .b(new_n180_), .c(x10), .O(z34));
  oai21  g094(.a(x14), .b(new_n142_), .c(x46), .O(new_n183_));
  nand3  g095(.a(new_n164_), .b(x09), .c(x00), .O(new_n184_));
