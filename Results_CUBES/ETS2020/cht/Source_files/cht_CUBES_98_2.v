// Benchmark "FAU" written by ABC on Mon Jul  6 19:22:46 2020
...
module FAU ( 
  ...
  wire new_n87_, new_n88_, new_n89_, new_n91_, new_n92_, new_n94_, new_n95_,
    ...
    new_n105_, new_n109_, new_n110_, new_n112_, new_n113_, new_n115_,
  ...
  nand2  g81(.a(new_n161_), .b(x44), .O(new_n174_));
  nand2  g82(.a(new_n163_), .b(x45), .O(new_n175_));
  aoi21  g83(.a(new_n175_), .b(new_n174_), .c(x10), .O(z33));
  nand2  g84(.a(new_n161_), .b(x46), .O(new_n178_));
  nand2  g85(.a(new_n163_), .b(x00), .O(new_n179_));
