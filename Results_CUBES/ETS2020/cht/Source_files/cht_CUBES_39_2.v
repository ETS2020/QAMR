// Benchmark "FAU" written by ABC on Mon Jul  6 19:22:12 2020
...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n90_, new_n91_, new_n93_, new_n94_,
    ...
    new_n168_, new_n169_, new_n172_, new_n173_, new_n178_, new_n179_;
  ...
  nand2  g35(.a(x25), .b(new_n99_), .O(new_n122_));
  ...
  nand2  g63(.a(x36), .b(new_n138_), .O(new_n152_));
  ...
  nand2  g84(.a(new_n163_), .b(x46), .O(new_n178_));
  nand2  g85(.a(new_n165_), .b(x00), .O(new_n179_));
