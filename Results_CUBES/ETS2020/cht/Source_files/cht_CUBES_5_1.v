// Benchmark "FAU" written by ABC on Mon Jul  6 19:21:52 2020
...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n88_, new_n89_, new_n91_, new_n92_,
    ...
    new_n103_, new_n112_, new_n113_, new_n115_, new_n116_, new_n120_,
  ...
  nand2  g20(.a(x25), .b(new_n101_), .O(new_n112_));
  ...
  nand2  g45(.a(x36), .b(new_n126_), .O(new_n140_));
  ...
  nand2  g55(.a(x38), .b(new_n126_), .O(new_n150_));
  ...
  nor2   g60(.a(x14), .b(new_n126_), .O(new_n155_));
  ...
  nand2  g78(.a(new_n153_), .b(x45), .O(new_n173_));
  nand2  g79(.a(new_n155_), .b(x46), .O(new_n174_));
