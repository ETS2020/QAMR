...
module FAU ( 
  ...
  wire new_n85_, new_n86_, new_n87_, new_n89_, new_n90_, new_n92_, new_n93_,
    new_n95_, new_n96_, new_n100_, new_n101_, new_n102_, new_n106_,
    new_n107_, new_n109_, new_n110_, new_n113_, new_n114_, new_n116_,
    new_n117_, new_n119_, new_n120_, new_n124_, new_n125_, new_n128_,
  ...
  nand2  g17(.a(x21), .b(new_n100_), .O(new_n106_));
  ...
  nor2   g63(.a(x14), .b(new_n128_), .O(new_n157_));
  ...
  nand2  g72(.a(new_n155_), .b(x43), .O(new_n167_));
  nand2  g73(.a(new_n157_), .b(x44), .O(new_n168_));
  aoi21  g74(.a(new_n168_), .b(new_n167_), .c(x10), .O(z32));
  nand2  g75(.a(new_n155_), .b(x44), .O(new_n170_));
  nand2  g76(.a(new_n157_), .b(x45), .O(new_n171_));
