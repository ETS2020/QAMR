...
module FAU ( 
  ...
  nor2   g69(.a(x14), .b(new_n132_), .O(new_n162_));
  ...
  nand2  g78(.a(new_n160_), .b(x45), .O(new_n173_));
  nand2  g79(.a(new_n162_), .b(x46), .O(new_n174_));
  aoi21  g80(.a(new_n174_), .b(new_n173_), .c(x10), .O(z34));
  nand2  g81(.a(new_n160_), .b(x46), .O(new_n176_));
  nand2  g82(.a(new_n162_), .b(x00), .O(new_n177_));
