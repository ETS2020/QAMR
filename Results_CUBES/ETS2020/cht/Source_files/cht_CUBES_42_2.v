...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n88_, new_n89_, new_n92_, new_n93_,
    ...
    new_n104_, new_n107_, new_n108_, new_n111_, new_n112_, new_n114_,
  ...
  nand2  g035(.a(x27), .b(new_n102_), .O(new_n124_));
  nand2  g036(.a(x28), .b(x08), .O(new_n125_));
  aoi21  g037(.a(new_n125_), .b(new_n124_), .c(x10), .O(z16));
  nand2  g038(.a(x28), .b(new_n102_), .O(new_n127_));
