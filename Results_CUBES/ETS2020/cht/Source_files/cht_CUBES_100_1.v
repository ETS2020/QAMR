...
module FAU ( 
  ...
  wire new_n84_, new_n85_, new_n86_, new_n88_, new_n89_, new_n92_, new_n93_,
    ...
    new_n139_, new_n140_, new_n145_, new_n146_, new_n147_, new_n149_,
    new_n150_, new_n152_, new_n153_, new_n155_, new_n156_, new_n158_,
    new_n159_, new_n162_, new_n163_;
  ...
  oai21  g61(.a(x14), .b(new_n130_), .c(x43), .O(new_n158_));
  nand3  g62(.a(x44), .b(new_n146_), .c(x09), .O(new_n159_));
  aoi21  g63(.a(new_n159_), .b(new_n158_), .c(x10), .O(z32));
  oai21  g64(.a(x14), .b(new_n130_), .c(x45), .O(new_n162_));
