...
module FAU ( 
  ...
  oai21  g63(.a(x14), .b(new_n137_), .c(x41), .O(new_n157_));
  inv1   g64(.a(x14), .O(new_n158_));
  nand3  g65(.a(x42), .b(new_n158_), .c(x09), .O(new_n159_));
  aoi21  g66(.a(new_n159_), .b(new_n157_), .c(x10), .O(z30));
  oai21  g67(.a(x14), .b(new_n137_), .c(x42), .O(new_n161_));
  nand3  g68(.a(x43), .b(new_n158_), .c(x09), .O(new_n162_));
  aoi21  g69(.a(new_n162_), .b(new_n161_), .c(x10), .O(z31));
  oai21  g70(.a(x14), .b(new_n137_), .c(x43), .O(new_n164_));
  nand3  g71(.a(x44), .b(new_n158_), .c(x09), .O(new_n165_));
  aoi21  g72(.a(new_n165_), .b(new_n164_), .c(x10), .O(z32));
  oai21  g73(.a(x14), .b(new_n137_), .c(x45), .O(new_n168_));
  nand3  g74(.a(x46), .b(new_n158_), .c(x09), .O(new_n169_));
