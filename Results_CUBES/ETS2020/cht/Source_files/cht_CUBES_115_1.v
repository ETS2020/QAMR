...
module FAU ( 
  ...
  wire new_n85_, new_n86_, new_n87_, new_n90_, new_n91_, new_n94_, new_n95_,
    new_n97_, new_n98_, new_n99_, new_n105_, new_n106_, new_n108_,
  ...
  nand2  g39(.a(x34), .b(new_n126_), .O(new_n134_));
  ...
  nor2   g54(.a(x14), .b(new_n126_), .O(new_n151_));
  nand2  g55(.a(new_n151_), .b(x40), .O(new_n152_));
  aoi21  g56(.a(new_n152_), .b(new_n150_), .c(x10), .O(z28));
  nand2  g57(.a(new_n149_), .b(x41), .O(new_n155_));
  nand2  g58(.a(new_n151_), .b(x42), .O(new_n156_));
  aoi21  g59(.a(new_n156_), .b(new_n155_), .c(x10), .O(z30));
  nand2  g60(.a(new_n149_), .b(x42), .O(new_n158_));
  nand2  g61(.a(new_n151_), .b(x43), .O(new_n159_));
  aoi21  g62(.a(new_n159_), .b(new_n158_), .c(x10), .O(z31));
  nand2  g63(.a(new_n149_), .b(x43), .O(new_n161_));
  nand2  g64(.a(new_n151_), .b(x44), .O(new_n162_));
  aoi21  g65(.a(new_n162_), .b(new_n161_), .c(x10), .O(z32));
  nand2  g66(.a(new_n149_), .b(x44), .O(new_n164_));
  nand2  g67(.a(new_n151_), .b(x45), .O(new_n165_));
  aoi21  g68(.a(new_n165_), .b(new_n164_), .c(x10), .O(z33));
  nand2  g69(.a(new_n149_), .b(x45), .O(new_n167_));
  nand2  g70(.a(new_n151_), .b(x46), .O(new_n168_));
  aoi21  g71(.a(new_n168_), .b(new_n167_), .c(x10), .O(z34));
  nand2  g72(.a(new_n149_), .b(x46), .O(new_n170_));
  nand2  g73(.a(new_n151_), .b(x00), .O(new_n171_));
