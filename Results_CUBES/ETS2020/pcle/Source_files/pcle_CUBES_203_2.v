...
module FAU ( 
  ...
  inv1   g22(.a(new_n42_), .O(new_n56_));
  nand3  g23(.a(x17), .b(x16), .c(x15), .O(new_n57_));
  oai21  g24(.a(new_n57_), .b(new_n48_), .c(x18), .O(new_n58_));
  inv1   g25(.a(new_n48_), .O(new_n59_));
  and2   g26(.a(x16), .b(x15), .O(new_n60_));
  inv1   g27(.a(x17), .O(new_n61_));
  nor2   g28(.a(x18), .b(new_n61_), .O(new_n62_));
  nand3  g29(.a(new_n62_), .b(new_n60_), .c(new_n59_), .O(new_n63_));
  nand2  g30(.a(new_n63_), .b(new_n58_), .O(new_n64_));
  nand2  g31(.a(new_n64_), .b(new_n56_), .O(new_n65_));
