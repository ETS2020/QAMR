...
module FAU ( 
  ...
  oai21  g40(.a(new_n71_), .b(new_n48_), .c(x18), .O(new_n72_));
  inv1   g41(.a(new_n54_), .O(new_n73_));
  and2   g42(.a(x16), .b(x15), .O(new_n74_));
  inv1   g43(.a(x17), .O(new_n75_));
  nor2   g44(.a(x18), .b(new_n75_), .O(new_n76_));
  nand3  g45(.a(new_n76_), .b(new_n74_), .c(new_n73_), .O(new_n77_));
  nand2  g46(.a(new_n77_), .b(new_n72_), .O(new_n78_));
  nand2  g47(.a(new_n78_), .b(new_n60_), .O(new_n79_));
