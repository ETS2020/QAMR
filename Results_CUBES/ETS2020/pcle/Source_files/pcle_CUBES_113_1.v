...
module FAU ( 
  ...
  inv1   g16(.a(new_n32_), .O(new_n48_));
  ...
  nand2  g21(.a(x08), .b(x04), .O(new_n53_));
  oai21  g22(.a(new_n52_), .b(new_n36_), .c(new_n53_), .O(z5));
  nand3  g23(.a(x16), .b(x15), .c(x14), .O(new_n56_));
  oai21  g24(.a(new_n56_), .b(new_n40_), .c(x17), .O(new_n57_));
  inv1   g25(.a(x17), .O(new_n58_));
  nand4  g26(.a(new_n58_), .b(x16), .c(x15), .d(x14), .O(new_n59_));
  oai21  g27(.a(new_n59_), .b(new_n40_), .c(new_n57_), .O(new_n60_));
  nand2  g28(.a(new_n60_), .b(new_n39_), .O(new_n61_));
  nand2  g29(.a(x08), .b(x06), .O(new_n62_));
  nand2  g30(.a(new_n62_), .b(new_n61_), .O(z7));
  nand4  g31(.a(x17), .b(x16), .c(x15), .d(x14), .O(new_n64_));
  oai21  g32(.a(new_n64_), .b(new_n40_), .c(x18), .O(new_n65_));
  inv1   g33(.a(new_n49_), .O(new_n66_));
  and2   g34(.a(x16), .b(x15), .O(new_n67_));
  nor2   g35(.a(x18), .b(new_n58_), .O(new_n68_));
  nand3  g36(.a(new_n68_), .b(new_n67_), .c(new_n66_), .O(new_n69_));
  nand2  g37(.a(new_n69_), .b(new_n65_), .O(new_n70_));
  nand2  g38(.a(new_n70_), .b(new_n39_), .O(new_n71_));
