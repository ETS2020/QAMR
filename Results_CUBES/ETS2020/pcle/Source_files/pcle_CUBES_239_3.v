...
module FAU ( 
  ...
  inv1   g25(.a(new_n42_), .O(new_n58_));
  nand3  g26(.a(x17), .b(x16), .c(x15), .O(new_n59_));
  oai21  g27(.a(new_n59_), .b(new_n50_), .c(x18), .O(new_n60_));
  inv1   g28(.a(new_n50_), .O(new_n61_));
  and2   g29(.a(x16), .b(x15), .O(new_n62_));
  inv1   g30(.a(x17), .O(new_n63_));
  nor2   g31(.a(x18), .b(new_n63_), .O(new_n64_));
  nand3  g32(.a(new_n64_), .b(new_n62_), .c(new_n61_), .O(new_n65_));
  nand2  g33(.a(new_n65_), .b(new_n60_), .O(new_n66_));
  nand2  g34(.a(new_n66_), .b(new_n58_), .O(new_n67_));
