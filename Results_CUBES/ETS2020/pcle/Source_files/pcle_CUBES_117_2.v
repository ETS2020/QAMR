...
module FAU ( 
  ...
  nand4  g35(.a(x17), .b(x16), .c(x15), .d(x14), .O(new_n68_));
  oai21  g36(.a(new_n68_), .b(new_n60_), .c(x18), .O(new_n69_));
  inv1   g37(.a(new_n49_), .O(new_n70_));
  and2   g38(.a(x16), .b(x15), .O(new_n71_));
  inv1   g39(.a(x17), .O(new_n72_));
  nor2   g40(.a(x18), .b(new_n72_), .O(new_n73_));
  nand3  g41(.a(new_n73_), .b(new_n71_), .c(new_n70_), .O(new_n74_));
  nand2  g42(.a(new_n74_), .b(new_n69_), .O(new_n75_));
  nand2  g43(.a(new_n75_), .b(new_n56_), .O(new_n76_));
  nand2  g44(.a(x08), .b(x07), .O(new_n77_));
  nand2  g45(.a(new_n77_), .b(new_n76_), .O(z8));
  zero   g46(.O(z2));
  zero   g47(.O(z3));
  zero   g48(.O(z4));
  zero   g49(.O(z7));
