// Benchmark "FAU" written by ABC on Tue Jul  7 11:19:12 2020
...
module FAU ( 
  ...
  oai21  g26(.a(new_n55_), .b(new_n43_), .c(new_n56_), .O(z5));
  inv1   g27(.a(new_n43_), .O(new_n58_));
  nand3  g28(.a(x15), .b(x14), .c(x13), .O(new_n59_));
  oai21  g29(.a(new_n59_), .b(new_n46_), .c(x16), .O(new_n60_));
  ...
  nand4  g46(.a(x17), .b(x16), .c(x15), .d(x14), .O(new_n77_));
  oai21  g47(.a(new_n77_), .b(new_n62_), .c(x18), .O(new_n78_));
  inv1   g48(.a(new_n52_), .O(new_n79_));
  and2   g49(.a(x16), .b(x15), .O(new_n80_));
  nor2   g50(.a(x18), .b(new_n71_), .O(new_n81_));
  nand3  g51(.a(new_n81_), .b(new_n80_), .c(new_n79_), .O(new_n82_));
  nand2  g52(.a(new_n82_), .b(new_n78_), .O(new_n83_));
  nand2  g53(.a(new_n83_), .b(new_n58_), .O(new_n84_));
