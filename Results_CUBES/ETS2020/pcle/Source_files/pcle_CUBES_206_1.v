...
module FAU ( 
  ...
  nand2  g19(.a(x15), .b(x14), .O(new_n52_));
  oai21  g20(.a(new_n52_), .b(new_n33_), .c(x16), .O(new_n53_));
  inv1   g21(.a(new_n33_), .O(new_n54_));
  nor2   g22(.a(new_n52_), .b(x16), .O(new_n55_));
  nand2  g23(.a(new_n55_), .b(new_n54_), .O(new_n56_));
  nand2  g24(.a(new_n56_), .b(new_n53_), .O(new_n57_));
  ...
  oai21  g29(.a(new_n61_), .b(new_n33_), .c(x17), .O(new_n62_));
  inv1   g30(.a(x17), .O(new_n63_));
  nand4  g31(.a(new_n63_), .b(x16), .c(x15), .d(x14), .O(new_n64_));
  oai21  g32(.a(new_n64_), .b(new_n33_), .c(new_n62_), .O(new_n65_));
  nand2  g33(.a(new_n65_), .b(new_n42_), .O(new_n66_));
  nand2  g34(.a(x08), .b(x06), .O(new_n67_));
  nand2  g35(.a(new_n67_), .b(new_n66_), .O(z7));
  nand4  g36(.a(x17), .b(x16), .c(x15), .d(x14), .O(new_n69_));
  oai21  g37(.a(new_n69_), .b(new_n33_), .c(x18), .O(new_n70_));
  inv1   g38(.a(new_n46_), .O(new_n71_));
  and2   g39(.a(x16), .b(x15), .O(new_n72_));
  nor2   g40(.a(x18), .b(new_n63_), .O(new_n73_));
  nand3  g41(.a(new_n73_), .b(new_n72_), .c(new_n71_), .O(new_n74_));
  nand2  g42(.a(new_n74_), .b(new_n70_), .O(new_n75_));
  nand2  g43(.a(new_n75_), .b(new_n42_), .O(new_n76_));
