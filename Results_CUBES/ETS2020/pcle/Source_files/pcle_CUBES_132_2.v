...
module FAU ( 
  ...
  oai21  g32(.a(new_n63_), .b(new_n47_), .c(x17), .O(new_n64_));
  inv1   g33(.a(x17), .O(new_n65_));
  nand4  g34(.a(new_n65_), .b(x16), .c(x15), .d(x14), .O(new_n66_));
  oai21  g35(.a(new_n66_), .b(new_n47_), .c(new_n64_), .O(new_n67_));
  nand2  g36(.a(new_n67_), .b(new_n46_), .O(new_n68_));
  nand2  g37(.a(x08), .b(x06), .O(new_n69_));
  nand2  g38(.a(new_n69_), .b(new_n68_), .O(z7));
  nand4  g39(.a(x17), .b(x16), .c(x15), .d(x14), .O(new_n71_));
  oai21  g40(.a(new_n71_), .b(new_n47_), .c(x18), .O(new_n72_));
  ...
  nand2  g46(.a(new_n77_), .b(new_n46_), .O(new_n78_));
