// Benchmark "FAU" written by ABC on Tue Jul  7 11:19:04 2020
...
module FAU ( 
  ...
  nand3  g16(.a(x13), .b(x12), .c(x11), .O(new_n49_));
  oai21  g17(.a(new_n49_), .b(new_n31_), .c(x16), .O(new_n50_));
  inv1   g18(.a(x16), .O(new_n51_));
  inv1   g19(.a(new_n49_), .O(new_n52_));
  nand3  g20(.a(new_n52_), .b(new_n32_), .c(new_n51_), .O(new_n53_));
  nand2  g21(.a(new_n53_), .b(new_n50_), .O(new_n54_));
  nand2  g22(.a(new_n36_), .b(new_n42_), .O(new_n55_));
  inv1   g23(.a(new_n55_), .O(new_n56_));
  nand2  g24(.a(new_n56_), .b(new_n54_), .O(new_n57_));
  nand2  g25(.a(x08), .b(x05), .O(new_n58_));
  nand2  g26(.a(new_n58_), .b(new_n57_), .O(z6));
  nand3  g27(.a(x16), .b(x15), .c(x14), .O(new_n60_));
  oai21  g28(.a(new_n60_), .b(new_n49_), .c(x17), .O(new_n61_));
  inv1   g29(.a(x17), .O(new_n62_));
  nand4  g30(.a(new_n62_), .b(x16), .c(x15), .d(x14), .O(new_n63_));
  oai21  g31(.a(new_n63_), .b(new_n49_), .c(new_n61_), .O(new_n64_));
  nand2  g32(.a(new_n64_), .b(new_n56_), .O(new_n65_));
