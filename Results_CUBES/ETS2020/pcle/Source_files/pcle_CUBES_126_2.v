...
module FAU ( 
  ...
  oai21  g35(.a(new_n65_), .b(new_n49_), .c(x17), .O(new_n66_));
  inv1   g36(.a(x17), .O(new_n67_));
  nand4  g37(.a(new_n67_), .b(x16), .c(x15), .d(x14), .O(new_n68_));
  oai21  g38(.a(new_n68_), .b(new_n49_), .c(new_n66_), .O(new_n69_));
  nand2  g39(.a(new_n69_), .b(new_n48_), .O(new_n70_));
  nand2  g40(.a(x08), .b(x06), .O(new_n71_));
  nand2  g41(.a(new_n71_), .b(new_n70_), .O(z7));
  nand4  g42(.a(x17), .b(x16), .c(x15), .d(x14), .O(new_n73_));
  oai21  g43(.a(new_n73_), .b(new_n49_), .c(x18), .O(new_n74_));
  inv1   g44(.a(new_n58_), .O(new_n75_));
  ...
  nand2  g49(.a(new_n79_), .b(new_n48_), .O(new_n80_));
