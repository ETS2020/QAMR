...
module FAU ( 
  ...
  aoi22  g26(.a(new_n55_), .b(new_n52_), .c(new_n53_), .d(x15), .O(new_n56_));
  nand2  g27(.a(x08), .b(x04), .O(new_n57_));
  oai21  g28(.a(new_n56_), .b(new_n44_), .c(new_n57_), .O(z5));
  ...
  nand4  g34(.a(new_n63_), .b(new_n52_), .c(new_n62_), .d(x15), .O(new_n64_));
