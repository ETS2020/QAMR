...
module FAU ( 
  ...
  inv1   g20(.a(new_n43_), .O(new_n52_));
  nand3  g21(.a(x15), .b(x14), .c(x13), .O(new_n53_));
  oai21  g22(.a(new_n53_), .b(new_n46_), .c(x16), .O(new_n54_));
  ...
  oai21  g32(.a(new_n64_), .b(new_n56_), .c(x18), .O(new_n65_));
  and2   g33(.a(x16), .b(x15), .O(new_n66_));
  inv1   g34(.a(x17), .O(new_n67_));
  nor2   g35(.a(x18), .b(new_n67_), .O(new_n68_));
  nand4  g36(.a(x14), .b(x13), .c(x12), .d(x11), .O(new_n69_));
  inv1   g37(.a(new_n69_), .O(new_n70_));
  nand3  g38(.a(new_n70_), .b(new_n68_), .c(new_n66_), .O(new_n71_));
  nand2  g39(.a(new_n71_), .b(new_n65_), .O(new_n72_));
  nand2  g40(.a(new_n72_), .b(new_n52_), .O(new_n73_));
