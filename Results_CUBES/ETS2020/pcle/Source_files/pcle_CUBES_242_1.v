// Benchmark "FAU" written by ABC on Tue Jul  7 11:19:18 2020
...
module FAU ( 
  ...
  oai21  g32(.a(new_n63_), .b(new_n53_), .c(x18), .O(new_n64_));
  inv1   g33(.a(new_n45_), .O(new_n65_));
  and2   g34(.a(x16), .b(x15), .O(new_n66_));
  inv1   g35(.a(x17), .O(new_n67_));
  nor2   g36(.a(x18), .b(new_n67_), .O(new_n68_));
  nand3  g37(.a(new_n68_), .b(new_n66_), .c(new_n65_), .O(new_n69_));
  nand2  g38(.a(new_n69_), .b(new_n64_), .O(new_n70_));
  nand2  g39(.a(new_n70_), .b(new_n51_), .O(new_n71_));
