...
module FAU ( 
  ...
  inv1   g19(.a(new_n45_), .O(new_n51_));
  nand2  g20(.a(x12), .b(x11), .O(new_n52_));
  nand3  g21(.a(x15), .b(x14), .c(x13), .O(new_n53_));
  oai21  g22(.a(new_n53_), .b(new_n52_), .c(x16), .O(new_n54_));
  ...
  nand2  g28(.a(new_n59_), .b(new_n51_), .O(new_n60_));
  ...
  nand2  g36(.a(new_n67_), .b(new_n51_), .O(new_n68_));
  ...
  nand2  g47(.a(new_n78_), .b(new_n51_), .O(new_n79_));
