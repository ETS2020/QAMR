...
module FAU ( 
  ...
  oai21  g32(.a(new_n62_), .b(new_n52_), .c(x17), .O(new_n63_));
  inv1   g33(.a(x17), .O(new_n64_));
  nand4  g34(.a(new_n64_), .b(x16), .c(x15), .d(x14), .O(new_n65_));
  oai21  g35(.a(new_n65_), .b(new_n52_), .c(new_n63_), .O(new_n66_));
  ...
  oai21  g40(.a(new_n70_), .b(new_n52_), .c(x18), .O(new_n71_));
  ...
  nand2  g47(.a(new_n77_), .b(new_n51_), .O(new_n78_));
