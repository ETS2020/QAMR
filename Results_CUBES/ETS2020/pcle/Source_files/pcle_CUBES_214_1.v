...
module FAU ( 
  ...
  aoi21  g19(.a(new_n51_), .b(new_n42_), .c(new_n49_), .O(new_n52_));
  nor3   g20(.a(new_n50_), .b(new_n41_), .c(x16), .O(new_n53_));
  oai21  g21(.a(new_n53_), .b(new_n52_), .c(new_n39_), .O(new_n54_));
