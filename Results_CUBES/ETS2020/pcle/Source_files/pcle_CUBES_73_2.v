...
module FAU ( 
  ...
  wire new_n29_, new_n30_, new_n31_, new_n32_, new_n33_, new_n34_, new_n35_,
    new_n36_, new_n37_, new_n39_, new_n40_, new_n41_, new_n48_, new_n49_,
  ...
  nand2  g20(.a(new_n34_), .b(new_n40_), .O(new_n54_));
  ...
  oai21  g26(.a(new_n59_), .b(new_n48_), .c(x18), .O(new_n60_));
  and2   g27(.a(x14), .b(x13), .O(new_n61_));
  nor2   g28(.a(x18), .b(new_n51_), .O(new_n62_));
  ...
  nand2  g33(.a(new_n66_), .b(new_n55_), .O(new_n67_));
