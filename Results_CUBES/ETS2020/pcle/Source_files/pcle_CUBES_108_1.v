...
module FAU ( 
  ...
  nand2  g28(.a(x15), .b(x14), .O(new_n60_));
  oai21  g29(.a(new_n42_), .b(new_n60_), .c(x16), .O(new_n61_));
  inv1   g30(.a(new_n42_), .O(new_n62_));
  nor2   g31(.a(new_n60_), .b(x16), .O(new_n63_));
  nand2  g32(.a(new_n63_), .b(new_n62_), .O(new_n64_));
  nand2  g33(.a(new_n64_), .b(new_n61_), .O(new_n65_));
  nand2  g34(.a(new_n65_), .b(new_n50_), .O(new_n66_));
  nand2  g35(.a(x08), .b(x05), .O(new_n67_));
  nand2  g36(.a(new_n67_), .b(new_n66_), .O(z6));
  nand3  g37(.a(x16), .b(x15), .c(x14), .O(new_n69_));
  oai21  g38(.a(new_n69_), .b(new_n42_), .c(x17), .O(new_n70_));
  inv1   g39(.a(x17), .O(new_n71_));
  nand4  g40(.a(new_n71_), .b(x16), .c(x15), .d(x14), .O(new_n72_));
  oai21  g41(.a(new_n72_), .b(new_n42_), .c(new_n70_), .O(new_n73_));
  nand2  g42(.a(new_n73_), .b(new_n50_), .O(new_n74_));
  nand2  g43(.a(x08), .b(x06), .O(new_n75_));
  nand2  g44(.a(new_n75_), .b(new_n74_), .O(z7));
  nand4  g45(.a(x17), .b(x16), .c(x15), .d(x14), .O(new_n77_));
  oai21  g46(.a(new_n77_), .b(new_n42_), .c(x18), .O(new_n78_));
  inv1   g47(.a(new_n54_), .O(new_n79_));
  and2   g48(.a(x16), .b(x15), .O(new_n80_));
  nor2   g49(.a(x18), .b(new_n71_), .O(new_n81_));
  nand3  g50(.a(new_n81_), .b(new_n80_), .c(new_n79_), .O(new_n82_));
  nand2  g51(.a(new_n82_), .b(new_n78_), .O(new_n83_));
  nand2  g52(.a(new_n83_), .b(new_n50_), .O(new_n84_));
  nand2  g53(.a(x08), .b(x07), .O(new_n85_));
  nand2  g54(.a(new_n85_), .b(new_n84_), .O(z8));
  zero   g55(.O(z1));
  zero   g56(.O(z2));
  zero   g57(.O(z3));
endmodule
