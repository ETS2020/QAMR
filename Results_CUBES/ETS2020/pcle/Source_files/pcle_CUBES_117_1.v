...
module FAU ( 
  ...
  inv1   g23(.a(x16), .O(new_n54_));
  nand2  g24(.a(x15), .b(x14), .O(new_n55_));
  inv1   g25(.a(new_n55_), .O(new_n56_));
  aoi21  g26(.a(new_n56_), .b(new_n47_), .c(new_n54_), .O(new_n57_));
  nor3   g27(.a(new_n55_), .b(new_n46_), .c(x16), .O(new_n58_));
  oai21  g28(.a(new_n58_), .b(new_n57_), .c(new_n44_), .O(new_n59_));
