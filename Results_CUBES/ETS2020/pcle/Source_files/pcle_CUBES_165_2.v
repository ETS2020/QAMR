...
module FAU ( 
  ...
  nand3  g18(.a(new_n40_), .b(new_n47_), .c(x13), .O(new_n48_));
  ...
  nand3  g29(.a(x16), .b(x15), .c(x14), .O(new_n60_));
  oai21  g30(.a(new_n60_), .b(new_n45_), .c(x17), .O(new_n61_));
  inv1   g31(.a(x17), .O(new_n62_));
  nand4  g32(.a(new_n62_), .b(x16), .c(x15), .d(x14), .O(new_n63_));
  oai21  g33(.a(new_n63_), .b(new_n45_), .c(new_n61_), .O(new_n64_));
  nand2  g34(.a(new_n64_), .b(new_n44_), .O(new_n65_));
  nand2  g35(.a(x08), .b(x06), .O(new_n66_));
  nand2  g36(.a(new_n66_), .b(new_n65_), .O(z7));
  zero   g37(.O(z0));
  zero   g38(.O(z6));
  zero   g39(.O(z8));
endmodule
