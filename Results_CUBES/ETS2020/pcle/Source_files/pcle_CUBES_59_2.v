...
module FAU ( 
  ...
  nand3  g17(.a(new_n40_), .b(x09), .c(new_n46_), .O(new_n47_));
  ...
  nand2  g24(.a(new_n51_), .b(x13), .O(new_n54_));
  oai22  g25(.a(new_n54_), .b(new_n44_), .c(new_n53_), .d(new_n51_), .O(new_n55_));
  ...
  oai21  g30(.a(new_n60_), .b(new_n44_), .c(x16), .O(new_n61_));
  ...
  nand2  g35(.a(new_n65_), .b(new_n50_), .O(new_n66_));
