...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n32_, new_n33_, new_n34_, new_n36_, new_n37_,
    ...
    new_n47_, new_n48_, new_n49_, new_n50_, new_n51_, new_n56_, new_n57_,
  ...
  nand4  g23(.a(x17), .b(x16), .c(x15), .d(x14), .O(new_n56_));
  oai21  g24(.a(new_n56_), .b(new_n45_), .c(x18), .O(new_n57_));
  and2   g25(.a(x16), .b(x15), .O(new_n58_));
  inv1   g26(.a(x17), .O(new_n59_));
  nor2   g27(.a(x18), .b(new_n59_), .O(new_n60_));
  nand4  g28(.a(x14), .b(x13), .c(x12), .d(x11), .O(new_n61_));
  inv1   g29(.a(new_n61_), .O(new_n62_));
  nand3  g30(.a(new_n62_), .b(new_n60_), .c(new_n58_), .O(new_n63_));
  nand2  g31(.a(new_n63_), .b(new_n57_), .O(new_n64_));
  nand2  g32(.a(new_n64_), .b(new_n44_), .O(new_n65_));
