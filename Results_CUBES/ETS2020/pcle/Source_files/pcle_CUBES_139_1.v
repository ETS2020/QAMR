...
module FAU ( 
  ...
  nand3  g20(.a(x13), .b(x12), .c(x11), .O(new_n52_));
  inv1   g21(.a(new_n52_), .O(new_n53_));
  aoi21  g22(.a(new_n53_), .b(new_n51_), .c(new_n49_), .O(new_n54_));
  nor3   g23(.a(new_n52_), .b(new_n50_), .c(x16), .O(new_n55_));
  oai21  g24(.a(new_n55_), .b(new_n54_), .c(new_n48_), .O(new_n56_));
  nand2  g25(.a(x08), .b(x05), .O(new_n57_));
  nand2  g26(.a(new_n57_), .b(new_n56_), .O(z6));
  nand3  g27(.a(x16), .b(x15), .c(x14), .O(new_n59_));
  oai21  g28(.a(new_n59_), .b(new_n52_), .c(x17), .O(new_n60_));
  inv1   g29(.a(x17), .O(new_n61_));
  nand4  g30(.a(new_n61_), .b(x16), .c(x15), .d(x14), .O(new_n62_));
  oai21  g31(.a(new_n62_), .b(new_n52_), .c(new_n60_), .O(new_n63_));
  nand2  g32(.a(new_n63_), .b(new_n48_), .O(new_n64_));
