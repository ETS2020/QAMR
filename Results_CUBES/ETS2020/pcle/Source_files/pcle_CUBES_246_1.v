...
module FAU ( 
  ...
  oai21  g21(.a(new_n52_), .b(new_n37_), .c(x16), .O(new_n53_));
  inv1   g22(.a(x16), .O(new_n54_));
  and2   g23(.a(x15), .b(x14), .O(new_n55_));
  nand3  g24(.a(new_n55_), .b(new_n45_), .c(new_n54_), .O(new_n56_));
  nand2  g25(.a(new_n56_), .b(new_n53_), .O(new_n57_));
  nand2  g26(.a(new_n57_), .b(new_n42_), .O(new_n58_));
  nand2  g27(.a(x08), .b(x05), .O(new_n59_));
  nand2  g28(.a(new_n59_), .b(new_n58_), .O(z6));
  zero   g29(.O(z0));
  zero   g30(.O(z2));
  zero   g31(.O(z5));
  zero   g32(.O(z7));
