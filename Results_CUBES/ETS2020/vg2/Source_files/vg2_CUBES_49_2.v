...
module FAU ( 
  ...
  inv1   g112(.a(new_n142_), .O(z5));
  oai21  g113(.a(new_n57_), .b(x14), .c(new_n51_), .O(new_n148_));
  aoi21  g114(.a(new_n148_), .b(new_n61_), .c(x03), .O(new_n149_));
  inv1   g115(.a(x03), .O(new_n150_));
  oai21  g116(.a(x20), .b(new_n63_), .c(x06), .O(new_n151_));
  aoi21  g117(.a(new_n151_), .b(x11), .c(new_n150_), .O(new_n152_));
  oai22  g118(.a(new_n152_), .b(new_n111_), .c(new_n149_), .d(new_n142_), .O(z6));
  inv1   g119(.a(new_n111_), .O(z7));
  zero   g120(.O(z0));
endmodule
