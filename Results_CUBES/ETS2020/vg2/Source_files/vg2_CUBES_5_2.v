...
module FAU ( 
  ...
  nand2  g36(.a(x20), .b(new_n62_), .O(new_n75_));
  aoi21  g37(.a(new_n75_), .b(new_n53_), .c(x11), .O(new_n76_));
  inv1   g38(.a(x05), .O(new_n77_));
  nand2  g39(.a(x24), .b(x07), .O(new_n78_));
  nand3  g40(.a(new_n37_), .b(x19), .c(x13), .O(new_n79_));
  aoi21  g41(.a(new_n79_), .b(new_n78_), .c(new_n77_), .O(new_n80_));
  nand2  g42(.a(new_n66_), .b(x19), .O(new_n81_));
  nand3  g43(.a(x24), .b(x13), .c(x07), .O(new_n82_));
  nand4  g44(.a(new_n37_), .b(new_n40_), .c(new_n39_), .d(x00), .O(new_n83_));
  nand3  g45(.a(new_n83_), .b(new_n82_), .c(new_n81_), .O(new_n84_));
  oai22  g46(.a(new_n84_), .b(new_n80_), .c(new_n76_), .d(x03), .O(new_n85_));
  nand2  g47(.a(new_n63_), .b(x14), .O(new_n86_));
  aoi21  g48(.a(new_n86_), .b(x06), .c(new_n61_), .O(new_n87_));
  nand2  g49(.a(x24), .b(x18), .O(new_n88_));
  nand3  g50(.a(new_n37_), .b(x15), .c(x13), .O(new_n89_));
  aoi21  g51(.a(new_n89_), .b(new_n88_), .c(new_n77_), .O(new_n90_));
  nand4  g52(.a(new_n37_), .b(x21), .c(new_n40_), .d(new_n39_), .O(new_n91_));
  nand3  g53(.a(x24), .b(x18), .c(x13), .O(new_n92_));
  nand2  g54(.a(new_n66_), .b(x15), .O(new_n93_));
  nand3  g55(.a(new_n93_), .b(new_n92_), .c(new_n91_), .O(new_n94_));
  oai22  g56(.a(new_n94_), .b(new_n90_), .c(new_n87_), .d(new_n52_), .O(new_n95_));
  nand2  g57(.a(new_n95_), .b(new_n85_), .O(z6));
  zero   g58(.O(z0));
  zero   g59(.O(z1));
  zero   g60(.O(z2));
  zero   g61(.O(z4));
