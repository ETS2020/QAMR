// Benchmark "FAU" written by ABC on Tue Jul  7 17:34:02 2020
...
module FAU ( 
  ...
  nand3  g081(.a(new_n53_), .b(new_n36_), .c(x21), .O(new_n115_));
  ...
  nor3   g087(.a(new_n120_), .b(new_n119_), .c(new_n56_), .O(z2));
  inv1   g088(.a(x09), .O(new_n123_));
  aoi21  g089(.a(new_n74_), .b(x04), .c(x17), .O(new_n124_));
  oai21  g090(.a(new_n124_), .b(x22), .c(new_n123_), .O(new_n125_));
  aoi21  g091(.a(new_n125_), .b(new_n71_), .c(x08), .O(new_n126_));
  inv1   g092(.a(x08), .O(new_n127_));
  inv1   g093(.a(x04), .O(new_n128_));
  aoi21  g094(.a(x23), .b(new_n128_), .c(new_n72_), .O(new_n129_));
  oai21  g095(.a(new_n129_), .b(new_n73_), .c(x09), .O(new_n130_));
  aoi21  g096(.a(new_n130_), .b(x16), .c(new_n127_), .O(new_n131_));
  oai22  g097(.a(new_n131_), .b(new_n119_), .c(new_n126_), .d(new_n46_), .O(z4));
  inv1   g098(.a(new_n46_), .O(z5));
  inv1   g099(.a(x06), .O(new_n134_));
  oai21  g100(.a(new_n79_), .b(x14), .c(new_n134_), .O(new_n135_));
  aoi21  g101(.a(new_n135_), .b(new_n76_), .c(x03), .O(new_n136_));
  inv1   g102(.a(x03), .O(new_n137_));
  oai21  g103(.a(x20), .b(new_n78_), .c(x06), .O(new_n138_));
  aoi21  g104(.a(new_n138_), .b(x11), .c(new_n137_), .O(new_n139_));
  oai22  g105(.a(new_n139_), .b(new_n119_), .c(new_n136_), .d(new_n46_), .O(z6));
  inv1   g106(.a(new_n119_), .O(z7));
  zero   g107(.O(z3));
endmodule
