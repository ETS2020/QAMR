// Benchmark "FAU" written by ABC on Tue Jul  7 17:33:39 2020
...
module FAU ( 
  ...
  oai21  g107(.a(new_n78_), .b(x14), .c(new_n47_), .O(new_n143_));
  aoi21  g108(.a(new_n143_), .b(new_n48_), .c(x03), .O(new_n144_));
  inv1   g109(.a(x03), .O(new_n145_));
  oai21  g110(.a(x20), .b(new_n77_), .c(x06), .O(new_n146_));
  aoi21  g111(.a(new_n146_), .b(x11), .c(new_n145_), .O(new_n147_));
  oai22  g112(.a(new_n147_), .b(new_n122_), .c(new_n144_), .d(new_n46_), .O(z6));
  inv1   g113(.a(new_n122_), .O(z7));
  zero   g114(.O(z4));
  zero   g115(.O(z5));
endmodule
