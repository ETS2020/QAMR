...
module FAU ( 
  ...
  nand2  g081(.a(x20), .b(new_n63_), .O(new_n119_));
  aoi21  g082(.a(new_n119_), .b(new_n79_), .c(x11), .O(new_n120_));
  nand2  g083(.a(x24), .b(x07), .O(new_n121_));
  nand3  g084(.a(new_n35_), .b(x19), .c(x13), .O(new_n122_));
  aoi21  g085(.a(new_n122_), .b(new_n121_), .c(new_n105_), .O(new_n123_));
  nand2  g086(.a(new_n89_), .b(x19), .O(new_n124_));
  nand3  g087(.a(x24), .b(x13), .c(x07), .O(new_n125_));
  inv1   g088(.a(x02), .O(new_n126_));
  inv1   g089(.a(x10), .O(new_n127_));
  nand4  g090(.a(new_n35_), .b(new_n127_), .c(new_n126_), .d(x00), .O(new_n128_));
  nand3  g091(.a(new_n128_), .b(new_n125_), .c(new_n124_), .O(new_n129_));
  oai22  g092(.a(new_n129_), .b(new_n123_), .c(new_n120_), .d(x03), .O(new_n130_));
  inv1   g093(.a(x03), .O(new_n131_));
  oai21  g094(.a(x20), .b(new_n63_), .c(x06), .O(new_n132_));
  aoi21  g095(.a(new_n132_), .b(x11), .c(new_n131_), .O(new_n133_));
  oai21  g096(.a(new_n133_), .b(new_n113_), .c(new_n130_), .O(z6));
  zero   g097(.O(z0));
  zero   g098(.O(z3));
  zero   g099(.O(z4));
  zero   g100(.O(z5));
