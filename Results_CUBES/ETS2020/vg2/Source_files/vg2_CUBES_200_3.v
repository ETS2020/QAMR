...
module FAU ( 
  ...
  inv1   g070(.a(x05), .O(new_n108_));
  nand2  g071(.a(x24), .b(x07), .O(new_n109_));
  nand3  g072(.a(new_n35_), .b(x19), .c(x13), .O(new_n110_));
  aoi21  g073(.a(new_n110_), .b(new_n109_), .c(new_n108_), .O(new_n111_));
  nand2  g074(.a(new_n89_), .b(x19), .O(new_n112_));
  nand3  g075(.a(x24), .b(x13), .c(x07), .O(new_n113_));
  inv1   g076(.a(x02), .O(new_n114_));
  inv1   g077(.a(x10), .O(new_n115_));
  nand4  g078(.a(new_n35_), .b(new_n115_), .c(new_n114_), .d(x00), .O(new_n116_));
  nand3  g079(.a(new_n116_), .b(new_n113_), .c(new_n112_), .O(new_n117_));
  or2    g080(.a(new_n117_), .b(new_n111_), .O(z5));
  nand2  g081(.a(x20), .b(new_n63_), .O(new_n119_));
  aoi21  g082(.a(new_n119_), .b(new_n79_), .c(x11), .O(new_n120_));
  oai22  g083(.a(new_n120_), .b(x03), .c(new_n117_), .d(new_n111_), .O(new_n121_));
  inv1   g084(.a(x03), .O(new_n122_));
  nand2  g085(.a(new_n57_), .b(x14), .O(new_n123_));
  aoi21  g086(.a(new_n123_), .b(x06), .c(new_n61_), .O(new_n124_));
  nand2  g087(.a(x24), .b(x18), .O(new_n125_));
  nand3  g088(.a(new_n35_), .b(x15), .c(x13), .O(new_n126_));
  aoi21  g089(.a(new_n126_), .b(new_n125_), .c(new_n108_), .O(new_n127_));
  nand3  g090(.a(new_n37_), .b(new_n35_), .c(x21), .O(new_n128_));
  nand3  g091(.a(x24), .b(x18), .c(x13), .O(new_n129_));
  nand2  g092(.a(new_n89_), .b(x15), .O(new_n130_));
  nand3  g093(.a(new_n130_), .b(new_n129_), .c(new_n128_), .O(new_n131_));
  oai22  g094(.a(new_n131_), .b(new_n127_), .c(new_n124_), .d(new_n122_), .O(new_n132_));
  nand2  g095(.a(new_n132_), .b(new_n121_), .O(z6));
  or2    g096(.a(new_n131_), .b(new_n127_), .O(z7));
  zero   g097(.O(z0));
  zero   g098(.O(z2));
  zero   g099(.O(z3));
  zero   g100(.O(z4));
