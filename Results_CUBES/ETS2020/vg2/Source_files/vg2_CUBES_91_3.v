// Benchmark "FAU" written by ABC on Tue Jul  7 17:33:54 2020
...
module FAU ( 
  ...
  nand2  g77(.a(x24), .b(x18), .O(new_n111_));
  nand2  g78(.a(x15), .b(x13), .O(new_n112_));
  oai21  g79(.a(new_n112_), .b(x24), .c(new_n111_), .O(new_n113_));
  nand3  g80(.a(new_n53_), .b(new_n35_), .c(x21), .O(new_n114_));
  nand3  g81(.a(x24), .b(x18), .c(x13), .O(new_n115_));
  nand2  g82(.a(new_n39_), .b(x15), .O(new_n116_));
  nand3  g83(.a(new_n116_), .b(new_n115_), .c(new_n114_), .O(new_n117_));
  aoi21  g84(.a(new_n113_), .b(x05), .c(new_n117_), .O(new_n118_));
  nand4  g85(.a(x20), .b(x14), .c(x11), .d(x06), .O(new_n119_));
  nor3   g86(.a(new_n119_), .b(new_n118_), .c(new_n56_), .O(z2));
  nand2  g87(.a(new_n46_), .b(new_n38_), .O(z5));
  zero   g88(.O(z3));
  zero   g89(.O(z4));
  zero   g90(.O(z6));
  zero   g91(.O(z7));
