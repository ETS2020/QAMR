// Benchmark "FAU" written by ABC on Tue Jul  7 17:34:09 2020
...
module FAU ( 
  ...
  inv1   g089(.a(new_n57_), .O(new_n123_));
  nor2   g090(.a(new_n78_), .b(new_n77_), .O(new_n124_));
  nand4  g091(.a(new_n124_), .b(new_n123_), .c(x11), .d(x06), .O(new_n125_));
  aoi21  g092(.a(new_n122_), .b(new_n117_), .c(new_n125_), .O(z2));
  nor2   g093(.a(new_n77_), .b(new_n48_), .O(new_n127_));
  ...
  nand3  g101(.a(new_n50_), .b(new_n48_), .c(new_n107_), .O(new_n135_));
  ...
  nand3  g105(.a(new_n49_), .b(new_n77_), .c(new_n48_), .O(new_n139_));
  oai22  g106(.a(new_n139_), .b(new_n108_), .c(new_n138_), .d(new_n86_), .O(new_n140_));
  aoi22  g107(.a(new_n140_), .b(new_n39_), .c(new_n137_), .d(new_n99_), .O(new_n141_));
  nand2  g108(.a(new_n141_), .b(new_n133_), .O(z3));
  nand2  g109(.a(new_n46_), .b(new_n38_), .O(z5));
  inv1   g110(.a(x03), .O(new_n145_));
  aoi21  g111(.a(x20), .b(new_n77_), .c(x06), .O(new_n146_));
  oai21  g112(.a(new_n146_), .b(x11), .c(new_n145_), .O(new_n147_));
  nand2  g113(.a(new_n147_), .b(z5), .O(new_n148_));
  nand2  g114(.a(new_n122_), .b(new_n117_), .O(z7));
  aoi21  g115(.a(new_n78_), .b(x14), .c(new_n47_), .O(new_n150_));
  oai21  g116(.a(new_n150_), .b(new_n48_), .c(x03), .O(new_n151_));
  nand2  g117(.a(new_n151_), .b(z7), .O(new_n152_));
  nand2  g118(.a(new_n152_), .b(new_n148_), .O(z6));
  zero   g119(.O(z4));
endmodule
