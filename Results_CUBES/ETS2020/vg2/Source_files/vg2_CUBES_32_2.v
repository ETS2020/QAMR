...
module FAU ( 
  ...
  inv1   g35(.a(x11), .O(new_n74_));
  inv1   g36(.a(x06), .O(new_n75_));
  inv1   g37(.a(x20), .O(new_n76_));
  oai21  g38(.a(new_n76_), .b(x14), .c(new_n75_), .O(new_n77_));
  aoi21  g39(.a(new_n77_), .b(new_n74_), .c(x03), .O(new_n78_));
  inv1   g40(.a(x03), .O(new_n79_));
  inv1   g41(.a(x14), .O(new_n80_));
  oai21  g42(.a(x20), .b(new_n80_), .c(x06), .O(new_n81_));
  aoi21  g43(.a(new_n81_), .b(x11), .c(new_n79_), .O(new_n82_));
  oai22  g44(.a(new_n82_), .b(new_n71_), .c(new_n78_), .d(new_n56_), .O(z6));
  zero   g45(.O(z0));
  zero   g46(.O(z1));
  zero   g47(.O(z2));
  zero   g48(.O(z3));
