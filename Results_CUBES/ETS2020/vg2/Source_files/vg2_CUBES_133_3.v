...
module FAU ( 
  ...
  nand2  g070(.a(new_n104_), .b(x05), .O(new_n105_));
  nand3  g071(.a(new_n37_), .b(new_n35_), .c(x21), .O(new_n106_));
  nand3  g072(.a(x24), .b(x18), .c(x13), .O(new_n107_));
  nand2  g073(.a(new_n84_), .b(x15), .O(new_n108_));
  nand3  g074(.a(new_n108_), .b(new_n107_), .c(new_n106_), .O(new_n109_));
  inv1   g075(.a(new_n109_), .O(new_n110_));
  inv1   g076(.a(new_n40_), .O(new_n111_));
  nor2   g077(.a(new_n56_), .b(new_n63_), .O(new_n112_));
  nand4  g078(.a(new_n112_), .b(new_n111_), .c(x11), .d(x06), .O(new_n113_));
  aoi21  g079(.a(new_n110_), .b(new_n105_), .c(new_n113_), .O(z2));
  nor2   g080(.a(new_n63_), .b(new_n61_), .O(new_n115_));
  nand4  g081(.a(new_n115_), .b(new_n73_), .c(new_n39_), .d(x20), .O(new_n116_));
  nor2   g082(.a(x08), .b(x06), .O(new_n117_));
  nor3   g083(.a(x20), .b(x14), .c(x11), .O(new_n118_));
  nand4  g084(.a(new_n118_), .b(new_n117_), .c(new_n50_), .d(new_n49_), .O(new_n119_));
  nand2  g085(.a(new_n119_), .b(new_n116_), .O(new_n120_));
  nand2  g086(.a(new_n120_), .b(new_n35_), .O(new_n121_));
  nand4  g087(.a(x20), .b(x18), .c(x14), .d(x11), .O(new_n122_));
  nand4  g088(.a(new_n56_), .b(new_n63_), .c(new_n61_), .d(new_n93_), .O(new_n123_));
  nand3  g089(.a(new_n50_), .b(x07), .c(new_n78_), .O(new_n124_));
  oai22  g090(.a(new_n124_), .b(new_n123_), .c(new_n122_), .d(new_n72_), .O(new_n125_));
  nand4  g091(.a(x20), .b(x15), .c(x14), .d(x11), .O(new_n126_));
  nand3  g092(.a(new_n50_), .b(new_n63_), .c(new_n61_), .O(new_n127_));
  oai22  g093(.a(new_n127_), .b(new_n94_), .c(new_n126_), .d(new_n72_), .O(new_n128_));
  aoi22  g094(.a(new_n128_), .b(new_n84_), .c(new_n125_), .d(new_n85_), .O(new_n129_));
  nand2  g095(.a(new_n129_), .b(new_n121_), .O(z3));
  inv1   g096(.a(x05), .O(new_n132_));
  nand2  g097(.a(x24), .b(x07), .O(new_n133_));
  nand3  g098(.a(new_n35_), .b(x19), .c(x13), .O(new_n134_));
  aoi21  g099(.a(new_n134_), .b(new_n133_), .c(new_n132_), .O(new_n135_));
  nand2  g100(.a(new_n84_), .b(x19), .O(new_n136_));
  nand3  g101(.a(x24), .b(x13), .c(x07), .O(new_n137_));
  inv1   g102(.a(x02), .O(new_n138_));
  inv1   g103(.a(x10), .O(new_n139_));
  nand4  g104(.a(new_n35_), .b(new_n139_), .c(new_n138_), .d(x00), .O(new_n140_));
  nand3  g105(.a(new_n140_), .b(new_n137_), .c(new_n136_), .O(new_n141_));
  or2    g106(.a(new_n141_), .b(new_n135_), .O(z5));
  nand2  g107(.a(x20), .b(new_n63_), .O(new_n143_));
  aoi21  g108(.a(new_n143_), .b(new_n78_), .c(x11), .O(new_n144_));
  oai22  g109(.a(new_n144_), .b(x03), .c(new_n141_), .d(new_n135_), .O(new_n145_));
  nand2  g110(.a(new_n110_), .b(new_n105_), .O(z7));
  aoi21  g111(.a(new_n56_), .b(x14), .c(new_n78_), .O(new_n147_));
  oai21  g112(.a(new_n147_), .b(new_n61_), .c(x03), .O(new_n148_));
  nand2  g113(.a(new_n148_), .b(z7), .O(new_n149_));
  nand2  g114(.a(new_n149_), .b(new_n145_), .O(z6));
  zero   g115(.O(z0));
  zero   g116(.O(z4));
endmodule
