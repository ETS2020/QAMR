...
module FAU ( 
  ...
  inv1   g098(.a(x06), .O(new_n134_));
  oai21  g099(.a(new_n79_), .b(x14), .c(new_n134_), .O(new_n135_));
  aoi21  g100(.a(new_n135_), .b(new_n76_), .c(x03), .O(new_n136_));
  inv1   g101(.a(x03), .O(new_n137_));
  oai21  g102(.a(x20), .b(new_n78_), .c(x06), .O(new_n138_));
  aoi21  g103(.a(new_n138_), .b(x11), .c(new_n137_), .O(new_n139_));
  oai22  g104(.a(new_n139_), .b(new_n119_), .c(new_n136_), .d(new_n46_), .O(z6));
  inv1   g105(.a(new_n119_), .O(z7));
  zero   g106(.O(z3));
  zero   g107(.O(z5));
endmodule
