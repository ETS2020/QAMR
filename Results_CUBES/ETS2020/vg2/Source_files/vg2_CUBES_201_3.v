...
module FAU ( 
  ...
  oai21  g110(.a(new_n57_), .b(x14), .c(new_n51_), .O(new_n147_));
  aoi21  g111(.a(new_n147_), .b(new_n61_), .c(x03), .O(new_n148_));
  inv1   g112(.a(x03), .O(new_n149_));
  oai21  g113(.a(x20), .b(new_n63_), .c(x06), .O(new_n150_));
  aoi21  g114(.a(new_n150_), .b(x11), .c(new_n149_), .O(new_n151_));
  oai22  g115(.a(new_n151_), .b(new_n144_), .c(new_n148_), .d(new_n133_), .O(z6));
  inv1   g116(.a(new_n144_), .O(z7));
  zero   g117(.O(z0));
  zero   g118(.O(z2));
  zero   g119(.O(z5));
endmodule
