...
module FAU ( 
  ...
  and2   g18(.a(x24), .b(x18), .O(new_n53_));
  nand2  g19(.a(x15), .b(x13), .O(new_n54_));
  nor2   g20(.a(new_n54_), .b(x24), .O(new_n55_));
  oai21  g21(.a(new_n55_), .b(new_n53_), .c(x05), .O(new_n56_));
  nor2   g22(.a(x10), .b(x02), .O(new_n57_));
  nand3  g23(.a(new_n57_), .b(new_n42_), .c(x21), .O(new_n58_));
  nand2  g24(.a(new_n53_), .b(x13), .O(new_n59_));
  ...
  aoi21  g31(.a(new_n62_), .b(new_n56_), .c(new_n65_), .O(z2));
  ...
  nand2  g60(.a(new_n62_), .b(new_n56_), .O(z7));
  zero   g61(.O(z1));
  zero   g62(.O(z4));
  zero   g63(.O(z5));
  zero   g64(.O(z6));
