...
module FAU ( 
  ...
  aoi21  g084(.a(new_n121_), .b(new_n78_), .c(x11), .O(new_n122_));
  ...
  nand2  g089(.a(new_n84_), .b(x19), .O(new_n127_));
  ...
  inv1   g096(.a(x03), .O(new_n134_));
  nand2  g097(.a(new_n56_), .b(x14), .O(new_n135_));
  aoi21  g098(.a(new_n135_), .b(x06), .c(new_n61_), .O(new_n136_));
  nand2  g099(.a(x24), .b(x18), .O(new_n137_));
  nand3  g100(.a(new_n35_), .b(x15), .c(x13), .O(new_n138_));
  aoi21  g101(.a(new_n138_), .b(new_n137_), .c(new_n123_), .O(new_n139_));
  nand3  g102(.a(new_n37_), .b(new_n35_), .c(x21), .O(new_n140_));
  nand3  g103(.a(x24), .b(x18), .c(x13), .O(new_n141_));
  nand2  g104(.a(new_n84_), .b(x15), .O(new_n142_));
  nand3  g105(.a(new_n142_), .b(new_n141_), .c(new_n140_), .O(new_n143_));
  oai22  g106(.a(new_n143_), .b(new_n139_), .c(new_n136_), .d(new_n134_), .O(new_n144_));
  nand2  g107(.a(new_n144_), .b(new_n133_), .O(z6));
  or2    g108(.a(new_n143_), .b(new_n139_), .O(z7));
  zero   g109(.O(z0));
  zero   g110(.O(z2));
  zero   g111(.O(z4));
  zero   g112(.O(z5));
