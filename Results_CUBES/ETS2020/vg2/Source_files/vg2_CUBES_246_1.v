...
module FAU ( 
  ...
  oai21  g71(.a(new_n48_), .b(x14), .c(new_n64_), .O(new_n107_));
  aoi21  g72(.a(new_n107_), .b(new_n65_), .c(x03), .O(new_n108_));
  ...
  oai22  g76(.a(new_n111_), .b(new_n62_), .c(new_n108_), .d(new_n46_), .O(z6));
  inv1   g77(.a(new_n62_), .O(z7));
  zero   g78(.O(z1));
  zero   g79(.O(z5));
endmodule
