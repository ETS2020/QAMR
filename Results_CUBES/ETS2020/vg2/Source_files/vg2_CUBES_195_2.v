...
module FAU ( 
  ...
  nand2  g50(.a(new_n83_), .b(new_n35_), .O(new_n84_));
  ...
  nor2   g59(.a(x12), .b(new_n34_), .O(new_n93_));
  nand4  g60(.a(new_n93_), .b(new_n68_), .c(new_n49_), .d(new_n48_), .O(new_n94_));
  nor2   g61(.a(x17), .b(x16), .O(new_n95_));
  nor2   g62(.a(x23), .b(x22), .O(new_n96_));
  nor3   g63(.a(x04), .b(x03), .c(x01), .O(new_n97_));
  nand3  g64(.a(new_n97_), .b(new_n96_), .c(new_n95_), .O(new_n98_));
  oai21  g65(.a(new_n98_), .b(new_n94_), .c(new_n92_), .O(new_n99_));
  nor2   g66(.a(new_n39_), .b(new_n35_), .O(new_n100_));
  nand2  g67(.a(new_n100_), .b(new_n99_), .O(new_n101_));
  nand4  g68(.a(x16), .b(x15), .c(x14), .d(x12), .O(new_n102_));
  nor2   g69(.a(new_n102_), .b(new_n60_), .O(new_n103_));
  nand3  g70(.a(new_n103_), .b(new_n88_), .c(new_n86_), .O(new_n104_));
  nor2   g71(.a(x14), .b(x12), .O(new_n105_));
  nand4  g72(.a(new_n105_), .b(new_n96_), .c(new_n68_), .d(new_n48_), .O(new_n106_));
  nand4  g73(.a(new_n97_), .b(new_n95_), .c(new_n79_), .d(x19), .O(new_n107_));
  oai21  g74(.a(new_n107_), .b(new_n106_), .c(new_n104_), .O(new_n108_));
  nand2  g75(.a(new_n108_), .b(new_n39_), .O(new_n109_));
  nand3  g76(.a(new_n109_), .b(new_n101_), .c(new_n84_), .O(z1));
  nand2  g77(.a(new_n46_), .b(new_n38_), .O(z5));
  inv1   g78(.a(x03), .O(new_n115_));
  aoi21  g79(.a(x20), .b(new_n78_), .c(x06), .O(new_n116_));
  oai21  g80(.a(new_n116_), .b(x11), .c(new_n115_), .O(new_n117_));
  nand2  g81(.a(new_n117_), .b(z5), .O(new_n118_));
  nand2  g82(.a(new_n79_), .b(x14), .O(new_n119_));
  aoi21  g83(.a(new_n119_), .b(x06), .c(new_n76_), .O(new_n120_));
  inv1   g84(.a(x05), .O(new_n121_));
  nand2  g85(.a(x24), .b(x18), .O(new_n122_));
  nand3  g86(.a(new_n35_), .b(x15), .c(x13), .O(new_n123_));
  aoi21  g87(.a(new_n123_), .b(new_n122_), .c(new_n121_), .O(new_n124_));
  nand3  g88(.a(new_n53_), .b(new_n35_), .c(x21), .O(new_n125_));
  nand3  g89(.a(x24), .b(x18), .c(x13), .O(new_n126_));
  nand2  g90(.a(new_n39_), .b(x15), .O(new_n127_));
  nand3  g91(.a(new_n127_), .b(new_n126_), .c(new_n125_), .O(new_n128_));
  oai22  g92(.a(new_n128_), .b(new_n124_), .c(new_n120_), .d(new_n115_), .O(new_n129_));
  nand2  g93(.a(new_n129_), .b(new_n118_), .O(z6));
  zero   g94(.O(z2));
  zero   g95(.O(z3));
  zero   g96(.O(z4));
  zero   g97(.O(z7));
