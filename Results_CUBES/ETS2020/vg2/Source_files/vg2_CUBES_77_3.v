// Benchmark "FAU" written by ABC on Tue Jul  7 17:33:49 2020
...
module FAU ( 
  ...
  and2   g76(.a(x24), .b(x18), .O(new_n110_));
  nand2  g77(.a(x15), .b(x13), .O(new_n111_));
  nor2   g78(.a(new_n111_), .b(x24), .O(new_n112_));
  oai21  g79(.a(new_n112_), .b(new_n110_), .c(x05), .O(new_n113_));
  nand3  g80(.a(new_n52_), .b(new_n35_), .c(x21), .O(new_n114_));
  aoi22  g81(.a(new_n110_), .b(x13), .c(new_n38_), .d(x15), .O(new_n115_));
  nand2  g82(.a(new_n115_), .b(new_n114_), .O(new_n116_));
  inv1   g83(.a(new_n116_), .O(new_n117_));
  inv1   g84(.a(new_n55_), .O(new_n118_));
  nor2   g85(.a(new_n78_), .b(new_n77_), .O(new_n119_));
  nand4  g86(.a(new_n119_), .b(new_n118_), .c(x11), .d(x06), .O(new_n120_));
  aoi21  g87(.a(new_n117_), .b(new_n113_), .c(new_n120_), .O(z2));
  nand2  g88(.a(new_n117_), .b(new_n113_), .O(z7));
  zero   g89(.O(z3));
  zero   g90(.O(z4));
  zero   g91(.O(z5));
  zero   g92(.O(z6));
