// Benchmark "FAU" written by ABC on Tue Jul  7 17:33:28 2020
...
module FAU ( 
  ...
  nand3  g083(.a(new_n54_), .b(new_n35_), .c(x21), .O(new_n117_));
  ...
  nand4  g094(.a(new_n127_), .b(new_n126_), .c(new_n66_), .d(new_n49_), .O(new_n128_));
  ...
  oai22  g100(.a(new_n133_), .b(new_n132_), .c(new_n131_), .d(new_n86_), .O(new_n134_));
  nand4  g101(.a(x20), .b(x15), .c(x14), .d(x11), .O(new_n135_));
  nand3  g102(.a(new_n49_), .b(new_n77_), .c(new_n48_), .O(new_n136_));
  oai22  g103(.a(new_n136_), .b(new_n108_), .c(new_n135_), .d(new_n86_), .O(new_n137_));
  aoi22  g104(.a(new_n137_), .b(new_n39_), .c(new_n134_), .d(new_n99_), .O(new_n138_));
  nand2  g105(.a(new_n138_), .b(new_n130_), .O(z3));
  nand2  g106(.a(new_n46_), .b(new_n38_), .O(z5));
  zero   g107(.O(z4));
  zero   g108(.O(z6));
  zero   g109(.O(z7));
endmodule
