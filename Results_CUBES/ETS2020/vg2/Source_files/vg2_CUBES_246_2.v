// Benchmark "FAU" written by ABC on Tue Jul  7 17:34:42 2020
...
module FAU ( 
  ...
  aoi21  g070(.a(new_n59_), .b(x04), .c(x17), .O(new_n107_));
  oai21  g071(.a(new_n107_), .b(x22), .c(new_n81_), .O(new_n108_));
  aoi21  g072(.a(new_n108_), .b(new_n64_), .c(x08), .O(new_n109_));
  inv1   g073(.a(x05), .O(new_n110_));
  nand2  g074(.a(x24), .b(x07), .O(new_n111_));
  nand3  g075(.a(new_n35_), .b(x19), .c(x13), .O(new_n112_));
  aoi21  g076(.a(new_n112_), .b(new_n111_), .c(new_n110_), .O(new_n113_));
  nand2  g077(.a(new_n89_), .b(x19), .O(new_n114_));
  nand3  g078(.a(x24), .b(x13), .c(x07), .O(new_n115_));
  inv1   g079(.a(x02), .O(new_n116_));
  inv1   g080(.a(x10), .O(new_n117_));
  nand4  g081(.a(new_n35_), .b(new_n117_), .c(new_n116_), .d(x00), .O(new_n118_));
  nand3  g082(.a(new_n118_), .b(new_n115_), .c(new_n114_), .O(new_n119_));
  nor2   g083(.a(new_n119_), .b(new_n113_), .O(new_n120_));
  inv1   g084(.a(x04), .O(new_n121_));
  aoi21  g085(.a(x23), .b(new_n121_), .c(new_n56_), .O(new_n122_));
  oai21  g086(.a(new_n122_), .b(new_n58_), .c(x09), .O(new_n123_));
  aoi21  g087(.a(new_n123_), .b(x16), .c(new_n80_), .O(new_n124_));
  nand2  g088(.a(x24), .b(x18), .O(new_n125_));
  nand3  g089(.a(new_n35_), .b(x15), .c(x13), .O(new_n126_));
  aoi21  g090(.a(new_n126_), .b(new_n125_), .c(new_n110_), .O(new_n127_));
  nand3  g091(.a(new_n37_), .b(new_n35_), .c(x21), .O(new_n128_));
  nand3  g092(.a(x24), .b(x18), .c(x13), .O(new_n129_));
  nand2  g093(.a(new_n89_), .b(x15), .O(new_n130_));
  nand3  g094(.a(new_n130_), .b(new_n129_), .c(new_n128_), .O(new_n131_));
  nor2   g095(.a(new_n131_), .b(new_n127_), .O(new_n132_));
  oai22  g096(.a(new_n132_), .b(new_n124_), .c(new_n120_), .d(new_n109_), .O(z4));
  inv1   g097(.a(new_n120_), .O(z5));
  zero   g098(.O(z0));
  zero   g099(.O(z2));
  zero   g100(.O(z3));
  zero   g101(.O(z6));
