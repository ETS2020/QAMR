...
module FAU ( 
  ...
  nand2  g070(.a(x20), .b(new_n63_), .O(new_n109_));
  aoi21  g071(.a(new_n109_), .b(new_n79_), .c(x11), .O(new_n110_));
  inv1   g072(.a(x05), .O(new_n111_));
  nand2  g073(.a(x24), .b(x07), .O(new_n112_));
  nand3  g074(.a(new_n35_), .b(x19), .c(x13), .O(new_n113_));
  aoi21  g075(.a(new_n113_), .b(new_n112_), .c(new_n111_), .O(new_n114_));
  nand2  g076(.a(new_n89_), .b(x19), .O(new_n115_));
  nand3  g077(.a(x24), .b(x13), .c(x07), .O(new_n116_));
  inv1   g078(.a(x02), .O(new_n117_));
  inv1   g079(.a(x10), .O(new_n118_));
  nand4  g080(.a(new_n35_), .b(new_n118_), .c(new_n117_), .d(x00), .O(new_n119_));
  nand3  g081(.a(new_n119_), .b(new_n116_), .c(new_n115_), .O(new_n120_));
  oai22  g082(.a(new_n120_), .b(new_n114_), .c(new_n110_), .d(x03), .O(new_n121_));
  inv1   g083(.a(x03), .O(new_n122_));
  nand2  g084(.a(new_n57_), .b(x14), .O(new_n123_));
  aoi21  g085(.a(new_n123_), .b(x06), .c(new_n61_), .O(new_n124_));
  nand2  g086(.a(x24), .b(x18), .O(new_n125_));
  nand3  g087(.a(new_n35_), .b(x15), .c(x13), .O(new_n126_));
  aoi21  g088(.a(new_n126_), .b(new_n125_), .c(new_n111_), .O(new_n127_));
  nand3  g089(.a(new_n37_), .b(new_n35_), .c(x21), .O(new_n128_));
  nand3  g090(.a(x24), .b(x18), .c(x13), .O(new_n129_));
  nand2  g091(.a(new_n89_), .b(x15), .O(new_n130_));
  nand3  g092(.a(new_n130_), .b(new_n129_), .c(new_n128_), .O(new_n131_));
  oai22  g093(.a(new_n131_), .b(new_n127_), .c(new_n124_), .d(new_n122_), .O(new_n132_));
  nand2  g094(.a(new_n132_), .b(new_n121_), .O(z6));
  or2    g095(.a(new_n131_), .b(new_n127_), .O(z7));
  zero   g096(.O(z0));
  zero   g097(.O(z2));
  zero   g098(.O(z3));
  zero   g099(.O(z4));
