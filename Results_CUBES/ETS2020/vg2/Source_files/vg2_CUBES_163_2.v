...
module FAU ( 
  ...
  oai21  g099(.a(new_n57_), .b(x14), .c(new_n79_), .O(new_n136_));
  aoi21  g100(.a(new_n136_), .b(new_n61_), .c(x03), .O(new_n137_));
  inv1   g101(.a(x03), .O(new_n138_));
  oai21  g102(.a(x20), .b(new_n63_), .c(x06), .O(new_n139_));
  aoi21  g103(.a(new_n139_), .b(x11), .c(new_n138_), .O(new_n140_));
  oai22  g104(.a(new_n140_), .b(new_n113_), .c(new_n137_), .d(new_n129_), .O(z6));
  inv1   g105(.a(new_n113_), .O(z7));
  zero   g106(.O(z0));
  zero   g107(.O(z3));
  zero   g108(.O(z5));
endmodule
