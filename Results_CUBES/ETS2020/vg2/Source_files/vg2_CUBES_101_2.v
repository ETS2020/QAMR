// Benchmark "FAU" written by ABC on Tue Jul  7 17:33:57 2020
...
module FAU ( 
  ...
  nor2   g080(.a(new_n77_), .b(new_n48_), .O(new_n115_));
  nand4  g081(.a(new_n115_), .b(new_n87_), .c(new_n56_), .d(x20), .O(new_n116_));
  nor2   g082(.a(x08), .b(x06), .O(new_n117_));
  nor3   g083(.a(x20), .b(x14), .c(x11), .O(new_n118_));
  nand4  g084(.a(new_n118_), .b(new_n117_), .c(new_n66_), .d(new_n49_), .O(new_n119_));
  ...
  nand3  g088(.a(new_n50_), .b(new_n48_), .c(new_n107_), .O(new_n123_));
  nand3  g089(.a(new_n49_), .b(x07), .c(new_n47_), .O(new_n124_));
  oai22  g090(.a(new_n124_), .b(new_n123_), .c(new_n122_), .d(new_n86_), .O(new_n125_));
  nand4  g091(.a(x20), .b(x15), .c(x14), .d(x11), .O(new_n126_));
  nand3  g092(.a(new_n49_), .b(new_n77_), .c(new_n48_), .O(new_n127_));
  oai22  g093(.a(new_n127_), .b(new_n108_), .c(new_n126_), .d(new_n86_), .O(new_n128_));
  aoi22  g094(.a(new_n128_), .b(new_n39_), .c(new_n125_), .d(new_n99_), .O(new_n129_));
  nand2  g095(.a(new_n129_), .b(new_n121_), .O(z3));
  nand2  g096(.a(new_n46_), .b(new_n38_), .O(z5));
  inv1   g097(.a(x03), .O(new_n133_));
  aoi21  g098(.a(x20), .b(new_n77_), .c(x06), .O(new_n134_));
  oai21  g099(.a(new_n134_), .b(x11), .c(new_n133_), .O(new_n135_));
  nand2  g100(.a(new_n135_), .b(z5), .O(new_n136_));
  nand2  g101(.a(new_n78_), .b(x14), .O(new_n137_));
  aoi21  g102(.a(new_n137_), .b(x06), .c(new_n48_), .O(new_n138_));
  inv1   g103(.a(x05), .O(new_n139_));
  nand2  g104(.a(x24), .b(x18), .O(new_n140_));
  nand3  g105(.a(new_n35_), .b(x15), .c(x13), .O(new_n141_));
  aoi21  g106(.a(new_n141_), .b(new_n140_), .c(new_n139_), .O(new_n142_));
  nand3  g107(.a(new_n54_), .b(new_n35_), .c(x21), .O(new_n143_));
  nand3  g108(.a(x24), .b(x18), .c(x13), .O(new_n144_));
  nand2  g109(.a(new_n39_), .b(x15), .O(new_n145_));
  nand3  g110(.a(new_n145_), .b(new_n144_), .c(new_n143_), .O(new_n146_));
  oai22  g111(.a(new_n146_), .b(new_n142_), .c(new_n138_), .d(new_n133_), .O(new_n147_));
  nand2  g112(.a(new_n147_), .b(new_n136_), .O(z6));
  or2    g113(.a(new_n146_), .b(new_n142_), .O(z7));
  zero   g114(.O(z2));
  zero   g115(.O(z4));
endmodule
