...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n24_, new_n25_, new_n26_, new_n27_, new_n28_,
    ...
    new_n38_, new_n39_, new_n40_, new_n41_, new_n44_, new_n45_;
  ...
  nand2  g21(.a(x08), .b(x03), .O(new_n44_));
  nand3  g22(.a(x15), .b(x14), .c(x10), .O(new_n45_));
  nor2   g23(.a(new_n45_), .b(new_n44_), .O(z4));
  zero   g24(.O(z3));
endmodule
