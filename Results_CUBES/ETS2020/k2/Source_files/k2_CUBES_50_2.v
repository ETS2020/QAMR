...
module FAU ( 
  ...
  inv1   g02(.a(x21), .O(new_n117_));
  nand2  g03(.a(new_n117_), .b(x20), .O(new_n118_));
  nor4   g04(.a(new_n118_), .b(new_n116_), .c(x19), .d(x18), .O(z24));
  inv1   g05(.a(x20), .O(new_n125_));
  inv1   g06(.a(x18), .O(new_n126_));
  nand4  g07(.a(x28), .b(x22), .c(x19), .d(new_n126_), .O(new_n127_));
  inv1   g08(.a(x28), .O(new_n128_));
  nor2   g09(.a(new_n126_), .b(x17), .O(new_n129_));
  inv1   g10(.a(x26), .O(new_n130_));
  nor2   g11(.a(new_n130_), .b(x19), .O(new_n131_));
  nand3  g12(.a(new_n131_), .b(new_n129_), .c(new_n128_), .O(new_n132_));
  aoi21  g13(.a(new_n132_), .b(new_n127_), .c(new_n125_), .O(new_n133_));
  ...
  nor2   g19(.a(x27), .b(new_n125_), .O(new_n139_));
  ...
  nand3  g23(.a(new_n142_), .b(x29), .c(new_n117_), .O(new_n143_));
