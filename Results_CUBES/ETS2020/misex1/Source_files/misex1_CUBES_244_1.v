// Benchmark "FAU" written by ABC on Tue Jul  7 10:53:12 2020
...
module FAU ( 
  ...
  nand3  g47(.a(new_n46_), .b(x2), .c(new_n21_), .O(new_n64_));
  inv1   g48(.a(new_n64_), .O(new_n65_));
  oai21  g49(.a(new_n65_), .b(new_n53_), .c(new_n17_), .O(new_n66_));
  oai21  g50(.a(x4), .b(x2), .c(new_n20_), .O(new_n67_));
  nand2  g51(.a(new_n67_), .b(new_n18_), .O(new_n68_));
  nand2  g52(.a(new_n68_), .b(new_n66_), .O(z6));
  zero   g53(.O(z5));
endmodule
