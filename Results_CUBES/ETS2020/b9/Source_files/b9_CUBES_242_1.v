// Benchmark "FAU" written by ABC on Thu Jul  9 23:04:52 2020
...
module FAU ( 
  ...
  nand4  g40(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n105_));
  inv1   g41(.a(new_n105_), .O(z09));
  nand3  g42(.a(x40), .b(x39), .c(x29), .O(new_n108_));
  oai21  g43(.a(new_n84_), .b(new_n64_), .c(new_n74_), .O(new_n109_));
  nand2  g44(.a(new_n109_), .b(new_n108_), .O(new_n110_));
  inv1   g45(.a(x08), .O(new_n111_));
  nand3  g46(.a(new_n74_), .b(x27), .c(new_n64_), .O(new_n112_));
  nand2  g47(.a(new_n112_), .b(new_n111_), .O(new_n113_));
  nor2   g48(.a(x30), .b(x09), .O(new_n114_));
  inv1   g49(.a(new_n114_), .O(new_n115_));
  aoi21  g50(.a(new_n113_), .b(new_n110_), .c(new_n115_), .O(z11));
  nor2   g51(.a(new_n77_), .b(x04), .O(new_n118_));
  nand2  g52(.a(x36), .b(x35), .O(new_n119_));
  nand2  g53(.a(new_n119_), .b(x28), .O(new_n120_));
  nor2   g54(.a(new_n78_), .b(x13), .O(new_n121_));
  nand3  g55(.a(new_n121_), .b(new_n120_), .c(new_n118_), .O(new_n122_));
  inv1   g56(.a(new_n66_), .O(new_n123_));
  nor2   g57(.a(x19), .b(x18), .O(new_n124_));
  nand3  g58(.a(new_n124_), .b(new_n123_), .c(x20), .O(new_n125_));
  nand2  g59(.a(new_n125_), .b(new_n122_), .O(new_n126_));
  nand2  g60(.a(new_n126_), .b(x27), .O(new_n127_));
  or2    g61(.a(x32), .b(x30), .O(new_n128_));
  nand3  g62(.a(new_n128_), .b(new_n121_), .c(new_n118_), .O(new_n129_));
  nand2  g63(.a(new_n129_), .b(new_n127_), .O(z13));
  nand4  g64(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n132_));
  inv1   g65(.a(new_n132_), .O(z15));
  ...
  nand2  g71(.a(new_n74_), .b(new_n84_), .O(new_n139_));
  nand2  g72(.a(new_n139_), .b(new_n108_), .O(new_n140_));
  nand2  g73(.a(new_n140_), .b(x08), .O(new_n141_));
  nand3  g74(.a(new_n141_), .b(new_n114_), .c(new_n112_), .O(z18));
  oai21  g75(.a(new_n73_), .b(new_n84_), .c(new_n111_), .O(new_n143_));
  oai21  g76(.a(new_n82_), .b(x27), .c(x35), .O(new_n144_));
  nand2  g77(.a(new_n144_), .b(new_n108_), .O(new_n145_));
  aoi21  g78(.a(new_n145_), .b(new_n143_), .c(new_n115_), .O(z20));
  zero   g79(.O(z01));
  zero   g80(.O(z08));
  zero   g81(.O(z10));
  zero   g82(.O(z12));
  zero   g83(.O(z14));
  aoi21  g84(.a(new_n113_), .b(new_n110_), .c(new_n115_), .O(z19));
endmodule
