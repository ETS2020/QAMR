// Benchmark "FAU" written by ABC on Thu Jul  9 22:49:01 2020
...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n116_, new_n117_, new_n118_, new_n121_, new_n125_, new_n126_,
  ...
  oai22  g35(.a(new_n82_), .b(x04), .c(new_n66_), .d(new_n72_), .O(new_n104_));
  oai21  g36(.a(new_n103_), .b(x10), .c(new_n104_), .O(z12));
  inv1   g37(.a(x13), .O(new_n106_));
  inv1   g38(.a(x39), .O(new_n107_));
  nor2   g39(.a(new_n107_), .b(x04), .O(new_n108_));
  nand2  g40(.a(x36), .b(x35), .O(new_n109_));
  nand2  g41(.a(new_n109_), .b(x28), .O(new_n110_));
  nand4  g42(.a(new_n110_), .b(new_n108_), .c(x40), .d(new_n106_), .O(new_n111_));
  inv1   g43(.a(new_n66_), .O(new_n112_));
  nor2   g44(.a(x19), .b(x18), .O(new_n113_));
  nand3  g45(.a(new_n113_), .b(new_n112_), .c(x20), .O(new_n114_));
  nand2  g46(.a(new_n114_), .b(new_n111_), .O(new_n115_));
  nand2  g47(.a(new_n115_), .b(x27), .O(new_n116_));
  nor2   g48(.a(new_n77_), .b(new_n82_), .O(new_n117_));
  nand3  g49(.a(new_n117_), .b(new_n106_), .c(new_n64_), .O(new_n118_));
  nand2  g50(.a(new_n118_), .b(new_n116_), .O(z13));
  nand4  g51(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n121_));
  inv1   g52(.a(new_n121_), .O(z15));
  inv1   g53(.a(x29), .O(new_n125_));
  oai22  g54(.a(new_n75_), .b(x27), .c(new_n82_), .d(new_n125_), .O(new_n126_));
  nand2  g55(.a(new_n126_), .b(x08), .O(new_n127_));
  nand4  g56(.a(x35), .b(new_n74_), .c(x27), .d(new_n64_), .O(new_n128_));
  nor2   g57(.a(x30), .b(x09), .O(new_n129_));
  nand3  g58(.a(new_n129_), .b(new_n128_), .c(new_n127_), .O(z18));
  zero   g59(.O(z03));
  zero   g60(.O(z04));
  zero   g61(.O(z06));
  zero   g62(.O(z07));
