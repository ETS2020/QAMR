...
module FAU ( 
  ...
  oai21  g63(.a(new_n94_), .b(x27), .c(new_n101_), .O(new_n132_));
  nand2  g64(.a(new_n132_), .b(x08), .O(new_n133_));
  nand3  g65(.a(new_n133_), .b(new_n108_), .c(new_n106_), .O(z18));
  oai21  g66(.a(new_n75_), .b(new_n77_), .c(new_n104_), .O(new_n135_));
  oai21  g67(.a(new_n74_), .b(x27), .c(x35), .O(new_n136_));
  nand2  g68(.a(new_n136_), .b(new_n101_), .O(new_n137_));
  aoi21  g69(.a(new_n137_), .b(new_n135_), .c(new_n109_), .O(z20));
  zero   g70(.O(z01));
  zero   g71(.O(z02));
  zero   g72(.O(z07));
  zero   g73(.O(z12));
  zero   g74(.O(z14));
  zero   g75(.O(z16));
  aoi21  g76(.a(new_n107_), .b(new_n103_), .c(new_n109_), .O(z19));
endmodule
