...
module FAU ( 
  ...
  nand2  g44(.a(x27), .b(new_n105_), .O(new_n109_));
  oai21  g45(.a(new_n109_), .b(new_n67_), .c(new_n108_), .O(new_n110_));
  inv1   g46(.a(x09), .O(new_n111_));
  nand2  g47(.a(new_n69_), .b(new_n111_), .O(new_n112_));
  ...
  oai21  g82(.a(new_n136_), .b(new_n64_), .c(new_n108_), .O(new_n149_));
  oai21  g83(.a(new_n66_), .b(x27), .c(x35), .O(new_n150_));
  nand2  g84(.a(new_n150_), .b(new_n104_), .O(new_n151_));
  aoi21  g85(.a(new_n151_), .b(new_n149_), .c(new_n112_), .O(z20));
  zero   g86(.O(z00));
  zero   g87(.O(z10));
  zero   g88(.O(z15));
  zero   g89(.O(z18));
