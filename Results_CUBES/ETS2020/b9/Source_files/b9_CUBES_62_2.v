// Benchmark "FAU" written by ABC on Thu Jul  9 22:52:13 2020
...
module FAU ( 
  ...
  inv1   g83(.a(x29), .O(new_n151_));
  oai22  g84(.a(new_n75_), .b(x27), .c(new_n82_), .d(new_n151_), .O(new_n152_));
  nand2  g85(.a(new_n152_), .b(x08), .O(new_n153_));
  nand4  g86(.a(x35), .b(new_n74_), .c(x27), .d(new_n64_), .O(new_n154_));
  nor2   g87(.a(x30), .b(x09), .O(new_n155_));
  nand3  g88(.a(new_n155_), .b(new_n154_), .c(new_n153_), .O(z18));
  zero   g89(.O(z03));
  zero   g90(.O(z04));
  zero   g91(.O(z06));
  zero   g92(.O(z11));
