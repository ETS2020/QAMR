// Benchmark "FAU" written by ABC on Thu Jul  9 22:53:31 2020
...
module FAU ( 
  ...
  nand2  g36(.a(new_n75_), .b(x07), .O(new_n101_));
  nand3  g37(.a(x40), .b(x39), .c(x05), .O(new_n102_));
  nand2  g38(.a(new_n102_), .b(new_n101_), .O(new_n103_));
  nand3  g39(.a(x40), .b(x39), .c(x05), .O(new_n104_));
  nor2   g40(.a(new_n104_), .b(new_n69_), .O(new_n105_));
  aoi21  g41(.a(new_n103_), .b(new_n68_), .c(new_n105_), .O(new_n106_));
  ...
  nor2   g46(.a(new_n64_), .b(new_n110_), .O(new_n111_));
  ...
  nor2   g54(.a(x36), .b(x35), .O(new_n119_));
  aoi21  g55(.a(new_n119_), .b(new_n80_), .c(new_n64_), .O(new_n120_));
  nand2  g56(.a(new_n78_), .b(new_n80_), .O(new_n121_));
  nand2  g57(.a(new_n121_), .b(x27), .O(new_n122_));
  oai21  g58(.a(new_n75_), .b(x04), .c(new_n122_), .O(new_n123_));
  oai21  g59(.a(new_n120_), .b(x10), .c(new_n123_), .O(z12));
  nor2   g60(.a(x19), .b(x18), .O(new_n126_));
  nand2  g61(.a(new_n126_), .b(x20), .O(new_n127_));
  inv1   g62(.a(x30), .O(new_n128_));
  inv1   g63(.a(x32), .O(new_n129_));
  nand2  g64(.a(x36), .b(x35), .O(new_n130_));
  nand4  g65(.a(new_n130_), .b(new_n129_), .c(new_n128_), .d(x28), .O(new_n131_));
  inv1   g66(.a(new_n131_), .O(new_n132_));
  nor2   g67(.a(x13), .b(x04), .O(new_n133_));
  nand2  g68(.a(new_n133_), .b(z08), .O(new_n134_));
  oai21  g69(.a(new_n134_), .b(new_n132_), .c(new_n127_), .O(new_n135_));
  inv1   g70(.a(x35), .O(new_n136_));
  nand3  g71(.a(new_n80_), .b(new_n136_), .c(x28), .O(new_n137_));
  nand2  g72(.a(new_n137_), .b(x27), .O(new_n138_));
  nand2  g73(.a(new_n138_), .b(new_n69_), .O(new_n139_));
  nand2  g74(.a(new_n134_), .b(new_n122_), .O(new_n140_));
  nand3  g75(.a(new_n140_), .b(new_n139_), .c(new_n135_), .O(z14));
  nand2  g76(.a(x22), .b(x01), .O(new_n143_));
  nor2   g77(.a(new_n143_), .b(x23), .O(z16));
  inv1   g78(.a(x24), .O(new_n145_));
  nand4  g79(.a(new_n145_), .b(x23), .c(x22), .d(x01), .O(new_n146_));
  inv1   g80(.a(new_n146_), .O(z17));
  oai21  g81(.a(new_n67_), .b(x27), .c(new_n109_), .O(new_n148_));
  nand2  g82(.a(new_n148_), .b(x08), .O(new_n149_));
  nand3  g83(.a(new_n149_), .b(new_n116_), .c(new_n114_), .O(z18));
  oai21  g84(.a(new_n136_), .b(new_n64_), .c(new_n113_), .O(new_n151_));
  oai21  g85(.a(new_n66_), .b(x27), .c(x35), .O(new_n152_));
  nand2  g86(.a(new_n152_), .b(new_n109_), .O(new_n153_));
  aoi21  g87(.a(new_n153_), .b(new_n151_), .c(new_n117_), .O(z20));
  zero   g88(.O(z00));
  zero   g89(.O(z09));
  zero   g90(.O(z13));
  zero   g91(.O(z15));
  aoi21  g92(.a(new_n115_), .b(new_n112_), .c(new_n117_), .O(z19));
endmodule
