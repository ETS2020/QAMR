...
module FAU ( 
  ...
  oai21  g70(.a(new_n67_), .b(x27), .c(new_n108_), .O(new_n138_));
  nand2  g71(.a(new_n138_), .b(x08), .O(new_n139_));
  nand3  g72(.a(new_n139_), .b(new_n115_), .c(new_n113_), .O(z18));
  oai21  g73(.a(new_n119_), .b(new_n75_), .c(new_n112_), .O(new_n141_));
  oai21  g74(.a(new_n66_), .b(x27), .c(x35), .O(new_n142_));
  nand2  g75(.a(new_n142_), .b(new_n108_), .O(new_n143_));
  aoi21  g76(.a(new_n143_), .b(new_n141_), .c(new_n116_), .O(z20));
  zero   g77(.O(z00));
  zero   g78(.O(z01));
  zero   g79(.O(z12));
  zero   g80(.O(z14));
  zero   g81(.O(z15));
  aoi21  g82(.a(new_n114_), .b(new_n111_), .c(new_n116_), .O(z19));
endmodule
