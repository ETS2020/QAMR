...
module FAU ( 
  ...
  nand2  g81(.a(z08), .b(x29), .O(new_n150_));
  oai21  g82(.a(new_n75_), .b(x27), .c(new_n150_), .O(new_n151_));
  ...
  inv1   g87(.a(new_n154_), .O(new_n156_));
  nor2   g88(.a(new_n72_), .b(new_n64_), .O(new_n157_));
  oai21  g89(.a(new_n157_), .b(new_n75_), .c(new_n150_), .O(new_n158_));
  inv1   g90(.a(x08), .O(new_n159_));
  nand2  g91(.a(new_n153_), .b(new_n159_), .O(new_n160_));
  aoi21  g92(.a(new_n160_), .b(new_n158_), .c(new_n156_), .O(z19));
  zero   g93(.O(z03));
  zero   g94(.O(z04));
  zero   g95(.O(z06));
  zero   g96(.O(z11));
