...
module FAU ( 
  ...
  oai21  g75(.a(new_n75_), .b(new_n77_), .c(new_n115_), .O(new_n143_));
  oai21  g76(.a(new_n74_), .b(x27), .c(x35), .O(new_n144_));
  nand2  g77(.a(new_n144_), .b(new_n112_), .O(new_n145_));
  aoi21  g78(.a(new_n145_), .b(new_n143_), .c(new_n118_), .O(z20));
  zero   g79(.O(z01));
  zero   g80(.O(z02));
  zero   g81(.O(z12));
  zero   g82(.O(z14));
  zero   g83(.O(z18));
  aoi21  g84(.a(new_n117_), .b(new_n114_), .c(new_n118_), .O(z19));
endmodule
