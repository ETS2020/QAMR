...
module FAU ( 
  ...
  inv1   g39(.a(x05), .O(new_n105_));
  nand2  g40(.a(new_n77_), .b(x07), .O(new_n106_));
  oai21  g41(.a(new_n77_), .b(new_n105_), .c(new_n106_), .O(new_n107_));
  inv1   g42(.a(x36), .O(new_n108_));
  aoi21  g43(.a(new_n75_), .b(new_n108_), .c(new_n83_), .O(new_n109_));
  inv1   g44(.a(x30), .O(new_n110_));
  inv1   g45(.a(x32), .O(new_n111_));
  nand3  g46(.a(x40), .b(x39), .c(x05), .O(new_n112_));
  aoi21  g47(.a(new_n111_), .b(new_n110_), .c(new_n112_), .O(new_n113_));
  aoi21  g48(.a(new_n109_), .b(new_n107_), .c(new_n113_), .O(new_n114_));
  nand3  g49(.a(x37), .b(x27), .c(x06), .O(new_n115_));
  oai21  g50(.a(new_n114_), .b(x04), .c(new_n115_), .O(z10));
  nand2  g51(.a(z08), .b(x29), .O(new_n117_));
  nor2   g52(.a(new_n83_), .b(new_n64_), .O(new_n118_));
  oai21  g53(.a(new_n118_), .b(new_n75_), .c(new_n117_), .O(new_n119_));
  inv1   g54(.a(x08), .O(new_n120_));
  nor2   g55(.a(new_n81_), .b(x28), .O(new_n121_));
  ...
  nand2  g59(.a(new_n110_), .b(new_n124_), .O(new_n125_));
  aoi21  g60(.a(new_n123_), .b(new_n119_), .c(new_n125_), .O(z11));
  ...
  nand2  g66(.a(new_n121_), .b(new_n83_), .O(new_n136_));
  nand2  g67(.a(new_n136_), .b(new_n117_), .O(new_n137_));
  nand2  g68(.a(new_n137_), .b(x08), .O(new_n138_));
  nand4  g69(.a(new_n138_), .b(new_n122_), .c(new_n110_), .d(new_n124_), .O(z18));
  oai21  g70(.a(new_n81_), .b(new_n83_), .c(new_n120_), .O(new_n140_));
  oai21  g71(.a(new_n74_), .b(x27), .c(x35), .O(new_n141_));
  nand2  g72(.a(new_n141_), .b(new_n117_), .O(new_n142_));
  aoi21  g73(.a(new_n142_), .b(new_n140_), .c(new_n125_), .O(z20));
  zero   g74(.O(z01));
  zero   g75(.O(z05));
  zero   g76(.O(z09));
  zero   g77(.O(z12));
  ...
  zero   g79(.O(z14));
  zero   g80(.O(z15));
  aoi21  g81(.a(new_n123_), .b(new_n119_), .c(new_n125_), .O(z19));
endmodule
