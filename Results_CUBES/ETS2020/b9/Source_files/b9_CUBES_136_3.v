// Benchmark "FAU" written by ABC on Thu Jul  9 22:57:26 2020
...
module FAU ( 
  ...
  oai21  g099(.a(new_n86_), .b(new_n72_), .c(new_n120_), .O(new_n164_));
  oai21  g100(.a(new_n74_), .b(x27), .c(x35), .O(new_n165_));
  nand2  g101(.a(new_n165_), .b(new_n117_), .O(new_n166_));
  aoi21  g102(.a(new_n166_), .b(new_n164_), .c(new_n125_), .O(z20));
  zero   g103(.O(z16));
  zero   g104(.O(z18));
