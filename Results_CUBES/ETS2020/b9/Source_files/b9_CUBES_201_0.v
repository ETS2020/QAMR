// Benchmark "FAU" written by ABC on Thu Jul  9 23:01:53 2020
...
module FAU ( 
  ...
  nand4  g65(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n133_));
  inv1   g66(.a(new_n133_), .O(z15));
  ...
  oai21  g72(.a(new_n67_), .b(x27), .c(new_n103_), .O(new_n140_));
  nand2  g73(.a(new_n140_), .b(x08), .O(new_n141_));
  nand3  g74(.a(new_n141_), .b(new_n110_), .c(new_n108_), .O(z18));
  oai21  g75(.a(new_n79_), .b(new_n64_), .c(new_n107_), .O(new_n143_));
  oai21  g76(.a(new_n66_), .b(x27), .c(x35), .O(new_n144_));
  nand2  g77(.a(new_n144_), .b(new_n103_), .O(new_n145_));
  aoi21  g78(.a(new_n145_), .b(new_n143_), .c(new_n111_), .O(z20));
  zero   g79(.O(z00));
  zero   g80(.O(z05));
  zero   g81(.O(z09));
  zero   g82(.O(z10));
