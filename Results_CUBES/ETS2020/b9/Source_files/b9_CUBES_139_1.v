...
module FAU ( 
  ...
  nand2  g73(.a(x22), .b(x01), .O(new_n141_));
  nor2   g74(.a(new_n141_), .b(x23), .O(z16));
  inv1   g75(.a(x24), .O(new_n143_));
  nand4  g76(.a(new_n143_), .b(x23), .c(x22), .d(x01), .O(new_n144_));
  inv1   g77(.a(new_n144_), .O(z17));
  oai21  g78(.a(new_n75_), .b(x27), .c(new_n116_), .O(new_n146_));
  nand2  g79(.a(new_n146_), .b(x08), .O(new_n147_));
  nand3  g80(.a(new_n147_), .b(new_n122_), .c(new_n120_), .O(z18));
  oai21  g81(.a(new_n81_), .b(new_n83_), .c(new_n119_), .O(new_n149_));
  oai21  g82(.a(new_n74_), .b(x27), .c(x35), .O(new_n150_));
  nand2  g83(.a(new_n150_), .b(new_n116_), .O(new_n151_));
  aoi21  g84(.a(new_n151_), .b(new_n149_), .c(new_n123_), .O(z20));
  zero   g85(.O(z01));
  zero   g86(.O(z05));
  zero   g87(.O(z12));
  zero   g88(.O(z14));
