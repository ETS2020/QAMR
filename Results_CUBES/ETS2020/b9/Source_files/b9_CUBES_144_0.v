...
module FAU ( 
  ...
  nand2  g74(.a(x22), .b(x01), .O(new_n142_));
  nor2   g75(.a(new_n142_), .b(x23), .O(z16));
  inv1   g76(.a(x24), .O(new_n144_));
  nand4  g77(.a(new_n144_), .b(x23), .c(x22), .d(x01), .O(new_n145_));
  inv1   g78(.a(new_n145_), .O(z17));
  nand3  g79(.a(x35), .b(new_n66_), .c(new_n64_), .O(new_n147_));
  nand2  g80(.a(new_n147_), .b(new_n103_), .O(new_n148_));
  nand2  g81(.a(new_n148_), .b(x08), .O(new_n149_));
  nand3  g82(.a(new_n149_), .b(new_n110_), .c(new_n108_), .O(z18));
  oai21  g83(.a(new_n135_), .b(new_n64_), .c(new_n107_), .O(new_n151_));
  oai21  g84(.a(new_n66_), .b(x27), .c(x35), .O(new_n152_));
  nand2  g85(.a(new_n152_), .b(new_n103_), .O(new_n153_));
  aoi21  g86(.a(new_n153_), .b(new_n151_), .c(new_n111_), .O(z20));
  zero   g87(.O(z00));
  zero   g88(.O(z05));
  zero   g89(.O(z09));
  zero   g90(.O(z10));
  zero   g91(.O(z15));
  aoi21  g92(.a(new_n109_), .b(new_n106_), .c(new_n111_), .O(z19));
endmodule
