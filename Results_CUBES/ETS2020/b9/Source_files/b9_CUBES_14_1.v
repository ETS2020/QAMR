...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n134_, new_n135_, new_n136_, new_n139_, new_n142_, new_n143_,
  ...
  inv1   g74(.a(x24), .O(new_n142_));
  nand4  g75(.a(new_n142_), .b(x23), .c(x22), .d(x01), .O(new_n143_));
  inv1   g76(.a(new_n143_), .O(z17));
  oai21  g77(.a(new_n81_), .b(new_n83_), .c(new_n119_), .O(new_n146_));
  oai21  g78(.a(new_n74_), .b(x27), .c(x35), .O(new_n147_));
  nand2  g79(.a(new_n147_), .b(new_n116_), .O(new_n148_));
  aoi21  g80(.a(new_n148_), .b(new_n146_), .c(new_n122_), .O(z20));
  zero   g81(.O(z01));
  zero   g82(.O(z05));
  zero   g83(.O(z12));
  zero   g84(.O(z14));
  zero   g85(.O(z16));
  zero   g86(.O(z18));
  aoi21  g87(.a(new_n121_), .b(new_n118_), .c(new_n122_), .O(z19));
endmodule
