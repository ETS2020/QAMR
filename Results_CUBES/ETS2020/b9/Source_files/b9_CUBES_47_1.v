...
module FAU ( 
  ...
  nand4  g32(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n98_));
  inv1   g33(.a(new_n98_), .O(z09));
  inv1   g34(.a(x05), .O(new_n100_));
  nand2  g35(.a(x40), .b(x39), .O(new_n101_));
  nand2  g36(.a(new_n101_), .b(x07), .O(new_n102_));
  oai21  g37(.a(new_n101_), .b(new_n100_), .c(new_n102_), .O(new_n103_));
  ...
  nor3   g42(.a(new_n107_), .b(new_n101_), .c(new_n100_), .O(new_n108_));
  ...
  nand3  g46(.a(x40), .b(x39), .c(x29), .O(new_n112_));
  ...
  nor2   g66(.a(new_n107_), .b(new_n101_), .O(new_n133_));
  ...
  inv1   g73(.a(x24), .O(new_n141_));
  nand4  g74(.a(new_n141_), .b(x23), .c(x22), .d(x01), .O(new_n142_));
  inv1   g75(.a(new_n142_), .O(z17));
  oai21  g76(.a(new_n105_), .b(x27), .c(new_n112_), .O(new_n144_));
  nand2  g77(.a(new_n144_), .b(x08), .O(new_n145_));
  nand3  g78(.a(new_n145_), .b(new_n119_), .c(new_n117_), .O(z18));
  oai21  g79(.a(new_n75_), .b(new_n77_), .c(new_n115_), .O(new_n147_));
  oai21  g80(.a(new_n74_), .b(x27), .c(x35), .O(new_n148_));
  nand2  g81(.a(new_n148_), .b(new_n112_), .O(new_n149_));
  aoi21  g82(.a(new_n149_), .b(new_n147_), .c(new_n120_), .O(z20));
  zero   g83(.O(z01));
  zero   g84(.O(z02));
  zero   g85(.O(z08));
  zero   g86(.O(z12));
