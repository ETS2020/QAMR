...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n114_, new_n119_, new_n121_, new_n123_, new_n124_, new_n127_,
    new_n128_, new_n129_;
  ...
  and2   g09(.a(x40), .b(x39), .O(new_n73_));
  ...
  nand3  g17(.a(new_n80_), .b(new_n77_), .c(new_n73_), .O(z02));
  ...
  nand2  g42(.a(new_n73_), .b(x29), .O(new_n108_));
  oai21  g43(.a(new_n84_), .b(new_n64_), .c(new_n75_), .O(new_n109_));
  nand2  g44(.a(new_n109_), .b(new_n108_), .O(new_n110_));
  inv1   g45(.a(x08), .O(new_n111_));
  nand3  g46(.a(new_n75_), .b(x27), .c(new_n64_), .O(new_n112_));
  ...
  nand4  g50(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n119_));
  inv1   g51(.a(new_n119_), .O(z15));
  nand2  g52(.a(x22), .b(x01), .O(new_n121_));
  nor2   g53(.a(new_n121_), .b(x23), .O(z16));
  inv1   g54(.a(x24), .O(new_n123_));
  nand4  g55(.a(new_n123_), .b(x23), .c(x22), .d(x01), .O(new_n124_));
  inv1   g56(.a(new_n124_), .O(z17));
  oai21  g57(.a(new_n74_), .b(new_n84_), .c(new_n111_), .O(new_n127_));
  oai21  g58(.a(new_n82_), .b(x27), .c(x35), .O(new_n128_));
  nand2  g59(.a(new_n128_), .b(new_n108_), .O(new_n129_));
  aoi21  g60(.a(new_n129_), .b(new_n127_), .c(new_n114_), .O(z20));
  zero   g61(.O(z01));
  zero   g62(.O(z08));
  zero   g63(.O(z10));
  zero   g64(.O(z12));
  ...
  zero   g66(.O(z14));
  zero   g67(.O(z18));
  aoi21  g68(.a(new_n113_), .b(new_n110_), .c(new_n114_), .O(z19));
endmodule
