// Benchmark "FAU" written by ABC on Thu Jul  9 22:55:40 2020
...
module FAU ( 
  ...
  nand4  g53(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n122_));
  inv1   g54(.a(new_n122_), .O(z15));
  ...
  oai21  g60(.a(new_n67_), .b(x27), .c(new_n92_), .O(new_n129_));
  nand2  g61(.a(new_n129_), .b(x08), .O(new_n130_));
  nand3  g62(.a(new_n130_), .b(new_n99_), .c(new_n97_), .O(z18));
  oai21  g63(.a(new_n79_), .b(new_n64_), .c(new_n96_), .O(new_n132_));
  oai21  g64(.a(new_n66_), .b(x27), .c(x35), .O(new_n133_));
  nand2  g65(.a(new_n133_), .b(new_n92_), .O(new_n134_));
  aoi21  g66(.a(new_n134_), .b(new_n132_), .c(new_n100_), .O(z20));
  zero   g67(.O(z00));
  zero   g68(.O(z05));
  zero   g69(.O(z07));
  zero   g70(.O(z09));
  zero   g71(.O(z10));
  zero   g72(.O(z13));
  aoi21  g73(.a(new_n98_), .b(new_n95_), .c(new_n100_), .O(z19));
endmodule
