...
module FAU ( 
  ...
  nand2  g61(.a(x22), .b(x01), .O(new_n130_));
  nor2   g62(.a(new_n130_), .b(x23), .O(z16));
  inv1   g63(.a(x24), .O(new_n132_));
  nand4  g64(.a(new_n132_), .b(x23), .c(x22), .d(x01), .O(new_n133_));
  inv1   g65(.a(new_n133_), .O(z17));
  nand2  g66(.a(new_n75_), .b(new_n72_), .O(new_n135_));
  nand2  g67(.a(new_n135_), .b(new_n100_), .O(new_n136_));
  nand2  g68(.a(new_n136_), .b(x08), .O(new_n137_));
  nand4  g69(.a(new_n137_), .b(new_n104_), .c(new_n107_), .d(new_n106_), .O(z18));
  oai21  g70(.a(new_n74_), .b(new_n72_), .c(new_n103_), .O(new_n139_));
  oai21  g71(.a(new_n87_), .b(x27), .c(x35), .O(new_n140_));
  nand2  g72(.a(new_n140_), .b(new_n100_), .O(new_n141_));
  aoi21  g73(.a(new_n141_), .b(new_n139_), .c(new_n108_), .O(z20));
  zero   g74(.O(z05));
  zero   g75(.O(z07));
  zero   g76(.O(z09));
  zero   g77(.O(z10));
