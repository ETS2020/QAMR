// Benchmark "FAU" written by ABC on Thu Jul  9 22:56:54 2020
...
module FAU ( 
  ...
  inv1   g76(.a(x29), .O(new_n147_));
  oai22  g77(.a(new_n75_), .b(x27), .c(new_n102_), .d(new_n147_), .O(new_n148_));
  nand2  g78(.a(new_n148_), .b(x08), .O(new_n149_));
  nand4  g79(.a(x35), .b(new_n74_), .c(x27), .d(new_n64_), .O(new_n150_));
  nor2   g80(.a(x30), .b(x09), .O(new_n151_));
  nand3  g81(.a(new_n151_), .b(new_n150_), .c(new_n149_), .O(z18));
  zero   g82(.O(z02));
  zero   g83(.O(z03));
  zero   g84(.O(z04));
  zero   g85(.O(z06));
