// Benchmark "FAU" written by ABC on Thu Jul  9 23:04:20 2020
...
module FAU ( 
  ...
  nand2  g62(.a(x22), .b(x01), .O(new_n130_));
  nor2   g63(.a(new_n130_), .b(x23), .O(z16));
  inv1   g64(.a(x24), .O(new_n132_));
  nand4  g65(.a(new_n132_), .b(x23), .c(x22), .d(x01), .O(new_n133_));
  inv1   g66(.a(new_n133_), .O(z17));
  oai21  g67(.a(new_n75_), .b(x27), .c(new_n105_), .O(new_n135_));
  nand2  g68(.a(new_n135_), .b(x08), .O(new_n136_));
  nand3  g69(.a(new_n136_), .b(new_n111_), .c(new_n109_), .O(z18));
  oai21  g70(.a(new_n81_), .b(new_n83_), .c(new_n108_), .O(new_n138_));
  oai21  g71(.a(new_n74_), .b(x27), .c(x35), .O(new_n139_));
  nand2  g72(.a(new_n139_), .b(new_n105_), .O(new_n140_));
  aoi21  g73(.a(new_n140_), .b(new_n138_), .c(new_n112_), .O(z20));
  zero   g74(.O(z01));
  zero   g75(.O(z07));
  zero   g76(.O(z12));
  zero   g77(.O(z14));
