...
module FAU ( 
  ...
  inv1   g71(.a(x24), .O(new_n140_));
  nand4  g72(.a(new_n140_), .b(x23), .c(x22), .d(x01), .O(new_n141_));
  inv1   g73(.a(new_n141_), .O(z17));
  oai21  g74(.a(new_n105_), .b(x27), .c(new_n112_), .O(new_n143_));
  nand2  g75(.a(new_n143_), .b(x08), .O(new_n144_));
  nand3  g76(.a(new_n144_), .b(new_n119_), .c(new_n117_), .O(z18));
  oai21  g77(.a(new_n75_), .b(new_n77_), .c(new_n115_), .O(new_n146_));
  oai21  g78(.a(new_n74_), .b(x27), .c(x35), .O(new_n147_));
  nand2  g79(.a(new_n147_), .b(new_n112_), .O(new_n148_));
  aoi21  g80(.a(new_n148_), .b(new_n146_), .c(new_n120_), .O(z20));
  zero   g81(.O(z01));
  zero   g82(.O(z02));
  zero   g83(.O(z08));
  zero   g84(.O(z12));
