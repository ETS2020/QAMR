...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n141_, new_n143_, new_n147_, new_n148_, new_n149_, new_n150_,
    new_n151_;
  ...
  nand2  g47(.a(x36), .b(x35), .O(new_n115_));
  nand2  g48(.a(new_n115_), .b(x28), .O(new_n116_));
  inv1   g49(.a(x40), .O(new_n117_));
  nor2   g50(.a(new_n117_), .b(x13), .O(new_n118_));
  nand4  g51(.a(new_n118_), .b(new_n116_), .c(x39), .d(new_n64_), .O(new_n119_));
  inv1   g52(.a(new_n66_), .O(new_n120_));
  inv1   g53(.a(x18), .O(new_n121_));
  inv1   g54(.a(x19), .O(new_n122_));
  nand3  g55(.a(x20), .b(new_n122_), .c(new_n121_), .O(new_n123_));
  inv1   g56(.a(new_n123_), .O(new_n124_));
  nand2  g57(.a(new_n124_), .b(new_n120_), .O(new_n125_));
  nand2  g58(.a(new_n125_), .b(new_n119_), .O(new_n126_));
  nand2  g59(.a(new_n126_), .b(x27), .O(new_n127_));
  nor2   g60(.a(x13), .b(x04), .O(new_n128_));
  nand3  g61(.a(new_n128_), .b(new_n78_), .c(z08), .O(new_n129_));
  nand2  g62(.a(new_n129_), .b(new_n127_), .O(z13));
  inv1   g63(.a(x30), .O(new_n131_));
  inv1   g64(.a(x32), .O(new_n132_));
  nand4  g65(.a(new_n115_), .b(new_n132_), .c(new_n131_), .d(x28), .O(new_n133_));
  inv1   g66(.a(new_n133_), .O(new_n134_));
  nand2  g67(.a(new_n128_), .b(z08), .O(new_n135_));
  oai21  g68(.a(new_n135_), .b(new_n134_), .c(new_n123_), .O(new_n136_));
  inv1   g69(.a(x35), .O(new_n137_));
  nand3  g70(.a(new_n88_), .b(new_n137_), .c(x28), .O(new_n138_));
  ...
  inv1   g77(.a(x29), .O(new_n147_));
  oai22  g78(.a(new_n75_), .b(x27), .c(new_n82_), .d(new_n147_), .O(new_n148_));
  nand2  g79(.a(new_n148_), .b(x08), .O(new_n149_));
  nand4  g80(.a(x35), .b(new_n74_), .c(x27), .d(new_n64_), .O(new_n150_));
  nor2   g81(.a(x30), .b(x09), .O(new_n151_));
  nand3  g82(.a(new_n151_), .b(new_n150_), .c(new_n149_), .O(z18));
  zero   g83(.O(z03));
  zero   g84(.O(z04));
  zero   g85(.O(z06));
  zero   g86(.O(z11));
