...
module FAU ( 
  ...
  wire new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_, new_n70_,
    ...
    new_n138_, new_n141_, new_n142_, new_n143_;
  ...
  oai21  g72(.a(new_n79_), .b(new_n64_), .c(new_n108_), .O(new_n141_));
  oai21  g73(.a(new_n66_), .b(x27), .c(x35), .O(new_n142_));
  nand2  g74(.a(new_n142_), .b(new_n104_), .O(new_n143_));
  aoi21  g75(.a(new_n143_), .b(new_n141_), .c(new_n112_), .O(z20));
  zero   g76(.O(z00));
  zero   g77(.O(z05));
  zero   g78(.O(z10));
  zero   g79(.O(z13));
  zero   g80(.O(z15));
  zero   g81(.O(z18));
  aoi21  g82(.a(new_n110_), .b(new_n107_), .c(new_n112_), .O(z19));
endmodule
