...
module FAU ( 
  ...
  nand2  g48(.a(z08), .b(x29), .O(new_n112_));
  nor2   g49(.a(new_n72_), .b(new_n64_), .O(new_n113_));
  oai21  g50(.a(new_n113_), .b(new_n76_), .c(new_n112_), .O(new_n114_));
  inv1   g51(.a(x08), .O(new_n115_));
  nand3  g52(.a(new_n75_), .b(x27), .c(new_n64_), .O(new_n116_));
  nand2  g53(.a(new_n116_), .b(new_n115_), .O(new_n117_));
  inv1   g54(.a(x09), .O(new_n118_));
  inv1   g55(.a(x30), .O(new_n119_));
  nand2  g56(.a(new_n119_), .b(new_n118_), .O(new_n120_));
  aoi21  g57(.a(new_n117_), .b(new_n114_), .c(new_n120_), .O(z11));
  aoi21  g58(.a(new_n63_), .b(new_n89_), .c(new_n72_), .O(new_n122_));
  nor2   g59(.a(new_n66_), .b(new_n72_), .O(new_n123_));
  nor2   g60(.a(new_n83_), .b(x04), .O(new_n124_));
  oai22  g61(.a(new_n124_), .b(new_n123_), .c(new_n122_), .d(x10), .O(z12));
  nor2   g62(.a(x19), .b(x18), .O(new_n127_));
  nand2  g63(.a(new_n127_), .b(x20), .O(new_n128_));
  inv1   g64(.a(x32), .O(new_n129_));
  nand2  g65(.a(x36), .b(x35), .O(new_n130_));
  nand4  g66(.a(new_n130_), .b(new_n129_), .c(new_n119_), .d(x28), .O(new_n131_));
  inv1   g67(.a(new_n131_), .O(new_n132_));
  nor2   g68(.a(x13), .b(x04), .O(new_n133_));
  nand2  g69(.a(new_n133_), .b(z08), .O(new_n134_));
  oai21  g70(.a(new_n134_), .b(new_n132_), .c(new_n128_), .O(new_n135_));
  nand3  g71(.a(new_n89_), .b(new_n74_), .c(x28), .O(new_n136_));
  nand2  g72(.a(new_n136_), .b(x27), .O(new_n137_));
  nand2  g73(.a(new_n137_), .b(new_n78_), .O(new_n138_));
  oai21  g74(.a(new_n66_), .b(new_n72_), .c(new_n134_), .O(new_n139_));
  nand3  g75(.a(new_n139_), .b(new_n138_), .c(new_n135_), .O(z14));
  nand4  g76(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n141_));
  inv1   g77(.a(new_n141_), .O(z15));
  ...
  nand2  g83(.a(new_n75_), .b(new_n72_), .O(new_n148_));
  nand2  g84(.a(new_n148_), .b(new_n112_), .O(new_n149_));
  nand2  g85(.a(new_n149_), .b(x08), .O(new_n150_));
  nand4  g86(.a(new_n150_), .b(new_n116_), .c(new_n119_), .d(new_n118_), .O(z18));
  oai21  g87(.a(new_n74_), .b(new_n72_), .c(new_n115_), .O(new_n152_));
  oai21  g88(.a(new_n87_), .b(x27), .c(x35), .O(new_n153_));
  nand2  g89(.a(new_n153_), .b(new_n112_), .O(new_n154_));
  aoi21  g90(.a(new_n154_), .b(new_n152_), .c(new_n120_), .O(z20));
  zero   g91(.O(z10));
  zero   g92(.O(z13));
  aoi21  g93(.a(new_n117_), .b(new_n114_), .c(new_n120_), .O(z19));
endmodule
