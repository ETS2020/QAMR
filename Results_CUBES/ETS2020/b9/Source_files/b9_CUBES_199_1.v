// Benchmark "FAU" written by ABC on Thu Jul  9 23:01:44 2020
...
module FAU ( 
  ...
  nor2   g46(.a(x30), .b(x09), .O(new_n113_));
  inv1   g47(.a(new_n113_), .O(new_n114_));
  aoi21  g48(.a(new_n112_), .b(new_n109_), .c(new_n114_), .O(z11));
  ...
  nand2  g66(.a(new_n74_), .b(new_n84_), .O(new_n136_));
  nand2  g67(.a(new_n136_), .b(new_n107_), .O(new_n137_));
  nand2  g68(.a(new_n137_), .b(x08), .O(new_n138_));
  nand3  g69(.a(new_n138_), .b(new_n113_), .c(new_n111_), .O(z18));
  oai21  g70(.a(new_n73_), .b(new_n84_), .c(new_n110_), .O(new_n140_));
  oai21  g71(.a(new_n82_), .b(x27), .c(x35), .O(new_n141_));
  nand2  g72(.a(new_n141_), .b(new_n107_), .O(new_n142_));
  aoi21  g73(.a(new_n142_), .b(new_n140_), .c(new_n114_), .O(z20));
  zero   g74(.O(z01));
  zero   g75(.O(z08));
  zero   g76(.O(z09));
  zero   g77(.O(z10));
