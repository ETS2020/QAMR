...
module FAU ( 
  ...
  nor2   g34(.a(x32), .b(x30), .O(new_n100_));
  nor3   g35(.a(new_n100_), .b(new_n77_), .c(new_n95_), .O(new_n101_));
  aoi21  g36(.a(new_n99_), .b(new_n97_), .c(new_n101_), .O(new_n102_));
  nand3  g37(.a(x37), .b(x27), .c(x06), .O(new_n103_));
  oai21  g38(.a(new_n102_), .b(x04), .c(new_n103_), .O(z10));
  nand3  g39(.a(x40), .b(x39), .c(x29), .O(new_n105_));
  nor2   g40(.a(new_n83_), .b(new_n64_), .O(new_n106_));
  oai21  g41(.a(new_n106_), .b(new_n75_), .c(new_n105_), .O(new_n107_));
  inv1   g42(.a(x08), .O(new_n108_));
  nand4  g43(.a(x35), .b(new_n74_), .c(x27), .d(new_n64_), .O(new_n109_));
  ...
  inv1   g49(.a(x39), .O(new_n116_));
  nor2   g50(.a(new_n116_), .b(x04), .O(new_n117_));
  oai21  g51(.a(new_n98_), .b(new_n81_), .c(x28), .O(new_n118_));
  nand4  g52(.a(new_n118_), .b(new_n117_), .c(x40), .d(new_n115_), .O(new_n119_));
  inv1   g53(.a(new_n66_), .O(new_n120_));
  ...
  nor2   g58(.a(new_n100_), .b(new_n77_), .O(new_n125_));
  nand3  g59(.a(new_n125_), .b(new_n115_), .c(new_n64_), .O(new_n126_));
  ...
  oai21  g65(.a(new_n75_), .b(x27), .c(new_n105_), .O(new_n134_));
  nand2  g66(.a(new_n134_), .b(x08), .O(new_n135_));
  nand3  g67(.a(new_n135_), .b(new_n111_), .c(new_n109_), .O(z18));
  oai21  g68(.a(new_n81_), .b(new_n83_), .c(new_n108_), .O(new_n137_));
  oai21  g69(.a(new_n74_), .b(x27), .c(x35), .O(new_n138_));
  nand2  g70(.a(new_n138_), .b(new_n105_), .O(new_n139_));
  aoi21  g71(.a(new_n139_), .b(new_n137_), .c(new_n112_), .O(z20));
  zero   g72(.O(z01));
  zero   g73(.O(z07));
  zero   g74(.O(z08));
  zero   g75(.O(z12));
