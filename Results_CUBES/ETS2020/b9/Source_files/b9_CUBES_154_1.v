...
module FAU ( 
  ...
  inv1   g57(.a(x24), .O(new_n125_));
  nand4  g58(.a(new_n125_), .b(x23), .c(x22), .d(x01), .O(new_n126_));
  inv1   g59(.a(new_n126_), .O(z17));
  oai21  g60(.a(new_n67_), .b(x27), .c(new_n97_), .O(new_n128_));
  nand2  g61(.a(new_n128_), .b(x08), .O(new_n129_));
  nand3  g62(.a(new_n129_), .b(new_n104_), .c(new_n102_), .O(z18));
  oai21  g63(.a(new_n108_), .b(new_n75_), .c(new_n101_), .O(new_n131_));
  oai21  g64(.a(new_n66_), .b(x27), .c(x35), .O(new_n132_));
  nand2  g65(.a(new_n132_), .b(new_n97_), .O(new_n133_));
  aoi21  g66(.a(new_n133_), .b(new_n131_), .c(new_n105_), .O(z20));
  zero   g67(.O(z00));
  zero   g68(.O(z01));
  zero   g69(.O(z07));
  zero   g70(.O(z12));
  zero   g71(.O(z14));
  aoi21  g72(.a(new_n103_), .b(new_n100_), .c(new_n105_), .O(z19));
endmodule
