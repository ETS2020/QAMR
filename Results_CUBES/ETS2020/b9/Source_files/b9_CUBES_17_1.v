// Benchmark "FAU" written by ABC on Thu Jul  9 22:48:58 2020
...
module FAU ( 
  ...
  oai21  g64(.a(new_n75_), .b(x27), .c(new_n105_), .O(new_n133_));
  nand2  g65(.a(new_n133_), .b(x08), .O(new_n134_));
  nand3  g66(.a(new_n134_), .b(new_n111_), .c(new_n109_), .O(z18));
  oai21  g67(.a(new_n81_), .b(new_n83_), .c(new_n108_), .O(new_n136_));
  oai21  g68(.a(new_n74_), .b(x27), .c(x35), .O(new_n137_));
  nand2  g69(.a(new_n137_), .b(new_n105_), .O(new_n138_));
  aoi21  g70(.a(new_n138_), .b(new_n136_), .c(new_n112_), .O(z20));
  zero   g71(.O(z01));
  zero   g72(.O(z07));
  zero   g73(.O(z12));
  zero   g74(.O(z14));
  zero   g75(.O(z15));
  zero   g76(.O(z17));
  aoi21  g77(.a(new_n110_), .b(new_n107_), .c(new_n112_), .O(z19));
endmodule
