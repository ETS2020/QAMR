// Benchmark "FAU" written by ABC on Thu Jul  9 23:03:15 2020
...
module FAU ( 
  ...
  oai21  g098(.a(new_n75_), .b(x27), .c(new_n117_), .O(new_n162_));
  nand2  g099(.a(new_n162_), .b(x08), .O(new_n163_));
  nand3  g100(.a(new_n163_), .b(new_n123_), .c(new_n121_), .O(z18));
  oai21  g101(.a(new_n86_), .b(new_n72_), .c(new_n120_), .O(new_n165_));
  oai21  g102(.a(new_n74_), .b(x27), .c(x35), .O(new_n166_));
  nand2  g103(.a(new_n166_), .b(new_n117_), .O(new_n167_));
  aoi21  g104(.a(new_n167_), .b(new_n165_), .c(new_n124_), .O(z20));
  zero   g105(.O(z17));
