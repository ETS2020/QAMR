// Benchmark "FAU" written by ABC on Thu Jul  9 22:56:47 2020
...
module FAU ( 
  ...
  oai21  g69(.a(new_n75_), .b(x27), .c(new_n105_), .O(new_n136_));
  nand2  g70(.a(new_n136_), .b(x08), .O(new_n137_));
  nand3  g71(.a(new_n137_), .b(new_n111_), .c(new_n109_), .O(z18));
  oai21  g72(.a(new_n81_), .b(new_n83_), .c(new_n108_), .O(new_n139_));
  oai21  g73(.a(new_n74_), .b(x27), .c(x35), .O(new_n140_));
  nand2  g74(.a(new_n140_), .b(new_n105_), .O(new_n141_));
  aoi21  g75(.a(new_n141_), .b(new_n139_), .c(new_n112_), .O(z20));
  zero   g76(.O(z01));
  zero   g77(.O(z07));
  zero   g78(.O(z12));
  zero   g79(.O(z14));
  aoi21  g80(.a(new_n110_), .b(new_n107_), .c(new_n112_), .O(z19));
endmodule
