// Benchmark "FAU" written by ABC on Thu Jul  9 22:58:04 2020
...
module FAU ( 
  ...
  nand2  g81(.a(new_n75_), .b(new_n72_), .O(new_n147_));
  nand2  g82(.a(new_n147_), .b(new_n112_), .O(new_n148_));
  nand2  g83(.a(new_n148_), .b(x08), .O(new_n149_));
  nand4  g84(.a(new_n149_), .b(new_n116_), .c(new_n119_), .d(new_n118_), .O(z18));
  oai21  g85(.a(new_n74_), .b(new_n72_), .c(new_n115_), .O(new_n151_));
  oai21  g86(.a(new_n87_), .b(x27), .c(x35), .O(new_n152_));
  nand2  g87(.a(new_n152_), .b(new_n112_), .O(new_n153_));
  aoi21  g88(.a(new_n153_), .b(new_n151_), .c(new_n120_), .O(z20));
  zero   g89(.O(z10));
  zero   g90(.O(z13));
  zero   g91(.O(z15));
