...
module FAU ( 
  ...
  nor2   g49(.a(x30), .b(x09), .O(new_n114_));
  inv1   g50(.a(new_n114_), .O(new_n115_));
  aoi21  g51(.a(new_n113_), .b(new_n110_), .c(new_n115_), .O(z11));
  nor2   g52(.a(new_n77_), .b(x04), .O(new_n118_));
  nand2  g53(.a(x36), .b(x35), .O(new_n119_));
  nand2  g54(.a(new_n119_), .b(x28), .O(new_n120_));
  nor2   g55(.a(new_n78_), .b(x13), .O(new_n121_));
  nand3  g56(.a(new_n121_), .b(new_n120_), .c(new_n118_), .O(new_n122_));
  inv1   g57(.a(new_n66_), .O(new_n123_));
  ...
  or2    g62(.a(x32), .b(x30), .O(new_n128_));
  nand3  g63(.a(new_n128_), .b(new_n121_), .c(new_n118_), .O(new_n129_));
  ...
  nand2  g72(.a(new_n74_), .b(new_n84_), .O(new_n139_));
  nand2  g73(.a(new_n139_), .b(new_n108_), .O(new_n140_));
  nand2  g74(.a(new_n140_), .b(x08), .O(new_n141_));
  nand3  g75(.a(new_n141_), .b(new_n114_), .c(new_n112_), .O(z18));
  oai21  g76(.a(new_n73_), .b(new_n84_), .c(new_n111_), .O(new_n143_));
  oai21  g77(.a(new_n82_), .b(x27), .c(x35), .O(new_n144_));
  nand2  g78(.a(new_n144_), .b(new_n108_), .O(new_n145_));
  aoi21  g79(.a(new_n145_), .b(new_n143_), .c(new_n115_), .O(z20));
  zero   g80(.O(z01));
  zero   g81(.O(z10));
  zero   g82(.O(z12));
  zero   g83(.O(z14));
