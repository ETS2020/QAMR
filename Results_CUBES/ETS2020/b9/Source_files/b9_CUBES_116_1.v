// Benchmark "FAU" written by ABC on Thu Jul  9 22:56:01 2020
...
module FAU ( 
  ...
  oai21  g64(.a(new_n75_), .b(x27), .c(new_n105_), .O(new_n134_));
  nand2  g65(.a(new_n134_), .b(x08), .O(new_n135_));
  nand3  g66(.a(new_n135_), .b(new_n111_), .c(new_n109_), .O(z18));
  oai21  g67(.a(new_n81_), .b(new_n83_), .c(new_n108_), .O(new_n137_));
  oai21  g68(.a(new_n74_), .b(x27), .c(x35), .O(new_n138_));
  nand2  g69(.a(new_n138_), .b(new_n105_), .O(new_n139_));
  aoi21  g70(.a(new_n139_), .b(new_n137_), .c(new_n112_), .O(z20));
  zero   g71(.O(z01));
  zero   g72(.O(z05));
  zero   g73(.O(z07));
  zero   g74(.O(z08));
