// Benchmark "FAU" written by ABC on Thu Jul  9 22:52:21 2020
...
module FAU ( 
  ...
  inv1   g55(.a(x24), .O(new_n123_));
  nand4  g56(.a(new_n123_), .b(x23), .c(x22), .d(x01), .O(new_n124_));
  inv1   g57(.a(new_n124_), .O(z17));
  nand2  g58(.a(new_n75_), .b(new_n84_), .O(new_n126_));
  nand2  g59(.a(new_n126_), .b(new_n107_), .O(new_n127_));
  nand2  g60(.a(new_n127_), .b(x08), .O(new_n128_));
  nand3  g61(.a(new_n128_), .b(new_n113_), .c(new_n111_), .O(z18));
  oai21  g62(.a(new_n74_), .b(new_n84_), .c(new_n110_), .O(new_n130_));
  oai21  g63(.a(new_n82_), .b(x27), .c(x35), .O(new_n131_));
  nand2  g64(.a(new_n131_), .b(new_n107_), .O(new_n132_));
  aoi21  g65(.a(new_n132_), .b(new_n130_), .c(new_n114_), .O(z20));
  zero   g66(.O(z01));
  zero   g67(.O(z10));
  zero   g68(.O(z12));
  zero   g69(.O(z13));
  zero   g70(.O(z14));
  aoi21  g71(.a(new_n112_), .b(new_n109_), .c(new_n114_), .O(z19));
endmodule
