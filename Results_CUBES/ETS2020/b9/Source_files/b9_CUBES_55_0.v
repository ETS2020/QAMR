...
module FAU ( 
  ...
  oai21  g68(.a(new_n67_), .b(x27), .c(new_n103_), .O(new_n137_));
  nand2  g69(.a(new_n137_), .b(x08), .O(new_n138_));
  nand3  g70(.a(new_n138_), .b(new_n110_), .c(new_n108_), .O(z18));
  oai21  g71(.a(new_n79_), .b(new_n64_), .c(new_n107_), .O(new_n140_));
  oai21  g72(.a(new_n66_), .b(x27), .c(x35), .O(new_n141_));
  nand2  g73(.a(new_n141_), .b(new_n103_), .O(new_n142_));
