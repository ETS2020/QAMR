// Benchmark "FAU" written by ABC on Thu Jul  9 22:58:01 2020
...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n128_, new_n131_, new_n133_, new_n137_, new_n138_, new_n139_;
  ...
  oai21  g44(.a(new_n84_), .b(new_n64_), .c(new_n74_), .O(new_n109_));
  nand2  g45(.a(new_n109_), .b(new_n108_), .O(new_n110_));
  inv1   g46(.a(x08), .O(new_n111_));
  nand3  g47(.a(new_n74_), .b(x27), .c(new_n64_), .O(new_n112_));
  nand2  g48(.a(new_n112_), .b(new_n111_), .O(new_n113_));
  or2    g49(.a(x30), .b(x09), .O(new_n114_));
  aoi21  g50(.a(new_n113_), .b(new_n110_), .c(new_n114_), .O(z11));
  nor2   g51(.a(new_n77_), .b(x04), .O(new_n117_));
  nand2  g52(.a(x36), .b(x35), .O(new_n118_));
  nand2  g53(.a(new_n118_), .b(x28), .O(new_n119_));
  nor2   g54(.a(new_n78_), .b(x13), .O(new_n120_));
  nand3  g55(.a(new_n120_), .b(new_n119_), .c(new_n117_), .O(new_n121_));
  inv1   g56(.a(new_n66_), .O(new_n122_));
  nor2   g57(.a(x19), .b(x18), .O(new_n123_));
  nand3  g58(.a(new_n123_), .b(new_n122_), .c(x20), .O(new_n124_));
  nand2  g59(.a(new_n124_), .b(new_n121_), .O(new_n125_));
  nand2  g60(.a(new_n125_), .b(x27), .O(new_n126_));
  or2    g61(.a(x32), .b(x30), .O(new_n127_));
  nand3  g62(.a(new_n127_), .b(new_n120_), .c(new_n117_), .O(new_n128_));
  nand2  g63(.a(new_n128_), .b(new_n126_), .O(z13));
  ...
  oai21  g68(.a(new_n73_), .b(new_n84_), .c(new_n111_), .O(new_n137_));
  oai21  g69(.a(new_n82_), .b(x27), .c(x35), .O(new_n138_));
  nand2  g70(.a(new_n138_), .b(new_n108_), .O(new_n139_));
  aoi21  g71(.a(new_n139_), .b(new_n137_), .c(new_n114_), .O(z20));
  zero   g72(.O(z01));
  zero   g73(.O(z10));
  zero   g74(.O(z12));
  zero   g75(.O(z14));
  zero   g76(.O(z17));
  zero   g77(.O(z18));
  aoi21  g78(.a(new_n113_), .b(new_n110_), .c(new_n114_), .O(z19));
endmodule
