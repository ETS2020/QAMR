// Benchmark "FAU" written by ABC on Thu Jul  9 23:02:48 2020
...
module FAU ( 
  ...
  nand2  g058(.a(x27), .b(new_n64_), .O(new_n121_));
  oai21  g059(.a(new_n121_), .b(new_n75_), .c(new_n120_), .O(new_n122_));
  ...
  aoi21  g064(.a(new_n63_), .b(new_n88_), .c(new_n72_), .O(new_n127_));
  ...
  nand4  g085(.a(new_n132_), .b(new_n147_), .c(new_n124_), .d(x28), .O(new_n148_));
  ...
  nand2  g092(.a(new_n150_), .b(new_n129_), .O(new_n155_));
  ...
  aoi21  g104(.a(new_n167_), .b(new_n165_), .c(new_n125_), .O(z20));
  zero   g105(.O(z18));
  aoi21  g106(.a(new_n122_), .b(new_n119_), .c(new_n125_), .O(z19));
endmodule
