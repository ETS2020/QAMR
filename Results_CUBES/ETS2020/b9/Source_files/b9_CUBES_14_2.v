// Benchmark "FAU" written by ABC on Thu Jul  9 22:48:46 2020
...
module FAU ( 
  ...
  nand2  g76(.a(x22), .b(x01), .O(new_n145_));
  nor2   g77(.a(new_n145_), .b(x23), .O(z16));
  inv1   g78(.a(x29), .O(new_n148_));
  oai22  g79(.a(new_n75_), .b(x27), .c(new_n102_), .d(new_n148_), .O(new_n149_));
  nand2  g80(.a(new_n149_), .b(x08), .O(new_n150_));
  nand4  g81(.a(x35), .b(new_n74_), .c(x27), .d(new_n64_), .O(new_n151_));
  nor2   g82(.a(x30), .b(x09), .O(new_n152_));
  nand3  g83(.a(new_n152_), .b(new_n151_), .c(new_n150_), .O(z18));
  zero   g84(.O(z02));
  zero   g85(.O(z03));
  zero   g86(.O(z04));
  zero   g87(.O(z06));
