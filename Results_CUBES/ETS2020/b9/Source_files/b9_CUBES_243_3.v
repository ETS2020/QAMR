// Benchmark "FAU" written by ABC on Thu Jul  9 23:04:57 2020
...
module FAU ( 
  ...
  nand2  g053(.a(x27), .b(new_n64_), .O(new_n117_));
  oai21  g054(.a(new_n117_), .b(new_n75_), .c(new_n116_), .O(new_n118_));
  inv1   g055(.a(x09), .O(new_n119_));
  inv1   g056(.a(x30), .O(new_n120_));
  nand2  g057(.a(new_n120_), .b(new_n119_), .O(new_n121_));
  aoi21  g058(.a(new_n118_), .b(new_n115_), .c(new_n121_), .O(z11));
  ...
  inv1   g079(.a(x32), .O(new_n143_));
  nand4  g080(.a(new_n128_), .b(new_n143_), .c(new_n120_), .d(x28), .O(new_n144_));
  inv1   g081(.a(new_n144_), .O(new_n145_));
  nand2  g082(.a(new_n140_), .b(z08), .O(new_n146_));
  oai21  g083(.a(new_n146_), .b(new_n145_), .c(new_n135_), .O(new_n147_));
  nand3  g084(.a(new_n83_), .b(new_n81_), .c(x28), .O(new_n148_));
  nand2  g085(.a(new_n148_), .b(x27), .O(new_n149_));
  nand2  g086(.a(new_n149_), .b(new_n77_), .O(new_n150_));
  nand2  g087(.a(new_n146_), .b(new_n125_), .O(new_n151_));
  nand3  g088(.a(new_n151_), .b(new_n150_), .c(new_n147_), .O(z14));
  nand4  g089(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n153_));
  inv1   g090(.a(new_n153_), .O(z15));
  nand2  g091(.a(x22), .b(x01), .O(new_n155_));
  nor2   g092(.a(new_n155_), .b(x23), .O(z16));
  inv1   g093(.a(x24), .O(new_n157_));
  nand4  g094(.a(new_n157_), .b(x23), .c(x22), .d(x01), .O(new_n158_));
  inv1   g095(.a(new_n158_), .O(z17));
  oai21  g096(.a(new_n81_), .b(new_n72_), .c(new_n116_), .O(new_n161_));
  oai21  g097(.a(new_n74_), .b(x27), .c(x35), .O(new_n162_));
  nand2  g098(.a(new_n162_), .b(new_n113_), .O(new_n163_));
  aoi21  g099(.a(new_n163_), .b(new_n161_), .c(new_n121_), .O(z20));
  zero   g100(.O(z02));
  zero   g101(.O(z18));
  aoi21  g102(.a(new_n118_), .b(new_n115_), .c(new_n121_), .O(z19));
endmodule
