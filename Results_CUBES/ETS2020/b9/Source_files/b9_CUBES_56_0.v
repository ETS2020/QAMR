// Benchmark "FAU" written by ABC on Thu Jul  9 22:51:46 2020
...
module FAU ( 
  ...
  oai21  g72(.a(new_n67_), .b(x27), .c(new_n104_), .O(new_n140_));
  nand2  g73(.a(new_n140_), .b(x08), .O(new_n141_));
  nand3  g74(.a(new_n141_), .b(new_n111_), .c(new_n109_), .O(z18));
  oai21  g75(.a(new_n79_), .b(new_n64_), .c(new_n108_), .O(new_n143_));
  oai21  g76(.a(new_n66_), .b(x27), .c(x35), .O(new_n144_));
  nand2  g77(.a(new_n144_), .b(new_n104_), .O(new_n145_));
  aoi21  g78(.a(new_n145_), .b(new_n143_), .c(new_n112_), .O(z20));
  zero   g79(.O(z00));
  zero   g80(.O(z05));
  zero   g81(.O(z10));
  zero   g82(.O(z13));
  zero   g83(.O(z15));
  aoi21  g84(.a(new_n110_), .b(new_n107_), .c(new_n112_), .O(z19));
endmodule
