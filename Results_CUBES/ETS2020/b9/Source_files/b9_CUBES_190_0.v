// Benchmark "FAU" written by ABC on Thu Jul  9 23:01:04 2020
...
module FAU ( 
  ...
  inv1   g34(.a(new_n98_), .O(z09));
  nand2  g35(.a(z08), .b(x29), .O(new_n101_));
  nor2   g36(.a(new_n72_), .b(new_n64_), .O(new_n102_));
  oai21  g37(.a(new_n102_), .b(new_n76_), .c(new_n101_), .O(new_n103_));
  inv1   g38(.a(x08), .O(new_n104_));
  nand3  g39(.a(new_n75_), .b(x27), .c(new_n64_), .O(new_n105_));
  nand2  g40(.a(new_n105_), .b(new_n104_), .O(new_n106_));
  inv1   g41(.a(x09), .O(new_n107_));
  inv1   g42(.a(x30), .O(new_n108_));
  nand2  g43(.a(new_n108_), .b(new_n107_), .O(new_n109_));
  aoi21  g44(.a(new_n106_), .b(new_n103_), .c(new_n109_), .O(z11));
  aoi21  g45(.a(new_n63_), .b(new_n89_), .c(new_n72_), .O(new_n111_));
  nor2   g46(.a(new_n66_), .b(new_n72_), .O(new_n112_));
  nor2   g47(.a(new_n83_), .b(x04), .O(new_n113_));
  oai22  g48(.a(new_n113_), .b(new_n112_), .c(new_n111_), .d(x10), .O(z12));
  nor2   g49(.a(x19), .b(x18), .O(new_n116_));
  nand2  g50(.a(new_n116_), .b(x20), .O(new_n117_));
  inv1   g51(.a(x32), .O(new_n118_));
  nand2  g52(.a(x36), .b(x35), .O(new_n119_));
  nand4  g53(.a(new_n119_), .b(new_n118_), .c(new_n108_), .d(x28), .O(new_n120_));
  inv1   g54(.a(new_n120_), .O(new_n121_));
  nor2   g55(.a(x13), .b(x04), .O(new_n122_));
  nand2  g56(.a(new_n122_), .b(z08), .O(new_n123_));
  oai21  g57(.a(new_n123_), .b(new_n121_), .c(new_n117_), .O(new_n124_));
  nand3  g58(.a(new_n89_), .b(new_n74_), .c(x28), .O(new_n125_));
  nand2  g59(.a(new_n125_), .b(x27), .O(new_n126_));
  nand2  g60(.a(new_n126_), .b(new_n78_), .O(new_n127_));
  oai21  g61(.a(new_n66_), .b(new_n72_), .c(new_n123_), .O(new_n128_));
  nand3  g62(.a(new_n128_), .b(new_n127_), .c(new_n124_), .O(z14));
  ...
  nand2  g69(.a(new_n136_), .b(new_n101_), .O(new_n137_));
  nand2  g70(.a(new_n137_), .b(x08), .O(new_n138_));
  nand4  g71(.a(new_n138_), .b(new_n105_), .c(new_n108_), .d(new_n107_), .O(z18));
  oai21  g72(.a(new_n74_), .b(new_n72_), .c(new_n104_), .O(new_n140_));
  oai21  g73(.a(new_n87_), .b(x27), .c(x35), .O(new_n141_));
  nand2  g74(.a(new_n141_), .b(new_n101_), .O(new_n142_));
  aoi21  g75(.a(new_n142_), .b(new_n140_), .c(new_n109_), .O(z20));
  zero   g76(.O(z05));
  zero   g77(.O(z07));
  zero   g78(.O(z10));
  zero   g79(.O(z13));
