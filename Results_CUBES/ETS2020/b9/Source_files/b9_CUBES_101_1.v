...
module FAU ( 
  ...
  wire new_n65_, new_n66_, new_n67_, new_n68_, new_n69_, new_n70_, new_n71_,
    ...
    new_n95_, new_n96_, new_n97_, new_n103_, new_n106_, new_n107_,
  ...
  nand3  g34(.a(x35), .b(new_n66_), .c(new_n75_), .O(new_n106_));
  nand2  g35(.a(new_n106_), .b(new_n88_), .O(new_n107_));
  nand2  g36(.a(new_n107_), .b(x08), .O(new_n108_));
  nand3  g37(.a(new_n108_), .b(new_n96_), .c(new_n94_), .O(z18));
  oai21  g38(.a(new_n73_), .b(new_n75_), .c(new_n92_), .O(new_n110_));
  oai21  g39(.a(new_n66_), .b(x27), .c(x35), .O(new_n111_));
  nand2  g40(.a(new_n111_), .b(new_n88_), .O(new_n112_));
  aoi21  g41(.a(new_n112_), .b(new_n110_), .c(new_n97_), .O(z20));
  zero   g42(.O(z00));
  zero   g43(.O(z01));
  zero   g44(.O(z07));
  zero   g45(.O(z10));
  ...
  zero   g49(.O(z15));
  zero   g50(.O(z17));
  aoi21  g51(.a(new_n95_), .b(new_n91_), .c(new_n97_), .O(z19));
endmodule
