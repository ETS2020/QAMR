// Benchmark "FAU" written by ABC on Thu Jul  9 22:58:44 2020
...
module FAU ( 
  ...
  nand2  g36(.a(z08), .b(x29), .O(new_n103_));
  ...
  nand2  g48(.a(new_n79_), .b(new_n81_), .O(new_n115_));
  nand2  g49(.a(new_n115_), .b(x27), .O(new_n116_));
  inv1   g50(.a(new_n116_), .O(new_n117_));
  nor2   g51(.a(new_n76_), .b(x04), .O(new_n118_));
  oai22  g52(.a(new_n118_), .b(new_n117_), .c(new_n114_), .d(x10), .O(z12));
  nand2  g53(.a(x36), .b(x35), .O(new_n120_));
  nand2  g54(.a(new_n120_), .b(x28), .O(new_n121_));
  nor2   g55(.a(x13), .b(x04), .O(new_n122_));
  nand3  g56(.a(new_n122_), .b(new_n121_), .c(z08), .O(new_n123_));
  nor2   g57(.a(x19), .b(x18), .O(new_n124_));
  nand3  g58(.a(new_n124_), .b(new_n115_), .c(x20), .O(new_n125_));
  nand2  g59(.a(new_n125_), .b(new_n123_), .O(new_n126_));
  nand2  g60(.a(new_n126_), .b(x27), .O(new_n127_));
  nand3  g61(.a(new_n122_), .b(z08), .c(new_n71_), .O(new_n128_));
  nand2  g62(.a(new_n128_), .b(new_n127_), .O(z13));
  nand2  g63(.a(new_n122_), .b(z08), .O(new_n130_));
  nand2  g64(.a(new_n124_), .b(x20), .O(new_n131_));
  nand4  g65(.a(new_n120_), .b(new_n70_), .c(new_n69_), .d(x28), .O(new_n132_));
  inv1   g66(.a(new_n132_), .O(new_n133_));
  oai21  g67(.a(new_n133_), .b(new_n130_), .c(new_n131_), .O(new_n134_));
  inv1   g68(.a(x35), .O(new_n135_));
  nand3  g69(.a(new_n81_), .b(new_n135_), .c(x28), .O(new_n136_));
  nand2  g70(.a(new_n136_), .b(x27), .O(new_n137_));
  nand3  g71(.a(new_n137_), .b(new_n70_), .c(new_n69_), .O(new_n138_));
  nand2  g72(.a(new_n130_), .b(new_n116_), .O(new_n139_));
  nand3  g73(.a(new_n139_), .b(new_n138_), .c(new_n134_), .O(z14));
  nand4  g74(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n141_));
  inv1   g75(.a(new_n141_), .O(z15));
  ...
  nand3  g81(.a(x35), .b(new_n66_), .c(new_n64_), .O(new_n148_));
  nand2  g82(.a(new_n148_), .b(new_n103_), .O(new_n149_));
  nand2  g83(.a(new_n149_), .b(x08), .O(new_n150_));
  nand3  g84(.a(new_n150_), .b(new_n110_), .c(new_n108_), .O(z18));
  oai21  g85(.a(new_n135_), .b(new_n64_), .c(new_n107_), .O(new_n152_));
  oai21  g86(.a(new_n66_), .b(x27), .c(x35), .O(new_n153_));
  nand2  g87(.a(new_n153_), .b(new_n103_), .O(new_n154_));
  aoi21  g88(.a(new_n154_), .b(new_n152_), .c(new_n111_), .O(z20));
  zero   g89(.O(z00));
  zero   g90(.O(z05));
  zero   g91(.O(z09));
  zero   g92(.O(z10));
  aoi21  g93(.a(new_n109_), .b(new_n106_), .c(new_n111_), .O(z19));
endmodule
