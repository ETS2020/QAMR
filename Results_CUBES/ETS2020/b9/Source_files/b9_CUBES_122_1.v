// Benchmark "FAU" written by ABC on Thu Jul  9 22:56:29 2020
...
module FAU ( 
  ...
  inv1   g45(.a(x30), .O(new_n111_));
  inv1   g46(.a(x32), .O(new_n112_));
  nand3  g47(.a(x40), .b(x39), .c(x05), .O(new_n113_));
  aoi21  g48(.a(new_n112_), .b(new_n111_), .c(new_n113_), .O(new_n114_));
  aoi21  g49(.a(new_n110_), .b(new_n108_), .c(new_n114_), .O(new_n115_));
  nand3  g50(.a(x37), .b(x27), .c(x06), .O(new_n116_));
  oai21  g51(.a(new_n115_), .b(x04), .c(new_n116_), .O(z10));
  nand3  g52(.a(x40), .b(x39), .c(x29), .O(new_n118_));
  nor2   g53(.a(new_n83_), .b(new_n64_), .O(new_n119_));
  oai21  g54(.a(new_n119_), .b(new_n75_), .c(new_n118_), .O(new_n120_));
  inv1   g55(.a(x08), .O(new_n121_));
  nor2   g56(.a(new_n81_), .b(x28), .O(new_n122_));
  nand3  g57(.a(new_n122_), .b(x27), .c(new_n64_), .O(new_n123_));
  nand2  g58(.a(new_n123_), .b(new_n121_), .O(new_n124_));
  inv1   g59(.a(x09), .O(new_n125_));
  nand2  g60(.a(new_n111_), .b(new_n125_), .O(new_n126_));
  aoi21  g61(.a(new_n124_), .b(new_n120_), .c(new_n126_), .O(z11));
  ...
  oai21  g69(.a(new_n75_), .b(x27), .c(new_n118_), .O(new_n138_));
  nand2  g70(.a(new_n138_), .b(x08), .O(new_n139_));
  nand4  g71(.a(new_n139_), .b(new_n123_), .c(new_n111_), .d(new_n125_), .O(z18));
  oai21  g72(.a(new_n81_), .b(new_n83_), .c(new_n121_), .O(new_n141_));
  oai21  g73(.a(new_n74_), .b(x27), .c(x35), .O(new_n142_));
  nand2  g74(.a(new_n142_), .b(new_n118_), .O(new_n143_));
  aoi21  g75(.a(new_n143_), .b(new_n141_), .c(new_n126_), .O(z20));
  zero   g76(.O(z01));
  zero   g77(.O(z06));
  zero   g78(.O(z08));
  zero   g79(.O(z12));
  zero   g80(.O(z13));
  zero   g81(.O(z14));
  aoi21  g82(.a(new_n124_), .b(new_n120_), .c(new_n126_), .O(z19));
endmodule
