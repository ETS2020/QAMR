...
module FAU ( 
  ...
  nand2  g37(.a(x27), .b(x04), .O(new_n104_));
  nand3  g38(.a(new_n104_), .b(x35), .c(new_n66_), .O(new_n105_));
  nand2  g39(.a(new_n105_), .b(new_n103_), .O(new_n106_));
  inv1   g40(.a(x08), .O(new_n107_));
  inv1   g41(.a(x04), .O(new_n108_));
  nand4  g42(.a(x35), .b(new_n66_), .c(x27), .d(new_n108_), .O(new_n109_));
  nand2  g43(.a(new_n109_), .b(new_n107_), .O(new_n110_));
  nor2   g44(.a(x30), .b(x09), .O(new_n111_));
  inv1   g45(.a(new_n111_), .O(new_n112_));
  aoi21  g46(.a(new_n110_), .b(new_n106_), .c(new_n112_), .O(z11));
  inv1   g47(.a(x10), .O(new_n114_));
  nor3   g48(.a(x37), .b(x36), .c(x35), .O(new_n115_));
  oai21  g49(.a(new_n115_), .b(new_n64_), .c(new_n114_), .O(new_n116_));
  aoi21  g50(.a(x35), .b(x28), .c(x37), .O(new_n117_));
  oai22  g51(.a(new_n117_), .b(new_n64_), .c(new_n76_), .d(x04), .O(new_n118_));
  nand2  g52(.a(new_n118_), .b(new_n116_), .O(z12));
  ...
  nand3  g60(.a(x35), .b(new_n66_), .c(new_n64_), .O(new_n129_));
  nand2  g61(.a(new_n129_), .b(new_n103_), .O(new_n130_));
  nand2  g62(.a(new_n130_), .b(x08), .O(new_n131_));
  nand3  g63(.a(new_n131_), .b(new_n111_), .c(new_n109_), .O(z18));
  oai21  g64(.a(new_n79_), .b(new_n64_), .c(new_n107_), .O(new_n133_));
  oai21  g65(.a(new_n66_), .b(x27), .c(x35), .O(new_n134_));
  nand2  g66(.a(new_n134_), .b(new_n103_), .O(new_n135_));
  aoi21  g67(.a(new_n135_), .b(new_n133_), .c(new_n112_), .O(z20));
  zero   g68(.O(z00));
  zero   g69(.O(z05));
  zero   g70(.O(z09));
  zero   g71(.O(z10));
  zero   g72(.O(z13));
  zero   g73(.O(z14));
  aoi21  g74(.a(new_n110_), .b(new_n106_), .c(new_n112_), .O(z19));
endmodule
