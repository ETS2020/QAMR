...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n155_, new_n160_, new_n161_, new_n162_;
  ...
  oai21  g093(.a(new_n81_), .b(new_n72_), .c(new_n116_), .O(new_n160_));
  oai21  g094(.a(new_n74_), .b(x27), .c(x35), .O(new_n161_));
  nand2  g095(.a(new_n161_), .b(new_n113_), .O(new_n162_));
  aoi21  g096(.a(new_n162_), .b(new_n160_), .c(new_n121_), .O(z20));
  zero   g097(.O(z02));
  zero   g098(.O(z17));
  zero   g099(.O(z18));
  zero   g100(.O(z19));
