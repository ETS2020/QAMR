...
module FAU ( 
  ...
  nor2   g32(.a(new_n98_), .b(new_n77_), .O(new_n99_));
  aoi21  g33(.a(new_n97_), .b(new_n76_), .c(new_n99_), .O(new_n100_));
  nand3  g34(.a(x37), .b(x27), .c(x06), .O(new_n101_));
  oai21  g35(.a(new_n100_), .b(x04), .c(new_n101_), .O(z10));
  aoi21  g36(.a(new_n63_), .b(new_n88_), .c(new_n72_), .O(new_n104_));
  nor2   g37(.a(new_n66_), .b(new_n72_), .O(new_n105_));
  nor2   g38(.a(new_n82_), .b(x04), .O(new_n106_));
  oai22  g39(.a(new_n106_), .b(new_n105_), .c(new_n104_), .d(x10), .O(z12));
  nor2   g40(.a(x19), .b(x18), .O(new_n109_));
  nand2  g41(.a(new_n109_), .b(x20), .O(new_n110_));
  inv1   g42(.a(x30), .O(new_n111_));
  inv1   g43(.a(x32), .O(new_n112_));
  nand2  g44(.a(x36), .b(x35), .O(new_n113_));
  nand4  g45(.a(new_n113_), .b(new_n112_), .c(new_n111_), .d(x28), .O(new_n114_));
  inv1   g46(.a(new_n114_), .O(new_n115_));
  nor2   g47(.a(x13), .b(x04), .O(new_n116_));
  nand2  g48(.a(new_n116_), .b(z08), .O(new_n117_));
  oai21  g49(.a(new_n117_), .b(new_n115_), .c(new_n110_), .O(new_n118_));
  inv1   g50(.a(x35), .O(new_n119_));
  nand3  g51(.a(new_n88_), .b(new_n119_), .c(x28), .O(new_n120_));
  nand2  g52(.a(new_n120_), .b(x27), .O(new_n121_));
  nand2  g53(.a(new_n121_), .b(new_n77_), .O(new_n122_));
  oai21  g54(.a(new_n66_), .b(new_n72_), .c(new_n117_), .O(new_n123_));
  nand3  g55(.a(new_n123_), .b(new_n122_), .c(new_n118_), .O(z14));
