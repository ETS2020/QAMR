...
module FAU ( 
  ...
  oai21  g75(.a(new_n67_), .b(x27), .c(new_n104_), .O(new_n141_));
  nand2  g76(.a(new_n141_), .b(x08), .O(new_n142_));
  nand3  g77(.a(new_n142_), .b(new_n111_), .c(new_n109_), .O(z18));
  oai21  g78(.a(new_n79_), .b(new_n64_), .c(new_n108_), .O(new_n144_));
  oai21  g79(.a(new_n66_), .b(x27), .c(x35), .O(new_n145_));
  nand2  g80(.a(new_n145_), .b(new_n104_), .O(new_n146_));
  aoi21  g81(.a(new_n146_), .b(new_n144_), .c(new_n112_), .O(z20));
  zero   g82(.O(z00));
  zero   g83(.O(z10));
  zero   g84(.O(z13));
