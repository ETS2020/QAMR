...
module FAU ( 
  ...
  nor3   g34(.a(new_n100_), .b(new_n77_), .c(new_n95_), .O(new_n101_));
  aoi21  g35(.a(new_n99_), .b(new_n97_), .c(new_n101_), .O(new_n102_));
  nand3  g36(.a(x37), .b(x27), .c(x06), .O(new_n103_));
  oai21  g37(.a(new_n102_), .b(x04), .c(new_n103_), .O(z10));
  nand3  g38(.a(x40), .b(x39), .c(x29), .O(new_n105_));
  nor2   g39(.a(new_n83_), .b(new_n64_), .O(new_n106_));
  ...
  inv1   g47(.a(x13), .O(new_n115_));
  inv1   g48(.a(x39), .O(new_n116_));
  nor2   g49(.a(new_n116_), .b(x04), .O(new_n117_));
  oai21  g50(.a(new_n98_), .b(new_n81_), .c(x28), .O(new_n118_));
  nand4  g51(.a(new_n118_), .b(new_n117_), .c(x40), .d(new_n115_), .O(new_n119_));
  inv1   g52(.a(new_n66_), .O(new_n120_));
  nor2   g53(.a(x19), .b(x18), .O(new_n121_));
  nand3  g54(.a(new_n121_), .b(new_n120_), .c(x20), .O(new_n122_));
  nand2  g55(.a(new_n122_), .b(new_n119_), .O(new_n123_));
  nand2  g56(.a(new_n123_), .b(x27), .O(new_n124_));
  nor2   g57(.a(new_n100_), .b(new_n77_), .O(new_n125_));
  nand3  g58(.a(new_n125_), .b(new_n115_), .c(new_n64_), .O(new_n126_));
  nand2  g59(.a(new_n126_), .b(new_n124_), .O(z13));
  nand2  g60(.a(x22), .b(x01), .O(new_n130_));
  nor2   g61(.a(new_n130_), .b(x23), .O(z16));
  inv1   g62(.a(x24), .O(new_n132_));
  nand4  g63(.a(new_n132_), .b(x23), .c(x22), .d(x01), .O(new_n133_));
  inv1   g64(.a(new_n133_), .O(z17));
  oai21  g65(.a(new_n75_), .b(x27), .c(new_n105_), .O(new_n135_));
  nand2  g66(.a(new_n135_), .b(x08), .O(new_n136_));
  nand3  g67(.a(new_n136_), .b(new_n111_), .c(new_n109_), .O(z18));
  oai21  g68(.a(new_n81_), .b(new_n83_), .c(new_n108_), .O(new_n138_));
  oai21  g69(.a(new_n74_), .b(x27), .c(x35), .O(new_n139_));
  nand2  g70(.a(new_n139_), .b(new_n105_), .O(new_n140_));
  aoi21  g71(.a(new_n140_), .b(new_n138_), .c(new_n112_), .O(z20));
  zero   g72(.O(z01));
  zero   g73(.O(z05));
  zero   g74(.O(z07));
  zero   g75(.O(z08));
