// Benchmark "FAU" written by ABC on Thu Jul  9 22:57:20 2020
...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n150_, new_n151_, new_n154_, new_n155_, new_n156_;
  ...
  nand2  g46(.a(x27), .b(new_n64_), .O(new_n110_));
  oai21  g47(.a(new_n110_), .b(new_n75_), .c(new_n109_), .O(new_n111_));
  inv1   g48(.a(x09), .O(new_n112_));
  inv1   g49(.a(x30), .O(new_n113_));
  nand2  g50(.a(new_n113_), .b(new_n112_), .O(new_n114_));
  aoi21  g51(.a(new_n111_), .b(new_n108_), .c(new_n114_), .O(z11));
  aoi21  g52(.a(new_n63_), .b(new_n88_), .c(new_n72_), .O(new_n116_));
  inv1   g53(.a(new_n66_), .O(new_n117_));
  nand2  g54(.a(new_n117_), .b(x27), .O(new_n118_));
  oai21  g55(.a(new_n82_), .b(x04), .c(new_n118_), .O(new_n119_));
  oai21  g56(.a(new_n116_), .b(x10), .c(new_n119_), .O(z12));
  nand2  g57(.a(x36), .b(x35), .O(new_n121_));
  nand2  g58(.a(new_n121_), .b(x28), .O(new_n122_));
  inv1   g59(.a(x40), .O(new_n123_));
  nor2   g60(.a(new_n123_), .b(x13), .O(new_n124_));
  nand4  g61(.a(new_n124_), .b(new_n122_), .c(x39), .d(new_n64_), .O(new_n125_));
  inv1   g62(.a(x18), .O(new_n126_));
  inv1   g63(.a(x19), .O(new_n127_));
  nand3  g64(.a(x20), .b(new_n127_), .c(new_n126_), .O(new_n128_));
  inv1   g65(.a(new_n128_), .O(new_n129_));
  nand2  g66(.a(new_n129_), .b(new_n117_), .O(new_n130_));
  nand2  g67(.a(new_n130_), .b(new_n125_), .O(new_n131_));
  nand2  g68(.a(new_n131_), .b(x27), .O(new_n132_));
  nor2   g69(.a(x13), .b(x04), .O(new_n133_));
  nand3  g70(.a(new_n133_), .b(new_n78_), .c(z08), .O(new_n134_));
  nand2  g71(.a(new_n134_), .b(new_n132_), .O(z13));
  inv1   g72(.a(x32), .O(new_n136_));
  nand4  g73(.a(new_n121_), .b(new_n136_), .c(new_n113_), .d(x28), .O(new_n137_));
  inv1   g74(.a(new_n137_), .O(new_n138_));
  nand2  g75(.a(new_n133_), .b(z08), .O(new_n139_));
  oai21  g76(.a(new_n139_), .b(new_n138_), .c(new_n128_), .O(new_n140_));
  ...
  nand2  g80(.a(new_n139_), .b(new_n118_), .O(new_n144_));
  ...
  oai21  g89(.a(new_n86_), .b(new_n72_), .c(new_n109_), .O(new_n154_));
  oai21  g90(.a(new_n74_), .b(x27), .c(x35), .O(new_n155_));
  nand2  g91(.a(new_n155_), .b(new_n106_), .O(new_n156_));
  aoi21  g92(.a(new_n156_), .b(new_n154_), .c(new_n114_), .O(z20));
  zero   g93(.O(z07));
  zero   g94(.O(z18));
  aoi21  g95(.a(new_n111_), .b(new_n108_), .c(new_n114_), .O(z19));
endmodule
