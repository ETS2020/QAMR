...
module FAU ( 
  ...
  nand3  g29(.a(x40), .b(x39), .c(x05), .O(new_n97_));
  nor2   g30(.a(new_n97_), .b(new_n77_), .O(new_n98_));
  aoi21  g31(.a(new_n96_), .b(new_n76_), .c(new_n98_), .O(new_n99_));
  ...
  nand2  g39(.a(new_n108_), .b(x20), .O(new_n109_));
  inv1   g40(.a(x30), .O(new_n110_));
  inv1   g41(.a(x32), .O(new_n111_));
  nand2  g42(.a(x36), .b(x35), .O(new_n112_));
  nand4  g43(.a(new_n112_), .b(new_n111_), .c(new_n110_), .d(x28), .O(new_n113_));
  inv1   g44(.a(new_n113_), .O(new_n114_));
  nor2   g45(.a(x13), .b(x04), .O(new_n115_));
  nand2  g46(.a(new_n115_), .b(z08), .O(new_n116_));
  oai21  g47(.a(new_n116_), .b(new_n114_), .c(new_n109_), .O(new_n117_));
  inv1   g48(.a(x35), .O(new_n118_));
  nand3  g49(.a(new_n88_), .b(new_n118_), .c(x28), .O(new_n119_));
  nand2  g50(.a(new_n119_), .b(x27), .O(new_n120_));
  nand2  g51(.a(new_n120_), .b(new_n77_), .O(new_n121_));
  oai21  g52(.a(new_n66_), .b(new_n72_), .c(new_n116_), .O(new_n122_));
  nand3  g53(.a(new_n122_), .b(new_n121_), .c(new_n117_), .O(z14));
  nand4  g54(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n124_));
  inv1   g55(.a(new_n124_), .O(z15));
  inv1   g56(.a(x24), .O(new_n127_));
  nand4  g57(.a(new_n127_), .b(x23), .c(x22), .d(x01), .O(new_n128_));
  inv1   g58(.a(new_n128_), .O(z17));
  zero   g59(.O(z03));
  zero   g60(.O(z04));
  zero   g61(.O(z06));
  zero   g62(.O(z07));
