// Benchmark "FAU" written by ABC on Thu Jul  9 22:55:31 2020
...
module FAU ( 
  ...
  nand3  g53(.a(x40), .b(x39), .c(x29), .O(new_n118_));
  ...
  oai21  g70(.a(new_n75_), .b(x27), .c(new_n118_), .O(new_n138_));
  nand2  g71(.a(new_n138_), .b(x08), .O(new_n139_));
  nand4  g72(.a(new_n139_), .b(new_n123_), .c(new_n111_), .d(new_n125_), .O(z18));
  oai21  g73(.a(new_n81_), .b(new_n83_), .c(new_n121_), .O(new_n141_));
  oai21  g74(.a(new_n74_), .b(x27), .c(x35), .O(new_n142_));
  nand2  g75(.a(new_n142_), .b(new_n118_), .O(new_n143_));
  aoi21  g76(.a(new_n143_), .b(new_n141_), .c(new_n126_), .O(z20));
  zero   g77(.O(z01));
  zero   g78(.O(z08));
  zero   g79(.O(z12));
  zero   g80(.O(z13));
