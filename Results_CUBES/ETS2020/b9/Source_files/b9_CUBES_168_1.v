...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n128_, new_n131_, new_n134_, new_n135_, new_n138_, new_n139_,
    new_n140_;
  ...
  oai21  g69(.a(new_n73_), .b(new_n84_), .c(new_n111_), .O(new_n138_));
  oai21  g70(.a(new_n82_), .b(x27), .c(x35), .O(new_n139_));
  nand2  g71(.a(new_n139_), .b(new_n108_), .O(new_n140_));
  aoi21  g72(.a(new_n140_), .b(new_n138_), .c(new_n114_), .O(z20));
  zero   g73(.O(z01));
  zero   g74(.O(z10));
  zero   g75(.O(z12));
  zero   g76(.O(z14));
  zero   g77(.O(z16));
  zero   g78(.O(z18));
  aoi21  g79(.a(new_n113_), .b(new_n110_), .c(new_n114_), .O(z19));
endmodule
