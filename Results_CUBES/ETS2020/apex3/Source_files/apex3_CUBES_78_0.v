...
module FAU ( 
  ...
  wire new_n123_, new_n124_, new_n125_, new_n126_, new_n127_, new_n128_,
    ...
    new_n184_, new_n189_, new_n190_, new_n191_, new_n199_, new_n200_,
    new_n201_, new_n202_;
  ...
  nand3  g54(.a(new_n174_), .b(x51), .c(new_n145_), .O(new_n199_));
  inv1   g55(.a(x43), .O(new_n200_));
  nand2  g56(.a(new_n200_), .b(x27), .O(new_n201_));
  nand3  g57(.a(new_n144_), .b(new_n159_), .c(new_n126_), .O(new_n202_));
  nor3   g58(.a(new_n202_), .b(new_n201_), .c(new_n199_), .O(z48));
  zero   g59(.O(z00));
  zero   g60(.O(z01));
  zero   g61(.O(z02));
  zero   g62(.O(z03));
