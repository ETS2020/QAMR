...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15, z16;
  wire new_n46_, new_n47_, new_n49_, new_n52_, new_n56_, new_n58_, new_n60_,
  ...
  nand3  g36(.a(x21), .b(x20), .c(x19), .O(new_n87_));
  inv1   g37(.a(new_n87_), .O(new_n88_));
  nand2  g38(.a(x26), .b(x17), .O(new_n89_));
  nand3  g39(.a(x24), .b(x23), .c(x22), .O(new_n90_));
  inv1   g40(.a(new_n90_), .O(new_n91_));
  nand3  g41(.a(new_n91_), .b(new_n89_), .c(new_n88_), .O(new_n92_));
  inv1   g42(.a(x25), .O(new_n93_));
  nand4  g43(.a(new_n93_), .b(x24), .c(x23), .d(x22), .O(new_n94_));
  inv1   g44(.a(new_n94_), .O(new_n95_));
  aoi22  g45(.a(new_n95_), .b(new_n88_), .c(new_n92_), .d(x25), .O(new_n96_));
  oai21  g46(.a(new_n96_), .b(new_n64_), .c(new_n56_), .O(z15));
  inv1   g47(.a(x18), .O(new_n98_));
  nand4  g48(.a(x25), .b(x24), .c(x19), .d(new_n98_), .O(new_n99_));
  nand4  g49(.a(x23), .b(x22), .c(x21), .d(x20), .O(new_n100_));
  oai21  g50(.a(new_n100_), .b(new_n99_), .c(x26), .O(new_n101_));
  nor2   g51(.a(x26), .b(new_n93_), .O(new_n102_));
  nand4  g52(.a(x24), .b(x23), .c(x20), .d(x19), .O(new_n103_));
  inv1   g53(.a(new_n103_), .O(new_n104_));
  nand4  g54(.a(new_n104_), .b(new_n102_), .c(x22), .d(x21), .O(new_n105_));
  nand2  g55(.a(new_n105_), .b(new_n101_), .O(new_n106_));
  nand2  g56(.a(new_n106_), .b(new_n65_), .O(new_n107_));
  nand2  g57(.a(new_n107_), .b(new_n58_), .O(z16));
  zero   g58(.O(z00));
  zero   g59(.O(z03));
  zero   g60(.O(z06));
  zero   g61(.O(z11));
