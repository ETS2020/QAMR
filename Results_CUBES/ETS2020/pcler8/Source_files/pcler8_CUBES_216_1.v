// Benchmark "FAU" written by ABC on Tue Jul  7 12:13:51 2020
...
module FAU ( 
  ...
  and2   g44(.a(x22), .b(x21), .O(new_n92_));
  nand2  g45(.a(new_n92_), .b(new_n86_), .O(new_n93_));
  nor2   g46(.a(new_n93_), .b(new_n91_), .O(new_n94_));
  oai21  g47(.a(new_n94_), .b(new_n90_), .c(new_n66_), .O(new_n95_));
  nand2  g48(.a(new_n95_), .b(new_n54_), .O(z13));
  nand3  g49(.a(x21), .b(x20), .c(x19), .O(new_n98_));
  inv1   g50(.a(new_n98_), .O(new_n99_));
  nand2  g51(.a(x26), .b(x17), .O(new_n100_));
  nand3  g52(.a(x24), .b(x23), .c(x22), .O(new_n101_));
  inv1   g53(.a(new_n101_), .O(new_n102_));
  nand3  g54(.a(new_n102_), .b(new_n100_), .c(new_n99_), .O(new_n103_));
  inv1   g55(.a(x25), .O(new_n104_));
  nand4  g56(.a(new_n104_), .b(x24), .c(x23), .d(x22), .O(new_n105_));
  inv1   g57(.a(new_n105_), .O(new_n106_));
  aoi22  g58(.a(new_n106_), .b(new_n99_), .c(new_n103_), .d(x25), .O(new_n107_));
  oai21  g59(.a(new_n107_), .b(new_n65_), .c(new_n57_), .O(z15));
  inv1   g60(.a(x18), .O(new_n109_));
  nand4  g61(.a(x25), .b(x24), .c(x19), .d(new_n109_), .O(new_n110_));
  nand4  g62(.a(x23), .b(x22), .c(x21), .d(x20), .O(new_n111_));
  oai21  g63(.a(new_n111_), .b(new_n110_), .c(x26), .O(new_n112_));
  and2   g64(.a(x24), .b(x23), .O(new_n113_));
  inv1   g65(.a(new_n91_), .O(new_n114_));
  nor2   g66(.a(x26), .b(new_n104_), .O(new_n115_));
  nand4  g67(.a(new_n115_), .b(new_n114_), .c(new_n92_), .d(new_n113_), .O(new_n116_));
  nand2  g68(.a(new_n116_), .b(new_n112_), .O(new_n117_));
  nand2  g69(.a(new_n117_), .b(new_n66_), .O(new_n118_));
  nand2  g70(.a(new_n118_), .b(new_n59_), .O(z16));
  zero   g71(.O(z00));
  zero   g72(.O(z06));
  zero   g73(.O(z11));
  zero   g74(.O(z14));
