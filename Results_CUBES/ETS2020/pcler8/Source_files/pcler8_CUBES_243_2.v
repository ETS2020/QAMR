...
module FAU ( 
  ...
  nand2  g34(.a(x08), .b(x01), .O(new_n81_));
  oai21  g35(.a(new_n80_), .b(new_n75_), .c(new_n81_), .O(z10));
  nand2  g36(.a(x26), .b(x25), .O(new_n83_));
  nand4  g37(.a(x24), .b(x23), .c(x22), .d(x13), .O(new_n84_));
  ...
  oai21  g43(.a(new_n89_), .b(new_n75_), .c(new_n60_), .O(z11));
  nand3  g44(.a(x26), .b(x25), .c(x16), .O(new_n93_));
  nand3  g45(.a(x21), .b(x20), .c(x19), .O(new_n94_));
  inv1   g46(.a(new_n94_), .O(new_n95_));
  nand4  g47(.a(new_n95_), .b(new_n93_), .c(x23), .d(x22), .O(new_n96_));
  nand2  g48(.a(x23), .b(x22), .O(new_n97_));
  nor3   g49(.a(new_n94_), .b(new_n97_), .c(x24), .O(new_n98_));
  aoi21  g50(.a(new_n96_), .b(x24), .c(new_n98_), .O(new_n99_));
  oai21  g51(.a(new_n99_), .b(new_n75_), .c(new_n64_), .O(z14));
  nand2  g52(.a(x26), .b(x17), .O(new_n101_));
  nand3  g53(.a(x24), .b(x23), .c(x22), .O(new_n102_));
  inv1   g54(.a(new_n102_), .O(new_n103_));
  nand3  g55(.a(new_n103_), .b(new_n101_), .c(new_n95_), .O(new_n104_));
  inv1   g56(.a(x25), .O(new_n105_));
  nand4  g57(.a(new_n105_), .b(x24), .c(x23), .d(x22), .O(new_n106_));
  inv1   g58(.a(new_n106_), .O(new_n107_));
  aoi22  g59(.a(new_n107_), .b(new_n95_), .c(new_n104_), .d(x25), .O(new_n108_));
  oai21  g60(.a(new_n108_), .b(new_n75_), .c(new_n66_), .O(z15));
  nor2   g61(.a(new_n52_), .b(x18), .O(new_n110_));
  nand3  g62(.a(new_n110_), .b(new_n49_), .c(new_n45_), .O(new_n111_));
  inv1   g63(.a(x26), .O(new_n112_));
  nand4  g64(.a(new_n112_), .b(x25), .c(x20), .d(x19), .O(new_n113_));
  nand4  g65(.a(x24), .b(x23), .c(x22), .d(x21), .O(new_n114_));
  nor2   g66(.a(new_n114_), .b(new_n113_), .O(new_n115_));
  aoi21  g67(.a(new_n111_), .b(x26), .c(new_n115_), .O(new_n116_));
  oai21  g68(.a(new_n116_), .b(new_n75_), .c(new_n68_), .O(z16));
  zero   g69(.O(z02));
  zero   g70(.O(z04));
  zero   g71(.O(z12));
  zero   g72(.O(z13));
