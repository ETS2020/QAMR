...
module FAU ( 
  ...
  nand2  g30(.a(x26), .b(x25), .O(new_n78_));
  nand4  g31(.a(x24), .b(x23), .c(x22), .d(x13), .O(new_n79_));
  ...
  oai21  g37(.a(new_n84_), .b(new_n75_), .c(new_n60_), .O(z11));
  nand3  g38(.a(x26), .b(x25), .c(x16), .O(new_n88_));
  nand3  g39(.a(x21), .b(x20), .c(x19), .O(new_n89_));
  inv1   g40(.a(new_n89_), .O(new_n90_));
  nand4  g41(.a(new_n90_), .b(new_n88_), .c(x23), .d(x22), .O(new_n91_));
  nand2  g42(.a(x23), .b(x22), .O(new_n92_));
  nor3   g43(.a(new_n89_), .b(new_n92_), .c(x24), .O(new_n93_));
  aoi21  g44(.a(new_n91_), .b(x24), .c(new_n93_), .O(new_n94_));
  oai21  g45(.a(new_n94_), .b(new_n75_), .c(new_n64_), .O(z14));
  nand2  g46(.a(x26), .b(x17), .O(new_n96_));
  nand3  g47(.a(x24), .b(x23), .c(x22), .O(new_n97_));
  inv1   g48(.a(new_n97_), .O(new_n98_));
  nand3  g49(.a(new_n98_), .b(new_n96_), .c(new_n90_), .O(new_n99_));
  inv1   g50(.a(x25), .O(new_n100_));
  nand4  g51(.a(new_n100_), .b(x24), .c(x23), .d(x22), .O(new_n101_));
  inv1   g52(.a(new_n101_), .O(new_n102_));
  aoi22  g53(.a(new_n102_), .b(new_n90_), .c(new_n99_), .d(x25), .O(new_n103_));
  oai21  g54(.a(new_n103_), .b(new_n75_), .c(new_n66_), .O(z15));
  nor2   g55(.a(new_n52_), .b(x18), .O(new_n105_));
  nand3  g56(.a(new_n105_), .b(new_n49_), .c(new_n45_), .O(new_n106_));
  inv1   g57(.a(x26), .O(new_n107_));
  nand4  g58(.a(new_n107_), .b(x25), .c(x20), .d(x19), .O(new_n108_));
  nand4  g59(.a(x24), .b(x23), .c(x22), .d(x21), .O(new_n109_));
  nor2   g60(.a(new_n109_), .b(new_n108_), .O(new_n110_));
  aoi21  g61(.a(new_n106_), .b(x26), .c(new_n110_), .O(new_n111_));
  oai21  g62(.a(new_n111_), .b(new_n75_), .c(new_n68_), .O(z16));
  zero   g63(.O(z02));
  zero   g64(.O(z05));
  zero   g65(.O(z10));
  zero   g66(.O(z12));
