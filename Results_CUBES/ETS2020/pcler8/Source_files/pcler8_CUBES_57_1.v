...
module FAU ( 
  ...
  oai21  g53(.a(new_n101_), .b(new_n75_), .c(new_n64_), .O(z13));
  nand3  g54(.a(x21), .b(x20), .c(x19), .O(new_n104_));
  inv1   g55(.a(new_n104_), .O(new_n105_));
  nand2  g56(.a(x26), .b(x17), .O(new_n106_));
  nand3  g57(.a(x24), .b(x23), .c(x22), .O(new_n107_));
  inv1   g58(.a(new_n107_), .O(new_n108_));
  nand3  g59(.a(new_n108_), .b(new_n106_), .c(new_n105_), .O(new_n109_));
  inv1   g60(.a(x25), .O(new_n110_));
  nand4  g61(.a(new_n110_), .b(x24), .c(x23), .d(x22), .O(new_n111_));
  inv1   g62(.a(new_n111_), .O(new_n112_));
  aoi22  g63(.a(new_n112_), .b(new_n105_), .c(new_n109_), .d(x25), .O(new_n113_));
  oai21  g64(.a(new_n113_), .b(new_n75_), .c(new_n67_), .O(z15));
  nor2   g65(.a(new_n52_), .b(x18), .O(new_n115_));
  nand3  g66(.a(new_n115_), .b(new_n49_), .c(new_n45_), .O(new_n116_));
  inv1   g67(.a(x26), .O(new_n117_));
  nand4  g68(.a(new_n117_), .b(x25), .c(x22), .d(x21), .O(new_n118_));
  nand4  g69(.a(x24), .b(x23), .c(x20), .d(x19), .O(new_n119_));
  nor2   g70(.a(new_n119_), .b(new_n118_), .O(new_n120_));
  aoi21  g71(.a(new_n116_), .b(x26), .c(new_n120_), .O(new_n121_));
  nand2  g72(.a(x08), .b(x07), .O(new_n122_));
  oai21  g73(.a(new_n121_), .b(new_n75_), .c(new_n122_), .O(z16));
  zero   g74(.O(z03));
  zero   g75(.O(z06));
  zero   g76(.O(z08));
  zero   g77(.O(z11));
