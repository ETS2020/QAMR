...
module FAU ( 
  ...
  wire new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_, new_n51_,
    ...
    new_n84_, new_n85_, new_n86_, new_n87_, new_n88_, new_n89_, new_n93_,
  ...
  nand2  g33(.a(x08), .b(x01), .O(new_n81_));
  oai21  g34(.a(new_n80_), .b(new_n75_), .c(new_n81_), .O(z10));
  nand2  g35(.a(x26), .b(x25), .O(new_n83_));
  nand4  g36(.a(x24), .b(x23), .c(x22), .d(x13), .O(new_n84_));
  nand2  g37(.a(x20), .b(x19), .O(new_n85_));
  inv1   g38(.a(new_n85_), .O(new_n86_));
  oai21  g39(.a(new_n84_), .b(new_n83_), .c(new_n86_), .O(new_n87_));
  nor2   g40(.a(new_n85_), .b(x21), .O(new_n88_));
  aoi21  g41(.a(new_n87_), .b(x21), .c(new_n88_), .O(new_n89_));
  oai21  g42(.a(new_n89_), .b(new_n75_), .c(new_n60_), .O(z11));
  nand3  g43(.a(x26), .b(x25), .c(x16), .O(new_n93_));
  nand3  g44(.a(x21), .b(x20), .c(x19), .O(new_n94_));
  inv1   g45(.a(new_n94_), .O(new_n95_));
  nand4  g46(.a(new_n95_), .b(new_n93_), .c(x23), .d(x22), .O(new_n96_));
  nand2  g47(.a(x23), .b(x22), .O(new_n97_));
  nor3   g48(.a(new_n94_), .b(new_n97_), .c(x24), .O(new_n98_));
  aoi21  g49(.a(new_n96_), .b(x24), .c(new_n98_), .O(new_n99_));
  oai21  g50(.a(new_n99_), .b(new_n75_), .c(new_n64_), .O(z14));
  nand2  g51(.a(x26), .b(x17), .O(new_n101_));
  nand3  g52(.a(x24), .b(x23), .c(x22), .O(new_n102_));
  inv1   g53(.a(new_n102_), .O(new_n103_));
  nand3  g54(.a(new_n103_), .b(new_n101_), .c(new_n95_), .O(new_n104_));
  inv1   g55(.a(x25), .O(new_n105_));
  nand4  g56(.a(new_n105_), .b(x24), .c(x23), .d(x22), .O(new_n106_));
  inv1   g57(.a(new_n106_), .O(new_n107_));
  aoi22  g58(.a(new_n107_), .b(new_n95_), .c(new_n104_), .d(x25), .O(new_n108_));
  oai21  g59(.a(new_n108_), .b(new_n75_), .c(new_n66_), .O(z15));
  nor2   g60(.a(new_n52_), .b(x18), .O(new_n110_));
  nand3  g61(.a(new_n110_), .b(new_n49_), .c(new_n45_), .O(new_n111_));
  inv1   g62(.a(x26), .O(new_n112_));
  nand4  g63(.a(new_n112_), .b(x25), .c(x20), .d(x19), .O(new_n113_));
  nand4  g64(.a(x24), .b(x23), .c(x22), .d(x21), .O(new_n114_));
  nor2   g65(.a(new_n114_), .b(new_n113_), .O(new_n115_));
  aoi21  g66(.a(new_n111_), .b(x26), .c(new_n115_), .O(new_n116_));
  oai21  g67(.a(new_n116_), .b(new_n75_), .c(new_n68_), .O(z16));
  zero   g68(.O(z02));
  zero   g69(.O(z04));
  zero   g70(.O(z05));
  zero   g71(.O(z12));
