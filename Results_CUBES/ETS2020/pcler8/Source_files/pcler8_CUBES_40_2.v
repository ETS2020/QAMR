...
module FAU ( 
  ...
  wire new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_, new_n51_,
    ...
    new_n76_, new_n77_, new_n78_, new_n79_, new_n80_, new_n84_, new_n85_,
  ...
  nand4  g21(.a(x26), .b(x25), .c(x24), .d(x23), .O(new_n69_));
  ...
  nand3  g28(.a(x22), .b(x21), .c(x12), .O(new_n76_));
  oai21  g29(.a(new_n76_), .b(new_n69_), .c(x19), .O(new_n77_));
  nor2   g30(.a(x20), .b(new_n52_), .O(new_n78_));
  aoi21  g31(.a(new_n77_), .b(x20), .c(new_n78_), .O(new_n79_));
  nand2  g32(.a(x08), .b(x01), .O(new_n80_));
  oai21  g33(.a(new_n79_), .b(new_n74_), .c(new_n80_), .O(z10));
  nand4  g34(.a(x26), .b(x25), .c(x24), .d(x15), .O(new_n84_));
  nand4  g35(.a(x22), .b(x21), .c(x20), .d(x19), .O(new_n85_));
  inv1   g36(.a(new_n85_), .O(new_n86_));
  nand2  g37(.a(new_n86_), .b(new_n84_), .O(new_n87_));
  nand2  g38(.a(x20), .b(x19), .O(new_n88_));
  inv1   g39(.a(x23), .O(new_n89_));
  nand3  g40(.a(new_n89_), .b(x22), .c(x21), .O(new_n90_));
  nor2   g41(.a(new_n90_), .b(new_n88_), .O(new_n91_));
  aoi21  g42(.a(new_n87_), .b(x23), .c(new_n91_), .O(new_n92_));
  nand2  g43(.a(x08), .b(x04), .O(new_n93_));
  oai21  g44(.a(new_n92_), .b(new_n74_), .c(new_n93_), .O(z13));
  ...
  oai21  g52(.a(new_n101_), .b(new_n74_), .c(new_n63_), .O(z14));
  ...
  oai21  g61(.a(new_n110_), .b(new_n74_), .c(new_n65_), .O(z15));
