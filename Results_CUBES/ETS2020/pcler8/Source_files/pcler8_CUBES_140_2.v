...
module FAU ( 
  ...
  nand4  g37(.a(x26), .b(x25), .c(x24), .d(x15), .O(new_n87_));
  nand4  g38(.a(x22), .b(x21), .c(x20), .d(x19), .O(new_n88_));
  inv1   g39(.a(new_n88_), .O(new_n89_));
  nand2  g40(.a(new_n89_), .b(new_n87_), .O(new_n90_));
  nand2  g41(.a(x22), .b(x21), .O(new_n91_));
  nor2   g42(.a(new_n91_), .b(x23), .O(new_n92_));
  aoi22  g43(.a(new_n92_), .b(new_n81_), .c(new_n90_), .d(x23), .O(new_n93_));
  nand2  g44(.a(x08), .b(x04), .O(new_n94_));
  oai21  g45(.a(new_n93_), .b(new_n75_), .c(new_n94_), .O(z13));
  nand3  g46(.a(x26), .b(x25), .c(x16), .O(new_n96_));
  nand3  g47(.a(x21), .b(x20), .c(x19), .O(new_n97_));
  inv1   g48(.a(new_n97_), .O(new_n98_));
  nand4  g49(.a(new_n98_), .b(new_n96_), .c(x23), .d(x22), .O(new_n99_));
  nand2  g50(.a(x23), .b(x22), .O(new_n100_));
  nor3   g51(.a(new_n97_), .b(new_n100_), .c(x24), .O(new_n101_));
  aoi21  g52(.a(new_n99_), .b(x24), .c(new_n101_), .O(new_n102_));
  oai21  g53(.a(new_n102_), .b(new_n75_), .c(new_n64_), .O(z14));
  nand2  g54(.a(x26), .b(x17), .O(new_n104_));
  nand3  g55(.a(x24), .b(x23), .c(x22), .O(new_n105_));
  inv1   g56(.a(new_n105_), .O(new_n106_));
  nand3  g57(.a(new_n106_), .b(new_n104_), .c(new_n98_), .O(new_n107_));
  inv1   g58(.a(x25), .O(new_n108_));
  nand4  g59(.a(new_n108_), .b(x24), .c(x23), .d(x22), .O(new_n109_));
  inv1   g60(.a(new_n109_), .O(new_n110_));
  aoi22  g61(.a(new_n110_), .b(new_n98_), .c(new_n107_), .d(x25), .O(new_n111_));
  oai21  g62(.a(new_n111_), .b(new_n75_), .c(new_n66_), .O(z15));
  ...
  oai21  g70(.a(new_n119_), .b(new_n75_), .c(new_n68_), .O(z16));
  zero   g71(.O(z02));
  zero   g72(.O(z04));
  zero   g73(.O(z05));
  zero   g74(.O(z10));
