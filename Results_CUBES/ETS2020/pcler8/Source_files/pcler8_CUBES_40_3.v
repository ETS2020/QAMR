...
module FAU ( 
  ...
  nand3  g56(.a(x26), .b(x25), .c(x16), .O(new_n102_));
  nand3  g57(.a(x21), .b(x20), .c(x19), .O(new_n103_));
  inv1   g58(.a(new_n103_), .O(new_n104_));
  nand4  g59(.a(new_n104_), .b(new_n102_), .c(x23), .d(x22), .O(new_n105_));
  nand2  g60(.a(x23), .b(x22), .O(new_n106_));
  nor3   g61(.a(new_n103_), .b(new_n106_), .c(x24), .O(new_n107_));
  aoi21  g62(.a(new_n105_), .b(x24), .c(new_n107_), .O(new_n108_));
  oai21  g63(.a(new_n108_), .b(new_n77_), .c(new_n66_), .O(z14));
  nand2  g64(.a(x26), .b(x17), .O(new_n110_));
  nand3  g65(.a(x24), .b(x23), .c(x22), .O(new_n111_));
  inv1   g66(.a(new_n111_), .O(new_n112_));
  nand3  g67(.a(new_n112_), .b(new_n110_), .c(new_n104_), .O(new_n113_));
  inv1   g68(.a(x25), .O(new_n114_));
  nand4  g69(.a(new_n114_), .b(x24), .c(x23), .d(x22), .O(new_n115_));
  inv1   g70(.a(new_n115_), .O(new_n116_));
  aoi22  g71(.a(new_n116_), .b(new_n104_), .c(new_n113_), .d(x25), .O(new_n117_));
  oai21  g72(.a(new_n117_), .b(new_n77_), .c(new_n68_), .O(z15));
  nor2   g73(.a(new_n52_), .b(x18), .O(new_n119_));
  nand3  g74(.a(new_n119_), .b(new_n49_), .c(new_n45_), .O(new_n120_));
  inv1   g75(.a(x26), .O(new_n121_));
  nand4  g76(.a(new_n121_), .b(x25), .c(x22), .d(x21), .O(new_n122_));
  nand4  g77(.a(x24), .b(x23), .c(x20), .d(x19), .O(new_n123_));
  nor2   g78(.a(new_n123_), .b(new_n122_), .O(new_n124_));
  aoi21  g79(.a(new_n120_), .b(x26), .c(new_n124_), .O(new_n125_));
  oai21  g80(.a(new_n125_), .b(new_n77_), .c(new_n70_), .O(z16));
  zero   g81(.O(z13));
endmodule
