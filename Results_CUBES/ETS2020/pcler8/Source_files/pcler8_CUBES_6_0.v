// Benchmark "FAU" written by ABC on Tue Jul  7 12:12:18 2020
...
module FAU ( 
  ...
  wire new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_, new_n51_,
    ...
    new_n64_, new_n66_, new_n71_, new_n72_, new_n73_, new_n74_, new_n75_,
  ...
  nand4  g23(.a(x26), .b(x25), .c(x24), .d(x23), .O(new_n72_));
  oai21  g24(.a(new_n72_), .b(new_n71_), .c(x19), .O(new_n73_));
  nor2   g25(.a(x20), .b(new_n52_), .O(new_n74_));
  aoi21  g26(.a(new_n73_), .b(x20), .c(new_n74_), .O(new_n75_));
  inv1   g27(.a(x10), .O(new_n76_));
  nand2  g28(.a(new_n51_), .b(new_n76_), .O(new_n77_));
  oai22  g29(.a(new_n77_), .b(new_n75_), .c(new_n58_), .d(new_n57_), .O(z10));
  ...
  oai21  g37(.a(new_n85_), .b(new_n77_), .c(new_n60_), .O(z11));
  ...
  oai21  g46(.a(new_n94_), .b(new_n77_), .c(new_n62_), .O(z12));
  ...
  oai21  g54(.a(new_n102_), .b(new_n77_), .c(new_n64_), .O(z13));
  ...
  oai21  g62(.a(new_n110_), .b(new_n77_), .c(new_n66_), .O(z14));
  ...
  nand2  g70(.a(x08), .b(x07), .O(new_n120_));
  oai21  g71(.a(new_n119_), .b(new_n77_), .c(new_n120_), .O(z16));
  zero   g72(.O(z01));
  zero   g73(.O(z07));
  zero   g74(.O(z08));
  zero   g75(.O(z09));
