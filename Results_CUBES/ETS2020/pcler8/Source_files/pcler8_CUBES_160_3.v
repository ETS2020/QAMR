...
module FAU ( 
  ...
  nand2  g37(.a(x08), .b(x01), .O(new_n83_));
  oai21  g38(.a(new_n82_), .b(new_n77_), .c(new_n83_), .O(z10));
  ...
  oai21  g46(.a(new_n91_), .b(new_n77_), .c(new_n60_), .O(z11));
  ...
  oai21  g55(.a(new_n100_), .b(new_n77_), .c(new_n62_), .O(z12));
  ...
  aoi22  g62(.a(new_n107_), .b(new_n88_), .c(new_n105_), .d(x23), .O(new_n108_));
