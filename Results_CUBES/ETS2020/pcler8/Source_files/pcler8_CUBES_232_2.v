...
module FAU ( 
  ...
  nand2  g45(.a(x08), .b(x03), .O(new_n94_));
  oai21  g46(.a(new_n93_), .b(new_n75_), .c(new_n94_), .O(z12));
  nand3  g47(.a(x26), .b(x25), .c(x16), .O(new_n97_));
  nand3  g48(.a(x21), .b(x20), .c(x19), .O(new_n98_));
  inv1   g49(.a(new_n98_), .O(new_n99_));
  nand4  g50(.a(new_n99_), .b(new_n97_), .c(x23), .d(x22), .O(new_n100_));
  nand2  g51(.a(x23), .b(x22), .O(new_n101_));
  nor3   g52(.a(new_n98_), .b(new_n101_), .c(x24), .O(new_n102_));
  aoi21  g53(.a(new_n100_), .b(x24), .c(new_n102_), .O(new_n103_));
  oai21  g54(.a(new_n103_), .b(new_n75_), .c(new_n64_), .O(z14));
  nand2  g55(.a(x26), .b(x17), .O(new_n105_));
  nand3  g56(.a(x24), .b(x23), .c(x22), .O(new_n106_));
  inv1   g57(.a(new_n106_), .O(new_n107_));
  nand3  g58(.a(new_n107_), .b(new_n105_), .c(new_n99_), .O(new_n108_));
  inv1   g59(.a(x25), .O(new_n109_));
  nand4  g60(.a(new_n109_), .b(x24), .c(x23), .d(x22), .O(new_n110_));
  inv1   g61(.a(new_n110_), .O(new_n111_));
  aoi22  g62(.a(new_n111_), .b(new_n99_), .c(new_n108_), .d(x25), .O(new_n112_));
  oai21  g63(.a(new_n112_), .b(new_n75_), .c(new_n66_), .O(z15));
  nor2   g64(.a(new_n52_), .b(x18), .O(new_n114_));
  nand3  g65(.a(new_n114_), .b(new_n49_), .c(new_n45_), .O(new_n115_));
  inv1   g66(.a(x26), .O(new_n116_));
  nand4  g67(.a(new_n116_), .b(x25), .c(x22), .d(x21), .O(new_n117_));
  nand4  g68(.a(x24), .b(x23), .c(x20), .d(x19), .O(new_n118_));
  nor2   g69(.a(new_n118_), .b(new_n117_), .O(new_n119_));
  aoi21  g70(.a(new_n115_), .b(x26), .c(new_n119_), .O(new_n120_));
  oai21  g71(.a(new_n120_), .b(new_n75_), .c(new_n68_), .O(z16));
  zero   g72(.O(z02));
  zero   g73(.O(z04));
  zero   g74(.O(z05));
  zero   g75(.O(z10));
