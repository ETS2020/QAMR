...
module FAU ( 
  ...
  nand3  g36(.a(new_n83_), .b(x18), .c(x01), .O(new_n84_));
  ...
  nand4  g42(.a(new_n83_), .b(x21), .c(x18), .d(x01), .O(new_n91_));
  nand4  g43(.a(new_n86_), .b(x20), .c(new_n73_), .d(x15), .O(new_n92_));
  inv1   g44(.a(new_n92_), .O(new_n93_));
  nand3  g45(.a(new_n93_), .b(new_n81_), .c(new_n76_), .O(new_n94_));
  nand2  g46(.a(new_n87_), .b(new_n85_), .O(new_n95_));
  aoi21  g47(.a(new_n94_), .b(new_n91_), .c(new_n95_), .O(z11));
  nor3   g48(.a(new_n53_), .b(x19), .c(new_n48_), .O(z13));
  inv1   g49(.a(x10), .O(new_n99_));
  nand4  g50(.a(new_n50_), .b(new_n49_), .c(new_n48_), .d(new_n99_), .O(new_n100_));
  nor2   g51(.a(new_n100_), .b(new_n47_), .O(z14));
  aoi21  g52(.a(new_n99_), .b(x01), .c(new_n44_), .O(new_n102_));
  inv1   g53(.a(x01), .O(new_n103_));
  nand3  g54(.a(x19), .b(new_n44_), .c(new_n103_), .O(new_n104_));
  oai21  g55(.a(new_n102_), .b(new_n85_), .c(new_n104_), .O(z15));
  nor2   g56(.a(new_n103_), .b(x00), .O(z16));
  inv1   g57(.a(new_n69_), .O(z17));
  zero   g58(.O(z02));
  zero   g59(.O(z03));
  zero   g60(.O(z06));
  zero   g61(.O(z07));
