...
module FAU ( 
  ...
  oai21  g55(.a(new_n55_), .b(new_n44_), .c(new_n65_), .O(new_n102_));
  oai21  g56(.a(x19), .b(x02), .c(x23), .O(new_n103_));
  nand3  g57(.a(new_n50_), .b(x17), .c(new_n44_), .O(new_n104_));
  ...
  nand3  g65(.a(x19), .b(new_n44_), .c(new_n64_), .O(new_n113_));
  oai21  g66(.a(new_n112_), .b(new_n63_), .c(new_n113_), .O(z15));
  nor2   g67(.a(new_n64_), .b(x00), .O(z16));
