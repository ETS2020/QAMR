...
module FAU ( 
  ...
  nand2  g17(.a(new_n61_), .b(x02), .O(new_n64_));
  inv1   g18(.a(x12), .O(new_n65_));
  nand4  g19(.a(new_n65_), .b(new_n55_), .c(x10), .d(new_n58_), .O(new_n66_));
  nor2   g20(.a(new_n66_), .b(new_n64_), .O(z04));
  nor3   g21(.a(new_n64_), .b(new_n54_), .c(new_n58_), .O(z05));
  nand3  g22(.a(new_n56_), .b(new_n58_), .c(x02), .O(new_n69_));
  nor3   g23(.a(new_n69_), .b(new_n60_), .c(new_n59_), .O(z06));
  nand4  g24(.a(new_n56_), .b(new_n65_), .c(new_n58_), .d(x01), .O(new_n71_));
  nand2  g25(.a(x02), .b(x00), .O(new_n72_));
  aoi21  g26(.a(new_n71_), .b(x01), .c(new_n72_), .O(z07));
  inv1   g27(.a(x08), .O(new_n74_));
  nand4  g28(.a(x19), .b(new_n47_), .c(x17), .d(new_n74_), .O(new_n75_));
  ...
  nand3  g33(.a(new_n52_), .b(new_n79_), .c(x02), .O(new_n80_));
  ...
  nand2  g39(.a(x02), .b(new_n60_), .O(new_n86_));
  inv1   g40(.a(new_n86_), .O(new_n87_));
  nor2   g41(.a(new_n65_), .b(x11), .O(new_n88_));
  nor2   g42(.a(x14), .b(x13), .O(new_n89_));
  nand4  g43(.a(new_n89_), .b(new_n88_), .c(new_n87_), .d(new_n85_), .O(new_n90_));
  ...
  nand3  g48(.a(new_n94_), .b(new_n93_), .c(new_n59_), .O(new_n95_));
  aoi21  g49(.a(new_n92_), .b(new_n90_), .c(new_n95_), .O(z09));
  nor2   g50(.a(x20), .b(new_n60_), .O(new_n97_));
  nand4  g51(.a(new_n97_), .b(new_n48_), .c(x22), .d(x21), .O(new_n98_));
  inv1   g52(.a(x13), .O(new_n99_));
  nand3  g53(.a(new_n99_), .b(x12), .c(new_n55_), .O(new_n100_));
  nor2   g54(.a(new_n100_), .b(new_n86_), .O(new_n101_));
  nor2   g55(.a(new_n82_), .b(x14), .O(new_n102_));
  nand4  g56(.a(new_n94_), .b(new_n93_), .c(x20), .d(x16), .O(new_n103_));
  ...
  nand4  g60(.a(new_n91_), .b(x21), .c(x18), .d(x01), .O(new_n107_));
  nand3  g61(.a(new_n93_), .b(x20), .c(new_n83_), .O(new_n108_));
  inv1   g62(.a(new_n108_), .O(new_n109_));
  nand3  g63(.a(new_n109_), .b(new_n102_), .c(new_n101_), .O(new_n110_));
  nand2  g64(.a(new_n94_), .b(new_n59_), .O(new_n111_));
  aoi21  g65(.a(new_n110_), .b(new_n107_), .c(new_n111_), .O(z11));
  oai21  g66(.a(new_n54_), .b(new_n50_), .c(new_n61_), .O(new_n113_));
  oai21  g67(.a(x19), .b(x02), .c(x23), .O(new_n114_));
  inv1   g68(.a(x19), .O(new_n115_));
  nand3  g69(.a(new_n115_), .b(x17), .c(new_n50_), .O(new_n116_));
  nand2  g70(.a(new_n116_), .b(new_n114_), .O(new_n117_));
  nand2  g71(.a(new_n117_), .b(new_n52_), .O(new_n118_));
  inv1   g72(.a(x24), .O(new_n119_));
  nand2  g73(.a(new_n119_), .b(x09), .O(new_n120_));
  aoi21  g74(.a(new_n118_), .b(new_n113_), .c(new_n120_), .O(z12));
  nand2  g75(.a(new_n52_), .b(new_n50_), .O(new_n122_));
  nor3   g76(.a(new_n122_), .b(x19), .c(new_n51_), .O(z13));
  nor2   g77(.a(x10), .b(x09), .O(new_n124_));
  nand4  g78(.a(new_n124_), .b(new_n115_), .c(new_n47_), .d(new_n51_), .O(new_n125_));
  nor2   g79(.a(new_n125_), .b(new_n122_), .O(z14));
  zero   g80(.O(z00));
  zero   g81(.O(z01));
  zero   g82(.O(z02));
  zero   g83(.O(z15));
