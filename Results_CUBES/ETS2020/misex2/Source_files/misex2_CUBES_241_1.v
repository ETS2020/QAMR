...
module FAU ( 
  ...
  aoi21  g59(.a(new_n53_), .b(x01), .c(new_n45_), .O(new_n107_));
  nand3  g60(.a(x19), .b(new_n45_), .c(new_n63_), .O(new_n108_));
  oai21  g61(.a(new_n107_), .b(new_n62_), .c(new_n108_), .O(z15));
  nor2   g62(.a(new_n63_), .b(x00), .O(z16));
  nand2  g63(.a(new_n46_), .b(x02), .O(new_n111_));
  inv1   g64(.a(new_n111_), .O(z17));
  zero   g65(.O(z00));
  zero   g66(.O(z08));
  zero   g67(.O(z10));
  zero   g68(.O(z12));
