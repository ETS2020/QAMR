...
module FAU ( 
  ...
  nand2  g39(.a(x02), .b(new_n65_), .O(new_n84_));
  inv1   g40(.a(new_n84_), .O(new_n85_));
  nor2   g41(.a(new_n70_), .b(x11), .O(new_n86_));
  nor2   g42(.a(x14), .b(x13), .O(new_n87_));
  nand4  g43(.a(new_n87_), .b(new_n86_), .c(new_n85_), .d(new_n83_), .O(new_n88_));
  nor2   g44(.a(x20), .b(x19), .O(new_n89_));
  nand3  g45(.a(new_n89_), .b(x18), .c(x01), .O(new_n90_));
  inv1   g46(.a(x21), .O(new_n91_));
  inv1   g47(.a(x22), .O(new_n92_));
  nand3  g48(.a(new_n92_), .b(new_n91_), .c(new_n64_), .O(new_n93_));
  aoi21  g49(.a(new_n90_), .b(new_n88_), .c(new_n93_), .O(z09));
  nor2   g50(.a(x20), .b(new_n65_), .O(new_n95_));
  nand4  g51(.a(new_n95_), .b(new_n58_), .c(x22), .d(x21), .O(new_n96_));
  inv1   g52(.a(x13), .O(new_n97_));
  nand3  g53(.a(new_n97_), .b(x12), .c(new_n61_), .O(new_n98_));
  nor2   g54(.a(new_n98_), .b(new_n84_), .O(new_n99_));
  nor2   g55(.a(new_n80_), .b(x14), .O(new_n100_));
  nand4  g56(.a(new_n92_), .b(new_n91_), .c(x20), .d(x16), .O(new_n101_));
  inv1   g57(.a(new_n101_), .O(new_n102_));
  nand3  g58(.a(new_n102_), .b(new_n100_), .c(new_n99_), .O(new_n103_));
  aoi21  g59(.a(new_n103_), .b(new_n96_), .c(x00), .O(z10));
  nand4  g60(.a(new_n89_), .b(x21), .c(x18), .d(x01), .O(new_n105_));
  nand3  g61(.a(new_n91_), .b(x20), .c(new_n81_), .O(new_n106_));
  inv1   g62(.a(new_n106_), .O(new_n107_));
  nand3  g63(.a(new_n107_), .b(new_n100_), .c(new_n99_), .O(new_n108_));
  nand2  g64(.a(new_n92_), .b(new_n64_), .O(new_n109_));
  aoi21  g65(.a(new_n108_), .b(new_n105_), .c(new_n109_), .O(z11));
  oai21  g66(.a(new_n55_), .b(new_n44_), .c(new_n66_), .O(new_n111_));
  ...
  nand2  g75(.a(new_n46_), .b(x02), .O(new_n123_));
