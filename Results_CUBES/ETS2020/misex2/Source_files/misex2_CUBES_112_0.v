...
module FAU ( 
  ...
  nor2   g48(.a(x20), .b(new_n63_), .O(new_n94_));
  nor2   g49(.a(new_n91_), .b(new_n90_), .O(new_n95_));
  nand4  g50(.a(new_n95_), .b(new_n94_), .c(new_n55_), .d(x18), .O(new_n96_));
  nand3  g51(.a(new_n91_), .b(new_n90_), .c(x20), .O(new_n97_));
  inv1   g52(.a(new_n97_), .O(new_n98_));
  nand4  g53(.a(x16), .b(x15), .c(new_n84_), .d(new_n83_), .O(new_n99_));
  inv1   g54(.a(new_n99_), .O(new_n100_));
  nand4  g55(.a(x12), .b(new_n59_), .c(x02), .d(new_n63_), .O(new_n101_));
  inv1   g56(.a(new_n101_), .O(new_n102_));
  nand3  g57(.a(new_n102_), .b(new_n100_), .c(new_n98_), .O(new_n103_));
  aoi21  g58(.a(new_n103_), .b(new_n96_), .c(x00), .O(z10));
  oai21  g59(.a(new_n52_), .b(new_n44_), .c(new_n64_), .O(new_n106_));
  oai21  g60(.a(x19), .b(x02), .c(x23), .O(new_n107_));
  nand3  g61(.a(new_n55_), .b(x17), .c(new_n44_), .O(new_n108_));
  nand2  g62(.a(new_n108_), .b(new_n107_), .O(new_n109_));
  nand2  g63(.a(new_n109_), .b(new_n45_), .O(new_n110_));
  inv1   g64(.a(x24), .O(new_n111_));
  nand2  g65(.a(new_n111_), .b(x09), .O(new_n112_));
  aoi21  g66(.a(new_n110_), .b(new_n106_), .c(new_n112_), .O(z12));
  nor3   g67(.a(new_n46_), .b(x19), .c(new_n57_), .O(z13));
  nor2   g68(.a(new_n63_), .b(x00), .O(z16));
  zero   g69(.O(z01));
  zero   g70(.O(z08));
  zero   g71(.O(z11));
  zero   g72(.O(z14));
