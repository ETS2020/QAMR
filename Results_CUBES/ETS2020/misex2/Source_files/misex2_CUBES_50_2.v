...
module FAU ( 
  ...
  nor2   g30(.a(x20), .b(x19), .O(new_n79_));
  nand4  g31(.a(new_n79_), .b(x21), .c(x18), .d(x01), .O(new_n80_));
  inv1   g32(.a(x16), .O(new_n81_));
  inv1   g33(.a(x21), .O(new_n82_));
  nand4  g34(.a(new_n82_), .b(x20), .c(new_n81_), .d(x15), .O(new_n83_));
  inv1   g35(.a(new_n83_), .O(new_n84_));
  inv1   g36(.a(x02), .O(new_n85_));
  nor2   g37(.a(new_n85_), .b(x01), .O(new_n86_));
  inv1   g38(.a(x13), .O(new_n87_));
  inv1   g39(.a(x14), .O(new_n88_));
  nand4  g40(.a(new_n88_), .b(new_n87_), .c(x12), .d(new_n62_), .O(new_n89_));
  inv1   g41(.a(new_n89_), .O(new_n90_));
  nand3  g42(.a(new_n90_), .b(new_n86_), .c(new_n84_), .O(new_n91_));
  inv1   g43(.a(x22), .O(new_n92_));
  nand2  g44(.a(new_n92_), .b(new_n58_), .O(new_n93_));
  aoi21  g45(.a(new_n91_), .b(new_n80_), .c(new_n93_), .O(z11));
  oai21  g46(.a(new_n54_), .b(new_n85_), .c(new_n60_), .O(new_n95_));
  oai21  g47(.a(x19), .b(x02), .c(x23), .O(new_n96_));
  nand3  g48(.a(new_n49_), .b(x17), .c(new_n85_), .O(new_n97_));
  nand2  g49(.a(new_n97_), .b(new_n96_), .O(new_n98_));
  nand2  g50(.a(new_n98_), .b(new_n73_), .O(new_n99_));
  inv1   g51(.a(x24), .O(new_n100_));
  nand2  g52(.a(new_n100_), .b(x09), .O(new_n101_));
  aoi21  g53(.a(new_n99_), .b(new_n95_), .c(new_n101_), .O(z12));
  nor2   g54(.a(x19), .b(new_n47_), .O(new_n103_));
  and2   g55(.a(new_n103_), .b(new_n45_), .O(z13));
  nor2   g56(.a(new_n55_), .b(new_n46_), .O(z14));
  aoi21  g57(.a(new_n54_), .b(x01), .c(new_n85_), .O(new_n106_));
  nand3  g58(.a(x19), .b(new_n85_), .c(new_n59_), .O(new_n107_));
  oai21  g59(.a(new_n106_), .b(new_n58_), .c(new_n107_), .O(z15));
  nor2   g60(.a(new_n59_), .b(x00), .O(z16));
