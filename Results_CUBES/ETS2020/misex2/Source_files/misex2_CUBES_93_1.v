...
module FAU ( 
  ...
  nand3  g65(.a(x19), .b(new_n44_), .c(new_n66_), .O(new_n113_));
  oai21  g66(.a(new_n112_), .b(new_n65_), .c(new_n113_), .O(z15));
  nor2   g67(.a(new_n66_), .b(x00), .O(z16));
  nand2  g68(.a(new_n46_), .b(x02), .O(new_n116_));
  inv1   g69(.a(new_n116_), .O(z17));
  zero   g70(.O(z01));
  zero   g71(.O(z08));
  zero   g72(.O(z11));
  zero   g73(.O(z12));
