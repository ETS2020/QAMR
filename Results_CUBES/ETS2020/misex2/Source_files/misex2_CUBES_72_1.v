...
module FAU ( 
  ...
  nand2  g36(.a(x02), .b(new_n66_), .O(new_n83_));
  inv1   g37(.a(new_n83_), .O(new_n84_));
  nor2   g38(.a(new_n74_), .b(x11), .O(new_n85_));
  ...
  nand3  g45(.a(new_n91_), .b(new_n90_), .c(new_n65_), .O(new_n92_));
  aoi21  g46(.a(new_n89_), .b(new_n87_), .c(new_n92_), .O(z09));
  nor2   g47(.a(x20), .b(new_n66_), .O(new_n94_));
  nand4  g48(.a(new_n94_), .b(new_n57_), .c(x22), .d(x21), .O(new_n95_));
  ...
  nand4  g57(.a(new_n88_), .b(x21), .c(x18), .d(x01), .O(new_n104_));
  nand3  g58(.a(new_n90_), .b(x20), .c(new_n80_), .O(new_n105_));
  inv1   g59(.a(new_n105_), .O(new_n106_));
  nand3  g60(.a(new_n106_), .b(new_n99_), .c(new_n98_), .O(new_n107_));
  nand2  g61(.a(new_n91_), .b(new_n65_), .O(new_n108_));
  aoi21  g62(.a(new_n107_), .b(new_n104_), .c(new_n108_), .O(z11));
  oai21  g63(.a(new_n54_), .b(new_n59_), .c(new_n67_), .O(new_n110_));
  ...
  nand3  g75(.a(x19), .b(new_n59_), .c(new_n66_), .O(new_n122_));
  oai21  g76(.a(new_n121_), .b(new_n65_), .c(new_n122_), .O(z15));
  nor2   g77(.a(new_n66_), .b(x00), .O(z16));
  nand2  g78(.a(new_n60_), .b(x02), .O(new_n125_));
