...
module FAU ( 
  ...
  oai21  g63(.a(new_n61_), .b(new_n44_), .c(new_n67_), .O(new_n109_));
  oai21  g64(.a(x19), .b(x02), .c(x23), .O(new_n110_));
  nand3  g65(.a(new_n50_), .b(x17), .c(new_n44_), .O(new_n111_));
  nand2  g66(.a(new_n111_), .b(new_n110_), .O(new_n112_));
  nand2  g67(.a(new_n112_), .b(new_n46_), .O(new_n113_));
  inv1   g68(.a(x24), .O(new_n114_));
  nand2  g69(.a(new_n114_), .b(x09), .O(new_n115_));
  aoi21  g70(.a(new_n113_), .b(new_n109_), .c(new_n115_), .O(z12));
  nor3   g71(.a(new_n53_), .b(x19), .c(new_n48_), .O(z13));
  nand4  g72(.a(new_n50_), .b(new_n49_), .c(new_n48_), .d(new_n61_), .O(new_n118_));
  nor2   g73(.a(new_n118_), .b(new_n47_), .O(z14));
  aoi21  g74(.a(new_n61_), .b(x01), .c(new_n44_), .O(new_n120_));
  nand3  g75(.a(x19), .b(new_n44_), .c(new_n66_), .O(new_n121_));
  oai21  g76(.a(new_n120_), .b(new_n65_), .c(new_n121_), .O(z15));
  nor2   g77(.a(new_n66_), .b(x00), .O(z16));
