...
module FAU ( 
  ...
  nand3  g23(.a(new_n67_), .b(new_n58_), .c(x10), .O(new_n68_));
  nor2   g24(.a(new_n68_), .b(new_n65_), .O(z04));
  nand3  g25(.a(new_n59_), .b(new_n61_), .c(x02), .O(new_n71_));
  nor3   g26(.a(new_n71_), .b(new_n63_), .c(new_n62_), .O(z06));
  nand4  g27(.a(new_n59_), .b(new_n67_), .c(new_n61_), .d(x01), .O(new_n73_));
  ...
  nor2   g41(.a(new_n45_), .b(x01), .O(new_n87_));
  ...
  nand2  g57(.a(new_n96_), .b(new_n62_), .O(new_n104_));
  aoi21  g58(.a(new_n103_), .b(new_n100_), .c(new_n104_), .O(z11));
  oai21  g59(.a(new_n53_), .b(new_n45_), .c(new_n64_), .O(new_n106_));
  oai21  g60(.a(x19), .b(x02), .c(x23), .O(new_n107_));
  nand3  g61(.a(new_n50_), .b(x17), .c(new_n45_), .O(new_n108_));
  nand2  g62(.a(new_n108_), .b(new_n107_), .O(new_n109_));
  nand2  g63(.a(new_n109_), .b(new_n46_), .O(new_n110_));
  inv1   g64(.a(x24), .O(new_n111_));
  nand2  g65(.a(new_n111_), .b(x09), .O(new_n112_));
  aoi21  g66(.a(new_n110_), .b(new_n106_), .c(new_n112_), .O(z12));
  nand2  g67(.a(new_n46_), .b(new_n45_), .O(new_n114_));
  nor3   g68(.a(new_n114_), .b(x19), .c(new_n48_), .O(z13));
  nor2   g69(.a(x10), .b(x09), .O(new_n116_));
  nand4  g70(.a(new_n116_), .b(new_n50_), .c(new_n49_), .d(new_n48_), .O(new_n117_));
  nor2   g71(.a(new_n117_), .b(new_n114_), .O(z14));
  aoi21  g72(.a(new_n53_), .b(x01), .c(new_n45_), .O(new_n119_));
  nand3  g73(.a(x19), .b(new_n45_), .c(new_n63_), .O(new_n120_));
  oai21  g74(.a(new_n119_), .b(new_n62_), .c(new_n120_), .O(z15));
