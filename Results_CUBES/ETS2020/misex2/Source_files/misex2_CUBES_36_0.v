...
module FAU ( 
  ...
  wire new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_, new_n51_,
    ...
    new_n116_, new_n118_, new_n120_, new_n121_;
  ...
  nand2  g72(.a(new_n46_), .b(new_n45_), .O(new_n118_));
  nor3   g73(.a(new_n118_), .b(x19), .c(new_n48_), .O(z13));
  nor2   g74(.a(x10), .b(x09), .O(new_n120_));
  nand4  g75(.a(new_n120_), .b(new_n50_), .c(new_n49_), .d(new_n48_), .O(new_n121_));
  nor2   g76(.a(new_n121_), .b(new_n118_), .O(z14));
  zero   g77(.O(z00));
  zero   g78(.O(z08));
  zero   g79(.O(z15));
  zero   g80(.O(z16));
