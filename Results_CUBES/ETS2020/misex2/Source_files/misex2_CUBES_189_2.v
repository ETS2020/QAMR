// Benchmark "FAU" written by ABC on Tue Jul  7 11:01:29 2020
...
module FAU ( 
  ...
  wire new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_, new_n51_,
    ...
    new_n88_, new_n89_, new_n90_, new_n96_, new_n98_, new_n99_;
  ...
  nand3  g16(.a(new_n61_), .b(x10), .c(new_n45_), .O(new_n62_));
  nor3   g17(.a(new_n62_), .b(x12), .c(x11), .O(z04));
  nor3   g18(.a(new_n60_), .b(new_n56_), .c(new_n45_), .O(z05));
  inv1   g19(.a(x11), .O(new_n65_));
  nor2   g20(.a(new_n62_), .b(new_n65_), .O(z06));
  inv1   g21(.a(x08), .O(new_n68_));
  nand4  g22(.a(x19), .b(new_n52_), .c(x17), .d(new_n68_), .O(new_n69_));
  inv1   g23(.a(x05), .O(new_n70_));
  nor2   g24(.a(x07), .b(x06), .O(new_n71_));
  nand3  g25(.a(new_n71_), .b(new_n70_), .c(x04), .O(new_n72_));
  inv1   g26(.a(x03), .O(new_n73_));
  nand4  g27(.a(new_n73_), .b(x02), .c(new_n47_), .d(new_n46_), .O(new_n74_));
  nor3   g28(.a(new_n74_), .b(new_n72_), .c(new_n69_), .O(z08));
  ...
  nor2   g33(.a(new_n48_), .b(x01), .O(new_n80_));
  inv1   g34(.a(x13), .O(new_n81_));
  inv1   g35(.a(x14), .O(new_n82_));
  nand4  g36(.a(new_n82_), .b(new_n81_), .c(x12), .d(new_n65_), .O(new_n83_));
  inv1   g37(.a(new_n83_), .O(new_n84_));
  nand3  g38(.a(new_n84_), .b(new_n80_), .c(new_n79_), .O(new_n85_));
  inv1   g39(.a(x20), .O(new_n86_));
  nand4  g40(.a(new_n86_), .b(new_n53_), .c(x18), .d(x01), .O(new_n87_));
  inv1   g41(.a(x21), .O(new_n88_));
  inv1   g42(.a(x22), .O(new_n89_));
  nand3  g43(.a(new_n89_), .b(new_n88_), .c(new_n46_), .O(new_n90_));
  aoi21  g44(.a(new_n87_), .b(new_n85_), .c(new_n90_), .O(z09));
  nand3  g45(.a(new_n53_), .b(new_n52_), .c(new_n51_), .O(new_n96_));
  nor4   g46(.a(new_n96_), .b(new_n49_), .c(x10), .d(x09), .O(z14));
  aoi21  g47(.a(new_n56_), .b(x01), .c(new_n48_), .O(new_n98_));
  nand3  g48(.a(x19), .b(new_n48_), .c(new_n47_), .O(new_n99_));
  oai21  g49(.a(new_n98_), .b(new_n46_), .c(new_n99_), .O(z15));
  nor2   g50(.a(new_n47_), .b(x00), .O(z16));
  zero   g51(.O(z00));
  zero   g52(.O(z03));
  zero   g53(.O(z07));
  zero   g54(.O(z10));
