...
module FAU ( 
  ...
  nand4  g44(.a(new_n89_), .b(new_n58_), .c(x22), .d(x21), .O(new_n90_));
  inv1   g45(.a(x21), .O(new_n91_));
  inv1   g46(.a(x22), .O(new_n92_));
  nand3  g47(.a(new_n92_), .b(new_n91_), .c(x20), .O(new_n93_));
  inv1   g48(.a(new_n93_), .O(new_n94_));
  inv1   g49(.a(x13), .O(new_n95_));
  inv1   g50(.a(x14), .O(new_n96_));
  nand4  g51(.a(x16), .b(x15), .c(new_n96_), .d(new_n95_), .O(new_n97_));
  inv1   g52(.a(new_n97_), .O(new_n98_));
  nand4  g53(.a(x12), .b(new_n62_), .c(x02), .d(new_n66_), .O(new_n99_));
  inv1   g54(.a(new_n99_), .O(new_n100_));
  nand3  g55(.a(new_n100_), .b(new_n98_), .c(new_n94_), .O(new_n101_));
  aoi21  g56(.a(new_n101_), .b(new_n90_), .c(x00), .O(z10));
  oai21  g57(.a(new_n61_), .b(new_n44_), .c(new_n67_), .O(new_n104_));
  ...
  nand4  g65(.a(new_n50_), .b(new_n49_), .c(new_n48_), .d(new_n61_), .O(new_n113_));
  nor2   g66(.a(new_n113_), .b(new_n47_), .O(z14));
  aoi21  g67(.a(new_n61_), .b(x01), .c(new_n44_), .O(new_n115_));
  nand3  g68(.a(x19), .b(new_n44_), .c(new_n66_), .O(new_n116_));
  oai21  g69(.a(new_n115_), .b(new_n65_), .c(new_n116_), .O(z15));
  zero   g70(.O(z02));
  zero   g71(.O(z09));
  zero   g72(.O(z11));
  zero   g73(.O(z13));
