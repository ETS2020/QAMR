...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n123_, new_n124_, new_n125_, new_n128_;
  ...
  nand2  g47(.a(x02), .b(new_n66_), .O(new_n92_));
  inv1   g48(.a(new_n92_), .O(new_n93_));
  nor2   g49(.a(new_n71_), .b(x11), .O(new_n94_));
  nor2   g50(.a(x14), .b(x13), .O(new_n95_));
  nand4  g51(.a(new_n95_), .b(new_n94_), .c(new_n93_), .d(new_n91_), .O(new_n96_));
  nor2   g52(.a(x20), .b(x19), .O(new_n97_));
  nand3  g53(.a(new_n97_), .b(x18), .c(x01), .O(new_n98_));
  ...
  nor2   g58(.a(x20), .b(new_n66_), .O(new_n103_));
  nand4  g59(.a(new_n103_), .b(new_n58_), .c(x22), .d(x21), .O(new_n104_));
  inv1   g60(.a(x13), .O(new_n105_));
  nand3  g61(.a(new_n105_), .b(x12), .c(new_n62_), .O(new_n106_));
  nor2   g62(.a(new_n106_), .b(new_n92_), .O(new_n107_));
  nor2   g63(.a(new_n88_), .b(x14), .O(new_n108_));
  nand4  g64(.a(new_n100_), .b(new_n99_), .c(x20), .d(x16), .O(new_n109_));
  ...
  nand4  g68(.a(new_n97_), .b(x21), .c(x18), .d(x01), .O(new_n113_));
  nand3  g69(.a(new_n99_), .b(x20), .c(new_n89_), .O(new_n114_));
  inv1   g70(.a(new_n114_), .O(new_n115_));
  nand3  g71(.a(new_n115_), .b(new_n108_), .c(new_n107_), .O(new_n116_));
  nand2  g72(.a(new_n100_), .b(new_n65_), .O(new_n117_));
  aoi21  g73(.a(new_n116_), .b(new_n113_), .c(new_n117_), .O(z11));
  oai21  g74(.a(new_n61_), .b(new_n44_), .c(new_n67_), .O(new_n119_));
  oai21  g75(.a(x19), .b(x02), .c(x23), .O(new_n120_));
  nand3  g76(.a(new_n50_), .b(x17), .c(new_n44_), .O(new_n121_));
  nand2  g77(.a(new_n121_), .b(new_n120_), .O(new_n122_));
  nand2  g78(.a(new_n122_), .b(new_n46_), .O(new_n123_));
  inv1   g79(.a(x24), .O(new_n124_));
  nand2  g80(.a(new_n124_), .b(x09), .O(new_n125_));
  aoi21  g81(.a(new_n123_), .b(new_n119_), .c(new_n125_), .O(z12));
  nor3   g82(.a(new_n53_), .b(x19), .c(new_n48_), .O(z13));
  nand4  g83(.a(new_n50_), .b(new_n49_), .c(new_n48_), .d(new_n61_), .O(new_n128_));
  nor2   g84(.a(new_n128_), .b(new_n47_), .O(z14));
