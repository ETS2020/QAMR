...
module FAU ( 
  ...
  nand4  g13(.a(new_n58_), .b(new_n47_), .c(new_n46_), .d(new_n45_), .O(new_n59_));
  inv1   g14(.a(x11), .O(new_n60_));
  nor2   g15(.a(new_n60_), .b(new_n44_), .O(new_n61_));
  nand2  g16(.a(new_n61_), .b(x12), .O(new_n62_));
  nor2   g17(.a(new_n46_), .b(new_n45_), .O(new_n63_));
  nand3  g18(.a(new_n63_), .b(new_n48_), .c(x02), .O(new_n64_));
  oai22  g19(.a(new_n64_), .b(new_n62_), .c(new_n59_), .d(new_n57_), .O(z03));
  nand2  g20(.a(new_n63_), .b(x02), .O(new_n66_));
  inv1   g21(.a(x12), .O(new_n67_));
  nand4  g22(.a(new_n67_), .b(new_n60_), .c(x10), .d(new_n48_), .O(new_n68_));
  nor2   g23(.a(new_n68_), .b(new_n66_), .O(z04));
  nor3   g24(.a(new_n66_), .b(new_n44_), .c(new_n48_), .O(z05));
  nand3  g25(.a(new_n61_), .b(new_n48_), .c(x02), .O(new_n71_));
  nor3   g26(.a(new_n71_), .b(new_n46_), .c(new_n45_), .O(z06));
  nand4  g27(.a(new_n61_), .b(new_n67_), .c(new_n48_), .d(x01), .O(new_n73_));
  ...
  nand2  g34(.a(x02), .b(new_n46_), .O(new_n81_));
  ...
  nand3  g43(.a(new_n89_), .b(new_n88_), .c(new_n45_), .O(new_n90_));
  aoi21  g44(.a(new_n87_), .b(new_n85_), .c(new_n90_), .O(z09));
  nor2   g45(.a(x20), .b(new_n46_), .O(new_n92_));
  nand4  g46(.a(new_n92_), .b(new_n56_), .c(x22), .d(x21), .O(new_n93_));
  inv1   g47(.a(x13), .O(new_n94_));
  nand3  g48(.a(new_n94_), .b(x12), .c(new_n60_), .O(new_n95_));
  nor2   g49(.a(new_n95_), .b(new_n81_), .O(new_n96_));
  nor2   g50(.a(new_n77_), .b(x14), .O(new_n97_));
  nand4  g51(.a(new_n89_), .b(new_n88_), .c(x20), .d(x16), .O(new_n98_));
  ...
  nand4  g55(.a(new_n86_), .b(x21), .c(x18), .d(x01), .O(new_n102_));
  nand3  g56(.a(new_n88_), .b(x20), .c(new_n78_), .O(new_n103_));
  inv1   g57(.a(new_n103_), .O(new_n104_));
  nand3  g58(.a(new_n104_), .b(new_n97_), .c(new_n96_), .O(new_n105_));
  nand2  g59(.a(new_n89_), .b(new_n45_), .O(new_n106_));
  aoi21  g60(.a(new_n105_), .b(new_n102_), .c(new_n106_), .O(z11));
  nor4   g61(.a(new_n52_), .b(new_n49_), .c(x17), .d(x10), .O(z14));
  aoi21  g62(.a(new_n44_), .b(x01), .c(new_n47_), .O(new_n111_));
  nand3  g63(.a(x19), .b(new_n47_), .c(new_n46_), .O(new_n112_));
  oai21  g64(.a(new_n111_), .b(new_n45_), .c(new_n112_), .O(z15));
  nor2   g65(.a(new_n46_), .b(x00), .O(z16));
  zero   g66(.O(z01));
  zero   g67(.O(z02));
  zero   g68(.O(z08));
  zero   g69(.O(z12));
