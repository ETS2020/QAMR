...
module FAU ( 
  ...
  nand4  g37(.a(new_n84_), .b(new_n83_), .c(x12), .d(new_n64_), .O(new_n85_));
  ...
  nand3  g44(.a(new_n91_), .b(new_n90_), .c(new_n60_), .O(new_n92_));
  ...
  nand2  g50(.a(new_n91_), .b(new_n60_), .O(new_n99_));
