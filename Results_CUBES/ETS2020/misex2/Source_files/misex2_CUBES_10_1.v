...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n88_, new_n89_, new_n90_, new_n91_, new_n92_, new_n93_, new_n100_,
    new_n101_;
  ...
  nor2   g38(.a(new_n60_), .b(x01), .O(new_n83_));
  inv1   g39(.a(x13), .O(new_n84_));
  inv1   g40(.a(x14), .O(new_n85_));
  nand4  g41(.a(new_n85_), .b(new_n84_), .c(x12), .d(new_n62_), .O(new_n86_));
  inv1   g42(.a(new_n86_), .O(new_n87_));
  nand3  g43(.a(new_n87_), .b(new_n83_), .c(new_n82_), .O(new_n88_));
  inv1   g44(.a(x20), .O(new_n89_));
  nand4  g45(.a(new_n89_), .b(new_n52_), .c(x18), .d(x01), .O(new_n90_));
  inv1   g46(.a(x21), .O(new_n91_));
  inv1   g47(.a(x22), .O(new_n92_));
  nand3  g48(.a(new_n92_), .b(new_n91_), .c(new_n45_), .O(new_n93_));
  aoi21  g49(.a(new_n90_), .b(new_n88_), .c(new_n93_), .O(z09));
  nor4   g50(.a(new_n47_), .b(x19), .c(new_n50_), .d(x02), .O(z13));
  nor2   g51(.a(new_n58_), .b(new_n49_), .O(z14));
  aoi21  g52(.a(new_n57_), .b(x01), .c(new_n60_), .O(new_n100_));
  nand3  g53(.a(x19), .b(new_n60_), .c(new_n46_), .O(new_n101_));
  oai21  g54(.a(new_n100_), .b(new_n45_), .c(new_n101_), .O(z15));
  nor2   g55(.a(new_n46_), .b(x00), .O(z16));
  zero   g56(.O(z08));
  zero   g57(.O(z10));
  zero   g58(.O(z11));
  zero   g59(.O(z12));
