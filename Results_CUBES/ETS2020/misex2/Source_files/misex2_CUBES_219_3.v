...
module FAU ( 
  ...
  nand4  g58(.a(new_n102_), .b(new_n57_), .c(new_n95_), .d(x01), .O(new_n103_));
  ...
  inv1   g63(.a(x01), .O(new_n108_));
  nand4  g64(.a(x12), .b(new_n62_), .c(x02), .d(new_n108_), .O(new_n109_));
  inv1   g65(.a(new_n109_), .O(new_n110_));
  nand3  g66(.a(new_n110_), .b(new_n107_), .c(new_n105_), .O(new_n111_));
  aoi21  g67(.a(new_n111_), .b(new_n103_), .c(x00), .O(z10));
  oai21  g68(.a(new_n54_), .b(new_n59_), .c(new_n66_), .O(new_n114_));
  ...
  nand3  g80(.a(x19), .b(new_n59_), .c(new_n108_), .O(new_n126_));
  oai21  g81(.a(new_n125_), .b(new_n97_), .c(new_n126_), .O(z15));
  nor2   g82(.a(new_n108_), .b(x00), .O(z16));
  zero   g83(.O(z04));
  zero   g84(.O(z11));
  zero   g85(.O(z17));
endmodule
