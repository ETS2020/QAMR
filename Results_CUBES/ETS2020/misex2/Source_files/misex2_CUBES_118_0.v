...
module FAU ( 
  ...
  nand4  g49(.a(new_n94_), .b(new_n52_), .c(x18), .d(x01), .O(new_n95_));
  ...
  nand4  g56(.a(new_n101_), .b(new_n100_), .c(new_n52_), .d(x18), .O(new_n102_));
  ...
  oai21  g65(.a(new_n56_), .b(new_n45_), .c(new_n63_), .O(new_n112_));
  oai21  g66(.a(x19), .b(x02), .c(x23), .O(new_n113_));
  nand3  g67(.a(new_n52_), .b(x17), .c(new_n45_), .O(new_n114_));
  ...
  nor3   g73(.a(new_n47_), .b(x19), .c(new_n54_), .O(z13));
  nand3  g74(.a(new_n48_), .b(new_n56_), .c(new_n60_), .O(new_n121_));
