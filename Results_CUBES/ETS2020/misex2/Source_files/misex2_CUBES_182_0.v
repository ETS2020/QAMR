...
module FAU ( 
  ...
  nor2   g54(.a(x20), .b(new_n62_), .O(new_n100_));
  nor2   g55(.a(new_n97_), .b(new_n96_), .O(new_n101_));
  nand4  g56(.a(new_n101_), .b(new_n100_), .c(new_n50_), .d(x18), .O(new_n102_));
  nand3  g57(.a(new_n97_), .b(new_n96_), .c(x20), .O(new_n103_));
  ...
  nand3  g67(.a(new_n50_), .b(x17), .c(new_n46_), .O(new_n114_));
  ...
  nor3   g73(.a(new_n48_), .b(x19), .c(new_n55_), .O(z13));
  aoi21  g74(.a(new_n49_), .b(x01), .c(new_n46_), .O(new_n122_));
  nand3  g75(.a(x19), .b(new_n46_), .c(new_n62_), .O(new_n123_));
  oai21  g76(.a(new_n122_), .b(new_n61_), .c(new_n123_), .O(z15));
