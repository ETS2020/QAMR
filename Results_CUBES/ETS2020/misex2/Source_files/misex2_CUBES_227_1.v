...
module FAU ( 
  ...
  nor2   g42(.a(new_n71_), .b(x11), .O(new_n88_));
  ...
  nand3  g73(.a(x19), .b(new_n45_), .c(new_n68_), .O(new_n120_));
  oai21  g74(.a(new_n119_), .b(new_n67_), .c(new_n120_), .O(z15));
  nor2   g75(.a(new_n68_), .b(x00), .O(z16));
  inv1   g76(.a(new_n79_), .O(z17));
  zero   g77(.O(z00));
  zero   g78(.O(z05));
  zero   g79(.O(z12));
endmodule
