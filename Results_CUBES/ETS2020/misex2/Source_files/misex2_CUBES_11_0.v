// Benchmark "FAU" written by ABC on Tue Jul  7 11:00:15 2020
...
module FAU ( 
  ...
  nand2  g08(.a(new_n50_), .b(x18), .O(new_n54_));
  ...
  nand4  g47(.a(new_n93_), .b(new_n92_), .c(new_n50_), .d(x18), .O(new_n94_));
  inv1   g48(.a(x13), .O(new_n95_));
  nand3  g49(.a(new_n95_), .b(x12), .c(new_n57_), .O(new_n96_));
  ...
  oai21  g62(.a(new_n49_), .b(new_n46_), .c(new_n63_), .O(new_n109_));
  oai21  g63(.a(x19), .b(x02), .c(x23), .O(new_n110_));
  nand3  g64(.a(new_n50_), .b(x17), .c(new_n46_), .O(new_n111_));
  ...
  nor3   g70(.a(new_n48_), .b(x19), .c(new_n55_), .O(z13));
  zero   g71(.O(z00));
  zero   g72(.O(z01));
  zero   g73(.O(z08));
  zero   g74(.O(z14));
