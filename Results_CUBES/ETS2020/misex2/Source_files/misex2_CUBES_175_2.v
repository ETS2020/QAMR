...
module FAU ( 
  ...
  nor3   g18(.a(new_n58_), .b(new_n64_), .c(new_n59_), .O(z05));
  ...
  nand2  g23(.a(new_n50_), .b(x02), .O(new_n72_));
  nand3  g24(.a(x19), .b(new_n46_), .c(x17), .O(new_n73_));
  ...
  nor2   g32(.a(new_n49_), .b(x01), .O(new_n83_));
  inv1   g33(.a(x13), .O(new_n84_));
  inv1   g34(.a(x14), .O(new_n85_));
  nand4  g35(.a(new_n85_), .b(new_n84_), .c(x12), .d(new_n60_), .O(new_n86_));
  inv1   g36(.a(new_n86_), .O(new_n87_));
  nand3  g37(.a(new_n87_), .b(new_n83_), .c(new_n82_), .O(new_n88_));
  inv1   g38(.a(x22), .O(new_n89_));
  nand2  g39(.a(new_n89_), .b(new_n55_), .O(new_n90_));
  aoi21  g40(.a(new_n88_), .b(new_n78_), .c(new_n90_), .O(z11));
  oai21  g41(.a(new_n64_), .b(new_n49_), .c(new_n57_), .O(new_n92_));
  oai21  g42(.a(x19), .b(x02), .c(x23), .O(new_n93_));
  nand3  g43(.a(new_n47_), .b(x17), .c(new_n49_), .O(new_n94_));
  nand2  g44(.a(new_n94_), .b(new_n93_), .O(new_n95_));
  nand2  g45(.a(new_n95_), .b(new_n50_), .O(new_n96_));
  inv1   g46(.a(x24), .O(new_n97_));
  nand2  g47(.a(new_n97_), .b(x09), .O(new_n98_));
  aoi21  g48(.a(new_n96_), .b(new_n92_), .c(new_n98_), .O(z12));
  aoi21  g49(.a(new_n64_), .b(x01), .c(new_n49_), .O(new_n102_));
  nand3  g50(.a(x19), .b(new_n49_), .c(new_n56_), .O(new_n103_));
  oai21  g51(.a(new_n102_), .b(new_n55_), .c(new_n103_), .O(z15));
  nor2   g52(.a(new_n56_), .b(x00), .O(z16));
  inv1   g53(.a(new_n72_), .O(z17));
  zero   g54(.O(z00));
  zero   g55(.O(z02));
  zero   g56(.O(z03));
  zero   g57(.O(z06));
