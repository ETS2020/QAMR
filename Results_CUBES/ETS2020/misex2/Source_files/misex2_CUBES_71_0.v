...
module FAU ( 
  ...
  nor4   g18(.a(new_n62_), .b(x12), .c(x11), .d(new_n58_), .O(z04));
  ...
  nand3  g53(.a(new_n99_), .b(x12), .c(new_n59_), .O(new_n100_));
  ...
  nand4  g66(.a(new_n50_), .b(new_n49_), .c(new_n48_), .d(new_n58_), .O(new_n115_));
  nor2   g67(.a(new_n115_), .b(new_n47_), .O(z14));
  zero   g68(.O(z01));
  zero   g69(.O(z02));
  zero   g70(.O(z05));
  zero   g71(.O(z12));
