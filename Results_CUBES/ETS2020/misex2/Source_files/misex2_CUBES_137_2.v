...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n92_, new_n95_, new_n96_, new_n97_;
  ...
  nor2   g41(.a(x19), .b(new_n47_), .O(new_n92_));
  and2   g42(.a(new_n92_), .b(new_n45_), .O(z13));
  nor2   g43(.a(new_n55_), .b(new_n46_), .O(z14));
  inv1   g44(.a(x02), .O(new_n95_));
  aoi21  g45(.a(new_n54_), .b(x01), .c(new_n95_), .O(new_n96_));
  nand3  g46(.a(x19), .b(new_n95_), .c(new_n60_), .O(new_n97_));
  oai21  g47(.a(new_n96_), .b(new_n59_), .c(new_n97_), .O(z15));
  nor2   g48(.a(new_n60_), .b(x00), .O(z16));
  inv1   g49(.a(new_n70_), .O(z17));
  zero   g50(.O(z03));
  zero   g51(.O(z04));
  zero   g52(.O(z06));
  zero   g53(.O(z07));
