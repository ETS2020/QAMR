...
module FAU ( 
  ...
  nand3  g14(.a(new_n45_), .b(new_n58_), .c(new_n44_), .O(new_n59_));
  ...
  oai22  g22(.a(new_n66_), .b(new_n62_), .c(new_n59_), .d(new_n57_), .O(z03));
  ...
  nor3   g27(.a(new_n68_), .b(new_n52_), .c(new_n47_), .O(z05));
  ...
  nand4  g34(.a(x19), .b(new_n55_), .c(x17), .d(new_n78_), .O(new_n79_));
  ...
  oai21  g72(.a(new_n52_), .b(new_n44_), .c(new_n65_), .O(new_n117_));
  oai21  g73(.a(x19), .b(x02), .c(x23), .O(new_n118_));
  inv1   g74(.a(x19), .O(new_n119_));
  nand3  g75(.a(new_n119_), .b(x17), .c(new_n44_), .O(new_n120_));
  ...
  aoi21  g80(.a(new_n122_), .b(new_n117_), .c(new_n124_), .O(z12));
  nor3   g81(.a(new_n46_), .b(x19), .c(new_n58_), .O(z13));
