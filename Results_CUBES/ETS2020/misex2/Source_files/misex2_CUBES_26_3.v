...
module FAU ( 
  ...
  nand4  g58(.a(new_n102_), .b(new_n59_), .c(x22), .d(x21), .O(new_n103_));
  ...
  oai21  g73(.a(new_n55_), .b(new_n44_), .c(new_n67_), .O(new_n118_));
  ...
  nor3   g81(.a(new_n54_), .b(x19), .c(new_n48_), .O(z13));
  nand4  g82(.a(new_n50_), .b(new_n49_), .c(new_n48_), .d(new_n55_), .O(new_n127_));
  nor2   g83(.a(new_n127_), .b(new_n47_), .O(z14));
  aoi21  g84(.a(new_n55_), .b(x01), .c(new_n44_), .O(new_n129_));
