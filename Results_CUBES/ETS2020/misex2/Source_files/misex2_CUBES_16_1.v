...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n117_, new_n118_, new_n119_, new_n120_, new_n123_;
  ...
  nand4  g46(.a(new_n91_), .b(new_n90_), .c(x12), .d(new_n62_), .O(new_n92_));
  ...
  nor2   g56(.a(new_n99_), .b(new_n98_), .O(new_n102_));
  nand4  g57(.a(new_n102_), .b(new_n58_), .c(new_n95_), .d(x01), .O(new_n103_));
  nand3  g58(.a(new_n99_), .b(new_n98_), .c(x20), .O(new_n104_));
  inv1   g59(.a(new_n104_), .O(new_n105_));
  nand4  g60(.a(x16), .b(x15), .c(new_n91_), .d(new_n90_), .O(new_n106_));
  inv1   g61(.a(new_n106_), .O(new_n107_));
  inv1   g62(.a(x01), .O(new_n108_));
  nand4  g63(.a(x12), .b(new_n62_), .c(x02), .d(new_n108_), .O(new_n109_));
  inv1   g64(.a(new_n109_), .O(new_n110_));
  nand3  g65(.a(new_n110_), .b(new_n107_), .c(new_n105_), .O(new_n111_));
  aoi21  g66(.a(new_n111_), .b(new_n103_), .c(x00), .O(z10));
  oai21  g67(.a(new_n61_), .b(new_n44_), .c(new_n66_), .O(new_n114_));
  ...
  nor3   g75(.a(new_n53_), .b(x19), .c(new_n48_), .O(z13));
