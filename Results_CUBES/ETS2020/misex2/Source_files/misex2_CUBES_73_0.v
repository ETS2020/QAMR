// Benchmark "FAU" written by ABC on Tue Jul  7 11:00:42 2020
...
module FAU ( 
  ...
  oai22  g17(.a(new_n62_), .b(new_n60_), .c(new_n57_), .d(new_n56_), .O(z03));
  nor4   g18(.a(new_n62_), .b(x12), .c(x11), .d(new_n46_), .O(z04));
  inv1   g19(.a(x00), .O(new_n66_));
  inv1   g20(.a(x01), .O(new_n67_));
  nand3  g21(.a(new_n59_), .b(new_n61_), .c(x02), .O(new_n68_));
  nor3   g22(.a(new_n68_), .b(new_n67_), .c(new_n66_), .O(z06));
  ...
  nand4  g28(.a(x19), .b(new_n48_), .c(x17), .d(new_n74_), .O(new_n75_));
  ...
  nand2  g39(.a(x02), .b(new_n67_), .O(new_n86_));
  inv1   g40(.a(new_n86_), .O(new_n87_));
  nor2   g41(.a(new_n70_), .b(x11), .O(new_n88_));
  ...
  nor2   g50(.a(x20), .b(new_n67_), .O(new_n97_));
  nand4  g51(.a(new_n97_), .b(new_n55_), .c(x22), .d(x21), .O(new_n98_));
  inv1   g52(.a(x13), .O(new_n99_));
  nand3  g53(.a(new_n99_), .b(x12), .c(new_n58_), .O(new_n100_));
  ...
  nand2  g64(.a(new_n94_), .b(new_n66_), .O(new_n111_));
