...
module FAU ( 
  ...
  nand4  g35(.a(x19), .b(new_n48_), .c(x17), .d(new_n79_), .O(new_n80_));
  ...
  nand3  g40(.a(new_n60_), .b(new_n84_), .c(x02), .O(new_n85_));
  ...
  oai21  g73(.a(new_n54_), .b(new_n59_), .c(new_n67_), .O(new_n118_));
  oai21  g74(.a(x19), .b(x02), .c(x23), .O(new_n119_));
  nand3  g75(.a(new_n49_), .b(x17), .c(new_n59_), .O(new_n120_));
  ...
  nor2   g81(.a(x19), .b(new_n47_), .O(new_n126_));
  and2   g82(.a(new_n126_), .b(new_n45_), .O(z13));
  nor2   g83(.a(new_n55_), .b(new_n46_), .O(z14));
  aoi21  g84(.a(new_n54_), .b(x01), .c(new_n59_), .O(new_n129_));
  nand3  g85(.a(x19), .b(new_n59_), .c(new_n66_), .O(new_n130_));
