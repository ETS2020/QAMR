...
module FAU ( 
  ...
  nand4  g38(.a(x19), .b(new_n54_), .c(x17), .d(new_n81_), .O(new_n82_));
  ...
  nand3  g43(.a(new_n45_), .b(new_n86_), .c(x02), .O(new_n87_));
  ...
  oai21  g76(.a(new_n57_), .b(new_n44_), .c(new_n68_), .O(new_n120_));
  oai21  g77(.a(x19), .b(x02), .c(x23), .O(new_n121_));
  nand3  g78(.a(new_n48_), .b(x17), .c(new_n44_), .O(new_n122_));
  ...
  aoi21  g84(.a(new_n57_), .b(x01), .c(new_n44_), .O(new_n130_));
  nand3  g85(.a(x19), .b(new_n44_), .c(new_n67_), .O(new_n131_));
  oai21  g86(.a(new_n130_), .b(new_n66_), .c(new_n131_), .O(z15));
  zero   g87(.O(z13));
  zero   g88(.O(z14));
  zero   g89(.O(z16));
  zero   g90(.O(z17));
