...
module FAU ( 
  ...
  nand3  g26(.a(new_n64_), .b(new_n47_), .c(x02), .O(new_n72_));
  nor2   g27(.a(new_n72_), .b(new_n66_), .O(z06));
  inv1   g28(.a(x12), .O(new_n74_));
  nand4  g29(.a(new_n64_), .b(new_n74_), .c(new_n47_), .d(x01), .O(new_n75_));
