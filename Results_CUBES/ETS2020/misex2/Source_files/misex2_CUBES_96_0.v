...
module FAU ( 
  ...
  nor2   g41(.a(x20), .b(new_n66_), .O(new_n88_));
  nand4  g42(.a(new_n88_), .b(new_n59_), .c(x22), .d(x21), .O(new_n89_));
  nand2  g43(.a(x02), .b(new_n66_), .O(new_n90_));
  inv1   g44(.a(x13), .O(new_n91_));
  nand3  g45(.a(new_n91_), .b(x12), .c(new_n62_), .O(new_n92_));
  ...
  nand3  g55(.a(new_n88_), .b(new_n59_), .c(x21), .O(new_n102_));
  ...
  nand2  g60(.a(new_n97_), .b(new_n65_), .O(new_n107_));
  aoi21  g61(.a(new_n106_), .b(new_n102_), .c(new_n107_), .O(z11));
  oai21  g62(.a(new_n55_), .b(new_n44_), .c(new_n67_), .O(new_n109_));
  ...
  nand4  g70(.a(new_n50_), .b(new_n49_), .c(new_n48_), .d(new_n55_), .O(new_n118_));
  nor2   g71(.a(new_n118_), .b(new_n47_), .O(z14));
  aoi21  g72(.a(new_n55_), .b(x01), .c(new_n44_), .O(new_n120_));
  nand3  g73(.a(x19), .b(new_n44_), .c(new_n66_), .O(new_n121_));
  oai21  g74(.a(new_n120_), .b(new_n65_), .c(new_n121_), .O(z15));
