...
module FAU ( 
  ...
  nor2   g46(.a(x10), .b(x09), .O(new_n97_));
  nand4  g47(.a(new_n97_), .b(new_n50_), .c(new_n49_), .d(new_n48_), .O(new_n98_));
  nor2   g48(.a(new_n98_), .b(new_n95_), .O(z14));
  aoi21  g49(.a(new_n53_), .b(x01), .c(new_n45_), .O(new_n100_));
  nand3  g50(.a(x19), .b(new_n45_), .c(new_n58_), .O(new_n101_));
  oai21  g51(.a(new_n100_), .b(new_n57_), .c(new_n101_), .O(z15));
  nor2   g52(.a(new_n58_), .b(x00), .O(z16));
