...
module FAU ( 
  ...
  nor2   g29(.a(new_n49_), .b(new_n58_), .O(new_n78_));
  ...
  nand3  g34(.a(new_n82_), .b(new_n81_), .c(x20), .O(new_n83_));
  inv1   g35(.a(new_n83_), .O(new_n84_));
  inv1   g36(.a(x13), .O(new_n85_));
  inv1   g37(.a(x14), .O(new_n86_));
  nand4  g38(.a(x16), .b(x15), .c(new_n86_), .d(new_n85_), .O(new_n87_));
  inv1   g39(.a(new_n87_), .O(new_n88_));
  nand4  g40(.a(x12), .b(new_n62_), .c(x02), .d(new_n58_), .O(new_n89_));
  inv1   g41(.a(new_n89_), .O(new_n90_));
  nand3  g42(.a(new_n90_), .b(new_n88_), .c(new_n84_), .O(new_n91_));
