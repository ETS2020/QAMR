...
module FAU ( 
  ...
  nand4  g43(.a(new_n88_), .b(new_n59_), .c(x22), .d(x21), .O(new_n89_));
  ...
  nand3  g56(.a(new_n88_), .b(new_n59_), .c(x21), .O(new_n102_));
  ...
  oai21  g63(.a(new_n55_), .b(new_n44_), .c(new_n67_), .O(new_n109_));
  ...
  nand3  g74(.a(x19), .b(new_n44_), .c(new_n66_), .O(new_n121_));
  oai21  g75(.a(new_n120_), .b(new_n65_), .c(new_n121_), .O(z15));
  nor2   g76(.a(new_n66_), .b(x00), .O(z16));
