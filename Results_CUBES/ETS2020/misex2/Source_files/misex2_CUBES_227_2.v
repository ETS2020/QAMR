...
module FAU ( 
  ...
  nand4  g42(.a(new_n88_), .b(new_n49_), .c(x18), .d(x01), .O(new_n89_));
  ...
  oai21  g47(.a(new_n54_), .b(new_n81_), .c(new_n60_), .O(new_n96_));
  oai21  g48(.a(x19), .b(x02), .c(x23), .O(new_n97_));
  nand3  g49(.a(new_n49_), .b(x17), .c(new_n81_), .O(new_n98_));
  nand2  g50(.a(new_n98_), .b(new_n97_), .O(new_n99_));
  nand2  g51(.a(new_n99_), .b(new_n73_), .O(new_n100_));
  inv1   g52(.a(x24), .O(new_n101_));
  nand2  g53(.a(new_n101_), .b(x09), .O(new_n102_));
  aoi21  g54(.a(new_n100_), .b(new_n96_), .c(new_n102_), .O(z12));
  nor2   g55(.a(x19), .b(new_n47_), .O(new_n104_));
  and2   g56(.a(new_n104_), .b(new_n45_), .O(z13));
  nor2   g57(.a(new_n55_), .b(new_n46_), .O(z14));
  aoi21  g58(.a(new_n54_), .b(x01), .c(new_n81_), .O(new_n107_));
  nand3  g59(.a(x19), .b(new_n81_), .c(new_n59_), .O(new_n108_));
  oai21  g60(.a(new_n107_), .b(new_n58_), .c(new_n108_), .O(z15));
  nor2   g61(.a(new_n59_), .b(x00), .O(z16));
  inv1   g62(.a(new_n74_), .O(z17));
  zero   g63(.O(z03));
  zero   g64(.O(z06));
  zero   g65(.O(z07));
  zero   g66(.O(z10));
