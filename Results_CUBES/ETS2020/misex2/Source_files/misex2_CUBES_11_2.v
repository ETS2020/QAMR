...
module FAU ( 
  ...
  nand2  g28(.a(x02), .b(new_n73_), .O(new_n77_));
  ...
  inv1   g46(.a(x00), .O(new_n95_));
  nand2  g47(.a(new_n85_), .b(new_n95_), .O(new_n96_));
  aoi21  g48(.a(new_n94_), .b(new_n90_), .c(new_n96_), .O(z11));
  nor3   g49(.a(new_n53_), .b(x19), .c(new_n48_), .O(z13));
  inv1   g50(.a(x10), .O(new_n100_));
  nand4  g51(.a(new_n50_), .b(new_n49_), .c(new_n48_), .d(new_n100_), .O(new_n101_));
  nor2   g52(.a(new_n101_), .b(new_n47_), .O(z14));
  aoi21  g53(.a(new_n100_), .b(x01), .c(new_n44_), .O(new_n103_));
  nand3  g54(.a(x19), .b(new_n44_), .c(new_n73_), .O(new_n104_));
  oai21  g55(.a(new_n103_), .b(new_n95_), .c(new_n104_), .O(z15));
  nor2   g56(.a(new_n73_), .b(x00), .O(z16));
