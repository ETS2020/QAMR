...
module FAU ( 
  ...
  oai21  g75(.a(new_n57_), .b(new_n44_), .c(new_n68_), .O(new_n119_));
  oai21  g76(.a(x19), .b(x02), .c(x23), .O(new_n120_));
  nand3  g77(.a(new_n48_), .b(x17), .c(new_n44_), .O(new_n121_));
  ...
  nor3   g83(.a(new_n46_), .b(x19), .c(new_n53_), .O(z13));
  nor2   g84(.a(new_n67_), .b(x00), .O(z16));
  inv1   g85(.a(new_n85_), .O(z17));
  zero   g86(.O(z14));
  zero   g87(.O(z15));
endmodule
