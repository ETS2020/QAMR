...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n68_, new_n70_, new_n71_, new_n74_, new_n76_, new_n77_, new_n81_,
  ...
  nand3  g27(.a(new_n70_), .b(new_n63_), .c(x10), .O(new_n71_));
  nor2   g28(.a(new_n71_), .b(new_n68_), .O(z04));
  nand3  g29(.a(new_n64_), .b(new_n47_), .c(x02), .O(new_n74_));
  nor2   g30(.a(new_n74_), .b(new_n66_), .O(z06));
  nand4  g31(.a(new_n64_), .b(new_n70_), .c(new_n47_), .d(x01), .O(new_n76_));
  nand2  g32(.a(x02), .b(x00), .O(new_n77_));
  aoi21  g33(.a(new_n76_), .b(x01), .c(new_n77_), .O(z07));
  inv1   g34(.a(x01), .O(new_n81_));
  nor2   g35(.a(x20), .b(new_n81_), .O(new_n82_));
  nand4  g36(.a(new_n82_), .b(new_n60_), .c(x22), .d(x21), .O(new_n83_));
  inv1   g37(.a(x21), .O(new_n84_));
  inv1   g38(.a(x22), .O(new_n85_));
  nand3  g39(.a(new_n85_), .b(new_n84_), .c(x20), .O(new_n86_));
  inv1   g40(.a(new_n86_), .O(new_n87_));
  inv1   g41(.a(x13), .O(new_n88_));
  inv1   g42(.a(x14), .O(new_n89_));
  nand4  g43(.a(x16), .b(x15), .c(new_n89_), .d(new_n88_), .O(new_n90_));
  inv1   g44(.a(new_n90_), .O(new_n91_));
  nand4  g45(.a(x12), .b(new_n63_), .c(x02), .d(new_n81_), .O(new_n92_));
  inv1   g46(.a(new_n92_), .O(new_n93_));
  nand3  g47(.a(new_n93_), .b(new_n91_), .c(new_n87_), .O(new_n94_));
  aoi21  g48(.a(new_n94_), .b(new_n83_), .c(x00), .O(z10));
  oai21  g49(.a(new_n57_), .b(new_n44_), .c(new_n67_), .O(new_n97_));
  oai21  g50(.a(x19), .b(x02), .c(x23), .O(new_n98_));
  nand3  g51(.a(new_n48_), .b(x17), .c(new_n44_), .O(new_n99_));
  nand2  g52(.a(new_n99_), .b(new_n98_), .O(new_n100_));
  nand2  g53(.a(new_n100_), .b(new_n45_), .O(new_n101_));
  inv1   g54(.a(x24), .O(new_n102_));
  nand2  g55(.a(new_n102_), .b(x09), .O(new_n103_));
  aoi21  g56(.a(new_n101_), .b(new_n97_), .c(new_n103_), .O(z12));
  zero   g57(.O(z05));
  zero   g58(.O(z08));
  zero   g59(.O(z09));
  zero   g60(.O(z11));
