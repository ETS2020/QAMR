...
module FAU ( 
  ...
  aoi21  g50(.a(new_n53_), .b(x01), .c(new_n45_), .O(new_n102_));
  nand3  g51(.a(x19), .b(new_n45_), .c(new_n59_), .O(new_n103_));
  oai21  g52(.a(new_n102_), .b(new_n58_), .c(new_n103_), .O(z15));
  nor2   g53(.a(new_n59_), .b(x00), .O(z16));
