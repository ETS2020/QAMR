...
module FAU ( 
  ...
  nand3  g77(.a(x19), .b(new_n59_), .c(new_n82_), .O(new_n123_));
  oai21  g78(.a(new_n122_), .b(new_n90_), .c(new_n123_), .O(z15));
  nor2   g79(.a(new_n82_), .b(x00), .O(z16));
  nand2  g80(.a(new_n60_), .b(x02), .O(new_n126_));
