...
module FAU ( 
  ...
  nand4  g69(.a(new_n50_), .b(new_n49_), .c(new_n48_), .d(new_n108_), .O(new_n118_));
  nor2   g70(.a(new_n118_), .b(new_n47_), .O(z14));
  aoi21  g71(.a(new_n108_), .b(x01), .c(new_n44_), .O(new_n120_));
  nand3  g72(.a(x19), .b(new_n44_), .c(new_n60_), .O(new_n121_));
  oai21  g73(.a(new_n120_), .b(new_n59_), .c(new_n121_), .O(z15));
  nor2   g74(.a(new_n60_), .b(x00), .O(z16));
