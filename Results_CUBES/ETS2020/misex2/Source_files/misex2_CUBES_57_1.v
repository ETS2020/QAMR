...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n61_, new_n62_, new_n63_, new_n64_, new_n67_, new_n69_, new_n71_,
    new_n72_, new_n73_, new_n75_, new_n76_, new_n77_, new_n78_, new_n79_,
    new_n80_, new_n82_, new_n83_, new_n84_, new_n85_, new_n86_, new_n87_,
    new_n88_, new_n89_, new_n90_, new_n91_, new_n92_, new_n93_, new_n94_,
    new_n95_, new_n96_, new_n97_, new_n100_, new_n101_, new_n102_,
    new_n103_, new_n104_, new_n108_, new_n110_, new_n111_, new_n112_;
  ...
  nand2  g21(.a(x01), .b(x00), .O(new_n67_));
  nor4   g22(.a(new_n67_), .b(new_n55_), .c(new_n45_), .d(new_n44_), .O(z05));
  nand3  g23(.a(new_n62_), .b(new_n45_), .c(x02), .O(new_n69_));
  nor2   g24(.a(new_n69_), .b(new_n67_), .O(z06));
  inv1   g25(.a(x12), .O(new_n71_));
  nand4  g26(.a(new_n62_), .b(new_n71_), .c(new_n45_), .d(x01), .O(new_n72_));
  ...
  nand2  g33(.a(new_n46_), .b(x02), .O(new_n79_));
  nand3  g34(.a(x19), .b(new_n49_), .c(x17), .O(new_n80_));
  ...
  nor2   g40(.a(new_n44_), .b(x01), .O(new_n86_));
  inv1   g41(.a(x13), .O(new_n87_));
  inv1   g42(.a(x14), .O(new_n88_));
  nand4  g43(.a(new_n88_), .b(new_n87_), .c(x12), .d(new_n61_), .O(new_n89_));
  ...
  inv1   g48(.a(x00), .O(new_n94_));
  inv1   g49(.a(x21), .O(new_n95_));
  inv1   g50(.a(x22), .O(new_n96_));
  nand3  g51(.a(new_n96_), .b(new_n95_), .c(new_n94_), .O(new_n97_));
  aoi21  g52(.a(new_n93_), .b(new_n91_), .c(new_n97_), .O(z09));
  nand4  g53(.a(new_n92_), .b(x21), .c(x18), .d(x01), .O(new_n100_));
  nand4  g54(.a(new_n95_), .b(x20), .c(new_n83_), .d(x15), .O(new_n101_));
  inv1   g55(.a(new_n101_), .O(new_n102_));
  nand3  g56(.a(new_n102_), .b(new_n90_), .c(new_n86_), .O(new_n103_));
  nand2  g57(.a(new_n96_), .b(new_n94_), .O(new_n104_));
  aoi21  g58(.a(new_n103_), .b(new_n100_), .c(new_n104_), .O(z11));
  nor3   g59(.a(new_n54_), .b(x19), .c(new_n48_), .O(z13));
  nand4  g60(.a(new_n50_), .b(new_n49_), .c(new_n48_), .d(new_n55_), .O(new_n108_));
  nor2   g61(.a(new_n108_), .b(new_n47_), .O(z14));
  aoi21  g62(.a(new_n55_), .b(x01), .c(new_n44_), .O(new_n110_));
  inv1   g63(.a(x01), .O(new_n111_));
  nand3  g64(.a(x19), .b(new_n44_), .c(new_n111_), .O(new_n112_));
  oai21  g65(.a(new_n110_), .b(new_n94_), .c(new_n112_), .O(z15));
  nor2   g66(.a(new_n111_), .b(x00), .O(z16));
  inv1   g67(.a(new_n79_), .O(z17));
  zero   g68(.O(z01));
  zero   g69(.O(z04));
  zero   g70(.O(z10));
  zero   g71(.O(z12));
