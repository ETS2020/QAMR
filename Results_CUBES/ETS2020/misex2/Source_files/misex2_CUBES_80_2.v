...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    new_n51_, new_n52_, new_n57_, new_n58_, new_n60_, new_n64_, new_n65_,
    new_n66_, new_n67_, new_n68_, new_n69_, new_n70_, new_n72_, new_n73_,
    new_n74_, new_n75_, new_n76_, new_n77_, new_n78_, new_n79_, new_n80_,
    new_n81_, new_n82_, new_n83_, new_n84_, new_n85_, new_n86_, new_n87_,
    new_n88_, new_n90_, new_n91_, new_n92_, new_n93_, new_n94_, new_n95_,
    new_n96_, new_n97_, new_n102_, new_n104_, new_n105_;
  ...
  nand2  g11(.a(x10), .b(new_n47_), .O(new_n58_));
  nor4   g12(.a(new_n58_), .b(new_n57_), .c(x12), .d(x11), .O(z04));
  inv1   g13(.a(x10), .O(new_n60_));
  nor3   g14(.a(new_n57_), .b(new_n60_), .c(new_n47_), .O(z05));
  inv1   g15(.a(x08), .O(new_n64_));
  nand4  g16(.a(x19), .b(new_n50_), .c(x17), .d(new_n64_), .O(new_n65_));
  inv1   g17(.a(x05), .O(new_n66_));
  nor2   g18(.a(x07), .b(x06), .O(new_n67_));
  nand3  g19(.a(new_n67_), .b(new_n66_), .c(x04), .O(new_n68_));
  inv1   g20(.a(x03), .O(new_n69_));
  nand4  g21(.a(new_n69_), .b(x02), .c(new_n45_), .d(new_n44_), .O(new_n70_));
  nor3   g22(.a(new_n70_), .b(new_n68_), .c(new_n65_), .O(z08));
  ...
  nor2   g27(.a(new_n46_), .b(x01), .O(new_n76_));
  ...
  nand3  g33(.a(new_n81_), .b(new_n76_), .c(new_n75_), .O(new_n82_));
  nor2   g34(.a(new_n50_), .b(new_n45_), .O(new_n83_));
  ...
  nand3  g39(.a(new_n87_), .b(new_n86_), .c(new_n44_), .O(new_n88_));
  ...
  nand4  g46(.a(x12), .b(new_n77_), .c(x02), .d(new_n45_), .O(new_n95_));
  ...
  nand4  g50(.a(new_n51_), .b(new_n50_), .c(new_n49_), .d(new_n60_), .O(new_n102_));
  nor2   g51(.a(new_n102_), .b(new_n48_), .O(z14));
  aoi21  g52(.a(new_n60_), .b(x01), .c(new_n46_), .O(new_n104_));
  nand3  g53(.a(x19), .b(new_n46_), .c(new_n45_), .O(new_n105_));
  oai21  g54(.a(new_n104_), .b(new_n44_), .c(new_n105_), .O(z15));
  nor2   g55(.a(new_n45_), .b(x00), .O(z16));
  zero   g56(.O(z01));
  zero   g57(.O(z02));
  zero   g58(.O(z03));
  zero   g59(.O(z06));
