...
module FAU ( 
  ...
  nand4  g17(.a(new_n47_), .b(x02), .c(x01), .d(x00), .O(new_n62_));
  oai21  g18(.a(new_n62_), .b(new_n61_), .c(new_n58_), .O(z03));
  nor4   g19(.a(new_n62_), .b(x12), .c(x11), .d(new_n52_), .O(z04));
  inv1   g20(.a(x00), .O(new_n66_));
  inv1   g21(.a(x01), .O(new_n67_));
  nand3  g22(.a(new_n60_), .b(new_n47_), .c(x02), .O(new_n68_));
  nor3   g23(.a(new_n68_), .b(new_n67_), .c(new_n66_), .O(z06));
  ...
  nand4  g29(.a(x19), .b(new_n55_), .c(x17), .d(new_n74_), .O(new_n75_));
  inv1   g30(.a(x05), .O(new_n76_));
  nor2   g31(.a(x07), .b(x06), .O(new_n77_));
  nand3  g32(.a(new_n77_), .b(new_n76_), .c(x04), .O(new_n78_));
  inv1   g33(.a(x03), .O(new_n79_));
  nand3  g34(.a(new_n45_), .b(new_n79_), .c(x02), .O(new_n80_));
  nor3   g35(.a(new_n80_), .b(new_n78_), .c(new_n75_), .O(z08));
  ...
  nand2  g40(.a(x02), .b(new_n67_), .O(new_n86_));
  inv1   g41(.a(new_n86_), .O(new_n87_));
  nor2   g42(.a(new_n70_), .b(x11), .O(new_n88_));
  ...
  nand3  g49(.a(new_n94_), .b(new_n93_), .c(new_n66_), .O(new_n95_));
  aoi21  g50(.a(new_n92_), .b(new_n90_), .c(new_n95_), .O(z09));
  nor2   g51(.a(x20), .b(new_n67_), .O(new_n97_));
  nand4  g52(.a(new_n97_), .b(new_n56_), .c(x22), .d(x21), .O(new_n98_));
  inv1   g53(.a(x13), .O(new_n99_));
  nand3  g54(.a(new_n99_), .b(x12), .c(new_n59_), .O(new_n100_));
  ...
  nand2  g65(.a(new_n94_), .b(new_n66_), .O(new_n111_));
