// Benchmark "FAU" written by ABC on Tue Jul  7 11:00:39 2020
...
module FAU ( 
  ...
  nand4  g50(.a(new_n95_), .b(new_n50_), .c(x18), .d(x01), .O(new_n96_));
  inv1   g51(.a(x21), .O(new_n97_));
  inv1   g52(.a(x22), .O(new_n98_));
  nand3  g53(.a(new_n98_), .b(new_n97_), .c(new_n63_), .O(new_n99_));
  aoi21  g54(.a(new_n96_), .b(new_n94_), .c(new_n99_), .O(z09));
  nor2   g55(.a(new_n98_), .b(new_n97_), .O(new_n101_));
  nand4  g56(.a(new_n101_), .b(new_n56_), .c(new_n95_), .d(x01), .O(new_n102_));
  ...
  nand4  g61(.a(x12), .b(new_n59_), .c(x02), .d(new_n64_), .O(new_n107_));
  ...
  oai21  g65(.a(new_n53_), .b(new_n45_), .c(new_n65_), .O(new_n112_));
  oai21  g66(.a(x19), .b(x02), .c(x23), .O(new_n113_));
  nand3  g67(.a(new_n50_), .b(x17), .c(new_n45_), .O(new_n114_));
  nand2  g68(.a(new_n114_), .b(new_n113_), .O(new_n115_));
  nand2  g69(.a(new_n115_), .b(new_n46_), .O(new_n116_));
  inv1   g70(.a(x24), .O(new_n117_));
  nand2  g71(.a(new_n117_), .b(x09), .O(new_n118_));
  aoi21  g72(.a(new_n116_), .b(new_n112_), .c(new_n118_), .O(z12));
  nand2  g73(.a(new_n46_), .b(new_n45_), .O(new_n120_));
  nor3   g74(.a(new_n120_), .b(x19), .c(new_n48_), .O(z13));
  nor2   g75(.a(x10), .b(x09), .O(new_n122_));
  nand4  g76(.a(new_n122_), .b(new_n50_), .c(new_n49_), .d(new_n48_), .O(new_n123_));
  nor2   g77(.a(new_n123_), .b(new_n120_), .O(z14));
  aoi21  g78(.a(new_n53_), .b(x01), .c(new_n45_), .O(new_n125_));
  nand3  g79(.a(x19), .b(new_n45_), .c(new_n64_), .O(new_n126_));
  oai21  g80(.a(new_n125_), .b(new_n63_), .c(new_n126_), .O(z15));
