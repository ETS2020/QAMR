...
module FAU ( 
  ...
  nand3  g11(.a(new_n46_), .b(new_n56_), .c(new_n45_), .O(new_n57_));
  ...
  oai22  g21(.a(new_n66_), .b(new_n61_), .c(new_n57_), .d(new_n55_), .O(z03));
  nand2  g22(.a(new_n65_), .b(x02), .O(new_n68_));
  inv1   g23(.a(x12), .O(new_n69_));
  nand4  g24(.a(new_n69_), .b(new_n59_), .c(x10), .d(new_n62_), .O(new_n70_));
  nor2   g25(.a(new_n70_), .b(new_n68_), .O(z04));
  nor3   g26(.a(new_n68_), .b(new_n58_), .c(new_n62_), .O(z05));
  nand3  g27(.a(new_n60_), .b(new_n62_), .c(x02), .O(new_n73_));
  nor3   g28(.a(new_n73_), .b(new_n64_), .c(new_n63_), .O(z06));
  nand4  g29(.a(new_n60_), .b(new_n69_), .c(new_n62_), .d(x01), .O(new_n75_));
  nand2  g30(.a(x02), .b(x00), .O(new_n76_));
  aoi21  g31(.a(new_n75_), .b(x01), .c(new_n76_), .O(z07));
  inv1   g32(.a(x08), .O(new_n78_));
  nand4  g33(.a(x19), .b(new_n53_), .c(x17), .d(new_n78_), .O(new_n79_));
  ...
  nand2  g44(.a(x02), .b(new_n64_), .O(new_n90_));
  inv1   g45(.a(new_n90_), .O(new_n91_));
  nor2   g46(.a(new_n69_), .b(x11), .O(new_n92_));
  ...
  nor2   g55(.a(x20), .b(new_n64_), .O(new_n101_));
  nand4  g56(.a(new_n101_), .b(new_n54_), .c(x22), .d(x21), .O(new_n102_));
  inv1   g57(.a(x13), .O(new_n103_));
  nand3  g58(.a(new_n103_), .b(x12), .c(new_n59_), .O(new_n104_));
  ...
  nand2  g69(.a(new_n98_), .b(new_n63_), .O(new_n115_));
  aoi21  g70(.a(new_n114_), .b(new_n111_), .c(new_n115_), .O(z11));
  oai21  g71(.a(new_n58_), .b(new_n45_), .c(new_n65_), .O(new_n117_));
  oai21  g72(.a(x19), .b(x02), .c(x23), .O(new_n118_));
  nand3  g73(.a(new_n48_), .b(x17), .c(new_n45_), .O(new_n119_));
  ...
  nor3   g79(.a(new_n47_), .b(x19), .c(new_n56_), .O(z13));
  zero   g80(.O(z00));
  zero   g81(.O(z02));
  zero   g82(.O(z14));
  zero   g83(.O(z15));
