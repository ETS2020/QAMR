...
module FAU ( 
  ...
  nand4  g36(.a(new_n82_), .b(new_n58_), .c(x22), .d(x21), .O(new_n83_));
  ...
  nand3  g49(.a(new_n82_), .b(new_n58_), .c(x21), .O(new_n96_));
  ...
  nand4  g56(.a(new_n50_), .b(new_n49_), .c(new_n48_), .d(new_n61_), .O(new_n105_));
  nor2   g57(.a(new_n105_), .b(new_n47_), .O(z14));
  aoi21  g58(.a(new_n61_), .b(x01), .c(new_n44_), .O(new_n107_));
  nand3  g59(.a(x19), .b(new_n44_), .c(new_n66_), .O(new_n108_));
  oai21  g60(.a(new_n107_), .b(new_n65_), .c(new_n108_), .O(z15));
  nand2  g61(.a(new_n46_), .b(x02), .O(new_n111_));
  inv1   g62(.a(new_n111_), .O(z17));
  zero   g63(.O(z02));
  zero   g64(.O(z08));
  zero   g65(.O(z09));
  zero   g66(.O(z12));
