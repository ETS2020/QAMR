...
module FAU ( 
  ...
  oai21  g58(.a(new_n60_), .b(new_n44_), .c(new_n66_), .O(new_n105_));
  oai21  g59(.a(x19), .b(x02), .c(x23), .O(new_n106_));
  nand3  g60(.a(new_n50_), .b(x17), .c(new_n44_), .O(new_n107_));
  nand2  g61(.a(new_n107_), .b(new_n106_), .O(new_n108_));
  nand2  g62(.a(new_n108_), .b(new_n46_), .O(new_n109_));
  inv1   g63(.a(x24), .O(new_n110_));
  nand2  g64(.a(new_n110_), .b(x09), .O(new_n111_));
  aoi21  g65(.a(new_n109_), .b(new_n105_), .c(new_n111_), .O(z12));
  nor3   g66(.a(new_n53_), .b(x19), .c(new_n48_), .O(z13));
  nand4  g67(.a(new_n50_), .b(new_n49_), .c(new_n48_), .d(new_n60_), .O(new_n114_));
