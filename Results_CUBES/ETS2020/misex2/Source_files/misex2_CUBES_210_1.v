...
module FAU ( 
  ...
  oai22  g19(.a(new_n64_), .b(new_n60_), .c(new_n57_), .d(new_n56_), .O(z03));
  nor4   g20(.a(new_n62_), .b(new_n46_), .c(new_n61_), .d(new_n51_), .O(z05));
  ...
  nand2  g30(.a(x02), .b(new_n76_), .O(new_n79_));
  inv1   g31(.a(x13), .O(new_n80_));
  nand3  g32(.a(new_n80_), .b(x12), .c(new_n58_), .O(new_n81_));
  ...
  nand3  g42(.a(new_n77_), .b(new_n55_), .c(x21), .O(new_n91_));
  ...
  inv1   g47(.a(x00), .O(new_n96_));
  nand2  g48(.a(new_n86_), .b(new_n96_), .O(new_n97_));
  aoi21  g49(.a(new_n95_), .b(new_n91_), .c(new_n97_), .O(z11));
  oai21  g50(.a(new_n46_), .b(new_n51_), .c(new_n63_), .O(new_n99_));
  oai21  g51(.a(x19), .b(x02), .c(x23), .O(new_n100_));
  nand3  g52(.a(new_n49_), .b(x17), .c(new_n51_), .O(new_n101_));
  nand2  g53(.a(new_n101_), .b(new_n100_), .O(new_n102_));
  nand2  g54(.a(new_n102_), .b(new_n52_), .O(new_n103_));
  inv1   g55(.a(x24), .O(new_n104_));
  nand2  g56(.a(new_n104_), .b(x09), .O(new_n105_));
  aoi21  g57(.a(new_n103_), .b(new_n99_), .c(new_n105_), .O(z12));
  aoi21  g58(.a(new_n46_), .b(x01), .c(new_n51_), .O(new_n109_));
  nand3  g59(.a(x19), .b(new_n51_), .c(new_n76_), .O(new_n110_));
  oai21  g60(.a(new_n109_), .b(new_n96_), .c(new_n110_), .O(z15));
  nor2   g61(.a(new_n76_), .b(x00), .O(z16));
  nand2  g62(.a(new_n52_), .b(x02), .O(new_n113_));
