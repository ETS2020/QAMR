...
module FAU ( 
  ...
  nand2  g79(.a(new_n46_), .b(new_n45_), .O(new_n125_));
  nor2   g80(.a(x10), .b(x09), .O(new_n126_));
  nand4  g81(.a(new_n126_), .b(new_n50_), .c(new_n49_), .d(new_n48_), .O(new_n127_));
  nor2   g82(.a(new_n127_), .b(new_n125_), .O(z14));
  aoi21  g83(.a(new_n53_), .b(x01), .c(new_n45_), .O(new_n129_));
  nand3  g84(.a(x19), .b(new_n45_), .c(new_n64_), .O(new_n130_));
  oai21  g85(.a(new_n129_), .b(new_n63_), .c(new_n130_), .O(z15));
