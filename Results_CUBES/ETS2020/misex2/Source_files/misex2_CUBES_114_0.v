// Benchmark "FAU" written by ABC on Tue Jul  7 11:01:00 2020
...
module FAU ( 
  ...
  nand3  g25(.a(new_n69_), .b(new_n61_), .c(x10), .O(new_n70_));
  nor2   g26(.a(new_n70_), .b(new_n67_), .O(z04));
  nand3  g27(.a(new_n62_), .b(new_n45_), .c(x02), .O(new_n73_));
  nor3   g28(.a(new_n73_), .b(new_n65_), .c(new_n64_), .O(z06));
  nand4  g29(.a(new_n62_), .b(new_n69_), .c(new_n45_), .d(x01), .O(new_n75_));
  nand2  g30(.a(x02), .b(x00), .O(new_n76_));
  aoi21  g31(.a(new_n75_), .b(x01), .c(new_n76_), .O(z07));
  inv1   g32(.a(x08), .O(new_n78_));
  nand4  g33(.a(x19), .b(new_n49_), .c(x17), .d(new_n78_), .O(new_n79_));
  inv1   g34(.a(x05), .O(new_n80_));
  nor2   g35(.a(x07), .b(x06), .O(new_n81_));
  nand3  g36(.a(new_n81_), .b(new_n80_), .c(x04), .O(new_n82_));
  inv1   g37(.a(x03), .O(new_n83_));
  nand3  g38(.a(new_n46_), .b(new_n83_), .c(x02), .O(new_n84_));
  nor3   g39(.a(new_n84_), .b(new_n82_), .c(new_n79_), .O(z08));
  ...
  nor2   g44(.a(new_n44_), .b(x01), .O(new_n90_));
  inv1   g45(.a(x13), .O(new_n91_));
  inv1   g46(.a(x14), .O(new_n92_));
  nand4  g47(.a(new_n92_), .b(new_n91_), .c(x12), .d(new_n61_), .O(new_n93_));
  inv1   g48(.a(new_n93_), .O(new_n94_));
  nand3  g49(.a(new_n94_), .b(new_n90_), .c(new_n89_), .O(new_n95_));
  ...
  nand3  g54(.a(new_n99_), .b(new_n98_), .c(new_n64_), .O(new_n100_));
  aoi21  g55(.a(new_n97_), .b(new_n95_), .c(new_n100_), .O(z09));
  nand4  g56(.a(new_n96_), .b(x21), .c(x18), .d(x01), .O(new_n103_));
  nand4  g57(.a(new_n98_), .b(x20), .c(new_n87_), .d(x15), .O(new_n104_));
  inv1   g58(.a(new_n104_), .O(new_n105_));
  nand3  g59(.a(new_n105_), .b(new_n94_), .c(new_n90_), .O(new_n106_));
  nand2  g60(.a(new_n99_), .b(new_n64_), .O(new_n107_));
  aoi21  g61(.a(new_n106_), .b(new_n103_), .c(new_n107_), .O(z11));
  oai21  g62(.a(new_n60_), .b(new_n44_), .c(new_n66_), .O(new_n109_));
  oai21  g63(.a(x19), .b(x02), .c(x23), .O(new_n110_));
  nand3  g64(.a(new_n50_), .b(x17), .c(new_n44_), .O(new_n111_));
  nand2  g65(.a(new_n111_), .b(new_n110_), .O(new_n112_));
  nand2  g66(.a(new_n112_), .b(new_n46_), .O(new_n113_));
  inv1   g67(.a(x24), .O(new_n114_));
  nand2  g68(.a(new_n114_), .b(x09), .O(new_n115_));
  aoi21  g69(.a(new_n113_), .b(new_n109_), .c(new_n115_), .O(z12));
  nor3   g70(.a(new_n53_), .b(x19), .c(new_n48_), .O(z13));
  nand4  g71(.a(new_n50_), .b(new_n49_), .c(new_n48_), .d(new_n60_), .O(new_n118_));
  nor2   g72(.a(new_n118_), .b(new_n47_), .O(z14));
  zero   g73(.O(z02));
  zero   g74(.O(z05));
  zero   g75(.O(z10));
  zero   g76(.O(z15));
