...
module FAU ( 
  ...
  oai21  g70(.a(new_n56_), .b(new_n45_), .c(new_n63_), .O(new_n116_));
  oai21  g71(.a(x19), .b(x02), .c(x23), .O(new_n117_));
  nand3  g72(.a(new_n52_), .b(x17), .c(new_n45_), .O(new_n118_));
  ...
  nor3   g78(.a(new_n47_), .b(x19), .c(new_n54_), .O(z13));
  nand3  g79(.a(new_n48_), .b(new_n56_), .c(new_n60_), .O(new_n125_));
  nor2   g80(.a(new_n125_), .b(new_n47_), .O(z14));
