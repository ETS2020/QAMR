...
module FAU ( 
  ...
  wire new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_, new_n51_,
    ...
    new_n98_, new_n99_, new_n100_, new_n104_, new_n105_;
  ...
  nand4  g22(.a(x19), .b(new_n49_), .c(x17), .d(new_n69_), .O(new_n70_));
  inv1   g23(.a(x05), .O(new_n71_));
  nor2   g24(.a(x07), .b(x06), .O(new_n72_));
  nand3  g25(.a(new_n72_), .b(new_n71_), .c(x04), .O(new_n73_));
  inv1   g26(.a(x03), .O(new_n74_));
  nand3  g27(.a(new_n46_), .b(new_n74_), .c(x02), .O(new_n75_));
  nor3   g28(.a(new_n75_), .b(new_n73_), .c(new_n70_), .O(z08));
  ...
  aoi21  g52(.a(new_n53_), .b(x01), .c(new_n45_), .O(new_n104_));
  nand3  g53(.a(x19), .b(new_n45_), .c(new_n58_), .O(new_n105_));
  oai21  g54(.a(new_n104_), .b(new_n57_), .c(new_n105_), .O(z15));
  nor2   g55(.a(new_n58_), .b(x00), .O(z16));
  zero   g56(.O(z00));
  zero   g57(.O(z03));
  zero   g58(.O(z06));
  zero   g59(.O(z07));
