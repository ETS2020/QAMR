...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n106_, new_n108_, new_n109_, new_n112_;
  ...
  nand4  g45(.a(x12), .b(new_n62_), .c(x02), .d(new_n66_), .O(new_n92_));
  ...
  oai21  g49(.a(new_n55_), .b(new_n44_), .c(new_n67_), .O(new_n97_));
  ...
  aoi21  g60(.a(new_n55_), .b(x01), .c(new_n44_), .O(new_n108_));
  nand3  g61(.a(x19), .b(new_n44_), .c(new_n66_), .O(new_n109_));
  oai21  g62(.a(new_n108_), .b(new_n65_), .c(new_n109_), .O(z15));
