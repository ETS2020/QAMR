...
module FAU ( 
  ...
  nand4  g61(.a(x12), .b(new_n57_), .c(x02), .d(new_n62_), .O(new_n107_));
  ...
  oai21  g65(.a(new_n49_), .b(new_n46_), .c(new_n63_), .O(new_n112_));
  oai21  g66(.a(x19), .b(x02), .c(x23), .O(new_n113_));
  nand3  g67(.a(new_n94_), .b(x17), .c(new_n46_), .O(new_n114_));
  nand2  g68(.a(new_n114_), .b(new_n113_), .O(new_n115_));
  nand2  g69(.a(new_n115_), .b(new_n47_), .O(new_n116_));
  inv1   g70(.a(x24), .O(new_n117_));
  nand2  g71(.a(new_n117_), .b(x09), .O(new_n118_));
  aoi21  g72(.a(new_n116_), .b(new_n112_), .c(new_n118_), .O(z12));
  nand3  g73(.a(new_n50_), .b(new_n49_), .c(new_n60_), .O(new_n121_));
  nor2   g74(.a(new_n121_), .b(new_n48_), .O(z14));
  zero   g75(.O(z00));
  zero   g76(.O(z01));
  zero   g77(.O(z11));
  zero   g78(.O(z13));
