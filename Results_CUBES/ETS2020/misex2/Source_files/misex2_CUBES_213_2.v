...
module FAU ( 
  ...
  inv1   g24(.a(x01), .O(new_n73_));
  nor2   g25(.a(new_n49_), .b(new_n73_), .O(new_n74_));
  ...
  nand4  g37(.a(x12), .b(new_n85_), .c(x02), .d(new_n73_), .O(new_n86_));
  ...
  nand4  g42(.a(new_n50_), .b(new_n49_), .c(new_n48_), .d(new_n93_), .O(new_n94_));
  nor2   g43(.a(new_n94_), .b(new_n47_), .O(z14));
  inv1   g44(.a(x00), .O(new_n96_));
  aoi21  g45(.a(new_n93_), .b(x01), .c(new_n44_), .O(new_n97_));
  nand3  g46(.a(x19), .b(new_n44_), .c(new_n73_), .O(new_n98_));
  oai21  g47(.a(new_n97_), .b(new_n96_), .c(new_n98_), .O(z15));
  nor2   g48(.a(new_n73_), .b(x00), .O(z16));
  inv1   g49(.a(new_n69_), .O(z17));
  zero   g50(.O(z02));
  zero   g51(.O(z03));
  zero   g52(.O(z06));
  zero   g53(.O(z07));
