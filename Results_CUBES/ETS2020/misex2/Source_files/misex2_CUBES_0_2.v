...
module FAU ( 
  ...
  aoi21  g44(.a(new_n88_), .b(new_n85_), .c(new_n91_), .O(z09));
  nand4  g45(.a(new_n87_), .b(new_n86_), .c(x22), .d(x21), .O(new_n93_));
  inv1   g46(.a(x13), .O(new_n94_));
  nand3  g47(.a(new_n94_), .b(x12), .c(new_n63_), .O(new_n95_));
  nor2   g48(.a(new_n95_), .b(new_n81_), .O(new_n96_));
  nor2   g49(.a(new_n77_), .b(x14), .O(new_n97_));
  nand4  g50(.a(new_n90_), .b(new_n89_), .c(x20), .d(x16), .O(new_n98_));
  ...
  nand3  g55(.a(new_n89_), .b(x20), .c(new_n78_), .O(new_n103_));
  inv1   g56(.a(new_n103_), .O(new_n104_));
  nand3  g57(.a(new_n104_), .b(new_n97_), .c(new_n96_), .O(new_n105_));
  nand2  g58(.a(new_n90_), .b(new_n59_), .O(new_n106_));
  aoi21  g59(.a(new_n105_), .b(new_n102_), .c(new_n106_), .O(z11));
  inv1   g60(.a(x10), .O(new_n108_));
  oai21  g61(.a(new_n108_), .b(new_n44_), .c(new_n61_), .O(new_n109_));
  oai21  g62(.a(x19), .b(x02), .c(x23), .O(new_n110_));
  nand3  g63(.a(new_n50_), .b(x17), .c(new_n44_), .O(new_n111_));
  nand2  g64(.a(new_n111_), .b(new_n110_), .O(new_n112_));
  nand2  g65(.a(new_n112_), .b(new_n46_), .O(new_n113_));
  inv1   g66(.a(x24), .O(new_n114_));
  nand2  g67(.a(new_n114_), .b(x09), .O(new_n115_));
  aoi21  g68(.a(new_n113_), .b(new_n109_), .c(new_n115_), .O(z12));
  nor3   g69(.a(new_n53_), .b(x19), .c(new_n48_), .O(z13));
  nand4  g70(.a(new_n50_), .b(new_n49_), .c(new_n48_), .d(new_n108_), .O(new_n118_));
  nor2   g71(.a(new_n118_), .b(new_n47_), .O(z14));
  aoi21  g72(.a(new_n108_), .b(x01), .c(new_n44_), .O(new_n120_));
  nand3  g73(.a(x19), .b(new_n44_), .c(new_n60_), .O(new_n121_));
  oai21  g74(.a(new_n120_), .b(new_n59_), .c(new_n121_), .O(z15));
  nor2   g75(.a(new_n60_), .b(x00), .O(z16));
  inv1   g76(.a(new_n74_), .O(z17));
  zero   g77(.O(z02));
  zero   g78(.O(z03));
  zero   g79(.O(z06));
  zero   g80(.O(z07));
