...
module FAU ( 
  ...
  wire new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_, new_n51_,
    ...
    new_n69_, new_n70_, new_n73_, new_n75_, new_n76_, new_n79_, new_n80_,
    new_n81_, new_n82_, new_n83_, new_n84_, new_n85_, new_n86_, new_n87_,
    new_n88_, new_n89_, new_n90_, new_n91_, new_n92_, new_n94_, new_n95_,
    new_n96_, new_n97_, new_n98_, new_n99_, new_n100_, new_n101_,
    new_n102_, new_n104_, new_n105_, new_n106_, new_n107_, new_n108_,
    new_n110_, new_n111_, new_n112_, new_n113_, new_n114_, new_n115_,
    new_n116_, new_n119_, new_n120_, new_n121_;
  ...
  nand2  g23(.a(new_n65_), .b(x02), .O(new_n68_));
  inv1   g24(.a(x12), .O(new_n69_));
  nand4  g25(.a(new_n69_), .b(new_n59_), .c(x10), .d(new_n62_), .O(new_n70_));
  nor2   g26(.a(new_n70_), .b(new_n68_), .O(z04));
  nor3   g27(.a(new_n68_), .b(new_n53_), .c(new_n62_), .O(z05));
  nand3  g28(.a(new_n60_), .b(new_n62_), .c(x02), .O(new_n73_));
  nor3   g29(.a(new_n73_), .b(new_n64_), .c(new_n63_), .O(z06));
  nand4  g30(.a(new_n60_), .b(new_n69_), .c(new_n62_), .d(x01), .O(new_n75_));
  ...
  nand2  g37(.a(x02), .b(new_n64_), .O(new_n83_));
  inv1   g38(.a(new_n83_), .O(new_n84_));
  nor2   g39(.a(new_n69_), .b(x11), .O(new_n85_));
  nor2   g40(.a(x14), .b(x13), .O(new_n86_));
  nand4  g41(.a(new_n86_), .b(new_n85_), .c(new_n84_), .d(new_n82_), .O(new_n87_));
  ...
  nand3  g46(.a(new_n91_), .b(new_n90_), .c(new_n63_), .O(new_n92_));
  aoi21  g47(.a(new_n89_), .b(new_n87_), .c(new_n92_), .O(z09));
  nor2   g48(.a(x20), .b(new_n64_), .O(new_n94_));
  nand4  g49(.a(new_n94_), .b(new_n56_), .c(x22), .d(x21), .O(new_n95_));
  inv1   g50(.a(x13), .O(new_n96_));
  nand3  g51(.a(new_n96_), .b(x12), .c(new_n59_), .O(new_n97_));
  nor2   g52(.a(new_n97_), .b(new_n83_), .O(new_n98_));
  nor2   g53(.a(new_n79_), .b(x14), .O(new_n99_));
  nand4  g54(.a(new_n91_), .b(new_n90_), .c(x20), .d(x16), .O(new_n100_));
  ...
  nand4  g58(.a(new_n88_), .b(x21), .c(x18), .d(x01), .O(new_n104_));
  nand3  g59(.a(new_n90_), .b(x20), .c(new_n80_), .O(new_n105_));
  inv1   g60(.a(new_n105_), .O(new_n106_));
  nand3  g61(.a(new_n106_), .b(new_n99_), .c(new_n98_), .O(new_n107_));
  nand2  g62(.a(new_n91_), .b(new_n63_), .O(new_n108_));
  aoi21  g63(.a(new_n107_), .b(new_n104_), .c(new_n108_), .O(z11));
  oai21  g64(.a(new_n53_), .b(new_n45_), .c(new_n65_), .O(new_n110_));
  ...
  nand2  g72(.a(new_n46_), .b(new_n45_), .O(new_n119_));
  nor2   g73(.a(x10), .b(x09), .O(new_n120_));
  nand4  g74(.a(new_n120_), .b(new_n50_), .c(new_n49_), .d(new_n48_), .O(new_n121_));
  nor2   g75(.a(new_n121_), .b(new_n119_), .O(z14));
  zero   g76(.O(z00));
  zero   g77(.O(z08));
  zero   g78(.O(z13));
  zero   g79(.O(z15));
