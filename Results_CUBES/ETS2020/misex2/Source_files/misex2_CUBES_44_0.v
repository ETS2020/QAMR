...
module FAU ( 
  ...
  nand4  g31(.a(x19), .b(new_n55_), .c(x17), .d(new_n76_), .O(new_n77_));
  ...
  nand3  g36(.a(new_n45_), .b(new_n81_), .c(x02), .O(new_n82_));
  ...
  oai21  g69(.a(new_n52_), .b(new_n44_), .c(new_n64_), .O(new_n115_));
  oai21  g70(.a(x19), .b(x02), .c(x23), .O(new_n116_));
  inv1   g71(.a(x19), .O(new_n117_));
  nand3  g72(.a(new_n117_), .b(x17), .c(new_n44_), .O(new_n118_));
  ...
  aoi21  g77(.a(new_n120_), .b(new_n115_), .c(new_n122_), .O(z12));
