...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n97_, new_n98_, new_n101_, new_n104_, new_n105_, new_n108_;
  ...
  nor2   g32(.a(x20), .b(new_n70_), .O(new_n79_));
  nand4  g33(.a(new_n79_), .b(new_n57_), .c(x22), .d(x21), .O(new_n80_));
  nand2  g34(.a(x02), .b(new_n70_), .O(new_n81_));
  inv1   g35(.a(x13), .O(new_n82_));
  nand3  g36(.a(new_n82_), .b(x12), .c(new_n62_), .O(new_n83_));
  nor2   g37(.a(new_n83_), .b(new_n81_), .O(new_n84_));
  inv1   g38(.a(x15), .O(new_n85_));
  nor2   g39(.a(new_n85_), .b(x14), .O(new_n86_));
  inv1   g40(.a(x21), .O(new_n87_));
  inv1   g41(.a(x22), .O(new_n88_));
  nand4  g42(.a(new_n88_), .b(new_n87_), .c(x20), .d(x16), .O(new_n89_));
  inv1   g43(.a(new_n89_), .O(new_n90_));
  nand3  g44(.a(new_n90_), .b(new_n86_), .c(new_n84_), .O(new_n91_));
  aoi21  g45(.a(new_n91_), .b(new_n80_), .c(x00), .O(z10));
  nand3  g46(.a(new_n79_), .b(new_n57_), .c(x21), .O(new_n93_));
  inv1   g47(.a(x16), .O(new_n94_));
  nand3  g48(.a(new_n87_), .b(x20), .c(new_n94_), .O(new_n95_));
  inv1   g49(.a(new_n95_), .O(new_n96_));
  nand3  g50(.a(new_n96_), .b(new_n86_), .c(new_n84_), .O(new_n97_));
  nand2  g51(.a(new_n88_), .b(new_n69_), .O(new_n98_));
  aoi21  g52(.a(new_n97_), .b(new_n93_), .c(new_n98_), .O(z11));
  nor2   g53(.a(x19), .b(new_n47_), .O(new_n101_));
  and2   g54(.a(new_n101_), .b(new_n45_), .O(z13));
  nor2   g55(.a(new_n55_), .b(new_n46_), .O(z14));
  aoi21  g56(.a(new_n54_), .b(x01), .c(new_n59_), .O(new_n104_));
  nand3  g57(.a(x19), .b(new_n59_), .c(new_n70_), .O(new_n105_));
  oai21  g58(.a(new_n104_), .b(new_n69_), .c(new_n105_), .O(z15));
  nor2   g59(.a(new_n70_), .b(x00), .O(z16));
  nand2  g60(.a(new_n60_), .b(x02), .O(new_n108_));
  inv1   g61(.a(new_n108_), .O(z17));
  zero   g62(.O(z05));
  zero   g63(.O(z08));
  zero   g64(.O(z09));
  zero   g65(.O(z12));
