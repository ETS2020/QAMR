...
module FAU ( 
  ...
  nor2   g22(.a(new_n49_), .b(new_n59_), .O(new_n72_));
  nor2   g23(.a(x20), .b(x19), .O(new_n73_));
  nand4  g24(.a(new_n73_), .b(new_n72_), .c(x22), .d(x21), .O(new_n74_));
  ...
  nand4  g34(.a(x12), .b(new_n83_), .c(x02), .d(new_n59_), .O(new_n84_));
  inv1   g35(.a(new_n84_), .O(new_n85_));
  nand3  g36(.a(new_n85_), .b(new_n82_), .c(new_n78_), .O(new_n86_));
  aoi21  g37(.a(new_n86_), .b(new_n74_), .c(x00), .O(z10));
