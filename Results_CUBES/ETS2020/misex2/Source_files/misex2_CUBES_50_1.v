...
module FAU ( 
  ...
  wire new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_, new_n51_,
    ...
    new_n112_, new_n113_, new_n114_, new_n116_, new_n117_;
  ...
  nand2  g62(.a(new_n46_), .b(new_n45_), .O(new_n112_));
  nor2   g63(.a(x10), .b(x09), .O(new_n113_));
  nand4  g64(.a(new_n113_), .b(new_n50_), .c(new_n49_), .d(new_n48_), .O(new_n114_));
  nor2   g65(.a(new_n114_), .b(new_n112_), .O(z14));
  aoi21  g66(.a(new_n53_), .b(x01), .c(new_n45_), .O(new_n116_));
  nand3  g67(.a(x19), .b(new_n45_), .c(new_n68_), .O(new_n117_));
  oai21  g68(.a(new_n116_), .b(new_n67_), .c(new_n117_), .O(z15));
  zero   g69(.O(z00));
  zero   g70(.O(z04));
  zero   g71(.O(z05));
  zero   g72(.O(z11));
