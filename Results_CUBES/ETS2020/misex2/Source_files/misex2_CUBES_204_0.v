...
module FAU ( 
  ...
  nand4  g53(.a(new_n99_), .b(new_n98_), .c(new_n52_), .d(x18), .O(new_n100_));
  ...
  nand3  g70(.a(new_n52_), .b(x17), .c(new_n45_), .O(new_n117_));
  ...
  nand3  g77(.a(new_n48_), .b(new_n56_), .c(new_n60_), .O(new_n124_));
  nor2   g78(.a(new_n124_), .b(new_n47_), .O(z14));
