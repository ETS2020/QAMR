...
module FAU ( 
  ...
  oai21  g59(.a(new_n57_), .b(new_n60_), .c(new_n65_), .O(new_n105_));
  oai21  g60(.a(x19), .b(x02), .c(x23), .O(new_n106_));
  nand3  g61(.a(new_n52_), .b(x17), .c(new_n60_), .O(new_n107_));
  ...
  aoi21  g66(.a(new_n109_), .b(new_n105_), .c(new_n111_), .O(z12));
  nor4   g67(.a(new_n47_), .b(x19), .c(new_n50_), .d(x02), .O(z13));
