...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n102_, new_n103_, new_n104_, new_n112_;
  ...
  nor4   g25(.a(new_n69_), .b(new_n57_), .c(new_n47_), .d(new_n44_), .O(z05));
  nand3  g26(.a(new_n64_), .b(new_n47_), .c(x02), .O(new_n71_));
  nor2   g27(.a(new_n71_), .b(new_n69_), .O(z06));
  inv1   g28(.a(x12), .O(new_n73_));
  nand4  g29(.a(new_n64_), .b(new_n73_), .c(new_n47_), .d(x01), .O(new_n74_));
  ...
  nand4  g43(.a(new_n88_), .b(new_n48_), .c(x18), .d(x01), .O(new_n89_));
  ...
  nand4  g50(.a(new_n95_), .b(new_n60_), .c(new_n88_), .d(x01), .O(new_n96_));
  ...
  inv1   g55(.a(x01), .O(new_n101_));
  nand4  g56(.a(x12), .b(new_n63_), .c(x02), .d(new_n101_), .O(new_n102_));
  inv1   g57(.a(new_n102_), .O(new_n103_));
  nand3  g58(.a(new_n103_), .b(new_n100_), .c(new_n98_), .O(new_n104_));
  aoi21  g59(.a(new_n104_), .b(new_n96_), .c(x00), .O(z10));
  nor2   g60(.a(new_n101_), .b(x00), .O(z16));
  nand2  g61(.a(new_n45_), .b(x02), .O(new_n112_));
