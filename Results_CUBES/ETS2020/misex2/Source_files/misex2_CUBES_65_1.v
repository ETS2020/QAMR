...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n102_, new_n107_, new_n109_, new_n110_, new_n113_;
  ...
  nand4  g37(.a(new_n84_), .b(new_n83_), .c(x12), .d(new_n62_), .O(new_n85_));
  inv1   g38(.a(new_n85_), .O(new_n86_));
  nand3  g39(.a(new_n86_), .b(new_n82_), .c(new_n81_), .O(new_n87_));
  inv1   g40(.a(x20), .O(new_n88_));
  nand4  g41(.a(new_n88_), .b(new_n50_), .c(x18), .d(x01), .O(new_n89_));
  inv1   g42(.a(x21), .O(new_n90_));
  inv1   g43(.a(x22), .O(new_n91_));
  nand3  g44(.a(new_n91_), .b(new_n90_), .c(new_n69_), .O(new_n92_));
  aoi21  g45(.a(new_n89_), .b(new_n87_), .c(new_n92_), .O(z09));
  nor2   g46(.a(new_n91_), .b(new_n90_), .O(new_n94_));
  nand4  g47(.a(new_n94_), .b(new_n59_), .c(new_n88_), .d(x01), .O(new_n95_));
  nand3  g48(.a(new_n91_), .b(new_n90_), .c(x20), .O(new_n96_));
  inv1   g49(.a(new_n96_), .O(new_n97_));
  nand4  g50(.a(x16), .b(x15), .c(new_n84_), .d(new_n83_), .O(new_n98_));
  inv1   g51(.a(new_n98_), .O(new_n99_));
  nand4  g52(.a(x12), .b(new_n62_), .c(x02), .d(new_n70_), .O(new_n100_));
  inv1   g53(.a(new_n100_), .O(new_n101_));
  nand3  g54(.a(new_n101_), .b(new_n99_), .c(new_n97_), .O(new_n102_));
  aoi21  g55(.a(new_n102_), .b(new_n95_), .c(x00), .O(z10));
  nor3   g56(.a(new_n54_), .b(x19), .c(new_n48_), .O(z13));
  nand4  g57(.a(new_n50_), .b(new_n49_), .c(new_n48_), .d(new_n55_), .O(new_n107_));
  nor2   g58(.a(new_n107_), .b(new_n47_), .O(z14));
  aoi21  g59(.a(new_n55_), .b(x01), .c(new_n44_), .O(new_n109_));
  nand3  g60(.a(x19), .b(new_n44_), .c(new_n70_), .O(new_n110_));
  oai21  g61(.a(new_n109_), .b(new_n69_), .c(new_n110_), .O(z15));
  nand2  g62(.a(new_n46_), .b(x02), .O(new_n113_));
  inv1   g63(.a(new_n113_), .O(z17));
  zero   g64(.O(z01));
  zero   g65(.O(z04));
  zero   g66(.O(z05));
  zero   g67(.O(z08));
