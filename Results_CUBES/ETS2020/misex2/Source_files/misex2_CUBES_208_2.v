...
module FAU ( 
  ...
  inv1   g33(.a(x11), .O(new_n82_));
  inv1   g34(.a(x13), .O(new_n83_));
  inv1   g35(.a(x14), .O(new_n84_));
  nand4  g36(.a(new_n84_), .b(new_n83_), .c(x12), .d(new_n82_), .O(new_n85_));
  inv1   g37(.a(new_n85_), .O(new_n86_));
  nand3  g38(.a(new_n86_), .b(new_n81_), .c(new_n80_), .O(new_n87_));
  inv1   g39(.a(x00), .O(new_n88_));
  inv1   g40(.a(x22), .O(new_n89_));
  nand2  g41(.a(new_n89_), .b(new_n88_), .O(new_n90_));
  aoi21  g42(.a(new_n87_), .b(new_n76_), .c(new_n90_), .O(z11));
  ...
  aoi21  g52(.a(new_n57_), .b(x01), .c(new_n44_), .O(new_n103_));
  inv1   g53(.a(x01), .O(new_n104_));
  nand3  g54(.a(x19), .b(new_n44_), .c(new_n104_), .O(new_n105_));
  oai21  g55(.a(new_n103_), .b(new_n88_), .c(new_n105_), .O(z15));
