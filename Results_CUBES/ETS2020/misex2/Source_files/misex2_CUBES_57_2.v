...
module FAU ( 
  ...
  wire new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n53_, new_n54_,
    ...
    new_n98_, new_n101_, new_n103_, new_n104_;
  ...
  inv1   g27(.a(x22), .O(new_n77_));
  nor2   g28(.a(new_n77_), .b(new_n76_), .O(new_n78_));
  nand4  g29(.a(new_n78_), .b(new_n75_), .c(x18), .d(x01), .O(new_n79_));
  nand3  g30(.a(new_n77_), .b(new_n76_), .c(x20), .O(new_n80_));
  inv1   g31(.a(new_n80_), .O(new_n81_));
  inv1   g32(.a(x13), .O(new_n82_));
  inv1   g33(.a(x14), .O(new_n83_));
  nand4  g34(.a(x16), .b(x15), .c(new_n83_), .d(new_n82_), .O(new_n84_));
  inv1   g35(.a(new_n84_), .O(new_n85_));
  nand4  g36(.a(x12), .b(new_n58_), .c(x02), .d(new_n54_), .O(new_n86_));
  inv1   g37(.a(new_n86_), .O(new_n87_));
  nand3  g38(.a(new_n87_), .b(new_n85_), .c(new_n81_), .O(new_n88_));
  aoi21  g39(.a(new_n88_), .b(new_n79_), .c(x00), .O(z10));
  oai21  g40(.a(new_n62_), .b(new_n45_), .c(new_n55_), .O(new_n91_));
  oai21  g41(.a(x19), .b(x02), .c(x23), .O(new_n92_));
  inv1   g42(.a(x19), .O(new_n93_));
  nand3  g43(.a(new_n93_), .b(x17), .c(new_n45_), .O(new_n94_));
  nand2  g44(.a(new_n94_), .b(new_n92_), .O(new_n95_));
  nand2  g45(.a(new_n95_), .b(new_n46_), .O(new_n96_));
  inv1   g46(.a(x24), .O(new_n97_));
  nand2  g47(.a(new_n97_), .b(x09), .O(new_n98_));
  aoi21  g48(.a(new_n96_), .b(new_n91_), .c(new_n98_), .O(z12));
  nand3  g49(.a(new_n48_), .b(new_n62_), .c(new_n57_), .O(new_n101_));
  nor2   g50(.a(new_n101_), .b(new_n47_), .O(z14));
  aoi21  g51(.a(new_n62_), .b(x01), .c(new_n45_), .O(new_n103_));
  nand3  g52(.a(x19), .b(new_n45_), .c(new_n54_), .O(new_n104_));
  oai21  g53(.a(new_n103_), .b(new_n53_), .c(new_n104_), .O(z15));
  nor2   g54(.a(new_n54_), .b(x00), .O(z16));
