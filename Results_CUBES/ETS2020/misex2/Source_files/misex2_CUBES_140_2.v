...
module FAU ( 
  ...
  nor3   g59(.a(new_n46_), .b(x19), .c(new_n49_), .O(z13));
  aoi21  g60(.a(new_n57_), .b(x01), .c(new_n44_), .O(new_n109_));
  inv1   g61(.a(x01), .O(new_n110_));
  nand3  g62(.a(x19), .b(new_n44_), .c(new_n110_), .O(new_n111_));
  oai21  g63(.a(new_n109_), .b(new_n86_), .c(new_n111_), .O(z15));
  nor2   g64(.a(new_n110_), .b(x00), .O(z16));
