...
module FAU ( 
  ...
  nand2  g31(.a(x02), .b(new_n77_), .O(new_n78_));
  ...
  nand3  g38(.a(new_n84_), .b(new_n79_), .c(new_n76_), .O(new_n85_));
  nor2   g39(.a(new_n50_), .b(new_n77_), .O(new_n86_));
  ...
  aoi21  g46(.a(new_n88_), .b(new_n85_), .c(new_n92_), .O(z09));
  nand4  g47(.a(new_n87_), .b(new_n86_), .c(x22), .d(x21), .O(new_n94_));
  nand3  g48(.a(new_n81_), .b(x12), .c(new_n80_), .O(new_n95_));
  nor2   g49(.a(new_n95_), .b(new_n78_), .O(new_n96_));
  nor2   g50(.a(new_n73_), .b(x14), .O(new_n97_));
  ...
  nand3  g56(.a(new_n90_), .b(x20), .c(new_n74_), .O(new_n103_));
  inv1   g57(.a(new_n103_), .O(new_n104_));
  nand3  g58(.a(new_n104_), .b(new_n97_), .c(new_n96_), .O(new_n105_));
  nand2  g59(.a(new_n91_), .b(new_n89_), .O(new_n106_));
  aoi21  g60(.a(new_n105_), .b(new_n102_), .c(new_n106_), .O(z11));
  nand2  g61(.a(x10), .b(x02), .O(new_n108_));
  nand3  g62(.a(new_n108_), .b(x01), .c(x00), .O(new_n109_));
  oai21  g63(.a(x19), .b(x02), .c(x23), .O(new_n110_));
  nand3  g64(.a(new_n51_), .b(x17), .c(new_n44_), .O(new_n111_));
  ...
  nor3   g70(.a(new_n46_), .b(x19), .c(new_n49_), .O(z13));
  aoi21  g71(.a(new_n57_), .b(x01), .c(new_n44_), .O(new_n119_));
  nand3  g72(.a(x19), .b(new_n44_), .c(new_n77_), .O(new_n120_));
  oai21  g73(.a(new_n119_), .b(new_n89_), .c(new_n120_), .O(z15));
  nor2   g74(.a(new_n77_), .b(x00), .O(z16));
  inv1   g75(.a(new_n70_), .O(z17));
  zero   g76(.O(z03));
  zero   g77(.O(z06));
  zero   g78(.O(z07));
  zero   g79(.O(z14));
