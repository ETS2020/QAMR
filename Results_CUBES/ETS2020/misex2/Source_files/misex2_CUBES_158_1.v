...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n91_, new_n92_, new_n93_, new_n94_, new_n95_, new_n96_, new_n102_;
  ...
  nand3  g17(.a(new_n62_), .b(new_n47_), .c(x02), .O(new_n63_));
  oai22  g18(.a(new_n63_), .b(new_n60_), .c(new_n56_), .d(new_n54_), .O(z03));
  nor4   g19(.a(new_n61_), .b(new_n57_), .c(new_n47_), .d(new_n44_), .O(z05));
  nand3  g20(.a(new_n59_), .b(new_n47_), .c(x02), .O(new_n67_));
  nor2   g21(.a(new_n67_), .b(new_n61_), .O(z06));
  inv1   g22(.a(x12), .O(new_n69_));
  nand4  g23(.a(new_n59_), .b(new_n69_), .c(new_n47_), .d(x01), .O(new_n70_));
  ...
  nand3  g37(.a(new_n86_), .b(new_n82_), .c(new_n81_), .O(new_n87_));
  or2    g38(.a(x22), .b(x00), .O(new_n88_));
  aoi21  g39(.a(new_n87_), .b(new_n77_), .c(new_n88_), .O(z11));
  oai21  g40(.a(new_n57_), .b(new_n44_), .c(new_n62_), .O(new_n90_));
  oai21  g41(.a(x19), .b(x02), .c(x23), .O(new_n91_));
  nand3  g42(.a(new_n48_), .b(x17), .c(new_n44_), .O(new_n92_));
  nand2  g43(.a(new_n92_), .b(new_n91_), .O(new_n93_));
  nand2  g44(.a(new_n93_), .b(new_n45_), .O(new_n94_));
  inv1   g45(.a(x24), .O(new_n95_));
  nand2  g46(.a(new_n95_), .b(x09), .O(new_n96_));
  aoi21  g47(.a(new_n94_), .b(new_n90_), .c(new_n96_), .O(z12));
  nor3   g48(.a(new_n46_), .b(x19), .c(new_n55_), .O(z13));
  nand2  g49(.a(new_n45_), .b(x02), .O(new_n102_));
  inv1   g50(.a(new_n102_), .O(z17));
  zero   g51(.O(z01));
  zero   g52(.O(z02));
  zero   g53(.O(z04));
  zero   g54(.O(z08));
