...
module FAU ( 
  ...
  nand4  g38(.a(new_n84_), .b(new_n51_), .c(x18), .d(x01), .O(new_n85_));
  ...
  nand2  g44(.a(x10), .b(x02), .O(new_n93_));
  nand3  g45(.a(new_n93_), .b(x01), .c(x00), .O(new_n94_));
  oai21  g46(.a(x19), .b(x02), .c(x23), .O(new_n95_));
  nand3  g47(.a(new_n51_), .b(x17), .c(new_n44_), .O(new_n96_));
  nand2  g48(.a(new_n96_), .b(new_n95_), .O(new_n97_));
  nand2  g49(.a(new_n97_), .b(new_n45_), .O(new_n98_));
  inv1   g50(.a(x24), .O(new_n99_));
  nand2  g51(.a(new_n99_), .b(x09), .O(new_n100_));
  aoi21  g52(.a(new_n98_), .b(new_n94_), .c(new_n100_), .O(z12));
  nor3   g53(.a(new_n46_), .b(x19), .c(new_n49_), .O(z13));
  aoi21  g54(.a(new_n57_), .b(x01), .c(new_n44_), .O(new_n104_));
  inv1   g55(.a(x01), .O(new_n105_));
  nand3  g56(.a(x19), .b(new_n44_), .c(new_n105_), .O(new_n106_));
  oai21  g57(.a(new_n104_), .b(new_n86_), .c(new_n106_), .O(z15));
  nor2   g58(.a(new_n105_), .b(x00), .O(z16));
