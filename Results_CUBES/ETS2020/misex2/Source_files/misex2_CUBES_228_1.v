...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n109_, new_n110_, new_n114_, new_n116_, new_n117_, new_n120_;
  ...
  nand4  g51(.a(new_n96_), .b(new_n58_), .c(x22), .d(x21), .O(new_n97_));
  ...
  nand4  g66(.a(new_n50_), .b(new_n49_), .c(new_n48_), .d(new_n61_), .O(new_n114_));
  nor2   g67(.a(new_n114_), .b(new_n47_), .O(z14));
  aoi21  g68(.a(new_n61_), .b(x01), .c(new_n44_), .O(new_n116_));
  nand3  g69(.a(x19), .b(new_n44_), .c(new_n66_), .O(new_n117_));
  oai21  g70(.a(new_n116_), .b(new_n65_), .c(new_n117_), .O(z15));
  nand2  g71(.a(new_n46_), .b(x02), .O(new_n120_));
  inv1   g72(.a(new_n120_), .O(z17));
  zero   g73(.O(z02));
  zero   g74(.O(z08));
  zero   g75(.O(z12));
  zero   g76(.O(z13));
