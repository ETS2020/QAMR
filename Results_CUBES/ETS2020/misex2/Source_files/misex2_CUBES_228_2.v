...
module FAU ( 
  ...
  nor2   g29(.a(new_n46_), .b(x01), .O(new_n78_));
  inv1   g30(.a(x13), .O(new_n79_));
  inv1   g31(.a(x14), .O(new_n80_));
  nand4  g32(.a(new_n80_), .b(new_n79_), .c(x12), .d(new_n59_), .O(new_n81_));
  ...
  nand3  g39(.a(new_n87_), .b(new_n86_), .c(new_n54_), .O(new_n88_));
  ...
  nand2  g45(.a(new_n87_), .b(new_n54_), .O(new_n95_));
  aoi21  g46(.a(new_n94_), .b(new_n91_), .c(new_n95_), .O(z11));
  oai21  g47(.a(new_n49_), .b(new_n46_), .c(new_n56_), .O(new_n97_));
  oai21  g48(.a(x19), .b(x02), .c(x23), .O(new_n98_));
  inv1   g49(.a(x19), .O(new_n99_));
  nand3  g50(.a(new_n99_), .b(x17), .c(new_n46_), .O(new_n100_));
  ...
  nand3  g58(.a(new_n50_), .b(new_n49_), .c(new_n58_), .O(new_n108_));
  nor2   g59(.a(new_n108_), .b(new_n48_), .O(z14));
  aoi21  g60(.a(new_n49_), .b(x01), .c(new_n46_), .O(new_n110_));
  nand3  g61(.a(x19), .b(new_n46_), .c(new_n55_), .O(new_n111_));
  oai21  g62(.a(new_n110_), .b(new_n54_), .c(new_n111_), .O(z15));
  nor2   g63(.a(new_n55_), .b(x00), .O(z16));
