...
module FAU ( 
  ...
  nand4  g47(.a(new_n93_), .b(new_n55_), .c(x22), .d(x21), .O(new_n94_));
  ...
  nand4  g62(.a(new_n50_), .b(new_n49_), .c(new_n48_), .d(new_n58_), .O(new_n111_));
  nor2   g63(.a(new_n111_), .b(new_n47_), .O(z14));
  aoi21  g64(.a(new_n58_), .b(x01), .c(new_n44_), .O(new_n113_));
  nand3  g65(.a(x19), .b(new_n44_), .c(new_n63_), .O(new_n114_));
  oai21  g66(.a(new_n113_), .b(new_n62_), .c(new_n114_), .O(z15));
  nand2  g67(.a(new_n46_), .b(x02), .O(new_n117_));
  inv1   g68(.a(new_n117_), .O(z17));
  zero   g69(.O(z01));
  zero   g70(.O(z02));
  zero   g71(.O(z08));
  zero   g72(.O(z12));
