...
module FAU ( 
  ...
  nand4  g53(.a(new_n99_), .b(new_n98_), .c(new_n50_), .d(x18), .O(new_n100_));
  ...
  nand3  g70(.a(new_n50_), .b(x17), .c(new_n46_), .O(new_n117_));
  ...
  nor2   g77(.a(new_n62_), .b(x00), .O(z16));
  inv1   g78(.a(new_n79_), .O(z17));
  zero   g79(.O(z00));
  zero   g80(.O(z01));
  zero   g81(.O(z05));
  zero   g82(.O(z14));
