...
module FAU ( 
  ...
  nand2  g43(.a(x02), .b(new_n87_), .O(new_n88_));
  inv1   g44(.a(new_n88_), .O(new_n89_));
  nor2   g45(.a(new_n72_), .b(x11), .O(new_n90_));
  nor2   g46(.a(x14), .b(x13), .O(new_n91_));
  nand4  g47(.a(new_n91_), .b(new_n90_), .c(new_n89_), .d(new_n86_), .O(new_n92_));
  ...
  nor2   g55(.a(x20), .b(new_n87_), .O(new_n100_));
  ...
  nor2   g60(.a(new_n83_), .b(x14), .O(new_n105_));
  ...
  nand4  g65(.a(new_n93_), .b(x21), .c(x18), .d(x01), .O(new_n110_));
  nand3  g66(.a(new_n96_), .b(x20), .c(new_n84_), .O(new_n111_));
  inv1   g67(.a(new_n111_), .O(new_n112_));
  nand3  g68(.a(new_n112_), .b(new_n105_), .c(new_n104_), .O(new_n113_));
  nand2  g69(.a(new_n97_), .b(new_n95_), .O(new_n114_));
  ...
  nand3  g81(.a(x19), .b(new_n44_), .c(new_n87_), .O(new_n127_));
  oai21  g82(.a(new_n126_), .b(new_n95_), .c(new_n127_), .O(z15));
