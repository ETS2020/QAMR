...
module FAU ( 
  ...
  nand2  g39(.a(x02), .b(new_n67_), .O(new_n85_));
  ...
  nand3  g48(.a(new_n93_), .b(new_n92_), .c(new_n66_), .O(new_n94_));
  aoi21  g49(.a(new_n91_), .b(new_n89_), .c(new_n94_), .O(z09));
  nor2   g50(.a(x20), .b(new_n67_), .O(new_n96_));
  ...
  nand2  g64(.a(new_n93_), .b(new_n66_), .O(new_n110_));
  aoi21  g65(.a(new_n109_), .b(new_n106_), .c(new_n110_), .O(z11));
  oai21  g66(.a(new_n57_), .b(new_n44_), .c(new_n68_), .O(new_n112_));
