...
module FAU ( 
  ...
  nand2  g30(.a(x02), .b(new_n74_), .O(new_n78_));
  ...
  inv1   g48(.a(x00), .O(new_n96_));
  nand2  g49(.a(new_n86_), .b(new_n96_), .O(new_n97_));
  aoi21  g50(.a(new_n95_), .b(new_n91_), .c(new_n97_), .O(z11));
  nand2  g51(.a(x10), .b(x02), .O(new_n99_));
  nand3  g52(.a(new_n99_), .b(x01), .c(x00), .O(new_n100_));
  oai21  g53(.a(x19), .b(x02), .c(x23), .O(new_n101_));
  nand3  g54(.a(new_n51_), .b(x17), .c(new_n44_), .O(new_n102_));
  ...
  nand3  g62(.a(x19), .b(new_n44_), .c(new_n74_), .O(new_n111_));
  oai21  g63(.a(new_n110_), .b(new_n96_), .c(new_n111_), .O(z15));
  nor2   g64(.a(new_n74_), .b(x00), .O(z16));
  inv1   g65(.a(new_n70_), .O(z17));
  zero   g66(.O(z03));
  zero   g67(.O(z06));
  zero   g68(.O(z07));
  zero   g69(.O(z09));
