...
module FAU ( 
  ...
  nand4  g12(.a(new_n50_), .b(x18), .c(new_n48_), .d(new_n44_), .O(new_n58_));
  ...
  nor2   g17(.a(new_n56_), .b(new_n55_), .O(new_n63_));
  nand3  g18(.a(new_n63_), .b(new_n45_), .c(x02), .O(new_n64_));
  oai22  g19(.a(new_n64_), .b(new_n62_), .c(new_n58_), .d(new_n57_), .O(z03));
  nand2  g20(.a(new_n63_), .b(x02), .O(new_n66_));
  inv1   g21(.a(x12), .O(new_n67_));
  nand4  g22(.a(new_n67_), .b(new_n60_), .c(x10), .d(new_n45_), .O(new_n68_));
  nor2   g23(.a(new_n68_), .b(new_n66_), .O(z04));
  nor3   g24(.a(new_n66_), .b(new_n59_), .c(new_n45_), .O(z05));
  nand3  g25(.a(new_n61_), .b(new_n45_), .c(x02), .O(new_n71_));
  nor3   g26(.a(new_n71_), .b(new_n56_), .c(new_n55_), .O(z06));
  nand4  g27(.a(new_n61_), .b(new_n67_), .c(new_n45_), .d(x01), .O(new_n73_));
  ...
  nand3  g51(.a(new_n96_), .b(new_n95_), .c(new_n55_), .O(new_n97_));
  ...
  nand2  g57(.a(new_n96_), .b(new_n55_), .O(new_n104_));
  aoi21  g58(.a(new_n103_), .b(new_n100_), .c(new_n104_), .O(z11));
  oai21  g59(.a(new_n59_), .b(new_n44_), .c(new_n63_), .O(new_n106_));
  oai21  g60(.a(x19), .b(x02), .c(x23), .O(new_n107_));
  nand3  g61(.a(new_n50_), .b(x17), .c(new_n44_), .O(new_n108_));
  ...
  nor4   g67(.a(new_n57_), .b(x19), .c(new_n48_), .d(x02), .O(z13));
  nand4  g68(.a(new_n50_), .b(new_n49_), .c(new_n48_), .d(new_n59_), .O(new_n115_));
  nor2   g69(.a(new_n115_), .b(new_n47_), .O(z14));
  nor2   g70(.a(new_n56_), .b(x00), .O(z16));
  inv1   g71(.a(new_n80_), .O(z17));
  zero   g72(.O(z01));
  zero   g73(.O(z02));
  zero   g74(.O(z10));
  zero   g75(.O(z15));
