...
module FAU ( 
  ...
  nand2  g43(.a(x02), .b(new_n63_), .O(new_n89_));
  ...
  nor2   g54(.a(x20), .b(new_n63_), .O(new_n100_));
  nand4  g55(.a(new_n100_), .b(new_n55_), .c(x22), .d(x21), .O(new_n101_));
  ...
  nand2  g68(.a(new_n97_), .b(new_n62_), .O(new_n114_));
  aoi21  g69(.a(new_n113_), .b(new_n110_), .c(new_n114_), .O(z11));
  oai21  g70(.a(new_n58_), .b(new_n44_), .c(new_n64_), .O(new_n116_));
  oai21  g71(.a(x19), .b(x02), .c(x23), .O(new_n117_));
  nand3  g72(.a(new_n50_), .b(x17), .c(new_n44_), .O(new_n118_));
  ...
  nand4  g78(.a(new_n50_), .b(new_n49_), .c(new_n48_), .d(new_n58_), .O(new_n125_));
  nor2   g79(.a(new_n125_), .b(new_n47_), .O(z14));
  zero   g80(.O(z01));
  zero   g81(.O(z02));
  zero   g82(.O(z13));
  zero   g83(.O(z15));
