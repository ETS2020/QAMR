...
module FAU ( 
  ...
  inv1   g34(.a(x20), .O(new_n82_));
  nand4  g35(.a(new_n82_), .b(new_n50_), .c(x18), .d(x01), .O(new_n83_));
  inv1   g36(.a(x00), .O(new_n84_));
  inv1   g37(.a(x21), .O(new_n85_));
  inv1   g38(.a(x22), .O(new_n86_));
  nand3  g39(.a(new_n86_), .b(new_n85_), .c(new_n84_), .O(new_n87_));
  aoi21  g40(.a(new_n83_), .b(new_n81_), .c(new_n87_), .O(z09));
  nand2  g41(.a(new_n46_), .b(new_n45_), .O(new_n93_));
  nor2   g42(.a(x10), .b(x09), .O(new_n94_));
  nand4  g43(.a(new_n94_), .b(new_n50_), .c(new_n49_), .d(new_n48_), .O(new_n95_));
  nor2   g44(.a(new_n95_), .b(new_n93_), .O(z14));
  aoi21  g45(.a(new_n53_), .b(x01), .c(new_n45_), .O(new_n97_));
  inv1   g46(.a(x01), .O(new_n98_));
  nand3  g47(.a(x19), .b(new_n45_), .c(new_n98_), .O(new_n99_));
  oai21  g48(.a(new_n97_), .b(new_n84_), .c(new_n99_), .O(z15));
