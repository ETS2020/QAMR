...
module FAU ( 
  ...
  wire new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_, new_n51_,
    ...
    new_n106_, new_n107_, new_n109_, new_n110_, new_n113_;
  ...
  nand4  g43(.a(new_n88_), .b(new_n50_), .c(x18), .d(x01), .O(new_n89_));
  ...
  oai21  g48(.a(new_n53_), .b(new_n45_), .c(new_n64_), .O(new_n96_));
  oai21  g49(.a(x19), .b(x02), .c(x23), .O(new_n97_));
  nand3  g50(.a(new_n50_), .b(x17), .c(new_n45_), .O(new_n98_));
  nand2  g51(.a(new_n98_), .b(new_n97_), .O(new_n99_));
  nand2  g52(.a(new_n99_), .b(new_n46_), .O(new_n100_));
  inv1   g53(.a(x24), .O(new_n101_));
  nand2  g54(.a(new_n101_), .b(x09), .O(new_n102_));
  aoi21  g55(.a(new_n100_), .b(new_n96_), .c(new_n102_), .O(z12));
  nand2  g56(.a(new_n46_), .b(new_n45_), .O(new_n104_));
  nor3   g57(.a(new_n104_), .b(x19), .c(new_n48_), .O(z13));
  nor2   g58(.a(x10), .b(x09), .O(new_n106_));
  nand4  g59(.a(new_n106_), .b(new_n50_), .c(new_n49_), .d(new_n48_), .O(new_n107_));
  nor2   g60(.a(new_n107_), .b(new_n104_), .O(z14));
  aoi21  g61(.a(new_n53_), .b(x01), .c(new_n45_), .O(new_n109_));
  nand3  g62(.a(x19), .b(new_n45_), .c(new_n63_), .O(new_n110_));
  oai21  g63(.a(new_n109_), .b(new_n62_), .c(new_n110_), .O(z15));
  nand2  g64(.a(new_n46_), .b(x02), .O(new_n113_));
  inv1   g65(.a(new_n113_), .O(z17));
  zero   g66(.O(z00));
  zero   g67(.O(z08));
  zero   g68(.O(z10));
  zero   g69(.O(z11));
