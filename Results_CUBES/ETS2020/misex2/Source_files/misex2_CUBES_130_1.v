...
module FAU ( 
  ...
  nand2  g14(.a(new_n45_), .b(new_n44_), .O(new_n59_));
  nand4  g15(.a(new_n51_), .b(x18), .c(new_n49_), .d(new_n46_), .O(new_n60_));
  ...
  nand4  g20(.a(new_n64_), .b(x02), .c(x01), .d(x00), .O(new_n65_));
  oai22  g21(.a(new_n65_), .b(new_n63_), .c(new_n60_), .d(new_n59_), .O(z03));
  nand2  g22(.a(x01), .b(x00), .O(new_n68_));
  nor4   g23(.a(new_n68_), .b(new_n55_), .c(new_n64_), .d(new_n46_), .O(z05));
  nand3  g24(.a(new_n62_), .b(new_n64_), .c(x02), .O(new_n70_));
  nor2   g25(.a(new_n70_), .b(new_n68_), .O(z06));
  inv1   g26(.a(x12), .O(new_n72_));
  nand4  g27(.a(new_n62_), .b(new_n72_), .c(new_n64_), .d(x01), .O(new_n73_));
  ...
  nor2   g34(.a(new_n46_), .b(x01), .O(new_n81_));
  inv1   g35(.a(x13), .O(new_n82_));
  inv1   g36(.a(x14), .O(new_n83_));
  nand4  g37(.a(new_n83_), .b(new_n82_), .c(x12), .d(new_n61_), .O(new_n84_));
  inv1   g38(.a(new_n84_), .O(new_n85_));
  nand3  g39(.a(new_n85_), .b(new_n81_), .c(new_n80_), .O(new_n86_));
  inv1   g40(.a(x20), .O(new_n87_));
  nand4  g41(.a(new_n87_), .b(new_n51_), .c(x18), .d(x01), .O(new_n88_));
  inv1   g42(.a(x21), .O(new_n89_));
  inv1   g43(.a(x22), .O(new_n90_));
  nand3  g44(.a(new_n90_), .b(new_n89_), .c(new_n44_), .O(new_n91_));
  aoi21  g45(.a(new_n88_), .b(new_n86_), .c(new_n91_), .O(z09));
  nor3   g46(.a(new_n47_), .b(x19), .c(new_n49_), .O(z13));
  nand4  g47(.a(new_n51_), .b(new_n50_), .c(new_n49_), .d(new_n55_), .O(new_n97_));
  nor2   g48(.a(new_n97_), .b(new_n48_), .O(z14));
  aoi21  g49(.a(new_n55_), .b(x01), .c(new_n46_), .O(new_n99_));
  nand3  g50(.a(x19), .b(new_n46_), .c(new_n45_), .O(new_n100_));
  oai21  g51(.a(new_n99_), .b(new_n44_), .c(new_n100_), .O(z15));
  nor2   g52(.a(new_n45_), .b(x00), .O(z16));
  zero   g53(.O(z01));
  zero   g54(.O(z04));
  zero   g55(.O(z08));
  zero   g56(.O(z10));
