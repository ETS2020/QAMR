...
module FAU ( 
  ...
  wire new_n46_, new_n47_, new_n48_, new_n49_, new_n50_, new_n51_, new_n54_,
    ...
    new_n104_, new_n107_, new_n109_, new_n110_;
  ...
  nand3  g56(.a(new_n50_), .b(new_n49_), .c(new_n58_), .O(new_n107_));
  nor2   g57(.a(new_n107_), .b(new_n48_), .O(z14));
  aoi21  g58(.a(new_n49_), .b(x01), .c(new_n46_), .O(new_n109_));
  nand3  g59(.a(x19), .b(new_n46_), .c(new_n55_), .O(new_n110_));
  oai21  g60(.a(new_n109_), .b(new_n54_), .c(new_n110_), .O(z15));
  nor2   g61(.a(new_n55_), .b(x00), .O(z16));
  inv1   g62(.a(new_n70_), .O(z17));
  zero   g63(.O(z00));
  zero   g64(.O(z01));
  zero   g65(.O(z03));
  zero   g66(.O(z06));
