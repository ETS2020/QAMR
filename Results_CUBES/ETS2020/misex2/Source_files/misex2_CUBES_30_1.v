...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n89_, new_n90_, new_n91_, new_n95_, new_n98_, new_n99_;
  ...
  nor2   g32(.a(x20), .b(new_n60_), .O(new_n79_));
  nand4  g33(.a(new_n79_), .b(new_n57_), .c(x22), .d(x21), .O(new_n80_));
  inv1   g34(.a(x21), .O(new_n81_));
  inv1   g35(.a(x22), .O(new_n82_));
  nand3  g36(.a(new_n82_), .b(new_n81_), .c(x20), .O(new_n83_));
  inv1   g37(.a(new_n83_), .O(new_n84_));
  inv1   g38(.a(x13), .O(new_n85_));
  inv1   g39(.a(x14), .O(new_n86_));
  nand4  g40(.a(x16), .b(x15), .c(new_n86_), .d(new_n85_), .O(new_n87_));
  inv1   g41(.a(new_n87_), .O(new_n88_));
  nand4  g42(.a(x12), .b(new_n63_), .c(x02), .d(new_n60_), .O(new_n89_));
  inv1   g43(.a(new_n89_), .O(new_n90_));
  nand3  g44(.a(new_n90_), .b(new_n88_), .c(new_n84_), .O(new_n91_));
  aoi21  g45(.a(new_n91_), .b(new_n80_), .c(x00), .O(z10));
  nor2   g46(.a(x19), .b(new_n47_), .O(new_n95_));
  and2   g47(.a(new_n95_), .b(new_n45_), .O(z13));
  nor2   g48(.a(new_n55_), .b(new_n46_), .O(z14));
  aoi21  g49(.a(new_n54_), .b(x01), .c(new_n61_), .O(new_n98_));
  nand3  g50(.a(x19), .b(new_n61_), .c(new_n60_), .O(new_n99_));
  oai21  g51(.a(new_n98_), .b(new_n59_), .c(new_n99_), .O(z15));
  nor2   g52(.a(new_n60_), .b(x00), .O(z16));
  zero   g53(.O(z04));
  zero   g54(.O(z08));
  zero   g55(.O(z09));
  zero   g56(.O(z11));
