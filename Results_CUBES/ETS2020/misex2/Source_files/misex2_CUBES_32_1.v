...
module FAU ( 
  ...
  nor4   g19(.a(new_n65_), .b(new_n58_), .c(new_n45_), .d(new_n44_), .O(z05));
  nand3  g20(.a(new_n60_), .b(new_n45_), .c(x02), .O(new_n67_));
  nor2   g21(.a(new_n67_), .b(new_n65_), .O(z06));
  inv1   g22(.a(x12), .O(new_n69_));
  nand4  g23(.a(new_n60_), .b(new_n69_), .c(new_n45_), .d(x01), .O(new_n70_));
  ...
  nand4  g44(.a(new_n91_), .b(new_n55_), .c(x22), .d(x21), .O(new_n92_));
  inv1   g45(.a(x13), .O(new_n93_));
  nand3  g46(.a(new_n93_), .b(x12), .c(new_n59_), .O(new_n94_));
  nor2   g47(.a(new_n94_), .b(new_n79_), .O(new_n95_));
  nor2   g48(.a(new_n74_), .b(x14), .O(new_n96_));
  ...
  nand4  g53(.a(new_n84_), .b(x21), .c(x18), .d(x01), .O(new_n101_));
  nand3  g54(.a(new_n87_), .b(x20), .c(new_n75_), .O(new_n102_));
  inv1   g55(.a(new_n102_), .O(new_n103_));
  nand3  g56(.a(new_n103_), .b(new_n96_), .c(new_n95_), .O(new_n104_));
  nand2  g57(.a(new_n88_), .b(new_n86_), .O(new_n105_));
  aoi21  g58(.a(new_n104_), .b(new_n101_), .c(new_n105_), .O(z11));
  nand2  g59(.a(new_n46_), .b(new_n44_), .O(new_n108_));
  nor3   g60(.a(new_n108_), .b(x19), .c(new_n48_), .O(z13));
  nand4  g61(.a(new_n50_), .b(new_n49_), .c(new_n48_), .d(new_n58_), .O(new_n110_));
  nor2   g62(.a(new_n110_), .b(new_n47_), .O(z14));
  aoi21  g63(.a(new_n58_), .b(x01), .c(new_n44_), .O(new_n112_));
  nand3  g64(.a(x19), .b(new_n44_), .c(new_n78_), .O(new_n113_));
  oai21  g65(.a(new_n112_), .b(new_n86_), .c(new_n113_), .O(z15));
  nor2   g66(.a(new_n78_), .b(x00), .O(z16));
  nand2  g67(.a(new_n46_), .b(x02), .O(new_n116_));
