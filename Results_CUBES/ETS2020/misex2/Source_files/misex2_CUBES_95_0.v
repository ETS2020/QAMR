...
module FAU ( 
  ...
  nand4  g44(.a(new_n89_), .b(new_n88_), .c(x12), .d(new_n59_), .O(new_n90_));
  ...
  nand4  g55(.a(new_n100_), .b(new_n56_), .c(new_n93_), .d(x01), .O(new_n101_));
  ...
  nand4  g61(.a(x12), .b(new_n59_), .c(x02), .d(new_n106_), .O(new_n107_));
  ...
  oai21  g65(.a(new_n53_), .b(new_n45_), .c(new_n64_), .O(new_n112_));
