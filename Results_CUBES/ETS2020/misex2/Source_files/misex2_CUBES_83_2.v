...
module FAU ( 
  ...
  nor2   g35(.a(x10), .b(x09), .O(new_n86_));
  nand4  g36(.a(new_n86_), .b(new_n50_), .c(new_n49_), .d(new_n48_), .O(new_n87_));
  nor2   g37(.a(new_n87_), .b(new_n84_), .O(z14));
  inv1   g38(.a(x00), .O(new_n89_));
  aoi21  g39(.a(new_n53_), .b(x01), .c(new_n45_), .O(new_n90_));
  inv1   g40(.a(x01), .O(new_n91_));
  nand3  g41(.a(x19), .b(new_n45_), .c(new_n91_), .O(new_n92_));
  oai21  g42(.a(new_n90_), .b(new_n89_), .c(new_n92_), .O(z15));
  nor2   g43(.a(new_n91_), .b(x00), .O(z16));
