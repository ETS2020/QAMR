...
module FAU ( 
  ...
  nor4   g11(.a(new_n52_), .b(new_n48_), .c(new_n44_), .d(new_n54_), .O(z01));
  ...
  nand3  g19(.a(new_n63_), .b(new_n54_), .c(x02), .O(new_n64_));
  ...
  nand4  g23(.a(new_n67_), .b(new_n60_), .c(x10), .d(new_n54_), .O(new_n68_));
  nor2   g24(.a(new_n68_), .b(new_n66_), .O(z04));
  nor3   g25(.a(new_n66_), .b(new_n44_), .c(new_n54_), .O(z05));
  nand3  g26(.a(new_n61_), .b(new_n54_), .c(x02), .O(new_n71_));
  nor3   g27(.a(new_n71_), .b(new_n46_), .c(new_n45_), .O(z06));
  nand4  g28(.a(new_n61_), .b(new_n67_), .c(new_n54_), .d(x01), .O(new_n73_));
