...
module FAU ( 
  ...
  nand4  g37(.a(new_n85_), .b(new_n84_), .c(x18), .d(x01), .O(new_n86_));
  inv1   g38(.a(x21), .O(new_n87_));
  inv1   g39(.a(x22), .O(new_n88_));
  nand3  g40(.a(new_n88_), .b(new_n87_), .c(new_n53_), .O(new_n89_));
  aoi21  g41(.a(new_n86_), .b(new_n83_), .c(new_n89_), .O(z09));
  oai21  g42(.a(new_n62_), .b(new_n45_), .c(new_n55_), .O(new_n93_));
  oai21  g43(.a(x19), .b(x02), .c(x23), .O(new_n94_));
  nand3  g44(.a(new_n84_), .b(x17), .c(new_n45_), .O(new_n95_));
  nand2  g45(.a(new_n95_), .b(new_n94_), .O(new_n96_));
  nand2  g46(.a(new_n96_), .b(new_n46_), .O(new_n97_));
  inv1   g47(.a(x24), .O(new_n98_));
  nand2  g48(.a(new_n98_), .b(x09), .O(new_n99_));
  aoi21  g49(.a(new_n97_), .b(new_n93_), .c(new_n99_), .O(z12));
  nand2  g50(.a(new_n84_), .b(x17), .O(new_n101_));
  nor2   g51(.a(new_n101_), .b(new_n47_), .O(z13));
  nand3  g52(.a(new_n48_), .b(new_n62_), .c(new_n57_), .O(new_n103_));
  nor2   g53(.a(new_n103_), .b(new_n47_), .O(z14));
  aoi21  g54(.a(new_n62_), .b(x01), .c(new_n45_), .O(new_n105_));
  nand3  g55(.a(x19), .b(new_n45_), .c(new_n54_), .O(new_n106_));
  oai21  g56(.a(new_n105_), .b(new_n53_), .c(new_n106_), .O(z15));
  nor2   g57(.a(new_n54_), .b(x00), .O(z16));
