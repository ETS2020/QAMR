...
module FAU ( 
  ...
  inv1   g33(.a(x18), .O(new_n78_));
  nand4  g34(.a(x19), .b(new_n78_), .c(x17), .d(new_n77_), .O(new_n79_));
  ...
  nand2  g61(.a(new_n99_), .b(new_n62_), .O(new_n107_));
  aoi21  g62(.a(new_n106_), .b(new_n103_), .c(new_n107_), .O(z11));
  oai21  g63(.a(new_n52_), .b(new_n44_), .c(new_n64_), .O(new_n109_));
  oai21  g64(.a(x19), .b(x02), .c(x23), .O(new_n110_));
  nand3  g65(.a(new_n57_), .b(x17), .c(new_n44_), .O(new_n111_));
  nand2  g66(.a(new_n111_), .b(new_n110_), .O(new_n112_));
  nand2  g67(.a(new_n112_), .b(new_n45_), .O(new_n113_));
  inv1   g68(.a(x24), .O(new_n114_));
  nand2  g69(.a(new_n114_), .b(x09), .O(new_n115_));
  aoi21  g70(.a(new_n113_), .b(new_n109_), .c(new_n115_), .O(z12));
  nor3   g71(.a(new_n46_), .b(x19), .c(new_n56_), .O(z13));
  nor2   g72(.a(new_n63_), .b(x00), .O(z16));
  zero   g73(.O(z01));
  zero   g74(.O(z10));
  zero   g75(.O(z14));
  zero   g76(.O(z15));
