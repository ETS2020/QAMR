...
module FAU ( 
  ...
  nand3  g28(.a(new_n62_), .b(new_n45_), .c(x02), .O(new_n73_));
  nor3   g29(.a(new_n73_), .b(new_n65_), .c(new_n64_), .O(z06));
  nand4  g30(.a(new_n62_), .b(new_n69_), .c(new_n45_), .d(x01), .O(new_n75_));
  ...
  nand4  g57(.a(new_n101_), .b(new_n58_), .c(x22), .d(x21), .O(new_n102_));
  inv1   g58(.a(x13), .O(new_n103_));
  nand3  g59(.a(new_n103_), .b(x12), .c(new_n61_), .O(new_n104_));
  ...
  oai21  g72(.a(new_n55_), .b(new_n44_), .c(new_n66_), .O(new_n117_));
  oai21  g73(.a(x19), .b(x02), .c(x23), .O(new_n118_));
  nand3  g74(.a(new_n50_), .b(x17), .c(new_n44_), .O(new_n119_));
  ...
  nor2   g80(.a(new_n56_), .b(new_n47_), .O(z14));
  aoi21  g81(.a(new_n55_), .b(x01), .c(new_n44_), .O(new_n127_));
  nand3  g82(.a(x19), .b(new_n44_), .c(new_n65_), .O(new_n128_));
  oai21  g83(.a(new_n127_), .b(new_n64_), .c(new_n128_), .O(z15));
  zero   g84(.O(z05));
  zero   g85(.O(z13));
  zero   g86(.O(z16));
  zero   g87(.O(z17));
