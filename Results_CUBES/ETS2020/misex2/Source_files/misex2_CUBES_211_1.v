...
module FAU ( 
  ...
  nand4  g51(.a(x12), .b(new_n59_), .c(x02), .d(new_n64_), .O(new_n97_));
  ...
  oai21  g55(.a(new_n53_), .b(new_n45_), .c(new_n65_), .O(new_n102_));
  oai21  g56(.a(x19), .b(x02), .c(x23), .O(new_n103_));
  nand3  g57(.a(new_n50_), .b(x17), .c(new_n45_), .O(new_n104_));
  ...
  nand2  g63(.a(new_n46_), .b(new_n45_), .O(new_n111_));
  nor2   g64(.a(x10), .b(x09), .O(new_n112_));
  nand4  g65(.a(new_n112_), .b(new_n50_), .c(new_n49_), .d(new_n48_), .O(new_n113_));
  nor2   g66(.a(new_n113_), .b(new_n111_), .O(z14));
  aoi21  g67(.a(new_n53_), .b(x01), .c(new_n45_), .O(new_n115_));
  nand3  g68(.a(x19), .b(new_n45_), .c(new_n64_), .O(new_n116_));
  oai21  g69(.a(new_n115_), .b(new_n63_), .c(new_n116_), .O(z15));
  zero   g70(.O(z00));
  zero   g71(.O(z09));
  zero   g72(.O(z11));
  zero   g73(.O(z13));
