...
module FAU ( 
  ...
  nand2  g62(.a(new_n46_), .b(new_n44_), .O(new_n110_));
  nor3   g63(.a(new_n110_), .b(x19), .c(new_n48_), .O(z13));
  nand4  g64(.a(new_n50_), .b(new_n49_), .c(new_n48_), .d(new_n58_), .O(new_n112_));
  nor2   g65(.a(new_n112_), .b(new_n47_), .O(z14));
  aoi21  g66(.a(new_n58_), .b(x01), .c(new_n44_), .O(new_n114_));
  nand3  g67(.a(x19), .b(new_n44_), .c(new_n63_), .O(new_n115_));
  oai21  g68(.a(new_n114_), .b(new_n62_), .c(new_n115_), .O(z15));
  nor2   g69(.a(new_n63_), .b(x00), .O(z16));
  nand2  g70(.a(new_n46_), .b(x02), .O(new_n118_));
  inv1   g71(.a(new_n118_), .O(z17));
  zero   g72(.O(z01));
  zero   g73(.O(z02));
  zero   g74(.O(z08));
  zero   g75(.O(z12));
