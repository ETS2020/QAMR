...
module FAU ( 
  ...
  nand4  g54(.a(new_n99_), .b(new_n55_), .c(x22), .d(x21), .O(new_n100_));
  ...
  oai21  g69(.a(new_n58_), .b(new_n44_), .c(new_n64_), .O(new_n115_));
  ...
  nand3  g80(.a(x19), .b(new_n44_), .c(new_n63_), .O(new_n127_));
  oai21  g81(.a(new_n126_), .b(new_n62_), .c(new_n127_), .O(z15));
  nor2   g82(.a(new_n63_), .b(x00), .O(z16));
  inv1   g83(.a(new_n81_), .O(z17));
  zero   g84(.O(z01));
  zero   g85(.O(z02));
  zero   g86(.O(z13));
endmodule
