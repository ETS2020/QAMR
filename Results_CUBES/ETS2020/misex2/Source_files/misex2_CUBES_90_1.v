// Benchmark "FAU" written by ABC on Tue Jul  7 11:00:49 2020
...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n72_, new_n73_, new_n74_, new_n78_, new_n79_, new_n80_, new_n81_,
    new_n82_, new_n83_, new_n84_, new_n85_, new_n86_, new_n87_, new_n88_,
    new_n89_, new_n90_, new_n91_, new_n96_, new_n98_, new_n99_, new_n100_,
    new_n103_;
  ...
  nor2   g31(.a(x20), .b(new_n78_), .O(new_n79_));
  nand4  g32(.a(new_n79_), .b(new_n59_), .c(x22), .d(x21), .O(new_n80_));
  ...
  nand4  g41(.a(x12), .b(new_n62_), .c(x02), .d(new_n78_), .O(new_n89_));
  ...
  nor3   g45(.a(new_n54_), .b(x19), .c(new_n48_), .O(z13));
  nand4  g46(.a(new_n50_), .b(new_n49_), .c(new_n48_), .d(new_n55_), .O(new_n96_));
  nor2   g47(.a(new_n96_), .b(new_n47_), .O(z14));
  inv1   g48(.a(x00), .O(new_n98_));
  aoi21  g49(.a(new_n55_), .b(x01), .c(new_n44_), .O(new_n99_));
  nand3  g50(.a(x19), .b(new_n44_), .c(new_n78_), .O(new_n100_));
  oai21  g51(.a(new_n99_), .b(new_n98_), .c(new_n100_), .O(z15));
  nor2   g52(.a(new_n78_), .b(x00), .O(z16));
  nand2  g53(.a(new_n46_), .b(x02), .O(new_n103_));
  inv1   g54(.a(new_n103_), .O(z17));
  zero   g55(.O(z01));
  zero   g56(.O(z04));
  zero   g57(.O(z08));
  zero   g58(.O(z09));
