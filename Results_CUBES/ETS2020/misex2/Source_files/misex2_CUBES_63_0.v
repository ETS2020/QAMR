// Benchmark "FAU" written by ABC on Tue Jul  7 11:00:38 2020
...
module FAU ( 
  ...
  nand2  g35(.a(x02), .b(new_n64_), .O(new_n82_));
  ...
  nand3  g44(.a(new_n90_), .b(new_n89_), .c(new_n63_), .O(new_n91_));
  aoi21  g45(.a(new_n88_), .b(new_n86_), .c(new_n91_), .O(z09));
  nor2   g46(.a(x20), .b(new_n64_), .O(new_n93_));
  nand4  g47(.a(new_n93_), .b(new_n56_), .c(x22), .d(x21), .O(new_n94_));
  ...
  nand2  g60(.a(new_n90_), .b(new_n63_), .O(new_n107_));
  aoi21  g61(.a(new_n106_), .b(new_n103_), .c(new_n107_), .O(z11));
  oai21  g62(.a(new_n53_), .b(new_n45_), .c(new_n65_), .O(new_n109_));
  oai21  g63(.a(x19), .b(x02), .c(x23), .O(new_n110_));
  nand3  g64(.a(new_n50_), .b(x17), .c(new_n45_), .O(new_n111_));
  ...
  nand2  g70(.a(new_n46_), .b(new_n45_), .O(new_n118_));
  nor2   g71(.a(x10), .b(x09), .O(new_n119_));
  nand4  g72(.a(new_n119_), .b(new_n50_), .c(new_n49_), .d(new_n48_), .O(new_n120_));
  nor2   g73(.a(new_n120_), .b(new_n118_), .O(z14));
  aoi21  g74(.a(new_n53_), .b(x01), .c(new_n45_), .O(new_n122_));
  nand3  g75(.a(x19), .b(new_n45_), .c(new_n64_), .O(new_n123_));
  oai21  g76(.a(new_n122_), .b(new_n63_), .c(new_n123_), .O(z15));
