...
module FAU ( 
  ...
  nor2   g30(.a(new_n48_), .b(new_n59_), .O(new_n78_));
  ...
  nand4  g41(.a(x12), .b(new_n62_), .c(x02), .d(new_n59_), .O(new_n89_));
  ...
  inv1   g45(.a(x02), .O(new_n94_));
  oai21  g46(.a(new_n54_), .b(new_n94_), .c(new_n60_), .O(new_n95_));
  oai21  g47(.a(x19), .b(x02), .c(x23), .O(new_n96_));
  nand3  g48(.a(new_n49_), .b(x17), .c(new_n94_), .O(new_n97_));
  ...
  aoi21  g57(.a(new_n54_), .b(x01), .c(new_n94_), .O(new_n106_));
  nand3  g58(.a(x19), .b(new_n94_), .c(new_n59_), .O(new_n107_));
