...
module FAU ( 
  ...
  wire new_n46_, new_n47_, new_n48_, new_n49_, new_n50_, new_n51_, new_n53_,
    ...
    new_n97_, new_n101_, new_n103_, new_n104_;
  ...
  nand4  g36(.a(new_n84_), .b(x21), .c(x18), .d(x01), .O(new_n85_));
  inv1   g37(.a(x16), .O(new_n86_));
  inv1   g38(.a(x21), .O(new_n87_));
  nand4  g39(.a(new_n87_), .b(x20), .c(new_n86_), .d(x15), .O(new_n88_));
  inv1   g40(.a(new_n88_), .O(new_n89_));
  nor2   g41(.a(new_n46_), .b(x01), .O(new_n90_));
  inv1   g42(.a(x13), .O(new_n91_));
  inv1   g43(.a(x14), .O(new_n92_));
  nand4  g44(.a(new_n92_), .b(new_n91_), .c(x12), .d(new_n57_), .O(new_n93_));
  inv1   g45(.a(new_n93_), .O(new_n94_));
  nand3  g46(.a(new_n94_), .b(new_n90_), .c(new_n89_), .O(new_n95_));
  inv1   g47(.a(x22), .O(new_n96_));
  nand2  g48(.a(new_n96_), .b(new_n67_), .O(new_n97_));
  aoi21  g49(.a(new_n95_), .b(new_n85_), .c(new_n97_), .O(z11));
  nor3   g50(.a(new_n48_), .b(x19), .c(new_n54_), .O(z13));
  nand3  g51(.a(new_n50_), .b(new_n49_), .c(new_n60_), .O(new_n101_));
  nor2   g52(.a(new_n101_), .b(new_n48_), .O(z14));
  aoi21  g53(.a(new_n49_), .b(x01), .c(new_n46_), .O(new_n103_));
  nand3  g54(.a(x19), .b(new_n46_), .c(new_n68_), .O(new_n104_));
  oai21  g55(.a(new_n103_), .b(new_n67_), .c(new_n104_), .O(z15));
  inv1   g56(.a(new_n78_), .O(z17));
  zero   g57(.O(z00));
  zero   g58(.O(z01));
  zero   g59(.O(z05));
  zero   g60(.O(z09));
