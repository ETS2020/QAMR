...
module FAU ( 
  ...
  nand4  g55(.a(new_n100_), .b(new_n99_), .c(new_n48_), .d(x18), .O(new_n101_));
  inv1   g56(.a(x13), .O(new_n102_));
  nand3  g57(.a(new_n102_), .b(x12), .c(new_n58_), .O(new_n103_));
  ...
  oai21  g70(.a(new_n57_), .b(new_n44_), .c(new_n63_), .O(new_n116_));
  oai21  g71(.a(x19), .b(x02), .c(x23), .O(new_n117_));
  nand3  g72(.a(new_n48_), .b(x17), .c(new_n44_), .O(new_n118_));
  ...
  nor3   g78(.a(new_n46_), .b(x19), .c(new_n55_), .O(z13));
  aoi21  g79(.a(new_n57_), .b(x01), .c(new_n44_), .O(new_n126_));
  nand3  g80(.a(x19), .b(new_n44_), .c(new_n62_), .O(new_n127_));
  oai21  g81(.a(new_n126_), .b(new_n61_), .c(new_n127_), .O(z15));
