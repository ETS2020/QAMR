...
module FAU ( 
  ...
  nand4  g09(.a(new_n54_), .b(new_n46_), .c(new_n52_), .d(new_n45_), .O(new_n55_));
  ...
  oai21  g19(.a(new_n64_), .b(new_n59_), .c(new_n55_), .O(z03));
  ...
  nand4  g31(.a(x19), .b(new_n53_), .c(x17), .d(new_n76_), .O(new_n77_));
  ...
  nor3   g59(.a(new_n47_), .b(x19), .c(new_n52_), .O(z13));
  nand3  g60(.a(new_n48_), .b(new_n56_), .c(new_n60_), .O(new_n108_));
  nor2   g61(.a(new_n108_), .b(new_n47_), .O(z14));
  aoi21  g62(.a(new_n56_), .b(x01), .c(new_n45_), .O(new_n110_));
  nand3  g63(.a(x19), .b(new_n45_), .c(new_n62_), .O(new_n111_));
