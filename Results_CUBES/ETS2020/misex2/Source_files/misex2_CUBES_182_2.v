...
module FAU ( 
  ...
  nor2   g36(.a(new_n44_), .b(x01), .O(new_n85_));
  inv1   g37(.a(x13), .O(new_n86_));
  inv1   g38(.a(x14), .O(new_n87_));
  nand4  g39(.a(new_n87_), .b(new_n86_), .c(x12), .d(new_n63_), .O(new_n88_));
  inv1   g40(.a(new_n88_), .O(new_n89_));
  nand3  g41(.a(new_n89_), .b(new_n85_), .c(new_n84_), .O(new_n90_));
  inv1   g42(.a(x22), .O(new_n91_));
  nand2  g43(.a(new_n91_), .b(new_n59_), .O(new_n92_));
  aoi21  g44(.a(new_n90_), .b(new_n80_), .c(new_n92_), .O(z11));
  oai21  g45(.a(new_n55_), .b(new_n44_), .c(new_n61_), .O(new_n94_));
  oai21  g46(.a(x19), .b(x02), .c(x23), .O(new_n95_));
  nand3  g47(.a(new_n50_), .b(x17), .c(new_n44_), .O(new_n96_));
  ...
  nor2   g53(.a(new_n56_), .b(new_n47_), .O(z14));
  aoi21  g54(.a(new_n55_), .b(x01), .c(new_n44_), .O(new_n104_));
  nand3  g55(.a(x19), .b(new_n44_), .c(new_n60_), .O(new_n105_));
  oai21  g56(.a(new_n104_), .b(new_n59_), .c(new_n105_), .O(z15));
  nor2   g57(.a(new_n60_), .b(x00), .O(z16));
  inv1   g58(.a(new_n74_), .O(z17));
  zero   g59(.O(z03));
  zero   g60(.O(z06));
  zero   g61(.O(z07));
  zero   g62(.O(z09));
