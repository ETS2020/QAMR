...
module FAU ( 
  ...
  nand2  g10(.a(new_n54_), .b(x18), .O(new_n55_));
  inv1   g11(.a(x17), .O(new_n56_));
  nand3  g12(.a(new_n45_), .b(new_n56_), .c(new_n44_), .O(new_n57_));
  ...
  oai22  g20(.a(new_n64_), .b(new_n61_), .c(new_n57_), .d(new_n55_), .O(z03));
  nor4   g21(.a(new_n62_), .b(new_n58_), .c(new_n47_), .d(new_n44_), .O(z05));
  ...
  nand2  g32(.a(new_n45_), .b(x02), .O(new_n78_));
  inv1   g33(.a(x18), .O(new_n79_));
  nand3  g34(.a(x19), .b(new_n79_), .c(x17), .O(new_n80_));
  nor3   g35(.a(new_n80_), .b(new_n78_), .c(new_n77_), .O(z08));
  ...
  inv1   g40(.a(x01), .O(new_n86_));
  nand2  g41(.a(x02), .b(new_n86_), .O(new_n87_));
  inv1   g42(.a(new_n87_), .O(new_n88_));
  nor2   g43(.a(new_n70_), .b(x11), .O(new_n89_));
  nor2   g44(.a(x14), .b(x13), .O(new_n90_));
  nand4  g45(.a(new_n90_), .b(new_n89_), .c(new_n88_), .d(new_n85_), .O(new_n91_));
  ...
  nor2   g53(.a(x20), .b(new_n86_), .O(new_n99_));
  nor2   g54(.a(new_n96_), .b(new_n95_), .O(new_n100_));
  nand4  g55(.a(new_n100_), .b(new_n99_), .c(new_n54_), .d(x18), .O(new_n101_));
  inv1   g56(.a(x13), .O(new_n102_));
  nand3  g57(.a(new_n102_), .b(x12), .c(new_n59_), .O(new_n103_));
  nor2   g58(.a(new_n103_), .b(new_n87_), .O(new_n104_));
  nor2   g59(.a(new_n82_), .b(x14), .O(new_n105_));
  ...
  nand4  g64(.a(new_n92_), .b(x21), .c(x18), .d(x01), .O(new_n110_));
  nand3  g65(.a(new_n95_), .b(x20), .c(new_n83_), .O(new_n111_));
  inv1   g66(.a(new_n111_), .O(new_n112_));
  nand3  g67(.a(new_n112_), .b(new_n105_), .c(new_n104_), .O(new_n113_));
  nand2  g68(.a(new_n96_), .b(new_n94_), .O(new_n114_));
  aoi21  g69(.a(new_n113_), .b(new_n110_), .c(new_n114_), .O(z11));
  oai21  g70(.a(new_n58_), .b(new_n44_), .c(new_n63_), .O(new_n116_));
  oai21  g71(.a(x19), .b(x02), .c(x23), .O(new_n117_));
  nand3  g72(.a(new_n54_), .b(x17), .c(new_n44_), .O(new_n118_));
  ...
  nor3   g78(.a(new_n46_), .b(x19), .c(new_n56_), .O(z13));
  aoi21  g79(.a(new_n58_), .b(x01), .c(new_n44_), .O(new_n126_));
  nand3  g80(.a(x19), .b(new_n44_), .c(new_n86_), .O(new_n127_));
  oai21  g81(.a(new_n126_), .b(new_n94_), .c(new_n127_), .O(z15));
  nor2   g82(.a(new_n86_), .b(x00), .O(z16));
  inv1   g83(.a(new_n78_), .O(z17));
  zero   g84(.O(z02));
  zero   g85(.O(z04));
  zero   g86(.O(z14));
endmodule
