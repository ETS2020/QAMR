...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    new_n51_, new_n52_, new_n55_, new_n57_, new_n58_, new_n59_, new_n60_,
  ...
  nor2   g12(.a(x19), .b(new_n50_), .O(new_n57_));
  inv1   g13(.a(new_n57_), .O(new_n58_));
  nand4  g14(.a(new_n49_), .b(new_n47_), .c(new_n46_), .d(new_n45_), .O(new_n59_));
  inv1   g15(.a(x11), .O(new_n60_));
  nor2   g16(.a(new_n60_), .b(new_n44_), .O(new_n61_));
  nand2  g17(.a(new_n61_), .b(x12), .O(new_n62_));
  nor2   g18(.a(new_n46_), .b(new_n45_), .O(new_n63_));
  nand3  g19(.a(new_n63_), .b(new_n55_), .c(x02), .O(new_n64_));
  oai22  g20(.a(new_n64_), .b(new_n62_), .c(new_n59_), .d(new_n58_), .O(z03));
  nand2  g21(.a(new_n63_), .b(x02), .O(new_n66_));
  inv1   g22(.a(x12), .O(new_n67_));
  nand4  g23(.a(new_n67_), .b(new_n60_), .c(x10), .d(new_n55_), .O(new_n68_));
  nor2   g24(.a(new_n68_), .b(new_n66_), .O(z04));
  nor3   g25(.a(new_n66_), .b(new_n44_), .c(new_n55_), .O(z05));
  nand3  g26(.a(new_n61_), .b(new_n55_), .c(x02), .O(new_n71_));
  nor3   g27(.a(new_n71_), .b(new_n46_), .c(new_n45_), .O(z06));
  nand4  g28(.a(new_n61_), .b(new_n67_), .c(new_n55_), .d(x01), .O(new_n73_));
  ...
  nor2   g37(.a(new_n67_), .b(x11), .O(new_n83_));
  ...
  nand3  g44(.a(new_n89_), .b(new_n88_), .c(new_n45_), .O(new_n90_));
  aoi21  g45(.a(new_n87_), .b(new_n85_), .c(new_n90_), .O(z09));
  nor2   g46(.a(x20), .b(new_n46_), .O(new_n92_));
  nand4  g47(.a(new_n92_), .b(new_n57_), .c(x22), .d(x21), .O(new_n93_));
  inv1   g48(.a(x13), .O(new_n94_));
  nand3  g49(.a(new_n94_), .b(x12), .c(new_n60_), .O(new_n95_));
  ...
  nand2  g60(.a(new_n89_), .b(new_n45_), .O(new_n106_));
  aoi21  g61(.a(new_n105_), .b(new_n102_), .c(new_n106_), .O(z11));
  nor3   g62(.a(new_n48_), .b(x19), .c(new_n49_), .O(z13));
  zero   g63(.O(z01));
  zero   g64(.O(z08));
  zero   g65(.O(z12));
  zero   g66(.O(z14));
