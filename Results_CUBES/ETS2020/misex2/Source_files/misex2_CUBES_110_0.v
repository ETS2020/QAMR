...
module FAU ( 
  ...
  nand2  g42(.a(x02), .b(new_n86_), .O(new_n89_));
  ...
  inv1   g59(.a(x00), .O(new_n106_));
  nand2  g60(.a(new_n96_), .b(new_n106_), .O(new_n107_));
  aoi21  g61(.a(new_n105_), .b(new_n101_), .c(new_n107_), .O(z11));
  oai21  g62(.a(new_n55_), .b(new_n44_), .c(new_n66_), .O(new_n109_));
