...
module FAU ( 
  ...
  nand4  g43(.a(new_n85_), .b(x21), .c(x18), .d(x01), .O(new_n92_));
  nand4  g44(.a(new_n87_), .b(x20), .c(new_n76_), .d(x15), .O(new_n93_));
  inv1   g45(.a(new_n93_), .O(new_n94_));
  nand3  g46(.a(new_n94_), .b(new_n83_), .c(new_n79_), .O(new_n95_));
  nand2  g47(.a(new_n88_), .b(new_n67_), .O(new_n96_));
  aoi21  g48(.a(new_n95_), .b(new_n92_), .c(new_n96_), .O(z11));
  nor3   g49(.a(new_n48_), .b(x19), .c(new_n54_), .O(z13));
  nand3  g50(.a(new_n50_), .b(new_n49_), .c(new_n60_), .O(new_n100_));
  nor2   g51(.a(new_n100_), .b(new_n48_), .O(z14));
  aoi21  g52(.a(new_n49_), .b(x01), .c(new_n46_), .O(new_n102_));
  nand3  g53(.a(x19), .b(new_n46_), .c(new_n68_), .O(new_n103_));
  oai21  g54(.a(new_n102_), .b(new_n67_), .c(new_n103_), .O(z15));
  nand2  g55(.a(new_n47_), .b(x02), .O(new_n106_));
