...
module FAU ( 
  ...
  nor3   g49(.a(new_n46_), .b(x19), .c(new_n47_), .O(z13));
  aoi21  g50(.a(new_n50_), .b(x01), .c(new_n44_), .O(new_n101_));
  nand3  g51(.a(x19), .b(new_n44_), .c(new_n62_), .O(new_n102_));
  oai21  g52(.a(new_n101_), .b(new_n61_), .c(new_n102_), .O(z15));
  nor2   g53(.a(new_n62_), .b(x00), .O(z16));
