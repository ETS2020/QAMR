...
module FAU ( 
  ...
  oai21  g66(.a(new_n61_), .b(new_n44_), .c(new_n67_), .O(new_n112_));
  ...
  nand4  g74(.a(new_n50_), .b(new_n49_), .c(new_n48_), .d(new_n61_), .O(new_n121_));
  nor2   g75(.a(new_n121_), .b(new_n47_), .O(z14));
  aoi21  g76(.a(new_n61_), .b(x01), .c(new_n44_), .O(new_n123_));
  nand3  g77(.a(x19), .b(new_n44_), .c(new_n66_), .O(new_n124_));
  oai21  g78(.a(new_n123_), .b(new_n65_), .c(new_n124_), .O(z15));
  nor2   g79(.a(new_n66_), .b(x00), .O(z16));
  nand2  g80(.a(new_n46_), .b(x02), .O(new_n127_));
