...
module FAU ( 
  ...
  nand2  g33(.a(x02), .b(new_n64_), .O(new_n81_));
  inv1   g34(.a(new_n81_), .O(new_n82_));
  nor2   g35(.a(new_n72_), .b(x11), .O(new_n83_));
  ...
  nand3  g42(.a(new_n89_), .b(new_n88_), .c(new_n63_), .O(new_n90_));
  aoi21  g43(.a(new_n87_), .b(new_n85_), .c(new_n90_), .O(z09));
  nor2   g44(.a(x20), .b(new_n64_), .O(new_n92_));
  nand4  g45(.a(new_n92_), .b(new_n56_), .c(x22), .d(x21), .O(new_n93_));
  ...
  nand2  g58(.a(new_n89_), .b(new_n63_), .O(new_n106_));
  aoi21  g59(.a(new_n105_), .b(new_n102_), .c(new_n106_), .O(z11));
  oai21  g60(.a(new_n53_), .b(new_n45_), .c(new_n65_), .O(new_n108_));
  oai21  g61(.a(x19), .b(x02), .c(x23), .O(new_n109_));
  nand3  g62(.a(new_n50_), .b(x17), .c(new_n45_), .O(new_n110_));
  ...
  nor2   g70(.a(x10), .b(x09), .O(new_n118_));
  nand4  g71(.a(new_n118_), .b(new_n50_), .c(new_n49_), .d(new_n48_), .O(new_n119_));
  nor2   g72(.a(new_n119_), .b(new_n116_), .O(z14));
  nor2   g73(.a(new_n64_), .b(x00), .O(z16));
  nand2  g74(.a(new_n46_), .b(x02), .O(new_n123_));
