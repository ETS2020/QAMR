...
module FAU ( 
  ...
  nand2  g34(.a(new_n47_), .b(x02), .O(new_n80_));
  ...
  nand2  g42(.a(x02), .b(new_n62_), .O(new_n88_));
  ...
  nor2   g53(.a(x20), .b(new_n62_), .O(new_n99_));
  nor2   g54(.a(new_n96_), .b(new_n95_), .O(new_n100_));
  nand4  g55(.a(new_n100_), .b(new_n99_), .c(new_n53_), .d(x18), .O(new_n101_));
  inv1   g56(.a(x13), .O(new_n102_));
  nand3  g57(.a(new_n102_), .b(x12), .c(new_n57_), .O(new_n103_));
  ...
  nand2  g68(.a(new_n96_), .b(new_n61_), .O(new_n114_));
  aoi21  g69(.a(new_n113_), .b(new_n110_), .c(new_n114_), .O(z11));
  nand3  g70(.a(new_n50_), .b(new_n49_), .c(new_n60_), .O(new_n118_));
  nor2   g71(.a(new_n118_), .b(new_n48_), .O(z14));
  inv1   g72(.a(new_n80_), .O(z17));
  zero   g73(.O(z00));
  zero   g74(.O(z01));
  zero   g75(.O(z12));
  zero   g76(.O(z13));
