...
module FAU ( 
  ...
  nor4   g22(.a(new_n65_), .b(x12), .c(x11), .d(new_n61_), .O(z04));
  ...
  nand2  g42(.a(x02), .b(new_n70_), .O(new_n88_));
  inv1   g43(.a(new_n88_), .O(new_n89_));
  nor2   g44(.a(new_n73_), .b(x11), .O(new_n90_));
  ...
  nor2   g53(.a(x20), .b(new_n70_), .O(new_n99_));
  nand4  g54(.a(new_n99_), .b(new_n58_), .c(x22), .d(x21), .O(new_n100_));
  inv1   g55(.a(x13), .O(new_n101_));
  nand3  g56(.a(new_n101_), .b(x12), .c(new_n62_), .O(new_n102_));
  ...
  nand2  g67(.a(new_n96_), .b(new_n69_), .O(new_n113_));
  aoi21  g68(.a(new_n112_), .b(new_n109_), .c(new_n113_), .O(z11));
  nor3   g69(.a(new_n53_), .b(x19), .c(new_n48_), .O(z13));
  nand4  g70(.a(new_n50_), .b(new_n49_), .c(new_n48_), .d(new_n61_), .O(new_n117_));
  nor2   g71(.a(new_n117_), .b(new_n47_), .O(z14));
  nor2   g72(.a(new_n70_), .b(x00), .O(z16));
  inv1   g73(.a(new_n81_), .O(z17));
  zero   g74(.O(z02));
  zero   g75(.O(z05));
  zero   g76(.O(z12));
  zero   g77(.O(z15));
