...
module FAU ( 
  ...
  nand4  g37(.a(new_n83_), .b(new_n82_), .c(x12), .d(new_n63_), .O(new_n84_));
  ...
  nand4  g46(.a(new_n87_), .b(x21), .c(x18), .d(x01), .O(new_n94_));
  nand4  g47(.a(new_n89_), .b(x20), .c(new_n78_), .d(x15), .O(new_n95_));
  inv1   g48(.a(new_n95_), .O(new_n96_));
  nand3  g49(.a(new_n96_), .b(new_n85_), .c(new_n81_), .O(new_n97_));
  nand2  g50(.a(new_n90_), .b(new_n59_), .O(new_n98_));
  aoi21  g51(.a(new_n97_), .b(new_n94_), .c(new_n98_), .O(z11));
  oai21  g52(.a(new_n55_), .b(new_n44_), .c(new_n61_), .O(new_n100_));
  oai21  g53(.a(x19), .b(x02), .c(x23), .O(new_n101_));
  nand3  g54(.a(new_n50_), .b(x17), .c(new_n44_), .O(new_n102_));
  nand2  g55(.a(new_n102_), .b(new_n101_), .O(new_n103_));
  nand2  g56(.a(new_n103_), .b(new_n46_), .O(new_n104_));
  ...
  aoi21  g61(.a(new_n55_), .b(x01), .c(new_n44_), .O(new_n110_));
  nand3  g62(.a(x19), .b(new_n44_), .c(new_n60_), .O(new_n111_));
  oai21  g63(.a(new_n110_), .b(new_n59_), .c(new_n111_), .O(z15));
  nor2   g64(.a(new_n60_), .b(x00), .O(z16));
  inv1   g65(.a(new_n74_), .O(z17));
  zero   g66(.O(z03));
  zero   g67(.O(z06));
  zero   g68(.O(z07));
  zero   g69(.O(z10));
