...
module FAU ( 
  ...
  nand2  g31(.a(x02), .b(new_n58_), .O(new_n80_));
  inv1   g32(.a(x13), .O(new_n81_));
  nand3  g33(.a(new_n81_), .b(x12), .c(new_n62_), .O(new_n82_));
  nor2   g34(.a(new_n82_), .b(new_n80_), .O(new_n83_));
  inv1   g35(.a(x15), .O(new_n84_));
  nor2   g36(.a(new_n84_), .b(x14), .O(new_n85_));
  inv1   g37(.a(x21), .O(new_n86_));
  inv1   g38(.a(x22), .O(new_n87_));
  nand4  g39(.a(new_n87_), .b(new_n86_), .c(x20), .d(x16), .O(new_n88_));
  inv1   g40(.a(new_n88_), .O(new_n89_));
  nand3  g41(.a(new_n89_), .b(new_n85_), .c(new_n83_), .O(new_n90_));
  aoi21  g42(.a(new_n90_), .b(new_n79_), .c(x00), .O(z10));
  nand3  g43(.a(new_n78_), .b(new_n77_), .c(x21), .O(new_n92_));
  inv1   g44(.a(x16), .O(new_n93_));
  nand3  g45(.a(new_n86_), .b(x20), .c(new_n93_), .O(new_n94_));
  inv1   g46(.a(new_n94_), .O(new_n95_));
  nand3  g47(.a(new_n95_), .b(new_n85_), .c(new_n83_), .O(new_n96_));
  nand2  g48(.a(new_n87_), .b(new_n57_), .O(new_n97_));
  aoi21  g49(.a(new_n96_), .b(new_n92_), .c(new_n97_), .O(z11));
  ...
  aoi21  g58(.a(new_n53_), .b(x01), .c(new_n45_), .O(new_n109_));
  nand3  g59(.a(x19), .b(new_n45_), .c(new_n58_), .O(new_n110_));
  oai21  g60(.a(new_n109_), .b(new_n57_), .c(new_n110_), .O(z15));
  nor2   g61(.a(new_n58_), .b(x00), .O(z16));
  inv1   g62(.a(new_n73_), .O(z17));
  zero   g63(.O(z00));
  zero   g64(.O(z03));
  zero   g65(.O(z06));
  zero   g66(.O(z07));
