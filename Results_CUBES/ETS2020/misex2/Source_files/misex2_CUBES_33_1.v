...
module FAU ( 
  ...
  nor4   g23(.a(new_n68_), .b(new_n55_), .c(new_n45_), .d(new_n44_), .O(z05));
  ...
  nand4  g55(.a(new_n100_), .b(new_n59_), .c(x22), .d(x21), .O(new_n101_));
  ...
  nor3   g70(.a(new_n54_), .b(x19), .c(new_n48_), .O(z13));
  nand4  g71(.a(new_n50_), .b(new_n49_), .c(new_n48_), .d(new_n55_), .O(new_n118_));
  nor2   g72(.a(new_n118_), .b(new_n47_), .O(z14));
  aoi21  g73(.a(new_n55_), .b(x01), .c(new_n44_), .O(new_n120_));
