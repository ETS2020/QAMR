...
module FAU ( 
  ...
  nand3  g49(.a(new_n51_), .b(x17), .c(new_n44_), .O(new_n98_));
  nand2  g50(.a(new_n98_), .b(new_n97_), .O(new_n99_));
  nand2  g51(.a(new_n99_), .b(new_n45_), .O(new_n100_));
  inv1   g52(.a(x24), .O(new_n101_));
  nand2  g53(.a(new_n101_), .b(x09), .O(new_n102_));
  aoi21  g54(.a(new_n100_), .b(new_n96_), .c(new_n102_), .O(z12));
  nor3   g55(.a(new_n46_), .b(x19), .c(new_n49_), .O(z13));
  inv1   g56(.a(x10), .O(new_n106_));
  aoi21  g57(.a(new_n106_), .b(x01), .c(new_n44_), .O(new_n107_));
  inv1   g58(.a(x01), .O(new_n108_));
  nand3  g59(.a(x19), .b(new_n44_), .c(new_n108_), .O(new_n109_));
  oai21  g60(.a(new_n107_), .b(new_n83_), .c(new_n109_), .O(z15));
  nor2   g61(.a(new_n108_), .b(x00), .O(z16));
  inv1   g62(.a(new_n67_), .O(z17));
  zero   g63(.O(z02));
  zero   g64(.O(z03));
  zero   g65(.O(z06));
  zero   g66(.O(z07));
