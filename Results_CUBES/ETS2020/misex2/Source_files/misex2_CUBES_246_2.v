...
module FAU ( 
  ...
  inv1   g23(.a(x01), .O(new_n72_));
  nor2   g24(.a(new_n49_), .b(new_n72_), .O(new_n73_));
  nor2   g25(.a(x20), .b(x19), .O(new_n74_));
  nand4  g26(.a(new_n74_), .b(new_n73_), .c(x22), .d(x21), .O(new_n75_));
  nand2  g27(.a(x02), .b(new_n72_), .O(new_n76_));
  ...
  inv1   g45(.a(x00), .O(new_n94_));
  nand2  g46(.a(new_n84_), .b(new_n94_), .O(new_n95_));
  aoi21  g47(.a(new_n93_), .b(new_n89_), .c(new_n95_), .O(z11));
  nand2  g48(.a(new_n46_), .b(new_n45_), .O(new_n98_));
  nor3   g49(.a(new_n98_), .b(x19), .c(new_n48_), .O(z13));
  nor2   g50(.a(x10), .b(x09), .O(new_n100_));
  nand4  g51(.a(new_n100_), .b(new_n50_), .c(new_n49_), .d(new_n48_), .O(new_n101_));
  nor2   g52(.a(new_n101_), .b(new_n98_), .O(z14));
  aoi21  g53(.a(new_n53_), .b(x01), .c(new_n45_), .O(new_n103_));
  nand3  g54(.a(x19), .b(new_n45_), .c(new_n72_), .O(new_n104_));
  oai21  g55(.a(new_n103_), .b(new_n94_), .c(new_n104_), .O(z15));
  nor2   g56(.a(new_n72_), .b(x00), .O(z16));
