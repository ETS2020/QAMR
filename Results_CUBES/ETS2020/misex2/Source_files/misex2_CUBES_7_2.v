...
module FAU ( 
  ...
  nand2  g16(.a(x10), .b(new_n47_), .O(new_n61_));
  nor4   g17(.a(new_n61_), .b(new_n60_), .c(x12), .d(x11), .O(z04));
  nor3   g18(.a(new_n60_), .b(new_n56_), .c(new_n47_), .O(z05));
  inv1   g19(.a(x08), .O(new_n66_));
  nand4  g20(.a(x19), .b(new_n50_), .c(x17), .d(new_n66_), .O(new_n67_));
  inv1   g21(.a(x05), .O(new_n68_));
  nor2   g22(.a(x07), .b(x06), .O(new_n69_));
  nand3  g23(.a(new_n69_), .b(new_n68_), .c(x04), .O(new_n70_));
  inv1   g24(.a(x03), .O(new_n71_));
  nand4  g25(.a(new_n71_), .b(x02), .c(new_n45_), .d(new_n44_), .O(new_n72_));
  nor3   g26(.a(new_n72_), .b(new_n70_), .c(new_n67_), .O(z08));
  ...
  nor2   g31(.a(new_n46_), .b(x01), .O(new_n78_));
  inv1   g32(.a(x11), .O(new_n79_));
  inv1   g33(.a(x13), .O(new_n80_));
  inv1   g34(.a(x14), .O(new_n81_));
  nand4  g35(.a(new_n81_), .b(new_n80_), .c(x12), .d(new_n79_), .O(new_n82_));
  inv1   g36(.a(new_n82_), .O(new_n83_));
  nand3  g37(.a(new_n83_), .b(new_n78_), .c(new_n77_), .O(new_n84_));
  ...
  nand3  g42(.a(new_n88_), .b(new_n87_), .c(new_n44_), .O(new_n89_));
  aoi21  g43(.a(new_n86_), .b(new_n84_), .c(new_n89_), .O(z09));
  nand4  g44(.a(new_n85_), .b(x21), .c(x18), .d(x01), .O(new_n92_));
  nand4  g45(.a(new_n87_), .b(x20), .c(new_n75_), .d(x15), .O(new_n93_));
  inv1   g46(.a(new_n93_), .O(new_n94_));
  nand3  g47(.a(new_n94_), .b(new_n83_), .c(new_n78_), .O(new_n95_));
  nand2  g48(.a(new_n88_), .b(new_n44_), .O(new_n96_));
  aoi21  g49(.a(new_n95_), .b(new_n92_), .c(new_n96_), .O(z11));
  nor2   g50(.a(new_n57_), .b(new_n48_), .O(z14));
  aoi21  g51(.a(new_n56_), .b(x01), .c(new_n46_), .O(new_n101_));
  nand3  g52(.a(x19), .b(new_n46_), .c(new_n45_), .O(new_n102_));
  oai21  g53(.a(new_n101_), .b(new_n44_), .c(new_n102_), .O(z15));
  nor2   g54(.a(new_n45_), .b(x00), .O(z16));
  zero   g55(.O(z03));
  zero   g56(.O(z06));
  zero   g57(.O(z07));
  zero   g58(.O(z10));
