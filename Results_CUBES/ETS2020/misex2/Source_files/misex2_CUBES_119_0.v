...
module FAU ( 
  ...
  nand4  g33(.a(x19), .b(new_n48_), .c(x17), .d(new_n78_), .O(new_n79_));
  ...
  nand3  g38(.a(new_n60_), .b(new_n83_), .c(x02), .O(new_n84_));
  nor3   g39(.a(new_n84_), .b(new_n82_), .c(new_n79_), .O(z08));
  nor2   g40(.a(x20), .b(new_n66_), .O(new_n87_));
  nand4  g41(.a(new_n87_), .b(new_n57_), .c(x22), .d(x21), .O(new_n88_));
  ...
  nand3  g54(.a(new_n87_), .b(new_n57_), .c(x21), .O(new_n101_));
  ...
  oai21  g61(.a(new_n54_), .b(new_n59_), .c(new_n67_), .O(new_n108_));
  oai21  g62(.a(x19), .b(x02), .c(x23), .O(new_n109_));
  nand3  g63(.a(new_n49_), .b(x17), .c(new_n59_), .O(new_n110_));
  ...
  nor2   g69(.a(x19), .b(new_n47_), .O(new_n116_));
  and2   g70(.a(new_n116_), .b(new_n45_), .O(z13));
