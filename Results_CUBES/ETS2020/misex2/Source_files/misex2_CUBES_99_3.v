...
module FAU ( 
  ...
  nand2  g46(.a(x02), .b(new_n66_), .O(new_n91_));
  ...
  nor2   g57(.a(x20), .b(new_n66_), .O(new_n102_));
  nand4  g58(.a(new_n102_), .b(new_n58_), .c(x22), .d(x21), .O(new_n103_));
  inv1   g59(.a(x13), .O(new_n104_));
  nand3  g60(.a(new_n104_), .b(x12), .c(new_n62_), .O(new_n105_));
  ...
  nand2  g71(.a(new_n99_), .b(new_n65_), .O(new_n116_));
  aoi21  g72(.a(new_n115_), .b(new_n112_), .c(new_n116_), .O(z11));
  oai21  g73(.a(new_n61_), .b(new_n44_), .c(new_n67_), .O(new_n118_));
  oai21  g74(.a(x19), .b(x02), .c(x23), .O(new_n119_));
  nand3  g75(.a(new_n50_), .b(x17), .c(new_n44_), .O(new_n120_));
  ...
  nor3   g81(.a(new_n53_), .b(x19), .c(new_n48_), .O(z13));
  nand4  g82(.a(new_n50_), .b(new_n49_), .c(new_n48_), .d(new_n61_), .O(new_n127_));
  nor2   g83(.a(new_n127_), .b(new_n47_), .O(z14));
  aoi21  g84(.a(new_n61_), .b(x01), .c(new_n44_), .O(new_n129_));
  nand3  g85(.a(x19), .b(new_n44_), .c(new_n66_), .O(new_n130_));
  oai21  g86(.a(new_n129_), .b(new_n65_), .c(new_n130_), .O(z15));
