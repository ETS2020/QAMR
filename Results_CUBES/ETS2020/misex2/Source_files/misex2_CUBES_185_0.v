...
module FAU ( 
  ...
  nor2   g09(.a(x19), .b(new_n45_), .O(new_n55_));
  inv1   g10(.a(new_n55_), .O(new_n56_));
  nand3  g11(.a(new_n50_), .b(new_n44_), .c(new_n48_), .O(new_n57_));
  ...
  nand3  g19(.a(new_n64_), .b(new_n49_), .c(x02), .O(new_n65_));
  ...
  nand4  g23(.a(new_n68_), .b(new_n59_), .c(x10), .d(new_n49_), .O(new_n69_));
  nor2   g24(.a(new_n69_), .b(new_n67_), .O(z04));
  nor3   g25(.a(new_n67_), .b(new_n58_), .c(new_n49_), .O(z05));
  nand3  g26(.a(new_n60_), .b(new_n49_), .c(x02), .O(new_n72_));
  nor3   g27(.a(new_n72_), .b(new_n63_), .c(new_n62_), .O(z06));
  nand4  g28(.a(new_n60_), .b(new_n68_), .c(new_n49_), .d(x01), .O(new_n74_));
  nand2  g29(.a(x02), .b(x00), .O(new_n75_));
  aoi21  g30(.a(new_n74_), .b(x01), .c(new_n75_), .O(z07));
  inv1   g31(.a(x08), .O(new_n77_));
  nand4  g32(.a(x19), .b(new_n45_), .c(x17), .d(new_n77_), .O(new_n78_));
  ...
  nor2   g43(.a(new_n48_), .b(x01), .O(new_n89_));
  ...
  nand4  g50(.a(new_n95_), .b(new_n46_), .c(x18), .d(x01), .O(new_n96_));
  ...
  nand4  g61(.a(x12), .b(new_n59_), .c(x02), .d(new_n63_), .O(new_n107_));
  ...
  oai21  g65(.a(new_n58_), .b(new_n48_), .c(new_n64_), .O(new_n112_));
  oai21  g66(.a(x19), .b(x02), .c(x23), .O(new_n113_));
  nand3  g67(.a(new_n46_), .b(x17), .c(new_n48_), .O(new_n114_));
  ...
  nor2   g73(.a(new_n63_), .b(x00), .O(z16));
  zero   g74(.O(z01));
  zero   g75(.O(z02));
  zero   g76(.O(z11));
  zero   g77(.O(z13));
