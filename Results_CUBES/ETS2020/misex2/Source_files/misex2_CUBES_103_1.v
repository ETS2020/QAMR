...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n103_, new_n104_, new_n105_, new_n108_, new_n111_, new_n112_;
  ...
  nand4  g40(.a(new_n85_), .b(new_n57_), .c(x22), .d(x21), .O(new_n86_));
  nand2  g41(.a(x02), .b(new_n84_), .O(new_n87_));
  inv1   g42(.a(x13), .O(new_n88_));
  nand3  g43(.a(new_n88_), .b(x12), .c(new_n62_), .O(new_n89_));
  ...
  nand3  g53(.a(new_n85_), .b(new_n57_), .c(x21), .O(new_n99_));
  ...
  nor2   g61(.a(x19), .b(new_n47_), .O(new_n108_));
  and2   g62(.a(new_n108_), .b(new_n45_), .O(z13));
  nor2   g63(.a(new_n55_), .b(new_n46_), .O(z14));
  aoi21  g64(.a(new_n54_), .b(x01), .c(new_n59_), .O(new_n111_));
  nand3  g65(.a(x19), .b(new_n59_), .c(new_n84_), .O(new_n112_));
  oai21  g66(.a(new_n111_), .b(new_n104_), .c(new_n112_), .O(z15));
  nor2   g67(.a(new_n84_), .b(x00), .O(z16));
  inv1   g68(.a(new_n80_), .O(z17));
  zero   g69(.O(z04));
  zero   g70(.O(z09));
  zero   g71(.O(z12));
endmodule
