...
module FAU ( 
  ...
  wire new_n47_, new_n48_, new_n49_, new_n50_, new_n51_, new_n52_, new_n53_,
    ...
    new_n84_, new_n85_, new_n86_, new_n87_, new_n90_, new_n91_;
  ...
  nand4  g38(.a(new_n51_), .b(new_n70_), .c(new_n61_), .d(new_n55_), .O(new_n90_));
  nand3  g39(.a(new_n47_), .b(new_n50_), .c(new_n49_), .O(new_n91_));
  nor2   g40(.a(new_n91_), .b(new_n90_), .O(z14));
  zero   g41(.O(z00));
  zero   g42(.O(z01));
  zero   g43(.O(z02));
  zero   g44(.O(z04));
