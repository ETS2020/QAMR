...
module FAU ( 
  ...
  wire new_n46_, new_n47_, new_n48_, new_n49_, new_n50_, new_n51_, new_n53_,
    ...
    new_n61_, new_n64_, new_n66_, new_n68_, new_n69_, new_n70_, new_n72_,
  ...
  nand4  g28(.a(new_n74_), .b(new_n73_), .c(x04), .d(new_n72_), .O(new_n75_));
  nand2  g29(.a(new_n47_), .b(x02), .O(new_n76_));
  inv1   g30(.a(x18), .O(new_n77_));
  nand3  g31(.a(x19), .b(new_n77_), .c(x17), .O(new_n78_));
  nor3   g32(.a(new_n78_), .b(new_n76_), .c(new_n75_), .O(z08));
  ...
  nor2   g37(.a(new_n46_), .b(x01), .O(new_n84_));
  inv1   g38(.a(x13), .O(new_n85_));
  inv1   g39(.a(x14), .O(new_n86_));
  nand4  g40(.a(new_n86_), .b(new_n85_), .c(x12), .d(new_n57_), .O(new_n87_));
  inv1   g41(.a(new_n87_), .O(new_n88_));
  nand3  g42(.a(new_n88_), .b(new_n84_), .c(new_n83_), .O(new_n89_));
  inv1   g43(.a(x20), .O(new_n90_));
  nand4  g44(.a(new_n90_), .b(new_n53_), .c(x18), .d(x01), .O(new_n91_));
  inv1   g45(.a(x00), .O(new_n92_));
  inv1   g46(.a(x21), .O(new_n93_));
  inv1   g47(.a(x22), .O(new_n94_));
  nand3  g48(.a(new_n94_), .b(new_n93_), .c(new_n92_), .O(new_n95_));
  aoi21  g49(.a(new_n91_), .b(new_n89_), .c(new_n95_), .O(z09));
  inv1   g50(.a(x01), .O(new_n97_));
  nor2   g51(.a(x20), .b(new_n97_), .O(new_n98_));
  nor2   g52(.a(new_n94_), .b(new_n93_), .O(new_n99_));
  nand4  g53(.a(new_n99_), .b(new_n98_), .c(new_n53_), .d(x18), .O(new_n100_));
  nand3  g54(.a(new_n94_), .b(new_n93_), .c(x20), .O(new_n101_));
  inv1   g55(.a(new_n101_), .O(new_n102_));
  nand4  g56(.a(x16), .b(x15), .c(new_n86_), .d(new_n85_), .O(new_n103_));
  inv1   g57(.a(new_n103_), .O(new_n104_));
  nand4  g58(.a(x12), .b(new_n57_), .c(x02), .d(new_n97_), .O(new_n105_));
  inv1   g59(.a(new_n105_), .O(new_n106_));
  nand3  g60(.a(new_n106_), .b(new_n104_), .c(new_n102_), .O(new_n107_));
  aoi21  g61(.a(new_n107_), .b(new_n100_), .c(x00), .O(z10));
  nand3  g62(.a(new_n50_), .b(new_n49_), .c(new_n60_), .O(new_n112_));
  nor2   g63(.a(new_n112_), .b(new_n48_), .O(z14));
  nor2   g64(.a(new_n97_), .b(x00), .O(z16));
  inv1   g65(.a(new_n76_), .O(z17));
  zero   g66(.O(z00));
  zero   g67(.O(z01));
  zero   g68(.O(z04));
  zero   g69(.O(z11));
