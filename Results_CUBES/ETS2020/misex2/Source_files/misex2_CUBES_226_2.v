...
module FAU ( 
  ...
  nor2   g32(.a(new_n45_), .b(x01), .O(new_n80_));
  inv1   g33(.a(x13), .O(new_n81_));
  inv1   g34(.a(x14), .O(new_n82_));
  nand4  g35(.a(new_n82_), .b(new_n81_), .c(x12), .d(new_n62_), .O(new_n83_));
  inv1   g36(.a(new_n83_), .O(new_n84_));
  nand3  g37(.a(new_n84_), .b(new_n80_), .c(new_n79_), .O(new_n85_));
  inv1   g38(.a(x20), .O(new_n86_));
  nand4  g39(.a(new_n86_), .b(new_n50_), .c(x18), .d(x01), .O(new_n87_));
  inv1   g40(.a(x21), .O(new_n88_));
  inv1   g41(.a(x22), .O(new_n89_));
  nand3  g42(.a(new_n89_), .b(new_n88_), .c(new_n57_), .O(new_n90_));
  aoi21  g43(.a(new_n87_), .b(new_n85_), .c(new_n90_), .O(z09));
  oai21  g44(.a(new_n53_), .b(new_n45_), .c(new_n59_), .O(new_n94_));
  oai21  g45(.a(x19), .b(x02), .c(x23), .O(new_n95_));
  nand3  g46(.a(new_n50_), .b(x17), .c(new_n45_), .O(new_n96_));
  nand2  g47(.a(new_n96_), .b(new_n95_), .O(new_n97_));
  nand2  g48(.a(new_n97_), .b(new_n46_), .O(new_n98_));
  inv1   g49(.a(x24), .O(new_n99_));
  nand2  g50(.a(new_n99_), .b(x09), .O(new_n100_));
  aoi21  g51(.a(new_n98_), .b(new_n94_), .c(new_n100_), .O(z12));
  nand2  g52(.a(new_n46_), .b(new_n45_), .O(new_n102_));
  nor3   g53(.a(new_n102_), .b(x19), .c(new_n48_), .O(z13));
  nor2   g54(.a(x10), .b(x09), .O(new_n104_));
  nand4  g55(.a(new_n104_), .b(new_n50_), .c(new_n49_), .d(new_n48_), .O(new_n105_));
  nor2   g56(.a(new_n105_), .b(new_n102_), .O(z14));
  aoi21  g57(.a(new_n53_), .b(x01), .c(new_n45_), .O(new_n107_));
  nand3  g58(.a(x19), .b(new_n45_), .c(new_n58_), .O(new_n108_));
  oai21  g59(.a(new_n107_), .b(new_n57_), .c(new_n108_), .O(z15));
  nor2   g60(.a(new_n58_), .b(x00), .O(z16));
  inv1   g61(.a(new_n73_), .O(z17));
  zero   g62(.O(z00));
  zero   g63(.O(z03));
  zero   g64(.O(z06));
  zero   g65(.O(z07));
