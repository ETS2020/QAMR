...
module FAU ( 
  ...
  nand4  g04(.a(new_n49_), .b(new_n48_), .c(new_n47_), .d(new_n46_), .O(new_n50_));
  inv1   g05(.a(x02), .O(new_n51_));
  nor2   g06(.a(x01), .b(x00), .O(new_n52_));
  nand3  g07(.a(new_n52_), .b(x09), .c(new_n51_), .O(new_n53_));
  nor2   g08(.a(new_n53_), .b(new_n50_), .O(z02));
  nor2   g09(.a(x19), .b(new_n48_), .O(new_n55_));
  inv1   g10(.a(new_n55_), .O(new_n56_));
  nand3  g11(.a(new_n52_), .b(new_n47_), .c(new_n51_), .O(new_n57_));
  inv1   g12(.a(x11), .O(new_n58_));
  nor2   g13(.a(new_n58_), .b(new_n46_), .O(new_n59_));
  ...
  oai22  g20(.a(new_n65_), .b(new_n60_), .c(new_n57_), .d(new_n56_), .O(z03));
  ...
  nor3   g25(.a(new_n67_), .b(new_n46_), .c(new_n61_), .O(z05));
  ...
  nand4  g32(.a(x19), .b(new_n48_), .c(x17), .d(new_n77_), .O(new_n78_));
  ...
  nand3  g37(.a(new_n52_), .b(new_n82_), .c(x02), .O(new_n83_));
  ...
  nor2   g43(.a(new_n51_), .b(x01), .O(new_n89_));
  ...
  nand4  g50(.a(new_n95_), .b(new_n49_), .c(x18), .d(x01), .O(new_n96_));
  ...
  nand4  g56(.a(new_n101_), .b(new_n55_), .c(new_n95_), .d(x01), .O(new_n102_));
  ...
  oai21  g65(.a(new_n46_), .b(new_n51_), .c(new_n64_), .O(new_n112_));
  oai21  g66(.a(x19), .b(x02), .c(x23), .O(new_n113_));
  nand3  g67(.a(new_n49_), .b(x17), .c(new_n51_), .O(new_n114_));
  nand2  g68(.a(new_n114_), .b(new_n113_), .O(new_n115_));
  nand2  g69(.a(new_n115_), .b(new_n52_), .O(new_n116_));
