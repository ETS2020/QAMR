...
module FAU ( 
  ...
  nand2  g45(.a(x02), .b(new_n66_), .O(new_n90_));
  inv1   g46(.a(new_n90_), .O(new_n91_));
  nor2   g47(.a(new_n70_), .b(x11), .O(new_n92_));
  ...
  nand3  g54(.a(new_n98_), .b(new_n97_), .c(new_n65_), .O(new_n99_));
  aoi21  g55(.a(new_n96_), .b(new_n94_), .c(new_n99_), .O(z09));
  nor2   g56(.a(x20), .b(new_n66_), .O(new_n101_));
  ...
  nand2  g70(.a(new_n98_), .b(new_n65_), .O(new_n115_));
  aoi21  g71(.a(new_n114_), .b(new_n111_), .c(new_n115_), .O(z11));
  oai21  g72(.a(new_n54_), .b(new_n59_), .c(new_n67_), .O(new_n117_));
  ...
  nand3  g84(.a(x19), .b(new_n59_), .c(new_n66_), .O(new_n129_));
  oai21  g85(.a(new_n128_), .b(new_n65_), .c(new_n129_), .O(z15));
