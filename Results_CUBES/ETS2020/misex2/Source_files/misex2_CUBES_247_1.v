...
module FAU ( 
  ...
  aoi21  g65(.a(new_n57_), .b(x01), .c(new_n60_), .O(new_n112_));
  nand3  g66(.a(x19), .b(new_n60_), .c(new_n46_), .O(new_n113_));
  oai21  g67(.a(new_n112_), .b(new_n45_), .c(new_n113_), .O(z15));
  nor2   g68(.a(new_n46_), .b(x00), .O(z16));
  nand2  g69(.a(new_n102_), .b(x02), .O(new_n116_));
