...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n68_, new_n72_, new_n74_, new_n75_, new_n76_, new_n80_, new_n81_,
  ...
  nor2   g31(.a(x20), .b(new_n66_), .O(new_n80_));
  nand4  g32(.a(new_n80_), .b(new_n58_), .c(x22), .d(x21), .O(new_n81_));
  nand2  g33(.a(x02), .b(new_n66_), .O(new_n82_));
  inv1   g34(.a(x13), .O(new_n83_));
  nand3  g35(.a(new_n83_), .b(x12), .c(new_n62_), .O(new_n84_));
  ...
  nand3  g45(.a(new_n80_), .b(new_n58_), .c(x21), .O(new_n94_));
  ...
  nand2  g50(.a(new_n89_), .b(new_n65_), .O(new_n99_));
  aoi21  g51(.a(new_n98_), .b(new_n94_), .c(new_n99_), .O(z11));
  oai21  g52(.a(new_n61_), .b(new_n44_), .c(new_n67_), .O(new_n101_));
  ...
  nand4  g61(.a(new_n50_), .b(new_n49_), .c(new_n48_), .d(new_n61_), .O(new_n110_));
  nor2   g62(.a(new_n110_), .b(new_n47_), .O(z14));
  aoi21  g63(.a(new_n61_), .b(x01), .c(new_n44_), .O(new_n112_));
  nand3  g64(.a(x19), .b(new_n44_), .c(new_n66_), .O(new_n113_));
  oai21  g65(.a(new_n112_), .b(new_n65_), .c(new_n113_), .O(z15));
  nand2  g66(.a(new_n46_), .b(x02), .O(new_n116_));
  inv1   g67(.a(new_n116_), .O(z17));
  zero   g68(.O(z02));
  zero   g69(.O(z04));
  zero   g70(.O(z05));
  zero   g71(.O(z08));
