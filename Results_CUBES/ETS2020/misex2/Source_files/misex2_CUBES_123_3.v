...
module FAU ( 
  ...
  aoi21  g77(.a(new_n61_), .b(x01), .c(new_n44_), .O(new_n123_));
  nand3  g78(.a(x19), .b(new_n44_), .c(new_n66_), .O(new_n124_));
  oai21  g79(.a(new_n123_), .b(new_n65_), .c(new_n124_), .O(z15));
  nor2   g80(.a(new_n66_), .b(x00), .O(z16));
  nand2  g81(.a(new_n46_), .b(x02), .O(new_n127_));
