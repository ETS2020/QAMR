...
module FAU ( 
  ...
  nand2  g47(.a(x02), .b(new_n67_), .O(new_n92_));
  ...
  nand3  g56(.a(new_n100_), .b(new_n99_), .c(new_n66_), .O(new_n101_));
  aoi21  g57(.a(new_n98_), .b(new_n96_), .c(new_n101_), .O(z09));
  nor2   g58(.a(x20), .b(new_n67_), .O(new_n103_));
  nand4  g59(.a(new_n103_), .b(new_n60_), .c(x22), .d(x21), .O(new_n104_));
  inv1   g60(.a(x13), .O(new_n105_));
  nand3  g61(.a(new_n105_), .b(x12), .c(new_n63_), .O(new_n106_));
  ...
  nand2  g72(.a(new_n100_), .b(new_n66_), .O(new_n117_));
  aoi21  g73(.a(new_n116_), .b(new_n113_), .c(new_n117_), .O(z11));
  oai21  g74(.a(new_n57_), .b(new_n44_), .c(new_n68_), .O(new_n119_));
  oai21  g75(.a(x19), .b(x02), .c(x23), .O(new_n120_));
  nand3  g76(.a(new_n48_), .b(x17), .c(new_n44_), .O(new_n121_));
  nand2  g77(.a(new_n121_), .b(new_n120_), .O(new_n122_));
  nand2  g78(.a(new_n122_), .b(new_n45_), .O(new_n123_));
  inv1   g79(.a(x24), .O(new_n124_));
  nand2  g80(.a(new_n124_), .b(x09), .O(new_n125_));
  aoi21  g81(.a(new_n123_), .b(new_n119_), .c(new_n125_), .O(z12));
  aoi21  g82(.a(new_n57_), .b(x01), .c(new_n44_), .O(new_n129_));
  nand3  g83(.a(x19), .b(new_n44_), .c(new_n67_), .O(new_n130_));
  oai21  g84(.a(new_n129_), .b(new_n66_), .c(new_n130_), .O(z15));
  nor2   g85(.a(new_n67_), .b(x00), .O(z16));
  zero   g86(.O(z05));
  zero   g87(.O(z13));
  zero   g88(.O(z14));
  zero   g89(.O(z17));
