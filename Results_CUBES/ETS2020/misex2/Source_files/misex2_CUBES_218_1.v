...
module FAU ( 
  ...
  nand4  g47(.a(new_n94_), .b(new_n58_), .c(new_n88_), .d(x01), .O(new_n95_));
  ...
  nand4  g57(.a(new_n50_), .b(new_n49_), .c(new_n48_), .d(new_n61_), .O(new_n107_));
  nor2   g58(.a(new_n107_), .b(new_n47_), .O(z14));
  aoi21  g59(.a(new_n61_), .b(x01), .c(new_n44_), .O(new_n109_));
  nand3  g60(.a(x19), .b(new_n44_), .c(new_n70_), .O(new_n110_));
  oai21  g61(.a(new_n109_), .b(new_n69_), .c(new_n110_), .O(z15));
  nor2   g62(.a(new_n70_), .b(x00), .O(z16));
  nand2  g63(.a(new_n46_), .b(x02), .O(new_n113_));
  inv1   g64(.a(new_n113_), .O(z17));
  zero   g65(.O(z02));
  zero   g66(.O(z04));
  zero   g67(.O(z05));
  zero   g68(.O(z08));
