...
module FAU ( 
  ...
  nand2  g37(.a(x02), .b(new_n66_), .O(new_n84_));
  inv1   g38(.a(new_n84_), .O(new_n85_));
  nor2   g39(.a(new_n70_), .b(x11), .O(new_n86_));
  nor2   g40(.a(x14), .b(x13), .O(new_n87_));
  nand4  g41(.a(new_n87_), .b(new_n86_), .c(new_n85_), .d(new_n83_), .O(new_n88_));
  nor2   g42(.a(x20), .b(x19), .O(new_n89_));
  nand3  g43(.a(new_n89_), .b(x18), .c(x01), .O(new_n90_));
  inv1   g44(.a(x21), .O(new_n91_));
  inv1   g45(.a(x22), .O(new_n92_));
  nand3  g46(.a(new_n92_), .b(new_n91_), .c(new_n65_), .O(new_n93_));
  aoi21  g47(.a(new_n90_), .b(new_n88_), .c(new_n93_), .O(z09));
  nor2   g48(.a(x20), .b(new_n66_), .O(new_n95_));
  ...
  nor2   g52(.a(new_n98_), .b(new_n84_), .O(new_n99_));
  nor2   g53(.a(new_n80_), .b(x14), .O(new_n100_));
  ...
  nand4  g58(.a(new_n89_), .b(x21), .c(x18), .d(x01), .O(new_n105_));
  nand3  g59(.a(new_n91_), .b(x20), .c(new_n81_), .O(new_n106_));
  inv1   g60(.a(new_n106_), .O(new_n107_));
  nand3  g61(.a(new_n107_), .b(new_n100_), .c(new_n99_), .O(new_n108_));
  nand2  g62(.a(new_n92_), .b(new_n65_), .O(new_n109_));
  aoi21  g63(.a(new_n108_), .b(new_n105_), .c(new_n109_), .O(z11));
  oai21  g64(.a(new_n55_), .b(new_n44_), .c(new_n67_), .O(new_n111_));
  ...
  nand4  g73(.a(new_n50_), .b(new_n49_), .c(new_n48_), .d(new_n55_), .O(new_n120_));
  nor2   g74(.a(new_n120_), .b(new_n47_), .O(z14));
  zero   g75(.O(z01));
  zero   g76(.O(z05));
  zero   g77(.O(z08));
  zero   g78(.O(z15));
