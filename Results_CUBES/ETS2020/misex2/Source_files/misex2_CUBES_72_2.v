...
module FAU ( 
  ...
  aoi21  g42(.a(new_n53_), .b(x01), .c(new_n45_), .O(new_n94_));
  inv1   g43(.a(x01), .O(new_n95_));
  nand3  g44(.a(x19), .b(new_n45_), .c(new_n95_), .O(new_n96_));
  oai21  g45(.a(new_n94_), .b(new_n86_), .c(new_n96_), .O(z15));
  nor2   g46(.a(new_n95_), .b(x00), .O(z16));
  inv1   g47(.a(new_n68_), .O(z17));
  zero   g48(.O(z00));
  zero   g49(.O(z03));
  zero   g50(.O(z06));
  zero   g51(.O(z07));
