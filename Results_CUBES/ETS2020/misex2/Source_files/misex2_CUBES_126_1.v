// Benchmark "FAU" written by ABC on Tue Jul  7 11:01:05 2020
...
module FAU ( 
  ...
  aoi21  g77(.a(new_n61_), .b(x01), .c(new_n44_), .O(new_n124_));
  nand3  g78(.a(x19), .b(new_n44_), .c(new_n107_), .O(new_n125_));
  oai21  g79(.a(new_n124_), .b(new_n96_), .c(new_n125_), .O(z15));
  nor2   g80(.a(new_n107_), .b(x00), .O(z16));
