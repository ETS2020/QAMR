...
module FAU ( 
  ...
  nor2   g29(.a(new_n49_), .b(new_n60_), .O(new_n78_));
  nor2   g30(.a(x20), .b(x19), .O(new_n79_));
  nand4  g31(.a(new_n79_), .b(new_n78_), .c(x22), .d(x21), .O(new_n80_));
  nand2  g32(.a(x02), .b(new_n60_), .O(new_n81_));
  inv1   g33(.a(x13), .O(new_n82_));
  nand3  g34(.a(new_n82_), .b(x12), .c(new_n63_), .O(new_n83_));
  nor2   g35(.a(new_n83_), .b(new_n81_), .O(new_n84_));
  inv1   g36(.a(x15), .O(new_n85_));
  nor2   g37(.a(new_n85_), .b(x14), .O(new_n86_));
  inv1   g38(.a(x21), .O(new_n87_));
  inv1   g39(.a(x22), .O(new_n88_));
  nand4  g40(.a(new_n88_), .b(new_n87_), .c(x20), .d(x16), .O(new_n89_));
  inv1   g41(.a(new_n89_), .O(new_n90_));
  nand3  g42(.a(new_n90_), .b(new_n86_), .c(new_n84_), .O(new_n91_));
  aoi21  g43(.a(new_n91_), .b(new_n80_), .c(x00), .O(z10));
  nand3  g44(.a(new_n79_), .b(new_n78_), .c(x21), .O(new_n93_));
  inv1   g45(.a(x16), .O(new_n94_));
  nand3  g46(.a(new_n87_), .b(x20), .c(new_n94_), .O(new_n95_));
  inv1   g47(.a(new_n95_), .O(new_n96_));
  nand3  g48(.a(new_n96_), .b(new_n86_), .c(new_n84_), .O(new_n97_));
  nand2  g49(.a(new_n88_), .b(new_n59_), .O(new_n98_));
  aoi21  g50(.a(new_n97_), .b(new_n93_), .c(new_n98_), .O(z11));
  inv1   g51(.a(x10), .O(new_n100_));
  oai21  g52(.a(new_n100_), .b(new_n44_), .c(new_n61_), .O(new_n101_));
  ...
  nor3   g60(.a(new_n53_), .b(x19), .c(new_n48_), .O(z13));
  nand4  g61(.a(new_n50_), .b(new_n49_), .c(new_n48_), .d(new_n100_), .O(new_n110_));
  nor2   g62(.a(new_n110_), .b(new_n47_), .O(z14));
  aoi21  g63(.a(new_n100_), .b(x01), .c(new_n44_), .O(new_n112_));
  nand3  g64(.a(x19), .b(new_n44_), .c(new_n60_), .O(new_n113_));
  oai21  g65(.a(new_n112_), .b(new_n59_), .c(new_n113_), .O(z15));
