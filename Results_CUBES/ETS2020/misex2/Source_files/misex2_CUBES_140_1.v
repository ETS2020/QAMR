...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n102_, new_n106_, new_n108_, new_n110_, new_n111_, new_n114_;
  ...
  nand4  g38(.a(new_n84_), .b(new_n83_), .c(x12), .d(new_n59_), .O(new_n85_));
  ...
  nand3  g45(.a(new_n91_), .b(new_n90_), .c(new_n62_), .O(new_n92_));
  aoi21  g46(.a(new_n89_), .b(new_n87_), .c(new_n92_), .O(z09));
  nor2   g47(.a(new_n91_), .b(new_n90_), .O(new_n94_));
  nand4  g48(.a(new_n94_), .b(new_n55_), .c(new_n88_), .d(x01), .O(new_n95_));
  nand3  g49(.a(new_n91_), .b(new_n90_), .c(x20), .O(new_n96_));
  inv1   g50(.a(new_n96_), .O(new_n97_));
  nand4  g51(.a(x16), .b(x15), .c(new_n84_), .d(new_n83_), .O(new_n98_));
  inv1   g52(.a(new_n98_), .O(new_n99_));
  nand4  g53(.a(x12), .b(new_n59_), .c(x02), .d(new_n63_), .O(new_n100_));
  inv1   g54(.a(new_n100_), .O(new_n101_));
  nand3  g55(.a(new_n101_), .b(new_n99_), .c(new_n97_), .O(new_n102_));
  aoi21  g56(.a(new_n102_), .b(new_n95_), .c(x00), .O(z10));
  nand2  g57(.a(new_n46_), .b(new_n44_), .O(new_n106_));
  nor3   g58(.a(new_n106_), .b(x19), .c(new_n48_), .O(z13));
  nand4  g59(.a(new_n50_), .b(new_n49_), .c(new_n48_), .d(new_n58_), .O(new_n108_));
  nor2   g60(.a(new_n108_), .b(new_n47_), .O(z14));
  aoi21  g61(.a(new_n58_), .b(x01), .c(new_n44_), .O(new_n110_));
  nand3  g62(.a(x19), .b(new_n44_), .c(new_n63_), .O(new_n111_));
  oai21  g63(.a(new_n110_), .b(new_n62_), .c(new_n111_), .O(z15));
  nand2  g64(.a(new_n46_), .b(x02), .O(new_n114_));
  inv1   g65(.a(new_n114_), .O(z17));
  zero   g66(.O(z01));
  zero   g67(.O(z02));
  zero   g68(.O(z08));
  zero   g69(.O(z11));
