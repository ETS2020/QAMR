...
module FAU ( 
  ...
  nor3   g64(.a(new_n46_), .b(x19), .c(new_n53_), .O(z13));
  aoi21  g65(.a(new_n57_), .b(x01), .c(new_n44_), .O(new_n113_));
  nand3  g66(.a(x19), .b(new_n44_), .c(new_n67_), .O(new_n114_));
  oai21  g67(.a(new_n113_), .b(new_n66_), .c(new_n114_), .O(z15));
  nor2   g68(.a(new_n67_), .b(x00), .O(z16));
  zero   g69(.O(z05));
  zero   g70(.O(z08));
  zero   g71(.O(z09));
  zero   g72(.O(z14));
