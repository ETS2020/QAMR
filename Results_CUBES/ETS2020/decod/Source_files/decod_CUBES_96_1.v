...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n26_, new_n27_, new_n28_, new_n30_, new_n31_,
    new_n35_, new_n36_, new_n37_, new_n41_, new_n42_, new_n43_, new_n45_,
    new_n49_;
  ...
  nand3  g12(.a(x4), .b(x3), .c(new_n26_), .O(new_n37_));
  nor2   g13(.a(new_n37_), .b(new_n36_), .O(z06));
  inv1   g14(.a(x0), .O(new_n41_));
  nand2  g15(.a(x1), .b(new_n41_), .O(new_n42_));
  nand3  g16(.a(x4), .b(new_n30_), .c(x2), .O(new_n43_));
  nor2   g17(.a(new_n43_), .b(new_n42_), .O(z09));
  nand3  g18(.a(new_n26_), .b(x1), .c(new_n41_), .O(new_n45_));
  nor2   g19(.a(new_n45_), .b(new_n28_), .O(z10));
  nor2   g20(.a(new_n45_), .b(new_n31_), .O(z11));
  nand2  g21(.a(new_n35_), .b(new_n41_), .O(new_n49_));
  nor2   g22(.a(new_n49_), .b(new_n43_), .O(z13));
  nor2   g23(.a(new_n49_), .b(new_n37_), .O(z14));
  zero   g24(.O(z01));
  zero   g25(.O(z04));
  zero   g26(.O(z05));
  zero   g27(.O(z07));
