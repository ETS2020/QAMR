...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n26_, new_n27_, new_n28_, new_n30_, new_n31_,
    new_n33_, new_n34_, new_n39_, new_n40_, new_n45_, new_n48_, new_n49_;
  ...
  nand3  g16(.a(x2), .b(new_n33_), .c(new_n39_), .O(new_n45_));
  nor2   g17(.a(new_n45_), .b(new_n28_), .O(z12));
  nor2   g18(.a(new_n45_), .b(new_n31_), .O(z13));
  nand2  g19(.a(new_n33_), .b(new_n39_), .O(new_n48_));
  nand3  g20(.a(x4), .b(x3), .c(new_n26_), .O(new_n49_));
  nor2   g21(.a(new_n49_), .b(new_n48_), .O(z14));
  zero   g22(.O(z01));
  zero   g23(.O(z05));
  zero   g24(.O(z06));
  zero   g25(.O(z07));
