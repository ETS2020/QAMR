...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n26_, new_n27_, new_n28_, new_n30_, new_n31_,
    new_n34_, new_n35_, new_n36_, new_n39_, new_n41_, new_n42_, new_n46_,
  ...
  nor2   g18(.a(new_n42_), .b(new_n28_), .O(z08));
  nor2   g19(.a(new_n42_), .b(new_n31_), .O(z09));
  nand2  g20(.a(x1), .b(new_n41_), .O(new_n46_));
  nor2   g21(.a(new_n46_), .b(new_n39_), .O(z11));
  nand3  g22(.a(x2), .b(new_n34_), .c(new_n41_), .O(new_n48_));
  nor2   g23(.a(new_n48_), .b(new_n28_), .O(z12));
  nor2   g24(.a(new_n48_), .b(new_n31_), .O(z13));
  nand2  g25(.a(new_n34_), .b(new_n41_), .O(new_n51_));
  nand3  g26(.a(x4), .b(x3), .c(new_n26_), .O(new_n52_));
  nor2   g27(.a(new_n52_), .b(new_n51_), .O(z14));
  zero   g28(.O(z01));
  zero   g29(.O(z04));
  zero   g30(.O(z06));
  zero   g31(.O(z10));
