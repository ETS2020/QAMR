...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n32_,
    new_n33_, new_n38_, new_n39_, new_n43_, new_n44_, new_n46_, new_n49_;
  ...
  nand2  g18(.a(x1), .b(new_n38_), .O(new_n43_));
  ...
  nand3  g24(.a(new_n28_), .b(new_n32_), .c(new_n38_), .O(new_n49_));
