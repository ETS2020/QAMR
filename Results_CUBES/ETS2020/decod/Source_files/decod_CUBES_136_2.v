...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n27_, new_n28_, new_n29_, new_n31_, new_n32_,
    new_n33_, new_n35_, new_n38_, new_n40_, new_n41_, new_n44_, new_n47_;
  ...
  nand3  g18(.a(new_n27_), .b(x1), .c(new_n40_), .O(new_n44_));
  nor2   g19(.a(new_n44_), .b(new_n33_), .O(z10));
  nor2   g20(.a(new_n44_), .b(new_n35_), .O(z11));
  nand3  g21(.a(x2), .b(new_n31_), .c(new_n40_), .O(new_n47_));
