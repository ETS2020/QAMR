...
module FAU ( 
  ...
  nand3  g19(.a(x2), .b(new_n31_), .c(new_n42_), .O(new_n47_));
  nor2   g20(.a(new_n47_), .b(new_n37_), .O(z12));
  nor2   g21(.a(new_n47_), .b(new_n39_), .O(z13));
  nand2  g22(.a(new_n31_), .b(new_n42_), .O(new_n51_));
  nand3  g23(.a(x4), .b(new_n24_), .c(new_n27_), .O(new_n52_));
  nor2   g24(.a(new_n52_), .b(new_n51_), .O(z15));
  zero   g25(.O(z00));
  zero   g26(.O(z03));
  zero   g27(.O(z05));
  zero   g28(.O(z08));
