...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n27_, new_n28_, new_n29_, new_n31_, new_n32_,
    new_n33_, new_n35_, new_n37_, new_n38_, new_n41_, new_n42_, new_n47_,
    new_n50_;
  ...
  nand3  g19(.a(x2), .b(new_n31_), .c(new_n41_), .O(new_n47_));
  nor2   g20(.a(new_n47_), .b(new_n33_), .O(z12));
  nor2   g21(.a(new_n47_), .b(new_n35_), .O(z13));
  nand3  g22(.a(new_n27_), .b(new_n31_), .c(new_n41_), .O(new_n50_));
  nor2   g23(.a(new_n50_), .b(new_n33_), .O(z14));
  nor2   g24(.a(new_n50_), .b(new_n35_), .O(z15));
  zero   g25(.O(z01));
  zero   g26(.O(z02));
  zero   g27(.O(z07));
  zero   g28(.O(z09));
