...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n26_, new_n27_, new_n28_, new_n30_, new_n31_,
    new_n34_, new_n35_, new_n36_, new_n38_, new_n41_, new_n42_, new_n47_,
    new_n50_;
  ...
  nor2   g19(.a(new_n42_), .b(new_n38_), .O(z10));
  nand3  g20(.a(x2), .b(new_n34_), .c(new_n41_), .O(new_n47_));
  nor2   g21(.a(new_n47_), .b(new_n28_), .O(z12));
  nor2   g22(.a(new_n47_), .b(new_n31_), .O(z13));
  nand3  g23(.a(new_n26_), .b(new_n34_), .c(new_n41_), .O(new_n50_));
  nor2   g24(.a(new_n50_), .b(new_n28_), .O(z14));
