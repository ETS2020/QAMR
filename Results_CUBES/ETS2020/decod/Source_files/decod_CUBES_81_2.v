...
module FAU ( 
  ...
  nor2   g15(.a(new_n40_), .b(new_n34_), .O(z08));
  nor2   g16(.a(new_n40_), .b(new_n37_), .O(z09));
  nand3  g17(.a(new_n32_), .b(x1), .c(new_n39_), .O(new_n43_));
  nor2   g18(.a(new_n43_), .b(new_n34_), .O(z10));
  nor2   g19(.a(new_n43_), .b(new_n37_), .O(z11));
  nand2  g20(.a(new_n28_), .b(new_n39_), .O(new_n46_));
  nor2   g21(.a(new_n46_), .b(new_n23_), .O(z12));
  nand3  g22(.a(x4), .b(x3), .c(new_n32_), .O(new_n49_));
  nor2   g23(.a(new_n49_), .b(new_n46_), .O(z14));
  zero   g24(.O(z01));
  zero   g25(.O(z02));
  zero   g26(.O(z03));
  zero   g27(.O(z05));
