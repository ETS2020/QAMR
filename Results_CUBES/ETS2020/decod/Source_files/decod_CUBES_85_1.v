...
module FAU ( 
  ...
  nand3  g20(.a(new_n28_), .b(x1), .c(new_n40_), .O(new_n44_));
  nor2   g21(.a(new_n44_), .b(new_n23_), .O(z10));
  nor2   g22(.a(new_n44_), .b(new_n26_), .O(z11));
  nand2  g23(.a(new_n32_), .b(new_n40_), .O(new_n47_));
  nor2   g24(.a(new_n47_), .b(new_n34_), .O(z12));
  nor2   g25(.a(new_n47_), .b(new_n37_), .O(z14));
  zero   g26(.O(z05));
  zero   g27(.O(z07));
  zero   g28(.O(z13));
  zero   g29(.O(z15));
