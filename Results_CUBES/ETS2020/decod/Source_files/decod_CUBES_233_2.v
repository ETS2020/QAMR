...
module FAU ( 
  ...
  wire new_n25_, new_n26_, new_n27_, new_n28_, new_n32_, new_n33_, new_n34_,
    new_n36_, new_n38_, new_n39_, new_n40_, new_n43_, new_n46_, new_n49_;
  ...
  nand3  g06(.a(new_n26_), .b(new_n32_), .c(x0), .O(new_n33_));
  nand2  g07(.a(x4), .b(x3), .O(new_n34_));
  nor2   g08(.a(new_n34_), .b(new_n33_), .O(z06));
  nand2  g09(.a(x4), .b(new_n27_), .O(new_n36_));
  ...
  nor2   g16(.a(new_n43_), .b(new_n34_), .O(z10));
  nor2   g17(.a(new_n43_), .b(new_n36_), .O(z11));
  nand2  g18(.a(new_n32_), .b(new_n38_), .O(new_n46_));
  nor2   g19(.a(new_n46_), .b(new_n40_), .O(z12));
  nand3  g20(.a(new_n26_), .b(new_n32_), .c(new_n38_), .O(new_n49_));
  nor2   g21(.a(new_n49_), .b(new_n34_), .O(z14));
  nor2   g22(.a(new_n49_), .b(new_n36_), .O(z15));
  zero   g23(.O(z00));
  zero   g24(.O(z01));
  zero   g25(.O(z02));
  zero   g26(.O(z04));
