...
module FAU ( 
  ...
  nand2  g22(.a(new_n33_), .b(new_n42_), .O(new_n49_));
  nor2   g23(.a(new_n49_), .b(new_n44_), .O(z13));
  nand3  g24(.a(new_n30_), .b(new_n33_), .c(new_n42_), .O(new_n51_));
  nor2   g25(.a(new_n51_), .b(new_n23_), .O(z14));
  nor2   g26(.a(new_n51_), .b(new_n26_), .O(z15));
  zero   g27(.O(z02));
  zero   g28(.O(z05));
  zero   g29(.O(z08));
  zero   g30(.O(z10));
