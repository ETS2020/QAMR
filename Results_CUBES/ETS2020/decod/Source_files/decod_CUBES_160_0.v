...
module FAU ( 
  ...
  nor2   g20(.a(new_n45_), .b(new_n37_), .O(z10));
  nor2   g21(.a(new_n45_), .b(new_n39_), .O(z11));
  nand2  g22(.a(new_n31_), .b(new_n42_), .O(new_n49_));
  nor2   g23(.a(new_n49_), .b(new_n25_), .O(z13));
  nand3  g24(.a(new_n28_), .b(new_n31_), .c(new_n42_), .O(new_n51_));
  nor2   g25(.a(new_n51_), .b(new_n37_), .O(z14));
  nor2   g26(.a(new_n51_), .b(new_n39_), .O(z15));
  zero   g27(.O(z00));
  zero   g28(.O(z02));
  zero   g29(.O(z05));
  zero   g30(.O(z08));
