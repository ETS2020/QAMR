...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n29_, new_n30_, new_n31_,
    new_n35_, new_n36_, new_n39_, new_n40_, new_n44_, new_n47_, new_n48_,
    new_n50_;
  ...
  nor2   g19(.a(new_n44_), .b(new_n31_), .O(z11));
  nand2  g20(.a(new_n35_), .b(new_n39_), .O(new_n47_));
  nand3  g21(.a(x4), .b(new_n25_), .c(x2), .O(new_n48_));
  nor2   g22(.a(new_n48_), .b(new_n47_), .O(z13));
  nand3  g23(.a(new_n30_), .b(new_n35_), .c(new_n39_), .O(new_n50_));
