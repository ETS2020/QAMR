...
module FAU ( 
  ...
  nand3  g14(.a(x4), .b(x3), .c(new_n30_), .O(new_n38_));
  nor2   g15(.a(new_n38_), .b(new_n34_), .O(z06));
  ...
  nor2   g21(.a(new_n46_), .b(new_n31_), .O(z11));
  nand2  g22(.a(new_n33_), .b(new_n41_), .O(new_n48_));
  nor2   g23(.a(new_n48_), .b(new_n35_), .O(z12));
  nand3  g24(.a(new_n30_), .b(new_n33_), .c(new_n41_), .O(new_n51_));
