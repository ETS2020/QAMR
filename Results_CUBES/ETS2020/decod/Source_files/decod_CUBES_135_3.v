...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n28_, new_n29_, new_n32_, new_n33_, new_n34_,
    new_n36_, new_n37_, new_n39_, new_n40_, new_n43_, new_n46_, new_n49_;
  ...
  nand3  g16(.a(new_n32_), .b(x1), .c(new_n39_), .O(new_n43_));
  nor2   g17(.a(new_n43_), .b(new_n34_), .O(z10));
  nor2   g18(.a(new_n43_), .b(new_n37_), .O(z11));
  nand2  g19(.a(new_n28_), .b(new_n39_), .O(new_n46_));
  nor2   g20(.a(new_n46_), .b(new_n23_), .O(z12));
  nand3  g21(.a(new_n32_), .b(new_n28_), .c(new_n39_), .O(new_n49_));
  nor2   g22(.a(new_n49_), .b(new_n34_), .O(z14));
