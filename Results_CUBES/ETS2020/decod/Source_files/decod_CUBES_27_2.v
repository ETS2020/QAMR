...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n30_, new_n31_, new_n34_,
    new_n35_, new_n38_, new_n39_, new_n40_, new_n43_, new_n46_, new_n49_;
  ...
  nor2   g17(.a(new_n40_), .b(new_n39_), .O(z08));
  nand3  g18(.a(new_n34_), .b(x1), .c(new_n38_), .O(new_n43_));
  ...
  nand3  g24(.a(new_n34_), .b(new_n30_), .c(new_n38_), .O(new_n49_));
  nor2   g25(.a(new_n49_), .b(new_n23_), .O(z14));
  nor2   g26(.a(new_n49_), .b(new_n26_), .O(z15));
  zero   g27(.O(z02));
  zero   g28(.O(z03));
  zero   g29(.O(z09));
endmodule
