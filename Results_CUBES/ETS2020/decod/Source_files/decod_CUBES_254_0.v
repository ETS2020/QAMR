...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n34_,
    new_n35_, new_n38_, new_n39_, new_n42_, new_n46_, new_n47_, new_n49_;
  ...
  nand2  g21(.a(new_n34_), .b(new_n38_), .O(new_n46_));
  nand3  g22(.a(x4), .b(new_n25_), .c(x2), .O(new_n47_));
  nor2   g23(.a(new_n47_), .b(new_n46_), .O(z13));
  nand3  g24(.a(new_n28_), .b(new_n34_), .c(new_n38_), .O(new_n49_));
