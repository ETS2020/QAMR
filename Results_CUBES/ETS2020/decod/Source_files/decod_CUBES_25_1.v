...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n33_,
    new_n34_, new_n35_, new_n37_, new_n41_, new_n42_, new_n44_, new_n47_,
    new_n50_;
  ...
  nand3  g20(.a(new_n28_), .b(x1), .c(new_n41_), .O(new_n44_));
  nor2   g21(.a(new_n44_), .b(new_n23_), .O(z10));
  nor2   g22(.a(new_n44_), .b(new_n26_), .O(z11));
  nand3  g23(.a(x2), .b(new_n33_), .c(new_n41_), .O(new_n47_));
  nor2   g24(.a(new_n47_), .b(new_n23_), .O(z12));
  nor2   g25(.a(new_n47_), .b(new_n26_), .O(z13));
  nand3  g26(.a(new_n28_), .b(new_n33_), .c(new_n41_), .O(new_n50_));
