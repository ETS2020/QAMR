...
module FAU ( 
  ...
  nand3  g21(.a(x4), .b(x3), .c(new_n28_), .O(new_n44_));
  nor2   g22(.a(new_n44_), .b(new_n40_), .O(z10));
  nand2  g23(.a(new_n32_), .b(new_n39_), .O(new_n47_));
  nor2   g24(.a(new_n47_), .b(new_n41_), .O(z12));
  nand3  g25(.a(new_n28_), .b(new_n32_), .c(new_n39_), .O(new_n50_));
