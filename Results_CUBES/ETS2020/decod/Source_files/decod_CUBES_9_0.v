...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n32_,
    new_n33_, new_n34_, new_n37_, new_n41_, new_n42_, new_n43_, new_n46_,
    new_n49_, new_n51_;
  ...
  nand2  g23(.a(new_n32_), .b(new_n41_), .O(new_n49_));
  nor2   g24(.a(new_n49_), .b(new_n43_), .O(z13));
  nand3  g25(.a(new_n28_), .b(new_n32_), .c(new_n41_), .O(new_n51_));
