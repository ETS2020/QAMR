...
module FAU ( 
  ...
  nor2   g22(.a(new_n45_), .b(new_n38_), .O(z10));
  nand2  g23(.a(new_n33_), .b(new_n41_), .O(new_n49_));
  nand3  g24(.a(x4), .b(new_n30_), .c(x2), .O(new_n50_));
  nor2   g25(.a(new_n50_), .b(new_n49_), .O(z13));
  nand3  g26(.a(new_n26_), .b(new_n33_), .c(new_n41_), .O(new_n52_));
