...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n32_,
    new_n33_, new_n36_, new_n39_, new_n40_, new_n41_, new_n44_, new_n48_,
    new_n49_, new_n51_;
  ...
  nand3  g21(.a(new_n28_), .b(x1), .c(new_n39_), .O(new_n44_));
  nor2   g22(.a(new_n44_), .b(new_n23_), .O(z10));
  nor2   g23(.a(new_n44_), .b(new_n26_), .O(z11));
  nand2  g24(.a(new_n32_), .b(new_n39_), .O(new_n48_));
  nand3  g25(.a(x4), .b(new_n25_), .c(x2), .O(new_n49_));
  nor2   g26(.a(new_n49_), .b(new_n48_), .O(z13));
  nand3  g27(.a(new_n28_), .b(new_n32_), .c(new_n39_), .O(new_n51_));
  nor2   g28(.a(new_n51_), .b(new_n23_), .O(z14));
  nor2   g29(.a(new_n51_), .b(new_n26_), .O(z15));
  zero   g30(.O(z09));
  zero   g31(.O(z12));
endmodule
