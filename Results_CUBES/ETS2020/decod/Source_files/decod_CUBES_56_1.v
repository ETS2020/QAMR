...
module FAU ( 
  ...
  wire new_n23_, new_n24_, new_n25_, new_n27_, new_n28_, new_n29_, new_n31_,
    new_n34_, new_n35_, new_n38_, new_n41_, new_n42_, new_n46_, new_n49_;
  ...
  nor2   g18(.a(new_n42_), .b(new_n38_), .O(z11));
  nand3  g19(.a(x2), .b(new_n34_), .c(new_n41_), .O(new_n46_));
  nor2   g20(.a(new_n46_), .b(new_n29_), .O(z12));
  nor2   g21(.a(new_n46_), .b(new_n31_), .O(z13));
  nand3  g22(.a(new_n27_), .b(new_n34_), .c(new_n41_), .O(new_n49_));
