// Benchmark "FAU" written by ABC on Tue Jul  7 10:45:55 2020
...
module FAU ( 
  ...
  nor2   g12(.a(new_n37_), .b(new_n31_), .O(z07));
  ...
  nand3  g17(.a(new_n30_), .b(x1), .c(new_n39_), .O(new_n43_));
  nor2   g18(.a(new_n43_), .b(new_n23_), .O(z10));
  nor2   g19(.a(new_n43_), .b(new_n26_), .O(z11));
  nand2  g20(.a(new_n36_), .b(new_n39_), .O(new_n47_));
