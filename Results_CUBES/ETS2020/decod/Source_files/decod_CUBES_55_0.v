...
module FAU ( 
  ...
  wire new_n23_, new_n24_, new_n25_, new_n27_, new_n28_, new_n29_, new_n31_,
    new_n35_, new_n36_, new_n40_, new_n41_, new_n44_, new_n47_, new_n49_;
  ...
  nand3  g21(.a(new_n27_), .b(new_n35_), .c(new_n40_), .O(new_n49_));
  nor2   g22(.a(new_n49_), .b(new_n29_), .O(z14));
  nor2   g23(.a(new_n49_), .b(new_n31_), .O(z15));
  zero   g24(.O(z00));
  zero   g25(.O(z04));
  zero   g26(.O(z05));
  zero   g27(.O(z08));
