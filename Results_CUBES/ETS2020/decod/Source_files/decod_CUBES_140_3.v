...
module FAU ( 
  ...
  nand3  g21(.a(x4), .b(x3), .c(new_n27_), .O(new_n45_));
  nor2   g22(.a(new_n45_), .b(new_n44_), .O(z10));
  nand3  g23(.a(x2), .b(new_n31_), .c(new_n40_), .O(new_n48_));
  nor2   g24(.a(new_n48_), .b(new_n33_), .O(z12));
  nor2   g25(.a(new_n48_), .b(new_n35_), .O(z13));
  nand3  g26(.a(new_n27_), .b(new_n31_), .c(new_n40_), .O(new_n51_));
  nor2   g27(.a(new_n51_), .b(new_n33_), .O(z14));
