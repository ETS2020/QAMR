...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n26_, new_n27_, new_n30_, new_n31_, new_n32_,
    new_n34_, new_n35_, new_n38_, new_n39_, new_n41_, new_n42_, new_n45_,
    new_n50_;
  ...
  nand2  g13(.a(new_n30_), .b(x0), .O(new_n38_));
  nand3  g14(.a(x4), .b(new_n34_), .c(new_n26_), .O(new_n39_));
  nor2   g15(.a(new_n39_), .b(new_n38_), .O(z07));
  inv1   g16(.a(x0), .O(new_n41_));
  nand2  g17(.a(x1), .b(new_n41_), .O(new_n42_));
  nor2   g18(.a(new_n42_), .b(new_n23_), .O(z08));
  nand3  g19(.a(new_n26_), .b(x1), .c(new_n41_), .O(new_n45_));
  nor2   g20(.a(new_n45_), .b(new_n32_), .O(z10));
  nor2   g21(.a(new_n45_), .b(new_n35_), .O(z11));
  nand2  g22(.a(new_n30_), .b(new_n41_), .O(new_n50_));
  nor2   g23(.a(new_n50_), .b(new_n27_), .O(z14));
  zero   g24(.O(z01));
  zero   g25(.O(z03));
  zero   g26(.O(z06));
  zero   g27(.O(z09));
