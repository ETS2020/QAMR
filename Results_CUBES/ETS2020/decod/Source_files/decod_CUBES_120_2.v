...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n29_, new_n30_, new_n31_,
    new_n33_, new_n34_, new_n37_, new_n40_, new_n41_, new_n42_, new_n45_,
    new_n48_, new_n51_;
  ...
  nor2   g20(.a(new_n42_), .b(new_n41_), .O(z08));
  nand3  g21(.a(new_n30_), .b(x1), .c(new_n40_), .O(new_n45_));
  nor2   g22(.a(new_n45_), .b(new_n23_), .O(z10));
  nor2   g23(.a(new_n45_), .b(new_n26_), .O(z11));
  nand2  g24(.a(new_n33_), .b(new_n40_), .O(new_n48_));
  nor2   g25(.a(new_n48_), .b(new_n42_), .O(z12));
  nand3  g26(.a(x4), .b(x3), .c(new_n30_), .O(new_n51_));
  nor2   g27(.a(new_n51_), .b(new_n48_), .O(z14));
  zero   g28(.O(z02));
  zero   g29(.O(z09));
  zero   g30(.O(z13));
  zero   g31(.O(z15));
