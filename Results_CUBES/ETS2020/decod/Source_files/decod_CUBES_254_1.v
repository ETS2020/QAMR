...
module FAU ( 
  ...
  wire new_n23_, new_n24_, new_n25_, new_n27_, new_n28_, new_n29_, new_n31_,
    new_n33_, new_n34_, new_n38_, new_n39_, new_n42_, new_n43_, new_n47_,
    new_n51_;
  ...
  nor2   g20(.a(new_n43_), .b(new_n39_), .O(z11));
  nand3  g21(.a(x2), .b(new_n33_), .c(new_n42_), .O(new_n47_));
  nor2   g22(.a(new_n47_), .b(new_n29_), .O(z12));
  nor2   g23(.a(new_n47_), .b(new_n31_), .O(z13));
  nand2  g24(.a(new_n33_), .b(new_n42_), .O(new_n51_));
  nor2   g25(.a(new_n51_), .b(new_n39_), .O(z15));
  zero   g26(.O(z00));
  zero   g27(.O(z06));
  zero   g28(.O(z08));
  zero   g29(.O(z10));
