...
module FAU ( 
  ...
  nor2   g17(.a(new_n41_), .b(new_n32_), .O(z08));
  nor2   g18(.a(new_n41_), .b(new_n35_), .O(z09));
  nand3  g19(.a(new_n26_), .b(x1), .c(new_n40_), .O(new_n44_));
  nor2   g20(.a(new_n44_), .b(new_n32_), .O(z10));
  nor2   g21(.a(new_n44_), .b(new_n35_), .O(z11));
  nand2  g22(.a(new_n30_), .b(new_n40_), .O(new_n47_));
  nor2   g23(.a(new_n47_), .b(new_n23_), .O(z12));
  nand3  g24(.a(x4), .b(new_n34_), .c(new_n26_), .O(new_n51_));
  nor2   g25(.a(new_n51_), .b(new_n47_), .O(z15));
  zero   g26(.O(z01));
  zero   g27(.O(z03));
  zero   g28(.O(z07));
  zero   g29(.O(z13));
