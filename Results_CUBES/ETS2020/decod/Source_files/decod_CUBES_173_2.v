...
module FAU ( 
  ...
  wire new_n23_, new_n24_, new_n25_, new_n27_, new_n28_, new_n31_, new_n32_,
    new_n33_, new_n36_, new_n37_, new_n39_, new_n41_, new_n42_, new_n49_;
  ...
  nor2   g18(.a(new_n42_), .b(new_n33_), .O(z08));
  nor2   g19(.a(new_n42_), .b(new_n28_), .O(z10));
  nand3  g20(.a(new_n27_), .b(new_n31_), .c(new_n41_), .O(new_n49_));
  nor2   g21(.a(new_n49_), .b(new_n37_), .O(z14));
  nor2   g22(.a(new_n49_), .b(new_n39_), .O(z15));
  zero   g23(.O(z00));
  zero   g24(.O(z03));
  zero   g25(.O(z05));
  zero   g26(.O(z09));
