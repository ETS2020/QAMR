...
module FAU ( 
  ...
  wire new_n23_, new_n24_, new_n25_, new_n27_, new_n28_, new_n29_, new_n31_,
    new_n33_, new_n34_, new_n35_, new_n38_, new_n42_, new_n43_, new_n48_,
    new_n50_;
  ...
  nand2  g20(.a(new_n33_), .b(new_n42_), .O(new_n48_));
  nor2   g21(.a(new_n48_), .b(new_n25_), .O(z13));
  nand3  g22(.a(new_n27_), .b(new_n33_), .c(new_n42_), .O(new_n50_));
  nor2   g23(.a(new_n50_), .b(new_n29_), .O(z14));
