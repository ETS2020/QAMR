...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n29_, new_n30_, new_n31_,
    new_n33_, new_n34_, new_n39_, new_n40_, new_n41_, new_n44_, new_n47_,
    new_n50_;
  ...
  nand3  g20(.a(x2), .b(new_n33_), .c(new_n39_), .O(new_n47_));
  nor2   g21(.a(new_n47_), .b(new_n23_), .O(z12));
  nor2   g22(.a(new_n47_), .b(new_n26_), .O(z13));
  nand2  g23(.a(new_n33_), .b(new_n39_), .O(new_n50_));
