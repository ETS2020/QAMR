...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n33_,
    new_n34_, new_n35_, new_n38_, new_n41_, new_n42_, new_n44_, new_n47_,
    new_n50_;
  ...
  nor2   g18(.a(new_n42_), .b(new_n35_), .O(z09));
  nand3  g19(.a(new_n28_), .b(x1), .c(new_n41_), .O(new_n44_));
  nor2   g20(.a(new_n44_), .b(new_n23_), .O(z10));
  ...
  nand3  g25(.a(new_n28_), .b(new_n33_), .c(new_n41_), .O(new_n50_));
  nor2   g26(.a(new_n50_), .b(new_n23_), .O(z14));
  nor2   g27(.a(new_n50_), .b(new_n26_), .O(z15));
  zero   g28(.O(z04));
  zero   g29(.O(z06));
  zero   g30(.O(z08));
endmodule
