...
module FAU ( 
  ...
  wire new_n23_, new_n24_, new_n25_, new_n27_, new_n28_, new_n32_, new_n33_,
    new_n37_, new_n38_, new_n39_, new_n41_, new_n43_, new_n46_, new_n47_,
    new_n50_;
  ...
  nor2   g10(.a(new_n33_), .b(new_n28_), .O(z06));
  ...
  nand2  g15(.a(x4), .b(new_n24_), .O(new_n41_));
  nor2   g16(.a(new_n41_), .b(new_n38_), .O(z09));
  nand3  g17(.a(new_n27_), .b(x1), .c(new_n37_), .O(new_n43_));
  nor2   g18(.a(new_n43_), .b(new_n39_), .O(z10));
  nor2   g19(.a(new_n43_), .b(new_n41_), .O(z11));
  nand2  g20(.a(new_n32_), .b(new_n37_), .O(new_n46_));
  nand3  g21(.a(x4), .b(x3), .c(x2), .O(new_n47_));
  nor2   g22(.a(new_n47_), .b(new_n46_), .O(z12));
  nand3  g23(.a(new_n27_), .b(new_n32_), .c(new_n37_), .O(new_n50_));
  nor2   g24(.a(new_n50_), .b(new_n39_), .O(z14));
  nor2   g25(.a(new_n50_), .b(new_n41_), .O(z15));
  zero   g26(.O(z00));
  zero   g27(.O(z03));
  zero   g28(.O(z04));
  zero   g29(.O(z07));
