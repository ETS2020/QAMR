...
module FAU ( 
  ...
  nand2  g23(.a(new_n34_), .b(new_n41_), .O(new_n49_));
  nor2   g24(.a(new_n49_), .b(new_n36_), .O(z13));
  nand3  g25(.a(new_n26_), .b(new_n34_), .c(new_n41_), .O(new_n51_));
  nor2   g26(.a(new_n51_), .b(new_n28_), .O(z14));
