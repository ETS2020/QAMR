// Benchmark "FAU" written by ABC on Tue Jul  7 10:46:07 2020
...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n32_,
    new_n33_, new_n36_, new_n37_, new_n40_, new_n41_, new_n42_, new_n45_,
    new_n48_, new_n51_;
  ...
  nand2  g24(.a(new_n32_), .b(new_n40_), .O(new_n48_));
  nor2   g25(.a(new_n48_), .b(new_n42_), .O(z12));
  nand3  g26(.a(new_n28_), .b(new_n32_), .c(new_n40_), .O(new_n51_));
