...
module FAU ( 
  ...
  nand2  g19(.a(new_n31_), .b(new_n42_), .O(new_n48_));
  nor2   g20(.a(new_n48_), .b(new_n25_), .O(z13));
  nand3  g21(.a(x4), .b(new_n24_), .c(new_n27_), .O(new_n51_));
  nor2   g22(.a(new_n51_), .b(new_n48_), .O(z15));
  zero   g23(.O(z00));
  zero   g24(.O(z03));
  zero   g25(.O(z05));
  zero   g26(.O(z08));
