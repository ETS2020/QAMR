...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n34_,
    new_n35_, new_n39_, new_n40_, new_n41_, new_n44_, new_n46_, new_n49_;
  ...
  nand3  g20(.a(x2), .b(new_n34_), .c(new_n39_), .O(new_n46_));
  nor2   g21(.a(new_n46_), .b(new_n23_), .O(z12));
  nor2   g22(.a(new_n46_), .b(new_n26_), .O(z13));
  nand3  g23(.a(new_n28_), .b(new_n34_), .c(new_n39_), .O(new_n49_));
