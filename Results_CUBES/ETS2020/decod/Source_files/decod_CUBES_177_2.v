...
module FAU ( 
  ...
  wire new_n24_, new_n25_, new_n26_, new_n28_, new_n29_, new_n31_, new_n32_,
    new_n37_, new_n38_, new_n39_, new_n42_, new_n45_;
  ...
  nand3  g15(.a(x4), .b(x3), .c(new_n24_), .O(new_n42_));
  nor2   g16(.a(new_n42_), .b(new_n38_), .O(z10));
  nand3  g17(.a(x2), .b(new_n31_), .c(new_n37_), .O(new_n45_));
  nor2   g18(.a(new_n45_), .b(new_n26_), .O(z12));
  nor2   g19(.a(new_n45_), .b(new_n29_), .O(z13));
  zero   g20(.O(z00));
  zero   g21(.O(z01));
  zero   g22(.O(z06));
  zero   g23(.O(z07));
