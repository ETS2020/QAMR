...
module FAU ( 
  ...
  wire new_n23_, new_n24_, new_n25_, new_n27_, new_n28_, new_n33_, new_n34_,
    new_n35_, new_n37_, new_n39_, new_n40_, new_n41_, new_n44_, new_n47_;
  ...
  nand3  g17(.a(new_n27_), .b(x1), .c(new_n39_), .O(new_n44_));
  nor2   g18(.a(new_n44_), .b(new_n35_), .O(z10));
  nor2   g19(.a(new_n44_), .b(new_n37_), .O(z11));
  nand3  g20(.a(x2), .b(new_n33_), .c(new_n39_), .O(new_n47_));
  nor2   g21(.a(new_n47_), .b(new_n35_), .O(z12));
  nor2   g22(.a(new_n47_), .b(new_n37_), .O(z13));
  zero   g23(.O(z00));
  zero   g24(.O(z03));
  zero   g25(.O(z04));
  zero   g26(.O(z05));
