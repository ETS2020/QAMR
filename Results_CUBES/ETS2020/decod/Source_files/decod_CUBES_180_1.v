...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n33_,
    new_n34_, new_n35_, new_n37_, new_n41_, new_n42_, new_n45_, new_n48_;
  ...
  nand3  g14(.a(new_n28_), .b(new_n33_), .c(x0), .O(new_n37_));
  ...
  nand3  g20(.a(x4), .b(new_n25_), .c(new_n28_), .O(new_n45_));
  nor2   g21(.a(new_n45_), .b(new_n42_), .O(z11));
  nand2  g22(.a(new_n33_), .b(new_n41_), .O(new_n48_));
  nor2   g23(.a(new_n48_), .b(new_n35_), .O(z13));
  nor2   g24(.a(new_n48_), .b(new_n45_), .O(z15));
  zero   g25(.O(z04));
  zero   g26(.O(z08));
  zero   g27(.O(z10));
  zero   g28(.O(z12));
