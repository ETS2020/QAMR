...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n30_, new_n31_, new_n35_,
    new_n36_, new_n37_, new_n39_, new_n40_, new_n41_, new_n46_, new_n50_;
  ...
  nand2  g10(.a(new_n30_), .b(x0), .O(new_n35_));
  inv1   g11(.a(x2), .O(new_n36_));
  nand3  g12(.a(x4), .b(new_n25_), .c(new_n36_), .O(new_n37_));
  nor2   g13(.a(new_n37_), .b(new_n35_), .O(z07));
  ...
  nor2   g18(.a(new_n40_), .b(new_n37_), .O(z11));
  nand3  g19(.a(x2), .b(new_n30_), .c(new_n39_), .O(new_n46_));
  nor2   g20(.a(new_n46_), .b(new_n23_), .O(z12));
  nor2   g21(.a(new_n46_), .b(new_n26_), .O(z13));
  nand2  g22(.a(new_n30_), .b(new_n39_), .O(new_n50_));
  nor2   g23(.a(new_n50_), .b(new_n37_), .O(z15));
  zero   g24(.O(z02));
  zero   g25(.O(z03));
  zero   g26(.O(z06));
  zero   g27(.O(z09));
