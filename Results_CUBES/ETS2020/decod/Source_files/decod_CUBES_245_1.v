...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n34_,
    new_n35_, new_n39_, new_n40_, new_n41_, new_n44_, new_n46_, new_n47_,
    new_n50_;
  ...
  nand2  g20(.a(new_n34_), .b(new_n39_), .O(new_n46_));
  nand3  g21(.a(x4), .b(x3), .c(x2), .O(new_n47_));
  nor2   g22(.a(new_n47_), .b(new_n46_), .O(z12));
  nand3  g23(.a(new_n28_), .b(new_n34_), .c(new_n39_), .O(new_n50_));
