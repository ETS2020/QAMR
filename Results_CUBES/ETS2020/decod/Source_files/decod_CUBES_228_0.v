...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n27_, new_n28_, new_n29_, new_n32_, new_n33_,
    new_n34_, new_n36_, new_n37_, new_n39_, new_n42_, new_n43_, new_n48_,
    new_n50_;
  ...
  nor2   g18(.a(new_n43_), .b(new_n34_), .O(z09));
  nor2   g19(.a(new_n43_), .b(new_n29_), .O(z11));
  nand2  g20(.a(new_n32_), .b(new_n42_), .O(new_n48_));
  nor2   g21(.a(new_n48_), .b(new_n34_), .O(z13));
  nand3  g22(.a(new_n27_), .b(new_n32_), .c(new_n42_), .O(new_n50_));
