...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n32_,
    new_n33_, new_n36_, new_n39_, new_n40_, new_n43_, new_n46_, new_n47_,
    new_n50_;
  ...
  nand2  g24(.a(new_n32_), .b(new_n39_), .O(new_n46_));
  nand3  g25(.a(x4), .b(x3), .c(x2), .O(new_n47_));
  nor2   g26(.a(new_n47_), .b(new_n46_), .O(z12));
