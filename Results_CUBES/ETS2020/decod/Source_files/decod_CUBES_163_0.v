...
module FAU ( 
  ...
  nand3  g21(.a(new_n30_), .b(x1), .c(new_n42_), .O(new_n46_));
  nor2   g22(.a(new_n46_), .b(new_n23_), .O(z10));
  nor2   g23(.a(new_n46_), .b(new_n26_), .O(z11));
  nand3  g24(.a(x2), .b(new_n33_), .c(new_n42_), .O(new_n49_));
  nor2   g25(.a(new_n49_), .b(new_n23_), .O(z12));
  nor2   g26(.a(new_n49_), .b(new_n26_), .O(z13));
  nand3  g27(.a(new_n30_), .b(new_n33_), .c(new_n42_), .O(new_n52_));
