...
module FAU ( 
  ...
  wire new_n24_, new_n25_, new_n26_, new_n28_, new_n29_, new_n31_, new_n32_,
    new_n35_, new_n39_, new_n40_, new_n41_, new_n43_, new_n49_, new_n50_;
  ...
  nand2  g21(.a(new_n31_), .b(new_n39_), .O(new_n49_));
  nand3  g22(.a(x4), .b(new_n28_), .c(new_n24_), .O(new_n50_));
