...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n29_, new_n30_, new_n31_,
    new_n33_, new_n34_, new_n37_, new_n40_, new_n41_, new_n45_, new_n48_,
    new_n49_, new_n51_;
  ...
  nand3  g24(.a(x4), .b(new_n25_), .c(x2), .O(new_n49_));
  nor2   g25(.a(new_n49_), .b(new_n48_), .O(z13));
  nand3  g26(.a(new_n30_), .b(new_n33_), .c(new_n40_), .O(new_n51_));
