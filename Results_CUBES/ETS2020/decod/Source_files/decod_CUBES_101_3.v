...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n30_, new_n31_, new_n34_,
    new_n35_, new_n38_, new_n39_, new_n42_, new_n45_, new_n46_, new_n49_;
  ...
  nand2  g21(.a(new_n30_), .b(new_n38_), .O(new_n45_));
  nand3  g22(.a(x4), .b(x3), .c(x2), .O(new_n46_));
  nor2   g23(.a(new_n46_), .b(new_n45_), .O(z12));
  nand3  g24(.a(x4), .b(x3), .c(new_n34_), .O(new_n49_));
  nor2   g25(.a(new_n49_), .b(new_n45_), .O(z14));
  zero   g26(.O(z02));
  zero   g27(.O(z03));
  zero   g28(.O(z13));
  zero   g29(.O(z15));
