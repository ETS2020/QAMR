...
module FAU ( 
  ...
  nand3  g18(.a(x2), .b(new_n35_), .c(new_n40_), .O(new_n46_));
  nor2   g19(.a(new_n46_), .b(new_n28_), .O(z12));
  nor2   g20(.a(new_n46_), .b(new_n31_), .O(z13));
  nand2  g21(.a(new_n35_), .b(new_n40_), .O(new_n49_));
