...
module FAU ( 
  ...
  wire new_n23_, new_n24_, new_n25_, new_n27_, new_n28_, new_n29_, new_n31_,
    new_n36_, new_n37_, new_n38_, new_n41_, new_n42_, new_n47_;
  ...
  inv1   g10(.a(x1), .O(new_n36_));
  nand2  g11(.a(new_n36_), .b(x0), .O(new_n37_));
  nand3  g12(.a(x4), .b(new_n24_), .c(new_n27_), .O(new_n38_));
  ...
  nor2   g17(.a(new_n42_), .b(new_n38_), .O(z11));
  nand2  g18(.a(new_n36_), .b(new_n41_), .O(new_n47_));
