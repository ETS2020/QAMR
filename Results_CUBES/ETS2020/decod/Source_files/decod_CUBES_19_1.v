...
module FAU ( 
  ...
  nand3  g20(.a(x4), .b(new_n25_), .c(new_n28_), .O(new_n46_));
  nor2   g21(.a(new_n46_), .b(new_n41_), .O(z11));
  nand2  g22(.a(new_n33_), .b(new_n40_), .O(new_n49_));
  nor2   g23(.a(new_n49_), .b(new_n35_), .O(z13));
  nand3  g24(.a(new_n28_), .b(new_n33_), .c(new_n40_), .O(new_n51_));
