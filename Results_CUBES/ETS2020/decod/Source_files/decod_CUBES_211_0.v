...
module FAU ( 
  ...
  wire new_n23_, new_n24_, new_n25_, new_n27_, new_n28_, new_n29_, new_n31_,
    new_n33_, new_n34_, new_n35_, new_n39_, new_n41_, new_n42_, new_n46_,
    new_n49_, new_n51_;
  ...
  nand3  g14(.a(x4), .b(new_n24_), .c(new_n27_), .O(new_n39_));
  nor2   g15(.a(new_n39_), .b(new_n34_), .O(z07));
  inv1   g16(.a(x0), .O(new_n41_));
  nand3  g17(.a(x2), .b(x1), .c(new_n41_), .O(new_n42_));
  nor2   g18(.a(new_n42_), .b(new_n29_), .O(z08));
  nor2   g19(.a(new_n42_), .b(new_n31_), .O(z09));
  nand2  g20(.a(x1), .b(new_n41_), .O(new_n46_));
  nor2   g21(.a(new_n46_), .b(new_n39_), .O(z11));
  nand2  g22(.a(new_n33_), .b(new_n41_), .O(new_n49_));
  nor2   g23(.a(new_n49_), .b(new_n25_), .O(z13));
  nand3  g24(.a(new_n27_), .b(new_n33_), .c(new_n41_), .O(new_n51_));
  nor2   g25(.a(new_n51_), .b(new_n29_), .O(z14));
  nor2   g26(.a(new_n51_), .b(new_n31_), .O(z15));
  zero   g27(.O(z00));
  zero   g28(.O(z05));
  zero   g29(.O(z06));
  zero   g30(.O(z10));
