...
module FAU ( 
  ...
  nand3  g14(.a(x4), .b(new_n24_), .c(new_n32_), .O(new_n43_));
  nor2   g15(.a(new_n43_), .b(new_n40_), .O(z11));
  nand2  g16(.a(new_n31_), .b(new_n39_), .O(new_n46_));
  nor2   g17(.a(new_n46_), .b(new_n25_), .O(z13));
  nand3  g18(.a(new_n32_), .b(new_n31_), .c(new_n39_), .O(new_n48_));
  nor2   g19(.a(new_n48_), .b(new_n34_), .O(z14));
  nor2   g20(.a(new_n48_), .b(new_n36_), .O(z15));
  zero   g21(.O(z00));
  zero   g22(.O(z02));
  zero   g23(.O(z03));
  zero   g24(.O(z04));
