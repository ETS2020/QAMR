...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n26_, new_n27_, new_n28_, new_n30_, new_n31_,
    new_n33_, new_n34_, new_n39_, new_n40_, new_n43_, new_n44_, new_n47_,
    new_n50_;
  ...
  nand3  g18(.a(x4), .b(x3), .c(new_n26_), .O(new_n44_));
  nor2   g19(.a(new_n44_), .b(new_n43_), .O(z10));
  nand2  g20(.a(new_n33_), .b(new_n39_), .O(new_n47_));
  nor2   g21(.a(new_n47_), .b(new_n23_), .O(z12));
  nand3  g22(.a(new_n26_), .b(new_n33_), .c(new_n39_), .O(new_n50_));
  nor2   g23(.a(new_n50_), .b(new_n28_), .O(z14));
  nor2   g24(.a(new_n50_), .b(new_n31_), .O(z15));
  zero   g25(.O(z01));
  zero   g26(.O(z05));
  zero   g27(.O(z06));
  zero   g28(.O(z07));
