...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n30_,
    new_n34_, new_n35_, new_n36_, new_n38_, new_n41_, new_n42_, new_n43_,
    new_n48_;
  ...
  nand3  g14(.a(new_n29_), .b(new_n34_), .c(x0), .O(new_n38_));
  ...
  nor2   g21(.a(new_n42_), .b(new_n30_), .O(z10));
  nand2  g22(.a(new_n34_), .b(new_n41_), .O(new_n48_));
  nor2   g23(.a(new_n48_), .b(new_n43_), .O(z12));
  nor2   g24(.a(new_n48_), .b(new_n30_), .O(z14));
  zero   g25(.O(z03));
  zero   g26(.O(z04));
  zero   g27(.O(z09));
  zero   g28(.O(z11));
