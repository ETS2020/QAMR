...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n29_, new_n30_, new_n31_,
    new_n33_, new_n34_, new_n38_, new_n40_, new_n41_, new_n42_, new_n47_,
    new_n50_;
  ...
  nor2   g22(.a(new_n47_), .b(new_n42_), .O(z12));
  nand3  g23(.a(new_n30_), .b(new_n33_), .c(new_n40_), .O(new_n50_));
