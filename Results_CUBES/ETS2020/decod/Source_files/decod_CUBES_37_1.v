// Benchmark "FAU" written by ABC on Tue Jul  7 10:46:04 2020
...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n32_,
    new_n33_, new_n36_, new_n39_, new_n40_, new_n43_, new_n47_, new_n48_,
    new_n50_;
  ...
  nand2  g24(.a(new_n32_), .b(new_n39_), .O(new_n47_));
  nand3  g25(.a(x4), .b(new_n25_), .c(x2), .O(new_n48_));
  nor2   g26(.a(new_n48_), .b(new_n47_), .O(z13));
  nand3  g27(.a(x4), .b(x3), .c(new_n28_), .O(new_n50_));
  nor2   g28(.a(new_n50_), .b(new_n47_), .O(z14));
  zero   g29(.O(z12));
  zero   g30(.O(z15));
endmodule
