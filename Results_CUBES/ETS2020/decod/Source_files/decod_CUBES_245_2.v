...
module FAU ( 
  ...
  nand3  g18(.a(new_n26_), .b(x1), .c(new_n39_), .O(new_n43_));
  nor2   g19(.a(new_n43_), .b(new_n28_), .O(z10));
  nor2   g20(.a(new_n43_), .b(new_n31_), .O(z11));
  nand3  g21(.a(x2), .b(new_n33_), .c(new_n39_), .O(new_n46_));
  nor2   g22(.a(new_n46_), .b(new_n28_), .O(z12));
  nor2   g23(.a(new_n46_), .b(new_n31_), .O(z13));
  nand2  g24(.a(new_n33_), .b(new_n39_), .O(new_n49_));
  nand3  g25(.a(x4), .b(x3), .c(new_n26_), .O(new_n50_));
