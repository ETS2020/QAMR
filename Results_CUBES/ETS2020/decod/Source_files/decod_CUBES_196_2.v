...
module FAU ( 
  ...
  wire new_n23_, new_n24_, new_n25_, new_n29_, new_n30_, new_n31_, new_n35_,
    new_n36_, new_n38_, new_n39_, new_n40_, new_n42_, new_n46_, new_n49_;
  ...
  nand3  g17(.a(x2), .b(new_n29_), .c(new_n38_), .O(new_n46_));
  nor2   g18(.a(new_n46_), .b(new_n40_), .O(z12));
  nor2   g19(.a(new_n46_), .b(new_n42_), .O(z13));
  nand3  g20(.a(new_n35_), .b(new_n29_), .c(new_n38_), .O(new_n49_));
  nor2   g21(.a(new_n49_), .b(new_n40_), .O(z14));
  nor2   g22(.a(new_n49_), .b(new_n42_), .O(z15));
  zero   g23(.O(z00));
  zero   g24(.O(z02));
  zero   g25(.O(z03));
  zero   g26(.O(z05));
