...
module FAU ( 
  ...
  nand3  g23(.a(x2), .b(new_n33_), .c(new_n42_), .O(new_n48_));
  nor2   g24(.a(new_n48_), .b(new_n29_), .O(z12));
  nor2   g25(.a(new_n48_), .b(new_n31_), .O(z13));
  nand2  g26(.a(new_n33_), .b(new_n42_), .O(new_n52_));
  nand3  g27(.a(x4), .b(new_n24_), .c(new_n27_), .O(new_n53_));
  nor2   g28(.a(new_n53_), .b(new_n52_), .O(z15));
  zero   g29(.O(z00));
  zero   g30(.O(z05));
  zero   g31(.O(z08));
  zero   g32(.O(z14));
