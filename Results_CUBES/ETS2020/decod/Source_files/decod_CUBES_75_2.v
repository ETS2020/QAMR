...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n29_, new_n30_, new_n31_, new_n32_, new_n35_,
    new_n36_, new_n38_, new_n39_, new_n44_, new_n45_, new_n47_, new_n50_;
  ...
  nor2   g14(.a(new_n39_), .b(new_n36_), .O(z11));
  nand3  g15(.a(x2), .b(new_n29_), .c(new_n38_), .O(new_n44_));
  nand2  g16(.a(x4), .b(x3), .O(new_n45_));
  nor2   g17(.a(new_n45_), .b(new_n44_), .O(z12));
  nand2  g18(.a(x4), .b(new_n31_), .O(new_n47_));
  nor2   g19(.a(new_n47_), .b(new_n44_), .O(z13));
  nand2  g20(.a(new_n29_), .b(new_n38_), .O(new_n50_));
  nor2   g21(.a(new_n50_), .b(new_n36_), .O(z15));
  zero   g22(.O(z01));
  zero   g23(.O(z02));
  zero   g24(.O(z03));
  zero   g25(.O(z04));
