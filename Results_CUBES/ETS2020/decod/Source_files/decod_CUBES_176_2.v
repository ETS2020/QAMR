...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n30_, new_n31_, new_n33_, new_n34_,
    new_n37_, new_n38_, new_n39_, new_n43_, new_n45_, new_n49_;
  ...
  nand3  g08(.a(new_n33_), .b(new_n26_), .c(x0), .O(new_n34_));
  nor2   g09(.a(new_n34_), .b(new_n28_), .O(z06));
  nor2   g10(.a(new_n34_), .b(new_n31_), .O(z07));
  ...
  nand3  g15(.a(x4), .b(new_n30_), .c(new_n33_), .O(new_n43_));
  nor2   g16(.a(new_n43_), .b(new_n38_), .O(z11));
  nand3  g17(.a(x2), .b(new_n26_), .c(new_n37_), .O(new_n45_));
  nor2   g18(.a(new_n45_), .b(new_n28_), .O(z12));
  nor2   g19(.a(new_n45_), .b(new_n31_), .O(z13));
  nand2  g20(.a(new_n26_), .b(new_n37_), .O(new_n49_));
  nor2   g21(.a(new_n49_), .b(new_n43_), .O(z15));
  zero   g22(.O(z00));
  zero   g23(.O(z01));
  zero   g24(.O(z02));
  zero   g25(.O(z03));
