...
module FAU ( 
  ...
  wire new_n23_, new_n24_, new_n25_, new_n28_, new_n29_, new_n31_, new_n32_,
    new_n33_, new_n38_, new_n39_, new_n40_, new_n42_, new_n45_, new_n47_,
    new_n50_;
  ...
  nand2  g18(.a(x1), .b(new_n38_), .O(new_n45_));
  nor2   g19(.a(new_n45_), .b(new_n29_), .O(z11));
  nand3  g20(.a(x2), .b(new_n31_), .c(new_n38_), .O(new_n47_));
  nor2   g21(.a(new_n47_), .b(new_n40_), .O(z12));
  nor2   g22(.a(new_n47_), .b(new_n42_), .O(z13));
  nand3  g23(.a(new_n28_), .b(new_n31_), .c(new_n38_), .O(new_n50_));
