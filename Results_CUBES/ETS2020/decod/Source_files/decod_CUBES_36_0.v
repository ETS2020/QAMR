...
module FAU ( 
  ...
  nand3  g23(.a(x2), .b(new_n31_), .c(new_n41_), .O(new_n49_));
  nor2   g24(.a(new_n49_), .b(new_n37_), .O(z12));
  nor2   g25(.a(new_n49_), .b(new_n39_), .O(z13));
  nand2  g26(.a(new_n31_), .b(new_n41_), .O(new_n53_));
  nor2   g27(.a(new_n53_), .b(new_n47_), .O(z15));
  zero   g28(.O(z00));
  zero   g29(.O(z03));
  zero   g30(.O(z05));
  zero   g31(.O(z10));
