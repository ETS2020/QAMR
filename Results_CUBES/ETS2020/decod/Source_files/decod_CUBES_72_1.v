...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n33_,
    new_n34_, new_n35_, new_n37_, new_n42_, new_n43_, new_n46_, new_n49_;
  ...
  nand3  g18(.a(new_n28_), .b(x1), .c(new_n42_), .O(new_n43_));
  ...
  nand3  g24(.a(new_n28_), .b(new_n33_), .c(new_n42_), .O(new_n49_));
