...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n26_, new_n27_, new_n30_, new_n31_, new_n32_,
    new_n34_, new_n35_, new_n37_, new_n40_, new_n41_, new_n46_, new_n50_;
  ...
  nand2  g20(.a(new_n30_), .b(new_n40_), .O(new_n46_));
  nor2   g21(.a(new_n46_), .b(new_n23_), .O(z12));
  nand3  g22(.a(x4), .b(new_n34_), .c(new_n26_), .O(new_n50_));
  nor2   g23(.a(new_n50_), .b(new_n46_), .O(z15));
  zero   g24(.O(z01));
  zero   g25(.O(z03));
  zero   g26(.O(z09));
  zero   g27(.O(z11));
