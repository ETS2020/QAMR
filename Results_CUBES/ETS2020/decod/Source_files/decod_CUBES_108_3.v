// Benchmark "FAU" written by ABC on Tue Jul  7 10:46:21 2020
...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n29_, new_n32_,
    new_n33_, new_n34_, new_n37_, new_n40_, new_n41_, new_n46_, new_n49_;
  ...
  nor2   g18(.a(new_n41_), .b(new_n34_), .O(z08));
  nor2   g19(.a(new_n41_), .b(new_n37_), .O(z10));
  nand2  g20(.a(new_n32_), .b(new_n40_), .O(new_n46_));
  nor2   g21(.a(new_n46_), .b(new_n34_), .O(z12));
