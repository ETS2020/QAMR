...
module FAU ( 
  ...
  wire new_n23_, new_n24_, new_n25_, new_n28_, new_n29_, new_n31_, new_n32_,
    new_n33_, new_n35_, new_n37_, new_n41_, new_n42_, new_n44_, new_n47_,
    new_n50_;
  ...
  nand3  g13(.a(new_n28_), .b(new_n31_), .c(x0), .O(new_n37_));
  ...
  nand3  g19(.a(new_n28_), .b(x1), .c(new_n41_), .O(new_n44_));
  nor2   g20(.a(new_n44_), .b(new_n33_), .O(z10));
  nor2   g21(.a(new_n44_), .b(new_n35_), .O(z11));
  nand3  g22(.a(x2), .b(new_n31_), .c(new_n41_), .O(new_n47_));
  nor2   g23(.a(new_n47_), .b(new_n33_), .O(z12));
  nor2   g24(.a(new_n47_), .b(new_n35_), .O(z13));
  nand3  g25(.a(new_n28_), .b(new_n31_), .c(new_n41_), .O(new_n50_));
  nor2   g26(.a(new_n50_), .b(new_n33_), .O(z14));
  nor2   g27(.a(new_n50_), .b(new_n35_), .O(z15));
  zero   g28(.O(z00));
  zero   g29(.O(z02));
  zero   g30(.O(z08));
endmodule
