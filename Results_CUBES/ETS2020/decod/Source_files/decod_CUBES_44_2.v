...
module FAU ( 
  ...
  nand2  g21(.a(new_n34_), .b(new_n40_), .O(new_n49_));
  nor2   g22(.a(new_n49_), .b(new_n36_), .O(z13));
  nand3  g23(.a(new_n30_), .b(new_n34_), .c(new_n40_), .O(new_n51_));
  nor2   g24(.a(new_n51_), .b(new_n23_), .O(z14));
  nor2   g25(.a(new_n51_), .b(new_n26_), .O(z15));
  zero   g26(.O(z02));
  zero   g27(.O(z04));
  zero   g28(.O(z06));
  zero   g29(.O(z07));
