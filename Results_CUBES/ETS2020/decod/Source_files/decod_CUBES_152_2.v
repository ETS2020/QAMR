...
module FAU ( 
  ...
  wire new_n22_, new_n23_, new_n26_, new_n27_, new_n31_, new_n32_, new_n33_,
    new_n34_, new_n38_, new_n39_, new_n44_, new_n48_;
  ...
  nor2   g15(.a(new_n39_), .b(new_n27_), .O(z10));
  nand2  g16(.a(new_n31_), .b(new_n38_), .O(new_n44_));
  nor2   g17(.a(new_n44_), .b(new_n23_), .O(z12));
  nand3  g18(.a(x4), .b(new_n33_), .c(new_n26_), .O(new_n48_));
  nor2   g19(.a(new_n48_), .b(new_n44_), .O(z15));
  zero   g20(.O(z01));
  zero   g21(.O(z03));
  zero   g22(.O(z04));
  zero   g23(.O(z07));
