...
module FAU ( 
  ...
  oai21  g45(.a(new_n74_), .b(new_n72_), .c(x19), .O(new_n94_));
  nor2   g46(.a(new_n74_), .b(new_n72_), .O(new_n95_));
  nand2  g47(.a(new_n95_), .b(new_n75_), .O(new_n96_));
  ...
  nand2  g51(.a(new_n56_), .b(new_n87_), .O(new_n100_));
  inv1   g52(.a(new_n100_), .O(new_n101_));
  nand3  g53(.a(new_n101_), .b(new_n99_), .c(new_n66_), .O(z13));
  nor2   g54(.a(x21), .b(x20), .O(new_n103_));
  inv1   g55(.a(new_n103_), .O(new_n104_));
  aoi21  g56(.a(new_n66_), .b(x21), .c(new_n100_), .O(new_n105_));
  oai21  g57(.a(new_n104_), .b(new_n98_), .c(new_n105_), .O(z14));
  oai21  g58(.a(new_n104_), .b(new_n98_), .c(x22), .O(new_n107_));
  inv1   g59(.a(new_n98_), .O(new_n108_));
  nand3  g60(.a(new_n108_), .b(new_n67_), .c(new_n65_), .O(new_n109_));
  nand3  g61(.a(new_n109_), .b(new_n107_), .c(new_n101_), .O(z15));
  nand2  g62(.a(new_n67_), .b(new_n65_), .O(new_n111_));
  oai21  g63(.a(new_n111_), .b(new_n98_), .c(x23), .O(new_n112_));
  nand3  g64(.a(new_n103_), .b(new_n48_), .c(new_n52_), .O(new_n113_));
  inv1   g65(.a(new_n113_), .O(new_n114_));
  nand2  g66(.a(new_n114_), .b(new_n108_), .O(new_n115_));
  nand3  g67(.a(new_n115_), .b(new_n112_), .c(new_n101_), .O(z16));
  inv1   g68(.a(new_n69_), .O(new_n117_));
  inv1   g69(.a(new_n92_), .O(new_n118_));
  oai21  g70(.a(new_n113_), .b(new_n98_), .c(x24), .O(new_n119_));
  nand3  g71(.a(new_n119_), .b(new_n118_), .c(new_n117_), .O(z17));
  inv1   g72(.a(new_n66_), .O(new_n121_));
  nand4  g73(.a(new_n81_), .b(new_n67_), .c(new_n121_), .d(new_n48_), .O(new_n122_));
  nand2  g74(.a(new_n117_), .b(x25), .O(new_n123_));
  nand3  g75(.a(new_n123_), .b(new_n122_), .c(new_n101_), .O(z18));
  zero   g76(.O(z02));
  zero   g77(.O(z04));
  zero   g78(.O(z09));
endmodule
