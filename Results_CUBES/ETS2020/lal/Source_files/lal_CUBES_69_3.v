// Benchmark "FAU" written by ABC on Wed Jul  8 19:28:31 2020
...
module FAU ( 
  ...
  wire new_n46_, new_n48_, new_n49_, new_n50_, new_n51_, new_n52_, new_n53_,
    ...
    new_n88_, new_n91_, new_n92_, new_n93_, new_n94_, new_n97_, new_n98_,
  ...
  oai21  g49(.a(new_n79_), .b(new_n77_), .c(x19), .O(new_n97_));
  nor2   g50(.a(new_n79_), .b(new_n77_), .O(new_n98_));
  nand2  g51(.a(new_n98_), .b(new_n80_), .O(new_n99_));
  nand3  g52(.a(new_n93_), .b(new_n92_), .c(new_n91_), .O(new_n100_));
  aoi21  g53(.a(new_n99_), .b(new_n97_), .c(new_n100_), .O(z12));
  nand2  g54(.a(new_n98_), .b(x19), .O(new_n102_));
  nand2  g55(.a(new_n102_), .b(x20), .O(new_n103_));
  nand2  g56(.a(new_n56_), .b(new_n92_), .O(new_n104_));
  inv1   g57(.a(new_n104_), .O(new_n105_));
  nand3  g58(.a(new_n105_), .b(new_n103_), .c(new_n71_), .O(z13));
  nor2   g59(.a(x21), .b(x20), .O(new_n107_));
  inv1   g60(.a(new_n107_), .O(new_n108_));
  aoi21  g61(.a(new_n71_), .b(x21), .c(new_n104_), .O(new_n109_));
  ...
  nand3  g65(.a(new_n112_), .b(new_n72_), .c(new_n70_), .O(new_n113_));
  nand3  g66(.a(new_n113_), .b(new_n111_), .c(new_n105_), .O(z15));
  nand2  g67(.a(new_n72_), .b(new_n70_), .O(new_n115_));
  ...
  inv1   g73(.a(new_n74_), .O(new_n121_));
  inv1   g74(.a(new_n100_), .O(new_n122_));
  oai21  g75(.a(new_n117_), .b(new_n102_), .c(x24), .O(new_n123_));
  nand3  g76(.a(new_n123_), .b(new_n122_), .c(new_n121_), .O(z17));
  inv1   g77(.a(new_n71_), .O(new_n125_));
  nand4  g78(.a(new_n86_), .b(new_n72_), .c(new_n125_), .d(new_n48_), .O(new_n126_));
