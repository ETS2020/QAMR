// Benchmark "FAU" written by ABC on Wed Jul  8 19:26:28 2020
...
module FAU ( 
  ...
  oai21  g41(.a(new_n78_), .b(new_n76_), .c(x19), .O(new_n92_));
  nor2   g42(.a(new_n78_), .b(new_n76_), .O(new_n93_));
  nand2  g43(.a(new_n93_), .b(new_n79_), .O(new_n94_));
  inv1   g44(.a(x07), .O(new_n95_));
  inv1   g45(.a(x15), .O(new_n96_));
  nand2  g46(.a(x05), .b(x04), .O(new_n97_));
  nand3  g47(.a(new_n97_), .b(new_n96_), .c(new_n95_), .O(new_n98_));
  aoi21  g48(.a(new_n94_), .b(new_n92_), .c(new_n98_), .O(z12));
  nand2  g49(.a(new_n93_), .b(x19), .O(new_n100_));
  nand2  g50(.a(new_n100_), .b(x20), .O(new_n101_));
  nand2  g51(.a(new_n56_), .b(new_n96_), .O(new_n102_));
  inv1   g52(.a(new_n102_), .O(new_n103_));
  nand3  g53(.a(new_n103_), .b(new_n101_), .c(new_n70_), .O(z13));
  nor2   g54(.a(x21), .b(x20), .O(new_n105_));
  inv1   g55(.a(new_n105_), .O(new_n106_));
  aoi21  g56(.a(new_n70_), .b(x21), .c(new_n102_), .O(new_n107_));
  oai21  g57(.a(new_n106_), .b(new_n100_), .c(new_n107_), .O(z14));
  oai21  g58(.a(new_n106_), .b(new_n100_), .c(x22), .O(new_n109_));
  inv1   g59(.a(new_n100_), .O(new_n110_));
  nand3  g60(.a(new_n110_), .b(new_n71_), .c(new_n69_), .O(new_n111_));
  nand3  g61(.a(new_n111_), .b(new_n109_), .c(new_n103_), .O(z15));
  nand2  g62(.a(new_n71_), .b(new_n69_), .O(new_n113_));
  oai21  g63(.a(new_n113_), .b(new_n100_), .c(x23), .O(new_n114_));
  nand3  g64(.a(new_n105_), .b(new_n48_), .c(new_n52_), .O(new_n115_));
  inv1   g65(.a(new_n115_), .O(new_n116_));
  nand2  g66(.a(new_n116_), .b(new_n110_), .O(new_n117_));
  nand3  g67(.a(new_n117_), .b(new_n114_), .c(new_n103_), .O(z16));
  inv1   g68(.a(new_n73_), .O(new_n119_));
  inv1   g69(.a(new_n98_), .O(new_n120_));
  oai21  g70(.a(new_n115_), .b(new_n100_), .c(x24), .O(new_n121_));
  nand3  g71(.a(new_n121_), .b(new_n120_), .c(new_n119_), .O(z17));
  inv1   g72(.a(new_n70_), .O(new_n123_));
  nand4  g73(.a(new_n85_), .b(new_n71_), .c(new_n123_), .d(new_n48_), .O(new_n124_));
  nand2  g74(.a(new_n119_), .b(x25), .O(new_n125_));
  nand3  g75(.a(new_n125_), .b(new_n124_), .c(new_n103_), .O(z18));
  zero   g76(.O(z05));
  zero   g77(.O(z06));
  zero   g78(.O(z09));
  zero   g79(.O(z10));
