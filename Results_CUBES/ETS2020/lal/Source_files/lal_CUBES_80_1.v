...
module FAU ( 
  ...
  wire new_n46_, new_n48_, new_n49_, new_n50_, new_n51_, new_n52_, new_n53_,
    ...
    new_n75_, new_n77_, new_n79_, new_n80_, new_n83_, new_n84_, new_n85_,
  ...
  nand4  g38(.a(new_n49_), .b(x19), .c(x18), .d(x17), .O(new_n85_));
  nand2  g39(.a(new_n74_), .b(new_n58_), .O(new_n86_));
  inv1   g40(.a(new_n86_), .O(new_n87_));
  nand3  g41(.a(new_n87_), .b(new_n85_), .c(new_n84_), .O(z13));
  inv1   g42(.a(new_n83_), .O(new_n89_));
  nor2   g43(.a(x21), .b(x20), .O(new_n90_));
  nand2  g44(.a(new_n90_), .b(new_n89_), .O(new_n91_));
  nand2  g45(.a(new_n85_), .b(x21), .O(new_n92_));
  nand3  g46(.a(new_n92_), .b(new_n91_), .c(new_n87_), .O(z14));
  nand2  g47(.a(new_n91_), .b(x22), .O(new_n94_));
  nor2   g48(.a(x22), .b(x21), .O(new_n95_));
  nand3  g49(.a(new_n95_), .b(new_n89_), .c(new_n49_), .O(new_n96_));
  nand3  g50(.a(new_n96_), .b(new_n94_), .c(new_n87_), .O(z15));
  nand2  g51(.a(new_n96_), .b(x23), .O(new_n98_));
  nor2   g52(.a(x23), .b(x22), .O(new_n99_));
  nand3  g53(.a(new_n99_), .b(new_n90_), .c(new_n89_), .O(new_n100_));
  nand3  g54(.a(new_n100_), .b(new_n98_), .c(new_n87_), .O(z16));
  nand2  g55(.a(new_n100_), .b(x24), .O(new_n102_));
  inv1   g56(.a(new_n85_), .O(new_n103_));
  nor2   g57(.a(x24), .b(x23), .O(new_n104_));
  nand3  g58(.a(new_n104_), .b(new_n95_), .c(new_n103_), .O(new_n105_));
  nand3  g59(.a(new_n105_), .b(new_n102_), .c(new_n87_), .O(z17));
  zero   g60(.O(z12));
  zero   g61(.O(z18));
  buf    g62(.a(x16), .O(z02));
endmodule
