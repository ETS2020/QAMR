// Benchmark "FAU" written by ABC on Wed Jul  8 19:33:30 2020
...
module FAU ( 
  ...
  wire new_n46_, new_n48_, new_n49_, new_n50_, new_n51_, new_n52_, new_n53_,
    ...
    new_n88_, new_n89_, new_n90_, new_n92_, new_n93_, new_n97_, new_n98_,
  ...
  oai21  g49(.a(new_n81_), .b(new_n79_), .c(x19), .O(new_n97_));
  nor2   g50(.a(new_n81_), .b(new_n79_), .O(new_n98_));
  nand2  g51(.a(new_n98_), .b(new_n82_), .O(new_n99_));
  nand2  g52(.a(new_n92_), .b(new_n56_), .O(new_n100_));
  ...
  nand4  g56(.a(new_n103_), .b(new_n92_), .c(new_n73_), .d(new_n56_), .O(z13));
  nor2   g57(.a(x21), .b(x20), .O(new_n105_));
  inv1   g58(.a(new_n105_), .O(new_n106_));
  nand2  g59(.a(new_n92_), .b(new_n56_), .O(new_n107_));
  aoi21  g60(.a(new_n73_), .b(x21), .c(new_n107_), .O(new_n108_));
  oai21  g61(.a(new_n106_), .b(new_n102_), .c(new_n108_), .O(z14));
  inv1   g62(.a(new_n107_), .O(new_n110_));
  oai21  g63(.a(new_n106_), .b(new_n102_), .c(x22), .O(new_n111_));
  inv1   g64(.a(new_n102_), .O(new_n112_));
  nand3  g65(.a(new_n112_), .b(new_n74_), .c(new_n72_), .O(new_n113_));
  nand3  g66(.a(new_n113_), .b(new_n111_), .c(new_n110_), .O(z15));
  nand2  g67(.a(new_n74_), .b(new_n72_), .O(new_n115_));
  oai21  g68(.a(new_n115_), .b(new_n102_), .c(x23), .O(new_n116_));
  nand3  g69(.a(new_n105_), .b(new_n48_), .c(new_n52_), .O(new_n117_));
  inv1   g70(.a(new_n117_), .O(new_n118_));
  nand2  g71(.a(new_n118_), .b(new_n112_), .O(new_n119_));
  nand3  g72(.a(new_n119_), .b(new_n116_), .c(new_n110_), .O(z16));
  inv1   g73(.a(new_n76_), .O(new_n121_));
  oai21  g74(.a(new_n117_), .b(new_n102_), .c(x24), .O(new_n122_));
  nand3  g75(.a(new_n122_), .b(new_n110_), .c(new_n121_), .O(z17));
  inv1   g76(.a(new_n73_), .O(new_n124_));
  nand4  g77(.a(new_n88_), .b(new_n74_), .c(new_n124_), .d(new_n48_), .O(new_n125_));
  nand2  g78(.a(new_n121_), .b(x25), .O(new_n126_));
  nand3  g79(.a(new_n126_), .b(new_n125_), .c(new_n110_), .O(z18));
  zero   g80(.O(z10));
  zero   g81(.O(z11));
  buf    g82(.a(x16), .O(z02));
endmodule
