// Benchmark "FAU" written by ABC on Wed Jul  8 19:26:44 2020
...
module FAU ( 
  ...
  wire new_n46_, new_n48_, new_n49_, new_n50_, new_n51_, new_n52_, new_n53_,
    ...
    new_n88_, new_n93_, new_n94_, new_n95_, new_n96_, new_n97_, new_n98_,
  ...
  oai21  g44(.a(new_n79_), .b(new_n77_), .c(x19), .O(new_n93_));
  nor2   g45(.a(new_n79_), .b(new_n77_), .O(new_n94_));
  nand2  g46(.a(new_n94_), .b(new_n80_), .O(new_n95_));
  inv1   g47(.a(x07), .O(new_n96_));
  inv1   g48(.a(x15), .O(new_n97_));
  nand2  g49(.a(x05), .b(x04), .O(new_n98_));
  nand3  g50(.a(new_n98_), .b(new_n97_), .c(new_n96_), .O(new_n99_));
  aoi21  g51(.a(new_n95_), .b(new_n93_), .c(new_n99_), .O(z12));
  nand2  g52(.a(new_n94_), .b(x19), .O(new_n101_));
  nand2  g53(.a(new_n101_), .b(x20), .O(new_n102_));
  nand2  g54(.a(new_n56_), .b(new_n97_), .O(new_n103_));
  inv1   g55(.a(new_n103_), .O(new_n104_));
  nand3  g56(.a(new_n104_), .b(new_n102_), .c(new_n71_), .O(z13));
  nor2   g57(.a(x21), .b(x20), .O(new_n106_));
  inv1   g58(.a(new_n106_), .O(new_n107_));
  aoi21  g59(.a(new_n71_), .b(x21), .c(new_n103_), .O(new_n108_));
  oai21  g60(.a(new_n107_), .b(new_n101_), .c(new_n108_), .O(z14));
  oai21  g61(.a(new_n107_), .b(new_n101_), .c(x22), .O(new_n110_));
  inv1   g62(.a(new_n101_), .O(new_n111_));
  nand3  g63(.a(new_n111_), .b(new_n72_), .c(new_n70_), .O(new_n112_));
  nand3  g64(.a(new_n112_), .b(new_n110_), .c(new_n104_), .O(z15));
  nand2  g65(.a(new_n72_), .b(new_n70_), .O(new_n114_));
  oai21  g66(.a(new_n114_), .b(new_n101_), .c(x23), .O(new_n115_));
  nand3  g67(.a(new_n106_), .b(new_n48_), .c(new_n52_), .O(new_n116_));
  inv1   g68(.a(new_n116_), .O(new_n117_));
  nand2  g69(.a(new_n117_), .b(new_n111_), .O(new_n118_));
  nand3  g70(.a(new_n118_), .b(new_n115_), .c(new_n104_), .O(z16));
  inv1   g71(.a(new_n74_), .O(new_n120_));
  inv1   g72(.a(new_n99_), .O(new_n121_));
  oai21  g73(.a(new_n116_), .b(new_n101_), .c(x24), .O(new_n122_));
  nand3  g74(.a(new_n122_), .b(new_n121_), .c(new_n120_), .O(z17));
  inv1   g75(.a(new_n71_), .O(new_n124_));
  nand4  g76(.a(new_n86_), .b(new_n72_), .c(new_n124_), .d(new_n48_), .O(new_n125_));
  nand2  g77(.a(new_n120_), .b(x25), .O(new_n126_));
  nand3  g78(.a(new_n126_), .b(new_n125_), .c(new_n104_), .O(z18));
  zero   g79(.O(z09));
  zero   g80(.O(z10));
  zero   g81(.O(z11));
  buf    g82(.a(x16), .O(z02));
