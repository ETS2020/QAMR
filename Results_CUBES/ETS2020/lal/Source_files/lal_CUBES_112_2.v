// Benchmark "FAU" written by ABC on Wed Jul  8 19:29:55 2020
...
module FAU ( 
  ...
  nand2  g46(.a(x05), .b(x04), .O(new_n93_));
  nand4  g47(.a(new_n93_), .b(new_n77_), .c(new_n92_), .d(new_n91_), .O(new_n94_));
  inv1   g48(.a(new_n94_), .O(z10));
  xnor2a g49(.a(x18), .b(x17), .O(new_n96_));
  nand3  g50(.a(new_n93_), .b(new_n92_), .c(new_n91_), .O(new_n97_));
  nor2   g51(.a(new_n97_), .b(new_n96_), .O(z11));
  oai21  g52(.a(new_n79_), .b(new_n77_), .c(x19), .O(new_n99_));
  nor2   g53(.a(new_n79_), .b(new_n77_), .O(new_n100_));
  ...
  nand2  g58(.a(new_n56_), .b(new_n92_), .O(new_n105_));
  inv1   g59(.a(new_n105_), .O(new_n106_));
  nand3  g60(.a(new_n106_), .b(new_n104_), .c(new_n71_), .O(z13));
  nor2   g61(.a(x21), .b(x20), .O(new_n108_));
  inv1   g62(.a(new_n108_), .O(new_n109_));
  aoi21  g63(.a(new_n71_), .b(x21), .c(new_n105_), .O(new_n110_));
  oai21  g64(.a(new_n109_), .b(new_n103_), .c(new_n110_), .O(z14));
  oai21  g65(.a(new_n109_), .b(new_n103_), .c(x22), .O(new_n112_));
  inv1   g66(.a(new_n103_), .O(new_n113_));
  nand3  g67(.a(new_n113_), .b(new_n72_), .c(new_n70_), .O(new_n114_));
  nand3  g68(.a(new_n114_), .b(new_n112_), .c(new_n106_), .O(z15));
  nand2  g69(.a(new_n72_), .b(new_n70_), .O(new_n116_));
  oai21  g70(.a(new_n116_), .b(new_n103_), .c(x23), .O(new_n117_));
  nand3  g71(.a(new_n108_), .b(new_n48_), .c(new_n52_), .O(new_n118_));
  inv1   g72(.a(new_n118_), .O(new_n119_));
  nand2  g73(.a(new_n119_), .b(new_n113_), .O(new_n120_));
  nand3  g74(.a(new_n120_), .b(new_n117_), .c(new_n106_), .O(z16));
  inv1   g75(.a(new_n74_), .O(new_n122_));
  inv1   g76(.a(new_n97_), .O(new_n123_));
  oai21  g77(.a(new_n118_), .b(new_n103_), .c(x24), .O(new_n124_));
  nand3  g78(.a(new_n124_), .b(new_n123_), .c(new_n122_), .O(z17));
  inv1   g79(.a(new_n71_), .O(new_n126_));
  nand4  g80(.a(new_n86_), .b(new_n72_), .c(new_n126_), .d(new_n48_), .O(new_n127_));
  nand2  g81(.a(new_n122_), .b(x25), .O(new_n128_));
  nand3  g82(.a(new_n128_), .b(new_n127_), .c(new_n106_), .O(z18));
  zero   g83(.O(z09));
  buf    g84(.a(x16), .O(z02));
endmodule
