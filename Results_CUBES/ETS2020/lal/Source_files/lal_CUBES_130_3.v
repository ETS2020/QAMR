// Benchmark "FAU" written by ABC on Wed Jul  8 19:30:27 2020
...
module FAU ( 
  ...
  wire new_n46_, new_n48_, new_n49_, new_n50_, new_n51_, new_n52_, new_n53_,
    ...
    new_n89_, new_n92_, new_n93_, new_n96_, new_n97_, new_n99_, new_n100_,
  ...
  nand4  g50(.a(new_n97_), .b(new_n88_), .c(new_n71_), .d(new_n54_), .O(z13));
  inv1   g51(.a(new_n96_), .O(new_n99_));
  nor2   g52(.a(x21), .b(x20), .O(new_n100_));
  nand2  g53(.a(new_n100_), .b(new_n99_), .O(new_n101_));
  nand2  g54(.a(new_n71_), .b(x21), .O(new_n102_));
  nand2  g55(.a(new_n88_), .b(new_n54_), .O(new_n103_));
  ...
  nand3  g59(.a(new_n99_), .b(new_n72_), .c(new_n70_), .O(new_n107_));
  ...
  inv1   g65(.a(new_n74_), .O(new_n113_));
  nand2  g66(.a(new_n111_), .b(x24), .O(new_n114_));
  nand3  g67(.a(new_n114_), .b(new_n104_), .c(new_n113_), .O(z17));
  inv1   g68(.a(new_n71_), .O(new_n116_));
  nand4  g69(.a(new_n84_), .b(new_n72_), .c(new_n116_), .d(new_n48_), .O(new_n117_));
