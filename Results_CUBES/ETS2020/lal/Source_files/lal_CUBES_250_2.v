...
module FAU ( 
  ...
  nand2  g40(.a(x05), .b(x04), .O(new_n87_));
  nor2   g41(.a(x15), .b(x07), .O(new_n88_));
  nand3  g42(.a(new_n88_), .b(new_n87_), .c(new_n75_), .O(new_n89_));
  inv1   g43(.a(new_n89_), .O(z10));
  nand3  g44(.a(x19), .b(x18), .c(x17), .O(new_n93_));
  nand2  g45(.a(new_n93_), .b(x20), .O(new_n94_));
  inv1   g46(.a(x15), .O(new_n95_));
  nand2  g47(.a(new_n54_), .b(new_n95_), .O(new_n96_));
  inv1   g48(.a(new_n96_), .O(new_n97_));
  nand3  g49(.a(new_n97_), .b(new_n94_), .c(new_n69_), .O(z13));
  inv1   g50(.a(new_n93_), .O(new_n99_));
  nor2   g51(.a(x21), .b(x20), .O(new_n100_));
  nand2  g52(.a(new_n100_), .b(new_n99_), .O(new_n101_));
  nand2  g53(.a(new_n69_), .b(x21), .O(new_n102_));
  nand3  g54(.a(new_n102_), .b(new_n101_), .c(new_n97_), .O(z14));
  nand2  g55(.a(new_n101_), .b(x22), .O(new_n104_));
  nand3  g56(.a(new_n99_), .b(new_n70_), .c(new_n68_), .O(new_n105_));
  nand3  g57(.a(new_n105_), .b(new_n104_), .c(new_n97_), .O(z15));
  nand2  g58(.a(new_n105_), .b(x23), .O(new_n107_));
  nor2   g59(.a(x23), .b(x22), .O(new_n108_));
  nand3  g60(.a(new_n108_), .b(new_n100_), .c(new_n99_), .O(new_n109_));
  nand3  g61(.a(new_n109_), .b(new_n107_), .c(new_n97_), .O(z16));
  inv1   g62(.a(new_n72_), .O(new_n111_));
  nand2  g63(.a(new_n109_), .b(x24), .O(new_n112_));
  nand4  g64(.a(new_n112_), .b(new_n88_), .c(new_n111_), .d(new_n87_), .O(z17));
  inv1   g65(.a(new_n69_), .O(new_n114_));
  nand4  g66(.a(new_n82_), .b(new_n70_), .c(new_n114_), .d(new_n48_), .O(new_n115_));
  nand2  g67(.a(new_n111_), .b(x25), .O(new_n116_));
  nand3  g68(.a(new_n116_), .b(new_n115_), .c(new_n97_), .O(z18));
  zero   g69(.O(z09));
  zero   g70(.O(z11));
  zero   g71(.O(z12));
  buf    g72(.a(x16), .O(z02));
