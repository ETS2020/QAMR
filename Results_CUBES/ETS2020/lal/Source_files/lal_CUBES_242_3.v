...
module FAU ( 
  ...
  nand2  g45(.a(new_n54_), .b(new_n89_), .O(new_n96_));
  inv1   g46(.a(new_n96_), .O(new_n97_));
  nand3  g47(.a(new_n97_), .b(new_n95_), .c(new_n68_), .O(z13));
  inv1   g48(.a(new_n94_), .O(new_n99_));
  nor2   g49(.a(x21), .b(x20), .O(new_n100_));
  nand2  g50(.a(new_n100_), .b(new_n99_), .O(new_n101_));
  nand2  g51(.a(new_n68_), .b(x21), .O(new_n102_));
  nand3  g52(.a(new_n102_), .b(new_n101_), .c(new_n97_), .O(z14));
  nand2  g53(.a(new_n101_), .b(x22), .O(new_n104_));
  nand3  g54(.a(new_n99_), .b(new_n69_), .c(new_n67_), .O(new_n105_));
  ...
  inv1   g60(.a(new_n71_), .O(new_n111_));
  inv1   g61(.a(new_n91_), .O(new_n112_));
  nand2  g62(.a(new_n109_), .b(x24), .O(new_n113_));
  nand3  g63(.a(new_n113_), .b(new_n112_), .c(new_n111_), .O(z17));
  inv1   g64(.a(new_n68_), .O(new_n115_));
  nand4  g65(.a(new_n81_), .b(new_n69_), .c(new_n115_), .d(new_n48_), .O(new_n116_));
  nand2  g66(.a(new_n111_), .b(x25), .O(new_n117_));
  nand3  g67(.a(new_n117_), .b(new_n116_), .c(new_n97_), .O(z18));
  zero   g68(.O(z05));
  zero   g69(.O(z06));
  zero   g70(.O(z09));
  zero   g71(.O(z10));
