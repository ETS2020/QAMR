// Benchmark "FAU" written by ABC on Wed Jul  8 19:30:37 2020
...
module FAU ( 
  ...
  wire new_n46_, new_n48_, new_n49_, new_n50_, new_n51_, new_n52_, new_n53_,
    ...
    new_n82_, new_n85_, new_n86_, new_n89_, new_n90_, new_n92_, new_n93_,
  ...
  nand2  g13(.a(new_n46_), .b(x06), .O(z07));
  inv1   g14(.a(x20), .O(new_n63_));
  nand4  g15(.a(new_n63_), .b(x19), .c(x18), .d(x17), .O(new_n64_));
  nor2   g16(.a(x22), .b(x21), .O(new_n65_));
  nand3  g17(.a(new_n65_), .b(new_n49_), .c(new_n48_), .O(new_n66_));
  nor2   g18(.a(new_n66_), .b(new_n64_), .O(new_n67_));
  nand4  g19(.a(new_n65_), .b(new_n49_), .c(x19), .d(x18), .O(new_n68_));
  oai21  g20(.a(new_n68_), .b(new_n67_), .c(x25), .O(new_n69_));
  inv1   g21(.a(x17), .O(new_n70_));
  inv1   g22(.a(x25), .O(new_n71_));
  or2    g23(.a(x19), .b(x18), .O(new_n72_));
  nand2  g24(.a(new_n51_), .b(x24), .O(new_n73_));
  oai21  g25(.a(new_n73_), .b(new_n72_), .c(new_n71_), .O(new_n74_));
  nand2  g26(.a(new_n74_), .b(new_n70_), .O(new_n75_));
  nand2  g27(.a(new_n73_), .b(new_n71_), .O(new_n76_));
  nor2   g28(.a(x25), .b(x24), .O(new_n77_));
  nor2   g29(.a(new_n77_), .b(new_n48_), .O(new_n78_));
  aoi21  g30(.a(new_n76_), .b(x20), .c(new_n78_), .O(new_n79_));
  nand3  g31(.a(new_n79_), .b(new_n75_), .c(new_n69_), .O(z08));
  nor2   g32(.a(x15), .b(x07), .O(new_n81_));
  nand2  g33(.a(new_n81_), .b(new_n55_), .O(new_n82_));
  inv1   g34(.a(new_n82_), .O(z09));
  xnor2a g35(.a(x18), .b(x17), .O(new_n85_));
  nand2  g36(.a(new_n81_), .b(new_n54_), .O(new_n86_));
  nor2   g37(.a(new_n86_), .b(new_n85_), .O(z11));
  nand3  g38(.a(x19), .b(x18), .c(x17), .O(new_n89_));
  nand2  g39(.a(new_n89_), .b(x20), .O(new_n90_));
  nand4  g40(.a(new_n90_), .b(new_n81_), .c(new_n64_), .d(new_n54_), .O(z13));
  inv1   g41(.a(new_n89_), .O(new_n92_));
  nor2   g42(.a(x21), .b(x20), .O(new_n93_));
  nand2  g43(.a(new_n93_), .b(new_n92_), .O(new_n94_));
  nand2  g44(.a(new_n64_), .b(x21), .O(new_n95_));
  nand2  g45(.a(new_n81_), .b(new_n54_), .O(new_n96_));
  inv1   g46(.a(new_n96_), .O(new_n97_));
  nand3  g47(.a(new_n97_), .b(new_n95_), .c(new_n94_), .O(z14));
  nand2  g48(.a(new_n94_), .b(x22), .O(new_n99_));
  nand3  g49(.a(new_n92_), .b(new_n65_), .c(new_n63_), .O(new_n100_));
  ...
  inv1   g55(.a(new_n67_), .O(new_n106_));
  nand2  g56(.a(new_n104_), .b(x24), .O(new_n107_));
  nand3  g57(.a(new_n107_), .b(new_n97_), .c(new_n106_), .O(z17));
  inv1   g58(.a(new_n64_), .O(new_n109_));
  nand4  g59(.a(new_n77_), .b(new_n65_), .c(new_n109_), .d(new_n48_), .O(new_n110_));
