// Benchmark "FAU" written by ABC on Wed Jul  8 19:33:59 2020
...
module FAU ( 
  ...
  inv1   g41(.a(x07), .O(new_n90_));
  inv1   g42(.a(x15), .O(new_n91_));
  nand2  g43(.a(x05), .b(x04), .O(new_n92_));
  nand4  g44(.a(new_n92_), .b(new_n76_), .c(new_n91_), .d(new_n90_), .O(new_n93_));
  inv1   g45(.a(new_n93_), .O(z10));
  xnor2a g46(.a(x18), .b(x17), .O(new_n95_));
  nand3  g47(.a(new_n92_), .b(new_n91_), .c(new_n90_), .O(new_n96_));
  nor2   g48(.a(new_n96_), .b(new_n95_), .O(z11));
  oai21  g49(.a(new_n78_), .b(new_n76_), .c(x19), .O(new_n98_));
  nor2   g50(.a(new_n78_), .b(new_n76_), .O(new_n99_));
  nand2  g51(.a(new_n99_), .b(new_n79_), .O(new_n100_));
  ...
  nand2  g55(.a(new_n56_), .b(new_n91_), .O(new_n104_));
  inv1   g56(.a(new_n104_), .O(new_n105_));
  nand3  g57(.a(new_n105_), .b(new_n103_), .c(new_n70_), .O(z13));
  nor2   g58(.a(x21), .b(x20), .O(new_n107_));
  inv1   g59(.a(new_n107_), .O(new_n108_));
  aoi21  g60(.a(new_n70_), .b(x21), .c(new_n104_), .O(new_n109_));
  oai21  g61(.a(new_n108_), .b(new_n102_), .c(new_n109_), .O(z14));
  oai21  g62(.a(new_n108_), .b(new_n102_), .c(x22), .O(new_n111_));
  inv1   g63(.a(new_n102_), .O(new_n112_));
  nand3  g64(.a(new_n112_), .b(new_n71_), .c(new_n69_), .O(new_n113_));
  nand3  g65(.a(new_n113_), .b(new_n111_), .c(new_n105_), .O(z15));
  nand2  g66(.a(new_n71_), .b(new_n69_), .O(new_n115_));
  oai21  g67(.a(new_n115_), .b(new_n102_), .c(x23), .O(new_n116_));
  nand3  g68(.a(new_n107_), .b(new_n48_), .c(new_n52_), .O(new_n117_));
  inv1   g69(.a(new_n117_), .O(new_n118_));
  nand2  g70(.a(new_n118_), .b(new_n112_), .O(new_n119_));
  nand3  g71(.a(new_n119_), .b(new_n116_), .c(new_n105_), .O(z16));
  inv1   g72(.a(new_n73_), .O(new_n121_));
  inv1   g73(.a(new_n96_), .O(new_n122_));
  oai21  g74(.a(new_n117_), .b(new_n102_), .c(x24), .O(new_n123_));
  nand3  g75(.a(new_n123_), .b(new_n122_), .c(new_n121_), .O(z17));
  inv1   g76(.a(new_n70_), .O(new_n125_));
  nand4  g77(.a(new_n85_), .b(new_n71_), .c(new_n125_), .d(new_n48_), .O(new_n126_));
  nand2  g78(.a(new_n121_), .b(x25), .O(new_n127_));
  nand3  g79(.a(new_n127_), .b(new_n126_), .c(new_n105_), .O(z18));
  zero   g80(.O(z05));
  zero   g81(.O(z06));
  zero   g82(.O(z09));
  buf    g83(.a(x16), .O(z02));
