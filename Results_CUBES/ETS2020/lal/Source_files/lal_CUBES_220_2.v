...
module FAU ( 
  ...
  inv1   g38(.a(x07), .O(new_n88_));
  inv1   g39(.a(x15), .O(new_n89_));
  nand2  g40(.a(x05), .b(x04), .O(new_n90_));
  nand3  g41(.a(new_n90_), .b(new_n89_), .c(new_n88_), .O(new_n91_));
  nor2   g42(.a(new_n91_), .b(new_n87_), .O(z11));
  oai21  g43(.a(new_n74_), .b(new_n72_), .c(x19), .O(new_n93_));
  nor2   g44(.a(new_n74_), .b(new_n72_), .O(new_n94_));
  ...
  nand2  g49(.a(new_n56_), .b(new_n89_), .O(new_n99_));
  ...
  inv1   g67(.a(new_n91_), .O(new_n117_));
