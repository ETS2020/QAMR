// Benchmark "FAU" written by ABC on Wed Jul  8 19:29:41 2020
...
module FAU ( 
  ...
  nand3  g28(.a(x24), .b(x22), .c(x21), .O(new_n77_));
  oai21  g29(.a(new_n77_), .b(new_n76_), .c(new_n73_), .O(new_n78_));
  nand2  g30(.a(new_n78_), .b(new_n72_), .O(new_n79_));
  aoi21  g31(.a(new_n77_), .b(new_n73_), .c(new_n65_), .O(new_n80_));
  nor2   g32(.a(x25), .b(x24), .O(new_n81_));
  nor2   g33(.a(new_n81_), .b(new_n48_), .O(new_n82_));
  nor2   g34(.a(new_n82_), .b(new_n80_), .O(new_n83_));
  nand3  g35(.a(new_n83_), .b(new_n79_), .c(new_n71_), .O(z08));
  nor2   g36(.a(x15), .b(x07), .O(new_n85_));
  nand2  g37(.a(new_n85_), .b(new_n57_), .O(new_n86_));
  inv1   g38(.a(new_n86_), .O(z09));
  nand3  g39(.a(new_n85_), .b(new_n56_), .c(new_n72_), .O(new_n88_));
  inv1   g40(.a(new_n88_), .O(z10));
  xnor2a g41(.a(x18), .b(x17), .O(new_n90_));
  nand2  g42(.a(new_n85_), .b(new_n56_), .O(new_n91_));
  nor2   g43(.a(new_n91_), .b(new_n90_), .O(z11));
  oai21  g44(.a(new_n74_), .b(new_n72_), .c(x19), .O(new_n93_));
  nor2   g45(.a(new_n74_), .b(new_n72_), .O(new_n94_));
  ...
  nand4  g50(.a(new_n98_), .b(new_n85_), .c(new_n66_), .d(new_n56_), .O(z13));
  nor2   g51(.a(x21), .b(x20), .O(new_n100_));
  inv1   g52(.a(new_n100_), .O(new_n101_));
  nand2  g53(.a(new_n85_), .b(new_n56_), .O(new_n102_));
  aoi21  g54(.a(new_n66_), .b(x21), .c(new_n102_), .O(new_n103_));
  ...
  nand3  g59(.a(new_n107_), .b(new_n67_), .c(new_n65_), .O(new_n108_));
  nand3  g60(.a(new_n108_), .b(new_n106_), .c(new_n105_), .O(z15));
  nand2  g61(.a(new_n67_), .b(new_n65_), .O(new_n110_));
  ...
  inv1   g70(.a(new_n66_), .O(new_n119_));
  nand4  g71(.a(new_n81_), .b(new_n67_), .c(new_n119_), .d(new_n48_), .O(new_n120_));
