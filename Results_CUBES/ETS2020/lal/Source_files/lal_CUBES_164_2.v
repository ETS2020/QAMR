// Benchmark "FAU" written by ABC on Wed Jul  8 19:31:31 2020
...
module FAU ( 
  ...
  wire new_n46_, new_n48_, new_n49_, new_n50_, new_n51_, new_n52_, new_n53_,
    ...
    new_n88_, new_n92_, new_n93_, new_n94_, new_n95_, new_n96_, new_n98_,
  ...
  inv1   g45(.a(x07), .O(new_n93_));
  inv1   g46(.a(x15), .O(new_n94_));
  nand2  g47(.a(x05), .b(x04), .O(new_n95_));
  nand3  g48(.a(new_n95_), .b(new_n94_), .c(new_n93_), .O(new_n96_));
  nor2   g49(.a(new_n96_), .b(new_n92_), .O(z11));
  oai21  g50(.a(new_n79_), .b(new_n77_), .c(x19), .O(new_n98_));
  nor2   g51(.a(new_n79_), .b(new_n77_), .O(new_n99_));
  nand2  g52(.a(new_n99_), .b(new_n80_), .O(new_n100_));
  ...
  nand2  g56(.a(new_n56_), .b(new_n94_), .O(new_n104_));
