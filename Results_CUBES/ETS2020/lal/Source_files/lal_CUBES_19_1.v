// Benchmark "FAU" written by ABC on Wed Jul  8 19:26:58 2020
...
module FAU ( 
  ...
  nor2   g33(.a(new_n80_), .b(new_n48_), .O(new_n81_));
  ...
  nand2  g50(.a(new_n56_), .b(new_n86_), .O(new_n99_));
  ...
  nand3  g63(.a(new_n102_), .b(new_n48_), .c(new_n52_), .O(new_n112_));
  ...
  nand4  g72(.a(new_n80_), .b(new_n66_), .c(new_n120_), .d(new_n48_), .O(new_n121_));
