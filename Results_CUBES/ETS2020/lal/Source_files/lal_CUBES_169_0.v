// Benchmark "FAU" written by ABC on Wed Jul  8 19:31:42 2020
...
module FAU ( 
  ...
  nand2  g15(.a(x18), .b(x17), .O(new_n68_));
  nand2  g16(.a(new_n68_), .b(x19), .O(new_n69_));
  inv1   g17(.a(x19), .O(new_n70_));
  nand3  g18(.a(new_n70_), .b(x18), .c(x17), .O(new_n71_));
  nand2  g19(.a(x05), .b(x04), .O(new_n72_));
  nand3  g20(.a(new_n72_), .b(new_n63_), .c(new_n62_), .O(new_n73_));
  aoi21  g21(.a(new_n71_), .b(new_n69_), .c(new_n73_), .O(z12));
  zero   g22(.O(z00));
  zero   g23(.O(z01));
  zero   g24(.O(z03));
  zero   g25(.O(z05));
