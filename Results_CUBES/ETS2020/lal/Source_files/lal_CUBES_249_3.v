// Benchmark "FAU" written by ABC on Wed Jul  8 19:34:10 2020
...
module FAU ( 
  ...
  wire new_n46_, new_n48_, new_n49_, new_n50_, new_n51_, new_n52_, new_n53_,
    ...
    new_n81_, new_n82_, new_n83_, new_n86_, new_n87_, new_n88_, new_n92_,
  ...
  nand2  g38(.a(x05), .b(x04), .O(new_n86_));
  nor2   g39(.a(x15), .b(x07), .O(new_n87_));
  nand3  g40(.a(new_n87_), .b(new_n86_), .c(new_n74_), .O(new_n88_));
  inv1   g41(.a(new_n88_), .O(z10));
  nand3  g42(.a(x19), .b(x18), .c(x17), .O(new_n92_));
  nand2  g43(.a(new_n92_), .b(x20), .O(new_n93_));
  inv1   g44(.a(x15), .O(new_n94_));
  nand2  g45(.a(new_n54_), .b(new_n94_), .O(new_n95_));
  inv1   g46(.a(new_n95_), .O(new_n96_));
  nand3  g47(.a(new_n96_), .b(new_n93_), .c(new_n68_), .O(z13));
  inv1   g48(.a(new_n92_), .O(new_n98_));
  nor2   g49(.a(x21), .b(x20), .O(new_n99_));
  nand2  g50(.a(new_n99_), .b(new_n98_), .O(new_n100_));
  nand2  g51(.a(new_n68_), .b(x21), .O(new_n101_));
  nand3  g52(.a(new_n101_), .b(new_n100_), .c(new_n96_), .O(z14));
  nand2  g53(.a(new_n100_), .b(x22), .O(new_n103_));
  nand3  g54(.a(new_n98_), .b(new_n69_), .c(new_n67_), .O(new_n104_));
  nand3  g55(.a(new_n104_), .b(new_n103_), .c(new_n96_), .O(z15));
  nand2  g56(.a(new_n104_), .b(x23), .O(new_n106_));
  nor2   g57(.a(x23), .b(x22), .O(new_n107_));
  nand3  g58(.a(new_n107_), .b(new_n99_), .c(new_n98_), .O(new_n108_));
  nand3  g59(.a(new_n108_), .b(new_n106_), .c(new_n96_), .O(z16));
  inv1   g60(.a(new_n71_), .O(new_n110_));
  nand2  g61(.a(new_n108_), .b(x24), .O(new_n111_));
  nand4  g62(.a(new_n111_), .b(new_n87_), .c(new_n110_), .d(new_n86_), .O(z17));
  inv1   g63(.a(new_n68_), .O(new_n113_));
  nand4  g64(.a(new_n81_), .b(new_n69_), .c(new_n113_), .d(new_n48_), .O(new_n114_));
  nand2  g65(.a(new_n110_), .b(x25), .O(new_n115_));
  nand3  g66(.a(new_n115_), .b(new_n114_), .c(new_n96_), .O(z18));
  zero   g67(.O(z06));
  zero   g68(.O(z09));
  zero   g69(.O(z11));
  zero   g70(.O(z12));
