...
module FAU ( 
  ...
  and2   g13(.a(x05), .b(x04), .O(new_n64_));
  nand3  g14(.a(new_n64_), .b(new_n63_), .c(new_n62_), .O(new_n65_));
  inv1   g15(.a(new_n65_), .O(z09));
  nand2  g16(.a(new_n63_), .b(new_n62_), .O(new_n68_));
  xnor2a g17(.a(x18), .b(x17), .O(new_n69_));
  nor3   g18(.a(new_n69_), .b(new_n68_), .c(new_n64_), .O(z11));
  zero   g19(.O(z00));
  zero   g20(.O(z01));
  zero   g21(.O(z03));
  zero   g22(.O(z05));
