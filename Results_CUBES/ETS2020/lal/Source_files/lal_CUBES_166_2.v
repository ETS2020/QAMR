...
module FAU ( 
  ...
  nand2  g31(.a(new_n50_), .b(x24), .O(new_n79_));
  ...
  nor2   g36(.a(new_n83_), .b(new_n47_), .O(new_n84_));
  ...
  nand2  g40(.a(new_n87_), .b(new_n54_), .O(new_n88_));
  inv1   g41(.a(new_n88_), .O(z09));
  nand3  g42(.a(new_n87_), .b(new_n53_), .c(new_n76_), .O(new_n90_));
  inv1   g43(.a(new_n90_), .O(z10));
  nand3  g44(.a(x19), .b(x18), .c(x17), .O(new_n94_));
  nand2  g45(.a(new_n94_), .b(x20), .O(new_n95_));
  nand4  g46(.a(new_n95_), .b(new_n87_), .c(new_n70_), .d(new_n53_), .O(z13));
  ...
  nand2  g51(.a(new_n87_), .b(new_n53_), .O(new_n101_));
  ...
  nand4  g65(.a(new_n83_), .b(new_n71_), .c(new_n114_), .d(new_n47_), .O(new_n115_));
