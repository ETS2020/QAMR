// Benchmark "FAU" written by ABC on Wed Jul  8 19:27:02 2020
...
module FAU ( 
  ...
  nand2  g46(.a(new_n94_), .b(x20), .O(new_n95_));
  nand4  g47(.a(new_n95_), .b(new_n87_), .c(new_n70_), .d(new_n54_), .O(z13));
  inv1   g48(.a(new_n94_), .O(new_n97_));
  nor2   g49(.a(x21), .b(x20), .O(new_n98_));
  nand2  g50(.a(new_n98_), .b(new_n97_), .O(new_n99_));
  nand2  g51(.a(new_n70_), .b(x21), .O(new_n100_));
  nand2  g52(.a(new_n87_), .b(new_n54_), .O(new_n101_));
  inv1   g53(.a(new_n101_), .O(new_n102_));
  nand3  g54(.a(new_n102_), .b(new_n100_), .c(new_n99_), .O(z14));
  nand2  g55(.a(new_n99_), .b(x22), .O(new_n104_));
  nand3  g56(.a(new_n97_), .b(new_n71_), .c(new_n69_), .O(new_n105_));
  nand3  g57(.a(new_n105_), .b(new_n104_), .c(new_n102_), .O(z15));
  nand2  g58(.a(new_n105_), .b(x23), .O(new_n107_));
  nor2   g59(.a(x23), .b(x22), .O(new_n108_));
  nand3  g60(.a(new_n108_), .b(new_n98_), .c(new_n97_), .O(new_n109_));
  nand3  g61(.a(new_n109_), .b(new_n107_), .c(new_n102_), .O(z16));
  inv1   g62(.a(new_n73_), .O(new_n111_));
  nand2  g63(.a(new_n109_), .b(x24), .O(new_n112_));
  nand3  g64(.a(new_n112_), .b(new_n102_), .c(new_n111_), .O(z17));
  inv1   g65(.a(new_n70_), .O(new_n114_));
  nand4  g66(.a(new_n83_), .b(new_n71_), .c(new_n114_), .d(new_n48_), .O(new_n115_));
  nand2  g67(.a(new_n111_), .b(x25), .O(new_n116_));
  nand3  g68(.a(new_n116_), .b(new_n115_), .c(new_n102_), .O(z18));
  zero   g69(.O(z06));
  zero   g70(.O(z11));
  zero   g71(.O(z12));
  buf    g72(.a(x16), .O(z02));
