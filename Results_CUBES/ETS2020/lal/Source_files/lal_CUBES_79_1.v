...
module FAU ( 
  ...
  wire new_n46_, new_n48_, new_n49_, new_n50_, new_n51_, new_n52_, new_n53_,
    ...
    new_n83_, new_n84_, new_n86_, new_n90_, new_n91_, new_n93_, new_n94_,
  ...
  nand2  g46(.a(new_n66_), .b(x21), .O(new_n96_));
  nand2  g47(.a(new_n83_), .b(new_n54_), .O(new_n97_));
  inv1   g48(.a(new_n97_), .O(new_n98_));
  nand3  g49(.a(new_n98_), .b(new_n96_), .c(new_n95_), .O(z14));
  nand2  g50(.a(new_n95_), .b(x22), .O(new_n100_));
  nand3  g51(.a(new_n93_), .b(new_n67_), .c(new_n65_), .O(new_n101_));
  ...
  inv1   g57(.a(new_n69_), .O(new_n107_));
  nand2  g58(.a(new_n105_), .b(x24), .O(new_n108_));
  nand3  g59(.a(new_n108_), .b(new_n98_), .c(new_n107_), .O(z17));
  inv1   g60(.a(new_n66_), .O(new_n110_));
  nand4  g61(.a(new_n79_), .b(new_n67_), .c(new_n110_), .d(new_n48_), .O(new_n111_));
