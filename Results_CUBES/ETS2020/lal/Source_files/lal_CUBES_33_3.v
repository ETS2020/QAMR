...
module FAU ( 
  ...
  oai21  g47(.a(new_n78_), .b(new_n76_), .c(x19), .O(new_n96_));
  nor2   g48(.a(new_n78_), .b(new_n76_), .O(new_n97_));
  nand2  g49(.a(new_n97_), .b(new_n79_), .O(new_n98_));
  nand3  g50(.a(new_n92_), .b(new_n91_), .c(new_n90_), .O(new_n99_));
  aoi21  g51(.a(new_n98_), .b(new_n96_), .c(new_n99_), .O(z12));
  nand2  g52(.a(new_n97_), .b(x19), .O(new_n101_));
  nand2  g53(.a(new_n101_), .b(x20), .O(new_n102_));
  nand2  g54(.a(new_n56_), .b(new_n91_), .O(new_n103_));
