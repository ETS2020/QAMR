...
module FAU ( 
  ...
  nor2   g10(.a(x15), .b(x07), .O(new_n62_));
  nand3  g11(.a(new_n62_), .b(x05), .c(x04), .O(new_n63_));
  inv1   g12(.a(new_n63_), .O(z09));
  inv1   g13(.a(x17), .O(new_n65_));
  nand2  g14(.a(x05), .b(x04), .O(new_n66_));
  nand3  g15(.a(new_n62_), .b(new_n66_), .c(new_n65_), .O(new_n67_));
  inv1   g16(.a(new_n67_), .O(z10));
  xnor2a g17(.a(x18), .b(x17), .O(new_n69_));
  nand2  g18(.a(new_n62_), .b(new_n66_), .O(new_n70_));
  nor2   g19(.a(new_n70_), .b(new_n69_), .O(z11));
