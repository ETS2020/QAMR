// Benchmark "FAU" written by ABC on Wed Jul  8 19:27:10 2020
...
module FAU ( 
  ...
  nand4  g20(.a(new_n66_), .b(x19), .c(x18), .d(x17), .O(new_n67_));
  nor2   g21(.a(x22), .b(x21), .O(new_n68_));
  nand3  g22(.a(new_n68_), .b(new_n49_), .c(new_n48_), .O(new_n69_));
  nor2   g23(.a(new_n69_), .b(new_n67_), .O(new_n70_));
  nand4  g24(.a(new_n68_), .b(new_n49_), .c(x19), .d(x18), .O(new_n71_));
  oai21  g25(.a(new_n71_), .b(new_n70_), .c(x25), .O(new_n72_));
  ...
  nand3  g31(.a(x24), .b(x22), .c(x21), .O(new_n78_));
  oai21  g32(.a(new_n78_), .b(new_n77_), .c(new_n74_), .O(new_n79_));
  nand2  g33(.a(new_n79_), .b(new_n73_), .O(new_n80_));
  aoi21  g34(.a(new_n78_), .b(new_n74_), .c(new_n66_), .O(new_n81_));
  nor2   g35(.a(x25), .b(x24), .O(new_n82_));
  nor2   g36(.a(new_n82_), .b(new_n48_), .O(new_n83_));
  nor2   g37(.a(new_n83_), .b(new_n81_), .O(new_n84_));
  nand3  g38(.a(new_n84_), .b(new_n80_), .c(new_n72_), .O(z08));
  nor2   g39(.a(x15), .b(x07), .O(new_n86_));
  nand2  g40(.a(new_n86_), .b(new_n57_), .O(new_n87_));
  inv1   g41(.a(new_n87_), .O(z09));
  xnor2a g42(.a(x18), .b(x17), .O(new_n90_));
  nand2  g43(.a(new_n86_), .b(new_n56_), .O(new_n91_));
  nor2   g44(.a(new_n91_), .b(new_n90_), .O(z11));
  oai21  g45(.a(new_n75_), .b(new_n73_), .c(x19), .O(new_n93_));
  nor2   g46(.a(new_n75_), .b(new_n73_), .O(new_n94_));
  nand2  g47(.a(new_n94_), .b(new_n76_), .O(new_n95_));
  ...
  nand4  g51(.a(new_n98_), .b(new_n86_), .c(new_n67_), .d(new_n56_), .O(z13));
  nor2   g52(.a(x21), .b(x20), .O(new_n100_));
  inv1   g53(.a(new_n100_), .O(new_n101_));
  nand2  g54(.a(new_n86_), .b(new_n56_), .O(new_n102_));
  aoi21  g55(.a(new_n67_), .b(x21), .c(new_n102_), .O(new_n103_));
  ...
  nand3  g60(.a(new_n107_), .b(new_n68_), .c(new_n66_), .O(new_n108_));
  nand3  g61(.a(new_n108_), .b(new_n106_), .c(new_n105_), .O(z15));
  nand2  g62(.a(new_n68_), .b(new_n66_), .O(new_n110_));
  ...
  inv1   g71(.a(new_n67_), .O(new_n119_));
  nand4  g72(.a(new_n82_), .b(new_n68_), .c(new_n119_), .d(new_n48_), .O(new_n120_));
