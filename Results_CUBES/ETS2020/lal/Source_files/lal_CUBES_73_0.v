...
module FAU ( 
  ...
  wire new_n46_, new_n50_, new_n51_, new_n52_, new_n53_, new_n54_, new_n55_,
    new_n58_, new_n62_, new_n63_, new_n64_, new_n67_, new_n68_, new_n69_,
  ...
  inv1   g13(.a(x07), .O(new_n62_));
  inv1   g14(.a(x15), .O(new_n63_));
  nand4  g15(.a(new_n63_), .b(new_n62_), .c(x05), .d(x04), .O(new_n64_));
  inv1   g16(.a(new_n64_), .O(z09));
  xnor2a g17(.a(x18), .b(x17), .O(new_n67_));
  nand2  g18(.a(x05), .b(x04), .O(new_n68_));
  nand3  g19(.a(new_n68_), .b(new_n63_), .c(new_n62_), .O(new_n69_));
  nor2   g20(.a(new_n69_), .b(new_n67_), .O(z11));
  nand2  g21(.a(x18), .b(x17), .O(new_n71_));
  nand2  g22(.a(new_n71_), .b(x19), .O(new_n72_));
  inv1   g23(.a(x19), .O(new_n73_));
  nand3  g24(.a(new_n73_), .b(x18), .c(x17), .O(new_n74_));
  aoi21  g25(.a(new_n74_), .b(new_n72_), .c(new_n69_), .O(z12));
  zero   g26(.O(z01));
  zero   g27(.O(z03));
  zero   g28(.O(z08));
  zero   g29(.O(z10));
