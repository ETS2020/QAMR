// Benchmark "FAU" written by ABC on Wed Jul  8 19:28:04 2020
...
module FAU ( 
  ...
  nand2  g10(.a(x18), .b(x17), .O(new_n64_));
  nand2  g11(.a(new_n64_), .b(x19), .O(new_n65_));
  inv1   g12(.a(x19), .O(new_n66_));
  nand3  g13(.a(new_n66_), .b(x18), .c(x17), .O(new_n67_));
  aoi21  g14(.a(new_n67_), .b(new_n65_), .c(new_n62_), .O(z12));
  zero   g15(.O(z00));
  zero   g16(.O(z01));
  zero   g17(.O(z03));
  zero   g18(.O(z04));
