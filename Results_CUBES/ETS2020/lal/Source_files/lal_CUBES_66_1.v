// Benchmark "FAU" written by ABC on Wed Jul  8 19:28:26 2020
...
module FAU ( 
  ...
  or2    g33(.a(x19), .b(x18), .O(new_n80_));
  nand2  g34(.a(new_n51_), .b(x24), .O(new_n81_));
  oai21  g35(.a(new_n81_), .b(new_n80_), .c(new_n79_), .O(new_n82_));
  nand2  g36(.a(new_n82_), .b(new_n78_), .O(new_n83_));
  nand2  g37(.a(new_n81_), .b(new_n79_), .O(new_n84_));
  nor2   g38(.a(x25), .b(x24), .O(new_n85_));
  nor2   g39(.a(new_n85_), .b(new_n48_), .O(new_n86_));
  aoi21  g40(.a(new_n84_), .b(x20), .c(new_n86_), .O(new_n87_));
  nand3  g41(.a(new_n87_), .b(new_n83_), .c(new_n77_), .O(z08));
  nor2   g42(.a(x15), .b(x07), .O(new_n89_));
  nand2  g43(.a(new_n89_), .b(new_n55_), .O(new_n90_));
  inv1   g44(.a(new_n90_), .O(z09));
  nand3  g45(.a(new_n89_), .b(new_n54_), .c(new_n78_), .O(new_n92_));
  inv1   g46(.a(new_n92_), .O(z10));
  nand3  g47(.a(x19), .b(x18), .c(x17), .O(new_n96_));
  nand2  g48(.a(new_n96_), .b(x20), .O(new_n97_));
  nand4  g49(.a(new_n97_), .b(new_n89_), .c(new_n72_), .d(new_n54_), .O(z13));
  inv1   g50(.a(new_n96_), .O(new_n99_));
  nor2   g51(.a(x21), .b(x20), .O(new_n100_));
  nand2  g52(.a(new_n100_), .b(new_n99_), .O(new_n101_));
  nand2  g53(.a(new_n72_), .b(x21), .O(new_n102_));
  nand2  g54(.a(new_n89_), .b(new_n54_), .O(new_n103_));
  inv1   g55(.a(new_n103_), .O(new_n104_));
  nand3  g56(.a(new_n104_), .b(new_n102_), .c(new_n101_), .O(z14));
  nand2  g57(.a(new_n101_), .b(x22), .O(new_n106_));
  nand3  g58(.a(new_n99_), .b(new_n73_), .c(new_n71_), .O(new_n107_));
  nand3  g59(.a(new_n107_), .b(new_n106_), .c(new_n104_), .O(z15));
  nand2  g60(.a(new_n107_), .b(x23), .O(new_n109_));
  nor2   g61(.a(x23), .b(x22), .O(new_n110_));
  nand3  g62(.a(new_n110_), .b(new_n100_), .c(new_n99_), .O(new_n111_));
  nand3  g63(.a(new_n111_), .b(new_n109_), .c(new_n104_), .O(z16));
  inv1   g64(.a(new_n75_), .O(new_n113_));
  nand2  g65(.a(new_n111_), .b(x24), .O(new_n114_));
  nand3  g66(.a(new_n114_), .b(new_n104_), .c(new_n113_), .O(z17));
  inv1   g67(.a(new_n72_), .O(new_n116_));
  nand4  g68(.a(new_n85_), .b(new_n73_), .c(new_n116_), .d(new_n48_), .O(new_n117_));
  nand2  g69(.a(new_n113_), .b(x25), .O(new_n118_));
  nand3  g70(.a(new_n118_), .b(new_n117_), .c(new_n104_), .O(z18));
  zero   g71(.O(z02));
  zero   g72(.O(z11));
  zero   g73(.O(z12));
endmodule
