// Benchmark "FAU" written by ABC on Wed Jul  8 19:30:58 2020
...
module FAU ( 
  ...
  nand2  g45(.a(new_n87_), .b(new_n56_), .O(new_n93_));
  nor2   g46(.a(new_n93_), .b(new_n92_), .O(z11));
  oai21  g47(.a(new_n76_), .b(new_n74_), .c(x19), .O(new_n95_));
  nor2   g48(.a(new_n76_), .b(new_n74_), .O(new_n96_));
  nand2  g49(.a(new_n96_), .b(new_n77_), .O(new_n97_));
  aoi21  g50(.a(new_n97_), .b(new_n95_), .c(new_n93_), .O(z12));
  nand2  g51(.a(new_n96_), .b(x19), .O(new_n99_));
  nand2  g52(.a(new_n99_), .b(x20), .O(new_n100_));
  nand4  g53(.a(new_n100_), .b(new_n87_), .c(new_n68_), .d(new_n56_), .O(z13));
  nor2   g54(.a(x21), .b(x20), .O(new_n102_));
  inv1   g55(.a(new_n102_), .O(new_n103_));
  nand2  g56(.a(new_n87_), .b(new_n56_), .O(new_n104_));
  aoi21  g57(.a(new_n68_), .b(x21), .c(new_n104_), .O(new_n105_));
  oai21  g58(.a(new_n103_), .b(new_n99_), .c(new_n105_), .O(z14));
  inv1   g59(.a(new_n104_), .O(new_n107_));
  oai21  g60(.a(new_n103_), .b(new_n99_), .c(x22), .O(new_n108_));
  inv1   g61(.a(new_n99_), .O(new_n109_));
  nand3  g62(.a(new_n109_), .b(new_n69_), .c(new_n67_), .O(new_n110_));
  nand3  g63(.a(new_n110_), .b(new_n108_), .c(new_n107_), .O(z15));
  nand2  g64(.a(new_n69_), .b(new_n67_), .O(new_n112_));
  oai21  g65(.a(new_n112_), .b(new_n99_), .c(x23), .O(new_n113_));
  nand3  g66(.a(new_n102_), .b(new_n48_), .c(new_n52_), .O(new_n114_));
  inv1   g67(.a(new_n114_), .O(new_n115_));
  nand2  g68(.a(new_n115_), .b(new_n109_), .O(new_n116_));
  nand3  g69(.a(new_n116_), .b(new_n113_), .c(new_n107_), .O(z16));
  inv1   g70(.a(new_n71_), .O(new_n118_));
  oai21  g71(.a(new_n114_), .b(new_n99_), .c(x24), .O(new_n119_));
  nand3  g72(.a(new_n119_), .b(new_n107_), .c(new_n118_), .O(z17));
  inv1   g73(.a(new_n68_), .O(new_n121_));
  nand4  g74(.a(new_n83_), .b(new_n69_), .c(new_n121_), .d(new_n48_), .O(new_n122_));
  nand2  g75(.a(new_n118_), .b(x25), .O(new_n123_));
  nand3  g76(.a(new_n123_), .b(new_n122_), .c(new_n107_), .O(z18));
  zero   g77(.O(z02));
  zero   g78(.O(z04));
endmodule
