// Benchmark "FAU" written by ABC on Wed Jul  8 19:32:51 2020
...
module FAU ( 
  ...
  nand3  g42(.a(new_n89_), .b(new_n88_), .c(new_n76_), .O(new_n90_));
  inv1   g43(.a(new_n90_), .O(z10));
  nand3  g44(.a(x19), .b(x18), .c(x17), .O(new_n94_));
  nand2  g45(.a(new_n94_), .b(x20), .O(new_n95_));
  inv1   g46(.a(x15), .O(new_n96_));
  nand2  g47(.a(new_n54_), .b(new_n96_), .O(new_n97_));
  inv1   g48(.a(new_n97_), .O(new_n98_));
  nand3  g49(.a(new_n98_), .b(new_n95_), .c(new_n70_), .O(z13));
  inv1   g50(.a(new_n94_), .O(new_n100_));
  nor2   g51(.a(x21), .b(x20), .O(new_n101_));
  nand2  g52(.a(new_n101_), .b(new_n100_), .O(new_n102_));
  nand2  g53(.a(new_n70_), .b(x21), .O(new_n103_));
  nand3  g54(.a(new_n103_), .b(new_n102_), .c(new_n98_), .O(z14));
  nand2  g55(.a(new_n102_), .b(x22), .O(new_n105_));
  nand3  g56(.a(new_n100_), .b(new_n71_), .c(new_n69_), .O(new_n106_));
  nand3  g57(.a(new_n106_), .b(new_n105_), .c(new_n98_), .O(z15));
  nand2  g58(.a(new_n106_), .b(x23), .O(new_n108_));
  nor2   g59(.a(x23), .b(x22), .O(new_n109_));
  nand3  g60(.a(new_n109_), .b(new_n101_), .c(new_n100_), .O(new_n110_));
  nand3  g61(.a(new_n110_), .b(new_n108_), .c(new_n98_), .O(z16));
  inv1   g62(.a(new_n73_), .O(new_n112_));
  nand2  g63(.a(new_n110_), .b(x24), .O(new_n113_));
  nand4  g64(.a(new_n113_), .b(new_n89_), .c(new_n112_), .d(new_n88_), .O(z17));
  inv1   g65(.a(new_n70_), .O(new_n115_));
  nand4  g66(.a(new_n83_), .b(new_n71_), .c(new_n115_), .d(new_n48_), .O(new_n116_));
  nand2  g67(.a(new_n112_), .b(x25), .O(new_n117_));
  nand3  g68(.a(new_n117_), .b(new_n116_), .c(new_n98_), .O(z18));
  zero   g69(.O(z02));
  zero   g70(.O(z09));
  zero   g71(.O(z11));
  zero   g72(.O(z12));
