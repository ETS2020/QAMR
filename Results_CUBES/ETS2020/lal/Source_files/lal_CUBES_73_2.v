// Benchmark "FAU" written by ABC on Wed Jul  8 19:28:40 2020
...
module FAU ( 
  ...
  nand2  g41(.a(new_n83_), .b(new_n54_), .O(new_n89_));
  nor2   g42(.a(new_n89_), .b(new_n88_), .O(z11));
  nand3  g43(.a(x19), .b(x18), .c(x17), .O(new_n92_));
  nand2  g44(.a(new_n92_), .b(x20), .O(new_n93_));
  nand4  g45(.a(new_n93_), .b(new_n83_), .c(new_n66_), .d(new_n54_), .O(z13));
  inv1   g46(.a(new_n92_), .O(new_n95_));
  nor2   g47(.a(x21), .b(x20), .O(new_n96_));
  nand2  g48(.a(new_n96_), .b(new_n95_), .O(new_n97_));
  nand2  g49(.a(new_n66_), .b(x21), .O(new_n98_));
  nand2  g50(.a(new_n83_), .b(new_n54_), .O(new_n99_));
  inv1   g51(.a(new_n99_), .O(new_n100_));
  nand3  g52(.a(new_n100_), .b(new_n98_), .c(new_n97_), .O(z14));
  nand2  g53(.a(new_n97_), .b(x22), .O(new_n102_));
  nand3  g54(.a(new_n95_), .b(new_n67_), .c(new_n65_), .O(new_n103_));
  nand3  g55(.a(new_n103_), .b(new_n102_), .c(new_n100_), .O(z15));
  nand2  g56(.a(new_n103_), .b(x23), .O(new_n105_));
  nor2   g57(.a(x23), .b(x22), .O(new_n106_));
  nand3  g58(.a(new_n106_), .b(new_n96_), .c(new_n95_), .O(new_n107_));
  nand3  g59(.a(new_n107_), .b(new_n105_), .c(new_n100_), .O(z16));
  inv1   g60(.a(new_n69_), .O(new_n109_));
  nand2  g61(.a(new_n107_), .b(x24), .O(new_n110_));
  nand3  g62(.a(new_n110_), .b(new_n100_), .c(new_n109_), .O(z17));
  inv1   g63(.a(new_n66_), .O(new_n112_));
  nand4  g64(.a(new_n79_), .b(new_n67_), .c(new_n112_), .d(new_n48_), .O(new_n113_));
  nand2  g65(.a(new_n109_), .b(x25), .O(new_n114_));
  nand3  g66(.a(new_n114_), .b(new_n113_), .c(new_n100_), .O(z18));
  zero   g67(.O(z02));
  zero   g68(.O(z04));
  zero   g69(.O(z12));
endmodule
