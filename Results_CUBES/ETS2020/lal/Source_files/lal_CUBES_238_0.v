// Benchmark "FAU" written by ABC on Wed Jul  8 19:33:49 2020
...
module FAU ( 
  ...
  wire new_n49_, new_n50_, new_n51_, new_n52_, new_n53_, new_n54_, new_n57_,
    new_n59_, new_n62_, new_n63_, new_n64_, new_n68_, new_n69_, new_n70_,
  ...
  nand2  g16(.a(x18), .b(x17), .O(new_n68_));
  nand2  g17(.a(new_n68_), .b(x19), .O(new_n69_));
  inv1   g18(.a(x19), .O(new_n70_));
  nand3  g19(.a(new_n70_), .b(x18), .c(x17), .O(new_n71_));
  nand2  g20(.a(x05), .b(x04), .O(new_n72_));
  nand3  g21(.a(new_n72_), .b(new_n63_), .c(new_n62_), .O(new_n73_));
  aoi21  g22(.a(new_n71_), .b(new_n69_), .c(new_n73_), .O(z12));
  zero   g23(.O(z00));
  zero   g24(.O(z01));
  zero   g25(.O(z03));
  zero   g26(.O(z08));
