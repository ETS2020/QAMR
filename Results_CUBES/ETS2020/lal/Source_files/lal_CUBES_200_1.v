// Benchmark "FAU" written by ABC on Wed Jul  8 19:32:41 2020
...
module FAU ( 
  ...
  nand2  g36(.a(x05), .b(x04), .O(new_n87_));
  nand3  g37(.a(x19), .b(x18), .c(x17), .O(new_n88_));
  nand2  g38(.a(new_n88_), .b(x20), .O(new_n89_));
  nand4  g39(.a(new_n89_), .b(new_n81_), .c(new_n64_), .d(new_n87_), .O(z13));
  inv1   g40(.a(new_n88_), .O(new_n91_));
  nor2   g41(.a(x21), .b(x20), .O(new_n92_));
  nand2  g42(.a(new_n92_), .b(new_n91_), .O(new_n93_));
  nand2  g43(.a(new_n64_), .b(x21), .O(new_n94_));
  nand2  g44(.a(new_n81_), .b(new_n87_), .O(new_n95_));
  inv1   g45(.a(new_n95_), .O(new_n96_));
  nand3  g46(.a(new_n96_), .b(new_n94_), .c(new_n93_), .O(z14));
  nand2  g47(.a(new_n93_), .b(x22), .O(new_n98_));
  nand3  g48(.a(new_n91_), .b(new_n65_), .c(new_n63_), .O(new_n99_));
  nand3  g49(.a(new_n99_), .b(new_n98_), .c(new_n96_), .O(z15));
  nand2  g50(.a(new_n99_), .b(x23), .O(new_n101_));
  nor2   g51(.a(x23), .b(x22), .O(new_n102_));
  nand3  g52(.a(new_n102_), .b(new_n92_), .c(new_n91_), .O(new_n103_));
  nand3  g53(.a(new_n103_), .b(new_n101_), .c(new_n96_), .O(z16));
  inv1   g54(.a(new_n67_), .O(new_n105_));
  nand2  g55(.a(new_n103_), .b(x24), .O(new_n106_));
  nand3  g56(.a(new_n106_), .b(new_n96_), .c(new_n105_), .O(z17));
  inv1   g57(.a(new_n64_), .O(new_n108_));
  nand4  g58(.a(new_n77_), .b(new_n65_), .c(new_n108_), .d(new_n48_), .O(new_n109_));
  nand2  g59(.a(new_n105_), .b(x25), .O(new_n110_));
  nand3  g60(.a(new_n110_), .b(new_n109_), .c(new_n96_), .O(z18));
  zero   g61(.O(z02));
  zero   g62(.O(z04));
  zero   g63(.O(z10));
  zero   g64(.O(z11));
