// Benchmark "FAU" written by ABC on Wed Jul  8 19:30:31 2020
...
module FAU ( 
  ...
  nand2  g48(.a(new_n91_), .b(new_n56_), .O(new_n96_));
  nor2   g49(.a(new_n96_), .b(new_n95_), .O(z11));
  oai21  g50(.a(new_n80_), .b(new_n78_), .c(x19), .O(new_n98_));
  nor2   g51(.a(new_n80_), .b(new_n78_), .O(new_n99_));
  nand2  g52(.a(new_n99_), .b(new_n81_), .O(new_n100_));
