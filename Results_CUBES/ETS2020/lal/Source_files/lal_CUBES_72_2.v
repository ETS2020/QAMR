// Benchmark "FAU" written by ABC on Wed Jul  8 19:28:39 2020
...
module FAU ( 
  ...
  wire new_n46_, new_n48_, new_n49_, new_n50_, new_n51_, new_n52_, new_n53_,
    ...
    new_n89_, new_n93_, new_n94_, new_n95_, new_n96_, new_n97_, new_n99_,
  ...
  inv1   g45(.a(x07), .O(new_n94_));
  inv1   g46(.a(x15), .O(new_n95_));
  nand2  g47(.a(x05), .b(x04), .O(new_n96_));
  nand3  g48(.a(new_n96_), .b(new_n95_), .c(new_n94_), .O(new_n97_));
  nor2   g49(.a(new_n97_), .b(new_n93_), .O(z11));
  ...
  nand2  g56(.a(new_n56_), .b(new_n95_), .O(new_n105_));
  ...
  inv1   g74(.a(new_n97_), .O(new_n123_));
