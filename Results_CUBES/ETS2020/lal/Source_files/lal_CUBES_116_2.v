...
module FAU ( 
  ...
  oai21  g49(.a(new_n80_), .b(new_n78_), .c(x19), .O(new_n97_));
  nor2   g50(.a(new_n80_), .b(new_n78_), .O(new_n98_));
  nand2  g51(.a(new_n98_), .b(new_n81_), .O(new_n99_));
  nand2  g52(.a(new_n91_), .b(new_n56_), .O(new_n100_));
  ...
  nand4  g56(.a(new_n103_), .b(new_n91_), .c(new_n72_), .d(new_n56_), .O(z13));
  nor2   g57(.a(x21), .b(x20), .O(new_n105_));
  inv1   g58(.a(new_n105_), .O(new_n106_));
  nand2  g59(.a(new_n91_), .b(new_n56_), .O(new_n107_));
  aoi21  g60(.a(new_n72_), .b(x21), .c(new_n107_), .O(new_n108_));
  ...
  nand3  g65(.a(new_n112_), .b(new_n73_), .c(new_n71_), .O(new_n113_));
  nand3  g66(.a(new_n113_), .b(new_n111_), .c(new_n110_), .O(z15));
  nand2  g67(.a(new_n73_), .b(new_n71_), .O(new_n115_));
  ...
  inv1   g73(.a(new_n75_), .O(new_n121_));
  oai21  g74(.a(new_n117_), .b(new_n102_), .c(x24), .O(new_n122_));
  nand3  g75(.a(new_n122_), .b(new_n110_), .c(new_n121_), .O(z17));
  inv1   g76(.a(new_n72_), .O(new_n124_));
  nand4  g77(.a(new_n87_), .b(new_n73_), .c(new_n124_), .d(new_n48_), .O(new_n125_));
