...
module FAU ( 
  ...
  nand2  g60(.a(new_n101_), .b(x19), .O(new_n107_));
  nand2  g61(.a(new_n92_), .b(new_n56_), .O(new_n108_));
  aoi21  g62(.a(new_n73_), .b(x21), .c(new_n108_), .O(new_n109_));
  oai21  g63(.a(new_n107_), .b(new_n106_), .c(new_n109_), .O(z14));
  inv1   g64(.a(new_n108_), .O(new_n111_));
  oai21  g65(.a(new_n107_), .b(new_n106_), .c(x22), .O(new_n112_));
  inv1   g66(.a(new_n107_), .O(new_n113_));
  ...
  oai21  g70(.a(new_n116_), .b(new_n107_), .c(x23), .O(new_n117_));
  nand3  g71(.a(new_n105_), .b(new_n48_), .c(new_n52_), .O(new_n118_));
  ...
  oai21  g76(.a(new_n118_), .b(new_n107_), .c(x24), .O(new_n123_));
