...
module FAU ( 
  ...
  oai21  g43(.a(new_n79_), .b(new_n77_), .c(x19), .O(new_n93_));
  nor2   g44(.a(new_n79_), .b(new_n77_), .O(new_n94_));
  nand2  g45(.a(new_n94_), .b(new_n80_), .O(new_n95_));
  inv1   g46(.a(x07), .O(new_n96_));
  inv1   g47(.a(x15), .O(new_n97_));
  nand2  g48(.a(x05), .b(x04), .O(new_n98_));
  nand3  g49(.a(new_n98_), .b(new_n97_), .c(new_n96_), .O(new_n99_));
  aoi21  g50(.a(new_n95_), .b(new_n93_), .c(new_n99_), .O(z12));
  nand2  g51(.a(new_n94_), .b(x19), .O(new_n101_));
  nand2  g52(.a(new_n101_), .b(x20), .O(new_n102_));
  nand2  g53(.a(new_n56_), .b(new_n97_), .O(new_n103_));
  inv1   g54(.a(new_n103_), .O(new_n104_));
  nand3  g55(.a(new_n104_), .b(new_n102_), .c(new_n71_), .O(z13));
  nor2   g56(.a(x21), .b(x20), .O(new_n106_));
  inv1   g57(.a(new_n106_), .O(new_n107_));
  aoi21  g58(.a(new_n71_), .b(x21), .c(new_n103_), .O(new_n108_));
  ...
  nand3  g62(.a(new_n111_), .b(new_n72_), .c(new_n70_), .O(new_n112_));
  nand3  g63(.a(new_n112_), .b(new_n110_), .c(new_n104_), .O(z15));
  nand2  g64(.a(new_n72_), .b(new_n70_), .O(new_n114_));
  ...
  inv1   g70(.a(new_n74_), .O(new_n120_));
  inv1   g71(.a(new_n99_), .O(new_n121_));
  oai21  g72(.a(new_n116_), .b(new_n101_), .c(x24), .O(new_n122_));
  nand3  g73(.a(new_n122_), .b(new_n121_), .c(new_n120_), .O(z17));
  inv1   g74(.a(new_n71_), .O(new_n124_));
  nand4  g75(.a(new_n86_), .b(new_n72_), .c(new_n124_), .d(new_n48_), .O(new_n125_));
