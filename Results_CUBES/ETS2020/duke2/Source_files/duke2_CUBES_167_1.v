// Benchmark "FAU" written by ABC on Tue Jul  7 13:31:27 2020
...
module FAU ( 
  ...
  wire new_n60_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    new_n70_, new_n73_, new_n74_, new_n88_;
  ...
  nand2  g11(.a(x07), .b(x05), .O(new_n73_));
  nand4  g12(.a(new_n73_), .b(new_n66_), .c(x17), .d(new_n69_), .O(new_n74_));
  inv1   g13(.a(new_n74_), .O(z13));
  inv1   g14(.a(x21), .O(new_n88_));
  aoi21  g15(.a(new_n88_), .b(new_n60_), .c(x20), .O(z26));
  zero   g16(.O(z00));
  zero   g17(.O(z01));
  zero   g18(.O(z02));
  zero   g19(.O(z03));
