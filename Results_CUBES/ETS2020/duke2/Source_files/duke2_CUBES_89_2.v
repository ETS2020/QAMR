// Benchmark "FAU" written by ABC on Tue Jul  7 13:30:38 2020
...
module FAU ( 
  ...
  xnor2a g162(.a(x08), .b(x07), .O(new_n215_));
  nand3  g163(.a(new_n215_), .b(new_n161_), .c(new_n72_), .O(new_n216_));
  nand4  g164(.a(new_n171_), .b(new_n106_), .c(x16), .d(new_n52_), .O(new_n217_));
  aoi21  g165(.a(new_n217_), .b(new_n216_), .c(new_n176_), .O(z07));
  nand2  g166(.a(new_n86_), .b(new_n80_), .O(new_n220_));
  inv1   g167(.a(x14), .O(new_n221_));
  nand4  g168(.a(new_n221_), .b(x13), .c(x08), .d(x02), .O(new_n222_));
  oai21  g169(.a(new_n220_), .b(x05), .c(new_n222_), .O(new_n223_));
  nor2   g170(.a(x12), .b(new_n62_), .O(new_n224_));
  nand2  g171(.a(new_n224_), .b(new_n223_), .O(new_n225_));
  nand2  g172(.a(new_n221_), .b(x13), .O(new_n226_));
  ...
  nor3   g203(.a(new_n220_), .b(new_n176_), .c(x15), .O(new_n257_));
  oai21  g204(.a(new_n257_), .b(new_n163_), .c(x05), .O(new_n258_));
  inv1   g205(.a(new_n220_), .O(new_n259_));
  ...
  oai21  g217(.a(new_n77_), .b(new_n80_), .c(new_n197_), .O(new_n272_));
  nand2  g218(.a(new_n272_), .b(new_n86_), .O(new_n273_));
  nand3  g219(.a(new_n178_), .b(new_n221_), .c(x08), .O(new_n274_));
  aoi21  g220(.a(new_n274_), .b(new_n273_), .c(x15), .O(new_n275_));
  nand2  g221(.a(new_n97_), .b(new_n93_), .O(new_n276_));
  inv1   g222(.a(new_n276_), .O(new_n277_));
  oai21  g223(.a(new_n277_), .b(new_n275_), .c(new_n52_), .O(new_n278_));
  nand3  g224(.a(new_n130_), .b(x15), .c(new_n73_), .O(new_n279_));
  nand3  g225(.a(new_n259_), .b(new_n133_), .c(x12), .O(new_n280_));
  aoi21  g226(.a(new_n280_), .b(new_n279_), .c(x04), .O(new_n281_));
  inv1   g227(.a(new_n211_), .O(new_n282_));
  inv1   g228(.a(new_n212_), .O(new_n283_));
  nor3   g229(.a(new_n283_), .b(new_n282_), .c(new_n86_), .O(new_n284_));
  nor2   g230(.a(new_n284_), .b(new_n281_), .O(new_n285_));
  nand2  g231(.a(new_n167_), .b(new_n142_), .O(new_n286_));
  aoi21  g232(.a(new_n285_), .b(new_n278_), .c(new_n286_), .O(new_n287_));
  nor3   g233(.a(new_n164_), .b(new_n54_), .c(new_n58_), .O(new_n288_));
  oai21  g234(.a(new_n288_), .b(new_n287_), .c(new_n53_), .O(new_n289_));
  nor2   g235(.a(new_n53_), .b(x05), .O(new_n290_));
  nand2  g236(.a(new_n290_), .b(new_n254_), .O(new_n291_));
  aoi21  g237(.a(new_n291_), .b(new_n289_), .c(x09), .O(z12));
  nand2  g238(.a(new_n69_), .b(x17), .O(new_n293_));
  inv1   g239(.a(new_n293_), .O(new_n294_));
  oai21  g240(.a(new_n53_), .b(new_n52_), .c(new_n294_), .O(new_n295_));
  inv1   g241(.a(new_n295_), .O(z13));
  inv1   g242(.a(new_n155_), .O(new_n297_));
  nand3  g243(.a(new_n97_), .b(new_n52_), .c(new_n75_), .O(new_n298_));
  oai21  g244(.a(new_n283_), .b(new_n282_), .c(new_n298_), .O(new_n299_));
  aoi21  g245(.a(x21), .b(new_n72_), .c(x07), .O(new_n300_));
  nand2  g246(.a(new_n300_), .b(new_n299_), .O(new_n301_));
  nand3  g247(.a(new_n161_), .b(new_n234_), .c(x07), .O(new_n302_));
  aoi21  g248(.a(new_n302_), .b(new_n301_), .c(new_n297_), .O(new_n303_));
  nor2   g249(.a(x21), .b(x15), .O(new_n304_));
  nand4  g250(.a(new_n304_), .b(new_n66_), .c(new_n221_), .d(x04), .O(new_n305_));
  nor3   g251(.a(x18), .b(x09), .c(x05), .O(new_n306_));
  inv1   g252(.a(new_n306_), .O(new_n307_));
  aoi21  g253(.a(new_n305_), .b(new_n57_), .c(new_n307_), .O(new_n308_));
  oai21  g254(.a(new_n308_), .b(new_n303_), .c(new_n158_), .O(new_n309_));
  aoi21  g255(.a(new_n54_), .b(new_n53_), .c(new_n158_), .O(new_n310_));
  nor2   g256(.a(new_n53_), .b(x01), .O(new_n311_));
  oai21  g257(.a(new_n311_), .b(new_n310_), .c(new_n306_), .O(new_n312_));
  nand2  g258(.a(new_n312_), .b(new_n309_), .O(z14));
  nor2   g259(.a(x07), .b(new_n52_), .O(new_n314_));
  inv1   g260(.a(new_n314_), .O(new_n315_));
  nand3  g261(.a(new_n69_), .b(x17), .c(new_n54_), .O(new_n316_));
  nor2   g262(.a(new_n316_), .b(new_n315_), .O(z15));
  nand2  g263(.a(new_n155_), .b(new_n158_), .O(new_n318_));
  oai21  g264(.a(new_n224_), .b(new_n179_), .c(x02), .O(new_n319_));
  ...
  nand2  g273(.a(new_n234_), .b(x09), .O(new_n328_));
  ...
  nand3  g280(.a(new_n159_), .b(new_n334_), .c(x09), .O(new_n335_));
  aoi21  g281(.a(new_n335_), .b(new_n333_), .c(new_n318_), .O(z16));
  inv1   g282(.a(new_n206_), .O(new_n337_));
  nand3  g283(.a(x12), .b(new_n80_), .c(new_n62_), .O(new_n338_));
  oai21  g284(.a(new_n125_), .b(new_n75_), .c(new_n338_), .O(new_n339_));
  nor2   g285(.a(x15), .b(x08), .O(new_n340_));
  nand4  g286(.a(new_n340_), .b(new_n339_), .c(new_n167_), .d(new_n79_), .O(new_n341_));
  aoi21  g287(.a(new_n341_), .b(new_n203_), .c(x07), .O(new_n342_));
  oai21  g288(.a(new_n342_), .b(new_n337_), .c(new_n52_), .O(new_n343_));
  nand4  g289(.a(new_n210_), .b(new_n109_), .c(x15), .d(new_n73_), .O(new_n344_));
  aoi21  g290(.a(new_n344_), .b(new_n343_), .c(x09), .O(z17));
  nand3  g291(.a(new_n81_), .b(x21), .c(new_n73_), .O(new_n346_));
  nand4  g292(.a(new_n88_), .b(new_n142_), .c(new_n83_), .d(new_n80_), .O(new_n347_));
  aoi21  g293(.a(new_n347_), .b(new_n346_), .c(new_n75_), .O(new_n348_));
  nand3  g294(.a(x21), .b(new_n86_), .c(new_n62_), .O(new_n349_));
  nor2   g295(.a(new_n83_), .b(new_n86_), .O(new_n350_));
  inv1   g296(.a(new_n350_), .O(new_n351_));
  nand3  g297(.a(new_n142_), .b(new_n181_), .c(new_n87_), .O(new_n352_));
  oai21  g298(.a(new_n352_), .b(new_n351_), .c(new_n349_), .O(new_n353_));
  nand2  g299(.a(new_n353_), .b(new_n80_), .O(new_n354_));
  nand3  g300(.a(new_n350_), .b(new_n190_), .c(x06), .O(new_n355_));
  aoi21  g301(.a(new_n355_), .b(new_n354_), .c(new_n65_), .O(new_n356_));
  oai21  g302(.a(new_n356_), .b(new_n348_), .c(new_n67_), .O(new_n357_));
  nand3  g303(.a(x19), .b(x15), .c(new_n86_), .O(new_n358_));
  nor2   g304(.a(x17), .b(x09), .O(new_n359_));
  nand3  g305(.a(new_n359_), .b(new_n149_), .c(x18), .O(new_n360_));
  aoi21  g306(.a(new_n358_), .b(new_n357_), .c(new_n360_), .O(z18));
  inv1   g307(.a(new_n149_), .O(new_n362_));
  nor2   g308(.a(new_n316_), .b(new_n362_), .O(z19));
  inv1   g309(.a(new_n281_), .O(new_n364_));
  nand2  g310(.a(new_n350_), .b(new_n221_), .O(new_n365_));
  oai21  g311(.a(new_n365_), .b(new_n177_), .c(new_n220_), .O(new_n366_));
  aoi21  g312(.a(new_n366_), .b(new_n52_), .c(new_n130_), .O(new_n367_));
  nand2  g313(.a(new_n224_), .b(new_n54_), .O(new_n368_));
  oai21  g314(.a(new_n368_), .b(new_n367_), .c(new_n364_), .O(new_n369_));
  inv1   g315(.a(new_n224_), .O(new_n370_));
  nand2  g316(.a(x12), .b(new_n62_), .O(new_n371_));
  nand4  g317(.a(new_n259_), .b(new_n133_), .c(x21), .d(new_n221_), .O(new_n372_));
  aoi21  g318(.a(new_n371_), .b(new_n370_), .c(new_n372_), .O(new_n373_));
  aoi21  g319(.a(new_n369_), .b(new_n142_), .c(new_n373_), .O(new_n374_));
  nor2   g320(.a(new_n65_), .b(x05), .O(new_n375_));
  nand4  g321(.a(new_n375_), .b(new_n248_), .c(new_n67_), .d(x04), .O(new_n376_));
  oai21  g322(.a(new_n374_), .b(new_n99_), .c(new_n376_), .O(new_n377_));
  nand2  g323(.a(new_n377_), .b(new_n72_), .O(new_n378_));
  nor2   g324(.a(new_n99_), .b(x15), .O(new_n379_));
  nand4  g325(.a(new_n379_), .b(new_n224_), .c(new_n130_), .d(x09), .O(new_n380_));
  nand2  g326(.a(new_n158_), .b(new_n53_), .O(new_n381_));
  aoi21  g327(.a(new_n380_), .b(new_n378_), .c(new_n381_), .O(z20));
  nor2   g328(.a(new_n54_), .b(x09), .O(new_n383_));
  nand2  g329(.a(new_n383_), .b(new_n259_), .O(new_n384_));
  nand3  g330(.a(new_n171_), .b(x08), .c(x06), .O(new_n385_));
  aoi21  g331(.a(new_n385_), .b(new_n384_), .c(x05), .O(new_n386_));
  inv1   g332(.a(new_n135_), .O(new_n387_));
  nor4   g333(.a(new_n387_), .b(x15), .c(x09), .d(new_n80_), .O(new_n388_));
  oai21  g334(.a(new_n388_), .b(new_n386_), .c(new_n53_), .O(new_n389_));
  nand3  g335(.a(new_n383_), .b(new_n290_), .c(x08), .O(new_n390_));
  aoi21  g336(.a(new_n390_), .b(new_n389_), .c(new_n176_), .O(z21));
  nand2  g337(.a(new_n383_), .b(new_n81_), .O(new_n392_));
  nand2  g338(.a(new_n171_), .b(x08), .O(new_n393_));
  aoi21  g339(.a(new_n393_), .b(new_n392_), .c(x05), .O(new_n394_));
  oai21  g340(.a(new_n394_), .b(new_n388_), .c(new_n53_), .O(new_n395_));
  nand2  g341(.a(new_n290_), .b(new_n119_), .O(new_n396_));
  aoi21  g342(.a(new_n396_), .b(new_n395_), .c(new_n176_), .O(z22));
  nor3   g343(.a(new_n269_), .b(new_n362_), .c(new_n72_), .O(z23));
  inv1   g344(.a(new_n359_), .O(new_n399_));
  nand3  g345(.a(new_n130_), .b(x18), .c(new_n65_), .O(new_n400_));
  nand3  g346(.a(new_n375_), .b(new_n99_), .c(new_n221_), .O(new_n401_));
  nand2  g347(.a(new_n54_), .b(x04), .O(new_n402_));
  aoi21  g348(.a(new_n401_), .b(new_n400_), .c(new_n402_), .O(new_n403_));
  nand3  g349(.a(x11), .b(new_n52_), .c(new_n75_), .O(new_n404_));
  nand2  g350(.a(new_n107_), .b(new_n73_), .O(new_n405_));
  nand2  g351(.a(new_n119_), .b(x18), .O(new_n406_));
  aoi21  g352(.a(new_n405_), .b(new_n404_), .c(new_n406_), .O(new_n407_));
  oai21  g353(.a(new_n407_), .b(new_n403_), .c(new_n142_), .O(new_n408_));
  nand3  g354(.a(new_n379_), .b(new_n86_), .c(new_n52_), .O(new_n409_));
  nand2  g355(.a(new_n409_), .b(new_n408_), .O(new_n410_));
  nand2  g356(.a(new_n410_), .b(new_n53_), .O(new_n411_));
  nand4  g357(.a(new_n290_), .b(new_n116_), .c(new_n99_), .d(x08), .O(new_n412_));
  aoi21  g358(.a(new_n412_), .b(new_n411_), .c(new_n399_), .O(z24));
  nand2  g359(.a(new_n383_), .b(new_n86_), .O(new_n414_));
  nand2  g360(.a(new_n167_), .b(new_n149_), .O(new_n415_));
  aoi21  g361(.a(new_n414_), .b(new_n393_), .c(new_n415_), .O(z25));
  nor2   g362(.a(new_n89_), .b(x20), .O(z26));
  inv1   g363(.a(new_n76_), .O(new_n418_));
  nand2  g364(.a(new_n133_), .b(new_n81_), .O(new_n419_));
  nor2   g365(.a(new_n419_), .b(new_n418_), .O(new_n420_));
  oai21  g366(.a(new_n420_), .b(new_n281_), .c(new_n142_), .O(new_n421_));
  nand3  g367(.a(new_n135_), .b(x19), .c(new_n54_), .O(new_n422_));
  aoi21  g368(.a(new_n422_), .b(new_n421_), .c(x07), .O(new_n423_));
  nor4   g369(.a(new_n160_), .b(new_n234_), .c(new_n86_), .d(new_n53_), .O(new_n424_));
  oai21  g370(.a(new_n424_), .b(new_n423_), .c(new_n167_), .O(new_n425_));
  nand3  g371(.a(x15), .b(new_n53_), .c(x00), .O(new_n426_));
  oai21  g372(.a(x15), .b(new_n53_), .c(new_n426_), .O(new_n427_));
  nand4  g373(.a(new_n427_), .b(new_n99_), .c(x17), .d(new_n52_), .O(new_n428_));
  nand2  g374(.a(new_n428_), .b(new_n425_), .O(new_n429_));
  nand2  g375(.a(new_n429_), .b(new_n72_), .O(new_n430_));
  inv1   g376(.a(x03), .O(new_n431_));
  nor2   g377(.a(x05), .b(new_n431_), .O(new_n432_));
  nand4  g378(.a(new_n432_), .b(new_n264_), .c(new_n171_), .d(new_n106_), .O(new_n433_));
  nand2  g379(.a(new_n433_), .b(new_n430_), .O(z27));
  nand3  g380(.a(new_n249_), .b(new_n142_), .c(x11), .O(new_n435_));
  aoi21  g381(.a(new_n435_), .b(new_n72_), .c(x02), .O(new_n436_));
  nand2  g382(.a(x11), .b(new_n53_), .O(new_n437_));
  oai21  g383(.a(new_n437_), .b(new_n436_), .c(x15), .O(new_n438_));
  nand3  g384(.a(x13), .b(new_n73_), .c(new_n75_), .O(new_n439_));
  inv1   g385(.a(new_n67_), .O(new_n440_));
  nor2   g386(.a(new_n440_), .b(x21), .O(new_n441_));
  nand4  g387(.a(new_n441_), .b(new_n439_), .c(new_n249_), .d(new_n183_), .O(new_n442_));
  aoi21  g388(.a(new_n442_), .b(new_n438_), .c(x05), .O(new_n443_));
  nand4  g389(.a(new_n243_), .b(new_n107_), .c(new_n54_), .d(x12), .O(new_n444_));
  nand2  g390(.a(new_n383_), .b(x21), .O(new_n445_));
  aoi21  g391(.a(new_n445_), .b(new_n444_), .c(x07), .O(new_n446_));
  oai21  g392(.a(new_n446_), .b(new_n443_), .c(x08), .O(new_n447_));
  nor3   g393(.a(new_n199_), .b(new_n440_), .c(new_n142_), .O(new_n448_));
  nor2   g394(.a(x19), .b(new_n54_), .O(new_n449_));
  nand3  g395(.a(new_n149_), .b(new_n72_), .c(new_n86_), .O(new_n450_));
  inv1   g396(.a(new_n450_), .O(new_n451_));
  oai21  g397(.a(new_n449_), .b(new_n448_), .c(new_n451_), .O(new_n452_));
  aoi21  g398(.a(new_n452_), .b(new_n447_), .c(new_n99_), .O(new_n453_));
  nand2  g399(.a(new_n383_), .b(new_n99_), .O(new_n454_));
  oai21  g400(.a(new_n73_), .b(new_n75_), .c(new_n290_), .O(new_n455_));
  nor2   g401(.a(new_n455_), .b(new_n454_), .O(new_n456_));
  oai21  g402(.a(new_n456_), .b(new_n453_), .c(new_n158_), .O(new_n457_));
  oai21  g403(.a(new_n234_), .b(new_n53_), .c(new_n152_), .O(new_n458_));
  nand2  g404(.a(new_n458_), .b(new_n315_), .O(new_n459_));
  nand2  g405(.a(new_n459_), .b(new_n294_), .O(new_n460_));
  nand2  g406(.a(new_n460_), .b(new_n457_), .O(z28));
  zero   g407(.O(z05));
  zero   g408(.O(z08));
  zero   g409(.O(z11));
endmodule
