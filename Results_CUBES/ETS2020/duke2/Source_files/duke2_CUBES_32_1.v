...
module FAU ( 
  ...
  wire new_n60_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    new_n70_, new_n79_, new_n80_, new_n81_, new_n89_;
  ...
  inv1   g11(.a(x07), .O(new_n79_));
  nand2  g12(.a(new_n79_), .b(new_n68_), .O(new_n80_));
  nand4  g13(.a(new_n66_), .b(x17), .c(new_n64_), .d(new_n69_), .O(new_n81_));
  nor2   g14(.a(new_n81_), .b(new_n80_), .O(z19));
