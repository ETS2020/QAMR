...
module FAU ( 
  ...
  oai21  g373(.a(new_n426_), .b(new_n293_), .c(new_n143_), .O(new_n427_));
  ...
  oai21  g407(.a(new_n73_), .b(new_n75_), .c(new_n302_), .O(new_n461_));
  ...
  nand2  g411(.a(new_n464_), .b(new_n327_), .O(new_n465_));
  nand2  g412(.a(new_n465_), .b(new_n306_), .O(new_n466_));
