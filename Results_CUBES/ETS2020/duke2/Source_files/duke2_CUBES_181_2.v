// Benchmark "FAU" written by ABC on Tue Jul  7 13:31:35 2020
...
module FAU ( 
  ...
  nand2  g269(.a(new_n53_), .b(x05), .O(new_n323_));
  nand3  g270(.a(new_n69_), .b(x17), .c(new_n54_), .O(new_n324_));
  nor2   g271(.a(new_n324_), .b(new_n323_), .O(z15));
  nand2  g272(.a(new_n156_), .b(new_n159_), .O(new_n326_));
  oai21  g273(.a(new_n187_), .b(new_n177_), .c(x02), .O(new_n327_));
  nor2   g274(.a(x16), .b(new_n65_), .O(new_n328_));
  oai21  g275(.a(new_n74_), .b(new_n87_), .c(new_n328_), .O(new_n329_));
  aoi21  g276(.a(new_n329_), .b(new_n327_), .c(new_n80_), .O(new_n330_));
  inv1   g277(.a(new_n74_), .O(new_n331_));
  nand3  g278(.a(x16), .b(x12), .c(new_n80_), .O(new_n332_));
  aoi22  g279(.a(new_n332_), .b(new_n84_), .c(new_n331_), .d(x13), .O(new_n333_));
  nor3   g280(.a(x21), .b(x14), .c(x09), .O(new_n334_));
  oai21  g281(.a(new_n333_), .b(new_n330_), .c(new_n334_), .O(new_n335_));
  nand2  g282(.a(new_n246_), .b(x09), .O(new_n336_));
  nand2  g283(.a(new_n54_), .b(new_n53_), .O(new_n337_));
  aoi21  g284(.a(new_n336_), .b(new_n335_), .c(new_n337_), .O(new_n338_));
  nand2  g285(.a(x15), .b(x09), .O(new_n339_));
  aoi21  g286(.a(new_n53_), .b(x02), .c(new_n339_), .O(new_n340_));
  oai21  g287(.a(new_n340_), .b(new_n338_), .c(new_n52_), .O(new_n341_));
  inv1   g288(.a(new_n66_), .O(new_n342_));
  nand3  g289(.a(new_n160_), .b(new_n342_), .c(x09), .O(new_n343_));
  aoi21  g290(.a(new_n343_), .b(new_n341_), .c(new_n326_), .O(z16));
  inv1   g291(.a(new_n219_), .O(new_n345_));
  nand2  g292(.a(new_n176_), .b(new_n80_), .O(new_n346_));
  oai21  g293(.a(new_n125_), .b(new_n75_), .c(new_n346_), .O(new_n347_));
  nor2   g294(.a(x15), .b(x08), .O(new_n348_));
  nand4  g295(.a(new_n348_), .b(new_n347_), .c(new_n168_), .d(new_n79_), .O(new_n349_));
  aoi21  g296(.a(new_n349_), .b(new_n216_), .c(x07), .O(new_n350_));
  oai21  g297(.a(new_n350_), .b(new_n345_), .c(new_n52_), .O(new_n351_));
  nand4  g298(.a(new_n223_), .b(new_n109_), .c(x15), .d(new_n73_), .O(new_n352_));
  aoi21  g299(.a(new_n352_), .b(new_n351_), .c(x09), .O(z17));
  nand3  g300(.a(x21), .b(new_n86_), .c(new_n62_), .O(new_n354_));
  nor2   g301(.a(new_n83_), .b(new_n86_), .O(new_n355_));
  inv1   g302(.a(new_n355_), .O(new_n356_));
  oai21  g303(.a(new_n356_), .b(new_n183_), .c(new_n354_), .O(new_n357_));
  nand2  g304(.a(new_n357_), .b(new_n80_), .O(new_n358_));
  inv1   g305(.a(new_n191_), .O(new_n359_));
  nand3  g306(.a(new_n355_), .b(new_n359_), .c(x06), .O(new_n360_));
  aoi21  g307(.a(new_n360_), .b(new_n358_), .c(new_n65_), .O(new_n361_));
  oai21  g308(.a(new_n361_), .b(new_n189_), .c(new_n67_), .O(new_n362_));
  nand3  g309(.a(x19), .b(x15), .c(new_n86_), .O(new_n363_));
  nor2   g310(.a(x17), .b(x09), .O(new_n364_));
  nand3  g311(.a(new_n364_), .b(new_n150_), .c(x18), .O(new_n365_));
  aoi21  g312(.a(new_n363_), .b(new_n362_), .c(new_n365_), .O(z18));
  inv1   g313(.a(new_n150_), .O(new_n367_));
  nor2   g314(.a(new_n324_), .b(new_n367_), .O(z19));
  inv1   g315(.a(new_n293_), .O(new_n369_));
  nand2  g316(.a(new_n355_), .b(new_n232_), .O(new_n370_));
  oai21  g317(.a(new_n370_), .b(new_n199_), .c(new_n234_), .O(new_n371_));
  aoi21  g318(.a(new_n371_), .b(new_n52_), .c(new_n130_), .O(new_n372_));
  nand2  g319(.a(new_n177_), .b(new_n54_), .O(new_n373_));
  oai21  g320(.a(new_n373_), .b(new_n372_), .c(new_n369_), .O(new_n374_));
  nor4   g321(.a(new_n234_), .b(new_n178_), .c(new_n134_), .d(x14), .O(new_n375_));
  aoi21  g322(.a(new_n374_), .b(new_n143_), .c(new_n375_), .O(new_n376_));
  nor2   g323(.a(new_n65_), .b(x05), .O(new_n377_));
  nand4  g324(.a(new_n377_), .b(new_n260_), .c(new_n67_), .d(x04), .O(new_n378_));
  oai21  g325(.a(new_n376_), .b(new_n99_), .c(new_n378_), .O(new_n379_));
  nand2  g326(.a(new_n379_), .b(new_n72_), .O(new_n380_));
  nor2   g327(.a(new_n99_), .b(x15), .O(new_n381_));
  nand4  g328(.a(new_n381_), .b(new_n177_), .c(new_n130_), .d(x09), .O(new_n382_));
  nand2  g329(.a(new_n159_), .b(new_n53_), .O(new_n383_));
  aoi21  g330(.a(new_n382_), .b(new_n380_), .c(new_n383_), .O(z20));
  nor2   g331(.a(new_n54_), .b(x09), .O(new_n385_));
  nand2  g332(.a(new_n385_), .b(new_n271_), .O(new_n386_));
  nand3  g333(.a(new_n172_), .b(x08), .c(x06), .O(new_n387_));
  aoi21  g334(.a(new_n387_), .b(new_n386_), .c(x05), .O(new_n388_));
  inv1   g335(.a(new_n136_), .O(new_n389_));
  nor4   g336(.a(new_n389_), .b(x15), .c(x09), .d(new_n80_), .O(new_n390_));
  oai21  g337(.a(new_n390_), .b(new_n388_), .c(new_n53_), .O(new_n391_));
  nand3  g338(.a(new_n385_), .b(new_n302_), .c(x08), .O(new_n392_));
  aoi21  g339(.a(new_n392_), .b(new_n391_), .c(new_n198_), .O(z21));
  nand2  g340(.a(new_n385_), .b(new_n81_), .O(new_n394_));
  nand2  g341(.a(new_n172_), .b(x08), .O(new_n395_));
  aoi21  g342(.a(new_n395_), .b(new_n394_), .c(x05), .O(new_n396_));
  oai21  g343(.a(new_n396_), .b(new_n390_), .c(new_n53_), .O(new_n397_));
  nand2  g344(.a(new_n302_), .b(new_n119_), .O(new_n398_));
  aoi21  g345(.a(new_n398_), .b(new_n397_), .c(new_n198_), .O(z22));
  nor3   g346(.a(new_n281_), .b(new_n367_), .c(new_n72_), .O(z23));
  inv1   g347(.a(new_n364_), .O(new_n401_));
  nand3  g348(.a(new_n130_), .b(x18), .c(new_n65_), .O(new_n402_));
  nand3  g349(.a(new_n377_), .b(new_n99_), .c(new_n232_), .O(new_n403_));
  nand2  g350(.a(new_n54_), .b(x04), .O(new_n404_));
  aoi21  g351(.a(new_n403_), .b(new_n402_), .c(new_n404_), .O(new_n405_));
  nand3  g352(.a(x11), .b(new_n52_), .c(new_n75_), .O(new_n406_));
  nand2  g353(.a(new_n107_), .b(new_n73_), .O(new_n407_));
  nand2  g354(.a(new_n119_), .b(x18), .O(new_n408_));
  aoi21  g355(.a(new_n407_), .b(new_n406_), .c(new_n408_), .O(new_n409_));
  oai21  g356(.a(new_n409_), .b(new_n405_), .c(new_n143_), .O(new_n410_));
  nand3  g357(.a(new_n381_), .b(new_n86_), .c(new_n52_), .O(new_n411_));
  nand2  g358(.a(new_n411_), .b(new_n410_), .O(new_n412_));
  nand2  g359(.a(new_n412_), .b(new_n53_), .O(new_n413_));
  nand4  g360(.a(new_n302_), .b(new_n116_), .c(new_n99_), .d(x08), .O(new_n414_));
  aoi21  g361(.a(new_n414_), .b(new_n413_), .c(new_n401_), .O(z24));
  nand2  g362(.a(new_n385_), .b(new_n86_), .O(new_n416_));
  nand2  g363(.a(new_n168_), .b(new_n150_), .O(new_n417_));
  aoi21  g364(.a(new_n416_), .b(new_n395_), .c(new_n417_), .O(z25));
  nor2   g365(.a(new_n89_), .b(x20), .O(z26));
  inv1   g366(.a(new_n76_), .O(new_n420_));
  nand2  g367(.a(new_n133_), .b(new_n81_), .O(new_n421_));
  nor2   g368(.a(new_n421_), .b(new_n420_), .O(new_n422_));
  oai21  g369(.a(new_n422_), .b(new_n293_), .c(new_n143_), .O(new_n423_));
  nand3  g370(.a(new_n136_), .b(x19), .c(new_n54_), .O(new_n424_));
  aoi21  g371(.a(new_n424_), .b(new_n423_), .c(x07), .O(new_n425_));
  nor4   g372(.a(new_n161_), .b(new_n246_), .c(new_n86_), .d(new_n53_), .O(new_n426_));
  oai21  g373(.a(new_n426_), .b(new_n425_), .c(new_n168_), .O(new_n427_));
  nand3  g374(.a(x15), .b(new_n53_), .c(x00), .O(new_n428_));
  oai21  g375(.a(x15), .b(new_n53_), .c(new_n428_), .O(new_n429_));
  nand4  g376(.a(new_n429_), .b(new_n99_), .c(x17), .d(new_n52_), .O(new_n430_));
  nand2  g377(.a(new_n430_), .b(new_n427_), .O(new_n431_));
  nand2  g378(.a(new_n431_), .b(new_n72_), .O(new_n432_));
  inv1   g379(.a(x03), .O(new_n433_));
  nor2   g380(.a(x05), .b(new_n433_), .O(new_n434_));
  nand4  g381(.a(new_n434_), .b(new_n276_), .c(new_n172_), .d(new_n106_), .O(new_n435_));
  nand2  g382(.a(new_n435_), .b(new_n432_), .O(z27));
  nand3  g383(.a(new_n261_), .b(new_n143_), .c(x11), .O(new_n437_));
  aoi21  g384(.a(new_n437_), .b(new_n72_), .c(x02), .O(new_n438_));
  nand2  g385(.a(x11), .b(new_n53_), .O(new_n439_));
  oai21  g386(.a(new_n439_), .b(new_n438_), .c(x15), .O(new_n440_));
  nand3  g387(.a(x13), .b(new_n73_), .c(new_n75_), .O(new_n441_));
  inv1   g388(.a(new_n67_), .O(new_n442_));
  nor2   g389(.a(new_n442_), .b(x21), .O(new_n443_));
  nand4  g390(.a(new_n443_), .b(new_n441_), .c(new_n261_), .d(new_n180_), .O(new_n444_));
  aoi21  g391(.a(new_n444_), .b(new_n440_), .c(x05), .O(new_n445_));
  nand4  g392(.a(new_n255_), .b(new_n107_), .c(new_n54_), .d(x12), .O(new_n446_));
  nand2  g393(.a(new_n385_), .b(x21), .O(new_n447_));
  aoi21  g394(.a(new_n447_), .b(new_n446_), .c(x07), .O(new_n448_));
  oai21  g395(.a(new_n448_), .b(new_n445_), .c(x08), .O(new_n449_));
  nor3   g396(.a(new_n212_), .b(new_n442_), .c(new_n143_), .O(new_n450_));
  nor2   g397(.a(x19), .b(new_n54_), .O(new_n451_));
  nand3  g398(.a(new_n150_), .b(new_n72_), .c(new_n86_), .O(new_n452_));
  inv1   g399(.a(new_n452_), .O(new_n453_));
  oai21  g400(.a(new_n451_), .b(new_n450_), .c(new_n453_), .O(new_n454_));
  aoi21  g401(.a(new_n454_), .b(new_n449_), .c(new_n99_), .O(new_n455_));
  nand2  g402(.a(new_n385_), .b(new_n99_), .O(new_n456_));
  oai21  g403(.a(new_n73_), .b(new_n75_), .c(new_n302_), .O(new_n457_));
  nor2   g404(.a(new_n457_), .b(new_n456_), .O(new_n458_));
  oai21  g405(.a(new_n458_), .b(new_n455_), .c(new_n159_), .O(new_n459_));
  oai21  g406(.a(new_n246_), .b(new_n53_), .c(new_n153_), .O(new_n460_));
  nand2  g407(.a(new_n460_), .b(new_n323_), .O(new_n461_));
  nand3  g408(.a(new_n461_), .b(new_n69_), .c(x17), .O(new_n462_));
  nand2  g409(.a(new_n462_), .b(new_n459_), .O(z28));
  zero   g410(.O(z11));
  zero   g411(.O(z13));
endmodule
