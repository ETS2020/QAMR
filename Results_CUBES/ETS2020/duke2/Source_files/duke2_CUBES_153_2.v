// Benchmark "FAU" written by ABC on Tue Jul  7 13:31:18 2020
...
module FAU ( 
  ...
  inv1   g368(.a(new_n76_), .O(new_n422_));
  nand2  g369(.a(new_n133_), .b(new_n81_), .O(new_n423_));
  nor2   g370(.a(new_n423_), .b(new_n422_), .O(new_n424_));
  oai21  g371(.a(new_n424_), .b(new_n293_), .c(new_n143_), .O(new_n425_));
  nand3  g372(.a(new_n136_), .b(x19), .c(new_n54_), .O(new_n426_));
  aoi21  g373(.a(new_n426_), .b(new_n425_), .c(x07), .O(new_n427_));
  nor4   g374(.a(new_n161_), .b(new_n246_), .c(new_n86_), .d(new_n53_), .O(new_n428_));
  oai21  g375(.a(new_n428_), .b(new_n427_), .c(new_n168_), .O(new_n429_));
  nand3  g376(.a(x15), .b(new_n53_), .c(x00), .O(new_n430_));
  oai21  g377(.a(x15), .b(new_n53_), .c(new_n430_), .O(new_n431_));
  nand4  g378(.a(new_n431_), .b(new_n99_), .c(x17), .d(new_n52_), .O(new_n432_));
  nand2  g379(.a(new_n432_), .b(new_n429_), .O(new_n433_));
  nand2  g380(.a(new_n433_), .b(new_n72_), .O(new_n434_));
  inv1   g381(.a(x03), .O(new_n435_));
  nor2   g382(.a(x05), .b(new_n435_), .O(new_n436_));
  nand4  g383(.a(new_n436_), .b(new_n276_), .c(new_n172_), .d(new_n106_), .O(new_n437_));
  nand2  g384(.a(new_n437_), .b(new_n434_), .O(z27));
  nand3  g385(.a(new_n261_), .b(new_n143_), .c(x11), .O(new_n439_));
  aoi21  g386(.a(new_n439_), .b(new_n72_), .c(x02), .O(new_n440_));
  nand2  g387(.a(x11), .b(new_n53_), .O(new_n441_));
  oai21  g388(.a(new_n441_), .b(new_n440_), .c(x15), .O(new_n442_));
  nand3  g389(.a(x13), .b(new_n73_), .c(new_n75_), .O(new_n443_));
  inv1   g390(.a(new_n67_), .O(new_n444_));
  nor2   g391(.a(new_n444_), .b(x21), .O(new_n445_));
  nand4  g392(.a(new_n445_), .b(new_n443_), .c(new_n261_), .d(new_n180_), .O(new_n446_));
  aoi21  g393(.a(new_n446_), .b(new_n442_), .c(x05), .O(new_n447_));
  nand4  g394(.a(new_n255_), .b(new_n107_), .c(new_n54_), .d(x12), .O(new_n448_));
  nand2  g395(.a(new_n389_), .b(x21), .O(new_n449_));
  aoi21  g396(.a(new_n449_), .b(new_n448_), .c(x07), .O(new_n450_));
  oai21  g397(.a(new_n450_), .b(new_n447_), .c(x08), .O(new_n451_));
  nor3   g398(.a(new_n212_), .b(new_n444_), .c(new_n143_), .O(new_n452_));
  nor2   g399(.a(x19), .b(new_n54_), .O(new_n453_));
  nand3  g400(.a(new_n150_), .b(new_n72_), .c(new_n86_), .O(new_n454_));
  inv1   g401(.a(new_n454_), .O(new_n455_));
  oai21  g402(.a(new_n453_), .b(new_n452_), .c(new_n455_), .O(new_n456_));
  aoi21  g403(.a(new_n456_), .b(new_n451_), .c(new_n99_), .O(new_n457_));
  nand2  g404(.a(new_n389_), .b(new_n99_), .O(new_n458_));
  oai21  g405(.a(new_n73_), .b(new_n75_), .c(new_n302_), .O(new_n459_));
  nor2   g406(.a(new_n459_), .b(new_n458_), .O(new_n460_));
  oai21  g407(.a(new_n460_), .b(new_n457_), .c(new_n159_), .O(new_n461_));
  oai21  g408(.a(new_n246_), .b(new_n53_), .c(new_n153_), .O(new_n462_));
  nand2  g409(.a(new_n462_), .b(new_n327_), .O(new_n463_));
  nand2  g410(.a(new_n463_), .b(new_n306_), .O(new_n464_));
  nand2  g411(.a(new_n464_), .b(new_n461_), .O(z28));
  zero   g412(.O(z11));
  zero   g413(.O(z25));
endmodule
