// Benchmark "FAU" written by ABC on Tue Jul  7 13:30:54 2020
...
module FAU ( 
  ...
  nand2  g180(.a(new_n86_), .b(new_n80_), .O(new_n233_));
  inv1   g181(.a(x14), .O(new_n234_));
  nand4  g182(.a(new_n234_), .b(x13), .c(x08), .d(x02), .O(new_n235_));
  oai21  g183(.a(new_n233_), .b(x05), .c(new_n235_), .O(new_n236_));
  nand2  g184(.a(new_n236_), .b(new_n177_), .O(new_n237_));
  nand2  g185(.a(new_n234_), .b(x13), .O(new_n238_));
  ...
  nor3   g216(.a(new_n233_), .b(new_n198_), .c(x15), .O(new_n269_));
  oai21  g217(.a(new_n269_), .b(new_n164_), .c(x05), .O(new_n270_));
  inv1   g218(.a(new_n233_), .O(new_n271_));
  ...
  nand3  g234(.a(new_n200_), .b(new_n234_), .c(x08), .O(new_n287_));
  ...
  nand4  g265(.a(new_n317_), .b(new_n66_), .c(new_n234_), .d(x04), .O(new_n318_));
  ...
  nand2  g322(.a(new_n360_), .b(new_n234_), .O(new_n375_));
  oai21  g323(.a(new_n375_), .b(new_n199_), .c(new_n233_), .O(new_n376_));
  ...
  nor4   g327(.a(new_n233_), .b(new_n178_), .c(new_n134_), .d(x14), .O(new_n380_));
  ...
  nand3  g355(.a(new_n382_), .b(new_n99_), .c(new_n234_), .O(new_n408_));
  ...
  inv1   g371(.a(new_n76_), .O(new_n425_));
  nand2  g372(.a(new_n133_), .b(new_n81_), .O(new_n426_));
  nor2   g373(.a(new_n426_), .b(new_n425_), .O(new_n427_));
  oai21  g374(.a(new_n427_), .b(new_n294_), .c(new_n143_), .O(new_n428_));
  nand3  g375(.a(new_n136_), .b(x19), .c(new_n54_), .O(new_n429_));
  aoi21  g376(.a(new_n429_), .b(new_n428_), .c(x07), .O(new_n430_));
  nor4   g377(.a(new_n161_), .b(new_n246_), .c(new_n86_), .d(new_n53_), .O(new_n431_));
  oai21  g378(.a(new_n431_), .b(new_n430_), .c(new_n168_), .O(new_n432_));
  nand3  g379(.a(x15), .b(new_n53_), .c(x00), .O(new_n433_));
  oai21  g380(.a(x15), .b(new_n53_), .c(new_n433_), .O(new_n434_));
  nand4  g381(.a(new_n434_), .b(new_n99_), .c(x17), .d(new_n52_), .O(new_n435_));
  nand2  g382(.a(new_n435_), .b(new_n432_), .O(new_n436_));
  nand2  g383(.a(new_n436_), .b(new_n72_), .O(new_n437_));
  inv1   g384(.a(x03), .O(new_n438_));
  nor2   g385(.a(x05), .b(new_n438_), .O(new_n439_));
  nand4  g386(.a(new_n439_), .b(new_n276_), .c(new_n172_), .d(new_n106_), .O(new_n440_));
  nand2  g387(.a(new_n440_), .b(new_n437_), .O(z27));
  nand3  g388(.a(new_n261_), .b(new_n143_), .c(x11), .O(new_n442_));
  aoi21  g389(.a(new_n442_), .b(new_n72_), .c(x02), .O(new_n443_));
  nand2  g390(.a(x11), .b(new_n53_), .O(new_n444_));
  oai21  g391(.a(new_n444_), .b(new_n443_), .c(x15), .O(new_n445_));
  nand3  g392(.a(x13), .b(new_n73_), .c(new_n75_), .O(new_n446_));
  inv1   g393(.a(new_n67_), .O(new_n447_));
  nor2   g394(.a(new_n447_), .b(x21), .O(new_n448_));
  nand4  g395(.a(new_n448_), .b(new_n446_), .c(new_n261_), .d(new_n180_), .O(new_n449_));
  aoi21  g396(.a(new_n449_), .b(new_n445_), .c(x05), .O(new_n450_));
  nand4  g397(.a(new_n255_), .b(new_n107_), .c(new_n54_), .d(x12), .O(new_n451_));
  nand2  g398(.a(new_n390_), .b(x21), .O(new_n452_));
  aoi21  g399(.a(new_n452_), .b(new_n451_), .c(x07), .O(new_n453_));
  oai21  g400(.a(new_n453_), .b(new_n450_), .c(x08), .O(new_n454_));
  nor3   g401(.a(new_n212_), .b(new_n447_), .c(new_n143_), .O(new_n455_));
  nor2   g402(.a(x19), .b(new_n54_), .O(new_n456_));
  nand3  g403(.a(new_n150_), .b(new_n72_), .c(new_n86_), .O(new_n457_));
  inv1   g404(.a(new_n457_), .O(new_n458_));
  oai21  g405(.a(new_n456_), .b(new_n455_), .c(new_n458_), .O(new_n459_));
  aoi21  g406(.a(new_n459_), .b(new_n454_), .c(new_n99_), .O(new_n460_));
  nand2  g407(.a(new_n390_), .b(new_n99_), .O(new_n461_));
  oai21  g408(.a(new_n73_), .b(new_n75_), .c(new_n303_), .O(new_n462_));
  nor2   g409(.a(new_n462_), .b(new_n461_), .O(new_n463_));
  oai21  g410(.a(new_n463_), .b(new_n460_), .c(new_n159_), .O(new_n464_));
  oai21  g411(.a(new_n246_), .b(new_n53_), .c(new_n153_), .O(new_n465_));
  nand2  g412(.a(new_n465_), .b(new_n328_), .O(new_n466_));
  nand2  g413(.a(new_n466_), .b(new_n307_), .O(new_n467_));
  nand2  g414(.a(new_n467_), .b(new_n464_), .O(z28));
  zero   g415(.O(z08));
  zero   g416(.O(z26));
endmodule
