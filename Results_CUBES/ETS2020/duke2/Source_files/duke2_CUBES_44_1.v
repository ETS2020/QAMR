...
module FAU ( 
  ...
  wire new_n60_, new_n62_, new_n63_, new_n64_, new_n65_, new_n66_, new_n67_,
    ...
    new_n102_, new_n105_, new_n106_, new_n111_, new_n112_;
  ...
  inv1   g48(.a(x18), .O(new_n111_));
  nand4  g49(.a(new_n111_), .b(x17), .c(new_n63_), .d(new_n86_), .O(new_n112_));
  nor3   g50(.a(new_n112_), .b(x07), .c(new_n64_), .O(z15));
  aoi21  g51(.a(new_n97_), .b(new_n60_), .c(x20), .O(z26));
  zero   g52(.O(z00));
  zero   g53(.O(z01));
  zero   g54(.O(z02));
  zero   g55(.O(z03));
