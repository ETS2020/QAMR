// Benchmark "FAU" written by ABC on Tue Jul  7 13:30:33 2020
...
module FAU ( 
  ...
  nor2   g368(.a(new_n89_), .b(x20), .O(z26));
  inv1   g369(.a(new_n76_), .O(new_n423_));
  nand2  g370(.a(new_n133_), .b(new_n81_), .O(new_n424_));
  nor2   g371(.a(new_n424_), .b(new_n423_), .O(new_n425_));
  oai21  g372(.a(new_n425_), .b(new_n294_), .c(new_n143_), .O(new_n426_));
  nand3  g373(.a(new_n136_), .b(x19), .c(new_n54_), .O(new_n427_));
  aoi21  g374(.a(new_n427_), .b(new_n426_), .c(x07), .O(new_n428_));
  nor4   g375(.a(new_n161_), .b(new_n246_), .c(new_n86_), .d(new_n53_), .O(new_n429_));
  oai21  g376(.a(new_n429_), .b(new_n428_), .c(new_n168_), .O(new_n430_));
  nand3  g377(.a(x15), .b(new_n53_), .c(x00), .O(new_n431_));
  oai21  g378(.a(x15), .b(new_n53_), .c(new_n431_), .O(new_n432_));
  nand4  g379(.a(new_n432_), .b(new_n99_), .c(x17), .d(new_n52_), .O(new_n433_));
  nand2  g380(.a(new_n433_), .b(new_n430_), .O(new_n434_));
  nand2  g381(.a(new_n434_), .b(new_n72_), .O(new_n435_));
  inv1   g382(.a(x03), .O(new_n436_));
  nor2   g383(.a(x05), .b(new_n436_), .O(new_n437_));
  nand4  g384(.a(new_n437_), .b(new_n276_), .c(new_n172_), .d(new_n106_), .O(new_n438_));
  nand2  g385(.a(new_n438_), .b(new_n435_), .O(z27));
  nand3  g386(.a(new_n261_), .b(new_n143_), .c(x11), .O(new_n440_));
  aoi21  g387(.a(new_n440_), .b(new_n72_), .c(x02), .O(new_n441_));
  nand2  g388(.a(x11), .b(new_n53_), .O(new_n442_));
  oai21  g389(.a(new_n442_), .b(new_n441_), .c(x15), .O(new_n443_));
  nand3  g390(.a(x13), .b(new_n73_), .c(new_n75_), .O(new_n444_));
  inv1   g391(.a(new_n67_), .O(new_n445_));
  nor2   g392(.a(new_n445_), .b(x21), .O(new_n446_));
  nand4  g393(.a(new_n446_), .b(new_n444_), .c(new_n261_), .d(new_n180_), .O(new_n447_));
  aoi21  g394(.a(new_n447_), .b(new_n443_), .c(x05), .O(new_n448_));
  nand4  g395(.a(new_n255_), .b(new_n107_), .c(new_n54_), .d(x12), .O(new_n449_));
  nand2  g396(.a(new_n390_), .b(x21), .O(new_n450_));
  aoi21  g397(.a(new_n450_), .b(new_n449_), .c(x07), .O(new_n451_));
  oai21  g398(.a(new_n451_), .b(new_n448_), .c(x08), .O(new_n452_));
  nor3   g399(.a(new_n212_), .b(new_n445_), .c(new_n143_), .O(new_n453_));
  nor2   g400(.a(x19), .b(new_n54_), .O(new_n454_));
  nand3  g401(.a(new_n150_), .b(new_n72_), .c(new_n86_), .O(new_n455_));
  inv1   g402(.a(new_n455_), .O(new_n456_));
  oai21  g403(.a(new_n454_), .b(new_n453_), .c(new_n456_), .O(new_n457_));
  aoi21  g404(.a(new_n457_), .b(new_n452_), .c(new_n99_), .O(new_n458_));
  nand2  g405(.a(new_n390_), .b(new_n99_), .O(new_n459_));
  oai21  g406(.a(new_n73_), .b(new_n75_), .c(new_n303_), .O(new_n460_));
  nor2   g407(.a(new_n460_), .b(new_n459_), .O(new_n461_));
  oai21  g408(.a(new_n461_), .b(new_n458_), .c(new_n159_), .O(new_n462_));
  oai21  g409(.a(new_n246_), .b(new_n53_), .c(new_n153_), .O(new_n463_));
  nand2  g410(.a(new_n463_), .b(new_n328_), .O(new_n464_));
  nand2  g411(.a(new_n464_), .b(new_n307_), .O(new_n465_));
  nand2  g412(.a(new_n465_), .b(new_n462_), .O(z28));
  zero   g413(.O(z04));
  zero   g414(.O(z25));
endmodule
