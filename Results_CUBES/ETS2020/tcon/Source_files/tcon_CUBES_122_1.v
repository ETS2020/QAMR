// Benchmark "FAU" written by ABC on Tue Jul  7 12:49:44 2020
...
module FAU ( 
  ...
  wire new_n40_, new_n41_, new_n44_, new_n45_, new_n47_, new_n48_, new_n50_,
    new_n51_;
  inv1   g00(.a(x12), .O(new_n40_));
  nand2  g01(.a(x08), .b(x03), .O(new_n41_));
  oai21  g02(.a(new_n40_), .b(x08), .c(new_n41_), .O(z11));
  inv1   g03(.a(x14), .O(new_n44_));
  nand2  g04(.a(x08), .b(x05), .O(new_n45_));
  oai21  g05(.a(new_n44_), .b(x08), .c(new_n45_), .O(z13));
