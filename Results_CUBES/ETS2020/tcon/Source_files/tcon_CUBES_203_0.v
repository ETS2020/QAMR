// Benchmark "FAU" written by ABC on Tue Jul  7 12:50:17 2020
...
module FAU ( 
  ...
  inv1   g15(.a(x14), .O(new_n53_));
  nand2  g16(.a(x08), .b(x05), .O(new_n54_));
  oai21  g17(.a(new_n53_), .b(x08), .c(new_n54_), .O(z13));
  inv1   g18(.a(x15), .O(new_n56_));
  nand2  g19(.a(x08), .b(x06), .O(new_n57_));
  oai21  g20(.a(new_n56_), .b(x08), .c(new_n57_), .O(z14));
  inv1   g21(.a(x16), .O(new_n59_));
  nand2  g22(.a(x08), .b(x07), .O(new_n60_));
  oai21  g23(.a(new_n59_), .b(x08), .c(new_n60_), .O(z15));
  zero   g24(.O(z01));
  zero   g25(.O(z02));
  zero   g26(.O(z06));
  zero   g27(.O(z07));
