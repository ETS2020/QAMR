// Benchmark "FAU" written by ABC on Tue Jul  7 10:51:20 2020
...
module FAU ( 
  ...
  nand2  g10(.a(new_n26_), .b(new_n31_), .O(new_n37_));
  ...
  nand2  g27(.a(x05), .b(new_n31_), .O(new_n54_));
  ...
  nand4  g37(.a(x13), .b(new_n56_), .c(x05), .d(new_n31_), .O(new_n64_));
  aoi21  g38(.a(new_n64_), .b(new_n60_), .c(new_n61_), .O(z08));
  and2   g39(.a(x13), .b(x06), .O(z09));
  nand3  g40(.a(new_n30_), .b(x06), .c(new_n26_), .O(new_n67_));
  inv1   g41(.a(new_n67_), .O(z10));
  zero   g42(.O(z01));
endmodule
