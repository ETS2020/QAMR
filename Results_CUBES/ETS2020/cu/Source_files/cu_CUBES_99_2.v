// Benchmark "FAU" written by ABC on Tue Jul  7 10:51:01 2020
...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n32_,
    ...
    new_n43_, new_n45_, new_n47_, new_n50_, new_n54_, new_n55_;
  ...
  nand4  g17(.a(new_n31_), .b(new_n27_), .c(new_n40_), .d(x00), .O(new_n43_));
  nor2   g18(.a(new_n43_), .b(new_n38_), .O(z03));
  nand4  g19(.a(new_n31_), .b(new_n27_), .c(x01), .d(new_n39_), .O(new_n45_));
  nor2   g20(.a(new_n45_), .b(new_n38_), .O(z04));
  nand4  g21(.a(new_n31_), .b(new_n27_), .c(x01), .d(x00), .O(new_n47_));
  nor2   g22(.a(new_n47_), .b(new_n38_), .O(z05));
  nand2  g23(.a(new_n31_), .b(new_n27_), .O(new_n50_));
  nor2   g24(.a(new_n38_), .b(new_n50_), .O(z07));
  and2   g25(.a(x13), .b(x06), .O(z09));
  nand2  g26(.a(x05), .b(x02), .O(new_n54_));
  nand3  g27(.a(new_n54_), .b(x06), .c(new_n26_), .O(new_n55_));
  inv1   g28(.a(new_n55_), .O(z10));
  zero   g29(.O(z06));
  zero   g30(.O(z08));
endmodule
