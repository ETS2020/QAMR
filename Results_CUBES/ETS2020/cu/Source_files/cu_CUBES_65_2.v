// Benchmark "FAU" written by ABC on Tue Jul  7 10:50:47 2020
...
module FAU ( 
  ...
  nand2  g25(.a(x05), .b(x02), .O(new_n54_));
  nand3  g26(.a(new_n54_), .b(x06), .c(new_n26_), .O(new_n55_));
  inv1   g27(.a(new_n55_), .O(z10));
  zero   g28(.O(z06));
  zero   g29(.O(z08));
  zero   g30(.O(z09));
endmodule
