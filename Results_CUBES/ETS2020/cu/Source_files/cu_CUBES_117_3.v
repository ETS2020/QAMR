// Benchmark "FAU" written by ABC on Tue Jul  7 10:51:09 2020
...
module FAU ( 
  ...
  nand3  g33(.a(new_n59_), .b(x05), .c(new_n26_), .O(new_n63_));
  nor3   g34(.a(new_n63_), .b(x04), .c(x02), .O(z07));
  nand4  g35(.a(x13), .b(new_n55_), .c(x05), .d(new_n27_), .O(new_n65_));
  aoi21  g36(.a(new_n65_), .b(new_n60_), .c(new_n61_), .O(z08));
  and2   g37(.a(x13), .b(x06), .O(z09));
  nand2  g38(.a(x05), .b(x02), .O(new_n68_));
  nand3  g39(.a(new_n68_), .b(x06), .c(new_n26_), .O(new_n69_));
