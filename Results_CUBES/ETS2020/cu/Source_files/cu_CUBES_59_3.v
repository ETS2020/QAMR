// Benchmark "FAU" written by ABC on Tue Jul  7 10:50:45 2020
...
module FAU ( 
  ...
  nand2  g23(.a(x05), .b(new_n27_), .O(new_n53_));
  ...
  nand4  g33(.a(x13), .b(new_n55_), .c(x05), .d(new_n27_), .O(new_n64_));
  aoi21  g34(.a(new_n64_), .b(new_n60_), .c(new_n61_), .O(z08));
  and2   g35(.a(x13), .b(x06), .O(z09));
  nand2  g36(.a(x05), .b(x02), .O(new_n67_));
  nand3  g37(.a(new_n67_), .b(x06), .c(new_n26_), .O(new_n68_));
