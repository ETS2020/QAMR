...
module FAU ( 
  ...
  inv1   g038(.a(new_n79_), .O(new_n85_));
  inv1   g039(.a(x30), .O(new_n86_));
  and2   g040(.a(x28), .b(x27), .O(new_n87_));
  nand2  g041(.a(new_n87_), .b(x29), .O(new_n88_));
  inv1   g042(.a(new_n88_), .O(new_n89_));
  nand3  g043(.a(new_n87_), .b(new_n86_), .c(x29), .O(new_n90_));
  oai21  g044(.a(new_n89_), .b(new_n86_), .c(new_n90_), .O(new_n91_));
  inv1   g045(.a(x26), .O(new_n92_));
  nand4  g046(.a(new_n57_), .b(new_n92_), .c(x25), .d(x01), .O(new_n93_));
  inv1   g047(.a(new_n93_), .O(new_n94_));
  nand3  g048(.a(new_n94_), .b(new_n91_), .c(new_n85_), .O(new_n95_));
  inv1   g049(.a(new_n95_), .O(z6));
  inv1   g050(.a(x31), .O(new_n97_));
  nand3  g051(.a(new_n89_), .b(new_n97_), .c(x30), .O(new_n98_));
  nand3  g052(.a(new_n87_), .b(x30), .c(x29), .O(new_n99_));
  aoi21  g053(.a(new_n99_), .b(x31), .c(new_n93_), .O(new_n100_));
  nand3  g054(.a(new_n100_), .b(new_n98_), .c(new_n85_), .O(z7));
  ...
  nand2  g075(.a(x32), .b(new_n86_), .O(new_n122_));
  oai21  g076(.a(new_n121_), .b(new_n86_), .c(new_n122_), .O(new_n123_));
  ...
  nand2  g098(.a(new_n92_), .b(x00), .O(new_n145_));
  ...
  nand2  g102(.a(new_n97_), .b(new_n86_), .O(new_n149_));
  ...
  nand2  g110(.a(x31), .b(new_n86_), .O(new_n157_));
