...
module FAU ( 
  ...
  aoi21  g066(.a(new_n93_), .b(new_n92_), .c(new_n91_), .O(new_n112_));
  inv1   g067(.a(new_n112_), .O(new_n113_));
  inv1   g068(.a(x33), .O(new_n114_));
  inv1   g069(.a(x15), .O(new_n115_));
  inv1   g070(.a(x17), .O(new_n116_));
  inv1   g071(.a(x18), .O(new_n117_));
  nand3  g072(.a(x19), .b(new_n117_), .c(x13), .O(new_n118_));
  inv1   g073(.a(x19), .O(new_n119_));
  nand3  g074(.a(new_n119_), .b(x18), .c(x14), .O(new_n120_));
  aoi21  g075(.a(new_n120_), .b(new_n118_), .c(new_n116_), .O(new_n121_));
  nand4  g076(.a(x19), .b(x18), .c(new_n116_), .d(x12), .O(new_n122_));
  inv1   g077(.a(new_n122_), .O(new_n123_));
  oai21  g078(.a(new_n123_), .b(new_n121_), .c(x16), .O(new_n124_));
  inv1   g079(.a(x16), .O(new_n125_));
  nand3  g080(.a(x19), .b(x18), .c(x17), .O(new_n126_));
  inv1   g081(.a(new_n126_), .O(new_n127_));
  nand3  g082(.a(new_n127_), .b(new_n125_), .c(x11), .O(new_n128_));
  aoi21  g083(.a(new_n128_), .b(new_n124_), .c(new_n115_), .O(new_n129_));
  inv1   g084(.a(x10), .O(new_n130_));
  nor4   g085(.a(new_n126_), .b(new_n125_), .c(x15), .d(new_n130_), .O(new_n131_));
  oai21  g086(.a(new_n131_), .b(new_n129_), .c(new_n114_), .O(new_n132_));
  nand2  g087(.a(new_n106_), .b(new_n98_), .O(new_n133_));
  oai22  g088(.a(new_n133_), .b(new_n132_), .c(new_n114_), .d(new_n106_), .O(new_n134_));
  nand2  g089(.a(new_n134_), .b(new_n113_), .O(new_n135_));
  nand2  g090(.a(x31), .b(x30), .O(new_n136_));
  nand2  g091(.a(x33), .b(new_n106_), .O(new_n137_));
  oai21  g092(.a(new_n136_), .b(new_n132_), .c(new_n137_), .O(new_n138_));
  nor3   g093(.a(new_n126_), .b(new_n125_), .c(new_n115_), .O(new_n139_));
  nand4  g094(.a(x19), .b(x18), .c(x17), .d(x11), .O(new_n140_));
  nand2  g095(.a(new_n140_), .b(new_n125_), .O(new_n141_));
  nand3  g096(.a(x19), .b(x18), .c(x12), .O(new_n142_));
  nand2  g097(.a(new_n142_), .b(new_n116_), .O(new_n143_));
  nand2  g098(.a(new_n143_), .b(new_n141_), .O(new_n144_));
  nor2   g099(.a(new_n144_), .b(new_n139_), .O(new_n145_));
  nor2   g100(.a(new_n125_), .b(new_n130_), .O(new_n146_));
  aoi21  g101(.a(new_n146_), .b(new_n127_), .c(x15), .O(new_n147_));
  aoi21  g102(.a(x19), .b(x13), .c(x18), .O(new_n148_));
  nand2  g103(.a(new_n106_), .b(x30), .O(new_n149_));
  nand2  g104(.a(x31), .b(new_n98_), .O(new_n150_));
  inv1   g105(.a(x14), .O(new_n151_));
  nand2  g106(.a(new_n119_), .b(new_n151_), .O(new_n152_));
  nand3  g107(.a(new_n152_), .b(new_n150_), .c(new_n149_), .O(new_n153_));
  nor3   g108(.a(new_n153_), .b(new_n148_), .c(new_n147_), .O(new_n154_));
  aoi21  g109(.a(new_n154_), .b(new_n145_), .c(new_n114_), .O(new_n155_));
  aoi21  g110(.a(new_n138_), .b(new_n112_), .c(new_n155_), .O(new_n156_));
  inv1   g111(.a(x26), .O(new_n157_));
  nand2  g112(.a(new_n157_), .b(x00), .O(new_n158_));
  aoi21  g113(.a(new_n156_), .b(new_n135_), .c(new_n158_), .O(z9));
  zero   g114(.O(z8));
endmodule
