...
module FAU ( 
  ...
  inv1   g050(.a(new_n94_), .O(new_n96_));
  inv1   g051(.a(x30), .O(new_n97_));
  nand2  g052(.a(new_n91_), .b(x29), .O(new_n98_));
  inv1   g053(.a(new_n98_), .O(new_n99_));
  nand3  g054(.a(new_n91_), .b(new_n97_), .c(x29), .O(new_n100_));
  oai21  g055(.a(new_n99_), .b(new_n97_), .c(new_n100_), .O(new_n101_));
  nand3  g056(.a(new_n101_), .b(new_n96_), .c(new_n82_), .O(new_n102_));
  inv1   g057(.a(new_n102_), .O(z6));
  inv1   g058(.a(x31), .O(new_n104_));
  nand3  g059(.a(new_n99_), .b(new_n104_), .c(x30), .O(new_n105_));
  nand3  g060(.a(new_n91_), .b(x30), .c(x29), .O(new_n106_));
  aoi21  g061(.a(new_n106_), .b(x31), .c(new_n94_), .O(new_n107_));
  nand3  g062(.a(new_n107_), .b(new_n105_), .c(new_n82_), .O(z7));
  aoi21  g063(.a(new_n90_), .b(new_n89_), .c(new_n88_), .O(new_n110_));
  inv1   g064(.a(new_n110_), .O(new_n111_));
  inv1   g065(.a(x33), .O(new_n112_));
  inv1   g066(.a(x15), .O(new_n113_));
  inv1   g067(.a(x17), .O(new_n114_));
  inv1   g068(.a(x18), .O(new_n115_));
  nand3  g069(.a(x19), .b(new_n115_), .c(x13), .O(new_n116_));
  inv1   g070(.a(x19), .O(new_n117_));
  nand3  g071(.a(new_n117_), .b(x18), .c(x14), .O(new_n118_));
  aoi21  g072(.a(new_n118_), .b(new_n116_), .c(new_n114_), .O(new_n119_));
  nand4  g073(.a(x19), .b(x18), .c(new_n114_), .d(x12), .O(new_n120_));
  inv1   g074(.a(new_n120_), .O(new_n121_));
  oai21  g075(.a(new_n121_), .b(new_n119_), .c(x16), .O(new_n122_));
  inv1   g076(.a(x16), .O(new_n123_));
  nand3  g077(.a(x19), .b(x18), .c(x17), .O(new_n124_));
  inv1   g078(.a(new_n124_), .O(new_n125_));
  nand3  g079(.a(new_n125_), .b(new_n123_), .c(x11), .O(new_n126_));
  aoi21  g080(.a(new_n126_), .b(new_n122_), .c(new_n113_), .O(new_n127_));
  inv1   g081(.a(x10), .O(new_n128_));
  nor4   g082(.a(new_n124_), .b(new_n123_), .c(x15), .d(new_n128_), .O(new_n129_));
  oai21  g083(.a(new_n129_), .b(new_n127_), .c(new_n112_), .O(new_n130_));
  nand2  g084(.a(new_n104_), .b(new_n97_), .O(new_n131_));
  oai22  g085(.a(new_n131_), .b(new_n130_), .c(new_n112_), .d(new_n104_), .O(new_n132_));
  nand2  g086(.a(new_n132_), .b(new_n111_), .O(new_n133_));
  nand2  g087(.a(x31), .b(x30), .O(new_n134_));
  nand2  g088(.a(x33), .b(new_n104_), .O(new_n135_));
  oai21  g089(.a(new_n134_), .b(new_n130_), .c(new_n135_), .O(new_n136_));
  nor3   g090(.a(new_n124_), .b(new_n123_), .c(new_n113_), .O(new_n137_));
  nand4  g091(.a(x19), .b(x18), .c(x17), .d(x11), .O(new_n138_));
  nand2  g092(.a(new_n138_), .b(new_n123_), .O(new_n139_));
  nand3  g093(.a(x19), .b(x18), .c(x12), .O(new_n140_));
  nand2  g094(.a(new_n140_), .b(new_n114_), .O(new_n141_));
  nand2  g095(.a(new_n141_), .b(new_n139_), .O(new_n142_));
  nor2   g096(.a(new_n142_), .b(new_n137_), .O(new_n143_));
  nor2   g097(.a(new_n123_), .b(new_n128_), .O(new_n144_));
  aoi21  g098(.a(new_n144_), .b(new_n125_), .c(x15), .O(new_n145_));
  aoi21  g099(.a(x19), .b(x13), .c(x18), .O(new_n146_));
  nand2  g100(.a(new_n104_), .b(x30), .O(new_n147_));
  nand2  g101(.a(x31), .b(new_n97_), .O(new_n148_));
  inv1   g102(.a(x14), .O(new_n149_));
  nand2  g103(.a(new_n117_), .b(new_n149_), .O(new_n150_));
  nand3  g104(.a(new_n150_), .b(new_n148_), .c(new_n147_), .O(new_n151_));
  nor3   g105(.a(new_n151_), .b(new_n146_), .c(new_n145_), .O(new_n152_));
  aoi21  g106(.a(new_n152_), .b(new_n143_), .c(new_n112_), .O(new_n153_));
  aoi21  g107(.a(new_n136_), .b(new_n110_), .c(new_n153_), .O(new_n154_));
  nand2  g108(.a(new_n93_), .b(x00), .O(new_n155_));
  aoi21  g109(.a(new_n154_), .b(new_n133_), .c(new_n155_), .O(z9));
  zero   g110(.O(z4));
  zero   g111(.O(z8));
endmodule
