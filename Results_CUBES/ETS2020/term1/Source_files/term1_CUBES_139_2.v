...
module FAU ( 
  ...
  aoi21  g056(.a(new_n84_), .b(new_n83_), .c(new_n82_), .O(new_n105_));
  inv1   g057(.a(new_n105_), .O(new_n106_));
  inv1   g058(.a(x33), .O(new_n107_));
  inv1   g059(.a(x15), .O(new_n108_));
  inv1   g060(.a(x17), .O(new_n109_));
  inv1   g061(.a(x18), .O(new_n110_));
  nand3  g062(.a(x19), .b(new_n110_), .c(x13), .O(new_n111_));
  inv1   g063(.a(x19), .O(new_n112_));
  nand3  g064(.a(new_n112_), .b(x18), .c(x14), .O(new_n113_));
  aoi21  g065(.a(new_n113_), .b(new_n111_), .c(new_n109_), .O(new_n114_));
  nand4  g066(.a(x19), .b(x18), .c(new_n109_), .d(x12), .O(new_n115_));
  inv1   g067(.a(new_n115_), .O(new_n116_));
  oai21  g068(.a(new_n116_), .b(new_n114_), .c(x16), .O(new_n117_));
  inv1   g069(.a(x16), .O(new_n118_));
  nand3  g070(.a(x19), .b(x18), .c(x17), .O(new_n119_));
  inv1   g071(.a(new_n119_), .O(new_n120_));
  nand3  g072(.a(new_n120_), .b(new_n118_), .c(x11), .O(new_n121_));
  aoi21  g073(.a(new_n121_), .b(new_n117_), .c(new_n108_), .O(new_n122_));
  inv1   g074(.a(x10), .O(new_n123_));
  nor4   g075(.a(new_n119_), .b(new_n118_), .c(x15), .d(new_n123_), .O(new_n124_));
  oai21  g076(.a(new_n124_), .b(new_n122_), .c(new_n107_), .O(new_n125_));
  nand2  g077(.a(new_n99_), .b(new_n90_), .O(new_n126_));
  oai22  g078(.a(new_n126_), .b(new_n125_), .c(new_n107_), .d(new_n99_), .O(new_n127_));
  nand2  g079(.a(new_n127_), .b(new_n106_), .O(new_n128_));
  nand2  g080(.a(x31), .b(x30), .O(new_n129_));
  nand2  g081(.a(x33), .b(new_n99_), .O(new_n130_));
  oai21  g082(.a(new_n129_), .b(new_n125_), .c(new_n130_), .O(new_n131_));
  nor3   g083(.a(new_n119_), .b(new_n118_), .c(new_n108_), .O(new_n132_));
  nand4  g084(.a(x19), .b(x18), .c(x17), .d(x11), .O(new_n133_));
  nand2  g085(.a(new_n133_), .b(new_n118_), .O(new_n134_));
  nand3  g086(.a(x19), .b(x18), .c(x12), .O(new_n135_));
  nand2  g087(.a(new_n135_), .b(new_n109_), .O(new_n136_));
  nand2  g088(.a(new_n136_), .b(new_n134_), .O(new_n137_));
  nor2   g089(.a(new_n137_), .b(new_n132_), .O(new_n138_));
  nor2   g090(.a(new_n118_), .b(new_n123_), .O(new_n139_));
  aoi21  g091(.a(new_n139_), .b(new_n120_), .c(x15), .O(new_n140_));
  aoi21  g092(.a(x19), .b(x13), .c(x18), .O(new_n141_));
  nand2  g093(.a(new_n99_), .b(x30), .O(new_n142_));
  nand2  g094(.a(x31), .b(new_n90_), .O(new_n143_));
  inv1   g095(.a(x14), .O(new_n144_));
  nand2  g096(.a(new_n112_), .b(new_n144_), .O(new_n145_));
  nand3  g097(.a(new_n145_), .b(new_n143_), .c(new_n142_), .O(new_n146_));
  nor3   g098(.a(new_n146_), .b(new_n141_), .c(new_n140_), .O(new_n147_));
  aoi21  g099(.a(new_n147_), .b(new_n138_), .c(new_n107_), .O(new_n148_));
  aoi21  g100(.a(new_n131_), .b(new_n105_), .c(new_n148_), .O(new_n149_));
  nand2  g101(.a(new_n87_), .b(x00), .O(new_n150_));
  aoi21  g102(.a(new_n149_), .b(new_n128_), .c(new_n150_), .O(z9));
  zero   g103(.O(z0));
  zero   g104(.O(z3));
  zero   g105(.O(z4));
  zero   g106(.O(z8));
