// Benchmark "FAU" written by ABC on Mon Jul  6 17:36:22 2020
...
module FAU ( 
  ...
  wire new_n17_, new_n18_, new_n19_, new_n20_, new_n21_, new_n22_, new_n23_,
    ...
    new_n80_, new_n81_, new_n82_, new_n83_, new_n86_, new_n88_, new_n91_;
  ...
  nor2   g68(.a(x3), .b(x1), .O(new_n86_));
  and2   g69(.a(x3), .b(x1), .O(z3));
  nor2   g70(.a(z3), .b(new_n86_), .O(new_n88_));
  inv1   g71(.a(new_n88_), .O(z2));
  xor2a  g72(.a(x2), .b(x0), .O(new_n91_));
  nor2   g73(.a(new_n91_), .b(new_n88_), .O(z5));
  zero   g74(.O(z1));
  zero   g75(.O(z4));
endmodule
