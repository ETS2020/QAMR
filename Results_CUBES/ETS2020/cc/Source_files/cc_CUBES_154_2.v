...
module FAU ( 
  ...
  nand2  g17(.a(new_n46_), .b(x17), .O(new_n64_));
  nand4  g18(.a(new_n45_), .b(x10), .c(x08), .d(x04), .O(new_n65_));
  aoi21  g19(.a(new_n65_), .b(new_n64_), .c(new_n55_), .O(z16));
  nand2  g20(.a(new_n46_), .b(x18), .O(new_n67_));
  nand4  g21(.a(new_n45_), .b(x10), .c(x08), .d(x05), .O(new_n68_));
  aoi21  g22(.a(new_n68_), .b(new_n67_), .c(new_n55_), .O(z17));
  zero   g23(.O(z01));
  zero   g24(.O(z03));
  zero   g25(.O(z06));
  zero   g26(.O(z13));
