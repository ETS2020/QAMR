...
module FAU ( 
  ...
  nand2  g18(.a(new_n46_), .b(x17), .O(new_n69_));
  nand4  g19(.a(new_n45_), .b(x10), .c(x08), .d(x04), .O(new_n70_));
  aoi21  g20(.a(new_n70_), .b(new_n69_), .c(new_n58_), .O(z16));
  nand2  g21(.a(new_n46_), .b(x19), .O(new_n73_));
  nand4  g22(.a(new_n45_), .b(x10), .c(x08), .d(x06), .O(new_n74_));
  aoi21  g23(.a(new_n74_), .b(new_n73_), .c(new_n58_), .O(z18));
