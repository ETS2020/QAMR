...
module FAU ( 
  ...
  nand2  g16(.a(new_n50_), .b(x15), .O(new_n62_));
  nand4  g17(.a(new_n45_), .b(x10), .c(x08), .d(x02), .O(new_n63_));
  aoi21  g18(.a(new_n63_), .b(new_n62_), .c(new_n57_), .O(z14));
  nand3  g19(.a(new_n46_), .b(x16), .c(new_n44_), .O(new_n65_));
  nand4  g20(.a(new_n45_), .b(x10), .c(x08), .d(x03), .O(new_n66_));
  aoi21  g21(.a(new_n66_), .b(new_n65_), .c(new_n57_), .O(z15));
  nand2  g22(.a(new_n46_), .b(x18), .O(new_n69_));
  nand4  g23(.a(new_n45_), .b(x10), .c(x08), .d(x05), .O(new_n70_));
  aoi21  g24(.a(new_n70_), .b(new_n69_), .c(new_n57_), .O(z17));
  nand2  g25(.a(new_n46_), .b(x20), .O(new_n73_));
  nand4  g26(.a(new_n45_), .b(x10), .c(x08), .d(x07), .O(new_n74_));
