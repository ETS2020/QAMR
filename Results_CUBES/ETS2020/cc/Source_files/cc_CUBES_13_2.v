...
module FAU ( 
  ...
  nand2  g15(.a(x10), .b(x08), .O(new_n63_));
  nand2  g16(.a(new_n63_), .b(x15), .O(new_n64_));
  nand4  g17(.a(new_n46_), .b(x10), .c(x08), .d(x02), .O(new_n65_));
  aoi21  g18(.a(new_n65_), .b(new_n64_), .c(new_n58_), .O(z14));
  nand3  g19(.a(new_n47_), .b(x16), .c(new_n43_), .O(new_n67_));
  nand4  g20(.a(new_n46_), .b(x10), .c(x08), .d(x03), .O(new_n68_));
  aoi21  g21(.a(new_n68_), .b(new_n67_), .c(new_n58_), .O(z15));
  nand2  g22(.a(new_n47_), .b(x18), .O(new_n71_));
  nand4  g23(.a(new_n46_), .b(x10), .c(x08), .d(x05), .O(new_n72_));
  aoi21  g24(.a(new_n72_), .b(new_n71_), .c(new_n58_), .O(z17));
  zero   g25(.O(z00));
  zero   g26(.O(z03));
  zero   g27(.O(z05));
  zero   g28(.O(z07));
