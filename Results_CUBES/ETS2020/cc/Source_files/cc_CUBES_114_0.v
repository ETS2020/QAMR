...
module FAU ( 
  ...
  nand2  g19(.a(new_n56_), .b(x20), .O(new_n72_));
  nand4  g20(.a(new_n55_), .b(x10), .c(x08), .d(x07), .O(new_n73_));
  aoi21  g21(.a(new_n73_), .b(new_n72_), .c(new_n54_), .O(z19));
  zero   g22(.O(z00));
  zero   g23(.O(z01));
  zero   g24(.O(z02));
  zero   g25(.O(z04));
