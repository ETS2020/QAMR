// Benchmark "FAU" written by ABC on Mon Jul  6 17:28:53 2020
...
module FAU ( 
  ...
  wire new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_, new_n55_,
    new_n56_, new_n57_, new_n61_, new_n62_, new_n64_, new_n65_, new_n67_,
  ...
  nand2  g19(.a(new_n47_), .b(x17), .O(new_n64_));
  nand4  g20(.a(new_n46_), .b(x10), .c(x08), .d(x04), .O(new_n65_));
  aoi21  g21(.a(new_n65_), .b(new_n64_), .c(new_n55_), .O(z16));
  nand2  g22(.a(new_n47_), .b(x18), .O(new_n67_));
  nand4  g23(.a(new_n46_), .b(x10), .c(x08), .d(x05), .O(new_n68_));
  aoi21  g24(.a(new_n68_), .b(new_n67_), .c(new_n55_), .O(z17));
  nand2  g25(.a(new_n47_), .b(x20), .O(new_n71_));
  nand4  g26(.a(new_n46_), .b(x10), .c(x08), .d(x07), .O(new_n72_));
  aoi21  g27(.a(new_n72_), .b(new_n71_), .c(new_n55_), .O(z19));
  zero   g28(.O(z03));
  zero   g29(.O(z13));
  zero   g30(.O(z14));
  zero   g31(.O(z18));
