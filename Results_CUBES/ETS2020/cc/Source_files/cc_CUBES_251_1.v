...
module FAU ( 
  ...
  nand2  g21(.a(new_n64_), .b(x18), .O(new_n69_));
  nand4  g22(.a(new_n61_), .b(x10), .c(x08), .d(x05), .O(new_n70_));
  aoi21  g23(.a(new_n70_), .b(new_n69_), .c(new_n54_), .O(z17));
  nand2  g24(.a(new_n64_), .b(x19), .O(new_n72_));
  nand4  g25(.a(new_n61_), .b(x10), .c(x08), .d(x06), .O(new_n73_));
  aoi21  g26(.a(new_n73_), .b(new_n72_), .c(new_n54_), .O(z18));
  zero   g27(.O(z00));
  zero   g28(.O(z01));
  zero   g29(.O(z02));
  zero   g30(.O(z05));
