...
module FAU ( 
  ...
  nand2  g26(.a(new_n46_), .b(x19), .O(new_n75_));
  nand4  g27(.a(new_n45_), .b(x10), .c(x08), .d(x06), .O(new_n76_));
  aoi21  g28(.a(new_n76_), .b(new_n75_), .c(new_n58_), .O(z18));
  nand2  g29(.a(new_n46_), .b(x20), .O(new_n78_));
  nand4  g30(.a(new_n45_), .b(x10), .c(x08), .d(x07), .O(new_n79_));
