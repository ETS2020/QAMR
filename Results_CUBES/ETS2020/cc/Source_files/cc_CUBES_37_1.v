...
module FAU ( 
  ...
  nand3  g20(.a(new_n46_), .b(x16), .c(new_n44_), .O(new_n67_));
  nand4  g21(.a(new_n45_), .b(x10), .c(x08), .d(x03), .O(new_n68_));
  aoi21  g22(.a(new_n68_), .b(new_n67_), .c(new_n57_), .O(z15));
  ...
  nand2  g26(.a(new_n46_), .b(x18), .O(new_n73_));
  nand4  g27(.a(new_n45_), .b(x10), .c(x08), .d(x05), .O(new_n74_));
  aoi21  g28(.a(new_n74_), .b(new_n73_), .c(new_n57_), .O(z17));
  nand2  g29(.a(new_n46_), .b(x19), .O(new_n76_));
  nand4  g30(.a(new_n45_), .b(x10), .c(x08), .d(x06), .O(new_n77_));
  aoi21  g31(.a(new_n77_), .b(new_n76_), .c(new_n57_), .O(z18));
  nand2  g32(.a(new_n46_), .b(x20), .O(new_n79_));
  nand4  g33(.a(new_n45_), .b(x10), .c(x08), .d(x07), .O(new_n80_));
  aoi21  g34(.a(new_n80_), .b(new_n79_), .c(new_n57_), .O(z19));
  zero   g35(.O(z01));
  zero   g36(.O(z04));
  zero   g37(.O(z08));
  zero   g38(.O(z09));
