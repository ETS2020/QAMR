...
module FAU ( 
  ...
  nand3  g15(.a(new_n47_), .b(x16), .c(new_n43_), .O(new_n62_));
  nand4  g16(.a(new_n46_), .b(x10), .c(x08), .d(x03), .O(new_n63_));
  aoi21  g17(.a(new_n63_), .b(new_n62_), .c(new_n56_), .O(z15));
  nand2  g18(.a(new_n47_), .b(x17), .O(new_n65_));
  nand4  g19(.a(new_n46_), .b(x10), .c(x08), .d(x04), .O(new_n66_));
  aoi21  g20(.a(new_n66_), .b(new_n65_), .c(new_n56_), .O(z16));
  nand2  g21(.a(new_n47_), .b(x18), .O(new_n68_));
  nand4  g22(.a(new_n46_), .b(x10), .c(x08), .d(x05), .O(new_n69_));
  aoi21  g23(.a(new_n69_), .b(new_n68_), .c(new_n56_), .O(z17));
  zero   g24(.O(z00));
  zero   g25(.O(z03));
  zero   g26(.O(z06));
  zero   g27(.O(z13));
