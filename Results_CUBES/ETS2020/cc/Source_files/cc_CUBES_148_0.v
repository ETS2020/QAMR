...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n50_, new_n51_,
    ...
    new_n68_, new_n69_, new_n72_, new_n73_, new_n75_, new_n76_, new_n78_,
  ...
  nand2  g26(.a(new_n46_), .b(x18), .O(new_n75_));
  nand4  g27(.a(new_n45_), .b(x10), .c(x08), .d(x05), .O(new_n76_));
  aoi21  g28(.a(new_n76_), .b(new_n75_), .c(new_n59_), .O(z17));
  nand2  g29(.a(new_n46_), .b(x19), .O(new_n78_));
  nand4  g30(.a(new_n45_), .b(x10), .c(x08), .d(x06), .O(new_n79_));
  aoi21  g31(.a(new_n79_), .b(new_n78_), .c(new_n59_), .O(z18));
  nand2  g32(.a(new_n46_), .b(x20), .O(new_n81_));
  nand4  g33(.a(new_n45_), .b(x10), .c(x08), .d(x07), .O(new_n82_));
  aoi21  g34(.a(new_n82_), .b(new_n81_), .c(new_n59_), .O(z19));
  zero   g35(.O(z01));
  zero   g36(.O(z04));
  zero   g37(.O(z05));
  zero   g38(.O(z06));
