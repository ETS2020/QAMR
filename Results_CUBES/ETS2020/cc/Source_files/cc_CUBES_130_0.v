// Benchmark "FAU" written by ABC on Mon Jul  6 17:28:02 2020
...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n50_, new_n51_,
    ...
    new_n66_, new_n67_, new_n70_, new_n71_, new_n74_, new_n75_, new_n77_,
    new_n78_;
  ...
  nand2  g22(.a(new_n46_), .b(x17), .O(new_n70_));
  nand4  g23(.a(new_n45_), .b(x10), .c(x08), .d(x04), .O(new_n71_));
  aoi21  g24(.a(new_n71_), .b(new_n70_), .c(new_n57_), .O(z16));
