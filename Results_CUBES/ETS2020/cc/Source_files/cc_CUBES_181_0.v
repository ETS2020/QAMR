...
module FAU ( 
  ...
  wire new_n43_, new_n44_, new_n47_, new_n48_, new_n55_, new_n56_, new_n57_,
    ...
    new_n67_, new_n70_, new_n71_, new_n73_, new_n74_, new_n76_, new_n77_,
    new_n79_, new_n80_;
  ...
  nand2  g27(.a(new_n57_), .b(x19), .O(new_n76_));
  nand4  g28(.a(new_n56_), .b(x10), .c(x08), .d(x06), .O(new_n77_));
  aoi21  g29(.a(new_n77_), .b(new_n76_), .c(new_n55_), .O(z18));
  nand2  g30(.a(new_n57_), .b(x20), .O(new_n79_));
  nand4  g31(.a(new_n56_), .b(x10), .c(x08), .d(x07), .O(new_n80_));
  aoi21  g32(.a(new_n80_), .b(new_n79_), .c(new_n55_), .O(z19));
  zero   g33(.O(z02));
  zero   g34(.O(z04));
  zero   g35(.O(z08));
  zero   g36(.O(z09));
