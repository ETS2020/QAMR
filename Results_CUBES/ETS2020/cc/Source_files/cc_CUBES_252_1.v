...
module FAU ( 
  ...
  nand3  g16(.a(new_n62_), .b(x10), .c(x08), .O(new_n63_));
  nand3  g17(.a(new_n63_), .b(x16), .c(new_n43_), .O(new_n64_));
  nand4  g18(.a(new_n62_), .b(x10), .c(x08), .d(x03), .O(new_n65_));
  aoi21  g19(.a(new_n65_), .b(new_n64_), .c(new_n55_), .O(z15));
  nand2  g20(.a(new_n63_), .b(x17), .O(new_n67_));
  nand4  g21(.a(new_n62_), .b(x10), .c(x08), .d(x04), .O(new_n68_));
  aoi21  g22(.a(new_n68_), .b(new_n67_), .c(new_n55_), .O(z16));
  nand2  g23(.a(new_n63_), .b(x18), .O(new_n70_));
  nand4  g24(.a(new_n62_), .b(x10), .c(x08), .d(x05), .O(new_n71_));
  aoi21  g25(.a(new_n71_), .b(new_n70_), .c(new_n55_), .O(z17));
  nand2  g26(.a(new_n63_), .b(x19), .O(new_n73_));
  nand4  g27(.a(new_n62_), .b(x10), .c(x08), .d(x06), .O(new_n74_));
  aoi21  g28(.a(new_n74_), .b(new_n73_), .c(new_n55_), .O(z18));
  nand2  g29(.a(new_n63_), .b(x20), .O(new_n76_));
