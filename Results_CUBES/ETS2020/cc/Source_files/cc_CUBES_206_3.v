...
module FAU ( 
  ...
  nand2  g24(.a(new_n47_), .b(x17), .O(new_n69_));
  nand4  g25(.a(new_n46_), .b(x10), .c(x08), .d(x04), .O(new_n70_));
  aoi21  g26(.a(new_n70_), .b(new_n69_), .c(new_n58_), .O(z16));
  nand2  g27(.a(new_n47_), .b(x18), .O(new_n72_));
  nand4  g28(.a(new_n46_), .b(x10), .c(x08), .d(x05), .O(new_n73_));
  aoi21  g29(.a(new_n73_), .b(new_n72_), .c(new_n58_), .O(z17));
  nand2  g30(.a(new_n47_), .b(x20), .O(new_n76_));
  nand4  g31(.a(new_n46_), .b(x10), .c(x08), .d(x07), .O(new_n77_));
  aoi21  g32(.a(new_n77_), .b(new_n76_), .c(new_n58_), .O(z19));
  zero   g33(.O(z07));
  zero   g34(.O(z14));
  zero   g35(.O(z15));
  zero   g36(.O(z18));
