...
module FAU ( 
  ...
  nand3  g11(.a(new_n46_), .b(x16), .c(new_n44_), .O(new_n59_));
  nand4  g12(.a(new_n45_), .b(x10), .c(x08), .d(x03), .O(new_n60_));
  aoi21  g13(.a(new_n60_), .b(new_n59_), .c(new_n58_), .O(z15));
  nand2  g14(.a(new_n46_), .b(x17), .O(new_n62_));
  nand4  g15(.a(new_n45_), .b(x10), .c(x08), .d(x04), .O(new_n63_));
  aoi21  g16(.a(new_n63_), .b(new_n62_), .c(new_n58_), .O(z16));
  nand2  g17(.a(new_n46_), .b(x18), .O(new_n65_));
  nand4  g18(.a(new_n45_), .b(x10), .c(x08), .d(x05), .O(new_n66_));
  aoi21  g19(.a(new_n66_), .b(new_n65_), .c(new_n58_), .O(z17));
  nand2  g20(.a(new_n46_), .b(x19), .O(new_n68_));
  nand4  g21(.a(new_n45_), .b(x10), .c(x08), .d(x06), .O(new_n69_));
  aoi21  g22(.a(new_n69_), .b(new_n68_), .c(new_n58_), .O(z18));
  zero   g23(.O(z01));
  zero   g24(.O(z03));
  zero   g25(.O(z08));
  zero   g26(.O(z12));
