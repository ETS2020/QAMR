...
module FAU ( 
  ...
  wire new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_, new_n51_,
    ...
    new_n66_, new_n68_, new_n69_, new_n71_, new_n72_, new_n77_, new_n78_;
  ...
  nand2  g26(.a(new_n47_), .b(x20), .O(new_n77_));
  nand4  g27(.a(new_n46_), .b(x10), .c(x08), .d(x07), .O(new_n78_));
  aoi21  g28(.a(new_n78_), .b(new_n77_), .c(new_n59_), .O(z19));
  zero   g29(.O(z00));
  zero   g30(.O(z04));
  zero   g31(.O(z06));
  zero   g32(.O(z09));
