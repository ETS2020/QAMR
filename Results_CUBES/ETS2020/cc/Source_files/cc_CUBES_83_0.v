...
module FAU ( 
  ...
  wire new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_, new_n51_,
    ...
    new_n65_, new_n67_, new_n68_, new_n71_, new_n72_, new_n76_, new_n77_;
  ...
  nand2  g12(.a(new_n47_), .b(x13), .O(new_n59_));
  nand4  g13(.a(new_n46_), .b(x10), .c(x08), .d(x00), .O(new_n60_));
  aoi21  g14(.a(new_n60_), .b(new_n59_), .c(new_n58_), .O(z12));
  nand2  g15(.a(new_n51_), .b(new_n43_), .O(new_n62_));
  ...
  aoi21  g22(.a(new_n68_), .b(new_n67_), .c(new_n58_), .O(z14));
  nand2  g23(.a(new_n47_), .b(x17), .O(new_n71_));
  nand4  g24(.a(new_n46_), .b(x10), .c(x08), .d(x04), .O(new_n72_));
  aoi21  g25(.a(new_n72_), .b(new_n71_), .c(new_n58_), .O(z16));
  nand2  g26(.a(new_n47_), .b(x20), .O(new_n76_));
  nand4  g27(.a(new_n46_), .b(x10), .c(x08), .d(x07), .O(new_n77_));
