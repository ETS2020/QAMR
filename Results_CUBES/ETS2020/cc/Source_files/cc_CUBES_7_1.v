...
module FAU ( 
  ...
  wire new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_, new_n51_,
    ...
    new_n65_, new_n67_, new_n68_, new_n70_, new_n71_, new_n75_, new_n76_,
    new_n78_, new_n79_;
  ...
  nand2  g30(.a(new_n47_), .b(x19), .O(new_n75_));
  nand4  g31(.a(new_n46_), .b(x10), .c(x08), .d(x06), .O(new_n76_));
  aoi21  g32(.a(new_n76_), .b(new_n75_), .c(new_n58_), .O(z18));
