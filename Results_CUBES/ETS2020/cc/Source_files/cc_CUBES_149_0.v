...
module FAU ( 
  ...
  nand2  g21(.a(new_n46_), .b(x17), .O(new_n71_));
  nand4  g22(.a(new_n45_), .b(x10), .c(x08), .d(x04), .O(new_n72_));
  aoi21  g23(.a(new_n72_), .b(new_n71_), .c(new_n58_), .O(z16));
  nand2  g24(.a(new_n46_), .b(x20), .O(new_n76_));
  nand4  g25(.a(new_n45_), .b(x10), .c(x08), .d(x07), .O(new_n77_));
  aoi21  g26(.a(new_n77_), .b(new_n76_), .c(new_n58_), .O(z19));
  zero   g27(.O(z00));
  zero   g28(.O(z01));
  zero   g29(.O(z04));
  zero   g30(.O(z06));
