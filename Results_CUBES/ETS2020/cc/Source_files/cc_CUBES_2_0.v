...
module FAU ( 
  ...
  wire new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_, new_n51_,
    ...
    new_n66_, new_n68_, new_n69_, new_n75_, new_n76_;
  ...
  nand2  g24(.a(new_n47_), .b(x20), .O(new_n75_));
  nand4  g25(.a(new_n46_), .b(x10), .c(x08), .d(x07), .O(new_n76_));
  aoi21  g26(.a(new_n76_), .b(new_n75_), .c(new_n59_), .O(z19));
  zero   g27(.O(z00));
  zero   g28(.O(z04));
  zero   g29(.O(z08));
  zero   g30(.O(z09));
