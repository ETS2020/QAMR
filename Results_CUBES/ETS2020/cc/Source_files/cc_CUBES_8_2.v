...
module FAU ( 
  ...
  nand2  g18(.a(new_n46_), .b(x17), .O(new_n65_));
  nand4  g19(.a(new_n45_), .b(x10), .c(x08), .d(x04), .O(new_n66_));
  aoi21  g20(.a(new_n66_), .b(new_n65_), .c(new_n57_), .O(z16));
  nand2  g21(.a(new_n46_), .b(x18), .O(new_n68_));
  nand4  g22(.a(new_n45_), .b(x10), .c(x08), .d(x05), .O(new_n69_));
  aoi21  g23(.a(new_n69_), .b(new_n68_), .c(new_n57_), .O(z17));
  nand2  g24(.a(new_n46_), .b(x20), .O(new_n72_));
  nand4  g25(.a(new_n45_), .b(x10), .c(x08), .d(x07), .O(new_n73_));
  aoi21  g26(.a(new_n73_), .b(new_n72_), .c(new_n57_), .O(z19));
  zero   g27(.O(z01));
  zero   g28(.O(z03));
  zero   g29(.O(z05));
  zero   g30(.O(z12));
