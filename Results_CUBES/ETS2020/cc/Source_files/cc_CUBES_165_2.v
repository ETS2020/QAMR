...
module FAU ( 
  ...
  nand3  g12(.a(new_n55_), .b(x16), .c(new_n43_), .O(new_n61_));
  nand4  g13(.a(new_n54_), .b(x10), .c(x08), .d(x03), .O(new_n62_));
  aoi21  g14(.a(new_n62_), .b(new_n61_), .c(new_n53_), .O(z15));
  nand2  g15(.a(new_n55_), .b(x17), .O(new_n64_));
  nand4  g16(.a(new_n54_), .b(x10), .c(x08), .d(x04), .O(new_n65_));
  aoi21  g17(.a(new_n65_), .b(new_n64_), .c(new_n53_), .O(z16));
  nand2  g18(.a(new_n55_), .b(x18), .O(new_n67_));
  nand4  g19(.a(new_n54_), .b(x10), .c(x08), .d(x05), .O(new_n68_));
  aoi21  g20(.a(new_n68_), .b(new_n67_), .c(new_n53_), .O(z17));
  zero   g21(.O(z00));
  zero   g22(.O(z02));
  zero   g23(.O(z03));
  zero   g24(.O(z06));
