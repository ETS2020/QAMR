...
module FAU ( 
  ...
  wire new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_, new_n51_,
    ...
    new_n64_, new_n66_, new_n67_, new_n72_, new_n73_, new_n75_, new_n76_;
  ...
  nand2  g27(.a(new_n47_), .b(x20), .O(new_n75_));
  nand4  g28(.a(new_n46_), .b(x10), .c(x08), .d(x07), .O(new_n76_));
  aoi21  g29(.a(new_n76_), .b(new_n75_), .c(new_n57_), .O(z19));
  zero   g30(.O(z00));
  zero   g31(.O(z09));
  zero   g32(.O(z10));
  zero   g33(.O(z15));
