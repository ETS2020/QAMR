// Benchmark "FAU" written by ABC on Mon Jul  6 17:28:41 2020
...
module FAU ( 
  ...
  nand2  g21(.a(new_n47_), .b(x15), .O(new_n66_));
  nand4  g22(.a(new_n56_), .b(x10), .c(x08), .d(x02), .O(new_n67_));
  aoi21  g23(.a(new_n67_), .b(new_n66_), .c(new_n55_), .O(z14));
  nand3  g24(.a(new_n57_), .b(x16), .c(new_n43_), .O(new_n69_));
  nand4  g25(.a(new_n56_), .b(x10), .c(x08), .d(x03), .O(new_n70_));
  aoi21  g26(.a(new_n70_), .b(new_n69_), .c(new_n55_), .O(z15));
  nand2  g27(.a(new_n57_), .b(x17), .O(new_n72_));
  nand4  g28(.a(new_n56_), .b(x10), .c(x08), .d(x04), .O(new_n73_));
  aoi21  g29(.a(new_n73_), .b(new_n72_), .c(new_n55_), .O(z16));
  nand2  g30(.a(new_n57_), .b(x18), .O(new_n75_));
  nand4  g31(.a(new_n56_), .b(x10), .c(x08), .d(x05), .O(new_n76_));
  aoi21  g32(.a(new_n76_), .b(new_n75_), .c(new_n55_), .O(z17));
  nand2  g33(.a(new_n57_), .b(x19), .O(new_n78_));
  nand4  g34(.a(new_n56_), .b(x10), .c(x08), .d(x06), .O(new_n79_));
  aoi21  g35(.a(new_n79_), .b(new_n78_), .c(new_n55_), .O(z18));
  nand2  g36(.a(new_n57_), .b(x20), .O(new_n81_));
  nand4  g37(.a(new_n56_), .b(x10), .c(x08), .d(x07), .O(new_n82_));
  aoi21  g38(.a(new_n82_), .b(new_n81_), .c(new_n55_), .O(z19));
  zero   g39(.O(z02));
  zero   g40(.O(z05));
  zero   g41(.O(z07));
  buf    g42(.a(x15), .O(z06));
