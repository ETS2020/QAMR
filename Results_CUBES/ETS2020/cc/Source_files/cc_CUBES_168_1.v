...
module FAU ( 
  ...
  aoi21  g24(.a(new_n69_), .b(new_n68_), .c(new_n57_), .O(z16));
  nand2  g25(.a(new_n47_), .b(x18), .O(new_n71_));
  nand4  g26(.a(new_n46_), .b(x10), .c(x08), .d(x05), .O(new_n72_));
  aoi21  g27(.a(new_n72_), .b(new_n71_), .c(new_n57_), .O(z17));
  nand2  g28(.a(new_n47_), .b(x19), .O(new_n74_));
  nand4  g29(.a(new_n46_), .b(x10), .c(x08), .d(x06), .O(new_n75_));
  aoi21  g30(.a(new_n75_), .b(new_n74_), .c(new_n57_), .O(z18));
  nand2  g31(.a(new_n47_), .b(x20), .O(new_n77_));
  nand4  g32(.a(new_n46_), .b(x10), .c(x08), .d(x07), .O(new_n78_));
  aoi21  g33(.a(new_n78_), .b(new_n77_), .c(new_n57_), .O(z19));
  zero   g34(.O(z00));
  zero   g35(.O(z04));
  zero   g36(.O(z14));
  zero   g37(.O(z15));
