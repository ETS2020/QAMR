...
module FAU ( 
  ...
  nand3  g15(.a(new_n60_), .b(x10), .c(x08), .O(new_n61_));
  nand3  g16(.a(new_n61_), .b(x16), .c(new_n46_), .O(new_n62_));
  nand4  g17(.a(new_n60_), .b(x10), .c(x08), .d(x03), .O(new_n63_));
  aoi21  g18(.a(new_n63_), .b(new_n62_), .c(new_n53_), .O(z15));
  nand2  g19(.a(new_n61_), .b(x17), .O(new_n65_));
  nand4  g20(.a(new_n60_), .b(x10), .c(x08), .d(x04), .O(new_n66_));
  aoi21  g21(.a(new_n66_), .b(new_n65_), .c(new_n53_), .O(z16));
  nand2  g22(.a(new_n61_), .b(x18), .O(new_n68_));
  nand4  g23(.a(new_n60_), .b(x10), .c(x08), .d(x05), .O(new_n69_));
  aoi21  g24(.a(new_n69_), .b(new_n68_), .c(new_n53_), .O(z17));
  nand2  g25(.a(new_n61_), .b(x19), .O(new_n71_));
  nand4  g26(.a(new_n60_), .b(x10), .c(x08), .d(x06), .O(new_n72_));
  aoi21  g27(.a(new_n72_), .b(new_n71_), .c(new_n53_), .O(z18));
  nand2  g28(.a(new_n61_), .b(x20), .O(new_n74_));
  nand4  g29(.a(new_n60_), .b(x10), .c(x08), .d(x07), .O(new_n75_));
  aoi21  g30(.a(new_n75_), .b(new_n74_), .c(new_n53_), .O(z19));
  zero   g31(.O(z01));
  zero   g32(.O(z02));
  zero   g33(.O(z12));
  zero   g34(.O(z14));
