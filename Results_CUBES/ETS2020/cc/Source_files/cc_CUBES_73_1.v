...
module FAU ( 
  ...
  nand3  g19(.a(new_n61_), .b(x10), .c(x08), .O(new_n65_));
  nand2  g20(.a(new_n65_), .b(x17), .O(new_n66_));
  nand4  g21(.a(new_n61_), .b(x10), .c(x08), .d(x04), .O(new_n67_));
  aoi21  g22(.a(new_n67_), .b(new_n66_), .c(new_n54_), .O(z16));
  nand2  g23(.a(new_n65_), .b(x19), .O(new_n70_));
  nand4  g24(.a(new_n61_), .b(x10), .c(x08), .d(x06), .O(new_n71_));
  aoi21  g25(.a(new_n71_), .b(new_n70_), .c(new_n54_), .O(z18));
  nand2  g26(.a(new_n65_), .b(x20), .O(new_n73_));
