...
module FAU ( 
  ...
  nand2  g26(.a(new_n46_), .b(x19), .O(new_n74_));
  nand4  g27(.a(new_n45_), .b(x10), .c(x08), .d(x06), .O(new_n75_));
  aoi21  g28(.a(new_n75_), .b(new_n74_), .c(new_n57_), .O(z18));
  nand2  g29(.a(new_n46_), .b(x20), .O(new_n77_));
  nand4  g30(.a(new_n45_), .b(x10), .c(x08), .d(x07), .O(new_n78_));
  aoi21  g31(.a(new_n78_), .b(new_n77_), .c(new_n57_), .O(z19));
  zero   g32(.O(z01));
  zero   g33(.O(z09));
  zero   g34(.O(z10));
  zero   g35(.O(z11));
