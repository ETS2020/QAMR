...
module FAU ( 
  ...
  nand2  g16(.a(new_n51_), .b(new_n43_), .O(new_n61_));
  nand2  g17(.a(new_n61_), .b(x15), .O(new_n62_));
  inv1   g18(.a(x01), .O(new_n63_));
  oai21  g19(.a(new_n51_), .b(new_n63_), .c(x14), .O(new_n64_));
  aoi21  g20(.a(new_n64_), .b(new_n62_), .c(new_n60_), .O(z13));
  nand2  g21(.a(new_n51_), .b(x15), .O(new_n66_));
  nand4  g22(.a(new_n46_), .b(x10), .c(x08), .d(x02), .O(new_n67_));
  aoi21  g23(.a(new_n67_), .b(new_n66_), .c(new_n60_), .O(z14));
  nand3  g24(.a(new_n47_), .b(x16), .c(new_n43_), .O(new_n69_));
  nand4  g25(.a(new_n46_), .b(x10), .c(x08), .d(x03), .O(new_n70_));
  aoi21  g26(.a(new_n70_), .b(new_n69_), .c(new_n60_), .O(z15));
  nand2  g27(.a(new_n47_), .b(x18), .O(new_n73_));
  nand4  g28(.a(new_n46_), .b(x10), .c(x08), .d(x05), .O(new_n74_));
  aoi21  g29(.a(new_n74_), .b(new_n73_), .c(new_n60_), .O(z17));
  nand2  g30(.a(new_n47_), .b(x19), .O(new_n76_));
  nand4  g31(.a(new_n46_), .b(x10), .c(x08), .d(x06), .O(new_n77_));
  aoi21  g32(.a(new_n77_), .b(new_n76_), .c(new_n60_), .O(z18));
  zero   g33(.O(z05));
  zero   g34(.O(z06));
  zero   g35(.O(z12));
  zero   g36(.O(z16));
