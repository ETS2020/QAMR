...
module FAU ( 
  ...
  aoi21  g26(.a(new_n72_), .b(new_n71_), .c(new_n59_), .O(z15));
  nand2  g27(.a(new_n47_), .b(x17), .O(new_n74_));
  nand4  g28(.a(new_n46_), .b(x10), .c(x08), .d(x04), .O(new_n75_));
  aoi21  g29(.a(new_n75_), .b(new_n74_), .c(new_n59_), .O(z16));
  nand2  g30(.a(new_n47_), .b(x18), .O(new_n77_));
  nand4  g31(.a(new_n46_), .b(x10), .c(x08), .d(x05), .O(new_n78_));
  aoi21  g32(.a(new_n78_), .b(new_n77_), .c(new_n59_), .O(z17));
  nand2  g33(.a(new_n47_), .b(x20), .O(new_n81_));
  nand4  g34(.a(new_n46_), .b(x10), .c(x08), .d(x07), .O(new_n82_));
  aoi21  g35(.a(new_n82_), .b(new_n81_), .c(new_n59_), .O(z19));
  zero   g36(.O(z00));
  zero   g37(.O(z04));
  zero   g38(.O(z08));
  zero   g39(.O(z09));
