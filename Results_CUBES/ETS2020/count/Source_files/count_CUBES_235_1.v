...
module FAU ( 
  ...
  nand4  g074(.a(new_n125_), .b(new_n124_), .c(new_n114_), .d(new_n97_), .O(new_n126_));
  ...
  nand4  g088(.a(new_n106_), .b(new_n55_), .c(new_n69_), .d(new_n61_), .O(new_n141_));
  nor2   g089(.a(x26), .b(x25), .O(new_n142_));
  nor2   g090(.a(x30), .b(x29), .O(new_n143_));
  nand4  g091(.a(new_n143_), .b(new_n125_), .c(new_n142_), .d(new_n87_), .O(new_n144_));
  oai21  g092(.a(new_n144_), .b(new_n141_), .c(x31), .O(new_n145_));
  nand4  g093(.a(new_n87_), .b(new_n97_), .c(new_n96_), .d(new_n69_), .O(new_n146_));
  ...
  nand4  g101(.a(new_n153_), .b(new_n122_), .c(new_n147_), .d(new_n63_), .O(new_n154_));
  ...
  nor2   g107(.a(x32), .b(x31), .O(new_n161_));
  nand4  g108(.a(new_n161_), .b(new_n143_), .c(new_n125_), .d(new_n142_), .O(new_n162_));
  oai21  g109(.a(new_n162_), .b(new_n90_), .c(x33), .O(new_n163_));
  inv1   g110(.a(x32), .O(new_n164_));
  inv1   g111(.a(x33), .O(new_n165_));
  nand4  g112(.a(new_n165_), .b(new_n164_), .c(new_n115_), .d(new_n114_), .O(new_n166_));
  inv1   g113(.a(new_n166_), .O(new_n167_));
  nand4  g114(.a(new_n167_), .b(new_n153_), .c(new_n100_), .d(new_n71_), .O(new_n168_));
  nand2  g115(.a(new_n168_), .b(new_n163_), .O(new_n169_));
