...
module FAU ( 
  ...
  nand4  g095(.a(new_n148_), .b(new_n147_), .c(new_n112_), .d(new_n93_), .O(new_n149_));
  oai21  g096(.a(new_n149_), .b(new_n89_), .c(x32), .O(new_n150_));
  inv1   g097(.a(new_n89_), .O(new_n151_));
  nor2   g098(.a(x32), .b(x31), .O(new_n152_));
  nand4  g099(.a(new_n152_), .b(new_n139_), .c(new_n121_), .d(new_n138_), .O(new_n153_));
  inv1   g100(.a(new_n153_), .O(new_n154_));
  nand2  g101(.a(new_n154_), .b(new_n151_), .O(new_n155_));
  ...
  oai21  g107(.a(new_n153_), .b(new_n89_), .c(x33), .O(new_n161_));
  nor2   g108(.a(x33), .b(x32), .O(new_n162_));
  nand4  g109(.a(new_n162_), .b(new_n148_), .c(new_n147_), .d(new_n112_), .O(new_n163_));
  ...
  oai21  g117(.a(new_n163_), .b(new_n103_), .c(x34), .O(new_n171_));
  nand2  g118(.a(new_n147_), .b(new_n112_), .O(new_n172_));
  ...
  nand3  g128(.a(new_n181_), .b(new_n173_), .c(new_n95_), .O(new_n182_));
