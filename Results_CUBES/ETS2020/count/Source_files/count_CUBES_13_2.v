...
module FAU ( 
  ...
  nand4  g056(.a(new_n111_), .b(new_n95_), .c(new_n78_), .d(new_n56_), .O(new_n112_));
  ...
  nand4  g062(.a(new_n94_), .b(new_n54_), .c(new_n65_), .d(new_n53_), .O(new_n118_));
  nor2   g063(.a(x26), .b(x25), .O(new_n119_));
  nor2   g064(.a(x30), .b(x29), .O(new_n120_));
  nand4  g065(.a(new_n120_), .b(new_n106_), .c(new_n119_), .d(new_n83_), .O(new_n121_));
  nor2   g066(.a(new_n121_), .b(new_n118_), .O(new_n122_));
  aoi21  g067(.a(new_n112_), .b(x30), .c(new_n122_), .O(new_n123_));
  inv1   g068(.a(x04), .O(new_n124_));
  aoi21  g069(.a(new_n59_), .b(new_n124_), .c(x18), .O(new_n125_));
  oai21  g070(.a(new_n123_), .b(new_n59_), .c(new_n125_), .O(z11));
  ...
  nand4  g083(.a(new_n130_), .b(new_n129_), .c(new_n98_), .d(new_n97_), .O(new_n139_));
  oai21  g084(.a(new_n139_), .b(new_n86_), .c(x32), .O(new_n140_));
  nor2   g085(.a(x32), .b(x31), .O(new_n141_));
  nand4  g086(.a(new_n141_), .b(new_n120_), .c(new_n106_), .d(new_n119_), .O(new_n142_));
  ...
  oai21  g094(.a(new_n142_), .b(new_n86_), .c(x33), .O(new_n150_));
  inv1   g095(.a(x22), .O(new_n151_));
  inv1   g096(.a(x23), .O(new_n152_));
  nand4  g097(.a(new_n97_), .b(new_n83_), .c(new_n152_), .d(new_n151_), .O(new_n153_));
  nor2   g098(.a(new_n153_), .b(new_n66_), .O(new_n154_));
  nor2   g099(.a(x33), .b(x32), .O(new_n155_));
  nand4  g100(.a(new_n155_), .b(new_n130_), .c(new_n129_), .d(new_n98_), .O(new_n156_));
  inv1   g101(.a(new_n156_), .O(new_n157_));
  nand2  g102(.a(new_n157_), .b(new_n154_), .O(new_n158_));
  nand2  g103(.a(new_n158_), .b(new_n150_), .O(new_n159_));
  ...
  nor2   g108(.a(x21), .b(x20), .O(new_n164_));
  nand4  g109(.a(new_n107_), .b(new_n94_), .c(new_n164_), .d(new_n54_), .O(new_n165_));
  oai21  g110(.a(new_n156_), .b(new_n165_), .c(x34), .O(new_n166_));
  nand2  g111(.a(new_n129_), .b(new_n98_), .O(new_n167_));
  ...
  nand3  g121(.a(new_n176_), .b(new_n168_), .c(new_n154_), .O(new_n177_));
