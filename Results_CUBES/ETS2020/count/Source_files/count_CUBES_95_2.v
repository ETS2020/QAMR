...
module FAU ( 
  ...
  nand3  g056(.a(new_n111_), .b(new_n110_), .c(new_n91_), .O(new_n112_));
  oai21  g057(.a(new_n112_), .b(new_n73_), .c(x29), .O(new_n113_));
  nor3   g058(.a(x29), .b(x28), .c(x27), .O(new_n114_));
  nand4  g059(.a(new_n114_), .b(new_n94_), .c(new_n74_), .d(new_n67_), .O(new_n115_));
  ...
  nand4  g065(.a(new_n90_), .b(new_n56_), .c(new_n60_), .d(new_n55_), .O(new_n121_));
  nor2   g066(.a(x26), .b(x25), .O(new_n122_));
  nor2   g067(.a(x30), .b(x29), .O(new_n123_));
  nand4  g068(.a(new_n123_), .b(new_n110_), .c(new_n122_), .d(new_n79_), .O(new_n124_));
  ...
  nand3  g080(.a(new_n135_), .b(new_n131_), .c(new_n83_), .O(new_n136_));
  ...
  nand4  g086(.a(new_n133_), .b(new_n132_), .c(new_n102_), .d(new_n101_), .O(new_n142_));
  oai21  g087(.a(new_n142_), .b(new_n82_), .c(x32), .O(new_n143_));
  nor2   g088(.a(x32), .b(x31), .O(new_n144_));
  nand4  g089(.a(new_n144_), .b(new_n123_), .c(new_n110_), .d(new_n122_), .O(new_n145_));
  ...
  inv1   g098(.a(x22), .O(new_n154_));
  inv1   g099(.a(x23), .O(new_n155_));
  nand4  g100(.a(new_n101_), .b(new_n79_), .c(new_n155_), .d(new_n154_), .O(new_n156_));
  nor2   g101(.a(new_n156_), .b(new_n61_), .O(new_n157_));
  nor2   g102(.a(x33), .b(x32), .O(new_n158_));
  nand4  g103(.a(new_n158_), .b(new_n133_), .c(new_n132_), .d(new_n102_), .O(new_n159_));
  inv1   g104(.a(new_n159_), .O(new_n160_));
  nand2  g105(.a(new_n160_), .b(new_n157_), .O(new_n161_));
  nand2  g106(.a(new_n161_), .b(new_n153_), .O(new_n162_));
  ...
  oai21  g111(.a(new_n159_), .b(new_n92_), .c(x34), .O(new_n167_));
  nand2  g112(.a(new_n132_), .b(new_n102_), .O(new_n168_));
  ...
  nand3  g122(.a(new_n177_), .b(new_n169_), .c(new_n157_), .O(new_n178_));
