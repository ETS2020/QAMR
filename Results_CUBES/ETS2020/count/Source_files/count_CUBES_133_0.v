...
module FAU ( 
  ...
  nand3  g050(.a(new_n104_), .b(new_n75_), .c(new_n86_), .O(new_n105_));
  ...
  nand4  g060(.a(new_n114_), .b(new_n113_), .c(new_n93_), .d(new_n85_), .O(new_n115_));
  ...
  nand4  g068(.a(new_n122_), .b(new_n96_), .c(new_n72_), .d(new_n63_), .O(new_n123_));
  ...
  nand4  g074(.a(new_n94_), .b(new_n55_), .c(new_n82_), .d(new_n61_), .O(new_n129_));
  nor2   g075(.a(x26), .b(x25), .O(new_n130_));
  nor2   g076(.a(x30), .b(x29), .O(new_n131_));
  nand4  g077(.a(new_n131_), .b(new_n114_), .c(new_n130_), .d(new_n71_), .O(new_n132_));
  ...
  nand4  g085(.a(new_n140_), .b(new_n139_), .c(new_n104_), .d(new_n86_), .O(new_n141_));
  oai21  g086(.a(new_n141_), .b(new_n76_), .c(x32), .O(new_n142_));
  nor2   g087(.a(x32), .b(x31), .O(new_n143_));
  nand4  g088(.a(new_n143_), .b(new_n131_), .c(new_n114_), .d(new_n130_), .O(new_n144_));
  inv1   g089(.a(new_n144_), .O(new_n145_));
  nand2  g090(.a(new_n145_), .b(new_n77_), .O(new_n146_));
  ...
  oai21  g096(.a(new_n144_), .b(new_n76_), .c(x33), .O(new_n152_));
  nor2   g097(.a(x33), .b(x32), .O(new_n153_));
  nand4  g098(.a(new_n153_), .b(new_n140_), .c(new_n139_), .d(new_n104_), .O(new_n154_));
  inv1   g099(.a(new_n154_), .O(new_n155_));
  nand2  g100(.a(new_n155_), .b(new_n88_), .O(new_n156_));
  ...
  nand4  g106(.a(new_n113_), .b(new_n95_), .c(new_n94_), .d(new_n55_), .O(new_n162_));
  oai21  g107(.a(new_n154_), .b(new_n162_), .c(x34), .O(new_n163_));
  nand2  g108(.a(new_n139_), .b(new_n104_), .O(new_n164_));
  ...
  nand3  g118(.a(new_n173_), .b(new_n165_), .c(new_n88_), .O(new_n174_));
