...
module FAU ( 
  ...
  nor2   g092(.a(x27), .b(x26), .O(new_n147_));
  nand4  g093(.a(new_n138_), .b(new_n137_), .c(new_n147_), .d(new_n94_), .O(new_n148_));
  oai21  g094(.a(new_n148_), .b(new_n86_), .c(x32), .O(new_n149_));
  nor2   g095(.a(x32), .b(x31), .O(new_n150_));
  nand4  g096(.a(new_n150_), .b(new_n129_), .c(new_n116_), .d(new_n128_), .O(new_n151_));
  ...
  nand4  g106(.a(new_n160_), .b(new_n138_), .c(new_n137_), .d(new_n147_), .O(new_n161_));
  inv1   g107(.a(new_n161_), .O(new_n162_));
  nand2  g108(.a(new_n162_), .b(new_n96_), .O(new_n163_));
  ...
  oai21  g114(.a(new_n161_), .b(new_n104_), .c(x34), .O(new_n169_));
  nand2  g115(.a(new_n137_), .b(new_n147_), .O(new_n170_));
