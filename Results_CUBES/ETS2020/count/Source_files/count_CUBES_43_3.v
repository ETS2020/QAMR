...
module FAU ( 
  ...
  nand3  g045(.a(new_n98_), .b(new_n94_), .c(new_n71_), .O(new_n99_));
  ...
  nand3  g051(.a(new_n76_), .b(new_n55_), .c(new_n61_), .O(new_n105_));
  inv1   g052(.a(x25), .O(new_n106_));
  nor2   g053(.a(x27), .b(x26), .O(new_n107_));
  nand3  g054(.a(new_n107_), .b(new_n85_), .c(new_n106_), .O(new_n108_));
  nor2   g055(.a(new_n108_), .b(new_n105_), .O(new_n109_));
  aoi21  g056(.a(new_n99_), .b(x27), .c(new_n109_), .O(new_n110_));
  ...
  inv1   g060(.a(x23), .O(new_n115_));
  inv1   g061(.a(x26), .O(new_n116_));
  nor2   g062(.a(x28), .b(x27), .O(new_n117_));
  nand4  g063(.a(new_n117_), .b(new_n95_), .c(new_n116_), .d(new_n115_), .O(new_n118_));
  oai21  g064(.a(new_n118_), .b(new_n105_), .c(x29), .O(new_n119_));
  nor3   g065(.a(x29), .b(x28), .c(x27), .O(new_n120_));
  nand4  g066(.a(new_n120_), .b(new_n98_), .c(new_n83_), .d(new_n63_), .O(new_n121_));
  nand2  g067(.a(new_n121_), .b(new_n119_), .O(new_n122_));
  ...
  nand4  g072(.a(new_n94_), .b(new_n55_), .c(new_n69_), .d(new_n61_), .O(new_n127_));
  nor2   g073(.a(x26), .b(x25), .O(new_n128_));
  nor2   g074(.a(x30), .b(x29), .O(new_n129_));
  nand4  g075(.a(new_n129_), .b(new_n117_), .c(new_n128_), .d(new_n82_), .O(new_n130_));
  ...
  nor3   g082(.a(x27), .b(x26), .c(x25), .O(new_n137_));
  ...
  nand3  g087(.a(new_n141_), .b(new_n137_), .c(new_n87_), .O(new_n142_));
  nand2  g088(.a(new_n142_), .b(new_n136_), .O(new_n143_));
  nand2  g089(.a(new_n143_), .b(x16), .O(new_n144_));
  inv1   g090(.a(x03), .O(new_n145_));
  aoi21  g091(.a(new_n58_), .b(new_n145_), .c(x18), .O(new_n146_));
  nand2  g092(.a(new_n146_), .b(new_n144_), .O(z12));
  nand4  g093(.a(new_n139_), .b(new_n138_), .c(new_n107_), .d(new_n106_), .O(new_n148_));
  oai21  g094(.a(new_n148_), .b(new_n86_), .c(x32), .O(new_n149_));
  nand2  g095(.a(new_n129_), .b(new_n117_), .O(new_n150_));
  inv1   g096(.a(x31), .O(new_n151_));
  inv1   g097(.a(x32), .O(new_n152_));
  nand4  g098(.a(new_n152_), .b(new_n151_), .c(new_n116_), .d(new_n106_), .O(new_n153_));
  nor2   g099(.a(new_n153_), .b(new_n150_), .O(new_n154_));
  nand2  g100(.a(new_n154_), .b(new_n87_), .O(new_n155_));
  nand2  g101(.a(new_n155_), .b(new_n149_), .O(new_n156_));
  nand2  g102(.a(new_n156_), .b(x16), .O(new_n157_));
  inv1   g103(.a(x02), .O(new_n158_));
  aoi21  g104(.a(new_n58_), .b(new_n158_), .c(x18), .O(new_n159_));
  nand2  g105(.a(new_n159_), .b(new_n157_), .O(z13));
  nor2   g106(.a(x33), .b(x32), .O(new_n162_));
  nand4  g107(.a(new_n162_), .b(new_n139_), .c(new_n138_), .d(new_n107_), .O(new_n163_));
  oai21  g108(.a(new_n163_), .b(new_n96_), .c(x34), .O(new_n164_));
  inv1   g109(.a(x22), .O(new_n165_));
  nand4  g110(.a(new_n106_), .b(new_n82_), .c(new_n115_), .d(new_n165_), .O(new_n166_));
  nor2   g111(.a(new_n166_), .b(new_n70_), .O(new_n167_));
  nand2  g112(.a(new_n138_), .b(new_n107_), .O(new_n168_));
  inv1   g113(.a(new_n168_), .O(new_n169_));
  inv1   g114(.a(x30), .O(new_n170_));
  nand2  g115(.a(new_n151_), .b(new_n170_), .O(new_n171_));
  inv1   g116(.a(x33), .O(new_n172_));
  inv1   g117(.a(x34), .O(new_n173_));
  nand3  g118(.a(new_n173_), .b(new_n172_), .c(new_n152_), .O(new_n174_));
  nor2   g119(.a(new_n174_), .b(new_n171_), .O(new_n175_));
  nand3  g120(.a(new_n175_), .b(new_n169_), .c(new_n167_), .O(new_n176_));
  nand2  g121(.a(new_n176_), .b(new_n164_), .O(new_n177_));
