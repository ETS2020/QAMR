...
module FAU ( 
  ...
  nand4  g057(.a(new_n111_), .b(new_n82_), .c(new_n73_), .d(new_n56_), .O(new_n112_));
  ...
  nor2   g061(.a(new_n115_), .b(new_n74_), .O(new_n116_));
  ...
  nand4  g068(.a(new_n122_), .b(new_n103_), .c(new_n75_), .d(new_n56_), .O(new_n123_));
  ...
  nand4  g074(.a(new_n99_), .b(new_n54_), .c(new_n65_), .d(new_n53_), .O(new_n130_));
  nor2   g075(.a(x26), .b(x25), .O(new_n131_));
  nor2   g076(.a(x30), .b(x29), .O(new_n132_));
  nand4  g077(.a(new_n132_), .b(new_n113_), .c(new_n131_), .d(new_n80_), .O(new_n133_));
  oai21  g078(.a(new_n133_), .b(new_n130_), .c(x31), .O(new_n134_));
  ...
  nand4  g090(.a(new_n146_), .b(new_n132_), .c(new_n113_), .d(new_n131_), .O(new_n147_));
  oai21  g091(.a(new_n147_), .b(new_n83_), .c(x33), .O(new_n148_));
