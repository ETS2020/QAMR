// Benchmark "FAU" written by ABC on Tue Jul  7 19:18:01 2020
...
module FAU ( 
  ...
  nand3  g054(.a(new_n106_), .b(new_n82_), .c(new_n105_), .O(new_n107_));
  nor2   g055(.a(new_n107_), .b(new_n74_), .O(new_n108_));
  aoi21  g056(.a(new_n99_), .b(x27), .c(new_n108_), .O(new_n109_));
  inv1   g057(.a(x07), .O(new_n110_));
  aoi21  g058(.a(new_n52_), .b(new_n110_), .c(x18), .O(new_n111_));
  oai21  g059(.a(new_n109_), .b(new_n52_), .c(new_n111_), .O(z08));
  inv1   g060(.a(x23), .O(new_n114_));
  inv1   g061(.a(x26), .O(new_n115_));
  nor2   g062(.a(x28), .b(x27), .O(new_n116_));
  nand4  g063(.a(new_n116_), .b(new_n91_), .c(new_n115_), .d(new_n114_), .O(new_n117_));
  oai21  g064(.a(new_n117_), .b(new_n74_), .c(x29), .O(new_n118_));
  nor3   g065(.a(x29), .b(x28), .c(x27), .O(new_n119_));
  nand4  g066(.a(new_n119_), .b(new_n98_), .c(new_n75_), .d(new_n58_), .O(new_n120_));
  ...
  nand4  g073(.a(new_n90_), .b(new_n60_), .c(new_n126_), .d(new_n73_), .O(new_n127_));
  nor2   g074(.a(x30), .b(x29), .O(new_n128_));
  nand4  g075(.a(new_n128_), .b(new_n116_), .c(new_n106_), .d(new_n80_), .O(new_n129_));
  nor2   g076(.a(new_n129_), .b(new_n127_), .O(new_n130_));
  aoi21  g077(.a(new_n120_), .b(x30), .c(new_n130_), .O(new_n131_));
  ...
  nand4  g083(.a(new_n80_), .b(new_n114_), .c(new_n136_), .d(new_n126_), .O(new_n137_));
  ...
  nand4  g092(.a(new_n145_), .b(new_n139_), .c(new_n138_), .d(new_n58_), .O(new_n146_));
  nand2  g093(.a(new_n146_), .b(new_n135_), .O(new_n147_));
  ...
  nand4  g100(.a(new_n153_), .b(new_n152_), .c(new_n106_), .d(new_n105_), .O(new_n154_));
  oai21  g101(.a(new_n154_), .b(new_n83_), .c(x32), .O(new_n155_));
  nand4  g102(.a(new_n142_), .b(new_n141_), .c(new_n140_), .d(new_n105_), .O(new_n156_));
  inv1   g103(.a(new_n156_), .O(new_n157_));
  inv1   g104(.a(x25), .O(new_n158_));
  inv1   g105(.a(x32), .O(new_n159_));
  nand4  g106(.a(new_n159_), .b(new_n143_), .c(new_n115_), .d(new_n158_), .O(new_n160_));
  inv1   g107(.a(new_n160_), .O(new_n161_));
  nand4  g108(.a(new_n161_), .b(new_n157_), .c(new_n138_), .d(new_n58_), .O(new_n162_));
