...
module FAU ( 
  ...
  nand4  g030(.a(new_n82_), .b(new_n55_), .c(new_n69_), .d(new_n61_), .O(new_n83_));
  and2   g031(.a(new_n83_), .b(x24), .O(new_n84_));
  ...
  inv1   g039(.a(x24), .O(new_n94_));
  nor2   g040(.a(x26), .b(x25), .O(new_n95_));
  nand4  g041(.a(new_n95_), .b(new_n82_), .c(new_n71_), .d(new_n94_), .O(new_n96_));
  nand3  g042(.a(new_n76_), .b(new_n55_), .c(new_n61_), .O(new_n97_));
  inv1   g043(.a(x25), .O(new_n98_));
  nor2   g044(.a(x27), .b(x26), .O(new_n99_));
  nand3  g045(.a(new_n99_), .b(new_n85_), .c(new_n98_), .O(new_n100_));
  nor2   g046(.a(new_n100_), .b(new_n97_), .O(new_n101_));
  aoi21  g047(.a(new_n96_), .b(x27), .c(new_n101_), .O(new_n102_));
  ...
  nor2   g057(.a(new_n111_), .b(new_n97_), .O(new_n112_));
  ...
  nand4  g063(.a(new_n119_), .b(new_n108_), .c(new_n95_), .d(new_n94_), .O(new_n120_));
  oai21  g064(.a(new_n120_), .b(new_n83_), .c(x31), .O(new_n121_));
  nor2   g065(.a(x29), .b(x28), .O(new_n122_));
  nor2   g066(.a(x31), .b(x30), .O(new_n123_));
  nand2  g067(.a(new_n123_), .b(new_n122_), .O(new_n124_));
  inv1   g068(.a(new_n124_), .O(new_n125_));
  nand3  g069(.a(new_n125_), .b(new_n106_), .c(new_n87_), .O(new_n126_));
  nand2  g070(.a(new_n126_), .b(new_n121_), .O(new_n127_));
  nand2  g071(.a(new_n127_), .b(x16), .O(new_n128_));
  inv1   g072(.a(x03), .O(new_n129_));
  aoi21  g073(.a(new_n58_), .b(new_n129_), .c(x18), .O(new_n130_));
  nand2  g074(.a(new_n130_), .b(new_n128_), .O(z12));
  nand4  g075(.a(new_n123_), .b(new_n122_), .c(new_n99_), .d(new_n98_), .O(new_n132_));
  oai21  g076(.a(new_n132_), .b(new_n86_), .c(x32), .O(new_n133_));
  nor2   g077(.a(x32), .b(x31), .O(new_n134_));
  nand4  g078(.a(new_n134_), .b(new_n119_), .c(new_n108_), .d(new_n95_), .O(new_n135_));
  inv1   g079(.a(new_n135_), .O(new_n136_));
  nand2  g080(.a(new_n136_), .b(new_n87_), .O(new_n137_));
  nand2  g081(.a(new_n137_), .b(new_n133_), .O(new_n138_));
  nand2  g082(.a(new_n138_), .b(x16), .O(new_n139_));
  inv1   g083(.a(x02), .O(new_n140_));
  aoi21  g084(.a(new_n58_), .b(new_n140_), .c(x18), .O(new_n141_));
  nand2  g085(.a(new_n141_), .b(new_n139_), .O(z13));
  oai21  g086(.a(new_n135_), .b(new_n86_), .c(x33), .O(new_n143_));
  inv1   g087(.a(x22), .O(new_n144_));
  inv1   g088(.a(x23), .O(new_n145_));
  nand4  g089(.a(new_n98_), .b(new_n94_), .c(new_n145_), .d(new_n144_), .O(new_n146_));
  nor2   g090(.a(new_n146_), .b(new_n70_), .O(new_n147_));
  nor2   g091(.a(x33), .b(x32), .O(new_n148_));
  nand4  g092(.a(new_n148_), .b(new_n123_), .c(new_n122_), .d(new_n99_), .O(new_n149_));
  inv1   g093(.a(new_n149_), .O(new_n150_));
  nand2  g094(.a(new_n150_), .b(new_n147_), .O(new_n151_));
  nand2  g095(.a(new_n151_), .b(new_n143_), .O(new_n152_));
  ...
  nand4  g101(.a(new_n109_), .b(new_n82_), .c(new_n157_), .d(new_n55_), .O(new_n158_));
  oai21  g102(.a(new_n149_), .b(new_n158_), .c(x34), .O(new_n159_));
  nand2  g103(.a(new_n122_), .b(new_n99_), .O(new_n160_));
  ...
  nand3  g113(.a(new_n169_), .b(new_n161_), .c(new_n147_), .O(new_n170_));
