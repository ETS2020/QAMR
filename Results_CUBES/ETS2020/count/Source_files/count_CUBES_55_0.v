...
module FAU ( 
  ...
  nand4  g089(.a(new_n77_), .b(new_n90_), .c(new_n89_), .d(new_n86_), .O(new_n143_));
  ...
  nand4  g105(.a(new_n158_), .b(new_n157_), .c(new_n107_), .d(new_n91_), .O(new_n159_));
  oai21  g106(.a(new_n159_), .b(new_n80_), .c(x32), .O(new_n160_));
  ...
  nand4  g111(.a(new_n164_), .b(new_n148_), .c(new_n116_), .d(new_n91_), .O(new_n165_));
  ...
  oai21  g121(.a(new_n174_), .b(new_n80_), .c(x33), .O(new_n175_));
  inv1   g122(.a(x33), .O(new_n176_));
  nand4  g123(.a(new_n176_), .b(new_n164_), .c(new_n161_), .d(new_n116_), .O(new_n177_));
  inv1   g124(.a(new_n177_), .O(new_n178_));
  nand4  g125(.a(new_n178_), .b(new_n150_), .c(new_n93_), .d(new_n88_), .O(new_n179_));
