...
module FAU ( 
  ...
  nand4  g064(.a(new_n118_), .b(new_n98_), .c(new_n78_), .d(new_n71_), .O(new_n119_));
  ...
  nand4  g070(.a(new_n94_), .b(new_n55_), .c(new_n64_), .d(new_n62_), .O(new_n125_));
  ...
  nand4  g094(.a(new_n148_), .b(new_n127_), .c(new_n114_), .d(new_n126_), .O(new_n149_));
  ...
  nor2   g106(.a(new_n160_), .b(new_n65_), .O(new_n161_));
