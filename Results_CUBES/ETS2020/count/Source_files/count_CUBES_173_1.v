...
module FAU ( 
  ...
  nand4  g058(.a(new_n111_), .b(new_n85_), .c(new_n72_), .d(new_n62_), .O(new_n112_));
  inv1   g059(.a(x26), .O(new_n113_));
  nor2   g060(.a(x25), .b(x24), .O(new_n114_));
  nor2   g061(.a(x28), .b(x27), .O(new_n115_));
  nand4  g062(.a(new_n115_), .b(new_n114_), .c(new_n113_), .d(new_n93_), .O(new_n116_));
  ...
  oai21  g068(.a(new_n116_), .b(new_n77_), .c(x29), .O(new_n122_));
  nor3   g069(.a(x29), .b(x28), .c(x27), .O(new_n123_));
  nand4  g070(.a(new_n123_), .b(new_n103_), .c(new_n78_), .d(new_n62_), .O(new_n124_));
  ...
  nand4  g076(.a(new_n102_), .b(new_n55_), .c(new_n65_), .d(new_n64_), .O(new_n131_));
  nor2   g077(.a(x26), .b(x25), .O(new_n132_));
  nor2   g078(.a(x30), .b(x29), .O(new_n133_));
  nand4  g079(.a(new_n133_), .b(new_n115_), .c(new_n132_), .d(new_n83_), .O(new_n134_));
  oai21  g080(.a(new_n134_), .b(new_n131_), .c(x31), .O(new_n135_));
  nand4  g081(.a(new_n83_), .b(new_n93_), .c(new_n92_), .d(new_n65_), .O(new_n136_));
  ...
  nand4  g089(.a(new_n143_), .b(new_n111_), .c(new_n137_), .d(new_n62_), .O(new_n144_));
  nand2  g090(.a(new_n144_), .b(new_n135_), .O(new_n145_));
  ...
  nand4  g096(.a(new_n151_), .b(new_n133_), .c(new_n115_), .d(new_n132_), .O(new_n152_));
  oai21  g097(.a(new_n152_), .b(new_n86_), .c(x33), .O(new_n153_));
  inv1   g098(.a(x27), .O(new_n154_));
  inv1   g099(.a(x32), .O(new_n155_));
  inv1   g100(.a(x33), .O(new_n156_));
  nand4  g101(.a(new_n156_), .b(new_n155_), .c(new_n154_), .d(new_n113_), .O(new_n157_));
  inv1   g102(.a(new_n157_), .O(new_n158_));
  nand4  g103(.a(new_n158_), .b(new_n143_), .c(new_n96_), .d(new_n67_), .O(new_n159_));
  nand2  g104(.a(new_n159_), .b(new_n153_), .O(new_n160_));
