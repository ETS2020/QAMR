...
module FAU ( 
  ...
  nor2   g060(.a(x27), .b(x26), .O(new_n114_));
  nor3   g061(.a(x25), .b(x24), .c(x23), .O(new_n115_));
  nand4  g062(.a(new_n115_), .b(new_n114_), .c(new_n72_), .d(new_n62_), .O(new_n116_));
  nor2   g063(.a(x28), .b(x27), .O(new_n117_));
  nor2   g064(.a(x26), .b(x23), .O(new_n118_));
  nand3  g065(.a(new_n118_), .b(new_n117_), .c(new_n103_), .O(new_n119_));
  ...
  nand4  g073(.a(new_n126_), .b(new_n106_), .c(new_n78_), .d(new_n62_), .O(new_n127_));
  ...
  nand4  g079(.a(new_n102_), .b(new_n55_), .c(new_n65_), .d(new_n64_), .O(new_n133_));
  nor2   g080(.a(x26), .b(x25), .O(new_n134_));
  nor2   g081(.a(x30), .b(x29), .O(new_n135_));
  nand4  g082(.a(new_n135_), .b(new_n117_), .c(new_n134_), .d(new_n83_), .O(new_n136_));
  ...
  nand4  g089(.a(new_n144_), .b(new_n135_), .c(new_n117_), .d(new_n134_), .O(new_n145_));
  oai21  g090(.a(new_n145_), .b(new_n86_), .c(x33), .O(new_n146_));
  nor2   g091(.a(x29), .b(x28), .O(new_n147_));
  nor2   g092(.a(x31), .b(x30), .O(new_n148_));
  nor2   g093(.a(x33), .b(x32), .O(new_n149_));
  nand4  g094(.a(new_n149_), .b(new_n148_), .c(new_n147_), .d(new_n114_), .O(new_n150_));
  inv1   g095(.a(new_n150_), .O(new_n151_));
  nand2  g096(.a(new_n151_), .b(new_n96_), .O(new_n152_));
  nand2  g097(.a(new_n152_), .b(new_n146_), .O(new_n153_));
  nand2  g098(.a(new_n153_), .b(x16), .O(new_n154_));
  inv1   g099(.a(x01), .O(new_n155_));
  aoi21  g100(.a(new_n58_), .b(new_n155_), .c(x18), .O(new_n156_));
  nand2  g101(.a(new_n156_), .b(new_n154_), .O(z14));
  oai21  g102(.a(new_n150_), .b(new_n104_), .c(x34), .O(new_n158_));
  nand2  g103(.a(new_n147_), .b(new_n114_), .O(new_n159_));
  inv1   g104(.a(new_n159_), .O(new_n160_));
  inv1   g105(.a(x30), .O(new_n161_));
  inv1   g106(.a(x31), .O(new_n162_));
  nand2  g107(.a(new_n162_), .b(new_n161_), .O(new_n163_));
  inv1   g108(.a(x32), .O(new_n164_));
  inv1   g109(.a(x33), .O(new_n165_));
  inv1   g110(.a(x34), .O(new_n166_));
  nand3  g111(.a(new_n166_), .b(new_n165_), .c(new_n164_), .O(new_n167_));
  nor2   g112(.a(new_n167_), .b(new_n163_), .O(new_n168_));
  nand3  g113(.a(new_n168_), .b(new_n160_), .c(new_n96_), .O(new_n169_));
  nand2  g114(.a(new_n169_), .b(new_n158_), .O(new_n170_));
  nand2  g115(.a(new_n170_), .b(x16), .O(new_n171_));
  inv1   g116(.a(x00), .O(new_n172_));
  aoi21  g117(.a(new_n58_), .b(new_n172_), .c(x18), .O(new_n173_));
  nand2  g118(.a(new_n173_), .b(new_n171_), .O(z15));
  zero   g119(.O(z01));
  zero   g120(.O(z08));
  zero   g121(.O(z12));
  zero   g122(.O(z13));
