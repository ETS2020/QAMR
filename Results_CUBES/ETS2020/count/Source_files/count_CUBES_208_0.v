...
module FAU ( 
  ...
  nand2  g094(.a(new_n132_), .b(new_n122_), .O(new_n149_));
  inv1   g095(.a(new_n149_), .O(new_n150_));
  nor2   g096(.a(x32), .b(x31), .O(new_n151_));
  nand2  g097(.a(new_n151_), .b(new_n106_), .O(new_n152_));
  inv1   g098(.a(new_n152_), .O(new_n153_));
  nand4  g099(.a(new_n153_), .b(new_n150_), .c(new_n136_), .d(new_n63_), .O(new_n154_));
  ...
  nand4  g105(.a(new_n151_), .b(new_n132_), .c(new_n122_), .d(new_n106_), .O(new_n160_));
  oai21  g106(.a(new_n160_), .b(new_n91_), .c(x33), .O(new_n161_));
  nor2   g107(.a(x33), .b(x32), .O(new_n162_));
  nand4  g108(.a(new_n162_), .b(new_n138_), .c(new_n137_), .d(new_n113_), .O(new_n163_));
  inv1   g109(.a(new_n163_), .O(new_n164_));
  nand2  g110(.a(new_n164_), .b(new_n97_), .O(new_n165_));
  ...
  oai21  g116(.a(new_n163_), .b(new_n104_), .c(x34), .O(new_n171_));
  nand2  g117(.a(new_n137_), .b(new_n113_), .O(new_n172_));
