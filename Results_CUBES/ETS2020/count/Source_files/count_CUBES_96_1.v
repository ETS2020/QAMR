// Benchmark "FAU" written by ABC on Tue Jul  7 19:18:38 2020
...
module FAU ( 
  ...
  inv1   g039(.a(x22), .O(new_n93_));
  inv1   g040(.a(x23), .O(new_n94_));
  inv1   g041(.a(x25), .O(new_n95_));
  nand4  g042(.a(new_n95_), .b(new_n83_), .c(new_n94_), .d(new_n93_), .O(new_n96_));
  oai21  g043(.a(new_n96_), .b(new_n66_), .c(x26), .O(new_n97_));
  ...
  nand4  g053(.a(new_n107_), .b(new_n85_), .c(new_n72_), .d(new_n62_), .O(new_n108_));
  inv1   g054(.a(x26), .O(new_n109_));
  nor2   g055(.a(x25), .b(x24), .O(new_n110_));
  nor2   g056(.a(x28), .b(x27), .O(new_n111_));
  nand4  g057(.a(new_n111_), .b(new_n110_), .c(new_n109_), .d(new_n94_), .O(new_n112_));
  ...
  nor3   g063(.a(x29), .b(x28), .c(x27), .O(new_n119_));
  nand4  g064(.a(new_n119_), .b(new_n99_), .c(new_n78_), .d(new_n62_), .O(new_n120_));
  nand4  g065(.a(new_n98_), .b(new_n55_), .c(new_n65_), .d(new_n64_), .O(new_n121_));
  nor2   g066(.a(x26), .b(x25), .O(new_n122_));
  nor2   g067(.a(x30), .b(x29), .O(new_n123_));
  nand4  g068(.a(new_n123_), .b(new_n111_), .c(new_n122_), .d(new_n83_), .O(new_n124_));
  nor2   g069(.a(new_n124_), .b(new_n121_), .O(new_n125_));
  aoi21  g070(.a(new_n120_), .b(x30), .c(new_n125_), .O(new_n126_));
  ...
  nand4  g077(.a(new_n133_), .b(new_n132_), .c(new_n131_), .d(new_n95_), .O(new_n134_));
  oai21  g078(.a(new_n134_), .b(new_n86_), .c(x32), .O(new_n135_));
  nand4  g079(.a(new_n83_), .b(new_n94_), .c(new_n93_), .d(new_n65_), .O(new_n136_));
  inv1   g080(.a(new_n136_), .O(new_n137_));
  inv1   g081(.a(x27), .O(new_n138_));
  inv1   g082(.a(x28), .O(new_n139_));
  inv1   g083(.a(x29), .O(new_n140_));
  inv1   g084(.a(x30), .O(new_n141_));
  ...
  nand4  g089(.a(new_n145_), .b(new_n144_), .c(new_n109_), .d(new_n95_), .O(new_n146_));
  inv1   g090(.a(new_n146_), .O(new_n147_));
  nand4  g091(.a(new_n147_), .b(new_n143_), .c(new_n137_), .d(new_n62_), .O(new_n148_));
  nand2  g092(.a(new_n148_), .b(new_n135_), .O(new_n149_));
  ...
  nand4  g098(.a(new_n154_), .b(new_n123_), .c(new_n111_), .d(new_n122_), .O(new_n155_));
  oai21  g099(.a(new_n155_), .b(new_n86_), .c(x33), .O(new_n156_));
  inv1   g100(.a(new_n96_), .O(new_n157_));
  nand4  g101(.a(new_n144_), .b(new_n141_), .c(new_n140_), .d(new_n139_), .O(new_n158_));
  inv1   g102(.a(new_n158_), .O(new_n159_));
  inv1   g103(.a(x33), .O(new_n160_));
  nand4  g104(.a(new_n160_), .b(new_n145_), .c(new_n138_), .d(new_n109_), .O(new_n161_));
  inv1   g105(.a(new_n161_), .O(new_n162_));
  nand4  g106(.a(new_n162_), .b(new_n159_), .c(new_n157_), .d(new_n67_), .O(new_n163_));
  nand2  g107(.a(new_n163_), .b(new_n156_), .O(new_n164_));
  nand2  g108(.a(new_n164_), .b(x16), .O(new_n165_));
  inv1   g109(.a(x01), .O(new_n166_));
  aoi21  g110(.a(new_n58_), .b(new_n166_), .c(x18), .O(new_n167_));
  nand2  g111(.a(new_n167_), .b(new_n165_), .O(z14));
  zero   g112(.O(z01));
  zero   g113(.O(z06));
  zero   g114(.O(z08));
  zero   g115(.O(z10));
