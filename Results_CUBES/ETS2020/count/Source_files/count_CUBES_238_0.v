...
module FAU ( 
  ...
  nand4  g081(.a(new_n106_), .b(new_n55_), .c(new_n69_), .d(new_n61_), .O(new_n134_));
  nor2   g082(.a(x26), .b(x25), .O(new_n135_));
  nor2   g083(.a(x30), .b(x29), .O(new_n136_));
  nand4  g084(.a(new_n136_), .b(new_n119_), .c(new_n135_), .d(new_n87_), .O(new_n137_));
  nor2   g085(.a(new_n137_), .b(new_n134_), .O(new_n138_));
  aoi21  g086(.a(new_n128_), .b(x30), .c(new_n138_), .O(new_n139_));
  inv1   g087(.a(x04), .O(new_n140_));
  aoi21  g088(.a(new_n58_), .b(new_n140_), .c(x18), .O(new_n141_));
  oai21  g089(.a(new_n139_), .b(new_n58_), .c(new_n141_), .O(z11));
  oai21  g090(.a(new_n137_), .b(new_n134_), .c(x31), .O(new_n143_));
  nand4  g091(.a(new_n87_), .b(new_n97_), .c(new_n96_), .d(new_n69_), .O(new_n144_));
  inv1   g092(.a(new_n144_), .O(new_n145_));
  inv1   g093(.a(x28), .O(new_n146_));
  inv1   g094(.a(x29), .O(new_n147_));
  inv1   g095(.a(x30), .O(new_n148_));
  inv1   g096(.a(x31), .O(new_n149_));
  nand4  g097(.a(new_n149_), .b(new_n148_), .c(new_n147_), .d(new_n146_), .O(new_n150_));
  inv1   g098(.a(new_n150_), .O(new_n151_));
  nand4  g099(.a(new_n151_), .b(new_n115_), .c(new_n145_), .d(new_n63_), .O(new_n152_));
  nand2  g100(.a(new_n152_), .b(new_n143_), .O(new_n153_));
  ...
  nor2   g105(.a(x27), .b(x26), .O(new_n158_));
  nor2   g106(.a(x29), .b(x28), .O(new_n159_));
  nor2   g107(.a(x31), .b(x30), .O(new_n160_));
  nand4  g108(.a(new_n160_), .b(new_n159_), .c(new_n158_), .d(new_n98_), .O(new_n161_));
  oai21  g109(.a(new_n161_), .b(new_n90_), .c(x32), .O(new_n162_));
  inv1   g110(.a(x27), .O(new_n163_));
  nand4  g111(.a(new_n148_), .b(new_n147_), .c(new_n146_), .d(new_n163_), .O(new_n164_));
  inv1   g112(.a(new_n164_), .O(new_n165_));
  inv1   g113(.a(x32), .O(new_n166_));
  nand4  g114(.a(new_n166_), .b(new_n149_), .c(new_n117_), .d(new_n98_), .O(new_n167_));
  inv1   g115(.a(new_n167_), .O(new_n168_));
  nand4  g116(.a(new_n168_), .b(new_n165_), .c(new_n145_), .d(new_n63_), .O(new_n169_));
  ...
  nand4  g123(.a(new_n175_), .b(new_n136_), .c(new_n119_), .d(new_n135_), .O(new_n176_));
  oai21  g124(.a(new_n176_), .b(new_n90_), .c(x33), .O(new_n177_));
  inv1   g125(.a(x33), .O(new_n178_));
  nand4  g126(.a(new_n178_), .b(new_n166_), .c(new_n163_), .d(new_n117_), .O(new_n179_));
  inv1   g127(.a(new_n179_), .O(new_n180_));
  nand4  g128(.a(new_n180_), .b(new_n151_), .c(new_n100_), .d(new_n71_), .O(new_n181_));
