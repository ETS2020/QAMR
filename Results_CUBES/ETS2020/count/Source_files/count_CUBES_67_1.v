// Benchmark "FAU" written by ABC on Tue Jul  7 19:18:20 2020
...
module FAU ( 
  ...
  nor2   g055(.a(x27), .b(x26), .O(new_n110_));
  nor3   g056(.a(x25), .b(x24), .c(x23), .O(new_n111_));
  nand4  g057(.a(new_n111_), .b(new_n110_), .c(new_n77_), .d(new_n63_), .O(new_n112_));
  ...
  nor2   g061(.a(new_n115_), .b(new_n78_), .O(new_n116_));
  ...
  nand4  g068(.a(new_n122_), .b(new_n102_), .c(new_n79_), .d(new_n63_), .O(new_n123_));
  ...
  nand4  g074(.a(new_n98_), .b(new_n55_), .c(new_n68_), .d(new_n61_), .O(new_n129_));
  nor2   g075(.a(x26), .b(x25), .O(new_n130_));
  nor2   g076(.a(x30), .b(x29), .O(new_n131_));
  nand4  g077(.a(new_n131_), .b(new_n113_), .c(new_n130_), .d(new_n89_), .O(new_n132_));
  ...
  nand4  g089(.a(new_n145_), .b(new_n144_), .c(new_n143_), .d(new_n110_), .O(new_n146_));
  inv1   g090(.a(new_n146_), .O(new_n147_));
  nand2  g091(.a(new_n147_), .b(new_n92_), .O(new_n148_));
  ...
  oai21  g097(.a(new_n146_), .b(new_n100_), .c(x34), .O(new_n154_));
  nand2  g098(.a(new_n143_), .b(new_n110_), .O(new_n155_));
  ...
  nand3  g108(.a(new_n164_), .b(new_n156_), .c(new_n92_), .O(new_n165_));
