...
module FAU ( 
  ...
  nand3  g045(.a(new_n98_), .b(new_n89_), .c(new_n68_), .O(new_n99_));
  ...
  nand4  g056(.a(new_n109_), .b(new_n82_), .c(new_n73_), .d(new_n60_), .O(new_n110_));
  inv1   g057(.a(x23), .O(new_n111_));
  inv1   g058(.a(x26), .O(new_n112_));
  nor2   g059(.a(x28), .b(x27), .O(new_n113_));
  nand4  g060(.a(new_n113_), .b(new_n90_), .c(new_n112_), .d(new_n111_), .O(new_n114_));
  nor2   g061(.a(new_n114_), .b(new_n100_), .O(new_n115_));
  ...
  nand4  g067(.a(new_n121_), .b(new_n98_), .c(new_n80_), .d(new_n60_), .O(new_n122_));
  inv1   g068(.a(x21), .O(new_n123_));
  nand4  g069(.a(new_n89_), .b(new_n58_), .c(new_n123_), .d(new_n57_), .O(new_n124_));
  nor2   g070(.a(x30), .b(x29), .O(new_n125_));
  nand4  g071(.a(new_n125_), .b(new_n113_), .c(new_n102_), .d(new_n79_), .O(new_n126_));
  ...
  oai21  g077(.a(new_n126_), .b(new_n124_), .c(x31), .O(new_n132_));
  inv1   g078(.a(x22), .O(new_n133_));
  nand4  g079(.a(new_n79_), .b(new_n111_), .c(new_n133_), .d(new_n123_), .O(new_n134_));
  ...
  nand4  g087(.a(new_n141_), .b(new_n109_), .c(new_n135_), .d(new_n60_), .O(new_n142_));
  nand2  g088(.a(new_n142_), .b(new_n132_), .O(new_n143_));
  ...
  nand4  g101(.a(new_n155_), .b(new_n139_), .c(new_n112_), .d(new_n154_), .O(new_n156_));
  inv1   g102(.a(new_n156_), .O(new_n157_));
  nand4  g103(.a(new_n157_), .b(new_n153_), .c(new_n135_), .d(new_n60_), .O(new_n158_));
