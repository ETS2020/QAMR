...
module FAU ( 
  ...
  nor2   g077(.a(x26), .b(x25), .O(new_n134_));
  nor2   g078(.a(x30), .b(x29), .O(new_n135_));
  nor2   g079(.a(x32), .b(x31), .O(new_n136_));
  nand4  g080(.a(new_n136_), .b(new_n135_), .c(new_n115_), .d(new_n134_), .O(new_n137_));
  oai21  g081(.a(new_n137_), .b(new_n86_), .c(x33), .O(new_n138_));
  inv1   g082(.a(x22), .O(new_n139_));
  inv1   g083(.a(x23), .O(new_n140_));
  nand4  g084(.a(new_n105_), .b(new_n83_), .c(new_n140_), .d(new_n139_), .O(new_n141_));
  nor2   g085(.a(new_n141_), .b(new_n66_), .O(new_n142_));
  nor2   g086(.a(x29), .b(x28), .O(new_n143_));
  nor2   g087(.a(x31), .b(x30), .O(new_n144_));
  nor2   g088(.a(x33), .b(x32), .O(new_n145_));
  nand4  g089(.a(new_n145_), .b(new_n144_), .c(new_n143_), .d(new_n106_), .O(new_n146_));
  inv1   g090(.a(new_n146_), .O(new_n147_));
  nand2  g091(.a(new_n147_), .b(new_n142_), .O(new_n148_));
  nand2  g092(.a(new_n148_), .b(new_n138_), .O(new_n149_));
  ...
  oai21  g097(.a(new_n146_), .b(new_n96_), .c(x34), .O(new_n154_));
  nand2  g098(.a(new_n143_), .b(new_n106_), .O(new_n155_));
  ...
  nand3  g108(.a(new_n164_), .b(new_n156_), .c(new_n142_), .O(new_n165_));
