...
module FAU ( 
  ...
  nand4  g079(.a(new_n132_), .b(new_n106_), .c(new_n83_), .d(new_n63_), .O(new_n133_));
  nand4  g080(.a(new_n102_), .b(new_n55_), .c(new_n69_), .d(new_n61_), .O(new_n134_));
  nor2   g081(.a(x26), .b(x25), .O(new_n135_));
  nor2   g082(.a(x30), .b(x29), .O(new_n136_));
  nand4  g083(.a(new_n136_), .b(new_n123_), .c(new_n135_), .d(new_n82_), .O(new_n137_));
  ...
  nand3  g094(.a(new_n147_), .b(new_n121_), .c(new_n87_), .O(new_n148_));
