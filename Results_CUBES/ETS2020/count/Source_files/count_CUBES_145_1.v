...
module FAU ( 
  ...
  nand4  g078(.a(new_n132_), .b(new_n123_), .c(new_n106_), .d(new_n94_), .O(new_n133_));
  ...
  nand4  g092(.a(new_n138_), .b(new_n137_), .c(new_n113_), .d(new_n95_), .O(new_n147_));
  oai21  g093(.a(new_n147_), .b(new_n91_), .c(x32), .O(new_n148_));
  nand2  g094(.a(new_n132_), .b(new_n123_), .O(new_n149_));
  inv1   g095(.a(new_n149_), .O(new_n150_));
  inv1   g096(.a(x31), .O(new_n151_));
  inv1   g097(.a(x32), .O(new_n152_));
  nand4  g098(.a(new_n152_), .b(new_n151_), .c(new_n122_), .d(new_n95_), .O(new_n153_));
  inv1   g099(.a(new_n153_), .O(new_n154_));
  nand4  g100(.a(new_n154_), .b(new_n150_), .c(new_n136_), .d(new_n63_), .O(new_n155_));
  nand2  g101(.a(new_n155_), .b(new_n148_), .O(new_n156_));
  ...
  nand4  g107(.a(new_n162_), .b(new_n138_), .c(new_n137_), .d(new_n113_), .O(new_n163_));
  oai21  g108(.a(new_n163_), .b(new_n104_), .c(x34), .O(new_n164_));
  nand2  g109(.a(new_n137_), .b(new_n113_), .O(new_n165_));
  inv1   g110(.a(new_n165_), .O(new_n166_));
  inv1   g111(.a(x30), .O(new_n167_));
  nand2  g112(.a(new_n151_), .b(new_n167_), .O(new_n168_));
  inv1   g113(.a(x33), .O(new_n169_));
  inv1   g114(.a(x34), .O(new_n170_));
  nand3  g115(.a(new_n170_), .b(new_n169_), .c(new_n152_), .O(new_n171_));
