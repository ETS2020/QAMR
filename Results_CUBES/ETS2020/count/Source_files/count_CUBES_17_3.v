...
module FAU ( 
  ...
  nand3  g066(.a(new_n119_), .b(new_n118_), .c(new_n117_), .O(new_n120_));
  ...
  nand4  g109(.a(new_n162_), .b(new_n141_), .c(new_n140_), .d(new_n109_), .O(new_n163_));
  ...
  nor2   g117(.a(x21), .b(x20), .O(new_n171_));
  nand4  g118(.a(new_n117_), .b(new_n106_), .c(new_n171_), .d(new_n55_), .O(new_n172_));
  oai21  g119(.a(new_n163_), .b(new_n172_), .c(x34), .O(new_n173_));
  nand2  g120(.a(new_n140_), .b(new_n109_), .O(new_n174_));
