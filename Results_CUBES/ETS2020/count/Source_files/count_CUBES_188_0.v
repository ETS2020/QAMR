...
module FAU ( 
  ...
  nand4  g093(.a(new_n144_), .b(new_n126_), .c(new_n143_), .d(new_n87_), .O(new_n145_));
  ...
  nand4  g104(.a(new_n156_), .b(new_n144_), .c(new_n126_), .d(new_n143_), .O(new_n157_));
  ...
  nand4  g114(.a(new_n166_), .b(new_n153_), .c(new_n152_), .d(new_n117_), .O(new_n167_));
  inv1   g115(.a(new_n167_), .O(new_n168_));
  nand2  g116(.a(new_n168_), .b(new_n100_), .O(new_n169_));
  ...
  oai21  g122(.a(new_n167_), .b(new_n108_), .c(x34), .O(new_n175_));
  nand2  g123(.a(new_n152_), .b(new_n117_), .O(new_n176_));
  inv1   g124(.a(new_n176_), .O(new_n177_));
  inv1   g125(.a(x30), .O(new_n178_));
  inv1   g126(.a(x31), .O(new_n179_));
  nand2  g127(.a(new_n179_), .b(new_n178_), .O(new_n180_));
  inv1   g128(.a(x32), .O(new_n181_));
  inv1   g129(.a(x33), .O(new_n182_));
  inv1   g130(.a(x34), .O(new_n183_));
  nand3  g131(.a(new_n183_), .b(new_n182_), .c(new_n181_), .O(new_n184_));
  nor2   g132(.a(new_n184_), .b(new_n180_), .O(new_n185_));
  nand3  g133(.a(new_n185_), .b(new_n177_), .c(new_n100_), .O(new_n186_));
  nand2  g134(.a(new_n186_), .b(new_n175_), .O(new_n187_));
