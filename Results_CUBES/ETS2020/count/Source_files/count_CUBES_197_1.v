...
module FAU ( 
  ...
  nand3  g044(.a(new_n97_), .b(new_n83_), .c(new_n71_), .O(new_n98_));
  ...
  nor2   g052(.a(x24), .b(x23), .O(new_n106_));
  nand4  g053(.a(new_n106_), .b(new_n105_), .c(new_n104_), .d(new_n94_), .O(new_n107_));
  nor2   g054(.a(new_n107_), .b(new_n81_), .O(new_n108_));
  aoi21  g055(.a(new_n98_), .b(x27), .c(new_n108_), .O(new_n109_));
  ...
  nand4  g060(.a(new_n113_), .b(new_n106_), .c(new_n76_), .d(new_n63_), .O(new_n114_));
  nor2   g061(.a(x25), .b(x24), .O(new_n115_));
  nor2   g062(.a(x28), .b(x27), .O(new_n116_));
  nand4  g063(.a(new_n116_), .b(new_n115_), .c(new_n104_), .d(new_n92_), .O(new_n117_));
  ...
  nand4  g071(.a(new_n126_), .b(new_n116_), .c(new_n125_), .d(new_n93_), .O(new_n127_));
  oai21  g072(.a(new_n127_), .b(new_n84_), .c(x31), .O(new_n128_));
  nand4  g073(.a(new_n93_), .b(new_n92_), .c(new_n91_), .d(new_n69_), .O(new_n129_));
  ...
  nand4  g081(.a(new_n136_), .b(new_n130_), .c(new_n113_), .d(new_n63_), .O(new_n137_));
  ...
  nand4  g087(.a(new_n106_), .b(new_n76_), .c(new_n55_), .d(new_n61_), .O(new_n144_));
  nor2   g088(.a(x32), .b(x31), .O(new_n145_));
  nand4  g089(.a(new_n145_), .b(new_n126_), .c(new_n116_), .d(new_n125_), .O(new_n146_));
  oai21  g090(.a(new_n146_), .b(new_n144_), .c(x33), .O(new_n147_));
  inv1   g091(.a(new_n95_), .O(new_n148_));
  inv1   g092(.a(x32), .O(new_n149_));
  inv1   g093(.a(x33), .O(new_n150_));
  nand4  g094(.a(new_n150_), .b(new_n149_), .c(new_n105_), .d(new_n104_), .O(new_n151_));
  inv1   g095(.a(new_n151_), .O(new_n152_));
  nand4  g096(.a(new_n152_), .b(new_n136_), .c(new_n148_), .d(new_n71_), .O(new_n153_));
  nand2  g097(.a(new_n153_), .b(new_n147_), .O(new_n154_));
