...
module FAU ( 
  ...
  nand4  g082(.a(new_n136_), .b(new_n135_), .c(new_n114_), .d(new_n98_), .O(new_n137_));
  oai21  g083(.a(new_n137_), .b(new_n90_), .c(x32), .O(new_n138_));
  nand4  g084(.a(new_n87_), .b(new_n97_), .c(new_n96_), .d(new_n69_), .O(new_n139_));
  inv1   g085(.a(new_n139_), .O(new_n140_));
  inv1   g086(.a(x29), .O(new_n141_));
  inv1   g087(.a(x30), .O(new_n142_));
  inv1   g088(.a(x31), .O(new_n143_));
  inv1   g089(.a(x32), .O(new_n144_));
  ...
  nand4  g094(.a(new_n148_), .b(new_n147_), .c(new_n123_), .d(new_n98_), .O(new_n149_));
  inv1   g095(.a(new_n149_), .O(new_n150_));
  nand4  g096(.a(new_n150_), .b(new_n146_), .c(new_n140_), .d(new_n63_), .O(new_n151_));
  nand2  g097(.a(new_n151_), .b(new_n138_), .O(new_n152_));
  ...
  nor2   g102(.a(x30), .b(x29), .O(new_n157_));
  nor2   g103(.a(x32), .b(x31), .O(new_n158_));
  nand4  g104(.a(new_n158_), .b(new_n157_), .c(new_n125_), .d(new_n106_), .O(new_n159_));
  oai21  g105(.a(new_n159_), .b(new_n90_), .c(x33), .O(new_n160_));
  nand4  g106(.a(new_n143_), .b(new_n142_), .c(new_n141_), .d(new_n148_), .O(new_n161_));
  inv1   g107(.a(new_n161_), .O(new_n162_));
  inv1   g108(.a(x33), .O(new_n163_));
  nand4  g109(.a(new_n163_), .b(new_n144_), .c(new_n147_), .d(new_n123_), .O(new_n164_));
  inv1   g110(.a(new_n164_), .O(new_n165_));
  nand4  g111(.a(new_n165_), .b(new_n162_), .c(new_n100_), .d(new_n71_), .O(new_n166_));
  nand2  g112(.a(new_n166_), .b(new_n160_), .O(new_n167_));
