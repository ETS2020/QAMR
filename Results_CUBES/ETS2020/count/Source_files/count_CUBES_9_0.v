...
module FAU ( 
  ...
  nor3   g053(.a(x25), .b(x24), .c(x23), .O(new_n108_));
  nand4  g054(.a(new_n108_), .b(new_n107_), .c(new_n71_), .d(new_n63_), .O(new_n109_));
  nand3  g055(.a(new_n71_), .b(new_n55_), .c(new_n61_), .O(new_n110_));
  nor2   g056(.a(x25), .b(x24), .O(new_n111_));
  nor2   g057(.a(x28), .b(x27), .O(new_n112_));
  nand4  g058(.a(new_n112_), .b(new_n111_), .c(new_n96_), .d(new_n88_), .O(new_n113_));
  nor2   g059(.a(new_n113_), .b(new_n110_), .O(new_n114_));
  ...
  nand4  g066(.a(new_n120_), .b(new_n99_), .c(new_n78_), .d(new_n63_), .O(new_n121_));
  ...
  nand4  g075(.a(new_n129_), .b(new_n112_), .c(new_n128_), .d(new_n77_), .O(new_n130_));
  ...
  nand4  g082(.a(new_n138_), .b(new_n129_), .c(new_n112_), .d(new_n128_), .O(new_n139_));
  oai21  g083(.a(new_n139_), .b(new_n81_), .c(x33), .O(new_n140_));
  nor2   g084(.a(x29), .b(x28), .O(new_n141_));
  nor2   g085(.a(x31), .b(x30), .O(new_n142_));
  nor2   g086(.a(x33), .b(x32), .O(new_n143_));
  nand4  g087(.a(new_n143_), .b(new_n142_), .c(new_n141_), .d(new_n107_), .O(new_n144_));
  inv1   g088(.a(new_n144_), .O(new_n145_));
  nand2  g089(.a(new_n145_), .b(new_n91_), .O(new_n146_));
  ...
  nand4  g095(.a(new_n111_), .b(new_n98_), .c(new_n97_), .d(new_n55_), .O(new_n152_));
  oai21  g096(.a(new_n144_), .b(new_n152_), .c(x34), .O(new_n153_));
  nand2  g097(.a(new_n141_), .b(new_n107_), .O(new_n154_));
  ...
  nand3  g107(.a(new_n163_), .b(new_n155_), .c(new_n91_), .O(new_n164_));
