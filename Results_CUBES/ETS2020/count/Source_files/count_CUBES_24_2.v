...
module FAU ( 
  ...
  aoi21  g020(.a(new_n74_), .b(new_n55_), .c(new_n73_), .O(new_n75_));
  nor2   g021(.a(x19), .b(x17), .O(new_n76_));
  nor2   g022(.a(x24), .b(x23), .O(new_n77_));
  nand4  g023(.a(new_n77_), .b(new_n67_), .c(new_n76_), .d(new_n59_), .O(new_n78_));
  inv1   g024(.a(new_n78_), .O(new_n79_));
  oai21  g025(.a(new_n79_), .b(new_n75_), .c(x16), .O(new_n80_));
  ...
  nand3  g032(.a(new_n67_), .b(new_n76_), .c(new_n59_), .O(new_n89_));
  ...
  nand4  g047(.a(new_n104_), .b(new_n87_), .c(new_n74_), .d(new_n55_), .O(new_n105_));
  ...
  nand4  g053(.a(new_n86_), .b(new_n76_), .c(new_n60_), .d(new_n59_), .O(new_n111_));
  nor2   g054(.a(x26), .b(x25), .O(new_n112_));
  nor2   g055(.a(x30), .b(x29), .O(new_n113_));
  nand4  g056(.a(new_n113_), .b(new_n99_), .c(new_n112_), .d(new_n73_), .O(new_n114_));
  ...
  nor2   g062(.a(x32), .b(x31), .O(new_n122_));
  nand4  g063(.a(new_n122_), .b(new_n113_), .c(new_n99_), .d(new_n112_), .O(new_n123_));
  oai21  g064(.a(new_n123_), .b(new_n78_), .c(x33), .O(new_n124_));
  inv1   g065(.a(x22), .O(new_n125_));
  inv1   g066(.a(x23), .O(new_n126_));
  nand4  g067(.a(new_n90_), .b(new_n73_), .c(new_n126_), .d(new_n125_), .O(new_n127_));
  nor2   g068(.a(new_n127_), .b(new_n61_), .O(new_n128_));
  nor2   g069(.a(x29), .b(x28), .O(new_n129_));
  nor2   g070(.a(x31), .b(x30), .O(new_n130_));
  nor2   g071(.a(x33), .b(x32), .O(new_n131_));
  nand4  g072(.a(new_n131_), .b(new_n130_), .c(new_n129_), .d(new_n91_), .O(new_n132_));
  inv1   g073(.a(new_n132_), .O(new_n133_));
  nand2  g074(.a(new_n133_), .b(new_n128_), .O(new_n134_));
  nand2  g075(.a(new_n134_), .b(new_n124_), .O(new_n135_));
  nand2  g076(.a(new_n135_), .b(x16), .O(new_n136_));
  inv1   g077(.a(x01), .O(new_n137_));
  aoi21  g078(.a(new_n54_), .b(new_n137_), .c(x18), .O(new_n138_));
  nand2  g079(.a(new_n138_), .b(new_n136_), .O(z14));
  nor2   g080(.a(x21), .b(x20), .O(new_n140_));
  nand4  g081(.a(new_n100_), .b(new_n86_), .c(new_n140_), .d(new_n76_), .O(new_n141_));
  oai21  g082(.a(new_n132_), .b(new_n141_), .c(x34), .O(new_n142_));
  nand2  g083(.a(new_n129_), .b(new_n91_), .O(new_n143_));
  inv1   g084(.a(new_n143_), .O(new_n144_));
  inv1   g085(.a(x30), .O(new_n145_));
  inv1   g086(.a(x31), .O(new_n146_));
  nand2  g087(.a(new_n146_), .b(new_n145_), .O(new_n147_));
  inv1   g088(.a(x32), .O(new_n148_));
  inv1   g089(.a(x33), .O(new_n149_));
  inv1   g090(.a(x34), .O(new_n150_));
  nand3  g091(.a(new_n150_), .b(new_n149_), .c(new_n148_), .O(new_n151_));
  nor2   g092(.a(new_n151_), .b(new_n147_), .O(new_n152_));
  nand3  g093(.a(new_n152_), .b(new_n144_), .c(new_n128_), .O(new_n153_));
  nand2  g094(.a(new_n153_), .b(new_n142_), .O(new_n154_));
  nand2  g095(.a(new_n154_), .b(x16), .O(new_n155_));
  inv1   g096(.a(x00), .O(new_n156_));
  aoi21  g097(.a(new_n54_), .b(new_n156_), .c(x18), .O(new_n157_));
  nand2  g098(.a(new_n157_), .b(new_n155_), .O(z15));
  zero   g099(.O(z00));
  zero   g100(.O(z01));
  zero   g101(.O(z04));
  zero   g102(.O(z06));
