...
module FAU ( 
  ...
  wire new_n52_, new_n53_, new_n54_, new_n55_, new_n56_, new_n57_, new_n58_,
    ...
    new_n120_, new_n124_, new_n125_, new_n126_, new_n127_, new_n128_,
  ...
  nand4  g064(.a(new_n89_), .b(new_n115_), .c(new_n114_), .d(new_n98_), .O(new_n116_));
  ...
  nand4  g071(.a(new_n124_), .b(new_n107_), .c(new_n82_), .d(new_n63_), .O(new_n125_));
  nand4  g072(.a(new_n106_), .b(new_n55_), .c(new_n69_), .d(new_n61_), .O(new_n126_));
  nor2   g073(.a(x26), .b(x25), .O(new_n127_));
  nor2   g074(.a(x28), .b(x27), .O(new_n128_));
  nor2   g075(.a(x30), .b(x29), .O(new_n129_));
  nand4  g076(.a(new_n129_), .b(new_n128_), .c(new_n127_), .d(new_n87_), .O(new_n130_));
  nor2   g077(.a(new_n130_), .b(new_n126_), .O(new_n131_));
  aoi21  g078(.a(new_n125_), .b(x30), .c(new_n131_), .O(new_n132_));
  inv1   g079(.a(x04), .O(new_n133_));
  aoi21  g080(.a(new_n58_), .b(new_n133_), .c(x18), .O(new_n134_));
  oai21  g081(.a(new_n132_), .b(new_n58_), .c(new_n134_), .O(z11));
  oai21  g082(.a(new_n130_), .b(new_n126_), .c(x31), .O(new_n136_));
  nand4  g083(.a(new_n87_), .b(new_n97_), .c(new_n96_), .d(new_n69_), .O(new_n137_));
  ...
  nand4  g092(.a(new_n145_), .b(new_n139_), .c(new_n138_), .d(new_n63_), .O(new_n146_));
  ...
  nand4  g099(.a(new_n153_), .b(new_n129_), .c(new_n128_), .d(new_n127_), .O(new_n154_));
  oai21  g100(.a(new_n154_), .b(new_n90_), .c(x33), .O(new_n155_));
  inv1   g101(.a(x32), .O(new_n156_));
  inv1   g102(.a(x33), .O(new_n157_));
  nand4  g103(.a(new_n157_), .b(new_n156_), .c(new_n115_), .d(new_n114_), .O(new_n158_));
  inv1   g104(.a(new_n158_), .O(new_n159_));
  nand4  g105(.a(new_n159_), .b(new_n145_), .c(new_n100_), .d(new_n71_), .O(new_n160_));
