// Benchmark "FAU" written by ABC on Tue Jul  7 19:19:05 2020
...
module FAU ( 
  ...
  nand4  g050(.a(new_n105_), .b(new_n77_), .c(new_n68_), .d(new_n67_), .O(new_n106_));
  nor2   g051(.a(x25), .b(x24), .O(new_n107_));
  nor2   g052(.a(x28), .b(x27), .O(new_n108_));
  nor2   g053(.a(x26), .b(x23), .O(new_n109_));
  nand3  g054(.a(new_n109_), .b(new_n108_), .c(new_n107_), .O(new_n110_));
  nor2   g055(.a(new_n110_), .b(new_n97_), .O(new_n111_));
  ...
  nand4  g062(.a(new_n117_), .b(new_n95_), .c(new_n75_), .d(new_n67_), .O(new_n118_));
  ...
  nand4  g068(.a(new_n94_), .b(new_n56_), .c(new_n60_), .d(new_n55_), .O(new_n124_));
  nor2   g069(.a(x26), .b(x25), .O(new_n125_));
  nor2   g070(.a(x30), .b(x29), .O(new_n126_));
  nand4  g071(.a(new_n126_), .b(new_n108_), .c(new_n125_), .d(new_n74_), .O(new_n127_));
  ...
  nand3  g082(.a(new_n137_), .b(new_n105_), .c(new_n79_), .O(new_n138_));
  ...
  nand4  g088(.a(new_n135_), .b(new_n134_), .c(new_n98_), .d(new_n86_), .O(new_n144_));
  oai21  g089(.a(new_n144_), .b(new_n78_), .c(x32), .O(new_n145_));
  nor2   g090(.a(x32), .b(x31), .O(new_n146_));
  nand4  g091(.a(new_n146_), .b(new_n126_), .c(new_n108_), .d(new_n125_), .O(new_n147_));
  inv1   g092(.a(new_n147_), .O(new_n148_));
  nand2  g093(.a(new_n148_), .b(new_n79_), .O(new_n149_));
  nand2  g094(.a(new_n149_), .b(new_n145_), .O(new_n150_));
  nand2  g095(.a(new_n150_), .b(x16), .O(new_n151_));
  inv1   g096(.a(x02), .O(new_n152_));
  aoi21  g097(.a(new_n54_), .b(new_n152_), .c(x18), .O(new_n153_));
  nand2  g098(.a(new_n153_), .b(new_n151_), .O(z13));
  oai21  g099(.a(new_n147_), .b(new_n78_), .c(x33), .O(new_n155_));
  nor2   g100(.a(x33), .b(x32), .O(new_n156_));
  nand4  g101(.a(new_n156_), .b(new_n135_), .c(new_n134_), .d(new_n98_), .O(new_n157_));
  inv1   g102(.a(new_n157_), .O(new_n158_));
  nand2  g103(.a(new_n158_), .b(new_n88_), .O(new_n159_));
  nand2  g104(.a(new_n159_), .b(new_n155_), .O(new_n160_));
  nand2  g105(.a(new_n160_), .b(x16), .O(new_n161_));
  inv1   g106(.a(x01), .O(new_n162_));
  aoi21  g107(.a(new_n54_), .b(new_n162_), .c(x18), .O(new_n163_));
  nand2  g108(.a(new_n163_), .b(new_n161_), .O(z14));
  nor2   g109(.a(x21), .b(x20), .O(new_n165_));
  nand4  g110(.a(new_n107_), .b(new_n94_), .c(new_n165_), .d(new_n56_), .O(new_n166_));
  oai21  g111(.a(new_n157_), .b(new_n166_), .c(x34), .O(new_n167_));
  nand2  g112(.a(new_n134_), .b(new_n98_), .O(new_n168_));
