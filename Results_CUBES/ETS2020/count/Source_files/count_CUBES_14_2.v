...
module FAU ( 
  ...
  nand4  g088(.a(new_n143_), .b(new_n130_), .c(new_n112_), .d(new_n129_), .O(new_n144_));
  inv1   g089(.a(new_n144_), .O(new_n145_));
  nand2  g090(.a(new_n145_), .b(new_n83_), .O(new_n146_));
  nand2  g091(.a(new_n146_), .b(new_n142_), .O(new_n147_));
  nand2  g092(.a(new_n147_), .b(x16), .O(new_n148_));
  inv1   g093(.a(x02), .O(new_n149_));
  aoi21  g094(.a(new_n54_), .b(new_n149_), .c(x18), .O(new_n150_));
  nand2  g095(.a(new_n150_), .b(new_n148_), .O(z13));
  oai21  g096(.a(new_n144_), .b(new_n82_), .c(x33), .O(new_n152_));
  nor2   g097(.a(x33), .b(x32), .O(new_n153_));
  nand4  g098(.a(new_n153_), .b(new_n140_), .c(new_n139_), .d(new_n138_), .O(new_n154_));
  ...
  nand2  g107(.a(new_n139_), .b(new_n138_), .O(new_n163_));
