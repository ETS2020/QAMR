...
module FAU ( 
  ...
  nand4  g053(.a(new_n105_), .b(new_n101_), .c(new_n100_), .d(new_n55_), .O(new_n106_));
  ...
  nand3  g060(.a(new_n112_), .b(new_n84_), .c(new_n93_), .O(new_n113_));
  nor2   g061(.a(new_n113_), .b(new_n76_), .O(new_n114_));
  ...
  nand4  g067(.a(new_n121_), .b(new_n105_), .c(new_n77_), .d(new_n63_), .O(new_n122_));
  nand4  g068(.a(new_n101_), .b(new_n55_), .c(new_n69_), .d(new_n61_), .O(new_n123_));
  nor2   g069(.a(x26), .b(x25), .O(new_n124_));
  nor2   g070(.a(x28), .b(x27), .O(new_n125_));
  nor2   g071(.a(x30), .b(x29), .O(new_n126_));
  nand4  g072(.a(new_n126_), .b(new_n125_), .c(new_n124_), .d(new_n82_), .O(new_n127_));
  nor2   g073(.a(new_n127_), .b(new_n123_), .O(new_n128_));
  aoi21  g074(.a(new_n122_), .b(x30), .c(new_n128_), .O(new_n129_));
  ...
  oai21  g078(.a(new_n127_), .b(new_n123_), .c(x31), .O(new_n133_));
  ...
  nand3  g084(.a(new_n138_), .b(new_n134_), .c(new_n86_), .O(new_n139_));
  nand2  g085(.a(new_n139_), .b(new_n133_), .O(new_n140_));
  ...
  nand4  g090(.a(new_n136_), .b(new_n135_), .c(new_n112_), .d(new_n93_), .O(new_n145_));
  oai21  g091(.a(new_n145_), .b(new_n85_), .c(x32), .O(new_n146_));
  nor2   g092(.a(x32), .b(x31), .O(new_n147_));
  nand4  g093(.a(new_n147_), .b(new_n126_), .c(new_n125_), .d(new_n124_), .O(new_n148_));
  inv1   g094(.a(new_n148_), .O(new_n149_));
  nand2  g095(.a(new_n149_), .b(new_n86_), .O(new_n150_));
  ...
  oai21  g101(.a(new_n148_), .b(new_n85_), .c(x33), .O(new_n156_));
  nor2   g102(.a(x33), .b(x32), .O(new_n157_));
  nand4  g103(.a(new_n157_), .b(new_n136_), .c(new_n135_), .d(new_n112_), .O(new_n158_));
  inv1   g104(.a(new_n158_), .O(new_n159_));
  nand2  g105(.a(new_n159_), .b(new_n95_), .O(new_n160_));
  ...
  oai21  g111(.a(new_n158_), .b(new_n103_), .c(x34), .O(new_n166_));
  nand2  g112(.a(new_n135_), .b(new_n112_), .O(new_n167_));
  ...
  nand3  g122(.a(new_n176_), .b(new_n168_), .c(new_n95_), .O(new_n177_));
