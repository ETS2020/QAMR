...
module FAU ( 
  ...
  nand2  g039(.a(new_n91_), .b(x25), .O(new_n92_));
  ...
  nand4  g058(.a(new_n111_), .b(new_n90_), .c(new_n76_), .d(new_n63_), .O(new_n112_));
  ...
  aoi22  g064(.a(new_n117_), .b(new_n78_), .c(new_n112_), .d(x28), .O(new_n118_));
  ...
  nand4  g069(.a(new_n123_), .b(new_n103_), .c(new_n84_), .d(new_n63_), .O(new_n124_));
  nand4  g070(.a(new_n94_), .b(new_n55_), .c(new_n69_), .d(new_n61_), .O(new_n125_));
  inv1   g071(.a(x24), .O(new_n126_));
  nor2   g072(.a(x26), .b(x25), .O(new_n127_));
  nor2   g073(.a(x30), .b(x29), .O(new_n128_));
  nand4  g074(.a(new_n128_), .b(new_n115_), .c(new_n127_), .d(new_n126_), .O(new_n129_));
  ...
  nand4  g082(.a(new_n126_), .b(new_n113_), .c(new_n136_), .d(new_n69_), .O(new_n137_));
  ...
  nand4  g090(.a(new_n144_), .b(new_n111_), .c(new_n138_), .d(new_n63_), .O(new_n145_));
  ...
  nand4  g097(.a(new_n152_), .b(new_n128_), .c(new_n115_), .d(new_n127_), .O(new_n153_));
  oai21  g098(.a(new_n153_), .b(new_n91_), .c(x33), .O(new_n154_));
  inv1   g099(.a(x25), .O(new_n155_));
  nand4  g100(.a(new_n155_), .b(new_n126_), .c(new_n113_), .d(new_n136_), .O(new_n156_));
  inv1   g101(.a(new_n156_), .O(new_n157_));
  inv1   g102(.a(x27), .O(new_n158_));
  inv1   g103(.a(x32), .O(new_n159_));
  inv1   g104(.a(x33), .O(new_n160_));
  nand4  g105(.a(new_n160_), .b(new_n159_), .c(new_n158_), .d(new_n114_), .O(new_n161_));
  inv1   g106(.a(new_n161_), .O(new_n162_));
  nand4  g107(.a(new_n162_), .b(new_n144_), .c(new_n157_), .d(new_n71_), .O(new_n163_));
  nand2  g108(.a(new_n163_), .b(new_n154_), .O(new_n164_));
  nand2  g109(.a(new_n164_), .b(x16), .O(new_n165_));
  inv1   g110(.a(x01), .O(new_n166_));
  aoi21  g111(.a(new_n58_), .b(new_n166_), .c(x18), .O(new_n167_));
