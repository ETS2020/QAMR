// Benchmark "FAU" written by ABC on Tue Jul  7 19:18:39 2020
...
module FAU ( 
  ...
  aoi22  g011(.a(new_n63_), .b(new_n54_), .c(new_n62_), .d(x21), .O(new_n64_));
  inv1   g012(.a(x13), .O(new_n65_));
  aoi21  g013(.a(new_n59_), .b(new_n65_), .c(x18), .O(new_n66_));
  oai21  g014(.a(new_n64_), .b(new_n59_), .c(new_n66_), .O(z02));
  inv1   g015(.a(x17), .O(new_n68_));
  inv1   g016(.a(x19), .O(new_n69_));
  inv1   g017(.a(x21), .O(new_n70_));
  nand4  g018(.a(new_n70_), .b(new_n53_), .c(new_n69_), .d(new_n68_), .O(new_n71_));
  nor2   g019(.a(x22), .b(x21), .O(new_n72_));
  aoi22  g020(.a(new_n72_), .b(new_n56_), .c(new_n71_), .d(x22), .O(new_n73_));
  ...
  nor2   g043(.a(new_n95_), .b(new_n71_), .O(new_n96_));
  ...
  nand4  g049(.a(new_n103_), .b(new_n85_), .c(new_n72_), .d(new_n56_), .O(new_n104_));
  nor2   g050(.a(x25), .b(x24), .O(new_n105_));
  nor2   g051(.a(x28), .b(x27), .O(new_n106_));
  nor2   g052(.a(x26), .b(x23), .O(new_n107_));
  nand3  g053(.a(new_n107_), .b(new_n106_), .c(new_n105_), .O(new_n108_));
  ...
  aoi21  g057(.a(new_n59_), .b(new_n111_), .c(x18), .O(new_n112_));
  oai21  g058(.a(new_n110_), .b(new_n59_), .c(new_n112_), .O(z09));
  inv1   g059(.a(x29), .O(new_n114_));
  nor3   g060(.a(x26), .b(x25), .c(x24), .O(new_n115_));
  nor3   g061(.a(x29), .b(x28), .c(x27), .O(new_n116_));
  nand4  g062(.a(new_n116_), .b(new_n115_), .c(new_n78_), .d(new_n56_), .O(new_n117_));
  oai21  g063(.a(new_n109_), .b(new_n114_), .c(new_n117_), .O(new_n118_));
  nand2  g064(.a(new_n118_), .b(x16), .O(new_n119_));
  inv1   g065(.a(x05), .O(new_n120_));
  aoi21  g066(.a(new_n59_), .b(new_n120_), .c(x18), .O(new_n121_));
  nand2  g067(.a(new_n121_), .b(new_n119_), .O(z10));
  nor2   g068(.a(x23), .b(x22), .O(new_n123_));
  nand4  g069(.a(new_n123_), .b(new_n54_), .c(new_n70_), .d(new_n53_), .O(new_n124_));
  nor2   g070(.a(x26), .b(x25), .O(new_n125_));
  nor2   g071(.a(x30), .b(x29), .O(new_n126_));
  nand4  g072(.a(new_n126_), .b(new_n125_), .c(new_n106_), .d(new_n83_), .O(new_n127_));
  nor2   g073(.a(new_n127_), .b(new_n124_), .O(new_n128_));
  aoi21  g074(.a(new_n117_), .b(x30), .c(new_n128_), .O(new_n129_));
  inv1   g075(.a(x04), .O(new_n130_));
  aoi21  g076(.a(new_n59_), .b(new_n130_), .c(x18), .O(new_n131_));
  oai21  g077(.a(new_n129_), .b(new_n59_), .c(new_n131_), .O(z11));
  ...
  nand3  g083(.a(new_n137_), .b(new_n103_), .c(new_n87_), .O(new_n138_));
  nand2  g084(.a(new_n138_), .b(new_n133_), .O(new_n139_));
  nand2  g085(.a(new_n139_), .b(x16), .O(new_n140_));
  inv1   g086(.a(x03), .O(new_n141_));
  aoi21  g087(.a(new_n59_), .b(new_n141_), .c(x18), .O(new_n142_));
  nand2  g088(.a(new_n142_), .b(new_n140_), .O(z12));
  nor2   g089(.a(x27), .b(x26), .O(new_n144_));
  nand4  g090(.a(new_n135_), .b(new_n134_), .c(new_n144_), .d(new_n94_), .O(new_n145_));
  oai21  g091(.a(new_n145_), .b(new_n86_), .c(x32), .O(new_n146_));
  nor2   g092(.a(x32), .b(x31), .O(new_n147_));
  nand4  g093(.a(new_n147_), .b(new_n126_), .c(new_n125_), .d(new_n106_), .O(new_n148_));
  inv1   g094(.a(new_n148_), .O(new_n149_));
  nand2  g095(.a(new_n149_), .b(new_n87_), .O(new_n150_));
  nand2  g096(.a(new_n150_), .b(new_n146_), .O(new_n151_));
  nand2  g097(.a(new_n151_), .b(x16), .O(new_n152_));
  inv1   g098(.a(x02), .O(new_n153_));
  aoi21  g099(.a(new_n59_), .b(new_n153_), .c(x18), .O(new_n154_));
  nand2  g100(.a(new_n154_), .b(new_n152_), .O(z13));
  oai21  g101(.a(new_n148_), .b(new_n86_), .c(x33), .O(new_n156_));
  nor2   g102(.a(x33), .b(x32), .O(new_n157_));
  nand4  g103(.a(new_n157_), .b(new_n135_), .c(new_n134_), .d(new_n144_), .O(new_n158_));
  inv1   g104(.a(new_n158_), .O(new_n159_));
  nand2  g105(.a(new_n159_), .b(new_n96_), .O(new_n160_));
  nand2  g106(.a(new_n160_), .b(new_n156_), .O(new_n161_));
  nand2  g107(.a(new_n161_), .b(x16), .O(new_n162_));
  inv1   g108(.a(x01), .O(new_n163_));
  aoi21  g109(.a(new_n59_), .b(new_n163_), .c(x18), .O(new_n164_));
  nand2  g110(.a(new_n164_), .b(new_n162_), .O(z14));
  nand4  g111(.a(new_n105_), .b(new_n123_), .c(new_n63_), .d(new_n54_), .O(new_n166_));
  oai21  g112(.a(new_n158_), .b(new_n166_), .c(x34), .O(new_n167_));
  nand2  g113(.a(new_n134_), .b(new_n144_), .O(new_n168_));
