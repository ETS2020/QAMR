...
module FAU ( 
  ...
  nand4  g070(.a(new_n122_), .b(new_n102_), .c(new_n121_), .d(new_n91_), .O(new_n123_));
  ...
  nand4  g087(.a(new_n139_), .b(new_n122_), .c(new_n138_), .d(new_n92_), .O(new_n140_));
  ...
  nand2  g108(.a(new_n139_), .b(new_n122_), .O(new_n161_));
  inv1   g109(.a(new_n161_), .O(new_n162_));
  inv1   g110(.a(x31), .O(new_n163_));
  inv1   g111(.a(x32), .O(new_n164_));
  nand4  g112(.a(new_n164_), .b(new_n163_), .c(new_n121_), .d(new_n93_), .O(new_n165_));
  inv1   g113(.a(new_n165_), .O(new_n166_));
  nand4  g114(.a(new_n166_), .b(new_n162_), .c(new_n148_), .d(new_n63_), .O(new_n167_));
  nand2  g115(.a(new_n167_), .b(new_n160_), .O(new_n168_));
  nand2  g116(.a(new_n168_), .b(x16), .O(new_n169_));
  inv1   g117(.a(x02), .O(new_n170_));
  aoi21  g118(.a(new_n58_), .b(new_n170_), .c(x18), .O(new_n171_));
  nand2  g119(.a(new_n171_), .b(new_n169_), .O(z13));
  nor2   g120(.a(x33), .b(x32), .O(new_n174_));
  nand4  g121(.a(new_n174_), .b(new_n150_), .c(new_n149_), .d(new_n112_), .O(new_n175_));
  oai21  g122(.a(new_n175_), .b(new_n103_), .c(x34), .O(new_n176_));
  nand2  g123(.a(new_n149_), .b(new_n112_), .O(new_n177_));
  inv1   g124(.a(new_n177_), .O(new_n178_));
  inv1   g125(.a(x30), .O(new_n179_));
  nand2  g126(.a(new_n163_), .b(new_n179_), .O(new_n180_));
  inv1   g127(.a(x33), .O(new_n181_));
  inv1   g128(.a(x34), .O(new_n182_));
  nand3  g129(.a(new_n182_), .b(new_n181_), .c(new_n164_), .O(new_n183_));
  nor2   g130(.a(new_n183_), .b(new_n180_), .O(new_n184_));
  nand3  g131(.a(new_n184_), .b(new_n178_), .c(new_n95_), .O(new_n185_));
  nand2  g132(.a(new_n185_), .b(new_n176_), .O(new_n186_));
