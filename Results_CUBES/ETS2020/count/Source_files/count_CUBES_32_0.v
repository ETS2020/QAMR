...
module FAU ( 
  ...
  nand4  g083(.a(new_n138_), .b(new_n137_), .c(new_n107_), .d(new_n89_), .O(new_n139_));
  oai21  g084(.a(new_n139_), .b(new_n81_), .c(x32), .O(new_n140_));
  nor2   g085(.a(x32), .b(x31), .O(new_n141_));
  nand4  g086(.a(new_n141_), .b(new_n129_), .c(new_n117_), .d(new_n128_), .O(new_n142_));
  inv1   g087(.a(new_n142_), .O(new_n143_));
  nand2  g088(.a(new_n143_), .b(new_n82_), .O(new_n144_));
  ...
  oai21  g094(.a(new_n142_), .b(new_n81_), .c(x33), .O(new_n150_));
  nor2   g095(.a(x33), .b(x32), .O(new_n151_));
  nand4  g096(.a(new_n151_), .b(new_n138_), .c(new_n137_), .d(new_n107_), .O(new_n152_));
  inv1   g097(.a(new_n152_), .O(new_n153_));
  nand2  g098(.a(new_n153_), .b(new_n91_), .O(new_n154_));
  ...
  nand4  g104(.a(new_n116_), .b(new_n98_), .c(new_n97_), .d(new_n55_), .O(new_n160_));
  oai21  g105(.a(new_n152_), .b(new_n160_), .c(x34), .O(new_n161_));
  nand2  g106(.a(new_n137_), .b(new_n107_), .O(new_n162_));
  ...
  nand3  g116(.a(new_n171_), .b(new_n163_), .c(new_n91_), .O(new_n172_));
