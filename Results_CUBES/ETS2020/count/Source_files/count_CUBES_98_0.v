...
module FAU ( 
  ...
  inv1   g089(.a(x31), .O(new_n145_));
  inv1   g090(.a(x32), .O(new_n146_));
  nand4  g091(.a(new_n146_), .b(new_n145_), .c(new_n92_), .d(new_n85_), .O(new_n147_));
  inv1   g092(.a(new_n147_), .O(new_n148_));
  nand4  g093(.a(new_n148_), .b(new_n144_), .c(new_n142_), .d(new_n63_), .O(new_n149_));
  nand2  g094(.a(new_n149_), .b(new_n140_), .O(new_n150_));
  nand2  g095(.a(new_n150_), .b(x16), .O(new_n151_));
  inv1   g096(.a(x02), .O(new_n152_));
  aoi21  g097(.a(new_n58_), .b(new_n152_), .c(x18), .O(new_n153_));
  nand2  g098(.a(new_n153_), .b(new_n151_), .O(z13));
  nand4  g099(.a(new_n111_), .b(new_n94_), .c(new_n93_), .d(new_n55_), .O(new_n156_));
  nor2   g100(.a(x33), .b(x32), .O(new_n157_));
  nand4  g101(.a(new_n157_), .b(new_n138_), .c(new_n137_), .d(new_n102_), .O(new_n158_));
  oai21  g102(.a(new_n158_), .b(new_n156_), .c(x34), .O(new_n159_));
  nand2  g103(.a(new_n137_), .b(new_n102_), .O(new_n160_));
  inv1   g104(.a(new_n160_), .O(new_n161_));
  inv1   g105(.a(x30), .O(new_n162_));
  nand2  g106(.a(new_n145_), .b(new_n162_), .O(new_n163_));
  inv1   g107(.a(x33), .O(new_n164_));
  inv1   g108(.a(x34), .O(new_n165_));
  nand3  g109(.a(new_n165_), .b(new_n164_), .c(new_n146_), .O(new_n166_));
  nor2   g110(.a(new_n166_), .b(new_n163_), .O(new_n167_));
  nand3  g111(.a(new_n167_), .b(new_n161_), .c(new_n87_), .O(new_n168_));
  nand2  g112(.a(new_n168_), .b(new_n159_), .O(new_n169_));
