...
module FAU ( 
  ...
  nand4  g079(.a(new_n134_), .b(new_n133_), .c(new_n106_), .d(new_n89_), .O(new_n135_));
  oai21  g080(.a(new_n135_), .b(new_n81_), .c(x32), .O(new_n136_));
  nor2   g081(.a(x26), .b(x25), .O(new_n137_));
  nor2   g082(.a(x30), .b(x29), .O(new_n138_));
  nor2   g083(.a(x32), .b(x31), .O(new_n139_));
  nand4  g084(.a(new_n139_), .b(new_n138_), .c(new_n116_), .d(new_n137_), .O(new_n140_));
  inv1   g085(.a(new_n140_), .O(new_n141_));
  nand2  g086(.a(new_n141_), .b(new_n82_), .O(new_n142_));
  nand2  g087(.a(new_n142_), .b(new_n136_), .O(new_n143_));
  nand2  g088(.a(new_n143_), .b(x16), .O(new_n144_));
  inv1   g089(.a(x02), .O(new_n145_));
  aoi21  g090(.a(new_n58_), .b(new_n145_), .c(x18), .O(new_n146_));
  nand2  g091(.a(new_n146_), .b(new_n144_), .O(z13));
  oai21  g092(.a(new_n140_), .b(new_n81_), .c(x33), .O(new_n148_));
  nor2   g093(.a(x33), .b(x32), .O(new_n149_));
  nand4  g094(.a(new_n149_), .b(new_n134_), .c(new_n133_), .d(new_n106_), .O(new_n150_));
  inv1   g095(.a(new_n150_), .O(new_n151_));
  nand2  g096(.a(new_n151_), .b(new_n91_), .O(new_n152_));
  ...
  nand4  g102(.a(new_n115_), .b(new_n98_), .c(new_n97_), .d(new_n55_), .O(new_n158_));
  oai21  g103(.a(new_n150_), .b(new_n158_), .c(x34), .O(new_n159_));
  nand2  g104(.a(new_n133_), .b(new_n106_), .O(new_n160_));
  ...
  nand3  g114(.a(new_n169_), .b(new_n161_), .c(new_n91_), .O(new_n170_));
  nand2  g115(.a(new_n170_), .b(new_n159_), .O(new_n171_));
