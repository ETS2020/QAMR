// Benchmark "FAU" written by ABC on Tue Jul  7 19:20:44 2020
...
module FAU ( 
  ...
  nand4  g056(.a(new_n110_), .b(new_n82_), .c(new_n73_), .d(new_n72_), .O(new_n111_));
  nor2   g057(.a(x28), .b(x27), .O(new_n112_));
  nor2   g058(.a(x26), .b(x23), .O(new_n113_));
  nand3  g059(.a(new_n113_), .b(new_n112_), .c(new_n92_), .O(new_n114_));
  ...
  nand4  g067(.a(new_n121_), .b(new_n95_), .c(new_n75_), .d(new_n72_), .O(new_n122_));
  ...
  nand4  g073(.a(new_n91_), .b(new_n55_), .c(new_n64_), .d(new_n62_), .O(new_n128_));
  nor2   g074(.a(x26), .b(x25), .O(new_n129_));
  nor2   g075(.a(x30), .b(x29), .O(new_n130_));
  nand4  g076(.a(new_n130_), .b(new_n112_), .c(new_n129_), .d(new_n80_), .O(new_n131_));
  ...
  nand3  g087(.a(new_n141_), .b(new_n110_), .c(new_n84_), .O(new_n142_));
  ...
  nand4  g093(.a(new_n139_), .b(new_n138_), .c(new_n103_), .d(new_n102_), .O(new_n148_));
  oai21  g094(.a(new_n148_), .b(new_n83_), .c(x32), .O(new_n149_));
  nor2   g095(.a(x32), .b(x31), .O(new_n150_));
  nand4  g096(.a(new_n150_), .b(new_n130_), .c(new_n112_), .d(new_n129_), .O(new_n151_));
  inv1   g097(.a(new_n151_), .O(new_n152_));
  nand2  g098(.a(new_n152_), .b(new_n84_), .O(new_n153_));
  ...
  oai21  g104(.a(new_n151_), .b(new_n83_), .c(x33), .O(new_n159_));
  inv1   g105(.a(x22), .O(new_n160_));
  inv1   g106(.a(x23), .O(new_n161_));
  nand4  g107(.a(new_n102_), .b(new_n80_), .c(new_n161_), .d(new_n160_), .O(new_n162_));
  nor2   g108(.a(new_n162_), .b(new_n65_), .O(new_n163_));
  nor2   g109(.a(x33), .b(x32), .O(new_n164_));
  nand4  g110(.a(new_n164_), .b(new_n139_), .c(new_n138_), .d(new_n103_), .O(new_n165_));
  ...
  oai21  g118(.a(new_n165_), .b(new_n93_), .c(x34), .O(new_n173_));
  nand2  g119(.a(new_n138_), .b(new_n103_), .O(new_n174_));
