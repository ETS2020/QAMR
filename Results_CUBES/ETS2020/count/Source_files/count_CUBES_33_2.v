...
module FAU ( 
  ...
  nand4  g084(.a(new_n137_), .b(new_n120_), .c(new_n136_), .d(new_n80_), .O(new_n138_));
  ...
  nand4  g106(.a(new_n159_), .b(new_n158_), .c(new_n119_), .d(new_n91_), .O(new_n160_));
  nor2   g107(.a(new_n160_), .b(new_n157_), .O(new_n161_));
  nand2  g108(.a(new_n161_), .b(new_n84_), .O(new_n162_));
  ...
  oai21  g116(.a(new_n170_), .b(new_n101_), .c(x34), .O(new_n171_));
  ...
  nand3  g125(.a(new_n179_), .b(new_n173_), .c(new_n93_), .O(new_n180_));
