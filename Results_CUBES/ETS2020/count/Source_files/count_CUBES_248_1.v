...
module FAU ( 
  ...
  nand2  g031(.a(new_n76_), .b(new_n63_), .O(new_n83_));
  ...
  nand4  g062(.a(new_n115_), .b(new_n90_), .c(new_n76_), .d(new_n63_), .O(new_n116_));
  nor2   g063(.a(x28), .b(x27), .O(new_n117_));
  nor2   g064(.a(x26), .b(x23), .O(new_n118_));
  nand3  g065(.a(new_n118_), .b(new_n117_), .c(new_n104_), .O(new_n119_));
  inv1   g066(.a(new_n119_), .O(new_n120_));
  aoi22  g067(.a(new_n120_), .b(new_n78_), .c(new_n116_), .d(x28), .O(new_n121_));
  ...
  nand4  g072(.a(new_n126_), .b(new_n107_), .c(new_n84_), .d(new_n63_), .O(new_n127_));
  nand4  g073(.a(new_n103_), .b(new_n55_), .c(new_n69_), .d(new_n61_), .O(new_n128_));
  nor2   g074(.a(x26), .b(x25), .O(new_n129_));
  nor2   g075(.a(x30), .b(x29), .O(new_n130_));
  nand4  g076(.a(new_n130_), .b(new_n117_), .c(new_n129_), .d(new_n94_), .O(new_n131_));
  ...
  nand2  g083(.a(new_n90_), .b(new_n76_), .O(new_n138_));
  ...
  nand4  g089(.a(new_n143_), .b(new_n115_), .c(new_n139_), .d(new_n63_), .O(new_n144_));
  nand2  g090(.a(new_n144_), .b(new_n137_), .O(new_n145_));
  nand2  g091(.a(new_n145_), .b(x16), .O(new_n146_));
  inv1   g092(.a(x03), .O(new_n147_));
  aoi21  g093(.a(new_n58_), .b(new_n147_), .c(x18), .O(new_n148_));
  nand2  g094(.a(new_n148_), .b(new_n146_), .O(z12));
  nor2   g095(.a(x32), .b(x31), .O(new_n151_));
  nand4  g096(.a(new_n151_), .b(new_n130_), .c(new_n117_), .d(new_n129_), .O(new_n152_));
  oai21  g097(.a(new_n152_), .b(new_n91_), .c(x33), .O(new_n153_));
  nor2   g098(.a(x27), .b(x26), .O(new_n154_));
  nor2   g099(.a(x33), .b(x32), .O(new_n155_));
  nand4  g100(.a(new_n155_), .b(new_n141_), .c(new_n140_), .d(new_n154_), .O(new_n156_));
  inv1   g101(.a(new_n156_), .O(new_n157_));
  nand2  g102(.a(new_n157_), .b(new_n97_), .O(new_n158_));
  nand2  g103(.a(new_n158_), .b(new_n153_), .O(new_n159_));
  ...
  oai21  g108(.a(new_n156_), .b(new_n105_), .c(x34), .O(new_n164_));
  nand2  g109(.a(new_n140_), .b(new_n154_), .O(new_n165_));
  ...
  nand3  g119(.a(new_n174_), .b(new_n166_), .c(new_n97_), .O(new_n175_));
