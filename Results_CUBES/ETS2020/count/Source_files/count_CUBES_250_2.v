// Benchmark "FAU" written by ABC on Tue Jul  7 19:21:10 2020
...
module FAU ( 
  ...
  nand4  g052(.a(new_n107_), .b(new_n106_), .c(new_n105_), .d(new_n94_), .O(new_n108_));
  oai21  g053(.a(new_n108_), .b(new_n78_), .c(x29), .O(new_n109_));
  nor3   g054(.a(x26), .b(x25), .c(x24), .O(new_n110_));
  nor3   g055(.a(x29), .b(x28), .c(x27), .O(new_n111_));
  nand4  g056(.a(new_n111_), .b(new_n110_), .c(new_n79_), .d(new_n63_), .O(new_n112_));
  nand2  g057(.a(new_n112_), .b(new_n109_), .O(new_n113_));
  ...
  nor2   g062(.a(x23), .b(x22), .O(new_n118_));
  nand4  g063(.a(new_n118_), .b(new_n55_), .c(new_n69_), .d(new_n61_), .O(new_n119_));
  nor2   g064(.a(x26), .b(x25), .O(new_n120_));
  nor2   g065(.a(x30), .b(x29), .O(new_n121_));
  nand4  g066(.a(new_n121_), .b(new_n120_), .c(new_n107_), .d(new_n84_), .O(new_n122_));
  ...
  nor2   g073(.a(x27), .b(x26), .O(new_n130_));
  nor2   g074(.a(x31), .b(x30), .O(new_n131_));
  nand4  g075(.a(new_n131_), .b(new_n130_), .c(new_n129_), .d(new_n95_), .O(new_n132_));
  oai21  g076(.a(new_n132_), .b(new_n87_), .c(x32), .O(new_n133_));
  nand4  g077(.a(new_n84_), .b(new_n94_), .c(new_n93_), .d(new_n69_), .O(new_n134_));
  inv1   g078(.a(new_n134_), .O(new_n135_));
  inv1   g079(.a(x27), .O(new_n136_));
  inv1   g080(.a(x28), .O(new_n137_));
  ...
  inv1   g085(.a(x29), .O(new_n142_));
  inv1   g086(.a(x30), .O(new_n143_));
  nand4  g087(.a(new_n143_), .b(new_n142_), .c(new_n105_), .d(new_n95_), .O(new_n144_));
  inv1   g088(.a(new_n144_), .O(new_n145_));
  nand4  g089(.a(new_n145_), .b(new_n141_), .c(new_n135_), .d(new_n63_), .O(new_n146_));
  nand2  g090(.a(new_n146_), .b(new_n133_), .O(new_n147_));
  ...
  nor2   g095(.a(x32), .b(x31), .O(new_n152_));
  nand4  g096(.a(new_n152_), .b(new_n121_), .c(new_n120_), .d(new_n107_), .O(new_n153_));
  oai21  g097(.a(new_n153_), .b(new_n87_), .c(x33), .O(new_n154_));
  nand4  g098(.a(new_n138_), .b(new_n143_), .c(new_n136_), .d(new_n105_), .O(new_n155_));
  inv1   g099(.a(new_n155_), .O(new_n156_));
  inv1   g100(.a(x33), .O(new_n157_));
  nand4  g101(.a(new_n157_), .b(new_n139_), .c(new_n142_), .d(new_n137_), .O(new_n158_));
  inv1   g102(.a(new_n158_), .O(new_n159_));
  nand4  g103(.a(new_n159_), .b(new_n156_), .c(new_n97_), .d(new_n71_), .O(new_n160_));
  nand2  g104(.a(new_n160_), .b(new_n154_), .O(new_n161_));
  nand2  g105(.a(new_n161_), .b(x16), .O(new_n162_));
  inv1   g106(.a(x01), .O(new_n163_));
  aoi21  g107(.a(new_n58_), .b(new_n163_), .c(x18), .O(new_n164_));
