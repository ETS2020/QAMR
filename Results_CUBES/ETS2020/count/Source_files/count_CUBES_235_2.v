// Benchmark "FAU" written by ABC on Tue Jul  7 19:20:55 2020
...
module FAU ( 
  ...
  nor2   g048(.a(x26), .b(x23), .O(new_n105_));
  nand3  g049(.a(new_n105_), .b(new_n104_), .c(new_n103_), .O(new_n106_));
  oai21  g050(.a(new_n106_), .b(new_n74_), .c(x29), .O(new_n107_));
  nor3   g051(.a(x29), .b(x28), .c(x27), .O(new_n108_));
  nand4  g052(.a(new_n108_), .b(new_n92_), .c(new_n75_), .d(new_n56_), .O(new_n109_));
  nand2  g053(.a(new_n109_), .b(new_n107_), .O(new_n110_));
  nand2  g054(.a(new_n110_), .b(x16), .O(new_n111_));
  inv1   g055(.a(x05), .O(new_n112_));
  aoi21  g056(.a(new_n59_), .b(new_n112_), .c(x18), .O(new_n113_));
  nand2  g057(.a(new_n113_), .b(new_n111_), .O(z10));
  nand4  g058(.a(new_n91_), .b(new_n54_), .c(new_n65_), .d(new_n53_), .O(new_n115_));
  nor2   g059(.a(x26), .b(x25), .O(new_n116_));
  nor2   g060(.a(x30), .b(x29), .O(new_n117_));
  nand4  g061(.a(new_n117_), .b(new_n103_), .c(new_n116_), .d(new_n80_), .O(new_n118_));
  nor2   g062(.a(new_n118_), .b(new_n115_), .O(new_n119_));
  aoi21  g063(.a(new_n109_), .b(x30), .c(new_n119_), .O(new_n120_));
  ...
  oai21  g067(.a(new_n118_), .b(new_n115_), .c(x31), .O(new_n124_));
  nor3   g068(.a(x27), .b(x26), .c(x25), .O(new_n125_));
  ...
  nand3  g073(.a(new_n129_), .b(new_n125_), .c(new_n84_), .O(new_n130_));
  nand2  g074(.a(new_n130_), .b(new_n124_), .O(new_n131_));
  ...
  nand4  g079(.a(new_n127_), .b(new_n126_), .c(new_n95_), .d(new_n94_), .O(new_n136_));
  oai21  g080(.a(new_n136_), .b(new_n83_), .c(x32), .O(new_n137_));
  nor2   g081(.a(x32), .b(x31), .O(new_n138_));
  nand4  g082(.a(new_n138_), .b(new_n117_), .c(new_n103_), .d(new_n116_), .O(new_n139_));
  inv1   g083(.a(new_n139_), .O(new_n140_));
  nand2  g084(.a(new_n140_), .b(new_n84_), .O(new_n141_));
  nand2  g085(.a(new_n141_), .b(new_n137_), .O(new_n142_));
  nand2  g086(.a(new_n142_), .b(x16), .O(new_n143_));
  inv1   g087(.a(x02), .O(new_n144_));
  aoi21  g088(.a(new_n59_), .b(new_n144_), .c(x18), .O(new_n145_));
  nand2  g089(.a(new_n145_), .b(new_n143_), .O(z13));
  oai21  g090(.a(new_n139_), .b(new_n83_), .c(x33), .O(new_n147_));
  inv1   g091(.a(x22), .O(new_n148_));
  inv1   g092(.a(x23), .O(new_n149_));
  nand4  g093(.a(new_n94_), .b(new_n80_), .c(new_n149_), .d(new_n148_), .O(new_n150_));
  nor2   g094(.a(new_n150_), .b(new_n66_), .O(new_n151_));
  nor2   g095(.a(x33), .b(x32), .O(new_n152_));
  nand4  g096(.a(new_n152_), .b(new_n127_), .c(new_n126_), .d(new_n95_), .O(new_n153_));
  inv1   g097(.a(new_n153_), .O(new_n154_));
  nand2  g098(.a(new_n154_), .b(new_n151_), .O(new_n155_));
  nand2  g099(.a(new_n155_), .b(new_n147_), .O(new_n156_));
  nand2  g100(.a(new_n156_), .b(x16), .O(new_n157_));
  inv1   g101(.a(x01), .O(new_n158_));
  aoi21  g102(.a(new_n59_), .b(new_n158_), .c(x18), .O(new_n159_));
  nand2  g103(.a(new_n159_), .b(new_n157_), .O(z14));
  nor2   g104(.a(x21), .b(x20), .O(new_n161_));
  nand4  g105(.a(new_n104_), .b(new_n91_), .c(new_n161_), .d(new_n54_), .O(new_n162_));
  oai21  g106(.a(new_n153_), .b(new_n162_), .c(x34), .O(new_n163_));
  nand2  g107(.a(new_n126_), .b(new_n95_), .O(new_n164_));
  inv1   g108(.a(new_n164_), .O(new_n165_));
  inv1   g109(.a(x30), .O(new_n166_));
  inv1   g110(.a(x31), .O(new_n167_));
  nand2  g111(.a(new_n167_), .b(new_n166_), .O(new_n168_));
  inv1   g112(.a(x32), .O(new_n169_));
  inv1   g113(.a(x33), .O(new_n170_));
  inv1   g114(.a(x34), .O(new_n171_));
  nand3  g115(.a(new_n171_), .b(new_n170_), .c(new_n169_), .O(new_n172_));
  nor2   g116(.a(new_n172_), .b(new_n168_), .O(new_n173_));
  nand3  g117(.a(new_n173_), .b(new_n165_), .c(new_n151_), .O(new_n174_));
  nand2  g118(.a(new_n174_), .b(new_n163_), .O(new_n175_));
  nand2  g119(.a(new_n175_), .b(x16), .O(new_n176_));
  inv1   g120(.a(x00), .O(new_n177_));
  aoi21  g121(.a(new_n59_), .b(new_n177_), .c(x18), .O(new_n178_));
  nand2  g122(.a(new_n178_), .b(new_n176_), .O(z15));
  zero   g123(.O(z00));
  zero   g124(.O(z03));
  zero   g125(.O(z06));
  zero   g126(.O(z07));
