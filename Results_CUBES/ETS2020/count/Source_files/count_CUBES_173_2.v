...
module FAU ( 
  ...
  nand3  g072(.a(new_n128_), .b(new_n101_), .c(new_n82_), .O(new_n129_));
  nand2  g073(.a(new_n129_), .b(new_n124_), .O(new_n130_));
  ...
  nand4  g081(.a(new_n137_), .b(new_n117_), .c(new_n103_), .d(new_n116_), .O(new_n138_));
  ...
  nand4  g103(.a(new_n104_), .b(new_n90_), .c(new_n89_), .d(new_n54_), .O(new_n160_));
