...
module FAU ( 
  ...
  nand4  g078(.a(new_n103_), .b(new_n55_), .c(new_n69_), .d(new_n61_), .O(new_n133_));
  nor2   g079(.a(x26), .b(x25), .O(new_n134_));
  nor2   g080(.a(x30), .b(x29), .O(new_n135_));
  nand4  g081(.a(new_n135_), .b(new_n116_), .c(new_n134_), .d(new_n84_), .O(new_n136_));
  ...
  nand3  g087(.a(new_n141_), .b(new_n113_), .c(new_n88_), .O(new_n142_));
  ...
  nand4  g093(.a(new_n139_), .b(new_n138_), .c(new_n106_), .d(new_n95_), .O(new_n148_));
  oai21  g094(.a(new_n148_), .b(new_n87_), .c(x32), .O(new_n149_));
  ...
  nand2  g098(.a(new_n152_), .b(new_n88_), .O(new_n153_));
  ...
  oai21  g104(.a(new_n151_), .b(new_n87_), .c(x33), .O(new_n159_));
  nor2   g105(.a(x33), .b(x32), .O(new_n160_));
  nand4  g106(.a(new_n160_), .b(new_n139_), .c(new_n138_), .d(new_n106_), .O(new_n161_));
  inv1   g107(.a(new_n161_), .O(new_n162_));
  nand2  g108(.a(new_n162_), .b(new_n97_), .O(new_n163_));
  ...
  nand4  g115(.a(new_n115_), .b(new_n103_), .c(new_n169_), .d(new_n55_), .O(new_n170_));
  oai21  g116(.a(new_n161_), .b(new_n170_), .c(x34), .O(new_n171_));
  nand2  g117(.a(new_n138_), .b(new_n106_), .O(new_n172_));
  ...
  nand3  g127(.a(new_n181_), .b(new_n173_), .c(new_n97_), .O(new_n182_));
