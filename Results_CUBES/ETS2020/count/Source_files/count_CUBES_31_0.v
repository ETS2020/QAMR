...
module FAU ( 
  ...
  nand4  g072(.a(new_n93_), .b(new_n55_), .c(new_n80_), .d(new_n61_), .O(new_n127_));
  nor2   g073(.a(x26), .b(x25), .O(new_n128_));
  nor2   g074(.a(x30), .b(x29), .O(new_n129_));
  nand4  g075(.a(new_n129_), .b(new_n112_), .c(new_n128_), .d(new_n84_), .O(new_n130_));
  ...
  nor2   g081(.a(x29), .b(x28), .O(new_n137_));
  nor2   g082(.a(x31), .b(x30), .O(new_n138_));
  nand4  g083(.a(new_n138_), .b(new_n137_), .c(new_n102_), .d(new_n85_), .O(new_n139_));
  oai21  g084(.a(new_n139_), .b(new_n79_), .c(x32), .O(new_n140_));
  nand2  g085(.a(new_n78_), .b(new_n70_), .O(new_n141_));
  inv1   g086(.a(new_n141_), .O(new_n142_));
  nand2  g087(.a(new_n129_), .b(new_n112_), .O(new_n143_));
  inv1   g088(.a(new_n143_), .O(new_n144_));
  nor2   g089(.a(x32), .b(x31), .O(new_n145_));
  nand2  g090(.a(new_n145_), .b(new_n128_), .O(new_n146_));
  inv1   g091(.a(new_n146_), .O(new_n147_));
  nand4  g092(.a(new_n147_), .b(new_n144_), .c(new_n142_), .d(new_n63_), .O(new_n148_));
  nand2  g093(.a(new_n148_), .b(new_n140_), .O(new_n149_));
  ...
  nand4  g098(.a(new_n145_), .b(new_n129_), .c(new_n112_), .d(new_n128_), .O(new_n154_));
  oai21  g099(.a(new_n154_), .b(new_n79_), .c(x33), .O(new_n155_));
  nor2   g100(.a(x33), .b(x32), .O(new_n156_));
  nand4  g101(.a(new_n156_), .b(new_n138_), .c(new_n137_), .d(new_n102_), .O(new_n157_));
  inv1   g102(.a(new_n157_), .O(new_n158_));
  nand2  g103(.a(new_n158_), .b(new_n87_), .O(new_n159_));
  ...
  nand4  g109(.a(new_n111_), .b(new_n94_), .c(new_n93_), .d(new_n55_), .O(new_n165_));
  oai21  g110(.a(new_n157_), .b(new_n165_), .c(x34), .O(new_n166_));
  nand2  g111(.a(new_n137_), .b(new_n102_), .O(new_n167_));
  inv1   g112(.a(new_n167_), .O(new_n168_));
  inv1   g113(.a(x30), .O(new_n169_));
  inv1   g114(.a(x31), .O(new_n170_));
  nand2  g115(.a(new_n170_), .b(new_n169_), .O(new_n171_));
  inv1   g116(.a(x32), .O(new_n172_));
  inv1   g117(.a(x33), .O(new_n173_));
  inv1   g118(.a(x34), .O(new_n174_));
  nand3  g119(.a(new_n174_), .b(new_n173_), .c(new_n172_), .O(new_n175_));
  nor2   g120(.a(new_n175_), .b(new_n171_), .O(new_n176_));
  nand3  g121(.a(new_n176_), .b(new_n168_), .c(new_n87_), .O(new_n177_));
  nand2  g122(.a(new_n177_), .b(new_n166_), .O(new_n178_));
