...
module FAU ( 
  ...
  nand4  g054(.a(new_n108_), .b(new_n101_), .c(new_n67_), .d(new_n55_), .O(new_n109_));
  ...
  nand4  g075(.a(new_n132_), .b(new_n131_), .c(new_n111_), .d(new_n130_), .O(new_n133_));
  oai21  g076(.a(new_n133_), .b(new_n82_), .c(x33), .O(new_n134_));
  nor2   g077(.a(x29), .b(x28), .O(new_n135_));
  nor2   g078(.a(x31), .b(x30), .O(new_n136_));
  nor2   g079(.a(x33), .b(x32), .O(new_n137_));
  nand4  g080(.a(new_n137_), .b(new_n136_), .c(new_n135_), .d(new_n101_), .O(new_n138_));
  inv1   g081(.a(new_n138_), .O(new_n139_));
  nand2  g082(.a(new_n139_), .b(new_n92_), .O(new_n140_));
  ...
  nor2   g088(.a(x21), .b(x20), .O(new_n146_));
  nand4  g089(.a(new_n110_), .b(new_n98_), .c(new_n146_), .d(new_n72_), .O(new_n147_));
  oai21  g090(.a(new_n138_), .b(new_n147_), .c(x34), .O(new_n148_));
  nand2  g091(.a(new_n135_), .b(new_n101_), .O(new_n149_));
  ...
  nand3  g101(.a(new_n158_), .b(new_n150_), .c(new_n92_), .O(new_n159_));
  nand2  g102(.a(new_n159_), .b(new_n148_), .O(new_n160_));
  nand2  g103(.a(new_n160_), .b(x16), .O(new_n161_));
  inv1   g104(.a(x00), .O(new_n162_));
  aoi21  g105(.a(new_n54_), .b(new_n162_), .c(x18), .O(new_n163_));
