// Benchmark "FAU" written by ABC on Tue Jul  7 19:18:08 2020
...
module FAU ( 
  ...
  nand4  g052(.a(new_n106_), .b(new_n85_), .c(new_n76_), .d(new_n63_), .O(new_n107_));
  nand3  g053(.a(new_n76_), .b(new_n55_), .c(new_n61_), .O(new_n108_));
  nor2   g054(.a(x28), .b(x27), .O(new_n109_));
  nor2   g055(.a(x26), .b(x23), .O(new_n110_));
  nand3  g056(.a(new_n110_), .b(new_n109_), .c(new_n95_), .O(new_n111_));
  nor2   g057(.a(new_n111_), .b(new_n108_), .O(new_n112_));
  ...
  nand4  g063(.a(new_n118_), .b(new_n98_), .c(new_n83_), .d(new_n63_), .O(new_n119_));
  nand4  g064(.a(new_n94_), .b(new_n55_), .c(new_n69_), .d(new_n61_), .O(new_n120_));
  nor2   g065(.a(x26), .b(x25), .O(new_n121_));
  nor2   g066(.a(x30), .b(x29), .O(new_n122_));
  nand4  g067(.a(new_n122_), .b(new_n109_), .c(new_n121_), .d(new_n82_), .O(new_n123_));
  ...
  nand4  g085(.a(new_n141_), .b(new_n122_), .c(new_n109_), .d(new_n121_), .O(new_n142_));
  ...
  nand4  g090(.a(new_n146_), .b(new_n82_), .c(new_n145_), .d(new_n144_), .O(new_n147_));
  nor2   g091(.a(new_n147_), .b(new_n70_), .O(new_n148_));
