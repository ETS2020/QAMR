...
module FAU ( 
  ...
  nand4  g083(.a(new_n137_), .b(new_n136_), .c(new_n104_), .d(new_n103_), .O(new_n138_));
  oai21  g084(.a(new_n138_), .b(new_n86_), .c(x32), .O(new_n139_));
  inv1   g085(.a(x22), .O(new_n140_));
  nand4  g086(.a(new_n127_), .b(new_n113_), .c(new_n140_), .d(new_n125_), .O(new_n141_));
  inv1   g087(.a(new_n141_), .O(new_n142_));
  inv1   g088(.a(x28), .O(new_n143_));
  inv1   g089(.a(x29), .O(new_n144_));
  inv1   g090(.a(x30), .O(new_n145_));
  nand4  g091(.a(new_n145_), .b(new_n144_), .c(new_n143_), .d(new_n103_), .O(new_n146_));
  inv1   g092(.a(new_n146_), .O(new_n147_));
  inv1   g093(.a(x25), .O(new_n148_));
  inv1   g094(.a(x31), .O(new_n149_));
  inv1   g095(.a(x32), .O(new_n150_));
  nand4  g096(.a(new_n150_), .b(new_n149_), .c(new_n114_), .d(new_n148_), .O(new_n151_));
  inv1   g097(.a(new_n151_), .O(new_n152_));
  nand4  g098(.a(new_n152_), .b(new_n147_), .c(new_n142_), .d(new_n60_), .O(new_n153_));
  nand2  g099(.a(new_n153_), .b(new_n139_), .O(new_n154_));
