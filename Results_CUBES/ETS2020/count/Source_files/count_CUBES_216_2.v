...
module FAU ( 
  ...
  nand2  g095(.a(new_n130_), .b(new_n113_), .O(new_n150_));
  inv1   g096(.a(x31), .O(new_n151_));
  inv1   g097(.a(x32), .O(new_n152_));
  nand4  g098(.a(new_n152_), .b(new_n151_), .c(new_n111_), .d(new_n90_), .O(new_n153_));
  ...
  nand4  g107(.a(new_n112_), .b(new_n98_), .c(new_n162_), .d(new_n55_), .O(new_n163_));
  nor2   g108(.a(x33), .b(x32), .O(new_n164_));
  nand4  g109(.a(new_n164_), .b(new_n139_), .c(new_n138_), .d(new_n102_), .O(new_n165_));
  oai21  g110(.a(new_n165_), .b(new_n163_), .c(x34), .O(new_n166_));
  nand2  g111(.a(new_n138_), .b(new_n102_), .O(new_n167_));
  inv1   g112(.a(new_n167_), .O(new_n168_));
  inv1   g113(.a(x30), .O(new_n169_));
  nand2  g114(.a(new_n151_), .b(new_n169_), .O(new_n170_));
  inv1   g115(.a(x33), .O(new_n171_));
  inv1   g116(.a(x34), .O(new_n172_));
  nand3  g117(.a(new_n172_), .b(new_n171_), .c(new_n152_), .O(new_n173_));
