...
module FAU ( 
  ...
  wire new_n52_, new_n53_, new_n54_, new_n55_, new_n56_, new_n57_, new_n58_,
    ...
    new_n134_, new_n139_, new_n140_, new_n141_, new_n142_, new_n143_,
  ...
  nor3   g064(.a(x25), .b(x24), .c(x23), .O(new_n117_));
  nand4  g065(.a(new_n117_), .b(new_n110_), .c(new_n72_), .d(new_n62_), .O(new_n118_));
  ...
  nand4  g086(.a(new_n141_), .b(new_n140_), .c(new_n121_), .d(new_n139_), .O(new_n142_));
  ...
  inv1   g095(.a(x28), .O(new_n151_));
  inv1   g096(.a(x29), .O(new_n152_));
  nand4  g097(.a(new_n152_), .b(new_n151_), .c(new_n150_), .d(new_n119_), .O(new_n153_));
  inv1   g098(.a(new_n153_), .O(new_n154_));
  nand4  g099(.a(new_n154_), .b(new_n149_), .c(new_n96_), .d(new_n67_), .O(new_n155_));
  nand2  g100(.a(new_n155_), .b(new_n143_), .O(new_n156_));
