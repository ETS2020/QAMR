...
module FAU ( 
  ...
  nand4  g062(.a(new_n118_), .b(new_n96_), .c(new_n75_), .d(new_n56_), .O(new_n119_));
  nand4  g063(.a(new_n95_), .b(new_n54_), .c(new_n65_), .d(new_n53_), .O(new_n120_));
  nor2   g064(.a(x26), .b(x25), .O(new_n121_));
  nor2   g065(.a(x30), .b(x29), .O(new_n122_));
  nand4  g066(.a(new_n122_), .b(new_n110_), .c(new_n121_), .d(new_n74_), .O(new_n123_));
  nor2   g067(.a(new_n123_), .b(new_n120_), .O(new_n124_));
  aoi21  g068(.a(new_n119_), .b(x30), .c(new_n124_), .O(new_n125_));
  ...
  nand3  g077(.a(new_n133_), .b(new_n106_), .c(new_n80_), .O(new_n134_));
  ...
  nand4  g083(.a(new_n131_), .b(new_n130_), .c(new_n99_), .d(new_n87_), .O(new_n140_));
  oai21  g084(.a(new_n140_), .b(new_n79_), .c(x32), .O(new_n141_));
  nand2  g085(.a(new_n122_), .b(new_n110_), .O(new_n142_));
  inv1   g086(.a(x31), .O(new_n143_));
  inv1   g087(.a(x32), .O(new_n144_));
  nand4  g088(.a(new_n144_), .b(new_n143_), .c(new_n108_), .d(new_n87_), .O(new_n145_));
  nor2   g089(.a(new_n145_), .b(new_n142_), .O(new_n146_));
  nand2  g090(.a(new_n146_), .b(new_n80_), .O(new_n147_));
  ...
  nand4  g097(.a(new_n109_), .b(new_n95_), .c(new_n154_), .d(new_n54_), .O(new_n155_));
  nor2   g098(.a(x33), .b(x32), .O(new_n156_));
  nand4  g099(.a(new_n156_), .b(new_n131_), .c(new_n130_), .d(new_n99_), .O(new_n157_));
  oai21  g100(.a(new_n157_), .b(new_n155_), .c(x34), .O(new_n158_));
  nand2  g101(.a(new_n130_), .b(new_n99_), .O(new_n159_));
  inv1   g102(.a(new_n159_), .O(new_n160_));
  inv1   g103(.a(x30), .O(new_n161_));
  nand2  g104(.a(new_n143_), .b(new_n161_), .O(new_n162_));
  inv1   g105(.a(x33), .O(new_n163_));
  inv1   g106(.a(x34), .O(new_n164_));
  nand3  g107(.a(new_n164_), .b(new_n163_), .c(new_n144_), .O(new_n165_));
