...
module FAU ( 
  ...
  nand4  g062(.a(new_n115_), .b(new_n86_), .c(new_n77_), .d(new_n63_), .O(new_n116_));
  inv1   g063(.a(x26), .O(new_n117_));
  nor2   g064(.a(x28), .b(x27), .O(new_n118_));
  nand4  g065(.a(new_n118_), .b(new_n104_), .c(new_n117_), .d(new_n94_), .O(new_n119_));
  nor2   g066(.a(new_n119_), .b(new_n78_), .O(new_n120_));
  ...
  nand4  g073(.a(new_n126_), .b(new_n107_), .c(new_n79_), .d(new_n63_), .O(new_n127_));
  ...
  nand4  g079(.a(new_n103_), .b(new_n55_), .c(new_n69_), .d(new_n61_), .O(new_n133_));
  nor2   g080(.a(x26), .b(x25), .O(new_n134_));
  nor2   g081(.a(x30), .b(x29), .O(new_n135_));
  nand4  g082(.a(new_n135_), .b(new_n118_), .c(new_n134_), .d(new_n84_), .O(new_n136_));
  ...
  nand3  g093(.a(new_n146_), .b(new_n115_), .c(new_n88_), .O(new_n147_));
  ...
  nand4  g100(.a(new_n144_), .b(new_n143_), .c(new_n153_), .d(new_n95_), .O(new_n154_));
  oai21  g101(.a(new_n154_), .b(new_n87_), .c(x32), .O(new_n155_));
  nand2  g102(.a(new_n135_), .b(new_n118_), .O(new_n156_));
  inv1   g103(.a(x31), .O(new_n157_));
  inv1   g104(.a(x32), .O(new_n158_));
  nand4  g105(.a(new_n158_), .b(new_n157_), .c(new_n117_), .d(new_n95_), .O(new_n159_));
  nor2   g106(.a(new_n159_), .b(new_n156_), .O(new_n160_));
  nand2  g107(.a(new_n160_), .b(new_n88_), .O(new_n161_));
  ...
  nand4  g114(.a(new_n168_), .b(new_n144_), .c(new_n143_), .d(new_n153_), .O(new_n169_));
  oai21  g115(.a(new_n169_), .b(new_n105_), .c(x34), .O(new_n170_));
  nand2  g116(.a(new_n143_), .b(new_n153_), .O(new_n171_));
  ...
  nand3  g124(.a(new_n178_), .b(new_n172_), .c(new_n97_), .O(new_n179_));
