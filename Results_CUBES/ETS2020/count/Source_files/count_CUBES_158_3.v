// Benchmark "FAU" written by ABC on Tue Jul  7 19:19:39 2020
...
module FAU ( 
  ...
  nand4  g037(.a(new_n91_), .b(new_n90_), .c(new_n89_), .d(new_n54_), .O(new_n92_));
  nand2  g038(.a(new_n92_), .b(x26), .O(new_n93_));
  nor3   g039(.a(x26), .b(x25), .c(x24), .O(new_n94_));
  nand3  g040(.a(new_n94_), .b(new_n90_), .c(new_n67_), .O(new_n95_));
  ...
  nand4  g056(.a(new_n112_), .b(new_n94_), .c(new_n79_), .d(new_n56_), .O(new_n113_));
  nand4  g057(.a(new_n90_), .b(new_n54_), .c(new_n65_), .d(new_n53_), .O(new_n114_));
  nor2   g058(.a(x26), .b(x25), .O(new_n115_));
  nor2   g059(.a(x28), .b(x27), .O(new_n116_));
  nor2   g060(.a(x30), .b(x29), .O(new_n117_));
  nand4  g061(.a(new_n117_), .b(new_n116_), .c(new_n115_), .d(new_n78_), .O(new_n118_));
  nor2   g062(.a(new_n118_), .b(new_n114_), .O(new_n119_));
  aoi21  g063(.a(new_n113_), .b(x30), .c(new_n119_), .O(new_n120_));
  ...
  oai21  g067(.a(new_n118_), .b(new_n114_), .c(x31), .O(new_n124_));
  ...
  nand3  g073(.a(new_n129_), .b(new_n125_), .c(new_n83_), .O(new_n130_));
  ...
  nand4  g080(.a(new_n137_), .b(new_n117_), .c(new_n116_), .d(new_n115_), .O(new_n138_));
  oai21  g081(.a(new_n138_), .b(new_n82_), .c(x33), .O(new_n139_));
  inv1   g082(.a(x22), .O(new_n140_));
  inv1   g083(.a(x23), .O(new_n141_));
  nand4  g084(.a(new_n102_), .b(new_n78_), .c(new_n141_), .d(new_n140_), .O(new_n142_));
  nor2   g085(.a(new_n142_), .b(new_n66_), .O(new_n143_));
  nor2   g086(.a(x33), .b(x32), .O(new_n144_));
  nand4  g087(.a(new_n144_), .b(new_n127_), .c(new_n126_), .d(new_n103_), .O(new_n145_));
  ...
  oai21  g095(.a(new_n145_), .b(new_n92_), .c(x34), .O(new_n153_));
  nand2  g096(.a(new_n126_), .b(new_n103_), .O(new_n154_));
  ...
  nand3  g106(.a(new_n163_), .b(new_n155_), .c(new_n143_), .O(new_n164_));
