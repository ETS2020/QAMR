...
module FAU ( 
  ...
  inv1   g049(.a(x27), .O(new_n104_));
  nand4  g050(.a(new_n81_), .b(new_n104_), .c(new_n103_), .d(new_n91_), .O(new_n105_));
  ...
  aoi21  g054(.a(new_n59_), .b(new_n108_), .c(x18), .O(new_n109_));
  oai21  g055(.a(new_n107_), .b(new_n59_), .c(new_n109_), .O(z08));
  nor2   g056(.a(x25), .b(x24), .O(new_n112_));
  nor2   g057(.a(x28), .b(x27), .O(new_n113_));
  nand4  g058(.a(new_n113_), .b(new_n112_), .c(new_n103_), .d(new_n90_), .O(new_n114_));
  ...
  nand4  g093(.a(new_n149_), .b(new_n125_), .c(new_n113_), .d(new_n124_), .O(new_n150_));
  oai21  g094(.a(new_n150_), .b(new_n82_), .c(x33), .O(new_n151_));
  inv1   g095(.a(new_n92_), .O(new_n152_));
  inv1   g096(.a(x32), .O(new_n153_));
  inv1   g097(.a(x33), .O(new_n154_));
  nand4  g098(.a(new_n154_), .b(new_n153_), .c(new_n104_), .d(new_n103_), .O(new_n155_));
  inv1   g099(.a(new_n155_), .O(new_n156_));
  nand4  g100(.a(new_n156_), .b(new_n141_), .c(new_n152_), .d(new_n67_), .O(new_n157_));
  nand2  g101(.a(new_n157_), .b(new_n151_), .O(new_n158_));
  nand2  g102(.a(new_n158_), .b(x16), .O(new_n159_));
  inv1   g103(.a(x01), .O(new_n160_));
  aoi21  g104(.a(new_n59_), .b(new_n160_), .c(x18), .O(new_n161_));
