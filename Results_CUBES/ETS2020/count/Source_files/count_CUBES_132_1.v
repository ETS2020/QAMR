...
module FAU ( 
  ...
  nand4  g060(.a(new_n113_), .b(new_n85_), .c(new_n72_), .d(new_n62_), .O(new_n114_));
  ...
  oai21  g070(.a(new_n118_), .b(new_n77_), .c(x29), .O(new_n124_));
  nor3   g071(.a(x29), .b(x28), .c(x27), .O(new_n125_));
  nand4  g072(.a(new_n125_), .b(new_n99_), .c(new_n78_), .d(new_n62_), .O(new_n126_));
  ...
  nand4  g078(.a(new_n98_), .b(new_n55_), .c(new_n65_), .d(new_n64_), .O(new_n132_));
  nor2   g079(.a(x26), .b(x25), .O(new_n133_));
  nor2   g080(.a(x30), .b(x29), .O(new_n134_));
  nand4  g081(.a(new_n134_), .b(new_n117_), .c(new_n133_), .d(new_n83_), .O(new_n135_));
  ...
  nand4  g088(.a(new_n83_), .b(new_n94_), .c(new_n93_), .d(new_n65_), .O(new_n142_));
  ...
  nand4  g096(.a(new_n149_), .b(new_n113_), .c(new_n143_), .d(new_n62_), .O(new_n150_));
  ...
  nand4  g104(.a(new_n157_), .b(new_n156_), .c(new_n106_), .d(new_n95_), .O(new_n158_));
  oai21  g105(.a(new_n158_), .b(new_n86_), .c(x32), .O(new_n159_));
  ...
  nand4  g110(.a(new_n163_), .b(new_n147_), .c(new_n115_), .d(new_n95_), .O(new_n164_));
  inv1   g111(.a(new_n164_), .O(new_n165_));
  nand4  g112(.a(new_n165_), .b(new_n162_), .c(new_n143_), .d(new_n62_), .O(new_n166_));
  ...
  oai21  g120(.a(new_n173_), .b(new_n86_), .c(x33), .O(new_n174_));
  inv1   g121(.a(new_n96_), .O(new_n175_));
  ...
  nand4  g125(.a(new_n178_), .b(new_n149_), .c(new_n175_), .d(new_n67_), .O(new_n179_));
