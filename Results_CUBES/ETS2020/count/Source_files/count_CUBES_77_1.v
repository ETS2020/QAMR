...
module FAU ( 
  ...
  nand4  g068(.a(new_n121_), .b(new_n102_), .c(new_n82_), .d(new_n63_), .O(new_n122_));
  ...
  nand4  g074(.a(new_n98_), .b(new_n55_), .c(new_n69_), .d(new_n61_), .O(new_n128_));
  nor2   g075(.a(x26), .b(x25), .O(new_n129_));
  nor2   g076(.a(x30), .b(x29), .O(new_n130_));
  nand4  g077(.a(new_n130_), .b(new_n112_), .c(new_n129_), .d(new_n87_), .O(new_n131_));
  nor2   g078(.a(new_n131_), .b(new_n128_), .O(new_n132_));
  ...
  oai21  g082(.a(new_n133_), .b(new_n58_), .c(new_n135_), .O(z11));
  oai21  g083(.a(new_n131_), .b(new_n128_), .c(x31), .O(new_n137_));
  ...
  nand3  g088(.a(new_n141_), .b(new_n110_), .c(new_n91_), .O(new_n142_));
  nand2  g089(.a(new_n142_), .b(new_n137_), .O(new_n143_));
  ...
  nand4  g095(.a(new_n149_), .b(new_n130_), .c(new_n112_), .d(new_n129_), .O(new_n150_));
  oai21  g096(.a(new_n150_), .b(new_n90_), .c(x33), .O(new_n151_));
  inv1   g097(.a(x22), .O(new_n152_));
  inv1   g098(.a(x23), .O(new_n153_));
  inv1   g099(.a(x25), .O(new_n154_));
  nand4  g100(.a(new_n154_), .b(new_n87_), .c(new_n153_), .d(new_n152_), .O(new_n155_));
  nor2   g101(.a(new_n155_), .b(new_n70_), .O(new_n156_));
  nor2   g102(.a(x27), .b(x26), .O(new_n157_));
  nor2   g103(.a(x33), .b(x32), .O(new_n158_));
  nand4  g104(.a(new_n158_), .b(new_n139_), .c(new_n138_), .d(new_n157_), .O(new_n159_));
  inv1   g105(.a(new_n159_), .O(new_n160_));
  nand2  g106(.a(new_n160_), .b(new_n156_), .O(new_n161_));
  nand2  g107(.a(new_n161_), .b(new_n151_), .O(new_n162_));
  ...
  oai21  g112(.a(new_n159_), .b(new_n100_), .c(x34), .O(new_n167_));
  nand2  g113(.a(new_n138_), .b(new_n157_), .O(new_n168_));
  ...
  nand3  g123(.a(new_n177_), .b(new_n169_), .c(new_n156_), .O(new_n178_));
