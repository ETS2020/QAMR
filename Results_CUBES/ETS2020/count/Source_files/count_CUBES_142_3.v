// Benchmark "FAU" written by ABC on Tue Jul  7 19:19:23 2020
...
module FAU ( 
  ...
  nand3  g066(.a(new_n117_), .b(new_n89_), .c(new_n98_), .O(new_n118_));
  ...
  nand4  g073(.a(new_n126_), .b(new_n110_), .c(new_n82_), .d(new_n63_), .O(new_n127_));
  nand4  g074(.a(new_n106_), .b(new_n55_), .c(new_n69_), .d(new_n61_), .O(new_n128_));
  nor2   g075(.a(x26), .b(x25), .O(new_n129_));
  nor2   g076(.a(x28), .b(x27), .O(new_n130_));
  nor2   g077(.a(x30), .b(x29), .O(new_n131_));
  nand4  g078(.a(new_n131_), .b(new_n130_), .c(new_n129_), .d(new_n87_), .O(new_n132_));
  nor2   g079(.a(new_n132_), .b(new_n128_), .O(new_n133_));
  aoi21  g080(.a(new_n127_), .b(x30), .c(new_n133_), .O(new_n134_));
  ...
  oai21  g084(.a(new_n132_), .b(new_n128_), .c(x31), .O(new_n138_));
  ...
  nand4  g096(.a(new_n141_), .b(new_n140_), .c(new_n117_), .d(new_n98_), .O(new_n150_));
  oai21  g097(.a(new_n150_), .b(new_n90_), .c(x32), .O(new_n151_));
  nor2   g098(.a(x32), .b(x31), .O(new_n152_));
  nand4  g099(.a(new_n152_), .b(new_n131_), .c(new_n130_), .d(new_n129_), .O(new_n153_));
  ...
  nor2   g108(.a(x33), .b(x32), .O(new_n162_));
  nand4  g109(.a(new_n162_), .b(new_n141_), .c(new_n140_), .d(new_n117_), .O(new_n163_));
  inv1   g110(.a(new_n163_), .O(new_n164_));
  nand2  g111(.a(new_n164_), .b(new_n100_), .O(new_n165_));
  nand2  g112(.a(new_n165_), .b(new_n161_), .O(new_n166_));
  nand2  g113(.a(new_n166_), .b(x16), .O(new_n167_));
  inv1   g114(.a(x01), .O(new_n168_));
  aoi21  g115(.a(new_n58_), .b(new_n168_), .c(x18), .O(new_n169_));
  nand2  g116(.a(new_n169_), .b(new_n167_), .O(z14));
  oai21  g117(.a(new_n163_), .b(new_n108_), .c(x34), .O(new_n171_));
  nand2  g118(.a(new_n140_), .b(new_n117_), .O(new_n172_));
  inv1   g119(.a(new_n172_), .O(new_n173_));
  inv1   g120(.a(x30), .O(new_n174_));
  inv1   g121(.a(x31), .O(new_n175_));
  nand2  g122(.a(new_n175_), .b(new_n174_), .O(new_n176_));
  inv1   g123(.a(x32), .O(new_n177_));
  inv1   g124(.a(x33), .O(new_n178_));
  inv1   g125(.a(x34), .O(new_n179_));
  nand3  g126(.a(new_n179_), .b(new_n178_), .c(new_n177_), .O(new_n180_));
  nor2   g127(.a(new_n180_), .b(new_n176_), .O(new_n181_));
  nand3  g128(.a(new_n181_), .b(new_n173_), .c(new_n100_), .O(new_n182_));
  nand2  g129(.a(new_n182_), .b(new_n171_), .O(new_n183_));
  nand2  g130(.a(new_n183_), .b(x16), .O(new_n184_));
  inv1   g131(.a(x00), .O(new_n185_));
  aoi21  g132(.a(new_n58_), .b(new_n185_), .c(x18), .O(new_n186_));
  nand2  g133(.a(new_n186_), .b(new_n184_), .O(z15));
  zero   g134(.O(z09));
  zero   g135(.O(z10));
endmodule
