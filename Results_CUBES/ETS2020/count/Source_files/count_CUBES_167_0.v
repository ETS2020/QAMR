...
module FAU ( 
  ...
  nand4  g061(.a(new_n115_), .b(new_n95_), .c(new_n114_), .d(new_n84_), .O(new_n116_));
  ...
  nand4  g078(.a(new_n132_), .b(new_n115_), .c(new_n131_), .d(new_n85_), .O(new_n133_));
  ...
  nand2  g099(.a(new_n132_), .b(new_n115_), .O(new_n154_));
  inv1   g100(.a(new_n154_), .O(new_n155_));
  inv1   g101(.a(x31), .O(new_n156_));
  inv1   g102(.a(x32), .O(new_n157_));
  nand4  g103(.a(new_n157_), .b(new_n156_), .c(new_n114_), .d(new_n86_), .O(new_n158_));
  inv1   g104(.a(new_n158_), .O(new_n159_));
  nand4  g105(.a(new_n159_), .b(new_n155_), .c(new_n141_), .d(new_n62_), .O(new_n160_));
  ...
  nor2   g111(.a(x33), .b(x32), .O(new_n167_));
  nand4  g112(.a(new_n167_), .b(new_n143_), .c(new_n142_), .d(new_n105_), .O(new_n168_));
  oai21  g113(.a(new_n168_), .b(new_n96_), .c(x34), .O(new_n169_));
  nand2  g114(.a(new_n142_), .b(new_n105_), .O(new_n170_));
  inv1   g115(.a(new_n170_), .O(new_n171_));
  inv1   g116(.a(x30), .O(new_n172_));
  nand2  g117(.a(new_n156_), .b(new_n172_), .O(new_n173_));
  inv1   g118(.a(x33), .O(new_n174_));
  inv1   g119(.a(x34), .O(new_n175_));
  nand3  g120(.a(new_n175_), .b(new_n174_), .c(new_n157_), .O(new_n176_));
  nor2   g121(.a(new_n176_), .b(new_n173_), .O(new_n177_));
  nand3  g122(.a(new_n177_), .b(new_n171_), .c(new_n88_), .O(new_n178_));
  nand2  g123(.a(new_n178_), .b(new_n169_), .O(new_n179_));
