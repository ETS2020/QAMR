...
module FAU ( 
  ...
  nand4  g093(.a(new_n146_), .b(new_n145_), .c(new_n114_), .d(new_n98_), .O(new_n147_));
  oai21  g094(.a(new_n147_), .b(new_n90_), .c(x32), .O(new_n148_));
  nand4  g095(.a(new_n87_), .b(new_n97_), .c(new_n96_), .d(new_n69_), .O(new_n149_));
  inv1   g096(.a(new_n149_), .O(new_n150_));
  inv1   g097(.a(x27), .O(new_n151_));
  inv1   g098(.a(x28), .O(new_n152_));
  inv1   g099(.a(x29), .O(new_n153_));
  inv1   g100(.a(x30), .O(new_n154_));
  nand4  g101(.a(new_n154_), .b(new_n153_), .c(new_n152_), .d(new_n151_), .O(new_n155_));
  inv1   g102(.a(new_n155_), .O(new_n156_));
  inv1   g103(.a(x31), .O(new_n157_));
  inv1   g104(.a(x32), .O(new_n158_));
  nand4  g105(.a(new_n158_), .b(new_n157_), .c(new_n123_), .d(new_n98_), .O(new_n159_));
  inv1   g106(.a(new_n159_), .O(new_n160_));
  nand4  g107(.a(new_n160_), .b(new_n156_), .c(new_n150_), .d(new_n63_), .O(new_n161_));
  nand2  g108(.a(new_n161_), .b(new_n148_), .O(new_n162_));
  ...
  nor2   g113(.a(x32), .b(x31), .O(new_n167_));
  nand4  g114(.a(new_n167_), .b(new_n137_), .c(new_n125_), .d(new_n136_), .O(new_n168_));
  oai21  g115(.a(new_n168_), .b(new_n90_), .c(x33), .O(new_n169_));
  nand4  g116(.a(new_n157_), .b(new_n154_), .c(new_n153_), .d(new_n152_), .O(new_n170_));
  inv1   g117(.a(new_n170_), .O(new_n171_));
  inv1   g118(.a(x33), .O(new_n172_));
  nand4  g119(.a(new_n172_), .b(new_n158_), .c(new_n151_), .d(new_n123_), .O(new_n173_));
  inv1   g120(.a(new_n173_), .O(new_n174_));
  nand4  g121(.a(new_n174_), .b(new_n171_), .c(new_n100_), .d(new_n71_), .O(new_n175_));
  nand2  g122(.a(new_n175_), .b(new_n169_), .O(new_n176_));
  nand2  g123(.a(new_n176_), .b(x16), .O(new_n177_));
  inv1   g124(.a(x01), .O(new_n178_));
  aoi21  g125(.a(new_n58_), .b(new_n178_), .c(x18), .O(new_n179_));
  nand2  g126(.a(new_n179_), .b(new_n177_), .O(z14));
  zero   g127(.O(z10));
  zero   g128(.O(z12));
  zero   g129(.O(z15));
endmodule
