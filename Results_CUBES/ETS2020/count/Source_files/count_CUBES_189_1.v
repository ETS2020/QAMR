...
module FAU ( 
  ...
  nand4  g057(.a(new_n111_), .b(new_n82_), .c(new_n73_), .d(new_n62_), .O(new_n112_));
  ...
  nand4  g068(.a(new_n122_), .b(new_n103_), .c(new_n75_), .d(new_n62_), .O(new_n123_));
  ...
  nand4  g074(.a(new_n99_), .b(new_n55_), .c(new_n65_), .d(new_n64_), .O(new_n129_));
  nor2   g075(.a(x26), .b(x25), .O(new_n130_));
  nor2   g076(.a(x30), .b(x29), .O(new_n131_));
  nand4  g077(.a(new_n131_), .b(new_n113_), .c(new_n130_), .d(new_n80_), .O(new_n132_));
  ...
  nand3  g088(.a(new_n142_), .b(new_n111_), .c(new_n84_), .O(new_n143_));
  ...
  nand4  g095(.a(new_n150_), .b(new_n131_), .c(new_n113_), .d(new_n130_), .O(new_n151_));
  oai21  g096(.a(new_n151_), .b(new_n83_), .c(x33), .O(new_n152_));
  nor2   g097(.a(x27), .b(x26), .O(new_n153_));
  nor2   g098(.a(x33), .b(x32), .O(new_n154_));
  nand4  g099(.a(new_n154_), .b(new_n140_), .c(new_n139_), .d(new_n153_), .O(new_n155_));
  inv1   g100(.a(new_n155_), .O(new_n156_));
  nand2  g101(.a(new_n156_), .b(new_n93_), .O(new_n157_));
  nand2  g102(.a(new_n157_), .b(new_n152_), .O(new_n158_));
  ...
  oai21  g107(.a(new_n155_), .b(new_n101_), .c(x34), .O(new_n163_));
  nand2  g108(.a(new_n139_), .b(new_n153_), .O(new_n164_));
  ...
  nand3  g118(.a(new_n173_), .b(new_n165_), .c(new_n93_), .O(new_n174_));
