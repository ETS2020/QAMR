...
module FAU ( 
  ...
  aoi22  g051(.a(new_n102_), .b(new_n71_), .c(new_n91_), .d(x25), .O(new_n103_));
  ...
  nand4  g065(.a(new_n90_), .b(new_n116_), .c(new_n115_), .d(new_n100_), .O(new_n117_));
  ...
  nand4  g072(.a(new_n123_), .b(new_n90_), .c(new_n76_), .d(new_n63_), .O(new_n124_));
  nor2   g073(.a(x25), .b(x24), .O(new_n125_));
  nor2   g074(.a(x28), .b(x27), .O(new_n126_));
  nand4  g075(.a(new_n126_), .b(new_n125_), .c(new_n115_), .d(new_n98_), .O(new_n127_));
  ...
  nand4  g083(.a(new_n136_), .b(new_n126_), .c(new_n135_), .d(new_n99_), .O(new_n137_));
  oai21  g084(.a(new_n137_), .b(new_n84_), .c(x31), .O(new_n138_));
  nand4  g085(.a(new_n99_), .b(new_n98_), .c(new_n97_), .d(new_n69_), .O(new_n139_));
  ...
  nand4  g093(.a(new_n146_), .b(new_n123_), .c(new_n140_), .d(new_n63_), .O(new_n147_));
  ...
  nand4  g100(.a(new_n154_), .b(new_n136_), .c(new_n126_), .d(new_n135_), .O(new_n155_));
  oai21  g101(.a(new_n155_), .b(new_n91_), .c(x33), .O(new_n156_));
  inv1   g102(.a(x32), .O(new_n157_));
  inv1   g103(.a(x33), .O(new_n158_));
  nand4  g104(.a(new_n158_), .b(new_n157_), .c(new_n116_), .d(new_n115_), .O(new_n159_));
  inv1   g105(.a(new_n159_), .O(new_n160_));
  nand4  g106(.a(new_n160_), .b(new_n146_), .c(new_n102_), .d(new_n71_), .O(new_n161_));
