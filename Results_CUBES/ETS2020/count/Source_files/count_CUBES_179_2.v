...
module FAU ( 
  ...
  inv1   g089(.a(x30), .O(new_n144_));
  inv1   g090(.a(x31), .O(new_n145_));
  inv1   g091(.a(x32), .O(new_n146_));
  nand4  g092(.a(new_n146_), .b(new_n145_), .c(new_n144_), .d(new_n130_), .O(new_n147_));
  nor2   g093(.a(x26), .b(x25), .O(new_n148_));
  nand2  g094(.a(new_n122_), .b(new_n148_), .O(new_n149_));
  nor2   g095(.a(new_n149_), .b(new_n147_), .O(new_n150_));
  nand2  g096(.a(new_n150_), .b(new_n87_), .O(new_n151_));
  nand2  g097(.a(new_n151_), .b(new_n143_), .O(new_n152_));
  ...
  nand4  g103(.a(new_n158_), .b(new_n141_), .c(new_n140_), .d(new_n113_), .O(new_n159_));
  oai21  g104(.a(new_n159_), .b(new_n104_), .c(x34), .O(new_n160_));
  nand2  g105(.a(new_n140_), .b(new_n113_), .O(new_n161_));
  inv1   g106(.a(new_n161_), .O(new_n162_));
  nand2  g107(.a(new_n145_), .b(new_n144_), .O(new_n163_));
  inv1   g108(.a(x33), .O(new_n164_));
  inv1   g109(.a(x34), .O(new_n165_));
  nand3  g110(.a(new_n165_), .b(new_n164_), .c(new_n146_), .O(new_n166_));
  nor2   g111(.a(new_n166_), .b(new_n163_), .O(new_n167_));
  nand3  g112(.a(new_n167_), .b(new_n162_), .c(new_n96_), .O(new_n168_));
  nand2  g113(.a(new_n168_), .b(new_n160_), .O(new_n169_));
