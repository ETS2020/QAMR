// Benchmark "FAU" written by ABC on Tue Jul  7 19:20:28 2020
...
module FAU ( 
  ...
  wire new_n52_, new_n53_, new_n54_, new_n55_, new_n56_, new_n57_, new_n58_,
    ...
    new_n135_, new_n136_, new_n137_, new_n138_, new_n142_, new_n143_,
  ...
  nand4  g060(.a(new_n113_), .b(new_n106_), .c(new_n72_), .d(new_n62_), .O(new_n114_));
  ...
  nand4  g071(.a(new_n124_), .b(new_n98_), .c(new_n78_), .d(new_n62_), .O(new_n125_));
  ...
  nand4  g077(.a(new_n94_), .b(new_n55_), .c(new_n65_), .d(new_n64_), .O(new_n131_));
  ...
  nand4  g087(.a(new_n142_), .b(new_n133_), .c(new_n115_), .d(new_n132_), .O(new_n143_));
  oai21  g088(.a(new_n143_), .b(new_n86_), .c(x33), .O(new_n144_));
  inv1   g089(.a(x22), .O(new_n145_));
  inv1   g090(.a(x23), .O(new_n146_));
  nand4  g091(.a(new_n105_), .b(new_n83_), .c(new_n146_), .d(new_n145_), .O(new_n147_));
  nor2   g092(.a(new_n147_), .b(new_n66_), .O(new_n148_));
  nor2   g093(.a(x29), .b(x28), .O(new_n149_));
  nor2   g094(.a(x31), .b(x30), .O(new_n150_));
  nor2   g095(.a(x33), .b(x32), .O(new_n151_));
  nand4  g096(.a(new_n151_), .b(new_n150_), .c(new_n149_), .d(new_n106_), .O(new_n152_));
  inv1   g097(.a(new_n152_), .O(new_n153_));
  nand2  g098(.a(new_n153_), .b(new_n148_), .O(new_n154_));
  nand2  g099(.a(new_n154_), .b(new_n144_), .O(new_n155_));
  ...
  oai21  g104(.a(new_n152_), .b(new_n96_), .c(x34), .O(new_n160_));
  nand2  g105(.a(new_n149_), .b(new_n106_), .O(new_n161_));
  ...
  nand3  g115(.a(new_n170_), .b(new_n162_), .c(new_n148_), .O(new_n171_));
