// Benchmark "FAU" written by ABC on Tue Jul  7 19:20:03 2020
...
module FAU ( 
  ...
  nand4  g098(.a(new_n152_), .b(new_n133_), .c(new_n115_), .d(new_n132_), .O(new_n153_));
  oai21  g099(.a(new_n153_), .b(new_n86_), .c(x33), .O(new_n154_));
  nor2   g100(.a(x33), .b(x32), .O(new_n155_));
  nand4  g101(.a(new_n155_), .b(new_n142_), .c(new_n141_), .d(new_n105_), .O(new_n156_));
  inv1   g102(.a(new_n156_), .O(new_n157_));
  nand2  g103(.a(new_n157_), .b(new_n96_), .O(new_n158_));
  nand2  g104(.a(new_n158_), .b(new_n154_), .O(new_n159_));
  nand2  g105(.a(new_n159_), .b(x16), .O(new_n160_));
  inv1   g106(.a(x01), .O(new_n161_));
  aoi21  g107(.a(new_n59_), .b(new_n161_), .c(x18), .O(new_n162_));
  nand2  g108(.a(new_n162_), .b(new_n160_), .O(z14));
  nor2   g109(.a(x21), .b(x20), .O(new_n164_));
  nand4  g110(.a(new_n114_), .b(new_n102_), .c(new_n164_), .d(new_n54_), .O(new_n165_));
  oai21  g111(.a(new_n156_), .b(new_n165_), .c(x34), .O(new_n166_));
  nand2  g112(.a(new_n141_), .b(new_n105_), .O(new_n167_));
