// Benchmark "FAU" written by ABC on Tue Jul  7 19:19:09 2020
...
module FAU ( 
  ...
  nor2   g063(.a(x26), .b(x23), .O(new_n118_));
  nand3  g064(.a(new_n118_), .b(new_n117_), .c(new_n99_), .O(new_n119_));
  oai21  g065(.a(new_n119_), .b(new_n73_), .c(x29), .O(new_n120_));
  ...
  nand4  g076(.a(new_n130_), .b(new_n117_), .c(new_n129_), .d(new_n79_), .O(new_n131_));
  ...
  nand3  g088(.a(new_n142_), .b(new_n138_), .c(new_n83_), .O(new_n143_));
  nand2  g089(.a(new_n143_), .b(new_n137_), .O(new_n144_));
  nand2  g090(.a(new_n144_), .b(x16), .O(new_n145_));
  inv1   g091(.a(x03), .O(new_n146_));
  aoi21  g092(.a(new_n54_), .b(new_n146_), .c(x18), .O(new_n147_));
  nand2  g093(.a(new_n147_), .b(new_n145_), .O(z12));
  nand4  g094(.a(new_n140_), .b(new_n139_), .c(new_n109_), .d(new_n90_), .O(new_n149_));
  oai21  g095(.a(new_n149_), .b(new_n82_), .c(x32), .O(new_n150_));
  nor2   g096(.a(x32), .b(x31), .O(new_n151_));
  nand4  g097(.a(new_n151_), .b(new_n130_), .c(new_n117_), .d(new_n129_), .O(new_n152_));
  ...
  nand4  g107(.a(new_n161_), .b(new_n140_), .c(new_n139_), .d(new_n109_), .O(new_n162_));
  ...
  nand2  g116(.a(new_n139_), .b(new_n109_), .O(new_n171_));
