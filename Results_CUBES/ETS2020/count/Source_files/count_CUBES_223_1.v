...
module FAU ( 
  ...
  nand4  g057(.a(new_n108_), .b(new_n83_), .c(new_n107_), .d(new_n55_), .O(new_n109_));
  nand2  g058(.a(new_n109_), .b(x26), .O(new_n110_));
  nor2   g059(.a(x26), .b(x25), .O(new_n111_));
  nand4  g060(.a(new_n111_), .b(new_n83_), .c(new_n71_), .d(new_n99_), .O(new_n112_));
  ...
  nand4  g074(.a(new_n125_), .b(new_n90_), .c(new_n76_), .d(new_n63_), .O(new_n126_));
  ...
  nand4  g084(.a(new_n137_), .b(new_n127_), .c(new_n111_), .d(new_n99_), .O(new_n138_));
  oai21  g085(.a(new_n138_), .b(new_n84_), .c(x31), .O(new_n139_));
  ...
  nand3  g090(.a(new_n143_), .b(new_n125_), .c(new_n92_), .O(new_n144_));
  ...
  nand4  g096(.a(new_n141_), .b(new_n140_), .c(new_n118_), .d(new_n100_), .O(new_n150_));
  oai21  g097(.a(new_n150_), .b(new_n91_), .c(x32), .O(new_n151_));
  nor2   g098(.a(x32), .b(x31), .O(new_n152_));
  nand4  g099(.a(new_n152_), .b(new_n137_), .c(new_n127_), .d(new_n111_), .O(new_n153_));
  inv1   g100(.a(new_n153_), .O(new_n154_));
  nand2  g101(.a(new_n154_), .b(new_n92_), .O(new_n155_));
  ...
  oai21  g107(.a(new_n153_), .b(new_n91_), .c(x33), .O(new_n161_));
  nor2   g108(.a(x33), .b(x32), .O(new_n162_));
  nand4  g109(.a(new_n162_), .b(new_n141_), .c(new_n140_), .d(new_n118_), .O(new_n163_));
  inv1   g110(.a(new_n163_), .O(new_n164_));
  nand2  g111(.a(new_n164_), .b(new_n102_), .O(new_n165_));
  ...
  oai21  g117(.a(new_n163_), .b(new_n109_), .c(x34), .O(new_n171_));
  nand2  g118(.a(new_n140_), .b(new_n118_), .O(new_n172_));
  ...
  nand3  g128(.a(new_n181_), .b(new_n173_), .c(new_n102_), .O(new_n182_));
