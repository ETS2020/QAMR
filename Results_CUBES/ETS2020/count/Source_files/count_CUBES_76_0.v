...
module FAU ( 
  ...
  nand4  g068(.a(new_n125_), .b(new_n124_), .c(new_n123_), .d(new_n85_), .O(new_n126_));
  oai21  g069(.a(new_n126_), .b(new_n79_), .c(x32), .O(new_n127_));
  nand2  g070(.a(new_n78_), .b(new_n70_), .O(new_n128_));
  ...
  nand2  g077(.a(new_n106_), .b(new_n134_), .O(new_n135_));
  inv1   g078(.a(new_n135_), .O(new_n136_));
  nand4  g079(.a(new_n136_), .b(new_n133_), .c(new_n129_), .d(new_n63_), .O(new_n137_));
  ...
  nand4  g085(.a(new_n131_), .b(new_n130_), .c(new_n106_), .d(new_n134_), .O(new_n143_));
  oai21  g086(.a(new_n143_), .b(new_n79_), .c(x33), .O(new_n144_));
  nor2   g087(.a(x33), .b(x32), .O(new_n145_));
  nand4  g088(.a(new_n145_), .b(new_n125_), .c(new_n124_), .d(new_n123_), .O(new_n146_));
  ...
  nand4  g096(.a(new_n105_), .b(new_n94_), .c(new_n93_), .d(new_n55_), .O(new_n154_));
  oai21  g097(.a(new_n146_), .b(new_n154_), .c(x34), .O(new_n155_));
  nand2  g098(.a(new_n124_), .b(new_n123_), .O(new_n156_));
  ...
  nand3  g108(.a(new_n165_), .b(new_n157_), .c(new_n87_), .O(new_n166_));
