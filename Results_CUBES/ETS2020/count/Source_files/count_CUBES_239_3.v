...
module FAU ( 
  ...
  inv1   g067(.a(x26), .O(new_n121_));
  nor2   g068(.a(x28), .b(x27), .O(new_n122_));
  nand4  g069(.a(new_n122_), .b(new_n103_), .c(new_n121_), .d(new_n93_), .O(new_n123_));
  oai21  g070(.a(new_n123_), .b(new_n77_), .c(x29), .O(new_n124_));
  nor3   g071(.a(x29), .b(x28), .c(x27), .O(new_n125_));
  nand4  g072(.a(new_n125_), .b(new_n106_), .c(new_n78_), .d(new_n71_), .O(new_n126_));
  ...
  nand4  g078(.a(new_n102_), .b(new_n55_), .c(new_n64_), .d(new_n62_), .O(new_n132_));
  nor2   g079(.a(x26), .b(x25), .O(new_n133_));
  nor2   g080(.a(x30), .b(x29), .O(new_n134_));
  nand4  g081(.a(new_n134_), .b(new_n122_), .c(new_n133_), .d(new_n83_), .O(new_n135_));
  ...
  nor3   g088(.a(x27), .b(x26), .c(x25), .O(new_n142_));
  ...
  nand3  g093(.a(new_n146_), .b(new_n142_), .c(new_n87_), .O(new_n147_));
  nand2  g094(.a(new_n147_), .b(new_n141_), .O(new_n148_));
  ...
  nand2  g101(.a(new_n134_), .b(new_n122_), .O(new_n155_));
  inv1   g102(.a(x31), .O(new_n156_));
  inv1   g103(.a(x32), .O(new_n157_));
  nand4  g104(.a(new_n157_), .b(new_n156_), .c(new_n121_), .d(new_n94_), .O(new_n158_));
  nor2   g105(.a(new_n158_), .b(new_n155_), .O(new_n159_));
  nand2  g106(.a(new_n159_), .b(new_n87_), .O(new_n160_));
  nand2  g107(.a(new_n160_), .b(new_n154_), .O(new_n161_));
  ...
  nand4  g113(.a(new_n167_), .b(new_n144_), .c(new_n143_), .d(new_n113_), .O(new_n168_));
  oai21  g114(.a(new_n168_), .b(new_n104_), .c(x34), .O(new_n169_));
  nand2  g115(.a(new_n143_), .b(new_n113_), .O(new_n170_));
  inv1   g116(.a(new_n170_), .O(new_n171_));
  inv1   g117(.a(x30), .O(new_n172_));
  nand2  g118(.a(new_n156_), .b(new_n172_), .O(new_n173_));
  inv1   g119(.a(x33), .O(new_n174_));
  inv1   g120(.a(x34), .O(new_n175_));
  nand3  g121(.a(new_n175_), .b(new_n174_), .c(new_n157_), .O(new_n176_));
  nor2   g122(.a(new_n176_), .b(new_n173_), .O(new_n177_));
  nand3  g123(.a(new_n177_), .b(new_n171_), .c(new_n96_), .O(new_n178_));
  nand2  g124(.a(new_n178_), .b(new_n169_), .O(new_n179_));
