...
module FAU ( 
  ...
  nand3  g041(.a(new_n95_), .b(new_n91_), .c(new_n67_), .O(new_n96_));
  ...
  nand4  g056(.a(new_n110_), .b(new_n82_), .c(new_n73_), .d(new_n62_), .O(new_n111_));
  ...
  nand4  g066(.a(new_n121_), .b(new_n95_), .c(new_n75_), .d(new_n62_), .O(new_n122_));
  nand4  g067(.a(new_n91_), .b(new_n55_), .c(new_n65_), .d(new_n64_), .O(new_n123_));
  ...
  nand3  g081(.a(new_n136_), .b(new_n110_), .c(new_n84_), .O(new_n137_));
  ...
  nand4  g092(.a(new_n102_), .b(new_n80_), .c(new_n148_), .d(new_n147_), .O(new_n149_));
  nor2   g093(.a(new_n149_), .b(new_n66_), .O(new_n150_));
  nor2   g094(.a(x33), .b(x32), .O(new_n151_));
  nand4  g095(.a(new_n151_), .b(new_n134_), .c(new_n133_), .d(new_n103_), .O(new_n152_));
  ...
  nand2  g104(.a(new_n133_), .b(new_n103_), .O(new_n161_));
