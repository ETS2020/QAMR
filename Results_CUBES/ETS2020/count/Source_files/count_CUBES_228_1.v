// Benchmark "FAU" written by ABC on Tue Jul  7 19:20:48 2020
...
module FAU ( 
  ...
  nand4  g032(.a(new_n85_), .b(new_n71_), .c(new_n55_), .d(new_n61_), .O(new_n86_));
  ...
  nand4  g045(.a(new_n98_), .b(new_n78_), .c(new_n97_), .d(new_n55_), .O(new_n99_));
  nand2  g046(.a(new_n99_), .b(x26), .O(new_n100_));
  inv1   g047(.a(new_n70_), .O(new_n101_));
  nor2   g048(.a(x26), .b(x25), .O(new_n102_));
  nand4  g049(.a(new_n102_), .b(new_n78_), .c(new_n101_), .d(new_n89_), .O(new_n103_));
  nand2  g050(.a(new_n103_), .b(new_n100_), .O(new_n104_));
  ...
  nor2   g057(.a(new_n110_), .b(new_n76_), .O(new_n111_));
  ...
  nand4  g063(.a(new_n116_), .b(new_n85_), .c(new_n71_), .d(new_n63_), .O(new_n117_));
  nor2   g064(.a(x28), .b(x27), .O(new_n118_));
  nor2   g065(.a(x26), .b(x23), .O(new_n119_));
  nand3  g066(.a(new_n119_), .b(new_n118_), .c(new_n98_), .O(new_n120_));
  nor2   g067(.a(new_n120_), .b(new_n76_), .O(new_n121_));
  ...
  nand4  g073(.a(new_n128_), .b(new_n118_), .c(new_n102_), .d(new_n89_), .O(new_n129_));
  oai21  g074(.a(new_n129_), .b(new_n79_), .c(x31), .O(new_n130_));
  nand2  g075(.a(new_n85_), .b(new_n71_), .O(new_n131_));
  ...
  nand4  g081(.a(new_n136_), .b(new_n116_), .c(new_n132_), .d(new_n63_), .O(new_n137_));
  ...
  nand4  g088(.a(new_n144_), .b(new_n128_), .c(new_n118_), .d(new_n102_), .O(new_n145_));
  oai21  g089(.a(new_n145_), .b(new_n86_), .c(x33), .O(new_n146_));
  nor2   g090(.a(x33), .b(x32), .O(new_n147_));
  nand4  g091(.a(new_n147_), .b(new_n134_), .c(new_n133_), .d(new_n109_), .O(new_n148_));
  inv1   g092(.a(new_n148_), .O(new_n149_));
  nand2  g093(.a(new_n149_), .b(new_n92_), .O(new_n150_));
  ...
  oai21  g099(.a(new_n148_), .b(new_n99_), .c(x34), .O(new_n156_));
  nand2  g100(.a(new_n133_), .b(new_n109_), .O(new_n157_));
  ...
  nand3  g110(.a(new_n166_), .b(new_n158_), .c(new_n92_), .O(new_n167_));
