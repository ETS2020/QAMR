...
module FAU ( 
  ...
  oai21  g063(.a(new_n117_), .b(new_n78_), .c(x29), .O(new_n118_));
  nor3   g064(.a(x29), .b(x28), .c(x27), .O(new_n119_));
  nand4  g065(.a(new_n119_), .b(new_n99_), .c(new_n79_), .d(new_n63_), .O(new_n120_));
  ...
  nand4  g074(.a(new_n128_), .b(new_n115_), .c(new_n127_), .d(new_n84_), .O(new_n129_));
  ...
  nand3  g086(.a(new_n140_), .b(new_n136_), .c(new_n88_), .O(new_n141_));
  ...
  nand4  g095(.a(new_n149_), .b(new_n128_), .c(new_n115_), .d(new_n127_), .O(new_n150_));
