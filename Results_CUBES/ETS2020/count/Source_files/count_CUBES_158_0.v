...
module FAU ( 
  ...
  nand2  g103(.a(new_n156_), .b(new_n131_), .O(new_n157_));
  inv1   g104(.a(new_n157_), .O(new_n158_));
  nand4  g105(.a(new_n158_), .b(new_n155_), .c(new_n141_), .d(new_n63_), .O(new_n159_));
  nand2  g106(.a(new_n159_), .b(new_n153_), .O(new_n160_));
  ...
  nand4  g111(.a(new_n156_), .b(new_n132_), .c(new_n115_), .d(new_n131_), .O(new_n165_));
  oai21  g112(.a(new_n165_), .b(new_n84_), .c(x33), .O(new_n166_));
  nor2   g113(.a(x33), .b(x32), .O(new_n167_));
  nand4  g114(.a(new_n167_), .b(new_n143_), .c(new_n142_), .d(new_n105_), .O(new_n168_));
  inv1   g115(.a(new_n168_), .O(new_n169_));
  nand2  g116(.a(new_n169_), .b(new_n90_), .O(new_n170_));
  ...
  nand4  g122(.a(new_n114_), .b(new_n97_), .c(new_n96_), .d(new_n55_), .O(new_n176_));
  oai21  g123(.a(new_n168_), .b(new_n176_), .c(x34), .O(new_n177_));
  nand2  g124(.a(new_n142_), .b(new_n105_), .O(new_n178_));
  ...
  nand3  g134(.a(new_n187_), .b(new_n179_), .c(new_n90_), .O(new_n188_));
