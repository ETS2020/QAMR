...
module FAU ( 
  ...
  nand3  g062(.a(new_n116_), .b(new_n115_), .c(new_n114_), .O(new_n117_));
  oai21  g063(.a(new_n117_), .b(new_n105_), .c(x29), .O(new_n118_));
  nor3   g064(.a(x29), .b(x28), .c(x27), .O(new_n119_));
  nand4  g065(.a(new_n119_), .b(new_n103_), .c(new_n83_), .d(new_n63_), .O(new_n120_));
  ...
  nand4  g071(.a(new_n102_), .b(new_n55_), .c(new_n69_), .d(new_n61_), .O(new_n126_));
  nor2   g072(.a(x26), .b(x25), .O(new_n127_));
  nor2   g073(.a(x30), .b(x29), .O(new_n128_));
  nand4  g074(.a(new_n128_), .b(new_n115_), .c(new_n127_), .d(new_n82_), .O(new_n129_));
  ...
  nand4  g092(.a(new_n138_), .b(new_n137_), .c(new_n106_), .d(new_n94_), .O(new_n147_));
  ...
  nand4  g105(.a(new_n159_), .b(new_n138_), .c(new_n137_), .d(new_n106_), .O(new_n160_));
  ...
  nor2   g113(.a(x21), .b(x20), .O(new_n168_));
  nand4  g114(.a(new_n114_), .b(new_n102_), .c(new_n168_), .d(new_n55_), .O(new_n169_));
  oai21  g115(.a(new_n160_), .b(new_n169_), .c(x34), .O(new_n170_));
  nand2  g116(.a(new_n137_), .b(new_n106_), .O(new_n171_));
