...
module FAU ( 
  ...
  nand4  g077(.a(new_n98_), .b(new_n55_), .c(new_n64_), .d(new_n63_), .O(new_n132_));
  nor2   g078(.a(x26), .b(x25), .O(new_n133_));
  nor2   g079(.a(x30), .b(x29), .O(new_n134_));
  nand4  g080(.a(new_n134_), .b(new_n116_), .c(new_n133_), .d(new_n78_), .O(new_n135_));
  ...
  nand3  g086(.a(new_n140_), .b(new_n113_), .c(new_n82_), .O(new_n141_));
  ...
  nand4  g092(.a(new_n138_), .b(new_n137_), .c(new_n106_), .d(new_n89_), .O(new_n147_));
  ...
  nand4  g097(.a(new_n151_), .b(new_n150_), .c(new_n96_), .d(new_n89_), .O(new_n152_));
  nor2   g098(.a(new_n152_), .b(new_n149_), .O(new_n153_));
  nand2  g099(.a(new_n153_), .b(new_n82_), .O(new_n154_));
  ...
  nand4  g105(.a(new_n115_), .b(new_n98_), .c(new_n97_), .d(new_n55_), .O(new_n161_));
  nor2   g106(.a(x33), .b(x32), .O(new_n162_));
  nand4  g107(.a(new_n162_), .b(new_n138_), .c(new_n137_), .d(new_n106_), .O(new_n163_));
  oai21  g108(.a(new_n163_), .b(new_n161_), .c(x34), .O(new_n164_));
  nand2  g109(.a(new_n137_), .b(new_n106_), .O(new_n165_));
  ...
  nand3  g117(.a(new_n172_), .b(new_n166_), .c(new_n91_), .O(new_n173_));
