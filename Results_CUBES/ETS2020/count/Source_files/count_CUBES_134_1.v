...
module FAU ( 
  ...
  nand4  g056(.a(new_n109_), .b(new_n88_), .c(new_n76_), .d(new_n63_), .O(new_n110_));
  inv1   g057(.a(x23), .O(new_n111_));
  inv1   g058(.a(x26), .O(new_n112_));
  nor2   g059(.a(x28), .b(x27), .O(new_n113_));
  nand4  g060(.a(new_n113_), .b(new_n93_), .c(new_n112_), .d(new_n111_), .O(new_n114_));
  ...
  oai21  g066(.a(new_n114_), .b(new_n81_), .c(x29), .O(new_n120_));
  nor3   g067(.a(x29), .b(x28), .c(x27), .O(new_n121_));
  nand4  g068(.a(new_n121_), .b(new_n101_), .c(new_n82_), .d(new_n63_), .O(new_n122_));
  ...
  nand4  g074(.a(new_n92_), .b(new_n55_), .c(new_n69_), .d(new_n61_), .O(new_n128_));
  inv1   g075(.a(x24), .O(new_n129_));
  nor2   g076(.a(x26), .b(x25), .O(new_n130_));
  nor2   g077(.a(x30), .b(x29), .O(new_n131_));
  nand4  g078(.a(new_n131_), .b(new_n113_), .c(new_n130_), .d(new_n129_), .O(new_n132_));
  nor2   g079(.a(new_n132_), .b(new_n128_), .O(new_n133_));
  aoi21  g080(.a(new_n122_), .b(x30), .c(new_n133_), .O(new_n134_));
  ...
  nand4  g086(.a(new_n129_), .b(new_n111_), .c(new_n139_), .d(new_n69_), .O(new_n140_));
  ...
  nand4  g094(.a(new_n147_), .b(new_n109_), .c(new_n141_), .d(new_n63_), .O(new_n148_));
  ...
  inv1   g103(.a(x25), .O(new_n158_));
  nand4  g104(.a(new_n158_), .b(new_n129_), .c(new_n111_), .d(new_n139_), .O(new_n159_));
  inv1   g105(.a(new_n159_), .O(new_n160_));
  inv1   g106(.a(x27), .O(new_n161_));
  inv1   g107(.a(x32), .O(new_n162_));
  inv1   g108(.a(x33), .O(new_n163_));
  nand4  g109(.a(new_n163_), .b(new_n162_), .c(new_n161_), .d(new_n112_), .O(new_n164_));
  inv1   g110(.a(new_n164_), .O(new_n165_));
  nand4  g111(.a(new_n165_), .b(new_n147_), .c(new_n160_), .d(new_n71_), .O(new_n166_));
  nand2  g112(.a(new_n166_), .b(new_n157_), .O(new_n167_));
