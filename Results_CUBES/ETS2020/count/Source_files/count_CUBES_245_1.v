...
module FAU ( 
  ...
  nand4  g089(.a(new_n143_), .b(new_n142_), .c(new_n106_), .d(new_n95_), .O(new_n144_));
  oai21  g090(.a(new_n144_), .b(new_n86_), .c(x32), .O(new_n145_));
  nand4  g091(.a(new_n83_), .b(new_n94_), .c(new_n93_), .d(new_n65_), .O(new_n146_));
  inv1   g092(.a(new_n146_), .O(new_n147_));
  inv1   g093(.a(x27), .O(new_n148_));
  inv1   g094(.a(x28), .O(new_n149_));
  inv1   g095(.a(x29), .O(new_n150_));
  ...
  inv1   g099(.a(x31), .O(new_n154_));
  inv1   g100(.a(x32), .O(new_n155_));
  nand4  g101(.a(new_n155_), .b(new_n154_), .c(new_n115_), .d(new_n95_), .O(new_n156_));
  inv1   g102(.a(new_n156_), .O(new_n157_));
  nand4  g103(.a(new_n157_), .b(new_n153_), .c(new_n147_), .d(new_n62_), .O(new_n158_));
  nand2  g104(.a(new_n158_), .b(new_n145_), .O(new_n159_));
  ...
  nor2   g109(.a(x32), .b(x31), .O(new_n164_));
  nand4  g110(.a(new_n164_), .b(new_n134_), .c(new_n117_), .d(new_n133_), .O(new_n165_));
  oai21  g111(.a(new_n165_), .b(new_n86_), .c(x33), .O(new_n166_));
  inv1   g112(.a(new_n96_), .O(new_n167_));
  nand4  g113(.a(new_n154_), .b(new_n151_), .c(new_n150_), .d(new_n149_), .O(new_n168_));
  inv1   g114(.a(new_n168_), .O(new_n169_));
  inv1   g115(.a(x33), .O(new_n170_));
  nand4  g116(.a(new_n170_), .b(new_n155_), .c(new_n148_), .d(new_n115_), .O(new_n171_));
  inv1   g117(.a(new_n171_), .O(new_n172_));
  nand4  g118(.a(new_n172_), .b(new_n169_), .c(new_n167_), .d(new_n67_), .O(new_n173_));
  nand2  g119(.a(new_n173_), .b(new_n166_), .O(new_n174_));
