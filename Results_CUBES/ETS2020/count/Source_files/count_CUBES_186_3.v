...
module FAU ( 
  ...
  nor2   g069(.a(x26), .b(x23), .O(new_n123_));
  nand3  g070(.a(new_n123_), .b(new_n122_), .c(new_n103_), .O(new_n124_));
  ...
  nand4  g082(.a(new_n135_), .b(new_n122_), .c(new_n134_), .d(new_n82_), .O(new_n136_));
  ...
  nand4  g103(.a(new_n156_), .b(new_n135_), .c(new_n122_), .d(new_n134_), .O(new_n157_));
