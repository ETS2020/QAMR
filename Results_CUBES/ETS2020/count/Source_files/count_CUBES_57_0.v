...
module FAU ( 
  ...
  nand2  g104(.a(new_n136_), .b(new_n119_), .O(new_n158_));
  inv1   g105(.a(new_n158_), .O(new_n159_));
  inv1   g106(.a(x31), .O(new_n160_));
  inv1   g107(.a(x32), .O(new_n161_));
  nand4  g108(.a(new_n161_), .b(new_n160_), .c(new_n118_), .d(new_n90_), .O(new_n162_));
  inv1   g109(.a(new_n162_), .O(new_n163_));
  nand4  g110(.a(new_n163_), .b(new_n159_), .c(new_n145_), .d(new_n63_), .O(new_n164_));
  nand2  g111(.a(new_n164_), .b(new_n157_), .O(new_n165_));
  nand2  g112(.a(new_n165_), .b(x16), .O(new_n166_));
  inv1   g113(.a(x02), .O(new_n167_));
  aoi21  g114(.a(new_n58_), .b(new_n167_), .c(x18), .O(new_n168_));
  nand2  g115(.a(new_n168_), .b(new_n166_), .O(z13));
  nor2   g116(.a(x33), .b(x32), .O(new_n171_));
  nand4  g117(.a(new_n171_), .b(new_n147_), .c(new_n146_), .d(new_n109_), .O(new_n172_));
  oai21  g118(.a(new_n172_), .b(new_n100_), .c(x34), .O(new_n173_));
  nand2  g119(.a(new_n146_), .b(new_n109_), .O(new_n174_));
  inv1   g120(.a(new_n174_), .O(new_n175_));
  inv1   g121(.a(x30), .O(new_n176_));
  nand2  g122(.a(new_n160_), .b(new_n176_), .O(new_n177_));
  inv1   g123(.a(x33), .O(new_n178_));
  inv1   g124(.a(x34), .O(new_n179_));
  nand3  g125(.a(new_n179_), .b(new_n178_), .c(new_n161_), .O(new_n180_));
  nor2   g126(.a(new_n180_), .b(new_n177_), .O(new_n181_));
  nand3  g127(.a(new_n181_), .b(new_n175_), .c(new_n92_), .O(new_n182_));
  nand2  g128(.a(new_n182_), .b(new_n173_), .O(new_n183_));
