...
module FAU ( 
  ...
  inv1   g059(.a(x23), .O(new_n114_));
  inv1   g060(.a(x26), .O(new_n115_));
  nor2   g061(.a(x28), .b(x27), .O(new_n116_));
  nand4  g062(.a(new_n116_), .b(new_n95_), .c(new_n115_), .d(new_n114_), .O(new_n117_));
  ...
  aoi21  g090(.a(new_n59_), .b(new_n144_), .c(x18), .O(new_n145_));
  nand2  g091(.a(new_n145_), .b(new_n143_), .O(z12));
  nand4  g092(.a(new_n138_), .b(new_n137_), .c(new_n106_), .d(new_n105_), .O(new_n147_));
  ...
  nand4  g097(.a(new_n151_), .b(new_n150_), .c(new_n115_), .d(new_n105_), .O(new_n152_));
  ...
  aoi21  g103(.a(new_n59_), .b(new_n157_), .c(x18), .O(new_n158_));
  nand2  g104(.a(new_n158_), .b(new_n156_), .O(z13));
  nor2   g105(.a(x33), .b(x32), .O(new_n161_));
  nand4  g106(.a(new_n161_), .b(new_n138_), .c(new_n137_), .d(new_n106_), .O(new_n162_));
  oai21  g107(.a(new_n162_), .b(new_n96_), .c(x34), .O(new_n163_));
  inv1   g108(.a(x22), .O(new_n164_));
  nand4  g109(.a(new_n105_), .b(new_n83_), .c(new_n114_), .d(new_n164_), .O(new_n165_));
  nor2   g110(.a(new_n165_), .b(new_n66_), .O(new_n166_));
  nand2  g111(.a(new_n137_), .b(new_n106_), .O(new_n167_));
  inv1   g112(.a(new_n167_), .O(new_n168_));
  inv1   g113(.a(x30), .O(new_n169_));
  nand2  g114(.a(new_n150_), .b(new_n169_), .O(new_n170_));
  inv1   g115(.a(x33), .O(new_n171_));
  inv1   g116(.a(x34), .O(new_n172_));
  nand3  g117(.a(new_n172_), .b(new_n171_), .c(new_n151_), .O(new_n173_));
  nor2   g118(.a(new_n173_), .b(new_n170_), .O(new_n174_));
  nand3  g119(.a(new_n174_), .b(new_n168_), .c(new_n166_), .O(new_n175_));
  nand2  g120(.a(new_n175_), .b(new_n163_), .O(new_n176_));
