...
module FAU ( 
  ...
  nand4  g069(.a(new_n123_), .b(new_n106_), .c(new_n83_), .d(new_n63_), .O(new_n124_));
  nand4  g070(.a(new_n102_), .b(new_n55_), .c(new_n69_), .d(new_n61_), .O(new_n125_));
  nor2   g071(.a(x26), .b(x25), .O(new_n126_));
  nor2   g072(.a(x28), .b(x27), .O(new_n127_));
  nor2   g073(.a(x30), .b(x29), .O(new_n128_));
  nand4  g074(.a(new_n128_), .b(new_n127_), .c(new_n126_), .d(new_n82_), .O(new_n129_));
  nor2   g075(.a(new_n129_), .b(new_n125_), .O(new_n130_));
  aoi21  g076(.a(new_n124_), .b(x30), .c(new_n130_), .O(new_n131_));
  ...
  oai21  g080(.a(new_n129_), .b(new_n125_), .c(x31), .O(new_n135_));
  nor3   g081(.a(x27), .b(x26), .c(x25), .O(new_n136_));
  ...
  nand3  g086(.a(new_n140_), .b(new_n136_), .c(new_n87_), .O(new_n141_));
  nand2  g087(.a(new_n141_), .b(new_n135_), .O(new_n142_));
  ...
  nand4  g092(.a(new_n138_), .b(new_n137_), .c(new_n114_), .d(new_n94_), .O(new_n147_));
  oai21  g093(.a(new_n147_), .b(new_n86_), .c(x32), .O(new_n148_));
  nand2  g094(.a(new_n128_), .b(new_n127_), .O(new_n149_));
  nor2   g095(.a(x32), .b(x31), .O(new_n150_));
  nand2  g096(.a(new_n150_), .b(new_n126_), .O(new_n151_));
  nor2   g097(.a(new_n151_), .b(new_n149_), .O(new_n152_));
  nand2  g098(.a(new_n152_), .b(new_n87_), .O(new_n153_));
  nand2  g099(.a(new_n153_), .b(new_n148_), .O(new_n154_));
  ...
  nor2   g104(.a(x33), .b(x32), .O(new_n160_));
  nand4  g105(.a(new_n160_), .b(new_n138_), .c(new_n137_), .d(new_n114_), .O(new_n161_));
  oai21  g106(.a(new_n161_), .b(new_n104_), .c(x34), .O(new_n162_));
  nand2  g107(.a(new_n137_), .b(new_n114_), .O(new_n163_));
