// Benchmark "FAU" written by ABC on Tue Jul  7 19:17:47 2020
...
module FAU ( 
  ...
  nand4  g084(.a(new_n103_), .b(new_n55_), .c(new_n69_), .d(new_n61_), .O(new_n137_));
  nor2   g085(.a(x26), .b(x25), .O(new_n138_));
  nor2   g086(.a(x30), .b(x29), .O(new_n139_));
  nand4  g087(.a(new_n139_), .b(new_n122_), .c(new_n138_), .d(new_n84_), .O(new_n140_));
  ...
  nand4  g094(.a(new_n84_), .b(new_n94_), .c(new_n93_), .d(new_n69_), .O(new_n147_));
  inv1   g095(.a(new_n147_), .O(new_n148_));
  inv1   g096(.a(x28), .O(new_n149_));
  inv1   g097(.a(x29), .O(new_n150_));
  inv1   g098(.a(x30), .O(new_n151_));
  inv1   g099(.a(x31), .O(new_n152_));
  nand4  g100(.a(new_n152_), .b(new_n151_), .c(new_n150_), .d(new_n149_), .O(new_n153_));
  inv1   g101(.a(new_n153_), .O(new_n154_));
  nand4  g102(.a(new_n154_), .b(new_n118_), .c(new_n148_), .d(new_n63_), .O(new_n155_));
  nand2  g103(.a(new_n155_), .b(new_n146_), .O(new_n156_));
  nand2  g104(.a(new_n156_), .b(x16), .O(new_n157_));
  inv1   g105(.a(x03), .O(new_n158_));
  aoi21  g106(.a(new_n58_), .b(new_n158_), .c(x18), .O(new_n159_));
  nand2  g107(.a(new_n159_), .b(new_n157_), .O(z12));
  nor2   g108(.a(x29), .b(x28), .O(new_n161_));
  nor2   g109(.a(x31), .b(x30), .O(new_n162_));
  nand4  g110(.a(new_n162_), .b(new_n161_), .c(new_n111_), .d(new_n95_), .O(new_n163_));
  oai21  g111(.a(new_n163_), .b(new_n87_), .c(x32), .O(new_n164_));
  inv1   g112(.a(x27), .O(new_n165_));
  nand4  g113(.a(new_n151_), .b(new_n150_), .c(new_n149_), .d(new_n165_), .O(new_n166_));
  inv1   g114(.a(new_n166_), .O(new_n167_));
  inv1   g115(.a(x32), .O(new_n168_));
  nand4  g116(.a(new_n168_), .b(new_n152_), .c(new_n120_), .d(new_n95_), .O(new_n169_));
  inv1   g117(.a(new_n169_), .O(new_n170_));
  nand4  g118(.a(new_n170_), .b(new_n167_), .c(new_n148_), .d(new_n63_), .O(new_n171_));
  nand2  g119(.a(new_n171_), .b(new_n164_), .O(new_n172_));
  nand2  g120(.a(new_n172_), .b(x16), .O(new_n173_));
  inv1   g121(.a(x02), .O(new_n174_));
  aoi21  g122(.a(new_n58_), .b(new_n174_), .c(x18), .O(new_n175_));
  nand2  g123(.a(new_n175_), .b(new_n173_), .O(z13));
  nor2   g124(.a(x32), .b(x31), .O(new_n177_));
  nand4  g125(.a(new_n177_), .b(new_n139_), .c(new_n122_), .d(new_n138_), .O(new_n178_));
  oai21  g126(.a(new_n178_), .b(new_n87_), .c(x33), .O(new_n179_));
  inv1   g127(.a(x33), .O(new_n180_));
  nand4  g128(.a(new_n180_), .b(new_n168_), .c(new_n165_), .d(new_n120_), .O(new_n181_));
  inv1   g129(.a(new_n181_), .O(new_n182_));
  nand4  g130(.a(new_n182_), .b(new_n154_), .c(new_n97_), .d(new_n71_), .O(new_n183_));
  nand2  g131(.a(new_n183_), .b(new_n179_), .O(new_n184_));
  nand2  g132(.a(new_n184_), .b(x16), .O(new_n185_));
  inv1   g133(.a(x01), .O(new_n186_));
  aoi21  g134(.a(new_n58_), .b(new_n186_), .c(x18), .O(new_n187_));
  nand2  g135(.a(new_n187_), .b(new_n185_), .O(z14));
  zero   g136(.O(z03));
  zero   g137(.O(z15));
endmodule
