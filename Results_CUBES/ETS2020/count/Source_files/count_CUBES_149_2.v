...
module FAU ( 
  ...
  nand4  g045(.a(new_n99_), .b(new_n98_), .c(new_n97_), .d(new_n54_), .O(new_n100_));
  ...
  nand4  g054(.a(new_n108_), .b(new_n80_), .c(new_n67_), .d(new_n56_), .O(new_n109_));
  nor2   g055(.a(x25), .b(x24), .O(new_n110_));
  nor2   g056(.a(x28), .b(x27), .O(new_n111_));
  nor2   g057(.a(x26), .b(x23), .O(new_n112_));
  nand3  g058(.a(new_n112_), .b(new_n111_), .c(new_n110_), .O(new_n113_));
  nor2   g059(.a(new_n113_), .b(new_n72_), .O(new_n114_));
  ...
  nand4  g066(.a(new_n120_), .b(new_n99_), .c(new_n73_), .d(new_n56_), .O(new_n121_));
  ...
  nand4  g075(.a(new_n129_), .b(new_n111_), .c(new_n128_), .d(new_n78_), .O(new_n130_));
  ...
  nand3  g086(.a(new_n140_), .b(new_n108_), .c(new_n82_), .O(new_n141_));
  ...
  nand4  g092(.a(new_n138_), .b(new_n137_), .c(new_n101_), .d(new_n89_), .O(new_n147_));
  ...
  nand4  g105(.a(new_n159_), .b(new_n138_), .c(new_n137_), .d(new_n101_), .O(new_n160_));
  ...
  nand4  g113(.a(new_n110_), .b(new_n98_), .c(new_n97_), .d(new_n54_), .O(new_n168_));
  oai21  g114(.a(new_n160_), .b(new_n168_), .c(x34), .O(new_n169_));
  nand2  g115(.a(new_n137_), .b(new_n101_), .O(new_n170_));
