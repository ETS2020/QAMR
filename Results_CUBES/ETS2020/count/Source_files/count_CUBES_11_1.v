...
module FAU ( 
  ...
  nor3   g063(.a(x25), .b(x24), .c(x23), .O(new_n116_));
  nand4  g064(.a(new_n116_), .b(new_n109_), .c(new_n76_), .d(new_n63_), .O(new_n117_));
  ...
  nand4  g085(.a(new_n140_), .b(new_n139_), .c(new_n119_), .d(new_n138_), .O(new_n141_));
  oai21  g086(.a(new_n141_), .b(new_n90_), .c(x33), .O(new_n142_));
  nor2   g087(.a(x29), .b(x28), .O(new_n143_));
  nor2   g088(.a(x31), .b(x30), .O(new_n144_));
  nor2   g089(.a(x33), .b(x32), .O(new_n145_));
  nand4  g090(.a(new_n145_), .b(new_n144_), .c(new_n143_), .d(new_n109_), .O(new_n146_));
  inv1   g091(.a(new_n146_), .O(new_n147_));
  nand2  g092(.a(new_n147_), .b(new_n100_), .O(new_n148_));
  ...
  nand2  g097(.a(new_n152_), .b(new_n150_), .O(z14));
  nor2   g098(.a(x21), .b(x20), .O(new_n154_));
  nand4  g099(.a(new_n118_), .b(new_n106_), .c(new_n154_), .d(new_n55_), .O(new_n155_));
  oai21  g100(.a(new_n146_), .b(new_n155_), .c(x34), .O(new_n156_));
  nand2  g101(.a(new_n143_), .b(new_n109_), .O(new_n157_));
  ...
  nand3  g111(.a(new_n166_), .b(new_n158_), .c(new_n100_), .O(new_n167_));
