// Benchmark "FAU" written by ABC on Tue Jul  7 19:20:51 2020
...
module FAU ( 
  ...
  nor3   g056(.a(x27), .b(x26), .c(x25), .O(new_n110_));
  nand4  g057(.a(new_n110_), .b(new_n89_), .c(new_n76_), .d(new_n63_), .O(new_n111_));
  nor2   g058(.a(x28), .b(x27), .O(new_n112_));
  nor2   g059(.a(x26), .b(x23), .O(new_n113_));
  nand3  g060(.a(new_n113_), .b(new_n112_), .c(new_n99_), .O(new_n114_));
  nor2   g061(.a(new_n114_), .b(new_n81_), .O(new_n115_));
  aoi21  g062(.a(new_n111_), .b(x28), .c(new_n115_), .O(new_n116_));
  ...
  nand4  g067(.a(new_n121_), .b(new_n102_), .c(new_n82_), .d(new_n63_), .O(new_n122_));
  ...
  nand4  g071(.a(new_n125_), .b(new_n112_), .c(new_n124_), .d(new_n87_), .O(new_n126_));
  ...
  nor2   g078(.a(x29), .b(x28), .O(new_n133_));
  nor2   g079(.a(x31), .b(x30), .O(new_n134_));
  nand2  g080(.a(new_n134_), .b(new_n133_), .O(new_n135_));
  inv1   g081(.a(new_n135_), .O(new_n136_));
  nand3  g082(.a(new_n136_), .b(new_n110_), .c(new_n91_), .O(new_n137_));
  nand2  g083(.a(new_n137_), .b(new_n132_), .O(new_n138_));
  nand2  g084(.a(new_n138_), .b(x16), .O(new_n139_));
  inv1   g085(.a(x03), .O(new_n140_));
  aoi21  g086(.a(new_n58_), .b(new_n140_), .c(x18), .O(new_n141_));
  nand2  g087(.a(new_n141_), .b(new_n139_), .O(z12));
  nor2   g088(.a(x32), .b(x31), .O(new_n144_));
  nand4  g089(.a(new_n144_), .b(new_n125_), .c(new_n112_), .d(new_n124_), .O(new_n145_));
  oai21  g090(.a(new_n145_), .b(new_n90_), .c(x33), .O(new_n146_));
  inv1   g091(.a(x22), .O(new_n147_));
  inv1   g092(.a(x23), .O(new_n148_));
  inv1   g093(.a(x25), .O(new_n149_));
  nand4  g094(.a(new_n149_), .b(new_n87_), .c(new_n148_), .d(new_n147_), .O(new_n150_));
  nor2   g095(.a(new_n150_), .b(new_n70_), .O(new_n151_));
  nor2   g096(.a(x27), .b(x26), .O(new_n152_));
  nor2   g097(.a(x33), .b(x32), .O(new_n153_));
  nand4  g098(.a(new_n153_), .b(new_n134_), .c(new_n133_), .d(new_n152_), .O(new_n154_));
  inv1   g099(.a(new_n154_), .O(new_n155_));
  nand2  g100(.a(new_n155_), .b(new_n151_), .O(new_n156_));
  nand2  g101(.a(new_n156_), .b(new_n146_), .O(new_n157_));
  ...
  oai21  g106(.a(new_n154_), .b(new_n100_), .c(x34), .O(new_n162_));
  nand2  g107(.a(new_n133_), .b(new_n152_), .O(new_n163_));
  ...
  nand3  g117(.a(new_n172_), .b(new_n164_), .c(new_n151_), .O(new_n173_));
