// Benchmark "FAU" written by ABC on Tue Jul  7 19:18:43 2020
...
module FAU ( 
  ...
  nand4  g073(.a(new_n98_), .b(new_n54_), .c(new_n65_), .d(new_n53_), .O(new_n128_));
  ...
  nand4  g107(.a(new_n112_), .b(new_n98_), .c(new_n162_), .d(new_n54_), .O(new_n163_));
