...
module FAU ( 
  ...
  oai21  g090(.a(new_n144_), .b(new_n85_), .c(x32), .O(new_n145_));
  inv1   g091(.a(x22), .O(new_n146_));
  nand4  g092(.a(new_n132_), .b(new_n114_), .c(new_n146_), .d(new_n65_), .O(new_n147_));
  ...
  nand4  g104(.a(new_n158_), .b(new_n154_), .c(new_n148_), .d(new_n56_), .O(new_n159_));
  ...
  oai21  g112(.a(new_n166_), .b(new_n85_), .c(x33), .O(new_n167_));
  ...
  nand4  g120(.a(new_n174_), .b(new_n171_), .c(new_n169_), .d(new_n67_), .O(new_n175_));
  nand2  g121(.a(new_n175_), .b(new_n167_), .O(new_n176_));
  nand2  g122(.a(new_n176_), .b(x16), .O(new_n177_));
  inv1   g123(.a(x01), .O(new_n178_));
  aoi21  g124(.a(new_n59_), .b(new_n178_), .c(x18), .O(new_n179_));
