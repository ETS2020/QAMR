// Benchmark "FAU" written by ABC on Tue Jul  7 19:20:26 2020
...
module FAU ( 
  ...
  nand2  g031(.a(new_n84_), .b(x25), .O(new_n85_));
  nor2   g032(.a(x21), .b(x20), .O(new_n86_));
  nor2   g033(.a(x23), .b(x22), .O(new_n87_));
  nor2   g034(.a(x25), .b(x24), .O(new_n88_));
  nand4  g035(.a(new_n88_), .b(new_n87_), .c(new_n86_), .d(new_n55_), .O(new_n89_));
  nand2  g036(.a(new_n89_), .b(new_n85_), .O(new_n90_));
  nand2  g037(.a(new_n90_), .b(x16), .O(new_n91_));
  inv1   g038(.a(x09), .O(new_n92_));
  aoi21  g039(.a(new_n58_), .b(new_n92_), .c(x18), .O(new_n93_));
  nand2  g040(.a(new_n93_), .b(new_n91_), .O(z06));
  nand2  g041(.a(new_n89_), .b(x26), .O(new_n95_));
  inv1   g042(.a(new_n70_), .O(new_n96_));
  nor3   g043(.a(x26), .b(x25), .c(x24), .O(new_n97_));
  nand3  g044(.a(new_n97_), .b(new_n87_), .c(new_n96_), .O(new_n98_));
  nand2  g045(.a(new_n98_), .b(new_n95_), .O(new_n99_));
  ...
  nand3  g052(.a(new_n105_), .b(new_n83_), .c(new_n104_), .O(new_n106_));
  nor2   g053(.a(new_n106_), .b(new_n76_), .O(new_n107_));
  aoi21  g054(.a(new_n98_), .b(x27), .c(new_n107_), .O(new_n108_));
  ...
  inv1   g060(.a(x23), .O(new_n114_));
  inv1   g061(.a(x26), .O(new_n115_));
  nor2   g062(.a(x28), .b(x27), .O(new_n116_));
  nand4  g063(.a(new_n116_), .b(new_n88_), .c(new_n115_), .d(new_n114_), .O(new_n117_));
  ...
  nand4  g071(.a(new_n124_), .b(new_n97_), .c(new_n77_), .d(new_n63_), .O(new_n125_));
  ...
  nand4  g077(.a(new_n87_), .b(new_n55_), .c(new_n69_), .d(new_n61_), .O(new_n131_));
  inv1   g078(.a(x24), .O(new_n132_));
  nor2   g079(.a(x26), .b(x25), .O(new_n133_));
  nor2   g080(.a(x30), .b(x29), .O(new_n134_));
  nand4  g081(.a(new_n134_), .b(new_n116_), .c(new_n133_), .d(new_n132_), .O(new_n135_));
  nor2   g082(.a(new_n135_), .b(new_n131_), .O(new_n136_));
  aoi21  g083(.a(new_n125_), .b(x30), .c(new_n136_), .O(new_n137_));
  ...
  nand4  g089(.a(new_n143_), .b(new_n142_), .c(new_n105_), .d(new_n104_), .O(new_n144_));
  oai21  g090(.a(new_n144_), .b(new_n84_), .c(x32), .O(new_n145_));
  inv1   g091(.a(x22), .O(new_n146_));
  nand4  g092(.a(new_n132_), .b(new_n114_), .c(new_n146_), .d(new_n69_), .O(new_n147_));
  inv1   g093(.a(new_n147_), .O(new_n148_));
  inv1   g094(.a(x27), .O(new_n149_));
  inv1   g095(.a(x28), .O(new_n150_));
  inv1   g096(.a(x29), .O(new_n151_));
  inv1   g097(.a(x30), .O(new_n152_));
  nand4  g098(.a(new_n152_), .b(new_n151_), .c(new_n150_), .d(new_n149_), .O(new_n153_));
  inv1   g099(.a(new_n153_), .O(new_n154_));
  inv1   g100(.a(x31), .O(new_n155_));
  inv1   g101(.a(x32), .O(new_n156_));
  nand4  g102(.a(new_n156_), .b(new_n155_), .c(new_n115_), .d(new_n104_), .O(new_n157_));
  inv1   g103(.a(new_n157_), .O(new_n158_));
  nand4  g104(.a(new_n158_), .b(new_n154_), .c(new_n148_), .d(new_n63_), .O(new_n159_));
  nand2  g105(.a(new_n159_), .b(new_n145_), .O(new_n160_));
  ...
  nand4  g111(.a(new_n165_), .b(new_n134_), .c(new_n116_), .d(new_n133_), .O(new_n166_));
  oai21  g112(.a(new_n166_), .b(new_n84_), .c(x33), .O(new_n167_));
  nand4  g113(.a(new_n104_), .b(new_n132_), .c(new_n114_), .d(new_n146_), .O(new_n168_));
  inv1   g114(.a(new_n168_), .O(new_n169_));
  nand4  g115(.a(new_n155_), .b(new_n152_), .c(new_n151_), .d(new_n150_), .O(new_n170_));
  inv1   g116(.a(new_n170_), .O(new_n171_));
  inv1   g117(.a(x33), .O(new_n172_));
  nand4  g118(.a(new_n172_), .b(new_n156_), .c(new_n149_), .d(new_n115_), .O(new_n173_));
  inv1   g119(.a(new_n173_), .O(new_n174_));
  nand4  g120(.a(new_n174_), .b(new_n171_), .c(new_n169_), .d(new_n96_), .O(new_n175_));
  nand2  g121(.a(new_n175_), .b(new_n167_), .O(new_n176_));
