...
module FAU ( 
  ...
  nand2  g095(.a(new_n137_), .b(new_n120_), .O(new_n149_));
  inv1   g096(.a(x31), .O(new_n150_));
  inv1   g097(.a(x32), .O(new_n151_));
  nand4  g098(.a(new_n151_), .b(new_n150_), .c(new_n100_), .d(new_n93_), .O(new_n152_));
  nor2   g099(.a(new_n152_), .b(new_n149_), .O(new_n153_));
  nand2  g100(.a(new_n153_), .b(new_n86_), .O(new_n154_));
  nand2  g101(.a(new_n154_), .b(new_n148_), .O(new_n155_));
  ...
  nand4  g106(.a(new_n119_), .b(new_n102_), .c(new_n101_), .d(new_n55_), .O(new_n161_));
  nor2   g107(.a(x33), .b(x32), .O(new_n162_));
  nand4  g108(.a(new_n162_), .b(new_n146_), .c(new_n145_), .d(new_n110_), .O(new_n163_));
  oai21  g109(.a(new_n163_), .b(new_n161_), .c(x34), .O(new_n164_));
  nand2  g110(.a(new_n145_), .b(new_n110_), .O(new_n165_));
  inv1   g111(.a(new_n165_), .O(new_n166_));
  inv1   g112(.a(x30), .O(new_n167_));
  nand2  g113(.a(new_n150_), .b(new_n167_), .O(new_n168_));
  inv1   g114(.a(x33), .O(new_n169_));
  inv1   g115(.a(x34), .O(new_n170_));
  nand3  g116(.a(new_n170_), .b(new_n169_), .c(new_n151_), .O(new_n171_));
  nor2   g117(.a(new_n171_), .b(new_n168_), .O(new_n172_));
  nand3  g118(.a(new_n172_), .b(new_n166_), .c(new_n95_), .O(new_n173_));
  nand2  g119(.a(new_n173_), .b(new_n164_), .O(new_n174_));
