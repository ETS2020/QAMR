...
module FAU ( 
  ...
  nand4  g042(.a(new_n98_), .b(new_n75_), .c(new_n62_), .d(new_n61_), .O(new_n99_));
  nor2   g043(.a(x25), .b(x24), .O(new_n100_));
  nor2   g044(.a(x28), .b(x27), .O(new_n101_));
  nand4  g045(.a(new_n101_), .b(new_n100_), .c(new_n87_), .d(new_n78_), .O(new_n102_));
  nor2   g046(.a(new_n102_), .b(new_n68_), .O(new_n103_));
  aoi21  g047(.a(new_n99_), .b(x28), .c(new_n103_), .O(new_n104_));
  inv1   g048(.a(x06), .O(new_n105_));
  aoi21  g049(.a(new_n55_), .b(new_n105_), .c(x18), .O(new_n106_));
  oai21  g050(.a(new_n104_), .b(new_n55_), .c(new_n106_), .O(z09));
  inv1   g051(.a(x29), .O(new_n108_));
  nor3   g052(.a(x29), .b(x28), .c(x27), .O(new_n109_));
  nand4  g053(.a(new_n109_), .b(new_n90_), .c(new_n69_), .d(new_n62_), .O(new_n110_));
  ...
  aoi21  g057(.a(new_n55_), .b(new_n113_), .c(x18), .O(new_n114_));
  nand2  g058(.a(new_n114_), .b(new_n112_), .O(z10));
  nand4  g059(.a(new_n89_), .b(new_n67_), .c(new_n59_), .d(new_n58_), .O(new_n116_));
  nor2   g060(.a(x26), .b(x25), .O(new_n117_));
  nor2   g061(.a(x30), .b(x29), .O(new_n118_));
  nand4  g062(.a(new_n118_), .b(new_n101_), .c(new_n117_), .d(new_n79_), .O(new_n119_));
  ...
  aoi21  g066(.a(new_n55_), .b(new_n122_), .c(x18), .O(new_n123_));
  oai21  g067(.a(new_n121_), .b(new_n55_), .c(new_n123_), .O(z11));
  oai21  g068(.a(new_n119_), .b(new_n116_), .c(x31), .O(new_n125_));
  nand2  g069(.a(new_n75_), .b(new_n61_), .O(new_n126_));
  ...
  nand4  g075(.a(new_n131_), .b(new_n98_), .c(new_n127_), .d(new_n62_), .O(new_n132_));
  nand2  g076(.a(new_n132_), .b(new_n125_), .O(new_n133_));
  nand2  g077(.a(new_n133_), .b(x16), .O(new_n134_));
  inv1   g078(.a(x03), .O(new_n135_));
  aoi21  g079(.a(new_n55_), .b(new_n135_), .c(x18), .O(new_n136_));
  nand2  g080(.a(new_n136_), .b(new_n134_), .O(z12));
  nor2   g081(.a(x32), .b(x31), .O(new_n139_));
  nand4  g082(.a(new_n139_), .b(new_n118_), .c(new_n101_), .d(new_n117_), .O(new_n140_));
  oai21  g083(.a(new_n140_), .b(new_n76_), .c(x33), .O(new_n141_));
  ...
  nand2  g088(.a(new_n145_), .b(new_n82_), .O(new_n146_));
  nand2  g089(.a(new_n146_), .b(new_n141_), .O(new_n147_));
  nand2  g090(.a(new_n147_), .b(x16), .O(new_n148_));
  inv1   g091(.a(x01), .O(new_n149_));
  aoi21  g092(.a(new_n55_), .b(new_n149_), .c(x18), .O(new_n150_));
  nand2  g093(.a(new_n150_), .b(new_n148_), .O(z14));
  nand4  g094(.a(new_n100_), .b(new_n89_), .c(new_n88_), .d(new_n67_), .O(new_n152_));
  oai21  g095(.a(new_n144_), .b(new_n152_), .c(x34), .O(new_n153_));
  nand2  g096(.a(new_n128_), .b(new_n142_), .O(new_n154_));
