...
module FAU ( 
  ...
  nand2  g019(.a(new_n54_), .b(new_n53_), .O(new_n73_));
  nor2   g020(.a(x23), .b(x22), .O(new_n74_));
  nand2  g021(.a(new_n74_), .b(new_n65_), .O(new_n75_));
  nor2   g022(.a(new_n75_), .b(new_n73_), .O(new_n76_));
  aoi21  g023(.a(new_n72_), .b(x23), .c(new_n76_), .O(new_n77_));
  ...
  nand3  g027(.a(new_n74_), .b(new_n56_), .c(new_n65_), .O(new_n81_));
  nor2   g028(.a(x24), .b(x23), .O(new_n82_));
  nand4  g029(.a(new_n82_), .b(new_n67_), .c(new_n54_), .d(new_n53_), .O(new_n83_));
  inv1   g030(.a(new_n83_), .O(new_n84_));
  aoi21  g031(.a(new_n81_), .b(x24), .c(new_n84_), .O(new_n85_));
  inv1   g032(.a(x10), .O(new_n86_));
  aoi21  g033(.a(new_n59_), .b(new_n86_), .c(x18), .O(new_n87_));
  oai21  g034(.a(new_n85_), .b(new_n59_), .c(new_n87_), .O(z05));
  ...
  nand4  g046(.a(new_n101_), .b(new_n82_), .c(new_n67_), .d(new_n56_), .O(new_n102_));
  ...
  oai21  g056(.a(new_n106_), .b(new_n72_), .c(x29), .O(new_n112_));
  ...
  oai21  g061(.a(new_n116_), .b(new_n81_), .c(new_n112_), .O(new_n117_));
  ...
  nand4  g068(.a(new_n125_), .b(new_n113_), .c(new_n124_), .d(new_n92_), .O(new_n126_));
  oai21  g069(.a(new_n126_), .b(new_n83_), .c(x32), .O(new_n127_));
  nor2   g070(.a(x30), .b(x29), .O(new_n128_));
  nor2   g071(.a(x32), .b(x31), .O(new_n129_));
  nand4  g072(.a(new_n129_), .b(new_n128_), .c(new_n114_), .d(new_n104_), .O(new_n130_));
  inv1   g073(.a(new_n130_), .O(new_n131_));
  nand2  g074(.a(new_n131_), .b(new_n84_), .O(new_n132_));
  ...
  oai21  g080(.a(new_n130_), .b(new_n83_), .c(x33), .O(new_n138_));
  nor2   g081(.a(x33), .b(x32), .O(new_n139_));
  nand4  g082(.a(new_n139_), .b(new_n125_), .c(new_n113_), .d(new_n124_), .O(new_n140_));
  inv1   g083(.a(new_n140_), .O(new_n141_));
  nand2  g084(.a(new_n141_), .b(new_n94_), .O(new_n142_));
  nand2  g085(.a(new_n142_), .b(new_n138_), .O(new_n143_));
  nand2  g086(.a(new_n143_), .b(x16), .O(new_n144_));
  inv1   g087(.a(x01), .O(new_n145_));
  aoi21  g088(.a(new_n59_), .b(new_n145_), .c(x18), .O(new_n146_));
  nand2  g089(.a(new_n146_), .b(new_n144_), .O(z14));
  nor2   g090(.a(x21), .b(x20), .O(new_n148_));
  nand4  g091(.a(new_n103_), .b(new_n74_), .c(new_n148_), .d(new_n54_), .O(new_n149_));
  oai21  g092(.a(new_n140_), .b(new_n149_), .c(x34), .O(new_n150_));
  nand2  g093(.a(new_n113_), .b(new_n124_), .O(new_n151_));
