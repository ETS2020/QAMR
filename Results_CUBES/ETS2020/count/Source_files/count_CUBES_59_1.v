...
module FAU ( 
  ...
  nand4  g054(.a(new_n107_), .b(new_n83_), .c(new_n70_), .d(new_n56_), .O(new_n108_));
  ...
  nor2   g059(.a(new_n112_), .b(new_n75_), .O(new_n113_));
  aoi21  g060(.a(new_n108_), .b(x28), .c(new_n113_), .O(new_n114_));
  inv1   g061(.a(x06), .O(new_n115_));
  aoi21  g062(.a(new_n59_), .b(new_n115_), .c(x18), .O(new_n116_));
  oai21  g063(.a(new_n114_), .b(new_n59_), .c(new_n116_), .O(z09));
  oai21  g064(.a(new_n112_), .b(new_n75_), .c(x29), .O(new_n118_));
  nor3   g065(.a(x29), .b(x28), .c(x27), .O(new_n119_));
  nand4  g066(.a(new_n119_), .b(new_n99_), .c(new_n76_), .d(new_n56_), .O(new_n120_));
  nand2  g067(.a(new_n120_), .b(new_n118_), .O(new_n121_));
  nand2  g068(.a(new_n121_), .b(x16), .O(new_n122_));
  inv1   g069(.a(x05), .O(new_n123_));
  aoi21  g070(.a(new_n59_), .b(new_n123_), .c(x18), .O(new_n124_));
  nand2  g071(.a(new_n124_), .b(new_n122_), .O(z10));
  inv1   g072(.a(x21), .O(new_n126_));
  nand4  g073(.a(new_n91_), .b(new_n54_), .c(new_n126_), .d(new_n53_), .O(new_n127_));
  nor2   g074(.a(x26), .b(x25), .O(new_n128_));
  nor2   g075(.a(x30), .b(x29), .O(new_n129_));
  nand4  g076(.a(new_n129_), .b(new_n111_), .c(new_n128_), .d(new_n81_), .O(new_n130_));
  ...
  nand4  g084(.a(new_n81_), .b(new_n109_), .c(new_n137_), .d(new_n126_), .O(new_n138_));
  ...
  nand4  g092(.a(new_n145_), .b(new_n107_), .c(new_n139_), .d(new_n56_), .O(new_n146_));
