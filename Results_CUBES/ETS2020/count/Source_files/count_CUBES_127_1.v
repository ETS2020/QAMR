// Benchmark "FAU" written by ABC on Tue Jul  7 19:19:07 2020
...
module FAU ( 
  ...
  wire new_n54_, new_n55_, new_n56_, new_n57_, new_n58_, new_n59_, new_n60_,
    ...
    new_n128_, new_n129_, new_n130_, new_n131_, new_n132_, new_n136_,
  ...
  nand3  g056(.a(new_n109_), .b(new_n81_), .c(new_n90_), .O(new_n110_));
  nor2   g057(.a(new_n110_), .b(new_n73_), .O(new_n111_));
  aoi21  g058(.a(new_n103_), .b(x27), .c(new_n111_), .O(new_n112_));
  inv1   g059(.a(x07), .O(new_n113_));
  aoi21  g060(.a(new_n54_), .b(new_n113_), .c(x18), .O(new_n114_));
  oai21  g061(.a(new_n112_), .b(new_n54_), .c(new_n114_), .O(z08));
  nor3   g062(.a(x27), .b(x26), .c(x25), .O(new_n116_));
  nand4  g063(.a(new_n116_), .b(new_n81_), .c(new_n68_), .d(new_n67_), .O(new_n117_));
  ...
  nor2   g067(.a(new_n120_), .b(new_n73_), .O(new_n121_));
  aoi21  g068(.a(new_n117_), .b(x28), .c(new_n121_), .O(new_n122_));
  inv1   g069(.a(x06), .O(new_n123_));
  aoi21  g070(.a(new_n54_), .b(new_n123_), .c(x18), .O(new_n124_));
  oai21  g071(.a(new_n122_), .b(new_n54_), .c(new_n124_), .O(z09));
  inv1   g072(.a(x29), .O(new_n126_));
  nor3   g073(.a(x29), .b(x28), .c(x27), .O(new_n127_));
  nand4  g074(.a(new_n127_), .b(new_n102_), .c(new_n74_), .d(new_n67_), .O(new_n128_));
  ...
  aoi21  g078(.a(new_n54_), .b(new_n131_), .c(x18), .O(new_n132_));
  nand2  g079(.a(new_n132_), .b(new_n130_), .O(z10));
  nor2   g080(.a(x29), .b(x28), .O(new_n136_));
  nor2   g081(.a(x31), .b(x30), .O(new_n137_));
  nand4  g082(.a(new_n137_), .b(new_n136_), .c(new_n109_), .d(new_n90_), .O(new_n138_));
  oai21  g083(.a(new_n138_), .b(new_n82_), .c(x32), .O(new_n139_));
  nor2   g084(.a(x26), .b(x25), .O(new_n140_));
  nor2   g085(.a(x30), .b(x29), .O(new_n141_));
  nor2   g086(.a(x32), .b(x31), .O(new_n142_));
  nand4  g087(.a(new_n142_), .b(new_n141_), .c(new_n118_), .d(new_n140_), .O(new_n143_));
  inv1   g088(.a(new_n143_), .O(new_n144_));
  nand2  g089(.a(new_n144_), .b(new_n83_), .O(new_n145_));
  nand2  g090(.a(new_n145_), .b(new_n139_), .O(new_n146_));
  nand2  g091(.a(new_n146_), .b(x16), .O(new_n147_));
  inv1   g092(.a(x02), .O(new_n148_));
  aoi21  g093(.a(new_n54_), .b(new_n148_), .c(x18), .O(new_n149_));
  nand2  g094(.a(new_n149_), .b(new_n147_), .O(z13));
  oai21  g095(.a(new_n143_), .b(new_n82_), .c(x33), .O(new_n151_));
  nor2   g096(.a(x33), .b(x32), .O(new_n152_));
  nand4  g097(.a(new_n152_), .b(new_n137_), .c(new_n136_), .d(new_n109_), .O(new_n153_));
  inv1   g098(.a(new_n153_), .O(new_n154_));
  nand2  g099(.a(new_n154_), .b(new_n92_), .O(new_n155_));
  nand2  g100(.a(new_n155_), .b(new_n151_), .O(new_n156_));
  nand2  g101(.a(new_n156_), .b(x16), .O(new_n157_));
  inv1   g102(.a(x01), .O(new_n158_));
  aoi21  g103(.a(new_n54_), .b(new_n158_), .c(x18), .O(new_n159_));
  nand2  g104(.a(new_n159_), .b(new_n157_), .O(z14));
  oai21  g105(.a(new_n153_), .b(new_n100_), .c(x34), .O(new_n161_));
  nand2  g106(.a(new_n136_), .b(new_n109_), .O(new_n162_));
  inv1   g107(.a(new_n162_), .O(new_n163_));
  inv1   g108(.a(x30), .O(new_n164_));
  inv1   g109(.a(x31), .O(new_n165_));
  nand2  g110(.a(new_n165_), .b(new_n164_), .O(new_n166_));
  inv1   g111(.a(x32), .O(new_n167_));
  inv1   g112(.a(x33), .O(new_n168_));
  inv1   g113(.a(x34), .O(new_n169_));
  nand3  g114(.a(new_n169_), .b(new_n168_), .c(new_n167_), .O(new_n170_));
  nor2   g115(.a(new_n170_), .b(new_n166_), .O(new_n171_));
  nand3  g116(.a(new_n171_), .b(new_n163_), .c(new_n92_), .O(new_n172_));
  nand2  g117(.a(new_n172_), .b(new_n161_), .O(new_n173_));
  nand2  g118(.a(new_n173_), .b(x16), .O(new_n174_));
  inv1   g119(.a(x00), .O(new_n175_));
  aoi21  g120(.a(new_n54_), .b(new_n175_), .c(x18), .O(new_n176_));
  nand2  g121(.a(new_n176_), .b(new_n174_), .O(z15));
  zero   g122(.O(z00));
  zero   g123(.O(z01));
  zero   g124(.O(z11));
  zero   g125(.O(z12));
