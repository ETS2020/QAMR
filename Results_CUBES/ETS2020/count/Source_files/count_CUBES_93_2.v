...
module FAU ( 
  ...
  nand4  g090(.a(new_n136_), .b(new_n135_), .c(new_n99_), .d(new_n98_), .O(new_n145_));
  oai21  g091(.a(new_n145_), .b(new_n87_), .c(x32), .O(new_n146_));
  nor2   g092(.a(x32), .b(x31), .O(new_n147_));
  nand4  g093(.a(new_n147_), .b(new_n127_), .c(new_n108_), .d(new_n126_), .O(new_n148_));
  inv1   g094(.a(new_n148_), .O(new_n149_));
  nand2  g095(.a(new_n149_), .b(new_n88_), .O(new_n150_));
  ...
  oai21  g101(.a(new_n148_), .b(new_n87_), .c(x33), .O(new_n156_));
  inv1   g102(.a(x22), .O(new_n157_));
  inv1   g103(.a(x23), .O(new_n158_));
  nand4  g104(.a(new_n98_), .b(new_n84_), .c(new_n158_), .d(new_n157_), .O(new_n159_));
  nor2   g105(.a(new_n159_), .b(new_n70_), .O(new_n160_));
  nor2   g106(.a(x33), .b(x32), .O(new_n161_));
  nand4  g107(.a(new_n161_), .b(new_n136_), .c(new_n135_), .d(new_n99_), .O(new_n162_));
  inv1   g108(.a(new_n162_), .O(new_n163_));
  nand2  g109(.a(new_n163_), .b(new_n160_), .O(new_n164_));
  nand2  g110(.a(new_n164_), .b(new_n156_), .O(new_n165_));
  ...
  nor2   g115(.a(x21), .b(x20), .O(new_n170_));
  nand4  g116(.a(new_n109_), .b(new_n95_), .c(new_n170_), .d(new_n55_), .O(new_n171_));
  oai21  g117(.a(new_n162_), .b(new_n171_), .c(x34), .O(new_n172_));
  nand2  g118(.a(new_n135_), .b(new_n99_), .O(new_n173_));
  ...
  nand3  g128(.a(new_n182_), .b(new_n174_), .c(new_n160_), .O(new_n183_));
