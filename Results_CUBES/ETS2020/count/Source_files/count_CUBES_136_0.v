...
module FAU ( 
  ...
  inv1   g033(.a(new_n65_), .O(new_n87_));
  ...
  oai21  g043(.a(new_n91_), .b(new_n65_), .c(x26), .O(new_n97_));
  ...
  nand3  g053(.a(new_n106_), .b(new_n80_), .c(new_n90_), .O(new_n107_));
  ...
  nor2   g065(.a(new_n118_), .b(new_n72_), .O(new_n119_));
  ...
  oai21  g070(.a(new_n118_), .b(new_n72_), .c(x29), .O(new_n124_));
  nor3   g071(.a(x29), .b(x28), .c(x27), .O(new_n125_));
  nand4  g072(.a(new_n125_), .b(new_n99_), .c(new_n73_), .d(new_n67_), .O(new_n126_));
  ...
  nand4  g078(.a(new_n98_), .b(new_n55_), .c(new_n64_), .d(new_n63_), .O(new_n133_));
  nor2   g079(.a(x26), .b(x25), .O(new_n134_));
  nor2   g080(.a(x30), .b(x29), .O(new_n135_));
  nand4  g081(.a(new_n135_), .b(new_n117_), .c(new_n134_), .d(new_n78_), .O(new_n136_));
  oai21  g082(.a(new_n136_), .b(new_n133_), .c(x31), .O(new_n137_));
  nand4  g083(.a(new_n78_), .b(new_n89_), .c(new_n88_), .d(new_n64_), .O(new_n138_));
  ...
  nand4  g091(.a(new_n145_), .b(new_n113_), .c(new_n139_), .d(new_n67_), .O(new_n146_));
  ...
  nand4  g099(.a(new_n153_), .b(new_n152_), .c(new_n106_), .d(new_n90_), .O(new_n154_));
  oai21  g100(.a(new_n154_), .b(new_n81_), .c(x32), .O(new_n155_));
  ...
  nand4  g107(.a(new_n161_), .b(new_n158_), .c(new_n139_), .d(new_n67_), .O(new_n162_));
  ...
  nand4  g114(.a(new_n168_), .b(new_n135_), .c(new_n117_), .d(new_n134_), .O(new_n169_));
  oai21  g115(.a(new_n169_), .b(new_n81_), .c(x33), .O(new_n170_));
  ...
  nand4  g119(.a(new_n173_), .b(new_n145_), .c(new_n92_), .d(new_n87_), .O(new_n174_));
