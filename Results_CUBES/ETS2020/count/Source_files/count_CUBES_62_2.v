...
module FAU ( 
  ...
  nand3  g050(.a(new_n104_), .b(new_n80_), .c(new_n91_), .O(new_n105_));
  ...
  nand4  g058(.a(new_n113_), .b(new_n112_), .c(new_n88_), .d(new_n90_), .O(new_n114_));
  oai21  g059(.a(new_n114_), .b(new_n103_), .c(x29), .O(new_n115_));
  ...
  nand4  g067(.a(new_n95_), .b(new_n55_), .c(new_n69_), .d(new_n61_), .O(new_n123_));
  nor2   g068(.a(x26), .b(x25), .O(new_n124_));
  nor2   g069(.a(x30), .b(x29), .O(new_n125_));
  nand4  g070(.a(new_n125_), .b(new_n113_), .c(new_n124_), .d(new_n77_), .O(new_n126_));
  ...
  nand3  g082(.a(new_n137_), .b(new_n133_), .c(new_n82_), .O(new_n138_));
  ...
  nand4  g088(.a(new_n135_), .b(new_n134_), .c(new_n104_), .d(new_n91_), .O(new_n144_));
  oai21  g089(.a(new_n144_), .b(new_n81_), .c(x32), .O(new_n145_));
  nor2   g090(.a(x32), .b(x31), .O(new_n146_));
  nand4  g091(.a(new_n146_), .b(new_n125_), .c(new_n113_), .d(new_n124_), .O(new_n147_));
  ...
  nand4  g101(.a(new_n156_), .b(new_n135_), .c(new_n134_), .d(new_n104_), .O(new_n157_));
  ...
  nand4  g109(.a(new_n112_), .b(new_n95_), .c(new_n94_), .d(new_n55_), .O(new_n165_));
  oai21  g110(.a(new_n157_), .b(new_n165_), .c(x34), .O(new_n166_));
  nand2  g111(.a(new_n134_), .b(new_n104_), .O(new_n167_));
