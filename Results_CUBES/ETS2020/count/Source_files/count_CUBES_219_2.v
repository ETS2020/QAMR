// Benchmark "FAU" written by ABC on Tue Jul  7 19:20:39 2020
...
module FAU ( 
  ...
  nand4  g049(.a(new_n105_), .b(new_n104_), .c(new_n103_), .d(new_n102_), .O(new_n106_));
  oai21  g050(.a(new_n106_), .b(new_n72_), .c(x29), .O(new_n107_));
  nor3   g051(.a(x29), .b(x28), .c(x27), .O(new_n108_));
  nand4  g052(.a(new_n108_), .b(new_n91_), .c(new_n73_), .d(new_n56_), .O(new_n109_));
  ...
  nand4  g061(.a(new_n117_), .b(new_n104_), .c(new_n116_), .d(new_n78_), .O(new_n118_));
  ...
  nand3  g073(.a(new_n129_), .b(new_n125_), .c(new_n82_), .O(new_n130_));
  ...
  nand4  g079(.a(new_n127_), .b(new_n126_), .c(new_n94_), .d(new_n93_), .O(new_n136_));
  oai21  g080(.a(new_n136_), .b(new_n81_), .c(x32), .O(new_n137_));
  nand2  g081(.a(new_n117_), .b(new_n104_), .O(new_n138_));
  inv1   g082(.a(x31), .O(new_n139_));
  inv1   g083(.a(x32), .O(new_n140_));
  nand4  g084(.a(new_n140_), .b(new_n139_), .c(new_n103_), .d(new_n93_), .O(new_n141_));
  nor2   g085(.a(new_n141_), .b(new_n138_), .O(new_n142_));
  nand2  g086(.a(new_n142_), .b(new_n82_), .O(new_n143_));
  ...
  nand4  g092(.a(new_n105_), .b(new_n90_), .c(new_n89_), .d(new_n54_), .O(new_n150_));
  nor2   g093(.a(x33), .b(x32), .O(new_n151_));
  nand4  g094(.a(new_n151_), .b(new_n127_), .c(new_n126_), .d(new_n94_), .O(new_n152_));
  oai21  g095(.a(new_n152_), .b(new_n150_), .c(x34), .O(new_n153_));
  inv1   g096(.a(x22), .O(new_n154_));
  nand4  g097(.a(new_n93_), .b(new_n78_), .c(new_n102_), .d(new_n154_), .O(new_n155_));
  nor2   g098(.a(new_n155_), .b(new_n66_), .O(new_n156_));
  nand2  g099(.a(new_n126_), .b(new_n94_), .O(new_n157_));
  inv1   g100(.a(new_n157_), .O(new_n158_));
  inv1   g101(.a(x30), .O(new_n159_));
  nand2  g102(.a(new_n139_), .b(new_n159_), .O(new_n160_));
  inv1   g103(.a(x33), .O(new_n161_));
  inv1   g104(.a(x34), .O(new_n162_));
  nand3  g105(.a(new_n162_), .b(new_n161_), .c(new_n140_), .O(new_n163_));
  nor2   g106(.a(new_n163_), .b(new_n160_), .O(new_n164_));
  nand3  g107(.a(new_n164_), .b(new_n158_), .c(new_n156_), .O(new_n165_));
  nand2  g108(.a(new_n165_), .b(new_n153_), .O(new_n166_));
  nand2  g109(.a(new_n166_), .b(x16), .O(new_n167_));
  inv1   g110(.a(x00), .O(new_n168_));
  aoi21  g111(.a(new_n59_), .b(new_n168_), .c(x18), .O(new_n169_));
