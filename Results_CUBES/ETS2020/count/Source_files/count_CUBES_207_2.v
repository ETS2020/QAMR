// Benchmark "FAU" written by ABC on Tue Jul  7 19:20:27 2020
...
module FAU ( 
  ...
  aoi21  g048(.a(new_n59_), .b(new_n102_), .c(x18), .O(new_n103_));
  oai21  g049(.a(new_n101_), .b(new_n59_), .c(new_n103_), .O(z08));
  nor3   g050(.a(x27), .b(x26), .c(x25), .O(new_n105_));
  nand4  g051(.a(new_n105_), .b(new_n85_), .c(new_n72_), .d(new_n56_), .O(new_n106_));
  ...
  nand4  g063(.a(new_n117_), .b(new_n95_), .c(new_n78_), .d(new_n56_), .O(new_n118_));
  ...
  nand4  g069(.a(new_n94_), .b(new_n54_), .c(new_n65_), .d(new_n53_), .O(new_n124_));
  ...
  nand3  g083(.a(new_n137_), .b(new_n105_), .c(new_n87_), .O(new_n138_));
  ...
  nand4  g089(.a(new_n135_), .b(new_n134_), .c(new_n98_), .d(new_n97_), .O(new_n144_));
  oai21  g090(.a(new_n144_), .b(new_n86_), .c(x32), .O(new_n145_));
  nor2   g091(.a(x32), .b(x31), .O(new_n146_));
  nand4  g092(.a(new_n146_), .b(new_n126_), .c(new_n107_), .d(new_n125_), .O(new_n147_));
  inv1   g093(.a(new_n147_), .O(new_n148_));
  nand2  g094(.a(new_n148_), .b(new_n87_), .O(new_n149_));
  nand2  g095(.a(new_n149_), .b(new_n145_), .O(new_n150_));
  nand2  g096(.a(new_n150_), .b(x16), .O(new_n151_));
  inv1   g097(.a(x02), .O(new_n152_));
  aoi21  g098(.a(new_n59_), .b(new_n152_), .c(x18), .O(new_n153_));
  nand2  g099(.a(new_n153_), .b(new_n151_), .O(z13));
  oai21  g100(.a(new_n147_), .b(new_n86_), .c(x33), .O(new_n155_));
  inv1   g101(.a(x22), .O(new_n156_));
  inv1   g102(.a(x23), .O(new_n157_));
  nand4  g103(.a(new_n97_), .b(new_n83_), .c(new_n157_), .d(new_n156_), .O(new_n158_));
  nor2   g104(.a(new_n158_), .b(new_n66_), .O(new_n159_));
  nor2   g105(.a(x33), .b(x32), .O(new_n160_));
  nand4  g106(.a(new_n160_), .b(new_n135_), .c(new_n134_), .d(new_n98_), .O(new_n161_));
  inv1   g107(.a(new_n161_), .O(new_n162_));
  nand2  g108(.a(new_n162_), .b(new_n159_), .O(new_n163_));
  nand2  g109(.a(new_n163_), .b(new_n155_), .O(new_n164_));
  nand2  g110(.a(new_n164_), .b(x16), .O(new_n165_));
  inv1   g111(.a(x01), .O(new_n166_));
  aoi21  g112(.a(new_n59_), .b(new_n166_), .c(x18), .O(new_n167_));
  nand2  g113(.a(new_n167_), .b(new_n165_), .O(z14));
  nor2   g114(.a(x21), .b(x20), .O(new_n169_));
  nand4  g115(.a(new_n108_), .b(new_n94_), .c(new_n169_), .d(new_n54_), .O(new_n170_));
  oai21  g116(.a(new_n161_), .b(new_n170_), .c(x34), .O(new_n171_));
  nand2  g117(.a(new_n134_), .b(new_n98_), .O(new_n172_));
  ...
  nand3  g127(.a(new_n181_), .b(new_n173_), .c(new_n159_), .O(new_n182_));
