...
module FAU ( 
  ...
  nand3  g053(.a(new_n109_), .b(new_n108_), .c(new_n88_), .O(new_n110_));
  oai21  g054(.a(new_n110_), .b(new_n98_), .c(x29), .O(new_n111_));
  nor3   g055(.a(x29), .b(x28), .c(x27), .O(new_n112_));
  nand4  g056(.a(new_n112_), .b(new_n91_), .c(new_n75_), .d(new_n74_), .O(new_n113_));
  nand2  g057(.a(new_n113_), .b(new_n111_), .O(new_n114_));
  ...
  nand4  g062(.a(new_n87_), .b(new_n55_), .c(new_n64_), .d(new_n62_), .O(new_n119_));
  nor2   g063(.a(x26), .b(x25), .O(new_n120_));
  nor2   g064(.a(x30), .b(x29), .O(new_n121_));
  nand4  g065(.a(new_n121_), .b(new_n108_), .c(new_n120_), .d(new_n73_), .O(new_n122_));
  nor2   g066(.a(new_n122_), .b(new_n119_), .O(new_n123_));
  aoi21  g067(.a(new_n113_), .b(x30), .c(new_n123_), .O(new_n124_));
  ...
  oai21  g071(.a(new_n122_), .b(new_n119_), .c(x31), .O(new_n128_));
  ...
  nand3  g077(.a(new_n133_), .b(new_n129_), .c(new_n80_), .O(new_n134_));
  nand2  g078(.a(new_n134_), .b(new_n128_), .O(new_n135_));
  ...
  nand4  g083(.a(new_n131_), .b(new_n130_), .c(new_n100_), .d(new_n99_), .O(new_n140_));
  oai21  g084(.a(new_n140_), .b(new_n79_), .c(x32), .O(new_n141_));
  nor2   g085(.a(x32), .b(x31), .O(new_n142_));
  nand4  g086(.a(new_n142_), .b(new_n121_), .c(new_n108_), .d(new_n120_), .O(new_n143_));
  inv1   g087(.a(new_n143_), .O(new_n144_));
  nand2  g088(.a(new_n144_), .b(new_n80_), .O(new_n145_));
  nand2  g089(.a(new_n145_), .b(new_n141_), .O(new_n146_));
  nand2  g090(.a(new_n146_), .b(x16), .O(new_n147_));
  inv1   g091(.a(x02), .O(new_n148_));
  aoi21  g092(.a(new_n58_), .b(new_n148_), .c(x18), .O(new_n149_));
  nand2  g093(.a(new_n149_), .b(new_n147_), .O(z13));
  oai21  g094(.a(new_n143_), .b(new_n79_), .c(x33), .O(new_n151_));
  inv1   g095(.a(x22), .O(new_n152_));
  inv1   g096(.a(x23), .O(new_n153_));
  nand4  g097(.a(new_n99_), .b(new_n73_), .c(new_n153_), .d(new_n152_), .O(new_n154_));
  nor2   g098(.a(new_n154_), .b(new_n65_), .O(new_n155_));
  nor2   g099(.a(x33), .b(x32), .O(new_n156_));
  nand4  g100(.a(new_n156_), .b(new_n131_), .c(new_n130_), .d(new_n100_), .O(new_n157_));
  inv1   g101(.a(new_n157_), .O(new_n158_));
  nand2  g102(.a(new_n158_), .b(new_n155_), .O(new_n159_));
  nand2  g103(.a(new_n159_), .b(new_n151_), .O(new_n160_));
  ...
  oai21  g108(.a(new_n157_), .b(new_n89_), .c(x34), .O(new_n165_));
  nand2  g109(.a(new_n130_), .b(new_n100_), .O(new_n166_));
