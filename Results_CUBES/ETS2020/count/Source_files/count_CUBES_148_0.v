...
module FAU ( 
  ...
  nor2   g067(.a(x26), .b(x23), .O(new_n121_));
  nand3  g068(.a(new_n121_), .b(new_n120_), .c(new_n100_), .O(new_n122_));
  ...
  nand4  g084(.a(new_n139_), .b(new_n138_), .c(new_n111_), .d(new_n91_), .O(new_n140_));
  oai21  g085(.a(new_n140_), .b(new_n83_), .c(x32), .O(new_n141_));
  nor2   g086(.a(x26), .b(x25), .O(new_n142_));
  nor2   g087(.a(x30), .b(x29), .O(new_n143_));
  nor2   g088(.a(x32), .b(x31), .O(new_n144_));
  nand4  g089(.a(new_n144_), .b(new_n143_), .c(new_n120_), .d(new_n142_), .O(new_n145_));
  ...
  nand4  g099(.a(new_n154_), .b(new_n139_), .c(new_n138_), .d(new_n111_), .O(new_n155_));
  ...
  nand2  g108(.a(new_n138_), .b(new_n111_), .O(new_n164_));
