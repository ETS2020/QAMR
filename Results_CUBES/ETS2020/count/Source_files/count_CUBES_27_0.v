...
module FAU ( 
  ...
  nor2   g056(.a(x23), .b(x22), .O(new_n113_));
  nand4  g057(.a(new_n113_), .b(new_n54_), .c(new_n65_), .d(new_n53_), .O(new_n114_));
  nor2   g058(.a(x26), .b(x25), .O(new_n115_));
  nor2   g059(.a(x30), .b(x29), .O(new_n116_));
  nand4  g060(.a(new_n116_), .b(new_n115_), .c(new_n96_), .d(new_n83_), .O(new_n117_));
  nor2   g061(.a(new_n117_), .b(new_n114_), .O(new_n118_));
  aoi21  g062(.a(new_n107_), .b(x30), .c(new_n118_), .O(new_n119_));
  ...
  nor2   g066(.a(x27), .b(x26), .O(new_n124_));
  nor2   g067(.a(x29), .b(x28), .O(new_n125_));
  nor2   g068(.a(x31), .b(x30), .O(new_n126_));
  nand4  g069(.a(new_n126_), .b(new_n125_), .c(new_n124_), .d(new_n84_), .O(new_n127_));
  oai21  g070(.a(new_n127_), .b(new_n80_), .c(x32), .O(new_n128_));
  nand2  g071(.a(new_n79_), .b(new_n67_), .O(new_n129_));
  inv1   g072(.a(new_n129_), .O(new_n130_));
  nor2   g073(.a(x32), .b(x31), .O(new_n131_));
  nand2  g074(.a(new_n131_), .b(new_n96_), .O(new_n132_));
  inv1   g075(.a(new_n132_), .O(new_n133_));
  nand2  g076(.a(new_n116_), .b(new_n115_), .O(new_n134_));
  inv1   g077(.a(new_n134_), .O(new_n135_));
  nand4  g078(.a(new_n135_), .b(new_n133_), .c(new_n130_), .d(new_n56_), .O(new_n136_));
  nand2  g079(.a(new_n136_), .b(new_n128_), .O(new_n137_));
  nand2  g080(.a(new_n137_), .b(x16), .O(new_n138_));
  inv1   g081(.a(x02), .O(new_n139_));
  aoi21  g082(.a(new_n59_), .b(new_n139_), .c(x18), .O(new_n140_));
  nand2  g083(.a(new_n140_), .b(new_n138_), .O(z13));
  nand4  g084(.a(new_n131_), .b(new_n116_), .c(new_n115_), .d(new_n96_), .O(new_n142_));
  oai21  g085(.a(new_n142_), .b(new_n80_), .c(x33), .O(new_n143_));
  nor2   g086(.a(x33), .b(x32), .O(new_n144_));
  nand4  g087(.a(new_n144_), .b(new_n126_), .c(new_n125_), .d(new_n124_), .O(new_n145_));
  inv1   g088(.a(new_n145_), .O(new_n146_));
  nand2  g089(.a(new_n146_), .b(new_n86_), .O(new_n147_));
  ...
  nand4  g096(.a(new_n95_), .b(new_n113_), .c(new_n153_), .d(new_n54_), .O(new_n154_));
  oai21  g097(.a(new_n145_), .b(new_n154_), .c(x34), .O(new_n155_));
  nand2  g098(.a(new_n125_), .b(new_n124_), .O(new_n156_));
  ...
  nand3  g108(.a(new_n165_), .b(new_n157_), .c(new_n86_), .O(new_n166_));
