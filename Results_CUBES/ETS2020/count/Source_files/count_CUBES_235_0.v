...
module FAU ( 
  ...
  nand4  g081(.a(new_n136_), .b(new_n135_), .c(new_n134_), .d(new_n88_), .O(new_n137_));
  oai21  g082(.a(new_n137_), .b(new_n84_), .c(x32), .O(new_n138_));
  nand2  g083(.a(new_n83_), .b(new_n71_), .O(new_n139_));
  inv1   g084(.a(new_n139_), .O(new_n140_));
  nand2  g085(.a(new_n126_), .b(new_n109_), .O(new_n141_));
  inv1   g086(.a(new_n141_), .O(new_n142_));
  nor2   g087(.a(x32), .b(x31), .O(new_n143_));
  nand2  g088(.a(new_n143_), .b(new_n125_), .O(new_n144_));
  inv1   g089(.a(new_n144_), .O(new_n145_));
  nand4  g090(.a(new_n145_), .b(new_n142_), .c(new_n140_), .d(new_n63_), .O(new_n146_));
  nand2  g091(.a(new_n146_), .b(new_n138_), .O(new_n147_));
  ...
  nand4  g096(.a(new_n143_), .b(new_n126_), .c(new_n109_), .d(new_n125_), .O(new_n152_));
  oai21  g097(.a(new_n152_), .b(new_n84_), .c(x33), .O(new_n153_));
  nor2   g098(.a(x33), .b(x32), .O(new_n154_));
  nand4  g099(.a(new_n154_), .b(new_n136_), .c(new_n135_), .d(new_n134_), .O(new_n155_));
  inv1   g100(.a(new_n155_), .O(new_n156_));
  nand2  g101(.a(new_n156_), .b(new_n90_), .O(new_n157_));
  ...
  nand4  g107(.a(new_n108_), .b(new_n97_), .c(new_n96_), .d(new_n55_), .O(new_n163_));
  oai21  g108(.a(new_n155_), .b(new_n163_), .c(x34), .O(new_n164_));
  nand2  g109(.a(new_n135_), .b(new_n134_), .O(new_n165_));
  ...
  nand3  g119(.a(new_n174_), .b(new_n166_), .c(new_n90_), .O(new_n175_));
