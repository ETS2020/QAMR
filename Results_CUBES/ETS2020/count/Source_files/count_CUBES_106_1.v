...
module FAU ( 
  ...
  nand4  g102(.a(new_n156_), .b(new_n140_), .c(new_n121_), .d(new_n139_), .O(new_n157_));
  oai21  g103(.a(new_n157_), .b(new_n89_), .c(x33), .O(new_n158_));
  nor2   g104(.a(x33), .b(x32), .O(new_n159_));
  nand4  g105(.a(new_n159_), .b(new_n146_), .c(new_n145_), .d(new_n112_), .O(new_n160_));
  inv1   g106(.a(new_n160_), .O(new_n161_));
  nand2  g107(.a(new_n161_), .b(new_n95_), .O(new_n162_));
  ...
  oai21  g113(.a(new_n160_), .b(new_n103_), .c(x34), .O(new_n168_));
  nand2  g114(.a(new_n145_), .b(new_n112_), .O(new_n169_));
  ...
  nand3  g124(.a(new_n178_), .b(new_n170_), .c(new_n95_), .O(new_n179_));
