...
module FAU ( 
  ...
  nor2   g035(.a(x21), .b(x20), .O(new_n90_));
  nor2   g036(.a(x23), .b(x22), .O(new_n91_));
  nor2   g037(.a(x25), .b(x24), .O(new_n92_));
  nand4  g038(.a(new_n92_), .b(new_n91_), .c(new_n90_), .d(new_n55_), .O(new_n93_));
  nand2  g039(.a(new_n93_), .b(x26), .O(new_n94_));
  nor3   g040(.a(x26), .b(x25), .c(x24), .O(new_n95_));
  nand3  g041(.a(new_n95_), .b(new_n91_), .c(new_n66_), .O(new_n96_));
  nand2  g042(.a(new_n96_), .b(new_n94_), .O(new_n97_));
  ...
  nand3  g049(.a(new_n103_), .b(new_n82_), .c(new_n102_), .O(new_n104_));
  nor2   g050(.a(new_n104_), .b(new_n74_), .O(new_n105_));
  ...
  nand3  g057(.a(new_n112_), .b(new_n111_), .c(new_n92_), .O(new_n113_));
  oai21  g058(.a(new_n113_), .b(new_n74_), .c(x29), .O(new_n114_));
  nor3   g059(.a(x29), .b(x28), .c(x27), .O(new_n115_));
  nand4  g060(.a(new_n115_), .b(new_n95_), .c(new_n75_), .d(new_n72_), .O(new_n116_));
  ...
  nand4  g066(.a(new_n91_), .b(new_n55_), .c(new_n64_), .d(new_n62_), .O(new_n122_));
  nor2   g067(.a(x26), .b(x25), .O(new_n123_));
  nor2   g068(.a(x30), .b(x29), .O(new_n124_));
  nand4  g069(.a(new_n124_), .b(new_n111_), .c(new_n123_), .d(new_n80_), .O(new_n125_));
  ...
  nand3  g081(.a(new_n136_), .b(new_n132_), .c(new_n84_), .O(new_n137_));
  ...
  nand4  g087(.a(new_n134_), .b(new_n133_), .c(new_n103_), .d(new_n102_), .O(new_n143_));
  oai21  g088(.a(new_n143_), .b(new_n83_), .c(x32), .O(new_n144_));
  nor2   g089(.a(x32), .b(x31), .O(new_n145_));
  nand4  g090(.a(new_n145_), .b(new_n124_), .c(new_n111_), .d(new_n123_), .O(new_n146_));
  inv1   g091(.a(new_n146_), .O(new_n147_));
  nand2  g092(.a(new_n147_), .b(new_n84_), .O(new_n148_));
  ...
  oai21  g098(.a(new_n146_), .b(new_n83_), .c(x33), .O(new_n154_));
  inv1   g099(.a(x22), .O(new_n155_));
  inv1   g100(.a(x23), .O(new_n156_));
  nand4  g101(.a(new_n102_), .b(new_n80_), .c(new_n156_), .d(new_n155_), .O(new_n157_));
  nor2   g102(.a(new_n157_), .b(new_n65_), .O(new_n158_));
  nor2   g103(.a(x33), .b(x32), .O(new_n159_));
  nand4  g104(.a(new_n159_), .b(new_n134_), .c(new_n133_), .d(new_n103_), .O(new_n160_));
  inv1   g105(.a(new_n160_), .O(new_n161_));
  nand2  g106(.a(new_n161_), .b(new_n158_), .O(new_n162_));
  nand2  g107(.a(new_n162_), .b(new_n154_), .O(new_n163_));
  nand2  g108(.a(new_n163_), .b(x16), .O(new_n164_));
  inv1   g109(.a(x01), .O(new_n165_));
  aoi21  g110(.a(new_n58_), .b(new_n165_), .c(x18), .O(new_n166_));
  nand2  g111(.a(new_n166_), .b(new_n164_), .O(z14));
  oai21  g112(.a(new_n160_), .b(new_n93_), .c(x34), .O(new_n168_));
  nand2  g113(.a(new_n133_), .b(new_n103_), .O(new_n169_));
