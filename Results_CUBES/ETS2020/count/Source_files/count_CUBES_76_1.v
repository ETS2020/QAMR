...
module FAU ( 
  ...
  nand4  g070(.a(new_n124_), .b(new_n103_), .c(new_n78_), .d(new_n56_), .O(new_n125_));
  nand4  g071(.a(new_n102_), .b(new_n54_), .c(new_n65_), .d(new_n53_), .O(new_n126_));
  ...
  nand3  g085(.a(new_n139_), .b(new_n112_), .c(new_n87_), .O(new_n140_));
  ...
  nand4  g091(.a(new_n137_), .b(new_n136_), .c(new_n105_), .d(new_n94_), .O(new_n146_));
  ...
  nand4  g104(.a(new_n158_), .b(new_n137_), .c(new_n136_), .d(new_n105_), .O(new_n159_));
  ...
  nor2   g112(.a(x21), .b(x20), .O(new_n167_));
  nand4  g113(.a(new_n114_), .b(new_n102_), .c(new_n167_), .d(new_n54_), .O(new_n168_));
  oai21  g114(.a(new_n159_), .b(new_n168_), .c(x34), .O(new_n169_));
  nand2  g115(.a(new_n136_), .b(new_n105_), .O(new_n170_));
