...
module FAU ( 
  ...
  inv1   g063(.a(x26), .O(new_n118_));
  nor2   g064(.a(x28), .b(x27), .O(new_n119_));
  nand4  g065(.a(new_n119_), .b(new_n99_), .c(new_n118_), .d(new_n89_), .O(new_n120_));
  ...
  nand4  g077(.a(new_n131_), .b(new_n119_), .c(new_n130_), .d(new_n78_), .O(new_n132_));
  ...
  nand2  g097(.a(new_n131_), .b(new_n119_), .O(new_n152_));
  inv1   g098(.a(x31), .O(new_n153_));
  inv1   g099(.a(x32), .O(new_n154_));
  nand4  g100(.a(new_n154_), .b(new_n153_), .c(new_n118_), .d(new_n90_), .O(new_n155_));
