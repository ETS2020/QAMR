...
module FAU ( 
  ...
  nand4  g070(.a(new_n127_), .b(new_n126_), .c(new_n99_), .d(new_n98_), .O(new_n128_));
  oai21  g071(.a(new_n128_), .b(new_n78_), .c(x32), .O(new_n129_));
  ...
  nand2  g077(.a(new_n134_), .b(new_n79_), .O(new_n135_));
  nand2  g078(.a(new_n135_), .b(new_n129_), .O(new_n136_));
  nand2  g079(.a(new_n136_), .b(x16), .O(new_n137_));
  inv1   g080(.a(x02), .O(new_n138_));
  aoi21  g081(.a(new_n54_), .b(new_n138_), .c(x18), .O(new_n139_));
  nand2  g082(.a(new_n139_), .b(new_n137_), .O(z13));
  oai21  g083(.a(new_n133_), .b(new_n78_), .c(x33), .O(new_n141_));
  inv1   g084(.a(x22), .O(new_n142_));
  inv1   g085(.a(x23), .O(new_n143_));
  nand4  g086(.a(new_n98_), .b(new_n74_), .c(new_n143_), .d(new_n142_), .O(new_n144_));
  nor2   g087(.a(new_n144_), .b(new_n61_), .O(new_n145_));
  nor2   g088(.a(x33), .b(x32), .O(new_n146_));
  nand4  g089(.a(new_n146_), .b(new_n127_), .c(new_n126_), .d(new_n99_), .O(new_n147_));
  inv1   g090(.a(new_n147_), .O(new_n148_));
  nand2  g091(.a(new_n148_), .b(new_n145_), .O(new_n149_));
  nand2  g092(.a(new_n149_), .b(new_n141_), .O(new_n150_));
  nand2  g093(.a(new_n150_), .b(x16), .O(new_n151_));
  inv1   g094(.a(x01), .O(new_n152_));
  aoi21  g095(.a(new_n54_), .b(new_n152_), .c(x18), .O(new_n153_));
  nand2  g096(.a(new_n153_), .b(new_n151_), .O(z14));
  oai21  g097(.a(new_n147_), .b(new_n88_), .c(x34), .O(new_n155_));
  nand2  g098(.a(new_n126_), .b(new_n99_), .O(new_n156_));
