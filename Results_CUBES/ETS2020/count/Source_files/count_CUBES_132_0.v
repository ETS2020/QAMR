...
module FAU ( 
  ...
  nand4  g087(.a(new_n141_), .b(new_n140_), .c(new_n105_), .d(new_n88_), .O(new_n142_));
  oai21  g088(.a(new_n142_), .b(new_n84_), .c(x32), .O(new_n143_));
  nand2  g089(.a(new_n83_), .b(new_n71_), .O(new_n144_));
  inv1   g090(.a(new_n144_), .O(new_n145_));
  nand2  g091(.a(new_n132_), .b(new_n115_), .O(new_n146_));
  inv1   g092(.a(new_n146_), .O(new_n147_));
  nor2   g093(.a(x32), .b(x31), .O(new_n148_));
  nand2  g094(.a(new_n148_), .b(new_n131_), .O(new_n149_));
  inv1   g095(.a(new_n149_), .O(new_n150_));
  nand4  g096(.a(new_n150_), .b(new_n147_), .c(new_n145_), .d(new_n63_), .O(new_n151_));
  ...
  nand4  g102(.a(new_n148_), .b(new_n132_), .c(new_n115_), .d(new_n131_), .O(new_n157_));
  oai21  g103(.a(new_n157_), .b(new_n84_), .c(x33), .O(new_n158_));
  nor2   g104(.a(x33), .b(x32), .O(new_n159_));
  nand4  g105(.a(new_n159_), .b(new_n141_), .c(new_n140_), .d(new_n105_), .O(new_n160_));
  inv1   g106(.a(new_n160_), .O(new_n161_));
  nand2  g107(.a(new_n161_), .b(new_n90_), .O(new_n162_));
  ...
  nand4  g113(.a(new_n114_), .b(new_n97_), .c(new_n96_), .d(new_n55_), .O(new_n168_));
  oai21  g114(.a(new_n160_), .b(new_n168_), .c(x34), .O(new_n169_));
  nand2  g115(.a(new_n140_), .b(new_n105_), .O(new_n170_));
  ...
  nand3  g125(.a(new_n179_), .b(new_n171_), .c(new_n90_), .O(new_n180_));
