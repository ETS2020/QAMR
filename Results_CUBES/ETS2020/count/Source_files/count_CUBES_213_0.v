// Benchmark "FAU" written by ABC on Tue Jul  7 19:20:33 2020
...
module FAU ( 
  ...
  nand4  g086(.a(new_n102_), .b(new_n55_), .c(new_n69_), .d(new_n61_), .O(new_n139_));
  nor2   g087(.a(x26), .b(x25), .O(new_n140_));
  nor2   g088(.a(x30), .b(x29), .O(new_n141_));
  nand4  g089(.a(new_n141_), .b(new_n123_), .c(new_n140_), .d(new_n82_), .O(new_n142_));
  ...
  nand4  g097(.a(new_n150_), .b(new_n149_), .c(new_n114_), .d(new_n94_), .O(new_n151_));
  ...
  oai21  g118(.a(new_n164_), .b(new_n104_), .c(x34), .O(new_n172_));
  ...
  nand3  g129(.a(new_n182_), .b(new_n174_), .c(new_n96_), .O(new_n183_));
