...
module FAU ( 
  ...
  inv1   g072(.a(x26), .O(new_n125_));
  nor2   g073(.a(x28), .b(x27), .O(new_n126_));
  nand4  g074(.a(new_n126_), .b(new_n107_), .c(new_n125_), .d(new_n97_), .O(new_n127_));
  ...
  nand4  g086(.a(new_n138_), .b(new_n126_), .c(new_n137_), .d(new_n87_), .O(new_n139_));
  ...
  nand2  g106(.a(new_n138_), .b(new_n126_), .O(new_n159_));
  inv1   g107(.a(x31), .O(new_n160_));
  inv1   g108(.a(x32), .O(new_n161_));
  nand4  g109(.a(new_n161_), .b(new_n160_), .c(new_n125_), .d(new_n98_), .O(new_n162_));
  nor2   g110(.a(new_n162_), .b(new_n159_), .O(new_n163_));
  nand2  g111(.a(new_n163_), .b(new_n91_), .O(new_n164_));
  nand2  g112(.a(new_n164_), .b(new_n158_), .O(new_n165_));
  nand2  g113(.a(new_n165_), .b(x16), .O(new_n166_));
  inv1   g114(.a(x02), .O(new_n167_));
  aoi21  g115(.a(new_n58_), .b(new_n167_), .c(x18), .O(new_n168_));
  nand2  g116(.a(new_n168_), .b(new_n166_), .O(z13));
  nor2   g117(.a(x33), .b(x32), .O(new_n171_));
  nand4  g118(.a(new_n171_), .b(new_n148_), .c(new_n147_), .d(new_n117_), .O(new_n172_));
  oai21  g119(.a(new_n172_), .b(new_n108_), .c(x34), .O(new_n173_));
  nand2  g120(.a(new_n147_), .b(new_n117_), .O(new_n174_));
  inv1   g121(.a(new_n174_), .O(new_n175_));
  inv1   g122(.a(x30), .O(new_n176_));
  nand2  g123(.a(new_n160_), .b(new_n176_), .O(new_n177_));
  inv1   g124(.a(x33), .O(new_n178_));
  inv1   g125(.a(x34), .O(new_n179_));
  nand3  g126(.a(new_n179_), .b(new_n178_), .c(new_n161_), .O(new_n180_));
  nor2   g127(.a(new_n180_), .b(new_n177_), .O(new_n181_));
  nand3  g128(.a(new_n181_), .b(new_n175_), .c(new_n100_), .O(new_n182_));
  nand2  g129(.a(new_n182_), .b(new_n173_), .O(new_n183_));
