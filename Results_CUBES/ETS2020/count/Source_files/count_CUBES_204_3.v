...
module FAU ( 
  ...
  nand2  g033(.a(new_n85_), .b(new_n72_), .O(new_n86_));
  nor2   g034(.a(new_n86_), .b(new_n63_), .O(new_n87_));
  ...
  nor2   g040(.a(x21), .b(x20), .O(new_n93_));
  nor2   g041(.a(x23), .b(x22), .O(new_n94_));
  nor2   g042(.a(x25), .b(x24), .O(new_n95_));
  nand4  g043(.a(new_n95_), .b(new_n94_), .c(new_n93_), .d(new_n55_), .O(new_n96_));
  oai21  g044(.a(new_n87_), .b(new_n92_), .c(new_n96_), .O(new_n97_));
  nand2  g045(.a(new_n97_), .b(x16), .O(new_n98_));
  inv1   g046(.a(x09), .O(new_n99_));
  aoi21  g047(.a(new_n58_), .b(new_n99_), .c(x18), .O(new_n100_));
  nand2  g048(.a(new_n100_), .b(new_n98_), .O(z06));
  nand2  g049(.a(new_n96_), .b(x26), .O(new_n102_));
  nor3   g050(.a(x26), .b(x25), .c(x24), .O(new_n103_));
  nand3  g051(.a(new_n103_), .b(new_n94_), .c(new_n66_), .O(new_n104_));
  ...
  nand4  g058(.a(new_n111_), .b(new_n85_), .c(new_n72_), .d(new_n71_), .O(new_n112_));
  inv1   g059(.a(x23), .O(new_n113_));
  inv1   g060(.a(x26), .O(new_n114_));
  nor2   g061(.a(x28), .b(x27), .O(new_n115_));
  nand4  g062(.a(new_n115_), .b(new_n95_), .c(new_n114_), .d(new_n113_), .O(new_n116_));
  nor2   g063(.a(new_n116_), .b(new_n77_), .O(new_n117_));
  aoi21  g064(.a(new_n112_), .b(x28), .c(new_n117_), .O(new_n118_));
  ...
  nand4  g070(.a(new_n123_), .b(new_n103_), .c(new_n78_), .d(new_n71_), .O(new_n124_));
  ...
  nand4  g076(.a(new_n94_), .b(new_n55_), .c(new_n64_), .d(new_n62_), .O(new_n130_));
  nor2   g077(.a(x30), .b(x29), .O(new_n131_));
  nand4  g078(.a(new_n131_), .b(new_n115_), .c(new_n95_), .d(new_n114_), .O(new_n132_));
  nor2   g079(.a(new_n132_), .b(new_n130_), .O(new_n133_));
  aoi21  g080(.a(new_n124_), .b(x30), .c(new_n133_), .O(new_n134_));
  ...
  oai21  g084(.a(new_n132_), .b(new_n130_), .c(x31), .O(new_n138_));
  inv1   g085(.a(new_n86_), .O(new_n139_));
  ...
  nand4  g090(.a(new_n143_), .b(new_n111_), .c(new_n139_), .d(new_n71_), .O(new_n144_));
  ...
  nand4  g098(.a(new_n153_), .b(new_n141_), .c(new_n140_), .d(new_n152_), .O(new_n154_));
  oai21  g099(.a(new_n154_), .b(new_n96_), .c(x34), .O(new_n155_));
  inv1   g100(.a(x22), .O(new_n156_));
  nand4  g101(.a(new_n92_), .b(new_n83_), .c(new_n113_), .d(new_n156_), .O(new_n157_));
  nor2   g102(.a(new_n157_), .b(new_n65_), .O(new_n158_));
  nand2  g103(.a(new_n140_), .b(new_n152_), .O(new_n159_));
  ...
  nand3  g113(.a(new_n168_), .b(new_n160_), .c(new_n158_), .O(new_n169_));
  nand2  g114(.a(new_n169_), .b(new_n155_), .O(new_n170_));
