// Benchmark "FAU" written by ABC on Tue Jul  7 19:19:41 2020
...
module FAU ( 
  ...
  nand4  g055(.a(new_n109_), .b(new_n81_), .c(new_n72_), .d(new_n71_), .O(new_n110_));
  ...
  nand4  g066(.a(new_n121_), .b(new_n99_), .c(new_n79_), .d(new_n71_), .O(new_n122_));
  nand4  g067(.a(new_n98_), .b(new_n55_), .c(new_n64_), .d(new_n62_), .O(new_n123_));
  ...
  nand4  g092(.a(new_n112_), .b(new_n98_), .c(new_n149_), .d(new_n55_), .O(new_n150_));
