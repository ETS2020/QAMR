...
module FAU ( 
  ...
  nand4  g047(.a(new_n100_), .b(new_n75_), .c(new_n99_), .d(new_n56_), .O(new_n101_));
  nand2  g048(.a(new_n101_), .b(x26), .O(new_n102_));
  nor2   g049(.a(x26), .b(x25), .O(new_n103_));
  nand4  g050(.a(new_n103_), .b(new_n75_), .c(new_n62_), .d(new_n91_), .O(new_n104_));
  ...
  nand4  g064(.a(new_n117_), .b(new_n82_), .c(new_n68_), .d(new_n67_), .O(new_n118_));
  ...
  nor2   g068(.a(new_n121_), .b(new_n73_), .O(new_n122_));
  aoi21  g069(.a(new_n118_), .b(x28), .c(new_n122_), .O(new_n123_));
  inv1   g070(.a(x06), .O(new_n124_));
  aoi21  g071(.a(new_n54_), .b(new_n124_), .c(x18), .O(new_n125_));
  oai21  g072(.a(new_n123_), .b(new_n54_), .c(new_n125_), .O(z09));
  nor2   g073(.a(x30), .b(x29), .O(new_n129_));
  nand4  g074(.a(new_n129_), .b(new_n119_), .c(new_n103_), .d(new_n91_), .O(new_n130_));
  oai21  g075(.a(new_n130_), .b(new_n76_), .c(x31), .O(new_n131_));
  ...
  nand3  g080(.a(new_n135_), .b(new_n117_), .c(new_n84_), .O(new_n136_));
  nand2  g081(.a(new_n136_), .b(new_n131_), .O(new_n137_));
  nand2  g082(.a(new_n137_), .b(x16), .O(new_n138_));
  inv1   g083(.a(x03), .O(new_n139_));
  aoi21  g084(.a(new_n54_), .b(new_n139_), .c(x18), .O(new_n140_));
  nand2  g085(.a(new_n140_), .b(new_n138_), .O(z12));
  nand4  g086(.a(new_n133_), .b(new_n132_), .c(new_n110_), .d(new_n92_), .O(new_n142_));
  oai21  g087(.a(new_n142_), .b(new_n83_), .c(x32), .O(new_n143_));
  nor2   g088(.a(x32), .b(x31), .O(new_n144_));
  nand4  g089(.a(new_n144_), .b(new_n129_), .c(new_n119_), .d(new_n103_), .O(new_n145_));
  inv1   g090(.a(new_n145_), .O(new_n146_));
  nand2  g091(.a(new_n146_), .b(new_n84_), .O(new_n147_));
  nand2  g092(.a(new_n147_), .b(new_n143_), .O(new_n148_));
  nand2  g093(.a(new_n148_), .b(x16), .O(new_n149_));
  inv1   g094(.a(x02), .O(new_n150_));
  aoi21  g095(.a(new_n54_), .b(new_n150_), .c(x18), .O(new_n151_));
  nand2  g096(.a(new_n151_), .b(new_n149_), .O(z13));
  oai21  g097(.a(new_n145_), .b(new_n83_), .c(x33), .O(new_n153_));
  nor2   g098(.a(x33), .b(x32), .O(new_n154_));
  nand4  g099(.a(new_n154_), .b(new_n133_), .c(new_n132_), .d(new_n110_), .O(new_n155_));
  inv1   g100(.a(new_n155_), .O(new_n156_));
  nand2  g101(.a(new_n156_), .b(new_n94_), .O(new_n157_));
  ...
  nand2  g108(.a(new_n132_), .b(new_n110_), .O(new_n164_));
