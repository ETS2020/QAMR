...
module FAU ( 
  ...
  nor3   g060(.a(x25), .b(x24), .c(x23), .O(new_n114_));
  nand4  g061(.a(new_n114_), .b(new_n107_), .c(new_n71_), .d(new_n63_), .O(new_n115_));
  nor2   g062(.a(x25), .b(x24), .O(new_n116_));
  nor2   g063(.a(x28), .b(x27), .O(new_n117_));
  nand4  g064(.a(new_n117_), .b(new_n116_), .c(new_n92_), .d(new_n94_), .O(new_n118_));
  ...
  oai21  g082(.a(new_n138_), .b(new_n85_), .c(x33), .O(new_n139_));
  nor2   g083(.a(x29), .b(x28), .O(new_n140_));
  nor2   g084(.a(x31), .b(x30), .O(new_n141_));
  nor2   g085(.a(x33), .b(x32), .O(new_n142_));
  nand4  g086(.a(new_n142_), .b(new_n141_), .c(new_n140_), .d(new_n107_), .O(new_n143_));
  inv1   g087(.a(new_n143_), .O(new_n144_));
  nand2  g088(.a(new_n144_), .b(new_n97_), .O(new_n145_));
  nand2  g089(.a(new_n145_), .b(new_n139_), .O(new_n146_));
  ...
  nand4  g094(.a(new_n116_), .b(new_n99_), .c(new_n98_), .d(new_n55_), .O(new_n151_));
  oai21  g095(.a(new_n143_), .b(new_n151_), .c(x34), .O(new_n152_));
  nand2  g096(.a(new_n140_), .b(new_n107_), .O(new_n153_));
  inv1   g097(.a(new_n153_), .O(new_n154_));
  inv1   g098(.a(x30), .O(new_n155_));
  inv1   g099(.a(x31), .O(new_n156_));
  nand2  g100(.a(new_n156_), .b(new_n155_), .O(new_n157_));
  inv1   g101(.a(x32), .O(new_n158_));
  inv1   g102(.a(x33), .O(new_n159_));
  inv1   g103(.a(x34), .O(new_n160_));
  nand3  g104(.a(new_n160_), .b(new_n159_), .c(new_n158_), .O(new_n161_));
  nor2   g105(.a(new_n161_), .b(new_n157_), .O(new_n162_));
  nand3  g106(.a(new_n162_), .b(new_n154_), .c(new_n97_), .O(new_n163_));
  nand2  g107(.a(new_n163_), .b(new_n152_), .O(new_n164_));
