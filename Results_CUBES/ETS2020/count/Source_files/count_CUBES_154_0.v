...
module FAU ( 
  ...
  nand4  g086(.a(new_n138_), .b(new_n127_), .c(new_n137_), .d(new_n98_), .O(new_n139_));
  ...
  nand2  g105(.a(new_n138_), .b(new_n127_), .O(new_n158_));
  inv1   g106(.a(x31), .O(new_n159_));
  inv1   g107(.a(x32), .O(new_n160_));
  nand4  g108(.a(new_n160_), .b(new_n159_), .c(new_n126_), .d(new_n99_), .O(new_n161_));
  nor2   g109(.a(new_n161_), .b(new_n158_), .O(new_n162_));
  nand2  g110(.a(new_n162_), .b(new_n91_), .O(new_n163_));
  nand2  g111(.a(new_n163_), .b(new_n157_), .O(new_n164_));
  ...
  nand4  g117(.a(new_n170_), .b(new_n147_), .c(new_n146_), .d(new_n117_), .O(new_n171_));
  oai21  g118(.a(new_n171_), .b(new_n108_), .c(x34), .O(new_n172_));
  nand2  g119(.a(new_n146_), .b(new_n117_), .O(new_n173_));
  inv1   g120(.a(new_n173_), .O(new_n174_));
  inv1   g121(.a(x30), .O(new_n175_));
  nand2  g122(.a(new_n159_), .b(new_n175_), .O(new_n176_));
  inv1   g123(.a(x33), .O(new_n177_));
  inv1   g124(.a(x34), .O(new_n178_));
  nand3  g125(.a(new_n178_), .b(new_n177_), .c(new_n160_), .O(new_n179_));
  nor2   g126(.a(new_n179_), .b(new_n176_), .O(new_n180_));
  nand3  g127(.a(new_n180_), .b(new_n174_), .c(new_n101_), .O(new_n181_));
