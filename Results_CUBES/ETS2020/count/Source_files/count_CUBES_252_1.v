...
module FAU ( 
  ...
  nor3   g063(.a(x25), .b(x24), .c(x23), .O(new_n117_));
  nand4  g064(.a(new_n117_), .b(new_n110_), .c(new_n73_), .d(new_n56_), .O(new_n118_));
  ...
  nor2   g081(.a(x26), .b(x25), .O(new_n138_));
  nor2   g082(.a(x30), .b(x29), .O(new_n139_));
  nor2   g083(.a(x32), .b(x31), .O(new_n140_));
  nand4  g084(.a(new_n140_), .b(new_n139_), .c(new_n119_), .d(new_n138_), .O(new_n141_));
  oai21  g085(.a(new_n141_), .b(new_n83_), .c(x33), .O(new_n142_));
  ...
  nand2  g091(.a(new_n147_), .b(new_n93_), .O(new_n148_));
  ...
  oai21  g097(.a(new_n146_), .b(new_n101_), .c(x34), .O(new_n154_));
  ...
  aoi21  g112(.a(new_n59_), .b(new_n168_), .c(x18), .O(new_n169_));
