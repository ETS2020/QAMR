// Benchmark "FAU" written by ABC on Tue Jul  7 19:20:11 2020
...
module FAU ( 
  ...
  nor2   g014(.a(x21), .b(x20), .O(new_n67_));
  aoi21  g015(.a(new_n67_), .b(new_n58_), .c(new_n66_), .O(new_n68_));
  nor2   g016(.a(x22), .b(x21), .O(new_n69_));
  nand3  g017(.a(new_n69_), .b(new_n58_), .c(new_n57_), .O(new_n70_));
  inv1   g018(.a(new_n70_), .O(new_n71_));
  oai21  g019(.a(new_n71_), .b(new_n68_), .c(x16), .O(new_n72_));
  inv1   g020(.a(x12), .O(new_n73_));
  aoi21  g021(.a(new_n52_), .b(new_n73_), .c(x18), .O(new_n74_));
  nand2  g022(.a(new_n74_), .b(new_n72_), .O(z03));
  nor3   g023(.a(x23), .b(x22), .c(x21), .O(new_n76_));
  aoi22  g024(.a(new_n76_), .b(new_n60_), .c(new_n70_), .d(x23), .O(new_n77_));
  ...
  nand4  g031(.a(new_n83_), .b(new_n69_), .c(new_n58_), .d(new_n57_), .O(new_n84_));
  ...
  nand4  g040(.a(new_n92_), .b(new_n91_), .c(new_n67_), .d(new_n58_), .O(new_n93_));
  ...
  nand4  g048(.a(new_n100_), .b(new_n91_), .c(new_n67_), .d(new_n58_), .O(new_n101_));
  ...
  nor2   g055(.a(x26), .b(x25), .O(new_n108_));
  nand3  g056(.a(new_n108_), .b(new_n83_), .c(new_n107_), .O(new_n109_));
  nor2   g057(.a(new_n109_), .b(new_n70_), .O(new_n110_));
  aoi21  g058(.a(new_n101_), .b(x27), .c(new_n110_), .O(new_n111_));
  inv1   g059(.a(x07), .O(new_n112_));
  aoi21  g060(.a(new_n52_), .b(new_n112_), .c(x18), .O(new_n113_));
  oai21  g061(.a(new_n111_), .b(new_n52_), .c(new_n113_), .O(z08));
  nor3   g062(.a(x27), .b(x26), .c(x25), .O(new_n115_));
  nand4  g063(.a(new_n115_), .b(new_n83_), .c(new_n69_), .d(new_n60_), .O(new_n116_));
  inv1   g064(.a(x23), .O(new_n117_));
  inv1   g065(.a(x26), .O(new_n118_));
  nor2   g066(.a(x28), .b(x27), .O(new_n119_));
  nand4  g067(.a(new_n119_), .b(new_n92_), .c(new_n118_), .d(new_n117_), .O(new_n120_));
  nor2   g068(.a(new_n120_), .b(new_n70_), .O(new_n121_));
  aoi21  g069(.a(new_n116_), .b(x28), .c(new_n121_), .O(new_n122_));
  inv1   g070(.a(x06), .O(new_n123_));
  aoi21  g071(.a(new_n52_), .b(new_n123_), .c(x18), .O(new_n124_));
  oai21  g072(.a(new_n122_), .b(new_n52_), .c(new_n124_), .O(z09));
  nor3   g073(.a(x29), .b(x28), .c(x27), .O(new_n127_));
  nand4  g074(.a(new_n127_), .b(new_n100_), .c(new_n76_), .d(new_n60_), .O(new_n128_));
  inv1   g075(.a(x21), .O(new_n129_));
  nand4  g076(.a(new_n91_), .b(new_n58_), .c(new_n129_), .d(new_n57_), .O(new_n130_));
  nor2   g077(.a(x30), .b(x29), .O(new_n131_));
  nand4  g078(.a(new_n131_), .b(new_n119_), .c(new_n108_), .d(new_n81_), .O(new_n132_));
  ...
  aoi21  g082(.a(new_n52_), .b(new_n135_), .c(x18), .O(new_n136_));
  oai21  g083(.a(new_n134_), .b(new_n52_), .c(new_n136_), .O(z11));
  oai21  g084(.a(new_n132_), .b(new_n130_), .c(x31), .O(new_n138_));
  nand4  g085(.a(new_n81_), .b(new_n117_), .c(new_n66_), .d(new_n129_), .O(new_n139_));
  ...
  nand4  g093(.a(new_n146_), .b(new_n115_), .c(new_n140_), .d(new_n60_), .O(new_n147_));
  nand2  g094(.a(new_n147_), .b(new_n138_), .O(new_n148_));
  ...
  nand4  g101(.a(new_n154_), .b(new_n153_), .c(new_n108_), .d(new_n107_), .O(new_n155_));
  oai21  g102(.a(new_n155_), .b(new_n84_), .c(x32), .O(new_n156_));
  nand4  g103(.a(new_n143_), .b(new_n142_), .c(new_n141_), .d(new_n107_), .O(new_n157_));
  inv1   g104(.a(new_n157_), .O(new_n158_));
  inv1   g105(.a(x32), .O(new_n159_));
  nand4  g106(.a(new_n159_), .b(new_n144_), .c(new_n118_), .d(new_n90_), .O(new_n160_));
  inv1   g107(.a(new_n160_), .O(new_n161_));
  nand4  g108(.a(new_n161_), .b(new_n158_), .c(new_n140_), .d(new_n60_), .O(new_n162_));
