...
module FAU ( 
  ...
  nor2   g030(.a(x23), .b(x22), .O(new_n84_));
  nor2   g031(.a(x21), .b(x20), .O(new_n85_));
  nor2   g032(.a(x25), .b(x24), .O(new_n86_));
  nand4  g033(.a(new_n86_), .b(new_n85_), .c(new_n84_), .d(new_n58_), .O(new_n87_));
  oai21  g034(.a(new_n78_), .b(new_n83_), .c(new_n87_), .O(new_n88_));
  ...
  nand4  g041(.a(new_n94_), .b(new_n85_), .c(new_n84_), .d(new_n58_), .O(new_n95_));
  ...
  nand3  g049(.a(new_n102_), .b(new_n76_), .c(new_n101_), .O(new_n103_));
  nor2   g050(.a(new_n103_), .b(new_n68_), .O(new_n104_));
  ...
  nand4  g056(.a(new_n109_), .b(new_n76_), .c(new_n67_), .d(new_n60_), .O(new_n110_));
  ...
  nor2   g061(.a(new_n114_), .b(new_n68_), .O(new_n115_));
  ...
  oai21  g066(.a(new_n114_), .b(new_n68_), .c(x29), .O(new_n120_));
  nor3   g067(.a(x29), .b(x28), .c(x27), .O(new_n121_));
  nand4  g068(.a(new_n121_), .b(new_n94_), .c(new_n69_), .d(new_n60_), .O(new_n122_));
  ...
  nand4  g075(.a(new_n84_), .b(new_n58_), .c(new_n128_), .d(new_n57_), .O(new_n129_));
  nor2   g076(.a(x30), .b(x29), .O(new_n130_));
  nand4  g077(.a(new_n130_), .b(new_n113_), .c(new_n102_), .d(new_n74_), .O(new_n131_));
  ...
  nand4  g085(.a(new_n74_), .b(new_n111_), .c(new_n138_), .d(new_n128_), .O(new_n139_));
  ...
  nand4  g093(.a(new_n146_), .b(new_n109_), .c(new_n140_), .d(new_n60_), .O(new_n147_));
  ...
  oai21  g102(.a(new_n155_), .b(new_n77_), .c(x32), .O(new_n156_));
  ...
  nand4  g106(.a(new_n159_), .b(new_n144_), .c(new_n112_), .d(new_n83_), .O(new_n160_));
