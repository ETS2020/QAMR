...
module FAU ( 
  ...
  nand4  g044(.a(new_n99_), .b(new_n85_), .c(new_n77_), .d(new_n63_), .O(new_n100_));
  ...
  nor2   g049(.a(new_n104_), .b(new_n78_), .O(new_n105_));
  aoi21  g050(.a(new_n100_), .b(x28), .c(new_n105_), .O(new_n106_));
  ...
  nand4  g057(.a(new_n112_), .b(new_n111_), .c(new_n79_), .d(new_n63_), .O(new_n113_));
  ...
  nand4  g067(.a(new_n122_), .b(new_n121_), .c(new_n102_), .d(new_n89_), .O(new_n123_));
  ...
  nand2  g074(.a(new_n85_), .b(new_n77_), .O(new_n130_));
  ...
  nand4  g080(.a(new_n135_), .b(new_n99_), .c(new_n131_), .d(new_n63_), .O(new_n136_));
  ...
  nand4  g087(.a(new_n133_), .b(new_n132_), .c(new_n142_), .d(new_n90_), .O(new_n143_));
  oai21  g088(.a(new_n143_), .b(new_n86_), .c(x32), .O(new_n144_));
  nor2   g089(.a(x32), .b(x31), .O(new_n145_));
  nand2  g090(.a(new_n145_), .b(new_n102_), .O(new_n146_));
  inv1   g091(.a(new_n146_), .O(new_n147_));
  nand2  g092(.a(new_n122_), .b(new_n121_), .O(new_n148_));
  inv1   g093(.a(new_n148_), .O(new_n149_));
  nand4  g094(.a(new_n149_), .b(new_n147_), .c(new_n131_), .d(new_n63_), .O(new_n150_));
  ...
  nand4  g101(.a(new_n101_), .b(new_n119_), .c(new_n157_), .d(new_n55_), .O(new_n158_));
  nor2   g102(.a(x33), .b(x32), .O(new_n159_));
  nand4  g103(.a(new_n159_), .b(new_n133_), .c(new_n132_), .d(new_n142_), .O(new_n160_));
  oai21  g104(.a(new_n160_), .b(new_n158_), .c(x34), .O(new_n161_));
  nand2  g105(.a(new_n132_), .b(new_n142_), .O(new_n162_));
  ...
  nand3  g115(.a(new_n171_), .b(new_n163_), .c(new_n92_), .O(new_n172_));
