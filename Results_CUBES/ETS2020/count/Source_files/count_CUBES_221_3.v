...
module FAU ( 
  ...
  nand4  g070(.a(new_n124_), .b(new_n99_), .c(new_n73_), .d(new_n67_), .O(new_n125_));
  nand4  g071(.a(new_n98_), .b(new_n55_), .c(new_n64_), .d(new_n63_), .O(new_n126_));
  nor2   g072(.a(x26), .b(x25), .O(new_n127_));
  nor2   g073(.a(x30), .b(x29), .O(new_n128_));
  nand4  g074(.a(new_n128_), .b(new_n116_), .c(new_n127_), .d(new_n78_), .O(new_n129_));
  ...
  nand3  g085(.a(new_n139_), .b(new_n113_), .c(new_n82_), .O(new_n140_));
  ...
  nand4  g091(.a(new_n137_), .b(new_n136_), .c(new_n106_), .d(new_n89_), .O(new_n146_));
  oai21  g092(.a(new_n146_), .b(new_n81_), .c(x32), .O(new_n147_));
  nand2  g093(.a(new_n128_), .b(new_n116_), .O(new_n148_));
  inv1   g094(.a(x31), .O(new_n149_));
  inv1   g095(.a(x32), .O(new_n150_));
  nand4  g096(.a(new_n150_), .b(new_n149_), .c(new_n96_), .d(new_n89_), .O(new_n151_));
  ...
  nand4  g104(.a(new_n115_), .b(new_n98_), .c(new_n97_), .d(new_n55_), .O(new_n160_));
  nor2   g105(.a(x33), .b(x32), .O(new_n161_));
  nand4  g106(.a(new_n161_), .b(new_n137_), .c(new_n136_), .d(new_n106_), .O(new_n162_));
  oai21  g107(.a(new_n162_), .b(new_n160_), .c(x34), .O(new_n163_));
  nand2  g108(.a(new_n136_), .b(new_n106_), .O(new_n164_));
  inv1   g109(.a(new_n164_), .O(new_n165_));
  inv1   g110(.a(x30), .O(new_n166_));
  nand2  g111(.a(new_n149_), .b(new_n166_), .O(new_n167_));
  inv1   g112(.a(x33), .O(new_n168_));
  inv1   g113(.a(x34), .O(new_n169_));
  nand3  g114(.a(new_n169_), .b(new_n168_), .c(new_n150_), .O(new_n170_));
  nor2   g115(.a(new_n170_), .b(new_n167_), .O(new_n171_));
  nand3  g116(.a(new_n171_), .b(new_n165_), .c(new_n91_), .O(new_n172_));
  nand2  g117(.a(new_n172_), .b(new_n163_), .O(new_n173_));
