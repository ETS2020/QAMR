...
module FAU ( 
  ...
  and2   g037(.a(new_n88_), .b(x24), .O(new_n89_));
  ...
  nor2   g074(.a(x26), .b(x23), .O(new_n127_));
  nand3  g075(.a(new_n127_), .b(new_n126_), .c(new_n108_), .O(new_n128_));
  oai21  g076(.a(new_n128_), .b(new_n81_), .c(x29), .O(new_n129_));
  nor3   g077(.a(x29), .b(x28), .c(x27), .O(new_n130_));
  nand2  g078(.a(new_n130_), .b(new_n111_), .O(new_n131_));
  oai21  g079(.a(new_n131_), .b(new_n88_), .c(new_n129_), .O(new_n132_));
  ...
  nand4  g086(.a(new_n139_), .b(new_n126_), .c(new_n138_), .d(new_n99_), .O(new_n140_));
  oai21  g087(.a(new_n140_), .b(new_n88_), .c(x31), .O(new_n141_));
  ...
  nand3  g093(.a(new_n146_), .b(new_n142_), .c(new_n92_), .O(new_n147_));
  ...
  nand4  g099(.a(new_n144_), .b(new_n143_), .c(new_n118_), .d(new_n100_), .O(new_n153_));
  oai21  g100(.a(new_n153_), .b(new_n91_), .c(x32), .O(new_n154_));
  nor2   g101(.a(x32), .b(x31), .O(new_n155_));
  nand4  g102(.a(new_n155_), .b(new_n139_), .c(new_n126_), .d(new_n138_), .O(new_n156_));
  inv1   g103(.a(new_n156_), .O(new_n157_));
  nand2  g104(.a(new_n157_), .b(new_n92_), .O(new_n158_));
  ...
  oai21  g110(.a(new_n156_), .b(new_n91_), .c(x33), .O(new_n164_));
  nor2   g111(.a(x33), .b(x32), .O(new_n165_));
  nand4  g112(.a(new_n165_), .b(new_n144_), .c(new_n143_), .d(new_n118_), .O(new_n166_));
  inv1   g113(.a(new_n166_), .O(new_n167_));
  nand2  g114(.a(new_n167_), .b(new_n102_), .O(new_n168_));
  ...
  oai21  g120(.a(new_n166_), .b(new_n109_), .c(x34), .O(new_n174_));
  nand2  g121(.a(new_n143_), .b(new_n118_), .O(new_n175_));
  ...
  nand3  g131(.a(new_n184_), .b(new_n176_), .c(new_n102_), .O(new_n185_));
