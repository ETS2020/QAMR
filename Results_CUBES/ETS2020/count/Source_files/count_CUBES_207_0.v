...
module FAU ( 
  ...
  nand4  g067(.a(new_n122_), .b(new_n96_), .c(new_n72_), .d(new_n63_), .O(new_n123_));
  ...
  nand4  g071(.a(new_n126_), .b(new_n114_), .c(new_n125_), .d(new_n71_), .O(new_n127_));
  ...
  nand4  g079(.a(new_n135_), .b(new_n134_), .c(new_n104_), .d(new_n86_), .O(new_n136_));
  oai21  g080(.a(new_n136_), .b(new_n76_), .c(x32), .O(new_n137_));
  nor2   g081(.a(x32), .b(x31), .O(new_n138_));
  nand4  g082(.a(new_n138_), .b(new_n126_), .c(new_n114_), .d(new_n125_), .O(new_n139_));
  inv1   g083(.a(new_n139_), .O(new_n140_));
  nand2  g084(.a(new_n140_), .b(new_n77_), .O(new_n141_));
  ...
  oai21  g090(.a(new_n139_), .b(new_n76_), .c(x33), .O(new_n147_));
  nor2   g091(.a(x33), .b(x32), .O(new_n148_));
  nand4  g092(.a(new_n148_), .b(new_n135_), .c(new_n134_), .d(new_n104_), .O(new_n149_));
  ...
  nand4  g100(.a(new_n113_), .b(new_n95_), .c(new_n94_), .d(new_n55_), .O(new_n157_));
  oai21  g101(.a(new_n149_), .b(new_n157_), .c(x34), .O(new_n158_));
  nand2  g102(.a(new_n134_), .b(new_n104_), .O(new_n159_));
