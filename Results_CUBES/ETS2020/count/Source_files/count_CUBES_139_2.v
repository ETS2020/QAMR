...
module FAU ( 
  ...
  nor2   g058(.a(x25), .b(x24), .O(new_n112_));
  nor2   g059(.a(x26), .b(x23), .O(new_n113_));
  nand3  g060(.a(new_n113_), .b(new_n112_), .c(new_n111_), .O(new_n114_));
  nor2   g061(.a(new_n114_), .b(new_n81_), .O(new_n115_));
  aoi21  g062(.a(new_n110_), .b(x28), .c(new_n115_), .O(new_n116_));
  inv1   g063(.a(x06), .O(new_n117_));
  aoi21  g064(.a(new_n58_), .b(new_n117_), .c(x18), .O(new_n118_));
  oai21  g065(.a(new_n116_), .b(new_n58_), .c(new_n118_), .O(z09));
  nor3   g066(.a(x29), .b(x28), .c(x27), .O(new_n121_));
  nand4  g067(.a(new_n121_), .b(new_n99_), .c(new_n82_), .d(new_n63_), .O(new_n122_));
  nand4  g068(.a(new_n98_), .b(new_n55_), .c(new_n69_), .d(new_n61_), .O(new_n123_));
  nor2   g069(.a(x26), .b(x25), .O(new_n124_));
  nor2   g070(.a(x30), .b(x29), .O(new_n125_));
  nand4  g071(.a(new_n125_), .b(new_n111_), .c(new_n124_), .d(new_n87_), .O(new_n126_));
  nor2   g072(.a(new_n126_), .b(new_n123_), .O(new_n127_));
  aoi21  g073(.a(new_n122_), .b(x30), .c(new_n127_), .O(new_n128_));
  inv1   g074(.a(x04), .O(new_n129_));
  aoi21  g075(.a(new_n58_), .b(new_n129_), .c(x18), .O(new_n130_));
  oai21  g076(.a(new_n128_), .b(new_n58_), .c(new_n130_), .O(z11));
  nor2   g077(.a(x29), .b(x28), .O(new_n133_));
  nor2   g078(.a(x31), .b(x30), .O(new_n134_));
  nand4  g079(.a(new_n134_), .b(new_n133_), .c(new_n102_), .d(new_n101_), .O(new_n135_));
  oai21  g080(.a(new_n135_), .b(new_n90_), .c(x32), .O(new_n136_));
  nor2   g081(.a(x32), .b(x31), .O(new_n137_));
  nand4  g082(.a(new_n137_), .b(new_n125_), .c(new_n111_), .d(new_n124_), .O(new_n138_));
  inv1   g083(.a(new_n138_), .O(new_n139_));
  nand2  g084(.a(new_n139_), .b(new_n91_), .O(new_n140_));
  nand2  g085(.a(new_n140_), .b(new_n136_), .O(new_n141_));
  nand2  g086(.a(new_n141_), .b(x16), .O(new_n142_));
  inv1   g087(.a(x02), .O(new_n143_));
  aoi21  g088(.a(new_n58_), .b(new_n143_), .c(x18), .O(new_n144_));
  nand2  g089(.a(new_n144_), .b(new_n142_), .O(z13));
  oai21  g090(.a(new_n138_), .b(new_n90_), .c(x33), .O(new_n146_));
  inv1   g091(.a(x22), .O(new_n147_));
  inv1   g092(.a(x23), .O(new_n148_));
  nand4  g093(.a(new_n101_), .b(new_n87_), .c(new_n148_), .d(new_n147_), .O(new_n149_));
  nor2   g094(.a(new_n149_), .b(new_n70_), .O(new_n150_));
  nor2   g095(.a(x33), .b(x32), .O(new_n151_));
  nand4  g096(.a(new_n151_), .b(new_n134_), .c(new_n133_), .d(new_n102_), .O(new_n152_));
  inv1   g097(.a(new_n152_), .O(new_n153_));
  nand2  g098(.a(new_n153_), .b(new_n150_), .O(new_n154_));
  nand2  g099(.a(new_n154_), .b(new_n146_), .O(new_n155_));
  ...
  nor2   g104(.a(x21), .b(x20), .O(new_n160_));
  nand4  g105(.a(new_n112_), .b(new_n98_), .c(new_n160_), .d(new_n55_), .O(new_n161_));
  oai21  g106(.a(new_n152_), .b(new_n161_), .c(x34), .O(new_n162_));
  nand2  g107(.a(new_n133_), .b(new_n102_), .O(new_n163_));
