// Benchmark "FAU" written by ABC on Tue Jul  7 19:20:54 2020
...
module FAU ( 
  ...
  nand4  g032(.a(new_n83_), .b(new_n55_), .c(new_n69_), .d(new_n61_), .O(new_n84_));
  ...
  nand4  g038(.a(new_n90_), .b(new_n76_), .c(new_n55_), .d(new_n61_), .O(new_n91_));
  ...
  aoi21  g045(.a(new_n91_), .b(x25), .c(new_n97_), .O(new_n98_));
  ...
  nand4  g051(.a(new_n103_), .b(new_n83_), .c(new_n102_), .d(new_n55_), .O(new_n104_));
  nand2  g052(.a(new_n104_), .b(x26), .O(new_n105_));
  nor2   g053(.a(x26), .b(x25), .O(new_n106_));
  nand4  g054(.a(new_n106_), .b(new_n83_), .c(new_n71_), .d(new_n94_), .O(new_n107_));
  ...
  nand3  g061(.a(new_n113_), .b(new_n90_), .c(new_n95_), .O(new_n114_));
  nor2   g062(.a(new_n114_), .b(new_n81_), .O(new_n115_));
  ...
  nand4  g068(.a(new_n120_), .b(new_n90_), .c(new_n76_), .d(new_n63_), .O(new_n121_));
  ...
  nor2   g072(.a(new_n124_), .b(new_n81_), .O(new_n125_));
  ...
  nand4  g078(.a(new_n132_), .b(new_n122_), .c(new_n106_), .d(new_n94_), .O(new_n133_));
  oai21  g079(.a(new_n133_), .b(new_n84_), .c(x31), .O(new_n134_));
  nand2  g080(.a(new_n90_), .b(new_n76_), .O(new_n135_));
  ...
  nand4  g086(.a(new_n140_), .b(new_n120_), .c(new_n136_), .d(new_n63_), .O(new_n141_));
  nand2  g087(.a(new_n141_), .b(new_n134_), .O(new_n142_));
  ...
  nand4  g093(.a(new_n148_), .b(new_n132_), .c(new_n122_), .d(new_n106_), .O(new_n149_));
  oai21  g094(.a(new_n149_), .b(new_n91_), .c(x33), .O(new_n150_));
  nor2   g095(.a(x33), .b(x32), .O(new_n151_));
  nand4  g096(.a(new_n151_), .b(new_n138_), .c(new_n137_), .d(new_n113_), .O(new_n152_));
  inv1   g097(.a(new_n152_), .O(new_n153_));
  nand2  g098(.a(new_n153_), .b(new_n97_), .O(new_n154_));
  nand2  g099(.a(new_n154_), .b(new_n150_), .O(new_n155_));
  nand2  g100(.a(new_n155_), .b(x16), .O(new_n156_));
  inv1   g101(.a(x01), .O(new_n157_));
  aoi21  g102(.a(new_n58_), .b(new_n157_), .c(x18), .O(new_n158_));
  nand2  g103(.a(new_n158_), .b(new_n156_), .O(z14));
  oai21  g104(.a(new_n152_), .b(new_n104_), .c(x34), .O(new_n160_));
  nand2  g105(.a(new_n137_), .b(new_n113_), .O(new_n161_));
  inv1   g106(.a(new_n161_), .O(new_n162_));
  inv1   g107(.a(x30), .O(new_n163_));
  inv1   g108(.a(x31), .O(new_n164_));
  nand2  g109(.a(new_n164_), .b(new_n163_), .O(new_n165_));
  inv1   g110(.a(x32), .O(new_n166_));
  inv1   g111(.a(x33), .O(new_n167_));
  inv1   g112(.a(x34), .O(new_n168_));
  nand3  g113(.a(new_n168_), .b(new_n167_), .c(new_n166_), .O(new_n169_));
  nor2   g114(.a(new_n169_), .b(new_n165_), .O(new_n170_));
  nand3  g115(.a(new_n170_), .b(new_n162_), .c(new_n97_), .O(new_n171_));
  nand2  g116(.a(new_n171_), .b(new_n160_), .O(new_n172_));
  nand2  g117(.a(new_n172_), .b(x16), .O(new_n173_));
  inv1   g118(.a(x00), .O(new_n174_));
  aoi21  g119(.a(new_n58_), .b(new_n174_), .c(x18), .O(new_n175_));
  nand2  g120(.a(new_n175_), .b(new_n173_), .O(z15));
  zero   g121(.O(z05));
  zero   g122(.O(z10));
  zero   g123(.O(z11));
  zero   g124(.O(z13));
