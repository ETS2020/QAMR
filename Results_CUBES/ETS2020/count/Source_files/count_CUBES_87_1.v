...
module FAU ( 
  ...
  nand4  g080(.a(new_n133_), .b(new_n116_), .c(new_n132_), .d(new_n83_), .O(new_n134_));
  ...
  nand4  g087(.a(new_n83_), .b(new_n93_), .c(new_n92_), .d(new_n65_), .O(new_n141_));
  ...
  nand4  g095(.a(new_n148_), .b(new_n112_), .c(new_n142_), .d(new_n56_), .O(new_n149_));
  ...
  nand4  g111(.a(new_n164_), .b(new_n161_), .c(new_n142_), .d(new_n56_), .O(new_n165_));
