...
module FAU ( 
  ...
  inv1   g065(.a(x23), .O(new_n119_));
  inv1   g066(.a(x26), .O(new_n120_));
  nor2   g067(.a(x28), .b(x27), .O(new_n121_));
  nand4  g068(.a(new_n121_), .b(new_n95_), .c(new_n120_), .d(new_n119_), .O(new_n122_));
  ...
  nand4  g077(.a(new_n94_), .b(new_n55_), .c(new_n69_), .d(new_n61_), .O(new_n131_));
  nor2   g078(.a(x30), .b(x29), .O(new_n132_));
  nand4  g079(.a(new_n132_), .b(new_n121_), .c(new_n95_), .d(new_n120_), .O(new_n133_));
  nor2   g080(.a(new_n133_), .b(new_n131_), .O(new_n134_));
  aoi21  g081(.a(new_n125_), .b(x30), .c(new_n134_), .O(new_n135_));
  ...
  oai21  g085(.a(new_n133_), .b(new_n131_), .c(x31), .O(new_n139_));
  inv1   g086(.a(new_n86_), .O(new_n140_));
  nor3   g087(.a(x27), .b(x26), .c(x25), .O(new_n141_));
  ...
  nand4  g092(.a(new_n145_), .b(new_n141_), .c(new_n140_), .d(new_n63_), .O(new_n146_));
  ...
  nand4  g099(.a(new_n154_), .b(new_n143_), .c(new_n142_), .d(new_n111_), .O(new_n155_));
  oai21  g100(.a(new_n155_), .b(new_n96_), .c(x34), .O(new_n156_));
  inv1   g101(.a(x22), .O(new_n157_));
  nand4  g102(.a(new_n92_), .b(new_n82_), .c(new_n119_), .d(new_n157_), .O(new_n158_));
  nor2   g103(.a(new_n158_), .b(new_n70_), .O(new_n159_));
  nand2  g104(.a(new_n142_), .b(new_n111_), .O(new_n160_));
