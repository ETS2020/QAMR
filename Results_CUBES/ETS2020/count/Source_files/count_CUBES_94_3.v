// Benchmark "FAU" written by ABC on Tue Jul  7 19:18:37 2020
...
module FAU ( 
  ...
  nand4  g048(.a(new_n101_), .b(new_n97_), .c(new_n96_), .d(new_n55_), .O(new_n102_));
  ...
  nand3  g054(.a(new_n71_), .b(new_n55_), .c(new_n61_), .O(new_n108_));
  nor2   g055(.a(x27), .b(x26), .O(new_n109_));
  nand3  g056(.a(new_n109_), .b(new_n80_), .c(new_n89_), .O(new_n110_));
  nor2   g057(.a(new_n110_), .b(new_n108_), .O(new_n111_));
  aoi21  g058(.a(new_n102_), .b(x27), .c(new_n111_), .O(new_n112_));
  ...
  nand4  g063(.a(new_n118_), .b(new_n101_), .c(new_n78_), .d(new_n63_), .O(new_n119_));
  nand4  g064(.a(new_n97_), .b(new_n55_), .c(new_n69_), .d(new_n61_), .O(new_n120_));
  nor2   g065(.a(x26), .b(x25), .O(new_n121_));
  nor2   g066(.a(x28), .b(x27), .O(new_n122_));
  nor2   g067(.a(x30), .b(x29), .O(new_n123_));
  nand4  g068(.a(new_n123_), .b(new_n122_), .c(new_n121_), .d(new_n77_), .O(new_n124_));
  nor2   g069(.a(new_n124_), .b(new_n120_), .O(new_n125_));
  aoi21  g070(.a(new_n119_), .b(x30), .c(new_n125_), .O(new_n126_));
  ...
  oai21  g074(.a(new_n124_), .b(new_n120_), .c(x31), .O(new_n130_));
  nor3   g075(.a(x27), .b(x26), .c(x25), .O(new_n131_));
  ...
  nand3  g080(.a(new_n135_), .b(new_n131_), .c(new_n82_), .O(new_n136_));
  ...
  nor2   g086(.a(x32), .b(x31), .O(new_n143_));
  nand4  g087(.a(new_n143_), .b(new_n123_), .c(new_n122_), .d(new_n121_), .O(new_n144_));
  oai21  g088(.a(new_n144_), .b(new_n81_), .c(x33), .O(new_n145_));
  nor2   g089(.a(x33), .b(x32), .O(new_n146_));
  nand4  g090(.a(new_n146_), .b(new_n133_), .c(new_n132_), .d(new_n109_), .O(new_n147_));
  inv1   g091(.a(new_n147_), .O(new_n148_));
  nand2  g092(.a(new_n148_), .b(new_n91_), .O(new_n149_));
  nand2  g093(.a(new_n149_), .b(new_n145_), .O(new_n150_));
  nand2  g094(.a(new_n150_), .b(x16), .O(new_n151_));
  inv1   g095(.a(x01), .O(new_n152_));
  aoi21  g096(.a(new_n58_), .b(new_n152_), .c(x18), .O(new_n153_));
  nand2  g097(.a(new_n153_), .b(new_n151_), .O(z14));
  oai21  g098(.a(new_n147_), .b(new_n99_), .c(x34), .O(new_n155_));
  nand2  g099(.a(new_n132_), .b(new_n109_), .O(new_n156_));
  inv1   g100(.a(new_n156_), .O(new_n157_));
  inv1   g101(.a(x30), .O(new_n158_));
  inv1   g102(.a(x31), .O(new_n159_));
  nand2  g103(.a(new_n159_), .b(new_n158_), .O(new_n160_));
  inv1   g104(.a(x32), .O(new_n161_));
  inv1   g105(.a(x33), .O(new_n162_));
  inv1   g106(.a(x34), .O(new_n163_));
  nand3  g107(.a(new_n163_), .b(new_n162_), .c(new_n161_), .O(new_n164_));
  nor2   g108(.a(new_n164_), .b(new_n160_), .O(new_n165_));
  nand3  g109(.a(new_n165_), .b(new_n157_), .c(new_n91_), .O(new_n166_));
  nand2  g110(.a(new_n166_), .b(new_n155_), .O(new_n167_));
  nand2  g111(.a(new_n167_), .b(x16), .O(new_n168_));
  inv1   g112(.a(x00), .O(new_n169_));
  aoi21  g113(.a(new_n58_), .b(new_n169_), .c(x18), .O(new_n170_));
  nand2  g114(.a(new_n170_), .b(new_n168_), .O(z15));
  zero   g115(.O(z02));
  zero   g116(.O(z04));
  zero   g117(.O(z09));
  zero   g118(.O(z10));
