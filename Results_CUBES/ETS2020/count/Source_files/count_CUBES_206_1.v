...
module FAU ( 
  ...
  nand4  g080(.a(new_n98_), .b(new_n56_), .c(new_n60_), .d(new_n55_), .O(new_n134_));
  nor2   g081(.a(x26), .b(x25), .O(new_n135_));
  nor2   g082(.a(x30), .b(x29), .O(new_n136_));
  nand4  g083(.a(new_n136_), .b(new_n118_), .c(new_n135_), .d(new_n79_), .O(new_n137_));
  ...
  aoi21  g087(.a(new_n54_), .b(new_n140_), .c(x18), .O(new_n141_));
  oai21  g088(.a(new_n139_), .b(new_n54_), .c(new_n141_), .O(z11));
