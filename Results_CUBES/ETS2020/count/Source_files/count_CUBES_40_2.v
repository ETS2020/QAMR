...
module FAU ( 
  ...
  nand4  g075(.a(new_n129_), .b(new_n116_), .c(new_n128_), .d(new_n84_), .O(new_n130_));
  ...
  nand4  g083(.a(new_n138_), .b(new_n137_), .c(new_n106_), .d(new_n95_), .O(new_n139_));
  oai21  g084(.a(new_n139_), .b(new_n87_), .c(x32), .O(new_n140_));
  nor2   g085(.a(x32), .b(x31), .O(new_n141_));
  nand4  g086(.a(new_n141_), .b(new_n129_), .c(new_n116_), .d(new_n128_), .O(new_n142_));
  ...
  nand4  g096(.a(new_n151_), .b(new_n138_), .c(new_n137_), .d(new_n106_), .O(new_n152_));
  ...
  nand4  g105(.a(new_n115_), .b(new_n103_), .c(new_n160_), .d(new_n55_), .O(new_n161_));
  oai21  g106(.a(new_n152_), .b(new_n161_), .c(x34), .O(new_n162_));
  nand2  g107(.a(new_n137_), .b(new_n106_), .O(new_n163_));
  ...
  nand3  g117(.a(new_n172_), .b(new_n164_), .c(new_n97_), .O(new_n173_));
