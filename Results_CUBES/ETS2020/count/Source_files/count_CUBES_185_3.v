...
module FAU ( 
  ...
  nor2   g053(.a(x23), .b(x22), .O(new_n106_));
  nor3   g054(.a(x26), .b(x25), .c(x24), .O(new_n107_));
  nand3  g055(.a(new_n107_), .b(new_n106_), .c(new_n71_), .O(new_n108_));
  nor2   g056(.a(x27), .b(x26), .O(new_n109_));
  nand3  g057(.a(new_n109_), .b(new_n89_), .c(new_n98_), .O(new_n110_));
  nor2   g058(.a(new_n110_), .b(new_n81_), .O(new_n111_));
  aoi21  g059(.a(new_n108_), .b(x27), .c(new_n111_), .O(new_n112_));
  inv1   g060(.a(x07), .O(new_n113_));
  aoi21  g061(.a(new_n58_), .b(new_n113_), .c(x18), .O(new_n114_));
  oai21  g062(.a(new_n112_), .b(new_n58_), .c(new_n114_), .O(z08));
  inv1   g063(.a(x26), .O(new_n117_));
  nor2   g064(.a(x25), .b(x24), .O(new_n118_));
  nor2   g065(.a(x28), .b(x27), .O(new_n119_));
  nand4  g066(.a(new_n119_), .b(new_n118_), .c(new_n117_), .d(new_n97_), .O(new_n120_));
  oai21  g067(.a(new_n120_), .b(new_n81_), .c(x29), .O(new_n121_));
  nor3   g068(.a(x29), .b(x28), .c(x27), .O(new_n122_));
  nand4  g069(.a(new_n122_), .b(new_n107_), .c(new_n82_), .d(new_n63_), .O(new_n123_));
  ...
  nand4  g075(.a(new_n106_), .b(new_n55_), .c(new_n69_), .d(new_n61_), .O(new_n129_));
  nor2   g076(.a(x26), .b(x25), .O(new_n130_));
  nor2   g077(.a(x30), .b(x29), .O(new_n131_));
  nand4  g078(.a(new_n131_), .b(new_n119_), .c(new_n130_), .d(new_n87_), .O(new_n132_));
  ...
  nand4  g096(.a(new_n141_), .b(new_n140_), .c(new_n109_), .d(new_n98_), .O(new_n150_));
  oai21  g097(.a(new_n150_), .b(new_n90_), .c(x32), .O(new_n151_));
  nand2  g098(.a(new_n131_), .b(new_n119_), .O(new_n152_));
  inv1   g099(.a(x31), .O(new_n153_));
  inv1   g100(.a(x32), .O(new_n154_));
  nand4  g101(.a(new_n154_), .b(new_n153_), .c(new_n117_), .d(new_n98_), .O(new_n155_));
  nor2   g102(.a(new_n155_), .b(new_n152_), .O(new_n156_));
  nand2  g103(.a(new_n156_), .b(new_n91_), .O(new_n157_));
  nand2  g104(.a(new_n157_), .b(new_n151_), .O(new_n158_));
  nand2  g105(.a(new_n158_), .b(x16), .O(new_n159_));
  inv1   g106(.a(x02), .O(new_n160_));
  aoi21  g107(.a(new_n58_), .b(new_n160_), .c(x18), .O(new_n161_));
  nand2  g108(.a(new_n161_), .b(new_n159_), .O(z13));
  nor2   g109(.a(x21), .b(x20), .O(new_n164_));
  nand4  g110(.a(new_n118_), .b(new_n106_), .c(new_n164_), .d(new_n55_), .O(new_n165_));
  nor2   g111(.a(x33), .b(x32), .O(new_n166_));
  nand4  g112(.a(new_n166_), .b(new_n141_), .c(new_n140_), .d(new_n109_), .O(new_n167_));
  oai21  g113(.a(new_n167_), .b(new_n165_), .c(x34), .O(new_n168_));
  nand2  g114(.a(new_n140_), .b(new_n109_), .O(new_n169_));
  inv1   g115(.a(new_n169_), .O(new_n170_));
  inv1   g116(.a(x30), .O(new_n171_));
  nand2  g117(.a(new_n153_), .b(new_n171_), .O(new_n172_));
  inv1   g118(.a(x33), .O(new_n173_));
  inv1   g119(.a(x34), .O(new_n174_));
  nand3  g120(.a(new_n174_), .b(new_n173_), .c(new_n154_), .O(new_n175_));
  nor2   g121(.a(new_n175_), .b(new_n172_), .O(new_n176_));
  nand3  g122(.a(new_n176_), .b(new_n170_), .c(new_n100_), .O(new_n177_));
  nand2  g123(.a(new_n177_), .b(new_n168_), .O(new_n178_));
