...
module FAU ( 
  ...
  aoi22  g039(.a(new_n92_), .b(new_n71_), .c(new_n86_), .d(x25), .O(new_n93_));
  ...
  nand3  g045(.a(new_n99_), .b(new_n98_), .c(new_n71_), .O(new_n100_));
  inv1   g046(.a(x26), .O(new_n101_));
  inv1   g047(.a(x27), .O(new_n102_));
  nand4  g048(.a(new_n85_), .b(new_n102_), .c(new_n101_), .d(new_n90_), .O(new_n103_));
  nor2   g049(.a(new_n103_), .b(new_n78_), .O(new_n104_));
  ...
  nand4  g055(.a(new_n109_), .b(new_n85_), .c(new_n77_), .d(new_n63_), .O(new_n110_));
  nor2   g056(.a(x25), .b(x24), .O(new_n111_));
  nor2   g057(.a(x28), .b(x27), .O(new_n112_));
  nand4  g058(.a(new_n112_), .b(new_n111_), .c(new_n101_), .d(new_n88_), .O(new_n113_));
  ...
  nand4  g066(.a(new_n120_), .b(new_n99_), .c(new_n79_), .d(new_n63_), .O(new_n121_));
  ...
  nand4  g072(.a(new_n98_), .b(new_n55_), .c(new_n68_), .d(new_n61_), .O(new_n128_));
  nor2   g073(.a(x26), .b(x25), .O(new_n129_));
  nor2   g074(.a(x30), .b(x29), .O(new_n130_));
  nand4  g075(.a(new_n130_), .b(new_n112_), .c(new_n129_), .d(new_n89_), .O(new_n131_));
  oai21  g076(.a(new_n131_), .b(new_n128_), .c(x31), .O(new_n132_));
  nand4  g077(.a(new_n89_), .b(new_n88_), .c(new_n87_), .d(new_n68_), .O(new_n133_));
  ...
  nand4  g085(.a(new_n140_), .b(new_n109_), .c(new_n134_), .d(new_n63_), .O(new_n141_));
  ...
  oai21  g093(.a(new_n149_), .b(new_n86_), .c(x33), .O(new_n150_));
  inv1   g094(.a(x32), .O(new_n151_));
  inv1   g095(.a(x33), .O(new_n152_));
  nand4  g096(.a(new_n152_), .b(new_n151_), .c(new_n102_), .d(new_n101_), .O(new_n153_));
  inv1   g097(.a(new_n153_), .O(new_n154_));
  nand4  g098(.a(new_n154_), .b(new_n140_), .c(new_n92_), .d(new_n71_), .O(new_n155_));
  nand2  g099(.a(new_n155_), .b(new_n150_), .O(new_n156_));
