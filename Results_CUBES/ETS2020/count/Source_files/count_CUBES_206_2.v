...
module FAU ( 
  ...
  nand4  g051(.a(new_n103_), .b(new_n82_), .c(new_n102_), .d(new_n55_), .O(new_n104_));
  nand2  g052(.a(new_n104_), .b(x26), .O(new_n105_));
  nor2   g053(.a(x26), .b(x25), .O(new_n106_));
  nand4  g054(.a(new_n106_), .b(new_n82_), .c(new_n71_), .d(new_n94_), .O(new_n107_));
  ...
  nor2   g068(.a(x28), .b(x27), .O(new_n124_));
  nor2   g069(.a(x30), .b(x29), .O(new_n125_));
  nand4  g070(.a(new_n125_), .b(new_n124_), .c(new_n106_), .d(new_n94_), .O(new_n126_));
  oai21  g071(.a(new_n126_), .b(new_n83_), .c(x31), .O(new_n127_));
  ...
  nand4  g083(.a(new_n130_), .b(new_n129_), .c(new_n114_), .d(new_n95_), .O(new_n139_));
  oai21  g084(.a(new_n139_), .b(new_n86_), .c(x32), .O(new_n140_));
  nand2  g085(.a(new_n125_), .b(new_n124_), .O(new_n141_));
  nor2   g086(.a(x32), .b(x31), .O(new_n142_));
  nand2  g087(.a(new_n142_), .b(new_n106_), .O(new_n143_));
  ...
  nand4  g096(.a(new_n152_), .b(new_n130_), .c(new_n129_), .d(new_n114_), .O(new_n153_));
  oai21  g097(.a(new_n153_), .b(new_n104_), .c(x34), .O(new_n154_));
  nand2  g098(.a(new_n129_), .b(new_n114_), .O(new_n155_));
  ...
  nand3  g108(.a(new_n164_), .b(new_n156_), .c(new_n97_), .O(new_n165_));
