...
module FAU ( 
  ...
  nand4  g076(.a(new_n129_), .b(new_n103_), .c(new_n77_), .d(new_n63_), .O(new_n130_));
  ...
  nand4  g088(.a(new_n142_), .b(new_n141_), .c(new_n110_), .d(new_n94_), .O(new_n143_));
  oai21  g089(.a(new_n143_), .b(new_n85_), .c(x32), .O(new_n144_));
  nand4  g090(.a(new_n82_), .b(new_n93_), .c(new_n92_), .d(new_n69_), .O(new_n145_));
  inv1   g091(.a(new_n145_), .O(new_n146_));
  inv1   g092(.a(x27), .O(new_n147_));
  inv1   g093(.a(x28), .O(new_n148_));
  inv1   g094(.a(x29), .O(new_n149_));
  inv1   g095(.a(x30), .O(new_n150_));
  nand4  g096(.a(new_n150_), .b(new_n149_), .c(new_n148_), .d(new_n147_), .O(new_n151_));
  inv1   g097(.a(new_n151_), .O(new_n152_));
  inv1   g098(.a(x31), .O(new_n153_));
  inv1   g099(.a(x32), .O(new_n154_));
  nand4  g100(.a(new_n154_), .b(new_n153_), .c(new_n119_), .d(new_n94_), .O(new_n155_));
  inv1   g101(.a(new_n155_), .O(new_n156_));
  nand4  g102(.a(new_n156_), .b(new_n152_), .c(new_n146_), .d(new_n63_), .O(new_n157_));
  nand2  g103(.a(new_n157_), .b(new_n144_), .O(new_n158_));
  ...
  nand4  g109(.a(new_n163_), .b(new_n133_), .c(new_n121_), .d(new_n132_), .O(new_n164_));
  oai21  g110(.a(new_n164_), .b(new_n85_), .c(x33), .O(new_n165_));
  nand4  g111(.a(new_n153_), .b(new_n150_), .c(new_n149_), .d(new_n148_), .O(new_n166_));
  inv1   g112(.a(new_n166_), .O(new_n167_));
  inv1   g113(.a(x33), .O(new_n168_));
  nand4  g114(.a(new_n168_), .b(new_n154_), .c(new_n147_), .d(new_n119_), .O(new_n169_));
  inv1   g115(.a(new_n169_), .O(new_n170_));
  nand4  g116(.a(new_n170_), .b(new_n167_), .c(new_n96_), .d(new_n91_), .O(new_n171_));
  nand2  g117(.a(new_n171_), .b(new_n165_), .O(new_n172_));
  nand2  g118(.a(new_n172_), .b(x16), .O(new_n173_));
  inv1   g119(.a(x01), .O(new_n174_));
  aoi21  g120(.a(new_n58_), .b(new_n174_), .c(x18), .O(new_n175_));
  nand2  g121(.a(new_n175_), .b(new_n173_), .O(z14));
  zero   g122(.O(z02));
  zero   g123(.O(z10));
  zero   g124(.O(z12));
  zero   g125(.O(z15));
