// Benchmark "FAU" written by ABC on Tue Jul  7 19:20:49 2020
...
module FAU ( 
  ...
  nor3   g082(.a(x29), .b(x28), .c(x27), .O(new_n135_));
  nand4  g083(.a(new_n135_), .b(new_n110_), .c(new_n82_), .d(new_n63_), .O(new_n136_));
  nor2   g084(.a(x26), .b(x25), .O(new_n137_));
  nor2   g085(.a(x30), .b(x29), .O(new_n138_));
  nand4  g086(.a(new_n138_), .b(new_n126_), .c(new_n137_), .d(new_n98_), .O(new_n139_));
  nor2   g087(.a(new_n139_), .b(new_n88_), .O(new_n140_));
  aoi21  g088(.a(new_n136_), .b(x30), .c(new_n140_), .O(new_n141_));
  ...
  oai21  g092(.a(new_n139_), .b(new_n88_), .c(x31), .O(new_n145_));
  ...
  nand3  g097(.a(new_n149_), .b(new_n124_), .c(new_n91_), .O(new_n150_));
  ...
  nand4  g103(.a(new_n147_), .b(new_n146_), .c(new_n117_), .d(new_n99_), .O(new_n156_));
  oai21  g104(.a(new_n156_), .b(new_n90_), .c(x32), .O(new_n157_));
  nor2   g105(.a(x32), .b(x31), .O(new_n158_));
  nand4  g106(.a(new_n158_), .b(new_n138_), .c(new_n126_), .d(new_n137_), .O(new_n159_));
  inv1   g107(.a(new_n159_), .O(new_n160_));
  nand2  g108(.a(new_n160_), .b(new_n91_), .O(new_n161_));
  nand2  g109(.a(new_n161_), .b(new_n157_), .O(new_n162_));
  nand2  g110(.a(new_n162_), .b(x16), .O(new_n163_));
  inv1   g111(.a(x02), .O(new_n164_));
  aoi21  g112(.a(new_n58_), .b(new_n164_), .c(x18), .O(new_n165_));
  nand2  g113(.a(new_n165_), .b(new_n163_), .O(z13));
  oai21  g114(.a(new_n159_), .b(new_n90_), .c(x33), .O(new_n167_));
  nor2   g115(.a(x33), .b(x32), .O(new_n168_));
  nand4  g116(.a(new_n168_), .b(new_n147_), .c(new_n146_), .d(new_n117_), .O(new_n169_));
  inv1   g117(.a(new_n169_), .O(new_n170_));
  nand2  g118(.a(new_n170_), .b(new_n101_), .O(new_n171_));
  nand2  g119(.a(new_n171_), .b(new_n167_), .O(new_n172_));
  nand2  g120(.a(new_n172_), .b(x16), .O(new_n173_));
  inv1   g121(.a(x01), .O(new_n174_));
  aoi21  g122(.a(new_n58_), .b(new_n174_), .c(x18), .O(new_n175_));
  nand2  g123(.a(new_n175_), .b(new_n173_), .O(z14));
  oai21  g124(.a(new_n169_), .b(new_n108_), .c(x34), .O(new_n177_));
  nand2  g125(.a(new_n146_), .b(new_n117_), .O(new_n178_));
  ...
  nand3  g135(.a(new_n187_), .b(new_n179_), .c(new_n101_), .O(new_n188_));
