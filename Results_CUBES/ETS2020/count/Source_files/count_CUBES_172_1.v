...
module FAU ( 
  ...
  nand4  g070(.a(new_n121_), .b(new_n114_), .c(new_n76_), .d(new_n63_), .O(new_n122_));
  ...
  nor2   g088(.a(x26), .b(x25), .O(new_n143_));
  nor2   g089(.a(x30), .b(x29), .O(new_n144_));
  nor2   g090(.a(x32), .b(x31), .O(new_n145_));
  nand4  g091(.a(new_n145_), .b(new_n144_), .c(new_n125_), .d(new_n143_), .O(new_n146_));
  oai21  g092(.a(new_n146_), .b(new_n90_), .c(x33), .O(new_n147_));
  inv1   g093(.a(x30), .O(new_n148_));
  inv1   g094(.a(x31), .O(new_n149_));
  inv1   g095(.a(x32), .O(new_n150_));
  inv1   g096(.a(x33), .O(new_n151_));
  nand4  g097(.a(new_n151_), .b(new_n150_), .c(new_n149_), .d(new_n148_), .O(new_n152_));
  inv1   g098(.a(new_n152_), .O(new_n153_));
  inv1   g099(.a(x27), .O(new_n154_));
  inv1   g100(.a(x28), .O(new_n155_));
  inv1   g101(.a(x29), .O(new_n156_));
  nand4  g102(.a(new_n156_), .b(new_n155_), .c(new_n154_), .d(new_n123_), .O(new_n157_));
  inv1   g103(.a(new_n157_), .O(new_n158_));
  nand4  g104(.a(new_n158_), .b(new_n153_), .c(new_n100_), .d(new_n71_), .O(new_n159_));
  nand2  g105(.a(new_n159_), .b(new_n147_), .O(new_n160_));
