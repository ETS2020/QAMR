// Benchmark "FAU" written by ABC on Tue Jul  7 19:18:00 2020
...
module FAU ( 
  ...
  nand4  g066(.a(new_n119_), .b(new_n118_), .c(new_n100_), .d(new_n92_), .O(new_n120_));
  oai21  g067(.a(new_n120_), .b(new_n76_), .c(x29), .O(new_n121_));
  nor3   g068(.a(x29), .b(x28), .c(x27), .O(new_n122_));
  nand4  g069(.a(new_n122_), .b(new_n103_), .c(new_n77_), .d(new_n63_), .O(new_n123_));
  ...
  nand4  g075(.a(new_n102_), .b(new_n55_), .c(new_n69_), .d(new_n61_), .O(new_n129_));
  nor2   g076(.a(x26), .b(x25), .O(new_n130_));
  nor2   g077(.a(x30), .b(x29), .O(new_n131_));
  nand4  g078(.a(new_n131_), .b(new_n119_), .c(new_n130_), .d(new_n82_), .O(new_n132_));
  ...
  nand3  g090(.a(new_n143_), .b(new_n139_), .c(new_n86_), .O(new_n144_));
  ...
  nand4  g096(.a(new_n141_), .b(new_n140_), .c(new_n110_), .d(new_n93_), .O(new_n150_));
  oai21  g097(.a(new_n150_), .b(new_n85_), .c(x32), .O(new_n151_));
  nor2   g098(.a(x32), .b(x31), .O(new_n152_));
  nand4  g099(.a(new_n152_), .b(new_n131_), .c(new_n119_), .d(new_n130_), .O(new_n153_));
  inv1   g100(.a(new_n153_), .O(new_n154_));
  nand2  g101(.a(new_n154_), .b(new_n86_), .O(new_n155_));
  ...
  oai21  g107(.a(new_n153_), .b(new_n85_), .c(x33), .O(new_n161_));
  nor2   g108(.a(x33), .b(x32), .O(new_n162_));
  nand4  g109(.a(new_n162_), .b(new_n141_), .c(new_n140_), .d(new_n110_), .O(new_n163_));
  inv1   g110(.a(new_n163_), .O(new_n164_));
  nand2  g111(.a(new_n164_), .b(new_n95_), .O(new_n165_));
  ...
  nand4  g117(.a(new_n118_), .b(new_n102_), .c(new_n101_), .d(new_n55_), .O(new_n171_));
  oai21  g118(.a(new_n163_), .b(new_n171_), .c(x34), .O(new_n172_));
  nand2  g119(.a(new_n140_), .b(new_n110_), .O(new_n173_));
