...
module FAU ( 
  ...
  nand4  g040(.a(new_n95_), .b(new_n94_), .c(new_n93_), .d(new_n55_), .O(new_n96_));
  nand3  g041(.a(new_n66_), .b(new_n55_), .c(new_n63_), .O(new_n97_));
  nor2   g042(.a(x27), .b(x26), .O(new_n98_));
  nand3  g043(.a(new_n98_), .b(new_n76_), .c(new_n85_), .O(new_n99_));
  ...
  nand4  g050(.a(new_n105_), .b(new_n76_), .c(new_n67_), .d(new_n66_), .O(new_n106_));
  ...
  nand4  g062(.a(new_n117_), .b(new_n95_), .c(new_n74_), .d(new_n67_), .O(new_n118_));
  ...
  nand4  g068(.a(new_n94_), .b(new_n55_), .c(new_n64_), .d(new_n63_), .O(new_n125_));
  nor2   g069(.a(x26), .b(x25), .O(new_n126_));
  nor2   g070(.a(x30), .b(x29), .O(new_n127_));
  nand4  g071(.a(new_n127_), .b(new_n108_), .c(new_n126_), .d(new_n73_), .O(new_n128_));
  ...
  nand3  g077(.a(new_n133_), .b(new_n105_), .c(new_n78_), .O(new_n134_));
  ...
  nand4  g084(.a(new_n141_), .b(new_n127_), .c(new_n108_), .d(new_n126_), .O(new_n142_));
  oai21  g085(.a(new_n142_), .b(new_n77_), .c(x33), .O(new_n143_));
  nor2   g086(.a(x33), .b(x32), .O(new_n144_));
  nand4  g087(.a(new_n144_), .b(new_n131_), .c(new_n130_), .d(new_n98_), .O(new_n145_));
  inv1   g088(.a(new_n145_), .O(new_n146_));
  nand2  g089(.a(new_n146_), .b(new_n87_), .O(new_n147_));
  nand2  g090(.a(new_n147_), .b(new_n143_), .O(new_n148_));
  ...
  nand4  g095(.a(new_n107_), .b(new_n94_), .c(new_n93_), .d(new_n55_), .O(new_n153_));
  oai21  g096(.a(new_n145_), .b(new_n153_), .c(x34), .O(new_n154_));
  nand2  g097(.a(new_n130_), .b(new_n98_), .O(new_n155_));
  inv1   g098(.a(new_n155_), .O(new_n156_));
  inv1   g099(.a(x30), .O(new_n157_));
  inv1   g100(.a(x31), .O(new_n158_));
  nand2  g101(.a(new_n158_), .b(new_n157_), .O(new_n159_));
  inv1   g102(.a(x32), .O(new_n160_));
  inv1   g103(.a(x33), .O(new_n161_));
  inv1   g104(.a(x34), .O(new_n162_));
  nand3  g105(.a(new_n162_), .b(new_n161_), .c(new_n160_), .O(new_n163_));
  nor2   g106(.a(new_n163_), .b(new_n159_), .O(new_n164_));
  nand3  g107(.a(new_n164_), .b(new_n156_), .c(new_n87_), .O(new_n165_));
  nand2  g108(.a(new_n165_), .b(new_n154_), .O(new_n166_));
  nand2  g109(.a(new_n166_), .b(x16), .O(new_n167_));
  inv1   g110(.a(x00), .O(new_n168_));
  aoi21  g111(.a(new_n58_), .b(new_n168_), .c(x18), .O(new_n169_));
  nand2  g112(.a(new_n169_), .b(new_n167_), .O(z15));
  zero   g113(.O(z01));
  zero   g114(.O(z02));
  zero   g115(.O(z04));
  zero   g116(.O(z07));
