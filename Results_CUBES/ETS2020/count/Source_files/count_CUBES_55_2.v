...
module FAU ( 
  ...
  nand4  g086(.a(new_n140_), .b(new_n139_), .c(new_n109_), .d(new_n98_), .O(new_n141_));
  oai21  g087(.a(new_n141_), .b(new_n90_), .c(x32), .O(new_n142_));
  nor2   g088(.a(x32), .b(x31), .O(new_n143_));
  nand4  g089(.a(new_n143_), .b(new_n131_), .c(new_n118_), .d(new_n130_), .O(new_n144_));
  inv1   g090(.a(new_n144_), .O(new_n145_));
  nand2  g091(.a(new_n145_), .b(new_n91_), .O(new_n146_));
  nand2  g092(.a(new_n146_), .b(new_n142_), .O(new_n147_));
  nand2  g093(.a(new_n147_), .b(x16), .O(new_n148_));
  inv1   g094(.a(x02), .O(new_n149_));
  aoi21  g095(.a(new_n58_), .b(new_n149_), .c(x18), .O(new_n150_));
  nand2  g096(.a(new_n150_), .b(new_n148_), .O(z13));
  oai21  g097(.a(new_n144_), .b(new_n90_), .c(x33), .O(new_n152_));
  nor2   g098(.a(x33), .b(x32), .O(new_n153_));
  nand4  g099(.a(new_n153_), .b(new_n140_), .c(new_n139_), .d(new_n109_), .O(new_n154_));
  inv1   g100(.a(new_n154_), .O(new_n155_));
  nand2  g101(.a(new_n155_), .b(new_n100_), .O(new_n156_));
  nand2  g102(.a(new_n156_), .b(new_n152_), .O(new_n157_));
  nand2  g103(.a(new_n157_), .b(x16), .O(new_n158_));
  inv1   g104(.a(x01), .O(new_n159_));
  aoi21  g105(.a(new_n58_), .b(new_n159_), .c(x18), .O(new_n160_));
  nand2  g106(.a(new_n160_), .b(new_n158_), .O(z14));
  nor2   g107(.a(x21), .b(x20), .O(new_n162_));
  nand4  g108(.a(new_n117_), .b(new_n106_), .c(new_n162_), .d(new_n55_), .O(new_n163_));
  oai21  g109(.a(new_n154_), .b(new_n163_), .c(x34), .O(new_n164_));
  nand2  g110(.a(new_n139_), .b(new_n109_), .O(new_n165_));
  ...
  nand3  g120(.a(new_n174_), .b(new_n166_), .c(new_n100_), .O(new_n175_));
  nand2  g121(.a(new_n175_), .b(new_n164_), .O(new_n176_));
