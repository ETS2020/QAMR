...
module FAU ( 
  ...
  nand4  g025(.a(new_n79_), .b(new_n72_), .c(new_n55_), .d(new_n62_), .O(new_n80_));
  ...
  nor2   g031(.a(new_n85_), .b(new_n65_), .O(new_n86_));
  ...
  nand3  g042(.a(new_n96_), .b(new_n92_), .c(new_n66_), .O(new_n97_));
  ...
  nand3  g048(.a(new_n72_), .b(new_n55_), .c(new_n62_), .O(new_n103_));
  ...
  nand4  g057(.a(new_n111_), .b(new_n79_), .c(new_n72_), .d(new_n71_), .O(new_n112_));
  ...
  nor3   g067(.a(x23), .b(x22), .c(x21), .O(new_n122_));
  nor3   g068(.a(x29), .b(x28), .c(x27), .O(new_n123_));
  nand4  g069(.a(new_n123_), .b(new_n122_), .c(new_n96_), .d(new_n71_), .O(new_n124_));
  oai21  g070(.a(new_n116_), .b(new_n121_), .c(new_n124_), .O(new_n125_));
  ...
  nand4  g075(.a(new_n92_), .b(new_n55_), .c(new_n64_), .d(new_n62_), .O(new_n130_));
  nor2   g076(.a(x26), .b(x25), .O(new_n131_));
  nor2   g077(.a(x30), .b(x29), .O(new_n132_));
  nand4  g078(.a(new_n132_), .b(new_n113_), .c(new_n131_), .d(new_n83_), .O(new_n133_));
  ...
  nand4  g086(.a(new_n141_), .b(new_n140_), .c(new_n104_), .d(new_n84_), .O(new_n142_));
  oai21  g087(.a(new_n142_), .b(new_n80_), .c(x32), .O(new_n143_));
  inv1   g088(.a(new_n80_), .O(new_n144_));
  nor2   g089(.a(x32), .b(x31), .O(new_n145_));
  nand4  g090(.a(new_n145_), .b(new_n132_), .c(new_n113_), .d(new_n131_), .O(new_n146_));
  inv1   g091(.a(new_n146_), .O(new_n147_));
  nand2  g092(.a(new_n147_), .b(new_n144_), .O(new_n148_));
  nand2  g093(.a(new_n148_), .b(new_n143_), .O(new_n149_));
  ...
  nand4  g100(.a(new_n155_), .b(new_n141_), .c(new_n140_), .d(new_n104_), .O(new_n156_));
  inv1   g101(.a(new_n156_), .O(new_n157_));
  nand2  g102(.a(new_n157_), .b(new_n86_), .O(new_n158_));
  ...
  oai21  g108(.a(new_n156_), .b(new_n94_), .c(x34), .O(new_n164_));
  nand2  g109(.a(new_n140_), .b(new_n104_), .O(new_n165_));
  ...
  nand3  g119(.a(new_n174_), .b(new_n166_), .c(new_n86_), .O(new_n175_));
