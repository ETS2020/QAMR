...
module FAU ( 
  ...
  nand3  g054(.a(new_n107_), .b(new_n82_), .c(new_n91_), .O(new_n108_));
  nor2   g055(.a(new_n108_), .b(new_n74_), .O(new_n109_));
  ...
  nand4  g061(.a(new_n114_), .b(new_n82_), .c(new_n73_), .d(new_n62_), .O(new_n115_));
  ...
  nand4  g092(.a(new_n146_), .b(new_n114_), .c(new_n140_), .d(new_n62_), .O(new_n147_));
  ...
  nor2   g098(.a(x29), .b(x28), .O(new_n153_));
  nor2   g099(.a(x31), .b(x30), .O(new_n154_));
  nand4  g100(.a(new_n154_), .b(new_n153_), .c(new_n107_), .d(new_n91_), .O(new_n155_));
  oai21  g101(.a(new_n155_), .b(new_n83_), .c(x32), .O(new_n156_));
  inv1   g102(.a(x27), .O(new_n157_));
  nand4  g103(.a(new_n143_), .b(new_n142_), .c(new_n141_), .d(new_n157_), .O(new_n158_));
  inv1   g104(.a(new_n158_), .O(new_n159_));
  inv1   g105(.a(x32), .O(new_n160_));
  nand4  g106(.a(new_n160_), .b(new_n144_), .c(new_n116_), .d(new_n91_), .O(new_n161_));
  inv1   g107(.a(new_n161_), .O(new_n162_));
  nand4  g108(.a(new_n162_), .b(new_n159_), .c(new_n140_), .d(new_n62_), .O(new_n163_));
  nand2  g109(.a(new_n163_), .b(new_n156_), .O(new_n164_));
  nand2  g110(.a(new_n164_), .b(x16), .O(new_n165_));
  inv1   g111(.a(x02), .O(new_n166_));
  aoi21  g112(.a(new_n58_), .b(new_n166_), .c(x18), .O(new_n167_));
  nand2  g113(.a(new_n167_), .b(new_n165_), .O(z13));
  nor2   g114(.a(x32), .b(x31), .O(new_n169_));
  nand4  g115(.a(new_n169_), .b(new_n136_), .c(new_n118_), .d(new_n135_), .O(new_n170_));
  oai21  g116(.a(new_n170_), .b(new_n83_), .c(x33), .O(new_n171_));
  inv1   g117(.a(x33), .O(new_n172_));
  nand4  g118(.a(new_n172_), .b(new_n160_), .c(new_n157_), .d(new_n116_), .O(new_n173_));
  inv1   g119(.a(new_n173_), .O(new_n174_));
  nand4  g120(.a(new_n174_), .b(new_n146_), .c(new_n93_), .d(new_n67_), .O(new_n175_));
  nand2  g121(.a(new_n175_), .b(new_n171_), .O(new_n176_));
