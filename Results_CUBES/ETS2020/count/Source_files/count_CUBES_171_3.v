...
module FAU ( 
  ...
  nand4  g063(.a(new_n117_), .b(new_n107_), .c(new_n82_), .d(new_n63_), .O(new_n118_));
  nand4  g064(.a(new_n106_), .b(new_n55_), .c(new_n69_), .d(new_n61_), .O(new_n119_));
  nor2   g065(.a(x26), .b(x25), .O(new_n120_));
  nor2   g066(.a(x28), .b(x27), .O(new_n121_));
  nor2   g067(.a(x30), .b(x29), .O(new_n122_));
  nand4  g068(.a(new_n122_), .b(new_n121_), .c(new_n120_), .d(new_n87_), .O(new_n123_));
  nor2   g069(.a(new_n123_), .b(new_n119_), .O(new_n124_));
  aoi21  g070(.a(new_n118_), .b(x30), .c(new_n124_), .O(new_n125_));
  ...
  oai21  g074(.a(new_n123_), .b(new_n119_), .c(x31), .O(new_n129_));
  nand4  g075(.a(new_n87_), .b(new_n97_), .c(new_n96_), .d(new_n69_), .O(new_n130_));
  inv1   g076(.a(new_n130_), .O(new_n131_));
  nor3   g077(.a(x29), .b(x28), .c(x25), .O(new_n132_));
  inv1   g078(.a(x26), .O(new_n133_));
  inv1   g079(.a(x27), .O(new_n134_));
  inv1   g080(.a(x30), .O(new_n135_));
  inv1   g081(.a(x31), .O(new_n136_));
  nand4  g082(.a(new_n136_), .b(new_n135_), .c(new_n134_), .d(new_n133_), .O(new_n137_));
  inv1   g083(.a(new_n137_), .O(new_n138_));
  nand4  g084(.a(new_n138_), .b(new_n132_), .c(new_n131_), .d(new_n63_), .O(new_n139_));
  nand2  g085(.a(new_n139_), .b(new_n129_), .O(new_n140_));
  ...
  nor2   g090(.a(x29), .b(x28), .O(new_n145_));
  nor2   g091(.a(x27), .b(x26), .O(new_n146_));
  nor2   g092(.a(x31), .b(x30), .O(new_n147_));
  nand4  g093(.a(new_n147_), .b(new_n146_), .c(new_n145_), .d(new_n98_), .O(new_n148_));
  oai21  g094(.a(new_n148_), .b(new_n90_), .c(x32), .O(new_n149_));
  inv1   g095(.a(x28), .O(new_n150_));
  inv1   g096(.a(x29), .O(new_n151_));
  nand4  g097(.a(new_n135_), .b(new_n151_), .c(new_n150_), .d(new_n134_), .O(new_n152_));
  inv1   g098(.a(new_n152_), .O(new_n153_));
  inv1   g099(.a(x32), .O(new_n154_));
  nand4  g100(.a(new_n154_), .b(new_n136_), .c(new_n133_), .d(new_n98_), .O(new_n155_));
  inv1   g101(.a(new_n155_), .O(new_n156_));
  nand4  g102(.a(new_n156_), .b(new_n153_), .c(new_n131_), .d(new_n63_), .O(new_n157_));
  nand2  g103(.a(new_n157_), .b(new_n149_), .O(new_n158_));
  ...
  nor2   g108(.a(x32), .b(x31), .O(new_n163_));
  nand4  g109(.a(new_n163_), .b(new_n122_), .c(new_n121_), .d(new_n120_), .O(new_n164_));
  oai21  g110(.a(new_n164_), .b(new_n90_), .c(x33), .O(new_n165_));
  inv1   g111(.a(x33), .O(new_n166_));
  nand4  g112(.a(new_n166_), .b(new_n154_), .c(new_n151_), .d(new_n150_), .O(new_n167_));
  inv1   g113(.a(new_n167_), .O(new_n168_));
  nand4  g114(.a(new_n168_), .b(new_n138_), .c(new_n100_), .d(new_n71_), .O(new_n169_));
  nand2  g115(.a(new_n169_), .b(new_n165_), .O(new_n170_));
  nand2  g116(.a(new_n170_), .b(x16), .O(new_n171_));
  inv1   g117(.a(x01), .O(new_n172_));
  aoi21  g118(.a(new_n58_), .b(new_n172_), .c(x18), .O(new_n173_));
  nand2  g119(.a(new_n173_), .b(new_n171_), .O(z14));
  zero   g120(.O(z08));
  zero   g121(.O(z09));
  zero   g122(.O(z10));
  zero   g123(.O(z15));
