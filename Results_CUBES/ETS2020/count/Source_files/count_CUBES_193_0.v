...
module FAU ( 
  ...
  oai21  g087(.a(new_n134_), .b(new_n131_), .c(x31), .O(new_n140_));
  inv1   g088(.a(x22), .O(new_n141_));
  nand4  g089(.a(new_n132_), .b(new_n113_), .c(new_n141_), .d(new_n130_), .O(new_n142_));
  ...
  nand4  g097(.a(new_n149_), .b(new_n111_), .c(new_n143_), .d(new_n60_), .O(new_n150_));
  nand2  g098(.a(new_n150_), .b(new_n140_), .O(new_n151_));
  ...
  nand4  g105(.a(new_n157_), .b(new_n156_), .c(new_n104_), .d(new_n103_), .O(new_n158_));
  oai21  g106(.a(new_n158_), .b(new_n86_), .c(x32), .O(new_n159_));
  nand4  g107(.a(new_n146_), .b(new_n145_), .c(new_n144_), .d(new_n103_), .O(new_n160_));
  inv1   g108(.a(new_n160_), .O(new_n161_));
  inv1   g109(.a(x25), .O(new_n162_));
  inv1   g110(.a(x32), .O(new_n163_));
  nand4  g111(.a(new_n163_), .b(new_n147_), .c(new_n114_), .d(new_n162_), .O(new_n164_));
  inv1   g112(.a(new_n164_), .O(new_n165_));
  nand4  g113(.a(new_n165_), .b(new_n161_), .c(new_n143_), .d(new_n60_), .O(new_n166_));
