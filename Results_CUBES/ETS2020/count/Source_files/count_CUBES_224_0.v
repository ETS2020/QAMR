...
module FAU ( 
  ...
  nand4  g072(.a(new_n128_), .b(new_n127_), .c(new_n126_), .d(new_n88_), .O(new_n129_));
  oai21  g073(.a(new_n129_), .b(new_n84_), .c(x32), .O(new_n130_));
  nand2  g074(.a(new_n83_), .b(new_n71_), .O(new_n131_));
  inv1   g075(.a(new_n131_), .O(new_n132_));
  nor2   g076(.a(x30), .b(x29), .O(new_n133_));
  nor2   g077(.a(x32), .b(x31), .O(new_n134_));
  nand2  g078(.a(new_n134_), .b(new_n133_), .O(new_n135_));
  inv1   g079(.a(new_n135_), .O(new_n136_));
  nor2   g080(.a(x26), .b(x25), .O(new_n137_));
  nand2  g081(.a(new_n109_), .b(new_n137_), .O(new_n138_));
  inv1   g082(.a(new_n138_), .O(new_n139_));
  nand4  g083(.a(new_n139_), .b(new_n136_), .c(new_n132_), .d(new_n63_), .O(new_n140_));
  nand2  g084(.a(new_n140_), .b(new_n130_), .O(new_n141_));
  ...
  nand4  g089(.a(new_n134_), .b(new_n133_), .c(new_n109_), .d(new_n137_), .O(new_n146_));
  oai21  g090(.a(new_n146_), .b(new_n84_), .c(x33), .O(new_n147_));
  nor2   g091(.a(x33), .b(x32), .O(new_n148_));
  nand4  g092(.a(new_n148_), .b(new_n128_), .c(new_n127_), .d(new_n126_), .O(new_n149_));
  inv1   g093(.a(new_n149_), .O(new_n150_));
  nand2  g094(.a(new_n150_), .b(new_n90_), .O(new_n151_));
  ...
  nand4  g100(.a(new_n108_), .b(new_n97_), .c(new_n96_), .d(new_n55_), .O(new_n157_));
  oai21  g101(.a(new_n149_), .b(new_n157_), .c(x34), .O(new_n158_));
  nand2  g102(.a(new_n127_), .b(new_n126_), .O(new_n159_));
  ...
  nand3  g112(.a(new_n168_), .b(new_n160_), .c(new_n90_), .O(new_n169_));
