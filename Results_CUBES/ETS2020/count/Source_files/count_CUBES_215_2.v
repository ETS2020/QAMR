...
module FAU ( 
  ...
  inv1   g038(.a(x21), .O(new_n91_));
  nand4  g039(.a(new_n91_), .b(new_n61_), .c(new_n53_), .d(new_n52_), .O(new_n92_));
  inv1   g040(.a(x22), .O(new_n93_));
  inv1   g041(.a(x23), .O(new_n94_));
  inv1   g042(.a(x25), .O(new_n95_));
  nand4  g043(.a(new_n95_), .b(new_n82_), .c(new_n94_), .d(new_n93_), .O(new_n96_));
  nor2   g044(.a(new_n96_), .b(new_n92_), .O(new_n97_));
  aoi21  g045(.a(new_n85_), .b(x25), .c(new_n97_), .O(new_n98_));
  ...
  nand4  g050(.a(new_n104_), .b(new_n84_), .c(new_n75_), .d(new_n63_), .O(new_n105_));
  nor2   g051(.a(x25), .b(x24), .O(new_n106_));
  nor2   g052(.a(x28), .b(x27), .O(new_n107_));
  nor2   g053(.a(x26), .b(x23), .O(new_n108_));
  nand3  g054(.a(new_n108_), .b(new_n107_), .c(new_n106_), .O(new_n109_));
  nor2   g055(.a(new_n109_), .b(new_n76_), .O(new_n110_));
  aoi21  g056(.a(new_n105_), .b(x28), .c(new_n110_), .O(new_n111_));
  inv1   g057(.a(x06), .O(new_n112_));
  aoi21  g058(.a(new_n58_), .b(new_n112_), .c(x18), .O(new_n113_));
  oai21  g059(.a(new_n111_), .b(new_n58_), .c(new_n113_), .O(z09));
  inv1   g060(.a(x29), .O(new_n115_));
  nor3   g061(.a(x26), .b(x25), .c(x24), .O(new_n116_));
  nor3   g062(.a(x29), .b(x28), .c(x27), .O(new_n117_));
  nand4  g063(.a(new_n117_), .b(new_n116_), .c(new_n77_), .d(new_n63_), .O(new_n118_));
  oai21  g064(.a(new_n110_), .b(new_n115_), .c(new_n118_), .O(new_n119_));
  ...
  nor2   g069(.a(x23), .b(x22), .O(new_n124_));
  nand4  g070(.a(new_n124_), .b(new_n55_), .c(new_n91_), .d(new_n61_), .O(new_n125_));
  nor2   g071(.a(x26), .b(x25), .O(new_n126_));
  nor2   g072(.a(x30), .b(x29), .O(new_n127_));
  nand4  g073(.a(new_n127_), .b(new_n126_), .c(new_n107_), .d(new_n82_), .O(new_n128_));
  nor2   g074(.a(new_n128_), .b(new_n125_), .O(new_n129_));
  aoi21  g075(.a(new_n118_), .b(x30), .c(new_n129_), .O(new_n130_));
  ...
  nand3  g084(.a(new_n138_), .b(new_n104_), .c(new_n86_), .O(new_n139_));
  ...
  nor2   g090(.a(x27), .b(x26), .O(new_n145_));
  nand4  g091(.a(new_n136_), .b(new_n135_), .c(new_n145_), .d(new_n95_), .O(new_n146_));
  oai21  g092(.a(new_n146_), .b(new_n85_), .c(x32), .O(new_n147_));
  nor2   g093(.a(x32), .b(x31), .O(new_n148_));
  nand4  g094(.a(new_n148_), .b(new_n127_), .c(new_n126_), .d(new_n107_), .O(new_n149_));
  inv1   g095(.a(new_n149_), .O(new_n150_));
  nand2  g096(.a(new_n150_), .b(new_n86_), .O(new_n151_));
  ...
  oai21  g102(.a(new_n149_), .b(new_n85_), .c(x33), .O(new_n157_));
  nor2   g103(.a(x33), .b(x32), .O(new_n158_));
  nand4  g104(.a(new_n158_), .b(new_n136_), .c(new_n135_), .d(new_n145_), .O(new_n159_));
  ...
  nand4  g112(.a(new_n106_), .b(new_n124_), .c(new_n69_), .d(new_n55_), .O(new_n167_));
  oai21  g113(.a(new_n159_), .b(new_n167_), .c(x34), .O(new_n168_));
  nand2  g114(.a(new_n135_), .b(new_n145_), .O(new_n169_));
  ...
  nand3  g124(.a(new_n178_), .b(new_n170_), .c(new_n97_), .O(new_n179_));
