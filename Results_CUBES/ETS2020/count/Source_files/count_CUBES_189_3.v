...
module FAU ( 
  ...
  oai21  g044(.a(new_n96_), .b(new_n67_), .c(x26), .O(new_n97_));
  nor3   g045(.a(x26), .b(x25), .c(x24), .O(new_n98_));
  nand3  g046(.a(new_n98_), .b(new_n94_), .c(new_n68_), .O(new_n99_));
  ...
  nand3  g054(.a(new_n106_), .b(new_n86_), .c(new_n105_), .O(new_n107_));
  nor2   g055(.a(new_n107_), .b(new_n78_), .O(new_n108_));
  ...
  oai21  g064(.a(new_n117_), .b(new_n78_), .c(x29), .O(new_n118_));
  nor3   g065(.a(x29), .b(x28), .c(x27), .O(new_n119_));
  nand4  g066(.a(new_n119_), .b(new_n98_), .c(new_n79_), .d(new_n60_), .O(new_n120_));
  ...
  nand4  g073(.a(new_n94_), .b(new_n58_), .c(new_n126_), .d(new_n57_), .O(new_n127_));
  nor2   g074(.a(x30), .b(x29), .O(new_n128_));
  nand4  g075(.a(new_n128_), .b(new_n116_), .c(new_n106_), .d(new_n84_), .O(new_n129_));
  ...
  nand4  g083(.a(new_n84_), .b(new_n114_), .c(new_n136_), .d(new_n126_), .O(new_n137_));
  ...
  nand4  g108(.a(new_n161_), .b(new_n157_), .c(new_n138_), .d(new_n60_), .O(new_n162_));
