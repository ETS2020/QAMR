...
module FAU ( 
  ...
  nand4  g058(.a(new_n114_), .b(new_n92_), .c(new_n75_), .d(new_n56_), .O(new_n115_));
  nand4  g059(.a(new_n91_), .b(new_n54_), .c(new_n65_), .d(new_n53_), .O(new_n116_));
  nor2   g060(.a(x26), .b(x25), .O(new_n117_));
  nor2   g061(.a(x30), .b(x29), .O(new_n118_));
  nand4  g062(.a(new_n118_), .b(new_n104_), .c(new_n117_), .d(new_n80_), .O(new_n119_));
  ...
  nand4  g070(.a(new_n127_), .b(new_n126_), .c(new_n95_), .d(new_n94_), .O(new_n128_));
  oai21  g071(.a(new_n128_), .b(new_n83_), .c(x32), .O(new_n129_));
  nor2   g072(.a(x32), .b(x31), .O(new_n130_));
  nand4  g073(.a(new_n130_), .b(new_n118_), .c(new_n104_), .d(new_n117_), .O(new_n131_));
  inv1   g074(.a(new_n131_), .O(new_n132_));
  nand2  g075(.a(new_n132_), .b(new_n84_), .O(new_n133_));
  nand2  g076(.a(new_n133_), .b(new_n129_), .O(new_n134_));
  nand2  g077(.a(new_n134_), .b(x16), .O(new_n135_));
  inv1   g078(.a(x02), .O(new_n136_));
  aoi21  g079(.a(new_n59_), .b(new_n136_), .c(x18), .O(new_n137_));
  nand2  g080(.a(new_n137_), .b(new_n135_), .O(z13));
  oai21  g081(.a(new_n131_), .b(new_n83_), .c(x33), .O(new_n139_));
  inv1   g082(.a(x22), .O(new_n140_));
  inv1   g083(.a(x23), .O(new_n141_));
  nand4  g084(.a(new_n94_), .b(new_n80_), .c(new_n141_), .d(new_n140_), .O(new_n142_));
  ...
  nand4  g096(.a(new_n105_), .b(new_n91_), .c(new_n153_), .d(new_n54_), .O(new_n154_));
