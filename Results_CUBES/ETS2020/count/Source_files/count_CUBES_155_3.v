// Benchmark "FAU" written by ABC on Tue Jul  7 19:19:36 2020
...
module FAU ( 
  ...
  nand3  g067(.a(new_n120_), .b(new_n119_), .c(new_n99_), .O(new_n121_));
  ...
  nand4  g084(.a(new_n137_), .b(new_n119_), .c(new_n136_), .d(new_n78_), .O(new_n138_));
  ...
  nand2  g106(.a(new_n159_), .b(new_n83_), .O(new_n160_));
  ...
  oai21  g112(.a(new_n158_), .b(new_n82_), .c(x33), .O(new_n166_));
  ...
  nand2  g116(.a(new_n169_), .b(new_n92_), .O(new_n170_));
  ...
  oai21  g122(.a(new_n168_), .b(new_n100_), .c(x34), .O(new_n176_));
  ...
  nand3  g133(.a(new_n186_), .b(new_n178_), .c(new_n92_), .O(new_n187_));
