...
module FAU ( 
  ...
  nand4  g072(.a(new_n126_), .b(new_n108_), .c(new_n125_), .d(new_n83_), .O(new_n127_));
  ...
  nand3  g083(.a(new_n137_), .b(new_n106_), .c(new_n87_), .O(new_n138_));
  ...
  inv1   g089(.a(x25), .O(new_n144_));
  nor2   g090(.a(x27), .b(x26), .O(new_n145_));
  nand4  g091(.a(new_n135_), .b(new_n134_), .c(new_n145_), .d(new_n144_), .O(new_n146_));
  oai21  g092(.a(new_n146_), .b(new_n86_), .c(x32), .O(new_n147_));
  nor2   g093(.a(x32), .b(x31), .O(new_n148_));
  nand4  g094(.a(new_n148_), .b(new_n126_), .c(new_n108_), .d(new_n125_), .O(new_n149_));
  ...
  nand4  g105(.a(new_n144_), .b(new_n83_), .c(new_n159_), .d(new_n158_), .O(new_n160_));
  nor2   g106(.a(new_n160_), .b(new_n66_), .O(new_n161_));
  nor2   g107(.a(x33), .b(x32), .O(new_n162_));
  nand4  g108(.a(new_n162_), .b(new_n135_), .c(new_n134_), .d(new_n145_), .O(new_n163_));
  ...
  nand2  g117(.a(new_n134_), .b(new_n145_), .O(new_n172_));
