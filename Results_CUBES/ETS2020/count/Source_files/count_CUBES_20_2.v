...
module FAU ( 
  ...
  nand4  g075(.a(new_n128_), .b(new_n103_), .c(new_n75_), .d(new_n56_), .O(new_n129_));
  ...
  aoi21  g079(.a(new_n59_), .b(new_n132_), .c(x18), .O(new_n133_));
  nand2  g080(.a(new_n133_), .b(new_n131_), .O(z10));
  nand4  g081(.a(new_n99_), .b(new_n54_), .c(new_n65_), .d(new_n53_), .O(new_n135_));
  ...
  aoi21  g088(.a(new_n59_), .b(new_n141_), .c(x18), .O(new_n142_));
  oai21  g089(.a(new_n140_), .b(new_n59_), .c(new_n142_), .O(z11));
  ...
  aoi21  g110(.a(new_n59_), .b(new_n163_), .c(x18), .O(new_n164_));
  ...
  aoi21  g120(.a(new_n59_), .b(new_n173_), .c(x18), .O(new_n174_));
  ...
  aoi21  g137(.a(new_n59_), .b(new_n190_), .c(x18), .O(new_n191_));
