...
module FAU ( 
  ...
  nand4  g068(.a(new_n89_), .b(new_n55_), .c(new_n75_), .d(new_n61_), .O(new_n124_));
  nor2   g069(.a(x26), .b(x25), .O(new_n125_));
  nor2   g070(.a(x30), .b(x29), .O(new_n126_));
  nand4  g071(.a(new_n126_), .b(new_n108_), .c(new_n125_), .d(new_n79_), .O(new_n127_));
  ...
  nand4  g079(.a(new_n135_), .b(new_n134_), .c(new_n98_), .d(new_n80_), .O(new_n136_));
  oai21  g080(.a(new_n136_), .b(new_n74_), .c(x32), .O(new_n137_));
  nand2  g081(.a(new_n73_), .b(new_n72_), .O(new_n138_));
  inv1   g082(.a(new_n138_), .O(new_n139_));
  nand2  g083(.a(new_n126_), .b(new_n108_), .O(new_n140_));
  inv1   g084(.a(new_n140_), .O(new_n141_));
  nor2   g085(.a(x32), .b(x31), .O(new_n142_));
  nand2  g086(.a(new_n142_), .b(new_n125_), .O(new_n143_));
  inv1   g087(.a(new_n143_), .O(new_n144_));
  nand4  g088(.a(new_n144_), .b(new_n141_), .c(new_n139_), .d(new_n63_), .O(new_n145_));
  ...
  nand4  g094(.a(new_n142_), .b(new_n126_), .c(new_n108_), .d(new_n125_), .O(new_n151_));
  oai21  g095(.a(new_n151_), .b(new_n74_), .c(x33), .O(new_n152_));
  nor2   g096(.a(x33), .b(x32), .O(new_n153_));
  nand4  g097(.a(new_n153_), .b(new_n135_), .c(new_n134_), .d(new_n98_), .O(new_n154_));
  inv1   g098(.a(new_n154_), .O(new_n155_));
  nand2  g099(.a(new_n155_), .b(new_n82_), .O(new_n156_));
  nand2  g100(.a(new_n156_), .b(new_n152_), .O(new_n157_));
  nand2  g101(.a(new_n157_), .b(x16), .O(new_n158_));
  inv1   g102(.a(x01), .O(new_n159_));
  aoi21  g103(.a(new_n58_), .b(new_n159_), .c(x18), .O(new_n160_));
  nand2  g104(.a(new_n160_), .b(new_n158_), .O(z14));
  nand4  g105(.a(new_n107_), .b(new_n89_), .c(new_n88_), .d(new_n55_), .O(new_n162_));
  oai21  g106(.a(new_n154_), .b(new_n162_), .c(x34), .O(new_n163_));
  nand2  g107(.a(new_n134_), .b(new_n98_), .O(new_n164_));
