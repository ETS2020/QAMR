...
module FAU ( 
  ...
  nand3  g047(.a(new_n66_), .b(new_n55_), .c(new_n63_), .O(new_n102_));
  nor2   g048(.a(x27), .b(x26), .O(new_n103_));
  nand3  g049(.a(new_n103_), .b(new_n76_), .c(new_n85_), .O(new_n104_));
  ...
  nand4  g056(.a(new_n110_), .b(new_n76_), .c(new_n67_), .d(new_n66_), .O(new_n111_));
  nor2   g057(.a(x25), .b(x24), .O(new_n112_));
  nor2   g058(.a(x28), .b(x27), .O(new_n113_));
  nand4  g059(.a(new_n113_), .b(new_n112_), .c(new_n92_), .d(new_n84_), .O(new_n114_));
  nor2   g060(.a(new_n114_), .b(new_n102_), .O(new_n115_));
  ...
  nand4  g066(.a(new_n121_), .b(new_n95_), .c(new_n74_), .d(new_n67_), .O(new_n122_));
  nand4  g067(.a(new_n94_), .b(new_n55_), .c(new_n64_), .d(new_n63_), .O(new_n123_));
  nor2   g068(.a(x26), .b(x25), .O(new_n124_));
  nor2   g069(.a(x30), .b(x29), .O(new_n125_));
  nand4  g070(.a(new_n125_), .b(new_n113_), .c(new_n124_), .d(new_n73_), .O(new_n126_));
  ...
  nand4  g078(.a(new_n134_), .b(new_n133_), .c(new_n103_), .d(new_n85_), .O(new_n135_));
  oai21  g079(.a(new_n135_), .b(new_n77_), .c(x32), .O(new_n136_));
  nand2  g080(.a(new_n125_), .b(new_n113_), .O(new_n137_));
  inv1   g081(.a(x31), .O(new_n138_));
  inv1   g082(.a(x32), .O(new_n139_));
  nand4  g083(.a(new_n139_), .b(new_n138_), .c(new_n92_), .d(new_n85_), .O(new_n140_));
  nor2   g084(.a(new_n140_), .b(new_n137_), .O(new_n141_));
  nand2  g085(.a(new_n141_), .b(new_n78_), .O(new_n142_));
  ...
  nand4  g091(.a(new_n112_), .b(new_n94_), .c(new_n93_), .d(new_n55_), .O(new_n149_));
  nor2   g092(.a(x33), .b(x32), .O(new_n150_));
  nand4  g093(.a(new_n150_), .b(new_n134_), .c(new_n133_), .d(new_n103_), .O(new_n151_));
  oai21  g094(.a(new_n151_), .b(new_n149_), .c(x34), .O(new_n152_));
  nand2  g095(.a(new_n133_), .b(new_n103_), .O(new_n153_));
  inv1   g096(.a(new_n153_), .O(new_n154_));
  inv1   g097(.a(x30), .O(new_n155_));
  nand2  g098(.a(new_n138_), .b(new_n155_), .O(new_n156_));
  inv1   g099(.a(x33), .O(new_n157_));
  inv1   g100(.a(x34), .O(new_n158_));
  nand3  g101(.a(new_n158_), .b(new_n157_), .c(new_n139_), .O(new_n159_));
  nor2   g102(.a(new_n159_), .b(new_n156_), .O(new_n160_));
  nand3  g103(.a(new_n160_), .b(new_n154_), .c(new_n87_), .O(new_n161_));
  nand2  g104(.a(new_n161_), .b(new_n152_), .O(new_n162_));
