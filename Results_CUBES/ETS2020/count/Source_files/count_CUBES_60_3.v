...
module FAU ( 
  ...
  nand3  g055(.a(new_n72_), .b(new_n55_), .c(new_n64_), .O(new_n109_));
  ...
  nand4  g064(.a(new_n117_), .b(new_n81_), .c(new_n72_), .d(new_n62_), .O(new_n118_));
  ...
  nand4  g074(.a(new_n128_), .b(new_n102_), .c(new_n79_), .d(new_n62_), .O(new_n129_));
  nand4  g075(.a(new_n98_), .b(new_n55_), .c(new_n65_), .d(new_n64_), .O(new_n130_));
  nor2   g076(.a(x26), .b(x25), .O(new_n131_));
  nor2   g077(.a(x30), .b(x29), .O(new_n132_));
  nand4  g078(.a(new_n132_), .b(new_n119_), .c(new_n131_), .d(new_n78_), .O(new_n133_));
  ...
  nand4  g096(.a(new_n151_), .b(new_n132_), .c(new_n119_), .d(new_n131_), .O(new_n152_));
  oai21  g097(.a(new_n152_), .b(new_n82_), .c(x33), .O(new_n153_));
