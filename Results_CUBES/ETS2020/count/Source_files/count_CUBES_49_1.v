...
module FAU ( 
  ...
  aoi22  g045(.a(new_n97_), .b(new_n71_), .c(new_n91_), .d(x25), .O(new_n98_));
  ...
  nand3  g050(.a(new_n103_), .b(new_n83_), .c(new_n71_), .O(new_n104_));
  inv1   g051(.a(x26), .O(new_n105_));
  inv1   g052(.a(x27), .O(new_n106_));
  nand4  g053(.a(new_n90_), .b(new_n106_), .c(new_n105_), .d(new_n95_), .O(new_n107_));
  nor2   g054(.a(new_n107_), .b(new_n81_), .O(new_n108_));
  ...
  nand4  g060(.a(new_n113_), .b(new_n90_), .c(new_n76_), .d(new_n63_), .O(new_n114_));
  nor2   g061(.a(x25), .b(x24), .O(new_n115_));
  nor2   g062(.a(x28), .b(x27), .O(new_n116_));
  nand4  g063(.a(new_n116_), .b(new_n115_), .c(new_n105_), .d(new_n93_), .O(new_n117_));
  ...
  nand4  g071(.a(new_n126_), .b(new_n116_), .c(new_n125_), .d(new_n94_), .O(new_n127_));
  oai21  g072(.a(new_n127_), .b(new_n84_), .c(x31), .O(new_n128_));
  nand4  g073(.a(new_n94_), .b(new_n93_), .c(new_n92_), .d(new_n69_), .O(new_n129_));
  ...
  nand4  g081(.a(new_n136_), .b(new_n113_), .c(new_n130_), .d(new_n63_), .O(new_n137_));
  nand2  g082(.a(new_n137_), .b(new_n128_), .O(new_n138_));
  ...
  nand4  g088(.a(new_n144_), .b(new_n126_), .c(new_n116_), .d(new_n125_), .O(new_n145_));
  oai21  g089(.a(new_n145_), .b(new_n91_), .c(x33), .O(new_n146_));
  inv1   g090(.a(x32), .O(new_n147_));
  inv1   g091(.a(x33), .O(new_n148_));
  nand4  g092(.a(new_n148_), .b(new_n147_), .c(new_n106_), .d(new_n105_), .O(new_n149_));
  inv1   g093(.a(new_n149_), .O(new_n150_));
  nand4  g094(.a(new_n150_), .b(new_n136_), .c(new_n97_), .d(new_n71_), .O(new_n151_));
  nand2  g095(.a(new_n151_), .b(new_n146_), .O(new_n152_));
