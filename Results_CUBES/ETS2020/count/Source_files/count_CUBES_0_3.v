...
module FAU ( 
  ...
  nand3  g062(.a(new_n76_), .b(new_n55_), .c(new_n61_), .O(new_n116_));
  ...
  nor2   g066(.a(new_n119_), .b(new_n116_), .O(new_n120_));
  ...
  nand4  g082(.a(new_n135_), .b(new_n117_), .c(new_n134_), .d(new_n82_), .O(new_n136_));
  ...
  nand4  g100(.a(new_n144_), .b(new_n143_), .c(new_n153_), .d(new_n94_), .O(new_n154_));
  oai21  g101(.a(new_n154_), .b(new_n86_), .c(x32), .O(new_n155_));
  nor2   g102(.a(x32), .b(x31), .O(new_n156_));
  nand4  g103(.a(new_n156_), .b(new_n135_), .c(new_n117_), .d(new_n134_), .O(new_n157_));
  ...
  nand4  g113(.a(new_n166_), .b(new_n144_), .c(new_n143_), .d(new_n153_), .O(new_n167_));
  ...
  nand2  g122(.a(new_n143_), .b(new_n153_), .O(new_n176_));
