...
module FAU ( 
  ...
  inv1   g055(.a(x25), .O(new_n108_));
  inv1   g056(.a(x26), .O(new_n109_));
  inv1   g057(.a(x27), .O(new_n110_));
  nand4  g058(.a(new_n88_), .b(new_n110_), .c(new_n109_), .d(new_n108_), .O(new_n111_));
  nor2   g059(.a(new_n111_), .b(new_n81_), .O(new_n112_));
  aoi21  g060(.a(new_n102_), .b(x27), .c(new_n112_), .O(new_n113_));
  ...
  nand4  g065(.a(new_n117_), .b(new_n88_), .c(new_n76_), .d(new_n63_), .O(new_n118_));
  inv1   g066(.a(x23), .O(new_n119_));
  nor2   g067(.a(x28), .b(x27), .O(new_n120_));
  nand4  g068(.a(new_n120_), .b(new_n93_), .c(new_n109_), .d(new_n119_), .O(new_n121_));
  ...
  oai21  g074(.a(new_n121_), .b(new_n81_), .c(x29), .O(new_n127_));
  nor3   g075(.a(x29), .b(x28), .c(x27), .O(new_n128_));
  nand4  g076(.a(new_n128_), .b(new_n101_), .c(new_n82_), .d(new_n63_), .O(new_n129_));
  ...
  nand4  g082(.a(new_n92_), .b(new_n55_), .c(new_n69_), .d(new_n61_), .O(new_n136_));
  inv1   g083(.a(x24), .O(new_n137_));
  nor2   g084(.a(x26), .b(x25), .O(new_n138_));
  nor2   g085(.a(x30), .b(x29), .O(new_n139_));
  nand4  g086(.a(new_n139_), .b(new_n120_), .c(new_n138_), .d(new_n137_), .O(new_n140_));
  oai21  g087(.a(new_n140_), .b(new_n136_), .c(x31), .O(new_n141_));
  inv1   g088(.a(x22), .O(new_n142_));
  nand4  g089(.a(new_n137_), .b(new_n119_), .c(new_n142_), .d(new_n69_), .O(new_n143_));
  ...
  nand4  g097(.a(new_n150_), .b(new_n117_), .c(new_n144_), .d(new_n63_), .O(new_n151_));
  nand2  g098(.a(new_n151_), .b(new_n141_), .O(new_n152_));
  ...
  nor2   g103(.a(x32), .b(x31), .O(new_n158_));
  nand4  g104(.a(new_n158_), .b(new_n139_), .c(new_n120_), .d(new_n138_), .O(new_n159_));
  oai21  g105(.a(new_n159_), .b(new_n89_), .c(x33), .O(new_n160_));
  nand4  g106(.a(new_n108_), .b(new_n137_), .c(new_n119_), .d(new_n142_), .O(new_n161_));
  inv1   g107(.a(new_n161_), .O(new_n162_));
  inv1   g108(.a(x32), .O(new_n163_));
  inv1   g109(.a(x33), .O(new_n164_));
  nand4  g110(.a(new_n164_), .b(new_n163_), .c(new_n110_), .d(new_n109_), .O(new_n165_));
  inv1   g111(.a(new_n165_), .O(new_n166_));
  nand4  g112(.a(new_n166_), .b(new_n150_), .c(new_n162_), .d(new_n71_), .O(new_n167_));
  nand2  g113(.a(new_n167_), .b(new_n160_), .O(new_n168_));
