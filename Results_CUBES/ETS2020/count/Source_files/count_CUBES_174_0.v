...
module FAU ( 
  ...
  oai21  g069(.a(new_n116_), .b(new_n78_), .c(x29), .O(new_n122_));
  nor3   g070(.a(x29), .b(x28), .c(x27), .O(new_n123_));
  nand4  g071(.a(new_n123_), .b(new_n96_), .c(new_n79_), .d(new_n60_), .O(new_n124_));
  ...
  nand4  g078(.a(new_n88_), .b(new_n58_), .c(new_n130_), .d(new_n57_), .O(new_n131_));
  inv1   g079(.a(x24), .O(new_n132_));
  nor2   g080(.a(x30), .b(x29), .O(new_n133_));
  nand4  g081(.a(new_n133_), .b(new_n115_), .c(new_n104_), .d(new_n132_), .O(new_n134_));
  nor2   g082(.a(new_n134_), .b(new_n131_), .O(new_n135_));
  aoi21  g083(.a(new_n124_), .b(x30), .c(new_n135_), .O(new_n136_));
  inv1   g084(.a(x04), .O(new_n137_));
  aoi21  g085(.a(new_n52_), .b(new_n137_), .c(x18), .O(new_n138_));
  oai21  g086(.a(new_n136_), .b(new_n52_), .c(new_n138_), .O(z11));
  nor2   g087(.a(x29), .b(x28), .O(new_n141_));
  nor2   g088(.a(x31), .b(x30), .O(new_n142_));
  nand4  g089(.a(new_n142_), .b(new_n141_), .c(new_n104_), .d(new_n103_), .O(new_n143_));
  oai21  g090(.a(new_n143_), .b(new_n86_), .c(x32), .O(new_n144_));
  inv1   g091(.a(x22), .O(new_n145_));
  nand4  g092(.a(new_n132_), .b(new_n113_), .c(new_n145_), .d(new_n130_), .O(new_n146_));
  inv1   g093(.a(new_n146_), .O(new_n147_));
  inv1   g094(.a(x28), .O(new_n148_));
  inv1   g095(.a(x29), .O(new_n149_));
  inv1   g096(.a(x30), .O(new_n150_));
  nand4  g097(.a(new_n150_), .b(new_n149_), .c(new_n148_), .d(new_n103_), .O(new_n151_));
  inv1   g098(.a(new_n151_), .O(new_n152_));
  inv1   g099(.a(x25), .O(new_n153_));
  inv1   g100(.a(x31), .O(new_n154_));
  inv1   g101(.a(x32), .O(new_n155_));
  nand4  g102(.a(new_n155_), .b(new_n154_), .c(new_n114_), .d(new_n153_), .O(new_n156_));
  inv1   g103(.a(new_n156_), .O(new_n157_));
  nand4  g104(.a(new_n157_), .b(new_n152_), .c(new_n147_), .d(new_n60_), .O(new_n158_));
  nand2  g105(.a(new_n158_), .b(new_n144_), .O(new_n159_));
