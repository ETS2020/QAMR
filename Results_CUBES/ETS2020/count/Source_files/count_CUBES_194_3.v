...
module FAU ( 
  ...
  nand4  g060(.a(new_n115_), .b(new_n98_), .c(new_n78_), .d(new_n71_), .O(new_n116_));
  nand4  g061(.a(new_n94_), .b(new_n55_), .c(new_n64_), .d(new_n62_), .O(new_n117_));
  ...
  nand4  g083(.a(new_n130_), .b(new_n129_), .c(new_n106_), .d(new_n105_), .O(new_n139_));
  oai21  g084(.a(new_n139_), .b(new_n86_), .c(x32), .O(new_n140_));
  nand2  g085(.a(new_n120_), .b(new_n119_), .O(new_n141_));
  nor2   g086(.a(x32), .b(x31), .O(new_n142_));
  nand2  g087(.a(new_n142_), .b(new_n118_), .O(new_n143_));
  nor2   g088(.a(new_n143_), .b(new_n141_), .O(new_n144_));
  nand2  g089(.a(new_n144_), .b(new_n87_), .O(new_n145_));
  nand2  g090(.a(new_n145_), .b(new_n140_), .O(new_n146_));
  ...
  nand4  g096(.a(new_n152_), .b(new_n130_), .c(new_n129_), .d(new_n106_), .O(new_n153_));
  oai21  g097(.a(new_n153_), .b(new_n96_), .c(x34), .O(new_n154_));
  inv1   g098(.a(x22), .O(new_n155_));
  inv1   g099(.a(x23), .O(new_n156_));
  nand4  g100(.a(new_n105_), .b(new_n83_), .c(new_n156_), .d(new_n155_), .O(new_n157_));
  nor2   g101(.a(new_n157_), .b(new_n65_), .O(new_n158_));
  nand2  g102(.a(new_n129_), .b(new_n106_), .O(new_n159_));
