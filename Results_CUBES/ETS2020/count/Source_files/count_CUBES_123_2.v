...
module FAU ( 
  ...
  nor2   g042(.a(x21), .b(x20), .O(new_n97_));
  nor2   g043(.a(x23), .b(x22), .O(new_n98_));
  nor3   g044(.a(x26), .b(x25), .c(x24), .O(new_n99_));
  nand4  g045(.a(new_n99_), .b(new_n98_), .c(new_n97_), .d(new_n55_), .O(new_n100_));
  nor2   g046(.a(x27), .b(x26), .O(new_n101_));
  nand3  g047(.a(new_n101_), .b(new_n80_), .c(new_n89_), .O(new_n102_));
  ...
  nor2   g053(.a(x25), .b(x24), .O(new_n109_));
  nor2   g054(.a(x28), .b(x27), .O(new_n110_));
  nor2   g055(.a(x26), .b(x23), .O(new_n111_));
  nand3  g056(.a(new_n111_), .b(new_n110_), .c(new_n109_), .O(new_n112_));
  oai21  g057(.a(new_n112_), .b(new_n72_), .c(x29), .O(new_n113_));
  nor3   g058(.a(x29), .b(x28), .c(x27), .O(new_n114_));
  nand4  g059(.a(new_n114_), .b(new_n99_), .c(new_n73_), .d(new_n67_), .O(new_n115_));
  nand2  g060(.a(new_n115_), .b(new_n113_), .O(new_n116_));
  ...
  nand4  g065(.a(new_n98_), .b(new_n55_), .c(new_n64_), .d(new_n63_), .O(new_n121_));
  nor2   g066(.a(x26), .b(x25), .O(new_n122_));
  nor2   g067(.a(x30), .b(x29), .O(new_n123_));
  nand4  g068(.a(new_n123_), .b(new_n110_), .c(new_n122_), .d(new_n78_), .O(new_n124_));
  nor2   g069(.a(new_n124_), .b(new_n121_), .O(new_n125_));
  aoi21  g070(.a(new_n115_), .b(x30), .c(new_n125_), .O(new_n126_));
  ...
  nand4  g076(.a(new_n132_), .b(new_n131_), .c(new_n101_), .d(new_n89_), .O(new_n133_));
  oai21  g077(.a(new_n133_), .b(new_n81_), .c(x32), .O(new_n134_));
  nor2   g078(.a(x32), .b(x31), .O(new_n135_));
  nand4  g079(.a(new_n135_), .b(new_n123_), .c(new_n110_), .d(new_n122_), .O(new_n136_));
  inv1   g080(.a(new_n136_), .O(new_n137_));
  nand2  g081(.a(new_n137_), .b(new_n82_), .O(new_n138_));
  nand2  g082(.a(new_n138_), .b(new_n134_), .O(new_n139_));
  nand2  g083(.a(new_n139_), .b(x16), .O(new_n140_));
  inv1   g084(.a(x02), .O(new_n141_));
  aoi21  g085(.a(new_n58_), .b(new_n141_), .c(x18), .O(new_n142_));
  nand2  g086(.a(new_n142_), .b(new_n140_), .O(z13));
  oai21  g087(.a(new_n136_), .b(new_n81_), .c(x33), .O(new_n144_));
  nor2   g088(.a(x33), .b(x32), .O(new_n145_));
  nand4  g089(.a(new_n145_), .b(new_n132_), .c(new_n131_), .d(new_n101_), .O(new_n146_));
  inv1   g090(.a(new_n146_), .O(new_n147_));
  nand2  g091(.a(new_n147_), .b(new_n91_), .O(new_n148_));
  nand2  g092(.a(new_n148_), .b(new_n144_), .O(new_n149_));
  ...
  nand4  g097(.a(new_n109_), .b(new_n98_), .c(new_n97_), .d(new_n55_), .O(new_n154_));
  oai21  g098(.a(new_n146_), .b(new_n154_), .c(x34), .O(new_n155_));
  nand2  g099(.a(new_n131_), .b(new_n101_), .O(new_n156_));
