// Benchmark "FAU" written by ABC on Tue Jul  7 19:20:59 2020
...
module FAU ( 
  ...
  nand4  g061(.a(new_n114_), .b(new_n85_), .c(new_n76_), .d(new_n63_), .O(new_n115_));
  ...
  nand4  g072(.a(new_n125_), .b(new_n98_), .c(new_n83_), .d(new_n63_), .O(new_n126_));
  ...
  nand4  g078(.a(new_n94_), .b(new_n55_), .c(new_n69_), .d(new_n61_), .O(new_n133_));
  nor2   g079(.a(x26), .b(x25), .O(new_n134_));
  nor2   g080(.a(x30), .b(x29), .O(new_n135_));
  nand4  g081(.a(new_n135_), .b(new_n116_), .c(new_n134_), .d(new_n82_), .O(new_n136_));
  ...
  nor2   g095(.a(x32), .b(x31), .O(new_n150_));
  nand4  g096(.a(new_n150_), .b(new_n135_), .c(new_n116_), .d(new_n134_), .O(new_n151_));
  inv1   g097(.a(new_n151_), .O(new_n152_));
  nand2  g098(.a(new_n152_), .b(new_n87_), .O(new_n153_));
  nand2  g099(.a(new_n153_), .b(new_n149_), .O(new_n154_));
  nand2  g100(.a(new_n154_), .b(x16), .O(new_n155_));
  inv1   g101(.a(x02), .O(new_n156_));
  aoi21  g102(.a(new_n58_), .b(new_n156_), .c(x18), .O(new_n157_));
  nand2  g103(.a(new_n157_), .b(new_n155_), .O(z13));
  oai21  g104(.a(new_n151_), .b(new_n86_), .c(x33), .O(new_n159_));
  inv1   g105(.a(x22), .O(new_n160_));
  inv1   g106(.a(x23), .O(new_n161_));
  nand4  g107(.a(new_n106_), .b(new_n82_), .c(new_n161_), .d(new_n160_), .O(new_n162_));
  nor2   g108(.a(new_n162_), .b(new_n70_), .O(new_n163_));
  nor2   g109(.a(x33), .b(x32), .O(new_n164_));
  nand4  g110(.a(new_n164_), .b(new_n139_), .c(new_n138_), .d(new_n107_), .O(new_n165_));
  inv1   g111(.a(new_n165_), .O(new_n166_));
  nand2  g112(.a(new_n166_), .b(new_n163_), .O(new_n167_));
  nand2  g113(.a(new_n167_), .b(new_n159_), .O(new_n168_));
  ...
  oai21  g118(.a(new_n165_), .b(new_n96_), .c(x34), .O(new_n173_));
  nand2  g119(.a(new_n138_), .b(new_n107_), .O(new_n174_));
  ...
  nand3  g129(.a(new_n183_), .b(new_n175_), .c(new_n163_), .O(new_n184_));
