...
module FAU ( 
  ...
  inv1   g055(.a(x23), .O(new_n111_));
  inv1   g056(.a(x26), .O(new_n112_));
  nor2   g057(.a(x28), .b(x27), .O(new_n113_));
  nand4  g058(.a(new_n113_), .b(new_n91_), .c(new_n112_), .d(new_n111_), .O(new_n114_));
  oai21  g059(.a(new_n114_), .b(new_n101_), .c(x29), .O(new_n115_));
  nor3   g060(.a(x29), .b(x28), .c(x27), .O(new_n116_));
  nand4  g061(.a(new_n116_), .b(new_n94_), .c(new_n79_), .d(new_n71_), .O(new_n117_));
  ...
  nand4  g067(.a(new_n90_), .b(new_n55_), .c(new_n64_), .d(new_n62_), .O(new_n123_));
  ...
  nand3  g082(.a(new_n137_), .b(new_n133_), .c(new_n83_), .O(new_n138_));
  ...
  nand2  g090(.a(new_n125_), .b(new_n113_), .O(new_n146_));
  inv1   g091(.a(x31), .O(new_n147_));
  inv1   g092(.a(x32), .O(new_n148_));
  nand4  g093(.a(new_n148_), .b(new_n147_), .c(new_n112_), .d(new_n102_), .O(new_n149_));
  ...
  nand4  g105(.a(new_n102_), .b(new_n78_), .c(new_n111_), .d(new_n161_), .O(new_n162_));
