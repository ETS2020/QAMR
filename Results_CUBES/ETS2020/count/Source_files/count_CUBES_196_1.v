...
module FAU ( 
  ...
  nand4  g097(.a(new_n152_), .b(new_n136_), .c(new_n117_), .d(new_n135_), .O(new_n153_));
  oai21  g098(.a(new_n153_), .b(new_n85_), .c(x33), .O(new_n154_));
  nor2   g099(.a(x33), .b(x32), .O(new_n155_));
  nand4  g100(.a(new_n155_), .b(new_n142_), .c(new_n141_), .d(new_n108_), .O(new_n156_));
  ...
  oai21  g108(.a(new_n156_), .b(new_n99_), .c(x34), .O(new_n164_));
  nand2  g109(.a(new_n141_), .b(new_n108_), .O(new_n165_));
