...
module FAU ( 
  ...
  nand4  g065(.a(new_n117_), .b(new_n89_), .c(new_n76_), .d(new_n63_), .O(new_n118_));
  nor2   g066(.a(x28), .b(x27), .O(new_n119_));
  nor2   g067(.a(x26), .b(x23), .O(new_n120_));
  nand3  g068(.a(new_n120_), .b(new_n119_), .c(new_n99_), .O(new_n121_));
  nor2   g069(.a(new_n121_), .b(new_n81_), .O(new_n122_));
  ...
  nand4  g076(.a(new_n128_), .b(new_n102_), .c(new_n82_), .d(new_n63_), .O(new_n129_));
  ...
  nand4  g082(.a(new_n98_), .b(new_n55_), .c(new_n69_), .d(new_n61_), .O(new_n135_));
  nor2   g083(.a(x26), .b(x25), .O(new_n136_));
  nor2   g084(.a(x30), .b(x29), .O(new_n137_));
  nand4  g085(.a(new_n137_), .b(new_n119_), .c(new_n136_), .d(new_n87_), .O(new_n138_));
  ...
  nand3  g096(.a(new_n148_), .b(new_n117_), .c(new_n91_), .O(new_n149_));
  ...
  nand4  g102(.a(new_n146_), .b(new_n145_), .c(new_n110_), .d(new_n109_), .O(new_n155_));
  oai21  g103(.a(new_n155_), .b(new_n90_), .c(x32), .O(new_n156_));
  nor2   g104(.a(x32), .b(x31), .O(new_n157_));
  nand4  g105(.a(new_n157_), .b(new_n137_), .c(new_n119_), .d(new_n136_), .O(new_n158_));
  inv1   g106(.a(new_n158_), .O(new_n159_));
  nand2  g107(.a(new_n159_), .b(new_n91_), .O(new_n160_));
  ...
  oai21  g113(.a(new_n158_), .b(new_n90_), .c(x33), .O(new_n166_));
  inv1   g114(.a(x22), .O(new_n167_));
  inv1   g115(.a(x23), .O(new_n168_));
  nand4  g116(.a(new_n109_), .b(new_n87_), .c(new_n168_), .d(new_n167_), .O(new_n169_));
  nor2   g117(.a(new_n169_), .b(new_n70_), .O(new_n170_));
  nor2   g118(.a(x33), .b(x32), .O(new_n171_));
  nand4  g119(.a(new_n171_), .b(new_n146_), .c(new_n145_), .d(new_n110_), .O(new_n172_));
  inv1   g120(.a(new_n172_), .O(new_n173_));
  nand2  g121(.a(new_n173_), .b(new_n170_), .O(new_n174_));
  nand2  g122(.a(new_n174_), .b(new_n166_), .O(new_n175_));
  nand2  g123(.a(new_n175_), .b(x16), .O(new_n176_));
  inv1   g124(.a(x01), .O(new_n177_));
  aoi21  g125(.a(new_n58_), .b(new_n177_), .c(x18), .O(new_n178_));
  nand2  g126(.a(new_n178_), .b(new_n176_), .O(z14));
  oai21  g127(.a(new_n172_), .b(new_n100_), .c(x34), .O(new_n180_));
  nand2  g128(.a(new_n145_), .b(new_n110_), .O(new_n181_));
  inv1   g129(.a(new_n181_), .O(new_n182_));
  inv1   g130(.a(x30), .O(new_n183_));
  inv1   g131(.a(x31), .O(new_n184_));
  nand2  g132(.a(new_n184_), .b(new_n183_), .O(new_n185_));
  inv1   g133(.a(x32), .O(new_n186_));
  inv1   g134(.a(x33), .O(new_n187_));
  inv1   g135(.a(x34), .O(new_n188_));
  nand3  g136(.a(new_n188_), .b(new_n187_), .c(new_n186_), .O(new_n189_));
  nor2   g137(.a(new_n189_), .b(new_n185_), .O(new_n190_));
  nand3  g138(.a(new_n190_), .b(new_n182_), .c(new_n170_), .O(new_n191_));
  nand2  g139(.a(new_n191_), .b(new_n180_), .O(new_n192_));
  nand2  g140(.a(new_n192_), .b(x16), .O(new_n193_));
  inv1   g141(.a(x00), .O(new_n194_));
  aoi21  g142(.a(new_n58_), .b(new_n194_), .c(x18), .O(new_n195_));
  nand2  g143(.a(new_n195_), .b(new_n193_), .O(z15));
  zero   g144(.O(z06));
endmodule
