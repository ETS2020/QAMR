...
module FAU ( 
  ...
  nand2  g082(.a(new_n78_), .b(new_n70_), .O(new_n137_));
  ...
  nand4  g088(.a(new_n142_), .b(new_n109_), .c(new_n138_), .d(new_n63_), .O(new_n143_));
  ...
  nand4  g094(.a(new_n140_), .b(new_n139_), .c(new_n102_), .d(new_n85_), .O(new_n149_));
  oai21  g095(.a(new_n149_), .b(new_n79_), .c(x32), .O(new_n150_));
  nand2  g096(.a(new_n129_), .b(new_n112_), .O(new_n151_));
  ...
  nand4  g107(.a(new_n153_), .b(new_n129_), .c(new_n112_), .d(new_n128_), .O(new_n162_));
  oai21  g108(.a(new_n162_), .b(new_n79_), .c(x33), .O(new_n163_));
  nor2   g109(.a(x33), .b(x32), .O(new_n164_));
  nand4  g110(.a(new_n164_), .b(new_n140_), .c(new_n139_), .d(new_n102_), .O(new_n165_));
  inv1   g111(.a(new_n165_), .O(new_n166_));
  nand2  g112(.a(new_n166_), .b(new_n87_), .O(new_n167_));
  ...
  nand4  g118(.a(new_n111_), .b(new_n94_), .c(new_n93_), .d(new_n55_), .O(new_n173_));
  oai21  g119(.a(new_n165_), .b(new_n173_), .c(x34), .O(new_n174_));
  nand2  g120(.a(new_n139_), .b(new_n102_), .O(new_n175_));
  ...
  nand3  g130(.a(new_n184_), .b(new_n176_), .c(new_n87_), .O(new_n185_));
