...
module FAU ( 
  ...
  nand4  g073(.a(new_n127_), .b(new_n109_), .c(new_n126_), .d(new_n84_), .O(new_n128_));
  ...
  nand3  g084(.a(new_n138_), .b(new_n107_), .c(new_n88_), .O(new_n139_));
  ...
  nand4  g091(.a(new_n146_), .b(new_n127_), .c(new_n109_), .d(new_n126_), .O(new_n147_));
  ...
  nand4  g096(.a(new_n151_), .b(new_n84_), .c(new_n150_), .d(new_n149_), .O(new_n152_));
  nor2   g097(.a(new_n152_), .b(new_n70_), .O(new_n153_));
  nor2   g098(.a(x27), .b(x26), .O(new_n154_));
  nor2   g099(.a(x33), .b(x32), .O(new_n155_));
  nand4  g100(.a(new_n155_), .b(new_n136_), .c(new_n135_), .d(new_n154_), .O(new_n156_));
  inv1   g101(.a(new_n156_), .O(new_n157_));
  nand2  g102(.a(new_n157_), .b(new_n153_), .O(new_n158_));
  nand2  g103(.a(new_n158_), .b(new_n148_), .O(new_n159_));
  ...
  oai21  g108(.a(new_n156_), .b(new_n97_), .c(x34), .O(new_n164_));
  nand2  g109(.a(new_n135_), .b(new_n154_), .O(new_n165_));
  ...
  nand3  g119(.a(new_n174_), .b(new_n166_), .c(new_n153_), .O(new_n175_));
