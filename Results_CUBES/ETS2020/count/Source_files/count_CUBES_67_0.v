...
module FAU ( 
  ...
  nand4  g056(.a(new_n110_), .b(new_n80_), .c(new_n67_), .d(new_n56_), .O(new_n111_));
  ...
  nand4  g067(.a(new_n121_), .b(new_n96_), .c(new_n73_), .d(new_n56_), .O(new_n122_));
  ...
  nand4  g073(.a(new_n95_), .b(new_n54_), .c(new_n65_), .d(new_n53_), .O(new_n129_));
  nor2   g074(.a(x26), .b(x25), .O(new_n130_));
  nor2   g075(.a(x30), .b(x29), .O(new_n131_));
  nand4  g076(.a(new_n131_), .b(new_n113_), .c(new_n130_), .d(new_n78_), .O(new_n132_));
  ...
  nand3  g082(.a(new_n137_), .b(new_n110_), .c(new_n82_), .O(new_n138_));
  ...
  nand4  g088(.a(new_n135_), .b(new_n134_), .c(new_n103_), .d(new_n91_), .O(new_n144_));
  oai21  g089(.a(new_n144_), .b(new_n81_), .c(x32), .O(new_n145_));
  nor2   g090(.a(x32), .b(x31), .O(new_n146_));
  nand4  g091(.a(new_n146_), .b(new_n131_), .c(new_n113_), .d(new_n130_), .O(new_n147_));
  inv1   g092(.a(new_n147_), .O(new_n148_));
  nand2  g093(.a(new_n148_), .b(new_n82_), .O(new_n149_));
  ...
  oai21  g099(.a(new_n147_), .b(new_n81_), .c(x33), .O(new_n155_));
  nor2   g100(.a(x33), .b(x32), .O(new_n156_));
  nand4  g101(.a(new_n156_), .b(new_n135_), .c(new_n134_), .d(new_n103_), .O(new_n157_));
  inv1   g102(.a(new_n157_), .O(new_n158_));
  nand2  g103(.a(new_n158_), .b(new_n93_), .O(new_n159_));
  ...
  nand4  g109(.a(new_n112_), .b(new_n95_), .c(new_n94_), .d(new_n54_), .O(new_n165_));
  oai21  g110(.a(new_n157_), .b(new_n165_), .c(x34), .O(new_n166_));
  nand2  g111(.a(new_n134_), .b(new_n103_), .O(new_n167_));
