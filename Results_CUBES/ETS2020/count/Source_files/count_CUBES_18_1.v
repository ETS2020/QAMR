...
module FAU ( 
  ...
  nand4  g057(.a(new_n111_), .b(new_n82_), .c(new_n73_), .d(new_n72_), .O(new_n112_));
  ...
  nand4  g067(.a(new_n122_), .b(new_n103_), .c(new_n75_), .d(new_n72_), .O(new_n123_));
  nand4  g068(.a(new_n99_), .b(new_n55_), .c(new_n64_), .d(new_n62_), .O(new_n124_));
  nor2   g069(.a(x26), .b(x25), .O(new_n125_));
  nor2   g070(.a(x30), .b(x29), .O(new_n126_));
  nand4  g071(.a(new_n126_), .b(new_n113_), .c(new_n125_), .d(new_n80_), .O(new_n127_));
  ...
  nand3  g082(.a(new_n137_), .b(new_n111_), .c(new_n84_), .O(new_n138_));
  ...
  nor2   g088(.a(x27), .b(x26), .O(new_n144_));
  nand4  g089(.a(new_n135_), .b(new_n134_), .c(new_n144_), .d(new_n91_), .O(new_n145_));
  oai21  g090(.a(new_n145_), .b(new_n83_), .c(x32), .O(new_n146_));
  nor2   g091(.a(x32), .b(x31), .O(new_n147_));
  nand4  g092(.a(new_n147_), .b(new_n126_), .c(new_n113_), .d(new_n125_), .O(new_n148_));
  inv1   g093(.a(new_n148_), .O(new_n149_));
  nand2  g094(.a(new_n149_), .b(new_n84_), .O(new_n150_));
  ...
  oai21  g100(.a(new_n148_), .b(new_n83_), .c(x33), .O(new_n156_));
  nor2   g101(.a(x33), .b(x32), .O(new_n157_));
  nand4  g102(.a(new_n157_), .b(new_n135_), .c(new_n134_), .d(new_n144_), .O(new_n158_));
  inv1   g103(.a(new_n158_), .O(new_n159_));
  nand2  g104(.a(new_n159_), .b(new_n93_), .O(new_n160_));
  nand2  g105(.a(new_n160_), .b(new_n156_), .O(new_n161_));
  nand2  g106(.a(new_n161_), .b(x16), .O(new_n162_));
  inv1   g107(.a(x01), .O(new_n163_));
  aoi21  g108(.a(new_n58_), .b(new_n163_), .c(x18), .O(new_n164_));
  nand2  g109(.a(new_n164_), .b(new_n162_), .O(z14));
  oai21  g110(.a(new_n158_), .b(new_n101_), .c(x34), .O(new_n166_));
  nand2  g111(.a(new_n134_), .b(new_n144_), .O(new_n167_));
