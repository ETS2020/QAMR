...
module FAU ( 
  ...
  nand4  g061(.a(new_n114_), .b(new_n85_), .c(new_n72_), .d(new_n71_), .O(new_n115_));
  ...
  nand4  g081(.a(new_n134_), .b(new_n116_), .c(new_n133_), .d(new_n83_), .O(new_n135_));
  ...
  nor2   g087(.a(x27), .b(x26), .O(new_n142_));
  nor2   g088(.a(x29), .b(x28), .O(new_n143_));
  nor2   g089(.a(x31), .b(x30), .O(new_n144_));
  nand4  g090(.a(new_n144_), .b(new_n143_), .c(new_n142_), .d(new_n94_), .O(new_n145_));
  oai21  g091(.a(new_n145_), .b(new_n86_), .c(x32), .O(new_n146_));
  nor2   g092(.a(x32), .b(x31), .O(new_n147_));
  nand4  g093(.a(new_n147_), .b(new_n134_), .c(new_n116_), .d(new_n133_), .O(new_n148_));
  ...
  nand4  g103(.a(new_n157_), .b(new_n144_), .c(new_n143_), .d(new_n142_), .O(new_n158_));
  ...
  nand2  g112(.a(new_n143_), .b(new_n142_), .O(new_n167_));
