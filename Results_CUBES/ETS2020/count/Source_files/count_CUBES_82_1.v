// Benchmark "FAU" written by ABC on Tue Jul  7 19:18:29 2020
...
module FAU ( 
  ...
  nor2   g067(.a(x23), .b(x22), .O(new_n122_));
  nand4  g068(.a(new_n122_), .b(new_n55_), .c(new_n69_), .d(new_n61_), .O(new_n123_));
  nor2   g069(.a(x26), .b(x25), .O(new_n124_));
  nor2   g070(.a(x30), .b(x29), .O(new_n125_));
  nand4  g071(.a(new_n125_), .b(new_n124_), .c(new_n105_), .d(new_n92_), .O(new_n126_));
  nor2   g072(.a(new_n126_), .b(new_n123_), .O(new_n127_));
  aoi21  g073(.a(new_n116_), .b(x30), .c(new_n127_), .O(new_n128_));
  ...
  oai21  g077(.a(new_n126_), .b(new_n123_), .c(x31), .O(new_n132_));
  nand2  g078(.a(new_n88_), .b(new_n76_), .O(new_n133_));
  ...
  nand4  g084(.a(new_n138_), .b(new_n102_), .c(new_n134_), .d(new_n63_), .O(new_n139_));
  ...
  nand4  g091(.a(new_n136_), .b(new_n135_), .c(new_n145_), .d(new_n93_), .O(new_n146_));
  oai21  g092(.a(new_n146_), .b(new_n89_), .c(x32), .O(new_n147_));
  nor2   g093(.a(x32), .b(x31), .O(new_n148_));
  nand2  g094(.a(new_n148_), .b(new_n105_), .O(new_n149_));
  inv1   g095(.a(new_n149_), .O(new_n150_));
  nand2  g096(.a(new_n125_), .b(new_n124_), .O(new_n151_));
  inv1   g097(.a(new_n151_), .O(new_n152_));
  nand4  g098(.a(new_n152_), .b(new_n150_), .c(new_n134_), .d(new_n63_), .O(new_n153_));
  nand2  g099(.a(new_n153_), .b(new_n147_), .O(new_n154_));
  ...
  nand4  g104(.a(new_n148_), .b(new_n125_), .c(new_n124_), .d(new_n105_), .O(new_n159_));
  oai21  g105(.a(new_n159_), .b(new_n89_), .c(x33), .O(new_n160_));
  nor2   g106(.a(x33), .b(x32), .O(new_n161_));
  nand4  g107(.a(new_n161_), .b(new_n136_), .c(new_n135_), .d(new_n145_), .O(new_n162_));
  ...
  nand4  g116(.a(new_n104_), .b(new_n122_), .c(new_n170_), .d(new_n55_), .O(new_n171_));
  oai21  g117(.a(new_n162_), .b(new_n171_), .c(x34), .O(new_n172_));
  nand2  g118(.a(new_n135_), .b(new_n145_), .O(new_n173_));
  ...
  nand3  g128(.a(new_n182_), .b(new_n174_), .c(new_n95_), .O(new_n183_));
