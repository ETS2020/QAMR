// Benchmark "FAU" written by ABC on Tue Jul  7 19:17:44 2020
...
module FAU ( 
  ...
  nand4  g038(.a(new_n91_), .b(new_n77_), .c(new_n90_), .d(new_n89_), .O(new_n92_));
  inv1   g039(.a(new_n92_), .O(new_n93_));
  aoi22  g040(.a(new_n93_), .b(new_n88_), .c(new_n80_), .d(x25), .O(new_n94_));
  ...
  oai21  g044(.a(new_n92_), .b(new_n87_), .c(x26), .O(new_n98_));
  nor2   g045(.a(x23), .b(x22), .O(new_n99_));
  nor3   g046(.a(x26), .b(x25), .c(x24), .O(new_n100_));
  nand3  g047(.a(new_n100_), .b(new_n88_), .c(new_n99_), .O(new_n101_));
  ...
  nand3  g054(.a(new_n107_), .b(new_n79_), .c(new_n91_), .O(new_n108_));
  ...
  nand4  g065(.a(new_n118_), .b(new_n117_), .c(new_n116_), .d(new_n90_), .O(new_n119_));
  nor2   g066(.a(new_n119_), .b(new_n71_), .O(new_n120_));
  ...
  oai21  g071(.a(new_n119_), .b(new_n71_), .c(x29), .O(new_n125_));
  nor3   g072(.a(x29), .b(x28), .c(x27), .O(new_n126_));
  nand4  g073(.a(new_n126_), .b(new_n100_), .c(new_n72_), .d(new_n63_), .O(new_n127_));
  ...
  nand4  g079(.a(new_n99_), .b(new_n55_), .c(new_n86_), .d(new_n61_), .O(new_n133_));
  nor2   g080(.a(x26), .b(x25), .O(new_n134_));
  nor2   g081(.a(x30), .b(x29), .O(new_n135_));
  nand4  g082(.a(new_n135_), .b(new_n118_), .c(new_n134_), .d(new_n77_), .O(new_n136_));
  ...
  nand4  g090(.a(new_n144_), .b(new_n143_), .c(new_n107_), .d(new_n91_), .O(new_n145_));
  oai21  g091(.a(new_n145_), .b(new_n80_), .c(x32), .O(new_n146_));
  nand4  g092(.a(new_n77_), .b(new_n90_), .c(new_n89_), .d(new_n86_), .O(new_n147_));
  ...
  nand4  g102(.a(new_n156_), .b(new_n155_), .c(new_n116_), .d(new_n91_), .O(new_n157_));
  inv1   g103(.a(new_n157_), .O(new_n158_));
  nand4  g104(.a(new_n158_), .b(new_n154_), .c(new_n148_), .d(new_n63_), .O(new_n159_));
  nand2  g105(.a(new_n159_), .b(new_n146_), .O(new_n160_));
  ...
  nand4  g111(.a(new_n165_), .b(new_n135_), .c(new_n118_), .d(new_n134_), .O(new_n166_));
  oai21  g112(.a(new_n166_), .b(new_n80_), .c(x33), .O(new_n167_));
  nand4  g113(.a(new_n155_), .b(new_n152_), .c(new_n151_), .d(new_n150_), .O(new_n168_));
  inv1   g114(.a(new_n168_), .O(new_n169_));
  inv1   g115(.a(x33), .O(new_n170_));
  nand4  g116(.a(new_n170_), .b(new_n156_), .c(new_n149_), .d(new_n116_), .O(new_n171_));
  inv1   g117(.a(new_n171_), .O(new_n172_));
  nand4  g118(.a(new_n172_), .b(new_n169_), .c(new_n93_), .d(new_n88_), .O(new_n173_));
