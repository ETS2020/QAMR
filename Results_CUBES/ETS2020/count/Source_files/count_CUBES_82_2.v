...
module FAU ( 
  ...
  nand4  g067(.a(new_n121_), .b(new_n95_), .c(new_n75_), .d(new_n62_), .O(new_n122_));
  ...
  nand4  g073(.a(new_n91_), .b(new_n55_), .c(new_n65_), .d(new_n64_), .O(new_n128_));
  ...
  oai21  g095(.a(new_n150_), .b(new_n83_), .c(x33), .O(new_n151_));
  inv1   g096(.a(x22), .O(new_n152_));
  inv1   g097(.a(x23), .O(new_n153_));
  nand4  g098(.a(new_n102_), .b(new_n80_), .c(new_n153_), .d(new_n152_), .O(new_n154_));
  nor2   g099(.a(new_n154_), .b(new_n66_), .O(new_n155_));
  nor2   g100(.a(x33), .b(x32), .O(new_n156_));
  nand4  g101(.a(new_n156_), .b(new_n139_), .c(new_n138_), .d(new_n103_), .O(new_n157_));
  ...
  oai21  g109(.a(new_n157_), .b(new_n93_), .c(x34), .O(new_n165_));
  nand2  g110(.a(new_n138_), .b(new_n103_), .O(new_n166_));
