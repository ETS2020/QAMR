...
module FAU ( 
  ...
  nand4  g096(.a(new_n141_), .b(new_n140_), .c(new_n150_), .d(new_n95_), .O(new_n151_));
  oai21  g097(.a(new_n151_), .b(new_n91_), .c(x32), .O(new_n152_));
  nand2  g098(.a(new_n130_), .b(new_n117_), .O(new_n153_));
  ...
  nand4  g109(.a(new_n155_), .b(new_n130_), .c(new_n117_), .d(new_n129_), .O(new_n164_));
  oai21  g110(.a(new_n164_), .b(new_n91_), .c(x33), .O(new_n165_));
  ...
  nand2  g114(.a(new_n168_), .b(new_n97_), .O(new_n169_));
  ...
  oai21  g120(.a(new_n167_), .b(new_n105_), .c(x34), .O(new_n175_));
  ...
  nand3  g131(.a(new_n185_), .b(new_n177_), .c(new_n97_), .O(new_n186_));
