// Benchmark "FAU" written by ABC on Tue Jul  7 19:20:57 2020
...
module FAU ( 
  ...
  aoi21  g020(.a(new_n74_), .b(new_n56_), .c(new_n73_), .O(new_n75_));
  nor2   g021(.a(x24), .b(x23), .O(new_n76_));
  nand4  g022(.a(new_n76_), .b(new_n67_), .c(new_n54_), .d(new_n53_), .O(new_n77_));
  inv1   g023(.a(new_n77_), .O(new_n78_));
  oai21  g024(.a(new_n78_), .b(new_n75_), .c(x16), .O(new_n79_));
  inv1   g025(.a(x10), .O(new_n80_));
  aoi21  g026(.a(new_n59_), .b(new_n80_), .c(x18), .O(new_n81_));
  ...
  nor2   g032(.a(new_n86_), .b(new_n66_), .O(new_n87_));
  ...
  nand4  g041(.a(new_n95_), .b(new_n94_), .c(new_n93_), .d(new_n54_), .O(new_n96_));
  ...
  nand3  g047(.a(new_n67_), .b(new_n54_), .c(new_n53_), .O(new_n102_));
  ...
  nand4  g056(.a(new_n110_), .b(new_n76_), .c(new_n67_), .d(new_n56_), .O(new_n111_));
  ...
  nand4  g067(.a(new_n121_), .b(new_n95_), .c(new_n74_), .d(new_n56_), .O(new_n122_));
  ...
  nand4  g073(.a(new_n94_), .b(new_n54_), .c(new_n65_), .d(new_n53_), .O(new_n128_));
  nor2   g074(.a(x26), .b(x25), .O(new_n129_));
  nor2   g075(.a(x30), .b(x29), .O(new_n130_));
  nand4  g076(.a(new_n130_), .b(new_n113_), .c(new_n129_), .d(new_n73_), .O(new_n131_));
  ...
  aoi21  g080(.a(new_n59_), .b(new_n134_), .c(x18), .O(new_n135_));
  oai21  g081(.a(new_n133_), .b(new_n59_), .c(new_n135_), .O(z11));
  nor2   g082(.a(x29), .b(x28), .O(new_n138_));
  nor2   g083(.a(x31), .b(x30), .O(new_n139_));
  nand4  g084(.a(new_n139_), .b(new_n138_), .c(new_n103_), .d(new_n85_), .O(new_n140_));
  oai21  g085(.a(new_n140_), .b(new_n77_), .c(x32), .O(new_n141_));
  nor2   g086(.a(x32), .b(x31), .O(new_n142_));
  nand4  g087(.a(new_n142_), .b(new_n130_), .c(new_n113_), .d(new_n129_), .O(new_n143_));
  inv1   g088(.a(new_n143_), .O(new_n144_));
  nand2  g089(.a(new_n144_), .b(new_n78_), .O(new_n145_));
  nand2  g090(.a(new_n145_), .b(new_n141_), .O(new_n146_));
  nand2  g091(.a(new_n146_), .b(x16), .O(new_n147_));
  inv1   g092(.a(x02), .O(new_n148_));
  aoi21  g093(.a(new_n59_), .b(new_n148_), .c(x18), .O(new_n149_));
  nand2  g094(.a(new_n149_), .b(new_n147_), .O(z13));
  oai21  g095(.a(new_n143_), .b(new_n77_), .c(x33), .O(new_n151_));
  nor2   g096(.a(x33), .b(x32), .O(new_n152_));
  nand4  g097(.a(new_n152_), .b(new_n139_), .c(new_n138_), .d(new_n103_), .O(new_n153_));
  inv1   g098(.a(new_n153_), .O(new_n154_));
  nand2  g099(.a(new_n154_), .b(new_n87_), .O(new_n155_));
  ...
  nand4  g105(.a(new_n112_), .b(new_n94_), .c(new_n93_), .d(new_n54_), .O(new_n161_));
  oai21  g106(.a(new_n153_), .b(new_n161_), .c(x34), .O(new_n162_));
  nand2  g107(.a(new_n138_), .b(new_n103_), .O(new_n163_));
  ...
  nand3  g117(.a(new_n172_), .b(new_n164_), .c(new_n87_), .O(new_n173_));
