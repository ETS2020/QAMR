...
module FAU ( 
  ...
  nand4  g090(.a(new_n106_), .b(new_n55_), .c(new_n69_), .d(new_n61_), .O(new_n143_));
  nor2   g091(.a(x26), .b(x25), .O(new_n144_));
  nor2   g092(.a(x30), .b(x29), .O(new_n145_));
  nand4  g093(.a(new_n145_), .b(new_n126_), .c(new_n144_), .d(new_n87_), .O(new_n146_));
  oai21  g094(.a(new_n146_), .b(new_n143_), .c(x31), .O(new_n147_));
  ...
  nand3  g099(.a(new_n151_), .b(new_n124_), .c(new_n91_), .O(new_n152_));
  ...
  nand4  g105(.a(new_n149_), .b(new_n148_), .c(new_n117_), .d(new_n98_), .O(new_n158_));
  oai21  g106(.a(new_n158_), .b(new_n90_), .c(x32), .O(new_n159_));
  nor2   g107(.a(x32), .b(x31), .O(new_n160_));
  nand4  g108(.a(new_n160_), .b(new_n145_), .c(new_n126_), .d(new_n144_), .O(new_n161_));
  inv1   g109(.a(new_n161_), .O(new_n162_));
  nand2  g110(.a(new_n162_), .b(new_n91_), .O(new_n163_));
  ...
  oai21  g116(.a(new_n161_), .b(new_n90_), .c(x33), .O(new_n169_));
  nor2   g117(.a(x33), .b(x32), .O(new_n170_));
  nand4  g118(.a(new_n170_), .b(new_n149_), .c(new_n148_), .d(new_n117_), .O(new_n171_));
  inv1   g119(.a(new_n171_), .O(new_n172_));
  nand2  g120(.a(new_n172_), .b(new_n100_), .O(new_n173_));
  ...
  oai21  g126(.a(new_n171_), .b(new_n108_), .c(x34), .O(new_n179_));
  nand2  g127(.a(new_n148_), .b(new_n117_), .O(new_n180_));
  ...
  nand3  g137(.a(new_n189_), .b(new_n181_), .c(new_n100_), .O(new_n190_));
