...
module FAU ( 
  ...
  nand4  g056(.a(new_n110_), .b(new_n81_), .c(new_n72_), .d(new_n56_), .O(new_n111_));
  nor2   g057(.a(x28), .b(x27), .O(new_n112_));
  nor2   g058(.a(x26), .b(x23), .O(new_n113_));
  nand3  g059(.a(new_n113_), .b(new_n112_), .c(new_n91_), .O(new_n114_));
  ...
  nand4  g067(.a(new_n121_), .b(new_n94_), .c(new_n79_), .d(new_n56_), .O(new_n122_));
  ...
  nand4  g073(.a(new_n90_), .b(new_n54_), .c(new_n65_), .d(new_n53_), .O(new_n128_));
  ...
  aoi21  g102(.a(new_n59_), .b(new_n156_), .c(x18), .O(new_n157_));
  ...
  nand4  g107(.a(new_n102_), .b(new_n78_), .c(new_n161_), .d(new_n160_), .O(new_n162_));
  nor2   g108(.a(new_n162_), .b(new_n66_), .O(new_n163_));
  ...
  aoi21  g116(.a(new_n59_), .b(new_n170_), .c(x18), .O(new_n171_));
  nand2  g117(.a(new_n171_), .b(new_n169_), .O(z14));
  oai21  g118(.a(new_n165_), .b(new_n92_), .c(x34), .O(new_n173_));
