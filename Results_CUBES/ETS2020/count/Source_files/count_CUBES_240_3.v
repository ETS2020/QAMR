// Benchmark "FAU" written by ABC on Tue Jul  7 19:21:00 2020
...
module FAU ( 
  ...
  nand4  g068(.a(new_n122_), .b(new_n106_), .c(new_n78_), .d(new_n71_), .O(new_n123_));
  nand4  g069(.a(new_n102_), .b(new_n55_), .c(new_n64_), .d(new_n62_), .O(new_n124_));
