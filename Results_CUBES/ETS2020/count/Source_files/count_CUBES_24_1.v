...
module FAU ( 
  ...
  nand4  g060(.a(new_n113_), .b(new_n88_), .c(new_n76_), .d(new_n63_), .O(new_n114_));
  nor2   g061(.a(x28), .b(x27), .O(new_n115_));
  nor2   g062(.a(x26), .b(x23), .O(new_n116_));
  nand3  g063(.a(new_n116_), .b(new_n115_), .c(new_n102_), .O(new_n117_));
  nor2   g064(.a(new_n117_), .b(new_n81_), .O(new_n118_));
  ...
  nand4  g071(.a(new_n124_), .b(new_n105_), .c(new_n82_), .d(new_n63_), .O(new_n125_));
  ...
  nand4  g077(.a(new_n101_), .b(new_n55_), .c(new_n69_), .d(new_n61_), .O(new_n131_));
  nor2   g078(.a(x26), .b(x25), .O(new_n132_));
  nor2   g079(.a(x30), .b(x29), .O(new_n133_));
  nand4  g080(.a(new_n133_), .b(new_n115_), .c(new_n132_), .d(new_n92_), .O(new_n134_));
  ...
  nand2  g087(.a(new_n88_), .b(new_n76_), .O(new_n141_));
  ...
  nand4  g093(.a(new_n146_), .b(new_n113_), .c(new_n142_), .d(new_n63_), .O(new_n147_));
  nand2  g094(.a(new_n147_), .b(new_n140_), .O(new_n148_));
  ...
  nor2   g099(.a(x27), .b(x26), .O(new_n153_));
  nand4  g100(.a(new_n144_), .b(new_n143_), .c(new_n153_), .d(new_n93_), .O(new_n154_));
  oai21  g101(.a(new_n154_), .b(new_n89_), .c(x32), .O(new_n155_));
  nand2  g102(.a(new_n133_), .b(new_n115_), .O(new_n156_));
  inv1   g103(.a(new_n156_), .O(new_n157_));
  nor2   g104(.a(x32), .b(x31), .O(new_n158_));
  nand2  g105(.a(new_n158_), .b(new_n132_), .O(new_n159_));
  inv1   g106(.a(new_n159_), .O(new_n160_));
  nand4  g107(.a(new_n160_), .b(new_n157_), .c(new_n142_), .d(new_n63_), .O(new_n161_));
  nand2  g108(.a(new_n161_), .b(new_n155_), .O(new_n162_));
  nand2  g109(.a(new_n162_), .b(x16), .O(new_n163_));
  inv1   g110(.a(x02), .O(new_n164_));
  aoi21  g111(.a(new_n58_), .b(new_n164_), .c(x18), .O(new_n165_));
  nand2  g112(.a(new_n165_), .b(new_n163_), .O(z13));
  nand4  g113(.a(new_n158_), .b(new_n133_), .c(new_n115_), .d(new_n132_), .O(new_n167_));
  oai21  g114(.a(new_n167_), .b(new_n89_), .c(x33), .O(new_n168_));
  nor2   g115(.a(x33), .b(x32), .O(new_n169_));
  nand4  g116(.a(new_n169_), .b(new_n144_), .c(new_n143_), .d(new_n153_), .O(new_n170_));
  inv1   g117(.a(new_n170_), .O(new_n171_));
  nand2  g118(.a(new_n171_), .b(new_n95_), .O(new_n172_));
  nand2  g119(.a(new_n172_), .b(new_n168_), .O(new_n173_));
  nand2  g120(.a(new_n173_), .b(x16), .O(new_n174_));
  inv1   g121(.a(x01), .O(new_n175_));
  aoi21  g122(.a(new_n58_), .b(new_n175_), .c(x18), .O(new_n176_));
  nand2  g123(.a(new_n176_), .b(new_n174_), .O(z14));
  oai21  g124(.a(new_n170_), .b(new_n103_), .c(x34), .O(new_n178_));
  nand2  g125(.a(new_n143_), .b(new_n153_), .O(new_n179_));
  inv1   g126(.a(new_n179_), .O(new_n180_));
  inv1   g127(.a(x30), .O(new_n181_));
  inv1   g128(.a(x31), .O(new_n182_));
  nand2  g129(.a(new_n182_), .b(new_n181_), .O(new_n183_));
  inv1   g130(.a(x32), .O(new_n184_));
  inv1   g131(.a(x33), .O(new_n185_));
  inv1   g132(.a(x34), .O(new_n186_));
  nand3  g133(.a(new_n186_), .b(new_n185_), .c(new_n184_), .O(new_n187_));
  nor2   g134(.a(new_n187_), .b(new_n183_), .O(new_n188_));
  nand3  g135(.a(new_n188_), .b(new_n180_), .c(new_n95_), .O(new_n189_));
  nand2  g136(.a(new_n189_), .b(new_n178_), .O(new_n190_));
  nand2  g137(.a(new_n190_), .b(x16), .O(new_n191_));
  inv1   g138(.a(x00), .O(new_n192_));
  aoi21  g139(.a(new_n58_), .b(new_n192_), .c(x18), .O(new_n193_));
  nand2  g140(.a(new_n193_), .b(new_n191_), .O(z15));
  zero   g141(.O(z05));
  zero   g142(.O(z08));
endmodule
