...
module FAU ( 
  ...
  nand3  g083(.a(new_n137_), .b(new_n133_), .c(new_n91_), .O(new_n138_));
  nand2  g084(.a(new_n138_), .b(new_n132_), .O(new_n139_));
  ...
  nand4  g089(.a(new_n135_), .b(new_n134_), .c(new_n102_), .d(new_n101_), .O(new_n144_));
  oai21  g090(.a(new_n144_), .b(new_n90_), .c(x32), .O(new_n145_));
  nand2  g091(.a(new_n125_), .b(new_n112_), .O(new_n146_));
  inv1   g092(.a(x31), .O(new_n147_));
  inv1   g093(.a(x32), .O(new_n148_));
  nand4  g094(.a(new_n148_), .b(new_n147_), .c(new_n111_), .d(new_n101_), .O(new_n149_));
  nor2   g095(.a(new_n149_), .b(new_n146_), .O(new_n150_));
  nand2  g096(.a(new_n150_), .b(new_n91_), .O(new_n151_));
  nand2  g097(.a(new_n151_), .b(new_n145_), .O(new_n152_));
  ...
  nand4  g103(.a(new_n113_), .b(new_n98_), .c(new_n158_), .d(new_n55_), .O(new_n159_));
  nor2   g104(.a(x33), .b(x32), .O(new_n160_));
  nand4  g105(.a(new_n160_), .b(new_n135_), .c(new_n134_), .d(new_n102_), .O(new_n161_));
  oai21  g106(.a(new_n161_), .b(new_n159_), .c(x34), .O(new_n162_));
  inv1   g107(.a(x22), .O(new_n163_));
  nand4  g108(.a(new_n101_), .b(new_n87_), .c(new_n110_), .d(new_n163_), .O(new_n164_));
  nor2   g109(.a(new_n164_), .b(new_n70_), .O(new_n165_));
  nand2  g110(.a(new_n134_), .b(new_n102_), .O(new_n166_));
  inv1   g111(.a(new_n166_), .O(new_n167_));
  inv1   g112(.a(x30), .O(new_n168_));
  nand2  g113(.a(new_n147_), .b(new_n168_), .O(new_n169_));
  inv1   g114(.a(x33), .O(new_n170_));
  inv1   g115(.a(x34), .O(new_n171_));
  nand3  g116(.a(new_n171_), .b(new_n170_), .c(new_n148_), .O(new_n172_));
  nor2   g117(.a(new_n172_), .b(new_n169_), .O(new_n173_));
  nand3  g118(.a(new_n173_), .b(new_n167_), .c(new_n165_), .O(new_n174_));
  nand2  g119(.a(new_n174_), .b(new_n162_), .O(new_n175_));
