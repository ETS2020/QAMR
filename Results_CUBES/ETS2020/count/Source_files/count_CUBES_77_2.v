...
module FAU ( 
  ...
  nand4  g087(.a(new_n141_), .b(new_n140_), .c(new_n109_), .d(new_n98_), .O(new_n142_));
  oai21  g088(.a(new_n142_), .b(new_n90_), .c(x32), .O(new_n143_));
  nor2   g089(.a(x32), .b(x31), .O(new_n144_));
  nand4  g090(.a(new_n144_), .b(new_n132_), .c(new_n119_), .d(new_n131_), .O(new_n145_));
  inv1   g091(.a(new_n145_), .O(new_n146_));
  nand2  g092(.a(new_n146_), .b(new_n91_), .O(new_n147_));
  nand2  g093(.a(new_n147_), .b(new_n143_), .O(new_n148_));
  nand2  g094(.a(new_n148_), .b(x16), .O(new_n149_));
  inv1   g095(.a(x02), .O(new_n150_));
  aoi21  g096(.a(new_n58_), .b(new_n150_), .c(x18), .O(new_n151_));
  nand2  g097(.a(new_n151_), .b(new_n149_), .O(z13));
  oai21  g098(.a(new_n145_), .b(new_n90_), .c(x33), .O(new_n153_));
  nor2   g099(.a(x33), .b(x32), .O(new_n154_));
  nand4  g100(.a(new_n154_), .b(new_n141_), .c(new_n140_), .d(new_n109_), .O(new_n155_));
  inv1   g101(.a(new_n155_), .O(new_n156_));
  nand2  g102(.a(new_n156_), .b(new_n100_), .O(new_n157_));
  ...
  nand4  g109(.a(new_n118_), .b(new_n106_), .c(new_n163_), .d(new_n55_), .O(new_n164_));
  oai21  g110(.a(new_n155_), .b(new_n164_), .c(x34), .O(new_n165_));
  nand2  g111(.a(new_n140_), .b(new_n109_), .O(new_n166_));
