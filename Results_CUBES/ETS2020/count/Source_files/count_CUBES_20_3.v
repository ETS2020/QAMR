...
module FAU ( 
  ...
  nand3  g041(.a(new_n95_), .b(new_n94_), .c(new_n66_), .O(new_n96_));
  ...
  nand4  g054(.a(new_n109_), .b(new_n108_), .c(new_n107_), .d(new_n106_), .O(new_n110_));
  oai21  g055(.a(new_n110_), .b(new_n77_), .c(x29), .O(new_n111_));
  nor3   g056(.a(x29), .b(x28), .c(x27), .O(new_n112_));
  nand4  g057(.a(new_n112_), .b(new_n95_), .c(new_n78_), .d(new_n71_), .O(new_n113_));
  ...
  nand4  g063(.a(new_n94_), .b(new_n55_), .c(new_n64_), .d(new_n62_), .O(new_n119_));
  ...
  nor3   g073(.a(x27), .b(x26), .c(x25), .O(new_n129_));
  ...
  nand3  g078(.a(new_n133_), .b(new_n129_), .c(new_n87_), .O(new_n134_));
  nand2  g079(.a(new_n134_), .b(new_n128_), .O(new_n135_));
  ...
  nand4  g084(.a(new_n131_), .b(new_n130_), .c(new_n98_), .d(new_n97_), .O(new_n140_));
  oai21  g085(.a(new_n140_), .b(new_n86_), .c(x32), .O(new_n141_));
  nand2  g086(.a(new_n121_), .b(new_n108_), .O(new_n142_));
  inv1   g087(.a(x31), .O(new_n143_));
  inv1   g088(.a(x32), .O(new_n144_));
  nand4  g089(.a(new_n144_), .b(new_n143_), .c(new_n107_), .d(new_n97_), .O(new_n145_));
  nor2   g090(.a(new_n145_), .b(new_n142_), .O(new_n146_));
  nand2  g091(.a(new_n146_), .b(new_n87_), .O(new_n147_));
  nand2  g092(.a(new_n147_), .b(new_n141_), .O(new_n148_));
  ...
  nor2   g097(.a(x21), .b(x20), .O(new_n154_));
  nand4  g098(.a(new_n109_), .b(new_n94_), .c(new_n154_), .d(new_n55_), .O(new_n155_));
  nor2   g099(.a(x33), .b(x32), .O(new_n156_));
  nand4  g100(.a(new_n156_), .b(new_n131_), .c(new_n130_), .d(new_n98_), .O(new_n157_));
  oai21  g101(.a(new_n157_), .b(new_n155_), .c(x34), .O(new_n158_));
  inv1   g102(.a(x22), .O(new_n159_));
  nand4  g103(.a(new_n97_), .b(new_n83_), .c(new_n106_), .d(new_n159_), .O(new_n160_));
  nor2   g104(.a(new_n160_), .b(new_n65_), .O(new_n161_));
  nand2  g105(.a(new_n130_), .b(new_n98_), .O(new_n162_));
  inv1   g106(.a(new_n162_), .O(new_n163_));
  inv1   g107(.a(x30), .O(new_n164_));
  nand2  g108(.a(new_n143_), .b(new_n164_), .O(new_n165_));
  inv1   g109(.a(x33), .O(new_n166_));
  inv1   g110(.a(x34), .O(new_n167_));
  nand3  g111(.a(new_n167_), .b(new_n166_), .c(new_n144_), .O(new_n168_));
