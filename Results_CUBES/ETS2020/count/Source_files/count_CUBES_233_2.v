...
module FAU ( 
  ...
  nand4  g074(.a(new_n128_), .b(new_n103_), .c(new_n75_), .d(new_n72_), .O(new_n129_));
  nand4  g075(.a(new_n99_), .b(new_n55_), .c(new_n64_), .d(new_n62_), .O(new_n130_));
  nor2   g076(.a(x26), .b(x25), .O(new_n131_));
  nor2   g077(.a(x30), .b(x29), .O(new_n132_));
  nand4  g078(.a(new_n132_), .b(new_n119_), .c(new_n131_), .d(new_n80_), .O(new_n133_));
  ...
  nand4  g086(.a(new_n141_), .b(new_n140_), .c(new_n110_), .d(new_n91_), .O(new_n142_));
  oai21  g087(.a(new_n142_), .b(new_n83_), .c(x32), .O(new_n143_));
  nor2   g088(.a(x32), .b(x31), .O(new_n144_));
  nand4  g089(.a(new_n144_), .b(new_n132_), .c(new_n119_), .d(new_n131_), .O(new_n145_));
  ...
  nand4  g099(.a(new_n154_), .b(new_n141_), .c(new_n140_), .d(new_n110_), .O(new_n155_));
  ...
  nand2  g108(.a(new_n140_), .b(new_n110_), .O(new_n164_));
