...
module FAU ( 
  ...
  nand3  g048(.a(new_n102_), .b(new_n81_), .c(new_n91_), .O(new_n103_));
  ...
  nand4  g067(.a(new_n94_), .b(new_n56_), .c(new_n60_), .d(new_n55_), .O(new_n123_));
  nor2   g068(.a(x26), .b(x25), .O(new_n124_));
  nor2   g069(.a(x30), .b(x29), .O(new_n125_));
  nand4  g070(.a(new_n125_), .b(new_n113_), .c(new_n124_), .d(new_n79_), .O(new_n126_));
  ...
  nand4  g077(.a(new_n79_), .b(new_n90_), .c(new_n89_), .d(new_n60_), .O(new_n133_));
  ...
  nand4  g085(.a(new_n140_), .b(new_n109_), .c(new_n134_), .d(new_n67_), .O(new_n141_));
  ...
  nand4  g093(.a(new_n148_), .b(new_n147_), .c(new_n102_), .d(new_n91_), .O(new_n149_));
  ...
  nand4  g099(.a(new_n154_), .b(new_n138_), .c(new_n111_), .d(new_n91_), .O(new_n155_));
  inv1   g100(.a(new_n155_), .O(new_n156_));
  nand4  g101(.a(new_n156_), .b(new_n153_), .c(new_n134_), .d(new_n67_), .O(new_n157_));
  ...
  inv1   g110(.a(new_n92_), .O(new_n166_));
  inv1   g111(.a(x33), .O(new_n167_));
  nand4  g112(.a(new_n167_), .b(new_n154_), .c(new_n151_), .d(new_n111_), .O(new_n168_));
  inv1   g113(.a(new_n168_), .O(new_n169_));
  nand4  g114(.a(new_n169_), .b(new_n140_), .c(new_n166_), .d(new_n62_), .O(new_n170_));
  nand2  g115(.a(new_n170_), .b(new_n165_), .O(new_n171_));
