...
module FAU ( 
  ...
  nand4  g086(.a(new_n140_), .b(new_n139_), .c(new_n112_), .d(new_n93_), .O(new_n141_));
  oai21  g087(.a(new_n141_), .b(new_n89_), .c(x32), .O(new_n142_));
  inv1   g088(.a(new_n89_), .O(new_n143_));
  nor2   g089(.a(x26), .b(x25), .O(new_n144_));
  nor2   g090(.a(x30), .b(x29), .O(new_n145_));
  nor2   g091(.a(x32), .b(x31), .O(new_n146_));
  nand4  g092(.a(new_n146_), .b(new_n145_), .c(new_n121_), .d(new_n144_), .O(new_n147_));
  inv1   g093(.a(new_n147_), .O(new_n148_));
  nand2  g094(.a(new_n148_), .b(new_n143_), .O(new_n149_));
  nand2  g095(.a(new_n149_), .b(new_n142_), .O(new_n150_));
  ...
  oai21  g100(.a(new_n147_), .b(new_n89_), .c(x33), .O(new_n155_));
  nor2   g101(.a(x33), .b(x32), .O(new_n156_));
  nand4  g102(.a(new_n156_), .b(new_n140_), .c(new_n139_), .d(new_n112_), .O(new_n157_));
  inv1   g103(.a(new_n157_), .O(new_n158_));
  nand2  g104(.a(new_n158_), .b(new_n95_), .O(new_n159_));
  ...
  oai21  g110(.a(new_n157_), .b(new_n103_), .c(x34), .O(new_n165_));
  nand2  g111(.a(new_n139_), .b(new_n112_), .O(new_n166_));
  ...
  nand3  g121(.a(new_n175_), .b(new_n167_), .c(new_n95_), .O(new_n176_));
