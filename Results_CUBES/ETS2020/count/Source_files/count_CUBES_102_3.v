...
module FAU ( 
  ...
  nor2   g043(.a(new_n96_), .b(new_n70_), .O(new_n97_));
  ...
  oai21  g048(.a(new_n97_), .b(new_n92_), .c(new_n101_), .O(new_n102_));
  ...
  nand3  g054(.a(new_n107_), .b(new_n84_), .c(new_n95_), .O(new_n108_));
  nor2   g055(.a(new_n108_), .b(new_n76_), .O(new_n109_));
  ...
  nand4  g062(.a(new_n116_), .b(new_n115_), .c(new_n92_), .d(new_n94_), .O(new_n117_));
  oai21  g063(.a(new_n117_), .b(new_n76_), .c(x29), .O(new_n118_));
  nor3   g064(.a(x29), .b(x28), .c(x27), .O(new_n119_));
  nand4  g065(.a(new_n119_), .b(new_n100_), .c(new_n77_), .d(new_n63_), .O(new_n120_));
  ...
  nand4  g071(.a(new_n99_), .b(new_n55_), .c(new_n69_), .d(new_n61_), .O(new_n126_));
  nor2   g072(.a(x26), .b(x25), .O(new_n127_));
  nor2   g073(.a(x30), .b(x29), .O(new_n128_));
  nand4  g074(.a(new_n128_), .b(new_n116_), .c(new_n127_), .d(new_n82_), .O(new_n129_));
  ...
  nand3  g086(.a(new_n140_), .b(new_n136_), .c(new_n86_), .O(new_n141_));
  ...
  nand4  g092(.a(new_n138_), .b(new_n137_), .c(new_n107_), .d(new_n95_), .O(new_n147_));
  oai21  g093(.a(new_n147_), .b(new_n85_), .c(x32), .O(new_n148_));
  nand2  g094(.a(new_n128_), .b(new_n116_), .O(new_n149_));
  inv1   g095(.a(x31), .O(new_n150_));
  inv1   g096(.a(x32), .O(new_n151_));
  nand4  g097(.a(new_n151_), .b(new_n150_), .c(new_n92_), .d(new_n95_), .O(new_n152_));
  nor2   g098(.a(new_n152_), .b(new_n149_), .O(new_n153_));
  nand2  g099(.a(new_n153_), .b(new_n86_), .O(new_n154_));
  ...
  nand4  g105(.a(new_n115_), .b(new_n99_), .c(new_n98_), .d(new_n55_), .O(new_n161_));
  nor2   g106(.a(x33), .b(x32), .O(new_n162_));
  nand4  g107(.a(new_n162_), .b(new_n138_), .c(new_n137_), .d(new_n107_), .O(new_n163_));
  oai21  g108(.a(new_n163_), .b(new_n161_), .c(x34), .O(new_n164_));
  nand2  g109(.a(new_n137_), .b(new_n107_), .O(new_n165_));
  inv1   g110(.a(new_n165_), .O(new_n166_));
  inv1   g111(.a(x30), .O(new_n167_));
  nand2  g112(.a(new_n150_), .b(new_n167_), .O(new_n168_));
  inv1   g113(.a(x33), .O(new_n169_));
  inv1   g114(.a(x34), .O(new_n170_));
  nand3  g115(.a(new_n170_), .b(new_n169_), .c(new_n151_), .O(new_n171_));
  nor2   g116(.a(new_n171_), .b(new_n168_), .O(new_n172_));
  nand3  g117(.a(new_n172_), .b(new_n166_), .c(new_n97_), .O(new_n173_));
  nand2  g118(.a(new_n173_), .b(new_n164_), .O(new_n174_));
