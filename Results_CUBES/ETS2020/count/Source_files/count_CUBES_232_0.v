...
module FAU ( 
  ...
  nand4  g064(.a(new_n117_), .b(new_n103_), .c(new_n116_), .d(new_n93_), .O(new_n118_));
  ...
  nand2  g096(.a(new_n135_), .b(new_n117_), .O(new_n151_));
  inv1   g097(.a(x31), .O(new_n152_));
  inv1   g098(.a(x32), .O(new_n153_));
  nand4  g099(.a(new_n153_), .b(new_n152_), .c(new_n116_), .d(new_n94_), .O(new_n154_));
  nor2   g100(.a(new_n154_), .b(new_n151_), .O(new_n155_));
  nand2  g101(.a(new_n155_), .b(new_n87_), .O(new_n156_));
  ...
  nand4  g108(.a(new_n163_), .b(new_n139_), .c(new_n138_), .d(new_n148_), .O(new_n164_));
  oai21  g109(.a(new_n164_), .b(new_n104_), .c(x34), .O(new_n165_));
  nand2  g110(.a(new_n138_), .b(new_n148_), .O(new_n166_));
