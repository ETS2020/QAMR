...
module FAU ( 
  ...
  nand4  g053(.a(new_n84_), .b(new_n106_), .c(new_n105_), .d(new_n94_), .O(new_n107_));
  ...
  nand4  g082(.a(new_n82_), .b(new_n93_), .c(new_n92_), .d(new_n69_), .O(new_n137_));
  ...
  nand4  g090(.a(new_n144_), .b(new_n113_), .c(new_n138_), .d(new_n63_), .O(new_n145_));
  ...
  nand4  g097(.a(new_n152_), .b(new_n134_), .c(new_n116_), .d(new_n133_), .O(new_n153_));
  oai21  g098(.a(new_n153_), .b(new_n85_), .c(x33), .O(new_n154_));
  inv1   g099(.a(x32), .O(new_n155_));
  inv1   g100(.a(x33), .O(new_n156_));
  nand4  g101(.a(new_n156_), .b(new_n155_), .c(new_n106_), .d(new_n105_), .O(new_n157_));
  inv1   g102(.a(new_n157_), .O(new_n158_));
  nand4  g103(.a(new_n158_), .b(new_n144_), .c(new_n96_), .d(new_n91_), .O(new_n159_));
  nand2  g104(.a(new_n159_), .b(new_n154_), .O(new_n160_));
