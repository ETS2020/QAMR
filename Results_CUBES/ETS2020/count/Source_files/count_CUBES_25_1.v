...
module FAU ( 
  ...
  nand4  g067(.a(new_n121_), .b(new_n100_), .c(new_n72_), .d(new_n63_), .O(new_n122_));
  ...
  nand4  g073(.a(new_n98_), .b(new_n55_), .c(new_n86_), .d(new_n61_), .O(new_n128_));
  nor2   g074(.a(x26), .b(x25), .O(new_n129_));
  nor2   g075(.a(x30), .b(x29), .O(new_n130_));
  nand4  g076(.a(new_n130_), .b(new_n112_), .c(new_n129_), .d(new_n77_), .O(new_n131_));
  ...
  nand3  g087(.a(new_n141_), .b(new_n109_), .c(new_n81_), .O(new_n142_));
  ...
  oai21  g095(.a(new_n150_), .b(new_n80_), .c(x33), .O(new_n151_));
  nor2   g096(.a(x33), .b(x32), .O(new_n152_));
  nand4  g097(.a(new_n152_), .b(new_n139_), .c(new_n138_), .d(new_n102_), .O(new_n153_));
  ...
  nand4  g105(.a(new_n111_), .b(new_n99_), .c(new_n98_), .d(new_n55_), .O(new_n161_));
  oai21  g106(.a(new_n153_), .b(new_n161_), .c(x34), .O(new_n162_));
  nand2  g107(.a(new_n138_), .b(new_n102_), .O(new_n163_));
