...
module FAU ( 
  ...
  nor2   g049(.a(x23), .b(x22), .O(new_n103_));
  nor3   g050(.a(x26), .b(x25), .c(x24), .O(new_n104_));
  nand3  g051(.a(new_n104_), .b(new_n103_), .c(new_n71_), .O(new_n105_));
  nor2   g052(.a(x27), .b(x26), .O(new_n106_));
  nand3  g053(.a(new_n106_), .b(new_n86_), .c(new_n95_), .O(new_n107_));
  nor2   g054(.a(new_n107_), .b(new_n78_), .O(new_n108_));
  aoi21  g055(.a(new_n105_), .b(x27), .c(new_n108_), .O(new_n109_));
  ...
  nand4  g060(.a(new_n113_), .b(new_n86_), .c(new_n77_), .d(new_n63_), .O(new_n114_));
  inv1   g061(.a(x26), .O(new_n115_));
  nor2   g062(.a(x25), .b(x24), .O(new_n116_));
  nor2   g063(.a(x28), .b(x27), .O(new_n117_));
  nand4  g064(.a(new_n117_), .b(new_n116_), .c(new_n115_), .d(new_n94_), .O(new_n118_));
  ...
  nand4  g071(.a(new_n125_), .b(new_n104_), .c(new_n79_), .d(new_n63_), .O(new_n126_));
  nand4  g072(.a(new_n103_), .b(new_n55_), .c(new_n69_), .d(new_n61_), .O(new_n127_));
  nor2   g073(.a(x26), .b(x25), .O(new_n128_));
  nor2   g074(.a(x30), .b(x29), .O(new_n129_));
  nand4  g075(.a(new_n129_), .b(new_n117_), .c(new_n128_), .d(new_n84_), .O(new_n130_));
  ...
  nand3  g086(.a(new_n140_), .b(new_n113_), .c(new_n88_), .O(new_n141_));
  ...
  nand4  g092(.a(new_n138_), .b(new_n137_), .c(new_n106_), .d(new_n95_), .O(new_n147_));
  oai21  g093(.a(new_n147_), .b(new_n87_), .c(x32), .O(new_n148_));
  nand2  g094(.a(new_n129_), .b(new_n117_), .O(new_n149_));
  inv1   g095(.a(x31), .O(new_n150_));
  inv1   g096(.a(x32), .O(new_n151_));
  nand4  g097(.a(new_n151_), .b(new_n150_), .c(new_n115_), .d(new_n95_), .O(new_n152_));
  nor2   g098(.a(new_n152_), .b(new_n149_), .O(new_n153_));
  nand2  g099(.a(new_n153_), .b(new_n88_), .O(new_n154_));
  ...
  nor2   g105(.a(x21), .b(x20), .O(new_n161_));
  nand4  g106(.a(new_n116_), .b(new_n103_), .c(new_n161_), .d(new_n55_), .O(new_n162_));
  nor2   g107(.a(x33), .b(x32), .O(new_n163_));
  nand4  g108(.a(new_n163_), .b(new_n138_), .c(new_n137_), .d(new_n106_), .O(new_n164_));
  oai21  g109(.a(new_n164_), .b(new_n162_), .c(x34), .O(new_n165_));
  nand2  g110(.a(new_n137_), .b(new_n106_), .O(new_n166_));
  inv1   g111(.a(new_n166_), .O(new_n167_));
  inv1   g112(.a(x30), .O(new_n168_));
  nand2  g113(.a(new_n150_), .b(new_n168_), .O(new_n169_));
  inv1   g114(.a(x33), .O(new_n170_));
  inv1   g115(.a(x34), .O(new_n171_));
  nand3  g116(.a(new_n171_), .b(new_n170_), .c(new_n151_), .O(new_n172_));
  nor2   g117(.a(new_n172_), .b(new_n169_), .O(new_n173_));
  nand3  g118(.a(new_n173_), .b(new_n167_), .c(new_n97_), .O(new_n174_));
