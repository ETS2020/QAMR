...
module FAU ( 
  ...
  nand4  g078(.a(new_n98_), .b(new_n55_), .c(new_n86_), .d(new_n61_), .O(new_n133_));
  nor2   g079(.a(x26), .b(x25), .O(new_n134_));
  nor2   g080(.a(x30), .b(x29), .O(new_n135_));
  nand4  g081(.a(new_n135_), .b(new_n117_), .c(new_n134_), .d(new_n77_), .O(new_n136_));
  ...
  nand3  g087(.a(new_n141_), .b(new_n114_), .c(new_n81_), .O(new_n142_));
  ...
  nand4  g093(.a(new_n139_), .b(new_n138_), .c(new_n107_), .d(new_n90_), .O(new_n148_));
  oai21  g094(.a(new_n148_), .b(new_n80_), .c(x32), .O(new_n149_));
  nand2  g095(.a(new_n135_), .b(new_n117_), .O(new_n150_));
  inv1   g096(.a(x31), .O(new_n151_));
  inv1   g097(.a(x32), .O(new_n152_));
  nand4  g098(.a(new_n152_), .b(new_n151_), .c(new_n97_), .d(new_n90_), .O(new_n153_));
  nor2   g099(.a(new_n153_), .b(new_n150_), .O(new_n154_));
  nand2  g100(.a(new_n154_), .b(new_n81_), .O(new_n155_));
  ...
  nand4  g106(.a(new_n116_), .b(new_n99_), .c(new_n98_), .d(new_n55_), .O(new_n162_));
  nor2   g107(.a(x33), .b(x32), .O(new_n163_));
  nand4  g108(.a(new_n163_), .b(new_n139_), .c(new_n138_), .d(new_n107_), .O(new_n164_));
  oai21  g109(.a(new_n164_), .b(new_n162_), .c(x34), .O(new_n165_));
  nand2  g110(.a(new_n138_), .b(new_n107_), .O(new_n166_));
  inv1   g111(.a(new_n166_), .O(new_n167_));
  inv1   g112(.a(x30), .O(new_n168_));
  nand2  g113(.a(new_n151_), .b(new_n168_), .O(new_n169_));
  inv1   g114(.a(x33), .O(new_n170_));
  inv1   g115(.a(x34), .O(new_n171_));
  nand3  g116(.a(new_n171_), .b(new_n170_), .c(new_n152_), .O(new_n172_));
