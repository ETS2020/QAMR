...
module FAU ( 
  ...
  nand4  g074(.a(new_n127_), .b(new_n107_), .c(new_n82_), .d(new_n63_), .O(new_n128_));
  ...
  aoi21  g080(.a(new_n128_), .b(x30), .c(new_n133_), .O(new_n134_));
  ...
  nor2   g084(.a(x27), .b(x26), .O(new_n139_));
  nor2   g085(.a(x29), .b(x28), .O(new_n140_));
  nor2   g086(.a(x31), .b(x30), .O(new_n141_));
  nand4  g087(.a(new_n141_), .b(new_n140_), .c(new_n139_), .d(new_n98_), .O(new_n142_));
  oai21  g088(.a(new_n142_), .b(new_n90_), .c(x32), .O(new_n143_));
  nand4  g089(.a(new_n87_), .b(new_n97_), .c(new_n96_), .d(new_n69_), .O(new_n144_));
  inv1   g090(.a(new_n144_), .O(new_n145_));
  inv1   g091(.a(x27), .O(new_n146_));
  inv1   g092(.a(x28), .O(new_n147_));
  inv1   g093(.a(x29), .O(new_n148_));
  inv1   g094(.a(x30), .O(new_n149_));
  nand4  g095(.a(new_n149_), .b(new_n148_), .c(new_n147_), .d(new_n146_), .O(new_n150_));
  inv1   g096(.a(new_n150_), .O(new_n151_));
  inv1   g097(.a(x31), .O(new_n152_));
  inv1   g098(.a(x32), .O(new_n153_));
  nand4  g099(.a(new_n153_), .b(new_n152_), .c(new_n117_), .d(new_n98_), .O(new_n154_));
  inv1   g100(.a(new_n154_), .O(new_n155_));
  nand4  g101(.a(new_n155_), .b(new_n151_), .c(new_n145_), .d(new_n63_), .O(new_n156_));
  nand2  g102(.a(new_n156_), .b(new_n143_), .O(new_n157_));
  ...
  nor2   g107(.a(x32), .b(x31), .O(new_n162_));
  nand4  g108(.a(new_n162_), .b(new_n131_), .c(new_n119_), .d(new_n130_), .O(new_n163_));
  oai21  g109(.a(new_n163_), .b(new_n90_), .c(x33), .O(new_n164_));
  nand4  g110(.a(new_n152_), .b(new_n149_), .c(new_n148_), .d(new_n147_), .O(new_n165_));
  inv1   g111(.a(new_n165_), .O(new_n166_));
  inv1   g112(.a(x33), .O(new_n167_));
  nand4  g113(.a(new_n167_), .b(new_n153_), .c(new_n146_), .d(new_n117_), .O(new_n168_));
  inv1   g114(.a(new_n168_), .O(new_n169_));
  nand4  g115(.a(new_n169_), .b(new_n166_), .c(new_n100_), .d(new_n71_), .O(new_n170_));
  nand2  g116(.a(new_n170_), .b(new_n164_), .O(new_n171_));
