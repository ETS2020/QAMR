...
module FAU ( 
  ...
  nor3   g056(.a(x25), .b(x24), .c(x23), .O(new_n111_));
  nand4  g057(.a(new_n111_), .b(new_n104_), .c(new_n67_), .d(new_n55_), .O(new_n112_));
  ...
  nand4  g084(.a(new_n140_), .b(new_n131_), .c(new_n113_), .d(new_n130_), .O(new_n141_));
  oai21  g085(.a(new_n141_), .b(new_n81_), .c(x33), .O(new_n142_));
  nor2   g086(.a(x29), .b(x28), .O(new_n143_));
  nor2   g087(.a(x31), .b(x30), .O(new_n144_));
  nor2   g088(.a(x33), .b(x32), .O(new_n145_));
  nand4  g089(.a(new_n145_), .b(new_n144_), .c(new_n143_), .d(new_n104_), .O(new_n146_));
  inv1   g090(.a(new_n146_), .O(new_n147_));
  nand2  g091(.a(new_n147_), .b(new_n87_), .O(new_n148_));
  ...
  oai21  g097(.a(new_n146_), .b(new_n95_), .c(x34), .O(new_n154_));
  nand2  g098(.a(new_n143_), .b(new_n104_), .O(new_n155_));
