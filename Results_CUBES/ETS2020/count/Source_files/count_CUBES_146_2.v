...
module FAU ( 
  ...
  nand4  g075(.a(new_n131_), .b(new_n130_), .c(new_n99_), .d(new_n98_), .O(new_n132_));
  oai21  g076(.a(new_n132_), .b(new_n87_), .c(x32), .O(new_n133_));
  nor2   g077(.a(x32), .b(x31), .O(new_n134_));
  nand4  g078(.a(new_n134_), .b(new_n122_), .c(new_n108_), .d(new_n121_), .O(new_n135_));
  inv1   g079(.a(new_n135_), .O(new_n136_));
  nand2  g080(.a(new_n136_), .b(new_n88_), .O(new_n137_));
  ...
  oai21  g086(.a(new_n135_), .b(new_n87_), .c(x33), .O(new_n143_));
  inv1   g087(.a(x22), .O(new_n144_));
  inv1   g088(.a(x23), .O(new_n145_));
  nand4  g089(.a(new_n98_), .b(new_n84_), .c(new_n145_), .d(new_n144_), .O(new_n146_));
  nor2   g090(.a(new_n146_), .b(new_n70_), .O(new_n147_));
  nor2   g091(.a(x33), .b(x32), .O(new_n148_));
  nand4  g092(.a(new_n148_), .b(new_n131_), .c(new_n130_), .d(new_n99_), .O(new_n149_));
  ...
  nand4  g101(.a(new_n109_), .b(new_n95_), .c(new_n157_), .d(new_n55_), .O(new_n158_));
  oai21  g102(.a(new_n149_), .b(new_n158_), .c(x34), .O(new_n159_));
  nand2  g103(.a(new_n130_), .b(new_n99_), .O(new_n160_));
