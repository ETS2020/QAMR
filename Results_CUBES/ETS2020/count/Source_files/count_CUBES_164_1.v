...
module FAU ( 
  ...
  nand4  g058(.a(new_n111_), .b(new_n85_), .c(new_n72_), .d(new_n56_), .O(new_n112_));
  ...
  aoi21  g066(.a(new_n59_), .b(new_n119_), .c(x18), .O(new_n120_));
  oai21  g067(.a(new_n118_), .b(new_n59_), .c(new_n120_), .O(z09));
  nor3   g068(.a(x29), .b(x28), .c(x27), .O(new_n123_));
  nand4  g069(.a(new_n123_), .b(new_n103_), .c(new_n78_), .d(new_n56_), .O(new_n124_));
  ...
  nand4  g088(.a(new_n142_), .b(new_n111_), .c(new_n136_), .d(new_n56_), .O(new_n143_));
  nand2  g089(.a(new_n143_), .b(new_n134_), .O(new_n144_));
  nand2  g090(.a(new_n144_), .b(x16), .O(new_n145_));
  inv1   g091(.a(x03), .O(new_n146_));
  aoi21  g092(.a(new_n59_), .b(new_n146_), .c(x18), .O(new_n147_));
  nand2  g093(.a(new_n147_), .b(new_n145_), .O(z12));
  nor2   g094(.a(x27), .b(x26), .O(new_n149_));
  ...
  nand4  g100(.a(new_n139_), .b(new_n138_), .c(new_n137_), .d(new_n154_), .O(new_n155_));
  inv1   g101(.a(new_n155_), .O(new_n156_));
  inv1   g102(.a(x32), .O(new_n157_));
  nand4  g103(.a(new_n157_), .b(new_n140_), .c(new_n113_), .d(new_n94_), .O(new_n158_));
  inv1   g104(.a(new_n158_), .O(new_n159_));
  nand4  g105(.a(new_n159_), .b(new_n156_), .c(new_n136_), .d(new_n56_), .O(new_n160_));
  ...
  nand4  g112(.a(new_n166_), .b(new_n127_), .c(new_n115_), .d(new_n126_), .O(new_n167_));
  oai21  g113(.a(new_n167_), .b(new_n86_), .c(x33), .O(new_n168_));
  inv1   g114(.a(x33), .O(new_n169_));
  nand4  g115(.a(new_n169_), .b(new_n157_), .c(new_n154_), .d(new_n113_), .O(new_n170_));
  inv1   g116(.a(new_n170_), .O(new_n171_));
  nand4  g117(.a(new_n171_), .b(new_n142_), .c(new_n96_), .d(new_n67_), .O(new_n172_));
  nand2  g118(.a(new_n172_), .b(new_n168_), .O(new_n173_));
  nand2  g119(.a(new_n173_), .b(x16), .O(new_n174_));
  inv1   g120(.a(x01), .O(new_n175_));
  aoi21  g121(.a(new_n59_), .b(new_n175_), .c(x18), .O(new_n176_));
  nand2  g122(.a(new_n176_), .b(new_n174_), .O(z14));
  zero   g123(.O(z00));
  zero   g124(.O(z08));
  zero   g125(.O(z10));
  zero   g126(.O(z15));
