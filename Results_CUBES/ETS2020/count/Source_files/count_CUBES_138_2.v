...
module FAU ( 
  ...
  nand4  g063(.a(new_n118_), .b(new_n96_), .c(new_n79_), .d(new_n63_), .O(new_n119_));
  nand4  g064(.a(new_n95_), .b(new_n55_), .c(new_n69_), .d(new_n61_), .O(new_n120_));
  nor2   g065(.a(x26), .b(x25), .O(new_n121_));
  nor2   g066(.a(x30), .b(x29), .O(new_n122_));
  nand4  g067(.a(new_n122_), .b(new_n108_), .c(new_n121_), .d(new_n84_), .O(new_n123_));
  nor2   g068(.a(new_n123_), .b(new_n120_), .O(new_n124_));
  aoi21  g069(.a(new_n119_), .b(x30), .c(new_n124_), .O(new_n125_));
  ...
  nand3  g078(.a(new_n133_), .b(new_n106_), .c(new_n88_), .O(new_n134_));
  ...
  nand4  g084(.a(new_n131_), .b(new_n130_), .c(new_n99_), .d(new_n98_), .O(new_n140_));
  oai21  g085(.a(new_n140_), .b(new_n87_), .c(x32), .O(new_n141_));
  nor2   g086(.a(x32), .b(x31), .O(new_n142_));
  nand4  g087(.a(new_n142_), .b(new_n122_), .c(new_n108_), .d(new_n121_), .O(new_n143_));
  inv1   g088(.a(new_n143_), .O(new_n144_));
  nand2  g089(.a(new_n144_), .b(new_n88_), .O(new_n145_));
  nand2  g090(.a(new_n145_), .b(new_n141_), .O(new_n146_));
  nand2  g091(.a(new_n146_), .b(x16), .O(new_n147_));
  inv1   g092(.a(x02), .O(new_n148_));
  aoi21  g093(.a(new_n58_), .b(new_n148_), .c(x18), .O(new_n149_));
  nand2  g094(.a(new_n149_), .b(new_n147_), .O(z13));
  oai21  g095(.a(new_n143_), .b(new_n87_), .c(x33), .O(new_n151_));
  inv1   g096(.a(x22), .O(new_n152_));
  inv1   g097(.a(x23), .O(new_n153_));
  nand4  g098(.a(new_n98_), .b(new_n84_), .c(new_n153_), .d(new_n152_), .O(new_n154_));
  nor2   g099(.a(new_n154_), .b(new_n70_), .O(new_n155_));
  nor2   g100(.a(x33), .b(x32), .O(new_n156_));
  nand4  g101(.a(new_n156_), .b(new_n131_), .c(new_n130_), .d(new_n99_), .O(new_n157_));
  inv1   g102(.a(new_n157_), .O(new_n158_));
  nand2  g103(.a(new_n158_), .b(new_n155_), .O(new_n159_));
  nand2  g104(.a(new_n159_), .b(new_n151_), .O(new_n160_));
  ...
  nand4  g110(.a(new_n109_), .b(new_n95_), .c(new_n165_), .d(new_n55_), .O(new_n166_));
  oai21  g111(.a(new_n157_), .b(new_n166_), .c(x34), .O(new_n167_));
  nand2  g112(.a(new_n130_), .b(new_n99_), .O(new_n168_));
  ...
  nand3  g122(.a(new_n177_), .b(new_n169_), .c(new_n155_), .O(new_n178_));
