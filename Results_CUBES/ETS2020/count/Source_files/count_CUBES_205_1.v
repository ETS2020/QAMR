...
module FAU ( 
  ...
  nand4  g062(.a(new_n117_), .b(new_n98_), .c(new_n78_), .d(new_n56_), .O(new_n118_));
  nand4  g063(.a(new_n94_), .b(new_n54_), .c(new_n65_), .d(new_n53_), .O(new_n119_));
  nor2   g064(.a(x26), .b(x25), .O(new_n120_));
  nor2   g065(.a(x30), .b(x29), .O(new_n121_));
  nand4  g066(.a(new_n121_), .b(new_n108_), .c(new_n120_), .d(new_n83_), .O(new_n122_));
  nor2   g067(.a(new_n122_), .b(new_n119_), .O(new_n123_));
  aoi21  g068(.a(new_n118_), .b(x30), .c(new_n123_), .O(new_n124_));
  inv1   g069(.a(x04), .O(new_n125_));
  aoi21  g070(.a(new_n59_), .b(new_n125_), .c(x18), .O(new_n126_));
  oai21  g071(.a(new_n124_), .b(new_n59_), .c(new_n126_), .O(z11));
  ...
  nand3  g077(.a(new_n132_), .b(new_n106_), .c(new_n87_), .O(new_n133_));
  ...
  nand4  g084(.a(new_n140_), .b(new_n121_), .c(new_n108_), .d(new_n120_), .O(new_n141_));
  oai21  g085(.a(new_n141_), .b(new_n86_), .c(x33), .O(new_n142_));
  inv1   g086(.a(x22), .O(new_n143_));
  inv1   g087(.a(x23), .O(new_n144_));
  inv1   g088(.a(x25), .O(new_n145_));
  nand4  g089(.a(new_n145_), .b(new_n83_), .c(new_n144_), .d(new_n143_), .O(new_n146_));
  nor2   g090(.a(new_n146_), .b(new_n66_), .O(new_n147_));
  nor2   g091(.a(x27), .b(x26), .O(new_n148_));
  nor2   g092(.a(x33), .b(x32), .O(new_n149_));
  nand4  g093(.a(new_n149_), .b(new_n130_), .c(new_n129_), .d(new_n148_), .O(new_n150_));
  inv1   g094(.a(new_n150_), .O(new_n151_));
  nand2  g095(.a(new_n151_), .b(new_n147_), .O(new_n152_));
  nand2  g096(.a(new_n152_), .b(new_n142_), .O(new_n153_));
  nand2  g097(.a(new_n153_), .b(x16), .O(new_n154_));
  inv1   g098(.a(x01), .O(new_n155_));
  aoi21  g099(.a(new_n59_), .b(new_n155_), .c(x18), .O(new_n156_));
  nand2  g100(.a(new_n156_), .b(new_n154_), .O(z14));
  oai21  g101(.a(new_n150_), .b(new_n96_), .c(x34), .O(new_n158_));
  nand2  g102(.a(new_n129_), .b(new_n148_), .O(new_n159_));
  ...
  nand3  g112(.a(new_n168_), .b(new_n160_), .c(new_n147_), .O(new_n169_));
