// Benchmark "FAU" written by ABC on Tue Jul  7 19:19:26 2020
...
module FAU ( 
  ...
  nor3   g019(.a(x23), .b(x22), .c(x21), .O(new_n74_));
  aoi21  g020(.a(new_n74_), .b(new_n67_), .c(new_n73_), .O(new_n75_));
  nor2   g021(.a(x24), .b(x23), .O(new_n76_));
  nand4  g022(.a(new_n76_), .b(new_n66_), .c(new_n55_), .d(new_n63_), .O(new_n77_));
  inv1   g023(.a(new_n77_), .O(new_n78_));
  oai21  g024(.a(new_n78_), .b(new_n75_), .c(x16), .O(new_n79_));
  inv1   g025(.a(x10), .O(new_n80_));
  aoi21  g026(.a(new_n58_), .b(new_n80_), .c(x18), .O(new_n81_));
  nand2  g027(.a(new_n81_), .b(new_n79_), .O(z05));
  inv1   g028(.a(x22), .O(new_n83_));
  inv1   g029(.a(x23), .O(new_n84_));
  inv1   g030(.a(x25), .O(new_n85_));
  nand4  g031(.a(new_n85_), .b(new_n73_), .c(new_n84_), .d(new_n83_), .O(new_n86_));
  nor2   g032(.a(new_n86_), .b(new_n65_), .O(new_n87_));
  ...
  nand4  g048(.a(new_n103_), .b(new_n76_), .c(new_n67_), .d(new_n66_), .O(new_n104_));
  nand3  g049(.a(new_n66_), .b(new_n55_), .c(new_n63_), .O(new_n105_));
  nor2   g050(.a(x25), .b(x24), .O(new_n106_));
  nor2   g051(.a(x28), .b(x27), .O(new_n107_));
  nand4  g052(.a(new_n107_), .b(new_n106_), .c(new_n92_), .d(new_n84_), .O(new_n108_));
  nor2   g053(.a(new_n108_), .b(new_n105_), .O(new_n109_));
  ...
  nand4  g060(.a(new_n115_), .b(new_n95_), .c(new_n74_), .d(new_n67_), .O(new_n116_));
  ...
  nand4  g066(.a(new_n94_), .b(new_n55_), .c(new_n64_), .d(new_n63_), .O(new_n123_));
  nor2   g067(.a(x26), .b(x25), .O(new_n124_));
  nor2   g068(.a(x30), .b(x29), .O(new_n125_));
  nand4  g069(.a(new_n125_), .b(new_n107_), .c(new_n124_), .d(new_n73_), .O(new_n126_));
  oai21  g070(.a(new_n126_), .b(new_n123_), .c(x31), .O(new_n127_));
  nor2   g071(.a(x29), .b(x28), .O(new_n128_));
  nor2   g072(.a(x31), .b(x30), .O(new_n129_));
  nand2  g073(.a(new_n129_), .b(new_n128_), .O(new_n130_));
  inv1   g074(.a(new_n130_), .O(new_n131_));
  nand3  g075(.a(new_n131_), .b(new_n103_), .c(new_n78_), .O(new_n132_));
  nand2  g076(.a(new_n132_), .b(new_n127_), .O(new_n133_));
  ...
  nor2   g081(.a(x27), .b(x26), .O(new_n138_));
  nand4  g082(.a(new_n129_), .b(new_n128_), .c(new_n138_), .d(new_n85_), .O(new_n139_));
  oai21  g083(.a(new_n139_), .b(new_n77_), .c(x32), .O(new_n140_));
  nor2   g084(.a(x32), .b(x31), .O(new_n141_));
  nand4  g085(.a(new_n141_), .b(new_n125_), .c(new_n107_), .d(new_n124_), .O(new_n142_));
  ...
  nand4  g095(.a(new_n151_), .b(new_n129_), .c(new_n128_), .d(new_n138_), .O(new_n152_));
  ...
  aoi21  g101(.a(new_n58_), .b(new_n157_), .c(x18), .O(new_n158_));
  nand2  g102(.a(new_n158_), .b(new_n156_), .O(z14));
  nand4  g103(.a(new_n106_), .b(new_n94_), .c(new_n93_), .d(new_n55_), .O(new_n160_));
  oai21  g104(.a(new_n152_), .b(new_n160_), .c(x34), .O(new_n161_));
  nand2  g105(.a(new_n128_), .b(new_n138_), .O(new_n162_));
