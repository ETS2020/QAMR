...
module FAU ( 
  ...
  nand4  g090(.a(new_n144_), .b(new_n143_), .c(new_n107_), .d(new_n95_), .O(new_n145_));
  oai21  g091(.a(new_n145_), .b(new_n86_), .c(x32), .O(new_n146_));
  nand4  g092(.a(new_n82_), .b(new_n94_), .c(new_n93_), .d(new_n69_), .O(new_n147_));
  ...
  nand4  g102(.a(new_n156_), .b(new_n155_), .c(new_n116_), .d(new_n95_), .O(new_n157_));
  ...
  oai21  g112(.a(new_n166_), .b(new_n86_), .c(x33), .O(new_n167_));
  inv1   g113(.a(new_n96_), .O(new_n168_));
  nand4  g114(.a(new_n155_), .b(new_n152_), .c(new_n151_), .d(new_n150_), .O(new_n169_));
  inv1   g115(.a(new_n169_), .O(new_n170_));
  inv1   g116(.a(x33), .O(new_n171_));
  nand4  g117(.a(new_n171_), .b(new_n156_), .c(new_n149_), .d(new_n116_), .O(new_n172_));
  inv1   g118(.a(new_n172_), .O(new_n173_));
  nand4  g119(.a(new_n173_), .b(new_n170_), .c(new_n168_), .d(new_n71_), .O(new_n174_));
  nand2  g120(.a(new_n174_), .b(new_n167_), .O(new_n175_));
