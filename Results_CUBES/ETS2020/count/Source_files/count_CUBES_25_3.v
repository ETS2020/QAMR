...
module FAU ( 
  ...
  aoi21  g062(.a(new_n59_), .b(new_n114_), .c(x18), .O(new_n115_));
  oai21  g063(.a(new_n113_), .b(new_n59_), .c(new_n115_), .O(z08));
  inv1   g064(.a(x26), .O(new_n118_));
  nor2   g065(.a(x25), .b(x24), .O(new_n119_));
  nor2   g066(.a(x28), .b(x27), .O(new_n120_));
  nand4  g067(.a(new_n120_), .b(new_n119_), .c(new_n118_), .d(new_n93_), .O(new_n121_));
  oai21  g068(.a(new_n121_), .b(new_n77_), .c(x29), .O(new_n122_));
  nor3   g069(.a(x29), .b(x28), .c(x27), .O(new_n123_));
  nand4  g070(.a(new_n123_), .b(new_n103_), .c(new_n78_), .d(new_n56_), .O(new_n124_));
  nand2  g071(.a(new_n124_), .b(new_n122_), .O(new_n125_));
  nand2  g072(.a(new_n125_), .b(x16), .O(new_n126_));
  inv1   g073(.a(x05), .O(new_n127_));
  aoi21  g074(.a(new_n59_), .b(new_n127_), .c(x18), .O(new_n128_));
  nand2  g075(.a(new_n128_), .b(new_n126_), .O(z10));
  nand4  g076(.a(new_n102_), .b(new_n54_), .c(new_n65_), .d(new_n53_), .O(new_n130_));
  nor2   g077(.a(x26), .b(x25), .O(new_n131_));
  nor2   g078(.a(x30), .b(x29), .O(new_n132_));
  nand4  g079(.a(new_n132_), .b(new_n120_), .c(new_n131_), .d(new_n83_), .O(new_n133_));
  ...
  aoi21  g083(.a(new_n59_), .b(new_n136_), .c(x18), .O(new_n137_));
  oai21  g084(.a(new_n135_), .b(new_n59_), .c(new_n137_), .O(z11));
  oai21  g085(.a(new_n133_), .b(new_n130_), .c(x31), .O(new_n139_));
  nand4  g086(.a(new_n83_), .b(new_n93_), .c(new_n92_), .d(new_n65_), .O(new_n140_));
  ...
  nand4  g095(.a(new_n148_), .b(new_n142_), .c(new_n141_), .d(new_n56_), .O(new_n149_));
  nand2  g096(.a(new_n149_), .b(new_n139_), .O(new_n150_));
  ...
  nand4  g103(.a(new_n156_), .b(new_n155_), .c(new_n110_), .d(new_n94_), .O(new_n157_));
  oai21  g104(.a(new_n157_), .b(new_n86_), .c(x32), .O(new_n158_));
  ...
  nand4  g109(.a(new_n162_), .b(new_n146_), .c(new_n118_), .d(new_n94_), .O(new_n163_));
  inv1   g110(.a(new_n163_), .O(new_n164_));
  nand4  g111(.a(new_n164_), .b(new_n161_), .c(new_n141_), .d(new_n56_), .O(new_n165_));
  ...
  nand4  g118(.a(new_n171_), .b(new_n132_), .c(new_n120_), .d(new_n131_), .O(new_n172_));
  oai21  g119(.a(new_n172_), .b(new_n86_), .c(x33), .O(new_n173_));
  inv1   g120(.a(x33), .O(new_n174_));
  nand4  g121(.a(new_n174_), .b(new_n162_), .c(new_n159_), .d(new_n118_), .O(new_n175_));
  inv1   g122(.a(new_n175_), .O(new_n176_));
  nand4  g123(.a(new_n176_), .b(new_n148_), .c(new_n96_), .d(new_n67_), .O(new_n177_));
  nand2  g124(.a(new_n177_), .b(new_n173_), .O(new_n178_));
  nand2  g125(.a(new_n178_), .b(x16), .O(new_n179_));
  inv1   g126(.a(x01), .O(new_n180_));
  aoi21  g127(.a(new_n59_), .b(new_n180_), .c(x18), .O(new_n181_));
