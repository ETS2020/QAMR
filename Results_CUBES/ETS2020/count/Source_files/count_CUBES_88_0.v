...
module FAU ( 
  ...
  nand4  g084(.a(new_n101_), .b(new_n55_), .c(new_n69_), .d(new_n61_), .O(new_n138_));
  nor2   g085(.a(x26), .b(x25), .O(new_n139_));
  nor2   g086(.a(x30), .b(x29), .O(new_n140_));
  nand4  g087(.a(new_n140_), .b(new_n121_), .c(new_n139_), .d(new_n92_), .O(new_n141_));
  oai21  g088(.a(new_n141_), .b(new_n138_), .c(x31), .O(new_n142_));
  nand2  g089(.a(new_n88_), .b(new_n76_), .O(new_n143_));
  ...
  nand4  g095(.a(new_n148_), .b(new_n119_), .c(new_n144_), .d(new_n63_), .O(new_n149_));
  ...
  nand4  g101(.a(new_n146_), .b(new_n145_), .c(new_n112_), .d(new_n93_), .O(new_n155_));
  oai21  g102(.a(new_n155_), .b(new_n89_), .c(x32), .O(new_n156_));
  nand2  g103(.a(new_n140_), .b(new_n121_), .O(new_n157_));
  inv1   g104(.a(new_n157_), .O(new_n158_));
  nor2   g105(.a(x32), .b(x31), .O(new_n159_));
  nand2  g106(.a(new_n159_), .b(new_n139_), .O(new_n160_));
  inv1   g107(.a(new_n160_), .O(new_n161_));
  nand4  g108(.a(new_n161_), .b(new_n158_), .c(new_n144_), .d(new_n63_), .O(new_n162_));
  ...
  nand4  g114(.a(new_n159_), .b(new_n140_), .c(new_n121_), .d(new_n139_), .O(new_n168_));
  oai21  g115(.a(new_n168_), .b(new_n89_), .c(x33), .O(new_n169_));
  nor2   g116(.a(x33), .b(x32), .O(new_n170_));
  nand4  g117(.a(new_n170_), .b(new_n146_), .c(new_n145_), .d(new_n112_), .O(new_n171_));
  inv1   g118(.a(new_n171_), .O(new_n172_));
  nand2  g119(.a(new_n172_), .b(new_n95_), .O(new_n173_));
  nand2  g120(.a(new_n173_), .b(new_n169_), .O(new_n174_));
  nand2  g121(.a(new_n174_), .b(x16), .O(new_n175_));
  inv1   g122(.a(x01), .O(new_n176_));
  aoi21  g123(.a(new_n58_), .b(new_n176_), .c(x18), .O(new_n177_));
  nand2  g124(.a(new_n177_), .b(new_n175_), .O(z14));
  oai21  g125(.a(new_n171_), .b(new_n103_), .c(x34), .O(new_n179_));
  nand2  g126(.a(new_n145_), .b(new_n112_), .O(new_n180_));
