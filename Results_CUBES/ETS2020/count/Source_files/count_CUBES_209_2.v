...
module FAU ( 
  ...
  aoi22  g034(.a(new_n88_), .b(new_n62_), .c(new_n78_), .d(x25), .O(new_n89_));
  ...
  nand3  g041(.a(new_n67_), .b(new_n76_), .c(new_n59_), .O(new_n97_));
  ...
  nand4  g050(.a(new_n105_), .b(new_n77_), .c(new_n67_), .d(new_n55_), .O(new_n106_));
  inv1   g051(.a(x26), .O(new_n107_));
  nor2   g052(.a(x25), .b(x24), .O(new_n108_));
  nor2   g053(.a(x28), .b(x27), .O(new_n109_));
  nand4  g054(.a(new_n109_), .b(new_n108_), .c(new_n107_), .d(new_n85_), .O(new_n110_));
  ...
  oai21  g060(.a(new_n110_), .b(new_n97_), .c(x29), .O(new_n116_));
  nor3   g061(.a(x29), .b(x28), .c(x27), .O(new_n117_));
  nand4  g062(.a(new_n117_), .b(new_n95_), .c(new_n74_), .d(new_n55_), .O(new_n118_));
  ...
  nand4  g068(.a(new_n94_), .b(new_n76_), .c(new_n60_), .d(new_n59_), .O(new_n124_));
  nor2   g069(.a(x26), .b(x25), .O(new_n125_));
  nor2   g070(.a(x30), .b(x29), .O(new_n126_));
  nand4  g071(.a(new_n126_), .b(new_n109_), .c(new_n125_), .d(new_n73_), .O(new_n127_));
  ...
  nand4  g078(.a(new_n73_), .b(new_n85_), .c(new_n84_), .d(new_n60_), .O(new_n134_));
  ...
  nand4  g086(.a(new_n141_), .b(new_n105_), .c(new_n135_), .d(new_n55_), .O(new_n142_));
  nand2  g087(.a(new_n142_), .b(new_n133_), .O(new_n143_));
  nand2  g088(.a(new_n143_), .b(x16), .O(new_n144_));
  inv1   g089(.a(x03), .O(new_n145_));
  aoi21  g090(.a(new_n54_), .b(new_n145_), .c(x18), .O(new_n146_));
  nand2  g091(.a(new_n146_), .b(new_n144_), .O(z12));
  nor2   g092(.a(x29), .b(x28), .O(new_n148_));
  nor2   g093(.a(x31), .b(x30), .O(new_n149_));
  nand4  g094(.a(new_n149_), .b(new_n148_), .c(new_n98_), .d(new_n86_), .O(new_n150_));
  oai21  g095(.a(new_n150_), .b(new_n78_), .c(x32), .O(new_n151_));
  ...
  nand4  g100(.a(new_n155_), .b(new_n139_), .c(new_n107_), .d(new_n86_), .O(new_n156_));
  inv1   g101(.a(new_n156_), .O(new_n157_));
  nand4  g102(.a(new_n157_), .b(new_n154_), .c(new_n135_), .d(new_n55_), .O(new_n158_));
  ...
  nand4  g109(.a(new_n164_), .b(new_n126_), .c(new_n109_), .d(new_n125_), .O(new_n165_));
  oai21  g110(.a(new_n165_), .b(new_n78_), .c(x33), .O(new_n166_));
  inv1   g111(.a(x33), .O(new_n167_));
  nand4  g112(.a(new_n167_), .b(new_n155_), .c(new_n152_), .d(new_n107_), .O(new_n168_));
  inv1   g113(.a(new_n168_), .O(new_n169_));
  nand4  g114(.a(new_n169_), .b(new_n141_), .c(new_n88_), .d(new_n62_), .O(new_n170_));
  nand2  g115(.a(new_n170_), .b(new_n166_), .O(new_n171_));
