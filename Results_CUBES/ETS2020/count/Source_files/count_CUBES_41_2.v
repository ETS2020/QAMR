...
module FAU ( 
  ...
  nand4  g051(.a(new_n106_), .b(new_n81_), .c(new_n73_), .d(new_n62_), .O(new_n107_));
  inv1   g052(.a(x26), .O(new_n108_));
  nor2   g053(.a(x28), .b(x27), .O(new_n109_));
  nand4  g054(.a(new_n109_), .b(new_n95_), .c(new_n108_), .d(new_n84_), .O(new_n110_));
  ...
  nand4  g062(.a(new_n117_), .b(new_n98_), .c(new_n75_), .d(new_n62_), .O(new_n118_));
  ...
  nand4  g068(.a(new_n94_), .b(new_n55_), .c(new_n65_), .d(new_n64_), .O(new_n124_));
  nor2   g069(.a(x26), .b(x25), .O(new_n125_));
  nor2   g070(.a(x30), .b(x29), .O(new_n126_));
  nand4  g071(.a(new_n126_), .b(new_n109_), .c(new_n125_), .d(new_n85_), .O(new_n127_));
  ...
  nand2  g078(.a(new_n81_), .b(new_n73_), .O(new_n134_));
  ...
  nand4  g084(.a(new_n139_), .b(new_n106_), .c(new_n135_), .d(new_n62_), .O(new_n140_));
  ...
  nand4  g091(.a(new_n137_), .b(new_n136_), .c(new_n146_), .d(new_n86_), .O(new_n147_));
  oai21  g092(.a(new_n147_), .b(new_n82_), .c(x32), .O(new_n148_));
  nand2  g093(.a(new_n126_), .b(new_n109_), .O(new_n149_));
  inv1   g094(.a(new_n149_), .O(new_n150_));
  inv1   g095(.a(x31), .O(new_n151_));
  inv1   g096(.a(x32), .O(new_n152_));
  nand4  g097(.a(new_n152_), .b(new_n151_), .c(new_n108_), .d(new_n86_), .O(new_n153_));
  inv1   g098(.a(new_n153_), .O(new_n154_));
  nand4  g099(.a(new_n154_), .b(new_n150_), .c(new_n135_), .d(new_n62_), .O(new_n155_));
  ...
  oai21  g107(.a(new_n163_), .b(new_n96_), .c(x34), .O(new_n164_));
  ...
  nand3  g116(.a(new_n172_), .b(new_n166_), .c(new_n88_), .O(new_n173_));
