// Benchmark "FAU" written by ABC on Tue Jul  7 16:44:23 2020
...
module FAU ( 
  ...
  nor2   g47(.a(x30), .b(new_n56_), .O(new_n103_));
  oai21  g48(.a(new_n103_), .b(new_n102_), .c(new_n59_), .O(new_n104_));
  inv1   g49(.a(x29), .O(new_n105_));
  nand2  g50(.a(new_n105_), .b(new_n58_), .O(new_n106_));
