...
module FAU ( 
  ...
  nor2   g75(.a(x33), .b(new_n57_), .O(new_n130_));
  oai21  g76(.a(new_n130_), .b(new_n129_), .c(new_n60_), .O(new_n131_));
  inv1   g77(.a(x32), .O(new_n132_));
  nand2  g78(.a(new_n132_), .b(new_n59_), .O(new_n133_));
  nand2  g79(.a(new_n133_), .b(new_n131_), .O(z12));
  inv1   g80(.a(x14), .O(new_n135_));
  nor2   g81(.a(x18), .b(new_n135_), .O(new_n136_));
  nor2   g82(.a(x34), .b(new_n57_), .O(new_n137_));
  oai21  g83(.a(new_n137_), .b(new_n136_), .c(new_n60_), .O(new_n138_));
  inv1   g84(.a(x33), .O(new_n139_));
  nand2  g85(.a(new_n139_), .b(new_n59_), .O(new_n140_));
