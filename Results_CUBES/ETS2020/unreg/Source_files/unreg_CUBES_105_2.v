...
module FAU ( 
  ...
  nor2   g54(.a(x30), .b(new_n55_), .O(new_n109_));
  oai21  g55(.a(new_n109_), .b(new_n108_), .c(new_n58_), .O(new_n110_));
  inv1   g56(.a(x29), .O(new_n111_));
  nand2  g57(.a(new_n111_), .b(new_n57_), .O(new_n112_));
  nand2  g58(.a(new_n112_), .b(new_n110_), .O(z09));
  inv1   g59(.a(x09), .O(new_n114_));
  nor2   g60(.a(x18), .b(new_n114_), .O(new_n115_));
  nor2   g61(.a(x31), .b(new_n55_), .O(new_n116_));
  oai21  g62(.a(new_n116_), .b(new_n115_), .c(new_n58_), .O(new_n117_));
  inv1   g63(.a(x30), .O(new_n118_));
  nand2  g64(.a(new_n118_), .b(new_n57_), .O(new_n119_));
  nand2  g65(.a(new_n119_), .b(new_n117_), .O(z10));
  inv1   g66(.a(x08), .O(new_n121_));
  nor2   g67(.a(x18), .b(new_n121_), .O(new_n122_));
  nor2   g68(.a(x24), .b(new_n55_), .O(new_n123_));
  oai21  g69(.a(new_n123_), .b(new_n122_), .c(new_n58_), .O(new_n124_));
  inv1   g70(.a(x31), .O(new_n125_));
  nand2  g71(.a(new_n125_), .b(new_n57_), .O(new_n126_));
  ...
  inv1   g87(.a(x13), .O(new_n142_));
  nor2   g88(.a(x18), .b(new_n142_), .O(new_n143_));
  nor2   g89(.a(x35), .b(new_n55_), .O(new_n144_));
  oai21  g90(.a(new_n144_), .b(new_n143_), .c(new_n58_), .O(new_n145_));
  inv1   g91(.a(x34), .O(new_n146_));
  nand2  g92(.a(new_n146_), .b(new_n57_), .O(new_n147_));
  nand2  g93(.a(new_n147_), .b(new_n145_), .O(z14));
  zero   g94(.O(z06));
  zero   g95(.O(z08));
  zero   g96(.O(z15));
endmodule
