// Benchmark "FAU" written by ABC on Tue Jul  7 16:43:45 2020
...
module FAU ( 
  ...
  nor2   g68(.a(x33), .b(new_n67_), .O(new_n124_));
  ...
  nor2   g75(.a(x34), .b(new_n67_), .O(new_n131_));
  ...
  nor2   g82(.a(x35), .b(new_n67_), .O(new_n138_));
