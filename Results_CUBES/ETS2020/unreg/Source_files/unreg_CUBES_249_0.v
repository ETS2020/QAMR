// Benchmark "FAU" written by ABC on Tue Jul  7 16:45:21 2020
...
module FAU ( 
  ...
  nor2   g40(.a(x33), .b(new_n55_), .O(new_n100_));
  oai21  g41(.a(new_n100_), .b(new_n99_), .c(new_n58_), .O(new_n101_));
  inv1   g42(.a(x32), .O(new_n102_));
  nand2  g43(.a(new_n102_), .b(new_n57_), .O(new_n103_));
