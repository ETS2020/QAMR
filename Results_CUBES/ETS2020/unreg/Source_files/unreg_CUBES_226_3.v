// Benchmark "FAU" written by ABC on Tue Jul  7 16:45:11 2020
...
module FAU ( 
  ...
  nor2   g54(.a(x31), .b(new_n56_), .O(new_n110_));
  oai21  g55(.a(new_n110_), .b(new_n109_), .c(new_n59_), .O(new_n111_));
  inv1   g56(.a(x30), .O(new_n112_));
  nand2  g57(.a(new_n112_), .b(new_n58_), .O(new_n113_));
