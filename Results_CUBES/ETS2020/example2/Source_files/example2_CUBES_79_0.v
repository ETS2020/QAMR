// Benchmark "FAU" written by ABC on Fri Jul 10 18:15:20 2020
...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n197_, new_n198_, new_n203_, new_n204_, new_n208_, new_n209_,
  ...
  nor2   g129(.a(new_n289_), .b(new_n281_), .O(z38));
  nor3   g130(.a(new_n281_), .b(new_n272_), .c(new_n188_), .O(z40));
  nor3   g131(.a(new_n281_), .b(new_n272_), .c(new_n185_), .O(z41));
  nor3   g132(.a(new_n281_), .b(new_n272_), .c(new_n182_), .O(z42));
  nor3   g133(.a(new_n281_), .b(new_n272_), .c(new_n170_), .O(z46));
  inv1   g134(.a(x07), .O(new_n299_));
  nand2  g135(.a(x52), .b(x15), .O(new_n300_));
  oai21  g136(.a(x52), .b(new_n299_), .c(new_n300_), .O(new_n301_));
  nor2   g137(.a(x79), .b(x77), .O(new_n302_));
  nand2  g138(.a(new_n302_), .b(new_n223_), .O(new_n303_));
  inv1   g139(.a(new_n303_), .O(new_n304_));
  nand2  g140(.a(new_n304_), .b(new_n301_), .O(new_n305_));
  nor2   g141(.a(x75), .b(x67), .O(new_n306_));
  inv1   g142(.a(new_n211_), .O(new_n307_));
  nand2  g143(.a(new_n307_), .b(x79), .O(new_n308_));
  nor2   g144(.a(new_n308_), .b(new_n306_), .O(new_n309_));
  nand2  g145(.a(new_n309_), .b(new_n213_), .O(new_n310_));
  aoi21  g146(.a(new_n310_), .b(new_n305_), .c(x01), .O(z47));
  inv1   g147(.a(x08), .O(new_n312_));
  nand2  g148(.a(x52), .b(x16), .O(new_n313_));
  oai21  g149(.a(x52), .b(new_n312_), .c(new_n313_), .O(new_n314_));
  nand2  g150(.a(new_n314_), .b(new_n304_), .O(new_n315_));
  inv1   g151(.a(new_n213_), .O(new_n316_));
  nor2   g152(.a(new_n308_), .b(new_n316_), .O(new_n317_));
  ...
  nand2  g158(.a(new_n322_), .b(new_n304_), .O(new_n323_));
  ...
  nand2  g164(.a(new_n328_), .b(new_n304_), .O(new_n329_));
  ...
  nand2  g170(.a(new_n334_), .b(new_n304_), .O(new_n335_));
  nand2  g171(.a(new_n317_), .b(x71), .O(new_n336_));
  aoi21  g172(.a(new_n336_), .b(new_n335_), .c(x01), .O(z51));
  inv1   g173(.a(x13), .O(new_n339_));
  nand2  g174(.a(x52), .b(x21), .O(new_n340_));
  oai21  g175(.a(x52), .b(new_n339_), .c(new_n340_), .O(new_n341_));
  nand2  g176(.a(new_n341_), .b(new_n304_), .O(new_n342_));
  nand2  g177(.a(new_n317_), .b(x73), .O(new_n343_));
  aoi21  g178(.a(new_n343_), .b(new_n342_), .c(x01), .O(z53));
  nand2  g179(.a(x52), .b(x22), .O(new_n345_));
  nand2  g180(.a(new_n271_), .b(x14), .O(new_n346_));
  inv1   g181(.a(new_n210_), .O(new_n347_));
  nand4  g182(.a(new_n347_), .b(new_n154_), .c(x04), .d(new_n153_), .O(new_n348_));
  aoi21  g183(.a(new_n346_), .b(new_n345_), .c(new_n348_), .O(z54));
  inv1   g184(.a(x82), .O(new_n350_));
  nand3  g185(.a(new_n258_), .b(x84), .c(new_n350_), .O(new_n351_));
  inv1   g186(.a(x80), .O(new_n352_));
  nand4  g187(.a(new_n233_), .b(new_n161_), .c(new_n352_), .d(x79), .O(new_n353_));
  nor2   g188(.a(new_n353_), .b(new_n351_), .O(z55));
  nand2  g189(.a(new_n231_), .b(x76), .O(new_n355_));
  xnor2a g190(.a(x84), .b(x81), .O(new_n356_));
  aoi21  g191(.a(new_n211_), .b(new_n210_), .c(new_n356_), .O(new_n357_));
  ...
  nand3  g195(.a(new_n160_), .b(new_n159_), .c(new_n153_), .O(new_n361_));
  nand3  g196(.a(new_n361_), .b(new_n360_), .c(new_n229_), .O(z56));
  inv1   g197(.a(x02), .O(new_n363_));
  nand3  g198(.a(new_n229_), .b(x03), .c(new_n363_), .O(new_n364_));
  inv1   g199(.a(new_n364_), .O(z57));
  nand4  g200(.a(x80), .b(new_n218_), .c(x43), .d(new_n236_), .O(new_n366_));
  oai22  g201(.a(new_n366_), .b(new_n217_), .c(new_n236_), .d(x40), .O(new_n367_));
  nand3  g202(.a(new_n367_), .b(new_n223_), .c(x79), .O(new_n368_));
  nor2   g203(.a(x79), .b(x78), .O(new_n369_));
  nand3  g204(.a(new_n369_), .b(new_n236_), .c(x40), .O(new_n370_));
  nand2  g205(.a(new_n370_), .b(new_n368_), .O(new_n371_));
  nand2  g206(.a(new_n371_), .b(x77), .O(new_n372_));
  oai21  g207(.a(new_n347_), .b(new_n226_), .c(new_n154_), .O(new_n373_));
  aoi21  g208(.a(new_n373_), .b(new_n372_), .c(x01), .O(z58));
  inv1   g209(.a(new_n369_), .O(new_n375_));
  aoi21  g210(.a(new_n222_), .b(new_n375_), .c(new_n152_), .O(new_n376_));
  oai21  g211(.a(new_n219_), .b(new_n217_), .c(new_n236_), .O(new_n377_));
  aoi21  g212(.a(new_n377_), .b(x79), .c(new_n222_), .O(new_n378_));
  oai21  g213(.a(new_n378_), .b(new_n376_), .c(x77), .O(new_n379_));
  nor2   g214(.a(x79), .b(x04), .O(new_n380_));
  inv1   g215(.a(new_n380_), .O(new_n381_));
  aoi21  g216(.a(new_n381_), .b(new_n379_), .c(x01), .O(z59));
  aoi21  g217(.a(new_n357_), .b(x79), .c(new_n380_), .O(new_n383_));
  aoi21  g218(.a(new_n383_), .b(new_n224_), .c(x01), .O(z60));
  nand2  g219(.a(new_n211_), .b(new_n210_), .O(new_n385_));
  aoi22  g220(.a(new_n385_), .b(new_n213_), .c(new_n161_), .d(new_n226_), .O(new_n386_));
  nor2   g221(.a(new_n154_), .b(x01), .O(new_n387_));
  inv1   g222(.a(new_n387_), .O(new_n388_));
  nor3   g223(.a(new_n388_), .b(new_n386_), .c(new_n352_), .O(z61));
  nand3  g224(.a(x84), .b(x81), .c(x79), .O(new_n390_));
  oai21  g225(.a(x79), .b(new_n226_), .c(new_n390_), .O(new_n391_));
  nand2  g226(.a(new_n391_), .b(new_n159_), .O(new_n392_));
  nand2  g227(.a(new_n377_), .b(x79), .O(new_n393_));
  nand3  g228(.a(x81), .b(x79), .c(new_n226_), .O(new_n394_));
  inv1   g229(.a(new_n394_), .O(new_n395_));
  aoi21  g230(.a(new_n393_), .b(x04), .c(new_n395_), .O(new_n396_));
  oai21  g231(.a(new_n396_), .b(new_n159_), .c(new_n392_), .O(new_n397_));
  nand2  g232(.a(new_n397_), .b(x78), .O(new_n398_));
  inv1   g233(.a(new_n390_), .O(new_n399_));
  nand2  g234(.a(new_n399_), .b(new_n307_), .O(new_n400_));
  aoi21  g235(.a(new_n400_), .b(new_n398_), .c(x01), .O(z62));
  nor3   g236(.a(new_n388_), .b(new_n386_), .c(new_n350_), .O(z63));
  nand2  g237(.a(x83), .b(x79), .O(new_n403_));
  or2    g238(.a(new_n403_), .b(new_n386_), .O(new_n404_));
  aoi21  g239(.a(new_n404_), .b(new_n303_), .c(x01), .O(z64));
  nor2   g240(.a(new_n160_), .b(x04), .O(new_n406_));
  nor2   g241(.a(new_n240_), .b(x78), .O(new_n407_));
  oai21  g242(.a(new_n407_), .b(new_n406_), .c(x77), .O(new_n408_));
  nand2  g243(.a(new_n347_), .b(x81), .O(new_n409_));
  nand2  g244(.a(new_n387_), .b(x84), .O(new_n410_));
  aoi21  g245(.a(new_n409_), .b(new_n408_), .c(new_n410_), .O(z65));
  zero   g246(.O(z02));
  zero   g247(.O(z05));
  zero   g248(.O(z16));
  zero   g249(.O(z17));
