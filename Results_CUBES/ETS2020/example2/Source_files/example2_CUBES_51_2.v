// Benchmark "FAU" written by ABC on Fri Jul 10 18:13:25 2020
...
module FAU ( 
  ...
  wire new_n154_, new_n155_, new_n156_, new_n157_, new_n158_, new_n159_,
    ...
    new_n319_, new_n321_, new_n322_, new_n323_, new_n324_, new_n328_,
    new_n329_, new_n336_, new_n337_, new_n338_, new_n339_;
  ...
  nand2  g109(.a(new_n214_), .b(x55), .O(new_n274_));
  nor2   g110(.a(new_n274_), .b(new_n267_), .O(z37));
  nand2  g111(.a(new_n214_), .b(x56), .O(new_n276_));
  nor2   g112(.a(new_n276_), .b(new_n267_), .O(z38));
  nand2  g113(.a(new_n214_), .b(x57), .O(new_n278_));
  nor2   g114(.a(new_n278_), .b(new_n267_), .O(z39));
  nand2  g115(.a(new_n214_), .b(x58), .O(new_n280_));
  nor2   g116(.a(new_n280_), .b(new_n267_), .O(z40));
  nand2  g117(.a(new_n214_), .b(x60), .O(new_n283_));
  nor2   g118(.a(new_n283_), .b(new_n267_), .O(z42));
  nand2  g119(.a(new_n214_), .b(x63), .O(new_n287_));
  nor2   g120(.a(new_n287_), .b(new_n267_), .O(z45));
  inv1   g121(.a(x07), .O(new_n290_));
  nand2  g122(.a(x52), .b(x15), .O(new_n291_));
  oai21  g123(.a(x52), .b(new_n290_), .c(new_n291_), .O(new_n292_));
  nand4  g124(.a(new_n210_), .b(x78), .c(new_n157_), .d(x04), .O(new_n293_));
  inv1   g125(.a(new_n293_), .O(new_n294_));
  nand2  g126(.a(new_n294_), .b(new_n292_), .O(new_n295_));
  ...
  nand2  g134(.a(new_n305_), .b(new_n294_), .O(new_n306_));
  nand4  g135(.a(new_n296_), .b(new_n158_), .c(x79), .d(x71), .O(new_n307_));
  aoi21  g136(.a(new_n307_), .b(new_n306_), .c(x01), .O(z51));
  inv1   g137(.a(x12), .O(new_n309_));
  nand2  g138(.a(x52), .b(x20), .O(new_n310_));
  oai21  g139(.a(x52), .b(new_n309_), .c(new_n310_), .O(new_n311_));
  nand2  g140(.a(new_n311_), .b(new_n294_), .O(new_n312_));
  nand4  g141(.a(new_n296_), .b(new_n158_), .c(x79), .d(x72), .O(new_n313_));
  aoi21  g142(.a(new_n313_), .b(new_n312_), .c(x01), .O(z52));
  inv1   g143(.a(x13), .O(new_n315_));
  nand2  g144(.a(x52), .b(x21), .O(new_n316_));
  oai21  g145(.a(x52), .b(new_n315_), .c(new_n316_), .O(new_n317_));
  nand2  g146(.a(new_n317_), .b(new_n294_), .O(new_n318_));
  nand4  g147(.a(new_n296_), .b(new_n158_), .c(x79), .d(x73), .O(new_n319_));
  aoi21  g148(.a(new_n319_), .b(new_n318_), .c(x01), .O(z53));
  inv1   g149(.a(x14), .O(new_n321_));
  nor2   g150(.a(x52), .b(new_n321_), .O(new_n322_));
  aoi21  g151(.a(x52), .b(x22), .c(new_n322_), .O(new_n323_));
  nand4  g152(.a(new_n155_), .b(new_n210_), .c(x04), .d(new_n160_), .O(new_n324_));
  nor2   g153(.a(new_n324_), .b(new_n323_), .O(z54));
  inv1   g154(.a(x02), .O(new_n328_));
  nand4  g155(.a(x03), .b(new_n328_), .c(new_n160_), .d(x00), .O(new_n329_));
  inv1   g156(.a(new_n329_), .O(z57));
  oai21  g157(.a(new_n158_), .b(new_n155_), .c(new_n296_), .O(new_n336_));
  inv1   g158(.a(x04), .O(new_n337_));
  nand2  g159(.a(new_n211_), .b(new_n337_), .O(new_n338_));
  nand3  g160(.a(x82), .b(x79), .c(new_n160_), .O(new_n339_));
  aoi21  g161(.a(new_n338_), .b(new_n336_), .c(new_n339_), .O(z63));
  zero   g162(.O(z00));
  zero   g163(.O(z01));
  zero   g164(.O(z03));
  zero   g165(.O(z04));
