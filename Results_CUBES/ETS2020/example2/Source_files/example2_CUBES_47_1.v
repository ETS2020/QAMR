...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n194_, new_n195_, new_n197_, new_n198_, new_n202_, new_n203_,
    ...
    new_n271_, new_n272_, new_n274_, new_n277_, new_n280_, new_n287_,
  ...
  nor2   g103(.a(new_n219_), .b(new_n237_), .O(new_n263_));
  inv1   g104(.a(new_n263_), .O(new_n264_));
  nand2  g105(.a(new_n264_), .b(new_n238_), .O(new_n265_));
  nand2  g106(.a(new_n263_), .b(x81), .O(new_n266_));
  aoi21  g107(.a(new_n266_), .b(new_n265_), .c(new_n241_), .O(new_n267_));
  nand2  g108(.a(new_n264_), .b(x81), .O(new_n268_));
  nand2  g109(.a(new_n263_), .b(new_n238_), .O(new_n269_));
  aoi21  g110(.a(new_n269_), .b(new_n268_), .c(new_n239_), .O(new_n270_));
  oai21  g111(.a(new_n270_), .b(new_n267_), .c(new_n262_), .O(new_n271_));
  nand2  g112(.a(new_n234_), .b(x53), .O(new_n272_));
  nor2   g113(.a(new_n272_), .b(new_n271_), .O(z35));
  nand2  g114(.a(new_n234_), .b(x54), .O(new_n274_));
  nor2   g115(.a(new_n274_), .b(new_n271_), .O(z36));
  nand2  g116(.a(new_n234_), .b(x56), .O(new_n277_));
  nor2   g117(.a(new_n277_), .b(new_n271_), .O(z38));
  inv1   g118(.a(new_n234_), .O(new_n280_));
  nor3   g119(.a(new_n271_), .b(new_n280_), .c(new_n194_), .O(z40));
  nor3   g120(.a(new_n271_), .b(new_n280_), .c(new_n191_), .O(z41));
  nor3   g121(.a(new_n271_), .b(new_n280_), .c(new_n185_), .O(z43));
  nor3   g122(.a(new_n271_), .b(new_n280_), .c(new_n182_), .O(z44));
  nor3   g123(.a(new_n271_), .b(new_n280_), .c(new_n179_), .O(z45));
  nand2  g124(.a(new_n234_), .b(x64), .O(new_n287_));
  nor2   g125(.a(new_n287_), .b(new_n271_), .O(z46));
  ...
  inv1   g159(.a(x13), .O(new_n324_));
  nand2  g160(.a(x52), .b(x21), .O(new_n325_));
  oai21  g161(.a(x52), .b(new_n324_), .c(new_n325_), .O(new_n326_));
  nand2  g162(.a(new_n326_), .b(new_n294_), .O(new_n327_));
  nand2  g163(.a(new_n307_), .b(x73), .O(new_n328_));
  aoi21  g164(.a(new_n328_), .b(new_n327_), .c(x01), .O(z53));
  inv1   g165(.a(x14), .O(new_n330_));
  nor2   g166(.a(x52), .b(new_n330_), .O(new_n331_));
  aoi21  g167(.a(x52), .b(x22), .c(new_n331_), .O(new_n332_));
  inv1   g168(.a(new_n167_), .O(new_n333_));
  nand4  g169(.a(new_n333_), .b(new_n154_), .c(x04), .d(new_n153_), .O(new_n334_));
  nor2   g170(.a(new_n334_), .b(new_n332_), .O(z54));
  ...
  oai21  g191(.a(new_n333_), .b(new_n229_), .c(new_n154_), .O(new_n357_));
  aoi21  g192(.a(new_n357_), .b(new_n356_), .c(x01), .O(z58));
  inv1   g193(.a(new_n353_), .O(new_n359_));
  aoi21  g194(.a(new_n225_), .b(new_n359_), .c(new_n152_), .O(new_n360_));
  oai21  g195(.a(new_n222_), .b(new_n220_), .c(new_n237_), .O(new_n361_));
  aoi21  g196(.a(new_n361_), .b(x79), .c(new_n225_), .O(new_n362_));
  ...
  aoi21  g202(.a(new_n367_), .b(new_n227_), .c(x01), .O(z60));
  inv1   g203(.a(new_n170_), .O(new_n369_));
  nand2  g204(.a(new_n168_), .b(new_n167_), .O(new_n370_));
  aoi22  g205(.a(new_n370_), .b(new_n216_), .c(new_n161_), .d(new_n229_), .O(new_n371_));
  nor3   g206(.a(new_n371_), .b(new_n369_), .c(new_n338_), .O(z61));
  nand3  g207(.a(x84), .b(x81), .c(x79), .O(new_n373_));
  oai21  g208(.a(x79), .b(new_n229_), .c(new_n373_), .O(new_n374_));
  nand2  g209(.a(new_n374_), .b(new_n159_), .O(new_n375_));
  nand2  g210(.a(new_n361_), .b(x79), .O(new_n376_));
  nand3  g211(.a(x81), .b(x79), .c(new_n229_), .O(new_n377_));
  ...
  nand2  g217(.a(new_n382_), .b(new_n297_), .O(new_n383_));
  aoi21  g218(.a(new_n383_), .b(new_n381_), .c(x01), .O(z62));
  nor3   g219(.a(new_n371_), .b(new_n369_), .c(new_n336_), .O(z63));
  nand2  g220(.a(x83), .b(x79), .O(new_n386_));
  or2    g221(.a(new_n386_), .b(new_n371_), .O(new_n387_));
  aoi21  g222(.a(new_n387_), .b(new_n293_), .c(x01), .O(z64));
  nor2   g223(.a(new_n160_), .b(x04), .O(new_n389_));
  nor2   g224(.a(new_n238_), .b(x78), .O(new_n390_));
  oai21  g225(.a(new_n390_), .b(new_n389_), .c(x77), .O(new_n391_));
  nand2  g226(.a(new_n333_), .b(x81), .O(new_n392_));
