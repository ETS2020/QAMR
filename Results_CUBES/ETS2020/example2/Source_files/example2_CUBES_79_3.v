...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n305_, new_n309_, new_n315_, new_n316_, new_n317_, new_n318_,
  ...
  nor3   g150(.a(new_n296_), .b(new_n287_), .c(new_n199_), .O(z41));
  nand2  g151(.a(new_n246_), .b(x60), .O(new_n309_));
  nor2   g152(.a(new_n309_), .b(new_n296_), .O(z42));
  ...
  nand2  g201(.a(new_n286_), .b(x14), .O(new_n360_));
  ...
  inv1   g205(.a(new_n273_), .O(new_n364_));
  nor2   g206(.a(x80), .b(new_n154_), .O(new_n365_));
  nand3  g207(.a(new_n365_), .b(new_n246_), .c(new_n165_), .O(new_n366_));
  nor4   g208(.a(new_n366_), .b(new_n364_), .c(new_n363_), .d(x82), .O(z55));
  nand2  g209(.a(new_n244_), .b(x76), .O(new_n368_));
  ...
  aoi21  g217(.a(new_n375_), .b(new_n164_), .c(new_n241_), .O(new_n376_));
  nand2  g218(.a(new_n376_), .b(new_n374_), .O(z56));
  inv1   g219(.a(x02), .O(new_n378_));
  nand3  g220(.a(new_n242_), .b(x03), .c(new_n378_), .O(new_n379_));
  inv1   g221(.a(new_n379_), .O(z57));
  nand4  g222(.a(x80), .b(new_n234_), .c(x43), .d(new_n249_), .O(new_n381_));
  oai22  g223(.a(new_n381_), .b(new_n233_), .c(new_n249_), .d(x40), .O(new_n382_));
  nand3  g224(.a(new_n382_), .b(new_n231_), .c(x79), .O(new_n383_));
  nand3  g225(.a(new_n179_), .b(new_n249_), .c(x40), .O(new_n384_));
  ...
  oai21  g231(.a(new_n235_), .b(new_n233_), .c(new_n249_), .O(new_n390_));
  ...
  aoi21  g238(.a(new_n396_), .b(new_n238_), .c(x01), .O(z60));
  oai21  g239(.a(new_n171_), .b(new_n169_), .c(new_n228_), .O(new_n398_));
  oai21  g240(.a(new_n244_), .b(x04), .c(new_n398_), .O(new_n399_));
  ...
  nor2   g260(.a(new_n253_), .b(x78), .O(new_n420_));
