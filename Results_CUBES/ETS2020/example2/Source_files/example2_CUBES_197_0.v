...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n206_, new_n207_, new_n210_, new_n211_, new_n214_, new_n215_,
    ...
    new_n276_, new_n278_, new_n280_, new_n282_, new_n286_, new_n294_,
  ...
  inv1   g108(.a(new_n162_), .O(new_n266_));
  nor2   g109(.a(new_n222_), .b(new_n242_), .O(new_n267_));
  inv1   g110(.a(new_n267_), .O(new_n268_));
  nand2  g111(.a(new_n268_), .b(new_n243_), .O(new_n269_));
  nand2  g112(.a(new_n267_), .b(x81), .O(new_n270_));
  aoi21  g113(.a(new_n270_), .b(new_n269_), .c(new_n246_), .O(new_n271_));
  nand2  g114(.a(new_n268_), .b(x81), .O(new_n272_));
  nand2  g115(.a(new_n267_), .b(new_n243_), .O(new_n273_));
  aoi21  g116(.a(new_n273_), .b(new_n272_), .c(new_n244_), .O(new_n274_));
  oai21  g117(.a(new_n274_), .b(new_n271_), .c(new_n266_), .O(new_n275_));
  nand2  g118(.a(new_n239_), .b(x52), .O(new_n276_));
  nor2   g119(.a(new_n276_), .b(new_n275_), .O(z34));
  nand2  g120(.a(new_n239_), .b(x53), .O(new_n278_));
  nor2   g121(.a(new_n278_), .b(new_n275_), .O(z35));
  nand2  g122(.a(new_n239_), .b(x54), .O(new_n280_));
  nor2   g123(.a(new_n280_), .b(new_n275_), .O(z36));
  nand2  g124(.a(new_n239_), .b(x55), .O(new_n282_));
  nor2   g125(.a(new_n282_), .b(new_n275_), .O(z37));
  inv1   g126(.a(new_n239_), .O(new_n286_));
  nor3   g127(.a(new_n275_), .b(new_n286_), .c(new_n190_), .O(z40));
  nor3   g128(.a(new_n275_), .b(new_n286_), .c(new_n187_), .O(z41));
  nor3   g129(.a(new_n275_), .b(new_n286_), .c(new_n184_), .O(z42));
  nor3   g130(.a(new_n275_), .b(new_n286_), .c(new_n181_), .O(z43));
  nor3   g131(.a(new_n275_), .b(new_n286_), .c(new_n172_), .O(z46));
  ...
  inv1   g149(.a(new_n219_), .O(new_n311_));
  ...
  inv1   g177(.a(x82), .O(new_n341_));
  nand4  g178(.a(x84), .b(x83), .c(new_n341_), .d(new_n243_), .O(new_n342_));
  inv1   g179(.a(x80), .O(new_n343_));
  nand4  g180(.a(new_n239_), .b(new_n161_), .c(new_n343_), .d(x79), .O(new_n344_));
  nor2   g181(.a(new_n344_), .b(new_n342_), .O(z55));
  nand2  g182(.a(new_n237_), .b(x76), .O(new_n346_));
  xnor2a g183(.a(x84), .b(x81), .O(new_n347_));
  aoi21  g184(.a(new_n217_), .b(new_n216_), .c(new_n347_), .O(new_n348_));
  nand2  g185(.a(new_n348_), .b(new_n153_), .O(new_n349_));
  nand2  g186(.a(new_n349_), .b(new_n346_), .O(new_n350_));
  nand2  g187(.a(new_n350_), .b(x79), .O(new_n351_));
  nand3  g188(.a(new_n160_), .b(new_n159_), .c(new_n153_), .O(new_n352_));
  nand3  g189(.a(new_n352_), .b(new_n351_), .c(new_n235_), .O(z56));
  inv1   g190(.a(x02), .O(new_n354_));
  nand3  g191(.a(new_n235_), .b(x03), .c(new_n354_), .O(new_n355_));
  inv1   g192(.a(new_n355_), .O(z57));
  nand4  g193(.a(x80), .b(new_n224_), .c(x43), .d(new_n242_), .O(new_n357_));
  oai22  g194(.a(new_n357_), .b(new_n223_), .c(new_n242_), .d(x40), .O(new_n358_));
  nand3  g195(.a(new_n358_), .b(new_n229_), .c(x79), .O(new_n359_));
  nor2   g196(.a(x79), .b(x78), .O(new_n360_));
  nand3  g197(.a(new_n360_), .b(new_n242_), .c(x40), .O(new_n361_));
  nand2  g198(.a(new_n361_), .b(new_n359_), .O(new_n362_));
  nand2  g199(.a(new_n362_), .b(x77), .O(new_n363_));
  inv1   g200(.a(new_n216_), .O(new_n364_));
  oai21  g201(.a(new_n364_), .b(new_n232_), .c(new_n154_), .O(new_n365_));
  aoi21  g202(.a(new_n365_), .b(new_n363_), .c(x01), .O(z58));
  inv1   g203(.a(new_n360_), .O(new_n367_));
  ...
  aoi21  g211(.a(new_n348_), .b(x79), .c(new_n372_), .O(new_n375_));
  ...
  nor3   g217(.a(new_n380_), .b(new_n378_), .c(new_n343_), .O(z61));
  ...
  nand2  g228(.a(new_n391_), .b(new_n302_), .O(new_n392_));
  aoi21  g229(.a(new_n392_), .b(new_n390_), .c(x01), .O(z62));
  nor3   g230(.a(new_n380_), .b(new_n378_), .c(new_n341_), .O(z63));
  nand2  g231(.a(x83), .b(x79), .O(new_n395_));
  or2    g232(.a(new_n395_), .b(new_n378_), .O(new_n396_));
  aoi21  g233(.a(new_n396_), .b(new_n298_), .c(x01), .O(z64));
  nor2   g234(.a(new_n160_), .b(x04), .O(new_n398_));
  nor2   g235(.a(new_n243_), .b(x78), .O(new_n399_));
  oai21  g236(.a(new_n399_), .b(new_n398_), .c(x77), .O(new_n400_));
  nand2  g237(.a(new_n364_), .b(x81), .O(new_n401_));
  nand2  g238(.a(new_n379_), .b(x84), .O(new_n402_));
