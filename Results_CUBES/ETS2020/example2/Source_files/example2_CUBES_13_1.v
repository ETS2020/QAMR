// Benchmark "FAU" written by ABC on Fri Jul 10 18:10:42 2020
...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n175_, new_n176_, new_n180_, new_n181_, new_n184_, new_n185_,
    ...
    new_n255_, new_n261_, new_n262_, new_n263_, new_n264_, new_n265_,
    new_n266_, new_n267_, new_n268_, new_n269_, new_n270_, new_n271_,
    new_n273_, new_n275_, new_n277_, new_n282_, new_n285_, new_n287_,
    new_n289_, new_n290_, new_n291_, new_n292_, new_n293_, new_n294_,
    new_n295_, new_n296_, new_n297_, new_n298_, new_n299_, new_n300_,
    new_n302_, new_n303_, new_n304_, new_n305_, new_n306_, new_n307_,
    new_n308_, new_n311_, new_n312_, new_n313_, new_n314_, new_n315_,
    new_n317_, new_n318_, new_n319_, new_n320_, new_n321_, new_n323_,
    new_n324_, new_n325_, new_n326_, new_n327_, new_n332_, new_n333_,
  ...
  nand4  g094(.a(new_n244_), .b(new_n234_), .c(x47), .d(new_n237_), .O(new_n252_));
  inv1   g095(.a(new_n252_), .O(z29));
  nand4  g096(.a(new_n244_), .b(new_n234_), .c(x49), .d(new_n237_), .O(new_n255_));
  inv1   g097(.a(new_n255_), .O(z31));
  inv1   g098(.a(new_n162_), .O(new_n261_));
  nor2   g099(.a(new_n219_), .b(new_n237_), .O(new_n262_));
  inv1   g100(.a(new_n262_), .O(new_n263_));
  nand2  g101(.a(new_n263_), .b(new_n238_), .O(new_n264_));
  nand2  g102(.a(new_n262_), .b(x81), .O(new_n265_));
  aoi21  g103(.a(new_n265_), .b(new_n264_), .c(new_n241_), .O(new_n266_));
  nand2  g104(.a(new_n263_), .b(x81), .O(new_n267_));
  nand2  g105(.a(new_n262_), .b(new_n238_), .O(new_n268_));
  aoi21  g106(.a(new_n268_), .b(new_n267_), .c(new_n239_), .O(new_n269_));
  oai21  g107(.a(new_n269_), .b(new_n266_), .c(new_n261_), .O(new_n270_));
  nand2  g108(.a(new_n234_), .b(x54), .O(new_n271_));
  nor2   g109(.a(new_n271_), .b(new_n270_), .O(z36));
  nand2  g110(.a(new_n234_), .b(x55), .O(new_n273_));
  nor2   g111(.a(new_n273_), .b(new_n270_), .O(z37));
  nand2  g112(.a(new_n234_), .b(x56), .O(new_n275_));
  ...
  nor3   g116(.a(new_n270_), .b(new_n277_), .c(new_n190_), .O(z40));
  nor3   g117(.a(new_n270_), .b(new_n277_), .c(new_n187_), .O(z41));
  nor3   g118(.a(new_n270_), .b(new_n277_), .c(new_n184_), .O(z42));
  nand2  g119(.a(new_n234_), .b(x61), .O(new_n282_));
  nor2   g120(.a(new_n282_), .b(new_n270_), .O(z43));
  nor3   g121(.a(new_n270_), .b(new_n277_), .c(new_n180_), .O(z44));
  nand2  g122(.a(new_n234_), .b(x63), .O(new_n285_));
  nor2   g123(.a(new_n285_), .b(new_n270_), .O(z45));
  nand2  g124(.a(new_n234_), .b(x64), .O(new_n287_));
  nor2   g125(.a(new_n287_), .b(new_n270_), .O(z46));
  ...
  inv1   g147(.a(x10), .O(new_n311_));
  nand2  g148(.a(x52), .b(x18), .O(new_n312_));
  oai21  g149(.a(x52), .b(new_n311_), .c(new_n312_), .O(new_n313_));
  nand2  g150(.a(new_n313_), .b(new_n294_), .O(new_n314_));
  nand2  g151(.a(new_n307_), .b(x70), .O(new_n315_));
  aoi21  g152(.a(new_n315_), .b(new_n314_), .c(x01), .O(z50));
  inv1   g153(.a(x11), .O(new_n317_));
  nand2  g154(.a(x52), .b(x19), .O(new_n318_));
  oai21  g155(.a(x52), .b(new_n317_), .c(new_n318_), .O(new_n319_));
  nand2  g156(.a(new_n319_), .b(new_n294_), .O(new_n320_));
  nand2  g157(.a(new_n307_), .b(x71), .O(new_n321_));
  aoi21  g158(.a(new_n321_), .b(new_n320_), .c(x01), .O(z51));
  inv1   g159(.a(x12), .O(new_n323_));
  nand2  g160(.a(x52), .b(x20), .O(new_n324_));
  oai21  g161(.a(x52), .b(new_n323_), .c(new_n324_), .O(new_n325_));
  nand2  g162(.a(new_n325_), .b(new_n294_), .O(new_n326_));
  nand2  g163(.a(new_n307_), .b(x72), .O(new_n327_));
  aoi21  g164(.a(new_n327_), .b(new_n326_), .c(x01), .O(z52));
  nand2  g165(.a(new_n160_), .b(new_n159_), .O(new_n332_));
  nand2  g166(.a(new_n232_), .b(x76), .O(new_n333_));
  ...
  nand4  g172(.a(new_n338_), .b(new_n332_), .c(new_n153_), .d(x00), .O(z56));
  nand4  g173(.a(x80), .b(new_n221_), .c(x43), .d(new_n237_), .O(new_n341_));
  oai22  g174(.a(new_n341_), .b(new_n220_), .c(new_n237_), .d(x40), .O(new_n342_));
  nand3  g175(.a(new_n342_), .b(new_n226_), .c(x79), .O(new_n343_));
  nor2   g176(.a(x79), .b(x78), .O(new_n344_));
  nand3  g177(.a(new_n344_), .b(new_n237_), .c(x40), .O(new_n345_));
  nand2  g178(.a(new_n345_), .b(new_n343_), .O(new_n346_));
  nand2  g179(.a(new_n346_), .b(x77), .O(new_n347_));
  inv1   g180(.a(new_n167_), .O(new_n348_));
  oai21  g181(.a(new_n348_), .b(new_n229_), .c(new_n154_), .O(new_n349_));
  aoi21  g182(.a(new_n349_), .b(new_n347_), .c(x01), .O(z58));
  inv1   g183(.a(new_n344_), .O(new_n351_));
  aoi21  g184(.a(new_n225_), .b(new_n351_), .c(new_n152_), .O(new_n352_));
  oai21  g185(.a(new_n222_), .b(new_n220_), .c(new_n237_), .O(new_n353_));
  aoi21  g186(.a(new_n353_), .b(x79), .c(new_n225_), .O(new_n354_));
  ...
  aoi21  g191(.a(new_n335_), .b(x79), .c(new_n356_), .O(new_n359_));
  aoi21  g192(.a(new_n359_), .b(new_n227_), .c(x01), .O(z60));
  nand2  g193(.a(new_n168_), .b(new_n167_), .O(new_n361_));
  aoi22  g194(.a(new_n361_), .b(new_n216_), .c(new_n161_), .d(new_n229_), .O(new_n362_));
  nand2  g195(.a(new_n170_), .b(x80), .O(new_n363_));
  nor2   g196(.a(new_n363_), .b(new_n362_), .O(z61));
  nand3  g197(.a(x84), .b(x81), .c(x79), .O(new_n365_));
  oai21  g198(.a(x79), .b(new_n229_), .c(new_n365_), .O(new_n366_));
  nand2  g199(.a(new_n366_), .b(new_n159_), .O(new_n367_));
  nand2  g200(.a(new_n353_), .b(x79), .O(new_n368_));
  nand3  g201(.a(x81), .b(x79), .c(new_n229_), .O(new_n369_));
  ...
  nor2   g215(.a(new_n238_), .b(x78), .O(new_n383_));
  oai21  g216(.a(new_n383_), .b(new_n382_), .c(x77), .O(new_n384_));
  nand2  g217(.a(new_n348_), .b(x81), .O(new_n385_));
