...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n249_, new_n251_, new_n254_, new_n257_, new_n259_, new_n261_,
    new_n263_, new_n264_, new_n265_, new_n266_, new_n267_, new_n268_,
    new_n269_, new_n270_, new_n271_, new_n272_, new_n273_, new_n274_,
    new_n276_, new_n277_, new_n278_, new_n279_, new_n280_, new_n281_,
    new_n282_, new_n283_, new_n284_, new_n285_, new_n286_, new_n288_,
    new_n290_, new_n292_, new_n301_, new_n305_, new_n306_, new_n307_,
  ...
  nor2   g105(.a(new_n221_), .b(x81), .O(new_n263_));
  ...
  inv1   g119(.a(new_n238_), .O(new_n277_));
  nand2  g120(.a(x83), .b(x42), .O(new_n278_));
  nand2  g121(.a(new_n278_), .b(new_n245_), .O(new_n279_));
  nand3  g122(.a(x83), .b(x81), .c(x42), .O(new_n280_));
  nand2  g123(.a(new_n280_), .b(new_n279_), .O(new_n281_));
  and2   g124(.a(new_n281_), .b(new_n246_), .O(new_n282_));
  nand2  g125(.a(new_n278_), .b(x81), .O(new_n283_));
  nand2  g126(.a(new_n263_), .b(x42), .O(new_n284_));
  aoi21  g127(.a(new_n284_), .b(new_n283_), .c(new_n242_), .O(new_n285_));
  oai21  g128(.a(new_n285_), .b(new_n282_), .c(new_n273_), .O(new_n286_));
  nor3   g129(.a(new_n286_), .b(new_n277_), .c(new_n276_), .O(z34));
  nand2  g130(.a(new_n238_), .b(x53), .O(new_n288_));
  nor2   g131(.a(new_n288_), .b(new_n286_), .O(z35));
  nand2  g132(.a(new_n238_), .b(x54), .O(new_n290_));
  nor2   g133(.a(new_n290_), .b(new_n286_), .O(z36));
  nand2  g134(.a(new_n238_), .b(x55), .O(new_n292_));
  nor2   g135(.a(new_n292_), .b(new_n286_), .O(z37));
  nor3   g136(.a(new_n286_), .b(new_n277_), .c(new_n194_), .O(z40));
  nor3   g137(.a(new_n286_), .b(new_n277_), .c(new_n191_), .O(z41));
  nor3   g138(.a(new_n286_), .b(new_n277_), .c(new_n188_), .O(z42));
  nor3   g139(.a(new_n286_), .b(new_n277_), .c(new_n185_), .O(z43));
  nand2  g140(.a(new_n238_), .b(x63), .O(new_n301_));
  nor2   g141(.a(new_n301_), .b(new_n286_), .O(z45));
  nor3   g142(.a(new_n286_), .b(new_n277_), .c(new_n178_), .O(z46));
  inv1   g143(.a(x08), .O(new_n305_));
  nand2  g144(.a(x52), .b(x16), .O(new_n306_));
  oai21  g145(.a(x52), .b(new_n305_), .c(new_n306_), .O(new_n307_));
  nor2   g146(.a(x79), .b(x77), .O(new_n308_));
  nand2  g147(.a(new_n308_), .b(new_n228_), .O(new_n309_));
  inv1   g148(.a(new_n309_), .O(new_n310_));
  nand2  g149(.a(new_n310_), .b(new_n307_), .O(new_n311_));
  inv1   g150(.a(new_n168_), .O(new_n312_));
  nand2  g151(.a(new_n312_), .b(x79), .O(new_n313_));
  inv1   g152(.a(new_n313_), .O(new_n314_));
  and2   g153(.a(new_n314_), .b(new_n218_), .O(new_n315_));
  nand2  g154(.a(new_n315_), .b(x68), .O(new_n316_));
  aoi21  g155(.a(new_n316_), .b(new_n311_), .c(x01), .O(z48));
  inv1   g156(.a(x09), .O(new_n318_));
  nand2  g157(.a(x52), .b(x17), .O(new_n319_));
  oai21  g158(.a(x52), .b(new_n318_), .c(new_n319_), .O(new_n320_));
  nand2  g159(.a(new_n320_), .b(new_n310_), .O(new_n321_));
  nand2  g160(.a(new_n315_), .b(x69), .O(new_n322_));
  aoi21  g161(.a(new_n322_), .b(new_n321_), .c(x01), .O(z49));
  inv1   g162(.a(x10), .O(new_n324_));
  nand2  g163(.a(x52), .b(x18), .O(new_n325_));
  oai21  g164(.a(x52), .b(new_n324_), .c(new_n325_), .O(new_n326_));
  nand2  g165(.a(new_n326_), .b(new_n310_), .O(new_n327_));
  nand2  g166(.a(new_n315_), .b(x70), .O(new_n328_));
  aoi21  g167(.a(new_n328_), .b(new_n327_), .c(x01), .O(z50));
  inv1   g168(.a(x11), .O(new_n330_));
  nand2  g169(.a(x52), .b(x19), .O(new_n331_));
  oai21  g170(.a(x52), .b(new_n330_), .c(new_n331_), .O(new_n332_));
  nand2  g171(.a(new_n332_), .b(new_n310_), .O(new_n333_));
  nand2  g172(.a(new_n315_), .b(x71), .O(new_n334_));
  ...
  nand2  g177(.a(new_n338_), .b(new_n310_), .O(new_n339_));
  nand2  g178(.a(new_n315_), .b(x72), .O(new_n340_));
  ...
  nand2  g183(.a(new_n344_), .b(new_n310_), .O(new_n345_));
  nand2  g184(.a(new_n315_), .b(x73), .O(new_n346_));
  aoi21  g185(.a(new_n346_), .b(new_n345_), .c(x01), .O(z53));
  nand2  g186(.a(x52), .b(x22), .O(new_n348_));
  nand2  g187(.a(new_n276_), .b(x14), .O(new_n349_));
  inv1   g188(.a(new_n167_), .O(new_n350_));
  nand4  g189(.a(new_n350_), .b(new_n154_), .c(x04), .d(new_n153_), .O(new_n351_));
  aoi21  g190(.a(new_n349_), .b(new_n348_), .c(new_n351_), .O(z54));
  inv1   g191(.a(x82), .O(new_n353_));
  nand3  g192(.a(new_n263_), .b(x84), .c(new_n353_), .O(new_n354_));
  inv1   g193(.a(x80), .O(new_n355_));
  nand4  g194(.a(new_n238_), .b(new_n161_), .c(new_n355_), .d(x79), .O(new_n356_));
  nor2   g195(.a(new_n356_), .b(new_n354_), .O(z55));
  nand2  g196(.a(new_n236_), .b(x76), .O(new_n358_));
  xnor2a g197(.a(x84), .b(x81), .O(new_n359_));
  aoi21  g198(.a(new_n168_), .b(new_n167_), .c(new_n359_), .O(new_n360_));
  nand2  g199(.a(new_n360_), .b(new_n153_), .O(new_n361_));
  nand2  g200(.a(new_n361_), .b(new_n358_), .O(new_n362_));
  nand2  g201(.a(new_n362_), .b(x79), .O(new_n363_));
  nand3  g202(.a(new_n160_), .b(new_n159_), .c(new_n153_), .O(new_n364_));
  nand3  g203(.a(new_n364_), .b(new_n363_), .c(new_n234_), .O(z56));
  inv1   g204(.a(x02), .O(new_n366_));
  nand3  g205(.a(new_n234_), .b(x03), .c(new_n366_), .O(new_n367_));
  inv1   g206(.a(new_n367_), .O(z57));
  nand4  g207(.a(x80), .b(new_n223_), .c(x43), .d(new_n241_), .O(new_n369_));
  oai22  g208(.a(new_n369_), .b(new_n222_), .c(new_n241_), .d(x40), .O(new_n370_));
  nand3  g209(.a(new_n370_), .b(new_n228_), .c(x79), .O(new_n371_));
  nor2   g210(.a(x79), .b(x78), .O(new_n372_));
  nand3  g211(.a(new_n372_), .b(new_n241_), .c(x40), .O(new_n373_));
  nand2  g212(.a(new_n373_), .b(new_n371_), .O(new_n374_));
  nand2  g213(.a(new_n374_), .b(x77), .O(new_n375_));
  oai21  g214(.a(new_n350_), .b(new_n231_), .c(new_n154_), .O(new_n376_));
  aoi21  g215(.a(new_n376_), .b(new_n375_), .c(x01), .O(z58));
  inv1   g216(.a(new_n372_), .O(new_n378_));
  aoi21  g217(.a(new_n227_), .b(new_n378_), .c(new_n152_), .O(new_n379_));
  oai21  g218(.a(new_n224_), .b(new_n222_), .c(new_n241_), .O(new_n380_));
  aoi21  g219(.a(new_n380_), .b(x79), .c(new_n227_), .O(new_n381_));
  ...
  aoi21  g225(.a(new_n386_), .b(new_n229_), .c(x01), .O(z60));
  inv1   g226(.a(new_n170_), .O(new_n388_));
  nand2  g227(.a(new_n168_), .b(new_n167_), .O(new_n389_));
  aoi22  g228(.a(new_n389_), .b(new_n218_), .c(new_n161_), .d(new_n231_), .O(new_n390_));
  nor3   g229(.a(new_n390_), .b(new_n388_), .c(new_n355_), .O(z61));
  nand3  g230(.a(x84), .b(x81), .c(x79), .O(new_n392_));
  oai21  g231(.a(x79), .b(new_n231_), .c(new_n392_), .O(new_n393_));
  nand2  g232(.a(new_n393_), .b(new_n159_), .O(new_n394_));
  nand2  g233(.a(new_n380_), .b(x79), .O(new_n395_));
  nand3  g234(.a(x81), .b(x79), .c(new_n231_), .O(new_n396_));
  inv1   g235(.a(new_n396_), .O(new_n397_));
  aoi21  g236(.a(new_n395_), .b(x04), .c(new_n397_), .O(new_n398_));
  oai21  g237(.a(new_n398_), .b(new_n159_), .c(new_n394_), .O(new_n399_));
  nand2  g238(.a(new_n399_), .b(x78), .O(new_n400_));
  inv1   g239(.a(new_n392_), .O(new_n401_));
  nand2  g240(.a(new_n401_), .b(new_n312_), .O(new_n402_));
  aoi21  g241(.a(new_n402_), .b(new_n400_), .c(x01), .O(z62));
  nor3   g242(.a(new_n390_), .b(new_n388_), .c(new_n353_), .O(z63));
  nand2  g243(.a(x83), .b(x79), .O(new_n405_));
  or2    g244(.a(new_n405_), .b(new_n390_), .O(new_n406_));
  aoi21  g245(.a(new_n406_), .b(new_n309_), .c(x01), .O(z64));
  nor2   g246(.a(new_n160_), .b(x04), .O(new_n408_));
  nor2   g247(.a(new_n245_), .b(x78), .O(new_n409_));
  oai21  g248(.a(new_n409_), .b(new_n408_), .c(x77), .O(new_n410_));
  nand2  g249(.a(new_n350_), .b(x81), .O(new_n411_));
  nand2  g250(.a(new_n170_), .b(x84), .O(new_n412_));
