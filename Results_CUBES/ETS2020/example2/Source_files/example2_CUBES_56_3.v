...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n264_, new_n266_, new_n268_, new_n271_, new_n273_, new_n274_,
    new_n275_, new_n276_, new_n277_, new_n278_, new_n279_, new_n280_,
    new_n281_, new_n282_, new_n283_, new_n284_, new_n286_, new_n287_,
    new_n288_, new_n289_, new_n290_, new_n291_, new_n292_, new_n293_,
    new_n294_, new_n295_, new_n296_, new_n298_, new_n300_, new_n302_,
    new_n304_, new_n315_, new_n316_, new_n317_, new_n318_, new_n319_,
  ...
  nand4  g109(.a(new_n258_), .b(new_n247_), .c(x46), .d(new_n250_), .O(new_n264_));
  inv1   g110(.a(new_n264_), .O(z28));
  nand4  g111(.a(new_n258_), .b(new_n247_), .c(x47), .d(new_n250_), .O(new_n266_));
  inv1   g112(.a(new_n266_), .O(z29));
  nand4  g113(.a(new_n258_), .b(new_n247_), .c(x48), .d(new_n250_), .O(new_n268_));
  ...
  nand2  g144(.a(new_n247_), .b(x54), .O(new_n300_));
  nor2   g145(.a(new_n300_), .b(new_n296_), .O(z36));
  nand2  g146(.a(new_n247_), .b(x55), .O(new_n302_));
  nor2   g147(.a(new_n302_), .b(new_n296_), .O(z37));
  nand2  g148(.a(new_n247_), .b(x56), .O(new_n304_));
  nor2   g149(.a(new_n304_), .b(new_n296_), .O(z38));
  nor3   g150(.a(new_n296_), .b(new_n287_), .c(new_n206_), .O(z39));
  nor3   g151(.a(new_n296_), .b(new_n287_), .c(new_n197_), .O(z42));
  nor3   g152(.a(new_n296_), .b(new_n287_), .c(new_n191_), .O(z44));
  nor3   g153(.a(new_n296_), .b(new_n287_), .c(new_n188_), .O(z45));
  nor3   g154(.a(new_n296_), .b(new_n287_), .c(new_n185_), .O(z46));
  inv1   g155(.a(x08), .O(new_n315_));
  nand2  g156(.a(x52), .b(x16), .O(new_n316_));
  oai21  g157(.a(x52), .b(new_n315_), .c(new_n316_), .O(new_n317_));
  nand3  g158(.a(new_n232_), .b(new_n154_), .c(new_n159_), .O(new_n318_));
  inv1   g159(.a(new_n318_), .O(new_n319_));
  nand2  g160(.a(new_n319_), .b(new_n317_), .O(new_n320_));
  inv1   g161(.a(new_n171_), .O(new_n321_));
  nand2  g162(.a(new_n321_), .b(x79), .O(new_n322_));
  inv1   g163(.a(new_n322_), .O(new_n323_));
  and2   g164(.a(new_n323_), .b(new_n229_), .O(new_n324_));
  nand2  g165(.a(new_n324_), .b(x68), .O(new_n325_));
  aoi21  g166(.a(new_n325_), .b(new_n320_), .c(x01), .O(z48));
  inv1   g167(.a(x09), .O(new_n327_));
  nand2  g168(.a(x52), .b(x17), .O(new_n328_));
  oai21  g169(.a(x52), .b(new_n327_), .c(new_n328_), .O(new_n329_));
  nand2  g170(.a(new_n329_), .b(new_n319_), .O(new_n330_));
  nand2  g171(.a(new_n324_), .b(x69), .O(new_n331_));
  aoi21  g172(.a(new_n331_), .b(new_n330_), .c(x01), .O(z49));
  inv1   g173(.a(x10), .O(new_n333_));
  nand2  g174(.a(x52), .b(x18), .O(new_n334_));
  oai21  g175(.a(x52), .b(new_n333_), .c(new_n334_), .O(new_n335_));
  nand2  g176(.a(new_n335_), .b(new_n319_), .O(new_n336_));
  nand2  g177(.a(new_n324_), .b(x70), .O(new_n337_));
  aoi21  g178(.a(new_n337_), .b(new_n336_), .c(x01), .O(z50));
  inv1   g179(.a(x11), .O(new_n339_));
  nand2  g180(.a(x52), .b(x19), .O(new_n340_));
  oai21  g181(.a(x52), .b(new_n339_), .c(new_n340_), .O(new_n341_));
  nand2  g182(.a(new_n341_), .b(new_n319_), .O(new_n342_));
  nand2  g183(.a(new_n324_), .b(x71), .O(new_n343_));
  aoi21  g184(.a(new_n343_), .b(new_n342_), .c(x01), .O(z51));
  inv1   g185(.a(x12), .O(new_n345_));
  nand2  g186(.a(x52), .b(x20), .O(new_n346_));
  oai21  g187(.a(x52), .b(new_n345_), .c(new_n346_), .O(new_n347_));
  nand2  g188(.a(new_n347_), .b(new_n319_), .O(new_n348_));
  nand2  g189(.a(new_n324_), .b(x72), .O(new_n349_));
  aoi21  g190(.a(new_n349_), .b(new_n348_), .c(x01), .O(z52));
  inv1   g191(.a(x13), .O(new_n351_));
  nand2  g192(.a(x52), .b(x21), .O(new_n352_));
  oai21  g193(.a(x52), .b(new_n351_), .c(new_n352_), .O(new_n353_));
  nand2  g194(.a(new_n353_), .b(new_n319_), .O(new_n354_));
  nand2  g195(.a(new_n324_), .b(x73), .O(new_n355_));
  aoi21  g196(.a(new_n355_), .b(new_n354_), .c(x01), .O(z53));
  nand2  g197(.a(x52), .b(x22), .O(new_n357_));
  nand2  g198(.a(new_n286_), .b(x14), .O(new_n358_));
  inv1   g199(.a(new_n170_), .O(new_n359_));
  nand4  g200(.a(new_n359_), .b(new_n154_), .c(x04), .d(new_n153_), .O(new_n360_));
  aoi21  g201(.a(new_n358_), .b(new_n357_), .c(new_n360_), .O(z54));
  inv1   g202(.a(x82), .O(new_n362_));
  nand3  g203(.a(new_n273_), .b(x84), .c(new_n362_), .O(new_n363_));
  inv1   g204(.a(x80), .O(new_n364_));
  nand4  g205(.a(new_n247_), .b(new_n165_), .c(new_n364_), .d(x79), .O(new_n365_));
  nor2   g206(.a(new_n365_), .b(new_n363_), .O(z55));
  nand2  g207(.a(new_n245_), .b(x76), .O(new_n367_));
  xnor2a g208(.a(x84), .b(x81), .O(new_n368_));
  aoi21  g209(.a(new_n171_), .b(new_n170_), .c(new_n368_), .O(new_n369_));
  ...
  aoi21  g234(.a(new_n369_), .b(x79), .c(new_n391_), .O(new_n394_));
  ...
  nor3   g239(.a(new_n398_), .b(new_n396_), .c(new_n364_), .O(z61));
  ...
  nand2  g250(.a(new_n409_), .b(new_n321_), .O(new_n410_));
  aoi21  g251(.a(new_n410_), .b(new_n408_), .c(x01), .O(z62));
  nor3   g252(.a(new_n398_), .b(new_n396_), .c(new_n362_), .O(z63));
  ...
  nor2   g258(.a(new_n254_), .b(x78), .O(new_n418_));
  oai21  g259(.a(new_n418_), .b(new_n417_), .c(x77), .O(new_n419_));
  nand2  g260(.a(new_n359_), .b(x81), .O(new_n420_));
