...
module FAU ( 
  ...
  wire new_n154_, new_n155_, new_n156_, new_n157_, new_n158_, new_n159_,
    ...
    new_n181_, new_n182_, new_n186_, new_n187_, new_n190_, new_n191_,
    ...
    new_n235_, new_n239_, new_n240_, new_n241_, new_n244_, new_n245_,
    new_n246_, new_n247_, new_n248_, new_n249_, new_n250_, new_n251_,
    new_n252_, new_n253_, new_n255_, new_n257_, new_n260_, new_n262_,
    new_n264_, new_n267_, new_n269_, new_n271_, new_n273_, new_n275_,
  ...
  nand3  g083(.a(x83), .b(new_n216_), .c(x42), .O(new_n250_));
  aoi21  g084(.a(new_n250_), .b(new_n249_), .c(new_n217_), .O(new_n251_));
  oai21  g085(.a(new_n251_), .b(new_n248_), .c(new_n222_), .O(new_n252_));
  nand2  g086(.a(new_n212_), .b(x52), .O(new_n253_));
  nor2   g087(.a(new_n253_), .b(new_n252_), .O(z34));
  nand2  g088(.a(new_n212_), .b(x53), .O(new_n255_));
  nor2   g089(.a(new_n255_), .b(new_n252_), .O(z35));
  nand2  g090(.a(new_n212_), .b(x54), .O(new_n257_));
  nor2   g091(.a(new_n257_), .b(new_n252_), .O(z36));
  nand2  g092(.a(new_n212_), .b(x56), .O(new_n260_));
  nor2   g093(.a(new_n260_), .b(new_n252_), .O(z38));
  nand2  g094(.a(new_n212_), .b(x57), .O(new_n262_));
  nor2   g095(.a(new_n262_), .b(new_n252_), .O(z39));
  nand2  g096(.a(new_n212_), .b(x58), .O(new_n264_));
  nor2   g097(.a(new_n264_), .b(new_n252_), .O(z40));
  nand2  g098(.a(new_n212_), .b(x60), .O(new_n267_));
  nor2   g099(.a(new_n267_), .b(new_n252_), .O(z42));
  nand2  g100(.a(new_n212_), .b(x61), .O(new_n269_));
  nor2   g101(.a(new_n269_), .b(new_n252_), .O(z43));
  nand2  g102(.a(new_n212_), .b(x62), .O(new_n271_));
  nor2   g103(.a(new_n271_), .b(new_n252_), .O(z44));
  nand2  g104(.a(new_n212_), .b(x63), .O(new_n273_));
  nor2   g105(.a(new_n273_), .b(new_n252_), .O(z45));
  nand2  g106(.a(new_n212_), .b(x64), .O(new_n275_));
  nor2   g107(.a(new_n275_), .b(new_n252_), .O(z46));
  inv1   g108(.a(x07), .O(new_n277_));
  nand2  g109(.a(x52), .b(x15), .O(new_n278_));
  oai21  g110(.a(x52), .b(new_n277_), .c(new_n278_), .O(new_n279_));
  inv1   g111(.a(x04), .O(new_n280_));
  nor2   g112(.a(x77), .b(new_n280_), .O(new_n281_));
  nor2   g113(.a(x79), .b(new_n156_), .O(new_n282_));
  nand3  g114(.a(new_n282_), .b(new_n281_), .c(new_n279_), .O(new_n283_));
  xnor2a g115(.a(x84), .b(x81), .O(new_n284_));
  or2    g116(.a(x75), .b(x67), .O(new_n285_));
  nor2   g117(.a(x78), .b(new_n154_), .O(new_n286_));
  nand4  g118(.a(new_n286_), .b(new_n285_), .c(new_n284_), .d(x79), .O(new_n287_));
  aoi21  g119(.a(new_n287_), .b(new_n283_), .c(x01), .O(z47));
  inv1   g120(.a(x09), .O(new_n290_));
  nand2  g121(.a(x52), .b(x17), .O(new_n291_));
  oai21  g122(.a(x52), .b(new_n290_), .c(new_n291_), .O(new_n292_));
  nand3  g123(.a(new_n292_), .b(new_n282_), .c(new_n281_), .O(new_n293_));
  nand4  g124(.a(new_n286_), .b(new_n284_), .c(x79), .d(x69), .O(new_n294_));
  aoi21  g125(.a(new_n294_), .b(new_n293_), .c(x01), .O(z49));
  inv1   g126(.a(x10), .O(new_n296_));
  nand2  g127(.a(x52), .b(x18), .O(new_n297_));
  oai21  g128(.a(x52), .b(new_n296_), .c(new_n297_), .O(new_n298_));
  nand3  g129(.a(new_n298_), .b(new_n282_), .c(new_n281_), .O(new_n299_));
  nand4  g130(.a(new_n286_), .b(new_n284_), .c(x79), .d(x70), .O(new_n300_));
  aoi21  g131(.a(new_n300_), .b(new_n299_), .c(x01), .O(z50));
  inv1   g132(.a(x11), .O(new_n302_));
  nand2  g133(.a(x52), .b(x19), .O(new_n303_));
  oai21  g134(.a(x52), .b(new_n302_), .c(new_n303_), .O(new_n304_));
  nand3  g135(.a(new_n304_), .b(new_n282_), .c(new_n281_), .O(new_n305_));
  nand4  g136(.a(new_n286_), .b(new_n284_), .c(x79), .d(x71), .O(new_n306_));
  ...
  nand3  g141(.a(new_n310_), .b(new_n282_), .c(new_n281_), .O(new_n311_));
  nand4  g142(.a(new_n286_), .b(new_n284_), .c(x79), .d(x72), .O(new_n312_));
  ...
  nand3  g147(.a(new_n316_), .b(new_n282_), .c(new_n281_), .O(new_n317_));
  nand4  g148(.a(new_n286_), .b(new_n284_), .c(x79), .d(x73), .O(new_n318_));
  aoi21  g149(.a(new_n318_), .b(new_n317_), .c(x01), .O(z53));
  inv1   g150(.a(x82), .O(new_n321_));
  nand4  g151(.a(x84), .b(x83), .c(new_n321_), .d(new_n216_), .O(new_n322_));
  nor2   g152(.a(x80), .b(new_n208_), .O(new_n323_));
  nand3  g153(.a(new_n323_), .b(new_n212_), .c(new_n209_), .O(new_n324_));
  nor2   g154(.a(new_n324_), .b(new_n322_), .O(z55));
  aoi21  g155(.a(x84), .b(new_n216_), .c(x76), .O(new_n326_));
  oai21  g156(.a(x84), .b(new_n216_), .c(new_n326_), .O(new_n327_));
  nand2  g157(.a(new_n327_), .b(new_n210_), .O(new_n328_));
  nand2  g158(.a(new_n156_), .b(new_n154_), .O(new_n329_));
  nand4  g159(.a(new_n329_), .b(new_n328_), .c(new_n158_), .d(x00), .O(z56));
  inv1   g160(.a(x02), .O(new_n331_));
  nand4  g161(.a(x03), .b(new_n331_), .c(new_n158_), .d(x00), .O(new_n332_));
