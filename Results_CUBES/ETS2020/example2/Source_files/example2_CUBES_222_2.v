...
module FAU ( 
  ...
  wire new_n154_, new_n155_, new_n156_, new_n157_, new_n158_, new_n159_,
    ...
    new_n335_, new_n336_, new_n341_, new_n342_, new_n343_;
  ...
  nand2  g097(.a(new_n209_), .b(x53), .O(new_n263_));
  nor2   g098(.a(new_n263_), .b(new_n262_), .O(z35));
  nand2  g099(.a(new_n209_), .b(x56), .O(new_n267_));
  nor2   g100(.a(new_n267_), .b(new_n262_), .O(z38));
  nand2  g101(.a(new_n209_), .b(x57), .O(new_n269_));
  nor2   g102(.a(new_n269_), .b(new_n262_), .O(z39));
  nand2  g103(.a(new_n209_), .b(x58), .O(new_n271_));
  nor2   g104(.a(new_n271_), .b(new_n262_), .O(z40));
  nand2  g105(.a(new_n209_), .b(x60), .O(new_n274_));
  nor2   g106(.a(new_n274_), .b(new_n262_), .O(z42));
  nand2  g107(.a(new_n209_), .b(x62), .O(new_n277_));
  nor2   g108(.a(new_n277_), .b(new_n262_), .O(z44));
  nand2  g109(.a(new_n209_), .b(x63), .O(new_n279_));
  nor2   g110(.a(new_n279_), .b(new_n262_), .O(z45));
  ...
  nand4  g158(.a(x84), .b(x83), .c(new_n329_), .d(new_n212_), .O(new_n330_));
  inv1   g159(.a(x80), .O(new_n331_));
  nand4  g160(.a(new_n209_), .b(new_n206_), .c(new_n331_), .d(x79), .O(new_n332_));
  nor2   g161(.a(new_n332_), .b(new_n330_), .O(z55));
  inv1   g162(.a(x02), .O(new_n335_));
  nand4  g163(.a(x03), .b(new_n335_), .c(new_n160_), .d(x00), .O(new_n336_));
  inv1   g164(.a(new_n336_), .O(z57));
  oai21  g165(.a(new_n158_), .b(new_n155_), .c(new_n288_), .O(new_n341_));
  nand2  g166(.a(new_n206_), .b(new_n285_), .O(new_n342_));
  nand3  g167(.a(x80), .b(x79), .c(new_n160_), .O(new_n343_));
  aoi21  g168(.a(new_n342_), .b(new_n341_), .c(new_n343_), .O(z61));
  zero   g169(.O(z00));
  zero   g170(.O(z01));
  zero   g171(.O(z04));
  zero   g172(.O(z06));
