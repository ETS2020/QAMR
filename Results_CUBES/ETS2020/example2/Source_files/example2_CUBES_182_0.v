// Benchmark "FAU" written by ABC on Fri Jul 10 18:22:33 2020
...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n286_, new_n294_, new_n297_, new_n298_, new_n299_, new_n300_,
  ...
  nand2  g124(.a(new_n229_), .b(x56), .O(new_n286_));
  nor2   g125(.a(new_n286_), .b(new_n278_), .O(z38));
  nor3   g126(.a(new_n278_), .b(new_n269_), .c(new_n184_), .O(z40));
  nor3   g127(.a(new_n278_), .b(new_n269_), .c(new_n181_), .O(z41));
  nor3   g128(.a(new_n278_), .b(new_n269_), .c(new_n177_), .O(z43));
  nand2  g129(.a(new_n229_), .b(x63), .O(new_n294_));
  nor2   g130(.a(new_n294_), .b(new_n278_), .O(z45));
  ...
  inv1   g148(.a(new_n209_), .O(new_n314_));
  ...
  inv1   g152(.a(x09), .O(new_n318_));
  nand2  g153(.a(x52), .b(x17), .O(new_n319_));
  oai21  g154(.a(x52), .b(new_n318_), .c(new_n319_), .O(new_n320_));
  nand2  g155(.a(new_n320_), .b(new_n302_), .O(new_n321_));
  nand2  g156(.a(new_n315_), .b(x69), .O(new_n322_));
  aoi21  g157(.a(new_n322_), .b(new_n321_), .c(x01), .O(z49));
  inv1   g158(.a(x10), .O(new_n324_));
  nand2  g159(.a(x52), .b(x18), .O(new_n325_));
  oai21  g160(.a(x52), .b(new_n324_), .c(new_n325_), .O(new_n326_));
  nand2  g161(.a(new_n326_), .b(new_n302_), .O(new_n327_));
  nand2  g162(.a(new_n315_), .b(x70), .O(new_n328_));
  aoi21  g163(.a(new_n328_), .b(new_n327_), .c(x01), .O(z50));
  inv1   g164(.a(x11), .O(new_n330_));
  nand2  g165(.a(x52), .b(x19), .O(new_n331_));
  oai21  g166(.a(x52), .b(new_n330_), .c(new_n331_), .O(new_n332_));
  nand2  g167(.a(new_n332_), .b(new_n302_), .O(new_n333_));
  nand2  g168(.a(new_n315_), .b(x71), .O(new_n334_));
  aoi21  g169(.a(new_n334_), .b(new_n333_), .c(x01), .O(z51));
  inv1   g170(.a(x12), .O(new_n336_));
  nand2  g171(.a(x52), .b(x20), .O(new_n337_));
  oai21  g172(.a(x52), .b(new_n336_), .c(new_n337_), .O(new_n338_));
  nand2  g173(.a(new_n338_), .b(new_n302_), .O(new_n339_));
  nand2  g174(.a(new_n315_), .b(x72), .O(new_n340_));
  aoi21  g175(.a(new_n340_), .b(new_n339_), .c(x01), .O(z52));
  inv1   g176(.a(x13), .O(new_n342_));
  nand2  g177(.a(x52), .b(x21), .O(new_n343_));
  oai21  g178(.a(x52), .b(new_n342_), .c(new_n343_), .O(new_n344_));
  nand2  g179(.a(new_n344_), .b(new_n302_), .O(new_n345_));
  nand2  g180(.a(new_n315_), .b(x73), .O(new_n346_));
  aoi21  g181(.a(new_n346_), .b(new_n345_), .c(x01), .O(z53));
  nand2  g182(.a(x52), .b(x22), .O(new_n348_));
  nand2  g183(.a(new_n268_), .b(x14), .O(new_n349_));
  inv1   g184(.a(new_n206_), .O(new_n350_));
  nand4  g185(.a(new_n350_), .b(new_n154_), .c(x04), .d(new_n153_), .O(new_n351_));
  aoi21  g186(.a(new_n349_), .b(new_n348_), .c(new_n351_), .O(z54));
  inv1   g187(.a(x82), .O(new_n353_));
  nand3  g188(.a(new_n255_), .b(x84), .c(new_n353_), .O(new_n354_));
  inv1   g189(.a(x80), .O(new_n355_));
  nand4  g190(.a(new_n229_), .b(new_n161_), .c(new_n355_), .d(x79), .O(new_n356_));
  nor2   g191(.a(new_n356_), .b(new_n354_), .O(z55));
  nand2  g192(.a(new_n227_), .b(x76), .O(new_n358_));
  xnor2a g193(.a(x84), .b(x81), .O(new_n359_));
  aoi21  g194(.a(new_n207_), .b(new_n206_), .c(new_n359_), .O(new_n360_));
  nand2  g195(.a(new_n360_), .b(new_n153_), .O(new_n361_));
  nand2  g196(.a(new_n361_), .b(new_n358_), .O(new_n362_));
  nand2  g197(.a(new_n362_), .b(x79), .O(new_n363_));
  nand3  g198(.a(new_n160_), .b(new_n159_), .c(new_n153_), .O(new_n364_));
  nand3  g199(.a(new_n364_), .b(new_n363_), .c(new_n225_), .O(z56));
  inv1   g200(.a(x02), .O(new_n366_));
  nand3  g201(.a(new_n225_), .b(x03), .c(new_n366_), .O(new_n367_));
  inv1   g202(.a(new_n367_), .O(z57));
  nand4  g203(.a(x80), .b(new_n214_), .c(x43), .d(new_n232_), .O(new_n369_));
  oai22  g204(.a(new_n369_), .b(new_n213_), .c(new_n232_), .d(x40), .O(new_n370_));
  nand3  g205(.a(new_n370_), .b(new_n219_), .c(x79), .O(new_n371_));
  nor2   g206(.a(x79), .b(x78), .O(new_n372_));
  nand3  g207(.a(new_n372_), .b(new_n232_), .c(x40), .O(new_n373_));
  nand2  g208(.a(new_n373_), .b(new_n371_), .O(new_n374_));
  nand2  g209(.a(new_n374_), .b(x77), .O(new_n375_));
  oai21  g210(.a(new_n350_), .b(new_n222_), .c(new_n154_), .O(new_n376_));
  aoi21  g211(.a(new_n376_), .b(new_n375_), .c(x01), .O(z58));
  inv1   g212(.a(new_n372_), .O(new_n378_));
  aoi21  g213(.a(new_n218_), .b(new_n378_), .c(new_n152_), .O(new_n379_));
  oai21  g214(.a(new_n215_), .b(new_n213_), .c(new_n232_), .O(new_n380_));
  aoi21  g215(.a(new_n380_), .b(x79), .c(new_n218_), .O(new_n381_));
  oai21  g216(.a(new_n381_), .b(new_n379_), .c(x77), .O(new_n382_));
  nor2   g217(.a(x79), .b(x04), .O(new_n383_));
  inv1   g218(.a(new_n383_), .O(new_n384_));
  aoi21  g219(.a(new_n384_), .b(new_n382_), .c(x01), .O(z59));
  aoi21  g220(.a(new_n360_), .b(x79), .c(new_n383_), .O(new_n386_));
  aoi21  g221(.a(new_n386_), .b(new_n220_), .c(x01), .O(z60));
  nand2  g222(.a(new_n207_), .b(new_n206_), .O(new_n388_));
  aoi22  g223(.a(new_n388_), .b(new_n209_), .c(new_n161_), .d(new_n222_), .O(new_n389_));
  nor2   g224(.a(new_n154_), .b(x01), .O(new_n390_));
  inv1   g225(.a(new_n390_), .O(new_n391_));
  nor3   g226(.a(new_n391_), .b(new_n389_), .c(new_n355_), .O(z61));
  nand3  g227(.a(x84), .b(x81), .c(x79), .O(new_n393_));
  oai21  g228(.a(x79), .b(new_n222_), .c(new_n393_), .O(new_n394_));
  nand2  g229(.a(new_n394_), .b(new_n159_), .O(new_n395_));
  nand2  g230(.a(new_n380_), .b(x79), .O(new_n396_));
  nand3  g231(.a(x81), .b(x79), .c(new_n222_), .O(new_n397_));
  inv1   g232(.a(new_n397_), .O(new_n398_));
  aoi21  g233(.a(new_n396_), .b(x04), .c(new_n398_), .O(new_n399_));
  oai21  g234(.a(new_n399_), .b(new_n159_), .c(new_n395_), .O(new_n400_));
  nand2  g235(.a(new_n400_), .b(x78), .O(new_n401_));
  inv1   g236(.a(new_n393_), .O(new_n402_));
  nand2  g237(.a(new_n402_), .b(new_n305_), .O(new_n403_));
  aoi21  g238(.a(new_n403_), .b(new_n401_), .c(x01), .O(z62));
  nor3   g239(.a(new_n391_), .b(new_n389_), .c(new_n353_), .O(z63));
  nand2  g240(.a(x83), .b(x79), .O(new_n406_));
  or2    g241(.a(new_n406_), .b(new_n389_), .O(new_n407_));
  aoi21  g242(.a(new_n407_), .b(new_n301_), .c(x01), .O(z64));
  nor2   g243(.a(new_n160_), .b(x04), .O(new_n409_));
  nor2   g244(.a(new_n236_), .b(x78), .O(new_n410_));
  oai21  g245(.a(new_n410_), .b(new_n409_), .c(x77), .O(new_n411_));
  nand2  g246(.a(new_n350_), .b(x81), .O(new_n412_));
  nand2  g247(.a(new_n390_), .b(x84), .O(new_n413_));
  aoi21  g248(.a(new_n412_), .b(new_n411_), .c(new_n413_), .O(z65));
  zero   g249(.O(z02));
  zero   g250(.O(z06));
  zero   g251(.O(z07));
  zero   g252(.O(z10));
