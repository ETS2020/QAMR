...
module FAU ( 
  ...
  wire new_n154_, new_n155_, new_n156_, new_n157_, new_n158_, new_n159_,
    ...
    new_n281_, new_n283_, new_n285_, new_n288_, new_n290_, new_n292_,
    ...
    new_n345_, new_n346_, new_n347_, new_n350_, new_n351_, new_n358_,
    new_n359_, new_n360_;
  ...
  oai21  g058(.a(new_n218_), .b(new_n217_), .c(new_n220_), .O(new_n221_));
  nand3  g059(.a(x79), .b(x78), .c(x77), .O(new_n222_));
  inv1   g060(.a(new_n222_), .O(new_n223_));
  inv1   g061(.a(x42), .O(new_n224_));
  nand3  g062(.a(new_n213_), .b(x44), .c(new_n224_), .O(new_n225_));
  inv1   g063(.a(new_n225_), .O(new_n226_));
  nand3  g064(.a(new_n226_), .b(new_n223_), .c(new_n221_), .O(new_n227_));
  inv1   g065(.a(new_n227_), .O(z26));
  nand3  g066(.a(new_n213_), .b(x45), .c(new_n224_), .O(new_n229_));
  inv1   g067(.a(new_n229_), .O(new_n230_));
  nand3  g068(.a(new_n230_), .b(new_n223_), .c(new_n221_), .O(new_n231_));
  inv1   g069(.a(new_n231_), .O(z27));
  nand3  g070(.a(new_n213_), .b(x46), .c(new_n224_), .O(new_n233_));
  inv1   g071(.a(new_n233_), .O(new_n234_));
  nand3  g072(.a(new_n234_), .b(new_n223_), .c(new_n221_), .O(new_n235_));
  inv1   g073(.a(new_n235_), .O(z28));
  nand3  g074(.a(new_n213_), .b(x47), .c(new_n224_), .O(new_n237_));
  inv1   g075(.a(new_n237_), .O(new_n238_));
  nand3  g076(.a(new_n238_), .b(new_n223_), .c(new_n221_), .O(new_n239_));
  inv1   g077(.a(new_n239_), .O(z29));
  nand3  g078(.a(new_n213_), .b(x48), .c(new_n224_), .O(new_n241_));
  inv1   g079(.a(new_n241_), .O(new_n242_));
  nand3  g080(.a(new_n242_), .b(new_n223_), .c(new_n221_), .O(new_n243_));
  inv1   g081(.a(new_n243_), .O(z30));
  nand3  g082(.a(new_n213_), .b(x49), .c(new_n224_), .O(new_n245_));
  inv1   g083(.a(new_n245_), .O(new_n246_));
  nand3  g084(.a(new_n246_), .b(new_n223_), .c(new_n221_), .O(new_n247_));
  inv1   g085(.a(new_n247_), .O(z31));
  nand3  g086(.a(new_n213_), .b(x50), .c(new_n224_), .O(new_n249_));
  inv1   g087(.a(new_n249_), .O(new_n250_));
  nand3  g088(.a(new_n250_), .b(new_n223_), .c(new_n221_), .O(new_n251_));
  inv1   g089(.a(new_n251_), .O(z32));
  inv1   g090(.a(new_n218_), .O(new_n253_));
  xnor2a g091(.a(x83), .b(x81), .O(new_n254_));
  nand2  g092(.a(x42), .b(x05), .O(new_n255_));
  nand2  g093(.a(x51), .b(new_n224_), .O(new_n256_));
  oai22  g094(.a(new_n256_), .b(new_n217_), .c(new_n255_), .d(new_n254_), .O(new_n257_));
  ...
  nand2  g098(.a(new_n260_), .b(new_n219_), .O(new_n261_));
  nand2  g099(.a(new_n223_), .b(new_n213_), .O(new_n262_));
  ...
  nand2  g103(.a(new_n265_), .b(new_n217_), .O(new_n266_));
  ...
  nand3  g107(.a(x83), .b(new_n217_), .c(x42), .O(new_n270_));
  aoi21  g108(.a(new_n270_), .b(new_n269_), .c(new_n218_), .O(new_n271_));
  oai21  g109(.a(new_n271_), .b(new_n268_), .c(new_n223_), .O(new_n272_));
  nand2  g110(.a(new_n213_), .b(x52), .O(new_n273_));
  nor2   g111(.a(new_n273_), .b(new_n272_), .O(z34));
  nand2  g112(.a(new_n213_), .b(x54), .O(new_n276_));
  nor2   g113(.a(new_n276_), .b(new_n272_), .O(z36));
  nand2  g114(.a(new_n213_), .b(x55), .O(new_n278_));
  nor2   g115(.a(new_n278_), .b(new_n272_), .O(z37));
  nand2  g116(.a(new_n213_), .b(x57), .O(new_n281_));
  nor2   g117(.a(new_n281_), .b(new_n272_), .O(z39));
  nand2  g118(.a(new_n213_), .b(x58), .O(new_n283_));
  nor2   g119(.a(new_n283_), .b(new_n272_), .O(z40));
  nand2  g120(.a(new_n213_), .b(x59), .O(new_n285_));
  nor2   g121(.a(new_n285_), .b(new_n272_), .O(z41));
  nand2  g122(.a(new_n213_), .b(x61), .O(new_n288_));
  nor2   g123(.a(new_n288_), .b(new_n272_), .O(z43));
  nand2  g124(.a(new_n213_), .b(x62), .O(new_n290_));
  nor2   g125(.a(new_n290_), .b(new_n272_), .O(z44));
  nand2  g126(.a(new_n213_), .b(x63), .O(new_n292_));
  nor2   g127(.a(new_n292_), .b(new_n272_), .O(z45));
  ...
  nand2  g177(.a(x83), .b(new_n217_), .O(new_n345_));
  inv1   g178(.a(x80), .O(new_n346_));
  nand4  g179(.a(new_n213_), .b(new_n210_), .c(new_n346_), .d(x79), .O(new_n347_));
  nor3   g180(.a(new_n347_), .b(new_n345_), .c(new_n344_), .O(z55));
  inv1   g181(.a(x02), .O(new_n350_));
  nand4  g182(.a(x03), .b(new_n350_), .c(new_n160_), .d(x00), .O(new_n351_));
  inv1   g183(.a(new_n351_), .O(z57));
  oai21  g184(.a(new_n158_), .b(new_n155_), .c(new_n302_), .O(new_n358_));
  nand2  g185(.a(new_n210_), .b(new_n298_), .O(new_n359_));
  nand3  g186(.a(x82), .b(x79), .c(new_n160_), .O(new_n360_));
  aoi21  g187(.a(new_n359_), .b(new_n358_), .c(new_n360_), .O(z63));
  zero   g188(.O(z00));
  zero   g189(.O(z01));
  zero   g190(.O(z03));
  zero   g191(.O(z04));
