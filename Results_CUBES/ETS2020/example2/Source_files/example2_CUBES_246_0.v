// Benchmark "FAU" written by ABC on Fri Jul 10 18:27:02 2020
...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n283_, new_n285_, new_n287_, new_n289_, new_n293_, new_n301_,
  ...
  inv1   g112(.a(new_n233_), .O(new_n272_));
  ...
  nand2  g119(.a(new_n258_), .b(x42), .O(new_n279_));
  aoi21  g120(.a(new_n279_), .b(new_n278_), .c(new_n238_), .O(new_n280_));
  oai21  g121(.a(new_n280_), .b(new_n277_), .c(new_n268_), .O(new_n281_));
  nor3   g122(.a(new_n281_), .b(new_n272_), .c(new_n271_), .O(z34));
  nand2  g123(.a(new_n233_), .b(x53), .O(new_n283_));
  nor2   g124(.a(new_n283_), .b(new_n281_), .O(z35));
  nand2  g125(.a(new_n233_), .b(x54), .O(new_n285_));
  nor2   g126(.a(new_n285_), .b(new_n281_), .O(z36));
  nand2  g127(.a(new_n233_), .b(x55), .O(new_n287_));
  nor2   g128(.a(new_n287_), .b(new_n281_), .O(z37));
  nand2  g129(.a(new_n233_), .b(x56), .O(new_n289_));
  nor2   g130(.a(new_n289_), .b(new_n281_), .O(z38));
  nor3   g131(.a(new_n281_), .b(new_n272_), .c(new_n186_), .O(z40));
  nand2  g132(.a(new_n233_), .b(x59), .O(new_n293_));
  nor2   g133(.a(new_n293_), .b(new_n281_), .O(z41));
  nor3   g134(.a(new_n281_), .b(new_n272_), .c(new_n179_), .O(z43));
  nor3   g135(.a(new_n281_), .b(new_n272_), .c(new_n176_), .O(z44));
  nor3   g136(.a(new_n281_), .b(new_n272_), .c(new_n173_), .O(z45));
  nor3   g137(.a(new_n281_), .b(new_n272_), .c(new_n170_), .O(z46));
  inv1   g138(.a(x08), .O(new_n301_));
  nand2  g139(.a(x52), .b(x16), .O(new_n302_));
  oai21  g140(.a(x52), .b(new_n301_), .c(new_n302_), .O(new_n303_));
  nand3  g141(.a(new_n225_), .b(new_n154_), .c(new_n159_), .O(new_n304_));
  inv1   g142(.a(new_n304_), .O(new_n305_));
  nand2  g143(.a(new_n305_), .b(new_n303_), .O(new_n306_));
  ...
  nand2  g166(.a(new_n310_), .b(x73), .O(new_n331_));
  aoi21  g167(.a(new_n331_), .b(new_n330_), .c(x01), .O(z53));
  nand2  g168(.a(x52), .b(x22), .O(new_n333_));
  nand2  g169(.a(new_n271_), .b(x14), .O(new_n334_));
  inv1   g170(.a(new_n212_), .O(new_n335_));
  nand4  g171(.a(new_n335_), .b(new_n154_), .c(x04), .d(new_n153_), .O(new_n336_));
  aoi21  g172(.a(new_n334_), .b(new_n333_), .c(new_n336_), .O(z54));
  inv1   g173(.a(x82), .O(new_n338_));
  nand3  g174(.a(new_n258_), .b(x84), .c(new_n338_), .O(new_n339_));
  inv1   g175(.a(x80), .O(new_n340_));
  nand4  g176(.a(new_n233_), .b(new_n161_), .c(new_n340_), .d(x79), .O(new_n341_));
  nor2   g177(.a(new_n341_), .b(new_n339_), .O(z55));
  nand2  g178(.a(new_n160_), .b(new_n159_), .O(new_n343_));
  nand2  g179(.a(new_n231_), .b(x76), .O(new_n344_));
  xnor2a g180(.a(x84), .b(x81), .O(new_n345_));
  aoi21  g181(.a(new_n213_), .b(new_n212_), .c(new_n345_), .O(new_n346_));
  nand2  g182(.a(new_n346_), .b(new_n153_), .O(new_n347_));
  nand2  g183(.a(new_n347_), .b(new_n344_), .O(new_n348_));
  nand2  g184(.a(new_n348_), .b(x79), .O(new_n349_));
  nand4  g185(.a(new_n349_), .b(new_n343_), .c(new_n153_), .d(x00), .O(z56));
  nand4  g186(.a(x80), .b(new_n220_), .c(x43), .d(new_n237_), .O(new_n352_));
  oai22  g187(.a(new_n352_), .b(new_n219_), .c(new_n237_), .d(x40), .O(new_n353_));
  nand3  g188(.a(new_n353_), .b(new_n225_), .c(x79), .O(new_n354_));
  nor2   g189(.a(x79), .b(x78), .O(new_n355_));
  nand3  g190(.a(new_n355_), .b(new_n237_), .c(x40), .O(new_n356_));
  nand2  g191(.a(new_n356_), .b(new_n354_), .O(new_n357_));
  nand2  g192(.a(new_n357_), .b(x77), .O(new_n358_));
  oai21  g193(.a(new_n335_), .b(new_n228_), .c(new_n154_), .O(new_n359_));
  aoi21  g194(.a(new_n359_), .b(new_n358_), .c(x01), .O(z58));
  inv1   g195(.a(new_n355_), .O(new_n361_));
  aoi21  g196(.a(new_n224_), .b(new_n361_), .c(new_n152_), .O(new_n362_));
  oai21  g197(.a(new_n221_), .b(new_n219_), .c(new_n237_), .O(new_n363_));
  aoi21  g198(.a(new_n363_), .b(x79), .c(new_n224_), .O(new_n364_));
  ...
  aoi21  g204(.a(new_n369_), .b(new_n226_), .c(x01), .O(z60));
  nand2  g205(.a(new_n213_), .b(new_n212_), .O(new_n371_));
  aoi22  g206(.a(new_n371_), .b(new_n215_), .c(new_n161_), .d(new_n228_), .O(new_n372_));
  nor2   g207(.a(new_n154_), .b(x01), .O(new_n373_));
  inv1   g208(.a(new_n373_), .O(new_n374_));
  nor3   g209(.a(new_n374_), .b(new_n372_), .c(new_n340_), .O(z61));
  nand3  g210(.a(x84), .b(x81), .c(x79), .O(new_n376_));
  oai21  g211(.a(x79), .b(new_n228_), .c(new_n376_), .O(new_n377_));
  nand2  g212(.a(new_n377_), .b(new_n159_), .O(new_n378_));
  nand2  g213(.a(new_n363_), .b(x79), .O(new_n379_));
  nand3  g214(.a(x81), .b(x79), .c(new_n228_), .O(new_n380_));
  inv1   g215(.a(new_n380_), .O(new_n381_));
  aoi21  g216(.a(new_n379_), .b(x04), .c(new_n381_), .O(new_n382_));
  oai21  g217(.a(new_n382_), .b(new_n159_), .c(new_n378_), .O(new_n383_));
  nand2  g218(.a(new_n383_), .b(x78), .O(new_n384_));
  inv1   g219(.a(new_n376_), .O(new_n385_));
  nand2  g220(.a(new_n385_), .b(new_n307_), .O(new_n386_));
  aoi21  g221(.a(new_n386_), .b(new_n384_), .c(x01), .O(z62));
  nor3   g222(.a(new_n374_), .b(new_n372_), .c(new_n338_), .O(z63));
  nand2  g223(.a(x83), .b(x79), .O(new_n389_));
  or2    g224(.a(new_n389_), .b(new_n372_), .O(new_n390_));
  aoi21  g225(.a(new_n390_), .b(new_n304_), .c(x01), .O(z64));
  nor2   g226(.a(new_n160_), .b(x04), .O(new_n392_));
  nor2   g227(.a(new_n241_), .b(x78), .O(new_n393_));
  oai21  g228(.a(new_n393_), .b(new_n392_), .c(x77), .O(new_n394_));
  nand2  g229(.a(new_n335_), .b(x81), .O(new_n395_));
  nand2  g230(.a(new_n373_), .b(x84), .O(new_n396_));
  aoi21  g231(.a(new_n395_), .b(new_n394_), .c(new_n396_), .O(z65));
  zero   g232(.O(z02));
  zero   g233(.O(z05));
  zero   g234(.O(z11));
  zero   g235(.O(z13));
