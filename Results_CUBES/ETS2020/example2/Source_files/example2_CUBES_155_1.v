// Benchmark "FAU" written by ABC on Fri Jul 10 18:20:40 2020
...
module FAU ( 
  ...
  nand4  g104(.a(new_n250_), .b(new_n240_), .c(x47), .d(new_n243_), .O(new_n259_));
  inv1   g105(.a(new_n259_), .O(z29));
  nand4  g106(.a(new_n250_), .b(new_n240_), .c(x48), .d(new_n243_), .O(new_n261_));
  inv1   g107(.a(new_n261_), .O(z30));
  nand4  g108(.a(new_n250_), .b(new_n240_), .c(x49), .d(new_n243_), .O(new_n263_));
  inv1   g109(.a(new_n263_), .O(z31));
  nor2   g110(.a(new_n223_), .b(x81), .O(new_n266_));
  ...
  nor3   g141(.a(new_n288_), .b(new_n297_), .c(new_n197_), .O(z39));
  nor3   g142(.a(new_n288_), .b(new_n297_), .c(new_n194_), .O(z40));
  nor3   g143(.a(new_n288_), .b(new_n297_), .c(new_n191_), .O(z41));
  nor3   g144(.a(new_n288_), .b(new_n297_), .c(new_n188_), .O(z42));
  nor3   g145(.a(new_n288_), .b(new_n297_), .c(new_n185_), .O(z43));
  ...
  inv1   g152(.a(new_n168_), .O(new_n313_));
  nand2  g153(.a(new_n313_), .b(x79), .O(new_n314_));
  inv1   g154(.a(new_n314_), .O(new_n315_));
  and2   g155(.a(new_n315_), .b(new_n220_), .O(new_n316_));
  ...
  nand2  g161(.a(new_n322_), .b(new_n311_), .O(new_n323_));
  nand2  g162(.a(new_n316_), .b(x70), .O(new_n324_));
  ...
  nand2  g167(.a(new_n329_), .b(new_n311_), .O(new_n330_));
  nand2  g168(.a(new_n316_), .b(x72), .O(new_n331_));
  aoi21  g169(.a(new_n331_), .b(new_n330_), .c(x01), .O(z52));
  inv1   g170(.a(x13), .O(new_n333_));
  nand2  g171(.a(x52), .b(x21), .O(new_n334_));
  oai21  g172(.a(x52), .b(new_n333_), .c(new_n334_), .O(new_n335_));
  nand2  g173(.a(new_n335_), .b(new_n311_), .O(new_n336_));
  nand2  g174(.a(new_n316_), .b(x73), .O(new_n337_));
  aoi21  g175(.a(new_n337_), .b(new_n336_), .c(x01), .O(z53));
  inv1   g176(.a(x14), .O(new_n339_));
  nor2   g177(.a(x52), .b(new_n339_), .O(new_n340_));
  aoi21  g178(.a(x52), .b(x22), .c(new_n340_), .O(new_n341_));
  inv1   g179(.a(new_n167_), .O(new_n342_));
  nand4  g180(.a(new_n342_), .b(new_n154_), .c(x04), .d(new_n153_), .O(new_n343_));
  nor2   g181(.a(new_n343_), .b(new_n341_), .O(z54));
  inv1   g182(.a(x82), .O(new_n345_));
  nand3  g183(.a(new_n266_), .b(x84), .c(new_n345_), .O(new_n346_));
  inv1   g184(.a(x80), .O(new_n347_));
  nand4  g185(.a(new_n240_), .b(new_n161_), .c(new_n347_), .d(x79), .O(new_n348_));
  ...
  nand3  g194(.a(new_n356_), .b(new_n355_), .c(new_n236_), .O(z56));
  inv1   g195(.a(x02), .O(new_n358_));
  nand3  g196(.a(new_n236_), .b(x03), .c(new_n358_), .O(new_n359_));
  inv1   g197(.a(new_n359_), .O(z57));
  nand4  g198(.a(x80), .b(new_n225_), .c(x43), .d(new_n243_), .O(new_n361_));
  oai22  g199(.a(new_n361_), .b(new_n224_), .c(new_n243_), .d(x40), .O(new_n362_));
  nand3  g200(.a(new_n362_), .b(new_n230_), .c(x79), .O(new_n363_));
  nor2   g201(.a(x79), .b(x78), .O(new_n364_));
  nand3  g202(.a(new_n364_), .b(new_n243_), .c(x40), .O(new_n365_));
  nand2  g203(.a(new_n365_), .b(new_n363_), .O(new_n366_));
  nand2  g204(.a(new_n366_), .b(x77), .O(new_n367_));
  oai21  g205(.a(new_n342_), .b(new_n233_), .c(new_n154_), .O(new_n368_));
  aoi21  g206(.a(new_n368_), .b(new_n367_), .c(x01), .O(z58));
  inv1   g207(.a(new_n364_), .O(new_n370_));
  aoi21  g208(.a(new_n229_), .b(new_n370_), .c(new_n152_), .O(new_n371_));
  oai21  g209(.a(new_n226_), .b(new_n224_), .c(new_n243_), .O(new_n372_));
  aoi21  g210(.a(new_n372_), .b(x79), .c(new_n229_), .O(new_n373_));
  ...
  aoi21  g216(.a(new_n378_), .b(new_n231_), .c(x01), .O(z60));
  inv1   g217(.a(new_n170_), .O(new_n380_));
  nand2  g218(.a(new_n168_), .b(new_n167_), .O(new_n381_));
  aoi22  g219(.a(new_n381_), .b(new_n220_), .c(new_n161_), .d(new_n233_), .O(new_n382_));
  nor3   g220(.a(new_n382_), .b(new_n380_), .c(new_n347_), .O(z61));
  nand3  g221(.a(x84), .b(x81), .c(x79), .O(new_n384_));
  oai21  g222(.a(x79), .b(new_n233_), .c(new_n384_), .O(new_n385_));
  nand2  g223(.a(new_n385_), .b(new_n159_), .O(new_n386_));
  nand2  g224(.a(new_n372_), .b(x79), .O(new_n387_));
  nand3  g225(.a(x81), .b(x79), .c(new_n233_), .O(new_n388_));
  ...
  nand2  g231(.a(new_n393_), .b(new_n313_), .O(new_n394_));
  aoi21  g232(.a(new_n394_), .b(new_n392_), .c(x01), .O(z62));
  nor3   g233(.a(new_n382_), .b(new_n380_), .c(new_n345_), .O(z63));
  nand2  g234(.a(x83), .b(x79), .O(new_n397_));
  or2    g235(.a(new_n397_), .b(new_n382_), .O(new_n398_));
  aoi21  g236(.a(new_n398_), .b(new_n310_), .c(x01), .O(z64));
  nor2   g237(.a(new_n160_), .b(x04), .O(new_n400_));
  nor2   g238(.a(new_n247_), .b(x78), .O(new_n401_));
  oai21  g239(.a(new_n401_), .b(new_n400_), .c(x77), .O(new_n402_));
  nand2  g240(.a(new_n342_), .b(x81), .O(new_n403_));
  nand2  g241(.a(new_n170_), .b(x84), .O(new_n404_));
  aoi21  g242(.a(new_n403_), .b(new_n402_), .c(new_n404_), .O(z65));
  zero   g243(.O(z07));
  zero   g244(.O(z14));
  zero   g245(.O(z19));
  zero   g246(.O(z32));
