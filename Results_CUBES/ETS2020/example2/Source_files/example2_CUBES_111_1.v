// Benchmark "FAU" written by ABC on Fri Jul 10 18:17:36 2020
...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n256_, new_n262_, new_n263_, new_n264_, new_n265_, new_n266_,
    new_n267_, new_n268_, new_n269_, new_n270_, new_n271_, new_n272_,
    new_n274_, new_n276_, new_n285_, new_n286_, new_n287_, new_n288_,
  ...
  nor2   g099(.a(new_n218_), .b(new_n236_), .O(new_n263_));
  inv1   g100(.a(new_n263_), .O(new_n264_));
  nand2  g101(.a(new_n264_), .b(new_n237_), .O(new_n265_));
  nand2  g102(.a(new_n263_), .b(x81), .O(new_n266_));
  aoi21  g103(.a(new_n266_), .b(new_n265_), .c(new_n240_), .O(new_n267_));
  nand2  g104(.a(new_n264_), .b(x81), .O(new_n268_));
  nand2  g105(.a(new_n263_), .b(new_n237_), .O(new_n269_));
  aoi21  g106(.a(new_n269_), .b(new_n268_), .c(new_n238_), .O(new_n270_));
  oai21  g107(.a(new_n270_), .b(new_n267_), .c(new_n262_), .O(new_n271_));
  nand2  g108(.a(new_n233_), .b(x55), .O(new_n272_));
  nor2   g109(.a(new_n272_), .b(new_n271_), .O(z37));
  nand2  g110(.a(new_n233_), .b(x56), .O(new_n274_));
  nor2   g111(.a(new_n274_), .b(new_n271_), .O(z38));
  inv1   g112(.a(new_n233_), .O(new_n276_));
  nor3   g113(.a(new_n271_), .b(new_n276_), .c(new_n198_), .O(z39));
  nor3   g114(.a(new_n271_), .b(new_n276_), .c(new_n195_), .O(z40));
  nor3   g115(.a(new_n271_), .b(new_n276_), .c(new_n192_), .O(z41));
  nor3   g116(.a(new_n271_), .b(new_n276_), .c(new_n183_), .O(z44));
  nor3   g117(.a(new_n271_), .b(new_n276_), .c(new_n180_), .O(z45));
  nor3   g118(.a(new_n271_), .b(new_n276_), .c(new_n177_), .O(z46));
  ...
  nand2  g123(.a(new_n288_), .b(new_n225_), .O(new_n289_));
  inv1   g124(.a(new_n289_), .O(new_n290_));
  nand2  g125(.a(new_n290_), .b(new_n287_), .O(new_n291_));
  nor2   g126(.a(x75), .b(x67), .O(new_n292_));
  nand2  g127(.a(new_n168_), .b(x79), .O(new_n293_));
  nor2   g128(.a(new_n293_), .b(new_n292_), .O(new_n294_));
  nand2  g129(.a(new_n294_), .b(new_n215_), .O(new_n295_));
  aoi21  g130(.a(new_n295_), .b(new_n291_), .c(x01), .O(z47));
  inv1   g131(.a(x08), .O(new_n297_));
  nand2  g132(.a(x52), .b(x16), .O(new_n298_));
  oai21  g133(.a(x52), .b(new_n297_), .c(new_n298_), .O(new_n299_));
  nand2  g134(.a(new_n299_), .b(new_n290_), .O(new_n300_));
  inv1   g135(.a(new_n215_), .O(new_n301_));
  nor2   g136(.a(new_n293_), .b(new_n301_), .O(new_n302_));
  nand2  g137(.a(new_n302_), .b(x68), .O(new_n303_));
  aoi21  g138(.a(new_n303_), .b(new_n300_), .c(x01), .O(z48));
  inv1   g139(.a(x09), .O(new_n305_));
  nand2  g140(.a(x52), .b(x17), .O(new_n306_));
  oai21  g141(.a(x52), .b(new_n305_), .c(new_n306_), .O(new_n307_));
  nand2  g142(.a(new_n307_), .b(new_n290_), .O(new_n308_));
  nand2  g143(.a(new_n302_), .b(x69), .O(new_n309_));
  ...
  nand2  g148(.a(new_n313_), .b(new_n290_), .O(new_n314_));
  nand2  g149(.a(new_n302_), .b(x70), .O(new_n315_));
  ...
  nand2  g154(.a(new_n319_), .b(new_n290_), .O(new_n320_));
  nand2  g155(.a(new_n302_), .b(x71), .O(new_n321_));
  ...
  nand2  g160(.a(new_n326_), .b(new_n290_), .O(new_n327_));
  nand2  g161(.a(new_n302_), .b(x73), .O(new_n328_));
  ...
  nand4  g166(.a(new_n166_), .b(new_n154_), .c(x04), .d(new_n153_), .O(new_n333_));
  nor2   g167(.a(new_n333_), .b(new_n332_), .O(z54));
  nand2  g168(.a(x84), .b(x83), .O(new_n335_));
  nor2   g169(.a(x80), .b(new_n154_), .O(new_n336_));
  nand3  g170(.a(new_n336_), .b(new_n233_), .c(new_n161_), .O(new_n337_));
  nor4   g171(.a(new_n337_), .b(new_n335_), .c(x82), .d(x81), .O(z55));
  nand2  g172(.a(new_n160_), .b(new_n159_), .O(new_n339_));
  nand2  g173(.a(new_n231_), .b(x76), .O(new_n340_));
  inv1   g174(.a(new_n168_), .O(new_n341_));
  xnor2a g175(.a(x84), .b(x81), .O(new_n342_));
  aoi21  g176(.a(new_n341_), .b(new_n167_), .c(new_n342_), .O(new_n343_));
  nand2  g177(.a(new_n343_), .b(new_n153_), .O(new_n344_));
  nand2  g178(.a(new_n344_), .b(new_n340_), .O(new_n345_));
  nand2  g179(.a(new_n345_), .b(x79), .O(new_n346_));
  nand4  g180(.a(new_n346_), .b(new_n339_), .c(new_n153_), .d(x00), .O(z56));
  nand4  g181(.a(x80), .b(new_n220_), .c(x43), .d(new_n236_), .O(new_n349_));
  oai22  g182(.a(new_n349_), .b(new_n219_), .c(new_n236_), .d(x40), .O(new_n350_));
  nand3  g183(.a(new_n350_), .b(new_n225_), .c(x79), .O(new_n351_));
  nor2   g184(.a(x79), .b(x78), .O(new_n352_));
  nand3  g185(.a(new_n352_), .b(new_n236_), .c(x40), .O(new_n353_));
  nand2  g186(.a(new_n353_), .b(new_n351_), .O(new_n354_));
  nand2  g187(.a(new_n354_), .b(x77), .O(new_n355_));
  oai21  g188(.a(new_n166_), .b(new_n228_), .c(new_n154_), .O(new_n356_));
  aoi21  g189(.a(new_n356_), .b(new_n355_), .c(x01), .O(z58));
  inv1   g190(.a(new_n352_), .O(new_n358_));
  aoi21  g191(.a(new_n224_), .b(new_n358_), .c(new_n152_), .O(new_n359_));
  oai21  g192(.a(new_n221_), .b(new_n219_), .c(new_n236_), .O(new_n360_));
  aoi21  g193(.a(new_n360_), .b(x79), .c(new_n224_), .O(new_n361_));
  ...
  aoi21  g199(.a(new_n366_), .b(new_n226_), .c(x01), .O(z60));
  ...
  nand2  g203(.a(new_n360_), .b(x79), .O(new_n372_));
  ...
  nand2  g210(.a(new_n378_), .b(new_n168_), .O(new_n379_));
  aoi21  g211(.a(new_n379_), .b(new_n377_), .c(x01), .O(z62));
  oai21  g212(.a(new_n168_), .b(new_n166_), .c(new_n215_), .O(new_n381_));
  oai21  g213(.a(new_n231_), .b(x04), .c(new_n381_), .O(new_n382_));
  nand2  g214(.a(new_n171_), .b(x82), .O(new_n383_));
  inv1   g215(.a(new_n383_), .O(new_n384_));
  and2   g216(.a(new_n384_), .b(new_n382_), .O(z63));
  nand3  g217(.a(new_n382_), .b(x83), .c(x79), .O(new_n386_));
  aoi21  g218(.a(new_n386_), .b(new_n289_), .c(x01), .O(z64));
  nor2   g219(.a(new_n160_), .b(x04), .O(new_n388_));
  nor2   g220(.a(new_n237_), .b(x78), .O(new_n389_));
  oai21  g221(.a(new_n389_), .b(new_n388_), .c(x77), .O(new_n390_));
  nand2  g222(.a(new_n166_), .b(x81), .O(new_n391_));
  nand2  g223(.a(new_n171_), .b(x84), .O(new_n392_));
