// Benchmark "FAU" written by ABC on Fri Jul 10 18:25:09 2020
...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n289_, new_n291_, new_n293_, new_n297_, new_n306_, new_n307_,
  ...
  inv1   g138(.a(new_n239_), .O(new_n297_));
  nor3   g139(.a(new_n286_), .b(new_n297_), .c(new_n188_), .O(z40));
  nor3   g140(.a(new_n286_), .b(new_n297_), .c(new_n185_), .O(z41));
  nor3   g141(.a(new_n286_), .b(new_n297_), .c(new_n182_), .O(z42));
  nor3   g142(.a(new_n286_), .b(new_n297_), .c(new_n179_), .O(z43));
  nor3   g143(.a(new_n286_), .b(new_n297_), .c(new_n176_), .O(z44));
  nor3   g144(.a(new_n286_), .b(new_n297_), .c(new_n170_), .O(z46));
  inv1   g145(.a(x08), .O(new_n306_));
  nand2  g146(.a(x52), .b(x16), .O(new_n307_));
  oai21  g147(.a(x52), .b(new_n306_), .c(new_n307_), .O(new_n308_));
  nand3  g148(.a(new_n229_), .b(new_n154_), .c(new_n159_), .O(new_n309_));
  inv1   g149(.a(new_n309_), .O(new_n310_));
  nand2  g150(.a(new_n310_), .b(new_n308_), .O(new_n311_));
  inv1   g151(.a(new_n217_), .O(new_n312_));
  nand2  g152(.a(new_n312_), .b(x79), .O(new_n313_));
  inv1   g153(.a(new_n313_), .O(new_n314_));
  and2   g154(.a(new_n314_), .b(new_n219_), .O(new_n315_));
  ...
  inv1   g163(.a(x13), .O(new_n327_));
  nand2  g164(.a(x52), .b(x21), .O(new_n328_));
  oai21  g165(.a(x52), .b(new_n327_), .c(new_n328_), .O(new_n329_));
  nand2  g166(.a(new_n329_), .b(new_n310_), .O(new_n330_));
  nand2  g167(.a(new_n315_), .b(x73), .O(new_n331_));
  aoi21  g168(.a(new_n331_), .b(new_n330_), .c(x01), .O(z53));
  inv1   g169(.a(x82), .O(new_n334_));
  nand3  g170(.a(new_n265_), .b(x84), .c(new_n334_), .O(new_n335_));
  inv1   g171(.a(x80), .O(new_n336_));
  nand4  g172(.a(new_n239_), .b(new_n161_), .c(new_n336_), .d(x79), .O(new_n337_));
  nor2   g173(.a(new_n337_), .b(new_n335_), .O(z55));
  nand2  g174(.a(new_n237_), .b(x76), .O(new_n339_));
  ...
  nand3  g180(.a(new_n160_), .b(new_n159_), .c(new_n153_), .O(new_n345_));
  nand3  g181(.a(new_n345_), .b(new_n344_), .c(new_n235_), .O(z56));
  inv1   g182(.a(x02), .O(new_n347_));
  nand3  g183(.a(new_n235_), .b(x03), .c(new_n347_), .O(new_n348_));
  inv1   g184(.a(new_n348_), .O(z57));
  nand4  g185(.a(x80), .b(new_n224_), .c(x43), .d(new_n242_), .O(new_n350_));
  oai22  g186(.a(new_n350_), .b(new_n223_), .c(new_n242_), .d(x40), .O(new_n351_));
  nand3  g187(.a(new_n351_), .b(new_n229_), .c(x79), .O(new_n352_));
  nor2   g188(.a(x79), .b(x78), .O(new_n353_));
  nand3  g189(.a(new_n353_), .b(new_n242_), .c(x40), .O(new_n354_));
  nand2  g190(.a(new_n354_), .b(new_n352_), .O(new_n355_));
  nand2  g191(.a(new_n355_), .b(x77), .O(new_n356_));
  inv1   g192(.a(new_n216_), .O(new_n357_));
  oai21  g193(.a(new_n357_), .b(new_n232_), .c(new_n154_), .O(new_n358_));
  aoi21  g194(.a(new_n358_), .b(new_n356_), .c(x01), .O(z58));
  inv1   g195(.a(new_n353_), .O(new_n360_));
  aoi21  g196(.a(new_n228_), .b(new_n360_), .c(new_n152_), .O(new_n361_));
  oai21  g197(.a(new_n225_), .b(new_n223_), .c(new_n242_), .O(new_n362_));
  aoi21  g198(.a(new_n362_), .b(x79), .c(new_n228_), .O(new_n363_));
  ...
  aoi21  g203(.a(new_n341_), .b(x79), .c(new_n365_), .O(new_n368_));
  aoi21  g204(.a(new_n368_), .b(new_n230_), .c(x01), .O(z60));
  nand2  g205(.a(new_n217_), .b(new_n216_), .O(new_n370_));
  aoi22  g206(.a(new_n370_), .b(new_n219_), .c(new_n161_), .d(new_n232_), .O(new_n371_));
  nor2   g207(.a(new_n154_), .b(x01), .O(new_n372_));
  inv1   g208(.a(new_n372_), .O(new_n373_));
  nor3   g209(.a(new_n373_), .b(new_n371_), .c(new_n336_), .O(z61));
  nand3  g210(.a(x84), .b(x81), .c(x79), .O(new_n375_));
  oai21  g211(.a(x79), .b(new_n232_), .c(new_n375_), .O(new_n376_));
  nand2  g212(.a(new_n376_), .b(new_n159_), .O(new_n377_));
  nand2  g213(.a(new_n362_), .b(x79), .O(new_n378_));
  nand3  g214(.a(x81), .b(x79), .c(new_n232_), .O(new_n379_));
  ...
  nand2  g220(.a(new_n384_), .b(new_n312_), .O(new_n385_));
  aoi21  g221(.a(new_n385_), .b(new_n383_), .c(x01), .O(z62));
  nor3   g222(.a(new_n373_), .b(new_n371_), .c(new_n334_), .O(z63));
  nand2  g223(.a(x83), .b(x79), .O(new_n388_));
  or2    g224(.a(new_n388_), .b(new_n371_), .O(new_n389_));
  aoi21  g225(.a(new_n389_), .b(new_n309_), .c(x01), .O(z64));
  nor2   g226(.a(new_n160_), .b(x04), .O(new_n391_));
  nor2   g227(.a(new_n246_), .b(x78), .O(new_n392_));
  oai21  g228(.a(new_n392_), .b(new_n391_), .c(x77), .O(new_n393_));
  nand2  g229(.a(new_n357_), .b(x81), .O(new_n394_));
  nand2  g230(.a(new_n372_), .b(x84), .O(new_n395_));
  aoi21  g231(.a(new_n394_), .b(new_n393_), .c(new_n395_), .O(z65));
  zero   g232(.O(z02));
  zero   g233(.O(z05));
  zero   g234(.O(z17));
  zero   g235(.O(z21));
