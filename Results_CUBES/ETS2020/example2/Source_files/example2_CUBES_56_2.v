...
module FAU ( 
  ...
  wire new_n154_, new_n155_, new_n156_, new_n157_, new_n158_, new_n159_,
    ...
    new_n173_, new_n174_, new_n178_, new_n179_, new_n182_, new_n183_,
  ...
  nand3  g059(.a(new_n217_), .b(x44), .c(new_n216_), .O(new_n222_));
  inv1   g060(.a(new_n222_), .O(new_n223_));
  nand3  g061(.a(new_n223_), .b(new_n215_), .c(new_n213_), .O(new_n224_));
  inv1   g062(.a(new_n224_), .O(z26));
  nand3  g063(.a(new_n217_), .b(x45), .c(new_n216_), .O(new_n226_));
  inv1   g064(.a(new_n226_), .O(new_n227_));
  nand3  g065(.a(new_n227_), .b(new_n215_), .c(new_n213_), .O(new_n228_));
  inv1   g066(.a(new_n228_), .O(z27));
  nand3  g067(.a(new_n217_), .b(x46), .c(new_n216_), .O(new_n230_));
  inv1   g068(.a(new_n230_), .O(new_n231_));
  nand3  g069(.a(new_n231_), .b(new_n215_), .c(new_n213_), .O(new_n232_));
  inv1   g070(.a(new_n232_), .O(z28));
  nand3  g071(.a(new_n217_), .b(x47), .c(new_n216_), .O(new_n234_));
  inv1   g072(.a(new_n234_), .O(new_n235_));
  nand3  g073(.a(new_n235_), .b(new_n215_), .c(new_n213_), .O(new_n236_));
  inv1   g074(.a(new_n236_), .O(z29));
  nand3  g075(.a(new_n217_), .b(x49), .c(new_n216_), .O(new_n239_));
  inv1   g076(.a(new_n239_), .O(new_n240_));
  nand3  g077(.a(new_n240_), .b(new_n215_), .c(new_n213_), .O(new_n241_));
  inv1   g078(.a(new_n241_), .O(z31));
  inv1   g079(.a(new_n210_), .O(new_n244_));
  xnor2a g080(.a(x83), .b(x81), .O(new_n245_));
  nand2  g081(.a(x42), .b(x05), .O(new_n246_));
  nand2  g082(.a(x51), .b(new_n216_), .O(new_n247_));
  oai22  g083(.a(new_n247_), .b(new_n209_), .c(new_n246_), .d(new_n245_), .O(new_n248_));
  ...
  nand2  g087(.a(new_n251_), .b(new_n211_), .O(new_n252_));
  nand2  g088(.a(new_n217_), .b(new_n215_), .O(new_n253_));
  ...
  nand2  g092(.a(new_n256_), .b(new_n209_), .O(new_n257_));
  ...
  nand3  g096(.a(x83), .b(new_n209_), .c(x42), .O(new_n261_));
  aoi21  g097(.a(new_n261_), .b(new_n260_), .c(new_n210_), .O(new_n262_));
  oai21  g098(.a(new_n262_), .b(new_n259_), .c(new_n215_), .O(new_n263_));
  nand2  g099(.a(new_n217_), .b(x52), .O(new_n264_));
  nor2   g100(.a(new_n264_), .b(new_n263_), .O(z34));
  nand2  g101(.a(new_n217_), .b(x53), .O(new_n266_));
  nor2   g102(.a(new_n266_), .b(new_n263_), .O(z35));
  nand2  g103(.a(new_n217_), .b(x54), .O(new_n268_));
  nor2   g104(.a(new_n268_), .b(new_n263_), .O(z36));
  nand2  g105(.a(new_n217_), .b(x55), .O(new_n270_));
  nor2   g106(.a(new_n270_), .b(new_n263_), .O(z37));
  nand2  g107(.a(new_n217_), .b(x56), .O(new_n272_));
  nor2   g108(.a(new_n272_), .b(new_n263_), .O(z38));
  nand2  g109(.a(new_n217_), .b(x57), .O(new_n274_));
  nor2   g110(.a(new_n274_), .b(new_n263_), .O(z39));
  nand2  g111(.a(new_n217_), .b(x58), .O(new_n276_));
  nor2   g112(.a(new_n276_), .b(new_n263_), .O(z40));
  nand2  g113(.a(new_n217_), .b(x59), .O(new_n278_));
  nor2   g114(.a(new_n278_), .b(new_n263_), .O(z41));
  nand2  g115(.a(new_n217_), .b(x60), .O(new_n280_));
  nor2   g116(.a(new_n280_), .b(new_n263_), .O(z42));
  nand2  g117(.a(new_n217_), .b(x61), .O(new_n282_));
  nor2   g118(.a(new_n282_), .b(new_n263_), .O(z43));
  nand2  g119(.a(new_n217_), .b(x62), .O(new_n284_));
  nor2   g120(.a(new_n284_), .b(new_n263_), .O(z44));
  nand2  g121(.a(new_n217_), .b(x63), .O(new_n286_));
  nor2   g122(.a(new_n286_), .b(new_n263_), .O(z45));
  nand2  g123(.a(new_n217_), .b(x64), .O(new_n288_));
  nor2   g124(.a(new_n288_), .b(new_n263_), .O(z46));
  inv1   g125(.a(x07), .O(new_n290_));
  nand2  g126(.a(x52), .b(x15), .O(new_n291_));
  oai21  g127(.a(x52), .b(new_n290_), .c(new_n291_), .O(new_n292_));
  inv1   g128(.a(x79), .O(new_n293_));
  nand4  g129(.a(new_n293_), .b(x78), .c(new_n154_), .d(x04), .O(new_n294_));
  inv1   g130(.a(new_n294_), .O(new_n295_));
  nand2  g131(.a(new_n295_), .b(new_n292_), .O(new_n296_));
  xor2a  g132(.a(x84), .b(x81), .O(new_n297_));
  inv1   g133(.a(new_n297_), .O(new_n298_));
  or2    g134(.a(x75), .b(x67), .O(new_n299_));
  nand3  g135(.a(x79), .b(new_n156_), .c(x77), .O(new_n300_));
  inv1   g136(.a(new_n300_), .O(new_n301_));
  nand3  g137(.a(new_n301_), .b(new_n299_), .c(new_n298_), .O(new_n302_));
  aoi21  g138(.a(new_n302_), .b(new_n296_), .c(x01), .O(z47));
  inv1   g139(.a(x09), .O(new_n305_));
  nand2  g140(.a(x52), .b(x17), .O(new_n306_));
  oai21  g141(.a(x52), .b(new_n305_), .c(new_n306_), .O(new_n307_));
  nand2  g142(.a(new_n307_), .b(new_n295_), .O(new_n308_));
  nor2   g143(.a(new_n300_), .b(new_n297_), .O(new_n309_));
  nand2  g144(.a(new_n309_), .b(x69), .O(new_n310_));
  aoi21  g145(.a(new_n310_), .b(new_n308_), .c(x01), .O(z49));
  inv1   g146(.a(x12), .O(new_n314_));
  nand2  g147(.a(x52), .b(x20), .O(new_n315_));
  oai21  g148(.a(x52), .b(new_n314_), .c(new_n315_), .O(new_n316_));
  nand2  g149(.a(new_n316_), .b(new_n295_), .O(new_n317_));
  nand2  g150(.a(new_n309_), .b(x72), .O(new_n318_));
  ...
  nand2  g155(.a(new_n322_), .b(new_n295_), .O(new_n323_));
  nand2  g156(.a(new_n309_), .b(x73), .O(new_n324_));
  aoi21  g157(.a(new_n324_), .b(new_n323_), .c(x01), .O(z53));
  inv1   g158(.a(x02), .O(new_n329_));
  nand4  g159(.a(x03), .b(new_n329_), .c(new_n158_), .d(x00), .O(new_n330_));
