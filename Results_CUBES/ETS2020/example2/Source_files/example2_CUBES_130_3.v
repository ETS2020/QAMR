// Benchmark "FAU" written by ABC on Fri Jul 10 18:18:56 2020
...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n300_, new_n301_, new_n302_, new_n304_, new_n307_, new_n309_,
  ...
  nand4  g114(.a(new_n263_), .b(new_n252_), .c(x44), .d(new_n255_), .O(new_n266_));
  inv1   g115(.a(new_n266_), .O(z26));
  nand4  g116(.a(new_n263_), .b(new_n252_), .c(x45), .d(new_n255_), .O(new_n268_));
  inv1   g117(.a(new_n268_), .O(z27));
  nand4  g118(.a(new_n263_), .b(new_n252_), .c(x46), .d(new_n255_), .O(new_n270_));
  ...
  nand2  g153(.a(new_n252_), .b(x55), .O(new_n307_));
  nor2   g154(.a(new_n307_), .b(new_n302_), .O(z37));
  nand2  g155(.a(new_n252_), .b(x56), .O(new_n309_));
  nor2   g156(.a(new_n309_), .b(new_n302_), .O(z38));
  nor3   g157(.a(new_n302_), .b(new_n293_), .c(new_n207_), .O(z39));
  nor3   g158(.a(new_n302_), .b(new_n293_), .c(new_n201_), .O(z41));
  nor3   g159(.a(new_n302_), .b(new_n293_), .c(new_n198_), .O(z42));
  nor3   g160(.a(new_n302_), .b(new_n293_), .c(new_n195_), .O(z43));
  nor3   g161(.a(new_n302_), .b(new_n293_), .c(new_n192_), .O(z44));
  nor3   g162(.a(new_n302_), .b(new_n293_), .c(new_n189_), .O(z45));
  inv1   g163(.a(x07), .O(new_n319_));
  nand2  g164(.a(x52), .b(x15), .O(new_n320_));
  oai21  g165(.a(x52), .b(new_n319_), .c(new_n320_), .O(new_n321_));
  nand3  g166(.a(new_n237_), .b(new_n154_), .c(new_n159_), .O(new_n322_));
  inv1   g167(.a(new_n322_), .O(new_n323_));
  nand2  g168(.a(new_n323_), .b(new_n321_), .O(new_n324_));
  nor2   g169(.a(x75), .b(x67), .O(new_n325_));
  nand2  g170(.a(new_n171_), .b(x79), .O(new_n326_));
  nor2   g171(.a(new_n326_), .b(new_n325_), .O(new_n327_));
  nand2  g172(.a(new_n327_), .b(new_n234_), .O(new_n328_));
  aoi21  g173(.a(new_n328_), .b(new_n324_), .c(x01), .O(z47));
  inv1   g174(.a(x09), .O(new_n331_));
  nand2  g175(.a(x52), .b(x17), .O(new_n332_));
  oai21  g176(.a(x52), .b(new_n331_), .c(new_n332_), .O(new_n333_));
  nand2  g177(.a(new_n333_), .b(new_n323_), .O(new_n334_));
  inv1   g178(.a(new_n234_), .O(new_n335_));
  nor2   g179(.a(new_n326_), .b(new_n335_), .O(new_n336_));
  nand2  g180(.a(new_n336_), .b(x69), .O(new_n337_));
  aoi21  g181(.a(new_n337_), .b(new_n334_), .c(x01), .O(z49));
  inv1   g182(.a(x11), .O(new_n340_));
  nand2  g183(.a(x52), .b(x19), .O(new_n341_));
  oai21  g184(.a(x52), .b(new_n340_), .c(new_n341_), .O(new_n342_));
  nand2  g185(.a(new_n342_), .b(new_n323_), .O(new_n343_));
  nand2  g186(.a(new_n336_), .b(x71), .O(new_n344_));
  aoi21  g187(.a(new_n344_), .b(new_n343_), .c(x01), .O(z51));
  inv1   g188(.a(x12), .O(new_n346_));
  nand2  g189(.a(x52), .b(x20), .O(new_n347_));
  oai21  g190(.a(x52), .b(new_n346_), .c(new_n347_), .O(new_n348_));
  nand2  g191(.a(new_n348_), .b(new_n323_), .O(new_n349_));
  nand2  g192(.a(new_n336_), .b(x72), .O(new_n350_));
  aoi21  g193(.a(new_n350_), .b(new_n349_), .c(x01), .O(z52));
  inv1   g194(.a(x13), .O(new_n352_));
  nand2  g195(.a(x52), .b(x21), .O(new_n353_));
  oai21  g196(.a(x52), .b(new_n352_), .c(new_n353_), .O(new_n354_));
  nand2  g197(.a(new_n354_), .b(new_n323_), .O(new_n355_));
  nand2  g198(.a(new_n336_), .b(x73), .O(new_n356_));
  aoi21  g199(.a(new_n356_), .b(new_n355_), .c(x01), .O(z53));
  nand2  g200(.a(x52), .b(x22), .O(new_n358_));
  nand2  g201(.a(new_n292_), .b(x14), .O(new_n359_));
  nand4  g202(.a(new_n169_), .b(new_n154_), .c(x04), .d(new_n153_), .O(new_n360_));
  aoi21  g203(.a(new_n359_), .b(new_n358_), .c(new_n360_), .O(z54));
  inv1   g204(.a(x84), .O(new_n362_));
  inv1   g205(.a(new_n279_), .O(new_n363_));
  nor2   g206(.a(x80), .b(new_n154_), .O(new_n364_));
  nand3  g207(.a(new_n364_), .b(new_n252_), .c(new_n165_), .O(new_n365_));
  nor4   g208(.a(new_n365_), .b(new_n363_), .c(new_n362_), .d(x82), .O(z55));
  nand2  g209(.a(new_n250_), .b(x76), .O(new_n367_));
  inv1   g210(.a(new_n171_), .O(new_n368_));
  xnor2a g211(.a(x84), .b(x81), .O(new_n369_));
  aoi21  g212(.a(new_n368_), .b(new_n170_), .c(new_n369_), .O(new_n370_));
  nand2  g213(.a(new_n370_), .b(new_n153_), .O(new_n371_));
  nand2  g214(.a(new_n371_), .b(new_n367_), .O(new_n372_));
  nand2  g215(.a(new_n372_), .b(x79), .O(new_n373_));
  nor2   g216(.a(x77), .b(x01), .O(new_n374_));
  aoi21  g217(.a(new_n374_), .b(new_n164_), .c(new_n247_), .O(new_n375_));
  nand2  g218(.a(new_n375_), .b(new_n373_), .O(z56));
  inv1   g219(.a(x02), .O(new_n377_));
  nand3  g220(.a(new_n248_), .b(x03), .c(new_n377_), .O(new_n378_));
  inv1   g221(.a(new_n378_), .O(z57));
  nand4  g222(.a(x80), .b(new_n240_), .c(x43), .d(new_n255_), .O(new_n380_));
  oai22  g223(.a(new_n380_), .b(new_n239_), .c(new_n255_), .d(x40), .O(new_n381_));
  nand3  g224(.a(new_n381_), .b(new_n237_), .c(x79), .O(new_n382_));
  nand3  g225(.a(new_n179_), .b(new_n255_), .c(x40), .O(new_n383_));
  nand2  g226(.a(new_n383_), .b(new_n382_), .O(new_n384_));
  nand2  g227(.a(new_n384_), .b(x77), .O(new_n385_));
  oai21  g228(.a(new_n169_), .b(new_n160_), .c(new_n154_), .O(new_n386_));
  aoi21  g229(.a(new_n386_), .b(new_n385_), .c(x01), .O(z58));
  aoi21  g230(.a(new_n163_), .b(new_n180_), .c(new_n152_), .O(new_n388_));
  oai21  g231(.a(new_n241_), .b(new_n239_), .c(new_n255_), .O(new_n389_));
  ...
  aoi21  g237(.a(new_n370_), .b(x79), .c(new_n392_), .O(new_n395_));
  aoi21  g238(.a(new_n395_), .b(new_n244_), .c(x01), .O(z60));
  oai21  g239(.a(new_n171_), .b(new_n169_), .c(new_n234_), .O(new_n397_));
  oai21  g240(.a(new_n250_), .b(x04), .c(new_n397_), .O(new_n398_));
  nand2  g241(.a(new_n174_), .b(x80), .O(new_n399_));
  inv1   g242(.a(new_n399_), .O(new_n400_));
  and2   g243(.a(new_n400_), .b(new_n398_), .O(z61));
  ...
  nand2  g247(.a(new_n389_), .b(x79), .O(new_n405_));
  ...
  nand2  g254(.a(new_n411_), .b(new_n171_), .O(new_n412_));
  aoi21  g255(.a(new_n412_), .b(new_n410_), .c(x01), .O(z62));
  nand3  g256(.a(new_n398_), .b(x83), .c(x79), .O(new_n415_));
  nand3  g257(.a(new_n176_), .b(new_n159_), .c(x04), .O(new_n416_));
  aoi21  g258(.a(new_n416_), .b(new_n415_), .c(x01), .O(z64));
  nor2   g259(.a(new_n164_), .b(x04), .O(new_n418_));
  nor2   g260(.a(new_n259_), .b(x78), .O(new_n419_));
  oai21  g261(.a(new_n419_), .b(new_n418_), .c(x77), .O(new_n420_));
  nand2  g262(.a(new_n169_), .b(x81), .O(new_n421_));
  nand2  g263(.a(new_n174_), .b(x84), .O(new_n422_));
