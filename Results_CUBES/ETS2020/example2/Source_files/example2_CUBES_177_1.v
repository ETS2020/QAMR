...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n282_, new_n285_, new_n287_, new_n289_, new_n291_, new_n299_,
    new_n301_, new_n302_, new_n303_, new_n304_, new_n305_, new_n306_,
    new_n307_, new_n308_, new_n309_, new_n310_, new_n311_, new_n312_,
    new_n314_, new_n315_, new_n316_, new_n317_, new_n318_, new_n319_,
    new_n320_, new_n322_, new_n323_, new_n324_, new_n325_, new_n326_,
    new_n328_, new_n329_, new_n330_, new_n331_, new_n332_, new_n334_,
    new_n335_, new_n336_, new_n337_, new_n338_, new_n343_, new_n344_,
  ...
  nand2  g125(.a(new_n234_), .b(x54), .O(new_n285_));
  nor2   g126(.a(new_n285_), .b(new_n281_), .O(z36));
  nand2  g127(.a(new_n234_), .b(x55), .O(new_n287_));
  ...
  nor3   g132(.a(new_n281_), .b(new_n291_), .c(new_n195_), .O(z39));
  nor3   g133(.a(new_n281_), .b(new_n291_), .c(new_n192_), .O(z40));
  nor3   g134(.a(new_n281_), .b(new_n291_), .c(new_n189_), .O(z41));
  nor3   g135(.a(new_n281_), .b(new_n291_), .c(new_n186_), .O(z42));
  nor3   g136(.a(new_n281_), .b(new_n291_), .c(new_n183_), .O(z43));
  nor3   g137(.a(new_n281_), .b(new_n291_), .c(new_n180_), .O(z44));
  nand2  g138(.a(new_n234_), .b(x64), .O(new_n299_));
  nor2   g139(.a(new_n299_), .b(new_n281_), .O(z46));
  inv1   g140(.a(x07), .O(new_n301_));
  nand2  g141(.a(x52), .b(x15), .O(new_n302_));
  oai21  g142(.a(x52), .b(new_n301_), .c(new_n302_), .O(new_n303_));
  nor2   g143(.a(x79), .b(x77), .O(new_n304_));
  nand2  g144(.a(new_n304_), .b(new_n224_), .O(new_n305_));
  inv1   g145(.a(new_n305_), .O(new_n306_));
  nand2  g146(.a(new_n306_), .b(new_n303_), .O(new_n307_));
  nor2   g147(.a(x75), .b(x67), .O(new_n308_));
  inv1   g148(.a(new_n168_), .O(new_n309_));
  nand2  g149(.a(new_n309_), .b(x79), .O(new_n310_));
  nor2   g150(.a(new_n310_), .b(new_n308_), .O(new_n311_));
  nand2  g151(.a(new_n311_), .b(new_n214_), .O(new_n312_));
  aoi21  g152(.a(new_n312_), .b(new_n307_), .c(x01), .O(z47));
  inv1   g153(.a(x08), .O(new_n314_));
  nand2  g154(.a(x52), .b(x16), .O(new_n315_));
  oai21  g155(.a(x52), .b(new_n314_), .c(new_n315_), .O(new_n316_));
  nand2  g156(.a(new_n316_), .b(new_n306_), .O(new_n317_));
  inv1   g157(.a(new_n214_), .O(new_n318_));
  nor2   g158(.a(new_n310_), .b(new_n318_), .O(new_n319_));
  nand2  g159(.a(new_n319_), .b(x68), .O(new_n320_));
  aoi21  g160(.a(new_n320_), .b(new_n317_), .c(x01), .O(z48));
  inv1   g161(.a(x09), .O(new_n322_));
  nand2  g162(.a(x52), .b(x17), .O(new_n323_));
  oai21  g163(.a(x52), .b(new_n322_), .c(new_n323_), .O(new_n324_));
  nand2  g164(.a(new_n324_), .b(new_n306_), .O(new_n325_));
  ...
  nand2  g170(.a(new_n330_), .b(new_n306_), .O(new_n331_));
  ...
  nand2  g176(.a(new_n336_), .b(new_n306_), .O(new_n337_));
  nand2  g177(.a(new_n319_), .b(x71), .O(new_n338_));
  aoi21  g178(.a(new_n338_), .b(new_n337_), .c(x01), .O(z51));
  inv1   g179(.a(x82), .O(new_n343_));
  nand3  g180(.a(new_n260_), .b(x84), .c(new_n343_), .O(new_n344_));
  inv1   g181(.a(x80), .O(new_n345_));
  nand4  g182(.a(new_n234_), .b(new_n161_), .c(new_n345_), .d(x79), .O(new_n346_));
  nor2   g183(.a(new_n346_), .b(new_n344_), .O(z55));
  nand2  g184(.a(new_n232_), .b(x76), .O(new_n348_));
  xnor2a g185(.a(x84), .b(x81), .O(new_n349_));
  aoi21  g186(.a(new_n168_), .b(new_n167_), .c(new_n349_), .O(new_n350_));
  ...
  nand3  g190(.a(new_n160_), .b(new_n159_), .c(new_n153_), .O(new_n354_));
  nand3  g191(.a(new_n354_), .b(new_n353_), .c(new_n230_), .O(z56));
  inv1   g192(.a(x02), .O(new_n356_));
  nand3  g193(.a(new_n230_), .b(x03), .c(new_n356_), .O(new_n357_));
  inv1   g194(.a(new_n357_), .O(z57));
  nand4  g195(.a(x80), .b(new_n219_), .c(x43), .d(new_n237_), .O(new_n359_));
  oai22  g196(.a(new_n359_), .b(new_n218_), .c(new_n237_), .d(x40), .O(new_n360_));
  nand3  g197(.a(new_n360_), .b(new_n224_), .c(x79), .O(new_n361_));
  nor2   g198(.a(x79), .b(x78), .O(new_n362_));
  nand3  g199(.a(new_n362_), .b(new_n237_), .c(x40), .O(new_n363_));
  nand2  g200(.a(new_n363_), .b(new_n361_), .O(new_n364_));
  nand2  g201(.a(new_n364_), .b(x77), .O(new_n365_));
  inv1   g202(.a(new_n167_), .O(new_n366_));
  oai21  g203(.a(new_n366_), .b(new_n227_), .c(new_n154_), .O(new_n367_));
  aoi21  g204(.a(new_n367_), .b(new_n365_), .c(x01), .O(z58));
  inv1   g205(.a(new_n362_), .O(new_n369_));
  aoi21  g206(.a(new_n223_), .b(new_n369_), .c(new_n152_), .O(new_n370_));
  oai21  g207(.a(new_n220_), .b(new_n218_), .c(new_n237_), .O(new_n371_));
  aoi21  g208(.a(new_n371_), .b(x79), .c(new_n223_), .O(new_n372_));
  oai21  g209(.a(new_n372_), .b(new_n370_), .c(x77), .O(new_n373_));
  nor2   g210(.a(x79), .b(x04), .O(new_n374_));
  inv1   g211(.a(new_n374_), .O(new_n375_));
  aoi21  g212(.a(new_n375_), .b(new_n373_), .c(x01), .O(z59));
  aoi21  g213(.a(new_n350_), .b(x79), .c(new_n374_), .O(new_n377_));
  aoi21  g214(.a(new_n377_), .b(new_n225_), .c(x01), .O(z60));
  inv1   g215(.a(new_n170_), .O(new_n379_));
  nand2  g216(.a(new_n168_), .b(new_n167_), .O(new_n380_));
  aoi22  g217(.a(new_n380_), .b(new_n214_), .c(new_n161_), .d(new_n227_), .O(new_n381_));
  nor3   g218(.a(new_n381_), .b(new_n379_), .c(new_n345_), .O(z61));
  nand3  g219(.a(x84), .b(x81), .c(x79), .O(new_n383_));
  oai21  g220(.a(x79), .b(new_n227_), .c(new_n383_), .O(new_n384_));
  nand2  g221(.a(new_n384_), .b(new_n159_), .O(new_n385_));
  nand2  g222(.a(new_n371_), .b(x79), .O(new_n386_));
  nand3  g223(.a(x81), .b(x79), .c(new_n227_), .O(new_n387_));
  inv1   g224(.a(new_n387_), .O(new_n388_));
  aoi21  g225(.a(new_n386_), .b(x04), .c(new_n388_), .O(new_n389_));
  oai21  g226(.a(new_n389_), .b(new_n159_), .c(new_n385_), .O(new_n390_));
  nand2  g227(.a(new_n390_), .b(x78), .O(new_n391_));
  inv1   g228(.a(new_n383_), .O(new_n392_));
  nand2  g229(.a(new_n392_), .b(new_n309_), .O(new_n393_));
  aoi21  g230(.a(new_n393_), .b(new_n391_), .c(x01), .O(z62));
  nor3   g231(.a(new_n381_), .b(new_n379_), .c(new_n343_), .O(z63));
  nand2  g232(.a(x83), .b(x79), .O(new_n396_));
  or2    g233(.a(new_n396_), .b(new_n381_), .O(new_n397_));
  aoi21  g234(.a(new_n397_), .b(new_n305_), .c(x01), .O(z64));
  nor2   g235(.a(new_n160_), .b(x04), .O(new_n399_));
  nor2   g236(.a(new_n241_), .b(x78), .O(new_n400_));
  oai21  g237(.a(new_n400_), .b(new_n399_), .c(x77), .O(new_n401_));
  nand2  g238(.a(new_n366_), .b(x81), .O(new_n402_));
  nand2  g239(.a(new_n170_), .b(x84), .O(new_n403_));
