// Benchmark "FAU" written by ABC on Fri Jul 10 18:21:30 2020
...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n229_, new_n231_, new_n232_, new_n233_, new_n234_, new_n238_,
    new_n239_, new_n240_, new_n241_, new_n242_, new_n243_, new_n244_,
    new_n245_, new_n246_, new_n248_, new_n250_, new_n253_, new_n255_,
    new_n257_, new_n258_, new_n259_, new_n260_, new_n261_, new_n262_,
    new_n263_, new_n264_, new_n265_, new_n266_, new_n267_, new_n268_,
    new_n272_, new_n273_, new_n274_, new_n275_, new_n276_, new_n277_,
    new_n278_, new_n279_, new_n280_, new_n281_, new_n283_, new_n285_,
    new_n287_, new_n295_, new_n298_, new_n299_, new_n300_, new_n301_,
  ...
  nand2  g022(.a(new_n152_), .b(x25), .O(new_n177_));
  oai21  g023(.a(new_n176_), .b(new_n152_), .c(new_n177_), .O(z07));
  ...
  nand4  g085(.a(new_n245_), .b(new_n233_), .c(x45), .d(new_n238_), .O(new_n246_));
  inv1   g086(.a(new_n246_), .O(z27));
  nand4  g087(.a(new_n245_), .b(new_n233_), .c(x46), .d(new_n238_), .O(new_n248_));
  inv1   g088(.a(new_n248_), .O(z28));
  nand4  g089(.a(new_n245_), .b(new_n233_), .c(x47), .d(new_n238_), .O(new_n250_));
  inv1   g090(.a(new_n250_), .O(z29));
  nand4  g091(.a(new_n245_), .b(new_n233_), .c(x49), .d(new_n238_), .O(new_n253_));
  inv1   g092(.a(new_n253_), .O(z31));
  nand4  g093(.a(new_n245_), .b(new_n233_), .c(x50), .d(new_n238_), .O(new_n255_));
  inv1   g094(.a(new_n255_), .O(z32));
  nor2   g095(.a(new_n216_), .b(x81), .O(new_n257_));
  nor2   g096(.a(x83), .b(new_n242_), .O(new_n258_));
  nor2   g097(.a(new_n258_), .b(new_n257_), .O(new_n259_));
  nand2  g098(.a(x42), .b(x05), .O(new_n260_));
  nand2  g099(.a(x51), .b(new_n238_), .O(new_n261_));
  oai22  g100(.a(new_n261_), .b(new_n242_), .c(new_n260_), .d(new_n259_), .O(new_n262_));
  nand2  g101(.a(new_n262_), .b(new_n240_), .O(new_n263_));
  xor2a  g102(.a(x83), .b(x81), .O(new_n264_));
  oai22  g103(.a(new_n264_), .b(new_n260_), .c(new_n261_), .d(x81), .O(new_n265_));
  nand2  g104(.a(new_n265_), .b(new_n243_), .O(new_n266_));
  inv1   g105(.a(new_n162_), .O(new_n267_));
  nand2  g106(.a(new_n233_), .b(new_n267_), .O(new_n268_));
  aoi21  g107(.a(new_n266_), .b(new_n263_), .c(new_n268_), .O(z33));
  nand2  g108(.a(x83), .b(x42), .O(new_n272_));
  nand2  g109(.a(new_n272_), .b(new_n242_), .O(new_n273_));
  nand3  g110(.a(x83), .b(x81), .c(x42), .O(new_n274_));
  nand2  g111(.a(new_n274_), .b(new_n273_), .O(new_n275_));
  and2   g112(.a(new_n275_), .b(new_n243_), .O(new_n276_));
  nand2  g113(.a(new_n272_), .b(x81), .O(new_n277_));
  nand2  g114(.a(new_n257_), .b(x42), .O(new_n278_));
  aoi21  g115(.a(new_n278_), .b(new_n277_), .c(new_n239_), .O(new_n279_));
  oai21  g116(.a(new_n279_), .b(new_n276_), .c(new_n267_), .O(new_n280_));
  nand2  g117(.a(new_n233_), .b(x54), .O(new_n281_));
  nor2   g118(.a(new_n281_), .b(new_n280_), .O(z36));
  nand2  g119(.a(new_n233_), .b(x55), .O(new_n283_));
  nor2   g120(.a(new_n283_), .b(new_n280_), .O(z37));
  nand2  g121(.a(new_n233_), .b(x56), .O(new_n285_));
  nor2   g122(.a(new_n285_), .b(new_n280_), .O(z38));
  inv1   g123(.a(new_n233_), .O(new_n287_));
  nor3   g124(.a(new_n280_), .b(new_n287_), .c(new_n194_), .O(z39));
  nor3   g125(.a(new_n280_), .b(new_n287_), .c(new_n191_), .O(z40));
  nor3   g126(.a(new_n280_), .b(new_n287_), .c(new_n188_), .O(z41));
  nor3   g127(.a(new_n280_), .b(new_n287_), .c(new_n185_), .O(z42));
  nor3   g128(.a(new_n280_), .b(new_n287_), .c(new_n182_), .O(z43));
  nor3   g129(.a(new_n280_), .b(new_n287_), .c(new_n176_), .O(z45));
  nand2  g130(.a(new_n233_), .b(x64), .O(new_n295_));
  nor2   g131(.a(new_n295_), .b(new_n280_), .O(z46));
  inv1   g132(.a(x08), .O(new_n298_));
  nand2  g133(.a(x52), .b(x16), .O(new_n299_));
  oai21  g134(.a(x52), .b(new_n298_), .c(new_n299_), .O(new_n300_));
  nor2   g135(.a(x79), .b(x77), .O(new_n301_));
  nand2  g136(.a(new_n301_), .b(new_n223_), .O(new_n302_));
  inv1   g137(.a(new_n302_), .O(new_n303_));
  nand2  g138(.a(new_n303_), .b(new_n300_), .O(new_n304_));
  inv1   g139(.a(new_n168_), .O(new_n305_));
  nand2  g140(.a(new_n305_), .b(x79), .O(new_n306_));
  inv1   g141(.a(new_n306_), .O(new_n307_));
  and2   g142(.a(new_n307_), .b(new_n213_), .O(new_n308_));
  ...
  nand2  g166(.a(new_n331_), .b(new_n303_), .O(new_n332_));
  nand2  g167(.a(new_n308_), .b(x72), .O(new_n333_));
  aoi21  g168(.a(new_n333_), .b(new_n332_), .c(x01), .O(z52));
  inv1   g169(.a(x14), .O(new_n336_));
  nor2   g170(.a(x52), .b(new_n336_), .O(new_n337_));
  aoi21  g171(.a(x52), .b(x22), .c(new_n337_), .O(new_n338_));
  inv1   g172(.a(new_n167_), .O(new_n339_));
  nand4  g173(.a(new_n339_), .b(new_n154_), .c(x04), .d(new_n153_), .O(new_n340_));
  nor2   g174(.a(new_n340_), .b(new_n338_), .O(z54));
  inv1   g175(.a(x82), .O(new_n342_));
  nand3  g176(.a(new_n257_), .b(x84), .c(new_n342_), .O(new_n343_));
  inv1   g177(.a(x80), .O(new_n344_));
  nand4  g178(.a(new_n233_), .b(new_n161_), .c(new_n344_), .d(x79), .O(new_n345_));
  nor2   g179(.a(new_n345_), .b(new_n343_), .O(z55));
  nand2  g180(.a(new_n231_), .b(x76), .O(new_n347_));
  xnor2a g181(.a(x84), .b(x81), .O(new_n348_));
  aoi21  g182(.a(new_n168_), .b(new_n167_), .c(new_n348_), .O(new_n349_));
  nand2  g183(.a(new_n349_), .b(new_n153_), .O(new_n350_));
  nand2  g184(.a(new_n350_), .b(new_n347_), .O(new_n351_));
  nand2  g185(.a(new_n351_), .b(x79), .O(new_n352_));
  nand3  g186(.a(new_n160_), .b(new_n159_), .c(new_n153_), .O(new_n353_));
  nand3  g187(.a(new_n353_), .b(new_n352_), .c(new_n229_), .O(z56));
  inv1   g188(.a(x02), .O(new_n355_));
  nand3  g189(.a(new_n229_), .b(x03), .c(new_n355_), .O(new_n356_));
  inv1   g190(.a(new_n356_), .O(z57));
  nand4  g191(.a(x80), .b(new_n218_), .c(x43), .d(new_n238_), .O(new_n358_));
  oai22  g192(.a(new_n358_), .b(new_n217_), .c(new_n238_), .d(x40), .O(new_n359_));
  nand3  g193(.a(new_n359_), .b(new_n223_), .c(x79), .O(new_n360_));
  nor2   g194(.a(x79), .b(x78), .O(new_n361_));
  nand3  g195(.a(new_n361_), .b(new_n238_), .c(x40), .O(new_n362_));
  nand2  g196(.a(new_n362_), .b(new_n360_), .O(new_n363_));
  nand2  g197(.a(new_n363_), .b(x77), .O(new_n364_));
  oai21  g198(.a(new_n339_), .b(new_n226_), .c(new_n154_), .O(new_n365_));
  aoi21  g199(.a(new_n365_), .b(new_n364_), .c(x01), .O(z58));
  inv1   g200(.a(new_n361_), .O(new_n367_));
  aoi21  g201(.a(new_n222_), .b(new_n367_), .c(new_n152_), .O(new_n368_));
  oai21  g202(.a(new_n219_), .b(new_n217_), .c(new_n238_), .O(new_n369_));
  aoi21  g203(.a(new_n369_), .b(x79), .c(new_n222_), .O(new_n370_));
  oai21  g204(.a(new_n370_), .b(new_n368_), .c(x77), .O(new_n371_));
  nor2   g205(.a(x79), .b(x04), .O(new_n372_));
  inv1   g206(.a(new_n372_), .O(new_n373_));
  aoi21  g207(.a(new_n373_), .b(new_n371_), .c(x01), .O(z59));
  aoi21  g208(.a(new_n349_), .b(x79), .c(new_n372_), .O(new_n375_));
  aoi21  g209(.a(new_n375_), .b(new_n224_), .c(x01), .O(z60));
  inv1   g210(.a(new_n170_), .O(new_n377_));
  nand2  g211(.a(new_n168_), .b(new_n167_), .O(new_n378_));
  aoi22  g212(.a(new_n378_), .b(new_n213_), .c(new_n161_), .d(new_n226_), .O(new_n379_));
  nor3   g213(.a(new_n379_), .b(new_n377_), .c(new_n344_), .O(z61));
  nand3  g214(.a(x84), .b(x81), .c(x79), .O(new_n381_));
  oai21  g215(.a(x79), .b(new_n226_), .c(new_n381_), .O(new_n382_));
  nand2  g216(.a(new_n382_), .b(new_n159_), .O(new_n383_));
  nand2  g217(.a(new_n369_), .b(x79), .O(new_n384_));
  nand3  g218(.a(x81), .b(x79), .c(new_n226_), .O(new_n385_));
  ...
  nand2  g224(.a(new_n390_), .b(new_n305_), .O(new_n391_));
  aoi21  g225(.a(new_n391_), .b(new_n389_), .c(x01), .O(z62));
  nor3   g226(.a(new_n379_), .b(new_n377_), .c(new_n342_), .O(z63));
  nand2  g227(.a(x83), .b(x79), .O(new_n394_));
  or2    g228(.a(new_n394_), .b(new_n379_), .O(new_n395_));
  aoi21  g229(.a(new_n395_), .b(new_n302_), .c(x01), .O(z64));
  ...
  nand2  g233(.a(new_n339_), .b(x81), .O(new_n400_));
  nand2  g234(.a(new_n170_), .b(x84), .O(new_n401_));
