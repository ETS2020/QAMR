...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n275_, new_n278_, new_n281_, new_n284_, new_n287_, new_n288_,
  ...
  inv1   g097(.a(new_n162_), .O(new_n261_));
  nor2   g098(.a(new_n217_), .b(new_n235_), .O(new_n262_));
  inv1   g099(.a(new_n262_), .O(new_n263_));
  nand2  g100(.a(new_n263_), .b(new_n236_), .O(new_n264_));
  nand2  g101(.a(new_n262_), .b(x81), .O(new_n265_));
  aoi21  g102(.a(new_n265_), .b(new_n264_), .c(new_n239_), .O(new_n266_));
  nand2  g103(.a(new_n263_), .b(x81), .O(new_n267_));
  nand2  g104(.a(new_n262_), .b(new_n236_), .O(new_n268_));
  aoi21  g105(.a(new_n268_), .b(new_n267_), .c(new_n237_), .O(new_n269_));
  oai21  g106(.a(new_n269_), .b(new_n266_), .c(new_n261_), .O(new_n270_));
  nand2  g107(.a(new_n232_), .b(x55), .O(new_n271_));
  nor2   g108(.a(new_n271_), .b(new_n270_), .O(z37));
  nand2  g109(.a(new_n232_), .b(x56), .O(new_n273_));
  nor2   g110(.a(new_n273_), .b(new_n270_), .O(z38));
  inv1   g111(.a(new_n232_), .O(new_n275_));
  nor3   g112(.a(new_n270_), .b(new_n275_), .c(new_n193_), .O(z39));
  nor3   g113(.a(new_n270_), .b(new_n275_), .c(new_n190_), .O(z40));
  nand2  g114(.a(new_n232_), .b(x59), .O(new_n278_));
  nor2   g115(.a(new_n278_), .b(new_n270_), .O(z41));
  nand2  g116(.a(new_n232_), .b(x61), .O(new_n281_));
  nor2   g117(.a(new_n281_), .b(new_n270_), .O(z43));
  nor3   g118(.a(new_n270_), .b(new_n275_), .c(new_n182_), .O(z44));
  nand2  g119(.a(new_n232_), .b(x63), .O(new_n284_));
  nor2   g120(.a(new_n284_), .b(new_n270_), .O(z45));
  ...
  nand2  g125(.a(new_n290_), .b(new_n224_), .O(new_n291_));
  inv1   g126(.a(new_n291_), .O(new_n292_));
  nand2  g127(.a(new_n292_), .b(new_n289_), .O(new_n293_));
  nor2   g128(.a(x75), .b(x67), .O(new_n294_));
  inv1   g129(.a(new_n168_), .O(new_n295_));
  nand2  g130(.a(new_n295_), .b(x79), .O(new_n296_));
  nor2   g131(.a(new_n296_), .b(new_n294_), .O(new_n297_));
  nand2  g132(.a(new_n297_), .b(new_n214_), .O(new_n298_));
  aoi21  g133(.a(new_n298_), .b(new_n293_), .c(x01), .O(z47));
  inv1   g134(.a(x08), .O(new_n300_));
  nand2  g135(.a(x52), .b(x16), .O(new_n301_));
  oai21  g136(.a(x52), .b(new_n300_), .c(new_n301_), .O(new_n302_));
  nand2  g137(.a(new_n302_), .b(new_n292_), .O(new_n303_));
  inv1   g138(.a(new_n214_), .O(new_n304_));
  nor2   g139(.a(new_n296_), .b(new_n304_), .O(new_n305_));
  nand2  g140(.a(new_n305_), .b(x68), .O(new_n306_));
  aoi21  g141(.a(new_n306_), .b(new_n303_), .c(x01), .O(z48));
  inv1   g142(.a(x09), .O(new_n308_));
  nand2  g143(.a(x52), .b(x17), .O(new_n309_));
  oai21  g144(.a(x52), .b(new_n308_), .c(new_n309_), .O(new_n310_));
  nand2  g145(.a(new_n310_), .b(new_n292_), .O(new_n311_));
  nand2  g146(.a(new_n305_), .b(x69), .O(new_n312_));
  aoi21  g147(.a(new_n312_), .b(new_n311_), .c(x01), .O(z49));
  inv1   g148(.a(x10), .O(new_n314_));
  nand2  g149(.a(x52), .b(x18), .O(new_n315_));
  oai21  g150(.a(x52), .b(new_n314_), .c(new_n315_), .O(new_n316_));
  nand2  g151(.a(new_n316_), .b(new_n292_), .O(new_n317_));
  nand2  g152(.a(new_n305_), .b(x70), .O(new_n318_));
  aoi21  g153(.a(new_n318_), .b(new_n317_), .c(x01), .O(z50));
  inv1   g154(.a(x11), .O(new_n320_));
  nand2  g155(.a(x52), .b(x19), .O(new_n321_));
  oai21  g156(.a(x52), .b(new_n320_), .c(new_n321_), .O(new_n322_));
  nand2  g157(.a(new_n322_), .b(new_n292_), .O(new_n323_));
  nand2  g158(.a(new_n305_), .b(x71), .O(new_n324_));
  aoi21  g159(.a(new_n324_), .b(new_n323_), .c(x01), .O(z51));
  inv1   g160(.a(x12), .O(new_n326_));
  nand2  g161(.a(x52), .b(x20), .O(new_n327_));
  oai21  g162(.a(x52), .b(new_n326_), .c(new_n327_), .O(new_n328_));
  nand2  g163(.a(new_n328_), .b(new_n292_), .O(new_n329_));
  nand2  g164(.a(new_n305_), .b(x72), .O(new_n330_));
  aoi21  g165(.a(new_n330_), .b(new_n329_), .c(x01), .O(z52));
  inv1   g166(.a(x82), .O(new_n334_));
  nand4  g167(.a(x84), .b(x83), .c(new_n334_), .d(new_n236_), .O(new_n335_));
  inv1   g168(.a(x80), .O(new_n336_));
  nand4  g169(.a(new_n232_), .b(new_n161_), .c(new_n336_), .d(x79), .O(new_n337_));
  nor2   g170(.a(new_n337_), .b(new_n335_), .O(z55));
  nand2  g171(.a(new_n160_), .b(new_n159_), .O(new_n339_));
  nand2  g172(.a(new_n230_), .b(x76), .O(new_n340_));
  xnor2a g173(.a(x84), .b(x81), .O(new_n341_));
  aoi21  g174(.a(new_n168_), .b(new_n167_), .c(new_n341_), .O(new_n342_));
  ...
  nand4  g179(.a(x80), .b(new_n219_), .c(x43), .d(new_n235_), .O(new_n348_));
  oai22  g180(.a(new_n348_), .b(new_n218_), .c(new_n235_), .d(x40), .O(new_n349_));
  nand3  g181(.a(new_n349_), .b(new_n224_), .c(x79), .O(new_n350_));
  nor2   g182(.a(x79), .b(x78), .O(new_n351_));
  nand3  g183(.a(new_n351_), .b(new_n235_), .c(x40), .O(new_n352_));
  nand2  g184(.a(new_n352_), .b(new_n350_), .O(new_n353_));
  nand2  g185(.a(new_n353_), .b(x77), .O(new_n354_));
  inv1   g186(.a(new_n167_), .O(new_n355_));
  oai21  g187(.a(new_n355_), .b(new_n227_), .c(new_n154_), .O(new_n356_));
  aoi21  g188(.a(new_n356_), .b(new_n354_), .c(x01), .O(z58));
  inv1   g189(.a(new_n351_), .O(new_n358_));
  aoi21  g190(.a(new_n223_), .b(new_n358_), .c(new_n152_), .O(new_n359_));
  oai21  g191(.a(new_n220_), .b(new_n218_), .c(new_n235_), .O(new_n360_));
  aoi21  g192(.a(new_n360_), .b(x79), .c(new_n223_), .O(new_n361_));
  ...
  aoi21  g198(.a(new_n366_), .b(new_n225_), .c(x01), .O(z60));
  inv1   g199(.a(new_n170_), .O(new_n368_));
  nand2  g200(.a(new_n168_), .b(new_n167_), .O(new_n369_));
  aoi22  g201(.a(new_n369_), .b(new_n214_), .c(new_n161_), .d(new_n227_), .O(new_n370_));
  nor3   g202(.a(new_n370_), .b(new_n368_), .c(new_n336_), .O(z61));
  nand3  g203(.a(x84), .b(x81), .c(x79), .O(new_n372_));
  oai21  g204(.a(x79), .b(new_n227_), .c(new_n372_), .O(new_n373_));
  nand2  g205(.a(new_n373_), .b(new_n159_), .O(new_n374_));
  nand2  g206(.a(new_n360_), .b(x79), .O(new_n375_));
  nand3  g207(.a(x81), .b(x79), .c(new_n227_), .O(new_n376_));
  inv1   g208(.a(new_n376_), .O(new_n377_));
  aoi21  g209(.a(new_n375_), .b(x04), .c(new_n377_), .O(new_n378_));
  oai21  g210(.a(new_n378_), .b(new_n159_), .c(new_n374_), .O(new_n379_));
  nand2  g211(.a(new_n379_), .b(x78), .O(new_n380_));
  inv1   g212(.a(new_n372_), .O(new_n381_));
  nand2  g213(.a(new_n381_), .b(new_n295_), .O(new_n382_));
  aoi21  g214(.a(new_n382_), .b(new_n380_), .c(x01), .O(z62));
  nor3   g215(.a(new_n370_), .b(new_n368_), .c(new_n334_), .O(z63));
  nand2  g216(.a(x83), .b(x79), .O(new_n385_));
  or2    g217(.a(new_n385_), .b(new_n370_), .O(new_n386_));
  aoi21  g218(.a(new_n386_), .b(new_n291_), .c(x01), .O(z64));
  nor2   g219(.a(new_n160_), .b(x04), .O(new_n388_));
  nor2   g220(.a(new_n236_), .b(x78), .O(new_n389_));
  oai21  g221(.a(new_n389_), .b(new_n388_), .c(x77), .O(new_n390_));
  nand2  g222(.a(new_n355_), .b(x81), .O(new_n391_));
