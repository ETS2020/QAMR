...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n250_, new_n252_, new_n258_, new_n260_, new_n261_, new_n262_,
    new_n263_, new_n264_, new_n265_, new_n266_, new_n267_, new_n268_,
    new_n269_, new_n270_, new_n271_, new_n275_, new_n276_, new_n277_,
    new_n278_, new_n279_, new_n280_, new_n281_, new_n282_, new_n283_,
    new_n284_, new_n286_, new_n288_, new_n290_, new_n295_, new_n301_,
    new_n302_, new_n303_, new_n304_, new_n305_, new_n306_, new_n307_,
    new_n308_, new_n309_, new_n310_, new_n311_, new_n313_, new_n314_,
    new_n315_, new_n316_, new_n317_, new_n319_, new_n320_, new_n321_,
    new_n322_, new_n323_, new_n325_, new_n326_, new_n327_, new_n328_,
    new_n329_, new_n334_, new_n335_, new_n336_, new_n337_, new_n339_,
  ...
  nand4  g098(.a(new_n247_), .b(new_n237_), .c(x50), .d(new_n240_), .O(new_n258_));
  inv1   g099(.a(new_n258_), .O(z32));
  nor2   g100(.a(new_n222_), .b(x81), .O(new_n260_));
  nor2   g101(.a(x83), .b(new_n244_), .O(new_n261_));
  nor2   g102(.a(new_n261_), .b(new_n260_), .O(new_n262_));
  nand2  g103(.a(x42), .b(x05), .O(new_n263_));
  nand2  g104(.a(x51), .b(new_n240_), .O(new_n264_));
  oai22  g105(.a(new_n264_), .b(new_n244_), .c(new_n263_), .d(new_n262_), .O(new_n265_));
  nand2  g106(.a(new_n265_), .b(new_n242_), .O(new_n266_));
  xor2a  g107(.a(x83), .b(x81), .O(new_n267_));
  oai22  g108(.a(new_n267_), .b(new_n263_), .c(new_n264_), .d(x81), .O(new_n268_));
  nand2  g109(.a(new_n268_), .b(new_n245_), .O(new_n269_));
  inv1   g110(.a(new_n162_), .O(new_n270_));
  nand2  g111(.a(new_n237_), .b(new_n270_), .O(new_n271_));
  aoi21  g112(.a(new_n269_), .b(new_n266_), .c(new_n271_), .O(z33));
  nand2  g113(.a(x83), .b(x42), .O(new_n275_));
  nand2  g114(.a(new_n275_), .b(new_n244_), .O(new_n276_));
  nand3  g115(.a(x83), .b(x81), .c(x42), .O(new_n277_));
  nand2  g116(.a(new_n277_), .b(new_n276_), .O(new_n278_));
  and2   g117(.a(new_n278_), .b(new_n245_), .O(new_n279_));
  nand2  g118(.a(new_n275_), .b(x81), .O(new_n280_));
  nand2  g119(.a(new_n260_), .b(x42), .O(new_n281_));
  aoi21  g120(.a(new_n281_), .b(new_n280_), .c(new_n241_), .O(new_n282_));
  oai21  g121(.a(new_n282_), .b(new_n279_), .c(new_n270_), .O(new_n283_));
  nand2  g122(.a(new_n237_), .b(x54), .O(new_n284_));
  nor2   g123(.a(new_n284_), .b(new_n283_), .O(z36));
  nand2  g124(.a(new_n237_), .b(x55), .O(new_n286_));
  nor2   g125(.a(new_n286_), .b(new_n283_), .O(z37));
  nand2  g126(.a(new_n237_), .b(x56), .O(new_n288_));
  nor2   g127(.a(new_n288_), .b(new_n283_), .O(z38));
  inv1   g128(.a(new_n237_), .O(new_n290_));
  nor3   g129(.a(new_n283_), .b(new_n290_), .c(new_n191_), .O(z39));
  nor3   g130(.a(new_n283_), .b(new_n290_), .c(new_n188_), .O(z40));
  nor3   g131(.a(new_n283_), .b(new_n290_), .c(new_n185_), .O(z41));
  nand2  g132(.a(new_n237_), .b(x61), .O(new_n295_));
  nor2   g133(.a(new_n295_), .b(new_n283_), .O(z43));
  nor3   g134(.a(new_n283_), .b(new_n290_), .c(new_n178_), .O(z44));
  nor3   g135(.a(new_n283_), .b(new_n290_), .c(new_n172_), .O(z46));
  ...
  inv1   g142(.a(new_n217_), .O(new_n307_));
  nand2  g143(.a(new_n307_), .b(x79), .O(new_n308_));
  inv1   g144(.a(new_n308_), .O(new_n309_));
  and2   g145(.a(new_n309_), .b(new_n219_), .O(new_n310_));
  ...
  inv1   g160(.a(x11), .O(new_n325_));
  nand2  g161(.a(x52), .b(x19), .O(new_n326_));
  oai21  g162(.a(x52), .b(new_n325_), .c(new_n326_), .O(new_n327_));
  nand2  g163(.a(new_n327_), .b(new_n305_), .O(new_n328_));
  nand2  g164(.a(new_n310_), .b(x71), .O(new_n329_));
  aoi21  g165(.a(new_n329_), .b(new_n328_), .c(x01), .O(z51));
  inv1   g166(.a(x82), .O(new_n334_));
  nand3  g167(.a(new_n260_), .b(x84), .c(new_n334_), .O(new_n335_));
  ...
  nand2  g214(.a(new_n382_), .b(new_n307_), .O(new_n383_));
  ...
  aoi21  g219(.a(new_n387_), .b(new_n304_), .c(x01), .O(z64));
  nor2   g220(.a(new_n160_), .b(x04), .O(new_n389_));
  nor2   g221(.a(new_n244_), .b(x78), .O(new_n390_));
