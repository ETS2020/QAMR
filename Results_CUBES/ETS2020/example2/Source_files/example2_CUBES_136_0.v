// Benchmark "FAU" written by ABC on Fri Jul 10 18:19:19 2020
...
module FAU ( 
  ...
  nand2  g141(.a(new_n239_), .b(x56), .O(new_n297_));
  nor2   g142(.a(new_n297_), .b(new_n289_), .O(z38));
  nor3   g143(.a(new_n289_), .b(new_n280_), .c(new_n191_), .O(z39));
  nor3   g144(.a(new_n289_), .b(new_n280_), .c(new_n188_), .O(z40));
  nor3   g145(.a(new_n289_), .b(new_n280_), .c(new_n179_), .O(z43));
  nor3   g146(.a(new_n289_), .b(new_n280_), .c(new_n172_), .O(z46));
  inv1   g147(.a(x08), .O(new_n308_));
  nand2  g148(.a(x52), .b(x16), .O(new_n309_));
  oai21  g149(.a(x52), .b(new_n308_), .c(new_n309_), .O(new_n310_));
  nand3  g150(.a(new_n229_), .b(new_n154_), .c(new_n159_), .O(new_n311_));
  inv1   g151(.a(new_n311_), .O(new_n312_));
  nand2  g152(.a(new_n312_), .b(new_n310_), .O(new_n313_));
  ...
  inv1   g171(.a(x12), .O(new_n333_));
  nand2  g172(.a(x52), .b(x20), .O(new_n334_));
  oai21  g173(.a(x52), .b(new_n333_), .c(new_n334_), .O(new_n335_));
  nand2  g174(.a(new_n335_), .b(new_n312_), .O(new_n336_));
  nand2  g175(.a(new_n317_), .b(x72), .O(new_n337_));
  aoi21  g176(.a(new_n337_), .b(new_n336_), .c(x01), .O(z52));
  nand2  g177(.a(x52), .b(x22), .O(new_n340_));
  nand2  g178(.a(new_n279_), .b(x14), .O(new_n341_));
  inv1   g179(.a(new_n216_), .O(new_n342_));
  ...
  nand3  g183(.a(new_n266_), .b(x84), .c(new_n345_), .O(new_n346_));
  inv1   g184(.a(x80), .O(new_n347_));
  nand4  g185(.a(new_n239_), .b(new_n161_), .c(new_n347_), .d(x79), .O(new_n348_));
  nor2   g186(.a(new_n348_), .b(new_n346_), .O(z55));
  nand2  g187(.a(new_n237_), .b(x76), .O(new_n350_));
  xnor2a g188(.a(x84), .b(x81), .O(new_n351_));
  aoi21  g189(.a(new_n217_), .b(new_n216_), .c(new_n351_), .O(new_n352_));
  ...
  nand3  g194(.a(new_n356_), .b(new_n355_), .c(new_n235_), .O(z56));
  inv1   g195(.a(x02), .O(new_n358_));
  nand3  g196(.a(new_n235_), .b(x03), .c(new_n358_), .O(new_n359_));
  inv1   g197(.a(new_n359_), .O(z57));
  nand4  g198(.a(x80), .b(new_n224_), .c(x43), .d(new_n242_), .O(new_n361_));
  oai22  g199(.a(new_n361_), .b(new_n223_), .c(new_n242_), .d(x40), .O(new_n362_));
  nand3  g200(.a(new_n362_), .b(new_n229_), .c(x79), .O(new_n363_));
  nor2   g201(.a(x79), .b(x78), .O(new_n364_));
  nand3  g202(.a(new_n364_), .b(new_n242_), .c(x40), .O(new_n365_));
  nand2  g203(.a(new_n365_), .b(new_n363_), .O(new_n366_));
  nand2  g204(.a(new_n366_), .b(x77), .O(new_n367_));
  oai21  g205(.a(new_n342_), .b(new_n232_), .c(new_n154_), .O(new_n368_));
  aoi21  g206(.a(new_n368_), .b(new_n367_), .c(x01), .O(z58));
  inv1   g207(.a(new_n364_), .O(new_n370_));
  aoi21  g208(.a(new_n228_), .b(new_n370_), .c(new_n152_), .O(new_n371_));
  oai21  g209(.a(new_n225_), .b(new_n223_), .c(new_n242_), .O(new_n372_));
  aoi21  g210(.a(new_n372_), .b(x79), .c(new_n228_), .O(new_n373_));
  ...
  aoi21  g216(.a(new_n378_), .b(new_n230_), .c(x01), .O(z60));
  nand2  g217(.a(new_n217_), .b(new_n216_), .O(new_n380_));
  aoi22  g218(.a(new_n380_), .b(new_n219_), .c(new_n161_), .d(new_n232_), .O(new_n381_));
  ...
  oai21  g223(.a(x79), .b(new_n232_), .c(new_n385_), .O(new_n386_));
  nand2  g224(.a(new_n386_), .b(new_n159_), .O(new_n387_));
  nand2  g225(.a(new_n372_), .b(x79), .O(new_n388_));
  nand3  g226(.a(x81), .b(x79), .c(new_n232_), .O(new_n389_));
  ...
  nand2  g232(.a(new_n394_), .b(new_n314_), .O(new_n395_));
  ...
  aoi21  g237(.a(new_n399_), .b(new_n311_), .c(x01), .O(z64));
  nor2   g238(.a(new_n160_), .b(x04), .O(new_n401_));
  nor2   g239(.a(new_n246_), .b(x78), .O(new_n402_));
