...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n302_, new_n304_, new_n306_, new_n313_, new_n317_, new_n318_,
  ...
  nor3   g154(.a(new_n298_), .b(new_n289_), .c(new_n202_), .O(z40));
  nor3   g155(.a(new_n298_), .b(new_n289_), .c(new_n196_), .O(z42));
  nand2  g156(.a(new_n248_), .b(x62), .O(new_n313_));
  nor2   g157(.a(new_n313_), .b(new_n298_), .O(z44));
