...
module FAU ( 
  ...
  nor2   g054(.a(x04), .b(x01), .O(new_n218_));
  nand3  g055(.a(new_n218_), .b(x44), .c(new_n217_), .O(new_n219_));
  inv1   g056(.a(new_n219_), .O(new_n220_));
  nand3  g057(.a(new_n220_), .b(new_n216_), .c(new_n214_), .O(new_n221_));
  inv1   g058(.a(new_n221_), .O(z26));
  nand3  g059(.a(new_n218_), .b(x45), .c(new_n217_), .O(new_n223_));
  inv1   g060(.a(new_n223_), .O(new_n224_));
  nand3  g061(.a(new_n224_), .b(new_n216_), .c(new_n214_), .O(new_n225_));
  inv1   g062(.a(new_n225_), .O(z27));
  nand3  g063(.a(new_n218_), .b(x46), .c(new_n217_), .O(new_n227_));
  inv1   g064(.a(new_n227_), .O(new_n228_));
  nand3  g065(.a(new_n228_), .b(new_n216_), .c(new_n214_), .O(new_n229_));
  inv1   g066(.a(new_n229_), .O(z28));
  nand3  g067(.a(new_n218_), .b(x47), .c(new_n217_), .O(new_n231_));
  inv1   g068(.a(new_n231_), .O(new_n232_));
  nand3  g069(.a(new_n232_), .b(new_n216_), .c(new_n214_), .O(new_n233_));
  inv1   g070(.a(new_n233_), .O(z29));
  nand3  g071(.a(new_n218_), .b(x49), .c(new_n217_), .O(new_n236_));
  inv1   g072(.a(new_n236_), .O(new_n237_));
  nand3  g073(.a(new_n237_), .b(new_n216_), .c(new_n214_), .O(new_n238_));
  inv1   g074(.a(new_n238_), .O(z31));
  inv1   g075(.a(new_n211_), .O(new_n241_));
  xnor2a g076(.a(x83), .b(x81), .O(new_n242_));
  nand2  g077(.a(x42), .b(x05), .O(new_n243_));
  nand2  g078(.a(x51), .b(new_n217_), .O(new_n244_));
  oai22  g079(.a(new_n244_), .b(new_n210_), .c(new_n243_), .d(new_n242_), .O(new_n245_));
  nand2  g080(.a(new_n245_), .b(new_n241_), .O(new_n246_));
  xor2a  g081(.a(x83), .b(x81), .O(new_n247_));
  oai22  g082(.a(new_n247_), .b(new_n243_), .c(new_n244_), .d(x81), .O(new_n248_));
  nand2  g083(.a(new_n248_), .b(new_n212_), .O(new_n249_));
  nand2  g084(.a(new_n218_), .b(new_n216_), .O(new_n250_));
  aoi21  g085(.a(new_n249_), .b(new_n246_), .c(new_n250_), .O(z33));
  xnor2a g086(.a(x84), .b(x82), .O(new_n253_));
  nand2  g087(.a(x83), .b(x42), .O(new_n254_));
  nand2  g088(.a(new_n254_), .b(new_n210_), .O(new_n255_));
  ...
  nand3  g092(.a(x83), .b(new_n210_), .c(x42), .O(new_n259_));
  aoi21  g093(.a(new_n259_), .b(new_n258_), .c(new_n211_), .O(new_n260_));
  oai21  g094(.a(new_n260_), .b(new_n257_), .c(new_n216_), .O(new_n261_));
  nand2  g095(.a(new_n218_), .b(x53), .O(new_n262_));
  nor2   g096(.a(new_n262_), .b(new_n261_), .O(z35));
  nand2  g097(.a(new_n218_), .b(x54), .O(new_n264_));
  nor2   g098(.a(new_n264_), .b(new_n261_), .O(z36));
  nand2  g099(.a(new_n218_), .b(x55), .O(new_n266_));
  nor2   g100(.a(new_n266_), .b(new_n261_), .O(z37));
  nand2  g101(.a(new_n218_), .b(x56), .O(new_n268_));
  nor2   g102(.a(new_n268_), .b(new_n261_), .O(z38));
  nand2  g103(.a(new_n218_), .b(x57), .O(new_n270_));
  nor2   g104(.a(new_n270_), .b(new_n261_), .O(z39));
  nand2  g105(.a(new_n218_), .b(x58), .O(new_n272_));
  nor2   g106(.a(new_n272_), .b(new_n261_), .O(z40));
  nand2  g107(.a(new_n218_), .b(x59), .O(new_n274_));
  nor2   g108(.a(new_n274_), .b(new_n261_), .O(z41));
  nand2  g109(.a(new_n218_), .b(x60), .O(new_n276_));
  nor2   g110(.a(new_n276_), .b(new_n261_), .O(z42));
  nand2  g111(.a(new_n218_), .b(x61), .O(new_n278_));
  nor2   g112(.a(new_n278_), .b(new_n261_), .O(z43));
  nand2  g113(.a(new_n218_), .b(x62), .O(new_n280_));
  nor2   g114(.a(new_n280_), .b(new_n261_), .O(z44));
  nand2  g115(.a(new_n218_), .b(x63), .O(new_n282_));
  nor2   g116(.a(new_n282_), .b(new_n261_), .O(z45));
  nand2  g117(.a(new_n218_), .b(x64), .O(new_n284_));
  nor2   g118(.a(new_n284_), .b(new_n261_), .O(z46));
  inv1   g119(.a(x07), .O(new_n286_));
  nand2  g120(.a(x52), .b(x15), .O(new_n287_));
  oai21  g121(.a(x52), .b(new_n286_), .c(new_n287_), .O(new_n288_));
  inv1   g122(.a(x79), .O(new_n289_));
  nand4  g123(.a(new_n289_), .b(x78), .c(new_n154_), .d(x04), .O(new_n290_));
  inv1   g124(.a(new_n290_), .O(new_n291_));
  nand2  g125(.a(new_n291_), .b(new_n288_), .O(new_n292_));
  xor2a  g126(.a(x84), .b(x81), .O(new_n293_));
  inv1   g127(.a(new_n293_), .O(new_n294_));
  or2    g128(.a(x75), .b(x67), .O(new_n295_));
  nand3  g129(.a(x79), .b(new_n156_), .c(x77), .O(new_n296_));
  inv1   g130(.a(new_n296_), .O(new_n297_));
  nand3  g131(.a(new_n297_), .b(new_n295_), .c(new_n294_), .O(new_n298_));
  aoi21  g132(.a(new_n298_), .b(new_n292_), .c(x01), .O(z47));
  inv1   g133(.a(x10), .O(new_n302_));
  nand2  g134(.a(x52), .b(x18), .O(new_n303_));
  oai21  g135(.a(x52), .b(new_n302_), .c(new_n303_), .O(new_n304_));
  nand2  g136(.a(new_n304_), .b(new_n291_), .O(new_n305_));
  nor2   g137(.a(new_n296_), .b(new_n293_), .O(new_n306_));
  nand2  g138(.a(new_n306_), .b(x70), .O(new_n307_));
  aoi21  g139(.a(new_n307_), .b(new_n305_), .c(x01), .O(z50));
  inv1   g140(.a(x12), .O(new_n310_));
  nand2  g141(.a(x52), .b(x20), .O(new_n311_));
  oai21  g142(.a(x52), .b(new_n310_), .c(new_n311_), .O(new_n312_));
  nand2  g143(.a(new_n312_), .b(new_n291_), .O(new_n313_));
  nand2  g144(.a(new_n306_), .b(x72), .O(new_n314_));
  ...
  nand2  g149(.a(new_n318_), .b(new_n291_), .O(new_n319_));
  nand2  g150(.a(new_n306_), .b(x73), .O(new_n320_));
  ...
  nor2   g155(.a(new_n156_), .b(x77), .O(new_n325_));
  nand4  g156(.a(new_n325_), .b(new_n289_), .c(x04), .d(new_n158_), .O(new_n326_));
  nor2   g157(.a(new_n326_), .b(new_n324_), .O(z54));
  inv1   g158(.a(x82), .O(new_n328_));
  nand2  g159(.a(x84), .b(new_n328_), .O(new_n329_));
  inv1   g160(.a(new_n218_), .O(new_n330_));
  nand2  g161(.a(x83), .b(new_n210_), .O(new_n331_));
  inv1   g162(.a(x80), .O(new_n332_));
  nand4  g163(.a(new_n332_), .b(x79), .c(x78), .d(x77), .O(new_n333_));
  nor4   g164(.a(new_n333_), .b(new_n331_), .c(new_n330_), .d(new_n329_), .O(z55));
  inv1   g165(.a(x02), .O(new_n336_));
  nand4  g166(.a(x03), .b(new_n336_), .c(new_n158_), .d(x00), .O(new_n337_));
