...
module FAU ( 
  ...
  nand4  g096(.a(new_n243_), .b(new_n242_), .c(x50), .d(new_n235_), .O(new_n256_));
  inv1   g097(.a(new_n256_), .O(z32));
  inv1   g098(.a(new_n162_), .O(new_n261_));
  nor2   g099(.a(new_n219_), .b(new_n235_), .O(new_n262_));
  inv1   g100(.a(new_n262_), .O(new_n263_));
  nand2  g101(.a(new_n263_), .b(new_n236_), .O(new_n264_));
  nand2  g102(.a(new_n262_), .b(x81), .O(new_n265_));
  aoi21  g103(.a(new_n265_), .b(new_n264_), .c(new_n239_), .O(new_n266_));
  nand2  g104(.a(new_n263_), .b(x81), .O(new_n267_));
  nand2  g105(.a(new_n262_), .b(new_n236_), .O(new_n268_));
  aoi21  g106(.a(new_n268_), .b(new_n267_), .c(new_n237_), .O(new_n269_));
  oai21  g107(.a(new_n269_), .b(new_n266_), .c(new_n261_), .O(new_n270_));
  nand2  g108(.a(new_n243_), .b(x54), .O(new_n271_));
  nor2   g109(.a(new_n271_), .b(new_n270_), .O(z36));
  nand2  g110(.a(new_n243_), .b(x55), .O(new_n273_));
  nor2   g111(.a(new_n273_), .b(new_n270_), .O(z37));
  nand2  g112(.a(new_n243_), .b(x56), .O(new_n275_));
  nor2   g113(.a(new_n275_), .b(new_n270_), .O(z38));
  inv1   g114(.a(new_n243_), .O(new_n277_));
  nor3   g115(.a(new_n270_), .b(new_n277_), .c(new_n199_), .O(z39));
  nor3   g116(.a(new_n270_), .b(new_n277_), .c(new_n196_), .O(z40));
  nor3   g117(.a(new_n270_), .b(new_n277_), .c(new_n193_), .O(z41));
  nor3   g118(.a(new_n270_), .b(new_n277_), .c(new_n190_), .O(z42));
  nor3   g119(.a(new_n270_), .b(new_n277_), .c(new_n187_), .O(z43));
  nor3   g120(.a(new_n270_), .b(new_n277_), .c(new_n181_), .O(z45));
  nor3   g121(.a(new_n270_), .b(new_n277_), .c(new_n178_), .O(z46));
  inv1   g122(.a(x07), .O(new_n286_));
  nand2  g123(.a(x52), .b(x15), .O(new_n287_));
  oai21  g124(.a(x52), .b(new_n286_), .c(new_n287_), .O(new_n288_));
  nor2   g125(.a(x79), .b(x77), .O(new_n289_));
  nand2  g126(.a(new_n289_), .b(new_n226_), .O(new_n290_));
  inv1   g127(.a(new_n290_), .O(new_n291_));
  nand2  g128(.a(new_n291_), .b(new_n288_), .O(new_n292_));
  nor2   g129(.a(x75), .b(x67), .O(new_n293_));
  inv1   g130(.a(new_n168_), .O(new_n294_));
  nand2  g131(.a(new_n294_), .b(x79), .O(new_n295_));
  nor2   g132(.a(new_n295_), .b(new_n293_), .O(new_n296_));
  nand2  g133(.a(new_n296_), .b(new_n216_), .O(new_n297_));
  aoi21  g134(.a(new_n297_), .b(new_n292_), .c(x01), .O(z47));
  ...
  inv1   g139(.a(new_n216_), .O(new_n303_));
  nor2   g140(.a(new_n295_), .b(new_n303_), .O(new_n304_));
  nand2  g141(.a(new_n304_), .b(x68), .O(new_n305_));
  aoi21  g142(.a(new_n305_), .b(new_n302_), .c(x01), .O(z48));
  inv1   g143(.a(x09), .O(new_n307_));
  nand2  g144(.a(x52), .b(x17), .O(new_n308_));
  oai21  g145(.a(x52), .b(new_n307_), .c(new_n308_), .O(new_n309_));
  nand2  g146(.a(new_n309_), .b(new_n291_), .O(new_n310_));
  nand2  g147(.a(new_n304_), .b(x69), .O(new_n311_));
  aoi21  g148(.a(new_n311_), .b(new_n310_), .c(x01), .O(z49));
  inv1   g149(.a(x10), .O(new_n313_));
  nand2  g150(.a(x52), .b(x18), .O(new_n314_));
  oai21  g151(.a(x52), .b(new_n313_), .c(new_n314_), .O(new_n315_));
  nand2  g152(.a(new_n315_), .b(new_n291_), .O(new_n316_));
  nand2  g153(.a(new_n304_), .b(x70), .O(new_n317_));
  ...
  nand2  g158(.a(new_n321_), .b(new_n291_), .O(new_n322_));
  nand2  g159(.a(new_n304_), .b(x71), .O(new_n323_));
  ...
  nand2  g164(.a(new_n327_), .b(new_n291_), .O(new_n328_));
  nand2  g165(.a(new_n304_), .b(x72), .O(new_n329_));
  aoi21  g166(.a(new_n329_), .b(new_n328_), .c(x01), .O(z52));
  inv1   g167(.a(x14), .O(new_n332_));
  nor2   g168(.a(x52), .b(new_n332_), .O(new_n333_));
  aoi21  g169(.a(x52), .b(x22), .c(new_n333_), .O(new_n334_));
  inv1   g170(.a(new_n167_), .O(new_n335_));
  nand4  g171(.a(new_n335_), .b(new_n154_), .c(x04), .d(new_n153_), .O(new_n336_));
  nor2   g172(.a(new_n336_), .b(new_n334_), .O(z54));
  inv1   g173(.a(x76), .O(new_n339_));
  xnor2a g174(.a(x84), .b(x81), .O(new_n340_));
  aoi21  g175(.a(new_n168_), .b(new_n167_), .c(new_n340_), .O(new_n341_));
  nand2  g176(.a(new_n341_), .b(new_n153_), .O(new_n342_));
  oai21  g177(.a(new_n161_), .b(new_n339_), .c(new_n342_), .O(new_n343_));
  nand2  g178(.a(new_n343_), .b(x79), .O(new_n344_));
  nand3  g179(.a(new_n160_), .b(new_n159_), .c(new_n153_), .O(new_n345_));
  nand3  g180(.a(new_n345_), .b(new_n344_), .c(new_n232_), .O(z56));
  inv1   g181(.a(x02), .O(new_n347_));
  nand3  g182(.a(new_n232_), .b(x03), .c(new_n347_), .O(new_n348_));
  inv1   g183(.a(new_n348_), .O(z57));
  nand4  g184(.a(x80), .b(new_n221_), .c(x43), .d(new_n235_), .O(new_n350_));
  oai22  g185(.a(new_n350_), .b(new_n220_), .c(new_n235_), .d(x40), .O(new_n351_));
  nand3  g186(.a(new_n351_), .b(new_n226_), .c(x79), .O(new_n352_));
  nor2   g187(.a(x79), .b(x78), .O(new_n353_));
  nand3  g188(.a(new_n353_), .b(new_n235_), .c(x40), .O(new_n354_));
  nand2  g189(.a(new_n354_), .b(new_n352_), .O(new_n355_));
  nand2  g190(.a(new_n355_), .b(x77), .O(new_n356_));
  oai21  g191(.a(new_n335_), .b(new_n229_), .c(new_n154_), .O(new_n357_));
  ...
  oai21  g195(.a(new_n222_), .b(new_n220_), .c(new_n235_), .O(new_n361_));
  ...
  nand2  g203(.a(new_n168_), .b(new_n167_), .O(new_n369_));
  aoi22  g204(.a(new_n369_), .b(new_n216_), .c(new_n161_), .d(new_n229_), .O(new_n370_));
  nand2  g205(.a(new_n170_), .b(x80), .O(new_n371_));
  nor2   g206(.a(new_n371_), .b(new_n370_), .O(z61));
  ...
  nand2  g217(.a(new_n382_), .b(new_n294_), .O(new_n383_));
  aoi21  g218(.a(new_n383_), .b(new_n381_), .c(x01), .O(z62));
  nand2  g219(.a(new_n170_), .b(x82), .O(new_n385_));
  nor2   g220(.a(new_n385_), .b(new_n370_), .O(z63));
  nand2  g221(.a(x83), .b(x79), .O(new_n387_));
  or2    g222(.a(new_n387_), .b(new_n370_), .O(new_n388_));
  aoi21  g223(.a(new_n388_), .b(new_n290_), .c(x01), .O(z64));
  nor2   g224(.a(new_n160_), .b(x04), .O(new_n390_));
  nor2   g225(.a(new_n236_), .b(x78), .O(new_n391_));
  oai21  g226(.a(new_n391_), .b(new_n390_), .c(x77), .O(new_n392_));
  nand2  g227(.a(new_n335_), .b(x81), .O(new_n393_));
