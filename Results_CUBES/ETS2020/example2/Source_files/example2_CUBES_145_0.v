// Benchmark "FAU" written by ABC on Fri Jul 10 18:19:57 2020
...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n288_, new_n290_, new_n293_, new_n297_, new_n305_, new_n306_,
  ...
  nand4  g101(.a(new_n248_), .b(new_n238_), .c(x47), .d(new_n241_), .O(new_n257_));
  inv1   g102(.a(new_n257_), .O(z29));
  nand4  g103(.a(new_n248_), .b(new_n238_), .c(x48), .d(new_n241_), .O(new_n259_));
  inv1   g104(.a(new_n259_), .O(z30));
  nand4  g105(.a(new_n248_), .b(new_n238_), .c(x49), .d(new_n241_), .O(new_n261_));
  inv1   g106(.a(new_n261_), .O(z31));
  nand4  g107(.a(new_n248_), .b(new_n238_), .c(x50), .d(new_n241_), .O(new_n263_));
  inv1   g108(.a(new_n263_), .O(z32));
  nor2   g109(.a(new_n221_), .b(x81), .O(new_n265_));
  nor2   g110(.a(x83), .b(new_n245_), .O(new_n266_));
  nor2   g111(.a(new_n266_), .b(new_n265_), .O(new_n267_));
  nand2  g112(.a(x42), .b(x05), .O(new_n268_));
  nand2  g113(.a(x51), .b(new_n241_), .O(new_n269_));
  oai22  g114(.a(new_n269_), .b(new_n245_), .c(new_n268_), .d(new_n267_), .O(new_n270_));
  ...
  nand2  g120(.a(new_n238_), .b(new_n275_), .O(new_n276_));
  aoi21  g121(.a(new_n274_), .b(new_n271_), .c(new_n276_), .O(z33));
  inv1   g122(.a(x52), .O(new_n278_));
  inv1   g123(.a(new_n238_), .O(new_n279_));
  nand2  g124(.a(x83), .b(x42), .O(new_n280_));
  nand2  g125(.a(new_n280_), .b(new_n245_), .O(new_n281_));
  nand3  g126(.a(x83), .b(x81), .c(x42), .O(new_n282_));
  nand2  g127(.a(new_n282_), .b(new_n281_), .O(new_n283_));
  and2   g128(.a(new_n283_), .b(new_n246_), .O(new_n284_));
  nand2  g129(.a(new_n280_), .b(x81), .O(new_n285_));
  nand2  g130(.a(new_n265_), .b(x42), .O(new_n286_));
  aoi21  g131(.a(new_n286_), .b(new_n285_), .c(new_n242_), .O(new_n287_));
  oai21  g132(.a(new_n287_), .b(new_n284_), .c(new_n275_), .O(new_n288_));
  nor3   g133(.a(new_n288_), .b(new_n279_), .c(new_n278_), .O(z34));
  nand2  g134(.a(new_n238_), .b(x53), .O(new_n290_));
  nor2   g135(.a(new_n290_), .b(new_n288_), .O(z35));
  nand2  g136(.a(new_n238_), .b(x55), .O(new_n293_));
  nor2   g137(.a(new_n293_), .b(new_n288_), .O(z37));
  nand2  g138(.a(new_n238_), .b(x58), .O(new_n297_));
  nor2   g139(.a(new_n297_), .b(new_n288_), .O(z40));
  nor3   g140(.a(new_n288_), .b(new_n279_), .c(new_n186_), .O(z42));
  nor3   g141(.a(new_n288_), .b(new_n279_), .c(new_n183_), .O(z43));
  inv1   g142(.a(x07), .O(new_n305_));
  nand2  g143(.a(x52), .b(x15), .O(new_n306_));
  oai21  g144(.a(x52), .b(new_n305_), .c(new_n306_), .O(new_n307_));
  nor2   g145(.a(x79), .b(x77), .O(new_n308_));
  nand2  g146(.a(new_n308_), .b(new_n228_), .O(new_n309_));
  inv1   g147(.a(new_n309_), .O(new_n310_));
  nand2  g148(.a(new_n310_), .b(new_n307_), .O(new_n311_));
  nor2   g149(.a(x75), .b(x67), .O(new_n312_));
  inv1   g150(.a(new_n168_), .O(new_n313_));
  nand2  g151(.a(new_n313_), .b(x79), .O(new_n314_));
  nor2   g152(.a(new_n314_), .b(new_n312_), .O(new_n315_));
  nand2  g153(.a(new_n315_), .b(new_n218_), .O(new_n316_));
  aoi21  g154(.a(new_n316_), .b(new_n311_), .c(x01), .O(z47));
  inv1   g155(.a(x08), .O(new_n318_));
  nand2  g156(.a(x52), .b(x16), .O(new_n319_));
  oai21  g157(.a(x52), .b(new_n318_), .c(new_n319_), .O(new_n320_));
  nand2  g158(.a(new_n320_), .b(new_n310_), .O(new_n321_));
  inv1   g159(.a(new_n218_), .O(new_n322_));
  nor2   g160(.a(new_n314_), .b(new_n322_), .O(new_n323_));
  nand2  g161(.a(new_n323_), .b(x68), .O(new_n324_));
  aoi21  g162(.a(new_n324_), .b(new_n321_), .c(x01), .O(z48));
  inv1   g163(.a(x09), .O(new_n326_));
  nand2  g164(.a(x52), .b(x17), .O(new_n327_));
  oai21  g165(.a(x52), .b(new_n326_), .c(new_n327_), .O(new_n328_));
  nand2  g166(.a(new_n328_), .b(new_n310_), .O(new_n329_));
  nand2  g167(.a(new_n323_), .b(x69), .O(new_n330_));
  aoi21  g168(.a(new_n330_), .b(new_n329_), .c(x01), .O(z49));
  inv1   g169(.a(x10), .O(new_n332_));
  nand2  g170(.a(x52), .b(x18), .O(new_n333_));
  oai21  g171(.a(x52), .b(new_n332_), .c(new_n333_), .O(new_n334_));
  nand2  g172(.a(new_n334_), .b(new_n310_), .O(new_n335_));
  nand2  g173(.a(new_n323_), .b(x70), .O(new_n336_));
  aoi21  g174(.a(new_n336_), .b(new_n335_), .c(x01), .O(z50));
  inv1   g175(.a(x11), .O(new_n338_));
  nand2  g176(.a(x52), .b(x19), .O(new_n339_));
  oai21  g177(.a(x52), .b(new_n338_), .c(new_n339_), .O(new_n340_));
  nand2  g178(.a(new_n340_), .b(new_n310_), .O(new_n341_));
  nand2  g179(.a(new_n323_), .b(x71), .O(new_n342_));
  aoi21  g180(.a(new_n342_), .b(new_n341_), .c(x01), .O(z51));
  inv1   g181(.a(x12), .O(new_n344_));
  nand2  g182(.a(x52), .b(x20), .O(new_n345_));
  oai21  g183(.a(x52), .b(new_n344_), .c(new_n345_), .O(new_n346_));
  nand2  g184(.a(new_n346_), .b(new_n310_), .O(new_n347_));
  nand2  g185(.a(new_n323_), .b(x72), .O(new_n348_));
  aoi21  g186(.a(new_n348_), .b(new_n347_), .c(x01), .O(z52));
  nand2  g187(.a(x52), .b(x22), .O(new_n351_));
  nand2  g188(.a(new_n278_), .b(x14), .O(new_n352_));
  inv1   g189(.a(new_n167_), .O(new_n353_));
  ...
  nand3  g193(.a(new_n265_), .b(x84), .c(new_n356_), .O(new_n357_));
  inv1   g194(.a(x80), .O(new_n358_));
  nand4  g195(.a(new_n238_), .b(new_n161_), .c(new_n358_), .d(x79), .O(new_n359_));
  nor2   g196(.a(new_n359_), .b(new_n357_), .O(z55));
  nand2  g197(.a(new_n236_), .b(x76), .O(new_n361_));
  xnor2a g198(.a(x84), .b(x81), .O(new_n362_));
  aoi21  g199(.a(new_n168_), .b(new_n167_), .c(new_n362_), .O(new_n363_));
  ...
  nand3  g204(.a(new_n367_), .b(new_n366_), .c(new_n234_), .O(z56));
  inv1   g205(.a(x02), .O(new_n369_));
  nand3  g206(.a(new_n234_), .b(x03), .c(new_n369_), .O(new_n370_));
  inv1   g207(.a(new_n370_), .O(z57));
  nand4  g208(.a(x80), .b(new_n223_), .c(x43), .d(new_n241_), .O(new_n372_));
  oai22  g209(.a(new_n372_), .b(new_n222_), .c(new_n241_), .d(x40), .O(new_n373_));
  nand3  g210(.a(new_n373_), .b(new_n228_), .c(x79), .O(new_n374_));
  nor2   g211(.a(x79), .b(x78), .O(new_n375_));
  nand3  g212(.a(new_n375_), .b(new_n241_), .c(x40), .O(new_n376_));
  nand2  g213(.a(new_n376_), .b(new_n374_), .O(new_n377_));
  nand2  g214(.a(new_n377_), .b(x77), .O(new_n378_));
  oai21  g215(.a(new_n353_), .b(new_n231_), .c(new_n154_), .O(new_n379_));
  aoi21  g216(.a(new_n379_), .b(new_n378_), .c(x01), .O(z58));
  inv1   g217(.a(new_n375_), .O(new_n381_));
  aoi21  g218(.a(new_n227_), .b(new_n381_), .c(new_n152_), .O(new_n382_));
  oai21  g219(.a(new_n224_), .b(new_n222_), .c(new_n241_), .O(new_n383_));
  aoi21  g220(.a(new_n383_), .b(x79), .c(new_n227_), .O(new_n384_));
  ...
  aoi21  g226(.a(new_n389_), .b(new_n229_), .c(x01), .O(z60));
  inv1   g227(.a(new_n170_), .O(new_n391_));
  nand2  g228(.a(new_n168_), .b(new_n167_), .O(new_n392_));
  aoi22  g229(.a(new_n392_), .b(new_n218_), .c(new_n161_), .d(new_n231_), .O(new_n393_));
  nor3   g230(.a(new_n393_), .b(new_n391_), .c(new_n358_), .O(z61));
  nand3  g231(.a(x84), .b(x81), .c(x79), .O(new_n395_));
  oai21  g232(.a(x79), .b(new_n231_), .c(new_n395_), .O(new_n396_));
  nand2  g233(.a(new_n396_), .b(new_n159_), .O(new_n397_));
  nand2  g234(.a(new_n383_), .b(x79), .O(new_n398_));
  nand3  g235(.a(x81), .b(x79), .c(new_n231_), .O(new_n399_));
  inv1   g236(.a(new_n399_), .O(new_n400_));
  aoi21  g237(.a(new_n398_), .b(x04), .c(new_n400_), .O(new_n401_));
  oai21  g238(.a(new_n401_), .b(new_n159_), .c(new_n397_), .O(new_n402_));
  nand2  g239(.a(new_n402_), .b(x78), .O(new_n403_));
  inv1   g240(.a(new_n395_), .O(new_n404_));
  nand2  g241(.a(new_n404_), .b(new_n313_), .O(new_n405_));
  aoi21  g242(.a(new_n405_), .b(new_n403_), .c(x01), .O(z62));
  nor3   g243(.a(new_n393_), .b(new_n391_), .c(new_n356_), .O(z63));
  nand2  g244(.a(x83), .b(x79), .O(new_n408_));
  or2    g245(.a(new_n408_), .b(new_n393_), .O(new_n409_));
  aoi21  g246(.a(new_n409_), .b(new_n309_), .c(x01), .O(z64));
  nor2   g247(.a(new_n160_), .b(x04), .O(new_n411_));
  nor2   g248(.a(new_n245_), .b(x78), .O(new_n412_));
  oai21  g249(.a(new_n412_), .b(new_n411_), .c(x77), .O(new_n413_));
  nand2  g250(.a(new_n353_), .b(x81), .O(new_n414_));
  nand2  g251(.a(new_n170_), .b(x84), .O(new_n415_));
  aoi21  g252(.a(new_n414_), .b(new_n413_), .c(new_n415_), .O(z65));
  zero   g253(.O(z06));
  zero   g254(.O(z07));
  zero   g255(.O(z12));
  zero   g256(.O(z21));
