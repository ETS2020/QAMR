...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n304_, new_n307_, new_n315_, new_n316_, new_n317_, new_n318_,
  ...
  nand4  g108(.a(new_n259_), .b(new_n248_), .c(x46), .d(new_n251_), .O(new_n264_));
  inv1   g109(.a(new_n264_), .O(z28));
  ...
  nand4  g114(.a(new_n259_), .b(new_n248_), .c(x50), .d(new_n251_), .O(new_n271_));
  inv1   g115(.a(new_n271_), .O(z32));
  nor2   g116(.a(new_n234_), .b(x81), .O(new_n273_));
  nor2   g117(.a(x83), .b(new_n255_), .O(new_n274_));
  ...
  nand2  g137(.a(new_n273_), .b(x42), .O(new_n294_));
  ...
  nand2  g150(.a(new_n248_), .b(x58), .O(new_n307_));
  nor2   g151(.a(new_n307_), .b(new_n296_), .O(z40));
  nor3   g152(.a(new_n296_), .b(new_n287_), .c(new_n198_), .O(z42));
  nor3   g153(.a(new_n296_), .b(new_n287_), .c(new_n195_), .O(z43));
  nor3   g154(.a(new_n296_), .b(new_n287_), .c(new_n192_), .O(z44));
  nor3   g155(.a(new_n296_), .b(new_n287_), .c(new_n189_), .O(z45));
  nor3   g156(.a(new_n296_), .b(new_n287_), .c(new_n186_), .O(z46));
  ...
  nand2  g186(.a(new_n331_), .b(x72), .O(new_n346_));
  ...
  nand2  g192(.a(new_n331_), .b(x73), .O(new_n352_));
  aoi21  g193(.a(new_n352_), .b(new_n351_), .c(x01), .O(z53));
  nand2  g194(.a(x52), .b(x22), .O(new_n354_));
  nand2  g195(.a(new_n286_), .b(x14), .O(new_n355_));
  ...
  inv1   g199(.a(new_n273_), .O(new_n359_));
  ...
  nand3  g219(.a(new_n179_), .b(new_n251_), .c(x40), .O(new_n379_));
  ...
  aoi21  g224(.a(new_n163_), .b(new_n180_), .c(new_n152_), .O(new_n384_));
  ...
  nand3  g251(.a(new_n176_), .b(new_n159_), .c(x04), .O(new_n412_));
