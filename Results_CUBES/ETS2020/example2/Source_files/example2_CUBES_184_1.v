...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n274_, new_n276_, new_n278_, new_n280_, new_n285_, new_n288_,
  ...
  nand4  g093(.a(new_n242_), .b(new_n232_), .c(x48), .d(new_n235_), .O(new_n252_));
  inv1   g094(.a(new_n252_), .O(z30));
  nand4  g095(.a(new_n242_), .b(new_n232_), .c(x49), .d(new_n235_), .O(new_n254_));
  inv1   g096(.a(new_n254_), .O(z31));
  nand4  g097(.a(new_n242_), .b(new_n232_), .c(x50), .d(new_n235_), .O(new_n256_));
  inv1   g098(.a(new_n256_), .O(z32));
  inv1   g099(.a(new_n162_), .O(new_n262_));
  nor2   g100(.a(new_n217_), .b(new_n235_), .O(new_n263_));
  inv1   g101(.a(new_n263_), .O(new_n264_));
  nand2  g102(.a(new_n264_), .b(new_n236_), .O(new_n265_));
  nand2  g103(.a(new_n263_), .b(x81), .O(new_n266_));
  aoi21  g104(.a(new_n266_), .b(new_n265_), .c(new_n239_), .O(new_n267_));
  nand2  g105(.a(new_n264_), .b(x81), .O(new_n268_));
  nand2  g106(.a(new_n263_), .b(new_n236_), .O(new_n269_));
  aoi21  g107(.a(new_n269_), .b(new_n268_), .c(new_n237_), .O(new_n270_));
  oai21  g108(.a(new_n270_), .b(new_n267_), .c(new_n262_), .O(new_n271_));
  nand2  g109(.a(new_n232_), .b(x55), .O(new_n272_));
  nor2   g110(.a(new_n272_), .b(new_n271_), .O(z37));
  nand2  g111(.a(new_n232_), .b(x56), .O(new_n274_));
  nor2   g112(.a(new_n274_), .b(new_n271_), .O(z38));
  nand2  g113(.a(new_n232_), .b(x57), .O(new_n276_));
  nor2   g114(.a(new_n276_), .b(new_n271_), .O(z39));
  inv1   g115(.a(new_n232_), .O(new_n278_));
  nor3   g116(.a(new_n271_), .b(new_n278_), .c(new_n192_), .O(z40));
  nand2  g117(.a(new_n232_), .b(x59), .O(new_n280_));
  nor2   g118(.a(new_n280_), .b(new_n271_), .O(z41));
  nor3   g119(.a(new_n271_), .b(new_n278_), .c(new_n185_), .O(z43));
  nor3   g120(.a(new_n271_), .b(new_n278_), .c(new_n182_), .O(z44));
  nand2  g121(.a(new_n232_), .b(x63), .O(new_n285_));
  nor2   g122(.a(new_n285_), .b(new_n271_), .O(z45));
  inv1   g123(.a(x07), .O(new_n288_));
  nand2  g124(.a(x52), .b(x15), .O(new_n289_));
  oai21  g125(.a(x52), .b(new_n288_), .c(new_n289_), .O(new_n290_));
  nor2   g126(.a(x79), .b(x77), .O(new_n291_));
  nand2  g127(.a(new_n291_), .b(new_n224_), .O(new_n292_));
  inv1   g128(.a(new_n292_), .O(new_n293_));
  nand2  g129(.a(new_n293_), .b(new_n290_), .O(new_n294_));
  ...
  nand2  g147(.a(new_n311_), .b(new_n293_), .O(new_n312_));
  ...
  nand2  g153(.a(new_n317_), .b(new_n293_), .O(new_n318_));
  ...
  nand2  g159(.a(new_n324_), .b(new_n293_), .O(new_n325_));
  nand2  g160(.a(new_n306_), .b(x72), .O(new_n326_));
  aoi21  g161(.a(new_n326_), .b(new_n325_), .c(x01), .O(z52));
  inv1   g162(.a(x82), .O(new_n330_));
  nand4  g163(.a(x84), .b(x83), .c(new_n330_), .d(new_n236_), .O(new_n331_));
  inv1   g164(.a(x80), .O(new_n332_));
  nand4  g165(.a(new_n232_), .b(new_n161_), .c(new_n332_), .d(x79), .O(new_n333_));
  ...
  nand4  g175(.a(x80), .b(new_n219_), .c(x43), .d(new_n235_), .O(new_n344_));
  oai22  g176(.a(new_n344_), .b(new_n218_), .c(new_n235_), .d(x40), .O(new_n345_));
  nand3  g177(.a(new_n345_), .b(new_n224_), .c(x79), .O(new_n346_));
  nor2   g178(.a(x79), .b(x78), .O(new_n347_));
  nand3  g179(.a(new_n347_), .b(new_n235_), .c(x40), .O(new_n348_));
  nand2  g180(.a(new_n348_), .b(new_n346_), .O(new_n349_));
  nand2  g181(.a(new_n349_), .b(x77), .O(new_n350_));
  inv1   g182(.a(new_n167_), .O(new_n351_));
  oai21  g183(.a(new_n351_), .b(new_n227_), .c(new_n154_), .O(new_n352_));
  aoi21  g184(.a(new_n352_), .b(new_n350_), .c(x01), .O(z58));
  inv1   g185(.a(new_n347_), .O(new_n354_));
  aoi21  g186(.a(new_n223_), .b(new_n354_), .c(new_n152_), .O(new_n355_));
  oai21  g187(.a(new_n220_), .b(new_n218_), .c(new_n235_), .O(new_n356_));
  aoi21  g188(.a(new_n356_), .b(x79), .c(new_n223_), .O(new_n357_));
  ...
  nand2  g209(.a(new_n377_), .b(new_n296_), .O(new_n378_));
  ...
  aoi21  g214(.a(new_n382_), .b(new_n292_), .c(x01), .O(z64));
  nor2   g215(.a(new_n160_), .b(x04), .O(new_n384_));
  nor2   g216(.a(new_n236_), .b(x78), .O(new_n385_));
