...
module FAU ( 
  ...
  wire new_n154_, new_n155_, new_n156_, new_n157_, new_n158_, new_n159_,
    ...
    new_n264_, new_n267_, new_n270_, new_n272_, new_n274_, new_n276_,
    ...
    new_n339_, new_n340_, new_n341_, new_n344_, new_n345_;
  ...
  inv1   g050(.a(x81), .O(new_n215_));
  xor2a  g051(.a(x84), .b(x82), .O(new_n216_));
  xor2a  g052(.a(x84), .b(x82), .O(new_n217_));
  nand2  g053(.a(new_n217_), .b(new_n215_), .O(new_n218_));
  oai21  g054(.a(new_n216_), .b(new_n215_), .c(new_n218_), .O(new_n219_));
  nand3  g055(.a(x79), .b(x78), .c(x77), .O(new_n220_));
  inv1   g056(.a(new_n220_), .O(new_n221_));
  inv1   g057(.a(x42), .O(new_n222_));
  nand3  g058(.a(new_n210_), .b(x45), .c(new_n222_), .O(new_n223_));
  inv1   g059(.a(new_n223_), .O(new_n224_));
  nand3  g060(.a(new_n224_), .b(new_n221_), .c(new_n219_), .O(new_n225_));
  inv1   g061(.a(new_n225_), .O(z27));
  nand3  g062(.a(new_n210_), .b(x46), .c(new_n222_), .O(new_n227_));
  inv1   g063(.a(new_n227_), .O(new_n228_));
  nand3  g064(.a(new_n228_), .b(new_n221_), .c(new_n219_), .O(new_n229_));
  inv1   g065(.a(new_n229_), .O(z28));
  nand3  g066(.a(new_n210_), .b(x47), .c(new_n222_), .O(new_n231_));
  inv1   g067(.a(new_n231_), .O(new_n232_));
  nand3  g068(.a(new_n232_), .b(new_n221_), .c(new_n219_), .O(new_n233_));
  inv1   g069(.a(new_n233_), .O(z29));
  nand3  g070(.a(new_n210_), .b(x48), .c(new_n222_), .O(new_n235_));
  inv1   g071(.a(new_n235_), .O(new_n236_));
  nand3  g072(.a(new_n236_), .b(new_n221_), .c(new_n219_), .O(new_n237_));
  inv1   g073(.a(new_n237_), .O(z30));
  nand3  g074(.a(new_n210_), .b(x49), .c(new_n222_), .O(new_n239_));
  inv1   g075(.a(new_n239_), .O(new_n240_));
  nand3  g076(.a(new_n240_), .b(new_n221_), .c(new_n219_), .O(new_n241_));
  inv1   g077(.a(new_n241_), .O(z31));
  inv1   g078(.a(new_n216_), .O(new_n244_));
  xnor2a g079(.a(x83), .b(x81), .O(new_n245_));
  nand2  g080(.a(x42), .b(x05), .O(new_n246_));
  nand2  g081(.a(x51), .b(new_n222_), .O(new_n247_));
  oai22  g082(.a(new_n247_), .b(new_n215_), .c(new_n246_), .d(new_n245_), .O(new_n248_));
  ...
  nand2  g086(.a(new_n251_), .b(new_n217_), .O(new_n252_));
  nand2  g087(.a(new_n221_), .b(new_n210_), .O(new_n253_));
  ...
  nand2  g091(.a(new_n256_), .b(new_n215_), .O(new_n257_));
  ...
  nand3  g095(.a(x83), .b(new_n215_), .c(x42), .O(new_n261_));
  aoi21  g096(.a(new_n261_), .b(new_n260_), .c(new_n216_), .O(new_n262_));
  oai21  g097(.a(new_n262_), .b(new_n259_), .c(new_n221_), .O(new_n263_));
  nand2  g098(.a(new_n210_), .b(x52), .O(new_n264_));
  nor2   g099(.a(new_n264_), .b(new_n263_), .O(z34));
  nand2  g100(.a(new_n210_), .b(x54), .O(new_n267_));
  nor2   g101(.a(new_n267_), .b(new_n263_), .O(z36));
  nand2  g102(.a(new_n210_), .b(x56), .O(new_n270_));
  nor2   g103(.a(new_n270_), .b(new_n263_), .O(z38));
  nand2  g104(.a(new_n210_), .b(x57), .O(new_n272_));
  nor2   g105(.a(new_n272_), .b(new_n263_), .O(z39));
  nand2  g106(.a(new_n210_), .b(x58), .O(new_n274_));
  nor2   g107(.a(new_n274_), .b(new_n263_), .O(z40));
  nand2  g108(.a(new_n210_), .b(x59), .O(new_n276_));
  nor2   g109(.a(new_n276_), .b(new_n263_), .O(z41));
  nand2  g110(.a(new_n210_), .b(x60), .O(new_n278_));
  nor2   g111(.a(new_n278_), .b(new_n263_), .O(z42));
  nand2  g112(.a(new_n210_), .b(x61), .O(new_n280_));
  nor2   g113(.a(new_n280_), .b(new_n263_), .O(z43));
  nand2  g114(.a(new_n210_), .b(x62), .O(new_n282_));
  nor2   g115(.a(new_n282_), .b(new_n263_), .O(z44));
  nand2  g116(.a(new_n210_), .b(x63), .O(new_n284_));
  nor2   g117(.a(new_n284_), .b(new_n263_), .O(z45));
  nand2  g118(.a(new_n210_), .b(x64), .O(new_n286_));
  nor2   g119(.a(new_n286_), .b(new_n263_), .O(z46));
  ...
  nand3  g135(.a(new_n303_), .b(new_n293_), .c(new_n292_), .O(new_n304_));
  nand4  g136(.a(new_n297_), .b(new_n295_), .c(x79), .d(x69), .O(new_n305_));
  ...
  nand3  g141(.a(new_n309_), .b(new_n293_), .c(new_n292_), .O(new_n310_));
  nand4  g142(.a(new_n297_), .b(new_n295_), .c(x79), .d(x70), .O(new_n311_));
  ...
  nor2   g165(.a(new_n291_), .b(x01), .O(new_n334_));
  nand4  g166(.a(new_n334_), .b(new_n206_), .c(x78), .d(new_n154_), .O(new_n335_));
  nor2   g167(.a(new_n335_), .b(new_n333_), .O(z54));
  inv1   g168(.a(x82), .O(new_n337_));
  nand2  g169(.a(x84), .b(new_n337_), .O(new_n338_));
  nand2  g170(.a(x83), .b(new_n215_), .O(new_n339_));
  nor2   g171(.a(x80), .b(new_n206_), .O(new_n340_));
  nand3  g172(.a(new_n340_), .b(new_n210_), .c(new_n207_), .O(new_n341_));
  nor3   g173(.a(new_n341_), .b(new_n339_), .c(new_n338_), .O(z55));
  inv1   g174(.a(x02), .O(new_n344_));
  nand4  g175(.a(x03), .b(new_n344_), .c(new_n158_), .d(x00), .O(new_n345_));
