...
module FAU ( 
  ...
  nand3  g136(.a(new_n225_), .b(new_n154_), .c(new_n159_), .O(new_n302_));
  ...
  and2   g142(.a(new_n307_), .b(new_n215_), .O(new_n308_));
  ...
  nand3  g174(.a(new_n160_), .b(new_n159_), .c(new_n153_), .O(new_n343_));
  nand3  g175(.a(new_n343_), .b(new_n342_), .c(new_n231_), .O(z56));
  inv1   g176(.a(x02), .O(new_n345_));
  nand3  g177(.a(new_n231_), .b(x03), .c(new_n345_), .O(new_n346_));
  inv1   g178(.a(new_n346_), .O(z57));
  nand4  g179(.a(x80), .b(new_n220_), .c(x43), .d(new_n239_), .O(new_n348_));
  oai22  g180(.a(new_n348_), .b(new_n219_), .c(new_n239_), .d(x40), .O(new_n349_));
  nand3  g181(.a(new_n349_), .b(new_n225_), .c(x79), .O(new_n350_));
  nor2   g182(.a(x79), .b(x78), .O(new_n351_));
  nand3  g183(.a(new_n351_), .b(new_n239_), .c(x40), .O(new_n352_));
  nand2  g184(.a(new_n352_), .b(new_n350_), .O(new_n353_));
  nand2  g185(.a(new_n353_), .b(x77), .O(new_n354_));
  oai21  g186(.a(new_n333_), .b(new_n228_), .c(new_n154_), .O(new_n355_));
  aoi21  g187(.a(new_n355_), .b(new_n354_), .c(x01), .O(z58));
  inv1   g188(.a(new_n351_), .O(new_n357_));
  aoi21  g189(.a(new_n224_), .b(new_n357_), .c(new_n152_), .O(new_n358_));
  oai21  g190(.a(new_n221_), .b(new_n219_), .c(new_n239_), .O(new_n359_));
  aoi21  g191(.a(new_n359_), .b(x79), .c(new_n224_), .O(new_n360_));
  ...
  aoi21  g196(.a(new_n339_), .b(x79), .c(new_n362_), .O(new_n365_));
  aoi21  g197(.a(new_n365_), .b(new_n226_), .c(x01), .O(z60));
  nand2  g198(.a(new_n213_), .b(new_n212_), .O(new_n367_));
  aoi22  g199(.a(new_n367_), .b(new_n215_), .c(new_n161_), .d(new_n228_), .O(new_n368_));
  nor2   g200(.a(new_n154_), .b(x01), .O(new_n369_));
  nand2  g201(.a(new_n369_), .b(x80), .O(new_n370_));
  nor2   g202(.a(new_n370_), .b(new_n368_), .O(z61));
  nand3  g203(.a(x84), .b(x81), .c(x79), .O(new_n372_));
  oai21  g204(.a(x79), .b(new_n228_), .c(new_n372_), .O(new_n373_));
  nand2  g205(.a(new_n373_), .b(new_n159_), .O(new_n374_));
  nand2  g206(.a(new_n359_), .b(x79), .O(new_n375_));
  nand3  g207(.a(x81), .b(x79), .c(new_n228_), .O(new_n376_));
