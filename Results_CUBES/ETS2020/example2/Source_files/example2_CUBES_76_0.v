...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n277_, new_n280_, new_n291_, new_n292_, new_n293_, new_n294_,
  ...
  nand2  g115(.a(new_n229_), .b(x53), .O(new_n277_));
  nor2   g116(.a(new_n277_), .b(new_n275_), .O(z35));
  nand2  g117(.a(new_n229_), .b(x55), .O(new_n280_));
  nor2   g118(.a(new_n280_), .b(new_n275_), .O(z37));
  nor3   g119(.a(new_n275_), .b(new_n266_), .c(new_n185_), .O(z41));
  nor3   g120(.a(new_n275_), .b(new_n266_), .c(new_n179_), .O(z43));
  nor3   g121(.a(new_n275_), .b(new_n266_), .c(new_n170_), .O(z46));
  ...
  inv1   g139(.a(new_n211_), .O(new_n308_));
  ...
  inv1   g143(.a(x10), .O(new_n313_));
  nand2  g144(.a(x52), .b(x18), .O(new_n314_));
  oai21  g145(.a(x52), .b(new_n313_), .c(new_n314_), .O(new_n315_));
  nand2  g146(.a(new_n315_), .b(new_n296_), .O(new_n316_));
  nand2  g147(.a(new_n309_), .b(x70), .O(new_n317_));
  aoi21  g148(.a(new_n317_), .b(new_n316_), .c(x01), .O(z50));
  inv1   g149(.a(x11), .O(new_n319_));
  nand2  g150(.a(x52), .b(x19), .O(new_n320_));
  oai21  g151(.a(x52), .b(new_n319_), .c(new_n320_), .O(new_n321_));
  nand2  g152(.a(new_n321_), .b(new_n296_), .O(new_n322_));
  nand2  g153(.a(new_n309_), .b(x71), .O(new_n323_));
  aoi21  g154(.a(new_n323_), .b(new_n322_), .c(x01), .O(z51));
  ...
  nand2  g162(.a(new_n265_), .b(x14), .O(new_n333_));
  inv1   g163(.a(new_n208_), .O(new_n334_));
  nand4  g164(.a(new_n334_), .b(new_n154_), .c(x04), .d(new_n153_), .O(new_n335_));
  aoi21  g165(.a(new_n333_), .b(new_n332_), .c(new_n335_), .O(z54));
  nand2  g166(.a(new_n160_), .b(new_n159_), .O(new_n338_));
  nand2  g167(.a(new_n227_), .b(x76), .O(new_n339_));
  xnor2a g168(.a(x84), .b(x81), .O(new_n340_));
  aoi21  g169(.a(new_n209_), .b(new_n208_), .c(new_n340_), .O(new_n341_));
  ...
  nand4  g173(.a(new_n344_), .b(new_n338_), .c(new_n153_), .d(x00), .O(z56));
  nand4  g174(.a(x80), .b(new_n216_), .c(x43), .d(new_n233_), .O(new_n347_));
  oai22  g175(.a(new_n347_), .b(new_n215_), .c(new_n233_), .d(x40), .O(new_n348_));
  nand3  g176(.a(new_n348_), .b(new_n221_), .c(x79), .O(new_n349_));
  nor2   g177(.a(x79), .b(x78), .O(new_n350_));
  nand3  g178(.a(new_n350_), .b(new_n233_), .c(x40), .O(new_n351_));
  nand2  g179(.a(new_n351_), .b(new_n349_), .O(new_n352_));
  nand2  g180(.a(new_n352_), .b(x77), .O(new_n353_));
  oai21  g181(.a(new_n334_), .b(new_n224_), .c(new_n154_), .O(new_n354_));
  aoi21  g182(.a(new_n354_), .b(new_n353_), .c(x01), .O(z58));
  inv1   g183(.a(new_n350_), .O(new_n356_));
  aoi21  g184(.a(new_n220_), .b(new_n356_), .c(new_n152_), .O(new_n357_));
  oai21  g185(.a(new_n217_), .b(new_n215_), .c(new_n233_), .O(new_n358_));
  aoi21  g186(.a(new_n358_), .b(x79), .c(new_n220_), .O(new_n359_));
  oai21  g187(.a(new_n359_), .b(new_n357_), .c(x77), .O(new_n360_));
  nor2   g188(.a(x79), .b(x04), .O(new_n361_));
  inv1   g189(.a(new_n361_), .O(new_n362_));
  aoi21  g190(.a(new_n362_), .b(new_n360_), .c(x01), .O(z59));
  aoi21  g191(.a(new_n341_), .b(x79), .c(new_n361_), .O(new_n364_));
  aoi21  g192(.a(new_n364_), .b(new_n222_), .c(x01), .O(z60));
  nand2  g193(.a(new_n209_), .b(new_n208_), .O(new_n366_));
  aoi22  g194(.a(new_n366_), .b(new_n211_), .c(new_n161_), .d(new_n224_), .O(new_n367_));
  nor2   g195(.a(new_n154_), .b(x01), .O(new_n368_));
  nand2  g196(.a(new_n368_), .b(x80), .O(new_n369_));
  nor2   g197(.a(new_n369_), .b(new_n367_), .O(z61));
  nand3  g198(.a(x84), .b(x81), .c(x79), .O(new_n371_));
  oai21  g199(.a(x79), .b(new_n224_), .c(new_n371_), .O(new_n372_));
  nand2  g200(.a(new_n372_), .b(new_n159_), .O(new_n373_));
  nand2  g201(.a(new_n358_), .b(x79), .O(new_n374_));
  nand3  g202(.a(x81), .b(x79), .c(new_n224_), .O(new_n375_));
  ...
  inv1   g207(.a(new_n371_), .O(new_n380_));
  nand2  g208(.a(new_n380_), .b(new_n299_), .O(new_n381_));
  aoi21  g209(.a(new_n381_), .b(new_n379_), .c(x01), .O(z62));
  nand2  g210(.a(new_n368_), .b(x82), .O(new_n383_));
  nor2   g211(.a(new_n383_), .b(new_n367_), .O(z63));
  nand2  g212(.a(x83), .b(x79), .O(new_n385_));
  or2    g213(.a(new_n385_), .b(new_n367_), .O(new_n386_));
  aoi21  g214(.a(new_n386_), .b(new_n295_), .c(x01), .O(z64));
  nor2   g215(.a(new_n160_), .b(x04), .O(new_n388_));
  nor2   g216(.a(new_n237_), .b(x78), .O(new_n389_));
  oai21  g217(.a(new_n389_), .b(new_n388_), .c(x77), .O(new_n390_));
  nand2  g218(.a(new_n334_), .b(x81), .O(new_n391_));
  nand2  g219(.a(new_n368_), .b(x84), .O(new_n392_));
