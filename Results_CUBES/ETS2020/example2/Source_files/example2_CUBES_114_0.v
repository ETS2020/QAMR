// Benchmark "FAU" written by ABC on Fri Jul 10 18:17:48 2020
...
module FAU ( 
  ...
  nand2  g130(.a(new_n233_), .b(x56), .O(new_n290_));
  nor2   g131(.a(new_n290_), .b(new_n282_), .O(z38));
  nor3   g132(.a(new_n282_), .b(new_n273_), .c(new_n181_), .O(z41));
  nand2  g133(.a(new_n233_), .b(x60), .O(new_n295_));
  nor2   g134(.a(new_n295_), .b(new_n282_), .O(z42));
  nor3   g135(.a(new_n282_), .b(new_n273_), .c(new_n174_), .O(z44));
  ...
  nand2  g181(.a(new_n272_), .b(x14), .O(new_n346_));
  inv1   g182(.a(new_n210_), .O(new_n347_));
  ...
  nand3  g186(.a(new_n259_), .b(x84), .c(new_n350_), .O(new_n351_));
  inv1   g187(.a(x80), .O(new_n352_));
  nand4  g188(.a(new_n233_), .b(new_n161_), .c(new_n352_), .d(x79), .O(new_n353_));
  nor2   g189(.a(new_n353_), .b(new_n351_), .O(z55));
  nand2  g190(.a(new_n231_), .b(x76), .O(new_n355_));
  xnor2a g191(.a(x84), .b(x81), .O(new_n356_));
  aoi21  g192(.a(new_n211_), .b(new_n210_), .c(new_n356_), .O(new_n357_));
  ...
  nand3  g197(.a(new_n361_), .b(new_n360_), .c(new_n229_), .O(z56));
  inv1   g198(.a(x02), .O(new_n363_));
  nand3  g199(.a(new_n229_), .b(x03), .c(new_n363_), .O(new_n364_));
  inv1   g200(.a(new_n364_), .O(z57));
  nand4  g201(.a(x80), .b(new_n218_), .c(x43), .d(new_n236_), .O(new_n366_));
  oai22  g202(.a(new_n366_), .b(new_n217_), .c(new_n236_), .d(x40), .O(new_n367_));
  nand3  g203(.a(new_n367_), .b(new_n223_), .c(x79), .O(new_n368_));
  nor2   g204(.a(x79), .b(x78), .O(new_n369_));
  nand3  g205(.a(new_n369_), .b(new_n236_), .c(x40), .O(new_n370_));
  nand2  g206(.a(new_n370_), .b(new_n368_), .O(new_n371_));
  nand2  g207(.a(new_n371_), .b(x77), .O(new_n372_));
  oai21  g208(.a(new_n347_), .b(new_n226_), .c(new_n154_), .O(new_n373_));
  aoi21  g209(.a(new_n373_), .b(new_n372_), .c(x01), .O(z58));
  inv1   g210(.a(new_n369_), .O(new_n375_));
  aoi21  g211(.a(new_n222_), .b(new_n375_), .c(new_n152_), .O(new_n376_));
  oai21  g212(.a(new_n219_), .b(new_n217_), .c(new_n236_), .O(new_n377_));
  aoi21  g213(.a(new_n377_), .b(x79), .c(new_n222_), .O(new_n378_));
  ...
  aoi21  g219(.a(new_n383_), .b(new_n224_), .c(x01), .O(z60));
  nand2  g220(.a(new_n211_), .b(new_n210_), .O(new_n385_));
  aoi22  g221(.a(new_n385_), .b(new_n213_), .c(new_n161_), .d(new_n226_), .O(new_n386_));
  ...
  oai21  g226(.a(x79), .b(new_n226_), .c(new_n390_), .O(new_n391_));
  nand2  g227(.a(new_n391_), .b(new_n159_), .O(new_n392_));
  nand2  g228(.a(new_n377_), .b(x79), .O(new_n393_));
  nand3  g229(.a(x81), .b(x79), .c(new_n226_), .O(new_n394_));
  ...
  nor2   g242(.a(new_n240_), .b(x78), .O(new_n407_));
