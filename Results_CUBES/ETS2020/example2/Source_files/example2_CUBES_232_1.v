...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n279_, new_n281_, new_n283_, new_n288_, new_n294_, new_n295_,
  ...
  nand2  g127(.a(new_n238_), .b(x61), .O(new_n288_));
  nor2   g128(.a(new_n288_), .b(new_n276_), .O(z43));
  ...
  nand4  g169(.a(x84), .b(x83), .c(new_n333_), .d(new_n243_), .O(new_n334_));
  inv1   g170(.a(x80), .O(new_n335_));
  nand4  g171(.a(new_n238_), .b(new_n161_), .c(new_n335_), .d(x79), .O(new_n336_));
  nor2   g172(.a(new_n336_), .b(new_n334_), .O(z55));
  nand2  g173(.a(new_n236_), .b(x76), .O(new_n338_));
  ...
  nand3  g179(.a(new_n160_), .b(new_n159_), .c(new_n153_), .O(new_n344_));
  nand3  g180(.a(new_n344_), .b(new_n343_), .c(new_n234_), .O(z56));
  inv1   g181(.a(x02), .O(new_n346_));
  nand3  g182(.a(new_n234_), .b(x03), .c(new_n346_), .O(new_n347_));
  inv1   g183(.a(new_n347_), .O(z57));
  nand4  g184(.a(x80), .b(new_n223_), .c(x43), .d(new_n242_), .O(new_n349_));
  oai22  g185(.a(new_n349_), .b(new_n222_), .c(new_n242_), .d(x40), .O(new_n350_));
  nand3  g186(.a(new_n350_), .b(new_n228_), .c(x79), .O(new_n351_));
  nor2   g187(.a(x79), .b(x78), .O(new_n352_));
  nand3  g188(.a(new_n352_), .b(new_n242_), .c(x40), .O(new_n353_));
  nand2  g189(.a(new_n353_), .b(new_n351_), .O(new_n354_));
  nand2  g190(.a(new_n354_), .b(x77), .O(new_n355_));
  inv1   g191(.a(new_n167_), .O(new_n356_));
  oai21  g192(.a(new_n356_), .b(new_n231_), .c(new_n154_), .O(new_n357_));
  aoi21  g193(.a(new_n357_), .b(new_n355_), .c(x01), .O(z58));
  inv1   g194(.a(new_n352_), .O(new_n359_));
  aoi21  g195(.a(new_n227_), .b(new_n359_), .c(new_n152_), .O(new_n360_));
  oai21  g196(.a(new_n224_), .b(new_n222_), .c(new_n242_), .O(new_n361_));
  aoi21  g197(.a(new_n361_), .b(x79), .c(new_n227_), .O(new_n362_));
  ...
  aoi21  g202(.a(new_n340_), .b(x79), .c(new_n364_), .O(new_n367_));
  aoi21  g203(.a(new_n367_), .b(new_n229_), .c(x01), .O(z60));
  inv1   g204(.a(new_n170_), .O(new_n369_));
  nand2  g205(.a(new_n168_), .b(new_n167_), .O(new_n370_));
  aoi22  g206(.a(new_n370_), .b(new_n218_), .c(new_n161_), .d(new_n231_), .O(new_n371_));
  nor3   g207(.a(new_n371_), .b(new_n369_), .c(new_n335_), .O(z61));
  nand3  g208(.a(x84), .b(x81), .c(x79), .O(new_n373_));
  oai21  g209(.a(x79), .b(new_n231_), .c(new_n373_), .O(new_n374_));
  nand2  g210(.a(new_n374_), .b(new_n159_), .O(new_n375_));
  nand2  g211(.a(new_n361_), .b(x79), .O(new_n376_));
  nand3  g212(.a(x81), .b(x79), .c(new_n231_), .O(new_n377_));
  inv1   g213(.a(new_n377_), .O(new_n378_));
  aoi21  g214(.a(new_n376_), .b(x04), .c(new_n378_), .O(new_n379_));
  oai21  g215(.a(new_n379_), .b(new_n159_), .c(new_n375_), .O(new_n380_));
  nand2  g216(.a(new_n380_), .b(x78), .O(new_n381_));
  inv1   g217(.a(new_n373_), .O(new_n382_));
  nand2  g218(.a(new_n382_), .b(new_n301_), .O(new_n383_));
  aoi21  g219(.a(new_n383_), .b(new_n381_), .c(x01), .O(z62));
  nor3   g220(.a(new_n371_), .b(new_n369_), .c(new_n333_), .O(z63));
  nand2  g221(.a(x83), .b(x79), .O(new_n386_));
  or2    g222(.a(new_n386_), .b(new_n371_), .O(new_n387_));
  aoi21  g223(.a(new_n387_), .b(new_n298_), .c(x01), .O(z64));
  nor2   g224(.a(new_n160_), .b(x04), .O(new_n389_));
  nor2   g225(.a(new_n243_), .b(x78), .O(new_n390_));
  oai21  g226(.a(new_n390_), .b(new_n389_), .c(x77), .O(new_n391_));
  nand2  g227(.a(new_n356_), .b(x81), .O(new_n392_));
  nand2  g228(.a(new_n170_), .b(x84), .O(new_n393_));
  aoi21  g229(.a(new_n392_), .b(new_n391_), .c(new_n393_), .O(z65));
  zero   g230(.O(z08));
  zero   g231(.O(z09));
  zero   g232(.O(z16));
  zero   g233(.O(z20));
