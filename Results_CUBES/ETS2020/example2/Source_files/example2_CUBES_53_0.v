...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n289_, new_n291_, new_n293_, new_n302_, new_n306_, new_n307_,
  ...
  nor3   g138(.a(new_n287_), .b(new_n278_), .c(new_n194_), .O(z40));
  nor3   g139(.a(new_n287_), .b(new_n278_), .c(new_n191_), .O(z41));
  nor3   g140(.a(new_n287_), .b(new_n278_), .c(new_n188_), .O(z42));
  nor3   g141(.a(new_n287_), .b(new_n278_), .c(new_n185_), .O(z43));
  nand2  g142(.a(new_n238_), .b(x63), .O(new_n302_));
  nor2   g143(.a(new_n302_), .b(new_n287_), .O(z45));
  nor3   g144(.a(new_n287_), .b(new_n278_), .c(new_n178_), .O(z46));
  inv1   g145(.a(x08), .O(new_n306_));
  nand2  g146(.a(x52), .b(x16), .O(new_n307_));
  oai21  g147(.a(x52), .b(new_n306_), .c(new_n307_), .O(new_n308_));
  nand3  g148(.a(new_n228_), .b(new_n154_), .c(new_n159_), .O(new_n309_));
  inv1   g149(.a(new_n309_), .O(new_n310_));
  nand2  g150(.a(new_n310_), .b(new_n308_), .O(new_n311_));
  inv1   g151(.a(new_n168_), .O(new_n312_));
  nand2  g152(.a(new_n312_), .b(x79), .O(new_n313_));
  inv1   g153(.a(new_n313_), .O(new_n314_));
  and2   g154(.a(new_n314_), .b(new_n218_), .O(new_n315_));
  nand2  g155(.a(new_n315_), .b(x68), .O(new_n316_));
  aoi21  g156(.a(new_n316_), .b(new_n311_), .c(x01), .O(z48));
  inv1   g157(.a(x10), .O(new_n319_));
  nand2  g158(.a(x52), .b(x18), .O(new_n320_));
  oai21  g159(.a(x52), .b(new_n319_), .c(new_n320_), .O(new_n321_));
  nand2  g160(.a(new_n321_), .b(new_n310_), .O(new_n322_));
  nand2  g161(.a(new_n315_), .b(x70), .O(new_n323_));
  aoi21  g162(.a(new_n323_), .b(new_n322_), .c(x01), .O(z50));
  inv1   g163(.a(x11), .O(new_n325_));
  nand2  g164(.a(x52), .b(x19), .O(new_n326_));
  oai21  g165(.a(x52), .b(new_n325_), .c(new_n326_), .O(new_n327_));
  nand2  g166(.a(new_n327_), .b(new_n310_), .O(new_n328_));
  nand2  g167(.a(new_n315_), .b(x71), .O(new_n329_));
  aoi21  g168(.a(new_n329_), .b(new_n328_), .c(x01), .O(z51));
  inv1   g169(.a(x13), .O(new_n332_));
  nand2  g170(.a(x52), .b(x21), .O(new_n333_));
  oai21  g171(.a(x52), .b(new_n332_), .c(new_n333_), .O(new_n334_));
  nand2  g172(.a(new_n334_), .b(new_n310_), .O(new_n335_));
  nand2  g173(.a(new_n315_), .b(x73), .O(new_n336_));
  aoi21  g174(.a(new_n336_), .b(new_n335_), .c(x01), .O(z53));
  nand2  g175(.a(x52), .b(x22), .O(new_n338_));
  nand2  g176(.a(new_n277_), .b(x14), .O(new_n339_));
  inv1   g177(.a(new_n167_), .O(new_n340_));
  nand4  g178(.a(new_n340_), .b(new_n154_), .c(x04), .d(new_n153_), .O(new_n341_));
  aoi21  g179(.a(new_n339_), .b(new_n338_), .c(new_n341_), .O(z54));
  inv1   g180(.a(x82), .O(new_n343_));
  nand3  g181(.a(new_n264_), .b(x84), .c(new_n343_), .O(new_n344_));
  inv1   g182(.a(x80), .O(new_n345_));
  nand4  g183(.a(new_n238_), .b(new_n161_), .c(new_n345_), .d(x79), .O(new_n346_));
  nor2   g184(.a(new_n346_), .b(new_n344_), .O(z55));
  nand2  g185(.a(new_n236_), .b(x76), .O(new_n348_));
  ...
  nand3  g192(.a(new_n354_), .b(new_n353_), .c(new_n234_), .O(z56));
  inv1   g193(.a(x02), .O(new_n356_));
  nand3  g194(.a(new_n234_), .b(x03), .c(new_n356_), .O(new_n357_));
  inv1   g195(.a(new_n357_), .O(z57));
  nand4  g196(.a(x80), .b(new_n223_), .c(x43), .d(new_n241_), .O(new_n359_));
  oai22  g197(.a(new_n359_), .b(new_n222_), .c(new_n241_), .d(x40), .O(new_n360_));
  nand3  g198(.a(new_n360_), .b(new_n228_), .c(x79), .O(new_n361_));
  nor2   g199(.a(x79), .b(x78), .O(new_n362_));
  nand3  g200(.a(new_n362_), .b(new_n241_), .c(x40), .O(new_n363_));
  nand2  g201(.a(new_n363_), .b(new_n361_), .O(new_n364_));
  nand2  g202(.a(new_n364_), .b(x77), .O(new_n365_));
  oai21  g203(.a(new_n340_), .b(new_n231_), .c(new_n154_), .O(new_n366_));
  aoi21  g204(.a(new_n366_), .b(new_n365_), .c(x01), .O(z58));
  inv1   g205(.a(new_n362_), .O(new_n368_));
  aoi21  g206(.a(new_n227_), .b(new_n368_), .c(new_n152_), .O(new_n369_));
  oai21  g207(.a(new_n224_), .b(new_n222_), .c(new_n241_), .O(new_n370_));
  aoi21  g208(.a(new_n370_), .b(x79), .c(new_n227_), .O(new_n371_));
  ...
  nand2  g229(.a(new_n391_), .b(new_n312_), .O(new_n392_));
  ...
  aoi21  g234(.a(new_n396_), .b(new_n309_), .c(x01), .O(z64));
  nor2   g235(.a(new_n160_), .b(x04), .O(new_n398_));
  nor2   g236(.a(new_n245_), .b(x78), .O(new_n399_));
