...
module FAU ( 
  ...
  wire new_n154_, new_n155_, new_n156_, new_n157_, new_n158_, new_n159_,
    ...
    new_n274_, new_n276_, new_n280_, new_n283_, new_n285_, new_n287_,
    ...
    new_n338_, new_n339_, new_n340_, new_n344_, new_n345_, new_n352_,
    new_n353_, new_n354_;
  ...
  nand3  g074(.a(new_n217_), .b(x48), .c(new_n216_), .O(new_n238_));
  inv1   g075(.a(new_n238_), .O(new_n239_));
  nand3  g076(.a(new_n239_), .b(new_n215_), .c(new_n213_), .O(new_n240_));
  inv1   g077(.a(new_n240_), .O(z30));
  nand3  g078(.a(new_n217_), .b(x49), .c(new_n216_), .O(new_n242_));
  inv1   g079(.a(new_n242_), .O(new_n243_));
  nand3  g080(.a(new_n243_), .b(new_n215_), .c(new_n213_), .O(new_n244_));
  inv1   g081(.a(new_n244_), .O(z31));
  inv1   g082(.a(new_n210_), .O(new_n247_));
  xnor2a g083(.a(x83), .b(x81), .O(new_n248_));
  nand2  g084(.a(x42), .b(x05), .O(new_n249_));
  nand2  g085(.a(x51), .b(new_n216_), .O(new_n250_));
  oai22  g086(.a(new_n250_), .b(new_n209_), .c(new_n249_), .d(new_n248_), .O(new_n251_));
  ...
  nand2  g090(.a(new_n254_), .b(new_n211_), .O(new_n255_));
  nand2  g091(.a(new_n217_), .b(new_n215_), .O(new_n256_));
  ...
  nand2  g095(.a(new_n260_), .b(new_n209_), .O(new_n261_));
  ...
  nand3  g099(.a(x83), .b(new_n209_), .c(x42), .O(new_n265_));
  aoi21  g100(.a(new_n265_), .b(new_n264_), .c(new_n210_), .O(new_n266_));
  oai21  g101(.a(new_n266_), .b(new_n263_), .c(new_n215_), .O(new_n267_));
  nand2  g102(.a(new_n217_), .b(x53), .O(new_n268_));
  nor2   g103(.a(new_n268_), .b(new_n267_), .O(z35));
  nand2  g104(.a(new_n217_), .b(x54), .O(new_n270_));
  nor2   g105(.a(new_n270_), .b(new_n267_), .O(z36));
  nand2  g106(.a(new_n217_), .b(x55), .O(new_n272_));
  nor2   g107(.a(new_n272_), .b(new_n267_), .O(z37));
  nand2  g108(.a(new_n217_), .b(x56), .O(new_n274_));
  nor2   g109(.a(new_n274_), .b(new_n267_), .O(z38));
  nand2  g110(.a(new_n217_), .b(x57), .O(new_n276_));
  nor2   g111(.a(new_n276_), .b(new_n267_), .O(z39));
  nand2  g112(.a(new_n217_), .b(x60), .O(new_n280_));
  nor2   g113(.a(new_n280_), .b(new_n267_), .O(z42));
  nand2  g114(.a(new_n217_), .b(x62), .O(new_n283_));
  nor2   g115(.a(new_n283_), .b(new_n267_), .O(z44));
  nand2  g116(.a(new_n217_), .b(x63), .O(new_n285_));
  nor2   g117(.a(new_n285_), .b(new_n267_), .O(z45));
  nand2  g118(.a(new_n217_), .b(x64), .O(new_n287_));
  ...
  inv1   g170(.a(x79), .O(new_n339_));
  nand4  g171(.a(new_n155_), .b(new_n339_), .c(x04), .d(new_n160_), .O(new_n340_));
  nor2   g172(.a(new_n340_), .b(new_n338_), .O(z54));
  inv1   g173(.a(x02), .O(new_n344_));
  nand4  g174(.a(x03), .b(new_n344_), .c(new_n160_), .d(x00), .O(new_n345_));
  inv1   g175(.a(new_n345_), .O(z57));
  oai21  g176(.a(new_n158_), .b(new_n155_), .c(new_n296_), .O(new_n352_));
  nand3  g177(.a(x78), .b(x77), .c(new_n292_), .O(new_n353_));
