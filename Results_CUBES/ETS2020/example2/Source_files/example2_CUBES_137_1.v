// Benchmark "FAU" written by ABC on Fri Jul 10 18:19:23 2020
...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n276_, new_n282_, new_n285_, new_n286_, new_n287_, new_n288_,
  ...
  nand4  g090(.a(new_n240_), .b(new_n230_), .c(x47), .d(new_n233_), .O(new_n249_));
  inv1   g091(.a(new_n249_), .O(z29));
  nand4  g092(.a(new_n240_), .b(new_n230_), .c(x48), .d(new_n233_), .O(new_n251_));
  inv1   g093(.a(new_n251_), .O(z30));
  nand4  g094(.a(new_n240_), .b(new_n230_), .c(x49), .d(new_n233_), .O(new_n253_));
  inv1   g095(.a(new_n253_), .O(z31));
  nand4  g096(.a(new_n240_), .b(new_n230_), .c(x50), .d(new_n233_), .O(new_n255_));
  inv1   g097(.a(new_n255_), .O(z32));
  inv1   g098(.a(new_n162_), .O(new_n261_));
  nor2   g099(.a(new_n215_), .b(new_n233_), .O(new_n262_));
  inv1   g100(.a(new_n262_), .O(new_n263_));
  nand2  g101(.a(new_n263_), .b(new_n234_), .O(new_n264_));
  nand2  g102(.a(new_n262_), .b(x81), .O(new_n265_));
  aoi21  g103(.a(new_n265_), .b(new_n264_), .c(new_n237_), .O(new_n266_));
  nand2  g104(.a(new_n263_), .b(x81), .O(new_n267_));
  nand2  g105(.a(new_n262_), .b(new_n234_), .O(new_n268_));
  aoi21  g106(.a(new_n268_), .b(new_n267_), .c(new_n235_), .O(new_n269_));
  oai21  g107(.a(new_n269_), .b(new_n266_), .c(new_n261_), .O(new_n270_));
  nand2  g108(.a(new_n230_), .b(x55), .O(new_n271_));
  nor2   g109(.a(new_n271_), .b(new_n270_), .O(z37));
  nand2  g110(.a(new_n230_), .b(x57), .O(new_n274_));
  nor2   g111(.a(new_n274_), .b(new_n270_), .O(z39));
  inv1   g112(.a(new_n230_), .O(new_n276_));
  nor3   g113(.a(new_n270_), .b(new_n276_), .c(new_n192_), .O(z40));
  nor3   g114(.a(new_n270_), .b(new_n276_), .c(new_n189_), .O(z41));
  nor3   g115(.a(new_n270_), .b(new_n276_), .c(new_n183_), .O(z43));
  nor3   g116(.a(new_n270_), .b(new_n276_), .c(new_n180_), .O(z44));
  nand2  g117(.a(new_n230_), .b(x63), .O(new_n282_));
  nor2   g118(.a(new_n282_), .b(new_n270_), .O(z45));
  nor3   g119(.a(new_n270_), .b(new_n276_), .c(new_n176_), .O(z46));
  inv1   g120(.a(x07), .O(new_n285_));
  nand2  g121(.a(x52), .b(x15), .O(new_n286_));
  oai21  g122(.a(x52), .b(new_n285_), .c(new_n286_), .O(new_n287_));
  nor2   g123(.a(x79), .b(x77), .O(new_n288_));
  nand2  g124(.a(new_n288_), .b(new_n222_), .O(new_n289_));
  inv1   g125(.a(new_n289_), .O(new_n290_));
  nand2  g126(.a(new_n290_), .b(new_n287_), .O(new_n291_));
  nor2   g127(.a(x75), .b(x67), .O(new_n292_));
  inv1   g128(.a(new_n168_), .O(new_n293_));
  nand2  g129(.a(new_n293_), .b(x79), .O(new_n294_));
  nor2   g130(.a(new_n294_), .b(new_n292_), .O(new_n295_));
  nand2  g131(.a(new_n295_), .b(new_n212_), .O(new_n296_));
  aoi21  g132(.a(new_n296_), .b(new_n291_), .c(x01), .O(z47));
  inv1   g133(.a(x08), .O(new_n298_));
  nand2  g134(.a(x52), .b(x16), .O(new_n299_));
  oai21  g135(.a(x52), .b(new_n298_), .c(new_n299_), .O(new_n300_));
  nand2  g136(.a(new_n300_), .b(new_n290_), .O(new_n301_));
  inv1   g137(.a(new_n212_), .O(new_n302_));
  ...
  nand2  g144(.a(new_n308_), .b(new_n290_), .O(new_n309_));
  ...
  nand2  g150(.a(new_n314_), .b(new_n290_), .O(new_n315_));
  ...
  nand2  g156(.a(new_n320_), .b(new_n290_), .O(new_n321_));
  nand2  g157(.a(new_n303_), .b(x71), .O(new_n322_));
  aoi21  g158(.a(new_n322_), .b(new_n321_), .c(x01), .O(z51));
  inv1   g159(.a(x12), .O(new_n324_));
  nand2  g160(.a(x52), .b(x20), .O(new_n325_));
  oai21  g161(.a(x52), .b(new_n324_), .c(new_n325_), .O(new_n326_));
  nand2  g162(.a(new_n326_), .b(new_n290_), .O(new_n327_));
  nand2  g163(.a(new_n303_), .b(x72), .O(new_n328_));
  aoi21  g164(.a(new_n328_), .b(new_n327_), .c(x01), .O(z52));
  inv1   g165(.a(x13), .O(new_n330_));
  nand2  g166(.a(x52), .b(x21), .O(new_n331_));
  oai21  g167(.a(x52), .b(new_n330_), .c(new_n331_), .O(new_n332_));
  nand2  g168(.a(new_n332_), .b(new_n290_), .O(new_n333_));
  nand2  g169(.a(new_n303_), .b(x73), .O(new_n334_));
  aoi21  g170(.a(new_n334_), .b(new_n333_), .c(x01), .O(z53));
  inv1   g171(.a(x82), .O(new_n337_));
  nand4  g172(.a(x84), .b(x83), .c(new_n337_), .d(new_n234_), .O(new_n338_));
  inv1   g173(.a(x80), .O(new_n339_));
  nand4  g174(.a(new_n230_), .b(new_n161_), .c(new_n339_), .d(x79), .O(new_n340_));
  nor2   g175(.a(new_n340_), .b(new_n338_), .O(z55));
  nand2  g176(.a(new_n160_), .b(new_n159_), .O(new_n342_));
  nand2  g177(.a(new_n228_), .b(x76), .O(new_n343_));
  ...
  nand2  g181(.a(new_n346_), .b(new_n343_), .O(new_n347_));
  nand2  g182(.a(new_n347_), .b(x79), .O(new_n348_));
  nand4  g183(.a(new_n348_), .b(new_n342_), .c(new_n153_), .d(x00), .O(z56));
  nand4  g184(.a(x80), .b(new_n217_), .c(x43), .d(new_n233_), .O(new_n351_));
  oai22  g185(.a(new_n351_), .b(new_n216_), .c(new_n233_), .d(x40), .O(new_n352_));
  nand3  g186(.a(new_n352_), .b(new_n222_), .c(x79), .O(new_n353_));
  nor2   g187(.a(x79), .b(x78), .O(new_n354_));
  nand3  g188(.a(new_n354_), .b(new_n233_), .c(x40), .O(new_n355_));
  nand2  g189(.a(new_n355_), .b(new_n353_), .O(new_n356_));
  nand2  g190(.a(new_n356_), .b(x77), .O(new_n357_));
  inv1   g191(.a(new_n167_), .O(new_n358_));
  oai21  g192(.a(new_n358_), .b(new_n225_), .c(new_n154_), .O(new_n359_));
  aoi21  g193(.a(new_n359_), .b(new_n357_), .c(x01), .O(z58));
  inv1   g194(.a(new_n354_), .O(new_n361_));
  aoi21  g195(.a(new_n221_), .b(new_n361_), .c(new_n152_), .O(new_n362_));
  oai21  g196(.a(new_n218_), .b(new_n216_), .c(new_n233_), .O(new_n363_));
  aoi21  g197(.a(new_n363_), .b(x79), .c(new_n221_), .O(new_n364_));
  ...
  aoi21  g202(.a(new_n345_), .b(x79), .c(new_n366_), .O(new_n369_));
  aoi21  g203(.a(new_n369_), .b(new_n223_), .c(x01), .O(z60));
  inv1   g204(.a(new_n170_), .O(new_n371_));
  nand2  g205(.a(new_n168_), .b(new_n167_), .O(new_n372_));
  aoi22  g206(.a(new_n372_), .b(new_n212_), .c(new_n161_), .d(new_n225_), .O(new_n373_));
  nor3   g207(.a(new_n373_), .b(new_n371_), .c(new_n339_), .O(z61));
  nand3  g208(.a(x84), .b(x81), .c(x79), .O(new_n375_));
  oai21  g209(.a(x79), .b(new_n225_), .c(new_n375_), .O(new_n376_));
  nand2  g210(.a(new_n376_), .b(new_n159_), .O(new_n377_));
  nand2  g211(.a(new_n363_), .b(x79), .O(new_n378_));
  nand3  g212(.a(x81), .b(x79), .c(new_n225_), .O(new_n379_));
  ...
  nand2  g218(.a(new_n384_), .b(new_n293_), .O(new_n385_));
  aoi21  g219(.a(new_n385_), .b(new_n383_), .c(x01), .O(z62));
  nor3   g220(.a(new_n373_), .b(new_n371_), .c(new_n337_), .O(z63));
  nand2  g221(.a(x83), .b(x79), .O(new_n388_));
  or2    g222(.a(new_n388_), .b(new_n373_), .O(new_n389_));
  aoi21  g223(.a(new_n389_), .b(new_n289_), .c(x01), .O(z64));
  nor2   g224(.a(new_n160_), .b(x04), .O(new_n391_));
  nor2   g225(.a(new_n234_), .b(x78), .O(new_n392_));
  oai21  g226(.a(new_n392_), .b(new_n391_), .c(x77), .O(new_n393_));
  nand2  g227(.a(new_n358_), .b(x81), .O(new_n394_));
  nand2  g228(.a(new_n170_), .b(x84), .O(new_n395_));
