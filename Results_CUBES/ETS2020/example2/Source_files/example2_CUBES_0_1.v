...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n282_, new_n283_, new_n286_, new_n288_, new_n290_, new_n293_,
  ...
  nor3   g131(.a(new_n283_), .b(new_n274_), .c(new_n194_), .O(z39));
  nand2  g132(.a(new_n235_), .b(x58), .O(new_n293_));
  nor2   g133(.a(new_n293_), .b(new_n283_), .O(z40));
  nor3   g134(.a(new_n283_), .b(new_n274_), .c(new_n190_), .O(z41));
  nor3   g135(.a(new_n283_), .b(new_n274_), .c(new_n187_), .O(z42));
  nor3   g136(.a(new_n283_), .b(new_n274_), .c(new_n184_), .O(z43));
  nand2  g137(.a(new_n235_), .b(x63), .O(new_n299_));
  nor2   g138(.a(new_n299_), .b(new_n283_), .O(z45));
  nand2  g139(.a(new_n235_), .b(x64), .O(new_n301_));
  nor2   g140(.a(new_n301_), .b(new_n283_), .O(z46));
  inv1   g141(.a(x07), .O(new_n303_));
  nand2  g142(.a(x52), .b(x15), .O(new_n304_));
  oai21  g143(.a(x52), .b(new_n303_), .c(new_n304_), .O(new_n305_));
  nor2   g144(.a(x79), .b(x77), .O(new_n306_));
  nand2  g145(.a(new_n306_), .b(new_n225_), .O(new_n307_));
  inv1   g146(.a(new_n307_), .O(new_n308_));
  nand2  g147(.a(new_n308_), .b(new_n305_), .O(new_n309_));
  nor2   g148(.a(x75), .b(x67), .O(new_n310_));
  nand2  g149(.a(new_n168_), .b(x79), .O(new_n311_));
  nor2   g150(.a(new_n311_), .b(new_n310_), .O(new_n312_));
  nand2  g151(.a(new_n312_), .b(new_n215_), .O(new_n313_));
  aoi21  g152(.a(new_n313_), .b(new_n309_), .c(x01), .O(z47));
  inv1   g153(.a(x08), .O(new_n315_));
  nand2  g154(.a(x52), .b(x16), .O(new_n316_));
  oai21  g155(.a(x52), .b(new_n315_), .c(new_n316_), .O(new_n317_));
  nand2  g156(.a(new_n317_), .b(new_n308_), .O(new_n318_));
  ...
  nand2  g176(.a(new_n337_), .b(new_n308_), .O(new_n338_));
  ...
  nand2  g182(.a(new_n343_), .b(new_n308_), .O(new_n344_));
  nand2  g183(.a(new_n320_), .b(x72), .O(new_n345_));
  aoi21  g184(.a(new_n345_), .b(new_n344_), .c(x01), .O(z52));
  nand2  g185(.a(x52), .b(x22), .O(new_n348_));
  nand2  g186(.a(new_n273_), .b(x14), .O(new_n349_));
  nand4  g187(.a(new_n166_), .b(new_n154_), .c(x04), .d(new_n153_), .O(new_n350_));
  aoi21  g188(.a(new_n349_), .b(new_n348_), .c(new_n350_), .O(z54));
  inv1   g189(.a(x82), .O(new_n352_));
  nand3  g190(.a(new_n260_), .b(x84), .c(new_n352_), .O(new_n353_));
  nor2   g191(.a(x80), .b(new_n154_), .O(new_n354_));
  nand3  g192(.a(new_n354_), .b(new_n235_), .c(new_n161_), .O(new_n355_));
  nor2   g193(.a(new_n355_), .b(new_n353_), .O(z55));
  nand2  g194(.a(new_n233_), .b(x76), .O(new_n357_));
  inv1   g195(.a(new_n168_), .O(new_n358_));
  xnor2a g196(.a(x84), .b(x81), .O(new_n359_));
  aoi21  g197(.a(new_n358_), .b(new_n167_), .c(new_n359_), .O(new_n360_));
  ...
  nand4  g206(.a(x80), .b(new_n220_), .c(x43), .d(new_n239_), .O(new_n369_));
  oai22  g207(.a(new_n369_), .b(new_n219_), .c(new_n239_), .d(x40), .O(new_n370_));
  nand3  g208(.a(new_n370_), .b(new_n225_), .c(x79), .O(new_n371_));
  nor2   g209(.a(x79), .b(x78), .O(new_n372_));
  nand3  g210(.a(new_n372_), .b(new_n239_), .c(x40), .O(new_n373_));
  nand2  g211(.a(new_n373_), .b(new_n371_), .O(new_n374_));
  nand2  g212(.a(new_n374_), .b(x77), .O(new_n375_));
  oai21  g213(.a(new_n166_), .b(new_n228_), .c(new_n154_), .O(new_n376_));
  ...
  oai21  g217(.a(new_n221_), .b(new_n219_), .c(new_n239_), .O(new_n380_));
  ...
  nand3  g225(.a(x84), .b(x81), .c(x79), .O(new_n389_));
  oai21  g226(.a(x79), .b(new_n228_), .c(new_n389_), .O(new_n390_));
  nand2  g227(.a(new_n390_), .b(new_n159_), .O(new_n391_));
  nand2  g228(.a(new_n380_), .b(x79), .O(new_n392_));
  nand3  g229(.a(x81), .b(x79), .c(new_n228_), .O(new_n393_));
  ...
  inv1   g234(.a(new_n389_), .O(new_n398_));
  nand2  g235(.a(new_n398_), .b(new_n168_), .O(new_n399_));
  aoi21  g236(.a(new_n399_), .b(new_n397_), .c(x01), .O(z62));
  oai21  g237(.a(new_n168_), .b(new_n166_), .c(new_n215_), .O(new_n401_));
  oai21  g238(.a(new_n233_), .b(x04), .c(new_n401_), .O(new_n402_));
  nand2  g239(.a(new_n171_), .b(x82), .O(new_n403_));
  inv1   g240(.a(new_n403_), .O(new_n404_));
  and2   g241(.a(new_n404_), .b(new_n402_), .O(z63));
  nand3  g242(.a(new_n402_), .b(x83), .c(x79), .O(new_n406_));
  aoi21  g243(.a(new_n406_), .b(new_n307_), .c(x01), .O(z64));
  nor2   g244(.a(new_n160_), .b(x04), .O(new_n408_));
  nor2   g245(.a(new_n243_), .b(x78), .O(new_n409_));
  oai21  g246(.a(new_n409_), .b(new_n408_), .c(x77), .O(new_n410_));
  nand2  g247(.a(new_n166_), .b(x81), .O(new_n411_));
  nand2  g248(.a(new_n171_), .b(x84), .O(new_n412_));
