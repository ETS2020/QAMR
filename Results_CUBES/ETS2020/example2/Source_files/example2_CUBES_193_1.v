// Benchmark "FAU" written by ABC on Fri Jul 10 18:23:20 2020
...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n290_, new_n292_, new_n294_, new_n302_, new_n305_, new_n306_,
  ...
  inv1   g081(.a(new_n161_), .O(new_n236_));
  inv1   g082(.a(x43), .O(new_n237_));
  nor2   g083(.a(x04), .b(x01), .O(new_n238_));
  nand3  g084(.a(new_n238_), .b(new_n237_), .c(x05), .O(new_n239_));
  aoi21  g085(.a(new_n236_), .b(x79), .c(new_n239_), .O(z24));
  ...
  nand4  g100(.a(new_n249_), .b(new_n238_), .c(x47), .d(new_n242_), .O(new_n256_));
  inv1   g101(.a(new_n256_), .O(z29));
  nand4  g102(.a(new_n249_), .b(new_n238_), .c(x48), .d(new_n242_), .O(new_n258_));
  inv1   g103(.a(new_n258_), .O(z30));
  nand4  g104(.a(new_n249_), .b(new_n238_), .c(x49), .d(new_n242_), .O(new_n260_));
  inv1   g105(.a(new_n260_), .O(z31));
  nand4  g106(.a(new_n249_), .b(new_n238_), .c(x50), .d(new_n242_), .O(new_n262_));
  inv1   g107(.a(new_n262_), .O(z32));
  nor2   g108(.a(new_n223_), .b(x81), .O(new_n264_));
  nor2   g109(.a(x83), .b(new_n246_), .O(new_n265_));
  nor2   g110(.a(new_n265_), .b(new_n264_), .O(new_n266_));
  nand2  g111(.a(x42), .b(x05), .O(new_n267_));
  nand2  g112(.a(x51), .b(new_n242_), .O(new_n268_));
  oai22  g113(.a(new_n268_), .b(new_n246_), .c(new_n267_), .d(new_n266_), .O(new_n269_));
  nand2  g114(.a(new_n269_), .b(new_n244_), .O(new_n270_));
  ...
  nand2  g119(.a(new_n238_), .b(new_n274_), .O(new_n275_));
  aoi21  g120(.a(new_n273_), .b(new_n270_), .c(new_n275_), .O(z33));
  inv1   g121(.a(x52), .O(new_n277_));
  inv1   g122(.a(new_n238_), .O(new_n278_));
  ...
  nor2   g134(.a(new_n290_), .b(new_n287_), .O(z36));
  nand2  g135(.a(new_n238_), .b(x55), .O(new_n292_));
  nor2   g136(.a(new_n292_), .b(new_n287_), .O(z37));
  nand2  g137(.a(new_n238_), .b(x56), .O(new_n294_));
  nor2   g138(.a(new_n294_), .b(new_n287_), .O(z38));
  nor3   g139(.a(new_n287_), .b(new_n278_), .c(new_n195_), .O(z39));
  nor3   g140(.a(new_n287_), .b(new_n278_), .c(new_n192_), .O(z40));
  nor3   g141(.a(new_n287_), .b(new_n278_), .c(new_n189_), .O(z41));
  nor3   g142(.a(new_n287_), .b(new_n278_), .c(new_n186_), .O(z42));
  nand2  g143(.a(new_n238_), .b(x63), .O(new_n302_));
  nor2   g144(.a(new_n302_), .b(new_n287_), .O(z45));
  inv1   g145(.a(x07), .O(new_n305_));
  nand2  g146(.a(x52), .b(x15), .O(new_n306_));
  oai21  g147(.a(x52), .b(new_n305_), .c(new_n306_), .O(new_n307_));
  nand3  g148(.a(new_n230_), .b(new_n154_), .c(new_n159_), .O(new_n308_));
  inv1   g149(.a(new_n308_), .O(new_n309_));
  nand2  g150(.a(new_n309_), .b(new_n307_), .O(new_n310_));
  ...
  nand2  g168(.a(new_n328_), .b(new_n309_), .O(new_n329_));
  nand2  g169(.a(new_n322_), .b(x70), .O(new_n330_));
  ...
  nand2  g174(.a(new_n334_), .b(new_n309_), .O(new_n335_));
  nand2  g175(.a(new_n322_), .b(x71), .O(new_n336_));
  aoi21  g176(.a(new_n336_), .b(new_n335_), .c(x01), .O(z51));
  nand2  g177(.a(x52), .b(x22), .O(new_n340_));
  nand2  g178(.a(new_n277_), .b(x14), .O(new_n341_));
  inv1   g179(.a(new_n167_), .O(new_n342_));
  ...
  nand3  g183(.a(new_n264_), .b(x84), .c(new_n345_), .O(new_n346_));
  inv1   g184(.a(x80), .O(new_n347_));
  nand4  g185(.a(new_n238_), .b(new_n161_), .c(new_n347_), .d(x79), .O(new_n348_));
  nor2   g186(.a(new_n348_), .b(new_n346_), .O(z55));
  nand2  g187(.a(new_n160_), .b(new_n159_), .O(new_n350_));
  nand2  g188(.a(new_n236_), .b(x76), .O(new_n351_));
  xnor2a g189(.a(x84), .b(x81), .O(new_n352_));
  aoi21  g190(.a(new_n168_), .b(new_n167_), .c(new_n352_), .O(new_n353_));
  nand2  g191(.a(new_n353_), .b(new_n153_), .O(new_n354_));
  nand2  g192(.a(new_n354_), .b(new_n351_), .O(new_n355_));
  nand2  g193(.a(new_n355_), .b(x79), .O(new_n356_));
  nand4  g194(.a(new_n356_), .b(new_n350_), .c(new_n153_), .d(x00), .O(z56));
  nand4  g195(.a(x80), .b(new_n225_), .c(x43), .d(new_n242_), .O(new_n359_));
  oai22  g196(.a(new_n359_), .b(new_n224_), .c(new_n242_), .d(x40), .O(new_n360_));
  nand3  g197(.a(new_n360_), .b(new_n230_), .c(x79), .O(new_n361_));
  nor2   g198(.a(x79), .b(x78), .O(new_n362_));
  nand3  g199(.a(new_n362_), .b(new_n242_), .c(x40), .O(new_n363_));
  nand2  g200(.a(new_n363_), .b(new_n361_), .O(new_n364_));
  nand2  g201(.a(new_n364_), .b(x77), .O(new_n365_));
  oai21  g202(.a(new_n342_), .b(new_n233_), .c(new_n154_), .O(new_n366_));
  aoi21  g203(.a(new_n366_), .b(new_n365_), .c(x01), .O(z58));
  inv1   g204(.a(new_n362_), .O(new_n368_));
  aoi21  g205(.a(new_n229_), .b(new_n368_), .c(new_n152_), .O(new_n369_));
  oai21  g206(.a(new_n226_), .b(new_n224_), .c(new_n242_), .O(new_n370_));
  aoi21  g207(.a(new_n370_), .b(x79), .c(new_n229_), .O(new_n371_));
  oai21  g208(.a(new_n371_), .b(new_n369_), .c(x77), .O(new_n372_));
  nor2   g209(.a(x79), .b(x04), .O(new_n373_));
  inv1   g210(.a(new_n373_), .O(new_n374_));
  aoi21  g211(.a(new_n374_), .b(new_n372_), .c(x01), .O(z59));
  aoi21  g212(.a(new_n353_), .b(x79), .c(new_n373_), .O(new_n376_));
  aoi21  g213(.a(new_n376_), .b(new_n231_), .c(x01), .O(z60));
  inv1   g214(.a(new_n170_), .O(new_n378_));
  nand2  g215(.a(new_n168_), .b(new_n167_), .O(new_n379_));
  aoi22  g216(.a(new_n379_), .b(new_n220_), .c(new_n161_), .d(new_n233_), .O(new_n380_));
  nor3   g217(.a(new_n380_), .b(new_n378_), .c(new_n347_), .O(z61));
  nand3  g218(.a(x84), .b(x81), .c(x79), .O(new_n382_));
  oai21  g219(.a(x79), .b(new_n233_), .c(new_n382_), .O(new_n383_));
  nand2  g220(.a(new_n383_), .b(new_n159_), .O(new_n384_));
  nand2  g221(.a(new_n370_), .b(x79), .O(new_n385_));
  nand3  g222(.a(x81), .b(x79), .c(new_n233_), .O(new_n386_));
  ...
  nand2  g228(.a(new_n391_), .b(new_n312_), .O(new_n392_));
  aoi21  g229(.a(new_n392_), .b(new_n390_), .c(x01), .O(z62));
  nor3   g230(.a(new_n380_), .b(new_n378_), .c(new_n345_), .O(z63));
  nand2  g231(.a(x83), .b(x79), .O(new_n395_));
  or2    g232(.a(new_n395_), .b(new_n380_), .O(new_n396_));
  aoi21  g233(.a(new_n396_), .b(new_n308_), .c(x01), .O(z64));
  nor2   g234(.a(new_n160_), .b(x04), .O(new_n398_));
  nor2   g235(.a(new_n246_), .b(x78), .O(new_n399_));
  oai21  g236(.a(new_n399_), .b(new_n398_), .c(x77), .O(new_n400_));
  nand2  g237(.a(new_n342_), .b(x81), .O(new_n401_));
  nand2  g238(.a(new_n170_), .b(x84), .O(new_n402_));
