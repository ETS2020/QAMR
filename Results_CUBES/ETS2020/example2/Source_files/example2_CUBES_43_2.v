...
module FAU ( 
  ...
  nand3  g075(.a(new_n213_), .b(x47), .c(new_n223_), .O(new_n237_));
  inv1   g076(.a(new_n237_), .O(new_n238_));
  nand3  g077(.a(new_n238_), .b(new_n222_), .c(new_n220_), .O(new_n239_));
  inv1   g078(.a(new_n239_), .O(z29));
  nand3  g079(.a(new_n213_), .b(x49), .c(new_n223_), .O(new_n242_));
  inv1   g080(.a(new_n242_), .O(new_n243_));
  nand3  g081(.a(new_n243_), .b(new_n222_), .c(new_n220_), .O(new_n244_));
  inv1   g082(.a(new_n244_), .O(z31));
  nand3  g083(.a(new_n213_), .b(x50), .c(new_n223_), .O(new_n246_));
  inv1   g084(.a(new_n246_), .O(new_n247_));
  nand3  g085(.a(new_n247_), .b(new_n222_), .c(new_n220_), .O(new_n248_));
  inv1   g086(.a(new_n248_), .O(z32));
  inv1   g087(.a(new_n217_), .O(new_n250_));
  xnor2a g088(.a(x83), .b(x81), .O(new_n251_));
  nand2  g089(.a(x42), .b(x05), .O(new_n252_));
  nand2  g090(.a(x51), .b(new_n223_), .O(new_n253_));
  oai22  g091(.a(new_n253_), .b(new_n216_), .c(new_n252_), .d(new_n251_), .O(new_n254_));
  nand2  g092(.a(new_n254_), .b(new_n250_), .O(new_n255_));
  xor2a  g093(.a(x83), .b(x81), .O(new_n256_));
  oai22  g094(.a(new_n256_), .b(new_n252_), .c(new_n253_), .d(x81), .O(new_n257_));
  nand2  g095(.a(new_n257_), .b(new_n218_), .O(new_n258_));
  nand2  g096(.a(new_n222_), .b(new_n213_), .O(new_n259_));
  aoi21  g097(.a(new_n258_), .b(new_n255_), .c(new_n259_), .O(z33));
  xnor2a g098(.a(x84), .b(x82), .O(new_n261_));
  nand2  g099(.a(x83), .b(x42), .O(new_n262_));
  nand2  g100(.a(new_n262_), .b(new_n216_), .O(new_n263_));
  nand3  g101(.a(x83), .b(x81), .c(x42), .O(new_n264_));
  aoi21  g102(.a(new_n264_), .b(new_n263_), .c(new_n261_), .O(new_n265_));
  nand2  g103(.a(new_n262_), .b(x81), .O(new_n266_));
  nand3  g104(.a(x83), .b(new_n216_), .c(x42), .O(new_n267_));
  aoi21  g105(.a(new_n267_), .b(new_n266_), .c(new_n217_), .O(new_n268_));
  oai21  g106(.a(new_n268_), .b(new_n265_), .c(new_n222_), .O(new_n269_));
  nand2  g107(.a(new_n213_), .b(x52), .O(new_n270_));
  nor2   g108(.a(new_n270_), .b(new_n269_), .O(z34));
  nand2  g109(.a(new_n213_), .b(x53), .O(new_n272_));
  nor2   g110(.a(new_n272_), .b(new_n269_), .O(z35));
  nand2  g111(.a(new_n213_), .b(x56), .O(new_n276_));
  nor2   g112(.a(new_n276_), .b(new_n269_), .O(z38));
  nand2  g113(.a(new_n213_), .b(x57), .O(new_n278_));
  nor2   g114(.a(new_n278_), .b(new_n269_), .O(z39));
  nand2  g115(.a(new_n213_), .b(x58), .O(new_n280_));
  nor2   g116(.a(new_n280_), .b(new_n269_), .O(z40));
  nand2  g117(.a(new_n213_), .b(x59), .O(new_n282_));
  nor2   g118(.a(new_n282_), .b(new_n269_), .O(z41));
  nand2  g119(.a(new_n213_), .b(x60), .O(new_n284_));
  nor2   g120(.a(new_n284_), .b(new_n269_), .O(z42));
  nand2  g121(.a(new_n213_), .b(x62), .O(new_n287_));
  nor2   g122(.a(new_n287_), .b(new_n269_), .O(z44));
  nand2  g123(.a(new_n213_), .b(x63), .O(new_n289_));
  ...
  nand4  g128(.a(new_n294_), .b(new_n161_), .c(new_n154_), .d(x04), .O(new_n295_));
  xor2a  g129(.a(x84), .b(x81), .O(new_n296_));
  inv1   g130(.a(new_n296_), .O(new_n297_));
  or2    g131(.a(x75), .b(x67), .O(new_n298_));
  nand3  g132(.a(x79), .b(new_n156_), .c(x77), .O(new_n299_));
  inv1   g133(.a(new_n299_), .O(new_n300_));
  nand3  g134(.a(new_n300_), .b(new_n298_), .c(new_n297_), .O(new_n301_));
  aoi21  g135(.a(new_n301_), .b(new_n295_), .c(x01), .O(z47));
  inv1   g136(.a(x11), .O(new_n306_));
  nand2  g137(.a(x52), .b(x19), .O(new_n307_));
  oai21  g138(.a(x52), .b(new_n306_), .c(new_n307_), .O(new_n308_));
  nand4  g139(.a(new_n308_), .b(new_n161_), .c(new_n154_), .d(x04), .O(new_n309_));
  nor2   g140(.a(new_n299_), .b(new_n296_), .O(new_n310_));
  nand2  g141(.a(new_n310_), .b(x71), .O(new_n311_));
  aoi21  g142(.a(new_n311_), .b(new_n309_), .c(x01), .O(z51));
  inv1   g143(.a(x12), .O(new_n313_));
  nand2  g144(.a(x52), .b(x20), .O(new_n314_));
  oai21  g145(.a(x52), .b(new_n313_), .c(new_n314_), .O(new_n315_));
  nand4  g146(.a(new_n315_), .b(new_n161_), .c(new_n154_), .d(x04), .O(new_n316_));
  nand2  g147(.a(new_n310_), .b(x72), .O(new_n317_));
  aoi21  g148(.a(new_n317_), .b(new_n316_), .c(x01), .O(z52));
  inv1   g149(.a(x13), .O(new_n319_));
  nand2  g150(.a(x52), .b(x21), .O(new_n320_));
  oai21  g151(.a(x52), .b(new_n319_), .c(new_n320_), .O(new_n321_));
  nand4  g152(.a(new_n321_), .b(new_n161_), .c(new_n154_), .d(x04), .O(new_n322_));
  nand2  g153(.a(new_n310_), .b(x73), .O(new_n323_));
  aoi21  g154(.a(new_n323_), .b(new_n322_), .c(x01), .O(z53));
  inv1   g155(.a(x14), .O(new_n325_));
  nor2   g156(.a(x52), .b(new_n325_), .O(new_n326_));
  aoi21  g157(.a(x52), .b(x22), .c(new_n326_), .O(new_n327_));
  nor2   g158(.a(new_n156_), .b(x77), .O(new_n328_));
  nand4  g159(.a(new_n328_), .b(new_n210_), .c(x04), .d(new_n158_), .O(new_n329_));
  nor2   g160(.a(new_n329_), .b(new_n327_), .O(z54));
  inv1   g161(.a(x02), .O(new_n333_));
  nand4  g162(.a(x03), .b(new_n333_), .c(new_n158_), .d(x00), .O(new_n334_));
