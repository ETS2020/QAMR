// Benchmark "FAU" written by ABC on Fri Jul 10 18:23:03 2020
...
module FAU ( 
  ...
  nand2  g134(.a(new_n235_), .b(x60), .O(new_n295_));
  nor2   g135(.a(new_n295_), .b(new_n282_), .O(z42));
  nor3   g136(.a(new_n282_), .b(new_n273_), .c(new_n181_), .O(z43));
  nor3   g137(.a(new_n282_), .b(new_n273_), .c(new_n178_), .O(z44));
  nor3   g138(.a(new_n282_), .b(new_n273_), .c(new_n172_), .O(z46));
  ...
  inv1   g151(.a(x09), .O(new_n314_));
  nand2  g152(.a(x52), .b(x17), .O(new_n315_));
  oai21  g153(.a(x52), .b(new_n314_), .c(new_n315_), .O(new_n316_));
  nand2  g154(.a(new_n316_), .b(new_n306_), .O(new_n317_));
  nand2  g155(.a(new_n311_), .b(x69), .O(new_n318_));
  aoi21  g156(.a(new_n318_), .b(new_n317_), .c(x01), .O(z49));
  inv1   g157(.a(x10), .O(new_n320_));
  nand2  g158(.a(x52), .b(x18), .O(new_n321_));
  oai21  g159(.a(x52), .b(new_n320_), .c(new_n321_), .O(new_n322_));
  nand2  g160(.a(new_n322_), .b(new_n306_), .O(new_n323_));
  nand2  g161(.a(new_n311_), .b(x70), .O(new_n324_));
  ...
  nand2  g166(.a(new_n330_), .b(new_n306_), .O(new_n331_));
  nand2  g167(.a(new_n311_), .b(x73), .O(new_n332_));
  aoi21  g168(.a(new_n332_), .b(new_n331_), .c(x01), .O(z53));
  nand2  g169(.a(x52), .b(x22), .O(new_n334_));
  nand2  g170(.a(new_n272_), .b(x14), .O(new_n335_));
  inv1   g171(.a(new_n214_), .O(new_n336_));
  ...
  nand3  g175(.a(new_n259_), .b(x84), .c(new_n339_), .O(new_n340_));
  ...
  nand2  g179(.a(new_n160_), .b(new_n159_), .O(new_n344_));
  nand2  g180(.a(new_n233_), .b(x76), .O(new_n345_));
  xnor2a g181(.a(x84), .b(x81), .O(new_n346_));
  aoi21  g182(.a(new_n215_), .b(new_n214_), .c(new_n346_), .O(new_n347_));
  ...
  nand4  g186(.a(new_n350_), .b(new_n344_), .c(new_n153_), .d(x00), .O(z56));
  nand4  g187(.a(x80), .b(new_n222_), .c(x43), .d(new_n238_), .O(new_n353_));
  oai22  g188(.a(new_n353_), .b(new_n221_), .c(new_n238_), .d(x40), .O(new_n354_));
  nand3  g189(.a(new_n354_), .b(new_n227_), .c(x79), .O(new_n355_));
  nor2   g190(.a(x79), .b(x78), .O(new_n356_));
  nand3  g191(.a(new_n356_), .b(new_n238_), .c(x40), .O(new_n357_));
  nand2  g192(.a(new_n357_), .b(new_n355_), .O(new_n358_));
  nand2  g193(.a(new_n358_), .b(x77), .O(new_n359_));
  oai21  g194(.a(new_n336_), .b(new_n230_), .c(new_n154_), .O(new_n360_));
  ...
  oai21  g198(.a(new_n223_), .b(new_n221_), .c(new_n238_), .O(new_n364_));
  ...
  aoi21  g204(.a(new_n347_), .b(x79), .c(new_n367_), .O(new_n370_));
  ...
  nor3   g210(.a(new_n375_), .b(new_n373_), .c(new_n341_), .O(z61));
  ...
  nor3   g223(.a(new_n375_), .b(new_n373_), .c(new_n339_), .O(z63));
  nand2  g224(.a(x83), .b(x79), .O(new_n390_));
  or2    g225(.a(new_n390_), .b(new_n373_), .O(new_n391_));
  aoi21  g226(.a(new_n391_), .b(new_n305_), .c(x01), .O(z64));
  nor2   g227(.a(new_n160_), .b(x04), .O(new_n393_));
  nor2   g228(.a(new_n242_), .b(x78), .O(new_n394_));
  oai21  g229(.a(new_n394_), .b(new_n393_), .c(x77), .O(new_n395_));
  nand2  g230(.a(new_n336_), .b(x81), .O(new_n396_));
