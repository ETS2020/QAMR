...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n262_, new_n267_, new_n268_, new_n269_, new_n270_, new_n271_,
    new_n272_, new_n273_, new_n274_, new_n275_, new_n276_, new_n277_,
    new_n279_, new_n281_, new_n283_, new_n289_, new_n294_, new_n295_,
  ...
  xnor2a g089(.a(x84), .b(x82), .O(new_n246_));
  nor2   g090(.a(new_n246_), .b(x81), .O(new_n247_));
  nor2   g091(.a(new_n247_), .b(new_n245_), .O(new_n248_));
  nor2   g092(.a(new_n248_), .b(new_n162_), .O(new_n249_));
  nand4  g093(.a(new_n249_), .b(new_n238_), .c(x44), .d(new_n242_), .O(new_n250_));
  inv1   g094(.a(new_n250_), .O(z26));
  nand4  g095(.a(new_n249_), .b(new_n238_), .c(x45), .d(new_n242_), .O(new_n252_));
  inv1   g096(.a(new_n252_), .O(z27));
  nand4  g097(.a(new_n249_), .b(new_n238_), .c(x46), .d(new_n242_), .O(new_n254_));
  inv1   g098(.a(new_n254_), .O(z28));
  nand4  g099(.a(new_n249_), .b(new_n238_), .c(x47), .d(new_n242_), .O(new_n256_));
  inv1   g100(.a(new_n256_), .O(z29));
  nand4  g101(.a(new_n249_), .b(new_n238_), .c(x48), .d(new_n242_), .O(new_n258_));
  inv1   g102(.a(new_n258_), .O(z30));
  nand4  g103(.a(new_n249_), .b(new_n238_), .c(x49), .d(new_n242_), .O(new_n260_));
  inv1   g104(.a(new_n260_), .O(z31));
  nand4  g105(.a(new_n249_), .b(new_n238_), .c(x50), .d(new_n242_), .O(new_n262_));
  inv1   g106(.a(new_n262_), .O(z32));
  inv1   g107(.a(new_n162_), .O(new_n267_));
  nor2   g108(.a(new_n221_), .b(new_n242_), .O(new_n268_));
  inv1   g109(.a(new_n268_), .O(new_n269_));
  nand2  g110(.a(new_n269_), .b(new_n243_), .O(new_n270_));
  nand2  g111(.a(new_n268_), .b(x81), .O(new_n271_));
  aoi21  g112(.a(new_n271_), .b(new_n270_), .c(new_n246_), .O(new_n272_));
  nand2  g113(.a(new_n269_), .b(x81), .O(new_n273_));
  nand2  g114(.a(new_n268_), .b(new_n243_), .O(new_n274_));
  aoi21  g115(.a(new_n274_), .b(new_n273_), .c(new_n244_), .O(new_n275_));
  oai21  g116(.a(new_n275_), .b(new_n272_), .c(new_n267_), .O(new_n276_));
  nand2  g117(.a(new_n238_), .b(x54), .O(new_n277_));
  nor2   g118(.a(new_n277_), .b(new_n276_), .O(z36));
  nand2  g119(.a(new_n238_), .b(x55), .O(new_n279_));
  nor2   g120(.a(new_n279_), .b(new_n276_), .O(z37));
  nand2  g121(.a(new_n238_), .b(x56), .O(new_n281_));
  nor2   g122(.a(new_n281_), .b(new_n276_), .O(z38));
  inv1   g123(.a(new_n238_), .O(new_n283_));
  nor3   g124(.a(new_n276_), .b(new_n283_), .c(new_n195_), .O(z39));
  nor3   g125(.a(new_n276_), .b(new_n283_), .c(new_n192_), .O(z40));
  nor3   g126(.a(new_n276_), .b(new_n283_), .c(new_n189_), .O(z41));
  nand2  g127(.a(new_n238_), .b(x62), .O(new_n289_));
  nor2   g128(.a(new_n289_), .b(new_n276_), .O(z44));
  nor3   g129(.a(new_n276_), .b(new_n283_), .c(new_n181_), .O(z45));
  nor3   g130(.a(new_n276_), .b(new_n283_), .c(new_n178_), .O(z46));
  inv1   g131(.a(x08), .O(new_n294_));
  nand2  g132(.a(x52), .b(x16), .O(new_n295_));
  oai21  g133(.a(x52), .b(new_n294_), .c(new_n295_), .O(new_n296_));
  nand3  g134(.a(new_n228_), .b(new_n154_), .c(new_n159_), .O(new_n297_));
  ...
  and2   g140(.a(new_n302_), .b(new_n218_), .O(new_n303_));
  ...
  nand4  g162(.a(x84), .b(x83), .c(new_n327_), .d(new_n243_), .O(new_n328_));
  inv1   g163(.a(x80), .O(new_n329_));
  nand4  g164(.a(new_n238_), .b(new_n161_), .c(new_n329_), .d(x79), .O(new_n330_));
  nor2   g165(.a(new_n330_), .b(new_n328_), .O(z55));
  nand2  g166(.a(new_n236_), .b(x76), .O(new_n332_));
  xnor2a g167(.a(x84), .b(x81), .O(new_n333_));
  aoi21  g168(.a(new_n168_), .b(new_n167_), .c(new_n333_), .O(new_n334_));
  nand2  g169(.a(new_n334_), .b(new_n153_), .O(new_n335_));
  nand2  g170(.a(new_n335_), .b(new_n332_), .O(new_n336_));
  nand2  g171(.a(new_n336_), .b(x79), .O(new_n337_));
  nand3  g172(.a(new_n160_), .b(new_n159_), .c(new_n153_), .O(new_n338_));
  nand3  g173(.a(new_n338_), .b(new_n337_), .c(new_n234_), .O(z56));
  inv1   g174(.a(x02), .O(new_n340_));
  nand3  g175(.a(new_n234_), .b(x03), .c(new_n340_), .O(new_n341_));
  inv1   g176(.a(new_n341_), .O(z57));
  nand4  g177(.a(x80), .b(new_n223_), .c(x43), .d(new_n242_), .O(new_n343_));
  oai22  g178(.a(new_n343_), .b(new_n222_), .c(new_n242_), .d(x40), .O(new_n344_));
  nand3  g179(.a(new_n344_), .b(new_n228_), .c(x79), .O(new_n345_));
  nor2   g180(.a(x79), .b(x78), .O(new_n346_));
  nand3  g181(.a(new_n346_), .b(new_n242_), .c(x40), .O(new_n347_));
  nand2  g182(.a(new_n347_), .b(new_n345_), .O(new_n348_));
  nand2  g183(.a(new_n348_), .b(x77), .O(new_n349_));
  inv1   g184(.a(new_n167_), .O(new_n350_));
  oai21  g185(.a(new_n350_), .b(new_n231_), .c(new_n154_), .O(new_n351_));
  aoi21  g186(.a(new_n351_), .b(new_n349_), .c(x01), .O(z58));
  inv1   g187(.a(new_n346_), .O(new_n353_));
  aoi21  g188(.a(new_n227_), .b(new_n353_), .c(new_n152_), .O(new_n354_));
  oai21  g189(.a(new_n224_), .b(new_n222_), .c(new_n242_), .O(new_n355_));
  aoi21  g190(.a(new_n355_), .b(x79), .c(new_n227_), .O(new_n356_));
  oai21  g191(.a(new_n356_), .b(new_n354_), .c(x77), .O(new_n357_));
  nor2   g192(.a(x79), .b(x04), .O(new_n358_));
  inv1   g193(.a(new_n358_), .O(new_n359_));
  aoi21  g194(.a(new_n359_), .b(new_n357_), .c(x01), .O(z59));
  aoi21  g195(.a(new_n334_), .b(x79), .c(new_n358_), .O(new_n361_));
  aoi21  g196(.a(new_n361_), .b(new_n229_), .c(x01), .O(z60));
  inv1   g197(.a(new_n170_), .O(new_n363_));
  nand2  g198(.a(new_n168_), .b(new_n167_), .O(new_n364_));
  aoi22  g199(.a(new_n364_), .b(new_n218_), .c(new_n161_), .d(new_n231_), .O(new_n365_));
  nor3   g200(.a(new_n365_), .b(new_n363_), .c(new_n329_), .O(z61));
  nand3  g201(.a(x84), .b(x81), .c(x79), .O(new_n367_));
  oai21  g202(.a(x79), .b(new_n231_), .c(new_n367_), .O(new_n368_));
  nand2  g203(.a(new_n368_), .b(new_n159_), .O(new_n369_));
  nand2  g204(.a(new_n355_), .b(x79), .O(new_n370_));
  nand3  g205(.a(x81), .b(x79), .c(new_n231_), .O(new_n371_));
  ...
  nand2  g211(.a(new_n376_), .b(new_n300_), .O(new_n377_));
  aoi21  g212(.a(new_n377_), .b(new_n375_), .c(x01), .O(z62));
  nor3   g213(.a(new_n365_), .b(new_n363_), .c(new_n327_), .O(z63));
  nand2  g214(.a(x83), .b(x79), .O(new_n380_));
  or2    g215(.a(new_n380_), .b(new_n365_), .O(new_n381_));
  aoi21  g216(.a(new_n381_), .b(new_n297_), .c(x01), .O(z64));
  nor2   g217(.a(new_n160_), .b(x04), .O(new_n383_));
  nor2   g218(.a(new_n243_), .b(x78), .O(new_n384_));
  oai21  g219(.a(new_n384_), .b(new_n383_), .c(x77), .O(new_n385_));
  nand2  g220(.a(new_n350_), .b(x81), .O(new_n386_));
  nand2  g221(.a(new_n170_), .b(x84), .O(new_n387_));
  aoi21  g222(.a(new_n386_), .b(new_n385_), .c(new_n387_), .O(z65));
  zero   g223(.O(z08));
  zero   g224(.O(z09));
  zero   g225(.O(z16));
  zero   g226(.O(z20));
