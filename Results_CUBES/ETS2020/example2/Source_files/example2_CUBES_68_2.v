...
module FAU ( 
  ...
  wire new_n154_, new_n155_, new_n156_, new_n157_, new_n158_, new_n159_,
    ...
    new_n265_, new_n266_, new_n267_, new_n268_, new_n270_, new_n273_,
    ...
    new_n333_, new_n334_, new_n335_, new_n338_, new_n339_;
  ...
  nand3  g074(.a(new_n210_), .b(x49), .c(new_n221_), .O(new_n239_));
  inv1   g075(.a(new_n239_), .O(new_n240_));
  nand3  g076(.a(new_n240_), .b(new_n220_), .c(new_n218_), .O(new_n241_));
  inv1   g077(.a(new_n241_), .O(z31));
  nand3  g078(.a(new_n210_), .b(x50), .c(new_n221_), .O(new_n243_));
  inv1   g079(.a(new_n243_), .O(new_n244_));
  nand3  g080(.a(new_n244_), .b(new_n220_), .c(new_n218_), .O(new_n245_));
  inv1   g081(.a(new_n245_), .O(z32));
  inv1   g082(.a(new_n215_), .O(new_n247_));
  xnor2a g083(.a(x83), .b(x81), .O(new_n248_));
  nand2  g084(.a(x42), .b(x05), .O(new_n249_));
  nand2  g085(.a(x51), .b(new_n221_), .O(new_n250_));
  oai22  g086(.a(new_n250_), .b(new_n214_), .c(new_n249_), .d(new_n248_), .O(new_n251_));
  ...
  nand2  g090(.a(new_n254_), .b(new_n216_), .O(new_n255_));
  nand2  g091(.a(new_n220_), .b(new_n210_), .O(new_n256_));
  aoi21  g092(.a(new_n255_), .b(new_n252_), .c(new_n256_), .O(z33));
  xnor2a g093(.a(x84), .b(x82), .O(new_n259_));
  nand2  g094(.a(x83), .b(x42), .O(new_n260_));
  nand2  g095(.a(new_n260_), .b(new_n214_), .O(new_n261_));
  nand3  g096(.a(x83), .b(x81), .c(x42), .O(new_n262_));
  aoi21  g097(.a(new_n262_), .b(new_n261_), .c(new_n259_), .O(new_n263_));
  nand2  g098(.a(new_n260_), .b(x81), .O(new_n264_));
  nand3  g099(.a(x83), .b(new_n214_), .c(x42), .O(new_n265_));
  aoi21  g100(.a(new_n265_), .b(new_n264_), .c(new_n215_), .O(new_n266_));
  oai21  g101(.a(new_n266_), .b(new_n263_), .c(new_n220_), .O(new_n267_));
  nand2  g102(.a(new_n210_), .b(x53), .O(new_n268_));
  nor2   g103(.a(new_n268_), .b(new_n267_), .O(z35));
  nand2  g104(.a(new_n210_), .b(x54), .O(new_n270_));
  nor2   g105(.a(new_n270_), .b(new_n267_), .O(z36));
  nand2  g106(.a(new_n210_), .b(x56), .O(new_n273_));
  nor2   g107(.a(new_n273_), .b(new_n267_), .O(z38));
  nand2  g108(.a(new_n210_), .b(x57), .O(new_n275_));
  nor2   g109(.a(new_n275_), .b(new_n267_), .O(z39));
  nand2  g110(.a(new_n210_), .b(x58), .O(new_n277_));
  nor2   g111(.a(new_n277_), .b(new_n267_), .O(z40));
  nand2  g112(.a(new_n210_), .b(x59), .O(new_n279_));
  nor2   g113(.a(new_n279_), .b(new_n267_), .O(z41));
  nand2  g114(.a(new_n210_), .b(x60), .O(new_n281_));
  nor2   g115(.a(new_n281_), .b(new_n267_), .O(z42));
  nand2  g116(.a(new_n210_), .b(x62), .O(new_n284_));
  nor2   g117(.a(new_n284_), .b(new_n267_), .O(z44));
  nand2  g118(.a(new_n210_), .b(x63), .O(new_n286_));
  nor2   g119(.a(new_n286_), .b(new_n267_), .O(z45));
  nand2  g120(.a(new_n210_), .b(x64), .O(new_n288_));
  nor2   g121(.a(new_n288_), .b(new_n267_), .O(z46));
  inv1   g122(.a(x07), .O(new_n290_));
  nand2  g123(.a(x52), .b(x15), .O(new_n291_));
  oai21  g124(.a(x52), .b(new_n290_), .c(new_n291_), .O(new_n292_));
  nand4  g125(.a(new_n206_), .b(x78), .c(new_n154_), .d(x04), .O(new_n293_));
  inv1   g126(.a(new_n293_), .O(new_n294_));
  nand2  g127(.a(new_n294_), .b(new_n292_), .O(new_n295_));
  xor2a  g128(.a(x84), .b(x81), .O(new_n296_));
  inv1   g129(.a(new_n296_), .O(new_n297_));
  nor2   g130(.a(x75), .b(x67), .O(new_n298_));
  nand3  g131(.a(x79), .b(new_n156_), .c(x77), .O(new_n299_));
  nor2   g132(.a(new_n299_), .b(new_n298_), .O(new_n300_));
  nand2  g133(.a(new_n300_), .b(new_n297_), .O(new_n301_));
  aoi21  g134(.a(new_n301_), .b(new_n295_), .c(x01), .O(z47));
  ...
  nor2   g139(.a(new_n299_), .b(new_n296_), .O(new_n308_));
  nand2  g140(.a(new_n308_), .b(x69), .O(new_n309_));
  aoi21  g141(.a(new_n309_), .b(new_n307_), .c(x01), .O(z49));
  inv1   g142(.a(x11), .O(new_n312_));
  nand2  g143(.a(x52), .b(x19), .O(new_n313_));
  oai21  g144(.a(x52), .b(new_n312_), .c(new_n313_), .O(new_n314_));
  nand2  g145(.a(new_n314_), .b(new_n294_), .O(new_n315_));
  nand2  g146(.a(new_n308_), .b(x71), .O(new_n316_));
  aoi21  g147(.a(new_n316_), .b(new_n315_), .c(x01), .O(z51));
  inv1   g148(.a(x12), .O(new_n318_));
  nand2  g149(.a(x52), .b(x20), .O(new_n319_));
  oai21  g150(.a(x52), .b(new_n318_), .c(new_n319_), .O(new_n320_));
  nand2  g151(.a(new_n320_), .b(new_n294_), .O(new_n321_));
  nand2  g152(.a(new_n308_), .b(x72), .O(new_n322_));
  ...
  nand2  g157(.a(new_n326_), .b(new_n294_), .O(new_n327_));
  nand2  g158(.a(new_n308_), .b(x73), .O(new_n328_));
  aoi21  g159(.a(new_n328_), .b(new_n327_), .c(x01), .O(z53));
  inv1   g160(.a(x82), .O(new_n331_));
  nand2  g161(.a(x84), .b(new_n331_), .O(new_n332_));
  nand2  g162(.a(x83), .b(new_n214_), .O(new_n333_));
  nor2   g163(.a(x80), .b(new_n206_), .O(new_n334_));
  nand3  g164(.a(new_n334_), .b(new_n210_), .c(new_n207_), .O(new_n335_));
  nor3   g165(.a(new_n335_), .b(new_n333_), .c(new_n332_), .O(z55));
  inv1   g166(.a(x02), .O(new_n338_));
  nand4  g167(.a(x03), .b(new_n338_), .c(new_n158_), .d(x00), .O(new_n339_));
