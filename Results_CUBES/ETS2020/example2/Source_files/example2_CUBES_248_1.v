// Benchmark "FAU" written by ABC on Fri Jul 10 18:27:11 2020
...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n244_, new_n246_, new_n250_, new_n253_, new_n255_, new_n256_,
    new_n257_, new_n258_, new_n259_, new_n260_, new_n261_, new_n262_,
    new_n263_, new_n264_, new_n265_, new_n266_, new_n268_, new_n269_,
    new_n270_, new_n271_, new_n272_, new_n273_, new_n274_, new_n275_,
    new_n276_, new_n277_, new_n278_, new_n280_, new_n282_, new_n285_,
    new_n287_, new_n289_, new_n292_, new_n297_, new_n300_, new_n301_,
  ...
  nand4  g089(.a(new_n243_), .b(new_n232_), .c(x48), .d(new_n236_), .O(new_n250_));
  inv1   g090(.a(new_n250_), .O(z30));
  nand4  g091(.a(new_n243_), .b(new_n232_), .c(x50), .d(new_n236_), .O(new_n253_));
  inv1   g092(.a(new_n253_), .O(z32));
  nor2   g093(.a(new_n217_), .b(x81), .O(new_n255_));
  nor2   g094(.a(x83), .b(new_n240_), .O(new_n256_));
  nor2   g095(.a(new_n256_), .b(new_n255_), .O(new_n257_));
  nand2  g096(.a(x42), .b(x05), .O(new_n258_));
  nand2  g097(.a(x51), .b(new_n236_), .O(new_n259_));
  oai22  g098(.a(new_n259_), .b(new_n240_), .c(new_n258_), .d(new_n257_), .O(new_n260_));
  ...
  nand2  g102(.a(new_n263_), .b(new_n241_), .O(new_n264_));
  ...
  nand2  g129(.a(new_n232_), .b(x60), .O(new_n292_));
  nor2   g130(.a(new_n292_), .b(new_n278_), .O(z42));
  nor3   g131(.a(new_n278_), .b(new_n269_), .c(new_n185_), .O(z43));
  nor3   g132(.a(new_n278_), .b(new_n269_), .c(new_n182_), .O(z44));
  nand2  g133(.a(new_n232_), .b(x64), .O(new_n297_));
  ...
  nand2  g150(.a(new_n314_), .b(new_n304_), .O(new_n315_));
  ...
  nand2  g156(.a(new_n320_), .b(new_n304_), .O(new_n321_));
  ...
  nand2  g162(.a(new_n326_), .b(new_n304_), .O(new_n327_));
  nand2  g163(.a(new_n309_), .b(x71), .O(new_n328_));
  aoi21  g164(.a(new_n328_), .b(new_n327_), .c(x01), .O(z51));
  nand2  g165(.a(x52), .b(x22), .O(new_n332_));
  nand2  g166(.a(new_n268_), .b(x14), .O(new_n333_));
  inv1   g167(.a(new_n167_), .O(new_n334_));
  nand4  g168(.a(new_n334_), .b(new_n154_), .c(x04), .d(new_n153_), .O(new_n335_));
  aoi21  g169(.a(new_n333_), .b(new_n332_), .c(new_n335_), .O(z54));
  inv1   g170(.a(x82), .O(new_n337_));
  nand3  g171(.a(new_n255_), .b(x84), .c(new_n337_), .O(new_n338_));
  inv1   g172(.a(x80), .O(new_n339_));
  nand4  g173(.a(new_n232_), .b(new_n161_), .c(new_n339_), .d(x79), .O(new_n340_));
  nor2   g174(.a(new_n340_), .b(new_n338_), .O(z55));
  nand2  g175(.a(new_n160_), .b(new_n159_), .O(new_n342_));
  nand2  g176(.a(new_n230_), .b(x76), .O(new_n343_));
  xnor2a g177(.a(x84), .b(x81), .O(new_n344_));
  aoi21  g178(.a(new_n168_), .b(new_n167_), .c(new_n344_), .O(new_n345_));
  ...
  nand4  g182(.a(new_n348_), .b(new_n342_), .c(new_n153_), .d(x00), .O(z56));
  nand4  g183(.a(x80), .b(new_n219_), .c(x43), .d(new_n236_), .O(new_n351_));
  oai22  g184(.a(new_n351_), .b(new_n218_), .c(new_n236_), .d(x40), .O(new_n352_));
  nand3  g185(.a(new_n352_), .b(new_n224_), .c(x79), .O(new_n353_));
  nor2   g186(.a(x79), .b(x78), .O(new_n354_));
  nand3  g187(.a(new_n354_), .b(new_n236_), .c(x40), .O(new_n355_));
  nand2  g188(.a(new_n355_), .b(new_n353_), .O(new_n356_));
  nand2  g189(.a(new_n356_), .b(x77), .O(new_n357_));
  oai21  g190(.a(new_n334_), .b(new_n227_), .c(new_n154_), .O(new_n358_));
  aoi21  g191(.a(new_n358_), .b(new_n357_), .c(x01), .O(z58));
  inv1   g192(.a(new_n354_), .O(new_n360_));
  aoi21  g193(.a(new_n223_), .b(new_n360_), .c(new_n152_), .O(new_n361_));
  oai21  g194(.a(new_n220_), .b(new_n218_), .c(new_n236_), .O(new_n362_));
  aoi21  g195(.a(new_n362_), .b(x79), .c(new_n223_), .O(new_n363_));
  oai21  g196(.a(new_n363_), .b(new_n361_), .c(x77), .O(new_n364_));
  nor2   g197(.a(x79), .b(x04), .O(new_n365_));
  inv1   g198(.a(new_n365_), .O(new_n366_));
  aoi21  g199(.a(new_n366_), .b(new_n364_), .c(x01), .O(z59));
  aoi21  g200(.a(new_n345_), .b(x79), .c(new_n365_), .O(new_n368_));
  aoi21  g201(.a(new_n368_), .b(new_n225_), .c(x01), .O(z60));
  inv1   g202(.a(new_n170_), .O(new_n370_));
  nand2  g203(.a(new_n168_), .b(new_n167_), .O(new_n371_));
  aoi22  g204(.a(new_n371_), .b(new_n214_), .c(new_n161_), .d(new_n227_), .O(new_n372_));
  nor3   g205(.a(new_n372_), .b(new_n370_), .c(new_n339_), .O(z61));
  nand3  g206(.a(x84), .b(x81), .c(x79), .O(new_n374_));
  oai21  g207(.a(x79), .b(new_n227_), .c(new_n374_), .O(new_n375_));
  nand2  g208(.a(new_n375_), .b(new_n159_), .O(new_n376_));
  nand2  g209(.a(new_n362_), .b(x79), .O(new_n377_));
  nand3  g210(.a(x81), .b(x79), .c(new_n227_), .O(new_n378_));
  inv1   g211(.a(new_n378_), .O(new_n379_));
  aoi21  g212(.a(new_n377_), .b(x04), .c(new_n379_), .O(new_n380_));
  oai21  g213(.a(new_n380_), .b(new_n159_), .c(new_n376_), .O(new_n381_));
  nand2  g214(.a(new_n381_), .b(x78), .O(new_n382_));
  inv1   g215(.a(new_n374_), .O(new_n383_));
  nand2  g216(.a(new_n383_), .b(new_n306_), .O(new_n384_));
  aoi21  g217(.a(new_n384_), .b(new_n382_), .c(x01), .O(z62));
  nor3   g218(.a(new_n372_), .b(new_n370_), .c(new_n337_), .O(z63));
  nand2  g219(.a(x83), .b(x79), .O(new_n387_));
  or2    g220(.a(new_n387_), .b(new_n372_), .O(new_n388_));
  aoi21  g221(.a(new_n388_), .b(new_n303_), .c(x01), .O(z64));
  nor2   g222(.a(new_n160_), .b(x04), .O(new_n390_));
  nor2   g223(.a(new_n240_), .b(x78), .O(new_n391_));
  oai21  g224(.a(new_n391_), .b(new_n390_), .c(x77), .O(new_n392_));
  nand2  g225(.a(new_n334_), .b(x81), .O(new_n393_));
