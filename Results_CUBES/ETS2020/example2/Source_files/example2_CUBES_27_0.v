...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n279_, new_n291_, new_n292_, new_n293_, new_n294_, new_n295_,
  ...
  inv1   g104(.a(new_n235_), .O(new_n263_));
  inv1   g105(.a(new_n162_), .O(new_n264_));
  nor2   g106(.a(new_n220_), .b(new_n238_), .O(new_n265_));
  inv1   g107(.a(new_n265_), .O(new_n266_));
  nand2  g108(.a(new_n266_), .b(new_n239_), .O(new_n267_));
  nand2  g109(.a(new_n265_), .b(x81), .O(new_n268_));
  aoi21  g110(.a(new_n268_), .b(new_n267_), .c(new_n242_), .O(new_n269_));
  nand2  g111(.a(new_n266_), .b(x81), .O(new_n270_));
  nand2  g112(.a(new_n265_), .b(new_n239_), .O(new_n271_));
  aoi21  g113(.a(new_n271_), .b(new_n270_), .c(new_n240_), .O(new_n272_));
  oai21  g114(.a(new_n272_), .b(new_n269_), .c(new_n264_), .O(new_n273_));
  nor3   g115(.a(new_n273_), .b(new_n263_), .c(new_n262_), .O(z34));
  nand2  g116(.a(new_n235_), .b(x53), .O(new_n275_));
  nor2   g117(.a(new_n275_), .b(new_n273_), .O(z35));
  nand2  g118(.a(new_n235_), .b(x54), .O(new_n277_));
  nor2   g119(.a(new_n277_), .b(new_n273_), .O(z36));
  nand2  g120(.a(new_n235_), .b(x55), .O(new_n279_));
  nor2   g121(.a(new_n279_), .b(new_n273_), .O(z37));
  nor3   g122(.a(new_n273_), .b(new_n263_), .c(new_n191_), .O(z39));
  nor3   g123(.a(new_n273_), .b(new_n263_), .c(new_n188_), .O(z40));
  nor3   g124(.a(new_n273_), .b(new_n263_), .c(new_n185_), .O(z41));
  nor3   g125(.a(new_n273_), .b(new_n263_), .c(new_n179_), .O(z43));
  nor3   g126(.a(new_n273_), .b(new_n263_), .c(new_n173_), .O(z45));
  nor3   g127(.a(new_n273_), .b(new_n263_), .c(new_n170_), .O(z46));
  inv1   g128(.a(x08), .O(new_n291_));
  nand2  g129(.a(x52), .b(x16), .O(new_n292_));
  oai21  g130(.a(x52), .b(new_n291_), .c(new_n292_), .O(new_n293_));
  nand3  g131(.a(new_n227_), .b(new_n154_), .c(new_n159_), .O(new_n294_));
  inv1   g132(.a(new_n294_), .O(new_n295_));
  nand2  g133(.a(new_n295_), .b(new_n293_), .O(new_n296_));
  inv1   g134(.a(new_n215_), .O(new_n297_));
  nand2  g135(.a(new_n297_), .b(x79), .O(new_n298_));
  inv1   g136(.a(new_n298_), .O(new_n299_));
  and2   g137(.a(new_n299_), .b(new_n217_), .O(new_n300_));
  nand2  g138(.a(new_n300_), .b(x68), .O(new_n301_));
  aoi21  g139(.a(new_n301_), .b(new_n296_), .c(x01), .O(z48));
  inv1   g140(.a(x09), .O(new_n303_));
  nand2  g141(.a(x52), .b(x17), .O(new_n304_));
  oai21  g142(.a(x52), .b(new_n303_), .c(new_n304_), .O(new_n305_));
  nand2  g143(.a(new_n305_), .b(new_n295_), .O(new_n306_));
  nand2  g144(.a(new_n300_), .b(x69), .O(new_n307_));
  aoi21  g145(.a(new_n307_), .b(new_n306_), .c(x01), .O(z49));
  inv1   g146(.a(x10), .O(new_n309_));
  nand2  g147(.a(x52), .b(x18), .O(new_n310_));
  oai21  g148(.a(x52), .b(new_n309_), .c(new_n310_), .O(new_n311_));
  nand2  g149(.a(new_n311_), .b(new_n295_), .O(new_n312_));
  nand2  g150(.a(new_n300_), .b(x70), .O(new_n313_));
  aoi21  g151(.a(new_n313_), .b(new_n312_), .c(x01), .O(z50));
  inv1   g152(.a(x11), .O(new_n315_));
  nand2  g153(.a(x52), .b(x19), .O(new_n316_));
  oai21  g154(.a(x52), .b(new_n315_), .c(new_n316_), .O(new_n317_));
  nand2  g155(.a(new_n317_), .b(new_n295_), .O(new_n318_));
  nand2  g156(.a(new_n300_), .b(x71), .O(new_n319_));
  aoi21  g157(.a(new_n319_), .b(new_n318_), .c(x01), .O(z51));
  nand2  g158(.a(x52), .b(x22), .O(new_n323_));
  nand2  g159(.a(new_n262_), .b(x14), .O(new_n324_));
  inv1   g160(.a(new_n214_), .O(new_n325_));
  nand4  g161(.a(new_n325_), .b(new_n154_), .c(x04), .d(new_n153_), .O(new_n326_));
  aoi21  g162(.a(new_n324_), .b(new_n323_), .c(new_n326_), .O(z54));
  inv1   g163(.a(x82), .O(new_n328_));
  nand4  g164(.a(x84), .b(x83), .c(new_n328_), .d(new_n239_), .O(new_n329_));
  inv1   g165(.a(x80), .O(new_n330_));
  nand4  g166(.a(new_n235_), .b(new_n161_), .c(new_n330_), .d(x79), .O(new_n331_));
  nor2   g167(.a(new_n331_), .b(new_n329_), .O(z55));
  nand2  g168(.a(new_n160_), .b(new_n159_), .O(new_n333_));
  nand2  g169(.a(new_n233_), .b(x76), .O(new_n334_));
  xnor2a g170(.a(x84), .b(x81), .O(new_n335_));
  aoi21  g171(.a(new_n215_), .b(new_n214_), .c(new_n335_), .O(new_n336_));
  ...
  nand4  g176(.a(x80), .b(new_n222_), .c(x43), .d(new_n238_), .O(new_n342_));
  oai22  g177(.a(new_n342_), .b(new_n221_), .c(new_n238_), .d(x40), .O(new_n343_));
  nand3  g178(.a(new_n343_), .b(new_n227_), .c(x79), .O(new_n344_));
  nor2   g179(.a(x79), .b(x78), .O(new_n345_));
  nand3  g180(.a(new_n345_), .b(new_n238_), .c(x40), .O(new_n346_));
  nand2  g181(.a(new_n346_), .b(new_n344_), .O(new_n347_));
  nand2  g182(.a(new_n347_), .b(x77), .O(new_n348_));
  oai21  g183(.a(new_n325_), .b(new_n230_), .c(new_n154_), .O(new_n349_));
  aoi21  g184(.a(new_n349_), .b(new_n348_), .c(x01), .O(z58));
  inv1   g185(.a(new_n345_), .O(new_n351_));
  aoi21  g186(.a(new_n226_), .b(new_n351_), .c(new_n152_), .O(new_n352_));
  oai21  g187(.a(new_n223_), .b(new_n221_), .c(new_n238_), .O(new_n353_));
  aoi21  g188(.a(new_n353_), .b(x79), .c(new_n226_), .O(new_n354_));
  oai21  g189(.a(new_n354_), .b(new_n352_), .c(x77), .O(new_n355_));
  nor2   g190(.a(x79), .b(x04), .O(new_n356_));
  inv1   g191(.a(new_n356_), .O(new_n357_));
  aoi21  g192(.a(new_n357_), .b(new_n355_), .c(x01), .O(z59));
  aoi21  g193(.a(new_n336_), .b(x79), .c(new_n356_), .O(new_n359_));
  aoi21  g194(.a(new_n359_), .b(new_n228_), .c(x01), .O(z60));
  nand2  g195(.a(new_n215_), .b(new_n214_), .O(new_n361_));
  aoi22  g196(.a(new_n361_), .b(new_n217_), .c(new_n161_), .d(new_n230_), .O(new_n362_));
  nor2   g197(.a(new_n154_), .b(x01), .O(new_n363_));
  ...
  oai21  g201(.a(x79), .b(new_n230_), .c(new_n366_), .O(new_n367_));
  nand2  g202(.a(new_n367_), .b(new_n159_), .O(new_n368_));
  nand2  g203(.a(new_n353_), .b(x79), .O(new_n369_));
  nand3  g204(.a(x81), .b(x79), .c(new_n230_), .O(new_n370_));
  ...
  nand2  g210(.a(new_n375_), .b(new_n297_), .O(new_n376_));
  ...
  or2    g214(.a(new_n379_), .b(new_n362_), .O(new_n380_));
  aoi21  g215(.a(new_n380_), .b(new_n294_), .c(x01), .O(z64));
  nor2   g216(.a(new_n160_), .b(x04), .O(new_n382_));
  nor2   g217(.a(new_n239_), .b(x78), .O(new_n383_));
  oai21  g218(.a(new_n383_), .b(new_n382_), .c(x77), .O(new_n384_));
  nand2  g219(.a(new_n325_), .b(x81), .O(new_n385_));
  nand2  g220(.a(new_n363_), .b(x84), .O(new_n386_));
