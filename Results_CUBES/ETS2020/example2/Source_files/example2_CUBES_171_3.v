...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n255_, new_n256_, new_n258_, new_n261_, new_n263_, new_n266_,
    new_n268_, new_n270_, new_n271_, new_n272_, new_n273_, new_n274_,
    new_n275_, new_n276_, new_n277_, new_n278_, new_n279_, new_n280_,
    new_n281_, new_n283_, new_n284_, new_n285_, new_n286_, new_n287_,
    new_n288_, new_n289_, new_n290_, new_n291_, new_n292_, new_n293_,
    new_n295_, new_n297_, new_n299_, new_n301_, new_n306_, new_n312_,
  ...
  nand2  g147(.a(new_n255_), .b(x60), .O(new_n306_));
  nor2   g148(.a(new_n306_), .b(new_n293_), .O(z42));
  ...
  nand2  g183(.a(new_n329_), .b(x70), .O(new_n342_));
  ...
  nand2  g189(.a(new_n329_), .b(x71), .O(new_n348_));
  ...
  nand2  g195(.a(new_n329_), .b(x72), .O(new_n354_));
  ...
  nand2  g200(.a(new_n358_), .b(new_n316_), .O(new_n359_));
  nand2  g201(.a(new_n329_), .b(x73), .O(new_n360_));
  aoi21  g202(.a(new_n360_), .b(new_n359_), .c(x01), .O(z53));
  nand2  g203(.a(x52), .b(x22), .O(new_n362_));
  nand2  g204(.a(new_n283_), .b(x14), .O(new_n363_));
  inv1   g205(.a(new_n170_), .O(new_n364_));
  nand4  g206(.a(new_n364_), .b(new_n154_), .c(x04), .d(new_n153_), .O(new_n365_));
  aoi21  g207(.a(new_n363_), .b(new_n362_), .c(new_n365_), .O(z54));
  inv1   g208(.a(x82), .O(new_n367_));
  nand3  g209(.a(new_n270_), .b(x84), .c(new_n367_), .O(new_n368_));
  inv1   g210(.a(x80), .O(new_n369_));
  nand4  g211(.a(new_n255_), .b(new_n165_), .c(new_n369_), .d(x79), .O(new_n370_));
  nor2   g212(.a(new_n370_), .b(new_n368_), .O(z55));
  inv1   g213(.a(x76), .O(new_n372_));
  nor2   g214(.a(new_n165_), .b(new_n372_), .O(new_n373_));
  xnor2a g215(.a(x84), .b(x81), .O(new_n374_));
  aoi21  g216(.a(new_n171_), .b(new_n170_), .c(new_n374_), .O(new_n375_));
  aoi21  g217(.a(new_n375_), .b(new_n153_), .c(new_n373_), .O(new_n376_));
  nor2   g218(.a(x77), .b(x01), .O(new_n377_));
  aoi21  g219(.a(new_n377_), .b(new_n164_), .c(new_n242_), .O(new_n378_));
  oai21  g220(.a(new_n376_), .b(new_n154_), .c(new_n378_), .O(z56));
  inv1   g221(.a(x02), .O(new_n380_));
  nand3  g222(.a(new_n243_), .b(x03), .c(new_n380_), .O(new_n381_));
  inv1   g223(.a(new_n381_), .O(z57));
  nand4  g224(.a(x80), .b(new_n235_), .c(x43), .d(new_n246_), .O(new_n383_));
  oai22  g225(.a(new_n383_), .b(new_n234_), .c(new_n246_), .d(x40), .O(new_n384_));
  nand3  g226(.a(new_n384_), .b(new_n232_), .c(x79), .O(new_n385_));
  nand3  g227(.a(new_n178_), .b(new_n246_), .c(x40), .O(new_n386_));
  nand2  g228(.a(new_n386_), .b(new_n385_), .O(new_n387_));
  nand2  g229(.a(new_n387_), .b(x77), .O(new_n388_));
  oai21  g230(.a(new_n364_), .b(new_n160_), .c(new_n154_), .O(new_n389_));
  aoi21  g231(.a(new_n389_), .b(new_n388_), .c(x01), .O(z58));
  aoi21  g232(.a(new_n163_), .b(new_n179_), .c(new_n152_), .O(new_n391_));
  oai21  g233(.a(new_n236_), .b(new_n234_), .c(new_n246_), .O(new_n392_));
  ...
  aoi21  g239(.a(new_n375_), .b(x79), .c(new_n395_), .O(new_n398_));
  aoi21  g240(.a(new_n398_), .b(new_n239_), .c(x01), .O(z60));
  inv1   g241(.a(new_n173_), .O(new_n400_));
  nand2  g242(.a(new_n171_), .b(new_n170_), .O(new_n401_));
  aoi22  g243(.a(new_n401_), .b(new_n229_), .c(new_n165_), .d(new_n160_), .O(new_n402_));
  nor3   g244(.a(new_n402_), .b(new_n400_), .c(new_n369_), .O(z61));
  ...
  nand2  g248(.a(new_n392_), .b(x79), .O(new_n407_));
  ...
  nand2  g255(.a(new_n413_), .b(new_n319_), .O(new_n414_));
  aoi21  g256(.a(new_n414_), .b(new_n412_), .c(x01), .O(z62));
  nor3   g257(.a(new_n402_), .b(new_n400_), .c(new_n367_), .O(z63));
  nand2  g258(.a(x83), .b(x79), .O(new_n417_));
  or2    g259(.a(new_n417_), .b(new_n402_), .O(new_n418_));
  nand3  g260(.a(new_n175_), .b(new_n159_), .c(x04), .O(new_n419_));
  aoi21  g261(.a(new_n419_), .b(new_n418_), .c(x01), .O(z64));
  nor2   g262(.a(new_n164_), .b(x04), .O(new_n421_));
  nor2   g263(.a(new_n250_), .b(x78), .O(new_n422_));
  oai21  g264(.a(new_n422_), .b(new_n421_), .c(x77), .O(new_n423_));
  nand2  g265(.a(new_n364_), .b(x81), .O(new_n424_));
  nand2  g266(.a(new_n173_), .b(x84), .O(new_n425_));
  aoi21  g267(.a(new_n424_), .b(new_n423_), .c(new_n425_), .O(z65));
  zero   g268(.O(z10));
  zero   g269(.O(z12));
  zero   g270(.O(z24));
  zero   g271(.O(z27));
