...
module FAU ( 
  ...
  nor3   g154(.a(new_n297_), .b(new_n288_), .c(new_n193_), .O(z43));
  nor3   g155(.a(new_n297_), .b(new_n288_), .c(new_n190_), .O(z44));
  nor3   g156(.a(new_n297_), .b(new_n288_), .c(new_n187_), .O(z45));
  inv1   g157(.a(x07), .O(new_n315_));
  nand2  g158(.a(x52), .b(x15), .O(new_n316_));
  oai21  g159(.a(x52), .b(new_n315_), .c(new_n316_), .O(new_n317_));
  nand3  g160(.a(new_n231_), .b(new_n154_), .c(new_n159_), .O(new_n318_));
  ...
  nand2  g166(.a(new_n323_), .b(new_n228_), .O(new_n324_));
  ...
  inv1   g172(.a(new_n228_), .O(new_n330_));
  ...
  nand3  g201(.a(new_n360_), .b(new_n246_), .c(new_n165_), .O(new_n361_));
  nor4   g202(.a(new_n361_), .b(new_n359_), .c(new_n358_), .d(x82), .O(z55));
  nand2  g203(.a(new_n244_), .b(x76), .O(new_n363_));
  ...
  aoi21  g211(.a(new_n370_), .b(new_n164_), .c(new_n241_), .O(new_n371_));
  nand2  g212(.a(new_n371_), .b(new_n369_), .O(z56));
  inv1   g213(.a(x02), .O(new_n373_));
  nand3  g214(.a(new_n242_), .b(x03), .c(new_n373_), .O(new_n374_));
  inv1   g215(.a(new_n374_), .O(z57));
  nand4  g216(.a(x80), .b(new_n234_), .c(x43), .d(new_n249_), .O(new_n376_));
  oai22  g217(.a(new_n376_), .b(new_n233_), .c(new_n249_), .d(x40), .O(new_n377_));
  nand3  g218(.a(new_n377_), .b(new_n231_), .c(x79), .O(new_n378_));
  nand3  g219(.a(new_n179_), .b(new_n249_), .c(x40), .O(new_n379_));
  ...
  oai21  g225(.a(new_n235_), .b(new_n233_), .c(new_n249_), .O(new_n385_));
  ...
  aoi21  g232(.a(new_n391_), .b(new_n238_), .c(x01), .O(z60));
  oai21  g233(.a(new_n171_), .b(new_n169_), .c(new_n228_), .O(new_n393_));
  oai21  g234(.a(new_n244_), .b(x04), .c(new_n393_), .O(new_n394_));
  ...
  nor2   g254(.a(new_n253_), .b(x78), .O(new_n415_));
