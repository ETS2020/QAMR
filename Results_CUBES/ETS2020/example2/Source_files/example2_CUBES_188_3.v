// Benchmark "FAU" written by ABC on Fri Jul 10 18:22:59 2020
...
module FAU ( 
  ...
  nand2  g147(.a(new_n248_), .b(x54), .O(new_n302_));
  nor2   g148(.a(new_n302_), .b(new_n298_), .O(z36));
  nand2  g149(.a(new_n248_), .b(x55), .O(new_n304_));
  nor2   g150(.a(new_n304_), .b(new_n298_), .O(z37));
  nand2  g151(.a(new_n248_), .b(x56), .O(new_n306_));
  nor2   g152(.a(new_n306_), .b(new_n298_), .O(z38));
  nor3   g153(.a(new_n298_), .b(new_n289_), .c(new_n205_), .O(z39));
  nor3   g154(.a(new_n298_), .b(new_n289_), .c(new_n201_), .O(z41));
  nor3   g155(.a(new_n298_), .b(new_n289_), .c(new_n198_), .O(z42));
  nor3   g156(.a(new_n298_), .b(new_n289_), .c(new_n195_), .O(z43));
  nor3   g157(.a(new_n298_), .b(new_n289_), .c(new_n192_), .O(z44));
  nor3   g158(.a(new_n298_), .b(new_n289_), .c(new_n189_), .O(z45));
  nor3   g159(.a(new_n298_), .b(new_n289_), .c(new_n186_), .O(z46));
  inv1   g160(.a(x07), .O(new_n316_));
  nand2  g161(.a(x52), .b(x15), .O(new_n317_));
  oai21  g162(.a(x52), .b(new_n316_), .c(new_n317_), .O(new_n318_));
  nand3  g163(.a(new_n233_), .b(new_n154_), .c(new_n159_), .O(new_n319_));
  ...
  nand2  g169(.a(new_n324_), .b(new_n230_), .O(new_n325_));
  ...
  inv1   g175(.a(new_n230_), .O(new_n331_));
  ...
  nand3  g210(.a(new_n366_), .b(new_n248_), .c(new_n165_), .O(new_n367_));
  nor4   g211(.a(new_n367_), .b(new_n365_), .c(new_n364_), .d(x82), .O(z55));
  nand2  g212(.a(new_n246_), .b(x76), .O(new_n369_));
  inv1   g213(.a(new_n171_), .O(new_n370_));
  xnor2a g214(.a(x84), .b(x81), .O(new_n371_));
  aoi21  g215(.a(new_n370_), .b(new_n170_), .c(new_n371_), .O(new_n372_));
  ...
  aoi21  g220(.a(new_n376_), .b(new_n164_), .c(new_n243_), .O(new_n377_));
  nand2  g221(.a(new_n377_), .b(new_n375_), .O(z56));
  inv1   g222(.a(x02), .O(new_n379_));
  nand3  g223(.a(new_n244_), .b(x03), .c(new_n379_), .O(new_n380_));
  inv1   g224(.a(new_n380_), .O(z57));
  nand4  g225(.a(x80), .b(new_n236_), .c(x43), .d(new_n251_), .O(new_n382_));
  oai22  g226(.a(new_n382_), .b(new_n235_), .c(new_n251_), .d(x40), .O(new_n383_));
  nand3  g227(.a(new_n383_), .b(new_n233_), .c(x79), .O(new_n384_));
  nand3  g228(.a(new_n179_), .b(new_n251_), .c(x40), .O(new_n385_));
  nand2  g229(.a(new_n385_), .b(new_n384_), .O(new_n386_));
  nand2  g230(.a(new_n386_), .b(x77), .O(new_n387_));
  oai21  g231(.a(new_n169_), .b(new_n160_), .c(new_n154_), .O(new_n388_));
  aoi21  g232(.a(new_n388_), .b(new_n387_), .c(x01), .O(z58));
  aoi21  g233(.a(new_n163_), .b(new_n180_), .c(new_n152_), .O(new_n390_));
  oai21  g234(.a(new_n237_), .b(new_n235_), .c(new_n251_), .O(new_n391_));
  ...
  aoi21  g240(.a(new_n372_), .b(x79), .c(new_n394_), .O(new_n397_));
  aoi21  g241(.a(new_n397_), .b(new_n240_), .c(x01), .O(z60));
  oai21  g242(.a(new_n171_), .b(new_n169_), .c(new_n230_), .O(new_n399_));
  oai21  g243(.a(new_n246_), .b(x04), .c(new_n399_), .O(new_n400_));
  nand2  g244(.a(new_n174_), .b(x80), .O(new_n401_));
  inv1   g245(.a(new_n401_), .O(new_n402_));
  and2   g246(.a(new_n402_), .b(new_n400_), .O(z61));
  nand3  g247(.a(x84), .b(x81), .c(x79), .O(new_n404_));
  oai21  g248(.a(x79), .b(new_n160_), .c(new_n404_), .O(new_n405_));
  nand2  g249(.a(new_n405_), .b(new_n159_), .O(new_n406_));
  nand2  g250(.a(new_n391_), .b(x79), .O(new_n407_));
  nand3  g251(.a(x81), .b(x79), .c(new_n160_), .O(new_n408_));
  inv1   g252(.a(new_n408_), .O(new_n409_));
  aoi21  g253(.a(new_n407_), .b(x04), .c(new_n409_), .O(new_n410_));
  oai21  g254(.a(new_n410_), .b(new_n159_), .c(new_n406_), .O(new_n411_));
  nand2  g255(.a(new_n411_), .b(x78), .O(new_n412_));
  inv1   g256(.a(new_n404_), .O(new_n413_));
  nand2  g257(.a(new_n413_), .b(new_n171_), .O(new_n414_));
  aoi21  g258(.a(new_n414_), .b(new_n412_), .c(x01), .O(z62));
  nand3  g259(.a(new_n400_), .b(x83), .c(x79), .O(new_n417_));
  nand3  g260(.a(new_n176_), .b(new_n159_), .c(x04), .O(new_n418_));
  aoi21  g261(.a(new_n418_), .b(new_n417_), .c(x01), .O(z64));
  nor2   g262(.a(new_n164_), .b(x04), .O(new_n420_));
  nor2   g263(.a(new_n255_), .b(x78), .O(new_n421_));
  oai21  g264(.a(new_n421_), .b(new_n420_), .c(x77), .O(new_n422_));
  nand2  g265(.a(new_n169_), .b(x81), .O(new_n423_));
  nand2  g266(.a(new_n174_), .b(x84), .O(new_n424_));
  aoi21  g267(.a(new_n423_), .b(new_n422_), .c(new_n424_), .O(z65));
  zero   g268(.O(z12));
  zero   g269(.O(z20));
  zero   g270(.O(z26));
  zero   g271(.O(z40));
