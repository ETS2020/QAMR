...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n243_, new_n245_, new_n247_, new_n251_, new_n254_, new_n259_,
    new_n260_, new_n261_, new_n262_, new_n263_, new_n264_, new_n265_,
    new_n266_, new_n267_, new_n268_, new_n269_, new_n271_, new_n273_,
    new_n275_, new_n277_, new_n282_, new_n287_, new_n288_, new_n289_,
  ...
  nand2  g107(.a(new_n232_), .b(x55), .O(new_n271_));
  nor2   g108(.a(new_n271_), .b(new_n268_), .O(z37));
  nand2  g109(.a(new_n232_), .b(x56), .O(new_n273_));
  nor2   g110(.a(new_n273_), .b(new_n268_), .O(z38));
  inv1   g111(.a(new_n232_), .O(new_n275_));
  nor3   g112(.a(new_n268_), .b(new_n275_), .c(new_n195_), .O(z39));
  nand2  g113(.a(new_n232_), .b(x58), .O(new_n277_));
  nor2   g114(.a(new_n277_), .b(new_n268_), .O(z40));
  nor3   g115(.a(new_n268_), .b(new_n275_), .c(new_n191_), .O(z41));
  nor3   g116(.a(new_n268_), .b(new_n275_), .c(new_n185_), .O(z43));
  nand2  g117(.a(new_n232_), .b(x62), .O(new_n282_));
  nor2   g118(.a(new_n282_), .b(new_n268_), .O(z44));
  nor3   g119(.a(new_n268_), .b(new_n275_), .c(new_n178_), .O(z46));
  inv1   g120(.a(x08), .O(new_n287_));
  nand2  g121(.a(x52), .b(x16), .O(new_n288_));
  oai21  g122(.a(x52), .b(new_n287_), .c(new_n288_), .O(new_n289_));
  nand3  g123(.a(new_n224_), .b(new_n154_), .c(new_n159_), .O(new_n290_));
  inv1   g124(.a(new_n290_), .O(new_n291_));
  nand2  g125(.a(new_n291_), .b(new_n289_), .O(new_n292_));
  inv1   g126(.a(new_n168_), .O(new_n293_));
  nand2  g127(.a(new_n293_), .b(x79), .O(new_n294_));
  inv1   g128(.a(new_n294_), .O(new_n295_));
  and2   g129(.a(new_n295_), .b(new_n214_), .O(new_n296_));
  nand2  g130(.a(new_n296_), .b(x68), .O(new_n297_));
  aoi21  g131(.a(new_n297_), .b(new_n292_), .c(x01), .O(z48));
  ...
  nand2  g141(.a(new_n308_), .b(new_n291_), .O(new_n309_));
  ...
  nand2  g147(.a(new_n315_), .b(new_n291_), .O(new_n316_));
  nand2  g148(.a(new_n296_), .b(x73), .O(new_n317_));
  aoi21  g149(.a(new_n317_), .b(new_n316_), .c(x01), .O(z53));
  inv1   g150(.a(x82), .O(new_n320_));
  nand4  g151(.a(x84), .b(x83), .c(new_n320_), .d(new_n236_), .O(new_n321_));
  inv1   g152(.a(x80), .O(new_n322_));
  nand4  g153(.a(new_n232_), .b(new_n161_), .c(new_n322_), .d(x79), .O(new_n323_));
  nor2   g154(.a(new_n323_), .b(new_n321_), .O(z55));
  nand2  g155(.a(new_n160_), .b(new_n159_), .O(new_n325_));
  nand2  g156(.a(new_n230_), .b(x76), .O(new_n326_));
  xnor2a g157(.a(x84), .b(x81), .O(new_n327_));
  aoi21  g158(.a(new_n168_), .b(new_n167_), .c(new_n327_), .O(new_n328_));
  nand2  g159(.a(new_n328_), .b(new_n153_), .O(new_n329_));
  nand2  g160(.a(new_n329_), .b(new_n326_), .O(new_n330_));
  nand2  g161(.a(new_n330_), .b(x79), .O(new_n331_));
  nand4  g162(.a(new_n331_), .b(new_n325_), .c(new_n153_), .d(x00), .O(z56));
  nand4  g163(.a(x80), .b(new_n219_), .c(x43), .d(new_n235_), .O(new_n334_));
  oai22  g164(.a(new_n334_), .b(new_n218_), .c(new_n235_), .d(x40), .O(new_n335_));
  nand3  g165(.a(new_n335_), .b(new_n224_), .c(x79), .O(new_n336_));
  ...
  inv1   g170(.a(new_n167_), .O(new_n341_));
  oai21  g171(.a(new_n341_), .b(new_n227_), .c(new_n154_), .O(new_n342_));
  aoi21  g172(.a(new_n342_), .b(new_n340_), .c(x01), .O(z58));
  inv1   g173(.a(new_n337_), .O(new_n344_));
  aoi21  g174(.a(new_n223_), .b(new_n344_), .c(new_n152_), .O(new_n345_));
  oai21  g175(.a(new_n220_), .b(new_n218_), .c(new_n235_), .O(new_n346_));
  aoi21  g176(.a(new_n346_), .b(x79), .c(new_n223_), .O(new_n347_));
  oai21  g177(.a(new_n347_), .b(new_n345_), .c(x77), .O(new_n348_));
  nor2   g178(.a(x79), .b(x04), .O(new_n349_));
  inv1   g179(.a(new_n349_), .O(new_n350_));
  aoi21  g180(.a(new_n350_), .b(new_n348_), .c(x01), .O(z59));
  aoi21  g181(.a(new_n328_), .b(x79), .c(new_n349_), .O(new_n352_));
  aoi21  g182(.a(new_n352_), .b(new_n225_), .c(x01), .O(z60));
  inv1   g183(.a(new_n170_), .O(new_n354_));
  nand2  g184(.a(new_n168_), .b(new_n167_), .O(new_n355_));
  aoi22  g185(.a(new_n355_), .b(new_n214_), .c(new_n161_), .d(new_n227_), .O(new_n356_));
  nor3   g186(.a(new_n356_), .b(new_n354_), .c(new_n322_), .O(z61));
  nand3  g187(.a(x84), .b(x81), .c(x79), .O(new_n358_));
  oai21  g188(.a(x79), .b(new_n227_), .c(new_n358_), .O(new_n359_));
  nand2  g189(.a(new_n359_), .b(new_n159_), .O(new_n360_));
  nand2  g190(.a(new_n346_), .b(x79), .O(new_n361_));
  nand3  g191(.a(x81), .b(x79), .c(new_n227_), .O(new_n362_));
  inv1   g192(.a(new_n362_), .O(new_n363_));
  aoi21  g193(.a(new_n361_), .b(x04), .c(new_n363_), .O(new_n364_));
  oai21  g194(.a(new_n364_), .b(new_n159_), .c(new_n360_), .O(new_n365_));
  nand2  g195(.a(new_n365_), .b(x78), .O(new_n366_));
  inv1   g196(.a(new_n358_), .O(new_n367_));
  nand2  g197(.a(new_n367_), .b(new_n293_), .O(new_n368_));
  aoi21  g198(.a(new_n368_), .b(new_n366_), .c(x01), .O(z62));
  nor3   g199(.a(new_n356_), .b(new_n354_), .c(new_n320_), .O(z63));
  nand2  g200(.a(x83), .b(x79), .O(new_n371_));
  or2    g201(.a(new_n371_), .b(new_n356_), .O(new_n372_));
  aoi21  g202(.a(new_n372_), .b(new_n290_), .c(x01), .O(z64));
  ...
  nand2  g206(.a(new_n341_), .b(x81), .O(new_n377_));
  nand2  g207(.a(new_n170_), .b(x84), .O(new_n378_));
  aoi21  g208(.a(new_n377_), .b(new_n376_), .c(new_n378_), .O(z65));
  zero   g209(.O(z08));
  zero   g210(.O(z12));
  zero   g211(.O(z15));
  zero   g212(.O(z16));
