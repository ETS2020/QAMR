...
module FAU ( 
  ...
  nand2  g182(.a(new_n340_), .b(new_n321_), .O(new_n341_));
  ...
  nand2  g188(.a(new_n346_), .b(new_n321_), .O(new_n347_));
  ...
  inv1   g202(.a(new_n277_), .O(new_n361_));
  nor2   g203(.a(x80), .b(new_n154_), .O(new_n362_));
  nand3  g204(.a(new_n362_), .b(new_n252_), .c(new_n165_), .O(new_n363_));
  nor4   g205(.a(new_n363_), .b(new_n361_), .c(new_n360_), .d(x82), .O(z55));
  nand2  g206(.a(new_n250_), .b(x76), .O(new_n365_));
  ...
  nand4  g219(.a(x80), .b(new_n240_), .c(x43), .d(new_n255_), .O(new_n378_));
  oai22  g220(.a(new_n378_), .b(new_n239_), .c(new_n255_), .d(x40), .O(new_n379_));
  nand3  g221(.a(new_n379_), .b(new_n237_), .c(x79), .O(new_n380_));
  nand3  g222(.a(new_n179_), .b(new_n255_), .c(x40), .O(new_n381_));
  ...
  oai21  g228(.a(new_n241_), .b(new_n239_), .c(new_n255_), .O(new_n387_));
  ...
  oai21  g236(.a(new_n171_), .b(new_n169_), .c(new_n234_), .O(new_n395_));
  oai21  g237(.a(new_n250_), .b(x04), .c(new_n395_), .O(new_n396_));
  ...
  nor2   g257(.a(new_n259_), .b(x78), .O(new_n417_));
