// Benchmark "FAU" written by ABC on Fri Jul 10 18:16:24 2020
...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n276_, new_n280_, new_n284_, new_n286_, new_n287_, new_n288_,
  ...
  nand4  g092(.a(new_n241_), .b(new_n240_), .c(x47), .d(new_n233_), .O(new_n250_));
  inv1   g093(.a(new_n250_), .O(z29));
  nand4  g094(.a(new_n241_), .b(new_n240_), .c(x48), .d(new_n233_), .O(new_n252_));
  inv1   g095(.a(new_n252_), .O(z30));
  nand4  g096(.a(new_n241_), .b(new_n240_), .c(x49), .d(new_n233_), .O(new_n254_));
  inv1   g097(.a(new_n254_), .O(z31));
  inv1   g098(.a(new_n162_), .O(new_n260_));
  nor2   g099(.a(new_n219_), .b(new_n233_), .O(new_n261_));
  inv1   g100(.a(new_n261_), .O(new_n262_));
  nand2  g101(.a(new_n262_), .b(new_n234_), .O(new_n263_));
  nand2  g102(.a(new_n261_), .b(x81), .O(new_n264_));
  aoi21  g103(.a(new_n264_), .b(new_n263_), .c(new_n237_), .O(new_n265_));
  nand2  g104(.a(new_n262_), .b(x81), .O(new_n266_));
  nand2  g105(.a(new_n261_), .b(new_n234_), .O(new_n267_));
  aoi21  g106(.a(new_n267_), .b(new_n266_), .c(new_n235_), .O(new_n268_));
  oai21  g107(.a(new_n268_), .b(new_n265_), .c(new_n260_), .O(new_n269_));
  nand2  g108(.a(new_n241_), .b(x54), .O(new_n270_));
  nor2   g109(.a(new_n270_), .b(new_n269_), .O(z36));
  nand2  g110(.a(new_n241_), .b(x56), .O(new_n273_));
  nor2   g111(.a(new_n273_), .b(new_n269_), .O(z38));
  inv1   g112(.a(new_n241_), .O(new_n276_));
  nor3   g113(.a(new_n269_), .b(new_n276_), .c(new_n192_), .O(z40));
  nor3   g114(.a(new_n269_), .b(new_n276_), .c(new_n189_), .O(z41));
  nor3   g115(.a(new_n269_), .b(new_n276_), .c(new_n186_), .O(z42));
  nand2  g116(.a(new_n241_), .b(x61), .O(new_n280_));
  nor2   g117(.a(new_n280_), .b(new_n269_), .O(z43));
  nor3   g118(.a(new_n269_), .b(new_n276_), .c(new_n179_), .O(z45));
  nand2  g119(.a(new_n241_), .b(x64), .O(new_n284_));
  nor2   g120(.a(new_n284_), .b(new_n269_), .O(z46));
  ...
  nand2  g125(.a(new_n289_), .b(new_n226_), .O(new_n290_));
  inv1   g126(.a(new_n290_), .O(new_n291_));
  nand2  g127(.a(new_n291_), .b(new_n288_), .O(new_n292_));
  nor2   g128(.a(x75), .b(x67), .O(new_n293_));
  inv1   g129(.a(new_n168_), .O(new_n294_));
  nand2  g130(.a(new_n294_), .b(x79), .O(new_n295_));
  nor2   g131(.a(new_n295_), .b(new_n293_), .O(new_n296_));
  nand2  g132(.a(new_n296_), .b(new_n216_), .O(new_n297_));
  aoi21  g133(.a(new_n297_), .b(new_n292_), .c(x01), .O(z47));
  inv1   g134(.a(x08), .O(new_n299_));
  nand2  g135(.a(x52), .b(x16), .O(new_n300_));
  oai21  g136(.a(x52), .b(new_n299_), .c(new_n300_), .O(new_n301_));
  nand2  g137(.a(new_n301_), .b(new_n291_), .O(new_n302_));
  inv1   g138(.a(new_n216_), .O(new_n303_));
  nor2   g139(.a(new_n295_), .b(new_n303_), .O(new_n304_));
  nand2  g140(.a(new_n304_), .b(x68), .O(new_n305_));
  aoi21  g141(.a(new_n305_), .b(new_n302_), .c(x01), .O(z48));
  inv1   g142(.a(x10), .O(new_n308_));
  nand2  g143(.a(x52), .b(x18), .O(new_n309_));
  oai21  g144(.a(x52), .b(new_n308_), .c(new_n309_), .O(new_n310_));
  nand2  g145(.a(new_n310_), .b(new_n291_), .O(new_n311_));
  nand2  g146(.a(new_n304_), .b(x70), .O(new_n312_));
  ...
  nand2  g151(.a(new_n316_), .b(new_n291_), .O(new_n317_));
  nand2  g152(.a(new_n304_), .b(x71), .O(new_n318_));
  ...
  nand2  g157(.a(new_n322_), .b(new_n291_), .O(new_n323_));
  nand2  g158(.a(new_n304_), .b(x72), .O(new_n324_));
  ...
  nand2  g163(.a(new_n328_), .b(new_n291_), .O(new_n329_));
  nand2  g164(.a(new_n304_), .b(x73), .O(new_n330_));
  aoi21  g165(.a(new_n330_), .b(new_n329_), .c(x01), .O(z53));
  inv1   g166(.a(x82), .O(new_n333_));
  nand4  g167(.a(x84), .b(x83), .c(new_n333_), .d(new_n234_), .O(new_n334_));
  inv1   g168(.a(x80), .O(new_n335_));
  nand4  g169(.a(new_n241_), .b(new_n161_), .c(new_n335_), .d(x79), .O(new_n336_));
  nor2   g170(.a(new_n336_), .b(new_n334_), .O(z55));
  nand2  g171(.a(new_n160_), .b(new_n159_), .O(new_n338_));
  inv1   g172(.a(x76), .O(new_n339_));
  ...
  oai21  g176(.a(new_n161_), .b(new_n339_), .c(new_n342_), .O(new_n343_));
  nand2  g177(.a(new_n343_), .b(x79), .O(new_n344_));
  nand4  g178(.a(new_n344_), .b(new_n338_), .c(new_n153_), .d(x00), .O(z56));
  nand4  g179(.a(x80), .b(new_n221_), .c(x43), .d(new_n233_), .O(new_n347_));
  oai22  g180(.a(new_n347_), .b(new_n220_), .c(new_n233_), .d(x40), .O(new_n348_));
  nand3  g181(.a(new_n348_), .b(new_n226_), .c(x79), .O(new_n349_));
  nor2   g182(.a(x79), .b(x78), .O(new_n350_));
  nand3  g183(.a(new_n350_), .b(new_n233_), .c(x40), .O(new_n351_));
  nand2  g184(.a(new_n351_), .b(new_n349_), .O(new_n352_));
  nand2  g185(.a(new_n352_), .b(x77), .O(new_n353_));
  inv1   g186(.a(new_n167_), .O(new_n354_));
  oai21  g187(.a(new_n354_), .b(new_n229_), .c(new_n154_), .O(new_n355_));
  aoi21  g188(.a(new_n355_), .b(new_n353_), .c(x01), .O(z58));
  inv1   g189(.a(new_n350_), .O(new_n357_));
  aoi21  g190(.a(new_n225_), .b(new_n357_), .c(new_n152_), .O(new_n358_));
  oai21  g191(.a(new_n222_), .b(new_n220_), .c(new_n233_), .O(new_n359_));
  aoi21  g192(.a(new_n359_), .b(x79), .c(new_n225_), .O(new_n360_));
  ...
  nand2  g213(.a(new_n380_), .b(new_n294_), .O(new_n381_));
  ...
  aoi21  g218(.a(new_n385_), .b(new_n290_), .c(x01), .O(z64));
  nor2   g219(.a(new_n160_), .b(x04), .O(new_n387_));
  nor2   g220(.a(new_n234_), .b(x78), .O(new_n388_));
