...
module FAU ( 
  ...
  nor3   g147(.a(new_n295_), .b(new_n286_), .c(new_n203_), .O(z39));
  nand2  g148(.a(new_n256_), .b(x58), .O(new_n305_));
  nor2   g149(.a(new_n305_), .b(new_n295_), .O(z40));
  nor3   g150(.a(new_n295_), .b(new_n286_), .c(new_n196_), .O(z42));
  nor3   g151(.a(new_n295_), .b(new_n286_), .c(new_n193_), .O(z43));
  nor3   g152(.a(new_n295_), .b(new_n286_), .c(new_n190_), .O(z44));
  nor3   g153(.a(new_n295_), .b(new_n286_), .c(new_n187_), .O(z45));
  nor3   g154(.a(new_n295_), .b(new_n286_), .c(new_n184_), .O(z46));
  ...
  nand2  g193(.a(new_n285_), .b(x14), .O(new_n353_));
  ...
  inv1   g197(.a(new_n272_), .O(new_n357_));
  nor2   g198(.a(x80), .b(new_n154_), .O(new_n358_));
  nand3  g199(.a(new_n358_), .b(new_n256_), .c(new_n165_), .O(new_n359_));
  ...
  aoi21  g210(.a(new_n369_), .b(new_n164_), .c(new_n243_), .O(new_n370_));
  nand2  g211(.a(new_n370_), .b(new_n368_), .O(z56));
  inv1   g212(.a(x02), .O(new_n372_));
  nand3  g213(.a(new_n244_), .b(x03), .c(new_n372_), .O(new_n373_));
  inv1   g214(.a(new_n373_), .O(z57));
  nand4  g215(.a(x80), .b(new_n236_), .c(x43), .d(new_n247_), .O(new_n375_));
  oai22  g216(.a(new_n375_), .b(new_n235_), .c(new_n247_), .d(x40), .O(new_n376_));
  nand3  g217(.a(new_n376_), .b(new_n233_), .c(x79), .O(new_n377_));
  ...
  oai21  g224(.a(new_n237_), .b(new_n235_), .c(new_n247_), .O(new_n384_));
  ...
  aoi21  g231(.a(new_n390_), .b(new_n240_), .c(x01), .O(z60));
  oai21  g232(.a(new_n171_), .b(new_n169_), .c(new_n230_), .O(new_n392_));
