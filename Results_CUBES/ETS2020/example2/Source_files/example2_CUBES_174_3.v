...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n333_, new_n334_, new_n335_, new_n336_, new_n340_, new_n341_,
  ...
  nand2  g145(.a(new_n256_), .b(x55), .O(new_n301_));
  nor2   g146(.a(new_n301_), .b(new_n296_), .O(z37));
  nand2  g147(.a(new_n256_), .b(x56), .O(new_n303_));
  nor2   g148(.a(new_n303_), .b(new_n296_), .O(z38));
  nor3   g149(.a(new_n296_), .b(new_n287_), .c(new_n205_), .O(z39));
  nor3   g150(.a(new_n296_), .b(new_n287_), .c(new_n202_), .O(z40));
  nor3   g151(.a(new_n296_), .b(new_n287_), .c(new_n198_), .O(z42));
  nor3   g152(.a(new_n296_), .b(new_n287_), .c(new_n195_), .O(z43));
  nor3   g153(.a(new_n296_), .b(new_n287_), .c(new_n192_), .O(z44));
  nor3   g154(.a(new_n296_), .b(new_n287_), .c(new_n189_), .O(z45));
  nor3   g155(.a(new_n296_), .b(new_n287_), .c(new_n186_), .O(z46));
  inv1   g156(.a(x07), .O(new_n313_));
  nand2  g157(.a(x52), .b(x15), .O(new_n314_));
  oai21  g158(.a(x52), .b(new_n313_), .c(new_n314_), .O(new_n315_));
  nand3  g159(.a(new_n233_), .b(new_n154_), .c(new_n159_), .O(new_n316_));
  inv1   g160(.a(new_n316_), .O(new_n317_));
  nand2  g161(.a(new_n317_), .b(new_n315_), .O(new_n318_));
  nor2   g162(.a(x75), .b(x67), .O(new_n319_));
  nand2  g163(.a(new_n171_), .b(x79), .O(new_n320_));
  nor2   g164(.a(new_n320_), .b(new_n319_), .O(new_n321_));
  nand2  g165(.a(new_n321_), .b(new_n230_), .O(new_n322_));
  aoi21  g166(.a(new_n322_), .b(new_n318_), .c(x01), .O(z47));
  ...
  inv1   g171(.a(new_n230_), .O(new_n328_));
  ...
  nand2  g178(.a(new_n334_), .b(new_n317_), .O(new_n335_));
  ...
  nand2  g185(.a(new_n329_), .b(x72), .O(new_n344_));
  ...
  nand2  g191(.a(new_n329_), .b(x73), .O(new_n350_));
  aoi21  g192(.a(new_n350_), .b(new_n349_), .c(x01), .O(z53));
  nand2  g193(.a(x52), .b(x22), .O(new_n352_));
  nand2  g194(.a(new_n286_), .b(x14), .O(new_n353_));
  nand4  g195(.a(new_n169_), .b(new_n154_), .c(x04), .d(new_n153_), .O(new_n354_));
  aoi21  g196(.a(new_n353_), .b(new_n352_), .c(new_n354_), .O(z54));
  inv1   g197(.a(x84), .O(new_n356_));
  inv1   g198(.a(new_n273_), .O(new_n357_));
  nor2   g199(.a(x80), .b(new_n154_), .O(new_n358_));
  nand3  g200(.a(new_n358_), .b(new_n256_), .c(new_n165_), .O(new_n359_));
  nor4   g201(.a(new_n359_), .b(new_n357_), .c(new_n356_), .d(x82), .O(z55));
  inv1   g202(.a(new_n165_), .O(new_n361_));
  nand2  g203(.a(new_n361_), .b(x76), .O(new_n362_));
  inv1   g204(.a(new_n171_), .O(new_n363_));
  xnor2a g205(.a(x84), .b(x81), .O(new_n364_));
  aoi21  g206(.a(new_n363_), .b(new_n170_), .c(new_n364_), .O(new_n365_));
  nand2  g207(.a(new_n365_), .b(new_n153_), .O(new_n366_));
  nand2  g208(.a(new_n366_), .b(new_n362_), .O(new_n367_));
  nand2  g209(.a(new_n367_), .b(x79), .O(new_n368_));
  nor2   g210(.a(x77), .b(x01), .O(new_n369_));
  aoi21  g211(.a(new_n369_), .b(new_n164_), .c(new_n243_), .O(new_n370_));
  nand2  g212(.a(new_n370_), .b(new_n368_), .O(z56));
  inv1   g213(.a(x02), .O(new_n372_));
  nand3  g214(.a(new_n244_), .b(x03), .c(new_n372_), .O(new_n373_));
  inv1   g215(.a(new_n373_), .O(z57));
  nand4  g216(.a(x80), .b(new_n236_), .c(x43), .d(new_n247_), .O(new_n375_));
  oai22  g217(.a(new_n375_), .b(new_n235_), .c(new_n247_), .d(x40), .O(new_n376_));
  nand3  g218(.a(new_n376_), .b(new_n233_), .c(x79), .O(new_n377_));
  nand3  g219(.a(new_n179_), .b(new_n247_), .c(x40), .O(new_n378_));
  nand2  g220(.a(new_n378_), .b(new_n377_), .O(new_n379_));
  nand2  g221(.a(new_n379_), .b(x77), .O(new_n380_));
  oai21  g222(.a(new_n169_), .b(new_n160_), .c(new_n154_), .O(new_n381_));
  aoi21  g223(.a(new_n381_), .b(new_n380_), .c(x01), .O(z58));
  aoi21  g224(.a(new_n163_), .b(new_n180_), .c(new_n152_), .O(new_n383_));
  oai21  g225(.a(new_n237_), .b(new_n235_), .c(new_n247_), .O(new_n384_));
  aoi21  g226(.a(new_n384_), .b(x79), .c(new_n163_), .O(new_n385_));
  ...
  aoi21  g231(.a(new_n365_), .b(x79), .c(new_n387_), .O(new_n390_));
  aoi21  g232(.a(new_n390_), .b(new_n240_), .c(x01), .O(z60));
  oai21  g233(.a(new_n171_), .b(new_n169_), .c(new_n230_), .O(new_n392_));
  oai21  g234(.a(new_n361_), .b(x04), .c(new_n392_), .O(new_n393_));
  nand2  g235(.a(new_n174_), .b(x80), .O(new_n394_));
  inv1   g236(.a(new_n394_), .O(new_n395_));
  and2   g237(.a(new_n395_), .b(new_n393_), .O(z61));
  nand3  g238(.a(x84), .b(x81), .c(x79), .O(new_n397_));
  oai21  g239(.a(x79), .b(new_n160_), .c(new_n397_), .O(new_n398_));
  nand2  g240(.a(new_n398_), .b(new_n159_), .O(new_n399_));
  nand2  g241(.a(new_n384_), .b(x79), .O(new_n400_));
  nand3  g242(.a(x81), .b(x79), .c(new_n160_), .O(new_n401_));
  inv1   g243(.a(new_n401_), .O(new_n402_));
  aoi21  g244(.a(new_n400_), .b(x04), .c(new_n402_), .O(new_n403_));
  oai21  g245(.a(new_n403_), .b(new_n159_), .c(new_n399_), .O(new_n404_));
  nand2  g246(.a(new_n404_), .b(x78), .O(new_n405_));
  inv1   g247(.a(new_n397_), .O(new_n406_));
  nand2  g248(.a(new_n406_), .b(new_n171_), .O(new_n407_));
  aoi21  g249(.a(new_n407_), .b(new_n405_), .c(x01), .O(z62));
  nand3  g250(.a(new_n393_), .b(x83), .c(x79), .O(new_n410_));
  nand3  g251(.a(new_n176_), .b(new_n159_), .c(x04), .O(new_n411_));
  aoi21  g252(.a(new_n411_), .b(new_n410_), .c(x01), .O(z64));
  nor2   g253(.a(new_n164_), .b(x04), .O(new_n413_));
  nor2   g254(.a(new_n251_), .b(x78), .O(new_n414_));
  oai21  g255(.a(new_n414_), .b(new_n413_), .c(x77), .O(new_n415_));
  nand2  g256(.a(new_n169_), .b(x81), .O(new_n416_));
  nand2  g257(.a(new_n174_), .b(x84), .O(new_n417_));
