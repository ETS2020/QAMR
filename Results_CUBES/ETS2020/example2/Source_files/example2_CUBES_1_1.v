// Benchmark "FAU" written by ABC on Fri Jul 10 18:09:52 2020
...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n197_, new_n198_, new_n201_, new_n202_, new_n207_, new_n208_,
    ...
    new_n277_, new_n280_, new_n282_, new_n284_, new_n287_, new_n294_,
  ...
  xor2a  g072(.a(x84), .b(x82), .O(new_n232_));
  inv1   g073(.a(new_n232_), .O(new_n233_));
  ...
  aoi21  g078(.a(new_n237_), .b(new_n234_), .c(new_n162_), .O(new_n238_));
  nand4  g079(.a(new_n238_), .b(new_n228_), .c(new_n231_), .d(x05), .O(new_n239_));
  inv1   g080(.a(new_n239_), .O(z25));
  nand4  g081(.a(new_n238_), .b(new_n228_), .c(x44), .d(new_n231_), .O(new_n241_));
  inv1   g082(.a(new_n241_), .O(z26));
  nand4  g083(.a(new_n238_), .b(new_n228_), .c(x45), .d(new_n231_), .O(new_n243_));
  inv1   g084(.a(new_n243_), .O(z27));
  nand4  g085(.a(new_n238_), .b(new_n228_), .c(x46), .d(new_n231_), .O(new_n245_));
  inv1   g086(.a(new_n245_), .O(z28));
  nand4  g087(.a(new_n238_), .b(new_n228_), .c(x48), .d(new_n231_), .O(new_n248_));
  inv1   g088(.a(new_n248_), .O(z30));
  nand4  g089(.a(new_n238_), .b(new_n228_), .c(x49), .d(new_n231_), .O(new_n250_));
  inv1   g090(.a(new_n250_), .O(z31));
  nand4  g091(.a(new_n238_), .b(new_n228_), .c(x50), .d(new_n231_), .O(new_n252_));
  inv1   g092(.a(new_n252_), .O(z32));
  nor2   g093(.a(new_n213_), .b(x81), .O(new_n254_));
  nor2   g094(.a(x83), .b(new_n235_), .O(new_n255_));
  nor2   g095(.a(new_n255_), .b(new_n254_), .O(new_n256_));
  nand2  g096(.a(x42), .b(x05), .O(new_n257_));
  nand2  g097(.a(x51), .b(new_n231_), .O(new_n258_));
  oai22  g098(.a(new_n258_), .b(new_n235_), .c(new_n257_), .d(new_n256_), .O(new_n259_));
  ...
  nand2  g104(.a(new_n228_), .b(new_n264_), .O(new_n265_));
  aoi21  g105(.a(new_n263_), .b(new_n260_), .c(new_n265_), .O(z33));
  nand2  g106(.a(x83), .b(x42), .O(new_n268_));
  nand2  g107(.a(new_n268_), .b(new_n235_), .O(new_n269_));
  nand3  g108(.a(x83), .b(x81), .c(x42), .O(new_n270_));
  nand2  g109(.a(new_n270_), .b(new_n269_), .O(new_n271_));
  and2   g110(.a(new_n271_), .b(new_n236_), .O(new_n272_));
  nand2  g111(.a(new_n268_), .b(x81), .O(new_n273_));
  nand2  g112(.a(new_n254_), .b(x42), .O(new_n274_));
  aoi21  g113(.a(new_n274_), .b(new_n273_), .c(new_n232_), .O(new_n275_));
  oai21  g114(.a(new_n275_), .b(new_n272_), .c(new_n264_), .O(new_n276_));
  nand2  g115(.a(new_n228_), .b(x53), .O(new_n277_));
  nor2   g116(.a(new_n277_), .b(new_n276_), .O(z35));
  nand2  g117(.a(new_n228_), .b(x55), .O(new_n280_));
  nor2   g118(.a(new_n280_), .b(new_n276_), .O(z37));
  nand2  g119(.a(new_n228_), .b(x56), .O(new_n282_));
  nor2   g120(.a(new_n282_), .b(new_n276_), .O(z38));
  inv1   g121(.a(new_n228_), .O(new_n284_));
  nor3   g122(.a(new_n276_), .b(new_n284_), .c(new_n193_), .O(z39));
  nor3   g123(.a(new_n276_), .b(new_n284_), .c(new_n190_), .O(z40));
  nand2  g124(.a(new_n228_), .b(x59), .O(new_n287_));
  nor2   g125(.a(new_n287_), .b(new_n276_), .O(z41));
  nor3   g126(.a(new_n276_), .b(new_n284_), .c(new_n181_), .O(z45));
  nor3   g127(.a(new_n276_), .b(new_n284_), .c(new_n178_), .O(z46));
  inv1   g128(.a(x07), .O(new_n294_));
  nand2  g129(.a(x52), .b(x15), .O(new_n295_));
  oai21  g130(.a(x52), .b(new_n294_), .c(new_n295_), .O(new_n296_));
  nand3  g131(.a(new_n220_), .b(new_n154_), .c(new_n159_), .O(new_n297_));
  inv1   g132(.a(new_n297_), .O(new_n298_));
  nand2  g133(.a(new_n298_), .b(new_n296_), .O(new_n299_));
  nor2   g134(.a(x75), .b(x67), .O(new_n300_));
  inv1   g135(.a(new_n168_), .O(new_n301_));
  nand2  g136(.a(new_n301_), .b(x79), .O(new_n302_));
  nor2   g137(.a(new_n302_), .b(new_n300_), .O(new_n303_));
  nand2  g138(.a(new_n303_), .b(new_n210_), .O(new_n304_));
  ...
  inv1   g144(.a(new_n210_), .O(new_n310_));
  ...
  nand2  g151(.a(new_n317_), .b(new_n298_), .O(new_n318_));
  nand2  g152(.a(new_n311_), .b(x70), .O(new_n319_));
  ...
  nand2  g157(.a(new_n323_), .b(new_n298_), .O(new_n324_));
  nand2  g158(.a(new_n311_), .b(x71), .O(new_n325_));
  ...
  nand3  g167(.a(new_n254_), .b(x84), .c(new_n335_), .O(new_n336_));
  inv1   g168(.a(x80), .O(new_n337_));
  nand4  g169(.a(new_n228_), .b(new_n161_), .c(new_n337_), .d(x79), .O(new_n338_));
  nor2   g170(.a(new_n338_), .b(new_n336_), .O(z55));
  nand2  g171(.a(new_n160_), .b(new_n159_), .O(new_n340_));
  nand2  g172(.a(new_n226_), .b(x76), .O(new_n341_));
  xnor2a g173(.a(x84), .b(x81), .O(new_n342_));
  aoi21  g174(.a(new_n168_), .b(new_n167_), .c(new_n342_), .O(new_n343_));
  nand2  g175(.a(new_n343_), .b(new_n153_), .O(new_n344_));
  nand2  g176(.a(new_n344_), .b(new_n341_), .O(new_n345_));
  nand2  g177(.a(new_n345_), .b(x79), .O(new_n346_));
  nand4  g178(.a(new_n346_), .b(new_n340_), .c(new_n153_), .d(x00), .O(z56));
  nand4  g179(.a(x80), .b(new_n215_), .c(x43), .d(new_n231_), .O(new_n349_));
  oai22  g180(.a(new_n349_), .b(new_n214_), .c(new_n231_), .d(x40), .O(new_n350_));
  nand3  g181(.a(new_n350_), .b(new_n220_), .c(x79), .O(new_n351_));
  nor2   g182(.a(x79), .b(x78), .O(new_n352_));
  nand3  g183(.a(new_n352_), .b(new_n231_), .c(x40), .O(new_n353_));
  nand2  g184(.a(new_n353_), .b(new_n351_), .O(new_n354_));
  nand2  g185(.a(new_n354_), .b(x77), .O(new_n355_));
  oai21  g186(.a(new_n332_), .b(new_n223_), .c(new_n154_), .O(new_n356_));
  ...
  oai21  g190(.a(new_n216_), .b(new_n214_), .c(new_n231_), .O(new_n360_));
  ...
  aoi21  g196(.a(new_n343_), .b(x79), .c(new_n363_), .O(new_n366_));
  ...
  nor3   g201(.a(new_n370_), .b(new_n368_), .c(new_n337_), .O(z61));
  ...
  nand2  g212(.a(new_n381_), .b(new_n301_), .O(new_n382_));
  aoi21  g213(.a(new_n382_), .b(new_n380_), .c(x01), .O(z62));
  nor3   g214(.a(new_n370_), .b(new_n368_), .c(new_n335_), .O(z63));
  nand2  g215(.a(x83), .b(x79), .O(new_n385_));
  or2    g216(.a(new_n385_), .b(new_n370_), .O(new_n386_));
  aoi21  g217(.a(new_n386_), .b(new_n297_), .c(x01), .O(z64));
  nor2   g218(.a(new_n160_), .b(x04), .O(new_n388_));
  nor2   g219(.a(new_n235_), .b(x78), .O(new_n389_));
  oai21  g220(.a(new_n389_), .b(new_n388_), .c(x77), .O(new_n390_));
  nand2  g221(.a(new_n332_), .b(x81), .O(new_n391_));
