...
module FAU ( 
  ...
  inv1   g163(.a(x07), .O(new_n320_));
  nand2  g164(.a(x52), .b(x15), .O(new_n321_));
  oai21  g165(.a(x52), .b(new_n320_), .c(new_n321_), .O(new_n322_));
  nand3  g166(.a(new_n237_), .b(new_n154_), .c(new_n159_), .O(new_n323_));
  inv1   g167(.a(new_n323_), .O(new_n324_));
  nand2  g168(.a(new_n324_), .b(new_n322_), .O(new_n325_));
  nor2   g169(.a(x75), .b(x67), .O(new_n326_));
  nand2  g170(.a(new_n171_), .b(x79), .O(new_n327_));
  nor2   g171(.a(new_n327_), .b(new_n326_), .O(new_n328_));
  nand2  g172(.a(new_n328_), .b(new_n234_), .O(new_n329_));
  aoi21  g173(.a(new_n329_), .b(new_n325_), .c(x01), .O(z47));
  inv1   g174(.a(x08), .O(new_n331_));
  nand2  g175(.a(x52), .b(x16), .O(new_n332_));
  oai21  g176(.a(x52), .b(new_n331_), .c(new_n332_), .O(new_n333_));
  nand2  g177(.a(new_n333_), .b(new_n324_), .O(new_n334_));
  inv1   g178(.a(new_n234_), .O(new_n335_));
  nor2   g179(.a(new_n327_), .b(new_n335_), .O(new_n336_));
  nand2  g180(.a(new_n336_), .b(x68), .O(new_n337_));
  aoi21  g181(.a(new_n337_), .b(new_n334_), .c(x01), .O(z48));
  inv1   g182(.a(x09), .O(new_n339_));
  nand2  g183(.a(x52), .b(x17), .O(new_n340_));
  oai21  g184(.a(x52), .b(new_n339_), .c(new_n340_), .O(new_n341_));
  nand2  g185(.a(new_n341_), .b(new_n324_), .O(new_n342_));
  nand2  g186(.a(new_n336_), .b(x69), .O(new_n343_));
  aoi21  g187(.a(new_n343_), .b(new_n342_), .c(x01), .O(z49));
  inv1   g188(.a(x10), .O(new_n345_));
  nand2  g189(.a(x52), .b(x18), .O(new_n346_));
  oai21  g190(.a(x52), .b(new_n345_), .c(new_n346_), .O(new_n347_));
  nand2  g191(.a(new_n347_), .b(new_n324_), .O(new_n348_));
  nand2  g192(.a(new_n336_), .b(x70), .O(new_n349_));
  aoi21  g193(.a(new_n349_), .b(new_n348_), .c(x01), .O(z50));
  inv1   g194(.a(x12), .O(new_n352_));
  nand2  g195(.a(x52), .b(x20), .O(new_n353_));
  oai21  g196(.a(x52), .b(new_n352_), .c(new_n353_), .O(new_n354_));
  nand2  g197(.a(new_n354_), .b(new_n324_), .O(new_n355_));
  ...
  nand2  g203(.a(new_n360_), .b(new_n324_), .O(new_n361_));
  ...
  nand3  g211(.a(new_n279_), .b(x84), .c(new_n368_), .O(new_n369_));
  nor2   g212(.a(x80), .b(new_n154_), .O(new_n370_));
  nand3  g213(.a(new_n370_), .b(new_n252_), .c(new_n165_), .O(new_n371_));
  nor2   g214(.a(new_n371_), .b(new_n369_), .O(z55));
  nand2  g215(.a(new_n250_), .b(x76), .O(new_n373_));
  ...
  aoi21  g223(.a(new_n380_), .b(new_n164_), .c(new_n247_), .O(new_n381_));
  nand2  g224(.a(new_n381_), .b(new_n379_), .O(z56));
  inv1   g225(.a(x02), .O(new_n383_));
  nand3  g226(.a(new_n248_), .b(x03), .c(new_n383_), .O(new_n384_));
  inv1   g227(.a(new_n384_), .O(z57));
  nand4  g228(.a(x80), .b(new_n240_), .c(x43), .d(new_n255_), .O(new_n386_));
  oai22  g229(.a(new_n386_), .b(new_n239_), .c(new_n255_), .d(x40), .O(new_n387_));
  nand3  g230(.a(new_n387_), .b(new_n237_), .c(x79), .O(new_n388_));
  nand3  g231(.a(new_n179_), .b(new_n255_), .c(x40), .O(new_n389_));
  ...
  oai21  g237(.a(new_n241_), .b(new_n239_), .c(new_n255_), .O(new_n395_));
  ...
  aoi21  g244(.a(new_n401_), .b(new_n244_), .c(x01), .O(z60));
  ...
  oai21  g257(.a(new_n171_), .b(new_n169_), .c(new_n234_), .O(new_n416_));
  oai21  g258(.a(new_n250_), .b(x04), .c(new_n416_), .O(new_n417_));
  ...
  nor2   g266(.a(new_n259_), .b(x78), .O(new_n425_));
