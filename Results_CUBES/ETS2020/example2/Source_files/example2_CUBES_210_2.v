...
module FAU ( 
  ...
  wire new_n154_, new_n155_, new_n156_, new_n157_, new_n158_, new_n159_,
    ...
    new_n201_, new_n202_, new_n205_, new_n206_, new_n213_, new_n214_,
    ...
    new_n321_, new_n322_, new_n323_, new_n326_, new_n327_, new_n332_,
    new_n333_, new_n334_;
  ...
  nand2  g075(.a(new_n244_), .b(new_n213_), .O(new_n245_));
  ...
  nand3  g079(.a(x83), .b(new_n213_), .c(x42), .O(new_n249_));
  aoi21  g080(.a(new_n249_), .b(new_n248_), .c(new_n214_), .O(new_n250_));
  oai21  g081(.a(new_n250_), .b(new_n247_), .c(new_n219_), .O(new_n251_));
  nand2  g082(.a(new_n221_), .b(x54), .O(new_n252_));
  nor2   g083(.a(new_n252_), .b(new_n251_), .O(z36));
  nand2  g084(.a(new_n221_), .b(x56), .O(new_n255_));
  nor2   g085(.a(new_n255_), .b(new_n251_), .O(z38));
  nand2  g086(.a(new_n221_), .b(x57), .O(new_n257_));
  nor2   g087(.a(new_n257_), .b(new_n251_), .O(z39));
  nand2  g088(.a(new_n221_), .b(x58), .O(new_n259_));
  nor2   g089(.a(new_n259_), .b(new_n251_), .O(z40));
  nand2  g090(.a(new_n221_), .b(x59), .O(new_n261_));
  nor2   g091(.a(new_n261_), .b(new_n251_), .O(z41));
  nand2  g092(.a(new_n221_), .b(x60), .O(new_n263_));
  nor2   g093(.a(new_n263_), .b(new_n251_), .O(z42));
  nand2  g094(.a(new_n221_), .b(x61), .O(new_n265_));
  nor2   g095(.a(new_n265_), .b(new_n251_), .O(z43));
  nand2  g096(.a(new_n221_), .b(x62), .O(new_n267_));
  nor2   g097(.a(new_n267_), .b(new_n251_), .O(z44));
  nand2  g098(.a(new_n221_), .b(x63), .O(new_n269_));
  nor2   g099(.a(new_n269_), .b(new_n251_), .O(z45));
  ...
  nand3  g114(.a(new_n286_), .b(new_n277_), .c(new_n276_), .O(new_n287_));
  nand4  g115(.a(new_n279_), .b(new_n158_), .c(x79), .d(x69), .O(new_n288_));
  aoi21  g116(.a(new_n288_), .b(new_n287_), .c(x01), .O(z49));
  inv1   g117(.a(x10), .O(new_n290_));
  nand2  g118(.a(x52), .b(x18), .O(new_n291_));
  oai21  g119(.a(x52), .b(new_n290_), .c(new_n291_), .O(new_n292_));
  nand3  g120(.a(new_n292_), .b(new_n277_), .c(new_n276_), .O(new_n293_));
  nand4  g121(.a(new_n279_), .b(new_n158_), .c(x79), .d(x70), .O(new_n294_));
  aoi21  g122(.a(new_n294_), .b(new_n293_), .c(x01), .O(z50));
  inv1   g123(.a(x11), .O(new_n296_));
  nand2  g124(.a(x52), .b(x19), .O(new_n297_));
  oai21  g125(.a(x52), .b(new_n296_), .c(new_n297_), .O(new_n298_));
  nand3  g126(.a(new_n298_), .b(new_n277_), .c(new_n276_), .O(new_n299_));
  nand4  g127(.a(new_n279_), .b(new_n158_), .c(x79), .d(x71), .O(new_n300_));
  aoi21  g128(.a(new_n300_), .b(new_n299_), .c(x01), .O(z51));
  inv1   g129(.a(x12), .O(new_n302_));
  nand2  g130(.a(x52), .b(x20), .O(new_n303_));
  oai21  g131(.a(x52), .b(new_n302_), .c(new_n303_), .O(new_n304_));
  nand3  g132(.a(new_n304_), .b(new_n277_), .c(new_n276_), .O(new_n305_));
  nand4  g133(.a(new_n279_), .b(new_n158_), .c(x79), .d(x72), .O(new_n306_));
  aoi21  g134(.a(new_n306_), .b(new_n305_), .c(x01), .O(z52));
  inv1   g135(.a(x13), .O(new_n308_));
  nand2  g136(.a(x52), .b(x21), .O(new_n309_));
  oai21  g137(.a(x52), .b(new_n308_), .c(new_n309_), .O(new_n310_));
  nand3  g138(.a(new_n310_), .b(new_n277_), .c(new_n276_), .O(new_n311_));
  nand4  g139(.a(new_n279_), .b(new_n158_), .c(x79), .d(x73), .O(new_n312_));
  aoi21  g140(.a(new_n312_), .b(new_n311_), .c(x01), .O(z53));
  inv1   g141(.a(x14), .O(new_n314_));
  nor2   g142(.a(x52), .b(new_n314_), .O(new_n315_));
  aoi21  g143(.a(x52), .b(x22), .c(new_n315_), .O(new_n316_));
  inv1   g144(.a(x79), .O(new_n317_));
  nand4  g145(.a(new_n155_), .b(new_n317_), .c(x04), .d(new_n160_), .O(new_n318_));
  nor2   g146(.a(new_n318_), .b(new_n316_), .O(z54));
  inv1   g147(.a(x82), .O(new_n320_));
  nand4  g148(.a(x84), .b(x83), .c(new_n320_), .d(new_n213_), .O(new_n321_));
  ...
  oai21  g155(.a(new_n158_), .b(new_n155_), .c(new_n279_), .O(new_n332_));
  nand3  g156(.a(x78), .b(x77), .c(new_n275_), .O(new_n333_));
  nand3  g157(.a(x80), .b(x79), .c(new_n160_), .O(new_n334_));
  aoi21  g158(.a(new_n333_), .b(new_n332_), .c(new_n334_), .O(z61));
  zero   g159(.O(z00));
  zero   g160(.O(z01));
  zero   g161(.O(z03));
  zero   g162(.O(z04));
