// Benchmark "FAU" written by ABC on Fri Jul 10 18:17:53 2020
...
module FAU ( 
  ...
  wire new_n154_, new_n155_, new_n156_, new_n157_, new_n158_, new_n159_,
    ...
    new_n315_, new_n316_, new_n319_, new_n320_, new_n327_, new_n328_,
    new_n329_, new_n330_;
  ...
  xnor2a g071(.a(x84), .b(x82), .O(new_n243_));
  nand2  g072(.a(x83), .b(x42), .O(new_n244_));
  nand2  g073(.a(new_n244_), .b(new_n208_), .O(new_n245_));
  nand3  g074(.a(x83), .b(x81), .c(x42), .O(new_n246_));
  aoi21  g075(.a(new_n246_), .b(new_n245_), .c(new_n243_), .O(new_n247_));
  nand2  g076(.a(new_n244_), .b(x81), .O(new_n248_));
  nand3  g077(.a(x83), .b(new_n208_), .c(x42), .O(new_n249_));
  aoi21  g078(.a(new_n249_), .b(new_n248_), .c(new_n209_), .O(new_n250_));
  oai21  g079(.a(new_n250_), .b(new_n247_), .c(new_n214_), .O(new_n251_));
  nand2  g080(.a(new_n216_), .b(x55), .O(new_n252_));
  nor2   g081(.a(new_n252_), .b(new_n251_), .O(z37));
  nand2  g082(.a(new_n216_), .b(x56), .O(new_n254_));
  nor2   g083(.a(new_n254_), .b(new_n251_), .O(z38));
  nand2  g084(.a(new_n216_), .b(x57), .O(new_n256_));
  nor2   g085(.a(new_n256_), .b(new_n251_), .O(z39));
  nand2  g086(.a(new_n216_), .b(x58), .O(new_n258_));
  nor2   g087(.a(new_n258_), .b(new_n251_), .O(z40));
  nand2  g088(.a(new_n216_), .b(x59), .O(new_n260_));
  nor2   g089(.a(new_n260_), .b(new_n251_), .O(z41));
  nand2  g090(.a(new_n216_), .b(x60), .O(new_n262_));
  nor2   g091(.a(new_n262_), .b(new_n251_), .O(z42));
  nand2  g092(.a(new_n216_), .b(x62), .O(new_n265_));
  nor2   g093(.a(new_n265_), .b(new_n251_), .O(z44));
  nand2  g094(.a(new_n216_), .b(x63), .O(new_n267_));
  nor2   g095(.a(new_n267_), .b(new_n251_), .O(z45));
  nand2  g096(.a(new_n216_), .b(x64), .O(new_n269_));
  nor2   g097(.a(new_n269_), .b(new_n251_), .O(z46));
  inv1   g098(.a(x07), .O(new_n271_));
  nand2  g099(.a(x52), .b(x15), .O(new_n272_));
  oai21  g100(.a(x52), .b(new_n271_), .c(new_n272_), .O(new_n273_));
  inv1   g101(.a(x79), .O(new_n274_));
  nand4  g102(.a(new_n274_), .b(x78), .c(new_n157_), .d(x04), .O(new_n275_));
  inv1   g103(.a(new_n275_), .O(new_n276_));
  nand2  g104(.a(new_n276_), .b(new_n273_), .O(new_n277_));
  ...
  nand4  g136(.a(new_n155_), .b(new_n274_), .c(x04), .d(new_n160_), .O(new_n311_));
  nor2   g137(.a(new_n311_), .b(new_n310_), .O(z54));
  inv1   g138(.a(x82), .O(new_n313_));
  nand4  g139(.a(x84), .b(x83), .c(new_n313_), .d(new_n208_), .O(new_n314_));
  inv1   g140(.a(x80), .O(new_n315_));
  nand4  g141(.a(new_n315_), .b(x79), .c(x78), .d(x77), .O(new_n316_));
  nor4   g142(.a(new_n316_), .b(new_n314_), .c(x04), .d(x01), .O(z55));
  inv1   g143(.a(x02), .O(new_n319_));
  nand4  g144(.a(x03), .b(new_n319_), .c(new_n160_), .d(x00), .O(new_n320_));
  inv1   g145(.a(new_n320_), .O(z57));
  oai21  g146(.a(new_n158_), .b(new_n155_), .c(new_n278_), .O(new_n327_));
  inv1   g147(.a(x04), .O(new_n328_));
  nand3  g148(.a(x78), .b(x77), .c(new_n328_), .O(new_n329_));
  nand3  g149(.a(x82), .b(x79), .c(new_n160_), .O(new_n330_));
  aoi21  g150(.a(new_n329_), .b(new_n327_), .c(new_n330_), .O(z63));
  zero   g151(.O(z00));
  zero   g152(.O(z01));
  zero   g153(.O(z03));
  zero   g154(.O(z04));
