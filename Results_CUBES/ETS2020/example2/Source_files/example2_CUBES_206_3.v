...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n198_, new_n200_, new_n201_, new_n205_, new_n206_, new_n209_,
  ...
  nand3  g157(.a(new_n230_), .b(new_n154_), .c(new_n159_), .O(new_n316_));
  ...
  nand2  g164(.a(new_n322_), .b(new_n227_), .O(new_n323_));
  ...
  inv1   g170(.a(new_n227_), .O(new_n329_));
  ...
  nand2  g184(.a(new_n330_), .b(x72), .O(new_n345_));
  ...
  nand2  g190(.a(new_n330_), .b(x73), .O(new_n351_));
  ...
  nand4  g200(.a(new_n245_), .b(new_n165_), .c(new_n360_), .d(x79), .O(new_n361_));
  nor2   g201(.a(new_n361_), .b(new_n359_), .O(z55));
  nand2  g202(.a(new_n243_), .b(x76), .O(new_n363_));
  ...
  nand4  g214(.a(x80), .b(new_n233_), .c(x43), .d(new_n248_), .O(new_n375_));
  oai22  g215(.a(new_n375_), .b(new_n232_), .c(new_n248_), .d(x40), .O(new_n376_));
  nand3  g216(.a(new_n376_), .b(new_n230_), .c(x79), .O(new_n377_));
  nand3  g217(.a(new_n178_), .b(new_n248_), .c(x40), .O(new_n378_));
  ...
  oai21  g223(.a(new_n234_), .b(new_n232_), .c(new_n248_), .O(new_n384_));
  ...
  aoi22  g233(.a(new_n393_), .b(new_n227_), .c(new_n165_), .d(new_n160_), .O(new_n394_));
  ...
  nor2   g253(.a(new_n252_), .b(x78), .O(new_n414_));
