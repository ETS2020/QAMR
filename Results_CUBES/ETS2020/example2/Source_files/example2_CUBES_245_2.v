...
module FAU ( 
  ...
  wire new_n154_, new_n155_, new_n156_, new_n157_, new_n158_, new_n159_,
    ...
    new_n268_, new_n270_, new_n273_, new_n275_, new_n278_, new_n280_,
  ...
  nand3  g068(.a(new_n222_), .b(x48), .c(new_n221_), .O(new_n233_));
  inv1   g069(.a(new_n233_), .O(new_n234_));
  nand3  g070(.a(new_n234_), .b(new_n220_), .c(new_n218_), .O(new_n235_));
  inv1   g071(.a(new_n235_), .O(z30));
  nand3  g072(.a(new_n222_), .b(x49), .c(new_n221_), .O(new_n237_));
  inv1   g073(.a(new_n237_), .O(new_n238_));
  nand3  g074(.a(new_n238_), .b(new_n220_), .c(new_n218_), .O(new_n239_));
  inv1   g075(.a(new_n239_), .O(z31));
  inv1   g076(.a(new_n215_), .O(new_n242_));
  xnor2a g077(.a(x83), .b(x81), .O(new_n243_));
  nand2  g078(.a(x42), .b(x05), .O(new_n244_));
  nand2  g079(.a(x51), .b(new_n221_), .O(new_n245_));
  oai22  g080(.a(new_n245_), .b(new_n214_), .c(new_n244_), .d(new_n243_), .O(new_n246_));
  ...
  nand2  g084(.a(new_n249_), .b(new_n216_), .O(new_n250_));
  nand2  g085(.a(new_n222_), .b(new_n220_), .O(new_n251_));
  aoi21  g086(.a(new_n250_), .b(new_n247_), .c(new_n251_), .O(z33));
  xnor2a g087(.a(x84), .b(x82), .O(new_n253_));
  nand2  g088(.a(x83), .b(x42), .O(new_n254_));
  nand2  g089(.a(new_n254_), .b(new_n214_), .O(new_n255_));
  ...
  nand3  g093(.a(x83), .b(new_n214_), .c(x42), .O(new_n259_));
  aoi21  g094(.a(new_n259_), .b(new_n258_), .c(new_n215_), .O(new_n260_));
  oai21  g095(.a(new_n260_), .b(new_n257_), .c(new_n220_), .O(new_n261_));
  nand2  g096(.a(new_n222_), .b(x52), .O(new_n262_));
  nor2   g097(.a(new_n262_), .b(new_n261_), .O(z34));
  nand2  g098(.a(new_n222_), .b(x54), .O(new_n265_));
  nor2   g099(.a(new_n265_), .b(new_n261_), .O(z36));
  nand2  g100(.a(new_n222_), .b(x56), .O(new_n268_));
  nor2   g101(.a(new_n268_), .b(new_n261_), .O(z38));
  nand2  g102(.a(new_n222_), .b(x57), .O(new_n270_));
  nor2   g103(.a(new_n270_), .b(new_n261_), .O(z39));
  nand2  g104(.a(new_n222_), .b(x59), .O(new_n273_));
  nor2   g105(.a(new_n273_), .b(new_n261_), .O(z41));
  nand2  g106(.a(new_n222_), .b(x60), .O(new_n275_));
  nor2   g107(.a(new_n275_), .b(new_n261_), .O(z42));
  nand2  g108(.a(new_n222_), .b(x62), .O(new_n278_));
  nor2   g109(.a(new_n278_), .b(new_n261_), .O(z44));
  nand2  g110(.a(new_n222_), .b(x63), .O(new_n280_));
  nor2   g111(.a(new_n280_), .b(new_n261_), .O(z45));
  nand2  g112(.a(new_n222_), .b(x64), .O(new_n282_));
  nor2   g113(.a(new_n282_), .b(new_n261_), .O(z46));
  ...
  nand3  g119(.a(new_n288_), .b(new_n286_), .c(new_n163_), .O(new_n289_));
  xnor2a g120(.a(x84), .b(x81), .O(new_n290_));
  or2    g121(.a(x75), .b(x67), .O(new_n291_));
  nand4  g122(.a(new_n291_), .b(new_n290_), .c(new_n158_), .d(x79), .O(new_n292_));
  aoi21  g123(.a(new_n292_), .b(new_n289_), .c(x01), .O(z47));
  inv1   g124(.a(x08), .O(new_n294_));
  nand2  g125(.a(x52), .b(x16), .O(new_n295_));
  oai21  g126(.a(x52), .b(new_n294_), .c(new_n295_), .O(new_n296_));
  nand3  g127(.a(new_n296_), .b(new_n288_), .c(new_n163_), .O(new_n297_));
  nand4  g128(.a(new_n290_), .b(new_n158_), .c(x79), .d(x68), .O(new_n298_));
  aoi21  g129(.a(new_n298_), .b(new_n297_), .c(x01), .O(z48));
  inv1   g130(.a(x09), .O(new_n300_));
  nand2  g131(.a(x52), .b(x17), .O(new_n301_));
  oai21  g132(.a(x52), .b(new_n300_), .c(new_n301_), .O(new_n302_));
  nand3  g133(.a(new_n302_), .b(new_n288_), .c(new_n163_), .O(new_n303_));
  nand4  g134(.a(new_n290_), .b(new_n158_), .c(x79), .d(x69), .O(new_n304_));
  aoi21  g135(.a(new_n304_), .b(new_n303_), .c(x01), .O(z49));
  inv1   g136(.a(x12), .O(new_n308_));
  nand2  g137(.a(x52), .b(x20), .O(new_n309_));
  oai21  g138(.a(x52), .b(new_n308_), .c(new_n309_), .O(new_n310_));
  nand3  g139(.a(new_n310_), .b(new_n288_), .c(new_n163_), .O(new_n311_));
  nand4  g140(.a(new_n290_), .b(new_n158_), .c(x79), .d(x72), .O(new_n312_));
  aoi21  g141(.a(new_n312_), .b(new_n311_), .c(x01), .O(z52));
  inv1   g142(.a(x13), .O(new_n314_));
  nand2  g143(.a(x52), .b(x21), .O(new_n315_));
  oai21  g144(.a(x52), .b(new_n314_), .c(new_n315_), .O(new_n316_));
  nand3  g145(.a(new_n316_), .b(new_n288_), .c(new_n163_), .O(new_n317_));
  nand4  g146(.a(new_n290_), .b(new_n158_), .c(x79), .d(x73), .O(new_n318_));
  aoi21  g147(.a(new_n318_), .b(new_n317_), .c(x01), .O(z53));
  inv1   g148(.a(x14), .O(new_n320_));
  nor2   g149(.a(x52), .b(new_n320_), .O(new_n321_));
  aoi21  g150(.a(x52), .b(x22), .c(new_n321_), .O(new_n322_));
  inv1   g151(.a(x79), .O(new_n323_));
  nand4  g152(.a(new_n155_), .b(new_n323_), .c(x04), .d(new_n160_), .O(new_n324_));
  nor2   g153(.a(new_n324_), .b(new_n322_), .O(z54));
  inv1   g154(.a(x02), .O(new_n328_));
  nand4  g155(.a(x03), .b(new_n328_), .c(new_n160_), .d(x00), .O(new_n329_));
  inv1   g156(.a(new_n329_), .O(z57));
  oai21  g157(.a(new_n158_), .b(new_n155_), .c(new_n290_), .O(new_n334_));
  nand3  g158(.a(x78), .b(x77), .c(new_n287_), .O(new_n335_));
  nand3  g159(.a(x80), .b(x79), .c(new_n160_), .O(new_n336_));
