...
module FAU ( 
  ...
  nand2  g119(.a(new_n277_), .b(new_n244_), .O(new_n278_));
  nand3  g120(.a(x83), .b(x81), .c(x42), .O(new_n279_));
  nand2  g121(.a(new_n279_), .b(new_n278_), .O(new_n280_));
  and2   g122(.a(new_n280_), .b(new_n245_), .O(new_n281_));
  nand2  g123(.a(new_n277_), .b(x81), .O(new_n282_));
  nand2  g124(.a(new_n262_), .b(x42), .O(new_n283_));
  aoi21  g125(.a(new_n283_), .b(new_n282_), .c(new_n241_), .O(new_n284_));
  oai21  g126(.a(new_n284_), .b(new_n281_), .c(new_n272_), .O(new_n285_));
  nor3   g127(.a(new_n285_), .b(new_n276_), .c(new_n275_), .O(z34));
  nand2  g128(.a(new_n237_), .b(x53), .O(new_n287_));
  nor2   g129(.a(new_n287_), .b(new_n285_), .O(z35));
  nand2  g130(.a(new_n237_), .b(x54), .O(new_n289_));
  nor2   g131(.a(new_n289_), .b(new_n285_), .O(z36));
  nand2  g132(.a(new_n237_), .b(x55), .O(new_n291_));
  nor2   g133(.a(new_n291_), .b(new_n285_), .O(z37));
  nor3   g134(.a(new_n285_), .b(new_n276_), .c(new_n186_), .O(z40));
  nor3   g135(.a(new_n285_), .b(new_n276_), .c(new_n183_), .O(z41));
  nand2  g136(.a(new_n237_), .b(x60), .O(new_n297_));
  nor2   g137(.a(new_n297_), .b(new_n285_), .O(z42));
  nor3   g138(.a(new_n285_), .b(new_n276_), .c(new_n179_), .O(z43));
  nor3   g139(.a(new_n285_), .b(new_n276_), .c(new_n176_), .O(z44));
  ...
  nand3  g177(.a(new_n262_), .b(x84), .c(new_n341_), .O(new_n342_));
