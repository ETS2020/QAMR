...
module FAU ( 
  ...
  nor3   g146(.a(new_n292_), .b(new_n283_), .c(new_n202_), .O(z39));
  ...
  nand3  g155(.a(new_n232_), .b(new_n154_), .c(new_n159_), .O(new_n313_));
  ...
  nand2  g162(.a(new_n319_), .b(new_n229_), .O(new_n320_));
  ...
  inv1   g168(.a(new_n229_), .O(new_n326_));
  ...
  nand2  g181(.a(new_n339_), .b(new_n314_), .O(new_n340_));
  ...
  nand2  g187(.a(new_n345_), .b(new_n314_), .O(new_n346_));
  ...
  nand2  g193(.a(new_n351_), .b(new_n314_), .O(new_n352_));
  ...
  oai21  g218(.a(new_n357_), .b(new_n160_), .c(new_n154_), .O(new_n378_));
  ...
  nand2  g229(.a(new_n171_), .b(new_n170_), .O(new_n389_));
  aoi22  g230(.a(new_n389_), .b(new_n229_), .c(new_n165_), .d(new_n160_), .O(new_n390_));
  nand2  g231(.a(new_n173_), .b(x80), .O(new_n391_));
  nor2   g232(.a(new_n391_), .b(new_n390_), .O(z61));
  ...
  nand2  g243(.a(new_n402_), .b(new_n317_), .O(new_n403_));
  aoi21  g244(.a(new_n403_), .b(new_n401_), .c(x01), .O(z62));
  nand2  g245(.a(new_n173_), .b(x82), .O(new_n405_));
  nor2   g246(.a(new_n405_), .b(new_n390_), .O(z63));
  nand2  g247(.a(x83), .b(x79), .O(new_n407_));
  or2    g248(.a(new_n407_), .b(new_n390_), .O(new_n408_));
  nand4  g249(.a(new_n154_), .b(x78), .c(new_n159_), .d(x04), .O(new_n409_));
  aoi21  g250(.a(new_n409_), .b(new_n408_), .c(x01), .O(z64));
  nor2   g251(.a(new_n164_), .b(x04), .O(new_n411_));
  nor2   g252(.a(new_n250_), .b(x78), .O(new_n412_));
  oai21  g253(.a(new_n412_), .b(new_n411_), .c(x77), .O(new_n413_));
  nand2  g254(.a(new_n357_), .b(x81), .O(new_n414_));
  nand2  g255(.a(new_n173_), .b(x84), .O(new_n415_));
