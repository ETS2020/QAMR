...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n294_, new_n295_, new_n297_, new_n300_, new_n302_, new_n309_,
  ...
  inv1   g036(.a(x61), .O(new_n190_));
  nand2  g037(.a(new_n152_), .b(x27), .O(new_n191_));
  oai21  g038(.a(new_n190_), .b(new_n152_), .c(new_n191_), .O(z09));
  ...
  nand4  g109(.a(new_n258_), .b(new_n247_), .c(x45), .d(new_n250_), .O(new_n263_));
  ...
  nand4  g115(.a(new_n258_), .b(new_n247_), .c(x49), .d(new_n250_), .O(new_n270_));
  inv1   g116(.a(new_n270_), .O(z31));
  nand4  g117(.a(new_n258_), .b(new_n247_), .c(x50), .d(new_n250_), .O(new_n272_));
  inv1   g118(.a(new_n272_), .O(z32));
  xnor2a g119(.a(x83), .b(x81), .O(new_n274_));
  nand2  g120(.a(x42), .b(x05), .O(new_n275_));
  nand2  g121(.a(x51), .b(new_n250_), .O(new_n276_));
  oai22  g122(.a(new_n276_), .b(new_n254_), .c(new_n275_), .d(new_n274_), .O(new_n277_));
  nand2  g123(.a(new_n277_), .b(new_n252_), .O(new_n278_));
  xor2a  g124(.a(x83), .b(x81), .O(new_n279_));
  oai22  g125(.a(new_n279_), .b(new_n275_), .c(new_n276_), .d(x81), .O(new_n280_));
  nand2  g126(.a(new_n280_), .b(new_n255_), .O(new_n281_));
  inv1   g127(.a(new_n257_), .O(new_n282_));
  nand2  g128(.a(new_n282_), .b(new_n247_), .O(new_n283_));
  aoi21  g129(.a(new_n281_), .b(new_n278_), .c(new_n283_), .O(z33));
  inv1   g130(.a(x52), .O(new_n285_));
  inv1   g131(.a(new_n247_), .O(new_n286_));
  nand2  g132(.a(x83), .b(x42), .O(new_n287_));
  nand2  g133(.a(new_n287_), .b(new_n254_), .O(new_n288_));
  nand3  g134(.a(x83), .b(x81), .c(x42), .O(new_n289_));
  nand2  g135(.a(new_n289_), .b(new_n288_), .O(new_n290_));
  and2   g136(.a(new_n290_), .b(new_n255_), .O(new_n291_));
  nand2  g137(.a(new_n287_), .b(x81), .O(new_n292_));
  nand3  g138(.a(x83), .b(new_n254_), .c(x42), .O(new_n293_));
  aoi21  g139(.a(new_n293_), .b(new_n292_), .c(new_n251_), .O(new_n294_));
  oai21  g140(.a(new_n294_), .b(new_n291_), .c(new_n282_), .O(new_n295_));
  nor3   g141(.a(new_n295_), .b(new_n286_), .c(new_n285_), .O(z34));
  nand2  g142(.a(new_n247_), .b(x53), .O(new_n297_));
  nor2   g143(.a(new_n297_), .b(new_n295_), .O(z35));
  nand2  g144(.a(new_n247_), .b(x55), .O(new_n300_));
  nor2   g145(.a(new_n300_), .b(new_n295_), .O(z37));
  nand2  g146(.a(new_n247_), .b(x56), .O(new_n302_));
  nor2   g147(.a(new_n302_), .b(new_n295_), .O(z38));
  nor3   g148(.a(new_n295_), .b(new_n286_), .c(new_n202_), .O(z39));
  nor3   g149(.a(new_n295_), .b(new_n286_), .c(new_n199_), .O(z40));
  nor3   g150(.a(new_n295_), .b(new_n286_), .c(new_n193_), .O(z42));
  nor3   g151(.a(new_n295_), .b(new_n286_), .c(new_n190_), .O(z43));
  nand2  g152(.a(new_n247_), .b(x62), .O(new_n309_));
  nor2   g153(.a(new_n309_), .b(new_n295_), .O(z44));
  nor3   g154(.a(new_n295_), .b(new_n286_), .c(new_n186_), .O(z45));
  ...
  nand2  g170(.a(new_n327_), .b(new_n317_), .O(new_n328_));
  inv1   g171(.a(new_n229_), .O(new_n329_));
  ...
  nand2  g178(.a(new_n335_), .b(new_n317_), .O(new_n336_));
  nand2  g179(.a(new_n330_), .b(x69), .O(new_n337_));
  aoi21  g180(.a(new_n337_), .b(new_n336_), .c(x01), .O(z49));
  inv1   g181(.a(x11), .O(new_n340_));
  nand2  g182(.a(x52), .b(x19), .O(new_n341_));
  oai21  g183(.a(x52), .b(new_n340_), .c(new_n341_), .O(new_n342_));
  nand2  g184(.a(new_n342_), .b(new_n317_), .O(new_n343_));
  nand2  g185(.a(new_n330_), .b(x71), .O(new_n344_));
  aoi21  g186(.a(new_n344_), .b(new_n343_), .c(x01), .O(z51));
  inv1   g187(.a(x12), .O(new_n346_));
  nand2  g188(.a(x52), .b(x20), .O(new_n347_));
  oai21  g189(.a(x52), .b(new_n346_), .c(new_n347_), .O(new_n348_));
  nand2  g190(.a(new_n348_), .b(new_n317_), .O(new_n349_));
  nand2  g191(.a(new_n330_), .b(x72), .O(new_n350_));
  aoi21  g192(.a(new_n350_), .b(new_n349_), .c(x01), .O(z52));
  inv1   g193(.a(x13), .O(new_n352_));
  nand2  g194(.a(x52), .b(x21), .O(new_n353_));
  oai21  g195(.a(x52), .b(new_n352_), .c(new_n353_), .O(new_n354_));
  nand2  g196(.a(new_n354_), .b(new_n317_), .O(new_n355_));
  nand2  g197(.a(new_n330_), .b(x73), .O(new_n356_));
  aoi21  g198(.a(new_n356_), .b(new_n355_), .c(x01), .O(z53));
  nand2  g199(.a(x52), .b(x22), .O(new_n358_));
  nand2  g200(.a(new_n285_), .b(x14), .O(new_n359_));
  inv1   g201(.a(new_n170_), .O(new_n360_));
  nand4  g202(.a(new_n360_), .b(new_n154_), .c(x04), .d(new_n153_), .O(new_n361_));
  aoi21  g203(.a(new_n359_), .b(new_n358_), .c(new_n361_), .O(z54));
  nand2  g204(.a(new_n245_), .b(x76), .O(new_n364_));
  xnor2a g205(.a(x84), .b(x81), .O(new_n365_));
  aoi21  g206(.a(new_n171_), .b(new_n170_), .c(new_n365_), .O(new_n366_));
  nand2  g207(.a(new_n366_), .b(new_n153_), .O(new_n367_));
  nand2  g208(.a(new_n367_), .b(new_n364_), .O(new_n368_));
  nand2  g209(.a(new_n368_), .b(x79), .O(new_n369_));
  nor2   g210(.a(x77), .b(x01), .O(new_n370_));
  aoi21  g211(.a(new_n370_), .b(new_n164_), .c(new_n242_), .O(new_n371_));
  nand2  g212(.a(new_n371_), .b(new_n369_), .O(z56));
  inv1   g213(.a(x02), .O(new_n373_));
  nand3  g214(.a(new_n243_), .b(x03), .c(new_n373_), .O(new_n374_));
  inv1   g215(.a(new_n374_), .O(z57));
  nand4  g216(.a(x80), .b(new_n235_), .c(x43), .d(new_n250_), .O(new_n376_));
  oai22  g217(.a(new_n376_), .b(new_n234_), .c(new_n250_), .d(x40), .O(new_n377_));
  nand3  g218(.a(new_n377_), .b(new_n232_), .c(x79), .O(new_n378_));
  nand3  g219(.a(new_n176_), .b(new_n250_), .c(x40), .O(new_n379_));
  nand2  g220(.a(new_n379_), .b(new_n378_), .O(new_n380_));
  nand2  g221(.a(new_n380_), .b(x77), .O(new_n381_));
  oai21  g222(.a(new_n360_), .b(new_n160_), .c(new_n154_), .O(new_n382_));
  aoi21  g223(.a(new_n382_), .b(new_n381_), .c(x01), .O(z58));
  aoi21  g224(.a(new_n163_), .b(new_n177_), .c(new_n152_), .O(new_n384_));
  oai21  g225(.a(new_n236_), .b(new_n234_), .c(new_n250_), .O(new_n385_));
  ...
  aoi21  g232(.a(new_n391_), .b(new_n239_), .c(x01), .O(z60));
  nand2  g233(.a(new_n171_), .b(new_n170_), .O(new_n393_));
  aoi22  g234(.a(new_n393_), .b(new_n229_), .c(new_n165_), .d(new_n160_), .O(new_n394_));
  nand2  g235(.a(new_n173_), .b(x80), .O(new_n395_));
  nor2   g236(.a(new_n395_), .b(new_n394_), .O(z61));
  ...
  nand2  g240(.a(new_n385_), .b(x79), .O(new_n400_));
  ...
  nand2  g247(.a(new_n406_), .b(new_n320_), .O(new_n407_));
  aoi21  g248(.a(new_n407_), .b(new_n405_), .c(x01), .O(z62));
  nand2  g249(.a(new_n173_), .b(x82), .O(new_n409_));
  nor2   g250(.a(new_n409_), .b(new_n394_), .O(z63));
  nand2  g251(.a(x83), .b(x79), .O(new_n411_));
  or2    g252(.a(new_n411_), .b(new_n394_), .O(new_n412_));
  ...
  nor2   g256(.a(new_n254_), .b(x78), .O(new_n416_));
  oai21  g257(.a(new_n416_), .b(new_n415_), .c(x77), .O(new_n417_));
  nand2  g258(.a(new_n360_), .b(x81), .O(new_n418_));
