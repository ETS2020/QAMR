// Benchmark "FAU" written by ABC on Fri Jul 10 18:22:13 2020
...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n169_, new_n170_, new_n172_, new_n173_, new_n177_, new_n178_,
    ...
    new_n243_, new_n244_, new_n246_, new_n251_, new_n253_, new_n255_,
    new_n258_, new_n259_, new_n260_, new_n261_, new_n262_, new_n263_,
    new_n264_, new_n265_, new_n266_, new_n267_, new_n268_, new_n269_,
    new_n271_, new_n273_, new_n276_, new_n284_, new_n288_, new_n289_,
  ...
  nand4  g090(.a(new_n243_), .b(new_n233_), .c(x48), .d(new_n236_), .O(new_n251_));
  inv1   g091(.a(new_n251_), .O(z30));
  nand4  g092(.a(new_n243_), .b(new_n233_), .c(x49), .d(new_n236_), .O(new_n253_));
  inv1   g093(.a(new_n253_), .O(z31));
  nand4  g094(.a(new_n243_), .b(new_n233_), .c(x50), .d(new_n236_), .O(new_n255_));
  inv1   g095(.a(new_n255_), .O(z32));
  inv1   g096(.a(x52), .O(new_n258_));
  inv1   g097(.a(new_n233_), .O(new_n259_));
  ...
  nor3   g108(.a(new_n269_), .b(new_n259_), .c(new_n258_), .O(z34));
  nand2  g109(.a(new_n233_), .b(x53), .O(new_n271_));
  nor2   g110(.a(new_n271_), .b(new_n269_), .O(z35));
  nand2  g111(.a(new_n233_), .b(x54), .O(new_n273_));
  nor2   g112(.a(new_n273_), .b(new_n269_), .O(z36));
  nand2  g113(.a(new_n233_), .b(x56), .O(new_n276_));
  nor2   g114(.a(new_n276_), .b(new_n269_), .O(z38));
  nor3   g115(.a(new_n269_), .b(new_n259_), .c(new_n186_), .O(z40));
  nor3   g116(.a(new_n269_), .b(new_n259_), .c(new_n183_), .O(z41));
  nor3   g117(.a(new_n269_), .b(new_n259_), .c(new_n177_), .O(z43));
  nand2  g118(.a(new_n233_), .b(x63), .O(new_n284_));
  nor2   g119(.a(new_n284_), .b(new_n269_), .O(z45));
  nor3   g120(.a(new_n269_), .b(new_n259_), .c(new_n172_), .O(z46));
  ...
  nand2  g138(.a(new_n298_), .b(x69), .O(new_n305_));
  aoi21  g139(.a(new_n305_), .b(new_n304_), .c(x01), .O(z49));
  inv1   g140(.a(x10), .O(new_n307_));
  nand2  g141(.a(x52), .b(x18), .O(new_n308_));
  oai21  g142(.a(x52), .b(new_n307_), .c(new_n308_), .O(new_n309_));
  nand2  g143(.a(new_n309_), .b(new_n293_), .O(new_n310_));
  nand2  g144(.a(new_n298_), .b(x70), .O(new_n311_));
  ...
  nand2  g159(.a(new_n258_), .b(x14), .O(new_n327_));
  inv1   g160(.a(new_n212_), .O(new_n328_));
  ...
  nand4  g164(.a(x84), .b(x83), .c(new_n331_), .d(new_n237_), .O(new_n332_));
  inv1   g165(.a(x80), .O(new_n333_));
  nand4  g166(.a(new_n233_), .b(new_n161_), .c(new_n333_), .d(x79), .O(new_n334_));
  nor2   g167(.a(new_n334_), .b(new_n332_), .O(z55));
  nand2  g168(.a(new_n160_), .b(new_n159_), .O(new_n336_));
  nand2  g169(.a(new_n231_), .b(x76), .O(new_n337_));
  xnor2a g170(.a(x84), .b(x81), .O(new_n338_));
  aoi21  g171(.a(new_n213_), .b(new_n212_), .c(new_n338_), .O(new_n339_));
  nand2  g172(.a(new_n339_), .b(new_n153_), .O(new_n340_));
  nand2  g173(.a(new_n340_), .b(new_n337_), .O(new_n341_));
  nand2  g174(.a(new_n341_), .b(x79), .O(new_n342_));
  nand4  g175(.a(new_n342_), .b(new_n336_), .c(new_n153_), .d(x00), .O(z56));
  nand4  g176(.a(x80), .b(new_n220_), .c(x43), .d(new_n236_), .O(new_n345_));
  oai22  g177(.a(new_n345_), .b(new_n219_), .c(new_n236_), .d(x40), .O(new_n346_));
  nand3  g178(.a(new_n346_), .b(new_n225_), .c(x79), .O(new_n347_));
  nor2   g179(.a(x79), .b(x78), .O(new_n348_));
  nand3  g180(.a(new_n348_), .b(new_n236_), .c(x40), .O(new_n349_));
  nand2  g181(.a(new_n349_), .b(new_n347_), .O(new_n350_));
  nand2  g182(.a(new_n350_), .b(x77), .O(new_n351_));
  oai21  g183(.a(new_n328_), .b(new_n228_), .c(new_n154_), .O(new_n352_));
  aoi21  g184(.a(new_n352_), .b(new_n351_), .c(x01), .O(z58));
  inv1   g185(.a(new_n348_), .O(new_n354_));
  aoi21  g186(.a(new_n224_), .b(new_n354_), .c(new_n152_), .O(new_n355_));
  oai21  g187(.a(new_n221_), .b(new_n219_), .c(new_n236_), .O(new_n356_));
  aoi21  g188(.a(new_n356_), .b(x79), .c(new_n224_), .O(new_n357_));
  ...
  aoi21  g193(.a(new_n339_), .b(x79), .c(new_n359_), .O(new_n362_));
  aoi21  g194(.a(new_n362_), .b(new_n226_), .c(x01), .O(z60));
  nand2  g195(.a(new_n213_), .b(new_n212_), .O(new_n364_));
  aoi22  g196(.a(new_n364_), .b(new_n215_), .c(new_n161_), .d(new_n228_), .O(new_n365_));
  nor2   g197(.a(new_n154_), .b(x01), .O(new_n366_));
  inv1   g198(.a(new_n366_), .O(new_n367_));
  nor3   g199(.a(new_n367_), .b(new_n365_), .c(new_n333_), .O(z61));
  nand3  g200(.a(x84), .b(x81), .c(x79), .O(new_n369_));
  oai21  g201(.a(x79), .b(new_n228_), .c(new_n369_), .O(new_n370_));
  nand2  g202(.a(new_n370_), .b(new_n159_), .O(new_n371_));
  nand2  g203(.a(new_n356_), .b(x79), .O(new_n372_));
  nand3  g204(.a(x81), .b(x79), .c(new_n228_), .O(new_n373_));
  inv1   g205(.a(new_n373_), .O(new_n374_));
  aoi21  g206(.a(new_n372_), .b(x04), .c(new_n374_), .O(new_n375_));
  oai21  g207(.a(new_n375_), .b(new_n159_), .c(new_n371_), .O(new_n376_));
  nand2  g208(.a(new_n376_), .b(x78), .O(new_n377_));
  inv1   g209(.a(new_n369_), .O(new_n378_));
  nand2  g210(.a(new_n378_), .b(new_n295_), .O(new_n379_));
  aoi21  g211(.a(new_n379_), .b(new_n377_), .c(x01), .O(z62));
  nor3   g212(.a(new_n367_), .b(new_n365_), .c(new_n331_), .O(z63));
  nand2  g213(.a(x83), .b(x79), .O(new_n382_));
  or2    g214(.a(new_n382_), .b(new_n365_), .O(new_n383_));
  aoi21  g215(.a(new_n383_), .b(new_n292_), .c(x01), .O(z64));
  nor2   g216(.a(new_n160_), .b(x04), .O(new_n385_));
  nor2   g217(.a(new_n237_), .b(x78), .O(new_n386_));
  oai21  g218(.a(new_n386_), .b(new_n385_), .c(x77), .O(new_n387_));
  nand2  g219(.a(new_n328_), .b(x81), .O(new_n388_));
  nand2  g220(.a(new_n366_), .b(x84), .O(new_n389_));
  aoi21  g221(.a(new_n388_), .b(new_n387_), .c(new_n389_), .O(z65));
  zero   g222(.O(z02));
  zero   g223(.O(z07));
  zero   g224(.O(z08));
  zero   g225(.O(z17));
