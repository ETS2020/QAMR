...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n270_, new_n273_, new_n276_, new_n279_, new_n281_, new_n288_,
  ...
  nor2   g099(.a(new_n218_), .b(new_n238_), .O(new_n261_));
  inv1   g100(.a(new_n261_), .O(new_n262_));
  nand2  g101(.a(new_n262_), .b(new_n239_), .O(new_n263_));
  nand2  g102(.a(new_n261_), .b(x81), .O(new_n264_));
  aoi21  g103(.a(new_n264_), .b(new_n263_), .c(new_n242_), .O(new_n265_));
  nand2  g104(.a(new_n262_), .b(x81), .O(new_n266_));
  nand2  g105(.a(new_n261_), .b(new_n239_), .O(new_n267_));
  aoi21  g106(.a(new_n267_), .b(new_n266_), .c(new_n240_), .O(new_n268_));
  oai21  g107(.a(new_n268_), .b(new_n265_), .c(new_n260_), .O(new_n269_));
  nand2  g108(.a(new_n235_), .b(x52), .O(new_n270_));
  nor2   g109(.a(new_n270_), .b(new_n269_), .O(z34));
  nand2  g110(.a(new_n235_), .b(x54), .O(new_n273_));
  nor2   g111(.a(new_n273_), .b(new_n269_), .O(z36));
  nand2  g112(.a(new_n235_), .b(x56), .O(new_n276_));
  nor2   g113(.a(new_n276_), .b(new_n269_), .O(z38));
  inv1   g114(.a(new_n235_), .O(new_n279_));
  nor3   g115(.a(new_n269_), .b(new_n279_), .c(new_n186_), .O(z40));
  nand2  g116(.a(new_n235_), .b(x59), .O(new_n281_));
  nor2   g117(.a(new_n281_), .b(new_n269_), .O(z41));
  nor3   g118(.a(new_n269_), .b(new_n279_), .c(new_n182_), .O(z42));
  nor3   g119(.a(new_n269_), .b(new_n279_), .c(new_n179_), .O(z43));
  nor3   g120(.a(new_n269_), .b(new_n279_), .c(new_n176_), .O(z44));
  nor3   g121(.a(new_n269_), .b(new_n279_), .c(new_n173_), .O(z45));
  ...
  inv1   g139(.a(new_n215_), .O(new_n305_));
  ...
  nand2  g146(.a(new_n312_), .b(new_n293_), .O(new_n313_));
  ...
  nand2  g152(.a(new_n319_), .b(new_n293_), .O(new_n320_));
  nand2  g153(.a(new_n306_), .b(x72), .O(new_n321_));
  ...
  nand2  g158(.a(new_n325_), .b(new_n293_), .O(new_n326_));
  nand2  g159(.a(new_n306_), .b(x73), .O(new_n327_));
  aoi21  g160(.a(new_n327_), .b(new_n326_), .c(x01), .O(z53));
  inv1   g161(.a(x82), .O(new_n330_));
  nand4  g162(.a(x84), .b(x83), .c(new_n330_), .d(new_n239_), .O(new_n331_));
  inv1   g163(.a(x80), .O(new_n332_));
  nand4  g164(.a(new_n235_), .b(new_n161_), .c(new_n332_), .d(x79), .O(new_n333_));
  nor2   g165(.a(new_n333_), .b(new_n331_), .O(z55));
  nand2  g166(.a(new_n233_), .b(x76), .O(new_n335_));
  xnor2a g167(.a(x84), .b(x81), .O(new_n336_));
  aoi21  g168(.a(new_n213_), .b(new_n212_), .c(new_n336_), .O(new_n337_));
  nand2  g169(.a(new_n337_), .b(new_n153_), .O(new_n338_));
  nand2  g170(.a(new_n338_), .b(new_n335_), .O(new_n339_));
  nand2  g171(.a(new_n339_), .b(x79), .O(new_n340_));
  nand3  g172(.a(new_n160_), .b(new_n159_), .c(new_n153_), .O(new_n341_));
  nand3  g173(.a(new_n341_), .b(new_n340_), .c(new_n231_), .O(z56));
  inv1   g174(.a(x02), .O(new_n343_));
  nand3  g175(.a(new_n231_), .b(x03), .c(new_n343_), .O(new_n344_));
  inv1   g176(.a(new_n344_), .O(z57));
  nand4  g177(.a(x80), .b(new_n220_), .c(x43), .d(new_n238_), .O(new_n346_));
  oai22  g178(.a(new_n346_), .b(new_n219_), .c(new_n238_), .d(x40), .O(new_n347_));
  nand3  g179(.a(new_n347_), .b(new_n225_), .c(x79), .O(new_n348_));
  nor2   g180(.a(x79), .b(x78), .O(new_n349_));
  nand3  g181(.a(new_n349_), .b(new_n238_), .c(x40), .O(new_n350_));
  nand2  g182(.a(new_n350_), .b(new_n348_), .O(new_n351_));
  nand2  g183(.a(new_n351_), .b(x77), .O(new_n352_));
  inv1   g184(.a(new_n212_), .O(new_n353_));
  oai21  g185(.a(new_n353_), .b(new_n228_), .c(new_n154_), .O(new_n354_));
  aoi21  g186(.a(new_n354_), .b(new_n352_), .c(x01), .O(z58));
  inv1   g187(.a(new_n349_), .O(new_n356_));
  aoi21  g188(.a(new_n224_), .b(new_n356_), .c(new_n152_), .O(new_n357_));
  oai21  g189(.a(new_n221_), .b(new_n219_), .c(new_n238_), .O(new_n358_));
  aoi21  g190(.a(new_n358_), .b(x79), .c(new_n224_), .O(new_n359_));
  ...
  aoi21  g195(.a(new_n337_), .b(x79), .c(new_n361_), .O(new_n364_));
  aoi21  g196(.a(new_n364_), .b(new_n226_), .c(x01), .O(z60));
  nand2  g197(.a(new_n213_), .b(new_n212_), .O(new_n366_));
  aoi22  g198(.a(new_n366_), .b(new_n215_), .c(new_n161_), .d(new_n228_), .O(new_n367_));
  nor2   g199(.a(new_n154_), .b(x01), .O(new_n368_));
  inv1   g200(.a(new_n368_), .O(new_n369_));
  nor3   g201(.a(new_n369_), .b(new_n367_), .c(new_n332_), .O(z61));
  nand3  g202(.a(x84), .b(x81), .c(x79), .O(new_n371_));
  oai21  g203(.a(x79), .b(new_n228_), .c(new_n371_), .O(new_n372_));
  nand2  g204(.a(new_n372_), .b(new_n159_), .O(new_n373_));
  nand2  g205(.a(new_n358_), .b(x79), .O(new_n374_));
  nand3  g206(.a(x81), .b(x79), .c(new_n228_), .O(new_n375_));
  inv1   g207(.a(new_n375_), .O(new_n376_));
  aoi21  g208(.a(new_n374_), .b(x04), .c(new_n376_), .O(new_n377_));
  oai21  g209(.a(new_n377_), .b(new_n159_), .c(new_n373_), .O(new_n378_));
  nand2  g210(.a(new_n378_), .b(x78), .O(new_n379_));
  inv1   g211(.a(new_n371_), .O(new_n380_));
  nand2  g212(.a(new_n380_), .b(new_n296_), .O(new_n381_));
  aoi21  g213(.a(new_n381_), .b(new_n379_), .c(x01), .O(z62));
  nor3   g214(.a(new_n369_), .b(new_n367_), .c(new_n330_), .O(z63));
  nand2  g215(.a(x83), .b(x79), .O(new_n384_));
  or2    g216(.a(new_n384_), .b(new_n367_), .O(new_n385_));
  aoi21  g217(.a(new_n385_), .b(new_n292_), .c(x01), .O(z64));
  nor2   g218(.a(new_n160_), .b(x04), .O(new_n387_));
  nor2   g219(.a(new_n239_), .b(x78), .O(new_n388_));
  oai21  g220(.a(new_n388_), .b(new_n387_), .c(x77), .O(new_n389_));
  nand2  g221(.a(new_n353_), .b(x81), .O(new_n390_));
  nand2  g222(.a(new_n368_), .b(x84), .O(new_n391_));
