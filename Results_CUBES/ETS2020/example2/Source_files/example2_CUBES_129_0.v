// Benchmark "FAU" written by ABC on Fri Jul 10 18:18:51 2020
...
module FAU ( 
  ...
  nand4  g090(.a(new_n243_), .b(new_n233_), .c(x47), .d(new_n236_), .O(new_n250_));
  ...
  nor3   g129(.a(new_n281_), .b(new_n272_), .c(new_n191_), .O(z39));
  nor3   g130(.a(new_n281_), .b(new_n272_), .c(new_n188_), .O(z40));
  nor3   g131(.a(new_n281_), .b(new_n272_), .c(new_n185_), .O(z41));
  nor3   g132(.a(new_n281_), .b(new_n272_), .c(new_n179_), .O(z43));
  nor3   g133(.a(new_n281_), .b(new_n272_), .c(new_n173_), .O(z45));
  ...
  nor2   g138(.a(x79), .b(x77), .O(new_n301_));
  nand2  g139(.a(new_n301_), .b(new_n225_), .O(new_n302_));
  inv1   g140(.a(new_n302_), .O(new_n303_));
  nand2  g141(.a(new_n303_), .b(new_n300_), .O(new_n304_));
  ...
  nand2  g177(.a(new_n340_), .b(new_n303_), .O(new_n341_));
  nand2  g178(.a(new_n316_), .b(x73), .O(new_n342_));
  aoi21  g179(.a(new_n342_), .b(new_n341_), .c(x01), .O(z53));
  nand2  g180(.a(x52), .b(x22), .O(new_n344_));
  nand2  g181(.a(new_n271_), .b(x14), .O(new_n345_));
  inv1   g182(.a(new_n212_), .O(new_n346_));
  nand4  g183(.a(new_n346_), .b(new_n154_), .c(x04), .d(new_n153_), .O(new_n347_));
  aoi21  g184(.a(new_n345_), .b(new_n344_), .c(new_n347_), .O(z54));
  inv1   g185(.a(x82), .O(new_n349_));
  nand3  g186(.a(new_n258_), .b(x84), .c(new_n349_), .O(new_n350_));
  inv1   g187(.a(x80), .O(new_n351_));
  nand4  g188(.a(new_n233_), .b(new_n161_), .c(new_n351_), .d(x79), .O(new_n352_));
  nor2   g189(.a(new_n352_), .b(new_n350_), .O(z55));
  nand2  g190(.a(new_n160_), .b(new_n159_), .O(new_n354_));
  nand2  g191(.a(new_n231_), .b(x76), .O(new_n355_));
  xnor2a g192(.a(x84), .b(x81), .O(new_n356_));
  aoi21  g193(.a(new_n213_), .b(new_n212_), .c(new_n356_), .O(new_n357_));
  nand2  g194(.a(new_n357_), .b(new_n153_), .O(new_n358_));
  nand2  g195(.a(new_n358_), .b(new_n355_), .O(new_n359_));
  nand2  g196(.a(new_n359_), .b(x79), .O(new_n360_));
  nand4  g197(.a(new_n360_), .b(new_n354_), .c(new_n153_), .d(x00), .O(z56));
  nand4  g198(.a(x80), .b(new_n220_), .c(x43), .d(new_n236_), .O(new_n363_));
  oai22  g199(.a(new_n363_), .b(new_n219_), .c(new_n236_), .d(x40), .O(new_n364_));
  nand3  g200(.a(new_n364_), .b(new_n225_), .c(x79), .O(new_n365_));
  nor2   g201(.a(x79), .b(x78), .O(new_n366_));
  nand3  g202(.a(new_n366_), .b(new_n236_), .c(x40), .O(new_n367_));
  nand2  g203(.a(new_n367_), .b(new_n365_), .O(new_n368_));
  nand2  g204(.a(new_n368_), .b(x77), .O(new_n369_));
  oai21  g205(.a(new_n346_), .b(new_n228_), .c(new_n154_), .O(new_n370_));
  ...
  oai21  g209(.a(new_n221_), .b(new_n219_), .c(new_n236_), .O(new_n374_));
  ...
  aoi21  g215(.a(new_n357_), .b(x79), .c(new_n377_), .O(new_n380_));
  ...
  nor3   g221(.a(new_n385_), .b(new_n383_), .c(new_n351_), .O(z61));
  ...
  nand2  g232(.a(new_n396_), .b(new_n306_), .O(new_n397_));
  aoi21  g233(.a(new_n397_), .b(new_n395_), .c(x01), .O(z62));
  nor3   g234(.a(new_n385_), .b(new_n383_), .c(new_n349_), .O(z63));
  nand2  g235(.a(x83), .b(x79), .O(new_n400_));
  or2    g236(.a(new_n400_), .b(new_n383_), .O(new_n401_));
  aoi21  g237(.a(new_n401_), .b(new_n302_), .c(x01), .O(z64));
  nor2   g238(.a(new_n160_), .b(x04), .O(new_n403_));
  nor2   g239(.a(new_n240_), .b(x78), .O(new_n404_));
  oai21  g240(.a(new_n404_), .b(new_n403_), .c(x77), .O(new_n405_));
  nand2  g241(.a(new_n346_), .b(x81), .O(new_n406_));
