...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n196_, new_n197_, new_n202_, new_n203_, new_n205_, new_n206_,
    new_n209_, new_n210_, new_n212_, new_n213_, new_n214_, new_n215_,
    new_n216_, new_n217_, new_n218_, new_n219_, new_n220_, new_n221_,
    new_n222_, new_n223_, new_n225_, new_n226_, new_n228_, new_n229_,
    new_n230_, new_n231_, new_n234_, new_n235_, new_n236_, new_n237_,
    new_n238_, new_n239_, new_n240_, new_n241_, new_n242_, new_n244_,
    new_n247_, new_n250_, new_n252_, new_n256_, new_n257_, new_n258_,
    new_n259_, new_n260_, new_n261_, new_n262_, new_n263_, new_n264_,
    new_n265_, new_n266_, new_n268_, new_n270_, new_n272_, new_n274_,
    new_n276_, new_n283_, new_n285_, new_n286_, new_n287_, new_n288_,
  ...
  nor2   g093(.a(new_n215_), .b(new_n234_), .O(new_n257_));
  inv1   g094(.a(new_n257_), .O(new_n258_));
  nand2  g095(.a(new_n258_), .b(new_n235_), .O(new_n259_));
  nand2  g096(.a(new_n257_), .b(x81), .O(new_n260_));
  aoi21  g097(.a(new_n260_), .b(new_n259_), .c(new_n238_), .O(new_n261_));
  nand2  g098(.a(new_n258_), .b(x81), .O(new_n262_));
  nand2  g099(.a(new_n257_), .b(new_n235_), .O(new_n263_));
  aoi21  g100(.a(new_n263_), .b(new_n262_), .c(new_n236_), .O(new_n264_));
  oai21  g101(.a(new_n264_), .b(new_n261_), .c(new_n256_), .O(new_n265_));
  nand2  g102(.a(new_n230_), .b(x53), .O(new_n266_));
  nor2   g103(.a(new_n266_), .b(new_n265_), .O(z35));
  nand2  g104(.a(new_n230_), .b(x54), .O(new_n268_));
  nor2   g105(.a(new_n268_), .b(new_n265_), .O(z36));
  nand2  g106(.a(new_n230_), .b(x55), .O(new_n270_));
  nor2   g107(.a(new_n270_), .b(new_n265_), .O(z37));
  nand2  g108(.a(new_n230_), .b(x56), .O(new_n272_));
  nor2   g109(.a(new_n272_), .b(new_n265_), .O(z38));
  nand2  g110(.a(new_n230_), .b(x57), .O(new_n274_));
  nor2   g111(.a(new_n274_), .b(new_n265_), .O(z39));
  inv1   g112(.a(new_n230_), .O(new_n276_));
  nor3   g113(.a(new_n265_), .b(new_n276_), .c(new_n192_), .O(z40));
  nor3   g114(.a(new_n265_), .b(new_n276_), .c(new_n189_), .O(z41));
  nor3   g115(.a(new_n265_), .b(new_n276_), .c(new_n183_), .O(z43));
  nor3   g116(.a(new_n265_), .b(new_n276_), .c(new_n177_), .O(z45));
  nand2  g117(.a(new_n230_), .b(x64), .O(new_n283_));
  nor2   g118(.a(new_n283_), .b(new_n265_), .O(z46));
  ...
  nand2  g123(.a(new_n288_), .b(new_n222_), .O(new_n289_));
  ...
  nand2  g130(.a(new_n295_), .b(new_n212_), .O(new_n296_));
  ...
  nand2  g135(.a(new_n301_), .b(new_n290_), .O(new_n302_));
  inv1   g136(.a(new_n212_), .O(new_n303_));
  nor2   g137(.a(new_n294_), .b(new_n303_), .O(new_n304_));
  nand2  g138(.a(new_n304_), .b(x69), .O(new_n305_));
  aoi21  g139(.a(new_n305_), .b(new_n302_), .c(x01), .O(z49));
  inv1   g140(.a(x11), .O(new_n308_));
  nand2  g141(.a(x52), .b(x19), .O(new_n309_));
  oai21  g142(.a(x52), .b(new_n308_), .c(new_n309_), .O(new_n310_));
  nand2  g143(.a(new_n310_), .b(new_n290_), .O(new_n311_));
  nand2  g144(.a(new_n304_), .b(x71), .O(new_n312_));
  ...
  nand2  g149(.a(new_n316_), .b(new_n290_), .O(new_n317_));
  nand2  g150(.a(new_n304_), .b(x72), .O(new_n318_));
  ...
  nand2  g155(.a(new_n322_), .b(new_n290_), .O(new_n323_));
  nand2  g156(.a(new_n304_), .b(x73), .O(new_n324_));
  aoi21  g157(.a(new_n324_), .b(new_n323_), .c(x01), .O(z53));
  inv1   g158(.a(x82), .O(new_n327_));
  nand4  g159(.a(x84), .b(x83), .c(new_n327_), .d(new_n235_), .O(new_n328_));
  inv1   g160(.a(x80), .O(new_n329_));
  nand4  g161(.a(new_n230_), .b(new_n161_), .c(new_n329_), .d(x79), .O(new_n330_));
  nor2   g162(.a(new_n330_), .b(new_n328_), .O(z55));
  nand2  g163(.a(new_n160_), .b(new_n159_), .O(new_n332_));
  nand2  g164(.a(new_n228_), .b(x76), .O(new_n333_));
  xnor2a g165(.a(x84), .b(x81), .O(new_n334_));
  aoi21  g166(.a(new_n168_), .b(new_n167_), .c(new_n334_), .O(new_n335_));
  ...
  nand4  g170(.a(new_n338_), .b(new_n332_), .c(new_n153_), .d(x00), .O(z56));
  nand4  g171(.a(x80), .b(new_n217_), .c(x43), .d(new_n234_), .O(new_n341_));
  oai22  g172(.a(new_n341_), .b(new_n216_), .c(new_n234_), .d(x40), .O(new_n342_));
  nand3  g173(.a(new_n342_), .b(new_n222_), .c(x79), .O(new_n343_));
  nor2   g174(.a(x79), .b(x78), .O(new_n344_));
  nand3  g175(.a(new_n344_), .b(new_n234_), .c(x40), .O(new_n345_));
  nand2  g176(.a(new_n345_), .b(new_n343_), .O(new_n346_));
  nand2  g177(.a(new_n346_), .b(x77), .O(new_n347_));
  inv1   g178(.a(new_n167_), .O(new_n348_));
  oai21  g179(.a(new_n348_), .b(new_n225_), .c(new_n154_), .O(new_n349_));
  aoi21  g180(.a(new_n349_), .b(new_n347_), .c(x01), .O(z58));
  inv1   g181(.a(new_n344_), .O(new_n351_));
  aoi21  g182(.a(new_n221_), .b(new_n351_), .c(new_n152_), .O(new_n352_));
  oai21  g183(.a(new_n218_), .b(new_n216_), .c(new_n234_), .O(new_n353_));
  aoi21  g184(.a(new_n353_), .b(x79), .c(new_n221_), .O(new_n354_));
  ...
  aoi21  g189(.a(new_n335_), .b(x79), .c(new_n356_), .O(new_n359_));
  aoi21  g190(.a(new_n359_), .b(new_n223_), .c(x01), .O(z60));
  inv1   g191(.a(new_n170_), .O(new_n361_));
  nand2  g192(.a(new_n168_), .b(new_n167_), .O(new_n362_));
  aoi22  g193(.a(new_n362_), .b(new_n212_), .c(new_n161_), .d(new_n225_), .O(new_n363_));
  nor3   g194(.a(new_n363_), .b(new_n361_), .c(new_n329_), .O(z61));
  nand3  g195(.a(x84), .b(x81), .c(x79), .O(new_n365_));
  oai21  g196(.a(x79), .b(new_n225_), .c(new_n365_), .O(new_n366_));
  nand2  g197(.a(new_n366_), .b(new_n159_), .O(new_n367_));
  nand2  g198(.a(new_n353_), .b(x79), .O(new_n368_));
  nand3  g199(.a(x81), .b(x79), .c(new_n225_), .O(new_n369_));
  ...
  inv1   g204(.a(new_n365_), .O(new_n374_));
  nand2  g205(.a(new_n374_), .b(new_n293_), .O(new_n375_));
  aoi21  g206(.a(new_n375_), .b(new_n373_), .c(x01), .O(z62));
  nor3   g207(.a(new_n363_), .b(new_n361_), .c(new_n327_), .O(z63));
  nand2  g208(.a(x83), .b(x79), .O(new_n378_));
  or2    g209(.a(new_n378_), .b(new_n363_), .O(new_n379_));
  aoi21  g210(.a(new_n379_), .b(new_n289_), .c(x01), .O(z64));
  nor2   g211(.a(new_n160_), .b(x04), .O(new_n381_));
  nor2   g212(.a(new_n235_), .b(x78), .O(new_n382_));
  oai21  g213(.a(new_n382_), .b(new_n381_), .c(x77), .O(new_n383_));
  nand2  g214(.a(new_n348_), .b(x81), .O(new_n384_));
  nand2  g215(.a(new_n170_), .b(x84), .O(new_n385_));
