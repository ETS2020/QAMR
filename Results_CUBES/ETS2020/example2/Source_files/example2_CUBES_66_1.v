...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n245_, new_n247_, new_n250_, new_n253_, new_n256_, new_n257_,
    new_n258_, new_n259_, new_n260_, new_n261_, new_n262_, new_n263_,
    new_n264_, new_n265_, new_n266_, new_n269_, new_n271_, new_n273_,
    new_n276_, new_n280_, new_n286_, new_n287_, new_n288_, new_n289_,
  ...
  nand4  g087(.a(new_n244_), .b(new_n232_), .c(x46), .d(new_n237_), .O(new_n247_));
  inv1   g088(.a(new_n247_), .O(z28));
  nand4  g089(.a(new_n244_), .b(new_n232_), .c(x48), .d(new_n237_), .O(new_n250_));
  inv1   g090(.a(new_n250_), .O(z30));
  nand4  g091(.a(new_n244_), .b(new_n232_), .c(x50), .d(new_n237_), .O(new_n253_));
  inv1   g092(.a(new_n253_), .O(z32));
  inv1   g093(.a(new_n162_), .O(new_n256_));
  nor2   g094(.a(new_n217_), .b(new_n237_), .O(new_n257_));
  inv1   g095(.a(new_n257_), .O(new_n258_));
  nand2  g096(.a(new_n258_), .b(new_n238_), .O(new_n259_));
  nand2  g097(.a(new_n257_), .b(x81), .O(new_n260_));
  aoi21  g098(.a(new_n260_), .b(new_n259_), .c(new_n241_), .O(new_n261_));
  nand2  g099(.a(new_n258_), .b(x81), .O(new_n262_));
  nand2  g100(.a(new_n257_), .b(new_n238_), .O(new_n263_));
  aoi21  g101(.a(new_n263_), .b(new_n262_), .c(new_n239_), .O(new_n264_));
  oai21  g102(.a(new_n264_), .b(new_n261_), .c(new_n256_), .O(new_n265_));
  nand2  g103(.a(new_n232_), .b(x52), .O(new_n266_));
  ...
  nor3   g112(.a(new_n265_), .b(new_n276_), .c(new_n188_), .O(z40));
  nor3   g113(.a(new_n265_), .b(new_n276_), .c(new_n185_), .O(z41));
  nand2  g114(.a(new_n232_), .b(x61), .O(new_n280_));
  nor2   g115(.a(new_n280_), .b(new_n265_), .O(z43));
  nor3   g116(.a(new_n265_), .b(new_n276_), .c(new_n177_), .O(z45));
  inv1   g117(.a(x08), .O(new_n286_));
  nand2  g118(.a(x52), .b(x16), .O(new_n287_));
  oai21  g119(.a(x52), .b(new_n286_), .c(new_n287_), .O(new_n288_));
  nor2   g120(.a(x79), .b(x77), .O(new_n289_));
  nand2  g121(.a(new_n289_), .b(new_n224_), .O(new_n290_));
  inv1   g122(.a(new_n290_), .O(new_n291_));
  nand2  g123(.a(new_n291_), .b(new_n288_), .O(new_n292_));
  inv1   g124(.a(new_n168_), .O(new_n293_));
  nand2  g125(.a(new_n293_), .b(x79), .O(new_n294_));
  inv1   g126(.a(new_n294_), .O(new_n295_));
  and2   g127(.a(new_n295_), .b(new_n214_), .O(new_n296_));
  nand2  g128(.a(new_n296_), .b(x68), .O(new_n297_));
  aoi21  g129(.a(new_n297_), .b(new_n292_), .c(x01), .O(z48));
  inv1   g130(.a(x09), .O(new_n299_));
  nand2  g131(.a(x52), .b(x17), .O(new_n300_));
  oai21  g132(.a(x52), .b(new_n299_), .c(new_n300_), .O(new_n301_));
  nand2  g133(.a(new_n301_), .b(new_n291_), .O(new_n302_));
  ...
  nand2  g139(.a(new_n307_), .b(new_n291_), .O(new_n308_));
  ...
  nand2  g145(.a(new_n313_), .b(new_n291_), .O(new_n314_));
  ...
  nand2  g151(.a(new_n320_), .b(new_n291_), .O(new_n321_));
  nand2  g152(.a(new_n296_), .b(x73), .O(new_n322_));
  aoi21  g153(.a(new_n322_), .b(new_n321_), .c(x01), .O(z53));
  nand2  g154(.a(x84), .b(x83), .O(new_n325_));
  nor2   g155(.a(x80), .b(new_n154_), .O(new_n326_));
  nand3  g156(.a(new_n326_), .b(new_n232_), .c(new_n161_), .O(new_n327_));
  nor4   g157(.a(new_n327_), .b(new_n325_), .c(x82), .d(x81), .O(z55));
  nand2  g158(.a(new_n160_), .b(new_n159_), .O(new_n329_));
  nand2  g159(.a(new_n230_), .b(x76), .O(new_n330_));
  xnor2a g160(.a(x84), .b(x81), .O(new_n331_));
  aoi21  g161(.a(new_n168_), .b(new_n167_), .c(new_n331_), .O(new_n332_));
  ...
  nand4  g165(.a(new_n335_), .b(new_n329_), .c(new_n153_), .d(x00), .O(z56));
  nand4  g166(.a(x80), .b(new_n219_), .c(x43), .d(new_n237_), .O(new_n338_));
  oai22  g167(.a(new_n338_), .b(new_n218_), .c(new_n237_), .d(x40), .O(new_n339_));
  nand3  g168(.a(new_n339_), .b(new_n224_), .c(x79), .O(new_n340_));
  nor2   g169(.a(x79), .b(x78), .O(new_n341_));
  nand3  g170(.a(new_n341_), .b(new_n237_), .c(x40), .O(new_n342_));
  nand2  g171(.a(new_n342_), .b(new_n340_), .O(new_n343_));
  nand2  g172(.a(new_n343_), .b(x77), .O(new_n344_));
  inv1   g173(.a(new_n167_), .O(new_n345_));
  oai21  g174(.a(new_n345_), .b(new_n227_), .c(new_n154_), .O(new_n346_));
  aoi21  g175(.a(new_n346_), .b(new_n344_), .c(x01), .O(z58));
  inv1   g176(.a(new_n341_), .O(new_n348_));
  aoi21  g177(.a(new_n223_), .b(new_n348_), .c(new_n152_), .O(new_n349_));
  oai21  g178(.a(new_n220_), .b(new_n218_), .c(new_n237_), .O(new_n350_));
  aoi21  g179(.a(new_n350_), .b(x79), .c(new_n223_), .O(new_n351_));
  ...
  aoi21  g184(.a(new_n332_), .b(x79), .c(new_n353_), .O(new_n356_));
  aoi21  g185(.a(new_n356_), .b(new_n225_), .c(x01), .O(z60));
  nand3  g186(.a(x84), .b(x81), .c(x79), .O(new_n359_));
  oai21  g187(.a(x79), .b(new_n227_), .c(new_n359_), .O(new_n360_));
  nand2  g188(.a(new_n360_), .b(new_n159_), .O(new_n361_));
  nand2  g189(.a(new_n350_), .b(x79), .O(new_n362_));
  nand3  g190(.a(x81), .b(x79), .c(new_n227_), .O(new_n363_));
  inv1   g191(.a(new_n363_), .O(new_n364_));
  aoi21  g192(.a(new_n362_), .b(x04), .c(new_n364_), .O(new_n365_));
  oai21  g193(.a(new_n365_), .b(new_n159_), .c(new_n361_), .O(new_n366_));
  nand2  g194(.a(new_n366_), .b(x78), .O(new_n367_));
  inv1   g195(.a(new_n359_), .O(new_n368_));
  nand2  g196(.a(new_n368_), .b(new_n293_), .O(new_n369_));
  aoi21  g197(.a(new_n369_), .b(new_n367_), .c(x01), .O(z62));
  oai21  g198(.a(new_n293_), .b(new_n345_), .c(new_n214_), .O(new_n371_));
  oai21  g199(.a(new_n230_), .b(x04), .c(new_n371_), .O(new_n372_));
  nand2  g200(.a(new_n170_), .b(x82), .O(new_n373_));
  inv1   g201(.a(new_n373_), .O(new_n374_));
  and2   g202(.a(new_n374_), .b(new_n372_), .O(z63));
  nand3  g203(.a(new_n372_), .b(x83), .c(x79), .O(new_n376_));
  aoi21  g204(.a(new_n376_), .b(new_n290_), .c(x01), .O(z64));
  nor2   g205(.a(new_n160_), .b(x04), .O(new_n378_));
  nor2   g206(.a(new_n238_), .b(x78), .O(new_n379_));
