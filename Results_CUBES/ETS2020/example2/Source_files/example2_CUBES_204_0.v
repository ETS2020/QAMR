...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n282_, new_n284_, new_n286_, new_n288_, new_n296_, new_n301_,
  ...
  nand2  g134(.a(new_n235_), .b(x62), .O(new_n296_));
  nor2   g135(.a(new_n296_), .b(new_n282_), .O(z44));
  ...
  nand2  g180(.a(new_n272_), .b(x14), .O(new_n345_));
  inv1   g181(.a(new_n214_), .O(new_n346_));
  ...
  nand3  g185(.a(new_n259_), .b(x84), .c(new_n349_), .O(new_n350_));
  ...
  nand2  g189(.a(new_n160_), .b(new_n159_), .O(new_n354_));
  nand2  g190(.a(new_n233_), .b(x76), .O(new_n355_));
  xnor2a g191(.a(x84), .b(x81), .O(new_n356_));
  aoi21  g192(.a(new_n215_), .b(new_n214_), .c(new_n356_), .O(new_n357_));
  ...
  nand4  g196(.a(new_n360_), .b(new_n354_), .c(new_n153_), .d(x00), .O(z56));
  nand4  g197(.a(x80), .b(new_n222_), .c(x43), .d(new_n238_), .O(new_n363_));
  oai22  g198(.a(new_n363_), .b(new_n221_), .c(new_n238_), .d(x40), .O(new_n364_));
  nand3  g199(.a(new_n364_), .b(new_n227_), .c(x79), .O(new_n365_));
  nor2   g200(.a(x79), .b(x78), .O(new_n366_));
  nand3  g201(.a(new_n366_), .b(new_n238_), .c(x40), .O(new_n367_));
  nand2  g202(.a(new_n367_), .b(new_n365_), .O(new_n368_));
  nand2  g203(.a(new_n368_), .b(x77), .O(new_n369_));
  oai21  g204(.a(new_n346_), .b(new_n230_), .c(new_n154_), .O(new_n370_));
  ...
  oai21  g208(.a(new_n223_), .b(new_n221_), .c(new_n238_), .O(new_n374_));
  ...
  aoi21  g214(.a(new_n357_), .b(x79), .c(new_n377_), .O(new_n380_));
  aoi21  g215(.a(new_n380_), .b(new_n228_), .c(x01), .O(z60));
  nand2  g216(.a(new_n215_), .b(new_n214_), .O(new_n382_));
  aoi22  g217(.a(new_n382_), .b(new_n217_), .c(new_n161_), .d(new_n230_), .O(new_n383_));
  nor2   g218(.a(new_n154_), .b(x01), .O(new_n384_));
  inv1   g219(.a(new_n384_), .O(new_n385_));
  nor3   g220(.a(new_n385_), .b(new_n383_), .c(new_n351_), .O(z61));
  ...
  nand2  g231(.a(new_n396_), .b(new_n308_), .O(new_n397_));
  aoi21  g232(.a(new_n397_), .b(new_n395_), .c(x01), .O(z62));
  nor3   g233(.a(new_n385_), .b(new_n383_), .c(new_n349_), .O(z63));
  ...
  nor2   g238(.a(new_n242_), .b(x78), .O(new_n404_));
  oai21  g239(.a(new_n404_), .b(new_n403_), .c(x77), .O(new_n405_));
  nand2  g240(.a(new_n346_), .b(x81), .O(new_n406_));
