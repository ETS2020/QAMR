...
module FAU ( 
  ...
  nand2  g135(.a(new_n244_), .b(x57), .O(new_n293_));
  nor2   g136(.a(new_n293_), .b(new_n283_), .O(z39));
  nor3   g137(.a(new_n283_), .b(new_n273_), .c(new_n196_), .O(z42));
  nor3   g138(.a(new_n283_), .b(new_n273_), .c(new_n193_), .O(z43));
  nor3   g139(.a(new_n283_), .b(new_n273_), .c(new_n190_), .O(z44));
  nor3   g140(.a(new_n283_), .b(new_n273_), .c(new_n187_), .O(z45));
  nor3   g141(.a(new_n283_), .b(new_n273_), .c(new_n184_), .O(z46));
  inv1   g142(.a(x07), .O(new_n302_));
  nand2  g143(.a(x52), .b(x15), .O(new_n303_));
  oai21  g144(.a(x52), .b(new_n302_), .c(new_n303_), .O(new_n304_));
  nand3  g145(.a(new_n229_), .b(new_n154_), .c(new_n159_), .O(new_n305_));
  inv1   g146(.a(new_n305_), .O(new_n306_));
  nand2  g147(.a(new_n306_), .b(new_n304_), .O(new_n307_));
  nor2   g148(.a(x75), .b(x67), .O(new_n308_));
  nand2  g149(.a(new_n171_), .b(x79), .O(new_n309_));
  nor2   g150(.a(new_n309_), .b(new_n308_), .O(new_n310_));
  nand2  g151(.a(new_n310_), .b(new_n226_), .O(new_n311_));
  aoi21  g152(.a(new_n311_), .b(new_n307_), .c(x01), .O(z47));
  inv1   g153(.a(x09), .O(new_n314_));
  nand2  g154(.a(x52), .b(x17), .O(new_n315_));
  oai21  g155(.a(x52), .b(new_n314_), .c(new_n315_), .O(new_n316_));
  nand2  g156(.a(new_n316_), .b(new_n306_), .O(new_n317_));
  inv1   g157(.a(new_n226_), .O(new_n318_));
  nor2   g158(.a(new_n309_), .b(new_n318_), .O(new_n319_));
  nand2  g159(.a(new_n319_), .b(x69), .O(new_n320_));
  aoi21  g160(.a(new_n320_), .b(new_n317_), .c(x01), .O(z49));
  inv1   g161(.a(x12), .O(new_n324_));
  nand2  g162(.a(x52), .b(x20), .O(new_n325_));
  oai21  g163(.a(x52), .b(new_n324_), .c(new_n325_), .O(new_n326_));
  nand2  g164(.a(new_n326_), .b(new_n306_), .O(new_n327_));
  nand2  g165(.a(new_n319_), .b(x72), .O(new_n328_));
  aoi21  g166(.a(new_n328_), .b(new_n327_), .c(x01), .O(z52));
  inv1   g167(.a(x13), .O(new_n330_));
  nand2  g168(.a(x52), .b(x21), .O(new_n331_));
  oai21  g169(.a(x52), .b(new_n330_), .c(new_n331_), .O(new_n332_));
  nand2  g170(.a(new_n332_), .b(new_n306_), .O(new_n333_));
  nand2  g171(.a(new_n319_), .b(x73), .O(new_n334_));
  aoi21  g172(.a(new_n334_), .b(new_n333_), .c(x01), .O(z53));
  nand2  g173(.a(x52), .b(x22), .O(new_n336_));
  nand2  g174(.a(new_n272_), .b(x14), .O(new_n337_));
  nand4  g175(.a(new_n169_), .b(new_n154_), .c(x04), .d(new_n153_), .O(new_n338_));
  aoi21  g176(.a(new_n337_), .b(new_n336_), .c(new_n338_), .O(z54));
  nand2  g177(.a(new_n242_), .b(x76), .O(new_n341_));
  inv1   g178(.a(new_n171_), .O(new_n342_));
  xnor2a g179(.a(x84), .b(x81), .O(new_n343_));
  aoi21  g180(.a(new_n342_), .b(new_n170_), .c(new_n343_), .O(new_n344_));
  nand2  g181(.a(new_n344_), .b(new_n153_), .O(new_n345_));
  nand2  g182(.a(new_n345_), .b(new_n341_), .O(new_n346_));
  nand2  g183(.a(new_n346_), .b(x79), .O(new_n347_));
  nor2   g184(.a(x77), .b(x01), .O(new_n348_));
  aoi21  g185(.a(new_n348_), .b(new_n164_), .c(new_n239_), .O(new_n349_));
  nand2  g186(.a(new_n349_), .b(new_n347_), .O(z56));
  inv1   g187(.a(x02), .O(new_n351_));
  nand3  g188(.a(new_n240_), .b(x03), .c(new_n351_), .O(new_n352_));
  inv1   g189(.a(new_n352_), .O(z57));
  nand4  g190(.a(x80), .b(new_n232_), .c(x43), .d(new_n247_), .O(new_n354_));
  oai22  g191(.a(new_n354_), .b(new_n231_), .c(new_n247_), .d(x40), .O(new_n355_));
  nand3  g192(.a(new_n355_), .b(new_n229_), .c(x79), .O(new_n356_));
  nand3  g193(.a(new_n177_), .b(new_n247_), .c(x40), .O(new_n357_));
  nand2  g194(.a(new_n357_), .b(new_n356_), .O(new_n358_));
  nand2  g195(.a(new_n358_), .b(x77), .O(new_n359_));
  oai21  g196(.a(new_n169_), .b(new_n160_), .c(new_n154_), .O(new_n360_));
  aoi21  g197(.a(new_n360_), .b(new_n359_), .c(x01), .O(z58));
  aoi21  g198(.a(new_n163_), .b(new_n178_), .c(new_n152_), .O(new_n362_));
  oai21  g199(.a(new_n233_), .b(new_n231_), .c(new_n247_), .O(new_n363_));
  aoi21  g200(.a(new_n363_), .b(x79), .c(new_n163_), .O(new_n364_));
  oai21  g201(.a(new_n364_), .b(new_n362_), .c(x77), .O(new_n365_));
  nor2   g202(.a(x79), .b(x04), .O(new_n366_));
  inv1   g203(.a(new_n366_), .O(new_n367_));
  aoi21  g204(.a(new_n367_), .b(new_n365_), .c(x01), .O(z59));
  aoi21  g205(.a(new_n344_), .b(x79), .c(new_n366_), .O(new_n369_));
  aoi21  g206(.a(new_n369_), .b(new_n236_), .c(x01), .O(z60));
  nand3  g207(.a(x84), .b(x81), .c(x79), .O(new_n372_));
  oai21  g208(.a(x79), .b(new_n160_), .c(new_n372_), .O(new_n373_));
  nand2  g209(.a(new_n373_), .b(new_n159_), .O(new_n374_));
  nand2  g210(.a(new_n363_), .b(x79), .O(new_n375_));
  nand3  g211(.a(x81), .b(x79), .c(new_n160_), .O(new_n376_));
  inv1   g212(.a(new_n376_), .O(new_n377_));
  aoi21  g213(.a(new_n375_), .b(x04), .c(new_n377_), .O(new_n378_));
  oai21  g214(.a(new_n378_), .b(new_n159_), .c(new_n374_), .O(new_n379_));
  nand2  g215(.a(new_n379_), .b(x78), .O(new_n380_));
  inv1   g216(.a(new_n372_), .O(new_n381_));
  nand2  g217(.a(new_n381_), .b(new_n171_), .O(new_n382_));
  aoi21  g218(.a(new_n382_), .b(new_n380_), .c(x01), .O(z62));
  oai21  g219(.a(new_n171_), .b(new_n169_), .c(new_n226_), .O(new_n384_));
  oai21  g220(.a(new_n242_), .b(x04), .c(new_n384_), .O(new_n385_));
  nand2  g221(.a(new_n174_), .b(x82), .O(new_n386_));
  inv1   g222(.a(new_n386_), .O(new_n387_));
  and2   g223(.a(new_n387_), .b(new_n385_), .O(z63));
  nand3  g224(.a(new_n385_), .b(x83), .c(x79), .O(new_n389_));
  nand4  g225(.a(new_n154_), .b(x78), .c(new_n159_), .d(x04), .O(new_n390_));
  aoi21  g226(.a(new_n390_), .b(new_n389_), .c(x01), .O(z64));
  nor2   g227(.a(new_n164_), .b(x04), .O(new_n392_));
  nor2   g228(.a(new_n248_), .b(x78), .O(new_n393_));
  oai21  g229(.a(new_n393_), .b(new_n392_), .c(x77), .O(new_n394_));
  nand2  g230(.a(new_n169_), .b(x81), .O(new_n395_));
  nand2  g231(.a(new_n174_), .b(x84), .O(new_n396_));
