...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n243_, new_n245_, new_n247_, new_n249_, new_n251_, new_n255_,
  ...
  nor2   g097(.a(new_n215_), .b(new_n235_), .O(new_n259_));
  inv1   g098(.a(new_n259_), .O(new_n260_));
  nand2  g099(.a(new_n260_), .b(new_n236_), .O(new_n261_));
  nand2  g100(.a(new_n259_), .b(x81), .O(new_n262_));
  aoi21  g101(.a(new_n262_), .b(new_n261_), .c(new_n239_), .O(new_n263_));
  nand2  g102(.a(new_n260_), .b(x81), .O(new_n264_));
  nand2  g103(.a(new_n259_), .b(new_n236_), .O(new_n265_));
  aoi21  g104(.a(new_n265_), .b(new_n264_), .c(new_n237_), .O(new_n266_));
  oai21  g105(.a(new_n266_), .b(new_n263_), .c(new_n258_), .O(new_n267_));
  nand2  g106(.a(new_n232_), .b(x52), .O(new_n268_));
  nor2   g107(.a(new_n268_), .b(new_n267_), .O(z34));
  nand2  g108(.a(new_n232_), .b(x53), .O(new_n270_));
  nor2   g109(.a(new_n270_), .b(new_n267_), .O(z35));
  nand2  g110(.a(new_n232_), .b(x54), .O(new_n272_));
  nor2   g111(.a(new_n272_), .b(new_n267_), .O(z36));
  nand2  g112(.a(new_n232_), .b(x55), .O(new_n274_));
  nor2   g113(.a(new_n274_), .b(new_n267_), .O(z37));
  nand2  g114(.a(new_n232_), .b(x56), .O(new_n276_));
  nor2   g115(.a(new_n276_), .b(new_n267_), .O(z38));
  inv1   g116(.a(new_n232_), .O(new_n278_));
  nor3   g117(.a(new_n267_), .b(new_n278_), .c(new_n193_), .O(z39));
  nor3   g118(.a(new_n267_), .b(new_n278_), .c(new_n190_), .O(z40));
  nor3   g119(.a(new_n267_), .b(new_n278_), .c(new_n187_), .O(z41));
  nor3   g120(.a(new_n267_), .b(new_n278_), .c(new_n184_), .O(z42));
  nand2  g121(.a(new_n232_), .b(x61), .O(new_n283_));
  nor2   g122(.a(new_n283_), .b(new_n267_), .O(z43));
  nand2  g123(.a(new_n232_), .b(x63), .O(new_n286_));
  nor2   g124(.a(new_n286_), .b(new_n267_), .O(z45));
  nor3   g125(.a(new_n267_), .b(new_n278_), .c(new_n178_), .O(z46));
  inv1   g126(.a(x07), .O(new_n289_));
  nand2  g127(.a(x52), .b(x15), .O(new_n290_));
  oai21  g128(.a(x52), .b(new_n289_), .c(new_n290_), .O(new_n291_));
  nand3  g129(.a(new_n222_), .b(new_n154_), .c(new_n159_), .O(new_n292_));
  inv1   g130(.a(new_n292_), .O(new_n293_));
  nand2  g131(.a(new_n293_), .b(new_n291_), .O(new_n294_));
  ...
  nand2  g136(.a(new_n298_), .b(new_n212_), .O(new_n299_));
  ...
  inv1   g142(.a(new_n212_), .O(new_n305_));
  ...
  inv1   g146(.a(x11), .O(new_n311_));
  nand2  g147(.a(x52), .b(x19), .O(new_n312_));
  oai21  g148(.a(x52), .b(new_n311_), .c(new_n312_), .O(new_n313_));
  nand2  g149(.a(new_n313_), .b(new_n293_), .O(new_n314_));
  nand2  g150(.a(new_n306_), .b(x71), .O(new_n315_));
  aoi21  g151(.a(new_n315_), .b(new_n314_), .c(x01), .O(z51));
  inv1   g152(.a(x13), .O(new_n318_));
  nand2  g153(.a(x52), .b(x21), .O(new_n319_));
  oai21  g154(.a(x52), .b(new_n318_), .c(new_n319_), .O(new_n320_));
  nand2  g155(.a(new_n320_), .b(new_n293_), .O(new_n321_));
  nand2  g156(.a(new_n306_), .b(x73), .O(new_n322_));
  aoi21  g157(.a(new_n322_), .b(new_n321_), .c(x01), .O(z53));
  inv1   g158(.a(x82), .O(new_n325_));
  nand4  g159(.a(x84), .b(x83), .c(new_n325_), .d(new_n236_), .O(new_n326_));
  inv1   g160(.a(x80), .O(new_n327_));
  nand4  g161(.a(new_n232_), .b(new_n161_), .c(new_n327_), .d(x79), .O(new_n328_));
  nor2   g162(.a(new_n328_), .b(new_n326_), .O(z55));
  nand2  g163(.a(new_n230_), .b(x76), .O(new_n330_));
  xnor2a g164(.a(x84), .b(x81), .O(new_n331_));
  aoi21  g165(.a(new_n168_), .b(new_n167_), .c(new_n331_), .O(new_n332_));
  nand2  g166(.a(new_n332_), .b(new_n153_), .O(new_n333_));
  nand2  g167(.a(new_n333_), .b(new_n330_), .O(new_n334_));
  nand2  g168(.a(new_n334_), .b(x79), .O(new_n335_));
  nand3  g169(.a(new_n160_), .b(new_n159_), .c(new_n153_), .O(new_n336_));
  nand3  g170(.a(new_n336_), .b(new_n335_), .c(new_n228_), .O(z56));
  inv1   g171(.a(x02), .O(new_n338_));
  nand3  g172(.a(new_n228_), .b(x03), .c(new_n338_), .O(new_n339_));
  inv1   g173(.a(new_n339_), .O(z57));
  nand4  g174(.a(x80), .b(new_n217_), .c(x43), .d(new_n235_), .O(new_n341_));
  oai22  g175(.a(new_n341_), .b(new_n216_), .c(new_n235_), .d(x40), .O(new_n342_));
  nand3  g176(.a(new_n342_), .b(new_n222_), .c(x79), .O(new_n343_));
  nor2   g177(.a(x79), .b(x78), .O(new_n344_));
  nand3  g178(.a(new_n344_), .b(new_n235_), .c(x40), .O(new_n345_));
  nand2  g179(.a(new_n345_), .b(new_n343_), .O(new_n346_));
  nand2  g180(.a(new_n346_), .b(x77), .O(new_n347_));
  inv1   g181(.a(new_n167_), .O(new_n348_));
  oai21  g182(.a(new_n348_), .b(new_n225_), .c(new_n154_), .O(new_n349_));
  aoi21  g183(.a(new_n349_), .b(new_n347_), .c(x01), .O(z58));
  inv1   g184(.a(new_n344_), .O(new_n351_));
  aoi21  g185(.a(new_n221_), .b(new_n351_), .c(new_n152_), .O(new_n352_));
  oai21  g186(.a(new_n218_), .b(new_n216_), .c(new_n235_), .O(new_n353_));
  aoi21  g187(.a(new_n353_), .b(x79), .c(new_n221_), .O(new_n354_));
  ...
  aoi21  g192(.a(new_n332_), .b(x79), .c(new_n356_), .O(new_n359_));
  aoi21  g193(.a(new_n359_), .b(new_n223_), .c(x01), .O(z60));
  inv1   g194(.a(new_n170_), .O(new_n361_));
  nand2  g195(.a(new_n168_), .b(new_n167_), .O(new_n362_));
  aoi22  g196(.a(new_n362_), .b(new_n212_), .c(new_n161_), .d(new_n225_), .O(new_n363_));
  nor3   g197(.a(new_n363_), .b(new_n361_), .c(new_n327_), .O(z61));
  nand3  g198(.a(x84), .b(x81), .c(x79), .O(new_n365_));
  oai21  g199(.a(x79), .b(new_n225_), .c(new_n365_), .O(new_n366_));
  nand2  g200(.a(new_n366_), .b(new_n159_), .O(new_n367_));
  nand2  g201(.a(new_n353_), .b(x79), .O(new_n368_));
  nand3  g202(.a(x81), .b(x79), .c(new_n225_), .O(new_n369_));
  ...
  nor3   g210(.a(new_n363_), .b(new_n361_), .c(new_n325_), .O(z63));
  nand2  g211(.a(x83), .b(x79), .O(new_n378_));
  or2    g212(.a(new_n378_), .b(new_n363_), .O(new_n379_));
  aoi21  g213(.a(new_n379_), .b(new_n292_), .c(x01), .O(z64));
  nor2   g214(.a(new_n160_), .b(x04), .O(new_n381_));
  nor2   g215(.a(new_n236_), .b(x78), .O(new_n382_));
  oai21  g216(.a(new_n382_), .b(new_n381_), .c(x77), .O(new_n383_));
  nand2  g217(.a(new_n348_), .b(x81), .O(new_n384_));
  nand2  g218(.a(new_n170_), .b(x84), .O(new_n385_));
