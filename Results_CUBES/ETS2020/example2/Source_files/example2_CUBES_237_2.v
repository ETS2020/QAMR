// Benchmark "FAU" written by ABC on Fri Jul 10 18:26:24 2020
...
module FAU ( 
  ...
  wire new_n154_, new_n155_, new_n156_, new_n157_, new_n158_, new_n159_,
    ...
    new_n275_, new_n278_, new_n280_, new_n283_, new_n285_, new_n287_,
    ...
    new_n339_, new_n340_, new_n343_, new_n344_, new_n349_, new_n350_,
    new_n351_;
  ...
  nand3  g072(.a(new_n212_), .b(x48), .c(new_n222_), .O(new_n237_));
  inv1   g073(.a(new_n237_), .O(new_n238_));
  nand3  g074(.a(new_n238_), .b(new_n221_), .c(new_n219_), .O(new_n239_));
  ...
  nand2  g110(.a(new_n212_), .b(x59), .O(new_n278_));
  nor2   g111(.a(new_n278_), .b(new_n265_), .O(z41));
  nand2  g112(.a(new_n212_), .b(x60), .O(new_n280_));
  nor2   g113(.a(new_n280_), .b(new_n265_), .O(z42));
  ...
  nand4  g164(.a(new_n155_), .b(new_n208_), .c(x04), .d(new_n160_), .O(new_n334_));
  nor2   g165(.a(new_n334_), .b(new_n333_), .O(z54));
  inv1   g166(.a(x82), .O(new_n336_));
  nand2  g167(.a(x84), .b(new_n336_), .O(new_n337_));
  nand2  g168(.a(x83), .b(new_n215_), .O(new_n338_));
  nor2   g169(.a(x80), .b(new_n208_), .O(new_n339_));
  nand3  g170(.a(new_n339_), .b(new_n212_), .c(new_n209_), .O(new_n340_));
  nor3   g171(.a(new_n340_), .b(new_n338_), .c(new_n337_), .O(z55));
