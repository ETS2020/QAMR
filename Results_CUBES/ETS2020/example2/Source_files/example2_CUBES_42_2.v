// Benchmark "FAU" written by ABC on Fri Jul 10 18:12:46 2020
...
module FAU ( 
  ...
  nand2  g085(.a(new_n250_), .b(new_n215_), .O(new_n251_));
  nand2  g086(.a(new_n219_), .b(new_n209_), .O(new_n252_));
  ...
  nand2  g097(.a(new_n209_), .b(x53), .O(new_n264_));
  nor2   g098(.a(new_n264_), .b(new_n263_), .O(z35));
  nand2  g099(.a(new_n209_), .b(x54), .O(new_n266_));
  nor2   g100(.a(new_n266_), .b(new_n263_), .O(z36));
  nand2  g101(.a(new_n209_), .b(x56), .O(new_n269_));
  nor2   g102(.a(new_n269_), .b(new_n263_), .O(z38));
  nand2  g103(.a(new_n209_), .b(x57), .O(new_n271_));
  nor2   g104(.a(new_n271_), .b(new_n263_), .O(z39));
  nand2  g105(.a(new_n209_), .b(x58), .O(new_n273_));
  nor2   g106(.a(new_n273_), .b(new_n263_), .O(z40));
  nand2  g107(.a(new_n209_), .b(x59), .O(new_n275_));
  nor2   g108(.a(new_n275_), .b(new_n263_), .O(z41));
  nand2  g109(.a(new_n209_), .b(x60), .O(new_n277_));
  nor2   g110(.a(new_n277_), .b(new_n263_), .O(z42));
  nand2  g111(.a(new_n209_), .b(x62), .O(new_n280_));
  nor2   g112(.a(new_n280_), .b(new_n263_), .O(z44));
  nand2  g113(.a(new_n209_), .b(x63), .O(new_n282_));
  nor2   g114(.a(new_n282_), .b(new_n263_), .O(z45));
  nand2  g115(.a(new_n209_), .b(x64), .O(new_n284_));
  nor2   g116(.a(new_n284_), .b(new_n263_), .O(z46));
  inv1   g117(.a(x07), .O(new_n286_));
  nand2  g118(.a(x52), .b(x15), .O(new_n287_));
  oai21  g119(.a(x52), .b(new_n286_), .c(new_n287_), .O(new_n288_));
  nand4  g120(.a(new_n206_), .b(x78), .c(new_n154_), .d(x04), .O(new_n289_));
  ...
  nor2   g125(.a(x75), .b(x67), .O(new_n294_));
  nand3  g126(.a(x79), .b(new_n156_), .c(x77), .O(new_n295_));
  nor2   g127(.a(new_n295_), .b(new_n294_), .O(new_n296_));
  nand2  g128(.a(new_n296_), .b(new_n293_), .O(new_n297_));
  aoi21  g129(.a(new_n297_), .b(new_n291_), .c(x01), .O(z47));
  inv1   g130(.a(x08), .O(new_n299_));
  nand2  g131(.a(x52), .b(x16), .O(new_n300_));
  oai21  g132(.a(x52), .b(new_n299_), .c(new_n300_), .O(new_n301_));
  nand2  g133(.a(new_n301_), .b(new_n290_), .O(new_n302_));
  nor2   g134(.a(new_n295_), .b(new_n292_), .O(new_n303_));
  nand2  g135(.a(new_n303_), .b(x68), .O(new_n304_));
  aoi21  g136(.a(new_n304_), .b(new_n302_), .c(x01), .O(z48));
  inv1   g137(.a(x11), .O(new_n308_));
  nand2  g138(.a(x52), .b(x19), .O(new_n309_));
  oai21  g139(.a(x52), .b(new_n308_), .c(new_n309_), .O(new_n310_));
  nand2  g140(.a(new_n310_), .b(new_n290_), .O(new_n311_));
  nand2  g141(.a(new_n303_), .b(x71), .O(new_n312_));
  ...
  nand2  g146(.a(new_n316_), .b(new_n290_), .O(new_n317_));
  nand2  g147(.a(new_n303_), .b(x72), .O(new_n318_));
  ...
  nand2  g152(.a(new_n322_), .b(new_n290_), .O(new_n323_));
  nand2  g153(.a(new_n303_), .b(x73), .O(new_n324_));
  aoi21  g154(.a(new_n324_), .b(new_n323_), .c(x01), .O(z53));
  aoi21  g155(.a(x84), .b(new_n213_), .c(x76), .O(new_n328_));
  oai21  g156(.a(x84), .b(new_n213_), .c(new_n328_), .O(new_n329_));
  nand2  g157(.a(new_n329_), .b(new_n207_), .O(new_n330_));
  nand2  g158(.a(new_n156_), .b(new_n154_), .O(new_n331_));
  nand4  g159(.a(new_n331_), .b(new_n330_), .c(new_n158_), .d(x00), .O(z56));
  inv1   g160(.a(x02), .O(new_n333_));
  nand4  g161(.a(x03), .b(new_n333_), .c(new_n158_), .d(x00), .O(new_n334_));
