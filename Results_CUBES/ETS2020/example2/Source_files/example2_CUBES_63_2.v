...
module FAU ( 
  ...
  wire new_n154_, new_n155_, new_n156_, new_n157_, new_n158_, new_n159_,
    ...
    new_n256_, new_n258_, new_n260_, new_n264_, new_n267_, new_n269_,
    ...
    new_n314_, new_n315_, new_n319_, new_n320_, new_n327_, new_n328_,
    new_n329_;
  ...
  nand2  g083(.a(new_n212_), .b(x53), .O(new_n252_));
  nor2   g084(.a(new_n252_), .b(new_n249_), .O(z35));
  nand2  g085(.a(new_n212_), .b(x56), .O(new_n256_));
  nor2   g086(.a(new_n256_), .b(new_n249_), .O(z38));
  nand2  g087(.a(new_n212_), .b(x57), .O(new_n258_));
  nor2   g088(.a(new_n258_), .b(new_n249_), .O(z39));
  nand2  g089(.a(new_n212_), .b(x58), .O(new_n260_));
  nor2   g090(.a(new_n260_), .b(new_n249_), .O(z40));
  nand2  g091(.a(new_n212_), .b(x61), .O(new_n264_));
  nor2   g092(.a(new_n264_), .b(new_n249_), .O(z43));
  nand2  g093(.a(new_n212_), .b(x63), .O(new_n267_));
  nor2   g094(.a(new_n267_), .b(new_n249_), .O(z45));
  nand2  g095(.a(new_n212_), .b(x64), .O(new_n269_));
  nor2   g096(.a(new_n269_), .b(new_n249_), .O(z46));
  inv1   g097(.a(x07), .O(new_n271_));
  nand2  g098(.a(x52), .b(x15), .O(new_n272_));
  oai21  g099(.a(x52), .b(new_n271_), .c(new_n272_), .O(new_n273_));
  inv1   g100(.a(x04), .O(new_n274_));
  nor2   g101(.a(x77), .b(new_n274_), .O(new_n275_));
  nand3  g102(.a(new_n275_), .b(new_n273_), .c(new_n163_), .O(new_n276_));
  ...
  nand3  g110(.a(new_n284_), .b(new_n275_), .c(new_n163_), .O(new_n285_));
  ...
  nand3  g116(.a(new_n290_), .b(new_n275_), .c(new_n163_), .O(new_n291_));
  ...
  nand3  g122(.a(new_n296_), .b(new_n275_), .c(new_n163_), .O(new_n297_));
  ...
  nand3  g128(.a(new_n302_), .b(new_n275_), .c(new_n163_), .O(new_n303_));
  ...
  nand3  g134(.a(new_n308_), .b(new_n275_), .c(new_n163_), .O(new_n309_));
  ...
  nand4  g140(.a(new_n155_), .b(new_n208_), .c(x04), .d(new_n160_), .O(new_n315_));
  nor2   g141(.a(new_n315_), .b(new_n314_), .O(z54));
  inv1   g142(.a(x02), .O(new_n319_));
  nand4  g143(.a(x03), .b(new_n319_), .c(new_n160_), .d(x00), .O(new_n320_));
  inv1   g144(.a(new_n320_), .O(z57));
  oai21  g145(.a(new_n158_), .b(new_n155_), .c(new_n277_), .O(new_n327_));
  nand2  g146(.a(new_n209_), .b(new_n274_), .O(new_n328_));
  nand3  g147(.a(x82), .b(x79), .c(new_n160_), .O(new_n329_));
  aoi21  g148(.a(new_n328_), .b(new_n327_), .c(new_n329_), .O(z63));
  zero   g149(.O(z00));
  zero   g150(.O(z01));
  zero   g151(.O(z04));
  zero   g152(.O(z08));
