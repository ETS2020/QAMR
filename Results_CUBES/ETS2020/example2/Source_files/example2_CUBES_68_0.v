...
module FAU ( 
  ...
  nor3   g131(.a(new_n282_), .b(new_n273_), .c(new_n184_), .O(z40));
  nor3   g132(.a(new_n282_), .b(new_n273_), .c(new_n181_), .O(z41));
  nand2  g133(.a(new_n233_), .b(x60), .O(new_n294_));
  nor2   g134(.a(new_n294_), .b(new_n282_), .O(z42));
  nor3   g135(.a(new_n282_), .b(new_n273_), .c(new_n177_), .O(z43));
  nor3   g136(.a(new_n282_), .b(new_n273_), .c(new_n174_), .O(z44));
  nand2  g137(.a(new_n233_), .b(x63), .O(new_n298_));
  nor2   g138(.a(new_n298_), .b(new_n282_), .O(z45));
  nor3   g139(.a(new_n282_), .b(new_n273_), .c(new_n170_), .O(z46));
  inv1   g140(.a(x07), .O(new_n301_));
  nand2  g141(.a(x52), .b(x15), .O(new_n302_));
  oai21  g142(.a(x52), .b(new_n301_), .c(new_n302_), .O(new_n303_));
  nand3  g143(.a(new_n225_), .b(new_n154_), .c(new_n159_), .O(new_n304_));
  ...
  nand2  g173(.a(new_n272_), .b(x14), .O(new_n337_));
  inv1   g174(.a(new_n212_), .O(new_n338_));
  ...
  nand3  g178(.a(new_n259_), .b(x84), .c(new_n341_), .O(new_n342_));
  inv1   g179(.a(x80), .O(new_n343_));
  nand4  g180(.a(new_n233_), .b(new_n161_), .c(new_n343_), .d(x79), .O(new_n344_));
  nor2   g181(.a(new_n344_), .b(new_n342_), .O(z55));
  nand2  g182(.a(new_n160_), .b(new_n159_), .O(new_n346_));
  nand2  g183(.a(new_n231_), .b(x76), .O(new_n347_));
  xnor2a g184(.a(x84), .b(x81), .O(new_n348_));
  aoi21  g185(.a(new_n213_), .b(new_n212_), .c(new_n348_), .O(new_n349_));
  ...
  nand4  g190(.a(x80), .b(new_n220_), .c(x43), .d(new_n236_), .O(new_n355_));
  oai22  g191(.a(new_n355_), .b(new_n219_), .c(new_n236_), .d(x40), .O(new_n356_));
  nand3  g192(.a(new_n356_), .b(new_n225_), .c(x79), .O(new_n357_));
  nor2   g193(.a(x79), .b(x78), .O(new_n358_));
  nand3  g194(.a(new_n358_), .b(new_n236_), .c(x40), .O(new_n359_));
  nand2  g195(.a(new_n359_), .b(new_n357_), .O(new_n360_));
  nand2  g196(.a(new_n360_), .b(x77), .O(new_n361_));
  oai21  g197(.a(new_n338_), .b(new_n228_), .c(new_n154_), .O(new_n362_));
  ...
  oai21  g201(.a(new_n221_), .b(new_n219_), .c(new_n236_), .O(new_n366_));
