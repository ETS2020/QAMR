...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n180_, new_n182_, new_n183_, new_n185_, new_n186_, new_n190_,
    ...
    new_n257_, new_n260_, new_n262_, new_n264_, new_n267_, new_n268_,
    new_n269_, new_n270_, new_n271_, new_n272_, new_n273_, new_n274_,
    new_n275_, new_n276_, new_n277_, new_n278_, new_n280_, new_n281_,
    new_n282_, new_n283_, new_n284_, new_n285_, new_n286_, new_n287_,
    new_n288_, new_n289_, new_n290_, new_n292_, new_n295_, new_n297_,
    new_n300_, new_n305_, new_n307_, new_n310_, new_n311_, new_n312_,
  ...
  nand4  g102(.a(new_n253_), .b(new_n252_), .c(x47), .d(new_n244_), .O(new_n260_));
  inv1   g103(.a(new_n260_), .O(z29));
  nand4  g104(.a(new_n253_), .b(new_n252_), .c(x48), .d(new_n244_), .O(new_n262_));
  inv1   g105(.a(new_n262_), .O(z30));
  nand4  g106(.a(new_n253_), .b(new_n252_), .c(x49), .d(new_n244_), .O(new_n264_));
  inv1   g107(.a(new_n264_), .O(z31));
  nor2   g108(.a(new_n231_), .b(x81), .O(new_n267_));
  nor2   g109(.a(x83), .b(new_n248_), .O(new_n268_));
  nor2   g110(.a(new_n268_), .b(new_n267_), .O(new_n269_));
  nand2  g111(.a(x42), .b(x05), .O(new_n270_));
  nand2  g112(.a(x51), .b(new_n244_), .O(new_n271_));
  oai22  g113(.a(new_n271_), .b(new_n248_), .c(new_n270_), .d(new_n269_), .O(new_n272_));
  nand2  g114(.a(new_n272_), .b(new_n246_), .O(new_n273_));
  xor2a  g115(.a(x83), .b(x81), .O(new_n274_));
  oai22  g116(.a(new_n274_), .b(new_n270_), .c(new_n271_), .d(x81), .O(new_n275_));
  nand2  g117(.a(new_n275_), .b(new_n249_), .O(new_n276_));
  inv1   g118(.a(new_n251_), .O(new_n277_));
  nand2  g119(.a(new_n253_), .b(new_n277_), .O(new_n278_));
  aoi21  g120(.a(new_n276_), .b(new_n273_), .c(new_n278_), .O(z33));
  inv1   g121(.a(x52), .O(new_n280_));
  inv1   g122(.a(new_n253_), .O(new_n281_));
  nand2  g123(.a(x83), .b(x42), .O(new_n282_));
  nand2  g124(.a(new_n282_), .b(new_n248_), .O(new_n283_));
  nand3  g125(.a(x83), .b(x81), .c(x42), .O(new_n284_));
  nand2  g126(.a(new_n284_), .b(new_n283_), .O(new_n285_));
  and2   g127(.a(new_n285_), .b(new_n249_), .O(new_n286_));
  nand2  g128(.a(new_n282_), .b(x81), .O(new_n287_));
  nand2  g129(.a(new_n267_), .b(x42), .O(new_n288_));
  aoi21  g130(.a(new_n288_), .b(new_n287_), .c(new_n245_), .O(new_n289_));
  oai21  g131(.a(new_n289_), .b(new_n286_), .c(new_n277_), .O(new_n290_));
  nor3   g132(.a(new_n290_), .b(new_n281_), .c(new_n280_), .O(z34));
  nand2  g133(.a(new_n253_), .b(x53), .O(new_n292_));
  nor2   g134(.a(new_n292_), .b(new_n290_), .O(z35));
  nand2  g135(.a(new_n253_), .b(x55), .O(new_n295_));
  nor2   g136(.a(new_n295_), .b(new_n290_), .O(z37));
  nand2  g137(.a(new_n253_), .b(x56), .O(new_n297_));
  nor2   g138(.a(new_n297_), .b(new_n290_), .O(z38));
  nor3   g139(.a(new_n290_), .b(new_n281_), .c(new_n200_), .O(z39));
  nand2  g140(.a(new_n253_), .b(x58), .O(new_n300_));
  nor2   g141(.a(new_n300_), .b(new_n290_), .O(z40));
  nor3   g142(.a(new_n290_), .b(new_n281_), .c(new_n193_), .O(z42));
  nor3   g143(.a(new_n290_), .b(new_n281_), .c(new_n190_), .O(z43));
  nand2  g144(.a(new_n253_), .b(x62), .O(new_n305_));
  nor2   g145(.a(new_n305_), .b(new_n290_), .O(z44));
  nand2  g146(.a(new_n253_), .b(x63), .O(new_n307_));
  nor2   g147(.a(new_n307_), .b(new_n290_), .O(z45));
  nor3   g148(.a(new_n290_), .b(new_n281_), .c(new_n185_), .O(z46));
  inv1   g149(.a(x07), .O(new_n310_));
  nand2  g150(.a(x52), .b(x15), .O(new_n311_));
  oai21  g151(.a(x52), .b(new_n310_), .c(new_n311_), .O(new_n312_));
  nand3  g152(.a(new_n230_), .b(new_n154_), .c(new_n159_), .O(new_n313_));
  ...
  nand2  g159(.a(new_n319_), .b(new_n227_), .O(new_n320_));
  ...
  inv1   g165(.a(new_n227_), .O(new_n327_));
  ...
  nand2  g172(.a(new_n334_), .b(new_n314_), .O(new_n335_));
  ...
  nand2  g178(.a(new_n340_), .b(new_n314_), .O(new_n341_));
  ...
  nand3  g193(.a(new_n267_), .b(x84), .c(new_n355_), .O(new_n356_));
  inv1   g194(.a(x80), .O(new_n357_));
  nand4  g195(.a(new_n253_), .b(new_n165_), .c(new_n357_), .d(x79), .O(new_n358_));
  ...
  aoi21  g203(.a(new_n365_), .b(new_n164_), .c(new_n240_), .O(new_n366_));
  oai21  g204(.a(new_n364_), .b(new_n154_), .c(new_n366_), .O(z56));
  inv1   g205(.a(x02), .O(new_n368_));
  nand3  g206(.a(new_n241_), .b(x03), .c(new_n368_), .O(new_n369_));
  inv1   g207(.a(new_n369_), .O(z57));
  nand4  g208(.a(x80), .b(new_n233_), .c(x43), .d(new_n244_), .O(new_n371_));
  oai22  g209(.a(new_n371_), .b(new_n232_), .c(new_n244_), .d(x40), .O(new_n372_));
  nand3  g210(.a(new_n372_), .b(new_n230_), .c(x79), .O(new_n373_));
  nand3  g211(.a(new_n178_), .b(new_n244_), .c(x40), .O(new_n374_));
  nand2  g212(.a(new_n374_), .b(new_n373_), .O(new_n375_));
  nand2  g213(.a(new_n375_), .b(x77), .O(new_n376_));
  oai21  g214(.a(new_n352_), .b(new_n160_), .c(new_n154_), .O(new_n377_));
  aoi21  g215(.a(new_n377_), .b(new_n376_), .c(x01), .O(z58));
  aoi21  g216(.a(new_n163_), .b(new_n179_), .c(new_n152_), .O(new_n379_));
  oai21  g217(.a(new_n234_), .b(new_n232_), .c(new_n244_), .O(new_n380_));
  ...
  aoi21  g224(.a(new_n386_), .b(new_n237_), .c(x01), .O(z60));
  inv1   g225(.a(new_n173_), .O(new_n388_));
  nand2  g226(.a(new_n171_), .b(new_n170_), .O(new_n389_));
  aoi22  g227(.a(new_n389_), .b(new_n227_), .c(new_n165_), .d(new_n160_), .O(new_n390_));
  nor3   g228(.a(new_n390_), .b(new_n388_), .c(new_n357_), .O(z61));
  nand3  g229(.a(x84), .b(x81), .c(x79), .O(new_n392_));
  oai21  g230(.a(x79), .b(new_n160_), .c(new_n392_), .O(new_n393_));
  nand2  g231(.a(new_n393_), .b(new_n159_), .O(new_n394_));
  nand2  g232(.a(new_n380_), .b(x79), .O(new_n395_));
  nand3  g233(.a(x81), .b(x79), .c(new_n160_), .O(new_n396_));
  inv1   g234(.a(new_n396_), .O(new_n397_));
  aoi21  g235(.a(new_n395_), .b(x04), .c(new_n397_), .O(new_n398_));
  oai21  g236(.a(new_n398_), .b(new_n159_), .c(new_n394_), .O(new_n399_));
  nand2  g237(.a(new_n399_), .b(x78), .O(new_n400_));
  inv1   g238(.a(new_n392_), .O(new_n401_));
  nand2  g239(.a(new_n401_), .b(new_n317_), .O(new_n402_));
  aoi21  g240(.a(new_n402_), .b(new_n400_), .c(x01), .O(z62));
  nor3   g241(.a(new_n390_), .b(new_n388_), .c(new_n355_), .O(z63));
  nand2  g242(.a(x83), .b(x79), .O(new_n405_));
  or2    g243(.a(new_n405_), .b(new_n390_), .O(new_n406_));
  nand3  g244(.a(new_n175_), .b(new_n159_), .c(x04), .O(new_n407_));
  aoi21  g245(.a(new_n407_), .b(new_n406_), .c(x01), .O(z64));
  nor2   g246(.a(new_n164_), .b(x04), .O(new_n409_));
  nor2   g247(.a(new_n248_), .b(x78), .O(new_n410_));
  oai21  g248(.a(new_n410_), .b(new_n409_), .c(x77), .O(new_n411_));
  nand2  g249(.a(new_n352_), .b(x81), .O(new_n412_));
  nand2  g250(.a(new_n173_), .b(x84), .O(new_n413_));
