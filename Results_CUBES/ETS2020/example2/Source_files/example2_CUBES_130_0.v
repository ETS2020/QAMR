// Benchmark "FAU" written by ABC on Fri Jul 10 18:18:55 2020
...
module FAU ( 
  ...
  nor2   g130(.a(new_n288_), .b(new_n285_), .O(z36));
  nand2  g131(.a(new_n235_), .b(x55), .O(new_n290_));
  nor2   g132(.a(new_n290_), .b(new_n285_), .O(z37));
  nand2  g133(.a(new_n235_), .b(x58), .O(new_n294_));
  nor2   g134(.a(new_n294_), .b(new_n285_), .O(z40));
  nor3   g135(.a(new_n285_), .b(new_n276_), .c(new_n185_), .O(z41));
  nor3   g136(.a(new_n285_), .b(new_n276_), .c(new_n179_), .O(z43));
  nor3   g137(.a(new_n285_), .b(new_n276_), .c(new_n176_), .O(z44));
  nor3   g138(.a(new_n285_), .b(new_n276_), .c(new_n173_), .O(z45));
  nor3   g139(.a(new_n285_), .b(new_n276_), .c(new_n170_), .O(z46));
  inv1   g140(.a(x08), .O(new_n303_));
  nand2  g141(.a(x52), .b(x16), .O(new_n304_));
  oai21  g142(.a(x52), .b(new_n303_), .c(new_n304_), .O(new_n305_));
  nand3  g143(.a(new_n225_), .b(new_n154_), .c(new_n159_), .O(new_n306_));
  ...
  nand2  g159(.a(new_n275_), .b(x14), .O(new_n326_));
  inv1   g160(.a(new_n212_), .O(new_n327_));
  ...
  nand3  g164(.a(new_n262_), .b(x84), .c(new_n330_), .O(new_n331_));
  inv1   g165(.a(x80), .O(new_n332_));
  nand4  g166(.a(new_n235_), .b(new_n161_), .c(new_n332_), .d(x79), .O(new_n333_));
  nor2   g167(.a(new_n333_), .b(new_n331_), .O(z55));
  nand2  g168(.a(new_n233_), .b(x76), .O(new_n335_));
  xnor2a g169(.a(x84), .b(x81), .O(new_n336_));
  aoi21  g170(.a(new_n213_), .b(new_n212_), .c(new_n336_), .O(new_n337_));
  nand2  g171(.a(new_n337_), .b(new_n153_), .O(new_n338_));
  nand2  g172(.a(new_n338_), .b(new_n335_), .O(new_n339_));
  nand2  g173(.a(new_n339_), .b(x79), .O(new_n340_));
  nand3  g174(.a(new_n160_), .b(new_n159_), .c(new_n153_), .O(new_n341_));
  nand3  g175(.a(new_n341_), .b(new_n340_), .c(new_n231_), .O(z56));
  inv1   g176(.a(x02), .O(new_n343_));
  nand3  g177(.a(new_n231_), .b(x03), .c(new_n343_), .O(new_n344_));
  inv1   g178(.a(new_n344_), .O(z57));
  nand4  g179(.a(x80), .b(new_n220_), .c(x43), .d(new_n238_), .O(new_n346_));
  oai22  g180(.a(new_n346_), .b(new_n219_), .c(new_n238_), .d(x40), .O(new_n347_));
  nand3  g181(.a(new_n347_), .b(new_n225_), .c(x79), .O(new_n348_));
  nor2   g182(.a(x79), .b(x78), .O(new_n349_));
  nand3  g183(.a(new_n349_), .b(new_n238_), .c(x40), .O(new_n350_));
  nand2  g184(.a(new_n350_), .b(new_n348_), .O(new_n351_));
  nand2  g185(.a(new_n351_), .b(x77), .O(new_n352_));
  oai21  g186(.a(new_n327_), .b(new_n228_), .c(new_n154_), .O(new_n353_));
  aoi21  g187(.a(new_n353_), .b(new_n352_), .c(x01), .O(z58));
  inv1   g188(.a(new_n349_), .O(new_n355_));
  aoi21  g189(.a(new_n224_), .b(new_n355_), .c(new_n152_), .O(new_n356_));
  oai21  g190(.a(new_n221_), .b(new_n219_), .c(new_n238_), .O(new_n357_));
  aoi21  g191(.a(new_n357_), .b(x79), .c(new_n224_), .O(new_n358_));
  ...
  aoi21  g196(.a(new_n337_), .b(x79), .c(new_n360_), .O(new_n363_));
  aoi21  g197(.a(new_n363_), .b(new_n226_), .c(x01), .O(z60));
  nand2  g198(.a(new_n213_), .b(new_n212_), .O(new_n365_));
  aoi22  g199(.a(new_n365_), .b(new_n215_), .c(new_n161_), .d(new_n228_), .O(new_n366_));
  nor2   g200(.a(new_n154_), .b(x01), .O(new_n367_));
  inv1   g201(.a(new_n367_), .O(new_n368_));
  nor3   g202(.a(new_n368_), .b(new_n366_), .c(new_n332_), .O(z61));
  ...
  nand2  g206(.a(new_n357_), .b(x79), .O(new_n373_));
  ...
  nand2  g213(.a(new_n379_), .b(new_n309_), .O(new_n380_));
  aoi21  g214(.a(new_n380_), .b(new_n378_), .c(x01), .O(z62));
  nor3   g215(.a(new_n368_), .b(new_n366_), .c(new_n330_), .O(z63));
  nand2  g216(.a(x83), .b(x79), .O(new_n383_));
  or2    g217(.a(new_n383_), .b(new_n366_), .O(new_n384_));
  aoi21  g218(.a(new_n384_), .b(new_n306_), .c(x01), .O(z64));
  nor2   g219(.a(new_n160_), .b(x04), .O(new_n386_));
  nor2   g220(.a(new_n242_), .b(x78), .O(new_n387_));
  oai21  g221(.a(new_n387_), .b(new_n386_), .c(x77), .O(new_n388_));
  nand2  g222(.a(new_n327_), .b(x81), .O(new_n389_));
  nand2  g223(.a(new_n367_), .b(x84), .O(new_n390_));
