...
module FAU ( 
  ...
  wire new_n154_, new_n155_, new_n156_, new_n157_, new_n158_, new_n159_,
    ...
    new_n320_, new_n324_, new_n325_, new_n332_, new_n333_, new_n334_,
    new_n335_;
  ...
  nand2  g092(.a(new_n257_), .b(new_n216_), .O(new_n258_));
  ...
  nand3  g096(.a(x83), .b(new_n216_), .c(x42), .O(new_n262_));
  aoi21  g097(.a(new_n262_), .b(new_n261_), .c(new_n217_), .O(new_n263_));
  oai21  g098(.a(new_n263_), .b(new_n260_), .c(new_n222_), .O(new_n264_));
  nand2  g099(.a(new_n224_), .b(x53), .O(new_n265_));
  nor2   g100(.a(new_n265_), .b(new_n264_), .O(z35));
  nand2  g101(.a(new_n224_), .b(x54), .O(new_n267_));
  nor2   g102(.a(new_n267_), .b(new_n264_), .O(z36));
  nand2  g103(.a(new_n224_), .b(x56), .O(new_n270_));
  nor2   g104(.a(new_n270_), .b(new_n264_), .O(z38));
  nand2  g105(.a(new_n224_), .b(x57), .O(new_n272_));
  nor2   g106(.a(new_n272_), .b(new_n264_), .O(z39));
  nand2  g107(.a(new_n224_), .b(x58), .O(new_n274_));
  nor2   g108(.a(new_n274_), .b(new_n264_), .O(z40));
  nand2  g109(.a(new_n224_), .b(x59), .O(new_n276_));
  nor2   g110(.a(new_n276_), .b(new_n264_), .O(z41));
  nand2  g111(.a(new_n224_), .b(x60), .O(new_n278_));
  nor2   g112(.a(new_n278_), .b(new_n264_), .O(z42));
  nand2  g113(.a(new_n224_), .b(x62), .O(new_n281_));
  nor2   g114(.a(new_n281_), .b(new_n264_), .O(z44));
  nand2  g115(.a(new_n224_), .b(x63), .O(new_n283_));
  nor2   g116(.a(new_n283_), .b(new_n264_), .O(z45));
  nand2  g117(.a(new_n224_), .b(x64), .O(new_n285_));
  nor2   g118(.a(new_n285_), .b(new_n264_), .O(z46));
  inv1   g119(.a(x07), .O(new_n287_));
  nand2  g120(.a(x52), .b(x15), .O(new_n288_));
  oai21  g121(.a(x52), .b(new_n287_), .c(new_n288_), .O(new_n289_));
  nand4  g122(.a(new_n289_), .b(new_n163_), .c(new_n157_), .d(x04), .O(new_n290_));
  xnor2a g123(.a(x84), .b(x81), .O(new_n291_));
  or2    g124(.a(x75), .b(x67), .O(new_n292_));
  nand4  g125(.a(new_n292_), .b(new_n291_), .c(new_n158_), .d(x79), .O(new_n293_));
  aoi21  g126(.a(new_n293_), .b(new_n290_), .c(x01), .O(z47));
  inv1   g127(.a(x08), .O(new_n295_));
  nand2  g128(.a(x52), .b(x16), .O(new_n296_));
  oai21  g129(.a(x52), .b(new_n295_), .c(new_n296_), .O(new_n297_));
  nand4  g130(.a(new_n297_), .b(new_n163_), .c(new_n157_), .d(x04), .O(new_n298_));
  nand4  g131(.a(new_n291_), .b(new_n158_), .c(x79), .d(x68), .O(new_n299_));
  aoi21  g132(.a(new_n299_), .b(new_n298_), .c(x01), .O(z48));
  inv1   g133(.a(x12), .O(new_n304_));
  nand2  g134(.a(x52), .b(x20), .O(new_n305_));
  oai21  g135(.a(x52), .b(new_n304_), .c(new_n305_), .O(new_n306_));
  nand4  g136(.a(new_n306_), .b(new_n163_), .c(new_n157_), .d(x04), .O(new_n307_));
  nand4  g137(.a(new_n291_), .b(new_n158_), .c(x79), .d(x72), .O(new_n308_));
  ...
  nand4  g142(.a(new_n312_), .b(new_n163_), .c(new_n157_), .d(x04), .O(new_n313_));
  nand4  g143(.a(new_n291_), .b(new_n158_), .c(x79), .d(x73), .O(new_n314_));
  aoi21  g144(.a(new_n314_), .b(new_n313_), .c(x01), .O(z53));
  inv1   g145(.a(x14), .O(new_n316_));
  nor2   g146(.a(x52), .b(new_n316_), .O(new_n317_));
  aoi21  g147(.a(x52), .b(x22), .c(new_n317_), .O(new_n318_));
  inv1   g148(.a(x79), .O(new_n319_));
  nand4  g149(.a(new_n155_), .b(new_n319_), .c(x04), .d(new_n160_), .O(new_n320_));
  nor2   g150(.a(new_n320_), .b(new_n318_), .O(z54));
  inv1   g151(.a(x02), .O(new_n324_));
  nand4  g152(.a(x03), .b(new_n324_), .c(new_n160_), .d(x00), .O(new_n325_));
  inv1   g153(.a(new_n325_), .O(z57));
  oai21  g154(.a(new_n158_), .b(new_n155_), .c(new_n291_), .O(new_n332_));
  inv1   g155(.a(x04), .O(new_n333_));
  nand3  g156(.a(x78), .b(x77), .c(new_n333_), .O(new_n334_));
  nand3  g157(.a(x82), .b(x79), .c(new_n160_), .O(new_n335_));
  aoi21  g158(.a(new_n334_), .b(new_n332_), .c(new_n335_), .O(z63));
  zero   g159(.O(z00));
  zero   g160(.O(z01));
  zero   g161(.O(z04));
  zero   g162(.O(z08));
