// Benchmark "FAU" written by ABC on Fri Jul 10 18:14:02 2020
...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n198_, new_n200_, new_n201_, new_n205_, new_n206_, new_n208_,
  ...
  nand2  g150(.a(new_n255_), .b(x57), .O(new_n305_));
  nor2   g151(.a(new_n305_), .b(new_n295_), .O(z39));
  nor3   g152(.a(new_n295_), .b(new_n286_), .c(new_n197_), .O(z42));
  nor3   g153(.a(new_n295_), .b(new_n286_), .c(new_n191_), .O(z44));
  nor3   g154(.a(new_n295_), .b(new_n286_), .c(new_n188_), .O(z45));
  nor3   g155(.a(new_n295_), .b(new_n286_), .c(new_n185_), .O(z46));
  inv1   g156(.a(x07), .O(new_n314_));
  nand2  g157(.a(x52), .b(x15), .O(new_n315_));
  oai21  g158(.a(x52), .b(new_n314_), .c(new_n315_), .O(new_n316_));
  nand3  g159(.a(new_n232_), .b(new_n154_), .c(new_n159_), .O(new_n317_));
  ...
  nand2  g166(.a(new_n323_), .b(new_n229_), .O(new_n324_));
  ...
  inv1   g172(.a(new_n229_), .O(new_n330_));
  ...
  nand2  g185(.a(new_n343_), .b(new_n318_), .O(new_n344_));
  ...
  nand3  g206(.a(new_n272_), .b(x84), .c(new_n364_), .O(new_n365_));
  inv1   g207(.a(x80), .O(new_n366_));
  nand4  g208(.a(new_n255_), .b(new_n165_), .c(new_n366_), .d(x79), .O(new_n367_));
  ...
  aoi21  g216(.a(new_n374_), .b(new_n164_), .c(new_n242_), .O(new_n375_));
  oai21  g217(.a(new_n373_), .b(new_n154_), .c(new_n375_), .O(z56));
  inv1   g218(.a(x02), .O(new_n377_));
  nand3  g219(.a(new_n243_), .b(x03), .c(new_n377_), .O(new_n378_));
  inv1   g220(.a(new_n378_), .O(z57));
  nand4  g221(.a(x80), .b(new_n235_), .c(x43), .d(new_n246_), .O(new_n380_));
  oai22  g222(.a(new_n380_), .b(new_n234_), .c(new_n246_), .d(x40), .O(new_n381_));
  nand3  g223(.a(new_n381_), .b(new_n232_), .c(x79), .O(new_n382_));
  nand3  g224(.a(new_n178_), .b(new_n246_), .c(x40), .O(new_n383_));
  ...
  oai21  g230(.a(new_n236_), .b(new_n234_), .c(new_n246_), .O(new_n389_));
  ...
  aoi21  g237(.a(new_n395_), .b(new_n239_), .c(x01), .O(z60));
  inv1   g238(.a(new_n173_), .O(new_n397_));
  nand2  g239(.a(new_n171_), .b(new_n170_), .O(new_n398_));
  aoi22  g240(.a(new_n398_), .b(new_n229_), .c(new_n165_), .d(new_n160_), .O(new_n399_));
  ...
  nor2   g260(.a(new_n250_), .b(x78), .O(new_n419_));
