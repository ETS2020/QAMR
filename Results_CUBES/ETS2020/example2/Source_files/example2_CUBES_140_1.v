...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n195_, new_n197_, new_n198_, new_n202_, new_n203_, new_n207_,
    ...
    new_n245_, new_n247_, new_n249_, new_n253_, new_n258_, new_n259_,
  ...
  nor2   g094(.a(new_n216_), .b(new_n235_), .O(new_n259_));
  inv1   g095(.a(new_n259_), .O(new_n260_));
  nand2  g096(.a(new_n260_), .b(new_n236_), .O(new_n261_));
  nand2  g097(.a(new_n259_), .b(x81), .O(new_n262_));
  aoi21  g098(.a(new_n262_), .b(new_n261_), .c(new_n239_), .O(new_n263_));
  nand2  g099(.a(new_n260_), .b(x81), .O(new_n264_));
  nand2  g100(.a(new_n259_), .b(new_n236_), .O(new_n265_));
  aoi21  g101(.a(new_n265_), .b(new_n264_), .c(new_n237_), .O(new_n266_));
  ...
  nand2  g105(.a(new_n231_), .b(x55), .O(new_n270_));
  nor2   g106(.a(new_n270_), .b(new_n267_), .O(z37));
  nand2  g107(.a(new_n231_), .b(x56), .O(new_n272_));
  nor2   g108(.a(new_n272_), .b(new_n267_), .O(z38));
  inv1   g109(.a(new_n231_), .O(new_n275_));
  nor3   g110(.a(new_n267_), .b(new_n275_), .c(new_n191_), .O(z40));
  nor3   g111(.a(new_n267_), .b(new_n275_), .c(new_n188_), .O(z41));
  nor3   g112(.a(new_n267_), .b(new_n275_), .c(new_n181_), .O(z44));
  nand2  g113(.a(new_n231_), .b(x63), .O(new_n281_));
  nor2   g114(.a(new_n281_), .b(new_n267_), .O(z45));
  nand2  g115(.a(new_n231_), .b(x64), .O(new_n283_));
  nor2   g116(.a(new_n283_), .b(new_n267_), .O(z46));
  ...
  inv1   g133(.a(new_n213_), .O(new_n302_));
  nor2   g134(.a(new_n293_), .b(new_n302_), .O(new_n303_));
  nand2  g135(.a(new_n303_), .b(x69), .O(new_n304_));
  aoi21  g136(.a(new_n304_), .b(new_n301_), .c(x01), .O(z49));
  inv1   g137(.a(x10), .O(new_n306_));
  nand2  g138(.a(x52), .b(x18), .O(new_n307_));
  oai21  g139(.a(x52), .b(new_n306_), .c(new_n307_), .O(new_n308_));
  nand2  g140(.a(new_n308_), .b(new_n290_), .O(new_n309_));
  nand2  g141(.a(new_n303_), .b(x70), .O(new_n310_));
  aoi21  g142(.a(new_n310_), .b(new_n309_), .c(x01), .O(z50));
  inv1   g143(.a(x11), .O(new_n312_));
  nand2  g144(.a(x52), .b(x19), .O(new_n313_));
  oai21  g145(.a(x52), .b(new_n312_), .c(new_n313_), .O(new_n314_));
  nand2  g146(.a(new_n314_), .b(new_n290_), .O(new_n315_));
  nand2  g147(.a(new_n303_), .b(x71), .O(new_n316_));
  aoi21  g148(.a(new_n316_), .b(new_n315_), .c(x01), .O(z51));
  inv1   g149(.a(x12), .O(new_n318_));
  nand2  g150(.a(x52), .b(x20), .O(new_n319_));
  oai21  g151(.a(x52), .b(new_n318_), .c(new_n319_), .O(new_n320_));
  nand2  g152(.a(new_n320_), .b(new_n290_), .O(new_n321_));
  nand2  g153(.a(new_n303_), .b(x72), .O(new_n322_));
  aoi21  g154(.a(new_n322_), .b(new_n321_), .c(x01), .O(z52));
  inv1   g155(.a(x13), .O(new_n324_));
  nand2  g156(.a(x52), .b(x21), .O(new_n325_));
  oai21  g157(.a(x52), .b(new_n324_), .c(new_n325_), .O(new_n326_));
  nand2  g158(.a(new_n326_), .b(new_n290_), .O(new_n327_));
  nand2  g159(.a(new_n303_), .b(x73), .O(new_n328_));
  aoi21  g160(.a(new_n328_), .b(new_n327_), .c(x01), .O(z53));
  inv1   g161(.a(x14), .O(new_n330_));
  nor2   g162(.a(x52), .b(new_n330_), .O(new_n331_));
  aoi21  g163(.a(x52), .b(x22), .c(new_n331_), .O(new_n332_));
  nand4  g164(.a(new_n166_), .b(new_n154_), .c(x04), .d(new_n153_), .O(new_n333_));
  nor2   g165(.a(new_n333_), .b(new_n332_), .O(z54));
  nand2  g166(.a(x84), .b(x83), .O(new_n335_));
  nor2   g167(.a(x80), .b(new_n154_), .O(new_n336_));
  nand3  g168(.a(new_n336_), .b(new_n231_), .c(new_n161_), .O(new_n337_));
  nor4   g169(.a(new_n337_), .b(new_n335_), .c(x82), .d(x81), .O(z55));
  nand2  g170(.a(new_n160_), .b(new_n159_), .O(new_n339_));
  nand2  g171(.a(new_n229_), .b(x76), .O(new_n340_));
  ...
  nand4  g179(.a(x80), .b(new_n218_), .c(x43), .d(new_n235_), .O(new_n349_));
  oai22  g180(.a(new_n349_), .b(new_n217_), .c(new_n235_), .d(x40), .O(new_n350_));
  nand3  g181(.a(new_n350_), .b(new_n223_), .c(x79), .O(new_n351_));
  nor2   g182(.a(x79), .b(x78), .O(new_n352_));
  nand3  g183(.a(new_n352_), .b(new_n235_), .c(x40), .O(new_n353_));
  nand2  g184(.a(new_n353_), .b(new_n351_), .O(new_n354_));
  nand2  g185(.a(new_n354_), .b(x77), .O(new_n355_));
  oai21  g186(.a(new_n166_), .b(new_n226_), .c(new_n154_), .O(new_n356_));
  aoi21  g187(.a(new_n356_), .b(new_n355_), .c(x01), .O(z58));
  inv1   g188(.a(new_n352_), .O(new_n358_));
  aoi21  g189(.a(new_n222_), .b(new_n358_), .c(new_n152_), .O(new_n359_));
  oai21  g190(.a(new_n219_), .b(new_n217_), .c(new_n235_), .O(new_n360_));
  aoi21  g191(.a(new_n360_), .b(x79), .c(new_n222_), .O(new_n361_));
  ...
  aoi21  g197(.a(new_n366_), .b(new_n224_), .c(x01), .O(z60));
  nand3  g198(.a(x84), .b(x81), .c(x79), .O(new_n369_));
  oai21  g199(.a(x79), .b(new_n226_), .c(new_n369_), .O(new_n370_));
  nand2  g200(.a(new_n370_), .b(new_n159_), .O(new_n371_));
  nand2  g201(.a(new_n360_), .b(x79), .O(new_n372_));
  nand3  g202(.a(x81), .b(x79), .c(new_n226_), .O(new_n373_));
  ...
  oai21  g210(.a(new_n168_), .b(new_n166_), .c(new_n213_), .O(new_n381_));
  oai21  g211(.a(new_n229_), .b(x04), .c(new_n381_), .O(new_n382_));
  ...
  aoi21  g216(.a(new_n386_), .b(new_n289_), .c(x01), .O(z64));
  nor2   g217(.a(new_n160_), .b(x04), .O(new_n388_));
  nor2   g218(.a(new_n236_), .b(x78), .O(new_n389_));
