// Benchmark "FAU" written by ABC on Fri Jul 10 18:24:14 2020
...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n252_, new_n255_, new_n258_, new_n260_, new_n261_, new_n262_,
    new_n263_, new_n264_, new_n265_, new_n266_, new_n267_, new_n268_,
    new_n269_, new_n270_, new_n271_, new_n273_, new_n274_, new_n275_,
    new_n276_, new_n277_, new_n278_, new_n279_, new_n280_, new_n281_,
    new_n282_, new_n284_, new_n286_, new_n290_, new_n294_, new_n299_,
  ...
  nand4  g098(.a(new_n246_), .b(new_n236_), .c(x50), .d(new_n239_), .O(new_n258_));
  inv1   g099(.a(new_n258_), .O(z32));
  nor2   g100(.a(new_n219_), .b(x81), .O(new_n260_));
  ...
  nor3   g129(.a(new_n281_), .b(new_n290_), .c(new_n193_), .O(z39));
  nor3   g130(.a(new_n281_), .b(new_n290_), .c(new_n190_), .O(z40));
  nor3   g131(.a(new_n281_), .b(new_n290_), .c(new_n187_), .O(z41));
  nand2  g132(.a(new_n236_), .b(x60), .O(new_n294_));
  nor2   g133(.a(new_n294_), .b(new_n281_), .O(z42));
  nor3   g134(.a(new_n281_), .b(new_n290_), .c(new_n183_), .O(z43));
  nor3   g135(.a(new_n281_), .b(new_n290_), .c(new_n177_), .O(z45));
  nand2  g136(.a(new_n236_), .b(x64), .O(new_n299_));
  ...
  nand3  g141(.a(new_n226_), .b(new_n154_), .c(new_n159_), .O(new_n305_));
  inv1   g142(.a(new_n305_), .O(new_n306_));
  nand2  g143(.a(new_n306_), .b(new_n304_), .O(new_n307_));
  inv1   g144(.a(new_n168_), .O(new_n308_));
  nand2  g145(.a(new_n308_), .b(x79), .O(new_n309_));
  inv1   g146(.a(new_n309_), .O(new_n310_));
  and2   g147(.a(new_n310_), .b(new_n216_), .O(new_n311_));
  ...
  nand2  g153(.a(new_n317_), .b(new_n306_), .O(new_n318_));
  nand2  g154(.a(new_n311_), .b(x70), .O(new_n319_));
  ...
  nand2  g159(.a(new_n323_), .b(new_n306_), .O(new_n324_));
  nand2  g160(.a(new_n311_), .b(x71), .O(new_n325_));
  aoi21  g161(.a(new_n325_), .b(new_n324_), .c(x01), .O(z51));
  inv1   g162(.a(x13), .O(new_n328_));
  nand2  g163(.a(x52), .b(x21), .O(new_n329_));
  oai21  g164(.a(x52), .b(new_n328_), .c(new_n329_), .O(new_n330_));
  nand2  g165(.a(new_n330_), .b(new_n306_), .O(new_n331_));
  nand2  g166(.a(new_n311_), .b(x73), .O(new_n332_));
  aoi21  g167(.a(new_n332_), .b(new_n331_), .c(x01), .O(z53));
  inv1   g168(.a(x82), .O(new_n335_));
  nand3  g169(.a(new_n260_), .b(x84), .c(new_n335_), .O(new_n336_));
  inv1   g170(.a(x80), .O(new_n337_));
  nand4  g171(.a(new_n236_), .b(new_n161_), .c(new_n337_), .d(x79), .O(new_n338_));
  nor2   g172(.a(new_n338_), .b(new_n336_), .O(z55));
  nand2  g173(.a(new_n234_), .b(x76), .O(new_n340_));
  xnor2a g174(.a(x84), .b(x81), .O(new_n341_));
  aoi21  g175(.a(new_n168_), .b(new_n167_), .c(new_n341_), .O(new_n342_));
  nand2  g176(.a(new_n342_), .b(new_n153_), .O(new_n343_));
  nand2  g177(.a(new_n343_), .b(new_n340_), .O(new_n344_));
  nand2  g178(.a(new_n344_), .b(x79), .O(new_n345_));
  nand3  g179(.a(new_n160_), .b(new_n159_), .c(new_n153_), .O(new_n346_));
  nand3  g180(.a(new_n346_), .b(new_n345_), .c(new_n232_), .O(z56));
  inv1   g181(.a(x02), .O(new_n348_));
  nand3  g182(.a(new_n232_), .b(x03), .c(new_n348_), .O(new_n349_));
  inv1   g183(.a(new_n349_), .O(z57));
  nand4  g184(.a(x80), .b(new_n221_), .c(x43), .d(new_n239_), .O(new_n351_));
  oai22  g185(.a(new_n351_), .b(new_n220_), .c(new_n239_), .d(x40), .O(new_n352_));
  nand3  g186(.a(new_n352_), .b(new_n226_), .c(x79), .O(new_n353_));
  nor2   g187(.a(x79), .b(x78), .O(new_n354_));
  nand3  g188(.a(new_n354_), .b(new_n239_), .c(x40), .O(new_n355_));
  nand2  g189(.a(new_n355_), .b(new_n353_), .O(new_n356_));
  nand2  g190(.a(new_n356_), .b(x77), .O(new_n357_));
  inv1   g191(.a(new_n167_), .O(new_n358_));
  oai21  g192(.a(new_n358_), .b(new_n229_), .c(new_n154_), .O(new_n359_));
  ...
  aoi21  g202(.a(new_n342_), .b(x79), .c(new_n366_), .O(new_n369_));
  ...
  aoi22  g206(.a(new_n372_), .b(new_n216_), .c(new_n161_), .d(new_n229_), .O(new_n373_));
  nor3   g207(.a(new_n373_), .b(new_n371_), .c(new_n337_), .O(z61));
  ...
  nand2  g218(.a(new_n384_), .b(new_n308_), .O(new_n385_));
  aoi21  g219(.a(new_n385_), .b(new_n383_), .c(x01), .O(z62));
  nor3   g220(.a(new_n373_), .b(new_n371_), .c(new_n335_), .O(z63));
  nand2  g221(.a(x83), .b(x79), .O(new_n388_));
  or2    g222(.a(new_n388_), .b(new_n373_), .O(new_n389_));
  aoi21  g223(.a(new_n389_), .b(new_n305_), .c(x01), .O(z64));
  nor2   g224(.a(new_n160_), .b(x04), .O(new_n391_));
  nor2   g225(.a(new_n243_), .b(x78), .O(new_n392_));
