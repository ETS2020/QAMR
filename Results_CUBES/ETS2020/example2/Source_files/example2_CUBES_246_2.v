...
module FAU ( 
  ...
  nand2  g085(.a(new_n251_), .b(new_n207_), .O(new_n252_));
  ...
  nand3  g089(.a(x83), .b(new_n207_), .c(x42), .O(new_n256_));
  aoi21  g090(.a(new_n256_), .b(new_n255_), .c(new_n208_), .O(new_n257_));
  oai21  g091(.a(new_n257_), .b(new_n254_), .c(new_n213_), .O(new_n258_));
  nand2  g092(.a(new_n215_), .b(x52), .O(new_n259_));
  nor2   g093(.a(new_n259_), .b(new_n258_), .O(z34));
  nand2  g094(.a(new_n215_), .b(x53), .O(new_n261_));
  ...
  nor2   g158(.a(new_n285_), .b(x01), .O(new_n329_));
  nand4  g159(.a(new_n329_), .b(new_n328_), .c(x78), .d(new_n154_), .O(new_n330_));
  nor2   g160(.a(new_n330_), .b(new_n327_), .O(z54));
  inv1   g161(.a(x82), .O(new_n332_));
  nand2  g162(.a(x84), .b(new_n332_), .O(new_n333_));
  inv1   g163(.a(new_n215_), .O(new_n334_));
  nand2  g164(.a(x83), .b(new_n207_), .O(new_n335_));
  ...
  nand4  g169(.a(x03), .b(new_n340_), .c(new_n158_), .d(x00), .O(new_n341_));
