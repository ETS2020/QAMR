...
module FAU ( 
  ...
  nand2  g132(.a(new_n238_), .b(x56), .O(new_n292_));
  nor2   g133(.a(new_n292_), .b(new_n286_), .O(z38));
  ...
  nand2  g177(.a(new_n337_), .b(new_n307_), .O(new_n338_));
  ...
  nand2  g183(.a(new_n343_), .b(new_n307_), .O(new_n344_));
  ...
  nand4  g207(.a(x80), .b(new_n223_), .c(x43), .d(new_n242_), .O(new_n369_));
  oai22  g208(.a(new_n369_), .b(new_n222_), .c(new_n242_), .d(x40), .O(new_n370_));
  nand3  g209(.a(new_n370_), .b(new_n228_), .c(x79), .O(new_n371_));
  nor2   g210(.a(x79), .b(x78), .O(new_n372_));
  nand3  g211(.a(new_n372_), .b(new_n242_), .c(x40), .O(new_n373_));
  ...
  oai21  g218(.a(new_n224_), .b(new_n222_), .c(new_n242_), .O(new_n380_));
  ...
  nand2  g240(.a(new_n401_), .b(new_n310_), .O(new_n402_));
  ...
  aoi21  g245(.a(new_n406_), .b(new_n306_), .c(x01), .O(z64));
