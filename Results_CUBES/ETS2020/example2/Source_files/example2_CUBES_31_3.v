...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n294_, new_n295_, new_n297_, new_n300_, new_n307_, new_n310_,
  ...
  nand2  g144(.a(new_n255_), .b(x55), .O(new_n300_));
  nor2   g145(.a(new_n300_), .b(new_n295_), .O(z37));
  nor3   g146(.a(new_n295_), .b(new_n286_), .c(new_n202_), .O(z39));
  nor3   g147(.a(new_n295_), .b(new_n286_), .c(new_n199_), .O(z40));
  nor3   g148(.a(new_n295_), .b(new_n286_), .c(new_n193_), .O(z42));
  nand2  g149(.a(new_n255_), .b(x61), .O(new_n307_));
  nor2   g150(.a(new_n307_), .b(new_n295_), .O(z43));
  nor3   g151(.a(new_n295_), .b(new_n286_), .c(new_n189_), .O(z44));
  nand2  g152(.a(new_n255_), .b(x63), .O(new_n310_));
  nor2   g153(.a(new_n310_), .b(new_n295_), .O(z45));
  nor3   g154(.a(new_n295_), .b(new_n286_), .c(new_n185_), .O(z46));
  ...
  nand3  g199(.a(new_n272_), .b(x84), .c(new_n358_), .O(new_n359_));
  inv1   g200(.a(x80), .O(new_n360_));
  nand4  g201(.a(new_n255_), .b(new_n165_), .c(new_n360_), .d(x79), .O(new_n361_));
  ...
  aoi21  g209(.a(new_n368_), .b(new_n164_), .c(new_n242_), .O(new_n369_));
  oai21  g210(.a(new_n367_), .b(new_n154_), .c(new_n369_), .O(z56));
  inv1   g211(.a(x02), .O(new_n371_));
  nand3  g212(.a(new_n243_), .b(x03), .c(new_n371_), .O(new_n372_));
  inv1   g213(.a(new_n372_), .O(z57));
  nand4  g214(.a(x80), .b(new_n235_), .c(x43), .d(new_n246_), .O(new_n374_));
  oai22  g215(.a(new_n374_), .b(new_n234_), .c(new_n246_), .d(x40), .O(new_n375_));
  nand3  g216(.a(new_n375_), .b(new_n232_), .c(x79), .O(new_n376_));
  nand3  g217(.a(new_n178_), .b(new_n246_), .c(x40), .O(new_n377_));
  ...
  oai21  g223(.a(new_n236_), .b(new_n234_), .c(new_n246_), .O(new_n383_));
  ...
  aoi21  g230(.a(new_n389_), .b(new_n239_), .c(x01), .O(z60));
  inv1   g231(.a(new_n173_), .O(new_n391_));
  nand2  g232(.a(new_n171_), .b(new_n170_), .O(new_n392_));
  aoi22  g233(.a(new_n392_), .b(new_n229_), .c(new_n165_), .d(new_n160_), .O(new_n393_));
