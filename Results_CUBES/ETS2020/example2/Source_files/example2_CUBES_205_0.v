...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n244_, new_n245_, new_n246_, new_n247_, new_n250_, new_n254_,
    new_n256_, new_n258_, new_n259_, new_n260_, new_n261_, new_n262_,
    new_n263_, new_n264_, new_n265_, new_n266_, new_n267_, new_n269_,
    new_n270_, new_n271_, new_n272_, new_n273_, new_n274_, new_n275_,
    new_n276_, new_n277_, new_n278_, new_n279_, new_n281_, new_n283_,
    new_n285_, new_n287_, new_n292_, new_n299_, new_n300_, new_n301_,
  ...
  nand4  g092(.a(new_n246_), .b(new_n235_), .c(x49), .d(new_n239_), .O(new_n254_));
  inv1   g093(.a(new_n254_), .O(z31));
  nand4  g094(.a(new_n246_), .b(new_n235_), .c(x50), .d(new_n239_), .O(new_n256_));
  inv1   g095(.a(new_n256_), .O(z32));
  xnor2a g096(.a(x83), .b(x81), .O(new_n258_));
  nand2  g097(.a(x42), .b(x05), .O(new_n259_));
  nand2  g098(.a(x51), .b(new_n239_), .O(new_n260_));
  oai22  g099(.a(new_n260_), .b(new_n243_), .c(new_n259_), .d(new_n258_), .O(new_n261_));
  nand2  g100(.a(new_n261_), .b(new_n241_), .O(new_n262_));
  xor2a  g101(.a(x83), .b(x81), .O(new_n263_));
  oai22  g102(.a(new_n263_), .b(new_n259_), .c(new_n260_), .d(x81), .O(new_n264_));
  nand2  g103(.a(new_n264_), .b(new_n244_), .O(new_n265_));
  inv1   g104(.a(new_n162_), .O(new_n266_));
  nand2  g105(.a(new_n235_), .b(new_n266_), .O(new_n267_));
  aoi21  g106(.a(new_n265_), .b(new_n262_), .c(new_n267_), .O(z33));
  inv1   g107(.a(x52), .O(new_n269_));
  inv1   g108(.a(new_n235_), .O(new_n270_));
  nand2  g109(.a(x83), .b(x42), .O(new_n271_));
  nand2  g110(.a(new_n271_), .b(new_n243_), .O(new_n272_));
  nand3  g111(.a(x83), .b(x81), .c(x42), .O(new_n273_));
  nand2  g112(.a(new_n273_), .b(new_n272_), .O(new_n274_));
  and2   g113(.a(new_n274_), .b(new_n244_), .O(new_n275_));
  nand2  g114(.a(new_n271_), .b(x81), .O(new_n276_));
  nand3  g115(.a(x83), .b(new_n243_), .c(x42), .O(new_n277_));
  aoi21  g116(.a(new_n277_), .b(new_n276_), .c(new_n240_), .O(new_n278_));
  oai21  g117(.a(new_n278_), .b(new_n275_), .c(new_n266_), .O(new_n279_));
  nor3   g118(.a(new_n279_), .b(new_n270_), .c(new_n269_), .O(z34));
  nand2  g119(.a(new_n235_), .b(x53), .O(new_n281_));
  nor2   g120(.a(new_n281_), .b(new_n279_), .O(z35));
  nand2  g121(.a(new_n235_), .b(x54), .O(new_n283_));
  nor2   g122(.a(new_n283_), .b(new_n279_), .O(z36));
  nand2  g123(.a(new_n235_), .b(x55), .O(new_n285_));
  nor2   g124(.a(new_n285_), .b(new_n279_), .O(z37));
  nand2  g125(.a(new_n235_), .b(x56), .O(new_n287_));
  nor2   g126(.a(new_n287_), .b(new_n279_), .O(z38));
  nor3   g127(.a(new_n279_), .b(new_n270_), .c(new_n188_), .O(z40));
  nor3   g128(.a(new_n279_), .b(new_n270_), .c(new_n185_), .O(z41));
  nand2  g129(.a(new_n235_), .b(x60), .O(new_n292_));
  nor2   g130(.a(new_n292_), .b(new_n279_), .O(z42));
  nor3   g131(.a(new_n279_), .b(new_n270_), .c(new_n181_), .O(z43));
  nor3   g132(.a(new_n279_), .b(new_n270_), .c(new_n172_), .O(z46));
  inv1   g133(.a(x08), .O(new_n299_));
  nand2  g134(.a(x52), .b(x16), .O(new_n300_));
  oai21  g135(.a(x52), .b(new_n299_), .c(new_n300_), .O(new_n301_));
  nor2   g136(.a(x79), .b(x77), .O(new_n302_));
  nand2  g137(.a(new_n302_), .b(new_n225_), .O(new_n303_));
  inv1   g138(.a(new_n303_), .O(new_n304_));
  nand2  g139(.a(new_n304_), .b(new_n301_), .O(new_n305_));
  inv1   g140(.a(new_n213_), .O(new_n306_));
  nand2  g141(.a(new_n306_), .b(x79), .O(new_n307_));
  inv1   g142(.a(new_n307_), .O(new_n308_));
  and2   g143(.a(new_n308_), .b(new_n215_), .O(new_n309_));
  nand2  g144(.a(new_n309_), .b(x68), .O(new_n310_));
  aoi21  g145(.a(new_n310_), .b(new_n305_), .c(x01), .O(z48));
  inv1   g146(.a(x09), .O(new_n312_));
  ...
  nand2  g150(.a(new_n309_), .b(x69), .O(new_n316_));
  aoi21  g151(.a(new_n316_), .b(new_n315_), .c(x01), .O(z49));
  inv1   g152(.a(x10), .O(new_n318_));
  nand2  g153(.a(x52), .b(x18), .O(new_n319_));
  oai21  g154(.a(x52), .b(new_n318_), .c(new_n319_), .O(new_n320_));
  nand2  g155(.a(new_n320_), .b(new_n304_), .O(new_n321_));
  nand2  g156(.a(new_n309_), .b(x70), .O(new_n322_));
  aoi21  g157(.a(new_n322_), .b(new_n321_), .c(x01), .O(z50));
  inv1   g158(.a(x12), .O(new_n325_));
  nand2  g159(.a(x52), .b(x20), .O(new_n326_));
  oai21  g160(.a(x52), .b(new_n325_), .c(new_n326_), .O(new_n327_));
  nand2  g161(.a(new_n327_), .b(new_n304_), .O(new_n328_));
  nand2  g162(.a(new_n309_), .b(x72), .O(new_n329_));
  aoi21  g163(.a(new_n329_), .b(new_n328_), .c(x01), .O(z52));
  inv1   g164(.a(x13), .O(new_n331_));
  nand2  g165(.a(x52), .b(x21), .O(new_n332_));
  oai21  g166(.a(x52), .b(new_n331_), .c(new_n332_), .O(new_n333_));
  nand2  g167(.a(new_n333_), .b(new_n304_), .O(new_n334_));
  nand2  g168(.a(new_n309_), .b(x73), .O(new_n335_));
  aoi21  g169(.a(new_n335_), .b(new_n334_), .c(x01), .O(z53));
  nand2  g170(.a(x52), .b(x22), .O(new_n337_));
  nand2  g171(.a(new_n269_), .b(x14), .O(new_n338_));
  inv1   g172(.a(new_n212_), .O(new_n339_));
  nand4  g173(.a(new_n339_), .b(new_n154_), .c(x04), .d(new_n153_), .O(new_n340_));
  aoi21  g174(.a(new_n338_), .b(new_n337_), .c(new_n340_), .O(z54));
  nand2  g175(.a(new_n233_), .b(x76), .O(new_n343_));
  xnor2a g176(.a(x84), .b(x81), .O(new_n344_));
  aoi21  g177(.a(new_n213_), .b(new_n212_), .c(new_n344_), .O(new_n345_));
  nand2  g178(.a(new_n345_), .b(new_n153_), .O(new_n346_));
  nand2  g179(.a(new_n346_), .b(new_n343_), .O(new_n347_));
  nand2  g180(.a(new_n347_), .b(x79), .O(new_n348_));
  nand3  g181(.a(new_n160_), .b(new_n159_), .c(new_n153_), .O(new_n349_));
  nand3  g182(.a(new_n349_), .b(new_n348_), .c(new_n231_), .O(z56));
  inv1   g183(.a(x02), .O(new_n351_));
  nand3  g184(.a(new_n231_), .b(x03), .c(new_n351_), .O(new_n352_));
  inv1   g185(.a(new_n352_), .O(z57));
  nand4  g186(.a(x80), .b(new_n220_), .c(x43), .d(new_n239_), .O(new_n354_));
  oai22  g187(.a(new_n354_), .b(new_n219_), .c(new_n239_), .d(x40), .O(new_n355_));
  nand3  g188(.a(new_n355_), .b(new_n225_), .c(x79), .O(new_n356_));
  nor2   g189(.a(x79), .b(x78), .O(new_n357_));
  nand3  g190(.a(new_n357_), .b(new_n239_), .c(x40), .O(new_n358_));
  nand2  g191(.a(new_n358_), .b(new_n356_), .O(new_n359_));
  nand2  g192(.a(new_n359_), .b(x77), .O(new_n360_));
  oai21  g193(.a(new_n339_), .b(new_n228_), .c(new_n154_), .O(new_n361_));
  aoi21  g194(.a(new_n361_), .b(new_n360_), .c(x01), .O(z58));
  inv1   g195(.a(new_n357_), .O(new_n363_));
  aoi21  g196(.a(new_n224_), .b(new_n363_), .c(new_n152_), .O(new_n364_));
  oai21  g197(.a(new_n221_), .b(new_n219_), .c(new_n239_), .O(new_n365_));
  aoi21  g198(.a(new_n365_), .b(x79), .c(new_n224_), .O(new_n366_));
  oai21  g199(.a(new_n366_), .b(new_n364_), .c(x77), .O(new_n367_));
  nor2   g200(.a(x79), .b(x04), .O(new_n368_));
  inv1   g201(.a(new_n368_), .O(new_n369_));
  aoi21  g202(.a(new_n369_), .b(new_n367_), .c(x01), .O(z59));
  aoi21  g203(.a(new_n345_), .b(x79), .c(new_n368_), .O(new_n371_));
  aoi21  g204(.a(new_n371_), .b(new_n226_), .c(x01), .O(z60));
  nand2  g205(.a(new_n213_), .b(new_n212_), .O(new_n373_));
  aoi22  g206(.a(new_n373_), .b(new_n215_), .c(new_n161_), .d(new_n228_), .O(new_n374_));
  nor2   g207(.a(new_n154_), .b(x01), .O(new_n375_));
  nand2  g208(.a(new_n375_), .b(x80), .O(new_n376_));
  nor2   g209(.a(new_n376_), .b(new_n374_), .O(z61));
  nand3  g210(.a(x84), .b(x81), .c(x79), .O(new_n378_));
  oai21  g211(.a(x79), .b(new_n228_), .c(new_n378_), .O(new_n379_));
  nand2  g212(.a(new_n379_), .b(new_n159_), .O(new_n380_));
  nand2  g213(.a(new_n365_), .b(x79), .O(new_n381_));
  nand3  g214(.a(x81), .b(x79), .c(new_n228_), .O(new_n382_));
  ...
  nand2  g222(.a(new_n375_), .b(x82), .O(new_n390_));
  nor2   g223(.a(new_n390_), .b(new_n374_), .O(z63));
  nand2  g224(.a(x83), .b(x79), .O(new_n392_));
  or2    g225(.a(new_n392_), .b(new_n374_), .O(new_n393_));
  aoi21  g226(.a(new_n393_), .b(new_n303_), .c(x01), .O(z64));
  nor2   g227(.a(new_n160_), .b(x04), .O(new_n395_));
  nor2   g228(.a(new_n243_), .b(x78), .O(new_n396_));
  oai21  g229(.a(new_n396_), .b(new_n395_), .c(x77), .O(new_n397_));
  nand2  g230(.a(new_n339_), .b(x81), .O(new_n398_));
  nand2  g231(.a(new_n375_), .b(x84), .O(new_n399_));
  aoi21  g232(.a(new_n398_), .b(new_n397_), .c(new_n399_), .O(z65));
  zero   g233(.O(z02));
  zero   g234(.O(z10));
  zero   g235(.O(z13));
  zero   g236(.O(z16));
