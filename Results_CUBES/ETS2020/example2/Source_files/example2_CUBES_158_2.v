...
module FAU ( 
  ...
  wire new_n154_, new_n155_, new_n156_, new_n157_, new_n158_, new_n159_,
    ...
    new_n279_, new_n282_, new_n284_, new_n286_, new_n287_, new_n288_,
    new_n289_, new_n290_, new_n291_, new_n292_, new_n293_, new_n294_,
    new_n295_, new_n297_, new_n298_, new_n299_, new_n300_, new_n301_,
    new_n303_, new_n304_, new_n305_, new_n306_, new_n307_, new_n309_,
    new_n310_, new_n311_, new_n312_, new_n313_, new_n315_, new_n316_,
    new_n317_, new_n318_, new_n319_, new_n322_, new_n323_, new_n324_,
    new_n325_, new_n326_, new_n331_, new_n332_, new_n337_, new_n338_,
    new_n339_;
  ...
  xnor2a g085(.a(x84), .b(x82), .O(new_n252_));
  nand2  g086(.a(x83), .b(x42), .O(new_n253_));
  nand2  g087(.a(new_n253_), .b(new_n213_), .O(new_n254_));
  nand3  g088(.a(x83), .b(x81), .c(x42), .O(new_n255_));
  aoi21  g089(.a(new_n255_), .b(new_n254_), .c(new_n252_), .O(new_n256_));
  nand2  g090(.a(new_n253_), .b(x81), .O(new_n257_));
  nand3  g091(.a(x83), .b(new_n213_), .c(x42), .O(new_n258_));
  aoi21  g092(.a(new_n258_), .b(new_n257_), .c(new_n214_), .O(new_n259_));
  oai21  g093(.a(new_n259_), .b(new_n256_), .c(new_n219_), .O(new_n260_));
  nand2  g094(.a(new_n210_), .b(x52), .O(new_n261_));
  nor2   g095(.a(new_n261_), .b(new_n260_), .O(z34));
  nand2  g096(.a(new_n210_), .b(x53), .O(new_n263_));
  nor2   g097(.a(new_n263_), .b(new_n260_), .O(z35));
  nand2  g098(.a(new_n210_), .b(x54), .O(new_n265_));
  nor2   g099(.a(new_n265_), .b(new_n260_), .O(z36));
  nand2  g100(.a(new_n210_), .b(x55), .O(new_n267_));
  nor2   g101(.a(new_n267_), .b(new_n260_), .O(z37));
  nand2  g102(.a(new_n210_), .b(x56), .O(new_n269_));
  nor2   g103(.a(new_n269_), .b(new_n260_), .O(z38));
  nand2  g104(.a(new_n210_), .b(x57), .O(new_n271_));
  nor2   g105(.a(new_n271_), .b(new_n260_), .O(z39));
  nand2  g106(.a(new_n210_), .b(x58), .O(new_n273_));
  nor2   g107(.a(new_n273_), .b(new_n260_), .O(z40));
  nand2  g108(.a(new_n210_), .b(x59), .O(new_n275_));
  nor2   g109(.a(new_n275_), .b(new_n260_), .O(z41));
  nand2  g110(.a(new_n210_), .b(x60), .O(new_n277_));
  nor2   g111(.a(new_n277_), .b(new_n260_), .O(z42));
  nand2  g112(.a(new_n210_), .b(x61), .O(new_n279_));
  nor2   g113(.a(new_n279_), .b(new_n260_), .O(z43));
  nand2  g114(.a(new_n210_), .b(x63), .O(new_n282_));
  nor2   g115(.a(new_n282_), .b(new_n260_), .O(z45));
  nand2  g116(.a(new_n210_), .b(x64), .O(new_n284_));
  nor2   g117(.a(new_n284_), .b(new_n260_), .O(z46));
  inv1   g118(.a(x07), .O(new_n286_));
  nand2  g119(.a(x52), .b(x15), .O(new_n287_));
  oai21  g120(.a(x52), .b(new_n286_), .c(new_n287_), .O(new_n288_));
  inv1   g121(.a(x04), .O(new_n289_));
  nor2   g122(.a(x77), .b(new_n289_), .O(new_n290_));
  nor2   g123(.a(x79), .b(new_n154_), .O(new_n291_));
  nand3  g124(.a(new_n291_), .b(new_n290_), .c(new_n288_), .O(new_n292_));
  ...
  nand3  g132(.a(new_n299_), .b(new_n291_), .c(new_n290_), .O(new_n300_));
  ...
  nand3  g138(.a(new_n305_), .b(new_n291_), .c(new_n290_), .O(new_n306_));
  ...
  nand3  g144(.a(new_n311_), .b(new_n291_), .c(new_n290_), .O(new_n312_));
  ...
  nand3  g150(.a(new_n317_), .b(new_n291_), .c(new_n290_), .O(new_n318_));
  ...
  nand3  g156(.a(new_n324_), .b(new_n291_), .c(new_n290_), .O(new_n325_));
  nand4  g157(.a(new_n293_), .b(new_n158_), .c(x79), .d(x73), .O(new_n326_));
  ...
  oai21  g162(.a(new_n158_), .b(new_n155_), .c(new_n293_), .O(new_n337_));
  nand3  g163(.a(x78), .b(x77), .c(new_n289_), .O(new_n338_));
  nand3  g164(.a(x80), .b(x79), .c(new_n160_), .O(new_n339_));
  aoi21  g165(.a(new_n338_), .b(new_n337_), .c(new_n339_), .O(z61));
  zero   g166(.O(z00));
  zero   g167(.O(z01));
  zero   g168(.O(z03));
  zero   g169(.O(z04));
