...
module FAU ( 
  ...
  wire new_n154_, new_n155_, new_n156_, new_n157_, new_n158_, new_n159_,
    ...
    new_n335_, new_n340_, new_n341_, new_n342_;
  ...
  nor2   g045(.a(new_n154_), .b(new_n157_), .O(new_n208_));
  ...
  aoi21  g050(.a(new_n209_), .b(x79), .c(new_n212_), .O(z24));
  ...
  nand3  g059(.a(new_n211_), .b(new_n221_), .c(x05), .O(new_n222_));
  inv1   g060(.a(new_n222_), .O(new_n223_));
  nand3  g061(.a(new_n223_), .b(new_n220_), .c(new_n218_), .O(new_n224_));
  inv1   g062(.a(new_n224_), .O(z25));
  nand3  g063(.a(new_n211_), .b(x45), .c(new_n221_), .O(new_n227_));
  inv1   g064(.a(new_n227_), .O(new_n228_));
  nand3  g065(.a(new_n228_), .b(new_n220_), .c(new_n218_), .O(new_n229_));
  inv1   g066(.a(new_n229_), .O(z27));
  nand3  g067(.a(new_n211_), .b(x46), .c(new_n221_), .O(new_n231_));
  inv1   g068(.a(new_n231_), .O(new_n232_));
  nand3  g069(.a(new_n232_), .b(new_n220_), .c(new_n218_), .O(new_n233_));
  inv1   g070(.a(new_n233_), .O(z28));
  nand3  g071(.a(new_n211_), .b(x47), .c(new_n221_), .O(new_n235_));
  inv1   g072(.a(new_n235_), .O(new_n236_));
  nand3  g073(.a(new_n236_), .b(new_n220_), .c(new_n218_), .O(new_n237_));
  inv1   g074(.a(new_n237_), .O(z29));
  nand3  g075(.a(new_n211_), .b(x49), .c(new_n221_), .O(new_n240_));
  ...
  nand2  g088(.a(new_n220_), .b(new_n211_), .O(new_n254_));
  ...
  nand2  g099(.a(new_n211_), .b(x52), .O(new_n265_));
  nor2   g100(.a(new_n265_), .b(new_n264_), .O(z34));
  nand2  g101(.a(new_n211_), .b(x53), .O(new_n267_));
  nor2   g102(.a(new_n267_), .b(new_n264_), .O(z35));
  nand2  g103(.a(new_n211_), .b(x54), .O(new_n269_));
  nor2   g104(.a(new_n269_), .b(new_n264_), .O(z36));
  nand2  g105(.a(new_n211_), .b(x55), .O(new_n271_));
  nor2   g106(.a(new_n271_), .b(new_n264_), .O(z37));
  nand2  g107(.a(new_n211_), .b(x56), .O(new_n273_));
  nor2   g108(.a(new_n273_), .b(new_n264_), .O(z38));
  nand2  g109(.a(new_n211_), .b(x57), .O(new_n275_));
  nor2   g110(.a(new_n275_), .b(new_n264_), .O(z39));
  nand2  g111(.a(new_n211_), .b(x58), .O(new_n277_));
  nor2   g112(.a(new_n277_), .b(new_n264_), .O(z40));
  nand2  g113(.a(new_n211_), .b(x59), .O(new_n279_));
  nor2   g114(.a(new_n279_), .b(new_n264_), .O(z41));
  nand2  g115(.a(new_n211_), .b(x60), .O(new_n281_));
  nor2   g116(.a(new_n281_), .b(new_n264_), .O(z42));
  nand2  g117(.a(new_n211_), .b(x62), .O(new_n284_));
  nor2   g118(.a(new_n284_), .b(new_n264_), .O(z44));
  nand2  g119(.a(new_n211_), .b(x63), .O(new_n286_));
  nor2   g120(.a(new_n286_), .b(new_n264_), .O(z45));
  nand2  g121(.a(new_n211_), .b(x64), .O(new_n288_));
  nor2   g122(.a(new_n288_), .b(new_n264_), .O(z46));
  ...
  nand3  g128(.a(new_n294_), .b(new_n292_), .c(new_n163_), .O(new_n295_));
  xnor2a g129(.a(x84), .b(x81), .O(new_n296_));
  or2    g130(.a(x75), .b(x67), .O(new_n297_));
  nand4  g131(.a(new_n297_), .b(new_n296_), .c(new_n158_), .d(x79), .O(new_n298_));
  aoi21  g132(.a(new_n298_), .b(new_n295_), .c(x01), .O(z47));
  inv1   g133(.a(x09), .O(new_n301_));
  nand2  g134(.a(x52), .b(x17), .O(new_n302_));
  oai21  g135(.a(x52), .b(new_n301_), .c(new_n302_), .O(new_n303_));
  nand3  g136(.a(new_n303_), .b(new_n294_), .c(new_n163_), .O(new_n304_));
  nand4  g137(.a(new_n296_), .b(new_n158_), .c(x79), .d(x69), .O(new_n305_));
  aoi21  g138(.a(new_n305_), .b(new_n304_), .c(x01), .O(z49));
  inv1   g139(.a(x10), .O(new_n307_));
  nand2  g140(.a(x52), .b(x18), .O(new_n308_));
  oai21  g141(.a(x52), .b(new_n307_), .c(new_n308_), .O(new_n309_));
  nand3  g142(.a(new_n309_), .b(new_n294_), .c(new_n163_), .O(new_n310_));
  nand4  g143(.a(new_n296_), .b(new_n158_), .c(x79), .d(x70), .O(new_n311_));
  aoi21  g144(.a(new_n311_), .b(new_n310_), .c(x01), .O(z50));
  inv1   g145(.a(x12), .O(new_n314_));
  nand2  g146(.a(x52), .b(x20), .O(new_n315_));
  oai21  g147(.a(x52), .b(new_n314_), .c(new_n315_), .O(new_n316_));
  nand3  g148(.a(new_n316_), .b(new_n294_), .c(new_n163_), .O(new_n317_));
  nand4  g149(.a(new_n296_), .b(new_n158_), .c(x79), .d(x72), .O(new_n318_));
  aoi21  g150(.a(new_n318_), .b(new_n317_), .c(x01), .O(z52));
  inv1   g151(.a(x13), .O(new_n320_));
  nand2  g152(.a(x52), .b(x21), .O(new_n321_));
  oai21  g153(.a(x52), .b(new_n320_), .c(new_n321_), .O(new_n322_));
  nand3  g154(.a(new_n322_), .b(new_n294_), .c(new_n163_), .O(new_n323_));
  nand4  g155(.a(new_n296_), .b(new_n158_), .c(x79), .d(x73), .O(new_n324_));
  aoi21  g156(.a(new_n324_), .b(new_n323_), .c(x01), .O(z53));
  inv1   g157(.a(x82), .O(new_n327_));
  nand2  g158(.a(x84), .b(new_n327_), .O(new_n328_));
  nand2  g159(.a(x83), .b(new_n214_), .O(new_n329_));
  inv1   g160(.a(x80), .O(new_n330_));
  nand4  g161(.a(new_n211_), .b(new_n208_), .c(new_n330_), .d(x79), .O(new_n331_));
  nor3   g162(.a(new_n331_), .b(new_n329_), .c(new_n328_), .O(z55));
  inv1   g163(.a(x02), .O(new_n334_));
  nand4  g164(.a(x03), .b(new_n334_), .c(new_n160_), .d(x00), .O(new_n335_));
  inv1   g165(.a(new_n335_), .O(z57));
  oai21  g166(.a(new_n158_), .b(new_n155_), .c(new_n296_), .O(new_n340_));
  nand2  g167(.a(new_n208_), .b(new_n293_), .O(new_n341_));
  nand3  g168(.a(x80), .b(x79), .c(new_n160_), .O(new_n342_));
  aoi21  g169(.a(new_n341_), .b(new_n340_), .c(new_n342_), .O(z61));
  zero   g170(.O(z00));
  zero   g171(.O(z01));
  zero   g172(.O(z04));
  zero   g173(.O(z07));
