...
module FAU ( 
  ...
  wire new_n154_, new_n155_, new_n156_, new_n157_, new_n158_, new_n159_,
    ...
    new_n201_, new_n202_, new_n205_, new_n206_, new_n211_, new_n212_,
    new_n213_, new_n214_, new_n215_, new_n216_, new_n217_, new_n218_,
    new_n219_, new_n220_, new_n221_, new_n222_, new_n224_, new_n225_,
    new_n226_, new_n228_, new_n229_, new_n230_, new_n235_, new_n236_,
  ...
  nand3  g069(.a(new_n219_), .b(x49), .c(new_n218_), .O(new_n235_));
  inv1   g070(.a(new_n235_), .O(new_n236_));
  nand3  g071(.a(new_n236_), .b(new_n217_), .c(new_n215_), .O(new_n237_));
  ...
  nand2  g113(.a(new_n219_), .b(x64), .O(new_n283_));
  ...
  inv1   g158(.a(new_n219_), .O(new_n330_));
  nand2  g159(.a(x83), .b(new_n211_), .O(new_n331_));
  ...
  inv1   g168(.a(new_n161_), .O(new_n344_));
  nand2  g169(.a(new_n344_), .b(x80), .O(new_n345_));
  aoi21  g170(.a(new_n343_), .b(new_n342_), .c(new_n345_), .O(z61));
  nand2  g171(.a(new_n344_), .b(x82), .O(new_n348_));
  aoi21  g172(.a(new_n343_), .b(new_n342_), .c(new_n348_), .O(z63));
  zero   g173(.O(z00));
  zero   g174(.O(z01));
  zero   g175(.O(z03));
  zero   g176(.O(z04));
