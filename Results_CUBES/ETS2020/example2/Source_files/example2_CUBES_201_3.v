...
module FAU ( 
  ...
  wire new_n152_, new_n153_, new_n154_, new_n155_, new_n156_, new_n157_,
    ...
    new_n309_, new_n313_, new_n315_, new_n316_, new_n317_, new_n318_,
  ...
  nand2  g143(.a(new_n256_), .b(x54), .O(new_n299_));
  ...
  nor3   g149(.a(new_n295_), .b(new_n286_), .c(new_n203_), .O(z39));
  nor3   g150(.a(new_n295_), .b(new_n286_), .c(new_n197_), .O(z41));
  nor3   g151(.a(new_n295_), .b(new_n286_), .c(new_n194_), .O(z42));
  nand2  g152(.a(new_n256_), .b(x61), .O(new_n309_));
  nor2   g153(.a(new_n309_), .b(new_n295_), .O(z43));
  nor3   g154(.a(new_n295_), .b(new_n286_), .c(new_n190_), .O(z44));
  nor3   g155(.a(new_n295_), .b(new_n286_), .c(new_n187_), .O(z45));
  nand2  g156(.a(new_n256_), .b(x64), .O(new_n313_));
  nor2   g157(.a(new_n313_), .b(new_n295_), .O(z46));
  ...
  nand2  g202(.a(new_n285_), .b(x14), .O(new_n360_));
  ...
  inv1   g206(.a(new_n272_), .O(new_n364_));
  ...
  nand3  g227(.a(new_n179_), .b(new_n247_), .c(x40), .O(new_n385_));
  ...
  aoi21  g232(.a(new_n163_), .b(new_n180_), .c(new_n152_), .O(new_n390_));
  ...
  nand3  g259(.a(new_n176_), .b(new_n159_), .c(x04), .O(new_n418_));
