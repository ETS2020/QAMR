...
module FAU ( 
  ...
  nand4  g22(.a(new_n51_), .b(x12), .c(new_n49_), .d(x09), .O(new_n52_));
  ...
  oai21  g28(.a(new_n45_), .b(new_n57_), .c(new_n31_), .O(new_n58_));
  nand2  g29(.a(new_n58_), .b(x12), .O(new_n59_));
  nand2  g30(.a(new_n32_), .b(new_n31_), .O(new_n60_));
  aoi21  g31(.a(new_n60_), .b(new_n59_), .c(new_n56_), .O(z09));
  ...
  nand2  g36(.a(new_n54_), .b(x11), .O(new_n66_));
  nand4  g37(.a(new_n45_), .b(x12), .c(x09), .d(x01), .O(new_n67_));
  aoi21  g38(.a(new_n67_), .b(new_n65_), .c(new_n66_), .O(z11));
  nand3  g39(.a(x12), .b(x11), .c(new_n57_), .O(new_n69_));
