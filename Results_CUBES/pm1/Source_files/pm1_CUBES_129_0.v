// Benchmark "FAU" written by ABC on Mon Jul  6 14:06:31 2020
...
module FAU ( 
  ...
  aoi21  g27(.a(new_n55_), .b(new_n53_), .c(new_n56_), .O(new_n57_));
  nand4  g28(.a(new_n57_), .b(z01), .c(new_n51_), .d(x00), .O(z08));
  inv1   g29(.a(new_n56_), .O(new_n59_));
  nand3  g30(.a(x12), .b(x11), .c(x00), .O(new_n60_));
  aoi21  g31(.a(new_n60_), .b(new_n59_), .c(x10), .O(z09));
  nand2  g32(.a(new_n51_), .b(x00), .O(new_n62_));
  nand3  g33(.a(x04), .b(x03), .c(x02), .O(new_n63_));
  nand2  g34(.a(new_n63_), .b(x12), .O(new_n64_));
  nand2  g35(.a(x11), .b(x09), .O(new_n65_));
  nor3   g36(.a(new_n65_), .b(new_n64_), .c(new_n62_), .O(z10));
  nand3  g37(.a(x09), .b(x01), .c(x00), .O(new_n67_));
  inv1   g38(.a(new_n67_), .O(new_n68_));
  nand3  g39(.a(new_n68_), .b(new_n63_), .c(x12), .O(new_n69_));
  nand2  g40(.a(new_n32_), .b(new_n30_), .O(new_n70_));
  nand2  g41(.a(x11), .b(new_n51_), .O(new_n71_));
  aoi21  g42(.a(new_n70_), .b(new_n69_), .c(new_n71_), .O(z11));
  inv1   g43(.a(x09), .O(new_n73_));
  nand3  g44(.a(x12), .b(x11), .c(new_n73_), .O(new_n74_));
  nor2   g45(.a(new_n74_), .b(new_n62_), .O(z12));
endmodule
