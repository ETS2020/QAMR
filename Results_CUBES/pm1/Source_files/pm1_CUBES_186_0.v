...
module FAU ( 
  ...
  nand4  g24(.a(x12), .b(x11), .c(x04), .d(x03), .O(new_n54_));
  inv1   g25(.a(new_n54_), .O(new_n55_));
  nand4  g26(.a(new_n55_), .b(new_n53_), .c(x02), .d(x00), .O(new_n56_));
  inv1   g27(.a(x10), .O(new_n57_));
  nand2  g28(.a(new_n57_), .b(x00), .O(new_n58_));
  inv1   g29(.a(new_n58_), .O(new_n59_));
  nand3  g30(.a(new_n59_), .b(new_n56_), .c(x11), .O(z08));
  nand3  g31(.a(new_n47_), .b(x03), .c(x02), .O(new_n61_));
  aoi21  g32(.a(new_n61_), .b(x11), .c(new_n47_), .O(new_n62_));
  nand2  g33(.a(x11), .b(new_n52_), .O(new_n63_));
  ...
  aoi21  g37(.a(new_n66_), .b(new_n65_), .c(new_n58_), .O(z09));
  nand2  g38(.a(new_n45_), .b(x11), .O(new_n68_));
  aoi21  g39(.a(new_n68_), .b(x04), .c(new_n32_), .O(new_n69_));
  nand2  g40(.a(new_n59_), .b(x09), .O(new_n70_));
  inv1   g41(.a(new_n70_), .O(new_n71_));
  and2   g42(.a(new_n71_), .b(new_n69_), .O(z10));
  nand3  g43(.a(new_n69_), .b(x09), .c(x01), .O(new_n73_));
  nand3  g44(.a(new_n32_), .b(x11), .c(new_n30_), .O(new_n74_));
  aoi21  g45(.a(new_n74_), .b(new_n73_), .c(new_n58_), .O(z11));
  nor3   g46(.a(new_n63_), .b(new_n58_), .c(new_n32_), .O(z12));
endmodule
