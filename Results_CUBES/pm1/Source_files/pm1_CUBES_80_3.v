...
module FAU ( 
  ...
  wire new_n30_, new_n31_, new_n32_, new_n35_, new_n36_, new_n37_, new_n38_,
    new_n39_, new_n41_, new_n45_, new_n46_, new_n47_, new_n50_, new_n52_,
  ...
  nand2  g22(.a(new_n50_), .b(x00), .O(new_n52_));
  xor2a  g23(.a(x12), .b(x11), .O(new_n53_));
  nor2   g24(.a(new_n53_), .b(new_n52_), .O(z09));
  nand3  g25(.a(x12), .b(x11), .c(x09), .O(new_n55_));
  nor2   g26(.a(new_n55_), .b(new_n52_), .O(z10));
  nand3  g27(.a(x12), .b(x09), .c(x01), .O(new_n57_));
  nand2  g28(.a(new_n32_), .b(new_n30_), .O(new_n58_));
  nand3  g29(.a(x11), .b(new_n50_), .c(x00), .O(new_n59_));
  aoi21  g30(.a(new_n58_), .b(new_n57_), .c(new_n59_), .O(z11));
  inv1   g31(.a(x09), .O(new_n61_));
  nand3  g32(.a(x12), .b(x11), .c(new_n61_), .O(new_n62_));
  nor2   g33(.a(new_n62_), .b(new_n52_), .O(z12));
endmodule
