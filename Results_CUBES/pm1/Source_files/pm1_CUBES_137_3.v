// Benchmark "FAU" written by ABC on Mon Jul  6 14:06:35 2020
...
module FAU ( 
  ...
  nand2  g41(.a(new_n57_), .b(x11), .O(new_n71_));
  nand4  g42(.a(new_n60_), .b(x12), .c(x09), .d(x01), .O(new_n72_));
  aoi21  g43(.a(new_n72_), .b(new_n70_), .c(new_n71_), .O(z11));
