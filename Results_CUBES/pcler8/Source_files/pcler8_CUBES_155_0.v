...
module FAU ( 
  ...
  nor2   g21(.a(new_n59_), .b(new_n65_), .O(z05));
  ...
  nand3  g32(.a(new_n76_), .b(x09), .c(new_n59_), .O(new_n77_));
  ...
  oai22  g40(.a(new_n84_), .b(new_n77_), .c(new_n59_), .d(new_n58_), .O(z10));
  ...
  oai21  g48(.a(new_n92_), .b(new_n77_), .c(new_n61_), .O(z11));
  inv1   g49(.a(x21), .O(new_n94_));
  inv1   g50(.a(x20), .O(new_n95_));
  nand2  g51(.a(x22), .b(new_n95_), .O(new_n96_));
  inv1   g52(.a(x22), .O(new_n97_));
  nand4  g53(.a(new_n97_), .b(x20), .c(x19), .d(new_n59_), .O(new_n98_));
  aoi21  g54(.a(new_n98_), .b(new_n96_), .c(new_n94_), .O(new_n99_));
  nand2  g55(.a(x23), .b(x14), .O(new_n100_));
  nor2   g56(.a(new_n94_), .b(new_n52_), .O(new_n101_));
  oai21  g57(.a(new_n100_), .b(new_n86_), .c(new_n101_), .O(new_n102_));
  nor2   g58(.a(new_n97_), .b(x08), .O(new_n103_));
  aoi21  g59(.a(new_n103_), .b(new_n102_), .c(new_n99_), .O(new_n104_));
  nand2  g60(.a(new_n76_), .b(x09), .O(new_n105_));
  oai21  g61(.a(new_n105_), .b(new_n104_), .c(new_n63_), .O(z12));
  inv1   g62(.a(x23), .O(new_n107_));
  nand4  g63(.a(x26), .b(x25), .c(x24), .d(x15), .O(new_n108_));
  nand4  g64(.a(x22), .b(x21), .c(x20), .d(x19), .O(new_n109_));
  inv1   g65(.a(new_n109_), .O(new_n110_));
  aoi21  g66(.a(new_n110_), .b(new_n108_), .c(new_n107_), .O(new_n111_));
  nand3  g67(.a(new_n107_), .b(x22), .c(x21), .O(new_n112_));
  nor2   g68(.a(new_n112_), .b(new_n88_), .O(new_n113_));
  oai21  g69(.a(new_n113_), .b(new_n111_), .c(new_n78_), .O(new_n114_));
  oai21  g70(.a(new_n59_), .b(new_n65_), .c(new_n114_), .O(z13));
  nand3  g71(.a(x26), .b(x25), .c(x16), .O(new_n116_));
  nand3  g72(.a(x21), .b(x20), .c(x19), .O(new_n117_));
  inv1   g73(.a(new_n117_), .O(new_n118_));
  nand4  g74(.a(new_n118_), .b(new_n116_), .c(x23), .d(x22), .O(new_n119_));
  nand2  g75(.a(x23), .b(x22), .O(new_n120_));
  nor3   g76(.a(new_n117_), .b(new_n120_), .c(x24), .O(new_n121_));
  aoi21  g77(.a(new_n119_), .b(x24), .c(new_n121_), .O(new_n122_));
  oai22  g78(.a(new_n122_), .b(new_n77_), .c(new_n59_), .d(new_n67_), .O(z14));
  nand2  g79(.a(x26), .b(x17), .O(new_n124_));
  nand3  g80(.a(x24), .b(x23), .c(x22), .O(new_n125_));
  inv1   g81(.a(new_n125_), .O(new_n126_));
  nand3  g82(.a(new_n126_), .b(new_n124_), .c(new_n118_), .O(new_n127_));
  inv1   g83(.a(x25), .O(new_n128_));
  nand4  g84(.a(new_n128_), .b(x24), .c(x23), .d(x22), .O(new_n129_));
  inv1   g85(.a(new_n129_), .O(new_n130_));
  aoi22  g86(.a(new_n130_), .b(new_n118_), .c(new_n127_), .d(x25), .O(new_n131_));
  oai21  g87(.a(new_n131_), .b(new_n77_), .c(new_n69_), .O(z15));
  nor2   g88(.a(new_n52_), .b(x18), .O(new_n133_));
  nand3  g89(.a(new_n133_), .b(new_n49_), .c(new_n45_), .O(new_n134_));
  inv1   g90(.a(x26), .O(new_n135_));
  nand4  g91(.a(new_n135_), .b(x25), .c(x22), .d(x21), .O(new_n136_));
  nand4  g92(.a(x24), .b(x23), .c(x20), .d(x19), .O(new_n137_));
  nor2   g93(.a(new_n137_), .b(new_n136_), .O(new_n138_));
  aoi21  g94(.a(new_n134_), .b(x26), .c(new_n138_), .O(new_n139_));
  oai21  g95(.a(new_n139_), .b(new_n77_), .c(new_n71_), .O(z16));
endmodule
