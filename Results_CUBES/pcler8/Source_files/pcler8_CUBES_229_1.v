...
module FAU ( 
  ...
  inv1   g27(.a(x11), .O(new_n72_));
  nor3   g28(.a(new_n51_), .b(new_n45_), .c(new_n72_), .O(new_n73_));
  inv1   g29(.a(x10), .O(new_n74_));
  nand2  g30(.a(new_n48_), .b(new_n74_), .O(new_n75_));
  inv1   g31(.a(new_n75_), .O(new_n76_));
  oai21  g32(.a(new_n73_), .b(new_n49_), .c(new_n76_), .O(new_n77_));
  ...
  oai22  g38(.a(new_n82_), .b(new_n75_), .c(new_n58_), .d(new_n57_), .O(z10));
  ...
  nand4  g66(.a(x23), .b(x22), .c(x21), .d(x19), .O(new_n111_));
  inv1   g67(.a(new_n111_), .O(new_n112_));
  aoi21  g68(.a(new_n112_), .b(new_n110_), .c(new_n109_), .O(new_n113_));
  nand4  g69(.a(new_n109_), .b(x23), .c(x22), .d(x21), .O(new_n114_));
  nor2   g70(.a(new_n114_), .b(new_n86_), .O(new_n115_));
  oai21  g71(.a(new_n115_), .b(new_n113_), .c(new_n76_), .O(new_n116_));
  nand2  g72(.a(new_n116_), .b(new_n66_), .O(z14));
  nand2  g73(.a(x24), .b(x23), .O(new_n118_));
  inv1   g74(.a(new_n118_), .O(new_n119_));
  nand3  g75(.a(x22), .b(x21), .c(x19), .O(new_n120_));
  ...
  nor3   g79(.a(new_n120_), .b(new_n118_), .c(x25), .O(new_n124_));
  aoi21  g80(.a(new_n123_), .b(x25), .c(new_n124_), .O(new_n125_));
  oai21  g81(.a(new_n125_), .b(new_n75_), .c(new_n68_), .O(z15));
  inv1   g82(.a(x18), .O(new_n127_));
  nand3  g83(.a(x25), .b(x24), .c(new_n127_), .O(new_n128_));
  oai21  g84(.a(new_n128_), .b(new_n111_), .c(x26), .O(new_n129_));
  inv1   g85(.a(x26), .O(new_n130_));
  nand4  g86(.a(new_n121_), .b(new_n119_), .c(new_n130_), .d(x25), .O(new_n131_));
  nand2  g87(.a(new_n131_), .b(new_n129_), .O(new_n132_));
  nand2  g88(.a(new_n132_), .b(new_n76_), .O(new_n133_));
  nand2  g89(.a(new_n133_), .b(new_n70_), .O(z16));
endmodule
