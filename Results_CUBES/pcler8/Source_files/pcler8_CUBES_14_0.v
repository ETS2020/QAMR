...
module FAU ( 
  ...
  nor2   g38(.a(new_n80_), .b(x08), .O(new_n83_));
  aoi22  g39(.a(new_n83_), .b(new_n82_), .c(new_n80_), .d(x19), .O(new_n84_));
  nand2  g40(.a(new_n77_), .b(x09), .O(new_n85_));
  oai21  g41(.a(new_n85_), .b(new_n84_), .c(new_n59_), .O(z10));
  ...
  oai21  g58(.a(new_n102_), .b(new_n78_), .c(new_n63_), .O(z12));
