// Benchmark "FAU" written by ABC on Mon Jul  6 14:22:09 2020
...
module FAU ( 
  ...
  oai21  g56(.a(new_n100_), .b(new_n79_), .c(new_n63_), .O(z12));
  ...
  aoi22  g63(.a(new_n107_), .b(new_n86_), .c(new_n105_), .d(x23), .O(new_n108_));
  oai21  g64(.a(new_n108_), .b(new_n79_), .c(new_n65_), .O(z13));
  ...
  oai21  g72(.a(new_n116_), .b(new_n79_), .c(new_n67_), .O(z14));
  ...
  oai21  g81(.a(new_n125_), .b(new_n79_), .c(new_n69_), .O(z15));
