...
module FAU ( 
  ...
  oai21  g48(.a(new_n92_), .b(new_n76_), .c(new_n61_), .O(z11));
  inv1   g49(.a(new_n80_), .O(new_n94_));
  and2   g50(.a(x23), .b(x14), .O(new_n95_));
  nand3  g51(.a(x21), .b(x20), .c(x19), .O(new_n96_));
  aoi21  g52(.a(new_n95_), .b(new_n94_), .c(new_n96_), .O(new_n97_));
  oai22  g53(.a(new_n97_), .b(new_n76_), .c(new_n59_), .d(new_n63_), .O(z12));
  ...
  nand3  g59(.a(new_n87_), .b(new_n99_), .c(x21), .O(new_n104_));
  ...
  nand2  g68(.a(x20), .b(x19), .O(new_n113_));
  nand3  g69(.a(new_n108_), .b(x23), .c(x21), .O(new_n114_));
  nor2   g70(.a(new_n114_), .b(new_n113_), .O(new_n115_));
  oai21  g71(.a(new_n115_), .b(new_n112_), .c(new_n77_), .O(new_n116_));
  ...
  oai21  g82(.a(new_n126_), .b(new_n110_), .c(x26), .O(new_n127_));
