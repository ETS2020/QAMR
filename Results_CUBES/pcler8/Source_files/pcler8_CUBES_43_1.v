// Benchmark "FAU" written by ABC on Mon Jul  6 14:21:29 2020
...
module FAU ( 
  ...
  oai22  g40(.a(new_n84_), .b(new_n76_), .c(new_n58_), .d(new_n57_), .O(z10));
  ...
  oai22  g48(.a(new_n92_), .b(new_n76_), .c(new_n58_), .d(new_n60_), .O(z11));
  ...
  nand2  g62(.a(new_n73_), .b(new_n102_), .O(new_n107_));
  nor2   g63(.a(new_n107_), .b(new_n88_), .O(new_n108_));
  ...
  nand3  g67(.a(new_n111_), .b(new_n96_), .c(new_n46_), .O(new_n112_));
  nor3   g68(.a(new_n95_), .b(new_n45_), .c(x24), .O(new_n113_));
  aoi21  g69(.a(new_n112_), .b(x24), .c(new_n113_), .O(new_n114_));
  oai22  g70(.a(new_n114_), .b(new_n76_), .c(new_n58_), .d(new_n66_), .O(z14));
  nand2  g71(.a(x26), .b(x17), .O(new_n116_));
  nand4  g72(.a(new_n116_), .b(new_n96_), .c(new_n46_), .d(x24), .O(new_n117_));
  inv1   g73(.a(x25), .O(new_n118_));
  nand2  g74(.a(new_n118_), .b(x24), .O(new_n119_));
  nor3   g75(.a(new_n119_), .b(new_n95_), .c(new_n45_), .O(new_n120_));
  aoi21  g76(.a(new_n117_), .b(x25), .c(new_n120_), .O(new_n121_));
  oai21  g77(.a(new_n121_), .b(new_n76_), .c(new_n68_), .O(z15));
  inv1   g78(.a(x26), .O(new_n123_));
  nand4  g79(.a(x24), .b(x23), .c(x22), .d(x20), .O(new_n124_));
  nand2  g80(.a(new_n124_), .b(new_n58_), .O(new_n125_));
  inv1   g81(.a(x18), .O(new_n126_));
  nand4  g82(.a(x25), .b(x21), .c(x19), .d(new_n126_), .O(new_n127_));
  nand2  g83(.a(new_n127_), .b(x20), .O(new_n128_));
  aoi21  g84(.a(new_n128_), .b(new_n125_), .c(new_n123_), .O(new_n129_));
  nand3  g85(.a(new_n73_), .b(new_n123_), .c(x25), .O(new_n130_));
  nand3  g86(.a(new_n89_), .b(x24), .c(x23), .O(new_n131_));
  nor2   g87(.a(new_n131_), .b(new_n130_), .O(new_n132_));
  nor2   g88(.a(x10), .b(new_n49_), .O(new_n133_));
  oai21  g89(.a(new_n132_), .b(new_n129_), .c(new_n133_), .O(new_n134_));
