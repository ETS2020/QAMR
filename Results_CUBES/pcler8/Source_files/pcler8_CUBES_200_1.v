// Benchmark "FAU" written by ABC on Mon Jul  6 14:22:41 2020
...
module FAU ( 
  ...
  nand3  g30(.a(new_n74_), .b(x09), .c(new_n56_), .O(new_n75_));
  ...
  oai21  g63(.a(new_n56_), .b(new_n64_), .c(new_n107_), .O(z13));
  ...
  nand2  g69(.a(x21), .b(x20), .O(new_n114_));
  nand3  g70(.a(new_n109_), .b(x23), .c(x22), .O(new_n115_));
  nor2   g71(.a(new_n115_), .b(new_n114_), .O(new_n116_));
  oai21  g72(.a(new_n116_), .b(new_n113_), .c(new_n76_), .O(new_n117_));
  nand2  g73(.a(new_n117_), .b(new_n66_), .O(z14));
  nand2  g74(.a(x24), .b(x23), .O(new_n119_));
  inv1   g75(.a(new_n119_), .O(new_n120_));
  nand3  g76(.a(x22), .b(x21), .c(x20), .O(new_n121_));
  inv1   g77(.a(new_n121_), .O(new_n122_));
  nand2  g78(.a(x26), .b(x17), .O(new_n123_));
  nand3  g79(.a(new_n123_), .b(new_n122_), .c(new_n120_), .O(new_n124_));
  nor3   g80(.a(new_n121_), .b(new_n119_), .c(x25), .O(new_n125_));
  aoi21  g81(.a(new_n124_), .b(x25), .c(new_n125_), .O(new_n126_));
  oai21  g82(.a(new_n126_), .b(new_n75_), .c(new_n68_), .O(z15));
  inv1   g83(.a(x18), .O(new_n128_));
  nand3  g84(.a(x25), .b(x24), .c(new_n128_), .O(new_n129_));
  oai21  g85(.a(new_n129_), .b(new_n111_), .c(x26), .O(new_n130_));
  inv1   g86(.a(x26), .O(new_n131_));
  nand4  g87(.a(new_n122_), .b(new_n120_), .c(new_n131_), .d(x25), .O(new_n132_));
