...
module FAU ( 
  ...
  nor2   g00(.a(x14), .b(x11), .O(new_n45_));
  ...
  nand3  g48(.a(x23), .b(x22), .c(x14), .O(new_n93_));
  oai21  g49(.a(new_n93_), .b(new_n71_), .c(x22), .O(new_n94_));
  ...
  oai22  g54(.a(new_n98_), .b(new_n78_), .c(new_n46_), .d(new_n61_), .O(z12));
  ...
  aoi22  g61(.a(new_n105_), .b(new_n88_), .c(new_n103_), .d(x23), .O(new_n106_));
  oai21  g62(.a(new_n106_), .b(new_n78_), .c(new_n63_), .O(z13));
  ...
  nor3   g66(.a(new_n97_), .b(new_n73_), .c(x24), .O(new_n111_));
  aoi21  g67(.a(new_n110_), .b(x24), .c(new_n111_), .O(new_n112_));
  oai21  g68(.a(new_n112_), .b(new_n78_), .c(new_n65_), .O(z14));
  nand2  g69(.a(x26), .b(x17), .O(new_n114_));
  nand3  g70(.a(x24), .b(x23), .c(x22), .O(new_n115_));
  inv1   g71(.a(new_n115_), .O(new_n116_));
  nand3  g72(.a(new_n116_), .b(new_n114_), .c(new_n108_), .O(new_n117_));
  inv1   g73(.a(x25), .O(new_n118_));
  nand4  g74(.a(new_n118_), .b(x24), .c(x23), .d(x22), .O(new_n119_));
  inv1   g75(.a(new_n119_), .O(new_n120_));
  aoi22  g76(.a(new_n120_), .b(new_n108_), .c(new_n117_), .d(x25), .O(new_n121_));
  oai21  g77(.a(new_n121_), .b(new_n78_), .c(new_n67_), .O(z15));
  nor2   g78(.a(new_n47_), .b(x18), .O(new_n123_));
  nand3  g79(.a(new_n123_), .b(new_n52_), .c(new_n50_), .O(new_n124_));
  inv1   g80(.a(x26), .O(new_n125_));
  nand4  g81(.a(new_n125_), .b(x25), .c(x22), .d(x21), .O(new_n126_));
  nand4  g82(.a(x24), .b(x23), .c(x20), .d(x19), .O(new_n127_));
  nor2   g83(.a(new_n127_), .b(new_n126_), .O(new_n128_));
  aoi21  g84(.a(new_n124_), .b(x26), .c(new_n128_), .O(new_n129_));
  oai21  g85(.a(new_n129_), .b(new_n78_), .c(new_n69_), .O(z16));
endmodule
