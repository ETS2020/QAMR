...
module FAU ( 
  ...
  oai21  g84(.a(new_n128_), .b(new_n106_), .c(x26), .O(new_n129_));
  and2   g85(.a(x24), .b(x23), .O(new_n130_));
  inv1   g86(.a(new_n109_), .O(new_n131_));
  nor2   g87(.a(x26), .b(new_n122_), .O(new_n132_));
  nand4  g88(.a(new_n132_), .b(new_n89_), .c(new_n131_), .d(new_n130_), .O(new_n133_));
  nand2  g89(.a(new_n133_), .b(new_n129_), .O(new_n134_));
  nand2  g90(.a(new_n134_), .b(new_n103_), .O(new_n135_));
  nand2  g91(.a(new_n135_), .b(new_n72_), .O(z16));
endmodule
