// Benchmark "FAU" written by ABC on Mon Jul  6 14:22:50 2020
...
module FAU ( 
  ...
  nor2   g21(.a(new_n46_), .b(new_n65_), .O(z08));
  ...
  nand3  g31(.a(new_n68_), .b(x20), .c(x12), .O(new_n76_));
  inv1   g32(.a(new_n76_), .O(new_n77_));
  aoi22  g33(.a(new_n77_), .b(new_n74_), .c(new_n75_), .d(new_n73_), .O(new_n78_));
  ...
  oai22  g39(.a(new_n83_), .b(new_n47_), .c(new_n46_), .d(new_n55_), .O(z11));
  ...
  oai21  g51(.a(new_n95_), .b(new_n90_), .c(new_n67_), .O(new_n96_));
  nand2  g52(.a(new_n96_), .b(new_n57_), .O(z12));
  oai21  g53(.a(new_n49_), .b(new_n48_), .c(x23), .O(new_n98_));
  inv1   g54(.a(x23), .O(new_n99_));
  nand3  g55(.a(new_n68_), .b(new_n88_), .c(new_n99_), .O(new_n100_));
  aoi21  g56(.a(new_n100_), .b(new_n98_), .c(x10), .O(new_n101_));
  nand2  g57(.a(x23), .b(x15), .O(new_n102_));
  nor3   g58(.a(new_n102_), .b(new_n93_), .c(new_n92_), .O(new_n103_));
  oai21  g59(.a(new_n103_), .b(new_n101_), .c(new_n67_), .O(new_n104_));
  nand2  g60(.a(new_n104_), .b(new_n59_), .O(z13));
  ...
  aoi21  g66(.a(new_n110_), .b(new_n107_), .c(x10), .O(new_n111_));
  inv1   g67(.a(new_n93_), .O(new_n112_));
  nand3  g68(.a(new_n112_), .b(x24), .c(x16), .O(new_n113_));
  inv1   g69(.a(new_n113_), .O(new_n114_));
  oai21  g70(.a(new_n114_), .b(new_n111_), .c(new_n67_), .O(new_n115_));
  nand2  g71(.a(new_n115_), .b(new_n61_), .O(z14));
  ...
  aoi21  g79(.a(new_n121_), .b(new_n73_), .c(new_n123_), .O(new_n124_));
  oai21  g80(.a(new_n124_), .b(new_n47_), .c(new_n63_), .O(z15));
  ...
  and2   g85(.a(x21), .b(x20), .O(new_n130_));
  nand2  g86(.a(x25), .b(x24), .O(new_n131_));
  nor2   g87(.a(new_n131_), .b(x26), .O(new_n132_));
  inv1   g88(.a(x19), .O(new_n133_));
  nor2   g89(.a(new_n133_), .b(x10), .O(new_n134_));
  nand4  g90(.a(new_n134_), .b(new_n132_), .c(new_n109_), .d(new_n130_), .O(new_n135_));
  nand2  g91(.a(new_n135_), .b(new_n129_), .O(new_n136_));
  nand2  g92(.a(new_n136_), .b(new_n67_), .O(new_n137_));
  oai21  g93(.a(new_n46_), .b(new_n65_), .c(new_n137_), .O(z16));
endmodule
