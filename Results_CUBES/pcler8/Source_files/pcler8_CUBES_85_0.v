...
module FAU ( 
  ...
  nand3  g67(.a(new_n111_), .b(new_n96_), .c(new_n48_), .O(new_n112_));
  nor3   g68(.a(new_n95_), .b(new_n47_), .c(x24), .O(new_n113_));
  aoi21  g69(.a(new_n112_), .b(x24), .c(new_n113_), .O(new_n114_));
  oai21  g70(.a(new_n114_), .b(new_n79_), .c(new_n68_), .O(z14));
