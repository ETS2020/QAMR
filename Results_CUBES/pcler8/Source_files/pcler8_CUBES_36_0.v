...
module FAU ( 
  ...
  nand2  g75(.a(x25), .b(new_n103_), .O(new_n120_));
  inv1   g76(.a(x25), .O(new_n121_));
  nand3  g77(.a(new_n121_), .b(x23), .c(x22), .O(new_n122_));
  oai21  g78(.a(new_n122_), .b(new_n113_), .c(new_n120_), .O(new_n123_));
  nand2  g79(.a(x26), .b(x17), .O(new_n124_));
  nand4  g80(.a(new_n124_), .b(new_n114_), .c(x24), .d(x22), .O(new_n125_));
  aoi22  g81(.a(new_n125_), .b(x25), .c(new_n123_), .d(x24), .O(new_n126_));
  nand2  g82(.a(new_n76_), .b(x09), .O(new_n127_));
  oai21  g83(.a(new_n127_), .b(new_n126_), .c(new_n69_), .O(z15));
