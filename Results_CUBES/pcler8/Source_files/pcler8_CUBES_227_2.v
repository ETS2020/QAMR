...
module FAU ( 
  ...
  oai22  g55(.a(new_n99_), .b(new_n77_), .c(new_n58_), .d(new_n62_), .O(z12));
  ...
  oai21  g63(.a(new_n107_), .b(new_n77_), .c(new_n64_), .O(z13));
  nand3  g64(.a(x26), .b(x25), .c(x16), .O(new_n109_));
  nand3  g65(.a(x21), .b(x20), .c(x19), .O(new_n110_));
  inv1   g66(.a(new_n110_), .O(new_n111_));
  nand3  g67(.a(new_n111_), .b(new_n109_), .c(new_n46_), .O(new_n112_));
  nor3   g68(.a(new_n110_), .b(new_n45_), .c(x24), .O(new_n113_));
  aoi21  g69(.a(new_n112_), .b(x24), .c(new_n113_), .O(new_n114_));
  oai22  g70(.a(new_n114_), .b(new_n77_), .c(new_n58_), .d(new_n66_), .O(z14));
  nand2  g71(.a(x26), .b(x17), .O(new_n116_));
  nand4  g72(.a(new_n116_), .b(new_n111_), .c(new_n46_), .d(x24), .O(new_n117_));
  inv1   g73(.a(x25), .O(new_n118_));
  nand4  g74(.a(new_n118_), .b(x24), .c(x23), .d(x22), .O(new_n119_));
  nor2   g75(.a(new_n119_), .b(new_n110_), .O(new_n120_));
  aoi21  g76(.a(new_n117_), .b(x25), .c(new_n120_), .O(new_n121_));
  oai21  g77(.a(new_n121_), .b(new_n77_), .c(new_n68_), .O(z15));
  inv1   g78(.a(x26), .O(new_n123_));
  oai21  g79(.a(new_n118_), .b(x18), .c(new_n48_), .O(new_n124_));
  inv1   g80(.a(x18), .O(new_n125_));
  nand3  g81(.a(x24), .b(x23), .c(x22), .O(new_n126_));
  oai21  g82(.a(new_n126_), .b(new_n110_), .c(new_n125_), .O(new_n127_));
  aoi21  g83(.a(new_n127_), .b(new_n124_), .c(new_n123_), .O(new_n128_));
  nand3  g84(.a(new_n123_), .b(x25), .c(x24), .O(new_n129_));
  nand4  g85(.a(x21), .b(x20), .c(x19), .d(new_n48_), .O(new_n130_));
  nor3   g86(.a(new_n130_), .b(new_n129_), .c(new_n45_), .O(new_n131_));
  oai21  g87(.a(new_n131_), .b(new_n128_), .c(new_n50_), .O(new_n132_));
