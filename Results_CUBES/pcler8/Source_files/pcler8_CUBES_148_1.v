...
module FAU ( 
  ...
  nand2  g57(.a(x21), .b(x20), .O(new_n102_));
  nand2  g58(.a(new_n102_), .b(new_n57_), .O(new_n103_));
  nand4  g59(.a(x26), .b(x25), .c(x24), .d(x15), .O(new_n104_));
  nand3  g60(.a(new_n104_), .b(x22), .c(x19), .O(new_n105_));
  nand2  g61(.a(new_n105_), .b(x20), .O(new_n106_));
  aoi21  g62(.a(new_n106_), .b(new_n103_), .c(new_n101_), .O(new_n107_));
  nand3  g63(.a(new_n101_), .b(x22), .c(x21), .O(new_n108_));
  nor2   g64(.a(new_n108_), .b(new_n87_), .O(new_n109_));
  nor2   g65(.a(x10), .b(new_n50_), .O(new_n110_));
  ...
  nand3  g73(.a(new_n117_), .b(new_n115_), .c(new_n114_), .O(new_n118_));
  nor3   g74(.a(new_n116_), .b(new_n113_), .c(x24), .O(new_n119_));
  ...
  nand4  g78(.a(new_n122_), .b(new_n117_), .c(new_n114_), .d(x24), .O(new_n123_));
  ...
  aoi21  g82(.a(new_n123_), .b(x25), .c(new_n126_), .O(new_n127_));
  ...
  oai22  g91(.a(new_n135_), .b(new_n78_), .c(new_n57_), .d(new_n71_), .O(z16));
endmodule
