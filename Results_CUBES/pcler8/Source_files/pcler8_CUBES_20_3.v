...
module FAU ( 
  ...
  nor2   g35(.a(x20), .b(new_n52_), .O(new_n80_));
  aoi21  g36(.a(new_n79_), .b(x20), .c(new_n80_), .O(new_n81_));
  inv1   g37(.a(x10), .O(new_n82_));
  nand2  g38(.a(new_n51_), .b(new_n82_), .O(new_n83_));
  oai22  g39(.a(new_n83_), .b(new_n81_), .c(new_n57_), .d(new_n59_), .O(z10));
  ...
  oai21  g47(.a(new_n91_), .b(new_n83_), .c(new_n61_), .O(z11));
  ...
  oai21  g56(.a(new_n100_), .b(new_n83_), .c(new_n63_), .O(z12));
  ...
  oai21  g64(.a(new_n108_), .b(new_n83_), .c(new_n65_), .O(z13));
  ...
  oai21  g72(.a(new_n116_), .b(new_n83_), .c(new_n67_), .O(z14));
  ...
  oai21  g81(.a(new_n125_), .b(new_n83_), .c(new_n69_), .O(z15));
  ...
  oai21  g89(.a(new_n133_), .b(new_n83_), .c(new_n71_), .O(z16));
endmodule
