// Benchmark "FAU" written by ABC on Mon Jul  6 14:21:47 2020
...
module FAU ( 
  ...
  nand4  g28(.a(x22), .b(x21), .c(x20), .d(x19), .O(new_n73_));
  inv1   g29(.a(new_n73_), .O(new_n74_));
  nand4  g30(.a(x26), .b(x25), .c(x24), .d(x23), .O(new_n75_));
  inv1   g31(.a(new_n75_), .O(new_n76_));
  aoi21  g32(.a(new_n76_), .b(new_n74_), .c(new_n52_), .O(new_n77_));
  inv1   g33(.a(x10), .O(new_n78_));
  nand2  g34(.a(new_n51_), .b(new_n78_), .O(new_n79_));
  oai22  g35(.a(new_n79_), .b(new_n77_), .c(new_n57_), .d(new_n56_), .O(z09));
  ...
  oai22  g40(.a(new_n84_), .b(new_n79_), .c(new_n57_), .d(new_n59_), .O(z10));
  ...
  oai21  g45(.a(new_n89_), .b(new_n88_), .c(new_n87_), .O(new_n90_));
  nor2   g46(.a(new_n86_), .b(x21), .O(new_n91_));
  aoi21  g47(.a(new_n90_), .b(x21), .c(new_n91_), .O(new_n92_));
  oai21  g48(.a(new_n92_), .b(new_n79_), .c(new_n61_), .O(z11));
  ...
  oai21  g57(.a(new_n101_), .b(new_n79_), .c(new_n63_), .O(z12));
  inv1   g58(.a(new_n79_), .O(new_n103_));
  inv1   g59(.a(x23), .O(new_n104_));
  nand4  g60(.a(x26), .b(x25), .c(x24), .d(x15), .O(new_n105_));
  aoi21  g61(.a(new_n105_), .b(new_n74_), .c(new_n104_), .O(new_n106_));
  nand3  g62(.a(new_n104_), .b(x22), .c(x21), .O(new_n107_));
  nor2   g63(.a(new_n107_), .b(new_n86_), .O(new_n108_));
  oai21  g64(.a(new_n108_), .b(new_n106_), .c(new_n103_), .O(new_n109_));
  nand2  g65(.a(new_n109_), .b(new_n65_), .O(z13));
  ...
  oai21  g73(.a(new_n117_), .b(new_n79_), .c(new_n67_), .O(z14));
  ...
  oai21  g82(.a(new_n126_), .b(new_n79_), .c(new_n69_), .O(z15));
  ...
  nor2   g87(.a(new_n131_), .b(new_n73_), .O(new_n132_));
  aoi21  g88(.a(new_n129_), .b(x26), .c(new_n132_), .O(new_n133_));
  oai21  g89(.a(new_n133_), .b(new_n79_), .c(new_n71_), .O(z16));
endmodule
