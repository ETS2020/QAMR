// Benchmark "FAU" written by ABC on Mon Jul  6 14:21:37 2020
...
module FAU ( 
  ...
  nand3  g21(.a(new_n66_), .b(new_n64_), .c(new_n63_), .O(new_n67_));
  oai21  g22(.a(new_n47_), .b(new_n46_), .c(new_n67_), .O(z09));
  xnor2a g23(.a(x20), .b(x19), .O(new_n69_));
  nand3  g24(.a(new_n63_), .b(x09), .c(new_n47_), .O(new_n70_));
  oai22  g25(.a(new_n70_), .b(new_n69_), .c(new_n47_), .d(new_n49_), .O(z10));
  ...
  nand2  g50(.a(new_n91_), .b(x24), .O(new_n96_));
  nor2   g51(.a(new_n64_), .b(x10), .O(new_n97_));
  nand4  g52(.a(new_n97_), .b(new_n66_), .c(x21), .d(x20), .O(new_n98_));
  oai22  g53(.a(new_n98_), .b(new_n96_), .c(new_n47_), .d(new_n59_), .O(z15));
  nand3  g54(.a(new_n66_), .b(x26), .c(new_n63_), .O(new_n100_));
