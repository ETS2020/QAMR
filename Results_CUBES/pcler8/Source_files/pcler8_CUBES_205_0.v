...
module FAU ( 
  ...
  oai21  g33(.a(new_n77_), .b(new_n76_), .c(new_n55_), .O(z09));
  ...
  oai22  g38(.a(new_n82_), .b(new_n77_), .c(new_n58_), .d(new_n57_), .O(z10));
  ...
  oai22  g46(.a(new_n90_), .b(new_n77_), .c(new_n58_), .d(new_n60_), .O(z11));
  ...
  oai21  g54(.a(new_n98_), .b(new_n77_), .c(new_n62_), .O(z12));
  ...
  nor2   g61(.a(new_n105_), .b(new_n86_), .O(new_n106_));
  aoi21  g62(.a(new_n103_), .b(x23), .c(new_n106_), .O(new_n107_));
  oai22  g63(.a(new_n107_), .b(new_n77_), .c(new_n58_), .d(new_n64_), .O(z13));
  nand3  g64(.a(x26), .b(x25), .c(x16), .O(new_n109_));
  nand3  g65(.a(new_n109_), .b(new_n94_), .c(new_n46_), .O(new_n110_));
  nor3   g66(.a(new_n93_), .b(new_n45_), .c(x24), .O(new_n111_));
  aoi21  g67(.a(new_n110_), .b(x24), .c(new_n111_), .O(new_n112_));
  oai22  g68(.a(new_n112_), .b(new_n77_), .c(new_n58_), .d(new_n66_), .O(z14));
  nand2  g69(.a(x26), .b(x17), .O(new_n114_));
  nand4  g70(.a(new_n114_), .b(new_n94_), .c(new_n46_), .d(x24), .O(new_n115_));
  inv1   g71(.a(x25), .O(new_n116_));
  nand2  g72(.a(new_n116_), .b(x24), .O(new_n117_));
  nor3   g73(.a(new_n117_), .b(new_n93_), .c(new_n45_), .O(new_n118_));
  aoi21  g74(.a(new_n115_), .b(x25), .c(new_n118_), .O(new_n119_));
  oai21  g75(.a(new_n119_), .b(new_n77_), .c(new_n68_), .O(z15));
  inv1   g76(.a(x24), .O(new_n121_));
  nand2  g77(.a(x26), .b(new_n121_), .O(new_n122_));
  inv1   g78(.a(x26), .O(new_n123_));
  nand4  g79(.a(new_n123_), .b(x24), .c(x23), .d(x22), .O(new_n124_));
  oai21  g80(.a(new_n124_), .b(new_n93_), .c(new_n122_), .O(new_n125_));
  nor2   g81(.a(new_n104_), .b(x18), .O(new_n126_));
  nand3  g82(.a(new_n126_), .b(new_n102_), .c(x25), .O(new_n127_));
  aoi22  g83(.a(new_n127_), .b(x26), .c(new_n125_), .d(x25), .O(new_n128_));
  nand2  g84(.a(new_n48_), .b(x09), .O(new_n129_));
  oai21  g85(.a(new_n129_), .b(new_n128_), .c(new_n70_), .O(z16));
endmodule
