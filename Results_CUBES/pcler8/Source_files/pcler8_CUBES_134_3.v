...
module FAU ( 
  ...
  inv1   g29(.a(new_n72_), .O(new_n75_));
  nand3  g30(.a(x21), .b(x20), .c(x19), .O(new_n76_));
  inv1   g31(.a(x21), .O(new_n77_));
  nor2   g32(.a(x22), .b(new_n77_), .O(new_n78_));
  aoi22  g33(.a(new_n78_), .b(new_n75_), .c(new_n76_), .d(x22), .O(new_n79_));
  oai21  g34(.a(new_n79_), .b(new_n70_), .c(new_n53_), .O(z12));
  nand4  g35(.a(x22), .b(x21), .c(x20), .d(x19), .O(new_n81_));
  nand2  g36(.a(x22), .b(x21), .O(new_n82_));
  nor2   g37(.a(new_n82_), .b(x23), .O(new_n83_));
  aoi22  g38(.a(new_n83_), .b(new_n75_), .c(new_n81_), .d(x23), .O(new_n84_));
  oai21  g39(.a(new_n84_), .b(new_n70_), .c(new_n55_), .O(z13));
  inv1   g40(.a(new_n70_), .O(new_n86_));
  nand3  g41(.a(x23), .b(x22), .c(x21), .O(new_n87_));
  oai21  g42(.a(new_n87_), .b(new_n72_), .c(x24), .O(new_n88_));
  inv1   g43(.a(x24), .O(new_n89_));
  inv1   g44(.a(new_n76_), .O(new_n90_));
  and2   g45(.a(x23), .b(x22), .O(new_n91_));
  nand3  g46(.a(new_n91_), .b(new_n90_), .c(new_n89_), .O(new_n92_));
  nand2  g47(.a(new_n92_), .b(new_n88_), .O(new_n93_));
  nand2  g48(.a(new_n93_), .b(new_n86_), .O(new_n94_));
  nand2  g49(.a(new_n94_), .b(new_n57_), .O(z14));
  nand3  g50(.a(x24), .b(x23), .c(x22), .O(new_n96_));
  inv1   g51(.a(new_n96_), .O(new_n97_));
  aoi21  g52(.a(new_n97_), .b(new_n90_), .c(x25), .O(new_n98_));
  oai22  g53(.a(new_n98_), .b(new_n70_), .c(new_n47_), .d(new_n59_), .O(z15));
  nand3  g54(.a(new_n64_), .b(x26), .c(new_n69_), .O(new_n100_));
  oai21  g55(.a(new_n47_), .b(new_n61_), .c(new_n100_), .O(z16));
  zero   g56(.O(z00));
endmodule
