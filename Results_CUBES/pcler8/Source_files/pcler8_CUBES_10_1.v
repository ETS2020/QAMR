...
module FAU ( 
  ...
  oai21  g83(.a(new_n127_), .b(new_n95_), .c(x26), .O(new_n128_));
  and2   g84(.a(x24), .b(x23), .O(new_n129_));
  inv1   g85(.a(new_n109_), .O(new_n130_));
  nor2   g86(.a(x26), .b(new_n122_), .O(new_n131_));
  nand4  g87(.a(new_n131_), .b(new_n89_), .c(new_n130_), .d(new_n129_), .O(new_n132_));
  nand2  g88(.a(new_n132_), .b(new_n128_), .O(new_n133_));
  nand2  g89(.a(new_n133_), .b(new_n103_), .O(new_n134_));
  nand2  g90(.a(new_n134_), .b(new_n72_), .O(z16));
endmodule
