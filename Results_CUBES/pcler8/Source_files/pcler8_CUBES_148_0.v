// Benchmark "FAU" written by ABC on Mon Jul  6 14:22:17 2020
...
module FAU ( 
  ...
  oai21  g43(.a(new_n86_), .b(new_n85_), .c(new_n87_), .O(new_n88_));
  inv1   g44(.a(x20), .O(new_n89_));
  nor3   g45(.a(x21), .b(new_n89_), .c(new_n52_), .O(new_n90_));
  ...
  nand2  g57(.a(x23), .b(new_n89_), .O(new_n102_));
  nand2  g58(.a(x19), .b(new_n57_), .O(new_n103_));
  inv1   g59(.a(x23), .O(new_n104_));
  nand3  g60(.a(new_n104_), .b(x21), .c(x20), .O(new_n105_));
  oai21  g61(.a(new_n105_), .b(new_n103_), .c(new_n102_), .O(new_n106_));
  nand4  g62(.a(x26), .b(x25), .c(x24), .d(x15), .O(new_n107_));
  nand3  g63(.a(x22), .b(x21), .c(x19), .O(new_n108_));
  inv1   g64(.a(new_n108_), .O(new_n109_));
  nand2  g65(.a(x23), .b(new_n57_), .O(new_n110_));
  aoi21  g66(.a(new_n109_), .b(new_n107_), .c(new_n110_), .O(new_n111_));
  aoi21  g67(.a(new_n106_), .b(x22), .c(new_n111_), .O(new_n112_));
  nand2  g68(.a(new_n77_), .b(x09), .O(new_n113_));
  oai21  g69(.a(new_n113_), .b(new_n112_), .c(new_n65_), .O(z13));
  ...
  nand2  g74(.a(x23), .b(x22), .O(new_n119_));
  nor3   g75(.a(new_n116_), .b(new_n119_), .c(x24), .O(new_n120_));
  aoi21  g76(.a(new_n118_), .b(x24), .c(new_n120_), .O(new_n121_));
  oai21  g77(.a(new_n121_), .b(new_n78_), .c(new_n67_), .O(z14));
  nand2  g78(.a(x26), .b(x17), .O(new_n123_));
  nand3  g79(.a(x24), .b(x23), .c(x22), .O(new_n124_));
  inv1   g80(.a(new_n124_), .O(new_n125_));
  nand3  g81(.a(new_n125_), .b(new_n123_), .c(new_n117_), .O(new_n126_));
  inv1   g82(.a(x25), .O(new_n127_));
  nand4  g83(.a(new_n127_), .b(x24), .c(x23), .d(x22), .O(new_n128_));
  inv1   g84(.a(new_n128_), .O(new_n129_));
  aoi22  g85(.a(new_n129_), .b(new_n117_), .c(new_n126_), .d(x25), .O(new_n130_));
  oai21  g86(.a(new_n130_), .b(new_n78_), .c(new_n69_), .O(z15));
  nor2   g87(.a(new_n52_), .b(x18), .O(new_n132_));
  nand3  g88(.a(new_n132_), .b(new_n49_), .c(new_n45_), .O(new_n133_));
  ...
  oai21  g94(.a(new_n138_), .b(new_n78_), .c(new_n71_), .O(z16));
endmodule
