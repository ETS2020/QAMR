...
module FAU ( 
  ...
  nand3  g82(.a(new_n122_), .b(new_n126_), .c(new_n120_), .O(new_n127_));
  nand2  g83(.a(new_n127_), .b(x19), .O(new_n128_));
  oai21  g84(.a(new_n128_), .b(new_n125_), .c(new_n101_), .O(new_n129_));
  nand2  g85(.a(new_n129_), .b(new_n68_), .O(z15));
  inv1   g86(.a(x18), .O(new_n131_));
  nand4  g87(.a(x25), .b(x24), .c(x19), .d(new_n131_), .O(new_n132_));
  oai21  g88(.a(new_n132_), .b(new_n47_), .c(x26), .O(new_n133_));
  nor2   g89(.a(x26), .b(new_n120_), .O(new_n134_));
  nand4  g90(.a(new_n134_), .b(new_n87_), .c(new_n107_), .d(new_n126_), .O(new_n135_));
