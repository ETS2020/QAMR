// Benchmark "FAU" written by ABC on Mon Jul  6 14:22:58 2020
...
module FAU ( 
  ...
  nor2   g035(.a(x20), .b(x19), .O(new_n80_));
  aoi21  g036(.a(new_n79_), .b(new_n76_), .c(new_n80_), .O(new_n81_));
  nor2   g037(.a(x10), .b(x08), .O(new_n82_));
  inv1   g038(.a(new_n82_), .O(new_n83_));
  oai21  g039(.a(new_n83_), .b(new_n81_), .c(new_n55_), .O(z09));
  ...
  aoi21  g044(.a(new_n86_), .b(new_n79_), .c(new_n88_), .O(new_n89_));
  ...
  nand2  g052(.a(x21), .b(new_n78_), .O(new_n97_));
  oai21  g053(.a(new_n96_), .b(new_n77_), .c(new_n97_), .O(new_n98_));
  ...
  aoi21  g062(.a(new_n106_), .b(new_n104_), .c(new_n77_), .O(new_n107_));
  ...
  aoi21  g070(.a(new_n114_), .b(new_n113_), .c(new_n77_), .O(new_n115_));
  ...
  aoi21  g081(.a(new_n125_), .b(new_n122_), .c(new_n77_), .O(new_n126_));
  ...
  aoi21  g091(.a(new_n135_), .b(new_n133_), .c(new_n77_), .O(new_n136_));
  ...
  aoi21  g100(.a(new_n144_), .b(new_n142_), .c(new_n77_), .O(new_n145_));
