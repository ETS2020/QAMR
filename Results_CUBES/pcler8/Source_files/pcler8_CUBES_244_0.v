// Benchmark "FAU" written by ABC on Mon Jul  6 14:23:00 2020
...
module FAU ( 
  ...
  nand2  g50(.a(x22), .b(new_n94_), .O(new_n95_));
  inv1   g51(.a(x22), .O(new_n96_));
  nand3  g52(.a(new_n96_), .b(x20), .c(x19), .O(new_n97_));
  aoi21  g53(.a(new_n97_), .b(new_n95_), .c(new_n93_), .O(new_n98_));
  nand2  g54(.a(x23), .b(x14), .O(new_n99_));
  and2   g55(.a(x21), .b(x19), .O(new_n100_));
  oai21  g56(.a(new_n99_), .b(new_n85_), .c(new_n100_), .O(new_n101_));
  aoi21  g57(.a(new_n101_), .b(x22), .c(new_n98_), .O(new_n102_));
  nand2  g58(.a(new_n77_), .b(x09), .O(new_n103_));
  oai21  g59(.a(new_n103_), .b(new_n102_), .c(new_n63_), .O(z12));
  ...
  nor3   g64(.a(x23), .b(new_n96_), .c(new_n93_), .O(new_n109_));
  aoi22  g65(.a(new_n109_), .b(new_n88_), .c(new_n108_), .d(x23), .O(new_n110_));
  oai21  g66(.a(new_n110_), .b(new_n78_), .c(new_n65_), .O(z13));
