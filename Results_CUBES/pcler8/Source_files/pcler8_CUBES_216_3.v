...
module FAU ( 
  ...
  xnor2a g41(.a(new_n85_), .b(x21), .O(new_n86_));
  nand3  g42(.a(x22), .b(x21), .c(x13), .O(new_n87_));
  nor2   g43(.a(new_n87_), .b(new_n72_), .O(new_n88_));
  aoi21  g44(.a(new_n86_), .b(new_n76_), .c(new_n88_), .O(new_n89_));
  oai22  g45(.a(new_n89_), .b(new_n84_), .c(new_n56_), .d(new_n60_), .O(z11));
  nand2  g46(.a(x26), .b(x25), .O(new_n91_));
  nand3  g47(.a(x24), .b(x23), .c(x14), .O(new_n92_));
  ...
  nor3   g63(.a(new_n85_), .b(new_n107_), .c(x23), .O(new_n108_));
  ...
  inv1   g87(.a(new_n107_), .O(new_n132_));
  inv1   g88(.a(new_n85_), .O(new_n133_));
  nor2   g89(.a(x26), .b(new_n123_), .O(new_n134_));
  nand4  g90(.a(new_n134_), .b(new_n133_), .c(new_n132_), .d(new_n131_), .O(new_n135_));
  nand2  g91(.a(new_n135_), .b(new_n130_), .O(new_n136_));
