...
module FAU ( 
  ...
  nand2  g67(.a(new_n111_), .b(new_n105_), .O(new_n112_));
  inv1   g68(.a(x24), .O(new_n113_));
  nor2   g69(.a(new_n113_), .b(x23), .O(new_n114_));
  aoi21  g70(.a(new_n112_), .b(x23), .c(new_n114_), .O(new_n115_));
  oai21  g71(.a(new_n115_), .b(new_n76_), .c(new_n67_), .O(z14));
  ...
  oai21  g81(.a(new_n125_), .b(new_n104_), .c(x26), .O(new_n126_));
