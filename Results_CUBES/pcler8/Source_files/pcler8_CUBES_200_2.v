...
module FAU ( 
  ...
  nand2  g28(.a(x23), .b(x19), .O(new_n73_));
  ...
  nand3  g52(.a(new_n85_), .b(new_n92_), .c(x21), .O(new_n97_));
  ...
  nor2   g57(.a(new_n101_), .b(x19), .O(new_n102_));
  nand4  g58(.a(x26), .b(x25), .c(x24), .d(x15), .O(new_n103_));
  nand4  g59(.a(new_n103_), .b(x22), .c(x21), .d(x20), .O(new_n104_));
  aoi21  g60(.a(new_n104_), .b(x19), .c(new_n102_), .O(new_n105_));
  oai22  g61(.a(new_n105_), .b(new_n76_), .c(new_n55_), .d(new_n63_), .O(z13));
  ...
  oai21  g69(.a(new_n113_), .b(new_n111_), .c(new_n91_), .O(new_n114_));
  nand2  g70(.a(new_n114_), .b(new_n65_), .O(z14));
  nand2  g71(.a(x24), .b(x22), .O(new_n116_));
