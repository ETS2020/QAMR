// Benchmark "FAU" written by ABC on Mon Jul  6 14:22:51 2020
...
module FAU ( 
  ...
  oai21  g76(.a(new_n120_), .b(new_n114_), .c(x25), .O(new_n121_));
  inv1   g77(.a(x25), .O(new_n122_));
  nand4  g78(.a(new_n122_), .b(x24), .c(x23), .d(x22), .O(new_n123_));
  oai21  g79(.a(new_n123_), .b(new_n114_), .c(new_n121_), .O(new_n124_));
  nand2  g80(.a(new_n124_), .b(new_n102_), .O(new_n125_));
