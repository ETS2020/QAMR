// Benchmark "FAU" written by ABC on Mon Jul  6 14:21:15 2020
...
module FAU ( 
  ...
  nor2   g15(.a(new_n50_), .b(new_n59_), .O(z02));
  inv1   g16(.a(x02), .O(new_n61_));
  nor2   g17(.a(new_n50_), .b(new_n61_), .O(z03));
  nand2  g18(.a(x08), .b(x03), .O(new_n63_));
  inv1   g19(.a(new_n63_), .O(z04));
  inv1   g20(.a(x04), .O(new_n65_));
  nor2   g21(.a(new_n50_), .b(new_n65_), .O(z05));
  inv1   g22(.a(x05), .O(new_n67_));
  nor2   g23(.a(new_n50_), .b(new_n67_), .O(z06));
  ...
  nand2  g33(.a(new_n52_), .b(new_n77_), .O(new_n78_));
  oai21  g34(.a(new_n78_), .b(new_n76_), .c(new_n57_), .O(z09));
  nand3  g35(.a(x22), .b(x21), .c(x12), .O(new_n80_));
  oai21  g36(.a(new_n80_), .b(new_n73_), .c(x19), .O(new_n81_));
  nor2   g37(.a(x20), .b(new_n53_), .O(new_n82_));
  aoi21  g38(.a(new_n81_), .b(x20), .c(new_n82_), .O(new_n83_));
  oai22  g39(.a(new_n83_), .b(new_n78_), .c(new_n50_), .d(new_n59_), .O(z10));
  ...
  oai22  g47(.a(new_n91_), .b(new_n78_), .c(new_n50_), .d(new_n61_), .O(z11));
  inv1   g48(.a(new_n85_), .O(new_n93_));
  nand3  g49(.a(new_n93_), .b(x23), .c(x14), .O(new_n94_));
  nand3  g50(.a(new_n94_), .b(new_n87_), .c(x21), .O(new_n95_));
  ...
  nor2   g61(.a(new_n105_), .b(x23), .O(new_n106_));
  aoi22  g62(.a(new_n106_), .b(new_n87_), .c(new_n104_), .d(x23), .O(new_n107_));
  oai22  g63(.a(new_n107_), .b(new_n78_), .c(new_n50_), .d(new_n65_), .O(z13));
  ...
  oai22  g71(.a(new_n115_), .b(new_n78_), .c(new_n50_), .d(new_n67_), .O(z14));
  nand3  g72(.a(x24), .b(x23), .c(x22), .O(new_n117_));
  oai21  g73(.a(new_n117_), .b(new_n111_), .c(x25), .O(new_n118_));
  inv1   g74(.a(x25), .O(new_n119_));
  nand4  g75(.a(new_n119_), .b(x24), .c(x23), .d(x22), .O(new_n120_));
  oai21  g76(.a(new_n120_), .b(new_n111_), .c(new_n118_), .O(new_n121_));
  nand3  g77(.a(x26), .b(x25), .c(x17), .O(new_n122_));
  inv1   g78(.a(new_n122_), .O(new_n123_));
  aoi21  g79(.a(new_n121_), .b(new_n77_), .c(new_n123_), .O(new_n124_));
  oai21  g80(.a(new_n124_), .b(new_n51_), .c(new_n69_), .O(z15));
  nor2   g81(.a(new_n53_), .b(x18), .O(new_n126_));
  nand3  g82(.a(new_n126_), .b(new_n49_), .c(new_n45_), .O(new_n127_));
  inv1   g83(.a(x26), .O(new_n128_));
  nand4  g84(.a(new_n128_), .b(x25), .c(x22), .d(x21), .O(new_n129_));
  inv1   g85(.a(new_n129_), .O(new_n130_));
  nand3  g86(.a(new_n87_), .b(x24), .c(x23), .O(new_n131_));
  inv1   g87(.a(new_n131_), .O(new_n132_));
  aoi22  g88(.a(new_n132_), .b(new_n130_), .c(new_n127_), .d(x26), .O(new_n133_));
