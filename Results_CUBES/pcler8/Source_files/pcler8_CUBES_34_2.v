...
module FAU ( 
  ...
  nand3  g68(.a(new_n112_), .b(new_n111_), .c(x19), .O(new_n113_));
  inv1   g69(.a(x24), .O(new_n114_));
  nor2   g70(.a(new_n114_), .b(x20), .O(new_n115_));
  aoi21  g71(.a(new_n113_), .b(x20), .c(new_n115_), .O(new_n116_));
  oai22  g72(.a(new_n116_), .b(new_n76_), .c(new_n59_), .d(new_n67_), .O(z14));
  ...
  nand3  g81(.a(x25), .b(x23), .c(new_n125_), .O(new_n126_));
  oai21  g82(.a(new_n126_), .b(new_n104_), .c(x26), .O(new_n127_));
