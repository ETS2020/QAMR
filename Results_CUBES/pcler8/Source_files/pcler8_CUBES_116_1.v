// Benchmark "FAU" written by ABC on Mon Jul  6 14:22:02 2020
...
module FAU ( 
  ...
  oai21  g41(.a(new_n84_), .b(new_n83_), .c(new_n85_), .O(new_n86_));
  ...
  and2   g47(.a(x21), .b(x19), .O(new_n92_));
  oai21  g48(.a(new_n91_), .b(new_n83_), .c(new_n92_), .O(new_n93_));
  ...
  nand3  g59(.a(new_n92_), .b(new_n99_), .c(x22), .O(new_n104_));
  ...
  nand4  g65(.a(x23), .b(x22), .c(x21), .d(x19), .O(new_n110_));
  inv1   g66(.a(new_n110_), .O(new_n111_));
  aoi21  g67(.a(new_n111_), .b(new_n109_), .c(new_n108_), .O(new_n112_));
  nand2  g68(.a(x21), .b(x19), .O(new_n113_));
  nand3  g69(.a(new_n108_), .b(x23), .c(x22), .O(new_n114_));
  nor2   g70(.a(new_n114_), .b(new_n113_), .O(new_n115_));
  oai21  g71(.a(new_n115_), .b(new_n112_), .c(new_n75_), .O(new_n116_));
  nand2  g72(.a(new_n116_), .b(new_n65_), .O(z14));
  ...
  oai21  g81(.a(new_n125_), .b(new_n74_), .c(new_n67_), .O(z15));
  inv1   g82(.a(x18), .O(new_n127_));
  nand3  g83(.a(x25), .b(x24), .c(new_n127_), .O(new_n128_));
  oai21  g84(.a(new_n128_), .b(new_n110_), .c(x26), .O(new_n129_));
