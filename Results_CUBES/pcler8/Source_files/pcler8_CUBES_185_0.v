...
module FAU ( 
  ...
  oai21  g49(.a(new_n85_), .b(new_n93_), .c(x22), .O(new_n94_));
  nand3  g50(.a(x21), .b(x20), .c(x19), .O(new_n95_));
  inv1   g51(.a(new_n95_), .O(new_n96_));
  nand3  g52(.a(x21), .b(x20), .c(x19), .O(new_n97_));
  aoi22  g53(.a(new_n97_), .b(x22), .c(new_n96_), .d(new_n94_), .O(new_n98_));
  oai22  g54(.a(new_n98_), .b(new_n78_), .c(new_n57_), .d(new_n63_), .O(z12));
  ...
  nand3  g59(.a(new_n93_), .b(x22), .c(x21), .O(new_n104_));
  nor2   g60(.a(new_n104_), .b(new_n87_), .O(new_n105_));
  aoi21  g61(.a(new_n103_), .b(x23), .c(new_n105_), .O(new_n106_));
  oai21  g62(.a(new_n106_), .b(new_n78_), .c(new_n65_), .O(z13));
  inv1   g63(.a(new_n97_), .O(new_n108_));
  nand3  g64(.a(x26), .b(x25), .c(x16), .O(new_n109_));
  nand4  g65(.a(new_n109_), .b(new_n108_), .c(x23), .d(x22), .O(new_n110_));
  nand2  g66(.a(x23), .b(x22), .O(new_n111_));
  nor3   g67(.a(new_n97_), .b(new_n111_), .c(x24), .O(new_n112_));
  ...
  nand3  g73(.a(new_n117_), .b(new_n115_), .c(new_n108_), .O(new_n118_));
  inv1   g74(.a(x25), .O(new_n119_));
  nand4  g75(.a(new_n119_), .b(x24), .c(x23), .d(x22), .O(new_n120_));
  inv1   g76(.a(new_n120_), .O(new_n121_));
  aoi22  g77(.a(new_n121_), .b(new_n108_), .c(new_n118_), .d(x25), .O(new_n122_));
