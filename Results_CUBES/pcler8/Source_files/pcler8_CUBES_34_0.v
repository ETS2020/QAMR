// Benchmark "FAU" written by ABC on Mon Jul  6 14:21:25 2020
...
module FAU ( 
  ...
  nor2   g27(.a(x24), .b(x20), .O(new_n72_));
  ...
  oai22  g40(.a(new_n84_), .b(new_n77_), .c(new_n56_), .d(new_n58_), .O(z10));
  ...
  oai21  g48(.a(new_n92_), .b(new_n77_), .c(new_n60_), .O(z11));
  ...
  nand2  g64(.a(new_n108_), .b(new_n103_), .O(new_n109_));
  nor2   g65(.a(new_n109_), .b(new_n88_), .O(new_n110_));
  oai21  g66(.a(new_n110_), .b(new_n107_), .c(new_n78_), .O(new_n111_));
  nand2  g67(.a(new_n111_), .b(new_n64_), .O(z13));
  inv1   g68(.a(x24), .O(new_n113_));
  nand4  g69(.a(new_n113_), .b(x23), .c(x22), .d(x21), .O(new_n114_));
  aoi21  g70(.a(new_n114_), .b(x20), .c(new_n51_), .O(new_n115_));
  nand3  g71(.a(x26), .b(x25), .c(x16), .O(new_n116_));
  nand4  g72(.a(x23), .b(x22), .c(x21), .d(x19), .O(new_n117_));
  inv1   g73(.a(new_n117_), .O(new_n118_));
  aoi21  g74(.a(new_n118_), .b(new_n116_), .c(new_n113_), .O(new_n119_));
  oai21  g75(.a(new_n119_), .b(new_n115_), .c(new_n78_), .O(new_n120_));
  ...
  oai21  g87(.a(new_n131_), .b(new_n77_), .c(new_n68_), .O(z15));
  inv1   g88(.a(x18), .O(new_n133_));
  nand4  g89(.a(x25), .b(x24), .c(x19), .d(new_n133_), .O(new_n134_));
  oai21  g90(.a(new_n134_), .b(new_n47_), .c(x26), .O(new_n135_));
  nor2   g91(.a(new_n113_), .b(new_n103_), .O(new_n136_));
  nor2   g92(.a(x26), .b(new_n128_), .O(new_n137_));
  nand4  g93(.a(new_n137_), .b(new_n89_), .c(new_n108_), .d(new_n136_), .O(new_n138_));
  nand2  g94(.a(new_n138_), .b(new_n135_), .O(new_n139_));
  nand2  g95(.a(new_n139_), .b(new_n78_), .O(new_n140_));
