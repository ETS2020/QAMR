...
module FAU ( 
  ...
  nor2   g29(.a(x23), .b(x22), .O(new_n74_));
  ...
  oai22  g40(.a(new_n84_), .b(new_n80_), .c(new_n57_), .d(new_n59_), .O(z10));
  ...
  oai21  g48(.a(new_n92_), .b(new_n80_), .c(new_n61_), .O(z11));
  nand2  g49(.a(x23), .b(x14), .O(new_n94_));
  oai21  g50(.a(new_n94_), .b(new_n86_), .c(x19), .O(new_n95_));
  inv1   g51(.a(x23), .O(new_n96_));
  nand2  g52(.a(x21), .b(x20), .O(new_n97_));
  oai21  g53(.a(new_n96_), .b(x22), .c(new_n97_), .O(new_n98_));
  inv1   g54(.a(x22), .O(new_n99_));
  nand4  g55(.a(new_n99_), .b(x21), .c(x20), .d(x19), .O(new_n100_));
  nand2  g56(.a(new_n100_), .b(new_n98_), .O(new_n101_));
  aoi21  g57(.a(new_n95_), .b(x22), .c(new_n101_), .O(new_n102_));
  oai21  g58(.a(new_n102_), .b(new_n80_), .c(new_n63_), .O(z12));
  nand4  g59(.a(x26), .b(x25), .c(x24), .d(x15), .O(new_n104_));
  nand2  g60(.a(new_n97_), .b(x22), .O(new_n105_));
  nand3  g61(.a(new_n105_), .b(new_n104_), .c(x19), .O(new_n106_));
  nand2  g62(.a(new_n96_), .b(x21), .O(new_n107_));
  oai21  g63(.a(new_n107_), .b(new_n88_), .c(x22), .O(new_n108_));
  aoi21  g64(.a(new_n106_), .b(x23), .c(new_n108_), .O(new_n109_));
  oai21  g65(.a(new_n109_), .b(new_n80_), .c(new_n65_), .O(z13));
  ...
  oai21  g73(.a(new_n117_), .b(new_n80_), .c(new_n67_), .O(z14));
