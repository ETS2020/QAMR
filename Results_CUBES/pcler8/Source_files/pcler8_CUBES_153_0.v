...
module FAU ( 
  ...
  nand3  g30(.a(x22), .b(x21), .c(x11), .O(new_n75_));
  ...
  oai21  g67(.a(new_n111_), .b(new_n86_), .c(new_n65_), .O(z13));
  ...
  oai21  g75(.a(new_n119_), .b(new_n86_), .c(new_n67_), .O(z14));
  ...
  oai21  g84(.a(new_n128_), .b(new_n86_), .c(new_n69_), .O(z15));
  ...
  oai21  g92(.a(new_n136_), .b(new_n86_), .c(new_n71_), .O(z16));
endmodule
