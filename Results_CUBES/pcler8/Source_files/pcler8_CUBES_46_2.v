// Benchmark "FAU" written by ABC on Mon Jul  6 14:21:30 2020
...
module FAU ( 
  ...
  nand3  g77(.a(new_n121_), .b(new_n120_), .c(x20), .O(new_n122_));
  inv1   g78(.a(x25), .O(new_n123_));
  nor2   g79(.a(new_n123_), .b(x19), .O(new_n124_));
  aoi21  g80(.a(new_n122_), .b(x19), .c(new_n124_), .O(new_n125_));
