// Benchmark "FAU" written by ABC on Mon Jul  6 14:22:38 2020
...
module FAU ( 
  ...
  nand2  g39(.a(x23), .b(x13), .O(new_n84_));
  ...
  nor2   g47(.a(new_n91_), .b(new_n78_), .O(new_n92_));
  inv1   g48(.a(x22), .O(new_n93_));
  nand3  g49(.a(x21), .b(x20), .c(x19), .O(new_n94_));
  inv1   g50(.a(new_n94_), .O(new_n95_));
  nand2  g51(.a(new_n93_), .b(x21), .O(new_n96_));
  oai22  g52(.a(new_n96_), .b(new_n87_), .c(new_n95_), .d(new_n93_), .O(new_n97_));
  oai21  g53(.a(new_n97_), .b(new_n92_), .c(new_n75_), .O(new_n98_));
  ...
  nand3  g67(.a(new_n111_), .b(new_n109_), .c(new_n95_), .O(new_n112_));
  nor3   g68(.a(new_n110_), .b(new_n94_), .c(x24), .O(new_n113_));
  ...
  oai21  g73(.a(new_n117_), .b(new_n94_), .c(x25), .O(new_n118_));
  inv1   g74(.a(x25), .O(new_n119_));
  nand4  g75(.a(new_n111_), .b(new_n95_), .c(new_n119_), .d(x24), .O(new_n120_));
  nand2  g76(.a(new_n120_), .b(new_n118_), .O(new_n121_));
  nand2  g77(.a(new_n121_), .b(new_n75_), .O(new_n122_));
  nand2  g78(.a(new_n122_), .b(new_n67_), .O(z15));
  inv1   g79(.a(x18), .O(new_n124_));
  nand3  g80(.a(x25), .b(x24), .c(new_n124_), .O(new_n125_));
  nand4  g81(.a(x23), .b(x21), .c(x20), .d(x19), .O(new_n126_));
  oai21  g82(.a(new_n126_), .b(new_n125_), .c(x26), .O(new_n127_));
  nor2   g83(.a(x26), .b(new_n119_), .O(new_n128_));
  nand4  g84(.a(new_n128_), .b(new_n95_), .c(x24), .d(x23), .O(new_n129_));
