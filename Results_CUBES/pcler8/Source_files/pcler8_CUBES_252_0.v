// Benchmark "FAU" written by ABC on Mon Jul  6 14:23:04 2020
...
module FAU ( 
  ...
  nor2   g16(.a(new_n58_), .b(new_n60_), .O(z03));
  ...
  nand2  g32(.a(new_n76_), .b(new_n55_), .O(z09));
  ...
  oai22  g39(.a(new_n83_), .b(new_n78_), .c(new_n58_), .d(new_n57_), .O(z10));
  ...
  oai22  g47(.a(new_n91_), .b(new_n78_), .c(new_n58_), .d(new_n60_), .O(z11));
  ...
  aoi22  g62(.a(new_n106_), .b(new_n88_), .c(new_n104_), .d(x23), .O(new_n107_));
  oai22  g63(.a(new_n107_), .b(new_n78_), .c(new_n58_), .d(new_n64_), .O(z13));
  nand3  g64(.a(x26), .b(x25), .c(x16), .O(new_n109_));
  nand3  g65(.a(new_n109_), .b(new_n95_), .c(new_n46_), .O(new_n110_));
  nor3   g66(.a(new_n94_), .b(new_n45_), .c(x24), .O(new_n111_));
  aoi21  g67(.a(new_n110_), .b(x24), .c(new_n111_), .O(new_n112_));
  oai22  g68(.a(new_n112_), .b(new_n78_), .c(new_n58_), .d(new_n66_), .O(z14));
  ...
  nor3   g73(.a(new_n117_), .b(new_n94_), .c(new_n45_), .O(new_n118_));
  ...
  nand4  g77(.a(new_n121_), .b(x25), .c(x24), .d(x21), .O(new_n122_));
  oai21  g78(.a(new_n122_), .b(new_n45_), .c(x20), .O(new_n123_));
  nand3  g79(.a(x25), .b(x24), .c(x21), .O(new_n124_));
  inv1   g80(.a(new_n124_), .O(new_n125_));
  nor2   g81(.a(new_n81_), .b(x18), .O(new_n126_));
  nand3  g82(.a(new_n126_), .b(new_n125_), .c(new_n46_), .O(new_n127_));
  aoi22  g83(.a(new_n127_), .b(x26), .c(new_n123_), .d(x19), .O(new_n128_));
  oai21  g84(.a(new_n128_), .b(new_n78_), .c(new_n70_), .O(z16));
endmodule
