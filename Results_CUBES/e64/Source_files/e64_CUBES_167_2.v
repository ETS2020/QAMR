...
module FAU ( 
  ...
  nand3  g326(.a(new_n360_), .b(new_n348_), .c(new_n157_), .O(new_n457_));
  nor4   g327(.a(new_n457_), .b(new_n456_), .c(new_n380_), .d(new_n356_), .O(z24));
  nand2  g328(.a(new_n349_), .b(new_n286_), .O(new_n459_));
  nand4  g329(.a(new_n357_), .b(new_n264_), .c(new_n337_), .d(x24), .O(new_n460_));
  ...
  nand2  g349(.a(new_n378_), .b(new_n328_), .O(new_n480_));
  ...
  nand4  g510(.a(new_n640_), .b(new_n546_), .c(new_n423_), .d(new_n327_), .O(new_n641_));
  ...
  nand4  g516(.a(new_n376_), .b(new_n340_), .c(new_n203_), .d(new_n165_), .O(new_n647_));
  ...
  nor4   g531(.a(new_n661_), .b(new_n656_), .c(new_n379_), .d(new_n329_), .O(z61));
  nor2   g532(.a(new_n380_), .b(new_n375_), .O(new_n663_));
  nand2  g533(.a(new_n348_), .b(x47), .O(new_n664_));
  nor2   g534(.a(new_n664_), .b(new_n656_), .O(new_n665_));
