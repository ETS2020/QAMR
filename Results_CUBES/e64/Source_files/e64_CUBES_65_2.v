...
module FAU ( 
  ...
  wire new_n135_, new_n136_, new_n138_, new_n139_, new_n140_, new_n141_,
    ...
    new_n328_, new_n332_, new_n333_, new_n334_, new_n335_, new_n336_,
  ...
  nor2   g158(.a(x55), .b(x51), .O(new_n302_));
  nor2   g159(.a(x43), .b(x41), .O(new_n303_));
  nand2  g160(.a(new_n303_), .b(new_n212_), .O(new_n304_));
  inv1   g161(.a(new_n304_), .O(new_n305_));
  nand4  g162(.a(new_n305_), .b(new_n302_), .c(new_n301_), .d(new_n213_), .O(new_n306_));
  ...
  nand3  g178(.a(new_n321_), .b(new_n303_), .c(new_n313_), .O(new_n322_));
  ...
  nand4  g184(.a(new_n327_), .b(new_n323_), .c(new_n318_), .d(new_n240_), .O(new_n328_));
  inv1   g185(.a(new_n328_), .O(z36));
  nand4  g186(.a(new_n324_), .b(new_n319_), .c(new_n305_), .d(new_n301_), .O(new_n332_));
  nor2   g187(.a(x06), .b(x04), .O(new_n333_));
  nand3  g188(.a(new_n333_), .b(new_n238_), .c(new_n168_), .O(new_n334_));
  inv1   g189(.a(new_n334_), .O(new_n335_));
  nand3  g190(.a(new_n335_), .b(new_n315_), .c(new_n311_), .O(new_n336_));
  nor2   g191(.a(new_n336_), .b(new_n332_), .O(z39));
  inv1   g192(.a(x56), .O(new_n352_));
  nand2  g193(.a(new_n352_), .b(x55), .O(new_n353_));
  nor2   g194(.a(new_n353_), .b(new_n211_), .O(new_n354_));
  nand4  g195(.a(new_n354_), .b(new_n323_), .c(new_n318_), .d(new_n240_), .O(new_n355_));
  inv1   g196(.a(new_n355_), .O(z54));
  inv1   g197(.a(new_n320_), .O(new_n357_));
  nand2  g198(.a(new_n303_), .b(new_n313_), .O(new_n358_));
  inv1   g199(.a(new_n358_), .O(new_n359_));
  nor2   g200(.a(x37), .b(new_n312_), .O(new_n360_));
  nand4  g201(.a(new_n360_), .b(new_n359_), .c(new_n357_), .d(new_n156_), .O(new_n361_));
  nor2   g202(.a(new_n361_), .b(new_n247_), .O(z55));
  inv1   g203(.a(x08), .O(new_n364_));
  nand4  g204(.a(new_n364_), .b(new_n185_), .c(new_n166_), .d(new_n184_), .O(new_n365_));
  nor2   g205(.a(new_n365_), .b(new_n227_), .O(new_n366_));
  inv1   g206(.a(x22), .O(new_n367_));
  nand3  g207(.a(new_n176_), .b(new_n367_), .c(x18), .O(new_n368_));
  nor2   g208(.a(new_n368_), .b(new_n174_), .O(new_n369_));
  nand2  g209(.a(new_n369_), .b(new_n366_), .O(new_n370_));
  nor2   g210(.a(new_n370_), .b(new_n165_), .O(z57));
  inv1   g211(.a(new_n214_), .O(new_n372_));
  nand3  g212(.a(new_n372_), .b(new_n248_), .c(new_n164_), .O(new_n373_));
  inv1   g213(.a(x24), .O(new_n374_));
  nand3  g214(.a(new_n222_), .b(new_n374_), .c(x22), .O(new_n375_));
  nor2   g215(.a(new_n375_), .b(new_n256_), .O(new_n376_));
  nand2  g216(.a(new_n376_), .b(new_n366_), .O(new_n377_));
  nor2   g217(.a(new_n377_), .b(new_n373_), .O(z58));
  nor2   g218(.a(x58), .b(x50), .O(new_n379_));
  nand3  g219(.a(new_n379_), .b(new_n198_), .c(x40), .O(new_n380_));
  nor2   g220(.a(new_n380_), .b(new_n197_), .O(z59));
  nor2   g221(.a(x08), .b(new_n185_), .O(new_n382_));
  nand2  g222(.a(new_n154_), .b(new_n152_), .O(new_n383_));
  nor2   g223(.a(new_n383_), .b(new_n233_), .O(new_n384_));
  nand4  g224(.a(new_n384_), .b(new_n382_), .c(new_n230_), .d(new_n228_), .O(new_n385_));
  inv1   g225(.a(new_n385_), .O(z60));
  nor2   g226(.a(x10), .b(new_n364_), .O(new_n387_));
  nand4  g227(.a(new_n387_), .b(new_n222_), .c(new_n187_), .d(new_n182_), .O(new_n388_));
  nand2  g228(.a(new_n213_), .b(new_n210_), .O(new_n389_));
  inv1   g229(.a(new_n389_), .O(new_n390_));
  nand2  g230(.a(new_n212_), .b(new_n206_), .O(new_n391_));
  inv1   g231(.a(new_n391_), .O(new_n392_));
  nand4  g232(.a(new_n392_), .b(new_n390_), .c(new_n161_), .d(new_n143_), .O(new_n393_));
  nor2   g233(.a(new_n393_), .b(new_n388_), .O(z61));
  nor2   g234(.a(new_n265_), .b(new_n227_), .O(new_n395_));
  nand2  g235(.a(new_n269_), .b(x47), .O(new_n396_));
  nor2   g236(.a(new_n396_), .b(new_n383_), .O(new_n397_));
  nand4  g237(.a(new_n397_), .b(new_n395_), .c(new_n273_), .d(new_n161_), .O(new_n398_));
  inv1   g238(.a(new_n398_), .O(z62));
  nand3  g239(.a(new_n379_), .b(new_n152_), .c(x56), .O(new_n400_));
  inv1   g240(.a(new_n400_), .O(new_n401_));
  nand4  g241(.a(new_n401_), .b(new_n395_), .c(new_n273_), .d(new_n161_), .O(new_n402_));
  inv1   g242(.a(new_n402_), .O(z63));
  nor2   g243(.a(x37), .b(new_n241_), .O(new_n404_));
  nand4  g244(.a(new_n404_), .b(new_n313_), .c(new_n282_), .d(new_n157_), .O(new_n405_));
  nor3   g245(.a(new_n405_), .b(new_n265_), .c(new_n227_), .O(z64));
  zero   g246(.O(z00));
  zero   g247(.O(z01));
  zero   g248(.O(z02));
  zero   g249(.O(z03));
