// Benchmark "FAU" written by ABC on Mon Jul  6 13:46:25 2020
...
module FAU ( 
  ...
  inv1   g490(.a(new_n361_), .O(new_n621_));
  nand3  g491(.a(new_n413_), .b(new_n621_), .c(new_n519_), .O(new_n622_));
  nand4  g492(.a(new_n374_), .b(new_n336_), .c(new_n205_), .d(new_n196_), .O(new_n623_));
  inv1   g493(.a(x22), .O(new_n624_));
  nand3  g494(.a(new_n152_), .b(new_n624_), .c(x18), .O(new_n625_));
  nor4   g495(.a(new_n625_), .b(new_n623_), .c(new_n622_), .d(new_n375_), .O(z57));
  nand2  g496(.a(new_n323_), .b(new_n284_), .O(new_n627_));
  nand3  g497(.a(new_n232_), .b(new_n231_), .c(x22), .O(new_n628_));
  nor4   g498(.a(new_n628_), .b(new_n627_), .c(new_n623_), .d(new_n622_), .O(z58));
