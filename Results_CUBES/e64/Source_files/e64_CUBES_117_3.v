// Benchmark "FAU" written by ABC on Mon Jul  6 13:46:04 2020
...
module FAU ( 
  ...
  nor3   g012(.a(x62), .b(x60), .c(x59), .O(new_n143_));
  ...
  nor2   g048(.a(x62), .b(x60), .O(new_n179_));
  ...
  nand3  g113(.a(new_n243_), .b(new_n242_), .c(new_n178_), .O(new_n244_));
  ...
  nor2   g135(.a(new_n149_), .b(x28), .O(new_n266_));
  inv1   g136(.a(new_n266_), .O(new_n267_));
  nor2   g137(.a(x31), .b(x30), .O(new_n268_));
  nand2  g138(.a(new_n268_), .b(new_n251_), .O(new_n269_));
  nor3   g139(.a(new_n269_), .b(new_n267_), .c(new_n265_), .O(new_n270_));
  nand4  g140(.a(new_n270_), .b(new_n233_), .c(new_n228_), .d(new_n223_), .O(new_n271_));
  nand3  g141(.a(new_n179_), .b(new_n240_), .c(new_n239_), .O(new_n272_));
  inv1   g142(.a(x57), .O(new_n273_));
  nand3  g143(.a(new_n132_), .b(new_n178_), .c(new_n273_), .O(new_n274_));
  inv1   g144(.a(x55), .O(new_n275_));
  nand3  g145(.a(new_n235_), .b(new_n275_), .c(new_n181_), .O(new_n276_));
  nor3   g146(.a(new_n276_), .b(new_n274_), .c(new_n272_), .O(new_n277_));
  nor2   g147(.a(x41), .b(x39), .O(new_n278_));
  nand3  g148(.a(new_n278_), .b(new_n250_), .c(new_n154_), .O(new_n279_));
  ...
  nor4   g159(.a(new_n289_), .b(new_n267_), .c(x15), .d(new_n220_), .O(z06));
  ...
  nor3   g164(.a(new_n244_), .b(new_n241_), .c(new_n236_), .O(new_n295_));
  inv1   g165(.a(x39), .O(new_n296_));
  nand2  g166(.a(new_n296_), .b(x38), .O(new_n297_));
  nor2   g167(.a(new_n297_), .b(new_n193_), .O(new_n298_));
  nand4  g168(.a(new_n298_), .b(new_n295_), .c(new_n294_), .d(new_n138_), .O(new_n299_));
  nor2   g169(.a(new_n299_), .b(new_n271_), .O(z08));
  nand2  g170(.a(new_n228_), .b(new_n223_), .O(new_n301_));
  nor2   g171(.a(new_n276_), .b(new_n192_), .O(new_n302_));
  ...
  nand2  g176(.a(new_n266_), .b(new_n231_), .O(new_n307_));
  nor3   g177(.a(new_n307_), .b(x24), .c(new_n229_), .O(new_n308_));
  nor2   g178(.a(x45), .b(x43), .O(new_n309_));
  nor2   g179(.a(x42), .b(x40), .O(new_n310_));
  nand4  g180(.a(new_n310_), .b(new_n309_), .c(new_n278_), .d(new_n255_), .O(new_n311_));
  nor3   g181(.a(new_n311_), .b(new_n269_), .c(new_n265_), .O(new_n312_));
  nand4  g182(.a(new_n312_), .b(new_n308_), .c(new_n306_), .d(new_n302_), .O(new_n313_));
  nor2   g183(.a(new_n313_), .b(new_n301_), .O(z09));
  nand3  g184(.a(new_n291_), .b(x28), .c(new_n285_), .O(new_n315_));
  ...
  nand2  g189(.a(new_n179_), .b(new_n132_), .O(new_n320_));
  ...
  nand4  g214(.a(new_n344_), .b(new_n266_), .c(new_n287_), .d(new_n285_), .O(new_n345_));
  ...
  nand3  g232(.a(new_n335_), .b(new_n211_), .c(x03), .O(new_n363_));
  ...
  nand2  g244(.a(new_n266_), .b(new_n169_), .O(new_n375_));
  nor2   g245(.a(new_n375_), .b(new_n374_), .O(new_n376_));
  nand3  g246(.a(new_n132_), .b(x62), .c(new_n242_), .O(new_n377_));
  ...
  nand2  g257(.a(new_n387_), .b(new_n263_), .O(new_n388_));
  nand3  g258(.a(new_n268_), .b(x29), .c(new_n247_), .O(new_n389_));
  nor2   g259(.a(new_n389_), .b(new_n388_), .O(new_n390_));
  nand2  g260(.a(new_n309_), .b(new_n190_), .O(new_n391_));
  nand2  g261(.a(new_n373_), .b(new_n257_), .O(new_n392_));
  ...
  nand2  g265(.a(new_n255_), .b(new_n191_), .O(new_n396_));
  nor2   g266(.a(new_n396_), .b(new_n184_), .O(new_n397_));
  and2   g267(.a(new_n243_), .b(new_n143_), .O(new_n398_));
  ...
  nand2  g271(.a(new_n211_), .b(new_n161_), .O(new_n402_));
  inv1   g272(.a(new_n402_), .O(new_n403_));
  nand2  g273(.a(new_n335_), .b(new_n403_), .O(new_n404_));
  inv1   g274(.a(new_n404_), .O(new_n405_));
  inv1   g275(.a(x30), .O(new_n406_));
  nand2  g276(.a(new_n266_), .b(new_n406_), .O(new_n407_));
  inv1   g277(.a(new_n407_), .O(new_n408_));
  nand2  g278(.a(new_n231_), .b(new_n168_), .O(new_n409_));
  nor2   g279(.a(new_n409_), .b(new_n362_), .O(new_n410_));
  nand4  g280(.a(new_n410_), .b(new_n408_), .c(new_n405_), .d(new_n401_), .O(new_n411_));
  nand3  g281(.a(new_n322_), .b(new_n157_), .c(new_n156_), .O(new_n412_));
  inv1   g282(.a(x51), .O(new_n413_));
  nor2   g283(.a(x56), .b(new_n413_), .O(new_n414_));
  nand3  g284(.a(new_n414_), .b(new_n355_), .c(new_n135_), .O(new_n415_));
  nor3   g285(.a(new_n415_), .b(new_n412_), .c(new_n411_), .O(z20));
  inv1   g286(.a(x41), .O(new_n417_));
  nand3  g287(.a(new_n373_), .b(new_n288_), .c(new_n417_), .O(new_n418_));
  nand2  g288(.a(new_n372_), .b(new_n266_), .O(new_n419_));
  nor2   g289(.a(new_n419_), .b(new_n418_), .O(new_n420_));
  nand2  g290(.a(new_n420_), .b(new_n359_), .O(new_n421_));
  nand4  g291(.a(new_n410_), .b(new_n405_), .c(new_n140_), .d(x00), .O(new_n422_));
  nor2   g292(.a(new_n422_), .b(new_n421_), .O(z21));
  nand4  g293(.a(new_n384_), .b(new_n328_), .c(new_n381_), .d(new_n203_), .O(new_n424_));
  nand2  g294(.a(new_n136_), .b(new_n131_), .O(new_n425_));
  nor3   g295(.a(new_n425_), .b(new_n274_), .c(new_n272_), .O(new_n426_));
  nor2   g296(.a(new_n389_), .b(new_n383_), .O(new_n427_));
  nand3  g297(.a(new_n157_), .b(new_n296_), .c(x36), .O(new_n428_));
  nor2   g298(.a(new_n428_), .b(new_n388_), .O(new_n429_));
  nand2  g299(.a(new_n154_), .b(new_n135_), .O(new_n430_));
  nor2   g300(.a(new_n430_), .b(new_n256_), .O(new_n431_));
  nand4  g301(.a(new_n431_), .b(new_n429_), .c(new_n427_), .d(new_n426_), .O(new_n432_));
  nor2   g302(.a(new_n432_), .b(new_n424_), .O(z22));
  nand3  g303(.a(new_n328_), .b(new_n381_), .c(new_n203_), .O(new_n434_));
  nand2  g304(.a(new_n294_), .b(new_n138_), .O(new_n435_));
  ...
  nand2  g316(.a(new_n268_), .b(new_n263_), .O(new_n447_));
  nor2   g317(.a(new_n447_), .b(new_n307_), .O(new_n448_));
  nand4  g318(.a(new_n448_), .b(new_n446_), .c(new_n441_), .d(new_n295_), .O(new_n449_));
  nor2   g319(.a(new_n449_), .b(new_n434_), .O(z23));
  nand3  g320(.a(new_n344_), .b(new_n285_), .c(x11), .O(new_n451_));
  ...
  nand2  g324(.a(new_n344_), .b(new_n285_), .O(new_n455_));
  nand3  g325(.a(new_n266_), .b(new_n331_), .c(x24), .O(new_n456_));
  nor4   g326(.a(new_n456_), .b(new_n453_), .c(new_n352_), .d(new_n455_), .O(z25));
  inv1   g327(.a(new_n223_), .O(new_n458_));
  inv1   g328(.a(new_n276_), .O(new_n459_));
  inv1   g329(.a(new_n396_), .O(new_n460_));
  nand2  g330(.a(new_n460_), .b(new_n459_), .O(new_n461_));
  nor2   g331(.a(new_n461_), .b(new_n305_), .O(new_n462_));
  nand3  g332(.a(new_n382_), .b(new_n444_), .c(new_n225_), .O(new_n463_));
  nor2   g333(.a(new_n463_), .b(new_n307_), .O(new_n464_));
  nand2  g334(.a(new_n264_), .b(new_n146_), .O(new_n465_));
  inv1   g335(.a(x33), .O(new_n466_));
  nand3  g336(.a(new_n268_), .b(new_n466_), .c(x32), .O(new_n467_));
  ...
  nand2  g342(.a(new_n294_), .b(new_n436_), .O(new_n473_));
  ...
  nand4  g357(.a(new_n460_), .b(new_n131_), .c(new_n181_), .d(x52), .O(new_n488_));
  nor2   g358(.a(new_n488_), .b(new_n305_), .O(new_n489_));
  inv1   g359(.a(new_n198_), .O(new_n490_));
  nand2  g360(.a(new_n226_), .b(new_n490_), .O(new_n491_));
  ...
  nor3   g370(.a(new_n198_), .b(x22), .c(new_n444_), .O(new_n501_));
  nand4  g371(.a(new_n501_), .b(new_n498_), .c(new_n397_), .d(new_n245_), .O(new_n502_));
  ...
  nand2  g377(.a(new_n328_), .b(new_n266_), .O(new_n508_));
  nor3   g378(.a(new_n508_), .b(new_n289_), .c(new_n177_), .O(z34));
  nand2  g379(.a(new_n191_), .b(new_n183_), .O(new_n510_));
  inv1   g380(.a(new_n510_), .O(new_n511_));
  nand3  g381(.a(new_n190_), .b(new_n288_), .c(new_n417_), .O(new_n512_));
  inv1   g382(.a(new_n512_), .O(new_n513_));
  nand3  g383(.a(new_n513_), .b(new_n511_), .c(new_n355_), .O(new_n514_));
  nand4  g384(.a(new_n163_), .b(new_n401_), .c(new_n161_), .d(x04), .O(new_n515_));
  nor2   g385(.a(new_n370_), .b(new_n170_), .O(new_n516_));
  nor2   g386(.a(x37), .b(x35), .O(new_n517_));
  nand2  g387(.a(new_n517_), .b(new_n373_), .O(new_n518_));
  ...
  nand3  g391(.a(new_n252_), .b(new_n436_), .c(new_n156_), .O(new_n523_));
  nor2   g392(.a(new_n523_), .b(new_n435_), .O(new_n524_));
  nand2  g393(.a(new_n226_), .b(new_n169_), .O(new_n525_));
  nor3   g394(.a(new_n525_), .b(x20), .c(new_n224_), .O(new_n526_));
  nand2  g395(.a(new_n251_), .b(new_n145_), .O(new_n527_));
  nor2   g396(.a(new_n527_), .b(new_n151_), .O(new_n528_));
  nand4  g397(.a(new_n528_), .b(new_n526_), .c(new_n524_), .d(new_n295_), .O(new_n529_));
  nor2   g398(.a(new_n529_), .b(new_n458_), .O(z37));
  nor4   g399(.a(new_n402_), .b(new_n141_), .c(x08), .d(x04), .O(new_n531_));
  nand2  g400(.a(new_n490_), .b(new_n168_), .O(new_n532_));
  inv1   g401(.a(new_n532_), .O(new_n533_));
  nand2  g402(.a(new_n373_), .b(new_n417_), .O(new_n534_));
  nand2  g403(.a(new_n517_), .b(new_n150_), .O(new_n535_));
  nor2   g404(.a(new_n535_), .b(new_n534_), .O(new_n536_));
  nand4  g405(.a(new_n536_), .b(new_n533_), .c(new_n531_), .d(new_n371_), .O(new_n537_));
  nand3  g406(.a(new_n452_), .b(new_n238_), .c(x59), .O(new_n538_));
  nand3  g407(.a(new_n511_), .b(new_n190_), .c(new_n154_), .O(new_n539_));
  or2    g408(.a(new_n539_), .b(new_n538_), .O(new_n540_));
  nor2   g409(.a(new_n540_), .b(new_n537_), .O(z38));
  nand3  g410(.a(new_n190_), .b(new_n288_), .c(x42), .O(new_n542_));
  inv1   g411(.a(new_n542_), .O(new_n543_));
  nand3  g412(.a(new_n543_), .b(new_n511_), .c(new_n355_), .O(new_n544_));
  nor2   g413(.a(new_n544_), .b(new_n537_), .O(z39));
  nand3  g414(.a(new_n172_), .b(new_n171_), .c(new_n164_), .O(new_n546_));
  inv1   g415(.a(new_n546_), .O(new_n547_));
  nor2   g416(.a(new_n170_), .b(new_n151_), .O(new_n548_));
  nand3  g417(.a(new_n387_), .b(new_n263_), .c(new_n257_), .O(new_n549_));
  nand2  g418(.a(new_n135_), .b(new_n413_), .O(new_n550_));
  nor3   g419(.a(new_n550_), .b(new_n549_), .c(new_n479_), .O(new_n551_));
  nand4  g420(.a(new_n551_), .b(new_n548_), .c(new_n547_), .d(new_n531_), .O(new_n552_));
  nand4  g421(.a(new_n143_), .b(new_n132_), .c(new_n275_), .d(x54), .O(new_n553_));
  nor2   g422(.a(new_n553_), .b(new_n552_), .O(z40));
  nand3  g423(.a(new_n548_), .b(new_n547_), .c(new_n531_), .O(new_n555_));
  inv1   g424(.a(x34), .O(new_n556_));
  nand3  g425(.a(new_n517_), .b(new_n556_), .c(x33), .O(new_n557_));
  nor2   g426(.a(new_n557_), .b(new_n392_), .O(new_n558_));
  nand3  g427(.a(new_n132_), .b(new_n275_), .c(new_n413_), .O(new_n559_));
  inv1   g428(.a(new_n559_), .O(new_n560_));
  nand4  g429(.a(new_n560_), .b(new_n558_), .c(new_n324_), .d(new_n143_), .O(new_n561_));
  nor2   g430(.a(new_n561_), .b(new_n555_), .O(z41));
  nand2  g431(.a(new_n395_), .b(new_n381_), .O(new_n563_));
  inv1   g432(.a(x49), .O(new_n564_));
  nor2   g433(.a(x50), .b(new_n564_), .O(new_n565_));
  nand4  g434(.a(new_n565_), .b(new_n143_), .c(new_n136_), .d(new_n134_), .O(new_n566_));
  nor2   g435(.a(new_n566_), .b(new_n563_), .O(z42));
  inv1   g436(.a(new_n192_), .O(new_n568_));
  nand4  g437(.a(new_n309_), .b(new_n257_), .c(new_n568_), .d(new_n185_), .O(new_n569_));
  nand2  g438(.a(new_n384_), .b(new_n382_), .O(new_n570_));
  nor2   g439(.a(new_n570_), .b(new_n307_), .O(new_n571_));
  nand2  g440(.a(new_n387_), .b(new_n373_), .O(new_n572_));
  nor2   g441(.a(new_n572_), .b(new_n447_), .O(new_n573_));
  nand4  g442(.a(new_n160_), .b(new_n210_), .c(new_n215_), .d(x01), .O(new_n574_));
  nor2   g443(.a(new_n574_), .b(new_n141_), .O(new_n575_));
  nand2  g444(.a(new_n205_), .b(new_n204_), .O(new_n576_));
  nor3   g445(.a(new_n370_), .b(new_n402_), .c(new_n576_), .O(new_n577_));
  nand4  g446(.a(new_n577_), .b(new_n575_), .c(new_n573_), .d(new_n571_), .O(new_n578_));
  nor2   g447(.a(new_n578_), .b(new_n569_), .O(z43));
  nand2  g448(.a(new_n254_), .b(new_n154_), .O(new_n580_));
  inv1   g449(.a(new_n580_), .O(new_n581_));
  nand4  g450(.a(new_n581_), .b(new_n143_), .c(new_n138_), .d(new_n134_), .O(new_n582_));
  nor2   g451(.a(new_n158_), .b(new_n147_), .O(new_n583_));
  nor4   g452(.a(new_n162_), .b(new_n141_), .c(x04), .d(new_n215_), .O(new_n584_));
  nor2   g453(.a(new_n173_), .b(new_n165_), .O(new_n585_));
  nand4  g454(.a(new_n585_), .b(new_n584_), .c(new_n583_), .d(new_n548_), .O(new_n586_));
  nor2   g455(.a(new_n586_), .b(new_n582_), .O(z44));
  inv1   g456(.a(x35), .O(new_n588_));
  nor2   g457(.a(new_n539_), .b(new_n180_), .O(new_n589_));
  nand4  g458(.a(new_n589_), .b(new_n319_), .c(new_n588_), .d(x34), .O(new_n590_));
  nor2   g459(.a(new_n590_), .b(new_n555_), .O(z45));
  nand4  g460(.a(new_n560_), .b(new_n494_), .c(new_n324_), .d(new_n143_), .O(new_n592_));
  nand3  g461(.a(new_n171_), .b(new_n206_), .c(x09), .O(new_n593_));
  nor2   g462(.a(new_n593_), .b(new_n199_), .O(new_n594_));
  nor2   g463(.a(new_n535_), .b(new_n198_), .O(new_n595_));
  nand3  g464(.a(new_n595_), .b(new_n594_), .c(new_n531_), .O(new_n596_));
  nor2   g465(.a(new_n596_), .b(new_n592_), .O(z46));
  nand2  g466(.a(new_n531_), .b(new_n371_), .O(new_n598_));
  nor3   g467(.a(new_n383_), .b(x18), .c(new_n442_), .O(new_n599_));
  nand3  g468(.a(new_n157_), .b(new_n296_), .c(new_n588_), .O(new_n600_));
  nor2   g469(.a(new_n600_), .b(new_n419_), .O(new_n601_));
  nand3  g470(.a(new_n601_), .b(new_n599_), .c(new_n589_), .O(new_n602_));
  nor2   g471(.a(new_n602_), .b(new_n598_), .O(z47));
  nand2  g472(.a(new_n466_), .b(x31), .O(new_n604_));
  nor2   g473(.a(new_n604_), .b(new_n187_), .O(new_n605_));
  nand3  g474(.a(new_n605_), .b(new_n194_), .c(new_n185_), .O(new_n606_));
  nor2   g475(.a(new_n606_), .b(new_n555_), .O(z48));
  inv1   g476(.a(new_n180_), .O(new_n608_));
  nand4  g477(.a(new_n183_), .b(new_n608_), .c(new_n182_), .d(x53), .O(new_n609_));
  nor2   g478(.a(new_n609_), .b(new_n552_), .O(z49));
  nand3  g479(.a(new_n397_), .b(new_n395_), .c(new_n381_), .O(new_n611_));
  nand3  g480(.a(new_n143_), .b(new_n177_), .c(x57), .O(new_n612_));
  nor2   g481(.a(new_n612_), .b(new_n611_), .O(z50));
  nand3  g482(.a(new_n191_), .b(new_n564_), .c(x48), .O(new_n614_));
  nor2   g483(.a(new_n614_), .b(new_n184_), .O(new_n615_));
  nand2  g484(.a(new_n615_), .b(new_n608_), .O(new_n616_));
  nor2   g485(.a(new_n616_), .b(new_n563_), .O(z51));
  nand3  g486(.a(new_n172_), .b(new_n220_), .c(x12), .O(new_n618_));
  nor2   g487(.a(new_n618_), .b(new_n170_), .O(new_n619_));
  nor2   g488(.a(new_n430_), .b(new_n158_), .O(new_n620_));
  nand3  g489(.a(new_n620_), .b(new_n619_), .c(new_n152_), .O(new_n621_));
  nor2   g490(.a(new_n425_), .b(new_n256_), .O(new_n622_));
  nand3  g491(.a(new_n622_), .b(new_n306_), .c(new_n381_), .O(new_n623_));
  nor2   g492(.a(new_n623_), .b(new_n621_), .O(z52));
  nand2  g493(.a(new_n240_), .b(x63), .O(new_n625_));
  nor2   g494(.a(new_n625_), .b(new_n399_), .O(z53));
  nor2   g495(.a(new_n518_), .b(new_n512_), .O(new_n627_));
  nor2   g496(.a(x56), .b(new_n275_), .O(new_n628_));
  nand4  g497(.a(new_n628_), .b(new_n627_), .c(new_n355_), .d(new_n191_), .O(new_n629_));
  nor2   g498(.a(new_n629_), .b(new_n411_), .O(z54));
  inv1   g499(.a(new_n418_), .O(new_n631_));
  nor2   g500(.a(x37), .b(new_n588_), .O(new_n632_));
  nand4  g501(.a(new_n632_), .b(new_n631_), .c(new_n321_), .d(new_n568_), .O(new_n633_));
  nor2   g502(.a(new_n633_), .b(new_n411_), .O(z55));
  nand2  g503(.a(new_n496_), .b(new_n494_), .O(new_n635_));
  nand2  g504(.a(new_n460_), .b(new_n493_), .O(new_n636_));
  nor2   g505(.a(new_n636_), .b(new_n635_), .O(new_n637_));
  nand3  g506(.a(new_n226_), .b(x20), .c(new_n442_), .O(new_n638_));
  nor3   g507(.a(new_n638_), .b(x18), .c(x16), .O(new_n639_));
  nor2   g508(.a(new_n198_), .b(new_n188_), .O(new_n640_));
  nand4  g509(.a(new_n640_), .b(new_n639_), .c(new_n637_), .d(new_n277_), .O(new_n641_));
  nor2   g510(.a(new_n641_), .b(new_n434_), .O(z56));
  nand4  g511(.a(new_n371_), .b(new_n334_), .c(new_n204_), .d(new_n161_), .O(new_n643_));
  inv1   g512(.a(x22), .O(new_n644_));
  nand3  g513(.a(new_n169_), .b(new_n644_), .c(x18), .O(new_n645_));
  nor4   g514(.a(new_n645_), .b(new_n643_), .c(new_n325_), .d(new_n151_), .O(z57));
  nand3  g515(.a(new_n631_), .b(new_n358_), .c(new_n355_), .O(new_n647_));
  nand3  g516(.a(new_n231_), .b(new_n230_), .c(x22), .O(new_n648_));
  nor4   g517(.a(new_n648_), .b(new_n647_), .c(new_n643_), .d(new_n419_), .O(z58));
  nor4   g518(.a(new_n482_), .b(new_n345_), .c(x43), .d(new_n338_), .O(z59));
  nor3   g519(.a(new_n370_), .b(x08), .c(new_n211_), .O(new_n651_));
  nand2  g520(.a(new_n132_), .b(new_n242_), .O(new_n652_));
  nor2   g521(.a(new_n652_), .b(new_n323_), .O(new_n653_));
  nand3  g522(.a(new_n653_), .b(new_n651_), .c(new_n376_), .O(new_n654_));
  inv1   g523(.a(new_n654_), .O(z60));
  nor2   g524(.a(x10), .b(new_n204_), .O(new_n656_));
  nand4  g525(.a(new_n656_), .b(new_n365_), .c(new_n332_), .d(new_n171_), .O(new_n657_));
  nand3  g526(.a(new_n452_), .b(new_n356_), .c(new_n343_), .O(new_n658_));
  nand2  g527(.a(new_n351_), .b(new_n190_), .O(new_n659_));
  nand2  g528(.a(new_n156_), .b(new_n150_), .O(new_n660_));
  nor4   g529(.a(new_n660_), .b(new_n659_), .c(new_n658_), .d(new_n657_), .O(z61));
  nor2   g530(.a(new_n375_), .b(new_n370_), .O(new_n662_));
  nand2  g531(.a(new_n343_), .b(x47), .O(new_n663_));
  nor2   g532(.a(new_n663_), .b(new_n652_), .O(new_n664_));
  nand4  g533(.a(new_n664_), .b(new_n662_), .c(new_n480_), .d(new_n372_), .O(new_n665_));
  inv1   g534(.a(new_n665_), .O(z62));
  nand4  g535(.a(new_n242_), .b(new_n177_), .c(x56), .d(new_n343_), .O(new_n667_));
  inv1   g536(.a(new_n667_), .O(new_n668_));
  nand4  g537(.a(new_n668_), .b(new_n662_), .c(new_n480_), .d(new_n372_), .O(new_n669_));
  inv1   g538(.a(new_n669_), .O(z63));
  nor2   g539(.a(new_n482_), .b(x60), .O(new_n671_));
  nand4  g540(.a(new_n671_), .b(new_n480_), .c(new_n287_), .d(x30), .O(new_n672_));
  nor3   g541(.a(new_n672_), .b(new_n375_), .c(new_n370_), .O(z64));
  zero   g542(.O(z36));
