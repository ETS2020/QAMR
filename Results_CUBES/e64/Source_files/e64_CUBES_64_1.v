...
module FAU ( 
  ...
  nand2  g219(.a(new_n349_), .b(new_n152_), .O(new_n350_));
  nor4   g220(.a(new_n350_), .b(new_n291_), .c(x58), .d(new_n348_), .O(z14));
  ...
  inv1   g329(.a(new_n349_), .O(new_n460_));
  ...
  nand3  g351(.a(new_n293_), .b(new_n152_), .c(x25), .O(new_n482_));
  nor3   g352(.a(x60), .b(x58), .c(x50), .O(new_n483_));
  nand2  g353(.a(new_n483_), .b(new_n349_), .O(new_n484_));
  nor3   g354(.a(new_n484_), .b(new_n482_), .c(new_n481_), .O(z28));
  inv1   g355(.a(new_n350_), .O(new_n486_));
  nand4  g356(.a(new_n379_), .b(new_n486_), .c(new_n293_), .d(new_n290_), .O(new_n487_));
  ...
  nand2  g377(.a(new_n486_), .b(new_n293_), .O(new_n508_));
  ...
  nor2   g525(.a(x58), .b(x50), .O(new_n656_));
  nand3  g526(.a(new_n656_), .b(new_n290_), .c(x40), .O(new_n657_));
  nor2   g527(.a(new_n657_), .b(new_n508_), .O(z59));
  ...
  inv1   g539(.a(new_n481_), .O(new_n670_));
  nor2   g540(.a(new_n381_), .b(new_n376_), .O(new_n671_));
  nand2  g541(.a(new_n348_), .b(x47), .O(new_n672_));
  nor2   g542(.a(new_n672_), .b(new_n660_), .O(new_n673_));
  nand4  g543(.a(new_n673_), .b(new_n671_), .c(new_n670_), .d(new_n378_), .O(new_n674_));
  inv1   g544(.a(new_n674_), .O(z62));
  nand3  g545(.a(new_n656_), .b(new_n190_), .c(x56), .O(new_n676_));
  inv1   g546(.a(new_n676_), .O(new_n677_));
  nand4  g547(.a(new_n677_), .b(new_n671_), .c(new_n670_), .d(new_n378_), .O(new_n678_));
  inv1   g548(.a(new_n678_), .O(z63));
  nand4  g549(.a(new_n483_), .b(new_n670_), .c(new_n289_), .d(x30), .O(new_n680_));
  nor3   g550(.a(new_n680_), .b(new_n381_), .c(new_n376_), .O(z64));
