// Benchmark "FAU" written by ABC on Mon Jul  6 13:46:01 2020
...
module FAU ( 
  ...
  nor4   g253(.a(new_n329_), .b(new_n383_), .c(new_n192_), .d(x60), .O(new_n384_));
  ...
  nor3   g526(.a(new_n329_), .b(new_n383_), .c(x60), .O(new_n657_));
  nand3  g527(.a(new_n657_), .b(new_n656_), .c(new_n382_), .O(new_n658_));
  inv1   g528(.a(new_n658_), .O(z60));
  nor2   g529(.a(x10), .b(new_n203_), .O(new_n660_));
  nand4  g530(.a(new_n660_), .b(new_n371_), .c(new_n338_), .d(new_n175_), .O(new_n661_));
  nand3  g531(.a(new_n361_), .b(new_n363_), .c(new_n348_), .O(new_n662_));
  nand2  g532(.a(new_n356_), .b(new_n196_), .O(new_n663_));
  nand2  g533(.a(new_n160_), .b(new_n154_), .O(new_n664_));
  nor4   g534(.a(new_n664_), .b(new_n663_), .c(new_n662_), .d(new_n661_), .O(z61));
  nand3  g535(.a(new_n377_), .b(new_n173_), .c(new_n152_), .O(new_n666_));
  or2    g536(.a(new_n666_), .b(new_n153_), .O(new_n667_));
  nand3  g537(.a(new_n328_), .b(new_n348_), .c(x47), .O(new_n668_));
  nor2   g538(.a(new_n668_), .b(new_n380_), .O(new_n669_));
  nand3  g539(.a(new_n669_), .b(new_n133_), .c(new_n190_), .O(new_n670_));
  nor2   g540(.a(new_n670_), .b(new_n667_), .O(z62));
  nand2  g541(.a(new_n190_), .b(x56), .O(new_n672_));
  nand2  g542(.a(new_n482_), .b(new_n378_), .O(new_n673_));
  nor4   g543(.a(new_n673_), .b(new_n672_), .c(new_n666_), .d(new_n484_), .O(z63));
  nor2   g544(.a(new_n484_), .b(x60), .O(new_n675_));
  nand4  g545(.a(new_n675_), .b(new_n482_), .c(new_n289_), .d(x30), .O(new_n676_));
  nor2   g546(.a(new_n676_), .b(new_n667_), .O(z64));
