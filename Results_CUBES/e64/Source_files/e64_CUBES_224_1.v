...
module FAU ( 
  ...
  nor2   g526(.a(new_n371_), .b(new_n366_), .O(new_n657_));
  nand3  g527(.a(new_n132_), .b(new_n342_), .c(x47), .O(new_n658_));
  inv1   g528(.a(new_n658_), .O(new_n659_));
  nand4  g529(.a(new_n659_), .b(new_n657_), .c(new_n470_), .d(new_n368_), .O(new_n660_));
  inv1   g530(.a(new_n660_), .O(z62));
  nand4  g531(.a(new_n441_), .b(new_n177_), .c(x56), .d(new_n342_), .O(new_n662_));
  inv1   g532(.a(new_n662_), .O(new_n663_));
  nand4  g533(.a(new_n663_), .b(new_n657_), .c(new_n470_), .d(new_n368_), .O(new_n664_));
  inv1   g534(.a(new_n664_), .O(z63));
  nor2   g535(.a(new_n472_), .b(x60), .O(new_n666_));
  nand4  g536(.a(new_n666_), .b(new_n470_), .c(new_n286_), .d(x30), .O(new_n667_));
  nor3   g537(.a(new_n667_), .b(new_n371_), .c(new_n366_), .O(z64));
