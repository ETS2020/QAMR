...
module FAU ( 
  ...
  wire new_n135_, new_n136_, new_n138_, new_n139_, new_n140_, new_n141_,
    ...
    new_n212_, new_n238_, new_n244_, new_n245_;
  ...
  nand3  g048(.a(new_n181_), .b(new_n157_), .c(new_n196_), .O(new_n197_));
  ...
  nor2   g065(.a(x15), .b(x11), .O(new_n244_));
  nand4  g066(.a(new_n244_), .b(new_n177_), .c(new_n176_), .d(new_n139_), .O(new_n245_));
  nor2   g067(.a(new_n245_), .b(new_n184_), .O(z64));
  zero   g068(.O(z00));
  zero   g069(.O(z01));
  zero   g070(.O(z02));
  zero   g071(.O(z03));
