...
module FAU ( 
  ...
  wire new_n131_, new_n132_, new_n133_, new_n134_, new_n135_, new_n136_,
    ...
    new_n650_, new_n651_, new_n653_, new_n654_, new_n656_, new_n657_,
  ...
  nand3  g220(.a(new_n350_), .b(new_n294_), .c(new_n152_), .O(new_n351_));
  ...
  nand4  g326(.a(new_n286_), .b(new_n219_), .c(x11), .d(new_n205_), .O(new_n457_));
  ...
  inv1   g329(.a(new_n350_), .O(new_n460_));
  ...
  nand3  g351(.a(new_n294_), .b(new_n152_), .c(x25), .O(new_n482_));
  nor3   g352(.a(x60), .b(x58), .c(x50), .O(new_n483_));
  nand2  g353(.a(new_n483_), .b(new_n350_), .O(new_n484_));
  nor3   g354(.a(new_n484_), .b(new_n482_), .c(new_n481_), .O(z28));
  nand4  g355(.a(x60), .b(new_n181_), .c(new_n349_), .d(new_n157_), .O(new_n486_));
  nor4   g356(.a(new_n486_), .b(new_n357_), .c(new_n460_), .d(x28), .O(z29));
  ...
  nand2  g361(.a(new_n317_), .b(new_n255_), .O(new_n492_));
  ...
  nor2   g372(.a(new_n502_), .b(new_n433_), .O(z31));
  nand4  g373(.a(new_n379_), .b(new_n353_), .c(new_n349_), .d(x46), .O(new_n504_));
  nor2   g374(.a(new_n504_), .b(new_n351_), .O(z32));
  nand4  g375(.a(new_n353_), .b(new_n349_), .c(new_n315_), .d(x39), .O(new_n506_));
  nor2   g376(.a(new_n506_), .b(new_n351_), .O(z33));
  nor4   g377(.a(new_n431_), .b(new_n291_), .c(new_n288_), .d(new_n181_), .O(z34));
  ...
  nor2   g399(.a(new_n529_), .b(new_n304_), .O(new_n530_));
  ...
  nand4  g403(.a(new_n533_), .b(new_n531_), .c(new_n530_), .d(new_n297_), .O(new_n534_));
  ...
  inv1   g413(.a(new_n362_), .O(new_n544_));
  ...
  nor2   g419(.a(x43), .b(new_n316_), .O(new_n550_));
  ...
  nand4  g438(.a(new_n568_), .b(new_n566_), .c(new_n331_), .d(new_n146_), .O(new_n569_));
  ...
  nor2   g449(.a(new_n389_), .b(new_n311_), .O(new_n580_));
  ...
  nand4  g457(.a(new_n587_), .b(new_n252_), .c(new_n158_), .d(new_n302_), .O(new_n588_));
  ...
  nand4  g468(.a(new_n568_), .b(new_n598_), .c(new_n331_), .d(new_n146_), .O(new_n599_));
  ...
  nand2  g475(.a(new_n537_), .b(new_n377_), .O(new_n606_));
  ...
  nand3  g479(.a(new_n378_), .b(new_n298_), .c(new_n609_), .O(new_n610_));
  nor2   g480(.a(new_n610_), .b(new_n300_), .O(new_n611_));
  ...
  nand4  g499(.a(new_n629_), .b(new_n628_), .c(new_n627_), .d(new_n305_), .O(new_n630_));
  ...
  nand4  g506(.a(new_n636_), .b(new_n524_), .c(new_n416_), .d(new_n414_), .O(new_n637_));
  inv1   g507(.a(new_n637_), .O(z54));
  nor2   g508(.a(x37), .b(new_n609_), .O(new_n639_));
  nand4  g509(.a(new_n639_), .b(new_n545_), .c(new_n424_), .d(new_n328_), .O(new_n640_));
  ...
  nand4  g515(.a(new_n377_), .b(new_n341_), .c(new_n203_), .d(new_n165_), .O(new_n646_));
  nand3  g516(.a(new_n173_), .b(new_n226_), .c(x18), .O(new_n647_));
  nor4   g517(.a(new_n647_), .b(new_n646_), .c(new_n332_), .d(new_n155_), .O(z57));
  inv1   g518(.a(new_n364_), .O(new_n649_));
  nand3  g519(.a(new_n424_), .b(new_n649_), .c(new_n544_), .O(new_n650_));
  nand3  g520(.a(new_n231_), .b(new_n230_), .c(x22), .O(new_n651_));
  nor4   g521(.a(new_n651_), .b(new_n650_), .c(new_n646_), .d(new_n425_), .O(z58));
  nor2   g522(.a(x58), .b(x50), .O(new_n653_));
  nand3  g523(.a(new_n653_), .b(new_n290_), .c(x40), .O(new_n654_));
  nor2   g524(.a(new_n654_), .b(new_n351_), .O(z59));
  ...
  nand4  g531(.a(new_n661_), .b(new_n371_), .c(new_n339_), .d(new_n175_), .O(new_n662_));
  nand3  g532(.a(new_n361_), .b(new_n363_), .c(new_n349_), .O(new_n663_));
  ...
  inv1   g536(.a(new_n481_), .O(new_n667_));
  nor2   g537(.a(new_n381_), .b(new_n376_), .O(new_n668_));
  nand2  g538(.a(new_n349_), .b(x47), .O(new_n669_));
  nor2   g539(.a(new_n669_), .b(new_n657_), .O(new_n670_));
  nand4  g540(.a(new_n670_), .b(new_n668_), .c(new_n667_), .d(new_n378_), .O(new_n671_));
  inv1   g541(.a(new_n671_), .O(z62));
  nand3  g542(.a(new_n653_), .b(new_n190_), .c(x56), .O(new_n673_));
  inv1   g543(.a(new_n673_), .O(new_n674_));
  nand4  g544(.a(new_n674_), .b(new_n668_), .c(new_n667_), .d(new_n378_), .O(new_n675_));
  inv1   g545(.a(new_n675_), .O(z63));
  nand4  g546(.a(new_n483_), .b(new_n667_), .c(new_n289_), .d(x30), .O(new_n677_));
