...
module FAU ( 
  ...
  wire new_n136_, new_n137_, new_n138_, new_n139_, new_n140_, new_n141_,
    ...
    new_n163_, new_n181_, new_n182_, new_n183_, new_n185_, new_n186_,
    new_n188_, new_n189_, new_n215_;
  ...
  nor2   g21(.a(x58), .b(x43), .O(new_n160_));
  nand3  g22(.a(new_n160_), .b(new_n139_), .c(x29), .O(new_n161_));
  inv1   g23(.a(x14), .O(new_n162_));
  nand3  g24(.a(new_n143_), .b(new_n162_), .c(x10), .O(new_n163_));
  nor2   g25(.a(new_n163_), .b(new_n161_), .O(z15));
  inv1   g26(.a(x50), .O(new_n181_));
  nor2   g27(.a(x40), .b(x39), .O(new_n182_));
  nand3  g28(.a(new_n182_), .b(new_n160_), .c(new_n181_), .O(new_n183_));
  nor2   g29(.a(new_n183_), .b(new_n156_), .O(z32));
  inv1   g30(.a(x40), .O(new_n185_));
  nand4  g31(.a(new_n160_), .b(new_n181_), .c(new_n185_), .d(x39), .O(new_n186_));
  nor2   g32(.a(new_n186_), .b(new_n156_), .O(z33));
  nand3  g33(.a(x58), .b(new_n140_), .c(new_n139_), .O(new_n188_));
  nand4  g34(.a(x29), .b(new_n138_), .c(new_n136_), .d(new_n162_), .O(new_n189_));
  nor2   g35(.a(new_n189_), .b(new_n188_), .O(z34));
  nand4  g36(.a(new_n157_), .b(new_n181_), .c(new_n140_), .d(x40), .O(new_n215_));
  nor2   g37(.a(new_n215_), .b(new_n156_), .O(z59));
  zero   g38(.O(z00));
  zero   g39(.O(z01));
  zero   g40(.O(z02));
  zero   g41(.O(z03));
