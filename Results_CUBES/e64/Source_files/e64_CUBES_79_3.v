...
module FAU ( 
  ...
  inv1   g356(.a(new_n350_), .O(new_n487_));
  inv1   g357(.a(new_n379_), .O(new_n488_));
  nor2   g358(.a(new_n488_), .b(x43), .O(new_n489_));
  nand2  g359(.a(new_n489_), .b(new_n487_), .O(new_n490_));
  nand3  g360(.a(new_n458_), .b(x60), .c(new_n181_), .O(new_n491_));
  ...
  nor3   g393(.a(new_n523_), .b(new_n488_), .c(new_n155_), .O(new_n524_));
  ...
  nand3  g398(.a(new_n361_), .b(new_n192_), .c(x61), .O(new_n529_));
  ...
  nand3  g402(.a(new_n445_), .b(new_n250_), .c(new_n160_), .O(new_n533_));
  ...
  nor3   g415(.a(new_n545_), .b(new_n488_), .c(x41), .O(new_n546_));
  ...
  nor3   g432(.a(new_n562_), .b(new_n560_), .c(new_n482_), .O(new_n563_));
  ...
  nand4  g469(.a(new_n599_), .b(new_n598_), .c(new_n445_), .d(new_n160_), .O(new_n600_));
  ...
  nand3  g483(.a(new_n378_), .b(new_n297_), .c(new_n613_), .O(new_n614_));
  ...
  nand3  g487(.a(new_n149_), .b(new_n470_), .c(x31), .O(new_n618_));
  ...
  nand4  g513(.a(new_n643_), .b(new_n549_), .c(new_n424_), .d(new_n327_), .O(new_n644_));
  ...
  nand4  g526(.a(new_n181_), .b(new_n348_), .c(new_n290_), .d(x40), .O(new_n657_));
  nor2   g527(.a(new_n657_), .b(new_n350_), .O(z59));
  ...
  nand4  g542(.a(new_n672_), .b(new_n670_), .c(new_n489_), .d(new_n378_), .O(new_n673_));
  inv1   g543(.a(new_n673_), .O(z62));
  nand3  g544(.a(new_n190_), .b(new_n181_), .c(x56), .O(new_n675_));
  nor3   g545(.a(new_n675_), .b(x50), .c(x46), .O(new_n676_));
  nand4  g546(.a(new_n676_), .b(new_n670_), .c(new_n489_), .d(new_n378_), .O(new_n677_));
  inv1   g547(.a(new_n677_), .O(z63));
  nand3  g548(.a(new_n483_), .b(new_n289_), .c(x30), .O(new_n679_));
  nor4   g549(.a(new_n679_), .b(new_n485_), .c(new_n381_), .d(new_n376_), .O(z64));
