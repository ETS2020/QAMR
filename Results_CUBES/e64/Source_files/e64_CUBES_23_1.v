...
module FAU ( 
  ...
  nand2  g354(.a(new_n484_), .b(new_n190_), .O(new_n485_));
  nor3   g355(.a(new_n485_), .b(new_n483_), .c(new_n460_), .O(z28));
  ...
  nand3  g525(.a(new_n484_), .b(new_n290_), .c(x40), .O(new_n656_));
  ...
  nand2  g538(.a(new_n173_), .b(new_n152_), .O(new_n669_));
  nor2   g539(.a(new_n669_), .b(new_n376_), .O(new_n670_));
  nand2  g540(.a(new_n356_), .b(new_n157_), .O(new_n671_));
  nor2   g541(.a(new_n671_), .b(new_n667_), .O(new_n672_));
  nand2  g542(.a(new_n348_), .b(x47), .O(new_n673_));
  nor2   g543(.a(new_n673_), .b(new_n659_), .O(new_n674_));
  nand3  g544(.a(new_n674_), .b(new_n672_), .c(new_n670_), .O(new_n675_));
  inv1   g545(.a(new_n675_), .O(z62));
  nor2   g546(.a(x60), .b(new_n363_), .O(new_n677_));
  nand4  g547(.a(new_n677_), .b(new_n672_), .c(new_n670_), .d(new_n484_), .O(new_n678_));
  inv1   g548(.a(new_n678_), .O(z63));
  nand3  g549(.a(new_n482_), .b(new_n289_), .c(x30), .O(new_n680_));
  nor4   g550(.a(new_n680_), .b(new_n669_), .c(new_n485_), .d(new_n376_), .O(z64));
