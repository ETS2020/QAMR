// Benchmark "FAU" written by ABC on Mon Jul  6 13:46:16 2020
...
module FAU ( 
  ...
  nor2   g062(.a(x58), .b(x50), .O(new_n237_));
  nand3  g063(.a(new_n237_), .b(new_n142_), .c(x40), .O(new_n238_));
  nor2   g064(.a(new_n238_), .b(new_n158_), .O(z59));
  inv1   g065(.a(x10), .O(new_n241_));
  nand4  g066(.a(new_n135_), .b(new_n138_), .c(new_n179_), .d(new_n241_), .O(new_n242_));
  nor2   g067(.a(new_n242_), .b(new_n177_), .O(new_n243_));
  nor2   g068(.a(x37), .b(x30), .O(new_n244_));
  nor2   g069(.a(x46), .b(x43), .O(new_n245_));
  nand3  g070(.a(new_n245_), .b(new_n244_), .c(new_n185_), .O(new_n246_));
  inv1   g071(.a(new_n246_), .O(new_n247_));
  inv1   g072(.a(x47), .O(new_n248_));
  nand2  g073(.a(new_n205_), .b(new_n248_), .O(new_n249_));
  inv1   g074(.a(x56), .O(new_n250_));
  nand3  g075(.a(new_n196_), .b(new_n159_), .c(new_n250_), .O(new_n251_));
  nor2   g076(.a(new_n251_), .b(new_n249_), .O(new_n252_));
  nand3  g077(.a(new_n252_), .b(new_n247_), .c(new_n243_), .O(new_n253_));
  inv1   g078(.a(new_n253_), .O(z61));
  nand2  g079(.a(new_n205_), .b(x47), .O(new_n255_));
  nor2   g080(.a(new_n255_), .b(new_n251_), .O(new_n256_));
  nand3  g081(.a(new_n256_), .b(new_n247_), .c(new_n243_), .O(new_n257_));
  inv1   g082(.a(new_n257_), .O(z62));
  nand3  g083(.a(new_n237_), .b(new_n196_), .c(x56), .O(new_n259_));
  inv1   g084(.a(new_n259_), .O(new_n260_));
  nand3  g085(.a(new_n260_), .b(new_n247_), .c(new_n243_), .O(new_n261_));
  inv1   g086(.a(new_n261_), .O(z63));
  inv1   g087(.a(new_n242_), .O(new_n263_));
  nand2  g088(.a(new_n263_), .b(new_n178_), .O(new_n264_));
  nor3   g089(.a(x60), .b(x58), .c(x50), .O(new_n265_));
  inv1   g090(.a(x30), .O(new_n266_));
  nor2   g091(.a(x37), .b(new_n266_), .O(new_n267_));
  nand4  g092(.a(new_n267_), .b(new_n265_), .c(new_n245_), .d(new_n185_), .O(new_n268_));
  nor2   g093(.a(new_n268_), .b(new_n264_), .O(z64));
  zero   g094(.O(z00));
  zero   g095(.O(z01));
  zero   g096(.O(z02));
  zero   g097(.O(z03));
