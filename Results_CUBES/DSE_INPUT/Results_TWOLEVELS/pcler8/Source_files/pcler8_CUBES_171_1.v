// Benchmark "FAU" written by ABC on Mon Jul  6 14:22:27 2020
...
module FAU ( 
  ...
  nand2  g67(.a(new_n84_), .b(x24), .O(new_n112_));
  nand4  g68(.a(new_n112_), .b(new_n87_), .c(new_n107_), .d(x23), .O(new_n113_));
  nand2  g69(.a(x23), .b(x22), .O(new_n114_));
  oai21  g70(.a(new_n93_), .b(new_n114_), .c(x24), .O(new_n115_));
  nand2  g71(.a(new_n115_), .b(new_n113_), .O(new_n116_));
  nand2  g72(.a(new_n116_), .b(new_n101_), .O(new_n117_));
  ...
  oai21  g84(.a(new_n128_), .b(new_n77_), .c(new_n68_), .O(z15));
  inv1   g85(.a(x18), .O(new_n130_));
  nand4  g86(.a(x25), .b(x24), .c(x19), .d(new_n130_), .O(new_n131_));
  oai21  g87(.a(new_n131_), .b(new_n47_), .c(x26), .O(new_n132_));
  and2   g88(.a(x24), .b(x23), .O(new_n133_));
  nor2   g89(.a(x26), .b(new_n125_), .O(new_n134_));
  nand4  g90(.a(new_n134_), .b(new_n87_), .c(new_n107_), .d(new_n133_), .O(new_n135_));
  nand2  g91(.a(new_n135_), .b(new_n132_), .O(new_n136_));
  nand2  g92(.a(new_n136_), .b(new_n101_), .O(new_n137_));
