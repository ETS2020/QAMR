// Benchmark "FAU" written by ABC on Mon Jul  6 14:21:56 2020
...
module FAU ( 
  ...
  nand3  g74(.a(new_n118_), .b(new_n116_), .c(new_n93_), .O(new_n119_));
  inv1   g75(.a(x25), .O(new_n120_));
  nand4  g76(.a(new_n120_), .b(x24), .c(x23), .d(x22), .O(new_n121_));
  inv1   g77(.a(new_n121_), .O(new_n122_));
  aoi22  g78(.a(new_n122_), .b(new_n93_), .c(new_n119_), .d(x25), .O(new_n123_));
  oai21  g79(.a(new_n123_), .b(new_n74_), .c(new_n67_), .O(z15));
  ...
  oai21  g89(.a(new_n133_), .b(new_n74_), .c(new_n69_), .O(z16));
endmodule
