// Benchmark "FAU" written by ABC on Mon Jul  6 14:21:41 2020
...
module FAU ( 
  ...
  nand3  g77(.a(new_n121_), .b(new_n120_), .c(x19), .O(new_n122_));
  inv1   g78(.a(x25), .O(new_n123_));
  nor2   g79(.a(new_n123_), .b(x20), .O(new_n124_));
  aoi21  g80(.a(new_n122_), .b(x20), .c(new_n124_), .O(new_n125_));
  oai21  g81(.a(new_n125_), .b(new_n74_), .c(new_n67_), .O(z15));
  inv1   g82(.a(x18), .O(new_n127_));
  nand3  g83(.a(x24), .b(x23), .c(new_n127_), .O(new_n128_));
  oai21  g84(.a(new_n128_), .b(new_n102_), .c(x26), .O(new_n129_));
  nor2   g85(.a(x26), .b(new_n114_), .O(new_n130_));
  nand3  g86(.a(new_n130_), .b(new_n111_), .c(new_n109_), .O(new_n131_));
