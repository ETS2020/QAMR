// Benchmark "FAU" written by ABC on Mon Jul  6 14:22:15 2020
...
module FAU ( 
  ...
  oai21  g46(.a(new_n90_), .b(new_n77_), .c(new_n60_), .O(z11));
  ...
  oai21  g55(.a(new_n99_), .b(new_n77_), .c(new_n62_), .O(z12));
  inv1   g56(.a(new_n77_), .O(new_n101_));
  ...
  oai21  g65(.a(new_n109_), .b(new_n106_), .c(new_n101_), .O(new_n110_));
  ...
  oai21  g74(.a(new_n118_), .b(new_n77_), .c(new_n66_), .O(z14));
  inv1   g75(.a(x25), .O(new_n120_));
  nor2   g76(.a(x26), .b(new_n120_), .O(new_n121_));
  and2   g77(.a(x24), .b(x23), .O(new_n122_));
  nand3  g78(.a(new_n87_), .b(new_n107_), .c(new_n122_), .O(new_n123_));
  nand3  g79(.a(x24), .b(x23), .c(x22), .O(new_n124_));
  oai21  g80(.a(new_n124_), .b(new_n114_), .c(x25), .O(new_n125_));
  oai21  g81(.a(new_n123_), .b(new_n121_), .c(new_n125_), .O(new_n126_));
  nand2  g82(.a(new_n126_), .b(new_n101_), .O(new_n127_));
  nand2  g83(.a(new_n127_), .b(new_n68_), .O(z15));
  inv1   g84(.a(x18), .O(new_n129_));
  nand4  g85(.a(x25), .b(x24), .c(x19), .d(new_n129_), .O(new_n130_));
  oai21  g86(.a(new_n130_), .b(new_n47_), .c(x26), .O(new_n131_));
  nor2   g87(.a(x26), .b(new_n120_), .O(new_n132_));
  nand4  g88(.a(new_n132_), .b(new_n87_), .c(new_n107_), .d(new_n122_), .O(new_n133_));
  nand2  g89(.a(new_n133_), .b(new_n131_), .O(new_n134_));
  nand2  g90(.a(new_n134_), .b(new_n101_), .O(new_n135_));
  nand2  g91(.a(new_n135_), .b(new_n70_), .O(z16));
endmodule
