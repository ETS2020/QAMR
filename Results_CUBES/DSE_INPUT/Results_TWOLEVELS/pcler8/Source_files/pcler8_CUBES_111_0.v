...
module FAU ( 
  ...
  nand3  g46(.a(new_n90_), .b(new_n46_), .c(x13), .O(new_n91_));
  aoi21  g47(.a(new_n88_), .b(new_n91_), .c(new_n86_), .O(new_n92_));
  aoi21  g48(.a(new_n88_), .b(new_n86_), .c(new_n92_), .O(new_n93_));
  oai21  g49(.a(new_n93_), .b(new_n76_), .c(new_n60_), .O(z11));
  nand3  g50(.a(new_n90_), .b(x23), .c(x14), .O(new_n95_));
  nand3  g51(.a(new_n95_), .b(new_n88_), .c(x21), .O(new_n96_));
  nor2   g52(.a(x22), .b(new_n86_), .O(new_n97_));
  aoi22  g53(.a(new_n97_), .b(new_n88_), .c(new_n96_), .d(x22), .O(new_n98_));
  oai21  g54(.a(new_n98_), .b(new_n76_), .c(new_n62_), .O(z12));
  inv1   g55(.a(x23), .O(new_n100_));
  and2   g56(.a(x26), .b(x25), .O(new_n101_));
  nand3  g57(.a(new_n101_), .b(x24), .c(x15), .O(new_n102_));
  ...
  nand2  g61(.a(new_n73_), .b(new_n100_), .O(new_n106_));
  nor2   g62(.a(new_n106_), .b(new_n87_), .O(new_n107_));
  oai21  g63(.a(new_n107_), .b(new_n105_), .c(new_n77_), .O(new_n108_));
  nand2  g64(.a(new_n108_), .b(new_n64_), .O(z13));
  nand2  g65(.a(new_n101_), .b(x16), .O(new_n110_));
  nand3  g66(.a(x21), .b(x20), .c(x19), .O(new_n111_));
  inv1   g67(.a(new_n111_), .O(new_n112_));
  nand3  g68(.a(new_n112_), .b(new_n110_), .c(new_n46_), .O(new_n113_));
  nor3   g69(.a(new_n111_), .b(new_n45_), .c(x24), .O(new_n114_));
  aoi21  g70(.a(new_n113_), .b(x24), .c(new_n114_), .O(new_n115_));
  oai21  g71(.a(new_n115_), .b(new_n76_), .c(new_n66_), .O(z14));
  nand3  g72(.a(x24), .b(x23), .c(x19), .O(new_n117_));
  ...
  nor2   g79(.a(new_n121_), .b(x20), .O(new_n124_));
  nor2   g80(.a(x10), .b(new_n49_), .O(new_n125_));
  ...
  nand4  g88(.a(new_n132_), .b(new_n88_), .c(new_n73_), .d(new_n131_), .O(new_n133_));
