...
module FAU ( 
  ...
  oai21  g72(.a(new_n116_), .b(new_n75_), .c(new_n66_), .O(z14));
  ...
  nand4  g78(.a(new_n113_), .b(new_n110_), .c(new_n122_), .d(x24), .O(new_n123_));
  nand2  g79(.a(new_n123_), .b(new_n121_), .O(new_n124_));
  nand2  g80(.a(new_n124_), .b(new_n76_), .O(new_n125_));
  nand2  g81(.a(new_n125_), .b(new_n68_), .O(z15));
  inv1   g82(.a(x18), .O(new_n127_));
  nand3  g83(.a(x25), .b(x24), .c(new_n127_), .O(new_n128_));
  nand4  g84(.a(x23), .b(x22), .c(x21), .d(x20), .O(new_n129_));
  oai21  g85(.a(new_n129_), .b(new_n128_), .c(x26), .O(new_n130_));
  inv1   g86(.a(new_n118_), .O(new_n131_));
  ...
  nand2  g90(.a(new_n134_), .b(new_n76_), .O(new_n135_));
