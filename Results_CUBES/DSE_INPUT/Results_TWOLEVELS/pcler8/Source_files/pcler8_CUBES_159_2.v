// Benchmark "FAU" written by ABC on Mon Jul  6 14:22:22 2020
...
module FAU ( 
  ...
  nor2   g34(.a(new_n78_), .b(new_n54_), .O(new_n79_));
  inv1   g35(.a(x10), .O(new_n80_));
  nand2  g36(.a(new_n53_), .b(new_n80_), .O(new_n81_));
  oai21  g37(.a(new_n81_), .b(new_n79_), .c(new_n58_), .O(z09));
  ...
  oai22  g42(.a(new_n86_), .b(new_n81_), .c(new_n61_), .d(new_n60_), .O(z10));
  ...
  oai21  g50(.a(new_n94_), .b(new_n81_), .c(new_n63_), .O(z11));
  ...
  oai21  g59(.a(new_n103_), .b(new_n81_), .c(new_n65_), .O(z12));
  ...
  oai21  g67(.a(new_n111_), .b(new_n81_), .c(new_n67_), .O(z13));
  ...
  nand3  g72(.a(new_n45_), .b(x23), .c(x22), .O(new_n117_));
  nor2   g73(.a(new_n117_), .b(new_n114_), .O(new_n118_));
  aoi21  g74(.a(new_n116_), .b(x24), .c(new_n118_), .O(new_n119_));
  oai21  g75(.a(new_n119_), .b(new_n81_), .c(new_n69_), .O(z14));
  ...
  aoi22  g82(.a(new_n126_), .b(new_n115_), .c(new_n124_), .d(x25), .O(new_n127_));
  oai21  g83(.a(new_n127_), .b(new_n81_), .c(new_n71_), .O(z15));
  ...
  oai21  g91(.a(new_n135_), .b(new_n81_), .c(new_n73_), .O(z16));
endmodule
