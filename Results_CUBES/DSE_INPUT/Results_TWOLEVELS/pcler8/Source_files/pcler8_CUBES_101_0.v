// Benchmark "FAU" written by ABC on Mon Jul  6 14:21:55 2020
...
module FAU ( 
  ...
  nor2   g28(.a(x22), .b(x20), .O(new_n73_));
  ...
  oai21  g49(.a(new_n93_), .b(new_n78_), .c(new_n61_), .O(z11));
  inv1   g50(.a(x22), .O(new_n95_));
  nand2  g51(.a(new_n95_), .b(x21), .O(new_n96_));
  aoi21  g52(.a(new_n96_), .b(x20), .c(new_n52_), .O(new_n97_));
  nand2  g53(.a(x23), .b(x14), .O(new_n98_));
  and2   g54(.a(x21), .b(x19), .O(new_n99_));
  oai21  g55(.a(new_n98_), .b(new_n87_), .c(new_n99_), .O(new_n100_));
  aoi21  g56(.a(new_n100_), .b(x22), .c(new_n97_), .O(new_n101_));
  ...
  nor2   g64(.a(new_n108_), .b(new_n89_), .O(new_n109_));
  oai21  g65(.a(new_n109_), .b(new_n107_), .c(new_n79_), .O(new_n110_));
