...
module FAU ( 
  ...
  oai21  g28(.a(new_n52_), .b(new_n51_), .c(new_n72_), .O(z09));
  nand2  g29(.a(new_n69_), .b(x12), .O(new_n74_));
  oai21  g30(.a(new_n74_), .b(new_n45_), .c(x19), .O(new_n75_));
  inv1   g31(.a(x19), .O(new_n76_));
  nor3   g32(.a(x20), .b(new_n76_), .c(new_n68_), .O(new_n77_));
  aoi21  g33(.a(new_n75_), .b(x20), .c(new_n77_), .O(new_n78_));
  oai21  g34(.a(new_n78_), .b(new_n47_), .c(new_n54_), .O(z10));
  ...
  nor2   g39(.a(x21), .b(new_n76_), .O(new_n84_));
  aoi21  g40(.a(new_n83_), .b(x21), .c(new_n84_), .O(new_n85_));
  nand3  g41(.a(x21), .b(new_n80_), .c(x09), .O(new_n86_));
  ...
  aoi21  g46(.a(x21), .b(x20), .c(new_n68_), .O(new_n91_));
  nand2  g47(.a(x23), .b(x14), .O(new_n92_));
  oai21  g48(.a(new_n92_), .b(new_n81_), .c(x19), .O(new_n93_));
  aoi21  g49(.a(new_n93_), .b(x20), .c(new_n91_), .O(new_n94_));
  ...
  nand2  g58(.a(new_n102_), .b(x20), .O(new_n103_));
  oai21  g59(.a(new_n49_), .b(new_n80_), .c(x09), .O(new_n104_));
  aoi21  g60(.a(new_n104_), .b(new_n103_), .c(new_n100_), .O(new_n105_));
  nor3   g61(.a(new_n49_), .b(new_n48_), .c(x23), .O(new_n106_));
  oai21  g62(.a(new_n106_), .b(new_n105_), .c(new_n46_), .O(new_n107_));
  nand2  g63(.a(new_n107_), .b(new_n60_), .O(z13));
  inv1   g64(.a(x24), .O(new_n109_));
  inv1   g65(.a(new_n91_), .O(new_n110_));
  nand3  g66(.a(x26), .b(x25), .c(x16), .O(new_n111_));
  nand4  g67(.a(new_n111_), .b(x23), .c(x22), .d(x19), .O(new_n112_));
  ...
  nor3   g72(.a(new_n116_), .b(new_n115_), .c(x24), .O(new_n117_));
  oai21  g73(.a(new_n117_), .b(new_n114_), .c(new_n46_), .O(new_n118_));
  nand2  g74(.a(new_n118_), .b(new_n62_), .O(z14));
  inv1   g75(.a(x25), .O(new_n120_));
  and2   g76(.a(x26), .b(x17), .O(new_n121_));
  nand4  g77(.a(x24), .b(x23), .c(x22), .d(x19), .O(new_n122_));
  oai21  g78(.a(new_n122_), .b(new_n121_), .c(x20), .O(new_n123_));
  aoi21  g79(.a(new_n123_), .b(new_n110_), .c(new_n120_), .O(new_n124_));
  nor4   g80(.a(new_n116_), .b(new_n115_), .c(x25), .d(new_n109_), .O(new_n125_));
  oai21  g81(.a(new_n125_), .b(new_n124_), .c(new_n46_), .O(new_n126_));
  nand2  g82(.a(new_n126_), .b(new_n64_), .O(z15));
  inv1   g83(.a(x26), .O(new_n128_));
  nand2  g84(.a(x22), .b(x19), .O(new_n129_));
  inv1   g85(.a(x18), .O(new_n130_));
  nand4  g86(.a(x25), .b(x24), .c(x23), .d(new_n130_), .O(new_n131_));
  oai21  g87(.a(new_n131_), .b(new_n129_), .c(x20), .O(new_n132_));
  aoi21  g88(.a(new_n132_), .b(new_n110_), .c(new_n128_), .O(new_n133_));
  nand3  g89(.a(new_n95_), .b(new_n128_), .c(x25), .O(new_n134_));
  nand3  g90(.a(new_n69_), .b(x24), .c(x23), .O(new_n135_));
  nor2   g91(.a(new_n135_), .b(new_n134_), .O(new_n136_));
  oai21  g92(.a(new_n136_), .b(new_n133_), .c(new_n46_), .O(new_n137_));
