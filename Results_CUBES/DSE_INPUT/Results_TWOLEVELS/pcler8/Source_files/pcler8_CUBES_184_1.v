// Benchmark "FAU" written by ABC on Mon Jul  6 14:22:33 2020
...
module FAU ( 
  ...
  nand3  g26(.a(new_n51_), .b(new_n46_), .c(x11), .O(new_n71_));
  nand2  g27(.a(new_n71_), .b(x19), .O(new_n72_));
  inv1   g28(.a(x10), .O(new_n73_));
  nand2  g29(.a(new_n48_), .b(new_n73_), .O(new_n74_));
  ...
  oai22  g37(.a(new_n81_), .b(new_n74_), .c(new_n57_), .d(new_n56_), .O(z10));
  ...
  oai21  g54(.a(new_n98_), .b(new_n74_), .c(new_n61_), .O(z12));
  ...
  nand2  g60(.a(new_n51_), .b(new_n100_), .O(new_n105_));
  nor2   g61(.a(new_n105_), .b(new_n85_), .O(new_n106_));
  ...
  nand3  g67(.a(new_n111_), .b(new_n93_), .c(new_n110_), .O(new_n112_));
  nor3   g68(.a(new_n92_), .b(new_n109_), .c(x24), .O(new_n113_));
  aoi21  g69(.a(new_n112_), .b(x24), .c(new_n113_), .O(new_n114_));
  oai21  g70(.a(new_n114_), .b(new_n74_), .c(new_n65_), .O(z14));
  ...
  nand4  g76(.a(new_n93_), .b(new_n110_), .c(new_n120_), .d(x24), .O(new_n121_));
  ...
  nand3  g80(.a(x25), .b(x24), .c(x21), .O(new_n125_));
  inv1   g81(.a(new_n125_), .O(new_n126_));
  nor2   g82(.a(new_n49_), .b(x18), .O(new_n127_));
  nand3  g83(.a(new_n127_), .b(new_n126_), .c(new_n110_), .O(new_n128_));
  inv1   g84(.a(x26), .O(new_n129_));
  nand4  g85(.a(new_n129_), .b(x25), .c(x24), .d(x23), .O(new_n130_));
  nor2   g86(.a(new_n130_), .b(new_n116_), .O(new_n131_));
  aoi21  g87(.a(new_n128_), .b(x26), .c(new_n131_), .O(new_n132_));
  oai21  g88(.a(new_n132_), .b(new_n74_), .c(new_n69_), .O(z16));
endmodule
