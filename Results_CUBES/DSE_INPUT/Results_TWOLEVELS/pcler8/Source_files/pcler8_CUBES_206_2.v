// Benchmark "FAU" written by ABC on Mon Jul  6 14:22:43 2020
...
module FAU ( 
  ...
  nand4  g49(.a(x26), .b(x25), .c(x24), .d(x14), .O(new_n94_));
  ...
  nand2  g58(.a(new_n102_), .b(new_n96_), .O(new_n103_));
  inv1   g59(.a(x23), .O(new_n104_));
  nor2   g60(.a(new_n104_), .b(x22), .O(new_n105_));
  aoi21  g61(.a(new_n103_), .b(x22), .c(new_n105_), .O(new_n106_));
  oai22  g62(.a(new_n106_), .b(new_n76_), .c(new_n59_), .d(new_n65_), .O(z13));
