...
module FAU ( 
  ...
  nor2   g44(.a(x21), .b(new_n52_), .O(new_n89_));
  aoi21  g45(.a(new_n88_), .b(x21), .c(new_n89_), .O(new_n90_));
  nand3  g46(.a(x21), .b(new_n85_), .c(new_n57_), .O(new_n91_));
  oai21  g47(.a(new_n90_), .b(new_n85_), .c(new_n91_), .O(new_n92_));
  nor2   g48(.a(x10), .b(new_n50_), .O(new_n93_));
  ...
  oai21  g54(.a(new_n96_), .b(new_n86_), .c(new_n98_), .O(new_n99_));
  ...
  oai22  g59(.a(new_n103_), .b(new_n78_), .c(new_n57_), .d(new_n63_), .O(z12));
  inv1   g60(.a(new_n78_), .O(new_n105_));
  inv1   g61(.a(x23), .O(new_n106_));
  inv1   g62(.a(x25), .O(new_n107_));
  inv1   g63(.a(x26), .O(new_n108_));
  nor2   g64(.a(new_n108_), .b(new_n107_), .O(new_n109_));
  nand3  g65(.a(new_n109_), .b(x24), .c(x15), .O(new_n110_));
  ...
  nand2  g69(.a(x20), .b(x19), .O(new_n114_));
  nand3  g70(.a(new_n106_), .b(x22), .c(x21), .O(new_n115_));
  nor2   g71(.a(new_n115_), .b(new_n114_), .O(new_n116_));
  oai21  g72(.a(new_n116_), .b(new_n113_), .c(new_n105_), .O(new_n117_));
  nand2  g73(.a(new_n117_), .b(new_n65_), .O(z13));
  nand2  g74(.a(x23), .b(x22), .O(new_n119_));
  inv1   g75(.a(new_n119_), .O(new_n120_));
  nand2  g76(.a(new_n109_), .b(x16), .O(new_n121_));
  ...
  nor3   g80(.a(new_n122_), .b(new_n119_), .c(x24), .O(new_n125_));
  aoi21  g81(.a(new_n124_), .b(x24), .c(new_n125_), .O(new_n126_));
  oai21  g82(.a(new_n126_), .b(new_n78_), .c(new_n67_), .O(z14));
  nand2  g83(.a(x26), .b(x17), .O(new_n128_));
  nand4  g84(.a(new_n128_), .b(new_n123_), .c(new_n120_), .d(x24), .O(new_n129_));
  nand3  g85(.a(new_n120_), .b(new_n107_), .c(x24), .O(new_n130_));
  inv1   g86(.a(new_n130_), .O(new_n131_));
  aoi22  g87(.a(new_n131_), .b(new_n123_), .c(new_n129_), .d(x25), .O(new_n132_));
  oai21  g88(.a(new_n132_), .b(new_n78_), .c(new_n69_), .O(z15));
  nor2   g89(.a(new_n52_), .b(x18), .O(new_n134_));
  nand3  g90(.a(new_n134_), .b(new_n49_), .c(new_n45_), .O(new_n135_));
  nand2  g91(.a(x24), .b(x23), .O(new_n136_));
  nand4  g92(.a(new_n108_), .b(x25), .c(x22), .d(x21), .O(new_n137_));
  nor3   g93(.a(new_n137_), .b(new_n114_), .c(new_n136_), .O(new_n138_));
