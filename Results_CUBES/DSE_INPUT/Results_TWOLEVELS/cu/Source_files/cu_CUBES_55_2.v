// Benchmark "FAU" written by ABC on Mon Jul  6 13:06:03 2020
...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n32_,
    ...
    new_n60_, new_n61_, new_n62_, new_n63_, new_n68_;
  ...
  aoi21  g25(.a(new_n50_), .b(new_n47_), .c(new_n41_), .O(new_n51_));
  ...
  nand2  g30(.a(new_n48_), .b(new_n41_), .O(new_n56_));
  aoi21  g31(.a(new_n55_), .b(new_n53_), .c(new_n56_), .O(new_n57_));
  inv1   g32(.a(x12), .O(new_n58_));
  nand4  g33(.a(x13), .b(new_n58_), .c(x05), .d(new_n31_), .O(new_n59_));
  inv1   g34(.a(new_n59_), .O(new_n60_));
  oai21  g35(.a(new_n57_), .b(new_n51_), .c(new_n60_), .O(new_n61_));
