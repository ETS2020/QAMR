...
module FAU ( 
  ...
  nand2  g15(.a(new_n27_), .b(new_n31_), .O(new_n41_));
  nand3  g16(.a(new_n37_), .b(x05), .c(new_n26_), .O(new_n42_));
  nor4   g17(.a(new_n42_), .b(new_n41_), .c(x01), .d(new_n40_), .O(z03));
  inv1   g18(.a(x01), .O(new_n44_));
  nor3   g19(.a(new_n38_), .b(new_n44_), .c(x00), .O(z04));
  nor4   g20(.a(new_n42_), .b(new_n41_), .c(new_n44_), .d(new_n40_), .O(z05));
  ...
  nand2  g25(.a(new_n31_), .b(x00), .O(new_n51_));
  aoi21  g26(.a(new_n50_), .b(new_n48_), .c(new_n51_), .O(new_n52_));
  ...
  aoi21  g40(.a(x02), .b(x00), .c(new_n38_), .O(z07));
