// Benchmark "FAU" written by ABC on Mon Jul  6 14:19:29 2020
...
module FAU ( 
  ...
  oai21  g088(.a(new_n140_), .b(new_n55_), .c(new_n58_), .O(new_n141_));
  ...
  nand2  g096(.a(new_n140_), .b(new_n57_), .O(new_n149_));
