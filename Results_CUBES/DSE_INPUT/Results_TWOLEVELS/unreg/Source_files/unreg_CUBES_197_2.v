...
module FAU ( 
  ...
  nor2   g089(.a(x33), .b(new_n55_), .O(new_n142_));
  oai21  g090(.a(new_n142_), .b(new_n141_), .c(new_n58_), .O(new_n143_));
  nand2  g091(.a(new_n143_), .b(x32), .O(z12));
  ...
  nor2   g107(.a(x18), .b(new_n159_), .O(new_n160_));
  nor2   g108(.a(x28), .b(new_n55_), .O(new_n161_));
  oai21  g109(.a(new_n161_), .b(new_n160_), .c(new_n58_), .O(new_n162_));
  inv1   g110(.a(x35), .O(new_n163_));
  nand2  g111(.a(new_n163_), .b(new_n57_), .O(new_n164_));
  nand2  g112(.a(new_n164_), .b(new_n162_), .O(z15));
endmodule
