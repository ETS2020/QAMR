// Benchmark "FAU" written by ABC on Mon Jul  6 20:11:02 2020
...
module FAU ( 
  ...
  oai21  g068(.a(new_n92_), .b(new_n102_), .c(new_n83_), .O(new_n113_));
  ...
  nand4  g073(.a(new_n117_), .b(new_n116_), .c(new_n83_), .d(new_n79_), .O(new_n118_));
  ...
  nand3  g085(.a(x19), .b(new_n81_), .c(x10), .O(new_n130_));
  ...
  aoi21  g089(.a(new_n133_), .b(new_n127_), .c(new_n81_), .O(new_n134_));
  ...
  nand3  g106(.a(x17), .b(new_n125_), .c(x11), .O(new_n151_));
  ...
  nor2   g114(.a(new_n125_), .b(new_n81_), .O(new_n159_));
  ...
  oai21  g124(.a(new_n168_), .b(new_n167_), .c(new_n81_), .O(new_n169_));
  ...
  aoi21  g143(.a(new_n187_), .b(new_n184_), .c(new_n81_), .O(new_n188_));
  ...
  oai21  g164(.a(new_n208_), .b(new_n168_), .c(new_n81_), .O(new_n209_));
  nand2  g165(.a(new_n205_), .b(x11), .O(new_n210_));
  nand2  g166(.a(new_n210_), .b(new_n125_), .O(new_n211_));
