// Benchmark "FAU" written by ABC on Mon Jul  6 20:10:56 2020
...
module FAU ( 
  ...
  oai21  g037(.a(x21), .b(x03), .c(x02), .O(new_n82_));
  aoi22  g038(.a(new_n82_), .b(new_n76_), .c(new_n81_), .d(new_n57_), .O(new_n83_));
  nand2  g039(.a(x25), .b(x01), .O(new_n84_));
  nor4   g040(.a(new_n84_), .b(new_n83_), .c(x27), .d(x26), .O(z3));
  xor2a  g041(.a(x28), .b(x27), .O(new_n86_));
  nor2   g042(.a(new_n84_), .b(x26), .O(new_n87_));
  nand2  g043(.a(new_n87_), .b(new_n86_), .O(new_n88_));
  nor2   g044(.a(new_n88_), .b(new_n83_), .O(z4));
  ...
  nand2  g049(.a(new_n93_), .b(new_n87_), .O(new_n94_));
  nor2   g050(.a(new_n94_), .b(new_n83_), .O(z5));
  ...
  nor2   g057(.a(new_n101_), .b(new_n83_), .O(z6));
  inv1   g058(.a(x21), .O(new_n103_));
  nand2  g059(.a(new_n103_), .b(new_n76_), .O(new_n104_));
  nand3  g060(.a(new_n104_), .b(new_n80_), .c(new_n78_), .O(new_n105_));
  inv1   g061(.a(x31), .O(new_n106_));
  nand3  g062(.a(new_n98_), .b(new_n106_), .c(x30), .O(new_n107_));
  inv1   g063(.a(x29), .O(new_n108_));
  nor2   g064(.a(new_n96_), .b(new_n108_), .O(new_n109_));
  nand2  g065(.a(new_n109_), .b(new_n92_), .O(new_n110_));
  nand2  g066(.a(new_n87_), .b(new_n57_), .O(new_n111_));
  ...
  nand3  g081(.a(new_n125_), .b(new_n76_), .c(x11), .O(new_n126_));
  aoi21  g082(.a(new_n126_), .b(new_n123_), .c(new_n114_), .O(new_n127_));
  nand3  g083(.a(x16), .b(new_n114_), .c(x10), .O(new_n128_));
  nor2   g084(.a(new_n128_), .b(new_n124_), .O(new_n129_));
  nand2  g085(.a(new_n91_), .b(new_n90_), .O(new_n130_));
  nand3  g086(.a(new_n130_), .b(new_n96_), .c(x29), .O(new_n131_));
  ...
  nor2   g092(.a(new_n76_), .b(new_n114_), .O(new_n137_));
  nand2  g093(.a(new_n137_), .b(new_n125_), .O(new_n138_));
  nor2   g094(.a(new_n118_), .b(new_n116_), .O(new_n139_));
  ...
  aoi21  g106(.a(new_n96_), .b(new_n108_), .c(new_n150_), .O(new_n151_));
  ...
  nand2  g116(.a(new_n106_), .b(new_n96_), .O(new_n161_));
  ...
  nand2  g125(.a(x31), .b(new_n96_), .O(new_n170_));
  ...
  oai21  g135(.a(new_n179_), .b(new_n145_), .c(new_n114_), .O(new_n180_));
  nand2  g136(.a(new_n175_), .b(x11), .O(new_n181_));
  nand2  g137(.a(new_n181_), .b(new_n76_), .O(new_n182_));
