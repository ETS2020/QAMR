...
module FAU ( 
  ...
  aoi21  g047(.a(new_n91_), .b(new_n50_), .c(new_n47_), .O(new_n92_));
  ...
  nand3  g052(.a(new_n96_), .b(x29), .c(new_n50_), .O(new_n97_));
  oai21  g053(.a(new_n96_), .b(new_n92_), .c(new_n97_), .O(new_n98_));
  nand3  g054(.a(new_n98_), .b(new_n88_), .c(new_n81_), .O(new_n99_));
  inv1   g055(.a(new_n99_), .O(z5));
  nand2  g056(.a(new_n88_), .b(new_n81_), .O(new_n101_));
  inv1   g057(.a(x30), .O(new_n102_));
  nand2  g058(.a(new_n95_), .b(x29), .O(new_n103_));
  inv1   g059(.a(new_n103_), .O(new_n104_));
  nand3  g060(.a(new_n95_), .b(new_n102_), .c(x29), .O(new_n105_));
  oai21  g061(.a(new_n104_), .b(new_n102_), .c(new_n105_), .O(new_n106_));
  nand2  g062(.a(new_n106_), .b(new_n50_), .O(new_n107_));
  nand2  g063(.a(x30), .b(new_n47_), .O(new_n108_));
  ...
  nor2   g067(.a(new_n102_), .b(new_n91_), .O(new_n112_));
  aoi21  g068(.a(new_n112_), .b(new_n95_), .c(new_n110_), .O(new_n113_));
  nand2  g069(.a(new_n88_), .b(new_n58_), .O(new_n114_));
  ...
  nand2  g089(.a(new_n94_), .b(new_n93_), .O(new_n134_));
  ...
  nand2  g108(.a(new_n152_), .b(new_n94_), .O(new_n153_));
  oai21  g109(.a(x19), .b(x14), .c(x31), .O(new_n154_));
  aoi21  g110(.a(new_n102_), .b(new_n91_), .c(new_n154_), .O(new_n155_));
  ...
  nand2  g120(.a(new_n110_), .b(new_n102_), .O(new_n165_));
  oai22  g121(.a(new_n165_), .b(new_n164_), .c(new_n163_), .d(new_n110_), .O(new_n166_));
  nand2  g122(.a(new_n166_), .b(new_n136_), .O(new_n167_));
  inv1   g123(.a(new_n136_), .O(new_n168_));
  nand2  g124(.a(x31), .b(x30), .O(new_n169_));
  nand2  g125(.a(x33), .b(new_n110_), .O(new_n170_));
  oai21  g126(.a(new_n169_), .b(new_n164_), .c(new_n170_), .O(new_n171_));
  aoi21  g127(.a(x18), .b(x12), .c(x17), .O(new_n172_));
  nand2  g128(.a(new_n110_), .b(x30), .O(new_n173_));
  nand2  g129(.a(x31), .b(new_n102_), .O(new_n174_));
