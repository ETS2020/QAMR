// Benchmark "FAU" written by ABC on Mon Jul  6 20:10:08 2020
...
module FAU ( 
  ...
  aoi21  g113(.a(new_n155_), .b(new_n135_), .c(new_n157_), .O(z8));
  ...
  nand2  g118(.a(new_n162_), .b(new_n131_), .O(new_n163_));
  ...
  xnor2a g124(.a(x31), .b(x30), .O(new_n169_));
  nand4  g125(.a(new_n169_), .b(new_n144_), .c(new_n142_), .d(new_n168_), .O(new_n170_));
  nor3   g126(.a(new_n170_), .b(new_n152_), .c(new_n147_), .O(new_n171_));
  nor2   g127(.a(new_n171_), .b(new_n159_), .O(new_n172_));
  aoi21  g128(.a(new_n167_), .b(new_n164_), .c(new_n172_), .O(new_n173_));
  aoi21  g129(.a(new_n173_), .b(new_n163_), .c(new_n157_), .O(z9));
endmodule
