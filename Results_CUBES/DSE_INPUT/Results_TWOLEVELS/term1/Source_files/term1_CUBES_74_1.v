// Benchmark "FAU" written by ABC on Mon Jul  6 20:09:30 2020
...
module FAU ( 
  ...
  or2    g050(.a(new_n79_), .b(new_n77_), .O(new_n95_));
  nand2  g051(.a(new_n95_), .b(new_n94_), .O(new_n96_));
  nand2  g052(.a(new_n93_), .b(new_n78_), .O(new_n97_));
  or2    g053(.a(new_n87_), .b(new_n57_), .O(new_n98_));
  aoi21  g054(.a(new_n97_), .b(new_n96_), .c(new_n98_), .O(z5));
  inv1   g055(.a(x30), .O(new_n100_));
  nand2  g056(.a(new_n93_), .b(x29), .O(new_n101_));
  inv1   g057(.a(new_n101_), .O(new_n102_));
  nand3  g058(.a(new_n93_), .b(new_n100_), .c(x29), .O(new_n103_));
  oai21  g059(.a(new_n102_), .b(new_n100_), .c(new_n103_), .O(new_n104_));
  nand2  g060(.a(new_n104_), .b(new_n95_), .O(new_n105_));
  nand2  g061(.a(new_n78_), .b(x30), .O(new_n106_));
  aoi21  g062(.a(new_n106_), .b(new_n105_), .c(new_n98_), .O(z6));
  ...
  aoi21  g068(.a(new_n112_), .b(new_n93_), .c(new_n109_), .O(new_n113_));
  nor2   g069(.a(new_n113_), .b(new_n98_), .O(new_n114_));
  ...
  nand2  g107(.a(new_n151_), .b(new_n92_), .O(new_n152_));
  ...
  nand2  g114(.a(new_n86_), .b(x00), .O(new_n159_));
