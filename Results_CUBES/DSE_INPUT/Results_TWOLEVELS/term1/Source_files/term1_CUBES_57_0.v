// Benchmark "FAU" written by ABC on Mon Jul  6 20:09:16 2020
...
module FAU ( 
  ...
  oai21  g026(.a(new_n70_), .b(x03), .c(x02), .O(new_n71_));
  inv1   g027(.a(x06), .O(new_n72_));
  nand2  g028(.a(new_n72_), .b(new_n70_), .O(new_n73_));
  nand3  g029(.a(new_n73_), .b(new_n71_), .c(new_n69_), .O(new_n74_));
  nand2  g030(.a(new_n74_), .b(new_n68_), .O(new_n75_));
  xor2a  g031(.a(x03), .b(x02), .O(new_n76_));
  aoi22  g032(.a(new_n76_), .b(x01), .c(new_n57_), .d(new_n72_), .O(new_n77_));
  ...
  nor2   g047(.a(x03), .b(new_n68_), .O(new_n92_));
  inv1   g048(.a(x26), .O(new_n93_));
  nand2  g049(.a(new_n93_), .b(x25), .O(new_n94_));
  inv1   g050(.a(new_n94_), .O(new_n95_));
  nand3  g051(.a(new_n95_), .b(new_n92_), .c(new_n91_), .O(new_n96_));
  nor2   g052(.a(new_n96_), .b(new_n90_), .O(z3));
  xnor2a g053(.a(x28), .b(x27), .O(new_n98_));
  nand2  g054(.a(new_n95_), .b(new_n92_), .O(new_n99_));
  nor3   g055(.a(new_n99_), .b(new_n98_), .c(new_n90_), .O(z4));
  inv1   g056(.a(x29), .O(new_n101_));
  inv1   g057(.a(x28), .O(new_n102_));
  nor2   g058(.a(new_n102_), .b(new_n91_), .O(new_n103_));
  xor2a  g059(.a(new_n103_), .b(new_n101_), .O(new_n104_));
  nor3   g060(.a(new_n104_), .b(new_n99_), .c(new_n90_), .O(z5));
  ...
  nand3  g065(.a(new_n103_), .b(new_n107_), .c(x29), .O(new_n110_));
  oai21  g066(.a(new_n109_), .b(new_n107_), .c(new_n110_), .O(new_n111_));
  nand3  g067(.a(new_n111_), .b(new_n106_), .c(new_n89_), .O(new_n112_));
  inv1   g068(.a(new_n112_), .O(z6));
  inv1   g069(.a(x31), .O(new_n114_));
  nand3  g070(.a(new_n109_), .b(new_n114_), .c(x30), .O(new_n115_));
  nor2   g071(.a(new_n107_), .b(new_n101_), .O(new_n116_));
  aoi21  g072(.a(new_n116_), .b(new_n103_), .c(new_n114_), .O(new_n117_));
  nor2   g073(.a(new_n117_), .b(new_n99_), .O(new_n118_));
  ...
  nand2  g092(.a(new_n102_), .b(new_n91_), .O(new_n137_));
  nand3  g093(.a(new_n137_), .b(new_n107_), .c(x29), .O(new_n138_));
  ...
  nand2  g111(.a(new_n155_), .b(new_n102_), .O(new_n156_));
  oai21  g112(.a(x19), .b(x14), .c(x31), .O(new_n157_));
  aoi21  g113(.a(new_n107_), .b(new_n101_), .c(new_n157_), .O(new_n158_));
  ...
  nand2  g118(.a(new_n93_), .b(x00), .O(new_n163_));
  ...
  oai21  g141(.a(new_n185_), .b(new_n152_), .c(new_n120_), .O(new_n186_));
