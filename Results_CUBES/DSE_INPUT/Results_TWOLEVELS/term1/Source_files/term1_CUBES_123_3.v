// Benchmark "FAU" written by ABC on Mon Jul  6 20:10:10 2020
...
module FAU ( 
  ...
  nor2   g077(.a(new_n116_), .b(new_n114_), .O(new_n122_));
  nand2  g078(.a(new_n122_), .b(x17), .O(new_n123_));
  inv1   g079(.a(new_n123_), .O(new_n124_));
  inv1   g080(.a(x11), .O(new_n125_));
  nor2   g081(.a(x16), .b(new_n125_), .O(new_n126_));
  nand2  g082(.a(new_n126_), .b(new_n124_), .O(new_n127_));
  aoi21  g083(.a(new_n127_), .b(new_n121_), .c(new_n112_), .O(new_n128_));
  nand3  g084(.a(x16), .b(new_n112_), .c(x10), .O(new_n129_));
  nor2   g085(.a(new_n129_), .b(new_n123_), .O(new_n130_));
  nand2  g086(.a(new_n93_), .b(new_n92_), .O(new_n131_));
  ...
  nand3  g093(.a(new_n124_), .b(x16), .c(x15), .O(new_n138_));
  inv1   g094(.a(x16), .O(new_n139_));
  nand3  g095(.a(new_n122_), .b(x17), .c(x11), .O(new_n140_));
  nand2  g096(.a(new_n140_), .b(new_n139_), .O(new_n141_));
  nand2  g097(.a(new_n122_), .b(x12), .O(new_n142_));
  ...
  oai21  g101(.a(new_n145_), .b(new_n123_), .c(new_n112_), .O(new_n146_));
  ...
  nor2   g114(.a(x33), .b(new_n116_), .O(new_n159_));
  nand4  g115(.a(new_n159_), .b(new_n126_), .c(x18), .d(x17), .O(new_n160_));
  nand2  g116(.a(new_n160_), .b(new_n121_), .O(new_n161_));
  aoi21  g117(.a(new_n161_), .b(x15), .c(new_n130_), .O(new_n162_));
  nand2  g118(.a(new_n106_), .b(new_n98_), .O(new_n163_));
  nand2  g119(.a(x33), .b(x31), .O(new_n164_));
  oai21  g120(.a(new_n163_), .b(new_n162_), .c(new_n164_), .O(new_n165_));
  nand2  g121(.a(new_n165_), .b(new_n133_), .O(new_n166_));
  inv1   g122(.a(new_n133_), .O(new_n167_));
  ...
  nand3  g127(.a(x17), .b(x15), .c(x11), .O(new_n172_));
  inv1   g128(.a(new_n172_), .O(new_n173_));
  nand2  g129(.a(x31), .b(new_n98_), .O(new_n174_));
  nand4  g130(.a(new_n174_), .b(new_n173_), .c(new_n122_), .d(new_n171_), .O(new_n175_));
  and2   g131(.a(new_n175_), .b(x33), .O(new_n176_));
  aoi21  g132(.a(new_n170_), .b(new_n167_), .c(new_n176_), .O(new_n177_));
  aoi21  g133(.a(new_n177_), .b(new_n166_), .c(new_n157_), .O(z9));
endmodule
