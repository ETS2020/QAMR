...
module FAU ( 
  ...
  nand3  g040(.a(new_n84_), .b(new_n80_), .c(new_n78_), .O(new_n85_));
  ...
  nand2  g056(.a(new_n92_), .b(new_n58_), .O(new_n101_));
  nor3   g057(.a(new_n101_), .b(new_n100_), .c(new_n95_), .O(z5));
  inv1   g058(.a(new_n101_), .O(new_n103_));
  inv1   g059(.a(x30), .O(new_n104_));
  nand2  g060(.a(new_n99_), .b(x29), .O(new_n105_));
  inv1   g061(.a(new_n105_), .O(new_n106_));
  nand3  g062(.a(new_n99_), .b(new_n104_), .c(x29), .O(new_n107_));
  oai21  g063(.a(new_n106_), .b(new_n104_), .c(new_n107_), .O(new_n108_));
  nand3  g064(.a(new_n108_), .b(new_n103_), .c(new_n85_), .O(new_n109_));
  inv1   g065(.a(new_n109_), .O(z6));
  oai21  g066(.a(new_n83_), .b(new_n81_), .c(new_n82_), .O(new_n111_));
  nand3  g067(.a(new_n111_), .b(new_n80_), .c(new_n78_), .O(new_n112_));
  inv1   g068(.a(x31), .O(new_n113_));
  nand3  g069(.a(new_n106_), .b(new_n113_), .c(x30), .O(new_n114_));
  nor2   g070(.a(new_n104_), .b(new_n96_), .O(new_n115_));
  aoi21  g071(.a(new_n115_), .b(new_n99_), .c(new_n113_), .O(new_n116_));
  nor2   g072(.a(new_n116_), .b(new_n101_), .O(new_n117_));
  ...
  aoi21  g079(.a(new_n123_), .b(new_n121_), .c(new_n81_), .O(new_n124_));
  nand4  g080(.a(x19), .b(x18), .c(new_n81_), .d(x12), .O(new_n125_));
  ...
  nand2  g090(.a(new_n98_), .b(new_n97_), .O(new_n135_));
  ...
  nor2   g097(.a(new_n128_), .b(new_n119_), .O(new_n142_));
  ...
  oai21  g106(.a(new_n150_), .b(new_n129_), .c(new_n119_), .O(new_n151_));
  ...
  aoi21  g111(.a(new_n104_), .b(new_n96_), .c(new_n155_), .O(new_n156_));
  ...
  nand2  g121(.a(new_n113_), .b(new_n104_), .O(new_n166_));
  ...
  nor2   g135(.a(new_n120_), .b(new_n81_), .O(new_n180_));
  ...
  oai21  g140(.a(new_n184_), .b(new_n150_), .c(new_n119_), .O(new_n185_));
