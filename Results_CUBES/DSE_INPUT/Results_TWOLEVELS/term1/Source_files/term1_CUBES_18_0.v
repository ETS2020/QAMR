// Benchmark "FAU" written by ABC on Mon Jul  6 20:08:44 2020
...
module FAU ( 
  ...
  oai21  g088(.a(new_n122_), .b(new_n120_), .c(x15), .O(new_n133_));
  nand3  g089(.a(new_n126_), .b(new_n129_), .c(x10), .O(new_n134_));
  nand2  g090(.a(new_n134_), .b(new_n133_), .O(new_n135_));
  nor2   g091(.a(x28), .b(x27), .O(new_n136_));
  nand2  g092(.a(new_n136_), .b(x30), .O(new_n137_));
  nand2  g093(.a(new_n101_), .b(x27), .O(new_n138_));
  aoi21  g094(.a(new_n138_), .b(new_n137_), .c(new_n124_), .O(new_n139_));
  nand2  g095(.a(x30), .b(new_n92_), .O(new_n140_));
  nor2   g096(.a(x16), .b(new_n129_), .O(new_n141_));
  nor2   g097(.a(new_n116_), .b(new_n115_), .O(new_n142_));
  nand4  g098(.a(new_n142_), .b(new_n141_), .c(new_n93_), .d(x19), .O(new_n143_));
  aoi21  g099(.a(new_n140_), .b(new_n138_), .c(new_n143_), .O(new_n144_));
  aoi21  g100(.a(new_n139_), .b(new_n135_), .c(new_n144_), .O(new_n145_));
  oai21  g101(.a(new_n132_), .b(new_n114_), .c(new_n145_), .O(new_n146_));
  nor2   g102(.a(x32), .b(new_n107_), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(new_n146_), .O(new_n148_));
  nor2   g104(.a(new_n124_), .b(new_n129_), .O(new_n149_));
  nand2  g105(.a(new_n149_), .b(new_n126_), .O(new_n150_));
  nor2   g106(.a(new_n118_), .b(new_n116_), .O(new_n151_));
  ...
  nand2  g110(.a(new_n154_), .b(new_n115_), .O(new_n155_));
  nand3  g111(.a(new_n155_), .b(new_n153_), .c(new_n150_), .O(new_n156_));
  nand2  g112(.a(x16), .b(x10), .O(new_n157_));
  oai21  g113(.a(new_n157_), .b(new_n125_), .c(new_n129_), .O(new_n158_));
  inv1   g114(.a(new_n108_), .O(new_n159_));
  nand2  g115(.a(new_n98_), .b(new_n92_), .O(new_n160_));
  oai21  g116(.a(new_n159_), .b(new_n92_), .c(new_n160_), .O(new_n161_));
  nand2  g117(.a(new_n161_), .b(new_n93_), .O(new_n162_));
  oai21  g118(.a(x19), .b(x14), .c(x31), .O(new_n163_));
  aoi21  g119(.a(new_n98_), .b(new_n91_), .c(new_n163_), .O(new_n164_));
  aoi21  g120(.a(x19), .b(x13), .c(x18), .O(new_n165_));
  aoi21  g121(.a(new_n108_), .b(x28), .c(new_n165_), .O(new_n166_));
  nand4  g122(.a(new_n166_), .b(new_n164_), .c(new_n162_), .d(new_n158_), .O(new_n167_));
  oai21  g123(.a(new_n167_), .b(new_n156_), .c(x32), .O(new_n168_));
  inv1   g124(.a(x26), .O(new_n169_));
  nand2  g125(.a(new_n169_), .b(x00), .O(new_n170_));
  aoi21  g126(.a(new_n168_), .b(new_n148_), .c(new_n170_), .O(z8));
  inv1   g127(.a(x33), .O(new_n172_));
  nor2   g128(.a(new_n107_), .b(new_n98_), .O(new_n173_));
  nor2   g129(.a(x31), .b(x30), .O(new_n174_));
  aoi22  g130(.a(new_n174_), .b(new_n91_), .c(new_n173_), .d(new_n99_), .O(new_n175_));
  nand3  g131(.a(new_n173_), .b(x29), .c(x27), .O(new_n176_));
  nand2  g132(.a(new_n174_), .b(new_n136_), .O(new_n177_));
  aoi21  g133(.a(new_n177_), .b(new_n176_), .c(new_n124_), .O(new_n178_));
  nand2  g134(.a(new_n174_), .b(new_n92_), .O(new_n179_));
  aoi21  g135(.a(new_n179_), .b(new_n176_), .c(new_n143_), .O(new_n180_));
  aoi21  g136(.a(new_n178_), .b(new_n135_), .c(new_n180_), .O(new_n181_));
  oai21  g137(.a(new_n175_), .b(new_n132_), .c(new_n181_), .O(new_n182_));
  nand2  g138(.a(new_n182_), .b(new_n172_), .O(new_n183_));
  oai21  g139(.a(new_n136_), .b(new_n159_), .c(x31), .O(new_n184_));
  nand2  g140(.a(new_n149_), .b(new_n142_), .O(new_n185_));
  nand2  g141(.a(new_n185_), .b(new_n118_), .O(new_n186_));
  inv1   g142(.a(new_n142_), .O(new_n187_));
  oai21  g143(.a(new_n157_), .b(new_n187_), .c(new_n129_), .O(new_n188_));
  nand2  g144(.a(new_n142_), .b(x11), .O(new_n189_));
  nand2  g145(.a(new_n189_), .b(new_n124_), .O(new_n190_));
  nand4  g146(.a(new_n190_), .b(new_n188_), .c(new_n186_), .d(new_n184_), .O(new_n191_));
  oai21  g147(.a(new_n136_), .b(new_n91_), .c(new_n98_), .O(new_n192_));
  nand2  g148(.a(new_n192_), .b(new_n107_), .O(new_n193_));
  nand2  g149(.a(new_n118_), .b(x14), .O(new_n194_));
  nand3  g150(.a(new_n194_), .b(new_n149_), .c(new_n142_), .O(new_n195_));
  aoi21  g151(.a(x18), .b(x12), .c(x17), .O(new_n196_));
  nor2   g152(.a(x18), .b(x13), .O(new_n197_));
  nor2   g153(.a(new_n197_), .b(new_n196_), .O(new_n198_));
  nand3  g154(.a(new_n198_), .b(new_n195_), .c(new_n193_), .O(new_n199_));
  oai21  g155(.a(new_n199_), .b(new_n191_), .c(x33), .O(new_n200_));
  aoi21  g156(.a(new_n200_), .b(new_n183_), .c(new_n170_), .O(z9));
endmodule
