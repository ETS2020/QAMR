...
module FAU ( 
  ...
  nand3  g088(.a(x19), .b(new_n115_), .c(x12), .O(new_n133_));
  nand3  g089(.a(new_n118_), .b(x17), .c(x14), .O(new_n134_));
  aoi21  g090(.a(new_n134_), .b(new_n133_), .c(new_n124_), .O(new_n135_));
  nand4  g091(.a(x19), .b(x17), .c(new_n124_), .d(x11), .O(new_n136_));
  inv1   g092(.a(new_n136_), .O(new_n137_));
  oai21  g093(.a(new_n137_), .b(new_n135_), .c(x15), .O(new_n138_));
  inv1   g094(.a(new_n130_), .O(new_n139_));
  nor2   g095(.a(new_n118_), .b(new_n115_), .O(new_n140_));
  ...
  aoi21  g101(.a(new_n145_), .b(new_n144_), .c(new_n116_), .O(new_n146_));
  nand2  g102(.a(x30), .b(new_n92_), .O(new_n147_));
  nor2   g103(.a(new_n124_), .b(new_n129_), .O(new_n148_));
  nand4  g104(.a(new_n148_), .b(new_n140_), .c(new_n93_), .d(new_n116_), .O(new_n149_));
  ...
  aoi21  g138(.a(new_n182_), .b(new_n181_), .c(new_n116_), .O(new_n183_));
  ...
  nor2   g145(.a(new_n116_), .b(new_n115_), .O(new_n190_));
  nand2  g146(.a(new_n190_), .b(new_n148_), .O(new_n191_));
  nand2  g147(.a(new_n191_), .b(new_n118_), .O(new_n192_));
  inv1   g148(.a(new_n190_), .O(new_n193_));
  oai21  g149(.a(new_n193_), .b(new_n162_), .c(new_n129_), .O(new_n194_));
  nand2  g150(.a(new_n190_), .b(x11), .O(new_n195_));
  nand2  g151(.a(new_n195_), .b(new_n124_), .O(new_n196_));
  nand4  g152(.a(new_n196_), .b(new_n194_), .c(new_n192_), .d(new_n189_), .O(new_n197_));
  oai21  g153(.a(new_n143_), .b(new_n91_), .c(new_n98_), .O(new_n198_));
  nand2  g154(.a(new_n198_), .b(new_n107_), .O(new_n199_));
  nand2  g155(.a(new_n118_), .b(x14), .O(new_n200_));
  nand3  g156(.a(new_n200_), .b(new_n190_), .c(new_n148_), .O(new_n201_));
  aoi21  g157(.a(x18), .b(x12), .c(x17), .O(new_n202_));
  nor2   g158(.a(x18), .b(x13), .O(new_n203_));
  nor2   g159(.a(new_n203_), .b(new_n202_), .O(new_n204_));
  nand3  g160(.a(new_n204_), .b(new_n201_), .c(new_n199_), .O(new_n205_));
  oai21  g161(.a(new_n205_), .b(new_n197_), .c(x33), .O(new_n206_));
  aoi21  g162(.a(new_n206_), .b(new_n188_), .c(new_n175_), .O(z9));
endmodule
