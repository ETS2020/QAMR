// Benchmark "FAU" written by ABC on Mon Jul  6 20:09:15 2020
...
module FAU ( 
  ...
  nand2  g101(.a(new_n108_), .b(x28), .O(new_n146_));
  oai21  g102(.a(x30), .b(x28), .c(new_n146_), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(new_n92_), .O(new_n148_));
  ...
  aoi21  g107(.a(new_n108_), .b(x27), .c(new_n151_), .O(new_n152_));
