...
module FAU ( 
  ...
  aoi21  g011(.a(x05), .b(new_n47_), .c(x07), .O(new_n56_));
  inv1   g012(.a(x04), .O(new_n57_));
  inv1   g013(.a(x06), .O(new_n58_));
  oai21  g014(.a(new_n58_), .b(x02), .c(new_n57_), .O(new_n59_));
  nor2   g015(.a(new_n58_), .b(x02), .O(new_n60_));
  nand2  g016(.a(new_n60_), .b(x04), .O(new_n61_));
  ...
  oai21  g020(.a(new_n64_), .b(new_n63_), .c(x04), .O(new_n65_));
  nand4  g021(.a(x06), .b(new_n57_), .c(x03), .d(new_n50_), .O(new_n66_));
  aoi21  g022(.a(new_n66_), .b(new_n65_), .c(x07), .O(new_n67_));
  oai21  g023(.a(new_n67_), .b(new_n62_), .c(new_n55_), .O(new_n68_));
  inv1   g024(.a(x07), .O(new_n69_));
  xor2a  g025(.a(x04), .b(x02), .O(new_n70_));
  nand3  g026(.a(new_n70_), .b(new_n69_), .c(x03), .O(new_n71_));
  nand2  g027(.a(x04), .b(x02), .O(new_n72_));
  nand2  g028(.a(new_n57_), .b(new_n50_), .O(new_n73_));
  nand2  g029(.a(new_n73_), .b(new_n72_), .O(new_n74_));
  oai21  g030(.a(x07), .b(new_n47_), .c(new_n74_), .O(new_n75_));
  nand2  g031(.a(new_n75_), .b(new_n71_), .O(new_n76_));
  nand3  g032(.a(x06), .b(new_n57_), .c(new_n50_), .O(new_n77_));
