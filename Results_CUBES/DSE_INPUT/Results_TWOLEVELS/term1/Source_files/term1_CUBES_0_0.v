// Benchmark "FAU" written by ABC on Mon Jul  6 20:08:35 2020
...
module FAU ( 
  ...
  oai21  g040(.a(x22), .b(x17), .c(new_n84_), .O(new_n85_));
  ...
  oai21  g068(.a(x21), .b(x16), .c(x22), .O(new_n113_));
  oai21  g069(.a(x22), .b(new_n112_), .c(new_n113_), .O(new_n114_));
  ...
  nand4  g082(.a(x19), .b(x18), .c(new_n112_), .d(x12), .O(new_n127_));
  ...
  nor2   g101(.a(new_n124_), .b(new_n82_), .O(new_n146_));
  ...
  nand2  g105(.a(new_n149_), .b(new_n112_), .O(new_n150_));
