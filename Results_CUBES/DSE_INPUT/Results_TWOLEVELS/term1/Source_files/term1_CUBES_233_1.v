// Benchmark "FAU" written by ABC on Mon Jul  6 20:11:40 2020
...
module FAU ( 
  ...
  nand2  g053(.a(new_n80_), .b(x29), .O(new_n98_));
  ...
  nand2  g061(.a(new_n80_), .b(x30), .O(new_n106_));
  aoi21  g062(.a(new_n106_), .b(new_n105_), .c(new_n91_), .O(z6));
  nor3   g063(.a(new_n80_), .b(new_n77_), .c(new_n76_), .O(new_n108_));
  nand2  g064(.a(new_n108_), .b(new_n86_), .O(new_n109_));
  inv1   g065(.a(x31), .O(new_n110_));
  nand3  g066(.a(new_n102_), .b(new_n110_), .c(x30), .O(new_n111_));
  inv1   g067(.a(x29), .O(new_n112_));
  nor2   g068(.a(new_n100_), .b(new_n112_), .O(new_n113_));
  nand2  g069(.a(new_n113_), .b(new_n95_), .O(new_n114_));
  aoi21  g070(.a(new_n114_), .b(x31), .c(new_n91_), .O(new_n115_));
  nand3  g071(.a(new_n115_), .b(new_n111_), .c(new_n109_), .O(z7));
  ...
  nand3  g090(.a(new_n134_), .b(new_n100_), .c(x29), .O(new_n135_));
  ...
  aoi21  g110(.a(new_n100_), .b(new_n112_), .c(new_n154_), .O(new_n155_));
  ...
  nand2  g119(.a(new_n110_), .b(new_n100_), .O(new_n164_));
  ...
  nand2  g128(.a(x31), .b(new_n100_), .O(new_n173_));
