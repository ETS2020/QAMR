...
module FAU ( 
  ...
  nand2  g043(.a(x28), .b(new_n87_), .O(new_n88_));
  inv1   g044(.a(x28), .O(new_n89_));
  nand3  g045(.a(new_n89_), .b(x27), .c(x01), .O(new_n90_));
  inv1   g046(.a(x26), .O(new_n91_));
  nand3  g047(.a(new_n57_), .b(new_n91_), .c(x25), .O(new_n92_));
  aoi21  g048(.a(new_n90_), .b(new_n88_), .c(new_n92_), .O(new_n93_));
  and2   g049(.a(new_n93_), .b(new_n82_), .O(z4));
  inv1   g050(.a(new_n92_), .O(new_n95_));
  xnor2a g051(.a(x29), .b(x27), .O(new_n96_));
  nand3  g052(.a(x29), .b(new_n89_), .c(x01), .O(new_n97_));
  oai21  g053(.a(new_n96_), .b(new_n89_), .c(new_n97_), .O(new_n98_));
  nand3  g054(.a(new_n98_), .b(new_n95_), .c(new_n82_), .O(new_n99_));
  inv1   g055(.a(new_n99_), .O(z5));
  inv1   g056(.a(x29), .O(new_n101_));
  oai21  g057(.a(new_n101_), .b(new_n89_), .c(x01), .O(new_n102_));
  nand2  g058(.a(new_n102_), .b(new_n88_), .O(new_n103_));
  nor2   g059(.a(new_n89_), .b(new_n87_), .O(new_n104_));
  nor2   g060(.a(x30), .b(new_n101_), .O(new_n105_));
  aoi22  g061(.a(new_n105_), .b(new_n104_), .c(new_n103_), .d(x30), .O(new_n106_));
  nor3   g062(.a(new_n106_), .b(new_n92_), .c(new_n83_), .O(z6));
  ...
  nand4  g068(.a(new_n57_), .b(new_n91_), .c(x25), .d(x01), .O(new_n113_));
  aoi21  g069(.a(new_n112_), .b(x31), .c(new_n113_), .O(new_n114_));
  nand3  g070(.a(new_n114_), .b(new_n109_), .c(new_n82_), .O(z7));
  ...
  aoi21  g089(.a(new_n89_), .b(new_n87_), .c(new_n101_), .O(new_n134_));
  ...
  nand2  g114(.a(new_n91_), .b(x00), .O(new_n159_));
