...
module FAU ( 
  ...
  oai21  g037(.a(x15), .b(x02), .c(x03), .O(new_n82_));
  ...
  aoi21  g082(.a(new_n126_), .b(new_n122_), .c(new_n103_), .O(new_n127_));
  nand3  g083(.a(x16), .b(new_n103_), .c(x10), .O(new_n128_));
  ...
  nor2   g092(.a(new_n123_), .b(new_n103_), .O(new_n137_));
  ...
  oai21  g101(.a(new_n145_), .b(new_n124_), .c(new_n103_), .O(new_n146_));
  ...
  oai21  g135(.a(new_n179_), .b(new_n145_), .c(new_n103_), .O(new_n180_));
