...
module FAU ( 
  ...
  nor4   g043(.a(new_n87_), .b(new_n84_), .c(new_n83_), .d(new_n57_), .O(z3));
  inv1   g044(.a(new_n83_), .O(new_n89_));
  inv1   g045(.a(x28), .O(new_n90_));
  nor2   g046(.a(new_n57_), .b(x28), .O(new_n91_));
  nand2  g047(.a(new_n91_), .b(x27), .O(new_n92_));
  oai21  g048(.a(new_n90_), .b(x27), .c(new_n92_), .O(new_n93_));
  nor2   g049(.a(new_n84_), .b(x26), .O(new_n94_));
  nand3  g050(.a(new_n94_), .b(new_n93_), .c(new_n89_), .O(new_n95_));
  inv1   g051(.a(new_n95_), .O(z4));
  nand2  g052(.a(new_n94_), .b(new_n89_), .O(new_n97_));
  nor2   g053(.a(new_n90_), .b(new_n86_), .O(new_n98_));
  oai22  g054(.a(new_n98_), .b(x03), .c(x28), .d(x02), .O(new_n99_));
  nand2  g055(.a(new_n99_), .b(x29), .O(new_n100_));
  inv1   g056(.a(x29), .O(new_n101_));
  nand2  g057(.a(new_n98_), .b(new_n101_), .O(new_n102_));
  aoi21  g058(.a(new_n102_), .b(new_n100_), .c(new_n97_), .O(z5));
  aoi21  g059(.a(x29), .b(x27), .c(x03), .O(new_n104_));
  oai21  g060(.a(new_n104_), .b(new_n91_), .c(x30), .O(new_n105_));
  inv1   g061(.a(x30), .O(new_n106_));
  nand3  g062(.a(new_n98_), .b(new_n106_), .c(x29), .O(new_n107_));
  aoi21  g063(.a(new_n107_), .b(new_n105_), .c(new_n97_), .O(z6));
  inv1   g064(.a(x31), .O(new_n109_));
  nand4  g065(.a(new_n98_), .b(new_n109_), .c(x30), .d(x29), .O(new_n110_));
  nor2   g066(.a(new_n106_), .b(new_n101_), .O(new_n111_));
  aoi21  g067(.a(new_n111_), .b(new_n98_), .c(new_n109_), .O(new_n112_));
  nand2  g068(.a(new_n94_), .b(new_n58_), .O(new_n113_));
  nor2   g069(.a(new_n113_), .b(new_n112_), .O(new_n114_));
  nand3  g070(.a(new_n114_), .b(new_n110_), .c(new_n89_), .O(z7));
  ...
  nand2  g088(.a(new_n90_), .b(new_n86_), .O(new_n133_));
  nand3  g089(.a(new_n133_), .b(new_n106_), .c(x29), .O(new_n134_));
  ...
  nand2  g107(.a(new_n151_), .b(new_n90_), .O(new_n152_));
  oai21  g108(.a(x19), .b(x14), .c(x31), .O(new_n153_));
  aoi21  g109(.a(new_n106_), .b(new_n101_), .c(new_n153_), .O(new_n154_));
  ...
  nand2  g118(.a(new_n109_), .b(new_n106_), .O(new_n163_));
  ...
  nand2  g127(.a(x31), .b(new_n106_), .O(new_n172_));
