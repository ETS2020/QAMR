// Benchmark "FAU" written by ABC on Mon Jul  6 20:11:48 2020
...
module FAU ( 
  ...
  nor2   g042(.a(new_n86_), .b(x27), .O(new_n87_));
  inv1   g043(.a(x27), .O(new_n88_));
  nor2   g044(.a(x28), .b(new_n88_), .O(new_n89_));
  nor2   g045(.a(new_n80_), .b(new_n79_), .O(new_n90_));
  nand2  g046(.a(new_n90_), .b(new_n78_), .O(new_n91_));
  oai21  g047(.a(new_n89_), .b(new_n87_), .c(new_n91_), .O(new_n92_));
  ...
  oai21  g052(.a(new_n96_), .b(new_n87_), .c(new_n93_), .O(new_n97_));
  inv1   g053(.a(x26), .O(new_n98_));
  nand4  g054(.a(new_n57_), .b(new_n98_), .c(x25), .d(x01), .O(new_n99_));
  aoi21  g055(.a(new_n97_), .b(new_n92_), .c(new_n99_), .O(z4));
  nor2   g056(.a(new_n86_), .b(new_n88_), .O(new_n101_));
  xor2a  g057(.a(new_n101_), .b(x29), .O(new_n102_));
  nand2  g058(.a(new_n102_), .b(new_n91_), .O(new_n103_));
  xnor2a g059(.a(x29), .b(x27), .O(new_n104_));
  nand3  g060(.a(x29), .b(new_n86_), .c(new_n94_), .O(new_n105_));
  oai21  g061(.a(new_n104_), .b(new_n86_), .c(new_n105_), .O(new_n106_));
  nand2  g062(.a(new_n106_), .b(new_n93_), .O(new_n107_));
  aoi21  g063(.a(new_n107_), .b(new_n103_), .c(new_n99_), .O(z5));
  nand3  g064(.a(new_n98_), .b(x25), .c(x01), .O(new_n109_));
  inv1   g065(.a(x29), .O(new_n110_));
  nand2  g066(.a(new_n82_), .b(new_n78_), .O(new_n111_));
  oai21  g067(.a(new_n110_), .b(new_n86_), .c(new_n111_), .O(new_n112_));
  inv1   g068(.a(new_n78_), .O(new_n113_));
  oai21  g069(.a(new_n86_), .b(x18), .c(new_n90_), .O(new_n114_));
  oai21  g070(.a(new_n114_), .b(new_n113_), .c(new_n88_), .O(new_n115_));
  nand2  g071(.a(new_n115_), .b(new_n112_), .O(new_n116_));
  nand3  g072(.a(new_n116_), .b(new_n57_), .c(x30), .O(new_n117_));
  nor3   g073(.a(new_n77_), .b(new_n76_), .c(new_n93_), .O(new_n118_));
  nand2  g074(.a(new_n118_), .b(new_n90_), .O(new_n119_));
  nor2   g075(.a(x30), .b(new_n110_), .O(new_n120_));
  nand4  g076(.a(new_n120_), .b(new_n119_), .c(new_n101_), .d(new_n57_), .O(new_n121_));
  aoi21  g077(.a(new_n121_), .b(new_n117_), .c(new_n109_), .O(z6));
  inv1   g078(.a(x31), .O(new_n123_));
  nand4  g079(.a(new_n101_), .b(new_n123_), .c(x30), .d(x29), .O(new_n124_));
  inv1   g080(.a(x30), .O(new_n125_));
  nor2   g081(.a(new_n125_), .b(new_n110_), .O(new_n126_));
  nand2  g082(.a(new_n126_), .b(new_n101_), .O(new_n127_));
  aoi21  g083(.a(new_n127_), .b(x31), .c(new_n99_), .O(new_n128_));
  nand3  g084(.a(new_n128_), .b(new_n124_), .c(new_n111_), .O(z7));
  ...
  aoi21  g102(.a(new_n86_), .b(new_n88_), .c(new_n110_), .O(new_n147_));
  ...
  nor2   g110(.a(new_n133_), .b(new_n93_), .O(new_n155_));
  ...
  nand2  g120(.a(new_n164_), .b(new_n86_), .O(new_n165_));
  oai21  g121(.a(x19), .b(x14), .c(x31), .O(new_n166_));
  aoi21  g122(.a(new_n125_), .b(new_n110_), .c(new_n166_), .O(new_n167_));
  ...
  nand2  g127(.a(new_n98_), .b(x00), .O(new_n172_));
  ...
  nand2  g141(.a(new_n93_), .b(new_n185_), .O(new_n186_));
  nand3  g142(.a(new_n186_), .b(new_n184_), .c(new_n183_), .O(new_n187_));
  nand2  g143(.a(new_n133_), .b(x14), .O(new_n188_));
  nor2   g144(.a(new_n93_), .b(new_n131_), .O(new_n189_));
