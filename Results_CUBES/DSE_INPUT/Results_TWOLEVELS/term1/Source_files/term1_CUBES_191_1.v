// Benchmark "FAU" written by ABC on Mon Jul  6 20:11:05 2020
...
module FAU ( 
  ...
  inv1   g084(.a(x10), .O(new_n129_));
  nor4   g085(.a(new_n125_), .b(new_n122_), .c(x15), .d(new_n129_), .O(new_n130_));
  ...
  nand2  g095(.a(new_n139_), .b(new_n126_), .O(new_n140_));
  nand2  g096(.a(x17), .b(x11), .O(new_n141_));
  oai21  g097(.a(new_n141_), .b(new_n123_), .c(new_n122_), .O(new_n142_));
  inv1   g098(.a(x12), .O(new_n143_));
  oai21  g099(.a(new_n123_), .b(new_n143_), .c(new_n113_), .O(new_n144_));
  nand3  g100(.a(new_n144_), .b(new_n142_), .c(new_n140_), .O(new_n145_));
  nand2  g101(.a(x16), .b(x10), .O(new_n146_));
  oai21  g102(.a(new_n146_), .b(new_n125_), .c(new_n112_), .O(new_n147_));
  ...
  nand2  g124(.a(x18), .b(x16), .O(new_n169_));
  oai21  g125(.a(new_n169_), .b(new_n129_), .c(new_n112_), .O(new_n170_));
  oai21  g126(.a(new_n138_), .b(new_n123_), .c(new_n113_), .O(new_n171_));
  oai21  g127(.a(new_n169_), .b(new_n112_), .c(new_n116_), .O(new_n172_));
  nand3  g128(.a(new_n172_), .b(new_n171_), .c(new_n170_), .O(new_n173_));
  inv1   g129(.a(new_n173_), .O(new_n174_));
  inv1   g130(.a(x14), .O(new_n175_));
  oai21  g131(.a(x19), .b(new_n175_), .c(x17), .O(new_n176_));
  oai21  g132(.a(new_n116_), .b(x12), .c(new_n176_), .O(new_n177_));
  nand2  g133(.a(new_n139_), .b(x18), .O(new_n178_));
  inv1   g134(.a(new_n178_), .O(new_n179_));
  nand2  g135(.a(new_n106_), .b(x30), .O(new_n180_));
  nand2  g136(.a(x18), .b(x11), .O(new_n181_));
  nand2  g137(.a(new_n181_), .b(new_n122_), .O(new_n182_));
  nand2  g138(.a(x31), .b(new_n98_), .O(new_n183_));
  inv1   g139(.a(x13), .O(new_n184_));
  nand2  g140(.a(new_n114_), .b(new_n184_), .O(new_n185_));
  nand4  g141(.a(new_n185_), .b(new_n183_), .c(new_n182_), .d(new_n180_), .O(new_n186_));
  aoi21  g142(.a(new_n179_), .b(new_n177_), .c(new_n186_), .O(new_n187_));
  aoi21  g143(.a(new_n187_), .b(new_n174_), .c(new_n160_), .O(new_n188_));
  aoi21  g144(.a(new_n168_), .b(new_n165_), .c(new_n188_), .O(new_n189_));
  aoi21  g145(.a(new_n189_), .b(new_n164_), .c(new_n158_), .O(z9));
endmodule
