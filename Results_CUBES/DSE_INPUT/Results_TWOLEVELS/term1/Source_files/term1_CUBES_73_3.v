// Benchmark "FAU" written by ABC on Mon Jul  6 20:09:29 2020
...
module FAU ( 
  ...
  aoi21  g053(.a(new_n93_), .b(x29), .c(new_n97_), .O(new_n98_));
  nand3  g054(.a(new_n93_), .b(new_n97_), .c(x29), .O(new_n99_));
  inv1   g055(.a(new_n99_), .O(new_n100_));
  nor2   g056(.a(new_n95_), .b(new_n80_), .O(new_n101_));
  ...
  nor4   g060(.a(new_n82_), .b(new_n57_), .c(x31), .d(x26), .O(new_n105_));
  nand3  g061(.a(new_n105_), .b(new_n104_), .c(new_n81_), .O(z7));
  nand2  g062(.a(x29), .b(x27), .O(new_n107_));
  ...
  nand2  g084(.a(x32), .b(new_n97_), .O(new_n129_));
  ...
  nand4  g088(.a(z0), .b(x31), .c(new_n97_), .d(x29), .O(new_n133_));
  nand3  g089(.a(x27), .b(new_n111_), .c(x14), .O(new_n134_));
  oai21  g090(.a(new_n134_), .b(new_n133_), .c(new_n132_), .O(new_n135_));
  nand4  g091(.a(x27), .b(x19), .c(new_n109_), .d(x13), .O(new_n136_));
  nor2   g092(.a(new_n136_), .b(new_n133_), .O(new_n137_));
  aoi21  g093(.a(new_n135_), .b(x18), .c(new_n137_), .O(new_n138_));
  nand3  g094(.a(z0), .b(x31), .c(new_n97_), .O(new_n139_));
  nor2   g095(.a(new_n139_), .b(new_n107_), .O(new_n140_));
  nand2  g096(.a(new_n140_), .b(new_n115_), .O(new_n141_));
  oai21  g097(.a(new_n138_), .b(new_n108_), .c(new_n141_), .O(new_n142_));
  nand2  g098(.a(new_n142_), .b(x16), .O(new_n143_));
  nand4  g099(.a(new_n140_), .b(new_n120_), .c(new_n117_), .d(x11), .O(new_n144_));
  nand2  g100(.a(new_n144_), .b(new_n143_), .O(new_n145_));
  inv1   g101(.a(new_n107_), .O(new_n146_));
  nand4  g102(.a(new_n124_), .b(new_n118_), .c(x17), .d(x16), .O(new_n147_));
  oai22  g103(.a(new_n147_), .b(new_n139_), .c(z0), .d(new_n97_), .O(new_n148_));
  nand2  g104(.a(new_n148_), .b(new_n146_), .O(new_n149_));
  inv1   g105(.a(x15), .O(new_n150_));
  nand2  g106(.a(x16), .b(x10), .O(new_n151_));
  oai21  g107(.a(new_n151_), .b(new_n119_), .c(new_n150_), .O(new_n152_));
  nand2  g108(.a(new_n118_), .b(x12), .O(new_n153_));
  nand2  g109(.a(new_n153_), .b(new_n108_), .O(new_n154_));
  nand3  g110(.a(new_n118_), .b(x17), .c(x11), .O(new_n155_));
  nand2  g111(.a(new_n155_), .b(new_n117_), .O(new_n156_));
  ...
  nand2  g117(.a(new_n161_), .b(new_n149_), .O(new_n162_));
  aoi21  g118(.a(new_n145_), .b(x15), .c(new_n162_), .O(new_n163_));
  inv1   g119(.a(x26), .O(new_n164_));
  nand2  g120(.a(new_n164_), .b(x00), .O(new_n165_));
  aoi21  g121(.a(new_n163_), .b(new_n131_), .c(new_n165_), .O(z8));
  inv1   g122(.a(x33), .O(new_n167_));
  inv1   g123(.a(x31), .O(new_n168_));
  oai21  g124(.a(x28), .b(x27), .c(x29), .O(new_n169_));
  nand3  g125(.a(new_n169_), .b(new_n168_), .c(new_n97_), .O(new_n170_));
  nand3  g126(.a(new_n146_), .b(x31), .c(x30), .O(new_n171_));
  nand2  g127(.a(new_n171_), .b(new_n170_), .O(new_n172_));
  nand2  g128(.a(new_n172_), .b(new_n167_), .O(new_n173_));
  or2    g129(.a(new_n173_), .b(new_n127_), .O(new_n174_));
  nor2   g130(.a(new_n109_), .b(new_n108_), .O(new_n175_));
  nand2  g131(.a(new_n175_), .b(x11), .O(new_n176_));
  nand2  g132(.a(new_n176_), .b(new_n117_), .O(new_n177_));
  nand3  g133(.a(new_n175_), .b(x16), .c(x15), .O(new_n178_));
  nand2  g134(.a(new_n178_), .b(new_n111_), .O(new_n179_));
  inv1   g135(.a(new_n175_), .O(new_n180_));
  oai21  g136(.a(new_n180_), .b(new_n151_), .c(new_n150_), .O(new_n181_));
  nand3  g137(.a(new_n181_), .b(new_n179_), .c(new_n177_), .O(new_n182_));
  nand2  g138(.a(x18), .b(x12), .O(new_n183_));
  nand2  g139(.a(new_n183_), .b(new_n108_), .O(new_n184_));
  nand2  g140(.a(new_n107_), .b(x31), .O(new_n185_));
  inv1   g141(.a(x13), .O(new_n186_));
  nand2  g142(.a(new_n109_), .b(new_n186_), .O(new_n187_));
  nand2  g143(.a(new_n168_), .b(x30), .O(new_n188_));
  nand4  g144(.a(new_n188_), .b(new_n187_), .c(new_n185_), .d(new_n184_), .O(new_n189_));
  inv1   g145(.a(new_n189_), .O(new_n190_));
  aoi21  g146(.a(new_n111_), .b(x14), .c(new_n178_), .O(new_n191_));
  oai21  g147(.a(x30), .b(new_n91_), .c(new_n92_), .O(new_n192_));
  aoi21  g148(.a(new_n192_), .b(x29), .c(new_n191_), .O(new_n193_));
  nand2  g149(.a(new_n193_), .b(new_n190_), .O(new_n194_));
  oai21  g150(.a(new_n194_), .b(new_n182_), .c(x33), .O(new_n195_));
  aoi21  g151(.a(new_n195_), .b(new_n174_), .c(new_n165_), .O(z9));
endmodule
