...
module FAU ( 
  ...
  nor2   g043(.a(new_n81_), .b(new_n80_), .O(new_n88_));
  inv1   g044(.a(new_n88_), .O(new_n89_));
  nand2  g045(.a(new_n89_), .b(new_n87_), .O(new_n90_));
  inv1   g046(.a(x27), .O(new_n91_));
  nand2  g047(.a(new_n82_), .b(new_n91_), .O(new_n92_));
  inv1   g048(.a(x26), .O(new_n93_));
  nand4  g049(.a(new_n57_), .b(new_n93_), .c(x25), .d(x01), .O(new_n94_));
  aoi21  g050(.a(new_n92_), .b(new_n90_), .c(new_n94_), .O(z4));
  xor2a  g051(.a(x29), .b(x27), .O(new_n96_));
  nand2  g052(.a(new_n96_), .b(new_n82_), .O(new_n97_));
  inv1   g053(.a(x28), .O(new_n98_));
  nor2   g054(.a(new_n98_), .b(new_n91_), .O(new_n99_));
  xor2a  g055(.a(new_n99_), .b(x29), .O(new_n100_));
  nand2  g056(.a(new_n100_), .b(new_n89_), .O(new_n101_));
  aoi21  g057(.a(new_n101_), .b(new_n97_), .c(new_n94_), .O(z5));
  aoi21  g058(.a(x29), .b(x27), .c(new_n83_), .O(new_n103_));
  nor2   g059(.a(new_n88_), .b(x28), .O(new_n104_));
  oai21  g060(.a(new_n104_), .b(new_n103_), .c(x30), .O(new_n105_));
  inv1   g061(.a(x30), .O(new_n106_));
  inv1   g062(.a(new_n82_), .O(new_n107_));
  oai21  g063(.a(new_n88_), .b(new_n98_), .c(new_n107_), .O(new_n108_));
  nand4  g064(.a(new_n108_), .b(new_n106_), .c(x29), .d(x27), .O(new_n109_));
  aoi21  g065(.a(new_n109_), .b(new_n105_), .c(new_n94_), .O(z6));
  inv1   g066(.a(new_n81_), .O(new_n111_));
  nand4  g067(.a(new_n107_), .b(new_n111_), .c(new_n79_), .d(new_n77_), .O(new_n112_));
  inv1   g068(.a(x31), .O(new_n113_));
  nand4  g069(.a(new_n99_), .b(new_n113_), .c(x30), .d(x29), .O(new_n114_));
  inv1   g070(.a(x29), .O(new_n115_));
  nor2   g071(.a(new_n106_), .b(new_n115_), .O(new_n116_));
  nand2  g072(.a(new_n116_), .b(new_n99_), .O(new_n117_));
  aoi21  g073(.a(new_n117_), .b(x31), .c(new_n94_), .O(new_n118_));
  nand3  g074(.a(new_n118_), .b(new_n114_), .c(new_n112_), .O(z7));
  ...
  nand2  g092(.a(new_n98_), .b(new_n91_), .O(new_n137_));
  ...
  aoi21  g113(.a(new_n106_), .b(new_n115_), .c(new_n157_), .O(new_n158_));
  ...
  nand2  g122(.a(new_n113_), .b(new_n106_), .O(new_n167_));
  ...
  nand2  g131(.a(x31), .b(new_n106_), .O(new_n176_));
