...
module FAU ( 
  ...
  nand2  g045(.a(new_n87_), .b(x27), .O(new_n90_));
  nor2   g046(.a(new_n83_), .b(x26), .O(new_n91_));
  inv1   g047(.a(new_n91_), .O(new_n92_));
  aoi21  g048(.a(new_n90_), .b(new_n89_), .c(new_n92_), .O(new_n93_));
  nand2  g049(.a(new_n93_), .b(new_n82_), .O(new_n94_));
  inv1   g050(.a(new_n94_), .O(z4));
  nand2  g051(.a(x29), .b(new_n87_), .O(new_n96_));
  aoi21  g052(.a(new_n96_), .b(new_n89_), .c(new_n92_), .O(new_n97_));
  nand2  g053(.a(new_n97_), .b(new_n82_), .O(new_n98_));
  inv1   g054(.a(new_n98_), .O(z5));
  inv1   g055(.a(x30), .O(new_n100_));
  nor2   g056(.a(new_n87_), .b(new_n77_), .O(new_n101_));
  xor2a  g057(.a(new_n101_), .b(new_n100_), .O(new_n102_));
  nand2  g058(.a(new_n91_), .b(new_n57_), .O(new_n103_));
  nor3   g059(.a(new_n103_), .b(new_n102_), .c(new_n81_), .O(z6));
  inv1   g060(.a(new_n81_), .O(new_n105_));
  nand2  g061(.a(new_n101_), .b(x30), .O(new_n106_));
  ...
  aoi21  g066(.a(new_n110_), .b(new_n101_), .c(new_n103_), .O(new_n111_));
  nand3  g067(.a(new_n111_), .b(new_n107_), .c(new_n105_), .O(z7));
  ...
  nand3  g087(.a(z0), .b(x31), .c(x30), .O(new_n132_));
  oai22  g088(.a(new_n132_), .b(new_n131_), .c(z0), .d(x30), .O(new_n133_));
  nand2  g089(.a(new_n133_), .b(new_n113_), .O(new_n134_));
  inv1   g090(.a(new_n131_), .O(new_n135_));
  nand2  g091(.a(x29), .b(x27), .O(new_n136_));
  inv1   g092(.a(new_n136_), .O(new_n137_));
  nor2   g093(.a(new_n137_), .b(x28), .O(new_n138_));
  nor4   g094(.a(new_n138_), .b(x32), .c(new_n108_), .d(x30), .O(new_n139_));
  nor3   g095(.a(new_n125_), .b(new_n124_), .c(new_n114_), .O(new_n140_));
  nand4  g096(.a(x19), .b(x18), .c(x17), .d(x11), .O(new_n141_));
  nand2  g097(.a(new_n141_), .b(new_n124_), .O(new_n142_));
  nand3  g098(.a(x19), .b(x18), .c(x12), .O(new_n143_));
  ...
  oai21  g103(.a(new_n137_), .b(new_n88_), .c(x30), .O(new_n148_));
  ...
  nand3  g107(.a(new_n151_), .b(new_n148_), .c(new_n147_), .O(new_n152_));
  nor3   g108(.a(new_n152_), .b(new_n145_), .c(new_n140_), .O(new_n153_));
  nor2   g109(.a(new_n153_), .b(z0), .O(new_n154_));
  aoi21  g110(.a(new_n139_), .b(new_n135_), .c(new_n154_), .O(new_n155_));
  nand2  g111(.a(new_n76_), .b(x00), .O(new_n156_));
  aoi21  g112(.a(new_n155_), .b(new_n134_), .c(new_n156_), .O(z8));
  inv1   g113(.a(x33), .O(new_n158_));
  oai21  g114(.a(new_n130_), .b(new_n128_), .c(new_n158_), .O(new_n159_));
  nand2  g115(.a(new_n108_), .b(new_n100_), .O(new_n160_));
  oai22  g116(.a(new_n160_), .b(new_n159_), .c(new_n158_), .d(new_n108_), .O(new_n161_));
  nand2  g117(.a(new_n161_), .b(new_n113_), .O(new_n162_));
  inv1   g118(.a(new_n138_), .O(new_n163_));
  nand2  g119(.a(x31), .b(x30), .O(new_n164_));
  nand2  g120(.a(x33), .b(new_n100_), .O(new_n165_));
  oai21  g121(.a(new_n159_), .b(new_n164_), .c(new_n165_), .O(new_n166_));
  nand4  g122(.a(x18), .b(x17), .c(x16), .d(x15), .O(new_n167_));
  aoi21  g123(.a(new_n118_), .b(x14), .c(new_n167_), .O(new_n168_));
  aoi21  g124(.a(x18), .b(x12), .c(x17), .O(new_n169_));
  oai21  g125(.a(x18), .b(x13), .c(new_n109_), .O(new_n170_));
  nor3   g126(.a(new_n170_), .b(new_n169_), .c(new_n168_), .O(new_n171_));
  inv1   g127(.a(x11), .O(new_n172_));
  nand2  g128(.a(x18), .b(x17), .O(new_n173_));
  oai21  g129(.a(new_n173_), .b(new_n172_), .c(new_n124_), .O(new_n174_));
  nand2  g130(.a(new_n167_), .b(new_n118_), .O(new_n175_));
  oai21  g131(.a(new_n173_), .b(new_n146_), .c(new_n114_), .O(new_n176_));
  nand3  g132(.a(new_n176_), .b(new_n175_), .c(new_n174_), .O(new_n177_));
  inv1   g133(.a(new_n177_), .O(new_n178_));
  aoi21  g134(.a(new_n178_), .b(new_n171_), .c(new_n158_), .O(new_n179_));
  aoi21  g135(.a(new_n166_), .b(new_n163_), .c(new_n179_), .O(new_n180_));
  aoi21  g136(.a(new_n180_), .b(new_n162_), .c(new_n156_), .O(z9));
endmodule
