// Benchmark "FAU" written by ABC on Mon Jul  6 20:10:39 2020
...
module FAU ( 
  ...
  nand4  g067(.a(new_n97_), .b(new_n111_), .c(x30), .d(x29), .O(new_n112_));
  ...
  nand3  g071(.a(new_n115_), .b(new_n112_), .c(new_n110_), .O(z7));
  ...
  nand2  g089(.a(new_n96_), .b(new_n89_), .O(new_n134_));
  nand3  g090(.a(new_n134_), .b(new_n105_), .c(x29), .O(new_n135_));
  ...
  aoi21  g110(.a(new_n105_), .b(new_n101_), .c(new_n154_), .O(new_n155_));
  ...
  nand2  g115(.a(new_n91_), .b(x00), .O(new_n160_));
  ...
  nand2  g119(.a(new_n111_), .b(new_n105_), .O(new_n164_));
  ...
  nand2  g128(.a(x31), .b(new_n105_), .O(new_n173_));
