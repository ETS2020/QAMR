// Benchmark "FAU" written by ABC on Mon Jul  6 20:08:46 2020
...
module FAU ( 
  ...
  oai21  g036(.a(x24), .b(x19), .c(new_n80_), .O(new_n81_));
  nor2   g037(.a(new_n81_), .b(new_n77_), .O(new_n82_));
  inv1   g038(.a(x26), .O(new_n83_));
  inv1   g039(.a(x27), .O(new_n84_));
  nand2  g040(.a(new_n57_), .b(x28), .O(new_n85_));
  nand2  g041(.a(x25), .b(x01), .O(new_n86_));
  inv1   g042(.a(new_n86_), .O(new_n87_));
  nand4  g043(.a(new_n87_), .b(new_n85_), .c(new_n84_), .d(new_n83_), .O(new_n88_));
  nor2   g044(.a(new_n88_), .b(new_n82_), .O(z3));
  nand3  g045(.a(new_n58_), .b(x28), .c(new_n84_), .O(new_n90_));
  oai21  g046(.a(x28), .b(new_n84_), .c(new_n90_), .O(new_n91_));
  nor2   g047(.a(new_n86_), .b(x26), .O(new_n92_));
  inv1   g048(.a(new_n92_), .O(new_n93_));
  nor2   g049(.a(new_n93_), .b(new_n82_), .O(new_n94_));
  ...
  nor2   g056(.a(new_n100_), .b(new_n84_), .O(new_n101_));
  nand2  g057(.a(new_n101_), .b(new_n99_), .O(new_n102_));
  aoi21  g058(.a(new_n102_), .b(new_n98_), .c(new_n57_), .O(new_n103_));
  nand2  g059(.a(new_n103_), .b(new_n97_), .O(new_n104_));
  nand3  g060(.a(new_n97_), .b(x29), .c(new_n100_), .O(new_n105_));
  aoi21  g061(.a(new_n105_), .b(new_n104_), .c(new_n93_), .O(z5));
  inv1   g062(.a(new_n94_), .O(new_n107_));
  oai21  g063(.a(new_n99_), .b(new_n84_), .c(x30), .O(new_n108_));
  ...
  aoi21  g069(.a(new_n113_), .b(new_n112_), .c(new_n107_), .O(z6));
  inv1   g070(.a(x31), .O(new_n115_));
  nand4  g071(.a(new_n101_), .b(new_n115_), .c(x30), .d(x29), .O(new_n116_));
  nor2   g072(.a(new_n109_), .b(new_n99_), .O(new_n117_));
  aoi21  g073(.a(new_n117_), .b(new_n101_), .c(new_n115_), .O(new_n118_));
  nor3   g074(.a(new_n118_), .b(new_n93_), .c(new_n57_), .O(new_n119_));
  nand3  g075(.a(new_n119_), .b(new_n116_), .c(new_n97_), .O(z7));
  ...
  aoi21  g090(.a(new_n134_), .b(new_n130_), .c(new_n121_), .O(new_n135_));
  nand3  g091(.a(x16), .b(new_n121_), .c(x10), .O(new_n136_));
  nor2   g092(.a(new_n136_), .b(new_n132_), .O(new_n137_));
  nand2  g093(.a(new_n100_), .b(new_n84_), .O(new_n138_));
  ...
  nor2   g100(.a(new_n131_), .b(new_n121_), .O(new_n145_));
  ...
  oai21  g109(.a(new_n153_), .b(new_n132_), .c(new_n121_), .O(new_n154_));
  ...
  aoi21  g114(.a(new_n109_), .b(new_n99_), .c(new_n158_), .O(new_n159_));
  aoi21  g115(.a(x19), .b(x13), .c(x18), .O(new_n160_));
  aoi21  g116(.a(new_n117_), .b(x28), .c(new_n160_), .O(new_n161_));
  ...
  nand2  g119(.a(new_n83_), .b(x00), .O(new_n164_));
  ...
  nor2   g137(.a(new_n123_), .b(new_n122_), .O(new_n182_));
  ...
  oai21  g142(.a(new_n186_), .b(new_n153_), .c(new_n121_), .O(new_n187_));
