...
module FAU ( 
  ...
  aoi21  g036(.a(new_n80_), .b(new_n50_), .c(new_n47_), .O(new_n81_));
  inv1   g037(.a(x26), .O(new_n82_));
  nand3  g038(.a(new_n82_), .b(x25), .c(x01), .O(new_n83_));
  nor3   g039(.a(new_n83_), .b(new_n81_), .c(new_n79_), .O(z3));
  inv1   g040(.a(x28), .O(new_n85_));
  xnor2a g041(.a(x28), .b(x27), .O(new_n86_));
  oai22  g042(.a(new_n86_), .b(x02), .c(new_n85_), .d(x03), .O(new_n87_));
  nor2   g043(.a(new_n83_), .b(new_n79_), .O(new_n88_));
  nand2  g044(.a(new_n88_), .b(new_n87_), .O(new_n89_));
  inv1   g045(.a(new_n89_), .O(z4));
  inv1   g046(.a(new_n88_), .O(new_n91_));
  nor2   g047(.a(new_n85_), .b(new_n80_), .O(new_n92_));
  xor2a  g048(.a(new_n92_), .b(x29), .O(new_n93_));
  aoi22  g049(.a(new_n93_), .b(new_n50_), .c(x29), .d(new_n47_), .O(new_n94_));
  nor2   g050(.a(new_n94_), .b(new_n91_), .O(z5));
  ...
  nand2  g056(.a(new_n100_), .b(new_n50_), .O(new_n101_));
  nand2  g057(.a(x30), .b(new_n47_), .O(new_n102_));
  aoi21  g058(.a(new_n102_), .b(new_n101_), .c(new_n91_), .O(z6));
  ...
  nor2   g063(.a(new_n96_), .b(new_n107_), .O(new_n108_));
  aoi21  g064(.a(new_n108_), .b(new_n92_), .c(new_n105_), .O(new_n109_));
  inv1   g065(.a(new_n83_), .O(new_n110_));
  nand2  g066(.a(new_n110_), .b(new_n57_), .O(new_n111_));
  nor2   g067(.a(new_n111_), .b(new_n109_), .O(new_n112_));
  nand3  g068(.a(new_n112_), .b(new_n106_), .c(new_n104_), .O(z7));
  ...
  nand2  g086(.a(new_n85_), .b(new_n80_), .O(new_n131_));
  nand3  g087(.a(new_n131_), .b(new_n96_), .c(x29), .O(new_n132_));
  ...
  aoi21  g107(.a(new_n96_), .b(new_n107_), .c(new_n151_), .O(new_n152_));
  ...
  nand2  g112(.a(new_n82_), .b(x00), .O(new_n157_));
  ...
  nand2  g116(.a(new_n105_), .b(new_n96_), .O(new_n161_));
