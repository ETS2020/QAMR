// Benchmark "FAU" written by ABC on Mon Jul  6 20:08:50 2020
...
module FAU ( 
  ...
  nand3  g088(.a(x18), .b(new_n115_), .c(x12), .O(new_n133_));
  nand3  g089(.a(new_n116_), .b(x17), .c(x13), .O(new_n134_));
  aoi21  g090(.a(new_n134_), .b(new_n133_), .c(new_n124_), .O(new_n135_));
  nand4  g091(.a(x18), .b(x17), .c(new_n124_), .d(x11), .O(new_n136_));
  inv1   g092(.a(new_n136_), .O(new_n137_));
  oai21  g093(.a(new_n137_), .b(new_n135_), .c(x15), .O(new_n138_));
  inv1   g094(.a(new_n130_), .O(new_n139_));
  nor2   g095(.a(new_n116_), .b(new_n115_), .O(new_n140_));
  ...
  nand2  g100(.a(new_n101_), .b(x27), .O(new_n145_));
  aoi21  g101(.a(new_n145_), .b(new_n144_), .c(new_n118_), .O(new_n146_));
  nand2  g102(.a(x30), .b(new_n92_), .O(new_n147_));
  nor2   g103(.a(new_n124_), .b(new_n129_), .O(new_n148_));
  nand4  g104(.a(new_n148_), .b(new_n140_), .c(new_n93_), .d(new_n118_), .O(new_n149_));
  aoi21  g105(.a(new_n147_), .b(new_n145_), .c(new_n149_), .O(new_n150_));
  aoi21  g106(.a(new_n146_), .b(new_n142_), .c(new_n150_), .O(new_n151_));
  oai21  g107(.a(new_n132_), .b(new_n114_), .c(new_n151_), .O(new_n152_));
  nor2   g108(.a(x32), .b(new_n107_), .O(new_n153_));
  nand2  g109(.a(new_n153_), .b(new_n152_), .O(new_n154_));
  nand2  g110(.a(new_n148_), .b(new_n126_), .O(new_n155_));
  nor2   g111(.a(new_n118_), .b(new_n116_), .O(new_n156_));
  ...
  nand2  g115(.a(new_n159_), .b(new_n115_), .O(new_n160_));
  nand3  g116(.a(new_n160_), .b(new_n158_), .c(new_n155_), .O(new_n161_));
  nand2  g117(.a(x16), .b(x10), .O(new_n162_));
  oai21  g118(.a(new_n162_), .b(new_n125_), .c(new_n129_), .O(new_n163_));
  inv1   g119(.a(new_n108_), .O(new_n164_));
  nand2  g120(.a(new_n98_), .b(new_n92_), .O(new_n165_));
  oai21  g121(.a(new_n164_), .b(new_n92_), .c(new_n165_), .O(new_n166_));
  nand2  g122(.a(new_n166_), .b(new_n93_), .O(new_n167_));
  oai21  g123(.a(x19), .b(x14), .c(x31), .O(new_n168_));
  aoi21  g124(.a(new_n98_), .b(new_n91_), .c(new_n168_), .O(new_n169_));
  aoi21  g125(.a(x19), .b(x13), .c(x18), .O(new_n170_));
  aoi21  g126(.a(new_n108_), .b(x28), .c(new_n170_), .O(new_n171_));
  ...
  inv1   g129(.a(x26), .O(new_n174_));
  nand2  g130(.a(new_n174_), .b(x00), .O(new_n175_));
  aoi21  g131(.a(new_n173_), .b(new_n154_), .c(new_n175_), .O(z8));
  inv1   g132(.a(x33), .O(new_n177_));
  nor2   g133(.a(new_n107_), .b(new_n98_), .O(new_n178_));
  nor2   g134(.a(x31), .b(x30), .O(new_n179_));
  aoi22  g135(.a(new_n179_), .b(new_n91_), .c(new_n178_), .d(new_n99_), .O(new_n180_));
  nand3  g136(.a(new_n178_), .b(x29), .c(x27), .O(new_n181_));
  nand2  g137(.a(new_n179_), .b(new_n143_), .O(new_n182_));
  aoi21  g138(.a(new_n182_), .b(new_n181_), .c(new_n118_), .O(new_n183_));
  nand2  g139(.a(new_n179_), .b(new_n92_), .O(new_n184_));
  aoi21  g140(.a(new_n184_), .b(new_n181_), .c(new_n149_), .O(new_n185_));
  aoi21  g141(.a(new_n183_), .b(new_n142_), .c(new_n185_), .O(new_n186_));
  oai21  g142(.a(new_n180_), .b(new_n132_), .c(new_n186_), .O(new_n187_));
  nand2  g143(.a(new_n187_), .b(new_n177_), .O(new_n188_));
  oai21  g144(.a(new_n143_), .b(new_n164_), .c(x31), .O(new_n189_));
  nand2  g145(.a(new_n148_), .b(new_n140_), .O(new_n190_));
  nand2  g146(.a(new_n190_), .b(new_n118_), .O(new_n191_));
  inv1   g147(.a(new_n140_), .O(new_n192_));
  oai21  g148(.a(new_n162_), .b(new_n192_), .c(new_n129_), .O(new_n193_));
  nand2  g149(.a(new_n140_), .b(x11), .O(new_n194_));
  nand2  g150(.a(new_n194_), .b(new_n124_), .O(new_n195_));
  nand4  g151(.a(new_n195_), .b(new_n193_), .c(new_n191_), .d(new_n189_), .O(new_n196_));
  oai21  g152(.a(new_n143_), .b(new_n91_), .c(new_n98_), .O(new_n197_));
  nand2  g153(.a(new_n197_), .b(new_n107_), .O(new_n198_));
  nand2  g154(.a(new_n118_), .b(x14), .O(new_n199_));
  nand3  g155(.a(new_n199_), .b(new_n148_), .c(new_n140_), .O(new_n200_));
  aoi21  g156(.a(x18), .b(x12), .c(x17), .O(new_n201_));
  nor2   g157(.a(x18), .b(x13), .O(new_n202_));
  nor2   g158(.a(new_n202_), .b(new_n201_), .O(new_n203_));
  nand3  g159(.a(new_n203_), .b(new_n200_), .c(new_n198_), .O(new_n204_));
  oai21  g160(.a(new_n204_), .b(new_n196_), .c(x33), .O(new_n205_));
  aoi21  g161(.a(new_n205_), .b(new_n188_), .c(new_n175_), .O(z9));
endmodule
