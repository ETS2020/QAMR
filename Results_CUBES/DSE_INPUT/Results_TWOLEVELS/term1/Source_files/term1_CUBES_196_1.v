...
module FAU ( 
  ...
  nand3  g076(.a(x19), .b(new_n81_), .c(x13), .O(new_n121_));
  ...
  nor2   g099(.a(new_n122_), .b(new_n81_), .O(new_n144_));
  ...
  nand2  g103(.a(new_n147_), .b(new_n120_), .O(new_n148_));
