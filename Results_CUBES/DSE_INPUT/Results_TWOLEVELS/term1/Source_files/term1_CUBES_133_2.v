...
module FAU ( 
  ...
  nand2  g016(.a(new_n60_), .b(new_n50_), .O(new_n61_));
  aoi21  g017(.a(new_n61_), .b(new_n58_), .c(new_n56_), .O(new_n62_));
  oai21  g018(.a(new_n59_), .b(x05), .c(new_n47_), .O(new_n63_));
  nand2  g019(.a(x06), .b(new_n50_), .O(new_n64_));
  inv1   g020(.a(new_n64_), .O(new_n65_));
  nand2  g021(.a(new_n65_), .b(new_n63_), .O(new_n66_));
  nand3  g022(.a(new_n64_), .b(new_n60_), .c(x05), .O(new_n67_));
  aoi21  g023(.a(new_n67_), .b(new_n66_), .c(x01), .O(new_n68_));
  oai21  g024(.a(new_n68_), .b(new_n62_), .c(new_n55_), .O(new_n69_));
  xor2a  g025(.a(x07), .b(x04), .O(new_n70_));
  nand2  g026(.a(x03), .b(new_n50_), .O(new_n71_));
  nand2  g027(.a(new_n60_), .b(x02), .O(new_n72_));
  aoi21  g028(.a(new_n72_), .b(new_n71_), .c(new_n56_), .O(new_n73_));
  nand2  g029(.a(new_n64_), .b(new_n63_), .O(new_n74_));
  nand4  g030(.a(new_n65_), .b(x08), .c(x05), .d(new_n47_), .O(new_n75_));
  aoi21  g031(.a(new_n75_), .b(new_n74_), .c(x01), .O(new_n76_));
  oai21  g032(.a(new_n76_), .b(new_n73_), .c(new_n70_), .O(new_n77_));
  aoi21  g033(.a(new_n77_), .b(new_n69_), .c(x09), .O(z2));
  ...
  xor2a  g052(.a(new_n96_), .b(new_n93_), .O(new_n97_));
  nand2  g053(.a(new_n90_), .b(new_n58_), .O(new_n98_));
  nor3   g054(.a(new_n98_), .b(new_n97_), .c(new_n82_), .O(z5));
  inv1   g055(.a(x30), .O(new_n100_));
  nand2  g056(.a(new_n96_), .b(x29), .O(new_n101_));
  inv1   g057(.a(new_n101_), .O(new_n102_));
  nand3  g058(.a(new_n96_), .b(new_n100_), .c(x29), .O(new_n103_));
  oai21  g059(.a(new_n102_), .b(new_n100_), .c(new_n103_), .O(new_n104_));
  nor2   g060(.a(new_n98_), .b(new_n82_), .O(new_n105_));
  ...
  nor2   g065(.a(new_n100_), .b(new_n93_), .O(new_n110_));
  aoi21  g066(.a(new_n110_), .b(new_n96_), .c(new_n108_), .O(new_n111_));
  nor2   g067(.a(new_n111_), .b(new_n98_), .O(new_n112_));
  nand3  g068(.a(new_n112_), .b(new_n109_), .c(new_n83_), .O(z7));
  ...
  nand2  g086(.a(new_n95_), .b(new_n94_), .O(new_n131_));
  nand3  g087(.a(new_n131_), .b(new_n100_), .c(x29), .O(new_n132_));
  ...
  nand2  g105(.a(new_n149_), .b(new_n95_), .O(new_n150_));
  oai21  g106(.a(x19), .b(x14), .c(x31), .O(new_n151_));
  aoi21  g107(.a(new_n100_), .b(new_n93_), .c(new_n151_), .O(new_n152_));
  ...
  nand2  g117(.a(new_n108_), .b(new_n100_), .O(new_n162_));
