...
module FAU ( 
  ...
  nand4  g042(.a(new_n58_), .b(new_n86_), .c(new_n85_), .d(x25), .O(new_n87_));
  nor2   g043(.a(new_n87_), .b(new_n84_), .O(z3));
  inv1   g044(.a(x28), .O(new_n89_));
  nand3  g045(.a(new_n89_), .b(x27), .c(x01), .O(new_n90_));
  oai21  g046(.a(new_n89_), .b(x27), .c(new_n90_), .O(new_n91_));
  nand3  g047(.a(new_n58_), .b(new_n85_), .c(x25), .O(new_n92_));
  inv1   g048(.a(new_n92_), .O(new_n93_));
  nand2  g049(.a(new_n93_), .b(new_n91_), .O(new_n94_));
  nor2   g050(.a(new_n94_), .b(new_n84_), .O(z4));
  inv1   g051(.a(x29), .O(new_n96_));
  nor2   g052(.a(new_n89_), .b(new_n86_), .O(new_n97_));
  nand2  g053(.a(new_n97_), .b(new_n96_), .O(new_n98_));
  oai21  g054(.a(new_n96_), .b(x28), .c(new_n98_), .O(new_n99_));
  aoi22  g055(.a(new_n99_), .b(x01), .c(x29), .d(new_n86_), .O(new_n100_));
  nand2  g056(.a(new_n93_), .b(new_n83_), .O(new_n101_));
  nor2   g057(.a(new_n101_), .b(new_n100_), .O(z5));
  oai21  g058(.a(new_n96_), .b(new_n89_), .c(x30), .O(new_n103_));
  ...
  nand2  g062(.a(new_n106_), .b(x01), .O(new_n107_));
  nand2  g063(.a(x30), .b(new_n86_), .O(new_n108_));
  aoi21  g064(.a(new_n108_), .b(new_n107_), .c(new_n101_), .O(z6));
  inv1   g065(.a(x31), .O(new_n110_));
  nand4  g066(.a(new_n97_), .b(new_n110_), .c(x30), .d(x29), .O(new_n111_));
  nor2   g067(.a(new_n104_), .b(new_n96_), .O(new_n112_));
  aoi21  g068(.a(new_n112_), .b(new_n97_), .c(new_n110_), .O(new_n113_));
  nand4  g069(.a(new_n58_), .b(new_n85_), .c(x25), .d(x01), .O(new_n114_));
  ...
  nand2  g089(.a(new_n89_), .b(new_n86_), .O(new_n134_));
  ...
  nand2  g108(.a(new_n152_), .b(new_n89_), .O(new_n153_));
  oai21  g109(.a(x19), .b(x14), .c(x31), .O(new_n154_));
  aoi21  g110(.a(new_n104_), .b(new_n96_), .c(new_n154_), .O(new_n155_));
  ...
  nand2  g115(.a(new_n85_), .b(x00), .O(new_n160_));
  ...
  nand2  g119(.a(new_n110_), .b(new_n104_), .O(new_n164_));
  ...
  nand2  g128(.a(x31), .b(new_n104_), .O(new_n173_));
