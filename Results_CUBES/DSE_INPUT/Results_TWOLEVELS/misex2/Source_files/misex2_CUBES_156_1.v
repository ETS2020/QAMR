...
module FAU ( 
  ...
  nand4  g75(.a(new_n60_), .b(new_n49_), .c(x17), .d(new_n59_), .O(new_n119_));
  inv1   g76(.a(x24), .O(new_n120_));
  nand2  g77(.a(new_n120_), .b(x09), .O(new_n121_));
  aoi21  g78(.a(new_n119_), .b(new_n118_), .c(new_n121_), .O(z12));
  nor2   g79(.a(x19), .b(new_n47_), .O(new_n123_));
  and2   g80(.a(new_n123_), .b(new_n45_), .O(z13));
  nor2   g81(.a(new_n55_), .b(new_n46_), .O(z14));
  aoi21  g82(.a(new_n54_), .b(x01), .c(new_n59_), .O(new_n126_));
  nand3  g83(.a(x19), .b(new_n59_), .c(new_n66_), .O(new_n127_));
  oai21  g84(.a(new_n126_), .b(new_n65_), .c(new_n127_), .O(z15));
