// Benchmark "FAU" written by ABC on Mon Jul  6 13:30:09 2020
...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n122_, new_n123_, new_n127_, new_n128_;
  ...
  nor2   g47(.a(new_n68_), .b(x11), .O(new_n91_));
  nor2   g48(.a(x14), .b(x13), .O(new_n92_));
  nand4  g49(.a(new_n92_), .b(new_n91_), .c(new_n90_), .d(new_n88_), .O(new_n93_));
  ...
  nor2   g56(.a(x20), .b(new_n63_), .O(new_n100_));
  nand4  g57(.a(new_n100_), .b(new_n57_), .c(x22), .d(x21), .O(new_n101_));
  inv1   g58(.a(x13), .O(new_n102_));
  nand3  g59(.a(new_n102_), .b(x12), .c(new_n59_), .O(new_n103_));
  nor2   g60(.a(new_n103_), .b(new_n89_), .O(new_n104_));
  nor2   g61(.a(new_n85_), .b(x14), .O(new_n105_));
  nand4  g62(.a(new_n97_), .b(new_n96_), .c(x20), .d(x16), .O(new_n106_));
  inv1   g63(.a(new_n106_), .O(new_n107_));
  nand3  g64(.a(new_n107_), .b(new_n105_), .c(new_n104_), .O(new_n108_));
  aoi21  g65(.a(new_n108_), .b(new_n101_), .c(x00), .O(z10));
  nand4  g66(.a(new_n94_), .b(x21), .c(x18), .d(x01), .O(new_n110_));
  nand3  g67(.a(new_n96_), .b(x20), .c(new_n86_), .O(new_n111_));
  inv1   g68(.a(new_n111_), .O(new_n112_));
  nand3  g69(.a(new_n112_), .b(new_n105_), .c(new_n104_), .O(new_n113_));
  nand2  g70(.a(new_n97_), .b(new_n62_), .O(new_n114_));
  aoi21  g71(.a(new_n113_), .b(new_n110_), .c(new_n114_), .O(z11));
  inv1   g72(.a(x02), .O(new_n116_));
  oai21  g73(.a(new_n54_), .b(new_n116_), .c(new_n64_), .O(new_n117_));
  oai21  g74(.a(x19), .b(x02), .c(x23), .O(new_n118_));
  nand3  g75(.a(new_n49_), .b(x17), .c(new_n116_), .O(new_n119_));
  nand2  g76(.a(new_n119_), .b(new_n118_), .O(new_n120_));
  nand2  g77(.a(new_n120_), .b(new_n81_), .O(new_n121_));
  inv1   g78(.a(x24), .O(new_n122_));
  nand2  g79(.a(new_n122_), .b(x09), .O(new_n123_));
  aoi21  g80(.a(new_n121_), .b(new_n117_), .c(new_n123_), .O(z12));
  nor3   g81(.a(new_n119_), .b(x01), .c(x00), .O(z13));
  nor2   g82(.a(new_n55_), .b(new_n46_), .O(z14));
  aoi21  g83(.a(new_n54_), .b(x01), .c(new_n116_), .O(new_n127_));
  nand3  g84(.a(x19), .b(new_n116_), .c(new_n63_), .O(new_n128_));
  oai21  g85(.a(new_n127_), .b(new_n62_), .c(new_n128_), .O(z15));
  nor2   g86(.a(new_n63_), .b(x00), .O(z16));
