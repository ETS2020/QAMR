...
module FAU ( 
  ...
  nand4  g18(.a(new_n61_), .b(x18), .c(new_n50_), .d(new_n60_), .O(new_n62_));
  ...
  nand2  g35(.a(new_n61_), .b(x02), .O(new_n79_));
  ...
  oai21  g73(.a(new_n57_), .b(new_n60_), .c(new_n66_), .O(new_n117_));
