...
module FAU ( 
  ...
  xnor2a g18(.a(new_n52_), .b(x08), .O(new_n53_));
  nand2  g19(.a(new_n53_), .b(new_n44_), .O(new_n54_));
  nand2  g20(.a(new_n49_), .b(x08), .O(new_n55_));
  aoi21  g21(.a(new_n55_), .b(new_n54_), .c(new_n40_), .O(z04));
  ...
  nand4  g29(.a(new_n63_), .b(new_n61_), .c(new_n58_), .d(x04), .O(z05));
  ...
  nand4  g39(.a(new_n67_), .b(new_n73_), .c(new_n72_), .d(new_n62_), .O(new_n74_));
  nand3  g40(.a(new_n74_), .b(new_n71_), .c(new_n65_), .O(z07));
  nand2  g41(.a(new_n74_), .b(x12), .O(new_n76_));
  inv1   g42(.a(x12), .O(new_n77_));
  nand4  g43(.a(new_n68_), .b(new_n67_), .c(new_n77_), .d(new_n73_), .O(new_n78_));
  nand3  g44(.a(new_n78_), .b(new_n76_), .c(new_n65_), .O(z08));
  nand3  g45(.a(new_n73_), .b(new_n59_), .c(x02), .O(new_n80_));
  inv1   g46(.a(x13), .O(new_n81_));
  nand4  g47(.a(new_n81_), .b(new_n77_), .c(new_n72_), .d(new_n62_), .O(new_n82_));
  nor2   g48(.a(new_n82_), .b(new_n80_), .O(new_n83_));
  nor2   g49(.a(new_n49_), .b(x02), .O(new_n84_));
  aoi21  g50(.a(new_n83_), .b(new_n67_), .c(new_n84_), .O(new_n85_));
  ...
  nand2  g56(.a(new_n73_), .b(new_n72_), .O(new_n91_));
  nand2  g57(.a(new_n81_), .b(new_n77_), .O(new_n92_));
  oai21  g58(.a(new_n92_), .b(new_n91_), .c(new_n90_), .O(new_n93_));
  nand3  g59(.a(new_n93_), .b(new_n89_), .c(new_n44_), .O(new_n94_));
  ...
  nor2   g63(.a(new_n84_), .b(x03), .O(new_n98_));
