...
module FAU ( 
  ...
  nand4  g30(.a(new_n64_), .b(new_n63_), .c(x07), .d(x06), .O(new_n65_));
  nand4  g31(.a(new_n65_), .b(new_n62_), .c(new_n58_), .d(x04), .O(z06));
  nand4  g32(.a(new_n63_), .b(x08), .c(x07), .d(x06), .O(new_n67_));
  nand2  g33(.a(new_n67_), .b(new_n59_), .O(new_n68_));
  aoi21  g34(.a(x11), .b(x09), .c(new_n40_), .O(new_n69_));
  nand3  g35(.a(new_n69_), .b(new_n68_), .c(new_n58_), .O(z07));
  nor2   g36(.a(x12), .b(new_n40_), .O(new_n71_));
  nand2  g37(.a(new_n71_), .b(new_n58_), .O(z08));
  nor2   g38(.a(x13), .b(new_n40_), .O(new_n73_));
  nand2  g39(.a(new_n73_), .b(new_n58_), .O(z09));
  and2   g40(.a(x06), .b(x00), .O(new_n75_));
  nand2  g41(.a(x08), .b(x07), .O(new_n76_));
  nor2   g42(.a(new_n76_), .b(x09), .O(new_n77_));
  nand3  g43(.a(new_n77_), .b(new_n75_), .c(new_n47_), .O(new_n78_));
  nand2  g44(.a(new_n45_), .b(x14), .O(new_n79_));
  aoi21  g45(.a(new_n79_), .b(new_n78_), .c(new_n40_), .O(z10));
  nand2  g46(.a(x16), .b(new_n35_), .O(new_n81_));
  aoi21  g47(.a(new_n81_), .b(new_n43_), .c(new_n40_), .O(z12));
