...
module FAU ( 
  ...
  aoi22  g41(.a(new_n75_), .b(new_n73_), .c(new_n74_), .d(x11), .O(new_n76_));
  nand4  g42(.a(new_n76_), .b(new_n72_), .c(new_n63_), .d(x04), .O(z07));
  nand2  g43(.a(new_n75_), .b(new_n73_), .O(new_n78_));
  nand2  g44(.a(new_n78_), .b(x12), .O(new_n79_));
  inv1   g45(.a(x12), .O(new_n80_));
  nand3  g46(.a(new_n75_), .b(new_n73_), .c(new_n80_), .O(new_n81_));
  nand3  g47(.a(new_n81_), .b(new_n79_), .c(new_n66_), .O(z08));
  inv1   g48(.a(x11), .O(new_n83_));
  inv1   g49(.a(x13), .O(new_n84_));
  nand3  g50(.a(new_n84_), .b(new_n80_), .c(new_n83_), .O(new_n85_));
  nor2   g51(.a(new_n85_), .b(new_n74_), .O(new_n86_));
  aoi21  g52(.a(new_n86_), .b(new_n47_), .c(new_n71_), .O(new_n87_));
  nand2  g53(.a(new_n81_), .b(x13), .O(new_n88_));
  nand4  g54(.a(new_n88_), .b(new_n87_), .c(new_n63_), .d(x04), .O(z09));
  nand2  g55(.a(new_n57_), .b(x00), .O(new_n90_));
  nand3  g56(.a(new_n75_), .b(new_n84_), .c(new_n80_), .O(new_n91_));
  nand2  g57(.a(new_n91_), .b(new_n90_), .O(new_n92_));
  nand3  g58(.a(new_n92_), .b(new_n73_), .c(new_n47_), .O(new_n93_));
  nand2  g59(.a(new_n45_), .b(x14), .O(new_n94_));
  aoi21  g60(.a(new_n94_), .b(new_n93_), .c(new_n40_), .O(z10));
  aoi21  g61(.a(new_n59_), .b(new_n43_), .c(new_n40_), .O(z12));
  nand3  g62(.a(x08), .b(x07), .c(x06), .O(new_n97_));
  nand4  g63(.a(new_n59_), .b(new_n58_), .c(new_n57_), .d(new_n43_), .O(new_n98_));
  aoi21  g64(.a(new_n97_), .b(new_n47_), .c(new_n98_), .O(new_n99_));
