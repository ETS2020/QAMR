...
module FAU ( 
  ...
  nand3  g48(.a(new_n74_), .b(new_n69_), .c(new_n82_), .O(new_n83_));
  aoi21  g49(.a(new_n81_), .b(x16), .c(new_n83_), .O(new_n84_));
  inv1   g50(.a(x16), .O(new_n85_));
  nor2   g51(.a(new_n85_), .b(x02), .O(new_n86_));
  aoi21  g52(.a(new_n84_), .b(new_n79_), .c(new_n86_), .O(new_n87_));
  ...
  oai21  g58(.a(new_n92_), .b(new_n84_), .c(new_n79_), .O(new_n93_));
