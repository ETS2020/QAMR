// Benchmark "FAU" written by ABC on Mon Jul  6 14:34:27 2020
...
module FAU ( 
  ...
  nand3  g27(.a(new_n58_), .b(x08), .c(x06), .O(new_n62_));
  ...
  nand3  g32(.a(new_n66_), .b(new_n63_), .c(new_n61_), .O(z06));
  nand2  g33(.a(new_n64_), .b(new_n58_), .O(new_n68_));
  oai21  g34(.a(new_n68_), .b(new_n54_), .c(x11), .O(new_n69_));
  nor2   g35(.a(x11), .b(x10), .O(new_n70_));
  nand3  g36(.a(new_n70_), .b(new_n65_), .c(new_n58_), .O(new_n71_));
  nand3  g37(.a(new_n71_), .b(new_n69_), .c(new_n61_), .O(z07));
  nand2  g38(.a(new_n70_), .b(new_n58_), .O(new_n73_));
  oai21  g39(.a(new_n73_), .b(new_n54_), .c(x12), .O(new_n74_));
  inv1   g40(.a(x11), .O(new_n75_));
  inv1   g41(.a(x12), .O(new_n76_));
  nand4  g42(.a(new_n76_), .b(new_n75_), .c(new_n64_), .d(new_n58_), .O(new_n77_));
  inv1   g43(.a(new_n77_), .O(new_n78_));
  nand2  g44(.a(new_n78_), .b(new_n65_), .O(new_n79_));
  nand3  g45(.a(new_n79_), .b(new_n74_), .c(new_n61_), .O(z08));
  inv1   g46(.a(x13), .O(new_n81_));
  nand4  g47(.a(new_n81_), .b(new_n76_), .c(new_n75_), .d(new_n64_), .O(new_n82_));
  ...
  oai21  g51(.a(new_n77_), .b(new_n54_), .c(x13), .O(new_n86_));
