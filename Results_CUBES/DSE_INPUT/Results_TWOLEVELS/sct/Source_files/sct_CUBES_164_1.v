...
module FAU ( 
  ...
  aoi21  g50(.a(new_n81_), .b(new_n44_), .c(new_n84_), .O(new_n85_));
  nor2   g51(.a(new_n80_), .b(x02), .O(new_n86_));
  aoi21  g52(.a(new_n85_), .b(new_n79_), .c(new_n86_), .O(new_n87_));
  oai21  g53(.a(new_n75_), .b(new_n54_), .c(x13), .O(new_n88_));
  nand2  g54(.a(x16), .b(x03), .O(new_n89_));
  nand4  g55(.a(new_n89_), .b(new_n88_), .c(new_n87_), .d(x04), .O(z09));
  inv1   g56(.a(x00), .O(new_n91_));
  aoi21  g57(.a(new_n44_), .b(x16), .c(new_n91_), .O(new_n92_));
  oai21  g58(.a(new_n92_), .b(new_n85_), .c(new_n79_), .O(new_n93_));
  nand2  g59(.a(new_n46_), .b(x14), .O(new_n94_));
  aoi21  g60(.a(new_n94_), .b(new_n93_), .c(new_n40_), .O(z10));
  nor2   g61(.a(new_n86_), .b(x03), .O(new_n96_));
