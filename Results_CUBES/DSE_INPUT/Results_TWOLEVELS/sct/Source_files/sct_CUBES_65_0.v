...
module FAU ( 
  ...
  nor3   g20(.a(new_n54_), .b(new_n46_), .c(new_n40_), .O(z04));
  nor2   g21(.a(new_n45_), .b(x02), .O(new_n56_));
  aoi21  g22(.a(new_n47_), .b(new_n43_), .c(new_n56_), .O(new_n57_));
  ...
  nand4  g28(.a(new_n62_), .b(new_n61_), .c(new_n59_), .d(x04), .O(new_n63_));
  inv1   g29(.a(new_n63_), .O(new_n64_));
  oai21  g30(.a(new_n57_), .b(new_n40_), .c(new_n64_), .O(z05));
  nand2  g31(.a(new_n59_), .b(x10), .O(new_n66_));
  oai21  g32(.a(new_n40_), .b(x02), .c(new_n44_), .O(new_n67_));
  nand2  g33(.a(new_n67_), .b(x16), .O(new_n68_));
  inv1   g34(.a(x10), .O(new_n69_));
  nand4  g35(.a(new_n69_), .b(new_n58_), .c(x08), .d(x07), .O(new_n70_));
  nand4  g36(.a(new_n70_), .b(new_n68_), .c(new_n66_), .d(x04), .O(z06));
  ...
  nand4  g41(.a(new_n75_), .b(new_n72_), .c(new_n68_), .d(x04), .O(z07));
  nand2  g42(.a(new_n75_), .b(x12), .O(new_n77_));
  inv1   g43(.a(x12), .O(new_n78_));
  nand3  g44(.a(new_n74_), .b(new_n73_), .c(new_n78_), .O(new_n79_));
  nand4  g45(.a(new_n79_), .b(new_n77_), .c(new_n68_), .d(x04), .O(z08));
  inv1   g46(.a(x11), .O(new_n81_));
  inv1   g47(.a(x13), .O(new_n82_));
  nand3  g48(.a(new_n82_), .b(new_n78_), .c(new_n81_), .O(new_n83_));
  nor2   g49(.a(new_n83_), .b(new_n70_), .O(new_n84_));
  aoi21  g50(.a(new_n84_), .b(new_n47_), .c(new_n56_), .O(new_n85_));
  nand2  g51(.a(new_n79_), .b(x13), .O(new_n86_));
  nand4  g52(.a(new_n86_), .b(new_n85_), .c(new_n62_), .d(x04), .O(z09));
  inv1   g53(.a(x00), .O(new_n88_));
  nand3  g54(.a(new_n74_), .b(new_n82_), .c(new_n78_), .O(new_n89_));
  nand2  g55(.a(new_n89_), .b(new_n88_), .O(new_n90_));
  nand3  g56(.a(new_n90_), .b(new_n73_), .c(new_n47_), .O(new_n91_));
  nand2  g57(.a(new_n46_), .b(x14), .O(new_n92_));
  aoi21  g58(.a(new_n92_), .b(new_n91_), .c(new_n40_), .O(z10));
  nor2   g59(.a(new_n56_), .b(x03), .O(new_n94_));
