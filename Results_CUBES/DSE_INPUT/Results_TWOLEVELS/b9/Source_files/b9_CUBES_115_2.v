...
module FAU ( 
  ...
  nand3  g066(.a(new_n77_), .b(x27), .c(new_n64_), .O(new_n129_));
  nand2  g067(.a(new_n129_), .b(new_n86_), .O(new_n130_));
  ...
  nor2   g073(.a(new_n135_), .b(x27), .O(new_n136_));
  oai21  g074(.a(new_n136_), .b(new_n134_), .c(new_n70_), .O(new_n137_));
  oai22  g075(.a(new_n68_), .b(x04), .c(new_n66_), .d(new_n74_), .O(new_n138_));
  nand2  g076(.a(new_n138_), .b(new_n137_), .O(z12));
  nand2  g077(.a(x36), .b(x35), .O(new_n140_));
  nand2  g078(.a(x40), .b(new_n89_), .O(new_n141_));
  inv1   g079(.a(x13), .O(new_n142_));
  inv1   g080(.a(new_n65_), .O(new_n143_));
  nand2  g081(.a(new_n143_), .b(new_n142_), .O(new_n144_));
  aoi21  g082(.a(new_n141_), .b(new_n140_), .c(new_n144_), .O(new_n145_));
  ...
  nand3  g088(.a(new_n150_), .b(new_n82_), .c(z08), .O(new_n151_));
  nand2  g089(.a(new_n151_), .b(new_n149_), .O(z13));
  nand4  g090(.a(new_n140_), .b(new_n81_), .c(new_n80_), .d(x28), .O(new_n153_));
  inv1   g091(.a(new_n153_), .O(new_n154_));
  nand2  g092(.a(new_n150_), .b(z08), .O(new_n155_));
  oai21  g093(.a(new_n155_), .b(new_n154_), .c(new_n147_), .O(new_n156_));
  nand3  g094(.a(new_n143_), .b(x40), .c(new_n142_), .O(new_n157_));
  ...
  nand2  g099(.a(new_n155_), .b(new_n66_), .O(new_n162_));
  ...
  oai21  g108(.a(new_n78_), .b(x27), .c(new_n126_), .O(new_n171_));
  nand2  g109(.a(new_n171_), .b(x08), .O(new_n172_));
  nand3  g110(.a(new_n172_), .b(new_n131_), .c(new_n129_), .O(z18));
  oai21  g111(.a(new_n76_), .b(new_n74_), .c(new_n86_), .O(new_n174_));
  oai21  g112(.a(new_n89_), .b(x27), .c(x35), .O(new_n175_));
  nand2  g113(.a(new_n175_), .b(new_n126_), .O(new_n176_));
  aoi21  g114(.a(new_n176_), .b(new_n174_), .c(new_n132_), .O(z20));
  aoi21  g115(.a(new_n130_), .b(new_n128_), .c(new_n132_), .O(z19));
endmodule
