// Benchmark "FAU" written by ABC on Mon Jul  6 15:00:44 2020
...
module FAU ( 
  ...
  aoi22  g064(.a(new_n63_), .b(new_n87_), .c(x40), .d(new_n72_), .O(new_n127_));
  nand2  g065(.a(z08), .b(new_n64_), .O(new_n128_));
  nand2  g066(.a(new_n120_), .b(z08), .O(new_n129_));
  aoi22  g067(.a(new_n129_), .b(new_n72_), .c(new_n128_), .d(new_n66_), .O(new_n130_));
  ...
  nand4  g081(.a(new_n78_), .b(z08), .c(new_n143_), .d(new_n64_), .O(new_n144_));
  nand2  g082(.a(new_n144_), .b(new_n142_), .O(z13));
  inv1   g083(.a(x35), .O(new_n146_));
  nand3  g084(.a(new_n87_), .b(new_n146_), .c(x28), .O(new_n147_));
  nand2  g085(.a(new_n147_), .b(x27), .O(new_n148_));
  nand2  g086(.a(new_n148_), .b(new_n77_), .O(new_n149_));
  nand2  g087(.a(new_n139_), .b(x27), .O(new_n150_));
  nand2  g088(.a(x20), .b(new_n138_), .O(new_n151_));
  aoi22  g089(.a(new_n151_), .b(new_n134_), .c(new_n150_), .d(new_n106_), .O(new_n152_));
  inv1   g090(.a(x32), .O(new_n153_));
  nand4  g091(.a(new_n132_), .b(new_n153_), .c(new_n124_), .d(x28), .O(new_n154_));
  nand2  g092(.a(new_n154_), .b(x39), .O(new_n155_));
  oai21  g093(.a(new_n151_), .b(x18), .c(new_n155_), .O(new_n156_));
  nand2  g094(.a(new_n143_), .b(new_n64_), .O(new_n157_));
  oai21  g095(.a(new_n151_), .b(new_n72_), .c(x40), .O(new_n158_));
  nand3  g096(.a(new_n158_), .b(new_n139_), .c(new_n137_), .O(new_n159_));
  nand2  g097(.a(new_n159_), .b(new_n157_), .O(new_n160_));
  nand4  g098(.a(new_n160_), .b(new_n156_), .c(new_n152_), .d(new_n149_), .O(z14));
  ...
  nor2   g106(.a(new_n146_), .b(x28), .O(new_n169_));
  aoi22  g107(.a(new_n169_), .b(new_n72_), .c(z08), .d(x29), .O(new_n170_));
  nor2   g108(.a(new_n72_), .b(x04), .O(new_n171_));
  aoi21  g109(.a(new_n171_), .b(new_n169_), .c(new_n125_), .O(new_n172_));
  oai21  g110(.a(new_n170_), .b(new_n82_), .c(new_n172_), .O(z18));
  oai21  g111(.a(new_n146_), .b(new_n72_), .c(new_n82_), .O(new_n174_));
  oai21  g112(.a(new_n74_), .b(x27), .c(x35), .O(new_n175_));
  nand2  g113(.a(new_n175_), .b(new_n117_), .O(new_n176_));
  aoi21  g114(.a(new_n176_), .b(new_n174_), .c(new_n125_), .O(z20));
  aoi21  g115(.a(new_n122_), .b(new_n119_), .c(new_n125_), .O(z19));
endmodule
