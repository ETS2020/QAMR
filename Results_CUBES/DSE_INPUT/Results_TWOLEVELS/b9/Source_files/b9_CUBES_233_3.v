...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n104_, new_n106_, new_n108_, new_n110_, new_n111_, new_n113_,
  ...
  nand4  g047(.a(new_n74_), .b(new_n106_), .c(x07), .d(new_n64_), .O(new_n110_));
  nand2  g048(.a(x37), .b(x06), .O(new_n111_));
  aoi21  g049(.a(new_n111_), .b(new_n110_), .c(new_n86_), .O(z10));
  nand2  g050(.a(z08), .b(x29), .O(new_n113_));
  nor2   g051(.a(new_n72_), .b(x28), .O(new_n114_));
  oai21  g052(.a(new_n86_), .b(new_n64_), .c(new_n114_), .O(new_n115_));
  nand2  g053(.a(new_n115_), .b(new_n113_), .O(new_n116_));
  inv1   g054(.a(x08), .O(new_n117_));
  nand2  g055(.a(x40), .b(x04), .O(new_n118_));
  nand4  g056(.a(new_n118_), .b(x35), .c(new_n84_), .d(x27), .O(new_n119_));
  ...
  aoi21  g061(.a(new_n120_), .b(new_n116_), .c(new_n123_), .O(z11));
  ...
  nand2  g066(.a(new_n118_), .b(z08), .O(new_n129_));
  aoi22  g067(.a(new_n129_), .b(new_n86_), .c(new_n128_), .d(new_n66_), .O(new_n130_));
  oai21  g068(.a(new_n127_), .b(x10), .c(new_n130_), .O(z12));
  aoi21  g069(.a(x36), .b(x35), .c(new_n84_), .O(new_n132_));
  inv1   g070(.a(x13), .O(new_n133_));
  nand4  g071(.a(x40), .b(x39), .c(new_n133_), .d(new_n64_), .O(new_n134_));
  nor2   g072(.a(x19), .b(x18), .O(new_n135_));
  nand2  g073(.a(new_n135_), .b(x20), .O(new_n136_));
  oai22  g074(.a(new_n136_), .b(new_n66_), .c(new_n134_), .d(new_n132_), .O(new_n137_));
  nand2  g075(.a(new_n137_), .b(x27), .O(new_n138_));
  or2    g076(.a(new_n134_), .b(new_n76_), .O(new_n139_));
  nand2  g077(.a(new_n139_), .b(new_n138_), .O(z13));
  inv1   g078(.a(x32), .O(new_n141_));
  nand2  g079(.a(x36), .b(x35), .O(new_n142_));
  nand4  g080(.a(new_n142_), .b(new_n141_), .c(new_n122_), .d(x28), .O(new_n143_));
  nand2  g081(.a(new_n133_), .b(new_n64_), .O(new_n144_));
  nand2  g082(.a(new_n144_), .b(x40), .O(new_n145_));
  nand3  g083(.a(new_n145_), .b(new_n143_), .c(z08), .O(new_n146_));
  nand2  g084(.a(new_n146_), .b(new_n136_), .O(new_n147_));
  oai21  g085(.a(new_n66_), .b(new_n86_), .c(new_n106_), .O(new_n148_));
  nand3  g086(.a(new_n87_), .b(new_n72_), .c(x28), .O(new_n149_));
  nand2  g087(.a(new_n149_), .b(x27), .O(new_n150_));
  nand2  g088(.a(new_n150_), .b(new_n76_), .O(new_n151_));
  oai21  g089(.a(new_n126_), .b(new_n66_), .c(new_n144_), .O(new_n152_));
  nand4  g090(.a(new_n152_), .b(new_n151_), .c(new_n148_), .d(new_n147_), .O(z14));
  ...
  nand2  g098(.a(new_n114_), .b(new_n86_), .O(new_n161_));
  nand2  g099(.a(new_n161_), .b(new_n113_), .O(new_n162_));
  nand2  g100(.a(new_n162_), .b(x08), .O(new_n163_));
  nor2   g101(.a(new_n86_), .b(x04), .O(new_n164_));
  aoi21  g102(.a(new_n164_), .b(new_n114_), .c(new_n123_), .O(new_n165_));
  nand2  g103(.a(new_n165_), .b(new_n163_), .O(z18));
  oai21  g104(.a(new_n72_), .b(new_n86_), .c(new_n117_), .O(new_n167_));
  oai21  g105(.a(new_n84_), .b(x27), .c(x35), .O(new_n168_));
  nand2  g106(.a(new_n168_), .b(new_n113_), .O(new_n169_));
  aoi21  g107(.a(new_n169_), .b(new_n167_), .c(new_n123_), .O(z20));
  aoi21  g108(.a(new_n120_), .b(new_n116_), .c(new_n123_), .O(z19));
endmodule
