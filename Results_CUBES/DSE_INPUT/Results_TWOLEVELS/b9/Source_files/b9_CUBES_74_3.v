// Benchmark "FAU" written by ABC on Mon Jul  6 15:00:02 2020
...
module FAU ( 
  ...
  nand3  g021(.a(new_n72_), .b(new_n83_), .c(x04), .O(new_n84_));
  ...
  nor2   g062(.a(new_n124_), .b(x28), .O(new_n125_));
  nor2   g063(.a(new_n72_), .b(x04), .O(new_n126_));
  aoi21  g064(.a(new_n126_), .b(new_n125_), .c(x30), .O(new_n127_));
  nand2  g065(.a(new_n127_), .b(new_n83_), .O(new_n128_));
  aoi21  g066(.a(new_n128_), .b(new_n123_), .c(x09), .O(z11));
  aoi22  g067(.a(new_n63_), .b(new_n88_), .c(x40), .d(new_n72_), .O(new_n130_));
  oai22  g068(.a(new_n107_), .b(x04), .c(new_n66_), .d(new_n72_), .O(new_n131_));
  oai21  g069(.a(new_n130_), .b(x10), .c(new_n131_), .O(z12));
  nand2  g070(.a(x36), .b(x35), .O(new_n133_));
  nand2  g071(.a(new_n133_), .b(x28), .O(new_n134_));
  nor2   g072(.a(new_n120_), .b(x13), .O(new_n135_));
  nand4  g073(.a(new_n135_), .b(new_n134_), .c(x39), .d(new_n64_), .O(new_n136_));
  inv1   g074(.a(x18), .O(new_n137_));
  inv1   g075(.a(x19), .O(new_n138_));
  nand2  g076(.a(new_n86_), .b(new_n88_), .O(new_n139_));
  ...
  nand3  g081(.a(new_n143_), .b(z08), .c(x32), .O(new_n144_));
  nand2  g082(.a(new_n144_), .b(new_n142_), .O(z13));
  nand3  g083(.a(x20), .b(new_n138_), .c(new_n137_), .O(new_n146_));
  nand3  g084(.a(new_n133_), .b(new_n78_), .c(x28), .O(new_n147_));
  inv1   g085(.a(new_n147_), .O(new_n148_));
  nand2  g086(.a(new_n143_), .b(z08), .O(new_n149_));
  oai21  g087(.a(new_n149_), .b(new_n148_), .c(new_n146_), .O(new_n150_));
  nand2  g088(.a(new_n149_), .b(new_n66_), .O(new_n151_));
  nand3  g089(.a(new_n88_), .b(new_n124_), .c(x28), .O(new_n152_));
  oai21  g090(.a(x30), .b(x27), .c(new_n152_), .O(new_n153_));
  nand2  g091(.a(new_n153_), .b(new_n78_), .O(new_n154_));
  and2   g092(.a(x40), .b(x13), .O(new_n155_));
  oai21  g093(.a(new_n155_), .b(new_n65_), .c(new_n72_), .O(new_n156_));
  nand4  g094(.a(new_n156_), .b(new_n154_), .c(new_n151_), .d(new_n150_), .O(z14));
  ...
  oai22  g104(.a(new_n75_), .b(x27), .c(new_n107_), .d(new_n166_), .O(new_n167_));
  nand2  g105(.a(new_n167_), .b(x08), .O(new_n168_));
  nand3  g106(.a(new_n168_), .b(new_n127_), .c(new_n165_), .O(z18));
  nor2   g107(.a(new_n120_), .b(new_n166_), .O(new_n170_));
  oai21  g108(.a(new_n124_), .b(new_n72_), .c(new_n83_), .O(new_n171_));
  aoi21  g109(.a(x28), .b(new_n72_), .c(new_n124_), .O(new_n172_));
  oai21  g110(.a(new_n172_), .b(new_n170_), .c(new_n171_), .O(new_n173_));
  nand2  g111(.a(new_n173_), .b(new_n77_), .O(new_n174_));
  inv1   g112(.a(new_n172_), .O(new_n175_));
  nand2  g113(.a(new_n175_), .b(new_n121_), .O(new_n176_));
  aoi21  g114(.a(new_n176_), .b(new_n174_), .c(x09), .O(z20));
  aoi21  g115(.a(new_n128_), .b(new_n123_), .c(x09), .O(z19));
endmodule
