...
module FAU ( 
  ...
  oai21  g022(.a(new_n84_), .b(x29), .c(x08), .O(new_n85_));
  ...
  nor2   g065(.a(new_n84_), .b(x27), .O(new_n128_));
  aoi21  g066(.a(new_n63_), .b(new_n90_), .c(new_n128_), .O(new_n129_));
  nand2  g067(.a(z08), .b(new_n64_), .O(new_n130_));
  nand3  g068(.a(x40), .b(x39), .c(new_n64_), .O(new_n131_));
  ...
  nor2   g073(.a(new_n84_), .b(x13), .O(new_n136_));
  ...
  nand4  g089(.a(new_n151_), .b(new_n146_), .c(x40), .d(x39), .O(new_n152_));
  nand2  g090(.a(new_n152_), .b(new_n141_), .O(new_n153_));
  oai21  g091(.a(new_n66_), .b(new_n72_), .c(new_n83_), .O(new_n154_));
  nand3  g092(.a(new_n90_), .b(new_n88_), .c(x28), .O(new_n155_));
  ...
  oai21  g104(.a(new_n75_), .b(x27), .c(new_n119_), .O(new_n167_));
  nand2  g105(.a(new_n167_), .b(x08), .O(new_n168_));
  nand3  g106(.a(new_n168_), .b(new_n125_), .c(new_n123_), .O(z18));
  oai21  g107(.a(new_n88_), .b(new_n72_), .c(new_n80_), .O(new_n170_));
  oai21  g108(.a(new_n74_), .b(x27), .c(x35), .O(new_n171_));
  nand2  g109(.a(new_n171_), .b(new_n119_), .O(new_n172_));
  aoi21  g110(.a(new_n172_), .b(new_n170_), .c(new_n126_), .O(z20));
  aoi21  g111(.a(new_n124_), .b(new_n121_), .c(new_n126_), .O(z19));
endmodule
