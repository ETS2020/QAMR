...
module FAU ( 
  ...
  nand3  g071(.a(x40), .b(x39), .c(new_n64_), .O(new_n134_));
  ...
  inv1   g078(.a(new_n66_), .O(new_n141_));
  ...
  nand4  g090(.a(new_n137_), .b(new_n152_), .c(new_n113_), .d(x28), .O(new_n153_));
  nand4  g091(.a(new_n153_), .b(new_n149_), .c(x40), .d(x39), .O(new_n154_));
  nand2  g092(.a(new_n154_), .b(new_n144_), .O(new_n155_));
  oai21  g093(.a(new_n66_), .b(new_n74_), .c(new_n68_), .O(new_n156_));
  nand3  g094(.a(new_n89_), .b(new_n87_), .c(x28), .O(new_n157_));
  ...
  nand4  g098(.a(new_n160_), .b(new_n159_), .c(new_n156_), .d(new_n155_), .O(z14));
  ...
  inv1   g106(.a(x09), .O(new_n169_));
  oai22  g107(.a(new_n77_), .b(x27), .c(new_n68_), .d(new_n120_), .O(new_n170_));
  nand2  g108(.a(new_n170_), .b(x08), .O(new_n171_));
  nand3  g109(.a(new_n171_), .b(new_n127_), .c(new_n169_), .O(z18));
  oai21  g110(.a(new_n87_), .b(new_n74_), .c(new_n84_), .O(new_n173_));
  aoi21  g111(.a(x28), .b(new_n74_), .c(new_n87_), .O(new_n174_));
  oai21  g112(.a(new_n174_), .b(new_n121_), .c(new_n173_), .O(new_n175_));
  nand2  g113(.a(new_n175_), .b(new_n113_), .O(new_n176_));
  or2    g114(.a(new_n174_), .b(x40), .O(new_n177_));
  aoi21  g115(.a(new_n177_), .b(new_n176_), .c(x09), .O(z20));
  aoi21  g116(.a(new_n128_), .b(new_n125_), .c(x09), .O(z19));
endmodule
