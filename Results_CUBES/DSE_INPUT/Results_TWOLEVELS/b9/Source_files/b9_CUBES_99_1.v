...
module FAU ( 
  ...
  oai21  g026(.a(new_n75_), .b(new_n88_), .c(x27), .O(new_n89_));
  ...
  nand3  g050(.a(new_n77_), .b(x27), .c(x07), .O(new_n113_));
  nand2  g051(.a(new_n81_), .b(z08), .O(new_n114_));
  aoi21  g052(.a(new_n114_), .b(new_n113_), .c(new_n112_), .O(new_n115_));
  nand2  g053(.a(x40), .b(new_n68_), .O(new_n116_));
  ...
  oai21  g058(.a(new_n120_), .b(new_n115_), .c(new_n64_), .O(new_n121_));
  nand3  g059(.a(x37), .b(x27), .c(x06), .O(new_n122_));
  nand2  g060(.a(new_n122_), .b(new_n121_), .O(z10));
  nand2  g061(.a(z08), .b(x29), .O(new_n124_));
  nor2   g062(.a(new_n75_), .b(x28), .O(new_n125_));
  oai21  g063(.a(new_n90_), .b(new_n64_), .c(new_n125_), .O(new_n126_));
  nand2  g064(.a(new_n126_), .b(new_n124_), .O(new_n127_));
  inv1   g065(.a(x08), .O(new_n128_));
  nand2  g066(.a(x40), .b(x04), .O(new_n129_));
  nand4  g067(.a(new_n129_), .b(x35), .c(new_n88_), .d(x27), .O(new_n130_));
  nand2  g068(.a(new_n130_), .b(new_n128_), .O(new_n131_));
  inv1   g069(.a(x09), .O(new_n132_));
  nand2  g070(.a(new_n79_), .b(new_n132_), .O(new_n133_));
  aoi21  g071(.a(new_n131_), .b(new_n127_), .c(new_n133_), .O(z11));
  nor3   g072(.a(x37), .b(x36), .c(x35), .O(new_n135_));
  nor2   g073(.a(new_n69_), .b(x27), .O(new_n136_));
  oai21  g074(.a(new_n136_), .b(new_n135_), .c(new_n71_), .O(new_n137_));
  nand2  g075(.a(z08), .b(new_n64_), .O(new_n138_));
  nand2  g076(.a(new_n129_), .b(z08), .O(new_n139_));
  aoi22  g077(.a(new_n139_), .b(new_n90_), .c(new_n138_), .d(new_n66_), .O(new_n140_));
  nand2  g078(.a(new_n140_), .b(new_n137_), .O(z12));
  nand2  g079(.a(x36), .b(x35), .O(new_n142_));
  nand2  g080(.a(new_n142_), .b(x28), .O(new_n143_));
  nor2   g081(.a(new_n69_), .b(x13), .O(new_n144_));
  nand4  g082(.a(new_n144_), .b(new_n143_), .c(x39), .d(new_n64_), .O(new_n145_));
  nor2   g083(.a(x19), .b(x18), .O(new_n146_));
  nand2  g084(.a(new_n146_), .b(x20), .O(new_n147_));
  oai21  g085(.a(new_n147_), .b(new_n66_), .c(new_n145_), .O(new_n148_));
  nand2  g086(.a(new_n148_), .b(x27), .O(new_n149_));
  nor2   g087(.a(x13), .b(x04), .O(new_n150_));
  nand3  g088(.a(new_n150_), .b(new_n81_), .c(z08), .O(new_n151_));
  nand2  g089(.a(new_n151_), .b(new_n149_), .O(z13));
  nand4  g090(.a(new_n142_), .b(new_n80_), .c(new_n79_), .d(x28), .O(new_n153_));
  nand4  g091(.a(new_n153_), .b(new_n150_), .c(x40), .d(x39), .O(new_n154_));
  nand2  g092(.a(new_n154_), .b(new_n147_), .O(new_n155_));
  oai22  g093(.a(new_n66_), .b(new_n90_), .c(new_n69_), .d(new_n68_), .O(new_n156_));
  nand3  g094(.a(new_n91_), .b(new_n75_), .c(x28), .O(new_n157_));
  nand2  g095(.a(new_n157_), .b(x27), .O(new_n158_));
  nand3  g096(.a(new_n158_), .b(new_n80_), .c(new_n79_), .O(new_n159_));
  oai22  g097(.a(new_n136_), .b(new_n66_), .c(x13), .d(x04), .O(new_n160_));
  ...
  nand2  g106(.a(new_n125_), .b(new_n90_), .O(new_n169_));
  nand2  g107(.a(new_n169_), .b(new_n124_), .O(new_n170_));
  nand2  g108(.a(new_n170_), .b(x08), .O(new_n171_));
  nor2   g109(.a(new_n90_), .b(x04), .O(new_n172_));
  aoi21  g110(.a(new_n172_), .b(new_n125_), .c(new_n133_), .O(new_n173_));
  nand2  g111(.a(new_n173_), .b(new_n171_), .O(z18));
  oai21  g112(.a(new_n75_), .b(new_n90_), .c(new_n128_), .O(new_n175_));
  oai21  g113(.a(new_n88_), .b(x27), .c(x35), .O(new_n176_));
  nand2  g114(.a(new_n176_), .b(new_n124_), .O(new_n177_));
  aoi21  g115(.a(new_n177_), .b(new_n175_), .c(new_n133_), .O(z20));
  aoi21  g116(.a(new_n131_), .b(new_n127_), .c(new_n133_), .O(z19));
endmodule
