...
module FAU ( 
  ...
  nand4  g30(.a(new_n49_), .b(new_n40_), .c(new_n32_), .d(new_n23_), .O(new_n50_));
  aoi21  g31(.a(new_n50_), .b(new_n20_), .c(new_n21_), .O(new_n51_));
  aoi21  g32(.a(new_n43_), .b(new_n24_), .c(new_n49_), .O(new_n52_));
  oai21  g33(.a(new_n52_), .b(new_n51_), .c(x03), .O(new_n53_));
  oai21  g34(.a(x07), .b(x03), .c(x05), .O(new_n54_));
  aoi21  g35(.a(x12), .b(x11), .c(new_n54_), .O(new_n55_));
