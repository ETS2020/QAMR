...
module FAU ( 
  ...
  aoi21  g10(.a(new_n29_), .b(new_n20_), .c(new_n21_), .O(new_n30_));
  inv1   g11(.a(x10), .O(new_n31_));
  aoi21  g12(.a(new_n24_), .b(new_n23_), .c(new_n31_), .O(new_n32_));
  ...
  aoi21  g25(.a(new_n44_), .b(new_n35_), .c(new_n36_), .O(new_n45_));
  nand2  g26(.a(new_n45_), .b(new_n43_), .O(z2));
  inv1   g27(.a(x12), .O(new_n47_));
  nand4  g28(.a(new_n47_), .b(new_n39_), .c(new_n31_), .d(new_n23_), .O(new_n48_));
  ...
  aoi21  g34(.a(new_n53_), .b(new_n35_), .c(new_n36_), .O(new_n54_));
