// Benchmark "FAU" written by ABC on Mon Jul  6 13:01:16 2020
...
module FAU ( 
  ...
  nand3  g24(.a(new_n24_), .b(new_n32_), .c(new_n23_), .O(new_n44_));
  inv1   g25(.a(x11), .O(new_n45_));
  nor2   g26(.a(new_n45_), .b(new_n28_), .O(new_n46_));
  oai21  g27(.a(x06), .b(x03), .c(x05), .O(new_n47_));
  aoi21  g28(.a(new_n46_), .b(new_n44_), .c(new_n47_), .O(new_n48_));
  nand2  g29(.a(new_n48_), .b(new_n43_), .O(z2));
  inv1   g30(.a(x12), .O(new_n50_));
  nand4  g31(.a(new_n50_), .b(new_n45_), .c(new_n32_), .d(new_n23_), .O(new_n51_));
  aoi21  g32(.a(new_n51_), .b(new_n20_), .c(new_n21_), .O(new_n52_));
  aoi21  g33(.a(new_n40_), .b(new_n24_), .c(new_n50_), .O(new_n53_));
