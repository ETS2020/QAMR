...
module FAU ( 
  ...
  nand3  g437(.a(new_n567_), .b(new_n182_), .c(new_n181_), .O(new_n568_));
  nor3   g438(.a(new_n568_), .b(new_n329_), .c(new_n193_), .O(new_n569_));
  ...
  nor2   g469(.a(new_n398_), .b(new_n329_), .O(new_n600_));
  nand4  g470(.a(new_n600_), .b(new_n567_), .c(new_n146_), .d(new_n133_), .O(new_n601_));
  ...
  nand3  g480(.a(new_n378_), .b(new_n297_), .c(new_n520_), .O(new_n611_));
  ...
  nor3   g498(.a(new_n602_), .b(x14), .c(new_n202_), .O(new_n629_));
  ...
  nor2   g509(.a(x37), .b(new_n520_), .O(new_n640_));
  nand4  g510(.a(new_n640_), .b(new_n547_), .c(new_n424_), .d(new_n327_), .O(new_n641_));
  ...
  nor4   g523(.a(new_n484_), .b(new_n350_), .c(x43), .d(new_n314_), .O(z59));
