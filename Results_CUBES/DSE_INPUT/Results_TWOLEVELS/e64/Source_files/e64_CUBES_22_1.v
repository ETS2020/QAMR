...
module FAU ( 
  ...
  nand3  g219(.a(new_n349_), .b(new_n293_), .c(new_n152_), .O(new_n350_));
  ...
  nand2  g355(.a(new_n349_), .b(new_n152_), .O(new_n486_));
  inv1   g356(.a(new_n486_), .O(new_n487_));
  nand4  g357(.a(new_n379_), .b(new_n487_), .c(new_n293_), .d(new_n290_), .O(new_n488_));
  ...
  nand3  g525(.a(new_n181_), .b(new_n348_), .c(x40), .O(new_n656_));
  nor3   g526(.a(new_n656_), .b(new_n486_), .c(new_n291_), .O(z59));
  ...
  inv1   g538(.a(new_n481_), .O(new_n669_));
  nor2   g539(.a(new_n381_), .b(new_n376_), .O(new_n670_));
  nand2  g540(.a(new_n348_), .b(x47), .O(new_n671_));
  nor2   g541(.a(new_n671_), .b(new_n659_), .O(new_n672_));
  nand4  g542(.a(new_n672_), .b(new_n670_), .c(new_n669_), .d(new_n378_), .O(new_n673_));
  inv1   g543(.a(new_n673_), .O(z62));
  nand4  g544(.a(new_n190_), .b(new_n181_), .c(x56), .d(new_n348_), .O(new_n675_));
  inv1   g545(.a(new_n675_), .O(new_n676_));
  nand4  g546(.a(new_n676_), .b(new_n670_), .c(new_n669_), .d(new_n378_), .O(new_n677_));
  inv1   g547(.a(new_n677_), .O(z63));
  nand4  g548(.a(new_n483_), .b(new_n669_), .c(new_n289_), .d(x30), .O(new_n679_));
