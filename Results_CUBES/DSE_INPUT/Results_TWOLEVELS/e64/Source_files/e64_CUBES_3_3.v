...
module FAU ( 
  ...
  wire new_n131_, new_n132_, new_n133_, new_n134_, new_n135_, new_n136_,
    ...
    new_n649_, new_n651_, new_n652_, new_n653_, new_n655_, new_n657_,
  ...
  nand3  g353(.a(new_n190_), .b(new_n181_), .c(new_n348_), .O(new_n484_));
  nor3   g354(.a(new_n484_), .b(new_n483_), .c(new_n460_), .O(z28));
  ...
  nand4  g524(.a(new_n181_), .b(new_n348_), .c(new_n290_), .d(x40), .O(new_n655_));
  nor2   g525(.a(new_n655_), .b(new_n350_), .O(z59));
  ...
  nand3  g542(.a(new_n190_), .b(x56), .c(new_n348_), .O(new_n673_));
  ...
  nand3  g546(.a(new_n482_), .b(new_n289_), .c(x30), .O(new_n677_));
  nor4   g547(.a(new_n677_), .b(new_n484_), .c(new_n381_), .d(new_n376_), .O(z64));
