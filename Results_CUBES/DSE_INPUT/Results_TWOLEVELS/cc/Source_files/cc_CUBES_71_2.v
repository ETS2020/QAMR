...
module FAU ( 
  ...
  nor4   g13(.a(new_n46_), .b(new_n50_), .c(x14), .d(new_n54_), .O(z03));
  inv1   g14(.a(x18), .O(z04));
  nand2  g15(.a(x09), .b(x08), .O(z10));
  inv1   g16(.a(z10), .O(z09));
  nand2  g17(.a(new_n51_), .b(x13), .O(new_n59_));
  ...
  nand2  g22(.a(new_n43_), .b(x14), .O(new_n64_));
  nand3  g23(.a(new_n64_), .b(new_n47_), .c(x15), .O(new_n65_));
  inv1   g24(.a(x01), .O(new_n66_));
  oai21  g25(.a(new_n46_), .b(new_n66_), .c(x14), .O(new_n67_));
  aoi21  g26(.a(new_n67_), .b(new_n65_), .c(new_n54_), .O(z13));
  nand2  g27(.a(new_n46_), .b(x15), .O(new_n69_));
  nand3  g28(.a(new_n61_), .b(x08), .c(x02), .O(new_n70_));
  aoi21  g29(.a(new_n70_), .b(new_n69_), .c(new_n54_), .O(z14));
  nand3  g30(.a(new_n51_), .b(x16), .c(new_n45_), .O(new_n72_));
  nand3  g31(.a(new_n61_), .b(x08), .c(x03), .O(new_n73_));
  aoi21  g32(.a(new_n73_), .b(new_n72_), .c(new_n54_), .O(z15));
  nand2  g33(.a(new_n51_), .b(x17), .O(new_n75_));
  nand3  g34(.a(new_n61_), .b(x08), .c(x04), .O(new_n76_));
  aoi21  g35(.a(new_n76_), .b(new_n75_), .c(new_n54_), .O(z16));
  nand2  g36(.a(new_n51_), .b(x18), .O(new_n78_));
  nand3  g37(.a(new_n61_), .b(x08), .c(x05), .O(new_n79_));
  aoi21  g38(.a(new_n79_), .b(new_n78_), .c(new_n54_), .O(z17));
  nand2  g39(.a(new_n51_), .b(x19), .O(new_n81_));
  nand3  g40(.a(new_n61_), .b(x08), .c(x06), .O(new_n82_));
  aoi21  g41(.a(new_n82_), .b(new_n81_), .c(new_n54_), .O(z18));
  inv1   g42(.a(x07), .O(new_n84_));
  nand2  g43(.a(x20), .b(x15), .O(new_n85_));
  oai21  g44(.a(x15), .b(new_n84_), .c(new_n85_), .O(new_n86_));
  nand2  g45(.a(new_n86_), .b(new_n47_), .O(new_n87_));
  nand2  g46(.a(new_n46_), .b(x20), .O(new_n88_));
