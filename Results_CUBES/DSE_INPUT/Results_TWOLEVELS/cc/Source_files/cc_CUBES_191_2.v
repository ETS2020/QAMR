// Benchmark "FAU" written by ABC on Mon Jul  6 13:09:15 2020
...
module FAU ( 
  ...
  oai21  g23(.a(new_n43_), .b(new_n64_), .c(x14), .O(new_n65_));
  nand2  g24(.a(new_n44_), .b(x15), .O(new_n66_));
  aoi21  g25(.a(new_n66_), .b(new_n65_), .c(new_n54_), .O(z13));
  ...
  nand2  g32(.a(new_n43_), .b(new_n49_), .O(new_n74_));
