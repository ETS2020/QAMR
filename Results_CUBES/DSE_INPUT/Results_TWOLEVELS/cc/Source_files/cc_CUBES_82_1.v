...
module FAU ( 
  ...
  oai21  g17(.a(new_n48_), .b(x14), .c(new_n58_), .O(new_n59_));
  nand2  g18(.a(new_n59_), .b(new_n45_), .O(new_n60_));
  aoi22  g19(.a(new_n44_), .b(x13), .c(x15), .d(x14), .O(new_n61_));
  aoi21  g20(.a(new_n61_), .b(new_n60_), .c(new_n53_), .O(z12));
  ...
  aoi21  g29(.a(new_n70_), .b(new_n67_), .c(new_n53_), .O(z14));
