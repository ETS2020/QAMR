// Benchmark "FAU" written by ABC on Mon Jul  6 13:00:25 2020
...
module FAU ( 
  ...
  nand2  g21(.a(new_n38_), .b(new_n24_), .O(new_n43_));
  nand3  g22(.a(new_n43_), .b(x13), .c(x04), .O(new_n44_));
  inv1   g23(.a(x07), .O(new_n45_));
  aoi21  g24(.a(new_n45_), .b(new_n22_), .c(new_n27_), .O(new_n46_));
