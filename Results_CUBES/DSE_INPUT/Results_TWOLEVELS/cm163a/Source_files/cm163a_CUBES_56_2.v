...
module FAU ( 
  ...
  nand4  g24(.a(new_n45_), .b(new_n38_), .c(x03), .d(x02), .O(new_n46_));
  nor3   g25(.a(x13), .b(x12), .c(x11), .O(new_n47_));
  aoi22  g26(.a(new_n47_), .b(new_n29_), .c(new_n46_), .d(x13), .O(new_n48_));
  nor2   g27(.a(new_n30_), .b(new_n22_), .O(new_n49_));
  oai21  g28(.a(x07), .b(x04), .c(x05), .O(new_n50_));
  aoi21  g29(.a(new_n49_), .b(x13), .c(new_n50_), .O(new_n51_));
  oai21  g30(.a(new_n48_), .b(x09), .c(new_n51_), .O(z3));
