// Benchmark "FAU" written by ABC on Mon Jul  6 20:04:17 2020
...
module FAU ( 
  ...
  nand2  g168(.a(new_n292_), .b(x07), .O(new_n320_));
  nand3  g169(.a(new_n154_), .b(x52), .c(x15), .O(new_n321_));
  nand2  g170(.a(new_n321_), .b(new_n320_), .O(new_n322_));
  nand3  g171(.a(new_n322_), .b(new_n236_), .c(new_n159_), .O(new_n323_));
  ...
  nand2  g176(.a(new_n327_), .b(new_n233_), .O(new_n328_));
  ...
  nand2  g203(.a(new_n354_), .b(new_n334_), .O(new_n355_));
  ...
  nand3  g224(.a(new_n279_), .b(x84), .c(new_n375_), .O(new_n376_));
  inv1   g225(.a(x80), .O(new_n377_));
  nand4  g226(.a(new_n251_), .b(new_n165_), .c(new_n377_), .d(x79), .O(new_n378_));
  nor2   g227(.a(new_n378_), .b(new_n376_), .O(z55));
  nand2  g228(.a(new_n249_), .b(x76), .O(new_n380_));
  ...
  aoi21  g235(.a(new_n386_), .b(new_n164_), .c(new_n246_), .O(new_n387_));
  nand2  g236(.a(new_n387_), .b(new_n385_), .O(z56));
  inv1   g237(.a(x02), .O(new_n389_));
  nand3  g238(.a(new_n247_), .b(x03), .c(new_n389_), .O(new_n390_));
  inv1   g239(.a(new_n390_), .O(z57));
  nand4  g240(.a(x80), .b(new_n239_), .c(x43), .d(new_n254_), .O(new_n392_));
  oai22  g241(.a(new_n392_), .b(new_n238_), .c(new_n254_), .d(x40), .O(new_n393_));
  nand3  g242(.a(new_n393_), .b(new_n236_), .c(x79), .O(new_n394_));
  nand3  g243(.a(new_n178_), .b(new_n254_), .c(x40), .O(new_n395_));
  nand2  g244(.a(new_n395_), .b(new_n394_), .O(new_n396_));
  nand2  g245(.a(new_n396_), .b(x77), .O(new_n397_));
  oai21  g246(.a(new_n372_), .b(new_n160_), .c(new_n154_), .O(new_n398_));
  aoi21  g247(.a(new_n398_), .b(new_n397_), .c(x01), .O(z58));
  aoi21  g248(.a(new_n163_), .b(new_n179_), .c(new_n152_), .O(new_n400_));
  oai21  g249(.a(new_n240_), .b(new_n238_), .c(new_n254_), .O(new_n401_));
  aoi21  g250(.a(new_n401_), .b(x79), .c(new_n163_), .O(new_n402_));
  ...
  aoi21  g255(.a(new_n382_), .b(x79), .c(new_n404_), .O(new_n407_));
  aoi21  g256(.a(new_n407_), .b(new_n243_), .c(x01), .O(z60));
  inv1   g257(.a(new_n173_), .O(new_n409_));
  nand2  g258(.a(new_n171_), .b(new_n170_), .O(new_n410_));
  aoi22  g259(.a(new_n410_), .b(new_n233_), .c(new_n165_), .d(new_n160_), .O(new_n411_));
  nor3   g260(.a(new_n411_), .b(new_n409_), .c(new_n377_), .O(z61));
