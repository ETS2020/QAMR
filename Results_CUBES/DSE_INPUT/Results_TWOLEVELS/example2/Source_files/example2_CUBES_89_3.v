...
module FAU ( 
  ...
  nand2  g222(.a(new_n160_), .b(new_n159_), .O(new_n374_));
  nand2  g223(.a(new_n168_), .b(new_n167_), .O(new_n375_));
  xor2a  g224(.a(x84), .b(x81), .O(new_n376_));
  nand3  g225(.a(new_n376_), .b(new_n375_), .c(x79), .O(new_n377_));
  nand4  g226(.a(new_n377_), .b(new_n374_), .c(new_n153_), .d(x00), .O(z56));
  ...
  oai21  g237(.a(new_n366_), .b(new_n239_), .c(new_n154_), .O(new_n389_));
  ...
  and2   g246(.a(new_n396_), .b(new_n377_), .O(new_n398_));
  aoi21  g247(.a(new_n398_), .b(new_n237_), .c(x01), .O(z60));
  inv1   g248(.a(new_n170_), .O(new_n400_));
  aoi22  g249(.a(new_n375_), .b(new_n226_), .c(new_n161_), .d(new_n239_), .O(new_n401_));
  nor3   g250(.a(new_n401_), .b(new_n400_), .c(new_n371_), .O(z61));
  nand3  g251(.a(x84), .b(x81), .c(x79), .O(new_n403_));
  oai21  g252(.a(x79), .b(new_n239_), .c(new_n403_), .O(new_n404_));
  nand2  g253(.a(new_n404_), .b(new_n159_), .O(new_n405_));
  nand2  g254(.a(new_n393_), .b(x79), .O(new_n406_));
  nand3  g255(.a(x81), .b(x79), .c(new_n239_), .O(new_n407_));
  inv1   g256(.a(new_n407_), .O(new_n408_));
  aoi21  g257(.a(new_n406_), .b(x04), .c(new_n408_), .O(new_n409_));
  oai21  g258(.a(new_n409_), .b(new_n159_), .c(new_n405_), .O(new_n410_));
  nand2  g259(.a(new_n410_), .b(x78), .O(new_n411_));
  inv1   g260(.a(new_n403_), .O(new_n412_));
  nand2  g261(.a(new_n412_), .b(new_n321_), .O(new_n413_));
  aoi21  g262(.a(new_n413_), .b(new_n411_), .c(x01), .O(z62));
  nor3   g263(.a(new_n401_), .b(new_n400_), .c(new_n369_), .O(z63));
  nand2  g264(.a(x83), .b(x79), .O(new_n416_));
  or2    g265(.a(new_n416_), .b(new_n401_), .O(new_n417_));
  aoi21  g266(.a(new_n417_), .b(new_n317_), .c(x01), .O(z64));
  nor2   g267(.a(new_n160_), .b(x04), .O(new_n419_));
  nor2   g268(.a(new_n253_), .b(x78), .O(new_n420_));
  oai21  g269(.a(new_n420_), .b(new_n419_), .c(x77), .O(new_n421_));
  nand2  g270(.a(new_n366_), .b(x81), .O(new_n422_));
