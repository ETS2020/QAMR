// Benchmark "FAU" written by ABC on Mon Jul  6 20:03:10 2020
...
module FAU ( 
  ...
  nand4  g179(.a(new_n226_), .b(new_n160_), .c(x77), .d(x68), .O(new_n331_));
  aoi21  g180(.a(new_n331_), .b(new_n330_), .c(x01), .O(z48));
  ...
  inv1   g185(.a(new_n226_), .O(new_n337_));
  nor2   g186(.a(new_n323_), .b(new_n337_), .O(new_n338_));
