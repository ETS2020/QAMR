...
module FAU ( 
  ...
  nand4  g158(.a(new_n251_), .b(x78), .c(x77), .d(x57), .O(new_n310_));
  aoi21  g159(.a(new_n298_), .b(new_n294_), .c(new_n310_), .O(z39));
  nor3   g160(.a(new_n300_), .b(new_n290_), .c(new_n203_), .O(z40));
  nor3   g161(.a(new_n300_), .b(new_n290_), .c(new_n200_), .O(z41));
