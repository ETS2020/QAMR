// Benchmark "FAU" written by ABC on Mon Jul  6 20:03:27 2020
...
module FAU ( 
  ...
  nand2  g189(.a(new_n332_), .b(x70), .O(new_n341_));
  nor2   g190(.a(x77), .b(new_n287_), .O(new_n342_));
  nand4  g191(.a(new_n342_), .b(new_n172_), .c(x18), .d(x04), .O(new_n343_));
  aoi21  g192(.a(new_n343_), .b(new_n341_), .c(x01), .O(z50));
