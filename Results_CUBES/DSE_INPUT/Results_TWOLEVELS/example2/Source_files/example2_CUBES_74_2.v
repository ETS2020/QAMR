...
module FAU ( 
  ...
  oai21  g064(.a(new_n214_), .b(new_n152_), .c(new_n215_), .O(z18));
  ...
  inv1   g114(.a(new_n248_), .O(new_n266_));
  nor4   g115(.a(new_n266_), .b(new_n235_), .c(new_n160_), .d(new_n214_), .O(new_n267_));
  and2   g116(.a(new_n267_), .b(new_n256_), .O(z29));
  ...
  nor3   g146(.a(new_n297_), .b(new_n266_), .c(new_n288_), .O(z34));
  ...
  nor3   g155(.a(new_n297_), .b(new_n266_), .c(new_n199_), .O(z39));
  nor3   g156(.a(new_n297_), .b(new_n266_), .c(new_n196_), .O(z40));
  nor3   g157(.a(new_n297_), .b(new_n266_), .c(new_n193_), .O(z41));
  nor3   g158(.a(new_n297_), .b(new_n266_), .c(new_n190_), .O(z42));
  nor3   g159(.a(new_n297_), .b(new_n266_), .c(new_n187_), .O(z43));
  nor3   g160(.a(new_n297_), .b(new_n266_), .c(new_n184_), .O(z44));
  nor3   g161(.a(new_n297_), .b(new_n266_), .c(new_n181_), .O(z45));
  nor3   g162(.a(new_n297_), .b(new_n266_), .c(new_n178_), .O(z46));
