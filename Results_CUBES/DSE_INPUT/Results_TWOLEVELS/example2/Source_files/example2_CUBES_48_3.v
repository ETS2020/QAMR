// Benchmark "FAU" written by ABC on Mon Jul  6 20:02:53 2020
...
module FAU ( 
  ...
  nand2  g200(.a(new_n292_), .b(x11), .O(new_n352_));
  nand3  g201(.a(new_n154_), .b(x52), .c(x19), .O(new_n353_));
  nand2  g202(.a(new_n353_), .b(new_n352_), .O(new_n354_));
  nand3  g203(.a(new_n354_), .b(new_n236_), .c(new_n159_), .O(new_n355_));
