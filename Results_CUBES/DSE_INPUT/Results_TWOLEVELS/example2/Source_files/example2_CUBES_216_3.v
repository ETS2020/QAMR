// Benchmark "FAU" written by ABC on Mon Jul  6 20:05:22 2020
...
module FAU ( 
  ...
  nor2   g107(.a(new_n258_), .b(x81), .O(new_n259_));
  ...
  inv1   g127(.a(x82), .O(new_n279_));
  nor2   g128(.a(new_n279_), .b(new_n255_), .O(new_n280_));
  xor2a  g129(.a(x84), .b(x83), .O(new_n281_));
  nor2   g130(.a(x82), .b(x81), .O(new_n282_));
  oai21  g131(.a(new_n282_), .b(new_n280_), .c(new_n281_), .O(new_n283_));
  xnor2a g132(.a(x84), .b(x83), .O(new_n284_));
  xor2a  g133(.a(x82), .b(x81), .O(new_n285_));
  nand2  g134(.a(new_n285_), .b(new_n284_), .O(new_n286_));
  inv1   g135(.a(new_n261_), .O(new_n287_));
  nand4  g136(.a(new_n287_), .b(new_n251_), .c(x42), .d(x05), .O(new_n288_));
  aoi21  g137(.a(new_n286_), .b(new_n283_), .c(new_n288_), .O(z33));
  inv1   g138(.a(x52), .O(new_n290_));
  inv1   g139(.a(new_n251_), .O(new_n291_));
  nor2   g140(.a(new_n237_), .b(new_n254_), .O(new_n292_));
  inv1   g141(.a(new_n292_), .O(new_n293_));
  nand2  g142(.a(new_n293_), .b(new_n255_), .O(new_n294_));
  nand2  g143(.a(new_n292_), .b(x81), .O(new_n295_));
  aoi21  g144(.a(new_n295_), .b(new_n294_), .c(new_n258_), .O(new_n296_));
  nand2  g145(.a(new_n293_), .b(x81), .O(new_n297_));
  nand2  g146(.a(new_n292_), .b(new_n255_), .O(new_n298_));
  aoi21  g147(.a(new_n298_), .b(new_n297_), .c(new_n256_), .O(new_n299_));
  oai21  g148(.a(new_n299_), .b(new_n296_), .c(new_n287_), .O(new_n300_));
  nor3   g149(.a(new_n300_), .b(new_n291_), .c(new_n290_), .O(z34));
  nand2  g150(.a(new_n251_), .b(x53), .O(new_n302_));
  nor2   g151(.a(new_n302_), .b(new_n300_), .O(z35));
  nand2  g152(.a(new_n251_), .b(x54), .O(new_n304_));
  nor2   g153(.a(new_n304_), .b(new_n300_), .O(z36));
  nand2  g154(.a(new_n251_), .b(x55), .O(new_n306_));
  nor2   g155(.a(new_n306_), .b(new_n300_), .O(z37));
  nand2  g156(.a(new_n251_), .b(x56), .O(new_n308_));
  nor2   g157(.a(new_n308_), .b(new_n300_), .O(z38));
  nor3   g158(.a(new_n300_), .b(new_n291_), .c(new_n206_), .O(z39));
  nor3   g159(.a(new_n300_), .b(new_n291_), .c(new_n203_), .O(z40));
  nor3   g160(.a(new_n300_), .b(new_n291_), .c(new_n200_), .O(z41));
  nor3   g161(.a(new_n300_), .b(new_n291_), .c(new_n197_), .O(z42));
  nor3   g162(.a(new_n300_), .b(new_n291_), .c(new_n194_), .O(z43));
  nor3   g163(.a(new_n300_), .b(new_n291_), .c(new_n191_), .O(z44));
  nor3   g164(.a(new_n300_), .b(new_n291_), .c(new_n188_), .O(z45));
  nor3   g165(.a(new_n300_), .b(new_n291_), .c(new_n185_), .O(z46));
  inv1   g166(.a(x07), .O(new_n318_));
  nand2  g167(.a(x52), .b(x15), .O(new_n319_));
  oai21  g168(.a(x52), .b(new_n318_), .c(new_n319_), .O(new_n320_));
  nand3  g169(.a(new_n236_), .b(new_n154_), .c(new_n159_), .O(new_n321_));
  ...
  nand3  g221(.a(new_n282_), .b(x84), .c(x83), .O(new_n373_));
  ...
  oai21  g243(.a(new_n370_), .b(new_n160_), .c(new_n154_), .O(new_n395_));
  ...
  nand2  g268(.a(new_n419_), .b(new_n325_), .O(new_n420_));
  aoi21  g269(.a(new_n420_), .b(new_n418_), .c(x01), .O(z62));
  nor3   g270(.a(new_n408_), .b(new_n406_), .c(new_n279_), .O(z63));
  ...
  nor2   g276(.a(new_n255_), .b(x78), .O(new_n428_));
  oai21  g277(.a(new_n428_), .b(new_n427_), .c(x77), .O(new_n429_));
  nand2  g278(.a(new_n370_), .b(x81), .O(new_n430_));
