...
module FAU ( 
  ...
  nand2  g221(.a(new_n154_), .b(x77), .O(new_n373_));
  nand3  g222(.a(new_n373_), .b(new_n160_), .c(new_n153_), .O(new_n374_));
  nand2  g223(.a(x79), .b(new_n159_), .O(new_n375_));
  nand3  g224(.a(new_n375_), .b(new_n374_), .c(new_n243_), .O(z56));
  inv1   g225(.a(x02), .O(new_n377_));
  nand3  g226(.a(new_n243_), .b(x03), .c(new_n377_), .O(new_n378_));
  inv1   g227(.a(new_n378_), .O(z57));
  nand4  g228(.a(x80), .b(new_n232_), .c(x43), .d(new_n250_), .O(new_n380_));
  oai22  g229(.a(new_n380_), .b(new_n231_), .c(new_n250_), .d(x40), .O(new_n381_));
  nand3  g230(.a(new_n381_), .b(new_n237_), .c(x79), .O(new_n382_));
  nor2   g231(.a(x79), .b(x78), .O(new_n383_));
  nand3  g232(.a(new_n383_), .b(new_n250_), .c(x40), .O(new_n384_));
  nand2  g233(.a(new_n384_), .b(new_n382_), .O(new_n385_));
  nand2  g234(.a(new_n385_), .b(x77), .O(new_n386_));
  oai21  g235(.a(new_n166_), .b(new_n240_), .c(new_n154_), .O(new_n387_));
  aoi21  g236(.a(new_n387_), .b(new_n386_), .c(x01), .O(z58));
  inv1   g237(.a(new_n383_), .O(new_n389_));
  aoi21  g238(.a(new_n236_), .b(new_n389_), .c(new_n152_), .O(new_n390_));
  oai21  g239(.a(new_n233_), .b(new_n231_), .c(new_n250_), .O(new_n391_));
  aoi21  g240(.a(new_n391_), .b(x79), .c(new_n236_), .O(new_n392_));
  oai21  g241(.a(new_n392_), .b(new_n390_), .c(x77), .O(new_n393_));
  nor2   g242(.a(x79), .b(x04), .O(new_n394_));
  inv1   g243(.a(new_n394_), .O(new_n395_));
  aoi21  g244(.a(new_n395_), .b(new_n393_), .c(x01), .O(z59));
  xor2a  g245(.a(x84), .b(x81), .O(new_n397_));
  nand2  g246(.a(new_n322_), .b(new_n167_), .O(new_n398_));
  ...
  nand2  g258(.a(new_n391_), .b(x79), .O(new_n410_));
