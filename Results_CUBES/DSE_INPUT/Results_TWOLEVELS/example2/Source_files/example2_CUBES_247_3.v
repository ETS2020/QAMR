// Benchmark "FAU" written by ABC on Mon Jul  6 20:05:53 2020
...
module FAU ( 
  ...
  nand2  g195(.a(new_n292_), .b(x10), .O(new_n347_));
  inv1   g196(.a(new_n170_), .O(new_n348_));
  nand4  g197(.a(new_n348_), .b(new_n154_), .c(x04), .d(new_n153_), .O(new_n349_));
  aoi21  g198(.a(new_n347_), .b(new_n346_), .c(new_n349_), .O(z50));
  ...
  aoi21  g219(.a(new_n370_), .b(new_n369_), .c(new_n349_), .O(z54));
  ...
  oai21  g243(.a(new_n348_), .b(new_n160_), .c(new_n154_), .O(new_n395_));
  ...
  nand2  g278(.a(new_n348_), .b(x81), .O(new_n430_));
