// Benchmark "FAU" written by ABC on Mon Jul  6 20:03:36 2020
...
module FAU ( 
  ...
  and2   g138(.a(new_n289_), .b(new_n254_), .O(new_n290_));
  nand2  g139(.a(new_n286_), .b(x81), .O(new_n291_));
  nand2  g140(.a(new_n273_), .b(x42), .O(new_n292_));
  aoi21  g141(.a(new_n292_), .b(new_n291_), .c(new_n250_), .O(new_n293_));
  oai21  g142(.a(new_n293_), .b(new_n290_), .c(new_n283_), .O(new_n294_));
  nand2  g143(.a(new_n246_), .b(x52), .O(new_n295_));
  nor2   g144(.a(new_n295_), .b(new_n294_), .O(z34));
  nand2  g145(.a(new_n246_), .b(x53), .O(new_n297_));
  nor2   g146(.a(new_n297_), .b(new_n294_), .O(z35));
  nand2  g147(.a(new_n246_), .b(x54), .O(new_n299_));
  nor2   g148(.a(new_n299_), .b(new_n294_), .O(z36));
  nand2  g149(.a(new_n246_), .b(x55), .O(new_n301_));
  nor2   g150(.a(new_n301_), .b(new_n294_), .O(z37));
  nand2  g151(.a(new_n246_), .b(x56), .O(new_n303_));
  nor2   g152(.a(new_n303_), .b(new_n294_), .O(z38));
  inv1   g153(.a(new_n246_), .O(new_n305_));
  nor3   g154(.a(new_n294_), .b(new_n305_), .c(new_n199_), .O(z39));
  nor3   g155(.a(new_n294_), .b(new_n305_), .c(new_n196_), .O(z40));
  nor3   g156(.a(new_n294_), .b(new_n305_), .c(new_n193_), .O(z41));
  nor3   g157(.a(new_n294_), .b(new_n305_), .c(new_n190_), .O(z42));
  nor3   g158(.a(new_n294_), .b(new_n305_), .c(new_n187_), .O(z43));
  nor3   g159(.a(new_n294_), .b(new_n305_), .c(new_n184_), .O(z44));
  nor3   g160(.a(new_n294_), .b(new_n305_), .c(new_n181_), .O(z45));
  nor3   g161(.a(new_n294_), .b(new_n305_), .c(new_n178_), .O(z46));
  ...
  nand2  g214(.a(x04), .b(new_n153_), .O(new_n366_));
  nor4   g215(.a(new_n366_), .b(new_n365_), .c(new_n167_), .d(x79), .O(z54));
  inv1   g216(.a(x82), .O(new_n368_));
  nand3  g217(.a(new_n273_), .b(x84), .c(new_n368_), .O(new_n369_));
  ...
  inv1   g239(.a(new_n167_), .O(new_n391_));
  oai21  g240(.a(new_n391_), .b(new_n239_), .c(new_n154_), .O(new_n392_));
  ...
  aoi21  g250(.a(new_n375_), .b(x79), .c(new_n399_), .O(new_n402_));
  ...
  nor3   g255(.a(new_n406_), .b(new_n404_), .c(new_n370_), .O(z61));
  ...
  nand2  g266(.a(new_n417_), .b(new_n322_), .O(new_n418_));
  aoi21  g267(.a(new_n418_), .b(new_n416_), .c(x01), .O(z62));
  nor3   g268(.a(new_n406_), .b(new_n404_), .c(new_n368_), .O(z63));
  nand2  g269(.a(x83), .b(x79), .O(new_n421_));
  or2    g270(.a(new_n421_), .b(new_n406_), .O(new_n422_));
  aoi21  g271(.a(new_n422_), .b(new_n318_), .c(x01), .O(z64));
  ...
  nand2  g275(.a(new_n391_), .b(x81), .O(new_n427_));
