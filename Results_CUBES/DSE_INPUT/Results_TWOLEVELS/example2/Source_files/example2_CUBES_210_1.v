// Benchmark "FAU" written by ABC on Mon Jul  6 20:05:16 2020
...
module FAU ( 
  ...
  nand3  g113(.a(new_n264_), .b(new_n251_), .c(x05), .O(new_n265_));
  inv1   g114(.a(new_n265_), .O(z25));
  nand4  g115(.a(new_n262_), .b(new_n251_), .c(x44), .d(new_n254_), .O(new_n267_));
  inv1   g116(.a(new_n267_), .O(z26));
  nand2  g117(.a(new_n264_), .b(new_n251_), .O(new_n269_));
  inv1   g118(.a(new_n269_), .O(z27));
  nand4  g119(.a(new_n262_), .b(new_n251_), .c(x46), .d(new_n254_), .O(new_n271_));
  inv1   g120(.a(new_n271_), .O(z28));
  nand4  g121(.a(new_n262_), .b(new_n251_), .c(x47), .d(new_n254_), .O(new_n273_));
  inv1   g122(.a(new_n273_), .O(z29));
  nand4  g123(.a(new_n262_), .b(new_n251_), .c(x48), .d(new_n254_), .O(new_n275_));
  inv1   g124(.a(new_n275_), .O(z30));
  nand4  g125(.a(new_n262_), .b(new_n251_), .c(x49), .d(new_n254_), .O(new_n277_));
  inv1   g126(.a(new_n277_), .O(z31));
  nand4  g127(.a(new_n262_), .b(new_n251_), .c(x50), .d(new_n254_), .O(new_n279_));
  ...
  nand2  g133(.a(x51), .b(new_n254_), .O(new_n285_));
  oai22  g134(.a(new_n285_), .b(new_n258_), .c(new_n284_), .d(new_n283_), .O(new_n286_));
  nand2  g135(.a(new_n286_), .b(new_n256_), .O(new_n287_));
  xor2a  g136(.a(x83), .b(x81), .O(new_n288_));
  oai22  g137(.a(new_n288_), .b(new_n284_), .c(new_n285_), .d(x81), .O(new_n289_));
  nand2  g138(.a(new_n289_), .b(new_n259_), .O(new_n290_));
  inv1   g139(.a(new_n261_), .O(new_n291_));
  nand2  g140(.a(new_n291_), .b(new_n251_), .O(new_n292_));
  aoi21  g141(.a(new_n290_), .b(new_n287_), .c(new_n292_), .O(z33));
  inv1   g142(.a(x52), .O(new_n294_));
  inv1   g143(.a(new_n251_), .O(new_n295_));
  ...
  and2   g148(.a(new_n299_), .b(new_n259_), .O(new_n300_));
  nand2  g149(.a(new_n296_), .b(x81), .O(new_n301_));
  nand2  g150(.a(new_n281_), .b(x42), .O(new_n302_));
  aoi21  g151(.a(new_n302_), .b(new_n301_), .c(new_n255_), .O(new_n303_));
  oai21  g152(.a(new_n303_), .b(new_n300_), .c(new_n291_), .O(new_n304_));
  nor3   g153(.a(new_n304_), .b(new_n295_), .c(new_n294_), .O(z34));
  nand2  g154(.a(new_n251_), .b(x53), .O(new_n306_));
  nor2   g155(.a(new_n306_), .b(new_n304_), .O(z35));
  nand2  g156(.a(new_n251_), .b(x54), .O(new_n308_));
  nor2   g157(.a(new_n308_), .b(new_n304_), .O(z36));
  nand2  g158(.a(new_n251_), .b(x55), .O(new_n310_));
  nor2   g159(.a(new_n310_), .b(new_n304_), .O(z37));
  nand2  g160(.a(new_n251_), .b(x56), .O(new_n312_));
  ...
  nand3  g173(.a(new_n236_), .b(new_n154_), .c(new_n159_), .O(new_n325_));
  inv1   g174(.a(new_n325_), .O(new_n326_));
  nand2  g175(.a(new_n326_), .b(new_n324_), .O(new_n327_));
  nor2   g176(.a(x75), .b(x67), .O(new_n328_));
  inv1   g177(.a(new_n171_), .O(new_n329_));
  nand2  g178(.a(new_n329_), .b(x79), .O(new_n330_));
  nor2   g179(.a(new_n330_), .b(new_n328_), .O(new_n331_));
  nand2  g180(.a(new_n331_), .b(new_n233_), .O(new_n332_));
  ...
  inv1   g186(.a(new_n233_), .O(new_n338_));
  nor2   g187(.a(new_n330_), .b(new_n338_), .O(new_n339_));
  ...
  nand2  g193(.a(new_n344_), .b(new_n326_), .O(new_n345_));
  ...
  nand2  g199(.a(new_n350_), .b(new_n326_), .O(new_n351_));
  ...
  nand2  g205(.a(new_n356_), .b(new_n326_), .O(new_n357_));
  ...
  nand2  g211(.a(new_n362_), .b(new_n326_), .O(new_n363_));
  ...
  nand2  g217(.a(new_n368_), .b(new_n326_), .O(new_n369_));
  nand2  g218(.a(new_n339_), .b(x73), .O(new_n370_));
  aoi21  g219(.a(new_n370_), .b(new_n369_), .c(x01), .O(z53));
  nand2  g220(.a(x52), .b(x22), .O(new_n372_));
  nand2  g221(.a(new_n294_), .b(x14), .O(new_n373_));
  inv1   g222(.a(new_n170_), .O(new_n374_));
  nand4  g223(.a(new_n374_), .b(new_n154_), .c(x04), .d(new_n153_), .O(new_n375_));
  aoi21  g224(.a(new_n373_), .b(new_n372_), .c(new_n375_), .O(z54));
  inv1   g225(.a(x82), .O(new_n377_));
  nand3  g226(.a(new_n281_), .b(x84), .c(new_n377_), .O(new_n378_));
  inv1   g227(.a(x80), .O(new_n379_));
  nand4  g228(.a(new_n251_), .b(new_n165_), .c(new_n379_), .d(x79), .O(new_n380_));
  nor2   g229(.a(new_n380_), .b(new_n378_), .O(z55));
  nand2  g230(.a(new_n249_), .b(x76), .O(new_n382_));
  xnor2a g231(.a(x84), .b(x81), .O(new_n383_));
  aoi21  g232(.a(new_n171_), .b(new_n170_), .c(new_n383_), .O(new_n384_));
  nand2  g233(.a(new_n384_), .b(new_n153_), .O(new_n385_));
  nand2  g234(.a(new_n385_), .b(new_n382_), .O(new_n386_));
  nand2  g235(.a(new_n386_), .b(x79), .O(new_n387_));
  nor2   g236(.a(x77), .b(x01), .O(new_n388_));
  aoi21  g237(.a(new_n388_), .b(new_n164_), .c(new_n246_), .O(new_n389_));
  nand2  g238(.a(new_n389_), .b(new_n387_), .O(z56));
  inv1   g239(.a(x02), .O(new_n391_));
  nand3  g240(.a(new_n247_), .b(x03), .c(new_n391_), .O(new_n392_));
  inv1   g241(.a(new_n392_), .O(z57));
  nand4  g242(.a(x80), .b(new_n239_), .c(x43), .d(new_n254_), .O(new_n394_));
  oai22  g243(.a(new_n394_), .b(new_n238_), .c(new_n254_), .d(x40), .O(new_n395_));
  nand3  g244(.a(new_n395_), .b(new_n236_), .c(x79), .O(new_n396_));
  nand3  g245(.a(new_n178_), .b(new_n254_), .c(x40), .O(new_n397_));
  nand2  g246(.a(new_n397_), .b(new_n396_), .O(new_n398_));
  nand2  g247(.a(new_n398_), .b(x77), .O(new_n399_));
  oai21  g248(.a(new_n374_), .b(new_n160_), .c(new_n154_), .O(new_n400_));
  aoi21  g249(.a(new_n400_), .b(new_n399_), .c(x01), .O(z58));
  aoi21  g250(.a(new_n163_), .b(new_n179_), .c(new_n152_), .O(new_n402_));
  oai21  g251(.a(new_n240_), .b(new_n238_), .c(new_n254_), .O(new_n403_));
  ...
  nor3   g262(.a(new_n413_), .b(new_n411_), .c(new_n379_), .O(z61));
  ...
  nand2  g273(.a(new_n424_), .b(new_n329_), .O(new_n425_));
  aoi21  g274(.a(new_n425_), .b(new_n423_), .c(x01), .O(z62));
  nor3   g275(.a(new_n413_), .b(new_n411_), .c(new_n377_), .O(z63));
  ...
  nor2   g281(.a(new_n258_), .b(x78), .O(new_n433_));
  oai21  g282(.a(new_n433_), .b(new_n432_), .c(x77), .O(new_n434_));
  nand2  g283(.a(new_n374_), .b(x81), .O(new_n435_));
