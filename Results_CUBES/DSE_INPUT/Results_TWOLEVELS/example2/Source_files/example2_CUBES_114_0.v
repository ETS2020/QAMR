...
module FAU ( 
  ...
  oai21  g176(.a(new_n287_), .b(x16), .c(new_n320_), .O(new_n328_));
  inv1   g177(.a(new_n226_), .O(new_n329_));
  nor2   g178(.a(new_n324_), .b(new_n329_), .O(new_n330_));
  ...
  nand2  g184(.a(new_n335_), .b(new_n320_), .O(new_n336_));
  ...
  nand2  g190(.a(new_n341_), .b(new_n320_), .O(new_n342_));
