// Benchmark "FAU" written by ABC on Mon Jul  6 20:02:58 2020
...
module FAU ( 
  ...
  oai21  g059(.a(new_n209_), .b(new_n152_), .c(new_n210_), .O(z14));
  ...
  nand3  g088(.a(new_n154_), .b(x05), .c(new_n160_), .O(new_n240_));
  ...
  aoi21  g095(.a(new_n164_), .b(x79), .c(new_n246_), .O(z24));
  xor2a  g096(.a(x84), .b(x81), .O(new_n248_));
  nand2  g097(.a(new_n165_), .b(x79), .O(new_n249_));
  inv1   g098(.a(new_n249_), .O(new_n250_));
  nand2  g099(.a(new_n250_), .b(new_n248_), .O(new_n251_));
  inv1   g100(.a(x42), .O(new_n252_));
  nand3  g101(.a(new_n245_), .b(new_n252_), .c(x05), .O(new_n253_));
  nor2   g102(.a(new_n253_), .b(new_n251_), .O(z25));
  nand3  g103(.a(new_n245_), .b(x44), .c(new_n252_), .O(new_n255_));
  nor2   g104(.a(new_n255_), .b(new_n251_), .O(z26));
  nand3  g105(.a(new_n245_), .b(x45), .c(new_n252_), .O(new_n257_));
  nor2   g106(.a(new_n257_), .b(new_n251_), .O(z27));
  nand3  g107(.a(new_n245_), .b(x46), .c(new_n252_), .O(new_n259_));
  nor2   g108(.a(new_n259_), .b(new_n251_), .O(z28));
  nand3  g109(.a(new_n245_), .b(x47), .c(new_n252_), .O(new_n261_));
  nor2   g110(.a(new_n261_), .b(new_n251_), .O(z29));
  nand3  g111(.a(new_n245_), .b(x48), .c(new_n252_), .O(new_n263_));
  nor2   g112(.a(new_n263_), .b(new_n251_), .O(z30));
  nand3  g113(.a(new_n245_), .b(x49), .c(new_n252_), .O(new_n265_));
  nor2   g114(.a(new_n265_), .b(new_n251_), .O(z31));
  nand3  g115(.a(new_n245_), .b(x50), .c(new_n252_), .O(new_n267_));
  nor2   g116(.a(new_n267_), .b(new_n251_), .O(z32));
  nand2  g117(.a(x42), .b(x05), .O(new_n269_));
  oai22  g118(.a(new_n269_), .b(x83), .c(new_n209_), .d(x42), .O(new_n270_));
  nand2  g119(.a(new_n270_), .b(new_n248_), .O(new_n271_));
  and2   g120(.a(x83), .b(x42), .O(new_n272_));
  nand3  g121(.a(new_n272_), .b(new_n233_), .c(x05), .O(new_n273_));
  nand2  g122(.a(new_n250_), .b(new_n245_), .O(new_n274_));
  aoi21  g123(.a(new_n273_), .b(new_n271_), .c(new_n274_), .O(z33));
  inv1   g124(.a(new_n248_), .O(new_n276_));
  nand2  g125(.a(new_n272_), .b(new_n233_), .O(new_n277_));
  oai21  g126(.a(new_n272_), .b(new_n276_), .c(new_n277_), .O(new_n278_));
  nand2  g127(.a(new_n245_), .b(x52), .O(new_n279_));
  inv1   g128(.a(new_n279_), .O(new_n280_));
  nand3  g129(.a(new_n280_), .b(new_n278_), .c(new_n250_), .O(new_n281_));
  inv1   g130(.a(new_n281_), .O(z34));
  nand2  g131(.a(new_n245_), .b(x53), .O(new_n283_));
  inv1   g132(.a(new_n283_), .O(new_n284_));
  nand3  g133(.a(new_n284_), .b(new_n278_), .c(new_n250_), .O(new_n285_));
  inv1   g134(.a(new_n285_), .O(z35));
  nand2  g135(.a(new_n245_), .b(x54), .O(new_n287_));
  inv1   g136(.a(new_n287_), .O(new_n288_));
  nand3  g137(.a(new_n288_), .b(new_n278_), .c(new_n250_), .O(new_n289_));
  inv1   g138(.a(new_n289_), .O(z36));
  nand2  g139(.a(new_n245_), .b(x55), .O(new_n291_));
  inv1   g140(.a(new_n291_), .O(new_n292_));
  nand3  g141(.a(new_n292_), .b(new_n278_), .c(new_n250_), .O(new_n293_));
  inv1   g142(.a(new_n293_), .O(z37));
  nand2  g143(.a(new_n245_), .b(x56), .O(new_n295_));
  inv1   g144(.a(new_n295_), .O(new_n296_));
  nand3  g145(.a(new_n296_), .b(new_n278_), .c(new_n250_), .O(new_n297_));
  inv1   g146(.a(new_n297_), .O(z38));
  nand2  g147(.a(new_n245_), .b(x57), .O(new_n299_));
  inv1   g148(.a(new_n299_), .O(new_n300_));
  nand3  g149(.a(new_n300_), .b(new_n278_), .c(new_n250_), .O(new_n301_));
  inv1   g150(.a(new_n301_), .O(z39));
  nand2  g151(.a(new_n245_), .b(x58), .O(new_n303_));
  inv1   g152(.a(new_n303_), .O(new_n304_));
  nand3  g153(.a(new_n304_), .b(new_n278_), .c(new_n250_), .O(new_n305_));
  inv1   g154(.a(new_n305_), .O(z40));
  nand2  g155(.a(new_n245_), .b(x59), .O(new_n307_));
  inv1   g156(.a(new_n307_), .O(new_n308_));
  nand3  g157(.a(new_n308_), .b(new_n278_), .c(new_n250_), .O(new_n309_));
  inv1   g158(.a(new_n309_), .O(z41));
  nand2  g159(.a(new_n245_), .b(x60), .O(new_n311_));
  inv1   g160(.a(new_n311_), .O(new_n312_));
  nand3  g161(.a(new_n312_), .b(new_n278_), .c(new_n250_), .O(new_n313_));
  inv1   g162(.a(new_n313_), .O(z42));
  nand2  g163(.a(new_n245_), .b(x61), .O(new_n315_));
  inv1   g164(.a(new_n315_), .O(new_n316_));
  nand3  g165(.a(new_n316_), .b(new_n278_), .c(new_n250_), .O(new_n317_));
  inv1   g166(.a(new_n317_), .O(z43));
  nand2  g167(.a(new_n245_), .b(x62), .O(new_n319_));
  inv1   g168(.a(new_n319_), .O(new_n320_));
  nand3  g169(.a(new_n320_), .b(new_n278_), .c(new_n250_), .O(new_n321_));
  inv1   g170(.a(new_n321_), .O(z44));
  nand2  g171(.a(new_n245_), .b(x63), .O(new_n323_));
  inv1   g172(.a(new_n323_), .O(new_n324_));
  nand3  g173(.a(new_n324_), .b(new_n278_), .c(new_n250_), .O(new_n325_));
  inv1   g174(.a(new_n325_), .O(z45));
  nand2  g175(.a(new_n245_), .b(x64), .O(new_n327_));
  inv1   g176(.a(new_n327_), .O(new_n328_));
  nand3  g177(.a(new_n328_), .b(new_n278_), .c(new_n250_), .O(new_n329_));
  ...
  nand2  g183(.a(new_n334_), .b(new_n236_), .O(new_n335_));
  inv1   g184(.a(new_n335_), .O(new_n336_));
  nand2  g185(.a(new_n336_), .b(new_n333_), .O(new_n337_));
  inv1   g186(.a(new_n172_), .O(new_n338_));
  inv1   g187(.a(x67), .O(new_n339_));
  nand2  g188(.a(new_n169_), .b(new_n339_), .O(new_n340_));
  nand4  g189(.a(new_n340_), .b(new_n233_), .c(new_n338_), .d(x79), .O(new_n341_));
  ...
  nand4  g195(.a(new_n233_), .b(new_n338_), .c(x79), .d(x68), .O(new_n347_));
  aoi21  g196(.a(new_n347_), .b(new_n346_), .c(x01), .O(z48));
  ...
  nand4  g201(.a(new_n233_), .b(new_n338_), .c(x79), .d(x69), .O(new_n353_));
  ...
  nand4  g207(.a(new_n233_), .b(new_n338_), .c(x79), .d(x70), .O(new_n359_));
  ...
  nand4  g213(.a(new_n233_), .b(new_n338_), .c(x79), .d(x71), .O(new_n365_));
  ...
  nand4  g219(.a(new_n233_), .b(new_n338_), .c(x79), .d(x72), .O(new_n371_));
  ...
  nand2  g224(.a(new_n375_), .b(new_n336_), .O(new_n376_));
  nand4  g225(.a(new_n233_), .b(new_n338_), .c(x79), .d(x73), .O(new_n377_));
  aoi21  g226(.a(new_n377_), .b(new_n376_), .c(x01), .O(z53));
  inv1   g227(.a(x14), .O(new_n379_));
  nor2   g228(.a(x52), .b(new_n379_), .O(new_n380_));
  aoi21  g229(.a(x52), .b(x22), .c(new_n380_), .O(new_n381_));
  inv1   g230(.a(new_n170_), .O(new_n382_));
  nand4  g231(.a(new_n382_), .b(new_n154_), .c(x04), .d(new_n153_), .O(new_n383_));
  nor2   g232(.a(new_n383_), .b(new_n381_), .O(z54));
  inv1   g233(.a(x81), .O(new_n385_));
  nand3  g234(.a(x84), .b(x83), .c(new_n385_), .O(new_n386_));
  inv1   g235(.a(x80), .O(new_n387_));
  nand4  g236(.a(new_n245_), .b(new_n165_), .c(new_n387_), .d(x79), .O(new_n388_));
  nor2   g237(.a(new_n388_), .b(new_n386_), .O(z55));
  nand2  g238(.a(new_n164_), .b(x76), .O(new_n390_));
  xor2a  g239(.a(x78), .b(x77), .O(new_n391_));
  nand3  g240(.a(new_n391_), .b(new_n248_), .c(new_n153_), .O(new_n392_));
  nand2  g241(.a(new_n392_), .b(new_n390_), .O(new_n393_));
  nand2  g242(.a(new_n393_), .b(x79), .O(new_n394_));
  nand3  g243(.a(new_n171_), .b(new_n159_), .c(new_n153_), .O(new_n395_));
  nand3  g244(.a(new_n395_), .b(new_n394_), .c(new_n242_), .O(z56));
  inv1   g245(.a(x02), .O(new_n397_));
  nand3  g246(.a(new_n242_), .b(x03), .c(new_n397_), .O(new_n398_));
  inv1   g247(.a(new_n398_), .O(z57));
  nand4  g248(.a(x79), .b(x77), .c(x42), .d(new_n152_), .O(new_n400_));
  inv1   g249(.a(new_n400_), .O(new_n401_));
  oai21  g250(.a(new_n401_), .b(new_n334_), .c(new_n236_), .O(new_n402_));
  nand2  g251(.a(new_n252_), .b(x40), .O(new_n403_));
  oai21  g252(.a(new_n403_), .b(new_n172_), .c(x04), .O(new_n404_));
  nand2  g253(.a(new_n404_), .b(new_n154_), .O(new_n405_));
  aoi21  g254(.a(new_n405_), .b(new_n402_), .c(x01), .O(z58));
  aoi21  g255(.a(new_n163_), .b(new_n179_), .c(new_n152_), .O(new_n407_));
  aoi21  g256(.a(x79), .b(x42), .c(new_n163_), .O(new_n408_));
  oai21  g257(.a(new_n408_), .b(new_n407_), .c(x77), .O(new_n409_));
  nand2  g258(.a(new_n154_), .b(new_n160_), .O(new_n410_));
  aoi21  g259(.a(new_n410_), .b(new_n409_), .c(x01), .O(z59));
  nand3  g260(.a(new_n391_), .b(new_n248_), .c(x79), .O(new_n412_));
  aoi22  g261(.a(new_n237_), .b(new_n236_), .c(new_n154_), .d(new_n160_), .O(new_n413_));
  aoi21  g262(.a(new_n413_), .b(new_n412_), .c(x01), .O(z60));
  nand2  g263(.a(new_n391_), .b(new_n233_), .O(new_n415_));
  nand2  g264(.a(new_n165_), .b(new_n160_), .O(new_n416_));
  nand2  g265(.a(new_n174_), .b(x80), .O(new_n417_));
  aoi21  g266(.a(new_n416_), .b(new_n415_), .c(new_n417_), .O(z61));
  nand2  g267(.a(new_n154_), .b(x04), .O(new_n419_));
  nand3  g268(.a(x84), .b(x81), .c(x79), .O(new_n420_));
  aoi21  g269(.a(new_n420_), .b(new_n419_), .c(x77), .O(new_n421_));
  nand2  g270(.a(x79), .b(x42), .O(new_n422_));
  nand2  g271(.a(new_n422_), .b(x04), .O(new_n423_));
  nand3  g272(.a(x81), .b(x79), .c(new_n160_), .O(new_n424_));
  aoi21  g273(.a(new_n424_), .b(new_n423_), .c(new_n159_), .O(new_n425_));
  oai21  g274(.a(new_n425_), .b(new_n421_), .c(x78), .O(new_n426_));
  inv1   g275(.a(new_n420_), .O(new_n427_));
  nand2  g276(.a(new_n427_), .b(new_n338_), .O(new_n428_));
  aoi21  g277(.a(new_n428_), .b(new_n426_), .c(x01), .O(z62));
  nand2  g278(.a(new_n416_), .b(new_n415_), .O(new_n431_));
  nand3  g279(.a(new_n431_), .b(x83), .c(x79), .O(new_n432_));
  nand3  g280(.a(new_n176_), .b(new_n159_), .c(x04), .O(new_n433_));
  aoi21  g281(.a(new_n433_), .b(new_n432_), .c(x01), .O(z64));
  nor2   g282(.a(new_n171_), .b(x04), .O(new_n435_));
  nor2   g283(.a(new_n385_), .b(x78), .O(new_n436_));
  oai21  g284(.a(new_n436_), .b(new_n435_), .c(x77), .O(new_n437_));
  nand2  g285(.a(new_n382_), .b(x81), .O(new_n438_));
  nand2  g286(.a(new_n174_), .b(x84), .O(new_n439_));
  aoi21  g287(.a(new_n438_), .b(new_n437_), .c(new_n439_), .O(z65));
  zero   g288(.O(z63));
endmodule
