...
module FAU ( 
  ...
  nand2  g12(.a(x18), .b(x10), .O(new_n41_));
  nand3  g13(.a(new_n41_), .b(new_n36_), .c(new_n37_), .O(new_n42_));
  ...
  aoi22  g35(.a(new_n63_), .b(new_n54_), .c(new_n61_), .d(x15), .O(new_n64_));
  ...
  nand2  g55(.a(x18), .b(new_n46_), .O(new_n84_));
  nand4  g56(.a(x17), .b(x16), .c(x15), .d(x14), .O(new_n85_));
  inv1   g57(.a(new_n85_), .O(new_n86_));
  aoi21  g58(.a(new_n86_), .b(new_n70_), .c(new_n84_), .O(new_n87_));
  inv1   g59(.a(x18), .O(new_n88_));
  nand4  g60(.a(new_n88_), .b(x17), .c(x16), .d(x15), .O(new_n89_));
  nor2   g61(.a(new_n89_), .b(new_n61_), .O(new_n90_));
  oai21  g62(.a(new_n90_), .b(new_n87_), .c(new_n36_), .O(new_n91_));
