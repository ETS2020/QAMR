// Benchmark "FAU" written by ABC on Mon Jul  6 13:56:25 2020
...
module FAU ( 
  ...
  nand3  g02(.a(new_n30_), .b(x13), .c(x12), .O(new_n31_));
  ...
  nand3  g12(.a(new_n34_), .b(new_n40_), .c(new_n32_), .O(new_n41_));
  nand2  g13(.a(new_n41_), .b(new_n39_), .O(z1));
  xnor2a g14(.a(x12), .b(x11), .O(new_n43_));
  nand2  g15(.a(new_n34_), .b(new_n32_), .O(new_n44_));
  ...
  nand3  g26(.a(new_n47_), .b(new_n52_), .c(x13), .O(new_n55_));
  ...
  aoi22  g34(.a(new_n62_), .b(new_n47_), .c(new_n60_), .d(x15), .O(new_n63_));
  nand2  g35(.a(x08), .b(x04), .O(new_n64_));
  oai21  g36(.a(new_n63_), .b(new_n44_), .c(new_n64_), .O(z5));
  inv1   g37(.a(x16), .O(new_n66_));
  aoi21  g38(.a(new_n54_), .b(new_n30_), .c(new_n66_), .O(new_n67_));
  nor3   g39(.a(new_n53_), .b(new_n29_), .c(x16), .O(new_n68_));
  ...
  nand2  g45(.a(x17), .b(new_n32_), .O(new_n74_));
  aoi21  g46(.a(new_n73_), .b(new_n54_), .c(new_n74_), .O(new_n75_));
  nor4   g47(.a(new_n53_), .b(new_n29_), .c(x17), .d(new_n66_), .O(new_n76_));
  oai21  g48(.a(new_n76_), .b(new_n75_), .c(new_n34_), .O(new_n77_));
  nand2  g49(.a(x08), .b(x06), .O(new_n78_));
  nand2  g50(.a(new_n78_), .b(new_n77_), .O(z7));
  inv1   g51(.a(new_n34_), .O(new_n80_));
  oai21  g52(.a(new_n72_), .b(new_n53_), .c(x18), .O(new_n81_));
  ...
  nor2   g56(.a(new_n82_), .b(x17), .O(new_n85_));
  aoi21  g57(.a(new_n84_), .b(new_n32_), .c(new_n85_), .O(new_n86_));
  nand2  g58(.a(x08), .b(x07), .O(new_n87_));
  oai21  g59(.a(new_n86_), .b(new_n80_), .c(new_n87_), .O(z8));
endmodule
