...
module FAU ( 
  ...
  oai21  g37(.a(new_n53_), .b(new_n29_), .c(x16), .O(new_n66_));
  inv1   g38(.a(x16), .O(new_n67_));
  inv1   g39(.a(new_n53_), .O(new_n68_));
  nand3  g40(.a(new_n68_), .b(new_n30_), .c(new_n67_), .O(new_n69_));
  ...
  nand3  g46(.a(new_n74_), .b(new_n52_), .c(x16), .O(new_n75_));
  inv1   g47(.a(x17), .O(new_n76_));
  nor2   g48(.a(new_n76_), .b(x15), .O(new_n77_));
  aoi21  g49(.a(new_n75_), .b(x15), .c(new_n77_), .O(new_n78_));
  nand2  g50(.a(x08), .b(x06), .O(new_n79_));
  oai21  g51(.a(new_n78_), .b(new_n45_), .c(new_n79_), .O(z7));
