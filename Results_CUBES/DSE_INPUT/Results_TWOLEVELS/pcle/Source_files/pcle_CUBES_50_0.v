...
module FAU ( 
  ...
  nor2   g12(.a(x15), .b(x13), .O(new_n41_));
  ...
  oai21  g33(.a(x15), .b(new_n61_), .c(x13), .O(new_n62_));
  nand3  g34(.a(x14), .b(x12), .c(x11), .O(new_n63_));
  aoi22  g35(.a(new_n63_), .b(x15), .c(new_n62_), .d(new_n54_), .O(new_n64_));
  ...
  nor2   g57(.a(new_n61_), .b(new_n56_), .O(new_n86_));
  nor2   g58(.a(x18), .b(new_n78_), .O(new_n87_));
  nand4  g59(.a(x16), .b(x15), .c(x12), .d(x11), .O(new_n88_));
  inv1   g60(.a(new_n88_), .O(new_n89_));
  nand3  g61(.a(new_n89_), .b(new_n87_), .c(new_n86_), .O(new_n90_));
  nand2  g62(.a(new_n90_), .b(new_n85_), .O(new_n91_));
  nand2  g63(.a(new_n91_), .b(new_n67_), .O(new_n92_));
