// Benchmark "FAU" written by ABC on Mon Jul  6 13:57:12 2020
...
module FAU ( 
  ...
  nand3  g36(.a(x15), .b(x14), .c(x13), .O(new_n65_));
  oai21  g37(.a(new_n65_), .b(new_n47_), .c(x16), .O(new_n66_));
  inv1   g38(.a(x16), .O(new_n67_));
  nand3  g39(.a(new_n67_), .b(x15), .c(x14), .O(new_n68_));
  oai21  g40(.a(new_n68_), .b(new_n52_), .c(new_n66_), .O(new_n69_));
  ...
  and2   g48(.a(x14), .b(x13), .O(new_n77_));
  and2   g49(.a(x15), .b(x12), .O(new_n78_));
  nand4  g50(.a(new_n78_), .b(new_n77_), .c(new_n76_), .d(x16), .O(new_n79_));
  nand3  g51(.a(new_n79_), .b(new_n75_), .c(x11), .O(new_n80_));
  nand2  g52(.a(new_n80_), .b(new_n64_), .O(new_n81_));
  nand2  g53(.a(x08), .b(x06), .O(new_n82_));
  nand2  g54(.a(new_n82_), .b(new_n81_), .O(z7));
  nand4  g55(.a(x17), .b(x16), .c(x15), .d(x14), .O(new_n84_));
  oai21  g56(.a(new_n84_), .b(new_n52_), .c(x18), .O(new_n85_));
  inv1   g57(.a(new_n58_), .O(new_n86_));
  inv1   g58(.a(new_n73_), .O(new_n87_));
  nor2   g59(.a(x18), .b(new_n76_), .O(new_n88_));
  nand3  g60(.a(new_n88_), .b(new_n87_), .c(new_n86_), .O(new_n89_));
  nand2  g61(.a(new_n89_), .b(new_n85_), .O(new_n90_));
  nand2  g62(.a(new_n90_), .b(new_n64_), .O(new_n91_));
