...
module FAU ( 
  ...
  nand2  g38(.a(new_n60_), .b(x16), .O(new_n67_));
  ...
  aoi21  g43(.a(new_n70_), .b(new_n66_), .c(new_n71_), .O(new_n72_));
  nand2  g44(.a(new_n33_), .b(x09), .O(new_n73_));
  nand2  g45(.a(x08), .b(x05), .O(new_n74_));
  oai21  g46(.a(new_n73_), .b(new_n72_), .c(new_n74_), .O(z6));
  nand3  g47(.a(x16), .b(x15), .c(x14), .O(new_n76_));
  oai21  g48(.a(new_n76_), .b(new_n53_), .c(x17), .O(new_n77_));
  nor2   g49(.a(x17), .b(new_n68_), .O(new_n78_));
