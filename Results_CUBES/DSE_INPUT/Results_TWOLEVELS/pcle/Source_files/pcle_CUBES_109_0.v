// Benchmark "FAU" written by ABC on Mon Jul  6 13:56:46 2020
...
module FAU ( 
  ...
  nand3  g53(.a(x14), .b(x13), .c(x12), .O(new_n82_));
  nand3  g54(.a(x17), .b(x16), .c(x15), .O(new_n83_));
  oai21  g55(.a(new_n83_), .b(new_n82_), .c(x18), .O(new_n84_));
  and2   g56(.a(x16), .b(x15), .O(new_n85_));
  inv1   g57(.a(new_n82_), .O(new_n86_));
  nor2   g58(.a(x18), .b(new_n76_), .O(new_n87_));
  nand3  g59(.a(new_n87_), .b(new_n86_), .c(new_n85_), .O(new_n88_));
  nand3  g60(.a(new_n88_), .b(new_n84_), .c(x11), .O(new_n89_));
