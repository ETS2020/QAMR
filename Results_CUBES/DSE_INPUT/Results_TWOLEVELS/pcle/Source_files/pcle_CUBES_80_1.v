...
module FAU ( 
  ...
  oai22  g28(.a(new_n56_), .b(new_n50_), .c(new_n55_), .d(new_n38_), .O(new_n57_));
  ...
  nand4  g35(.a(new_n61_), .b(x14), .c(x13), .d(x11), .O(new_n64_));
  ...
  nor2   g42(.a(new_n70_), .b(x16), .O(new_n71_));
  aoi22  g43(.a(new_n71_), .b(new_n55_), .c(new_n69_), .d(x16), .O(new_n72_));
  nand2  g44(.a(x08), .b(x05), .O(new_n73_));
  oai21  g45(.a(new_n72_), .b(new_n47_), .c(new_n73_), .O(z6));
  oai21  g46(.a(new_n62_), .b(new_n29_), .c(x17), .O(new_n75_));
  inv1   g47(.a(x17), .O(new_n76_));
  nand3  g48(.a(new_n63_), .b(new_n30_), .c(new_n76_), .O(new_n77_));
  nand2  g49(.a(new_n77_), .b(new_n75_), .O(new_n78_));
  nand2  g50(.a(new_n78_), .b(new_n54_), .O(new_n79_));
  nand2  g51(.a(x08), .b(x06), .O(new_n80_));
  nand2  g52(.a(new_n80_), .b(new_n79_), .O(z7));
  nand3  g53(.a(x17), .b(x16), .c(x15), .O(new_n82_));
  oai21  g54(.a(new_n82_), .b(new_n62_), .c(x18), .O(new_n83_));
  inv1   g55(.a(x18), .O(new_n84_));
  nand4  g56(.a(new_n84_), .b(x17), .c(x16), .d(x15), .O(new_n85_));
  oai21  g57(.a(new_n85_), .b(new_n62_), .c(new_n83_), .O(new_n86_));
  nand2  g58(.a(new_n86_), .b(new_n54_), .O(new_n87_));
