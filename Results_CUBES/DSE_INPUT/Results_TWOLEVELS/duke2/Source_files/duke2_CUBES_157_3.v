// Benchmark "FAU" written by ABC on Mon Jul  6 13:59:57 2020
...
module FAU ( 
  ...
  nand4  g231(.a(new_n159_), .b(new_n72_), .c(x07), .d(new_n52_), .O(new_n283_));
  nor2   g232(.a(new_n283_), .b(new_n117_), .O(z11));
  oai21  g233(.a(new_n77_), .b(new_n80_), .c(new_n210_), .O(new_n285_));
  nand2  g234(.a(new_n285_), .b(new_n86_), .O(new_n286_));
  nand3  g235(.a(new_n200_), .b(new_n232_), .c(x08), .O(new_n287_));
  ...
  inv1   g258(.a(new_n156_), .O(new_n310_));
  ...
  nand3  g263(.a(new_n162_), .b(new_n246_), .c(x07), .O(new_n315_));
  aoi21  g264(.a(new_n315_), .b(new_n314_), .c(new_n310_), .O(new_n316_));
  nor2   g265(.a(x21), .b(x15), .O(new_n317_));
  nand4  g266(.a(new_n317_), .b(new_n66_), .c(new_n232_), .d(x04), .O(new_n318_));
  ...
  oai21  g270(.a(new_n321_), .b(new_n316_), .c(new_n159_), .O(new_n322_));
  aoi21  g271(.a(new_n54_), .b(new_n53_), .c(new_n159_), .O(new_n323_));
  ...
  nand2  g279(.a(new_n156_), .b(new_n159_), .O(new_n331_));
  oai21  g280(.a(new_n187_), .b(new_n177_), .c(x02), .O(new_n332_));
  nor2   g281(.a(x16), .b(new_n65_), .O(new_n333_));
  oai21  g282(.a(new_n74_), .b(new_n87_), .c(new_n333_), .O(new_n334_));
  aoi21  g283(.a(new_n334_), .b(new_n332_), .c(new_n80_), .O(new_n335_));
  inv1   g284(.a(new_n74_), .O(new_n336_));
  nand3  g285(.a(x16), .b(x12), .c(new_n80_), .O(new_n337_));
  aoi22  g286(.a(new_n337_), .b(new_n84_), .c(new_n336_), .d(x13), .O(new_n338_));
  nor3   g287(.a(x21), .b(x14), .c(x09), .O(new_n339_));
  oai21  g288(.a(new_n338_), .b(new_n335_), .c(new_n339_), .O(new_n340_));
  nand2  g289(.a(new_n246_), .b(x09), .O(new_n341_));
  ...
  nand3  g296(.a(new_n160_), .b(new_n347_), .c(x09), .O(new_n348_));
  aoi21  g297(.a(new_n348_), .b(new_n346_), .c(new_n331_), .O(z16));
  inv1   g298(.a(new_n219_), .O(new_n350_));
  nand2  g299(.a(new_n176_), .b(new_n80_), .O(new_n351_));
  oai21  g300(.a(new_n125_), .b(new_n75_), .c(new_n351_), .O(new_n352_));
  ...
  nand4  g305(.a(new_n223_), .b(new_n109_), .c(x15), .d(new_n73_), .O(new_n357_));
  ...
  inv1   g312(.a(new_n191_), .O(new_n364_));
  ...
  nand3  g318(.a(new_n369_), .b(new_n150_), .c(x18), .O(new_n370_));
  aoi21  g319(.a(new_n368_), .b(new_n367_), .c(new_n370_), .O(z18));
  inv1   g320(.a(new_n150_), .O(new_n372_));
  nor2   g321(.a(new_n329_), .b(new_n372_), .O(z19));
  inv1   g322(.a(new_n294_), .O(new_n374_));
  nand2  g323(.a(new_n360_), .b(new_n232_), .O(new_n375_));
  oai21  g324(.a(new_n375_), .b(new_n199_), .c(new_n234_), .O(new_n376_));
  aoi21  g325(.a(new_n376_), .b(new_n52_), .c(new_n130_), .O(new_n377_));
  nand2  g326(.a(new_n177_), .b(new_n54_), .O(new_n378_));
  oai21  g327(.a(new_n378_), .b(new_n377_), .c(new_n374_), .O(new_n379_));
  nor4   g328(.a(new_n234_), .b(new_n178_), .c(new_n134_), .d(x14), .O(new_n380_));
  aoi21  g329(.a(new_n379_), .b(new_n143_), .c(new_n380_), .O(new_n381_));
  nor2   g330(.a(new_n65_), .b(x05), .O(new_n382_));
  nand4  g331(.a(new_n382_), .b(new_n260_), .c(new_n67_), .d(x04), .O(new_n383_));
  ...
  nand4  g335(.a(new_n386_), .b(new_n177_), .c(new_n130_), .d(x09), .O(new_n387_));
  ...
  nand2  g339(.a(new_n390_), .b(new_n271_), .O(new_n391_));
  nand3  g340(.a(new_n172_), .b(x08), .c(x06), .O(new_n392_));
  aoi21  g341(.a(new_n392_), .b(new_n391_), .c(x05), .O(new_n393_));
  inv1   g342(.a(new_n136_), .O(new_n394_));
  ...
  nand2  g348(.a(new_n172_), .b(x08), .O(new_n400_));
  aoi21  g349(.a(new_n400_), .b(new_n399_), .c(x05), .O(new_n401_));
  oai21  g350(.a(new_n401_), .b(new_n395_), .c(new_n53_), .O(new_n402_));
  nand2  g351(.a(new_n303_), .b(new_n119_), .O(new_n403_));
  aoi21  g352(.a(new_n403_), .b(new_n402_), .c(new_n198_), .O(z22));
  nor3   g353(.a(new_n281_), .b(new_n372_), .c(new_n72_), .O(z23));
  inv1   g354(.a(new_n369_), .O(new_n406_));
  nand3  g355(.a(new_n130_), .b(x18), .c(new_n65_), .O(new_n407_));
  nand3  g356(.a(new_n382_), .b(new_n99_), .c(new_n232_), .O(new_n408_));
  ...
  oai21  g363(.a(new_n414_), .b(new_n410_), .c(new_n143_), .O(new_n415_));
  ...
  nand4  g367(.a(new_n303_), .b(new_n116_), .c(new_n99_), .d(x08), .O(new_n419_));
  aoi21  g368(.a(new_n419_), .b(new_n418_), .c(new_n406_), .O(z24));
  nand2  g369(.a(new_n390_), .b(new_n86_), .O(new_n421_));
  nand2  g370(.a(new_n168_), .b(new_n150_), .O(new_n422_));
  aoi21  g371(.a(new_n421_), .b(new_n400_), .c(new_n422_), .O(z25));
  nor2   g372(.a(new_n89_), .b(x20), .O(z26));
  inv1   g373(.a(new_n76_), .O(new_n425_));
  nand2  g374(.a(new_n133_), .b(new_n81_), .O(new_n426_));
  nor2   g375(.a(new_n426_), .b(new_n425_), .O(new_n427_));
  oai21  g376(.a(new_n427_), .b(new_n294_), .c(new_n143_), .O(new_n428_));
  nand3  g377(.a(new_n136_), .b(x19), .c(new_n54_), .O(new_n429_));
  aoi21  g378(.a(new_n429_), .b(new_n428_), .c(x07), .O(new_n430_));
  nor4   g379(.a(new_n161_), .b(new_n246_), .c(new_n86_), .d(new_n53_), .O(new_n431_));
  ...
  nand4  g388(.a(new_n439_), .b(new_n276_), .c(new_n172_), .d(new_n106_), .O(new_n440_));
  nand2  g389(.a(new_n440_), .b(new_n437_), .O(z27));
  nand3  g390(.a(new_n261_), .b(new_n143_), .c(x11), .O(new_n442_));
  ...
  nand4  g397(.a(new_n448_), .b(new_n446_), .c(new_n261_), .d(new_n180_), .O(new_n449_));
  aoi21  g398(.a(new_n449_), .b(new_n445_), .c(x05), .O(new_n450_));
  nand4  g399(.a(new_n255_), .b(new_n107_), .c(new_n54_), .d(x12), .O(new_n451_));
  nand2  g400(.a(new_n390_), .b(x21), .O(new_n452_));
  aoi21  g401(.a(new_n452_), .b(new_n451_), .c(x07), .O(new_n453_));
  oai21  g402(.a(new_n453_), .b(new_n450_), .c(x08), .O(new_n454_));
  nor3   g403(.a(new_n212_), .b(new_n447_), .c(new_n143_), .O(new_n455_));
  nor2   g404(.a(x19), .b(new_n54_), .O(new_n456_));
  nand3  g405(.a(new_n150_), .b(new_n72_), .c(new_n86_), .O(new_n457_));
  ...
  nand2  g409(.a(new_n390_), .b(new_n99_), .O(new_n461_));
  oai21  g410(.a(new_n73_), .b(new_n75_), .c(new_n303_), .O(new_n462_));
  nor2   g411(.a(new_n462_), .b(new_n461_), .O(new_n463_));
  oai21  g412(.a(new_n463_), .b(new_n460_), .c(new_n159_), .O(new_n464_));
  oai21  g413(.a(new_n246_), .b(new_n53_), .c(new_n153_), .O(new_n465_));
  nand2  g414(.a(new_n465_), .b(new_n328_), .O(new_n466_));
  nand2  g415(.a(new_n466_), .b(new_n307_), .O(new_n467_));
