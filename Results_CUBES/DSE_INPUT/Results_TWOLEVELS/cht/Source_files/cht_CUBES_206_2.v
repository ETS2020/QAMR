// Benchmark "FAU" written by ABC on Mon Jul  6 13:19:37 2020
...
module FAU ( 
  ...
  nand2  g093(.a(new_n175_), .b(x40), .O(new_n177_));
  nand2  g094(.a(x41), .b(x09), .O(new_n178_));
  ...
  aoi21  g099(.a(new_n182_), .b(new_n180_), .c(x10), .O(z30));
  nand2  g100(.a(new_n175_), .b(x42), .O(new_n184_));
  nand2  g101(.a(new_n181_), .b(x43), .O(new_n185_));
  aoi21  g102(.a(new_n185_), .b(new_n184_), .c(x10), .O(z31));
  nand2  g103(.a(new_n175_), .b(x43), .O(new_n187_));
  nand2  g104(.a(new_n181_), .b(x44), .O(new_n188_));
  aoi21  g105(.a(new_n188_), .b(new_n187_), .c(x10), .O(z32));
  nand2  g106(.a(new_n175_), .b(x44), .O(new_n190_));
  nand2  g107(.a(new_n181_), .b(x45), .O(new_n191_));
  aoi21  g108(.a(new_n191_), .b(new_n190_), .c(x10), .O(z33));
  nand2  g109(.a(new_n175_), .b(x45), .O(new_n193_));
  nand2  g110(.a(new_n181_), .b(x46), .O(new_n194_));
  aoi21  g111(.a(new_n194_), .b(new_n193_), .c(x10), .O(z34));
  nand2  g112(.a(new_n175_), .b(x46), .O(new_n196_));
  nand2  g113(.a(new_n181_), .b(x00), .O(new_n197_));
