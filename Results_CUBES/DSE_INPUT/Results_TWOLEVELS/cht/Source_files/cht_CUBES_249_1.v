...
module FAU ( 
  ...
  inv1   g111(.a(x10), .O(new_n195_));
  nand2  g112(.a(x45), .b(new_n195_), .O(new_n196_));
  nor2   g113(.a(new_n196_), .b(new_n177_), .O(z34));
  nand4  g114(.a(new_n174_), .b(new_n195_), .c(x09), .d(x00), .O(new_n198_));
