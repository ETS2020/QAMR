// Benchmark "FAU" written by ABC on Tue Jul  7 07:47:26 2020
...
module FAU ( 
  ...
  nand3  g072(.a(new_n228_), .b(x085), .c(x053), .O(new_n229_));
  ...
  nand2  g082(.a(x061), .b(new_n224_), .O(new_n239_));
  ...
  nand2  g096(.a(x093), .b(x029), .O(new_n253_));
