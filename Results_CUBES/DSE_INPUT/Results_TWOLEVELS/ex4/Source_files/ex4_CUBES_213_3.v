...
module FAU ( 
  ...
  aoi21  g068(.a(x061), .b(new_n224_), .c(x093), .O(new_n225_));
  aoi22  g069(.a(new_n225_), .b(x021), .c(x117), .d(x109), .O(new_n226_));
  inv1   g070(.a(x021), .O(new_n227_));
  nand2  g071(.a(x125), .b(x101), .O(new_n228_));
  oai21  g072(.a(x021), .b(x013), .c(new_n228_), .O(new_n229_));
  oai22  g073(.a(new_n229_), .b(new_n225_), .c(x069), .d(new_n227_), .O(new_n230_));
  oai21  g074(.a(new_n230_), .b(new_n226_), .c(x085), .O(new_n231_));
  inv1   g075(.a(x005), .O(new_n232_));
  nand2  g076(.a(x061), .b(x037), .O(new_n233_));
  nand2  g077(.a(x093), .b(x069), .O(new_n234_));
  aoi22  g078(.a(new_n234_), .b(new_n233_), .c(x125), .d(x101), .O(new_n235_));
  nor2   g079(.a(x021), .b(x013), .O(new_n236_));
  nand2  g080(.a(new_n236_), .b(x085), .O(new_n237_));
  oai21  g081(.a(new_n237_), .b(new_n235_), .c(new_n232_), .O(new_n238_));
  aoi21  g082(.a(new_n238_), .b(new_n231_), .c(new_n223_), .O(new_n239_));
  inv1   g083(.a(x037), .O(new_n240_));
  nand3  g084(.a(new_n236_), .b(x093), .c(x061), .O(new_n241_));
  nand3  g085(.a(new_n241_), .b(x085), .c(new_n240_), .O(new_n242_));
  inv1   g086(.a(x069), .O(new_n243_));
  nand3  g087(.a(new_n243_), .b(x037), .c(new_n227_), .O(new_n244_));
  nand2  g088(.a(new_n244_), .b(new_n242_), .O(new_n245_));
  oai21  g089(.a(new_n245_), .b(new_n239_), .c(x077), .O(new_n246_));
  nand2  g090(.a(x117), .b(x109), .O(new_n247_));
  nand3  g091(.a(new_n247_), .b(x085), .c(x053), .O(new_n248_));
  aoi21  g092(.a(new_n248_), .b(x077), .c(x013), .O(new_n249_));
  inv1   g093(.a(x013), .O(new_n250_));
  nand3  g094(.a(new_n243_), .b(x053), .c(new_n227_), .O(new_n251_));
  inv1   g095(.a(x085), .O(new_n252_));
  nand3  g096(.a(new_n252_), .b(x037), .c(new_n232_), .O(new_n253_));
  aoi21  g097(.a(new_n253_), .b(new_n251_), .c(new_n250_), .O(new_n254_));
  nor2   g098(.a(x053), .b(x037), .O(new_n255_));
  nor3   g099(.a(new_n255_), .b(new_n254_), .c(new_n249_), .O(new_n256_));
  aoi21  g100(.a(new_n256_), .b(new_n246_), .c(new_n222_), .O(z05));
  ...
  inv1   g231(.a(x077), .O(new_n389_));
  inv1   g232(.a(x125), .O(new_n390_));
  oai21  g233(.a(new_n390_), .b(x117), .c(new_n224_), .O(new_n391_));
  inv1   g234(.a(x061), .O(new_n392_));
  nand3  g235(.a(x125), .b(x093), .c(new_n392_), .O(new_n393_));
  nand2  g236(.a(x029), .b(new_n250_), .O(new_n394_));
  nand3  g237(.a(new_n394_), .b(new_n393_), .c(new_n252_), .O(new_n395_));
  aoi21  g238(.a(new_n391_), .b(new_n227_), .c(new_n395_), .O(new_n396_));
  nor2   g239(.a(new_n396_), .b(new_n232_), .O(new_n397_));
  inv1   g240(.a(x109), .O(new_n398_));
  inv1   g241(.a(x117), .O(new_n399_));
  nand2  g242(.a(new_n399_), .b(new_n398_), .O(new_n400_));
  aoi21  g243(.a(x069), .b(x037), .c(new_n232_), .O(new_n401_));
  aoi21  g244(.a(new_n224_), .b(new_n227_), .c(x085), .O(new_n402_));
  oai21  g245(.a(new_n402_), .b(new_n401_), .c(new_n400_), .O(new_n403_));
  nand3  g246(.a(new_n252_), .b(x069), .c(x029), .O(new_n404_));
  nand3  g247(.a(x101), .b(new_n392_), .c(x005), .O(new_n405_));
  nand2  g248(.a(new_n405_), .b(new_n404_), .O(new_n406_));
  nand2  g249(.a(new_n406_), .b(new_n240_), .O(new_n407_));
  inv1   g250(.a(x093), .O(new_n408_));
  nand2  g251(.a(new_n408_), .b(new_n392_), .O(new_n409_));
  nand2  g252(.a(x021), .b(x013), .O(new_n410_));
  nand2  g253(.a(new_n410_), .b(x005), .O(new_n411_));
  oai21  g254(.a(x085), .b(new_n243_), .c(new_n411_), .O(new_n412_));
  nand2  g255(.a(new_n412_), .b(new_n409_), .O(new_n413_));
  nand3  g256(.a(new_n410_), .b(new_n252_), .c(x029), .O(new_n414_));
  nand3  g257(.a(new_n408_), .b(new_n243_), .c(x005), .O(new_n415_));
  nand2  g258(.a(new_n415_), .b(new_n414_), .O(new_n416_));
  oai21  g259(.a(x125), .b(x101), .c(new_n416_), .O(new_n417_));
  nand4  g260(.a(new_n417_), .b(new_n413_), .c(new_n407_), .d(new_n403_), .O(new_n418_));
  oai21  g261(.a(new_n418_), .b(new_n397_), .c(new_n223_), .O(new_n419_));
  nand3  g262(.a(x125), .b(new_n398_), .c(x005), .O(new_n420_));
  oai21  g263(.a(x085), .b(new_n224_), .c(new_n420_), .O(new_n421_));
  nand2  g264(.a(new_n421_), .b(new_n250_), .O(new_n422_));
  nor2   g265(.a(new_n224_), .b(x021), .O(new_n423_));
  oai21  g266(.a(new_n423_), .b(new_n409_), .c(new_n252_), .O(new_n424_));
  nand2  g267(.a(new_n424_), .b(new_n422_), .O(new_n425_));
  nor2   g268(.a(x037), .b(new_n227_), .O(new_n426_));
  aoi22  g269(.a(new_n426_), .b(x069), .c(new_n425_), .d(x037), .O(new_n427_));
  nand2  g270(.a(new_n427_), .b(new_n419_), .O(new_n428_));
  nand2  g271(.a(new_n428_), .b(new_n389_), .O(new_n429_));
  nand3  g272(.a(new_n400_), .b(new_n252_), .c(new_n223_), .O(new_n430_));
  aoi21  g273(.a(new_n430_), .b(new_n389_), .c(new_n250_), .O(new_n431_));
  nand3  g274(.a(x069), .b(new_n223_), .c(x021), .O(new_n432_));
  nand3  g275(.a(x085), .b(new_n240_), .c(x005), .O(new_n433_));
  aoi21  g276(.a(new_n433_), .b(new_n432_), .c(x013), .O(new_n434_));
  nor2   g277(.a(new_n223_), .b(new_n240_), .O(new_n435_));
  nor3   g278(.a(new_n435_), .b(new_n434_), .c(new_n431_), .O(new_n436_));
  aoi21  g279(.a(new_n436_), .b(new_n429_), .c(x045), .O(z13));
  inv1   g280(.a(x102), .O(new_n438_));
  nand2  g281(.a(new_n275_), .b(new_n438_), .O(new_n439_));
  nand2  g282(.a(new_n439_), .b(new_n297_), .O(new_n440_));
  ...
  oai21  g286(.a(new_n298_), .b(x030), .c(new_n443_), .O(new_n444_));
  nor2   g287(.a(x118), .b(x022), .O(new_n445_));
  aoi21  g288(.a(new_n445_), .b(x126), .c(x086), .O(new_n446_));
  oai21  g289(.a(new_n275_), .b(x110), .c(x038), .O(new_n447_));
  nand2  g290(.a(new_n447_), .b(x118), .O(new_n448_));
  oai21  g291(.a(new_n438_), .b(x062), .c(new_n264_), .O(new_n449_));
  nand2  g292(.a(new_n449_), .b(new_n278_), .O(new_n450_));
  nand4  g293(.a(new_n450_), .b(new_n448_), .c(new_n446_), .d(new_n444_), .O(new_n451_));
  oai21  g294(.a(new_n451_), .b(new_n442_), .c(new_n294_), .O(new_n452_));
  nand4  g295(.a(x126), .b(new_n281_), .c(new_n278_), .d(x014), .O(new_n453_));
  aoi21  g296(.a(new_n453_), .b(new_n452_), .c(x054), .O(new_n454_));
  nand3  g297(.a(x086), .b(new_n278_), .c(new_n269_), .O(new_n455_));
  inv1   g298(.a(new_n455_), .O(new_n456_));
  oai21  g299(.a(new_n456_), .b(new_n454_), .c(x006), .O(new_n457_));
  nand2  g300(.a(new_n272_), .b(x030), .O(new_n458_));
  nand2  g301(.a(new_n458_), .b(new_n270_), .O(new_n459_));
  nand2  g302(.a(new_n459_), .b(new_n294_), .O(new_n460_));
  aoi21  g303(.a(new_n460_), .b(new_n269_), .c(new_n441_), .O(new_n461_));
  nor2   g304(.a(new_n268_), .b(x022), .O(new_n462_));
  oai21  g305(.a(new_n462_), .b(new_n298_), .c(x070), .O(new_n463_));
  nand4  g306(.a(new_n443_), .b(new_n439_), .c(new_n272_), .d(x030), .O(new_n464_));
  aoi21  g307(.a(new_n464_), .b(new_n463_), .c(x078), .O(new_n465_));
  oai21  g308(.a(new_n465_), .b(new_n461_), .c(new_n260_), .O(new_n466_));
  nand2  g309(.a(new_n443_), .b(x030), .O(new_n467_));
  nand2  g310(.a(new_n467_), .b(new_n290_), .O(new_n468_));
  nand3  g311(.a(new_n468_), .b(new_n294_), .c(x038), .O(new_n469_));
  ...
  aoi21  g317(.a(new_n470_), .b(new_n274_), .c(new_n474_), .O(new_n475_));
