...
module FAU ( 
  ...
  nor2   g50(.a(x18), .b(new_n96_), .O(new_n97_));
  aoi21  g51(.a(x18), .b(x03), .c(new_n97_), .O(new_n98_));
  aoi21  g52(.a(new_n93_), .b(new_n72_), .c(new_n57_), .O(new_n99_));
  ...
  nand4  g70(.a(new_n116_), .b(new_n100_), .c(new_n74_), .d(new_n51_), .O(new_n117_));
  ...
  nand4  g80(.a(new_n126_), .b(new_n125_), .c(new_n93_), .d(new_n74_), .O(new_n127_));
  ...
  nand4  g90(.a(new_n136_), .b(new_n135_), .c(new_n93_), .d(new_n74_), .O(new_n137_));
  nand2  g91(.a(new_n137_), .b(new_n134_), .O(new_n138_));
  nand2  g92(.a(new_n138_), .b(x16), .O(new_n139_));
  nand2  g93(.a(new_n139_), .b(new_n133_), .O(z16));
  nor2   g94(.a(new_n48_), .b(x17), .O(new_n141_));
  nand4  g95(.a(new_n141_), .b(new_n135_), .c(new_n116_), .d(new_n93_), .O(new_n142_));
