...
module FAU ( 
  ...
  nand2  g49(.a(new_n74_), .b(new_n51_), .O(new_n96_));
  nand4  g50(.a(new_n57_), .b(new_n51_), .c(new_n48_), .d(new_n72_), .O(new_n97_));
  ...
  aoi22  g59(.a(new_n105_), .b(new_n84_), .c(new_n97_), .d(x23), .O(new_n106_));
