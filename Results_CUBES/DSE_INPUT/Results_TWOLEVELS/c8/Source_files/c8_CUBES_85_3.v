...
module FAU ( 
  ...
  nand2  g038(.a(new_n54_), .b(x19), .O(new_n85_));
  nor2   g039(.a(x20), .b(x17), .O(new_n86_));
  nor2   g040(.a(new_n74_), .b(new_n51_), .O(new_n87_));
  aoi21  g041(.a(new_n86_), .b(new_n85_), .c(new_n87_), .O(new_n88_));
  oai21  g042(.a(new_n88_), .b(new_n80_), .c(new_n84_), .O(z10));
  inv1   g043(.a(x10), .O(new_n90_));
  nor2   g044(.a(x18), .b(new_n90_), .O(new_n91_));
  aoi21  g045(.a(x18), .b(x02), .c(new_n91_), .O(new_n92_));
  nor2   g046(.a(new_n86_), .b(new_n54_), .O(new_n93_));
  ...
  aoi22  g057(.a(new_n103_), .b(new_n102_), .c(new_n94_), .d(x22), .O(new_n104_));
  oai21  g058(.a(new_n104_), .b(new_n80_), .c(new_n101_), .O(z12));
  ...
  nand3  g063(.a(new_n102_), .b(new_n74_), .c(new_n51_), .O(new_n110_));
  nor3   g064(.a(x23), .b(x22), .c(x21), .O(new_n111_));
  aoi22  g065(.a(new_n111_), .b(new_n103_), .c(new_n110_), .d(x23), .O(new_n112_));
  oai21  g066(.a(new_n112_), .b(new_n80_), .c(new_n109_), .O(z13));
  ...
  aoi21  g071(.a(new_n111_), .b(new_n103_), .c(new_n63_), .O(new_n118_));
  ...
  nand4  g095(.a(new_n141_), .b(new_n140_), .c(new_n135_), .d(new_n74_), .O(new_n142_));
  nand2  g096(.a(new_n142_), .b(new_n139_), .O(new_n143_));
  nand2  g097(.a(new_n143_), .b(x16), .O(new_n144_));
  nand2  g098(.a(new_n144_), .b(new_n134_), .O(z16));
  nor2   g099(.a(x22), .b(new_n48_), .O(new_n146_));
  nand4  g100(.a(new_n146_), .b(new_n140_), .c(new_n119_), .d(new_n86_), .O(new_n147_));
