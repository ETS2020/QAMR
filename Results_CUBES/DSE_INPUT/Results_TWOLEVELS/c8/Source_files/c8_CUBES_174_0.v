...
module FAU ( 
  ...
  aoi21  g53(.a(new_n93_), .b(new_n74_), .c(new_n57_), .O(new_n100_));
  nand3  g54(.a(new_n93_), .b(new_n74_), .c(new_n57_), .O(new_n101_));
  inv1   g55(.a(new_n101_), .O(new_n102_));
  oai21  g56(.a(new_n102_), .b(new_n100_), .c(x16), .O(new_n103_));
  nand2  g57(.a(new_n103_), .b(new_n99_), .O(z12));
  ...
  nor2   g64(.a(x18), .b(new_n63_), .O(new_n111_));
  aoi21  g65(.a(x18), .b(x05), .c(new_n111_), .O(new_n112_));
  nand2  g66(.a(new_n108_), .b(new_n84_), .O(new_n113_));
  nand3  g67(.a(new_n113_), .b(x24), .c(x16), .O(new_n114_));
  oai21  g68(.a(new_n112_), .b(x16), .c(new_n114_), .O(z14));
