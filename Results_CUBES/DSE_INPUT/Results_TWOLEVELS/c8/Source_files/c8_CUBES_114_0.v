...
module FAU ( 
  ...
  aoi22  g55(.a(new_n101_), .b(new_n85_), .c(new_n93_), .d(x22), .O(new_n102_));
  ...
  nand3  g62(.a(new_n60_), .b(new_n57_), .c(new_n54_), .O(new_n109_));
  nor2   g63(.a(new_n109_), .b(new_n84_), .O(new_n110_));
  aoi21  g64(.a(new_n108_), .b(x23), .c(new_n110_), .O(new_n111_));
  ...
  oai21  g73(.a(new_n109_), .b(new_n84_), .c(x24), .O(new_n120_));
  ...
  nand4  g81(.a(new_n118_), .b(new_n101_), .c(new_n74_), .d(new_n51_), .O(new_n128_));
  ...
  nand2  g88(.a(new_n134_), .b(new_n88_), .O(new_n135_));
  nand4  g89(.a(x25), .b(new_n63_), .c(new_n60_), .d(new_n57_), .O(new_n136_));
  inv1   g90(.a(new_n136_), .O(new_n137_));
  aoi22  g91(.a(new_n137_), .b(new_n94_), .c(new_n128_), .d(x26), .O(new_n138_));
  oai21  g92(.a(new_n138_), .b(new_n88_), .c(new_n135_), .O(z16));
