...
module FAU ( 
  ...
  nand4  g53(.a(new_n54_), .b(new_n51_), .c(new_n48_), .d(new_n72_), .O(new_n100_));
  nor3   g54(.a(x22), .b(x21), .c(x20), .O(new_n101_));
  aoi22  g55(.a(new_n101_), .b(new_n74_), .c(new_n100_), .d(x22), .O(new_n102_));
  ...
  nand3  g60(.a(new_n93_), .b(new_n74_), .c(new_n57_), .O(new_n107_));
  ...
  nor2   g69(.a(new_n115_), .b(new_n100_), .O(new_n116_));
  aoi21  g70(.a(new_n93_), .b(new_n74_), .c(new_n63_), .O(new_n117_));
  ...
  oai21  g77(.a(new_n66_), .b(new_n87_), .c(new_n123_), .O(z15));
  inv1   g78(.a(x15), .O(new_n125_));
  nand2  g79(.a(x18), .b(x07), .O(new_n126_));
  oai21  g80(.a(x18), .b(new_n125_), .c(new_n126_), .O(new_n127_));
  nand2  g81(.a(new_n127_), .b(new_n87_), .O(new_n128_));
  oai21  g82(.a(new_n69_), .b(new_n87_), .c(new_n128_), .O(z16));
  nand3  g83(.a(x27), .b(x17), .c(x16), .O(new_n130_));
