// Benchmark "FAU" written by ABC on Mon Jul  6 13:21:09 2020
...
module FAU ( 
  ...
  nand2  g26(.a(x18), .b(x00), .O(new_n73_));
  oai21  g27(.a(x18), .b(new_n47_), .c(new_n73_), .O(new_n74_));
  nand2  g28(.a(new_n74_), .b(new_n72_), .O(new_n75_));
  oai21  g29(.a(x17), .b(new_n72_), .c(new_n75_), .O(z09));
  inv1   g30(.a(x17), .O(new_n77_));
  nor2   g31(.a(new_n51_), .b(new_n77_), .O(new_n78_));
  nor2   g32(.a(x20), .b(x17), .O(new_n79_));
  oai21  g33(.a(new_n79_), .b(new_n78_), .c(x16), .O(new_n80_));
  inv1   g34(.a(x09), .O(new_n81_));
  nor2   g35(.a(x18), .b(new_n81_), .O(new_n82_));
  aoi21  g36(.a(x18), .b(x01), .c(new_n82_), .O(new_n83_));
  oai21  g37(.a(new_n83_), .b(x16), .c(new_n80_), .O(z10));
  inv1   g38(.a(x10), .O(new_n85_));
  nor2   g39(.a(x18), .b(new_n85_), .O(new_n86_));
  aoi21  g40(.a(x18), .b(x02), .c(new_n86_), .O(new_n87_));
  nor2   g41(.a(new_n79_), .b(new_n54_), .O(new_n88_));
  nor3   g42(.a(x21), .b(x20), .c(x17), .O(new_n89_));
  oai21  g43(.a(new_n89_), .b(new_n88_), .c(x16), .O(new_n90_));
  oai21  g44(.a(new_n87_), .b(x16), .c(new_n90_), .O(z11));
  inv1   g45(.a(x11), .O(new_n92_));
  nand2  g46(.a(x18), .b(x03), .O(new_n93_));
  oai21  g47(.a(x18), .b(new_n92_), .c(new_n93_), .O(new_n94_));
  nand2  g48(.a(new_n94_), .b(new_n72_), .O(new_n95_));
  nand2  g49(.a(new_n79_), .b(new_n54_), .O(new_n96_));
  nand4  g50(.a(new_n57_), .b(new_n54_), .c(new_n51_), .d(new_n77_), .O(new_n97_));
  inv1   g51(.a(new_n97_), .O(new_n98_));
  aoi21  g52(.a(new_n96_), .b(x22), .c(new_n98_), .O(new_n99_));
  oai21  g53(.a(new_n99_), .b(new_n72_), .c(new_n95_), .O(z12));
  inv1   g54(.a(x12), .O(new_n101_));
  nand2  g55(.a(x18), .b(x04), .O(new_n102_));
  oai21  g56(.a(x18), .b(new_n101_), .c(new_n102_), .O(new_n103_));
  nand2  g57(.a(new_n103_), .b(new_n72_), .O(new_n104_));
  nor2   g58(.a(x23), .b(x22), .O(new_n105_));
  aoi22  g59(.a(new_n105_), .b(new_n89_), .c(new_n97_), .d(x23), .O(new_n106_));
  oai21  g60(.a(new_n106_), .b(new_n72_), .c(new_n104_), .O(z13));
  ...
  nand3  g65(.a(new_n105_), .b(new_n79_), .c(new_n54_), .O(new_n112_));
  nor3   g66(.a(x24), .b(x23), .c(x22), .O(new_n113_));
  aoi22  g67(.a(new_n113_), .b(new_n89_), .c(new_n112_), .d(x24), .O(new_n114_));
  oai21  g68(.a(new_n114_), .b(new_n72_), .c(new_n111_), .O(z14));
  inv1   g69(.a(x14), .O(new_n116_));
  nand2  g70(.a(x18), .b(x06), .O(new_n117_));
  oai21  g71(.a(x18), .b(new_n116_), .c(new_n117_), .O(new_n118_));
  nand2  g72(.a(new_n118_), .b(new_n72_), .O(new_n119_));
  aoi21  g73(.a(new_n113_), .b(new_n89_), .c(new_n66_), .O(new_n120_));
  nor2   g74(.a(x25), .b(x24), .O(new_n121_));
  nand4  g75(.a(new_n121_), .b(new_n105_), .c(new_n79_), .d(new_n54_), .O(new_n122_));
  ...
  nand2  g82(.a(new_n128_), .b(new_n72_), .O(new_n129_));
  ...
  oai21  g86(.a(new_n132_), .b(new_n72_), .c(new_n129_), .O(z16));
