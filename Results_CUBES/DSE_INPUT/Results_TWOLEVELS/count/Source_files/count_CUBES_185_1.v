...
module FAU ( 
  ...
  nand3  g132(.a(new_n157_), .b(new_n149_), .c(new_n115_), .O(new_n184_));
  inv1   g133(.a(x31), .O(new_n185_));
  nand3  g134(.a(new_n185_), .b(new_n171_), .c(new_n158_), .O(new_n186_));
  nor2   g135(.a(new_n186_), .b(new_n184_), .O(new_n187_));
  nand4  g136(.a(new_n187_), .b(new_n113_), .c(new_n72_), .d(new_n82_), .O(new_n188_));
  nor2   g137(.a(x32), .b(x31), .O(new_n189_));
  nand4  g138(.a(new_n189_), .b(new_n164_), .c(new_n137_), .d(new_n144_), .O(new_n190_));
  ...
  oai21  g143(.a(new_n192_), .b(new_n52_), .c(new_n194_), .O(z13));
  inv1   g144(.a(x32), .O(new_n196_));
  nand3  g145(.a(new_n196_), .b(new_n185_), .c(new_n171_), .O(new_n197_));
  nor2   g146(.a(new_n197_), .b(new_n159_), .O(new_n198_));
  nand4  g147(.a(new_n198_), .b(new_n124_), .c(new_n72_), .d(new_n82_), .O(new_n199_));
  nor2   g148(.a(x33), .b(x32), .O(new_n200_));
  nand4  g149(.a(new_n200_), .b(new_n177_), .c(new_n150_), .d(new_n127_), .O(new_n201_));
  nor2   g150(.a(new_n201_), .b(new_n101_), .O(new_n202_));
  aoi21  g151(.a(new_n199_), .b(x33), .c(new_n202_), .O(new_n203_));
  ...
  oai21  g155(.a(new_n202_), .b(x34), .c(x16), .O(new_n207_));
