...
module FAU ( 
  ...
  inv1   g37(.a(x22), .O(new_n89_));
  nor2   g38(.a(x24), .b(x23), .O(new_n90_));
  nand4  g39(.a(new_n90_), .b(new_n67_), .c(new_n52_), .d(new_n89_), .O(new_n91_));
  oai21  g40(.a(new_n81_), .b(new_n88_), .c(new_n91_), .O(new_n92_));
  ...
  nand3  g47(.a(new_n90_), .b(new_n89_), .c(new_n78_), .O(new_n99_));
  ...
  nand3  g57(.a(new_n97_), .b(new_n79_), .c(new_n108_), .O(new_n109_));
  oai21  g58(.a(new_n109_), .b(new_n72_), .c(new_n107_), .O(new_n110_));
  ...
  nand4  g64(.a(new_n108_), .b(new_n115_), .c(new_n88_), .d(new_n82_), .O(new_n116_));
  inv1   g65(.a(new_n116_), .O(new_n117_));
  nand4  g66(.a(new_n117_), .b(new_n89_), .c(new_n78_), .d(new_n59_), .O(new_n118_));
  inv1   g67(.a(x27), .O(new_n119_));
  nor2   g68(.a(new_n52_), .b(new_n119_), .O(new_n120_));
  aoi21  g69(.a(new_n118_), .b(new_n52_), .c(new_n120_), .O(new_n121_));
  inv1   g70(.a(x07), .O(new_n122_));
  aoi21  g71(.a(new_n56_), .b(new_n122_), .c(x18), .O(new_n123_));
  oai21  g72(.a(new_n121_), .b(new_n56_), .c(new_n123_), .O(z08));
