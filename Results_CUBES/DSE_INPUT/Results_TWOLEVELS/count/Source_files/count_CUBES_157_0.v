...
module FAU ( 
  ...
  nand4  g036(.a(new_n87_), .b(new_n72_), .c(new_n58_), .d(new_n57_), .O(new_n88_));
  ...
  nand4  g044(.a(new_n95_), .b(new_n79_), .c(new_n66_), .d(new_n58_), .O(new_n96_));
  ...
  nand4  g052(.a(new_n103_), .b(new_n79_), .c(new_n66_), .d(new_n58_), .O(new_n104_));
  ...
  nand4  g061(.a(new_n87_), .b(new_n112_), .c(new_n111_), .d(new_n110_), .O(new_n113_));
  ...
  nand4  g068(.a(new_n119_), .b(new_n87_), .c(new_n72_), .d(new_n60_), .O(new_n120_));
  nor2   g069(.a(x28), .b(x27), .O(new_n121_));
  nor2   g070(.a(x26), .b(x23), .O(new_n122_));
  nand3  g071(.a(new_n122_), .b(new_n121_), .c(new_n95_), .O(new_n123_));
  ...
  nand3  g077(.a(new_n79_), .b(new_n66_), .c(new_n58_), .O(new_n129_));
  inv1   g078(.a(new_n129_), .O(new_n130_));
  nand3  g079(.a(new_n111_), .b(new_n110_), .c(new_n86_), .O(new_n131_));
  inv1   g080(.a(x28), .O(new_n132_));
  inv1   g081(.a(x29), .O(new_n133_));
  nand3  g082(.a(new_n133_), .b(new_n132_), .c(new_n112_), .O(new_n134_));
  nor2   g083(.a(new_n134_), .b(new_n131_), .O(new_n135_));
  nand2  g084(.a(new_n135_), .b(new_n130_), .O(new_n136_));
  oai21  g085(.a(new_n123_), .b(new_n77_), .c(x29), .O(new_n137_));
  ...
  nand4  g093(.a(new_n144_), .b(new_n103_), .c(new_n143_), .d(new_n60_), .O(new_n145_));
  ...
  aoi22  g097(.a(new_n148_), .b(new_n81_), .c(new_n145_), .d(x30), .O(new_n149_));
  ...
  nand4  g101(.a(x30), .b(new_n133_), .c(new_n132_), .d(new_n112_), .O(new_n153_));
  nor2   g102(.a(new_n153_), .b(new_n131_), .O(new_n154_));
  aoi22  g103(.a(new_n154_), .b(new_n81_), .c(new_n145_), .d(x31), .O(new_n155_));
