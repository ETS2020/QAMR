...
module FAU ( 
  ...
  nand2  g082(.a(new_n127_), .b(new_n100_), .O(new_n134_));
  inv1   g083(.a(new_n134_), .O(new_n135_));
  nand4  g084(.a(new_n135_), .b(new_n84_), .c(new_n72_), .d(new_n82_), .O(new_n136_));
  nor2   g085(.a(x28), .b(x27), .O(new_n137_));
  nand4  g086(.a(new_n137_), .b(new_n100_), .c(new_n115_), .d(new_n109_), .O(new_n138_));
  nor2   g087(.a(new_n138_), .b(new_n126_), .O(new_n139_));
  aoi21  g088(.a(new_n136_), .b(x28), .c(new_n139_), .O(new_n140_));
  ...
  nand2  g093(.a(new_n137_), .b(new_n144_), .O(new_n145_));
  inv1   g094(.a(new_n145_), .O(new_n146_));
  nand4  g095(.a(new_n146_), .b(new_n92_), .c(new_n72_), .d(new_n82_), .O(new_n147_));
  nand2  g096(.a(new_n84_), .b(new_n60_), .O(new_n148_));
  inv1   g097(.a(x27), .O(new_n149_));
  nor2   g098(.a(x29), .b(x28), .O(new_n150_));
  nand4  g099(.a(new_n150_), .b(new_n144_), .c(new_n149_), .d(new_n110_), .O(new_n151_));
  nor2   g100(.a(new_n151_), .b(new_n148_), .O(new_n152_));
  aoi21  g101(.a(new_n147_), .b(x29), .c(new_n152_), .O(new_n153_));
  ...
  nand3  g107(.a(new_n158_), .b(new_n157_), .c(new_n149_), .O(new_n159_));
  inv1   g108(.a(new_n159_), .O(new_n160_));
  nand3  g109(.a(new_n144_), .b(new_n90_), .c(new_n73_), .O(new_n161_));
  inv1   g110(.a(new_n161_), .O(new_n162_));
  nand4  g111(.a(new_n162_), .b(new_n160_), .c(new_n72_), .d(new_n82_), .O(new_n163_));
  nor2   g112(.a(x30), .b(x29), .O(new_n164_));
  nand4  g113(.a(new_n164_), .b(new_n137_), .c(new_n144_), .d(new_n110_), .O(new_n165_));
  ...
  nand3  g121(.a(new_n157_), .b(new_n149_), .c(new_n115_), .O(new_n173_));
  nor2   g122(.a(new_n173_), .b(new_n172_), .O(new_n174_));
  nand4  g123(.a(new_n174_), .b(new_n113_), .c(new_n72_), .d(new_n82_), .O(new_n175_));
  nand4  g124(.a(new_n90_), .b(new_n73_), .c(new_n72_), .d(new_n82_), .O(new_n176_));
  nor2   g125(.a(x31), .b(x30), .O(new_n177_));
  nand4  g126(.a(new_n177_), .b(new_n150_), .c(new_n127_), .d(new_n111_), .O(new_n178_));
  ...
  oai21  g132(.a(new_n179_), .b(x32), .c(x16), .O(new_n184_));
  inv1   g133(.a(x02), .O(new_n185_));
  aoi21  g134(.a(new_n52_), .b(new_n185_), .c(x18), .O(new_n186_));
  nand2  g135(.a(new_n186_), .b(new_n184_), .O(z13));
  nand3  g136(.a(new_n157_), .b(new_n149_), .c(new_n115_), .O(new_n188_));
  inv1   g137(.a(x31), .O(new_n189_));
  nand3  g138(.a(new_n189_), .b(new_n171_), .c(new_n158_), .O(new_n190_));
  nor2   g139(.a(new_n190_), .b(new_n188_), .O(new_n191_));
  nand4  g140(.a(new_n191_), .b(new_n113_), .c(new_n72_), .d(new_n82_), .O(new_n192_));
  nor2   g141(.a(x33), .b(x31), .O(new_n193_));
  nand4  g142(.a(new_n193_), .b(new_n164_), .c(new_n137_), .d(new_n144_), .O(new_n194_));
  nor2   g143(.a(new_n194_), .b(new_n176_), .O(new_n195_));
  ...
  nand3  g149(.a(new_n200_), .b(new_n189_), .c(new_n171_), .O(new_n201_));
  nor2   g150(.a(new_n201_), .b(new_n159_), .O(new_n202_));
  nand4  g151(.a(new_n202_), .b(new_n124_), .c(new_n72_), .d(new_n82_), .O(new_n203_));
  nor2   g152(.a(x34), .b(x33), .O(new_n204_));
  nand4  g153(.a(new_n204_), .b(new_n177_), .c(new_n150_), .d(new_n127_), .O(new_n205_));
