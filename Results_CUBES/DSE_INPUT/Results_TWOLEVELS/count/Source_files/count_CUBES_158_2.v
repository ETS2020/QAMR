...
module FAU ( 
  ...
  oai21  g087(.a(new_n138_), .b(new_n130_), .c(x28), .O(new_n139_));
  inv1   g088(.a(x26), .O(new_n140_));
  nor2   g089(.a(x28), .b(x27), .O(new_n141_));
  nand2  g090(.a(new_n141_), .b(new_n140_), .O(new_n142_));
  nand3  g091(.a(new_n137_), .b(new_n105_), .c(new_n94_), .O(new_n143_));
  oai21  g092(.a(new_n143_), .b(new_n142_), .c(new_n139_), .O(new_n144_));
  nand2  g093(.a(new_n144_), .b(new_n53_), .O(new_n145_));
  nand3  g094(.a(x28), .b(x19), .c(x16), .O(new_n146_));
  inv1   g095(.a(x06), .O(new_n147_));
  aoi21  g096(.a(new_n58_), .b(new_n147_), .c(x18), .O(new_n148_));
  nand3  g097(.a(new_n148_), .b(new_n146_), .c(new_n145_), .O(z09));
  nand2  g098(.a(new_n141_), .b(new_n118_), .O(new_n150_));
  ...
  nand3  g109(.a(new_n118_), .b(new_n96_), .c(new_n76_), .O(new_n161_));
  nor2   g110(.a(new_n161_), .b(new_n155_), .O(new_n162_));
  nand3  g111(.a(new_n162_), .b(new_n68_), .c(new_n52_), .O(new_n163_));
  nor2   g112(.a(x30), .b(x29), .O(new_n164_));
  nand4  g113(.a(new_n164_), .b(new_n141_), .c(new_n118_), .d(new_n117_), .O(new_n165_));
  ...
  nand2  g121(.a(new_n129_), .b(new_n172_), .O(new_n173_));
  ...
  nand4  g126(.a(new_n177_), .b(new_n154_), .c(new_n129_), .d(new_n128_), .O(new_n178_));
  ...
  nor2   g134(.a(new_n185_), .b(new_n142_), .O(new_n186_));
  nand4  g135(.a(new_n186_), .b(new_n115_), .c(new_n68_), .d(new_n52_), .O(new_n187_));
  nor2   g136(.a(x32), .b(x31), .O(new_n188_));
  nand4  g137(.a(new_n188_), .b(new_n164_), .c(new_n141_), .d(new_n118_), .O(new_n189_));
  ...
  nand4  g146(.a(new_n197_), .b(new_n126_), .c(new_n68_), .d(new_n52_), .O(new_n198_));
  nand2  g147(.a(new_n154_), .b(new_n129_), .O(new_n199_));
  ...
  nand4  g156(.a(new_n207_), .b(new_n126_), .c(new_n68_), .d(new_n52_), .O(new_n208_));
  inv1   g157(.a(x34), .O(new_n209_));
  nand3  g158(.a(new_n200_), .b(new_n177_), .c(new_n209_), .O(new_n210_));
  nor3   g159(.a(new_n210_), .b(new_n199_), .c(new_n106_), .O(new_n211_));
