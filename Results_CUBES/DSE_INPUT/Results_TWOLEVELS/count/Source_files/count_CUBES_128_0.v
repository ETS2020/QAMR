...
module FAU ( 
  ...
  oai21  g035(.a(new_n77_), .b(x19), .c(new_n64_), .O(new_n87_));
  ...
  aoi21  g042(.a(new_n87_), .b(x23), .c(new_n93_), .O(new_n94_));
  oai21  g043(.a(new_n94_), .b(new_n58_), .c(new_n86_), .O(z04));
  oai21  g044(.a(new_n91_), .b(x19), .c(new_n64_), .O(new_n96_));
  ...
  nand4  g058(.a(new_n109_), .b(new_n89_), .c(new_n69_), .d(new_n55_), .O(new_n110_));
  ...
  nand3  g069(.a(new_n120_), .b(new_n89_), .c(new_n71_), .O(new_n121_));
  ...
  nand4  g078(.a(new_n129_), .b(new_n89_), .c(new_n128_), .d(new_n88_), .O(new_n130_));
  ...
  nand4  g090(.a(new_n134_), .b(new_n109_), .c(new_n89_), .d(new_n88_), .O(new_n142_));
  ...
  oai22  g104(.a(new_n155_), .b(new_n92_), .c(new_n153_), .d(new_n151_), .O(new_n156_));
