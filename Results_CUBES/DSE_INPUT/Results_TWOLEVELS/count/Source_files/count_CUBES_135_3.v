...
module FAU ( 
  ...
  nand3  g041(.a(new_n92_), .b(new_n57_), .c(new_n65_), .O(new_n93_));
  ...
  aoi21  g048(.a(x24), .b(x19), .c(new_n99_), .O(new_n100_));
  oai21  g049(.a(new_n97_), .b(new_n52_), .c(new_n100_), .O(z05));
  nand3  g050(.a(new_n96_), .b(new_n66_), .c(new_n65_), .O(new_n102_));
