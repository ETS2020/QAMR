...
module FAU ( 
  ...
  nand3  g091(.a(new_n135_), .b(new_n110_), .c(new_n90_), .O(new_n143_));
  aoi21  g092(.a(new_n143_), .b(new_n53_), .c(new_n63_), .O(new_n144_));
  inv1   g093(.a(new_n134_), .O(new_n145_));
  nand2  g094(.a(new_n110_), .b(new_n118_), .O(new_n146_));
  ...
  oai21  g101(.a(new_n144_), .b(new_n142_), .c(new_n152_), .O(z09));
  inv1   g102(.a(x29), .O(new_n154_));
  nand4  g103(.a(new_n147_), .b(new_n130_), .c(new_n98_), .d(new_n77_), .O(new_n155_));
  ...
  nand2  g113(.a(new_n157_), .b(new_n128_), .O(new_n165_));
  nand3  g114(.a(new_n130_), .b(new_n98_), .c(new_n77_), .O(new_n166_));
  ...
  nand3  g118(.a(new_n169_), .b(new_n147_), .c(new_n121_), .O(new_n170_));
  ...
  oai21  g126(.a(new_n177_), .b(new_n119_), .c(new_n53_), .O(new_n178_));
  aoi21  g127(.a(new_n178_), .b(new_n64_), .c(new_n176_), .O(new_n179_));
  nor2   g128(.a(x31), .b(x30), .O(new_n180_));
  nand4  g129(.a(new_n180_), .b(new_n157_), .c(new_n135_), .d(new_n107_), .O(new_n181_));
  ...
  nand4  g136(.a(new_n180_), .b(new_n147_), .c(new_n154_), .d(new_n117_), .O(new_n188_));
  oai21  g137(.a(new_n188_), .b(new_n119_), .c(new_n53_), .O(new_n189_));
  ...
  oai21  g148(.a(new_n199_), .b(new_n131_), .c(new_n53_), .O(new_n200_));
  aoi21  g149(.a(new_n200_), .b(new_n64_), .c(new_n198_), .O(new_n201_));
  ...
  nand4  g159(.a(new_n203_), .b(new_n180_), .c(new_n157_), .d(new_n128_), .O(new_n211_));
  oai21  g160(.a(new_n211_), .b(new_n131_), .c(new_n53_), .O(new_n212_));
  aoi21  g161(.a(new_n212_), .b(new_n64_), .c(new_n210_), .O(new_n213_));
  nand3  g162(.a(new_n203_), .b(new_n180_), .c(new_n210_), .O(new_n214_));
  nor3   g163(.a(new_n214_), .b(new_n202_), .c(new_n111_), .O(new_n215_));
