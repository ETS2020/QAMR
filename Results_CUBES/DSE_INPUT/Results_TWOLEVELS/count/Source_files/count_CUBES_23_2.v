...
module FAU ( 
  ...
  nand2  g011(.a(new_n61_), .b(new_n53_), .O(new_n63_));
  nor2   g012(.a(new_n63_), .b(x17), .O(new_n64_));
  ...
  and2   g030(.a(new_n70_), .b(x22), .O(new_n82_));
  ...
  nor2   g039(.a(new_n90_), .b(new_n70_), .O(new_n91_));
  ...
  oai21  g045(.a(new_n96_), .b(x19), .c(new_n64_), .O(new_n97_));
  ...
  nand2  g057(.a(new_n108_), .b(new_n89_), .O(new_n109_));
  ...
  aoi21  g066(.a(new_n117_), .b(new_n53_), .c(new_n70_), .O(new_n118_));
  ...
  oai21  g078(.a(new_n129_), .b(new_n90_), .c(new_n53_), .O(new_n130_));
  ...
  oai21  g091(.a(new_n142_), .b(new_n90_), .c(new_n53_), .O(new_n143_));
  aoi21  g092(.a(new_n143_), .b(new_n64_), .c(new_n140_), .O(new_n144_));
  nand2  g093(.a(new_n108_), .b(new_n116_), .O(new_n145_));
  nor2   g094(.a(x28), .b(x27), .O(new_n146_));
  nand2  g095(.a(new_n146_), .b(new_n115_), .O(new_n147_));
  nor3   g096(.a(new_n147_), .b(new_n132_), .c(new_n145_), .O(new_n148_));
  ...
  nand4  g102(.a(new_n146_), .b(new_n128_), .c(new_n98_), .d(new_n79_), .O(new_n154_));
  aoi21  g103(.a(new_n154_), .b(new_n53_), .c(new_n70_), .O(new_n155_));
  nor3   g104(.a(x29), .b(x28), .c(x27), .O(new_n156_));
  nand4  g105(.a(new_n156_), .b(new_n119_), .c(new_n96_), .d(new_n64_), .O(new_n157_));
  ...
  nand2  g113(.a(new_n164_), .b(new_n126_), .O(new_n165_));
  nand3  g114(.a(new_n128_), .b(new_n98_), .c(new_n79_), .O(new_n166_));
  oai21  g115(.a(new_n166_), .b(new_n165_), .c(new_n53_), .O(new_n167_));
  aoi21  g116(.a(new_n167_), .b(new_n64_), .c(new_n163_), .O(new_n168_));
  nor2   g117(.a(x30), .b(x29), .O(new_n169_));
  nand2  g118(.a(new_n169_), .b(new_n146_), .O(new_n170_));
  nor2   g119(.a(new_n170_), .b(new_n129_), .O(new_n171_));
  and2   g120(.a(new_n171_), .b(new_n91_), .O(new_n172_));
  ...
  nand3  g126(.a(new_n169_), .b(new_n141_), .c(new_n140_), .O(new_n178_));
  ...
  nand2  g130(.a(new_n181_), .b(new_n64_), .O(new_n182_));
  nor2   g131(.a(x31), .b(x30), .O(new_n183_));
  nand3  g132(.a(new_n183_), .b(new_n164_), .c(new_n133_), .O(new_n184_));
  ...
  nor2   g139(.a(new_n63_), .b(x31), .O(new_n191_));
  aoi21  g140(.a(new_n191_), .b(new_n179_), .c(new_n190_), .O(new_n192_));
  nand4  g141(.a(new_n108_), .b(new_n89_), .c(new_n71_), .d(new_n53_), .O(new_n193_));
  nor2   g142(.a(x32), .b(x31), .O(new_n194_));
  nand4  g143(.a(new_n194_), .b(new_n169_), .c(new_n146_), .d(new_n115_), .O(new_n195_));
  ...
  nor2   g150(.a(new_n195_), .b(new_n193_), .O(new_n202_));
  nor2   g151(.a(new_n202_), .b(new_n201_), .O(new_n203_));
  nor2   g152(.a(x33), .b(x32), .O(new_n204_));
  nand4  g153(.a(new_n204_), .b(new_n183_), .c(new_n164_), .d(new_n141_), .O(new_n205_));
  nor2   g154(.a(new_n205_), .b(new_n193_), .O(new_n206_));
  ...
  oai21  g159(.a(new_n205_), .b(new_n193_), .c(x34), .O(new_n211_));
  nor2   g160(.a(x34), .b(x33), .O(new_n212_));
  nand2  g161(.a(new_n212_), .b(new_n69_), .O(new_n213_));
  nor2   g162(.a(new_n213_), .b(new_n170_), .O(new_n214_));
  nand4  g163(.a(new_n214_), .b(new_n194_), .c(new_n128_), .d(new_n181_), .O(new_n215_));
