...
module FAU ( 
  ...
  oai21  g031(.a(new_n78_), .b(x23), .c(x16), .O(new_n83_));
  inv1   g032(.a(x11), .O(new_n84_));
  aoi21  g033(.a(new_n58_), .b(new_n84_), .c(x18), .O(new_n85_));
  nand2  g034(.a(new_n85_), .b(new_n83_), .O(z04));
  nor3   g035(.a(x24), .b(x22), .c(x21), .O(new_n87_));
  aoi22  g036(.a(new_n87_), .b(new_n63_), .c(new_n77_), .d(x24), .O(new_n88_));
  ...
  aoi21  g041(.a(new_n87_), .b(new_n63_), .c(new_n92_), .O(new_n93_));
  nor2   g042(.a(x25), .b(x24), .O(new_n94_));
  nand4  g043(.a(new_n94_), .b(new_n76_), .c(new_n55_), .d(new_n61_), .O(new_n95_));
  ...
  aoi22  g054(.a(new_n105_), .b(new_n71_), .c(new_n95_), .d(x26), .O(new_n106_));
  ...
  nand3  g061(.a(new_n112_), .b(new_n111_), .c(new_n71_), .O(new_n113_));
  ...
  nand4  g075(.a(new_n126_), .b(new_n94_), .c(new_n76_), .d(new_n63_), .O(new_n127_));
  ...
  oai21  g085(.a(new_n131_), .b(new_n77_), .c(x30), .O(new_n137_));
  nor3   g086(.a(x30), .b(x29), .c(x28), .O(new_n138_));
  nand4  g087(.a(new_n138_), .b(new_n112_), .c(new_n87_), .d(new_n63_), .O(new_n139_));
  ...
  nand4  g093(.a(new_n111_), .b(new_n55_), .c(new_n69_), .d(new_n61_), .O(new_n145_));
  ...
  oai21  g101(.a(new_n150_), .b(new_n58_), .c(new_n152_), .O(z12));
  oai21  g102(.a(new_n148_), .b(new_n145_), .c(x32), .O(new_n154_));
  nand4  g103(.a(new_n92_), .b(new_n102_), .c(new_n101_), .d(new_n69_), .O(new_n155_));
  ...
  nand4  g111(.a(new_n162_), .b(new_n126_), .c(new_n156_), .d(new_n63_), .O(new_n163_));
  ...
  nand4  g127(.a(new_n178_), .b(new_n175_), .c(new_n156_), .d(new_n63_), .O(new_n179_));
  ...
  nand4  g139(.a(new_n190_), .b(new_n162_), .c(new_n105_), .d(new_n71_), .O(new_n191_));
