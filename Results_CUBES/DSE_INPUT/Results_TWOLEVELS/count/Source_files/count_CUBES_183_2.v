...
module FAU ( 
  ...
  nand2  g012(.a(new_n63_), .b(new_n60_), .O(z01));
  ...
  oai21  g020(.a(new_n69_), .b(new_n62_), .c(new_n71_), .O(z02));
  ...
  aoi21  g029(.a(new_n62_), .b(new_n80_), .c(x18), .O(new_n81_));
  ...
  aoi22  g045(.a(new_n96_), .b(new_n59_), .c(new_n93_), .d(x24), .O(new_n97_));
  inv1   g046(.a(x10), .O(new_n98_));
  aoi21  g047(.a(new_n62_), .b(new_n98_), .c(x18), .O(new_n99_));
  oai21  g048(.a(new_n97_), .b(new_n62_), .c(new_n99_), .O(z05));
  ...
  nand4  g052(.a(new_n103_), .b(new_n85_), .c(new_n68_), .d(new_n54_), .O(new_n104_));
  ...
  nand3  g066(.a(new_n85_), .b(new_n68_), .c(new_n54_), .O(new_n118_));
  ...
  oai21  g071(.a(new_n120_), .b(new_n62_), .c(new_n122_), .O(z07));
  nor2   g072(.a(new_n117_), .b(new_n86_), .O(new_n124_));
  nand3  g073(.a(new_n124_), .b(new_n66_), .c(new_n65_), .O(new_n125_));
  nand3  g074(.a(new_n74_), .b(new_n54_), .c(new_n57_), .O(new_n126_));
  ...
  aoi21  g092(.a(new_n62_), .b(new_n143_), .c(x18), .O(new_n144_));
  oai21  g093(.a(new_n142_), .b(new_n62_), .c(new_n144_), .O(z09));
  ...
  oai21  g104(.a(new_n153_), .b(new_n62_), .c(new_n155_), .O(z10));
  ...
  nand3  g120(.a(new_n94_), .b(new_n74_), .c(new_n59_), .O(new_n172_));
  ...
  oai21  g127(.a(new_n176_), .b(new_n62_), .c(new_n178_), .O(z12));
  ...
  oai21  g138(.a(new_n187_), .b(new_n62_), .c(new_n189_), .O(z13));
  ...
  oai21  g150(.a(new_n199_), .b(new_n62_), .c(new_n201_), .O(z14));
  ...
  oai21  g159(.a(new_n208_), .b(new_n62_), .c(new_n210_), .O(z15));
endmodule
