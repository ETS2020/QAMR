...
module FAU ( 
  ...
  nand2  g112(.a(new_n155_), .b(new_n128_), .O(new_n164_));
  nand3  g113(.a(new_n130_), .b(new_n98_), .c(new_n77_), .O(new_n165_));
  ...
  nand3  g117(.a(new_n168_), .b(new_n145_), .c(new_n121_), .O(new_n169_));
  nor2   g118(.a(new_n169_), .b(new_n91_), .O(new_n170_));
  oai21  g119(.a(new_n170_), .b(new_n167_), .c(x16), .O(new_n171_));
  nand2  g120(.a(new_n171_), .b(new_n162_), .O(z11));
  inv1   g121(.a(x31), .O(new_n173_));
  nand3  g122(.a(new_n168_), .b(new_n135_), .c(new_n142_), .O(new_n174_));
  ...
  nand4  g126(.a(new_n177_), .b(new_n155_), .c(new_n135_), .d(new_n107_), .O(new_n178_));
  ...
  nand4  g133(.a(new_n177_), .b(new_n145_), .c(new_n152_), .d(new_n117_), .O(new_n185_));
  ...
  nand4  g137(.a(new_n188_), .b(new_n168_), .c(new_n145_), .d(new_n130_), .O(new_n189_));
  ...
  nand4  g144(.a(new_n188_), .b(new_n155_), .c(new_n163_), .d(new_n128_), .O(new_n196_));
  oai21  g145(.a(new_n196_), .b(new_n131_), .c(new_n53_), .O(new_n197_));
  aoi21  g146(.a(new_n197_), .b(new_n64_), .c(new_n195_), .O(new_n198_));
  nand2  g147(.a(new_n155_), .b(new_n135_), .O(new_n199_));
  ...
  nand4  g156(.a(new_n200_), .b(new_n177_), .c(new_n155_), .d(new_n128_), .O(new_n208_));
