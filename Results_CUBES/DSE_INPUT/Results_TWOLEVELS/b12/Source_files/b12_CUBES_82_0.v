// Benchmark "FAU" written by ABC on Mon Jul  6 13:26:35 2020
...
module FAU ( 
  ...
  nand4  g30(.a(new_n54_), .b(x13), .c(new_n41_), .d(new_n40_), .O(z5));
  nand2  g31(.a(new_n41_), .b(new_n40_), .O(new_n56_));
  aoi21  g32(.a(x09), .b(new_n27_), .c(new_n39_), .O(new_n57_));
  oai21  g33(.a(new_n57_), .b(new_n36_), .c(new_n45_), .O(new_n58_));
  aoi21  g34(.a(x14), .b(x01), .c(new_n27_), .O(new_n59_));
  aoi21  g35(.a(x09), .b(new_n26_), .c(x02), .O(new_n60_));
  oai21  g36(.a(new_n60_), .b(new_n59_), .c(new_n39_), .O(new_n61_));
  aoi21  g37(.a(new_n61_), .b(new_n58_), .c(new_n56_), .O(z6));
  inv1   g38(.a(x09), .O(new_n63_));
  nand4  g39(.a(new_n41_), .b(new_n45_), .c(new_n40_), .d(x01), .O(new_n64_));
  oai21  g40(.a(new_n63_), .b(x01), .c(new_n64_), .O(new_n65_));
  nand2  g41(.a(new_n65_), .b(new_n27_), .O(new_n66_));
  nor2   g42(.a(x07), .b(new_n27_), .O(new_n67_));
  aoi21  g43(.a(new_n67_), .b(new_n45_), .c(new_n56_), .O(new_n68_));
  nand2  g44(.a(new_n68_), .b(new_n66_), .O(z7));
  nor2   g45(.a(x10), .b(x09), .O(new_n70_));
  aoi21  g46(.a(new_n70_), .b(new_n40_), .c(x02), .O(new_n71_));
  inv1   g47(.a(x12), .O(new_n72_));
  nand3  g48(.a(new_n72_), .b(new_n27_), .c(new_n26_), .O(new_n73_));
  aoi21  g49(.a(new_n73_), .b(x09), .c(new_n56_), .O(new_n74_));
  oai21  g50(.a(new_n71_), .b(x00), .c(new_n74_), .O(z8));
endmodule
