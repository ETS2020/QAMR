...
module FAU ( 
  ...
  nand2  g33(.a(new_n57_), .b(x11), .O(new_n58_));
  nand2  g34(.a(new_n58_), .b(x00), .O(new_n59_));
  inv1   g35(.a(x11), .O(new_n60_));
  inv1   g36(.a(x12), .O(new_n61_));
  oai21  g37(.a(new_n60_), .b(new_n40_), .c(new_n61_), .O(new_n62_));
  nand2  g38(.a(new_n62_), .b(new_n59_), .O(z3));
  inv1   g39(.a(x00), .O(new_n64_));
  nand2  g40(.a(new_n58_), .b(new_n64_), .O(new_n65_));
  inv1   g41(.a(x08), .O(new_n66_));
  oai21  g42(.a(new_n66_), .b(x07), .c(new_n60_), .O(new_n67_));
  inv1   g43(.a(new_n57_), .O(new_n68_));
  nand2  g44(.a(new_n68_), .b(x00), .O(new_n69_));
  nand3  g45(.a(new_n69_), .b(new_n67_), .c(new_n65_), .O(z4));
  inv1   g46(.a(new_n45_), .O(new_n71_));
  inv1   g47(.a(x13), .O(new_n72_));
  nand2  g48(.a(new_n72_), .b(new_n40_), .O(new_n73_));
  nand4  g49(.a(new_n73_), .b(new_n59_), .c(new_n71_), .d(new_n61_), .O(z5));
  oai21  g50(.a(new_n56_), .b(x03), .c(new_n30_), .O(new_n75_));
  aoi21  g51(.a(x08), .b(x00), .c(x01), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(new_n75_), .O(new_n77_));
  inv1   g53(.a(x14), .O(new_n78_));
  oai21  g54(.a(x09), .b(new_n34_), .c(new_n25_), .O(new_n79_));
  nand2  g55(.a(new_n30_), .b(new_n64_), .O(new_n80_));
  oai21  g56(.a(x08), .b(new_n64_), .c(new_n80_), .O(new_n81_));
  nor2   g57(.a(new_n25_), .b(x00), .O(new_n82_));
  aoi22  g58(.a(new_n82_), .b(new_n78_), .c(new_n81_), .d(new_n79_), .O(new_n83_));
  aoi21  g59(.a(new_n83_), .b(new_n77_), .c(new_n45_), .O(z6));
  nand3  g60(.a(x09), .b(x03), .c(new_n30_), .O(new_n85_));
  nand4  g61(.a(new_n41_), .b(new_n66_), .c(new_n40_), .d(x02), .O(new_n86_));
  ...
  aoi21  g65(.a(new_n89_), .b(new_n66_), .c(new_n45_), .O(new_n90_));
  nand2  g66(.a(new_n90_), .b(new_n88_), .O(z7));
  nand2  g67(.a(new_n61_), .b(new_n30_), .O(new_n92_));
  oai21  g68(.a(new_n92_), .b(new_n89_), .c(x09), .O(new_n93_));
  nand2  g69(.a(new_n68_), .b(new_n64_), .O(new_n94_));
  nand3  g70(.a(new_n94_), .b(new_n93_), .c(new_n71_), .O(z8));
endmodule
