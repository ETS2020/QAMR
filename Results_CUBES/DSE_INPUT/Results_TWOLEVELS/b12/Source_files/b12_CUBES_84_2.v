// Benchmark "FAU" written by ABC on Mon Jul  6 13:26:37 2020
...
module FAU ( 
  ...
  oai21  g32(.a(new_n56_), .b(new_n40_), .c(new_n44_), .O(new_n57_));
  ...
  nand2  g36(.a(new_n45_), .b(new_n44_), .O(new_n61_));
  aoi21  g37(.a(x14), .b(x02), .c(x00), .O(new_n62_));
  nor2   g38(.a(x08), .b(new_n40_), .O(new_n63_));
  oai21  g39(.a(new_n63_), .b(new_n62_), .c(x01), .O(new_n64_));
  inv1   g40(.a(x09), .O(new_n65_));
  oai21  g41(.a(new_n65_), .b(x03), .c(new_n30_), .O(new_n66_));
  aoi21  g42(.a(x08), .b(x00), .c(x01), .O(new_n67_));
  nor2   g43(.a(new_n34_), .b(x02), .O(new_n68_));
  aoi22  g44(.a(new_n68_), .b(new_n65_), .c(new_n67_), .d(new_n66_), .O(new_n69_));
  aoi21  g45(.a(new_n69_), .b(new_n64_), .c(new_n61_), .O(z6));
  nand2  g46(.a(new_n68_), .b(x09), .O(new_n71_));
  nand4  g47(.a(new_n45_), .b(new_n56_), .c(new_n44_), .d(x02), .O(new_n72_));
  ...
  aoi21  g51(.a(new_n75_), .b(new_n56_), .c(new_n61_), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(new_n74_), .O(z7));
  inv1   g53(.a(x12), .O(new_n78_));
  nand2  g54(.a(new_n78_), .b(new_n30_), .O(new_n79_));
  oai21  g55(.a(new_n79_), .b(new_n75_), .c(x09), .O(new_n80_));
  aoi21  g56(.a(new_n65_), .b(new_n40_), .c(new_n61_), .O(new_n81_));
