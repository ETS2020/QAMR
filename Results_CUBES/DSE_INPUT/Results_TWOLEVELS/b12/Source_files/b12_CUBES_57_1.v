...
module FAU ( 
  ...
  nand2  g31(.a(new_n50_), .b(x01), .O(new_n56_));
  ...
  aoi21  g41(.a(x14), .b(x02), .c(new_n27_), .O(new_n66_));
  aoi21  g42(.a(new_n35_), .b(new_n25_), .c(x01), .O(new_n67_));
  oai21  g43(.a(new_n67_), .b(new_n66_), .c(new_n54_), .O(new_n68_));
  aoi21  g44(.a(new_n68_), .b(new_n65_), .c(new_n62_), .O(z6));
  oai21  g45(.a(x10), .b(new_n25_), .c(new_n27_), .O(new_n70_));
