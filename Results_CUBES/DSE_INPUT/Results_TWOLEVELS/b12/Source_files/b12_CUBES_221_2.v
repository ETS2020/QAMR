...
module FAU ( 
  ...
  inv1   g44(.a(new_n65_), .O(new_n69_));
  oai21  g45(.a(x09), .b(new_n34_), .c(new_n25_), .O(new_n70_));
  oai22  g46(.a(new_n65_), .b(x02), .c(x08), .d(new_n56_), .O(new_n71_));
  nor2   g47(.a(x14), .b(new_n25_), .O(new_n72_));
  aoi22  g48(.a(new_n72_), .b(new_n69_), .c(new_n71_), .d(new_n70_), .O(new_n73_));
  aoi21  g49(.a(new_n73_), .b(new_n68_), .c(x10), .O(z6));
  nand3  g50(.a(x09), .b(x03), .c(new_n30_), .O(new_n75_));
  nand3  g51(.a(new_n41_), .b(new_n50_), .c(x02), .O(new_n76_));
  ...
  aoi21  g55(.a(new_n79_), .b(new_n50_), .c(new_n45_), .O(new_n80_));
