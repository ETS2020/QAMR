...
module FAU ( 
  ...
  oai22  g39(.a(new_n63_), .b(new_n55_), .c(new_n62_), .d(x01), .O(new_n64_));
  nand2  g40(.a(new_n64_), .b(new_n50_), .O(new_n65_));
  nand2  g41(.a(x09), .b(new_n34_), .O(new_n66_));
  aoi21  g42(.a(new_n66_), .b(new_n30_), .c(x01), .O(new_n67_));
  nand2  g43(.a(x14), .b(x02), .O(new_n68_));
  nand2  g44(.a(new_n68_), .b(x01), .O(new_n69_));
  nand3  g45(.a(new_n62_), .b(x03), .c(new_n30_), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(new_n69_), .O(new_n71_));
  oai21  g47(.a(new_n71_), .b(new_n67_), .c(new_n55_), .O(new_n72_));
  aoi21  g48(.a(new_n72_), .b(new_n65_), .c(new_n45_), .O(z6));
  nand3  g49(.a(new_n63_), .b(x09), .c(x03), .O(new_n74_));
  nand4  g50(.a(new_n74_), .b(new_n41_), .c(x08), .d(new_n40_), .O(z7));
  inv1   g51(.a(x12), .O(new_n76_));
  nand3  g52(.a(new_n63_), .b(new_n76_), .c(x03), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(x09), .O(new_n78_));
  aoi21  g54(.a(new_n62_), .b(new_n55_), .c(new_n45_), .O(new_n79_));
