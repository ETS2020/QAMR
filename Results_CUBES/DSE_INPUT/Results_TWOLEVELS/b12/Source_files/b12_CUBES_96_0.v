...
module FAU ( 
  ...
  aoi21  g41(.a(new_n58_), .b(x03), .c(x01), .O(new_n66_));
  nand3  g42(.a(x09), .b(new_n34_), .c(new_n25_), .O(new_n67_));
  oai21  g43(.a(new_n66_), .b(x02), .c(new_n67_), .O(new_n68_));
  nand2  g44(.a(new_n68_), .b(new_n59_), .O(new_n69_));
  inv1   g45(.a(x14), .O(new_n70_));
  nand2  g46(.a(new_n25_), .b(new_n56_), .O(new_n71_));
  oai21  g47(.a(x08), .b(new_n56_), .c(new_n71_), .O(new_n72_));
  nor2   g48(.a(new_n25_), .b(x00), .O(new_n73_));
  aoi22  g49(.a(new_n73_), .b(new_n70_), .c(new_n72_), .d(x02), .O(new_n74_));
  aoi21  g50(.a(new_n74_), .b(new_n69_), .c(new_n45_), .O(z6));
  nand3  g51(.a(x09), .b(x03), .c(new_n25_), .O(new_n76_));
  inv1   g52(.a(x08), .O(new_n77_));
  nand4  g53(.a(new_n41_), .b(new_n77_), .c(new_n40_), .d(x01), .O(new_n78_));
