// Benchmark "FAU" written by ABC on Mon Jul  6 13:26:30 2020
...
module FAU ( 
  ...
  nor2   g33(.a(x13), .b(x00), .O(new_n58_));
  nand2  g34(.a(x09), .b(x08), .O(new_n59_));
  oai21  g35(.a(new_n59_), .b(new_n58_), .c(new_n40_), .O(new_n60_));
  oai21  g36(.a(x11), .b(new_n40_), .c(new_n60_), .O(z4));
  inv1   g37(.a(x12), .O(new_n62_));
  nor2   g38(.a(new_n58_), .b(x00), .O(new_n63_));
  nand4  g39(.a(new_n63_), .b(new_n62_), .c(new_n41_), .d(new_n40_), .O(z5));
  inv1   g40(.a(x08), .O(new_n65_));
  inv1   g41(.a(x09), .O(new_n66_));
  aoi21  g42(.a(new_n66_), .b(x03), .c(x01), .O(new_n67_));
  nand3  g43(.a(x09), .b(new_n34_), .c(new_n25_), .O(new_n68_));
  oai21  g44(.a(new_n67_), .b(x02), .c(new_n68_), .O(new_n69_));
  oai21  g45(.a(new_n65_), .b(new_n56_), .c(new_n69_), .O(new_n70_));
  inv1   g46(.a(x14), .O(new_n71_));
  nand2  g47(.a(new_n25_), .b(new_n56_), .O(new_n72_));
  oai21  g48(.a(x08), .b(new_n56_), .c(new_n72_), .O(new_n73_));
  nor2   g49(.a(new_n25_), .b(x00), .O(new_n74_));
  aoi22  g50(.a(new_n74_), .b(new_n71_), .c(new_n73_), .d(x02), .O(new_n75_));
  aoi21  g51(.a(new_n75_), .b(new_n70_), .c(new_n45_), .O(z6));
  nand3  g52(.a(x09), .b(x03), .c(new_n25_), .O(new_n77_));
  nand4  g53(.a(new_n41_), .b(new_n65_), .c(new_n40_), .d(x01), .O(new_n78_));
  ...
  aoi21  g57(.a(new_n81_), .b(new_n65_), .c(new_n45_), .O(new_n82_));
  nand2  g58(.a(new_n82_), .b(new_n80_), .O(z7));
  nand4  g59(.a(new_n62_), .b(x03), .c(new_n30_), .d(new_n25_), .O(new_n84_));
  nand2  g60(.a(new_n84_), .b(x09), .O(new_n85_));
  aoi21  g61(.a(new_n66_), .b(new_n56_), .c(new_n45_), .O(new_n86_));
