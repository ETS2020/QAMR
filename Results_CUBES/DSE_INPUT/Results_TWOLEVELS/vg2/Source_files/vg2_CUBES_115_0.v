...
module FAU ( 
  ...
  oai21  g078(.a(new_n43_), .b(new_n110_), .c(new_n111_), .O(new_n112_));
  ...
  nand2  g107(.a(new_n140_), .b(x16), .O(new_n141_));
  aoi21  g108(.a(new_n141_), .b(x08), .c(new_n54_), .O(new_n142_));
  aoi21  g109(.a(new_n75_), .b(x04), .c(x17), .O(new_n143_));
  oai21  g110(.a(new_n143_), .b(x22), .c(new_n100_), .O(new_n144_));
  nand2  g111(.a(new_n144_), .b(new_n72_), .O(new_n145_));
  aoi21  g112(.a(new_n145_), .b(new_n130_), .c(new_n65_), .O(new_n146_));
  nor2   g113(.a(new_n56_), .b(x24), .O(new_n147_));
  oai21  g114(.a(new_n146_), .b(new_n142_), .c(new_n147_), .O(new_n148_));
  aoi21  g115(.a(new_n140_), .b(x16), .c(new_n130_), .O(new_n149_));
  nand2  g116(.a(x08), .b(x07), .O(new_n150_));
  oai21  g117(.a(new_n149_), .b(new_n110_), .c(new_n150_), .O(new_n151_));
  nand2  g118(.a(new_n151_), .b(new_n95_), .O(new_n152_));
  inv1   g119(.a(new_n38_), .O(new_n153_));
  oai21  g120(.a(new_n55_), .b(x24), .c(new_n153_), .O(new_n154_));
  aoi21  g121(.a(new_n141_), .b(x08), .c(new_n53_), .O(new_n155_));
  aoi21  g122(.a(new_n145_), .b(new_n130_), .c(new_n66_), .O(new_n156_));
  oai21  g123(.a(new_n156_), .b(new_n155_), .c(new_n154_), .O(new_n157_));
  nand3  g124(.a(new_n157_), .b(new_n152_), .c(new_n148_), .O(z4));
  ...
  nand2  g129(.a(new_n118_), .b(new_n113_), .O(z7));
  nand2  g130(.a(new_n102_), .b(x14), .O(new_n164_));
