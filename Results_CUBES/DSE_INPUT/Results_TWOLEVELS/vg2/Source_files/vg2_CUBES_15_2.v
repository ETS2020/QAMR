...
module FAU ( 
  ...
  aoi21  g120(.a(new_n134_), .b(x17), .c(x09), .O(new_n154_));
  oai21  g121(.a(new_n154_), .b(x16), .c(new_n139_), .O(new_n155_));
  nand2  g122(.a(new_n155_), .b(x19), .O(new_n156_));
  oai21  g123(.a(new_n153_), .b(new_n53_), .c(new_n156_), .O(new_n157_));
  nand2  g124(.a(new_n157_), .b(new_n152_), .O(new_n158_));
  nand3  g125(.a(new_n158_), .b(new_n150_), .c(new_n147_), .O(z4));
  inv1   g126(.a(x03), .O(new_n160_));
  aoi21  g127(.a(x20), .b(new_n46_), .c(x06), .O(new_n161_));
  oai21  g128(.a(new_n161_), .b(x11), .c(new_n160_), .O(new_n162_));
  nand2  g129(.a(new_n162_), .b(z5), .O(new_n163_));
  nand2  g130(.a(new_n108_), .b(new_n103_), .O(z7));
  nand2  g131(.a(new_n47_), .b(x14), .O(new_n165_));
  aoi21  g132(.a(new_n165_), .b(x06), .c(new_n89_), .O(new_n166_));
  oai21  g133(.a(new_n166_), .b(new_n160_), .c(z7), .O(new_n167_));
  nand2  g134(.a(new_n167_), .b(new_n163_), .O(z6));
endmodule
