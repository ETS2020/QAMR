...
module FAU ( 
  ...
  nand4  g054(.a(x23), .b(x20), .c(x14), .d(x12), .O(new_n88_));
  ...
  nand4  g064(.a(new_n97_), .b(new_n49_), .c(new_n71_), .d(new_n96_), .O(new_n98_));
  oai22  g065(.a(new_n98_), .b(new_n95_), .c(new_n90_), .d(new_n87_), .O(new_n99_));
  nor2   g066(.a(new_n39_), .b(new_n36_), .O(new_n100_));
  nand2  g067(.a(new_n100_), .b(new_n99_), .O(new_n101_));
  nand3  g068(.a(x17), .b(x16), .c(x15), .O(new_n102_));
  inv1   g069(.a(new_n102_), .O(new_n103_));
  nand4  g070(.a(new_n103_), .b(new_n89_), .c(new_n86_), .d(new_n84_), .O(new_n104_));
  inv1   g071(.a(x09), .O(new_n105_));
  nand4  g072(.a(new_n73_), .b(new_n72_), .c(new_n48_), .d(new_n105_), .O(new_n106_));
  ...
  nor2   g078(.a(x16), .b(x12), .O(new_n112_));
  nand4  g079(.a(new_n112_), .b(new_n49_), .c(new_n77_), .d(new_n96_), .O(new_n113_));
  oai21  g080(.a(new_n113_), .b(new_n111_), .c(new_n104_), .O(new_n114_));
  nand2  g081(.a(new_n114_), .b(new_n39_), .O(new_n115_));
  nand3  g082(.a(new_n115_), .b(new_n101_), .c(new_n82_), .O(z1));
  ...
  nor2   g094(.a(new_n127_), .b(new_n48_), .O(new_n128_));
  nand4  g095(.a(new_n128_), .b(new_n86_), .c(new_n56_), .d(x20), .O(new_n129_));
  ...
  nand3  g106(.a(new_n49_), .b(new_n127_), .c(new_n48_), .O(new_n140_));
  oai22  g107(.a(new_n140_), .b(new_n109_), .c(new_n139_), .d(new_n85_), .O(new_n141_));
  ...
  oai21  g111(.a(new_n144_), .b(x22), .c(new_n105_), .O(new_n145_));
  aoi21  g112(.a(new_n145_), .b(new_n76_), .c(x08), .O(new_n146_));
  aoi21  g113(.a(x23), .b(new_n96_), .c(new_n77_), .O(new_n147_));
  ...
  oai21  g121(.a(x20), .b(new_n127_), .c(x06), .O(new_n155_));
