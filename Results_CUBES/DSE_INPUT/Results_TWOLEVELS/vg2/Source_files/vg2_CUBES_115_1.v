...
module FAU ( 
  ...
  nand3  g086(.a(new_n54_), .b(new_n35_), .c(x21), .O(new_n120_));
  ...
  nand3  g090(.a(new_n123_), .b(x11), .c(x06), .O(new_n124_));
  nor3   g091(.a(new_n124_), .b(new_n122_), .c(new_n57_), .O(z2));
  ...
  nand2  g110(.a(new_n120_), .b(new_n119_), .O(new_n144_));
  nand2  g111(.a(new_n144_), .b(x16), .O(new_n145_));
  nand4  g112(.a(new_n35_), .b(x16), .c(x15), .d(x13), .O(new_n146_));
  nand2  g113(.a(new_n146_), .b(new_n115_), .O(new_n147_));
  nand2  g114(.a(new_n147_), .b(x05), .O(new_n148_));
  nand3  g115(.a(new_n148_), .b(new_n145_), .c(new_n118_), .O(new_n149_));
  nand2  g116(.a(new_n149_), .b(new_n143_), .O(new_n150_));
  nand2  g117(.a(new_n46_), .b(new_n38_), .O(z5));
  oai21  g118(.a(x23), .b(new_n67_), .c(new_n72_), .O(new_n152_));
  aoi21  g119(.a(new_n152_), .b(new_n73_), .c(x09), .O(new_n153_));
  oai21  g120(.a(new_n153_), .b(x16), .c(new_n107_), .O(new_n154_));
  nand2  g121(.a(new_n154_), .b(z5), .O(new_n155_));
  oai21  g122(.a(new_n121_), .b(new_n117_), .c(new_n107_), .O(new_n156_));
  nand3  g123(.a(new_n156_), .b(new_n155_), .c(new_n150_), .O(z4));
  inv1   g124(.a(x03), .O(new_n158_));
  aoi21  g125(.a(x20), .b(new_n77_), .c(x06), .O(new_n159_));
  oai21  g126(.a(new_n159_), .b(x11), .c(new_n158_), .O(new_n160_));
  nand2  g127(.a(new_n160_), .b(z5), .O(new_n161_));
  nand2  g128(.a(new_n78_), .b(x14), .O(new_n162_));
  aoi21  g129(.a(new_n162_), .b(x06), .c(new_n48_), .O(new_n163_));
  oai22  g130(.a(new_n163_), .b(new_n158_), .c(new_n121_), .d(new_n117_), .O(new_n164_));
  nand2  g131(.a(new_n164_), .b(new_n161_), .O(z6));
  inv1   g132(.a(new_n122_), .O(z7));
endmodule
