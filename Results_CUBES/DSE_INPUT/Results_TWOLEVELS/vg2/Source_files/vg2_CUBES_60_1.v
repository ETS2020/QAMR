...
module FAU ( 
  ...
  nand3  g051(.a(x17), .b(x16), .c(x12), .O(new_n85_));
  ...
  nand4  g060(.a(new_n50_), .b(new_n49_), .c(new_n71_), .d(new_n93_), .O(new_n94_));
  nor2   g061(.a(new_n94_), .b(new_n92_), .O(new_n95_));
  nor2   g062(.a(new_n39_), .b(new_n36_), .O(new_n96_));
  oai21  g063(.a(new_n95_), .b(new_n87_), .c(new_n96_), .O(new_n97_));
  nor2   g064(.a(new_n84_), .b(new_n83_), .O(new_n98_));
  nand3  g065(.a(x20), .b(x17), .c(x15), .O(new_n99_));
  nand4  g066(.a(x23), .b(x22), .c(x16), .d(x12), .O(new_n100_));
  nor2   g067(.a(new_n100_), .b(new_n99_), .O(new_n101_));
  nand2  g068(.a(new_n101_), .b(new_n98_), .O(new_n102_));
  inv1   g069(.a(x09), .O(new_n103_));
  nand4  g070(.a(new_n73_), .b(new_n72_), .c(new_n48_), .d(new_n103_), .O(new_n104_));
  ...
  nand4  g077(.a(new_n110_), .b(new_n49_), .c(new_n71_), .d(new_n93_), .O(new_n111_));
  oai21  g078(.a(new_n111_), .b(new_n109_), .c(new_n102_), .O(new_n112_));
  nand2  g079(.a(new_n112_), .b(new_n39_), .O(new_n113_));
  nand3  g080(.a(new_n113_), .b(new_n97_), .c(new_n82_), .O(z1));
  ...
  nor2   g092(.a(new_n125_), .b(new_n84_), .O(new_n126_));
  ...
  nand3  g100(.a(new_n50_), .b(new_n48_), .c(new_n106_), .O(new_n134_));
  nand3  g101(.a(new_n49_), .b(x07), .c(new_n47_), .O(new_n135_));
  oai22  g102(.a(new_n135_), .b(new_n134_), .c(new_n133_), .d(new_n84_), .O(new_n136_));
  nand4  g103(.a(x20), .b(x15), .c(x14), .d(x11), .O(new_n137_));
  nand3  g104(.a(new_n49_), .b(new_n76_), .c(new_n48_), .O(new_n138_));
  oai22  g105(.a(new_n138_), .b(new_n107_), .c(new_n137_), .d(new_n84_), .O(new_n139_));
  aoi22  g106(.a(new_n139_), .b(new_n39_), .c(new_n136_), .d(new_n96_), .O(new_n140_));
  nand2  g107(.a(new_n140_), .b(new_n132_), .O(z3));
  aoi21  g108(.a(new_n73_), .b(x04), .c(x17), .O(new_n142_));
  oai21  g109(.a(new_n142_), .b(x22), .c(new_n103_), .O(new_n143_));
  aoi21  g110(.a(new_n143_), .b(new_n71_), .c(x08), .O(new_n144_));
  inv1   g111(.a(x17), .O(new_n145_));
  aoi21  g112(.a(x23), .b(new_n93_), .c(new_n145_), .O(new_n146_));
  oai21  g113(.a(new_n146_), .b(new_n72_), .c(x09), .O(new_n147_));
  aoi21  g114(.a(new_n147_), .b(x16), .c(new_n106_), .O(new_n148_));
  ...
  oai22  g122(.a(new_n155_), .b(new_n122_), .c(new_n152_), .d(new_n46_), .O(z6));
  inv1   g123(.a(new_n122_), .O(z7));
endmodule
