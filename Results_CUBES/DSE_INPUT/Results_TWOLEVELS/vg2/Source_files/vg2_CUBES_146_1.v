...
module FAU ( 
  ...
  oai22  g032(.a(new_n65_), .b(new_n64_), .c(new_n53_), .d(new_n63_), .O(new_n66_));
  ...
  nand4  g046(.a(new_n79_), .b(new_n76_), .c(new_n70_), .d(new_n66_), .O(new_n80_));
  ...
  nand4  g058(.a(new_n79_), .b(new_n68_), .c(x07), .d(new_n46_), .O(new_n92_));
  nand3  g059(.a(new_n76_), .b(new_n48_), .c(new_n67_), .O(new_n93_));
  ...
  nor2   g064(.a(new_n97_), .b(new_n59_), .O(new_n98_));
  ...
  oai21  g090(.a(new_n53_), .b(new_n123_), .c(new_n54_), .O(new_n124_));
  nor2   g091(.a(new_n119_), .b(new_n47_), .O(new_n125_));
  nand4  g092(.a(new_n125_), .b(new_n124_), .c(new_n87_), .d(x20), .O(new_n126_));
  nor3   g093(.a(x20), .b(x14), .c(x11), .O(new_n127_));
  nand4  g094(.a(new_n127_), .b(new_n103_), .c(new_n66_), .d(new_n48_), .O(new_n128_));
  ...
  nand3  g103(.a(new_n48_), .b(new_n119_), .c(new_n47_), .O(new_n137_));
  ...
  oai21  g108(.a(new_n141_), .b(x22), .c(new_n100_), .O(new_n142_));
  aoi21  g109(.a(new_n142_), .b(new_n71_), .c(x08), .O(new_n143_));
  nor2   g110(.a(new_n74_), .b(new_n73_), .O(new_n144_));
  nand4  g111(.a(new_n144_), .b(x18), .c(x16), .d(new_n67_), .O(new_n145_));
  oai21  g112(.a(new_n143_), .b(new_n34_), .c(new_n145_), .O(new_n146_));
  nand2  g113(.a(new_n146_), .b(new_n95_), .O(new_n147_));
  inv1   g114(.a(new_n39_), .O(new_n148_));
  oai21  g115(.a(new_n65_), .b(x24), .c(new_n148_), .O(new_n149_));
  nand4  g116(.a(new_n144_), .b(x16), .c(x15), .d(new_n67_), .O(new_n150_));
  oai21  g117(.a(new_n143_), .b(new_n64_), .c(new_n150_), .O(new_n151_));
  nand2  g118(.a(new_n151_), .b(new_n149_), .O(new_n152_));
  nand2  g119(.a(new_n118_), .b(new_n113_), .O(z7));
  aoi21  g120(.a(x22), .b(new_n72_), .c(new_n100_), .O(new_n154_));
  oai21  g121(.a(new_n154_), .b(new_n71_), .c(x08), .O(new_n155_));
  nor2   g122(.a(x17), .b(x04), .O(new_n156_));
  oai21  g123(.a(new_n156_), .b(x22), .c(new_n100_), .O(new_n157_));
  aoi21  g124(.a(new_n157_), .b(new_n71_), .c(x08), .O(new_n158_));
  nand3  g125(.a(new_n144_), .b(x16), .c(new_n67_), .O(new_n159_));
  oai21  g126(.a(new_n158_), .b(new_n63_), .c(new_n159_), .O(new_n160_));
  nor2   g127(.a(new_n53_), .b(x24), .O(new_n161_));
  aoi22  g128(.a(new_n161_), .b(new_n160_), .c(new_n155_), .d(z7), .O(new_n162_));
  nand3  g129(.a(new_n162_), .b(new_n152_), .c(new_n147_), .O(z4));
  ...
  nand2  g134(.a(new_n102_), .b(x14), .O(new_n168_));
  aoi21  g135(.a(new_n168_), .b(x06), .c(new_n47_), .O(new_n169_));
  oai21  g136(.a(new_n169_), .b(new_n167_), .c(z7), .O(new_n170_));
