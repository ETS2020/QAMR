...
module FAU ( 
  ...
  nand4  g059(.a(new_n80_), .b(new_n69_), .c(x07), .d(new_n46_), .O(new_n93_));
  nand3  g060(.a(new_n77_), .b(new_n48_), .c(new_n68_), .O(new_n94_));
  ...
  nand3  g066(.a(new_n99_), .b(new_n88_), .c(new_n85_), .O(new_n100_));
  ...
  nand4  g073(.a(new_n106_), .b(new_n102_), .c(new_n47_), .d(new_n101_), .O(new_n107_));
  ...
  nand4  g093(.a(new_n126_), .b(new_n104_), .c(new_n67_), .d(new_n48_), .O(new_n127_));
  ...
  aoi22  g104(.a(new_n137_), .b(new_n39_), .c(new_n134_), .d(new_n96_), .O(new_n138_));
  nand2  g105(.a(new_n138_), .b(new_n129_), .O(z3));
  aoi21  g106(.a(new_n75_), .b(x04), .c(x17), .O(new_n140_));
  oai21  g107(.a(new_n140_), .b(x22), .c(new_n101_), .O(new_n141_));
  aoi21  g108(.a(new_n141_), .b(new_n72_), .c(x08), .O(new_n142_));
  nor2   g109(.a(new_n75_), .b(new_n74_), .O(new_n143_));
  nand4  g110(.a(new_n143_), .b(x18), .c(x16), .d(new_n68_), .O(new_n144_));
  oai21  g111(.a(new_n142_), .b(new_n34_), .c(new_n144_), .O(new_n145_));
  ...
  nand4  g115(.a(new_n143_), .b(x16), .c(x15), .d(new_n68_), .O(new_n149_));
  oai21  g116(.a(new_n142_), .b(new_n66_), .c(new_n149_), .O(new_n150_));
  nand2  g117(.a(new_n150_), .b(new_n148_), .O(new_n151_));
  inv1   g118(.a(new_n44_), .O(new_n152_));
  nand2  g119(.a(new_n119_), .b(new_n114_), .O(z7));
  nand2  g120(.a(new_n141_), .b(new_n72_), .O(new_n154_));
  nand2  g121(.a(new_n154_), .b(new_n131_), .O(new_n155_));
  aoi21  g122(.a(x22), .b(new_n73_), .c(new_n101_), .O(new_n156_));
  oai21  g123(.a(new_n156_), .b(new_n72_), .c(x08), .O(new_n157_));
  aoi22  g124(.a(new_n157_), .b(z7), .c(new_n155_), .d(new_n152_), .O(new_n158_));
  nand3  g125(.a(new_n158_), .b(new_n151_), .c(new_n146_), .O(z4));
  ...
  nand2  g130(.a(new_n103_), .b(x14), .O(new_n164_));
  aoi21  g131(.a(new_n164_), .b(x06), .c(new_n47_), .O(new_n165_));
  oai21  g132(.a(new_n165_), .b(new_n163_), .c(z7), .O(new_n166_));
