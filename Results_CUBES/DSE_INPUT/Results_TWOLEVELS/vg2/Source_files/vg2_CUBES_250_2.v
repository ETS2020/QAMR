...
module FAU ( 
  ...
  nand3  g079(.a(new_n112_), .b(new_n100_), .c(new_n82_), .O(z1));
  ...
  nand2  g084(.a(new_n37_), .b(x15), .O(new_n118_));
  nand3  g085(.a(x24), .b(x18), .c(x13), .O(new_n119_));
  nand3  g086(.a(new_n42_), .b(new_n41_), .c(new_n40_), .O(new_n120_));
  ...
  nor3   g090(.a(new_n123_), .b(new_n122_), .c(new_n55_), .O(z2));
  nor2   g091(.a(new_n76_), .b(new_n47_), .O(new_n125_));
  nand4  g092(.a(new_n125_), .b(new_n86_), .c(new_n54_), .d(x20), .O(new_n126_));
  nor2   g093(.a(x14), .b(x11), .O(new_n127_));
  nand3  g094(.a(new_n48_), .b(new_n107_), .c(new_n46_), .O(new_n128_));
  inv1   g095(.a(new_n128_), .O(new_n129_));
  nand4  g096(.a(new_n129_), .b(new_n127_), .c(new_n65_), .d(new_n77_), .O(new_n130_));
  ...
  nand3  g100(.a(new_n49_), .b(new_n47_), .c(new_n107_), .O(new_n134_));
  ...
  nand2  g104(.a(new_n127_), .b(new_n48_), .O(new_n138_));
  ...
  aoi21  g112(.a(x23), .b(new_n145_), .c(new_n71_), .O(new_n146_));
  oai21  g113(.a(new_n146_), .b(new_n72_), .c(x09), .O(new_n147_));
  aoi21  g114(.a(new_n147_), .b(x16), .c(new_n107_), .O(new_n148_));
  nand3  g115(.a(new_n62_), .b(new_n42_), .c(x21), .O(new_n149_));
  nand3  g116(.a(new_n149_), .b(new_n119_), .c(new_n118_), .O(new_n150_));
  nor2   g117(.a(new_n150_), .b(new_n117_), .O(new_n151_));
  oai22  g118(.a(new_n151_), .b(new_n148_), .c(new_n144_), .d(new_n45_), .O(z4));
  nand2  g119(.a(new_n36_), .b(x05), .O(new_n153_));
  nand4  g120(.a(new_n43_), .b(new_n39_), .c(new_n38_), .d(new_n153_), .O(z5));
  nor2   g121(.a(new_n53_), .b(x24), .O(new_n155_));
  ...
  nand3  g126(.a(x19), .b(new_n47_), .c(x06), .O(new_n160_));
  oai21  g127(.a(new_n159_), .b(new_n52_), .c(new_n160_), .O(new_n161_));
  nand2  g128(.a(new_n161_), .b(new_n156_), .O(new_n162_));
  inv1   g129(.a(x18), .O(new_n163_));
  nand3  g130(.a(new_n47_), .b(x07), .c(x06), .O(new_n164_));
  oai21  g131(.a(new_n159_), .b(new_n163_), .c(new_n164_), .O(new_n165_));
  nand2  g132(.a(new_n165_), .b(new_n99_), .O(new_n166_));
  nand2  g133(.a(new_n127_), .b(x20), .O(new_n167_));
  nand2  g134(.a(new_n167_), .b(new_n157_), .O(new_n168_));
  nand2  g135(.a(new_n158_), .b(x11), .O(new_n169_));
  aoi21  g136(.a(new_n169_), .b(x03), .c(new_n149_), .O(new_n170_));
  aoi21  g137(.a(new_n168_), .b(z5), .c(new_n170_), .O(new_n171_));
  nand3  g138(.a(new_n171_), .b(new_n166_), .c(new_n162_), .O(z6));
  inv1   g139(.a(new_n151_), .O(z7));
endmodule
