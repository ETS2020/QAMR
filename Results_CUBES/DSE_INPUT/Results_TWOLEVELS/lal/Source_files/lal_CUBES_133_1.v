// Benchmark "FAU" written by ABC on Mon Jul  6 14:41:03 2020
...
module FAU ( 
  ...
  nand3  g21(.a(new_n66_), .b(new_n63_), .c(new_n61_), .O(z01));
  ...
  nand3  g35(.a(new_n54_), .b(new_n52_), .c(new_n80_), .O(new_n81_));
  ...
  nand2  g39(.a(new_n84_), .b(new_n62_), .O(z08));
  nor2   g40(.a(x15), .b(x07), .O(new_n86_));
  nand2  g41(.a(new_n86_), .b(new_n65_), .O(new_n87_));
  inv1   g42(.a(new_n87_), .O(z09));
  nand3  g43(.a(new_n86_), .b(new_n64_), .c(new_n80_), .O(new_n89_));
  inv1   g44(.a(new_n89_), .O(z10));
  xnor2a g45(.a(x18), .b(x17), .O(new_n91_));
  nand2  g46(.a(new_n86_), .b(new_n64_), .O(new_n92_));
  nor2   g47(.a(new_n92_), .b(new_n91_), .O(z11));
  oai21  g48(.a(new_n52_), .b(new_n80_), .c(x19), .O(new_n94_));
  nor2   g49(.a(new_n52_), .b(new_n80_), .O(new_n95_));
  ...
  nand3  g54(.a(new_n95_), .b(new_n50_), .c(x19), .O(new_n100_));
  nand2  g55(.a(new_n86_), .b(new_n64_), .O(new_n101_));
  ...
  nand3  g65(.a(new_n110_), .b(new_n109_), .c(new_n50_), .O(new_n111_));
  nand3  g66(.a(new_n111_), .b(new_n108_), .c(new_n102_), .O(z15));
  nand2  g67(.a(new_n111_), .b(x23), .O(new_n113_));
  nand4  g68(.a(new_n104_), .b(new_n109_), .c(new_n48_), .d(new_n57_), .O(new_n114_));
  nand3  g69(.a(new_n114_), .b(new_n113_), .c(new_n102_), .O(z16));
  nand2  g70(.a(x19), .b(x18), .O(new_n116_));
  nand2  g71(.a(x24), .b(new_n54_), .O(new_n117_));
  inv1   g72(.a(x21), .O(new_n118_));
  nand3  g73(.a(new_n49_), .b(new_n57_), .c(new_n118_), .O(new_n119_));
  oai21  g74(.a(new_n119_), .b(new_n116_), .c(new_n117_), .O(new_n120_));
  aoi21  g75(.a(new_n53_), .b(new_n51_), .c(new_n49_), .O(new_n121_));
  aoi21  g76(.a(new_n120_), .b(x17), .c(new_n121_), .O(new_n122_));
  nand2  g77(.a(new_n58_), .b(x24), .O(new_n123_));
  oai21  g78(.a(new_n122_), .b(x20), .c(new_n123_), .O(new_n124_));
  nand2  g79(.a(new_n124_), .b(new_n48_), .O(new_n125_));
  nand3  g80(.a(new_n48_), .b(new_n50_), .c(x17), .O(new_n126_));
  aoi21  g81(.a(new_n126_), .b(x24), .c(new_n101_), .O(new_n127_));
  nand2  g82(.a(new_n127_), .b(new_n125_), .O(z17));
  inv1   g83(.a(new_n100_), .O(new_n129_));
  nand4  g84(.a(new_n110_), .b(new_n129_), .c(new_n49_), .d(new_n48_), .O(new_n130_));
  nand4  g85(.a(new_n130_), .b(new_n86_), .c(new_n64_), .d(new_n62_), .O(z18));
  buf    g86(.a(x16), .O(z02));
endmodule
