...
module FAU ( 
  ...
  nand4  g49(.a(new_n83_), .b(new_n94_), .c(new_n89_), .d(x19), .O(new_n95_));
  ...
  nand3  g54(.a(new_n99_), .b(new_n94_), .c(new_n89_), .O(new_n100_));
  or2    g55(.a(new_n100_), .b(new_n87_), .O(new_n101_));
  nand3  g56(.a(new_n101_), .b(new_n98_), .c(new_n92_), .O(z15));
  oai21  g57(.a(new_n100_), .b(new_n87_), .c(x23), .O(new_n103_));
  nand2  g58(.a(new_n103_), .b(new_n92_), .O(z16));
  inv1   g59(.a(x07), .O(new_n105_));
  inv1   g60(.a(x15), .O(new_n106_));
  nand4  g61(.a(new_n53_), .b(new_n49_), .c(new_n106_), .d(new_n105_), .O(z17));
  nand4  g62(.a(new_n53_), .b(new_n69_), .c(new_n106_), .d(new_n105_), .O(z18));
  buf    g63(.a(x16), .O(z02));
endmodule
