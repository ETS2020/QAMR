// Benchmark "FAU" written by ABC on Mon Jul  6 14:40:05 2020
...
module FAU ( 
  ...
  nand2  g13(.a(x22), .b(x18), .O(new_n59_));
  ...
  nand3  g29(.a(new_n50_), .b(x19), .c(x17), .O(new_n75_));
  ...
  or2    g39(.a(x19), .b(x18), .O(new_n85_));
  ...
  nand3  g50(.a(new_n93_), .b(new_n54_), .c(new_n82_), .O(new_n96_));
  inv1   g51(.a(new_n96_), .O(z10));
  xnor2a g52(.a(x19), .b(x17), .O(new_n98_));
  nand2  g53(.a(new_n93_), .b(new_n54_), .O(new_n99_));
  nor2   g54(.a(new_n99_), .b(new_n98_), .O(z12));
  nand2  g55(.a(x19), .b(x17), .O(new_n101_));
  nand2  g56(.a(new_n101_), .b(x20), .O(new_n102_));
  nand4  g57(.a(new_n102_), .b(new_n93_), .c(new_n75_), .d(new_n54_), .O(z13));
  nand2  g58(.a(new_n75_), .b(x21), .O(new_n104_));
  inv1   g59(.a(new_n101_), .O(new_n105_));
  nor2   g60(.a(x21), .b(x20), .O(new_n106_));
  nand2  g61(.a(new_n106_), .b(new_n105_), .O(new_n107_));
  nand2  g62(.a(new_n93_), .b(new_n54_), .O(new_n108_));
  inv1   g63(.a(new_n108_), .O(new_n109_));
  nand3  g64(.a(new_n109_), .b(new_n107_), .c(new_n104_), .O(z14));
  inv1   g65(.a(new_n75_), .O(new_n111_));
  nand3  g66(.a(new_n111_), .b(new_n77_), .c(new_n76_), .O(new_n112_));
  ...
  nand3  g71(.a(new_n116_), .b(new_n111_), .c(new_n76_), .O(new_n117_));
  ...
  nand4  g75(.a(new_n106_), .b(new_n120_), .c(new_n105_), .d(new_n77_), .O(new_n121_));
  nand3  g76(.a(new_n121_), .b(new_n119_), .c(new_n109_), .O(z17));
  oai21  g77(.a(new_n78_), .b(new_n75_), .c(x25), .O(new_n123_));
  nand4  g78(.a(new_n116_), .b(new_n106_), .c(new_n89_), .d(new_n105_), .O(new_n124_));
  nand3  g79(.a(new_n124_), .b(new_n123_), .c(new_n109_), .O(z18));
  buf    g80(.a(x16), .O(z02));
  inv1   g81(.a(new_n96_), .O(z11));
endmodule
