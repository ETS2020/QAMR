...
module FAU ( 
  ...
  nand2  g54(.a(new_n86_), .b(new_n52_), .O(new_n100_));
  inv1   g55(.a(new_n100_), .O(new_n101_));
  nand2  g56(.a(new_n70_), .b(new_n95_), .O(new_n102_));
  nand4  g57(.a(new_n102_), .b(new_n68_), .c(x19), .d(x17), .O(new_n103_));
  ...
  nand2  g61(.a(new_n106_), .b(new_n76_), .O(new_n107_));
  nand3  g62(.a(new_n68_), .b(x19), .c(x17), .O(new_n108_));
  nand2  g63(.a(new_n108_), .b(x21), .O(new_n109_));
  nand3  g64(.a(new_n109_), .b(new_n107_), .c(new_n101_), .O(z14));
  nand2  g65(.a(new_n107_), .b(x22), .O(new_n111_));
  nand3  g66(.a(new_n76_), .b(new_n74_), .c(new_n68_), .O(new_n112_));
  nand3  g67(.a(new_n112_), .b(new_n111_), .c(new_n101_), .O(z15));
  nand2  g68(.a(new_n112_), .b(x23), .O(new_n114_));
  nand4  g69(.a(new_n106_), .b(new_n76_), .c(new_n48_), .d(new_n71_), .O(new_n115_));
  nand3  g70(.a(new_n115_), .b(new_n114_), .c(new_n101_), .O(z16));
  nand2  g71(.a(new_n115_), .b(x24), .O(new_n117_));
  nor2   g72(.a(new_n100_), .b(new_n73_), .O(new_n118_));
  nand2  g73(.a(new_n118_), .b(new_n117_), .O(z17));
  inv1   g74(.a(new_n69_), .O(new_n120_));
  nand4  g75(.a(new_n82_), .b(new_n74_), .c(new_n120_), .d(new_n48_), .O(new_n121_));
  oai21  g76(.a(new_n72_), .b(new_n69_), .c(x25), .O(new_n122_));
  nand3  g77(.a(new_n122_), .b(new_n121_), .c(new_n101_), .O(z18));
  buf    g78(.a(x16), .O(z02));
endmodule
