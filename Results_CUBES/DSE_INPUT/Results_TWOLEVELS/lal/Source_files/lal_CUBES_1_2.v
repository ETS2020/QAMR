...
module FAU ( 
  ...
  nor2   g43(.a(x20), .b(new_n82_), .O(new_n89_));
  nand2  g44(.a(new_n89_), .b(new_n83_), .O(new_n90_));
  nand2  g45(.a(new_n83_), .b(x19), .O(new_n91_));
  ...
  nand4  g49(.a(new_n83_), .b(new_n52_), .c(new_n50_), .d(x19), .O(new_n95_));
  nand3  g50(.a(new_n95_), .b(new_n94_), .c(new_n88_), .O(z14));
  nand2  g51(.a(new_n95_), .b(x22), .O(new_n97_));
  nor2   g52(.a(x22), .b(x21), .O(new_n98_));
  nand2  g53(.a(new_n98_), .b(new_n50_), .O(new_n99_));
  or2    g54(.a(new_n99_), .b(new_n91_), .O(new_n100_));
  nand3  g55(.a(new_n100_), .b(new_n97_), .c(new_n88_), .O(z15));
  oai21  g56(.a(new_n99_), .b(new_n91_), .c(x23), .O(new_n102_));
  nor2   g57(.a(x23), .b(x22), .O(new_n103_));
  nand4  g58(.a(new_n103_), .b(new_n89_), .c(new_n83_), .d(new_n52_), .O(new_n104_));
  nand3  g59(.a(new_n104_), .b(new_n102_), .c(new_n88_), .O(z16));
  nand3  g60(.a(new_n103_), .b(new_n52_), .c(new_n50_), .O(new_n106_));
  oai21  g61(.a(new_n106_), .b(new_n91_), .c(x24), .O(new_n107_));
  inv1   g62(.a(x23), .O(new_n108_));
  inv1   g63(.a(new_n90_), .O(new_n109_));
  nand4  g64(.a(new_n98_), .b(new_n109_), .c(new_n48_), .d(new_n108_), .O(new_n110_));
  nand3  g65(.a(new_n110_), .b(new_n107_), .c(new_n88_), .O(z17));
  nand2  g66(.a(x19), .b(x17), .O(new_n112_));
  nand3  g67(.a(new_n112_), .b(new_n73_), .c(new_n57_), .O(new_n113_));
  nand4  g68(.a(new_n48_), .b(new_n108_), .c(new_n53_), .d(new_n52_), .O(new_n114_));
  ...
  aoi21  g72(.a(new_n50_), .b(x18), .c(new_n49_), .O(new_n118_));
  nor2   g73(.a(new_n118_), .b(new_n87_), .O(new_n119_));
  nand2  g74(.a(new_n119_), .b(new_n117_), .O(z18));
  buf    g75(.a(x16), .O(z02));
endmodule
