...
module FAU ( 
  ...
  wire new_n46_, new_n48_, new_n49_, new_n50_, new_n51_, new_n52_, new_n53_,
    ...
    new_n85_, new_n87_, new_n88_, new_n89_, new_n91_, new_n92_, new_n95_;
  ...
  oai21  g37(.a(new_n82_), .b(new_n76_), .c(x19), .O(new_n83_));
  inv1   g38(.a(x19), .O(new_n84_));
  nand3  g39(.a(new_n84_), .b(x18), .c(x17), .O(new_n85_));
  aoi21  g40(.a(new_n85_), .b(new_n83_), .c(new_n80_), .O(z12));
  nand2  g41(.a(x19), .b(x17), .O(new_n87_));
  aoi21  g42(.a(new_n87_), .b(x18), .c(new_n58_), .O(new_n88_));
  nand2  g43(.a(x20), .b(new_n82_), .O(new_n89_));
  nand3  g44(.a(new_n89_), .b(new_n88_), .c(new_n73_), .O(z13));
  inv1   g45(.a(x15), .O(new_n91_));
  nor2   g46(.a(z09), .b(x07), .O(new_n92_));
  nand3  g47(.a(new_n92_), .b(new_n52_), .c(new_n91_), .O(z14));
  nand3  g48(.a(new_n92_), .b(new_n53_), .c(new_n91_), .O(z15));
  nor2   g49(.a(x23), .b(x15), .O(new_n95_));
  nand2  g50(.a(new_n95_), .b(new_n92_), .O(z16));
  nand3  g51(.a(new_n92_), .b(new_n48_), .c(new_n91_), .O(z17));
  nand3  g52(.a(new_n92_), .b(new_n49_), .c(new_n91_), .O(z18));
  buf    g53(.a(x16), .O(z02));
endmodule
