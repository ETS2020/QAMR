// Benchmark "FAU" written by ABC on Mon Jul  6 14:00:44 2020
...
module FAU ( 
  ...
  oai22  g077(.a(new_n54_), .b(x08), .c(x11), .d(new_n126_), .O(new_n129_));
  oai21  g078(.a(new_n129_), .b(new_n128_), .c(new_n103_), .O(new_n130_));
  aoi21  g079(.a(new_n130_), .b(new_n125_), .c(x05), .O(new_n131_));
  nand2  g080(.a(new_n54_), .b(new_n126_), .O(new_n132_));
  nor2   g081(.a(new_n82_), .b(new_n52_), .O(new_n133_));
  nand3  g082(.a(new_n133_), .b(new_n93_), .c(new_n73_), .O(new_n134_));
  ...
  oai21  g091(.a(new_n142_), .b(new_n135_), .c(new_n53_), .O(new_n143_));
  nand4  g092(.a(new_n133_), .b(x19), .c(new_n54_), .d(x07), .O(new_n144_));
  aoi21  g093(.a(new_n144_), .b(new_n143_), .c(new_n102_), .O(new_n145_));
  oai21  g094(.a(new_n145_), .b(new_n131_), .c(new_n72_), .O(new_n146_));
  nor2   g095(.a(new_n79_), .b(x09), .O(new_n147_));
  ...
  nor2   g107(.a(new_n102_), .b(new_n82_), .O(new_n159_));
  ...
  nor2   g119(.a(new_n102_), .b(x17), .O(new_n171_));
  nand3  g120(.a(new_n171_), .b(new_n54_), .c(new_n82_), .O(new_n172_));
  ...
  nand4  g124(.a(new_n175_), .b(new_n171_), .c(new_n109_), .d(new_n52_), .O(new_n176_));
  oai21  g125(.a(new_n174_), .b(x09), .c(new_n176_), .O(z03));
  nor2   g126(.a(x20), .b(x14), .O(z04));
  nand3  g127(.a(new_n84_), .b(x21), .c(new_n73_), .O(new_n179_));
  nand4  g128(.a(new_n79_), .b(new_n86_), .c(x08), .d(new_n126_), .O(new_n180_));
  aoi21  g129(.a(new_n180_), .b(new_n179_), .c(new_n94_), .O(new_n181_));
  inv1   g130(.a(new_n181_), .O(new_n182_));
  nor2   g131(.a(new_n65_), .b(x04), .O(new_n183_));
  nor2   g132(.a(x12), .b(new_n62_), .O(new_n184_));
  nor2   g133(.a(new_n184_), .b(new_n183_), .O(new_n185_));
  nand2  g134(.a(new_n74_), .b(x06), .O(new_n186_));
  oai21  g135(.a(new_n185_), .b(x06), .c(new_n186_), .O(new_n187_));
  nand3  g136(.a(new_n187_), .b(x21), .c(new_n82_), .O(new_n188_));
  nor2   g137(.a(x17), .b(x15), .O(new_n189_));
  nor2   g138(.a(x14), .b(x09), .O(new_n190_));
  nand4  g139(.a(new_n190_), .b(new_n189_), .c(new_n153_), .d(x18), .O(new_n191_));
  aoi21  g140(.a(new_n188_), .b(new_n182_), .c(new_n191_), .O(z05));
  nand2  g141(.a(new_n137_), .b(x04), .O(new_n193_));
  nand2  g142(.a(new_n193_), .b(new_n186_), .O(new_n194_));
  nor2   g143(.a(new_n80_), .b(x08), .O(new_n195_));
  nand2  g144(.a(new_n86_), .b(new_n126_), .O(new_n196_));
  oai22  g145(.a(new_n196_), .b(new_n94_), .c(new_n87_), .d(new_n75_), .O(new_n197_));
  aoi22  g146(.a(new_n197_), .b(new_n90_), .c(new_n195_), .d(new_n194_), .O(new_n198_));
  oai21  g147(.a(new_n198_), .b(x15), .c(new_n97_), .O(new_n199_));
  nand3  g148(.a(new_n167_), .b(x15), .c(x00), .O(new_n200_));
  inv1   g149(.a(new_n200_), .O(new_n201_));
  aoi21  g150(.a(new_n199_), .b(new_n171_), .c(new_n201_), .O(new_n202_));
  nand3  g151(.a(new_n167_), .b(new_n54_), .c(x07), .O(new_n203_));
  oai21  g152(.a(new_n202_), .b(x07), .c(new_n203_), .O(new_n204_));
  nand2  g153(.a(new_n204_), .b(new_n52_), .O(new_n205_));
  nand3  g154(.a(new_n79_), .b(x18), .c(new_n162_), .O(new_n206_));
  inv1   g155(.a(new_n206_), .O(new_n207_));
  nor2   g156(.a(x15), .b(x12), .O(new_n208_));
  nor2   g157(.a(new_n52_), .b(new_n62_), .O(new_n209_));
  nand4  g158(.a(new_n209_), .b(new_n208_), .c(new_n207_), .d(new_n109_), .O(new_n210_));
  aoi21  g159(.a(new_n210_), .b(new_n205_), .c(x09), .O(z06));
  inv1   g160(.a(new_n171_), .O(new_n212_));
  xnor2a g161(.a(x08), .b(x07), .O(new_n213_));
  nand3  g162(.a(new_n213_), .b(new_n165_), .c(new_n72_), .O(new_n214_));
  nand4  g163(.a(new_n175_), .b(new_n109_), .c(x16), .d(new_n52_), .O(new_n215_));
  aoi21  g164(.a(new_n215_), .b(new_n214_), .c(new_n212_), .O(z07));
  nor2   g165(.a(x20), .b(new_n78_), .O(z08));
  nand2  g166(.a(new_n82_), .b(new_n126_), .O(new_n218_));
  nand3  g167(.a(new_n78_), .b(x08), .c(x02), .O(new_n219_));
  oai21  g168(.a(new_n218_), .b(x05), .c(new_n219_), .O(new_n220_));
  nand2  g169(.a(new_n220_), .b(new_n184_), .O(new_n221_));
  nand3  g170(.a(x11), .b(new_n82_), .c(new_n94_), .O(new_n222_));
  nand4  g171(.a(new_n78_), .b(new_n86_), .c(x08), .d(x02), .O(new_n223_));
  aoi21  g172(.a(new_n223_), .b(new_n222_), .c(new_n126_), .O(new_n224_));
  nand2  g173(.a(x12), .b(x10), .O(new_n225_));
  aoi21  g174(.a(new_n225_), .b(new_n196_), .c(new_n219_), .O(new_n226_));
  oai21  g175(.a(new_n226_), .b(new_n224_), .c(new_n52_), .O(new_n227_));
  aoi21  g176(.a(new_n227_), .b(new_n221_), .c(x21), .O(new_n228_));
  inv1   g177(.a(x19), .O(new_n229_));
  nand2  g178(.a(new_n136_), .b(new_n229_), .O(new_n230_));
  inv1   g179(.a(new_n230_), .O(new_n231_));
  oai21  g180(.a(new_n231_), .b(new_n228_), .c(new_n72_), .O(new_n232_));
  nand3  g181(.a(new_n148_), .b(new_n110_), .c(x08), .O(new_n233_));
  aoi21  g182(.a(new_n233_), .b(new_n232_), .c(x07), .O(new_n234_));
  inv1   g183(.a(new_n133_), .O(new_n235_));
  nor2   g184(.a(new_n235_), .b(new_n66_), .O(new_n236_));
  oai21  g185(.a(new_n236_), .b(new_n234_), .c(new_n54_), .O(new_n237_));
  inv1   g186(.a(new_n147_), .O(new_n238_));
  inv1   g187(.a(new_n76_), .O(new_n239_));
  nand3  g188(.a(new_n156_), .b(new_n238_), .c(new_n239_), .O(new_n240_));
  oai21  g189(.a(new_n238_), .b(new_n52_), .c(new_n240_), .O(new_n241_));
  nand2  g190(.a(new_n241_), .b(new_n109_), .O(new_n242_));
  aoi21  g191(.a(new_n242_), .b(new_n237_), .c(new_n102_), .O(new_n243_));
  ...
  oai21  g196(.a(new_n247_), .b(new_n243_), .c(new_n162_), .O(new_n248_));
  nand2  g197(.a(new_n167_), .b(new_n54_), .O(new_n249_));
  inv1   g198(.a(new_n249_), .O(new_n250_));
  nand2  g199(.a(new_n250_), .b(new_n245_), .O(new_n251_));
  nand2  g200(.a(new_n251_), .b(new_n248_), .O(z09));
  nor3   g201(.a(new_n218_), .b(new_n212_), .c(x15), .O(new_n253_));
  oai21  g202(.a(new_n253_), .b(new_n167_), .c(x05), .O(new_n254_));
  inv1   g203(.a(new_n218_), .O(new_n255_));
  nand2  g204(.a(new_n255_), .b(new_n171_), .O(new_n256_));
  oai21  g205(.a(new_n256_), .b(new_n54_), .c(new_n170_), .O(new_n257_));
  nand2  g206(.a(new_n257_), .b(new_n52_), .O(new_n258_));
  aoi21  g207(.a(new_n258_), .b(new_n254_), .c(x07), .O(new_n259_));
  nor2   g208(.a(new_n121_), .b(x17), .O(new_n260_));
  nand3  g209(.a(new_n260_), .b(new_n133_), .c(new_n54_), .O(new_n261_));
  aoi21  g210(.a(new_n261_), .b(new_n168_), .c(new_n53_), .O(new_n262_));
  oai21  g211(.a(new_n262_), .b(new_n259_), .c(new_n72_), .O(new_n263_));
  aoi22  g212(.a(new_n153_), .b(x09), .c(new_n150_), .d(x05), .O(new_n264_));
  nand2  g213(.a(new_n189_), .b(new_n159_), .O(new_n265_));
  oai21  g214(.a(new_n265_), .b(new_n264_), .c(new_n263_), .O(z10));
  nand4  g215(.a(new_n162_), .b(new_n72_), .c(x07), .d(new_n52_), .O(new_n267_));
  nor2   g216(.a(new_n267_), .b(new_n120_), .O(z11));
  nand3  g217(.a(new_n78_), .b(x11), .c(x10), .O(new_n269_));
  oai21  g218(.a(new_n269_), .b(new_n95_), .c(new_n218_), .O(new_n270_));
  nand2  g219(.a(new_n270_), .b(new_n184_), .O(new_n271_));
  nand3  g220(.a(new_n78_), .b(new_n86_), .c(x08), .O(new_n272_));
  nand2  g221(.a(new_n272_), .b(new_n83_), .O(new_n273_));
  aoi22  g222(.a(new_n273_), .b(new_n74_), .c(new_n84_), .d(new_n239_), .O(new_n274_));
  aoi21  g223(.a(new_n274_), .b(new_n271_), .c(x15), .O(new_n275_));
  nand2  g224(.a(new_n100_), .b(new_n96_), .O(new_n276_));
  inv1   g225(.a(new_n276_), .O(new_n277_));
  oai21  g226(.a(new_n277_), .b(new_n275_), .c(new_n52_), .O(new_n278_));
  nand3  g227(.a(new_n133_), .b(x15), .c(new_n73_), .O(new_n279_));
  nand3  g228(.a(new_n255_), .b(new_n139_), .c(x12), .O(new_n280_));
  aoi21  g229(.a(new_n280_), .b(new_n279_), .c(x04), .O(new_n281_));
  inv1   g230(.a(new_n208_), .O(new_n282_));
  inv1   g231(.a(new_n209_), .O(new_n283_));
  nor3   g232(.a(new_n283_), .b(new_n282_), .c(new_n82_), .O(new_n284_));
  nor2   g233(.a(new_n284_), .b(new_n281_), .O(new_n285_));
  nand2  g234(.a(new_n171_), .b(new_n79_), .O(new_n286_));
  aoi21  g235(.a(new_n285_), .b(new_n278_), .c(new_n286_), .O(new_n287_));
  nor3   g236(.a(new_n168_), .b(new_n54_), .c(new_n58_), .O(new_n288_));
  ...
  inv1   g245(.a(new_n159_), .O(new_n297_));
  nand3  g246(.a(new_n100_), .b(new_n52_), .c(new_n94_), .O(new_n298_));
  oai21  g247(.a(new_n283_), .b(new_n282_), .c(new_n298_), .O(new_n299_));
  aoi21  g248(.a(x21), .b(new_n72_), .c(x07), .O(new_n300_));
  nand2  g249(.a(new_n300_), .b(new_n299_), .O(new_n301_));
  nand3  g250(.a(new_n165_), .b(new_n229_), .c(x07), .O(new_n302_));
  aoi21  g251(.a(new_n302_), .b(new_n301_), .c(new_n297_), .O(new_n303_));
  nor2   g252(.a(x21), .b(x15), .O(new_n304_));
  nand4  g253(.a(new_n304_), .b(new_n66_), .c(new_n78_), .d(x04), .O(new_n305_));
  nor3   g254(.a(x18), .b(x09), .c(x05), .O(new_n306_));
  inv1   g255(.a(new_n306_), .O(new_n307_));
  aoi21  g256(.a(new_n305_), .b(new_n57_), .c(new_n307_), .O(new_n308_));
  oai21  g257(.a(new_n308_), .b(new_n303_), .c(new_n162_), .O(new_n309_));
  aoi21  g258(.a(new_n54_), .b(new_n53_), .c(new_n162_), .O(new_n310_));
  nor2   g259(.a(new_n53_), .b(x01), .O(new_n311_));
  oai21  g260(.a(new_n311_), .b(new_n310_), .c(new_n306_), .O(new_n312_));
  nand2  g261(.a(new_n312_), .b(new_n309_), .O(z14));
  nor2   g262(.a(x07), .b(new_n52_), .O(new_n314_));
  inv1   g263(.a(new_n314_), .O(new_n315_));
  nand3  g264(.a(new_n69_), .b(x17), .c(new_n54_), .O(new_n316_));
  nor2   g265(.a(new_n316_), .b(new_n315_), .O(z15));
  nand2  g266(.a(new_n159_), .b(new_n162_), .O(new_n318_));
  oai21  g267(.a(new_n184_), .b(new_n86_), .c(x02), .O(new_n319_));
  nor2   g268(.a(x16), .b(new_n65_), .O(new_n320_));
  nand2  g269(.a(new_n320_), .b(new_n74_), .O(new_n321_));
  aoi21  g270(.a(new_n321_), .b(new_n319_), .c(new_n126_), .O(new_n322_));
  nand3  g271(.a(x16), .b(x12), .c(new_n126_), .O(new_n323_));
  aoi21  g272(.a(new_n323_), .b(new_n87_), .c(new_n75_), .O(new_n324_));
  nor3   g273(.a(x21), .b(x14), .c(x09), .O(new_n325_));
  oai21  g274(.a(new_n324_), .b(new_n322_), .c(new_n325_), .O(new_n326_));
  nand2  g275(.a(new_n229_), .b(x09), .O(new_n327_));
  nand2  g276(.a(new_n54_), .b(new_n53_), .O(new_n328_));
  aoi21  g277(.a(new_n327_), .b(new_n326_), .c(new_n328_), .O(new_n329_));
  nand2  g278(.a(x15), .b(x09), .O(new_n330_));
  aoi21  g279(.a(new_n53_), .b(x02), .c(new_n330_), .O(new_n331_));
  oai21  g280(.a(new_n331_), .b(new_n329_), .c(new_n52_), .O(new_n332_));
  inv1   g281(.a(new_n66_), .O(new_n333_));
  nand3  g282(.a(new_n163_), .b(new_n333_), .c(x09), .O(new_n334_));
  aoi21  g283(.a(new_n334_), .b(new_n332_), .c(new_n318_), .O(z16));
  inv1   g284(.a(new_n203_), .O(new_n336_));
  nand2  g285(.a(new_n183_), .b(new_n126_), .O(new_n337_));
  oai21  g286(.a(new_n76_), .b(new_n126_), .c(new_n337_), .O(new_n338_));
  nor2   g287(.a(x15), .b(x08), .O(new_n339_));
  nand4  g288(.a(new_n339_), .b(new_n338_), .c(new_n171_), .d(new_n81_), .O(new_n340_));
  aoi21  g289(.a(new_n340_), .b(new_n200_), .c(x07), .O(new_n341_));
  oai21  g290(.a(new_n341_), .b(new_n336_), .c(new_n52_), .O(new_n342_));
  nand4  g291(.a(new_n207_), .b(new_n112_), .c(x15), .d(new_n73_), .O(new_n343_));
  aoi21  g292(.a(new_n343_), .b(new_n342_), .c(x09), .O(z17));
  inv1   g293(.a(new_n183_), .O(new_n345_));
  nor3   g294(.a(new_n218_), .b(new_n345_), .c(new_n79_), .O(new_n346_));
  oai21  g295(.a(new_n346_), .b(new_n181_), .c(new_n67_), .O(new_n347_));
  nand3  g296(.a(x19), .b(x15), .c(new_n82_), .O(new_n348_));
  nor2   g297(.a(x17), .b(x09), .O(new_n349_));
  nand3  g298(.a(new_n349_), .b(new_n153_), .c(x18), .O(new_n350_));
  aoi21  g299(.a(new_n348_), .b(new_n347_), .c(new_n350_), .O(z18));
  inv1   g300(.a(new_n153_), .O(new_n352_));
  nor2   g301(.a(new_n316_), .b(new_n352_), .O(z19));
  nand2  g302(.a(new_n270_), .b(new_n52_), .O(new_n354_));
  nand2  g303(.a(new_n184_), .b(new_n54_), .O(new_n355_));
  aoi21  g304(.a(new_n354_), .b(new_n235_), .c(new_n355_), .O(new_n356_));
  or2    g305(.a(new_n356_), .b(new_n281_), .O(new_n357_));
  nand4  g306(.a(new_n255_), .b(new_n139_), .c(x21), .d(new_n78_), .O(new_n358_));
  nor2   g307(.a(new_n358_), .b(new_n185_), .O(new_n359_));
  aoi21  g308(.a(new_n357_), .b(new_n79_), .c(new_n359_), .O(new_n360_));
  nor2   g309(.a(new_n65_), .b(x05), .O(new_n361_));
  nand4  g310(.a(new_n361_), .b(new_n244_), .c(new_n67_), .d(x04), .O(new_n362_));
  ...
  nand4  g314(.a(new_n365_), .b(new_n184_), .c(new_n133_), .d(x09), .O(new_n366_));
  nand2  g315(.a(new_n162_), .b(new_n53_), .O(new_n367_));
  aoi21  g316(.a(new_n366_), .b(new_n364_), .c(new_n367_), .O(z20));
  nor2   g317(.a(new_n54_), .b(x09), .O(new_n369_));
  nand2  g318(.a(new_n369_), .b(new_n255_), .O(new_n370_));
  nand3  g319(.a(new_n175_), .b(x08), .c(x06), .O(new_n371_));
  aoi21  g320(.a(new_n371_), .b(new_n370_), .c(x05), .O(new_n372_));
  inv1   g321(.a(new_n136_), .O(new_n373_));
  nor4   g322(.a(new_n373_), .b(x15), .c(x09), .d(new_n126_), .O(new_n374_));
  oai21  g323(.a(new_n374_), .b(new_n372_), .c(new_n53_), .O(new_n375_));
  nand3  g324(.a(new_n369_), .b(new_n290_), .c(x08), .O(new_n376_));
  aoi21  g325(.a(new_n376_), .b(new_n375_), .c(new_n212_), .O(z21));
  nand2  g326(.a(new_n369_), .b(new_n84_), .O(new_n378_));
  nand2  g327(.a(new_n175_), .b(x08), .O(new_n379_));
  aoi21  g328(.a(new_n379_), .b(new_n378_), .c(x05), .O(new_n380_));
  oai21  g329(.a(new_n380_), .b(new_n374_), .c(new_n53_), .O(new_n381_));
  nand2  g330(.a(new_n290_), .b(new_n122_), .O(new_n382_));
  aoi21  g331(.a(new_n382_), .b(new_n381_), .c(new_n212_), .O(z22));
  nor3   g332(.a(new_n265_), .b(new_n352_), .c(new_n72_), .O(z23));
  inv1   g333(.a(new_n349_), .O(new_n385_));
  nand3  g334(.a(new_n133_), .b(x18), .c(new_n65_), .O(new_n386_));
  ...
  nand4  g346(.a(new_n290_), .b(new_n119_), .c(new_n102_), .d(x08), .O(new_n398_));
  aoi21  g347(.a(new_n398_), .b(new_n397_), .c(new_n385_), .O(z24));
  nand2  g348(.a(new_n369_), .b(new_n82_), .O(new_n400_));
  nand2  g349(.a(new_n171_), .b(new_n153_), .O(new_n401_));
  aoi21  g350(.a(new_n400_), .b(new_n379_), .c(new_n401_), .O(z25));
  aoi21  g351(.a(new_n79_), .b(new_n78_), .c(x20), .O(z26));
  nor3   g352(.a(new_n140_), .b(new_n83_), .c(new_n76_), .O(new_n404_));
  oai21  g353(.a(new_n404_), .b(new_n281_), .c(new_n79_), .O(new_n405_));
  nand3  g354(.a(new_n136_), .b(x19), .c(new_n54_), .O(new_n406_));
  aoi21  g355(.a(new_n406_), .b(new_n405_), .c(x07), .O(new_n407_));
  nor4   g356(.a(new_n164_), .b(new_n229_), .c(new_n82_), .d(new_n53_), .O(new_n408_));
  oai21  g357(.a(new_n408_), .b(new_n407_), .c(new_n171_), .O(new_n409_));
  ...
  nand4  g365(.a(new_n416_), .b(new_n260_), .c(new_n175_), .d(new_n109_), .O(new_n417_));
  nand2  g366(.a(new_n417_), .b(new_n414_), .O(z27));
  nand3  g367(.a(new_n245_), .b(new_n79_), .c(x11), .O(new_n419_));
  ...
  inv1   g371(.a(new_n225_), .O(new_n423_));
  nand2  g372(.a(new_n245_), .b(new_n423_), .O(new_n424_));
  ...
  nand4  g376(.a(new_n238_), .b(new_n110_), .c(new_n54_), .d(x12), .O(new_n428_));
  ...
  aoi21  g381(.a(new_n193_), .b(new_n186_), .c(new_n432_), .O(new_n433_));
  nor2   g382(.a(x19), .b(new_n54_), .O(new_n434_));
  nand3  g383(.a(new_n153_), .b(new_n72_), .c(new_n82_), .O(new_n435_));
  ...
  oai21  g388(.a(new_n73_), .b(new_n94_), .c(new_n290_), .O(new_n440_));
  nor2   g389(.a(new_n440_), .b(new_n439_), .O(new_n441_));
  oai21  g390(.a(new_n441_), .b(new_n438_), .c(new_n162_), .O(new_n442_));
  oai21  g391(.a(new_n229_), .b(new_n53_), .c(new_n156_), .O(new_n443_));
  nand2  g392(.a(new_n443_), .b(new_n315_), .O(new_n444_));
  nand2  g393(.a(new_n444_), .b(new_n294_), .O(new_n445_));
