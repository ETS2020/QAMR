...
module FAU ( 
  ...
  nand3  g117(.a(new_n168_), .b(new_n136_), .c(new_n54_), .O(new_n169_));
  aoi21  g118(.a(new_n169_), .b(new_n167_), .c(x07), .O(new_n170_));
  oai21  g119(.a(new_n170_), .b(new_n166_), .c(new_n72_), .O(new_n171_));
  ...
  nand2  g164(.a(new_n164_), .b(x15), .O(new_n216_));
  ...
  nand2  g249(.a(new_n164_), .b(new_n153_), .O(new_n301_));
  ...
  nand2  g253(.a(new_n304_), .b(new_n266_), .O(new_n305_));
  ...
  oai21  g271(.a(new_n322_), .b(new_n317_), .c(new_n159_), .O(new_n323_));
  aoi21  g272(.a(new_n54_), .b(new_n53_), .c(new_n159_), .O(new_n324_));
  ...
  nand2  g280(.a(new_n156_), .b(new_n159_), .O(new_n332_));
  oai21  g281(.a(new_n187_), .b(new_n177_), .c(x02), .O(new_n333_));
  nor2   g282(.a(x16), .b(new_n65_), .O(new_n334_));
  oai21  g283(.a(new_n74_), .b(new_n87_), .c(new_n334_), .O(new_n335_));
  aoi21  g284(.a(new_n335_), .b(new_n333_), .c(new_n80_), .O(new_n336_));
  inv1   g285(.a(new_n74_), .O(new_n337_));
  nand3  g286(.a(x16), .b(x12), .c(new_n80_), .O(new_n338_));
  aoi22  g287(.a(new_n338_), .b(new_n84_), .c(new_n337_), .d(x13), .O(new_n339_));
  ...
  nor2   g321(.a(new_n330_), .b(new_n372_), .O(z19));
  ...
  nand2  g351(.a(new_n304_), .b(new_n119_), .O(new_n403_));
  ...
  nand4  g367(.a(new_n304_), .b(new_n116_), .c(new_n99_), .d(x08), .O(new_n419_));
  ...
  nand2  g413(.a(new_n464_), .b(new_n329_), .O(new_n465_));
  nand2  g414(.a(new_n465_), .b(new_n308_), .O(new_n466_));
