// Benchmark "FAU" written by ABC on Mon Jul  6 14:58:09 2020
...
module FAU ( 
  ...
  nand3  g046(.a(new_n79_), .b(x13), .c(x01), .O(new_n80_));
  ...
  nand4  g054(.a(new_n87_), .b(new_n84_), .c(x11), .d(x09), .O(new_n88_));
  nand3  g055(.a(x23), .b(x22), .c(x20), .O(new_n89_));
  inv1   g056(.a(new_n89_), .O(new_n90_));
  nor2   g057(.a(new_n61_), .b(new_n60_), .O(new_n91_));
  nand4  g058(.a(new_n91_), .b(new_n90_), .c(x14), .d(x12), .O(new_n92_));
  ...
  inv1   g064(.a(new_n40_), .O(new_n98_));
  nand4  g065(.a(new_n57_), .b(new_n56_), .c(new_n41_), .d(new_n98_), .O(new_n99_));
  nor2   g066(.a(new_n99_), .b(new_n97_), .O(new_n100_));
  aoi21  g067(.a(new_n93_), .b(new_n81_), .c(new_n100_), .O(new_n101_));
  nand2  g068(.a(new_n101_), .b(new_n73_), .O(z1));
  nand2  g069(.a(new_n79_), .b(x13), .O(new_n103_));
  nand3  g070(.a(new_n35_), .b(new_n34_), .c(x21), .O(new_n104_));
  nand2  g071(.a(new_n104_), .b(new_n103_), .O(new_n105_));
  nand2  g072(.a(new_n105_), .b(x01), .O(new_n106_));
  nand2  g073(.a(x13), .b(x01), .O(new_n107_));
  nand2  g074(.a(new_n34_), .b(x15), .O(new_n108_));
  oai22  g075(.a(new_n108_), .b(new_n107_), .c(new_n78_), .d(x13), .O(new_n109_));
  inv1   g076(.a(x13), .O(new_n110_));
  nand3  g077(.a(x15), .b(new_n110_), .c(new_n74_), .O(new_n111_));
  ...
  nand3  g082(.a(new_n115_), .b(x06), .c(x03), .O(new_n116_));
  aoi21  g083(.a(new_n113_), .b(new_n106_), .c(new_n116_), .O(z2));
  nand4  g084(.a(x20), .b(x14), .c(x11), .d(x08), .O(new_n118_));
  nor3   g085(.a(new_n118_), .b(new_n85_), .c(new_n82_), .O(new_n119_));
  nand2  g086(.a(new_n119_), .b(new_n81_), .O(new_n120_));
  nand2  g087(.a(x08), .b(x06), .O(new_n121_));
  nor3   g088(.a(new_n114_), .b(new_n121_), .c(new_n49_), .O(new_n122_));
  nand2  g089(.a(new_n122_), .b(new_n48_), .O(new_n123_));
  nor3   g090(.a(x20), .b(x14), .c(x08), .O(new_n124_));
  nand2  g091(.a(new_n42_), .b(new_n41_), .O(new_n125_));
  inv1   g092(.a(new_n125_), .O(new_n126_));
  nand3  g093(.a(new_n126_), .b(new_n124_), .c(new_n38_), .O(new_n127_));
  nand2  g094(.a(new_n127_), .b(new_n123_), .O(new_n128_));
  nand2  g095(.a(new_n128_), .b(new_n34_), .O(new_n129_));
  nand4  g096(.a(new_n124_), .b(new_n42_), .c(new_n41_), .d(new_n98_), .O(new_n130_));
  nand3  g097(.a(new_n130_), .b(new_n129_), .c(new_n120_), .O(z3));
  ...
  aoi21  g103(.a(new_n136_), .b(new_n40_), .c(new_n74_), .O(new_n137_));
  nand3  g104(.a(x19), .b(new_n110_), .c(new_n74_), .O(new_n138_));
  nand2  g105(.a(new_n98_), .b(x13), .O(new_n139_));
  inv1   g106(.a(x02), .O(new_n140_));
  inv1   g107(.a(x10), .O(new_n141_));
  nand4  g108(.a(new_n34_), .b(new_n141_), .c(new_n140_), .d(x00), .O(new_n142_));
  nand3  g109(.a(new_n142_), .b(new_n139_), .c(new_n138_), .O(new_n143_));
  nor2   g110(.a(new_n143_), .b(new_n137_), .O(new_n144_));
  aoi21  g111(.a(x23), .b(new_n83_), .c(new_n61_), .O(new_n145_));
  oai21  g112(.a(new_n145_), .b(new_n62_), .c(x09), .O(new_n146_));
  aoi21  g113(.a(new_n146_), .b(x16), .c(new_n86_), .O(new_n147_));
  nand3  g114(.a(new_n34_), .b(x15), .c(x13), .O(new_n148_));
  aoi21  g115(.a(new_n148_), .b(new_n78_), .c(new_n74_), .O(new_n149_));
  nand3  g116(.a(new_n111_), .b(new_n104_), .c(new_n103_), .O(new_n150_));
  nor2   g117(.a(new_n150_), .b(new_n149_), .O(new_n151_));
  oai22  g118(.a(new_n151_), .b(new_n147_), .c(new_n144_), .d(new_n135_), .O(z4));
  inv1   g119(.a(new_n144_), .O(z5));
  nand2  g120(.a(x20), .b(new_n67_), .O(new_n154_));
  nand2  g121(.a(new_n154_), .b(new_n85_), .O(new_n155_));
  aoi21  g122(.a(new_n155_), .b(new_n65_), .c(x03), .O(new_n156_));
  nand2  g123(.a(new_n68_), .b(x14), .O(new_n157_));
  nand2  g124(.a(new_n157_), .b(x06), .O(new_n158_));
  aoi21  g125(.a(new_n158_), .b(x11), .c(new_n82_), .O(new_n159_));
  oai22  g126(.a(new_n159_), .b(new_n151_), .c(new_n156_), .d(new_n144_), .O(z6));
