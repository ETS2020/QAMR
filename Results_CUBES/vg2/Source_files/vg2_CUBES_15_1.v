...
module FAU ( 
  ...
  nand3  g103(.a(new_n48_), .b(new_n121_), .c(new_n47_), .O(new_n137_));
  oai22  g104(.a(new_n137_), .b(new_n104_), .c(new_n136_), .d(new_n86_), .O(new_n138_));
  aoi22  g105(.a(new_n138_), .b(new_n39_), .c(new_n135_), .d(new_n95_), .O(new_n139_));
  nand2  g106(.a(new_n139_), .b(new_n130_), .O(z3));
  aoi21  g107(.a(x23), .b(new_n68_), .c(new_n73_), .O(new_n141_));
  nand4  g108(.a(new_n73_), .b(x15), .c(x13), .d(x05), .O(new_n142_));
  oai21  g109(.a(new_n141_), .b(new_n56_), .c(new_n142_), .O(new_n143_));
  nand2  g110(.a(new_n143_), .b(new_n35_), .O(new_n144_));
  oai21  g111(.a(new_n110_), .b(new_n39_), .c(new_n118_), .O(new_n145_));
  nand3  g112(.a(x24), .b(x18), .c(x08), .O(new_n146_));
  nor3   g113(.a(new_n146_), .b(new_n75_), .c(x04), .O(new_n147_));
  aoi21  g114(.a(new_n145_), .b(new_n73_), .c(new_n147_), .O(new_n148_));
  aoi21  g115(.a(new_n148_), .b(new_n144_), .c(new_n74_), .O(new_n149_));
  aoi21  g116(.a(new_n120_), .b(new_n113_), .c(x09), .O(new_n150_));
  oai21  g117(.a(new_n150_), .b(new_n149_), .c(x16), .O(new_n151_));
  inv1   g118(.a(new_n39_), .O(new_n152_));
  oai21  g119(.a(new_n54_), .b(x24), .c(new_n152_), .O(new_n153_));
  aoi21  g120(.a(new_n75_), .b(x04), .c(x17), .O(new_n154_));
  oai21  g121(.a(new_n154_), .b(x22), .c(new_n100_), .O(new_n155_));
  aoi21  g122(.a(new_n155_), .b(new_n72_), .c(x08), .O(new_n156_));
  nand2  g123(.a(x15), .b(new_n132_), .O(new_n157_));
  oai21  g124(.a(new_n156_), .b(new_n65_), .c(new_n157_), .O(new_n158_));
  nand2  g125(.a(new_n158_), .b(new_n153_), .O(new_n159_));
  nand2  g126(.a(x18), .b(new_n132_), .O(new_n160_));
  oai21  g127(.a(new_n156_), .b(new_n34_), .c(new_n160_), .O(new_n161_));
  nand2  g128(.a(new_n161_), .b(new_n95_), .O(new_n162_));
  inv1   g129(.a(x00), .O(new_n163_));
  nand2  g130(.a(x21), .b(new_n132_), .O(new_n164_));
  oai21  g131(.a(new_n156_), .b(new_n163_), .c(new_n164_), .O(new_n165_));
  nand3  g132(.a(new_n165_), .b(new_n55_), .c(new_n35_), .O(new_n166_));
  nand4  g133(.a(new_n166_), .b(new_n162_), .c(new_n159_), .d(new_n151_), .O(z4));
  nand2  g134(.a(x20), .b(new_n121_), .O(new_n168_));
  aoi21  g135(.a(new_n168_), .b(new_n46_), .c(x11), .O(new_n169_));
  oai21  g136(.a(new_n169_), .b(x03), .c(z5), .O(new_n170_));
  inv1   g137(.a(x03), .O(new_n171_));
  nand2  g138(.a(new_n120_), .b(new_n113_), .O(z7));
