...
module FAU ( 
  ...
  nand3  g021(.a(new_n54_), .b(x21), .c(x12), .O(new_n55_));
  ...
  nand2  g027(.a(x14), .b(x11), .O(new_n61_));
  ...
  nand4  g062(.a(new_n95_), .b(new_n93_), .c(new_n69_), .d(new_n50_), .O(new_n96_));
  ...
  nand3  g069(.a(x20), .b(x17), .c(x16), .O(new_n103_));
  ...
  nand4  g074(.a(new_n78_), .b(new_n77_), .c(new_n48_), .d(new_n107_), .O(new_n108_));
  inv1   g075(.a(new_n108_), .O(new_n109_));
  inv1   g076(.a(x08), .O(new_n110_));
  nand4  g077(.a(new_n79_), .b(x19), .c(new_n110_), .d(new_n47_), .O(new_n111_));
  ...
  nand3  g082(.a(new_n115_), .b(new_n102_), .c(new_n84_), .O(z1));
  ...
  nand2  g093(.a(new_n54_), .b(x21), .O(new_n127_));
  nand2  g094(.a(new_n127_), .b(new_n53_), .O(new_n128_));
  nor3   g095(.a(new_n87_), .b(new_n61_), .c(new_n79_), .O(new_n129_));
  nand2  g096(.a(new_n129_), .b(new_n128_), .O(new_n130_));
  nor2   g097(.a(x08), .b(x06), .O(new_n131_));
  nor3   g098(.a(x20), .b(x14), .c(x11), .O(new_n132_));
  nand4  g099(.a(new_n132_), .b(new_n131_), .c(new_n67_), .d(new_n49_), .O(new_n133_));
  ...
  nand3  g103(.a(new_n50_), .b(new_n48_), .c(new_n110_), .O(new_n137_));
  nand3  g104(.a(new_n49_), .b(x07), .c(new_n47_), .O(new_n138_));
  oai22  g105(.a(new_n138_), .b(new_n137_), .c(new_n136_), .d(new_n87_), .O(new_n139_));
  nand4  g106(.a(x20), .b(x15), .c(x14), .d(x11), .O(new_n140_));
  nand3  g107(.a(new_n49_), .b(new_n78_), .c(new_n48_), .O(new_n141_));
  oai22  g108(.a(new_n141_), .b(new_n111_), .c(new_n140_), .d(new_n87_), .O(new_n142_));
  aoi22  g109(.a(new_n142_), .b(new_n39_), .c(new_n139_), .d(new_n101_), .O(new_n143_));
  nand2  g110(.a(new_n143_), .b(new_n135_), .O(z3));
  aoi21  g111(.a(new_n75_), .b(x04), .c(x17), .O(new_n145_));
  oai21  g112(.a(new_n145_), .b(x22), .c(new_n107_), .O(new_n146_));
  aoi21  g113(.a(new_n146_), .b(new_n72_), .c(x08), .O(new_n147_));
  inv1   g114(.a(x04), .O(new_n148_));
  aoi21  g115(.a(x23), .b(new_n148_), .c(new_n73_), .O(new_n149_));
  oai21  g116(.a(new_n149_), .b(new_n74_), .c(x09), .O(new_n150_));
  aoi21  g117(.a(new_n150_), .b(x16), .c(new_n110_), .O(new_n151_));
  oai22  g118(.a(new_n151_), .b(new_n124_), .c(new_n147_), .d(new_n46_), .O(z4));
  inv1   g119(.a(new_n46_), .O(z5));
  oai21  g120(.a(new_n79_), .b(x14), .c(new_n47_), .O(new_n154_));
  aoi21  g121(.a(new_n154_), .b(new_n48_), .c(x03), .O(new_n155_));
  inv1   g122(.a(x03), .O(new_n156_));
  oai21  g123(.a(x20), .b(new_n78_), .c(x06), .O(new_n157_));
  aoi21  g124(.a(new_n157_), .b(x11), .c(new_n156_), .O(new_n158_));
  oai22  g125(.a(new_n158_), .b(new_n124_), .c(new_n155_), .d(new_n46_), .O(z6));
  inv1   g126(.a(new_n124_), .O(z7));
endmodule
