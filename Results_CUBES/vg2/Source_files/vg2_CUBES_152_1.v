...
module FAU ( 
  ...
  oai21  g120(.a(new_n141_), .b(x17), .c(new_n134_), .O(new_n154_));
  aoi21  g121(.a(new_n154_), .b(new_n140_), .c(x16), .O(new_n155_));
  oai21  g122(.a(new_n155_), .b(x08), .c(x19), .O(new_n156_));
