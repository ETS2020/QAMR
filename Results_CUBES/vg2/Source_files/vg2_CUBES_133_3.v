// Benchmark "FAU" written by ABC on Mon Jul  6 14:57:38 2020
...
module FAU ( 
  ...
  nand3  g010(.a(x24), .b(new_n34_), .c(x07), .O(new_n44_));
  ...
  nor3   g019(.a(new_n52_), .b(x03), .c(x01), .O(new_n53_));
  and2   g020(.a(new_n53_), .b(new_n49_), .O(z0));
  nand4  g021(.a(new_n34_), .b(new_n39_), .c(new_n38_), .d(x00), .O(new_n55_));
  nand3  g022(.a(x19), .b(x13), .c(x05), .O(new_n56_));
  nand2  g023(.a(new_n56_), .b(new_n55_), .O(new_n57_));
  nor2   g024(.a(x03), .b(x01), .O(new_n58_));
  nor2   g025(.a(x06), .b(x04), .O(new_n59_));
  ...
  nand3  g038(.a(new_n71_), .b(new_n62_), .c(new_n57_), .O(new_n72_));
  ...
  nor3   g050(.a(new_n70_), .b(new_n65_), .c(new_n61_), .O(new_n84_));
  ...
  aoi21  g062(.a(new_n34_), .b(x05), .c(x13), .O(new_n96_));
  nand2  g063(.a(x24), .b(x07), .O(new_n97_));
  nand4  g064(.a(x19), .b(new_n36_), .c(new_n34_), .d(new_n35_), .O(new_n98_));
  oai21  g065(.a(new_n97_), .b(new_n96_), .c(new_n98_), .O(new_n99_));
  ...
  nor2   g070(.a(new_n103_), .b(new_n87_), .O(new_n104_));
  ...
  nand4  g074(.a(new_n51_), .b(new_n58_), .c(new_n50_), .d(new_n107_), .O(new_n108_));
  aoi21  g075(.a(new_n56_), .b(new_n55_), .c(new_n108_), .O(new_n109_));
  inv1   g076(.a(new_n73_), .O(new_n110_));
  inv1   g077(.a(x01), .O(new_n111_));
  nor2   g078(.a(x02), .b(new_n111_), .O(new_n112_));
  nand4  g079(.a(x21), .b(x20), .c(x14), .d(x11), .O(new_n113_));
  inv1   g080(.a(new_n113_), .O(new_n114_));
  inv1   g081(.a(x03), .O(new_n115_));
  nor2   g082(.a(x10), .b(new_n115_), .O(new_n116_));
  nand4  g083(.a(new_n116_), .b(new_n114_), .c(new_n112_), .d(new_n110_), .O(new_n117_));
  inv1   g084(.a(new_n117_), .O(new_n118_));
  oai21  g085(.a(new_n118_), .b(new_n109_), .c(new_n40_), .O(new_n119_));
  inv1   g086(.a(new_n108_), .O(new_n120_));
  nand3  g087(.a(x20), .b(x14), .c(x11), .O(new_n121_));
  nor3   g088(.a(new_n121_), .b(new_n88_), .c(new_n73_), .O(new_n122_));
  aoi22  g089(.a(new_n122_), .b(new_n87_), .c(new_n120_), .d(new_n99_), .O(new_n123_));
  nand2  g090(.a(new_n123_), .b(new_n119_), .O(z3));
  inv1   g091(.a(x09), .O(new_n125_));
  aoi21  g092(.a(new_n64_), .b(x04), .c(x17), .O(new_n126_));
  oai21  g093(.a(new_n126_), .b(x22), .c(new_n125_), .O(new_n127_));
  aoi21  g094(.a(new_n127_), .b(new_n68_), .c(x08), .O(new_n128_));
  aoi21  g095(.a(new_n97_), .b(new_n45_), .c(new_n35_), .O(new_n129_));
  nand3  g096(.a(new_n48_), .b(new_n41_), .c(new_n37_), .O(new_n130_));
  nor2   g097(.a(new_n130_), .b(new_n129_), .O(new_n131_));
  inv1   g098(.a(x04), .O(new_n132_));
  aoi21  g099(.a(x23), .b(new_n132_), .c(new_n69_), .O(new_n133_));
  oai21  g100(.a(new_n133_), .b(new_n63_), .c(x09), .O(new_n134_));
  aoi21  g101(.a(new_n134_), .b(x16), .c(new_n107_), .O(new_n135_));
  nand2  g102(.a(x24), .b(x18), .O(new_n136_));
  nand3  g103(.a(new_n40_), .b(x15), .c(x13), .O(new_n137_));
  aoi21  g104(.a(new_n137_), .b(new_n136_), .c(new_n35_), .O(new_n138_));
  nand3  g105(.a(x15), .b(new_n36_), .c(new_n35_), .O(new_n139_));
  nand3  g106(.a(x24), .b(x18), .c(x13), .O(new_n140_));
  nand3  g107(.a(new_n140_), .b(new_n139_), .c(new_n102_), .O(new_n141_));
  nor2   g108(.a(new_n141_), .b(new_n138_), .O(new_n142_));
  oai22  g109(.a(new_n142_), .b(new_n135_), .c(new_n131_), .d(new_n128_), .O(z4));
  inv1   g110(.a(new_n131_), .O(z5));
  inv1   g111(.a(x06), .O(new_n145_));
  oai21  g112(.a(new_n50_), .b(x14), .c(new_n145_), .O(new_n146_));
  nand2  g113(.a(new_n146_), .b(new_n49_), .O(new_n147_));
  nand2  g114(.a(x07), .b(x03), .O(new_n148_));
  nand2  g115(.a(x18), .b(new_n115_), .O(new_n149_));
  aoi22  g116(.a(new_n149_), .b(new_n148_), .c(new_n36_), .d(new_n35_), .O(new_n150_));
  oai21  g117(.a(x20), .b(new_n67_), .c(x06), .O(new_n151_));
  nand3  g118(.a(x18), .b(x11), .c(x05), .O(new_n152_));
  inv1   g119(.a(new_n152_), .O(new_n153_));
  and2   g120(.a(new_n153_), .b(new_n151_), .O(new_n154_));
  oai21  g121(.a(new_n154_), .b(new_n150_), .c(x24), .O(new_n155_));
  nand2  g122(.a(new_n102_), .b(new_n85_), .O(new_n156_));
  nand3  g123(.a(new_n156_), .b(new_n151_), .c(x11), .O(new_n157_));
  inv1   g124(.a(x15), .O(new_n158_));
  nand2  g125(.a(x19), .b(x03), .O(new_n159_));
  oai21  g126(.a(new_n158_), .b(x03), .c(new_n159_), .O(new_n160_));
  nand3  g127(.a(new_n40_), .b(x13), .c(x05), .O(new_n161_));
  oai21  g128(.a(x13), .b(x05), .c(new_n161_), .O(new_n162_));
  nand2  g129(.a(new_n162_), .b(new_n160_), .O(new_n163_));
  inv1   g130(.a(x21), .O(new_n164_));
  nand2  g131(.a(x03), .b(x00), .O(new_n165_));
  oai21  g132(.a(new_n164_), .b(x03), .c(new_n165_), .O(new_n166_));
  nand4  g133(.a(new_n166_), .b(new_n40_), .c(new_n39_), .d(new_n38_), .O(new_n167_));
  nand3  g134(.a(new_n167_), .b(new_n163_), .c(new_n157_), .O(new_n168_));
  inv1   g135(.a(new_n168_), .O(new_n169_));
  nand3  g136(.a(new_n169_), .b(new_n155_), .c(new_n147_), .O(z6));
  inv1   g137(.a(new_n142_), .O(z7));
endmodule
