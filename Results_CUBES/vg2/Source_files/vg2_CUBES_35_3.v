...
module FAU ( 
  ...
  nand2  g72(.a(new_n57_), .b(x09), .O(new_n106_));
  aoi21  g73(.a(new_n106_), .b(x16), .c(new_n97_), .O(new_n107_));
  inv1   g74(.a(x09), .O(new_n108_));
  nand3  g75(.a(new_n58_), .b(new_n57_), .c(x04), .O(new_n109_));
  nand2  g76(.a(new_n109_), .b(new_n108_), .O(new_n110_));
  oai21  g77(.a(x22), .b(new_n56_), .c(new_n97_), .O(new_n111_));
  aoi21  g78(.a(new_n110_), .b(new_n55_), .c(new_n111_), .O(new_n112_));
  oai22  g79(.a(new_n112_), .b(new_n46_), .c(new_n107_), .d(new_n74_), .O(z4));
