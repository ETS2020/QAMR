...
module FAU ( 
  ...
  nand4  g091(.a(new_n124_), .b(new_n87_), .c(new_n57_), .d(x20), .O(new_n125_));
  nor3   g092(.a(x20), .b(x14), .c(x11), .O(new_n126_));
  nand4  g093(.a(new_n126_), .b(new_n103_), .c(new_n67_), .d(new_n48_), .O(new_n127_));
  ...
  nand3  g098(.a(new_n49_), .b(new_n47_), .c(new_n131_), .O(new_n132_));
  nand3  g099(.a(new_n48_), .b(x07), .c(new_n46_), .O(new_n133_));
  oai22  g100(.a(new_n133_), .b(new_n132_), .c(new_n130_), .d(new_n86_), .O(new_n134_));
  nand3  g101(.a(new_n124_), .b(x20), .c(x15), .O(new_n135_));
  nand3  g102(.a(new_n48_), .b(new_n120_), .c(new_n47_), .O(new_n136_));
  oai22  g103(.a(new_n136_), .b(new_n104_), .c(new_n135_), .d(new_n86_), .O(new_n137_));
  aoi22  g104(.a(new_n137_), .b(new_n39_), .c(new_n134_), .d(new_n95_), .O(new_n138_));
  nand2  g105(.a(new_n138_), .b(new_n129_), .O(z3));
  aoi21  g106(.a(x23), .b(new_n68_), .c(new_n73_), .O(new_n140_));
  oai21  g107(.a(new_n140_), .b(new_n74_), .c(x09), .O(new_n141_));
  oai21  g108(.a(new_n110_), .b(new_n131_), .c(new_n114_), .O(new_n142_));
  nand3  g109(.a(new_n142_), .b(new_n141_), .c(x16), .O(new_n143_));
  ...
  nand2  g126(.a(x20), .b(new_n120_), .O(new_n160_));
  ...
  nand2  g130(.a(new_n119_), .b(new_n113_), .O(z7));
