...
module FAU ( 
  ...
  nand4  g058(.a(new_n91_), .b(new_n90_), .c(new_n88_), .d(new_n68_), .O(new_n92_));
  inv1   g059(.a(x04), .O(new_n93_));
  nor2   g060(.a(x17), .b(x16), .O(new_n94_));
  nand4  g061(.a(new_n94_), .b(new_n49_), .c(new_n71_), .d(new_n93_), .O(new_n95_));
  nor2   g062(.a(new_n95_), .b(new_n92_), .O(new_n96_));
  nor2   g063(.a(new_n39_), .b(new_n36_), .O(new_n97_));
  oai21  g064(.a(new_n96_), .b(new_n87_), .c(new_n97_), .O(new_n98_));
  nor2   g065(.a(new_n84_), .b(new_n83_), .O(new_n99_));
  nand3  g066(.a(x20), .b(x16), .c(x15), .O(new_n100_));
  ...
  nand4  g078(.a(new_n111_), .b(new_n49_), .c(new_n77_), .d(new_n93_), .O(new_n112_));
  oai21  g079(.a(new_n112_), .b(new_n110_), .c(new_n103_), .O(new_n113_));
  nand2  g080(.a(new_n113_), .b(new_n39_), .O(new_n114_));
  nand3  g081(.a(new_n114_), .b(new_n98_), .c(new_n82_), .O(z1));
  ...
  nor2   g093(.a(new_n126_), .b(new_n84_), .O(new_n127_));
  ...
  oai22  g103(.a(new_n136_), .b(new_n135_), .c(new_n134_), .d(new_n84_), .O(new_n137_));
  nand4  g104(.a(x20), .b(x15), .c(x14), .d(x11), .O(new_n138_));
  inv1   g105(.a(x14), .O(new_n139_));
  nand3  g106(.a(new_n49_), .b(new_n139_), .c(new_n48_), .O(new_n140_));
  oai22  g107(.a(new_n140_), .b(new_n108_), .c(new_n138_), .d(new_n84_), .O(new_n141_));
  aoi22  g108(.a(new_n141_), .b(new_n39_), .c(new_n137_), .d(new_n97_), .O(new_n142_));
  ...
  aoi21  g113(.a(x23), .b(new_n93_), .c(new_n77_), .O(new_n147_));
  oai21  g114(.a(new_n147_), .b(new_n72_), .c(x09), .O(new_n148_));
  aoi21  g115(.a(new_n148_), .b(x16), .c(new_n107_), .O(new_n149_));
  oai22  g116(.a(new_n149_), .b(new_n123_), .c(new_n146_), .d(new_n46_), .O(z4));
  ...
  oai21  g121(.a(x20), .b(new_n139_), .c(x06), .O(new_n155_));
