...
module FAU ( 
  ...
  nor3   g050(.a(new_n79_), .b(new_n75_), .c(new_n69_), .O(new_n84_));
  nand2  g051(.a(x24), .b(x18), .O(new_n85_));
  oai21  g052(.a(x13), .b(x05), .c(new_n85_), .O(new_n86_));
  nand3  g053(.a(new_n86_), .b(new_n62_), .c(new_n59_), .O(new_n87_));
  inv1   g054(.a(new_n87_), .O(new_n88_));
  oai21  g055(.a(new_n39_), .b(new_n35_), .c(new_n40_), .O(new_n89_));
  aoi21  g056(.a(new_n89_), .b(new_n84_), .c(new_n88_), .O(new_n90_));
  ...
  nand3  g060(.a(new_n54_), .b(new_n36_), .c(x21), .O(new_n94_));
  ...
  nor3   g066(.a(new_n99_), .b(new_n98_), .c(new_n57_), .O(z2));
  ...
  nor3   g071(.a(new_n104_), .b(new_n103_), .c(new_n57_), .O(new_n105_));
  nand2  g072(.a(new_n105_), .b(new_n102_), .O(new_n106_));
  nor2   g073(.a(x14), .b(x08), .O(new_n107_));
  nand3  g074(.a(new_n49_), .b(new_n48_), .c(new_n47_), .O(new_n108_));
  inv1   g075(.a(new_n108_), .O(new_n109_));
  nand4  g076(.a(new_n109_), .b(new_n107_), .c(new_n66_), .d(new_n78_), .O(new_n110_));
  ...
  nand3  g081(.a(new_n107_), .b(new_n78_), .c(x07), .O(new_n115_));
  oai22  g082(.a(new_n115_), .b(new_n108_), .c(new_n114_), .d(new_n113_), .O(new_n116_));
  nor2   g083(.a(new_n39_), .b(new_n36_), .O(new_n117_));
  nand4  g084(.a(x20), .b(x15), .c(x14), .d(x11), .O(new_n118_));
  nand3  g085(.a(new_n107_), .b(new_n78_), .c(x19), .O(new_n119_));
  oai22  g086(.a(new_n119_), .b(new_n108_), .c(new_n118_), .d(new_n113_), .O(new_n120_));
  aoi22  g087(.a(new_n120_), .b(new_n39_), .c(new_n117_), .d(new_n116_), .O(new_n121_));
  ...
  aoi21  g095(.a(x23), .b(new_n128_), .c(new_n72_), .O(new_n129_));
  oai21  g096(.a(new_n129_), .b(new_n73_), .c(x09), .O(new_n130_));
  aoi21  g097(.a(new_n130_), .b(x16), .c(new_n127_), .O(new_n131_));
  oai22  g098(.a(new_n131_), .b(new_n98_), .c(new_n126_), .d(new_n46_), .O(z4));
  inv1   g099(.a(new_n46_), .O(z5));
  nand2  g100(.a(x20), .b(new_n77_), .O(new_n134_));
  nand2  g101(.a(new_n134_), .b(new_n47_), .O(new_n135_));
  aoi21  g102(.a(new_n135_), .b(new_n48_), .c(x03), .O(new_n136_));
  inv1   g103(.a(x03), .O(new_n137_));
  nand2  g104(.a(new_n78_), .b(x14), .O(new_n138_));
  nand2  g105(.a(new_n138_), .b(x06), .O(new_n139_));
  aoi21  g106(.a(new_n139_), .b(x11), .c(new_n137_), .O(new_n140_));
  oai22  g107(.a(new_n140_), .b(new_n98_), .c(new_n136_), .d(new_n46_), .O(z6));
