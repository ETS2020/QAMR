// Benchmark "FAU" written by ABC on Mon Jul  6 14:58:34 2020
...
module FAU ( 
  ...
  nand4  g019(.a(x15), .b(x13), .c(x06), .d(x05), .O(new_n53_));
  ...
  nor2   g055(.a(new_n88_), .b(new_n61_), .O(new_n89_));
  nand3  g056(.a(new_n89_), .b(new_n87_), .c(new_n85_), .O(new_n90_));
  nor2   g057(.a(x12), .b(x11), .O(new_n91_));
  inv1   g058(.a(x07), .O(new_n92_));
  nor2   g059(.a(new_n92_), .b(x06), .O(new_n93_));
  nand4  g060(.a(new_n93_), .b(new_n91_), .c(new_n68_), .d(new_n49_), .O(new_n94_));
  ...
  nor2   g065(.a(new_n38_), .b(new_n43_), .O(new_n99_));
  ...
  nand4  g072(.a(new_n77_), .b(new_n76_), .c(new_n47_), .d(new_n105_), .O(new_n106_));
  inv1   g073(.a(new_n106_), .O(new_n107_));
  inv1   g074(.a(x08), .O(new_n108_));
  nand4  g075(.a(new_n78_), .b(x19), .c(new_n108_), .d(new_n46_), .O(new_n109_));
  inv1   g076(.a(new_n109_), .O(new_n110_));
  nand2  g077(.a(new_n110_), .b(new_n107_), .O(new_n111_));
  oai21  g078(.a(new_n111_), .b(new_n97_), .c(new_n104_), .O(new_n112_));
  nand2  g079(.a(new_n112_), .b(new_n38_), .O(new_n113_));
  nand3  g080(.a(new_n113_), .b(new_n100_), .c(new_n83_), .O(z1));
  nand2  g081(.a(x15), .b(x13), .O(new_n115_));
  nand2  g082(.a(x24), .b(x18), .O(new_n116_));
  oai21  g083(.a(new_n115_), .b(x24), .c(new_n116_), .O(new_n117_));
  nand2  g084(.a(new_n117_), .b(x05), .O(new_n118_));
  nand3  g085(.a(x24), .b(x18), .c(x13), .O(new_n119_));
  inv1   g086(.a(new_n119_), .O(new_n120_));
  aoi21  g087(.a(new_n38_), .b(x15), .c(new_n120_), .O(new_n121_));
  nand2  g088(.a(new_n121_), .b(new_n118_), .O(new_n122_));
  nand2  g089(.a(new_n122_), .b(x06), .O(new_n123_));
  nand3  g090(.a(new_n54_), .b(new_n43_), .c(x21), .O(new_n124_));
  inv1   g091(.a(new_n57_), .O(new_n125_));
  nand2  g092(.a(x14), .b(x11), .O(new_n126_));
  inv1   g093(.a(new_n126_), .O(new_n127_));
  nand3  g094(.a(new_n127_), .b(new_n125_), .c(x20), .O(new_n128_));
  aoi21  g095(.a(new_n124_), .b(new_n123_), .c(new_n128_), .O(z2));
  nor2   g096(.a(new_n78_), .b(new_n77_), .O(new_n130_));
  nand4  g097(.a(new_n130_), .b(new_n125_), .c(x11), .d(x08), .O(new_n131_));
  aoi21  g098(.a(new_n55_), .b(new_n53_), .c(new_n131_), .O(new_n132_));
  nor2   g099(.a(x08), .b(x06), .O(new_n133_));
  nor2   g100(.a(x14), .b(x11), .O(new_n134_));
  nand4  g101(.a(new_n134_), .b(new_n133_), .c(new_n48_), .d(new_n78_), .O(new_n135_));
  aoi21  g102(.a(new_n65_), .b(new_n64_), .c(new_n135_), .O(new_n136_));
  oai21  g103(.a(new_n136_), .b(new_n132_), .c(new_n43_), .O(new_n137_));
  nand4  g104(.a(x20), .b(x18), .c(x14), .d(x11), .O(new_n138_));
  nand3  g105(.a(new_n49_), .b(new_n47_), .c(new_n108_), .O(new_n139_));
  nand3  g106(.a(new_n48_), .b(x07), .c(new_n46_), .O(new_n140_));
  oai22  g107(.a(new_n140_), .b(new_n139_), .c(new_n138_), .d(new_n86_), .O(new_n141_));
  nand4  g108(.a(x20), .b(x15), .c(x14), .d(x11), .O(new_n142_));
  nand2  g109(.a(new_n134_), .b(new_n48_), .O(new_n143_));
  oai22  g110(.a(new_n143_), .b(new_n109_), .c(new_n142_), .d(new_n86_), .O(new_n144_));
  aoi22  g111(.a(new_n144_), .b(new_n38_), .c(new_n141_), .d(new_n99_), .O(new_n145_));
  nand2  g112(.a(new_n145_), .b(new_n137_), .O(z3));
  inv1   g113(.a(x04), .O(new_n147_));
  oai21  g114(.a(x23), .b(new_n147_), .c(new_n72_), .O(new_n148_));
  aoi21  g115(.a(new_n148_), .b(new_n73_), .c(x09), .O(new_n149_));
  oai21  g116(.a(new_n149_), .b(x16), .c(new_n108_), .O(new_n150_));
  nand2  g117(.a(new_n150_), .b(z5), .O(new_n151_));
  oai21  g118(.a(new_n74_), .b(x04), .c(x17), .O(new_n152_));
  aoi21  g119(.a(new_n152_), .b(x22), .c(new_n105_), .O(new_n153_));
  oai21  g120(.a(new_n153_), .b(new_n71_), .c(x08), .O(new_n154_));
  nand3  g121(.a(new_n124_), .b(new_n121_), .c(new_n118_), .O(z7));
  nand2  g122(.a(z7), .b(new_n154_), .O(new_n156_));
  nand2  g123(.a(new_n156_), .b(new_n151_), .O(z4));
  oai21  g124(.a(new_n78_), .b(x14), .c(new_n46_), .O(new_n158_));
  aoi21  g125(.a(new_n158_), .b(new_n47_), .c(x03), .O(new_n159_));
  nand3  g126(.a(x18), .b(x11), .c(new_n46_), .O(new_n160_));
  oai21  g127(.a(new_n159_), .b(new_n92_), .c(new_n160_), .O(new_n161_));
  nand2  g128(.a(new_n161_), .b(new_n99_), .O(new_n162_));
  nand3  g129(.a(new_n43_), .b(x13), .c(x05), .O(new_n163_));
  oai21  g130(.a(x13), .b(x05), .c(new_n163_), .O(new_n164_));
  inv1   g131(.a(x19), .O(new_n165_));
  nand3  g132(.a(x15), .b(x11), .c(new_n46_), .O(new_n166_));
  oai21  g133(.a(new_n159_), .b(new_n165_), .c(new_n166_), .O(new_n167_));
  nand2  g134(.a(new_n167_), .b(new_n164_), .O(new_n168_));
  inv1   g135(.a(new_n44_), .O(new_n169_));
  inv1   g136(.a(x03), .O(new_n170_));
  nand2  g137(.a(new_n158_), .b(new_n47_), .O(new_n171_));
  nand2  g138(.a(new_n171_), .b(new_n170_), .O(new_n172_));
  oai21  g139(.a(new_n126_), .b(x20), .c(x03), .O(new_n173_));
  aoi22  g140(.a(new_n173_), .b(z7), .c(new_n172_), .d(new_n169_), .O(new_n174_));
  nand3  g141(.a(new_n174_), .b(new_n168_), .c(new_n162_), .O(z6));
endmodule
