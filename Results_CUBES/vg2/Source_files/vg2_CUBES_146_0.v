...
module FAU ( 
  ...
  oai21  g033(.a(new_n54_), .b(new_n65_), .c(new_n66_), .O(new_n67_));
  ...
  nand3  g052(.a(new_n85_), .b(x08), .c(x06), .O(new_n86_));
  ...
  nand4  g058(.a(new_n79_), .b(new_n69_), .c(x07), .d(new_n46_), .O(new_n92_));
  nand3  g059(.a(new_n76_), .b(new_n48_), .c(new_n68_), .O(new_n93_));
  ...
  nand3  g065(.a(new_n98_), .b(new_n87_), .c(new_n84_), .O(new_n99_));
  ...
  nand3  g072(.a(new_n105_), .b(new_n101_), .c(new_n100_), .O(new_n106_));
  ...
  nand3  g080(.a(new_n55_), .b(new_n43_), .c(x21), .O(new_n114_));
  ...
  oai21  g106(.a(new_n54_), .b(x24), .c(new_n139_), .O(new_n140_));
  ...
  nand4  g111(.a(new_n74_), .b(x19), .c(new_n72_), .d(x04), .O(new_n145_));
  oai21  g112(.a(new_n144_), .b(new_n53_), .c(new_n145_), .O(new_n146_));
  nand2  g113(.a(new_n146_), .b(new_n140_), .O(new_n147_));
  nand4  g114(.a(new_n74_), .b(new_n72_), .c(x07), .d(x04), .O(new_n148_));
  oai21  g115(.a(new_n144_), .b(new_n110_), .c(new_n148_), .O(new_n149_));
  nand2  g116(.a(new_n149_), .b(new_n95_), .O(new_n150_));
  inv1   g117(.a(new_n114_), .O(new_n151_));
  nand2  g118(.a(new_n143_), .b(x16), .O(new_n152_));
  nand2  g119(.a(new_n152_), .b(x08), .O(new_n153_));
  aoi21  g120(.a(new_n141_), .b(x17), .c(x09), .O(new_n154_));
  oai21  g121(.a(new_n154_), .b(x16), .c(new_n130_), .O(new_n155_));
  aoi22  g122(.a(new_n155_), .b(z5), .c(new_n153_), .d(new_n151_), .O(new_n156_));
  nand3  g123(.a(new_n156_), .b(new_n150_), .c(new_n147_), .O(z4));
  nand2  g124(.a(x20), .b(new_n119_), .O(new_n158_));
  aoi21  g125(.a(new_n158_), .b(new_n46_), .c(x11), .O(new_n159_));
  oai21  g126(.a(new_n159_), .b(x03), .c(z5), .O(new_n160_));
  inv1   g127(.a(x03), .O(new_n161_));
  nand2  g128(.a(new_n118_), .b(new_n113_), .O(z7));
  nand2  g129(.a(new_n102_), .b(x14), .O(new_n163_));
  aoi21  g130(.a(new_n163_), .b(x06), .c(new_n47_), .O(new_n164_));
  oai21  g131(.a(new_n164_), .b(new_n161_), .c(z7), .O(new_n165_));
  nand2  g132(.a(new_n165_), .b(new_n160_), .O(z6));
endmodule
