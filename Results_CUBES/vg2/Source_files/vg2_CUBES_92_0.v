...
module FAU ( 
  ...
  oai21  g037(.a(new_n56_), .b(new_n69_), .c(new_n70_), .O(new_n71_));
  inv1   g038(.a(x04), .O(new_n72_));
  nor2   g039(.a(x09), .b(x08), .O(new_n73_));
  nand4  g040(.a(new_n73_), .b(new_n49_), .c(new_n50_), .d(new_n72_), .O(new_n74_));
  ...
  nand4  g047(.a(new_n48_), .b(new_n47_), .c(new_n80_), .d(new_n51_), .O(new_n81_));
  nor3   g048(.a(new_n81_), .b(new_n79_), .c(new_n74_), .O(new_n82_));
  ...
  inv1   g053(.a(new_n38_), .O(new_n87_));
  oai21  g054(.a(new_n43_), .b(new_n86_), .c(new_n87_), .O(new_n88_));
  nand3  g055(.a(new_n88_), .b(new_n67_), .c(new_n64_), .O(new_n89_));
  oai21  g056(.a(new_n38_), .b(new_n34_), .c(new_n39_), .O(new_n90_));
  nand2  g057(.a(new_n90_), .b(new_n82_), .O(new_n91_));
  nand3  g058(.a(new_n91_), .b(new_n89_), .c(new_n85_), .O(z1));
  inv1   g059(.a(new_n88_), .O(new_n93_));
  nand2  g060(.a(new_n61_), .b(new_n43_), .O(new_n94_));
  inv1   g061(.a(new_n62_), .O(new_n95_));
  nor2   g062(.a(new_n51_), .b(new_n50_), .O(new_n96_));
  nand4  g063(.a(new_n96_), .b(new_n95_), .c(x20), .d(x14), .O(new_n97_));
  aoi21  g064(.a(new_n94_), .b(new_n93_), .c(new_n97_), .O(z2));
  nand3  g065(.a(x20), .b(x14), .c(x08), .O(new_n99_));
  nand2  g066(.a(new_n96_), .b(new_n95_), .O(new_n100_));
  nor2   g067(.a(new_n100_), .b(new_n99_), .O(new_n101_));
  inv1   g068(.a(x08), .O(new_n102_));
  nand3  g069(.a(new_n48_), .b(new_n47_), .c(new_n102_), .O(new_n103_));
  nand2  g070(.a(new_n53_), .b(new_n49_), .O(new_n104_));
  nor2   g071(.a(new_n104_), .b(new_n103_), .O(new_n105_));
  aoi22  g072(.a(new_n105_), .b(new_n71_), .c(new_n101_), .d(new_n61_), .O(new_n106_));
  aoi22  g073(.a(new_n105_), .b(new_n90_), .c(new_n101_), .d(new_n88_), .O(new_n107_));
  oai21  g074(.a(new_n106_), .b(x24), .c(new_n107_), .O(z3));
  inv1   g075(.a(new_n61_), .O(new_n109_));
  aoi21  g076(.a(x23), .b(new_n72_), .c(new_n76_), .O(new_n110_));
  oai21  g077(.a(new_n110_), .b(new_n77_), .c(x09), .O(new_n111_));
  aoi21  g078(.a(new_n111_), .b(x16), .c(new_n102_), .O(new_n112_));
  nand2  g079(.a(new_n71_), .b(x08), .O(new_n113_));
  oai21  g080(.a(new_n112_), .b(new_n109_), .c(new_n113_), .O(new_n114_));
  nand2  g081(.a(new_n114_), .b(new_n43_), .O(new_n115_));
  nand3  g082(.a(new_n87_), .b(x08), .c(x07), .O(new_n116_));
  oai21  g083(.a(new_n112_), .b(new_n86_), .c(new_n116_), .O(new_n117_));
  nand2  g084(.a(new_n117_), .b(x24), .O(new_n118_));
  oai21  g085(.a(new_n35_), .b(x15), .c(new_n70_), .O(new_n119_));
  nand2  g086(.a(new_n119_), .b(new_n43_), .O(new_n120_));
  oai21  g087(.a(new_n34_), .b(x08), .c(new_n120_), .O(new_n121_));
  oai21  g088(.a(x23), .b(new_n72_), .c(new_n76_), .O(new_n122_));
  aoi21  g089(.a(new_n122_), .b(new_n77_), .c(x09), .O(new_n123_));
  nor2   g090(.a(new_n123_), .b(x16), .O(new_n124_));
  nand2  g091(.a(new_n111_), .b(x16), .O(new_n125_));
  nand3  g092(.a(new_n125_), .b(new_n69_), .c(x08), .O(new_n126_));
  aoi22  g093(.a(new_n126_), .b(new_n38_), .c(new_n124_), .d(new_n121_), .O(new_n127_));
  nand3  g094(.a(new_n127_), .b(new_n118_), .c(new_n115_), .O(z4));
  nand2  g095(.a(new_n46_), .b(new_n37_), .O(z5));
  nand2  g096(.a(new_n71_), .b(x03), .O(new_n130_));
  ...
  oai21  g100(.a(new_n133_), .b(new_n109_), .c(new_n130_), .O(new_n134_));
  nand2  g101(.a(new_n134_), .b(new_n43_), .O(new_n135_));
  nand3  g102(.a(new_n87_), .b(x07), .c(x03), .O(new_n136_));
  oai21  g103(.a(new_n133_), .b(new_n86_), .c(new_n136_), .O(new_n137_));
