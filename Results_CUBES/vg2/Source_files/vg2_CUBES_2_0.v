...
module FAU ( 
  ...
  nand2  g032(.a(new_n65_), .b(new_n56_), .O(new_n66_));
  ...
  nand4  g045(.a(new_n78_), .b(new_n75_), .c(new_n70_), .d(new_n66_), .O(new_n79_));
  ...
  inv1   g050(.a(new_n58_), .O(new_n84_));
  nand3  g051(.a(new_n84_), .b(x08), .c(x06), .O(new_n85_));
  ...
  nand4  g057(.a(new_n78_), .b(new_n68_), .c(x07), .d(new_n46_), .O(new_n91_));
  nand3  g058(.a(new_n75_), .b(new_n48_), .c(new_n67_), .O(new_n92_));
  oai21  g059(.a(new_n92_), .b(new_n91_), .c(new_n90_), .O(new_n93_));
  nor2   g060(.a(new_n38_), .b(new_n43_), .O(new_n94_));
  ...
  nand3  g064(.a(new_n97_), .b(new_n86_), .c(new_n83_), .O(new_n98_));
  ...
  nand4  g071(.a(new_n104_), .b(new_n100_), .c(new_n47_), .d(new_n99_), .O(new_n105_));
  ...
  oai21  g077(.a(new_n43_), .b(new_n109_), .c(new_n110_), .O(new_n111_));
  ...
  nand4  g086(.a(new_n119_), .b(new_n84_), .c(x11), .d(x06), .O(new_n120_));
  aoi21  g087(.a(new_n117_), .b(new_n112_), .c(new_n120_), .O(z2));
  nor2   g088(.a(new_n118_), .b(new_n47_), .O(new_n122_));
  nand4  g089(.a(new_n122_), .b(new_n86_), .c(new_n57_), .d(x20), .O(new_n123_));
  inv1   g090(.a(x00), .O(new_n124_));
  oai21  g091(.a(new_n56_), .b(new_n124_), .c(new_n65_), .O(new_n125_));
  nor3   g092(.a(x20), .b(x14), .c(x11), .O(new_n126_));
  nand4  g093(.a(new_n126_), .b(new_n125_), .c(new_n102_), .d(new_n48_), .O(new_n127_));
  nand2  g094(.a(new_n127_), .b(new_n123_), .O(new_n128_));
  nand2  g095(.a(new_n128_), .b(new_n43_), .O(new_n129_));
  nand3  g096(.a(new_n122_), .b(x20), .c(x18), .O(new_n130_));
  ...
  oai22  g100(.a(new_n133_), .b(new_n132_), .c(new_n130_), .d(new_n85_), .O(new_n134_));
  nand3  g101(.a(new_n122_), .b(x20), .c(x15), .O(new_n135_));
  nand3  g102(.a(new_n48_), .b(new_n118_), .c(new_n47_), .O(new_n136_));
  oai22  g103(.a(new_n136_), .b(new_n103_), .c(new_n135_), .d(new_n85_), .O(new_n137_));
  aoi22  g104(.a(new_n137_), .b(new_n38_), .c(new_n134_), .d(new_n94_), .O(new_n138_));
  nand2  g105(.a(new_n138_), .b(new_n129_), .O(z3));
  inv1   g106(.a(new_n38_), .O(new_n140_));
  oai21  g107(.a(new_n55_), .b(x24), .c(new_n140_), .O(new_n141_));
  ...
  aoi21  g111(.a(new_n144_), .b(x16), .c(new_n131_), .O(new_n145_));
  nand4  g112(.a(new_n73_), .b(x19), .c(new_n71_), .d(x04), .O(new_n146_));
  oai21  g113(.a(new_n145_), .b(new_n53_), .c(new_n146_), .O(new_n147_));
  nand2  g114(.a(new_n147_), .b(new_n141_), .O(new_n148_));
  nand4  g115(.a(new_n73_), .b(new_n71_), .c(x07), .d(x04), .O(new_n149_));
  oai21  g116(.a(new_n145_), .b(new_n109_), .c(new_n149_), .O(new_n150_));
  nand2  g117(.a(new_n150_), .b(new_n94_), .O(new_n151_));
  aoi21  g118(.a(new_n142_), .b(x17), .c(x09), .O(new_n152_));
  oai21  g119(.a(new_n152_), .b(x16), .c(new_n131_), .O(new_n153_));
  nand2  g120(.a(x17), .b(x04), .O(new_n154_));
  aoi21  g121(.a(new_n154_), .b(x22), .c(new_n99_), .O(new_n155_));
  oai21  g122(.a(new_n155_), .b(new_n71_), .c(x08), .O(new_n156_));
  nand2  g123(.a(new_n156_), .b(x21), .O(new_n157_));
  nand3  g124(.a(new_n73_), .b(new_n71_), .c(x04), .O(new_n158_));
  nand2  g125(.a(new_n158_), .b(new_n157_), .O(new_n159_));
  nor2   g126(.a(new_n56_), .b(x24), .O(new_n160_));
  aoi22  g127(.a(new_n160_), .b(new_n159_), .c(new_n153_), .d(z5), .O(new_n161_));
  nand3  g128(.a(new_n161_), .b(new_n151_), .c(new_n148_), .O(z4));
  nand2  g129(.a(x20), .b(new_n118_), .O(new_n163_));
  ...
  nand2  g133(.a(new_n117_), .b(new_n112_), .O(z7));
  nand2  g134(.a(new_n101_), .b(x14), .O(new_n168_));
