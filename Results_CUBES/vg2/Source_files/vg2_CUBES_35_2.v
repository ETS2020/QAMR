...
module FAU ( 
  ...
  nand4  g056(.a(new_n89_), .b(new_n88_), .c(new_n87_), .d(new_n67_), .O(new_n90_));
  inv1   g057(.a(x04), .O(new_n91_));
  nand4  g058(.a(new_n49_), .b(new_n48_), .c(new_n70_), .d(new_n91_), .O(new_n92_));
  nor2   g059(.a(new_n92_), .b(new_n90_), .O(new_n93_));
  nor2   g060(.a(new_n38_), .b(new_n35_), .O(new_n94_));
  oai21  g061(.a(new_n93_), .b(new_n86_), .c(new_n94_), .O(new_n95_));
  nor2   g062(.a(new_n83_), .b(new_n82_), .O(new_n96_));
  nand3  g063(.a(x20), .b(x16), .c(x15), .O(new_n97_));
  nand4  g064(.a(x23), .b(x22), .c(x14), .d(x12), .O(new_n98_));
  ...
  nand4  g071(.a(new_n104_), .b(new_n102_), .c(new_n101_), .d(new_n89_), .O(new_n105_));
  nor2   g072(.a(x14), .b(x12), .O(new_n106_));
  nand4  g073(.a(new_n106_), .b(new_n48_), .c(new_n70_), .d(new_n91_), .O(new_n107_));
  oai21  g074(.a(new_n107_), .b(new_n105_), .c(new_n100_), .O(new_n108_));
  nand2  g075(.a(new_n108_), .b(new_n38_), .O(new_n109_));
  nand3  g076(.a(new_n109_), .b(new_n95_), .c(new_n81_), .O(z1));
  ...
  nand4  g085(.a(x20), .b(x14), .c(x11), .d(x06), .O(new_n119_));
  nor3   g086(.a(new_n119_), .b(new_n118_), .c(new_n56_), .O(z2));
  nand3  g087(.a(x20), .b(x14), .c(x11), .O(new_n121_));
  nor2   g088(.a(new_n121_), .b(new_n83_), .O(new_n122_));
  nand2  g089(.a(new_n122_), .b(new_n55_), .O(new_n123_));
  nor3   g090(.a(x20), .b(x14), .c(x11), .O(new_n124_));
  nand4  g091(.a(new_n124_), .b(new_n102_), .c(new_n65_), .d(new_n48_), .O(new_n125_));
  ...
  nand3  g096(.a(new_n49_), .b(new_n47_), .c(new_n129_), .O(new_n130_));
  nand3  g097(.a(new_n48_), .b(x07), .c(new_n46_), .O(new_n131_));
  oai22  g098(.a(new_n131_), .b(new_n130_), .c(new_n128_), .d(new_n83_), .O(new_n132_));
  nand3  g099(.a(new_n102_), .b(new_n76_), .c(x19), .O(new_n133_));
  nand4  g100(.a(x20), .b(x15), .c(x14), .d(x11), .O(new_n134_));
  nand3  g101(.a(new_n48_), .b(new_n75_), .c(new_n47_), .O(new_n135_));
  oai22  g102(.a(new_n135_), .b(new_n133_), .c(new_n134_), .d(new_n83_), .O(new_n136_));
  aoi22  g103(.a(new_n136_), .b(new_n38_), .c(new_n132_), .d(new_n94_), .O(new_n137_));
  nand2  g104(.a(new_n137_), .b(new_n127_), .O(z3));
  nand2  g105(.a(new_n113_), .b(x05), .O(new_n139_));
  inv1   g106(.a(new_n117_), .O(new_n140_));
  ...
  nor2   g117(.a(x22), .b(new_n70_), .O(new_n151_));
  oai21  g118(.a(new_n151_), .b(x09), .c(new_n150_), .O(new_n152_));
  nand3  g119(.a(new_n89_), .b(new_n70_), .c(x04), .O(new_n153_));
  nand3  g120(.a(new_n153_), .b(new_n152_), .c(new_n129_), .O(new_n154_));
  nand2  g121(.a(new_n154_), .b(z5), .O(new_n155_));
  nand2  g122(.a(new_n155_), .b(new_n146_), .O(z4));
  oai21  g123(.a(new_n76_), .b(x14), .c(new_n46_), .O(new_n157_));
  aoi21  g124(.a(new_n157_), .b(new_n47_), .c(x03), .O(new_n158_));
  inv1   g125(.a(x03), .O(new_n159_));
  oai21  g126(.a(x20), .b(new_n75_), .c(x06), .O(new_n160_));
  aoi21  g127(.a(new_n160_), .b(x11), .c(new_n159_), .O(new_n161_));
  oai22  g128(.a(new_n161_), .b(new_n118_), .c(new_n158_), .d(new_n45_), .O(z6));
endmodule
