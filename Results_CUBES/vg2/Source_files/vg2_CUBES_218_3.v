...
module FAU ( 
  ...
  oai22  g024(.a(new_n57_), .b(new_n55_), .c(new_n56_), .d(x02), .O(new_n58_));
  ...
  nand3  g032(.a(new_n35_), .b(new_n37_), .c(x00), .O(new_n66_));
  nand2  g033(.a(new_n66_), .b(new_n39_), .O(new_n67_));
  inv1   g034(.a(x04), .O(new_n68_));
  nor2   g035(.a(x09), .b(x08), .O(new_n69_));
  nand4  g036(.a(new_n69_), .b(new_n51_), .c(new_n49_), .d(new_n68_), .O(new_n70_));
  ...
  nand3  g052(.a(new_n59_), .b(x08), .c(x06), .O(new_n86_));
  ...
  nand4  g058(.a(new_n80_), .b(new_n69_), .c(x07), .d(new_n49_), .O(new_n92_));
  nand3  g059(.a(new_n77_), .b(new_n51_), .c(new_n68_), .O(new_n93_));
  oai21  g060(.a(new_n93_), .b(new_n92_), .c(new_n91_), .O(new_n94_));
  nor2   g061(.a(new_n42_), .b(new_n34_), .O(new_n95_));
  ...
  nand4  g072(.a(new_n105_), .b(new_n101_), .c(new_n50_), .d(new_n100_), .O(new_n106_));
  ...
  nand3  g077(.a(new_n34_), .b(x15), .c(x13), .O(new_n111_));
  oai21  g078(.a(new_n34_), .b(new_n110_), .c(new_n111_), .O(new_n112_));
  nand2  g079(.a(new_n112_), .b(x05), .O(new_n113_));
  nand4  g080(.a(new_n34_), .b(x21), .c(new_n35_), .d(new_n37_), .O(new_n114_));
  ...
  nand4  g087(.a(new_n120_), .b(new_n59_), .c(x11), .d(x06), .O(new_n121_));
  aoi21  g088(.a(new_n118_), .b(new_n113_), .c(new_n121_), .O(z2));
  nor2   g089(.a(new_n119_), .b(new_n50_), .O(new_n123_));
  nand4  g090(.a(new_n123_), .b(new_n87_), .c(new_n58_), .d(x20), .O(new_n124_));
  nor3   g091(.a(x20), .b(x14), .c(x11), .O(new_n125_));
  nand4  g092(.a(new_n125_), .b(new_n103_), .c(new_n67_), .d(new_n51_), .O(new_n126_));
  ...
  aoi22  g103(.a(new_n136_), .b(new_n42_), .c(new_n133_), .d(new_n95_), .O(new_n137_));
  nand2  g104(.a(new_n137_), .b(new_n128_), .O(z3));
  nand2  g105(.a(x19), .b(x13), .O(new_n139_));
  oai21  g106(.a(new_n139_), .b(x24), .c(new_n44_), .O(new_n140_));
  nand2  g107(.a(new_n140_), .b(x05), .O(new_n141_));
  nand4  g108(.a(new_n34_), .b(new_n35_), .c(new_n37_), .d(x00), .O(new_n142_));
  nand2  g109(.a(new_n45_), .b(x13), .O(new_n143_));
  nand4  g110(.a(new_n143_), .b(new_n142_), .c(new_n141_), .d(new_n46_), .O(z5));
  aoi21  g111(.a(new_n75_), .b(x04), .c(x17), .O(new_n145_));
  oai21  g112(.a(new_n145_), .b(x22), .c(new_n100_), .O(new_n146_));
  nand3  g113(.a(new_n146_), .b(z5), .c(new_n72_), .O(new_n147_));
  aoi21  g114(.a(x23), .b(new_n68_), .c(new_n73_), .O(new_n148_));
  oai21  g115(.a(new_n148_), .b(new_n74_), .c(x09), .O(new_n149_));
  aoi21  g116(.a(new_n149_), .b(x16), .c(new_n130_), .O(new_n150_));
  nand2  g117(.a(x08), .b(x07), .O(new_n151_));
  oai21  g118(.a(new_n150_), .b(new_n110_), .c(new_n151_), .O(new_n152_));
  nand2  g119(.a(new_n152_), .b(new_n95_), .O(new_n153_));
  oai21  g120(.a(new_n57_), .b(x24), .c(new_n43_), .O(new_n154_));
  nand2  g121(.a(x19), .b(x08), .O(new_n155_));
  oai21  g122(.a(new_n150_), .b(new_n55_), .c(new_n155_), .O(new_n156_));
  nand2  g123(.a(new_n156_), .b(new_n154_), .O(new_n157_));
  nand2  g124(.a(x21), .b(new_n35_), .O(new_n158_));
  nand2  g125(.a(x08), .b(x00), .O(new_n159_));
  oai21  g126(.a(new_n158_), .b(new_n150_), .c(new_n159_), .O(new_n160_));
  nor2   g127(.a(x24), .b(x02), .O(new_n161_));
  nand2  g128(.a(new_n161_), .b(new_n160_), .O(new_n162_));
  nand4  g129(.a(new_n162_), .b(new_n157_), .c(new_n153_), .d(new_n147_), .O(z4));
  nand2  g130(.a(x20), .b(new_n119_), .O(new_n164_));
  aoi21  g131(.a(new_n164_), .b(new_n49_), .c(x11), .O(new_n165_));
  oai21  g132(.a(new_n165_), .b(x03), .c(z5), .O(new_n166_));
  inv1   g133(.a(x03), .O(new_n167_));
  nand2  g134(.a(new_n118_), .b(new_n113_), .O(z7));
  nand2  g135(.a(new_n102_), .b(x14), .O(new_n169_));
  aoi21  g136(.a(new_n169_), .b(x06), .c(new_n50_), .O(new_n170_));
