...
module FAU ( 
  ...
  inv1   g052(.a(new_n58_), .O(new_n86_));
  nand3  g053(.a(new_n86_), .b(x08), .c(x06), .O(new_n87_));
  ...
  nand4  g059(.a(new_n80_), .b(new_n69_), .c(x07), .d(new_n47_), .O(new_n93_));
  nand3  g060(.a(new_n77_), .b(new_n49_), .c(new_n68_), .O(new_n94_));
  ...
  nand3  g067(.a(new_n100_), .b(new_n88_), .c(new_n85_), .O(new_n101_));
  ...
  nand4  g074(.a(new_n107_), .b(new_n103_), .c(new_n48_), .d(new_n102_), .O(new_n108_));
  oai21  g075(.a(new_n108_), .b(new_n94_), .c(new_n101_), .O(new_n109_));
  nand2  g076(.a(new_n109_), .b(new_n39_), .O(new_n110_));
  nand3  g077(.a(new_n110_), .b(new_n98_), .c(new_n83_), .O(z1));
  ...
  nand4  g081(.a(new_n36_), .b(x21), .c(new_n43_), .d(new_n42_), .O(new_n115_));
  ...
  nand4  g088(.a(new_n121_), .b(new_n86_), .c(x11), .d(x06), .O(new_n122_));
  nor2   g089(.a(new_n122_), .b(new_n119_), .O(z2));
  nor2   g090(.a(new_n120_), .b(new_n48_), .O(new_n124_));
  nand4  g091(.a(new_n124_), .b(new_n88_), .c(new_n57_), .d(x20), .O(new_n125_));
  nor3   g092(.a(x20), .b(x14), .c(x11), .O(new_n126_));
  nand4  g093(.a(new_n126_), .b(new_n105_), .c(new_n67_), .d(new_n49_), .O(new_n127_));
  ...
  nand3  g098(.a(new_n50_), .b(new_n48_), .c(new_n131_), .O(new_n132_));
  ...
  nand3  g102(.a(new_n49_), .b(new_n120_), .c(new_n48_), .O(new_n136_));
  oai22  g103(.a(new_n136_), .b(new_n106_), .c(new_n135_), .d(new_n87_), .O(new_n137_));
  aoi22  g104(.a(new_n137_), .b(new_n39_), .c(new_n134_), .d(new_n97_), .O(new_n138_));
  nand2  g105(.a(new_n138_), .b(new_n129_), .O(z3));
  aoi21  g106(.a(new_n75_), .b(x04), .c(x17), .O(new_n140_));
  oai21  g107(.a(new_n140_), .b(x22), .c(new_n102_), .O(new_n141_));
  aoi21  g108(.a(new_n141_), .b(new_n72_), .c(x08), .O(new_n142_));
  aoi21  g109(.a(x23), .b(new_n68_), .c(new_n73_), .O(new_n143_));
  oai21  g110(.a(new_n143_), .b(new_n74_), .c(x09), .O(new_n144_));
  ...
  nand3  g114(.a(x21), .b(new_n104_), .c(x14), .O(new_n148_));
  nand2  g115(.a(new_n148_), .b(x06), .O(new_n149_));
  nand2  g116(.a(new_n149_), .b(x11), .O(new_n150_));
  inv1   g117(.a(x03), .O(new_n151_));
  nand2  g118(.a(x11), .b(new_n151_), .O(new_n152_));
  aoi22  g119(.a(new_n152_), .b(x00), .c(x21), .d(new_n151_), .O(new_n153_));
  aoi21  g120(.a(new_n153_), .b(new_n150_), .c(new_n56_), .O(new_n154_));
  aoi21  g121(.a(new_n104_), .b(x14), .c(new_n47_), .O(new_n155_));
  oai21  g122(.a(new_n155_), .b(new_n48_), .c(x03), .O(new_n156_));
  nand2  g123(.a(new_n156_), .b(x15), .O(new_n157_));
  aoi21  g124(.a(x20), .b(new_n120_), .c(x06), .O(new_n158_));
  oai21  g125(.a(new_n158_), .b(x11), .c(new_n151_), .O(new_n159_));
  nand2  g126(.a(new_n159_), .b(x19), .O(new_n160_));
  aoi21  g127(.a(new_n160_), .b(new_n157_), .c(new_n55_), .O(new_n161_));
  oai21  g128(.a(new_n161_), .b(new_n154_), .c(new_n36_), .O(new_n162_));
  nand2  g129(.a(new_n160_), .b(new_n157_), .O(new_n163_));
  nand2  g130(.a(new_n156_), .b(x18), .O(new_n164_));
  nand2  g131(.a(new_n159_), .b(x07), .O(new_n165_));
  nand2  g132(.a(new_n165_), .b(new_n164_), .O(new_n166_));
  aoi22  g133(.a(new_n166_), .b(new_n97_), .c(new_n163_), .d(new_n39_), .O(new_n167_));
  nand2  g134(.a(new_n167_), .b(new_n162_), .O(z6));
  inv1   g135(.a(new_n119_), .O(z7));
endmodule
