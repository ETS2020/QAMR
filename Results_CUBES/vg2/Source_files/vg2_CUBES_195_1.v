...
module FAU ( 
  ...
  nand4  g053(.a(x20), .b(x18), .c(x08), .d(x06), .O(new_n87_));
  ...
  nand4  g062(.a(new_n95_), .b(new_n94_), .c(new_n92_), .d(new_n49_), .O(new_n96_));
  inv1   g063(.a(x08), .O(new_n97_));
  nor3   g064(.a(x20), .b(x17), .c(x12), .O(new_n98_));
  nor2   g065(.a(x11), .b(x09), .O(new_n99_));
  nand4  g066(.a(new_n99_), .b(new_n98_), .c(new_n97_), .d(new_n67_), .O(new_n100_));
  oai21  g067(.a(new_n100_), .b(new_n96_), .c(new_n91_), .O(new_n101_));
  nor2   g068(.a(new_n39_), .b(new_n36_), .O(new_n102_));
  nand2  g069(.a(new_n102_), .b(new_n101_), .O(new_n103_));
  nor2   g070(.a(x08), .b(x06), .O(new_n104_));
  nand3  g071(.a(new_n104_), .b(new_n95_), .c(new_n92_), .O(new_n105_));
  inv1   g072(.a(new_n105_), .O(new_n106_));
  inv1   g073(.a(x13), .O(new_n107_));
  nand3  g074(.a(new_n99_), .b(x19), .c(new_n107_), .O(new_n108_));
  nand3  g075(.a(new_n49_), .b(new_n34_), .c(new_n67_), .O(new_n109_));
  nor2   g076(.a(new_n109_), .b(new_n108_), .O(new_n110_));
  nand3  g077(.a(new_n110_), .b(new_n106_), .c(new_n98_), .O(new_n111_));
  nand3  g078(.a(new_n111_), .b(new_n103_), .c(new_n83_), .O(z1));
  inv1   g079(.a(x15), .O(new_n113_));
  nand2  g080(.a(x24), .b(x18), .O(new_n114_));
  oai21  g081(.a(x24), .b(new_n113_), .c(new_n114_), .O(new_n115_));
  ...
  aoi21  g085(.a(new_n115_), .b(x05), .c(new_n118_), .O(new_n119_));
  nor2   g086(.a(new_n78_), .b(new_n77_), .O(new_n120_));
  nand4  g087(.a(new_n120_), .b(new_n84_), .c(x11), .d(x06), .O(new_n121_));
  nor2   g088(.a(new_n121_), .b(new_n119_), .O(z2));
  nand2  g089(.a(x08), .b(x06), .O(new_n123_));
  nand3  g090(.a(x20), .b(x14), .c(x11), .O(new_n124_));
  nor3   g091(.a(new_n124_), .b(new_n123_), .c(new_n57_), .O(new_n125_));
  nand2  g092(.a(new_n125_), .b(new_n56_), .O(new_n126_));
  nor3   g093(.a(x20), .b(x14), .c(x11), .O(new_n127_));
  nand4  g094(.a(new_n127_), .b(new_n104_), .c(new_n66_), .d(new_n49_), .O(new_n128_));
  nand2  g095(.a(new_n128_), .b(new_n126_), .O(new_n129_));
  nand2  g096(.a(new_n129_), .b(new_n36_), .O(new_n130_));
  nand3  g097(.a(new_n84_), .b(x14), .c(x11), .O(new_n131_));
  nand3  g098(.a(new_n50_), .b(new_n48_), .c(new_n97_), .O(new_n132_));
  nand2  g099(.a(new_n94_), .b(new_n49_), .O(new_n133_));
  oai22  g100(.a(new_n133_), .b(new_n132_), .c(new_n131_), .d(new_n87_), .O(new_n134_));
  nand4  g101(.a(new_n78_), .b(x19), .c(new_n77_), .d(new_n48_), .O(new_n135_));
  nand3  g102(.a(new_n104_), .b(new_n49_), .c(new_n39_), .O(new_n136_));
  nor2   g103(.a(new_n136_), .b(new_n135_), .O(new_n137_));
  aoi21  g104(.a(new_n134_), .b(new_n102_), .c(new_n137_), .O(new_n138_));
  nand2  g105(.a(new_n138_), .b(new_n130_), .O(z3));
  aoi21  g106(.a(new_n74_), .b(x04), .c(x17), .O(new_n140_));
  oai21  g107(.a(new_n140_), .b(x22), .c(new_n85_), .O(new_n141_));
  aoi21  g108(.a(new_n141_), .b(new_n71_), .c(x08), .O(new_n142_));
  aoi21  g109(.a(x23), .b(new_n67_), .c(new_n72_), .O(new_n143_));
  oai21  g110(.a(new_n143_), .b(new_n73_), .c(x09), .O(new_n144_));
  aoi21  g111(.a(new_n144_), .b(x16), .c(new_n97_), .O(new_n145_));
  oai22  g112(.a(new_n145_), .b(new_n119_), .c(new_n142_), .d(new_n46_), .O(z4));
  inv1   g113(.a(new_n46_), .O(z5));
  oai21  g114(.a(new_n78_), .b(x14), .c(new_n47_), .O(new_n148_));
  aoi21  g115(.a(new_n148_), .b(new_n48_), .c(x03), .O(new_n149_));
  inv1   g116(.a(x03), .O(new_n150_));
  nand2  g117(.a(new_n78_), .b(x14), .O(new_n151_));
  nand2  g118(.a(new_n151_), .b(x06), .O(new_n152_));
  aoi21  g119(.a(new_n152_), .b(x11), .c(new_n150_), .O(new_n153_));
  oai22  g120(.a(new_n153_), .b(new_n119_), .c(new_n149_), .d(new_n46_), .O(z6));
