...
module FAU ( 
  ...
  nand3  g054(.a(x22), .b(x20), .c(x18), .O(new_n88_));
  ...
  oai21  g116(.a(new_n55_), .b(x24), .c(new_n149_), .O(new_n150_));
  aoi21  g117(.a(new_n141_), .b(x08), .c(new_n53_), .O(new_n151_));
  aoi21  g118(.a(new_n145_), .b(new_n130_), .c(new_n66_), .O(new_n152_));
  oai21  g119(.a(new_n152_), .b(new_n151_), .c(new_n150_), .O(new_n153_));
  aoi21  g120(.a(new_n144_), .b(new_n72_), .c(x08), .O(new_n154_));
  nand2  g121(.a(x17), .b(x04), .O(new_n155_));
  aoi21  g122(.a(new_n155_), .b(x22), .c(new_n100_), .O(new_n156_));
  oai21  g123(.a(new_n156_), .b(new_n72_), .c(x08), .O(new_n157_));
  nand2  g124(.a(new_n157_), .b(x18), .O(new_n158_));
  oai21  g125(.a(new_n154_), .b(new_n34_), .c(new_n158_), .O(new_n159_));
  nand2  g126(.a(new_n159_), .b(new_n95_), .O(new_n160_));
  nand3  g127(.a(new_n160_), .b(new_n153_), .c(new_n148_), .O(z4));
  nand2  g128(.a(x20), .b(new_n119_), .O(new_n162_));
  aoi21  g129(.a(new_n162_), .b(new_n46_), .c(x11), .O(new_n163_));
  oai21  g130(.a(new_n163_), .b(x03), .c(z5), .O(new_n164_));
  inv1   g131(.a(x03), .O(new_n165_));
  nand2  g132(.a(new_n118_), .b(new_n113_), .O(z7));
  nand2  g133(.a(new_n102_), .b(x14), .O(new_n167_));
  aoi21  g134(.a(new_n167_), .b(x06), .c(new_n47_), .O(new_n168_));
  oai21  g135(.a(new_n168_), .b(new_n165_), .c(z7), .O(new_n169_));
  nand2  g136(.a(new_n169_), .b(new_n164_), .O(z6));
endmodule
