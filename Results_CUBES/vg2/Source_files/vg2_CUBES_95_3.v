// Benchmark "FAU" written by ABC on Mon Jul  6 14:57:20 2020
...
module FAU ( 
  ...
  oai21  g59(.a(new_n92_), .b(new_n34_), .c(new_n91_), .O(new_n93_));
  ...
  nand2  g63(.a(x15), .b(x13), .O(new_n97_));
  oai21  g64(.a(new_n97_), .b(x24), .c(new_n92_), .O(new_n98_));
  nand2  g65(.a(new_n98_), .b(x05), .O(new_n99_));
  nand3  g66(.a(new_n54_), .b(new_n36_), .c(x21), .O(new_n100_));
  nand3  g67(.a(new_n100_), .b(new_n99_), .c(new_n91_), .O(z7));
  ...
  inv1   g80(.a(z7), .O(new_n114_));
  inv1   g81(.a(x09), .O(new_n115_));
  aoi21  g82(.a(new_n74_), .b(x04), .c(x17), .O(new_n116_));
  oai21  g83(.a(new_n116_), .b(x22), .c(new_n115_), .O(new_n117_));
  aoi21  g84(.a(new_n117_), .b(new_n71_), .c(x08), .O(new_n118_));
  inv1   g85(.a(x04), .O(new_n119_));
  aoi21  g86(.a(x23), .b(new_n119_), .c(new_n72_), .O(new_n120_));
  oai21  g87(.a(new_n120_), .b(new_n73_), .c(x09), .O(new_n121_));
  aoi21  g88(.a(new_n121_), .b(x16), .c(new_n107_), .O(new_n122_));
  oai22  g89(.a(new_n122_), .b(new_n114_), .c(new_n118_), .d(new_n46_), .O(z4));
  inv1   g90(.a(new_n46_), .O(z5));
  nand2  g91(.a(x20), .b(new_n77_), .O(new_n125_));
  nand2  g92(.a(new_n125_), .b(new_n47_), .O(new_n126_));
  aoi21  g93(.a(new_n126_), .b(new_n48_), .c(x03), .O(new_n127_));
  inv1   g94(.a(x03), .O(new_n128_));
  nand2  g95(.a(new_n78_), .b(x14), .O(new_n129_));
  nand2  g96(.a(new_n129_), .b(x06), .O(new_n130_));
  aoi21  g97(.a(new_n130_), .b(x11), .c(new_n128_), .O(new_n131_));
  oai22  g98(.a(new_n131_), .b(new_n114_), .c(new_n127_), .d(new_n46_), .O(z6));
endmodule
