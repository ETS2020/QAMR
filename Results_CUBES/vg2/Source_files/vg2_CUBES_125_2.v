...
module FAU ( 
  ...
  nand3  g034(.a(new_n67_), .b(new_n66_), .c(new_n44_), .O(new_n68_));
  inv1   g035(.a(x16), .O(new_n69_));
  inv1   g036(.a(x17), .O(new_n70_));
  nand3  g037(.a(new_n48_), .b(new_n70_), .c(new_n69_), .O(new_n71_));
  nor2   g038(.a(x11), .b(x10), .O(new_n72_));
  nor2   g039(.a(x14), .b(x12), .O(new_n73_));
  nor2   g040(.a(x06), .b(x04), .O(new_n74_));
  nand4  g041(.a(new_n74_), .b(new_n73_), .c(new_n72_), .d(new_n49_), .O(new_n75_));
  ...
  nand4  g053(.a(new_n86_), .b(new_n67_), .c(new_n66_), .d(new_n49_), .O(new_n87_));
  ...
  nand3  g070(.a(new_n55_), .b(new_n35_), .c(x21), .O(new_n104_));
  ...
  nor2   g078(.a(new_n47_), .b(new_n89_), .O(new_n112_));
  ...
  nand2  g082(.a(new_n55_), .b(x00), .O(new_n116_));
  nand3  g083(.a(x19), .b(x13), .c(x05), .O(new_n117_));
  nand2  g084(.a(new_n117_), .b(new_n116_), .O(new_n118_));
  nor2   g085(.a(x14), .b(x08), .O(new_n119_));
  nand2  g086(.a(new_n50_), .b(new_n49_), .O(new_n120_));
  inv1   g087(.a(new_n120_), .O(new_n121_));
  nand4  g088(.a(new_n121_), .b(new_n119_), .c(new_n118_), .d(new_n48_), .O(new_n122_));
  ...
  nand3  g092(.a(new_n119_), .b(new_n48_), .c(new_n89_), .O(new_n126_));
  nand2  g093(.a(new_n86_), .b(new_n49_), .O(new_n127_));
  oai22  g094(.a(new_n127_), .b(new_n126_), .c(new_n125_), .d(new_n113_), .O(new_n128_));
  nand3  g095(.a(new_n112_), .b(x20), .c(x15), .O(new_n129_));
  nand3  g096(.a(new_n119_), .b(new_n48_), .c(x19), .O(new_n130_));
  ...
  oai21  g103(.a(x16), .b(new_n136_), .c(new_n135_), .O(new_n137_));
  nand2  g104(.a(new_n137_), .b(x19), .O(new_n138_));
  inv1   g105(.a(x22), .O(new_n139_));
  aoi21  g106(.a(x23), .b(new_n88_), .c(new_n70_), .O(new_n140_));
  oai21  g107(.a(new_n140_), .b(new_n139_), .c(x09), .O(new_n141_));
  aoi21  g108(.a(new_n141_), .b(x16), .c(new_n135_), .O(new_n142_));
  oai21  g109(.a(new_n142_), .b(new_n134_), .c(new_n138_), .O(new_n143_));
  nand2  g110(.a(new_n143_), .b(new_n39_), .O(new_n144_));
  nand2  g111(.a(new_n141_), .b(x16), .O(new_n145_));
  aoi21  g112(.a(new_n145_), .b(x08), .c(new_n100_), .O(new_n146_));
  inv1   g113(.a(x23), .O(new_n147_));
  nand2  g114(.a(new_n147_), .b(x04), .O(new_n148_));
  aoi21  g115(.a(new_n148_), .b(new_n70_), .c(x22), .O(new_n149_));
  oai21  g116(.a(new_n149_), .b(x09), .c(new_n69_), .O(new_n150_));
  aoi21  g117(.a(new_n150_), .b(new_n135_), .c(new_n34_), .O(new_n151_));
  oai21  g118(.a(new_n151_), .b(new_n146_), .c(new_n93_), .O(new_n152_));
  inv1   g119(.a(new_n57_), .O(new_n153_));
  inv1   g120(.a(x02), .O(new_n154_));
  nand4  g121(.a(new_n69_), .b(new_n42_), .c(new_n154_), .d(x00), .O(new_n155_));
  inv1   g122(.a(new_n155_), .O(new_n156_));
  aoi22  g123(.a(new_n156_), .b(new_n149_), .c(new_n137_), .d(new_n118_), .O(new_n157_));
  oai21  g124(.a(new_n142_), .b(new_n153_), .c(new_n157_), .O(new_n158_));
  nand2  g125(.a(new_n158_), .b(new_n35_), .O(new_n159_));
  nand3  g126(.a(new_n159_), .b(new_n152_), .c(new_n144_), .O(z4));
  inv1   g127(.a(x03), .O(new_n161_));
  aoi21  g128(.a(x20), .b(new_n47_), .c(x06), .O(new_n162_));
  ...
  nand2  g132(.a(new_n48_), .b(x14), .O(new_n166_));
  aoi21  g133(.a(new_n166_), .b(x06), .c(new_n89_), .O(new_n167_));
  oai21  g134(.a(new_n167_), .b(new_n161_), .c(z7), .O(new_n168_));
