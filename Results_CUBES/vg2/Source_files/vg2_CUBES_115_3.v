...
module FAU ( 
  ...
  aoi21  g111(.a(new_n139_), .b(new_n73_), .c(x08), .O(new_n145_));
  nand2  g112(.a(x18), .b(new_n69_), .O(new_n146_));
  oai21  g113(.a(new_n145_), .b(new_n144_), .c(new_n146_), .O(new_n147_));
  nand2  g114(.a(new_n147_), .b(new_n128_), .O(new_n148_));
  inv1   g115(.a(new_n38_), .O(new_n149_));
  oai21  g116(.a(new_n55_), .b(x24), .c(new_n149_), .O(new_n150_));
  aoi21  g117(.a(new_n136_), .b(x08), .c(new_n53_), .O(new_n151_));
  aoi21  g118(.a(new_n140_), .b(new_n69_), .c(new_n66_), .O(new_n152_));
  oai21  g119(.a(new_n152_), .b(new_n151_), .c(new_n150_), .O(new_n153_));
  nand3  g120(.a(new_n153_), .b(new_n148_), .c(new_n143_), .O(z4));
  nand2  g121(.a(x20), .b(new_n96_), .O(new_n155_));
  ...
  nand2  g125(.a(new_n113_), .b(new_n108_), .O(z7));
  nand2  g126(.a(new_n92_), .b(x14), .O(new_n160_));
