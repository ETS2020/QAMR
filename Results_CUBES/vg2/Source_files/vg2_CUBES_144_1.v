...
module FAU ( 
  ...
  aoi21  g114(.a(new_n137_), .b(x08), .c(new_n100_), .O(new_n148_));
  aoi21  g115(.a(new_n144_), .b(new_n139_), .c(new_n34_), .O(new_n149_));
  oai21  g116(.a(new_n149_), .b(new_n148_), .c(new_n93_), .O(new_n150_));
  inv1   g117(.a(new_n39_), .O(new_n151_));
  oai21  g118(.a(new_n55_), .b(x24), .c(new_n151_), .O(new_n152_));
  aoi21  g119(.a(new_n136_), .b(x16), .c(new_n139_), .O(new_n153_));
  aoi21  g120(.a(x22), .b(new_n140_), .c(x16), .O(new_n154_));
  oai21  g121(.a(new_n154_), .b(x08), .c(x19), .O(new_n155_));
  oai21  g122(.a(new_n153_), .b(new_n53_), .c(new_n155_), .O(new_n156_));
  nand2  g123(.a(new_n156_), .b(new_n152_), .O(new_n157_));
  nand3  g124(.a(new_n157_), .b(new_n150_), .c(new_n147_), .O(z4));
  inv1   g125(.a(x03), .O(new_n159_));
  aoi21  g126(.a(x20), .b(new_n46_), .c(x06), .O(new_n160_));
  oai21  g127(.a(new_n160_), .b(x11), .c(new_n159_), .O(new_n161_));
  nand2  g128(.a(new_n161_), .b(z5), .O(new_n162_));
  nand2  g129(.a(new_n108_), .b(new_n103_), .O(z7));
  nand2  g130(.a(new_n47_), .b(x14), .O(new_n164_));
  aoi21  g131(.a(new_n164_), .b(x06), .c(new_n89_), .O(new_n165_));
  oai21  g132(.a(new_n165_), .b(new_n159_), .c(z7), .O(new_n166_));
  nand2  g133(.a(new_n166_), .b(new_n162_), .O(z6));
endmodule
