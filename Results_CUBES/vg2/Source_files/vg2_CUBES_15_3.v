...
module FAU ( 
  ...
  nor2   g067(.a(x17), .b(x12), .O(new_n101_));
  nor2   g068(.a(x08), .b(x06), .O(new_n102_));
  nand4  g069(.a(new_n102_), .b(new_n101_), .c(new_n100_), .d(new_n91_), .O(new_n103_));
  nand4  g070(.a(new_n94_), .b(new_n74_), .c(new_n93_), .d(x19), .O(new_n104_));
  nand4  g071(.a(x16), .b(x15), .c(x14), .d(x12), .O(new_n105_));
  nor2   g072(.a(new_n105_), .b(new_n61_), .O(new_n106_));
  nand3  g073(.a(new_n106_), .b(new_n85_), .c(new_n83_), .O(new_n107_));
  oai21  g074(.a(new_n104_), .b(new_n103_), .c(new_n107_), .O(new_n108_));
  ...
  nand2  g095(.a(new_n102_), .b(new_n48_), .O(new_n129_));
  ...
  nand3  g102(.a(new_n49_), .b(new_n47_), .c(new_n135_), .O(new_n136_));
  nand2  g103(.a(new_n90_), .b(new_n48_), .O(new_n137_));
  oai22  g104(.a(new_n137_), .b(new_n136_), .c(new_n134_), .d(new_n84_), .O(new_n138_));
  nand3  g105(.a(new_n124_), .b(x20), .c(x15), .O(new_n139_));
  nand4  g106(.a(new_n93_), .b(x19), .c(new_n120_), .d(new_n47_), .O(new_n140_));
  ...
  aoi21  g110(.a(x23), .b(new_n69_), .c(new_n73_), .O(new_n144_));
  oai21  g111(.a(new_n144_), .b(new_n74_), .c(x09), .O(new_n145_));
  nand2  g112(.a(new_n145_), .b(x16), .O(new_n146_));
  aoi21  g113(.a(new_n146_), .b(x08), .c(new_n54_), .O(new_n147_));
  inv1   g114(.a(x09), .O(new_n148_));
  aoi21  g115(.a(new_n66_), .b(x04), .c(x17), .O(new_n149_));
  oai21  g116(.a(new_n149_), .b(x22), .c(new_n148_), .O(new_n150_));
  nand2  g117(.a(new_n150_), .b(new_n72_), .O(new_n151_));
  aoi21  g118(.a(new_n151_), .b(new_n135_), .c(new_n126_), .O(new_n152_));
  nor2   g119(.a(new_n56_), .b(x24), .O(new_n153_));
  oai21  g120(.a(new_n152_), .b(new_n147_), .c(new_n153_), .O(new_n154_));
  aoi21  g121(.a(new_n146_), .b(x08), .c(new_n111_), .O(new_n155_));
  aoi21  g122(.a(new_n151_), .b(new_n135_), .c(new_n34_), .O(new_n156_));
  oai21  g123(.a(new_n156_), .b(new_n155_), .c(new_n98_), .O(new_n157_));
  inv1   g124(.a(new_n39_), .O(new_n158_));
  oai21  g125(.a(new_n55_), .b(x24), .c(new_n158_), .O(new_n159_));
  aoi21  g126(.a(new_n145_), .b(x16), .c(new_n135_), .O(new_n160_));
  oai21  g127(.a(x17), .b(x04), .c(new_n74_), .O(new_n161_));
  aoi21  g128(.a(new_n161_), .b(new_n148_), .c(x16), .O(new_n162_));
  oai21  g129(.a(new_n162_), .b(x08), .c(x19), .O(new_n163_));
  oai21  g130(.a(new_n160_), .b(new_n53_), .c(new_n163_), .O(new_n164_));
  nand2  g131(.a(new_n164_), .b(new_n159_), .O(new_n165_));
  nand3  g132(.a(new_n165_), .b(new_n157_), .c(new_n154_), .O(z4));
  nand2  g133(.a(x20), .b(new_n120_), .O(new_n167_));
  aoi21  g134(.a(new_n167_), .b(new_n46_), .c(x11), .O(new_n168_));
  oai21  g135(.a(new_n168_), .b(x03), .c(z5), .O(new_n169_));
  inv1   g136(.a(x03), .O(new_n170_));
  nand2  g137(.a(new_n119_), .b(new_n114_), .O(z7));
  nand2  g138(.a(new_n93_), .b(x14), .O(new_n172_));
  aoi21  g139(.a(new_n172_), .b(x06), .c(new_n47_), .O(new_n173_));
  oai21  g140(.a(new_n173_), .b(new_n170_), .c(z7), .O(new_n174_));
  nand2  g141(.a(new_n174_), .b(new_n169_), .O(z6));
endmodule
