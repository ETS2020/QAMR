...
module FAU ( 
  ...
  nor2   g052(.a(x22), .b(x20), .O(new_n86_));
  nand4  g053(.a(new_n86_), .b(new_n85_), .c(new_n83_), .d(new_n68_), .O(new_n87_));
  inv1   g054(.a(x04), .O(new_n88_));
  nor2   g055(.a(x16), .b(x14), .O(new_n89_));
  nand4  g056(.a(new_n89_), .b(new_n49_), .c(new_n72_), .d(new_n88_), .O(new_n90_));
  nand4  g057(.a(x08), .b(x06), .c(x03), .d(x01), .O(new_n91_));
  inv1   g058(.a(new_n91_), .O(new_n92_));
  nand4  g059(.a(new_n92_), .b(x11), .c(x09), .d(x04), .O(new_n93_));
  nor2   g060(.a(new_n76_), .b(new_n75_), .O(new_n94_));
  and2   g061(.a(x20), .b(x18), .O(new_n95_));
  and2   g062(.a(x23), .b(x22), .O(new_n96_));
  nand4  g063(.a(new_n96_), .b(new_n95_), .c(new_n94_), .d(x17), .O(new_n97_));
  oai22  g064(.a(new_n97_), .b(new_n93_), .c(new_n90_), .d(new_n87_), .O(new_n98_));
  ...
  nand4  g070(.a(new_n103_), .b(new_n102_), .c(new_n101_), .d(new_n86_), .O(new_n104_));
  nor2   g071(.a(x17), .b(x16), .O(new_n105_));
  nand4  g072(.a(new_n105_), .b(new_n49_), .c(x19), .d(new_n88_), .O(new_n106_));
  nand3  g073(.a(x20), .b(x17), .c(x15), .O(new_n107_));
  inv1   g074(.a(new_n107_), .O(new_n108_));
  nand3  g075(.a(new_n108_), .b(new_n96_), .c(new_n94_), .O(new_n109_));
  oai22  g076(.a(new_n109_), .b(new_n93_), .c(new_n106_), .d(new_n104_), .O(new_n110_));
  ...
  nand4  g090(.a(new_n123_), .b(new_n92_), .c(new_n56_), .d(x20), .O(new_n124_));
  nor3   g091(.a(x20), .b(x14), .c(x11), .O(new_n125_));
  nand2  g092(.a(new_n103_), .b(new_n49_), .O(new_n126_));
  ...
  nand2  g099(.a(new_n132_), .b(new_n50_), .O(new_n133_));
  nand3  g100(.a(new_n49_), .b(x07), .c(new_n47_), .O(new_n134_));
  oai22  g101(.a(new_n134_), .b(new_n133_), .c(new_n131_), .d(new_n91_), .O(new_n135_));
  nand4  g102(.a(x20), .b(x15), .c(x14), .d(x11), .O(new_n136_));
  nand4  g103(.a(new_n77_), .b(x19), .c(new_n76_), .d(new_n48_), .O(new_n137_));
  oai22  g104(.a(new_n137_), .b(new_n126_), .c(new_n136_), .d(new_n91_), .O(new_n138_));
  aoi22  g105(.a(new_n138_), .b(new_n39_), .c(new_n135_), .d(new_n99_), .O(new_n139_));
  nand2  g106(.a(new_n139_), .b(new_n130_), .O(z3));
  inv1   g107(.a(x09), .O(new_n141_));
  nor2   g108(.a(x17), .b(x04), .O(new_n142_));
  oai21  g109(.a(new_n142_), .b(x22), .c(new_n141_), .O(new_n143_));
  aoi21  g110(.a(new_n143_), .b(new_n71_), .c(x08), .O(new_n144_));
  oai21  g111(.a(new_n73_), .b(x17), .c(x09), .O(new_n145_));
  nand2  g112(.a(new_n96_), .b(new_n88_), .O(new_n146_));
  nand2  g113(.a(new_n146_), .b(x08), .O(new_n147_));
  aoi21  g114(.a(new_n145_), .b(x16), .c(new_n147_), .O(new_n148_));
  oai22  g115(.a(new_n148_), .b(new_n120_), .c(new_n144_), .d(new_n46_), .O(z4));
