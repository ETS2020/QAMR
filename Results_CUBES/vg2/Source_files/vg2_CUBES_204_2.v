...
module FAU ( 
  ...
  nand3  g020(.a(new_n53_), .b(x21), .c(x16), .O(new_n54_));
  ...
  nand4  g026(.a(x17), .b(x14), .c(x12), .d(x11), .O(new_n60_));
  ...
  nand3  g066(.a(x20), .b(x17), .c(x15), .O(new_n100_));
  nand4  g067(.a(x23), .b(x22), .c(x14), .d(x12), .O(new_n101_));
  ...
  nand4  g071(.a(new_n76_), .b(new_n75_), .c(new_n47_), .d(new_n104_), .O(new_n105_));
  inv1   g072(.a(new_n105_), .O(new_n106_));
  inv1   g073(.a(x08), .O(new_n107_));
  nand4  g074(.a(new_n77_), .b(x19), .c(new_n107_), .d(new_n46_), .O(new_n108_));
  inv1   g075(.a(new_n108_), .O(new_n109_));
  nand2  g076(.a(new_n109_), .b(new_n106_), .O(new_n110_));
  oai21  g077(.a(new_n110_), .b(new_n96_), .c(new_n103_), .O(new_n111_));
  nand2  g078(.a(new_n111_), .b(new_n38_), .O(new_n112_));
  nand3  g079(.a(new_n112_), .b(new_n99_), .c(new_n82_), .O(z1));
  ...
  nor3   g090(.a(new_n123_), .b(new_n122_), .c(new_n56_), .O(z2));
  nand2  g091(.a(new_n53_), .b(x21), .O(new_n125_));
  nand2  g092(.a(new_n125_), .b(new_n52_), .O(new_n126_));
  nor2   g093(.a(new_n76_), .b(new_n47_), .O(new_n127_));
  nand4  g094(.a(new_n127_), .b(new_n126_), .c(new_n86_), .d(x20), .O(new_n128_));
  nor2   g095(.a(x08), .b(x06), .O(new_n129_));
  nor3   g096(.a(x20), .b(x14), .c(x11), .O(new_n130_));
  nand4  g097(.a(new_n130_), .b(new_n129_), .c(new_n65_), .d(new_n48_), .O(new_n131_));
  ...
  nand3  g102(.a(new_n48_), .b(x07), .c(new_n46_), .O(new_n136_));
  oai22  g103(.a(new_n136_), .b(new_n135_), .c(new_n134_), .d(new_n85_), .O(new_n137_));
  nand4  g104(.a(x20), .b(x15), .c(x14), .d(x11), .O(new_n138_));
  nand3  g105(.a(new_n48_), .b(new_n76_), .c(new_n47_), .O(new_n139_));
  oai22  g106(.a(new_n139_), .b(new_n108_), .c(new_n138_), .d(new_n85_), .O(new_n140_));
  aoi22  g107(.a(new_n140_), .b(new_n38_), .c(new_n137_), .d(new_n98_), .O(new_n141_));
  ...
  aoi21  g112(.a(new_n119_), .b(new_n118_), .c(new_n70_), .O(new_n146_));
  nand3  g113(.a(x24), .b(x18), .c(x16), .O(new_n147_));
  ...
  oai21  g117(.a(new_n150_), .b(new_n146_), .c(new_n145_), .O(new_n151_));
  nand2  g118(.a(new_n37_), .b(x05), .O(new_n152_));
  inv1   g119(.a(new_n44_), .O(new_n153_));
  nand2  g120(.a(new_n153_), .b(new_n152_), .O(z5));
  oai21  g121(.a(x23), .b(new_n143_), .c(new_n71_), .O(new_n155_));
  aoi21  g122(.a(new_n155_), .b(new_n72_), .c(x09), .O(new_n156_));
  oai21  g123(.a(new_n156_), .b(x16), .c(new_n107_), .O(new_n157_));
  nand2  g124(.a(new_n157_), .b(z5), .O(new_n158_));
  oai21  g125(.a(new_n121_), .b(new_n117_), .c(new_n107_), .O(new_n159_));
  nand3  g126(.a(new_n159_), .b(new_n158_), .c(new_n151_), .O(z4));
  oai21  g127(.a(new_n77_), .b(x14), .c(new_n46_), .O(new_n161_));
  aoi21  g128(.a(new_n161_), .b(new_n47_), .c(x03), .O(new_n162_));
  inv1   g129(.a(x03), .O(new_n163_));
  oai21  g130(.a(x20), .b(new_n76_), .c(x06), .O(new_n164_));
  aoi21  g131(.a(new_n164_), .b(x11), .c(new_n163_), .O(new_n165_));
  oai22  g132(.a(new_n165_), .b(new_n122_), .c(new_n162_), .d(new_n45_), .O(z6));
  inv1   g133(.a(new_n122_), .O(z7));
endmodule
