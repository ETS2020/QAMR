...
module FAU ( 
  ...
  nand4  g11(.a(new_n21_), .b(new_n26_), .c(new_n17_), .d(new_n16_), .O(z3));
  nand4  g12(.a(new_n21_), .b(new_n19_), .c(new_n17_), .d(x2), .O(z5));
  nand4  g13(.a(new_n24_), .b(new_n21_), .c(new_n17_), .d(x2), .O(z6));
  nand4  g14(.a(new_n21_), .b(new_n26_), .c(new_n17_), .d(x2), .O(z7));
  one    g15(.O(z0));
  one    g16(.O(z4));
endmodule
